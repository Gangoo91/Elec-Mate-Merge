...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['42%', '3%', '6%', 'Cannot be calculated'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['LonWorks', 'BACnet IP', 'KNX', 'Modbus RTU'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['29V DC (nominal 30V)', '12V DC', '5V DC', '230V AC'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Loop testing', 'Firmware update', 'Trend logging', 'Point-to-point testing'],
    correctAnswer: 3,
    explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/h-n-c-module3-section6"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Approved Document L 2021 makes BMS / BAS controls and commissioning evidence a
              Building Control submission item. As BSE designer you specify the controls and write
              the commissioning brief; the M&amp;V evidence feeds into the Part L log book and any
              subsequent EPC / DEC. Wrong / missing controls is one of the commonest reasons
              buildings underperform their design SBEM model in operation.
            </>
          }
        ...
        <ConceptBlock title="Building Management Systems (BMS) Overview">
          <p>
            A Building Management System (BMS) is a computer-based control system that monitors and
            manages a building's mechanical and electrical equipment. Modern BMS installations
            integrate HVAC, lighting, fire systems, security, and energy metering into a unified
            management platform.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">BMS Architecture Levels</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Management</strong> — Workstations, servers, web interface — Operator
              interface, data storage, analytics, reporting
            </li>
            <li>
              <strong>Automation</strong> — Controllers, outstations, DDC panels — Execute control
              strategies, local processing, network communication
            </li>
            <li>
              <strong>Field</strong> — Sensors, actuators, valves, dampers — Measure conditions,
              execute control actions on plant
            </li>
          </ul>
        ...
        <ConceptBlock title="Sensors: Temperature, Occupancy, Light Level">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Room sensor</strong> — NTC thermistor, Pt100/Pt1000 — Space temperature
              control — ±0.3°C to ±0.5°C
            </li>
            <li>
              <strong>Duct sensor</strong> — Pt100 averaging element — Supply/return air temperature
              — ±0.2°C to ±0.5°C
            </li>
            <li>
              <strong>Pipe sensor</strong> — Pt100 pocket or strap-on — CHW/HHW flow temperature —
              ±0.2°C to ±0.5°C
            </li>
            <li>
              <strong>Outside air</strong> — Pt100/Pt1000 in housing — Weather compensation — ±0.5°C
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>PIR (Passive Infrared)</strong> — Body heat movement — Corridors, toilets,
              meeting rooms
            </li>
            <li>
              <strong>Microwave</strong> — Doppler shift from movement — Areas requiring
              through-partition detection
            </li>
            <li>
              <strong>Dual-tech (PIR + MW)</strong> — Both must trigger — Open-plan offices,
              reducing false triggers
            </li>
            <li>
              <strong>Ultrasonic</strong> — Sound wave reflection — Partitioned spaces, cubicles
            </li>
            <li>
              <strong>CO2 sensor (proxy)</strong> — Exhaled CO2 accumulation — Demand-controlled
              ventilation
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ceiling-mounted:</strong> Measure combined daylight and artificial light on
              working plane (typical 300-500 lux target)
            </li>
            <li>
          ...
          <p>
            <strong>Sensor placement:</strong> Position temperature sensors away from heat sources,
            draughts, and direct sunlight. Mount occupancy sensors to cover the required detection
            zone without obstructions.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Control Strategies: PID, Optimum Start/Stop">
          ...
          <p>
            PID (Proportional-Integral-Derivative) control is the most widely used feedback control
            algorithm. It calculates an error value as the difference between measured value and
            setpoint, then applies correction based on three terms:
          </p>
          ...
          <p className="text-white text-xs mt-1">Responds immediately but leaves offset</p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Proportional band (PB):</strong> Range over which output varies from 0-100%.
              Narrow PB = aggressive response
            </li>
            <li>
              <strong>Integral time (Ti):</strong> Time to repeat proportional action. Shorter Ti =
              faster error elimination
            </li>
            <li>
              <strong>Derivative time (Td):</strong> Time to anticipate error change. Often set to
              zero for HVAC (noise sensitivity)
            </li>
            <li>
              <strong>Rule of thumb:</strong> Start with P-only, add I to eliminate offset, add D
              only if oscillation persists
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Optimum Start/Stop Control</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Optimum Start</strong> — Calculates latest start time to reach setpoint at
              occupancy — Avoids over-early heating; adapts to thermal mass and weather
            </li>
            <li>
              <strong>Optimum Stop</strong> — Shuts down plant before end of occupancy using thermal
              storage — Utilises building thermal mass; reduces run hours
            </li>
            <li>
              <strong>Night Setback</strong> — Maintains minimum temperature (e.g., 12°C) overnight
              — Prevents frost damage; reduces morning preheat time
            </li>
            <li>
              <strong>Free Cooling</strong> — Uses outside air for cooling when conditions permit —
        ...
        <ConceptBlock title="Network Protocols: BACnet, Modbus, KNX">
          <p>
            Communication protocols enable devices from different manufacturers to exchange data and
            work together. Selecting appropriate protocols affects system flexibility, cost, and
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BACnet</strong> — Open standard (ASHRAE/ISO) — HVAC, BMS integration —
              Ethernet (IP), RS-485 (MS/TP)
            </li>
            <li>
              <strong>Modbus</strong> — Open de facto standard — Metering, industrial equipment —
              RS-485 (RTU), Ethernet (TCP)
            </li>
            <li>
              <strong>KNX</strong> — Open standard (ISO/IEC) — Lighting, blinds, room control —
              Twisted pair, IP, RF, PLC
            </li>
            <li>
              <strong>DALI</strong> — Open standard (IEC 62386) — Lighting control — Two-wire bus
              (max 64 devices)
            </li>
            <li>
              <strong>LonWorks</strong> — Open standard (ISO/IEC) — General building automation —
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Object-oriented data model (analog input, binary output, schedule, etc.)</li>
            <li>Standard services: read/write property, COV, alarms, scheduling</li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Bus voltage:</strong> 29V DC (21-30V tolerance) supplied by KNX power supply
            </li>
            <li>
              <strong>Topology:</strong> Line, area, and backbone structure; 64 devices per line, 15
              lines per area
            </li>
            <li>
          ...
          <p>
            <strong>Specification tip:</strong> Always specify open protocols (BACnet, KNX, DALI) to
            avoid vendor lock-in and ensure long-term system flexibility and maintainability.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="HVAC Control Strategies">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Air Handling Unit (AHU) Control</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Supply air temperature</strong> — Duct temperature sensor — Heating/cooling
              valve, mixing dampers
            </li>
            <li>
              <strong>Supply air pressure</strong> — Duct pressure sensor — Supply fan VSD
            </li>
            <li>
              <strong>Fresh air quantity</strong> — CO2 sensor, air flow station — Fresh air damper
            </li>
            <li>
              <strong>Room temperature</strong> — Room sensor — VAV box damper, reheat coil
            </li>
            <li>
              <strong>Humidity</strong> — Humidity sensor — Humidifier, cooling coil
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Frost protection:</strong> Maintains minimum temperatures to prevent damage
            </li>
            <li>
              <strong>DHW priority:</strong> Prioritises domestic hot water heating when required
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Chilled Water System Control</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Load-based sequencing:</strong> Stages chillers to match building cooling load
            </li>
            <li>
              <strong>Supply temperature reset:</strong> Raises CHW temperature when full cooling
              not needed
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Dead Band and Changeover</p>
          <p>
        ...
        <ConceptBlock title="Lighting Control Systems">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Bus topology</strong> — Two-wire, polarity-independent, daisy-chain or star
            </li>
            <li>
              <strong>Maximum devices</strong> — 64 addresses per DALI line (drivers, sensors,
              switches)
            </li>
            <li>
              <strong>Dimming range</strong> — 0.1-100% with logarithmic curve (matches human
              perception)
            </li>
            <li>
              <strong>Groups/scenes</strong> — 16 groups, 16 scenes per device
            </li>
            <li>
              <strong>DALI-2</strong> — Enhanced standard with mandatory features, improved
              interoperability
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Lighting Control Strategies</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Occupancy control:</strong> PIR/microwave sensors switch or dim lighting
            </li>
            <li>
              <strong>Daylight harvesting:</strong> Photocells dim artificial lighting near windows
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Typical Energy Savings</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Emergency Lighting Integration</p>
          <p>DALI emergency luminaires (Type 1) provide addressable monitoring and testing:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Automated function testing (monthly) and duration testing (annually)</li>
            <li>Battery and lamp status monitoring via DALI bus</li>
            <li>Automatic test logging for compliance documentation</li>
            <li>Rest mode: extinguish in mains-healthy condition to extend battery life</li>
          </ul>

          <p>
            <strong>Compliance note:</strong> Part L requires lighting controls in new non-domestic
            buildings. BREEAM credits available for metering, zoning, and occupant controls.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Integration and Interoperability">
          <p>
            ...
            security, fire, access control, and metering. Successful integration enables coordinated
            operation, unified monitoring, and enhanced energy management.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Integration Architecture</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Native protocol</strong> — Direct communication on same protocol —
              BACnet-to-BACnet device integration
            </li>
            <li>
              <strong>Protocol gateway</strong> — Translates between protocols — Modbus meter to
              BACnet BMS
            </li>
            <li>
              <strong>Hard-wired I/O</strong> — Volt-free contacts, 0-10V, 4-20mA — Fire alarm
              interface (status/trips)
            </li>
            <li>
              <strong>API/middleware</strong> — Software integration layer — Building analytics
              platforms, IoT
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Typical System Integrations</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Security/access control:</strong> Occupancy data triggers HVAC and lighting
              modes; after-hours access activates local services
            </li>
            <li>
              <strong>Lighting and HVAC:</strong> Shared occupancy sensors; coordinated scheduling;
              lighting scenes trigger temperature setpoints
            </li>
            <li>
            ...
            <li>
              <strong>Lifts:</strong> Status monitoring, fault alarms, energy consumption tracking
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Interoperability Considerations</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Points list coordination:</strong> Define all integrated points, addresses,
              and data formats in specification
            </li>
            <li>
            ...
            <li>
              <strong>Testing:</strong> Factory acceptance testing (FAT) with simulated integration;
              site witness testing
            </li>
            <li>
              <strong>Documentation:</strong> System architecture diagrams, integration matrices,
        ...
        <ConceptBlock title="Building Services: Commissioning BMS, Energy Monitoring">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">BMS Commissioning Stages</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pre-commissioning</strong> — Cable testing, power-on checks, software upload —
              Installation check sheets
            </li>
            <li>
              <strong>Point-to-point</strong> — Verify each sensor/actuator displays/operates
              correctly — Points commissioning sheets
            </li>
            <li>
              <strong>Loop testing</strong> — Verify control loops operate correctly (setpoint
              changes) — Control loop test records
            </li>
            <li>
              <strong>Functional testing</strong> — Test sequences of operation, interlocks, alarms
              — Functional test scripts and results
            </li>
            <li>
              <strong>Optimisation</strong> — Tune PID loops, adjust schedules, optimum start
              parameters — Trend logs, tuning records
            </li>
            <li>
              <strong>Seasonal</strong> — Verify heating and cooling modes over full year — Seasonal
              commissioning reports
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Energy Monitoring Features</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Automated M&T:</strong> Target setting, CUSUM analysis, exception reporting
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Soft Landings and Aftercare</p>
          <p>BSRIA Soft Landings framework extends BMS commissioning with:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Industry guidance:</strong> BSRIA BG6 (BMS Design Guide), BG49 (Soft Landings),
            and CIBSE TM63 (Operational Energy) provide comprehensive commissioning and energy
            monitoring guidance.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            ...
            temperature 19°C, proportional band 4°C, and integral time 300 seconds. Calculate the
            proportional output.
          </p>
          ...
          <p>
            <strong>Question:</strong> A 200m² perimeter zone has lighting load of 12 W/m². Daylight
            harvesting achieves 35% average dimming over 2,500 occupied hours. Calculate annual
            energy saving.
          </p>
          ...
          <p>
            <strong>Question:</strong> Building requires 3 hours to preheat from 12°C to 21°C when
            outside temperature is 5°C. Occupancy starts at 08:00. When should heating start?
          </p>
          ...
          <p className="text-white">- Actual external temperature (warmer = later start)</p>
          ...
          <p>
            <strong>Question:</strong> A meeting room designed for 20 people typically has average
            occupancy of 8. Fresh air rate is 10 l/s/person. Calculate the ventilation reduction
            with demand control.
          </p>
        ...
        <ConceptBlock title="Practical Guidance">
          <p className="text-sm font-medium text-elec-yellow/80">BMS Specification Checklist</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Define open protocols (BACnet, KNX, DALI) for all major systems</li>
            <li>
            ...
            <li>Define graphics requirements, alarm priorities, and trend logging</li>
            <li>Include integration matrix for all interfaced systems</li>
            <li>Specify commissioning requirements including seasonal testing</li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Energy Monitoring Best Practice</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Sub-meter major end uses: HVAC, lighting, small power, lifts, catering</li>
            <li>Collect half-hourly data minimum (15-minute for detailed analysis)</li>
            <li>Establish baselines and set reduction targets</li>
            <li>Monitor baseload (out-of-hours) consumption as key efficiency indicator</li>
            <li>Implement automated exception reporting for consumption anomalies</li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A new university lecture-block has 6 dual-duct AHUs serving 18 lecture theatres.
              Original BMS contractor proposes a bespoke control sequence with PID loops on each AHU
              damper. The BSE consultant insists on ASHRAE Guideline 36 (G36) high-performance
              sequences instead.
            </>
          }
          whatToDo={
            <>
              G36 sequences are pre-engineered, peer-reviewed, energy-optimised templates for AHUs,
              VAVs, central plant. They include trim-and-respond static-pressure reset,
              demand-controlled outdoor air, supply-air temperature reset, fault detection and
              diagnostics &mdash; all of which routinely save 15&ndash;30 % energy over bespoke
              sequences with no trade-off in comfort. Specify G36 sequences with BACnet IP
              automation controllers; include FDD (fault detection &amp; diagnosis) modules; require
              the contractor to provide the M&amp;V evidence for comparison against the SBEM model.
            </>
          }
          whyItMatters={
            <>
              Bespoke BMS sequences are the source of most building underperformance vs design
              intent &mdash; the &ldquo;performance gap&rdquo; documented in CIBSE TM54. G36 (and
              the equivalent BSRIA BG29 in UK practice) closes the gap by encoding best-in-class
              control logic. The HNC engineer who insists on G36 unlocks the 20&ndash;30 % energy
              saving the SBEM model already promised but the building rarely delivers.
            </>
          }
        />
