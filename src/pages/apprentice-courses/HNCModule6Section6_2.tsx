    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Fabric first:</strong> Optimise envelope before active systems
              </li>
              <li className="pl-1">
                <strong>U-values:</strong> Walls 0.15-0.18, Roof 0.10-0.13, Floor 0.10-0.15 W/m²K
              </li>
              <li className="pl-1">
                <strong>Airtightness:</strong> Target 3 m³/h/m² @ 50Pa or better
              </li>
              <li className="pl-1">
                <strong>Result:</strong> 60-80% reduction in heating demand
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Heating:</strong> 2-4 kW vs 10-15 kW typical
              </li>
              <li className="pl-1">
                <strong>Ventilation:</strong> MVHR essential for airtight buildings
              </li>
              <li className="pl-1">
                <strong>Distribution:</strong> Lower flow temperatures viable
              </li>
              <li className="pl-1">
                <strong>Controls:</strong> Simpler due to stable temperatures
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Energy Hierarchy (in order of priority):
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>1. Be lean:</strong> Reduce demand through excellent fabric and passive
                  design
                </li>
                <li className="pl-1">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Minimise surface area to volume ratio
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        U-values 2-3x better than regulations
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Sealed envelope with controlled ventilation
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Prevents infiltration losses
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Solar optimisation</td>
                      <td className="border border-white/10 px-3 py-2">
                        South-facing glazing, appropriate shading
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Free heating gains, overheating control
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key principle:</strong> Every kilowatt-hour of demand avoided is worth more
              than a kilowatt-hour generated - savings are guaranteed for the building's lifetime.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Frame in contact with masonry
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Insulated frames, return insulation
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Insulated lintels, thermally broken
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Floor junction</td>
                      <td className="border border-white/10 px-3 py-2">
                        Concrete slab bridges cavity
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Perimeter insulation, thermal breaks
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Balconies</td>
                      <td className="border border-white/10 px-3 py-2">
                        Slab extends through envelope
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Thermal break connectors (Isokorb)
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm mb-2">
                The air barrier must be continuous, robust, and durable:
              </p>
              <ul className="text-sm text-white space-y-1">
                <li>
                  • Identify one layer as the designated air barrier (membrane or wet plaster)
                </li>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A fabric first approach fundamentally changes building services requirements. With
              heat losses reduced by 60-80%, system sizing, selection, and distribution strategies
              are transformed. This creates opportunities for simpler, smaller, and more efficient
              installations.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Heating System Sizing Comparison
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <div className="my-6 p-4 rounded-lg bg-green-500/10 border border-green-500/30">
              <p className="text-sm font-medium text-green-400 mb-2">
                Passivhaus Window Requirements
              </p>
              <ul className="text-sm space-y-1">
                ...
                <li>
                  • <strong>Glazing:</strong> Triple glazing with low-e coatings, argon or krypton
                  fill
                </li>
                <li>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: U-Value and Heat Loss Calculation
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Airtightness Impact on Infiltration Heat Loss
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: System Sizing for Fabric First Dwelling
              </h3>
              <p className="text-sm text-white mb-2">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Fabric First Design Checklist
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Set U-value targets at project outset (consider Passivhaus or near-Passivhaus)
                </li>
                <li className="pl-1">
                  Model thermal bridges using psi values - include in heat loss calculations
                </li>
                <li className="pl-1">Design continuous insulation and air barrier strategies</li>
                <li className="pl-1">
                  Specify airtightness target and interim testing requirements
                </li>
                <li className="pl-1">
                  Coordinate MVHR duct routing with structural and architectural design
                </li>
                <li className="pl-1">
                  Size heating systems based on actual calculated loads, not rules of thumb
                </li>
              </ul>
            </div>
