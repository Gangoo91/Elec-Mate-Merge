...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['15-20 kW (standard sizing)', '2-4 kW', '6-8 kW', '10-12 kW'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['15 kWh/m²/year or less', '100 kWh/m²/year', '50 kWh/m²/year', '25 kWh/m²/year'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Passivhaus is the most rigorous mainstream fabric-first standard. The 0.6 ACH
              airtightness target is roughly 8× tighter than Part L's 5 m³/h·m². The capital premium
              (typically 5–15% on construction cost) is offset by operational savings, smaller M&E
              systems, and increasing market valuation premium for certified Passivhaus dwellings.
            </>
          }
        ...
        <ConceptBlock title="Fabric First Hierarchy">
          <p>
            The fabric first approach follows a clear hierarchy: reduce energy demand through
            building fabric before considering active systems and renewable generation. This
            fundamentally changes how we approach building services design, as a well-designed
            envelope dramatically reduces system requirements.
          </p>
          <p>
            <strong>Energy Hierarchy (in order of priority):</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Be lean:</strong> Reduce demand through excellent fabric and passive design
            </li>
            <li>
              <strong>2. Be clean:</strong> Use efficient systems with low-carbon energy sources
            </li>
            <li>
              <strong>3. Be green:</strong> Generate renewable energy on-site
            </li>
            <li>
              <strong>4. Be seen:</strong> Monitor, display, and optimise performance
            </li>
          </ul>
          <p>
            <strong>Fabric First Design Principles</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Compact form:</strong> Minimise surface area to volume ratio — Reduces heat
              loss area
            </li>
            <li>
              <strong>Superinsulation:</strong> U-values 2-3x better than regulations — Minimises
              transmission losses
            </li>
            <li>
              <strong>Thermal bridge-free:</strong> Continuous insulation envelope — Eliminates cold
              spots and condensation
            </li>
            <li>
              <strong>Airtightness:</strong> Sealed envelope with controlled ventilation — Prevents
              infiltration losses
            </li>
            <li>
              <strong>Solar optimisation:</strong> South-facing glazing, appropriate shading — Free
              heating gains, overheating control
            </li>
          </ul>
          <p>
            <strong>Key principle:</strong> Every kilowatt-hour of demand avoided is worth more than
            a kilowatt-hour generated - savings are guaranteed for the building's lifetime.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Enhanced Insulation and U-Value Targets">
          <p>
            Fabric first designs significantly exceed Building Regulations minimum U-values. The
            additional insulation cost is offset by smaller mechanical systems and dramatically
            reduced running costs over the building's lifetime.
          </p>
          <p>
            <strong>U-Value Comparison (W/m²K)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>External walls:</strong> 0.26 — 0.15-0.18 — 0.10-0.15
            </li>
            <li>
              <strong>Roof:</strong> 0.16 — 0.10-0.13 — 0.08-0.12
            </li>
            <li>
              <strong>Ground floor:</strong> 0.18 — 0.10-0.15 — 0.08-0.12
            </li>
            <li>
              <strong>Windows:</strong> 1.6 (whole window) — 0.8-1.2 — 0.8 or better
            </li>
            <li>
              <strong>Doors:</strong> 1.6 — 1.0-1.2 — 0.8
            </li>
          </ul>
          <p>
            <strong>Insulation Types</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Wall Build-Up Options</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Thickness Required</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Design consideration:</strong> Thicker insulation affects internal dimensions,
            foundation depths, and eaves details - coordinate with architect early in design.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Thermal Bridging and Airtightness">
          <p>
            Even with excellent insulation, thermal bridges and air leakage can account for 30-50%
            of heat loss in a building. Addressing these requires careful design detailing and
            rigorous site quality control.
          </p>
          <p>
          ...
          <p>
            <strong>Thermal Bridge Solutions</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Window reveals:</strong> Frame in contact with masonry — Insulated frames,
              return insulation
            </li>
            <li>
              <strong>Lintels:</strong> Steel conducts heat — Insulated lintels, thermally broken
            </li>
            <li>
              <strong>Floor junction:</strong> Concrete slab bridges cavity — Perimeter insulation,
              thermal breaks
            </li>
            <li>
              <strong>Balconies:</strong> Slab extends through envelope — Thermal break connectors
              (Isokorb)
            </li>
          </ul>
          <p>
            <strong>Airtightness Targets and Testing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Building Regulations:</strong> 10 m³/h/m² @ 50Pa (minimum backstop)
            </li>
            <li>
              <strong>Part L 2021 notional:</strong> 5 m³/h/m² @ 50Pa
            </li>
            <li>
              <strong>Enhanced fabric first:</strong> 3 m³/h/m² @ 50Pa or better
            </li>
            <li>
              <strong>Passivhaus:</strong> 0.6 ACH @ 50Pa (approx. 0.3-0.5 m³/h/m²)
            </li>
          </ul>
          <p>
            <strong>Air Barrier Strategy</strong>
          </p>
          ...
          <p>
            <strong>Critical point:</strong> Airtightness must be achieved during construction -
            retrofitting a continuous air barrier after completion is extremely difficult.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Impact on Building Services Design">
          <p>
            A fabric first approach fundamentally changes building services requirements. With heat
            losses reduced by 60-80%, system sizing, selection, and distribution strategies are
            transformed. This creates opportunities for simpler, smaller, and more efficient
            installations.
          </p>
          <p>
            <strong>Heating System Sizing Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Standard build:</strong> 80-100 W/m² — 10-15 kW — 80-120 kWh/m²/yr
            </li>
            <li>
              <strong>Part L 2021 compliant:</strong> 50-70 W/m² — 6-8 kW — 50-70 kWh/m²/yr
            </li>
            <li>
              <strong>Enhanced fabric first:</strong> 25-35 W/m² — 3-4 kW — 25-40 kWh/m²/yr
            </li>
            <li>
              <strong>Passivhaus:</strong> 10-15 W/m² — 1-2 kW — ≤15 kWh/m²/yr
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Passivhaus Window Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              • <strong>U-value:</strong> 0.80 W/m²K or better (whole window including frame)
            </li>
            <li>
              • <strong>Glazing:</strong> Triple glazing with low-e coatings, argon or krypton fill
            </li>
            <li>
              • <strong>Frame:</strong> Thermally broken or insulated composite frames
            </li>
            <li>
              • <strong>Installation:</strong> Positioned in insulation zone, not on masonry
            </li>
            <li>
              • <strong>Solar gain (g-value):</strong> 0.5 or higher for passive solar heating
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Compare infiltration losses for a 250m³ dwelling at different
            airtightness levels.
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Enhanced wall U-value: <strong>0.15-0.18 W/m²K</strong>
            </li>
            <li>
              Passivhaus space heating: <strong>≤15 kWh/m²/year</strong>
            </li>
            <li>
              Passivhaus airtightness: <strong>0.6 ACH @ 50Pa</strong>
            </li>
            <li>
              MVHR heat recovery: <strong>85-95%</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Oversizing heating systems</strong> - use actual calculated loads, not
                standard ratios
              </li>
              <li>
                <strong>Ignoring thermal bridges</strong> - can account for 30% of heat loss in
                well-insulated buildings
              </li>
              <li>
                <strong>Late airtightness consideration</strong> - must be designed from concept
                stage
              </li>
              <li>
                <strong>Forgetting summer overheating</strong> - excellent insulation works both
                ways
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A 4-bed Passivhaus-certified detached house. The architect-led PHPP calculation shows
              peak heat load 8 W/m² = 1,600 W total. The M&E designer, used to conventional
              dwellings, specifies a 6 kW air-source heat pump and full radiator distribution. The
              system is grossly oversized, will short-cycle, and SCOP will be poor.
            </>
          }
          whatToDo={
            <>
              Re-design M&E to match Passivhaus heat load. Options: (1) tiny output ASHP (2.5–3 kW,
              the smallest commercially available) feeding a single underfloor zone or
              low-temperature radiators; (2) electric direct (small underfloor mat or panel heaters)
              — simpler but loses the heat-pump SCOP advantage; (3) MVHR with post-heater (heat pump
              heats supply air) — elegant for super-low-load Passivhaus but uncommon in UK practice.
              Specify a buffer to manage the heat-pump cycling. Verify with detailed simulation.
            </>
          }
          whyItMatters={
            <>
              Conventional M&E sizing assumes conventional fabric. Apply it to Passivhaus and you
              over-size by 3–5×, with terrible operational efficiency. Fabric-first design demands
              M&E-first re-thinking. The smallest commercial heat pumps in the UK are still too
              large for many true Passivhaus dwellings — the supply chain is catching up.
            </>
          }
        />
