                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      ...
                      <li>• <strong>Hole diameter:</strong> Maximum 0.25 × joist depth</li>
                      <li>• <strong>Hole position:</strong> Between 0.25 and 0.4 × span from support</li>
                      <li>• <strong>Multiple holes:</strong> Minimum 3 × hole diameter spacing</li>
                    </ul>
                  </div>
                  <div>
