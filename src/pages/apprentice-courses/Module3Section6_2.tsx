...
import { ArrowLeft, ArrowRight, MapPin, Layers, Home, Drill } from 'lucide-react';
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <section className="mb-10">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Diagonal routes, shallow depths, unprotected cables outside
                  zones.
                </li>
                <li>
                  <strong>Use:</strong> 150mm safe zones, 50mm minimum depth, steel conduit
                  protection.
                </li>
                <li>
                  <strong>Check:</strong> Zone compliance, burial depth, mechanical protection
                  adequacy.
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
            ...
            <li>
              Understand the importance of accurate routing for future inspection and maintenance.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-10">
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <p className="text-xs sm:text-sm text-white mb-3">
                  <strong>Safe Zone Philosophy:</strong> Safe zones are predetermined areas where
                  cables are expected to be present. Anyone working on a building should assume
                  cables exist in these zones and take appropriate precautions. This predictability
                  is the key to preventing accidental damage during maintenance, renovation, or
                  decoration work.
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Logical routing paths:</strong> Direct connections between
                        accessories
                      </li>
                      <li>
                        * <strong>Structural boundaries:</strong> Related to building geometry
                      </li>
                      <li>
                        * <strong>Visual indicators:</strong> Connected to visible electrical
                        accessories
                      </li>
                      <li>
                        * <strong>Practical installation:</strong> Easy cable pulling routes
                      </li>
                      <li>
                        * <strong>Future identification:</strong> Predictable for maintenance work
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Pre-regulation era:</strong> Random cable routing caused injuries
                      </li>
                      <li>
                        * <strong>Industry feedback:</strong> Building trades requested predictable
                        zones
                      </li>
                      <li>
                        * <strong>European harmonisation:</strong> Consistent with CENELEC standards
                      </li>
                      <li>
                        * <strong>Practical experience:</strong> Refined through real-world
                        application
                      </li>
                      <li>
                        * <strong>Current best practice:</strong> Widely adopted across trades
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="p-4 bg-transparent border border-green-400/30 rounded-lg mb-4">
                <h5 className="font-medium text-green-400 mb-3">
                  Vertical Safe Zones - Detailed Specifications
                </h5>
                    ...
                    <tbody>
                      <tr>
                        <td className="border border-white/10 p-3">
                          <strong>Ceiling Line Zone</strong>
                        </td>
                        ...
                        <td className="border border-white/10 p-3">
                          Lighting circuits, ceiling feeds
                        </td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">
                          <strong>Corner Zone</strong>
                        </td>
                        ...
                        <td className="border border-white/10 p-3">
                          Distribution feeds, riser cables
                        </td>
                      </tr>
                      <tr>
                        <td className="border border-white/10 p-3">
                          <strong>Accessory Zone</strong>
                        </td>
                      ...
                      <tr className="bg-muted/5">
                        ...
                        <td className="border border-white/10 p-3">Horizontal around room</td>
                        <td className="border border-white/10 p-3">
                          Underfloor heating, skirting outlets
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-elec-yellow mb-3">
                  Horizontal Safe Zones and Cross-Connections
                </h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Accessory interconnection:</strong> Direct horizontal routes
                        between accessories
                      </li>
                      <li>
                        * <strong>Ring circuit routing:</strong> Horizontal paths around room
                        perimeter
                      </li>
                      <li>
                        * <strong>Switch drop connections:</strong> From ceiling lights to wall
                        switches
                      </li>
                      <li>
                        * <strong>Multi-gang accessory feeds:</strong> Between adjacent mounting
                        positions
                      </li>
                      <li>
                        * <strong>Data and power separation:</strong> Dedicated horizontal cable
                        routes
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Overlapping zones:</strong> Cable can be placed in intersection
                        areas
                      </li>
                      <li>
                        * <strong>Zone boundaries:</strong> Cables must remain within defined limits
                      </li>
                      <li>
                        * <strong>Change of direction:</strong> Only at zone intersections or
                        corners
                      </li>
                      <li>
                        * <strong>Multiple circuits:</strong> Segregation requirements still apply
                      </li>
                      <li>
                        * <strong>Future expansion:</strong> Consider space for additional circuits
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="mt-4 p-3 bg-white/5 rounded-lg">
                  ...
                  <p className="text-xs sm:text-sm text-white mb-2">
                    <strong>Example Room Analysis:</strong> A typical 4m x 3m room with a door,
                    window, and electrical accessories.
                  </p>
                  <div className="grid md:grid-cols-2 gap-4">
                    <ul className="space-y-1 text-sm">
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
              <h4 className="font-medium text-white mb-3">
                Engineering Basis for Depth Requirements
              </h4>
              <div className="p-4 bg-transparent border border-amber-400/30 rounded-lg mb-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Picture fixing:</strong> 25-40mm typical screw/nail penetration
                      </li>
                      <li>
                        * <strong>Shelf brackets:</strong> 50-75mm rawlplug and screw depth
                      </li>
                      <li>
                        * <strong>TV wall mounts:</strong> 60-100mm heavy-duty fixing depth
                      </li>
                      <li>
                        * <strong>Kitchen units:</strong> 40-60mm cabinet fixing screws
                      </li>
                      <li>
                        * <strong>Plasterboard drilling:</strong> 30-50mm typical overrun depth
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>50mm minimum:</strong> Protects against 95% of penetrations
                      </li>
                      <li>
                        * <strong>25mm depth:</strong> Only 60% protection level
                      </li>
                      <li>
                        * <strong>75mm depth:</strong> 99% protection but impractical
                      </li>
                      <li>
                        * <strong>Accident data:</strong> Most strikes occur 20-45mm depth
                      </li>
                      <li>
                        * <strong>Cost-benefit:</strong> 50mm provides optimal
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-elec-yellow mb-3">
                  Protection Methods for Non-Compliant Routing
                </h5>
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-white/10 text-sm">
                    <thead>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border border-white/10 p-3">
                          Requires earthing, expansion joints
                        </td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">
                          <strong>Steel Trunking</strong>
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="border border-white/10 p-3">
                          Requires appropriate termination
                        </td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">
                        ...
                        <td className="border border-white/10 p-3">
                          30mA or less, does not prevent damage
                        </td>
                      </tr>
                      <tr>
                        <td className="border border-white/10 p-3">
                          <strong>Plastic Capping</strong>
                        </td>
                        ...
                        <td className="border border-white/10 p-3">
                          Not acceptable as sole protection
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div className="p-4 bg-transparent border border-cyan-400/30 rounded-lg">
                <h5 className="font-medium text-cyan-400 mb-3">
                  Installation Depth Measurement and Verification
                </h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Surface reference:</strong> Measure from final finished surface
                      </li>
                      <li>
                        * <strong>Multi-layer walls:</strong> Consider plaster, tiles, cladding
                      </li>
                      <li>
                        * <strong>Cable diameter:</strong> Measure to nearest surface of cable
                      </li>
                      <li>
                        * <strong>Conduit systems:</strong> Measure to outer surface of protection
                      </li>
                      <li>
                        * <strong>Documentation:</strong> Record actual depths during installation
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Physical measurement:</strong> Depth gauge during installation
                      </li>
                      <li>
                        * <strong>Cable detection:</strong> Electronic locators for verification
                      </li>
                      <li>
                        * <strong>Photographic records:</strong> Document before wall closure
                      </li>
                      <li>
                        * <strong>As-built drawings:</strong> Mark actual cable positions
                      </li>
                      <li>
                        * <strong>Handover documentation:</strong> Provide depth confirmation
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-transparent border border-green-400/30 rounded-lg mb-4">
                <h5 className="font-medium text-green-400 mb-3">
                  Floor Construction Methods and Cable Routing
                </h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Above joists:</strong> Route in notches or above top surface
                      </li>
                      <li>
                        * <strong>Through joists:</strong> Drill at neutral axis (mid-depth)
                      </li>
                      <li>
                        * <strong>Hole diameter:</strong> Maximum 0.25 x joist depth
                      </li>
                      <li>
                        * <strong>Hole position:</strong> Between 0.25 and 0.4 x span from support
                      </li>
                      <li>
                        * <strong>Multiple holes:</strong> Minimum 3 x hole diameter spacing
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Screed routing:</strong> Install before concrete pour
                      </li>
                      <li>
                        * <strong>Conduit protection:</strong> Prevent concrete ingress
                      </li>
                      <li>
                        * <strong>Expansion joints:</strong> Accommodate building movement
                      </li>
                      <li>
                        * <strong>Reinforcement coordination:</strong> Avoid structural steel
                        conflict
                      </li>
                      <li>
                        * <strong>Load bearing:</strong> Consider heavy equipment loading
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-elec-yellow mb-3">
                  Ceiling and Roof Space Applications
                </h5>
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Zone compliance:</strong> Routes must respect bathroom zones
                      </li>
                      <li>
                        * <strong>Waterproof protection:</strong> IP-rated cable glands
                      </li>
                      <li>
                        * <strong>Indirect routing:</strong> Avoid direct paths through wet zones
                      </li>
                      <li>
                        * <strong>RCD protection:</strong> Required for all circuits in bathroom
                      </li>
                      <li>
                        * <strong>Equipotential bonding:</strong> Cable routes to bonding points
                      </li>
                    </ul>
                  </div>
                  <div>
                    <h6 className="font-medium text-white mb-2">
                      Commercial and Industrial Routing
                    </h6>
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Surface containment:</strong> Preferred over concealed routing
                      </li>
                      <li>
                        * <strong>Cable segregation:</strong> Power, data, control system separation
                      </li>
                      <li>
                        * <strong>Access requirements:</strong> Maintenance and modification needs
                      </li>
                      <li>
                        * <strong>Fire protection:</strong> Enhanced fire stopping requirements
                      </li>
                      <li>
                        * <strong>Expansion capability:</strong> Space for additional circuits
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="mt-4 p-3 bg-white/5 rounded-lg">
                  <h6 className="font-medium text-white mb-2">
                    Case Study: Multi-Storey Office Building
                  </h6>
                  <p className="text-xs sm:text-sm text-white mb-2">
                    <strong>Project Requirements:</strong> 4-storey office with mixed services and
                    future flexibility needs.
                  </p>
                  <div className="grid md:grid-cols-2 gap-4">
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Riser strategy:</strong> Dedicated service shafts on each floor
                      </li>
                      <li>
                        * <strong>Horizontal distribution:</strong> Raised floor and ceiling voids
                      </li>
                      <li>
                        * <strong>Zone planning:</strong> Power and data service zones
                      </li>
                      <li>
                        * <strong>Fire compartmentation:</strong> Fire-stopped penetrations
                      </li>
                    </ul>
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Access planning:</strong> Removable ceiling panels at key points
                      </li>
                      <li>
                        * <strong>Future-proofing:</strong> 40% spare capacity in all routes
                      </li>
                      <li>
                        * <strong>Documentation:</strong> CAD drawings with service coordinates
                      </li>
                      <li>
                        * <strong>Compliance:</strong> BS 7671 and building regulations integration
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Are safe zones the same for internal and external walls?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: Yes. BS 7671 applies safe zones to both internal and external walls to ensure
                consistent protection regardless of wall type or construction method.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Does an RCD make it safe to route cables anywhere?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: No. RCD protection reduces shock risk but does not prevent cable damage. Cables
                must still be in safe zones or mechanically protected - RCD is supplementary
                protection only.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Can safe zones be ignored in industrial wiring?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: No. While industrial installations often use surface containment instead of
                concealed wiring, safe zone principles still apply where cables are concealed in
                walls or floors.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: What if I need to route diagonally between accessories?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: Diagonal routing is prohibited as it's unpredictable. Use vertical and horizontal
                safe zone routes, even if this requires more cable length and installation time.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 bg-transparent border-l-2 border-elec-yellow rounded-lg border border-white/10">
            <p className="text-white">
              ...
              applying these requirements protects both the electrical installation and future
              building occupants from the hazards of accidental cable strikes.
            </p>
          </div>
        </section>
