...
const DESCRIPTION =
  'Identify series, parallel and mixed circuits on site for fault finding and planning. BS 7671 aligned guidance.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      'All loads fail together',
      'Single cable between loads',
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'A single cable between loads',
      'All loads losing power when one fails',
      'Independent operation of each load',
      'Always using ring connections',
    ],
    correctAnswer: 2,
    explanation:
      'In parallel, each branch is supplied directly, so other loads keep working if one fails.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    options: [
      'Junction box with multiple terminals',
      'Ring main setup',
      'One cable in, one out, no branches',
      'Each load has a separate fuse',
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      ...
      "You'll impress the inspector",
      'It helps avoid unnecessary rewiring',
  ...
  },
  {
    id: 6,
    question:
      'At a socket MCB, two conductors in both line and neutral terminals usually indicate:',
    options: ['A spur radial', 'A ring final circuit', 'A series circuit', 'A three-phase circuit'],
    correctAnswer: 1,
    explanation:
      'Two conductors returning to the same protective device typically indicate a ring final.',
  },
  {
    id: 7,
    ...
    options: [
      ...
      'Pull the main fuse',
      'Disconnect CPCs to avoid tripping RCDs',
      'Increase the breaker rating',
    ],
    correctAnswer: 0,
    explanation:
      'Follow safe isolation procedures (prove your tester on a known source, isolate, test dead).',
  },
  {
    id: 8,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Ring finals return to the same protective device, giving two conductors at each terminal.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Multimeter continuity testing can trace circuit paths and identify series/parallel arrangements.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Never work on live circuits. Always follow safe isolation procedures: prove your tester, isolate the circuit, test dead, then trace wiring. Use visual inspection first - look at CU terminations and junction patterns.',
  },
  {
    question: "What's the quickest way to spot a ring final circuit?",
    answer:
      'At the consumer unit, ring finals have two conductors at each terminal (line, neutral, earth). The conductors form a complete loop from the protective device and back again.',
  },
  {
    question: 'Can I use a multimeter to identify circuit types?',
    answer:
      'Yes, but only after safe isolation. Use continuity testing to trace paths between components. Series will show continuity through all components in sequence, parallel will show direct paths to each branch.',
  },
  {
    question: 'What if I find mixed series and parallel in one installation?',
    answer:
      "This is common - for example, parallel branches each containing series-connected components. Map the circuit carefully and consider each section's behaviour separately.",
  },
  {
    question: 'How does circuit type affect fault finding?',
    answer:
      'Series circuits: one fault affects all components. Check continuity through the entire chain. Parallel circuits: isolate each branch to identify which has the fault without affecting others.',
  },
  {
    question: 'Are there any visual clues without opening accessories?',
    answer:
      'Yes - observe failure patterns (does one fault affect all loads?), cable routing (single chain vs multiple branches), and protective device arrangements at the consumer unit.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Series clues:</strong> Single path, daisy-chain wiring, all fail together
              </li>
              <li>
                <strong>Parallel clues:</strong> Multiple branches, independent operation, junction
                boxes
              </li>
              <li>
                <strong>Ring finals:</strong> Two conductors at MCB terminals, loop back to CU
              </li>
              <li>
                <strong>Safety first:</strong> Always isolate and prove dead before investigating
              </li>
              <li>
                <strong>BS 7671:</strong> Use continuity testing and visual inspection methods
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> CU terminations, junction patterns, failure modes
              </li>
              <li>
                <strong>Use:</strong> Fault diagnosis, circuit mapping, modification planning
              </li>
              <li>
                <strong>Apply:</strong> Safe isolation, continuity testing, circuit tracing
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Circuit identification starts with systematic observation. Learn to read the visual
              clues that reveal circuit topology without energised testing.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Series circuit indicators:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Daisy-chain wiring:</strong> Single cable in, single cable out at each
                  component
                </li>
                <li>
                  <strong>No junction boxes:</strong> Components connected end-to-end
                </li>
                <li>
                  <strong>Failure mode:</strong> One component failure stops entire circuit
                </li>
                <li>
                  <strong>Common locations:</strong> Decorative lighting, training boards
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Junction boxes:</strong> Multiple terminations at distribution points
                </li>
                <li>
                  <strong>Independent operation:</strong> Components work separately
                </li>
                <li>
                  <strong>Multiple paths:</strong> Several cables from one supply point
                </li>
                <li>
                  <strong>Common locations:</strong> Socket outlets, lighting points, appliance
                  circuits
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The consumer unit tells the story of circuit configuration. Learn to read termination
              patterns to identify circuit types quickly.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Two conductors:</strong> Two line conductors at MCB/RCBO terminal
                </li>
                <li>
                  <strong>Loop back:</strong> Circuit leaves CU and returns to same protective
                  device
                </li>
                <li>
                  <strong>Continuity test:</strong> End-to-end resistance on each conductor
                </li>
                <li>
                  <strong>Common rating:</strong> Usually 32A for socket rings
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Single conductors:</strong> One line conductor at protective device
                </li>
                <li>
                  <strong>Tree structure:</strong> Branches at accessories, not at CU
                </li>
                <li>
                  <strong>Various ratings:</strong> 16A, 20A, 32A depending on application
                </li>
                <li>
                  <strong>Dead-end test:</strong> No return path to CU
                </li>
              </ul>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Practical check:</strong> Ring finals show low resistance (typically less than
              0.05 ohms) between opposite ends when tested at CU. Radials show open circuit at far
              end.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-6 leading-relaxed">
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <ul className="text-white space-y-0.5">
                    ...
                    <li>
                      <strong>Lighting:</strong> Radial circuits with parallel branches
                    </li>
                    <li>
                      <strong>Cooker:</strong> 32A/40A radial to control unit
                    </li>
                    <li>
                      <strong>Shower:</strong> Dedicated radial circuit
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="text-white space-y-0.5">
                    ...
                    <li>
                      <strong>Switching:</strong> Series switches controlling parallel loads
                    </li>
                    <li>
                      <strong>Controls:</strong> Series sensing in control circuits
                    </li>
                    <li>
                      <strong>Decorative:</strong> Low-voltage festoon lighting
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div>
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Commercial/Industrial Patterns
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Distribution boards:</strong> Always radial feeds from main panels
                </li>
                <li>
                  <strong>Lighting banks:</strong> Parallel circuits with series switching elements
                </li>
                <li>
                  <strong>Motor circuits:</strong> Individual radial supplies for independent
                  control
                </li>
                <li>
                  <strong>Emergency systems:</strong> Parallel for redundancy, series for monitoring
                </li>
                <li>
                  <strong>Data/communication:</strong> Often series (daisy-chain) topology
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Circuit recognition is essential for effective fault diagnosis and compliance with BS
              7671 testing requirements.
            </p>
