...
const DESCRIPTION =
  'Know what to do when alarms sound, how to evacuate safely, roles and responsibilities, and post-incident actions.';
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Common site emergencies include fire, electric shock, gas leaks, explosions, structural failure, serious injury, and chemical spills.',
    },
    {
      id: 2,
      ...
      correctAnswer: 1,
      explanation:
        'When an evacuation alarm sounds, stop work immediately. Do not waste time investigating or collecting items - evacuate using the nearest safe exit.',
    },
    {
      id: 3,
      ...
      correctAnswer: 2,
      explanation:
        'After evacuating, all workers must report to the designated assembly point where a roll call will be conducted to ensure everyone is accounted for.',
    },
    {
      id: 4,
      ...
      correctAnswer: 2,
      explanation:
        'Never delay evacuation to collect tools, personal items, or equipment. Lives are more important than possessions - these can be replaced.',
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        'False. When an emergency alarm sounds, evacuate immediately without waiting for permission. Every second counts in an emergency situation.',
    },
    {
      id: 6,
      ...
      correctAnswer: 1,
      explanation:
        'When the evacuation alarm sounds, stop work immediately and evacuate using the nearest safe exit. Do not delay for any reason.',
    },
    {
      id: 7,
      ...
      correctAnswer: 2,
      explanation:
        'Assembly points are designated areas where everyone gathers so that a roll call can be conducted to ensure all personnel are accounted for and safe.',
    },
    {
      id: 8,
      ...
      correctAnswer: 1,
      explanation:
        'Fire wardens or designated emergency marshals are responsible for conducting roll calls and reporting headcounts to the incident commander.',
    },
    {
      id: 9,
      question:
        'In an electrical incident with a casualty, what must you do BEFORE providing first aid?',
      options: [
        'Call 999 first',
      ...
      correctAnswer: 2,
      explanation:
        "Before providing first aid to an electrical incident casualty, you must isolate the electrical supply if it's safe to do so. Never touch the casualty while they may still be energised.",
    },
    {
      id: 10,
      ...
      correctAnswer: 2,
      explanation:
        'Emergency procedure records, accident book entries, and related documentation must be kept for at least 3 years as required by health and safety regulations.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-white text-sm leading-relaxed">
                Site emergencies like fire, electric shock, and gas leaks can happen without
                warning. When they do, lives depend on following emergency procedures immediately.
                This covers alarm responses, evacuation routes, key roles (fire wardens, first
                aiders), and post-incident actions including roll calls and reporting.
              </p>
            </div>
            <div className="bg-card border border-elec-yellow/30 rounded-lg p-4">
              ...
              <div className="space-y-2 text-white text-sm">
                <p>
                  <span className="text-elec-yellow">Spot:</span> Alarm types, exit signage,
                  assembly point, fire wardens/first aiders
                </p>
                <p>
                  <span className="text-elec-yellow">Use:</span> Stop work, evacuate via nearest
                  exit, no lifts/no belongings, go to assembly point, wait for roll call
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="flex items-start gap-3">
              ...
              <span className="text-white">
                Understand emergency procedure content and legal expectations
              </span>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span className="text-white">
                Follow evacuation routes and roles (fire wardens, roll call)
              </span>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span className="text-white">
                Respond correctly to fire, electrical, and gas incidents
              </span>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span className="text-white">
                Complete post-incident actions (roll call, preserve scene, reporting/RIDDOR)
              </span>
            </div>
          </div>
        </Card>
          ...
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="flex-1">
              <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">
                Emergency Procedures Overview & Legal Purpose
              </h2>
            </div>
          </div>
          <div className="ml-12 space-y-4">
            <p className="text-white">
              Emergency procedures are written plans that specify actions to take during site
              emergencies. They exist to protect life, minimise harm, ensure swift professional
              help, and maintain accountability for all personnel.
            </p>
        ...
        <div className="mb-8 border-l-4 border-orange-500 p-6 bg-card rounded-lg">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">
                Evacuation Planning & Roles
              </h2>
              <p className="text-white">
                Effective evacuation requires clear routes, visible signage, designated assembly
                points, and trained personnel with specific roles. Personal Emergency Evacuation
                Plans (PEEPs) may be needed for individuals with mobility limitations.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-6">
            <div className="bg-muted/50 border border-border rounded-lg p-4">
              ...
              <ul className="space-y-2 text-white text-sm">
                <li>
                  • <strong>Fire wardens:</strong> Lead evacuation, check areas
                </li>
                <li>
                  • <strong>Marshals:</strong> Guide people to assembly points
                </li>
                <li>
                  • <strong>First aiders:</strong> Assist injured during evacuation
                </li>
                <li>
                  • <strong>Supervisors:</strong> Account for their teams
                </li>
              </ul>
            </div>
            <div className="bg-muted/50 border border-border rounded-lg p-4">
        ...
        <div className="mb-8 border-l-4 border-indigo-500 p-6 bg-card rounded-lg">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">
                Incident Response Basics (Electrical/Fire/Gas)
              </h2>
              <p className="text-white">
                Different emergency types require specific response procedures. Knowing how to
                respond safely to fire, electrical incidents, and gas leaks can save lives and
        ...
        <div className="mb-8 border-l-4 border-elec-yellow p-6 bg-card rounded-lg">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-semibold text-white mb-2">
                Alarms, Communication & Drills
              </h2>
              <p className="text-white">
                Effective emergency response relies on clear alarm systems, reliable communication
                methods, accurate muster procedures, and regular practice through drills that help
          ...
          <div className="space-y-6">
            <div className="bg-muted/50 border border-border rounded-lg p-4">
              ...
              <ul className="space-y-2 text-white text-sm">
                <li>
                  • <strong>Fire alarms:</strong> Continuous siren or bells
                </li>
                <li>
                  • <strong>Gas alarms:</strong> Often different tone/pattern from fire
                </li>
                <li>
                  • <strong>Tannoy/Radio:</strong> Clear instructions and updates
                </li>
                <li>
                  • <strong>Hand signals:</strong> When noise levels prevent verbal communication
                </li>
                <li>
                  • <strong>Site-specific signals:</strong> Air horns, klaxons for large sites
                </li>
              </ul>
            </div>
        ...
        <div className="mb-8 border-l-4 border-slate-500 p-6 bg-card rounded-lg">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-white">
                Post-incident actions ensure accountability, preserve evidence for investigation,
                maintain legal compliance, and help prevent similar occurrences. Proper
                record-keeping and reporting are essential legal requirements.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-muted/50 border border-border rounded-lg p-4">
              <h3 className="font-semibold text-white mb-3">
                Legal Record-Keeping (3 Years Minimum)
              </h3>
              <ul className="space-y-2 text-white text-sm">
        ...
        <Card className="p-6 bg-card border-border/20 mb-8">
          ...
          <div className="bg-card border border-amber-400/30 rounded-lg p-6 mb-6">
            <h3 className="font-semibold text-white mb-3">
              Scenario: Electrical Panel Smoke Detection
            </h3>
            <p className="text-white mb-4">
              During routine electrical work on a commercial site, a worker noticed smoke coming
              from a main distribution panel. The fire alarm was triggered, and emergency procedures
              were activated immediately.
            </p>
          </div>
          ...
          <div className="bg-card border border-green-400/30 rounded-lg p-4">
            ...
            <p className="text-white text-sm">
              Quick evacuation prevented potential injuries from electrical fire or explosion. Clear
              role assignments ensured systematic area checking and accurate roll call. Proper
              electrical isolation by a competent person prevented escalation. The incident
              demonstrated that well-practiced procedures save lives when every second counts.
            </p>
          </div>
        </Card>
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-elec-yellow pl-4">
              <h3 className="font-semibold text-white mb-2">
                Can I grab my personal items during evacuation?
              </h3>
              <p className="text-white text-sm">
                No. Never delay evacuation to collect personal belongings, tools, or equipment.
                Lives are more important than possessions, and these can be replaced. Every second
                counts in an emergency.
              </p>
            </div>
            <div className="border-l-4 border-elec-yellow pl-4">
              <h3 className="font-semibold text-white mb-2">
                Can I use the lift during evacuation?
              </h3>
              <p className="text-white text-sm">
                Never use lifts during emergency evacuation. Power failures can trap people, and
                lifts may automatically return to ground floor in fire mode. Always use stairs, even
                if it takes longer.
              </p>
            </div>
            <div className="border-l-4 border-elec-yellow pl-4">
              ...
              <p className="text-white text-sm">
                Only when the incident commander (usually fire service or senior site management)
                gives the "all clear." Never re-enter before official authorisation, even if the
                alarm stops.
              </p>
            </div>
            <div className="border-l-4 border-elec-yellow pl-4">
              <h3 className="font-semibold text-white mb-2">
                How are visitors accounted for during evacuation?
              </h3>
              <p className="text-white text-sm">
                Sites must maintain visitor sign-in/out books or electronic systems. Fire wardens
                use these to account for visitors during roll call. Visitors should be inducted on
                emergency procedures upon arrival.
              </p>
            </div>
            <div className="border-l-4 border-elec-yellow pl-4">
              <h3 className="font-semibold text-white mb-2">
                What if someone is missing at roll call?
              </h3>
              <p className="text-white text-sm">
                Report missing persons immediately to the incident commander. Provide last known
                location and any relevant medical information. Never re-enter to search - this is a
                job for emergency services with proper equipment.
              </p>
            </div>
            <div className="border-l-4 border-elec-yellow pl-4">
              <h3 className="font-semibold text-white mb-2">
                Do evacuation drills count as real training records?
              </h3>
              <p className="text-white text-sm">
                Yes, but separate formal training should also be provided. Drills are practical
                exercises, while training covers procedures, responsibilities, and emergency
                response theory. Both are important for compliance.
              </p>
            </div>
          </div>
        </Card>
