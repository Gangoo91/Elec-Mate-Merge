...
const sections = [
  {
    ...
    icon: Calendar,
    description: 'PPM principles, scheduling, records, lubrication and inspection routines.',
  },
  {
    id: 2,
    ...
    icon: Activity,
    description:
      'Visual inspection, thermal imaging, vibration analysis and predictive maintenance.',
  },
  {
    id: 3,
    title: 'Fault finding and diagnostics',
    icon: Search,
    description: 'Systematic diagnostics, test instruments, motor faults and control circuits.',
  },
  {
    id: 4,
    title: 'Repair and replacement procedures',
    icon: Wrench,
    description: 'Safe isolation, component replacement, cable jointing and recommissioning.',
  },
  {
    id: 5,
    title: 'Testing and inspection',
    icon: TestTube,
    description: 'Visual inspections, continuity, insulation resistance and functional testing.',
  },
  {
    id: 6,
    ...
    icon: FileX,
    description:
      'Identifying underlying failures, 5 Whys, fishbone diagrams and corrective actions.',
  },
  {
    id: 7,
    title: 'Reliability-centred maintenance',
    icon: Settings,
    description: 'RCM principles, balancing maintenance types and criticality analysis.',
  },
];
...
export default function MOETModule4() {
  useSEO({
    ...
    description:
      'PPM, condition monitoring, fault diagnostics, repairs, testing, root cause analysis and reliability-centred maintenance.',
  });
