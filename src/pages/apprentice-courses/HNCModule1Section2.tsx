    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Develop competence in identifying hazards, assessing risks and producing professional RAMS
          documentation
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the systematic approach to risk assessment used throughout the
          building services industry - from initial hazard identification through to producing
          comprehensive Risk Assessments and Method Statements (RAMS) that ensure safe working
