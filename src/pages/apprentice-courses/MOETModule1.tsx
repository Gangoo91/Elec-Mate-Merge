...
const sections = [
  {
    ...
    icon: Shield,
    description:
      'Permits to work, isolation, lock-out tag-out, work at height and confined spaces.',
  },
  {
    id: 2,
    title: 'Electrical safety',
    icon: Zap,
    description: 'Electrical dangers, safe tool use, PPE, approach distances and earthing.',
  },
  {
    id: 3,
    title: 'Risk assessment and method statements',
    icon: FileCheck,
    description: 'Hazard identification, evaluation, controls and dynamic assessments.',
  },
  {
    id: 4,
    title: 'Regulations and standards',
    icon: BookOpen,
    description: 'HSWA, Electricity at Work, BS 7671, PUWER, LOLER and industry guidance.',
  },
  {
    id: 5,
...
export default function MOETModule1() {
  useSEO({
    ...
    description:
      'Safe systems of work, electrical safety, RAMS, regulations, environment and emergency procedures for maintenance operations.',
  });
