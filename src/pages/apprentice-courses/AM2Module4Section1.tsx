...
const AM2Module4Section1 = () => {
  ...
  const quickCheckQuestions: Array<{
    ...
    },
    {
      ...
      options: ['500V DC', '1000V DC', '250V DC', '100V DC'],
      correctIndex: 0,
      explanation:
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ['0.72Ω', '1.44Ω (pre-A4 figure)', '1.37Ω', '2.87Ω'],
      correctAnswer: 2,
      explanation:
    ...
    },
    {
      ...
      options: ['500V DC', '1000V DC', '250V DC', '230V AC'],
      correctAnswer: 0,
      explanation:
    ...
    },
    {
      ...
      options: ['220V - 240V', '225V - 235V', '207V - 253V', '200V - 250V'],
      correctAnswer: 2,
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Master the correct testing sequence for AM2 electrical assessment as per IET Guidance Note
          3 and BS 7671 Part 6 - ensure safety and compliance through systematic testing procedures.
        </p>
        ...
        >
          ...
          <p>
            ...
            500V. Test between all conductors and to earth. Test Sequence: Line to Neutral, Line to
            Earth, Neutral to Earth. Minimum Values: 1.0 MΩ for most circuits, 0.5 MΩ for fire
            alarm/SELV. AM2 Critical: Disconnect electronic equipment, remove lamps where practical.
          </p>
          <p>
          ...
          <p>
            <strong>5. Earth Electrode Resistance (where applicable).</strong> For TT systems only.
            Test electrode resistance using appropriate earth tester. Maximum Values: Typically 200Ω
            for TT systems with 30mA RCD protection.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              the dead-test list. The reg names exactly the two continuity tests AM2 expects you to
              perform — the protective conductor path AND, on every ring, the live conductors
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              <strong>500 V DC</strong>, minimum <strong>1 MΩ</strong>. SELV/PELV: 250 V DC, 0.5 MΩ.
              Above 500 V: 1000 V DC. On AM2 day, set the MFT to 500 V DC for the standard rig and
              disconnect current-using equipment first — Reg 643.3.3 covers the 250 V DC two-stage
              method where electronics cannot be cleanly removed.
            </>
          }
        ...
        >
          ...
          <p>
            <strong>8. Voltage Measurements.</strong> Verify supply voltage at consumer unit and at
            extremities of circuits. Acceptable Range: 230V ±10% (207V - 253V). 3-Phase: 400V ±10%
            (360V - 440V). AM2 Requirement: Record voltage drop calculations where significant.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              On a TN system (which is what most AM2 rigs simulate) you prove ADS by measuring earth
              fault loop impedance. Ze first at the origin, then Zs at the furthest point of each
              circuit. Compare against Table 41.3 — and apply the 0.8 rule (measured Zs at ambient ≤
              0.8 × tabulated max) so the conductor still operates the device when warm.
            </>
          }
        ...
        >
          ...
          <p>
            <strong>RCD Testing — Trip Time.</strong> Test at ½×IΔn (should not trip — confirms RCD
            won't nuisance-trip). Test at 1×IΔn (general-purpose non-delay RCD must trip within
          ...
          <p>
            ...
            impedance) first. Measure Zs at furthest points on each circuit. Verify Zs is less than
            or equal to maximum values in BS 7671:2018+A4:2026 Table 41.3. Account for temperature
            correction factors.
          </p>
        </ConceptBlock>
        ...
        <div className="my-6">
          ...
          <p className="text-xs sm:text-sm text-white/80 mb-3">
            Use Ohm's Law to sanity-check your Zs reading at the furthest point. Worked example: U0
            = 230 V, target fault current Ia for a B32 = 230 / 1.37 ≈ 168 A → Zs(max) ≈ 1.37 Ω (BS
            7671 A4:2026 Table 41.3). Measured Zs must be at or below 0.8 × table max (≈ 1.10 Ω for
            B32) to allow for hot-cable correction. Plug in V and your measured Zs to read the
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              <strong>B32 = 1.37 Ω</strong> · B40 = 1.09 Ω. C-curve roughly halves these. Then apply
              the 0.8 rule for ambient measurement → measured Zs on a B32 must be ≤ 1.10 Ω. Drill
              these numbers before AM2 day so you can write them without looking them up.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              Record the measured value exactly — 1.18 Ω. State the Table 41.3 max (1.37 Ω) and the
              0.8 acceptance threshold (1.10 Ω) on your working. Flag it as a non-compliance — the
              cable is fine when cold but pushes over the hot-corrected limit. On a real EICR that's
              a C2 (potentially dangerous). On AM2 day, recording it correctly with the figure and
              the reasoning earns marks. Hiding it = fail.
            </>
          }
          whyItMatters={
            <>
              The 0.8 rule isn't paranoia — it's the temperature-correction factor that turns a cold
              Zs reading into the worst-case hot-cable Zs the breaker has to clear. Miss it and you
              certify a circuit that meets paper limits cold but fails to disconnect within ADS time
              once the cable is loaded.
            </>
          }
        />
        ...
        >
          ...
          <p>
            <strong>Professional Standards Expected:</strong> Methodical approach matching industry
            standards. Clear understanding of safety implications. Accurate documentation as work
            progresses. Professional communication with assessors. Realistic timeframes for each
            test procedure. Appropriate response to unexpected results.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            appropriate PPE, and risk assessment procedures consistently throughout the assessment.
          </p>
          <p>
          ...
          <p>
            <strong>Correct Equipment Use.</strong> Appropriate test instruments, correct settings,
            proper lead connections, and understanding equipment limitations.
          </p>
          <p>
            <strong>Accurate Documentation.</strong> Recording results systematically, understanding
            what values mean, and identifying when results require investigation.
          </p>
          <p>
            <strong>Professional Communication.</strong> Explaining procedures, discussing findings,
            and demonstrating understanding of regulations and standards.
          </p>
          <p>
            <strong>Common Failure Points:</strong> Attempting live tests before completing all dead
            tests. Inadequate isolation procedures or failing to prove dead. Using incorrect test
            voltages or equipment settings. Poor documentation or inability to interpret results.
            Unsafe practices or inadequate risk assessment.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            <strong>Next Steps:</strong> Having mastered the testing sequence, you should now focus
            on practical application and timing. The next section covers specific test procedures
            and common scenarios you will encounter during your AM2 assessment.
          </p>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            ...
            {
              question: 'What test voltage do I use if the rig has electronic equipment connected?',
              answer:
