...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['39.5 W/m²', '69.8 W/m²', '49.6 W/m²', '59.2 W/m²'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['3.50 m²·K/W', '0.35 m²·K/W', '0.0035 m²·K/W', '2.86 m²·K/W'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['2.07 m²·K/W', '1.96 m²·K/W', '1.48 m²·K/W', '0.69 m²·K/W'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['50 times worse', '35 times worse', '1430 times worse', 'Similar performance'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['0.55 W/m²·K', '0.35 W/m²·K', '0.18 W/m²·K', '0.26 W/m²·K'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Part L is the regulatory anchor for conduction calculations on a building services
              project. Insulation thickness on pipework and ductwork is not optional — it is a
              Building Regulations submission item, evidenced against BS 5422 and the
              project&rsquo;s as-built model.
            </>
          }
        ...
        >
          <p>
            Conduction is heat transfer through a material by direct molecular contact. Molecules in
            hotter regions vibrate more energetically, transferring kinetic energy to adjacent
        ...
        >
          <p>
            ...
            time) or transient (temperatures changing with time). Building services design typically
            uses steady-state analysis for sizing, but transient effects influence real-world
            performance.
          </p>
          <p>
        ...
        >
          ...
          <p>
            ...
            m²·K/W. Higher = better insulation. Thermal resistance is the 'opposition' to heat flow
            - the thermal equivalent of electrical resistance.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              R_total = 0.13 + 0.132 + 1.429 + 0.526 + 0.023 + 0.04 = <strong>2.28 m²·K/W</strong>
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Wall ties</strong> - metal penetrating cavity. Mitigation: stainless/plastic
              ties, thermal clips
            </li>
            <li>
        ...
        >
          <p>
            <strong>Pipe insulation:</strong> Pipe insulation is essential for LPHW/MTHW systems to
            minimise distribution losses and maintain water temperatures. BS 5422 specifies minimum
          ...
          <p>
            <strong>Example - pipe heat loss calculation:</strong> Calculate the heat loss per metre
            from a 42mm OD LPHW pipe at 80°C in a 20°C plantroom, with and without 25mm insulation
            (k = 0.035 W/m·K).
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Uninsulated (simplified bare pipe): q ≈ π × D × h × dT ≈ 3.14 × 0.042 × 10 × 60</li>
            <li>
              q ≈ <strong>79 W/m</strong>
            </li>
            <li>
              Insulated (cylindrical coordinates): R_ins = ln(r2/r1) / (2 × π × k) = ln(46/21) / (2
              × 3.14 × 0.035)
            </li>
          ...
          <p>
            <strong>Wall construction for Building Regulations:</strong> To achieve U ≤ 0.26 W/m²·K
            (Building Regs Part L), typical constructions require:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You are specifying the insulation thickness for a 100 mm steel LTHW flow main running
              through an unheated plant room. The fluid runs at 80 °C, the ambient is 10 °C, and the
              project is targeting Part L 2021 compliance.
            </>
          }
          whatToDo={
            <>
              Apply BS 5422 maximum permitted heat loss (W/m) for the pipe size and temperature
              class. Pick a phenolic or mineral-wool insulation with appropriate k value (typically
              0.025-0.040 W/m·K). Calculate the radial heat loss using the cylindrical conduction
              equation (Q = 2πLk(T₁-T₂)/ln(r₂/r₁)). Iterate thickness until Q is below the BS 5422
              limit. Document the calculation in the Part L submission.
            </>
          }
          whyItMatters={
            <>
              Under-insulated pipework wastes energy for the building&rsquo;s 25-year life and
              breaches Part L. Over-insulating wastes capital. The Fourier-law calculation gives the
              defendable answer.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Convection</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
