    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Understand Part L requirements for conservation of fuel and power in new and existing
          buildings
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the Building Regulations Approved Document Part L, which sets energy
          efficiency requirements for buildings. You'll learn about compliance routes, fabric
          standards, services requirements and the documentation needed to demonstrate compliance.
        </p>
