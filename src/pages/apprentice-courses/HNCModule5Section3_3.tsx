...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Weekly', 'Daily', 'Quarterly', 'Monthly'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['EV ÷ PV', 'AC ÷ EV', 'PV ÷ AC', 'BAC ÷ EV'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['£45,000 profit', '£5,000 profit', '6.25% margin', '£40,000 profit'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Labour', 'Plant hire', 'Preliminaries', 'Management costs'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['£1,125,000', '£900,000', '£1,000,000', '£1,250,000'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Cost monitoring, progress reporting, forecasting techniques, cost value reconciliation and
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Under NEC, payment is based on actual progress (PWDD). Robust cost control with
              monthly EVM and CVR is the basis of accurate interim payment, accurate cost reporting
              and accurate compensation event assessment. Without it, you cannot answer the PM's
              questions at the monthly meeting.
            </>
          }
        ...
        <ConceptBlock title="Cost Monitoring Fundamentals">
          <p>
            Effective cost control requires systematic monitoring throughout the project lifecycle.
            For building services installations, this means tracking labour, materials, plant, and
            subcontract costs against the budget and work completed.
          </p>
          <p>
        ...
        <ConceptBlock title="Cost Value Reconciliation (CVR)">
          <p>
            Cost Value Reconciliation is the UK construction industry's standard method for tracking
            project financial performance. It compares the value of work completed against the costs
            incurred to determine whether the project is making or losing money.
          </p>
          <p>
            <strong>CVR Basic Formula:</strong> Margin = Value - Cost. Where Value = certified work
            + variations + dayworks - retentions.
          </p>
          <p>
        ...
        <ConceptBlock title="Earned Value Management (EVM)">
          ...
          <p>
            <strong>Performance Indices — Cost Performance Index (CPI):</strong> CPI = EV / AC. CPI
            = 1.0: On budget; CPI &gt; 1.0: Under budget; CPI &lt; 1.0: Over budget.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Variance at Completion (VAC):</strong> BAC - EAC — Positive = forecast under
              budget
            </li>
          </ul>
          <p>
            <strong>Building Services Example — Office Electrical Installation:</strong> Month 4 of
            a £600,000 electrical installation:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Forecasting and Progress Reporting">
          ...
          <p>
            <strong>
              Variance Analysis — Common Causes on M&E Projects (Type — Causes — Action):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Labour overspend:</strong> Low productivity, rework, overtime — Method review,
              resource change
            </li>
            <li>
          ...
          <p>
            <strong>Reporting tip:</strong> Present trends graphically — an S-curve showing planned
            vs actual progress, or a chart of CPI/SPI over time, communicates status faster than
            tables alone.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Example 2 — EVM Performance Analysis:</strong> A mechanical installation has BAC
            = £800,000, PV = £400,000, EV = £350,000, AC = £380,000. Calculate CPI, SPI, and EAC.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Example 3 — TCPI Calculation:</strong> Using the same project: BAC = £800,000,
            EV = £350,000, AC = £380,000. What efficiency is needed for remaining work to meet
            budget?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Late reporting</strong> — Monthly reports more than 2 weeks after period end
                lose value
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              Your monthly CVR has shown the project at "on budget" for eight months. At month nine,
              the QS reports a £220k loss after recalculating against actuals — two subcontractors'
              costs were under-accrued, and a programme slip has not been reflected in the FFC. Your
              director is furious; the client is suspicious.
            </>
          }
          whatToDo={
            <>
              Audit the CVR methodology immediately — actuals must include accruals (work done, not
              yet invoiced), committed costs (purchase orders), and labour booked but not yet paid.
              Re-baseline the FFC honestly. From now on, CVR is reviewed monthly by the QS with the
              project manager, signed off in writing, and challenged by the commercial director — no
              rubber-stamping. Implement EVM if not already in use to give an early warning of
              variance.
            </>
          }
          whyItMatters={
            <>
              Cost control discipline catches problems early. A £220k loss at month nine has time to
              recover; a £220k loss at month nineteen does not. The monthly CVR is the project's
              health check — skip it and you skip the diagnosis.
            </>
          }
        />
