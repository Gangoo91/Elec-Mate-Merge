...
const HNCModule6Section1_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 1 · Subsection 6"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Handover is a regulatory event, not just a project milestone. The building log book
              (CIBSE TM31 format) is mandatory for non-domestic buildings — without it, the building
              has not legally completed. The principal contractor and M&E designer share
              responsibility for assembling the evidence pack; the principal designer signs off the
              H&S file.
            </>
          }
        ...
        <ConceptBlock title="Energy Performance Certificates (EPCs)">
          <p>
            Energy Performance Certificates are a legal requirement for buildings when constructed,
            sold, or let. They provide a standardised rating of energy efficiency and
            recommendations for improvement, enabling comparison between properties and informing
            decisions about energy use.
          </p>
          <p>
            <strong>EPC Rating Scale</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Rating A (1-25):</strong> Most efficient - typical of new builds with
              excellent insulation and renewables
            </li>
            <li>
              <strong>Rating B (26-50):</strong> Very efficient - well-designed new buildings with
              good controls
            </li>
            <li>
              <strong>Rating C (51-75):</strong> Efficient - meets current Building Regulations
              minimum standards
            </li>
            <li>
              <strong>Rating D (76-100):</strong> Average efficiency - typical of 1990s-2000s
              construction
            </li>
            <li>
              <strong>Rating E-G (101+):</strong> Below average to poor - older buildings requiring
              improvement
            </li>
          </ul>
          <p>
            <strong>EPC Requirements for New Buildings</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>When required:</strong> Before occupation — Before occupation
            </li>
            <li>
              <strong>Assessor type:</strong> OCDEA accredited — NDEA accredited
            </li>
            <li>
              <strong>Calculation method:</strong> SAP 10.2 — SBEM/DSM
            </li>
            <li>
              <strong>Validity period:</strong> 10 years — 10 years
            </li>
            <li>
              <strong>Registration:</strong> EPC Register — Non-Domestic EPC Register
            </li>
          </ul>
          <p>
            <strong>EPC Documentation Checklist</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Key point:</strong> Building services installations directly impact EPC ratings
            through heating/cooling efficiency, lighting efficacy, and controls effectiveness.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Commissioning Certificates and Part L Evidence">
          <p>
            Commissioning certificates provide documented evidence that building services systems
            have been installed correctly and operate as designed. Under Part L, commissioning is
            mandatory and must be notified to Building Control through Regulation 44.
          </p>
          <p>
            <strong>Regulation 44 Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Systems Requiring Commissioning</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Part L Evidence Package</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BRUKL/SBEM output:</strong> Demonstrates BER ≤ TER compliance — Design and
              as-built stages
            </li>
            <li>
              <strong>U-value calculations:</strong> Confirms fabric performance — Design stage,
              verified as-built
            </li>
            <li>
              <strong>Air test certificate:</strong> Confirms air permeability target met — As-built
              only
            </li>
            <li>
              <strong>Commissioning certificates:</strong> Systems meet design intent — Completion
              stage
            </li>
            <li>
              <strong>EPC certificate:</strong> Official energy rating — Before occupation
            </li>
          </ul>
          <p>
            <strong>Commissioning Certificate Content</strong>
          </p>
          <p>
            <strong>Project details:</strong> Name, address, Building Control reference
          </p>
          <p>
            <strong>System identification:</strong> Description, location, design parameters
          </p>
          <p>
            <strong>Test results:</strong> Measured values vs design values
          </p>
          <p>
            <strong>Compliance statement:</strong> Confirmation system meets design intent
          </p>
          <p>
            <strong>Certification:</strong> Signed by competent commissioning engineer
          </p>
          <p>
            <strong>Date and reference:</strong> Unique certificate number
          </p>
          <p>
            <strong>Best practice:</strong> Use CIBSE Commissioning Code M templates to ensure
            certificates contain all required information and are accepted by Building Control.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Building Log Book and As-Built Documentation">
          <p>
            The building log book is a statutory requirement under Part L for buildings with a
            useful floor area exceeding 500m². It documents the energy-consuming systems and
            provides guidance for efficient operation. As-built documentation records the
            installation as actually constructed for future reference.
          </p>
          <p>
            <strong>Building Log Book Contents (CIBSE TM31)</strong>
          </p>
          <p>
            <strong>Part A: General Information</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Part B: System Information</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>As-Built Documentation Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>As-built drawings:</strong> Show installation as actually constructed —
              CAD/PDF, marked-up originals
            </li>
            <li>
              <strong>Equipment schedules:</strong> Final specifications of installed equipment —
              Spreadsheet/PDF
            </li>
            <li>
              <strong>Schematics:</strong> System flow diagrams as installed — CAD/PDF
            </li>
            <li>
              <strong>Control diagrams:</strong> Wiring and control logic as installed — CAD/PDF
            </li>
            <li>
              <strong>Test certificates:</strong> Electrical test, pressure test results —
              Standardised forms
            </li>
          </ul>
          <p>
            <strong>As-Built Drawing Requirements Checklist</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Quality standard:</strong> As-built drawings should enable someone unfamiliar
            with the project to locate, identify, and maintain any installed system or component.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Handover Procedures and Building Control Sign-Off">
          <p>
            Effective handover ensures the client receives a building that performs as designed,
            with all documentation needed for operation and maintenance. Building Control sign-off
            confirms regulatory compliance and enables lawful occupation.
          </p>
          <p>
            <strong>Building Control Sign-Off Process</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Submit:</strong> All Part L evidence and commissioning notices
            </li>
            <li>
              <strong>2. Inspect:</strong> Final inspection of completed works
            </li>
            <li>
              <strong>3. Review:</strong> Documentation check against requirements
            </li>
            <li>
              <strong>4. Issue:</strong> Completion certificate (Building Regulations compliance)
            </li>
            <li>
              <strong>5. Register:</strong> EPC lodged on public register
            </li>
          </ul>
          <p>
            <strong>Handover Documentation Package</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>O&M manuals:</strong> Operating procedures, maintenance schedules, equipment
              data
            </li>
            <li>
              <strong>As-built drawings:</strong> Complete set showing final installation
            </li>
            <li>
              <strong>Test certificates:</strong> Electrical, pressure, commissioning results
            </li>
            <li>
              <strong>Warranties:</strong> Equipment and workmanship warranties
            </li>
            <li>
              <strong>Spare parts:</strong> Recommended spares list and initial provision
            </li>
            <li>
              <strong>Building log book:</strong> Energy systems documentation (if over 500m²)
            </li>
            <li>
              <strong>Health & Safety File:</strong> CDM information for future works
            </li>
            <li>
              <strong>EPC certificate:</strong> Registered energy performance certificate
            </li>
          </ul>
          <p>
            <strong>Structured Handover Activities</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pre-handover:</strong> Snagging, documentation review, training planning —
              Contractor + Client
            </li>
            <li>
              <strong>Handover meeting:</strong> Formal transfer, documentation acceptance — All
              parties
            </li>
            <li>
              <strong>Training:</strong> System demonstrations, operating procedures —
              Contractor/specialists
            </li>
            <li>
              <strong>Soft landings:</strong> Extended aftercare, fine-tuning, POE — Design team +
              Contractor
            </li>
            <li>
              <strong>Defects period:</strong> Rectification of emerging defects — Contractor
            </li>
          </ul>
          <p>
            <strong>Soft Landings Framework (GSL)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stage 1:</strong> Inception and briefing - embed soft landings from start
            </li>
            <li>
              <strong>Stage 2:</strong> Design development - focus on usability and operability
            </li>
            <li>
              <strong>Stage 3:</strong> Pre-handover - prepare client, training programmes
            </li>
            <li>
              <strong>Stage 4:</strong> Initial aftercare - resident on site, reactive support
            </li>
            <li>
              <strong>Stage 5:</strong> Extended aftercare - fine-tuning, seasonal commissioning
            </li>
            <li>
              <strong>Stage 6:</strong> Post-occupancy evaluation - review actual vs predicted
              performance
            </li>
          </ul>
          <p>
            <strong>Performance gap:</strong> Soft landings addresses the common gap between design
            predictions and actual building performance, which can be 2-5 times greater energy use
            than predicted.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Building log book threshold: <strong>500m² useful floor area</strong>
            </li>
            <li>
              EPC validity: <strong>10 years</strong>
            </li>
            <li>
              Regulation 44 notice: <strong>within 30 days of completion</strong>
            </li>
            <li>
              Documentation retention: <strong>life of building (min 12 years contractual)</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Design vs as-built mismatch</strong> - Ensure calculations reflect actual
                installation
              </li>
              <li>
                <strong>Generic certificates</strong> - Commissioning data must be project-specific
              </li>
              <li>
                <strong>Missing air test</strong> - Required evidence, cannot be calculated
              </li>
              <li>
                <strong>Late EPC registration</strong> - Must be registered before occupation
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A fully-let office building handed over six months ago. The Soft Landings aftercare
              team are monitoring half-hourly metering and discover the AHUs are running 0700–2000
              seven days a week, not the 0700–1900 weekday schedule the SBEM model assumed. The
              actual energy use is 35% above design.
            </>
          }
          whatToDo={
            <>
              Convene a performance review with the BMS commissioning engineer, FM team and tenant.
              Verify: (1) what the BMS is actually doing vs. the commissioned strategy; (2) whether
              the tenant has overridden time schedules; (3) whether weekend usage is genuine
              occupancy. Re-commission to design intent or, if the tenant has legitimately extended
              occupancy, re-baseline the SBEM operational model. Use the defect liability period to
              fix this — performance gap interventions are far cheaper before the liability period
              ends.
            </>
          }
          whyItMatters={
            <>
              The performance gap (predicted vs actual energy use) is typically 30–80% in commercial
              buildings — and most of it is operational, not design. Soft Landings aftercare catches
              it; conventional handover walks away. CIBSE TM61–63 set out the seasonal commissioning
              and aftercare obligations that close the gap.
            </>
          }
        />
