      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>EPC:</strong> Energy rating A-G, required for all new buildings
              </li>
              <li className="pl-1">
                <strong>Part L:</strong> BER must not exceed TER for compliance
              </li>
              <li className="pl-1">
                <strong>Log book:</strong> Required for buildings over 500m²
              </li>
              <li className="pl-1">
                <strong>Regulation 44:</strong> Notice of commissioning to Building Control
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Commissioning:</strong> Test data proving design intent achieved
              </li>
              <li className="pl-1">
                <strong>As-built:</strong> Drawings showing actual installation
              </li>
              <li className="pl-1">
                <strong>O&M manuals:</strong> Operation and maintenance information
              </li>
              <li className="pl-1">
                <strong>Handover:</strong> Training, documentation, sign-off
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Energy Performance Certificates are a legal requirement for buildings when
              constructed, sold, or let. They provide a standardised rating of energy efficiency and
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Rating B (26-50):</strong> Very efficient - well-designed new buildings
                  with good controls
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Rating E-G (101+):</strong> Below average to poor - older buildings
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Building services installations directly impact EPC
              ratings through heating/cooling efficiency, lighting efficacy, and controls
              effectiveness.
            </p>
          </div>
        </section>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Demonstrates BER ≤ TER compliance
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Confirms fabric performance
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Design stage, verified as-built
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Air test certificate</td>
                      <td className="border border-white/10 px-3 py-2">
                        Confirms air permeability target met
                      </td>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Show installation as actually constructed
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Final specifications of installed equipment
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        System flow diagrams as installed
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Wiring and control logic as installed
                      </td>
                      <td className="border border-white/10 px-3 py-2">CAD/PDF</td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Electrical test, pressure test results
                      </td>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                As-Built Drawing Requirements Checklist
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              <p className="text-sm font-medium text-blue-400 mb-2">
                Building Control Sign-Off Process
              </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>O&M manuals:</strong> Operating procedures, maintenance schedules,
                  equipment data
                </li>
                <li className="pl-1">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Structured Handover Activities
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Snagging, documentation review, training planning
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Formal transfer, documentation acceptance
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        System demonstrations, operating procedures
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Extended aftercare, fine-tuning, POE
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Rectification of emerging defects
                      </td>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Part L Compliance Package for Office Building
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: HVAC Commissioning Certificate
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  Certificate confirms system meets design intent
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Handover Documentation Checklist
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="text-green-400">
                  O&M Manuals (3 volumes) | Complete | Approved by FM
                </p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Verify all Part L calculations reflect as-built installation
                </li>
                <li className="pl-1">
                  Ensure commissioning certificates include measured vs design values
                </li>
                <li className="pl-1">
                  Confirm EPC is registered before applying for completion certificate
                </li>
                <li className="pl-1">
                  Check building log book covers all energy-consuming systems
                </li>
                <li className="pl-1">
                  Validate as-built drawings show actual installed routes and locations
                </li>
                <li className="pl-1">
                  Obtain signed training attendance records from client staff
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  ...
                  <strong>life of building (min 12 years contractual)</strong>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Generic certificates</strong> - Commissioning data must be
                  project-specific
                </li>
                <li className="pl-1">
