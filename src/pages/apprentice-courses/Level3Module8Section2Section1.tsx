...
const TITLE = 'Time management for L3 closed-book MC | Level 3 Module 8.2.1 | Elec-Mate';
const DESCRIPTION =
...
const faqs = [
  ...
  {
    question: 'Is the L3 paper one combined exam or one paper per unit?',
    answer:
  ...
  {
    question: 'Should I use the same pacing on every unit paper or vary it per unit?',
    answer:
  ...
  {
    question: 'What do I do if I am running out of time with 10 questions still unanswered?',
    answer:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Pacing the 60Q / 90min unit papers (and the 40Q / 60min Unit 308 paper) —
          minutes-per-question targets, flag-and-skip discipline, banking time for calculation-heavy
          items, and what to do when the clock starts beating you.
        </p>
        ...
        >
          <p>
            Compare the per-question time pressure across the three L2/L3 closed-book papers you
            will sit:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>L2 unit papers (201, 202, 203, 204, 210)</strong> — 60 questions in 90
              minutes. Mostly recall and recognition with some Ohm&apos;s law and basic circuit
              reasoning. 1 min 30 sec per question is comfortable for most candidates.
            </li>
            <li>
              <strong>L3 unit papers (201 refresher, 301, 302, 303, 304, 305)</strong> — 60
              questions in 90 minutes. Same per-question rate, but the question content shifts to
              multi-step calculations (voltage drop, Zs, cable derating), EICR coding judgement and
              design choices. The same 1.5 min feels much tighter.
            </li>
            <li>
              <strong>L3 Unit 308 (Career Awareness)</strong> — 40 questions in 60 minutes. Same 1.5
              min per question but the content is recall-heavy (qualifications, JIB grades, AM2,
              professional bodies, CPD routes). Most candidates finish this paper inside 45 minutes.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Cable colour codes, accessory ratings, standard MCB curves (B, C, D — when each is
              used).
            </li>
            <li>
              Earthing system identification (TN-S, TN-C-S / PNB, TT, IT) and the disconnection-time
              framework at a high level.
            </li>
            <li>Inspection-and-test sequence order (the &quot;dead before live&quot; sequence).</li>
            <li>HSE / industry recall items — RIDDOR thresholds, PUWER scope, EAWR Reg 4.</li>
            <li>
              Single-step calculations: P = VI, V = IR, transformer ratio, basic three-phase
              line/phase relationships.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Maximum 3 minutes per calculation question.</strong> Hard ceiling. If at 3
              minutes you have not converged, flag and move on.
            </li>
            <li>
              <strong>Recognise the formula family first.</strong> Voltage drop = (mV/A/m &times; Ib
              &times; L) / 1000. Zs = Ze + (R1 + R2). Cable CCC after grouping = It &times; Ca
              &times; Cg &times; Ci. Once you have the formula, the numbers fall in.
            </li>
            <li>
              <strong>EICR coding questions: walk the four codes.</strong> Is it immediately
              dangerous (C1)? Potentially dangerous (C2)? Improvement recommended but compliant at
              the time of installation (C3)? Further investigation required (FI)? Most coding
              questions hinge on distinguishing C2 from C3 — the &quot;potentially dangerous&quot;
              vs &quot;recommended improvement&quot; line.
            </li>
            <li>
              <strong>Three-phase questions: line vs phase.</strong> Line voltage = phase voltage
              &times; root-3 (star). Line current = phase current &times; root-3 (delta). Always
              confirm which the question is asking for.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Every question has an answer selected — no blanks. (Hard rule.)</li>
            <li>
              Calculation answers checked for unit consistency (mm&sup2;, A, V, &Omega;, kW vs W,
              kVA vs VA).
            </li>
            <li>
              Safety questions cross-checked — &quot;is the answer I picked the BS 7671-compliant
              one, or is it the convenient one?&quot;
            </li>
            <li>
              Flagged items revisited with fresh eyes — sometimes the answer is obvious second time.
            </li>
            <li>
              Spot the distractor patterns — the tempting wrong answer is often numerically close to
              the right one, but with a unit error or a missed derating factor.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              converging on an answer, OR your gut is telling you the question is harder than it
              should be.
            </li>
            <li>
              <strong>Action</strong> — pick the best of the four options based on first instinct
              (apply any obvious eliminations: safety-violating answers, impossible values), tick
              the answer, flag the question.
            </li>
            <li>
              <strong>Move</strong> — go to the next question. Do not look back until Pass 3. The
              flagged answer is your insurance — if Pass 3 confirms it, you keep it; if Pass 3
              changes it, you fix it; if Pass 3 runs out of time, you have still scored on instinct
              rather than blank.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Candidate sits down on Unit 305 (Design), reads question 1, does not immediately see
              the answer, and decides to &quot;think it through properly&quot;. Spends 5 minutes on
              Q1, gets it right, feels good. Q2 same pattern — 4 minutes, right answer. By Q15 they
              have used 45 of the 90 minutes on a quarter of the paper. The last 45 questions get
              done in 45 minutes flat at low accuracy, with the calculation items skipped entirely.
              They fail by 4 marks.
            </>
          }
          doInstead={
            <>
              Drill the flag-and-skip habit in every single mock. Set a 90-second mental timer for
              each question. If you have not converged at 90 seconds, give it 30 more seconds, then
              flag-and-skip if you are still stuck. The paper is designed assuming you spend ~75-90
              seconds per question on average — if you are spending 4 minutes, the paper-setter has
              already won.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You have 90 minutes for 60 closed-book questions on Unit 304. Roughly 35% of the paper
              is EICR coding scenarios, 25% is calculation (Zs limits, disconnection times, IR
              thresholds, RCD operating values), 25% is sequence- and instrument-selection
              questions, and 15% is recall on Part 6 of BS 7671. You have to manage time across all
              four bands.
            </>
          }
          whatToDo={
            <>
              Pass 1 (0-45 min): Sweep the whole paper. Answer the recall questions first (Part 6
              structure, instrument categories CAT II/III/IV, what each continuity test confirms).
              Answer the easier coding scenarios (clear C1s like exposed live conductors; clear C3s
              like a single-pole switch on a neutral). Flag the harder C2-vs-C3 calls and the
              multi-step calculations. Aim for 35-40 questions answered. Pass 2 (45-75 min): Tackle
              the calculations and the trickier coding calls methodically. 3-minute hard ceiling per
              item. Pass 3 (75-90 min): Review the flagged items and the ones you guessed. Re-check
              unit consistency on the calculations. Confirm no blanks.
            </>
          }
          whyItMatters={
            <>
              Unit 304 has the highest calculation-and-coding density of the L3 papers. Without
              disciplined pacing, candidates routinely hit the time wall with 15+ questions
              unanswered. The three-pass approach buys you the buffer to handle the heavy items
              without sacrificing the easy marks elsewhere.
            </>
          }
        />
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pass 1 (~30 min)</strong> — sweep all 40 questions. Most should be quick
              recall. Flag anything you cannot place from memory.
            </li>
            <li>
              <strong>Pass 2 (~20 min)</strong> — tackle the flagged items with elimination — JIB
              grading questions usually have one or two impossible options you can rule out
              immediately.
            </li>
            <li>
            ...
            <li>
              <strong>Most candidates finish inside 45 minutes</strong> with 15 minutes to spare —
              use it for review, do not rush out the door.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Practise the mocks with the on-screen calculator if your platform offers one — get
              used to the click-rhythm.
            </li>
            <li>
              For each calculation question, jot the formula on rough paper before plugging in
              numbers. Forces clarity, prevents mid-calc panic.
            </li>
            <li>
              Use the rough paper for elimination too — quickly write A B C D and cross out the
              eliminated options. Faster than re-reading on screen.
            </li>
            <li>
              Memory functions (M+, MR) save real seconds on multi-step calculations like voltage
              drop with grouping factors.
            </li>
            <li>
              Round sensibly — the MC distractors are usually a clear 5-10% apart. You don&apos;t
              need three decimal places to pick the right option.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Minute 75</strong> — survey what is left. Count the unanswered and flagged
              items. Mentally sort: which 3 can you nail in 90 seconds each; which 3 will take 2-3
              minutes; which 3 are pure-guess territory.
            </li>
            <li>
              <strong>Minutes 75-82</strong> — clear the easy quick-wins among the unanswered. Do
              not start anything you cannot finish in 90 seconds.
            </li>
            <li>
              <strong>Minutes 82-87</strong> — tackle the medium-effort items. 3-minute hard ceiling
              each.
            </li>
            <li>
              <strong>Minutes 87-89</strong> — pure-guess sweep. Read each remaining question for
              ~10 seconds, eliminate the obviously wrong, pick the most plausible. Tick every blank.
            </li>
            <li>
              <strong>Minute 89-90</strong> — final blank-check. Confirm every question has an
              answer. Submit on the bell, not before.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Candidate finishes Pass 1 with 25 minutes still on the clock, feels pleased, and
              submits to be done. They lose the review pass entirely. Three of their Pass 1 answers
              contained unit errors that Pass 3 would have caught (mm&sup2; misread as mm, divided
              by 1000 instead of multiplied). Two of their Pass 1 guesses had clearer answers on a
              second read. They fail by 2 marks — exactly the marks Pass 3 would have recovered.
            </>
          }
          doInstead={
            <>
              Use every available minute. There is no bonus for finishing early — only a penalty for
              finishing wrong. Even if you feel completely confident, spend the buffer reviewing the
              calculations for unit consistency, the coding questions for C2/C3 borderline calls and
              the safety questions for BS 7671 compliance. Submit on the bell or at 89:50 — never
              with significant buffer remaining.
            </>
          }
        />
