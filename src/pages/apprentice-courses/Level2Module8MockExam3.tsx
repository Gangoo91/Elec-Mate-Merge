...
import { getRandomQuestions } from "@/data/apprentice-courses/level2/module3/questionBank";
          ...
          <Card className="border-elec-yellow/30 bg-card">
            <CardContent className="p-8">
              <div className="text-center mb-8">
                ...
                <h1 className="text-2xl font-bold text-foreground mb-2">Mock Exam 3</h1>
                <h2 className="text-lg text-elec-yellow mb-6">Electrical Installation Methods & Technology</h2>
              ...
              <div className="bg-background p-4 rounded-xl border border-muted/40 mb-6">
                ...
                <div className="grid gap-2">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-sm text-white/80 leading-relaxed">30 questions randomly selected from Module 3 content</p>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="h-1.5 w-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0" />
          ...
          <Card className="border-elec-yellow/30 bg-card">
            <CardContent className="p-6">
              <div className="text-center mb-6">
                ...
                <h2 className="text-lg text-elec-yellow">Electrical Installation Methods & Technology</h2>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-xs text-center text-white/80 pt-2 border-t border-elec-yellow/30">
                    <div>Exam: Module 3</div>
                    <div>Installation Methods & Technology</div>
                  </div>
                </div>
              </div>
            </CardContent>
