            ...
            <CardContent className="p-8">
              <div className="text-center mb-8">
                ...
                <h2 className="text-lg text-elec-yellow mb-6">
                  Electrical Installation Methods & Technology
                </h2>
                <p className="text-white/80 mb-6">
                  Test your knowledge of electrical installation methods, cable types, wiring
                  systems, and technology for Level 2 electrical installation.
                </p>
              </div>
