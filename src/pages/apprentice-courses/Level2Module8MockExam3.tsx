          ...
          <Card className="border-emerald-500/30 bg-card">
            <CardContent className="p-8">
              <div className="text-center mb-8">
                ...
                <h2 className="text-lg text-emerald-400 mb-6">Electrical Installation Methods & Technology</h2>
          ...
          <Card className="border-emerald-500/30 bg-card">
            <CardContent className="p-6">
              <div className="text-center mb-6">
                ...
                <h2 className="text-lg text-emerald-400">Electrical Installation Methods & Technology</h2>
              </div>
