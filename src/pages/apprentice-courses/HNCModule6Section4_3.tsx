...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['4.0-6.0 kgCO₂e/kg', '0.5-1.0 kgCO₂e/kg', '1.5-3.0 kgCO₂e/kg', '8.0-12.0 kgCO₂e/kg'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['A1-A3 and B6 only', 'A1-A5 only', 'All stages A-D', 'A1-A5, B1-B5, C1-C4'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['40-60%', '25-35%', '10-15%', '80-90%'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Steel cable tray', 'Copper busbars', 'Plastic conduit', 'PVC trunking'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['2.0-4.0 kgCO₂e/m', '6.0-10.0 kgCO₂e/m', '0.5-1.0 kgCO₂e/m', '15.0-25.0 kgCO₂e/m'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['ISO 14001', 'BREEAM', 'BS 7671', 'EN 15804'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              RICS WLCA 2nd edition is now the UK standard — referenced by GLA London Plan, by major
              developers, and increasingly by tender requirements. EPDs are the primary data source;
              generic ICE database data is a fallback only. The assessment is iterative — Stage 2
              baseline, Stage 4 detailed, Stage 6 as-built — informing design decisions, not just
        ...
        <ConceptBlock title="Understanding Embodied Carbon">
          ...
          <p>
            <strong>Components of embodied carbon:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Product stage (A1-A3):</strong> Raw material extraction, transport,
              manufacturing - typically 70-80% of total
            </li>
            <li>
              <strong>Construction (A4-A5):</strong> Transport to site and installation activities
            </li>
            <li>
              <strong>In-use (B1-B5):</strong> Maintenance, repair, replacement of components
            </li>
            <li>
              <strong>End of life (C1-C4):</strong> Deconstruction, transport, processing, disposal
            </li>
          </ul>
          <p>
            <strong>Whole Life Carbon Framework</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Product:</strong> A1-A3 — Raw material supply, transport to factory,
              manufacturing
            </li>
            <li>
              <strong>Construction:</strong> A4-A5 — Transport to site, installation and
              construction processes
            </li>
            <li>
              <strong>Use:</strong> B1-B5 — Use, maintenance, repair, replacement, refurbishment
            </li>
            <li>
              <strong>Operational:</strong> B6-B7 — Operational energy and water use
            </li>
            <li>
              <strong>End of Life:</strong> C1-C4 — Deconstruction, transport, waste processing,
              disposal
            </li>
            <li>
              <strong>Beyond Life:</strong> D — Reuse, recovery, recycling potential (reported
              separately)
            </li>
          </ul>
          <p>
            <strong>Critical insight:</strong> For highly efficient buildings, embodied carbon can
            represent 50-70% of whole life carbon, making upfront material choices increasingly
            important for Net Zero targets.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Life Cycle Stages in Detail">
          <p>
            Understanding each life cycle stage enables targeted carbon reduction strategies. The EN
            15804 framework provides standardised modules that form the basis for EPDs and whole
            life carbon assessments.
          </p>
          <p>
            <strong>Product Stage (A1-A3)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>A1:</strong> Raw material extraction and processing
            </li>
            <li>
              <strong>A2:</strong> Transport to manufacturing plant
            </li>
            <li>
              <strong>A3:</strong> Manufacturing and packaging
            </li>
            <li>Often called 'cradle to gate'</li>
            <li>Typically 70-80% of embodied carbon</li>
          </ul>
          <p>
            <strong>Construction Stage (A4-A5)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>A4:</strong> Transport from factory to site
            </li>
            <li>
              <strong>A5:</strong> Installation and construction waste
            </li>
          ...
          <p>
            <strong>Use Stage (B1-B7)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>B1:</strong> Use (emissions from product itself)
            </li>
            <li>
              <strong>B2:</strong> Maintenance activities
            </li>
            <li>
              <strong>B3:</strong> Repair
            </li>
            <li>
              <strong>B4:</strong> Replacement (major for MEP)
            </li>
            <li>
              <strong>B5:</strong> Refurbishment
            </li>
          </ul>
          <p>
            <strong>End of Life (C1-C4) and Beyond (D)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>C3:</strong> Waste processing for reuse
            </li>
            <li>
              <strong>C4:</strong> Disposal
            </li>
            <li>
              <strong>D:</strong> Benefits beyond boundary
            </li>
          </ul>
          <p>
            <strong>B4 Replacement Cycles for MEP Components</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>LED luminaires:</strong> 15-20 years — 2-3 cycles
            </li>
            <li>
              <strong>Distribution boards:</strong> 25-30 years — 1-2 cycles
            </li>
            <li>
              <strong>Cables and containment:</strong> 40-60 years — 0-1 cycle
            </li>
            <li>
              <strong>HVAC plant:</strong> 15-25 years — 2-3 cycles
            </li>
            <li>
              <strong>BMS controllers:</strong> 10-15 years — 3-5 cycles
            </li>
          </ul>
          <p>
            <strong>Design consideration:</strong> B4 replacement can double the embodied carbon of
            short-lifespan components over a 60-year reference study period.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="MEP Embodied Carbon and EPDs">
          <p>
            ...
            Environmental Product Declarations (EPDs) provide verified, comparable data for material
            selection decisions based on the EN 15804 standard.
          </p>
          <p>
            <strong>Typical MEP Material Embodied Carbon Values</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Mechanical Materials</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Understanding EPDs</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Type III EPD:</strong> Third-party verified environmental declaration to EN
              15804
            </li>
            <li>
              <strong>GWP (A1-A3):</strong> Global Warming Potential for product stage - key
              comparison metric
            </li>
            <li>
              <strong>Functional unit:</strong> Basis of comparison (e.g., per kg, per metre, per
              luminaire)
            </li>
            <li>
              <strong>Reference service life:</strong> Expected lifespan affecting B4 calculations
            </li>
            <li>
              <strong>Programme operator:</strong> Scheme under which EPD is registered (e.g., IBU,
              BRE)
            </li>
          </ul>
          <p>
            <strong>Refrigerant Carbon Impact</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>R410A:</strong> 2,088 — 2,088 kgCO₂e — Split AC, VRF
            </li>
            <li>
              <strong>R32:</strong> 675 — 675 kgCO₂e — Split AC, small chillers
            </li>
            <li>
              <strong>R134a:</strong> 1,430 — 1,430 kgCO₂e — Chillers
            </li>
            <li>
              <strong>R290 (Propane):</strong> 3 — 3 kgCO₂e — Heat pumps
            </li>
            <li>
              <strong>R744 (CO₂):</strong> 1 — 1 kgCO₂e — Commercial refrigeration
            </li>
          </ul>
          <p>
            <strong>Data sources:</strong> Use CIBSE TM65, ICE Database, or manufacturer EPDs. Where
            product-specific EPDs are unavailable, use generic data with conservative assumptions.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Reduction Strategies and RICS Methodology">
          <p>
            Effective embodied carbon reduction requires intervention at the right design stage. The
            RICS Whole Life Carbon Assessment methodology provides a standardised approach for
            calculating, comparing, and reporting building carbon.
          </p>
          <p>
            <strong>Carbon Reduction Hierarchy</strong>
          </p>
          ...
          <p>
            <strong>MEP-Specific Reduction Strategies</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Right-sizing systems:</strong> 10-30% — Accurate load calculations, avoid
              over-design
            </li>
            <li>
              <strong>Recycled copper content:</strong> 30-50% — Specify high recycled content
              cables
            </li>
            <li>
              <strong>Optimised containment:</strong> 20-40% — Efficient routing, shared risers,
              lighter gauges
            </li>
            <li>
              <strong>Low-GWP refrigerants:</strong> 60-99% — R32, R290, CO₂ systems instead of
              R410A
            </li>
            <li>
              <strong>Extended luminaire life:</strong> 25-40% — Quality products with 50,000+ hour
              life
            </li>
          </ul>
          <p>
            <strong>RICS Whole Life Carbon Requirements</strong>
          </p>
          <p>
            <strong>Reference study period:</strong> 60 years (standard building life)
          </p>
          <p>
            <strong>Mandatory modules:</strong> A1-A5, B1-B5, C1-C4
          </p>
          <p>
            <strong>Separate reporting:</strong> B6-B7 (operational), Module D (beyond boundary)
          </p>
          <p>
            <strong>Data hierarchy:</strong> Product EPD {'>'} Industry EPD {'>'} Generic database
          </p>
          <p>
            <strong>Unit:</strong> kgCO₂e/m² GIA for benchmarking
          </p>
          <p>
            <strong>Reporting:</strong> Clear statement of inclusions, exclusions, and data quality
          </p>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Calculate embodied carbon for 500m of 95mm² 4-core armoured
            cable.
          </p>
          <p>Given:</p>
          ...
          <p>
            <strong>Scenario:</strong> Compare whole life refrigerant carbon for R410A vs R32 VRF
            system.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Calculate whole life embodied carbon including replacements
            for lighting.
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Product stage (A1-A3): <strong>70-80%</strong> of embodied carbon
            </li>
            <li>
              MEP contribution: <strong>15-25%</strong> of building embodied carbon
            </li>
            <li>
              Copper cable: <strong>2.5-3.0 kgCO₂e/kg</strong> (virgin)
            </li>
            <li>
              Reference study period: <strong>60 years</strong> (RICS standard)
            </li>
            <li>
              R410A GWP: <strong>2,088</strong> vs R32: <strong>675</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Ignoring B4 replacements:</strong> Short-lifespan components multiply carbon
              </li>
              <li>
                <strong>Forgetting refrigerants:</strong> High-GWP refrigerants can dominate HVAC
                carbon
              </li>
              <li>
                <strong>Using outdated data:</strong> Generic databases may not reflect current
                manufacturing
              </li>
              <li>
                <strong>Late assessment:</strong> Waiting until Stage 4/5 limits reduction options
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A 5,000 m² office refurbishment is targeting LETI Band B for embodied carbon (≤625
              kgCO₂e/m² A1–A5). The proposed all-new MEP package modelled at 720. Looking at
              hotspots: switchgear (15 t), new HVAC plant (45 t) and copper cabling (28 t) account
              for over half the M&E embodied carbon.
            </>
          }
          whatToDo={
            <>
              Three reduction strategies: (1) re-use existing switchgear (de-rate or refurbish
              in-situ — typical 60–80% embodied carbon saving on the asset); (2) specify
              high-recycled-content plant (chillers, AHUs with EPDs showing 30%+ recycled); (3)
              replace copper cabling with aluminium where current rating allows (40–60% embodied
              saving but technical assessment needed). Combined, these can pull the total below 625.
              Document each substitution with an EPD-backed calculation.
            </>
          }
          whyItMatters={
            <>
              Embodied carbon in M&E is dominated by metals — switchgear (steel + copper), cabling
              (copper), refrigeration plant (copper + steel). The biggest reduction lever is reuse,
              not replacement. Specifying "new" without challenge typically wastes 30–50% of the
              embodied carbon budget. RICS WLCA forces this to be measured and reported.
            </>
          }
        />
