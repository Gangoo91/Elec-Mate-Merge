    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Embodied carbon:</strong> Emissions from materials and construction
              </li>
              <li className="pl-1">
                <strong>Life cycle stages:</strong> A1-A5, B1-B7, C1-C4, D
              </li>
              <li className="pl-1">
                <strong>MEP contribution:</strong> 15-25% of building embodied carbon
              </li>
              <li className="pl-1">
                <strong>Key materials:</strong> Copper, steel, refrigerants, aluminium
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Copper cable:</strong> ~2.5 kgCO₂e/kg (virgin)
              </li>
              <li className="pl-1">
                <strong>Steel containment:</strong> ~2.0 kgCO₂e/kg
              </li>
              <li className="pl-1">
                <strong>Early design:</strong> Greatest reduction opportunity
              </li>
              <li className="pl-1">
                <strong>EPDs:</strong> Verified product carbon data
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              materials and construction processes throughout a building's life cycle. Unlike
              operational carbon which can be reduced through efficient management and grid
              decarbonisation, embodied carbon is 'locked in' once construction is complete.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Construction (A4-A5):</strong> Transport to site and installation
                  activities
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>End of life (C1-C4):</strong> Deconstruction, transport, processing,
                  disposal
                </li>
              </ul>
            </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Transport to site, installation and construction processes
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Reuse, recovery, recycling potential (reported separately)
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Understanding each life cycle stage enables targeted carbon reduction strategies. The
              EN 15804 framework provides standardised modules that form the basis for EPDs and
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              ...
              <div className="p-4 rounded-lg bg-white/5">
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  End of Life (C1-C4) and Beyond (D)
                </p>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  <li className="pl-1">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                B4 Replacement Cycles for MEP Components
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Design consideration:</strong> B4 replacement can double the embodied carbon
              of short-lifespan components over a 60-year reference study period.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              Environmental Product Declarations (EPDs) provide verified, comparable data for
              material selection decisions based on the EN 15804 standard.
            </p>

            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              <p className="text-sm font-medium text-blue-400 mb-2">
                Typical MEP Material Embodied Carbon Values
              </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Type III EPD:</strong> Third-party verified environmental declaration to
                  EN 15804
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Functional unit:</strong> Basis of comparison (e.g., per kg, per metre,
                  per luminaire)
                </li>
                <li className="pl-1">
                  <strong>Reference service life:</strong> Expected lifespan affecting B4
                  calculations
                </li>
                <li className="pl-1">
                  <strong>Programme operator:</strong> Scheme under which EPD is registered (e.g.,
                  IBU, BRE)
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Data sources:</strong> Use CIBSE TM65, ICE Database, or manufacturer EPDs.
              Where product-specific EPDs are unavailable, use generic data with conservative
              assumptions.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              The RICS Whole Life Carbon Assessment methodology provides a standardised approach for
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                MEP-Specific Reduction Strategies
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Accurate load calculations, avoid over-design
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Specify high recycled content cables
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Efficient routing, shared risers, lighter gauges
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        R32, R290, CO₂ systems instead of R410A
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Quality products with 50,000+ hour life
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                RICS Whole Life Carbon Requirements
              </p>
              <div className="text-sm space-y-2">
                ...
                <p>
                  <strong>Separate reporting:</strong> B6-B7 (operational), Module D (beyond
                  boundary)
                </p>
                <p>
                  <strong>Data hierarchy:</strong> Product EPD {'>'} Industry EPD {'>'} Generic
                  database
                </p>
                <p>
                ...
                <p>
                  <strong>Reporting:</strong> Clear statement of inclusions, exclusions, and data
                  quality
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Refrigerant Lifecycle Carbon
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: B4 Replacement Impact
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  Premium option: 23% lower whole life carbon despite higher unit cost
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Embodied Carbon Assessment Checklist
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Define system boundaries and reference study period (typically 60 years)
                </li>
                <li className="pl-1">List all MEP components and materials with quantities</li>
                <li className="pl-1">
                  Source carbon coefficients: EPDs first, then generic databases
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Ignoring B4 replacements:</strong> Short-lifespan components multiply
                  carbon
                </li>
                <li className="pl-1">
