    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Pay-when-paid is illegal in the UK construction industry except where the upstream
              party is genuinely insolvent. Subcontractors must be paid in line with the contract's
              payment provisions — you cannot make payment to your subcontractor conditional on
              receipt from the client. Every subcontract must be Construction Act compliant or it is
              void on payment terms.
            </>
          }
        ...
        <ConceptBlock title="Subcontract Types and Selection">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Domestic subcontractor:</strong> Selected entirely by main contractor with no
              client involvement
            </li>
            <li>
            ...
            <li>
              <strong>Key difference:</strong> Main contractor retains full responsibility for named
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>JCT DOM/1:</strong> Works subcontracts (labour + materials) — Full subcontract
              with design provisions option
            </li>
            <li>
            ...
            <li>
              <strong>Bespoke forms:</strong> Main contractor's own terms — Often heavily amended in
              contractor's favour
            </li>
          </ul>
          <p>
            <strong>Building Services Scenario — Hospital M&E Package:</strong> A main contractor on
            a £45M hospital project subcontracts the M&E installation (£18M value) using DOM/1 with
            design portion supplement. The electrical subcontractor provides detailed design,
            procurement, installation, testing and commissioning. Flow-down clauses ensure
          ...
          <p>
            <strong>Selection principle:</strong> Choose subcontract forms that provide appropriate
            risk allocation whilst remaining fair — overly onerous terms may deter quality
            subcontractors or lead to disputes.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Back-to-Back and Flow-Down Clauses">
          ...
          <p>
            <strong>
              Common Flow-Down Areas for Building Services (Category — Typical Requirements):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Health & Safety:</strong> CDM compliance, site inductions, method statements,
              permit systems
            </li>
            <li>
          ...
          <p>
            <strong>Risk — Incomplete Back-to-Back:</strong> If the main contract requires 14 days
            notice for delay claims but the subcontract allows 28 days, the main contractor may
            receive late notice from the subcontractor but be time-barred from claiming against the
            client. Always ensure notice periods, limitation periods, and procedural requirements
            are truly back-to-back.
          </p>
          <p>
        ...
        <ConceptBlock title="Payment Terms and Construction Act Compliance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Payment notice:</strong> Payer must issue notice stating sum due within 5 days
              of due date
            </li>
            <li>
              <strong>Pay less notice:</strong> If paying less than notified, must give notice with
              reasons
            </li>
            <li>
            ...
            <li>
              <strong>Suspension:</strong> Right to suspend work for non-payment after 7 days notice
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            submitted on time. Poor applications delay payment and damage commercial relationships.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Coordination and Programme Integration">
          <p>
            Building services coordination is critical to project success. Multiple M&E trades must
            work in confined spaces, often with complex sequencing requirements. Effective
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Electrical vs Ductwork:</strong> Cable tray and duct routing clash in ceiling
              void — Combined services drawing review, agree levels
            </li>
            <li>
            ...
            <li>
              <strong>Pipework vs Structure:</strong> Penetration locations clash with reinforcement
              — Early builders work drawing submission
            </li>
            <li>
          ...
          <p>
            ...
            resolving clashes on drawings costs a fraction of fixing them on site. Modern BIM tools
            can identify clashes automatically if models are properly maintained.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — Back-to-Back Payment Provisions:</strong> Main contract has 28-day
            payment terms from due date. How should the subcontract be structured?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              This ensures payment obligations flow through without the main contractor being "out
              of pocket"
            </li>
            <li>
          ...
          <p>
            <strong>Example 2 — Contra-Charge Procedure:</strong> Electrical subcontractor fails to
            complete cable glanding, main contractor instructs another subcontractor to complete at
            a cost of £2,400.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Step 4: Issue contra-charge notice with evidence: copy of instruction, photos showing
              incomplete work, invoice from completing subcontractor, deduction from next payment
              £2,400
            </li>
            <li>
          ...
          <p>
            <strong>Example 3 — Delay Claim Flow-Through:</strong> M&E subcontractor delayed 6 weeks
            due to late steelwork. How do costs flow through the contractual chain?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Note: Subcontractor must comply with notice requirements in subcontract.</li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Ignoring flow-downs</strong> — Non-compliance can have serious consequences
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              Your fire alarm subcontractor goes into administration at week 20 of a 32-week
              programme. They have completed 60% of installation but have not been paid for their
              last application of £85,000 (you certified, the client paid). Their administrator
              demands payment; the replacement subcontractor needs three weeks to mobilise and
              quotes 40% more for completion.
            </>
          }
          whatToDo={
            <>
              Engage your insolvency clause immediately — most subcontracts allow termination on
              insolvency. Audit the work installed and tested against payment certified — pay only
              for verifiable work. Engage administrators properly; do not unilaterally withhold
              without legal advice. Mobilise the replacement under a separate subcontract; recover
              the cost difference and programme impact under your subcontract's damages provision
              and your project's risk allowance. Update the risk register and early warning under
              the main contract.
            </>
          }
          whyItMatters={
            <>
              Subcontractor insolvency is one of the highest-impact risks in MEP delivery.
              Watertight subcontracts with insolvency clauses, performance bonds (where commercial)
              and parent company guarantees are not paranoia — they are the basis of recovery. Plus,
              treat the supply chain financially fairly: prompt payment is the best insolvency
              prevention.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">NEC contracts</div>
          </button>
          <button
