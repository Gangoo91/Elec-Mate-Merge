...
const quickCheckQuestions = [
  {
    ...
    options: ['Straight line', 'Exponential', 'Parabolic (H ∝ Q²)', 'Inverse'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['8 times', '2 times', '4 times', 'Stays the same'],
    correctAnswer: 2,
    explanation:
...
const HNCModule2Section2_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 2 · Subsection 6"
        title="System Curves and Operating Points"
        backTo="/study-centre/apprentice/h-n-c-module2-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Match pumps to systems, understand parallel/series operation, and use VSDs to save energy.
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CIBSE TM 22 and Guide H position VSD pumping as the default for variable-load building
              services water systems. As an HNC designer the case for VSD is rarely technical — it
              is regulatory (Part L), economic (lifecycle cost) and practical (acoustic comfort).
            </>
          }
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Friction head (KQ²):</strong> Pipe and fitting losses — scales with the square
              of flow
            </li>
            <li>
          ...
          <p>
            <strong>Closed-loop systems (heating, chilled water):</strong> Static head ≈ 0 because
            the loop is balanced. System curve passes through the origin: H = KQ².
          </p>
          <p>
            <strong>Open systems (booster sets, cooling towers):</strong> Significant static head.
            Curve starts at Hstatic at zero flow.
          </p>
          <p>
            <strong>Doubling flow quadruples friction loss.</strong> That's why oversized pumps with
            control valves throttled down waste so much energy — they're operating against an
            inflated resistance curve.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The operating point is where the pump curve crosses the system curve. At that point,
            head produced equals head needed. The system reaches equilibrium and runs steady-state.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Throttle valves (close): system curve steepens → operating point shifts left (lower
              flow, higher head)
            </li>
            <li>
              Open valves: system curve flattens → operating point shifts right (higher flow, lower
              head)
            </li>
            <li>
              Reduce pump speed (VSD): pump curve drops → operating point follows down an affinity
              law line
            </li>
            <li>
              Air lock or blockage: dramatic system steepening → pump heads towards shutoff (low
              flow, high head, motor heat)
            </li>
          </ul>
          <p>
            <strong>Aim:</strong> Operating point should sit close to the pump's BEP. Too far left =
            recirculation, vibration, motor heat. Too far right = cavitation risk, motor overload.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Combined curve doubles flow only if the system curve is flat — usually you get 40-60%
              more flow
            </li>
          ...
          <p>
            <strong>Primary-secondary arrangement:</strong> Common in modern HVAC. Primary pumps run
            at constant flow through the boiler/chiller. Secondary pumps handle building
            distribution, often with VSDs. A bypass pipe hydraulically decouples the two circuits,
            so secondary flow can vary without disturbing plant flow.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Variable speed drives change pump speed by adjusting the motor frequency. Combined with
            the affinity laws (P ∝ N³), they cut energy dramatically when system demand varies.
          </p>
          <p>
            <strong>Throttling vs VSD:</strong> Throttling closes a valve, raising system
            resistance, pushing the pump up its curve — same power, less flow. VSD slows the pump,
            moving down affinity law lines — much less power for the same flow. A 20% flow cut by
            throttling saves ~10%; the same cut via VSD saves ~50%.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Constant discharge pressure:</strong> Simple, but wastes energy at low loads
              (pump still maintains full pressure)
            </li>
            <li>
            ...
            <li>
              <strong>Proportional pressure:</strong> Setpoint reduces with flow — best efficiency
              for variable-volume systems
            </li>
            <li>
              <strong>Sensorless:</strong> Estimates ΔP from speed/power — simpler install, slightly
              less precise
            </li>
          </ul>
          <p>
            <strong>Minimum speed:</strong> Typically 30-40% of full speed. Below that, motor
            cooling fails, pump efficiency collapses, and bearings suffer.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Example 1 - finding the system constant K:</strong> A system has 5 m static head
            and needs 15 m total head at 10 l/s.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              15 = 5 + K × 10² → K = 10/100 = <strong>0.1</strong>
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              H₂ = 20 × 0.8² = <strong>12.8 m</strong>
            </li>
            <li>P₂/P₁ = 0.8³ = 0.512 → 49% energy saving</li>
          </ul>
          <p>
            <strong>Example 3 - friction loss doubling effect:</strong> A circuit at 1 m/s loses 5
            kPa/m friction. At 2 m/s flow, what does it lose?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Friction ∝ v² → ratio (2/1)² = 4</li>
            <li>
              New loss = 5 × 4 = <strong>20 kPa/m</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>No bypass in primary-secondary</strong> — Disturbs plant flow when secondary
                varies
              </li>
              <li>
                <strong>Ignoring minimum flow</strong> — Bearings and motor cooling suffer at very
                low flow
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A 5.5 kW constant-speed CHW pump runs 8,760 hours per year on an office chilled-water
              system. Average load is 50% of design. The client asks for an energy retrofit option.
            </>
          }
          whatToDo={
            <>
              Specify VSD pump matched to the system curve. Apply affinity laws — at 50% load (50%
              flow), the system curve gives ~25% head, requiring ~12.5% input power. Annual energy:
              original 5.5 × 8,760 × 0.5 (load factor) = 24,090 kWh. Retrofit: ~3,000 kWh. Saving:
              ~21,000 kWh/year, payback typically 18-30 months. Specify two-port valves at terminals
              (not three-port mixers) to preserve variable-flow logic and DP setpoint at the index
              leg.
            </>
          }
          whyItMatters={
            <>
              Pumping accounts for 5-15% of building energy use in commercial buildings. VSD
              retrofit on existing systems is one of the highest-return energy interventions
              available — and Part L now drives it on new builds.
            </>
          }
        />
