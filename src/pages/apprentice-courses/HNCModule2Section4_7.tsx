...
const DESCRIPTION = 'Industry standards and guidelines including CIBSE, BS and EN codes';
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['100 dB', '53.5 dB', '50 dB', '52 dB'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['43 m² sabins', '34 m² sabins', '54 m² sabins', '67 m² sabins'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['BS 8233', 'BS EN 12354', 'BS EN ISO 3382', 'BS 4142'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['5.33 W/m²', '11.0 W/m²', '2.67 W/m²', '32 W/m²'],
    correctAnswer: 0,
    explanation:
...
const HNCModule2Section4_7 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 4 · Subsection 7"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The functional requirement is the legal duty; the Approved Document is practical
              guidance issued to show how it can be satisfied. Following it is evidence — not proof
              — of compliance, and an alternative approach is permitted provided you can demonstrate
              the requirement is still met. Approved Document E deals with resistance to the passage
              of sound and Approved Document L with the conservation of fuel and power, which is
              where lighting energy performance is picked up. Always work from the edition in force
              for the project, including any amendments.
            </>
          }
        ...
        >
          <p>
            Lighting and acoustic design in the UK is governed by a stack of documents with very
            different legal standing. Confusing the levels is the most common failure in HNC
            assignments — and in real specifications, where it produces criteria nobody priced and
            criteria nobody can enforce.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Secondary legislation:</strong> Regulations made under an Act — the Building
              Regulations, the Construction (Design and Management) Regulations, the Control of
              Noise at Work Regulations, the Workplace (Health, Safety and Welfare) Regulations.
              These are the law and are mandatory.
            </li>
            <li>
              <strong>Statutory guidance:</strong> the Approved Documents. They illustrate one way
              of meeting a functional requirement. Alternatives are permitted if you can evidence
              compliance.
            </li>
            <li>
              <strong>Standards:</strong> BS, BS EN and BS EN ISO documents. Voluntary in
              themselves, but frequently referenced by legislation, by guidance and by the contract
              — which makes them mandatory in practice.
            </li>
            <li>
              <strong>Industry guidance:</strong> CIBSE Guides and Technical Memoranda, SLL Code for
              Lighting and Lighting Guides, ILP guidance notes, trade association specifications.
              Authoritative professional practice, not law.
            </li>
            <li>
            ...
            <li>
              ...
              specification. Whatever they cite becomes a contractual obligation regardless of its
              status elsewhere on the ladder.
            </li>
          </ul>
          <p>
            ...
            assessment standard. A client enforces the contract. An insurer, after a claim, asks
            whether you followed recognised practice. Each audience reads a different rung of the
            ladder, and your design has to satisfy all of them at once.
          </p>
          <p>
            <strong>Occupational noise is a separate track.</strong> Where employees are exposed to
            high noise levels at work, the Control of Noise at Work Regulations impose duties on the
            employer through daily and weekly exposure action values and an absolute exposure limit
            value. That is health and safety law, enforced by the HSE, and it runs alongside — not
            instead of — the building acoustics documents. A plant room can simultaneously comply
            with a residential sound insulation requirement and breach an occupational exposure
            duty.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            A standard is a legal-technical document with fixed conventions. Reading it correctly is
            a skill in its own right, and it separates an engineer who cites standards from one who
            merely name-drops them.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>BS EN:</strong> a European Standard adopted identically as a British Standard.
              Conflicting national standards are withdrawn on adoption.
            </li>
            <li>
              <strong>BS EN ISO:</strong> one text adopted at international, European and national
              level.
            </li>
            <li>
              <strong>PD / PAS / TS / DD:</strong> published documents, publicly available
              specifications, technical specifications and drafts for development. Useful, but below
              full standard status — never present one as a requirement.
            </li>
            <li>
              <strong>Part numbers:</strong> a hyphenated suffix denotes a part of a series (indoor
              versus outdoor, laboratory versus field measurement). Citing the series without the
              part is ambiguous.
            </li>
            <li>
            ...
            <li>
              <strong>National annex (NA):</strong> UK-specific parameters permitted by the European
              text. Where an NA exists, the UK values in it override the default.
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Normative versus informative:</strong> normative clauses and normative annexes
            carry requirements. Informative annexes, notes, examples and bibliographies do not. A
            note in a standard never contains a requirement — if it appears to, the requirement
            lives in the clause the note is attached to.
          </p>
          <p>
            <strong>Dated and undated references:</strong> a dated reference (standard plus year)
            freezes the edition; only that edition applies. An undated reference means the latest
            edition, including amendments, applies. In a specification the choice is a risk
            decision: date the reference when you need the criteria fixed for the contract, leave it
            undated when you want the contractor to build to current practice.
          </p>
          <p>
            <strong>Scope clause first.</strong> Every standard opens by stating what it covers and
            what it excludes. Half of all misapplications are caught by reading the scope: an indoor
            workplace standard does not cover a car park approach; a laboratory measurement standard
            does not describe a site test.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              document for maintained illuminance, uniformity, glare rating, colour rendering and
              colour appearance by task and area type.
            </li>
            <li>
              <strong>BS EN 12464-2</strong> — the outdoor work places companion: yards, loading
              bays, external circulation, external plant areas.
            </li>
            <li>
              <strong>BS EN 12193</strong> — sports lighting, with performance classes tied to the
              level of competition and to broadcast requirements.
            </li>
            <li>
              <strong>BS EN 1838</strong> — lighting applications, emergency lighting. Sets out what
              escape route, open area and high-risk task area lighting must deliver.
            </li>
            <li>
              <strong>BS 5266-1</strong> — the UK code of practice for emergency lighting of
              premises: system selection, design application, installation, commissioning and the
              periodic test regime.
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              ...
              data. This is why an intensity distribution file from one manufacturer can be compared
              with another&rsquo;s.
            </li>
            <li>
              <strong>BS EN 12464 supporting practice</strong> — verification by measurement: a
              calibrated meter, a defined grid on the working plane, and the maintained value as the
              comparison basis rather than the initial value.
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>BS EN 62471</strong> — photobiological safety of lamps and lamp systems, which
              matters for high-output LED and UV sources.
            </li>
            <li>
              <strong>BS EN 15193 series</strong> — energy performance of buildings, energy
              requirements for lighting. Source of the annual lighting energy indicator concept used
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>ILP guidance notes</strong> — Institution of Lighting Professionals guidance
              on obtrusive light and exterior lighting, routinely cited in planning conditions for
              external schemes.
            </li>
            <li>
          ...
          <p>
            <strong>Discipline point:</strong> the European workplace standard gives the target; the
            CIBSE/SLL guide explains how UK practice interprets it; the product standards let you
            prove the equipment can deliver it. Cite the one that actually supports the statement
            you are making.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Acoustic references split into statutory requirements, assessment methods, measurement
            and rating procedures, prediction methods and sector requirements. A competent HNC
            engineer can say which of those five a document belongs to before opening it.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              insulation between and within dwellings and rooms for residential purposes, internal
              walls and floors, common internal parts and school acoustics by cross-reference.
            </li>
            <li>
              <strong>Pre-completion testing and Robust Details</strong> — two alternative routes to
              demonstrating separating element performance in new residential work. One tests the
              building; the other adopts pre-approved constructions registered and inspected under a
              scheme.
            </li>
            <li>
              <strong>Planning conditions</strong> — typically written around an assessment standard
              and a stated criterion at a defined receptor position. Read the condition wording
              precisely; it, not the standard, is what gets discharged.
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>BS 4142</strong> — methods for rating and assessing industrial and commercial
              sound. The method behind almost every plant noise report submitted with a planning
              application.
            </li>
            <li>
              <strong>CIBSE Guide B4</strong> — noise and vibration control for building services
              systems: plant selection, attenuator sizing, breakout, vibration isolation, design
              criteria for room types.
            </li>
            <li>
              <strong>CIBSE Guide A</strong> — environmental design, which supplies the background
              environmental criteria the acoustic targets sit within.
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              ...
              frequency-band results into single-figure ratings (Rw, DnT,w, Ln,w) and defines the
              spectrum adaptation terms C and Ctr.
            </li>
            <li>
              <strong>BS EN ISO 10140 series</strong> — laboratory measurement of sound insulation
              of building elements. Where a manufacturer&rsquo;s partition data comes from.
            </li>
            <li>
              <strong>BS EN ISO 16283 series</strong> — field measurement of sound insulation in
              buildings: airborne, impact and facade. The site test procedure.
            </li>
            <li>
            ...
            <li>
              ...
              buildings from the performance of elements. The prediction route, including flanking
              transmission.
            </li>
            <li>
              <strong>BS EN ISO 1996 series</strong> — description, measurement and assessment of
              environmental noise.
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Education</strong> — acoustic design of schools guidance, giving performance
              standards for teaching and learning spaces, referenced from the Approved Document.
            </li>
            <li>
            ...
            <li>
              ...
              guidance, where the concern is employee exposure rather than building performance.
            </li>
          </ul>
          <p>
            <strong>Discipline point:</strong> do not quote a laboratory rating where a field rating
            is required. Laboratory Rw excludes flanking; the field descriptor DnT,w includes
            everything the real building does. Specifications that mix them produce partitions that
            pass on paper and fail on test.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            A design criteria schedule is a list of symbols. Each one has a defining document, a
            measurement method and a tolerance. If you cannot name all three for a line on your
            schedule, that line cannot be enforced.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ēm</strong> — maintained illuminance on the reference surface, in lux. The
              design target and the value verified on site.
            </li>
            <li>
              <strong>U₀</strong> — illuminance uniformity, the ratio of minimum to average over the
              reference area.
            </li>
            <li>
              <strong>UGR</strong> — unified glare rating, a calculated discomfort glare index for
              the observer positions and viewing directions stated.
            </li>
            <li>
              <strong>Ra / CRI</strong> — colour rendering index, how faithfully surface colours
              appear under the source.
            </li>
            <li>
              <strong>CCT</strong> — correlated colour temperature in kelvin, the apparent warmth or
              coolness of the light.
            </li>
            <li>
              <strong>MF</strong> — maintenance factor, the depreciation allowance linking initial
              to maintained illuminance.
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>DnT,w</strong> — weighted standardised level difference between two rooms as
              built, including flanking. Add C or Ctr where the spectrum matters.
            </li>
            <li>
              <strong>L&prime;nT,w</strong> — weighted standardised impact sound pressure level in
              the receiving room. Lower is better, which catches people out.
            </li>
            <li>
            ...
            <li>
              <strong>LAeq,T</strong> — equivalent continuous A-weighted level over a stated period.
            ...
            <li>
              <strong>LAFmax</strong> — maximum A-weighted level with fast time weighting, used for
              intermittent events such as a night-time delivery or a plant start.
            </li>
            <li>
              <strong>NR / NC</strong> — noise rating and noise criteria curves, single-figure room
              criteria derived by comparing octave-band levels against a family of curves.
            </li>
          </ul>
          <p>
            <strong>The three questions for every criterion:</strong> which document defines the
            descriptor, what measurement method verifies it, and at what position and time is it
            assessed? &ldquo;NR 30&rdquo; alone is not a criterion. &ldquo;NR 30 from building
            services plant, measured in the centre of the room with the space unoccupied and all
            systems at design duty&rdquo; is.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            contains offices, a school teaching block, a plant room adjoining flats and an external
            service yard. Which document governs which line?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              ...
              verified by field measurement to the <strong>BS EN ISO 16283 series</strong> and rated
              to the <strong>BS EN ISO 717 series</strong>.
            </li>
            <li>
              Plant noise at the nearest residential facade → <strong>BS 4142</strong>, against the
            ...
            <li>
              ...
              lighting energy indicator from the <strong>BS EN 15193 series</strong> where an
              assessment requires it.
            </li>
            <li>
              <strong>Take the numeric targets from the current edition of each document</strong> at
              the time you issue the schedule — never from a previous project&rsquo;s spreadsheet.
            </li>
          </ul>
          <p>
            <strong>Example 2: Installed power density and efficacy check.</strong> The 12 m × 8 m
            classroom from Subsection 4.2 has been lit with 16 LED panels, each 4,000 lm at 32 W
            circuit power, for a 300 lux maintained target. Check the energy metrics before issuing.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              Compare each figure against the metric the current energy document actually asks for —
              efficacy, power density or an annual indicator are three different tests and a scheme
          ...
          <p>
            ...
            measured specific sound level from the chiller at the facade is 44 dB LAeq. The source
            has an audible tonal component, so a character correction of +3 dB is applied. The
            representative background sound level in the assessment period is 39 dB LA90.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              The standard then requires the margin to be interpreted <strong>in context</strong> —
              absolute levels, the character of the residual environment, the sensitivity of the
              receptor and any mitigation already applied. Take the interpretation wording from the
              current edition; do not reduce it to a remembered pass/fail number.
            </li>
            <li>
              Design response: if mitigation is needed, an attenuated condenser, a screen breaking
              line of sight, or a lower fan speed at night each reduce the specific level — and
              removing the tonal character removes the correction as well, worth 3 dB on its own
              here.
            </li>
          </ul>
          <p>
            <strong>Example 4: Reverberation-time shortfall in a classroom.</strong> The same 12 m ×
            8 m room has a 2.8 m floor-to-ceiling height, and the project&rsquo;s governing document
            sets a mid-frequency reverberation time target of 0.8 s. Existing finishes provide
            roughly 20 m² sabins of absorption. How much acoustic ceiling is needed?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Room volume V = 12 × 8 × 2.8 = <strong>268.8 m³</strong>
            </li>
            <li>Sabine: T = 0.161 V / A, so A = 0.161 V / T</li>
            <li>
            ...
            <li>
              Coordination consequence: 38 m² of perforated tile has to coexist with 16 luminaires,
              diffusers, detectors and speakers on the same grid — which is why the acoustic
              criterion belongs on the reflected ceiling plan, not just in a report.
            </li>
            <li>
              Verify on completion by measurement to the room-acoustics measurement standard, with
              the room in its stated furnished condition.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            the alternative adopted, the evidence that the underlying requirement is still met, and
            the name and date of the person who accepted it. A documented departure is engineering
            judgement; an undocumented one is indistinguishable from an error.
          </p>
          <p>
            ...
            measurement (commissioning) → record (handover file). A break anywhere in that chain is
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Treating guidance as law (or law as optional):</strong> both errors produce
                indefensible specifications
              </li>
              <li>
              ...
              <li>
                <strong>Mixing laboratory and field descriptors:</strong> specifying Rw where DnT,w
                is what will actually be tested on site
              </li>
              <li>
                <strong>Criteria with no verification method:</strong> a number nobody can measure
                is a number nobody has to achieve
              </li>
              <li>
                <strong>Ignoring the sector document:</strong> healthcare and education requirements
                are frequently stricter than the general standard
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              You are the building services engineer on a two-storey teaching block reaching
              practical completion. The contractor has asked for sign-off on lighting and acoustics.
              Approved Document E applies via the education sector acoustic requirements, the
              lighting was designed to the European indoor workplace standard interpreted through
              the relevant SLL Lighting Guide, escape lighting to the emergency lighting standard
              and its UK code of practice, and a planning condition on plant noise was written
              around the industrial and commercial sound assessment standard. The client&rsquo;s
              technical adviser has asked for the evidence, not the assurances.
            </>
          }
          whatToDo={
            <>
              Assemble one row per criterion. For lighting: design calculation, the maintained
              illuminance and uniformity targets with the governing document named, and a grid
              measurement with a calibrated meter for each room type. For escape lighting: the
              design layout, the duration test result and the completion certificate, plus the
              logbook handed to the responsible person. For teaching-space acoustics: predicted
              reverberation time, the installed absorption schedule, and a room measurement to the
              room-acoustics standard in the stated furnished condition. For separating
              constructions: field sound insulation tests to the field measurement standard, rated
              to the single-figure rating standard, reported as the field descriptor — not the
              manufacturer&rsquo;s laboratory figure. For plant noise: an in-situ measurement at the
              position named in the planning condition, assessed by the method the condition cites.
              Attach every instrument calibration certificate. Where anything departs from the
              design criterion, record the departure formally with the acceptance.
            </>
          }
          whyItMatters={
            <>
              Handover is where the standards stop being reading and start being liability. A school
              that fails an acoustic test after occupation is a remediation project inside a live
              building, during term. An escape lighting system without a logbook leaves the
              responsible person unable to discharge their duty from day one. The evidence pack is
              the only thing that shows the design criteria were real — and years later, in a
              dispute, it is the only thing anybody reads.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Human Comfort</div>
          </button>
