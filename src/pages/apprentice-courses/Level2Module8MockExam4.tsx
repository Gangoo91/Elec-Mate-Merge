...
const Level2Module8MockExam4 = () => {
  useSEO(
    "Mock Exam 4: Installing Wiring Systems & Enclosures - Level 2 Module 8",
    "Test your knowledge of wiring systems, cable installation, enclosures, and electrical containment systems for Level 2 electrical installation."
  );
  ...
  if (!examStarted) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-2xl bg-card border-emerald-500/30">
            ...
            <div className="text-center space-y-6">
              <div>
                ...
                <p className="text-muted-foreground">
                  Level 2 Electrical Installation - Mock Exam 4
                </p>
              </div>

              <div className="bg-background/50 p-6 rounded-lg border border-emerald-500/30">
                <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-4">Exam Instructions</h2>
                <ul className="text-sm text-muted-foreground space-y-2 text-left">
                  <li>• 30 questions covering wiring systems, cables, and enclosures</li>
              ...
              <Button 
                onClick={startExam}
                className="bg-emerald-500 hover:bg-emerald-500/90 text-black font-bold text-lg px-12 py-4"
                size="lg"
              >
                Start Exam
          ...
          <Card className="border-emerald-500/30 bg-card">
            <CardContent className="p-6">
              <div className="text-center mb-6">
                ...
                <h2 className="text-lg text-emerald-400">Installing Wiring Systems & Enclosures</h2>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-xs text-center text-muted-foreground pt-2 border-t border-emerald-500/30">
                    <div>Exam: Module 4</div>
                    <div>Wiring Systems & Enclosures</div>
                  </div>
                </div>
              </div>
            </CardContent>
...
export default Level2Module8MockExam4;