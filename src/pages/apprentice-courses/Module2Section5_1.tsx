...
const DESCRIPTION =
  'Learn about conductors and insulators - definitions, examples, and practical applications in electrical installations.';

const quickCheckQuestions = [
  {
    id: 'resistivity',
    question: 'Which symbol represents resistivity in electrical calculations?',
    options: ['σ (sigma)', 'ρ (rho)', 'ε (epsilon)', 'λ (lambda)'],
    correctIndex: 1,
    explanation:
      "Resistivity is denoted by the Greek letter rho (ρ), measuring a material's resistance to current flow.",
  },
  {
    id: 'conductor-temp',
    ...
    correctIndex: 1,
    explanation:
      'Metal resistance generally increases with temperature - this must be considered in design calculations.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Insulation prevents dangerous current leakage and provides essential safety protection.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Copper has high conductivity, making it ideal for conductors in cables and busbars.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Metal resistance increases with temperature; design must consider operating temperature.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'High insulation resistance minimises leakage currents and the risk of shock and fire.',
  },
  {
    id: 8,
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'Resistance is directly proportional to resistivity (ρ) and length (L), and inversely proportional to cross-sectional area (A).',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'High dielectric strength allows insulation to withstand voltage without breakdown, ensuring safety and reliability.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Conductors (like copper) have low resistivity and allow current flow easily. Insulators (like PVC) have high resistivity and resist current flow, providing safety and preventing leakage.',
  },
  {
    question: 'Why is copper preferred over aluminium for most installations?',
    answer:
      "Copper has lower resistivity than aluminium, meaning smaller cable sizes can carry the same current. It's also easier to terminate and less prone to connection problems.",
  },
  {
    question: 'Can I repair damaged cable insulation with tape?',
    answer:
      'No. Damaged insulation in fixed wiring must be properly repaired or the cable replaced. Tape is not an acceptable permanent repair for mains voltage cables.',
  },
  {
    question: 'How does temperature affect cable performance?',
    answer:
      'Higher temperatures increase conductor resistance (reducing current capacity) and can degrade insulation. Cable ratings include temperature derating factors - see BS 7671 Appendix 4.',
  },
  {
    question: "What does 'dielectric strength' mean?",
    answer:
      'Dielectric strength is the maximum voltage an insulating material can withstand before breakdown occurs. Higher dielectric strength means better insulation performance.',
  },
];
  ...
  return (
    <div className="bg-[#1a1a1a] overflow-x-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Conductors:</strong> Low resistivity (ρ) - copper, aluminium allow current
                  flow
                </li>
                <li>
                  <strong>Insulators:</strong> High resistivity - PVC, XLPE, rubber prevent current
                  flow
                </li>
                <li>
                  <strong>Resistance formula:</strong> R = ρL/A (resistivity × length ÷ area)
                </li>
                <li>
                  <strong>Temperature effects:</strong> Metal resistance increases with heat
                </li>
                <li>
                  <strong>Safety:</strong> Good insulation prevents shock and fire risk
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> T&E copper cores, PVC sheathing, SWA armour, XLPE
                  insulation
                </li>
                <li>
                  <strong>Use:</strong> Check cable markings for conductor/insulation type and
                  ratings
                </li>
                <li>
                  <strong>Apply:</strong> Select appropriate materials for environment and load
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow bg-card/30 p-6 rounded-r-lg">
            <h2 className="text-lg sm:text-xl font-semibold text-white mb-4 flex items-center gap-2">
            ...
            <div className="space-y-4 text-white">
              <p>
                Electrical materials are classified by their ability to conduct electricity. This
                fundamental property, measured as resistivity (ρ), determines how and where
                materials are used in electrical installations. Understanding these properties is
                essential for safe cable selection, current capacity calculations, and fault
                analysis.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-card border border-border/30 p-4 rounded-lg">
                  ...
                  <div className="space-y-2 text-white text-sm">
                    <div>
                      <p>
                        <strong>Copper (Cu):</strong> ρ ≈ 17.2 nΩ·m at 20°C
                      </p>
                    ...
                    <div>
                      <p>
                        <strong>Aluminium (Al):</strong> ρ ≈ 28.2 nΩ·m at 20°C
                      </p>
                      <ul className="list-disc pl-4 space-y-1">
                    ...
                    <div>
                      <p>
                        <strong>Steel:</strong> Much higher resistivity
                      </p>
                      <ul className="list-disc pl-4 space-y-1">
                ...
                <div className="bg-card border border-border/30 p-4 rounded-lg">
                  ...
                  <div className="space-y-2 text-white text-sm">
                    ...
                    <div>
                      <p>
                        <strong>XLPE (Cross-Linked Polyethylene):</strong>
                      </p>
                      <ul className="list-disc pl-4 space-y-1">
                    ...
                    <div>
                      <p>
                        <strong>Rubber and Elastomers:</strong>
                      </p>
                      <ul className="list-disc pl-4 space-y-1">
              ...
              <div className="bg-indigo-500/10 border border-indigo-400/30 p-4 rounded-lg">
                <h4 className="font-semibold text-indigo-300 mb-2">
                  Practical Example: Resistance Calculation
                </h4>
                <div className="text-indigo-200 text-sm space-y-2">
                  <p>
                    <strong>Scenario:</strong> 50m run of 2.5mm² copper conductor at 20°C
                  </p>
                  ...
                  <p>
                    <strong>Application:</strong> This resistance affects voltage drop calculations
                    and heating effects in the conductor.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow bg-card/30 p-6 rounded-r-lg">
            ...
            <div className="space-y-4 text-white">
              <p>
                Temperature significantly affects both conductors and insulators. Understanding
                these effects is crucial for safe installation design, current capacity
                calculations, and long-term reliability. BS 7671 provides detailed guidance on
                temperature considerations in Appendix 4.
              </p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="bg-card border border-elec-yellow/30 p-4 rounded-lg">
                      ...
                      <div className="space-y-2 text-elec-yellow text-sm">
                        <p>
                          <strong>Derating Factors (Appendix 4):</strong>
                        </p>
                        <ul className="list-disc pl-4 space-y-1">
                        ...
                        <p className="text-xs">
                          <strong>Example:</strong> 35°C ambient = 0.94 derating factor
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
                    <div className="bg-card border border-elec-yellow/30 p-4 rounded-lg">
                      ...
                      <div className="text-elec-yellow text-sm space-y-1">
                        <p>
                          <strong>70°C conductor temperature</strong>
                        </p>
                        <ul className="list-disc pl-4 space-y-1">
                    ...
                    <div className="bg-card border border-elec-yellow/30 p-4 rounded-lg">
                      ...
                      <div className="text-elec-yellow text-sm space-y-1">
                        <p>
                          <strong>90°C conductor temperature</strong>
                        </p>
                        <ul className="list-disc pl-4 space-y-1">
                ...
                <div className="bg-card border border-border/30 p-4 rounded-lg">
                  <h4 className="font-semibold text-elec-yellow mb-2">
                    Worked Example: Temperature Correction
                  </h4>
                  <div className="text-white text-sm space-y-2">
                    <p>
                      <strong>Scenario:</strong> 2.5mm² T&E cable in 40°C ambient, grouped with 5
                      other circuits
                    </p>
                    <div className="bg-orange-600/20 p-3 rounded space-y-1">
                      <p>
                        <strong>Step 1:</strong> Base rating (Reference Method C) = 27A
                      </p>
                      <p>
                        <strong>Step 2:</strong> Temperature derating (40°C) = 0.87
                      </p>
                      <p>
                        <strong>Step 3:</strong> Grouping factor (6 circuits) = 0.57
                      </p>
                      <p>
                        <strong>Result:</strong> Actual rating = 27 × 0.87 × 0.57 = 13.4A
                      </p>
                    </div>
                    <p>
                      <strong>Conclusion:</strong> Significant reduction from base rating due to
              ...
              <div className="bg-card border border-border/30 p-4 rounded-lg">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-elec-yellow space-y-2">
                    <p>
                      <strong>Critical Safety Points:</strong>
                    </p>
                    <ul className="list-disc pl-4 space-y-1 text-sm">
                      <li>
                        Overheated insulation can fail catastrophically, causing fire or shock risk
                      </li>
                      <li>
                        Always apply appropriate derating factors - don't rely on base cable ratings
                      </li>
                      <li>Consider worst-case ambient conditions over the cable's lifetime</li>
                      <li>
                        Monitor installation temperatures, especially in plant rooms and roof spaces
                      </li>
                      <li>
                        Thermal runaway can occur if cables overheat and resistance increases
                        further
                      </li>
                    </ul>
                  </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500 bg-card/30 p-6 rounded-r-lg">
            <h2 className="text-lg sm:text-xl font-semibold text-white mb-4 flex items-center gap-2">
            ...
            <div className="space-y-4 text-white">
              <p>
                Proper material selection requires systematic analysis of electrical, environmental,
                and economic factors. BS 7671 Part 5 provides comprehensive guidance on selection
                and erection of electrical equipment and wiring systems.
              </p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="bg-card border border-border/30 p-4 rounded-lg">
                      ...
                      <div className="space-y-2 text-white text-sm">
                        <p>
                          <strong>External Influences (BS 7671 Appendix 5):</strong>
                        </p>
                        <ul className="list-disc pl-4 space-y-1">
                        ...
                        <p>
                          <strong>Installation Conditions:</strong>
                        </p>
                        <ul className="list-disc pl-4 space-y-1">
                  ...
                  <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
                    <div className="bg-card border border-border/30 p-4 rounded-lg">
                      ...
                      <div className="text-white text-sm space-y-1">
                        ...
                        <p>
                          <strong>Support and Containment:</strong>
                        </p>
                        <ul className="list-disc pl-4 space-y-1">
                    ...
                    <div className="bg-card border border-border/30 p-4 rounded-lg">
                      ...
                      <div className="text-white text-sm space-y-1">
                        <p>
                          <strong>Connection Integrity:</strong>
                        </p>
                        <ul className="list-disc pl-4 space-y-1">
                    ...
                    <div className="bg-card border border-border/30 p-4 rounded-lg">
                      ...
                      <div className="text-white text-sm space-y-1">
                        <p>
                          <strong>Initial Verification Tests:</strong>
                        </p>
                        <ul className="list-disc pl-4 space-y-1">
                ...
                <div className="bg-card border border-border/30 p-4 rounded-lg">
                  <h4 className="font-semibold text-elec-yellow mb-2">
                    Case Study: Office Building Feeder Selection
                  </h4>
                  <div className="text-white text-sm space-y-2">
                    <p>
                      <strong>Requirements:</strong> 63A three-phase feeder, 80m run, 35°C plant
                      room
                    </p>
                    <div className="bg-elec-yellow/20 p-3 rounded space-y-1">
                      <p>
                        <strong>Option 1 - Copper:</strong> 16mm² SWA, higher cost but compact
                      </p>
                      <p>
                        <strong>Option 2 - Aluminium:</strong> 25mm² SWA, lower cost but larger
                      </p>
                      <p>
                      ...
                      <p>
                        <strong>Decision:</strong> Copper selected due to voltage drop limits,
                        despite higher cost
                      </p>
                    </div>
                    <p>
                      <strong>Learning Point:</strong> Material selection must consider all
            ...
            <div>
              ...
              <div className="bg-card border border-border/30 p-4 rounded-lg">
                <ul className="list-disc pl-4 space-y-2 text-sm text-white">
                  <li>
                    <strong>Wrong material selection:</strong> Not considering environment or
                    application requirements
                  </li>
                  <li>
                    <strong>Inadequate protection:</strong> Exposing cables to mechanical damage or
                    unsuitable conditions
                  </li>
                  <li>
                    <strong>Poor terminations:</strong> Incorrect connectors, insufficient torque,
                    or mixed materials
                  </li>
                  <li>
                    <strong>Ignoring temperature:</strong> Not applying derating factors or
                    considering ambient conditions
                  </li>
                  <li>
                    <strong>Damaged insulation:</strong> Attempting repairs with tape instead of
                    proper replacement
                  </li>
                </ul>
              </div>
            ...
            <div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <ul className="list-disc pl-4 space-y-2 text-sm text-elec-yellow/80">
                  <li>
                    <strong>Study BS 7671 Part 5:</strong> Selection and erection of electrical
                    equipment
                  </li>
                  <li>
                    <strong>Learn Appendix 4:</strong> Current-carrying capacity and voltage drop
                    tables
                  </li>
                  <li>
                    <strong>Understand testing:</strong> How material properties affect test results
                  </li>
                  <li>
                    <strong>Practice identification:</strong> Learn to read cable markings and
                    specifications
                  </li>
                  <li>
                    <strong>Stay informed:</strong> New materials and standards are regularly
                    introduced
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-card border border-border/30 p-3 rounded-lg">
                  ...
                  <ul className="space-y-1 text-white text-xs">
                    <li>
                      • <strong>Copper:</strong> Low ρ, easy termination, T&E/flex
                    </li>
                    <li>
                      • <strong>Aluminium:</strong> Light, cheap, needs larger CSA
                    </li>
                    <li>
                      • <strong>Steel:</strong> SWA armour, earthing, not live conductors
                    </li>
                    <li>
                      • <strong>R = ρL/A:</strong> Bigger CSA = lower resistance
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-card border border-border/30 p-3 rounded-lg">
                  ...
                  <ul className="space-y-1 text-white text-xs">
                    <li>
                      • <strong>PVC:</strong> 70°C rating, T&E sheathing
                    </li>
                    <li>
                      • <strong>XLPE:</strong> 90°C rating, SWA insulation
                    </li>
                    <li>
                      • <strong>LSF/LSZH:</strong> Low smoke, fire performance
                    </li>
                    <li>
                      • <strong>Rubber:</strong> Flexible, harsh environments
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-card border border-elec-yellow/30 p-3 rounded-lg">
                  ...
                  <ul className="space-y-1 text-elec-yellow text-xs">
                    <li>
                      • <strong>Temperature:</strong> Apply derating factors (App 4)
                    </li>
                    <li>
                      • <strong>Environment:</strong> Match material to conditions
                    </li>
                    <li>
                      • <strong>Terminations:</strong> Correct lugs and torque
                    </li>
                    <li>
                      • <strong>Protection:</strong> Avoid mechanical damage
                    </li>
                    <li>
                      • <strong>Testing:</strong> IR ≥1MΩ, continuity checks
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-card border border-border/30 p-3 rounded-lg">
                  ...
                  <ul className="space-y-1 text-white text-xs">
                    <li>
                      • <strong>Isolation:</strong> Lock-off before conductor work
                    </li>
                    <li>
                      • <strong>Damage:</strong> Replace, don't tape fix insulation
                    </li>
                    <li>
                      • <strong>Mixed materials:</strong> Use bimetallic connectors
                    </li>
                    <li>
                      • <strong>Overheating:</strong> Check current capacity limits
                    </li>
                  </ul>
                </div>
              </div>
        ...
        {/* Quiz */}
        <Quiz title="Test Your Knowledge: Conductors and Insulators" questions={quizQuestions} />
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/apprentice/level2/module2/section5/5-2">
              Next
