      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Prevention, fire extinguishers, and evacuation - protecting life and property
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Understand fire prevention principles and the fire triangle",
              "Identify fire classes and appropriate extinguisher types",
              "Know how to use fire extinguishers safely and effectively",
              "Understand hot works procedures and permits",
              "Apply evacuation procedures correctly",
              "Recognise the electrician's role in fire prevention"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module1-section4-3">
              <ArrowLeft className="w-4 h-4 mr-2" />
          ...
          <Button
            ...
            asChild
          >
            <Link to="../level3-module1-section4-5">
