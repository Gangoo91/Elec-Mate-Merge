      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Ohm's Law:</strong> V = I x R — voltage, current and resistance relationship
              </li>
              <li className="pl-1">
                <strong>Watt's Law:</strong> P = I x V — power, current and voltage relationship
              </li>
              <li className="pl-1">
                <strong>Series:</strong> Current same everywhere; voltages add; resistances add
              </li>
              <li className="pl-1">
                <strong>Parallel:</strong> Voltage same everywhere; currents add; reciprocal
                resistances add
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Fault-finding:</strong> Compare measured V, I, R against calculated values
              </li>
              <li className="pl-1">
                <strong>Cable losses:</strong> P = I squared R gives heat generated in conductors
              </li>
              <li className="pl-1">
                <strong>Load assessment:</strong> I = P / V determines circuit loading
              </li>
              <li className="pl-1">
                <strong>ST1426:</strong> Essential calculation skills for maintenance practice
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Cover V — leaves I x R (voltage = current multiplied by resistance)
                </li>
                <li className="pl-1">
                  Cover I — leaves V over R (current = voltage divided by resistance)
                </li>
                <li className="pl-1">
                  Cover R — leaves V over I (resistance = voltage divided by current)
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Worked Example — Maintenance Scenario
              </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                Ohm's Law assumes constant resistance. In practice, the resistance of many
                components changes with temperature (filament lamps, heating elements), voltage
                polarity (diodes), or light level (LDRs). These are called 'non-ohmic' or
                'non-linear' devices. For AC circuits with inductors or capacitors, we must use
                impedance (Z) instead of simple resistance — impedance includes both resistance and
                reactance: V = I x Z. This is covered in detail in later sections.
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                The formula P = I²R is particularly important in maintenance because it describes
                the heat generated in any conductor carrying current. Since power loss is
                proportional to the
                <strong> square</strong> of the current, doubling the current quadruples the heat
                loss. This is why overloaded cables become dangerously hot, why high-resistance
                joints cause fires, and why BS 7671 places strict limits on cable current-carrying
                capacity. During thermal imaging surveys, you are looking for evidence of excessive
                I²R heating at connections and joints.
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Three Rules of Series Circuits
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white">
                ...
                supply: V1 = 100 x 20/100 = 20 V, V2 = 100 x 80/100 = 80 V. The larger resistor
                drops the larger voltage.
              </p>
            </div>

            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Worked Example — Series Circuit Analysis
              </p>
              <p className="text-sm text-white mb-2">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              <p className="text-sm font-medium text-orange-400 mb-2">
                Series Circuits in Maintenance
              </p>
              <p className="text-sm text-white">
                The most common series circuit you will encounter is a safety interlock chain —
                emergency stop buttons, guard switches, and safety relays connected in series so
                that opening any one device breaks the circuit and stops the machine. Understanding
                series behaviour is essential for troubleshooting these circuits. If the machine
                will not start, check for an open switch or broken conductor anywhere in the series
                chain using a voltmeter to identify where voltage is being dropped.
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                There are several methods for calculating total parallel resistance, depending on
                the situation:
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                ...
                proportion to their resistance — more current flows through the lower resistance
                path:
              </p>
              <div className="text-center mb-3">
                <p className="text-lg font-mono text-elec-yellow">
              ...
              <p className="text-sm text-white">
                For two resistors in parallel, a useful shortcut: I1 = I(total) x R2 / (R1 + R2).
                Note that the 'other' resistor appears in the numerator — the current in one branch
                depends on the resistance of the other branch.
              </p>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Parallel Circuits in Maintenance Practice
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  ...
                  conduit, extraneous conductive parts) reduce the overall earth fault loop
                  impedance, improving protection
                </li>
                <li className="pl-1">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Step 3:</strong> Calculate the 'missing' quantity using Ohm's Law or
                  Watt's Law
                </li>
                <li className="pl-1">
                  <strong>Step 4:</strong> Compare measured/calculated values against expected
                  values
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-3">
                Case Study: High-Resistance Joint
              </p>
              <p className="text-sm text-white mb-2">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Using Voltage Drop for Fault Location
              </p>
              <p className="text-sm text-white">
                In a series circuit (such as a long cable run), you can locate a fault by measuring
                the voltage at different points along the circuit. A significant voltage drop across
                a short section indicates high resistance at that point — typically a damaged
                conductor, corroded joint, or loose connection. Under load, measure the voltage at
                the supply end and at the load end. The difference is the total voltage drop. If
                this exceeds the BS 7671 limit (typically 3-5% of the nominal supply voltage),
                identify where in the run the excessive drop occurs by measuring at intermediate
                points.
              </p>
            </div>
