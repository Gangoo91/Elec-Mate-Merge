...
const quizQuestions = [
  ...
  {
    id: 9,
    question: "A 'snubber' or freewheeling protection across a DC relay coil typically consists of:",
    options: [
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Capacitors</strong> store energy in an electric field (E = ½CV²)
              </li>
              <li className="pl-1">
                <strong>Inductors</strong> store energy in a magnetic field (E = ½LI²)
              </li>
              <li className="pl-1">
                <strong>RC time constant</strong> τ = R x C (seconds)
              </li>
              <li className="pl-1">
                <strong>RL time constant</strong> τ = L / R (seconds)
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Common Capacitor Types in Maintenance
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Tantalum electrolytic:</strong> Smaller than aluminium electrolytic for
                  the same capacitance. Polarised. Used in electronic control boards. Can fail
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                When a capacitor charges through a resistor, the voltage rises exponentially
                according to the RC time constant:
              </p>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>1τ:</strong> Capacitor charges to 63.2% of supply voltage (or discharges
                  to 36.8%)
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              <p className="text-sm font-medium text-red-400 mb-2">
                Capacitor Safety — Stored Energy Hazard
              </p>
              <p className="text-sm text-white mb-3">
                Capacitors present a unique and serious safety hazard because they retain stored
                energy after the supply is disconnected. Key safety considerations:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Energy:</strong> E = ½CV². A 1,000 μF capacitor at 400 V stores 80 J —
                  enough to cause fatal injury
                </li>
                <li className="pl-1">
                  <strong>Discharge time:</strong> Depends on the discharge resistance. Internal
                  bleeder resistors may take 1-10 minutes. If the bleeder resistor fails (open
                  circuit), the capacitor can remain charged indefinitely
                </li>
                <li className="pl-1">
                  <strong>Verification:</strong> Always measure the voltage across the capacitor
                  terminals with a suitable DC voltmeter before handling. Do not rely on the bleeder
                  circuit alone
                </li>
                <li className="pl-1">
                  <strong>Safe discharge:</strong> If manual discharge is required, use an insulated
                  discharge tool (resistor with insulated probes) — never short-circuit a charged
                  capacitor directly (explosive discharge, contact welding, component damage)
                </li>
                <li className="pl-1">
                  <strong>BS EN 60831:</strong> PFC capacitors must discharge to below 50 V within
                  one minute of disconnection
                </li>
              </ul>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> The voltage rating on a capacitor is the maximum
              continuous voltage it can withstand. Exceeding this rating, even briefly, can cause
              dielectric breakdown, short circuit and potentially explosive failure — particularly
              for electrolytic capacitors. Always replace capacitors with the same or higher voltage
              rating.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p>
              Inductors are governed by two fundamental laws of electromagnetic induction: Faraday's
              law (the magnitude of induced EMF is proportional to the rate of change of magnetic
              flux linkage) and Lenz's law (the direction of induced EMF opposes the change
              producing it). Together, these laws explain why inductors oppose changes in current —
              a property that is both useful (in filters, chokes and transformers) and potentially
              hazardous (back-EMF voltage spikes).
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Practical consequence:</strong> An inductor opposes any increase in
                  current (self-induced back-EMF) and opposes any decrease in current (maintaining
                  current flow through any available path)
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  ...
                  switch-mode power supplies, EMC filters and high-frequency chokes. Low eddy
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                RL Time Constant and Energy Storage
              </p>
              <p className="text-sm text-white mb-3">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                RC and RL Time Constants Compared
              </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Practical Time Constant Examples
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>VSD DC bus capacitor discharge:</strong> C = 1000 μF, bleeder R = 100 kΩ.
                  τ = 100 s. To discharge to less than 50 V from 565 V (peak of 400 V): requires
                  approximately 5τ = 500 s (8.3 minutes). This explains why manufacturer discharge
                  times are typically 5-15 minutes
                </li>
                <li className="pl-1">
                  <strong>Motor start circuit:</strong> L = 0.5 H, R = 5 Ω. τ = 0.1 s. Current
                  reaches 99% of steady-state in 0.5 s. This matches the typical motor starting time
                  for a small motor
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Capacitor Applications in Maintenance
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  ...
                  audible hum. ESR (equivalent series resistance) increases with age — measurable
                  with ESR meter
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Inductor Applications in Maintenance
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>VSD line reactors (chokes):</strong> Series inductors on VSD input to
                  reduce harmonic current distortion by 30-50%. Typically 3-5% impedance. Check for
                  core vibration (loose laminations), overheating and insulation degradation
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  ...
                  capacitance function. Compare reading to rated value — should be within ±10%.
                  Ensure capacitor is fully discharged before testing
                </li>
                <li className="pl-1">
                  <strong>ESR test:</strong> An ESR (equivalent series resistance) meter measures
                  the internal resistance of a capacitor. High ESR indicates degradation (dried-out
                ...
                <li className="pl-1">
                  ...
                  case/chassis with an insulation resistance tester at an appropriate voltage.
                  Minimum 2 MΩ for LV capacitors
                </li>
                <li className="pl-1">
                  <strong>Inductance test:</strong> Use an LCR meter to measure inductance. Compare
                  to rated value. Low readings may indicate shorted turns
                </li>
                <li className="pl-1">
                  <strong>Winding resistance:</strong> Measure with a low-resistance ohmmeter.
                  Compare between phases (for three-phase equipment) — a significant imbalance
                  indicates a winding fault. Compare to previous measurements for trend analysis
                </li>
                <li className="pl-1">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Wait the manufacturer's specified discharge time (typically 5-15 minutes for VSDs)
                </li>
                <li className="pl-1">
                  Verify discharge by measuring DC voltage across capacitor terminals with a
                ...
                <li className="pl-1">
                  When replacing, ensure the new capacitor matches the voltage and capacitance
                  ratings (voltage may be higher, never lower)
                </li>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Motor windings retain residual magnetism — a motor can generate voltage if the
                  shaft is rotated externally
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  When replacing relay/contactor coils, ensure suppression devices (flyback diodes,
                  RC snubbers) are also checked and replaced if necessary
                </li>
              </ul>
            </div>
          </div>
        ...
        {/* Quiz */}
        <section className="mb-10">
          <Quiz title="Test Your Knowledge — Capacitors and Inductors" questions={quizQuestions} />
        </section>
