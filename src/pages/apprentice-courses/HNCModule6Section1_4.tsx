...
const quickCheckQuestions = [
  {
    ...
    options: [
      'Litres per second per person at the design occupancy (l/s per person)',
      'Air changes per hour under normal atmospheric pressure (ACH)',
      'Watts per square metre per kelvin across the envelope (W/m²K)',
  ...
  },
  {
    ...
    options: [
      'To measure the thermal conductivity (U-value) of the external walls',
      'To verify the mechanical ventilation system delivers its design air flow rates',
      'To pressurise the building to identify air leakage paths and measure overall airtightness',
      'To test the fire resistance and smoke sealing of compartment walls',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The building achieves the lowest air permeability physically possible',
      'The tester is qualified and uses calibrated equipment to recognised standards',
      'The dwelling is exempt from any further Part L compliance checks',
      'The mechanical ventilation system has been commissioned to design flow rates',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Diffusion of air directly through solid masonry walls',
      'Service penetrations through the air barrier',
      'Heat loss through thermal bridging at junctions',
      'Condensation forming within the cavity insulation',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['3 m³/h.m² @ 50Pa', '8 m³/h.m² @ 50Pa', '5 m³/h.m² @ 50Pa', '10 m³/h.m² @ 50Pa'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Before the air barrier is installed, while the structure is still open',
      'Only at practical completion, once all finishes are in place',
      'After the air barrier is complete but before internal finishes',
      'After handover, once the building is occupied and in use',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['50 Pa', '25 Pa', '75 Pa', '100 Pa'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Decorator’s caulk applied around the faceplate after fitting',
      'Proprietary airtight back boxes or membrane seals',
      'Expanding polyurethane foam packed behind the back box',
      'Intumescent fire collars fitted to each cable entry',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Testing is not required at all once the floor area exceeds a threshold',
      'A single test of the smallest room can represent the whole building',
      'Use representative sample testing of similar construction zones',
      'The design value may simply be assumed without any physical test',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It improves heat recovery by drawing in more fresh outdoor air',
      'It has no effect because the fans simply compensate automatically',
      'It increases the measured U-value of the external walls',
  ...
  },
  {
    ...
    options: [
      ...
      'Requires the building to be heated to a fixed internal temperature first',
      'Measures leakage at 4 Pascals, closer to natural operating conditions',
      'Can only be used on dwellings and is not valid for non-domestic buildings',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Installing services too early, before the structural frame is complete',
      'Late installation of services after air barrier sealing is complete',
      'Using oversized cables that increase the load on the supply',
      'Routing ductwork through the heated rather than unheated zones',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Always the Part L limiting value of 8 m³/h.m² regardless of construction',
      'The lowest figure technically achievable, to maximise the SAP score',
      'Fixed at 10 m³/h.m² as a safe default for every dwelling type',
  ...
  },
  {
    ...
    options: [
      ...
      'The building is automatically exempt from any further Part L checks',
      'No action is needed provided the result is below 10 m³/h.m²',
      'The mechanical ventilation system must be removed and re-specified',
    ],
    correctAnswer: 0,
    explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/h-n-c-module6-section1"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Every-plot testing is now the default — the old representative-sample concession is
              rare. Use an ATTMA-registered tester, retain the certificate for Building Control, and
              feed the as-tested figure into the as-built SAP. A failed test halts the completion
              process until remediation and re-test is done.
            </>
          }
        ...
        <ConceptBlock title="Air Permeability Fundamentals">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Air permeability (q50):</strong> Air leakage rate per m² of envelope area at
              50Pa (m³/h.m²)
            </li>
            <li>
            ...
            <li>
              <strong>Air barrier:</strong> The continuous layer that prevents air movement through
              the envelope
            </li>
          </ul>
          <p>
            <strong>Building Regulations Air Permeability Limits</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>New dwellings (Part L1A):</strong> 8 m³/h.m² @ 50Pa — 3-5 m³/h.m² @ 50Pa —
              ~0.6 ACH (n50)
            </li>
            <li>
              <strong>New non-domestic (Part L2A):</strong> 8 m³/h.m² @ 50Pa — 3-5 m³/h.m² @ 50Pa —
              ~0.6 ACH (n50)
            </li>
            <li>
              <strong>Existing dwellings (Part L1B):</strong> Not mandatory — Varies by scope — N/A
            </li>
            <li>
              <strong>Extensions &gt;50m²:</strong> 8 m³/h.m² @ 50Pa — Match existing or better —
              N/A
            </li>
          </ul>
          <p>
            <strong>Why Airtightness Matters</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Energy efficiency:</strong> Uncontrolled air leakage can account for 30-50% of
              heat loss
            </li>
            <li>
            ...
            <li>
              <strong>Moisture control:</strong> Air leakage can transport moisture into building
              fabric causing condensation
            </li>
            <li>
              <strong>MVHR performance:</strong> Mechanical ventilation requires airtight envelope
          ...
          <p>
            ...
            calculations must be achieved on site - unrealistic targets lead to compliance issues at
            completion.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Blower Door Testing Methodology">
          <p>
            ...
            depressurise the building, and the airflow required to maintain the pressure difference
            is measured.
          </p>
          <p>
          ...
          <p>
            <strong>Building Preparation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Test Procedure Steps</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Preparation:</strong> Building survey, seal openings, record conditions —
              Ensure test validity and repeatability
            </li>
            <li>
              <strong>2. Equipment setup:</strong> Install fan in door, connect manometer — Create
              controlled pressure boundary
            </li>
            <li>
              <strong>3. Baseline reading:</strong> Measure natural pressure difference (fan off) —
              Account for wind/stack effects
            </li>
            <li>
              <strong>4. Pressurisation:</strong> Fan blows air in, readings at 10-60Pa increments —
              Establish flow/pressure relationship
            </li>
            <li>
              <strong>5. Depressurisation:</strong> Fan extracts air, readings at same increments —
              Verify results, identify one-way leaks
            </li>
            <li>
              <strong>6. Calculation:</strong> Average pressurisation and depressurisation —
              Determine q50 air permeability result
            </li>
          </ul>
          <p>
            <strong>Leak Detection During Testing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Smoke pencils:</strong> Handheld smoke generators show air movement at leakage
              points
            </li>
            <li>
          ...
          <p>
            ...
            the average provides the most representative result and differences can indicate one-way
            leakage paths.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="ATTMA Testing Procedures and Certification">
          <p>
            The Air Tightness Testing & Measurement Association (ATTMA) sets the technical standards
            for air permeability testing in the UK. ATTMA certification ensures testers are
            competent, use calibrated equipment, and follow standardised procedures acceptable to
            Building Control.
          </p>
          <p>
            <strong>ATTMA Technical Standards</strong>
          </p>
          <p>
            <strong>TSL1 - Dwellings</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>TSL2 - Non-Domestic</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>ATTMA Certification Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Tester certification:</strong> Individual testers must pass ATTMA examination
          ...
          <p>
            <strong>Test Certificate Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Property identification:</strong> Full address, UPRN, plot number (if
              applicable)
            </li>
            <li>
              <strong>Test details:</strong> Date, time, weather conditions, internal/external
              temperatures
            </li>
            <li>
              <strong>Building data:</strong> Envelope area, internal volume, floor area
            </li>
            <li>
              <strong>Equipment:</strong> Fan serial number, calibration certificate reference
            </li>
            <li>
              <strong>Results:</strong> q50 value, n50 value, uncertainty, pass/fail against target
            </li>
            <li>
              <strong>Certification:</strong> Tester name, ATTMA number, signature, lodgement
              reference
            </li>
          </ul>
          <p>
            <strong>Sample Testing for Large Developments</strong>
          </p>
        ...
        <ConceptBlock title="Achieving Targets and MEP Coordination">
          <p>
            Achieving design air permeability targets requires coordinated effort across all trades
            throughout construction. For building services engineers, understanding common leakage
            paths and sealing requirements for MEP penetrations is essential for maintaining air
            barrier integrity.
          </p>
          <p>
            <strong>Common Air Leakage Paths</strong>
          </p>
          <p>
            <strong>Structural Junctions</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Service Penetrations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>MEP Sealing Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Electrical back boxes:</strong> Airtight back boxes or membrane seals —
              Multiple cable entries need individual sealing
            </li>
            <li>
              <strong>Cable penetrations:</strong> Proprietary grommets or mastic sealant — Size
              grommets to match cable diameter
            </li>
            <li>
              <strong>Pipe penetrations:</strong> Pipe collars, sleeves with internal seal — Allow
              for thermal movement on hot pipes
            </li>
            <li>
              <strong>Ductwork penetrations:</strong> Airtight grilles, sealed sleeves — Coordinate
              fire damper requirements
            </li>
            <li>
              <strong>Service risers:</strong> Fire-rated sealant with airtight properties — Combine
              fire stopping and air sealing
            </li>
            <li>
              <strong>Recessed lighting:</strong> Airtight downlight covers or IC-rated fittings —
              Maintain ventilation for non-IC fittings
            </li>
          </ul>
          <p>
            <strong>Construction Stage Coordination</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Design:</strong> Define air barrier line, specify sealing details — Coordinate
              penetration locations, specify airtight products
            </li>
            <li>
              <strong>First fix:</strong> Install air barrier, make penetrations — Complete all
              penetrations before air barrier closes
            </li>
            <li>
              <strong>Air barrier complete:</strong> Pre-test before finishes, identify issues —
              Seal all service penetrations, inspect work
            </li>
            <li>
              <strong>Second fix:</strong> Maintain air barrier during fitting out — No new
              penetrations through air barrier
            </li>
            <li>
              <strong>Completion:</strong> Final ATTMA test for compliance — Support leak detection,
              remedial sealing if needed
            </li>
          </ul>
          <p>
            <strong>Best Practice: Airtightness Champion</strong>
          </p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> A detached dwelling with envelope area 320 m² tested at 50Pa
            shows air leakage rate of 1,280 m³/h.
          </p>
          <p>Given:</p>
          ...
          <p>
            <strong>Scenario:</strong> Same dwelling with internal volume 480 m³. Calculate n50 air
            changes.
          </p>
          <p>Given:</p>
          <p>Air leakage rate (Q50) = 1,280 m³/h</p>
          ...
          <p>
            <strong>Scenario:</strong> Pre-test shows 6.5 m³/h.m² @ 50Pa against design target of
            5.0 m³/h.m². Identify remediation approach.
          </p>
          <p>Assessment:</p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Unclear responsibility</strong> - airtightness falls between trades without
                coordination
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A four-bed detached achieves an air permeability of 4.2 m³/h·m² — excellent for SAP.
              MVHR is installed but CO₂ monitoring during the first six weeks of occupation shows
              bedroom CO₂ peaking at 1,800 ppm overnight (target ≤1,000 ppm). The homeowner reports
              stuffiness and condensation on bedroom windows.
            </>
          }
          whatToDo={
            <>
              Commissioning issue, not fabric failure. Verify: (1) MVHR commissioned to BPEC
              standards with measured air-flow rates per terminal matching the design schedule; (2)
              duct routes are not crushed or kinked; (3) supply terminals in bedrooms are not
              blocked by furniture; (4) boost mode is functional and used appropriately. If
              commissioned correctly and still failing, increase the design supply rate or step up
              to an MVHR with higher-capacity boost mode. Part F compliance is the responsibility of
              the M&E designer regardless of fabric performance.
            </>
          }
          whyItMatters={
            <>
              Tight fabric without working ventilation is a health hazard. Indoor air pollutants,
              moisture and CO₂ accumulate, leading to mould, occupant complaints and warranty
              claims. Part L and Part F must be designed and commissioned together — neither stands
              alone.
            </>
          }
        />
