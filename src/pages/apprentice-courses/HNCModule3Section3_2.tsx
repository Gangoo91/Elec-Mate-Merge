...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['0.01s (10ms)', '0.05s (50ms)', '0.02s (20ms)', '0.1s (100ms)'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['100 rad/s', '50 rad/s', '157 rad/s', '314 rad/s'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['20ms', '10ms', '16.67ms', '25ms'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['25 cycles', '50 cycles', '314 cycles', '100 cycles'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['4,000m', '40km', '400m', '4,000km'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS EN 50160 is the standard the DNO works to. Your BSE designs assume 49.5&ndash;50.5
              Hz as the normal operating envelope. Outside this band (e.g. island-mode generation
              following grid loss), motor speeds, transformer losses and PFC capacitor performance
              all drift — which is why generator changeover sequences must verify frequency before
              re-energising loads.
            </>
          }
        ...
        <ConceptBlock title="Frequency - The Foundation of AC Systems">
          ...
          <p>
            <strong>Remember:</strong> UK frequency of 50Hz means the voltage crosses zero 100 times
            per second (twice per cycle) - this affects lighting flicker calculations.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Period - Time for One Complete Cycle">
          <p>
            Period (T) is the time taken for one complete cycle of the waveform. It has a simple but
            fundamental reciprocal relationship with frequency: as frequency increases, the period
          ...
          <p>
            <strong>Angular Frequency (ω):</strong> Angular frequency expresses how fast the phase
            angle changes, measured in radians per second. Since one complete cycle equals 2π
            radians: ω = 2πf = 2π/T. For UK 50Hz: ω = 2 × π × 50 ={' '}
            <strong>314.16 rad/s ≈ 314 rad/s</strong>.
          </p>
          <p>
            <strong>Exam tip:</strong> Remember ω = 314 rad/s for UK 50Hz. For 60Hz systems, ω = 377
            rad/s.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Amplitude and Instantaneous Values">
          ...
          <p>
            <strong>Instantaneous Value Equation:</strong> v = Vm sin(ωt). Where v is instantaneous
            voltage, Vm is peak voltage, ω is angular frequency, t is time. For UK mains: v = 325
            sin(314t) volts.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              5 ms (90°) — sin(ωt) = 1.000 — Voltage <strong>325V (peak)</strong>
            </li>
            <li>10 ms (180°) — sin(ωt) = 0 — Voltage 0V</li>
            <li>
              15 ms (270°) — sin(ωt) = -1.000 — Voltage <strong>-325V (negative peak)</strong>
            </li>
        ...
        <ConceptBlock title="Frequency Effects on Reactive Components and Equipment">
          <p>
            Frequency directly affects how inductors and capacitors behave in AC circuits. This has
            major implications for motor operation, power factor correction, and equipment
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Fluorescent ballasts — Different operating point; May not start or run correctly
            </li>
            <li>Electronic loads — SMPS usually 50-60Hz tolerant; Check equipment rating plate</li>
          </ul>
          <p>
            <strong>Motor Synchronous Speed:</strong> ns = (120 × f) / p. Where ns is synchronous
            speed (RPM), f is frequency (Hz), p is number of poles.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              At 60Hz (design frequency): ns = (120 × 60) / 4 = <strong>1800 RPM</strong>
            </li>
            <li>
              At 50Hz (UK supply): ns = (120 × 50) / 4 = <strong>1500 RPM</strong>
            </li>
            <li>
              Speed reduction: Change = (1800 - 1500) / 1800 × 100 = <strong>16.7% slower</strong>
            </li>
            <li>Motor will run slower and may overheat if mechanically loaded</li>
          </ul>
          <p>
            <strong>Example 3: Reactance Change with Frequency.</strong> A 100µF capacitor is used
            for power factor correction. Calculate its reactance at 50Hz and 60Hz.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Capacitive reactance: Xc = 1 / (2πfC)</li>
            <li>
              At 50Hz: Xc = 1 / (2 × π × 50 × 100×10⁻⁶) = 1 / 0.0314 = <strong>31.8Ω</strong>
            </li>
            <li>
              At 60Hz: Xc = 1 / (2 × π × 60 × 100×10⁻⁶) = 1 / 0.0377 = <strong>26.5Ω</strong>
            </li>
          ...
          <p>
            <strong>Example 4: Time to Reach Peak Voltage.</strong> Starting from zero crossing, how
            long until UK mains reaches its positive peak?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Peak occurs when sin(ωt) = 1, i.e., ωt = π/2 (90°)</li>
            <li>
              t = (π/2) / ω = (π/2) / 314 = 1.571 / 314 = 0.005s = <strong>5ms</strong>
            </li>
            <li>
              Verification: Peak is at T/4 = 20ms/4 = 5ms — One quarter cycle from zero to positive
              peak
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Using degrees instead of radians</strong> — Ensure calculator is in correct
                mode for sin(ωt)
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A 75 kW screw chiller imported from a US project is being installed on a London
              commercial fit-out. Nameplate: 460 V, 60 Hz, 4-pole, 1750 RPM full load. The MCC is
              400 V, 50 Hz. The contractor proposes simply re-tapping the 460 V transformer and
              connecting direct.
            </>
          }
          whatToDo={
            <>
              Reject the proposal. At 50 Hz the synchronous speed drops to (120 &times; 50)/4 = 1500
              RPM &mdash; a 16.7 % speed reduction and refrigerant flow shortfall that will not meet
              design duty. Magnetising current rises (V/f ratio increases from 7.67 to 8.0) so the
              motor draws more no-load current and the windings heat. Specify a properly rated VSD
              or a 50 Hz replacement motor; do not connect the as-imported machine. Record the
              variation against the design submission.
            </>
          }
          whyItMatters={
            <>
              Cross-frequency motor connection is one of the commonest commissioning failures on
              imported equipment. It breaches BS 7671 132.2.1 (suitability for service conditions),
              invalidates the manufacturer&rsquo;s warranty, and under refrigerant duty may breach
              F-Gas Regulation 517/2014 if the unit trips repeatedly.
            </>
          }
        />
