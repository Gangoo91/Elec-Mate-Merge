...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['10 years', '15 years', '5 years', '2 years'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['£500,000', 'Unlimited', '£10 million', '£1 million'],
    correctIndex: 1,
    explanation:
...
const HNCModule1Section4_1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1.4.1"
        title="Duty of Care and Accountability"
        backTo="../h-n-c-module1-section4"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Legal obligations, liability, and consequences for health and safety failures in building
          services
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Section 37 reaches up to directors and senior managers. As an HNC supervisor in a
              small or growing firm, the day you take a senior role this clause applies to you
              personally — &ldquo;neglect&rdquo; is a low bar.
            </>
          }
        ...
        <ConceptBlock title="The Legal Duty of Care">
          <p>
            ...
            care to avoid acts or omissions that could foreseeably cause harm to others. In the
            workplace, this duty is established through both common law (case law) and statute law
            (Acts of Parliament).
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Employers</strong> — Duty Owed To: Employees. Building Services Example: Safe
              isolation procedures for electricians
            </li>
            <li>
              <strong>Employers</strong> — Duty Owed To: Non-employees. Building Services Example:
              Public protected from work activities
            </li>
            <li>
              <strong>Employees</strong> — Duty Owed To: Self and others. Building Services Example:
              Following permit-to-work requirements
            </li>
            <li>
              <strong>Designers</strong> — Duty Owed To: Those who build, use, maintain. Building
              Services Example: Designing for safe maintenance access
            </li>
            <li>
              <strong>Controllers of premises</strong> — Duty Owed To: Those using the premises.
              Building Services Example: Safe electrical installations in buildings
            </li>
          </ul>
        ...
        <ConceptBlock title="Civil Negligence and Compensation Claims">
          <p>
            ...
            by another's failure to exercise reasonable care. These proceedings are brought in civil
            courts (County Court or High Court) and are separate from criminal prosecutions.
          </p>
          ...
          <div className="p-3 rounded bg-white/5 text-center">
            ...
            <p className="text-xs text-white">The defendant owed the claimant a duty of care</p>
          </div>
          <div className="p-3 rounded bg-white/5 text-center">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>The standard is that of a 'reasonable person' in that position</li>
            <li>
              For professionals, it is the standard of a reasonably competent person in that
              profession
            </li>
            <li>Specialists are judged against the standard of reasonable specialists</li>
            <li>The court considers what was reasonably foreseeable at the time</li>
          </ul>
            ...
            whatHappens={
              <>
                <p className="text-sm text-white">
                  <strong>Scenario:</strong> An electrician fails to properly terminate a cable
                  joint, which later fails and causes a fire injuring an occupant.
                  <br />
                  <br />
                  <strong>Analysis:</strong> (1) The electrician's employer owed a duty of care to
                  building occupants (Section 3 HASAWA). (2) The work fell below the standard
                  expected of a competent electrician (breach). (3) The inadequate termination
                  caused the fire and injury (causation). The injured party can claim compensation
                  from the employer (vicarious liability) and the installing company.
                </p>
              </>
            }
            doInstead={
        ...
        <ConceptBlock title="Corporate and Personal Criminal Liability">
          <p>
            ...
            brought against companies, partnerships, and individuals including directors, managers,
            and employees.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Section 2 breach (employees)</strong> — Legal Basis: HASAWA 1974. Maximum
              Penalty: Unlimited fine
            </li>
            <li>
              <strong>Section 3 breach (non-employees)</strong> — Legal Basis: HASAWA 1974. Maximum
              Penalty: Unlimited fine
            </li>
            <li>
              <strong>Regulation breach</strong> — Legal Basis: Various regulations. Maximum
              Penalty: Unlimited fine (triable either way)
            </li>
            <li>
              <strong>Corporate manslaughter</strong> — Legal Basis: CMCHA 2007. Maximum Penalty:
            ...
            whatHappens={
              <>
                <p className="text-sm text-white mb-3">
                  ...
                  attributable to any <strong>neglect</strong> on the part of, any director,
                  manager, secretary or similar officer, that person as well as the body corporate
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Company directors</strong> — Basis of Liability: Section 37 HASAWA. Maximum
              Penalty: Unlimited fine and/or 2 years imprisonment
            </li>
            <li>
              <strong>Managers</strong> — Basis of Liability: Section 37 HASAWA. Maximum Penalty:
              Unlimited fine and/or 2 years imprisonment
            </li>
            <li>
              <strong>Employees</strong> — Basis of Liability: Section 7/8 HASAWA. Maximum Penalty:
              Unlimited fine (rarely imprisonment)
            </li>
            <li>
              <strong>Self-employed</strong> — Basis of Liability: Section 3 HASAWA. Maximum
              Penalty: Unlimited fine and/or 2 years imprisonment
            </li>
          </ul>
          ...
          <p className="text-sm text-white">
            In addition to criminal penalties, courts can disqualify directors from holding company
            directorships:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Up to 15 years disqualification for conviction on indictment</li>
            <li>Up to 5 years for summary conviction</li>
            <li>Applies to all companies, not just the one where the offence occurred</li>
            <li>Acting as director while disqualified is a criminal offence</li>
          </ul>
        ...
        <ConceptBlock title="Health and Safety Sentencing Guidelines">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Very High</strong> — Description: Deliberate breach or flagrant disregard.
              Indicators: Ignored warnings, profit-driven risk-taking
            </li>
            <li>
              <strong>High</strong> — Description: Fell far short of standard. Indicators: Serious
              and obvious risk ignored
            </li>
            <li>
              <strong>Medium</strong> — Description: Fell short of standard. Indicators: Risk
              foreseeable but not obvious
            </li>
            <li>
              <strong>Low</strong> — Description: Minor failing. Indicators: Isolated incident,
              systems in place
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Category 1</strong> — Seriousness of Harm Risked: Death or physical/mental
              impairment causing lifelong effects. Likelihood of Harm: High
            </li>
            <li>
              <strong>Category 2</strong> — Seriousness of Harm Risked: Physical/mental impairment,
              serious, long-term. Likelihood of Harm: Medium
            </li>
            <li>
              <strong>Category 3</strong> — Seriousness of Harm Risked: Moderate harm. Likelihood of
              Harm: Low
            </li>
            <li>
              <strong>Category 4</strong> — Seriousness of Harm Risked: Low risk of harm. Likelihood
              of Harm: Remote
            </li>
          </ul>
          ...
          <CommonMistake
            ...
            whatHappens={
              <>
                <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
                  <li>
                    <strong>1 (Death risk)</strong> — Very High Culpability: £2.6m - £10m+. High
                    Culpability: £1.5m - £4m. Medium Culpability: £550k - £1.5m
                  </li>
                  <li>
                    <strong>2 (Serious harm)</strong> — Very High Culpability: £1m - £3m. High
                    Culpability: £450k - £1.5m. Medium Culpability: £200k - £750k
                  </li>
                </ul>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Guilty plea discount:</strong> Up to one-third reduction for early guilty plea,
            reducing to one-tenth if entered at trial.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical Guidance">
          <div>
            <p>
              <strong>Key Legal Principles to Remember</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                <strong>Vicarious liability:</strong> Employers liable for employees' negligence in
                course of employment
              </li>
              <li>
                <strong>Non-delegable duty:</strong> Cannot escape duty by delegating to contractors
              </li>
              <li>
          ...
          <div>
            <p>
              <strong>Protecting Yourself as a Building Services Professional</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <div>
            <p>
              <strong>Common Failures Leading to Prosecution</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A director instructs you, the HNC site supervisor, to authorise live work on an HV
              switchboard to keep a deadline. There is no Reg 14 documentation, no permit, no risk
              assessment update. The director says &ldquo;just sign it off, the lads know what
              they&rsquo;re doing.&rdquo;
            </>
          }
          whatToDo={
            <>
              Refuse in writing. Cite EAWR Reg 14 (live-work test), HSWA s.7 (your personal duty),
              HSWA s.37 (the director&rsquo;s personal liability), HSWA s.36 (the liability of any
              other person whose act or default leads to the offence). Escalate above the director
              if necessary. Document the conversation, the refusal and the rationale. If the work
              proceeds without your sign-off, report to HSE — your protection under ERA 1996 s.44
          ...
          whyItMatters={
            <>
              ...
              operatives become co-defendants. A documented refusal is the only defence, and the law
              actively protects the refuser.
            </>
          }
        />
