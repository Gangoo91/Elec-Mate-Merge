      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 md:mb-8 p-4 md:p-6 bg-transparent border-white/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">1. Definition of a Fault</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-4">
                      <div>
                        <p className="text-sm md:text-base text-white mb-2"><strong>Primary Types of Electrical Faults:</strong></p>
                        <div className="grid gap-3 sm:grid-cols-2 mb-3">
                          <div className="bg-[#121212]/50 p-3 rounded border">
                            <p className="font-medium text-white mb-1 text-sm md:text-base">Short Circuits</p>
                            <p className="text-xs md:text-xs sm:text-sm text-white">Unintended connection between line and neutral or between phases</p>
                          </div>
                          <div className="bg-[#121212]/50 p-3 rounded border">
                            <p className="font-medium text-white mb-1 text-sm md:text-base">Earth Faults</p>
                            <p className="text-xs md:text-xs sm:text-sm text-white">Live conductors making contact with earth or earthed metalwork</p>
                          </div>
                          <div className="bg-[#121212]/50 p-3 rounded border">
                            <p className="font-medium text-white mb-1 text-sm md:text-base">Open Circuits</p>
                            <p className="text-xs md:text-xs sm:text-sm text-white">Broken or disconnected conductors preventing current flow</p>
                          </div>
                          <div className="bg-[#121212]/50 p-3 rounded border">
                            <p className="font-medium text-white mb-1 text-sm md:text-base">Insulation Breakdown</p>
                            <p className="text-xs md:text-xs sm:text-sm text-white">Deteriorated insulation allowing dangerous leakage currents</p>
                          </div>
                        </div>
                      </div>

                      <div>
                        <p className="text-base text-white mb-2"><strong>Secondary Fault Types:</strong></p>
                      ...
                      <div>
                        <p className="text-base text-white mb-2"><strong>BS 7671 Requirements:</strong></p>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">2. Difference Between Normal Operation and Fault Conditions</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-4">
                      <div>
                        <p className="text-base text-white mb-2"><strong>Normal Operation Characteristics:</strong></p>
                        <div className="bg-[#121212]/50 p-3 rounded border mb-3">
                          <div className="grid gap-3 lg:grid-cols-2">
                            <div>
                              <p className="font-medium text-white mb-2 text-sm md:text-base">Electrical Parameters</p>
                            ...
                            <div>
                              <p className="font-medium text-white mb-2 text-sm md:text-base">Protective Systems</p>
                              <ul className="list-disc ml-4 space-y-1 text-xs md:text-xs sm:text-sm text-white">
                      ...
                      <div>
                        <p className="text-base text-white mb-2"><strong>Fault Condition Indicators:</strong></p>
                      ...
                      <div>
                        <p className="text-base text-white mb-2"><strong>Hidden vs Obvious Faults:</strong></p>
                        <div className="grid gap-3 lg:grid-cols-2">
                          <div className="bg-amber-50 dark:bg-amber-900/20 p-3 rounded border border-amber-200 dark:border-amber-800">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">3. Common Ways Faults Appear</h3>
            <p className="text-base text-white mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-4">
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="bg-[#121212]/50 p-3 rounded border">
                          <p className="font-medium text-white mb-2">Short Circuit</p>
                          <p className="text-xs sm:text-sm text-white">Line and neutral or line-to-line conductors make unintended contact</p>
                        </div>
                        <div className="bg-[#121212]/50 p-3 rounded border">
                          <p className="font-medium text-white mb-2">Earth Fault</p>
                          <p className="text-xs sm:text-sm text-white">Live conductors make contact with earth or earthed metalwork</p>
                        </div>
                        <div className="bg-[#121212]/50 p-3 rounded border">
                          <p className="font-medium text-white mb-2">Open Circuit</p>
                          <p className="text-xs sm:text-sm text-white">Conductor is broken or disconnected, stopping current flow</p>
                        </div>
                        <div className="bg-[#121212]/50 p-3 rounded border">
                          <p className="font-medium text-white mb-2">Insulation Fault</p>
                          <p className="text-xs sm:text-sm text-white">Insulation breaks down, allowing leakage currents</p>
                        </div>
                      </div>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">4. Why Understanding Faults Matters</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-4">
                      <div>
                        <p className="text-base text-white mb-2"><strong>Professional Benefits:</strong></p>
                        <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
                      ...
                      <div>
                        <p className="text-base text-white mb-2"><strong>Safety Impact:</strong></p>
                        <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
        ...
        <Card className="mb-6 md:mb-8 p-4 md:p-6 bg-transparent border-white/20">
          ...
          <div className="space-y-4">
            <div>
              <p className="text-sm md:text-base text-white font-medium mb-2">On-Site Best Practices:</p>
            ...
            <div>
              <p className="text-sm md:text-base text-white font-medium mb-2">Communication and Reporting:</p>
              <ul className="list-disc pl-6 space-y-2 text-sm md:text-base text-white">
            ...
            <div>
              <p className="text-sm md:text-base text-white font-medium mb-2">Professional Development:</p>
              <ul className="list-disc pl-6 space-y-2 text-sm md:text-base text-white">
        ...
        <Card className="mb-6 md:mb-8 p-4 md:p-6 bg-transparent border-white/20">
          ...
          <div className="space-y-4">
            <div className="rounded-lg p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
              <h3 className="font-medium text-white mb-3">Case Study: Misdiagnosed Circuit Breaker Problem</h3>
              <p className="text-base text-white mb-4">
              ...
              <ol className="list-decimal ml-6 space-y-2 text-xs sm:text-sm text-white mb-4">
        ...
        <Card className="mb-6 md:mb-8 p-4 md:p-6 bg-transparent border-white/20">
          ...
          <div className="space-y-4">
            <div className="rounded-lg p-4 bg-muted/50 border border-border/30">
              <p className="font-medium text-white mb-2">Q: Is a tripped circuit breaker always a sign of a fault?</p>
              <p className="text-xs sm:text-sm text-white">A: Not always — it could be due to overload or a one-off event, but repeated tripping usually indicates a fault that needs investigation. A single trip might be caused by starting current from motors or temporary overload, but consistent tripping indicates an underlying problem.</p>
            </div>
            <div className="rounded-lg p-4 bg-muted/50 border border-border/30">
              <p className="font-medium text-white mb-2">Q: Are all faults dangerous?</p>
              <p className="text-xs sm:text-sm text-white">A: Yes, even minor faults can escalate into serious hazards if left uncorrected. All faults represent a breakdown in safe operation and should be addressed promptly. What appears minor today could become life-threatening tomorrow.</p>
            </div>
            <div className="rounded-lg p-4 bg-muted/50 border border-border/30">
              <p className="font-medium text-white mb-2">Q: Do hidden faults still count as faults if the installation appears to work?</p>
              <p className="text-xs sm:text-sm text-white">A: Yes. A system can appear to function while being unsafe — for example, reversed polarity. Hidden faults are often the most dangerous because they're not immediately obvious but still create safety risks.</p>
            </div>
            <div className="rounded-lg p-4 bg-muted/50 border border-border/30">
              <p className="font-medium text-white mb-2">Q: How can I tell the difference between a fault and normal wear?</p>
              <p className="text-xs sm:text-sm text-white">A: Normal wear is gradual degradation that doesn't immediately compromise safety (like slight contact wear in switches). A fault is any condition that takes the system outside safe operating parameters defined in BS 7671, regardless of whether it affects apparent operation.</p>
            </div>
            <div className="rounded-lg p-4 bg-muted/50 border border-border/30">
              <p className="font-medium text-white mb-2">Q: What should I do if I suspect a fault but can't confirm it?</p>
              <p className="text-xs sm:text-sm text-white">A: Always err on the side of caution. Isolate the circuit if safe to do so, and seek guidance from a qualified person. Never ignore unexplained symptoms or assume they will resolve themselves.</p>
            </div>
          </div>
        </Card>
        ...
        <Card className="mb-6 md:mb-8 p-4 md:p-6 bg-transparent border-white/20">
          ...
          <div className="grid gap-4 md:grid-cols-2 md:gap-6">
            <div className="rounded-lg p-3 md:p-4 bg-transparent border border-elec-yellow/30">
              <h3 className="font-medium text-white mb-3 text-sm md:text-base">Quick Fault Recognition</h3>
            ...
            <div className="rounded-lg p-3 md:p-4 bg-transparent border border-border/30">
              <h3 className="font-medium text-white mb-3 text-sm md:text-base">Action Steps</h3>
              <ul className="text-xs md:text-xs sm:text-sm text-white space-y-1">
