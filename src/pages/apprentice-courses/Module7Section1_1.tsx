...
const DESCRIPTION =
  'Understanding the definition of electrical faults and distinguishing between normal operation and fault conditions in electrical installations.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      'Good connections and proper polarity',
      'Short circuits and earth faults',
      'New cables and clean terminals',
      'Correct voltage and frequency',
    ],
    correctIndex: 1,
    explanation:
      'Short circuits and earth faults are two common types of electrical faults that create safety hazards.',
  },
  {
    id: 'importance-check',
    ...
    correctIndex: 1,
    explanation:
      'Understanding faults allows electricians to test intelligently, interpret results correctly, and recognise unsafe conditions before they cause accidents.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'Faults use more electricity',
      'Faults are always visible',
    ],
    correctAnswer: 1,
    explanation:
      'Fault conditions create abnormal current flow, safety risks, and mean the system is no longer operating within safe limits set by BS 7671.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'False. A system can appear to function while being unsafe - for example, reversed polarity may not stop equipment working but creates hidden dangers.',
  },
  {
    id: 9,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'The apprentice incorrectly assumed the breaker was faulty instead of recognising the repeated tripping as a sign of a possible short circuit fault.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Not always — it could be due to overload or a one-off event, but repeated tripping usually indicates a fault that needs investigation.',
  },
  {
    question: 'Are all faults dangerous?',
    answer:
      'Yes, even minor faults can escalate into serious hazards if left uncorrected. All faults represent a breakdown in safe operation and should be addressed.',
  },
  {
    question: 'Do hidden faults still count as faults if the installation appears to work?',
    answer:
      "Yes. A system can appear to function while being unsafe — for example, reversed polarity. Hidden faults are often the most dangerous because they're not immediately obvious.",
  },
  {
    question: 'How can I tell the difference between a fault and normal wear?',
    answer:
      "Normal wear is gradual degradation that doesn't immediately compromise safety (like slight contact wear in switches). A fault is any condition that takes the system outside safe operating parameters defined in BS 7671.",
  },
  {
    question: "What should I do if I suspect a fault but can't confirm it?",
    answer:
      'Always err on the side of caution. Isolate the circuit if safe to do so, and seek guidance from a qualified person. Never ignore unexplained symptoms.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Definition:</strong> Any defect preventing safe circuit operation
              </li>
              <li>
                <strong>Types:</strong> Short circuits, earth faults, open circuits
              </li>
              <li>
                <strong>Danger:</strong> Faults create safety risks even if equipment works
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Repeated tripping, abnormal readings, unusual behaviour
              </li>
              <li>
                <strong>Use:</strong> Test equipment, visual inspection, correct terminology
              </li>
              <li>
                <strong>Check:</strong> All circuits before energising
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A fault in electrical terms is any defect that prevents a circuit from functioning
              safely or correctly according to BS 7671 standards. Faults may involve unexpected
              connections, breaks in continuity, or abnormal current flow that creates danger or
              disruption.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Primary Types of Electrical Faults:
              </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Polarity faults:</strong> Incorrect connection of line and neutral
                  conductors
                </li>
                <li>
                  <strong>High resistance connections:</strong> Loose or corroded joints creating
                  heat
                </li>
                <li>
                  <strong>Cross-connections:</strong> Wires connected to wrong terminals or circuits
                </li>
                <li>
                  <strong>Mechanical damage:</strong> Physical damage affecting conductor integrity
                </li>
                <li>
                  <strong>Overloading:</strong> Current demand exceeding design capacity
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Understanding the clear distinction between normal and fault conditions is essential
              for safe electrical work and proper testing.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> A system can appear to function while being unsafe. Hidden
              faults are often the most dangerous because they're not immediately obvious.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Clear understanding of faults is essential for safe electrical practice and
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
              ...
              <p className="text-sm text-white">
                Faults are not just technical issues — they are direct hazards that can cause
                serious injury or death if not properly identified and corrected. The HSE reports
                over 1,000 workplace electrical accidents per year in the UK.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Treat all unexplained test results as a potential fault until proven otherwise
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                ...
                <li>
                  <strong>Replacing components without testing</strong> — diagnose before replacing
                </li>
                <li>
                  <strong>Ignoring intermittent faults</strong> — they often indicate serious
                  problems
                </li>
                <li>
                  <strong>Poor documentation</strong> — always record findings accurately
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 rounded-lg bg-white/5">
            <h3 className="text-sm font-medium text-white mb-3">
              Case Study: Misdiagnosed Circuit Breaker Problem
            </h3>
            <p className="text-sm text-white mb-4">
              An apprentice was asked to investigate a socket circuit that repeatedly tripped the
              32A Type B MCB within minutes of being reset. Instead of recognising this pattern as
              indicating a possible short circuit fault, he assumed the circuit breaker itself was
              faulty and replaced it with a new one. The problem continued with the new MCB also
              tripping repeatedly.
            </p>
            ...
            <div className="p-3 rounded bg-red-500/10 border-l-2 border-red-500/50">
              <p className="text-sm text-white">
                <strong>Cost of Misdiagnosis:</strong> Wasted time (4 hours), unnecessary parts cost
                (£45 for new MCB), and potential safety risks from the unresolved short circuit
                fault.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <p className="text-white leading-relaxed">
            A fault is any defect or abnormal condition that prevents a circuit from operating
            safely and correctly. Common examples include short circuits, earth faults, open
            circuits, insulation breakdown, and polarity faults. Recognising faults is critical
            because they create risks of shock, fire, or equipment damage. Understanding the
            definition of a fault is the first step in learning how to test, diagnose, and correct
