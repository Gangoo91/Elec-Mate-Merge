...
const DESCRIPTION =
  'Hands-on calculations for series and parallel circuits with built-in calculators. UK electricians, BS 7671 aligned.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'Start with the largest resistor',
      'Start with series sections first',
    ],
    correctIndex: 1,
    explanation:
      "Reduce parallel sections first as they're easier to identify and calculate, then handle the remaining series combinations.",
  },
  {
    id: '2',
    question:
      "For two 10Ω resistors in parallel, then in series with a 5Ω resistor, what's the total resistance?",
    options: [
      '20Ω',
      '15Ω',
      '10Ω',
...
const faqs = [
  {
    ...
    answer:
      'Start by identifying clear parallel sections and reduce them first using the parallel formula. Then identify series sections and add resistances. Work systematically from the most obvious combinations toward the supply.',
  },
  {
    question: "What's the difference between voltage dividers and current dividers?",
    answer:
      'Voltage dividers work in series circuits - voltage splits proportionally. Current dividers work in parallel circuits - current splits inversely proportional to resistance. Both use the same supply.',
  },
  {
    question: 'How do these calculations apply to real installations?',
    answer:
      'LED arrays, resistor networks in control panels, and mixed lighting/power circuits all exhibit series-parallel behaviour. Understanding these helps with troubleshooting and load calculations.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Only the total supply current',
      'The number of branches in the network',
      'The order the resistors were connected',
  ...
  },
  {
    ...
    options: [
      'Volt drop and Zs for device disconnection',
      'The colour of the conductor insulation only',
      'The brand of the protective devices fitted',
      'The room temperature at the consumer unit',
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      'In the earthing conductor to the main earth bar',
      'LED tapes and control-panel resistor networks',
      'In the supply cable from the local transformer',
      'In a single radial circuit to one appliance',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'Add every resistor value together in one step',
      'Always start from the resistor nearest the supply',
      'Treat the whole network as a single series chain',
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      'Only the total resistance of the network',
      'Voltage drop, Zs, device ratings, and cable capacity',
      'Only the supply voltage at the origin',
      'Only the number of branches in the circuit',
    ],
    correctAnswer: 1,
  ...
  },
  {
    id: 10,
    question:
      'Three resistors: 20Ω and 30Ω in parallel, then in series with 10Ω. Total resistance?',
    options: [
      '60Ω',
      '50Ω',
      '22Ω',
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Series:</strong> I same, V divides, Rt adds
              </li>
              <li>
                <strong>Parallel:</strong> V same, currents add, 1/Rt sums
              </li>
              <li>
                <strong>Use dividers:</strong> Vx = Vs×Rx/Rt, Ibranch = Vs/Rbranch
              </li>
              <li>
                <strong>Combine step-by-step:</strong> Reduce then solve
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> LED tape networks, resistor networks
              </li>
              <li>
                <strong>Use:</strong> Mixed series-parallel lighting, control panel components
              </li>
              <li>
                <strong>Apply:</strong> Checking manufacturer limits, load distribution analysis
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Complex circuits combine series and parallel elements. Success comes from systematic
              reduction:
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li>
                    Voltages add: V<sub>T</sub> = V₁ + V₂ + V₃
                  </li>
                  <li>
                    Resistances add: R<sub>T</sub> = R₁ + R₂ + R₃
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    Voltage same: V₁ = V₂ = V₃ = V<sub>S</sub>
                  </li>
                  <li>
                    Currents add: I<sub>T</sub> = I₁ + I₂ + I₃
                  </li>
                  <li>
                    Reciprocals: 1/R<sub>T</sub> = 1/R₁ + 1/R₂ + 1/R₃
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>Step 1:</strong> Reduce series section: R<sub>series</sub> = 150 + 450 =
                  600Ω
                </li>
                <li>
                  <strong>Step 2:</strong> Parallel combination: R<sub>T</sub> = (600×120)/(600+120)
                  = 100Ω
                </li>
                <li>
                  <strong>Step 3:</strong> Total current: I<sub>T</sub> = 24V ÷ 100Ω = 0.24A
                </li>
                <li>
                  <strong>Step 4:</strong> Branch currents:
                </li>
                <li className="ml-4">
                  Series branch: I<sub>series</sub> = 24V ÷ 600Ω = 0.04A
                </li>
                <li className="ml-4">Parallel branch: I₃ = 24V ÷ 120Ω = 0.2A</li>
                <li>
                  <strong>Check:</strong> 0.04A + 0.2A = 0.24A
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>Step 1:</strong> Reduce parallel section: R<sub>parallel</sub> =
                  (100×300)/(100+300) = 75Ω
                </li>
                <li>
                  <strong>Step 2:</strong> Total resistance: R<sub>T</sub> = 75 + 50 = 125Ω
                </li>
                <li>
                  <strong>Step 3:</strong> Total current: I<sub>T</sub> = 12V ÷ 125Ω = 0.096A
                </li>
                <li>
                  <strong>Step 4:</strong> Voltage across parallel section: V<sub>parallel</sub> =
                  0.096A × 75Ω = 7.2V
                </li>
                <li>
                  <strong>Step 5:</strong> Branch currents in parallel section:
                </li>
                <li className="ml-4">I₁ = 7.2V ÷ 100Ω = 0.072A</li>
                <li className="ml-4">I₂ = 7.2V ÷ 300Ω = 0.024A</li>
                <li>
                  <strong>Check:</strong> 0.072A + 0.024A = 0.096A
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="text-white space-y-6 leading-relaxed">
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <p className="text-elec-yellow font-mono text-sm mb-2">
                  V<sub>x</sub> = V<sub>s</sub> × (R<sub>x</sub>/(R₁+R₂+...))
                </p>
                <ul className="text-sm text-white space-y-1">
              ...
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li>
                    Or directly: I<sub>branch</sub> = V<sub>s</sub>/R<sub>branch</sub>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-elec-yellow/70">
                Use these tools to verify your manual calculations and explore different scenarios
                quickly.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Mixed series-parallel circuits appear throughout electrical installations and
              equipment.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>BS 7671 Design Requirements:</strong>
              <br />
              Voltage Drop: Calculate actual voltage at load terminals, considering all series
              resistance
              <br />
              Current Capacity: Ensure each conductor can carry its actual current safely
              <br />
              Protective Devices: Select based on highest current path and coordination requirements
              <br />
              Fault Conditions: Consider how series-parallel arrangements affect fault current paths
              <br />
              Load Distribution: Balance loads appropriately across supply phases
              <br />
        ...
        <section className="mb-10">
          ...
          <div className="mt-6 p-5 rounded-lg bg-transparent">
            <h3 className="text-sm font-medium text-white mb-4">
              Quick Reference: Mixed Circuit Rules
            </h3>
        ...
        <section className="mb-10">
          <Quiz
            title="Test Your Understanding: Series & Parallel Calculations"
