    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Understand procurement strategies and contractual frameworks for building services
          projects
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the procurement routes, standard contract forms and supply chain
          management practices essential for successful delivery of building services installations
          - from initial tender through to subcontractor coordination and material logistics.
        </p>
