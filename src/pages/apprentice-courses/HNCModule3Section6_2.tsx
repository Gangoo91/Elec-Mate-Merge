                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Current minimum (0.75-1000kW)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-semibold text-green-400">
                        IE4
                      </td>
                      <td className="border border-white/10 px-3 py-2">Super Premium</td>
                      <td className="border border-white/10 px-3 py-2">92.6%</td>
                      <td className="border border-white/10 px-3 py-2">
                        Required for 75-200kW (Jul 2023)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-semibold text-blue-400">
                        IE5
                      </td>
                      <td className="border border-white/10 px-3 py-2">Ultra Premium</td>
                      <td className="border border-white/10 px-3 py-2">~94%</td>
                      <td className="border border-white/10 px-3 py-2">
                        ~20% lower losses than IE4
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Security, emergency lighting, IT cooling
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Building warm-up, early arrivals
                      </td>
                    </tr>
                    <tr>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Detailed analysis, bankable savings
                      </td>
                    </tr>
                  </tbody>
                </table>
