...
const quickCheckQuestions = [
  {
    ...
    options: ['η = Pin/Pout × 100%', 'η = Pout - Pin', 'η = Pin × Pout', 'η = Pout/Pin × 100%'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['IE2 High', 'IE3 Premium', 'IE5 Ultra Premium', 'IE1 Standard'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['3 years', '1 year', '2 years', '4 years'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['IE4 Super Premium', 'IE1 Standard', 'IE3 Premium', 'IE2 High'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['45-55%', '90-97%', '25-35%', '65-75%'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['20-30%', '80-90%', '40-50%', '60-70%'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Approved Document L 2021 &mdash; both Volume 1 (dwellings) and Volume 2 (other
              buildings) &mdash; requires fixed building services to be energy-efficient. The
              IE-class motor and transformer-efficiency arithmetic in this section is the
              engineering evidence that satisfies the regulation. Building Control inspectors will
              check the motor schedule and transformer spec against Ecodesign minimum, and may
              request supporting calculations on commercial submissions.
            </>
          }
        ...
        <ConceptBlock title="In 30 seconds">
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Basic formula:</strong> η = Pout/Pin × 100%
            </li>
            <li>
              <strong>Motor classes:</strong> IE1 to IE5 (Standard to Ultra Premium)
            </li>
            <li>
              <strong>System efficiency:</strong> Individual efficiencies multiply
            </li>
            <li>
              <strong>Life cycle costs:</strong> Energy is 90-97% of motor costs
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">Building Services Context</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HVAC motors:</strong> Fans, pumps, compressors
            </li>
            <li>
              <strong>Transformers:</strong> Distribution efficiency matters
            </li>
            <li>
              <strong>Part-load:</strong> Real-world operation rarely at full load
            </li>
            <li>
              <strong>Energy audits:</strong> Identify improvement opportunities
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Fundamental Efficiency Concepts">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">The Efficiency Equation</p>
          <p>
            <strong>
              η = P<sub>out</sub> / P<sub>in</sub> × 100%
            </strong>
          </p>
          <p>Where η (eta) = efficiency, Pout = useful output power, Pin = total input power</p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>η = Pout / (Pout + Losses) × 100%</strong> — when output and losses are known
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Copper losses (I²R)</strong> — Winding resistance — Varies with load squared
            </li>
            <li>
              <strong>Iron losses (core)</strong> — Hysteresis and eddy currents — Approximately
              constant
            </li>
            <li>
              <strong>Friction and windage</strong> — Bearings, air resistance — Approximately
              constant
            </li>
            <li>
              <strong>Stray load losses</strong> — Leakage flux, harmonics — Varies with load
            </li>
          </ul>
        ...
        <ConceptBlock title="Motor Efficiency Classes (IE1-IE5)">
          <p>
            ...
            under IEC 60034-30-1. These are legally mandated minimum requirements under EU Ecodesign
            regulations.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>IE1</strong> — Standard — 88.4% — No longer permitted for new installations
            </li>
            <li>
              <strong>IE2</strong> — High — 89.8% — Previous minimum standard
            </li>
            <li>
              <strong>IE3</strong> — Premium — 91.4% — Current minimum (0.75-1000kW)
            </li>
            <li>
              <strong>IE4</strong> — Super Premium — 92.6% — Required for 75-200kW (Jul 2023)
            </li>
            <li>
              <strong>IE5</strong> — Ultra Premium — ~94% — ~20% lower losses than IE4
            </li>
          </ul>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Efficiency Improvement Example</p>
          <p>An 11kW motor runs 6000 hours/year. Upgrading from IE2 (89.8%) to IE4 (92.6%):</p>
          ...
          <p>
            <strong>Remember:</strong> Efficiency improvements compound over the motor's 15-20 year
            lifespan. Small percentage gains translate to thousands of pounds in savings.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Transformer Efficiency and All-Day Efficiency">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Transformer Efficiency Formula</p>
          <p>
            <strong>
              η = (V<sub>2</sub>I<sub>2</sub>cosφ) / (V<sub>2</sub>I<sub>2</sub>cosφ + P<sub>i</sub>{' '}
              + P<sub>c</sub>) × 100%
            </strong>
          </p>
          <p>Where Pi = iron losses (constant), Pc = copper losses at actual load</p>

          <p className="text-sm font-medium text-white">Key transformer loss characteristics:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Iron losses (Pi):</strong> Constant whenever transformer is energised (no-load
              losses)
            </li>
            <li>
              <strong>Copper losses (Pc):</strong> Vary with load squared: Pc = Pc(FL) × (I/IFL)²
            </li>
            <li>
              <strong>Maximum efficiency:</strong> Occurs when Pi = Pc (iron losses = copper losses)
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Maximum Efficiency Load Point</p>
          <p>
            <strong>
              x = √(P<sub>i</sub> / P<sub>c(FL)</sub>)
            </strong>
          </p>
          <p>Where x = fraction of full load at maximum efficiency</p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>00:00-07:00</strong> — 7h — 10-20% — Security, emergency lighting, IT cooling
            </li>
            <li>
              <strong>07:00-09:00</strong> — 2h — 50-70% — Building warm-up, early arrivals
            </li>
            <li>
              <strong>09:00-17:00</strong> — 8h — 80-100% — Full occupation, peak HVAC
            </li>
            <li>
              <strong>17:00-20:00</strong> — 3h — 40-60% — Reduced occupation, cleaning
            </li>
            <li>
              <strong>20:00-00:00</strong> — 4h — 15-25% — Security, minimal HVAC
            </li>
          </ul>
        ...
        <ConceptBlock title="Part-Load Efficiency Considerations">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>HVAC systems sized for peak loads that occur 1-2% of the time</li>
            <li>Motors driving variable loads (fans, pumps) spend most time at 50-75% load</li>
            <li>Fixed losses become proportionally larger as output decreases</li>
            <li>Oversized equipment operates inefficiently at typical loads</li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>100%</strong> — 91.4% — Baseline — Rated efficiency
            </li>
            <li>
              <strong>75%</strong> — 91.8% — -4% — Often peak efficiency point
            </li>
            <li>
              <strong>50%</strong> — 90.2% — +14% — Still acceptable
            </li>
            <li>
              <strong>25%</strong> — 84.5% — +80% — Significant efficiency drop
            </li>
            <li>
              <strong>10%</strong> — ~70% — +250% — Very poor - consider resizing
            </li>
          </ul>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">VSD Energy Savings (Fan/Pump)</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Design principle:</strong> Always consider the operating load profile, not just
            the nameplate rating. A motor that spends 90% of its time at 40% load may be the wrong
            choice.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="System Efficiency Calculations">
          <p>
            ...
            cascade effect means even small improvements in individual components can significantly
            impact overall system performance.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">System Efficiency Formula</p>
          <p>
            <strong>
          ...
          <p>Individual efficiencies multiply - they do not add</p>

          <p className="text-sm font-medium text-elec-yellow/80">Example: Chilled Water System</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Transformer</strong> — 97% — 97.0%
            </li>
            <li>
              <strong>Variable speed drive</strong> — 97% — 94.1%
            </li>
            <li>
              <strong>Motor (IE3)</strong> — 93% — 87.5%
            </li>
            <li>
              <strong>Belt drive</strong> — 95% — 83.1%
            </li>
            <li>
              <strong>Pump</strong> — 80% — 66.5%
            </li>
          </ul>
          <p className="text-xs text-white mt-2">
            Overall system efficiency: 0.97 × 0.97 × 0.93 × 0.95 × 0.80 = 66.5% - nearly one-third
            of input energy is lost.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Baseline</strong> — - — 66.5% — -
            </li>
            <li>
              <strong>IE4 motor (96%)</strong> — 96% — 68.7% — +3.3%
            </li>
            <li>
              <strong>Direct drive (no belt)</strong> — 100% — 70.0% — +5.3%
            </li>
            <li>
              <strong>Better pump (85%)</strong> — 85% — 70.6% — +6.2%
            </li>
            <li>
              <strong>All improvements</strong> — - — 76.7% — +15.3%
            </li>
          </ul>
        ...
        <ConceptBlock title="Life Cycle Cost Analysis">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Life Cycle Cost Formula</p>
          <p>
            <strong>
              LCC = C<sub>ic</sub> + C<sub>in</sub> + C<sub>e</sub> + C<sub>o</sub> + C<sub>m</sub>{' '}
              + C<sub>s</sub> + C<sub>env</sub> - C<sub>d</sub>
            </strong>
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Energy consumption</strong> — 90-97% — Dominates total cost
            </li>
            <li>
              <strong>Purchase price</strong> — 2-5% — One-time cost
            </li>
            <li>
              <strong>Installation</strong> — 0.5-2% — Often included in purchase
            </li>
            <li>
              <strong>Maintenance</strong> — 1-3% — Bearings, lubrication
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Simple Payback Period</p>

          <p>
            <strong>Payback = ΔCost / Annual Savings</strong>
          </p>
          <p>Years to recover extra investment</p>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Net Present Value (NPV)</p>
          ...
          <p>Discounted cash flow over equipment life</p>
          ...
          <p>15kW motor, 6000 hours/year, 15 year life, electricity at 15p/kWh:</p>
        ...
        <ConceptBlock title="Energy Auditing Techniques">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Level 1</strong> — Walk-through survey — 1-2 days — Quick wins identification
            </li>
            <li>
              <strong>Level 2</strong> — Standard audit — 1-2 weeks — Energy balance, ECM costings
            </li>
            <li>
              <strong>Level 3</strong> — Investment-grade audit — Several weeks — Detailed analysis,
              bankable savings
            </li>
          </ul>
          ...
          <p className="text-white text-sm">Rank by payback, NPV, or marginal abatement cost</p>

          <p className="text-sm font-medium text-elec-yellow/80">Key Audit Instrumentation</p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HVAC</strong> — 40-50 — 35-45 — 45-55
            </li>
            <li>
              <strong>Lighting</strong> — 20-30 — 25-35 — 15-20
            </li>
            <li>
              <strong>Equipment/IT</strong> — 15-25 — 10-15 — 20-30
            </li>
            <li>
              <strong>Other</strong> — 10-15 — 15-20 — 10-15
            </li>
          </ul>
        ...
        <ConceptBlock title="Building Services: Equipment Selection and Payback Calculations">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Running hours</strong> — &gt;4000 hours/year — &lt;2000 hours/year
            </li>
            <li>
              <strong>Load profile</strong> — Continuous, near full load — Intermittent, variable
            </li>
            <li>
              <strong>Energy cost</strong> — High/rising tariffs — Low/stable tariffs
            </li>
            <li>
              <strong>Equipment life</strong> — &gt;10 years expected — Short-term installation
            </li>
            <li>
              <strong>Building certification</strong> — BREEAM/LEED targets — No certification
              needed
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>LED lighting retrofit</strong> — 50-70% — 2-4 years
            </li>
            <li>
              <strong>VSD on AHU fans</strong> — 30-50% — 1-3 years
            </li>
            <li>
              <strong>VSD on pumps</strong> — 25-40% — 1-3 years
            </li>
            <li>
              <strong>IE3/IE4 motor upgrade</strong> — 3-5% — 1-2 years
            </li>
            <li>
              <strong>Optimised BMS controls</strong> — 10-20% — &lt;1 year
            </li>
            <li>
              <strong>Power factor correction</strong> — kVA reduction — 1-3 years
            </li>
            <li>
              <strong>Compressed air leak repair</strong> — 20-30% — &lt;1 year
            </li>
          </ul>
          ...
          <p>Office building lighting: 500 × 58W fluorescent fittings, 3000 hours/year</p>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">BREEAM/LEED Energy Credits</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BREEAM Ene01:</strong> Up to 15 credits for exceeding Part L by 40%+
            </li>
            <li>
              <strong>Sub-metering (Ene02):</strong> Requires major energy-consuming systems to be
              metered
            </li>
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>Alternative: η = (Pin - Losses) / Pin = (18.5 - 2.0) / 18.5 = 89.2%</p>
          ...
          <p>
            ...
            copper losses of 8kW. It operates at full load for 6 hours, half load for 10 hours, and
            10% load for 8 hours daily. Calculate the all-day efficiency at 0.8 power factor.
          </p>
          ...
          <p>
            <strong>Question:</strong> A pumping system requires 45kW at the pump shaft. The system
            comprises: VSD (96%), motor (91%), coupling (98%), pump (75%). Calculate annual energy
            cost at 14p/kWh for 5000 hours operation.
          </p>
          ...
          <p>Losses = 70.1 - 45 = 25.1 kW (GBP 17,570/year wasted)</p>

          <p className="text-sm font-medium text-elec-yellow/80">
            Example 4: NPV Analysis for VSD Investment
          </p>
          <p>
            <strong>Question:</strong> A VSD costs GBP 8,000 installed and saves GBP 2,500/year in
            energy. Equipment life is 10 years. Calculate NPV at 8% discount rate.
          </p>
        ...
        <Scenario
          ...
          situation={
            <>
              A primary chilled-water circulation pump has the following nameplate data: 30 kW IE3
              motor (94 % at full load), direct-coupled centrifugal pump (BEP efficiency 76 %, but
              operating at 65 % of BEP flow with system efficiency only 58 %). VSD-controlled (97
              %). Total electrical input measured at 42 kW. Hydraulic output measured at 19.5 kW.
            </>
          }
          whatToDo={
            <>
              Compute system efficiency: 19.5 / 42 = 46 % overall. Cascade analysis: VSD 0.97
              &times; motor 0.94 &times; pump 0.58 = 0.529 &mdash; close to the measured 0.46 (with
              cabling and operating tolerance). The pump is the limiting stage at 58 %, dragging the
              whole system down. Investigation: pump is oversized for actual demand &mdash; impeller
              trim or pump replacement to BEP-aligned curve recovers ~15&ndash;20 % efficiency
              points. Specify a hydraulic re-balance and trim assessment; consider pump downsize at
              next planned outage. Document the cascade in the building log book.
            </>
          }
          whyItMatters={
            <>
              Cascade efficiency analysis pinpoints which stage to fix first &mdash; upgrading the
              IE3 motor to IE4 here would only recover ~1 efficiency point, while right-sizing the
              pump recovers 15&ndash;20. The HNC engineer&rsquo;s analytical instinct to look at the
              system not just the component is what unlocks the largest savings.
            </>
          }
        />
