...
const DESCRIPTION =
  'Comprehensive guide to electric vehicle charging point installation under BS 7671 Section 722 and OZEV guidance, covering charging modes, cable sizing, and PME considerations.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Section 722 was introduced specifically for EV charging installations. It covers requirements for connecting EVs to the electrical supply, including protection, isolation, earthing, and cable sizing specific to charging applications.',
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      'In PME (TN-C-S) systems, a fault in the supply neutral can cause the installation earth to rise significantly above true earth. For an EV connected by a metal cable to both the house earth and actual earth (via its tyres), this creates a potential shock hazard.',
  },
  {
    id: 'check-3',
    question:
      'What is the minimum dedicated cable size typically required for a 7kW (32A) single-phase EV charger?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'A 7kW charger draws approximately 32A continuously. 6mm squared cable is typically required, though this must be verified against installation conditions including route length, grouping, thermal insulation contact, and ambient temperature. Longer runs may require 10mm squared.',
  },
  {
    id: 'check-4',
    question:
      'What type of RCD protection is specifically required for EV charging circuits under BS 7671?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Regulation 722.531.2 requires either a Type A RCD with the EVSE having integral DC fault detection (most Mode 3 chargers include this), or a Type B RCD. Type AC RCDs are not sufficient as they may not detect DC fault components from EV charging electronics.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Mode 1 uses standard sockets (not recommended), Mode 2 uses a special cable with in-cable control box, Mode 3 uses dedicated charging stations with built-in protection, and Mode 4 is DC rapid charging with the charger converting AC to DC.',
  },
  {
    id: 2,
    question:
      'A homeowner has a TN-C-S (PME) supply. What additional measure may be required for EV charging?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'For PME supplies, BS 7671 requires either a separate earth electrode meeting specific resistance values, or an increased protective conductor CSA to limit touch voltage under PME fault conditions. Many charger installations include a small earth rod for this purpose.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      "The OZEV (formerly OLEV) grant requires chargers to be 'smart' (capable of responding to signals to shift charging times), installed by OZEV-approved installers, and meet technical specifications. The installer must be registered with OZEV to process grant claims.",
  },
  {
    id: 4,
    question:
      'Why might a 7kW charger be more suitable than an 11kW or 22kW charger for many domestic installations?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Most UK domestic supplies are single-phase with 60A or 80A main fuses. A 7kW charger (32A) is typically the maximum that can be accommodated alongside normal household loads. 11kW and 22kW chargers require three-phase supplies, which are uncommon in UK homes.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Regulation 722.537.2.1.2 requires an isolating device to be provided to disconnect the charging equipment from the supply. This must be readily accessible and disconnect all live conductors, typically located near the charger or in the consumer unit.',
  },
  {
    id: 6,
    question:
      "What does a 'Mode 3' EV charging station provide that a Mode 2 arrangement does not?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Mode 3 stations have control, protection and communication functions built into the permanently installed unit. Mode 2 relies on an in-cable control box (ICCB) which provides similar functions but in a portable format - Mode 3 is considered safer and more convenient for regular use.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'EV charging is typically a continuous load (defined as 3 hours or more). Voltage drop calculations must use the full rated current, not a reduced value. The 5% limit applies for power circuits, and the cable route length from consumer unit to charger must be considered.',
  },
  {
    id: 8,
    question:
      'A car park is installing multiple EV chargers. What load management consideration applies?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "Dynamic load management (sometimes called 'smart charging' or 'load balancing') allows multiple chargers to share available capacity, reducing charging power when many vehicles charge simultaneously. This enables more charging points without requiring supply upgrades.",
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Type 2 (IEC 62196-2, also known as Mennekes) is the European standard for AC charging. It supports single-phase up to 7kW and three-phase up to 22kW. CHAdeMO and CCS are DC rapid charging connectors used for Mode 4 charging.',
  },
  {
    id: 10,
    question:
      'What earthing arrangement consideration applies when an EV charger is installed in an outbuilding supplied by SWA from the house?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'When extending a PME earthed supply to an outbuilding for EV charging, additional earthing measures are required. The SWA armour alone may not meet the protective conductor requirements. Often an earth electrode at the outbuilding and/or additional copper CPC within the SWA is specified.',
  },
  {
    id: 11,
    ...
    correctAnswer: 1,
    explanation:
      'Charging time is approximately battery capacity divided by charging power. For 60kWh at 7kW: 60/7 = approximately 8.5 hours. In practice, charging slows near 100% SOC, so full charges may take slightly longer. Most users charge overnight, making this acceptable for daily use.',
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      "An Electrical Installation Certificate (or Minor Works for additions to existing circuits) is required. Additionally, the installer should provide manufacturer's instructions, warranty information, user guidance on operation, and if applicable, OZEV grant documentation.",
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Section 722:</strong> Specific BS 7671 requirements for EV charging
              </li>
              <li>
                <strong>PME Concern:</strong> Special earthing measures often required
              </li>
              <li>
                <strong>Type A+ RCD:</strong> With DC detection, or Type B RCD required
              </li>
              <li>
                <strong>7kW Typical:</strong> Maximum single-phase domestic charging
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Undersized cables overheating during prolonged charging
              </li>
              <li>
                <strong>Use:</strong> Earth electrode for PME installations
              </li>
              <li>
                <strong>Apply:</strong> Smart charging to manage peak demand
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Electric vehicle charging is categorised into four modes, each with different power
              levels, safety features, and applications. Understanding these modes is essential for
              selecting the right solution for each installation.
            </p>
            ...
            <div className="grid gap-4 my-6">
              ...
              <div className="p-4 rounded-lg bg-white/5">
                <div className="flex justify-between items-start mb-2">
                  <p className="text-sm font-medium text-elec-yellow/80">
                    Mode 2 - In-Cable Control Box (ICCB)
                  </p>
                ...
                <ul className="text-sm text-white/80 space-y-1 ml-4">
                  ...
                  <li>
                    Slower than dedicated installations; socket outlet loading concerns remain
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The majority of UK domestic supplies use the TN-C-S (PME - Protective Multiple
              Earthing) system. While this provides excellent fault protection under normal
              conditions, it creates a specific concern for EV charging that BS 7671 Section 722
              addresses.
            </p>
            <p>
              The issue arises because an EV is simultaneously connected to the installation's
              protective conductor (via the charging cable) and to true earth (via its tyres on the
              ground). Under a PME fault condition (broken supply neutral), the installation's earth
              can rise to a dangerous voltage relative to true earth.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <ul className="text-sm text-white/90 space-y-2 ml-4">
                ...
                <li>
                  5. A person touching the vehicle while standing on the ground receives a shock
                </li>
              </ul>
            </div>

            <p>
              Section 722 provides two approaches to address this risk. Either the protective
              conductor must be sized to limit the touch voltage to safe levels, or an earth
              electrode must be installed to provide an alternative return path.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white/90 space-y-1 ml-4">
                ...
                <li>
                  <strong>Option 2:</strong> Size protective conductor to Table 54.1 enhanced
                  requirements
                </li>
                <li>
                  <strong>Option 3:</strong> Use charger with PME fault detection and shutdown
                </li>
                <li>
                  <strong>Combination:</strong> Many installations use earth rod plus enhanced CPC
                </li>
              </ul>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> For most domestic installations, a simple earth rod of
              around 1.2m driven near the charger location provides adequate protection. The rod
              must be tested to confirm acceptable resistance (typically below 200 ohms for this
              purpose).
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              EV charging represents a significant sustained load that requires careful cable
              sizing. Unlike most domestic loads that are intermittent, EV charging typically runs
              continuously for several hours - this affects cable sizing calculations significantly.
            </p>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="text-white/90">
                    ...
                    <tr className="border-b border-white/10">
                      ...
                      <td className="py-2 pr-4">
                        6mm<sup>2</sup> or 10mm<sup>2</sup>
                      </td>
            ...
            <p>
              Voltage drop must be calculated at full load current for the complete cable run. For a
              7kW charger at 32A over 25 metres of 6mm<sup>2</sup> cable, the voltage drop is
              approximately 4.7V (about 2%). This is within the 5% limit but leaves less margin for
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              EV charging circuits require specific protection arrangements that differ from
              standard power circuits. The electronics in EV chargers and vehicles can produce DC
              fault components that standard Type AC RCDs cannot detect.
            </p>

            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-white mb-3">
                RCD Requirements (Regulation 722.531.2):
              </p>
            ...
            <p>
              Smart charging capability is increasingly important - and mandatory for OZEV grant
              eligibility. Smart chargers can communicate with the grid, respond to time-of-use
              tariffs, and participate in vehicle-to-grid (V2G) schemes.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white/90 space-y-1 ml-4">
                ...
                <li>
                  <strong>Dynamic load management:</strong> Automatically reduce charging when
                  household demand peaks
                </li>
                <li>
                  <strong>Solar integration:</strong> Charge preferentially when solar generation is
                  available
                </li>
                <li>
                  <strong>App control:</strong> Monitor and control charging remotely
                </li>
                <li>
                  <strong>Grid services:</strong> Participate in demand response schemes
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-white/90 italic">
              ...
              the main fuse from overloading. When the cooker switches off, charging resumes at full
              power.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Undersized cables</strong> - Not accounting for continuous load or route
                  length
                </li>
                <li>
                  <strong>Wrong RCD type</strong> - Using Type AC instead of Type A with DC
                  detection
                </li>
                <li>
                  <strong>Ignoring PME</strong> - Not installing earth electrode where required
                </li>
                <li>
                  <strong>Supply overload</strong> - Not checking total demand against main fuse
                  capacity
                </li>
                <li>
                  <strong>Poor cable routing</strong> - Cables through insulation without derating
                </li>
                <li>
                  <strong>Missing isolation</strong> - No readily accessible isolator for charger
                </li>
              </ul>
            </div>
          </div>
