      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Designing and installing electric vehicle charging systems under BS 7671 Section 722 and OZEV guidance
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "EV charging modes and their applications",
              "BS 7671 Section 722 requirements",
              "PME earthing considerations and solutions",
              "Cable sizing for continuous EV charging loads",
              "RCD types and DC fault protection",
              "OZEV grant requirements and smart charging"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="../level3-module6-section4-4-5">
