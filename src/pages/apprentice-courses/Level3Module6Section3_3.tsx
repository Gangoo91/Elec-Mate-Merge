    ...
    <div className="min-h-screen overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        <header className="text-center mb-12">
          <div className="inline-flex items-center gap-2 text-elec-yellow text-sm mb-3"><Zap className="h-4 w-4" /><span>Module 6.3.3</span></div>
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3">Correction Factors</h1>
          <p className="text-white/80">Applying Ca, Cg, Ci to determine actual cable capacity</p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {["Explain why correction factors are needed", "Use BS 7671 tables to find Ca, Cg, and Ci values", "Apply multiple factors in cable calculations", "Calculate minimum tabulated current required", "Understand the effect of BS 3036 fuses (Cc)", "Apply correction factors to practical examples"].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button variant="ghost" size="lg" className="w-full sm:w-auto min-h-[48px] text-white/70 hover:text-white hover:bg-white/5" asChild>
            <Link to="../level3-module6-section3-2"><ArrowLeft className="w-4 h-4 mr-2" />Back: Current Capacity</Link>
          </Button>
          <Button size="lg" className="w-full sm:w-auto min-h-[48px] bg-elec-yellow text-[#1a1a1a] hover:bg-elec-yellow/90 font-semibold" asChild>
            <Link to="../level3-module6-section3-4">Next: Grouping & Thermal<ArrowLeft className="w-4 h-4 ml-2 rotate-180" /></Link>
          </Button>
        </nav>
      </article>
    </div>
