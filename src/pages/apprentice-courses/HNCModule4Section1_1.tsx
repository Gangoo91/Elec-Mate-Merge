        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Maximum demand:</strong> Highest expected load at any instant
              </li>
              <li className="pl-1">
                <strong>Assessment methods:</strong> Measured, calculated, or benchmarked
              </li>
              <li className="pl-1">
                <strong>ESQCR requirement:</strong> Must agree with DNO before connection
              </li>
              <li className="pl-1">
                <strong>Integration period:</strong> Typically 30 minutes
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Office buildings:</strong> 70-100 VA/m² typical
              </li>
              <li className="pl-1">
                <strong>Retail:</strong> 80-150 VA/m² typical
              </li>
              <li className="pl-1">
                <strong>Industrial:</strong> Highly variable by process
              </li>
              <li className="pl-1">
                <strong>Growth allowance:</strong> 20-25% recommended
              </li>
            </ul>
          </div>
        </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">Maximum demand current</td>
                      <td className="border border-white/10 px-3 py-2">
                        Larger containment, higher material cost
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Oversized plant, higher running costs
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              <p className="text-sm font-medium text-red-400 mb-2">
                ESQCR Regulation 25 - Key Requirements
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">Consumers must provide maximum demand information to DNO</li>
                <li className="pl-1">
                  Notification required before connection or significant increase
                </li>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Information Required for DNO Application
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Coincident demand:</strong> Loads that operate simultaneously and
                  contribute to peak
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Design implication:</strong> Only coincident loads determine maximum
                  demand
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Benchmark Assessment
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: kW to kVA Conversion
              </h3>
              <p className="text-sm text-white mb-2">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Determine operational patterns (hours of use, seasonal variation)
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Confusing kW and kVA</strong> — DNO supplies rated in kVA
                </li>
                <li className="pl-1">
