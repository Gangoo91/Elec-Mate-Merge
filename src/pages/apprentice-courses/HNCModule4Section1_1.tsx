...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['15 minutes', '30 minutes', '1 minute', '1 hour'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['769kVA', '500kVA', '750kVA', '325kVA'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 311.1 is the regulatory anchor for everything in this subsection. As the designer,
              you cannot pull a kVA figure out of the air — you must determine maximum demand by a
              defensible method (measured, calculated with diversity, or benchmarked) and document
              it. Get this wrong and every cable, every CB rating and the DNO connection itself sit
        ...
        <ConceptBlock title="Maximum Demand Fundamentals">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DNO supply</strong> sized by maximum demand (kVA) — overestimate means higher
              connection charges
            </li>
            <li>
            ...
            <li>
              <strong>Main switchgear</strong> sized by maximum demand current — overestimate means
          ...
          <p>
            <strong>Design principle:</strong> Accurate maximum demand assessment balances adequate
            capacity against unnecessary infrastructure cost.
          </p>
          <p>
            <strong>Quick context:</strong> Office buildings typically run at 70-100 VA/m²; retail
            80-150 VA/m²; industrial highly variable by process. Always add 20-25% growth allowance.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="ESQCR Requirements and DNO Interface">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Stage 1:</strong> Submit application with maximum demand (kVA), power factor,
              connection details
            </li>
            <li>
        ...
        <ConceptBlock title="Load Profiles and Peak Measurement">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>15 minutes</strong> — captures short-term process peaks; used in some billing
              tariffs
            </li>
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — benchmark assessment:</strong> Estimate maximum demand for a 5,000m²
          ...
          <p>
            <strong>Example 2 — calculated method:</strong> Calculate maximum demand from connected
            loads — Lighting 80kW, Small power 120kW, HVAC 200kW, Lifts 60kW (2 × 30kW).
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              client wants to add a new comms room (continuous 40&nbsp;kW IT load), VRF cooling and
              a small staff kitchen. The design team needs maximum demand to confirm whether the
              existing supply will cope or a DNO upgrade is the critical path.
            </>
          }
          whatToDo={
            <>
              Take the CIBSE prestige-office benchmark of 90–130&nbsp;VA/m² as a sanity check (≈
              540&nbsp;kVA). Then build the calculated method: lighting 30&nbsp;kW × 0.9, small
              power 110&nbsp;kW × 0.4, VRF 90&nbsp;kW × 0.7, comms 40&nbsp;kW × 1.0 (data centre —
              no diversity), kitchen 25&nbsp;kW × 0.5. Sum, divide by an expected 0.95 power factor,
              add 20% growth, then convert to kVA. Compare against the existing 250&nbsp;kVA supply.
              If above, lodge a DNO application immediately — reinforcement may take 3–6 months.
            </>
          }
          whyItMatters={
            <>
              Reg 311.1 makes this assessment mandatory. ESQCR Reg 25 places the duty on you as
              designer to agree the figure with the DNO before connection. Discovering a supply
              shortfall at second-fix stage is a programme-killer that can push the handover back by
              months and trigger client claims.
            </>
          }
        />
