...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['300mm', '600mm', '150mm', '450mm'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Class A+', 'Class B', 'Class A+++', 'Class A'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Below 45°C', 'Below 35°C', 'Below 65°C', 'Below 55°C'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['88% SEDBUK', '90% SEDBUK', '92% SEDBUK', '86% SEDBUK'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Copper', 'Mild steel', 'Cast iron', 'PVC or ABS plastic'],
    correctAnswer: 3,
    explanation:
...
const HNCModule8Section1_1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 1 · Subsection 1"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Boiler Types and Classifications">
          ...
          <p>
            <strong>Primary Boiler Classifications:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Combination (Combi) boilers:</strong> Provide space heating and instantaneous
              DHW from a single unit
            </li>
            <li>
            ...
            <li>
              <strong>Regular (heat-only) boilers:</strong> Require separate pump, expansion vessel
              and controls, typically with vented cylinders
            </li>
            <li>
              <strong>Condensing boilers:</strong> High-efficiency units that recover latent heat
              from flue gases
            </li>
          </ul>
          <p>
            <strong>Boiler Type Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Combi:</strong> Instantaneous — Small-medium properties, 1-2 bathrooms — 24-42
              kW
            </li>
            <li>
              <strong>System:</strong> Stored (cylinder) — Larger properties, multiple bathrooms —
              12-35 kW
            </li>
            <li>
              <strong>Regular:</strong> Stored (cylinder) — Replacement in existing systems — 12-30
              kW
            </li>
            <li>
              <strong>Commercial:</strong> Various — Large buildings, cascade systems — 50-150+ kW
            </li>
          </ul>
          <p>
            <strong>Condensing Boiler Operation</strong>
          </p>
          <p>Key principles:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Building Regulations requirement:</strong> Part L mandates minimum 90% seasonal
            efficiency (SEDBUK 2009) for new boiler installations, effectively requiring condensing
            technology in virtually all cases.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Efficiency Ratings and ErP Directive">
          <p>
            The Energy-related Products (ErP) directive establishes minimum efficiency standards and
            energy labelling requirements for heating appliances. Understanding these ratings is
            essential for specifying compliant and efficient heating systems.
          </p>
          <p>
            <strong>ErP Energy Labels</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>SEDBUK Methodology</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>ErP Efficiency Classes - Space Heating</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>A+++:</strong> &gt;150% — Heat pumps (GSHP)
            </li>
            <li>
              <strong>A++:</strong> 125-150% — Heat pumps (ASHP)
            </li>
            <li>
              <strong>A+:</strong> 98-125% — Condensing + solar thermal
            </li>
            <li>
              <strong>A:</strong> 90-98% — Condensing boilers
            </li>
            <li>
              <strong>B-D:</strong> 82-90% — Non-condensing (limited use)
            </li>
          </ul>
          <p>
            <strong>Weather Compensation Benefits</strong>
          </p>
          <p>
            Weather compensation adjusts boiler flow temperature based on external conditions. In
            milder weather, lower flow temperatures (&lt;55°C) maximise condensing operation,
        ...
        <ConceptBlock title="Cascade Systems and Sequencing Control">
          <p>
            Cascade boiler systems utilise multiple boilers operating together to meet varying heat
            demands efficiently. Sequencing control brings boilers online progressively, maintaining
            high efficiency across the full load range while providing resilience.
          </p>
          <p>
            <strong>Cascade System Advantages:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Maintenance:</strong> Individual boilers can be serviced without total system
              shutdown
            </li>
            <li>
              <strong>Extended life:</strong> Reduced running hours per unit with lead-lag rotation
            </li>
          </ul>
          <p>
            <strong>Cascade Control Methods</strong>
          </p>
          <p>
            <strong>Sequencing Control</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Lead-Lag Rotation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Cascade System Components</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Low-loss header:</strong> Hydraulic separation — Size for total system flow
              rate, air/dirt separation
            </li>
            <li>
              <strong>Cascade controller:</strong> Sequencing logic — BMS integration, weather
              compensation, optimisation
            </li>
            <li>
              <strong>Primary pumps:</strong> Boiler circuit flow — Individual or common, variable
              speed recommended
            </li>
            <li>
              <strong>Non-return valves:</strong> Prevent reverse flow — Spring-loaded type, low
              resistance design
            </li>
            <li>
              <strong>Isolation valves:</strong> Maintenance isolation — Full bore, lockable handles
            </li>
            <li>
              <strong>Common flue:</strong> Shared flue system — Fan-assisted, sized for all boilers
              firing
            </li>
          </ul>
          <p>
            <strong>Worked Example: Cascade Sizing</strong>
          </p>
          <p>
            <strong>Scenario:</strong> Office building with 200 kW design heat load. Specify cascade
            system.
          </p>
          ...
          <p>
            ...
            Typical designs operate at 60-80% of total installed capacity during average conditions.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Flue Requirements and Safety Controls">
          ...
          <p>
            <strong>Flue Types and Applications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Room-sealed balanced flue:</strong> Concentric or twin-pipe system drawing air
              from outside - most common for modern boilers
            </li>
            <li>
          ...
          <p>
            <strong>Building Regulations Part J - Terminal Positions</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Below opening window:</strong> 300mm — 300mm — 300mm
            </li>
            <li>
              <strong>Above opening window:</strong> 300mm — 300mm — 300mm
            </li>
            <li>
              <strong>Horizontally from opening:</strong> 300mm — 400mm — 600mm
            </li>
            <li>
              <strong>Below eaves/gutter:</strong> 200mm — 300mm — 300mm
            </li>
            <li>
              <strong>From internal corner:</strong> 300mm — 600mm — 600mm
            </li>
            <li>
              <strong>Above ground level:</strong> 300mm — 300mm — 300mm
            </li>
          </ul>
          <p>
            <strong>Safety Controls - Mandatory Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Flame supervision device:</strong> Ionisation probe or thermocouple - shuts
              off gas if flame fails
            </li>
            <li>
              <strong>Overheat thermostat:</strong> High limit stat (typically 95-100°C) - manual
              reset required
            </li>
            <li>
              <strong>Pressure relief valve:</strong> PRV set at 3 bar - discharges to safe location
            </li>
            <li>
            ...
            <li>
              <strong>Frost protection:</strong> Prevents freezing damage - integral to most modern
              boilers
            </li>
          </ul>
          <p>
            <strong>Electrical Connections (BS 7671)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Permanent supply:</strong> FCU, 3A or 5A fuse — Dedicated circuit recommended
            </li>
            <li>
              <strong>Isolation:</strong> Accessible double-pole — Within 3m of boiler
            </li>
            <li>
              <strong>Room thermostat:</strong> Volt-free contacts — Breaks call for heat
            </li>
            <li>
              <strong>Cylinder stat:</strong> Volt-free contacts — System/regular boilers only
            </li>
            <li>
              <strong>Programmer:</strong> Mains or low voltage — Time control for CH and DHW
            </li>
            <li>
              <strong>External sensor:</strong> Manufacturer specific — Weather compensation
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Gas Safe requirement:</strong> All gas boiler installations must be carried out
            by a Gas Safe registered engineer. The Benchmark commissioning checklist (or
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> 28 kW combi boiler to be installed in kitchen. Assess flue
            terminal position.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Configure cascade controller for 3 × 80 kW boilers serving
            office building.
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Poor system cleanliness:</strong> Debris damages heat exchanger - flush and
                filter
              </li>
              <li>
