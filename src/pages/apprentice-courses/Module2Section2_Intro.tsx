      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="mb-10 p-4 sm:p-6 border border-white/20 rounded-lg">
          ...
          <p className="text-xs sm:text-sm text-white">
            You're viewing Section 2. If anything looks off, please let us know and we'll refine the
            content for Level 2 learners in UK English, aligned to BS 7671.
          </p>
        </section>

        <div
          className="flex items-start gap-3 bg-card/20 border-l-2 border-elec-yellow p-4 rounded mt-6"
          role="alert"
        >
          <AlertTriangle className="w-5 h-5 text-elec-yellow mt-0.5" />
          <p className="text-white text-sm">
            Always follow safe isolation and BS 7671. Manufacturer instructions take priority for
