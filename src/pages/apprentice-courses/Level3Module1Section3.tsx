...
const subsections = [
  {
    ...
    icon: PowerOff,
    href: "../level3-module1-section3-3-1",
  },
  {
    number: "3.2", 
    ...
    icon: Lock,
    href: "../level3-module1-section3-3-2",
  },
  {
    number: "3.3",
    ...
    icon: AlertTriangle,
    href: "../level3-module1-section3-3-3",
  },
  {
    number: "3.4",
    ...
    icon: Zap,
    href: "../level3-module1-section3-3-4",
  },
  {
    number: "3.5",
    ...
    icon: TestTube,
    href: "../level3-module1-section3-3-5",
  },
  {
    number: "3.6", 
    ...
    icon: Shield,
    href: "../level3-module1-section3-3-6",
  },
];
