    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Apply financial management principles to building services projects from estimate to final
          account
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the complete cost management cycle for building services projects -
          from initial estimating and budget development through to cost control, variations
          management and final account agreement.
        </p>
