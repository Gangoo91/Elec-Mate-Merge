...
const seoDescription =
  'Learn preventative maintenance strategies for electrical installations including planned inspection schedules, predictive maintenance techniques, and condition-based monitoring to prevent future faults.';

// Quick check questions for inline knowledge checks
const quickCheckQuestions = [
  {
    question:
      'What is the maximum recommended interval for periodic inspection of a domestic installation according to BS 7671 guidance?',
    options: ['5 years', '10 years', '3 years', '1 year'],
    correctAnswer: 1,
    explanation:
      "BS 7671 Guidance Note 3 recommends a maximum interval of 10 years for periodic inspection of domestic installations, though more frequent inspections may be required based on the installation's condition and use.",
  },
  {
    question:
      'Which maintenance approach uses real-time monitoring to predict when equipment will fail?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Predictive maintenance uses real-time monitoring of equipment parameters such as temperature, vibration, and electrical characteristics to predict when failure is likely to occur, allowing intervention before breakdown.',
  },
  {
    question:
      'What should be included in a preventative maintenance schedule for electrical installations?',
    options: [
      'Only visual inspections',
      'Only testing without records',
      'Visual inspection, testing, and documentation',
      'Repairs only when faults occur',
    ],
    correctAnswer: 2,
    explanation:
      'A comprehensive preventative maintenance schedule should include regular visual inspections, periodic testing to verify safe operation, and thorough documentation of all findings, actions, and recommendations.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Thermal imaging detects elevated temperatures caused by loose connections, overloaded circuits, unbalanced loads, and failing components, allowing identification of problems before they cause faults or fires.',
  },
];
...
const quizQuestions = [
  {
    question:
      'According to BS 7671 Guidance Note 3, what is the recommended maximum interval for periodic inspection of commercial installations?',
    options: ['1 year', '3 years', '5 years', '10 years'],
    correctAnswer: 2,
    explanation:
      "BS 7671 Guidance Note 3 recommends a maximum interval of 5 years for periodic inspection of commercial installations, though the actual interval should be determined by the installation's condition, use, and environment.",
  },
  {
    question:
      'What type of maintenance involves monitoring equipment condition to schedule repairs before failure?',
    options: [
      'Reactive maintenance',
    ...
    correctAnswer: 1,
    explanation:
      'Condition-based maintenance monitors the actual condition of equipment through various techniques and schedules maintenance activities based on measured parameters, preventing unexpected failures.',
  },
  {
    question:
      'Which of the following is NOT typically included in a planned preventative maintenance programme?',
    options: [
      'Scheduled visual inspections',
      'Regular testing of protective devices',
      'Waiting for equipment to fail before replacing',
      'Proactive component replacement',
    ],
    correctAnswer: 2,
    explanation:
      'Waiting for equipment to fail is reactive maintenance, not preventative maintenance. PPM programmes focus on scheduled inspections, testing, and proactive replacement of components before they fail.',
  },
  {
    question:
      'What temperature difference typically indicates a serious problem when using thermal imaging on electrical connections?',
    options: [
      '5C above ambient',
      '10C above similar connections',
      '20C or more above similar connections',
      'Any temperature difference',
    ],
    correctAnswer: 2,
    explanation:
      'A temperature difference of 20C or more above similar connections under similar load conditions typically indicates a serious problem requiring immediate attention, such as a loose connection or failing component.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'RCDs should be tested quarterly (every 3 months) by the user using the integral test button to verify the mechanical operation. This is in addition to periodic testing by a competent person.',
  },
  {
    question:
      'What document should record the recommended interval for the next periodic inspection?',
    options: [
      'Building logbook only',
    ...
    correctAnswer: 2,
    explanation:
      "The Electrical Installation Condition Report (EICR) includes a section for recording the recommended interval to the next inspection, based on the installation's condition, use, and environment.",
  },
  {
    question:
      'Which maintenance strategy is most appropriate for critical systems where failure cannot be tolerated?',
    options: [
      'Run-to-failure',
      'Time-based replacement',
      'Condition-based maintenance with redundancy',
      'Annual inspection only',
    ],
    correctAnswer: 2,
    explanation:
      'Critical systems require condition-based maintenance combined with redundancy to ensure continuous operation. This approach monitors equipment health while having backup systems available if primary equipment shows signs of impending failure.',
  },
  {
    question: 'What should be checked during routine maintenance of consumer units?',
    options: [
      'Only the main switch operation',
      'Tightness of connections, signs of overheating, and device operation',
      'Paint finish only',
      'Labels only',
    ],
    correctAnswer: 1,
    explanation:
      'Routine maintenance of consumer units should include checking connection tightness, looking for signs of overheating or arcing, verifying device operation, confirming correct circuit identification, and ensuring the enclosure is in good condition.',
  },
  {
    question:
      'What is the primary benefit of maintaining an electrical installation asset register?',
    options: [
      'Reduces electricity consumption',
      'Helps identify equipment age and maintenance history',
      'Eliminates the need for testing',
      'Reduces installation costs',
    ],
    correctAnswer: 1,
    explanation:
      'An asset register tracks equipment details, installation dates, maintenance history, and expected lifespan, helping to plan replacements, schedule maintenance, and identify aging equipment that may need attention.',
  },
  {
    question:
      'According to best practice, when should worn or damaged flexible cables be replaced?',
    options: [
      'Only when they cause a fault',
      'As soon as damage is identified',
      'At the next periodic inspection',
      'When the equipment is replaced',
    ],
    correctAnswer: 1,
    explanation:
      'Damaged flexible cables should be replaced as soon as the damage is identified. Continuing to use damaged cables creates risk of electric shock and fire, and deterioration will only worsen over time.',
  },
  {
    question: 'What role does environmental monitoring play in preventative maintenance?',
    options: [
      "No role - environment doesn't affect electrical equipment",
      'Identifies conditions that accelerate equipment degradation',
      'Only relevant for outdoor installations',
      'Reduces testing requirements',
    ],
    correctAnswer: 1,
    explanation:
      'Environmental monitoring identifies conditions such as excessive moisture, dust, temperature extremes, or corrosive atmospheres that accelerate equipment degradation, allowing proactive measures to protect equipment or increase maintenance frequency.',
  },
  {
    question: 'What should be the outcome of an effective preventative maintenance programme?',
    options: [
      'Elimination of all electrical testing',
      'Reduced equipment lifespan',
      'Fewer unexpected failures and extended equipment life',
      'Higher repair costs',
    ],
    correctAnswer: 2,
    explanation:
      'An effective preventative maintenance programme results in fewer unexpected failures, extended equipment lifespan, improved safety, reduced emergency repair costs, and better compliance with regulatory requirements.',
  },
];
...
const faqs = [
  ...
  {
    question:
      'What training do I need to perform preventative maintenance on electrical installations?',
    answer:
  ...
  return (
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <section className="mb-8 sm:mb-12">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <ul className="list-disc pl-5 text-white text-sm space-y-2">
              ...
              <li>
                <strong>Reduced Downtime:</strong> Planned maintenance minimises unexpected failures
                and emergency repairs
              </li>
              <li>
                <strong>Extended Equipment Life:</strong> Proper maintenance prolongs the
                serviceable life of installations
              </li>
              <li>
                <strong>Cost Savings:</strong> Preventing failures is typically cheaper than
                emergency repairs
              </li>
              <li>
                <strong>Regulatory Compliance:</strong> Demonstrates due diligence under Electricity
                at Work Regulations
              </li>
              <li>
                <strong>Energy Efficiency:</strong> Well-maintained equipment operates more
                efficiently
              </li>
            </ul>
          </div>
        ...
        <section className="mb-8 sm:mb-12">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <ul className="list-disc pl-5 text-white text-sm space-y-2">
              ...
              <li>
                <strong>Environmental conditions:</strong> Moisture, dust, chemicals, or temperature
                extremes accelerate deterioration
              </li>
              <li>
                <strong>Intensity of use:</strong> Heavily used installations may require more
                frequent attention
              </li>
              <li>
                <strong>Equipment age:</strong> Older installations may need closer monitoring
              </li>
              <li>
                <strong>Modifications or additions:</strong> Changes since last inspection may
                warrant earlier re-inspection
              </li>
              <li>
                <strong>Insurance requirements:</strong> Insurers may stipulate specific inspection
                intervals
              </li>
              <li>
                <strong>Regulatory requirements:</strong> Some premises have statutory inspection
                requirements
              </li>
            </ul>
            ...
            <p className="text-white text-sm mb-3">
              ...
              communicated to the duty holder responsible for the installation.
            </p>
          </div>
        </section>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-white/5 rounded-lg p-4 mb-4">
              ...
              <ul className="list-disc pl-5 text-white text-sm space-y-1">
                ...
                <li>
                  <strong>Harmonics:</strong> Distortion from non-linear loads affecting equipment
                  life
                </li>
                <li>
                  <strong>Load profiles:</strong> Peak demands and load patterns
                </li>
                <li>
                  <strong>Power factor:</strong> Reactive power affecting efficiency
                </li>
                <li>
                  <strong>Phase balance:</strong> Uneven distribution across phases
                </li>
              </ul>
            </div>
        ...
        <section className="mb-8 sm:mb-12">
          ...
          <div className="prose prose-invert max-w-none">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border border-white/20 p-2">
                      RCD test button operation by user
                    </td>
                  ...
                  <tr>
                    <td className="border border-white/20 p-2">Annually</td>
                    <td className="border border-white/20 p-2">
                      Thermal survey of distribution boards
                    </td>
            ...
            <ul className="list-disc pl-5 text-white text-sm space-y-2">
              ...
              <li>
                <strong>Shutdown coordination:</strong> Plan testing requiring isolation with
                operations
              </li>
              <li>
                <strong>Seasonal factors:</strong> Consider heating/cooling loads and occupancy
                patterns
              </li>
              <li>
                <strong>Resource availability:</strong> Ensure competent personnel and equipment are
                available
              </li>
              <li>
                <strong>Regulatory deadlines:</strong> Meet statutory inspection requirements
              </li>
              <li>
                <strong>Grouping opportunities:</strong> Combine related activities efficiently
              </li>
            </ul>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-gradient-to-r from-yellow-400/10 to-amber-500/10 rounded-lg p-4 border border-yellow-400/20 mb-4">
              ...
              <ol className="list-decimal pl-5 text-white text-sm space-y-2">
                ...
                <li>
                  <strong>Identify:</strong> Find patterns indicating equipment issues or programme
                  gaps
                </li>
                <li>
                  <strong>Adjust:</strong> Modify maintenance intervals, activities, or techniques
                  as needed
                </li>
                <li>
                  <strong>Implement:</strong> Update schedules, procedures, and documentation
                </li>
                <li>
                  <strong>Monitor:</strong> Track effectiveness of changes through ongoing records
                </li>
              </ol>
            </div>
            ...
            <ul className="list-disc pl-5 text-white text-sm space-y-2">
              ...
              <li>
                <strong>Emergency callouts:</strong> Number and cost of unplanned interventions
              </li>
              <li>
                <strong>Equipment availability:</strong> Uptime of critical systems
              </li>
              <li>
                <strong>Defect trends:</strong> Patterns in observations from inspections
              </li>
              <li>
                <strong>Regulatory compliance:</strong> Status of required certifications
              </li>
              <li>
                <strong>Cost efficiency:</strong> Maintenance cost per asset or per unit
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-white text-sm">
                ...
                with clear metrics and benefits.
              </p>
            </div>
        ...
        {/* Quiz Section */}
        <section className="mb-8 sm:mb-12">
          <Quiz title="Section 5.5 Knowledge Check" questions={quizQuestions} passingScore={75} />
        </section>
