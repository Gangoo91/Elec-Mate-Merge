...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['1,000 m²', '2,000 m²', 'No limit specified', '1,600 m²'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['Category L1', 'Category L5', 'Category L3', 'Category P1'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['32 devices', '20 devices', '10 devices', 'No specific limit'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <ConceptBlock title="BS 5839-1 System Categories">
          ...
          <p>
            <strong>Life Safety Categories (L1-L5)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>L1:</strong> All areas including voids, roof spaces, cupboards — High-risk
              premises, hospitals, residential care
            </li>
            <li>
              <strong>L2:</strong> Escape routes, rooms opening onto them, high-risk areas — Hotels,
              hostels, HMOs, boarding houses
            </li>
            <li>
              <strong>L3:</strong> Escape routes only — Factories, warehouses with clear escape
              paths
            </li>
            <li>
              <strong>L4:</strong> Escape routes within dwellings — Domestic premises (linked to
              Building Regs)
            </li>
            <li>
              <strong>L5:</strong> Specific areas defined by fire risk assessment — Bespoke
              protection, server rooms, plant areas
            </li>
          </ul>
          <p>
            <strong>Property and Manual Categories</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>P1:</strong> All areas (property protection throughout) — Museums, heritage
              buildings, warehouses
            </li>
            <li>
              <strong>P2:</strong> High-risk areas only (property) — Storage areas, plant rooms,
              specific risks
            </li>
            <li>
              <strong>M:</strong> Manual call points only, no automatic detection — Low-risk,
              single-storey, good visibility
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Detector Types and Selection">
          <p>
            ...
            characteristics likely to occur and the environmental conditions that could cause false
            alarms. Different detector technologies respond to different fire signatures.
          </p>
          <p>
            <strong>Optical Smoke Detectors</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Ionisation Smoke Detectors</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Multi-Sensor Detectors</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Detector Selection Guide</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Office, corridor:</strong> Optical or multi-sensor — General purpose, good
              response
            </li>
            <li>
              <strong>Kitchen:</strong> Heat detector — Immune to cooking fumes
            </li>
            <li>
              <strong>Plant room:</strong> Heat detector (rate-of-rise) — Tolerates fumes, dust,
              temperature
            </li>
            <li>
              <strong>Server room:</strong> Aspirating (VESDA) — Very early warning, high airflow
            </li>
            <li>
              <strong>Warehouse (high ceiling):</strong> Beam detector or aspirating — Point
              detectors impractical at height
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Zoning Requirements and Cause and Effect">
          <p>
            ...
            brigade response. Cause and effect matrices define system behaviour when alarms occur in
            different zones, controlling outputs such as sounders, door releases, and building
            services interfaces.
          </p>
          <p>
            <strong>BS 5839-1 Zoning Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Floor separation:</strong> Each floor should be a separate zone (exceptions
              for atriums)
            </li>
            <li>
          ...
          <p>
            <strong>Cause and Effect Matrix Example</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Zone 1 - Ground Floor:</strong> Yes — Yes — Yes — Yes
            </li>
            <li>
              <strong>Zone 2 - First Floor:</strong> Yes — Yes — Yes — Yes
            </li>
            <li>
              <strong>Zone 5 - Kitchen:</strong> Delayed 3min — Yes — No — Extract only
            </li>
            <li>
              <strong>Zone 8 - Plant Room:</strong> Yes — Yes — Yes — Yes
            </li>
            <li>
              <strong>MCP Any Zone:</strong> Immediate — Yes — Yes — Yes
            </li>
          </ul>
          <p>
            <strong>Typical System Outputs (Effects)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Voice Alarm and System Integration">
          ...
          <p>
            <strong>BS 5839-8 Voice Alarm Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Intelligibility:</strong> STIPA (Speech Transmission Index for PA) &gt; 0.5
              minimum
            </li>
            <li>
            ...
            <li>
              <strong>Fault tolerance:</strong> Single fault should not disable more than one zone
            </li>
          </ul>
          <p>
            <strong>When Voice Alarm is Required</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Voice Alarm Message Types</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Fire Alarm Integration Interfaces</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HVAC / AHU:</strong> Volt-free contact or BACnet — Shutdown fans, close
              dampers
            </li>
            <li>
              <strong>Smoke dampers:</strong> 24V DC or volt-free — Close to prevent smoke spread
            </li>
            <li>
              <strong>Lifts:</strong> Dedicated fire service switch — Recall to ground, doors open
            </li>
            <li>
              <strong>Access control:</strong> Volt-free or network — Unlock escape route doors
            </li>
            <li>
              <strong>BMS:</strong> BACnet, Modbus, or volt-free — Log alarms, coordinate response
            </li>
            <li>
              <strong>Emergency lighting:</strong> Automatic (loss of supply) — Illuminate escape
              routes
            </li>
            <li>
              <strong>Gas suppression:</strong> Dedicated interface panel — Trigger release after
              delay
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> A 4-storey office building with open-plan offices, meeting
            rooms, a ground floor reception, plant room, and basement car park. Determine the
            appropriate BS 5839-1 category.
          </p>
          ...
          <p>
            Plant room: <span>P2</span> (property protection of high-risk area)
          </p>
          <p>
            Car park: <span>P2</span> or separate system per BS 5839-6
          </p>
          ...
          <p>
            Minimum zones = 4,000 ÷ 2,000 = <span>2 zones</span>
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Calculate battery capacity for a fire alarm system with 2A
            standby current and 8A alarm current.
          </p>
          ...
          <p>
            52 x 1.25 = <span>65 Ah minimum</span>
          </p>
