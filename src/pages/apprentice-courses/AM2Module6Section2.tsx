...
const AM2Module6Section2 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ['Bathroom zones', 'Maximum Zs values', 'Cable colour codes', 'RCD requirements'],
      correctAnswer: 2,
      explanation:
    ...
    },
    {
      ...
      options: ['P = I squared R', 'P = VI', 'I = V/R', 'V = IR'],
      correctAnswer: 3,
    ...
    },
    {
      ...
      options: ['8.7 A', '6.7 A', '10.2 A', '12.5 A'],
      correctAnswer: 0,
    ...
    },
    {
      ...
      options: ['0.2 seconds', '0.4 seconds', 'No requirement', '5 seconds'],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: ['BS 7671', 'CDM 2015', 'EAWR 1989', 'HASAWA 1974'],
      correctAnswer: 2,
      explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/am2/module6"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The AM2 online knowledge test checks whether you can apply electrical theory, regulations,
          and safety knowledge to real-world practice. It's not just memory - questions are designed
          to see if you understand principles and can use BS 7671, science, and safety rules in
          practical contexts. Knowing the core subject areas makes revision focused and efficient.
        </p>
          ...
          whatHappens={
            <>
              <p className="text-ios-callout text-white mb-2">
                The AM2 knowledge test covers three specific areas. Trying to revise everything will
                waste time and reduce your chances of success.
              </p>
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-4 text-sm sm:text-base leading-relaxed">
            ...
            <ul className="space-y-2 ml-4 text-white">
              ...
              <li>
                - <strong className="text-white">Bathroom zones and IP ratings:</strong> Zone 0, 1,
                2 boundaries and required IP protection levels
              </li>
              <li>
            ...
            <ul className="space-y-2 ml-4 text-white">
              ...
              <li>
                - <strong className="text-white">"Where must RCDs be fitted?"</strong> - Application
                requirements from Part 7
              </li>
              <li>
            ...
            <ul className="space-y-2 ml-4 text-white">
              ...
              <li>
                - <strong className="text-white">Bathroom zones:</strong> Zone 0 (inside bath), Zone
                1 (above bath to 2.25m), Zone 2 (0.6m from Zone 1)
              </li>
              <li>
                - <strong className="text-white">Volt drop limits:</strong> 3% (lighting), 5% (other
                uses), from origin of installation
              </li>
              <li>
                - <strong className="text-white">RCD ratings:</strong> 30mA for socket outlets, 0.3s
                maximum disconnection time
              </li>
              <li>
                - <strong className="text-white">Insulation resistance:</strong> Minimum 1MO between
        ...
        <RegsCallout
          ...
          meaning={
            <>
              On the BS 7671 paper, you'll see questions on key values you should know cold: maximum
              Zs for protective devices (e.g. <strong>1.37 Ω for 32A Type B MCB</strong> in
              A4:2026), bathroom zone boundaries, IR test voltages (500 V DC), minimum IR (1 MΩ),
              disconnection times (0.4 s for socket circuits up to 32 A on TN systems). If the paper
              is open book, you can look these up — but only if you can navigate the index quickly.
              Memorise the headline numbers anyway.
            </>
          }
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-4 text-sm sm:text-base leading-relaxed">
            ...
            <ul className="space-y-2 ml-4 text-white">
              ...
              <li>
                - <strong className="text-white">Units and conversions:</strong> Amps, volts, watts,
                ohms, kilowatts, kilowatt-hours
              </li>
              <li>
            ...
            <ul className="space-y-2 ml-4 text-white">
              ...
              <li>
                - <strong className="text-white">Three-phase:</strong> Line voltage = 1.732 x Phase
                voltage (1.732 x 230V = 400V)
              </li>
            </ul>
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-4 text-sm sm:text-base leading-relaxed">
            ...
            <ul className="space-y-2 ml-4 text-white">
              ...
              <li>
                - <strong className="text-white">Hard hat:</strong> Protection from falling objects
                and head impact
              </li>
              <li>
                - <strong className="text-white">Safety glasses:</strong> Eye protection from arcing
                and debris
              </li>
              <li>
              ...
              <li>
                - <strong className="text-white">Voltage indicator:</strong> Properly maintained and
                tested proving unit
              </li>
              <li>
                - <strong className="text-white">High-visibility clothing:</strong> When working in
        ...
        <Scenario
          ...
          situation={
            <>
              Question on the test: "An apprentice is asked to install a socket outlet in zone 2 of
              a bathroom. Which of the following is the correct minimum IP rating for the
          ...
          whatToDo={
            <>
              ...
              <ul className="space-y-1 list-disc pl-5 mt-2">
                <li>
                  Zone 2 = the area extending 0.6 m horizontally beyond the bath/shower up to 2.25 m
                  high
                </li>
                <li>
          ...
          whyItMatters={
            <>
              ...
              versus "what's required" — is what separates pass from fail. On the day, slow down on
              questions like this. Re-read before you click.
            </>
          }
        />
        ...
        <ConceptBlock title="4. Question Style Examples in Core Topics">
          ...
          <p>
            <strong>Question:</strong> "What is the maximum disconnection time for a socket circuit
            under BS 7671?"
          </p>
          <p>
          ...
          <p>
            <strong>Question:</strong> "If a heater is rated at 2 kW on a 230 V supply, what current
            will it draw?"
          </p>
          <p>
        ...
        <ConceptBlock title="Practical Guidance">
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Make revision checklists:</strong> Create separate lists for each category to
              track your progress
            </li>
            <li>
            ...
            <li>
              <strong>Use mock questions:</strong> Build confidence under exam conditions with timed
              practice tests
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Real-world Examples">
          ...
          <p>
            Candidate memorised Zs tables from BS 7671, passed regulation-based questions easily and
            built confidence for other areas.
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              measures Zs of 1.50 Ω on a circuit protected by a 32A Type B MCB. What is the correct
              course of action?" You panic — you know the number but you're not sure how to apply
              it.
            </>
          }
          doInstead={
            <>
              Learn each value with its meaning. 1.37 Ω is the MAXIMUM permitted — readings above it
              mean the disconnection time can't be guaranteed and the circuit doesn't comply with BS
              7671. The action: investigate the cause (high resistance joint, undersized CPC),
              rectify, re-test. Same value, but now you know what to DO with it. That's the level of
              understanding that wins applied-scenario marks.
            </>
          }
        />
        ...
        <ConceptBlock title="Summary">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Regulations:</strong> Zs, RCDs, bathroom zones, cable sizes, earthing/bonding,
              test sequences
            </li>
            <li>
