...
const AM2Module6Section2 = () => {
  ...
  return (
    ...
    >
      ...
      <AM2ContentCard>
        ...
        <div className="space-y-4 text-sm sm:text-base leading-relaxed">
          ...
          <ul className="space-y-2 ml-4 text-white">
            ...
            <li>
              - <strong className="text-white">RCD requirements:</strong> Where they must be fitted,
              trip times (30mA/0.3s), and applications
            </li>
            <li>
              - <strong className="text-white">Bathroom zones and IP ratings:</strong> Zone 0, 1, 2
              boundaries and required IP protection levels
            </li>
            <li>
            ...
            <li>
              - <strong className="text-white">Inspection & testing sequence:</strong> GN3 order and
          ...
          <ul className="space-y-2 ml-4 text-white">
            ...
            <li>
              - <strong className="text-white">"What IP rating is required in..."</strong> - Special
          ...
          <ul className="space-y-2 ml-4 text-white">
            ...
            <li>
              - <strong className="text-white">Bathroom zones:</strong> Zone 0 (inside bath), Zone 1
              (above bath to 2.25m), Zone 2 (0.6m from Zone 1)
            </li>
            <li>
      ...
      <AM2ContentCard>
        ...
        <div className="space-y-4 text-sm sm:text-base leading-relaxed">
          ...
          <ul className="space-y-2 ml-4 text-white">
            ...
            <li>
              - <strong className="text-white">Power calculations:</strong> P = VI (apparent power),
              P = I squared R (power loss in resistance)
            </li>
            <li>
      ...
      <AM2ContentCard>
        ...
        <div className="space-y-4 text-sm sm:text-base leading-relaxed">
          ...
          <ul className="space-y-2 ml-4 text-white">
            ...
            <li>
              -{' '}
              <strong className="text-white">Risk assessments and method statements (RAMS):</strong>{' '}
            ...
            <li>
              - <strong className="text-white">Manual handling:</strong> Safe lifting and moving of
          ...
          <ul className="space-y-2 ml-4 text-white">
            ...
            <li>
              - <strong className="text-white">Regulation 12:</strong> Adequate precautions must be
              taken to prevent electrical equipment becoming electrically charged
            </li>
            <li>
              - <strong className="text-white">Regulation 13:</strong> Adequate precautions must be
              taken to prevent danger from work on or near live conductors
            </li>
            <li>
          ...
          <ul className="space-y-2 ml-4 text-white">
            ...
            <li>
              - <strong className="text-white">Insulated tools:</strong> Tools rated for electrical
              work (1000V rating)
            </li>
            <li>
      ...
      {/* Navigation Footer */}
      <AM2NavigationFooter
        prevHref="/study-centre/apprentice/am2/module6/section1"
        prevLabel="Test Format"
        nextHref="/study-centre/apprentice/am2/module6/section3"
