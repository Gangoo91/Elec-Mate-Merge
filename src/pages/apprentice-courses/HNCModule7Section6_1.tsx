...
const HNCModule7Section6_1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 6 · Subsection 1"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Board Types and Designations">
          <p>
            ...
            requirements for low-voltage switchgear and controlgear assemblies. Understanding board
            designations is essential for specifying appropriate equipment for each installation
            environment.
          </p>
          <p>
            <strong>Key board type classifications:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DBO (Type B):</strong> Distribution boards for operation by ordinary persons -
            ...
            <li>
              <strong>Consumer unit:</strong> Specific type of DBO for domestic installations with
              integral main switch
            </li>
            <li>
              <strong>Sub-distribution board:</strong> Fed from main board, distributing to local
              final circuits
            </li>
          </ul>
          <p>
            <strong>Board Type Selection Guide</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Domestic:</strong> Consumer unit (Type B) — Non-combustible enclosure,
              integral main switch
            </li>
            <li>
              <strong>Commercial office:</strong> DBO-B — Tool-only access to live parts, IP2X
              minimum
            </li>
            <li>
              <strong>Industrial:</strong> DBO-A or DBO-B — Form of separation, higher IP rating
            </li>
            <li>
              <strong>Plant room:</strong> DBO-A (restricted access) — Higher forms of separation,
              dust/moisture protection
            </li>
            <li>
              <strong>External:</strong> DBO-B with IP65+ — Weather protection, UV-resistant
              materials
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="IP Ratings and Environmental Protection">
          ...
          <p>
            <strong>First Digit - Solid Objects</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Second Digit - Moisture</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>0:</strong> No protection
          ...
          <p>
            <strong>IP Rating Selection by Location</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Indoor dry (office, home):</strong> IP2X — IP20 or IP30
            </li>
            <li>
              <strong>Kitchen/utility:</strong> IP2X — IP40 or IP41
            </li>
            <li>
              <strong>Bathroom (outside zones):</strong> IP44 — IP44
            </li>
            <li>
              <strong>External sheltered:</strong> IP44 — IP55
            </li>
            <li>
              <strong>External exposed:</strong> IP55 — IP65 or IP66
            </li>
            <li>
              <strong>Industrial dusty:</strong> IP5X — IP54 or IP55
            </li>
            <li>
              <strong>Wash-down areas:</strong> IP65 — IP66 or IP67
            </li>
          </ul>
          <p>
            <strong>Important:</strong> IP ratings apply with the enclosure closed. Cable entries
            must be properly sealed with appropriate glands to maintain the rated protection level.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Circuit Groupings and Layout Design">
          <p>
            Effective circuit grouping within distribution boards is governed by BS 7671 Regulation
            314.1, which requires installations to be divided into circuits to avoid danger and
            minimise inconvenience in the event of a fault, while facilitating safe operation,
            inspection, and maintenance.
          </p>
          <p>
            <strong>BS 7671 Circuit Division Requirements (Reg 314.1)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Recommended Circuit Groupings</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lighting circuits:</strong> Separate from socket circuits; consider emergency
              lighting on dedicated supply
            </li>
            <li>
            ...
            <li>
              <strong>Safety circuits:</strong> Fire alarm, emergency lighting, security on separate
              RCDs or non-RCD protected
            </li>
            <li>
          ...
          <p>
            <strong>RCD Allocation Strategy</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Socket outlets up to 32A:</strong> 30mA RCD required — Distribute across
              multiple RCDs
            </li>
            <li>
              <strong>Lighting circuits:</strong> 30mA RCD (most cases) — Separate RCD from sockets
              where possible
            </li>
            <li>
              <strong>Outdoor circuits:</strong> 30mA RCD required — Dedicated RCD recommended
            </li>
            <li>
              <strong>Freezers/fridges:</strong> RCD protected — Separate RCD to avoid food spoilage
            </li>
            <li>
              <strong>Fire alarm:</strong> May be non-RCD — Risk assessment required per Reg 411.3.3
            </li>
          </ul>
          <p>
            <strong>Design tip:</strong> Use dual RCD consumer units or split-load boards to
            distribute circuits across two RCDs, ensuring loss of one RCD does not cause total loss
            of lighting or power.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Labelling, Documentation, and Installation">
          ...
          <p>
            <strong>Required Circuit Chart Information (Reg 514.9.1)</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Additional Best Practice</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Warning Labels Required by BS 7671</strong>
          </p>
          <p>
            <strong>RCD Test Notice (Reg 514.12.2):</strong> "This installation, or part of it, is
            protected by a device which automatically switches off the supply if an earth fault
            develops. Test quarterly by pressing the button marked 'T' or 'Test'. The device should
            switch off the supply and should then be switched on to restore the supply. If the
            device does not switch off the supply when the button is pressed, seek expert advice."
          </p>
          <p>
            <strong>Dual Supply Warning:</strong> Required where more than one source of supply
            exists
          </p>
          <p>
            <strong>Voltage Warning:</strong> Where nominal voltage exceeds 230V between conductors
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Accessibility:</strong> Reg 132.12 — Adequate space for operation and
              maintenance
            </li>
            <li>
              <strong>Mounting height:</strong> Best practice — Main switch 1.2-1.8m above floor
              level
            </li>
            <li>
              <strong>Cable entry:</strong> IP maintenance — Suitable glands, maintain bending radii
            </li>
            <li>
              <strong>Ventilation:</strong> Heat dissipation — Adequate clearance around enclosure
            </li>
            <li>
              <strong>Spare capacity:</strong> Future expansion — Minimum 20% spare ways recommended
            </li>
            <li>
              <strong>Earthing:</strong> Reg 542 — Adequate earth bar capacity, MET connection
            </li>
          </ul>
          <p>
            <strong>Compliance note:</strong> Circuit charts must be accurate and updated following
            any modification. Inaccurate documentation creates safety risks during maintenance and
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Select appropriate IP rating for a distribution board in an
            exposed car park location.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Design circuit allocation for a small commercial three-phase
            distribution board.
          </p>
          <p>Load Schedule:</p>
