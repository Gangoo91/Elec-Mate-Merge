...
const Module2Section2_1: React.FC = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: [
        'The supply voltage has risen above 230 V',
        'Loose connection or high current causing I²R heating',
        'The cable is too long for the circuit',
        'The fuse rating is higher than needed',
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      options: [
        'Only one of V, I or R known',
        'All three of V, I and R known',
        'Any two of V, I and R',
        'Only the supply voltage known',
      ],
      correctAnswer: 2,
  ...
  return (
    <div className="bg-[#1a1a1a] overflow-x-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        {/* Section: Understanding V, I, and R */}
        <section className="mb-10">
          <h2 className="text-lg sm:text-xl font-semibold text-white mb-4 flex items-center gap-2">
