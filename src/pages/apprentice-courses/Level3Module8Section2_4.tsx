...
const Level3Module8Section2_4 = () => {
  ...
  const quizQuestions = [
    {
      question:
        'According to BS 7671, what is the FIRST test that should be performed in the prescribed sequence?',
      options: [
      ...
      correctAnswer: 2,
      explanation:
        'Continuity of protective conductors (including main and supplementary bonding) is the first test in the prescribed sequence per Regulation 643.2.1. This must be done before the installation is energised.',
    },
    {
      question:
        'What is the minimum acceptable insulation resistance value for a new 230V circuit tested at 500V DC?',
      options: ['0.5 MΩ', '1.0 MΩ', '2.0 MΩ', '5.0 MΩ'],
      correctAnswer: 1,
      explanation:
        'The minimum acceptable insulation resistance for circuits up to 500V is 1.0 MΩ when tested at 500V DC according to BS 7671 Table 64.3.',
    },
    {
      question:
        'What minimum test current must a low-resistance ohmmeter provide for continuity testing?',
      options: ['50 mA', '100 mA', '200 mA', '500 mA'],
      correctAnswer: 2,
      explanation:
        'A low-resistance ohmmeter must produce a test current of at least 200 mA at between 4V and 24V DC as specified in BS EN 61557-4.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'SPDs (Surge Protective Devices) may be damaged by the 500V DC test voltage used for insulation resistance testing. They must be disconnected to prevent damage and to obtain accurate readings.',
    },
    {
      question: 'When testing RCD operation, what phase angles should be used?',
      options: ['0° only', '180° only', '90° and 270°', '0° and 180°'],
      correctAnswer: 3,
      explanation:
        'RCDs should be tested at both 0° and 180° phase angles to find the worst-case tripping time. The highest recorded value should be used for compliance purposes.',
    },
    {
      question:
        'What correction factor should be applied to tabulated Zs values when comparing with measured values at ambient temperature?',
      options: ['Multiply by 1.2', 'Multiply by 0.8', 'Divide by 0.8', 'No correction needed'],
      correctAnswer: 1,
      explanation:
        'A multiplying factor of 0.8 should be applied to tabulated maximum Zs values (or measured values divided by 0.8) to allow for conductor temperature rise during normal operation.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'The three-step method (end-to-end testing) is used for testing ring final circuit continuity. It involves measuring r1+rn, r2, and r1+r2 with cross-connections, then verifying at each socket outlet.',
    },
    {
      question:
        'Which test must be completed BEFORE the installation is energised for the first time?',
      options: [
        'RCD operation test',
        'Earth fault loop impedance',
      ...
      correctAnswer: 3,
      explanation:
        'For TT systems, earth electrode resistance must be measured before the installation is energised (Regulation 643.7.2) to verify that protective devices can operate within required disconnection times.',
    },
    {
      question:
        'What should be done if a measured Zs value is close to the maximum permitted value?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'When measured Zs is close to maximum permitted values, temperature correction must be applied. Conductors will have higher resistance when hot during normal operation, so the measured cold value must be adjusted.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'The null function compensates for test lead resistance by subtracting it from subsequent measurements. This ensures accurate readings of the actual conductor resistance being tested.',
    },
    {
      question:
        'At what test current should a 30 mA RCD be tested to verify it trips within the maximum permitted time?',
      options: ['15 mA (½×IΔn)', '30 mA (1×IΔn)', '150 mA (5×IΔn)', '300 mA (10×IΔn)'],
      correctAnswer: 2,
      explanation:
        'At the rated residual operating current (1×IΔn = 30 mA), a general Type AC RCD must trip within 300 ms. At 5×IΔn (150 mA), it must trip within 40 ms.',
    },
    {
      question:
        'Why is it important to record BOTH line-neutral and line-earth prospective fault currents?',
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'Both values must be recorded because protective devices must have adequate breaking capacity for all foreseeable fault conditions. The highest prospective fault current must not exceed the rated breaking capacity of the installed devices.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        'The prescribed sequence ensures safety and accuracy. Dead tests are performed first (continuity, insulation resistance) while the installation is safely isolated, then live tests (Zs, Ipf, RCD) once preliminary safety is confirmed. This protects both the tester and the installation.',
    },
    {
      question: 'Can I skip tests if they were done on a previous inspection?',
      answer:
        'No. For initial verification, all relevant tests must be completed. For periodic inspection, the scope may be agreed with the client, but you cannot simply rely on previous results. Conditions may have changed since the last inspection.',
    },
    {
      question: 'What should I do if I get unexpected test results?',
      answer:
        'Never ignore unexpected results. Investigate the cause - check connections, verify the test method, ensure leads are correctly connected, and retest. If results remain unusual, there may be a fault that needs rectification before proceeding.',
    },
    {
      question: 'How often should test instruments be calibrated?',
      answer:
        'Test instruments should be calibrated at regular intervals as recommended by the manufacturer, typically annually. Additionally, they should be checked against known values periodically and recalibrated if damaged or suspect.',
    },
    {
      question: 'Is it acceptable to use a multifunction tester for all tests?',
      answer:
        'Multifunction testers can perform most required tests and are commonly used. However, ensure the instrument meets the relevant standards (BS EN 61557 series) for each test function and that you understand the correct operation for each test type.',
    },
    {
      question: 'What documentation is required for test results?',
      answer:
        'All test results must be recorded on the appropriate schedule (Schedule of Test Results) and included with the Electrical Installation Certificate (EIC) or Minor Electrical Installation Works Certificate (MEIWC). Results should include the circuit details, measured values, and comparison with permitted limits.',
    },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <section className="mb-12">
          <div className="flex items-center gap-3 mb-6">
            <span className="flex items-center justify-center w-8 h-8 rounded-full bg-elec-yellow text-[#1a1a1a] font-bold text-sm">
              1
            </span>
          ...
          <div className="prose prose-invert max-w-none mb-6">
            <p className="text-white">
              ...
              tests. Following this sequence is essential for both safety and accuracy.
            </p>
          </div>
                ...
                {testSequence.map((test, index) => (
                  <tr key={index} className={index % 2 === 0 ? 'bg-white/5' : ''}>
                    ...
                    <td className="border border-white/20 px-3 py-2 text-sm">
                      <span
                        className={`px-2 py-0.5 rounded text-xs font-medium ${test.deadOrLive === 'Dead' ? 'bg-green-500/20 text-green-400' : test.deadOrLive === 'Live' ? 'bg-red-500/20 text-red-400' : 'bg-yellow-500/20 text-yellow-400'}`}
                      >
                        {test.deadOrLive}
                      </span>
                    </td>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-4 mb-6">
            ...
            <p className="text-white text-sm">
              ...
              <strong>P</strong>rove function (live tests). The dead tests come first for safety!
            </p>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-invert max-w-none mb-6">
            <p className="text-white">
              ...
              instruments can lead to invalid results and potential safety issues.
            </p>
          </div>
            ...
            {testInstruments.map((item, index) => (
              <div key={index} className="bg-white/5 border border-white/10 rounded-xl p-4">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <span className="px-2 py-0.5 bg-elec-yellow/20 text-elec-yellow text-xs rounded font-medium">
                    {item.standard}
                  </span>
                </div>
          ...
          <div className="grid gap-4 mb-6">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <h4 className="text-elec-yellow font-medium mb-3">
                Insulation Resistance (Table 64.3)
              </h4>
