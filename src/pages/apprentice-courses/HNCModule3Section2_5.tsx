...
const quizQuestions = [
  {
    ...
    options: ['75 kVAr', '113 kVAr', '100 kVAr', '88 kVAr'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['0.90 lagging', '0.85 lagging', 'Unity (1.0)', '0.95 lagging or better'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['20 kVAr', '25 kVAr', '10 kVAr', '15 kVAr'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['THD below 5%', 'Any THD requires detuning', 'THD above 50%', 'THD above 10-15%'],
    correctAnswer: 3,
    explanation:
...
const HNCModule3Section2_5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 2 · Subsection 5"
        title="Power Factor Correction Methods"
        backTo="/study-centre/apprentice/h-n-c-module3-section2"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Plain capacitor banks on a system with significant harmonic content can resonate with
              the supply impedance, dramatically over-stressing the cans and blowing fuses. Detuning
              shifts the resonant frequency below the harmonic spectrum, protecting the bank and
              acting as a partial harmonic filter — standard on any modern building services PFC
              retrofit.
            </>
          }
        ...
        <ConceptBlock title="Capacitor Bank Sizing and Calculation">
          <p>
            ...
            lagging reactive power drawn by inductive loads. The key to effective PFC is calculating
            the correct capacitor size to achieve the target power factor without over-correction.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              phi<sub>1</sub> = original phase angle (cos inverse of original pf)
            </li>
            <li>
              phi<sub>2</sub> = target phase angle (cos inverse of target pf)
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">Power Factor Conversion Table</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>0.70 pf:</strong> Phase angle 45.6 degrees, tan phi 1.020, kVAr/kW 1.020
            </li>
            <li>
              <strong>0.75 pf:</strong> Phase angle 41.4 degrees, tan phi 0.882, kVAr/kW 0.882
            </li>
            <li>
              <strong>0.80 pf:</strong> Phase angle 36.9 degrees, tan phi 0.750, kVAr/kW 0.750
            </li>
            <li>
              <strong>0.85 pf:</strong> Phase angle 31.8 degrees, tan phi 0.620, kVAr/kW 0.620
            </li>
            <li>
              <strong>0.90 pf:</strong> Phase angle 25.8 degrees, tan phi 0.484, kVAr/kW 0.484
            </li>
            <li>
              <strong>0.95 pf (target):</strong> Phase angle 18.2 degrees, tan phi 0.329, kVAr/kW
              0.329
            </li>
            <li>
              <strong>1.00 pf:</strong> Phase angle 0 degrees, tan phi 0.000, kVAr/kW 0.000
            </li>
          </ul>
        ...
        <ConceptBlock title="Fixed vs Automatic Switching Capacitor Banks">
          <p>
            ...
            Fixed capacitors suit constant loads, while variable loads demand automatic switching to
            prevent over-correction during light load periods.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Target pf (cos phi):</strong> Desired power factor setpoint — typically 0.95 -
              0.98 lag
            </li>
            <li>
            ...
            <li>
              <strong>Discharge time:</strong> Capacitor discharge before reconnection — 60-90
              seconds
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Binary steps:</strong> 1:2:4:8 ratio for fine control (e.g., 12.5, 25, 50, 100
              = 187.5 kVAr in 15 combinations)
            </li>
            <li>
              <strong>Mixed steps:</strong> Smaller first stage for fine tuning (e.g., 10, 25, 25,
              50, 50 kVAr)
            </li>
          </ul>
          <p className="text-sm text-elec-yellow/70">
            <strong>Capacitor switching:</strong> Contactors must be rated for capacitor duty (high
            inrush current). Use special capacitor-switching contactors or current-limiting
            reactors.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Connection Methods and Correction Strategies">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Individual:</strong> At each load (motor terminals). Maximum cable loss
              reduction, precise correction. Highest cost, maintenance at multiple locations.
            </li>
            <li>
              <strong>Group:</strong> Distribution board level. Good balance of cost and efficiency.
              Reactive current in final circuits.
            </li>
            <li>
              <strong>Central:</strong> Main switchboard / intake. Lowest capital cost, easy
              maintenance. Reactive current flows throughout building.
            </li>
            <li>
              <strong>Hybrid:</strong> Combination of above. Optimised for specific installation.
              More complex design.
            </li>
          </ul>
        ...
        <ConceptBlock title="Active PFC and Harmonic Considerations">
          <p>
            Modern building services increasingly use Variable Frequency Drives (VFDs), LED drivers,
            and other non-linear loads that generate harmonics. Standard capacitors can resonate
            with system inductance at harmonic frequencies, requiring detuned solutions or active
            filtering.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">Harmonic Resonance Warning</p>
          <p>
            Capacitors reduce system impedance at resonant frequency fr = 1/(2 x pi x root(LC)). If
            fr coincides with a harmonic frequency (250Hz, 350Hz, etc.), harmonics are amplified
            dramatically. This causes capacitor overheating, failure, and potentially fire. Always
            assess harmonic content before specifying standard capacitors.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>5.67% (p = 0.0567):</strong> Resonant frequency 210 Hz (4.2 x 50Hz). Light
              harmonic pollution.
            </li>
            <li>
              <strong>7% (p = 0.07):</strong> Resonant frequency 189 Hz (3.78 x 50Hz). Standard for
              VFD applications.
            </li>
            <li>
              <strong>14% (p = 0.14):</strong> Resonant frequency 134 Hz (2.68 x 50Hz). Heavy
              harmonic pollution (DC drives).
            </li>
          </ul>
          ...
          <p>
            ...
            reactive and harmonic currents. They offer advantages in challenging environments but at
            higher cost.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DOL induction motors:</strong> Typical pf 0.75-0.85, low harmonics — Standard
              capacitors
            </li>
            <li>
              <strong>VFD-controlled motors:</strong> 0.95+ (VFD input), high harmonics (5th, 7th) —
              7% detuned or active filter
            </li>
            <li>
              <strong>Fluorescent (magnetic):</strong> 0.5-0.6, moderate harmonics (3rd) —
              Individual capacitors (5-8 microF)
            </li>
            <li>
              <strong>LED drivers (with PFC):</strong> 0.90-0.98, low-moderate harmonics — Usually
              not required
            </li>
            <li>
              <strong>UPS systems:</strong> 0.80-0.95, high harmonics — Active filter or input
              filter
            </li>
            <li>
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            PFC. If THD exceeds 10-15%, use detuned reactors. If THD exceeds 20% or critical systems
            involved, consider active filters.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A commercial building has measured demand of 350kW at 0.78
            power factor. Calculate the capacitor bank required to achieve 0.95 pf.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Qc = 30 x (0.698 - 0.329) = 30 x 0.369 = <strong>11.1 kVAr</strong>
            </li>
          ...
          <p>
            <strong>Question:</strong> Design an automatic PFC system for a site with demand varying
            between 100kW and 400kW. Existing pf is 0.75, target is 0.95.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Option B - Mixed steps (recommended): 1 x 12.5 kVAr + 2 x 25 kVAr + 4 x 37.5 kVAr =
              212.5 kVAr
            </li>
          ...
          <p>
            <strong>Question:</strong> A 50 microF capacitor is available. Calculate its kVAr rating
            when connected in star and delta on a 400V three-phase system.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Total Q (3 capacitors) = 3 x 830 = <strong>2.49 kVAr</strong>
            </li>
            <li>
              <strong>Delta connection:</strong>
            </li>
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Qc = P(tan phi1 - tan phi2)</strong> - Required capacitor kVAr
            </li>
            <li>
              <strong>Q = V squared / Xc = 2 x pi x f x C x V squared</strong> - Capacitor reactive
              power
            </li>
            <li>
              <strong>fr = fn / root(p)</strong> - Detuned resonant frequency
            </li>
            <li>
              <strong>Delta kVAr is approximately 3 x Star kVAr</strong> - Connection comparison
            </li>
            <li>
              <strong>Max motor cap = 0.35 x motor kVA</strong> - Individual correction limit
            </li>
          </ul>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Oversizing individual motor capacitors causing self-excitation and overvoltage. Using
              standard capacitors with VFDs creating harmonic resonance risk. Fixing capacitors on
              variable loads results in leading pf at light load. Ignoring discharge time and
              reconnecting before 50V causes voltage transients. Wrong CT connection means
              controller measures wrong current direction.
            </>
          }
          doInstead={
            <>
              Limit individual motor capacitors to 30-40% of motor kVA. Always use 7% (or 14%)
              detuned reactors with VFDs or significant THD. Use automatic switching for variable
              loads. Wait for full discharge (60-90 s) before reconnection. Verify CT location
              upstream of capacitor and correct polarity at commissioning.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You are picking the PFC strategy for a 1.6 MVA office-and-warehouse with a 25 %
              VFD-driven motor load (chillers, AHUs), 60 % active-PFC LED lighting and small-power
              load, and 15 % miscellaneous heating / IT. Average PF measured at the supply is 0.78
              lagging, target is 0.97. Site electrical engineer wants detuned bank because of the
              VFD harmonic content.
            </>
          }
          whatToDo={
            <>
              Calculate Q_C from the load profile across the day, picking step size to match the
              smallest motor block (typically 25–50 kVAr per step). Specify a stepped
              (contactor-switched) bank with 6–8 steps to track load smoothly. Add 7 % series
              detuning reactors to BS EN 61921, capacitors to BS EN 60831-1, assembled enclosure to
              BS EN 61439-1. Locate at the main LV switchboard rather than at each motor (load is
              too dynamic for fixed local PFC). Specify thyristor switching (instead of contactors)
              only if load varies faster than once per minute. Document the bank in the single-line
              diagram and on the Part L energy submission.
            </>
          }
          whyItMatters={
            <>
              The choice between static / stepped / active PFC, central vs local, and plain vs
              detuned, drives both capital cost and operating performance for the next 25 years. Get
              it wrong and you either over-spend on hardware or under-correct and continue paying
              penalties — your design decisions need to defend against both.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Section 2.6</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
