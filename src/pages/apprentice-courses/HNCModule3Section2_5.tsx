        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Standard capacitor sizes: 5, 10, 12.5, 15, 20, 25, 30, 50, 75, 100 kVAr
                </li>
                ...
                <li className="pl-1">
                  Consider demand variation when sizing - measure over representative period
                </li>
              </ul>
            </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Step size relative to CT ratio
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Capacitor discharge before reconnection
                      </td>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        At each load (motor terminals)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Maximum cable loss reduction, precise correction
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Highest cost, maintenance at multiple locations
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Main switchboard / intake
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Lowest capital cost, easy maintenance
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Reactive current flows throughout building
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Optimised for specific installation
                      </td>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Capacitor switched with motor contactor (parallel connection)
                </li>
                ...
                <li className="pl-1">
                  For soft-start or VFD motors, use separate capacitor switching
                </li>
              </ul>
            </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Heavy harmonic pollution (DC drives)
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Q = V squared / Xc = 2 x pi x f x C x V squared</strong> - Capacitor
                  reactive power
                </li>
                <li className="pl-1">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Check for VFDs, UPS, large LED installations - harmonic sources
                </li>
                <li className="pl-1">
                  Verify supply transformer short-circuit level for resonance calculation
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  HRC fuses sized for inrush (typically 1.5x capacitor current)
                </li>
                <li className="pl-1">
                  Ventilation - capacitors generate heat, especially detuned types
                </li>
                <li className="pl-1">
                  CT location - current measurement upstream of capacitor connection
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Oversizing individual motor capacitors</strong> - causes self-excitation
                  and overvoltage
                </li>
                <li className="pl-1">
                  <strong>Standard capacitors with VFDs</strong> - harmonic resonance risk
                </li>
                <li className="pl-1">
                  <strong>Fixed capacitors on variable loads</strong> - leading pf at light load
                </li>
                <li className="pl-1">
                  <strong>Ignoring discharge time</strong> - reconnecting before 50V causes voltage
                  transients
                </li>
                <li className="pl-1">
                  <strong>Wrong CT connection</strong> - controller measures wrong current direction
                </li>
              </ul>
            </div>
          </div>
