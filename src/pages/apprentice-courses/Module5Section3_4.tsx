...
const TITLE =
  'Minimising Disruption to Other Site Activities - Module 5.3.4 | Level 2 Electrical Course';
const DESCRIPTION =
  'Learn to coordinate electrical work with other trades, prevent clashes, and maintain smooth site operations through effective planning and communication.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Minimising disruption keeps projects on schedule, prevents rework, reduces safety risks, and builds positive working relationships.',
  },
  {
    id: 2,
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Minimising disruption keeps projects on schedule, prevents rework, reduces safety risks, and maintains good professional relationships.',
    },
    {
      id: 2,
    ...
    },
    {
      id: 4,
      question:
        'True or False: Electrical accessories should be installed after plastering is complete.',
      options: ['True', 'False'],
      correctAnswer: 0,
      explanation:
        'True. Electrical accessories are typically installed during second fix after plastering and other wet trades are complete.',
    },
    {
      id: 5,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Damage should be reported immediately to the supervisor so proper procedures can be followed for repairs.',
    },
    {
      id: 10,
  ...
  const faqs = [
    {
      ...
      answer:
        'Report it immediately to your supervisor. Rework may be chargeable to that trade if poor coordination caused it. Document the damage with photos and ensure proper procedures are followed.',
    },
    {
      question: 'Who is responsible for site coordination?',
      answer:
        'The site manager oversees coordination, but each trade must take responsibility for communicating their requirements and attending coordination meetings.',
    },
    {
      question: 'Can electrical work be delayed to suit other trades?',
      answer:
        "Yes — sequencing often requires flexibility to keep overall progress smooth. Sometimes it's better to delay than to create conflicts or safety issues.",
    },
  ];
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                as plasterers, carpenters, plumbers, or decorators. Poor coordination can cause
                delays, damage to work, and safety hazards. Minimising disruption ensures smoother
                progress for all trades and helps maintain good professional relationships.
              </p>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p>
                <strong className="text-white">Real Impact:</strong> Well-coordinated projects show
                40% fewer defects, 25% faster completion times, and significantly improved
                relationships between trades.
              </p>
              <p className="text-sm p-3 rounded bg-white/5 border border-white/10">
                <strong className="text-white">Industry Standard:</strong> CDM 2015 regulations
                require effective coordination between trades to ensure health, safety, and quality
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                  <p className="font-medium text-green-400 mb-3">
                    A. Electrical vs Plastering Conflicts
                  </p>
                ...
                <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                  <p className="font-medium text-elec-yellow mb-3">
                    B. Electrical vs Mechanical Services
                  </p>
                  <div className="grid md:grid-cols-2 gap-4 text-sm">
                    <div>
                ...
                <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                  <p className="font-medium text-purple-400 mb-3">
                    C. Electrical vs Carpentry and Decoration
                  </p>
                  <div className="grid md:grid-cols-2 gap-4 text-sm">
                    <div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm text-white/80">
                  ...
                  <li>
                    <strong className="text-white">Cost Increases:</strong> Rework, materials waste,
                    extended site costs
                  </li>
                  <li>
                    <strong className="text-white">Quality Issues:</strong> Damage to installed work
                    requiring repair
                  </li>
                  <li>
                    <strong className="text-white">Safety Risks:</strong> Unsafe working conditions
              ...
              <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/20">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm text-white/80">
                  ...
                  <li>
                    <strong className="text-white">Reputation Impact:</strong> Reduced future work
                    opportunities
                  </li>
                  <li>
                    <strong className="text-white">Team Morale:</strong> Stress and job satisfaction
                    issues
                  </li>
                  <li>
                    <strong className="text-white">Client Relations:</strong> Reduced confidence and
                    satisfaction
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
              <p className="text-amber-300 mb-3">
                On a housing site, electricians installed socket boxes before plastering without
                protective covers. Plasterers filled in the boxes, requiring electricians to dig
                them out later. This wasted hours of work and created friction between trades.
                Proper coordination and use of protective covers would have prevented the issue.
              </p>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 leading-relaxed">
              <p>
                ...
                effectively. You saw the risks of poor coordination and explored practical methods
                like protective covers, clear markings, and flexible scheduling to avoid problems.
              </p>
            </div>
          </section>
