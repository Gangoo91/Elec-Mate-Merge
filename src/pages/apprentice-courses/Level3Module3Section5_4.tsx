...
const DESCRIPTION =
  'Master power factor correction techniques for electrical installations. Learn about the power triangle, capacitor sizing, and economic benefits of power factor improvement.';
...
const quickCheckQuestions = [
  {
    ...
    options: ['0', '0.5', '0.85', '1 (unity)'],
    correctIndex: 3,
    explanation:
      'In a purely resistive circuit, current and voltage are in phase (no phase shift). The power factor is cos 0 degrees = 1, known as unity power factor. No reactive power is present.',
  },
  {
    id: 'check-2',
    question: 'A 230V 4kW motor has a power factor of 0.4. What current does it draw?',
    options: ['17.4 A', '43.5 A', '92 A', '4 A'],
    correctIndex: 1,
    explanation:
      'Current = Power / (Voltage x Power Factor) = 4000 / (230 x 0.4) = 43.5 A. The poor power factor causes the motor to draw 2.5 times more current than it would at unity power factor (17.4 A).',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 1,
    explanation:
      'Capacitors draw leading current (current leads voltage by 90 degrees). This leading reactive power (kVAr) cancels out the lagging reactive power from inductive loads, reducing total reactive power and improving power factor.',
  },
  {
    id: 'check-4',
    ...
    correctIndex: 1,
    explanation:
      'If load varies (as it usually does), capacitors sized for unity at full load will over-correct at partial load, causing a leading power factor. Leading power factor is also chargeable by distribution network operators. A target of 0.95 provides margin for load variation.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Apparent power (kVA) is the vector sum of true power (kW) and reactive power (kVAr). It represents the total power the supply must provide, even though only the true power component does useful work.',
  },
  {
    id: 2,
    question: 'The formula for power factor is:',
    options: ['PF = kVA / kW', 'PF = kW / kVA', 'PF = kVAr / kW', 'PF = kW x kVA'],
    correctAnswer: 1,
    explanation:
      'Power factor = True Power / Apparent Power = kW / kVA. This can also be expressed as cos theta, where theta is the phase angle between current and voltage.',
  },
  {
    id: 3,
    question: 'A circuit has 4 kW true power and 10 kVA apparent power. What is the power factor?',
    options: ['0.25', '0.4', '2.5', '40'],
    correctAnswer: 1,
    explanation:
      'Power factor = kW / kVA = 4 / 10 = 0.4. This is a poor power factor, meaning significant reactive power is present (drawing more current than necessary for the actual work done).',
  },
  {
    id: 4,
    ...
    correctAnswer: 0,
    explanation:
      'kVAr (kilovolt-amperes reactive) is the unit of reactive power - the power that flows back and forth between source and reactive components (inductors, capacitors) without doing useful work.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Poor power factor means higher current for the same real power, requiring larger cables, transformers, and switchgear. Distribution network operators recover these infrastructure costs by charging on kVA (which includes reactive power) rather than just kW.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'The choke/ballast in a fluorescent luminaire is inductive, causing lagging power factor. The capacitor connected across line and neutral provides power factor correction. The lamp still works without it but draws slightly more current.',
  },
  {
    id: 7,
    question: 'For the equation true power = V x I x cos theta, cos theta represents:',
    options: ['The current', 'The voltage', 'The power factor', 'The phase angle in radians'],
    correctAnswer: 2,
    explanation:
      'Cos theta (where theta is the phase angle between voltage and current) equals the power factor. This formula shows that true power depends on voltage, current, AND how well they are aligned in phase.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Automatic power factor correction (APFC) units use monitoring technology to switch capacitor banks in and out as load varies. This maintains optimal power factor without over-correction at light load. Banks are typically in multiples of 50 kVAr.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Over-correction creates a leading power factor (current leads voltage). Leading power factor can cause voltage rise and is also subject to charges from distribution network operators. Target 0.95 lagging to avoid this.',
  },
  {
    id: 10,
    question: 'The phase angle of a circuit with power factor 0.85 is approximately:',
    options: ['15 degrees', '32 degrees', '45 degrees', '85 degrees'],
    correctAnswer: 1,
    explanation:
      'Phase angle = cos^-1 (power factor) = cos^-1 (0.85) = 31.79 degrees, approximately 32 degrees. The current lags (inductive) or leads (capacitive) the voltage by this angle.',
  },
  {
    id: 11,
    ...
    correctAnswer: 2,
    explanation:
      'An electric kettle is a purely resistive load with unity power factor (1.0). Motors have poor power factor especially unloaded. Fluorescent lamps without correction capacitors have lagging power factor due to the inductive ballast.',
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      'Better power factor means less current for the same real power. Less current means reduced voltage drop in cables (I x R losses) and reduced heating losses (I squared R). This improves efficiency and may allow smaller cables.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Uncorrected industrial installations typically have power factors between 0.7 and 0.85 due to motor loads. With correction, target 0.95 or higher. Domestic installations are usually better (0.9+) as they have more resistive loads (heating, lighting) and fewer motors.',
  },
  {
    question: 'How do I calculate the capacitor size needed for power factor correction?',
    answer:
      'Draw a power triangle showing current power factor angle and target angle. The difference in reactive power (kVAr) between these is what the capacitor must supply. Then calculate capacitor current (Ic = kVAr x 1000 / V), capacitive reactance (Xc = V / Ic), and finally capacitance (C = 1 / 2 x pi x f x Xc).',
  },
  {
    question: 'Where should power factor correction capacitors be installed?',
    answer:
      'Options include: at individual loads (best correction but more expensive), at distribution boards (group correction), or at the main intake (bulk correction, cheapest but least effective for reducing losses within the installation). Large installations often use a combination.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Motors need magnetic flux to operate, which requires reactive (magnetising) current even with no mechanical load. At full load, real power (doing work) increases but reactive power stays similar, so the ratio (power factor) improves. Off-load, the motor draws mostly reactive current.',
  },
  {
    question: 'What is the difference between static and automatic power factor correction?',
    answer:
      'Static correction uses fixed capacitors sized for a specific load - simple but can over-correct at light load. Automatic correction uses controllers that switch capacitor banks in/out based on measured power factor, maintaining optimal correction as load varies. Automatic is more expensive but more effective for varying loads.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Power Factor:</strong> Ratio of true power (kW) to apparent power (kVA)
              </li>
              <li>
                <strong>Poor PF:</strong> Inductive loads cause current to lag voltage
              </li>
              <li>
                <strong>Correction:</strong> Capacitors provide leading current to cancel lag
              </li>
              <li>
                <strong>Target:</strong> 0.95 (not unity, to allow for load variation)
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Capacitors in luminaires, capacitor banks at switchboards
              </li>
              <li>
                <strong>Use:</strong> Power triangle to calculate correction requirements
              </li>
              <li>
                <strong>Apply:</strong> Select capacitor kVAr rating to improve PF to 0.95
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              In DC circuits, power is simply voltage multiplied by current (P = V x I). In AC
              circuits with reactive components, the relationship becomes more complex. The power
              triangle helps visualise the three types of power present in AC circuits.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key Relationship:</strong> Power factor = True Power / Apparent Power = kW /
              kVA = cos theta (where theta is the phase angle between voltage and current)
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Most electrical loads in commercial and industrial installations are inductive -
              motors, transformers, fluorescent lighting ballasts, and induction heating. These
              inductive loads cause current to lag behind voltage, resulting in a lagging power
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Power factor correction works by adding capacitive reactive power to cancel out
              inductive reactive power. Since capacitors cause current to lead voltage (opposite to
              inductors), they counteract the lagging effect of inductive loads. The most common
              correction method uses static capacitors.
            </p>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/20 my-6">
              ...
              <p className="text-xs text-white/90">
                ...
                luminaire still works but draws slightly more current. When replacing luminaires,
                ensure correction capacitors are included.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Important:</strong> Correction is typically to 0.95 rather than unity. If the
              load reduces, fixed capacitors may over-correct, creating a leading power factor which
              is also penalised. Automatic systems avoid this by adjusting capacitance to match
              actual load.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              To size a power factor correction capacitor, we need to determine how much reactive
              power (kVAr) must be cancelled. The power triangle provides the method - we calculate
              the reactive power at current and target power factors, and the difference is the
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20 my-6">
              ...
              <div className="text-xs text-white/80 space-y-2 font-mono">
                ...
                <p className="mt-3">
                  <strong>Step 2:</strong> Find target reactive power at PF 0.85
                </p>
                ...
                <p className="mt-3">
                  <strong>Step 3:</strong> Required capacitor kVAr
                </p>
                <p className="ml-4">Qc = 9.17 - 2.48 = 6.69 kVAr (approximately 6.6 kVAr)</p>

                <p className="mt-3">
                  <strong>Step 4:</strong> Calculate capacitor value (if required)
                </p>
                <p className="ml-4">Ic = Qc x 1000 / V = 6600 / 230 = 28.7 A</p>
                <p className="ml-4">Xc = V / Ic = 230 / 28.7 = 8.01 ohms</p>
                <p className="ml-4">
                  C = 1 / (2 x pi x f x Xc) = 1 / (2 x 3.14 x 50 x 8.01) = 398 microfarads
                </p>

                <p className="text-green-400 mt-3">
                  A 398 microfarad (or nearest standard value 400 microfarad) capacitor is required.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Installing Correction Equipment
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Over-correction</strong> - Leading PF is also penalised; target 0.95 not
                  1.0
                </li>
                <li>
                ...
                <li>
                  <strong>Ignoring harmonics</strong> - Can damage capacitors; use detuned types
                </li>
                <li>
                  <strong>Wrong voltage rating</strong> - Capacitors rated for wrong voltage fail
                  quickly
                </li>
              </ul>
            </div>
