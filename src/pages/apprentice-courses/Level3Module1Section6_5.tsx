...
const DESCRIPTION =
  'Understand the role of safety representatives and trade unions in workplace health and safety. Learn about statutory rights, consultation requirements, and worker representation.';
...
const quickCheckQuestions = [
  {
    ...
    options: ['The employer', 'The HSE', 'The recognised trade union', 'The workers by vote'],
    correctIndex: 2,
    explanation:
      'Trade union safety representatives are appointed by the recognised trade union, not elected by workers or appointed by employers. This gives them statutory rights under the Safety Representatives and Safety Committees Regulations 1977.',
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      'Safety representatives have the statutory right to inspect the workplace at agreed intervals - typically quarterly. They can also inspect after notifiable accidents or dangerous occurrences, and investigate potential hazards.',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 2,
    explanation:
      'Representatives of Employee Safety (ROES) are elected by workers in non-unionised workplaces under the Health and Safety (Consultation with Employees) Regulations 1996. They have similar but slightly more limited rights compared to trade union safety reps.',
  },
  {
    id: 'check-4',
    ...
    correctIndex: 1,
    explanation:
      'Employers must allow safety representatives time off with pay during working hours for training. This is a statutory requirement - adequate training is essential for representatives to fulfil their functions effectively.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'The 1977 Regulations apply where independent trade unions are recognised. The union can then appoint safety representatives with statutory functions. Non-unionised workplaces are covered by different regulations from 1996.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Employers must provide safety representatives with information necessary for them to carry out their functions - this includes hazard information, accident statistics, risk assessments, and safety policies. Some information (like medical records) has confidentiality restrictions.',
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'Under the 1977 Regulations, if at least two trade union safety representatives request a safety committee in writing, the employer must establish one within three months. This gives workers a formal structure for consultation.',
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      "Safety representatives can represent employees in discussions with HSE inspectors and receive information from inspectors. They cannot issue formal notices (that's an HSE inspector function) but they play a vital role in worker-inspector communication.",
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Dismissal of a safety representative for carrying out their legitimate safety functions is automatically unfair dismissal. This protection encourages representatives to raise genuine safety concerns without fear of losing their jobs.',
  },
  {
    id: 6,
    question:
      'The Health and Safety (Consultation with Employees) Regulations 1996 require employers to:',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'The 1996 Regulations require employers to consult employees not covered by trade union safety representatives. This can be direct consultation or through elected Representatives of Employee Safety (ROES).',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'Trade union safety reps have broader statutory functions under the 1977 Regulations, including inspection rights. ROES under the 1996 Regulations have rights to information, consultation, and time off for training, but slightly more limited inspection powers.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Consultation topics include: introduction of health and safety measures, appointment of competent persons, health and safety information provision, planning of training, and consequences of new technology. This ensures worker input on safety decisions.',
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      "While regulations don't specify exact frequency, best practice is quarterly meetings as a minimum, with many organisations meeting monthly. Regular meetings ensure ongoing attention to safety matters and timely resolution of concerns.",
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Trade unions support health and safety by: providing training courses for representatives, offering advice and resources to members, representing members in safety disputes, campaigning for improved legislation, and providing legal support when needed.',
  },
  {
    id: 11,
    ...
    correctAnswer: 1,
    explanation:
      "Safety representatives should immediately inform the employer of serious hazards. Following up in writing creates a record. If the employer doesn't respond adequately, the representative can escalate to the HSE, but the first step is working with the employer.",
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      "Consultation benefits employers through: practical insights from workers who know the job, better identification of hazards, improved compliance when workers are involved in decisions, and a more positive safety culture. It's genuinely valuable, not just a legal box-tick.",
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Safety reps:</strong> Appointed by unions with statutory functions
              </li>
              <li>
                <strong>ROES:</strong> Elected in non-union workplaces
              </li>
              <li>
                <strong>Rights:</strong> Inspection, information, consultation, training
              </li>
              <li>
                <strong>Committees:</strong> Must be established if requested
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Who your safety rep is, when committees meet
              </li>
              <li>
                <strong>Use:</strong> Raise concerns through proper channels
              </li>
              <li>
                <strong>Apply:</strong> Support worker consultation, consider becoming a rep
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Trade union safety representatives have been a key part of workplace safety since the
              1977 Regulations. Appointed by recognised trade unions, they represent workers in
              discussions about health and safety and have important statutory functions that
              employers must respect.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Key statutory functions of safety representatives:
              </p>
            ...
            <p>
              These functions give workers a genuine voice in safety matters. Research consistently
              shows that workplaces with active union safety representation have better safety
              records. The presence of a knowledgeable representative who can identify hazards and
              advocate for improvements benefits everyone.
            </p>

            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Safety representatives represent all employees in their
              area, not just union members. Their work benefits everyone on site.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              To carry out their functions effectively, safety representatives have specific rights
              that employers must honour. These aren't optional concessions - they're legal
              requirements that enable proper worker representation on safety matters.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              ...
              <div>
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Information and training rights:
                </p>
                <ul className="text-sm text-white space-y-1">
            ...
            <p>
              Employers must consult safety representatives on matters including: introduction of
              safety measures, appointment of competent persons, health and safety information,
              training planning, and new technology implications. This isn't just informing them -
              it's genuine consultation seeking their input.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Not all workplaces have recognised trade unions. The Health and Safety (Consultation
              with Employees) Regulations 1996 ensure that workers in non-unionised workplaces still
              have consultation rights - either through direct consultation or through elected
              Representatives of Employee Safety (ROES).
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Election:</strong> Elected by the workers they represent (not appointed by
                  union)
                </li>
                <li>
                  <strong>Consultation:</strong> Must be consulted on health and safety matters
                </li>
                <li>
                  <strong>Information:</strong> Entitled to necessary safety information
                </li>
                <li>
                  <strong>Training:</strong> Entitled to paid time off for training
                </li>
                <li>
                  <strong>Protection:</strong> Protected from dismissal/detriment for their role
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-white/90 italic">
              ...
              requirements and changing site procedures. Their input improves the practicality of
              safety measures.
            </p>

            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> ROES have slightly different (often more limited) rights
              than trade union safety reps, but the principle is the same: workers should have a
              voice in safety matters.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Safety committees provide a formal structure for worker-employer consultation on
              health and safety. Where two or more trade union safety representatives request one in
              writing, the employer must establish a safety committee within three months.
            </p>
            ...
            <p>
              Effective safety committees are collaborative forums, not adversarial meetings. They
              review accident data, discuss inspection findings, monitor safety measures, consider
              risks from changes, and plan improvements. The best committees have balanced
              representation and focus on practical problem-solving.
            </p>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Working with Safety Representatives
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                If Considering Becoming a Representative
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Bypassing representatives</strong> - Use proper channels rather than going
                  around them
                </li>
                <li>
                  <strong>Dismissing concerns</strong> - Even if you disagree, concerns deserve
                  proper consideration
                </li>
                <li>
                  <strong>Treating consultation as a tick-box</strong> - Genuine input should
                  influence decisions
                </li>
                <li>
                  <strong>Assuming reps are troublemakers</strong> - Most are trying to make
                  workplaces safer
                </li>
                <li>
                  <strong>Ignoring non-union workers</strong> - All workers have consultation rights
                </li>
              </ul>
            </div>
          </div>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/apprentice/level3-module1-section6-6">
