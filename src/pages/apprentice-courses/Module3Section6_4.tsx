...
import { ArrowLeft, ArrowRight, Wrench, Shield, FileText } from 'lucide-react';
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'Which type of gland is most suitable for a marine environment?',
    options: [
      'IP68-rated brass or stainless steel gland',
      'Unrated plastic compression bush',
      'Standard nylon gland for indoor use',
      'Rubber grommet pushed into the knockout',
    ],
    correctAnswer: 0,
    explanation:
  ...
  {
    id: 3,
    question: 'Which statement about cable glands is correct?',
    options: [
      'They only ever provide environmental sealing, not mechanical grip',
      'They are only fitted to non-armoured flexible cables',
      'They can provide both mechanical retention and environmental sealing',
      'They must never be earthed, even when metallic',
    ],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 4,
    question: 'Which standard requires cables to be protected against damage at entry points?',
    options: [
  ...
  {
    id: 5,
    question: 'Which IP rating is typically the minimum for an enclosure exposed to heavy rain?',
    options: [
      'IP20',
      'IP44',
      'IP54',
  ...
  },
  {
    id: 6,
    question:
      'In which location would an explosion-proof (ATEX-certified) gland be required?',
    options: [
      'A petrol forecourt or other hazardous ATEX zone',
      'A domestic bathroom outside the zones',
      'A commercial office ceiling void',
      'A dry under-stairs storage cupboard',
    ],
    correctAnswer: 0,
    explanation:
      'Hazardous areas (ATEX zones) such as petrochemical sites and petrol forecourts require certified explosion-proof glands.',
  },
  {
    id: 7,
    question: 'Why should unused cable entries in an enclosure be sealed?',
    options: [
      'To increase the number of usable circuit ways',
      'To make the enclosure easier to relocate later',
      'To maintain the IP rating and prevent ingress of dust, water or pests',
      'To reduce the torque needed on the remaining glands',
    ],
    correctAnswer: 2,
    explanation:
      'Open entries compromise the IP rating and can allow moisture, dust, or pests to enter, risking failures.',
  },
  {
    id: 8,
    question: 'What is one risk of over-tightening a cable gland?',
    options: [
      'It improves the seal and extends cable life',
      'It permanently increases the enclosure IP rating',
      'It has no effect provided the cable is the correct size',
      'It can cut into or deform the sheath, leading to premature failure',
    ],
    correctAnswer: 3,
    explanation:
...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'To identify the cable cores by colour',
      'To improve the appearance of the enclosure',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A plain rubber grommet pushed into the knockout',
      'An open knockout left unsealed for ventilation',
      'An IP-rated cable gland sized to the cable outside diameter',
      'A plastic bush with no sealing washer',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To ensure the compression seal works without damaging the sheath',
      'To reduce the cost of the gland',
      'To allow the gland to be fitted without any tools',
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  BS 7671 requires preventing damage during installation, use and maintenance.
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Sharp knockout edges, missing grommets, loose glands, open
                  entries.
                </li>
                <li>
                  <strong>Use:</strong> Sized grommets/bushes, IP-rated glands, sealing plugs for
                  unused entries.
                </li>
                <li>
                  <strong>Check:</strong> Gland torque, bend radius, strain relief, enclosure rating
                  maintained.
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
              <h4 className="font-medium text-white mb-3">
                Understanding Cable Entry Vulnerabilities
              </h4>
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                ...
                <p className="text-xs sm:text-sm text-white mb-3">
                  <strong>Primary Purpose:</strong> Cable entry protection serves multiple critical
                  safety functions beyond basic edge protection. Proper entry systems prevent
                  progressive failure modes that can compromise entire electrical installations and
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Mechanical protection:</strong> Shield cable sheath from sharp
                        knockout edges
                      </li>
                      <li>
                        * <strong>Strain relief:</strong> Transfer mechanical loads to outer sheath,
                        not cores
                      </li>
                      <li>
                        * <strong>Environmental sealing:</strong> Maintain IP rating against
                        dust/moisture
                      </li>
                      <li>
                        * <strong>Arc prevention:</strong> Prevent conductor exposure leading to
                        flashover
                      </li>
                      <li>
                        * <strong>Chemical protection:</strong> Shield from cleaning agents and
                        contaminants
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Extended cable life:</strong> Prevent premature insulation
                        degradation
                      </li>
                      <li>
                        * <strong>Reduced maintenance:</strong> Lower fault rates and inspection
                        requirements
                      </li>
                      <li>
                        * <strong>System integrity:</strong> Maintain design safety margins over
                        installation life
                      </li>
                      <li>
                        * <strong>Compliance continuity:</strong> Ensure ongoing regulatory
                        conformance
                      </li>
                      <li>
                        * <strong>Cost effectiveness:</strong> Avoid expensive emergency repairs and
                        downtime
                      </li>
                    </ul>
                  </div>
                  ...
                  <table className="w-full border-collapse border border-white/10 text-sm">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border border-white/10 p-3">
                          Visible scoring, sheath thinning
                        </td>
                        <td className="border border-white/10 p-3 text-green-400">Low</td>
                        <td className="border border-white/10 p-3">
                          Proper grommet sizing and fitting
                        </td>
                      </tr>
                      <tr className="bg-muted/5">
                        ...
                        <td className="border border-white/10 p-3">
                          Sheath penetration, moisture ingress
                        </td>
                        <td className="border border-white/10 p-3">
                          Discolouration, swelling, corrosion
                        </td>
                      ...
                      <tr>
                        ...
                        <td className="border border-white/10 p-3">
                          Insulation compromise, tracking
                        </td>
                      ...
                      <tr className="bg-muted/5">
                        ...
                        <td className="border border-white/10 p-3">
                          Short circuit, earth fault, fire
                        </td>
                        <td className="border border-white/10 p-3">
                          Tripping, arcing, thermal damage
                        </td>
                        <td className="border border-white/10 p-3 text-red-600">Critical</td>
                        <td className="border border-white/10 p-3">
                          Emergency isolation and replacement
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div className="p-4 bg-transparent border border-cyan-400/30 rounded-lg">
                <h5 className="font-medium text-cyan-400 mb-3">
                  Cost Analysis of Entry Protection
                </h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h6 className="font-medium text-white mb-2">
                      Prevention Costs (per entry point)
                    </h6>
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Basic grommet:</strong> 0.10-0.50 GBP
                      </li>
                      <li>
                        * <strong>Plastic bush:</strong> 0.50-2.00 GBP
                      </li>
                      <li>
                        * <strong>Standard gland:</strong> 2.00-15.00 GBP
                      </li>
                      <li>
                        * <strong>IP67/68 gland:</strong> 5.00-30.00 GBP
                      </li>
                      <li>
                        * <strong>ATEX rated gland:</strong> 20.00-100.00 GBP
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Emergency callout:</strong> 150-300 GBP
                      </li>
                      <li>
                        * <strong>Cable replacement:</strong> 50-500+ GBP per circuit
                      </li>
                      <li>
                        * <strong>Downtime costs:</strong> 500-5000+ GBP per hour
                      </li>
                      <li>
                        * <strong>Fire damage:</strong> 10,000-1M+ GBP
                      </li>
                      <li>
                        * <strong>Insurance excess:</strong> 1000-25,000 GBP
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="mb-6">
            ...
            <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
              ...
              <ul className="space-y-1 text-sm">
                <li>
                  * <strong>Grommets:</strong> Flexible inserts for knockouts; low/medium
                  protection.
                </li>
                <li>
                  * <strong>Bushes:</strong> Rigid (often threaded) smooth entry; common with
                  conduit.
                </li>
                <li>
                  * <strong>Glands:</strong> Provide sealing and strain relief; choose by material
                  and IP.
                </li>
              </ul>
            </div>
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-transparent border border-green-400/30 rounded-lg mb-4">
                <h5 className="font-medium text-green-400 mb-3">
                  IP Classification System (BS EN 60529)
                </h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <h6 className="font-medium text-white mb-2">
                    ...
                    <ul className="space-y-1 text-sm">
                      ...
                      <li>
                        * <strong>4:</strong> Protected against solid objects 1.0mm or larger
                      </li>
                      <li>
                        * <strong>5:</strong> Dust protected (limited ingress permitted)
                      </li>
                      <li>
                        * <strong>6:</strong> Dust tight (no ingress of dust)
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      ...
                      <li>
                        * <strong>4:</strong> Splashing water from any direction
                      </li>
                      <li>
                        * <strong>5:</strong> Water jets from any direction
                      </li>
                      <li>
                        * <strong>6:</strong> Powerful water jets
                      </li>
                      <li>
                        * <strong>7:</strong> Immersion up to 1m depth
                      </li>
                      <li>
                        * <strong>8:</strong> Immersion beyond 1m depth
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <table className="w-full border-collapse border border-white/10 text-sm">
                  ...
                  <tbody>
                    ...
                    <tr className="bg-muted/5">
                      ...
                      <td className="border border-white/10 p-3">
                        UV stability, temperature cycling
                      </td>
                    </tr>
                    <tr>
          ...
          <div className="mb-2">
            ...
            <div className="mb-6">
              <h4 className="font-medium text-white mb-3">
                UK Regulatory Landscape for Cable Entry Protection
              </h4>
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                ...
                <p className="text-xs sm:text-sm text-white mb-3">
                  <strong>Legal Framework:</strong> Cable entry protection in the UK is governed by
                  multiple statutory instruments and technical standards. Compliance ensures both
                  safety and legal conformity for electrical installations across all sectors.
                </p>
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-white/10 text-sm">
                    <thead>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border border-white/10 p-3">
                          Section 527: Cable support systems and enclosure entry
                        </td>
                        <td className="border border-white/10 p-3">
                          Part P Building Regulations, industry codes
                        </td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">
                          <strong>BS EN 60529:1992</strong>
                        </td>
                        <td className="border border-white/10 p-3">IP rating classification</td>
                        <td className="border border-white/10 p-3">
                          Ingress protection testing and marking
                        </td>
                        <td className="border border-white/10 p-3">
                      ...
                      <tr>
                        <td className="border border-white/10 p-3">
                          <strong>Building Regulations 2010</strong>
                        </td>
                      ...
                      <tr className="bg-muted/5">
                        ...
                        <td className="border border-white/10 p-3">
                          All electrical work activities
                        </td>
                        <td className="border border-white/10 p-3">
                          Regulation 4: Systems to prevent danger
                        </td>
          ...
          <div className="mt-6 p-4 bg-transparent border border-border/30 rounded-lg">
            ...
            <p className="text-xs sm:text-sm text-white">
              A metal consumer unit was installed without grommets on knockout entries. After a year
              of vibration, the sheath abraded leading to a live-to-earth fault that tripped the
              RCD. Retrofitting proper grommets and sealing unused entries restored integrity and
          ...
          <div className="space-y-4">
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Can I use plastic grommets in outdoor enclosures?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: Only if the enclosure's IP rating is maintained - outdoor installations usually
                require IP-rated glands instead.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Are metal glands better than plastic ones?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: Metal glands provide greater strength and durability; selection should match the
                environment, corrosion risk and IP requirement.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: What's the difference between a bush and a grommet?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: A bush is a rigid fitting (often threaded) providing a smooth entry; a grommet is
                a flexible insert that protects the cable on a knockout edge.
              </p>
            </div>
          </div>
        </section>
