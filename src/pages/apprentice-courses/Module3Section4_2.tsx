    ...
    <div className="bg-[#1a1a1a] overflow-x-hidden">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>First Fix:</strong> Infrastructure phase — cables, containment, back
                  boxes, CU location.
                </li>
                <li>
                  <strong>Second Fix:</strong> Finish phase — accessories fitted and final
                  terminations and testing.
                </li>
                <li>Sequence protects finishes and improves coordination with other trades.</li>
                <li>
                  Testing: preliminary checks at First Fix; full testing and certification at Second
                  Fix.
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Trunking, conduits, and back boxes (First Fix); flush
                  sockets, luminaires (Second Fix).
                </li>
                <li>
                  <strong>Use:</strong> Carry out First Fix before plaster/decoration; Second Fix
                  only after finishes are complete.
                </li>
                <li>
                  <strong>Check:</strong> Safe zones, earthing/bonding in place, documentation and
                  labels at Second Fix.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-4 text-xs sm:text-sm text-white">
              <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/20">
                ...
                <p>
                  The stage where cables, containment, and electrical infrastructure are installed,
                  but final connections and fittings are not yet in place.
                </p>
              </div>
              <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/20">
              ...
              <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/20">
                ...
                <p>
                  Usually carried out after initial construction but before plastering, decoration,
                  or floor finishes.
                </p>
              </div>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-4 text-xs sm:text-sm text-white">
              <div className="rounded-lg p-4 bg-transparent border border-green-400/30">
                <p className="font-medium mb-2">Definition</p>
                <p>
                  The stage where electrical accessories and final connections are installed after
              ...
              <div className="rounded-lg p-4 bg-transparent border border-green-400/30">
                <p className="font-medium mb-2">Timing</p>
                <p>
                  Carried out after walls are painted, floors laid, and ceilings finished to prevent
                  damage to final fittings.
                </p>
              </div>
              <div className="rounded-lg p-4 bg-transparent border border-amber-400/30">
                <p className="font-medium mb-2">Key Considerations</p>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-4 text-xs sm:text-sm text-white">
              <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/20">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li>
                    <strong>With Builders:</strong> Ensure structural work complete before cable
                    runs.
                  </li>
                  <li>
                    <strong>With Plumbers:</strong> Coordinate routes to avoid clashes with
                    pipework.
                  </li>
                  <li>
                    <strong>With HVAC:</strong> Plan around ductwork and ventilation systems.
                  </li>
                  <li>
                    <strong>With Carpenters:</strong> Mark cable routes before stud work completion.
                  </li>
                </ul>
              </div>
              <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-white/20">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li>
                    <strong>With Decorators:</strong> Wait until all painting and wallpapering
                    complete.
                  </li>
                  <li>
                    <strong>With Flooring:</strong> Coordinate socket heights with floor finishes.
                  </li>
                  <li>
                    <strong>With Kitchen Fitters:</strong> Time appliance connections with
                    installation.
                  </li>
                  <li>
                    <strong>With Final Clean:</strong> Install accessories after deep cleaning.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-4 text-xs sm:text-sm text-white">
              <div className="rounded-lg p-4 bg-indigo-500/10 border border-indigo-400/30">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li>
                    <strong>First Fix:</strong> Typically 60-70% of total electrical installation
                    time
                  </li>
                  <li>
                    <strong>Second Fix:</strong> Usually 30-40% of total time but requires precision
                  </li>
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              <p className="text-white font-medium">
                Residential Development Project - Meadowview Gardens
              </p>
            </div>
          </div>
            ...
            <div className="bg-muted/30 rounded-lg p-4 border border-white/10">
              ...
              <div className="space-y-2 text-sm text-white">
                <div className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Week 8:</strong> Roof completed, ground floor
                    slab ready
                  </span>
                </div>
                <div className="flex items-start gap-2">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Week 10:</strong> All cables in, continuity tests
                    passed
                  </span>
                </div>
              </div>
            ...
            <div className="bg-muted/30 rounded-lg p-4 border border-white/10">
              ...
              <div className="space-y-2 text-sm text-white">
                <div className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Week 17:</strong> All decoration and flooring
                    completed
                  </span>
                </div>
                <div className="flex items-start gap-2">
            ...
            <div className="grid md:grid-cols-3 gap-3 sm:gap-4 text-sm">
              <div className="flex items-start gap-2">
                ...
                <span className="text-white">
                  <strong className="text-white">Zero Damage:</strong> No accessories damaged during
                  construction phase
                </span>
              </div>
              <div className="flex items-start gap-2">
                <Clock className="w-4 h-4 text-elec-yellow mt-0.5 flex-shrink-0" />
                <span className="text-white">
                  <strong className="text-white">Time Saved:</strong> 15% faster than single-phase
                  approach
                </span>
              </div>
              <div className="flex items-start gap-2">
                ...
                <span className="text-white">
                  <strong className="text-white">Trade Harmony:</strong> Excellent coordination with
                  all trades
                </span>
              </div>
            </div>
        ...
        <section className="mb-10">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              <div className="space-y-2">
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-elec-yellow mt-0.5 flex-shrink-0" />
                  <span className="text-white">
                    Protects electrical accessories from construction damage
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-elec-yellow mt-0.5 flex-shrink-0" />
                  <span className="text-white">
                    Enables efficient coordination with other building trades
                  </span>
                </div>
              </div>
              <div className="space-y-2">
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-elec-yellow mt-0.5 flex-shrink-0" />
                  <span className="text-white">
                    Improves quality control and reduces rectification work
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-4 h-4 text-elec-yellow mt-0.5 flex-shrink-0" />
                  <span className="text-white">
                    Ensures BS 7671 compliance throughout the process
                  </span>
                </div>
              </div>
            </div>
          ...
          {/* Bottom Line */}
          <div className="mt-6 bg-elec-yellow/5 rounded-lg p-4 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
            <p className="text-white font-medium text-center">
              <strong>Bottom Line:</strong> The two-stage approach isn't just about timing—it's
              about delivering professional, damage-free electrical installations that meet BS 7671
              standards while working harmoniously with other trades.
            </p>
          </div>
        </section>
