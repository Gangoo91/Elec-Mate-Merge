...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['63A to 250A', 'Up to 63A', 'Above 2000A only', '100A to 1600A'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Form 2', 'Form 4', 'Form 1', 'Form 3'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <ConceptBlock title="LV Switchboard Fundamentals">
          ...
          <p>
            <strong>LV Switchboard Components:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Metering:</strong> Current transformers and meters for monitoring and billing
            </li>
            <li>
              <strong>Protection relays:</strong> Electronic devices providing advanced protection
              functions
            </li>
          </ul>
          <p>
            <strong>Switchboard Configurations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Single-ended:</strong> Single incomer feeding all outgoing circuits — Small
              commercial, non-critical loads
            </li>
            <li>
              <strong>Double-ended:</strong> Two incomers with bus section switch — Enhanced
              reliability, dual supplies
            </li>
            <li>
              <strong>Ring main:</strong> Multiple interconnected boards — Large sites, industrial
              facilities
            </li>
            <li>
              <strong>With standby:</strong> Generator or UPS integration — Critical facilities,
        ...
        <ConceptBlock title="MCCB vs ACB Selection Criteria">
          ...
          <p>
            <strong>MCCB Characteristics</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>ACB Characteristics</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Selection Decision Matrix</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Rated current:</strong> &lt;1600A — &gt;800A, especially &gt;1600A
            </li>
            <li>
              <strong>Fault level:</strong> &lt;50kA typical — &gt;50kA or high reliability required
            </li>
            <li>
              <strong>Maintenance:</strong> Shutdown acceptable — Withdrawable needed, live busbar
              work
            </li>
            <li>
              <strong>Protection:</strong> Basic overcurrent protection — Advanced functions,
              communication
            </li>
            <li>
              <strong>Budget:</strong> Cost-sensitive applications — Reliability justifies premium
            </li>
          </ul>
          <p>
            <strong>Overlap Zone: 800A to 1600A</strong>
          </p>
          <p>
        ...
        <ConceptBlock title="Rated Currents and Short-Circuit Ratings">
          ...
          <p>
            <strong>Key Rated Values</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>In:</strong> Rated current — Maximum continuous current without exceeding
              temperature rise limits
            </li>
            <li>
              <strong>Ue:</strong> Rated operational voltage — Voltage at which device operates
              (typically 400V for LV)
            </li>
            <li>
              <strong>Icu:</strong> Ultimate short-circuit breaking capacity — Maximum fault current
              device can interrupt (may require replacement after)
            </li>
            <li>
              <strong>Ics:</strong> Service short-circuit breaking capacity — Fault current device
              can interrupt and remain serviceable
            </li>
            <li>
              <strong>Icw:</strong> Short-time withstand current — Fault current withstood for
              specified duration (typically 1s) without damage
            </li>
            <li>
              <strong>Icm:</strong> Rated short-circuit making capacity — Peak fault current device
              can close onto
            </li>
          </ul>
          <p>
            <strong>Icu Selection Process</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Worked Example: Breaking Capacity Selection</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Transformer:</strong> 1000kVA, 6% impedance
            </li>
            <li>
              <strong>Secondary voltage:</strong> 400V
            </li>
            <li>
              <strong>PSCC at transformer:</strong> I<sub>sc</sub> = kVA × 1000 / (√3 × V × Z%)
            </li>
            <li>
              <strong>Calculation:</strong> = 1000 × 1000 / (1.732 × 400 × 0.06) = 24.1kA
            </li>
            <li>
              <strong>Selection:</strong> MCCB with Icu ≥ 25kA (select 36kA for margin)
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Forms of Separation and Type-Tested Assemblies">
          ...
          <p>
            <strong>Forms of Internal Separation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Form 1:</strong> No internal separation — Simple distribution boards,
              single-user access
            </li>
            <li>
              <strong>Form 2a:</strong> Busbars separated from functional units; terminals not
              separated — Standard commercial switchboards
            </li>
            <li>
              <strong>Form 2b:</strong> Form 2a plus terminals in same compartment as busbar —
              Modified commercial applications
            </li>
            <li>
              <strong>Form 3a:</strong> Busbars and functional units separated; terminals not
              separated from busbars — Industrial, frequent maintenance
            </li>
            <li>
              <strong>Form 3b:</strong> Form 3a plus terminals separated from busbars — Higher
              safety requirement
            </li>
            <li>
              <strong>Form 4a:</strong> Form 3b plus terminals separated from each other (in common
              space) — Critical facilities, hospitals
            </li>
            <li>
              <strong>Form 4b:</strong> Form 3b plus terminals enclosed individually — Maximum
              safety, data centres
            </li>
          </ul>
          <p>
            <strong>Type-Tested Assembly (TTA)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Partially Type-Tested Assembly (PTTA)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>BS EN 61439 Verification Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Dielectric properties:</strong> Insulation must withstand rated impulse and
          ...
          <p>
            <strong>Specifying Form of Separation</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Form 2:</strong> Standard for commercial buildings where circuit work requires
            isolation of affected circuits only.
          </p>
          <p>
            <strong>Form 3:</strong> Required where cable termination must proceed with adjacent
            circuits energised.
          </p>
          <p>
            <strong>Form 4:</strong> Essential for critical facilities requiring maximum flexibility
            and safety during live maintenance.
          </p>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Specify switchgear for a 1600A main LV switchboard fed from a
            1000kVA transformer (6% impedance).
          </p>
          ...
          <p>
            Rationale: Maintenance flexibility, adequate breaking capacity with margin, integration
            capability
          </p>
          <p>
          ...
          <p>
            <strong>Scenario:</strong> Select MCCB for a 350A submain with 25kA prospective fault
            current.
          </p>
          ...
          <p>
            Rationale: Maximum safety for live working, individual terminal compartments enable
            simultaneous work on multiple circuits
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Busbar systems</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
