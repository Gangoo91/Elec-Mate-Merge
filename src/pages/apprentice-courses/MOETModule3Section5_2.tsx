      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Lead-acid:</strong> 2.0 V/cell — flooded (maintenance) or VRLA (sealed)
              </li>
              <li className="pl-1">
                <strong>Lithium-ion:</strong> 3.2-3.7 V/cell — requires BMS, longer life
              </li>
              <li className="pl-1">
                <strong>Testing:</strong> Impedance trending, load testing, visual inspection
              </li>
              <li className="pl-1">
                <strong>Safety:</strong> Hydrogen gas, acid, arc flash, thermal runaway risks
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  ...
                  distilled water, produces hydrogen gas during charging, needs ventilation, long
                  life (15-20 years), low cost per Ah for large installations
                </li>
                <li className="pl-1">
                  <strong>VRLA-AGM:</strong> Electrolyte absorbed in glass mat separator, sealed,
                  maintenance-free, recombines gases internally, 3-12 year design life, most common
                  in UPS and telecoms
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>LiFePO4 (Lithium Iron Phosphate):</strong> 3.2 V/cell nominal. Safest
                  Li-ion chemistry, excellent thermal stability, 3,000-5,000+ cycle life, 10-15+
                  year design life. Preferred for stationary applications
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  1.2 V/cell nominal. Extremely robust — operates -40°C to +60°C
                </li>
                ...
                <li className="pl-1">
                  Used in critical standby applications (substations, telecoms, railway)
                </li>
                <li className="pl-1">
                  Being phased out due to cadmium toxicity (EU Battery Directive restrictions)
                </li>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Battery selection depends on the application requirements:
              cycle life, operating temperature range, required autonomy, space and weight
              constraints, safety requirements and total cost of ownership (not just purchase
              price).
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  ...
                  applied after a discharge event to restore the battery to full charge more
                  quickly. Time-limited to prevent overcharging
                </li>
                <li className="pl-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Maintenance tip:</strong> Incorrect charging is a leading cause of premature
              battery failure. Verify charger output voltage is within the manufacturer's
              specification for the battery type and temperature. A charger set too high causes
              gassing and thermal runaway risk; too low causes sulphation and reduced capacity.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Load (discharge) testing:</strong> Discharge the battery under a
                  controlled load to verify actual capacity. The definitive test but disruptive —
                  requires bypass or alternative power
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Thermal imaging:</strong> Infrared scan of battery connections and cells
                  to identify hot spots caused by high-resistance joints or internally failing cells
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                ...
                new, and repeat at regular intervals (quarterly or annually). An impedance increase
                of more than 25% from baseline indicates significant degradation. An impedance
                increase of more than 50% from baseline indicates the cell/block is approaching end
                of life and should be flagged for replacement.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> The 80% capacity rule: when a battery's actual capacity
              (measured by load test) drops below 80% of its rated capacity, it should be scheduled
              for replacement. Below 80%, degradation accelerates rapidly and failure can occur
              without warning.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Lithium-ion:</strong> Internal short circuit, overcharge, mechanical
                  damage or external heat source triggers an exothermic decomposition of the cathode
                  material. Temperatures can reach 500°C+. Venting of flammable gases, fire and
                  cell-to-cell propagation can occur
                </li>
                <li className="pl-1">
                  <strong>Prevention:</strong> Correct charging voltage, temperature compensation,
                  BMS monitoring (Li-ion), adequate ventilation, regular inspection for swelling or
                  hot spots
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Battery Room Safety Requirements (BS EN 50272)
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              in maintaining battery systems safely, including awareness of hazards, use of
              appropriate PPE, testing procedures and waste disposal compliance.
            </p>
          </div>
        </section>
