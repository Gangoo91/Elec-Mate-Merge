          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent">
                ...
                <p className="text-white text-xs">Battery, power station, generator</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">2. Load</p>
                <p className="text-white text-xs">Lamp, motor, heater, TV</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">3. Path</p>
                <p className="text-white text-xs">Wires, cables, connections</p>
              </div>
            </div>
