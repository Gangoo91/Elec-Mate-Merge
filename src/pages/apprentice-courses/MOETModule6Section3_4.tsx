      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Traceability:</strong> Complete history linked to dates, personnel and
                documents
              </li>
              <li className="pl-1">
                <strong>Audit trails:</strong> Who did what, when, and what was approved
              </li>
              <li className="pl-1">
                <strong>Retention:</strong> Records kept for the life of the installation
              </li>
              <li className="pl-1">
                <strong>Calibration:</strong> Test instruments traceable to national standards
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Where:</strong> Exact asset identification, location code, circuit
                  reference
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Results:</strong> Findings, measurements, test results, condition
                  assessment
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                ...
                aggravating factor in the prosecution. The lesson is clear: if it is not documented
                with full traceability, it effectively did not happen.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Never backdate entries</strong> — if a record is late, note the actual
                  date of entry alongside the date of the work
                </li>
                <li className="pl-1">
                  <strong>Never destroy records</strong> without authorisation and in accordance
                ...
                <li className="pl-1">
                  <strong>Digital records:</strong> Use the system's formal amendment process; do
                  not create new records to replace originals
                </li>
              </ul>
            </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Automatic timestamp and user ID
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Manual date and signature
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Depends on discipline of the writer
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Physical alterations may be visible
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">Retrieval</td>
                      <td className="border border-white/10 px-3 py-2">
                        Full history retrievable instantly
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Requires physical access to files
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Evidence of maintenance to prevent danger
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Examination records for lifting equipment
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Records of ATEX equipment maintenance
                      </td>
                      <td className="border border-white/10 px-3 py-2">Life of equipment</td>
                    </tr>
                    <tr>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                ...
                decommissioning (typically 6 years, which aligns with the limitation period for
                civil claims). Digital storage makes long-term retention practical and
                cost-effective. Never destroy records without written authorisation and a documented
                retention policy.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  All test instruments must have a current calibration certificate
                </li>
                <li className="pl-1">
                  Calibration must be traceable to national standards (UKAS in the UK)
                </li>
                <li className="pl-1">
                  Never use an out-of-calibration instrument for certification testing
                </li>
                <li className="pl-1">
                  GS38 requires voltage indicators proved before and after use
                </li>
                <li className="pl-1">
                  Records must link specific test results to the instrument (by serial number)
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Practical Steps for Every Technician
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
