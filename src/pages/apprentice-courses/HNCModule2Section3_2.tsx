...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['20-30%', '80-90%', '70-80%', '40-60%'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['14.7 g/kg', '58.8 g/kg', '7.4 g/kg', '29.4 g/kg'],
    correctAnswer: 0,
    explanation:
  ...
  return (
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              recommendations. As the HNC engineer you cite these when defending humidity setpoints
              to the architect, when sizing humidifiers, and when justifying glazing or insulation
              upgrades to eliminate condensation black-spots.
            </>
          }
        ...
        >
          <p>
            Relative humidity is the most commonly quoted humidity measure, expressing how close air
            is to being saturated with water vapour at its current temperature.
          </p>
          <p>
        ...
        >
          <p>
            ...
            water per kilogram of dry air. Unlike RH, it remains constant during sensible heating or
            cooling.
          </p>
          <p>
        ...
        >
          <p>
            ...
            constant pressure and moisture content. Below this temperature, water vapour condenses.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Window condensation:</strong> Occurs if glass temperature falls below room dew
              point
            </li>
            <li>
        ...
        >
          <p>
            Wet bulb temperature is measured by a thermometer with its bulb covered by a wet wick in
            moving air. Evaporation from the wick causes cooling proportional to the air's humidity.
          </p>
          <p>
        ...
        >
          <p>
            <strong>Example 1: Calculating Moisture Content.</strong> Air at 25°C has RH of 60%. The
            saturation vapour pressure at 25°C is 3.169 kPa. Find the moisture content.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 2: Finding Dew Point.</strong> Air at 20°C, 50% RH. At what temperature
            will condensation occur on a cold surface?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3: Effect of Heating on RH.</strong> Winter air at 5°C, 80% RH is heated
            to 21°C. Find the new RH.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Yes — condensation WILL occur on the glass.</strong> Solution: improve glazing
              or reduce humidity.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A client reports persistent condensation on the inside face of single-glazed Crittall
              windows in a heritage meeting room. Internal conditions are 21 °C and 55% RH
              (post-MVHR retrofit). The architect insists the glazing must be retained. You are
              asked to write the technical brief.
            </>
          }
          whatToDo={
            <>
              Calculate room dew point: at 21 °C, ps ≈ 2.487 kPa, pv = 0.55 × 2.487 ≈ 1.368 kPa, dew
              point ≈ 11.7 °C. Estimate the inner glass surface temperature using the glazing
              U-value and design external temperature. Where surface T &lt; dew point, recommend
              either secondary glazing (raises surface temperature) or a humidity setpoint reduction
              (lowers dew point). Document the trade-off in the project risk register.
            </>
          }
          whyItMatters={
            <>
              Sustained condensation rots the timber subframe, voids any heritage-fabric warranty
              and triggers mould-growth complaints under the Homes (Fitness for Human Habitation)
              Act 2018. The dew-point calculation puts a defendable number on the choice between
              glazing upgrade and humidity control.
            </>
          }
        />
