...
const AM2Module5Section2 = () => {
  ...
  const faqs = [
    {
      ...
      answer:
        'No, you adapt it to symptoms, but you must stay logical and structured. The key is demonstrating systematic thinking.',
    },
    {
      question: "Can I get marks for explaining the fault even if I don't locate it exactly?",
      answer:
        'Yes - assessors credit method and reasoning. Your logical approach is as important as the final result.',
    },
    {
      question: 'What happens if I guess and get it right?',
      answer:
        "You won't score well - NET assesses the process, not luck. Professional electricians work systematically, not by guesswork.",
    },
    {
      question: "Do I have to write rectification even though I don't fix it?",
      answer:
        'Yes - recording rectification is part of the assessment. It proves you understand how to make the installation safe.',
    },
    {
      question: 'Will assessors give hints?',
      answer:
        "No - they only observe. It's your job to demonstrate the logical process independently.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      {/* The 7-Step Process */}
      <AM2ContentCard title="1. The 7-Step Logical Process" icon={Target} accent>
      ...
      {/* Steps 4-7 */}
      <AM2ContentCard title="2. Testing and Analysis Steps" icon={Zap}>
        <div className="space-y-4">
      ...
      {/* Practical Guidance */}
      <AM2ContentCard title="3. Practical Guidance for AM2 Success" icon={Wrench}>
      ...
      {/* Real-World Examples */}
      <AM2ContentCard title="4. Real-World Examples" icon={BookOpen}>
        <div className="space-y-4">
          <div className="bg-white/5 border border-red-500/30 rounded-xl p-4">
      ...
      {/* FAQ Section */}
      <AM2ContentCard title="5. Frequently Asked Questions" icon={Lightbulb}>
        <div className="space-y-4">
          {faqs.map((faq, index) => (
      ...
      {/* Quiz Section */}
      <Quiz title="Test Your Knowledge: Logical Fault-Finding Process" questions={quizQuestions} />
