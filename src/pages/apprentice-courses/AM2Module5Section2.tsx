    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Fault diagnosis is about working systematically. In the AM2, you are being tested not only
          on your knowledge of electrical faults but also on your ability to think like a competent
          electrician.
        </p>
        ...
        <p className="text-ios-body text-white leading-relaxed -mt-4 mb-6">
          ...
          safely, approach faults in a structured way, use test instruments properly, and state your
          diagnosis clearly.
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              outside the maximum for the protective device. For a 32A Type B MCB the maximum Zs is
        ...
        <ConceptBlock title="2. Testing and Analysis Steps">
          ...
          <p>Start from the origin (CU) and work outwards. This avoids chasing faults randomly.</p>
          <p>
          ...
          <p>
            <strong className="text-elec-yellow">Step 6: Record the Fault and Rectification</strong>
          </p>
          ...
          <p>
            <strong>Example:</strong> "Open CPC between CU and socket 2. Rectify by reconnecting CPC
            at CU terminal."
          </p>
        ...
        <Scenario
          ...
          situation={
            <>
              You re-energise after Step 7 and the 30 mA RCD on the AM2 board trips immediately. The
              board has multiple circuits running through that RCD. You've got 40 minutes of fault
              time left. Symptom: low IR somewhere on the line-to-earth side.
            </>
          }
          whatToDo={
            <>
              Don't try to test the whole board live. Isolate again. With the RCD off, switch each
              MCB OFF, then turn them on one at a time and re-energise — the one that drops the RCD
              is your faulty circuit. Then dead-test that circuit only: IR L-E and N-E at 500 V DC.
              The reading near 0 MΩ tells you which side of the fault you're on. Half-split from
              there.
            </>
          }
          whyItMatters={
            <>
              The assessor wants to see methodical isolation, not panic. Working through one MCB at
              a time means you're isolating the fault to one circuit before doing detailed
        ...
        <RegsCallout
          ...
          meaning={
            <>
              For circuits up to 500 V (which is everything you'll see on AM2), test at 500 V DC and
              the minimum acceptable IR is 1 MΩ. Anything lower is a failed test result and points
              to an earth fault or short. Below 2 MΩ, BS 7671 says investigate even if it
              technically passes — that's the level of detail the assessor wants in your reasoning.
            </>
          }
        ...
        <ConceptBlock title="3. Practical Guidance for AM2 Success">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Always think safety first</strong> - if you forget isolation, it's an instant
              fail
            </li>
            <li>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              between consumer unit MCB earth bar and socket SO2 — rectify by reconnecting CPC at CU
              earth bar — re-test continuity (R2) and Zs at SO2 to confirm within 1.37 Ω for 32A
              Type B."
            </>
          }
        />
        ...
        <ConceptBlock title="6. Section Summary">
          ...
          <p>
            <strong className="text-elec-yellow">Remember:</strong> Following this method shows the
            assessor you are competent and professional, even under exam pressure. NET assessors
            mark the process and reasoning - not just the final answer.
          </p>
        </ConceptBlock>
