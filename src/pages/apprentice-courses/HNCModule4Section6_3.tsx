...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Light Single Flex', 'Low Smoke Flame', 'Long Service Factor', 'Low Smoke and Fume'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The BS 7671 Appendix 6 schedules (Schedule of Inspections, Schedule of Test Results,
              EIC) get bound into the O&amp;M, but the day-to-day handover schedule lives on the DB
              as a Reg 514.12.1 notice. The dates of last and next inspection go on it. As the HNC
              engineer producing the master schedule pack, you specify the notice (durable material,
              font, fixing) and you record the recommended next-test interval based on your Reg
              652.1 frequency assessment.
            </>
          }
        ...
        <ConceptBlock title="Equipment Schedules">
          ...
          <p>
            <strong>
              Distribution board schedule example (way / description / protection / cable / load):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Key point:</strong> DB schedules should match the physical board layout, showing
            incomer and all outgoing ways.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Cable Schedules">
          <p>
            Cable schedules document all cables in the installation, providing essential information
            for procurement, installation and testing. They link circuit design to physical
            implementation.
          </p>
          <p>
          ...
          <p>
            <strong>Important:</strong> Cable schedules must align with DB schedules and single-line
            diagrams for consistency.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Luminaire Schedules">
          <p>
            ...
            calculations to specified products. They are essential for procurement, installation and
            demonstrating compliance with lighting standards.
          </p>
          <p>
        ...
        <ConceptBlock title="Data Sheets and Coordination">
          <p>
            Data sheets provide comprehensive technical information for specific products, enabling
            design verification, installation planning and maintenance. They supplement schedules
        ...
        <Scenario
          ...
          situation={
            <>
              Stage 4 design freeze on a 5-storey commercial building. Drawings are ready. Schedules
              need to lock down for the contractor and QS. You have: 84 final circuits across 5
              floor DBs, 320 luminaires (including 60 emergency), one MSB, two sub-mains. Tagging is
              mostly consistent but a few items still carry the Stage 3 placeholders.
            </>
          }
          whatToDo={
            <>
              Run a tag reconciliation: every drawing tag has a row on the right schedule, every
              schedule row has a tag on the right drawing. Cable schedule columns: Tag / From / To /
              Route / Csa / Type / Length / Vdrop% / Device rating / Fault level / Notes. Luminaire
              schedule: Tag / Type code / Manufacturer / Lamp/driver / Em design / UGR / Ra / CCT /
              IP / Mounting / Quantity / Notes. Emergency luminaires on a separate schedule with
              duration and self-test/central-battery flag. DB schedules use the BS 7671 Appendix 6
              pro-formas (Schedule of Circuit Details, Schedule of Test Results pre-populated for
              the install team). Specify a Reg 514.12.1 notice on each DB door (durable Traffolyte,
              A5 minimum, fixing method). Cross-reference the EIC scope to the schedules. Issue all
              schedules in the same pack as the drawings they describe — same revision, same date.
            </>
          }
          whyItMatters={
            <>
              A schedule out-of-step with the drawings means the contractor orders the wrong
              quantities, the QS prices the wrong items, and the EIC at handover doesn’t match the
              as-built. Reconciliation is a 2-hour task that saves a 2-week dispute.
            </>
          }
        />
