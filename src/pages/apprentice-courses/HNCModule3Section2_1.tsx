...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['0.1 Wb-turns', '0.01 Wb-turns', '25 Wb-turns', '10 Wb-turns'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['1.15J', '11.5J', '2.65J', '26.5J'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['8.0 kVAr', '12.4 kVAr', '16.8 kVAr', '24.7 kVAr'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['E = 1/2 LV squared', 'E = L/I squared', 'E = LI', 'E = 1/2 LI squared'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Every PFC capacitor in a building services switchroom is built to BS EN 60831-1. The
              discharge-resistor clause is the reason you wait 3 minutes before touching the
              terminals after isolation — the stored ½CV² energy in a large bank can be lethal
              otherwise.
            </>
          }
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Inductance (L):</strong> Opposition to current change, stores energy in
              magnetic fields
            </li>
            <li>
              <strong>Capacitance (C):</strong> Ability to store charge, stores energy in electric
              fields
            </li>
            <li>
        ...
        <ConceptBlock title="Magnetic Fields and Electromagnetic Induction">
          <p>
            Electromagnetic induction is the fundamental principle behind generators, transformers,
            and inductors. When a conductor experiences a changing magnetic field, an electromotive
            force (EMF) is induced.
          </p>
          <p className="text-sm font-medium text-white">Magnetic field fundamentals:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Magnetic flux (Phi):</strong> Total magnetic field passing through an area,
              measured in Webers (Wb)
            </li>
            <li>
              <strong>Flux density (B):</strong> Flux per unit area, B = Phi/A, measured in Tesla
              (T)
            </li>
            <li>
              <strong>Flux linkage (lambda):</strong> Total flux linking a coil, lambda = N Phi, in
              Weber-turns
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Faraday's Law:</strong> EMF proportional to rate of flux change — magnitude of
              induced voltage
            </li>
            <li>
              <strong>Lenz's Law:</strong> Induced EMF opposes the change causing it — direction of
              induced current (negative sign)
            </li>
            <li>
              <strong>Fleming's Right Hand:</strong> Motion, Field, EMF perpendicular — generator
              action direction
            </li>
          </ul>
        ...
        <ConceptBlock title="Inductance — Self and Mutual">
          <p>
            ...
            the magnetic field created by current flow inducing a voltage that opposes the current
            change.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>M = k √(L1 × L2)</strong> — k = coupling coefficient (0 to 1), typically
              0.95-0.99 for power transformers
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">
            Inductance Values in Building Services
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Electric Fields and Capacitance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Permittivity (epsilon):</strong> Ability of material to store electric field
              energy
            </li>
            <li>
              <strong>epsilon = epsilon0 × epsilonr:</strong> Absolute permittivity = free space ×
              relative
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Plate area (A) increases:</strong> C increases — Larger capacitors need more
              material
            </li>
            <li>
              <strong>Separation (d) increases:</strong> C decreases — Thin dielectrics = high C but
              lower voltage rating
            </li>
            <li>
              <strong>Permittivity (epsilonr) increases:</strong> C increases — Ceramic εr =
              1000-10000 vs air εr = 1
            </li>
          </ul>
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            microfarad capacitor at 400V stores E = ½ × 0.001 × 400² = 80J — enough to cause severe
            burns or cardiac arrest. Always discharge before working.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Building Services Applications">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">
            Motor Windings and Inductive Loads
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            Capacitors supply leading reactive power (kVAr) to cancel lagging reactive power from
            motors:
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>AHU supply fan:</strong> 15-75kW — pf 0.80-0.85 — individual PFC capacitor
              bank
            </li>
            <li>
              <strong>Chilled water pump:</strong> 5-30kW — pf 0.80-0.85 — VSD often provides unity
              pf
            </li>
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          <p className="text-sm font-medium text-elec-yellow/80">
            Example 1: Induced EMF in Motor Winding
          </p>
          <p>
            <strong>Question:</strong> A motor winding with 200 turns experiences a flux change from
            50mWb to 30mWb in 10ms. Calculate the induced EMF.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Using Faraday's Law: e = -N × (dPhi/dt)</li>
            <li>Flux change: dPhi = 30 - 50 = -20mWb = -0.020 Wb; Time: dt = 10ms = 0.010 s</li>
            <li>
              e = -200 × (-0.020 / 0.010) = -200 × (-2) = <strong>+400V</strong>
            </li>
            <li>The positive sign indicates EMF opposes the flux reduction</li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
            Example 2: Energy Stored in Motor Winding
          </p>
          <p>
            <strong>Question:</strong> An AHU motor winding has inductance of 150mH and carries 25A
            at full load. Calculate the stored energy.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              E = ½ × 0.150H × (25A)² = ½ × 0.150 × 625 = <strong>46.9 J</strong>
            </li>
            <li>This energy must dissipate safely when motor is switched off</li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
            Example 3: Capacitor for Power Factor Correction
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Qc = 30 × (0.882 - 0.329) = 30 × 0.553 = <strong>16.6 kVAr</strong>
            </li>
            <li>Select a 20 kVAr capacitor bank (nearest standard size)</li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
            Example 4: Capacitance Calculation
          </p>
          <p>
            <strong>Question:</strong> A PFC capacitor uses polypropylene dielectric (εr = 2.2) with
            plates of 0.5m² separated by 25 micrometres. Calculate the capacitance.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>C = epsilon0 epsilonr A / d = (8.854 × 10⁻¹² × 2.2 × 0.5) / (25 × 10⁻⁶)</li>
            <li>
              C = (9.74 × 10⁻¹²) / (25 × 10⁻⁶) = <strong>0.39 µF</strong>
            </li>
            <li>Multiple plates in parallel are used to achieve higher values</li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
            Example 5: Capacitor Energy Storage
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              E = ½ × 470 × 10⁻⁶ × (650)² = ½ × 470 × 10⁻⁶ × 422500 = <strong>99.3 J</strong>
            </li>
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              epsilon0 = <strong>8.854 × 10⁻¹² F/m</strong> (permittivity of free space)
            </li>
            <li>
              XL = <strong>2 pi fL</strong> (inductive reactance at frequency f)
            </li>
            <li>
              XC = <strong>1/(2 pi fC)</strong> (capacitive reactance)
            </li>
            <li>
              Target power factor: <strong>0.95 lagging</strong> (avoid leading)
            </li>
            <li>
              Polypropylene εr ≈ <strong>2.2</strong> (PFC capacitors)
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Capacitors store energy indefinitely — discharge through resistor before working
            </li>
            ...
            <li>
              Polarity matters for electrolytic capacitors — incorrect connection causes failure
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              (causes voltage rise). Forgetting the squared term in energy formulas. Not discharging
              a charged capacitor before working. Designing PFC without checking for harmonic
              resonance.
            </>
          }
          doInstead={
            <>
              Convert all to base SI units before substituting. Target 0.95 lagging, never leading.
              Remember energy ∝ I² or V². Always verify discharge with a meter. Check the resonance
              frequency f₀ = 1/(2π√LC) sits well away from supply harmonics.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A 7.5 kW single-phase fan-coil motor on a 230 V 50 Hz supply has a measured power
              factor of 0.72 lagging. The tenant has been hit with a power-factor penalty on the
              utility bill and you need to fit a local capacitor at the motor to bring PF up to
              0.95.
            </>
          }
          whatToDo={
            <>
              Compute the required reactive correction: kVAr = P × (tan φ₁ − tan φ₂) = 7.5 ×
              (tan(cos⁻¹ 0.72) − tan(cos⁻¹ 0.95)) ≈ 7.5 × (0.964 − 0.329) ≈ 4.76 kVAr. Convert to
              capacitance at 50 Hz: C = Q / (2πfV²) = 4760 / (2π × 50 × 230²) ≈ 286 µF. Pick the
              next standard value above (typically 300 µF at 250 V AC), to BS EN 60831-1, fitted
              with discharge resistors.
            </>
          }
          whyItMatters={
            <>
              Local PFC at the motor cuts the line current the cable has to carry, reduces I²R
              losses, and removes the supplier’s reactive penalty. The capacitance calculation is a
              direct application of inductive vs capacitive reactance — get the value wrong and you
              either under-correct or over-correct into a leading PF (which the supplier may also
              penalise).
            </>
          }
        />
