        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              ...
              <li className="pl-1">
                <strong>Energy:</strong> E = 1/2 LI squared (inductor), E = 1/2 CV squared
                (capacitor)
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Magnetic flux (Phi):</strong> Total magnetic field passing through an
                  area, measured in Webers (Wb)
                </li>
                <li className="pl-1">
                  <strong>Flux density (B):</strong> Flux per unit area, B = Phi/A, measured in
                  Tesla (T)
                </li>
                <li className="pl-1">
                  <strong>Flux linkage (lambda):</strong> Total flux linking a coil, lambda = N Phi,
                  in Weber-turns
                </li>
                <li className="pl-1">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Direction of induced current (negative sign)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Fleming's Right Hand</td>
                      <td className="border border-white/10 px-3 py-2">
                        Motion, Field, EMF perpendicular
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Generator action direction
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              reducing power factor. A motor with 100mH inductance at 50Hz has XL = 2 pi fL = 31.4
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Permittivity (epsilon):</strong> Ability of material to store electric
                  field energy
                </li>
                <li className="pl-1">
                  <strong>epsilon = epsilon0 x epsilonr:</strong> Absolute permittivity = free space
                  x relative
                </li>
                <li className="pl-1">
                  <strong>epsilon0 = 8.854 x 10 to the minus 12 F/m:</strong> Permittivity of free
                  space
                </li>
              </ul>
            </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Larger capacitors need more material
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Thin dielectrics = high C but lower voltage rating
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Permittivity (epsilonr) increases
                      </td>
                      <td className="border border-white/10 px-3 py-2">C increases</td>
                      <td className="border border-white/10 px-3 py-2">
                        Ceramic epsilonr = 1000-10000 vs air epsilonr = 1
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        PFC capacitors, film capacitors
                      </td>
                    </tr>
                    <tr>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              microfarad capacitor at 400V stores E = 1/2 x 0.001 x 400 squared = 80J - enough to
              cause severe burns or cardiac arrest. Always discharge before working.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Motor windings are primarily inductive - current lags voltage
                </li>
            ...
            <div className="my-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 mb-4">
                <p className="text-sm text-white mb-2">
                  Capacitors supply leading reactive power (kVAr) to cancel lagging reactive power
                  from motors:
                </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Central PFC for multiple units
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  Qc = 30 x 0.553 = <strong>16.6 kVAr</strong>
                </p>
                <p className="mt-2 text-green-400">
                  Select a 20 kVAr capacitor bank (nearest standard size)
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> A PFC capacitor uses polypropylene dielectric (epsilonr =
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2">
                  C = (8.854 x 10 to the minus 12 x 2.2 x 0.5) / (25 x 10 to the minus 6)
                </p>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>E = 1/2 L I squared</strong> — Energy in inductor
                </li>
                <li className="pl-1">
                  <strong>C = epsilon A/d</strong> — Parallel plate capacitance
                </li>
                <li className="pl-1">
                  <strong>E = 1/2 C V squared</strong> — Energy in capacitor
                </li>
                <li className="pl-1">
                  <strong>Qc = P(tan phi1 - tan phi2)</strong> — PFC sizing
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  epsilon0 = <strong>8.854 x 10 to the minus 12 F/m</strong> (permittivity of free
                  space)
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  Polypropylene epsilonr approximately <strong>2.2</strong> (PFC capacitors)
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Unit confusion:</strong> mH to H (divide by 1000), microfarads to F
                  (divide by 10 to the 6), mWb to Wb (divide by 1000)
                </li>
                <li className="pl-1">
                  <strong>Over-correction:</strong> Leading power factor causes voltage rise,
                  damages equipment
                </li>
                <li className="pl-1">
                  <strong>Forgetting squared terms:</strong> Energy formulae have I squared or V
                  squared - doubling doubles energy by 4 times
                </li>
                <li className="pl-1">
                  <strong>Static discharge:</strong> Large capacitors retain charge - always verify
                  with meter before contact
                </li>
                <li className="pl-1">
                  <strong>Harmonic resonance:</strong> PFC capacitors can resonate with system
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Inductors generate voltage spikes when switched - use arc suppression
                </li>
                <li className="pl-1">
                  Capacitors store energy indefinitely - discharge through resistor before working
                </li>
                <li className="pl-1">
                  PFC capacitors have internal discharge resistors but may take minutes
                </li>
                <li className="pl-1">
                  Failed capacitors can explode - ensure adequate ventilation
                </li>
                <li className="pl-1">
