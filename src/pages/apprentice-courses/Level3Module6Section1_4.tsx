...
const DESCRIPTION =
  'Learn to incorporate safety principles, reliability requirements, and user-focused design into electrical installations following BS 7671 and best practice guidelines.';

const quickCheckQuestions = [
  {
    id: 'check-1',
    question:
      'What is the fundamental safety principle that underpins electrical installation design?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Protection against electric shock is the fundamental safety principle. BS 7671 requires both basic protection (preventing contact with live parts) and fault protection (limiting touch voltages and ensuring rapid disconnection during faults). All design decisions must support these protective measures.',
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      "N-1 redundancy means the system can continue operating normally if any single component (N) fails - there's always one backup (-1). This is common in critical installations where loss of power is unacceptable, achieved through duplicate supplies, transformers, or distribution paths.",
  },
  {
    id: 'check-3',
    ...
    correctIndex: 1,
    explanation:
      'Clear labelling and logical circuit arrangements improve safety by enabling correct identification during maintenance and emergencies, and improve usability by allowing users to quickly locate and operate controls. This is a requirement of BS 7671 and good design practice.',
  },
  {
    id: 'check-4',
    ...
    correctIndex: 2,
    explanation:
      'Maintainability requires adequate access for personnel and equipment, clearly identified isolation facilities for safe working, and documentation showing circuit arrangements. BS 7671 Regulation 132.12 requires consideration of maintenance needs. Poor access leads to unsafe shortcuts.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'BS 7671 defines basic protection (preventing contact with live parts during normal operation) and fault protection (limiting touch voltage and duration during fault conditions). Together these provide the required level of shock protection through complementary measures.',
  },
  {
    id: 2,
    question:
      'A hospital operating theatre requires continuous power supply. What design approach addresses this?',
    options: [
      'Use thicker cables',
    ...
    correctAnswer: 2,
    explanation:
      'Critical areas require redundancy and backup power. Dual supply feeds with automatic changeover provide resilience against supply failures. UPS systems bridge the gap during changeover and provide ride-through for transients. HTM 06-01 specifies detailed requirements for healthcare.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Discrimination (selectivity) ensures that only the protective device closest to a fault operates, isolating the faulty circuit while maintaining supply to all healthy circuits. This improves reliability by preventing nuisance outages and aids fault location. It requires coordinating device ratings and characteristics.',
  },
  {
    id: 4,
    question:
      'According to BS 7671, what is the maximum disconnection time for a 230V final circuit in a TN system?',
    options: ['5 seconds', '0.4 seconds', '1 second', '0.1 seconds'],
    correctAnswer: 1,
    explanation:
      'For final circuits not exceeding 63A in TN systems at 230V, BS 7671 Table 41.1 requires maximum 0.4 second disconnection time. This limits the duration of electric shock during fault conditions to a tolerable level. Longer times are only permitted for distribution circuits with specific conditions.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Distribution boards should be mounted at accessible height (typically 1350-1450mm to main switch), with circuits logically grouped (e.g., by floor or function), clearly labelled in durable format, and with circuit charts maintained. This aids both everyday use and emergency situations.',
  },
  {
    id: 7,
    question:
      'A design includes circuits for life safety systems (emergency lighting, fire alarms). What special consideration applies?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Life safety circuits require separate circuits (not sharing with other loads), often with fire-resistant cables (e.g., BS 8519), protection against inadvertent isolation, and in some cases maintenance of supply during fire conditions. BS 5266 and BS 5839 specify detailed requirements.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Isolation facilities enable circuits or equipment to be made dead and secured in that state for safe maintenance work. BS 7671 Part 5 requires appropriate devices for isolation, with means for securing off and proving dead. Inadequate isolation provision leads to dangerous live working.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Accessibility requirements (Building Regulations Part M, BS 8300) affect socket heights (400-1000mm), switch heights (750-1200mm), accessible light switches, contrasting colours for controls, and provision of visual and audible indicators. These requirements apply to all buildings except private dwellings.',
  },
  {
    id: 10,
    question:
      'What design approach provides resilience against single points of failure in a data centre?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Data centres use A+B power distribution with independent paths from source to load. Each server/equipment has dual power supplies connected to different feeds. If either A or B fails, the equipment continues operating on the remaining feed. This is combined with redundant UPS and generators.',
  },
  {
    id: 11,
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'In space-constrained situations, prioritise access to equipment requiring regular attention (distribution boards, isolators). Consider surface-mounted distribution boards for easier access than flush-mounted. Ensure minimum working spaces per BS 7671 are maintained. Document any compromises and their implications.',
  },
  {
    question: 'Should I design for future expansion?',
    answer:
      'Yes - within reasonable limits agreed with the client. Typically include 20-30% spare capacity in distribution boards, spare ways for circuits, and containment sized for additional cables. The cost of oversizing during initial installation is much less than retrofitting capacity later.',
  },
  {
    question: "What makes a circuit arrangement 'logical'?",
    answer:
      'Logical arrangement groups related circuits together (all lighting on one side, power on another; circuits by floor or area). Circuit numbering follows a clear sequence. Labels match circuit charts. Users can reasonably predict which device controls which circuit without needing the charts for everyday operation.',
  },
  {
    question: 'How does discrimination affect design?',
    answer:
      'Achieving discrimination may require larger upstream protective devices (higher rated MCBs), time-delayed RCDs at origin with 30mA downstream, or MCCBs with adjustable settings. The protective device schedules should show that discrimination has been considered and identify any cases where it cannot be achieved.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Safety:</strong> Basic + fault protection throughout
              </li>
              <li>
                <strong>Reliability:</strong> Redundancy, discrimination, quality
              </li>
              <li>
                <strong>Usability:</strong> Logical layout, clear labelling, access
              </li>
              <li>
                <strong>Maintainability:</strong> Isolation, space, documentation
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>BS 7671:</strong> Mandatory safety requirements
              </li>
              <li>
                <strong>Discrimination:</strong> Fault isolation to affected circuit
              </li>
              <li>
                <strong>Accessibility:</strong> Building Regs Part M compliance
              </li>
              <li>
                <strong>CDM:</strong> Design for safe maintenance
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Safety is not an add-on to electrical design - it is the foundation upon which all
              other considerations rest. BS 7671 establishes the fundamental requirements for
              protection against electric shock, thermal effects, overcurrent, fault currents, and
              overvoltage. Every design decision must be evaluated against its impact on these
              protective measures.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                BS 7671 Protection Requirements:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Basic protection:</strong> Insulation of live parts, barriers and
                  enclosures (IP2X or IPXXB minimum)
                </li>
                <li>
                  <strong>Fault protection:</strong> Automatic disconnection of supply within
                  required times (0.4s for final circuits)
                </li>
                <li>
                  <strong>Additional protection:</strong> RCDs not exceeding 30mA for socket-outlets
                  and other specified circuits
                </li>
                <li>
                  <strong>Protection against thermal effects:</strong> Preventing ignition, burns,
                  and fire
                </li>
                <li>
                  <strong>Protection against overcurrent:</strong> Correctly rated fuses and MCBs
                </li>
              </ul>
            </div>

            <p>
              The designer must ensure that these protections work together as a complete system.
              Individual components may be correctly specified, but if they don't coordinate
              properly - for example, if a cable isn't protected by its associated MCB - the
              installation is unsafe. This is why design calculations proving coordination are
              essential.
            </p>

            <p className="text-sm text-elec-yellow/70">
              <strong>Design Principle:</strong> Every circuit must be verified to meet BS 7671
              requirements for shock protection (Zs values), thermal protection (adiabatic
              equation), and overcurrent protection (I²t characteristics). Never assume compliance -
              calculate and prove it.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Reliability in electrical design means the installation performs its intended function
              consistently over its service life, with minimal unplanned outages. While no
              installation is immune to failure, good design minimises the probability of failure
              and limits the impact when failures do occur.
            </p>
            ...
            <p>
              Discrimination ensures that faults are isolated at the nearest protective device,
              maintaining supply to healthy circuits. This requires careful coordination of
              protective device characteristics - time-current curves must not overlap in the fault
              current region. Manufacturers' data and software tools assist with discrimination
              studies.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A well-designed installation is intuitive to use. Users should be able to operate
              switches and controls without confusion, locate circuit protection when needed, and
              understand the basic arrangement of the system. Building Regulations Part M and BS
              8300 add specific requirements for accessibility by people with disabilities.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Accessibility Requirements (Part M / BS 8300):
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Socket outlets:</strong> 400mm to 1000mm above floor level
                </li>
                <li>
                  <strong>Light switches:</strong> 750mm to 1200mm above floor level
                </li>
                <li>
                  <strong>Controls:</strong> Operable with closed fist, contrasting colours
                </li>
                <li>
                  <strong>Visual indicators:</strong> Large, contrasting, and appropriately
                  positioned
                </li>
                <li>
                  <strong>Audible devices:</strong> Consider hearing loop interfaces
                </li>
              </ul>
            </div>

            <p>
              Beyond minimum regulatory requirements, good design considers the end users.
              Distribution boards should be at comfortable height with clear sightlines to circuit
              labels. Switches should be positioned at entry points where users naturally reach for
              them. Labelling should be durable and use plain language that non-electricians
              understand.
            </p>

            <p className="text-sm text-elec-yellow/70">
              <strong>Usability Tip:</strong> Circuit labels should describe what the circuit
              controls, not just its number. "Kitchen Sockets" is more useful than "Circuit 7" when
              someone is trying to reset a tripped breaker without access to the circuit chart.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              CDM Regulations place duties on designers to consider how their designs will be safely
              maintained during use. Electrical installations require periodic inspection and
              testing, component replacement, and occasionally fault finding. The design should
              facilitate these activities safely and efficiently.
            </p>
            ...
            <p>
              Consider the maintenance operative's perspective: Can they reach the distribution
              board without a ladder? Is there enough space to open the enclosure and work safely?
              Can circuits be isolated individually without affecting critical services? These
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Inadequate access</strong> - Distribution boards behind doors or furniture
                </li>
                <li>
                  <strong>Poor labelling</strong> - Labels that fade, fall off, or use cryptic codes
                </li>
                <li>
                  <strong>No spare capacity</strong> - Full boards that cannot accommodate any
                  additions
                </li>
              </ul>
            </div>
