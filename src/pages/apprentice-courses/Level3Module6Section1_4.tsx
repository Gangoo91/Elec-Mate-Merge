      ...
      <div className="border-b border-white/10 sticky top-0 z-50 bg-[#1a1a1a]/95 backdrop-blur-sm">
        <div className="px-4 sm:px-6 py-2">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module6-section1">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3">
            Designing for Safety, Reliability, and Usability
          </h1>
          <p className="text-white/80">
            Incorporating fundamental design principles into electrical installations
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Apply fundamental safety principles to design",
              "Incorporate reliability through redundancy and discrimination",
              "Design for user accessibility and understanding",
              "Consider maintenance requirements in design decisions",
              "Balance competing requirements effectively",
              "Meet regulatory requirements for accessibility"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module6-section1-3">
              <ArrowLeft className="w-4 h-4 mr-2" />
          ...
          <Button
            ...
            asChild
          >
            <Link to="../level3-module6-section1-5">
