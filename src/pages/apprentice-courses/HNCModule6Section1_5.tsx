...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['50 kW', '150 kW', '25 kW', '100 kW'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['80 lm/W', '50 lm/W', '95 lm/W', '60 lm/W'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['1.6 W/(l/s)', '1.8 W/(l/s)', '2.2 W/(l/s)', '2.0 W/(l/s)'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['All heated spaces', 'At least 90%', 'Only spaces over 50 m²', 'At least 80%'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The two Compliance Guides (DBSCG and NDBSCG) are the practical reference — they
              translate the headline Part L principle into specific minimum efficiencies for every
              plant type, controls schedule and metering provision. Building Control will check
              installed plant against the relevant Guide table; non-compliant plant cannot be
              installed without offsetting measures.
            </>
          }
        ...
        <ConceptBlock title="Heating System Efficiencies">
          ...
          <p>
            <strong>Boiler Efficiency Requirements:</strong>
          </p>
          ...
          <p>
            <strong>Heat Pump Performance Standards</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Air Source Heat Pump (ASHP):</strong> 2.8 — 55°C design flow
            </li>
            <li>
              <strong>Ground Source Heat Pump (GSHP):</strong> 3.0 — 55°C design flow
            </li>
            <li>
              <strong>Water Source Heat Pump (WSHP):</strong> 3.0 — 55°C design flow
            </li>
            <li>
              <strong>Exhaust Air Heat Pump:</strong> 2.5 — 55°C design flow
            </li>
          </ul>
          <p>
            <strong>Understanding SCOP</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Design consideration:</strong> Heat pump efficiency is highly dependent on flow
            temperature. Design for the lowest practical flow temperature to maximise SCOP.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Lighting Efficacy and Controls">
          <p>
            Part L sets minimum luminaire efficacy requirements and mandates automatic controls for
            lighting in non-domestic buildings. These requirements significantly reduce energy
            consumption from lighting, which typically represents 20-40% of building energy use.
          </p>
          <p>
            <strong>General Lighting</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Display Lighting</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Mandatory Lighting Controls</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Offices:</strong> Presence/absence, daylight dimming — Zone control per 6 m
              window depth
            </li>
            <li>
              <strong>Circulation areas:</strong> Presence detection, time scheduling — Maintained
              illuminance when unoccupied
            </li>
            <li>
              <strong>Toilets/ancillary:</strong> Absence detection — Auto-off after vacancy
            </li>
            <li>
              <strong>Retail:</strong> Time scheduling, zone control — Separate display lighting
              circuits
            </li>
            <li>
              <strong>External lighting:</strong> Daylight sensing, time control — Dimming for
              overnight period
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="HVAC System Requirements">
          <p>
            ...
            efficiency, ventilation system fan power, heat recovery effectiveness, and comprehensive
            controls. These requirements ensure building services systems operate at optimum
            efficiency.
          </p>
          <p>
            <strong>Specific Fan Power (SFP) Limits</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Extract only:</strong> 0.5 W/(l/s)
            </li>
            <li>
              <strong>Supply only:</strong> 1.1 W/(l/s)
            </li>
            <li>
              <strong>Supply and extract:</strong> 1.8 W/(l/s)
            </li>
            <li>
              <strong>With heating/cooling:</strong> 2.0 W/(l/s)
            </li>
            <li>
              <strong>All air units:</strong> 2.2 W/(l/s)
            </li>
          </ul>
          <p>
            <strong>Cooling System Efficiency (Minimum EER/SEER)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>HVAC Controls Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Wet heating systems:</strong> Weather compensation, room stat, TRVs — Optimum
              start/stop, night setback
            </li>
            <li>
              <strong>Warm air heating:</strong> Room thermostat, time control — Zone dampers for
              areas &gt;150 m²
            </li>
            <li>
              <strong>Cooling systems:</strong> Zone control, time scheduling — Interlock with
              heating, free cooling
            </li>
            <li>
              <strong>Ventilation:</strong> Variable speed drives, CO₂ control — Heat recovery
              bypass for summer
            </li>
            <li>
              <strong>Heat recovery:</strong> Minimum 73% efficiency, bypass — Frost protection,
              summer bypass
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Metering and Commissioning">
          <p>
            Part L requires comprehensive metering to enable energy monitoring and management, plus
            detailed commissioning to ensure systems operate at design efficiency. Both requirements
            are essential for achieving real-world energy performance.
          </p>
          <p>
            <strong>Metering Requirements</strong>
          </p>
          <p>
            <strong>Systems &gt;50 kW Output</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Systems &gt;100 kW Output</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Heating:</strong> Flow rates, temperatures, control response — BSRIA BG 2
              commissioning records
            </li>
            <li>
              <strong>Cooling:</strong> Capacity verification, EER measurement — Manufacturer
              commissioning sheets
            </li>
            <li>
              <strong>Ventilation:</strong> Air flow rates, SFP measurement — CIBSE TM50 testing
              records
            </li>
            <li>
              <strong>Lighting:</strong> Lux levels, control function testing — SLL commissioning
              sheets
            </li>
            <li>
              <strong>BMS/Controls:</strong> Setpoints, sequences, alarms — Point-to-point testing
              schedules
            </li>
          </ul>
          <p>
            <strong>Building Log Book Requirements</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Timing requirement:</strong> Commissioning must be complete before the building
            is occupied or any fixed building services are used. The commissioning certificate must
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Verify all heating equipment meets minimum efficiency (92% boilers, SCOP 2.8/3.0 heat
              pumps)
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Heat pump flow temperatures:</strong> Designing for high flow temps reduces
              SCOP below compliance
            </li>
            <li>
            ...
            <li>
              <strong>Lighting controls:</strong> Omitting daylight dimming or presence detection
            </li>
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You designed a Cat A office to a LENI of 22 kWh/m²/year using high-efficacy LED panels
              at 130 lm/cW. Under value engineering, the contractor substituted cheaper panels at 95
              lm/cW. SBEM re-run shows LENI now at 32, the BER exceeds TER and the building fails
              Part L.
            </>
          }
          whatToDo={
            <>
              You have three choices: (1) reverse the substitution and reinstate the specified
              luminaires; (2) compensate with enhanced controls — DALI scenes, daylight harvesting
              at every perimeter, occupancy-based scene reduction — and re-model in SBEM; (3)
              compensate elsewhere in the design (e.g. higher heat-pump SCOP, additional rooftop
              PV). Option 1 is cheapest if caught early; option 3 typically the most expensive.
              Reject the substitution at submittal stage rather than at SBEM stage.
            </>
          }
          whyItMatters={
            <>
              Lighting is the most common Part L failure point in non-domestic buildings because
              efficacy degrades quickly as you slide down the price list. The M&E designer must hold
              the line on luminaire specification at value engineering — every 10 lm/cW lost on
              average drives a measurable LENI penalty.
            </>
          }
        />
