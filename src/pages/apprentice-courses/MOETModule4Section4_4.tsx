/**
 * MOET · Module 4 · Section 4 · Subsection 4 — Use of Approved Spare Parts
 *
...
const MOETModule4Section4_4 = () => {
  ...
  return (
    <HubPage ground="reading">
      <HubMasthead
        section="Module 4 · Section 4.4 · Subsection 4"
      ...
      <HubBody pushContext="Get notified about your course progress, quiz streaks and new study content">
        <StudyPage>
          ...
          <TLDR
            points={[
              'OEM preferred: guaranteed compatibility and warranty retention.',
              'Third-party: acceptable if specifications are verified and matched.',
              'Obsolescence: monitor lifecycle, plan a last-time buy, plan alternatives.',
              'Traceability: full chain from manufacturer to installation.',
            ]}
          />
          ...
          <ConceptBlock title="Key principles">
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              ...
              <li>
                <strong>Stock management:</strong> FIFO rotation, reorder points, storage
                conditions.
              </li>
              <li>
          ...
          <ContentEyebrow>OEM vs third-party spare parts</ContentEyebrow>

          <ConceptBlock title="OEM vs third-party spare parts">
            <p>
          ...
          <ConceptBlock title="OEM vs third-party comparison">
            <div className="overflow-x-auto">
              <table className="w-full text-left text-[13.5px]">
                <thead>
                  <tr className="border-b border-white/10">
                    <th className="py-2 pr-4 font-medium text-white">Factor</th>
                    <th className="py-2 pr-4 font-medium text-white">OEM</th>
                    <th className="py-2 font-medium text-white">Third-party</th>
                  </tr>
                </thead>
                <tbody className="text-white">
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4 font-medium">Specification match</td>
                    <td className="py-2 pr-4">Guaranteed exact match</td>
                    <td className="py-2">Must be verified by the user</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4 font-medium">Warranty</td>
                    <td className="py-2 pr-4">Maintains equipment warranty</td>
                    <td className="py-2">May void equipment warranty</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4 font-medium">Cost</td>
                    <td className="py-2 pr-4">Generally higher</td>
                    <td className="py-2">Generally lower</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4 font-medium">Lead time</td>
                    <td className="py-2 pr-4">Can be longer (specialist items)</td>
                    <td className="py-2">Often shorter (wider availability)</td>
                  </tr>
                  <tr className="border-b border-white/5">
                    <td className="py-2 pr-4 font-medium">Quality assurance</td>
                    <td className="py-2 pr-4">Manufacturer&apos;s QA system</td>
                    <td className="py-2">Must be independently verified</td>
                  </tr>
                  <tr>
                    <td className="py-2 pr-4 font-medium">Counterfeit risk</td>
                    <td className="py-2 pr-4">Low (via authorised channels)</td>
                    <td className="py-2">Higher (especially from unfamiliar sources)</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <CommonMistake
            title="Counterfeit components warning"
            whatHappens={
              <>
            ...
            doInstead={
              <>
                Always source components from authorised distributors and be suspicious of prices
                significantly below market norms. Report suspected counterfeit products to the
                manufacturer and Trading Standards.
              </>
            }
          />
          ...
          <ContentEyebrow>Specifications matching and quality assurance</ContentEyebrow>

          <ConceptBlock title="Specifications matching and quality assurance">
            <p>
          ...
          <ConceptBlock title="Specifications to match">
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
          ...
          <ConceptBlock title="Incoming quality assurance checklist">
            <ol className="list-decimal space-y-2 pl-5 marker:text-elec-yellow/70">
              <li>Verify part number matches the purchase order and specification.</li>
              <li>Inspect packaging for damage, tampering or signs of being opened.</li>
              <li>Check quantity matches the order.</li>
              <li>Verify markings: UKCA/CE, part number, date code, batch number.</li>
              <li>Review certificate of conformity (if supplied).</li>
              <li>Visual inspection of the component for physical damage or defects.</li>
              <li>Compare physical characteristics with the datasheet.</li>
              <li>Record in the CMMS with all identification details.</li>
            </ol>
          </ConceptBlock>
          ...
          <ContentEyebrow>Obsolescence management</ContentEyebrow>

          <ConceptBlock title="Obsolescence management">
            <p>
          ...
          <ConceptBlock title="Obsolescence management strategy">
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
                <strong>Monitor:</strong> subscribe to manufacturer end-of-life (EOL) notifications,
                monitor product lifecycle stages (active, mature, last-order, obsolete).
              </li>
              <li>
                <strong>Assess:</strong> when an EOL notice is received, assess the impact — how
                many of the component are installed, what is the failure rate, what is the remaining
                equipment life?
              </li>
              <li>
              ...
              <li>
                <strong>Implement:</strong> transition to the alternative component through planned
                replacement or next-failure replacement.
              </li>
              <li>
            ...
            <p>
              ...
              performance, better energy efficiency, enhanced diagnostics and predictive maintenance
              capabilities. A planned technology refresh can be more cost-effective than managing
              obsolescence for ageing equipment — particularly when spare parts become scarce and
          ...
          <ContentEyebrow>Critical spares, stock and warranty</ContentEyebrow>

          <ConceptBlock title="Critical spares holding, stock management and warranty">
            <p>
          ...
          <ConceptBlock title="Critical spares analysis matrix">
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
          ...
          <ConceptBlock title="Stock management best practice">
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                <strong>Reorder point:</strong> defined minimum stock level that triggers a reorder
                — set based on lead time and usage rate.
              </li>
              <li>
                <strong>Storage conditions:</strong> clean, dry, temperature-controlled environment.
                Anti-static storage for electronic components. Protection from dust, moisture and
                UV.
              </li>
              <li>
                <strong>Labelling:</strong> clear identification with part number, description, date
                received, shelf-life date and storage location.
              </li>
              <li>
          ...
          <ConceptBlock title="Warranty considerations">
            <ul className="list-disc space-y-1.5 pl-5 marker:text-elec-yellow/70">
              <li>
              ...
              <li>
                <strong>Authorised personnel:</strong> some warranties require repairs to be carried
                out by manufacturer-trained personnel.
              </li>
              <li>
          ...
          <Bleed>
            <div className="grid grid-cols-2 gap-3 pt-2">
              ...
              <button
                onClick={() => navigate('/study-centre/apprentice/m-o-e-t-module4-section4-5')}
