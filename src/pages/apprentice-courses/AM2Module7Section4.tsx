    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The AM2 is designed to test competence, not trick candidates. Yet many apprentices fail
          because of the same avoidable mistakes: rushing, skipping steps, poor paperwork, or
          guessing. If you know what the common pitfalls are, you can prepare for them and make sure
          you don't fall into the same traps.
        </p>
        ...
        <ConceptBlock title="Most Failures Are Avoidable">
          <p>
            ...
            errors are predictable and preventable. Know the pitfalls, prepare for them, and you'll
            avoid the traps that catch many candidates.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Safe Isolation Mistakes">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-red-400/70">
            ...
            <li>
              <strong>Using wrong tester</strong> (multimeter instead of two-pole voltage indicator)
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-yellow-400/70">
            ...
            <li>
              <strong>Overconfidence</strong> — assuming circuit is dead without proper verification
            </li>
            <li>
        ...
        <ConceptBlock title="Installation Mistakes">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-red-400/70">
            ...
            <li>
              <strong>Not labelling circuits</strong> in distribution board — identification failure
            </li>
            <li>
        ...
        <ConceptBlock title="Inspection & Testing Mistakes">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
            ...
            <li>
              <strong>Writing unrealistic values</strong> ("0 ohms" Zs, "infinity" IR, "999 MOhms")
            </li>
            <li>
        ...
        <ConceptBlock title="Real-world Examples">
          <p>
            <strong className="text-red-400">Example 1.</strong> Candidate skipped re-prove in safe
            isolation procedure — assessor stopped exam immediately — automatic fail.
          </p>
          <p>
          ...
          <p>
            ...
            instead of explaining specific rectification action — lost fault-finding marks for poor
            documentation.
          </p>
          <p>
            <strong className="text-blue-400">Example 4.</strong> Candidate misread "minimum IR" and
            answered with recommended value instead of required minimum — lost marks in knowledge
            test.
          </p>
          <p>
        ...
        <ConceptBlock title="Frequently Asked Questions">
          ...
          <p>
            <strong>Q2: Do assessors allow small errors?</strong> Some workmanship issues lose marks
            but don't cause failure. However, safety errors cause instant fail regardless of size.
          </p>
          <p>
            <strong>Q3: Can I pass if I make one or two minor mistakes?</strong> Yes — but repeated
            small errors will drag your score down. The key is avoiding patterns of careless
            mistakes.
          </p>
          <p>
            <strong>Q4: Is paperwork as important as installation work?</strong> Yes — incomplete or
            inaccurate paperwork loses many marks. Documentation is part of professional electrical
            work.
          </p>
          <p>
            <strong>Q5: What's the biggest single avoidable mistake?</strong> Not following the safe
            isolation procedure fully and correctly. This alone causes more failures than any other
            single error.
          </p>
          <p>
            <strong>Q6: Should I tell the assessor if I make a mistake?</strong> Yes — honesty and
            immediate correction show professionalism and safety awareness. It's better than trying
            to hide errors.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              conductors, copper proud of the terminal, screws not tightened to torque — all breach
              526.1. Slow down on terminations and you avoid one of the most common AM2 mistakes.
            </>
          }
        ...
        <Quiz questions={quizQuestions} title="Test Your Knowledge: Avoiding Common AM2 Mistakes" />
