...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['3-12 months', '1 month', '5 years', '1 week'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['50% signal', 'Maximum signal (100%)', 'Pulsed signal', 'No signal (0%)'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Point-to-point verification, functional performance testing, graphics testing, and system
          integration checks.
        </p>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Code C is the technical reference for BMS commissioning. The cause-and-effect schedule
              is the heart of functional testing — every sequence stated, every condition tested. A
              BMS commissioned without C-style discipline will work in default state but fail
              unpredictably under control sequences.
            </>
          }
        ...
        <ConceptBlock title="Point-to-Point Verification">
          <p>
            ...
            process confirms that every field device is correctly wired to its designated controller
            input or output, with accurate signal conditioning and engineering unit scaling.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>PT100/PT1000 RTD:</strong> Use decade box or reference probe — Reading within
              ±0.5°C
            </li>
            <li>
        ...
        <ConceptBlock title="Actuator Testing and Control Sequence Verification">
          ...
          <p>
            <strong>
              Functional performance test — AHU example. For an air handling unit, test the
              following sequences in order:
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Safety interlocks:</strong> Fire alarm input, smoke detection, filter DP trip
            </li>
            <li>
        ...
        <ConceptBlock title="Graphics Testing and Alarm Verification">
          <p>
            The BMS graphical interface is the operator's primary interaction with building systems.
            Graphics testing ensures accurate display of system status, while alarm testing verifies
            that abnormal conditions are detected and communicated appropriately.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>High/low limit:</strong> Adjust setpoint or simulate value — Alarm at correct
              threshold
            </li>
            <li>
          ...
          <p>
            <strong>Best practice:</strong> Involve the building operator in graphics testing. Their
            feedback on usability is invaluable for optimising the interface.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Trend Logging and System Integration">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Storage capacity:</strong> Calculate required storage, verify archival process
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>BACnet IP/MSTP:</strong> Primary BMS network — Device discovery, point mapping
            </li>
            <li>
              <strong>Modbus TCP/RTU:</strong> Meters, VFDs, chillers — Register addresses, scaling
              factors
            </li>
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Example 2 — Actuator stroke test:</strong> Test a heating valve actuator (spring
            return, fail closed) with 0-10V position feedback.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              A new commercial building handover. BMS commissioned standalone, fire alarm
              commissioned standalone, integration "to be done at site" but never properly executed.
              Six weeks after handover, a fire alarm activation fails to shut down the supply AHUs.
              Investigation: the BMS does not act on the fire alarm signal — the integration was
              never tested.
            </>
          }
          whatToDo={
            <>
              Integration testing is mandatory before handover. The cause-and-effect schedule lists
              every interface: fire→AHU shutdown, fire→damper close, fire→lift recall,
              security→access lock, BMS→meter→main. Test each combination. Witness with the client.
              Document the result. Any failure prevents handover. Update commissioning programme to
              allow time — typically 1–2 weeks for integration testing on a commercial building,
              longer on a hospital.
            </>
          }
          whyItMatters={
            <>
              Integration is where commissioning lives or dies. A standalone-commissioned BMS may
              pass its own tests but fail in service when the building behaves as a system.
              Integration testing is what proves the building works as designed, not just that the
