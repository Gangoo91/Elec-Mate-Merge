      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Systematic techniques for diagnosing and locating electrical faults
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Apply the half-split method for fault location",
              "Gather relevant information before investigating",
              "Identify common fault types and their symptoms",
              "Use appropriate test equipment for diagnosis",
              "Work safely during fault investigation",
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="../level3-module5-section6-6-3">
