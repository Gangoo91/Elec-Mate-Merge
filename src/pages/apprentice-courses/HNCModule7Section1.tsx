    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-base text-muted-foreground mb-12">
          This section covers the design of LV distribution systems, from incoming supply through
          switchgear, busbars and cables to final circuits. You'll learn about equipment selection,
          cable sizing, discrimination studies and power quality management for commercial
