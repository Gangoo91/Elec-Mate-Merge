...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['S ≥ I²t', 'I²t ≥ k²S²', 'k ≥ I²t', 'k²S² ≥ I²t'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['2,116 A²s', '460 A²s', '1,840 A²s', '211,600 A²s'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Time halves', 'Time quadruples', 'Time remains the same', 'Time doubles'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['4mm² and above', '2.5mm² and above', '1.5mm² and above', '6mm² and above'],
    correctAnswer: 2,
    explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/h-n-c-module4-section2"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 434.5.2 is the regulatory anchor for the adiabatic check. The protective device
              must clear the prospective fault current quickly enough that the cable does not exceed
              its limiting temperature. The standard formula t ≤ k²S² / I² lives inside Reg 434.5.2
              itself — verifying it is mandatory for any non-trivial circuit, especially long cable
              runs and reduced-CSA CPCs where fault current is modest but disconnection time
              stretches.
            </>
          }
        ...
        <ConceptBlock title="The Adiabatic Equation">
          ...
          <p>
            <strong>Why 'adiabatic'?</strong> The term 'adiabatic' means no heat transfer. During a
            very short fault (typically &lt;5 seconds), the heating is so rapid that heat doesn't
            have time to dissipate from the conductor — it's all absorbed by the conductor itself.
            This is the worst-case thermal scenario.
          </p>
          <p>
            <strong>BS 7671 Regulation 434.5.2:</strong> "The characteristics of protective devices
            protecting a conductor against fault current shall be such that the energy let through
            (I²t) does not exceed that which the conductor can withstand (k²S²)."
          </p>
          <p>
        ...
        <ConceptBlock title="k Values and Thermal Constants">
          ...
          <p>
            <strong>
              k values from BS 7671 Table 43.1 (conductor / insulation / k / max temp °C):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Let-Through Energy (I²t)">
          ...
          <p>
            <strong>I²t calculation:</strong> I²t = I² × t, where I = RMS fault current (A) and t =
            disconnection time (s).
          </p>
          <p>
            <strong>
              Typical I²t values by device type (device / rating / I²t A²s / min cable Cu/PVC):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Protective Device Coordination">
          ...
          <p>
            <strong>Example verification:</strong> 32A MCB Type B protecting 4mm² Cu/PVC cable; PSCC
            at origin: 6kA; MCB I²t at 6kA (from data): 35,000 A²s; cable k²S² = 115² × 4² ={' '}
            <strong>211,600 A²s</strong>; check: 211,600 ≥ 35,000 — cable adequately protected.
          </p>
          <p>
            <strong>High fault level warning:</strong> Near main switchboards, PSCC can exceed 20kA.
            At these levels:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Maximum disconnection time check:</strong> Alternatively, calculate the maximum
            time the cable can withstand a given fault current — t<sub>max</sub> = k²S² / I². The
            protective device must operate within this time at the given fault current.
          </p>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — minimum cable size for MCB:</strong> An MCB has I²t = 45,000 A²s.
            What is the minimum Cu/PVC cable size?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Using S = √(I²t) / k</li>
            <li>S = √(45,000) / 115</li>
          ...
          <p>
            <strong>Example 2 — maximum fault time:</strong> A 6mm² Cu/XLPE cable experiences a 5kA
            fault. What is the maximum permissible disconnection time?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              A 70&nbsp;m sub-main runs from the main switchpanel to a remote DB. Live conductors
              are 50&nbsp;mm² Cu/XLPE. The CPC has been reduced to 25&nbsp;mm² Cu (Table 54.7
              permits half-size CPC for 50&nbsp;mm² lives). Prospective earth-fault current at the
              DB calculated as 1.8&nbsp;kA. The 100&nbsp;A MCB upstream has a Type C characteristic
              with a 0.4&nbsp;s disconnection time at this fault level.
            </>
          }
          whatToDo={
            <>
              Apply Reg 434.5.2 adiabatic check on the 25&nbsp;mm² CPC: t = k²S² / I² = (143² × 25²)
              / 1800² = (20,449 × 625) / 3,240,000 ≈ 3.94&nbsp;s. The MCB clears in 0.4&nbsp;s, so
              the CPC withstand (3.94&nbsp;s) easily exceeds the disconnection time. Pass. If the
              fault current dropped (longer cable, higher Z_s), recompute — the adiabatic check
              passes or fails on the prospective fault current that the cable actually sees at its
              origin. Document on the cable schedule.
            </>
          }
          whyItMatters={
            <>
              Reduced CPCs (Table 54.7) are common but they are the cable element most likely to
              fail an adiabatic check on long runs with modest fault currents. Reg 434.5.2 makes the
              check mandatory. A failed check means upsizing the CPC or accepting a faster device —
              never just hoping it clears in time.
            </>
          }
        />
