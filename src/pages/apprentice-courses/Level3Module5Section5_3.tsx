      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Recording the detailed evidence that supports your certification
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Complete the schedule of inspections systematically",
              "Record test results accurately with correct units",
              "Document multiple circuits and distribution boards",
              "Use standard symbols and abbreviations correctly",
              "Link schedules to the Electrical Installation Certificate",
              "Provide comprehensive records for future reference"
            ].map((item, i) => (
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="../level3-module5-section5-5-4">
