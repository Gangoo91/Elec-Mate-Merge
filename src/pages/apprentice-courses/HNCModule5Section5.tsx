    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Plan and execute commissioning activities and handover procedures for building services
          systems
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the commissioning and handover process for building services
          installations - from initial planning through electrical and mechanical commissioning, BMS
          testing, witness procedures and final documentation delivery.
        </p>
