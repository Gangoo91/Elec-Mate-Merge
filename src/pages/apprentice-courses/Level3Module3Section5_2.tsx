...
const DESCRIPTION =
  'Master efficiency calculations and understand electrical losses in motors, transformers and cables for City & Guilds Level 3.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Efficiency = Output / Input x 100% = 7.5 / 9 x 100 = 83.3%. The remaining 16.7% is lost as heat.',
  },
  {
    id: 'qc2',
    ...
    correctIndex: 1,
    explanation:
      'Copper losses are the I squared R losses in the transformer windings. They are load-dependent and increase with the square of the current.',
  },
  {
    id: 'qc3',
    ...
    correctIndex: 2,
    explanation:
      'Iron losses (core losses) occur due to the magnetising of the core and are constant as long as the transformer is energised, regardless of load.',
  },
  {
    id: 'qc4',
    question:
      'A cable has 2% power loss. If 10 kW is delivered to the load, what was the input power?',
    options: ['10.2 kW', '10.4 kW', '10.204 kW', '9.8 kW'],
    correctIndex: 2,
    explanation:
      'If 2% is lost, 98% reaches the load. Input = Output / 0.98 = 10 / 0.98 = 10.204 kW.',
  },
];
...
const quizQuestions = [
  {
    ...
    explanation:
      'Efficiency = (Useful Output Power / Input Power) x 100%. This gives the percentage of input power that becomes useful output.',
  },
  {
    id: 'q2',
    question:
      'A transformer has 500 W iron losses and 300 W copper losses at full load. Total losses are:',
    options: ['200 W', '800 W', '500 W', '1500 W'],
    correctAnswer: '800 W',
    explanation:
      'Total losses = Iron losses + Copper losses = 500 + 300 = 800 W. Iron losses are constant; copper losses vary with load.',
  },
  {
    id: 'q3',
    ...
    explanation:
      'Input = Output / Efficiency = 11 / 0.85 = 12.94 kW. The motor draws more power than it outputs due to losses.',
  },
  {
    id: 'q4',
    ...
    explanation:
      'Laminations break up the paths for eddy currents, reducing these losses. Each thin lamination is insulated from the next.',
  },
  {
    id: 'q5',
    ...
    explanation:
      'Mathematically, maximum efficiency occurs when variable losses (copper) equal fixed losses (iron). This typically occurs around 50-75% load.',
  },
  {
    id: 'q6',
  ...
  },
  {
    ...
    options: [
      ...
      'Changing magnetic domains in core',
      'Circulating currents in core',
      'Leakage flux',
    ],
    correctAnswer: 'Changing magnetic domains in core',
    explanation:
      'Hysteresis losses occur because energy is needed to repeatedly magnetise and demagnetise the core material as the AC field changes direction.',
  },
  {
    id: 'q8',
    ...
    explanation:
      'IE3 is premium efficiency under IEC 60034-30. IE1 is standard, IE2 is high, IE3 is premium, and IE4 is super premium.',
  },
  {
    id: 'q9',
    ...
    explanation:
      'Cable losses follow P = I squared x R, so they increase with the square of the current. Doubling current quadruples losses.',
  },
  {
    id: 'q10',
    ...
    correctAnswer: '81%',
    explanation:
      'Overall efficiency = 0.9 x 0.9 = 0.81 = 81%. Efficiencies multiply for series stages, always giving a lower result.',
  },
  {
    id: 'q11',
    ...
    options: [
      'Winding resistance',
      'Bearing friction',
      'Leakage flux and harmonic currents',
      'Ventilation fan',
    ],
    correctAnswer: 'Leakage flux and harmonic currents',
    explanation:
      'Stray losses include losses from leakage flux, harmonic currents, and other effects not accounted for in main iron and copper losses.',
  },
  {
    id: 'q12',
    ...
    explanation:
      'Input = 50 / 0.97 = 51.55 kW. Losses = 51.55 - 50 = 1.55 kW. Alternatively: Losses = Input x (1 - efficiency).',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Iron losses (core losses) occur in the magnetic core due to hysteresis and eddy currents - they are constant whenever the equipment is energised. Copper losses (I squared R losses) occur in the windings due to their resistance - they increase with the square of the current and are therefore load-dependent. Total losses = iron losses + copper losses.',
  },
  {
    question: 'Why does efficiency matter for electrical equipment?',
    answer:
      'Efficiency affects running costs, heat generation, and environmental impact. A 1% efficiency improvement on a large motor can save thousands of pounds annually. Heat from losses must be dissipated, affecting cooling requirements. EU regulations (Ecodesign) mandate minimum motor efficiencies (IE3/IE4) for environmental reasons.',
  },
  {
    question: 'How do I calculate the running cost of inefficient equipment?',
    answer:
      'Extra cost = Power x Hours x Rate x (1/efficiency_old - 1/efficiency_new). For example, replacing an 85% efficient motor with 92% efficient: for 10 kW output, 8000 hours/year, 15p/kWh: Annual saving = 10 x 8000 x 0.15 x (1/0.85 - 1/0.92) = 12000 x (1.176 - 1.087) = 1068 pounds per year.',
  },
  {
    question: 'What are the main sources of loss in electric motors?',
    answer:
      'Motor losses include: Stator copper losses (I squared R in stator windings), Rotor copper losses (I squared R in rotor), Iron losses (hysteresis and eddy current in core), Mechanical losses (bearing friction, windage), and Stray losses (leakage flux effects). Larger motors typically have higher efficiency as fixed losses become proportionally smaller.',
  },
  {
    question: 'How does load affect transformer efficiency?',
    answer:
      'Transformer efficiency varies with load. Iron losses are constant, but copper losses increase with load squared. Maximum efficiency occurs when copper losses equal iron losses (typically 50-75% load). At light loads, iron losses dominate; at heavy loads, copper losses dominate. This is why transformers are sized to operate near their optimal efficiency point.',
  },
  {
    question: 'What is the significance of motor efficiency classes IE1 to IE4?',
    answer:
      'IEC 60034-30 defines motor efficiency classes: IE1 (Standard), IE2 (High), IE3 (Premium), IE4 (Super Premium). EU Ecodesign regulations require IE3 minimum for most industrial motors. IE4 motors offer typically 1-2% higher efficiency than IE3, providing significant lifetime savings on large continuously running motors. Payback period depends on running hours and electricity costs.',
  },
];
              ...
              <div>
                ...
                <ul className="space-y-2 text-white">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Calculate electrical efficiency for motors, transformers and systems
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 shrink-0" />
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-white leading-relaxed">
              ...
              calculations, and meeting regulatory requirements.
            </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-blue-500/10 rounded-lg border border-blue-500/20">
                    ...
                    <ul className="text-white text-sm space-y-1">
                      ...
                      <li>
                        <strong>Eddy currents:</strong> Circulating currents induced in the core
                      </li>
                    </ul>
                  </div>
                    ...
                    <div className="p-3 bg-white/5 rounded-lg">
                      ...
                      <div className="text-sm text-white space-y-1">
                        ...
                        <p className="text-green-400 font-medium mt-2">
                          Annual saving: 397 pounds - payback in 1-2 years
                        </p>
                      </div>
                    </div>
                  </div>
