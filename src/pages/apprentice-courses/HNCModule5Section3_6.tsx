...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['£92,000', '£80,000', '£260,000', '£180,000'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Both are equal', 'Option A: £130,000', 'Cannot be determined', 'Option B: £120,000'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['SWOT analysis', 'Gantt chart', 'FAST diagram', 'Critical path method'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Value engineering decisions now must consider whole-life carbon, not just cost. PAS
              2080 provides the framework — embodied carbon (manufacture, transport, install) plus
              operational carbon (use, maintenance, replacement, end-of-life). Many MEP decisions
              (LED vs fluorescent, heat pump vs boiler, embodied carbon of switchgear) benefit
              dramatically from whole-life analysis.
            </>
          }
        ...
        <ConceptBlock title="Value Engineering Fundamentals">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>2. Function Analysis:</strong> Identify and classify functions — FAST diagram
            </li>
            <li>
        ...
        <ConceptBlock title="Function Analysis and Options Development">
          <p>
            Function analysis is the core of value engineering. By understanding what a system must
            do (rather than what it is), alternative solutions become apparent. Functions are
          ...
          <p>
            <strong>
              Example — HVAC Options Analysis (Option — Capital — Efficiency — Flexibility):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            ...
            "illuminate workspace" (300-500 lux). VE solution: Standard LED luminaires (£85/m2) with
            feature lighting in reception only. Saves £95/m2 whilst maintaining function. Feature
            areas enhanced, general areas adequate.
          </p>
          <p>
        ...
        <ConceptBlock title="Life Cycle Costing Methods">
          <p>
            Life cycle costing (LCC) evaluates the total cost of ownership over an asset's life. For
            building services, energy and maintenance costs often exceed the initial capital cost,
            making LCC essential for informed decision-making.
          </p>
          <p>
          ...
          <p>
            <strong>Simple Life Cycle Cost Calculation:</strong> LCC = Capital + (Annual Operating ×
            Years) + Replacements. Does not account for time value of money — suitable for quick
            comparisons.
          </p>
          <p>
        ...
        <ConceptBlock title="Energy Efficiency and Payback Analysis">
          ...
          <p>
            <strong>Simple Payback Period:</strong> Payback = Additional Cost / Annual Saving. Quick
            metric but ignores time value of money and savings beyond payback.
          </p>
          <p>
            <strong>
              Typical Energy Efficiency Measures — Building Services (Measure — Saving — Payback):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Decision:</strong> With 15-20 year chiller life, Option B delivers significant
              whole-life savings despite longer payback.
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Planned maintenance:</strong> Use CIBSE Guide M benchmarks (typically 2-5% of
              capital/year)
            </li>
            <li>
            ...
            <li>
              <strong>Major replacements:</strong> Component lifecycles (motors 15yr, controls 10yr,
              compressors 12yr)
            </li>
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — Simple Payback Calculation:</strong> A heat pump costs £45,000 more
            than a gas boiler system but saves £6,500/year in energy. Calculate the simple payback.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            over 20 years (simple method): Option A: £12,000 capital, £3,200/year energy, £800/year
            maintenance. Option B: £18,000 capital, £1,800/year energy, £600/year maintenance.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Compare to simple sum: £10,000 × 5 = £50,000. NPV reflects true present value.</li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Value Engineering Workshops">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HVAC:</strong> System selection, zoning, plant rationalisation, heat recovery
            </li>
            <li>
              <strong>Electrical:</strong> Diversity review, distribution topology, lighting control
              strategy
            </li>
            <li>
              <strong>Plumbing:</strong> Water heating strategy, pipe routing, rainwater harvesting
            </li>
            <li>
              <strong>Fire:</strong> Addressable vs conventional, suppression alternatives
            </li>
            <li>
              <strong>BMS:</strong> Integration scope, points schedule, proprietary vs open protocol
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              At month seven of a 14-month school project, the client demands £180k of VE. The
              design team proposes substituting the specified DALI lighting controls with a simpler
              0–10V system. The cost saving is £140k. You as project manager raise a concern: the
              building is already wired for DALI; a change now means re-pulling drivers, modifying
              the BMS interface and re-commissioning. The net cost change after rework is +£40k,
              with three weeks programme impact.
            </>
          }
          whatToDo={
            <>
              VE done late is rarely cheap. Always ask: what is the cost of change, including
              rework, design rev, programme impact and risk? Run the alternative through the design
              team, the M&E subcontractor and the commissioning manager before committing. Often the
              headline saving evaporates after rework. Recommend the VE proposal be rejected and
              propose alternative savings (specification of luminaire, lamp type, sensor count) that
              do not unwind installed work.
            </>
          }
          whyItMatters={
            <>
              VE is most powerful when applied early. Late VE is often a cost-shifting exercise
              where the saving in one place reappears as cost elsewhere. Discipline of
              options-analysis with full cost-of-change protects the project from headline-driven
              decisions.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Final account</div>
          </button>
          <button
