      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              ...
              <li className="pl-1">
                <strong>5x5 matrix:</strong> Structured tool for rating risk (1-25)
              </li>
              <li className="pl-1">
                <strong>Ratings:</strong> Trivial, tolerable, moderate, substantial, intolerable
              </li>
              <li className="pl-1">
                <strong>ALARP:</strong> Risk reduced as low as reasonably practicable
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Legal basis:</strong> MHSWR 1999 Reg 3 — suitable and sufficient RA
              </li>
              <li className="pl-1">
                <strong>Severity:</strong> Electrical contact = potentially fatal (severity 5)
              </li>
              <li className="pl-1">
                <strong>Controls:</strong> Safe isolation, PPE, competence, barriers
              </li>
              <li className="pl-1">
                <strong>ST1426:</strong> Risk assessment knowledge and application KSBs
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Expected to happen; has happened before in this workplace or frequently in
                        the industry
                      </td>
                    </tr>
                    <tr>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        First aid injury; minor cuts, bruises; short-term discomfort; no lost
                        workdays
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/30">
              ...
              <p className="text-sm text-white mt-3">
                For example, if a hazard has a likelihood of 3 (possible) and a severity of 4
                (major), the risk score is 3 x 4 = 12, which falls in the 'moderate' to
                'substantial' range depending on the matrix used. The score determines the urgency
                and nature of the response required.
              </p>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              severity of contact with mains voltage (230/400 V) is always at least 'major' (4) and
              potentially 'catastrophic' (5), because electric shock at these voltages can be fatal.
              This means that even a low likelihood still produces a significant risk score, which
              is why safe isolation is always the default control measure.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr className="bg-red-500/5">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Work must not proceed under any circumstances until the risk is reduced. If
                        it is not possible to reduce the risk, the work must remain prohibited.
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-3">
                Electrical Maintenance Risk Examples
              </h3>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                Best practice is to rate each hazard twice: once without controls (the 'inherent' or
                'gross' risk) and once with the proposed controls in place (the 'residual' or 'net'
                risk). This demonstrates the effectiveness of the controls and shows that the risk
                has been reduced to an acceptable level. For example, live working on a 400 V board
                might be rated as 20 (substantial) without controls, but with safe isolation,
                proving dead, locking off and appropriate PPE, the residual risk drops to 5
                (tolerable).
              </p>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 grid sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  Uses descriptive categories and professional judgement. The assessor draws on
                  their training, experience and knowledge of the work to rate hazards using
                  word-based scales (e.g., 'low', 'medium', 'high') or the numbered scales of a risk
                  matrix.
                </p>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  <li className="pl-1">
                    <strong>Advantages:</strong> Quick, practical, does not require statistical
                    data, accessible to non-specialists
                  </li>
                  <li className="pl-1">
                    <strong>Limitations:</strong> Subjective — different assessors may reach
                    different conclusions; less precise; relies on the competence of the assessor
                  </li>
                  <li className="pl-1">
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white mb-2">
                  ...
                  relationships, and calculated probabilities — to produce a numerical risk figure.
                  This may involve fault tree analysis, event tree analysis, or statistical
                  modelling.
                </p>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  <li className="pl-1">
                  ...
                  <li className="pl-1">
                    <strong>Limitations:</strong> Requires reliable data (which is often not
                    available), complex, time-consuming, may give a false sense of precision
                  </li>
                  <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-3">
                Semi-Quantitative Assessment — The Practical Middle Ground
              </h3>
              <p className="text-sm text-white mb-3">
                The 5x5 risk matrix is a semi-quantitative method — it assigns numbers to
                qualitative judgements, producing a numerical score that can be ranked and compared.
                This is the approach most commonly used in electrical maintenance because it
                provides a structured framework without requiring statistical data that is rarely
                available for individual maintenance tasks.
              </p>
              <p className="text-sm text-white">
                ...
                competently and understand the meaning of the scores it produces. Quantitative
                methods are specialist tools that you should be aware of but are unlikely to need to
                apply directly.
              </p>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Competence to Carry Out Risk Assessment
              </h3>
              <p className="text-sm text-white">
                Regulation 7 of the Management of Health and Safety at Work Regulations 1999
                requires employers to appoint one or more competent persons to assist with health
                and safety arrangements, including risk assessment. A competent person is someone
                with "sufficient training and experience or knowledge and other qualities" to carry
                out the function properly. For electrical risk assessments, this means a person who
                combines health and safety risk assessment knowledge with technical understanding of
                electrical systems and the specific work being assessed. As a maintenance technician
                progressing through ST1426, you are developing both sets of competence.
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="space-y-2">
                <div className="p-3 rounded bg-red-500/20 border border-red-500/30">
                  ...
                  <p className="text-xs text-white">
                    Risk cannot be justified except in extraordinary circumstances. Work must not
                    proceed.
                  </p>
                </div>
                <div className="p-3 rounded bg-yellow-500/20 border border-yellow-500/30">
                  ...
                  <p className="text-xs text-white">
                    Risk is tolerable only if further reduction is impracticable or the cost is
                    grossly disproportionate to the benefit. Continuous effort to reduce risk within
                    this zone.
                  </p>
                </div>
                <div className="p-3 rounded bg-green-500/20 border border-green-500/30">
                  <p className="text-sm font-medium text-green-400">
                    Broadly Acceptable Region (Bottom)
                  </p>
                  <p className="text-xs text-white">
                    Risk is so low that no further action is needed. Monitor to ensure it stays in
                    this region.
                  </p>
                </div>
              </div>
            ...
            <p>
              The word "reasonably practicable" is a legal test established by case law (Edwards v
              National Coal Board, 1949). It means that the degree of risk must be weighed against
              the sacrifice (in money, time and trouble) of the measures needed to avert that risk.
              If the risk is high, then substantial expenditure on controls is expected — you cannot
              argue that safe isolation equipment is "too expensive" when the alternative is a risk
              of fatal electric shock. The sacrifice must be "grossly disproportionate" to the risk
              before you can stop taking further precautions.
            </p>

            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                ALARP in Electrical Maintenance — Practical Examples
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Arc flash PPE:</strong> Specialist arc-rated clothing and face shields
                  have a cost, but the severity of arc flash burns justifies the expenditure for
                  work on systems with significant fault levels
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  ...
                  and IP-rated enclosures during design reduces the risk at source — this is ALARP
                  in action at the design stage
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  The groups of people who might be harmed and how (employees, contractors,
                  visitors, public)
                </li>
                <li className="pl-1">The existing control measures in place</li>
                <li className="pl-1">
                  Any further action required, including timescales and responsibilities
                </li>
              ...
              <p className="text-sm text-white mt-3">
                ...
                assessment form with clear entries for each significant hazard is sufficient. The
                key is that someone else could read it and understand what hazards are present, how
                they are controlled, and what additional action is needed.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Change in equipment:</strong> New plant, machinery or tools; modification
                ...
                <li className="pl-1">
                  <strong>Change in environment:</strong> Different site, weather conditions,
                  building alterations, new hazards in adjacent areas
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Legislative or guidance change:</strong> New regulations, updated
                  standards (e.g., BS 7671 amendments), revised HSE guidance
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Routine review period:</strong> Good practice recommends reviewing all
                  risk assessments at least annually, even if no specific trigger has occurred
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Re-visit the work area to check whether conditions have changed
                </li>
                <li className="pl-1">
                  Consult workers who carry out the activity regularly — they may have identified
                  new hazards or control weaknesses
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  Update the assessment to reflect any changes, with a new date and assessor
                  signature
                </li>
                <li className="pl-1">
                  Communicate any changes to the work team through briefings or toolbox talks
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              <p className="text-sm font-medium text-red-400 mb-2">
                Common Failure — Stale Risk Assessments
              </p>
              <p className="text-sm text-white">
                One of the most common failures in risk assessment management is allowing
                assessments to become "stale" — dated documents that no longer reflect the current
                work conditions but are still being used to authorise work. A risk assessment
                written for a site two years ago may be dangerously inadequate if the site
                conditions have changed. Always check the date of the risk assessment and verify at
                the point of work that it accurately describes the conditions you actually find. If
                it does not, stop work and request a review before proceeding.
              </p>
            </div>
