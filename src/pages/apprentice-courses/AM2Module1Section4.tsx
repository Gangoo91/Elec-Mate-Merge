  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/am2/module1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Learn from others' mistakes - understanding why candidates fail helps you avoid the same
          traps.
        </p>
        ...
        <ConceptBlock title="What this section is for">
          <p>
            ...
            Manual, and training centres confirm the same patterns. These aren't just minor mistakes
            — they are avoidable errors that can cost you marks, time, and even result in an
            automatic fail.
          </p>
          <p>
            This section gives you a clear view of the top reasons candidates fail, why they happen,
            and how to avoid them. Learning from others' mistakes is one of the most effective ways
        ...
        <ConceptBlock title="1. Safe Isolation Mistakes (The #1 Fail Point)">
          <p>
            <strong className="text-red-300">Critical.</strong> NET highlights safe isolation errors
            as the single biggest cause of failure. These are critical safety issues that result in
            automatic fails.
          </p>
          <p>
        ...
        <ConceptBlock title="Real-world Failure Examples">
          <p>
            ...
            Installed circuits correctly and completed all sections well, but failed to re-prove the
            tester during safe isolation. Result: Automatic fail despite otherwise competent
            performance.
          </p>
          <p>
            <strong className="text-elec-yellow">Candidate B: Specification Deviation.</strong>{' '}
            Completed installation neatly and safely but used 2.5mm cable where 4mm was specified on
            the drawing. Lost significant marks for not following specifications exactly.
          </p>
          <p>
        ...
        <ConceptBlock title="Summary">
          <p>
            ...
            safety breaches, time management issues, and workmanship below professional standards.
          </p>
          <p>
            <strong className="text-elec-yellow">Key Takeaway.</strong> Avoiding these errors isn't
            about luck — it's about strict practice, sticking to procedures, and working to
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              accessible, and must isolate <em>all</em> voltage. If your Section C isolation doesn’t
              cut every live conductor, or you can’t reach the means in a hurry, that’s the
              regulation you’ve breached — and it’s a critical fail.
            </>
          }
        ...
        <Scenario
          ...
          whatToDo={
            <>
              Stop. Re-prove the tester on the proving unit (or a known live source) <em>after</em>
              the dead test. If the tester has failed silently between the first prove and the dead
              test, you’ve just declared a live circuit dead. The full sequence is: prove on live →
              test the circuit dead → re-prove on live.
            </>
          }
          whyItMatters={
            <>
              Skipping the second prove is the single most common AM2 failure NET reports. Assessors
              will not give it back to you — re-proving is the procedure, not optional.
            </>
          }
        />
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Follow the drawing exactly. If you genuinely think it can’t be done as drawn, ask the
              assessor before you cut a single piece of cable. They will either confirm the spec or
              note an agreed deviation in writing.
            </>
          }
        />
