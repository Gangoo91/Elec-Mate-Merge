...
const DESCRIPTION =
  'Understand HSE GS38 guidance on electrical test equipment safety, including probe requirements, CAT ratings, fused leads, and proper equipment selection.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'GS38 recommends a maximum 4mm exposed probe tip to minimise the risk of short circuits between adjacent conductors or contact with earthed metalwork. Longer tips increase arc flash risk. Shrouded probes with spring-loaded tips achieve this safely.',
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      'CAT III (Category III) indicates the equipment is designed for distribution level - testing at sub-distribution boards, fixed wiring, and industrial equipment. CAT ratings relate to transient overvoltage withstand capability, not just steady-state voltage.',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 1,
    explanation:
      'Fused leads (typically 500mA or 1A) limit the current that can flow if the probes accidentally short circuit. Without fuses, a short at a high-capacity source could cause severe arc flash, burns, and injury. The fuse blows before damage occurs.',
  },
  {
    id: 'check-4',
    ...
    correctIndex: 1,
    explanation:
      "You must prove your voltage indicator works on a known live source or proving unit BEFORE testing the circuit, and AGAIN AFTER. This confirms it was functioning correctly throughout. A faulty tester showing '0V' on a live circuit could cost you your life.",
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      "GS38 is 'Guidance Sheet 38' published by the Health and Safety Executive (HSE). It provides guidance on the selection and use of electrical test equipment to prevent injury. It's not law but represents accepted good practice.",
  },
  {
    id: 2,
    question:
      'What CAT rating is required for testing at the origin of an installation (meter position)?',
    options: ['CAT I', 'CAT II', 'CAT III', 'CAT IV'],
    correctAnswer: 3,
    explanation:
      'CAT IV is required for testing at the origin/service entrance where connection to the utility supply occurs. This location has the highest transient overvoltage exposure. CAT IV equipment provides the greatest protection against voltage transients.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Finger barriers or guards prevent fingers from accidentally sliding down onto the probe tip during use. When applying pressure to make contact, fingers can slip - barriers ensure they stop before reaching live metal. This is a key GS38 requirement.',
  },
  {
    id: 4,
    question:
      "A multimeter's display shows 'OL' when testing a known live circuit. What does this indicate?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'OL (Over Limit/Overload) means the measurement exceeds the selected range. This could be a genuinely high voltage, or it could indicate a problem (wrong range, faulty meter). NEVER assume OL means safe - it requires investigation. This is why two-pole testers are preferred.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      "Two-pole voltage indicators have only one function - detecting voltage. They can't be accidentally set to resistance or current mode. They provide clear, unambiguous indication (lights/display/sounder) and are designed to fail safe. Multimeters are versatile but require careful range selection.",
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      "A proving unit generates a known voltage (typically 230V or 400V at very low current) to verify your voltage indicator is working correctly. You prove before testing, then again after. This confirms the tester was functional throughout - essential for trusting a 'dead' reading.",
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'Test leads with blown fuses must not be used. The fuses provide essential short-circuit protection. Replace with the correct fuse type and rating as specified by the manufacturer. Never substitute higher-rated fuses or bypass them.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      "CAT II is for appliance level testing - socket outlets, portable equipment, and receptacle points. It's the lowest industrial category. Higher categories (CAT III for distribution, CAT IV for origin) are required closer to the supply source.",
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      "Test equipment should be formally calibrated annually or as per manufacturer's recommendations. This ensures accuracy is maintained. Between calibrations, daily visual checks and proving tests verify operational condition. Equipment that's been dropped or damaged needs immediate recalibration.",
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Visual inspection should check: insulation for cuts/damage/deterioration, probe tips for damage/corrosion, lead flexibility (stiff leads may have internal breaks), plug condition, and strain relief at connections. Damaged equipment must be replaced, not repaired.',
  },
  {
    id: 11,
    question:
      "A 'volt stick' (non-contact voltage detector) indicates no voltage on a cable. Can you safely cut it?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Non-contact voltage detectors (volt sticks) are useful for initial indication but can be affected by shielded cables, low batteries, and other factors. They cannot prove dead. Always follow up with a contact-type voltage indicator to confirm before working.',
  },
  {
    id: 12,
    question:
      'What minimum IP rating is generally recommended for test equipment used in industrial environments?',
    options: ['IP20', 'IP54 or higher', 'IP00', "IP rating doesn't matter"],
    correctAnswer: 1,
    explanation:
      'IP54 or higher provides protection against dust ingress and water splashing from any direction. Industrial and construction environments expose equipment to dust, moisture, and rough handling. Inadequate IP rating risks equipment failure when you need it most.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Either is acceptable provided the equipment meets GS38 requirements and is properly maintained. If using personal equipment, you're responsible for ensuring it's suitable, maintained, and calibrated. Many companies require only company-provided equipment for liability reasons. Check your employer's policy.",
  },
  {
    question: 'How do I know if my probes meet GS38?',
    answer:
      'Check for: maximum 4mm exposed tip (or spring-loaded shrouded design), finger barriers, fused leads, appropriate CAT rating for your work, and robust construction. If the probes came with certified test equipment from a reputable manufacturer, they likely comply. When in doubt, purchase GS38-compliant replacement leads.',
  },
  {
    question: 'My voltage indicator sometimes gives erratic readings. What should I do?',
    answer:
      'Stop using it immediately. Erratic readings indicate a fault - internal damage, low battery, or probe problems. Replace batteries and re-test. If problems persist, the unit needs repair or replacement. Never use equipment that behaves unpredictably - your life may depend on its accuracy.',
  },
  {
  ...
  },
  {
    ...
    answer:
      "Not necessarily. A quality multifunction tester can perform both roles if properly rated. However, for proving dead, dedicated two-pole voltage indicators are preferred because they can't be set to the wrong mode. Many electricians carry both - a voltage indicator for safe isolation and a multifunction tester for formal tests.",
  },
  {
    question: 'Can damaged insulation on test leads be repaired with tape?',
    answer:
      'No. Damaged test leads should be replaced, not repaired. Tape can hide ongoing deterioration, may not restore full insulation integrity, and creates an unreliable repair. Test leads are safety-critical equipment - the cost of replacement is trivial compared to the risk of using compromised leads.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Probes:</strong> Max 4mm exposed tip, finger barriers, shrouded design
              </li>
              <li>
                <strong>Leads:</strong> Fused (500mA typical), robust insulation, CAT rated
              </li>
              <li>
                <strong>CAT ratings:</strong> II=appliances, III=distribution, IV=origin
              </li>
              <li>
                <strong>Proving:</strong> Before AND after testing the circuit
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Check:</strong> CAT rating matches location, fuses intact, tips undamaged
              </li>
              <li>
                <strong>Prove:</strong> Tester works before and after testing
              </li>
              <li>
                <strong>Inspect:</strong> Daily visual checks, annual calibration
              </li>
              <li>
                <strong>Replace:</strong> Damaged leads - never repair
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              GS38 is a Guidance Sheet published by the Health and Safety Executive (HSE). Its full
              title is "Electrical test equipment for use by electricians." While not legally
              binding, it represents industry best practice and failure to follow it could be
              considered evidence of negligence if an accident occurs.
            </p>
            <p>
              The guidance exists because inadequate test equipment has contributed to electrical
              accidents, including fatalities. A multimeter set to the wrong range, test leads with
              damaged insulation, or probes that slip and short-circuit have all caused serious
              injuries. GS38 addresses these risks.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Legal Position:</strong> GS38 is guidance, not law. However, the Electricity
              at Work Regulations require suitable precautions for live work. Using equipment that
              doesn't meet GS38 could constitute failure to take suitable precautions.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Category (CAT) ratings indicate where test equipment can safely be used in an
              electrical installation. They relate to transient overvoltage withstand capability -
              not just the steady-state voltage. Closer to the supply source, transient overvoltages
              are more severe, requiring higher CAT ratings.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Test probes and leads are your physical interface with potentially lethal voltages.
              Their design features aren't aesthetic - each specification exists because inadequate
              equipment has caused injuries.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Probes and leads wear out. Budget for replacement leads
              when purchasing equipment. Damaged leads are more dangerous than no leads at all
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Test equipment is safety-critical. Regular proving, inspection, and maintenance ensure
              it's ready when you need it. A voltage indicator that fails during use could lead you
              to believe a live circuit is dead - with potentially fatal consequences.
            </p>
            ...
            <div className="my-6 p-4 rounded bg-white/5 border-l-2 border-elec-yellow">
              ...
              <p className="text-sm text-white/90">
                ...
                accuracy. Keep calibration records.
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Your Test Equipment Kit Should Include
              </h3>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Not proving before and after</strong> - Tester may have failed
                </li>
                <li>
                  <strong>Using wrong CAT equipment</strong> - Inadequate transient protection
                </li>
                <li>
                  <strong>Ignoring damaged insulation</strong> - "It still works" isn't safe
                </li>
                <li>
                  <strong>Bypassing blown fuses</strong> - Removes essential protection
                </li>
                <li>
                  <strong>Using multimeter on wrong range</strong> - Could show 0V when live
                </li>
              </ul>
            </div>
          </div>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/apprentice/level3-module1-section3-6">
