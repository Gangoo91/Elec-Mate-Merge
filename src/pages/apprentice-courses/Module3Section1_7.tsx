...
const TITLE =
  'Selecting Cables Based on Application and Environment - Module 3.1.7 | Level 2 Electrical Course';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'LSZH (Low Smoke Zero Halogen) cables reduce toxic emissions in fires, making them essential for public buildings and escape routes.',
  },
  {
    id: 10,
...
const scenarios = [
  {
    ...
    scenario:
      'You need to run power to a small timber workshop 15m from the house. The cable will be buried directly in the garden. The load will include lighting and power tools (approx. 20A).',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'SWA provides mechanical protection for underground runs, meeting BS 7671 requirements. Twin and Earth is not suitable for direct burial, and flex in conduit would be less durable and non-compliant for fixed outdoor supply.',
  },
  {
    title: 'Scenario 2 - Loft Lighting Circuit',
    scenario:
      'A new lighting circuit is being installed in a domestic loft. The cables will run over insulation material.',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "Thermal insulation reduces a cable's ability to dissipate heat, lowering its current capacity. Upsizing ensures compliance with current-carrying requirements. Standard size may overheat, and flexible cord is not permitted for fixed wiring.",
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      'Portable appliances require flexible cords for movement without damage. T&E is for fixed wiring, and Cat6 is for data, not power.',
  },
  {
    title: 'Scenario 4 - Outdoor Security Lights on a Wall',
    scenario:
      'Two LED floodlights are mounted on an external brick wall. The cable run is exposed to sunlight and weather.',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'UV light degrades PVC sheathing. Outdoor runs require UV-resistant sheaths or physical protection. SWA could be used but must be properly terminated, which option (c) omits.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'High temperatures can degrade standard PVC insulation. Heat-resistant cable is necessary. SWA offers mechanical protection but not high-heat tolerance.',
  },
  {
    title: 'Scenario 6 - Data Network in an Office',
    scenario: 'Installing 24 network points for office computers.',
    options: ['Cat6 twisted pair cable', 'Twin and Earth cable', 'Alarm cable'],
    correctAnswer: 0,
    explanation:
      'Data networks require twisted pair cabling for high-speed communication. T&E and alarm cables are not suitable for networking and will not meet performance or compliance requirements.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Heat-resistant cable is essential to handle prolonged high temperatures from heating mats. PVC flex may soften and degrade over time, and T&E is not designed for continuous high heat in such applications.',
  },
];

const faqs = [
  {
    q: 'How do I determine the correct cable size for a given load?',
    a: 'Consider the load current, installation method, ambient temperature, grouping factors, and voltage drop requirements. Use BS 7671 tables and apply all relevant derating factors.',
  },
  {
    q: 'When is SWA cable required over standard T&E?',
    a: "SWA is required for direct burial, high mechanical risk areas, and where enhanced protection is needed. It's essential for underground supplies and industrial environments.",
  },
  {
    q: "What makes a cable 'heat-resistant' and when is it needed?",
    a: 'Heat-resistant cables use special insulation materials (silicone, XLPE, high-temp PVC) that maintain properties at elevated temperatures. Required near heat sources, in plant rooms, and for heating circuits.',
  },
  {
    q: 'How does thermal insulation affect cable sizing?',
    a: 'Thermal insulation reduces heat dissipation, requiring derating or cable upsizing. The derating factor depends on insulation type and thickness - refer to BS 7671 Appendix 4.',
  },
  {
    q: 'What environmental factors must be considered in cable selection?',
    a: 'Temperature (ambient and operating), UV exposure, moisture, chemicals, mechanical stress, fire requirements, and installation method all influence cable choice.',
  },
  {
    q: 'When should LSZH cables be used instead of PVC?',
    a: 'LSZH cables are required in escape routes, public buildings, transport systems, and areas where people may be trapped during fires to reduce toxic emissions.',
  },
];
  ...
  return (
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              ...
              <li>
                Consider current capacity, environment, installation method, and protection needs
              </li>
              <li>
                BS 7671 requires cables to meet both electrical and environmental requirements
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Consider temperature, UV exposure, mechanical risk, and
                installation method
              </li>
              <li>
                <strong>Use:</strong> SWA for burial, heat-resistant for high temps, UV-resistant
                outdoors
              </li>
              <li>
                <strong>Check:</strong> Current capacity, derating factors, environmental
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="grid sm:grid-cols-3 gap-3 my-6">
              <div className="p-3 rounded bg-white/5">
                ...
                <ul className="text-xs text-white space-y-1">
                  ...
                  <li>
                    <strong>Voltage drop:</strong> Maximum 3% for lighting, 5% for power
                  </li>
                  <li>
                    <strong>Short circuit rating:</strong> Withstand fault currents safely
                  </li>
                  <li>
                    <strong>Earth loop impedance:</strong> Enable protective device operation
                  </li>
                  <li>
                    <strong>Harmonic compatibility:</strong> Consider non-linear loads
                  </li>
                </ul>
              </div>
              <div className="p-3 rounded bg-green-500/10 border border-green-400/30">
                ...
                <ul className="text-xs text-white space-y-1">
                  ...
                  <li>
                    <strong>UV exposure:</strong> Sunlight degradation of PVC sheaths
                  </li>
                  <li>
                    <strong>Moisture:</strong> Humidity, condensation, direct water contact
                  </li>
                  <li>
                    <strong>Chemical exposure:</strong> Oils, acids, cleaning agents
                  </li>
                  <li>
                    <strong>Mechanical stress:</strong> Vibration, movement, impact risk
                  </li>
                </ul>
              </div>
              <div className="p-3 rounded bg-white/5">
                ...
                <ul className="text-xs text-white space-y-1">
                  ...
                  <li>
                    <strong>Clipped direct:</strong> Standard installation with air cooling
                  </li>
                  <li>
                    <strong>In insulation:</strong> Thermal derating required
                  </li>
                  <li>
                    <strong>Enclosed (conduit/trunking):</strong> Grouping factors apply
                  </li>
                  <li>
                    <strong>Underground ducts:</strong> Pulling forces and access needs
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm font-medium text-elec-yellow mb-3">
                BS 7671 Selection Requirements
              </p>
              <div className="grid sm:grid-cols-2 gap-4">
                <ul className="text-xs text-white space-y-1">
                  <li>
                    <strong>Section 521:</strong> Types of wiring systems and their applications
                  </li>
                  <li>
                    <strong>Section 522:</strong> Selection and erection with respect to external
                    influences
                  </li>
                  <li>
                    <strong>Section 523:</strong> Current-carrying capacity and voltage drop
                  </li>
                  <li>
                    <strong>Appendix 4:</strong> Current-carrying capacity tables and derating
                    factors
                  </li>
                </ul>
                <ul className="text-xs text-white space-y-1">
                  <li>
                    <strong>Table 4A1-4A3:</strong> Installation methods and reference conditions
                  </li>
                  <li>
                    <strong>Table 4B1-4B4:</strong> Current-carrying capacity for different cable
                    types
                  </li>
                  <li>
                    <strong>Table 4C1-4C6:</strong> Voltage drop calculations and limits
                  </li>
                  <li>
                    <strong>Table 4D1A-4D5A:</strong> Derating factors for various conditions
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-3">
                External Influence Classifications (IP Codes)
              </p>
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <ul className="text-xs text-white space-y-1">
                    ...
                    <li>
                      <strong>AA5:</strong> -20 C to +40 C (unheated buildings)
                    </li>
                    <li>
                      <strong>AA6:</strong> -5 C to +60 C (boiler rooms, near heat sources)
                    </li>
                    <li>
                      <strong>AA7:</strong> -25 C to +55 C (external installations)
                    </li>
                    <li>
                      <strong>AA8:</strong> -50 C to +40 C (cold storage, refrigeration)
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="text-xs text-white space-y-1">
                    ...
                    <li>
                      <strong>AD2:</strong> Free-falling drops (slight condensation)
                    </li>
                    <li>
                      <strong>AD3:</strong> Spraying water (rain, washing)
                    </li>
                    <li>
                      <strong>AD4:</strong> Splashing water (bathrooms, kitchens)
                    </li>
                    <li>
                      <strong>AD8:</strong> Submersion (swimming pools, fountains)
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="grid sm:grid-cols-2 gap-3 my-6">
              <div className="p-3 rounded bg-white/5">
                ...
                <ul className="text-xs text-white space-y-1">
                  ...
                  <li>
                    <strong>AG2:</strong> Medium (0.5 J) - industrial areas
                  </li>
                  <li>
                    <strong>AG3:</strong> High (5.0 J) - areas with heavy machinery
                  </li>
                  <li>
                    <strong>Direct burial:</strong> Requires maximum protection
                  </li>
                </ul>
              </div>
              <div className="p-3 rounded bg-white/5">
                ...
                <ul className="text-xs text-white space-y-1">
                  ...
                  <li>
                    <strong>AN2:</strong> Medium (limited outdoor exposure)
                  </li>
                  <li>
                    <strong>AN3:</strong> High (direct sunlight exposure)
                  </li>
                  <li>
                    <strong>UV protection:</strong> Essential for AN2/AN3
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 rounded-lg bg-green-500/10 border border-green-400/30">
            <h3 className="text-sm font-medium text-white mb-3">
              Industrial Food Processing Plant Cable Selection Challenge
            </h3>
            <p className="text-sm text-white mb-4">
              An industrial food processing plant required electrical installation across multiple
              environmental zones, each presenting unique challenges for cable selection. The
              project highlighted the importance of systematic cable selection based on detailed
            ...
            <ul className="list-disc ml-6 space-y-1 text-sm text-white mb-4">
              <li>
                <strong>High-temperature areas:</strong> Near ovens and steam equipment reaching 85
                C ambient
              </li>
              <li>
                <strong>Wash-down zones:</strong> High-pressure cleaning with chemical detergents
              </li>
              <li>
                <strong>Cold storage:</strong> Freezer areas operating at -25 C continuously
              </li>
              <li>
                <strong>External distribution:</strong> Cables exposed to UV radiation and weather
              </li>
              <li>
                <strong>Mechanical risk areas:</strong> Fork-lift traffic and heavy machinery zones
              </li>
              <li>
                <strong>Hygiene requirements:</strong> Food-safe materials and easy-clean
                installations
              </li>
            </ul>
            <p className="text-sm font-medium text-white mb-2">
              Cable Selection Solutions Applied:
            </p>
            <ul className="list-disc ml-6 space-y-1 text-sm text-white mb-4">
              <li>
                <strong>High-temperature zones:</strong> Silicone-insulated cables rated to 150 C
                with mineral insulation near ovens
              </li>
              <li>
                <strong>Wash-down areas:</strong> LSZH cables in IP67-rated stainless steel trunking
                systems
              </li>
              <li>
                <strong>Cold storage:</strong> Arctic-grade cables maintaining flexibility to -40 C
              </li>
              <li>
                <strong>External runs:</strong> UV-stabilised SWA cables with additional mechanical
                protection
              </li>
              <li>
                <strong>High-risk areas:</strong> Steel-tape armoured cables in heavy-duty
                galvanised trunking
              </li>
              <li>
                <strong>Hygiene zones:</strong> Smooth-sheathed cables in sealed, washable
                containment systems
              </li>
            </ul>
            ...
            <ul className="list-disc ml-6 space-y-1 text-sm text-white mb-4">
              ...
              <li>
                Systematic selection approach saved 40% compared to over-specifying throughout
              </li>
              <li>Detailed documentation enabled efficient maintenance and future modifications</li>
              <li>
                Compliance with food industry standards achieved without compromising electrical
                performance
              </li>
            </ul>
            <p className="text-sm text-white">
              This project demonstrated that systematic cable selection based on accurate
              environmental assessment delivers reliable, cost-effective installations that meet
              both electrical and operational requirements.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            <p className="text-sm text-white mb-3">
              Correct cable selection is fundamental to electrical safety, system reliability, and
              regulatory compliance. The process requires systematic consideration of electrical,
              environmental, and installation factors to ensure optimal performance throughout the
              cable's service life.
            </p>
            <p className="text-sm text-white mb-2">
              Key principles for successful cable selection:
            </p>
            <ul className="text-sm text-white space-y-1 ml-4">
              <li>
                <strong>Systematic approach:</strong> Consider all electrical and environmental
                requirements methodically
              </li>
              <li>
                <strong>Environmental assessment:</strong> Accurately classify temperature,
                moisture, UV, and mechanical risks
              </li>
              <li>
                <strong>Derating factors:</strong> Apply appropriate factors for installation
                method, grouping, and ambient conditions
              </li>
              <li>
                <strong>Future-proofing:</strong> Consider potential changes in load, environment,
                or operational requirements
              </li>
              <li>
                <strong>Cost-effectiveness:</strong> Balance initial cost against reliability,
                maintenance, and replacement costs
              </li>
              <li>
                <strong>Compliance verification:</strong> Ensure selection meets all relevant
                standards and regulations
              </li>
              <li>
                <strong>Documentation:</strong> Record selection rationale and environmental
                assumptions for future reference
              </li>
            </ul>
            <p className="text-sm text-white mt-3">
              By mastering these cable selection principles and practicing with real-world
              scenarios, electricians can confidently specify the right cable for every application,
              ensuring safe, reliable, and compliant electrical installations.
            </p>
          </div>
        </section>
        ...
        {/* Quiz */}
        <section className="mb-10">
          <Quiz title="Cable Selection Knowledge Test" questions={quizQuestions} />
        </section>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/apprentice/level2/module3/section2/2-1">
              Next Section
