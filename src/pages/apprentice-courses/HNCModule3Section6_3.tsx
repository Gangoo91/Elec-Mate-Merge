...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Load cycling', 'Time shifting', 'Load shedding', 'Peak shaving'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['2:1 to 3:1', '1.5:1', '1.2:1', '5:1'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['375 kVA', '395 kVA', '525 kVA', '475 kVA'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['5 seconds', '2-5 minutes', '10-30 seconds', '10 minutes'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Peak clipping', 'Strategic conservation', 'Valley filling', 'Load shifting'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['£10,800', '£21,600', '£9,000', '£1,800'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS 7671 311.1 makes maximum-demand assessment compulsory at design stage. Once the
              building is in service, &ldquo;maximum demand&rdquo; becomes a continuously-billed
              quantity on commercial half-hourly DNO tariffs &mdash; the difference between sized MD
              and operational MD is where load management lives. As the BSE engineer you specify the
              BMS load-shedding logic, generator interlocks, battery dispatch and EV-charger
              throttling that keep operational MD below the contractual cap.
            </>
          }
        ...
        <ConceptBlock title="Maximum Demand and Load Factor">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Maximum Demand (MD):</strong> Highest average power over integration period
              (kW or kVA)
            </li>
            <li>
              <strong>Integration Period:</strong> Time over which demand is averaged (typically 30
              minutes)
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Load Factor Calculation</p>
          <p>
            <strong>Load Factor = Average Demand / Maximum Demand</strong>
          </p>
          <p>Also expressed as: Total Energy (kWh) / (MD × Operating Hours)</p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Continuous process industry</strong> — 0.80 - 0.95 — 24/7 operation, stable
              loads
            </li>
            <li>
              <strong>Office building</strong> — 0.40 - 0.60 — Peak morning start-up, daytime only
            </li>
            <li>
              <strong>Retail premises</strong> — 0.50 - 0.65 — Extended hours, variable occupancy
            </li>
            <li>
              <strong>Schools and colleges</strong> — 0.30 - 0.45 — Term-time only, holidays
            </li>
            <li>
              <strong>Residential</strong> — 0.25 - 0.35 — Morning/evening peaks, diverse occupancy
            </li>
          </ul>

          <p>
            <strong>Commercial benefit:</strong> Higher load factor means better utilisation of
            supply infrastructure. Many suppliers offer lower unit rates to customers with high load
            factors.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Demand Response Strategies">
          <p>
            Demand response (DR) encompasses actions taken to reduce electricity consumption during
            periods of peak demand or grid stress. Participation in DR programmes can provide
            significant financial benefits whilst supporting grid stability.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Incentive-based DR:</strong> Receive payments for reducing load when called
              upon
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">UK Demand Response Schemes</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Demand Flexibility Service:</strong> National Grid payments for shifting load
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">DR Event Notification Timeline</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Day-ahead</strong> — Scheduled DR, Triad avoidance — Lower
            </li>
            <li>
              <strong>2-4 hours</strong> — Demand Flexibility Service — Medium
            </li>
            <li>
              <strong>20-30 minutes</strong> — STOR, Emergency response — Higher
            </li>
          </ul>

          <p>
            <strong>Building automation:</strong> BMS integration with aggregator platforms enables
            automatic DR response, maximising participation without manual intervention.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Load Shedding and Prioritisation">
          <p>
            ...
            threshold. Effective load shedding requires careful prioritisation to maintain essential
            services whilst reducing non-critical consumption.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Load Priority Categories</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1 - Critical</strong> — Life safety — Fire systems, emergency lighting, lifts
              — Never shed
            </li>
            <li>
              <strong>2 - Essential</strong> — Core operations — IT servers, security, critical
              process — Only in emergency
            </li>
            <li>
              <strong>3 - Important</strong> — Comfort critical — Primary HVAC, main lighting —
              Reduce before shed
            </li>
            <li>
              <strong>4 - Deferrable</strong> — Flexible loads — EV charging, water heating, storage
              — First to shed
            </li>
            <li>
              <strong>5 - Non-essential</strong> — Amenity — Decorative lighting, displays, vending
              — Shed freely
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Load Shedding Strategies</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Implementation Requirements</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Peak Shaving Techniques">
          <p>
            ...
            or storage during peak periods. This reduces demand charges, improves supply resilience,
            and can provide significant cost savings.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Peak Shaving Technologies</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Battery storage (BESS)</strong> — Milliseconds — 1-4 hours — Daily peak
              shaving, DR
            </li>
            <li>
              <strong>Diesel/gas generator</strong> — 30-60 seconds — Hours (fuel limited) —
              Extended peaks, backup
            </li>
            <li>
              <strong>CHP (combined heat/power)</strong> — Minutes — Continuous — Base load with
              heat demand
            </li>
            <li>
              <strong>Solar PV</strong> — Instant (when generating) — Daylight hours — Daytime peak
              reduction
            </li>
            <li>
              <strong>Thermal storage (ice/water)</strong> — Minutes — Hours — HVAC peak shifting
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Battery Sizing for Peak Shaving</p>
          <p>
            <strong>Required Capacity (kWh) = Peak Reduction (kW) x Duration (hours) / DoD</strong>
          </p>
          <p>DoD = Depth of Discharge (typically 0.8-0.9 for lithium-ion)</p>
          ...
          <p>
            <strong>Hybrid systems:</strong> Combining solar PV with battery storage maximises peak
            shaving benefits - PV reduces daytime peaks whilst batteries handle morning start-up and
            evening peaks.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Time-of-Use Tariffs">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Typical UK ToU Tariff Periods</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Peak (Red)</strong> — 16:00-19:00 weekdays — 30-45p/kWh — Minimise consumption
            </li>
            <li>
              <strong>High (Amber)</strong> — 07:00-16:00, 19:00-23:00 — 18-25p/kWh — Normal
              operations
            </li>
            <li>
              <strong>Off-peak (Green)</strong> — 23:00-07:00, weekends — 8-15p/kWh — Shift flexible
              loads here
            </li>
          </ul>

          <p className="text-sm font-medium text-white">Loads suitable for time shifting:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            Triads are the three highest demand periods on the national grid between November and
            February. Transmission charges (TNUoS) are based on your demand during these periods.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Typical Triad periods: 17:00-18:00 on cold winter weekdays</li>
            <li>Triad charges: £50-70/kW depending on region</li>
            <li>Reducing demand by 100 kW during Triads saves £5,000-7,000/year</li>
          </ul>
        ...
        <ConceptBlock title="Power Factor Correction Benefits">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Power Factor Relationships</p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reduced MD charges</strong> — Lower kVA demand — 5-15% of demand charge
            </li>
            <li>
              <strong>Avoid pf penalty</strong> — Suppliers penalise pf &lt; 0.90 — Varies by
              supplier
            </li>
            <li>
              <strong>Released capacity</strong> — More kW from same kVA supply — Avoid supply
              upgrade cost
            </li>
            <li>
              <strong>Reduced I²R losses</strong> — Lower current = less heat loss — 1-3% energy
              saving
            </li>
            <li>
              <strong>Voltage improvement</strong> — Less voltage drop in cables — Improved
          ...
          <p>
            <strong>kVAr = kW × (tan(cos⁻¹pf₁) - tan(cos⁻¹pf₂))</strong>
          </p>
        ...
        <ConceptBlock title="Demand Side Management">
          <p>
            ...
            patterns through efficiency improvements, load shifting, and demand reduction. Effective
            DSM reduces costs, improves grid stability, and supports decarbonisation goals.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">DSM Strategy Types</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Peak Clipping</strong> — Reduce peaks directly — Load shedding, demand
              limiting
            </li>
            <li>
              <strong>Valley Filling</strong> — Increase off-peak consumption — Off-peak water/ice
              storage
            </li>
            <li>
              <strong>Load Shifting</strong> — Move loads from peak to off-peak — EV charging, batch
              processes
            </li>
            <li>
              <strong>Strategic Conservation</strong> — Permanent demand reduction — Efficiency
              upgrades, LED retrofit
            </li>
            <li>
              <strong>Flexible Load Shape</strong> — Adapt to grid conditions — Smart controls,
              price response
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">DSM Implementation Hierarchy</p>
        ...
        <ConceptBlock title="Building Services: BMS Load Control">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">BMS Load Control Functions</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Demand limiting</strong> — Auto-shed loads at threshold — 10-20%
            </li>
            <li>
              <strong>Staggered starting</strong> — Sequential equipment start-up — 15-30%
            </li>
            <li>
              <strong>Optimum start</strong> — Pre-condition before occupancy — 5-10%
            </li>
            <li>
              <strong>Duty cycling</strong> — Limit equipment run-time % — 10-15%
            </li>
            <li>
              <strong>Load rotation</strong> — Cycle similar loads — 5-10%
            </li>
          </ul>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Demand Limiting Algorithm</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Load Priority Programming</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Soft Starter and VSD Benefits</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Soft starters:</strong> Reduce starting current from 6-8x to 2-3x FLC
            </li>
            <li>
              <strong>VSDs:</strong> Eliminate starting current spike entirely, enable speed control
            </li>
            <li>Both reduce peak demand during start-up and protect supply infrastructure</li>
            <li>
              VSDs additionally reduce running power at part-load (follows cube law for fans/pumps)
            </li>
          </ul>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> An office building consumes 15,000 kWh over a 22-day working
            month, operating 10 hours per day. Maximum demand is 95 kW. Calculate the load factor.
          </p>
          ...
          <p>→ Good load factor indicates efficient supply utilisation</p>
          ...
          <p>
            <strong>Question:</strong> A building has maximum demand of 600 kW. You want to limit
            grid demand to 450 kW for a 3-hour peak period using battery storage. Size the system.
          </p>
        ...
        <Scenario
          ...
          situation={
            <>
              A distribution warehouse has a 1500 kVA DNO supply, current peak demand 900 kVA,
              average demand 380 kVA (load factor 0.42). The operator plans to add 30 fleet EV
              chargers (22 kW each) for overnight charging. Naive addition would push peak to ~1450
              kVA, just within supply capacity but tipping into the highest red-zone DUoS charge
              band. Operator asks the BSE engineer for a smart-charging + battery storage business
              case.
            </>
          }
          whatToDo={
            <>
              Three-step: (a) BMS smart-charging schedules EV chargers to start in staggered groups
              overnight, capping aggregate EV demand at 400 kW instead of 660 kW &mdash; brings peak
              to ~1240 kVA, below the red-zone trigger; (b) install a 200 kWh / 100 kW battery
              storage system that charges off-peak (green zone) and discharges during the morning
              business peak &mdash; further trims peak to ~1100 kVA; (c) integrate with the
              DNO&rsquo;s Demand Flexibility Service for additional revenue. Document payback
              (typically 6&ndash;9 years on storage alone, 4&ndash;6 years with DUoS arbitrage) in
              the operator&rsquo;s ESOS submission.
            </>
          }
          whyItMatters={
            <>
              EV fleet electrification is shifting peak demand for warehouse, retail and depot
              operators. Without load management, every operator faces expensive substation
              upgrades. The HNC engineer who designs smart charging + storage as part of the EV
              connection avoids the substation upgrade and unlocks the DUoS arbitrage. The financial
