                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      ...
                      <li>* <strong>I - Insulation:</strong> Temperature rise limited (140C average or less)</li>
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>* <strong>Activation temperature:</strong> Typically 120-180C</li>
              ...
              <div className="p-4 bg-transparent border border-green-400/30 rounded-lg mb-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>* <strong>Fire rating match:</strong> System rating greater than or equal to barrier rating</li>
