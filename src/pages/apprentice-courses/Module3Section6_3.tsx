...
import { ArrowLeft, ArrowRight, Flame, Shield, Wrench, Eye } from 'lucide-react';
import { InlineCheck } from '@/components/apprentice-courses/InlineCheck';
import { Quiz } from '@/components/apprentice-courses/Quiz';
import useSEO from '@/hooks/useSEO';

const TITLE = 'Fire Stopping and Sealing Penetrations - Module 3.6.3 | Level 2 Electrical Course';
const DESCRIPTION =
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'Which type of foam is acceptable for fire stopping a penetration?',
    options: [
      'Only tested and certified fire-rated foam',
      'Any general-purpose expanding foam',
      'Standard DIY-store gap-filling foam',
      'Any foam, provided it is fully cured',
    ],
    correctAnswer: 0,
    explanation:
      'Only tested and certified fire-rated foams that meet specific fire resistance standards can be used for fire stopping applications.',
  },
  {
    id: 4,
    ...
    options: [
      ...
      'Plastic capping over the opening',
      'Fire-rated boards or intumescent wraps',
      'Expanding foam from a DIY store',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Apply a coat of intumescent paint to the cables',
      'Remove all cables from the penetration',
  ...
  },
  {
    ...
    options: [
      ...
      'To confirm the cables are the correct colour code',
      'To verify the circuit disconnection time',
  ...
  {
    id: 8,
    question: 'Which standards in the UK cover fire stopping for service penetrations?',
    options: [
      'The Electricity at Work Regulations only',
      'BS 5266 (emergency lighting) only',
      'BS 5839 (fire alarms) only',
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <header className="mb-6 sm:mb-8 text-center">
          <div className="inline-flex items-center justify-center px-3 py-1 rounded-full bg-elec-yellow/10 border border-elec-yellow/30 mb-4">
            <span className="text-elec-yellow text-sm font-medium">Module 3.6.3</span>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  Service penetrations compromise fire barrier integrity without proper sealing.
                </li>
                <li>
                  Fire stopping prevents flames, smoke, and heat spreading between compartments.
                </li>
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Unsealed gaps, damaged seals, non-rated materials, missing
                  fire stopping.
                </li>
                <li>
                  <strong>Use:</strong> Intumescent products, fire pillows, rated boards, certified
                  systems.
                </li>
                <li>
                  <strong>Check:</strong> Seal integrity, material ratings, installation compliance,
                  maintenance records.
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <ul className="list-disc pl-6 space-y-2 text-xs sm:text-sm text-white">
            <li>
              Explain why penetrations in fire barriers must be sealed and the consequences of
              failure.
            </li>
            <li>
              Identify approved materials and methods for different types of electrical
              penetrations.
            </li>
        ...
        <section className="mb-10">
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
              <h4 className="font-medium text-white mb-3">
                Understanding Fire Compartmentation Strategy
              </h4>
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <p className="text-xs sm:text-sm text-white mb-3">
                  <strong>Compartmentation Philosophy:</strong> Fire compartmentation divides
                  buildings into separate fire-resisting sections to prevent fire spread, protect
                  escape routes, and provide firefighting access. Every penetration through these
                  barriers potentially compromises the entire fire safety strategy unless properly
                  sealed.
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Flame spread:</strong> Direct fire penetration through openings
                      </li>
                      <li>
                        * <strong>Heat transfer:</strong> Conduction through materials and
                        structures
                      </li>
                      <li>
                        * <strong>Smoke movement:</strong> Toxic gases spreading via air paths
                      </li>
                      <li>
                        * <strong>Stack effect:</strong> Vertical smoke movement in tall buildings
                      </li>
                      <li>
                        * <strong>Pressure differentials:</strong> Wind and HVAC effects on smoke
                        flow
                      </li>
                    </ul>
                  </div>
                  <div>
                    <h6 className="font-medium text-white mb-2">
                      Consequences of Unsealed Penetrations
                    </h6>
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Rapid fire spread:</strong> 2-5 minute compartment failure
                      </li>
                      <li>
                        * <strong>Smoke logging:</strong> Escape route contamination
                      </li>
                      <li>
                        * <strong>Structural damage:</strong> Heat weakening adjacent compartments
                      </li>
                      <li>
                        * <strong>Life safety:</strong> Reduced evacuation time available
                      </li>
                      <li>
                        * <strong>Property loss:</strong> Exponential damage progression
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-elec-yellow mb-3">
                  Building Regulations and Legal Framework
                </h5>
                    ...
                    <tbody>
                      <tr>
                        <td className="border border-white/10 p-3">
                          <strong>Building Regulations Part B</strong>
                        </td>
                        <td className="border border-white/10 p-3">Fire safety in buildings</td>
                        <td className="border border-white/10 p-3">
                          Maintain fire resistance of barriers
                        </td>
                        <td className="border border-white/10 p-3">
                          Fire test certificates, installation records
                        </td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">
                          <strong>BS 7671 Section 527</strong>
                        </td>
                        <td className="border border-white/10 p-3">
                          Electrical installation fire precautions
                        </td>
                        <td className="border border-white/10 p-3">
                          Appropriate sealing where barriers penetrated
                        </td>
                        <td className="border border-white/10 p-3">
                          Material specifications, test certificates
                        </td>
                      </tr>
                      <tr>
                        <td className="border border-white/10 p-3">
                          <strong>BS EN 1366 Series</strong>
                        </td>
                        <td className="border border-white/10 p-3">Fire resistance testing</td>
                        <td className="border border-white/10 p-3">
                          Test methods for service penetrations
                        </td>
                        <td className="border border-white/10 p-3">Third-party test reports</td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">
                          <strong>BS 8519</strong>
                        </td>
                        <td className="border border-white/10 p-3">
                          Fire stopping installation code
                        </td>
                        <td className="border border-white/10 p-3">
                          Installation best practice guidance
                        </td>
                        <td className="border border-white/10 p-3">
                          Installation certificates, photographic records
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div className="p-4 bg-transparent border border-green-400/30 rounded-lg">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>30 minutes:</strong> Typical for single-storey commercial,
                        domestic
                      </li>
                      <li>
                        * <strong>60 minutes:</strong> Multi-storey offices, educational buildings
                      </li>
                      <li>
                        * <strong>90 minutes:</strong> High-rise buildings, hospitals
                      </li>
                      <li>
                        * <strong>120 minutes:</strong> Special risk buildings, critical
                        infrastructure
                      </li>
                      <li>
                        * <strong>240 minutes:</strong> Exceptional cases, nuclear facilities
                      </li>
                    </ul>
                  </div>
                  <div>
                    <h6 className="font-medium text-white mb-2">
                      Rating Criteria (EI Classification)
                    </h6>
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>E - Integrity:</strong> No flames or hot gases pass through
                      </li>
                      <li>
                        * <strong>I - Insulation:</strong> Temperature rise limited (140C average or
                        less)
                      </li>
                      <li>
                        * <strong>Load bearing:</strong> R classification for structural elements
                      </li>
                      <li>
                        * <strong>Smoke control:</strong> S classification for smoke tightness
                      </li>
                      <li>
                        * <strong>Test conditions:</strong> ISO 834 standard fire curve
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-elec-yellow mb-3">
                  Intumescent Material Technology
                </h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Activation temperature:</strong> Typically 120-180C
                      </li>
                      <li>
                        * <strong>Expansion ratio:</strong> 10:1 to 50:1 volume increase
                      </li>
                      <li>
                        * <strong>Char formation:</strong> Insulating carbonaceous layer
                      </li>
                      <li>
                        * <strong>Endothermic reaction:</strong> Absorbs heat during expansion
                      </li>
                      <li>
                        * <strong>Self-extinguishing:</strong> No contribution to fire load
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Sealants:</strong> Gun-applied for small gaps and irregular shapes
                      </li>
                      <li>
                        * <strong>Putty:</strong> Hand-moldable for complex penetrations
                      </li>
                      <li>
                        * <strong>Strips and wraps:</strong> Pre-formed for pipe and cable bundles
                      </li>
                      <li>
                        * <strong>Blocks and pillows:</strong> Removable systems for access points
                      </li>
                      <li>
                        * <strong>Coatings:</strong> Spray or brush application for large areas
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <table className="w-full border-collapse border border-white/10 text-sm">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="border border-white/10 p-3">
                          Sized to pipe, structural fixing
                        </td>
                      </tr>
                      <tr className="bg-muted/5">
              ...
              <div className="p-4 bg-transparent border border-amber-400/30 rounded-lg mb-4">
                <h5 className="font-medium text-amber-400 mb-3">
                  Fire-Rated Board Systems and Structural Solutions
                </h5>
              ...
              <div className="p-4 bg-transparent border border-cyan-400/30 rounded-lg">
                <h5 className="font-medium text-cyan-400 mb-3">
                  Electrical-Specific Fire Stopping Solutions
                </h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Tray fire barriers:</strong> Vertical and horizontal intumescent
                        systems
                      </li>
                      <li>
                        * <strong>Wrap systems:</strong> Flexible intumescent wraps for cable
                        bundles
                      </li>
                      <li>
                        * <strong>Box barriers:</strong> Enclosure systems for large cable
                        quantities
                      </li>
                      <li>
                        * <strong>Coated barriers:</strong> Spray-applied intumescent coatings
                      </li>
                      <li>
                        * <strong>Hybrid systems:</strong> Combination of pillows and rigid barriers
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Metal conduit:</strong> Fire-rated joint compounds and end seals
                      </li>
                      <li>
                        * <strong>PVC systems:</strong> Intumescent collars to close gaps when
                        plastic melts
                      </li>
                      <li>
                        * <strong>Cable baskets:</strong> Modular fire barrier systems
                      </li>
                      <li>
                        * <strong>Floor boxes:</strong> Specialist fire-rated floor penetration
                        systems
                      </li>
                      <li>
                        * <strong>Busbar trunking:</strong> High-temperature rated fire stopping
                        materials
                      </li>
                    </ul>
                  </div>
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-transparent border border-green-400/30 rounded-lg mb-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Barrier identification:</strong> Verify fire rating and
                        construction type
                      </li>
                      <li>
                        * <strong>Penetration survey:</strong> Catalogue all existing and planned
                        openings
                      </li>
                      <li>
                        * <strong>Service coordination:</strong> Plan routes to minimise
                        penetrations
                      </li>
                      <li>
                        * <strong>Access planning:</strong> Identify maintenance and future
                        modification needs
                      </li>
                      <li>
                        * <strong>Environmental conditions:</strong> Assess humidity, temperature,
                        chemical exposure
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Fire rating match:</strong> System rating greater than or equal to
                        barrier rating
                      </li>
                      <li>
                        * <strong>Test evidence:</strong> Third-party test reports for specific
                        application
                      </li>
                      <li>
                        * <strong>Service compatibility:</strong> Chemical compatibility with
                        cables/pipes
                      </li>
                      <li>
                        * <strong>Environmental durability:</strong> Long-term performance in
                        service conditions
                      </li>
                      <li>
                        * <strong>Maintenance requirements:</strong> Inspection and replacement
                        schedules
                      </li>
                    </ul>
                  </div>
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg">
                <h5 className="font-medium text-elec-yellow mb-3">
                  Common Installation Failures and Prevention
                </h5>
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Incomplete gap filling:</strong> Hidden voids behind visible
                        sealing
                      </li>
                      <li>
                        * <strong>Material incompatibility:</strong> Chemical reaction between
                        sealant and services
                      </li>
                      <li>
                        * <strong>Inadequate substrate preparation:</strong> Poor adhesion due to
                        contamination
                      </li>
                      <li>
                        * <strong>Incorrect material selection:</strong> Wrong fire rating or
                        application type
                      </li>
                      <li>
                        * <strong>Installation defects:</strong> Air bubbles, uneven application,
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-sm">
                      <li>
                        * <strong>Competent installer training:</strong> Manufacturer certification
                        programmes
                      </li>
                      <li>
                        * <strong>Quality control procedures:</strong> Stage inspections and hold
                        points
                      </li>
                      <li>
                        * <strong>Material verification:</strong> Check certificates and batch
                        numbers
                      </li>
                      <li>
                        * <strong>Installation supervision:</strong> Experienced oversight of
                        critical installations
                      </li>
                      <li>
                        * <strong>Independent inspection:</strong> Third-party verification for
          ...
          <div className="space-y-4">
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Can expanding foam from a DIY store be used as fire stopping?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: No. Only tested and certified fire-rated foams with proven fire resistance test
                evidence are acceptable for fire stopping applications.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Are fire pillows permanent installations?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: No. Fire pillows are removable and intended for access points, but they must
                still provide the required fire rating and be properly compressed for effectiveness.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Does trunking itself provide fire stopping?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: No. Unless it is specifically fire-rated trunking installed with approved sealing
                materials, additional fire stopping is required at barrier penetrations.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">
                Q: Who can install fire stopping systems?
              </h3>
              <p className="text-xs sm:text-sm text-white">
                A: Installation should be carried out by competent persons with appropriate training
                and certification. Many manufacturers offer training schemes for installers.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 bg-transparent border-l-2 border-elec-yellow rounded-lg border border-white/10">
            <p className="text-white">
              ...
              Regulations Part B and BS 7671 while protecting life and property. Only tested,
              certified fire-rated systems should be used, and any breach of fire stopping integrity
