    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-base text-muted-foreground mb-12">
          This section covers the fundamental calculations required for lighting design. You'll
          learn about the lumen method, point-by-point calculations, glare assessment, uniformity
          requirements and how to achieve compliance with CIBSE Lighting Guides for different
          applications.
        </p>
