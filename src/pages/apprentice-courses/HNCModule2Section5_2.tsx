...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['20-25 W/m²', '5-8 W/m²', '30-35 W/m²', '10-12 W/m²'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['CIBSE Guide F', 'CIBSE Guide B', 'CIBSE TM46', 'CIBSE Guide A'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['15-20 W/m²', '10 W/m²', '25-30 W/m²', '40-50 W/m²'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['8-12 m²/person', '25 m²/person', '5 m²/person', '15-20 m²/person'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CIBSE Guide A is the master reference for the input values that go into every heating
              and cooling load calculation in the UK. Cite it on the load schedule alongside Guide B
              sizing methods so the calculation is auditable end-to-end.
            </>
          }
        ...
        >
          <p>
            ...
            and latent heat (adding moisture). The emission rate varies substantially with activity
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Sensible heat:</strong> Raises air dry-bulb temperature, handled by cooling
              coils
            </li>
            <li>
            ...
            <li>
              <strong>Environmental effect:</strong> Higher room temperatures shift emission towards
              latent
            </li>
          </ul>
          <p>
            <strong>
              Heat emission by activity (CIBSE Guide A) - total / sensible / latent in W:
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        >
          <p>
            Electrical equipment and lighting convert electrical energy to heat. In modern offices,
            equipment gains often exceed occupant gains and can dominate cooling loads, particularly
            in IT-intensive spaces.
          </p>
          <p>
          ...
          <p>
            <strong>All lighting is heat:</strong> The visible light portion (20-25%) is absorbed by
            surfaces and becomes heat anyway. For cooling calculations, use the full electrical
            power.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Heat flows through the building fabric due to temperature differences between inside and
            outside. In winter this is predominantly heat loss; in summer, gains can occur through
            the fabric, particularly through glazing and poorly insulated roofs.
          </p>
          <p>
          ...
          <p>
            <strong>Sol-air temperature concept:</strong> In summer, external surfaces are heated by
            solar radiation above air temperature. The sol-air temperature accounts for this
          ...
          <p>
            ...
            external design temperature (typically -4°C to -1°C UK depending on location). Include a
            margin for morning boost.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Time variation:</strong> Steady-state assumes equilibrium; dynamic uses
              hour-by-hour/sub-hourly
            </li>
            <li>
              <strong>Thermal mass:</strong> Steady-state not modelled; dynamic fully accounted
            </li>
            <li>
              <strong>Weather data:</strong> Steady-state design conditions only; dynamic uses
              annual weather file
            </li>
            <li>
              <strong>Complexity:</strong> Steady-state spreadsheet/hand calc; dynamic specialist
              software
            </li>
            <li>
              <strong>Best use:</strong> Steady-state for heating loads, estimates; dynamic for
              cooling, overheating, energy
            </li>
          </ul>
          <p>
            <strong>CIBSE admittance method:</strong> Semi-dynamic manual method using Y-value
            (admittance) for storage, swing in temperature calculation, good for simple single-zone
            spaces.
          </p>
          <p>
        ...
        >
          <p>
            ...
            gains for a 200m² open-plan office with 20 occupants (sedentary), LED lighting at 12
            W/m², and equipment at 22 W/m².
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 2 - With diversity applied:</strong> Apply typical diversity factors to
            the above example: occupancy 0.85, lighting 0.90, equipment 0.70.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              A new 6-bed care-home extension (220 m² treated floor area) needs a heating load
              schedule for the LPHW boiler and rad-circuit design. External winter design is -3 °C
              (CIBSE Guide A, southern UK); internal target 22 °C bedrooms, 24 °C bathrooms (HBN
              08-02 dementia-friendly).
            </>
          }
          whatToDo={
            <>
              Calculate fabric losses room-by-room: Q_fabric = Σ(U × A × ΔT) for walls, windows,
              roof, floor and party elements. Add ventilation loss Q_vent = 0.33 × n × V × ΔT (n =
              ach, V = room volume). Add a 10–15% margin for intermittent heating and a 1.2 boost
              factor for dementia-friendly continuous-temperature operation. Sum to get peak heating
              load. Check against installed radiator output at 50 °C mean water temperature
              (low-temperature hot water for ASHP-readiness).
            </>
          }
          whyItMatters={
            <>
              Care-home heating must hit setpoint reliably for vulnerable occupants — a regulated
              welfare requirement under CQC standards. Undersized at design stage means cold rooms
              in winter and a CQC observation. Oversized means cycling, poor ASHP efficiency, and a
              chunky bill. The CIBSE Guide A method gives the defendable middle ground.
            </>
          }
        />
