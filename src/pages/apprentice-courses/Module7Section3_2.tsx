...
const DESCRIPTION =
  'Understanding how circuits function in sequence to locate faults logically and efficiently.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Sequence of operation describes the order in which current flows through components and how the circuit is intended to function.',
  },
  {
    id: 2,
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Sequence of operation describes how current flows through the circuit and how devices interact in their intended order.',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'By following the sequence step by step and testing each stage, electricians can narrow down where the fault interrupts normal operation.',
    },
    {
      id: 6,
      question:
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'The loose line conductor at the switch interrupted the sequence of operation before current could reach the lamp.',
    },
    {
      id: 10,
      question:
  ...
  const faqs = [
    {
      ...
      answer:
        'The order in which current flows through components in a circuit and how the circuit is intended to function.',
    },
    {
      question: 'Why is it important in fault finding?',
      answer:
        'It helps electricians logically identify where a fault has interrupted normal operation.',
    },
    {
      question: 'Can sequence of operation apply to complex circuits?',
      answer:
        'Yes, from simple lighting circuits to industrial control panels, the principle is the same.',
    },
    {
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            ...
            <ul className="text-white/80 space-y-1 text-sm list-disc pl-4">
              ...
              <li>
                Understanding this sequence is vital for distinguishing normal from abnormal
                operation.
              </li>
              <li>
                Without this knowledge, fault finding becomes guesswork instead of logical analysis.
              </li>
            </ul>
          </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                component should function in order.
              </p>
              ...
              <div className="p-3 rounded bg-white/5 text-sm">
                <strong className="text-white">Key principle:</strong> When any part of this
                sequence is broken, the circuit will not function as intended.
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <ul className="text-sm list-disc pl-4 space-y-1">
                  <li>
                    <strong className="text-white">Step 1:</strong> Supply voltage available at
                    distribution board
                  </li>
                  <li>
                    <strong className="text-white">Step 2:</strong> Current passes through MCB or
                    fuse (protective device)
                  </li>
                  <li>
                    <strong className="text-white">Step 3:</strong> Current flows to light switch
                    when closed
                  </li>
                  <li>
                    <strong className="text-white">Step 4:</strong> Current continues to lamp,
                    energising it
                  </li>
                  <li>
                    <strong className="text-white">Step 5:</strong> Current returns via neutral
                    conductor to complete circuit
                  </li>
                </ul>
              </div>

              <p>
                <strong className="text-white">Fault implications:</strong> If any part breaks down
                - loose neutral, faulty switch, blown lamp - the circuit fails.
              </p>

              <div className="p-3 rounded bg-white/5 text-sm">
                <strong className="text-white">Diagnostic approach:</strong> Test each step in
                sequence to locate where the break occurs.
              </div>
            </div>
          </section>
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-orange-500/50">
                ...
                <ul className="text-sm list-disc pl-4 space-y-1">
                  <li>
                    <strong className="text-white">Question 1:</strong> Has current reached the
                    load? If not, work backwards
                  </li>
                  <li>
                    <strong className="text-white">Question 2:</strong> Is the control circuit
                    functioning? Test switches and contactors
                  </li>
                  <li>
                    <strong className="text-white">Question 3:</strong> Are protective devices
                    operating correctly?
                  </li>
                  <li>
                    <strong className="text-white">Question 4:</strong> Is there a complete return
                    path for current?
                  </li>
                  <li>
                    <strong className="text-white">Question 5:</strong> Are connections secure at
                    each stage?
                  </li>
                </ul>
              </div>
              ...
              <p>
                <strong className="text-white">Systematic approach:</strong> Test each stage
                methodically until the break in sequence is found.
              </p>

              <div className="p-3 rounded bg-white/5 text-sm">
                <strong className="text-white">Professional practice:</strong> Understanding
                sequence prevents wasted time and unnecessary part replacement.
              </div>
            </div>
          </section>
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <ul className="text-sm list-disc pl-4 space-y-1">
                  <li>
                    <strong className="text-white">Stage 1:</strong> Supply available and emergency
                    stops not activated
                  </li>
                  <li>
                    <strong className="text-white">Stage 2:</strong> Safety interlocks satisfied
                    (guards closed, permits active)
                  </li>
                  <li>
                    <strong className="text-white">Stage 3:</strong> Control circuit energised via
                    start button
                  </li>
                  <li>
                    <strong className="text-white">Stage 4:</strong> Contactor operates connecting
                    motor to supply
                  </li>
                  <li>
                    <strong className="text-white">Stage 5:</strong> Overload protection monitors
                    motor current
                  </li>
                  <li>
                    <strong className="text-white">Stage 6:</strong> Motor runs until stop signal or
              ...
              <p>
                <strong className="text-white">Fault location:</strong> A fault at any stage
                prevents motor operation - sequence understanding shows where to focus testing.
              </p>

              <div className="p-3 rounded bg-white/5 text-sm">
                <strong className="text-white">Diagnostic efficiency:</strong> Testing each stage
                systematically avoids guesswork and component damage.
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-teal-500/50">
                ...
                <ul className="text-sm list-disc pl-4 space-y-1">
                  <li>
                    <strong className="text-white">Supply side:</strong> Voltage present at origin,
                    protective devices intact
                  </li>
                  <li>
                    <strong className="text-white">Control side:</strong> Switches operating,
                    contacts making/breaking
                  </li>
                  <li>
                    <strong className="text-white">Load side:</strong> Voltage reaching equipment,
                    return path complete
                  </li>
                  <li>
                    <strong className="text-white">Protection side:</strong> Earth paths continuous,
                    RCD sensitivity correct
                  </li>
                  <li>
                    <strong className="text-white">Documentation:</strong> Record results at each
              ...
              <div className="p-3 rounded bg-white/5 text-sm">
                <strong className="text-white">Sequence verification:</strong> Each test confirms or
                eliminates that stage as the fault location.
              </div>
            </div>
          </section>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <div className="grid sm:grid-cols-2 gap-3 text-sm text-white/80">
                  ...
                  <div>
                    ...
                    <p>
                      Apprentice replaced lamp holder first. Experienced electrician tested
                      sequence: supply → switch → lamp holder.
                    </p>
                  </div>
                  <div>
                    <p className="text-green-400 font-medium mb-1">Fix</p>
                    <p>
                      Testing revealed loose line conductor at switch, interrupting the sequence
                      before reaching lamp.
                    </p>
                  </div>
                  <div>
                    <p className="text-purple-400 font-medium mb-1">Lesson Learned</p>
                    <p>
                      Understanding sequence prevents unnecessary component replacement and
                      identifies real faults quickly.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-blue-500/50">
                ...
                <div className="grid sm:grid-cols-2 gap-3 text-sm text-white/80">
                  <div>
                    <p className="text-elec-yellow font-medium mb-1">Situation</p>
                    <p>
                      Factory conveyor belt would not start. Staff assumed motor failure and
                  ...
                  <div>
                    <p className="text-orange-400 font-medium mb-1">Investigation</p>
                    <p>
                      Electrician tested control sequence systematically: supply → interlocks →
                      contactor → motor.
                    </p>
                  </div>
                  <div>
                    <p className="text-green-400 font-medium mb-1">Fix</p>
                    <p>
                      Motor overload relay had tripped due to earlier fault condition. Reset relay
                      and addressed overload cause.
                    </p>
                  </div>
                  <div>
                    <p className="text-purple-400 font-medium mb-1">Lesson Learned</p>
                    <p>
                      Sequence understanding prevented expensive motor replacement and identified
                      actual protective operation.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* Quiz */}
          <section className="mb-10">
            <Quiz title="Knowledge Check: Sequence of Operation" questions={quizQuestions} />
          </section>
