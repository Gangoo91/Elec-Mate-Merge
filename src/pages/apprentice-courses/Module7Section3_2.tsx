              ...
              <div className="rounded-lg p-4 sm:p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">What "Sequence of Operation" Means</p>
                    <p className="text-sm sm:text-base text-foreground mb-2">The sequence of operation is essentially the "story" of how a circuit works from beginning to end. It describes the intended path of current flow and how each component should function in order.</p>
              ...
              <div className="rounded-lg p-4 sm:p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm sm:text-base text-foreground mb-2">In a basic lighting circuit, the sequence is: power supplied from distribution board → protective device → switch → lamp → return on neutral conductor.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-sm sm:text-base text-foreground mb-2"><strong>Fault implications:</strong> If any part breaks down - loose neutral, faulty switch, blown lamp - the circuit fails.</p>
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-4 sm:p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-emerald-400 mb-1">Using Sequence to Fault-Find</p>
                    <p className="text-sm sm:text-base text-foreground mb-2">When faults occur, electricians must mentally trace the sequence to predict where the fault might be located. This prevents random testing and component replacement.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-sm sm:text-base text-foreground mb-2"><strong>Systematic approach:</strong> Test each stage methodically until the break in sequence is found.</p>
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-4 sm:p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-1">Complex Systems: Motor Control Circuits</p>
                    <p className="text-sm sm:text-base text-foreground mb-2">Motor control systems demonstrate complex sequences involving safety interlocks, overload protection, and start/stop controls that must operate in specific order.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-sm sm:text-base text-foreground mb-2"><strong>Fault location:</strong> A fault at any stage prevents motor operation - sequence understanding shows where to focus testing.</p>
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
              ...
              <div className="rounded-lg p-4 sm:p-5 border-l-4 border-l-teal-500 bg-teal-500/5">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm sm:text-base text-foreground mb-2">Create simple checklists to confirm continuity and energisation at each stage of the sequence, building a clear picture of circuit operation.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
        ...
        <Card className="mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg border border-border/30 bg-card">
              <h3 className="font-semibold text-foreground mb-3">Domestic Lighting Fault</h3>
              <div className="grid sm:grid-cols-4 gap-4 text-sm">
                <div>
                  <p className="font-medium text-emerald-400 dark:text-emerald-400 mb-1">Situation</p>
                  <p className="text-foreground">Homeowner reported one light fitting stopped working completely.</p>
                </div>
                <div>
                  <p className="font-medium text-orange-600 dark:text-emerald-400 mb-1">Investigation</p>
                  <p className="text-foreground">Apprentice replaced lamp holder first. Experienced electrician tested sequence: supply → switch → lamp holder.</p>
                </div>
                <div>
                  <p className="font-medium text-green-600 dark:text-green-400 mb-1">Fix</p>
                  <p className="text-foreground">Testing revealed loose line conductor at switch, interrupting the sequence before reaching lamp.</p>
                </div>
                <div>
                  <p className="font-medium text-purple-600 dark:text-emerald-400 mb-1">Lesson Learned</p>
                  <p className="text-foreground">Understanding sequence prevents unnecessary component replacement and identifies real faults quickly.</p>
                </div>
              </div>
            </div>

            <div className="p-4 rounded-lg border border-border/30 bg-card">
              <h3 className="font-semibold text-foreground mb-3">Factory Conveyor Motor</h3>
              <div className="grid sm:grid-cols-4 gap-4 text-sm">
                <div>
                  <p className="font-medium text-emerald-400 dark:text-emerald-400 mb-1">Situation</p>
                  <p className="text-foreground">Factory conveyor belt would not start. Staff assumed motor failure and prepared for replacement.</p>
                </div>
                <div>
                  <p className="font-medium text-orange-600 dark:text-emerald-400 mb-1">Investigation</p>
                  <p className="text-foreground">Electrician tested control sequence systematically: supply → interlocks → contactor → motor.</p>
                </div>
                <div>
                  <p className="font-medium text-green-600 dark:text-green-400 mb-1">Fix</p>
                  <p className="text-foreground">Motor overload relay had tripped due to earlier fault condition. Reset relay and addressed overload cause.</p>
                </div>
                <div>
                  <p className="font-medium text-purple-600 dark:text-emerald-400 mb-1">Lesson Learned</p>
                  <p className="text-foreground">Sequence understanding prevented expensive motor replacement and identified actual protective operation.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <Card className="mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="p-4 rounded-lg bg-card border border-border/30">
              <h3 className="font-semibold text-emerald-400 dark:text-emerald-400 mb-2">Know the Story</h3>
              <p className="text-xs sm:text-sm text-foreground">Understand how the circuit is supposed to work before diagnosing faults.</p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-card border border-green-400/30">
              ...
              <p className="text-xs sm:text-sm text-foreground">Focus testing at interfaces between sequence stages to isolate problems.</p>
            </div>
            
            <div className="p-4 rounded-lg bg-card border border-border/30">
              <h3 className="font-semibold text-orange-600 dark:text-emerald-400 mb-2">Record and Confirm</h3>
              <p className="text-xs sm:text-sm text-foreground">Document findings at each stage and verify complete sequence after repair.</p>
            </div>
            
            <div className="p-4 rounded-lg bg-card border border-border/30">
              <h3 className="font-semibold text-purple-600 dark:text-emerald-400 mb-2">Prevent Guesswork</h3>
              <p className="text-xs sm:text-sm text-foreground">Systematic sequence checking eliminates random testing and part replacement.</p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-teal-500/10 border border-teal-400/30">
              ...
              <p className="text-xs sm:text-sm text-foreground">From simple lighting to complex industrial controls, sequence thinking applies universally.</p>
            </div>
            
            <div className="p-4 rounded-lg bg-card border border-border/30">
              <h3 className="font-semibold text-red-600 dark:text-emerald-400 mb-2">Professional Practice</h3>
              <p className="text-xs sm:text-sm text-foreground">Understanding sequence demonstrates systematic electrical knowledge and competence.</p>
            </div>
          </div>
          ...
          <div className="mt-6 p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/30">
            ...
            <p className="text-xs sm:text-sm text-foreground">Master sequence thinking early in your career - it forms the foundation for all advanced fault finding and diagnostic skills.</p>
          </div>
        </Card>
