...
const TITLE =
  'Using Measurement Tools and Marking Equipment - Module 4.2.1 | Level 2 Electrical Course';
const DESCRIPTION =
  'Learn proper selection, use, and maintenance of electrical measurement and marking tools for accurate installations compliant with BS 7671.';
...
const quizQuestions = [
  {
    ...
    correctAnswer: 2,
    explanation:
      'A scriber is specifically designed for scoring marks on metal surfaces for cutting or drilling.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Laser levels provide longer range capability and faster setup for creating straight lines over long distances.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Measuring twice before cutting or drilling reduces the risk of costly errors and material waste.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      "Pencil is ideal for temporary marks on plaster as it can be easily erased and won't damage the surface.",
  },
  {
    id: 6,
    ...
    options: [
      ...
      'Check against tape measure',
      'Compare with a chalk line',
    ],
    correctAnswer: 1,
    explanation:
      'The reverse test involves placing the level on a known level surface, noting the bubble position, then reversing the level 180 degrees. The bubble should be in the same position.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'A damaged measuring tape can give inaccurate readings, leading to misaligned installations and potential safety issues.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'BS 7671 requires accurate installation placement for compliance with safety standards, safe zones, and spacing requirements.',
  },
];
...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'Scriber and vernier calipers',
    ],
    correctIndex: 0,
    explanation:
      'Chalk line and laser level are both excellent for creating long, straight marking lines across surfaces.',
  },
  {
    id: 2,
    ...
    correctIndex: 1,
    explanation:
      'Using the same tape measure throughout a project avoids calibration discrepancies that can occur between different measuring tools.',
  },
  {
    id: 3,
    ...
    options: [
      'Drop it from height',
      'Test against a known level surface',
      'Compare with a ruler',
      'Check the warranty date',
    ],
    correctIndex: 1,
    explanation:
      'Testing a spirit level against a known level surface (reverse test) is the standard method to verify its accuracy.',
  },
];
...
const measurementTools = [
  {
    ...
    bestPractices: [
      'Keep straight during use',
      'Use same tape throughout project',
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white/80 text-sm space-y-1 list-disc pl-4">
                  ...
                  <li>
                    <strong>Use:</strong> Appropriate tools for task, correct marking method
                  </li>
                  <li>
                    <strong>Check:</strong> Tool accuracy, measurement consistency, BS 7671
                    compliance
                  </li>
                </ul>
              </div>
            ...
            <div className="p-4 rounded-lg bg-blue-500/10 border-l-2 border-blue-500/50">
              ...
              <div className="p-3 rounded bg-blue-500/10 border border-blue-500/20">
                <p className="text-blue-300 text-xs">
                  <strong>Lesson:</strong> Accurate marking from the start would have prevented the
                  problem. The cost of proper measurement tools and techniques is minimal compared
                  to rework expenses.
                </p>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-white/80 text-sm">
                ...
                cut once, and always verify your work against BS 7671 requirements.
              </p>
            </div>
          </section>
          ...
          <Quiz
            ...
            title="Test Your Knowledge: Measurement Tools and Marking Equipment"
          />
