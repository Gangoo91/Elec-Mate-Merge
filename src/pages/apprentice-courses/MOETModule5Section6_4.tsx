      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>OT cyber attacks</strong> can cause physical damage, safety incidents, and
                environmental harm
              </li>
              <li className="pl-1">
                <strong>IEC 62443</strong> is the international standard for industrial
                cybersecurity
              </li>
              <li className="pl-1">
                <strong>Defence in depth</strong> applies multiple security layers — no single point
                of failure
              </li>
              <li className="pl-1">
                <strong>DMZ architecture</strong> prevents direct OT-to-IT connectivity
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  ...
                  uranium enrichment centrifuges — proved cyber attacks can cross the
                ...
                <li className="pl-1">
                  ...
                  instrumented systems — the first known attack specifically aimed at disabling
                  safety systems
                </li>
                <li className="pl-1">
                  <strong>Colonial Pipeline (2021):</strong> Ransomware attack on pipeline
                  operations caused fuel supply disruptions across the southeastern United States
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Increasing connectivity:</strong> IIoT, remote access, and cloud
                  integration expand the attack surface
                </li>
                <li className="pl-1">
                  <strong>IT/OT convergence:</strong> Connecting previously isolated control
                  networks to enterprise systems introduces new risk pathways
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Default credentials:</strong> Many devices ship with default passwords
                  that are never changed
                </li>
                <li className="pl-1">
                  <strong>Protocol vulnerabilities:</strong> Industrial protocols (Modbus, older
                  OPC) were designed without security features
                </li>
              </ul>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Cybersecurity is not just an IT problem. Every maintenance
              technician who connects a laptop, USB drive, or mobile device to an OT network is part
              of the security perimeter. Understanding basic cybersecurity principles is now an
              essential skill for all OT personnel.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                The Purdue Model — Network Levels
              </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">Enterprise/Internet</td>
                      <td className="border border-white/10 px-3 py-2">
                        Internet, cloud services, external partners
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">4</td>
                      <td className="border border-white/10 px-3 py-2">Enterprise Network</td>
                      <td className="border border-white/10 px-3 py-2">
                        ERP, email, intranet, business systems
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">3.5</td>
                      <td className="border border-white/10 px-3 py-2">DMZ</td>
                      <td className="border border-white/10 px-3 py-2">
                        Historians, patch servers, remote access gateways
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">3</td>
                      <td className="border border-white/10 px-3 py-2">Site Operations</td>
                      <td className="border border-white/10 px-3 py-2">
                        MES, batch management, site historian
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">2</td>
                      <td className="border border-white/10 px-3 py-2">Area Supervisory</td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">Basic Control</td>
                      <td className="border border-white/10 px-3 py-2">
                        PLCs, DCS controllers, SIS, drives
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">0</td>
                      <td className="border border-white/10 px-3 py-2">Physical Process</td>
                      <td className="border border-white/10 px-3 py-2">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                The DMZ — Critical Separation Layer
              </p>
              <p className="text-sm text-white mb-3">
                The DMZ is the most critical element of the architecture. It provides controlled
                data exchange between OT (Levels 0-3) and IT (Level 4) without any direct
                connection:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Zone:</strong> A group of assets with the same security requirements
                  (e.g., a production cell, a utility system)
                </li>
                <li className="pl-1">
                  <strong>Conduit:</strong> A controlled communication path between zones with
                  defined security controls
                </li>
                <li className="pl-1">
                  <strong>Blast radius:</strong> If one zone is compromised, segmentation prevents
                  the attacker from moving to other zones
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                Specialist OT network monitoring tools provide passive, non-intrusive visibility
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Dragos:</strong> Industrial cybersecurity platform with threat
                  intelligence and incident response
                </li>
                <li className="pl-1">
                  These tools understand industrial protocols (Modbus, OPC, Profinet, EtherNet/IP)
                  and can detect malicious commands, configuration changes, and unusual device
                  behaviour
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Detection:</strong> Network monitoring, operator awareness, automated
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                As a maintenance technician, your role in cybersecurity includes: using strong
                unique passwords and never sharing accounts, following USB handling procedures,
                reporting any suspicious activity or unexpected system behaviour immediately,
                ensuring laptop and test equipment antivirus definitions are up to date before
                connecting to the OT network, and following the site's change management procedures
                for all system modifications.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">SL 1</td>
                      <td className="border border-white/10 px-3 py-2">
                        Casual or accidental violation
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Accidental configuration change by authorised user
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">SL 2</td>
                      <td className="border border-white/10 px-3 py-2">
                        Intentional, low resources
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Disgruntled employee, basic hacking tools
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">SL 3</td>
                      <td className="border border-white/10 px-3 py-2">
                        Intentional, moderate resources
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Organised criminal group, specialised ICS knowledge
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">SL 4</td>
                      <td className="border border-white/10 px-3 py-2">
                        Intentional, high resources
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        State-sponsored attack (e.g., Stuxnet level)
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                ...
                operators of essential services — including energy, water, transport, health, and
                digital infrastructure — to take appropriate and proportionate measures to manage
                the cybersecurity risks to their OT and IT systems. Operators must report
                significant cyber incidents to the relevant competent authority. Non-compliance can
                result in enforcement action and financial penalties of up to 17 million pounds. The
                National Cyber Security Centre (NCSC) provides guidance and the Cyber Assessment
                Framework (CAF) for self-assessment.
              </p>
            </div>

            <p className="text-sm text-white/90 italic">
              <strong>Note:</strong> Under ST1426, maintenance technicians are expected to
              understand the importance of cybersecurity in industrial environments, recognise
              common threats and vulnerabilities, follow organisational security policies and
              procedures, and understand the role of standards such as IEC 62443 in protecting
