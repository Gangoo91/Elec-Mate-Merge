    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Understand BREEAM assessment methodology and how building services contribute to
          certification
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the Building Research Establishment Environmental Assessment Method
          (BREEAM), the world's leading sustainability assessment method for buildings. You'll learn
          about assessment categories, credit requirements and how electrical installations
