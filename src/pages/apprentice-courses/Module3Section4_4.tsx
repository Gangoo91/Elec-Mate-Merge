...
import { ArrowLeft, Wrench, Cable, Shield, AlertTriangle, HelpCircle } from 'lucide-react';
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  Use the right method: crimp, mechanical, resin — based on environment and rating.
                </li>
                <li>
                  Follow manufacturer instructions and torque settings; test earth continuity.
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> BW (indoor), CW (outdoor), E1W (hazardous); shrouds and
                  earth tags.
                </li>
                <li>
                  <strong>Use:</strong> Fan armour evenly; clamp correctly; seal to IP rating;
                  torque to spec.
                </li>
                <li>
                  <strong>Check:</strong> Continuity of armour to earth; no exposed strands; correct
                  sheath grip.
                </li>
              </ul>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-slate-400/30">
                  ...
                  <ul className="list-disc pl-4 space-y-1">
                    <li>
                      <strong>BW</strong> – indoor SWA
                    </li>
                    <li>
                      <strong>CW</strong> – outdoor SWA, weatherproof
                    </li>
                    <li>
                      <strong>E1W</strong> – hazardous areas
                    </li>
        ...
        <section className="mb-10">
          ...
          <div className="grid gap-3 text-sm">
            {[
              ...
              <div
                key={i}
                className="flex items-start p-3 bg-card/10 rounded-lg border border-white/10"
              >
        ...
        <section className="mb-10">
          ...
          <div className="grid gap-3 text-sm">
            {[
              ...
              <div
                key={i}
                className="flex items-start p-3 bg-destructive/10 rounded-lg border border-destructive/20"
              >
        ...
        <section className="mb-10">
          ...
          <div className="text-xs sm:text-sm text-white space-y-2">
            <p>
              <strong>BS 7671:</strong> 526 (Electrical connections), 522 (Selection and erection),
              543 (Earthing arrangements), Part 6 (Inspection & testing)
            </p>
            <p>
              <strong>Manufacturer data:</strong> Gland and joint kit instructions incl. torque
              settings
            </p>
            <p>
              <strong>HSE/GS38:</strong> Safe working practices, test equipment guidance
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
              ...
              <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-border/30">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="bg-elec-yellow text-white text-xs rounded-full w-5 h-5 flex items-center justify-center flex-shrink-0 mt-0.5">
                      1
                    </span>
              ...
              <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-border/30">
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    ...
                    <p>
                      Ambient temp 5-35°C. Below 5°C: joint may not cure. Above 35°C: rapid cure
                      time.
                    </p>
                  </div>
                  <div>
                    ...
                    <p>
                      Exact resin:hardener ratio critical. Use graduated mixing cups, not guesswork.
                    </p>
                  </div>
                  <div>
          ...
          <InlineCheck
            ...
            options={[
              'Slight conductor movement',
              'No conductor movement',
              'Crimp connector slides',
              'Heat-shrink stretches',
            ]}
            correctIndex={1}
              ...
              <div className="rounded-lg p-4 bg-transparent border border-cyan-400/30">
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    ...
                    <ul className="list-disc pl-4 space-y-1">
                      <li>
                        <strong>IR Test:</strong> 0.8 MΩ (L-E), 2.1 MΩ (N-E), 5.2 MΩ (L-N)
                      </li>
                      <li>
                        <strong>Continuity:</strong> L & N good, CPC 0.15Ω increase
                      </li>
                      <li>
                        <strong>Earth fault loop:</strong> 0.45Ω (within limits)
                      </li>
                      <li>
                        <strong>RCD:</strong> 28ms @ 1x, 12ms @ 5x
                      </li>
                    </ul>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-4 space-y-1">
                      <li>
                        <strong>IR Test:</strong> &gt;999 MΩ all combinations
                      </li>
                      <li>
                        <strong>RCD Test:</strong> Normal operation restored
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="grid gap-4">
              ...
              <div className="grid md:grid-cols-3 gap-3 sm:gap-4">
                ...
                <div className="rounded-lg p-4 bg-transparent border border-green-400/30">
                  ...
                  <ul className="list-disc pl-4 space-y-1 text-sm">
                    <li>
                      <strong>Indoor dry:</strong> BW glands, IP54
                    </li>
                    <li>
                      <strong>Outdoor:</strong> CW glands, IP68
                    </li>
                    <li>
                      <strong>Underground:</strong> CW glands, IP68
                    </li>
                    <li>
                      <strong>Hazardous areas:</strong> E1W glands
                    </li>
                  </ul>
                </div>
              ...
              <div className="rounded-lg p-4 bg-transparent border border-green-400/30">
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    ...
                    <ul className="list-disc pl-4 space-y-1">
                      <li>
                        <strong>IP54:</strong> Dust protected, splash resistant
                      </li>
                      <li>
                        <strong>IP66:</strong> Dust tight, powerful water jets
                      </li>
                      <li>
                        <strong>IP67:</strong> Dust tight, temporary immersion
                      </li>
                      <li>
                        <strong>IP68:</strong> Dust tight, continuous immersion
                      </li>
                    </ul>
                  </div>
                  <div>
            ...
            <div className="grid gap-6">
              <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-border/30">
                ...
                <div className="mt-3 p-3 bg-red-400/20 rounded">
                  ...
                  <p className="text-sm">
                    Poor gland earth connections, corroded armour, loose earth tags, inadequate
                    bonding at joints, high source impedance.
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-border/30">
                ...
                <div className="mt-3 p-3 bg-orange-400/20 rounded">
                  ...
                  <p className="text-sm">
                    IR tester, clamp-on leakage meter, thermal imaging camera, moisture meter, cable
                    fault locator.
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-lg p-4 bg-elec-yellow/10 border border-elec-yellow/30">
                ...
                <div className="mt-3 p-3 bg-elec-yellow/20 rounded">
                  ...
                  <p className="text-sm">
                    Immediate disconnection if safe to do so, full joint replacement, thermal
                    imaging post-repair, load testing.
                  </p>
                </div>
              </div>
            </div>
