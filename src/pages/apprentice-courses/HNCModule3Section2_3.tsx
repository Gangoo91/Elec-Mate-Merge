...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Frequency', 'Phase angle', 'Angular velocity', 'Peak or RMS magnitude'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['50 rad/s', '314 rad/s', '157 rad/s', '100 rad/s'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['7 units', '1 unit', '12 units', '5 units'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Phase angle at t=0', 'Angular frequency', 'Peak voltage', 'Time period'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['OHM', 'SOHCAHTOA', 'WAPITI', 'CIVIL'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    id: 9,
    question:
      'A 7.5kW motor running at lagging power factor has a capacitor bank added. This would:',
    options: [
  ...
  },
  {
    ...
    options: ['0 degrees', '45 degrees', '90 degrees leading', '90 degrees lagging'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Power-quality and energy-monitoring CTs in a building services switchroom are
              specified by accuracy class AND phase displacement. A phase error of even a few
              minutes shows up as an apparent power-factor offset on the BMS metering screen —
              phasor arithmetic is the only way to interpret what the readings actually mean.
            </>
          }
        ...
        <ConceptBlock title="Sinusoidal Waveforms and Phase Angle">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>omega</strong> = angular frequency = 2 pi f (rad/s)
            </li>
            <li>
              <strong>t</strong> = time (seconds)
            </li>
            <li>
              <strong>phi</strong> = phase angle at t = 0 (degrees or radians)
            </li>
          </ul>
          <p className="text-sm font-medium text-white">Key relationships:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Angular frequency:</strong> omega = 2 pi f = 2 x 3.14159 x 50 = 314 rad/s (UK)
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>phi = 0 degrees:</strong> In phase with reference — No shift, standard sine
              wave
            </li>
            <li>
              <strong>phi = +30 degrees:</strong> Leads reference by 30 degrees — Shifted left
              (earlier in time)
            </li>
            <li>
              <strong>phi = -45 degrees:</strong> Lags reference by 45 degrees — Shifted right
              (later in time)
            </li>
            <li>
              <strong>phi = +90 degrees:</strong> Leads by quarter cycle — Starts at peak (cosine
              wave)
            </li>
            <li>
        ...
        <ConceptBlock title="Phasor Representation of AC Quantities">
          <p>
            ...
            circuit rotate at the same angular frequency omega, so we can "freeze" them and analyse
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Rectangular to polar:</strong> |V| = root(a squared + b squared); phi =
              arctan(b/a)
            </li>
          </ul>
          <p className="text-sm text-elec-yellow/70">
        ...
        <ConceptBlock title="Voltage-Current Phase Relationships in R, L, C">
          <p>
            ...
            relationship between voltage and current. Understanding these is essential for analysing
            AC circuits in building services.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">Component Phase Behaviour</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Resistor (R):</strong> V and I in phase (phi = 0 degrees). Ohm's law: V = IR
              at all instants. Example: Electric heaters, incandescent lamps
            </li>
            <li>
              <strong>Inductor (L):</strong> I lags V by 90 degrees (V leads I). Induced EMF opposes
              current change. Example: Motor windings, chokes, transformers
            </li>
            <li>
              <strong>Capacitor (C):</strong> I leads V by 90 degrees (V lags I). Current flows to
              charge plates before voltage builds. Example: PF correction capacitors, filter
              circuits
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">The CIVIL Mnemonic</p>
          <p>
            <strong>C-I-V-I-L:</strong> In a <strong>C</strong>apacitor, <strong>I</strong> leads{' '}
            <strong>V</strong>. In an <strong>I</strong>nductor (<strong>L</strong>),{' '}
            <strong>V</strong> leads <strong>I</strong>.
          </p>
          <p>
            The middle letters show which quantity leads: "IV" (I leads V) for capacitor, "VI" (V
            leads I) for inductor.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">Combined Circuits</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>RL circuit:</strong> Current lags voltage by angle between 0 degrees and 90
              degrees
            </li>
            <li>
              <strong>RC circuit:</strong> Current leads voltage by angle between 0 degrees and 90
              degrees
            </li>
            <li>
            ...
            <li>
              <strong>At resonance:</strong> X<sub>L</sub> = X<sub>C</sub>, phase angle = 0 degrees
              (purely resistive)
            </li>
          </ul>
          <p className="text-sm text-elec-yellow/70">
        ...
        <ConceptBlock title="Phasor Addition and Building Services Applications">
          ...
          <p>
            Special cases: theta = 0 degrees gives V<sub>1</sub> + V<sub>2</sub>; theta = 90 degrees
            gives root(V<sub>1</sub>
            <sup>2</sup> + V<sub>2</sub>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Motor starting:</strong> High inductive current (6-8x full load) at 0.2-0.3
              pf; current phasor nearly 90 degrees behind voltage
            </li>
            <li>
              <strong>Power factor correction:</strong> Capacitor current (leading) cancels
              inductive current (lagging); resultant closer to voltage reference
            </li>
            <li>
              <strong>Series voltage drops:</strong> V<sub>R</sub>, V<sub>L</sub>, V<sub>C</sub> add
              as phasors; supply = phasor sum of component voltages
            </li>
            <li>
              <strong>Parallel branch currents:</strong> Total current = phasor sum of branch
              currents (different phases)
            </li>
            <li>
              <strong>Three-phase systems:</strong> Line voltages = phasor difference between phases
              (120 degrees apart)
            </li>
          </ul>
          <p className="text-sm text-elec-yellow/70">
        ...
        <ConceptBlock title="Worked Examples">
          <p className="text-sm font-medium text-elec-yellow/80">
            Example 1: Sinusoidal Expression
          </p>
          <p>
            <strong>Question:</strong> UK mains voltage has RMS value 230V at 50Hz, referenced as 0
            degrees. Write the expression for instantaneous voltage.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>v = 325 sin(314t) volts</strong>
            </li>
            <li>or equivalently: v = 325 sin(100 pi t) volts</li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
            Example 2: Phase Angle from Power Factor
          </p>
          <p>
            <strong>Question:</strong> An AHU motor operates at 0.85 power factor lagging. Calculate
            the phase angle and describe the current phasor position.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              On phasor diagram: draw voltage at 0 degrees, current at -31.8 degrees (clockwise from
              voltage)
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
            Example 3: Phasor Addition for Series RL Circuit
          </p>
          <p>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">
            Example 4: Motor Starting Current Analysis
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Warning: This 90A starting current causes significant voltage drop on supply cables
              and may require star-delta or soft starter for larger installations
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
            Example 5: Power Factor Correction with Capacitors
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Target condition (pf = 0.95):</strong>
            </li>
            <li>
            ...
            <li>
              <strong>Capacitor required:</strong>
            </li>
            <li>
              kVAr<sub>C</sub> = kVAr<sub>1</sub> - kVAr<sub>2</sub> = 20.4 - 6.6
            </li>
            <li>
              <strong>Capacitor bank required: 13.8 kVAr (leading)</strong>
            </li>
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>
                V<sub>RMS</sub> = V<sub>m</sub> / root 2
              </strong>{' '}
              - RMS from peak
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              phase. Calculator in wrong mode (degrees vs radians). Forgetting to state whether the
              result is leading or lagging. Mixing RMS and peak values in the same calculation.
            </>
          }
          doInstead={
            <>
              Use CIVIL: C = I leads V, L = V leads I. Only add magnitudes directly when in phase;
              otherwise use phasor sum. Check calculator mode before using arccos/arctan. Always
              state direction (leading/lagging). Be explicit which value (RMS or peak) is being
              used.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              You have just energised a new variable-speed AHU fed from a 400 V three-phase VFD. The
              drive is showing a phase-rotation alarm and refusing to run. The building services BMS
              metering on the same supply reads correct line voltages but flags an unusual
              reverse-power indication on one of the CTs.
            </>
          }
          whatToDo={
            <>
              Sketch the supply phasor diagram — in a healthy 400 V system, V_L1, V_L2, V_L3 sit
              120° apart in positive sequence (L1 → L2 → L3 anticlockwise). Verify with a
              phase-rotation meter at the panel terminals. If the meter confirms reverse rotation,
              swap any two phases at the upstream feeder. The CT reverse-power flag is the same
              problem expressed in phasor terms — the current phasor on the misconnected channel is
              sitting 180° from where the BMS expects it. Re-check after the swap and clear both
              alarms.
            </>
          }
          whyItMatters={
            <>
              Phasor diagrams turn an abstract “phase rotation” alarm into a picture you can fix.
              Without phasor reasoning you would be guessing at terminations — with it, the
              diagnosis is one sketch and one swap.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Capacitance</div>
          </button>
          <button
