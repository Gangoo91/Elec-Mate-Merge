...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['90-95%', '20-30%', '60-80%', '40-50%'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['25-40%', '10-20%', '50-60%', '70-80%'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 5,
    question:
      'What grid electricity carbon factor does SAP 10.2 use for Part L compliance calculations?',
    options: ['0.233 kgCO₂e/kWh', '0.136 kgCO₂e/kWh', '0.519 kgCO₂e/kWh', '0.314 kgCO₂e/kWh'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Energy-related emissions, regulated vs unregulated loads, benchmarking methodologies, and
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The London Plan energy hierarchy + 35% improvement is the toughest UK regional
              standard — most other authorities are catching up. RIBA 2030 Climate Challenge sets
              voluntary EUI targets for all UK practice; LETI design guides translate these into
              specific m²/W limits, lighting density limits, and DHW design rules.
            </>
          }
        ...
        <ConceptBlock title="Understanding Operational Carbon">
          ...
          <p>
            <strong>Key components of operational carbon:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Energy sources:</strong> Grid electricity, natural gas, oil, biomass, district
              systems
            </li>
            <li>
          ...
          <p>
            <strong>Operational Carbon Calculation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Grid electricity:</strong> 0.193 kgCO₂e/kWh — SAP 10.2 methodology; decreasing
              annually
            </li>
            <li>
              <strong>Natural gas:</strong> 0.183 kgCO₂e/kWh — Including upstream emissions;
              relatively stable
            </li>
            <li>
              <strong>Heating oil:</strong> 0.247 kgCO₂e/kWh — Higher than gas; declining use
            </li>
            <li>
              <strong>LPG:</strong> 0.214 kgCO₂e/kWh — Common in off-grid locations
            </li>
            <li>
              <strong>Biomass (wood pellets):</strong> 0.015 kgCO₂e/kWh — Low operational carbon;
              consider supply chain
            </li>
          </ul>
          <p>
            <strong>Grid Decarbonisation Trajectory</strong>
          </p>
          <p>
          ...
          <p>
            This trajectory makes electrification (heat pumps) increasingly advantageous over gas
            heating.
          </p>
          <p>
        ...
        <ConceptBlock title="Regulated vs Unregulated Energy">
          <p>
            ...
            compliance calculations) and unregulated energy (not addressed by Part L). Understanding
            this distinction is crucial for predicting actual building performance and closing the
            'performance gap'.
          </p>
          <p>
            <strong>Regulated Loads (Part L)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Unregulated Loads (Not Part L)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Typical Energy Split by Building Type</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>General office:</strong> 60-75% — 25-40% — IT equipment, small power, lifts
            </li>
            <li>
              <strong>Retail (large):</strong> 50-65% — 35-50% — Refrigeration, escalators, display
            </li>
            <li>
              <strong>Hospital:</strong> 45-60% — 40-55% — Medical equipment, catering, lifts
            </li>
            <li>
              <strong>School:</strong> 70-85% — 15-30% — IT suites, catering, sports facilities
            </li>
            <li>
              <strong>Hotel:</strong> 55-70% — 30-45% — Catering, laundry, lifts, leisure
            </li>
          </ul>
          <p>
            <strong>The Performance Gap</strong>
          </p>
        ...
        <ConceptBlock title="Benchmarking Methodologies">
          ...
          <p>
            <strong>Energy Use Intensity (EUI) Calculation</strong>
          </p>
          <p>
            <span>EUI =</span> Total Annual Energy Consumption (kWh) ÷ Gross Internal Area (m²)
          </p>
          <p>
            <span>Example office building:</span>
          </p>
          ...
          <p>
            <strong>CIBSE TM46 Benchmarks (Selected Building Types)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>General office (nat vent):</strong> 95 — 120 — ~130
            </li>
            <li>
              <strong>General office (air-con):</strong> 128 — 107 — ~160
            </li>
            <li>
              <strong>Primary school:</strong> 32 — 113 — ~100
            </li>
            <li>
              <strong>Hospital (clinical):</strong> 90 — 300 — ~280
            </li>
            <li>
              <strong>Hotel:</strong> 105 — 200 — ~220
            </li>
            <li>
              <strong>Retail (supermarket):</strong> 365 — 105 — ~350
            </li>
          </ul>
          <p>
            <strong>LETI Net Zero Targets</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>NABERS UK Rating Scale</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Display Energy Certificate (DEC) Ratings</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Carbon Reduction Strategies">
          ...
          <p>
            <strong>Decarbonise Supply</strong>
          </p>
          <p>Heat pumps, solar PV, green tariffs, district heating, biomass</p>
          <p>
            <strong>Offset Residual</strong>
          </p>
          <p>Carbon credits, verified offsets (last resort for unavoidable emissions)</p>
          <p>
            <strong>Building Services Reduction Strategies</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lighting:</strong> LED retrofit with DALI controls — 60-80% — 2-4 years
            </li>
            <li>
              <strong>HVAC:</strong> Variable speed drives on fans/pumps — 30-50% — 2-3 years
            </li>
            <li>
              <strong>Heating:</strong> Air source heat pump (replacing gas) — 60-70% carbon — 7-12
              years
            </li>
            <li>
              <strong>Controls:</strong> BMS optimisation and scheduling — 10-20% — 1-2 years
            </li>
            <li>
              <strong>Ventilation:</strong> Demand-controlled ventilation (CO₂) — 20-40% — 3-5 years
            </li>
            <li>
              <strong>Generation:</strong> Rooftop solar PV — 10-30% electricity — 6-10 years
            </li>
          </ul>
          <p>
            <strong>Quick Wins (Low Cost, High Impact)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Strategic Investments (Higher Cost, Transformational)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Monitoring and Verification (M&V)</strong>
          </p>
          <p>Essential for demonstrating actual savings and maintaining performance:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              • <strong>Sub-metering:</strong> Disaggregate consumption by end-use (lighting, HVAC,
              small power)
            </li>
            <li>
              • <strong>Baselining:</strong> Establish pre-intervention performance for comparison
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Offsetting before reducing</strong> - follow the carbon hierarchy correctly
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              only). Twelve months of half-hourly metering shows actual total EUI at 195 kWh/m²/year
              — 2.6× design. Of the gap, ~30 kWh/m² is unregulated load (IT, kitchens, lifts) not
              modelled in SBEM, and ~90 kWh/m² is operational drift (BMS schedules, HVAC overrides,
              weekend running).
            </>
          }
          whatToDo={
            <>
              Convene a performance review — typically the BMS commissioning engineer, FM team,
              tenant occupier and original M&E designer. Verify (1) BMS scheduling matches
              commissioned strategy; (2) HVAC setpoints have not drifted; (3) lighting controls are
              functioning. Re-commission to design intent. Engage tenant on small power baseline
              (PCs, multi-screens, kitchen plug load). Set up annual TM22 energy audit to track.
              Report findings via a CIBSE TM63 In-Use Performance review.
            </>
          }
          whyItMatters={
            <>
              Part L design compliance is the floor, not the target. Net-zero-aligned buildings need
              post-occupancy verification — the gap between predicted and actual energy use is
              typically 30–80% for non-domestic, and the difference is mostly operational, not
              design. Soft Landings + TM63 + ISO 50001 are the institutional response.
            </>
          }
        />
