      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Definition:</strong> Step-by-step safe work procedures
              </li>
              <li className="pl-1">
                <strong>Purpose:</strong> Document how tasks will be completed safely
              </li>
              <li className="pl-1">
                <strong>Content:</strong> Tasks, hazards, controls, responsibilities
              </li>
              <li className="pl-1">
                <strong>Legal basis:</strong> CDM 2015, HASAWA 1974, MHSWR 1999
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Isolation:</strong> Safe de-energisation procedures
              </li>
              <li className="pl-1">
                <strong>Installation:</strong> Cable routing, containment, terminations
              </li>
              <li className="pl-1">
                <strong>Commissioning:</strong> Testing, energisation, handover
              </li>
              <li className="pl-1">
                <strong>RAMS:</strong> Combined with risk assessments
              </li>
            </ul>
          </div>
        </div>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Duty to provide safe systems of work (Section 2)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">MHSWR 1999</td>
                      <td className="border border-white/10 px-3 py-2">
                        Implement preventive and protective measures from risk assessments
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">CDM 2015</td>
                      <td className="border border-white/10 px-3 py-2">
                        Contractors must plan, manage, and monitor work safely
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">EAWR 1989</td>
                      <td className="border border-white/10 px-3 py-2">
                        Safe systems for electrical work, especially Regulation 14
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Project name, location, date, revision number, author, approver
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Clear description of what work is covered, boundaries, exclusions
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">Personnel</td>
                      <td className="border border-white/10 px-3 py-2">
                        Roles, responsibilities, competence requirements, supervision
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Tools, PPE, materials, inspection requirements
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Step-by-step work instructions in logical order
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Identified risks and specific control measures for each
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        First aid, emergency contacts, evacuation, incident reporting
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">Sign-off</td>
                      <td className="border border-white/10 px-3 py-2">
                        Signatures confirming reading and understanding
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Isolation, LOTO, proving dead, permit to work, insulated tools
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Arc flash</td>
                      <td className="border border-white/10 px-3 py-2">
                        De-energise where possible, arc-rated PPE, approach boundaries
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Working at height</td>
                      <td className="border border-white/10 px-3 py-2">
                        MEWP, scaffolding, edge protection, harness systems
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Manual handling</td>
                      <td className="border border-white/10 px-3 py-2">
                        Mechanical aids, team lifts, correct techniques, weight limits
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Dust/debris</td>
                      <td className="border border-white/10 px-3 py-2">
                        Local exhaust ventilation, dust sheets, RPE, wet cutting
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-white mb-6">
            Building Services Method Statement Examples
          </h2>

          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Electrical Isolation Method Statement
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Cable Installation in Occupied Building
              </h3>
              <div className="text-sm text-white space-y-3">
                <p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Commissioning Method Statement
              </h3>
              <div className="text-sm text-white space-y-3">
                <p>
