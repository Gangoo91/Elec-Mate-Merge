      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              work&rdquo;. As an HNC engineer the legal hook for issuing one (and the consequence of
              not having one) traces straight to s.2(2)(a).
            </>
          }
        ...
        <ConceptBlock title="Purpose and Scope of Method Statements">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Demonstrate competence to principal contractors and clients</li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HASAWA 1974</strong> — Requirement: Duty to provide safe systems of work
              (Section 2)
            </li>
            <li>
              <strong>MHSWR 1999</strong> — Requirement: Implement preventive and protective
              measures from risk assessments
            </li>
            <li>
              <strong>CDM 2015</strong> — Requirement: Contractors must plan, manage, and monitor
              work safely
            </li>
            <li>
              <strong>EAWR 1989</strong> — Requirement: Safe systems for electrical work, especially
              Regulation 14
            </li>
          </ul>
          ...
          <p className="text-sm text-white">
            Method statements are typically combined with risk assessments to form RAMS. The risk
            assessment identifies <strong>what</strong> could go wrong, while the method statement
            describes <strong>how</strong>
            work will be done safely. Together they provide comprehensive documentation of hazard
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            it documents procedures for competent workers who have the skills to carry out the work
            safely.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Content and Format Requirements">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Header Information</strong> — Content Required: Project name, location, date,
              revision number, author, approver
            </li>
            <li>
              <strong>Scope of Work</strong> — Content Required: Clear description of what work is
              covered, boundaries, exclusions
            </li>
            <li>
              <strong>Personnel</strong> — Content Required: Roles, responsibilities, competence
              requirements, supervision
            </li>
            <li>
              <strong>Equipment/Materials</strong> — Content Required: Tools, PPE, materials,
              inspection requirements
            </li>
            <li>
              <strong>Sequence of Operations</strong> — Content Required: Step-by-step work
              instructions in logical order
            </li>
            <li>
              <strong>Hazards and Controls</strong> — Content Required: Identified risks and
              specific control measures for each
            </li>
            <li>
              <strong>Emergency Procedures</strong> — Content Required: First aid, emergency
              contacts, evacuation, incident reporting
            </li>
            <li>
              <strong>Sign-off</strong> — Content Required: Signatures confirming reading and
              understanding
            </li>
          </ul>
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            short enough that workers will actually read them. Focus on the critical safety points.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Task Breakdown and Sequencing">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Preparation phase:</strong> Site access, permits, equipment checks, isolation
            </li>
            <li>
              <strong>Execution phase:</strong> Main work activities in logical sequence
            </li>
            <li>
              <strong>Completion phase:</strong> Testing, reinstatement, handover, demobilisation
            </li>
            <li>
              <strong>Dependencies:</strong> Identify tasks that must complete before others begin
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Isolation and lock-off</strong> — Before This Can Start: Any work on circuits
            </li>
            <li>
              <strong>Containment installation</strong> — Before This Can Start: Cable pulling
            </li>
            <li>
              <strong>Cable installation</strong> — Before This Can Start: Terminations
            </li>
            <li>
              <strong>Dead testing</strong> — Before This Can Start: Energisation
            </li>
            <li>
              <strong>Visual inspection</strong> — Before This Can Start: Live testing
            </li>
          </ul>
        ...
        <ConceptBlock title="Control Measures, Responsibilities and Emergency Procedures">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Electric shock</strong> — Control Measures: Isolation, LOTO, proving dead,
              permit to work, insulated tools
            </li>
            <li>
              <strong>Arc flash</strong> — Control Measures: De-energise where possible, arc-rated
              PPE, approach boundaries
            </li>
            <li>
              <strong>Working at height</strong> — Control Measures: MEWP, scaffolding, edge
              protection, harness systems
            </li>
            <li>
              <strong>Manual handling</strong> — Control Measures: Mechanical aids, team lifts,
              correct techniques, weight limits
            </li>
            <li>
              <strong>Dust/debris</strong> — Control Measures: Local exhaust ventilation, dust
              sheets, RPE, wet cutting
            </li>
          </ul>
          ...
          <CommonMistake
            ...
            whatHappens={
              <>
                <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
                  <li>
                    <strong>Electric shock:</strong> Isolate supply safely (do not touch victim
                    until isolated), call 999, commence CPR if trained and required
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Arc flash:</strong> Do not approach until supply confirmed isolated,
                    treat burns, call emergency services
                  </li>
                </ul>
              </>
            }
        ...
        <ConceptBlock title="Building Services Method Statement Examples">
          <p>
            <strong>Example 1: Electrical Isolation Method Statement</strong>
          </p>
          <div className="text-sm text-white space-y-3">
            ...
            <div className="bg-black/30 p-3 rounded">
              ...
              <p className="mt-3 text-white">
                <strong>Key controls:</strong> LOTO procedure, proving dead sequence, permit system
              </p>
            </div>
          </div>

          <p>
            <strong>Example 2: Cable Installation in Occupied Building</strong>
          </p>
          <div className="text-sm text-white space-y-3">
            <p>
            ...
            <div className="bg-black/30 p-3 rounded">
              ...
              <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
                ...
                <li>
                  <strong>Cable handling:</strong> Use drum stands, winches; minimum 2-person team
                  for heavy cables
                </li>
                <li>
                ...
                <li>
                  <strong>Housekeeping:</strong> Clear debris, secure cables, remove trip hazards at
                  end of shift
                </li>
              </ul>
            </div>
          ...
          <p>
            <strong>Example 3: Commissioning Method Statement</strong>
          </p>
          <div className="text-sm text-white space-y-3">
            <p>
            ...
            <div className="bg-black/30 p-3 rounded">
              ...
              <p className="mt-3 text-white">
                <strong>Hold point:</strong> Energisation requires supervisor authorisation after
                dead test verification
              </p>
            </div>
          </div>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical Guidance">
          <div>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>Visit the site before writing - understand actual conditions</li>
              <li>Involve workers who will do the job in the development</li>
              <li>Use active verbs: "isolate the supply" not "the supply should be isolated"</li>
              <li>Be specific about controls: "use 1100mm barriers" not "use barriers"</li>
          ...
          <div>
            <p>
              <strong>Review and Update Triggers</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              Your team must pull a 240 mm² four-core SWA up a 12-storey riser shaft to feed a new
              tenant&rsquo;s LV switchboard. The building is occupied, the shaft also carries
              fire-rated penetrations, and the existing services include lit life-safety cabling
              that must remain energised throughout.
            </>
          }
          whatToDo={
            <>
              Write the MS as a numbered sequence: pre-task brief, cable preparation, riser access
              permit, exclusion zones at each landing, lifting plan to LOLER 1998 (cable winch,
              pulleys, rated fixings), communications protocol, fire-stopping reinstatement at each
              penetration to BS 476-20, post-pull continuity check, sign off. Reference the parent
              risk assessment, the lifting plan, the permit-to-work and the COSHH assessment for the
              cable lubricant. Brief and sign in every operative.
            </>
          }
          whyItMatters={
            <>
              Riser pulls combine work at height, manual handling, lifting, fire-stopping and live
              electrical risks. A vague MS lets each risk fall through the gap between trades. A
              specific MS catches them.
            </>
          }
        />
