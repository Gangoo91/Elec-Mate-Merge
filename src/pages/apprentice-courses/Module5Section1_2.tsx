      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Types of Electrical Drawings</h3>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Drawing Types and Applications</p>
                    <p className="text-base text-foreground mb-2"><strong>Layout drawings:</strong> Show physical positions of electrical equipment.</p>
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Circuit diagrams (schematic):</strong> Show electrical connections between components.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Wiring diagrams:</strong> Detail cable cores, terminals, and specific connections.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Block diagrams:</strong> Simplified system overview.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Reading Symbols and Conventions</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>BS 7671 and BS EN standards:</strong> Provide consistent symbol definitions.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Common electrical symbols:</strong> Essential symbols for everyday installation work.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Legend importance:</strong> Always check for site-specific variations.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Drawing conventions:</strong> Standard practices for clear communication.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Scales and Dimensions</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-1">Scale Interpretation and Application</p>
                    <p className="text-base text-foreground mb-2"><strong>Common drawing scales:</strong> Understanding scale ratios and their applications.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Scale calculation:</strong> Converting drawing measurements to real dimensions.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Dimensional information:</strong> Precise measurements for accurate installation.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Setting out accuracy:</strong> Ensuring precise positioning on site.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Interpreting Circuit Information</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-emerald-400 mb-1">Circuit Organisation and Identification</p>
                    <p className="text-base text-foreground mb-2"><strong>Circuit grouping:</strong> How circuits are organised and distributed.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Cable and conductor identification:</strong> Understanding coding systems.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Protective devices:</strong> Understanding protection schemes.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Circuit routing:</strong> Understanding cable paths and installation methods.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Applying Drawings on Site</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-cyan-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Integration with specifications:</strong> Using drawings and specs together.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Site verification:</strong> Checking actual conditions against drawings.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Conflict resolution:</strong> Managing discrepancies and unclear information.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Quality control:</strong> Ensuring accuracy throughout installation.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      <li>Mark out positions before cutting or drilling</li>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Common Errors When Reading Drawings</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-red-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-red-600 dark:text-emerald-400 mb-1">Avoiding Common Drawing Interpretation Errors</p>
                    <p className="text-base text-foreground mb-2"><strong>Scale and dimension errors:</strong> Measurement and positioning mistakes.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Symbol interpretation errors:</strong> Misunderstanding drawing symbols.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Information oversight:</strong> Missing important drawing details.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Site assumption errors:</strong> Not verifying actual conditions.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="rounded-lg p-4 bg-card border border-amber-400/30">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-foreground mb-2">School Refurbishment Symbol Mix-Up</p>
        ...
        {/* Pocket Guide */}
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-4">Pocket Guide: Reading Electrical Drawings</h2>
