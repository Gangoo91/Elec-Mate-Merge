...
const TITLE =
  'Reading Basic Electrical Installation Drawings - Module 5.1.2 | Level 2 Electrical Course';
const DESCRIPTION =
  'Master electrical drawing interpretation - understand symbols, scales, circuits and layouts. Essential skills for accurate installation work and BS 7671 compliance.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      'It shows which symbols are non-standard',
      'It lists the materials needed for the job',
      'It identifies which conductor is live',
...
const Module5Section1_2 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: [
        '50 units on the drawing equal 1 unit in real life',
        'The drawing is 50% of full size',
        'There are 50 circuits shown on the drawing',
    ...
    },
    {
      ...
      options: [
        ...
        'It shows the order to install equipment',
        'Because symbols may vary between drawings or projects',
        'It lists the dimensions for every circuit',
      ],
      correctAnswer: 2,
      explanation:
    ...
    },
    {
      ...
      options: [
        ...
        'The order in which circuits are tested',
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Common errors include misreading the scale, ignoring important notes, mixing up symbols, and not checking legends.',
    },
    {
      id: 10,
      question: 'Drawings and specifications must be used together. Why?',
      options: [
        'Because the drawing replaces the need for a legend',
        'Because specifications show the physical layout',
        'Because drawings show where to install, and specifications explain how',
        'Because drawings give the cost and specifications the timescale',
      ],
      correctAnswer: 2,
      explanation:
  ...
  const faqs = [
    {
      ...
      answer:
        'No - architectural drawings show building layout, structure, and general arrangements. Electrical drawings focus specifically on circuits, containment, equipment positions, and electrical connections.',
    },
    {
      question: 'What if site conditions differ from the drawing?',
      answer:
        'Stop work and confirm with the supervisor or project manager before making any changes. Document the difference and obtain written approval for any modifications to avoid disputes later.',
    },
    {
      question: 'Do all drawings use the same symbols?',
      answer:
        'Most follow BS standards, but there can be variations. Always check the legend and symbol key for each set of drawings as different designers may use slight variations or additional symbols.',
    },
    {
      question: 'How do I know which drawing to use for different tasks?',
      answer:
        'Layout drawings for positioning equipment, circuit diagrams for understanding electrical connections, wiring diagrams for detailed connections, and block diagrams for overall system understanding.',
    },
    {
      question: 'What should I do if a drawing is unclear or seems to contain errors?',
      answer:
        "Don't guess or make assumptions. Raise the issue immediately with your supervisor, document your concerns in writing, and obtain clarification before proceeding with the work.",
    },
  ];
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1 text-white text-sm">
                  ...
                  <li>
                    <strong>Use:</strong> Layout drawings for positioning, schematics for
                    connections, legends for symbols.
                  </li>
                  <li>
                    <strong>Check:</strong> Scale, dimensions, site conditions, conflicts with
                    specs.
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="mb-2">
                  <strong className="text-white">Layout drawings:</strong> Show physical positions
                ...
                <p className="mb-2">
                  <strong className="text-white">Circuit diagrams (schematic):</strong> Show
                ...
                <p className="mb-2">
                  <strong className="text-white">Wiring diagrams:</strong> Detail cable cores,
                  terminals, and specific connections.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="mb-2">
                  <strong className="text-white">Block diagrams:</strong> Simplified system
                  overview.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <p className="mb-2">
                  <strong className="text-white">BS 7671 and BS EN standards:</strong> Provide
                  consistent symbol definitions.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="mb-2">
                  <strong className="text-white">Common electrical symbols:</strong> Essential
                  symbols for everyday installation work.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="mb-2">
                  <strong className="text-white">Legend importance:</strong> Always check for
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <p className="mb-2">
                  <strong className="text-white">Common drawing scales:</strong> Understanding scale
                ...
                <p className="mb-2">
                  <strong className="text-white">Scale calculation:</strong> Converting drawing
                  measurements to real dimensions.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="mb-2">
                  <strong className="text-white">Dimensional information:</strong> Precise
                  measurements for accurate installation.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-orange-500/50">
                <p className="font-medium text-white mb-3">
                  Circuit Organisation and Identification
                </p>

                <p className="mb-2">
                  <strong className="text-white">Circuit grouping:</strong> How circuits are
                ...
                <p className="mb-2">
                  <strong className="text-white">Cable and conductor identification:</strong>{' '}
                ...
                <p className="mb-2">
                  <strong className="text-white">Protective devices:</strong> Understanding
                  protection schemes.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-cyan-500/50">
                ...
                <p className="mb-2">
                  <strong className="text-white">Integration with specifications:</strong> Using
                  drawings and specs together.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="mb-2">
                  <strong className="text-white">Site verification:</strong> Checking actual
                  conditions against drawings.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="mb-2">
                  <strong className="text-white">Conflict resolution:</strong> Managing
                  discrepancies and unclear information.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-red-500/50">
                <p className="font-medium text-white mb-3">
                  Avoiding Common Drawing Interpretation Errors
                </p>

                <p className="mb-2">
                  <strong className="text-white">Scale and dimension errors:</strong> Measurement
                ...
                <p className="mb-2">
                  <strong className="text-white">Symbol interpretation errors:</strong>{' '}
                  Misunderstanding drawing symbols.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="mb-2">
                  <strong className="text-white">Information oversight:</strong> Missing important
                  drawing details.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-white">
                  ...
                  <p className="text-sm mb-3">
                    ...
                    throughout the building. Without checking the drawing legend, they assumed all
                    switch symbols were standard single-pole switches.
                  </p>
                  <p className="text-sm mb-3">
                  ...
                  <p className="text-sm mb-3">
                    The apprentice installed single switches throughout, including locations that
                    required two-way and intermediate switching. When the lighting was tested,
                    multiple corridors had lights that could only be controlled from one end,
                    creating safety issues for evacuation routes.
                  </p>
                  <p className="text-sm mb-3">The consequences included:</p>
                  <ul className="text-sm list-disc ml-4 space-y-1 mb-3">
                    ...
                    <li>
                      Failed Building Control inspection due to inadequate emergency lighting
                      control
                    </li>
                  </ul>
                  <p className="text-sm font-medium text-white">
                    <strong>Lesson learned:</strong> Always check the legend first - never assume
                    symbol meanings, even for apparently "standard" symbols.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Always read</strong> the title block (project
                    name, date, scale).
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                  <span>
                    <strong className="text-white">Check</strong> the legend for symbols and
                    abbreviations.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                  <span>
                    <strong className="text-white">Identify</strong> the type of drawing (layout,
                    schematic, wiring).
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                  <span>
                    <strong className="text-white">Cross-check</strong> against specifications and
                    site conditions.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
                  <span>
                    <strong className="text-white">Use drawings</strong> as a live reference — not
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4">
              ...
              <p className="mt-4 font-medium text-elec-yellow">
                Accurate drawing interpretation ensures safe, compliant, and efficient installations
                whilst preventing costly errors and rework.
              </p>
            </div>
          </section>
