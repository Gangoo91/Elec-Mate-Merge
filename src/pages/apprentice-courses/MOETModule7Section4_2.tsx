...
const DESCRIPTION =
  'Effective communication techniques for electrical maintenance technicians: verbal and written reporting, technical communication, handover procedures and professional reporting for EPA assessment under ST1426.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Active listening means fully focusing on the speaker, understanding their message, asking clarifying questions and providing feedback to confirm understanding. In maintenance, this is critical during briefings, handovers and fault reporting where missing a detail can have serious safety or operational consequences.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "Professional emails should have a clear subject line (e.g., 'Urgent: Earth fault on DB7 — Block C'), a concise description of the issue, relevant technical details (readings, observations, location) and a clear statement of any action required or expected. This ensures the recipient has all the information needed to respond appropriately.",
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Effective communication should be clear (easy to understand), concise (no unnecessary words) and confirmed (the recipient acknowledges understanding). In safety-critical maintenance environments, confirmation is particularly important — never assume your message has been understood without checking.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A complete fault report includes: precise location (building, floor, equipment ID), symptoms observed, test results and readings, your diagnosis and reasoning, any immediate actions taken (isolation, barriers), and recommended next steps. This gives the supervisor all the information needed to make decisions and allocate resources.',
  },
  {
    id: 4,
  ...
  },
  {
    id: 6,
    question:
      'When communicating technical information to a non-technical audience (e.g., a building manager), you should:',
    options: [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "The phonetic alphabet (Alpha, Bravo, Charlie...) prevents misidentification of letters in noisy environments or over radio. In maintenance, misidentifying a circuit reference (e.g., 'B' misheard as 'D') could mean working on the wrong circuit. Using 'Bravo' instead of 'B' removes ambiguity and is standard practice in many industrial settings.",
  },
  {
    id: 8,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Maintenance environments present multiple communication barriers: high noise levels in plant areas, time pressure during breakdowns, excessive technical jargon, assumptions that others already know, and a reluctance to challenge more senior colleagues. Awareness of these barriers is the first step to overcoming them.',
  },
  {
    id: 11,
    ...
    correctAnswer: 1,
    explanation:
      'Closed-loop communication is a safety-critical technique: the sender delivers the message, the receiver repeats it back in their own words, and the sender confirms the repeat is correct. This three-step process eliminates misunderstandings. It is standard practice in HV switching operations and should be used for any safety-critical information exchange.',
  },
  {
    id: 12,
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              results, you are communicating information that others will use to make decisions. If
              that communication is unclear, incomplete or inaccurate, the consequences can range
              from wasted time and repeated work to serious safety incidents.
            </p>
            <p>
              The ST1426 standard recognises communication as a core professional behaviour. The EPA
              assesses not just what you know and what you can do, but how effectively you can
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              handovers, the ability to convey information clearly and listen actively is essential
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              logs and technical reports all form part of the documentary evidence trail that
              organisations rely on for compliance, audit, trending and continuous improvement. Your
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              safety officers, clients and — during your EPA — an independent assessor. Each
              audience has a different level of technical knowledge and different information needs.
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              commercial organisations, and the quality of data entered by technicians directly
              affects maintenance planning, performance reporting and asset management decisions.
