      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Main switchboard:</strong> Receives DNO supply, distributes to building
              </li>
              <li className="pl-1">
                <strong>Form of separation:</strong> 1-4 defines internal compartmentalisation
              </li>
              <li className="pl-1">
                <strong>IP rating:</strong> Protection against solids and liquids
              </li>
              <li className="pl-1">
                <strong>Fault rating:</strong> Must exceed prospective fault current
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Standard:</strong> BS EN 61439 for type-tested assemblies
              </li>
              <li className="pl-1">
                <strong>Clearances:</strong> 700mm minimum working space
              </li>
              <li className="pl-1">
                <strong>Environment:</strong> IP rating matched to location
              </li>
              <li className="pl-1">
                <strong>Future-proofing:</strong> 20-30% spare capacity typical
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Distribute power to sub-distribution boards and major loads
                </li>
                <li className="pl-1">
                  Incorporate protective devices for fault current interruption
                </li>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        One set of busbars serving all circuits
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Standard buildings, non-critical
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Bus section</td>
                      <td className="border border-white/10 px-3 py-2">
                        Single busbar split by section switch
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Partial shutdown for maintenance
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Duplicate busbar</td>
                      <td className="border border-white/10 px-3 py-2">
                        Two busbars with bus coupler
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Critical facilities, high availability
                      </td>
                    </tr>
                    <tr>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Small DBs, full isolation for work
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        As 2a plus terminals in same compartment
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Standard distribution boards
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Busbars and all units separated
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        As 3a plus terminals separate from busbars
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Main switchboards, live working
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Form 4a</td>
                      <td className="border border-white/10 px-3 py-2">
                        All separate including terminals in unit
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        All separate including external terminals
                      </td>
                      <td className="border border-white/10 px-3 py-2">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                IP Ratings for Building Services Locations
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Controlled access, clean environment
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Tools may be present, some dust
                      </td>
                    </tr>
                    <tr>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Maximum fault current device can break
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Breaking capacity for continued use
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Current assembly can carry for 1 second
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Peak value of fault current tolerated
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Typical PFC Values in Building Services
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Specifying Form of Separation
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2">
                  Specification: <strong>IP54 minimum</strong>
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Fault Rating Verification
              </h3>
              <p className="text-sm text-white mb-2">
