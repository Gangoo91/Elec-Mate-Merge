...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Making capacity', 'Breaking capacity', 'Peak withstand', 'Short-time withstand'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['BS 7671', 'BS EN 61439', 'BS EN 60947', 'BS 88'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['700mm minimum', '900mm minimum', '500mm minimum', '1200mm minimum'],
    correctAnswer: 0,
    explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/h-n-c-module4-section5"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 510.3 is the umbrella that ties the BS EN 61439 type-test certificate to the wider
              BS 7671 verification. The MSB has to be selected against the prospective fault current
              at the origin (Chapter 43), the disconnection times for the downstream circuits
              (Chapter 41), the ambient/IP/IK environment (Chapter 52), and the manufacturer’s
              installation/torque/cable termination instructions. Skip any of those and the
              assembly’s type-test certificate doesn’t cover you.
            </>
          }
        ...
        <ConceptBlock title="Main Switchboards">
          <p>
            The main switchboard (MSB) is the central point for power distribution in a building. It
            receives the incoming supply from the Distribution Network Operator (DNO) and
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Bus section:</strong> Single busbar split by section switch — partial shutdown
              for maintenance
            </li>
            <li>
              <strong>Duplicate busbar:</strong> Two busbars with bus coupler — critical facilities,
              high availability
            </li>
            <li>
          ...
          <p>
            <strong>Design principle:</strong> Always specify 20-30% spare capacity in switchboards
            for future expansion. Adding ways later is expensive and disruptive.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Form of Separation">
          ...
          <p>
            <strong>
              Forms of internal separation (form / separation provided / typical application):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Specification tip:</strong> Form 3b is commonly specified for main switchboards
            where occasional terminal work may be needed without complete shutdown.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="IP Ratings">
          <p>
            ...
            against solid objects and liquids. Correct IP selection ensures equipment reliability in
          ...
          <p>
            <strong>
              IP ratings for building services locations (location / minimum IP / reason):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Fault Ratings and Type-Tested Assemblies">
          <p>
            ...
            ratings ensures equipment selection matches the prospective fault current (PFC) at each
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — specifying form of separation:</strong> A main switchboard serves a
            hospital with 24/7 operations. Maintenance must be possible with minimum disruption.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Critical loads cannot be interrupted</li>
        ...
        <Scenario
          ...
          situation={
            <>
              You’re specifying the main switchboard for a new 1,800 m² light-industrial unit: 400 V
              TP+N, 800 A incomer, DNO advised PFC of 25 kA at the cut-out, plant room location with
              occasional damp ingress through the ventilation louvres. Spec is due with the
          ...
          whatToDo={
            <>
              ...
              clear circuit identification. IP54 (against the damp plant room and to keep dust out
              of the busbar chamber). Incomer: 800 A 4-pole ACB with motorised operation, Icu = 50
              kA, Ics ≥ 50 kA (give yourself headroom over the 25 kA PFC for future supply
              upgrades). Outgoing MCCBs sized per the load schedule, 36 kA Ics minimum. Add a surge
              protection device at the origin (Reg 443/534 territory). Tie the specification back to
              Reg 510.3 — manufacturer’s torque tables, IP54 maintenance regime, ambient ≤ 40 °C
              derating curve. Document the PFC, the type-test certificate references, and the
              form-of-separation drawing in the O&amp;M.
            </>
          }
          whyItMatters={
            <>
              Under-specifying Ics means a device that trips on a fault but can’t re-close safely —
              at 25 kA PFC, that’s a switchboard fire. Over-specifying form of separation needlessly
              inflates the cost. This is where the HNC engineer earns their fee.
            </>
          }
        />
