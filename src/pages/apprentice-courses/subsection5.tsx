...
const DESCRIPTION =
  'Master essential electrical measuring instruments for safe testing and fault finding. Learn voltage indicators, multimeters, continuity testers and safety procedures.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'A proving unit provides a known voltage source to check that your voltage indicator is working correctly before and after testing.',
  },
  {
    id: 2,
  ...
  const faqs = [
    {
      ...
      answer:
        'Voltage indicators are designed specifically for safety (proving dead) with GS38 compliance. Multimeters are measurement tools for fault finding and testing but should never be used for isolation verification.',
    },
    {
      question: 'Why do I need a proving unit?',
      answer:
        'A proving unit provides a known voltage source to verify your voltage indicator is working before and after testing. This ensures your safety equipment is functioning correctly when you rely on it to prove circuits dead.',
    },
    {
      question: 'Can I use any multimeter for electrical work?',
      answer:
        "Use only quality multimeters with proper safety ratings (CAT ratings) appropriate for the voltage levels you're working with. Check leads and probes for damage before each use.",
    },
    {
      question: 'What happens if my continuity reading is high?',
      answer:
        'High resistance readings (far from 0 ohms) may indicate poor connections, damaged conductors, or incomplete circuits. Investigate and rectify before energising the circuit.',
    },
    {
      question: 'How often should test equipment be calibrated?',
      answer:
        'Follow manufacturer recommendations and company procedures. Typically annually for precision instruments, but check before each use for damage and basic function with proving units.',
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-base text-foreground">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  Different tools for different purposes: proving dead, fault finding, testing.
                </li>
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Voltage indicators, proving units, multimeters, continuity
                  testers.
                </li>
                <li>
                  <strong>Use:</strong> Safe isolation verification, fault finding, circuit testing.
                </li>
                <li>
                  <strong>Check:</strong> Equipment condition, calibration dates, probe safety.
                </li>
              </ul>
            </div>
          </div>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            ...
            <p className="text-base text-foreground mb-4">
              Voltage indicators and proving units are fundamental safety equipment for electrical
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-elec-yellow dark:text-elec-yellow mb-1">
                      Voltage Indicators - Essential Safety Equipment
                    </p>
                    <p className="text-base text-foreground mb-2">
                      <strong>Purpose and design:</strong> Specifically designed for proving
                      circuits dead safely.
                    </p>
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Proving units:</strong> Essential companion equipment for safety
                      verification.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Safety procedures:</strong> Critical for electrical worker protection.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Critical safety rule:</strong> Always use GS38-compliant voltage
                      indicators with proving units for isolation verification
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-6">
            ...
            <p className="text-base text-foreground mb-4">
              Continuity testers verify electrical connections and conductor integrity for safe
              circuit operation:
            </p>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Purpose and function:</strong> Measure resistance to verify electrical
                      connections.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Common applications:</strong> Essential verification tests for
                      electrical safety.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Testing procedures:</strong> Systematic approach for accurate results.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Good practice:</strong> Always isolate circuits completely before
                      continuity testing and verify instrument calibration
                    </div>
                  </div>
                </div>
              </div>
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">
              Multimeters - Versatile Measurement Tools
            </h3>
            <p className="text-base text-foreground mb-4">
              Multimeters are versatile instruments for general electrical measurements and fault
              finding:
            </p>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-elec-yellow mb-1">
                      Multimeter Capabilities and Safe Use
                    </p>
                    <p className="text-base text-foreground mb-2">
                      <strong>Measurement capabilities:</strong> Multiple electrical quantities in
                      one instrument.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Safety requirements:</strong> Critical for safe operation and accurate
                      results.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Applications and limitations:</strong> Understanding proper use and
                      restrictions.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Important limitation:</strong> Never use multimeters for
                      safety-critical isolation verification - use dedicated voltage indicators
                    </div>
                  </div>
                </div>
              </div>
