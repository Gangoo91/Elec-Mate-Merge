...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['5 days', '10 days', '8 days', '25 days'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['16 person-weeks', '4 person-weeks', '12 person-weeks', '7 person-weeks'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['50 hours', '12.5 hours', '6.25 hours', '25 hours'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Labour allocation, materials procurement, plant requirements and resource optimisation for
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Resource planning is one of the practical means by which a principal contractor
              evidences Reg 13 compliance. Over-loading a workface (too many trades in one zone) is
              a Reg 13 breach as much as a productivity problem — you cannot manage the construction
              phase if you have not planned the resources.
            </>
          }
        ...
        <ConceptBlock title="Resource Histograms and Levelling">
          ...
          <p>
            By delaying non-critical activities and extending durations, peaks of 12-14 are reduced
            to maximum 8, matching available resources.
          </p>
          <p>
        ...
        <ConceptBlock title="Materials Procurement Planning">
          <p>
            Effective material procurement ensures items arrive when needed without excessive early
            delivery consuming storage space and working capital. Lead time management is critical
            for long lead items that can delay the entire project if not ordered promptly.
          </p>
          <p>
        ...
        <ConceptBlock title="Plant Requirements and Productivity Factors">
          ...
          <p>
            ...
            Factor × Occupancy Factor. Example: 40m/day × 0.65 (MEWP) × 0.80 (occupied) = 20.8m/day.
          </p>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — Labour Duration Calculation:</strong> Calculate the labour duration
            for installing 450m of cable tray at 4m height using scissor lifts. Base productivity is
            40m/day.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 2 — Resource Levelling:</strong> Week 3 shows demand for 14 electricians
            but only 10 are available. Activity B has 2 weeks float. How can this be resolved?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 — Material Delivery Schedule:</strong> Main LV switchgear is required
            on site by Week 20. Lead time is 14 weeks. When must the order be placed and what
            precedes it?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              To recover a slipped programme, the project director instructs you to add a second
              shift of electricians on the Level 4 fit-out. Your resource histogram now shows 28
              operatives concurrent in a 600 m² zone, alongside the mechanical second-fix gang of 12
              and ceiling installers of 9. Within a week the HSE inspector visits after a near-miss
              with a falling tool — overcrowding is cited.
            </>
          }
          whatToDo={
            <>
              Halt the doubling-up. Re-resource against the programme using zoning: split Level 4
              into east and west halves with electrical leading east one week, mechanical the next,
              ceilings following. Update the resource histogram and the construction phase plan.
              Brief the foremen. The genuine recovery comes from sequence and zoning, not headcount.
            </>
          }
          whyItMatters={
            <>
              Workface density is both a productivity issue (rework, wasted travel time, supervision
              dilution) and a CDM Reg 13 issue. The HSE will judge whether the principal contractor
              planned resources properly — your histogram and zoning plan is the answer.
            </>
          }
        />
