...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['2.0 to 2.5 metres', '0.5 to 0.8 metres', '3.0 to 4.0 metres', '1.0 to 1.5 metres'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['4-6°C', '14-18°C', '8-12°C', '20-24°C'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['£7,500', '£10,000', '£5,000', '£6,000'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['10% ethylene glycol', 'Pure water', '25% propylene glycol', '50% methanol'],
    correctAnswer: 2,
    explanation:
...
const HNCModule6Section2_2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 2 · Subsection 2"
        title="Heat Pump Technology"
        backTo="/study-centre/apprentice/h-n-c-module6-section2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          ASHP and GSHP systems, COP and SCOP performance metrics, system design principles, and MCS
        ...
        <RegsCallout
          ...
          meaning={
            <>
              MIS 3005 is the practical standard — it sits above MCS 015 (the product certification
              scheme). Every BUS-funded installation and every dwelling claiming heat-pump SAP
              credits must be MIS 3005 compliant. Sizing per BS EN 12831 (room-by-room heat loss) is
              mandatory; rule-of-thumb sizing forfeits the certification and the grant.
            </>
          }
        ...
        <ConceptBlock title="Heat Pump Operating Principles">
          <p>
            Heat pumps extract low-grade heat from ambient sources (air, ground, or water) and
            upgrade it to useful temperatures for space heating and hot water. They operate on the
            vapour compression cycle, using electrical energy to drive a compressor that transfers
            heat from a cold source to a warmer sink.
          </p>
          <p>
            <strong>The Refrigeration Cycle in Heat Pumps:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Evaporator:</strong> Low-pressure refrigerant absorbs heat from the source
              (air/ground), evaporating from liquid to gas
            </li>
            <li>
              <strong>Compressor:</strong> Raises refrigerant pressure and temperature using
              electrical energy
            </li>
            <li>
              <strong>Condenser:</strong> High-pressure refrigerant releases heat to the heating
              system, condensing back to liquid
            </li>
            <li>
              <strong>Expansion valve:</strong> Reduces pressure, cooling refrigerant ready to
              absorb heat again
            </li>
          </ul>
          <p>
            <strong>Air Source vs Ground Source Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Heat source temperature:</strong> -15°C to +35°C (variable) — 8-12°C (stable)
            </li>
            <li>
              <strong>Typical SCOP:</strong> 2.8 - 3.5 — 3.5 - 4.5
            </li>
            <li>
              <strong>Installation cost (typical):</strong> £8,000 - £15,000 — £15,000 - £35,000
            </li>
            <li>
              <strong>Land requirement:</strong> Outdoor unit location only — Borehole or extensive
              trenching
            </li>
            <li>
              <strong>Defrost cycles:</strong> Required in cold/humid conditions — Not required
            </li>
            <li>
              <strong>Noise considerations:</strong> Fan noise requires assessment — Indoor
              equipment only
            </li>
          </ul>
          <p>
            <strong>Key principle:</strong> The smaller the temperature lift (difference between
            source and output), the higher the efficiency. This is why heat pumps work best with
        ...
        <ConceptBlock title="COP and SCOP Performance Metrics">
          <p>
            ...
            and predicting running costs. COP and SCOP provide different but complementary measures
            of performance.
          </p>
          <p>
            <strong>COP Calculation</strong>
          </p>
          <p>
            <span>COP = Heat Output (kW) ÷ Electrical Input (kW)</span>
          </p>
          <p>Example:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Heat output:</strong> 12 kW
            </li>
            <li>
              <strong>Electrical input:</strong> 3 kW
            </li>
            <li>
              <strong>COP:</strong> 12 ÷ 3 = 4.0
            </li>
          </ul>
          <p>Energy delivered: 4 kW heat for every 1 kW electricity</p>
          <p>
            <strong>COP (Coefficient of Performance)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>SCOP (Seasonal COP)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Factors Affecting COP</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Source temperature ↑:</strong> COP increases — GSHP preferred in cold climates
            </li>
            <li>
              <strong>Flow temperature ↓:</strong> COP increases — Design for 35-45°C where possible
            </li>
            <li>
              <strong>Part-load operation:</strong> Inverter units maintain efficiency — Avoid
              oversizing fixed-speed units
            </li>
            <li>
              <strong>Defrost cycles:</strong> Reduces effective output — Allow for defrost in ASHP
              sizing
            </li>
            <li>
              <strong>Cycling frequency:</strong> Frequent cycling reduces SCOP — Buffer vessels or
              modulating units
            </li>
          </ul>
          <p>
            <strong>Running Cost Calculation Example</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Annual heat demand:</strong> 18,000 kWh
            </li>
            <li>
              <strong>SCOP:</strong> 3.2
            </li>
            <li>
              <strong>Electricity required:</strong> 18,000 ÷ 3.2 = 5,625 kWh
            </li>
            <li>
              <strong>Electricity rate:</strong> 24p/kWh
            </li>
            <li>
              <strong>Annual running cost:</strong> 5,625 × £0.24 = £1,350
            </li>
          </ul>
          <p>Compare: Gas boiler (90% efficiency, 7p/kWh) = £1,400/year</p>
          <p>
            <strong>Efficiency benchmark:</strong> MCS requires a minimum SPF (Seasonal Performance
            Factor) of 2.5 for installations to qualify for incentive schemes.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="System Design and Sizing">
          <p>
            Correct sizing is critical for heat pump performance. Undersizing leads to comfort
            issues and supplementary heating dependency; oversizing causes cycling, reduced
            efficiency, and wasted capital expenditure.
          </p>
          <p>
            <strong>Heat Loss Calculation Process (MCS MIS 3005)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Room-by-room calculation:</strong> Calculate fabric and ventilation losses for
              each room
            </li>
            <li>
              <strong>U-values:</strong> Use actual or estimated values for walls, roof, floor,
              windows, doors
            </li>
            <li>
              <strong>Design temperatures:</strong> Internal 21°C, external typically -3°C for most
              UK locations
            </li>
            <li>
              <strong>Ventilation:</strong> Air change rates based on room type and building
              airtightness
            </li>
            <li>
              <strong>Thermal bridging:</strong> Add allowance for heat loss at junctions (typically
              10-15%)
            </li>
          </ul>
          <p>
            <strong>Heat Loss Calculation Example</strong>
          </p>
          <p>Living room: 5m × 4m × 2.4m ceiling</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>External wall area:</strong> 12 m² (after windows)
            </li>
            <li>
              <strong>U-value:</strong> 0.35 W/m²K
            </li>
            <li>
              <strong>Temperature difference:</strong> 21 - (-3) = 24K
            </li>
            <li>
              <strong>Wall loss:</strong> 12 × 0.35 × 24 = 100.8 W
            </li>
          </ul>
          <p>+ Window loss + Floor loss + Roof loss + Ventilation loss</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Total room heat loss:</strong> 850 W
            </li>
          </ul>
          <p>
            <strong>Emitter Sizing for Low Temperatures</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>75/65°C (boiler):</strong> 70°C — 1.00 — Baseline
            </li>
            <li>
              <strong>55/45°C:</strong> 50°C — 0.52 — 1.9× larger
            </li>
            <li>
              <strong>45/40°C:</strong> 42.5°C — 0.37 — 2.7× larger
            </li>
            <li>
              <strong>35/30°C (UFH):</strong> 32.5°C — 0.21 — 4.8× larger
            </li>
          </ul>
          <p>
            <strong>Buffer Vessel Sizing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Hot Water Cylinder Sizing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Sizing rule:</strong> For ASHP, allow 10-15% additional capacity for defrost
            impact. Never size to peak load only - consider annual energy requirements and part-load
            efficiency.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="MCS Certification and BUS Grant Requirements">
          <p>
            ...
            installations in the UK. MCS certification is mandatory for accessing government
            incentive schemes including the Boiler Upgrade Scheme (BUS).
          </p>
          <p>
            <strong>MCS Heat Pump Standard (MIS 3005) Key Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Heat loss calculation:</strong> Room-by-room to approved methodology
            </li>
            <li>
              <strong>System design:</strong> Documented design including all components
            </li>
            <li>
              <strong>Product certification:</strong> Heat pump must be MCS-certified product
            </li>
            <li>
              <strong>Installer certification:</strong> Company must hold MCS installer certificate
            </li>
            <li>
              <strong>Commissioning:</strong> Full commissioning to manufacturer requirements
            </li>
            <li>
              <strong>Documentation:</strong> Comprehensive handover pack for customer
            </li>
          </ul>
          <p>
            <strong>Boiler Upgrade Scheme (BUS) - Key Facts</strong>
          </p>
          <p>
            <strong>Grant values (2024):</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              - Air source heat pump: <strong>£7,500</strong>
            </li>
            <li>
              - Ground source heat pump: <strong>£7,500</strong>
            </li>
            <li>
              - Biomass boiler (rural only): <strong>£5,000</strong>
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>MCS Documentation Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Heat loss calculation:</strong> Justifies system sizing — Pre-installation
            </li>
            <li>
              <strong>System design:</strong> Component specification — Pre-installation
            </li>
            <li>
              <strong>Commissioning record:</strong> Performance verification — Completion
            </li>
            <li>
              <strong>MCS certificate:</strong> Scheme compliance — Post-installation
            </li>
            <li>
              <strong>Handover pack:</strong> Customer information — Handover
            </li>
            <li>
              <strong>Electrical certificate:</strong> BS 7671 compliance — Completion
            </li>
          </ul>
          <p>
            <strong>Electrical Installation Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Supply capacity:</strong> Verify DNO supply adequate (typically 60-100A single
              phase, or three phase)
            </li>
            <li>
              <strong>Dedicated circuit:</strong> Separate MCB/RCBO for heat pump (typically 20-32A)
            </li>
            <li>
              <strong>Isolator:</strong> Local isolation adjacent to outdoor unit
            </li>
            <li>
              <strong>Earth bonding:</strong> Supplementary bonding to metal pipework
            </li>
            <li>
              <strong>Outdoor wiring:</strong> UV-resistant cable or conduit for external runs
            </li>
            <li>
              <strong>RCD protection:</strong> 30mA RCD protection as per BS 7671
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Room requires 1.5 kW heat output. Size radiator for 45/40°C
            heat pump operation.
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Optimal flow temperature: <strong>35-45°C</strong>
            </li>
            <li>
              Maximum MCS flow temperature: <strong>55°C</strong>
            </li>
            <li>
              Typical ASHP SCOP: <strong>2.8-3.5</strong>
            </li>
            <li>
              Typical GSHP SCOP: <strong>3.5-4.5</strong>
            </li>
            <li>
              Buffer vessel sizing: <strong>10-20 litres/kW</strong>
            </li>
            <li>
              BUS grant (ASHP/GSHP): <strong>£7,500</strong>
            </li>
            <li>
              Ground temperature (UK): <strong>8-12°C</strong>
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Oversizing:</strong> Causes cycling, reduced efficiency, wasted cost
            </li>
            <li>
              <strong>Inadequate emitters:</strong> System cannot achieve design temperatures
            </li>
            <li>
              <strong>Poor outdoor unit location:</strong> Restricted airflow or recirculation
            </li>
            <li>
              <strong>Insufficient electrical supply:</strong> Trips or voltage drop issues
            </li>
            <li>
              <strong>Missing flow control:</strong> No weather compensation or incorrect curves
            </li>
            <li>
              <strong>Undersized hot water coil:</strong> Long reheat times, legionella risk
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A 2018 ASHP retrofit on a 1960s detached house was sized to 8 kW based on then-current
              fabric. The owner has since added a single-storey extension and removed wall
              insulation in the kitchen rebuild. The system now struggles below 2 °C — buffer tank
              charges to 50 °C and the ASHP is in defrost cycle frequently.
            </>
          }
          whatToDo={
            <>
              Re-do the heat loss calculation per BS EN 12831 using the as-built fabric. If the new
              design heat load exceeds the ASHP capacity at design external temperature, three
              options: (1) upsize the ASHP unit (most expensive); (2) add a second cascaded unit
              (good for staged expansion); (3) reduce the heat load by addressing the extension
              envelope and reinstating wall insulation (best long-term but highest disruption).
              Reset the weather compensation curve and re-verify SCOP under the new fabric. Update
              MCS documentation.
            </>
          }
          whyItMatters={
            <>
              Heat pumps fail their SCOP target when undersized — they cycle, defrost more often,
              and run electric backup, hammering the COP. Every fabric change to a heat-pump
              dwelling needs a heat loss recalculation. Oversizing is also bad (cycles too often,
              poor SCOP) — the design must follow the fabric.
            </>
          }
        />
