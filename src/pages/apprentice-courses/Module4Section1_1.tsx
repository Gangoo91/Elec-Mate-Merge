...
const Module4Section1_1 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'It ensures you work from the latest, accurate information and avoid costly errors.',
    },
    {
      id: 5,
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm text-white">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    Drawings = routes, devices, containment; specs = materials and workmanship.
                  </li>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    <strong>Spot:</strong> Title block, key/legend, symbol list, schedules.
                  </li>
                  <li>
                    <strong>Use:</strong> Trace circuits, follow containment, confirm specs.
                  </li>
                  <li>
                    <strong>Check:</strong> Scale, issue/version, manufacturer instructions vs BS
                    7671.
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="rounded-lg p-4 bg-white/5 border border-white/10 text-sm text-white space-y-2">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  Include performance requirements, quality standards and installation methods.
                </li>
