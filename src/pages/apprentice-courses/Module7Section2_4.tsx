...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "The I²t characteristic represents the energy let-through of the protective device, which must not exceed the cable's thermal capacity to prevent damage during fault conditions.",
  },
  {
    id: 5,
...
const Module7Section2_4 = () => {
  ...
  const faqs = [
    {
      question:
        'How do I determine if an existing installation is properly protected against overload?',
      answer:
        'Conduct a load survey to measure actual currents, verify the Ib ≤ In ≤ Iz relationship for all circuits, check protective device characteristics match the load types, and ensure coordination between protective devices is maintained.',
    },
    {
      question: "What's the difference between overload and overcurrent protection?",
      answer:
        'Overload protection specifically addresses currents that exceed normal ratings but remain within circuit parameters. Overcurrent protection is broader, covering both overload and fault currents (short circuits and earth faults).',
    },
    {
      question: 'Can I use a larger protective device to stop nuisance tripping?',
      answer:
        "No, the protective device rating must not exceed the cable's current-carrying capacity (In ≤ Iz). If nuisance tripping occurs, investigate the cause - it may indicate actual overload, incorrect device type, or installation issues.",
    },
    {
      question: 'How often should overload protection be reviewed?',
      answer:
        'Review protection annually during routine maintenance, after any load changes, when adding new circuits, if protective devices operate frequently, or following any electrical modifications to the installation.',
    },
  ];
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <div>
                ...
                <p className="mb-3">
                  An overload condition occurs when a circuit carries more current than it is
                  designed for, without a fault being present. Unlike short circuits which create
                  very low resistance paths, overloads result from legitimate loads that exceed
                  circuit capacity.
                </p>
                ...
                <div className="p-4 rounded-lg bg-white/5 border border-white/10 mb-4">
                  ...
                  <ul className="list-disc pl-4 space-y-1 text-sm">
                    <li>
                      <strong>Gradual development:</strong> Current builds up over time as loads are
                      added
                    </li>
                    <li>
                      <strong>Finite current levels:</strong> Higher than design but not infinite
                      like short circuits
                    </li>
                    <li>
                      <strong>Heating effects:</strong> I²R losses cause temperature rise in
                      conductors
                    </li>
                    <li>
                      <strong>Time dependency:</strong> Damage accumulates with duration of overload
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <div className="p-3 rounded-lg bg-white/5 border border-white/10">
                    <h4 className="font-medium text-orange-400 mb-2 text-sm">
                      Operational Issues:
                    </h4>
                    <ul className="list-disc pl-4 space-y-1 text-xs">
              ...
              <div>
                ...
                <p className="mb-3">
                  Overload currents cause heating in conductors following the I²R relationship. Even
                  small overloads can cause significant temperature rises over time, leading to
                  insulation damage, connection deterioration, and fire risk.
                </p>
                ...
                <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30">
                  ...
                  <ul className="list-disc pl-4 space-y-1 text-sm">
                    <li>
                      <strong>Immediate:</strong> Voltage drop, reduced performance, warm
                      connections
                    </li>
                    <li>
                      <strong>Short-term:</strong> Insulation softening, connection expansion
                    </li>
                    <li>
                      <strong>Long-term:</strong> Insulation failure, fire risk, equipment damage
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <div>
                ...
                <p className="mb-3">
                  Overload protection operates on inverse time characteristics - the higher the
                  overload current, the faster the protective device operates. This allows for
                  normal starting currents while protecting against sustained overloads.
                </p>
                ...
                <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/30 mb-4">
                  ...
                  <ul className="list-disc pl-4 space-y-1 text-sm">
                    <li>
                      <strong>Type B (3-5 times In):</strong> General purpose, resistive and lightly
                      inductive loads
                    </li>
                    <li>
                      <strong>Type C (5-10 times In):</strong> Inductive loads, fluorescent
                      lighting, motors
                    </li>
                    <li>
                      <strong>Type D (10-20 times In):</strong> High inrush loads, transformers,
                      large motors
                    </li>
                  </ul>
                </div>
              ...
              <div>
                ...
                <p className="mb-3">
                  Proper coordination ensures only the protective device closest to the overload
                  operates, maintaining supply to unaffected circuits. This requires careful
                  selection of device ratings and characteristics.
                </p>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <div>
                ...
                <div className="p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/30 mb-4 text-center">
                  ...
                  <ul className="list-disc pl-4 space-y-1 text-sm text-left">
                    <li>
                      <strong>Ib (Design current):</strong> Maximum current circuit will carry in
                      normal service
                    </li>
                    <li>
                      <strong>In (Nominal current):</strong> Current rating of protective device
                    </li>
                    <li>
                      <strong>Iz (Current-carrying capacity):</strong> Current cable can carry
                      continuously
                    </li>
                  </ul>
                </div>
                <p>
                  This relationship ensures the protective device will operate before the cable
                  reaches its thermal limit, providing effective overload protection.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mb-3">
                  Cable current-carrying capacity must be adjusted for installation conditions. The
                  corrected capacity (Iz) = It × Ca × Cg × Ci × Cc
                </p>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="p-3 rounded-lg bg-elec-yellow/10 border border-elec-yellow/30">
                    ...
                    <ul className="list-disc pl-4 space-y-1 text-xs">
                      <li>
                        <strong>Ca:</strong> Ambient temperature (0.87-1.15)
                      </li>
                      <li>
                        <strong>Cs:</strong> Soil thermal resistivity (0.7-1.0)
                      </li>
                      <li>
                        <strong>Cd:</strong> Depth of burial (0.9-1.0)
                      </li>
                    </ul>
                  </div>
                  <div className="p-3 rounded-lg bg-white/5 border border-white/10">
                    ...
                    <ul className="list-disc pl-4 space-y-1 text-xs">
                      <li>
                        <strong>Cg:</strong> Grouping factor (0.5-1.0)
                      </li>
                      <li>
                        <strong>Ci:</strong> Installation method varies by type
                      </li>
                      <li>
                        <strong>Cc:</strong> Conductor operating temperature
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <ol className="list-decimal pl-4 space-y-1 text-xs">
                    ...
                    <li>
                      Calculate required cable current-carrying capacity (It ≥ In/correction
                      factors)
                    </li>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <div>
                ...
                <p className="mb-3">
                  Regular load surveys are essential for identifying potential overload conditions
                  before they cause damage. These should be conducted during peak demand periods to
                  capture maximum loading.
                </p>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <ul className="list-disc pl-4 space-y-1 text-xs">
                      <li>
                        Verify protective device operation at 1.45 times In within 1 hour
                        (conventional)
                      </li>
              ...
              <div>
                ...
                <p className="mb-3">
                  Effective load management prevents overload conditions and optimises installation
                  capacity. This involves both design measures and operational controls.
                </p>
              ...
              <div>
                ...
                <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30">
                  ...
                  <ul className="list-disc pl-4 space-y-1 text-sm">
                    <li>
                      <strong>Immediate:</strong> Reduce load by redistributing or disconnecting
                      non-essential equipment
                    </li>
                    <li>
                      <strong>Short-term:</strong> Install additional circuits to share loading
                    </li>
                    <li>
                      <strong>Long-term:</strong> Upgrade cable sizes and protective devices as
                      required
                    </li>
                    <li>
                      <strong>Systematic:</strong> Review and update load calculations and design
                      criteria
                    </li>
                  </ul>
                </div>
            ...
            <div className="p-4 rounded-lg bg-gradient-to-r from-elec-yellow/10 to-purple-500/10 border border-white/10">
              ...
              <div className="grid gap-4 sm:grid-cols-2 text-sm text-white/80">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Documentation and periodic review ensure continued protection effectiveness
                  </li>
                </ul>
              </div>
            </div>
