...
const quickCheckQuestions = [
  {
    ...
    options: ['Management level', 'Automation level', 'Enterprise level', 'Field level'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Daisy chain topology', 'Ring topology', 'Star topology', 'Bus topology'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Automation level', 'Field level', 'Integration level', 'Management level'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Wireless 4G/5G', 'Twisted pair cable', 'Coaxial cable', 'Fibre optic cable'],
    correctAnswer: 1,
    explanation:
...
const HNCModule8Section5_1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 5 · Subsection 1"
      ...
      <HubBody>
        ...
        <ConceptBlock title="BMS Architecture Overview">
          <p>
            ...
            manages a building's mechanical, electrical, and electromechanical services. Modern BMS
            architecture follows a hierarchical three-tier model that provides flexibility,
            resilience, and scalability.
          </p>
          <p>
            <strong>Three-Tier BMS Architecture</strong>
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Autonomous operation:</strong> Outstations continue working if network fails
            </li>
            <li>
          ...
          <p>
            <strong>BMS vs Traditional Controls</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Control location:</strong> Local at each plant — Distributed with central
              monitoring
            </li>
            <li>
              <strong>Visibility:</strong> Manual inspection required — Real-time graphics and
              alarms
            </li>
            <li>
              <strong>Data logging:</strong> Manual or none — Automatic trending
            </li>
            <li>
              <strong>Scheduling:</strong> Time clocks at each location — Centralised, flexible
              schedules
            </li>
            <li>
              <strong>Integration:</strong> Standalone systems — Coordinated multi-system operation
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Field Level: Sensors, Actuators and Points">
          ...
          <p>
            <strong>Point Types in BMS</strong>
          </p>
          <p>
            <strong>Hardware Points (Physical)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Software Points (Virtual)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Common field devices:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Signal Types and Ranges</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>4-20mA:</strong> 4mA = 0%, 20mA = 100% — Transmitters, actuators
            </li>
            <li>
              <strong>0-10V DC:</strong> 0V = 0%, 10V = 100% — Actuators, VSDs, dimmers
            </li>
            <li>
              <strong>Resistance:</strong> PT100, PT1000, NTC — Temperature sensors
            </li>
            <li>
              <strong>Volt-free contact:</strong> Open/Closed — Status, alarms, interlocks
            </li>
            <li>
              <strong>Pulse:</strong> Count per unit — Meters (kWh, m³)
            </li>
          </ul>
          <p>
            <strong>Points Schedule Example</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>AHU1_SAT:</strong> AI — Supply air temp — °C — HI: 35, LO: 5
            </li>
            <li>
              <strong>AHU1_SF_CMD:</strong> DO — Supply fan command — On/Off — -
            </li>
            <li>
              <strong>AHU1_HCV:</strong> AO — Heating valve — % — -
            </li>
            <li>
              <strong>AHU1_SAT_SP:</strong> AV — Supply air setpoint — °C — -
            </li>
          </ul>
          <p>
            <strong>Best practice:</strong> Use consistent naming conventions for points. A typical
            format is: System_Equipment_Point (e.g., HVAC_AHU01_SupplyTemp).
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Outstations and Controllers">
          <p>
            ...
            automation level of the BMS. They provide local intelligence, execute control programs,
            and communicate with both field devices and the management level.
          </p>
          <p>
            <strong>Outstation Functions</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Communication Functions</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Outstation types:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Unitary controllers:</strong> Fixed I/O for specific applications (FCU, VAV)
            </li>
            <li>
          ...
          <p>
            <strong>Controller Specifications to Consider</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>I/O capacity:</strong> 8-64 points base, expandable — Allow 20% spare capacity
            </li>
            <li>
              <strong>Input types:</strong> Universal or dedicated — Universal offers flexibility
            </li>
            <li>
              <strong>Program memory:</strong> 256KB - 4MB — Complex sequences need more
            </li>
            <li>
              <strong>Trend storage:</strong> 10,000 - 500,000 samples — Battery-backed or flash
            </li>
            <li>
              <strong>Network ports:</strong> RS-485, Ethernet, wireless — Match system architecture
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Head-End Systems and Network Topology">
          ...
          <p>
            <strong>Head-End Software Functions</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Head-end system components:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Bus:</strong> Single cable, devices tap in — Simple, low cable cost — Single
              point failure affects all
            </li>
            <li>
              <strong>Star:</strong> Central hub/switch — Easy troubleshooting — Hub failure stops
              network
            </li>
            <li>
              <strong>Ring:</strong> Circular connection — Redundant path — More complex
              installation
            </li>
            <li>
              <strong>Mesh:</strong> Multiple interconnections — Highest resilience — Most expensive
            </li>
            <li>
              <strong>Tree/Hierarchical:</strong> Multiple levels of stars — Scalable, organised —
              Backbone critical
            </li>
          </ul>
          <p>
            <strong>Typical BMS Network Architecture</strong>
          </p>
          <p>
            <strong>Level 3 (Enterprise):</strong> Corporate LAN, IT integration, cloud services
          </p>
          <p>↓ Firewall / Gateway</p>
          <p>
            <strong>Level 2 (Supervision):</strong> Head-end server, workstations - Ethernet TCP/IP
          </p>
          <p>↓ Router / Gateway</p>
          <p>
            <strong>Level 1 (Automation):</strong> Outstations - BACnet/IP, BACnet MS/TP, LonWorks
          </p>
          <p>↓ Controller I/O</p>
          <p>
          ...
          <p>
            <strong>Wired Media Options</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Wireless Options</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Integration with Other Building Systems">
          ...
          <p>
            <strong>Systems Commonly Integrated with BMS</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fire alarm:</strong> HVAC shutdown, smoke control, status display — Volt-free
              contacts, protocol gateway
            </li>
            <li>
              <strong>Access control:</strong> Occupancy-based HVAC, lighting control — BACnet, OPC,
              API
            </li>
            <li>
              <strong>Lighting control:</strong> Coordinated scenes, daylight harvesting — DALI
              gateway, KNX, BACnet
            </li>
            <li>
              <strong>Electrical metering:</strong> Energy monitoring, demand response — Modbus,
              BACnet, M-Bus
            </li>
            <li>
              <strong>Lifts:</strong> Status monitoring, fault alarms — Volt-free contacts, serial
            </li>
            <li>
              <strong>Security/CCTV:</strong> Event correlation, lighting response — IP integration,
              contacts
            </li>
            <li>
              <strong>Solar PV:</strong> Generation monitoring, load shifting — Modbus, SunSpec
            </li>
          </ul>
          <p>
            <strong>Integration Example: Fire Alarm Interface</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Benefits of integrated building management:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Energy efficiency:</strong> Systems respond to actual occupancy and conditions
            </li>
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            ...
            supply/extract temperatures, filter differential pressure, and supply air humidity. How
            many I/O points are needed?
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Point Name::</strong> BLR1_FLOW_TEMP
            </li>
            <li>
              <strong>Point Type::</strong> AI (Analogue Input)
            </li>
            <li>
              <strong>Description::</strong> Boiler 1 Flow Temperature
            </li>
            <li>
              <strong>Controller::</strong> CTRL-PLANTROOM-01
            </li>
            <li>
              <strong>Address::</strong> AI-04
            </li>
            <li>
              <strong>Sensor Type::</strong> PT1000
            </li>
            <li>
              <strong>Range::</strong> 0-100°C
            </li>
            <li>
              <strong>Engineering Units::</strong> °C
            </li>
            <li>
              <strong>High Alarm::</strong> 85°C (Priority 2)
            </li>
            <li>
              <strong>High-High Alarm::</strong> 90°C (Priority 1)
            </li>
            <li>
              <strong>Low Alarm::</strong> 40°C (Priority 3)
            </li>
            <li>
              <strong>Trend Interval::</strong> 5 minutes
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Point:</strong> Single monitored or controlled value (hardware or software)
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Poor documentation:</strong> Incomplete points schedules cause commissioning
                delays
              </li>
              <li>
