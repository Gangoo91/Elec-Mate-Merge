...
const DESCRIPTION =
  'Comprehensive guide to emergency lighting systems for maintenance technicians: BS 5266, maintained and non-maintained systems, central battery and self-contained, testing requirements, logbook recording, common faults and battery replacement under ST1426.';
...
const faqs = [
  {
    ...
    answer:
      'BS 5266-1 requires 3-hour duration for sleeping accommodation (hotels, hospitals, care homes) and premises that cannot be immediately evacuated and reoccupied. A 1-hour duration is only acceptable where the premises can be evacuated immediately, are not used for sleeping, and will not be reoccupied until the system has fully recharged (typically 24 hours). In practice, most new installations specify 3-hour duration to provide the greatest flexibility and safety margin.',
  },
  {
    question: 'Can I use an automatic test system instead of manual testing?',
    answer:
      'Yes — BS 5266-1 recognises automatic test systems (ATS) as an acceptable alternative to manual testing. ATS can perform both monthly functional tests and annual duration tests automatically, and record the results electronically. However, a visual inspection of the installation must still be carried out periodically to check for physical damage, blocked luminaires, or changes to the building layout that may require additional emergency lighting.',
  },
  {
    question: "What is the difference between 'sustained' and 'maintained' emergency lighting?",
    answer:
      "The terminology can be confusing. Under BS EN 1838: 'Maintained' means the luminaire operates at all times — both on mains and on battery. 'Non-maintained' means the luminaire operates only when the mains fails. 'Sustained' is sometimes used to describe a luminaire with two lamps — one for normal lighting and one for emergency lighting — but this term is not formally defined in BS 5266 and its use is discouraged in favour of 'maintained' and 'non-maintained'.",
  },
  {
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Maintained:</strong> Always on — non-maintained: battery only on mains
                failure
              </li>
              <li className="pl-1">
                <strong>Duration:</strong> 1 hour or 3 hours depending on premises use
              </li>
              <li className="pl-1">
                <strong>Testing:</strong> Monthly functional + annual full-duration (BS 5266)
              </li>
              <li className="pl-1">
                <strong>Escape routes:</strong> Minimum 1 lux on centre line at floor level
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>BS 5266-1:</strong> Code of practice for emergency lighting
              </li>
              <li className="pl-1">
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p>
              BS 5266-1 is the primary code of practice for emergency lighting in the UK, setting
              out the design, installation, wiring, testing and maintenance requirements. BS EN 1838
              specifies the photometric requirements — the minimum illuminance levels that must be
              achieved. Together, these standards form the basis for all emergency lighting
              installations and maintenance programmes.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Escape route lighting:</strong> Illuminates defined escape routes to
                  enable safe and effective evacuation. Minimum 1 lux on centre line at floor level.
                ...
                <li className="pl-1">
                  ...
                  mains failure (e.g., hospital operating theatres). Not strictly 'emergency'
                  lighting but often part of the same system
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Non-maintained:</strong> The emergency lamp is OFF during normal
                  conditions and only illuminates when the mains supply fails. The battery is
                  continuously charged while the mains is available. Most common type in commercial
                  premises
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  ...
                  normal lighting (mains-powered) and one for emergency lighting (battery-backed).
                  The emergency lamp only operates on mains failure
                </li>
                <li className="pl-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> The choice between maintained and non-maintained depends
              on the use of the space. As a maintenance technician, you must be able to identify the
              type of each luminaire and ensure the correct operation mode is maintained.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  <li className="pl-1">
                    Battery, charger and control circuit within each luminaire
                  </li>
                  <li className="pl-1">
                    Simple wiring — connected to normal lighting circuit (permanent live)
                  </li>
                  <li className="pl-1">No additional wiring for emergency supply</li>
                  <li className="pl-1">
                    Each unit independent — failure affects only that luminaire
                  </li>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  ...
                  <li className="pl-1">
                    Best suited for large commercial and industrial installations
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Battery Types in Emergency Lighting
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  ...
                  lighter weight, better high-temperature tolerance. Increasingly the preferred
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                Self-contained emergency luminaires require a permanent live supply (not switched)
                to keep the battery charger energised. This is critical — if the luminaire is
                connected to a switched circuit, turning off the light switch will discharge the
                battery, and the luminaire will not operate when needed. Central battery systems
                require dedicated fire-resistant cabling (typically to BS 8519 or BS 7629) from the
                central battery to each emergency luminaire, as the wiring must survive long enough
                to maintain the emergency lighting during a fire.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Maintenance tip:</strong> When maintaining self-contained luminaires, always
              verify that the permanent live supply is present at each fitting. A common fault is
              incorrect connection to a switched live, which means the battery is only being charged
              when the normal lighting is on.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              when needed. BS 5266-1 sets out a clear testing regime that includes daily visual
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Each luminaire illuminates; correct operation of changeover; indicator
                        status
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Simulate mains failure by operating the test switch (local test button, key
                  switch, or remote test facility)
                </li>
                <li className="pl-1">
                  Confirm each emergency luminaire and exit sign illuminates correctly
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  Restore mains supply and confirm luminaires return to normal mode
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  Record results in the log book — including any failures and remedial actions
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Annual Full-Duration Test Procedure
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Plan the test to minimise risk — ensure the building can be safely evacuated
                ...
                <li className="pl-1">
                  Record any luminaires that have failed or dimmed significantly before the end of
                  the test
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  Record all results in the log book, including any remedial actions required
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                ...
                available for inspection. It must contain: a certificate of completion for the
                initial installation; details of all luminaires (location, type, lamp, battery); a
                schedule of tests; records of all tests carried out (date, type, results, defects,
                remedial action); records of all maintenance and battery replacements; and any
                alterations or additions to the system. The log book must be retained for the life
                of the installation.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Automatic test systems (ATS) can automate monthly and
              annual testing, but a visual inspection is still required periodically to check for
              physical damage, obscured luminaires, and changes to the building layout.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Common Faults in Self-Contained Luminaires
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Driver/inverter failure:</strong> The electronic driver that powers the
                  LED from the battery fails. Symptoms: battery charges but lamp does not illuminate
                  on test
                </li>
                <li className="pl-1">
                  <strong>Physical damage:</strong> Impact damage to the luminaire body, diffuser,
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Common Faults in Central Battery Systems
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Battery Replacement Procedure (Self-Contained)
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Step 1:</strong> Isolate the mains supply to the luminaire and confirm
                  dead
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Step 10:</strong> Record the replacement in the emergency lighting log
                  book
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              maintain and test emergency lighting systems, identify faults, carry out repairs, and
              maintain accurate records. Emergency lighting is one of the most commonly assessed
              areas in the end-point assessment.
            </p>
          </div>
        </section>
