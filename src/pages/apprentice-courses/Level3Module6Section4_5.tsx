      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Designing safe electrical systems for construction sites, exhibitions, and outdoor events
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Construction site electrical supply arrangements",
              "110V reduced voltage systems and their advantages",
              "Exhibition and event electrical requirements",
              "Cable routing and protection for temporary works",
              "Inspection regimes for temporary installations",
              "Generator-supplied installations"
            ].map((item, i) => (
