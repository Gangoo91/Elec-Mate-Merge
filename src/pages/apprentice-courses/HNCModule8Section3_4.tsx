...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['1:10 (10%)', '1:50 (2%)', '1:200 (0.5%)', '1:100 (1%)'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['15 - 25 kW', '0.5 - 1.5 kW', '2 - 8 kW', '50 - 100 kW'],
    correctAnswer: 2,
    explanation:
...
const HNCModule8Section3_4 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 3 · Subsection 4"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Fan Coil Units (FCUs)">
          <p>
            Fan coil units are the most common terminal devices in commercial HVAC systems. They
            consist of a fan, one or more heat exchanger coils, a filter, and a drip tray, all
            housed in a compact enclosure. FCUs provide localised heating and cooling with
            individual zone control capability.
          </p>
          <p>
            <strong>FCU Configurations</strong>
          </p>
          <p>
            <strong>2-Pipe System</strong>
          </p>
          ...
          <p>
            <strong>FCU Mounting Types</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ceiling concealed:</strong> Above suspended ceiling — Offices, hotels - most
              common type
            </li>
            <li>
              <strong>Ceiling exposed:</strong> Below ceiling, visible — Industrial, retail where
              voids unavailable
            </li>
            <li>
              <strong>Floor standing:</strong> At floor level — Perimeter heating, glazed facades
            </li>
            <li>
              <strong>Vertical:</strong> Wall or column mounted — Where floor/ceiling space limited
            </li>
            <li>
              <strong>Horizontal ducted:</strong> In ceiling void with ductwork — Larger zones,
              distributed outlets
            </li>
          </ul>
          <p>
            <strong>Typical FCU Specifications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cooling capacity:</strong> 1.5 - 15 kW sensible (typical office units)
            </li>
            <li>
              <strong>Fan motor:</strong> 20 - 150W (EC motors preferred)
            </li>
            <li>
              <strong>Airflow:</strong> 150 - 1500 m³/h (3-speed or variable)
            </li>
            <li>
              <strong>Coil pressure drop:</strong> 20 - 50 kPa at design flow
            </li>
            <li>
              <strong>Noise level:</strong> 30 - 45 dB(A) at 1m (speed dependent)
            </li>
          </ul>
          <p>
            <strong>FCU components:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fan section:</strong> Centrifugal fan, typically 3-speed or EC variable speed
            </li>
            <li>
              <strong>Coil(s):</strong> Copper tube, aluminium fin heat exchanger(s)
            </li>
            <li>
              <strong>Filter:</strong> G3/G4 panel filter, typically washable or disposable
            </li>
            <li>
              <strong>Drip tray:</strong> Stainless steel or plastic, with drain connection
            </li>
            <li>
              <strong>Casing:</strong> Galvanised steel, insulated to prevent condensation
            </li>
            <li>
              <strong>Control valve(s):</strong> 2-way or 3-way, typically 15-20mm
            </li>
          </ul>
          <p>
            <strong>Design consideration:</strong> FCU capacity is typically quoted at specific
            entering water and air temperatures. Verify design conditions match actual project
            parameters and apply derating factors where necessary.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Chilled Beams - Active and Passive">
          <p>
            Chilled beams provide space cooling (and sometimes heating) using chilled water coils
            mounted at ceiling level. They offer quiet, low-maintenance operation but are limited to
            sensible cooling only - latent loads must be handled by the primary air system or
            separate dehumidification.
          </p>
          <p>
            <strong>Passive vs Active Chilled Beams</strong>
          </p>
          <p>
            <strong>Passive Chilled Beams</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Active Chilled Beams</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Active Chilled Beam Operation</strong>
          </p>
          <p>
            <strong>Induction principle:</strong> Primary conditioned air (typically 12-15°C) is
            supplied through small nozzles at high velocity. This creates a low-pressure zone that
            draws room air through the coil - the venturi or ejector effect.
          </p>
          <p>
            <strong>Induction ratio:</strong> Typically 1:3 to 1:5, meaning for every 1 part primary
            air, 3-5 parts of room air are induced. This multiplies the apparent air supply rate
            without increasing ductwork size.
          </p>
          <p>
            <strong>Discharge temperature:</strong> Mixed air (primary + induced) leaves at 16-18°C,
            well above the room dew point, eliminating condensation risk from the beam discharge.
          </p>
          <p>
            <strong>Chilled Beam Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cooling capacity:</strong> 150-300 W/m — 300-600 W/m
            </li>
            <li>
              <strong>Heating capability:</strong> Limited (stratification issues) — Good (forced
              air distribution)
            </li>
            <li>
              <strong>Primary air duct:</strong> Not required — Required
            </li>
            <li>
              <strong>Ventilation:</strong> Separate system needed — Integrated
            </li>
            <li>
              <strong>CHW temperature:</strong> &gt;14°C (above dewpoint) — 10-16°C (primary air
              dehumidifies)
            </li>
            <li>
              <strong>Noise level:</strong> Silent — 20-35 NR (nozzle noise)
            </li>
          </ul>
          <p>
            <strong>Critical: Condensation Prevention</strong>
          </p>
          <p>
            Chilled beams (especially passive) have no condensate drainage provision. Condensation
            on beam surfaces causes:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Prevention:</strong> Maintain CHW temperature above room dewpoint. Typical
            office at 24°C, 50% RH has dewpoint of ~13°C. CHW is typically limited to 14-16°C with
            dewpoint monitoring and automatic CHW temperature rise.
          </p>
          <p>
            <strong>Design note:</strong> Active chilled beams are specified per BS EN 15116. Ensure
            primary air is dehumidified to handle latent loads and maintain room dewpoint below CHW
            temperature.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Cassette Units and VAV Boxes">
          <p>
            Ceiling cassette units and VAV (Variable Air Volume) boxes represent different
            approaches to zone conditioning. Cassettes are self-contained terminal units (often DX
            or chilled water), while VAV boxes modulate airflow from a central air handling system.
          </p>
          <p>
            <strong>Ceiling Cassette Units</strong>
          </p>
          <p>
            Ceiling cassettes are compact, ceiling-recessed units that provide local heating and
            cooling. They are available in chilled water, DX (split/VRF), and heat pump
            configurations.
          </p>
          <p>
            <strong>Cassette configurations:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>4-way:</strong> Air discharge in 4 directions, most common
            </li>
            <li>
              <strong>2-way:</strong> Discharge in 2 opposite directions
            </li>
            <li>
              <strong>1-way:</strong> Single direction discharge
            </li>
            <li>
              <strong>Round flow:</strong> 360° circular discharge pattern
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>VRF/DX Cassette Considerations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Medium:</strong> Chilled/hot water — Refrigerant (R410A, R32)
            </li>
            <li>
              <strong>Pipework:</strong> Steel/copper, larger diameter — Copper, small diameter
              (6-16mm)
            </li>
            <li>
              <strong>Leak risk:</strong> Water damage — Refrigerant release (F-gas implications)
            </li>
            <li>
              <strong>Control:</strong> Valve + fan speed — Inverter compressor + fan
            </li>
            <li>
              <strong>Maintenance:</strong> Filter, valve, fan — Filter, fan, refrigerant check
            </li>
          </ul>
          <p>
            <strong>VAV Terminal Boxes</strong>
          </p>
          <p>
          ...
          <p>
            <strong>VAV box types:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pressure-independent:</strong> Maintains setpoint regardless of duct pressure
              changes
            </li>
            <li>
              <strong>Pressure-dependent:</strong> Simpler, affected by system pressure
            </li>
            <li>
              <strong>With reheat:</strong> Hot water or electric coil for heating
            </li>
            <li>
              <strong>Fan-powered:</strong> Integral fan for constant room airflow
            </li>
          </ul>
          <p>
            <strong>VAV control strategy:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>VAV Minimum Airflow Settings</strong>
          </p>
          <p>VAV boxes have minimum and maximum airflow limits:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Minimum:</strong> Typically 20-30% of design airflow for ventilation
              requirements
            </li>
            <li>
              <strong>Maximum:</strong> 100% design airflow (damper fully open)
            </li>
            <li>
              <strong>Dead band:</strong> Range where no action occurs (typically 1-2°C)
            </li>
          </ul>
          <p>
            Setting minimums too low reduces energy but risks inadequate ventilation and poor air
            distribution. Too high wastes fan energy. Balance based on occupancy density and fresh
            air requirements.
          </p>
          <p>
            <strong>Selection guide:</strong> VAV suits large open-plan areas with varying loads.
            Cassettes suit individual rooms or areas requiring independent control. Consider noise,
            ceiling void, and maintenance access in selection.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Control Valves, EC Motors, and Condensate Drainage">
          <p>
            Effective terminal unit operation depends on properly specified control components:
            valves for water flow modulation, efficient fan motors, and adequate condensate
            management. These elements significantly impact energy performance, comfort, and
            maintenance requirements.
          </p>
          <p>
            <strong>Control Valve Types</strong>
          </p>
          <p>
            <strong>2-Way Valves</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Valve Sizing and Authority</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Valve authority:</strong> Valve ΔP / (Valve ΔP + Circuit ΔP) — &gt;0.5 for
              good control
            </li>
            <li>
              <strong>Valve Kvs:</strong> Size to achieve design ΔP at design flow — Typically Kvs
              0.4 - 4.0 for FCUs
            </li>
            <li>
              <strong>Connection size:</strong> Match coil connections — 15mm, 20mm, 25mm
            </li>
            <li>
              <strong>Close-off pressure:</strong> Must exceed system static pressure — 100 - 400
              kPa typical
            </li>
          </ul>
          <p>
            <strong>Actuator Types</strong>
          </p>
          <p>
            <strong>Thermal actuators:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Modulating actuators:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>EC Fan Motors</strong>
          </p>
          <p>
            Electronically Commutated (EC) motors are now standard in quality FCUs, replacing
            traditional AC induction motors with shaded-pole or PSC (permanent split capacitor)
            windings.
          </p>
          <p>
            <strong>EC motor advantages:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Condensate Drainage Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Minimum fall:</strong> 1:100 (1% or 10mm/m) — 1:50 preferred where possible
            </li>
            <li>
              <strong>Pipe material:</strong> PVC, ABS, or copper — PVC-U most common
            </li>
            <li>
              <strong>Pipe diameter:</strong> 21.5mm (3/4") minimum — Match FCU connection
            </li>
            <li>
              <strong>Trap requirement:</strong> 50mm water seal minimum — Prevents air being drawn
              in
            </li>
            <li>
              <strong>Air break:</strong> Tundish or visible gap — Required before connection to
              drainage
            </li>
          </ul>
          <p>
            <strong>Condensate Pump Requirements</strong>
          </p>
          <p>When gravity drainage is not achievable, condensate pumps are required:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Pump type:</strong> Centrifugal mini-pump, typically 10-20W
            </li>
            <li>
              <strong>Lift capacity:</strong> Typically 3-6m head
            </li>
            <li>
              <strong>Flow rate:</strong> Match peak condensate production (0.5-2 l/hr typical)
            </li>
            <li>
              <strong>Float switch:</strong> Activates pump when tray fills
            </li>
            <li>
              <strong>High-level alarm:</strong> Volt-free contact to BMS
            </li>
            <li>
              <strong>Electrical supply:</strong> Typically from FCU isolator or separate fused spur
            </li>
          </ul>
          <p>
            <strong>FCU Electrical Installation Summary</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Supply:</strong> 230V single phase (check unit requirements)
            </li>
            <li>
              <strong>Protection:</strong> MCB 6-16A depending on load, RCD where applicable
            </li>
            <li>
              <strong>Isolation:</strong> Local isolator within 1m of unit
            </li>
            <li>
              <strong>Control wiring:</strong> 0-10V fan speed, valve actuator, room sensor
            </li>
            <li>
              <strong>BMS connection:</strong> Status, alarms, setpoint adjustment
            </li>
          </ul>
          <p>
            <strong>Commissioning note:</strong> Terminal units require water flow balancing, air
            flow measurement (where ducted), control loop tuning, and condensate drainage testing
            before handover.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Select a ceiling-concealed FCU for an office zone with 6 kW
            sensible cooling load and 2 kW heating load. The system uses 4-pipe chilled/hot water
            with 2-way valves.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Determine the minimum chilled water temperature for passive
            chilled beams in a meeting room designed for 22°C, 50% RH.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Size a 2-way control valve for an FCU with design water flow
            rate of 0.15 l/s and target valve pressure drop of 15 kPa.
          </p>
          <p>Given data:</p>
          ...
          <p>
            <strong>Scenario:</strong> Compare annual energy consumption of EC and AC motors for an
            FCU operating at 60% average speed for 3000 hours per year.
          </p>
          ...
          <p>
            <strong>AC motor (voltage-controlled):</strong>
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Minimum CHW temperature for passive beams: <strong>14-16°C</strong> (above dewpoint)
            </li>
            <li>
              Active chilled beam induction ratio: <strong>1:3 to 1:5</strong>
            </li>
            <li>
              Condensate drain minimum fall: <strong>1:100 (1%)</strong>
            </li>
            <li>
              Control valve authority target: <strong>&gt;0.5</strong>
            </li>
            <li>
              EC motor efficiency at part load: <strong>70-90%</strong>
            </li>
            <li>
              FCU coil pressure drop typical: <strong>20-50 kPa</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Using 3-way valves with variable speed pumps</strong> - wastes pump energy
              </li>
              <li>
                <strong>Undersizing valve authority</strong> - poor temperature control, hunting
              </li>
              <li>
                <strong>Insufficient condensate drainage fall</strong> - standing water, biological
                growth
              </li>
              <li>
                <strong>Ignoring dewpoint for chilled beams</strong> - condensation damage
              </li>
              <li>
                <strong>Inadequate ceiling void for FCUs</strong> - maintenance access problems
              </li>
            </ul>
          }
