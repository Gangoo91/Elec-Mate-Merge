      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>FCUs:</strong> Fan-driven, high capacity, handles latent loads
              </li>
              <li className="pl-1">
                <strong>Chilled beams:</strong> Quiet, low maintenance, sensible only
              </li>
              <li className="pl-1">
                <strong>2-pipe vs 4-pipe:</strong> Changeover vs simultaneous H/C
              </li>
              <li className="pl-1">
                <strong>Control:</strong> 2-way valves for variable flow systems
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Selection:</strong> Based on load, noise, ceiling void, access
              </li>
              <li className="pl-1">
                <strong>Electrical:</strong> MCB protection, isolators, control wiring
              </li>
              <li className="pl-1">
                <strong>Commissioning:</strong> Water flow, air balance, controls
              </li>
              <li className="pl-1">
                <strong>Standards:</strong> BS EN 1397, BS EN 15116
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Offices, hotels - most common type
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Industrial, retail where voids unavailable
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Perimeter heating, glazed facades
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Where floor/ceiling space limited
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Horizontal ducted</td>
                      <td className="border border-white/10 px-3 py-2">
                        In ceiling void with ductwork
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Larger zones, distributed outlets
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Fan section:</strong> Centrifugal fan, typically 3-speed or EC variable
                  speed
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              mounted at ceiling level. They offer quiet, low-maintenance operation but are limited
              to sensible cooling only - latent loads must be handled by the primary air system or
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="text-sm space-y-2">
                <p>
                  <strong>Induction principle:</strong> Primary conditioned air (typically 12-15°C)
                  is supplied through small nozzles at high velocity. This creates a low-pressure
                  zone that draws room air through the coil - the venturi or ejector effect.
                </p>
                <p>
                  <strong>Induction ratio:</strong> Typically 1:3 to 1:5, meaning for every 1 part
                  primary air, 3-5 parts of room air are induced. This multiplies the apparent air
                  supply rate without increasing ductwork size.
                </p>
                <p>
                  <strong>Discharge temperature:</strong> Mixed air (primary + induced) leaves at
                  16-18°C, well above the room dew point, eliminating condensation risk from the
                  beam discharge.
                </p>
              </div>
            </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        10-16°C (primary air dehumidifies)
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              <p className="text-sm font-medium text-orange-400 mb-2">
                Critical: Condensation Prevention
              </p>
              <div className="text-sm text-white">
                <p className="mb-2">
                  Chilled beams (especially passive) have no condensate drainage provision.
                  Condensation on beam surfaces causes:
                </p>
                ...
                <p className="mt-2">
                  ...
                  office at 24°C, 50% RH has dewpoint of ~13°C. CHW is typically limited to 14-16°C
                  with dewpoint monitoring and automatic CHW temperature rise.
                </p>
              </div>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Design note:</strong> Active chilled beams are specified per BS EN 15116.
              Ensure primary air is dehumidified to handle latent loads and maintain room dewpoint
              below CHW temperature.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              or chilled water), while VAV boxes modulate airflow from a central air handling
              system.
            </p>
            ...
            <div className="my-6">
              ...
              <div className="p-4 rounded-lg bg-white/5">
                <p className="text-sm text-white mb-2">
                  Ceiling cassettes are compact, ceiling-recessed units that provide local heating
                  and cooling. They are available in chilled water, DX (split/VRF), and heat pump
                  configurations.
                </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                VRF/DX Cassette Considerations
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Steel/copper, larger diameter
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Copper, small diameter (6-16mm)
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Refrigerant release (F-gas implications)
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6">
              ...
              <div className="p-4 rounded-lg bg-white/5">
                <p className="text-sm text-white mb-2">
                  VAV boxes modulate the volume of conditioned air supplied to a zone. The central
                  AHU provides air at constant temperature; capacity is controlled by varying
                  airflow.
                </p>
                <div className="grid sm:grid-cols-2 gap-4 mt-3">
                  <div>
                    ...
                    <ul className="text-xs text-white space-y-1 list-disc list-outside ml-4">
                      <li className="pl-1">
                        <strong>Pressure-independent:</strong> Maintains setpoint regardless of duct
                        pressure changes
                      </li>
                      <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              ...
              <div className="text-sm text-white">
                ...
                <p className="mt-2">
                  Setting minimums too low reduces energy but risks inadequate ventilation and poor
                  air distribution. Too high wastes fan energy. Balance based on occupancy density
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              Cassettes suit individual rooms or areas requiring independent control. Consider
              noise, ceiling void, and maintenance access in selection.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Size to achieve design ΔP at design flow
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Typically Kvs 0.4 - 4.0 for FCUs
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Must exceed system static pressure
                      </td>
            ...
            <div className="my-6">
              ...
              <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/30">
                <p className="text-sm text-white mb-2">
                  ...
                  traditional AC induction motors with shaded-pole or PSC (permanent split
                  capacitor) windings.
                </p>
                <div className="grid sm:grid-cols-2 gap-4 mt-3">
                  <div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Required before connection to drainage
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <div className="text-sm text-white">
                <p className="mb-2">
                  When gravity drainage is not achievable, condensate pumps are required:
                </p>
                <ul className="list-disc list-outside ml-5 space-y-1">
                  <li className="pl-1">
                  ...
                  <li className="pl-1">
                    <strong>Flow rate:</strong> Match peak condensate production (0.5-2 l/hr
                    typical)
                  </li>
                  <li className="pl-1">
                  ...
                  <li className="pl-1">
                    <strong>Electrical supply:</strong> Typically from FCU isolator or separate
                    fused spur
                  </li>
                </ul>
              </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              <p className="text-sm font-medium text-blue-400 mb-2">
                FCU Electrical Installation Summary
              </p>
              <div className="text-sm space-y-1">
                <p>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: FCU Selection for Office Zone
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Scenario:</strong> Select a ceiling-concealed FCU for an office zone with 6
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  Selected: Model FCU-600 (7.2 kW cooling, 3.1 kW heating)
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Chilled Beam Dewpoint Analysis
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="ml-4">
                  Dewpoint = 22 - ((100 - 50)/5) = 22 - 10 = 12°C (approximate)
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Control Valve Sizing
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 4: EC vs AC Motor Energy Comparison
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <table className="text-sm text-white w-full border-collapse">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="border border-white/10 px-3 py-2">
                      Ceiling FCU or active chilled beam
                    </td>
                    <td className="border border-white/10 px-3 py-2">
                      Noise (NR35-40), uniform distribution
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-white/10 px-3 py-2">Private office</td>
                    <td className="border border-white/10 px-3 py-2">
                      4-way cassette or ceiling FCU
                    </td>
                    <td className="border border-white/10 px-3 py-2">
                      Individual control, aesthetics
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-white/10 px-3 py-2">Meeting room</td>
                    <td className="border border-white/10 px-3 py-2">
                      Passive chilled beam or ceiling FCU
                    </td>
                    <td className="border border-white/10 px-3 py-2">
                      Low noise critical, variable occupancy
                    </td>
                  </tr>
                  <tr>
                    <td className="border border-white/10 px-3 py-2">Hotel bedroom</td>
                    <td className="border border-white/10 px-3 py-2">
                      Vertical FCU or under-window unit
                    </td>
                    <td className="border border-white/10 px-3 py-2">
                      Low noise (NR25-30), individual control
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="border border-white/10 px-3 py-2">
                      Capacity for high gains, aesthetics
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="border border-white/10 px-3 py-2">
                      High air change rates, fume extraction
                    </td>
                  </tr>
                  <tr>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Terminal Unit Specification Checklist
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Confirm cooling and heating capacity at actual design conditions
                </li>
                <li className="pl-1">
                  Verify noise level suits application (specify NR rating required)
                </li>
                <li className="pl-1">
                  Check physical dimensions fit available ceiling void/floor space
                </li>
                <li className="pl-1">Ensure access for filter cleaning and maintenance</li>
                <li className="pl-1">
                  Specify control valve type, size, and actuator (0-10V preferred)
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Minimum CHW temperature for passive beams: <strong>14-16°C</strong> (above
                  dewpoint)
                </li>
                <li className="pl-1">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Insufficient condensate drainage fall</strong> - standing water,
                  biological growth
                </li>
                <li className="pl-1">
