      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
          <div className="bg-white/5 border border-elec-yellow/20 rounded-lg p-4 sm:p-5">
            <h3 className="text-elec-yellow font-semibold mb-2 text-sm uppercase tracking-wide">
              In 30 Seconds
            </h3>
            <ul className="text-left text-white text-sm space-y-1.5">
              <li>
                - <strong>Stator:</strong> Laminated core with 3-phase copper windings
              </li>
              <li>
                - <strong>Rotor:</strong> Squirrel-cage bars, no brushes or slip rings
              </li>
              <li>
                - <strong>Slip:</strong> 2-5% at full load, essential for torque
              </li>
              <li>
                - <strong>Nameplate:</strong> Every field matters for replacement and sizing
              </li>
            </ul>
          </div>
          <div className="bg-white/5 border border-elec-yellow/20 rounded-lg p-4 sm:p-5">
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-4 p-4 rounded-lg bg-white/5 text-center">
              <p className="text-elec-yellow font-mono text-lg">
            ...
            <div className="my-4 p-4 rounded-lg bg-white/5 text-center">
              <p className="text-elec-yellow font-mono">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-4 p-4 rounded-lg bg-white/5">
              <ul className="text-white space-y-3 text-left">
                <li>
                  <strong className="text-elec-yellow">Ball Bearings (Rolling Element):</strong>{' '}
                  Most common in small to medium motors (up to approximately 200 kW). They use steel
                  balls running in precision-machined races. Ball bearings are grease-lubricated,
                  available as sealed (greased for life) or re-greaseable types. They have a finite
                  life determined by speed, load and lubrication conditions -- typically 20,000 to
                  40,000 operating hours under normal conditions.
                </li>
                <li>
                  <strong className="text-elec-yellow">Sleeve Bearings (Plain Bearings):</strong>{' '}
                  Used in larger motors (above approximately 200 kW). The shaft rotates in an
                  oil-lubricated bearing shell, typically babbitt-lined. Sleeve bearings require an
                  oil supply system (ring-oiled, pressure-fed or oil mist). They have a longer life
                  than ball bearings when properly maintained and can accommodate higher speeds and
                  loads.
                </li>
                <li>
                  <strong className="text-elec-yellow">Roller Bearings:</strong> Used where high
                  radial loads are present, such as belt-driven applications. Cylindrical or
                  spherical roller bearings provide greater load capacity than ball bearings but are
                  more expensive and require more precise alignment.
                </li>
              </ul>
            </div>

            <h3 className="text-lg font-semibold text-white mt-6 mb-3">
              2.2 Motor Cooling Methods
            </h3>
            <p>
            ...
            <div className="my-4 p-4 rounded-lg bg-white/5">
              <ul className="text-white space-y-3 text-left">
                <li>
                  <strong className="text-elec-yellow">IC411 (TEFC):</strong> Totally Enclosed Fan
                  Cooled. The most common type in industrial use. An external fan mounted on the
                  non-drive end shaft draws air over the motor frame fins. The motor internals are
                  sealed from the external environment, protecting against dust and moisture.
                </li>
                <li>
                  <strong className="text-elec-yellow">IC01 (ODP):</strong> Open Drip Proof. Air is
                  drawn directly through the motor for cooling. Only suitable for clean, dry
                  environments such as plant rooms and switchrooms.
                </li>
                <li>
                  <strong className="text-elec-yellow">IC71 (TENV):</strong> Totally Enclosed
                  Non-Ventilated. Relies on natural convection and radiation for heat dissipation.
                  Used for very small motors or where an external fan cannot be fitted.
                </li>
                <li>
                  <strong className="text-elec-yellow">IC81W:</strong> Water-cooled. A water jacket
                  surrounds the stator for heat removal. Used for large motors in confined spaces or
                  high ambient temperature environments where air cooling is insufficient.
                </li>
              </ul>
            </div>
            <p className="text-sm text-elec-yellow/70">
              <strong>Maintenance note:</strong> For TEFC motors, the cooling fan and fan cowl are
              critical components. A blocked or damaged fan cowl, a broken fan blade, or debris on
              the frame fins will cause the motor to overheat. During every maintenance visit, check
              that the fan is intact, the cowl is secure and the air path is clear of debris.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-4 p-4 rounded-lg bg-white/5">
              <ul className="text-white space-y-3 text-left">
                <li>
                  <strong className="text-elec-yellow">Star Connection:</strong> U2, V2, W2 are
                  linked together (star point). Supply is connected to U1, V1, W1. The voltage
                  across each winding is the supply line voltage divided by the square root of 3
                  (e.g., 400 V supply gives 230 V per winding). Used for higher supply voltages or
                  for star-delta starting.
                </li>
                <li>
                  <strong className="text-elec-yellow">Delta Connection:</strong> U1-W2, V1-U2,
                  W1-V2 are linked. Supply is connected at the junction points. The full line
                  voltage appears across each winding (e.g., 400 V supply gives 400 V per winding).
                  Standard running configuration for most 400 V motors.
                </li>
              </ul>
            </div>
            <p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Maintenance note:</strong> The terminal box should always be checked during
              maintenance for signs of overheating (discoloured connections), moisture ingress
              (condensation or corrosion), loose connections (tighten to the manufacturer's torque
              specification) and damaged cable glands. The gland plate must maintain the motor's IP
              rating.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-4 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-3">
                Key Nameplate Data Fields
              </p>
              <ul className="text-white space-y-3 text-left text-sm">
                <li>
                  <strong className="text-elec-yellow">Rated Power (kW):</strong> The mechanical
                  output power at the shaft. A 7.5 kW motor delivers 7.5 kW of mechanical power. The
                  electrical input power is higher due to losses (copper, iron, friction, windage).
                </li>
                <li>
                  <strong className="text-elec-yellow">Rated Speed (RPM):</strong> The shaft speed
                  at full load. Always less than synchronous speed due to slip (e.g., 1450 RPM for a
                  4-pole motor at 50 Hz).
                </li>
                <li>
                  <strong className="text-elec-yellow">Rated Voltage:</strong> The supply voltage
                  for which the motor is designed. Often shown as 400/690 V (400 V delta, 690 V
                  star) or 230/400 V (230 V delta, 400 V star).
                </li>
                <li>
                  <strong className="text-elec-yellow">Rated Current (A):</strong> The full-load
                  current at rated voltage and power. Used for sizing cables, protective devices and
                  starters. This is the value the overload relay should be set to.
                </li>
                <li>
                  <strong className="text-elec-yellow">Efficiency (eta):</strong> The ratio of
                  mechanical output to electrical input, expressed as a percentage. Modern motors
                  are classified IE1 to IE5 under IEC 60034-30, with IE3 being the minimum for new
                  installations in the EU.
                </li>
                <li>
                  <strong className="text-elec-yellow">Power Factor (cos phi):</strong> Typically
                  0.80 to 0.90 at full load. Significantly lower at light load, which affects the
                  installation's overall power factor and may incur reactive power charges.
                </li>
                <li>
                  <strong className="text-elec-yellow">IP Rating:</strong> The degree of protection
                  against dust and water ingress. IP55 is standard for general industrial use; IP66
                  for washdown areas.
                </li>
                <li>
                  <strong className="text-elec-yellow">Insulation Class:</strong> The maximum
                  temperature the winding insulation can withstand. Class B (130 degrees C), Class F
                  (155 degrees C) and Class H (180 degrees C) are common. Most modern motors use
                  Class F insulation.
                </li>
                <li>
                  <strong className="text-elec-yellow">Duty Cycle:</strong> S1 (continuous), S2
                  (short-time), S3-S8 (various intermittent duties). S1 is the most common
                  designation.
                </li>
                <li>
                  <strong className="text-elec-yellow">Frame Size:</strong> The physical dimensions
                  of the motor, standardised to IEC 60072. Determines mounting dimensions, shaft
                  height and shaft diameter. Essential for replacement compatibility.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-4 p-4 rounded-lg bg-white/5">
              <ul className="text-white space-y-2 text-left">
                <li>
                  <strong className="text-elec-yellow">B3 (Foot Mounted):</strong> The most common
                  configuration. Motor sits on feet bolted to a baseplate or plinth. Horizontal
                  shaft. Used for most general industrial applications.
                </li>
                <li>
                  <strong className="text-elec-yellow">B5 (Flange Mounted):</strong> Motor mounted
                  via a large flange on the drive end. Common for pump and gearbox connections where
                  precise concentricity is needed.
                </li>
                <li>
                  <strong className="text-elec-yellow">B14 (Face Mounted):</strong> Similar to B5
                  but with a smaller flange. Used for smaller motors on machinery.
                </li>
                <li>
                  <strong className="text-elec-yellow">B35 (Foot and Flange):</strong> Combination
                  of foot and flange mounting for maximum flexibility and support.
                </li>
                <li>
                  <strong className="text-elec-yellow">V1 (Vertical, shaft down):</strong> Motor
                  mounted vertically with shaft pointing downward. Common for submersible pumps and
                  vertical fans.
                </li>
              </ul>
            </div>
            ...
            <div className="my-4 p-4 rounded-lg bg-white/5">
              <ul className="text-white space-y-3 text-left">
                <li>
                  <strong className="text-elec-yellow">Angular Misalignment:</strong> The shaft
                  centrelines meet at an angle. This causes axial vibration and thrust bearing wear.
                  Detected by unequal gaps around the coupling periphery.
                </li>
                <li>
                  <strong className="text-elec-yellow">Parallel (Offset) Misalignment:</strong> The
                  shaft centrelines are parallel but offset vertically or horizontally. This causes
                  radial vibration and bearing wear. Detected by a step between the coupling halves.
                </li>
              </ul>
            </div>
            <p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Soft foot (uneven motor feet) must be corrected before
              alignment. If the motor rocks on its feet, it will distort when bolted down,
              misaligning the shaft. Check for soft foot by loosening each foot bolt in turn and
              measuring any gap with a feeler gauge. Correct with stainless steel shims.
            </p>
          </div>
        </section>
        ...
        <div className="mt-10 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              <h3 className="text-elec-yellow font-semibold mb-3 text-sm uppercase tracking-wide">
                Synchronous Speeds (50 Hz)
              </h3>
