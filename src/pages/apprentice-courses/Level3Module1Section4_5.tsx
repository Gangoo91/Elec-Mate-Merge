      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Protecting your body from physical hazards - lifting injuries, hearing damage, and HAVS
          </p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              "Apply correct manual handling assessment and techniques",
              "Understand noise exposure limits and control measures",
              "Recognise HAVS symptoms and causes",
              "Know when health surveillance is required",
              "Select appropriate PPE for noise and vibration",
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="../level3-module1-section4-4">
              <ArrowLeft className="w-4 h-4 mr-2" />
          ...
          <Button
            ...
            asChild
          >
            <Link to="../level3-module1-section4-6">
