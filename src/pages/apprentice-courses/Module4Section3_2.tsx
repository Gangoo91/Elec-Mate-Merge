...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Hydraulic bending', 'PVC bending', 'Electric bending'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['Spirit level', 'Protractor or angle gauge', 'Tape measure'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: ['Hand-operated bending machine', 'Hydraulic bending machine', 'Basic lever machine'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['It wastes energy', 'It can cause kinks or damage to the conduit', "It's too noisy"],
    correctAnswer: 1,
