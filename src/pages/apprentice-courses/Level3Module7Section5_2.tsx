...
const DESCRIPTION =
  'Essential guide to starting and running an electrical contracting business in the UK. Learn about business structures, registration requirements, financial management, and marketing.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'The main advantage of a limited company is limited liability - your personal assets are protected if the business fails. Sole traders have unlimited liability, meaning personal assets could be at risk for business debts.',
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      'VAT registration is mandatory when your taxable turnover exceeds the threshold (currently around 90,000 GBP annually). You can voluntarily register below this threshold, which may benefit you if you primarily deal with VAT-registered businesses.',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 1,
    explanation:
      "Electrical contractors typically purchase materials and pay wages before receiving client payment. Poor cash flow management can lead to inability to pay suppliers or wages even when technically profitable. It's a leading cause of business failure.",
  },
  {
    id: 'check-4',
    ...
    correctIndex: 1,
    explanation:
      'HMRC requires you to keep comprehensive records of all income and expenses, including receipts, invoices, bank statements, and financial accounts for at least 5 years (6 years for limited companies). Good record-keeping is essential for accurate tax returns.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: ['Limited company', 'Partnership', 'Sole trader', 'Limited liability partnership'],
    correctAnswer: 2,
    explanation:
      "Sole trader is the simplest business structure. You simply register with HMRC for self-assessment and start trading. There's no company registration, fewer accounts requirements, and simpler tax returns.",
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      "The UTR is a 10-digit reference number issued by HMRC when you register for self-assessment. You'll need it for filing tax returns and corresponding with HMRC about your tax affairs.",
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'CIS requires contractors in the construction industry to deduct tax from payments to subcontractors and pass this to HMRC. Electricians working as subcontractors will have CIS deductions made. Being CIS registered at gross status avoids deductions.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      "A comprehensive business plan should cover your business concept, target market, competition analysis, services and pricing, financial projections, marketing strategy, and operational plans. It's essential for planning and may be needed for loans.",
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      "Employers' liability insurance is legally required if you employ anyone, even part-time. It covers claims by employees who are injured or become ill due to their work. You could be fined for not having valid cover.",
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      "A trading name (like 'Smith's Electrical Services') allows you to trade under a more professional or memorable name than your personal name or company registered name. It doesn't need to be registered but must appear on business documents alongside your legal name.",
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Self-Assessment tax returns are due by 31 January following the tax year end (5 April). The balancing payment is due by 31 January, with payments on account due 31 January and 31 July. Late payment incurs penalties and interest.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      "Charge-out rates must cover all costs (labour, overheads, vehicle, insurance, tools, training) plus profit. Consider local market rates, your skills and qualifications, and the value you provide. Too low and you won't survive; too high and you won't win work.",
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Separating business and personal finances makes accounting simpler, tax returns more accurate, provides clearer financial picture of business health, and appears more professional to clients and suppliers. Use a dedicated business bank account.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Word of mouth and referrals are typically the most effective marketing for electrical contractors. Doing quality work, being reliable, and asking satisfied customers for reviews and referrals builds sustainable business. Local online presence and trade directories also help.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Start-up costs vary but typically include: van (new or used), tools and test equipment, initial stock/materials, insurance, competent person scheme fees, marketing/website, and working capital for at least 3 months of expenses. Budget 15,000-30,000 GBP minimum for a realistic start, though you can start smaller working from home without a van.',
  },
  {
    question: 'Should I register as a sole trader or limited company?',
    answer:
      'Sole trader is simpler and cheaper to set up, with less administration. Limited company offers limited liability protection and may be more tax-efficient at higher earnings. Many start as sole traders and incorporate later as they grow. Consider consulting an accountant for advice based on your circumstances.',
  },
  {
    question: 'Do I need to join a competent person scheme immediately?',
    answer:
      "If you'll be doing notifiable domestic work (new circuits, consumer unit changes, bathroom work), you either need scheme membership or must use building control for each job. For commercial-only work or non-notifiable domestic work, it's not essential but may help win work.",
  },
  {
    question: 'How do I price my work competitively without undercharging?',
    answer:
      "Calculate your true costs (including all overheads, not just materials and labour), add your required profit margin, and check against local market rates. Don't compete on price alone - compete on quality, reliability, and service. Undercharging leads to unsustainable business.",
  },
  {
    question: 'Should I use an accountant?',
    answer:
      'While not legally required, an accountant can save you money through tax efficiency, ensure compliance, handle year-end accounts, and free your time for earning work. A good accountant typically saves more than they cost. At minimum, consider one for annual accounts and tax returns.',
  },
  {
    question: 'How long before I can expect to be profitable?',
    answer:
      'This varies widely. Many electrical businesses become profitable within the first year if costs are controlled and work is consistent. However, building a sustainable client base typically takes 2-3 years. Plan to support yourself during the early growth phase.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Structure:</strong> Sole trader (simple) vs Limited company (protection)
              </li>
              <li>
                <strong>Registration:</strong> HMRC, VAT if applicable, CIS, insurance
              </li>
              <li>
                <strong>Finance:</strong> Separate accounts, cash flow management, records
              </li>
              <li>
                <strong>Marketing:</strong> Reputation, referrals, online presence
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Opportunities and risks before starting
              </li>
              <li>
                <strong>Use:</strong> Proper planning and professional advice
              </li>
              <li>
                <strong>Apply:</strong> Business skills alongside technical expertise
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The first major decision when starting a business is choosing your legal structure.
              This affects taxation, liability, administration burden, and how others perceive your
              business. The two most common options for electrical contractors are sole trader and
              limited company.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Many electricians start as sole traders for simplicity and
              incorporate later as their business grows. There's no one-size-fits-all answer -
              consider your circumstances and get professional advice.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Starting a business involves various registrations and ongoing compliance
              requirements. Getting these right from the start prevents problems with HMRC and
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>HMRC Self-Assessment:</strong> Register within 3 months of starting to
                  trade. You'll receive a UTR.
                </li>
                <li>
                  <strong>VAT Registration:</strong> Required if turnover exceeds threshold. Can
                  register voluntarily below.
                </li>
                <li>
                  <strong>CIS Registration:</strong> Register if working in construction industry,
                  especially as subcontractor.
                </li>
                <li>
                  <strong>Companies House:</strong> Required for limited companies only.
                </li>
                <li>
                  <strong>ICO Registration:</strong> Required if you hold customer data (most
                  businesses).
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Good financial management is essential for business survival. Many technically
              excellent electricians fail in business due to poor financial planning and cash flow
              management. Understand your numbers from day one.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Critical Point:</strong> Profit doesn't equal cash. You can be profitable on
              paper but run out of cash if clients pay slowly and you must pay suppliers quickly.
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The best technical skills mean nothing without customers. Marketing for electrical
              contractors focuses on building reputation and trust rather than aggressive
              advertising. Most successful electrical businesses grow through referrals and repeat
              customers.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Quality work:</strong> Your best marketing - do excellent work every time
                </li>
                <li>
                  <strong>Ask for reviews:</strong> Google, Checkatrade, Trustpilot - satisfied
                  customers will help
                </li>
                <li>
                  <strong>Professional image:</strong> Clean van, tidy appearance, business cards
                </li>
                <li>
                  <strong>Online presence:</strong> Website, Google Business Profile, social media
                </li>
                <li>
                  <strong>Local networking:</strong> Build relationships with other trades for
                  referrals
                </li>
                <li>
                  <strong>Trade directories:</strong> Scheme listings (NICEIC Find a Contractor,
                  etc.)
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Underpricing</strong> - Calculate true costs, don't just match cheap
                  competitors
                </li>
                <li>
                  <strong>Poor cash flow</strong> - Invoice promptly, chase debts, keep reserves
                </li>
                <li>
                  <strong>No records</strong> - Keep receipts, track expenses, use accounting
                  software
                </li>
                <li>
                  <strong>Growing too fast</strong> - Take on what you can manage well
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="p-5 rounded-lg bg-transparent">
            <h3 className="text-sm font-medium text-white mb-4">
              Quick Reference - Starting a Business
            </h3>
