...
const Level3Module8Section3_3 = () => {
  ...
  const memoryTechniques = [
    ...
    },
    {
      ...
      example:
        'Walk through your house placing test sequence at different rooms: continuity in hallway, insulation in kitchen...',
    ...
    },
    {
      ...
      example:
        'The electron travels from the brown live wire, through the load, returns via the blue neutral...',
  ...
  const commonPatterns = [
    {
      ...
      explanation:
        '0.4s for final circuits (where users interact), 5s for distribution (where only competent persons access)',
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 0,
      explanation:
        "SLIPPT = Seek permission, Locate supply, Identify circuit, Prove proving device, Prove dead, Test proving device again (the two P's and two T's).",
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'CRISP-ZPR represents the test sequence: Continuity, Ring circuit, Insulation resistance, SELV/Polarity (dead tests), then Zs, PFC, RCD (live tests).',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Chunking involves breaking large amounts of information into smaller, manageable groups. This works because working memory can typically hold 7±2 items, and grouping increases effective capacity.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "The Method of Loci involves mentally placing information at specific locations in a familiar environment (like your home). When recalling, you mentally 'walk through' the space, encountering each piece of information.",
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'This mnemonic helps remember MCB instantaneous trip multipliers: Type B trips at 3-5 times rated current, Type C at 5-10 times, and Type D at 10-20 times rated current.',
    },
    {
      question:
        'According to spaced repetition, when should you review new material after first learning it?',
      options: [
      ...
      correctAnswer: 2,
      explanation:
        'Spaced repetition suggests reviewing at increasing intervals: Day 1, Day 3, Day 7, Day 14, Day 30. This combats the forgetting curve and strengthens long-term memory more effectively than massed practice.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Visual memory is processed by different brain areas and tends to be stronger and longer-lasting than purely verbal memory. Creating vivid mental images helps cement information in long-term memory.',
    },
    {
      ...
      correctAnswer: 0,
      explanation:
        'In TN-C-S: T=Terra (earth derived from supply), N=Neutral connected to earth at source, C=Combined neutral/earth in supply cable, S=Separate at installation. The letters describe the earthing arrangement.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'The 0.4/5 second rule refers to maximum disconnection times: 0.4 seconds for final circuits (where users interact) and 5 seconds for distribution circuits (accessed only by competent persons).',
    },
    {
      question: "What memory technique is being used when you create 'CRISP-ZPR'?",
      options: ['Visual association', 'Method of Loci', 'Acronyms/Acrostics', 'Storytelling'],
      correctAnswer: 2,
      explanation:
        'CRISP-ZPR is an acronym - a word or phrase formed from the first letters of items in a list. This provides retrieval cues and makes ordered information easier to recall.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'The 150mm zones from edges, corners, and fittings create predictable locations where cables can be expected. This reduces the risk of cable damage from subsequent work like drilling.',
    },
    {
      question:
        "What's the benefit of linking information into a narrative (storytelling technique)?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'Storytelling engages multiple brain areas (language, emotion, visualisation) which creates more neural connections and makes information more memorable than isolated facts.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Start with existing mnemonics like those provided here. For creating your own, use humour, emotion, or absurdity - they're more memorable. The mnemonic doesn't need to make sense to anyone else, just be meaningful to you.",
    },
    {
      question: 'How many times should I review information to remember it?',
      answer:
        'Research suggests 5-7 exposures are typically needed for long-term retention. Using spaced repetition (Day 1, 3, 7, 14, 30) is more effective than reviewing 7 times in one session. Quality of engagement matters more than quantity.',
    },
    {
      question: "I'm not a visual learner - will visual techniques still work?",
      answer:
        "The concept of 'learning styles' is largely a myth. Visual memory is strong for everyone - it's how our brains evolved. Even if you prefer reading, creating mental images will enhance your memory. Try it before dismissing it.",
    },
    {
      question: 'Should I use memory techniques for everything?',
      answer:
        "No - reserve intensive techniques for information that's hard to remember or frequently needed. For information you naturally understand or that follows logical patterns, understanding is often sufficient. Use techniques strategically.",
    },
    {
      question: 'What if I forget the mnemonic itself?',
      answer:
        "This can happen if you learn too many at once. Start with a few key mnemonics and ensure they're well-established before adding more. Also, understanding the underlying concept provides a backup if the mnemonic fails.",
    },
    {
      question: 'Can I use these techniques in the exam itself?',
      answer:
        "Absolutely. Many candidates quickly jot down key mnemonics on scrap paper at the start of the exam while they're fresh. This 'memory dump' provides a reference throughout the exam and reduces anxiety about forgetting.",
    },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
            ...
            {electricalMnemonics.map((item, index) => (
              <div key={index} className="bg-white/5 border border-white/10 rounded-xl p-4">
                <div className="flex items-start justify-between mb-2">
                  ...
                  <span className="px-3 py-1 bg-elec-yellow/20 text-elec-yellow font-bold rounded">
                    {item.mnemonic}
                  </span>
                </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-8">
          <h3 className="text-lg font-semibold text-white mb-4">
            Quick Reference - Essential Mnemonics
          </h3>
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="space-y-2">
