...
const quizQuestions = [
  {
    ...
    options: ['Table 4D2A', 'Table 4D1A', 'Table 4D5', 'Table 4E1A'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Ib = P / V', 'Ib = P / (√3 × VL × pf)', 'Ib = P / (√3 × VL)', 'Ib = 3 × P / V'],
    correctAnswer: 1,
    explanation:
...
const HNCModule4Section2_1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 2 · Subsection 1"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 311.1 explicitly ties cable sizing to &lsquo;thermal limits and admissible voltage
              drop&rsquo;. The thermal-limits half is delivered by Appendix 4: pick the right
              reference method for the actual installation, apply every derating factor that applies
              (Cg, Ca, Ci, Cf), and verify that the resulting I_z is at least equal to I_n. Skip a
              derating factor and the cable runs above its design temperature, accelerates
              insulation ageing and ultimately fails — often as a fire.
            </>
          }
        ...
        <ConceptBlock title="BS 7671 Appendix 4 Tables">
          ...
          <p>
            <strong>Remember:</strong> Tables ending in 'A' are for copper conductors; those ending
            in 'B' are for aluminium.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Installation Reference Methods">
          <p>
            The installation reference method defines how a cable is installed and directly affects
            its current-carrying capacity. Better cooling means higher capacity; restricted heat
            dissipation means lower capacity.
          </p>
          <p>
        ...
        <ConceptBlock title="Cable Selection Process">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Step 4 — Apply factors:</strong> calculate minimum It required: It = In / (Ca
              × Cg × Ci)
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>Step 5: Table 4D2A Method B: 2.5mm² = 20A (too small), 4mm² = 27A (adequate)</li>
            <li>Select 4mm² twin and earth</li>
          </ul>
          <p>
            <strong>Important:</strong> The calculated minimum It includes the effect of correction
            factors. Always verify the final selection meets voltage drop requirements.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — lighting circuit:</strong> Select cable for 20 × 45W LED luminaires
            on a 230V circuit, cables in trunking (Method B), 30°C ambient, no grouping.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 2 — three-phase motor:</strong> Size cable for 15kW AHU motor (pf 0.85),
            400V 3φ, XLPE/SWA on cable tray (Method E), 40°C plant room.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              between traditional 32&nbsp;A ring-finals and 20&nbsp;A radial circuits. The cables
              run in 2-tier galvanised perimeter trunking with up to 6 circuits grouped, ambient
              ceiling-void temperature 35&nbsp;°C in summer.
            </>
          }
          whatToDo={
            <>
              Reference method B (in trunking). Six circuits grouped: C_g ≈ 0.57 (Appendix 4 Table
              4C1). Ambient 35&nbsp;°C: C_a ≈ 0.94 for 70&nbsp;°C thermoplastic. For a ring-final on
              32&nbsp;A: I_t needed = 32 / (0.57 × 0.94) = ≈ 60&nbsp;A → 4&nbsp;mm² conductors at
              minimum. For a 20&nbsp;A radial: I_t = 20 / 0.535 = ≈ 38&nbsp;A → 2.5&nbsp;mm² fine.
              Combined with voltage-drop check (Reg 525.202) and cost, radials are usually the
              cleaner choice on commercial floorplates with grouped circuits.
            </>
          }
          whyItMatters={
            <>
              Forget the grouping factor and you have a 32&nbsp;A protective device on a cable with
              a real I_z below 32&nbsp;A — Reg 311.1 thermal-limits breach, slow insulation ageing,
              and a fire risk that the periodic inspection should catch but often does not.
              Reference method matters: trunking (B) is more onerous than clipped direct (C).
            </>
          }
        />
