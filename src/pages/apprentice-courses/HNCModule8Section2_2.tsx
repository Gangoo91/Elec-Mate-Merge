...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['4.0-5.0 m/s', '0.5-1.0 m/s', '2.5-3.5 m/s', '1.5-2.0 m/s'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Fine filter', 'HEPA filter', 'Ultra-fine filter', 'Coarse filter'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['G4 (coarse)', 'H13 (HEPA)', 'F7 (fine)', 'No filtration required'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Filter type', 'Building height', 'Ductwork material', 'Motor power rating'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['15-25 dB', '35-45 dB', '5-10 dB', '50-60 dB'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Night setback', 'Zone reset', 'Economiser control', 'Demand control ventilation'],
    correctAnswer: 2,
    explanation:
      ...
      <HubBody>
        ...
        <ConceptBlock title="AHU Components and Functions">
          <p>
            ...
            Understanding each component's function is essential for proper selection, installation
            and maintenance.
          </p>
          <p>
            <strong>Primary AHU Components:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Intake/mixing section:</strong> Fresh air inlet with weather louvres, mixing
              dampers for recirculated air
            </li>
            <li>
              <strong>Filter section:</strong> Pre-filters (G4) and main filters (F7/F9) to remove
              airborne particles
            </li>
            <li>
              <strong>Heating coil:</strong> LTHW, steam, or electric heater battery for air heating
            </li>
            <li>
              <strong>Cooling coil:</strong> Chilled water or DX refrigerant coil for cooling and
              dehumidification
            </li>
            <li>
              <strong>Humidifier:</strong> Steam injection or evaporative humidifier for moisture
              addition
            </li>
            <li>
              <strong>Supply fan:</strong> Centrifugal or plug fan to deliver air at required volume
              and pressure
            </li>
            <li>
          ...
          <p>
            <strong>Component Arrangement - Typical Sequence</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1:</strong> Intake louvre/damper — Weather protection, isolation, air volume
              control
            </li>
            <li>
              <strong>2:</strong> Mixing box — Blend fresh and recirculated air
            </li>
            <li>
              <strong>3:</strong> Pre-filter (G4) — Remove coarse particles, protect main filter
            </li>
            <li>
              <strong>4:</strong> Heating coil — Pre-heat (frost protection), main heating
            </li>
            <li>
              <strong>5:</strong> Cooling coil — Sensible and latent cooling
            </li>
            <li>
              <strong>6:</strong> Droplet eliminator — Prevent condensate carryover
            </li>
            <li>
              <strong>7:</strong> Main filter (F7) — Fine particle filtration
            </li>
            <li>
              <strong>8:</strong> Supply fan — Air movement at design volume/pressure
            </li>
            <li>
              <strong>9:</strong> Attenuator — Noise reduction before distribution
            </li>
          </ul>
          <p>
            <strong>Damper Types and Applications</strong>
          </p>
          ...
          <p>
            <strong>Design consideration:</strong> AHU component arrangement affects performance and
            maintenance. Ensure adequate access for filter changes, coil cleaning, and fan belt
            adjustment. Minimum 600mm clear space is required for service access.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Heating and Cooling Coil Selection">
          ...
          <p>
            <strong>Coil Selection Parameters</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Face velocity:</strong> 2.5-3.5 m/s — 2.0-2.5 m/s
            </li>
            <li>
              <strong>Rows typical:</strong> 1-2 rows — 4-8 rows
            </li>
            <li>
              <strong>Fin spacing:</strong> 2.5-4 fins/cm — 3-5 fins/cm
            </li>
            <li>
              <strong>Pressure drop (air):</strong> 50-100 Pa — 100-200 Pa
            </li>
            <li>
              <strong>Water velocity:</strong> 0.5-1.5 m/s — 0.5-1.5 m/s
            </li>
          </ul>
          <p>
            <strong>Coil Capacity Calculation</strong>
          </p>
          ...
          <p>
            <strong>Critical Design Considerations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Frost protection:</strong> Pre-heat coil or face/bypass damper for sub-zero
              outdoor air
            </li>
            <li>
          ...
          <p>
            <strong>Selection tip:</strong> Use manufacturer's selection software for accurate coil
            sizing. Input design conditions and verify that selected coil meets duty within
        ...
        <ConceptBlock title="Filtration Systems and Filter Grades">
          <p>
            Air filtration protects building occupants, maintains indoor air quality, and preserves
            HVAC equipment. Filter selection depends on application requirements, with multi-stage
            filtration providing optimal performance and economy.
          </p>
          <p>
            <strong>Filter Classifications (EN ISO 16890)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>G4:</strong> ISO Coarse &gt;50% — Coarse — Pre-filter, equipment protection
            </li>
            <li>
              <strong>F7:</strong> ePM1 50-65% — Fine — Offices, retail, general HVAC
            </li>
            <li>
              <strong>F9:</strong> ePM1 &gt;80% — Fine — Healthcare, laboratories
            </li>
            <li>
              <strong>H13:</strong> HEPA 99.95% — HEPA — Operating theatres, cleanrooms
            </li>
            <li>
              <strong>H14:</strong> HEPA 99.995% — HEPA — Pharmaceutical, aseptic areas
            </li>
          </ul>
          <p>
            <strong>Multi-Stage Filtration Strategy</strong>
          </p>
          <p>
            <strong>Stage 1: Pre-filter</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Stage 2: Main Filter</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Stage 3: Final Filter</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Application Filter Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Office/retail:</strong> G4 — F7 — -
            </li>
            <li>
              <strong>Hospital wards:</strong> G4 — F7/F9 — -
            </li>
            <li>
              <strong>Operating theatre:</strong> G4 — F9 — H13/H14
            </li>
            <li>
              <strong>Cleanroom ISO 7:</strong> G4 — F9 — H13
            </li>
            <li>
              <strong>Cleanroom ISO 5:</strong> G4 — F9 — H14/ULPA
            </li>
          </ul>
          <p>
            <strong>Filter Pressure Drop Monitoring</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Initial pressure drop:</strong> Clean filter pressure drop at design velocity
            </li>
            <li>
              <strong>Final pressure drop:</strong> Maximum allowable before replacement (typically
              2-3× initial)
            </li>
            <li>
              <strong>Differential pressure switch:</strong> Provides alarm when filter approaches
              final pressure drop
            </li>
            <li>
              <strong>BMS integration:</strong> Continuous monitoring enables predictive maintenance
            </li>
            <li>
          ...
          <p>
            <strong>Maintenance note:</strong> Filter replacement is a significant operational cost.
            Using pre-filters extends main filter life by 50% or more. Always replace pre-filters
            before they become fully loaded to protect downstream components.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Acoustic Treatment and Electrical Systems">
          ...
          <p>
            <strong>Acoustic Treatment Components</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Rectangular attenuator:</strong> Ductwork noise reduction — 15-25 dB
              (frequency dependent)
            </li>
            <li>
              <strong>Circular attenuator:</strong> Spigot/branch attenuation — 10-20 dB
            </li>
            <li>
              <strong>Acoustic lining:</strong> Ductwork internal absorption — 3-10 dB per metre
            </li>
            <li>
              <strong>Flexible connection:</strong> Vibration isolation — Structure-borne break
            </li>
            <li>
              <strong>Anti-vibration mounts:</strong> Fan/motor isolation — 85-95% vibration
              reduction
            </li>
          </ul>
          <p>
            <strong>Noise Transmission Paths</strong>
          </p>
          <p>Airborne Paths:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>AHU Electrical Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Supply fan motor:</strong> 400V 3-phase — Largest electrical load, VSD
              recommended
            </li>
            <li>
              <strong>Extract fan motor:</strong> 400V 3-phase — VSD for VAV systems
            </li>
            <li>
              <strong>Control panel:</strong> 230V single-phase — BMS interface, safety circuits
            </li>
            <li>
              <strong>Damper actuators:</strong> 24V AC or 230V — Spring-return for fire dampers
            </li>
            <li>
              <strong>Electric heater:</strong> 400V 3-phase — SCR control, airflow interlock
              required
            </li>
            <li>
              <strong>Humidifier:</strong> 400V 3-phase — Steam generator has high power demand
            </li>
          </ul>
          <p>
            <strong>Control Panel Requirements</strong>
          </p>
          <p>
            <strong>Power Components</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Safety Interlocks Required</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Airflow proving:</strong> Electric heater disabled without adequate airflow
            </li>
            <li>
          ...
          <p>
            <strong>VSD Benefits for AHU Fans</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Energy savings:</strong> Fan power varies with cube of speed (affinity laws)
            </li>
            <li>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Fan selection</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
