    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Understanding how the AM2 is marked and what constitutes a pass or fail - your key to
          assessment success.
        </p>
        ...
        <ConceptBlock title="What this section is for">
          <p>
            <strong className="text-elec-yellow">Important Note.</strong> The AM2 is not a "college
            exam" — it is a competence-based final assessment overseen by NET to prove you can work
            independently and safely as an electrician. Unlike written exams, the AM2 is judged
            against strict marking criteria and thresholds, with particular focus on safety,
            accuracy, and compliance with BS 7671.
          </p>
          <p>
            Some mistakes will only lose you marks, but others are considered critical fails that
            stop you passing regardless of your score elsewhere. Understanding how the AM2 is marked
            is vital to preparing effectively.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="3. Critical Fails (Automatic Failures)">
          <p>NET defines certain errors as automatic fails regardless of performance elsewhere:</p>
          <p>
        ...
        <ConceptBlock title="4. Section-by-Section Expectations">
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Composite Installation</strong> — must follow drawings exactly; correct cable
              types, routing, termination, and neatness standards
            </li>
            <li>
              <strong>Inspection, Testing &amp; Certification</strong> — step-by-step GN3 procedure;
              accurate test results; correctly completed EIC
            </li>
            <li>
        ...
        <ConceptBlock title="Real-world Examples">
          <p>
            ...
            wired an entire installation correctly but missed one key step in safe isolation (didn't
            re-prove tester). Result: Automatic fail despite otherwise excellent work.
          </p>
          <p>
            <strong className="text-elec-yellow">Example 2: Insufficient Fault Finding.</strong>{' '}
            Candidate completed installation work but only correctly identified 1/4 faults. Overall
            high marks in installation didn't save them — failed due to not meeting section
            threshold.
          </p>
          <p>
            <strong className="text-amber-400">Example 3: Specification Deviation.</strong>{' '}
            Candidate completed installation neatly but didn't follow the drawing (used wrong cable
            size for cooker). Marked down heavily — borderline pass due to accuracy requirements.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              a CPC you rushed at the end. The conductor is over-stripped and one strand is proud of
              the terminal.
            </>
          }
          whatToDo={
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              proving the test lamp before isolating Section C, or you leave the certificate signed
              but missing a Zs reading. Both are critical-fail territory.
            </>
          }
          doInstead={
            <>
              Memorise the critical-fail list before you walk in. Treat each one as a non-negotiable
              checkpoint. Speed is worth nothing if a single critical fail ends the whole 2½ days.
            </>
          }
        />
