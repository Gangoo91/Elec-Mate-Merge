        ...
        <section className="mb-10">
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-elec-yellow mb-3">BS 7671 Bathroom Zoning System</h5>
                <div className="space-y-4">
                    ...
                    <table className="w-full border-collapse border border-white/10 text-sm">
                      <thead>
                        <tr className="">
                          ...
                          <th className="border border-white/10 p-3 text-left">Equipment Permitted</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <td className="border border-white/10 p-3"><strong>Zone 0</strong></td>
                          ...
                          <td className="border border-white/10 p-3">Current-using equipment for that zone only</td>
                        </tr>
                        <tr className="bg-muted/5">
                          <td className="border border-white/10 p-3"><strong>Zone 1</strong></td>
                          ...
                          <td className="border border-white/10 p-3">Water heaters, shower pumps, ventilation</td>
                        </tr>
                        <tr>
                          <td className="border border-white/10 p-3"><strong>Zone 2</strong></td>
                          ...
                          <td className="border border-white/10 p-3">Luminaires, ventilation, water heating</td>
                        </tr>
                        <tr className="bg-muted/5">
                          <td className="border border-white/10 p-3"><strong>Outside Zones</strong></td>
                          ...
                          <td className="border border-white/10 p-3">Standard equipment (not 13A sockets)</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="p-3 bg-white/5 rounded-lg">
                      <h6 className="font-medium text-white mb-2">Equipment Prohibited in All Zones</h6>
                      <ul className="space-y-1 text-sm">
          ...
          <div className="mb-6">
            ...
            <div className="mb-6">
              ...
              <div className="p-4 bg-transparent border border-border/30 rounded-lg mb-4">
                <h5 className="font-medium text-elec-yellow mb-3">IP Rating Selection for Outdoor Use</h5>
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-white/10 text-sm">
                    <thead>
                      <tr className="">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="border border-white/10 p-3">IP66</td>
                        <td className="border border-white/10 p-3">Internal heater for condensation</td>
                      </tr>
                      <tr className="bg-muted/5">
                        <td className="border border-white/10 p-3">Junction Boxes</td>
                        <td className="border border-white/10 p-3">IP65</td>
                        <td className="border border-white/10 p-3">IP67</td>
                        <td className="border border-white/10 p-3">Avoid if possible - use integral connections</td>
                      </tr>
                      <tr>
                        <td className="border border-white/10 p-3">Cable Glands</td>
                        <td className="border border-white/10 p-3">IP68</td>
                        <td className="border border-white/10 p-3">IP68</td>
                        <td className="border border-white/10 p-3">Match or exceed enclosure rating</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">Q: Can I install a normal light switch in a bathroom?</h3>
            ...
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">Q: Are outdoor lights required to be IP-rated?</h3>
              <p className="text-xs sm:text-sm text-white">
            ...
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">Q: Do outdoor sockets need to be switched?</h3>
              <p className="text-xs sm:text-sm text-white">
                A: Not mandatory by regulation, but switching adds convenience and provides additional isolation for maintenance safety.
              </p>
            </div>
            <div className="p-4 bg-transparent border border-white/10 rounded-lg">
              <h3 className="font-medium text-white mb-2">Q: Can I use a shaver socket in Zone 1?</h3>
              <p className="text-xs sm:text-sm text-white">
