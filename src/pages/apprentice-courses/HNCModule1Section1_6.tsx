...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Part M', 'Part A', 'Part P', 'Part L'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['GWP above 750', 'GWP above 2500', 'There is no GWP threshold', 'GWP above 150'],
    correctAnswer: 1,
    explanation:
...
const HNCModule1Section1_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1.1.6"
        title="Environmental and Building Regulations"
        backTo="../h-n-c-module1-section1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Essential UK legislation governing environmental protection, electrical installations, and
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              hazardous load (lamps, batteries, asbestos, oil) goes via a registered carrier, and
              the waste hierarchy (prevent, reuse, recycle, recover, dispose) is documented.
            </>
          }
        ...
        <ConceptBlock title="Environmental Protection Act 1990">
          <p>
            The Environmental Protection Act 1990 (EPA 1990) is the cornerstone of UK environmental
            legislation. For building services professionals, understanding its requirements is
            essential for legal compliance and professional practice.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Part III:</strong> Statutory nuisances - noise, dust, odours from construction
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Prevent escape</strong> — Action: Store waste securely on site. Evidence:
              Covered skips, locked compounds
            </li>
            <li>
              <strong>Transfer to authorised person</strong> — Action: Check carrier's licence.
              Evidence: Carrier registration number
            </li>
            <li>
              <strong>Describe waste accurately</strong> — Action: Complete transfer documentation.
              Evidence: Waste Transfer Notes (2 years)
            </li>
            <li>
              <strong>Prevent illegal disposal</strong> — Action: Verify final destination.
              Evidence: Licensed facility confirmation
            </li>
          </ul>
            ...
            whatHappens={
              <>
                <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
                  ...
                  <li>
                    <strong>Vehicle seizure:</strong> Powers to seize vehicles used for illegal
                    waste activity
                  </li>
                </ul>
              </>
        ...
        <ConceptBlock title="Part P Building Regulations - Electrical Safety">
          ...
          <div>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>Any work in special locations (bathrooms, swimming pools)</li>
          ...
          <div>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>Adding sockets/FCUs from existing circuits (not in special locations)</li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Kitchens:</strong> New circuits require notification, but adding sockets to
              existing circuits does not
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Competent Person Scheme</strong> — Process: Self-certify and notify scheme
              within 30 days. Certification: EIC + Building Regs Compliance Cert
            </li>
            <li>
              <strong>Building Control</strong> — Process: Notify LA before work, arrange
              inspections. Certification: EIC + LA Completion Certificate
            </li>
            <li>
              <strong>Third Party Certification</strong> — Process: Engage registered third party
              certifier. Certification: EIC + Third Party Certificate
            </li>
          </ul>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Note:</strong> Part P applies to England and Wales only. Scotland uses Building
            Standards, and Northern Ireland has its own Building Regulations.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="F-gas Regulations - Refrigerant Handling">
          <p>
            ...
            greenhouse gases (HFCs, PFCs, SF6) to combat climate change. For building services, this
            primarily affects air conditioning, refrigeration, and heat pump installations.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Personnel must hold appropriate certification (Categories I-IV)</li>
            <li>Refrigerant must be recovered during servicing and at end of life</li>
            <li>Leak checking requirements based on CO2-equivalent charge</li>
            <li>Records must be kept of refrigerant quantities and leak checks</li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Category I</strong> — Scope of Work: All activities - no charge limit. Typical
              Applications: Commercial HVAC contractors
            </li>
            <li>
              <strong>Category II</strong> — Scope of Work: Recovery from equipment &lt;3kg charge.
              Typical Applications: Small systems, domestic AC
            </li>
            <li>
              <strong>Category III</strong> — Scope of Work: Recovery from equipment &lt;3kg
              (hermetic). Typical Applications: Domestic refrigeration
            </li>
            <li>
              <strong>Category IV</strong> — Scope of Work: Leak checking only. Typical
              Applications: Maintenance staff, inspectors
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>&lt;5 tonnes CO2e</strong> — Minimum Check Frequency: Not required. Notes:
              Good practice to check
            </li>
            <li>
              <strong>5-50 tonnes CO2e</strong> — Minimum Check Frequency: Every 12 months. Notes:
              Every 24 months with leak detection
            </li>
            <li>
              <strong>50-500 tonnes CO2e</strong> — Minimum Check Frequency: Every 6 months. Notes:
              Every 12 months with leak detection
            </li>
            <li>
              <strong>&gt;500 tonnes CO2e</strong> — Minimum Check Frequency: Every 3 months. Notes:
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            increasingly common for new split AC systems, while natural refrigerants (R290 propane,
            R744 CO2) are used in supermarket refrigeration.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Waste Regulations - WEEE and Hazardous Waste">
          <p>
            Building services work generates significant waste, from replaced equipment to packaging
            and construction materials. Proper classification and disposal is both a legal
            requirement and professional responsibility.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Producer responsibility:</strong> Manufacturers must finance collection and
              treatment
            </li>
            <li>
            ...
            <li>
              <strong>Holder responsibility:</strong> Business users must arrange proper disposal
            </li>
            <li>
              <strong>AATF:</strong> All WEEE must go to Approved Authorised Treatment Facilities
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fluorescent tubes</strong> — Hazardous Components: Mercury, phosphor powder.
              Disposal Route: Hazardous waste collection
            </li>
            <li>
              <strong>Air conditioning units</strong> — Hazardous Components: Refrigerant, oil.
              Disposal Route: F-gas recovery + AATF
            </li>
            <li>
              <strong>Control panels</strong> — Hazardous Components: Batteries, capacitors.
              Disposal Route: AATF for WEEE
            </li>
            <li>
              <strong>Older thermostats</strong> — Hazardous Components: Mercury switches. Disposal
              Route: Hazardous waste collection
            </li>
            <li>
              <strong>UPS systems</strong> — Hazardous Components: Lead-acid batteries. Disposal
              Route: Battery recycler + AATF
            </li>
          </ul>
        ...
        <ConceptBlock title="Additional Building Regulations">
          <p>
            <strong>Part L - Conservation of Fuel and Power</strong>
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lighting:</strong> Minimum efficacy requirements, controls for presence and
              daylight
            </li>
            <li>
          ...
          <p>
            <strong>Part F - Ventilation</strong>
          </p>
          <p className="text-sm text-white mb-2">
          ...
          <p>
            <strong>Part B - Fire Safety</strong>
          </p>
          <p className="text-sm text-white mb-2">
        ...
        <ConceptBlock title="Practical Compliance Checklist">
          <div>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>Check for other relevant Building Regulations (Part L, F, B)</li>
              <li>Establish waste streams and disposal routes</li>
              <li>Verify personnel hold required certifications (F-gas if applicable)</li>
              <li>Notify Building Control or competent person scheme as required</li>
            </ul>
          </div>
          ...
          <div>
            <p>
              <strong>Common Compliance Failures</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You are project-engineer on a high-street strip-out. The existing fit-out contains 230
              fluorescent tubes, four 24 V sealed-lead-acid emergency lighting batteries and a 6 kVA
              online UPS with eight VRLA cells. The contractor wants them in the general waste skip.
            </>
          }
          whatToDo={
            <>
              Refuse. Apply EPA 1990 s.34 duty of care, the Hazardous Waste Regulations 2005
              (lead-acid batteries are absolute-entry hazardous waste), and the Waste Electrical and
              Electronic Equipment Regulations 2013 (UPS, lamps and emergency packs are all WEEE).
              Segregate at source: lamps to a registered tube recycler; batteries via a Battery
              Compliance Scheme; UPS to a B2B WEEE producer take-back or AATF. File the consignment
              notes for three years.
            </>
          }
          whyItMatters={
            <>
              Fly-tipping or mis-routing hazardous waste is an unlimited-fine offence and personal
              director liability under EPA s.157. The Environment Agency cross-checks consignment
              notes against carrier records.
            </>
          }
        />
