      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Essential UK legislation governing environmental protection, electrical installations,
            and building services compliance
          </p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>EPA 1990:</strong> Controls waste, pollution, and environmental
                contamination
              </li>
              <li className="pl-1">
                <strong>Part P:</strong> Electrical safety in dwellings - notification required
              </li>
              <li className="pl-1">
                <strong>F-gas:</strong> Refrigerant handling requires certified personnel
              </li>
              <li className="pl-1">
                <strong>WEEE:</strong> Proper disposal of electrical equipment
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Waste duty of care:</strong> All construction waste properly managed
              </li>
              <li className="pl-1">
                <strong>Competent person schemes:</strong> NICEIC, NAPIT self-certification
              </li>
              <li className="pl-1">
                <strong>Part L:</strong> Energy efficiency requirements
              </li>
              <li className="pl-1">
                <strong>Hazardous waste:</strong> Specialist disposal requirements
              </li>
            </ul>
          </div>
        </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Licensed facility confirmation
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Self-certify and notify scheme within 30 days
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        EIC + Building Regs Compliance Cert
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Building Control</td>
                      <td className="border border-white/10 px-3 py-2">
                        Notify LA before work, arrange inspections
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        EIC + LA Completion Certificate
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Engage registered third party certifier
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        EIC + Third Party Certificate
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        All activities - no charge limit
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Recovery from equipment &lt;3kg charge
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Small systems, domestic AC
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Category III</td>
                      <td className="border border-white/10 px-3 py-2">
                        Recovery from equipment &lt;3kg (hermetic)
                      </td>
