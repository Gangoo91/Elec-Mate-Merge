...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Farads', 'Ohms', 'Siemens', 'Henrys'],
    correctAnswer: 1,
    explanation:
...
const HNCModule3Section2_2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 2 · Subsection 2"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Z_s is impedance, not pure resistance — on three-phase circuits and long runs the
              inductive component matters and the calculated Z is bigger than the R₁ + R₂ you
              measured at DC. Always derive disconnection times from the impedance value, not from a
              continuity-only ohms reading.
            </>
          }
        ...
        >
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Capacitive reactance:</strong> X<sub>C</sub> = 1/(2πfC) (decreases with
              frequency)
            </li>
            <li>
        ...
        <ConceptBlock title="Inductive Reactance (X_L)">
          <p>
            Inductive reactance is the opposition to AC current flow caused by an inductor. When AC
            current flows through an inductor, the changing magnetic field induces a back-EMF that
            opposes the change in current. This opposition increases with both frequency and
            inductance.
          </p>
          ...
          <p>
            ...
            — Where: f = frequency (Hz), L = inductance (H), ω = 2πf (rad/s).
          </p>
          <p className="text-sm font-medium text-white">Key characteristics:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              X<sub>L</sub> is measured in Ohms (Ω)
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Small single-phase motor:</strong> 50-100mH — X<sub>L</sub> = 15.7-31.4Ω at
              50Hz
            </li>
            <li>
              <strong>Three-phase motor (per phase):</strong> 10-50mH — X<sub>L</sub> = 3.14-15.7Ω
              at 50Hz
            </li>
            <li>
        ...
        <ConceptBlock title="Capacitive Reactance (X_C)">
          ...
          <p>
            ...
            — Where: f = frequency (Hz), C = capacitance (F), ω = 2πf (rad/s).
          </p>
          <p className="text-sm font-medium text-white">Key characteristics:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              X<sub>C</sub> is measured in Ohms (Ω)
            </li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">
            Frequency Dependence Comparison (L = 100mH; C = 100µF)
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              50Hz: X<sub>L</sub> = 31.4Ω; X<sub>C</sub> = 31.8Ω
            </li>
            <li>
              100Hz: X<sub>L</sub> = 62.8Ω; X<sub>C</sub> = 15.9Ω
            </li>
            <li>
              150Hz: X<sub>L</sub> = 94.2Ω; X<sub>C</sub> = 10.6Ω
            </li>
          </ul>
          <p className="text-sm text-elec-yellow/70">
        ...
        <ConceptBlock title="Complex Impedance (Z = R + jX)">
          ...
          <p>
            <strong>Z = R + jX</strong> — Where R = resistance, X = net reactance (X<sub>L</sub> - X
            <sub>C</sub>), j = √-1.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Series and Parallel Impedance Combinations">
          ...
          <p>
            ...
            — Add complex impedances directly: (R<sub>1</sub> + jX<sub>1</sub>) + (R<sub>2</sub>+ jX
            <sub>2</sub>) = (R<sub>1</sub> + R<sub>2</sub>) + j(X<sub>1</sub> + X<sub>2</sub>).
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">Parallel Impedance</p>
          <p>
            <strong>
              1/Z<sub>T</sub> = 1/Z<sub>1</sub> + 1/Z<sub>2</sub> + ...
            </strong>{' '}
            For two impedances: Z<sub>T</sub> = (Z<sub>1</sub> × Z<sub>2</sub>)/(Z<sub>1</sub> + Z
            <sub>2</sub>).
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">Building Services Applications</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Motor circuit (cable + motor):</strong> Series — Z<sub>cable</sub> + Z
              <sub>motor</sub>
            </li>
            <li>
            ...
            <li>
              <strong>Fault loop (source + cable):</strong> Series — Z<sub>s</sub> = Z<sub>e</sub> +
              Z<sub>cable</sub>
            </li>
          </ul>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Design note:</strong> For small cables (&lt;25mm²), reactance is negligible and
            Z ≈ R. For larger cables, especially long runs, include reactance in voltage drop
            calculations.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              X<sub>L</sub> = 2πfL = 2π × 50 × 0.050 = <strong>15.7Ω</strong>
            </li>
            <li>
              |Z| = √(R² + X<sub>L</sub>²) = √(64 + 246.5) = √310.5 = <strong>17.6Ω</strong>
            </li>
            <li>
              I = V/|Z| = 230/17.6 = <strong>13.1A</strong>
            </li>
            <li>
              θ = arctan(15.7/8) = <strong>63°</strong> lagging → pf = cos(63°) = 0.45
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              |Z| = V/I = 230/20 = 11.5Ω; θ<sub>1</sub> = arccos(0.7) = 45.6°
            </li>
            <li>
              R = 11.5 × 0.7 = 8.05Ω; X<sub>L</sub> = 11.5 × 0.714 = 8.21Ω
            </li>
            <li>
              θ<sub>2</sub> = arccos(0.95) = 18.2° → X<sub>new</sub> = R × tan(θ<sub>2</sub>) = 8.05
              × 0.329 = 2.65Ω
            </li>
            <li>
              X<sub>C</sub> = X<sub>L</sub> - X<sub>new</sub> = 8.21 - 2.65 = <strong>5.56Ω</strong>
            </li>
            <li>
              C = 1/(2πfX<sub>C</sub>) = 1/(2π × 50 × 5.56) = <strong>573µF</strong>
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Z<sub>base</sub> = V²/S = 400²/100000 = 1.6Ω
            </li>
            <li>
              Z<sub>T</sub> = 4% × Z<sub>base</sub> = 0.04 × 1.6 = <strong>0.064Ω</strong>
            </li>
            <li>
              Given X/R = 10, |Z|² = R² + (10R)² = 101R² → R = 0.064/10.05 = <strong>6.4 mΩ</strong>
            </li>
            <li>
              X = 10R = <strong>64 mΩ</strong> → Z = 0.0064 + j0.064 Ω
            </li>
          </ul>
          ...
          <p>
            ...
            <sub>e</sub>= 0.35Ω and uses 30m of 4mm² cable (R = 4.61mΩ/m, X = 0.1mΩ/m). Calculate
            total Z<sub>s</sub>.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              R<sub>cable</sub> = 30 × 2 × 4.61 mΩ = 0.277Ω; X<sub>cable</sub> = 30 × 2 × 0.1 mΩ =
              0.006Ω
            </li>
            <li>
              Assuming Z<sub>e</sub> resistive: R<sub>total</sub> = 0.35 + 0.277 = 0.627Ω; X
              <sub>total</sub> = 0.006Ω
            </li>
            <li>
              |Z<sub>s</sub>| = √(0.627² + 0.006²) ≈ <strong>0.627Ω</strong> (X negligible for 4mm²)
            </li>
            <li>
              I<sub>pf</sub> = U₀/Z<sub>s</sub> = 230/0.627 = <strong>367A</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              2π × 50Hz = <strong>314.16 rad/s</strong>
            </li>
            <li>
              At 50Hz: X<sub>L</sub> = 314L (L in henrys)
            </li>
            <li>
              At 50Hz: X<sub>C</sub> = 3183/C (C in µF gives X in Ω)
            </li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              that reactance depends on frequency. Sign errors: X<sub>L</sub> is +j, X<sub>C</sub>{' '}
              is -j. Ignoring cable reactance on long large cable runs.
            </>
          }
          doInstead={
            <>
        ...
        <Scenario
          ...
          situation={
            <>
              A 15 kW three-phase induction motor on the supply-air AHU has a measured running
              impedance of (3 + j5) Ω per phase. The blocked-rotor (locked-rotor) impedance is
              roughly one sixth of running impedance because rotor reactance drops at standstill.
              You need to estimate Direct-On-Line starting current to size cable, MCCB and feeder
              transformer.
            </>
          }
          whatToDo={
            <>
              Compute running impedance: |Z_run| = √(3² + 5²) = √34 ≈ 5.83 Ω, giving full-load line
              current of 230 / 5.83 ≈ 39 A. Estimate blocked-rotor impedance |Z_start| ≈ 5.83 / 6 ≈
              0.97 Ω, giving DOL starting current ≈ 230 / 0.97 ≈ 237 A — about 6 × FLC, consistent
              with NEMA Code F. Pick a Type C or D MCB sized for the running load but rated to ride
              through the start, and confirm the upstream transformer can deliver 237 A for several
              seconds without excessive voltage dip (≤ 5 % is the usual target).
            </>
          }
          whyItMatters={
            <>
              Impedance is the only correct model for AC starting current. Treating the motor as a
              pure resistance under-estimates inrush by a factor of six — the upstream MCB
              nuisance-trips on every start, the cable cooks under repeated inrush, and the feeder
              transformer dips voltage on neighbouring circuits. Soft-start or VFD systems exist
              precisely because of this DOL starting impedance behaviour.
            </>
          }
        />
