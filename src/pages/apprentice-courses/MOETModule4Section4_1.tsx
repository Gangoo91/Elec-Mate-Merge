      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Prove-test-prove:</strong> Confirm indicator works before and after testing
              </li>
              <li className="pl-1">
                <strong>Multi-source:</strong> Identify and isolate ALL supplies including backfeed
              </li>
              <li className="pl-1">
                <strong>Lock and tag:</strong> Personal lock prevents unauthorised re-energisation
              </li>
              <li className="pl-1">
                <strong>Verify after repair:</strong> IR, continuity, visual checks before
                re-energising
              </li>
            </ul>
          </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ol className="text-sm text-white space-y-2 list-decimal list-outside ml-5">
                <li className="pl-1">
                  ...
                  schedules, and schematic diagrams to identify the correct circuit and all points
                  of isolation. Physically trace the circuit where any doubt exists.
                </li>
                <li className="pl-1">
                  <strong>Identify all sources of supply:</strong> Consider mains, standby
                  generators, UPS systems, battery supplies, PV arrays, and any possibility of
                  backfeed from interconnected equipment or parallel sources.
                </li>
                <li className="pl-1">
                  <strong>Notify affected persons:</strong> Inform all persons who may be affected
                  by the isolation, including building occupants, production staff, and the duty
                  holder or responsible person.
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Lock off and tag:</strong> Apply your personal safety lock and danger tag
                  to the isolator. Use a multi-lock hasp if multiple persons will be working. Retain
                  the only key on your person.
                </li>
                <li className="pl-1">
                  <strong>Prove the voltage indicator:</strong> Test the two-pole voltage indicator
                  on a known live source or proving unit to confirm it indicates correctly.
                </li>
                <li className="pl-1">
                  <strong>Test for dead:</strong> Test between all live conductors and earth, and
                  between all live conductors, at the point of work. For single phase: L-N, L-E,
                  N-E. For three phase: L1-L2, L2-L3, L1-L3, L1-N, L2-N, L3-N, L1-E, L2-E, L3-E,
                  N-E.
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                Never assume a circuit is dead because a switch is in the 'off' position, a fuse has
                been removed, or a colleague tells you it is dead. The only acceptable confirmation
                is your own personal prove-test-prove procedure carried out at the point of work.
                'Test before you touch' is not just good practice — it is a legal requirement under
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Proving unit:</strong> Battery-powered unit generating a known test
                  voltage to confirm indicator operation
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Common Multiple Supply Sources
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>UPS systems:</strong> Uninterruptible power supplies maintain output
                  voltage even when the mains supply is isolated — the UPS output and battery must
                  be isolated separately
                </li>
                <li className="pl-1">
                  <strong>Solar PV arrays:</strong> PV panels generate DC voltage whenever exposed
                  to light — the DC side cannot be 'switched off' during daylight hours and must be
                  treated as live
                </li>
                <li className="pl-1">
                  <strong>Battery systems:</strong> Emergency lighting, fire alarm and security
                  system batteries provide a continuous supply independent of the mains
                </li>
                <li className="pl-1">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Multi-Source Isolation Checklist
              </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        ATS and generator breaker
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Prevent auto-start; lock off ATS
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">UPS</td>
                      <td className="border border-white/10 px-3 py-2">
                        UPS output breaker and battery disconnect
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Confirm UPS shows no output
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        DC side may still be live in daylight
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Battery systems</td>
                      <td className="border border-white/10 px-3 py-2">
                        Battery isolator / disconnect
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Prove dead at battery terminals
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              <p className="text-sm font-medium text-orange-400 mb-2">
                Stored Energy Hazards in Repair Work
              </p>
              <p className="text-sm text-white">
                ...
                capacitor banks can also retain a charge. Always allow the manufacturer's specified
                discharge time, then verify with a voltage indicator before touching any internal
                components.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Personal lock:</strong> Each person working on the circuit applies their
                  own unique lock — only they hold the key
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Danger tag:</strong> A tag with the person's name, date, time and nature
                  of work is attached alongside the lock
                </li>
                <li className="pl-1">
                  <strong>Key retention:</strong> The key must remain on the person of the lock
                  owner at all times — never left in a toolbox, locker or handed to a colleague
                </li>
                <li className="pl-1">
                  <strong>Lock removal:</strong> Only the person who applied the lock may remove it.
                  If a lock must be removed in an emergency with the owner absent, a formal
                  procedure involving a senior authorised person must be followed with full
                  documentation
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Issue:</strong> An authorised person (AP) issues the permit after
                  confirming all safety precautions are in place
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Clearance:</strong> Upon completion, the CP clears the permit confirming
                  all work is complete, personnel are clear, and temporary earths removed
                </li>
                <li className="pl-1">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ol className="text-sm text-white space-y-2 list-decimal list-outside ml-5">
                <li className="pl-1">
                  ...
                  tight, no tools or materials left in the enclosure, all guards and covers
                  replaced, no visible damage to insulation or components
                </li>
                <li className="pl-1">
                  <strong>Insulation resistance:</strong> Measure IR between all live conductors and
                  earth, and between live conductors. Compare with BS 7671 Table 6.3 minimum values
                ...
                <li className="pl-1">
                  <strong>Polarity:</strong> Confirm correct polarity of connections, especially
                  after replacing switches, socket outlets or distribution equipment
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ol className="text-sm text-white space-y-2 list-decimal list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Remove temporary earths:</strong> If safety earths were applied, remove
                  them in the correct order (earth end last)
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Re-energise from supply end:</strong> Close the isolator or circuit
                  breaker. If multiple stages of isolation exist, re-energise from the supply end
                  working towards the load
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                ...
                and verify correct operation of interlocks, indicators and protective functions.
                Then energise the power circuits under no-load conditions where possible. Finally,
                apply the load gradually while monitoring currents, voltages and temperatures. This
                phased approach minimises the risk of further damage if an issue remains.
              </p>
            </div>
