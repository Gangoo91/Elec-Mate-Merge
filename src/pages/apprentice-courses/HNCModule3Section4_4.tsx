...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['69.3 kVA', '40 kVA', '120 kVA', '173 kVA'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['80 kW', '150 kW', '40 kW', '20 kW'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['80 kVAr', '20 kVAr', '125 kVAr', '60 kVAr'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['175 kVA', '238 kVA', '184 kVA', '263 kVA'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['400 kW', '625 kW', '300 kW', '500 kW'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['266 kVAr', '440 kVAr', '350 kVAr', '530 kVAr'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS 7671 311.2 lets you apply diversity (CIBSE Guide F or IET On-Site Guide tables) to
              connected three-phase loads when calculating maximum demand for transformer and DNO
              supply sizing. As BSE designer your arithmetic chain is: nameplate kW &rarr; diversity
              factor &rarr; assumed pf &rarr; kVA &rarr; round up to standard transformer/DNO
              rating. This is the single most commercially significant calculation on the project
              &mdash; the substation rating is the basis of the connection charge.
            </>
          }
        ...
        <ConceptBlock title="Three-Phase Real Power Formula">
          ...
          <p>
            ...
            balanced three-phase system, power is delivered continuously (unlike single-phase which
            pulsates). The mathematical derivation shows that total instantaneous power equals √3 ×
            VL × IL × cos φ at all times.
          </p>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Key point:</strong> For a balanced load, the power in each phase is P/3. The √3
            factor converts between line and phase quantities automatically.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Apparent Power (kVA)">
          <p>
            ...
            real power that does useful work and reactive power that sustains magnetic and electric
            fields. It determines the current flowing and hence the capacity required for cables,
        ...
        <ConceptBlock title="Reactive Power (kVAr)">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Capacitive (QC):</strong> Capacitors, long cables — current leads voltage; -Q
              (supplied)
            </li>
          </ul>
        ...
        <ConceptBlock title="Two-Wattmeter Method for Power Measurement">
          <p>
            ...
            three-phase, three-wire system. It works for both balanced and unbalanced loads and can
            also determine the power factor.
          </p>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Interpreting Wattmeter Readings</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Practical note:</strong> Modern three-phase power analysers use digital sampling
            and FFT, but the two-wattmeter principle is still useful for understanding readings and
            verification.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Power Factor in Three-Phase Systems">
          <p>
            Power factor is the ratio of real power to apparent power. It indicates how effectively
            the electrical power is being converted into useful work output. A poor power factor
            means the supply must provide more current (and hence more kVA) to deliver the same
        ...
        <ConceptBlock title="kW vs kVA in Specifications">
          <p>
            Understanding when to use kW and when to use kVA is crucial for correct specification of
            electrical equipment. Using the wrong unit can lead to under-sized or over-sized
          ...
          <p className="text-sm text-white italic">
            <strong>Common error:</strong> Specifying a 200kW generator for a 200kW load. At 0.8pf,
            this load requires 250kVA, so a 250kVA (200kW) generator would be fully loaded.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Maximum Demand Calculations">
          <p>
            Maximum demand (MD) is the highest load expected to occur at any one time. It determines
            the capacity of the incoming supply, main cables, and distribution equipment. Accurate
            MD assessment is essential for cost-effective design.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>DNO requirements:</strong> Electricity distributors require power factor of 0.95
            or better. Consumers with poor pf may face kVA-based maximum demand charges.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Building Services: Transformer Sizing and Supply Calculations">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Supply Agreement Considerations</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Cost optimisation:</strong> Accurately sizing supply capacity avoids paying for
            unused capacity while ensuring sufficient headroom for operational peaks and future
            growth.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A three-phase induction motor draws 45A at 400V with a power
            factor of 0.85. Calculate the real, apparent, and reactive power.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Example 2: Two-Wattmeter Method</p>
          <p>
            <strong>Question:</strong> Two wattmeters connected to a balanced three-phase load read
            42kW and 18kW. Calculate the total power and power factor.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Question:</strong> Calculate the transformer size for an office building with:
            Lighting 80kW, Small power 120kW, HVAC 200kW, Lifts 60kW. Apply appropriate diversity.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Question:</strong> A factory has a load of 500kW at 0.7 power factor. Calculate
            the capacitor kVAr required to improve pf to 0.95.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Confusing kW and kVA when sizing transformers. Forgetting the √3 factor in three-phase
              formulas. Ignoring power factor — same kW needs more current at low pf. Sizing without
              diversity factors. Forgetting to add a future-growth margin.
            </>
          }
          doInstead={
            <>
              Always size transformers/generators in kVA. Include √3 (1.732) in every three-phase
              calculation. Convert kW to kVA using the load's expected pf. Apply diversity from the
              IET On-Site Guide Appendix A allowances to every load type. Add 20-25% headroom for
              growth.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A new MRI suite has the following three-phase loads: 80 kVA scanner (helium compressor
              + RF cabinet) at 0.85 pf, 25 kVA chiller plant at 0.78 pf, 12 kW (single-phase, 230 V)
              lighting/SP at 0.95 pf. The local LV substation feeds the suite via a dedicated 200 A
              submain. You need to confirm capacity and design the PFC, if required.
            </>
          }
          whatToDo={
            <>
              Compute kVA per circuit: scanner 80 kVA, chiller 25 kVA, lighting/SP = 12/0.95 = 12.6
              kVA. Total connected = 117.6 kVA. Apply diversity (scanner 100 % during scans, chiller
              100 % when scanning, lighting 80 %): operating kVA &asymp; 115 kVA. Submain capacity
              at 400 V three-phase: 200 A &times; 400 &times; &radic;3 = 138 kVA &mdash; just
              adequate. Combined pf &asymp; 0.83 &mdash; below 0.95 target. Specify a 25 kVAr
              detuned PFC bank local to the suite to lift pf to 0.96 and free up busbar headroom.
            </>
          }
          whyItMatters={
            <>
              MRI suites are pf-poor, harmonic-rich (RF amplifier), and intolerant of voltage dip
              (each helium re-fill costs ~&pound;15k). The three-phase arithmetic the BSE engineer
              signs off here drives the substation kVA, the cable size, the PFC sizing, and the
              protection coordination upstream &mdash; getting it wrong costs five-figure variations
