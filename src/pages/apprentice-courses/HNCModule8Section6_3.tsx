      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>MEP coordination:</strong> Integrating mechanical, electrical, and plumbing
                services
              </li>
              <li className="pl-1">
                <strong>Clash detection:</strong> Identifying spatial conflicts before installation
              </li>
              <li className="pl-1">
                <strong>Services priority:</strong> Gravity drainage &gt; ductwork &gt; pipes &gt;
                cables
              </li>
              <li className="pl-1">
                <strong>RFIs:</strong> Formal requests for design clarification
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>BIM models:</strong> Federated 3D coordination at LOD 300+
              </li>
              <li className="pl-1">
                <strong>Coordination meetings:</strong> Weekly during active installation
              </li>
              <li className="pl-1">
                <strong>Ceiling voids:</strong> Zoned allocation with access requirements
              </li>
              <li className="pl-1">
                <strong>Sequencing:</strong> First fix → second fix → commissioning
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Design consultants:</strong> M&amp;E engineers, architects providing
                  design intent and resolving technical queries
                </li>
                <li className="pl-1">
                  <strong>Trade contractors:</strong> Responsible for detailed design and
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Initial routing studies, spatial allocation
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Detailed routing, equipment positioning
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Contractor input, clash resolution
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Installation drawings, sequences
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Construction</td>
                      <td className="border border-white/10 px-3 py-2">
                        Ongoing coordination, site verification
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        As-built records, commissioning data
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              spatial coordination and automated clash detection. Federated models combine
              individual discipline models to identify conflicts that would be difficult to spot in
              2D drawings.
            </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Physical intersection of solid elements
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Duct passing through steel beam
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Must resolve - impossible condition
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Violation of clearance zones
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Cable tray within access zone of valve
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        High - affects operation/maintenance
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Access blocked by earlier installation
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Medium - affects programme
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Cable bending radius compromised
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        High - affects installation quality
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                BIM Level of Development (LOD) for Coordination
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Approximate geometry, generic placeholders
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Accurate geometry, specific element sizes
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        LOD 300 + interfaces and supports
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Prefabrication, detailed sequencing
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              ...
              <ol className="text-sm text-white space-y-1.5 list-decimal list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Review and classify:</strong> Filter false positives, categorise by
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Services Priority Hierarchy (Typical)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Requires falls, cannot be pressurised
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 text-orange-400 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Large cross-section, limited flexibility
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 text-yellow-400 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Head positions fixed, some flexibility
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Pressurised, moderate flexibility
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 text-blue-400 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        High flexibility, small cross-section
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 text-purple-400 font-medium">
                        6
                      </td>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Most flexible, smallest elements
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              <p className="text-sm font-medium text-red-400 mb-2">
                Common Ceiling Void Coordination Failures
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Support clashes:</strong> Multiple trades fixing to same structural
                  elements
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Typical Electrical Installation Sequence
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Containment, back boxes, cabling to points
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Structural completion, wall framing
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Distribution boards, switchgear, major plant
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Wall finishes, ceiling grid installed
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">4. Testing</td>
                      <td className="border border-white/10 px-3 py-2">
                        Dead testing, live testing, commissioning
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Second fix complete, power available
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        BMS integration, systems commissioning
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        All M&amp;E systems operational
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white mb-3">
                    Regular coordination meetings bring together all stakeholders to review
                    progress, resolve clashes, and agree installation sequences. Effective meetings
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Unclear specification or drawing detail
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Conflict between drawings or specifications
                      </td>
                      <td className="border border-white/10 px-3 py-2">3-5 working days</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Proposed change to design intent
                      </td>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                    <li className="pl-1">
                      <strong>Be specific:</strong> Reference exact drawing numbers, specification
                      clauses, and locations
                    </li>
                    <li className="pl-1">
                      <strong>Include context:</strong> Explain why the information is needed and
                      impact of delay
                    </li>
                    <li className="pl-1">
                      <strong>Propose solutions:</strong> Where possible, suggest potential
                      resolutions for consideration
                    </li>
                    <li className="pl-1">
                      <strong>Attach evidence:</strong> Include marked-up drawings, photographs, or
                      clash reports
                    </li>
                    <li className="pl-1">
                    ...
                    <li className="pl-1">
                      <strong>Update drawings:</strong> Ensure RFI responses are incorporated into
                      working drawings
                    </li>
                  </ul>
                </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-orange-400 mb-2">
                    Programme Coordination Risks
                  </p>
                  <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                    <li className="pl-1">
                      <strong>Delayed information:</strong> RFI responses arriving after work window
                      has passed
                    </li>
                    <li className="pl-1">
                      <strong>Access conflicts:</strong> Multiple trades requiring same area
                      simultaneously
                    </li>
                    <li className="pl-1">
                    ...
                    <li className="pl-1">
                      <strong>Resource clashes:</strong> Insufficient labour to meet programme
                      requirements
                    </li>
                    <li className="pl-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key success factor:</strong> Proactive coordination - identifying and
              resolving issues before they impact the programme - is far more effective than
              reactive problem-solving after delays occur.
            </p>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Resolving a Ceiling Void Clash
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: RFI for Specification Discrepancy
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Scenario:</strong> The electrical specification calls for IP65-rated
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  Response Required By: [date - 5 days before order deadline]
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Installation Sequence Planning
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Scenario:</strong> Plan the electrical installation sequence for an office
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  Key Interface: All above-ceiling work must complete before
                </p>
                <p className="text-green-400">
                  ceiling grid. Daily coordination briefing at 07:30.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Latest clash detection report reviewed and responses prepared
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>BIM Execution Plan (BEP):</strong> Coordination protocols and
                  responsibilities
                </li>
                <li className="pl-1">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Missing interfaces:</strong> Failing to coordinate with all affected
                  trades
                </li>
                <li className="pl-1">
