      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-6 mt-6">
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Start with the distribution board &mdash; list every MCB, RCBO, busbar and
                    enclosure
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Measure cable routes on drawings using the scale &mdash; add 10% for waste and
                    deviation
                  </span>
                </li>
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    List containment: conduit lengths, trunking, cable clips, fixings, back boxes
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Include consumables: tape, glands, grommets, labels, screws, rawlplugs
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <h4 className="font-medium text-green-400 mb-2">
                Worked Example &mdash; Bathroom Refurbishment
              </h4>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-1 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Working weeks per year: 52 &minus; 5 (holiday) &minus; 1 (sick) = 46 weeks
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Minimum hourly rate: &pound;48,000 / 1,449 ={' '}
                    <strong className="text-white">&pound;33.13/hr</strong>
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
                ...
                <div className="bg-white/5 rounded-lg p-2 text-center">
                  <p className="text-green-400 font-mono text-sm">
                    Margin = Profit / Selling &times; 100
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-1 text-sm text-white">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Margin: &pound;80 / &pound;480 &times; 100 ={' '}
                    <strong className="text-white">16.67%</strong>
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              and submit quarterly returns to HMRC. The maths is straightforward but errors are
              common.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <h4 className="font-medium text-green-400 mb-2">
                Worked Example &mdash; Invoice Calculation
              </h4>
              <div className="space-y-1 text-sm">
                <div className="flex justify-between border-b border-white/10 pb-1">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <p className="text-sm text-white">
                ...
                &mdash; charging the wrong rate can result in penalties.
              </p>
            </div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              handle variations can make or break the profitability of a fixed-price job.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-white">Identify:</strong> Recognise that work is outside
                    the original scope
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-white">Document:</strong> Write a clear description of
                    the additional work
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-white">Price:</strong> Calculate the additional cost
                    (materials + labour + markup)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-white">Agree:</strong> Get the customer to sign the
                    variation order before starting
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-white">Invoice:</strong> Add the variation to the final
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              the value you provide: quality workmanship, reliability, proper certification, and
              guarantees.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Always do a detailed material takeoff &mdash; never guess at quantities
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Calculate your true hourly rate including ALL overheads, not just your desired
                    wage
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Understand the difference between markup (on cost) and margin (on selling price)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Put all quotes in writing with clear scope, exclusions, and payment terms
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    Price for value, not just cost &mdash; quality workmanship commands premium
                    rates
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white">
                ...
                service, not just the time on site.
              </p>
            </div>
          </div>
        </motion.div>
