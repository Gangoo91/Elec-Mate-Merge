  ...
  const faqs = [
    {
      ...
      answer:
        'Yes, but it must be GS38 compliant and in good condition. All equipment will be checked before use.',
    },
    {
      question: 'Do I always use the MFT?',
      answer:
        'Mostly, but safe isolation requires a separate two-pole voltage tester. Each tool has specific applications.',
    },
    {
      question: 'What if my readings seem unrealistic?',
      answer:
        'Re-check instrument settings and connections - never fake values. Assessors can spot unrealistic numbers.',
    },
    {
      question: 'How strict are assessors about GS38?',
      answer:
        'Very strict - unsafe equipment use equals instant fail. Safety is non-negotiable in electrical work.',
    },
    {
      question: 'Do I lose marks for being slow with instruments?',
      answer:
        'No, but poor efficiency risks running out of time. Practice until instrument operation becomes second nature.',
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <AM2ContentCard title="1. Core Test Instruments in AM2 Fault Finding" icon={Settings}>
        ...
        <AM2ContentCard title="2. Safe Use - GS38 Compliance" icon={Shield} accent>
          <div className="space-y-4">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <h4 className="text-ios-headline font-semibold text-white mb-3">
                Essential GS38 Requirements:
              </h4>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
        ...
        <AM2ContentCard title="3. Efficient Application of Tests" icon={Zap}>
        ...
        <AM2ContentCard title="4. Common Errors and Assessor Expectations" icon={Eye}>
          <div className="space-y-4">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <h4 className="text-ios-headline font-semibold text-white mb-3">
        ...
        <AM2ContentCard title="5. Advanced Equipment Mastery" icon={Zap}>
          <div className="space-y-4">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <h4 className="text-ios-headline font-semibold text-white mb-3">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              ...
              <div className="space-y-3">
                <div>
                  <h5 className="text-ios-callout font-semibold text-white mb-2">
                    Common Equipment Problems in AM2:
                  </h5>
                  <ul className="space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="text-elec-yellow">•</span>
        ...
        <AM2ContentCard title="6. Industry Standards and Compliance" icon={Shield}>
          <div className="space-y-4">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <h4 className="text-ios-headline font-semibold text-white mb-3">
        ...
        {/* Practical Tips */}
        <AM2ContentCard title="7. Practical Tips for Success" icon={Target}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
        ...
        {/* FAQ Section */}
        <AM2ContentCard title="9. Frequently Asked Questions" icon={Lightbulb}>
          <div className="space-y-4">
            {faqs.map((faq, index) => (
        ...
        {/* Summary */}
        <AM2ContentCard title="10. Section Summary" icon={BookOpen} accent>
          <div className="space-y-4">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4">
              <h4 className="text-ios-headline font-semibold text-white mb-3">
                Efficient Test Equipment Use Means:
              </h4>
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
