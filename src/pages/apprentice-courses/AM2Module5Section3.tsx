...
const AM2Module5Section3 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: ['5-10 mm', '1-2 mm', '2-4 mm', 'No limit specified'],
      correctAnswer: 2,
      explanation:
    ...
    },
    {
      ...
      options: ['Ohms', 'Megohms (M)', 'Amperes (A)', 'Volts (V)'],
      correctAnswer: 1,
      explanation:
    ...
    },
    {
      ...
      options: ['40ms', '150ms', '500ms', '300ms'],
      correctAnswer: 3,
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          In AM2 fault diagnosis, test equipment is your main tool. You will rely on instruments
          like a multifunction tester (MFT), a continuity tester, an insulation resistance tester,
          and a voltage indicator to identify faults safely and accurately.
        </p>
        ...
        <div className="space-y-6">
          ...
          <ConceptBlock title="2. Safe Use - GS38 Compliance">
            ...
            <p>
              <strong className="text-elec-yellow">Safe Working Practices — Before Testing:</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <p>
              <strong className="text-elec-yellow">Safe Working Practices — During Testing:</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <Scenario
            ...
            situation={
              <>
                You're testing IR L-N on a lighting circuit at the AM2 board. The reading shows 0.3
                MΩ. Below the 1 MΩ minimum, so technically a fail. But you noticed the LED drivers
                are still connected. You need to decide: is this an actual short circuit fault, or
                are the electronics dragging the reading down?
              </>
            }
            whatToDo={
              <>
                Disconnect the LED drivers (or any electronic accessories) from the circuit, then
                re-test. BS 7671 specifically calls out that electronics must be disconnected for IR
                testing because they internally bridge L-N at lower voltages and skew your reading
                massively. If after disconnection the IR is still &lt; 1 MΩ, you've got a real
                fault. If it climbs to &gt; 200 MΩ, the drivers were the issue — circuit is fine, no
                fault.
              </>
            }
            whyItMatters={
              <>
                ...
                "short circuit fault" because you didn't disconnect electronics is a recording error
                under BS 7671 Reg 642 — and tells the assessor you don't understand what an IR test
                actually measures. Even if the rig has a deliberate fault elsewhere, you can lose
                method marks here.
              </>
            }
          />
          ...
          <RegsCallout
            ...
            meaning={
              <>
                ...
                IR is 1 MΩ but anything &lt; 2 MΩ should be investigated. Electronics, dimmers, LED
                drivers, surge protection devices: disconnect them first or you'll get a low reading
                that isn't a fault. Recording a "fault" that's actually a connected SPD = lost marks
                and a confused assessor.
              </>
            }
          ...
          <ConceptBlock title="4. Common Errors and Assessor Expectations">
            <p>
              <strong className="text-elec-yellow">Common Candidate Errors (NET Guidance):</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
