  ...
  const quizQuestions = [
    {
      ...
      options: [
        ...
        'To increase the current rating of each circuit',
      ],
      correctAnswer: 0,
      explanation:
        'Clear labelling lets anyone identify and safely isolate the correct circuit quickly, which is the primary safety benefit.',
    },
    {
      id: 2,
      question: 'Which standard requires circuits to be identifiable?',
      options: [
        'BS 6423',
        'BS 7671',
        'BS 5839',
      ...
      correctAnswer: 1,
      explanation: 'BS 7671 (the IET Wiring Regulations) requires every circuit to be identifiable.',
    },
    {
      id: 3,
      ...
      options: [
        ...
        'Only the supply meter and the main earth bar',
        'Only flexible cables and extension leads',
        'Only socket outlets in wet locations',
      ],
      correctAnswer: 0,
      explanation:
        'Labels are required at distribution boards, protective devices, isolators, and on cables for larger projects.',
    },
    {
      id: 4,
      question: 'What should be included in a distribution board schedule?',
      options: [
        'Only the address and date of installation',
        'Only the make and model of the consumer unit',
        'Circuit reference, description, device rating and RCD/RCBO protection',
        'Only the total connected load in amperes',
      ],
      correctAnswer: 2,
      explanation:
        'A DB schedule must record each circuit reference, its load description, the device rating, and the RCD/RCBO protection.',
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        'False — labelling is a requirement regardless of personal knowledge, because others must also identify circuits.',
    },
    {
      id: 6,
      ...
      options: [
        ...
        'Pencil markings',
        'Temporary adhesive stickers',
        'Printed labels',
      ],
      correctAnswer: 3,
      explanation:
        'Printed labels are preferred because they are more durable and legible than handwritten or temporary alternatives.',
    },
    {
      id: 7,
      question: 'What risk is created by poor labelling?',
      options: [
        'Higher running costs for the installation',
        'Isolating the wrong circuit and creating safety hazards',
        'Reduced lifespan of the protective devices',
        'A poor appearance at the consumer unit',
      ],
      correctAnswer: 1,
      explanation:
        'Poor labelling can lead to isolating the wrong circuit, leaving live conductors and creating serious safety hazards.',
    },
    {
      id: 8,
      question: 'Who is responsible for updating circuit labels after changes?',
      options: [
        'The supply distributor (DNO)',
        'The original consumer unit manufacturer',
        'The electrician carrying out the work',
        'The building control officer',
      ],
      correctAnswer: 2,
      explanation:
        'The electrician carrying out any modification must update all relevant labelling immediately after the work.',
    },
    {
      id: 9,
      question: 'Where should the circuit schedule be fixed?',
      options: [
        'In the property owner\'s filing cabinet',
        'Inside or adjacent to the distribution board',
        'On the outside wall of the building',
        'Only in the electrician\'s job records',
      ],
      correctAnswer: 1,
      explanation:
        'The circuit schedule must be fixed inside or next to the distribution board so it is immediately available.',
    },
    {
      id: 10,
      question: 'In the real-world example, what happened due to poor labelling?',
      options: [
        'A circuit was overloaded and the cable overheated',
        'The wrong cable size was used for a ring final',
        'Emergency lighting was isolated by mistake, creating a safety risk',
        'An RCD was fitted to the wrong distribution board',
      ],
      correctAnswer: 2,
      explanation:
        'Emergency lighting was accidentally isolated instead of the classroom lighting, creating a safety risk during evacuation drills.',
    },
  ];
