...
const quickCheckQuestions = [
  {
    ...
    options: ['4 steps', '5 steps', '6 steps', '3 steps'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['10 or more', '5 or more', 'Any number', '3 or more'],
    correctIndex: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              A risk assessment that has not been reviewed after a change is presumed inadequate. As
              an HNC supervisor you trigger reviews on equipment change, personnel change, layout
              change, near-miss and incident.
            </>
          }
        ...
        <ConceptBlock title="HSE Five Steps to Risk Assessment">
          ...
          <div className="my-6 space-y-4">
            ...
            <div className="p-4 rounded-lg bg-white/5 border-l-4 border-blue-400">
              ...
              <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
                ...
                <li>Vulnerable groups: young workers, pregnant women, disabled persons</li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5 border-l-4 border-green-400">
              ...
              <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
                ...
                <li>Compare against industry standards and legal requirements</li>
                <li>Apply hierarchy of control: eliminate, substitute, engineer, admin, PPE</li>
            ...
            <div className="p-4 rounded-lg bg-white/5 border-l-4 border-orange-400">
              ...
              <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
                <li>Set a review date (typically annually for low-risk activities)</li>
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            paperwork exercise. It should be 'suitable and sufficient' - proportionate to the level
            of risk.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Likelihood and Severity Scales">
          <p>
            Risk assessment requires quantifying both how likely harm is to occur and how severe the
            consequences would be. Standard scales allow consistent evaluation across different
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1</strong> — Rating: Rare. Description: Unlikely to ever occur
            </li>
            <li>
              <strong>2</strong> — Rating: Unlikely. Description: Could occur but not expected
            </li>
            <li>
              <strong>3</strong> — Rating: Possible. Description: Might occur occasionally
            </li>
            <li>
              <strong>4</strong> — Rating: Likely. Description: Probably will occur
            </li>
            <li>
              <strong>5</strong> — Rating: Almost Certain. Description: Expected to occur frequently
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1</strong> — Rating: Negligible. Description: Minor injury, no lost time
            </li>
            <li>
              <strong>2</strong> — Rating: Minor. Description: First aid injury, short absence
            </li>
            <li>
              <strong>3</strong> — Rating: Moderate. Description: Medical treatment, extended
              absence
            </li>
            <li>
              <strong>4</strong> — Rating: Major. Description: Serious injury, long-term disability
            </li>
            <li>
              <strong>5</strong> — Rating: Catastrophic. Description: Fatality or multiple serious
              injuries
            </li>
          </ul>
        ...
        <ConceptBlock title="Risk Matrices (3×3 and 5×5)">
          <p>
            ...
            determine overall risk levels. The resulting risk score guides the priority and type of
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>High Likelihood (3)</strong> — Low Severity (1): 3 - Medium. Medium Severity
              (2): 6 - High. High Severity (3): 9 - Very High
            </li>
            <li>
              <strong>Medium Likelihood (2)</strong> — Low Severity (1): 2 - Low. Medium Severity
              (2): 4 - Medium. High Severity (3): 6 - High
            </li>
            <li>
              <strong>Low Likelihood (1)</strong> — Low Severity (1): 1 - Low. Medium Severity (2):
              2 - Low. High Severity (3): 3 - Medium
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Almost Certain (5)</strong> — Negligible (1): 5. Minor (2): 10. Moderate (3):
              15. Major (4): 20. Catastrophic (5): 25
            </li>
            <li>
              <strong>Likely (4)</strong> — Negligible (1): 4. Minor (2): 8. Moderate (3): 12. Major
              (4): 16. Catastrophic (5): 20
            </li>
            <li>
              <strong>Possible (3)</strong> — Negligible (1): 3. Minor (2): 6. Moderate (3): 9.
              Major (4): 12. Catastrophic (5): 15
            </li>
            <li>
              <strong>Unlikely (2)</strong> — Negligible (1): 2. Minor (2): 4. Moderate (3): 6.
              Major (4): 8. Catastrophic (5): 10
            </li>
            <li>
              <strong>Rare (1)</strong> — Negligible (1): 1. Minor (2): 2. Moderate (3): 3. Major
              (4): 4. Catastrophic (5): 5
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1-4</strong> — Level: Low. Required Action: Monitor and maintain existing
              controls
            </li>
            <li>
              <strong>5-9</strong> — Level: Medium. Required Action: Additional controls required;
              implement reasonably practicable measures
            </li>
            <li>
              <strong>10-16</strong> — Level: High. Required Action: Urgent action required; work
              should not proceed until risk reduced
            </li>
            <li>
              <strong>17-25</strong> — Level: Very High. Required Action: Intolerable; stop work
              immediately; eliminate hazard or find alternative method
            </li>
          </ul>
        ...
        <ConceptBlock title="Recording Significant Findings and Review Requirements">
          <p>
            The Management of Health and Safety at Work Regulations 1999 require employers with five
            or more employees to record the significant findings of their risk assessments. Good
            record-keeping is also essential evidence of due diligence.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Electric shock (isolation failure)</strong> — Who at Risk: Electricians. L: 2.
              S: 5. R: 10. Controls: Safe isolation, GS38 probes, lock-off
            </li>
            <li>
              <strong>Manual handling (cable drums)</strong> — Who at Risk: All workers. L: 4. S: 3.
              R: 12. Controls: Mechanical aids, team lifts, training
            </li>
            <li>
              <strong>Work at height (cable trays)</strong> — Who at Risk: Electricians. L: 3. S: 4.
              R: 12. Controls: MEWP, scaffolding, harness systems
            </li>
            <li>
              <strong>Trips (trailing cables)</strong> — Who at Risk: All building users. L: 3. S:
              2. R: 6. Controls: Cable covers, barriers, signage
            </li>
          </ul>
        ...
        <ConceptBlock title="Building Services Risk Assessment Examples">
          <p>
            <strong>Example 1: Consumer Unit Replacement</strong>
          </p>
          ...
          <p>
            <strong>Example 2: Commercial Lighting Installation</strong>
          </p>
          <p className="text-sm text-white mb-3">
          ...
          <p>
            <strong>Example 3: Distribution Board Testing</strong>
          </p>
          <p className="text-sm text-white mb-3">
        ...
        <ConceptBlock title="Practical Guidance">
          <div>
            <p>
              <strong>Risk Assessment Checklist</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <div>
            <p>
              <strong>Hierarchy of Control (ERICPD)</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              Your firm is providing temporary supply for a 5-day outdoor event. 100 m runs of
              armoured cable from a rented genset to a single marquee distribution unit. Public
              access throughout, heavy footfall, possible rain.
            </>
          }
          whatToDo={
            <>
              Apply the five steps. Identify hazards (electric shock, trip, fire, public contact,
              weather). Identify who could be harmed (event staff, public, performers, you).
              Evaluate using a 5×5 matrix — likelihood (5 — public touch), severity (5 — fatal).
              Record significant findings — TT supply with 30 mA RCD, BS 7671 Section 711
              compliance, IP44 distribution, ramped cable protectors, perimeter fencing, daily
              insulation testing, signage. Review on day 3 after weather forecast change.
            </>
          }
          whyItMatters={
            <>
