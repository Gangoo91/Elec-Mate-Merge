    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Design effective protection systems that ensure safety whilst maintaining continuity of
          supply through proper discrimination
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the selection and coordination of protective devices for building
          services installations. Proper protection design is essential for safety, but equally
          important is achieving discrimination to minimise disruption when faults occur.
        </p>
