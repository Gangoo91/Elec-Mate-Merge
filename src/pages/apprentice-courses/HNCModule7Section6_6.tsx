...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['5 years', '25 years', 'Life of the building', '10 years'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: ['Distribution schedule', 'Single line diagram', 'Cable schedule', 'Test certificate'],
    correctAnswer: 1,
    explanation:
...
const HNCModule7Section6_6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 6 · Subsection 6"
        title="Documentation Requirements"
        backTo="/study-centre/apprentice/h-n-c-module7-section6"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Single line diagrams, distribution schedules, test certificates, O&M manuals, and as-built
        ...
        <ConceptBlock title="Single Line Diagrams and Distribution Schedules">
          <p>
            ...
            understanding and managing electrical installations. They provide essential information
            for operation, maintenance, fault finding, and future modifications.
          </p>
          <p>
            <strong>Single Line Diagram Requirements:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Supply details:</strong> DNO supply characteristics, CT ratios, maximum demand
            </li>
            <li>
          ...
          <p>
            <strong>Distribution Schedule Content</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Circuit No.:</strong> Unique circuit reference — 1, 2, 3... or L1, L2, P1...
            </li>
            <li>
              <strong>Description:</strong> Circuit use/location — Lighting - Ground Floor East
            </li>
            <li>
              <strong>Protective Device:</strong> Type and rating — MCB Type B 16A
            </li>
            <li>
              <strong>Cable:</strong> Type and size — 6242Y 1.5mm²
            </li>
            <li>
              <strong>Design Current (Ib):</strong> Calculated load current — 8.5A
            </li>
            <li>
              <strong>RCD:</strong> RCD protection if applicable — 30mA Type A
            </li>
            <li>
              <strong>Points:</strong> Number of outlets — 12 luminaires
            </li>
          </ul>
          <p>
            <strong>Single Line Diagram Symbols</strong>
          </p>
          ...
          <p>
            <strong>Best practice:</strong> Single line diagrams should be displayed in main switch
            rooms. Distribution schedules should be fixed inside each distribution board cover.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Test Certificates (EIC, EICR, MEIWC)">
          ...
          <p>
            <strong>EIC - Electrical Installation Certificate</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>MEIWC - Minor Works</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>EIC Declaration Sections</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Section 1:</strong> Designer — Design complies with BS 7671
            </li>
            <li>
              <strong>Section 2:</strong> Constructor/Installer — Installation constructed to design
            </li>
            <li>
              <strong>Section 3:</strong> Inspector/Tester — Inspection and testing completed
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>C1:</strong> Danger present — Immediate remedial action
            </li>
            <li>
              <strong>C2:</strong> Potentially dangerous — Urgent remedial action
            </li>
            <li>
              <strong>C3:</strong> Improvement recommended — Action at discretion
            </li>
            <li>
              <strong>FI:</strong> Further investigation — Investigation required
            </li>
          </ul>
          <p>
            <strong>Retention requirement:</strong> BS 7671 Regulation 132.13 requires certificates
            and test results to be retained for the working life of the installation.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Operation and Maintenance Manuals">
          ...
          <p>
            <strong>O&M Manual Structure</strong>
          </p>
          <p>
            <strong>Volume 1 - Operating Information</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Volume 2 - Maintenance Information</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>O&M Manual Contents Checklist</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Schematics:</strong> Single line diagrams, control schematics, wiring diagrams
            </li>
            <li>
            ...
            <li>
              <strong>Test certificates:</strong> EIC, commissioning records, witness test reports
            </li>
            <li>
          ...
          <p>
            <strong>Maintenance Schedule Example - Distribution Boards</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Visual inspection:</strong> Monthly — Skilled person
            </li>
            <li>
              <strong>Thermal imaging survey:</strong> Annually — Competent person
            </li>
            <li>
              <strong>Termination tightness check:</strong> Annually — Competent person
            </li>
            <li>
              <strong>RCD functional test:</strong> Quarterly — Instructed person
            </li>
            <li>
              <strong>Full periodic inspection:</strong> 5 years — Competent person
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="As-Built Drawings and Handover Documentation">
          ...
          <p>
            <strong>As-Built Drawing Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Cable routes:</strong> Actual containment routes with measurements from datums
            </li>
            <li>
              <strong>Equipment locations:</strong> Precise positions of all distribution boards,
              switches, accessories
            </li>
            <li>
              <strong>Hidden services:</strong> Accurate recording of concealed cables and equipment
            </li>
            <li>
          ...
          <p>
            <strong>Drawing Types Required</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>General arrangement:</strong> Equipment positions, containment routes — 1:50
              or 1:100
            </li>
            <li>
              <strong>Single line diagrams:</strong> Distribution schematic — NTS
            </li>
            <li>
              <strong>Lighting layouts:</strong> Luminaire positions, switching zones — 1:50 or
              1:100
            </li>
            <li>
              <strong>Small power layouts:</strong> Socket and FCU positions — 1:50 or 1:100
            </li>
            <li>
              <strong>Containment layouts:</strong> Cable tray, trunking, conduit routes — 1:50 or
              1:100
            </li>
            <li>
              <strong>Wiring diagrams:</strong> Panel internal wiring, control circuits — NTS
            </li>
            <li>
              <strong>External works:</strong> Underground routes, depths, marker posts — 1:100 or
              1:200
            </li>
          </ul>
          <p>
            <strong>Handover Documentation Package Checklist</strong>
          </p>
          <p>
            <strong>Certificates and Records</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Document Retention Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>EIC and test results:</strong> Life of installation — BS 7671 Reg. 132.13
            </li>
            <li>
              <strong>Health and Safety File:</strong> Life of building — CDM 2015 Reg. 12
            </li>
            <li>
              <strong>O&M manuals:</strong> Life of building — CDM 2015 / Contract
            </li>
            <li>
              <strong>As-built drawings:</strong> Life of building — Good practice
            </li>
            <li>
              <strong>EICR reports:</strong> Until superseded + archive — BS 7671
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            2 | Kitchen | Unprotected cable at cooker | <span>C1</span>
          </p>
          <p>
            3 | WC | No supplementary bonding | <span>C2</span>
          </p>
          <p>
            4 | External | IP rating inadequate for location| <span>C2</span>
          </p>
          <p>
            5 | Throughout | No RCD protection to socket outlets| <span>C2</span>
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Develop an index structure for electrical O&M manuals for a
            commercial building.
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Missing signatures:</strong> All EIC sections must be signed by appropriate
                persons
              </li>
              <li>
