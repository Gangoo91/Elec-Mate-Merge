...
const DESCRIPTION =
  'Learn electrical units (volts, amps, ohms, watts), prefixes and BS 7671 testing. Understand measurement fundamentals for apprentice electricians.';
...
const faqs = [
  {
    ...
    answer:
      'The UK harmonised with European standards, changing from 240V to 230V (±10%). In practice, supply voltage can still be around 240V, which falls within the acceptable tolerance range.',
  },
  {
    question: "What's the difference between kW and kWh?",
    answer:
      'kW (kilowatts) is power - the rate of energy use at a moment in time. kWh (kilowatt-hours) is energy - the total amount consumed over time. Think of kW as speed and kWh as distance travelled.',
  },
  {
    question: 'Why are test results sometimes given in different units?',
    answer:
      'Different tests measure different ranges. Insulation resistance is in MΩ (mega-ohms) because values are very high, while continuity is in Ω or mΩ because values are very low. Using appropriate units makes readings easier to understand.',
  },
  {
    question: 'Do I need to memorise all the conversion factors?',
    answer:
      'You should know the common ones (milli = ÷1000, kilo = ×1000, mega = ×1,000,000) as these appear constantly. For others, charts and calculators are acceptable tools to use on site.',
  },
  {
    question: 'Why do some components show power in VA instead of W?',
    answer:
      'VA (volt-amperes) is used for reactive loads like transformers and motors where not all the electrical energy converts to useful work. For resistive loads (heaters, lamps), VA and W are the same.',
  },
  {
    question: 'What happens if I use the wrong units in calculations?',
    answer:
      'Using wrong units can lead to serious errors - oversized or undersized cables, incorrect protection devices, or safety hazards. Always double-check your units and convert consistently throughout calculations.',
  },
];
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-xs sm:text-sm text-white">
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>V (Volts):</strong> Electrical pressure that pushes current through
                  circuits.
                </li>
                <li>
                  <strong>A (Amps):</strong> Current flow - the amount of electricity moving.
                </li>
                <li>
                  <strong>Ω (Ohms):</strong> Resistance - opposition to current flow.
                </li>
                <li>
                  <strong>W (Watts):</strong> Power - rate of energy conversion (V × A).
                </li>
                <li>
                  <strong>kWh:</strong> Energy consumed over time - what you pay for on bills.
                </li>
                <li>
                  <strong>Prefixes:</strong> k = ×1000, m = ÷1000, M = ×1,000,000
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Equipment labels, circuit breaker ratings, test results,
                  cable specifications.
                </li>
                <li>
                  <strong>Use:</strong> Component selection, test interpretation, load calculations.
                </li>
                <li>
                  <strong>Apply:</strong> Circuit design, fault finding, safety verification,
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                Identify and use the correct units for voltage, current, resistance, power, and
                energy
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Apply unit prefixes (kilo, mega, milli, micro) in practical electrical work
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Interpret equipment labels, test results, and circuit specifications correctly
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Convert between different units used in BS 7671 testing and installation work
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Avoid common unit-related mistakes that can cause safety hazards or component
                failures
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Use electrical units confidently in Ohm's Law calculations and power formulas
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Understanding electrical units is like learning a language — know what each one
                means and when to use it. These units appear on every piece of equipment, every
                drawing, and every test result.
              </p>
              ...
              <div className="rounded-md border border-white/10 p-3 bg-white/5">
                <p className="text-sm">
                  <strong>Professional tip:</strong> These units appear on drawings, labels, and
                  test results. Master them early and work more safely and efficiently.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Electrical quantities can be very large or very small, so we use prefixes to make
                them easier to work with. These are essential for interpreting test results and
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Understanding units isn't just theory — you'll encounter them constantly in real
                electrical work:
              </p>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-6 text-white">
              <p>
                Units come together in electrical formulas. Understanding how V, I, R, and P relate
                helps with calculations and understanding circuit behaviour.
              </p>
          ...
          <div className="space-y-6">
            <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
              ...
              <ul className="space-y-2 text-white text-sm">
                ...
                <li>
                  • Record test results with the correct units (MΩ for insulation, Ω for continuity)
                </li>
            ...
            <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
              ...
              <ul className="space-y-2 text-white text-sm">
                ...
                <li>
                  • Use the unit conversion tools until you're confident with mental calculations
                </li>
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 p-4 bg-white/5 border border-white/10 rounded-lg">
            <div>
              ...
              <ul className="space-y-1 text-xs sm:text-sm text-white/80">
                ...
                <li>
                  • Three-phase supply: <strong className="text-white">400V</strong>
                </li>
                <li>
                  • Standard RCD rating: <strong className="text-white">30mA</strong>
                </li>
                <li>
                  • Plug fuse: <strong className="text-white">13A</strong>
                </li>
                <li>
                  • Ring circuit MCB: <strong className="text-white">32A</strong>
                </li>
                <li>
                  • Mains frequency: <strong className="text-white">50Hz</strong>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-1 text-xs sm:text-sm text-white/80">
                ...
                <li>
                  • Continuity: <strong className="text-white">&lt;0.05Ω</strong>
                </li>
                <li>
                  • Earth loop (socket): <strong className="text-white">&lt;1.44Ω</strong>
                </li>
                <li>
                  • RCD trip time: <strong className="text-white">&lt;300ms</strong>
                </li>
                <li>
                  • RCD trip current: <strong className="text-white">15-30mA</strong>
                </li>
              </ul>
            </div>
          </div>
