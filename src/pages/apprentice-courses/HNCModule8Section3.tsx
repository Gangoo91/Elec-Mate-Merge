    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-base text-muted-foreground mb-12">
          This section covers air conditioning and cooling systems from an electrical services
          perspective. You'll learn about refrigeration principles, DX and chilled water systems,
          VRF technology, terminal units and the commissioning procedures for cooling systems.
        </p>
