      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>SI system:</strong> 7 base units — ampere is the electrical base unit
              </li>
              <li className="pl-1">
                <strong>Prefixes:</strong> pico (10^-12) to mega (10^6) — critical for correct
                recording
              </li>
              <li className="pl-1">
                <strong>Accuracy vs precision:</strong> Closeness to truth vs repeatability of
                readings
              </li>
              <li className="pl-1">
                <strong>Calibration:</strong> Annual for portable instruments, traceable to national
                standards
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Continuity:</strong> milliohms (m-ohms) for short runs, ohms for circuits
              </li>
              <li className="pl-1">
                <strong>Insulation:</strong> Megaohms (M-ohms) — minimum 1 M-ohm per BS 7671
              </li>
              <li className="pl-1">
                <strong>RCD trip:</strong> Milliamperes (mA) — typically 30 mA rated
              </li>
              <li className="pl-1">
                <strong>ST1426:</strong> Correct measurement and recording of test results
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Derived Units for Electrical Quantities
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Complete SI Prefix Table for Electrical Maintenance
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Moving to a smaller prefix:</strong> Multiply. Example: 0.03 A to
                  milliamps = 0.03 x 1000 = 30 mA
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              <p className="text-sm font-medium text-red-400 mb-2">
                Critical Warning: Case Sensitivity
              </p>
              <p className="text-sm text-white">
                ...
                but <strong>K</strong> = kelvin (temperature). Always write prefix symbols exactly
                as defined: k (lower case) for kilo, M (upper case) for mega.
              </p>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  Accuracy describes how close a measurement is to the true (actual) value. An
                  accurate instrument gives readings that are close to reality. Accuracy is limited
                  by systematic errors (bias) which can be reduced by calibration. For a multimeter,
                  accuracy is typically specified as '± X% of reading + Y digits' — for example '±
                  0.5% rdg + 2 digits'.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  ...
                  times. An instrument can be precise (readings always close together) but
                  inaccurate (readings consistently offset from the true value). Precision is
                  limited by random errors such as electrical noise, temperature fluctuations, and
                  contact resistance.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  ...
                  detect and display. On a digital multimeter, it is determined by the number of
                  counts on the display. A 4000-count meter on the 400 V range has a resolution of
                  0.1 V. A 6000-count meter on the same range has a resolution of approximately 0.07
                  V. Higher resolution does not necessarily mean higher accuracy — the extra decimal
                  places may not be meaningful.
                </p>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                The number of significant figures in a measurement should reflect the accuracy of
                the instrument and the meaningfulness of the reading:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Record only as many figures as the instrument accuracy justifies
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  For most maintenance measurements, 3-4 significant figures are appropriate
                </li>
                <li className="pl-1">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Level 4 — Your instrument:</strong> Calibrated against the working
                  standard. The calibration certificate records any deviation and uncertainty
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Calibration Requirements for Electrical Test Instruments
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                Every measurement has an associated uncertainty — a range within which the true
                value lies. Calibration certificates state this as '± X at 95% confidence level'.
                For a multifunction tester measuring loop impedance, the uncertainty might be ± 5%.
                This means that a reading of 1.00 ohm could actually be anywhere between 0.95 and
                1.05 ohms. When comparing test results against maximum values in BS 7671, you must
                account for this uncertainty to ensure the installation is genuinely safe, not just
                apparently safe.
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Summary of Key Maintenance Measurements
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Recording Results on Test Certificates
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  If a reading exceeds the instrument range, note '&gt;XXX' rather than leaving
                  blank
                </li>
                <li className="pl-1">
                  Record ambient temperature at the time of testing — this affects loop impedance
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-3">
                GS38 — Electrical Test Equipment for Use on Low Voltage
              </h3>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  The prove-test-prove sequence must be followed every time you prove dead
                </li>
              </ul>
            </div>
