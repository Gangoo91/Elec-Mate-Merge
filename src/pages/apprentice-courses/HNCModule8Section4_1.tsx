...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['6 poles', '2 poles', '8 poles', '4 poles'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['89-91%', '80-85%', '75-80%', '95-97%'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['1-2 years', 'More than 8 years', 'Less than 1 year', '3-4 years'],
    correctAnswer: 3,
    explanation:
...
const HNCModule8Section4_1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 4 · Subsection 1"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Three-Phase Induction Motor Principles">
          <p>
            The <strong>three-phase squirrel cage induction motor</strong> is the most common motor
            type in building services. It converts electrical energy to mechanical energy using
            electromagnetic induction, with no electrical connection to the rotor.
          </p>
          <p>
            <strong>Motor Construction</strong>
          </p>
          <p>
            <strong>Stator (Stationary Part)</strong>
          </p>
          ...
          <p>
            <strong>Rotor (Rotating Part)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Operating Principle - The Rotating Magnetic Field</strong>
          </p>
          <p>
            When three-phase AC is applied to the stator windings, the currents create a magnetic
            field that rotates at <strong>synchronous speed</strong>. This rotation occurs because:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Synchronous Speed Formula</strong>
          </p>
          <p>Ns = (120 x f) / p</p>
          <p>Where:</p>
          ...
          <p>
            <strong>Synchronous Speeds at 50Hz</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>2:</strong> 3000 rpm — 2850-2950 rpm — Centrifugal pumps, small fans
            </li>
            <li>
              <strong>4:</strong> 1500 rpm — 1420-1480 rpm — AHU fans, HVAC pumps
            </li>
            <li>
              <strong>6:</strong> 1000 rpm — 940-980 rpm — Large fans, cooling towers
            </li>
            <li>
              <strong>8:</strong> 750 rpm — 700-740 rpm — Low-speed drives, conveyors
            </li>
          </ul>
          <p>
            <strong>Key principle:</strong> Fewer poles = higher speed. 2-pole motors are the
            fastest, but 4-pole motors are most common in HVAC due to good balance of speed, torque
            and efficiency.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Slip and Torque Production">
          <p>
            <strong>Slip</strong> is the difference between synchronous speed and actual rotor
            speed, expressed as a percentage. It is essential for motor operation - without slip,
            there would be no induced rotor current and therefore no torque.
          </p>
          <p>
            <strong>Slip Formula</strong>
          </p>
          ...
          <p>
            <strong>Why Slip is Essential:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Torque-Speed Characteristic</strong>
          </p>
          ...
          <p>
            <strong>Key Points on the Torque-Speed Curve</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Starting (locked rotor):</strong> s = 100% — High current (6-8x FLC), moderate
              torque (1.5-2.5x rated)
            </li>
            <li>
              <strong>Pull-out (breakdown):</strong> s = 10-20% — Maximum torque (2-3x rated),
              unstable beyond this
            </li>
            <li>
              <strong>Full load:</strong> s = 2-6% — Rated torque, rated current, stable operation
            </li>
            <li>
              <strong>No load:</strong> s = 0.5-1% — Minimal torque (friction only), low current
            </li>
          </ul>
          <p>
          ...
          <p>
            If the load torque exceeds pull-out torque, the motor will <strong>stall</strong>. The
            rotor slows dramatically, slip increases, and current rises to starting levels. Without
            protection, the motor will overheat rapidly. This is why overload and stall protection
            are essential.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="IE Efficiency Classes and Regulations">
          <p>
            The <strong>International Efficiency (IE) classification</strong> system standardises
            motor efficiency ratings globally. Higher IE numbers indicate better efficiency and
            lower running costs, though typically with higher purchase price.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>IE1:</strong> Standard — 87.6% — No longer permitted for most applications
            </li>
            <li>
              <strong>IE2:</strong> High — 89.4% — Permitted only with VSD
            </li>
            <li>
              <strong>IE3:</strong> Premium — 91.0% — Minimum standard (since July 2021)
            </li>
            <li>
              <strong>IE4:</strong> Super Premium — 92.1% — Required for some applications from 2023
            </li>
            <li>
              <strong>IE5:</strong> Ultra Premium — &gt;93% — Future standard, emerging technology
            </li>
          </ul>
          <p>
            <strong>UK/EU Ecodesign Regulations (2021 onwards)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>July 2021:</strong> IE3 minimum for motors 0.75-1000kW (2, 4, 6, 8 pole)
            </li>
            <li>
              <strong>July 2021:</strong> IE2 permitted only when used with VSD
            </li>
            <li>
              <strong>July 2023:</strong> IE4 minimum for motors 75-200kW (2-6 pole)
            </li>
            <li>
              <strong>Exemptions:</strong> ATEX motors, brake motors, some special applications
            </li>
          </ul>
          <p>
            <strong>Motor Losses and Efficiency</strong>
          </p>
          <p>
            <strong>Types of Losses</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>How IE3/IE4 Reduce Losses</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Cost-Benefit Example: IE2 vs IE3</strong>
          </p>
          ...
          <p>
            Annual cost: 66,667 x 0.15 = <strong>10,000 pounds</strong>
          </p>
          ...
          <p>
            ...
            &gt;4000 hours/year, IE4 often provides better lifetime value despite higher purchase
            cost.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Motor Nameplate Data and Selection">
          ...
          <p>
            <strong>Motor Nameplate Data Explained</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Rated voltage:</strong> 400V 3~ — Three-phase 400V supply
            </li>
            <li>
              <strong>Rated power:</strong> 11kW — Mechanical output power at shaft
            </li>
            <li>
              <strong>Rated current:</strong> 21.5A — Full load current per line
            </li>
            <li>
              <strong>Power factor:</strong> cos phi 0.85 — Ratio of real to apparent power
            </li>
            <li>
              <strong>Rated speed:</strong> 1460 rpm — Full load speed (indicates 4-pole)
            </li>
            <li>
              <strong>Efficiency:</strong> IE3 / 91.0% — Efficiency class and value at rated load
            </li>
            <li>
              <strong>Insulation class:</strong> F — Maximum winding temperature 155 degrees C
            </li>
            <li>
              <strong>Duty cycle:</strong> S1 — Continuous duty at rated load
            </li>
            <li>
              <strong>Frame size:</strong> 160M — 160mm shaft height, medium length
            </li>
            <li>
              <strong>Protection:</strong> IP55 — Dust protected, water jet protected
            </li>
          </ul>
          <p>
            <strong>Duty Cycles (IEC 60034-1)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>S1:</strong> Continuous duty — AHU fans, pumps, chillers
            </li>
            <li>
              <strong>S2:</strong> Short-time duty (10, 30, 60, 90 min) — Fire damper actuators
            </li>
            <li>
              <strong>S3:</strong> Intermittent periodic duty — Cooling tower fans (on/off control)
            </li>
            <li>
              <strong>S4:</strong> Intermittent periodic with starting — Lift motors, crane hoists
            </li>
            <li>
              <strong>S5:</strong> Intermittent with electric braking — Positioning drives
            </li>
            <li>
              <strong>S6-S10:</strong> Various cyclic duties — Specialist applications
            </li>
          </ul>
          <p>
            <strong>IEC Frame Sizes (Shaft Height)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>80:</strong> 80mm — 0.55-1.1kW
            </li>
            <li>
              <strong>100:</strong> 100mm — 1.5-3kW
            </li>
            <li>
              <strong>132:</strong> 132mm — 5.5-11kW
            </li>
            <li>
              <strong>160:</strong> 160mm — 11-18.5kW
            </li>
            <li>
              <strong>180:</strong> 180mm — 22kW
            </li>
            <li>
              <strong>200:</strong> 200mm — 30-37kW
            </li>
            <li>
              <strong>225:</strong> 225mm — 45-55kW
            </li>
            <li>
              <strong>250-315:</strong> 250-315mm — 75-200kW
            </li>
          </ul>
          <p>
            <strong>Motor Selection Checklist for HVAC</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Power requirement:</strong> Calculate shaft power needed (with margin)
            </li>
            <li>
              <strong>Speed:</strong> Match to driven equipment (direct or via gearbox/belt)
            </li>
            <li>
              <strong>Voltage:</strong> Match supply (typically 400V three-phase in UK)
            </li>
            <li>
              <strong>Efficiency:</strong> IE3 minimum, IE4 for high running hours
            </li>
            <li>
              <strong>Duty cycle:</strong> S1 for continuous, or appropriate S-rating
            </li>
            <li>
              <strong>Environment:</strong> IP rating, temperature range, altitude
            </li>
            <li>
              <strong>Mounting:</strong> B3 (foot), B5 (flange), B14 (face), B35 (foot and flange)
            </li>
            <li>
              <strong>Starting method:</strong> DOL, star-delta, soft start or VSD
            </li>
            <li>
              <strong>Special requirements:</strong> Hazardous area, brake, encoder
            </li>
          </ul>
          <p>
            <strong>VSD Applications - Derating Considerations</strong>
          </p>
          <p>
            ...
            either <strong>oversize the motor</strong> or specify a{' '}
            <strong>force-ventilated motor</strong> with separate cooling fan.
          </p>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A 6-pole motor operates on a 50Hz supply and runs at 960 rpm
            at full load. Calculate the synchronous speed and percentage slip.
          </p>
          ...
          <p>
            Pin = 1.732 x 400 x 28 x 0.87 = <strong>16,874W</strong>
          </p>
          ...
          <p>
            <strong>Question:</strong> An AHU fan motor (22kW, 4-pole) runs 6000 hours/year. Compare
            annual running costs for IE2 (90.5%) vs IE4 (93.0%) at 18p/kWh.
          </p>
          ...
          <p>
            <strong>Question:</strong> Select a motor for a LPHW pump requiring 7.5kW at full speed,
            operating continuously via VSD at 30-100% speed. Ambient temperature 40 degrees C.
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Synchronous speed:</strong> Ns = 120f / p (rpm)
            </li>
            <li>
              <strong>Slip:</strong> s = (Ns - Nr) / Ns x 100%
            </li>
            <li>
              <strong>Power input:</strong> Pin = root3 x V x I x cos(phi)
            </li>
            <li>
              <strong>Efficiency:</strong> eta = Pout / Pin x 100%
            </li>
            <li>
              <strong>Torque:</strong> T = P / omega = P x 60 / (2 x pi x N)
            </li>
            <li>
              <strong>Affinity law (power):</strong> P2 / P1 = (N2 / N1) cubed
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              2-pole sync speed at 50Hz: <strong>3000 rpm</strong>
            </li>
            <li>
              4-pole sync speed at 50Hz: <strong>1500 rpm</strong>
            </li>
            <li>
              6-pole sync speed at 50Hz: <strong>1000 rpm</strong>
            </li>
            <li>
              Typical full-load slip: <strong>2-6%</strong>
            </li>
            <li>
              DOL starting current: <strong>6-8x FLC</strong>
            </li>
            <li>
              IE3 minimum efficiency (11kW 4-pole): <strong>~91%</strong>
            </li>
            <li>
              Class F max temperature: <strong>155 degrees C</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Undersizing:</strong> Not allowing margin for load variations and
                degradation
              </li>
              <li>
                <strong>Oversizing:</strong> Running motors at low load reduces efficiency and power
                factor
              </li>
              <li>
                <strong>Wrong duty rating:</strong> Using S1 motor for intermittent duty without
                checking
              </li>
              <li>
                <strong>VSD derating:</strong> Not accounting for reduced cooling at low speeds
              </li>
              <li>
                <strong>Environment:</strong> Ignoring ambient temperature and altitude derating
              </li>
              <li>
                <strong>Frame compatibility:</strong> Not checking mounting dimensions when
                replacing motors
              </li>
            </ul>
          }
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Motor control</div>
          </button>
          <button
