      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Induction motors:</strong> Rotating magnetic field induces rotor current
              </li>
              <li className="pl-1">
                <strong>Synchronous speed:</strong> Ns = 120f / p (depends on poles and frequency)
              </li>
              <li className="pl-1">
                <strong>Slip:</strong> Rotor runs 2-6% slower than synchronous speed
              </li>
              <li className="pl-1">
                <strong>IE efficiency:</strong> IE3 (Premium) now minimum legal requirement
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>AHU fans:</strong> 2 or 4-pole motors, 1-30kW typical
              </li>
              <li className="pl-1">
                <strong>Pumps:</strong> 2-pole for centrifugal, 4-pole for positive displacement
              </li>
              <li className="pl-1">
                <strong>Chillers:</strong> Large motors up to 500kW, high efficiency critical
              </li>
              <li className="pl-1">
                <strong>Selection:</strong> Match duty cycle, efficiency class and frame size
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The <strong>three-phase squirrel cage induction motor</strong> is the most common
              motor type in building services. It converts electrical energy to mechanical energy
              using electromagnetic induction, with no electrical connection to the rotor.
            </p>
            ...
            <div className="my-6">
              ...
              <ol className="text-sm text-white space-y-2 list-decimal list-outside ml-5">
                ...
                <li className="pl-1">
                  The combination produces a field of constant magnitude that rotates smoothly
                </li>
                <li className="pl-1">
                  The field rotates at a speed determined by frequency and number of poles
                </li>
              </ol>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              fastest, but 4-pole motors are most common in HVAC due to good balance of speed,
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ol className="text-sm text-white space-y-2 list-decimal list-outside ml-5">
                ...
                <li className="pl-1">
                  This relative motion induces EMF in the rotor bars (Faraday's law)
                </li>
                <li className="pl-1">
                  The EMF drives current through the short-circuited rotor bars
                </li>
                <li className="pl-1">
                  Current-carrying conductors in a magnetic field experience force (motor action)
                </li>
                ...
                <li className="pl-1">
                  Equilibrium is reached when motor torque equals load torque
                </li>
              </ol>
            </div>
       ...
       (s=1)      load    speed
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        High current (6-8x FLC), moderate torque (1.5-2.5x rated)
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Maximum torque (2-3x rated), unstable beyond this
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Rated torque, rated current, stable operation
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Minimal torque (friction only), low current
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                    <tr className="bg-white/5">
                      ...
                      <th className="border border-white/10 px-3 py-2 text-left">
                        Typical Efficiency (11kW 4-pole)
                      </th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        No longer permitted for most applications
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2 text-green-300">
                        Minimum standard (since July 2021)
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Required for some applications from 2023
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Future standard, emerging technology
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-3">
                UK/EU Ecodesign Regulations (2021 onwards)
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-3">
                Motor Nameplate Data Explained
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Mechanical output power at shaft
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Full load speed (indicates 4-pole)
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Efficiency class and value at rated load
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        160mm shaft height, medium length
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Dust protected, water jet protected
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        AHU fans, pumps, chillers
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">S2</td>
                      <td className="border border-white/10 px-3 py-2">
                        Short-time duty (10, 30, 60, 90 min)
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Cooling tower fans (on/off control)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">S4</td>
                      <td className="border border-white/10 px-3 py-2">
                        Intermittent periodic with starting
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Lift motors, crane hoists
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">S5</td>
                      <td className="border border-white/10 px-3 py-2">
                        Intermittent with electric braking
                      </td>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Motor Selection Checklist for HVAC
              </p>
              <div className="p-4 rounded-lg bg-white/5">
                <ol className="text-sm text-white space-y-2 list-decimal list-outside ml-5">
                  ...
                  <li className="pl-1">
                    <strong>Mounting:</strong> B3 (foot), B5 (flange), B14 (face), B35 (foot and
                    flange)
                  </li>
                  <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-amber-500/10 border border-amber-500/30">
              ...
              <p className="text-sm text-white/90">
                ...
                <strong>force-ventilated motor</strong>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Calculating Synchronous Speed and Slip
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Verifying Nameplate Data
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Energy Savings from Motor Upgrade
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 4: Motor Selection for Variable Speed Pump
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> Select a motor for a LPHW pump requiring 7.5kW at full
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2">
                  High ambient derating (40 degrees C vs 40 degrees C standard): 1.0
                </p>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Oversizing:</strong> Running motors at low load reduces efficiency and
                  power factor
                </li>
                <li className="pl-1">
