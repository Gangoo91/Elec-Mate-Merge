...
const HNCModule8 = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      description:
        'DX systems, chilled water, VRF/VRV technology, refrigeration principles and system selection',
      icon: Snowflake,
    ...
    },
    {
      ...
      description:
        'Building management systems, control strategies, sensors, actuators, protocols and system optimisation',
      icon: Cpu,
    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-12">
          Understand HVAC system design and the electrical services that support heating,
          ventilation and air conditioning in modern commercial buildings
        </p>
