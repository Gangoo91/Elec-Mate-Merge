    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Understand the properties of moist air and apply psychrometric analysis to HVAC system
          design
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the thermodynamic properties of air-water vapour mixtures, the use of
          psychrometric charts, and the analysis of air conditioning processes - fundamental
          knowledge for designing and commissioning HVAC systems.
        </p>
