  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'GS38 is a Health and Safety Executive guidance note that sets minimum safety requirements for electrical test equipment in the UK.',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Double insulation provides robust protection against physical damage and ensures safety even if the outer insulation is compromised.',
    },
    {
      id: 6,
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'The apprentice correctly identified the insulation damage, reported it to his supervisor, and was provided with GS38-compliant replacement equipment.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-10">
            <p className="text-white/80 leading-relaxed">
              ...
              equipment in the UK. Compliance with GS38 protects electricians from shock, burns, and
              arc flash injuries during testing. Apprentices must become familiar with these
              requirements and treat them as standard practice in every situation, not just during
              formal inspections.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-4">
              ...
              <ul className="space-y-2 text-sm text-white/80">
                ...
                <li>
                  <strong className="text-white">Shrouded probes:</strong> Only 2 mm of exposed
                  metal should be visible at the probe tip to reduce accidental contact risk
                </li>
                <li>
                  <strong className="text-white">Finger guards:</strong> Probes must have guards to
                  prevent fingers from slipping forward onto live conductors
                </li>
                <li>
                  <strong className="text-white">Double insulation:</strong> Leads should be
                  flexible, robust, and resistant to cuts, abrasion, and heat
                </li>
                <li>
                  <strong className="text-white">Category ratings:</strong> Equipment must be rated
                  (CAT II, III, or IV) for the electrical system being tested
                </li>
              </ul>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50 mb-4">
              ...
              <ul className="space-y-2 text-sm text-white/80">
                ...
                <li>
                  <strong className="text-white">Modified equipment:</strong> Alterations may
                  compromise safety features
                </li>
                <li>
                  <strong className="text-white">Damaged leads:</strong> Cracked insulation or
                  exposed conductors are dangerous
                </li>
                <li>
                  <strong className="text-white">Incorrect fuses:</strong> Wrong ratings won't
                  provide adequate protection
                </li>
                <li>
                  <strong className="text-white">Excessive probe tips:</strong> More than 2mm
                  exposure increases contact risk
                </li>
              </ul>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-amber-500/5 border-l-2 border-amber-500/50 mb-4">
              ...
              <ul className="space-y-2 text-sm text-white/80">
                ...
                <li>
                  <strong className="text-white">Daily inspection duty:</strong> Electricians must
                  visually inspect test equipment before each use
                </li>
                <li>
                  <strong className="text-white">Employer responsibilities:</strong> Must provide
                  GS38-compliant equipment and training
                </li>
                <li>
                  <strong className="text-white">Individual accountability:</strong> Each
                  electrician is personally responsible for refusing non-compliant equipment
                </li>
                <li>
                  <strong className="text-white">Reporting requirements:</strong> Non-compliant
                  equipment must be reported and removed from service
                </li>
              </ul>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-purple-500/5 border-l-2 border-purple-500/50 mb-4">
              ...
              <ul className="space-y-2 text-sm text-white/80">
                ...
                <li>
                  <strong className="text-white">Equipment selection:</strong> Choose appropriate
                  category-rated instruments for the system being tested
                </li>
                <li>
                  <strong className="text-white">Damage reporting:</strong> Immediately report and
                  remove any non-compliant equipment from service
                </li>
                <li>
                  <strong className="text-white">Refusal protocols:</strong> Know how to
                  professionally refuse unsafe equipment and escalate concerns
                </li>
                <li>
                  <strong className="text-white">Continuous learning:</strong> Stay updated on GS38
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-red-500/5 border-l-2 border-red-500/50">
                ...
                <p className="text-xs text-amber-400 font-medium">
                  GS38-compliant probes with 2mm tips and finger guards would have prevented this
                  accident.
                </p>
              </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <ul className="space-y-2 text-sm text-white/80">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    GS38 sets mandatory safety standards for electrical test equipment in the UK
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400">✓</span>
                  <span>
                    Key features include fused leads, shrouded probes, finger guards, and proper
                    category ratings
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400">✓</span>
                  <span>
                    Non-compliant equipment must never be used, regardless of convenience or
                    pressure
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400">✓</span>
                  <span>
                    Legal compliance is backed by the Electricity at Work Regulations 1989
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400">✓</span>
                  <span>
                    Daily inspection and professional equipment management are essential practices
                  </span>
                </li>
              </ul>
            </div>
