  ...
  const faqs = [
    {
      ...
      answer:
        'Ring circuits should be tested during initial installation, at periodic inspections (typically every 10 years for domestic), and whenever modifications are made. Any signs of problems require immediate testing.',
    },
    {
      question: 'Can I tell if a ring is broken just by looking?',
      answer:
        'No, visual inspection cannot determine ring integrity. You need proper electrical testing with calibrated instruments to confirm both legs are complete and have correct resistance values.',
    },
    {
      question: 'What if my ring test shows unequal resistance values?',
      answer:
        'Slight variations are normal due to cable routing differences, but significant discrepancies indicate faults. Investigate loose connections, cable damage, or incorrect installation methods.',
    },
    {
      question: 'Do I need special qualifications to test ring circuits?',
      answer:
        'Yes, ring circuit testing requires appropriate electrical qualifications and competency. This is typically part of 18th Edition, inspection and testing courses, and relevant NVQ qualifications.',
    },
    {
      question: 'What should I do if I find a broken ring?',
      answer:
        'A broken ring is a serious safety issue. Isolate the circuit immediately, investigate the cause, repair the break, and retest before re-energising. Consider whether an EICR code is required.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Cable forms complete loop from consumer unit outward terminals back to
                      consumer unit return terminals
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Current divides between two paths, reducing load on each cable leg by
                      approximately 50%
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Enables 32A protection with 2.5mm² cable (normally rated 27A as radial)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Reduces voltage drop across circuit by providing parallel current paths
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <ul className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Broken ring becomes radial circuit carrying full load through single cable
                      path
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-400">⚠</span>
                    <span>
                      2.5mm² cable carrying 32A load will overheat rapidly - cable rating exceeded
                      by 18%
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-red-400">⚠</span>
                    <span>
                      MCB may not protect adequately as current still below 32A trip point
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      BS 7671:2018+A2:2022 Section 612.2.2 mandates ring continuity verification
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      EICR Code C1 (Danger Present) applies to broken rings requiring immediate
                      action
                    </span>
                  </li>
                </ul>
          ...
          <InlineCheck
            ...
            options={[
              ...
              'Becomes overloaded and dangerous',
              'Saves energy',
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Disconnect both line conductors at consumer unit and measure resistance
                      between them
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Repeat for neutral conductors - should give similar reading to line
                      measurement
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Test CPC (earth) conductors separately - typically higher reading due to
                      smaller CSA
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Typical values for 2.5mm² ring: Line and Neutral ≈ 1.2Ω, CPC ≈ 1.9Ω (depends
                      on length)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Reading of infinity (OL) indicates broken ring requiring immediate
                      investigation
                    </span>
                  </li>
                </ul>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ol className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Isolate ring circuit at consumer unit and prove dead using GS38 voltage
                      indicator
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Identify outgoing and return legs of ring circuit at consumer unit terminals
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow font-medium">3.</span>
                    <span>
                      Zero low-resistance ohmmeter using test leads (note lead resistance typically
                      0.01-0.02Ω)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Repeat for neutral conductors - values should be similar to line reading
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow font-medium">6.</span>
                    <span>
                      Test CPC conductors separately - expect higher reading due to smaller CSA
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow font-medium">7.</span>
                    <span>
                      Record all readings and compare to expected values for cable type and length
                    </span>
                  </li>
                </ol>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      2.5mm² copper ring (30m each leg): Line/Neutral ≈ 1.2Ω, CPC (1.5mm²) ≈ 1.9Ω
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      4mm² copper ring (40m each leg): Line/Neutral ≈ 0.9Ω, CPC (1.5mm²) ≈ 2.5Ω
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      Readings should be consistent between line and neutral conductors (±10%
                      variation)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">•</span>
                    <span>
                      CPC reading higher due to smaller cross-sectional area (typically 1.5mm² vs
                      2.5mm²)
                    </span>
                  </li>
                </ul>
              ...
              <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
                ...
                <ul className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Infinite resistance (OL): Complete break in ring - check all terminations and
                      cable joints
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-amber-400">⚠</span>
                    <span>
                      Very high resistance (&gt;5Ω): Poor connections, loose terminals, or corroded
                      joints
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-amber-400">⚠</span>
                    <span>
                      Unequal leg readings: Different cable sizes, poor connections, or partial
                      damage
                    </span>
                  </li>
                </ul>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Complete ring break: Danger Present - immediate disconnection required
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-amber-400">C2</span>
                    <span>
                      High resistance connections: Potentially Dangerous - urgent remedial work
                      needed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Minor variations within limits: Improvement Recommended - monitor and review
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white/80 mb-4">
                ...
                occasional tripping when multiple appliances are used.
              </p>
