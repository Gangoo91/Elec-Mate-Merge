...
const TITLE =
  'Zoning, Environmental Considerations, and Cable Choice - Module 5.2.4 | Level 2 Electrical Course';
const DESCRIPTION =
  'Learn about safe cable routing zones, environmental factors affecting cable performance, and selecting appropriate cables for different applications in compliance with BS 7671.';
...
const Module5Section2_4 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      id: 3,
      question:
        'True or False: It is acceptable to run T&E cables diagonally across a wall if they are deep enough.',
      options: ['True', 'False'],
      correctAnswer: 1,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Grouping cables together reduces their current-carrying capacity, leading to overheating risk.',
    },
    {
      id: 6,
  ...
  const faqs = [
    {
      ...
      answer:
        'Cables outside safe zones must be mechanically protected (e.g., steel conduit or earthed metallic covering) to prevent damage from drilling or nails. This is required by BS 7671 Regulation 522.6.202.',
    },
    {
      question: 'How do I calculate derating factors for grouped cables?',
      answer:
        'Consult BS 7671 Appendix 4 tables. Apply grouping factors based on the number of loaded circuits, installation method, and ambient temperature. Multiple factors may need to be applied cumulatively.',
    },
    {
      question: 'When should I use SWA cables instead of T&E?',
      answer:
        'Use SWA for outdoor installations, underground runs, areas with high mechanical stress, or where cables need armoured protection. SWA provides both mechanical protection and earthing continuity.',
    },
    {
      question: "What's the difference between LSF and LSZH cables?",
      answer:
        'LSF (Low Smoke and Fume) cables produce less smoke when burning. LSZH (Low Smoke Zero Halogen) cables produce minimal smoke and no halogenated gases, making them safer for evacuation routes and enclosed spaces.',
    },
  ];
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-white/80 text-sm">
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    <strong>Spot:</strong> Cables outside zones need protection
                  </li>
                  <li>
                    <strong>Use:</strong> BS 7671 Reg 522.6.202 and Appendix 4
                  </li>
                  <li>
                    <strong>Check:</strong> Derating factors for grouping/temperature
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <p className="text-white/80 leading-relaxed">
              ...
              subsection introduces how installation zones, environmental factors, and cable
              selection work together to ensure safety and compliance with BS 7671.
            </p>
          </section>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <p className="font-medium text-elec-yellow mb-3">
                  BS 7671 Safe Zone Requirements (Regulation 522.6.202)
                </p>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <ul className="text-sm list-disc ml-4 space-y-1">
                      <li>
                        <strong>Horizontally or vertically:</strong> From any point on an accessory
                        to the boundary of the zone
                      </li>
                      <li>
                        <strong>Within 150mm:</strong> Of the top of the wall (junction with
                        ceiling)
                      </li>
                      <li>
                        <strong>Within 150mm:</strong> Of the angle formed by two walls
                      </li>
                      <li>
                        <strong>Accessory zones:</strong> Horizontally or vertically from switches,
              ...
              <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
                <p className="font-medium text-orange-400 mb-2">
                  Outside Safe Zones - Protection Requirements:
                </p>
                <ul className="text-sm ml-4 list-disc space-y-1">
                  <li>
                    <strong>Steel conduit:</strong> Earthed metallic conduit providing mechanical
                    protection
                  </li>
                  <li>
                    <strong>Steel trunking:</strong> Earthed metallic trunking systems
                  </li>
                  <li>
                    <strong>Armoured cables:</strong> SWA or similar mechanically protected cables
                  </li>
                  <li>
                    <strong>30mA RCD protection:</strong> Additional protection for concealed cables
                    (Reg 522.6.203)
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30">
                ...
                <ul className="text-sm ml-4 list-disc space-y-1">
                  <li>
                    <strong>Never assume:</strong> Always check zone compliance before installation
                  </li>
                  <li>
                    <strong>Document routes:</strong> Provide clear cable route drawings for future
                    reference
                  </li>
                  <li>
                    <strong>Mark positions:</strong> Use cable route markers where practical
                  </li>
                  <li>
                    <strong>Consider future work:</strong> Think about likely drilling positions
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10 mt-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  <p className="font-medium text-elec-yellow mb-2">
                    Twin & Earth (T&E) - 6242Y/6243Y
                  </p>
                  <div className="grid sm:grid-cols-2 gap-3 text-sm">
                    <ul className="list-disc ml-4 space-y-1">
                      <li>
                        <strong>Construction:</strong> 2 insulated conductors + bare CPC in PVC
                        sheath
                      </li>
                      <li>
                        <strong>Applications:</strong> Standard domestic fixed wiring
                      </li>
                      <li>
                        <strong>Voltage rating:</strong> 300/500V
                      </li>
                    </ul>
                    <ul className="list-disc ml-4 space-y-1">
                      <li>
                        <strong>Installation:</strong> Internal use only, must be protected
                      </li>
                      <li>
                        <strong>Advantages:</strong> Cost-effective, easy to install
                      </li>
                      <li>
                        <strong>Limitations:</strong> Not for damp or outdoor locations
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3 text-sm">
                    <ul className="list-disc ml-4 space-y-1">
                      <li>
                        <strong>Construction:</strong> Insulated conductors + steel wire armouring +
                        outer sheath
                      </li>
                      <li>
                        <strong>Applications:</strong> Outdoor, underground, high mechanical stress
                      </li>
                      <li>
                        <strong>Armouring benefits:</strong> Mechanical protection + earthing
                      </li>
                    </ul>
                    <ul className="list-disc ml-4 space-y-1">
                      <li>
                        <strong>Voltage ratings:</strong> Available up to 11kV and beyond
                      </li>
                      <li>
                        <strong>Installation:</strong> Direct burial, overhead, industrial
                      </li>
                      <li>
                        <strong>Termination:</strong> Requires special glands and techniques
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  <p className="font-medium text-elec-yellow mb-2">
                    Flexible Cables (H05VV-F, H07RN-F)
                  </p>
                  <div className="grid sm:grid-cols-2 gap-3 text-sm">
                    <ul className="list-disc ml-4 space-y-1">
                      <li>
                        <strong>Construction:</strong> Stranded conductors for flexibility
                      </li>
                      <li>
                        <strong>Applications:</strong> Appliances, temporary connections
                      </li>
                      <li>
                        <strong>Types:</strong> Light duty (H05), heavy duty (H07)
                      </li>
                    </ul>
                    <ul className="list-disc ml-4 space-y-1">
                      <li>
                        <strong>Benefits:</strong> Flexibility, various sheaths available
                      </li>
                      <li>
                        <strong>Installation:</strong> Not suitable for permanent fixed wiring
                      </li>
                      <li>
                        <strong>Standards:</strong> BS EN 50525 series
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3 text-sm">
                    <ul className="list-disc ml-4 space-y-1">
                      <li>
                        <strong>LSF:</strong> Low Smoke and Fume - reduced smoke
                      </li>
                      <li>
                        <strong>LSZH:</strong> Low Smoke Zero Halogen - no toxic gases
                      </li>
                      <li>
                        <strong>Applications:</strong> Schools, hospitals, public buildings
                      </li>
                    </ul>
                    <ul className="list-disc ml-4 space-y-1">
                      <li>
                        <strong>Fire performance:</strong> Better evacuation conditions
                      </li>
                      <li>
                        <strong>Cost:</strong> Higher than standard PVC
                      </li>
                      <li>
                        <strong>Standards:</strong> BS 7211, BS EN 50267
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <div className="grid sm:grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <ul className="space-y-1">
                      <li>
                        <strong>Grouping factor (Cg):</strong> Multiple cables together reduce heat
                        dissipation
                      </li>
                      <li>
                        <strong>Ambient temperature (Ca):</strong> Higher temperatures reduce
                        capacity
                      </li>
                      <li>
                        <strong>Thermal insulation (Ci):</strong> Surrounded by insulation materials
                      </li>
                      <li>
                        <strong>Installation method:</strong> Different methods have different
                        cooling
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1">
                      <li>
                        <strong>Step 1:</strong> Determine base current-carrying capacity (Iz)
                      </li>
                      <li>
                        <strong>Step 2:</strong> Apply all relevant correction factors
                      </li>
                      <li>
                        <strong>Step 3:</strong> Derated capacity = Iz × Cg × Ca × Ci
                      </li>
                      <li>
                        <strong>Step 4:</strong> Ensure derated capacity ≥ design current
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <ul className="text-sm space-y-2">
                  <li>
                    <strong>Current coordination:</strong> Cable current-carrying capacity (Iz) must
                    be ≥ protective device rating (In)
                  </li>
                  <li>
                    <strong>Voltage drop limits:</strong> Maximum 3% for lighting, 5% for other uses
                    per BS 7671
                  </li>
                  <li>
                    <strong>Fault protection:</strong> Cable must withstand fault current until
                    protective device operates
                  </li>
                  <li>
                    <strong>Earth fault loop impedance:</strong> Must be low enough for protective
                    device operation
                  </li>
                  <li>
                    <strong>Selectivity:</strong> Consider discrimination between protective devices
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-white/80 text-sm mb-3">
                ...
                safe zones or used mechanical protection.
              </p>
              ...
              <div className="space-y-3">
                <div className="p-3 rounded bg-black/20">
                  ...
                  <ul className="text-xs list-disc ml-4 space-y-1 text-white/70">
                    ...
                    <li>
                      <strong>No zone compliance:</strong> Route was outside both horizontal and
                      vertical safe zones
                    </li>
                    <li>
                      <strong>No protection:</strong> Standard T&E cable used without mechanical
                      protection
                    </li>
                    <li>
                      <strong>Poor communication:</strong> Follow-on trades not informed of cable
                      routes
                    </li>
                  </ul>
                </div>
          ...
          <section className="mb-10">
            ...
            <p className="text-white/80 leading-relaxed">
              ...
              derating factors affect current-carrying capacity. You also learned practical steps
              for ensuring safety and compliance in real-world installations.
            </p>
          </section>
