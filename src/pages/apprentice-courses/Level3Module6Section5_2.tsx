    ...
    <div className="min-h-screen overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        <header className="text-center mb-12">
          <div className="inline-flex items-center gap-2 text-elec-yellow text-sm mb-3"><Zap className="h-4 w-4" /><span>Module 6.5.2</span></div>
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3">Ring Final Circuits</h1>
          <p className="text-white/80">Design and testing of ring circuits for socket outlets</p>
        </header>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {["Explain the advantages of ring final circuit design", "Apply BS 7671 floor area recommendations", "Distinguish between fused and non-fused spurs", "Calculate expected R1+R2 values for ring circuits", "Perform ring continuity testing procedures", "Identify common ring circuit faults"].map((item, i) => (
        ...
        <nav className="flex flex-col sm:flex-row gap-4 justify-between pt-8 border-t border-white/10">
          <Button variant="outline" className="border-white/20 text-white hover:bg-white/5" asChild>
            <Link to="../level3-module6-section5-1"><ArrowLeft className="w-4 h-4 mr-2" />Previous: Domestic Circuits</Link>
          </Button>
          <Button className="bg-elec-yellow text-[#1a1a1a] hover:bg-elec-yellow/90" asChild>
            <Link to="../level3-module6-section5-3">Next: Radial Circuits<ArrowLeft className="w-4 h-4 ml-2 rotate-180" /></Link>
          </Button>
        </nav>
      </article>
    </div>
