      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-cyan-400/5 border-l-2 border-cyan-400/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>ADP:</strong> Effective coil surface temperature
              </li>
              <li className="pl-1">
                <strong>Contact factor:</strong> CF = 0.75-0.95 typical
              </li>
              <li className="pl-1">
                <strong>Bypass factor:</strong> BF = 1 - CF
              </li>
              <li className="pl-1">
                <strong>CHW temps:</strong> 6/12°C standard
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-cyan-400/5 border-l-2 border-cyan-400/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Cooling coils:</strong> 4-8 rows, wet operation
              </li>
              <li className="pl-1">
                <strong>Heating coils:</strong> 1-2 rows, LTHW 82/71°C
              </li>
              <li className="pl-1">
                <strong>Face velocity:</strong> 2.0-3.0 m/s cooling
              </li>
              <li className="pl-1">
                <strong>DX coils:</strong> Direct expansion alternative
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="font-mono text-center text-sm space-y-2 mb-3">
                <p>CF + BF = 1</p>
                <p>
                  CF = (T<sub>in</sub> - T<sub>off</sub>) / (T<sub>in</sub> - ADP)
                </p>
                <p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-cyan-400/80 mb-2">
                Factors Affecting Contact Factor
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Max 3 m/s to prevent carryover
                      </td>
                    </tr>
                    <tr>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="font-mono text-sm space-y-2">
                <p>
                  Total load: Q<sub>t</sub> = ṁ × (h<sub>in</sub> - h<sub>off</sub>)
                </p>
                <p>
                  Sensible load: Q<sub>s</sub> = ṁ × c<sub>p</sub> × (T<sub>in</sub> - T
                  <sub>off</sub>)
                </p>
                <p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-cyan-400/80 mb-2">
                Heating Coil Types and Applications
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-cyan-400/80 mb-2">
                Example 1: Off-Coil Temperature from Contact Factor
              </h3>
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p>
                  T_off = 28 - 0.82 × 18 = 28 - 14.76 = <strong>13.2°C</strong>
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-cyan-400/80 mb-2">
                Example 2: Determining ADP from Conditions
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p>
                  From psychrometric chart: <strong>ADP ≈ 9°C</strong>
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-cyan-400/80 mb-2">
                Example 3: Cooling Coil Load Calculation
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white">
                ...
                <p>
                  Qs = 5 × 1.005 × (28 - 14) = 5 × 1.005 × 14 = <strong>70.4 kW</strong>
                </p>
                <p className="mt-2">Latent load: QL = ṁ × Δg × hfg</p>
                <p>
                  QL = 5 × 0.003 × 2450 = <strong>36.8 kW</strong>
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-cyan-400/80 mb-2">
                Example 4: Chilled Water Flow Rate
              </h3>
              <p className="text-sm text-white mb-2">
