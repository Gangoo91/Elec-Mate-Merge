...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['14.8°C', '12.0°C', '16.0°C', '13.2°C'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['ΔT = Q / (ṁ × cp)', 'ΔT = Q × cp × ṁ', 'ΔT = Q / (ṁ × hfg)', 'ΔT = ṁ / (Q × cp)'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['40/30°C', '82/71°C', '60/50°C', '120/100°C'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['1.0-1.5 m/s', '6.0-8.0 m/s', '2.0-3.0 m/s', '4.0-5.0 m/s'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CIBSE Guide B3 is the UK reference standard for coil selection and performance
              verification. As HNC engineer you cite Guide B3 in coil schedule notes, in the design
              risk register, and in any RFI response when a contractor proposes a substitute coil.
            </>
          }
        ...
        >
          ...
          <p>
            ...
            temperature. Lower ADP provides more dehumidification but requires colder water and more
            energy.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            <strong>Contact Factor Equations</strong> (same equations apply for moisture content g):
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>CF + BF = 1</li>
        ...
        >
          <p>
            ...
            cooling coil at 28°C. The ADP is 10°C and the coil contact factor is 0.82. Calculate the
          ...
          <p>
            <strong>Example 2: Determining ADP from Conditions.</strong> Air at 26°C, 11 g/kg enters
            a cooling coil and leaves at 14°C, 9 g/kg. Find the ADP and contact factor.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Verify with moisture: CF = (11-9)/(11-8.5) = 2/2.5 = 0.8 (slight difference due to
              chart reading)
            </li>
          </ul>
          <p>
            <strong>Example 3: Cooling Coil Load Calculation.</strong> A coil handles 5 kg/s. Entry:
            28°C, 12 g/kg, h = 58 kJ/kg. Exit: 14°C, 9 g/kg, h = 37 kJ/kg. Calculate loads.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Example 4: Chilled Water Flow Rate.</strong> A 120 kW cooling coil uses chilled
            water at 6/12°C. Calculate the required water flow rate.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              You are designing the AHU for a 12-bed recovery ward. The HTM 03-01 ventilation
              requirement is 10 ach with a strict 22 °C, 50% RH supply target. Mixed entering air is
              28 °C, 60% RH (summer). Chilled water supply is 6 °C flow, 12 °C return.
            </>
          }
          whatToDo={
            <>
              ...
              saturation curve. Choose a coil with contact factor &gt;0.92 (typically 6–8 rows, 2.0
              m/s face velocity). Size duty Q̇ = ṁ × Δh. Cross-check with the manufacturer&rsquo;s
              selection software, then lock the schedule.
            </>
          }
          whyItMatters={
            <>
              Hospital ventilation is regulated under HTM 03-01 with explicit dew-point and RH
              limits to control infection risk. An undersized coil that misses the off-coil target
              leaves the ward in a regulatory non-compliance position — and patient comfort suffers.
              The chart-based ADP/β method is the defensible audit trail.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">AC Processes</div>
          </button>
          <button
