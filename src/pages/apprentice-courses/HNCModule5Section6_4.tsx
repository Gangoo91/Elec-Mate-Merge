    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The CPP is the principal contractor's primary CDM site deliverable. It must be in
              place before site set-up — not after, not "in development". HSE inspectors ask for the
              CPP on first visit; absence is a Reg 12 breach. The CPP is also the operational
              document referenced by site management daily.
            </>
          }
        ...
        <ConceptBlock title="CDM 2015 Dutyholders and Responsibilities">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Principal designer:</strong> Plans, manages and coordinates health and safety
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Ensure site induction provided:</strong> All workers inducted before starting
              work
            </li>
            <li>
          ...
          <p>
            <strong>F10 notification requirements:</strong> An F10 notification must be submitted to
            the HSE before construction begins when:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Building services context:</strong> As a subcontractor, you are classified as a
            'contractor' under CDM 2015 and must comply with the principal contractor's site rules
        ...
        <ConceptBlock title="Construction Phase Plan Requirements">
          ...
          <p>
            <strong>
              Schedule 3 high-risk activities — the construction phase plan must include specific
              arrangements for controlling these high-risk activities:
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>
              Construction phase plan review triggers — the plan must be reviewed and updated when:
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            before starting work on any site. Review it to understand site-specific requirements and
            how your work interfaces with other trades.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Site Inductions and Toolbox Talks">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Topic selection:</strong> Relevant to current work, recent incidents, seasonal
              risks
            </li>
            <li>
          ...
          <p>
            <strong>Documentation tip:</strong> Keep attendance records for all toolbox talks. These
            demonstrate due diligence and are valuable evidence if incidents occur. Many sites use
            digital sign-in systems for efficiency.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="RAMS Process and Implementation">
          <p>
            ...
            construction sites. They translate general safety requirements into specific, actionable
            control measures for individual work activities.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Distribution board installation:</strong> Electrical contact, manual handling
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Generic content:</strong> Copy-paste documents that don't reflect actual site
              conditions
            </li>
            <li>
          ...
          <p>
            ...
            Generic documents are not compliant and provide no legal protection if incidents occur.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical Scenarios">
          <p>
            <strong>Scenario 1 — Arriving at a new site:</strong> You are starting electrical first
            fix on a new-build office block. What CDM compliance steps must you complete?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              An HSE inspector arrives at week 6 of an MEP project. They ask to see the CPP. The PM
              produces a 40-page document that is the company's template — generic risks, generic
              procedures, no project-specific content. The inspector identifies the CPP does not
              address: confined space risk in the basement plant room, the live electrical
              environment, the asbestos report findings, the working at height plan for the riser.
              Improvement Notice issued.
            </>
          }
          whatToDo={
            <>
              The CPP must be project-specific. Re-write within 14 days using actual site
              information: hazards from PCI, structure of the works, specific risk control measures,
              welfare arrangement, emergency procedures, briefing arrangements. The CPP is reviewed
              and updated as the project progresses — not a one-shot document. Brief the site team
              on CPP content; make it the working document, not a shelf document.
            </>
          }
          whyItMatters={
            <>
              The CPP is the project's safety constitution. A generic CPP signals that the principal
              contractor has not engaged with the actual risks — a finding that exposes the
              contractor to enforcement, the project to delay, and the operatives to harm.
              Investment in a real CPP returns in safer, smoother delivery.
            </>
          }
        />
