...
const quickCheckQuestions = [
  {
    ...
    options: ['Number of luminaires', 'Lumens required', 'Nominal wattage', 'Neutral factor'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['500 lux', '625 lux', '781 lux', '400 lux'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['6m × 4m (24m²)', '15m × 8m (120m²)', '9m × 6m (54m²)', '20m × 15m (300m²)'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 510.3 makes the lighting calc more than a CIBSE exercise. The luminaire you drop
              into the lumen-method N must also satisfy the BS 7671 selection rules — IP rating for
              the location, terminal capacity for your CPC, ambient temperature rating, manufacturer
              mounting instructions. The DIALux output and the BS 7671 schedule are two halves of
              the same submission.
            </>
          }
        ...
        <ConceptBlock title="The Lumen Method Formula">
          ...
          <p>
            <strong>Remember:</strong> The lumen method gives average illuminance only. Use software
            to verify uniformity and UGR compliance.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Room Index and Mounting Height">
          <p>
            ...
            It determines how efficiently light reaches the working plane versus being absorbed by
            walls.
          </p>
          <p>
            <strong>Room index formula:</strong> K = (L × W) / (H<sub>m</sub> × (L + W)) — where L =
            room length, W = room width, H<sub>m</sub> = mounting height above working plane.
          </p>
          <p>
          ...
          <p>
            <strong>Design insight:</strong> Higher K means better utilisation factor. Large rooms
            are more efficient because proportionally less light is lost to walls.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Utilisation Factors and Reflectances">
          ...
          <p>
            <strong>
              Standard surface reflectances (surface / standard / light colours / dark colours):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>
              Example UF table — recessed LED panel, ceiling 0.7 / floor 0.2 (K / walls 0.5 / walls
              0.3 / walls 0.1):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Maintenance Factor and Software Tools">
          <p>
            The maintenance factor accounts for the gradual reduction in light output over time due
            to lamp depreciation and dirt accumulation. Modern software tools like DIALux and Relux
            provide detailed point-by-point calculations that go beyond the simple lumen method.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>LDD</strong> = Luminaire Dirt Depreciation (0.8-0.95 depending on IP rating)
            </li>
            <li>
          ...
          <p>
            ...
            verify with DIALux/Relux for detailed design. Always document assumptions for MF and UF
            in design reports.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — office lumen method calculation:</strong> Calculate luminaires for a
            15m × 10m office, 2.8m ceiling, using 600×600 LED panels (3600 lumens each). Target 500
            lux maintained.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Example 3 — warehouse calculation:</strong> warehouse 30m × 20m × 8m mounting
            height. Target 200 lux. LED highbays at 24,000 lumens each. Determine quantity.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Wrong Hm</strong> — remember to subtract working plane from ceiling height
              </li>
              <li>
                <strong>Initial vs maintained</strong> — UF tables give maintained values when MF
                applied
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              Subcontractor sends a DIALux model claiming 9 luminaires deliver 300 lx maintained in
              a 12 m × 8 m classroom (Hm = 2.4 m). Each luminaire 4,200 lm, MF assumed 0.8. You’re
              the building services engineer signing the lighting design — does the figure stack up
              before you spend two hours interrogating the model?
            </>
          }
          whatToDo={
            <>
              Run the lumen-method back-check. K = (12 × 8) / [2.4 × (12 + 8)] = 96 / 48 = 2.0.
              Reflectances 0.7/0.5/0.2 give a UF of around 0.6 for a typical recessed modular. N =
              (E × A) / (Φ × UF × MF) = (300 × 96) / (4,200 × 0.6 × 0.8) = 28,800 / 2,016 ≈ 14.3 →
              15 luminaires. The model’s 9 is off by a third — either UF or MF is wrong, or they’ve
              lifted point-by-point peaks and quoted them as maintained average. Send it back with
              the K, UF and MF you used, and ask for a 6 × 4 grid (24 luminaires wouldn’t be wrong
              either — round to a sensible matrix that gives Uo ≥ 0.7).
            </>
          }
          whyItMatters={
            <>
              If you sign that lighting schedule and the room reads at 200 lx on commissioning, it’s
              your stamp on the EIC and your reputation with the client. The lumen-method hand calc
              is a 30-second guard rail.
            </>
          }
        />
