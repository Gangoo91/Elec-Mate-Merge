      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              ...
              <li className="pl-1">
                <strong>Room index:</strong> K = LW / Hm(L+W)
              </li>
              <li className="pl-1">
                <strong>UF:</strong> From tables based on K and reflectances
              </li>
              <li className="pl-1">
                <strong>MF:</strong> Typically 0.7-0.8 for clean offices
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>DIALux:</strong> Industry standard, free, 3D capable
              </li>
              <li className="pl-1">
                <strong>Relux:</strong> Alternative with similar capabilities
              </li>
              <li className="pl-1">
                <strong>IES/LDT files:</strong> Photometric data format
              </li>
              <li className="pl-1">
                <strong>Point-by-point:</strong> Grid illuminance calculation
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Step 4:</strong> Calculate room index (K) - see Section 2
                </li>
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="font-mono text-center text-xl mb-4">
                K = (L × W) / (H<sub>m</sub> × (L + W))
              </p>
              <div className="text-sm text-center">
                ...
                <p>
                  ...
                  = Mounting height above working plane (m)
                </p>
              </div>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example UF Table (Recessed LED Panel)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              due to lamp depreciation and dirt accumulation. Modern software tools like DIALux and
              Relux provide detailed point-by-point calculations that go beyond the simple lumen
              method.
            </p>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Office Lumen Method Calculation
              </h3>
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2">
                  <strong>Step 3:</strong> Room index K = (15 × 10) / (2 × (15 + 10))
                </p>
                <p>
                  K = 150 / 50 = <strong>3.0</strong>
                </p>
                <p className="mt-2">
                  <strong>Step 4:</strong> From UF table (K=3.0, reflectances 0.7/0.5/0.2):
                </p>
                <p>
                  UF = <strong>0.68</strong>
                </p>
                <p className="mt-2">
                  <strong>Step 5:</strong> Clean office, 3-year maintenance: MF ={' '}
                  <strong>0.8</strong>
                </p>
                <p className="mt-2">
                  <strong>Step 6:</strong> Apply lumen method:
                </p>
                <p>N = (E × A) / (Φ × UF × MF)</p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-amber-400">
                  ⚠ Spacing uneven - consider 6 × 7 = 42 grid instead
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Warehouse Calculation
              </h3>
              <p className="text-sm text-white mb-2">
