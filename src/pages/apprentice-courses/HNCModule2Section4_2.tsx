...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Quarter', 'Half', 'Double', 'One-eighth'],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['300 lux', '400-500 lux', '750 lux', '200 lux'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['E = I / d', 'E = I / (d × cos θ)', 'E = I × d² × cos θ', 'E = I × cos θ / d²'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['1667 lux', '556 lux', '481 lux', '642 lux'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['It decreases', 'It fluctuates randomly', 'It stays constant', 'It increases'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS EN 12464-1 is the harmonised European standard, embedded into CIBSE Lighting Guide
              recommendations. Quote it on the lighting calculation summary so the building control
              officer, BREEAM assessor and contractor are working from the same numbers as you.
            </>
          }
        ...
        >
          <p>
            ...
            required to achieve a target average illuminance across a working plane. It accounts for
            room characteristics, surface finishes, and maintenance conditions through systematic
            factors.
          </p>
          <p>
        ...
        >
          ...
          <p>
            <strong>Design tip:</strong> Dark surfaces significantly reduce UF. For dark ceilings or
            walls, expect 10-30% lower UF than standard tables suggest.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Lighting systems depreciate over time — lamps lose output, luminaires and room surfaces
            accumulate dirt. The maintenance factor (MF) accounts for this, ensuring the design
            achieves required illuminance throughout the maintenance cycle.
          </p>
          <p>
        ...
        >
          <p>
            ...
            intensity data and geometric relationships. It combines the inverse square law (distance
            effect) with the cosine law (angle of incidence effect).
          </p>
          <p>
            <strong>Point-by-Point Formula:</strong> E = (I × cos θ) / d². E = illuminance (lux), I
            = intensity towards point (cd), θ = angle to normal, d = distance (m).
          </p>
          <p>
        ...
        >
          <p>
            <strong>Example 1: Lumen Method - Office Lighting.</strong> Calculate luminaires needed
            for a 15m × 10m office requiring 400 lux maintained. Luminaires output 4000lm each.
            Ceiling height 3m, working plane 0.85m. Reflectances C70 W50 F20.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Step 1: Calculate room index. Hm = 3.0 - 0.85 = 2.15m</li>
            <li>
              RI = (15 × 10) / [2.15 × (15 + 10)] = 150 / 53.75 = <strong>2.79</strong>
            </li>
            <li>
          ...
          <p>
            ...
            intensity in the relevant direction is mounted 2.5m above a display. The display is 1.5m
            horizontally from directly below the downlight. Calculate the illuminance on the
            display.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            factor for an LED installation in a clean office. LLMF = 0.9, LSF = 1.0, LMF = 0.9, RSMF
            = 0.95.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              This means the installation will deliver 77% of initial lumens at end of maintenance
              cycle.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              You are designing the lighting for a new 12 m × 8 m primary-school classroom, mounting
              height 2.7 m, target Em = 300 lux maintained, UGR ≤ 19. The architect has selected a
              4000 K, CRI 90 LED panel rated 4,000 lm at 32 W. Reflectances: ceiling 70%, walls 50%,
              floor 20%.
            </>
          }
          whatToDo={
            <>
              Compute room index k = (12 × 8) / [2.7 × (12 + 8)] = 1.78. Look up UF from the
              photometric file at k = 1.78 and the given reflectances (typically 0.62). Set MF =
              0.80 (clean office/classroom, 3-year cleaning cycle, LED LLMF 0.92 × LMF 0.92 × RSMF ≈
              0.80). Calculate N = (300 × 96) / (4000 × 0.62 × 0.80) ≈ 14.5 — round up to 16
              luminaires arranged 4 × 4 for uniformity. Verify U₀ ≥ 0.6 with a point-by-point grid
              in DIALux.
            </>
          }
          whyItMatters={
            <>
              Schools are inspected against BS EN 12464-1 and Building Bulletin 90 (lighting for
              schools). An undersized scheme triggers a re-design after handover and a Department
              for Education non-conformity report. The lumen-method calculation is the auditable
              spine of the lighting design.
            </>
          }
        />
