    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-base text-muted-foreground mb-12">
          This section covers technologies and strategies for improving electrical energy efficiency
          in commercial buildings. You'll learn about LED lighting, power factor correction,
          harmonic mitigation, energy metering and demand management techniques.
        </p>
