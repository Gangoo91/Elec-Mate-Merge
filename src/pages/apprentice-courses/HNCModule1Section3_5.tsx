...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Monthly', 'Once a year', 'Every 6 months minimum', 'Only when new staff join'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              site-specific procedures must integrate with the building owner&rsquo;s fire strategy
              and the principal contractor&rsquo;s evacuation plan — they cannot stand alone.
            </>
          }
        ...
        <ConceptBlock title="Emergency Planning">
          <p>
            Effective emergency planning ensures everyone knows what to do when things go wrong. The
            key is to identify potential emergencies, plan responses, train personnel, and practice
            regularly so that response becomes automatic.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Roles and responsibilities:</strong> Who does what - coordinators, wardens,
              first aiders
            </li>
            <li>
            ...
            <li>
              <strong>Evacuation routes:</strong> Primary and alternative routes, assembly points
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Electrical shock</strong> — Immediate Actions: Isolate supply, safe rescue,
              call 999, first aid. Key Hazards: Secondary contact, cardiac arrest
            </li>
            <li>
              <strong>Gas leak</strong> — Immediate Actions: No ignition sources, evacuate,
              ventilate, call National Grid. Key Hazards: Explosion, asphyxiation
            </li>
            <li>
              <strong>Refrigerant leak</strong> — Immediate Actions: Evacuate plant room, ventilate,
              do not re-enter. Key Hazards: Oxygen displacement, toxicity
            </li>
            <li>
              <strong>Major water leak</strong> — Immediate Actions: Isolate water, assess
              electrical risk, evacuate if needed. Key Hazards: Electrical hazard, slip, structural
            </li>
            <li>
              <strong>Lift entrapment</strong> — Immediate Actions: Reassure occupants, call lift
              engineer, do not attempt rescue. Key Hazards: Falls, crushing, panic
            </li>
          </ul>
        ...
        <ConceptBlock title="Fire Safety and Evacuation">
          <p>
            Fire remains one of the most significant workplace hazards. The Regulatory Reform (Fire
            Safety) Order 2005 requires employers to assess fire risks and implement appropriate
            measures including detection, warning, means of escape, and firefighting equipment.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Water</strong> — Colour Band: Red (all red). Suitable For: Paper, wood,
              textiles (Class A). NOT For: Electrical, liquids, metals
            </li>
            <li>
              <strong>Foam (AFFF)</strong> — Colour Band: Cream. Suitable For: Liquids, solids
              (Class A, B). NOT For: Electrical, cooking fat
            </li>
            <li>
              <strong>Dry Powder</strong> — Colour Band: Blue. Suitable For: Multi-purpose (A, B, C,
              electrical). NOT For: Enclosed spaces (visibility)
            </li>
            <li>
              <strong>CO2</strong> — Colour Band: Black. Suitable For: Electrical, liquids (Class
              B). NOT For: Outdoor (wind dispersal)
            </li>
            <li>
              <strong>Wet Chemical</strong> — Colour Band: Yellow. Suitable For: Cooking oils and
              fats (Class F). NOT For: Electrical
            </li>
          </ul>
        ...
        <ConceptBlock title="First Aid Provision">
          <p>
            ...
            first aid equipment, facilities and personnel. What's "adequate" depends on the nature
            of work, hazards present, number of employees, and access to emergency services.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Low risk (office)</strong> — Employees: &lt;25. Minimum Provision: First aid
              kit + appointed person
            </li>
            <li>
              <strong>Low risk (office)</strong> — Employees: 25-50. Minimum Provision: First aid
              kit + EFAW or appointed person
            </li>
            <li>
              <strong>Low risk (office)</strong> — Employees: 50+. Minimum Provision: First aid kit
              + FAW (1 per 100)
            </li>
            <li>
              <strong>Higher risk (construction)</strong> — Employees: &lt;5. Minimum Provision:
              First aid kit + appointed person
            </li>
            <li>
              <strong>Higher risk (construction)</strong> — Employees: 5-50. Minimum Provision:
              First aid kit + EFAW/FAW
            </li>
            <li>
              <strong>Higher risk (construction)</strong> — Employees: 50+. Minimum Provision: First
              aid kit + FAW (1 per 50)
            </li>
          </ul>
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Consider:</strong> For electrical work, consider additional burn dressings. AED
            (defibrillator) access is recommended - cardiac arrest is a risk with electrical shock.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Electrical Emergency Response">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1</strong> — Action: Ensure safety. Key Points: Do not touch casualty if still
              in contact with live source
            </li>
            <li>
              <strong>2</strong> — Action: Isolate supply. Key Points: Switch off at source if quick
              and safe, or disconnect plug
            </li>
            <li>
              <strong>3</strong> — Action: If cannot isolate. Key Points: Use non-conductive
              material to separate casualty from source
            </li>
            <li>
              <strong>4</strong> — Action: Call 999. Key Points: State electrical incident -
              location, condition, whether isolated
            </li>
            <li>
              <strong>5</strong> — Action: Assess casualty. Key Points: Check response, breathing,
              circulation (DR ABC)
            </li>
            <li>
              <strong>6</strong> — Action: CPR if needed. Key Points: 30 compressions : 2 breaths.
              Use AED if available
            </li>
            <li>
              <strong>7</strong> — Action: Treat burns. Key Points: Cool with water 20+ mins. Cover
              loosely. Do not burst blisters
            </li>
          </ul>
          ...
          <CommonMistake
            ...
            whatHappens={
              <>
                <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
                  <li>High voltage (above 1000V AC) can arc significant distances</li>
                  <li>Do not approach within the safe distance until confirmed isolated</li>
                  <li>Call emergency services and the network operator immediately</li>
          ...
          <p className="text-sm text-white italic">
            ...
            hospital, even if they appear unharmed. Internal injuries and cardiac effects may not be
        ...
        <ConceptBlock title="Practical Application">
          <p>
            <strong>Example 1: Responding to Electrical Contact</strong>
          </p>
          <p className="text-sm text-white mb-2">
            <strong>Scenario:</strong> A colleague is found unconscious, still holding a faulty 230V
            portable tool.
          </p>
          <div className="bg-black/30 p-3 rounded text-sm text-white">
            ...
            <p className="ml-4">
              4. If cannot isolate - use non-conductive item (dry wood, plastic) to push tool away
            </p>
          ...
          <p>
            <strong>Example 2: Fire During Electrical Work</strong>
          </p>
          <p className="text-sm text-white mb-2">
            <strong>Scenario:</strong> Fire breaks out in switchroom while working on distribution
            board.
          </p>
          <div className="bg-black/30 p-3 rounded text-sm text-white">
            <p>
        ...
        <ConceptBlock title="Key Points Summary">
          <div>
            ...
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              ...
              <li>Maintain equipment - extinguishers, alarms, emergency lighting</li>
          ...
          <div>
            <p>
              <strong>Fire Safety Essentials</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <div>
            <p>
              <strong>Electrical Emergency Critical Points</strong>
            </p>
            <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              An operative receives an electric shock while working on a sub-distribution board in a
              basement plant room. They are conscious but disorientated, and the board is still
              energised.
            </>
          }
          whatToDo={
            <>
              Apply the rehearsed sequence. Do not touch the casualty until the supply is isolated
              upstream. Send a second person to call 999 and meet the ambulance. Once isolated,
              follow first-aid (DRSABCD), administer oxygen if trained, do not move the casualty
              unless still in danger. Apply RIDDOR &mdash; an electric shock causing more than
              24-hour absence is a reportable injury under Schedule 1. Preserve the scene. Engage
              the AED if cardiac arrest follows. Brief HSE the same day.
            </>
          }
          whyItMatters={
            <>
              Electrical shock victims can suffer delayed cardiac arrest hours after the event.
              Procedures must include hospital escort, follow-up monitoring and incident
              investigation, not just the immediate rescue.
            </>
          }
        />
