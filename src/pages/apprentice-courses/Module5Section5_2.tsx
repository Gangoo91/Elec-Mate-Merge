...
const TITLE =
  'Communicating with Site Supervisors and Foremen - Module 5.5.2 | Level 2 Electrical Course';
const DESCRIPTION =
  'Learn effective communication techniques with site supervisors and foremen. Essential skills for professional interaction and project success on construction sites.';
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Recording key details helps ensure instructions are followed correctly and provides reference for later questions.',
  },
  {
    id: 6,
  ...
  const faqs = [
    {
      ...
      answer:
        "Not usually — always go to your foreman/supervisor first, unless it's an emergency. This maintains proper communication chains and ensures your immediate supervisor is aware of issues.",
    },
    {
      question: 'What if my supervisor is unavailable?',
      answer:
        'Wait if possible, or pass the issue to another foreman from your team. Never guess or make assumptions about instructions — clarity is essential for safety and quality.',
    },
    {
      question: "Should I challenge instructions if I think they're unsafe?",
      answer:
        'Yes — politely raise the concern with your supervisor. If the issue remains unresolved, escalate to the Health & Safety Officer. Safety concerns should never be ignored.',
    },
    {
      question: 'How should I handle conflicting instructions from different people?',
      answer:
        'Always report conflicting instructions to your supervisor/foreman rather than trying to resolve them yourself. They have the authority and information to make the correct decision.',
    },
    {
      question: 'Is it necessary to record verbal instructions?',
      answer:
        'Yes, particularly for complex or critical tasks. Written records provide backup, prevent misunderstandings, and offer legal protection if issues arise later.',
    },
    {
      question: "What's the best way to ask for clarification without seeming incompetent?",
      answer:
        "Asking questions shows professionalism, not incompetence. Use phrases like 'Just to confirm...' or 'To ensure I understand correctly...' when seeking clarification.",
    },
    {
      question: 'How often should I update my supervisor on progress?',
      answer:
        'Follow their preferred schedule, but generally provide updates at key milestones, when problems arise, or at the end of significant work phases. Regular communication prevents surprises.',
    },
  ];
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <header className="text-center mb-12">
            ...
            <p className="text-white/70 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
              Learn effective communication techniques with site supervisors and foremen for
              professional success on construction sites.
            </p>
          </header>
          ...
          <section className="mb-10">
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-white/80 text-sm space-y-1 list-disc ml-4">
                  <li>
                    <strong>Spot:</strong> Miscommunication leading to rework, delays, or safety
                    issues.
                  </li>
                  <li>
                    <strong>Use:</strong> Confirmation techniques and proper reporting channels.
                  </li>
                  <li>
                    <strong>Check:</strong> Regular progress updates and clarification requests.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                Clear and professional communication with site supervisors and foremen is essential
                for smooth project delivery and workplace safety. As an apprentice electrician, your
                supervisors and foremen are your direct link to project management, daily work
                allocation, and critical safety information.
              </p>
              <p>
                Effective communication in the electrical trade involves more than just receiving
                instructions. It includes understanding technical drawings, confirming electrical
                specifications, reporting progress on installations, and ensuring compliance with
                safety procedures. Poor communication can result in incorrect installations, safety
                hazards, project delays, and costly rework.
              </p>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/70">
                      Effective communication with supervisors reduces project delays by up to 40%
                      and significantly improves safety outcomes through clearer understanding of
              ...
              <p>
                <strong>Real Impact:</strong> Projects with excellent supervisor-trades
                communication show 30% fewer rework incidents and improved team morale.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-white/70 text-sm">
                  <li className="flex items-start">
                    <span className="text-elec-yellow mr-2">•</span>Understand the role of
                    supervisors and foremen in communication
                  </li>
                  <li className="flex items-start">
                  ...
                  <li className="flex items-start">
                    <span className="text-elec-yellow mr-2">•</span>Know when and how to report
                    issues or progress
                  </li>
                  <li className="flex items-start">
                    <span className="text-elec-yellow mr-2">•</span>Avoid misunderstandings and
                    conflicts on site
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-white/70 text-sm">
                  <li className="flex items-start">
                    <span className="text-elec-yellow mr-2">•</span>Recognise the importance of
                    clear record-keeping and confirmation
                  </li>
                  <li className="flex items-start">
                    <span className="text-elec-yellow mr-2">•</span>Use proper channels for
                    reporting and escalation
                  </li>
                  <li className="flex items-start">
                    <span className="text-elec-yellow mr-2">•</span>Build professional relationships
                    with site supervisors
                  </li>
                  <li className="flex items-start">
                    <span className="text-elec-yellow mr-2">•</span>Maintain clear and accurate work
                    documentation
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                Supervisors and foremen are your key communication link on site. Understanding their
                role helps you communicate more effectively:
              </p>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    <strong>Communication Bridge</strong> – Act as the link between site management
                    and tradespeople, ensuring information flows clearly in both directions.
                  </li>
                  <li>
                    <strong>Task Management</strong> – Allocate tasks, check work quality, and
                    ensure deadlines are met whilst coordinating between different trades.
                  </li>
                  <li>
                    <strong>Safety Leadership</strong> – Provide safety guidance, enforce site
                    rules, conduct toolbox talks, and ensure compliance with health and safety
                    regulations.
                  </li>
                  <li>
                    <strong>Quality Control</strong> – Monitor work standards, conduct inspections,
                    and ensure all work meets specifications and regulations.
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <p className="text-sm text-white/70">
                  <strong>Why This Matters:</strong> Supervisors and foremen have the authority to
                  make decisions about your work and are accountable for the outcomes. Building good
                  communication with them directly impacts your daily work experience and career
                  development.
                </p>
              </div>
            </div>
          ...
          <section className="mb-10 mt-8">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    <strong>Speak clearly and respectfully</strong> – Use appropriate volume and
                    pace, avoid mumbling or speaking too quickly.
                  </li>
                  <li>
                    <strong>Use site-appropriate terminology</strong> – Use technical terms
                    correctly but avoid unnecessary jargon that might confuse.
                  </li>
                  <li>
                    <strong>Confirm instructions back</strong> – Example: "Just to confirm, you want
                    me to run the conduit along the east wall and terminate at the DB?"
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm text-white/70 space-y-2">
                  <li>
                    <strong>Maintain appropriate eye contact</strong> – Shows attention and respect
                    without being intimidating.
                  </li>
                  <li>
                    <strong>Use positive body language</strong> – Stand or sit upright, face the
                    speaker, avoid crossed arms or defensive postures.
                  </li>
                  <li>
                    <strong>Show active listening</strong> – Nod appropriately, ask relevant
                    questions, avoid distractions like phones.
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
                ...
                <p className="text-sm text-white/70 italic">
                  "Good morning, John. I've finished the first fix in the office area. Before I
                  start the second fix, could you confirm which circuits need RCD protection? I want
                  to make sure I understand the specification correctly."
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10 mt-8">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <p className="text-sm text-white/70">
                  Misunderstandings between trades leading to conflicts, delays, and tension on
                  site. These often arise from unclear communication about workspace sharing,
                  installation sequences, or responsibilities.
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-white/80 mb-3">
                    <strong>The Situation:</strong> On a refurbishment project, an apprentice
                    misheard the instruction to "terminate at DB2" and instead wired into DB1.
                  </p>
                  <p className="text-white/80 mb-3">
                    <strong>The Result:</strong> The mistake caused two days' delay and extra cost
                    for rewiring and testing.
                  </p>
                  <p className="text-white/80">
                    <strong>The Lesson:</strong> If the apprentice had repeated back the instruction
                    to the supervisor, the issue would have been avoided. A simple "Just to confirm,
                    you want me to terminate at DB2, not DB1?" would have prevented the costly
                    mistake.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                <h3 className="font-semibold text-white mb-2">
                  Q: Can I go directly to the site manager with a question?
                </h3>
                <p className="text-sm text-white/70">
                  A: Not usually — always go to your foreman/supervisor first, unless it's an
                  emergency situation that requires immediate senior management attention.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                <h3 className="font-semibold text-white mb-2">
                  Q: What if my supervisor is unavailable?
                </h3>
                <p className="text-sm text-white/70">
                  A: Wait if possible, or pass the issue to another foreman from your team. Never
                  guess or make assumptions about what should be done.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-red-500/50">
                <h3 className="font-semibold text-white mb-2">
                  Q: Should I challenge instructions if I think they're unsafe?
                </h3>
                <p className="text-sm text-white/70">
                  A: Yes — politely raise the safety concern, and if it remains unresolved, escalate
                  to the Health & Safety Officer. Safety always takes priority.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <div className="flex items-start gap-3">
                ...
                <p className="text-white/80">
                  You've learned how to communicate clearly and effectively with supervisors and
                  foremen, why it matters, and how to avoid common mistakes. Good communication
                  reduces errors, improves safety, and keeps projects running smoothly while
