...
const quizQuestions = [
  {
    ...
    options: ['At least 50%', 'At least 90%', 'At least 70%', '100% mandatory'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['DALI', 'DMX512', 'Modbus RTU/TCP', '1-Wire'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['24 readings', '48 readings', '144 readings', '96 readings'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['400/1', '2000/5', '400/5', '80/1'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Part L 2021 metering provisions are stricter than 2013. Every meaningful end-use needs
              a sub-meter; the 90% allocation rule means no large unmetered loads. Smart Meter
              (SMETS2) requirement for utility-billed meters separately mandates remote reading.
              CIBSE TM39 is the practical reference for designing the metering strategy.
            </>
          }
        ...
        <ConceptBlock title="Metering Hierarchy and Strategy">
          <p>
            ...
            visibility of consumption at multiple levels throughout a building. CIBSE TM39 provides
            comprehensive guidance on metering strategy development, recommending that at least 90%
            of total building energy consumption should be captured by sub-metering.
          </p>
          <p>
            <strong>Metering hierarchy levels:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Level 1 (Fiscal):</strong> Main utility meters at building intake - used for
              billing
            </li>
            <li>
              <strong>Level 2 (Sub-main):</strong> Distribution board level meters - major systems
              or zones
            </li>
            <li>
            ...
            <li>
              <strong>Level 4 (Equipment):</strong> Individual plant items - chillers, AHUs, lifts
            </li>
          </ul>
          <p>
            <strong>Typical Metering Hierarchy Structure</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Level 1:</strong> Main intake room — Utility billing — Fiscal CT meter (Class
              0.5)
            </li>
            <li>
              <strong>Level 2:</strong> MSB outgoing ways — System/zone allocation — CT meter (Class
              1.0)
            </li>
            <li>
              <strong>Level 3:</strong> Floor/tenant DBs — Tenant recharging — MID approved meter
            </li>
            <li>
              <strong>Level 4:</strong> Plant equipment — Equipment monitoring — Direct connect/CT
              meter
            </li>
          </ul>
          <p>
            <strong>CIBSE TM39 Metering Guidance</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Main Metering and Sub-Metering">
          ...
          <p>
            <strong>Main (Fiscal) Metering</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Sub-Metering Strategies</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>By tenant:</strong> Multi-tenant buildings — Fair cost allocation — MID
              approval for recharging
            </li>
            <li>
              <strong>By system:</strong> Single occupancy — Identifies energy use by end use —
              Requires careful categorisation
            </li>
            <li>
              <strong>By zone/floor:</strong> Large floor plate buildings — Location-based analysis
              — May not align with systems
            </li>
            <li>
              <strong>Hybrid:</strong> Complex buildings — Flexible analysis options — More meters,
              higher cost
            </li>
          </ul>
          <p>
            <strong>CIBSE TM39 Recommended Sub-Metering Categories</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>HVAC:</strong> Chillers, boilers, pumps, fans, FCUs, splits (separately where
              practical)
            </li>
            <li>
        ...
        <ConceptBlock title="Automatic Meter Reading and Data Loggers">
          ...
          <p>
            <strong>AMR System Components</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Meters:</strong> Energy meters with communication interfaces
            </li>
            <li>
              <strong>Communications:</strong> Modbus, M-Bus, BACnet, pulse outputs
            </li>
            <li>
              <strong>Data concentrator:</strong> Collects data from multiple meters
            </li>
            <li>
              <strong>Software:</strong> Energy monitoring and analysis platform
            </li>
            <li>
              <strong>Network:</strong> Wired (RS485, Ethernet) or wireless (LoRa, GSM)
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Modbus RTU:</strong> RS485 (2-wire) — Industrial metering — 1200m
            </li>
            <li>
              <strong>Modbus TCP:</strong> Ethernet — BMS integration — 100m per segment
            </li>
            <li>
              <strong>M-Bus:</strong> 2-wire bus — Utility metering — 1000m
            </li>
            <li>
              <strong>BACnet MS/TP:</strong> RS485 — BMS integration — 1200m
            </li>
            <li>
              <strong>Pulse output:</strong> Volt-free contact — Simple counting — Application
              dependent
            </li>
          </ul>
          <p>
            <strong>Pulse Counting</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Data Logging Intervals</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Data Logger Functions</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Interval recording:</strong> Store readings at defined intervals (typically
              15-30 minutes)
            </li>
            <li>
            ...
            <li>
              <strong>Alarm logging:</strong> Record over/under voltage, power factor trips, demand
              limits
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="CT Metering and Accuracy Classes">
          ...
          <p>
            <strong>CT Selection Criteria</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Primary current:</strong> 125% of design current — 400A circuit → 500/5 CT
            </li>
            <li>
              <strong>Secondary current:</strong> 5A standard, 1A for long runs — 5A typical, 1A if
              &gt;30m cable
            </li>
            <li>
              <strong>Accuracy class:</strong> Match meter requirements — Class 0.5 for fiscal,
              Class 1 for sub
            </li>
            <li>
              <strong>Burden (VA):</strong> Meter VA + cable losses — 5VA meter + 2VA cable = 7.5VA
              CT
            </li>
            <li>
              <strong>Window size:</strong> Accommodate conductor/busbar — Split-core for retrofit
            </li>
          </ul>
          <p>
            <strong>Meter Accuracy Classes (IEC 62053)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Class 0.2S:</strong> ±0.2% — Revenue metering, high-value loads
            </li>
            <li>
              <strong>Class 0.5S:</strong> ±0.5% — Fiscal metering, check metering
            </li>
            <li>
              <strong>Class 1:</strong> ±1.0% — Commercial sub-metering
            </li>
            <li>
              <strong>Class 2:</strong> ±2.0% — Domestic, monitoring only
            </li>
          </ul>
          <p>
            <strong>CT Installation Best Practice</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Orientation:</strong> Install CTs with correct polarity (P1/K marking towards
              supply)
            </li>
            <li>
          ...
          <p>
            <strong>Multi-Function Meter Parameters</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Commissioning requirement:</strong> Verify CT ratios are correctly programmed in
            meters - incorrect ratios are a common cause of metering errors.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Design metering hierarchy for a 6-storey office building with
            ground floor retail and basement car park.
          </p>
          ...
          <p>
            <strong>Scenario:</strong> Select CTs for a 630A submain feeding a distribution board
            25m from the meter location.
          </p>
          <p>Given:</p>
          ...
          <p>
            Select standard size: <span>800/5 CT</span>
          </p>
          <p>Secondary Cable Calculation (2.5mm² twin):</p>
          <p>Resistance: 7.41 mΩ/m × 25m × 2 = 0.37Ω</p>
          <p>
            Power loss at 5A: I²R = 25 × 0.37 = 9.25W = <span>9.25VA</span>
          </p>
          ...
          <p>Total: 12.25VA</p>
          <p>
            Select CT burden: <span>15VA Class 1.0</span>
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Insufficient sub-metering:</strong> Cannot identify consumption patterns or
                apportion costs
              </li>
              <li>
                <strong>No reconciliation:</strong> Sub-meter totals not verified against main meter
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A multi-tenanted office building bills electricity by floor based on a single
              sub-meter per floor. A tenant on the second floor disputes a £45k annual bill,
              claiming their actual occupancy is 30% lower than the previous tenant. There is no
              sub-metering by tenancy within the floor — billing is allocated by lettable area.
            </>
          }
          whatToDo={
            <>
              Three-stage response: (1) immediately install temporary sub-metering at the tenant's
              distribution boards to measure actual consumption — this resolves the dispute; (2)
              plan permanent retrofit of tenant-level sub-metering, ideally with auto-billing
              software (e.g. NES, Coherent Research); (3) update the lease for new tenants to
              require tenant-level sub-metering and pay-as-used billing rather than apportioned.
              Long-term, this is also a Heat Network (Metering and Billing) Regulations 2014 issue
              if heat is included — separate metering may be a legal requirement, not a commercial
              choice.
            </>
          }
          whyItMatters={
            <>
              Sub-metering pays for itself the moment a tenant challenges a bill — and it pays again
              every time the FM team can identify a high-consumption tenant or end-use.
              Underspecification at design stage forces disruptive retrofit. The metering strategy
              is more important than most M&E equipment choices because it determines what you can
              manage in operation.
            </>
          }
        />
