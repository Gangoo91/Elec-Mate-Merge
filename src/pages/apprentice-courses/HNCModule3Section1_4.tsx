...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['10 ohms', '50 ohms', '12 ohms', '25 ohms'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1.25mm squared', '2.5mm squared', '3.75mm squared', '5mm squared'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              On a parallel-fed distribution board the design current at any point is the sum of the
              branch currents at that node — derived directly from the parallel-circuit
              current-divider analysis. Get the parallel arithmetic right and the Iᵇ ≤ Iₙ ≤ I_z
              chain holds for every device in the board.
            </>
          }
        ...
        <ConceptBlock title="Parallel Circuit Fundamentals">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>
                RT &lt; R<sub>smallest</sub>
              </strong>{' '}
              — Total R is LESS than the smallest
            </li>
          </ul>
        ...
        <ConceptBlock title="Calculating Total Resistance">
          <p>
            Calculating equivalent resistance is essential for determining circuit current and power
            consumption. There are two main methods depending on the number of resistors.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">
            Method 1: Reciprocal Formula (Any Number)
          </p>
          <p>
            <strong>1/RT = 1/R1 + 1/R2 + 1/R3 + ...</strong> Calculate the sum of reciprocals, then
          ...
          <p>
            <strong>RT = (R1 x R2) / (R1 + R2)</strong> — Quick method for two resistors: multiply
            then divide by sum.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              RT = (40 x 60) / (40 + 60) = 2400 / 100 = <strong>24 ohms</strong>
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
        ...
        <ConceptBlock title="Current Divider Rule">
          <p>
            ...
            Understanding this is crucial for load balancing and cable sizing in distribution
            systems.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <p>
            <strong>I1 = IT x (R2 / (R1 + R2))</strong> — Note: Current through R1 uses R2 in the
            numerator (opposite to voltage divider).
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            ...
            directly: <strong>I1 = V / R1 and I2 = V / R2</strong>. This is often easier when you
            know the supply voltage.
          </p>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              I1 = V/R1 = 180/20 = <strong>9A</strong>; I2 = V/R2 = 180/30 = <strong>6A</strong>
            </li>
          </ul>
          <p className="text-sm text-elec-yellow/70">
        ...
        <ConceptBlock title="Application 2: Ring Final Circuit">
          <p>
            A ring final provides two parallel cable paths to each socket, effectively doubling the
            cable capacity and reducing voltage drop.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>If broken to radial:</strong> V = 32A x (50m x 0.00741) x 2 = 23.7V (10.3% -
              fails!)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Heaters in parallel, currents add: IT = 8.7 + 8.7 + 8.7 = <strong>26.1A</strong>
            </li>
          ...
          <p>
            <strong>Question:</strong> Two 35mm squared cables (R = 0.524 milliohms/m) run 80m in
            parallel to supply a sub-board. Calculate the combined resistance and voltage drop at
            100A.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Single cable resistance (go + return): R = 80m x 2 x 0.524 milliohms = 83.8 milliohms
              = 0.0838 ohms
            </li>
            <li>
              Parallel cables: RT = 0.0838/2 = <strong>0.0419 ohms</strong>
            </li>
            ...
            <li>
              Percentage: (4.19/230) x 100 = <strong>1.82%</strong> ✓ within 5% limit
            </li>
          </ul>
          ...
          <p>
            ...
            decorative pendants (40W each), and 1 feature wall light (60W). Calculate total current
            and verify 6A MCB is adequate.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              All loads in parallel, currents add: IT = 0.26 + 0.35 + 0.26 = <strong>0.87A</strong>
            </li>
            <li>
              Total power: PT = 60 + 80 + 60 = <strong>200W</strong>
            </li>
            <li>
              0.87A is well within 6A MCB capacity. Could add many more luminaires within rating
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Adding resistances directly (that's series). Forgetting to take the reciprocal at the
              end of the 1/RT calculation. Current-divider confusion: I1 uses R2 in the numerator,
              not R1. Expecting RT to be greater than the smallest resistor (it's always less in
              parallel).
            </>
          }
          doInstead={
            <>
              Use the reciprocal sum, then invert. For two resistors use product/sum. For identical
              use R/n. Cross-check by computing branch currents from V/R and adding — they must
              equal IT.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              MCB-protected sub-board: 5 A, 4 A, 6 A and 3 A under design conditions. You need to
              choose the upstream device for the sub-board incoming feed.
            </>
          }
          whatToDo={
            <>
              Apply the parallel-current rule: I_T = I₁ + I₂ + I₃ + I₄ = 5 + 4 + 6 + 3 = 18 A. Pick
              the next standard device above 18 A — a 20 A Type B MCB — and check the upstream cable
              I_z is at least 20 A under installation method, ambient and grouping factors. Confirm
              voltage drop on the longest branch using mV/A/m × length × I_b. Allow diversity per
              the IET On-Site Guide Appendix A if all four circuits are not switched on
              simultaneously.
            </>
          }
          whyItMatters={
            <>
              ...
              under-sized incomer will nuisance-trip on a Monday morning when every desk lamp comes
              on.
            </>
          }
        />
