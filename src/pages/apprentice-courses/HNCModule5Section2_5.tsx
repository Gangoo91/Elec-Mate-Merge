    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              For public-sector tenders above OJEU/UK threshold, equal treatment, transparency and
              proportionality are legal duties. Even on private tenders, applying the same
              principles produces better outcomes and defensible decisions. A challenged tender on a
              public job can be set aside — embed compliance from invitation.
            </>
          }
        ...
        <ConceptBlock title="Invitation to Tender (ITT)">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Instructions to tenderers:</strong> Submission requirements, deadline, format,
              and process
            </li>
            <li>
        ...
        <ConceptBlock title="Bid Preparation and Pricing Strategies">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Front-loaded:</strong> Higher prices in early activities — Improved cash flow,
              scrutinised by clients
            </li>
            <li>
          ...
          <p>
            ...
            containment installation to improve cash flow but keeps rates within 15% of market norms
            to avoid rejection. Risk allowance of 2% is included for design development.
          </p>
          <p>
        ...
        <ConceptBlock title="Tender Evaluation and Interviews">
          ...
          <p>
            <strong>
              Typical Evaluation Criteria and Weightings (Criterion — Typical Weight — Assessment
              Areas):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Negotiation and Contract Award">
          <p>
            ...
            contract award. Understanding this process and the legal framework ensures smooth
            transition from tender to contract.
          </p>
          <p>
          ...
          <p>
            ...
            contract is finalised. The LOI specifies: ordering of distribution boards (8-week lead),
            detailed coordination drawings, and attendance at two design meetings. The contractor
            mobilises but limits exposure to the LOI cap until formal contract execution three weeks
            later.
          </p>
          <p>
            <strong>Legal principle:</strong> Never exceed the LOI cap value. If the contract fails
            to materialise, recovering costs beyond the cap is extremely difficult.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — MEAT Score Calculation:</strong> Calculate the total MEAT score for
            Contractor A. Evaluation weighting: Quality 60%, Price 40%. Quality score: 72/100.
          ...
          <p>
            <strong>Example 2 — Tender Pricing Build-Up:</strong> An electrical contractor prices a
            data centre installation. Direct costs total £3.2M. Calculate the tender price using
            standard mark-ups.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Generic responses:</strong> Tailor every submission to the specific project
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You are running a tender for a £4m hospital MEP package. After scoring, the
              second-placed bidder is £200k cheaper but scored lower on technical quality. The
              client suggests calling the second-placed bidder to "see if they can match" the
              technical quality. You agree and have a private call.
            </>
          }
          whatToDo={
            <>
              Stop. Bilateral negotiation in a competitive tender, especially on public-sector work,
              is a serious procurement breach. If you want to renegotiate, either go back to all
              bidders with revised requirements (effectively re-tendering) or award against the
              published criteria. Document the rationale for the award using the original scoring.
              If you genuinely need to reopen scope, do so transparently with all bidders. Never
              have a private call with one bidder during evaluation.
            </>
          }
          whyItMatters={
            <>
              Tender fairness is both legal compliance (public sector) and best practice (private
              sector). A challenged tender can be set aside, costing months of programme. The
              discipline of a clean process protects both client and bidders, and leads to award
              decisions you can defend at audit.
            </>
          }
        />
