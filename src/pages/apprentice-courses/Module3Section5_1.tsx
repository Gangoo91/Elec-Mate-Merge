...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'In the BS 7671 water classification, what does AD4 indicate?',
    options: [
      'No significant presence of water',
      'Sprays of water (from any direction)',
      'Splashes of water only',
      'Total immersion in water',
    ],
    correctAnswer: 1,
    explanation:
      'In the AD series, AD3 is splashes and AD4 is sprays of water from any direction, common in some outdoor and washdown areas.',
  },
  {
    id: 3,
    question:
      'Which statement about external influence classifications is correct?',
    options: [
      'Every installation has at least one external influence classification',
      'Only outdoor installations need to be classified',
      'Classifications are optional for domestic work',
      'Only the supply company assigns classifications',
    ],
    correctAnswer: 0,
    explanation:
      "Even a 'normal' environment has influence ratings, such as AD1 (no significant presence of water), so every installation is classified.",
  },
  {
    id: 4,
    question: 'Which of these is an example of a utilisation-related (B category) influence?',
    options: [
  ...
  {
    id: 5,
    question: 'Which BS 7671 external influence category covers corrosive or polluting substances?',
    options: [
      'AD (presence of water)',
      'AF (corrosive substances)',
  ...
  {
    id: 6,
    question: 'Why should external influence codes be documented?',
    options: [
      'To replace the need for inspection and testing',
  ...
  {
    id: 8,
    question: "Which of these is an example of a 'construction of premises' (C category) influence?",
    options: [
