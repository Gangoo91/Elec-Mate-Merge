...
const DESCRIPTION =
  'Master true power, reactive power, apparent power and power factor for City & Guilds electrical science Level 3.';

const quickCheckQuestions = [
  {
    id: 'qc1',
    question:
      'A circuit draws 2 kW true power and 1.5 kVAr reactive power. What is the apparent power?',
    options: ['2.5 kVA', '3.5 kVA', '2.0 kVA', '0.5 kVA'],
    correctIndex: 0,
    explanation:
      'S = sqrt(P squared + Q squared) = sqrt(2 squared + 1.5 squared) = sqrt(4 + 2.25) = sqrt(6.25) = 2.5 kVA.',
  },
  {
    id: 'qc2',
    ...
    correctIndex: 3,
    explanation:
      'In a purely resistive circuit, current and voltage are in phase (0 degree phase angle), so power factor = cos(0) = 1.0.',
  },
  {
    id: 'qc3',
    question:
      'A motor has apparent power of 10 kVA and power factor of 0.8. What is the true power?',
    options: ['12.5 kW', '8 kW', '6 kW', '10 kW'],
    correctIndex: 1,
    explanation:
      'P = S times pf = 10 times 0.8 = 8 kW. True power is apparent power multiplied by power factor.',
  },
  {
    id: 'qc4',
    ...
    correctIndex: 2,
    explanation:
      'Inductive circuits cause current to lag voltage, producing lagging VAr. Capacitive circuits produce leading VAr.',
  },
];
...
const quizQuestions = [
  {
    ...
    explanation:
      'True power (P) measured in watts is the actual power consumed by resistive elements and converted to heat or work.',
  },
  {
    id: 'q2',
    ...
    explanation:
      'Reactive components (inductors and capacitors) store and return energy each cycle, creating reactive power without consuming energy.',
  },
  {
    id: 'q3',
    question:
      'A single-phase motor draws 15 A at 230 V with power factor 0.75. What is the true power?',
  ...
  },
  {
    ...
    explanation:
      'The power triangle shows the relationship between P (true), Q (reactive), and S (apparent) power using Pythagoras.',
  },
  {
    id: 'q5',
    ...
    explanation:
      'Capacitors provide leading VAr to cancel the lagging VAr from inductive loads, improving power factor.',
  },
  {
    id: 'q6',
    question:
      'If a circuit has power factor 0.6 lagging, the phase angle between voltage and current is approximately:',
    options: ['36.87 degrees', '53.13 degrees', '60 degrees', '30 degrees'],
    correctAnswer: '53.13 degrees',
    explanation:
      'Phase angle = arccos(0.6) = 53.13 degrees. The current lags voltage by this angle in an inductive circuit.',
  },
  {
    id: 'q7',
    question:
      'A 3-phase motor draws 50 A per phase at 400 V line voltage with pf 0.85. What is the true power?',
    options: ['29.4 kW', '34.6 kW', '17 kW', '58.9 kW'],
    correctAnswer: '29.4 kW',
    explanation:
      'For 3-phase: P = sqrt(3) times V_L times I times pf = 1.732 times 400 times 50 times 0.85 = 29.4 kW.',
  },
  {
    id: 'q8',
    ...
    explanation:
      'The power triangle gives S squared = P squared + Q squared, or kVA squared = kW squared + kVAr squared.',
  },
  {
    id: 'q9',
    ...
    explanation:
      'Lagging power factor means current lags voltage, which occurs in inductive loads like motors and transformers.',
  },
  {
    id: 'q10',
    ...
    options: [
      'Uses more energy',
      'Requires higher current for same power',
      'Causes voltage rise',
      'Reduces frequency',
    ],
    correctAnswer: 'Requires higher current for same power',
    explanation:
      'Low pf means higher current for the same true power, requiring larger cables and transformers without delivering more useful power.',
  },
  {
    id: 'q11',
    question:
      'A factory has 200 kW load at 0.7 pf. To correct to 0.95 pf, the required kVAr correction is approximately:',
    options: ['102 kVAr', '152 kVAr', '204 kVAr', '50 kVAr'],
    correctAnswer: '102 kVAr',
    explanation:
      'Initial Q1 = P times tan(arccos(0.7)) = 200 times 1.02 = 204 kVAr. Final Q2 = 200 times tan(arccos(0.95)) = 200 times 0.33 = 66 kVAr. Correction = 204 minus 66 = 138 kVAr approximately 102 kVAr with standard capacitor values.',
  },
  {
    id: 'q12',
    ...
    explanation:
      'A pure capacitor stores and returns all energy each cycle (no real power consumed), so pf = 0, and current leads voltage hence leading.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Power factor affects cable sizing, transformer capacity, and electricity costs. Low power factor means higher currents for the same useful power, requiring larger cables and causing more losses. Many commercial tariffs include power factor penalties below 0.9. BS 7671 requires consideration of power factor for maximum demand calculations.',
  },
  {
    question: 'How do capacitors improve power factor?',
    answer:
      'Capacitors provide leading reactive power (kVAr) that cancels the lagging reactive power from inductive loads. This reduces the total reactive power, improving power factor. Capacitors are installed in parallel with loads and sized to achieve the target power factor, typically 0.95 or above.',
  },
  {
    question: 'What is reactive power and why doesnt it do useful work?',
    answer:
      'Reactive power represents energy stored in magnetic fields (inductors) or electric fields (capacitors) each quarter cycle, then returned to the supply. While it flows back and forth, no net energy is transferred. However, it still requires current flow, loading cables and transformers without doing useful work.',
  },
  {
    question: 'How do I calculate power factor from voltage and current readings?',
    answer:
      'Measure true power with a wattmeter (P in watts), and calculate apparent power from V times I (S in VA). Power factor equals P divided by S. Alternatively, measure phase angle with a phase meter and calculate pf equals cos(phase angle). Most modern power analysers display power factor directly.',
  },
  {
              ...
              <div>
                ...
                <ul className="space-y-2 text-white/80">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Distinguish between true, reactive and apparent power in AC circuits
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 shrink-0" />
                    <span>
                      Calculate power factor and understand its significance for electrical
                      installations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 shrink-0" />
                    <span>
                      Apply the power triangle to solve single-phase and three-phase power problems
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 shrink-0" />
                    <span>
                      Design power factor correction using capacitors for industrial installations
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-white/80 leading-relaxed">
              ...
              for electrical design and calculating maximum demand.
            </p>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-amber-500/10 rounded-lg border border-amber-500/20">
                    ...
                    <code className="text-amber-300 text-lg">
                  ...
                  <div className="p-4 bg-purple-500/10 rounded-lg border border-purple-500/20">
                    ...
                    <code className="text-purple-300 text-lg">
                      S = V x I = sqrt(P squared + Q squared)
                    </code>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="space-y-4">
                  <div className="bg-gradient-to-r from-purple-500/10 to-transparent p-4 rounded-lg border-l-4 border-purple-500">
                    <p className="text-white font-medium mb-3">
                      Key Formulae from the Power Triangle:
                    </p>
                  ...
                  <div className="p-4 bg-white/5 rounded-lg">
                    ...
                    <div className="space-y-2 text-sm font-mono">
                      ...
                      <p className="text-green-400 mt-2">
                        Check: sqrt(5 squared + 3.75 squared) = sqrt(25 + 14.0625) = 6.25 kVA
                        Correct
                      </p>
                    </div>
                  </div>
          ...
          <section className="mb-12">
            ...
            <Card className="bg-white/5 border-white/10 my-6">
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold text-white mb-4">
                  Calculating Correction Capacitors
                </h3>
                ...
                <div className="p-4 bg-white/5 rounded-lg">
                  ...
                  <div className="space-y-2 text-sm font-mono">
                    ...
                    <p className="text-green-400 mt-2">
                      Install 100 kVAr or 110 kVAr capacitor bank (standard sizes)
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <ul className="text-white/80 text-sm space-y-2">
                      ...
                      <li>
                        <strong>Harmonics:</strong> Non-linear loads can cause capacitor overheating
                        - use detuned reactors
                      </li>
                      <li>
                        <strong>Switching transients:</strong> Large capacitor banks need contactors
                        rated for capacitive switching
                      </li>
                      <li>
                        <strong>Discharge time:</strong> Capacitors retain charge - allow discharge
                        before reconnection
                      </li>
                    </ul>
                  </div>
