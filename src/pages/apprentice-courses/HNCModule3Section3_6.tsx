...
const quickCheckQuestions = [
  {
    ...
    options: ['P = VI', 'P = VI sin φ', 'P = VI cos φ', 'P = V/I'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Watts (W)', 'Volt-Amperes (VA)', 'Joules (J)', 'Volt-Amperes reactive (VAr)'],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['P = VL × IL', 'P = √3 × VL × IL × cos φ', 'P = √3 × VL × IL', 'P = 3 × VP × IP'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['4.06kW', '2.55kW', '2.93kW', '3.45kW'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['20kVAr', '40kVAr', '80kVAr', '60kVAr'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['15.6kW', '17.3kW', '10.4kW', '13.9kW'],
    correctAnswer: 0,
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS 7671 311.1 forces you to declare maximum demand &mdash; in kVA, not kW &mdash;
              because that is the figure the DNO sizes the supply on, and the figure the
              busbar/switchgear must carry. As a BSE designer you take connected kW, apply CIBSE
              Guide F diversity, divide by the assumed pf (0.85 typical for office, 0.9 for
              residential, 0.78 for refrigeration), and present the kVA on your DNO supply
              application.
            </>
          }
        ...
        <ConceptBlock title="True (Active) Power - P">
          ...
          <p>
            <strong>True Power Formulae:</strong> Single-phase: P = V × I × cos φ. Three-phase: P =
            √3 × VL × IL × cos φ.
          </p>
        ...
        <ConceptBlock title="Reactive Power - Q">
          <p>
            ...
            capacitors store energy in electric fields - both returning this energy to the supply
            each cycle.
          </p>
          <p>
            <strong>Reactive Power Formula:</strong> Single-phase: Q = V × I × sin φ. Three-phase: Q
            = √3 × VL × IL × sin φ.
          </p>
        ...
        <ConceptBlock title="Apparent Power - S">
          ...
          <p>
            <strong>Apparent Power Formula:</strong> Single-phase: S = V × I. Three-phase: S = √3 ×
            VL × IL.
          </p>
          <p>
            <strong>The Power Triangle Relationship:</strong> S² = P² + Q²; equivalently S = √(P² +
            Q²). Apparent power is the vector sum of true and reactive power.
          </p>
          ...
          <p>
            <strong>Design tip:</strong> When specifying a generator for a building with pf = 0.8, a
            100kVA generator can only deliver 80kW of true power to the load.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Power Measurement with Wattmeters">
          <p>
            ...
            automatically accounting for the phase angle. Modern digital power analysers extend this
            to provide comprehensive power quality data.
          </p>
          <p>
            <strong>Wattmeter Operating Principle:</strong> An electrodynamic wattmeter contains a
            current coil (in series with load) and a voltage coil (in parallel with load). The
            torque produced is proportional to the instantaneous product of V and I, giving a
            deflection proportional to average (true) power. Reading = (1/T) × ∫ v(t) × i(t) dt = V
            × I × cos φ = P.
          </p>
          ...
          <p>
            ...
            Power Factor: tan φ = √3 × (W1 - W2) / (W1 + W2). Note: One reading may be negative at
            low power factors.
          </p>
          <p>
        ...
        <ConceptBlock title="Single-Phase vs Three-Phase Power">
          <p>
            ...
            essential for correctly sizing equipment and calculating loads in building services
            installations.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              True (P) — Single-phase: P = V × I × cos φ — Three-phase: P = √3 × VL × IL × cos φ
            </li>
            <li>
              Reactive (Q) — Single-phase: Q = V × I × sin φ — Three-phase: Q = √3 × VL × IL × sin φ
            </li>
            <li>
              Current — Single-phase: I = P / (V × cos φ) — Three-phase: I = P / (√3 × VL × cos φ)
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Why √3 in Three-Phase Formulae?</strong> In a three-phase system, line voltage
            (400V) is √3 times phase voltage (230V). The √3 factor (1.732) converts between line and
            phase values. For balanced loads, total power equals 3 × phase power, but using line
            values: P = √3 × VL × IL × cos φ.
          </p>
          <p>
        ...
        <ConceptBlock title="kWh vs kVAh Billing">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>kWh (kilowatt-hours):</strong> True energy = P × t (billed to all customers)
            </li>
            <li>
              <strong>kVArh (kilovolt-ampere reactive hours):</strong> Reactive energy = Q × t
            </li>
            <li>
              <strong>kVAh (kilovolt-ampere hours):</strong> Total energy = S × t = √(kWh² + kVArh²)
            </li>
            <li>
          ...
          <p>
            <strong>Worked Example: Annual Energy Cost Impact of Power Factor.</strong> Site: 500kW
            average load, 8760 hours/year. At pf = 0.75: kVA = 500 / 0.75 = 667 kVA; Reactive =
            √(667² - 500²) = 441 kVAr; kVArh = 441 × 8760 = 3,863,160 kVArh. At pf = 0.95: kVA = 500
            / 0.95 = 526 kVA; Reactive = √(526² - 500²) = 164 kVAr; kVArh = 164 × 8760 = 1,436,640
            kVArh. Savings: 2,426,520 kVArh @ 0.5p = £12,133/year.
          </p>
          <p>
        ...
        <ConceptBlock title="Building Services: DNO Charges and Power Monitoring">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Power factor below 0.9 — Trigger: kVArh exceeds 0.484 × kWh — Typical Charge: 0.3-0.8p
              per excess kVArh
            </li>
            <li>
              Maximum demand — Trigger: Peak kVA in billing period — Typical Charge: £2-5 per kVA
              per month
            </li>
            <li>
              Excess capacity — Trigger: Demand exceeds agreed supply — Typical Charge: Penalty
              rates apply
            </li>
          </ul>
          ...
          <p>
            <strong>Best practice:</strong> Install power monitoring at main incomer as minimum. For
            buildings over 1MVA, sub-metering by floor or tenant enables accurate cost allocation
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1: Single-Phase Power Calculation.</strong> A single-phase motor draws
            8.5A at 230V with a power factor of 0.82. Calculate P, Q, and S.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              Reactive power: Q = S × sin φ = 1955 × 0.572 = <strong>1118 VAr = 1.12 kVAr</strong>
            </li>
            <li>Check: S² = P² + Q² → 1955² = 1603² + 1118²</li>
          </ul>
          <p>
            <strong>Example 2: Three-Phase Load Current.</strong> An AHU has a 22kW motor with power
            factor 0.88 on 400V three-phase. What current does it draw?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>Using: P = √3 × VL × IL × cos φ</li>
            <li>Rearranging: IL = P / (√3 × VL × cos φ)</li>
            <li>
              IL = 22000 / (1.732 × 400 × 0.88) = 22000 / 609.7 = <strong>36.1A per phase</strong>
            </li>
            <li>Select 40A protective device and appropriate cable</li>
          </ul>
          <p>
            <strong>Example 3: Power Factor from Two Wattmeters.</strong> Two-wattmeter method gives
            W1 = 45kW and W2 = 25kW. Find total power and power factor.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Total power: P = W1 + W2 = 45 + 25 = <strong>70 kW</strong>
            </li>
            <li>
              tan φ = √3 × (W1 - W2) / (W1 + W2) = 1.732 × (45 - 25) / (45 + 25) = 1.732 × 20 / 70 =
              0.495
            </li>
            <li>
              φ = arctan(0.495) = 26.3°; cos φ = cos(26.3°) = <strong>0.896 ≈ 0.90</strong>
            </li>
          </ul>
          <p>
            <strong>Example 4: Capacitor Sizing for PFC.</strong> A 150kW load at pf = 0.75 needs
            correction to pf = 0.95. What capacitor kVAr is required?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              At pf = 0.75: φ₁ = arccos(0.75) = 41.4°, tan φ₁ = 0.882; Q₁ = P × tan φ₁ = 150 × 0.882
              = 132.3 kVAr
            </li>
            <li>
              At pf = 0.95: φ₂ = arccos(0.95) = 18.2°, tan φ₂ = 0.329; Q₂ = P × tan φ₂ = 150 × 0.329
              = 49.4 kVAr
            </li>
            <li>
              Capacitor required: Qc = Q₁ - Q₂ = 132.3 - 49.4 = <strong>82.9 kVAr</strong>
            </li>
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>P = √3 × VL × IL × cos φ</strong> — Three-phase true power
            </li>
          </ul>
          <p>
        ...
        <Scenario
          ...
          situation={
            <>
              A new mixed-use development has 320 kW connected mechanical load (chillers, AHU fans,
              pumps, lifts) at an estimated 0.78 pf, plus 180 kW lighting and small power at 0.92
              pf, plus 90 kW EV charging at unity pf. CIBSE Guide F diversity factors give a
              coincident demand of 75 % on mechanical and 60 % on lighting/SP and 100 % on EV. You
              need the DNO application kVA.
            </>
          }
          whatToDo={
            <>
              Compute each contribution: mechanical = (320 &times; 0.75) / 0.78 = 308 kVA;
              lighting/SP = (180 &times; 0.60) / 0.92 = 117 kVA; EV = (90 &times; 1.00) / 1.00 = 90
              kVA. Total = 515 kVA. Round up to the nearest standard DNO substation rating (probably
              800 kVA for headroom on EV growth) and submit on the connection application. Specify a
              600 kVA G99 standby generator if the brief includes essential life-safety / lift
              backup.
            </>
          }
          whyItMatters={
            <>
              ...
              connection charges and ongoing capacity charges. The kVA arithmetic with pf and
              diversity is the most commercially significant calculation a BSE engineer does on most
              projects.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Harmonics</div>
          </button>
          <button
