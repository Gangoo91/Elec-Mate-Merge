...
const quickCheckQuestions = [
  {
    ...
    options: ['Half the line current', 'Equal to line current', '√3 times line current', 'Zero'],
    correctIndex: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              BS EN 50160 sets the DNO target of &le; 2 % negative-sequence voltage unbalance at the
              LV PCC. As the BSE designer of a new distribution board you take responsibility for
              keeping the contribution from your installation below this threshold by balancing
              single-phase loads across L1/L2/L3 during design stage and verifying at commissioning.
              Asymmetry above 2 % derates induction motor torque and accelerates winding failure.
            </>
          }
        ...
        <ConceptBlock title="Balanced Three-Phase Loads">
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Key principle:</strong> Three-phase motors and industrial equipment are designed
            as balanced loads. Single-phase loads connected to three-phase systems inherently create
            unbalance.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Neutral Current in Balanced Star Systems">
          <p>
            ...
            three phase currents, being equal in magnitude but displaced by 120°, sum vectorially to
            zero.
          </p>
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            neutral carries no current. This is why three-phase motors (balanced loads) often don't
        ...
        <ConceptBlock title="Unbalanced Loads — Unequal Phase Loading">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Phase angle unbalance:</strong> Deviation from 120° separation — e.g. angles
              0°, -118°, -243°
            </li>
            <li>
              <strong>Single-phasing:</strong> Loss of one phase (extreme unbalance) — blown fuse or
              open conductor
            </li>
          </ul>
          <p className="text-sm text-elec-yellow/70">
            <strong>Design target:</strong> In building services, aim to keep phase currents within
            10-15% of each other. This minimises neutral current and maintains acceptable voltage
            balance.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Calculating Neutral Current with Unbalance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>
                I<sub>N</sub> = √(I<sub>R</sub>² + I<sub>Y</sub>² + I<sub>B</sub>² - I<sub>R</sub>·I
                <sub>Y</sub> - I<sub>Y</sub>·I<sub>B</sub> - I<sub>B</sub>·I
                <sub>R</sub>)
              </strong>
            </li>
          </ul>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>
                Balanced (I<sub>R</sub>=I<sub>Y</sub>=I<sub>B</sub>=I):
              </strong>{' '}
              I<sub>N</sub> = 0 — currents cancel
            </li>
            <li>
              <strong>One phase loaded (I, 0, 0):</strong> I<sub>N</sub> = I — full current returns
              via neutral
            </li>
            <li>
            ...
            <li>
              <strong>Two phases, one double (2I, I, 0):</strong> I<sub>N</sub> = √3 × I — neutral
              exceeds smaller phase
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <p>
            <strong>Problem:</strong> A distribution board has: Red = 40A, Yellow = 30A, Blue = 25A
            (all resistive loads). Calculate neutral current.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            phase currents, the neutral only carries 13.2A. The neutral current is always less than
            the arithmetic sum.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Effects of Unbalance: Voltage Asymmetry and Overheating">
          <p>
            ...
            efficiency, and system reliability. Understanding these effects is essential for proper
            system design.
          </p>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">
            Effects on Three-Phase Equipment
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>VSDs/Inverters:</strong> Increased DC bus ripple — capacitor stress, harmonics
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Neutral overheating:</strong> Undersized neutrals may overheat with unbalanced
              loads
            </li>
            <li>
        ...
        <ConceptBlock title="Load Balancing Strategies">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Grouping similar loads:</strong> Distribute lighting circuits across all three
              phases
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">
            Worked Example: DB Load Schedule
          </p>
          <p>
            <strong>Problem:</strong> Allocate these loads across three phases: 20A, 15A, 12A, 10A,
            8A, 6A, 5A, 4A
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-sm text-elec-yellow/70">
            <strong>Practical tip:</strong> In existing installations, use a clamp meter to measure
            phase currents during peak load. If unbalance exceeds 15%, consider relocating circuits.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Single-Phase Loads on Three-Phase Systems">
          ...
          <p>
            In an office building with computers on each phase drawing equal fundamental current but
            50% third harmonic content, the neutral current from triplen harmonics alone equals 1.5×
            the phase fundamental current. Combined with any unbalance, the neutral can
            significantly exceed phase current.
          </p>
          <p className="text-sm text-elec-yellow/70">
        ...
        <ConceptBlock title="Building Services: DB Load Distribution and Neutral Sizing">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>0 - 15% third harmonic:</strong> Based on phase size (can be reduced) — Reg.
              523.6.3
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Industrial (motors):</strong> Typical THD &lt;15% — neutral 50-100% of phase
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">
            Worked Example: Office DB Design
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Distribution (balanced):</strong>
            </li>
          ...
          <p className="text-sm text-elec-yellow/70">
            ...
            expected diversity, and harmonic content assumptions. This aids future modifications and
            troubleshooting.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Problem:</strong> A four-wire star system supplies loads of 50A on Red, 40A on
            Yellow, and 30A on Blue (all resistive). Calculate the neutral current.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Using: I<sub>N</sub> = √(I<sub>R</sub>² + I<sub>Y</sub>² + I<sub>B</sub>² - I
            ...
            <li>
              The neutral carries 17.3A despite a 20A difference between max and min phase currents.
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">
          ...
          <p>
            <strong>Problem:</strong> A 30kW motor operates with 2.5% voltage unbalance. What is the
            recommended output derating?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              non-linear loads are present. Ignoring voltage unbalance effects on motors. Poor load
              scheduling at design stage.
            </>
          }
          doInstead={
            <>
              Use phasor (vector) addition for neutral current. Only assume zero neutral for
              perfectly balanced loads. Oversize the neutral for IT/LED dominated buildings. Derate
              motors above 1% VUF. Schedule single-phase loads evenly across all three phases at
              design.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A 250 A four-way distribution board in a refurbished open-plan office is tripping the
              upstream MCCB intermittently. Power-quality logging shows L1 = 195 A, L2 = 142 A, L3 =
              178 A — a 23 % imbalance. Tenant fit-out added a kitchenette (single-phase 32 A on L1)
              and 30 desk PCs (also concentrated on L1). Upstream supply voltage shows 2.7 %
              negative-sequence.
            </>
          }
          whatToDo={
            <>
              Re-allocate single-phase circuits across L1, L2, L3 to bring imbalance below 10 %.
              Move the kitchenette circuit (and ideally the dishwasher / hot-water boiler) to L2 or
              L3. Split the desk power into three roughly equal phase groups. Verify with a true-RMS
              clamp meter at recommissioning, logging at least 24 hours. Investigate the upstream
              2.7 % negative-sequence — could be DNO-side or another tenant — and raise with the
              landlord if outside this installation&rsquo;s control.
            </>
          }
          whyItMatters={
            <>
              Phase imbalance accelerates motor failure (negative-sequence torque heats the rotor)
              and breaches BS EN 50160 limits. It also wastes neutral capacity and trips upstream
              protection nuisance-style. Phase rebalancing is the cheapest, fastest power-quality
              fix on most commercial fit-out boards.
            </>
          }
        />
