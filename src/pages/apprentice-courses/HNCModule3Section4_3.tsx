      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Characteristics of a balanced load:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Common causes of unbalance in buildings:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">Single-phase loads distributed unevenly across phases</li>
                <li className="pl-1">
                  Large single-phase equipment (lifts, air conditioning units)
                </li>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Different current magnitudes per phase
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Different voltage magnitudes per phase
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        V<sub>R</sub>=235V, V<sub>Y</sub>=228V, V<sub>B</sub>=232V
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Phase angle unbalance</td>
                      <td className="border border-white/10 px-3 py-2">
                        Deviation from 120° separation
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Loss of one phase (extreme unbalance)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Blown fuse, open conductor
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        One phase loaded (I, 0, 0)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        I<sub>N</sub> = I
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Full current returns via neutral
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Two phases equally loaded (I, I, 0)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        I<sub>N</sub> = I
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Equal to single phase current
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
                        Two phases, one double (2I, I, 0)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        I<sub>N</sub> = √3 × I
                      </td>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Negative sequence currents, increased heating
                      </td>
                      <td className="border border-white/10 px-3 py-2">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <div className="text-sm text-white/90">
                ...
                <p className="mt-2 text-red-300">
                  <strong>NEMA MG1:</strong> Motors should be derated if voltage unbalance exceeds
                  1%.
                </p>
              </div>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Other consequences of unbalance:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Nuisance tripping:</strong> Protection devices may trip on unbalanced
                  faults
                </li>
                <li className="pl-1">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ol className="text-sm text-white space-y-2 list-decimal list-outside ml-5">
                ...
                <li className="pl-1">
                  Continue allocating each load to the phase with lowest total
                </li>
                <li className="pl-1">Check final balance - aim for within 10-15% variation</li>
                <li className="pl-1">
                  Adjust allocation if necessary by swapping similar-sized loads
                </li>
              </ol>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2">
                  <strong>Final: R=26A, Y=27A, B=27A</strong>
                </p>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Group similar load types (lighting, small power, mechanical)
                </li>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Based on phase size (can be reduced)
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Neutral is sizing conductor (may exceed phase)
                      </td>
                      <td className="border border-white/10 px-3 py-2">523.6.3</td>
                    </tr>
                  </tbody>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="text-elec-yellow mt-1">
                  Consider 150% (150A) if high IT density expected
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-amber-400">
                  ⚠ Exceeds 2% limit - investigate cause and consider remedial action
                </p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>VUF (approx):</strong> (V<sub>max</sub> - V<sub>min</sub>) / V
                  <sub>avg</sub> × 100%
                </li>
                <li className="pl-1">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Adding currents arithmetically:</strong> Neutral ≠ I<sub>R</sub> + I
                  <sub>Y</sub> + I<sub>B</sub> (must use phasors)
                </li>
                <li className="pl-1">
                  <strong>Assuming zero neutral:</strong> Only true for perfectly balanced loads
                </li>
                <li className="pl-1">
                  <strong>Undersizing neutrals:</strong> Harmonic loads may require oversized
                  neutral
                </li>
                <li className="pl-1">
                  <strong>Ignoring unbalance effects:</strong> Motors derate significantly with VUF
                </li>
                <li className="pl-1">
                  <strong>Poor load scheduling:</strong> Design-stage balance prevents operational
                  issues
                </li>
              </ul>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-xs text-white">
              <div>
                ...
                <ul className="space-y-0.5">
                  <li>
                    Equal impedance: Z<sub>R</sub> = Z<sub>Y</sub> = Z<sub>B</sub>
                  </li>
