...
const DESCRIPTION =
  'Understanding the four modes of electric vehicle charging as defined by IEC 61851, from domestic socket charging to DC rapid charging.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "Mode 1 is slow AC charging from a standard socket without any dedicated EV safety features. It's not permitted for public use in the UK and is generally discouraged for domestic use due to the lack of in-cable control and protection device (IC-CPD). Maximum current is typically limited to 10A.",
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      "Mode 2 includes an IC-CPD (In-Cable Control and Protection Device) - the 'brick' in the charging cable. This provides earth monitoring, overcurrent protection, and control pilot communication with the vehicle. It makes Mode 2 significantly safer than Mode 1 for domestic socket charging.",
  },
  {
    id: 'check-3',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "Mode 4 is DC rapid charging where the charger converts AC to DC and supplies DC power directly to the vehicle's battery, bypassing the vehicle's onboard charger. This enables much higher charging speeds (50-350kW+) but requires expensive off-board charging equipment and is typically used at public charging stations.",
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 0,
    explanation:
      'Mode 1 (direct connection to standard socket without protection device) is not permitted for public charging in the UK due to safety concerns. The lack of earth monitoring and control pilot communication makes it unsuitable for uncontrolled public environments.',
  },
  {
    id: 2,
    question: 'What is the maximum current typically available from Mode 2 charging in the UK?',
    options: ['6A', '10A (2.3kW at 230V)', '32A (7.4kW at 230V)', '100A'],
    correctAnswer: 1,
    explanation:
      "Mode 2 charging via UK domestic socket is typically limited to 10A (approximately 2.3kW at 230V) or sometimes 13A with appropriate IC-CPD settings. This provides 'granny charging' suitable for overnight top-ups but not rapid charging. The socket and circuit protection must support the selected current.",
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'EVSE stands for Electric Vehicle Supply Equipment. It refers to the charging infrastructure that supplies electricity to EVs, including wallboxes, public charging posts, and rapid chargers. The EVSE manages the charging session, communicates with the vehicle, and provides safety functions.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'The control pilot (CP) is a PWM signal that enables communication between the EVSE and vehicle. It indicates available current, confirms the vehicle is connected and ready, verifies earth continuity, and allows the vehicle to request charging to start. This communication is essential for safe, controlled charging.',
  },
  {
    id: 5,
    ...
    correctAnswer: 3,
    explanation:
      'Mode 4 (DC rapid charging) provides the fastest charging speeds, typically 50kW to 350kW+. The external charger handles AC to DC conversion and can supply much higher power than vehicle onboard chargers. Mode 4 can add 100+ miles of range in 20-30 minutes depending on the charger and vehicle capability.',
  },
  {
    id: 6,
    question: 'What typical power output does a single-phase Mode 3 home charger provide?',
    options: ['2.3kW', '7kW (7.4kW at 32A)', '22kW', '50kW'],
    correctAnswer: 1,
    explanation:
      'Single-phase Mode 3 home chargers typically provide 7kW (actually 7.36kW at 32A, 230V). This is the most common domestic installation, providing a full overnight charge for most EVs. Three-phase installations can provide up to 22kW but require three-phase supply and are less common in UK homes.',
  },
  {
    id: 7,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "Mode 1 lacks the IC-CPD that Mode 2 provides. Without this device, there's no earth monitoring, no thermal protection in the cable, no overcurrent protection beyond the socket's MCB, and no control pilot communication. This means faults may not be detected before becoming dangerous.",
  },
  {
    id: 9,
    question: 'What is the approximate range of charging power for Mode 4 DC rapid chargers?',
    options: ['3-7kW', '7-22kW', '50-350kW or more', 'Under 3kW only'],
    correctAnswer: 2,
    explanation:
      "Mode 4 DC rapid chargers range from around 50kW (standard rapid) to 150kW+ (ultra-rapid) and up to 350kW or more for the latest high-power charging networks. Power delivery depends on both the charger capability and the vehicle's acceptance rate, which varies by model and battery state.",
  },
  {
    id: 10,
    question: 'Which standard defines the four EV charging modes?',
    options: ['BS 7671', 'IEC 61851', 'G98/G99', 'Part P'],
    correctAnswer: 1,
    explanation:
      'IEC 61851 is the international standard that defines the four EV charging modes and related requirements for EV conductive charging systems. BS 7671 covers general electrical installation (including EVSE), while G98/G99 addresses grid connection. Part P covers building regulations for electrical work.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Mode 1:</strong> Standard socket, no protection - NOT permitted publicly in
                UK
              </li>
              <li>
                <strong>Mode 2:</strong> Standard socket WITH IC-CPD protection device
              </li>
              <li>
                <strong>Mode 3:</strong> Dedicated EVSE (wallbox) - most common home installation
              </li>
              <li>
                <strong>Mode 4:</strong> DC rapid charging - public/commercial only
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> IC-CPD 'brick' on Mode 2 cables, wallbox for Mode 3
              </li>
              <li>
                <strong>Use:</strong> Mode 3 for daily home charging at 7kW
              </li>
              <li>
                <strong>Apply:</strong> IEC 61851 defines all charging mode requirements
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Mode 1 is the most basic form of EV charging: connecting the vehicle directly to a
              standard domestic socket without any dedicated EV protection or control. While
              technically possible, Mode 1 is NOT permitted for public charging in the UK and is
              strongly discouraged for home use.
            </p>
            ...
            <p>
              The safety concerns with Mode 1 are significant: no earth continuity monitoring, no
              protection against socket overheating, and no way for the vehicle to verify safe
              connection before drawing current. A fault in the earth path would not be detected
              until it's potentially too late.
            </p>

            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Mode 1 equipment is rarely seen in the UK market. Always
              verify charging cables include an IC-CPD for Mode 2 operation when socket charging is
              required.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Mode 2 adds critical safety features to socket-based charging through the IC-CPD - the
              'brick' or control box integrated into the charging cable. This device makes socket
              charging significantly safer, though still slower than dedicated EVSE.
            </p>
            ...
            <p>
              Mode 2 is the charging cable typically supplied with EVs. It's suitable for occasional
              use, emergency charging, or when visiting locations without dedicated charging. For
              regular daily charging, Mode 3 is preferred.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Mode 3 is the standard for home and workplace EV charging. A permanently installed
              wallbox provides dedicated supply, higher power, integrated safety features, and often
              smart functionality. This is what electricians will most commonly install.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Single-phase:</strong> Typically 7kW (32A at 230V) - standard UK home
                  installation
                </li>
                <li>
                  <strong>Three-phase:</strong> Up to 22kW (32A at 400V) - requires three-phase
                  supply
                </li>
                <li>
                  <strong>Integrated safety:</strong> RCD, overcurrent protection, earth monitoring
                  built into EVSE
                </li>
                <li>
                  <strong>Control pilot:</strong> Continuous communication with vehicle during
                  charging
                </li>
                <li>
                  <strong>Smart features:</strong> Often includes scheduling, load management,
                  energy monitoring
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Mode 4 provides DC power directly to the vehicle's battery, bypassing the vehicle's
              onboard charger. This enables much higher charging power - from 50kW to over 350kW -
              dramatically reducing charging time. Mode 4 is found at public rapid charging
              stations.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Mode 4 chargers are complex, expensive installations
              requiring industrial power supplies. Electricians working on DC chargers need
              specialist training beyond standard EV charging certification.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Installing Mode 3 Equipment
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Installing Mode 1 connections</strong> - not permitted and unsafe
                </li>
                <li>
                  <strong>Undersizing supply</strong> - consider whole installation capacity, not
                  just charger
                </li>
                <li>
                  <strong>Ignoring PME earthing restrictions</strong> - may require earth electrode
                </li>
                <li>
                  <strong>Forgetting DNO notification</strong> - required for EV charger
                  installations
                </li>
              </ul>
            </div>
