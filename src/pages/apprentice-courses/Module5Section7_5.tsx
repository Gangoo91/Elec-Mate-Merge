      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Types of Site Documentation</h3>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Essential Documentation Categories</p>
                    <p className="text-base text-foreground mb-2"><strong>Drawings and as-builts:</strong> Visual records of electrical installations.</p>
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Specifications and standards:</strong> Technical requirements and compliance documents.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Test certificates and compliance records:</strong> Verification of safety and standards.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Safety documentation:</strong> Risk management and procedural requirements.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Why Proper Storage Matters</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Document protection and preservation:</strong> Preventing loss of critical information.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Regulatory compliance and standards:</strong> Meeting legal and professional obligations.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Operational efficiency and accessibility:</strong> Supporting daily work activities.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Communication and collaboration:</strong> Enhancing team coordination.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          {/* Methods of Storage */}
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Methods of Storage</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-amber-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Physical storage systems:</strong> Secure on-site document management.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Digital storage platforms:</strong> Cloud-based and networked solutions.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Mobile access solutions:</strong> Field-accessible documentation systems.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Hybrid storage approaches:</strong> Combining physical and digital benefits.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">Consequences of Poor Documentation Storage</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-red-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-red-600 dark:text-emerald-400 mb-1">Serious Risks from Poor Documentation Management</p>
                    <p className="text-base text-foreground mb-2"><strong>Operational failures and mistakes:</strong> Work quality and accuracy impacts.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Project delays and inefficiencies:</strong> Time and cost implications.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Compliance and legal issues:</strong> Regulatory and contractual consequences.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Safety and risk management failures:</strong> Hazard exposure and incident risks.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-6">
            <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/30">
              <h3 className="font-medium text-foreground mb-2">Commercial Office Project - Water Damage Disaster</h3>
            ...
            <div className="rounded-lg p-4 bg-card border border-amber-400/30">
              <h3 className="font-medium text-foreground mb-2">Hospital Project - Version Control Failure</h3>
              <p className="text-base text-foreground mb-2">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-card border border-border/30">
              <h3 className="font-medium text-foreground mb-2">Good Practice - Digital Document Management</h3>
              <p className="text-base text-foreground mb-2">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
            <div>
              <h3 className="font-medium text-foreground mb-3">Physical Storage Best Practices</h3>
            ...
            <div>
              <h3 className="font-medium text-foreground mb-3">Digital Management Strategies</h3>
              <ul className="text-xs sm:text-sm text-foreground space-y-2">
                <li className="flex items-start gap-2">
        ...
        {/* Pocket Guide */}
        <Card className="mb-8 p-6 bg-emerald-500/5 border-emerald-500/30">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-3">
              <div className="flex items-start gap-2">
                ...
                <span className="text-xs sm:text-sm text-foreground">Store drawings, certificates, and manuals securely</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-5 h-5 mt-0.5 text-green-500 flex-shrink-0" />
                <span className="text-xs sm:text-sm text-foreground">Always back up digital files with regular updates</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-5 h-5 mt-0.5 text-green-500 flex-shrink-0" />
                <span className="text-xs sm:text-sm text-foreground">Ensure site staff can access documents quickly</span>
              </div>
            </div>
            <div className="space-y-3">
              <div className="flex items-start gap-2">
                <CheckCircle className="w-5 h-5 mt-0.5 text-green-500 flex-shrink-0" />
                <span className="text-xs sm:text-sm text-foreground">Only use the latest version of documents</span>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-5 h-5 mt-0.5 text-green-500 flex-shrink-0" />
                <span className="text-xs sm:text-sm text-foreground">Protect physical copies from damage</span>
              </div>
            </div>
          </div>
        </Card>
