    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Professional workmanship standards and NET compliance requirements for AM2 assessment -
          master terminations, connections and labelling for assessment success.
        </p>
        ...
        <ConceptBlock title="NET Assessment Criteria - What Assessors Check">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Exposed copper beyond terminals</strong> - Immediate fail. Any visible copper
              creates shock/short circuit risk.
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Untidy cable dressing</strong> - Professional standards. Cables crossing, poor
              routing, excessive length.
            </li>
            <li>
        ...
        <ConceptBlock title="1. General Termination Standards (BS 7671, Section 526)">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>No bare copper visible outside terminals.</strong> Critical safety requirement
              - prevents shock and short circuits.
            </li>
            <li>
              <strong>Insulation runs up to terminal.</strong> Proper cable preparation with correct
              strip lengths.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              "Durable" is the AM2 word. Tight today isn't enough — the connection has to stay tight
              after thermal cycling. That's why you torque to spec, why you don't double flex into a
              single rigid terminal, and why the assessor will give a screw a gentle pull-test.
              Loose, hand-tight or over-crushed terminations all fail this clause.
            </>
          }
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              connector block taped up and pushed into a void fails this reg, even if the connection
              itself is sound. If you can't reach an outlet in one cable run, your joint goes inside
              a BS 4662 box or a BS 5733 maintenance-free junction box, fixed and accessible.
            </>
          }
        ...
        <ConceptBlock title="2. Accessory Terminations (Sockets, Switches, Cooker Outlets)">
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>CPC identification.</strong> Apply green/yellow sleeving to CPC - required in
              ALL accessories including plastic ones. No exceptions in AM2.
            </li>
            <li>
              <strong>Conductor preparation.</strong> Cut conductors to correct length - no twisting
              or bunching. Allow enough length for secure termination without stress.
            </li>
            <li>
        ...
        <ConceptBlock title="4. SWA Cable Terminations - Advanced Techniques">
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Gland assembly.</strong> Thread gland components onto cable in correct order.
              Ensure banjo washer is properly positioned for armour contact.
            </li>
            <li>
        ...
        <ConceptBlock title="5. Circuit Identification and Labelling">
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Verification and durability.</strong> Check all labels are legible, permanent,
              and accurately describe the circuits. No temporary markings allowed.
            </li>
          </ol>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Consistent naming convention</strong> - Follow pattern throughout installation
            </li>
            <li>
        ...
        <ConceptBlock title="6. Common Assessment Failures - NET Data Analysis">
          ...
          <ol className="space-y-1.5 list-decimal pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Loose terminal connections (29% of failures).</strong> Insufficient tightening
          ...
          <p>
            <strong className="text-elec-yellow">Assessment Recovery Strategy.</strong> If you make
            a termination error during assessment:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              Acknowledge it immediately, isolate the supply, lift the misplaced conductor, drop it
              into the correct bar, and re-tighten. Then check every other CPC and neutral — if you
              mixed one, you might have mixed another. Don't try to defend the mistake. The recovery
              — calm, methodical, full check — is what an assessor wants to see.
            </>
          }
          whyItMatters={
            <>
              CPC in the neutral bar disconnects the circuit's earth path entirely. On a fault, the
              casing of an accessory could go to mains potential with no return path through the MCB
              — exposed-conductive-parts at 230 V. It's a fundamental polarity error and a section
              fail. The assessor isn't looking to embarrass you — they're checking whether you spot
              and fix safety-critical errors.
            </>
          }
        />
