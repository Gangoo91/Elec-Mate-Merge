    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-base text-muted-foreground mb-12">
          This section covers essential life safety systems in commercial buildings. You'll learn
          about emergency lighting design to BS 5266, fire alarm systems to BS 5839, standby
          generators, UPS systems and the testing and compliance requirements for these critical
          systems.
        </p>
