...
const quickCheckQuestions = [
  {
    ...
    options: ['150 lux', '500 lux', '300 lux', '750 lux'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['200 lux', '50 lux', '100 lux', '300 lux'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1000 lux', '10,000-100,000 lux', '300 lux', '500 lux'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Ra 90', 'Ra 95', 'Ra 70', 'Ra 80'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['150 lux', '750 lux', '300 lux', '500 lux'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Your CIBSE-driven lighting criteria still terminate at a BS 7671 lighting point. When
              you specify a 500 lux office solution, the schedule has to land on one of the
              permitted termination methods — you are not free to invent a fitting interface. The
              designer’s job is to thread the luminaire choice through both the photometric criteria{' '}
              <em>and</em> Regulation 559.5.1.
            </>
          }
        ...
        <ConceptBlock title="Task Illuminance — CIBSE SLL Requirements">
          <p>
            Illuminance is the quantity of light falling on a surface, measured in lux (lumens per
            square metre). The CIBSE Society of Light and Lighting publishes recommendations for
            maintained illuminance levels based on the visual tasks to be performed.
          </p>
          <p>
          ...
          <p>
            <strong>
              Recommended illuminance levels — CIBSE SLL (space type / Em lux / UGR / Ra):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Note:</strong> These are maintained illuminance values. Initial illuminance must
            be higher to account for the maintenance factor (typically MF = 0.7-0.8).
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Uniformity Ratios — Even Light Distribution">
          <p>
            ...
            excessive contrast between bright and dark areas. Poor uniformity causes visual fatigue
            as the eye constantly adapts to different light levels.
          </p>
          <p>
          ...
          <p>
            <strong>Luminance ratios in the visual field:</strong> To prevent adaptation problems,
            luminance ratios should not exceed:
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Design tip:</strong> Achieve good uniformity by spacing luminaires appropriately
            — typically spacing-to-height ratio (SHR) of 1.0-1.5 depending on luminaire type.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Glare Control — Unified Glare Rating (UGR)">
          <p>
            ...
            ability to see. The Unified Glare Rating (UGR) system quantifies discomfort glare from
            luminaires, with lower values indicating better glare control.
          </p>
          <p>
          ...
          <p>
            ...
            screens) should have luminance below 1500 cd/m² at relevant angles to prevent reflected
            glare.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Colour Rendering and Visual Comfort">
          <p>
            ...
            objects. It is measured by the Colour Rendering Index (CRI or Ra) on a scale of 0-100,
            where 100 represents perfect colour rendering equivalent to natural daylight.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Flicker:</strong> LED drivers should provide flicker-free operation (IEEE 1789
              compliant)
            </li>
            <li>
            ...
            <li>
              <strong>View:</strong> windows and visual relief from uniform artificial environments
            </li>
          </ul>
          <p>
            <strong>Kruithof curve:</strong> Visual comfort depends on the relationship between
            illuminance and colour temperature — higher illuminance levels are more acceptable with
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — office lighting criteria:</strong> Specify lighting criteria for a
            new open-plan office with VDU workstations.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 — surrounding area requirements:</strong> Task area illuminance is 750
            lux. What is the minimum surrounding area illuminance?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Illuminance:</strong> identify tasks, specify maintained lux from CIBSE SLL
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>UGR calculation errors</strong> — UGR varies with viewing position and room
                proportions
              </li>
              <li>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              0.7 task / ≥ 0.5 surround, UGR ≤ 19, Ra ≥ 80, CCT 4000 K, MF 0.8, luminaire luminance
              &lt; 1500 cd/m² in the offending zone for VDU compatibility. CAD zone: tighten to UGR
              ≤ 16 and Em 750 lx (or local task lighting). Note in the criteria that the luminaire
              must terminate to BS 7671 Reg 559.5.1 — most will be either a BS EN 60598 luminaire or
              a DCL (BS EN 61995-1) on a plug-in lighting distribution unit (BS 5733). Confirm room
              reflectances assumed (0.7/0.5/0.2) so the DIALux model isn’t optimistic.
            </>
          }
          whyItMatters={
            <>
              Without a criteria sheet, the QS prices the cheapest UGR-22 luminaire and the client
              gets glare complaints on day one. Your spec — illuminance, uniformity, UGR, Ra, CCT,
              MF — is what stops a value-engineering downgrade hollowing out the design.
            </>
          }
        />
