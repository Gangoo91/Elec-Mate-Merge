        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Copper:</strong> 100% IACS conductivity, excellent jointing properties
              </li>
              <li className="pl-1">
                <strong>Aluminium:</strong> 61% IACS, lighter but requires oxide preparation
              </li>
              <li className="pl-1">
                <strong>Trunking:</strong> Feeder, plug-in and lighting variants
              </li>
              <li className="pl-1">
                <strong>Thermal imaging:</strong> Minimum 40% load for reliable surveys
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Joints:</strong> Torque, compound and re-torque after thermal cycling
              </li>
              <li className="pl-1">
                <strong>Fire barriers:</strong> Must be maintained at cable penetrations
              </li>
              <li className="pl-1">
                <strong>Cable fill:</strong> 45% maximum for adequate ventilation
              </li>
              <li className="pl-1">
                <strong>ST1426:</strong> Maps to electrical plant knowledge KSBs
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  ...
                  for small boards to 120 mm x 10 mm or multiple bars per phase for large
                  switchboards
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Typical applications:</strong> Large panel boards, busbar trunking,
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Conductive, self-limiting
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Resistive, requires preparation
                      </td>
                    </tr>
                    <tr>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> When copper and aluminium are joined directly, galvanic
              corrosion will occur due to their different positions in the electrochemical series.
              Bimetallic connectors or transition pads must always be used at copper-to-aluminium
              connections.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  ...
                  along its length -- power is taken off only at the ends. Feeder trunking provides
                  the lowest impedance path for high-current distribution and is commonly used in
                  industrial plants and large commercial buildings.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  Medium-current trunking typically rated from 100 A to 1600 A with tap-off points
                  at regular intervals (usually every 0.5 m or 1.0 m). Allows distribution boards,
                  motor starters or other loads to be connected at any tap-off position, providing
                  excellent flexibility for layout changes and future expansion. Plug-in units can
                  be hot-swapped on some systems without shutting down the trunking.
                </p>
              </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Flexible:</strong> Tap-off units can be added or changed without
                  re-cabling
                </li>
                <li className="pl-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Maintenance note:</strong> Rising main maintenance includes checking the
              tightness of all joint bolts (using calibrated torque equipment), inspecting tap-off
              units for signs of overheating, verifying that fire barriers at each floor penetration
              are intact, and performing thermal imaging of joints under load.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  ...
                  galvanised steel, stainless steel and aluminium. Cable tray provides good
                  ventilation around cables (improving current ratings compared to enclosed
                  containment), is easy to install and modify, and allows cables to be visually
                  inspected without removal. Tray width is selected based on the number and size of
                  cables, with consideration of space factors and future expansion.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  ...
                  cross rungs. Cable ladder is designed for large, heavy cables where the weight
                  would exceed the capacity of standard tray. Typically used for HV cables, large LV
                  sub-main cables and heavy industrial cable routes. The open rung design provides
                  excellent ventilation and allows cables to be secured individually with cable
                  cleats at each rung.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  An increasingly popular alternative to traditional tray. Wire mesh basket is
                  lighter, faster to install, provides excellent ventilation and is more economical.
                  It is well suited to data cables, small power cables and mixed services. However,
                  it may not be suitable for very heavy cables due to its lower load-carrying
                  capacity compared to steel tray or ladder.
                </p>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                ...
                (requiring larger cables), and makes maintenance difficult. Always allow a minimum
                of 25% spare capacity for future additions.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>BS 7671 reference:</strong> Cable grouping factors (Table 4C1) and thermal
              insulation factors must be applied when calculating the current-carrying capacity of
              cables in containment. The installation method directly determines the applicable
              rating from Appendix 4.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              pathways for fire and smoke to spread between compartments, undermining the building's
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Materials:</strong> Intumescent pillows (expand when heated),
                  fire-resistant sealant, fire-rated boards (mineral fibre or calcium silicate),
                  intumescent wraps for individual cables
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                During maintenance work, always check that fire barriers have not been compromised.
                If additional cables are routed through a fire barrier, the barrier must be
                re-sealed to its original fire rating using approved materials and methods. This is
                a legal requirement and a key item on periodic inspection reports (BS 7671
                Regulation 421.7). Breached fire barriers have been identified as a contributing
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              systems, a high-resistance connection generates excess heat visible as a "hot spot".
            </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Schedule maintenance during next planned shutdown
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Plan maintenance within weeks; increase monitoring
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Arrange maintenance ASAP; consider load reduction
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Immediate action; risk of failure, fire or damage
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Best Practice for Thermal Surveys
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Conditions:</strong> Consistent ambient temperatures; avoid direct
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Maintenance value:</strong> Regular thermal imaging identifies deteriorating
              connections before they fail catastrophically. A single busbar joint failure can cause
              a complete installation outage, arc flash injuries and significant fire damage.
              Prevention through thermal imaging is far more cost-effective than reactive repair.
            </p>
          </div>
        </section>
