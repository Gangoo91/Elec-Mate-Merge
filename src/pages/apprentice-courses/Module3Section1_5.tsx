...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Flexible cords use multi-stranded conductors that can bend repeatedly without breaking, unlike solid conductors in fixed wiring.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'False. BS 7671 does not permit flexible cords for concealed fixed wiring in building fabric.',
  },
  {
    id: 4,
...
const faqs = [
  {
    q: 'Can I use flexible cord for wiring inside walls?',
    a: 'No, BS 7671 does not permit flex for concealed fixed wiring in building fabric.',
  },
  {
    q: 'Can flexible cords be repaired if damaged?',
    a: 'Minor damage can be repaired by shortening and re-terminating, but cords with insulation damage along their length should be replaced.',
  },
  {
    q: 'Are all flexible cords heat-resistant?',
    a: 'No — only those specifically designed and rated for high-temperature use can withstand elevated temperatures.',
  },
  {
    q: 'How do I select the correct flex for outdoor use?',
    a: 'Consider temperature range, UV resistance, mechanical protection needed, and choose appropriate type (HOFR, artic, or UV-stabilised).',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              ...
              <li>
                Various types: PVC, heat-resistant, HOFR rubber, and artic for different
                environments
              </li>
              <li>
                Must use proper flex outlets with strain relief - cannot be used for fixed wiring
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Multi-stranded conductors, flexible outer sheath, used with
                cord grips
              </li>
              <li>
                <strong>Use:</strong> Portable appliances, pendant lights, extension leads,
                equipment connections
              </li>
              <li>
                <strong>Check:</strong> Correct type for environment, proper strain relief, current
                rating adequate
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Flexible cords use fine multi-stranded conductors that can withstand repeated bending
              and movement without conductor fatigue or breakage.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Standard Conductor Classes
                </p>
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Class 5:</strong> Flexible conductors for fixed installation connections
                  </li>
                  <li>
                    <strong>Class 6:</strong> Extra flexible for portable equipment and frequent
                    movement
                  </li>
                  <li>
                    <strong>Stranding:</strong> Multiple fine wires twisted together
                  </li>
                  <li>
                    <strong>Tinning:</strong> Often tin-plated to resist corrosion and ease
                    termination
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>PVC:</strong> Standard domestic and commercial use up to 70°C
                  </li>
                  <li>
                    <strong>Rubber:</strong> Superior flexibility and temperature resistance
                  </li>
                  <li>
                    <strong>Silicone:</strong> High temperature applications up to 180°C
                  </li>
                  <li>
                    <strong>XLPE:</strong> Cross-linked for enhanced thermal properties
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="grid sm:grid-cols-2 gap-3 my-6">
              <div className="p-3 rounded bg-white/5">
                ...
                <ul className="text-xs text-white space-y-1">
                  ...
                  <li>
                    <strong>Applications:</strong> Domestic appliances, table lamps, extension leads
                  </li>
                  <li>
                    <strong>Advantages:</strong> Cost-effective, good general performance
                  </li>
                  <li>
                    <strong>Limitations:</strong> Can become stiff in cold conditions
                  </li>
                </ul>
              </div>
              <div className="p-3 rounded bg-white/5">
                ...
                <ul className="text-xs text-white space-y-1">
                  ...
                  <li>
                    <strong>Applications:</strong> Cookers, ovens, immersion heaters, industrial
                    equipment
                  </li>
                  <li>
                    <strong>Insulation:</strong> Silicone rubber or high-temperature PVC compounds
                  </li>
                  <li>
                    <strong>Cost:</strong> Higher than standard PVC but essential for hot
                    environments
                  </li>
                </ul>
              </div>
            ...
            <div className="grid sm:grid-cols-2 gap-3 my-6">
              <div className="p-3 rounded bg-green-500/10 border border-green-400/30">
                ...
                <ul className="text-xs text-white space-y-1">
                  ...
                  <li>
                    <strong>Applications:</strong> Outdoor tools, industrial equipment, mechanical
                    wear environments
                  </li>
                  <li>
                    <strong>Properties:</strong> Excellent abrasion resistance, oil resistance
                  </li>
                  <li>
                    <strong>Durability:</strong> Superior to PVC for harsh conditions
                  </li>
                </ul>
              </div>
              <div className="p-3 rounded bg-white/5">
                ...
                <ul className="text-xs text-white space-y-1">
                  ...
                  <li>
                    <strong>Applications:</strong> Outdoor use in cold climates, refrigeration
                    equipment
                  </li>
                  <li>
                    <strong>Construction:</strong> Special rubber compounds maintain flexibility
                  </li>
                  <li>
                    <strong>Identification:</strong> Usually marked as "Artic" or low-temperature
                    rated
                  </li>
                </ul>
              </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <ul className="text-xs text-white space-y-1">
                  <li>
                    <strong>Submersible flex:</strong> Pumps and underwater equipment
                  </li>
                  <li>
                    <strong>Chemical resistant:</strong> Laboratory and industrial process equipment
                  </li>
                  <li>
                    <strong>Low smoke zero halogen:</strong> Public buildings and escape routes
                  </li>
                  <li>
                    <strong>Screened flex:</strong> Data and control applications with EMC
                    requirements
                  </li>
                </ul>
                <ul className="text-xs text-white space-y-1">
                  <li>
                    <strong>Flat flex:</strong> Space-saving installations under carpets
                  </li>
                  <li>
                    <strong>Coiled flex:</strong> Retractable connections for portable tools
                  </li>
                  <li>
                    <strong>Multicore flex:</strong> Control panels and instrumentation
                  </li>
                  <li>
                    <strong>High voltage flex:</strong> Specialist industrial and medical equipment
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Flexible Cord Preparation Process:
              </p>
              <ol className="list-decimal ml-6 space-y-1 text-sm text-white">
                <li>
                  <strong>Measure and cut:</strong> Allow sufficient length for strain relief loop
                  inside outlet
                </li>
                <li>
                  <strong>Remove outer sheath:</strong> Strip back 50-75mm using cable knife, taking
                  care not to damage insulation
                </li>
                <li>
                  <strong>Separate conductors:</strong> Identify and separate live (brown), neutral
                  (blue), and earth (green/yellow)
                </li>
                <li>
                  <strong>Strip conductor insulation:</strong> Remove 10-12mm from each conductor
                  using appropriate strippers
                </li>
                <li>
                  <strong>Prepare conductor ends:</strong> Twist strands tightly or fit ferrules for
                  neat termination
                </li>
                <li>
                  <strong>Check polarity:</strong> Ensure brown connects to live, blue to neutral,
        ...
        <section className="mb-10">
          ...
          <div className="p-4 rounded-lg bg-green-500/10 border border-green-400/30">
            <h3 className="text-sm font-medium text-white mb-3">
              Commercial Kitchen Pendant Light Failure
            </h3>
            <p className="text-sm text-white mb-4">
              A pendant light in a commercial kitchen was initially connected using standard PVC
              flex. After several months of operation, the heat from cooking equipment and steam
              caused the PVC insulation to harden and crack near the lamp holder.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            <p className="text-sm text-white mb-3">
              Flexible cords are essential for connecting portable or movable equipment safely
              whilst providing the flexibility needed for repeated movement and positioning. Correct
              selection, installation, and termination ensure they remain safe and reliable
              throughout their service life.
            </p>
            <p className="text-sm text-white mb-3">
              They are not a substitute for fixed wiring but are a vital part of many electrical
              installations. Key success factors include:
            </p>
            <ul className="text-sm text-white space-y-1 ml-4">
              <li>
                Selecting appropriate flex type for environmental conditions and temperature
                requirements
              </li>
              ...
              <li>
                Understanding limitations and replacing damaged cords rather than attempting repairs
              </li>
            </ul>
          </div>
        </section>
        ...
        {/* Quiz */}
        <section className="mb-10">
          <Quiz title="Flexible Cords Knowledge Test" questions={quizQuestions} />
        </section>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/apprentice/level2/module3/section1/1-6">
              Next Section
