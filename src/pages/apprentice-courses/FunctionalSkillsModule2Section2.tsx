...
const FunctionalSkillsModule2Section2 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "Professional emails should use formal language, address the client by name, and clearly state the purpose. 'Dear Mr Thompson, I am writing to confirm...' is professional, specific, and sets the right tone for client communication.",
    },
    {
      id: 6,
      question:
      ...
      correctAnswer: 2,
      explanation:
        'Using non-standard abbreviations can cause confusion. While common abbreviations like MCB, RCD, and CPC are widely understood in the trade, informal or company-specific abbreviations should be avoided on official forms that may be read by other professionals.',
    },
    {
      id: 7,
      question:
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              7671. An EICR is an official assessment of an installation's safety. Method statements
              and risk assessments are legally required safety documents. Every word you write on
              these forms matters.
            </p>
            <p>
              Poor writing on technical documents can have serious consequences. Vague or inaccurate
              descriptions of defects may lead to safety issues being overlooked. Incomplete test
              records can result in failed audits. Unprofessional emails can damage your reputation
              and cost you clients. Developing strong technical writing skills is not optional — it
              is essential to your career.
            </p>

            <h4 className="text-white font-semibold pt-2">
              The four principles of technical writing
            </h4>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Use UK English spelling (colour, centre, metre, defence)</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Write dates in the format DD/MM/YYYY (e.g. 15/03/2026)</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Use standard industry abbreviations (MCB, RCD, CPC, EICR) but avoid informal
                  shorthand
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Write in the third person for formal documents ("The installation was tested..."
                  not "I tested...")
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Use consistent terminology throughout a document — do not switch between "consumer
                  unit" and "fuseboard"
                </span>
              </li>
            </ul>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              existing electrical installation and identifies any defects or non-compliances.
              Completing it accurately requires both technical knowledge and strong writing skills.
            </p>
            ...
            <p>
              Each observation must be assigned a classification code. Understanding and correctly
              applying these codes is essential:
            </p>
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    ...
                    Immediate remedial action required. The person responsible for the installation
                    should be advised to take action immediately.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-orange-400">C2 — Potentially dangerous:</strong> Urgent
                    remedial action required. The defect could become dangerous if left unaddressed.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    ...
                    installation does not comply with current standards but is not immediately
                    dangerous. Improvement is recommended.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">&bull;</span>
                  <span>
                    <strong className="text-blue-400">FI — Further investigation:</strong> The
                    observation requires further investigation to determine its significance. This
                    might be used when access is limited or testing was not possible.
                  </span>
                </li>
              </ul>
            </div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              alterations comply with BS 7671. They are your professional declaration — your
              signature on these forms means you are certifying that the work is safe and compliant.
            </p>
            ...
            <p>
              An EIC is required for all new installations and for alterations or additions to
              existing installations that include new circuits. It consists of:
            </p>
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Replacing a light fitting with a different type</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Adding a fused connection unit to an existing ring final circuit</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Installing an outdoor socket from an existing circuit</span>
              </li>
            </ul>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              understanding of the work, the hazards involved, and the measures needed to carry it
              out safely.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 mt-2">
              <ol className="space-y-2 list-decimal list-inside text-white">
                ...
                <li>
                  Confirm the ceiling void has been inspected for asbestos-containing materials
                  (refer to asbestos survey report)
                </li>
                <li>
                  Set up a mobile tower scaffold in accordance with the manufacturer's instructions
                  (PASMA trained operatives only)
                </li>
                <li>
                  Remove ceiling tiles to gain access to the void. Wear dust mask (FFP2 minimum) and
                  safety glasses
                </li>
                <li>
                  Install cable tray supports at 1.2m maximum centres using appropriate fixings for
                  the building structure
                </li>
                <li>
                  Route cables on cable tray in accordance with the cable schedule (drawing ref:
                  E-101 Rev C)
                </li>
                <li>
                  Maintain a minimum separation of 50mm from data cables at crossings, and 300mm for
                  parallel runs
                </li>
                ...
                <li>
                  Dismantle scaffold and clear the work area of all tools, materials, and waste
                </li>
              </ol>
            </div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Use imperative sentences (commands): "Isolate...", "Verify...", "Install..."
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Avoid jargon that non-electrical trades may not understand</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Do not use humour or informal language — this is a safety document</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Be concise but thorough — every word should serve a purpose</span>
              </li>
            </ul>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              installations, or raising issues on a commercial project, your emails represent you
              and your company. Professional email writing is a skill that will directly affect your
              career success.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 mt-2 font-mono text-xs text-white">
              ...
              <p className="mb-2">
                I am writing to confirm that the consumer unit replacement at your property has been
              ...
              <p className="mb-2">
                All circuits have been tested and are operating correctly. I have attached the
                Electrical Installation Certificate (EIC) and the Building Regulations compliance
                notification for your records. Please keep these documents safe, as they will be
                needed for any future property sale or insurance claim.
              </p>
              <p className="mb-2">
                If you notice any issues with your electrics or have any questions, please do not
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              condition of an installation beyond the standard EICR format. A well-structured
              technical report demonstrates your expertise and provides a clear record for your
              client.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 mt-2">
              ...
              <p className="text-white">
                ...
                the results recorded. 3. A full EICR is recommended, as the presence of one
                unauthorised alteration suggests there may be others.
              </p>
            </div>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            <p>
              ...
              purposes: they support your invoices, provide evidence in disputes, track project
              progress, and create a permanent record that may be needed months or years later.
            </p>
        ...
        >
          ...
          <div className="space-y-3 text-sm text-white leading-relaxed">
            ...
            <ul className="space-y-2">
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Use the same date format throughout (DD/MM/YYYY)</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Use the same unit conventions (always ohm or always omega symbol, not a mix)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Use the same terminology throughout — if you call it a "consumer unit" at the
                  start, do not switch to "distribution board" later in the same document
                </span>
              </li>
            </ul>
            ...
            <p>
              An unsigned or undated certificate has no legal standing. Always check that you have
              signed and dated every page or section that requires it before leaving site. On
              multi-page documents, ensure every page is numbered and referenced.
            </p>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Are all test values recorded correctly and in the right units?</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Are all addresses, names, and dates correct?</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Is the spelling correct, especially of technical terms?</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Are all observations clear, specific, and correctly classified?</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>Have you signed and dated the document?</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-green-400 mt-0.5">&bull;</span>
                <span>
                  Would another electrician understand everything without needing to ask you for
                  clarification?
                </span>
              </li>
            </ul>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4">
              ...
              <p className="text-sm text-white">
                ...
                writing will become obvious when you read it back.
              </p>
            </div>
          </div>
        </motion.div>
