...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Class B', 'Class A', 'Class C', 'Class D'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['0.5mm', '0.7mm', '1.0mm', '0.8mm'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['250 Pa', '1500 Pa', '500 Pa', '1000 Pa'],
    correctAnswer: 2,
    explanation:
...
const HNCModule8Section2_5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 2 · Subsection 5"
      ...
      <HubBody>
        ...
        <ConceptBlock title="Duct Sizing Methods">
          <p>
            Duct sizing determines the cross-sectional area required to convey the design airflow at
            acceptable velocity and pressure drop. Two principal methods are used in UK practice:
            equal friction and velocity reduction, each with distinct advantages for different
            applications.
          </p>
          <p>
            <strong>The Equal Friction Method</strong>
          </p>
          <p>
            This method maintains constant pressure drop per unit length throughout the duct system,
            typically 1.0 Pa/m for low-velocity comfort systems or up to 2.0 Pa/m where space is
            limited.
          </p>
          ...
          <p>
            <strong>The Velocity Reduction Method</strong>
          </p>
          <p>
            Starting with higher velocity at the fan (6-8 m/s), velocity is progressively reduced in
            steps along the duct run to achieve lower velocities (3-4 m/s) at terminal outlets.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Recommended Duct Velocities</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Residential/quiet office:</strong> 4-6 — 3-4 — 2-3
            </li>
            <li>
              <strong>General commercial:</strong> 6-9 — 4-6 — 3-4
            </li>
            <li>
              <strong>Industrial/plant rooms:</strong> 8-12 — 6-9 — 5-8
            </li>
            <li>
              <strong>Hospital/theatre:</strong> 4-5 — 3-4 — 2-3
            </li>
            <li>
              <strong>Kitchen extract:</strong> 10-15 — 8-10 — 6-8
            </li>
          </ul>
          <p>
            <strong>Pressure Drop Calculation</strong>
          </p>
          <p>
            <strong>Straight Duct Sections</strong>
          </p>
          <p>ΔP = f × (L/D) × (ρv²/2)</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Fittings and Components</strong>
          </p>
          <p>ΔP = K × (ρv²/2)</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            <sub>h</sub> = 4A/P where A = cross-sectional area and P = perimeter. This allows use of
            circular duct friction charts.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Ductwork Materials and Construction">
          <p>
            ...
            ductwork in the UK. Material selection depends on the application, with galvanised steel
            being the default for most commercial systems, whilst aluminium or stainless steel serve
            specialist needs.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Galvanised steel:</strong> Standard commercial HVAC — Cost-effective, good
              corrosion resistance
            </li>
            <li>
              <strong>Stainless steel:</strong> Kitchen extract, pharmaceutical, corrosive
              atmospheres — Excellent corrosion resistance, cleanable
            </li>
            <li>
              <strong>Aluminium:</strong> Lightweight applications, external exposed — Lightweight
              (1/3 weight of steel), non-magnetic
            </li>
            <li>
              <strong>Phenolic/PIR board:</strong> Low-velocity supply, acoustic applications —
              Pre-insulated, low thermal bridging, quiet
            </li>
            <li>
              <strong>Flexible duct:</strong> Final connections, short runs only — Easy
              installation, absorbs vibration
            </li>
          </ul>
          <p>
            <strong>DW/144 Material Thickness Requirements (Galvanised Steel)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Up to 300:</strong> 0.5mm — 0.5mm
            </li>
            <li>
              <strong>301 - 450:</strong> 0.7mm — 0.5mm
            </li>
            <li>
              <strong>451 - 750:</strong> 0.8mm — 0.6mm
            </li>
            <li>
              <strong>751 - 1000:</strong> 1.0mm — 0.8mm
            </li>
            <li>
              <strong>1001 - 1500:</strong> 1.2mm — 1.0mm
            </li>
            <li>
              <strong>&gt;1500:</strong> 1.2mm + stiffeners — 1.0mm + stiffeners
            </li>
          </ul>
          <p>
            <strong>Rectangular Duct Advantages</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Circular Duct Advantages</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Aspect Ratio Considerations</strong>
          </p>
          <p>
            For rectangular ducts, the aspect ratio (width ÷ height) should not exceed 4:1. Higher
            aspect ratios result in increased friction losses, uneven velocity distribution, and
            higher material usage. Where possible, aim for aspect ratios of 2:1 or less for optimal
            performance.
          </p>
          <p>
            <strong>Specification note:</strong> Always specify DW/144 compliance in ductwork
            specifications to ensure construction quality. Include pressure class (low/medium/high)
            and leakage class (A/B/C/D) requirements.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Fire and Smoke Dampers">
          <p>
            ...
            of fire compartmentation. Smoke dampers prevent smoke spread through ductwork during the
            critical early stages of a fire when temperatures may not yet trigger fire dampers.
          </p>
          <p>
            <strong>Fire Damper Classifications (BS EN 15650)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>E60:</strong> 60 minutes integrity — Standard commercial - 60 min compartments
            </li>
            <li>
              <strong>E90:</strong> 90 minutes integrity — Enhanced protection - sleeping risk areas
            </li>
            <li>
              <strong>E120:</strong> 120 minutes integrity — High-risk areas, extended evacuation
              time
            </li>
            <li>
              <strong>ES60/ES120:</strong> Integrity + smoke leakage control — Combined fire/smoke
              damper applications
            </li>
          </ul>
          <p>
            <strong>Fire Dampers</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Fire Damper Installation Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Fusible link:</strong> Must be in airstream and visible through access panel
            </li>
            <li>
          ...
          <p>
            <strong>Smoke Damper Leakage Classes (BS EN 1751)</strong>
          </p>
          <p>Class 0</p>
          <p>No requirement</p>
          <p>Class 1</p>
          ...
          <p>
            ...
            instructions. Incorrect installation invalidates fire certification and may not function
            correctly in a fire.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Acoustic Attenuation and Leakage Testing">
          <p>
            Acoustic treatment controls noise transmission through ductwork, whilst leakage testing
            verifies ductwork integrity. Both are essential for energy-efficient, comfortable
            building environments and must be considered during the design stage.
          </p>
          <p>
            <strong>Sources of Ductwork Noise</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fan noise:</strong> Mechanical and aerodynamic sources — Attenuators,
              anti-vibration mounts
            </li>
            <li>
              <strong>Airflow noise:</strong> Turbulence at fittings (∝ v^5-6) — Reduce velocity,
              turning vanes
            </li>
            <li>
              <strong>Terminal noise:</strong> Diffuser/grille regenerated noise — Select low-noise
              terminals, reduce velocity
            </li>
            <li>
              <strong>Breakout noise:</strong> Sound radiating through duct walls — Acoustic
              lagging, heavier duct material
            </li>
            <li>
              <strong>Crosstalk:</strong> Sound transfer between rooms via ducts — Lined duct,
              acoustic crosstalk attenuators
            </li>
          </ul>
          <p>
            <strong>Splitter Attenuators</strong>
          </p>
          <p>
            The most common acoustic attenuator type uses parallel splitters of sound-absorbing
            material (typically glass fibre or mineral wool) to absorb sound energy as air passes
            through.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>DW/144 Ductwork Leakage Classes</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Class A:</strong> 0.027 × p^0.65 L/s per m² — Standard low-pressure commercial
            </li>
            <li>
              <strong>Class B:</strong> 0.009 × p^0.65 L/s per m² — Medium-pressure, enhanced
              commercial
            </li>
            <li>
              <strong>Class C:</strong> 0.003 × p^0.65 L/s per m² — High-pressure, energy-critical
            </li>
            <li>
              <strong>Class D:</strong> 0.001 × p^0.65 L/s per m² — Exceptionally tight, cleanrooms
              and special cases
            </li>
          </ul>
          <p>
            Note: p = test pressure in Pa. For Class A at 400 Pa: 0.027 × 400^0.65 = 1.33 L/s per m²
            duct surface
          </p>
          <p>
            <strong>Leakage Testing Procedure (DW/143)</strong>
          </p>
          <p>
            <strong>Pressure Decay Method</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Constant Pressure Method</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>1. Seal all openings in test section</li>
          ...
          <p>
            <strong>Energy Impact of Ductwork Leakage</strong>
          </p>
          <p>
            A system with 10% duct leakage requires approximately 20-30% more fan power to deliver
            the same airflow to terminals. Modern energy regulations increasingly require the
            tighter Class B or C limits rather than the basic Class A. Testing before insulation
            allows remedial sealing - test sections typically limited to 100-200m² of duct surface
            area for practical reasons.
          </p>
          <p>
            <strong>Best practice:</strong> Specify leakage testing in all ductwork contracts and
            witness testing on site. Remedial sealing after insulation is significantly more costly
            and may not achieve the required class.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Calculate pressure drop through a 90° bend (no vanes) at 6
            m/s velocity.
          </p>
          <p>Using: ΔP = K × (ρv²/2)</p>
          ...
          <p>
            <strong>Scenario:</strong> Verify Class A compliance for a duct section with 150 m²
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Standard commercial leakage class: <strong>Class A</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Ignoring fitting losses</strong> - often 50%+ of total system pressure drop
              </li>
              <li>
