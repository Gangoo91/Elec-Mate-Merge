    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Testing in AM2 isn't finished until the results are recorded on the correct certificates.
          Assessors expect you to fill in documentation clearly, accurately, and in full.
        </p>
        ...
        >
          ...
          <p>
            <strong>Test Results Required:</strong> Continuity, insulation, polarity. Zs, PSC/PSCC,
            RCD results. Risk Assessment / Method Statement (RAMS).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              blank. Reg 644.4 also requires you to record the recommended interval until the first
              periodic inspection (typically 5 years for domestic, less for harsher environments) —
              that field on the EIC is part of the certificate, not optional.
            </>
          }
        ...
        <div className="my-6">
          <VideoCard
            ...
            caption={
              <>
                Craig Wiltshire walks the Schedule of Inspections row by row. AM2 expects every line
                ticked or marked N/A — never blank, never crossed through. Watch how he reasons each
                tick against what was actually inspected on a typical assessment installation.
              </>
            }
          />
        </div>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              with conductor sizes, OCPD type and rating, wiring method. A4:2026 added an exception
              for domestic dwellings (514.9.1 now contains an exception for households), but on the
              AM2 rig you complete the full schedule. Don't leave the conductor size, the cable
              reference method, or the protective device columns blank — they are part of the
              "diagram, chart or table" the reg requires.
            </>
          }
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              the end. <strong>Unrealistic Values:</strong> Recording unrealistic numbers (e.g. 0.00
              Ω for Zs). Writing "infinite" instead of &gt;200 MΩ. Mixing up insulation resistance
              vs continuity values. Using obvious "book answers" from reference materials.
            </>
          }
          doInstead={
            <>
              Record measured values as you test. Use correct units (Ω, MΩ, V, ms). State the meter
              limit (e.g. "&gt;200 MΩ") instead of infinity. Sense-check every figure against the
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              based on the wrong rulebook. Easy mark gone, and it questions whether the test values
              you wrote (Zsmax, RCD routine) are even from the right edition.
            </>
          }
          doInstead={
            <>
              The current standard is <strong>BS 7671:2018+A4:2026</strong>. Write that exactly. The
              figures you cite follow: B32 Zsmax = 1.37 Ω (NOT 1.44), RCD verification at 1×IΔn (NOT
              5×IΔn), documentation reference Reg 132.13 (NOT 132.12). Set the standard reference at
              the top of the certificate first — every other figure has to match it.
            </>
          }
        />
        ...
        >
          ...
          <p>
            <strong>Error Correction:</strong> Single line through error, initial change. Never use
            correction fluid or tape. Date and initial significant corrections.
          </p>
          <p>
        ...
        >
          <p>
            <strong>Continuity Tests — Continuity of CPC:</strong> Expect small values (fractions of
            an ohm). Ring circuit continuity: Typically 0.05-0.5 Ω. Units: Always in Ω (ohms).
          </p>
          <p>
          ...
          <p>
            <strong>Earth Fault Loop Impedance (Zs) — Realistic range:</strong> Typically 0.2-2.0 Ω
            for most circuits. Must align with max permitted for protective device. Check BS
            7671:2018+A4:2026 Table 41.3 for maximum values (B32 = 1.37 Ω).
          </p>
          <p>
            <strong>RCD Testing — Trip time:</strong> Record at 1×IΔn in milliseconds (ms) — A4:2026
            deleted the 5×IΔn test. General-purpose RCD: &lt;300ms at 1×IΔn (Type S: &lt;200ms; Type
            AC/A in dwellings: ≤40ms reaffirmed for additional protection per Reg 415.1.1).
            Polarity: Tick "satisfactory" at each accessory.
          </p>
          <p>
        ...
        >
          <p>
            <strong>During Testing:</strong> Record results as you test — don't leave until the end.
            Write clearly — if assessor can't read it, you lose marks. Check units — always write Ω,
            MΩ, V, ms.
          </p>
          <p>
            <strong>Quality Control:</strong> Double-check results against expected ranges. Compare
            with GN3 and BS 7671 guidance. Keep paperwork tidy — no scribbles or rushed writing.
          </p>
          <p>
            <strong>Time Management:</strong> Allocate 10-15 minutes for paperwork completion. Don't
            rush — accuracy is more important than speed. Review all sections before submitting.
          </p>
          <p>
        ...
        >
          <p>
            ...
            resistance results as "∞." Assessor marked incorrect — failed paperwork section. Lesson:
            Always record meter limit readings like "&gt;200 MΩ" instead of infinity symbols.
          </p>
          <p>
        ...
        >
          ...
          <p>
            <strong>Next Steps:</strong> You're now ready to move on to Section 4, where we'll cover
            functional and operational testing procedures.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              than the meter's 200 MΩ ceiling, Zs at the furthest point = 0.00 Ω. The 0.00 Ω reading
              is what came up on the meter — but you know every circuit has some impedance.
            </>
          }
          whatToDo={
            <>
              Don't write 0.00 Ω. Re-test — that reading is wrong. Common causes: probes touching
              the same terminal, MFT on the wrong range, or the test leads not zeroed. Re-prove the
              leads, set the loop function, take the reading at the actual furthest socket. You
              should land somewhere between Ze (about 0.3 Ω on a typical TN-C-S rig) plus the R1+R2
              you measured (0.42 Ω) — so a sensible Zs is around 0.7-0.9 Ω. Write the new figure.
              For IR, write "&gt;200 MΩ" (or whatever the meter ceiling is) — never the infinity
              symbol.
            </>
          }
          whyItMatters={
            <>
              "0.00 Ω" and "∞" are the two figures assessors flag fastest. Both prove the candidate
              copied a textbook answer instead of taking a measurement. Real readings have noise,
              real meters have ceilings, real cables have impedance — the EIC has to show that.
            </>
          }
        />
