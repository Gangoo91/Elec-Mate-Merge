          ...
          <Card className="border-emerald-500/30 bg-card">
            <CardContent className="p-6">
              <div className="text-center mb-6">
                ...
                <h2 className="text-lg text-emerald-400">Design, Planning & Communication</h2>
              </div>
              ...
              <div className="text-center">
                <Link 
                  to=".."
                  className="inline-flex items-components gap-2 text-sm text-muted-foreground hover:text-emerald-400 transition-colors"
                >
