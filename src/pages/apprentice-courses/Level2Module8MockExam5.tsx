...
import {
  ...
  module5QuestionBank,
  type QuestionBank,
} from '@/data/apprentice-courses/level2/module5/questionBank';
...
const Level2Module8MockExam5 = () => {
  ...
  const history = useMockExamHistory('level2-module8-mock5', user?.id ?? null);
  const failureRates = useQuestionFailureRates(
    'level2-module8-mock5',
  ...
  useEffect(() => {
    ...
    recordMockExamAttempt({
      examSlug: 'level2-module8-mock5',
      source: 'in_app',
      examName: 'Level 2 Mock Exam 5',
      questions: examQuestions,
  ...
  if (!examStarted) {
    return (
      <ExamStartPanel
        ...
        title="Module 5: Communicate with others within building services"
        subtitle="Level 2 Electrical Installation - Mock Exam 5 (C&G 2365-02 Unit 210)"
        totalQuestions={60}
        ...
        topics={[
          'Site roles',
          'Statutory framework',
          'Workplace & customer information',
