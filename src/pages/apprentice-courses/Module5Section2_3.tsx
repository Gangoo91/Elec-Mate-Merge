      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">1. Purpose of Protective Devices</h3>
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-4">
                      <div>
                        <p className="text-base text-white mb-2"><strong>Prevent Overheating:</strong></p>
                      ...
                      <div>
                        <p className="text-base text-white mb-2"><strong>Automatic Disconnection:</strong></p>
                        <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
                      ...
                      <div>
                        <p className="text-base text-white mb-2"><strong>Electric Shock Protection:</strong></p>
                        <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">2. Miniature Circuit Breakers (MCBs)</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-4">
                      <div>
                        <p className="text-base text-white mb-2"><strong>MCB Operating Principles:</strong></p>
                        <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
                      ...
                      <div>
                        <p className="text-base text-white mb-2"><strong>MCB Ratings (Amperes):</strong></p>
                        <div className="bg-[#121212]/50 p-3 rounded border mb-2">
                          <div className="grid md:grid-cols-2 gap-4">
                            <div>
                              <p className="font-medium text-white mb-2">Common Domestic Ratings:</p>
                      ...
                      <div>
                        <p className="text-base text-white mb-2"><strong>MCB Types (Trip Characteristics):</strong></p>
                        <div className="space-y-3">
                          <div className="bg-[#121212]/30 p-4 rounded border">
                            <p className="font-medium text-white mb-2">Type B - Domestic Applications</p>
                            <div className="grid md:grid-cols-2 gap-4">
                              <div>
                          ...
                          <div className="bg-[#121212]/30 p-4 rounded border">
                            <p className="font-medium text-white mb-2">Type C - Light Commercial</p>
                            <div className="grid md:grid-cols-2 gap-4">
                              <div>
                                <ul className="text-xs sm:text-sm text-white list-disc ml-4 space-y-1">
                          ...
                          <div className="bg-[#121212]/30 p-4 rounded border">
                            <p className="font-medium text-white mb-2">Type D - Industrial Applications</p>
                            <div className="grid md:grid-cols-2 gap-4">
                              <div>
                                <ul className="text-xs sm:text-sm text-white list-disc ml-4 space-y-1">
                      ...
                      <div>
                        <p className="text-base text-white mb-2"><strong>Advanced MCB Features:</strong></p>
                        <div className="grid md:grid-cols-2 gap-3">
                          <div className="bg-[#121212]/50 p-3 rounded border">
                            <p className="font-medium text-white mb-1">Technical Features</p>
                      ...
                      <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded border border-green-200 dark:border-green-800">
                        ...
                        <div className="text-xs sm:text-sm text-white space-y-2">
                          ...
                          <div className="bg-[#121212]/30 p-2 rounded">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">3. Residual Current Devices (RCDs)</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-4">
                      <div>
                        <p className="text-base text-white mb-2"><strong>How RCDs Work:</strong></p>
                        <ul className="text-xs sm:text-sm text-white ml-4 list-disc space-y-1">
                      ...
                      <div>
                        <p className="text-base text-white mb-2"><strong>RCD Types and Ratings:</strong></p>
                        <div className="grid md:grid-cols-2 gap-4">
                          <div className="bg-[#121212]/50 p-3 rounded border">
                            <p className="font-medium text-white mb-2">Sensitivity Ratings</p>
                            <ul className="text-xs sm:text-sm text-white space-y-1">
                          ...
                          <div className="bg-[#121212]/50 p-3 rounded border">
                            <p className="font-medium text-white mb-2">RCD Types by Waveform</p>
                            <ul className="text-xs sm:text-sm text-white space-y-1">
                      ...
                      <div>
                        <p className="text-base text-white mb-2"><strong>Operating Time Requirements (BS 7671):</strong></p>
                        <div className="bg-[#121212]/50 p-3 rounded border mb-2">
                          <div className="grid md:grid-cols-2 gap-4">
                            <div>
                              <p className="font-medium text-white mb-1">Standard Operating Times</p>
                              <ul className="text-xs sm:text-sm text-white space-y-1">
                      ...
                      <div>
                        <p className="text-base text-white mb-2"><strong>RCD Installation Considerations:</strong></p>
                        <div className="grid md:grid-cols-2 gap-3">
                          <div className="bg-[#121212]/50 p-3 rounded border">
                            <p className="font-medium text-white mb-1">Technical Considerations</p>
                            <ul className="text-xs text-white list-disc ml-4 space-y-1">
                          ...
                          <div className="bg-[#121212]/50 p-3 rounded border">
                            <p className="font-medium text-white mb-1">Common Installation Issues</p>
                            <ul className="text-xs text-white list-disc ml-4 space-y-1">
                      ...
                      <div>
                        <p className="text-base text-white mb-2"><strong>RCBO vs RCD + MCB:</strong></p>
                        <div className="grid md:grid-cols-2 gap-3">
                          <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded border border-green-200 dark:border-green-800">
                      ...
                      <div className="bg-orange-50 dark:bg-orange-900/20 p-3 rounded border border-orange-200 dark:border-orange-800">
                        ...
                        <div className="grid md:grid-cols-2 gap-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-white mb-1">Solutions:</p>
                            <ul className="text-xs text-white list-disc ml-4 space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">4. Coordinating MCBs and RCDs</h3>
            <p className="text-base text-white mb-4">
            ...
            <div className="bg-[#121212]/50 p-4 rounded-lg border border-white/10 mb-4">
              <div className="space-y-3">
                <p className="text-base text-white"><strong>Typical Coordination Examples:</strong></p>
          ...
          {/* BS 7671 Guidance */}
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">5. BS 7671 Guidance</h3>
            <p className="text-base text-white mb-4">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">6. Modern Protective Technologies</h3>
            <p className="text-base text-white mb-4">
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-4">
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="bg-[#121212]/30 p-4 rounded border">
                          <p className="font-medium text-white mb-2">AFDDs (Arc Fault Detection Devices)</p>
                          <ul className="text-xs sm:text-sm text-white list-disc ml-4 space-y-1">
                        ...
                        <div className="bg-[#121212]/30 p-4 rounded border">
                          <p className="font-medium text-white mb-2">SPDs (Surge Protection Devices)</p>
                          <ul className="text-xs sm:text-sm text-white list-disc ml-4 space-y-1">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="bg-[#121212]/30 p-4 rounded border">
                          <p className="font-medium text-white mb-2">Smart Protection Systems</p>
                          <ul className="text-xs sm:text-sm text-white list-disc ml-4 space-y-1">
                        ...
                        <div className="bg-[#121212]/30 p-4 rounded border">
                          <p className="font-medium text-white mb-2">Future Developments</p>
                          <ul className="text-xs sm:text-sm text-white list-disc ml-4 space-y-1">
