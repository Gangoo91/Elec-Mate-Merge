...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['North-facing', 'South-facing', 'West-facing', 'East-facing'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['U-value', 'Visible light transmittance', 'g-value (solar factor)', 'Frame material'],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Part O integrates overheating directly into Building Regulations. Natural ventilation
              is permitted but must be evidenced — the simplified method is geometry/orientation
              rules; the dynamic method is TM59 hour-by-hour analysis. CIBSE Guide A provides the
              engineering basis for both.
            </>
          }
        ...
        <ConceptBlock title="Passive Design Fundamentals">
          <p>
            ...
            prioritises reducing energy demand before considering how remaining demand is met - the
            foundation of sustainable building design.
          </p>
          <p>
            <strong>Key passive design principles:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fabric first:</strong> Invest in building envelope before mechanical systems
            </li>
            <li>
          ...
          <p>
            <strong>Passive vs Active Design Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Heating:</strong> Solar gain, insulation, thermal mass — Boilers, heat pumps,
              radiators
            </li>
            <li>
              <strong>Cooling:</strong> Shading, ventilation, night purge — Chillers, air
              conditioning, FCUs
            </li>
            <li>
              <strong>Ventilation:</strong> Natural cross-flow, stack effect — AHUs, extract fans,
              ductwork
            </li>
            <li>
              <strong>Lighting:</strong> Daylighting, light shelves, rooflights — LED luminaires,
              control systems
            </li>
            <li>
              <strong>Energy use:</strong> Minimal operational energy — Continuous energy
              consumption
            </li>
          </ul>
          <p>
            <strong>The Energy Hierarchy</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Reduce demand:</strong> Passive design, fabric performance
            </li>
            <li>
              <strong>2. Use energy efficiently:</strong> High-efficiency systems, heat recovery
            </li>
            <li>
              <strong>3. Supply from renewables:</strong> PV, solar thermal, heat pumps
            </li>
            <li>
              <strong>4. Offset remaining carbon:</strong> Green tariffs, carbon credits
            </li>
          </ul>
          <p>
            <strong>Design principle:</strong> Every kWh of demand reduced through passive measures
            is worth more than a kWh generated - it saves capital cost, maintenance, and space
        ...
        <ConceptBlock title="Solar Orientation and Daylighting">
          <p>
            Solar orientation determines how buildings interact with the sun throughout the day and
            year. Optimal orientation maximises beneficial winter solar gain whilst minimising
            summer overheating risk, while providing adequate daylight to reduce artificial lighting
            requirements.
          </p>
          <p>
            <strong>South-Facing (UK)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Daylighting Design Parameters</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Daylight Factor:</strong> Internal/external illuminance ratio — 2% minimum, 5%
              for tasks
            </li>
            <li>
              <strong>Uniformity Ratio:</strong> Min/average daylight factor — ≥0.4 for good
              distribution
            </li>
            <li>
              <strong>Daylit Depth:</strong> Distance daylight penetrates — 1.5-2.5 × window head
              height
            </li>
            <li>
              <strong>Glazing Ratio:</strong> Window area / floor area — 15-25% typical office
            </li>
            <li>
              <strong>View Out:</strong> Visual connection to outside — 75% of floor area with view
            </li>
          </ul>
          <p>
            <strong>Daylighting strategies:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Light tubes:</strong> Channel daylight to internal rooms via reflective ducts
            </li>
          </ul>
          <p>
            <strong>Best practice:</strong> Design for 300-500 lux average daylight in workspaces.
            Provide daylight-linked dimming controls to maximise energy savings from natural light.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Natural Ventilation Strategies">
          <p>
            ...
            buildings without mechanical fans. When designed correctly, natural ventilation provides
            fresh air, removes heat and pollutants, and significantly reduces energy consumption
            compared to fully air-conditioned buildings.
          </p>
          <p>
            <strong>Natural Ventilation Driving Forces</strong>
          </p>
          <p>
            <strong>Wind-Driven (Cross Ventilation)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Buoyancy-Driven (Stack Effect)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Ventilation Strategy Options</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Single-Sided:</strong> Openings on one facade only — Rooms ≤2.5× ceiling
              height deep
            </li>
            <li>
              <strong>Cross Ventilation:</strong> Openings on opposite/adjacent walls — Narrow plan
              buildings (≤15m)
            </li>
            <li>
              <strong>Stack Ventilation:</strong> Vertical shafts or atria — Multi-storey, deep plan
              buildings
            </li>
            <li>
              <strong>Wind Towers:</strong> Roof-mounted wind catchers — Hot climates, traditional
              buildings
            </li>
            <li>
              <strong>Mixed Mode:</strong> Natural with mechanical backup — UK offices, schools,
              hospitals
            </li>
          </ul>
          <p>
            <strong>Design requirements for natural ventilation:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Clear air paths:</strong> Internal doors, transfer grilles, open plan layouts
            </li>
            <li>
          ...
          <p>
            <strong>Ventilation Rate Calculation (Stack Effect)</strong>
          </p>
        ...
        <ConceptBlock title="Thermal Mass and Passive Cooling">
          ...
          <p>
            <strong>Thermal Mass Properties of Common Materials</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Dense concrete:</strong> 2400 — 1000 — High
            </li>
            <li>
              <strong>Brick:</strong> 1700 — 800 — High
            </li>
            <li>
              <strong>Water:</strong> 1000 — 4186 — Very high
            </li>
            <li>
              <strong>Timber:</strong> 500 — 1600 — Low
            </li>
            <li>
              <strong>Steel:</strong> 7800 — 450 — Medium
            </li>
          </ul>
          <p>
            <strong>Accessing Thermal Mass</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Night Purge Ventilation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Passive Cooling Strategies</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>External solar shading:</strong> Prevents solar gain entering — 30-50%
            </li>
            <li>
              <strong>Night purge ventilation:</strong> Pre-cools thermal mass — 20-40%
            </li>
            <li>
              <strong>Exposed thermal mass:</strong> Absorbs peak gains — 15-25%
            </li>
            <li>
              <strong>Solar control glazing:</strong> Reduces transmitted radiation — 20-35%
            </li>
            <li>
              <strong>Green roofs/walls:</strong> Evaporative cooling, insulation — 10-20%
            </li>
          </ul>
          <p>
            <strong>Solar Shading Design</strong>
          </p>
          <p>
            <strong>South facades:</strong> Horizontal overhangs or brise-soleil - effective against
            high summer sun
          </p>
          <p>
            <strong>East/West facades:</strong> Vertical fins or adjustable louvres - needed for
            low-angle sun
          </p>
          <p>
          ...
          <p>
            <strong>Phase Change Materials (PCMs)</strong>
          </p>
          <p>
            PCMs (typically paraffin waxes or salt hydrates) melt at around 21-25°C, absorbing
            significant latent heat without temperature rise. When incorporated into ceiling tiles,
            plasterboard, or dedicated panels, PCMs provide thermal mass equivalent to much heavier
            concrete. Particularly valuable in lightweight construction where traditional thermal
            mass is impractical. PCM systems can absorb 100-200 Wh/m² of ceiling area.
          </p>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Calculate average daylight factor for a 6m × 8m office with a
            south-facing window 4m wide × 1.8m high, head height 2.7m from floor.
          </p>
          ...
          <p>
            Result: DF ~2% meets minimum; supplementary artificial lighting needed for task areas
          </p>
          <p>
          ...
          <p>
            <strong>Scenario:</strong> Assess thermal mass capacity of exposed 200mm concrete soffit
            in a 100m² office to absorb next-day heat gains.
          </p>
          ...
          <p>
            Result: Soffit can absorb 25 W/m² of heat gains - significant contribution to cooling
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Suspended ceilings hiding thermal mass</strong> - coordinate with acoustics
                early
              </li>
              <li>
                <strong>Relying on internal blinds for solar control</strong> - heat already inside
              </li>
              <li>
              ...
              <li>
                <strong>Ignoring security/weather for night ventilation</strong> - openings must be
                secure and rain-proof
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A 38 m² studio flat on the south aspect of a residential block. Single-aspect (no
              cross-ventilation), full-height glazing, 1.5 m balcony overhang. Part O TM59 dynamic
              modelling shows operative temperature exceeding 26°C for 480 hours/year (limit ~3% =
              263 hours). Design fails Part O.
            </>
          }
          whatToDo={
            <>
              Three options: (1) external solid shading (brise-soleil, deep recessed reveals) —
              typically 30–50% reduction in overheating hours, often architecturally challenging;
              (2) reduce glazing area and add insulated spandrel panels — most effective but
              visually intrusive; (3) mechanical cooling (MVHR with summer bypass + limited active
              cooling) — works technically but adds capital and operational cost. Most common
              solution is a combination of moderate glazing reduction + external shading + MVHR with
              night purge. Re-run TM59 to verify.
            </>
          }
          whyItMatters={
            <>
              Part O has been the most disruptive change to residential design in a decade.
              Single-aspect dwellings on hot facades are the worst case. The cheapest fix is at
              concept stage (orientation, dual aspect, glazing area); by RIBA Stage 4 only
              mechanical cooling typically works. Engage the M&E and overheating engineer at Stage
              1.
            </>
          }
        />
