...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['0.024s', '0.094s', '0.235s', '0.470s'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Ib ≥ In ≥ Iz', 'Iz ≤ In ≤ Ib', 'In ≤ Ib ≤ Iz', 'Ib ≤ In ≤ Iz'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 432 establishes the device-selection principle. The protective device must match
              the protection function: overload only (gG fuse, Type B/C/D MCB), fault only (HRC
              current-limiting fuse), both (MCB / MCCB), or both with discrimination (MCCB with
              adjustable instantaneous trip). As designer you specify the device type for each
              circuit, justify the selection against the load characteristic (resistive, motor,
              transformer, capacitor) and document it on the schedule of tests.
            </>
          }
        ...
        <ConceptBlock title="Overload Protection — Regulation 433">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Reg 433.1.1(i):</strong> Ib ≤ In ≤ Iz — device rating between load and cable
              capacity
            </li>
            <li>
              <strong>Reg 433.1.1(ii):</strong> I₂ ≤ 1.45 × Iz — effective operating current within
              limit
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ib:</strong> design current — the current intended to flow in normal service
            </li>
            <li>
              <strong>In:</strong> nominal current — the rated current of the protective device
            </li>
            <li>
              <strong>Iz:</strong> current-carrying capacity — the maximum continuous current the
              cable can carry
            </li>
            <li>
        ...
        <ConceptBlock title="Short-Circuit Protection — Regulation 434">
          ...
          <p>
            <strong>The adiabatic equation:</strong> t = k²S²/I² — maximum fault clearance time to
          ...
          <p>
            <strong>
              Breaking capacity requirements (device type / typical Icn / application):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Earth Fault Protection — Regulation 411">
          ...
          <p>
            <strong>
              Automatic disconnection times (system / final circuits ≤32A / distribution circuits):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Protection Coordination Principles">
          <p>
            ...
            discrimination. The hierarchy must be designed so the device nearest the fault operates
            first.
          </p>
          <p>
          ...
          <p>
            <strong>
              When separate devices are required (application / overload protection / short-circuit
              protection):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            final circuits, confirming breaking capacities, disconnection times, and discrimination
            ratios.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — verifying overload protection:</strong> A 7.5kW single-phase heater
            operates at 230V. The cable Iz is 36A. Is a 32A MCB suitable?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Example 3 — earth fault loop verification:</strong> A TN system has Ze = 0.35Ω.
            A 32A Type B MCB protects 20m of 2.5mm² cable (R1+R2 = 14.82mΩ/m). Verify protection.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Forgetting temperature correction</strong> — multiply measured Zs by 1.2 for
                verification
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A 10&nbsp;kVA control transformer feeds a small machine-shop sub-panel. Inrush current
              is around 8–10× FLC for the first cycle, settling to 2–3× for several cycles. With FLC
              ≈ 14&nbsp;A, the inrush touches 100–140&nbsp;A briefly. A Type B 16&nbsp;A MCB has
              been fitted and is nuisance-tripping on energisation each morning. The maintenance
              team want a fix that does not compromise fault-current protection.
            </>
          }
          whatToDo={
            <>
              Type B trips at 3–5× I_n instantaneously — explains the nuisance trips. Type C trips
              at 5–10× I_n: a Type C 16&nbsp;A clears at ≈ 80–160&nbsp;A instantaneous, still tight
              against a 140&nbsp;A inrush. Type D (10–20× I_n) is the right selection for
              transformer / motor inrush: a Type D 16&nbsp;A clears at 160–320&nbsp;A instantaneous,
              comfortably above the inrush. Reg 432 requires the device type to suit the load —
              change to Type D 16&nbsp;A. Re-verify the fault-current adiabatic check (Reg 434.5.2):
              higher instantaneous threshold means slower clearance on a low-level fault, so confirm
              Z_s satisfies Table 41.3 for Type D.
            </>
          }
          whyItMatters={
            <>
              Reg 432 makes device-type selection a design decision matched to the load
              characteristic. Defaulting to Type B everywhere triggers nuisance trips on inductive /
              transformer loads; defaulting to Type D everywhere risks slower fault clearance that
              may breach Reg 411 disconnection times.
            </>
          }
        />
