...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'To increase cable current rating',
      'To allow longer cable runs',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['50-100 Hz', '2-16 kHz', '50-100 kHz', '1-5 MHz'],
    correctAnswer: 1,
    explanation:
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Screened cables:</strong> Essential for EMC compliance
              </li>
              <li className="pl-1">
                <strong>EMC filters:</strong> Required at drive supply input
              </li>
              <li className="pl-1">
                <strong>360-degree earthing:</strong> Screens at both cable ends
              </li>
              <li className="pl-1">
                <strong>Motor parameters:</strong> Must match nameplate exactly
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Accel/decel ramps:</strong> 5-15s typical for HVAC
              </li>
              <li className="pl-1">
                <strong>Minimum frequency:</strong> 20-30Hz for centrifugal pumps
              </li>
              <li className="pl-1">
                <strong>Cable separation:</strong> 300mm from signal cables
              </li>
              <li className="pl-1">
                <strong>Commissioning:</strong> Document all parameters
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Screened/shielded construction:</strong> Braided copper screen or foil
                  with drain wire
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Appropriate voltage rating:</strong> Consider voltage spikes from
                  reflections
                </li>
                <li className="pl-1">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Symmetrical cores, copper braid screen, PE outer
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Steel or copper braided screen, flexible
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Suitable for shorter runs, panel connections
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">Screened SWA</td>
                      <td className="border border-white/10 px-3 py-2">
                        Armour over copper tape screen
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                        EMC-compliant trunking
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Metal trunking with bonded joints
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Screened cable usually sufficient
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">25-100m</td>
                      <td className="border border-white/10 px-3 py-2">
                        Consider output reactor (choke) at drive
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">&gt; 100m</td>
                      <td className="border border-white/10 px-3 py-2">
                        dV/dt filter or sine-wave filter essential
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white/90">
                ...
                all new installations. For existing motors, output filters should be considered.
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Key rule:</strong> Cable selection affects EMC compliance, motor life and
              system reliability. Never substitute standard cable types to reduce costs.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Sources of EMC Emissions
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Conducted emissions:</strong> High-frequency noise conducted back onto
                  mains supply
                </li>
                <li className="pl-1">
                  <strong>Radiated emissions:</strong> Electromagnetic fields from motor cables
                  acting as antennas
                </li>
                <li className="pl-1">
                  <strong>Common-mode currents:</strong> High-frequency currents flowing through
                  earth paths
                </li>
                <li className="pl-1">
              ...
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                        C2 (Second environment)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Industrial, restricted distribution
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Less strict, internal EMC filter typically sufficient
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Dedicated industrial installation
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        No conducted emission limits (radiated only)
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  <li className="pl-1">
                    <strong>Common-mode choke:</strong> Blocks high-frequency noise on all
                    conductors
                  </li>
                  <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>360-degree termination:</strong> Use EMC glands providing full
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>HVAC context:</strong> Building management systems are particularly
              susceptible to VSD interference. Proper EMC installation prevents false readings,
              communication errors and control instability.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Thermal protection, current limit
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                        Motor nominal voltage (Un)
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Base frequency for V/f control
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Slip calculation, speed feedback
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Auto-tuning, parameter estimation
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Magnetising current calculation
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Rotating tune:</strong> Measures at various speeds (motor must be
                  uncoupled)
                </li>
                <li className="pl-1">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Prevent water hammer, check valves
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        High inertia, belt slip prevention
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Large inertia, avoid regeneration
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Motor insulation:</strong> Measure IR with motor disconnected (&gt;1M ohm
                  at 500V DC)
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Supply voltage:</strong> Confirm within drive specification (+/-10%
                  typical)
                </li>
                <li className="pl-1">
                  <strong>Mechanical checks:</strong> Coupling alignment, guards fitted, rotation
                  free
                </li>
              </ul>
            </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Short circuit, earth fault, incorrect parameters, seized motor
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Check motor IR, verify parameters, inspect for mechanical jam
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Motor winding fault, cable damage, moisture ingress
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Rapid deceleration, high inertia load, regenerating
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Increase decel time, consider braking resistor
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Supply dips, supply loss, loose connections
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Overload condition, incorrect motor current setting
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Verify motor In parameter, check load condition
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Blocked cooling, high ambient, overload
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Clean filters, check ventilation, reduce load
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Open circuit in motor or cable, loose connection
                      </td>
                      <td className="border border-white/10 px-3 py-2">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white/90">
                ...
                equipment, supply voltage variations during building peak loads, and thermal issues
                that appear only when drive/motor reaches operating temperature.
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Cable Selection for AHU Fan
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> An 11kW AHU supply fan motor is located 45 metres from
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  Recommendation: 4mm sq. screened VSD cable with output reactor
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Acceleration Time Calculation
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2">
                  Angular acceleration: alpha = T / J = 148.2 / 12 = 12.35 rad/s squared
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Troubleshooting Earth Fault
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  Solution: Dry out motor, reseal terminal box, install breather
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 4: EMC Filter Selection
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> A 7.5kW VSD is being installed in a hospital plantroom
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2 text-green-400">
                  Note: Install EMC filter as close to drive as possible
                </p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Motor IR test:</strong> &gt;1M ohm at 500V DC minimum (&gt;100M ohm
                  preferred)
                </li>
                <li className="pl-1">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Deceleration time:</strong> 10-60s depending on inertia and regen
                  capability
                </li>
                <li className="pl-1">
                  <strong>Minimum frequency:</strong> 20-30Hz for centrifugal pumps
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Pigtail screen termination:</strong> Creates antenna, use 360-degree
                  glands
                </li>
                <li className="pl-1">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Immediate OC on start:</strong> Check motor parameters, look for
                  short/earth fault
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Intermittent trips:</strong> Check connections, look for thermal or EMC
                  issues
                </li>
                <li className="pl-1">
                  <strong>Motor overheating:</strong> Check load, verify cooling, check minimum
                  speed
                </li>
              </ul>
            </div>
