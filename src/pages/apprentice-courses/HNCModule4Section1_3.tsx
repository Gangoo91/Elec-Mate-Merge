...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['280 kVA', '160 kVA', '250 kVA', '200 kVA'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['About 16%', 'About 10%', 'About 5%', 'About 25%'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['kVAr² = kW² + kVA²', 'kW² = kVA² + kVAr²', 'kVA² = kW² + kVAr²', 'kW = kVA × kVAr'],
    correctAnswer: 2,
    explanation:
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              proper-functioning duty under (b) covers economic and reliable operation — leaving a
              building running at 0.7 power factor wastes DNO capacity, oversizes cables and
              switchgear and exposes the client to reactive-energy charges. Power factor correction
              is a design decision, not an afterthought, and your sign-off under 132.1 carries the
              responsibility.
            </>
          }
        ...
        <ConceptBlock title="Power Factor Fundamentals">
          <p>
            ...
            affecting everything from cable sizing to electricity costs. Understanding power factor
            is essential for efficient building services design.
          </p>
          <p>
        ...
        <ConceptBlock title="Impact on Supply Capacity">
          <p>
            ...
            infrastructure is rated by current-carrying capacity, which means poor power factor uses
            more of the available supply capacity for the same useful power.
          </p>
          <p>
          ...
          <p>
            <strong>Design impact:</strong> A building at 0.7 pf needs 43% more supply capacity than
            one at unity pf for the same useful power.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="DNO Requirements">
          <p>
            UK Distribution Network Operators require customers to maintain adequate power factor at
            the point of supply. This is both a technical requirement (network capacity) and a
          ...
          <p>
            <strong>Note:</strong> Check with your local DNO for specific requirements — these vary
            between operators and may change.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Fixed PFC on variable loads</strong> — leads to over-correction at low load
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              power factor of 0.78 lagging. The DNO connection agreement specifies a 0.95 minimum
              and the client is being billed for kVArh. Loads: 8 × 22&nbsp;kW induction motors on
              conveyors (varies by shift), some compressors, LED area lighting and a small office
              wing. The client wants a payback under 3 years.
            </>
          }
          whatToDo={
            <>
              Use kVAr = kW × (tan φ₁ − tan φ₂) = 220 × (tan 38.7° − tan 18.2°) = 220 × (0.802 −
              0.329) = ≈ 104 kVAr to bring 220&nbsp;kW from 0.78 to 0.95. Specify automatic PFC
              (load varies by shift), 6–8 step controller, sized at 110–125&nbsp;kVAr for growth
              headroom, with detuned reactors (typically 7% or 14%) if any VSDs are present or
              harmonic survey shows distortion. Locate at the main LV panel. Document the
              calculation against Reg 132.1 design-objective duty.
            </>
          }
          whyItMatters={
            <>
              A switch from 0.78 to 0.95 reduces apparent power from 282&nbsp;kVA to 232&nbsp;kVA —
              a 50&nbsp;kVA capacity release without a single DNO upgrade. Reactive-energy charges
              typically pay back the PFC investment in 18–30 months. Skip the detuned reactors and
              the capacitors blow on the harmonic spectrum within months.
            </>
          }
        />
