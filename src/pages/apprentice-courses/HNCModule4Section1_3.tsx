      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Power factor:</strong> kW/kVA = cos φ (0 to 1.0)
              </li>
              <li className="pl-1">
                <strong>Lagging pf:</strong> Caused by inductive loads (motors)
              </li>
              <li className="pl-1">
                <strong>DNO requirement:</strong> Typically 0.95 minimum
              </li>
              <li className="pl-1">
                <strong>Correction:</strong> Capacitors supply local reactive power
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Motors:</strong> 0.7-0.85 pf typical uncorrected
              </li>
              <li className="pl-1">
                <strong>LED drivers:</strong> 0.5-0.95 depending on quality
              </li>
              <li className="pl-1">
                <strong>UPS systems:</strong> Unity or leading pf possible
              </li>
              <li className="pl-1">
                <strong>Impact:</strong> Affects transformer/cable sizing
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Power Factor Values by Load Type
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Current Increase Due to Poor Power Factor
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-3">
                DNOs may apply charges for excessive reactive power consumption:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Connection Agreement Implications
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
