...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      'Convert AC to DC then back to AC at a new frequency',
      'Convert a DC battery supply directly into mains AC',
      'Step a 230 V supply up to 400 V three-phase',
      'Correct the power factor of an inductive load',
    ],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'AC chargers feed DC straight into the vehicle battery',
      'All home chargers supply 400 V three-phase to the car',
      'Rapid chargers rely on the car to rectify AC internally',
  ...
  },
  {
    ...
    options: [
      'DC cannot be carried over overhead lines at any voltage',
      'AC suffers no power losses regardless of the distance',
      'AC is easily transformed to higher/lower voltages with transformers',
      'AC requires thinner conductors than DC for the same power',
    ],
    correctAnswer: 2,
    explanation:
