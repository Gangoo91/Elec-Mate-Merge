...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['350Hz', '50Hz', '250Hz', '150Hz'],
    correctAnswer: 2,
    explanation:
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'BS 7671 Appendix 4 Section 5.5 gives the rating factors. Reg 523.6.3 makes the neutral a loaded conductor once third-harmonic distortion exceeds 15% of the fundamental line current, and requires the neutral to be no smaller than the line conductors. Reg 524.2.2 then warns that above 33% triplen content an increase in neutral cross-sectional area may be required. Appendix 4 worked example: at 33-45% third harmonic, size the cable on the neutral current with a 0.86 rating factor, where In = 3 x (h/100) x I_line. Reg 431.2.3 also requires overcurrent detection in the neutral, so a 4-pole device.',
  },
  {
...
const HNCModule4Section1_4 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 1 · Subsection 4"
        title="Harmonic Assessment"
        backTo="/study-centre/apprentice/h-n-c-module4-section1"
      />
      <HubBody>
        ...
        <TLDR
          points={[
            ...
            'BS 7671 Reg 524.2.3(a) requires the ‘expected maximum current including harmonics’ to be used when sizing the neutral conductor.',
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Reg 524.2.3(a) explicitly requires harmonic content to be included in the expected
              maximum neutral current. For modern offices and commercial buildings with LED lighting
              and IT equipment, third-harmonic content above 33% means the neutral can carry as much
              as the line — sometimes more. Designers must size the neutral against this current,
              not the line current alone, and apply Appendix 4 grouping/derating factors to reflect
              the true thermal duty.
            </>
          }
          cite="Source: BS 7671:2018+A4:2026 — Regulations 523.6.3, 524.2.2 and 524.2.3(a); BS 7671 Appendix 4 Section 5.5; ENA Engineering Recommendation G5/4-1."
        />
        ...
        <ConceptBlock title="Effects on Neutral Conductors">
          ...
          <p>
            <strong>Critical warning:</strong> A circuit with 50% third harmonic per phase can have
            neutral current equal to 1.5 times the phase current. Standard neutral sizing (equal to
            or smaller than phase) is inadequate for high harmonic loads.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>0-15% 3rd harmonic:</strong> ≤45% of phase — standard sizing (= phase or 50%)
            </li>
            <li>
          ...
          <p>
            <strong>BS 7671 requirements (Regs 523.6.3 / 524.2.2, Appendix 4 Section 5.5):</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Engineering Recommendation G5/4-1">
          <p>
            ...
            for harmonic voltage distortion and customer emission limits. It applies to all
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Stage 3 — network study:</strong> full harmonic penetration study using power
              system analysis software, required for large or complex installations
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — THD calculation:</strong> A VSD draws 100A fundamental with 30A 5th
            and 20A 7th harmonic. Calculate THDi.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 2 — neutral current:</strong> Three phases each carry 50A with 40% third
            harmonic. Calculate neutral current.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Example 3 — filter sizing:</strong> Total VSD load is 200kW at 0.95 pf. THDi is
            40%. Size an active filter to achieve &lt;8% THDi.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              A 1,200&nbsp;m² open-plan office has just had a full LED panel retrofit alongside 300
              new desktop workstations. The FM team report the sub-main neutral is running
              10–15&nbsp;°C hotter than the lines and a thermal-imaging survey shows the neutral bar
              in the DB clearly warmer than the phase bars. THD-i measured at 38% on the 3rd
              harmonic.
            </>
          }
          whatToDo={
            <>
              Apply Reg 524.2.3(a): the expected neutral current must include harmonics. With 3rd
              harmonic above 33%, the neutral on a balanced three-phase circuit can equal or exceed
              the line current. Recalculate the sub-main against BS 7671 Appendix 4 Section 5.5
              ...
              drivers and PCs with active PFC at next refresh. Consider an active or hybrid filter
              at the DB if THD-i above 50%.
            </>
          }
          whyItMatters={
            <>
              Under-sized neutrals overheat insulation, accelerate cable failure and create a fire
              risk. Reg 524.2.3(a) makes inclusion of harmonic content in neutral sizing a mandatory
              design step — getting caught with a degraded neutral after a workstation refresh is a
              defendable design failure. ENA G5/4-1 emission limits also apply at the supply
              boundary.
            </>
          }
        />
        ...
        <KeyTakeaways
          points={[
            ...
            'Reg 524.2.3(a) makes inclusion of harmonic content mandatory when sizing neutral conductors — ‘expected maximum current including harmonics’.',
            ...
            'BS 7671 Appendix 4 Section 5.5 gives the rating factors for triplen-harmonic loaded circuits — used alongside the Appendix 4 grouping factors. (Section 5.6 covers 5th, 7th and higher harmonics in the line conductors.)',
            ...
            'Size for the future: harmonic content tends to rise with each tech refresh. Today’s 30% THD is tomorrow’s 50%.',
          ]}
        />
