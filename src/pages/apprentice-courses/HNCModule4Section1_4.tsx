      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Harmonics:</strong> Integer multiples of 50Hz fundamental
              </li>
              <li className="pl-1">
                <strong>Cause:</strong> Non-linear loads (VSDs, SMPS, LEDs)
              </li>
              <li className="pl-1">
                <strong>THD:</strong> Total Harmonic Distortion percentage
              </li>
              <li className="pl-1">
                <strong>G5/4-1:</strong> UK emission limits standard
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>VSDs:</strong> 5th, 7th harmonics significant
              </li>
              <li className="pl-1">
                <strong>LED lighting:</strong> 3rd harmonic from drivers
              </li>
              <li className="pl-1">
                <strong>Neutral sizing:</strong> May exceed phase current
              </li>
              <li className="pl-1">
                <strong>Transformers:</strong> K-rated for harmonic loads
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                A circuit with 50% third harmonic per phase can have neutral current equal to 1.5
                times the phase current. Standard neutral sizing (equal to or smaller than phase) is
                inadequate for high harmonic loads.
              </p>
            </div>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Neutral Current with Harmonics
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                BS 7671 Requirements (Appendix 11)
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">Consider harmonic content when sizing neutrals</li>
                <li className="pl-1">
                  For single-core cables, neutral may need to be larger than phase
                </li>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Typical VSD Harmonic Current Spectrum (6-Pulse)
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Small drives (&lt;30kW):</strong> Standard with DC choke usually
                  acceptable
                </li>
                <li className="pl-1">
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2">
                  Total neutral current ≈ <strong>60A</strong>
                </p>
