  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 2,
      explanation:
        'The Health and Safety at Work Act 1974 is the primary legislation requiring employers to provide safe working environments for all workers.',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      correctAnswer: 0,
      explanation:
        'Barriers, exclusion zones, and warning signs help protect people from falling objects during overhead work.',
    },
    {
      id: 4,
      question: 'What is the first step when preparing to work near live circuits?',
      options: ['Put on PPE', 'Isolate and lock off power', 'Set up lighting', 'Check tools'],
      correctAnswer: 1,
      explanation:
        'The first and most critical step is to isolate and lock off power to ensure no live circuits pose a danger during work.',
    },
    {
      id: 5,
      ...
      correctAnswer: 0,
      explanation:
        'Adequate lighting prevents mistakes, improves safety, and ensures quality work by allowing accurate installation and inspection.',
    },
    {
      id: 6,
      question: 'Which type of lighting is commonly used for temporary site lighting?',
      options: ['Halogen floodlight', 'LED work light', 'Candle lamp', 'Neon tube'],
      correctAnswer: 1,
      explanation:
        'LED work lights are commonly used for temporary site lighting due to their efficiency, durability, and bright output.',
    },
    {
      id: 7,
      ...
      correctAnswer: 0,
      explanation:
        'Available space and clear access routes must be checked to ensure materials can be safely transported and stored in the work area.',
    },
    {
      id: 8,
      ...
      correctAnswer: 0,
      explanation:
        'Clear walkways prevent trips and falls, and ensure emergency access routes remain available at all times.',
    },
  ];
  ...
  const quickChecks = [
    {
      ...
      correctIndex: 1,
      explanation:
        'Trip hazards must be removed to prevent accidents and ensure safe movement around the work area, maintaining clear access for workers and emergency services.',
    },
    {
      id: 'lighting-check',
      ...
      correctIndex: 2,
      explanation:
        'Portable LED work lights are commonly used to provide adequate lighting in areas where fixed lighting is insufficient.',
    },
    {
      id: 'safety-check',
      question:
        'What must be done with live circuits before starting electrical work in that area?',
      options: [
        'Put up warning signs only',
      ...
      correctIndex: 2,
      explanation:
        'Live circuits must be isolated and locked off using proper lockout procedures to ensure worker safety.',
    },
  ];
  ...
  const accessConsiderations = [
    {
      ...
      factors:
        'Doorway dimensions, corridor clearance, scaffolding access points, material delivery routes',
      standards:
        '600mm minimum clearance, adequate headroom, emergency exit compliance, disability access',
    },
    {
      ...
      standards:
        '600mm around equipment, sufficient headroom, clear emergency routes, adequate ventilation',
    },
    {
      ...
      standards:
        'PASMA for towers, 3:1 ratio for ladders, guardrails above 2m, inspection certificates',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-10">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm text-white">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    <strong>Spot:</strong> Trip hazards, inadequate lighting, overhead services.
                  </li>
                  <li>
                    <strong>Use:</strong> Proper isolation procedures, adequate lighting, barriers.
                  </li>
                  <li>
                    <strong>Check:</strong> Access routes, lighting levels, safety measures.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm text-white">
              ...
              <li>
                Identify hazards and take steps to control or eliminate them before starting work.
              </li>
          ...
          <section className="mb-10">
            ...
            <Quiz questions={quizQuestions} title="Test Your Knowledge: Preparing the Work Area" />
          </section>
