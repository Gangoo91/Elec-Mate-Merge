...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1.09 ohms', '1.37 ohms', '2.19 ohms', '0.69 ohms'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['1 second maximum', '200ms maximum', '300ms maximum', '40ms maximum'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The EIC + Schedules are the formal, legal record that the installation has been
              verified and meets BS 7671. They are signed by the designer, constructor and verifier
              (often the same person on small jobs). Issuing without proper verification is a
              regulatory breach and a criminal exposure under EAWR. Treat certification as the
              closure of commissioning, not a paperwork chore.
            </>
          }
        ...
        <ConceptBlock title="Test Sequences and Procedures">
          <p>
            The sequence of testing is critical - each test validates the safety of subsequent tests
            and confirms results of previous tests. Dead tests must always precede live tests.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Continuity (R1+R2):</strong> Low resistance ohmmeter — Compare with calculated
              values
            </li>
            <li>
          ...
          <p>
            <strong>
              Ring final circuit testing — three-step ring test confirms continuity and identifies
              interconnections:
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Building services note:</strong> Large installations require systematic testing
            by distribution board, with clear marking of tested circuits.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Certification and Documentation">
          <p>
            Proper certification is a legal requirement under BS 7671 and the Building Regulations.
            The type of certificate depends on the nature of the work undertaken.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Schedule 2 - Construction:</strong> Signed by Constructor/Installer — Confirms
              work constructed to design and BS 7671
            </li>
            <li>
              <strong>Schedule 3 - Inspection:</strong> Signed by Inspector — Confirms inspected and
              tested, complies with BS 7671
            </li>
            <li>
        ...
        <ConceptBlock title="Switchgear Commissioning and Energisation">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Preparation:</strong> Confirm all dead tests complete, area secured, personnel
              briefed
            </li>
            <li>
            ...
            <li>
              <strong>Initial energisation:</strong> Energise incomer only, verify voltage and phase
              rotation
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Submain protection:</strong> Discrimination with upstream, let-through energy
            </li>
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — Insulation resistance testing:</strong> A distribution board with 12
            circuits requires insulation resistance testing. Three circuits have electronic dimmers.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Damaging equipment</strong> — insulation testing with electronics connected
              </li>
              <li>
                <strong>Incorrect Zs comparison</strong> — using tabulated values without 0.8 factor
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A new 1600A LV switchboard is to be energised. The DNO transformer is live to the
              cable head. The electrical sub turns up on a Saturday with no method statement, no
              isolation procedure documented, no witness, and no schedule of test results. They
              energise the board cold; the upstream protection trips on a fault on a connected
              sub-main. The investigation is delayed because there are no contemporaneous records.
            </>
          }
          whatToDo={
            <>
              Stop. Energisation of LV switchgear is a high-risk activity requiring a documented
              procedure: confirm IR test passed and recorded, polarity verified, all downstream
              circuits isolated, witness present, energisation sequence (transformer secondary →
              busbar → outgoing breakers in turn), test under no-load then progressive load.
              Document each step. Re-brief the team on energisation discipline as an EAWR Reg 4 / BS
              7671 requirement.
            </>
          }
          whyItMatters={
            <>
              Energisation is the moment when years of installation become live. Defects buried in
              cable, switchgear or terminations become safety hazards when energised. Discipline at
              this stage protects life, equipment and project — and creates the audit trail that
              supports the EIC.
            </>
          }
        />
