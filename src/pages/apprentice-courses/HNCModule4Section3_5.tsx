...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['IΔn ≤ 10mA', 'IΔn ≤ 100mA', 'IΔn ≤ 30mA', 'No RCD requirement'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1.15Ω', '0.72Ω', '1.44Ω (pre-A4)', '1.37Ω (A4:2026)'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['AC only', 'Smooth DC only', 'AC and pulsating DC', 'High-frequency only'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['40ms', '500ms', '300ms', '130ms'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              additional protection requirement now bites on more circuits. The only escape is a
              documented risk assessment in non-dwellings. Reg 411.3.4, also new in A4:2026,
              additionally requires 30&nbsp;mA RCDs on AC final circuits supplying luminaires in
              domestic premises. For kitchens (multiple wet appliances) and bathrooms (zone
              restrictions), specify Type A or F RCBOs as default — Type AC is now obsolete in most
              modern installations because of the prevalence of pulsating-DC fault paths from
              electronics.
            </>
          }
        ...
        <ConceptBlock title="RCD Types and Characteristics">
          ...
          <p>
            <strong>
              RCD operating times — BS 7671:2018+A4:2026 verification (test current / general
              instantaneous / Type S time-delayed):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Additional Protection (Regulation 415)">
          <p>
            ...
            circuits where there's increased risk of direct contact or where basic protection may be
            compromised.
          </p>
          <p>
          ...
          <p>
            <strong>
              BS 7671 Regulation 411.3.3 requirements (application / requirement / notes):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="TN and TT System Requirements">
          ...
          <p>
            <strong>Formula:</strong> Zs ≤ U<sub>o</sub> / I<sub>a</sub> — where Ia is the current
            causing automatic disconnection in required time.
          </p>
          <p>
            <strong>
              TN system maximum Zs values — BS 7671:2018+A4:2026 Table 41.3 (230V, 0.4s):
            </strong>
          </p>
          <p>
            For Type B 32A the maximum Zs is <strong>1.37Ω</strong> (the older 1.44Ω was the pre-A4
            figure before Cmin = 0.95 was applied to U<sub>0</sub> in Reg 411.4.4). Read all other
            device ratings directly from the current Table 41.3 — A4:2026 reduced every tabulated
            maximum by ~5% versus pre-A4. Do not work from memorised pre-A4 values on design or
            verification.
          </p>
          <p>
            <strong>TT system earth fault protection:</strong> In TT systems, the earth fault path
            includes the installation's earth electrode resistance (RA), which is typically much
            higher than the TN metallic path. RCDs are almost always required.
          </p>
          <p>
            <strong>Formula:</strong> R<sub>A</sub> × I<sub>Δn</sub> ≤ 50V — limits touch voltage on
            exposed-conductive-parts during a fault.
          </p>
          <p>
            <strong>
              TT system maximum RA values (RCD rating IΔn / maximum RA / typical use):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Key point:</strong> TT systems require RCDs because fault currents are typically
            too low to operate overcurrent devices within required times.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Time-Delayed RCDs and Discrimination">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Current discrimination:</strong> upstream IΔn &gt; downstream IΔn (e.g., 100mA
              vs 30mA)
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              Final circuits — instantaneous — 30mA — ≤300ms @ IΔn (BS 7671 A4:2026 verification per
              Reg 643.8)
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            protection. A fault on one circuit doesn't affect others. Split-load boards with shared
            RCDs will disconnect all circuits on that RCD for any single circuit fault.
          </p>
          <p>
            <strong>Design consideration:</strong> For critical installations, use individual RCBOs
            or dedicated RCDs per circuit to maximise discrimination and supply availability.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            ...
            circuit with measured Zs = 0.85Ω at the furthest point. Is disconnection time adequate?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>From BS 7671:2018+A4:2026 Table 41.3:</li>
            <li>
              32A Type B MCB max Zs = <strong>1.37Ω</strong> for 0.4s (Cmin = 0.95 applied to U
              <sub>0</sub>)
            </li>
          ...
          <p>
            <strong>Example 3 — RCD type selection for VSD circuit:</strong> A 7.5kW variable speed
            drive supplies an AHU fan. What RCD type is required?
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              A new-build dwelling. Kitchen has socket-outlets serving the worktop, an integrated
              dishwasher, washing machine, induction hob and downlighters. Bathroom has shower,
              towel rail, mirror demister, fan and downlighters. The client wants fewer nuisance
              trips — one RCD covering everything has caused the whole upstairs to lose power on a
              single dishwasher fault.
            </>
          }
          whatToDo={
            <>
              Apply Reg 411.3.3 (A4:2026): 30&nbsp;mA RCD on every socket-outlet ≤ 32&nbsp;A. Apply
              Reg 411.3.4 (A4:2026): 30&nbsp;mA RCD on every AC final circuit supplying luminaires
              in the dwelling. Specify individual 30&nbsp;mA Type A RCBOs per circuit — not shared
              RCDs. This means a fault on the dishwasher trips only the dishwasher, not the kitchen
              lights or the bathroom. For the induction hob (often 30+&nbsp;A), confirm if
              it&rsquo;s a 32&nbsp;A or 40&nbsp;A circuit — Reg 411.3.3 applies up to 32&nbsp;A.
              Test under A4:2026 method: single-shot 1×IΔn (NOT 5×IΔn — that was older guidance),
              confirm disconnection within 300&nbsp;ms.
            </>
          }
          whyItMatters={
            <>
              Sharing one RCD across multiple circuits guarantees nuisance trips and complaints.
              A4:2026 widened the 411.3.3 socket-outlet RCD requirement to 32&nbsp;A and introduced
              411.3.4 for luminaires in dwellings — both push the design toward per-circuit RCBOs.
              Use the older 5×IΔn test method on certification and the EICR is technically
              non-compliant.
            </>
          }
        />
