    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Essential reference guide for AM2 fault-finding procedures. Keep this handy during your
        ...
        <div className="space-y-6">
          ...
          <RegsCallout
            ...
            meaning={
              <>
                ...
                terminations, missing CPCs, wrong polarity) are deliberately set under Reg 134, and
                verification (initial + after alteration) is what your testing proves under Reg 643.
                When you write your answer, frame it in this language: identify the workmanship
                defect, describe the workmanship-quality fix, name the verification test that
                confirms compliance.
              </>
            }
          ...
          <Scenario
            ...
            whatToDo={
              <>
                <strong>Don't touch anything yet.</strong> First 5 minutes: visual walkaround. Look
                at the consumer unit, look at every accessory, note circuit names, identify the
                isolation point. Then put the kettle on (figuratively). When you start testing, your
                very first action is safe isolation: prove voltage indicator on a known live source,
                isolate at the CU, prove dead, re-prove the indicator. Only THEN start dead testing.
                Methodical opening sets the tone for everything that follows.
              </>
            }
            whyItMatters={
              <>
                The most common AM2 failure isn't getting the fault wrong — it's rushing the start.
                Candidates skip safe isolation under time pressure and either (a) get marked instant
                fail or (b) trip a live RCD when they shouldn't and confuse themselves. 5 minutes of
                methodical observation saves 30 minutes of chaos.
              </>
            }
          />
          ...
          <CommonMistake
            ...
            whatHappens={
              <>
                You walk in determined to identify what the fault is. You jab around with the meter,
                spot something wrong, write "earth fault at SO2 — fix it" and feel relieved.
                Assessor marks you partial because there's no methodology shown, no test sequence,
                no rectification format, no re-test. Even though you found the fault, you didn't
                prove competence.
              </>
            }
            doInstead={
              <>
                AM2 marks the JOURNEY, not just the destination. Talk through your symptom analysis,
                name your test choices, record actual values, format rectification properly, name
                the re-test. Even if you misidentify the exact fault location, demonstrating method
                earns method marks. Random guessing earns nothing.
              </>
            }
          />
          ...
          <ConceptBlock title="Module 5 Complete">
            <p className="text-ios-body text-white leading-relaxed">
              ...
              sheet summarises all the key concepts from the module. Use it as a study aid and refer
              back to it before your assessment.
            </p>
          </ConceptBlock>
