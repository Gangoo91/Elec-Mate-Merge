                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Very high starting torque, speed varies inversely with load, can runaway at
                        no load
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Traction, cranes, hoists, starter motors
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Nearly constant speed, good regulation, moderate starting torque
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Machine tools, pumps, fans, conveyors
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        High starting torque with better speed regulation than series
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Lifts, presses, rolling mills
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Field from separate DC supply
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Excellent speed control, linear characteristics
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Precision drives, Ward-Leonard systems
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        PM field (no field winding)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Similar to shunt, compact, efficient at small sizes
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Small fans, automotive, battery tools
                      </td>
                    </tr>
                  </tbody>
                </table>
              ...
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                        Armature voltage (PWM)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Vary V<sub>a</sub> from 0 to rated
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Reduce field current (increase If rheostat)
                      </td>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Flat (series compensates drop)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Automotive (historically)
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Back-EMF exceeds supply, motor becomes generator
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Returned to supply/battery
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Armature connected to resistors, motor generates
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Supply polarity reversed while running
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        High dissipation in motor
                      </td>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              ...
              <p className="text-sm text-white mb-2">
                <strong>Historical:</strong> DC motors dominated lift applications for decades due
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Excessive brush sparking:</strong> Wrong brush grade, incorrect brush
                  position, worn commutator, open armature coil
                </li>
                <li className="pl-1">
                  <strong>Motor fails to start:</strong> Open circuit in armature or field, seized
                  bearings, mechanical jam
                </li>
                <li className="pl-1">
                  <strong>Motor runs slowly:</strong> Low supply voltage, high armature resistance,
                  weak field
                </li>
                <li className="pl-1">
                  <strong>Motor overspeeds:</strong> Open shunt field, series motor at no load
                </li>
                <li className="pl-1">
                  <strong>Overheating:</strong> Overload, poor ventilation, high ambient,
                  short-circuit turns
                </li>
              </ul>
            </div>
