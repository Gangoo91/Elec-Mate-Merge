...
const quickCheckQuestions = [
  {
    ...
    options: ['Shunt motor', 'Compound motor', 'Series motor', 'Separately excited motor'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1875 rpm', '1500 rpm', '1200 rpm', '1800 rpm'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Almost every legacy DC lift you encounter as a BSE engineer is a modernisation
              candidate &mdash; the cost of replacement parts for old Ward-Leonard sets, brush gear
              and rotary commutators usually exceeds the whole-lift PMSM + VSD upgrade price. Doing
              so brings the lift under BS EN 81-20/-50 and gains 40&ndash;60 % energy improvement.
            </>
          }
        ...
        <ConceptBlock title="In 30 seconds">
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Series motors:</strong> High starting torque, speed varies with load
            </li>
            <li>
              <strong>Shunt motors:</strong> Constant speed, good regulation
            </li>
            <li>
              <strong>Compound motors:</strong> Combine series and shunt characteristics
            </li>
            <li>
              <strong>BLDC:</strong> Electronic commutation, maintenance-free
            </li>
          </ul>
          <p className="text-sm font-medium text-elec-yellow/80">Building Services Context</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lifts:</strong> Historically DC, now PMSM with VFD
            </li>
            <li>
              <strong>Legacy HVAC:</strong> Older damper actuators and fans
            </li>
            <li>
              <strong>Battery systems:</strong> UPS, emergency equipment
            </li>
            <li>
              <strong>BLDC fans:</strong> EC motors in modern ventilation
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="DC Motor Construction and Operation">
          <p>
            ...
            (converting electrical energy to mechanical) or generators (converting mechanical energy
            to electrical). Their construction comprises stationary field poles and a rotating
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Rotor (armature):</strong> Carries the armature windings that produce torque
              when carrying current
            </li>
            <li>
              <strong>Commutator:</strong> Segmented copper cylinder that reverses current direction
              in armature coils
            </li>
            <li>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Fundamental Motor Equations</p>
          ...
          <p>EMF proportional to flux and speed</p>
          ...
          <p>Torque proportional to flux and current</p>
          ...
          <p>
            ...
            only by winding resistance. Starters or electronic control are essential to limit inrush
            current.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="DC Motor Types - Series, Shunt, and Compound">
          <p>
            ...
            This configuration determines the motor's speed-torque characteristics and suitability
            for different applications.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">DC Motor Types Comparison</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Series</strong> — Field in series with armature — Very high starting torque,
              speed varies inversely with load, can runaway at no load — Traction, cranes, hoists,
              starter motors
            </li>
            <li>
              <strong>Shunt</strong> — Field in parallel with armature — Nearly constant speed, good
              regulation, moderate starting torque — Machine tools, pumps, fans, conveyors
            </li>
            <li>
              <strong>Compound (cumulative)</strong> — Both series and shunt fields — High starting
              torque with better speed regulation than series — Lifts, presses, rolling mills
            </li>
            <li>
              <strong>Separately excited</strong> — Field from separate DC supply — Excellent speed
              control, linear characteristics — Precision drives, Ward-Leonard systems
            </li>
            <li>
              <strong>Permanent magnet</strong> — PM field (no field winding) — Similar to shunt,
              compact, efficient at small sizes — Small fans, automotive, battery tools
            </li>
          </ul>
        ...
        <ConceptBlock title="Speed-Torque Characteristics">
          ...
          <p>
            Speed regulation = (N<sub>no-load</sub> - N<sub>full-load</sub>) / N<sub>full-load</sub>{' '}
            x 100%
          </p>
          <p>Typical values:</p>
        ...
        <ConceptBlock title="Armature Reaction and Commutation">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Field distortion:</strong> Main flux is distorted, strengthened at one pole
              tip and weakened at the other
            </li>
            <li>
              <strong>MNA shift:</strong> Magnetic neutral axis shifts in the direction of rotation
              (motor) or opposite (generator)
            </li>
            <li>
              <strong>Reduced flux:</strong> Cross-magnetising effect can reduce effective main flux
              (flux weakening)
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Compensating windings:</strong> Windings in main pole faces cancel armature
              reaction
            </li>
            <li>
              <strong>Brush shift:</strong> Older method - move brushes to new neutral axis (varies
              with load)
            </li>
            <li>
              <strong>High-resistance brushes:</strong> Reduce circulating current in commutating
              coils
            </li>
          </ul>

          <p>
            <strong>Maintenance note:</strong> Brush sparking indicates commutation problems. Check
            brush pressure, commutator condition, interpole gaps, and ensure brushes are on the
            correct neutral axis.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Speed Control Methods">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Armature voltage (PWM)</strong> — Vary V<sub>a</sub> from 0 to rated — 0 to
              base speed — High (90%+)
            </li>
            <li>
              <strong>Field weakening</strong> — Reduce field current (increase If rheostat) — Base
              speed to 2-3x base — High
            </li>
            <li>
              <strong>Armature resistance</strong> — Add resistance in armature circuit — 0 to base
              speed — Low (I<sup>2</sup>R losses)
            </li>
            <li>
              <strong>Ward-Leonard</strong> — Motor-generator set with field control — Full range,
              reversible — Moderate (3 machines)
            </li>
          </ul>
          ...
          <p>
            ...
            below base speed. Field weakening above base speed gives constant power (torque reduces
            as speed increases).
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="DC Generators and Excitation">
          <p>
            DC generators produce direct current from mechanical input. While largely superseded by
            AC generation with rectification, understanding DC generator principles is essential for
            maintenance of existing systems and for understanding motor operation in regenerative
            mode.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">DC Generator Excitation Types</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Separately excited</strong> — External DC source — Drops slightly with load —
              Ward-Leonard systems
            </li>
            <li>
              <strong>Self-excited shunt</strong> — From own output (parallel) — Relatively constant
              — General purpose DC supply
            </li>
            <li>
              <strong>Self-excited series</strong> — From own output (series) — Rises with load —
              Arc welding, boosters
            </li>
            <li>
              <strong>Compound (level)</strong> — Both series and shunt — Flat (series compensates
              drop) — Automotive (historically)
            </li>
          </ul>

          <p className="text-sm font-medium text-white">Build-up of Self-Excited Generators</p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Residual magnetism:</strong> Must exist in poles (if lost, flash field from
              external DC)
            </li>
            <li>
              <strong>Correct field polarity:</strong> Field current must strengthen residual flux,
              not oppose it
            </li>
            <li>
              <strong>Field resistance:</strong> Must be below critical value where OCC and field
              line intersect
            </li>
            <li>
              <strong>Sufficient speed:</strong> Prime mover must drive above minimum required speed
            </li>
          </ul>

          <p>
            <strong>Maintenance tip:</strong> If a self-excited generator fails to build up voltage,
            check for loss of residual magnetism. A brief application of DC to the field (flashing)
            can restore it.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Brushless DC Motors (BLDC)">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Advantages over Brushed DC</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">BLDC in Building Services</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>EC fans:</strong> Electronically commutated fans for HVAC - high efficiency,
              variable speed
            </li>
            <li>
        ...
        <ConceptBlock title="Regenerative Braking">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Types of Electric Braking</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Regenerative</strong> — Back-EMF exceeds supply, motor becomes generator —
              Returned to supply/battery — Lifts, EVs, trains
            </li>
            <li>
              <strong>Dynamic (rheostatic)</strong> — Armature connected to resistors, motor
              generates — Dissipated as heat — Cranes, older lifts
            </li>
            <li>
              <strong>Plugging (counter-current)</strong> — Supply polarity reversed while running —
              High dissipation in motor — Emergency stops (rare)
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Regeneration in Lifts</p>
          <p>Lift systems regenerate energy in two scenarios:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Descending with heavy load:</strong> Gravitational potential energy converted
              to electrical
            </li>
            <li>
          ...
          <p className="text-sm text-white mt-2">
            Energy can be fed back to the building supply, stored in batteries/supercapacitors, or
            dissipated in braking resistors if regeneration is not possible.
          </p>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A 230V DC shunt motor has an armature resistance of 0.5 ohm
            and draws 20A at full load when running at 1200 rpm. Calculate (a) the back-EMF at full
            load, and (b) the starting current if connected directly to supply.
          </p>
          ...
          <p>This is 23x full-load current - a starter is essential!</p>

          <p className="text-sm font-medium text-elec-yellow/80">
            Example 2: Speed Control by Field Weakening
          </p>
          <p>
            <strong>Question:</strong> A DC shunt motor runs at 1000 rpm with full field current. If
            the field current is reduced to 80% of its original value, calculate the new speed
          ...
          <p>Field weakening increases speed above base value</p>
          ...
          <p>
            ...
            load, regenerating at 80% of rated power. If the DC bus voltage is 600V and losses are
            5%, calculate the power returned to the supply.
          </p>
          ...
          <p>This current flows back into the supply or to other loads</p>
        </ConceptBlock>

        <SectionRule />

        <ConceptBlock title="Practical Guidance">
          <p className="text-sm font-medium text-elec-yellow/80">DC Motor Maintenance Checklist</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Brushes:</strong> Check wear, spring tension, freedom of movement in holders
            </li>
            <li>
            ...
            <li>
              <strong>Windings:</strong> Measure insulation resistance, check for overheating signs
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Speed regulation:</strong> (N<sub>nl</sub> - N<sub>fl</sub>) / N<sub>fl</sub>{' '}
              x 100%
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              A 12-storey commercial building has two passenger lifts dating from 1973 with DC
              Ward-Leonard control (3-phase induction motor &rarr; DC generator &rarr; DC traction
              motor). Spares are increasingly hard to source and annual energy consumption per lift
              is ~38,000 kWh. The lift contractor quotes a like-for-like rebuild at &pound;42k or a
              full PMSM + VSD modernisation at &pound;110k.
            </>
          }
          whatToDo={
            <>
              Recommend the PMSM + VSD upgrade. Reasoning: (a) Energy &mdash; PMSM + regenerative
              VSD typically halves lift energy, ~19,000 kWh/year saved per lift = ~&pound;3,800 per
              lift per year &rarr; ~5 year payback on the differential; (b) brings the lift under BS
              EN 81-20/-50 which is required for any insurance and DDA / Equality Act compliance;
              (c) eliminates rotary commutator brush maintenance; (d) regen back into the busbar
              offsets other building load. Document the lifecycle case to the building owner.
            </>
          }
          whyItMatters={
            <>
              Most BSE engineers will encounter at least one DC lift modernisation in their career.
              The HNC understanding of DC machine principles is what lets you intelligently
              challenge the contractor&rsquo;s &ldquo;like for like&rdquo; default and unlock the
              larger but more cost-effective upgrade.
            </>
          }
        />
