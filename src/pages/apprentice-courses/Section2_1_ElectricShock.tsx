...
const DESCRIPTION =
  'Understanding electric shock, arc flash, thermal burns, first aid procedures, and prevention strategies for electrical workers. EAWR and BS 7671 compliance.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Never touch someone receiving an electric shock until the power is isolated. Make the situation safe first to avoid becoming a casualty yourself.',
  },
  {
    id: 2,
    ...
    correctIndex: 1,
    explanation:
      'Arc flash occurs when electrical current travels through the air between conductors or from conductor to ground, creating intense heat and pressure.',
  },
  {
    id: 3,
    question: 'How long should electrical burns be cooled with running water?',
    options: ['5 minutes', '10 minutes', 'At least 20 minutes', 'Until ambulance arrives'],
    correctIndex: 2,
    explanation:
      'HSE guidance recommends cooling burns with cool running water for at least 20 minutes to reduce tissue damage.',
  },
  {
    id: 4,
    ...
    correctIndex: 0,
    explanation:
      'Hand-to-hand current path across the chest is most dangerous as it passes through the heart and can cause cardiac arrest.',
  },
];
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Hand-to-hand current path across the chest is most dangerous as it directly affects the heart and can cause ventricular fibrillation.',
    },
    {
      id: 2,
      question: "At what current level can 'let-go' become impossible for most people?",
      options: ['1-5 mA', '5-10 mA', '10-20 mA', '50-100 mA'],
      correctAnswer: 2,
      explanation:
        "At 10-20 mA, muscular control is lost and 'let-go' becomes impossible for most people due to muscle contraction.",
    },
    {
      id: 3,
      question: 'What temperature can an arc flash reach?',
      options: ['1,000°C', '5,000°C', '10,000°C', "Up to 20,000°C (hotter than the sun's surface)"],
      correctAnswer: 3,
      explanation:
        "Arc flash temperatures can reach up to 20,000°C, which is four times hotter than the sun's surface, causing severe burns instantly.",
    },
    {
      id: 4,
      ...
      correctAnswer: 0,
      explanation:
        'AC is generally more dangerous as it causes stronger muscle contractions and interferes more with heart rhythm at power frequencies (50Hz).',
    },
    {
      id: 5,
      ...
      correctAnswer: 2,
      explanation:
        'After ensuring safety, check responsiveness and breathing. Call 999 for serious injuries, unconsciousness, or breathing problems.',
    },
    {
      id: 6,
      ...
      correctAnswer: 0,
      explanation:
        'Arc flash PPE must be rated for the calculated incident energy at the working distance, determined by arc flash risk assessment.',
    },
    {
      id: 7,
      ...
      correctAnswer: 1,
      explanation:
        'EAWR Regulations 13 and 14: work dead wherever possible; live work only when unreasonable to work dead with suitable precautions.',
    },
    {
      id: 8,
      ...
      correctAnswer: 1,
      explanation:
        'Safe isolation ensures circuits are completely dead and secured against re-energisation, preventing electric shock during work.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        'Current magnitude, voltage level, current path through body, duration of contact, frequency (AC/DC), body resistance (affected by moisture, skin condition), and individual health factors all influence shock severity.',
    },
    {
      question: 'How does RCD protection help prevent electric shock?',
      answer:
        'RCDs detect imbalance between live and neutral currents (indicating current leakage to earth) and disconnect the supply within 30-40 milliseconds, before dangerous current levels can cause harm.',
    },
    {
      question: 'What should I do if I witness an electrical accident?',
      answer:
        "Don't touch the casualty while power is on. Isolate supply if safe to do so. Call 999 for serious injuries. If trained and safe, provide first aid including CPR if needed. Preserve the scene for investigation.",
    },
    {
      question: 'How can I identify arc flash hazards?',
      answer:
        'Look for electrical equipment with exposed live parts, switching operations, fault conditions, and work on energised equipment. Arc flash risk assessments should identify hazards and required PPE levels.',
    },
    {
      question: "What's the difference between electrical burns and thermal burns?",
      answer:
        'Electrical burns occur when current passes through tissue, causing internal damage. Thermal burns result from arc flash heat. Both can occur simultaneously and require immediate cooling and medical attention.',
    },
  ];
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 text-base text-foreground">
            <div className="rounded-lg p-4 bg-card/10 border border-border/20">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  Arc flash creates extreme heat (up to 20,000°C) causing severe burns and pressure
                  waves.
                </li>
                <li>Immediate isolation of power and proper first aid can save lives.</li>
                <li>
                  Prevention through safe isolation procedures and appropriate PPE is essential.
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-4 border-l-elec-yellow border border-elec-yellow/30">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>Spot:</strong> Exposed live parts, damaged equipment, wet conditions,
                  missing covers.
                </li>
                <li>
                  <strong>Use:</strong> Safe isolation procedures, GS38 voltage testers, appropriate
                  PPE ratings.
                </li>
                <li>
                  <strong>Check:</strong> RCD operation, equipment condition, environmental hazards,
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <ul className="list-disc pl-6 space-y-2 text-base text-foreground">
            <li>
              Understand the physiological effects of electric shock and factors affecting severity.
            </li>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
                ...
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Threshold levels:</strong> Different current levels cause different
                      physiological effects.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      <li>
                        <strong>1-5 mA:</strong> Perception threshold - barely noticeable tingling
                      </li>
                      <li>
                        <strong>5-10 mA:</strong> Maximum safe current - uncomfortable sensation
                      </li>
                      <li>
                        <strong>10-20 mA:</strong> Muscular control lost - 'let-go' threshold
                        exceeded
                      </li>
                      <li>
                        <strong>50-100 mA:</strong> Ventricular fibrillation possible - potentially
                        fatal
                      </li>
                      <li>
                        <strong>100+ mA:</strong> Certain ventricular fibrillation and cardiac
                        arrest
                      </li>
                    </ul>
                    <p className="text-base text-foreground mb-2">
                      <strong>Critical factors:</strong> Current path and duration determine
                      severity.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>AC vs DC effects:</strong> Different characteristics affect danger
                      level.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Key principle:</strong> Current through the body, not voltage alone,
          ...
          <section className="mb-6">
            ...
            <p className="text-base text-foreground mb-4">
              Arc flash events create extreme hazards beyond electric shock, requiring specific
              protection measures:
            </p>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Arc flash formation:</strong> Electrical arc creates multiple severe
                      hazards.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Common arc flash scenarios:</strong> Situations where arc flash is
                      most likely.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Protection strategies:</strong> Multi-layered approach to arc flash
                      safety.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Key principle:</strong> Arc flash energy decreases with distance -
          ...
          <section className="mb-6">
            ...
            <p className="text-base text-foreground mb-4">
              Proper emergency response can mean the difference between life and death in electrical
              accidents:
            </p>
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-red-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-red-600 dark:text-elec-yellow mb-1">
                      Immediate Response Procedure
                    </p>
                    <p className="text-base text-foreground mb-2">
                      <strong>Step 1 - Make safe:</strong> Isolate the electrical supply immediately
                      if safe to do so.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Step 2 - Assess casualty:</strong> Check responsiveness and breathing.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Step 3 - Treat burns:</strong> Cool burns immediately and
                      appropriately.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Remember:</strong> Electrical burns may be more severe internally than
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">
              Prevention Strategies and Safe Systems
            </h3>
            <p className="text-base text-foreground mb-4">
              Preventing electrical injuries through systematic safety measures and legal
              compliance:
            </p>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>EAWR compliance:</strong> Legal framework for electrical safety.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>Safe isolation procedure:</strong> Systematic approach to ensuring
                      safety.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2">
                      <strong>PPE and protection systems:</strong> Last line of defence.
                    </p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                      <li>
                        RCD protection: 30mA for socket outlets, higher ratings for fixed equipment
                      </li>
                    ...
                    <div className="text-xs sm:text-sm text-foreground bg-background/50 p-2 rounded border">
                      <strong>Hierarchy:</strong> Eliminate hazard → Control hazard → PPE as last
                      resort
                    </div>
                  </div>
                </div>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="bg-card/10 p-4 rounded-lg border border-border/20 mb-4">
            <p className="font-medium text-foreground mb-2">
              Scenario: Electrical Accident Response
            </p>
            <p className="text-base text-foreground">
              An apprentice electrician contacts a live 230V cable while working in a distribution
              board. A colleague witnesses the incident.
            </p>
          </div>
          <div className="space-y-4 text-base text-foreground">
            <div>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>
                  <strong>1. Make safe:</strong> Colleague immediately isolates main supply to
                  distribution board
                </li>
                <li>
                  <strong>2. Assess casualty:</strong> Apprentice is conscious but shaken,
                  complaining of arm pain
                </li>
                <li>
                  <strong>3. Emergency response:</strong> Call 999 as electrical contact injury
                  requires hospital assessment
                </li>
                <li>
                  <strong>4. First aid:</strong> Check for burns, treat if present, monitor for
                  delayed reactions
                </li>
                <li>
                  <strong>5. Site safety:</strong> Secure area, notify supervisor, preserve evidence
                  for investigation
                </li>
              </ul>
            </div>
        ...
        <Card className="mb-8 p-6 bg-card border-border/20">
          ...
          <div className="space-y-3 text-base text-foreground">
            <p>
              Electric shock and burn injuries in electrical work are preventable through proper
              procedures and protective measures.
            </p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Current path and magnitude</strong> determine shock severity, with
                hand-to-hand across chest being most dangerous.
              </li>
              <li>
                <strong>Arc flash creates extreme hazards</strong> including temperatures up to
                20,000°C and dangerous pressure waves.
              </li>
              <li>
                <strong>Emergency response priorities:</strong> isolate power, assess casualty,
                provide appropriate first aid, call for help.
              </li>
              <li>
                <strong>Prevention through safe systems:</strong> EAWR compliance, safe isolation,
                appropriate PPE, and competent work.
              </li>
              <li>
                <strong>Legal obligations</strong> require systematic approaches to electrical
