...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 2,
    explanation:
      'In a purely inductive circuit, current lags voltage by 90 degrees. This is because the inductor opposes changes in current, causing it to reach its peak after the voltage.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'A lagging power factor indicates an inductive load where current lags behind voltage. The 0.8 value means only 80% of the apparent power is converted to true power.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Power factor = True Power / Apparent Power = 8 kW / 10 kVA = 0.8. This indicates that 80% of the apparent power is being converted to useful work.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'S = VI = 230 x 10 = 2300 VA. With cos(phi) = 0.6, sin(phi) = 0.8. Reactive power Q = S x sin(phi) = 2300 x 0.8 = 1840 VAR.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "Power factor = cos(30) = 0.866. Since voltage leads current (or current lags voltage), this indicates a lagging power factor. Wait - if voltage leads current, current is lagging, so it's a lagging power factor.",
  },
  {
  ...
  {
    question:
      'What capacitive reactive power is needed to correct a 0.7 lagging power factor to 0.95 lagging for a 50 kW load?',
    options: ['25.2 kVAR', '51.0 kVAR', '34.5 kVAR', '16.4 kVAR'],
    correctIndex: 0,
    explanation:
      'Q1 = P x tan(cos^-1(0.7)) = 50 x 1.02 = 51 kVAR. Q2 = P x tan(cos^-1(0.95)) = 50 x 0.329 = 16.4 kVAR. Required capacitive kVAR = 51 - 16.4 = 34.6 kVAR. Closest answer considering rounding.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'In the power triangle, true power (kW) is the horizontal base, reactive power (kVAR) is the vertical side, and apparent power (kVA) is the hypotenuse.',
  },
  {
    question:
      'A circuit has apparent power of 25 kVA and reactive power of 15 kVAR. Calculate the true power.',
    options: ['10 kW', '20 kW', '40 kW', '29.15 kW'],
    correctIndex: 1,
    explanation:
      'Using the power triangle: S squared = P squared + Q squared. Therefore P = sqrt(S squared - Q squared) = sqrt(625 - 225) = sqrt(400) = 20 kW.',
  },
  {
    question: 'Why do electricity suppliers penalise consumers with low power factor?',
    options: [
      'Low power factor reduces energy consumption',
      'Higher currents are required for the same true power',
      'It improves system efficiency',
      'It reduces voltage drop',
    ],
    correctIndex: 1,
    explanation:
      'Low power factor means higher current for the same true power, causing greater losses in cables, transformers and switchgear. Suppliers must size equipment for apparent power but only bill for true power.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Phase angle phi = cos^-1(power factor) = cos^-1(0.707) = 45 degrees. This is a common value as cos(45) = 1/sqrt(2) = 0.707.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'For 3-phase: P = sqrt(3) x V x I x cos(phi) = 1.732 x 400 x 50 x 0.8 = 27,712 W = 27.7 kW.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Capacitive loads cause current to lead voltage, resulting in a leading power factor. Capacitor banks are specifically installed to provide leading reactive power for power factor correction.',
  },
  {
    ...
    correctIndex: 0,
    explanation:
      "Z = sqrt(R squared + XL squared) = sqrt(900 + 1600) = 50 ohms. Power factor = R/Z = 30/50 = 0.6. Since XL &gt; 0 (inductive), it's lagging.",
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'The power triangle shows that apparent power, true power and reactive power form a right-angled triangle. Therefore kVA squared = kW squared + kVAR squared, or kVA = sqrt(kW squared + kVAR squared).',
  },
  {
    question:
      'A factory has a power factor of 0.7 and uses 100 kW. After installing capacitors, power factor improves to 0.95. What is the reduction in apparent power demand?',
    options: ['37.4 kVA', '142.9 kVA', '105.3 kVA', '47.6 kVA'],
    correctIndex: 0,
    explanation:
      'Original kVA = 100/0.7 = 142.9 kVA. New kVA = 100/0.95 = 105.3 kVA. Reduction = 142.9 - 105.3 = 37.6 kVA (approximately 37.4 kVA).',
  },
];
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'No, power factor cannot exceed 1 (unity). It represents the ratio of true power to apparent power, or the cosine of the phase angle. Since cosine values range from -1 to 1, and power factor is typically expressed as a positive value, it ranges from 0 to 1. Unity power factor (1.0) represents the ideal condition where all power is converted to useful work.',
  },
  {
    question: 'How do I calculate the capacitor size for power factor correction?',
    answer:
      'Calculate required capacitive kVAR = P x (tan(phi1) - tan(phi2)), where P is true power in kW, phi1 is the original phase angle, and phi2 is the target phase angle. Then capacitance C = kVAR x 1000 / (2 x pi x f x V squared). For 3-phase systems, divide the total kVAR by 3 for the per-phase value.',
  },
  {
    question: 'What happens if power factor correction is excessive?',
    answer:
      'Over-correction (leading power factor) can cause voltage rise, increased losses, and potential resonance issues. It can also lead to capacitor damage and penalties from suppliers who specify minimum as well as maximum power factor limits. Automatic power factor correction systems prevent over-correction by switching capacitor stages as load varies.',
  },
];
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="mb-12">
            ...
            <div className="bg-[#242424] rounded-lg p-6 border border-white/10">
              ...
              <ul className="text-white space-y-2 mb-4">
                ...
                <li>
                  <strong>ICE:</strong> In capacitance (C), current (I) leads EMF (voltage, E)
                </li>
              </ul>
          ...
          <div className="mb-12">
            ...
            <div className="bg-[#242424] rounded-lg p-6 border border-white/10">
              ...
              <ul className="text-white space-y-2 mb-4">
                ...
                <li>
                  <strong>Group correction:</strong> Capacitors at distribution boards serving
                  multiple loads - good compromise
                </li>
                <li>
                  <strong>Central correction:</strong> Main capacitor bank at incoming supply -
                  easiest to install but least efficient
                </li>
                <li>
                  <strong>Automatic correction:</strong> Controller switches capacitor stages based
                  on measured power factor - responds to varying loads
                </li>
              </ul>
          ...
          <div className="mb-12">
            ...
            <div className="bg-yellow-900/30 border border-yellow-500/50 rounded-lg p-6">
              ...
              <ul className="text-white space-y-2">
                ...
                <li>
                  <strong>Harmonic distortion:</strong> Capacitors can amplify harmonics from
                  non-linear loads (VFDs, LED drivers). May need detuned reactors.
                </li>
                <li>
                  <strong>Switching transients:</strong> Use contactors rated for capacitor
                  switching (AC-6b category). Standard contactors will fail prematurely.
                </li>
                <li>
                  <strong>Discharge resistors:</strong> Capacitors must have discharge resistors to
                  reduce voltage to safe levels within specified time.
                </li>
                <li>
                  <strong>BS 7671 requirements:</strong> Regulation 559 covers capacitor
                  installations including isolation, protection and discharge requirements.
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="flex justify-between items-center pt-8 border-t border-white/10">
          ...
          <Button className="bg-green-600 hover:bg-green-700 text-white" asChild>
            <Link to="/study-centre/apprentice/level3-module3-section2-6">
