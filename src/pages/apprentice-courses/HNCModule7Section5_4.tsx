...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['500 metres', '100 metres', '1,200 metres', '2,400 metres'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['At least 50%', 'At least 70%', '100% mandatory', 'At least 90%'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Class 2.0', 'Class 0.5', 'Class 1.0', 'Class 0.2'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['100% of CT rating', '25% of CT rating', '120% of CT rating', '50-60% of CT rating'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['RS-232', 'Ethernet', 'RS-485', 'Fibre optic'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Class 3', 'Class 0.5 or Class 0.2S', 'Class 1', 'Class 5'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['One CT', 'Two CTs', 'Four CTs', 'Three CTs'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <ConceptBlock title="Meter Types and Applications">
          ...
          <p>
            <strong>Common meter types:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Basic kWh meters:</strong> Cumulative energy measurement only, pulse output
            </li>
            <li>
              <strong>Multi-function meters (MFM):</strong> V, I, kW, kVA, kVAr, PF, Hz, THD, kWh
            </li>
            <li>
              <strong>Maximum demand indicators:</strong> Record peak demand for tariff management
            </li>
            <li>
              <strong>Power quality analysers:</strong> Harmonics, flicker, sags, swells, transients
            </li>
          </ul>
          <p>
            <strong>Meter Selection by Application</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Fiscal/billing:</strong> MID-approved kWh — Class 1.0, sealed, tamper-evident
            </li>
            <li>
              <strong>Tenant sub-metering:</strong> Multi-function with comms — kWh, Modbus/pulse,
              DIN rail
            </li>
            <li>
              <strong>Plant monitoring:</strong> Multi-function meter — Real-time V, I, kW, PF,
              harmonics
            </li>
            <li>
              <strong>Maximum demand tariff:</strong> MD indicator/recorder — Half-hourly data, peak
              recording
            </li>
            <li>
              <strong>Power quality analysis:</strong> Power quality analyser — EN 50160 compliance,
              waveform capture
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Accuracy Classes and IEC 62053">
          <p>
            ...
            on maximum permissible percentage errors at different load and power factor conditions.
            Proper accuracy specification ensures reliable energy data for billing and monitoring
            applications.
          </p>
          <p>
            <strong>IEC 62053-21</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Accuracy Class Error Limits (IEC 62053-21)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Class 0.5:</strong> ±0.5% — ±1.0% — High-value sub-metering
            </li>
            <li>
              <strong>Class 1.0:</strong> ±1.0% — ±1.5% — Commercial billing
            </li>
            <li>
              <strong>Class 2.0:</strong> ±2.0% — ±2.5% — Monitoring only
            </li>
            <li>
              <strong>Class 0.2S:</strong> ±0.2% — ±0.4% — Revenue/fiscal metering
            </li>
          </ul>
          <p>
            <strong>MID (Measuring Instruments Directive)</strong>
          </p>
          <p>
            For billing applications in the UK and EU, meters must be MID-approved (2014/32/EU). MID
            requires Class B accuracy (equivalent to IEC Class 1.0) minimum for active energy meters
            used in direct transactions. MID approval includes factory calibration, sealing, and
        ...
        <ConceptBlock title="CT Connections and Installation">
          <p>
            ...
            direct connection capacity. Correct CT selection, installation, and wiring are critical
            for measurement accuracy and safety.
          </p>
          <p>
            <strong>Critical Safety Warning</strong>
          </p>
          <p>
            <strong>Never open-circuit an energised CT secondary.</strong> This creates dangerous
            voltages (potentially thousands of volts) that can cause arcing, insulation failure, and
            serious injury. Always short-circuit CT secondaries before disconnecting meters, and use
            CT terminal blocks with shorting links for safe isolation.
          </p>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Secondary current:</strong> 1A for long runs (&gt;15m), 5A for short distances
            </li>
            <li>
          ...
          <p>
            <strong>CT Burden Calculation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Meter current input:</strong> 0.1 - 0.5 VA — Modern electronic meters
            </li>
            <li>
              <strong>Cable (2.5mm², 10m):</strong> 0.7 VA (5A sec) — 0.03 VA for 1A secondary
            </li>
            <li>
              <strong>Connections:</strong> 0.1 - 0.2 VA — Terminal blocks, crimps
            </li>
            <li>
              <strong>Total typical:</strong> 1 - 2 VA — CT should be rated &gt;2.5 VA
            </li>
          </ul>
          <p>
            <strong>CT Wiring Principles</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Data Communications and Sub-Metering Strategies">
          ...
          <p>
            <strong>Communication Protocols Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Modbus RTU:</strong> RS-485 — 1,200m — Local meter networks
            </li>
            <li>
              <strong>Modbus TCP:</strong> Ethernet — 100m per segment — IT network integration
            </li>
            <li>
              <strong>BACnet MS/TP:</strong> RS-485 — 1,200m — BMS integration
            </li>
            <li>
              <strong>BACnet IP:</strong> Ethernet — Network dependent — Enterprise BMS
            </li>
            <li>
              <strong>Pulse output:</strong> Volt-free contact — 500m typical — Simple BMS
              connection
            </li>
            <li>
              <strong>M-Bus:</strong> 2-wire bus — 1,000m — Multi-utility metering
            </li>
          </ul>
          <p>
            <strong>Modbus RTU Configuration</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>CIBSE TM39 Sub-Metering Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Sub-Metering Hierarchy Example</strong>
          </p>
          <p>
            <strong>Level 1: Fiscal Meter</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Level 2: Distribution</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Level 4: Equipment</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            detailed analysis. Daily totals are insufficient for effective monitoring and targeting
            programmes.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Select CTs for metering a 400A TP+N distribution board with
            typical load of 280A.
          </p>
          <p>Given:</p>
          ...
          <p>
            <strong>Scenario:</strong> Design Modbus RTU network for 24 meters across a commercial
            building.
          </p>
          <p>Requirements:</p>
