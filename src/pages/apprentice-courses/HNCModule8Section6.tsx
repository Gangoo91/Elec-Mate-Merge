    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-base text-muted-foreground mb-12">
          This section covers the coordination of HVAC systems with electrical services and other
          building systems. You'll learn about electrical requirements for HVAC plant, plant room
          design, interface coordination, commissioning procedures and the documentation required
