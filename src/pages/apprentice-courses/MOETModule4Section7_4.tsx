      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Standards:</strong> SAE JA1011 defines genuine RCM; ISO 55000 provides the
                asset management framework
              </li>
              <li className="pl-1">
                <strong>CMMS:</strong> Essential data infrastructure for scheduling, recording and
                analysing maintenance
              </li>
              <li className="pl-1">
                <strong>Data-driven:</strong> Pareto analysis, RCA and KPIs drive targeted
                improvements
              </li>
              <li className="pl-1">
                <strong>Culture:</strong> Reliability is everyone's responsibility, not just the
                maintenance team's
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 space-y-3">
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  SAE JA1011 / JA1012 — RCM Process Standard
                </h3>
                <p className="text-sm text-white">
                  Defines the minimum requirements for a genuine RCM process. JA1011 sets the
                  criteria; JA1012 provides the implementation guide. Key requirements: all seven
                  questions addressed in sequence, structured decision logic for task selection, and
                  documented outcomes. Any process that does not meet these criteria should not be
                  called RCM. This standard ensures rigour and consistency and prevents the dilution
                  of RCM into superficial exercises.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                ...
                <p className="text-sm text-white">
                  The international framework for managing physical assets over their entire
                  lifecycle. ISO 55001 specifies the requirements for an asset management system;
                  ISO 55002 provides implementation guidance. RCM fits within this framework as the
                  methodology for determining maintenance requirements. ISO 55000 also covers asset
                  lifecycle decisions (acquisition, operation, maintenance, modification and
                  disposal), risk management, and the alignment of asset management with
              ...
              <div className="p-4 rounded-lg bg-white/5">
                ...
                <p className="text-sm text-white">
                  ...
                  (maintenance cost efficiency), technical (equipment reliability and availability),
                  and organisational (work management effectiveness). Using standardised KPIs
                  enables meaningful benchmarking against industry peers and consistent internal
                  tracking over time.
                </p>
              </div>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> You do not need to memorise these standard numbers, but
              you should understand the principles they represent. SAE JA1011 = rigorous RCM
              process. ISO 55000 = lifecycle asset management. BS EN 13306 = common language. BS EN
              15341 = measuring performance. Together they form the professional framework within
              which modern maintenance operates.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                CMMS Best Practice Configuration
              </p>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Complete, with unique tag numbers, criticality ratings, and parent-child
                        relationships
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Simple, meaningful, aligned to actual failure modes — maximum 15-20 codes
                        per equipment type
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Planned, assigned, in progress, completed, closed — with mandatory fields
                        for failure cause and actions
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">Spare parts</td>
                      <td className="border border-white/10 px-3 py-2">
                        Linked to assets, with stock levels aligned to criticality (critical spares
                        held, non-critical sourced)
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2 font-medium">
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Automated reporting of PM compliance, MTBF, MTTR, planned ratio,
                        availability
                      </td>
                    </tr>
                  </tbody>
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              <p className="text-sm font-medium text-orange-400 mb-2">
                The Technician's Role in Data Quality
              </p>
              <p className="text-sm text-white mb-2">
                As a maintenance technician, you are the primary data generator. The quality of
                every maintenance decision depends on the quality of the data you record:
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  ...
                  condition the equipment was in — "replaced motor" tells us nothing; "motor bearing
                  DE failed, excessive vibration noted 3 months ago during PM, bearing replaced and
                  aligned to 0.05mm" tells us everything
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Parts recording:</strong> Record which parts were used — this supports
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> "Garbage in, garbage out" applies absolutely to CMMS data.
              If failure codes are wrong, notes are empty, and times are guessed, the system cannot
              provide meaningful analysis. If the data is accurate and detailed, the system becomes
              a powerful tool for continuous improvement. Every work order you complete is a
              contribution to the organisation's maintenance knowledge.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                The PDCA Improvement Cycle Applied to Maintenance
              </p>
              <div className="grid sm:grid-cols-2 gap-3">
                <div className="p-3 rounded-lg bg-blue-500/10 border border-blue-500/30">
                  <h3 className="text-sm font-medium text-blue-400 mb-1">Plan</h3>
                  <p className="text-sm text-white">
                    Analyse CMMS data (Pareto of failures, trend analysis). Identify the top failure
                    modes by impact. Perform RCA on significant failures. Develop specific
                    improvement actions.
                  </p>
                </div>
                <div className="p-3 rounded-lg bg-green-500/10 border border-green-500/30">
                  ...
                  <p className="text-sm text-white">
                    Implement the improvement: revised PM task, new condition monitoring route,
                    design modification, operator training, or procedure change. Document the
                    change.
                  </p>
                </div>
                <div className="p-3 rounded-lg bg-yellow-500/10 border border-yellow-500/30">
                  ...
                  <p className="text-sm text-white">
                    Measure the results over a defined period: has the failure rate reduced? Has
                    MTBF improved? Has the KPI moved in the right direction? Did the improvement
                ...
                <div className="p-3 rounded-lg bg-purple-500/10 border border-purple-500/30">
                  ...
                  <p className="text-sm text-white">
                    If successful, standardise the improvement and extend to similar assets. If not,
                    analyse why and try a different approach. Update the FMEA and maintenance plan.
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Pareto Analysis for Maintenance Improvement
              </p>
              <p className="text-sm text-white mb-2">
                The Pareto principle (80/20 rule) applies powerfully to maintenance: typically 20%
                of failure modes cause 80% of the downtime, cost and safety incidents. Identifying
                and targeting this top 20% delivers the greatest improvement for the least effort.
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Step 1:</strong> Extract failure data from the CMMS for a defined period
                  (typically 12 months)
                </li>
                <li className="pl-1">
                  <strong>Step 2:</strong> Rank failure modes by impact (downtime hours, cost, or
                  number of occurrences)
                </li>
                <li className="pl-1">
                  <strong>Step 3:</strong> Identify the top 5-10 failure modes that account for the
                  majority of impact
                </li>
                <li className="pl-1">
                  <strong>Step 4:</strong> Perform root cause analysis on each of the top failure
                  modes
                </li>
                <li className="pl-1">
                  <strong>Step 5:</strong> Develop and implement targeted improvement actions for
                  each
                </li>
                <li className="pl-1">
                  <strong>Step 6:</strong> Measure the results and repeat the analysis
                </li>
              </ul>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Continuous improvement is not about making massive changes
              — it is about making many small, evidence-based improvements over time. Each
              improvement may seem modest, but the cumulative effect over months and years is
              transformational. The organisations that achieve world-class maintenance performance
              do so through sustained, disciplined application of the improvement cycle, not through
              one-off projects.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 text-sm">
                  <span className="text-elec-yellow/80 font-medium min-w-[140px]">
                    Leadership commitment
                  </span>
                  <span>
                    Management actively supports maintenance improvement, provides resources, and
                    visibly prioritises reliability in decision-making
                  </span>
                </div>
                <div className="flex items-start gap-3 text-sm">
                  <span className="text-elec-yellow/80 font-medium min-w-[140px]">
                  ...
                  <span>
                    Maintenance strategy is based on evidence (failure data, condition monitoring,
                    risk analysis), not tradition, opinion or budget convenience
                  </span>
                </div>
                <div className="flex items-start gap-3 text-sm">
                  <span className="text-elec-yellow/80 font-medium min-w-[140px]">
                  ...
                  <span>
                    Failures are investigated to find systemic causes (training gaps, procedure
                    weaknesses, design issues), not to punish individuals
                  </span>
                </div>
                <div className="flex items-start gap-3 text-sm">
                  <span className="text-elec-yellow/80 font-medium min-w-[140px]">
                  ...
                  <span>
                    Operators care for their equipment, maintainers investigate root causes,
                    engineers support design improvements, and management provides resources
                  </span>
                </div>
                <div className="flex items-start gap-3 text-sm">
                  <span className="text-elec-yellow/80 font-medium min-w-[140px]">
                  ...
                  <span>
                    Every failure, every PM visit and every condition monitoring result is an
                    opportunity to improve. Knowledge is shared, not hoarded
                  </span>
                </div>
                <div className="flex items-start gap-3 text-sm">
                  <span className="text-elec-yellow/80 font-medium min-w-[140px]">
                  ...
                  <span>
                    The organisation invests in training and development because it recognises that
                    people are the most important element of the maintenance system
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  What the Technician Can Influence
                </h3>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              ...
              <div className="p-4 rounded-lg bg-white/5">
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Signs of a Weak Reliability Culture
                </h3>
                <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                  <li className="pl-1">
                    Maintenance is seen as a cost to be minimised, not an investment
                  </li>
                  <li className="pl-1">
                    Breakdowns are accepted as inevitable rather than investigated
                  </li>
            ...
            <p className="text-sm text-white italic">
              ...
              they form an integrated system. Good condition monitoring detects failures early. Good
              fault diagnosis identifies what went wrong. Good RCA identifies why it went wrong.
              Good RCM ensures the right strategy is applied to prevent recurrence. And a
              reliability culture ensures all of this actually happens consistently, every day. As a
              maintenance technician, you are at the heart of this system.
            </p>
          </div>
        </section>
        ...
        <div className="mb-8 p-6 rounded-xl bg-elec-yellow/10 border border-elec-yellow/30 text-center">
          ...
          <p className="text-sm text-white">
            ...
            and reliability-centred maintenance. These topics form the foundation of professional
            electrical maintenance practice aligned to ST1426.
          </p>
        </div>
