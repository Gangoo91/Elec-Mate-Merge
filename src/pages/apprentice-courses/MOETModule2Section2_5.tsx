        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>XL = 2πfL</strong> — inductive reactance increases with frequency
              </li>
              <li className="pl-1">
                <strong>XC = 1/(2πfC)</strong> — capacitive reactance decreases with frequency
              </li>
              <li className="pl-1">
                <strong>Z = √(R² + X²)</strong> — impedance is the vector sum
              </li>
              <li className="pl-1">
                <strong>PF = cos φ = kW/kVA</strong> — target 0.95 for UK installations
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>At DC (f = 0):</strong> XC = infinity — capacitor blocks DC completely
                  (open circuit)
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              <p className="text-sm font-medium text-orange-400 mb-2">
                Reactance vs Resistance — Key Differences
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Series resonance:</strong> Impedance falls to R only. Current reaches
                  maximum. Dangerous in power systems — can cause overcurrents through PFC
                  capacitors
                </li>
                <li className="pl-1">
                  <strong>Parallel resonance:</strong> Impedance rises to maximum. Current from
                  supply falls to minimum. Can amplify harmonic voltages at the resonant frequency
                </li>
                <li className="pl-1">
                  <strong>In PFC systems:</strong> Resonance between PFC capacitors and transformer
                  inductance at a harmonic frequency can amplify that harmonic to dangerous levels.
                  This is why PFC must be designed with harmonic content in mind
                </li>
              </ul>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Maintenance tip:</strong> Earth fault loop impedance (Zs) measured during
              testing is an AC impedance, not just resistance. It includes the resistance and
              reactance of the supply transformer, cables and earth path. At 50 Hz, the reactive
              component is significant for larger cable sizes and longer runs, which is why measured
              Zs may differ from calculated values based on resistance alone.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Real power P (kW):</strong> The power that does useful work — turns
                  motors, produces heat, produces light. P = V x I x cos φ. Measured by a wattmeter.
                  The only type of power you pay for directly (kWh meter)
                </li>
                <li className="pl-1">
                  <strong>Reactive power Q (kVAr):</strong> The power that flows back and forth
                  between the supply and the reactive components (inductors, capacitors) without
                  doing useful work. Q = V x I x sin φ. Essential for maintaining magnetic fields in
                  motors and transformers but causes additional current to flow
                </li>
                <li className="pl-1">
                  ...
                  (transformer, cables, switchgear) must be rated for the apparent power, not just
                  the real power
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Leading (0 &lt; PF &lt; 1):</strong> Capacitive load. Current leads
                  voltage. Caused by PFC capacitors, long lightly loaded cables. Usually only seen
                  when PFC overcorrects
                </li>
                <li className="pl-1">
                  <strong>Zero PF (PF = 0):</strong> Purely reactive load. No real power consumed.
                  All power is reactive. Theoretical limit — not encountered in practice
                </li>
              </ul>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  ...
                  large inductive load. The capacitor is switched with the load. Simple and
                  effective but requires many capacitors. Often used for large motors (&gt;15 kW)
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  ...
                  fast, precise PFC in applications with rapidly varying loads (arc furnaces,
                  welding bays)
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Freed-up capacity:</strong> Reducing the current from 100 kVA to 74 kVA
                  (PF 0.7 to 0.95) frees 26 kVA of transformer and cable capacity for additional
                  load
                </li>
                <li className="pl-1">
                  <strong>Reduced I²R losses:</strong> Lower current means proportionally lower
                  copper losses in cables and transformers. Energy savings of 2-5% are typical
                </li>
                <li className="pl-1">
                  <strong>Improved voltage regulation:</strong> Less current means less voltage
                  drop. Voltage at the load terminals improves, benefiting motor performance and
                  equipment life
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Stored energy:</strong> PFC capacitors retain a charge after
                  disconnection. Discharge resistors should reduce the voltage to below 50 V within
                  one minute (BS EN 60831). Always verify discharge before handling
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  ...
                  that may be disconnected from the supply — the motor can self-excite as a
                  generator, producing dangerous voltages
                </li>
              </ul>
            </div>
