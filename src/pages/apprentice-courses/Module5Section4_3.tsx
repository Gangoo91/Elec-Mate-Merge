      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-6">
            <div className="space-y-3">
              <h4 className="font-medium text-foreground">Tool Selection Skills</h4>
            ...
            <div className="space-y-3">
              <h4 className="font-medium text-foreground">Tool Management</h4>
              <ul className="space-y-2 text-muted-foreground text-sm">
                <li className="flex items-start">
                  <span className="text-emerald-400 mr-2 font-bold">•</span>
        ...
        <Card className="mb-6 p-6 bg-card border-border/20">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-foreground">Learning Point 1: Selecting the Right Tool</h2>
          </div>
          ...
          <div className="mb-6">
            <h3 className="text-lg font-medium text-foreground mb-3">Why Tool Selection Matters</h3>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
                <p className="text-sm font-medium text-amber-700 dark:text-amber-400 mb-2">Safety</p>
                <p className="text-xs sm:text-sm text-foreground">Wrong tools can slip, break, or cause electrical hazards</p>
              </div>
              <div className="p-4 rounded-lg bg-emerald-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
                <p className="text-sm font-medium text-blue-700 dark:text-emerald-400 mb-2">Quality</p>
                <p className="text-xs sm:text-sm text-foreground">Correct tools ensure precise connections and professional finish</p>
              </div>
              <div className="p-4 rounded-lg bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
                <p className="text-sm font-medium text-green-700 dark:text-green-400 mb-2">Efficiency</p>
                <p className="text-xs sm:text-sm text-foreground">Right tools complete tasks faster with better results</p>
              </div>
              <div className="p-4 rounded-lg bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800">
                <p className="text-sm font-medium text-purple-700 dark:text-emerald-400 mb-2">Compliance</p>
                <p className="text-xs sm:text-sm text-foreground">Specialist tools may be required for BS 7671 compliance</p>
              </div>
            </div>
          </div>
          
          <div className="rounded-lg p-4 bg-muted/50 border border-border/30 mb-4">
            <h4 className="font-medium text-foreground mb-2">Common Tool Categories</h4>
          ...
          <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded border border-red-200 dark:border-red-800">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-red-700 dark:text-emerald-400 mb-2">Never Use Makeshift Alternatives</p>
                <p className="text-xs sm:text-sm text-foreground">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-foreground mb-4">Quick Check - Tool Selection</h3>
            <InlineCheck
        ...
        <Card className="mb-6 p-6 bg-card border-border/20">
          <div className="flex items-center gap-3 mb-4">
            <CheckCircle className="w-6 h-6 text-emerald-400" />
            <h2 className="text-lg sm:text-xl font-semibold text-foreground">Learning Point 2: Specialist Tools</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 mb-6">
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-foreground">Essential Specialist Tools</h3>
              
              <div className="p-4 rounded-lg bg-emerald-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
                <p className="font-medium text-blue-700 dark:text-emerald-400 mb-2">Torque Screwdrivers</p>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-foreground">When Specialist Tools Are Required</h3>
              ...
              <div className="p-4 rounded-lg bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800">
                <p className="font-medium text-purple-700 dark:text-emerald-400 mb-2">Quality Benefits</p>
                <ul className="text-xs sm:text-sm text-foreground list-disc pl-4 space-y-1">
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded border border-yellow-200 dark:border-yellow-800">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-yellow-700 dark:text-emerald-400 mb-2">Calibration Requirements</p>
                <p className="text-xs sm:text-sm text-foreground">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-foreground mb-4">Quick Check - Specialist Tools</h3>
            <InlineCheck
        ...
        <Card className="mb-6 p-6 bg-card border-border/20">
          <div className="flex items-center gap-3 mb-4">
            <CheckCircle className="w-6 h-6 text-emerald-400" />
            <h2 className="text-lg sm:text-xl font-semibold text-foreground">Learning Point 3: Tool Availability</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 sm:gap-6 mb-6">
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-foreground">Planning Tool Requirements</h3>
              
              <div className="p-4 rounded-lg bg-emerald-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
                <p className="font-medium text-blue-700 dark:text-emerald-400 mb-2">Pre-Project Planning</p>
                <ul className="text-xs sm:text-sm text-foreground list-disc pl-4 space-y-1">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-medium text-foreground">Managing Shared Tools</h3>
              ...
              <div className="p-4 rounded-lg bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800">
                <p className="font-medium text-purple-700 dark:text-emerald-400 mb-2">Backup Strategies</p>
                <ul className="text-xs sm:text-sm text-foreground list-disc pl-4 space-y-1">
          ...
          <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded border border-red-200 dark:border-red-800 mb-4">
            <div className="flex items-start gap-3">
              <AlertTriangle className="w-5 h-5 text-red-600 dark:text-emerald-400 mt-0.5 flex-shrink-0" />
              <div>
                <p className="font-medium text-red-700 dark:text-emerald-400 mb-2">Impact of Poor Tool Planning</p>
                <ul className="text-xs sm:text-sm text-foreground list-disc pl-4 space-y-1">
          ...
          <div className="rounded-lg p-4 bg-muted/50 border border-border/30">
            <h4 className="font-medium text-foreground mb-2">Best Practice Example</h4>
            <p className="text-xs sm:text-sm text-foreground">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-foreground mb-4">Quick Check - Tool Availability</h3>
            <InlineCheck
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <div className="space-y-6">
            ...
            <div className="border border-border/30 rounded-lg p-4">
              <h3 className="text-lg font-semibold text-foreground mb-3">Example 1: Selecting Tools for MCB Installation</h3>
              
              <div className="grid md:grid-cols-2 gap-4 mb-4">
                <div className="space-y-3">
                  <h4 className="font-medium text-foreground">Task Requirements:</h4>
            ...
            {/* Example 2 */}
            <div className="border border-border/30 rounded-lg p-4">
              <h3 className="text-lg font-semibold text-foreground mb-3">Example 2: Tool Management System Implementation</h3>
              
              <div className="grid md:grid-cols-3 gap-3 sm:gap-4 mb-4">
                <div>
                  <h4 className="font-medium text-foreground mb-2">Daily Checks</h4>
                  <ul className="text-sm text-muted-foreground space-y-1">
                ...
                <div>
                  <h4 className="font-medium text-foreground mb-2">Weekly Reviews</h4>
                  <ul className="text-sm text-muted-foreground space-y-1">
                ...
                <div>
                  <h4 className="font-medium text-foreground mb-2">Monthly Actions</h4>
                  <ul className="text-sm text-muted-foreground space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          <h2 className="text-lg sm:text-xl font-semibold text-foreground mb-6">Key Reference Values</h2>
          <div className="space-y-4">
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-emerald-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800">
                <h3 className="font-medium text-blue-700 dark:text-emerald-400 mb-2">Common Torque Values</h3>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-foreground">Pocket Guide - Tool Selection & Availability</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="flex justify-between items-center pt-8 border-t border-border/20">
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-muted-foreground">3 of 6 subsections</p>
          </div>
