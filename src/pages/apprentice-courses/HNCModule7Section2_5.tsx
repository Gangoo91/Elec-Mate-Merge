    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Online UPS:</strong> Zero transfer time, continuous protection
              </li>
              <li className="pl-1">
                <strong>Sizing:</strong> kVA = kW ÷ power factor + 25% headroom
              </li>
              <li className="pl-1">
                <strong>VRLA batteries:</strong> 5-10 year design life at 20-25°C
              </li>
              <li className="pl-1">
                <strong>Bypass:</strong> Static (automatic) and maintenance (manual)
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Critical loads:</strong> Data centres, medical, life safety
              </li>
              <li className="pl-1">
                <strong>Configuration:</strong> N+1 or 2N for high availability
              </li>
              <li className="pl-1">
                <strong>Monitoring:</strong> BMS integration, SNMP, Modbus
              </li>
              <li className="pl-1">
                <strong>Environment:</strong> Temperature control essential
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        PCs, home office, basic protection
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Small servers, networking, retail
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Data centres, medical, critical IT
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              <p className="text-sm font-medium text-blue-400 mb-2">
                Online Double Conversion Process
              </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Selection principle:</strong> Choose online double conversion for any load
              where even milliseconds of interruption could cause data loss, process failure, or
              safety issues.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-green-500/10 border border-green-500/30">
              <p className="text-sm font-medium text-green-400 mb-2">
                Worked Example: Server Room UPS Sizing
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Battery systems are the heart of UPS installations, storing energy for discharge
              during mains failure. The choice between VRLA (Valve Regulated Lead Acid) and
              lithium-ion technologies depends on space constraints, lifecycle cost, and operating
              environment.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Temperature rule:</strong> VRLA battery life halves for every 10°C above 25°C.
              A battery rated for 10 years at 25°C will last only 5 years at 35°C.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Maintenance Bypass Procedure (Typical)
              </p>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Complete UPS System Sizing
              </h3>
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="ml-4 text-green-400">
                  Select: 80 Ah battery string (next standard size)
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Battery Replacement Planning
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Parallel UPS Configuration
              </h3>
              <p className="text-sm text-white mb-2">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                UPS Selection Checklist
              </h3>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Determine actual load (measure, don't assume from nameplates)
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>No maintenance bypass</strong> - Cannot service UPS without load
                  disruption
                </li>
                <li className="pl-1">
