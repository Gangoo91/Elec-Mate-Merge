...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['15 kVA', '13.5 kVA', '16.7 kVA', '18 kVA'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['3-5 years', '15-20 years', '10-15 years', '5-10 years'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['5-12 ms', '0 ms (no transfer)', '2-4 ms', '15-25 ms'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['40 minutes', '29 minutes', '60 minutes', '12 minutes'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Inverter', 'Rectifier/charger', 'Output transformer', 'Static bypass switch'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['10-15°C', '20-25°C', '15-20°C', '25-30°C'],
    correctAnswer: 1,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <ConceptBlock title="UPS Topologies">
          <p>
            Uninterruptible Power Supply systems provide continuous power to critical loads by
            bridging the gap between mains failure and generator start-up, or providing complete
            power conditioning for sensitive equipment. The three main topologies offer different
            levels of protection, efficiency, and cost.
          </p>
          <p>
            <strong>UPS Topology Comparison:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Offline (Standby):</strong> 5-12 ms — 95-98% — PCs, home office, basic
              protection
            </li>
            <li>
              <strong>Line-Interactive:</strong> 2-4 ms — 94-97% — Small servers, networking, retail
            </li>
            <li>
              <strong>Online Double Conversion:</strong> 0 ms — 90-94% — Data centres, medical,
              critical IT
            </li>
          </ul>
          <p>
            <strong>Offline (Standby)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Line-Interactive</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Online Double Conversion</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Online Double Conversion Process</strong>
          </p>
          <p>
            <span>Stage 1:</span> AC mains → Rectifier → DC bus
          </p>
          <p>
            <span>Stage 2:</span> DC bus → Charges batteries continuously
          </p>
          <p>
            <span>Stage 3:</span> DC bus → Inverter → Clean AC to load
          </p>
          <p>
            <span>On mains fail:</span> Batteries maintain DC bus seamlessly
          </p>
          <p>
            <strong>Selection principle:</strong> Choose online double conversion for any load where
            even milliseconds of interruption could cause data loss, process failure, or safety
            issues.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="UPS Sizing Calculations">
          ...
          <p>
            <strong>Fundamental Sizing Equations</strong>
          </p>
          <p>
            <strong>Apparent Power:</strong> S (kVA) = P (kW) ÷ Power Factor
          </p>
          <p>
            <strong>With headroom:</strong> UPS Rating = S × 1.25 to 1.30
          </p>
          <p>
            <strong>Battery Wh:</strong> Capacity = V × Ah × DOD × η
          </p>
          <p>
            <strong>Autonomy:</strong> Time (h) = Battery Wh ÷ Load (W)
          </p>
          <p>
            <strong>Sizing Parameters</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>IT load power factor:</strong> 0.9 - 0.95 — Modern servers with PFC
            </li>
            <li>
              <strong>Growth headroom:</strong> 25-30% — 3-5 year planning horizon
            </li>
            <li>
              <strong>Battery DOD (Depth of Discharge):</strong> 80% — Protects battery life
            </li>
            <li>
              <strong>Inverter efficiency:</strong> 90-94% — Losses in conversion
            </li>
            <li>
              <strong>Typical autonomy:</strong> 10-30 minutes — Generator start + stabilise
            </li>
          </ul>
          <p>
            <strong>Worked Example: Server Room UPS Sizing</strong>
          </p>
          <p>
            <span>Given:</span> 12 servers × 800W = 9.6 kW total
          </p>
          <p>
            <span>Power factor:</span> 0.9
          </p>
          <p>
            <span>Autonomy required:</span> 15 minutes
          </p>
          <p>
            <span>Step 1:</span> kVA = 9.6 ÷ 0.9 = 10.67 kVA
          </p>
          <p>
            <span>Step 2:</span> With 25% headroom = 10.67 × 1.25 = 13.3 kVA
          </p>
          <p>
            <span>Step 3:</span> Select 15 kVA UPS (standard size)
          </p>
          <p>
            <span>Battery:</span> Energy = 9.6 kW × 0.25h ÷ 0.9 = 2.67 kWh
          </p>
          <p>
            <span>At 80% DOD:</span> Battery capacity = 2.67 ÷ 0.8 = 3.33 kWh
          </p>
          <p>
            <strong>Design tip:</strong> Always verify actual measured load before final UPS
            selection. Nameplate ratings often exceed actual consumption by 30-50%.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Battery Technologies and BMS">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Design life:</strong> 5-10 years — 10-15 years
            </li>
            <li>
              <strong>Cycle life:</strong> 200-400 cycles — 3,000-5,000 cycles
            </li>
            <li>
              <strong>Energy density:</strong> 30-40 Wh/kg — 100-150 Wh/kg
            </li>
            <li>
              <strong>Recharge time:</strong> 8-12 hours — 1-4 hours
            </li>
            <li>
              <strong>Temperature sensitivity:</strong> High (20-25°C optimal) — Lower (up to 40°C)
            </li>
            <li>
              <strong>Initial cost:</strong> Lower — 2-3× higher
            </li>
            <li>
              <strong>Lifecycle cost:</strong> Higher (replacements) — Lower over 15 years
            </li>
          </ul>
          <p>
            <strong>VRLA Battery Considerations</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Lithium-Ion Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Battery Management System (BMS) Functions</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cell monitoring:</strong> Individual voltage and temperature per cell
            </li>
            <li>
              <strong>Charge control:</strong> CC/CV charging with temperature compensation
            </li>
            <li>
              <strong>Balancing:</strong> Equalises cell voltages during charge
            </li>
            <li>
              <strong>Protection:</strong> Overcurrent, overvoltage, thermal runaway prevention
            </li>
            <li>
              <strong>State estimation:</strong> SOC (State of Charge), SOH (State of Health)
            </li>
            <li>
              <strong>Communication:</strong> CAN bus, Modbus, SNMP to UPS controller
            </li>
          </ul>
          <p>
            <strong>Temperature rule:</strong> VRLA battery life halves for every 10°C above 25°C. A
            battery rated for 10 years at 25°C will last only 5 years at 35°C.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Bypass Arrangements and Monitoring">
          <p>
            Bypass arrangements are essential for maintaining load power during UPS maintenance or
            failure conditions. Modern installations incorporate both automatic and manual bypass
            capabilities, complemented by comprehensive monitoring systems.
          </p>
          <p>
            <strong>Bypass Types and Functions</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Automatic Static:</strong> SCR/thyristor switching — &lt;4 ms — Overload,
              inverter fault
            </li>
            <li>
              <strong>Manual Bypass:</strong> Rotary switch or breakers — Make-before-break —
              Planned maintenance
            </li>
            <li>
              <strong>External Maintenance:</strong> Wrap-around cabinet — Overlapping contacts —
              Complete UPS isolation
            </li>
            <li>
              <strong>ECO Mode:</strong> Continuous bypass + monitoring — 2-4 ms to inverter —
              Energy efficiency mode
            </li>
          </ul>
          <p>
            <strong>Maintenance Bypass Procedure (Typical)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>SNMP:</strong> Network management integration
            </li>
            <li>
              <strong>Modbus TCP/RTU:</strong> BMS integration
            </li>
            <li>
              <strong>BACnet:</strong> Building automation
            </li>
            <li>
              <strong>Dry contacts:</strong> Simple alarm relay outputs
            </li>
            <li>
              <strong>USB/RS232:</strong> Local shutdown software
            </li>
            <li>
              <strong>Web interface:</strong> Remote monitoring
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>N:</strong> Single UPS, no redundancy - failure = load loss
            </li>
            <li>
              <strong>N+1:</strong> Parallel UPS units, one spare - one can fail
            </li>
            <li>
              <strong>2N:</strong> Two independent UPS systems - either can support full load
            </li>
            <li>
              <strong>2N+1:</strong> Two systems plus one spare - highest availability
            </li>
            <li>
              <strong>Distributed:</strong> Multiple smaller UPS per rack - localised redundancy
            </li>
          </ul>
          <p>
            <strong>Availability target:</strong> 2N configurations can achieve 99.9999%
            availability (seconds of downtime per year) when combined with dual utility feeds and
            generator backup.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Online UPS transfer time: <strong>0 ms</strong>
            </li>
            <li>
              IT load power factor: <strong>0.9 typical</strong>
            </li>
            <li>
              VRLA optimal temperature: <strong>20-25°C</strong>
            </li>
            <li>
              Battery DOD for sizing: <strong>80%</strong>
            </li>
            <li>
              Design headroom: <strong>25-30%</strong>
            </li>
            <li>
              Typical autonomy: <strong>10-30 minutes</strong>
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Undersized batteries</strong> - Using nameplate loads instead of measured
                values
              </li>
              <li>
                <strong>Ignoring temperature</strong> - No cooling for battery room reduces life
                significantly
              </li>
              <li>
                <strong>No maintenance bypass</strong> - Cannot service UPS without load disruption
              </li>
              <li>
                <strong>Mixed battery ages</strong> - Old cells fail first, compromising entire
                string
              </li>
            </ul>
          }
