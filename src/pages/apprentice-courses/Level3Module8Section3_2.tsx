...
const Level3Module8Section3_2 = () => {
  ...
  const questionTypes = [
    ...
    },
    {
      ...
      example:
        'A circuit has Zs of 1.2Ω. The protective device is a 32A Type B MCB. Does this comply with BS 7671?',
  ...
  const distractorPatterns = [
    ...
    },
    {
      ...
      example:
        'Correct: Higher Zs = slower disconnection / Distractor: Higher Zs = faster disconnection',
  ...
  const quizQuestions = [
    {
      question:
        "A question asks 'Which is the MOST important reason for...' What type of question is this?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "Keywords like 'MOST', 'BEST', and 'PRIMARY' indicate a best answer question where multiple options may be partially correct but one is the best choice.",
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        "'Explain' requires you to make something clear by giving reasons. Simply stating a fact is not enough - you must say WHY or HOW.",
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "Questions using 'EXCEPT', 'NOT', or 'LEAST' are negative questions. You need to find the option that is FALSE or does NOT apply.",
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Distractors are incorrect options deliberately designed to appear plausible. Understanding distractor patterns helps you identify and eliminate them.',
    },
    {
      question:
        "An option states: 'RCDs will ALWAYS prevent fatal electric shock.' Is this likely correct?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        "Options using absolute terms like 'ALWAYS', 'NEVER', 'ALL' are usually incorrect. RCDs reduce risk but cannot guarantee prevention of all shocks.",
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        "Predicting your answer before reading options prevents being influenced by distractors. If your prediction matches an option, it's likely correct.",
    },
    {
      question:
        "You've eliminated two options but can't decide between the remaining two. What's the best strategy?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'When stuck between two options, carefully compare their differences. One often has a subtle error or the other is more complete.',
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        "'State' requires a direct answer without explanation. Unlike 'explain', you don't need to give reasons - just the fact.",
    },
    {
      question:
        "A distractor pattern shows 'Correct: 1.0 MΩ at 500V DC' vs 'Distractor: 1.0 MΩ at 250V DC'. What type of distractor is this?",
      options: [
        'Reversed logic',
        'Close but not quite',
      ...
      correctAnswer: 1,
      explanation:
        "This is a 'close but not quite' distractor where the wording is similar but a detail (voltage in this case) is subtly wrong.",
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'The first option that looks correct may be a distractor. A better, more complete answer may be among the later options.',
    },
    {
      question: 'A question asks about voltage drop calculation. What type of question is this?',
      options: ['Direct knowledge', 'Best answer', 'Negative question', 'Calculation'],
      correctAnswer: 3,
      explanation:
        'Questions asking you to calculate, work out, or find a numerical value are calculation questions. They require mathematical computation.',
    },
    {
      question:
        "What should you do if an option uses impressive technical terms you've never encountered?",
      options: [
      ...
      correctAnswer: 1,
      explanation:
        'Technical-sounding nonsense is a common distractor pattern. If complex terminology is unfamiliar despite your revision, it may be made up.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "First, re-read the question to ensure you understand what's being asked. If still stuck, look for extreme words (always, never) which are usually wrong. Make an educated guess, mark the question, and return to it later if time permits.",
    },
    {
      question: "Should I change my answer if I'm unsure?",
      answer:
        'Research shows first instincts are usually correct. Only change your answer if you have a specific reason - like realising you misread the question or remembering a fact that contradicts your choice. Vague doubt is not a good reason to change.',
    },
    {
      question: "How do I handle 'All of the above' or 'None of the above' options?",
      answer:
        "Carefully evaluate each option individually. For 'All of the above', if you find even one incorrect option, eliminate it. For 'None of the above', only select if you're confident all other options are wrong.",
    },
    {
      question: 'What if two options seem identical?',
      answer:
        "They're not - look more closely for subtle differences in wording, numbers, or qualifiers. One small word can change the entire meaning. If they truly seem identical, one may be a typo - choose the one that matches your knowledge.",
    },
    {
      question: 'How important is it to show working in calculation questions?',
      answer:
        "Very important, even in multiple choice. If you make an arithmetic error but show correct method, you may still get marks. It also helps you check your own work and identify where you went wrong if the answer doesn't match an option.",
    },
    {
      question: "What if my calculated answer isn't among the options?",
      answer:
        'First, recheck your calculation. Then verify you used the correct formula and units. Check for common errors like using wrong table values or forgetting decimal places. If still no match, choose the closest option and mark for review.',
    },
  ];
        ...
        <section className="mb-12">
          ...
          <div className="prose prose-invert max-w-none mb-6">
            <p className="text-white/80">
              ...
              approach to what's being asked.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="bg-white/5 rounded-lg p-4">
              ...
              <ul className="space-y-1 text-white/70 text-sm">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-3 h-3 text-green-400" /> Identify the command word
                  (State, Explain, Calculate)
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-3 h-3 text-green-400" /> Check for negative words (NOT,
                  EXCEPT)
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-3 h-3 text-green-400" /> Underline key technical terms
                </li>
              </ul>
            </div>
            <div className="bg-white/5 rounded-lg p-4">
              ...
              <ul className="space-y-1 text-white/70 text-sm">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-3 h-3 text-green-400" /> Look for absolute words
                  (always, never)
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-3 h-3 text-green-400" /> Check numbers and units
                  carefully
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-3 h-3 text-green-400" /> Compare similar-looking options
                  for differences
                </li>
              </ul>
            </div>
            <div className="bg-white/5 rounded-lg p-4">
              ...
              <ul className="space-y-1 text-white/70 text-sm">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-3 h-3 text-green-400" /> Use your predicted answer as a
                  guide
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-3 h-3 text-green-400" /> Make your best guess and mark
                  for review
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-3 h-3 text-green-400" /> Never leave a question blank
                </li>
              </ul>
            </div>
          </div>
