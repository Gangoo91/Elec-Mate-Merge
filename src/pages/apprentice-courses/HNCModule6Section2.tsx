    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-base text-muted-foreground mb-12">
          This section covers the main renewable energy technologies used in buildings, from solar
          PV and heat pumps to biomass and CHP systems. You'll learn about system design,
          installation requirements, grid connection and how these technologies integrate with
