...
const quickCheckQuestions = [
  {
    ...
    options: ['Derivative (D)', 'Proportional (P)', 'All three equally', 'Integral (I)'],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['Temperature', 'Humidity', 'Light levels', 'CO2 concentration'],
    correctIndex: 3,
    explanation:
...
const HNCModule8Section5_5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 5 · Subsection 5"
      ...
      <HubBody>
        ...
        <ConceptBlock title="PID Control Theory">
          ...
          <p>
            <strong>The PID Control Equation</strong>
          </p>
          <p>
          ...
          <p>
            <strong>The Three PID Terms</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Proportional (P):</strong> Output proportional to current error — Fast initial
              response — Cannot eliminate steady-state error
            </li>
            <li>
              <strong>Integral (I):</strong> Output proportional to accumulated error — Eliminates
              steady-state offset — Can cause overshoot and windup
            </li>
            <li>
              <strong>Derivative (D):</strong> Output proportional to rate of change — Anticipates
              and reduces overshoot — Sensitive to noise, rarely used in HVAC
            </li>
          </ul>
          <p>
            <strong>Common HVAC Control Modes</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>PID Tuning Methods</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Ziegler-Nichols (ultimate gain):</strong> Increase P until oscillation,
              calculate from K<sub>u</sub> and P<sub>u</sub> — Fast response, some overshoot
              acceptable
            </li>
            <li>
              <strong>Ziegler-Nichols (step response):</strong> Measure delay and time constant from
              step test — When oscillation testing is impractical
            </li>
            <li>
              <strong>Lambda tuning:</strong> Specify desired closed-loop time constant —
              Conservative, no overshoot required
            </li>
            <li>
              <strong>Trial and error:</strong> Systematically adjust and observe — Fine-tuning,
              experienced engineers
            </li>
            <li>
              <strong>Auto-tuning:</strong> Controller performs automated tests — Modern BMS,
              initial commissioning
            </li>
          </ul>
          <p>
            <strong>Practical tip:</strong> Most HVAC loops use PI control. Start with manufacturer
            defaults, then adjust proportional band first, followed by integral time. Only add
            derivative if overshoot is problematic and the signal is noise-free.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Cascade Control">
          ...
          <p>
            <strong>Cascade Control Structure</strong>
          </p>
          ...
          <p>
            <strong>Requirements for Cascade Control</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Common HVAC Cascade Applications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>AHU heating:</strong> Room/return air temp — Supply air temp — LTHW
              temp/pressure changes
            </li>
            <li>
              <strong>Chilled water system:</strong> Zone temperature — CHW flow/valve position —
              CHW supply temp variations
            </li>
            <li>
              <strong>VAV box:</strong> Zone temperature — Airflow rate — Duct pressure changes
            </li>
            <li>
              <strong>Boiler plant:</strong> Flow temperature — Boiler firing rate — Return temp,
              load changes
            </li>
          </ul>
          <p>
            <strong>Tuning Cascade Loops</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            ...
            its next adjustment. If the outer loop is too fast, it will fight the inner loop causing
            instability.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Optimised Start/Stop">
          <p>
            ...
            the minimum pre-conditioning time required to achieve comfort conditions by occupancy
            start, and the earliest time plant can be switched off whilst maintaining comfort until
            occupancy ends.
          </p>
          <p>
            <strong>Optimum Start</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Optimum Start Algorithm Factors</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Outside air temperature:</strong> Lower temp = earlier start — OAT sensor
            </li>
            <li>
              <strong>Inside air temperature:</strong> Lower temp = earlier start — Zone sensor
            </li>
            <li>
              <strong>Building thermal mass:</strong> Higher mass = earlier start — Configured
              parameter
            </li>
            <li>
              <strong>Plant heating/cooling capacity:</strong> Higher capacity = later start —
              Learned or configured
            </li>
            <li>
              <strong>Historical performance:</strong> Algorithm adapts over time — Self-learning
            </li>
          </ul>
          <p>
            <strong>Basic Optimum Start Calculation</strong>
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Boost mode:</strong> Override for rapid warm-up if algorithm underestimates
            </li>
            <li>
        ...
        <ConceptBlock title="Demand-Based Control and Setpoint Reset">
          ...
          <p>
            <strong>CO2-Based DCV Control:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Alternative DCV Methods:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Chilled Water Temperature Reset</strong>
          </p>
          <p>
            Raising the chilled water supply temperature during part-load conditions improves
            chiller efficiency (higher COP at elevated evaporator temperature) whilst still meeting
            cooling demand.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Outside air reset:</strong> CHW temp increases as OAT decreases — 6C at 30C
              OAT to 12C at 15C OAT
            </li>
            <li>
              <strong>Valve position reset:</strong> CHW temp increases if no valves &gt;90% open —
              Gradual increase until demand satisfied
            </li>
            <li>
              <strong>Return water reset:</strong> CHW temp based on return temperature — Maintain
              minimum delta-T
            </li>
          </ul>
          <p>
            <strong>Supply Air Temperature Reset</strong>
          </p>
          <p>
            Adjusting supply air temperature based on zone demand reduces simultaneous heating and
            cooling, improves dehumidification control, and optimises fan energy.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Low cooling demand:</strong> Raise SAT (e.g., 13C to 16C) — Reduced cooling
              and reheat energy
            </li>
            <li>
              <strong>High humidity:</strong> Lower SAT for dehumidification — Improved comfort,
              mould prevention
            </li>
            <li>
              <strong>Heating season:</strong> Raise SAT based on zone demand — Reduced reheat,
              improved efficiency
            </li>
          </ul>
          <p>
            <strong>Static Pressure Reset (VAV Systems)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Concept:</strong> Reduce duct pressure setpoint when VAV boxes are not fully
              open
            </li>
            <li>
              <strong>Method:</strong> Monitor VAV damper positions; if none &gt;90% open, reduce SP
              setpoint
            </li>
            <li>
              <strong>Benefit:</strong> Significant fan energy savings (fan power varies with cube
              of speed)
            </li>
            <li>
              <strong>Typical range:</strong> Design pressure 400 Pa, reset down to 200 Pa minimum
            </li>
            <li>
          ...
          <p>
            <strong>Night Setback and Unoccupied Mode</strong>
          </p>
          <p>
            <strong>Night Setback Settings:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Heating Hot Water Reset</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            ...
            temperature is 19C. With P-only control (K<sub>p</sub> = 10%/C), what is the controller
            output?
          </p>
          ...
          <p>
            Note: With P-only control, there will be a steady-state offset because the valve cannot
            reach 100% output for small errors.
          </p>
          <p>
          ...
          <p>
            <strong>Scenario:</strong> A meeting room has 800 ppm CO2 setpoint, outdoor 400 ppm. At
            100% occupancy, the outdoor air damper should be 100% open. Current CO2 is 600 ppm. What
            damper position?
          </p>
          ...
          <p>
            As occupancy increases and CO2 rises toward 800 ppm, the damper will progressively open
            to 100%.
          </p>
          <p>
          ...
          <p>
            <strong>Scenario:</strong> A chiller produces 500 kW cooling. At 6C CHW, COP is 4.0. At
            10C CHW, COP is 5.0. Calculate power reduction.
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Continuous oscillation:</strong> Excessive gain (P or I) — Reduce proportional
              gain, increase Ti
            </li>
            <li>
              <strong>Slow response:</strong> Insufficient gain, Ti too long — Increase gain, reduce
              Ti
            </li>
            <li>
              <strong>Steady-state offset:</strong> No integral action, or Ti too long — Enable
              integral, reduce Ti
            </li>
            <li>
              <strong>Overshoot then settling:</strong> Ti too short, no derivative — Increase Ti,
              add derivative if appropriate
            </li>
            <li>
              <strong>Output stuck at limit:</strong> Integral windup, undersized plant — Enable
              anti-windup, check plant sizing
            </li>
          </ul>
          <p>
