...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['60 seconds', '15 seconds', '0.5 seconds', '5 seconds'],
    correctIndex: 3,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['PH90 (90 minutes)', 'PH30 (30 minutes)', 'PH60 (60 minutes)', 'PH120 (120 minutes)'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Monthly', 'Annually', 'Daily', 'Weekly'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Emergency lighting', 'Sprinkler pump', 'Fire alarm panel', 'Smoke extract fan'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['150mm', '600mm', '450mm', '300mm'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <ConceptBlock title="Safety Services and Essential Supplies">
          ...
          <p>
            <strong>Safety service classifications:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Smoke control systems:</strong> Maintains tenable conditions in escape routes
            </li>
            <li>
          ...
          <p>
            <strong>Source Classifications (BS 7671 Regulation 560.6)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>No-break (UPS):</strong> 0 seconds — Fire alarm panels, critical IT
            </li>
            <li>
              <strong>Very short break:</strong> &lt; 0.15 seconds — Emergency lighting (maintained)
            </li>
            <li>
              <strong>Short break:</strong> &lt; 0.5 seconds — Smoke control systems
            </li>
            <li>
              <strong>Medium break:</strong> &lt; 15 seconds — Firefighting lifts, sprinkler pumps
            </li>
            <li>
              <strong>Long break:</strong> &gt; 15 seconds — Non-critical backup loads
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Fire-Rated Cables and Standards">
          ...
          <p>
            <strong>BS 7846 Categories</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>BS 8519 Enhanced</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Cable Type Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>MICC (Mineral Insulated):</strong> Inherently fire-resistant — Highest
              performance, harsh environments
            </li>
            <li>
              <strong>FP200 Gold:</strong> PH120 to BS 8491 — Fire alarm, emergency lighting
            </li>
            <li>
              <strong>SWA with fire barrier:</strong> Variable with system — Power to safety
              equipment
            </li>
            <li>
              <strong>LSOH fire-resistant:</strong> PH30/60/90/120 — General safety services
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Changeover Systems and Automatic Transfer">
          <p>
            Automatic Transfer Switches (ATS) provide seamless changeover between normal and standby
            power sources. Proper design ensures safety services receive power within acceptable
            transfer times while preventing backfeed hazards.
          </p>
          <p>
            <strong>ATS Operating Sequence</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1.</strong> Monitor mains supply voltage and frequency
            </li>
            <li>
              <strong>2.</strong> Detect mains failure (voltage drops below threshold)
            </li>
            <li>
              <strong>3.</strong> Send start signal to standby generator
            </li>
            <li>
              <strong>4.</strong> Generator reaches rated speed and voltage
            </li>
            <li>
              <strong>5.</strong> ATS transfers load to generator
            </li>
            <li>
              <strong>6.</strong> Monitor mains for restoration
            </li>
            <li>
              <strong>7.</strong> Retransfer to mains after stabilisation delay
            </li>
            <li>
              <strong>8.</strong> Generator runs on cooldown, then stops
            </li>
          </ul>
          <p>
            <strong>ATS Types and Applications</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Open transition:</strong> 50-100ms break — Standard safety services
            </li>
            <li>
              <strong>Closed transition:</strong> Make-before-break — Critical loads, paralleling
            </li>
            <li>
              <strong>Soft load transfer:</strong> Ramped transition — Motor loads, gradual transfer
            </li>
            <li>
              <strong>Static (solid-state):</strong> &lt; 4ms — Data centres, critical IT
            </li>
          </ul>
          <p>
          ...
          <p>
            <strong>Safety requirement:</strong> Open transition is preferred for most applications
            as it prevents any possibility of generator-mains paralleling, which requires complex
        ...
        <ConceptBlock title="Testing Requirements and Maintenance">
          <p>
            Safety service installations require rigorous testing regimes to ensure reliability when
            needed. BS 7671 and equipment-specific standards define commissioning tests, while
            ongoing maintenance ensures continued operational readiness.
          </p>
          <p>
            <strong>Commissioning Tests</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Test Documentation Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Commissioning certificate:</strong> Initial test results, system configuration
              — Life of installation
            </li>
            <li>
              <strong>Monthly test log:</strong> Test date, results, operator signature — Minimum 3
              years
            </li>
            <li>
              <strong>Annual inspection report:</strong> Comprehensive assessment, remedials — Life
              of installation
            </li>
            <li>
              <strong>Maintenance records:</strong> Repairs, replacements, modifications — Life of
              installation
            </li>
          </ul>
          <p>
            <strong>Generator Load Bank Testing</strong>
          </p>
          <p>
            <strong>Purpose:</strong> Verify generator can sustain rated load for required duration
          </p>
          <p>
          ...
          <p>
            <strong>Records:</strong> Fuel consumption, temperature, oil pressure, voltage/frequency
            stability
          </p>
          <p>
            <strong>Compliance note:</strong> Fire safety legislation requires safety systems to be
            maintained in proper working order. Test records provide evidence of compliance and may
            be requested by enforcing authorities.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Develop monthly functional test procedure for office building
            safety power system.
          </p>
          <p>Test procedure:</p>
          <p>Pre-test checks:</p>
