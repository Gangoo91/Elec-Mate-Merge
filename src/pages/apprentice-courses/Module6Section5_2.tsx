...
const Module6Section5_2 = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'The electrician performing the test is responsible for ensuring all safety procedures are followed correctly.',
    },
    {
      id: 10,
  ...
  const faqs = [
    {
      question:
        'What voltage is typically used for insulation resistance testing on standard low-voltage circuits?',
      answer:
        '500 V DC is typically used for most low-voltage circuits, though 250 V DC may be used where sensitive equipment is involved.',
    },
    {
      question: 'Can you carry out an insulation resistance test without isolating the supply?',
      answer:
        'No, the circuit must always be isolated and proved dead first. Testing live circuits is extremely dangerous and will give false readings.',
    },
    {
      question: 'Why must circuits be discharged after testing?',
      answer:
        'To remove any stored energy left in the insulation or equipment, which could otherwise give shocks or false readings in subsequent tests.',
    },
    {
      question: 'What safety equipment should be worn during IR testing?',
      answer:
        "Appropriate PPE including insulated gloves when required, and ensure all safety procedures are followed according to manufacturer's instructions.",
    },
    {
      question: 'How do you know if the test equipment is working correctly?',
      answer:
        "Check the instrument is properly calibrated, test leads are in good condition, and follow manufacturer's operational checks before use.",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            ...
            <ul className="text-white/80 text-sm space-y-1">
              ...
              <li>
                • <strong>Use:</strong> Correct test voltage (250V/500V/1000V DC)
              </li>
              <li>
                • <strong>Check:</strong> Circuit isolated, equipment disconnected, PPE worn
              </li>
            </ul>
          </div>
            ...
            <div className="text-white/80 space-y-3 leading-relaxed">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Identify the correct instruments used for insulation resistance testing
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-elec-yellow flex-shrink-0 mt-1" />
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-elec-yellow flex-shrink-0 mt-1" />
                  <span>
                    Recognise the importance of isolating and preparing circuits before testing
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-elec-yellow flex-shrink-0 mt-1" />
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                Using the wrong instrument, or failing to follow safe procedures, can result in
                inaccurate readings, damage to sensitive equipment, or even personal injury.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                depending on the installation being tested) across the conductors and measures the
                resistance to current flow.
              </p>
              <p>
                Modern testers are digital, lightweight, and include additional functions such as
                continuity testing. However, electricians must ensure the instrument is properly
                calibrated and rated for the voltage being tested.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                a suitable voltage indicator that no voltage is present.
              </p>
              <p>
                All appliances, electronic devices, and sensitive equipment should be disconnected
                from the circuit to prevent damage from the test voltage. Failure to do this could
                result in equipment being permanently damaged or giving false readings.
              </p>
              <p>
                It is also important to ensure that the circuit is free from temporary connections,
                such as borrowed neutrals, which could interfere with the test.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <p>
                ...
                be applied once all persons are clear of the circuit and informed that testing is
                about to begin.
              </p>
              <p>
                Many testers include a warning light to show that a test voltage is present. Once
                the test is complete, the circuit must be discharged to earth to remove any stored
                charge before it is reconnected.
              </p>
              <p>
                Electricians should also follow the manufacturer's operating instructions and wear
                suitable PPE such as insulated gloves when required.
              </p>
            </div>
          </section>
            ...
            <div className="text-white/80 space-y-4 leading-relaxed">
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <ul className="text-sm space-y-2">
                  <li>
                    • <strong>Accidental contact:</strong> Contact with test voltage can cause
                    discomfort or harm
                  </li>
                  <li>
                    • <strong>Equipment damage:</strong> Connected equipment can be damaged by test
                    voltages
                  </li>
                  <li>
                    • <strong>Misleading results:</strong> Poor preparation can produce invalid
                    readings
                  </li>
                  <li>
                    • <strong>Stored charge:</strong> Capacitive charge can cause shocks after
                    testing
                  </li>
                </ul>
              </div>
              <p>
                To minimise these risks, electricians must follow safe isolation procedures,
                double-check all disconnections, and ensure test leads are in good condition.
                Maintaining concentration during testing is vital to avoid mistakes that could
                compromise safety.
              </p>
            </div>
          </section>
          ...
          <InlineCheck
            ...
            options={[
              ...
              'Accidental contact with test voltage and equipment damage',
              'Lower readings and more work',
              'No risks at all',
            ]}
            correctIndex={1}
            ...
            <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/20">
              ...
              <div className="text-white/80 text-sm space-y-3 leading-relaxed">
                <p>
                  ...
                  500V DC test voltage damaged the computers' power supplies, costing the contractor
                  several thousand pounds in replacement equipment.
                </p>
                <p>
                  The incident could have been avoided by isolating properly, disconnecting all
                  sensitive equipment, and confirming the circuit was safe to test.
                </p>
                <p className="font-medium text-green-400 mt-3">
                  Lesson: Preparing the circuit correctly before testing is just as important as
                  carrying out the test itself.
                </p>
              </div>
            </div>
          </section>
