          ...
          <Card className="border-elec-yellow/30 bg-card">
            <CardContent className="p-8">
              <div className="text-center mb-8">
                ...
                <h2 className="text-lg text-elec-yellow mb-6">Inspection, Testing & Certification</h2>
              ...
              <div className="bg-background p-4 rounded-xl border border-muted/40 mb-6">
                ...
                <div className="grid gap-2">
                  <div className="flex items-start gap-2">
                    ...
                    <p className="text-sm text-white/80 leading-relaxed">30 questions randomly selected from Module 6 content</p>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="h-1.5 w-1.5 rounded-full bg-elec-yellow mt-2 flex-shrink-0" />
          ...
          <Card className="border-elec-yellow/30 bg-card">
            <CardContent className="p-6">
              <div className="text-center mb-6">
                ...
                <h2 className="text-lg text-elec-yellow">Inspection, Testing & Certification</h2>
              </div>
