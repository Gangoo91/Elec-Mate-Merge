...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 2,
    explanation:
      'Safety inspections focus on physical workplace conditions and immediate hazards. Safety audits are more comprehensive, examining the entire safety management system including policies, procedures, training, and culture - not just current conditions.',
  },
  {
    id: 'check-2',
    question:
      'How often should general workplace safety inspections typically be conducted on a construction site?',
    options: [
      'Once a year',
    ...
    correctIndex: 1,
    explanation:
      'Construction sites are dynamic environments with changing hazards. General inspections should be conducted daily or weekly. Higher-risk areas or activities may need more frequent inspection. The frequency should match the risk level.',
  },
  {
    id: 'check-3',
    ...
    correctIndex: 1,
    explanation:
      'Serious hazards must be addressed immediately - this may mean stopping work. All findings should be recorded with assigned actions, responsible persons, and deadlines. The purpose of inspection is to drive action, not just documentation.',
  },
  {
    id: 'check-4',
    ...
    correctIndex: 2,
    explanation:
      'Effective inspections involve multiple perspectives: workers understand day-to-day hazards, supervisors know operations, safety representatives provide worker input, and management ensure resources. Collaborative inspection produces better results.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'A safety audit is a systematic, independent examination of a safety management system against defined criteria (such as legal requirements, company standards, or standards like ISO 45001). It assesses whether what is supposed to happen actually happens.',
  },
  {
    id: 2,
    question:
      'Which of the following would typically be checked during a workplace safety inspection?',
    options: [
      'Employee birthdays',
    ...
    correctAnswer: 1,
    explanation:
      'Safety inspections check physical conditions: PPE availability and condition, housekeeping and tidiness, machinery guarding, clear access and egress routes, fire extinguisher checks, first aid provisions, and general hazard identification.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Checklists ensure consistency across inspections, help inspectors cover all relevant areas, provide documentation of what was checked, and ensure nothing important is overlooked. They also make it easier to track trends over time.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Regulation 5 requires employers to have arrangements for effective planning, organisation, control, monitoring, and review of preventive and protective measures. This includes regular inspections to check that controls remain effective.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      "A formal safety inspection is pre-planned, follows a systematic methodology, uses checklists or protocols, is documented with findings and actions, and is typically scheduled at regular intervals. This contrasts with informal 'walk-around' observations.",
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Safety audit outcomes include a formal report detailing findings (both positive and negative), recommendations for improvement, identified non-conformances, and opportunities for enhancement. The report drives improvement actions.',
  },
  {
    id: 7,
    question:
      'Who has the right to conduct inspections in the workplace under SRSC Regulations 1977?',
    options: [
      'Only HSE inspectors',
      'Only managers',
    ...
    correctIndex: 2,
    explanation:
      'Under the Safety Representatives and Safety Committees Regulations 1977, trade union appointed safety representatives have the legal right to inspect the workplace at least once every three months, or more frequently if circumstances warrant.',
  },
  {
    id: 8,
    question:
      'An electrician notices damaged insulation on cables during routine work. What type of safety activity is this?',
    options: [
      'A formal audit',
    ...
    correctAnswer: 1,
    explanation:
      "This is informal observation or continuous monitoring - workers noticing hazards as part of their normal work. This is valuable safety activity and such findings should be reported even though it's not a formal inspection.",
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      'Close-out is the process of verifying that recommended corrective actions have been properly implemented and are effective. This ensures the audit leads to actual improvement, not just paperwork.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Serious and imminent dangers require immediate action - stop the dangerous activity, evacuate workers from the hazard, and make the area safe. Documentation is important but secondary to preventing harm.',
  },
  {
    id: 11,
    ...
    correctAnswer: 1,
    explanation:
      "Reactive monitoring measures failures - accidents, incidents, near misses, ill health. It's important for learning but should be balanced with proactive monitoring (inspections, audits, observations) that identifies hazards before harm occurs.",
  },
  {
    id: 12,
    ...
    correctAnswer: 1,
    explanation:
      'Workers have direct experience of workplace hazards and may identify issues that managers or external auditors miss. Their involvement also increases buy-in to safety improvements and demonstrates that their safety concerns are valued.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Internal audits are conducted by your own organisation's staff (though ideally someone independent of the area being audited). External audits are conducted by outside parties - this could be a client, certification body, regulatory body (HSE), or independent consultant. External audits provide greater independence but internal audits are valuable for ongoing self-assessment.",
  },
  {
    question: 'Do I need to be trained to conduct safety inspections?',
    answer:
      'Basic workplace inspections can be conducted by anyone with appropriate knowledge of the work area and hazards. More formal inspections and audits benefit from training in inspection techniques, use of checklists, and reporting. Some specialist inspections (e.g., scaffolding, lifting equipment) require specific competencies.',
  },
  {
    question: 'How do I know what to look for during an inspection?',
    answer:
      'Use a checklist specific to your work area. Common areas include: PPE (available, suitable, worn, maintained), housekeeping (clean, tidy, clear walkways), fire safety (extinguishers, exits, storage), electrical safety (leads, connections, isolations), work at height (scaffolds, ladders, edge protection), and welfare (facilities, drinking water).',
  },
  {
    question: "What happens if I find a problem but can't fix it myself?",
    answer:
      "Record the finding, make the area safe if there's immediate danger (barriers, signs, stop work if necessary), and report to someone who can authorise the fix. Don't ignore problems because you can't personally resolve them - your role is to identify and report, ensuring action is taken.",
  },
  {
    question: 'Can workers refuse to work in an area that fails inspection?',
    answer:
      'Workers have a legal right to refuse work they reasonably believe poses serious and imminent danger to themselves or others. If an inspection reveals serious hazards, work should not proceed until controls are in place. The Employment Rights Act 1996 protects workers who raise legitimate safety concerns.',
  },
  {
    question: 'How should inspection records be stored?',
    answer:
      'Inspection records should be kept in a systematic way that allows retrieval for reference, trend analysis, and legal purposes. Electronic systems allow easier analysis but paper records are acceptable. Records should typically be kept for at least 3 years, longer if they relate to health surveillance or specific regulatory requirements.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-8 text-gray-200">
        ...
        <header className="mb-8">
          ...
          <p className="text-lg text-gray-300">
            Systematic methods for checking that safety controls are in place and working
            effectively.
          </p>
        </header>
        ...
        <div className="bg-[#222] border-l-4 border-elec-yellow rounded p-5 mb-8">
          ...
          <ul className="list-disc list-inside space-y-1 text-gray-300">
            <li>
              Inspections check physical conditions; audits examine the whole management system
            </li>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              Safety audits and inspections are both monitoring tools, but they serve different
              purposes and operate at different levels. Understanding the difference helps you use
              each effectively.
            </p>
            ...
            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm">
                    Checking before things go wrong - inspections, audits, observations, safety
                    tours, compliance checks. Measures what IS happening.
                  </p>
                </div>
                <div>
                  <p className="font-medium text-elec-yellow">Reactive Monitoring</p>
                  <p className="text-sm">
                    Learning from failures - accident investigations, near-miss analysis, ill-health
                    reports, complaints. Measures what HAS gone wrong.
                  </p>
                </div>
              </div>
              <p className="text-sm mt-3 italic">
                Both types are needed - proactive monitoring prevents harm; reactive monitoring
                ensures we learn from failures.
              </p>
            </div>
            ...
            <div className="bg-yellow-900/30 border border-yellow-600/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                ...
                employers to make and give effect to arrangements for effective monitoring and
                review of preventive and protective measures. This isn't optional - it's law.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              Effective safety inspections follow a systematic approach. Whether formal or informal,
              the process should identify hazards, check controls, and lead to action where needed.
            </p>
            ...
            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm">
                    Broad review of the whole work area - housekeeping, PPE, emergency equipment,
                    welfare facilities, general conditions.
                  </p>
                </div>
                <div>
                  <p className="font-medium text-elec-yellow">Statutory Inspection</p>
                  <p className="text-sm">
                    Legally required inspections by competent persons - lifting equipment (LOLER),
                    pressure systems (PSSR), electrical installations (EICR).
                  </p>
                </div>
                <div>
                  <p className="font-medium text-elec-yellow">Pre-Use Checks</p>
                  <p className="text-sm">
                    Daily/pre-use inspection of equipment - scaffolds, MEWPs, vehicles, power tools,
                    PPE.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm">
                    Focused on a particular activity or hazard - permit-to-work checks, hot work
                    areas, confined space entry.
                  </p>
                </div>
              </div>
            </div>
            ...
            <ol className="list-decimal list-inside space-y-2">
              <li>
                <strong>Prepare:</strong> Review checklist, previous findings, risk assessments,
                recent incidents
              </li>
              <li>
                <strong>Inform:</strong> Let people know you're inspecting (unless unannounced for
                good reason)
              </li>
              <li>
                <strong>Observe:</strong> Walk through systematically, looking for hazards and
                checking controls
              </li>
              <li>
                <strong>Record:</strong> Document findings - both positive and negative
              </li>
              <li>
                <strong>Act:</strong> Address immediate hazards; assign actions for other findings
              </li>
              <li>
                <strong>Report:</strong> Communicate findings to relevant parties
              </li>
              <li>
                <strong>Follow up:</strong> Check that actions have been completed
              </li>
            </ol>

            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              <h4 className="font-semibold text-white mb-3">
                What to Inspect - Electrical Work Areas:
              </h4>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              Safety audits take a wider view, examining whether the organisation's safety
              management system is fit for purpose and being implemented effectively. They answer
              the question: "Is what should be happening actually happening?"
            </p>
            ...
            <ol className="list-decimal list-inside space-y-2">
              <li>
                <strong>Planning:</strong> Define scope, criteria, team, schedule
              </li>
              <li>
                <strong>Preparation:</strong> Review documents, prepare checklists, notify auditees
              </li>
              <li>
                <strong>Opening meeting:</strong> Explain purpose, process, and expectations
              </li>
              <li>
                <strong>Audit execution:</strong> Document review, interviews, observations
              </li>
              <li>
                <strong>Analysis:</strong> Evaluate findings against criteria
              </li>
              <li>
                <strong>Closing meeting:</strong> Present preliminary findings
              </li>
              <li>
                <strong>Reporting:</strong> Formal report with findings and recommendations
              </li>
              <li>
                <strong>Follow-up:</strong> Verify corrective actions (close-out)
              </li>
            </ol>
            ...
            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              ...
              <div className="space-y-3">
                <div className="border-l-4 border-red-500 pl-4">
                  ...
                  <p className="text-sm">
                    Total absence of or significant failure to implement a required element.
                    Presents serious risk. Requires immediate action.
                  </p>
                </div>
                <div className="border-l-4 border-elec-yellow pl-4">
                  <p className="font-medium text-elec-yellow">Minor Non-Conformance</p>
                  <p className="text-sm">
                    Partial implementation or isolated failure. Does not affect overall system
                    effectiveness but needs correction.
                  </p>
                </div>
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-sm">
                    Not a failure but an area where improvement could be made. Recommendation for
                    enhancement.
                  </p>
                </div>
                <div className="border-l-4 border-green-500 pl-4">
                  ...
                  <p className="text-sm">
                    Noteworthy positive finding that could be shared or replicated elsewhere.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-blue-900/30 border border-blue-500/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                ...
                management systems. Many organisations are certified to this standard, which
                requires regular internal and external auditing. Understanding audit principles
                helps you participate effectively in such audits.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              The value of inspections and audits lies entirely in what happens afterward.
              Documentation without action is wasted effort. Findings must drive improvement.
            </p>
            ...
            <div className="bg-red-900/30 border border-red-500/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                An inspection that identifies hazards but leads to no action may be worse than no
                inspection at all. Once you know about a hazard and don't act, you have demonstrated
                knowledge of the risk - this has serious legal implications if someone is then
                injured.
              </p>
            </div>
            ...
            <div className="bg-[#282828] border border-gray-700 rounded-lg p-5 my-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-sm">
                    Address high-risk findings first. Immediate action for serious hazards. Use
                    risk-based approach for others.
                  </p>
                </div>
                <div>
                  <p className="font-medium text-elec-yellow">Assignment</p>
                  <p className="text-sm">
                    Every action needs an owner - someone responsible for completion. Be specific:
                    "Fix" is not an action; "Replace damaged cable in Panel 3 - J Smith" is.
                  </p>
                </div>
                <div>
                  <p className="font-medium text-elec-yellow">Deadlines</p>
                  <p className="text-sm">
                    Set realistic but firm deadlines. Immediate hazards need immediate action.
                    Others need dates, not "as soon as possible."
                  </p>
                </div>
                <div>
                  <p className="font-medium text-elec-yellow">Tracking</p>
                  <p className="text-sm">
                    Maintain a log of all actions. Review regularly. Chase overdue actions. Report
                    on completion rates.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm">
                    Check that actions have actually been completed and are effective. Don't just
                    accept "done" - verify it.
                  </p>
                </div>
              </div>
            </div>
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                <strong>Trend analysis:</strong> Look for patterns - recurring issues indicate
                systemic problems
              </li>
              <li>
                <strong>Root cause:</strong> Why did this happen? Address underlying causes, not
                just symptoms
              </li>
              <li>
                <strong>Sharing learning:</strong> If one area has issues, others might too - share
                findings
              </li>
              <li>
                <strong>Policy review:</strong> Do findings indicate policies need updating?
              </li>
              <li>
                <strong>Training needs:</strong> Do findings reveal knowledge gaps requiring
                training?
              </li>
            </ul>
            ...
            <div className="bg-yellow-900/30 border border-yellow-600/50 rounded-lg p-4 my-4">
              ...
              <p className="text-sm">
                Even as an apprentice, you can contribute significantly to safety monitoring. Report
                hazards you observe, participate actively in inspections, suggest improvements based
                on your direct experience, and help ensure actions are completed. Safety monitoring
          ...
          <div className="bg-[#282828] border border-gray-700 rounded-lg p-5">
            ...
            <div className="space-y-3 text-gray-300">
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Work area:</strong> Clear access, adequate lighting, housekeeping
                  acceptable?
                </span>
              </div>
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Tools and equipment:</strong> In good condition, tested, suitable for
                  task?
                </span>
              </div>
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>PPE:</strong> Available, correct type, in good condition?
                </span>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-elec-yellow font-bold">4.</span>
                <span>
                  <strong>Isolation:</strong> Correct isolation in place, lock-off applied, tested
                  dead?
                </span>
              </div>
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Emergency:</strong> Know location of extinguisher, first aid, assembly
                  point?
                </span>
              </div>
              <div className="flex items-start gap-2">
                ...
                <span>
                  <strong>Others:</strong> Are other workers/trades creating hazards affecting you?
                </span>
              </div>
            </div>
          </div>
        ...
        {/* Quiz */}
        <section className="mb-10">
          <Quiz title="Section 5.4 Knowledge Check" questions={quizQuestions} />
        </section>
