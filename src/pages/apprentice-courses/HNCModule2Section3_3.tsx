...
const quickCheckQuestions = [
  {
    ...
    options: ['Dry bulb temperature', 'Enthalpy', 'Moisture content', 'Relative humidity'],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['Relative humidity', 'Moisture content (g/kg)', 'Wet bulb temperature', 'Enthalpy'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['0 kJ/kg', 'Approximately 0 kJ/kg', 'Undefined', '2501 kJ/kg'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['J/kg', 'BTU/lb', 'kJ/kg of moist air', 'kJ/kg of dry air'],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The CIBSE chart is the de facto reference for UK HVAC design. As HNC engineer you
              should annotate every AHU schematic with its psychrometric process line so the
              commissioning engineer and BMS programmer can verify performance against design
              intent.
            </>
          }
        ...
        >
          <p>
            The psychrometric chart is a graphical representation of the thermodynamic properties of
            moist air. It allows engineers to visualise and analyse air conditioning processes.
          </p>
          <p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Adiabatic humidification:</strong> Along wet bulb line ↙. g↑, tdb↓, h constant
            </li>
            <li>
        ...
        >
          <p>
            <strong>Example 1: Finding All Properties.</strong> A sling psychrometer reads 24°C dry
            bulb and 17°C wet bulb. Find RH, moisture content, dew point and enthalpy.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Step 1: Plot the state point. Find vertical line at 24°C dry bulb. Find diagonal wet
              bulb line at 17°C. Mark intersection.
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Step 1: Plot initial state (12°C, 70% RH). Read initial moisture content: 6.2 g/kg.
            </li>
            <li>
              Step 2: Move horizontally to 22°C. Sensible heating = horizontal line (constant g).
            </li>
          ...
          <p>
            <strong>Example 3: Mixing Two Air Streams.</strong> 3 kg/s of outside air (30°C, 60% RH)
            mixes with 7 kg/s of return air (24°C, 50% RH). Find the mixed condition.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Step 1: Plot both states. Outside (O): 30°C, 60% RH → g = 16.0 g/kg. Return (R): 24°C,
              50% RH → g = 9.4 g/kg.
            </li>
            <li>Step 2: Draw line between O and R.</li>
            <li>
              Step 3: Find mixed point (M) by lever rule. Mass ratio: 3:7 (outside:return). M is
              3/10 of distance from R toward O.
            </li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Step 1: Plot room condition (21°C, 55% RH). Moisture content from chart: 8.6 g/kg.
            </li>
            <li>
              Step 2: Find dew point. Move horizontally left to saturation curve. Read temperature
              at intersection.
            </li>
            <li>
            ...
            <li>
              Any surface at or below 11.5°C will have condensation. Keep surfaces above 12°C for
              safety margin.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Confusing wet bulb and enthalpy lines:</strong> Nearly parallel but distinct
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              You inherit a partial design for a 12,000 l/s mixed-air AHU serving a 4-floor office.
              The schematic shows 30% outside air at 32 °C, 60% RH (CIBSE summer design) mixed with
              70% return air at 24 °C, 50% RH. The cooling coil is provisionally sized at 180 kW.
              You need to verify before tender.
            </>
          }
          whatToDo={
            <>
              Plot the outside-air state and the return-air state on the chart. Apply the lever rule
              (by mass flow, not volume): mixed point is 30% of the way from return to outside. Read
              the mixed-air enthalpy and moisture content. Plot the off-coil state from the supply
              temperature and required moisture content, read enthalpy. Calculate Q̇coil = ṁsupply ×
              Δh. Compare to the provisional 180 kW.
            </>
          }
          whyItMatters={
            <>
              Sizing a cooling coil from sensible duty alone (ignoring latent load) typically
              undersizes it by 25–40% in the UK summer. The chart visualises both sensible and
              latent legs of the process — undeniable on a peer review and cheaper than swapping the
              coil after commissioning.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Humidity</div>
          </button>
          <button
