...
const TITLE =
  'Identifying Installation Requirements from Drawings - Module 5.1.5 | Level 2 Electrical Course';
const DESCRIPTION =
  'Learn how to analyse electrical drawings to identify materials, routes, accessories, and compliance requirements before beginning installation work.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'The title block contains comprehensive information including drawing type, project details, scale, and date - all essential for proper interpretation.',
  },
  {
    id: 2,
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'The title block provides essential information including project details, drawing type, scale, and date needed for proper interpretation.',
    },
    {
      id: 2,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        "Notes commonly include critical material specifications such as 'All cables to be LSF' which are essential for safety and regulatory compliance.",
    },
    {
      id: 6,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Safe zones ensure cables are installed in positions where they are protected from damage during construction and future work, as required by BS 7671.',
    },
    {
      id: 10,
  ...
  const faqs = [
    {
      ...
      answer:
        'Not always — cable sizes should be confirmed in the project specification when not clearly shown on drawings.',
    },
    {
      question: 'What if the drawing shows a circuit number but no protective device?',
      answer:
        'Cross-reference the circuit number with the distribution schedule, which will specify the protective device type and rating.',
    },
    {
      question: 'Can I ignore small notes if the main drawing looks clear?',
      answer:
        'Never — notes may contain critical details about materials, installation methods, or safety requirements that override standard practices.',
    },
    {
      question: 'How do I know which symbols apply to my installation?',
      answer:
        'Always refer to the drawing legend or symbol key, and cross-check with project specifications for material and accessory details.',
    },
    {
      question: 'What should I do if I find conflicts between drawings and specifications?',
      answer:
        'Stop work immediately and seek clarification from the project manager. Document the conflict and get written confirmation of the correct approach.',
    },
  ];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <header className="text-center mb-12">
            <div className="inline-flex items-center gap-2 text-elec-yellow text-sm mb-3">
              ...
              <span className="text-white">Section 5.1.5</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-bold text-white mb-3 leading-tight">
              Identifying Installation Requirements from Drawings
            </h1>
            <p className="text-white text-base sm:text-lg leading-relaxed max-w-2xl mx-auto">
              Drawings are more than just pictures of layouts — they are instructions for how an
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <ul className="list-disc pl-5 space-y-1 text-white text-sm">
                  <li>
                    <strong>Spot:</strong> Material lists, installation methods, BS standards,
                    testing requirements.
                  </li>
                  <li>
                    <strong>Use:</strong> Follow specifications exactly, cross-check with drawings,
                    report conflicts.
                  </li>
                  <li>
                    <strong>Check:</strong> Materials match spec, methods are correct, standards are
                    current.
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The title block and notes provide essential information that must be understood
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="mb-2">
                  <strong className="text-white">Title block gives:</strong> Drawing type, project
                  details, scale, and date.
                </p>
                ...
                <p className="mb-2">
                  <strong className="text-white">Notes often contain:</strong> Vital instructions
                  (e.g., "all cables to be LSF – low smoke and fume").
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="text-sm text-white mt-3">
                  <strong>Key principle:</strong> Always read title blocks and notes first - they
                  contain mandatory requirements that override standard practices
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Drawings use symbols and annotations to specify exactly which materials and
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <p className="mb-2">
                  <strong className="text-white">Symbols and annotations</strong> show whether to
                  use PVC, steel conduit, trunking, tray, or other containment.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="mb-2">
                  <strong className="text-white">Socket, switch, and luminaire symbols</strong>{' '}
                  specify accessory types.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="text-sm text-white mt-3">
                  <strong>Selection guide:</strong> Always refer to the drawing legend and
                  cross-check with specifications for complete material details
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every circuit must be properly identified and cross-referenced to ensure correct
                installation:
              </p>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-purple-500/50">
                ...
                <p className="mb-2">
                  <strong className="text-white">Circuits labelled</strong> with numbers or codes
                  (e.g., L1/03).
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="mb-2">
                  <strong className="text-white">Must be cross-referenced</strong> with distribution
                  schedules.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="text-sm text-white mt-3">
                  <strong>Critical process:</strong> Never assume circuit details - always
                  cross-reference with distribution schedules and specifications
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>Cable routes must be carefully planned to comply with safety regulations:</p>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-orange-500/50">
                ...
                <p className="mb-2">
                  <strong className="text-white">Drawings show intended routes</strong> within
                ...
                <p className="mb-2">
                  <strong className="text-white">Routes must follow regulations</strong> for safe
                  cable zones.
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="text-sm text-white mt-3">
                  <strong>Safety priority:</strong> Routes must comply with BS 7671 safe zones to
                  prevent damage during future work
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Drawings and specifications must be used together for complete installation
                information:
              </p>

              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-teal-500/50">
                <p className="font-medium text-white mb-3">
                  Drawings and Specifications Integration
                </p>

                <p className="mb-2">
                  <strong className="text-white">Drawings give visual positions;</strong>{' '}
                  specifications give technical detail (e.g., cable sizes, protective devices).
                </p>
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                ...
                <p className="mb-2">
                  <strong className="text-white">Both must be used together</strong> for complete
                ...
                <p className="text-sm text-white mt-3">
                  <strong>Working principle:</strong> Drawings show where, specifications show how -
                  both are essential for compliant installation
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Avoid these common mistakes when interpreting installation requirements from
                drawings:
              </p>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-red-500/50">
                ...
                <ul className="text-sm ml-4 mb-3 list-disc space-y-1">
                  <li>
                    <strong className="text-white">Ignoring notes:</strong> Missing critical
                    material or method requirements
                  </li>
                  <li>
                    <strong className="text-white">Misreading symbols:</strong> Installing wrong
                    accessory or material types
                  </li>
                  <li>
                    <strong className="text-white">Assuming cable sizes:</strong> Not checking
                    specifications for cable requirements
                  </li>
                  <li>
                    <strong className="text-white">Wrong scale interpretation:</strong> Incorrect
                    measurements and positioning
                  </li>
                  <li>
                    <strong className="text-white">Outdated drawings:</strong> Working from
                    superseded versions
                  </li>
                  <li>
                    <strong className="text-white">Missing cross-references:</strong> Not checking
                    distribution schedules
                  </li>
                </ul>

                <p className="text-sm text-white mt-3">
                  <strong>Prevention strategy:</strong> Always read carefully, check specifications,
                  and seek clarification when uncertain
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-white">
                  ...
                  <p className="text-sm mb-3">
                    On a commercial site, an installer assumed all sockets were standard 13A types
                    based on the drawing symbols. However, the drawing notes specified that some
                    sockets required RCD-protected outlets for outdoor use. The oversight led to
                    failed inspection, rework, and project delays, costing both time and money.
                  </p>
                  <p className="text-sm font-medium text-white">
                    <strong>Lesson:</strong> Always read all notes and cross-check with
                    specifications - symbols alone don't provide complete information.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  How to identify installation requirements from electrical drawings effectively.
                </li>
                <li>
                  The importance of title blocks, notes, and legends in drawing interpretation.
                </li>
                <li>How to determine materials, accessories, and routes from drawing symbols.</li>
                <li>
                  Why cross-referencing with specifications is essential for complete information.
                </li>
              ...
              <p className="mt-4 font-medium text-elec-yellow">
                Accurate interpretation of installation requirements ensures safe, compliant, and
          ...
          {/* Quiz */}
          <div className="mb-10">
            <Quiz title="Installation Requirements Quiz" questions={quizQuestions} />
          </div>
