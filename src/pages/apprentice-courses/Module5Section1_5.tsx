      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-card border-border/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">1. Reading the Title Block and Notes</h3>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-emerald-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-emerald-400 dark:text-emerald-400 mb-1">Title Block Information</p>
                    <p className="text-base text-foreground mb-2"><strong>Title block gives:</strong> Drawing type, project details, scale, and date.</p>
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Notes often contain:</strong> Vital instructions (e.g., "all cables to be LSF – low smoke and fume").</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">2. Identifying Materials</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Symbols and annotations</strong> show whether to use PVC, steel conduit, trunking, tray, or other containment.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Socket, switch, and luminaire symbols</strong> specify accessory types.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">3. Circuit Identification</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-purple-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-purple-600 dark:text-emerald-400 mb-1">Circuit Codes and References</p>
                    <p className="text-base text-foreground mb-2"><strong>Circuits labelled</strong> with numbers or codes (e.g., L1/03).</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Must be cross-referenced</strong> with distribution schedules.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">4. Safe Zones and Routes</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-orange-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-orange-600 dark:text-emerald-400 mb-1">Cable Routes and Safe Zones</p>
                    <p className="text-base text-foreground mb-2"><strong>Drawings show intended routes</strong> within walls, floors, and ceilings.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Routes must follow regulations</strong> for safe cable zones.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">5. Cross-Referencing Specifications</h3>
            <p className="text-base text-foreground mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-teal-500 bg-teal-500/5">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Drawings give visual positions;</strong> specifications give technical detail (e.g., cable sizes, protective devices).</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-foreground mb-2"><strong>Both must be used together</strong> for complete installation requirements.</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
          ...
          {/* Common Errors */}
          <section className="mb-6">
            <h3 className="font-medium text-foreground mb-4">6. Common Errors</h3>
            <p className="text-base text-foreground mb-4">
            ...
            <div className="space-y-4">
              <div className="rounded-lg p-5 border-l-4 border-l-red-500 bg-card">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-red-600 dark:text-emerald-400 mb-1">Common Interpretation Errors</p>
                    <ul className="text-xs sm:text-sm text-foreground ml-4 mb-2 list-disc space-y-1">
