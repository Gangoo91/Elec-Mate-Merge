...
const quickCheckQuestions = [
  {
    ...
    options: ['Dry bulb temperature', 'Moisture content (g/kg)', 'Relative humidity', 'Enthalpy'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Qs = ṁ × g × hfg', 'Qs = V̇ × ΔP', 'Qs = ṁ × Δg', 'Qs = ṁ × cp × ΔT'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['QL = ṁ × Δg × hfg', 'QL = V̇ × Δρ', 'QL = ṁ × cp × ΔT', 'QL = ṁ × Δh'],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              CIBSE Guide B is the design code of practice for the four canonical AHU processes. As
              HNC engineer you reference Guide B1/B3 when selecting plant schedules, especially when
              the architect questions why coils, humidifiers or fan sizes have been upgraded against
        ...
        >
          ...
          <p>
            <strong>Adiabatic Saturation Efficiency:</strong> η = (T1 - T2) / (T1 - Twb). Efficiency
            typically 70-90% for spray/media systems.
          </p>
          <p>
        ...
        >
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cooling coil:</strong> Surface below dew point. Chart path toward ADP. Used in
              most HVAC systems.
            </li>
            <li>
              <strong>Desiccant:</strong> Moisture absorption. Chart path down-right (g↓, T↑). Used
              for low humidity needs.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <p>
            <strong>Example 2: Cooling with Dehumidification.</strong> Air at 28°C, 12 g/kg enters a
            cooling coil and leaves at 14°C, 9 g/kg. Calculate sensible, latent and total load for 3
            kg/s.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Example 3: Air Mixing.</strong> 1.5 kg/s outside air (32°C, 18 g/kg) mixes with
            4.5 kg/s return air (24°C, 10 g/kg). Find mixed conditions.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <Scenario
          ...
          situation={
            <>
              A 220 m² City dealing-room with full-height south glazing has 65 occupants and 80 kW
              of IT load. Summer design is 30 °C, 50% RH ambient; internal target is 22 °C, 50% RH.
              The original concept used sensible-only chilled beams and now overheats by
              mid-afternoon.
            </>
          }
          whatToDo={
            <>
              Calculate the sensible load (occupants 75 W each + IT 80 kW + solar gain). Calculate
              the latent load from occupant moisture generation (≈55 g/h each at light office work).
              Compute SHR. If SHR &lt; 0.85, chilled beams alone are insufficient — recommend a
              4-pipe FCU or AHU coil with active dehumidification. Plot the supply-air state on the
              chart and document the ADP and contact factor in the schedule.
            </>
          }
          whyItMatters={
            <>
              A latent-blind design strands the building at high RH and warm operative temperature.
              Productivity drops, the FM team field complaints, and retrofitting active
              dehumidification in occupied dealing rooms is brutally expensive. The chart-based SHR
              check catches the gap at design stage.
            </>
          }
        />
