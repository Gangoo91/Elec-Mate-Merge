...
const TITLE =
  'Following Up with Re-Testing or Certification (Awareness) - Level 2 Module 7 Section 6.5';
const DESCRIPTION =
...
const quizQuestions = [
  {
    ...
    options: [
      ...
      'To reduce the time spent on the original fault diagnosis',
      'To avoid having to isolate the circuit again',
    ],
    correctAnswer: 1,
    explanation:
      'Retesting provides objective proof that the repair was successful and the installation once again complies with BS 7671.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    options: [
      'That the original installer was at fault',
      'That the cable size now meets BS 7671 minimums',
      'That the supply voltage is within tolerance',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Only competent, qualified electricians can legally sign and validate electrical certification.',
  },
  {
    id: 6,
    question: 'What role can apprentices play in re-testing?',
    options: [
      'They must sign the certificate once testing is complete',
      'They can decide whether the installation passes or fails',
      'They can carry out physical retests under supervision and record values accurately',
      'They have no part to play in the re-testing process',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'True - a visual check of the repair is sufficient',
      'True - only the supervisor needs to confirm the repair',
      'False - retesting is only needed on new installations',
  ...
  },
  {
    ...
    options: [
      ...
      'To allow the circuit to remain energised during testing',
      'To remove the need for a competent person to sign off',
      'To reduce the number of tests that must be carried out',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The insulation resistance reading on the lighting circuit',
      'The corrected continuity test results for the CPC',
      'The earth fault loop impedance at the origin',
      'The RCD trip time at the consumer unit',
    ],
    correctAnswer: 1,
    explanation:
      'The corrected test results showing proper CPC continuity were entered onto the Electrical Installation Certificate.',
  },
  {
    id: 10,
    question:
    ...
    options: [
      'The repair itself failed when the circuit was energised',
      'The apprentice signed the certificate without authority',
      'Building control questioned whether the repair had been verified, requiring a return visit',
      'The wrong type of certificate was issued to the client',
    ],
    correctAnswer: 2,
    explanation:
...
const quickCheckQuestions = [
  {
    ...
    options: [
      'To increase the rating of the protective device',
      'To reduce the time spent on the next fault',
      'To avoid having to isolate the circuit again',
  ...
  },
  {
    ...
    options: [
      'EIC, MWC, or EICR depending on the type of work',
      'Only the Minor Works Certificate in every case',
      'Only the Electrical Installation Certificate in every case',
      'No certificate ever needs updating after a repair',
    ],
    correctIndex: 0,
    explanation:
      'Different electrical work requires different certification types, and all may need updating when faults are repaired.',
  },
  {
    id: 'apprentice-role',
    question:
    ...
    options: [
      'They can sign the certificate but must not carry out the tests',
      'Apprentices can carry out physical retests and record values under supervision, but cannot sign certification',
      'They can decide pass or fail but must not record the readings',
      'They can issue the certificate to building control on completion',
    ],
    correctIndex: 1,
    explanation:
      'Apprentices can assist with testing and recording but lack the authority to validate or certify results.',
  },
  {
    ...
    options: [
      'Because it speeds up the original fault diagnosis',
      'Because it removes the need for a competent person to sign off',
      'Because it provides legal compliance, protects users, and demonstrates professional integrity',
      'Because it allows the circuit to stay live during the work',
    ],
    correctIndex: 2,
    explanation:
      'Proper retesting and certification protect users, ensure legal compliance, and maintain professional reputation and accountability.',
  },
];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-10">
            <p className="text-white text-base sm:text-lg leading-relaxed">
              ...
              evidence that the installation is safe for continued use. Apprentices at Level 2 are
              not responsible for certification, but they must understand why follow-up testing
              matters and how it fits into professional electrical practice.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                loose connection has been re-terminated, continuity must be checked again; if
                miswiring has been corrected, polarity must be verified. Retesting provides
                objective proof that the installation once again complies with BS 7671. Without
                retesting, repairs cannot be trusted and the installation cannot be energised
                safely.
              </p>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-blue-500/50">
                ...
                <ul className="space-y-1.5 text-sm">
                  <li>
                    • <strong>Continuity tests</strong> - After reconnecting CPCs or circuit
                    conductors
                  </li>
                  <li>
                    • <strong>Polarity tests</strong> - After correcting miswired connections
                  </li>
                  <li>
                    • <strong>Insulation resistance tests</strong> - After replacing damaged cables
                    or accessories
                  </li>
                  <li>
                    • <strong>RCD testing</strong> - After any work affecting protective devices
                  </li>
                  <li>
                    • <strong>Earth fault loop impedance tests</strong> - After changes to earthing
                    arrangements
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                recorded on an Electrical Installation Certificate (EIC) or Minor Works Certificate
                (MWC). During periodic inspections (EICRs), repaired faults and their updated test
                results should also be documented. Certification provides a legal record that the
                installation has been tested and found safe. Apprentices must understand that while
                they can assist with recording values, only competent persons can sign
                certification.
              </p>
              ...
              <div className="p-4 rounded-lg bg-white/5 border-l-2 border-green-500/50">
                ...
                <ul className="space-y-1.5 text-sm">
                  <li>
                    • <strong>Electrical Installation Certificate (EIC)</strong> - New installations
                    and major alterations
                  </li>
                  <li>
                    • <strong>Minor Works Certificate (MWC)</strong> - Small additions and
                    alterations
                  </li>
                  <li>
                  ...
                  <li>
                    • <strong>Schedule of Test Results</strong> - Detailed test data supporting
                    certificates
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                assist in updating test schedules. However, you cannot sign or certify results as
                valid — this responsibility rests with the qualified supervisor. By assisting
                carefully and recording accurately, apprentices build both competence and trust.
              </p>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                properly proven safe, both the electrician and the client are exposed to risk.
                Proper follow-up protects users, meets the requirements of BS 7671, and demonstrates
                professionalism. Apprentices should learn early that "finding and fixing" is only
                complete once the work is retested, recorded, and handed over with evidence.
              </p>
              ...
              <div className="grid gap-4">
                <div className="p-4 rounded-lg bg-white/5 border-l-2 border-elec-yellow/50">
                  ...
                  <ul className="space-y-1.5 text-sm">
                    <li>
                      • Electrical work is only complete when properly verified and documented
                    </li>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-white text-sm">
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <span>
                      <strong>Repeat Exact Tests:</strong> Always repeat the specific test that
                      revealed the original fault using the same test method
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <span>
                      <strong>Record Clearly:</strong> Document updated values clearly with circuit
                      references and descriptions of actions taken
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <span>
                      <strong>Compare Results:</strong> Check new test results against original
                      readings and acceptable limits
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <span>
                      <strong>Verify Improvement:</strong> Ensure readings now meet BS 7671
                      requirements and demonstrate fault elimination
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-green-500/30">
                ...
                <ul className="space-y-2 text-white text-sm">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Accurate Notes:</strong> Provide precise circuit references, fault
                      descriptions, and repair actions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-1">•</span>
                    <span>
                      <strong>Support Supervisors:</strong> Assist with entering results into
                      certificates and maintaining schedules
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-1">•</span>
                    <span>
                      <strong>Learn Processes:</strong> Ask to review how test results link to
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-1">•</span>
                    <span>
                      <strong>Understand Importance:</strong> Appreciate how proper documentation
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-white text-sm">
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <span>
                      <strong>Build Competence:</strong> Gain experience with proper testing
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <span>
                      <strong>Establish Trust:</strong> Demonstrate reliability through careful
                      assistance and accurate recording
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <span>
                      <strong>Understand Boundaries:</strong> Know what you can and cannot do in
                      terms of certification responsibility
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <span>
                      <strong>Prepare for Future:</strong> Build skills and knowledge that support
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-elec-yellow/30">
                ...
                <div className="space-y-3 text-white text-sm">
                  <p>
                    ...
                    conductor). Initial continuity readings were infinite, indicating a complete
                    break in the protective conductor.
                  </p>
                  <p>
                    <strong className="text-white">Action:</strong> The apprentice, working under
                    supervision, located the problem at a socket outlet where the CPC had not been
                    properly terminated. The connection was re-made with correct technique and
                    torque settings.
                  </p>
                  <p>
                    <strong className="text-white">Follow-up:</strong> The apprentice retested
                    continuity across the entire ring, recording readings that now showed proper
                    values (typically less than 0.05Ω for domestic rings). The corrected results
                    were entered onto the Electrical Installation Certificate.
                  </p>
                  <p>
                    <strong className="text-white">Outcome:</strong> Without retesting and updating
                    the certificate, the fault would have remained undocumented, leaving the
                    certificate incomplete and the installation legally non-compliant. The thorough
                    follow-up ensured safety and compliance.
                  </p>
                </div>
                <div className="mt-3 p-3 rounded-lg bg-elec-yellow/10 border border-elec-yellow/20">
                  <p className="text-white text-sm font-medium">
                    Key Learning: Proper retesting and documentation turned a potentially dangerous
                    situation into a compliant, safe installation.
                  </p>
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-red-500/30">
                ...
                <div className="space-y-3 text-white text-sm">
                  <p>
                    ...
                    building. The reading was 0.3MΩ, well below the minimum 1MΩ required by BS 7671.
                  </p>
                  <p>
                    <strong className="text-white">Action:</strong> The faulty section of cable was
                    identified and replaced. Post-repair testing showed insulation resistance had
                    improved to 150MΩ, well within acceptable limits.
                  </p>
                  <p>
                    <strong className="text-white">Problem:</strong> However, the electrician failed
                    to update the EICR with the new test results. The original report was submitted
                    to building control showing the fault as unresolved.
                  </p>
                  <p>
                    <strong className="text-white">Consequences:</strong> Months later, when the
                    report was reviewed by building control during a routine audit, the missing
                    updated information raised serious questions about whether the repair had
                    actually been verified. The contractor was forced to:
                  </p>
                ...
                <div className="mt-3 p-3 rounded-lg bg-red-500/10 border border-red-500/20">
                  <p className="text-white text-sm font-medium">
                    Key Learning: Incomplete documentation can have serious professional and
                    financial consequences, even when the technical work is completed correctly.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                fault rectification from a simple repair into a professional, accountable process.
              </p>
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <span>
                      <strong className="text-white">Retesting is Essential:</strong> Every repair
                      must be verified through appropriate testing to prove the fault is eliminated
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <span>
                      <strong className="text-white">Certification Updates:</strong> Test results
                      must be recorded on appropriate certificates (EIC, MWC, or EICR) to provide
                      legal compliance
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <span>
                      <strong className="text-white">Apprentice Support Role:</strong> Level 2
                      apprentices can assist with retesting and recording but cannot sign
                      certification
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <span>
                      <strong className="text-white">Professional Standards:</strong> Proper
                      follow-up demonstrates professionalism, ensures safety, and protects
                      reputation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow mt-1">•</span>
                    <span>
                      <strong className="text-white">Legal Protection:</strong> Complete
                      documentation protects both electricians and clients from liability and
                      compliance issues
                    </span>
                  </li>
                </ul>
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    ...
                    <span className="font-medium text-white">
                      Always retest after repairs - it's the only way to prove the fault is
                      eliminated and the installation is safe
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow font-bold mt-1">2.</span>
                    <span className="font-medium text-white">
                      Update certificates with corrected results - proper documentation is essential
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span className="font-medium text-white">
                      Work within your scope - apprentices assist with testing but only qualified
                      persons can certify results
                    </span>
                  </li>
                </ul>
              </div>
