...
const HNCModule3Section5_3 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 5 · Subsection 3"
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Why this matters for transformer selection: an autotransformer&rsquo;s primary and
              secondary share a winding, so a fault on the secondary can directly impose primary
              voltage on the load. BS 7671 411 ADS is therefore jeopardised if you specify an
              autotransformer for safety isolation duty. For medical, fountain, marina, SELV/PELV,
              locations conducting electrical situations, and laboratory bench-top isolation, you
              must specify a true isolating transformer to BS EN 61558 with separated windings.
            </>
          }
        ...
        <ConceptBlock title="Single-Phase Transformer Construction">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Domestic supply (rural)</strong> — 16-50 kVA — Pole-mounted, 11 kV/230V
            </li>
            <li>
              <strong>Control circuits</strong> — 0.1-5 kVA — 400V/110V or 230V/24V
            </li>
            <li>
              <strong>Isolation transformers</strong> — 0.5-10 kVA — 1:1 ratio for IT systems
            </li>
            <li>
              <strong>Site tool supplies</strong> — 3-10 kVA — 230V/110V CTE
            </li>
            <li>
              <strong>Welding supplies</strong> — 5-50 kVA — High current, low voltage secondary
            </li>
          </ul>

          <p>
            <strong>Design consideration:</strong> Three single-phase transformers can provide
            three-phase supply with individual unit redundancy - if one fails, the remaining two can
            supply reduced load via open-delta connection.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Three-Phase Transformer Types">
          <p>
            ...
            distribution. They offer significant advantages in size, weight, and efficiency compared
            to equivalent banks of single-phase units.
          </p>
          ...
          <p>
            The most common construction uses a three-limbed core where each phase winding occupies
            one limb. The magnetic flux from each phase combines in the common yokes connecting the
            limbs.
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Independent phases:</strong> Fault in one phase less likely to affect others
            </li>
            <li>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Core material</strong> — ~15% less — Baseline
            </li>
            <li>
              <strong>Copper material</strong> — ~15% less — Baseline
            </li>
            <li>
              <strong>Floor space</strong> — Smaller footprint — Larger total area
            </li>
            <li>
              <strong>Cost</strong> — Lower — Higher
            </li>
            <li>
              <strong>Efficiency</strong> — Higher — Slightly lower
            </li>
            <li>
              <strong>Redundancy</strong> — Complete failure if faulty — Open-delta operation
              possible
            </li>
            <li>
              <strong>Transport</strong> — May exceed limits at large ratings — Easier for very
              large installations
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Vector Groups">
          ...
          <p>
            The notation uses capital letters for HV winding, lowercase for LV winding, and a clock
            number for phase displacement.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Dyn11</strong> — 330° (LV leads) — UK distribution standard (11kV/400V)
            </li>
            <li>
              <strong>Yy0</strong> — 0° — Transmission (problems with 3rd harmonic)
            </li>
            <li>
              <strong>Dd0</strong> — 0° — Industrial, no neutral required
            </li>
            <li>
              <strong>Yd1</strong> — 30° (LV lags) — Step-up transformers at generators
            </li>
            <li>
              <strong>Dy11</strong> — 330° (LV leads) — Step-up from LV generation
            </li>
            <li>
              <strong>YNd1</strong> — 30° (LV lags) — Transmission with HV neutral
            </li>
            <li>
              <strong>Dzn0</strong> — 0° — Earthing/grounding transformers
            </li>
          </ul>

          <p className="text-sm font-medium text-elec-yellow/80">Why Dyn11 is the UK Standard</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Star secondary:</strong> Provides neutral for single-phase loads (230V from
              400V three-phase)
            </li>
            <li>
            ...
            <li>
              <strong>Unbalanced loads:</strong> Can supply unbalanced single-phase loads without
              problems
            </li>
          </ul>

          <p>
            <strong>Remember:</strong> The clock number indicates where the LV voltage phasor points
            when the HV phasor points to 12 o'clock. Each hour represents 30°.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Parallel Operation Requirements">
          <p>
            ...
            strict conditions must be met to prevent circulating currents and ensure proper load
            sharing.
          </p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Different voltage ratios:</strong> Circulating current proportional to voltage
              difference
            </li>
            <li>
            ...
            <li>
              <strong>Different impedances:</strong> Unequal load sharing - low Z takes more load
            </li>
            <li>
          ...
          <p>
            When transformers with different impedances are paralleled, they share load inversely
            proportional to their per-unit impedances:
          </p>

          <p>S₁ = S_total × (Z₂ / (Z₁ + Z₂))</p>
          <p>S₂ = S_total × (Z₁ / (Z₁ + Z₂))</p>

          <p>The lower impedance transformer carries more than its proportionate share of load.</p>

          <p className="text-sm font-medium text-elec-yellow/80">Parallel Operation Checks</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Voltage ratio</strong> — Measure secondary open-circuit — Within ±0.5%
            </li>
            <li>
              <strong>Phase sequence</strong> — Phase rotation meter — Same sequence (R-Y-B)
            </li>
            <li>
              <strong>Phase angle</strong> — Voltage across open switch — Zero or very low voltage
            </li>
            <li>
              <strong>Polarity</strong> — Polarity test or nameplate — Same polarity markings
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ConceptBlock title="Auto-Transformers">
          ...
          <p>The kVA rating of an auto-transformer required for a given load is:</p>

          <p>kVA_auto = kVA_load × (1 - V₂/V₁)</p>
          <p>For 400V to 230V: kVA_auto = kVA_load × (1 - 230/400) = 0.425 × kVA_load</p>

          <p>
            The auto-transformer need only be rated at 42.5% of the load for a 400V/230V conversion.
          </p>

          <p className="text-sm font-medium text-elec-yellow/80">Auto-Transformer Applications</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Motor starting</strong> — 80%, 65%, 50% taps — Reduced voltage starting
            </li>
            <li>
              <strong>Voltage regulators</strong> — Variable ±10% — Voltage correction (variacs)
            </li>
            <li>
              <strong>Interconnection</strong> — 400kV/275kV — Grid voltage matching
            </li>
            <li>
              <strong>Test supplies</strong> — Variable 0-100% — Laboratory voltage adjustment
            </li>
            <li>
              <strong>Buck-boost</strong> — ±5% to ±15% — Voltage correction for equipment
            </li>
          </ul>
        ...
        <ConceptBlock title="Scott Connection for Two-Phase Conversion">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Construction and Operation</p>

          <p>Two single-phase transformers are used:</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Main transformer:</strong> Connected across two phases (e.g., R-B)
            </li>
            <li>
              <strong>Teaser transformer:</strong> Primary has 86.6% turns, connected to Y and main
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Voltage and Turn Ratios</p>

          <p>Main transformer: N₁ turns (full winding)</p>
          <p>Teaser transformer primary: 0.866 × N₁ turns (86.6%)</p>
          <p>For equal secondary voltages, both secondaries have the same turns</p>
          <p>The 86.6% factor is √3/2, derived from three-phase geometry</p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Neutral Earthing Transformers">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Generator earthing</strong> — Delta-connected generators — Provide earth
              reference, limit fault current
            </li>
            <li>
              <strong>Delta secondary</strong> — Dd0 transformer output — Enable earth fault
              protection
            </li>
            <li>
              <strong>Industrial systems</strong> — Imported delta supplies — Create TN system from
              IT supply
            </li>
            <li>
              <strong>Resistance earthing</strong> — Medium voltage systems — Limit earth fault
        ...
        <ConceptBlock title="Building Services: Transformer Selection and Installation">
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Transformer Types for Buildings</p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Oil-filled (ONAN)</strong> — Natural oil/air — Fire chamber required —
              External substations
            </li>
            <li>
              <strong>Ester-filled</strong> — Natural oil/air — K-class fluid, reduced risk — Indoor
              with restrictions
            </li>
            <li>
              <strong>Cast resin (AN)</strong> — Air natural — F1 class - self-extinguishing —
              Indoor substations
            </li>
            <li>
              <strong>Cast resin (AF)</strong> — Forced air — F1 class - self-extinguishing — Higher
              loading in buildings
            </li>
            <li>
              <strong>VPI dry-type</strong> — Air natural — Good fire performance — Clean indoor
              environments
            </li>
          </ul>
          ...
          <p className="text-sm font-medium text-elec-yellow/80">Acoustic Considerations</p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Rating (kVA)</strong> — Maximum demand + growth allowance (typically 20%)
            </li>
            <li>
              <strong>Voltage ratio</strong> — 11kV/400V standard, check DNO requirements
            </li>
            <li>
              <strong>Vector group</strong> — Dyn11 for distribution with neutral
            </li>
            <li>
              <strong>Impedance</strong> — Typically 4-6% for distribution
            </li>
            <li>
              <strong>Cooling class</strong> — AN/AF for indoor, ONAN for outdoor
            </li>
            <li>
              <strong>Losses</strong> — Eco-design Tier 2 minimum (EU 2019/1783)
            </li>
            <li>
              <strong>Noise level</strong> — Specify maximum dB(A) for location
            </li>
            <li>
              <strong>Tap range</strong> — ±5% in 2.5% steps typical
            </li>
          </ul>

          <p>
            <strong>Design tip:</strong> For buildings with critical loads, consider two smaller
            transformers in parallel rather than one large unit - this provides N+1 redundancy with
            50% capacity maintained on single unit failure.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> Calculate the kVA rating of an auto-transformer to supply a
            100 kVA load at 380V from a 400V supply.
          </p>
          ...
          <p>Only 5% of load kVA required due to small voltage change</p>
          ...
          <p>
            <strong>Question:</strong> A 1000 kVA dry-type transformer has 1.5% no-load losses and
            5% full-load losses. Calculate ventilation requirements at 75% load.
          </p>
          ...
          <p>Natural ventilation area (rule of thumb: 0.35 m² per 100 kW):</p>
          <p>
        ...
        <ConceptBlock title="Practical Guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Vector groups:</strong> D = delta, Y = star, n = neutral, number = phase shift
              (×30°)
            </li>
            <li>
              <strong>UK distribution:</strong> Dyn11 standard (11kV delta, 400V star with neutral)
            </li>
            <li>
              <strong>Parallel operation:</strong> Same ratio, same vector group, similar impedance
            </li>
            <li>
              <strong>Auto-transformer:</strong> Size advantage = (1 - V₂/V₁) × load kVA
            </li>
            <li>
              <strong>Fire safety:</strong> Dry-type preferred indoors; oil requires fire chamber
            </li>
          </ul>
        ...
        <Scenario
          ...
          situation={
            <>
              A new operating theatre requires an IT (Isolated Terre) earthing system for Group 2
              medical locations under BS 7671 Section 710. The medical contractor proposes a 5 kVA
              single-phase transformer for the patient circuits with an insulation monitor (IMD) to
              BS EN 61557-8.
            </>
          }
          whatToDo={
            <>
              Specify an isolating transformer to BS EN 61558-2-15 (specifically for medical use):
              single-phase, 230 V/230 V, 5 kVA continuous, with a permanently-installed insulation
              monitoring device to BS EN 61557-8. The transformer must be a true two-winding type
              (not autotransformer), with primary and secondary fully galvanically separated, screen
              between primary and secondary earthed via a dedicated medical earth conductor. BS 7671
              710.512.1.1 mandates the IMD trip on any single insulation fault with audible / visual
              alarm at the operator panel.
            </>
          }
          whyItMatters={
            <>
              Group 2 medical (operating, intensive care, cardiac cath labs) cannot tolerate a
              circuit interruption mid-procedure. The IT system + isolating transformer ensures a
              single first fault does not cause disconnection; the IMD alerts staff to act before a
              second fault. Autotransformer use here would be a safety failure with potentially
              fatal consequence and a serious BS 7671 / HTM 06-01 breach.
            </>
          }
        />
