    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              ...
              Assessment-of-General-Characteristics stage (Part 3). It’s a 12-item checklist you
              walk down for every project — harmonic-rich loads (LED drivers, VFDs, IT equipment),
              DC feedback (PV, EV chargers), power factor, fluctuating loads (lifts, presses). The
              output drives RCD type, neutral sizing, SPD selection, transformer K-factor and cable
              derating.
            </>
          }
        ...
        <ConceptBlock title="Voltage Regulation">
          ...
          <p>
            <strong>
              BS EN 50160 voltage quality parameters (parameter / requirement / notes):
            </strong>
          </p>
        ...
        <ConceptBlock title="Transient Protection (SPDs)">
          ...
          <p>
            <strong>
              SPD types and applications (type / test current / location / application):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              Type 1 (T1) — 10/350µs (Iimp) — main DB/origin — direct lightning, LPS buildings
            </li>
            <li>
          ...
          <p>
            <strong>Coordination:</strong> T1 and T2 SPDs must be coordinated — typically 10m cable
            minimum between them, or use manufacturer-specified coordination components.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Earthing Arrangements">
          <p>
            ...
            impedance, protective device operation and electromagnetic compatibility. Understanding
            different systems enables correct design for each situation.
          </p>
          <p>
        ...
        <ConceptBlock title="EMC Considerations">
          <p>
            ...
            without causing or being affected by electromagnetic interference. Modern buildings with
            extensive electronic systems require careful EMC design.
          </p>
          <p>
            <strong>
              Sources of EMI in buildings (source / interference type / affected equipment):
            </strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
        ...
        <ConceptBlock title="Worked Examples">
          <p>
            <strong>Example 1 — SPD specification:</strong> Specify SPDs for an office building with
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>Neutral exceeds phase current!</strong> Specify 200% rated neutral or separate
              neutrals
            </li>
          </ul>
          <p>
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            ...
            <li>
              <strong>191V is below -15% limit (195.5V)</strong> — solution: increase cable size or
              reduce length
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          situation={
            <>
              FM team report a sub-main feeder to a Cat-A office floor is running 15 °C hotter than
              the design assumption, particularly the neutral conductor. Floor is 100 % LED lighting
              (DALI drivers), 80 IT desks, 6 large laser printers. Trip device hasn’t operated.
              Asked to advise.
            </>
          }
          whatToDo={
            <>
              Send out a 7-day power-quality logger (Class A meter per BS EN 50160). You expect to
              see THD V around 4–5 % and THD I 25–40 % with a strong third-harmonic signature from
              the LED drivers and IT switched-mode supplies. Neutral current likely 1.0× phase
              current or higher because the third harmonic is zero-sequence and sums in the neutral.
              Recommendation: re-rate the existing neutral via the Reg 524 / OSG derating tables for
              THD &gt; 33 %, OR pull a parallel neutral conductor, OR replace the sub-main with 200
              % neutral. Confirm RCD is Type A minimum (Type B if EV charging is on the same board).
              Add a Type 2 SPD at the floor DB (Reg 534.4.1.5). Document the Reg 331.1 assessment in
              the design narrative — this is exactly the case Reg 331.1 was written to catch at
              design stage.
            </>
          }
          whyItMatters={
            <>
              ...
              site is the moment you start specifying 200 % neutrals by default for any IT-heavy
              floor.
            </>
          }
        />
