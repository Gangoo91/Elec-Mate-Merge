  ...
  const quizQuestions = [
    {
      ...
      options: [
        ...
        'A permanent reduction in supply voltage',
        'Increased insulation resistance',
        'Faster RCD disconnection times',
      ],
      correctAnswer: 0,
      explanation:
        'Loose terminations create high contact resistance, leading to heat build-up, arcing and potential fire.',
    },
    {
      id: 2,
      ...
      correctAnswer: 1,
      explanation:
        'False — single-pole switches must break the line (live) conductor so the circuit is safe when switched off.',
    },
    {
      id: 3,
      question: 'What is reversed polarity?',
      options: [
        'When the line and neutral conductors are swapped',
        'When the earth conductor is left disconnected',
        'When two circuits share a single neutral conductor',
        'When a cable is run outside its permitted safe zone',
      ],
      correctAnswer: 0,
      explanation:
        'Reversed polarity occurs when the line and neutral conductors are connected the wrong way round, swapping their positions.',
    },
    {
      id: 4,
      question: 'Why must earth (protective) conductors be sleeved green/yellow?',
      options: [
        'To increase the current-carrying capacity of the conductor',
        'To comply with BS 7671 conductor identification requirements',
        'To improve the conductor\'s resistance to corrosion',
        'To make the conductor easier to pull through conduit',
      ],
      correctAnswer: 1,
      explanation:
        'Green/yellow sleeving identifies a conductor as a protective (earth) conductor, as required by BS 7671 identification rules.',
    },
    {
      id: 5,
      ...
      options: [
        ...
        'A multimeter or polarity tester',
        'A cable spirit level',
      ],
      correctAnswer: 2,
      explanation:
        'A multimeter or dedicated polarity tester confirms correct polarity after the initial visual inspection.',
    },
    {
      id: 6,
      question: 'What can over-tightening a terminal screw cause?',
      options: [
        'Lower contact resistance and a cooler joint',
        'Improved compliance with manufacturer torque settings',
        'A more secure connection that never works loose',
        'Damage to the conductor strands or terminal threads',
      ],
      correctAnswer: 3,
      explanation:
        'Over-tightening can crush conductor strands or strip the terminal threads, creating a poor, unreliable connection.',
    },
    {
      id: 7,
      question: 'Why is incorrect polarity especially dangerous in lighting circuits?',
      options: [
        'It increases the energy used by the lamp',
        'It makes lamps flicker at low brightness',
        'It causes the lamp to fail prematurely',
        'Because fittings can remain live even when switched off',
      ],
      correctAnswer: 3,
      explanation:
        'With reversed polarity the switch breaks the neutral instead of the line, leaving the fitting live even when switched off.',
    },
    {
      id: 8,
      ...
      correctAnswer: 1,
      explanation:
        'BS 7671 (the IET Wiring Regulations) sets the requirements for polarity and terminations in electrical installations.',
    },
    {
      id: 9,
      question: 'What is one sign of poor terminations during inspection?',
      options: [
        'A higher than expected insulation resistance',
        'Discolouration or melting at the terminals',
        'Conductors that are easy to disconnect',
        'A reduced earth fault loop impedance',
      ],
      correctAnswer: 1,
      explanation:
        'Discolouration or melting at terminals indicates overheating caused by a high-resistance, poor connection.',
    },
    {
      id: 10,
      question: 'Can multiple conductors be placed in one terminal?',
      options: [
        'No, never — only one conductor is ever permitted per terminal',
        'Yes, in any terminal provided the screw is fully tightened',
        'Yes, only where the terminal is designed and rated to accept them',
        'Yes, but only if the conductors are different sizes',
      ],
      correctAnswer: 2,
      explanation:
        'Multiple conductors may only be placed in a terminal that is specifically designed and rated for more than one connection.',
    },
  ];
