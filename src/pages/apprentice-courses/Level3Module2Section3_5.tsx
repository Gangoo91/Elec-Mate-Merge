...
const DESCRIPTION =
  'Understanding battery maintenance requirements, performance monitoring, degradation factors, and end-of-life disposal for energy storage systems.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "End-of-life is typically defined as when usable capacity falls to 70-80% of original rated capacity. The battery doesn't stop working at this point but may no longer meet the application's requirements. For home storage, a battery at 80% capacity is still useful; for EVs, reduced range may be unacceptable.",
  },
  {
    id: 'check-3',
    ...
    correctIndex: 2,
    explanation:
      "Most manufacturers recommend annual visual inspection and system health checks. Electrical installations require periodic inspection at intervals specified on the EIC (typically 5 years for domestic). Regular monitoring via the system's app or display helps identify issues between formal inspections.",
  },
  {
    id: 'check-4',
    ...
    correctIndex: 1,
    explanation:
      "Lithium batteries contain valuable materials and should be recycled through specialist facilities. Many manufacturers and retailers offer take-back schemes. Some end-of-life EV batteries are repurposed for less demanding stationary storage applications ('second life'). Disposal in normal waste is illegal and environmentally harmful.",
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Temperature has the most significant impact on battery degradation. High temperatures accelerate chemical reactions that cause capacity loss. A battery consistently operated at 35°C may degrade twice as fast as one kept at 25°C. This is why installation location and ventilation are so important.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Cycle ageing refers to degradation caused by repeated charge/discharge cycles. Each cycle causes small amounts of irreversible change to the electrodes and electrolyte. Deep cycles (high DoD) cause more wear than shallow cycles. Cycle life ratings indicate expected cycles to 70-80% capacity.',
  },
  {
    id: 3,
    question:
      'Why is it beneficial to avoid storing lithium batteries at 100% state of charge for extended periods?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "Storing lithium batteries at high state of charge (especially 100%) accelerates calendar ageing. For long-term storage, 40-60% SoC is ideal. Many battery systems have a 'storage mode' setting. For daily use, full charges are fine - this guidance applies to extended idle periods.",
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Annual inspection should include: visual check for damage, swelling, or corrosion; verification that connections are secure; checking ventilation is unobstructed; reviewing BMS data for cell balance and State of Health; and examining operating logs for fault history or unusual patterns.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Significant cell voltage imbalance may indicate a weak or failing cell, BMS balancing malfunction, or connection issues. Small variations (20-50mV) are normal, but larger differences warrant investigation. Continuing to operate with significant imbalance can damage healthy cells and reduce total capacity.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      "Capacity fade is the permanent, irreversible reduction in a battery's maximum energy storage capability over time. It's caused by chemical and physical changes to electrodes and electrolyte. A new 10kWh battery may only store 8kWh after several years of use. This is tracked as State of Health (SoH).",
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Most modern battery systems include monitoring through smartphone apps, web portals, or inverter displays. Users can track State of Charge, daily energy throughput, self-consumption rates, and often State of Health. This data helps identify performance changes and potential issues early.',
  },
  {
    id: 8,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Lithium batteries contain valuable materials (lithium, cobalt, nickel) that can be recycled. Improper disposal poses fire risks (damaged batteries in waste) and environmental hazards (chemical leakage). UK regulations require proper disposal through licensed facilities. Many manufacturers offer take-back programs.',
  },
  {
    id: 10,
    question:
      'What maintenance task should NEVER be attempted by untrained personnel on battery systems?',
    options: [
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Lifespan:</strong> 10-15 years typical, 3,000-6,000 cycles for quality LFP
              </li>
              <li>
                <strong>Degradation:</strong> Temperature and cycling patterns are key factors
              </li>
              <li>
                <strong>Inspection:</strong> Annual visual + electrical, ongoing monitoring via app
              </li>
              <li>
                <strong>End of life:</strong> Recycle through specialist facilities, never normal
                waste
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> State of Health (SoH) reading in monitoring system
              </li>
              <li>
                <strong>Use:</strong> Cell voltage balance data to identify issues
              </li>
              <li>
                <strong>Apply:</strong> Manufacturer take-back schemes for disposal
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              All batteries degrade over time - this is an unavoidable chemical and physical
              process. Understanding the mechanisms helps predict lifespan and take steps to
              minimise degradation. Two main processes drive capacity loss: calendar ageing and
              cycle ageing.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Calendar ageing:</strong> Time-based degradation regardless of use. Higher
                  storage temperature and high state of charge accelerate this.
                </li>
                <li>
                  <strong>Cycle ageing:</strong> Wear from charging/discharging. Deep cycles and
                  high currents cause more wear than shallow cycles.
                </li>
                <li>
                  <strong>SEI layer growth:</strong> A film forms on the anode that consumes lithium
                  and increases resistance over time.
                </li>
                <li>
                  <strong>Mechanical stress:</strong> Electrode materials expand/contract during
                  cycling, causing micro-fractures over thousands of cycles.
                </li>
              </ul>
            </div>

            <p>
              Quality LFP batteries typically retain 80% capacity after 4,000-6,000 cycles or 10+
              years. NMC batteries may reach this point faster (2,000-4,000 cycles) but offer higher
              initial energy density. Operating temperature has the largest controllable impact on
              degradation rate.
            </p>

            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> A battery reaching 80% capacity isn't dead - it simply
              stores less energy. Many continue useful service well beyond this point, particularly
              in applications tolerant of reduced capacity.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Modern lithium battery systems require minimal routine maintenance compared to older
              technologies like lead-acid. However, regular inspection and monitoring remain
              important to ensure safe, optimal operation and to identify developing issues before
              they become serious.
            </p>
            ...
            <p>
              The Electrical Installation Certificate specifies periodic inspection intervals. For
              domestic installations, this is typically every 5 years, but more frequent inspection
              may be appropriate for battery systems given their importance and complexity.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Modern battery systems provide extensive monitoring data through apps, web portals,
              and inverter displays. Understanding what to look for helps identify issues early and
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>State of Health (SoH):</strong> Current capacity as percentage of
                  original. Should decrease slowly (1-2% per year typical).
                </li>
                <li>
                  <strong>Cell voltage balance:</strong> Difference between highest and lowest cell.
                  Large variations indicate problems.
                </li>
                <li>
                  <strong>Temperature:</strong> Operating temperature during charge/discharge.
                  Consistently high temperatures accelerate ageing.
                </li>
                <li>
                  <strong>Cycle count / throughput:</strong> Total cycles or energy throughput helps
                  track usage against warranty terms.
                </li>
                <li>
                  <strong>Fault history:</strong> Log of past alerts and warnings. Recurring faults
                  need investigation.
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              When batteries reach end of useful life for their original application, proper
              handling is essential. Lithium batteries cannot be disposed of in normal waste due to
              fire risks and environmental regulations. Recycling recovers valuable materials and is
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                ...
                <li>
                  Damaged or swollen batteries require specialist handling - do not transport in
                  normal vehicles
                </li>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> UK WEEE (Waste Electrical and Electronic Equipment)
              regulations require proper disposal of batteries. Distributors and retailers have
              obligations to accept old batteries when selling new ones.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Ignoring degradation warnings</strong> - sudden SoH drops indicate
                  problems
                </li>
                <li>
                  <strong>Skipping annual inspections</strong> - issues can develop unnoticed
                </li>
                <li>
                  <strong>Improper disposal</strong> - illegal and hazardous; use proper channels
                </li>
                <li>
                  <strong>Opening battery enclosures</strong> - dangerous high voltages inside;
