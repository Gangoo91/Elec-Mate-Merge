    ...
    <div className="bg-background">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          Understand the legal framework governing health, safety and welfare in the building
          services engineering industry
        </p>
        <p className="text-base text-muted-foreground mb-12">
          This section covers the essential UK legislation that building services engineers must
          understand and comply with - from the overarching Health and Safety at Work Act to
          specific regulations governing electrical work, construction projects, hazardous
          substances, and work equipment.
        </p>
