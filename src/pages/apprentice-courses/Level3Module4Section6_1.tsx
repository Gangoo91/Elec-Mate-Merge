...
const seoDescription =
  'Master professional communication skills for explaining electrical faults and remedial work to clients, including technical translation, managing expectations, and building trust through clear explanations.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'Avoid all technical terms and oversimplify',
      'Use analogies and plain language while being accurate',
      "Refuse to explain as they won't understand",
    ],
    correctAnswer: 2,
    explanation:
      'Professional communication involves translating technical information into plain language the customer can understand, using analogies where helpful, while maintaining accuracy and not patronising the customer.',
  },
  {
    question: 'What should you do if a customer disagrees with your fault diagnosis?',
    options: [
      'Insist you are correct and refuse to explain further',
      'Listen to their concerns and explain your reasoning with evidence',
      'Agree with them to avoid conflict',
      'Walk away from the job',
    ],
    correctAnswer: 1,
    explanation:
      "Professional handling of disagreements involves actively listening to the customer's concerns, calmly explaining your reasoning supported by evidence such as test results, and working together to find a resolution.",
  },
  {
    question: 'Before starting remedial work, what should be confirmed with the customer?',
    options: [
      'Nothing - just proceed with repairs',
      'Scope of work, costs, and timescales',
      'Only the final price',
      'Just the start date',
    ],
    correctAnswer: 1,
    explanation:
      'Before commencing work, you should confirm the agreed scope of work, provide a clear breakdown of costs, establish realistic timescales, and ensure the customer understands and approves what will be done.',
  },
  {
    question:
      'How should you handle a situation where you discover additional faults during repair?',
    options: [
      'Fix everything and add it to the bill without consultation',
      'Stop work completely and leave',
      'Inform the customer immediately and discuss options',
      'Ignore additional faults if not part of original job',
    ],
    correctAnswer: 2,
    explanation:
      'Professional practice requires immediately informing the customer of any additional faults discovered, explaining the implications, providing options and costs, and obtaining approval before proceeding with extra work.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      ...
      'To minimise time spent talking',
      'To build trust and ensure understanding',
      'To avoid any commitment',
    ],
    correctAnswer: 2,
    explanation:
      'The primary goal is building trust and ensuring the customer understands the situation. Clear, honest communication creates confidence in your work and helps customers make informed decisions.',
  },
  {
    question: 'When should you first contact the customer about a fault diagnosis job?',
    options: [
      'Only when the work is complete',
      'Before arriving to confirm access and discuss initial expectations',
      'Never - they contacted you',
      "Only if there's a problem",
    ],
    correctAnswer: 1,
    explanation:
      'Initial contact before arriving allows you to confirm access arrangements, discuss their description of the problem, set expectations for the diagnostic process, and establish a professional relationship from the start.',
  },
  {
    question: 'How should you explain the cost difference between a quick fix and a proper repair?',
    options: [
      "Don't mention it - just do the proper repair",
      "Use technical regulations they won't understand",
      'Explain the long-term implications of each option clearly',
      'Tell them the quick fix is dangerous without explanation',
    ],
    correctAnswer: 2,
    explanation:
      'Professional communication involves clearly explaining both options, including the long-term implications, costs, and risks of each approach, allowing the customer to make an informed decision.',
  },
  {
    question: 'What should be included in a written quotation for remedial work?',
    options: [
      'Just the total price',
      'Detailed breakdown of work, materials, labour, and timescales',
      'Technical specifications only',
      'Verbal agreement is sufficient',
    ],
    correctAnswer: 1,
    explanation:
      'A professional quotation should include a detailed breakdown of the work to be done, itemised materials, labour costs, VAT if applicable, expected timescales, and any terms and conditions.',
  },
  {
    question:
      'How should you respond to a customer who questions why the repair is taking longer than expected?',
    options: [
      'Ignore their concerns and continue working',
      'Apologise, explain the reasons, and provide updated timescales',
      'Blame previous electricians for poor work',
      "Tell them you'll finish when you finish",
    ],
    correctAnswer: 1,
    explanation:
      'Professional response involves acknowledging their concern, apologising for any inconvenience, explaining honestly why additional time is needed, and providing realistic updated completion estimates.',
  },
  {
    question:
      'What documentation should you provide to the customer after completing remedial work?',
    options: [
      'Nothing unless they ask',
      'Appropriate certification and clear handover information',
      'Technical test sheets only',
      'Just a receipt',
    ],
    correctAnswer: 1,
    explanation:
      'After completing work, provide appropriate certification (EIC, MWC, or EICR as applicable), explain what was done, provide any relevant operating instructions, and leave clear handover information.',
  },
  {
    question:
      "When a customer asks you to do work that wouldn't comply with regulations, what should you do?",
    options: [
      'Do what they ask - customer is always right',
      'Refuse and leave without explanation',
      "Explain why it's not possible and offer compliant alternatives",
      "Do it but don't certify the work",
    ],
    correctAnswer: 2,
    explanation:
      "Professional practice requires explaining why the requested work cannot be done (referencing regulations as needed), then offering compliant alternatives that meet the customer's underlying needs where possible.",
  },
  {
    question:
      "How should sensitive information about an installation's condition be communicated to a tenant?",
    options: [
      "Tell them everything regardless of who's responsible",
      'Refuse to discuss anything with them',
      'Explain the situation appropriately and direct them to the landlord',
      'Only give written reports to property owners',
    ],
    correctAnswer: 2,
    explanation:
      'When dealing with tenants, explain the situation appropriately for safety purposes, but direct detailed discussions about remedial work requirements and costs to the landlord or property owner who is responsible for the installation.',
  },
  {
    question:
      'What is the best approach when a customer seems frustrated about the fault or repair cost?',
    options: [
      'Match their frustration level',
      'Remain calm, empathetic, and focus on solutions',
      'Immediately offer a discount',
      'End the conversation quickly',
    ],
    correctAnswer: 1,
    explanation:
      'Professional communication with frustrated customers involves remaining calm, showing empathy for their situation, actively listening to their concerns, and focusing on practical solutions rather than becoming defensive.',
  },
  {
    question: 'How should you handle questions about work done by other electricians?',
    options: [
      "Criticise their work openly to gain the customer's trust",
      'Remain professional and focus on the current situation',
      'Refuse to comment on anything',
      'Always defend other electricians regardless of quality',
    ],
    correctAnswer: 1,
    explanation:
      "Professional conduct requires remaining diplomatic about other electricians' work. Focus on the current situation, what needs to be done now, and avoid unnecessary criticism while being honest about any genuine concerns.",
  },
  {
    question: 'What should you do if you cannot complete a job on the agreed date?',
    options: [
      'Just turn up when you can',
      'Contact the customer as early as possible to rearrange',
      'Send someone else without telling them',
      'Finish other jobs and fit them in when possible',
    ],
    correctAnswer: 1,
    explanation:
      'Professional practice requires contacting the customer as soon as you know there will be a delay, apologising for the inconvenience, explaining the reason if appropriate, and arranging a new mutually convenient date.',
  },
  {
    question:
      'When providing verbal explanations of fault diagnosis findings, what should you avoid?',
    options: [
      'Using analogies to explain concepts',
      'Jargon and acronyms without explanation',
      'Showing test equipment readings',
      'Demonstrating the fault if safe to do so',
    ],
    correctAnswer: 1,
    explanation:
      'Avoid using unexplained jargon, technical acronyms, or assuming knowledge. While showing readings and demonstrations can help, unexplained technical language creates confusion and undermines trust.',
  },
];
...
const faqs = [
  ...
  {
    question:
      'How should I handle a customer who is angry about finding faults in a new installation?',
    answer:
  ...
  return (
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          ...
          <div className="prose prose-invert max-w-none">
              ...
              <table className="w-full text-sm text-white/80 border border-white/20">
                <thead>
                  <tr className="bg-white/10">
                    ...
                    <th className="border border-white/20 p-2 text-left">
                      Customer-Friendly Analogy
                    </th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    ...
                    <td className="border border-white/20 p-2">
                      "Like the rubber coating on a hosepipe cracking and letting water leak out"
                    </td>
                  </tr>
                  <tr className="bg-white/5">
                    <td className="border border-white/20 p-2">Earth fault</td>
                    <td className="border border-white/20 p-2">
                      "Electricity is finding an unintended path to ground, like water draining
                      where it shouldn't"
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="border border-white/20 p-2">
                      "Like a garden hose not quite screwed onto the tap - it works but wastes
                      energy and could cause problems"
                    </td>
                  </tr>
                  <tr className="bg-white/5">
                    <td className="border border-white/20 p-2">Overloaded circuit</td>
                    <td className="border border-white/20 p-2">
                      "Imagine too many cars on a single-lane road - it creates problems and
                      bottlenecks"
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="border border-white/20 p-2">
                      "This safety device senses electricity going where it shouldn't and cuts power
                      instantly to protect you"
                    </td>
                  </tr>
                  <tr className="bg-white/5">
                    <td className="border border-white/20 p-2">Circuit breaker tripping</td>
                    <td className="border border-white/20 p-2">
                      "The circuit is demanding more power than it's designed for, so the breaker
                      shuts it off for safety"
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 rounded-lg p-4 border border-red-500/20 mb-4">
              ...
              <ul className="list-disc pl-5 text-white/80 text-sm space-y-2">
                ...
                <li>
                  <strong>Requires urgent attention:</strong> "This isn't immediately dangerous but
                  could become so - I recommend addressing it within the next few days"
                </li>
                <li>
                  <strong>Improvement recommended:</strong> "This doesn't meet current standards but
                  isn't dangerous - worth addressing when you do other work"
                </li>
                <li>
                  <strong>For information:</strong> "This is something to be aware of but doesn't
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-gradient-to-r from-yellow-400/10 to-amber-500/10 rounded-lg p-4 border border-yellow-400/20 mb-4">
              ...
              <ol className="list-decimal pl-5 text-white/80 text-sm space-y-2">
                ...
                <li>
                  <strong>Explain the finding:</strong> Describe what you've found and its
                  significance
                </li>
                <li>
                  <strong>Assess urgency:</strong> Clarify whether it needs immediate attention or
                  can wait
                </li>
                <li>
                  <strong>Provide options:</strong> Give clear choices with costs for each
                </li>
                <li>
                  <strong>Document the decision:</strong> Record what was found and the customer's
                  choice
                </li>
                <li>
                  <strong>Proceed as agreed:</strong> Only do additional work with clear approval
                </li>
              </ol>
            </div>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-white/5 rounded-lg p-4 mb-4">
              <ul className="list-disc pl-5 text-white/70 text-sm space-y-2">
                ...
                <li>
                  <strong>Listen actively:</strong> Let them express their concerns without
                  interruption
                </li>
                <li>
                  <strong>Acknowledge feelings:</strong> "I understand this is frustrating for you"
                </li>
                <li>
                  <strong>Focus on solutions:</strong> Move the conversation toward resolving the
                  issue
                </li>
                <li>
                  <strong>Avoid blame:</strong> Don't criticise others or become defensive
                </li>
                <li>
                  <strong>Document concerns:</strong> Keep records of complaints and your responses
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/5 rounded-lg p-4 mb-4">
              <ul className="list-disc pl-5 text-white/70 text-sm space-y-2">
                ...
                <li>
                  <strong>Be specific:</strong> Explain exactly what the problem is
                </li>
                <li>
                  <strong>Explain the implications:</strong> What does this mean for them?
                </li>
                <li>
                  <strong>Offer solutions:</strong> What can be done to address the situation?
                </li>
                <li>
                  <strong>Allow time:</strong> Let them process the information and ask questions
                </li>
                <li>
                  <strong>Follow up in writing:</strong> Confirm key points in a clear written
                  summary
                </li>
              </ul>
            </div>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-white/5 rounded-lg p-4 mb-4">
              <ul className="list-disc pl-5 text-white/70 text-sm space-y-2">
                ...
                <li>
                  <strong>Minor Works Certificate:</strong> For small additions or alterations
                </li>
                <li>
                  <strong>Electrical Installation Condition Report:</strong> For inspection of
                  existing installations
                </li>
                <li>
                  Explain the certificate to the customer: what it covers and its significance
                </li>
        ...
        {/* Quiz Section */}
        <section className="mb-8 sm:mb-12">
          <Quiz title="Section 6.1 Knowledge Check" questions={quizQuestions} passingScore={75} />
        </section>
