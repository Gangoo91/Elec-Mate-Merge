...
const TITLE =
  'Updating As-Built Drawings (Basic Awareness) - Module 5.7.4 | Level 2 Electrical Course';
const DESCRIPTION =
  'Learn about as-built drawings and their importance in electrical installations. Understand when and why drawings must be updated for compliance and safety.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'As-built drawings are the final, updated versions of design drawings that show the installation exactly as it exists on site, including any changes made during construction.',
  },
  {
    id: 2,
    ...
    correctIndex: 1,
    explanation:
      'Updates should be made as work progresses, not left until the end. This ensures accuracy and prevents important changes from being forgotten.',
  },
  {
    id: 3,
    ...
    correctIndex: 1,
    explanation:
      'As-built drawings provide accurate information about the actual installation, which is essential for future modifications, extensions, and maintenance work.',
  },
];
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'As-built drawings are the final, updated versions of design drawings that show the installation exactly as it exists on site.',
    },
    {
      id: 2,
      ...
      correctAnswer: 1,
      explanation:
        'As-built drawings must be updated to ensure compliance, safety, and provide accurate records for future maintenance and modifications.',
    },
    {
      id: 3,
      ...
      correctAnswer: 2,
      explanation:
        'Locations of distribution boards, cable routes, altered circuits, and accessory positions must all be accurately recorded.',
    },
    {
      id: 4,
      question: 'When should updates to drawings be made?',
      ...
      correctAnswer: 1,
      explanation:
        'Updates should be made as work progresses to ensure accuracy and prevent important changes from being forgotten.',
    },
    {
      id: 5,
      ...
      correctAnswer: 1,
      explanation:
        'Failing to update drawings can lead to wrong isolations, creating serious safety hazards for maintenance teams.',
    },
    {
      id: 6,
      ...
      correctAnswer: 1,
      explanation:
        'Marked-up as-built updates should be submitted to the site engineer or document controller regularly.',
    },
    {
      id: 7,
      ...
      correctAnswer: 1,
      explanation:
        'As-built drawings are important regardless of project size as they ensure safety and compliance.',
    },
    {
      id: 8,
      question: 'What colour is typically used for marking changes on paper drawings?',
      options: ['Blue pen', 'Black pen', 'Red pen', 'Green pen'],
      correctAnswer: 2,
      explanation:
        'Red pen is typically used for marking changes on paper drawings to make alterations clearly visible.',
    },
    {
      id: 9,
      ...
      correctAnswer: 1,
      explanation:
        'The maintenance team isolated the wrong breaker and accidentally cut power to critical hospital equipment due to out-of-date drawings.',
    },
    {
      id: 10,
      question: 'Why are as-built drawings valuable for future work?',
      ...
      correctAnswer: 1,
      explanation:
        'As-built drawings provide accurate information about the actual installation, essential for future modifications, extensions, and maintenance.',
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        'Yes - even minor changes like relocated outlets or altered cable routes should be recorded. What seems minor during installation can become significant during future maintenance or modifications.',
    },
    {
      question: 'What happens if I forget to mark up a change?',
      answer:
        'Try to record it as soon as you remember. Take photos if needed to verify the actual installation. Late updates are better than no updates, but accuracy may be compromised.',
    },
    {
      question: 'Who is responsible for updating as-built drawings?',
      answer:
        'Everyone on the installation team has a role. Electricians mark up changes during work, and the site engineer or document controller compiles the final as-built drawings.',
    },
    {
      question: 'Can I use digital mark-ups instead of red pen?',
      answer:
        'Yes - many projects now use digital mark-up tools. The important thing is that changes are clearly highlighted and submitted regularly to the document controller.',
    },
    {
      question: 'How detailed should as-built updates be?',
      answer:
        'Include all changes from the original design: cable routes, equipment positions, circuit numbers, and any additions or deletions. If it affects how someone would work on the installation, it should be recorded.',
    },
  ];
        ...
        <div className="max-w-3xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-white/90">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  ...
                  <li>
                    They show the installation exactly as completed on site, including changes.
                  </li>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-5 space-y-1 text-sm">
                  <li>
                    <strong>Spot:</strong> Changes from original design, rerouted cables, altered
                    positions.
                  </li>
                  <li>
                    <strong>Use:</strong> Red pen mark-ups, digital annotations, regular updates.
                  </li>
                  <li>
                    <strong>Check:</strong> Accuracy against actual installation, completeness of
                    updates.
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 text-white/90">
              ...
              <li>
                Recognise when and why drawings must be updated during and after construction work.
              </li>
              <li>
                Understand the consequences of failing to update as-built documentation accurately.
              </li>
              <li>
                Apply good practices in providing information for updating drawings during
                installation work.
              </li>
            </ul>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-4">
              ...
              <ul className="text-sm text-white/80 ml-4 mb-3 list-disc space-y-1">
                ...
                <li>
                  Include changes made during construction due to site conditions or client requests
                </li>
