...
const DESCRIPTION =
  'Safety considerations for battery storage installations including fire risks, ventilation requirements, location selection, and electrical installation standards.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Thermal runaway is a dangerous chain reaction where heat causes chemical reactions that generate more heat, potentially leading to fire or explosion. It can be triggered by overcharging, physical damage, internal short circuits, or external heat sources. Proper BMS protection and installation practices prevent this.',
  },
  {
    id: 'check-2',
    question: 'What minimum IP rating is typically required for indoor battery installations?',
    options: ['IP20', 'IP44', 'IP65', 'No IP rating required indoors'],
    correctIndex: 0,
    explanation:
      'IP20 is typically the minimum for indoor installations, protecting against objects larger than 12mm. Higher ratings (IP44+) are needed for locations with moisture risk. Outdoor or garage installations often require IP54 or IP65. Always check manufacturer specifications for the specific installation environment.',
  },
  {
    id: 'check-3',
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "Manufacturer specifications vary but typically require 200-500mm clearance at the front for access and on sides for ventilation and heat dissipation. Always follow the specific manufacturer's installation manual. Inadequate clearance can void warranties and create safety hazards.",
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Battery systems should not be installed on escape routes or near main exits as a fire could block evacuation. Fire services recommend locations that do not impede escape and allow emergency access. Living spaces, bedrooms, and areas under stairs are also typically unsuitable.',
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'ABC dry powder or specialist lithium battery extinguishers are recommended. Water can be used in large quantities to cool cells but presents electrical and chemical hazards. CO2 may not be effective. For significant fires, evacuation and fire service attendance is the appropriate response.',
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      'Most domestic LFP battery systems are sealed and generate minimal heat under normal operation. Natural ventilation (avoiding enclosed, unventilated spaces) is typically adequate. Manufacturer guidelines must be followed. Some larger or NMC-based systems may have specific mechanical ventilation requirements.',
  },
  {
    id: 5,
    question:
      "What is the purpose of the 'caution: battery storage' label required at the main distribution board?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Warning labels at the consumer unit alert firefighters and electricians that the installation includes battery storage, which remains energised even when the mains is isolated. This is critical safety information that affects emergency response procedures and safe isolation for maintenance.',
  },
  {
    id: 6,
    question:
      'According to BS 7671, what earth fault protection considerations apply to battery systems?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'BS 7671 requires appropriate earth fault protection. Battery system requirements vary - some inverters have built-in protection, others require external devices. RCDs may not be suitable for all DC circuits. Follow manufacturer guidance and applicable BS 7671 requirements for the specific installation.',
  },
  {
    id: 7,
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Most manufacturers recommend annual visual inspection and system health check. The Electrical Installation Certificate requires periodic inspection at intervals not exceeding those specified (typically 5 years for domestic, less for commercial). BMS data should be reviewed regularly to identify any developing issues.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Thermal runaway:</strong> Main lithium battery hazard - prevented by BMS and
                proper installation
              </li>
              <li>
                <strong>Location:</strong> Not on escape routes, adequate ventilation, structural
                support
              </li>
              <li>
                <strong>Labelling:</strong> Required at battery, isolator, and consumer unit
              </li>
              <li>
                <strong>Documentation:</strong> EIC, user manual, emergency procedures mandatory
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Warning labels, isolation points, ventilation provision
              </li>
              <li>
                <strong>Use:</strong> Manufacturer installation guide for location requirements
              </li>
              <li>
                <strong>Apply:</strong> Fire service guidance for emergency access planning
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              While modern lithium batteries are inherently safe when properly designed and
              installed, understanding potential hazards is essential for risk management. The
              primary concern is thermal runaway - a self-accelerating chemical reaction that can
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Overcharging:</strong> Charging beyond safe voltage limits (BMS prevents
                  this)
                </li>
                <li>
                  <strong>Over-discharging:</strong> Depleting below minimum voltage (BMS prevents
                  this)
                </li>
                <li>
                  <strong>Physical damage:</strong> Crushing, puncturing, or impact causing internal
                  shorts
                </li>
                <li>
                  <strong>External heat:</strong> Fire or extreme ambient temperatures
                </li>
                <li>
                  <strong>Manufacturing defects:</strong> Internal contamination or damage (rare in
                  quality products)
                </li>
              </ul>
            </div>
            ...
            <p>
              LFP batteries have significantly better thermal stability than NMC or other lithium
              chemistries. The phosphate cathode structure remains stable at higher temperatures,
              making thermal runaway much less likely even under abuse conditions. This is a key
              reason LFP dominates domestic storage applications.
            </p>

            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> The BMS provides primary protection against electrical
              causes of thermal runaway. Proper installation and location selection protect against
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Selecting an appropriate installation location is critical for safety. The location
              affects fire risk, emergency access, maintenance feasibility, and system performance.
              Fire service guidance and manufacturer requirements must both be satisfied.
            </p>
            ...
            <p>
              Consider the weight of the system - floor-standing batteries can exceed 100kg.
              Wall-mounted units require secure fixing into masonry or structural elements.
              Vibration, temperature extremes, and moisture exposure affect both safety and
              lifespan.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Battery storage installations must comply with BS 7671, manufacturer requirements, and
              relevant building regulations. Key considerations include circuit protection,
              isolation provisions, cable sizing, and environmental protection.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Dedicated circuit:</strong> From consumer unit with appropriate
                  overcurrent protection
                </li>
                <li>
                  <strong>Isolation:</strong> Accessible means to isolate battery system (AC and DC
                  where applicable)
                </li>
                <li>
                  <strong>Cable sizing:</strong> Appropriate for maximum currents and installation
                  method
                </li>
                <li>
                  <strong>Earth fault protection:</strong> As required by manufacturer and BS 7671
                </li>
                <li>
                  <strong>Surge protection:</strong> SPD protection where required by risk
                  assessment
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-white italic">
              <strong>Example:</strong> A typical 5kW hybrid inverter installation requires a
              dedicated 32A circuit from the consumer unit, with appropriately rated isolator
              adjacent to the unit, correctly sized DC cabling from battery to inverter, and
              communication cabling for BMS-inverter connection.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Proper labelling ensures that emergency services, future electricians, and building
              occupants are aware of the battery installation and can respond appropriately.
              Documentation provides essential information for safe operation and maintenance.
            </p>
            ...
            <div className="grid grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent">
                ...
                <p className="text-white text-xs">
                  Warning label, isolation instructions, emergency contact
                </p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">At Consumer Unit</p>
                <p className="text-white text-xs">
                  "Caution: Battery Storage System" with location indicated
                </p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">At Meter Position</p>
                <p className="text-white text-xs">
                  DNO warning label for generation/storage systems
                </p>
              </div>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Required documentation for handover:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Emergency services use warning labels to assess risks
              before entering properties. Clear, durable labels in standardised locations are a
              legal requirement and could save lives.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Installing on escape routes</strong> - creates evacuation hazard in
                  emergency
                </li>
                <li>
                  <strong>Insufficient ventilation</strong> - causes overheating and reduced
                  lifespan
                </li>
                <li>
                  <strong>Missing labels</strong> - endangers emergency responders and future
                  workers
                </li>
                <li>
                  <strong>Inadequate fixing</strong> - heavy batteries can fall causing damage and
                  injury
                </li>
              </ul>
            </div>
