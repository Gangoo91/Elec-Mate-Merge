        ...
        <div className="max-w-3xl mx-auto">
          ...
          <section className="mb-10">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm text-white/90">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>
                    <strong>Spot:</strong> Safe zone boundaries, hazards (pipes, heat), fixing
                    positions.
                  </li>
                  <li>
                    <strong>Use:</strong> Chalk lines for marking, cable detectors, appropriate
                    fixings.
                  </li>
                  <li>
                    <strong>Check:</strong> Spacing, wall type, hidden services, BS 7671 compliance.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm text-white/90">
              ...
              <li>
                Determine appropriate fixing points for different cable types and containment.
              </li>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-lg p-4 border-l-2 border-red-500/50 bg-red-500/5">
                <div className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-7 h-7 bg-red-500 text-white rounded-full flex items-center justify-center text-sm font-bold">
                    !
                  </span>
                  <div className="flex-1">
              ...
              <div className="p-4 bg-white/5 rounded border border-white/10">
                ...
                <div className="grid md:grid-cols-3 gap-4 text-xs text-white/80">
                  ...
                  <div>
                    ...
                    <p>
                      Spring toggles, cavity anchors, or plasterboard fixings for hollow sections.
                    </p>
                  </div>
                  <div>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-4">
              <div className="rounded-lg p-4 bg-white/5 border border-white/10">
                ...
                <div className="text-xs text-white/70 space-y-1">
                  ...
                  <p>
                    <strong>Risk:</strong> Insulation degradation, reduced current capacity
                  </p>
                  <p>
                    <strong>Minimum distance:</strong> 50mm from heat sources where possible
                  </p>
                </div>
              </div>
              <div className="rounded-lg p-4 bg-white/5 border border-white/10">
                ...
                <div className="text-xs text-white/70 space-y-1">
                  ...
                  <p>
                    <strong>Solution:</strong> Use appropriate IP-rated cables and containment
                  </p>
                  <p>
                    <strong>Examples:</strong> LSF cables, galvanised steel containment
                  </p>
                </div>
              </div>
              <div className="rounded-lg p-4 bg-elec-yellow/10 border border-elec-yellow/30">
                ...
                <div className="text-xs text-white/70 space-y-1">
                  ...
                  <p>
                    <strong>Reason:</strong> Avoid interference and accidental damage
                  </p>
                  <p>
                    <strong>Best practice:</strong> Cross at 90° where routes must intersect
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="rounded-lg p-4 border-l-2 border-red-500/50 bg-red-500/5">
                ...
                <div className="text-sm text-white/80 space-y-1">
                  ...
                  <p>
                    • <strong>Moving parts:</strong> Door hinges, sliding mechanisms, lifting
                    equipment
                  </p>
                  <p>
                    • <strong>Impact zones:</strong> High-traffic areas, loading bays, machinery
                    locations
                  </p>
                  <p>
                    • <strong>Protection:</strong> Use armoured cables, protective conduit, or
                    physical barriers
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-lg p-4 border-l-2 border-elec-yellow/50 bg-elec-yellow/5">
                ...
                <div className="text-sm text-white/80 space-y-1">
                  ...
                  <p>
                    • <strong>UV exposure:</strong> Use UV-resistant cables for outdoor
                    installations
                  </p>
                  <p>
                    • <strong>Rodent damage:</strong> Consider armoured cables in vulnerable areas
                  </p>
                  <p>
                    • <strong>Chemical exposure:</strong> Industrial environments, swimming pools
                  </p>
                </div>
              </div>
            </div>
