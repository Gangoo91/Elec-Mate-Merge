...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['230V DC', '400V DC', 'About 565V DC', 'About 325V DC'],
    correctAnswer: 2,
    explanation:
...
const HNCModule8Section4_3 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 4 · Subsection 3"
      ...
      <HubBody>
        ...
        <ConceptBlock title="VSD Principles and Construction">
          ...
          <p>
            <strong>Three main sections of a VSD:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Rectifier:</strong> Converts incoming AC to DC using diode or thyristor bridge
            </li>
            <li>
            ...
            <li>
              <strong>Inverter:</strong> Converts DC to variable frequency AC using IGBT switches
              with PWM
            </li>
          </ul>
          <p>
            <strong>Motor Speed Formula</strong>
          </p>
          <p>
          ...
          <p>
            <strong>VSD Voltage Levels</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>230V single-phase:</strong> ~325V DC — 230 &times; 1.414 = 325V
            </li>
            <li>
              <strong>400V three-phase:</strong> ~565V DC — 400 &times; 1.414 = 565V
            </li>
            <li>
              <strong>690V three-phase:</strong> ~975V DC — 690 &times; 1.414 = 975V
            </li>
          </ul>
          <p>
            <strong>IGBT Inverter Section</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Six IGBTs:</strong> Two per phase in three-phase inverter (upper and lower)
            </li>
            <li>
              <strong>Freewheeling diodes:</strong> Parallel to each IGBT for current return paths
            </li>
            <li>
          ...
          <p>
            <strong>Speed Calculation Example</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Terminology note:</strong> VSD, VFD, and inverter are often used interchangeably
            in HVAC. Technically, the inverter is just the DC-to-AC section, but commonly refers to
            the complete drive.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="PWM Technology and V/f Control">
          ...
          <p>
            <strong>PWM Operating Principle:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>V/f Characteristic Curve</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>10Hz:</strong> 80V — 8 V/Hz — Constant torque
            </li>
            <li>
              <strong>25Hz:</strong> 200V — 8 V/Hz — Constant torque
            </li>
            <li>
              <strong>50Hz (base):</strong> 400V — 8 V/Hz — Rated point
            </li>
            <li>
              <strong>60Hz:</strong> 400V (max) — 6.67 V/Hz — Field weakening
            </li>
          </ul>
          <p>
            <strong>Below Base Frequency</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Above Base Frequency</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Carrier Frequency Effects</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Smoother motor current:</strong> More motor current ripple
            </li>
            <li>
              <strong>Quieter motor operation:</strong> Audible motor noise
            </li>
            <li>
              <strong>Higher inverter losses:</strong> Lower inverter losses
            </li>
            <li>
              <strong>More motor insulation stress:</strong> Less motor insulation stress
            </li>
            <li>
              <strong>More EMI emissions:</strong> Less EMI emissions
            </li>
          </ul>
        ...
        <ConceptBlock title="Vector Control and Energy Savings">
          ...
          <p>
            <strong>Control Method Comparison:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Speed accuracy:</strong> plus/minus 2-5% — plus/minus 0.1-1%
            </li>
            <li>
              <strong>Low speed torque:</strong> Limited — Excellent (100% at 0 Hz)
            </li>
            <li>
              <strong>Dynamic response:</strong> Moderate — Fast
            </li>
            <li>
              <strong>Setup complexity:</strong> Simple — Motor data required
            </li>
            <li>
              <strong>Typical use:</strong> Fans, pumps — Hoists, precise positioning
            </li>
          </ul>
          <p>
            <strong>Fan and Pump Affinity Laws (Cube Law)</strong>
          </p>
          ...
          <p>
            <strong>Energy Savings - Power vs Speed</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>100%:</strong> 100% — 100% — Baseline
            </li>
            <li>
              <strong>90%:</strong> 90% — 73% — 27%
            </li>
            <li>
              <strong>80%:</strong> 80% — 51% — 49%
            </li>
            <li>
              <strong>70%:</strong> 70% — 34% — 66%
            </li>
            <li>
              <strong>60%:</strong> 60% — 22% — 78%
            </li>
            <li>
              <strong>50%:</strong> 50% — 12.5% — 87.5%
            </li>
          </ul>
          <p>
            <strong>VSD Energy Savings Calculation Example</strong>
          </p>
          <p>
            <strong>Scenario:</strong> 15kW AHU fan operates 5000 hours/year at average 70% speed vs
            damper control
          </p>
          ...
          <p>
            <strong>Vector Control Types</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Sensorless vector:</strong> Speed estimated from current/voltage - good for
              most applications
            </li>
            <li>
              <strong>Closed-loop vector:</strong> Uses encoder feedback - best accuracy and torque
              control
            </li>
            <li>
              <strong>Direct Torque Control (DTC):</strong> Alternative method with very fast torque
              response
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Harmonics, EMC and VSD Selection">
          ...
          <p>
            <strong>Harmonic Generation by 6-Pulse VSDs:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
          ...
          <p>
            <strong>Harmonic Effects on Electrical Systems</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Transformer heating:</strong> Eddy currents at harmonic frequencies — Derating
              or overheating
            </li>
            <li>
              <strong>Neutral overload:</strong> Triplen harmonics (3rd, 9th) add in neutral —
              Overheated neutral conductor
            </li>
            <li>
              <strong>Capacitor damage:</strong> Resonance amplification — PFC capacitor failure
            </li>
            <li>
              <strong>Voltage distortion:</strong> Harmonic currents in source impedance — Equipment
              malfunction
            </li>
          </ul>
          <p>
            <strong>Harmonic Mitigation Methods</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>No mitigation (6-pulse):</strong> 30-40% — Small drives on stiff supply
            </li>
            <li>
              <strong>Input line reactor (3-5%):</strong> 25-35% — Standard for medium drives
            </li>
            <li>
              <strong>DC bus choke:</strong> 30-35% — Built-in on some drives
            </li>
            <li>
              <strong>Passive filter:</strong> 8-15% — Large single drives
            </li>
            <li>
              <strong>12-pulse rectifier:</strong> 8-12% — Large drives &gt;100kW
            </li>
            <li>
              <strong>Active Front End (AFE):</strong> &lt;5% — Premium quality, regeneration
            </li>
            <li>
              <strong>Active filter:</strong> &lt;5% — Multiple drives, retrofit
            </li>
          </ul>
          <p>
            <strong>EMC Requirements and Measures</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
            ...
            <li>
              <strong>Motor cables:</strong> Use screened/armoured with 360-degree gland termination
            </li>
            <li>
          ...
          <p>
            <strong>EMC Installation Best Practice</strong>
          </p>
          <p>
            <strong>Motor Cable Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Installation Separation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>VSD Selection Criteria for HVAC</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Power rating:</strong> Match or slightly exceed motor kW
            </li>
            <li>
              <strong>Current rating:</strong> Must exceed motor FLC (consider derating factors)
            </li>
            <li>
              <strong>Supply voltage:</strong> 230V single-phase or 400V three-phase
            </li>
            <li>
              <strong>Enclosure rating:</strong> IP20 in panels, IP54/55 standalone
            </li>
            <li>
              <strong>Control interface:</strong> Modbus, BACnet, analog 0-10V, digital I/O
            </li>
            <li>
              <strong>EMC filter:</strong> Built-in C2 filter for first environment
            </li>
            <li>
              <strong>Harmonic mitigation:</strong> Line reactor or built-in DC choke minimum
            </li>
          </ul>
          <p>
            <strong>Motor Considerations for VSD Operation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Insulation:</strong> Inverter-duty motors have reinforced insulation for PWM
              spikes
            </li>
            <li>
          ...
          <p>
            ...
            harmonic contribution. Large installations (&gt;75kW total drives) may require harmonic
            assessment to demonstrate compliance and avoid connection agreement issues.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Question:</strong> A 4-pole induction motor with 3% slip runs on a VSD at 35Hz.
          ...
          <p>
            <strong>Question:</strong> A 400V, 50Hz motor operates at 30Hz. What voltage should the
            VSD provide to maintain constant flux?
          </p>
          ...
          <p>
            <strong>Question:</strong> A 22kW supply fan operates at 65% speed via VSD. Calculate
          ...
          <p>
            <strong>Question:</strong> A VSD is supplied from 400V three-phase. Calculate the DC bus
            voltage.
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Running motors too slow:</strong> Self-cooled motors overheat at low speeds
              </li>
              <li>
