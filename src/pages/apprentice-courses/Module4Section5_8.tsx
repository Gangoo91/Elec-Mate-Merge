      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Identification of Common Electrical Faults</h3>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Reversed polarity:</strong> Dangerous condition with live and neutral conductors incorrectly connected.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Open circuits:</strong> Complete loss of electrical continuity through broken conductors or failed connections.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Short circuits and earth faults:</strong> Direct connections between conductors or to earth.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
          ...
          {/* Causes of Faults */}
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Root Causes and Contributing Factors</h3>
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Material and component issues:</strong> Defective or inappropriate materials affecting installation integrity.</p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>Process and procedural failures:</strong> Inadequate quality control and testing procedures.</p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-xs sm:text-sm text-white mb-2"><strong>External damage factors:</strong> Damage from other activities affecting electrical installations.</p>
                    <ul className="text-xs text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Systematic Fault-Finding Methodologies</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Test equipment applications:</strong> Appropriate instruments for specific fault types.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Safety procedures during testing:</strong> Essential requirements for safe fault investigation.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Logical fault location process:</strong> Systematic narrowing of fault location.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
          ...
          {/* Corrective Actions */}
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Professional Fault Correction Techniques</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-green-500 ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Terminal and connection repairs:</strong> Professional standards for reliable connections.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Component replacement procedures:</strong> Safe removal and installation of damaged items.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Polarity and connection correction:</strong> Safe methods for correcting wiring errors.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Containment and support repairs:</strong> Maintaining mechanical protection and support.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Comprehensive Fault Prevention Strategies</h3>
            <p className="text-base text-white mb-4">
              ...
              <div className="rounded-lg p-5 border-l-4 border-l-elec-yellow ">
                <div className="flex items-start gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Protection during construction:</strong> Maintaining installation integrity throughout build process.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Standards compliance:</strong> Adherence to regulations and manufacturer requirements.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
                    ...
                    <p className="text-base text-white mb-2"><strong>Continuous improvement processes:</strong> Learning from experience to prevent future problems.</p>
                    <ul className="text-xs sm:text-sm text-white ml-4 mb-2 list-disc space-y-1">
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          {/* Safety Procedures */}
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Safety Procedures and Risk Management</h3>
            <div className="space-y-4">
              <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-border/30">
                <p className="font-medium text-white mb-2">Essential Safety Requirements</p>
              ...
              <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-border/30">
                <p className="font-medium text-white mb-2">Fault Investigation Best Practices</p>
                <ul className="text-xs sm:text-sm text-white space-y-1 list-disc pl-4">
              ...
              <div className="rounded-lg p-4 bg-transparent border border-green-400/30">
                <p className="font-medium text-white mb-2">Systematic Approach Guidelines</p>
                <ul className="text-xs sm:text-sm text-white space-y-1 list-disc pl-4">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Detailed Repair and Correction Procedures</h3>
            
            <div className="space-y-4">
              <div className="rounded-lg p-4 bg-transparent border border-amber-400/30">
                <p className="font-medium text-white mb-2">Loose Connection Correction Process</p>
              ...
              <div className="rounded-lg p-4 bg-transparent border border-cyan-400/30">
                <p className="font-medium text-white mb-2">Polarity Fault Correction Procedure</p>
              ...
              <div className="rounded-lg p-4 bg-indigo-500/10 border border-indigo-400/30">
                <p className="font-medium text-white mb-2">Cable Damage Repair Process</p>
                <ol className="text-xs text-white space-y-1 list-decimal pl-4">
          ...
          <section className="mb-6">
            <h3 className="font-medium text-white mb-4">Quality Assurance and Verification Procedures</h3>
            <div className="rounded-lg p-3 sm:p-4 bg-transparent border border-border/30">
              <p className="text-base text-white mb-3"><strong>Post-repair verification checklist:</strong></p>
              ...
              <div className="mt-3 p-2 bg-[#121212]/50 rounded border">
                <p className="text-xs sm:text-sm text-white"><strong>Professional standard:</strong> All repairs must meet current standards even if original installation was to earlier requirements.</p>
              </div>
            </div>
          </section>
        </Card>
        ...
        <Card className="mb-6 sm:mb-8 p-4 sm:p-6 bg-transparent border-white/20">
          ...
          <div className="space-y-4">
            <div>
              <h4 className="font-medium text-white mb-2">Q: If a fault is found, should I always repair it immediately?</h4>
              <p className="text-base text-white">A: Only if it can be done safely and without breaching other site rules. Otherwise, isolate and make safe until proper repair can be scheduled with appropriate resources and safety measures.</p>
            </div>
            <Separator />
            <div>
              <h4 className="font-medium text-white mb-2">Q: Can a single fault cause multiple symptoms?</h4>
              <p className="text-base text-white">A: Yes — for example, a loose neutral connection can cause intermittent power loss, voltage fluctuations, flickering lights, and equipment malfunction. Always consider interconnected effects when investigating faults.</p>
            </div>
            <Separator />
            <div>
              <h4 className="font-medium text-white mb-2">Q: How often should I test for faults during installation?</h4>
              <p className="text-base text-white">A: At minimum during first fix, second fix, and final testing stages, plus after any rework or areas where damage might have occurred. Regular testing identifies problems early when they are easier to correct.</p>
            </div>
            <Separator />
            <div>
              <h4 className="font-medium text-white mb-2">Q: What should I do if I find multiple faults in the same circuit?</h4>
              <p className="text-base text-white">A: Address one fault at a time and re-test after each correction to verify the repair and ensure no new problems are introduced. This systematic approach prevents confusion and ensures thorough resolution.</p>
            </div>
          </div>
        </Card>
