...
const seoDescription =
  'Master the skills of accurately costing electrical repairs and clearly explaining remedial work requirements to customers, including pricing strategies, quotation preparation, and justifying costs.';

// Quick check questions for inline knowledge checks
const quickCheckQuestions = [
  {
    question:
      'What should always be included in a professional quotation for remedial electrical work?',
    options: [
      'Just the total price',
      'Scope of work, itemised costs, timescales, and terms',
      'Technical specifications only',
      'Labour rate only',
    ],
    correctAnswer: 1,
    explanation:
      'A professional quotation should include a clear scope of work, itemised breakdown of labour and materials, expected timescales, payment terms, validity period, and any relevant terms and conditions.',
  },
  {
    question: 'When explaining repair costs to a customer, what approach is most effective?',
    options: [
      'Quote as low as possible to win the work',
      'Focus on the value and safety benefits of the repair',
      'Avoid discussing costs until the invoice',
      'Compare your prices to competitors',
    ],
    correctAnswer: 1,
    explanation:
      "Effective cost communication focuses on the value provided: the safety benefits, compliance with regulations, longevity of the repair, and prevention of future problems. This helps customers understand what they're paying for.",
  },
  {
    question: 'How should you handle a request to reduce your quoted price?',
    options: [
      'Always agree to avoid losing the work',
      'Explain the costs involved and offer alternative solutions if possible',
      'Immediately increase the price to allow negotiation room',
      'Refuse to discuss pricing',
    ],
    correctAnswer: 1,
    explanation:
      'Respond professionally by explaining what contributes to the cost (materials, labour, expertise, certification). If appropriate, offer alternative solutions at different price points, but never compromise quality or safety to reduce price.',
  },
  {
    question: 'What is the difference between a quotation and an estimate?',
    options: [
      'They are the same thing',
      'A quotation is a fixed price, an estimate is approximate',
      'An estimate is more professional',
      'A quotation is only for large jobs',
    ],
    correctAnswer: 1,
    explanation:
      "A quotation is a fixed price that you're committed to honour (within its validity period), while an estimate is an approximate figure that may change. Always clarify which you're providing and ensure customers understand the difference.",
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      'Only time on site',
      'Time, travel, expertise level, and business overheads',
      'Just the hourly rate',
      'What competitors charge',
    ],
    correctAnswer: 1,
    explanation:
      'Labour costs should include productive time on site, travel time, the expertise level required for the work, and a contribution to business overheads including insurance, vehicle costs, training, and administration.',
  },
  {
    question: 'When should you provide a revised quotation during a job?',
    options: [
      'Never - stick to the original price',
      'When the scope of work changes or additional issues are discovered',
      'Only at the end when presenting the final bill',
      'Only if the customer asks',
    ],
    correctAnswer: 1,
    explanation:
      'Provide a revised quotation whenever the scope changes or additional work is identified. Get customer agreement before proceeding with work beyond the original scope to avoid disputes about payment.',
  },
  {
    question: 'How should you explain why quality materials cost more?',
    options: [
      'Avoid mentioning material quality',
      'Explain the benefits of quality: reliability, safety, longevity, and warranty',
      "Just say they're the best",
      'Compare to what competitors use',
    ],
    correctAnswer: 1,
    explanation:
      'Explain the tangible benefits of quality materials: longer service life, better reliability, compliance with standards, safety features, and warranty coverage. Help customers understand the long-term value rather than just the initial cost.',
  },
  {
    question: 'What should you do if a customer cannot afford the recommended repair?',
    options: [
      'Do substandard work at a lower price',
      'Walk away from the job',
      'Discuss priorities and phased approaches while maintaining safety',
      'Refuse to help',
    ],
    correctAnswer: 2,
    explanation:
      'Work with the customer to prioritise essential safety repairs that must be done immediately versus improvements that could be phased over time. Never compromise safety, but help find workable solutions within their budget.',
  },
  {
    question: 'Why is it important to provide itemised quotations?',
    options: [
      "It's a legal requirement for all work",
      'It helps customers understand costs and makes comparisons fair',
      'It increases the total price',
      "It's only needed for large jobs",
    ],
    correctAnswer: 1,
    explanation:
      "Itemised quotations help customers understand what they're paying for, enable fair comparisons between quotes, demonstrate transparency and professionalism, and reduce disputes about what was included.",
  },
  {
    question: 'How should you respond when a customer gets a lower quote from a competitor?',
    options: [
      'Immediately match their price',
      'Explain the differences in scope, quality, and qualifications',
      'Criticise the competitor',
      'Refuse to discuss it',
    ],
    correctAnswer: 1,
    explanation:
      'Professionally explain what your quote includes (scope, materials, certification, warranty) and ask whether the competing quote covers the same. Lower quotes may exclude essential elements or use inferior materials.',
  },
  {
    question: 'What is the purpose of a validity period on a quotation?',
    options: [
      'To pressure customers into quick decisions',
      'To protect against material price changes and manage workload',
      "It's just a formality",
      'To allow price increases',
    ],
    correctAnswer: 1,
    explanation:
      'Validity periods protect you from being held to prices if material costs increase significantly. They also help manage your workload by preventing old quotes being accepted during busy periods when capacity is limited.',
  },
  {
    question: 'When explaining costs for emergency callouts, what should customers understand?',
    options: [
      'Emergency rates are arbitrary',
      'Why rates are higher: unsocial hours, disrupted schedule, immediate response',
      'Emergencies should be the same price as scheduled work',
      'They should call during office hours',
    ],
    correctAnswer: 1,
    explanation:
      'Explain that emergency rates reflect the unsocial hours worked, the disruption to scheduled work and personal time, the need to maintain emergency capacity, and the immediate response provided. Help them see the value of prompt service.',
  },
  {
    question: 'What approach should you take to pricing guarantee or callback work?',
    options: [
      'Always charge full rate',
      "Never charge - it's always your fault",
      'Assess reasonably - charge for new faults, not genuine failures of your work',
      'Avoid providing any guarantee',
    ],
    correctAnswer: 2,
    explanation:
      'Genuine failures of your work should be corrected without charge within a reasonable period. New faults unrelated to your work, or issues arising from customer actions, can reasonably be charged. Be clear about your terms upfront.',
  },
  {
    question: 'How can providing multiple options help with cost discussions?',
    options: [
      'It confuses customers',
      'It shows different price points while meeting their needs',
      "It's unnecessary extra work",
      'Customers prefer single options',
    ],
    correctAnswer: 1,
    explanation:
      'Offering options (e.g., minimum compliance vs enhanced specification) helps customers make informed choices based on their budget and priorities. It demonstrates flexibility and customer focus while maintaining professional standards.',
  },
  {
    question: 'What information should accompany a final invoice?',
    options: [
      'Just the total amount due',
      'Breakdown of work done, materials used, and any variations from quote',
      'Technical test results only',
      'Nothing - the quote already covered it',
    ],
    correctAnswer: 1,
    explanation:
      'Final invoices should include a breakdown of work completed, materials used, any variations from the original quote with explanations, payment terms, and relevant certificates or documentation references.',
  },
  {
    question: 'How should you handle payment for large or phased remedial work?',
    options: [
      'Always require full payment upfront',
      'Never ask for any payment until completion',
      'Agree staged payments matching work milestones',
      "Payment terms aren't important",
    ],
    correctAnswer: 2,
    explanation:
      'For larger projects, staged payments tied to milestones protect both parties: you receive payment as work progresses, and the customer only pays for completed stages. Agree terms clearly before starting work.',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <section className="mb-8 sm:mb-12">
          <div className="flex items-center gap-3 mb-4">
            <span className="text-xs sm:text-sm font-bold text-yellow-400 bg-yellow-400/10 px-2 py-1 rounded">
              01
            </span>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-white/5 rounded-lg p-4 mb-4">
              <ul className="list-disc pl-5 text-white text-sm space-y-2">
                ...
                <li>
                  <strong>Vehicle costs:</strong> Purchase/lease, fuel, maintenance, insurance,
                  parking
                </li>
                <li>
                  <strong>Tools and equipment:</strong> Purchase, calibration, maintenance,
                  replacement
                </li>
                <li>
                  <strong>Training and qualifications:</strong> Courses, certification, CPD
                  requirements
                </li>
                <li>
                  <strong>Business administration:</strong> Accounting, software, phone, office
                  costs
                </li>
                <li>
                  <strong>Scheme membership:</strong> Competent person scheme fees, trade
                  associations
                </li>
                <li>
                  <strong>Non-productive time:</strong> Quoting, administration, training, holidays,
                  sickness
                </li>
              </ul>
            </div>
        ...
        <section className="mb-8 sm:mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-white">
              Preparing Professional Quotations
            </h2>
          </div>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-gradient-to-r from-yellow-400/10 to-amber-500/10 rounded-lg p-4 border border-yellow-400/20 mb-4">
              ...
              <ul className="list-disc pl-5 text-white text-sm space-y-2">
                ...
                <li>
                  <strong>Customer details:</strong> Name, address, contact information
                </li>
                <li>
                  <strong>Reference and date:</strong> Unique quotation number and date issued
                </li>
                <li>
                  <strong>Scope of work:</strong> Clear description of what will be done
                </li>
                <li>
                  <strong>Materials:</strong> Specification of key materials or "or equivalent"
                </li>
                <li>
                  <strong>Price breakdown:</strong> Labour, materials, and total (itemised or
                  summary)
                </li>
                <li>
                  <strong>VAT:</strong> Clearly state if prices include or exclude VAT
                </li>
                <li>
                  <strong>Timescales:</strong> Estimated duration and proposed start date
                </li>
                <li>
                  <strong>Validity period:</strong> How long the quotation remains valid
                </li>
                <li>
                  <strong>Payment terms:</strong> When and how payment is expected
                </li>
                <li>
                  <strong>Terms and conditions:</strong> Cancellation policy, guarantee, exclusions
                </li>
              </ul>
            </div>
                ...
                <tbody>
                  ...
                  <tr className="bg-white/5">
                    <td className="border border-white/20 p-2">
                      Legally binding within validity period
                    </td>
                    <td className="border border-white/20 p-2">
                      Can change when actual work is assessed
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr className="bg-white/5">
                    <td className="border border-white/20 p-2">
                      Appropriate when work is clearly defined
                    </td>
                    <td className="border border-white/20 p-2">
                      Appropriate when scope is uncertain
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-white/5 rounded-lg p-4 mb-4">
              <ul className="list-disc pl-5 text-white text-sm space-y-2">
                ...
                <li>
                  <strong>Compliance:</strong> "The work will meet current regulations and be fully
                  certified"
                </li>
                <li>
                  <strong>Quality:</strong> "We use quality materials that will last many years"
                </li>
                <li>
                  <strong>Expertise:</strong> "You're benefiting from qualified, insured
                  professionals"
                </li>
                <li>
                  <strong>Peace of mind:</strong> "You'll have documentation for insurance and
                  property sale"
                </li>
                <li>
                  <strong>Prevention:</strong> "Fixing this now prevents more costly problems later"
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/5 rounded-lg p-4 mb-4">
              <ul className="list-disc pl-5 text-white text-sm space-y-2">
                ...
                <li>
                  <strong>Labour:</strong> Describe the skilled work involved and time required
                </li>
                <li>
                  <strong>Testing:</strong> Explain the testing and certification process
                </li>
                <li>
                  <strong>Qualifications:</strong> Mention the training and expertise required
                </li>
                <li>
                  <strong>Compliance:</strong> Reference the regulations you must meet
                </li>
                <li>
                  <strong>Guarantees:</strong> Describe any warranty on your work
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-lg p-4 border border-green-500/20 mb-4">
              ...
              <ul className="list-disc pl-5 text-white text-sm space-y-2">
                ...
                <li>
                  <strong>Option B - Recommended:</strong> "This includes the essential work plus
                  improvements for better performance and longer life. Cost: Y"
                </li>
                <li>
                  <strong>Option C - Comprehensive:</strong> "This fully upgrades the affected area
                  to current best practice. Cost: Z"
                </li>
              </ul>
            </div>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-gradient-to-r from-yellow-400/10 to-amber-500/10 rounded-lg p-4 border border-yellow-400/20 mb-4">
              <ul className="list-disc pl-5 text-white text-sm space-y-2">
                ...
                <li>
                  <strong>Don't drop price instantly:</strong> This suggests the original price was
                  inflated
                </li>
                <li>
                  <strong>Scope adjustment:</strong> If reducing price, reduce scope to match
                </li>
                <li>
                  <strong>Maintain quality:</strong> Never compromise materials or safety for price
                </li>
                <li>
                  <strong>Professional alternatives:</strong> Offer legitimate options rather than
                  discounts
                </li>
                <li>
                  <strong>Know your limits:</strong> Be prepared to decline work that isn't viable
                </li>
              </ul>
            </div>
        ...
        <section className="mb-8 sm:mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-white">
              Managing Variations and Additional Work
            </h2>
          </div>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-gradient-to-r from-yellow-400/10 to-amber-500/10 rounded-lg p-4 border border-yellow-400/20 mb-4">
              ...
              <ol className="list-decimal pl-5 text-white text-sm space-y-2">
                ...
                <li>
                  <strong>Stop:</strong> Pause before doing any work outside the agreed scope
                </li>
                <li>
                  <strong>Document:</strong> Record what you've found and why additional work is
                  needed
                </li>
                <li>
                  <strong>Communicate:</strong> Explain the situation clearly to the customer
                </li>
                <li>
                  <strong>Quote:</strong> Provide a clear price for the additional work
                </li>
                <li>
                  <strong>Agree:</strong> Obtain customer approval before proceeding (in writing
                  ideally)
                </li>
                <li>
                  <strong>Proceed:</strong> Complete the additional work as agreed
                </li>
                <li>
                  <strong>Record:</strong> Document the variation for your records and invoicing
                </li>
              </ol>
            </div>
        ...
        {/* Quiz Section */}
        <section className="mb-8 sm:mb-12">
          <Quiz title="Section 6.3 Knowledge Check" questions={quizQuestions} passingScore={75} />
        </section>
