...
const quickCheckQuestions = [
  {
    ...
    options: [
      'To verify that the building simply meets the minimum Part L standard',
      'To reduce building CO2 emissions through improved energy performance beyond Building Regulations',
      'To measure the actual metered energy use once the building is occupied',
      'To set the maximum water consumption allowed per building occupant',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A single main meter recording total site consumption only',
      'Quarterly manual meter readings recorded in a paper logbook',
      'Metering of the incoming water and gas supplies only',
  ...
  },
  {
    ...
    options: ['50 luminous lm/W', '70 luminous lm/W', '60 luminous lm/W', '80 luminous lm/W'],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'The Display Energy Certificate (DEC) operational rating',
      'CIBSE TM54 operational energy prediction report',
      'BRUKL (Building Regulations UK Part L)',
      'The building log book prepared at handover',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['8 credits', '4 credits', '10 credits', '6 credits'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['Hourly or better', 'Daily', 'Weekly', 'Monthly'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A dedicated sub-meter on every external luminaire',
      'Automatic daylight sensing and time scheduling',
      'A minimum colour rendering index of 90 for all fittings',
      'Manual switching by the building operator each evening',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'A spreadsheet of manual U-value calculations',
      'The CIBSE TM46 benchmarking tool',
  ...
  },
  {
    ...
    options: ['1.5 W/m²', '2.5 W/m²', '2.0 W/m²', '3.0 W/m²'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Manufacturer product data sheets on their own',
      'A signed statement of design intent with no calculations',
      'Design stage BRUKL output and energy model report',
      'At least twelve months of post-occupancy energy bills',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only the space heating demand of the building',
      'Only the unregulated small-power and IT loads',
      'Only the energy generated by on-site renewable technologies',
  ...
  },
  {
    ...
    options: [
      ...
      'BREEAM energy credits and the EPC rating are exactly the same figure',
      'An EPC is required only for buildings that fail to achieve any BREEAM credits',
      'BREEAM credits are calculated entirely independently of any Part L data',
    ],
    correctAnswer: 0,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              Ene 01 is directly tied to the NCM output. Improvements come from (in order of typical
              cost-effectiveness): better fabric, low-carbon heating (heat pumps), high-efficacy
              lighting + controls, on-site PV. There is no other route to credits — you must run
              SBEM/SAP and demonstrate the % improvement; design intent statements alone earn
              nothing.
            </>
          }
        ...
        <ConceptBlock title="Ene 01 - Energy Performance and EPR">
          <p>
            BREEAM Ene 01 is typically the highest-weighted energy credit issue, rewarding buildings
            that achieve operational CO2 emissions reductions beyond Building Regulations Part L
            minimum requirements. Credits are awarded based on the Energy Performance Ratio (EPR),
            which compares the actual building's calculated performance against a notional baseline
            building.
          </p>
          <p>
            <strong>Energy Performance Ratio (EPR) Explained:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>EPR calculation:</strong> Compares actual vs notional building energy/carbon
              performance
            </li>
            <li>
            ...
            <li>
              <strong>Improvement required:</strong> Higher EPR = better performance = more credits
            </li>
            <li>
          ...
          <p>
            <strong>Ene 01 Credit Thresholds (Indicative)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1-3:</strong> Marginal improvement over Part L — Enhanced fabric, efficient
              lighting
            </li>
            <li>
              <strong>4-6:</strong> Good performance (Very Good/Excellent) — Heat recovery, LED
              throughout, controls
            </li>
            <li>
              <strong>7-9:</strong> Excellent performance — LZC technologies, optimised systems
            </li>
            <li>
              <strong>10+:</strong> Outstanding/Net zero — Passive design, significant renewables
            </li>
          </ul>
          <p>
            <strong>BRUKL Output Requirements</strong>
          </p>
          ...
          <p>
            BRUKL must demonstrate BER ≤ TER for Part L compliance; BREEAM rewards BER significantly
            below TER.
          </p>
          <p>
            <strong>Design principle:</strong> Early-stage decisions on building form, orientation,
            and fabric have the greatest impact on Ene 01 performance - optimise these before
            relying on efficient services or renewables.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Ene 02 - Sub-Metering of Substantial Energy Uses">
          ...
          <p>
            <strong>Mandatory Sub-Metering</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Sub-Metering Strategy Example - Office Building</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Main incomer:</strong> Main LV switchboard — CT metering, MID Class B
            </li>
            <li>
              <strong>HVAC:</strong> Mechanical services DB — kWh meter, pulsed output
            </li>
            <li>
              <strong>Lighting:</strong> Lighting distribution boards — kWh meter per floor
            </li>
            <li>
              <strong>Small power:</strong> Floor distribution boards — kWh meter per tenant area
            </li>
            <li>
              <strong>Lifts:</strong> Lift motor room DB — Dedicated kWh meter
            </li>
            <li>
              <strong>Server room:</strong> IT distribution board — Dedicated kWh meter
            </li>
          </ul>
          <p>
        ...
        <ConceptBlock title="Ene 03 - External Lighting">
          ...
          <p>
            <strong>Core Requirements - Ene 03</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Minimum efficacy:</strong> Average initial luminous efficacy ≥70 luminous lm/W
              across all external luminaires
            </li>
            <li>
            ...
            <li>
              <strong>Time scheduling:</strong> Time-based controls preventing unnecessary operation
            </li>
            <li>
          ...
          <p>
            <strong>External Lighting Design Checklist</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Car parks:</strong> 20-75 lux (BS 5489) — Photocell + time clock, presence
              dimming
            </li>
            <li>
              <strong>Pedestrian routes:</strong> 5-20 lux — Photocell control, reduced overnight
            </li>
            <li>
              <strong>Building entrance:</strong> 100-200 lux — Photocell, occupancy-linked dimming
            </li>
            <li>
              <strong>Security/perimeter:</strong> Variable — PIR activation, CCTV integration
            </li>
            <li>
              <strong>Decorative/facade:</strong> Design dependent — Time scheduling, curfew hours
            </li>
          </ul>
          <p>
            <strong>Efficacy Calculation Example:</strong>
          </p>
          ...
          <p>
            ...
            (light pollution) requirements - use luminaires with appropriate upward light ratio (0%
            for E1/E2 zones) and consider impact on neighbouring properties.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Ene 04 - Low and Zero Carbon Technologies">
          ...
          <p>
            <strong>Recognised LZC Technologies</strong>
          </p>
          <p>
            <strong>Electricity Generation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>LZC Feasibility Study Requirements</strong>
          </p>
          ...
          <p>
            <strong>Credit Requirements and Calculation</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Feasibility study:</strong> Prerequisite — LZC options assessment report
            </li>
            <li>
              <strong>Energy contribution:</strong> ≥10% of building demand — Energy model showing
              LZC output
            </li>
            <li>
              <strong>Carbon contribution:</strong> OR ≥10% CO2 reduction — Carbon calculation
              methodology
            </li>
            <li>
              <strong>System specification:</strong> Detailed design — Drawings, specifications,
              datasheets
            </li>
          </ul>
          <p>
            <strong>Heat Pump Carbon Assessment Example</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Technology selection:</strong> Heat pumps typically offer highest carbon savings
            due to grid decarbonisation trajectory. Solar PV provides excellent returns where roof
            area permits and complements electrified heating.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Compare LZC options for school building (1,500m², 200,000 kWh
            annual demand).
          </p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              ...
              <li>
                <strong>Inadequate sub-metering:</strong> Missing systems results in non-compliance
              </li>
              <li>
                <strong>Decorative lighting excluded:</strong> All external lighting counts towards
                efficacy
              </li>
              <li>
        ...
        <Scenario
          ...
          situation={
            <>
              A school project is targeting BREEAM Outstanding. The Ene 01 target is 50% improvement
              on Part L. Design SBEM achieves 38% (heat pumps + good fabric); the gap of 12% would
              normally be closed with rooftop PV. The roof is reserved for solar thermal and a
              green-roof biodiversity strategy — PV is precluded.
            </>
          }
          whatToDo={
            <>
              Three routes to close the gap: (1) external PV on a canopy / car-port structure (often
              planning-acceptable, sometimes adds shading benefit); (2) battery storage + smart
              charging optimised against half-hourly grid carbon (Ene 04 LZC + smart controls —
              modest contribution); (3) abandon Outstanding and target Excellent (45–55%,
              achievable). Discuss with the BREEAM Assessor early — often a combination of LZC
              technologies plus enhanced fabric (better airtightness, improved Ψ-values) can claw
              back the gap.
            </>
          }
          whyItMatters={
            <>
              BREEAM Outstanding is the rating that almost always needs on-site renewables. The roof
              real-estate conflict (PV vs solar thermal vs green roof vs biodiversity) is the most
              common Outstanding-vs-Excellent decision. Lock the roof strategy at RIBA Stage 2, not
              Stage 4.
            </>
          }
        />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">Water category</div>
          </button>
          <button
