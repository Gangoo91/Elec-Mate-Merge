      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5 text-left">
              <li className="pl-1">
                <strong>Initiative:</strong> Proactive action within your authority level
              </li>
              <li className="pl-1">
                <strong>Problem-solving:</strong> Structured, systematic diagnostic approach
              </li>
              <li className="pl-1">
                <strong>Root cause:</strong> Address underlying causes, not just symptoms
              </li>
              <li className="pl-1">
                <strong>Escalation:</strong> Know when to seek help — a professional skill
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Process improvement:</strong> Suggesting a more efficient way to complete
                  a maintenance task
                </li>
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                Initiative does not mean acting beyond your authority or competence. As an
                apprentice, you should take initiative within your level — report hazards rather
                than attempting to fix high-voltage issues alone, suggest improvements rather than
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Initiative is a spectrum: at one end is "only does what
              they are told," at the other is "acts without thinking." The professional sweet spot
              is in between — proactive, thoughtful action within your authority, with good
              judgement about when to act and when to consult.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                The Diagnostic Problem-Solving Cycle
              </p>
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-3">
                Worked Example: Systematic Fault Diagnosis
              </h3>
              <p className="text-sm text-white mb-3">
                <strong>Scenario:</strong> A three-phase motor on a conveyor system trips
                intermittently on overload.
              </p>
              <ul className="text-sm text-white space-y-2 list-none">
                <li>
                  <strong>Step 1 — Define:</strong> Motor trips on overload relay 2-3 times per
                  shift. No pattern to timing.
                </li>
                <li>
                  <strong>Step 2 — Gather:</strong> Check maintenance history (no recent work),
                  operator reports (belt seems to slow before trip), motor nameplate data.
                </li>
                <li>
                  <strong>Step 3 — Possible causes:</strong> Overloaded belt, bearing failure,
                  supply voltage issue, incorrect overload setting, loose connections.
                </li>
                <li>
                  <strong>Step 4 — Test:</strong> Check current draw (slightly above rated), check
                  bearing temperature (elevated on drive end), check connections (all tight), check
                  overload setting (correct).
                </li>
                <li>
                  <strong>Step 5 — Implement:</strong> Replace drive-end bearing.
                </li>
                <li>
                  <strong>Step 6 — Verify:</strong> Run motor on load — current draw now normal, no
                  overheating, no trips after 4 hours.
                </li>
                <li>
                  <strong>Step 7 — Document:</strong> Record in CMMS, recommend adding bearing
                  checks to PM schedule.
                </li>
              </ul>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> The structured approach works even when you have never
              seen the fault before. The process gives you a framework for approaching any problem
              logically, rather than relying solely on past experience.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                The 5 Whys Technique — Worked Example
              </p>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Motor was drawing excessive current
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        No lubrication — grease had dried out
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Motor was not on the planned maintenance schedule
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Why 5</td>
                      <td className="border border-white/10 px-3 py-2">
                        Why was it not on the PM schedule?
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Installed during a modification and never added
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Root cause analysis prevents recurrence. Replacing the
              bearing fixes today's problem; adding the motor to the PM schedule prevents the same
              failure happening again. The assessor values evidence that you think beyond the
              immediate fix.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p>
              ...
              is not initiative — it is recklessness. Knowing when to say "this is beyond my current
              ability and I need to involve someone more experienced" demonstrates exactly the
              professional judgement the assessor is looking for.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  Provide all relevant information: symptoms, test results, documentation
                </li>
                <li className="pl-1">
                  Suggest what you think the problem might be (your best hypothesis)
                </li>
                <li className="pl-1">
                  Ask how you can assist or learn from the escalated resolution
                </li>
              </ul>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Professional escalation is not "I cannot do this — you
              deal with it." It is "I have investigated this systematically, here is what I have
              found, here is why I believe specialist input is needed, and here is how I can help."
              That is a professional communication, not an admission of failure.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
              ...
              <p className="text-sm text-white">
                "During a routine inspection, I noticed unusual vibration on the extract fan motor
                (initiative — identifying a problem proactively). I checked the bearing temperature
                (elevated) and current draw (slightly above rated), consulted the maintenance
                history (no recent bearing replacement), and reported my findings to my supervisor
                with a recommendation to schedule a bearing replacement before failure (structured
                problem-solving and appropriate communication). The replacement was scheduled and
                completed during the next planned shutdown, preventing an unplanned breakdown
                (positive outcome). I learned the value of using all available diagnostic indicators
                together, not just relying on one measurement (reflection)."
              </p>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>ST1426 link:</strong> Initiative and problem-solving are assessed across all
              three EPA components. The assessor is looking for evidence of genuine professional
              thinking — not just following procedures, but understanding why you do what you do and
              being proactive about identifying and addressing issues.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 rounded-lg bg-white/5">
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              ...
              <li className="pl-1">
                Follow the diagnostic cycle: define, gather, hypothesise, test, fix, verify,
                document
              </li>
              <li className="pl-1">
              ...
              <li className="pl-1">
                A failed test is not a failed attempt — it gives you information to refine your
                diagnosis
              </li>
              <li className="pl-1">
                Document the complete problem-solving journey for your portfolio, not just the
                outcome
              </li>
              <li className="pl-1">
