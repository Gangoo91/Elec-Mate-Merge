...
const DESCRIPTION =
  'Learn lock-out tag-out (LOTO) procedures, types of lock-off devices, warning tag requirements, and permit-to-work systems for electrical safety.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "A personal padlock ensures that only YOU can remove it and restore power. If someone else could remove your lock, they could re-energise the circuit while you're working on it. Your lock = Your life. One lock per person working on the circuit.",
  },
  {
    id: 'check-2',
    ...
    correctIndex: 1,
    explanation:
      "Warning tags must identify WHO isolated the circuit, WHEN they did it, WHY it's isolated, and HOW to contact them. This prevents accidental re-energisation and provides accountability. Without this information, someone might wrongly assume the isolation is no longer needed.",
  },
  {
    id: 'check-3',
    question:
      'Multiple electricians are working on the same isolated circuit. How should lock-off be managed?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      "Each person working on the circuit must apply their own personal padlock via a multi-lock hasp. Power can only be restored when EVERY person has removed their lock after confirming they've finished work. No single person should be able to remove another's protection.",
  },
  {
    id: 'check-4',
    ...
    correctIndex: 2,
    explanation:
      'Permit-to-work systems are used for high-risk activities, particularly in industrial and commercial settings. They formally document the isolation, specify precautions, and create a controlled handover process. Common in factories, substations, and anywhere with complex or high-voltage systems.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'LOTO stands for Lock Out Tag Out - the procedure of physically locking isolation devices in the OFF position and attaching warning tags. This is a fundamental safety procedure to prevent accidental re-energisation during maintenance or repair work.',
  },
  {
    id: 2,
    question:
      'Which type of lock-off device is used for miniature circuit breakers (MCBs) in consumer units?',
    options: [
      'Valve lockout',
    ...
    correctAnswer: 1,
    explanation:
      "MCB lock-off devices clip over the breaker toggle, preventing it from being switched on. They have a hole for a padlock to secure them in place. Different manufacturers' MCBs may require different lock-off devices, so check compatibility.",
  },
  {
    id: 3,
    question: 'What colour are warning tags typically for electrical isolation?',
    options: ['Green', 'Blue', 'Red or danger yellow', 'White'],
    correctAnswer: 2,
    explanation:
      "Electrical isolation warning tags are typically red or danger yellow with clear 'DANGER - Do Not Operate' or 'Do Not Switch On' warnings. The high-visibility colour ensures they cannot be overlooked. Some sites have specific colour codes for different types of isolation.",
  },
  {
    id: 4,
    question:
      "What should you do if you find someone else's lock on equipment you need to re-energise?",
    options: [
    ...
    correctAnswer: 2,
    explanation:
      "Never remove another person's lock under any circumstances. That person may still be working on the circuit or may have left for a valid reason. Contact them directly to confirm they have completed work safely. This is why contact details must be on the tag.",
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'A multi-lock hasp (or lockout hasp) allows multiple padlocks to be attached to a single isolation point. Each worker applies their own lock, and the equipment cannot be re-energised until every lock is removed. This protects multiple workers simultaneously.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "Withdrawn fuses should be kept on your person or in a locked container that only you control. This prevents anyone from finding and replacing the fuse while you're working. The fuse carrier should be tagged as well. Treat withdrawn fuses with the same care as your lock.",
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      "Permit-to-work systems formally document isolations, specify required precautions, and create a controlled handover process. They ensure everyone knows what's isolated, who's working, and when it's safe to restore power. Essential for complex or high-risk situations.",
  },
  {
    id: 9,
    question:
      'Before leaving site at the end of a day (work incomplete), what should you check regarding lock-off?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'If work is incomplete and the circuit must remain isolated, your lock and tag must stay in place. If you must leave, establish clear handover procedures - but never simply transfer your lock to someone else. They must apply their own lock before you remove yours.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      "Purpose-designed safety lockout padlocks should be used - they're typically coloured for easy identification, have unique keys (no master keys), and are robust enough for industrial use. Never use combination locks (others could know the code) or master-keyed locks (defeats the purpose of personal protection).",
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>LOTO:</strong> Lock Out Tag Out - physical prevention of re-energisation
              </li>
              <li>
                <strong>Personal lock:</strong> Only YOU can remove your lock - one person, one lock
              </li>
              <li>
                <strong>Tags:</strong> Name, date, reason, contact details - always with locks
              </li>
              <li>
                <strong>Multi-lock:</strong> Each worker applies their own lock via a hasp
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Isolation points, lock-off provisions, hasp fittings
              </li>
              <li>
                <strong>Use:</strong> MCB locks, rotary isolator locks, fuse carrier locks
              </li>
              <li>
                <strong>Apply:</strong> Your personal lock + warning tag at every isolation
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Proving dead tells you the circuit is safe NOW. But what stops someone switching it
              back on while you're working? The answer is lock-off - physically preventing anyone
              from restoring power until you're ready.
            </p>
            <p>
              Consider this: you isolate a circuit at the consumer unit, prove it dead at your work
              point, and begin work. Meanwhile, a colleague arrives, sees the MCB is off, assumes it
              tripped, and switches it back on. You receive a 230V shock. This scenario has killed
              electricians. Lock-off prevents it.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>The Principle:</strong> Your lock, your life. Only YOU should be able to
              remove your lock. Never allow master-keyed systems or situations where others can
              defeat your protection.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Different equipment requires different lock-off devices. Understanding which device to
              use - and having the right ones in your kit - is essential for any electrician.
            </p>
            ...
            <div className="my-6 p-4 rounded bg-white/5">
              ...
              <p className="text-sm text-white">
                ...
                else could find and replace them.
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Warning tags communicate essential information about an isolation. They're the link
              between the physical lock and the human who placed it. A lock without a tag is a
              mystery - a tag without a lock is just a suggestion.
            </p>
            ...
            <div className="my-6 p-4 rounded bg-elec-yellow/5 border border-elec-yellow/20">
              ...
              <ul className="text-sm text-white space-y-2">
                <li>
                  <strong>1. Clear Warning:</strong> "DANGER - DO NOT OPERATE" or "DO NOT SWITCH ON"
                </li>
                <li>
                  <strong>2. Your Name:</strong> Who isolated this circuit?
                </li>
                <li>
                  <strong>3. Date and Time:</strong> When was it isolated?
                </li>
                <li>
                  <strong>4. Reason:</strong> Why is it isolated? (e.g., "Rewiring kitchen circuit")
                </li>
                <li>
                  <strong>5. Contact Details:</strong> Mobile number or how to reach you
                </li>
                <li>
                  <strong>6. Expected Duration:</strong> When do you expect to finish? (if known)
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> If your tag fell off and someone found your lock, could
              they contact you? If not, your tag isn't doing its job. Write clearly, include all
              details, and attach securely.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              When multiple people work on the same isolated circuit, each person must have their
              own protection. A supervisor's lock doesn't protect the apprentice. A mate's lock
              doesn't protect you. The solution is a multi-lock hasp.
            </p>
            ...
            <div className="my-6 p-4 rounded bg-red-500/10 border border-red-500/20">
              ...
              <p className="text-sm text-white">
                ...
                colleagues who didn't realise they were still working.
              </p>
            </div>
            ...
            <p className="text-sm text-white italic">
              ...
              working. The circuit CANNOT be re-energised until both B and C have also removed their
              locks. This protects everyone.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              In industrial and commercial settings, particularly with high-voltage equipment or
              complex systems, permit-to-work (PTW) systems add a formal layer of control to the
              isolation process.
            </p>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Your Lock-Off Kit Should Contain
              </h3>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Never remove another person's lock</strong> - no exceptions
                </li>
                <li>
                  <strong>Never use master-keyed padlocks</strong> - defeats personal protection
                </li>
                <li>
                  <strong>Never leave locks overnight without tags</strong> - creates confusion
                </li>
                <li>
                  <strong>Never rely on tags alone</strong> - tags warn, locks prevent
                </li>
                <li>
                  <strong>Never assume someone else locked off for you</strong> - verify yourself
                </li>
              </ul>
            </div>
          </div>
