        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>LiFePO4:</strong> Preferred for safety and cycle life
              </li>
              <li className="pl-1">
                <strong>DoD:</strong> Depth of discharge affects lifespan
              </li>
              <li className="pl-1">
                <strong>BMS:</strong> Essential for cell protection and balancing
              </li>
              <li className="pl-1">
                <strong>Grid services:</strong> Frequency response and peak shaving
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Round-trip efficiency:</strong> 90-95% lithium-ion
              </li>
              <li className="pl-1">
                <strong>Cycle life:</strong> 4,000-10,000 cycles LiFePO4
              </li>
              <li className="pl-1">
                <strong>Usable DoD:</strong> 80-90% lithium, 50% lead-acid
              </li>
              <li className="pl-1">
                <strong>Fire rating:</strong> 30-minute separation required
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              enables appropriate selection for residential, commercial, and grid-scale
              installations.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Lithium Iron Phosphate (LiFePO4):</strong> Safest chemistry, excellent
                  cycle life (6,000-10,000), lower energy density, preferred for stationary storage
                </li>
                <li className="pl-1">
                  <strong>Lithium Nickel Manganese Cobalt (NMC):</strong> Higher energy density,
                  good cycle life (3,000-5,000), requires more sophisticated thermal management
                </li>
                <li className="pl-1">
                  <strong>Lithium Titanate (LTO):</strong> Very fast charging, exceptional cycle
                  life (15,000+), lower energy density, higher cost
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10 border border-blue-500/30">
              ...
              <p className="text-sm text-white">
                ...
                long-duration storage applications where 4-12 hours of discharge is required.
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              maximising self-consumption, providing backup power, or participating in grid
              services.
            </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Self-Consumption Sizing Method
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
            ...
            <div className="my-6 p-4 rounded-lg bg-green-500/10 border border-green-500/30">
              ...
              <div className="text-sm text-white space-y-2">
                ...
                <p>
                  <strong>Excess PV available:</strong> Analysis shows ~5kWh surplus on typical
                  summer day
                </p>
                <p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Cell voltage monitoring:</strong> Tracks individual cell voltages to
                  detect imbalance or failing cells
                </li>
                <li className="pl-1">
                  <strong>Cell balancing:</strong> Equalises charge across cells - passive
                  (dissipative) or active (energy transfer)
                </li>
                <li className="pl-1">
                  <strong>Temperature monitoring:</strong> Multiple sensors detect hotspots and
                  trigger cooling or shutdown
                </li>
                <li className="pl-1">
                  <strong>Over-charge protection:</strong> Disconnects charging when cells reach
                  maximum voltage (4.2V NMC, 3.65V LiFePO4)
                </li>
                <li className="pl-1">
                  <strong>Over-discharge protection:</strong> Disconnects load at minimum voltage
                  (2.5V NMC, 2.5V LiFePO4)
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>State of Charge (SoC):</strong> Calculates remaining capacity using
                  coulomb counting and voltage correlation
                </li>
                <li className="pl-1">
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Voc × number of series modules
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Apply cold temperature coefficient
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Maximum PV current</td>
                      <td className="border border-white/10 px-3 py-2">
                        Isc × number of parallel strings
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        × 1.25 for irradiance peaks
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              protection, ventilation, and electrical safety. Beyond self-consumption,
              grid-connected batteries can provide valuable services to the electricity network.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Fire Safety Requirements (BS EN 62619, BS 7671)
              </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Overcurrent protection:</strong> DC-rated fuses or MCBs suitable for
                  battery short-circuit current (can exceed 10kA)
                </li>
                <li className="pl-1">
                ...
                <li className="pl-1">
                  <strong>Labelling:</strong> Warning labels indicating battery presence, voltages,
                  and isolation points
                </li>
                <li className="pl-1">
                  <strong>G98/G99 compliance:</strong> Grid connection requirements for
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <p className="text-sm text-white">
                ...
                with automatic shutdown; appropriate spacing between cells; and fire-resistant
                enclosures. LiFePO4 chemistry is inherently more resistant to thermal runaway than
                NMC.
              </p>
            </div>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Rapid power injection/absorption to stabilise grid frequency
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        &lt;1 second response, high power capability
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Peak Shaving</td>
                      <td className="border border-white/10 px-3 py-2">
                        Reduce demand during peak periods (typically 4-7pm)
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Absorb excess renewable generation, release during low generation
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Large capacity, aggregation platform
                      </td>
                    </tr>
                    <tr>
                      <td className="border border-white/10 px-3 py-2">Voltage Support</td>
                      <td className="border border-white/10 px-3 py-2">
                        Reactive power provision for local voltage regulation
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Inverter capable of reactive power control
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Usable Energy Calculation
              </h3>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: Battery Cycle Life Estimation
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: C-Rate and Discharge Time
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 4: MPPT Controller Sizing
              </h3>
              <p className="text-sm text-white mb-2">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  Verify location meets fire separation and ventilation requirements
                </li>
                <li className="pl-1">
                  Confirm mounting surface can support battery weight (typically 100-150kg)
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Ignoring temperature range</strong> - Reduces capacity and lifespan
                  outside 10-35°C
                </li>
                <li className="pl-1">
