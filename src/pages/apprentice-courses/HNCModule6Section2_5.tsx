...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['98-99%', '70-75%', '90-95%', '80-85%'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['7.2kWh', '8.1kWh', '9.0kWh', '8.0kWh'],
    correctAnswer: 0,
    explanation:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/study-centre/apprentice/h-n-c-module6-section2"
      />
      <HubBody>
        ...
        <RegsCallout
          ...
          meaning={
            <>
              The IET CoP is the de facto UK BESS standard — referenced by BS 7671, by insurers, and
              by the LABC. Location restrictions are tighter than installers often assume: garages
              and outbuildings are preferred over loft, under-stair or hallway sites. Indoor
              installations need a documented fire-risk assessment.
            </>
          }
        ...
        <ConceptBlock title="Battery Technologies">
          <p>
            Modern energy storage systems utilise various battery chemistries, each with distinct
            characteristics suited to different applications. Understanding these technologies
            enables appropriate selection for residential, commercial, and grid-scale installations.
          </p>
          <p>
            <strong>Lithium-Ion Technologies:</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Lithium Iron Phosphate (LiFePO4):</strong> Safest chemistry, excellent cycle
              life (6,000-10,000), lower energy density, preferred for stationary storage
            </li>
            <li>
              <strong>Lithium Nickel Manganese Cobalt (NMC):</strong> Higher energy density, good
              cycle life (3,000-5,000), requires more sophisticated thermal management
            </li>
            <li>
              <strong>Lithium Titanate (LTO):</strong> Very fast charging, exceptional cycle life
              (15,000+), lower energy density, higher cost
            </li>
          </ul>
          <p>
            <strong>Battery Technology Comparison</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>LiFePO4:</strong> 6,000-10,000 — 80-90% — 92-98% — Domestic, commercial
              storage
            </li>
            <li>
              <strong>NMC:</strong> 3,000-5,000 — 80-90% — 90-95% — High energy density needs
            </li>
            <li>
              <strong>Lead-Acid AGM:</strong> 500-1,500 — 50% — 80-85% — Low-cost backup, off-grid
            </li>
            <li>
              <strong>Vanadium Flow:</strong> 20,000+ — 100% — 65-80% — Grid-scale, long duration
            </li>
          </ul>
          <p>
            <strong>Flow Battery Characteristics</strong>
          </p>
          <p>
            Flow batteries store energy in liquid electrolytes in external tanks. Power output is
            determined by the cell stack size, while energy capacity depends on tank volume. This
            allows independent scaling of power (kW) and energy (kWh) - ideal for long-duration
            storage applications where 4-12 hours of discharge is required.
          </p>
          <p>
            <strong>Key consideration:</strong> LiFePO4 has become the dominant technology for UK
            residential and commercial installations due to its safety profile, cycle life, and
            competitive pricing.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Capacity, Power, and System Sizing">
          <p>
            Correct battery sizing requires understanding the relationship between capacity (kWh),
            power (kW), depth of discharge, and the specific application requirements - whether
            maximising self-consumption, providing backup power, or participating in grid services.
          </p>
          <p>
            <strong>Energy Capacity (kWh)</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
          ...
          <p>
            <strong>Self-Consumption Sizing Method</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>1. Daily consumption:</strong> Annual kWh ÷ 365 — 3,650kWh ÷ 365 = 10kWh/day
            </li>
            <li>
              <strong>2. Evening/night load:</strong> Consumption 4pm-8am — Typically 50-70% = 6kWh
            </li>
            <li>
              <strong>3. Target self-consumption:</strong> Evening load × target % — 6kWh × 80% =
              4.8kWh needed
            </li>
            <li>
              <strong>4. Account for DoD:</strong> Required ÷ DoD — 4.8kWh ÷ 0.8 = 6kWh nominal
            </li>
            <li>
              <strong>5. Account for efficiency:</strong> Nominal ÷ efficiency — 6kWh ÷ 0.9 = 6.7kWh
              system
            </li>
          </ul>
          <p>
            <strong>Worked Example: Domestic System Sizing</strong>
          </p>
          <p>
            <strong>Property:</strong> 4-bed house, 4,000kWh annual consumption, 4kWp PV system
          </p>
          <p>
            <strong>Daily consumption:</strong> 4,000 ÷ 365 = 11kWh
          </p>
          <p>
            <strong>Evening/overnight load:</strong> 65% × 11kWh = 7.15kWh
          </p>
          <p>
            <strong>Excess PV available:</strong> Analysis shows ~5kWh surplus on typical summer day
          </p>
          <p>
            <strong>Usable capacity needed:</strong> Minimum 5kWh to capture surplus
          </p>
          <p>
            <strong>Nominal capacity (80% DoD):</strong> 5 ÷ 0.8 = 6.25kWh
          </p>
          <p>
            <strong>Recommendation:</strong> 6-8kWh system with 3kW continuous power rating
          </p>
          <p>
            <strong>Design tip:</strong> Oversizing batteries provides diminishing returns - a
            larger battery may never fully charge in winter when PV output is low.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Charge Controllers and Battery Management">
          <p>
            Charge controllers regulate energy flow between the PV array and batteries, while the
            Battery Management System (BMS) monitors and protects individual cells. Both are
            essential for safe, efficient, and long-lasting battery operation.
          </p>
          <p>
            <strong>MPPT vs PWM Charge Controllers</strong>
          </p>
          ...
          <p>
            <strong>Battery Management System Functions</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Cell voltage monitoring:</strong> Tracks individual cell voltages to detect
              imbalance or failing cells
            </li>
            <li>
              <strong>Cell balancing:</strong> Equalises charge across cells - passive (dissipative)
              or active (energy transfer)
            </li>
            <li>
              <strong>Temperature monitoring:</strong> Multiple sensors detect hotspots and trigger
              cooling or shutdown
            </li>
            <li>
              <strong>Over-charge protection:</strong> Disconnects charging when cells reach maximum
              voltage (4.2V NMC, 3.65V LiFePO4)
            </li>
            <li>
              <strong>Over-discharge protection:</strong> Disconnects load at minimum voltage (2.5V
              NMC, 2.5V LiFePO4)
            </li>
            <li>
              <strong>Short circuit protection:</strong> Fast-acting disconnection for fault
              currents
            </li>
            <li>
              <strong>State of Charge (SoC):</strong> Calculates remaining capacity using coulomb
              counting and voltage correlation
            </li>
            <li>
              <strong>State of Health (SoH):</strong> Tracks capacity degradation over time
            </li>
          </ul>
          <p>
            <strong>Charge Controller Sizing</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Maximum PV voltage:</strong> Voc × number of series modules — Apply cold
              temperature coefficient
            </li>
            <li>
              <strong>Maximum PV current:</strong> Isc × number of parallel strings — × 1.25 for
              irradiance peaks
            </li>
            <li>
              <strong>Controller current rating:</strong> PV power ÷ battery voltage — Select next
              size up
            </li>
          </ul>
          <p>
            <strong>Communication protocols:</strong> Modern BMS units communicate via CAN bus,
            RS485, or Modbus with inverters and monitoring systems, enabling real-time data logging
        ...
        <ConceptBlock title="Safety Requirements and Grid Services">
          <p>
            Battery installations must comply with stringent safety requirements covering fire
            protection, ventilation, and electrical safety. Beyond self-consumption, grid-connected
            batteries can provide valuable services to the electricity network.
          </p>
          <p>
            <strong>Fire Safety Requirements (BS EN 62619, BS 7671)</strong>
          </p>
          <p>
          ...
          <p>
            <strong>Electrical Safety Requirements</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>DC isolation:</strong> Accessible DC isolator between battery and inverter
              rated for DC fault current
            </li>
            <li>
              <strong>Overcurrent protection:</strong> DC-rated fuses or MCBs suitable for battery
              short-circuit current (can exceed 10kA)
            </li>
            <li>
              <strong>Earthing:</strong> Compliant with BS 7671 requirements for PV and battery
              systems
            </li>
            <li>
              <strong>Labelling:</strong> Warning labels indicating battery presence, voltages, and
              isolation points
            </li>
            <li>
              <strong>G98/G99 compliance:</strong> Grid connection requirements for import/export
              functionality
            </li>
          </ul>
          <p>
            <strong>Thermal Runaway Prevention</strong>
          </p>
          <p>
            ...
            temperature range (typically 0-45°C); adequate ventilation; BMS thermal monitoring with
            automatic shutdown; appropriate spacing between cells; and fire-resistant enclosures.
            LiFePO4 chemistry is inherently more resistant to thermal runaway than NMC.
          </p>
          <p>
            <strong>Grid Services Overview</strong>
          </p>
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              <strong>Frequency Response:</strong> Rapid power injection/absorption to stabilise
              grid frequency — &lt;1 second response, high power capability
            </li>
            <li>
              <strong>Peak Shaving:</strong> Reduce demand during peak periods (typically 4-7pm) —
              Predictable load profiles, time-of-use tariffs
            </li>
            <li>
              <strong>Grid Balancing:</strong> Absorb excess renewable generation, release during
              low generation — Large capacity, aggregation platform
            </li>
            <li>
              <strong>Voltage Support:</strong> Reactive power provision for local voltage
              regulation — Inverter capable of reactive power control
            </li>
          </ul>
          <p>
            <strong>Revenue stacking:</strong> Domestic batteries can generate additional income
            through grid services while still prioritising self-consumption - typical earnings range
            from £50-200 per year depending on capacity and services enrolled.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="Worked Examples">
          ...
          <p>
            <strong>Scenario:</strong> Calculate the usable AC energy from a 13.5kWh battery system
            with 90% DoD and 95% inverter efficiency.
          </p>
          <p>Given:</p>
          ...
          <p>
            <strong>Scenario:</strong> A LiFePO4 battery is rated for 6,000 cycles at 80% DoD. If
            cycled once daily, estimate the calendar life.
          </p>
          <p>Given:</p>
          ...
          <p>
            <strong>Scenario:</strong> A 10kWh battery system is discharging at 2.5kW. Calculate the
            C-rate and expected discharge time.
          </p>
          <p>Given:</p>
          ...
          <p>
            <strong>Scenario:</strong> Size an MPPT controller for a 4kWp PV array (10 × 400W panels
            in 2 strings of 5) with 48V battery system.
          </p>
        ...
        <ConceptBlock title="Practical guidance">
          ...
          <ul className="space-y-1.5 list-disc pl-5 marker:text-elec-yellow/70">
            <li>
              LiFePO4 cell voltage: <strong>3.2V nominal</strong> (2.5V-3.65V range)
            </li>
            <li>
              NMC cell voltage: <strong>3.7V nominal</strong> (2.5V-4.2V range)
            </li>
            <li>
              Typical round-trip efficiency: <strong>90-95%</strong> lithium-ion
            </li>
            <li>
              Recommended DoD: <strong>80%</strong> for optimal lifespan
            </li>
            <li>
              Fire separation: <strong>30 minutes</strong> minimum
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <ul className="space-y-1.5 list-disc pl-5 marker:text-orange-400/70">
              <li>
                <strong>Oversizing batteries</strong> - May never fully charge in winter, wasting
                investment
              </li>
              <li>
                <strong>Ignoring temperature range</strong> - Reduces capacity and lifespan outside
                10-35°C
              </li>
              <li>
                <strong>Using AC-rated protection</strong> - DC faults require DC-rated devices
              </li>
              <li>
                <strong>Poor ventilation</strong> - Causes thermal stress and potential fire risk
              </li>
            </ul>
          }
        ...
        <Scenario
          ...
          situation={
            <>
              A homeowner installs a 9.5 kWh NMC chemistry battery in the loft as part of a PV
              upgrade. The work is MCS-signed and Building Control inspected. Six months later the
              home insurance renewal is refused because the insurer has updated their policy to
              exclude NMC batteries in habitable buildings without dedicated fire compartmentation.
            </>
          }
          whatToDo={
            <>
              Re-locate to an outbuilding or garage with fire compartmentation per IET CoP, OR
              replace with a wall-mount LFP unit with manufacturer-rated indoor fire enclosure, OR
              commission a fire risk assessment to insurer requirements (typically uneconomic).
              Document the change for insurance disclosure. Going forward: specify LFP for any
              indoor location and check insurer policy before quoting.
            </>
          }
          whyItMatters={
            <>
              BESS is the fastest-changing area of building services regulation — IET CoP, ABI,
              ABBA, LABC all updating annually. NMC chemistry is becoming uninsurable in residential
              applications. Always specify chemistry, location and fire enclosure to the latest
              standard.
            </>
          }
        />
