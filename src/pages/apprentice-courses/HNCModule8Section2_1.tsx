    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>Air change rate:</strong> Volume replacements per hour (ACH)
              </li>
              <li className="pl-1">
                <strong>Fresh air:</strong> Typically 10 L/s per person for offices
              </li>
              <li className="pl-1">
                <strong>CO2 indicator:</strong> Below 800-1000 ppm for good IAQ
              </li>
              <li className="pl-1">
                <strong>Regulations:</strong> Building Regs Part F, CIBSE Guide B
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
              <li className="pl-1">
                <strong>BMS integration:</strong> CO2 sensors for demand control
              </li>
              <li className="pl-1">
                <strong>Energy efficiency:</strong> Heat recovery systems
              </li>
              <li className="pl-1">
                <strong>System selection:</strong> Natural vs mechanical ventilation
              </li>
              <li className="pl-1">
                <strong>Compliance:</strong> Part F, BREEAM, WELL standards
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              space is replaced per hour. It is a fundamental metric for ventilation system design
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Ceiling height:</strong> Taller spaces may need higher ACH for equivalent
                  air quality
                </li>
                <li className="pl-1">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Based on typical occupancy density
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Higher density, intermittent use
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        CO2 control critical for learning
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Grease, heat, combustion products
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Sterility, anaesthetic gas removal
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">6-10</td>
                      <td className="border border-white/10 px-3 py-2">
                        High metabolic rates, odour control
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Design tip:</strong> Always verify ACH calculations against per-person fresh
              air rates and select the higher value. A low-occupancy space may need more than the
              ACH minimum, whilst a high-occupancy small room may exceed ACH requirements.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white mb-3">
                ...
                non-domestic buildings, fresh air rates are specified based on space type and
                occupancy.
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                CIBSE Guide B Fresh Air Recommendations
              </p>
              <p className="text-sm text-white mb-3">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Domestic Ventilation Requirements (Part F)
              </p>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>VOCs:</strong> Volatile organic compounds from furnishings, cleaning
                  products, paints
                </li>
                <li className="pl-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              ...
              Additional sensors for particulates, VOCs or specific gases may be required depending
              on the application. Healthcare and laboratory environments often need comprehensive
              IAQ monitoring.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Ventilation strategies are selected based on building type, climate, energy
              requirements and indoor environment objectives. The main approaches are natural
              ventilation, mechanical ventilation and mixed-mode systems.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">Natural Ventilation</p>
              <p className="text-sm text-white mb-2">
                Relies on wind pressure and buoyancy (stack effect) to drive airflow through
              ...
              <div className="grid sm:grid-cols-2 gap-4 my-4">
                ...
                <div>
                  ...
                  <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                    ...
                    <li className="pl-1">
                      Limited depth (approximately 2.5× ceiling height single-sided)
                    </li>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5">
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                ...
                <li className="pl-1">
                  <strong>Stack ventilation:</strong> Requires height difference &gt;3m between
                  inlet and outlet
                </li>
                <li className="pl-1">
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white mb-2">
                Uses fans to provide controlled airflow, enabling heat recovery, filtration and
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Mechanical extract with natural supply
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Variable air volume with zone control
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Low-level supply, high-level extract
                      </td>
                      <td className="border border-white/10 px-3 py-2">
                        Atria, theatres, auditoria
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white mb-2">
                Combines natural and mechanical ventilation to optimise comfort and energy
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Key Ventilation Standards and Guidance
              </p>
              <div className="overflow-x-auto">
                <table className="text-sm text-white w-full border-collapse">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Minimum ventilation rates for compliance
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Design temperatures, air quality targets
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Detailed ventilation design guidance
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        IAQ credits, monitoring requirements
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Ventilation criteria for educational buildings
                      </td>
                    </tr>
                    <tr>
                ...
                <table className="text-sm text-white w-full border-collapse">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Stratification improves breathing zone
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="border border-white/10 px-3 py-2">
                        Direct supply to breathing zone
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <div className="space-y-6">
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 1: Office Ventilation Calculation
              </h3>
              <p className="text-sm text-white mb-2">
                <strong>Question:</strong> Calculate the fresh air supply rate for an open-plan
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 2: CO2-Based Ventilation Assessment
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 3: Natural Ventilation Assessment
              </h3>
              <p className="text-sm text-white mb-2">
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 4: Kitchen Extract Sizing
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p className="mt-2">
                  <strong>
                    Step 2: Apply CIBSE recommended ACH (25 ACH for commercial kitchen)
                  </strong>
                </p>
            ...
            <div className="p-4 rounded-lg bg-white/5">
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Example 5: Demand Control Ventilation Savings
              </h3>
              <p className="text-sm text-white mb-2">
              ...
              <div className="bg-black/30 p-3 rounded text-sm font-mono text-white/90">
                ...
                <p>
                  Q_actual = 40 persons × 10 L/s + background = approximately 500 L/s = 0.5 m³/s
                </p>
                <p className="mt-2">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1.5 list-disc list-outside ml-5">
                <li className="pl-1">
                  <strong>Confusing total air with fresh air:</strong> Recirculated air does not
                  count towards outdoor air requirements
                </li>
                <li className="pl-1">
                  <strong>Ignoring ventilation effectiveness:</strong> Poor diffuser placement
                  reduces actual delivered air quality
                </li>
                <li className="pl-1">
