            ...
            <SheetHeader className="px-4 pb-4 border-b border-border">
              <div className="flex items-start justify-between">
                ...
                <Select
                  ...
                  onValueChange={(v) => selectedTicket && updateStatusMutation.mutate({ id: selectedTicket.id, status: v })}
                >
                  <SelectTrigger className="w-[130px] h-9 touch-manipulation">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="open">Open</SelectItem>
              ...
              <Card>
                <CardContent className="pt-4 pb-4">
                  <p className="text-xs text-muted-foreground mb-2">
                    {selectedTicket?.created_at && format(new Date(selectedTicket.created_at), "dd MMM yyyy HH:mm")}
                  </p>
                    ...
                    <div className="flex items-center gap-2 mb-2">
                      <p className="text-xs font-medium">
                        ...
                        {response.is_admin_response && (
                          <Badge className="ml-2 bg-blue-500/20 text-blue-400 text-[10px]">Admin</Badge>
                        )}
                      </p>
