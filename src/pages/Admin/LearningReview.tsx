...
interface LearningSuggestion {
  ...
  suggested_knowledge_update: any;
...
export default function LearningReview() {
  ...
  const handleApprove = async (suggestion: LearningSuggestion) => {
    ...
    try {
      const knowledgeUpdate = suggestion.suggested_knowledge_update;

      // Insert into appropriate knowledge base  
      const tableName = getKnowledgeTableName(suggestion.agent_name);
      
      // Use appropriate type assertion for knowledge base tables
                      ...
                      {editingId === suggestion.id ? (
                        ...
                        <div className="text-sm">
                          <p className="font-semibold">
                            {suggestion.suggested_knowledge_update?.topic}
                          </p>
                          <p className="text-muted-foreground line-clamp-2">
                            {suggestion.suggested_knowledge_update?.content}
                          </p>
                        </div>
                      )}
                    </TableCell>
