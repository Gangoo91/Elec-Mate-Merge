  ...
  return (
    <div className="space-y-6">
      ...
      <Alert className="bg-yellow-900/20 text-yellow-500 border-yellow-500/30 mb-4">
        ...
        <AlertDescription>
          These settings are for demonstration purposes. In a real implementation, these would be
          connected to your application's backend and persisted in a database.
        </AlertDescription>
      </Alert>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch checked={maintenanceMode} onCheckedChange={handleToggleMaintenanceMode} />
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-400">Clear all system caches</p>
                  </div>
