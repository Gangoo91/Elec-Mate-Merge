  ...
  return (
    <div className="bg-gradient-to-b from-elec-dark via-elec-grey to-elec-dark flex flex-col">
        ...
        <div className="bg-elec-yellow/20 border-b border-elec-yellow/40 px-4 py-2 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm text-elec-light">
              <strong>Example room loaded!</strong> Click <strong>AI Room Builder</strong> in the
              header to create your own.
            </p>
          </div>
          <Button
            variant="ghost"
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
        ...
        <PropertiesPanel selectedObject={selectedObject} onUpdate={handleObjectUpdate} />
      </div>
