            ...
            <AccordionContent className="px-4 pb-4">
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                <Card className="border-elec-yellow/20 bg-elec-dark">
                  ...
                  <CardContent>
                    <Button className="w-full" onClick={() => handleAction('View Dashboard')}>
                      View Dashboard
                    </Button>
                  </CardContent>
                </Card>
                ...
                <Card className="border-elec-yellow/20 bg-elec-dark">
                  ...
                  <CardContent>
                    <Button className="w-full" onClick={() => handleAction('View Growth Trends')}>
                      View Trends
                    </Button>
                  </CardContent>
                </Card>
            ...
            <AccordionContent className="px-4 pb-4">
              <Card className="border-elec-yellow/20 bg-elec-dark">
                <CardHeader>
                  ...
                  <CardDescription>
                    Analyse job completion time, customer satisfaction, and efficiency
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
            ...
            <AccordionContent className="px-4 pb-4">
              <Card className="border-elec-yellow/20 bg-elec-dark">
                <CardHeader>
                  ...
                  <CardDescription>
                    Analyse client retention, acquisition, and lifetime value
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <Button className="w-full" onClick={() => handleAction('View Client Analysis')}>
                      View Analysis
                    </Button>
                  </div>
                </CardContent>
