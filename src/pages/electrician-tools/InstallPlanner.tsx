    ...
    switch (currentStep) {
      case 4: // Environment step
        if (planData.designMode === 'multi') {
          console.log(
            'Validating Environment step for multi-circuit mode:',
      ...
      case 5: // Environment step for single circuit mode
        if (planData.designMode === 'single') {
          console.log(
            'Validating Environment step for single-circuit mode:',
            planData.environmentalSettings
          );
    ...
    switch (currentStep) {
      ...
      case 3:
        if (planData.designMode === 'multi') {
          return (
            planData.circuits &&
            planData.circuits.length > 0 &&
            planData.circuits.some((c) => c.enabled)
          );
        }
            ...
            <Card className="border-green-500/30 bg-card shadow-lg">
              <CardContent className="p-6 sm:p-8">
                <div className="text-center space-y-4">
                  ...
                  <h3 className="font-bold text-green-400 text-xl sm:text-2xl">
