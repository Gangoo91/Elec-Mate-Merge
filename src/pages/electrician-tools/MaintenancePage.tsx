...
import MaintenanceSpecialistInterface from '@/components/electrician-tools/maintenance-specialist/MaintenanceSpecialistInterface';
      ...
      >
        {!fromSavedResults && (
          ...
          >
            ...
            >
              <span className="text-elec-yellow">Maintenance</span>{' '}
            ...
            >
              Brief the asset. Get a formal maintenance method statement with isolation, testing,
              EICR observations and a printable hand-over pack — grounded in BS 7671.
            </motion.p>
        ...
        <motion.section variants={itemVariants}>
          <MaintenanceSpecialistInterface />
        </motion.section>
      </motion.main>
    </div>
  );
