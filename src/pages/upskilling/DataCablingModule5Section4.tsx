    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The PoE section. IEEE 802.3 Types 1 through 4, Classes 0 through 8, the BS
          7671:2018+A4:2026 §716 regulatory cap of 750 mA per conductor (and 750 mA per contact at
          the connector), the SELV/PELV mandate, the special-location restrictions, the cable
          category list, LP-rated cable for bundle thermal management, and how PoE current changes
          the data-channel performance equation from 15 April 2026.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              <strong>Type 1 — IEEE 802.3af (2003), original PoE.</strong> 15.4 W PSE max / 12.95 W
              PD max. 2-pair power delivery. Classes 0-3. Voltage 44-57 V at PSE. Used historically
              for IP phones, basic IP cameras, low-power APs. Still widely deployed.
            </li>
            <li>
            ...
            <li>
              ...
              per-conductor current at a given total wattage). Classes 5-6. Voltage 50-57 V at PSE.
              Used for high-density APs, PTZ cameras, larger LED lighting, building-automation
              gateways.
            </li>
            <li>
          ...
          <p>
            The Class system inside the Types is how the PSE and PD negotiate power delivery. The PD
            signals its Class during link-up; the PSE provides the corresponding power budget. A
            Class 4 PD on a Type 4 PSE gets only 30 W (the Class 4 ceiling), not 90 W — the PSE caps
            at the Class. This is why a "Type 4 PSE" gives flexibility to power any Class up to 8.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <br />
              (a) power sourcing equipment (PSE) conforming to BS EN IEC 62368-1 and BS EN 60950-22
              in addition to the interoperability requirements of ISO/IEC/IEEE DIS 8802-3:2024; or
              <br />
              ...
              <br />
              NOTE 1: Where PELV is used mitigation measures may be required to limit the sharing of
              LV fault currents in accordance with BS EN 50310 and BS IEC 61000-5-2.
              Exposed-conductive-parts of ELV DC power equipment (such as PoE switches or
              converters) can be connected by a protective conductor to the main earthing terminal.
              <br />
        ...
        <RegsCallout
          ...
          clause={
            <>
              The connecting hardware used for data cables used to distribute DC power shall comply
              with BS ISO/IEC 11801-1 and support a continuous operating current of{' '}
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              <strong>LP (Limited Power) cable rating.</strong> Manufacturer declaration of maximum
              continuous current per conductor that the cable insulation tolerates without exceeding
              its rated temperature in a specified bundle size and ambient. Specify LP-rated cable
              for any PoE-everything build, and any installation with sustained Type 3 / Type 4 in
              bundles &gt; 12 cables.
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              IEEE 802.3bt spec, notes 90 W PSE / 71.3 W PD across four pairs, buys cable to general
              Cat 6A spec (no LP rating), bundles 24 cables tightly into a single containment,
              installs without bundle thermal modelling. Channel certifies to Class EA marginal pass
              at install. Six months in, under continuous PoE Type 4 load and high ambient, the
              bundle interior reaches 60 °C, the data channels degrade, intermittent link failures
              spread across the AP fleet, and on inspection the contractor discovers some conductors
              are running close to or above 750 mA — non-compliant under §716.523.2.101.
              Remediation: re-design with bundle-size cap, LP-rated cable, separate containment,
              re-certify with comfortable margins.
            </>
          }
          doInstead={
            <>
              Treat BS 7671 §716 as the binding regulatory ceiling, not the IEEE figures. Design to:
              (1) per-conductor design current ≤ 750 mA in worst-case (§716.523.2.101); (2)
        ...
        <Scenario
          ...
          situation={
            <>
              A new build with full PoE-LED lighting throughout. The lighting designer specs Cat 6A
              shielded cable (S/FTP) running back to a centralised PoE switch. The installer asks
              the electrician to terminate the cable screens onto the comms-room main earthing
              busbar to "ensure a good earth path".
            </>
          }
          whatToDo={
            <>
              Two BS 7671 references govern. (1) §716.414.1.1 NOTE 2 verbatim: "The screen/shielding
              of the communications cabling provides functional earthing and it is not suitable for
              limiting the sharing of LV fault currents." So the screen IS functional earthing —
              bonded to the equipotential bonding network per BS EN 50310 and §444.5.3.1(a) — but is
              NOT a protective earth path for fault currents. (2) §545 (ICT functional earthing —
              entirely new in A4:2026) governs the functional bonding network, the MFET (main
              functional earthing terminal), and the 2.5 / 4 mm² Cu minimum CSAs for functional
              earthing conductors. The correct termination is screen → keystone shield earth → patch
              panel chassis earth → rack earth → MFET → MET. NOT a separate cable from each screen
              end to the comms-room earth bar — that creates earth loops that pump LV fault current
              through the screens (which is what NOTE 2 explicitly says they are NOT for). Specify
              it correctly per §545 / BS EN 50310, document it in the BS EN 50174-1 administration
              record, and cross-check the bonding network against the building protective bonding
              under §444.1.
            </>
          }
          whyItMatters={
            <>
              Screen-bonding errors on shielded PoE installations are one of the most common EMC and
              fault-current problems in commercial buildings. Done wrong, the screens become a
              fault-current path between distant earth points, pumping current that produces
              interference, degrades data, and in extreme cases damages active equipment. Done right
              per §545 + BS EN 50310, the screens are the functional-earth reference for EMC
