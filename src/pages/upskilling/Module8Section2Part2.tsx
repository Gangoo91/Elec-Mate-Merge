      ...
      <div className="px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8 pb-8 sm:pb-12">
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-between">
            <Link to="/study-centre/upskilling/inspection-testing-module-8-section-2-part-1">
              <Button variant="outline" className="border-gray-600 text-white hover:bg-card min-h-[48px]">
                <ArrowLeft className="mr-2 h-4 w-4" />
                Previous: Test Preparation
              </Button>
            </Link>
            <Link to="/study-centre/upskilling/inspection-testing-module-8-section-2-part-3">
