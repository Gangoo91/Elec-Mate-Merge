...
const inlineChecks = [
  {
    ...
    options: [
      'Wood pellet, log and wood chip boilers, plus biomass-CHP variants under Section 551',
      'Only wood-log manual-feed appliances, with no automatic-feed pellet or chip boilers in use',
      'Solar thermal collectors and air-source heat pumps marketed under the biomass label',
      'Open-fire room heaters only, with no whole-building biomass boilers available on the market',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A pure plumbing job with no electrical supply terminated by the electrician at all',
      'A standard 13 A fused-spur supply shared with the existing kitchen ring final circuit',
      'A dedicated 16 A circuit for the auger, fans, ignition and controls, with RCD and thermal protection',
      'A three-phase 32 A supply, because the auger and fans together demand a balanced load',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It only governs RCD selection for the boiler supply circuit, not any thermal effects',
      'It applies solely to outdoor installations and never inside a building boiler room',
      'It requires a fixed 1 m clearance from any wall, regardless of the building construction',
      'In CA2 (combustible) buildings it adds Section 421 — clearances, fire-resistance and flue protection',
    ],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Smoke Control Areas only restrict open coal fires, never biomass pellet or log boilers',
      'In an SCA only a DEFRA-exempt appliance may legally burn biomass, so the boiler model must be checked and documented at quote stage',
      'Any biomass boiler is allowed in an SCA provided an RCD protects the supply circuit',
      'Smoke Control Areas exist only in Scotland and never apply in England or Wales',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'A single plumber handles the whole job, including the electrical supply and its certification',
      'A general builder installs the boiler and self-certifies the electrical work under Part P',
      'A multi-trade install — dedicated circuit, Reg 422.4, cable thermal protection and SCA checks',
      'Only an MCS company is needed, covering combustion, hydraulics and electrics all in-house',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Standard 70 °C PVC cable is always adequate next to the flue with no protection',
      'Only the boiler casing matters; the flue stays at room temperature in operation',
      'Reg 522.2.1 only governs cables in the ground, not cables near hot equipment',
      'The flue exceeds 250 °C and cabling runs through elevated-temperature zones, so Reg 522.2.1 requires shielding, distance or thermally rated cable',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A log boiler has no auger and a bigger store; a pellet boiler adds an auger and draws a little more',
      'A log boiler needs a bigger auger motor than a pellet boiler, so it draws more current overall',
      'A log boiler requires a three-phase supply while a pellet boiler runs on single-phase only',
      'A pellet boiler has no electrical components at all, so only the log boiler needs a circuit',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A single HETAS registration covers both the combustion side and the electrical certification',
      'The BS 7671 electrician self-certifies the flue and the combustion side under Part P',
      'HETAS covers combustion and flue; the electrician covers the supply circuit — two distinct competencies',
      'The DNO inspects and signs off both the combustion side and the electrical side of the install',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Install the customer chosen boiler regardless, since SCA enforcement rarely actually happens',
      'Fitting an RCD on the supply circuit is enough to make any boiler legal within an SCA',
      'Only the fuel supplier, not the installer, needs to consider SCA emission restrictions',
      'Verify the SCA status and DEFRA exempt list; if not exempt in an SCA the install is illegal',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It adds a second flue but no electrical generation, so Section 551 still does not apply',
      'It adds electrical generation, so Section 551 applies — anti-islanding per Reg 551.7.5 and EREC G98/G99 depending on output',
      'It generates electricity but, being off-grid by design, never needs DNO notification',
      'It only changes the fuel grade required, leaving the electrical scope identical to heat-only',
    ],
    correctAnswer: 1,
    explanation:
