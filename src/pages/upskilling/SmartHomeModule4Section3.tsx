...
const DESCRIPTION =
  'Understand environmental monitoring sensors and their integration with smart home systems for improved health, comfort, and building protection.';
...
const quickCheckQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      '40-60% relative humidity is considered optimal for human health and comfort. Below 40% causes dry skin and respiratory irritation; above 60% promotes mould growth and dust mites.',
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Studies show cognitive performance begins to decline when CO2 levels exceed 800-1000 ppm. Outdoor air is typically around 400 ppm, so indoor levels should be kept as close to this as practical.',
  },
  {
    ...
    options: [
      ...
      'Ventilation Optimisation Circuit',
      'Volume Of Contamination',
    ],
    correctAnswer: 1,
    explanation:
      'VOC stands for Volatile Organic Compound - chemicals that evaporate at room temperature from sources like paints, cleaning products, and furniture, potentially affecting health and air quality.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Humidity sensors can automatically control bathroom extractor fans, running them when humidity rises after showering and stopping when levels return to normal, preventing condensation and mould.',
  },
  {
...
const faqs = [
  {
    ...
    answer:
      'Most consumer-grade sensors are factory calibrated and do not require user calibration. CO2 sensors typically have automatic baseline calibration that assumes the sensor will see fresh air (400 ppm) at least once per week. Professional sensors may need periodic recalibration, typically annually.',
  },
  {
    question: 'Can environmental sensors trigger HVAC systems directly?',
    answer:
      'With proper integration, yes. Smart home platforms can use sensor data to control HVAC systems. For example, high humidity can boost bathroom extraction, high CO2 can increase ventilation rates, and poor air quality can trigger air purifiers or close windows near busy roads.',
  },
  {
    question: 'Where should I position indoor air quality sensors?',
    answer:
      'Position sensors at breathing height (1.2-1.5m) away from direct airflow, windows, and doors. Avoid placing near known pollution sources like cookers or printers. For whole-house monitoring, place sensors in regularly occupied rooms like living rooms and bedrooms.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-3xl mx-auto">
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Relative humidity significantly affects both occupant comfort and building health. Smart
            humidity sensors enable automated control of ventilation and dehumidification.
          </p>
          <div className="space-y-3 mb-4">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <h4 className="font-medium text-elec-yellow mb-2">Health Impacts</h4>
              <p className="text-white text-sm">
                Low humidity (below 40%) dries out mucous membranes, increasing susceptibility to
                respiratory infections. High humidity (above 60%) promotes mould growth, dust mites,
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-white text-sm">
                Sustained high humidity causes condensation on cold surfaces, leading to mould
                growth, timber decay, and damage to decorations. Monitoring humidity enables early
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            CO2 levels indicate ventilation adequacy. As occupants breathe, CO2 accumulates indoors.
            Elevated levels indicate insufficient fresh air and correlate with reduced cognitive
            performance and occupant discomfort.
          </p>
          <div className="space-y-4 mb-4">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <ul className="space-y-2 text-white text-sm">
                <li>
                  <span className="text-elec-yellow">400 ppm:</span> Outdoor baseline (fresh air)
                </li>
                <li>
                  <span className="text-elec-yellow">600-800 ppm:</span> Good indoor air quality
                </li>
                <li>
                  <span className="text-elec-yellow">800-1000 ppm:</span> Acceptable, cognitive
                  effects begin
                </li>
                <li>
                  <span className="text-elec-yellow">1000-1500 ppm:</span> Poor - increased
                  ventilation needed
                </li>
                <li>
                  <span className="text-elec-yellow">Above 1500 ppm:</span> Very poor - significant
                  health impact
                </li>
              </ul>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm">
                CO2 sensors are particularly valuable in bedrooms (overnight accumulation), meeting
                rooms (rapid rise with multiple occupants), classrooms, and any space with variable
                occupancy. They provide objective data for ventilation control and highlight when
                windows should be opened or MVHR boosted.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Beyond CO2 and humidity, comprehensive air quality monitoring includes particulate
            matter, volatile organic compounds, and specific pollutants.
          </p>
          <div className="space-y-3">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <h4 className="font-medium text-elec-yellow mb-2">Particulate Matter (PM2.5/PM10)</h4>
              <p className="text-white text-sm">
                Fine particles from cooking, dust, pollen, and outdoor pollution. PM2.5 (particles
                under 2.5 microns) is most concerning as it penetrates deep into the respiratory
                system. WHO guidelines suggest below 15 micrograms per cubic metre annual average.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-white text-sm">
                Gases released from paints, furniture, cleaning products, and building materials.
                Common VOCs include formaldehyde, benzene, and toluene. New builds and recently
                decorated spaces often have elevated VOC levels.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <h4 className="font-medium text-elec-yellow mb-2">Radon</h4>
              <p className="text-white text-sm">
                Radioactive gas from ground decay, a significant lung cancer risk. Certain areas of
                the UK have elevated radon levels. Specialist sensors are required for accurate
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm">
                Bathroom and kitchen extractors can be triggered automatically when humidity rises,
                running until levels return to normal. This ensures effective moisture removal
                without wasting energy through continuous operation.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-elec-yellow mb-2">CO2-Based Ventilation</h4>
              <p className="text-white text-sm">
                MVHR systems can increase fan speed when CO2 exceeds threshold levels, providing
                fresh air on demand. This is more efficient than constant maximum ventilation and
                responds to actual occupancy.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-elec-yellow mb-2">Air Quality Response</h4>
              <p className="text-white text-sm">
                When outdoor air quality is poor (high PM2.5), smart systems can reduce natural
                ventilation and rely on filtered mechanical systems. Conversely, when indoor VOCs
                are high, increased ventilation helps dilute pollutants.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Choosing the right sensors and positioning them correctly is essential for accurate
            monitoring and useful data.
          </p>
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            ...
            <ul className="text-white text-sm space-y-1">
              <li>
                <span className="text-elec-yellow">Living room:</span> Primary occupied space,
                general monitoring
              </li>
              <li>
                <span className="text-elec-yellow">Bedrooms:</span> Overnight CO2 and humidity
                tracking
              </li>
              <li>
                <span className="text-elec-yellow">Kitchen:</span> Humidity and particulate
                monitoring
              </li>
              <li>
                <span className="text-elec-yellow">Bathroom:</span> Humidity for extraction control
              </li>
            </ul>
          </div>
        </section>
