...
const faqs = [
  {
    ...
    answer:
      'BS 7671 requires SPD protection for circuits supplying equipment with rated impulse withstand voltage less than 2.5kV. Most EV chargers contain sensitive electronics requiring protection, particularly in areas with high lightning activity.',
  },
  {
    question: 'Can I use domestic SPDs for commercial EV chargers?',
    answer:
      "Commercial installations typically require higher capacity SPDs due to increased power levels and exposure. Use SPDs rated appropriately for the installation's expected fault levels and energy requirements.",
  },
  {
    question: 'How do I coordinate SPDs with RCD protection?',
    answer:
      'SPDs can cause temporary earth leakage during operation. Use Type A or Type B RCDs suitable for EV charging, and ensure SPD leakage characteristics are considered in RCD selection and discrimination.',
  },
  {
    question: 'What maintenance do SPDs require?',
    answer:
      'Regular visual inspection for damage, checking status indicators, verifying connection tightness, and testing isolation facilities. Replace SPDs when indicators show degradation or after significant surge events.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'A coastal EV charging hub with 150kW rapid chargers requires surge protection. What SPD configuration is most appropriate?',
    options: [
...
const EVChargingModule4Section5 = () => {
  useSEO({
    ...
    description:
      'Learn to protect EV charging systems from electrical surges and lightning strikes. Covers SPD selection, installation, coordination, and BS 7671 requirements.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Type 1:</strong> Direct lightning (10/350μs test)
              </li>
              <li>
                <strong>Type 2:</strong> Indirect surges (8/20μs test)
              </li>
              <li>
                <strong>Lead length:</strong> &lt;0.5m total for effectiveness
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> DIN rail SPD with green/red indicator
              </li>
              <li>
                <strong>Use:</strong> Multi-stage coordination for full protection
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Iimp:</strong> 12.5kA to 25kA typical
                  </li>
                  <li>
                    <strong>Location:</strong> Service entrance
                  </li>
                  <li>
                    <strong>Technology:</strong> Spark gap, gas discharge
                  </li>
                  <li>
                    <strong>Use:</strong> Buildings with external LPS
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>In:</strong> 5kA to 40kA typical
                  </li>
                  <li>
                    <strong>Location:</strong> Distribution boards
                  </li>
                  <li>
                    <strong>Technology:</strong> Metal oxide varistor
                  </li>
                  <li>
                    <strong>Response:</strong> &lt;25ns fast response
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              SPD effectiveness depends critically on installation quality. Short lead lengths and
              proper earthing are essential for adequate protection.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Lead length:</strong> &lt;0.5m total
                  </li>
                  <li>
                    <strong>Cable routing:</strong> Avoid loops
                  </li>
                  <li>
                    <strong>Type 1 cable:</strong> Minimum 16mm²
                  </li>
                  <li>
                    <strong>Type 2 cable:</strong> Minimum 2.5mm²
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Stage spacing:</strong> Minimum 10m
                  </li>
                  <li>
                    <strong>Alternative:</strong> Decoupling inductors
                  </li>
                  <li>
                    <strong>Backup:</strong> MCB for each SPD
                  </li>
                  <li>
                    <strong>Monitoring:</strong> Status indication
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Single charger:</strong> Type 2 at DB + integrated Type 3
                </li>
                <li>
                  <strong>Multiple chargers:</strong> Type 1+2 at incomer + Type 2 at sub-DB
                </li>
                <li>
                  <strong>Rapid charging:</strong> Enhanced Type 1 + DC SPDs + signal protection
                </li>
                <li>
                  <strong>Exposed location:</strong> Multi-stage with comprehensive earthing
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Regular inspection and testing ensures SPD systems remain effective. SPDs degrade over
              time and must be replaced when indicators show failure.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Insulation:</strong> Between terminals and earth
                  </li>
                  <li>
                    <strong>Continuity:</strong> All earth connections
                  </li>
                  <li>
                    <strong>Backup:</strong> MCB operation verified
                  </li>
                  <li>
                    <strong>Indication:</strong> Status display tested
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Monthly:</strong> Visual inspection
                  </li>
                  <li>
                    <strong>Quarterly:</strong> Connection checks
                  </li>
                  <li>
                    <strong>Annually:</strong> Full testing, thermal imaging
                  </li>
                  <li>
                    <strong>Post-storm:</strong> Immediate inspection
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Local indicators:</strong> LED displays, mechanical flags
                </li>
                <li>
                  <strong>Remote monitoring:</strong> Dry contacts for BMS integration
                </li>
                <li>
                  <strong>Smart SPDs:</strong> Digital communication interfaces
                </li>
                <li>
                  <strong>Trending:</strong> Monitor leakage current for degradation
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Long leads:</strong> — Reduces protection effectiveness
                </li>
                <li>
                  <strong>No backup MCB:</strong> — SPD failure could cause fire
                </li>
                <li>
                  <strong>Wrong rating:</strong> — Under-rated SPDs fail prematurely
                </li>
                <li>
                  <strong>Ignoring indicators:</strong> — Failed SPDs provide no protection
                </li>
              </ul>
            </div>
          </div>
