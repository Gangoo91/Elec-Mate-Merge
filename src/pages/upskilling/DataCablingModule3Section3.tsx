    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Fibre termination practice — fusion vs mechanical splice, pre-polished and
          fusion-splice-on field connectors, cleaver geometry, splice loss budgets, pigtails vs
          patch cords, and the discipline of inspect-clean-cleave-splice-protect that delivers
          low-loss, long-life terminations.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              fibres fuse into a continuous filament. Loss typically 0.05-0.1 dB (SM) or 0.1-0.2 dB
              (MM). Splice protector applied immediately, then laid into a splice tray. Long-term
              reliability is essentially the cable\u2019s — the splice is continuous glass.
            </li>
            <li>
              <strong>Mechanical splice.</strong> Cleaved fibres are inserted into opposite ends of
              a small mechanical fixture (typically 60 mm long), which uses precision V- grooves and
              (often) an index-matching gel to align the cores. A clamp or wedge holds the
              alignment. Loss typically 0.1-0.2 dB. Service life shorter than fusion — gel can dry
              out, mechanical components can shift over decades. The fixture itself is consumable.
            </li>
          </ul>
          <p>
            Both technologies require a clean perpendicular cleave on each fibre — cleave quality is
            decisive for either method. A fusion splicer with poor cleaves splices with elevated
            loss; a mechanical splice with poor cleaves has unstable alignment. Cleave first, splice
            second.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              tray, fusion-splice each field fibre to a factory-polished pigtail, sleeve the splice
              with a heat-shrink protector, lay into the tray, plug the pigtail into the patch panel
              adapter. Total loss per termination: ~0.05-0.1 dB splice + 0.2-0.5 dB connector pair.
              Service life: cable lifetime. The professional default.
            </li>
            <li>
            ...
            <li>
              <strong>Pre-polished mechanical-splice connector.</strong> Field-installable connector
              with an internal factory-polished fibre stub and an internal mechanical splice
              (gel-filled aligner). Cleave the field fibre, insert, clamp. Total loss ~0.3-0.5 dB.
              No splice tray, no fusion splicer. Quickest field option but shorter service life and
              higher loss than FSOC.
            </li>
            <li>
              <strong>Traditional epoxy-and-polish field connector.</strong> Cleave, glue with
              two-part epoxy into the connector, cure (heat or ambient), hand-polish through graded
              grit on a polish puck, inspect. 10-15 minutes per connector, high skill requirement,
              widely variable consistency. Mostly obsolete; replaced by FSOC and pre-polished
              mechanical-splice for new work.
            </li>
          </ul>
          <p>
            Patch cords (double-ended) are not a "termination method" in the same sense — they are
            factory-finished interconnect cables that plug into both ends of an already- terminated
            cabling system. Their job is to interconnect the fixed cabling with the active
            equipment.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              equivalent) before laying into the tray. Cable identification and the as-built record
              shall include the splice locations and the splice tray layouts.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              cleavers have multiple angular positions on a rotational blade — advance the blade to
              a fresh position when cleave quality drops, replace the blade per manufacturer
              guidance.
            </li>
            <li>
            ...
            <li>
              ...
              stripped to a specific length before insertion — too long or too short throws off the
              clamp / V-groove geometry. Use the cleaver\u2019s fixture or a tape measure.
            </li>
          </ul>
          <p>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Fibre attenuation:</strong> link length (km) × cable attenuation (dB/km). For
              OS2 single-mode at 1310 nm: 0.4 dB/km maximum specification (typically 0.32-0.38 dB/km
              in practice). For OM4 multimode at 850 nm: ~3.5 dB/km. At 1300 nm multimode is around
              1.5 dB/km.
            </li>
            <li>
              <strong>Splice loss:</strong> 0.05-0.1 dB per fusion splice (SM or MM), 0.1-0.2 dB per
              mechanical splice. Multiply by the number of splices in the link.
            </li>
            <li>
              <strong>Connector-pair loss:</strong> 0.2-0.5 dB per mated connector pair (clean,
              inspected). Multiply by the number of connector pairs in the channel — usually 4 (one
              at each end of the field cable, plus patch leads at each end), but count carefully.
            </li>
          </ul>
          <p>
            Add a small budget headroom (typically 1 dB) for ageing, future patching, minor
            contamination. Test against the budget at commissioning. If you exceed budget, you have
            a problem — usually a contaminated connector or a marginal splice.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              BEFORE mating. Clean if not pass. Re-inspect. Mate. Document the inspection result in
              the as-built record. The five minutes per connector is not optional — it is the
        ...
        <Scenario
          ...
          situation={
            <>
              A new campus job. 280 m OS2 single-mode fibre run between buildings, two intermediate
              hand-hole splice closures along the duct route. The fibre will carry 10GBASE-LR
              (single-mode 1310 nm) initially, with capacity for 25GBASE-LR upgrade in 5 years. You
              are the design / install lead.
            </>
          }
          whatToDo={
            <>
              Calculate the link budget at 1310 nm: fibre attenuation 0.28 km × 0.4 dB/km = 0.11 dB;
              splice loss 4 fusion splices × 0.1 dB = 0.4 dB (one splice at each hand-hole, plus one
              at each building termination); connector-pair loss 2 mated pairs × 0.4 dB = 0.8 dB;
              total ~1.3 dB. 10GBASE-LR has a 6.2 dB transceiver budget for OS2 — the link sits well
              inside, with comfortable headroom for 25GBASE-LR upgrade. Specify pigtailed-fusion at
              each building termination, fusion splice in hand-hole closures with mechanical
              protection and bend-radius compliance, and bidirectional OTDR commissioning to capture
              every splice and connector. Specify metal-free OS2 outside-plant cable (BS 7671
              §444.4.9 — verbatim — prefers metal-free fibre between buildings). Document the
              as-built with splice locations, tray layouts, connector polish grade, OTDR traces, and
              the calculated link budget.
            </>
          }
          whyItMatters={
            <>
              ...
              §444.4.9 inter-building bonding concern. Bidirectional OTDR commissioning captures the
              link signature at day one, so any future drift can be diagnosed against a known
              baseline. The as-built record is what makes the link maintainable in 5, 10, 15 years.
              The 1.3 dB budget vs the 6.2 dB transceiver budget gives headroom for ageing, future
              patching, and the 25GBASE-LR upgrade.
            </>
          }
        />
