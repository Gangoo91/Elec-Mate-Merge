    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white">Reliable fibre joining methods and quality targets</p>
        </header>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent">
                ...
                <p className="text-white text-xs">Remove coating</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">Clean</p>
                <p className="text-white text-xs">IPA + lint-free</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">Cleave</p>
                <p className="text-white text-xs">&lt;0.5° angle</p>
              </div>
            </div>
          </div>
        </section>
