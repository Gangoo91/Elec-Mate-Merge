...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Fail-safe output means the sensor provides a predetermined safe state (like 0mA or high alarm) when it fails, allowing the control system to take appropriate safety action.',
  },
  {
    id: 9,
