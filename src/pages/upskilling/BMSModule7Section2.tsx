...
const faqs = [
  {
    ...
    answer:
      'AND logic requires ALL conditions to be true for output, while OR logic only requires ANY one condition to be true. AND is used for safety interlocks, OR for multiple triggers.',
  },
  {
    question: 'Why is PID control used instead of simple on/off switching?',
    answer:
      'PID provides smooth, precise control that maintains setpoints without oscillation. Simple on/off causes hunting and overshoots. PID is essential for temperature and pressure control.',
  },
  {
    question: 'Why are electricians involved in programming tests?',
    answer:
      'To verify that programmed logic matches physical installation, test physical responses, and confirm safety interlocks work correctly. Programming must align with actual wiring.',
  },
  {
    question: 'What happens if PID parameters are incorrectly tuned?',
    answer:
      'Incorrect tuning causes oscillation (hunting around setpoint), slow response, or overshoot. Proper tuning requires testing during commissioning with actual building loads.',
  },
];
...
const BMSModule7Section2 = () => {
  useSEO({
    ...
    description:
      'Learn BMS programming methods including function blocks, Boolean logic (AND/OR/NOT), and PID control for Building Management Systems.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white">Function blocks, Boolean logic, and PID control</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Function blocks:</strong> Visual graphical programming
              </li>
              <li>
                <strong>Boolean:</strong> AND/OR/NOT logic decisions
              </li>
              <li>
                <strong>PID:</strong> Proportional, Integral, Derivative control
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Logic diagrams in control schematics
              </li>
              <li>
                <strong>Use:</strong> Verify interlock logic during commissioning
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Function blocks are <strong>graphical building blocks</strong> used to create control
              logic. They represent specific functions that process inputs and generate outputs,
              making complex sequences easier to understand.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Boolean logic uses <strong>True (1) and False (0)</strong> as its two basic states.
              These binary conditions form the foundation of all digital decision-making in BMS
              systems.
            </p>
            ...
            <div className="grid sm:grid-cols-3 gap-4 my-6">
              <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
                ...
                <p className="text-sm text-white">
                  ALL conditions must be true for output to be true. Used for safety interlocks
                  where every requirement must be met.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
                <p className="text-sm font-medium text-green-300 mb-2">OR Logic</p>
                <p className="text-sm text-white">
                  ANY one condition being true gives true output. Used for multiple triggers or
                  alternative start conditions.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-purple-500/10 border border-purple-500/20">
                <p className="text-sm font-medium text-purple-300 mb-2">NOT Logic</p>
                <p className="text-sm text-white">
                  Inverts the input signal. True becomes False, False becomes True. Used for "if NOT
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
              ...
              <p className="text-sm text-white">
                Fan runs ONLY when: (System Enabled) AND (NOT Fire Alarm) AND (Flow Switch OK). If
                any condition fails, the fan stops - this is why AND logic is critical for safety.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              PID control stands for <strong>Proportional, Integral, Derivative</strong> - a
              mathematical approach that provides smooth, precise control of analog outputs like
              valve positions or fan speeds.
            </p>
            ...
            <div className="grid sm:grid-cols-3 gap-4 my-6">
              <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
                ...
                <p className="text-sm text-white">
                  Reacts to current error. Larger error = larger correction. Provides immediate
                  response but can leave residual offset.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
                <p className="text-sm font-medium text-green-300 mb-2">Integral (I)</p>
                <p className="text-sm text-white">
                  Accumulates error over time. Gradually increases output to eliminate steady-state
                  offset. Corrects long-term drift.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-purple-500/10 border border-purple-500/20">
                <p className="text-sm font-medium text-purple-300 mb-2">Derivative (D)</p>
                <p className="text-sm text-white">
                  Reacts to rate of change. Anticipates future error based on trend. Helps prevent
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
              ...
              <p className="text-sm text-white">
                Setpoint: 21°C. Actual: 19°C (2°C error). P responds to the 2°C gap, I accumulates
                error if it persists, D predicts if temperature is rising or falling. Together they
                smoothly adjust the heating valve to reach and maintain 21°C.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Programming and testing is done with electricians present to{' '}
              <strong>verify that programmed logic matches the physical installation</strong> and
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Physical verification:</strong> Outputs match commands
                  </li>
                  <li>
                    <strong>Interlock testing:</strong> Safety logic works correctly
                  </li>
                  <li>
                    <strong>Sensor calibration:</strong> Readings match actual values
                  </li>
                  <li>
                    <strong>Documentation:</strong> Record test results
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Inverted signals:</strong> NO vs NC confusion
                  </li>
                  <li>
                    <strong>Wrong addressing:</strong> Output to wrong device
                  </li>
                  <li>
                    <strong>Logic errors:</strong> AND vs OR mistakes
                  </li>
                  <li>
                    <strong>Timer values:</strong> Too fast or too slow
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-white mb-6">
            Case Study: Fire Alarm Logic Error
          </h2>
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
              <p className="text-sm font-medium text-red-300 mb-2">Problem</p>
              <p className="text-sm text-white">
                During fire alarm testing, a supply fan continued running instead of stopping. This
                could spread smoke through the building in a real fire.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/20">
              <p className="text-sm font-medium text-orange-300 mb-2">Investigation</p>
              <p className="text-sm text-white">
                The program used OR logic: (Enabled) OR (NOT Fire Alarm). This meant the fan would
                run if EITHER condition was true - including when fire alarm was active.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
              <p className="text-sm font-medium text-green-300 mb-2">Solution</p>
              <p className="text-sm text-white">
                Changed to AND logic: (Enabled) AND (NOT Fire Alarm). Now the fan only runs when
                BOTH conditions are true - system enabled AND no fire alarm.
              </p>
            </div>
          </div>
        </section>
