    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Categories by function (escape / anti-panic / high-risk / standby / local-area), luminaire
          types by operating mode (maintained / non-maintained / sustained), and system
          architectures (self-contained / central battery / hybrid).
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              escape route at floor level, with edge exclusions per BS EN 1838:2024 (outer 0.5 m on
              routes &gt; 2 m, outer ¼ width on routes ≤ 2 m). The 2024 update replaces the 2013
              centre-line + central-band wording. Switch-on 50 % within 5 s, full within 60 s.
              Standard 3-hour duration. For corridors, staircases and any defined escape path.
            </li>
            <li>
            ...
            <li>
              ...
              procedure plus margin (often a few minutes; can be longer). NEW in 2025: ≥ 2 separate
              circuits, ≤ 20 luminaires per fault. For workstations with hazardous machinery or
              processes that must be safely shut down.
            </li>
            <li>
              <strong>Standby lighting.</strong> NEW in 2025 BS 5266-1 scope. Illumination allowing
              normal activity to continue during mains failure. Levels and duration set by the
              operational requirement, not the safety case. For datacentres, broadcast studios,
              operating theatres, broadcast control rooms, areas where the activity must continue.
            </li>
            <li>
              ...
              the 2024 EN application; sits between escape and anti-panic in concept. For care home
              bedrooms, hospital wards at night, hotel guest rooms in some configurations.
            </li>
          </ul>
          <p>
            The category is the design output for each space. A schedule mapping every space to its
            category(ies) is the design brief; the luminaire layout, supply, and controls are then
            engineered to deliver the categories selected.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              lighting — and (where required) local-area lighting for occupants permitted to remain
              during the period of failure. Escape route lighting shall achieve not less than 1 lx
              across the full width of the route at floor level, with permitted edge exclusions of
              0.5 m on routes wider than 2 m and ¼ width on routes 2 m or narrower. Open area
              lighting shall achieve not less than 0.5 lx throughout the empty core area. High-risk
              task area lighting shall achieve not less than 10 % of the required maintained
              illuminance for the task, but in no case less than 15 lx, with a switch-on time of 0.5
              s.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              ...
              <text x="256" y="166" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Switch-on:
              </text>
              <text x="256" y="178" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                50% in 5 s
              </text>
              <text x="256" y="190" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                100% in 60 s
              </text>
              <text x="256" y="210" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Ratio: 40:1
              </text>
              <text x="256" y="230" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Duration: 3 hr
              </text>
              <text
                x="256"
            ...
            <g>
              ...
              <text x="416" y="166" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Switch-on:
              </text>
              <text x="416" y="178" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                ≤ 0.5 s
              </text>
              <text x="416" y="190" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                (instantaneous)
              </text>
              <text x="416" y="210" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Ratio: 10:1
              </text>
              <text x="416" y="230" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <g>
              ...
              <text x="576" y="146" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                (application-specific)
              </text>
              <text x="576" y="166" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Switch-on:
              </text>
              <text x="576" y="178" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                per operation
              </text>
              <text x="576" y="190" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                (often instant)
              </text>
              <text x="576" y="210" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Ratio: per task
              </text>
              <text x="576" y="230" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <g>
              ...
              <text x="729" y="146" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                application
              </text>
              <text x="729" y="166" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Switch-on:
              </text>
              <text x="729" y="178" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                5 s typical
              </text>
              <text x="729" y="198" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Duration: 3 hr
              </text>
              <text x="729" y="218" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                + as required
              </text>
              <text
                x="729"
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="410" y="398" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              Each space may need ONE category, or a COMBINATION layered together — e.g. press floor
              needs high-risk + escape + anti-panic
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Maintained.</strong> The lamp is illuminated under normal mains supply AND on
              emergency battery supply. The lamp never goes off (except when manually isolated for
              service). Used where the luminaire must be visible at all times — exit signs,
              way-finding signs, refuge identification signs, point-of-emphasis indicators in places
              of assembly, healthcare, education. The slight extra running cost is justified by
              continuous visibility.
            </li>
            <li>
              <strong>Non-maintained.</strong> The lamp is OFF under normal mains supply (the
              battery is being held in float-charge state; the electronics monitor mains presence).
              On loss of mains, the lamp automatically illuminates from the battery. Used for
              general escape and anti-panic illumination of areas that have their own normal
              lighting and where the emergency luminaire would be redundant during normal occupancy.
              The dominant mode for general escape illumination — cheaper to run, simpler to
              commission.
            </li>
            <li>
              <strong>Sustained / combined.</strong> The luminaire houses TWO independent light
              sources — a normal lamp (operated from mains for general illumination) AND a separate
              emergency lamp (operated from battery on mains failure). The two are independent: the
              normal lamp can be controlled by DALI / dimming / scene switching without affecting
              the emergency lamp's readiness. On mains failure the normal lamp goes off; the
              emergency lamp comes on. Used in modern multi-functional fittings, particularly where
              the same physical fitting must serve both general lighting and emergency lighting
              roles in a controlled lighting design.
            </li>
          </ul>
          <p>
            The data sheet for any compliant luminaire states the mode (typically symbol codes). On
            site, the rating-plate label states it. In the design schedule, every luminaire is
            listed with its category (function) AND its mode (operation). Confusion between the two
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              Sometimes NON-MAINTAINED. The workforce knows the exits from training and signage; the
              sign only needs to illuminate on actual emergency. This is a niche application;
              default is maintained for any non-trivial occupancy.
            </li>
            <li>
              <strong>General escape route lighting in corridors and stairs.</strong>
              NON-MAINTAINED. The corridor has its own normal lighting; the emergency luminaire only
              needs to fire when the mains fails. Saves running cost, reduces visual distraction.
            </li>
            <li>
              <strong>Anti-panic in open assembly areas.</strong> Usually NON-MAINTAINED. The normal
              lighting of the assembly area provides general illumination; the emergency luminaires
              are dark unless the mains fails.
            </li>
            <li>
            ...
            <li>
              <strong>Standby lighting in datacentre / theatre / surgical theatre.</strong> Usually
              SUSTAINED or specialist multi-source. The requirement is continued operation; the same
              fitting must provide normal operating lighting AND emergency continuation. Bespoke
              design.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Luminaires for emergency lighting shall be marked to indicate their type of operation,
              as follows: type "X0" — non-maintained luminaire, the lamp operates only in the
              emergency operation mode; type "X1" — maintained luminaire, the lamp is in operation
              in both the normal mode and the emergency operation mode; type "C" — combined
              luminaire, with one or more lamps for normal supply and one or more separate lamps for
              emergency supply; with rating-plate symbology indicating the mode and emergency
              duration.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              emergency distribution); high fault tolerance (failure of one battery affects only one
              luminaire); easy to extend (add a new luminaire to any existing lighting circuit);
              standardised products from many manufacturers; simple test — most products have an
              integral self-test feature; suits small to medium installations.
            </li>
            <li>
            ...
            <li>
              <strong>Battery technology.</strong> Modern self-contained luminaires use lithium iron
              phosphate (LiFePO₄) or lithium-ion. Older NiCd / NiMH still in service. Battery life
              typically 4-7 years for modern Li chemistry; replacement cost plus labour is the
              dominant lifecycle cost.
            </li>
            <li>
              <strong>Self-test capability.</strong> Modern self-contained luminaires automatically
              perform monthly functional tests and annual full-duration tests (where the product
              supports it). The luminaire reports status via integral LED indicator or via wireless
              / DALI / KNX integration. Reduces manual testing burden but does not eliminate the
              need for site verification per BS EN 50172:2024.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              lead-acid, NiCd, modern Li); centralised testing and reporting; simpler luminaires (no
              internal electronics); known long life of well-maintained battery (10+ years for
              VRLA).
            </li>
            <li>
              ...
              charger, or supply distribution failure can affect many luminaires unless segmentation
              is designed in); requires plant-room space; requires specialist commissioning and
              maintenance.
            </li>
            <li>
              ...
              labelling. Required for any central battery system; the manufacturer's declaration of
              compliance is part of the project handover.
            </li>
            <li>
              <strong>Typical applications.</strong> Hospitals (where IPS / UPS and central battery
              overlap for life-safety services), large datacentres, theatres and cinemas (where
              central feeding the auditorium luminaires is convenient), large shopping centres /
              airports (where centralisation supports building-management integration).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Phased upgrade.</strong> A building originally fitted with central battery is
              being extended; the extension is fitted with self-contained for cost reasons; the
              existing central battery serves the original areas. The two architectures coexist
              within the same maintenance regime.
            </li>
            <li>
              <strong>Standby + escape combination.</strong> A datacentre needs standby lighting in
              the rack rooms (central battery preferred, longer duration, BMS integration); the rest
              of the building has escape and anti-panic provisions served by self-contained.
            </li>
          </ul>
          <p>
            The maintenance regime is the most common stumbling-block on hybrid sites. Make sure the
            contractor has the competence and equipment to test and maintain both architectures;
            make sure the documentation clearly identifies which luminaires belong to which
            architecture; make sure the photometric verification cycle covers both.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              incorporates its own battery), central battery type (where one or more central battery
              installations supply all emergency luminaires through a dedicated emergency-supply
              distribution complying with BS EN 50171), or a combination of these. The selection of
              architecture shall be based on the risk assessment, the size and complexity of the
              premises, the maintenance regime, and the duration required. For high-risk task areas,
              the emergency supply shall be divided across at least two separate circuits, with each
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Escape route.</strong> 50% of required illuminance within 5 s; 100% within 60
              s. The escape begins on partial illumination and the 1 lx target is reached within a
              minute of mains failure.
            </li>
            <li>
            ...
            <li>
              ...
              operator does not lose sight of the controls. The fastest of the categories; designed
              against the operator's response window for hazardous machinery.
            </li>
            <li>
              <strong>Standby.</strong> Per operational requirement — often instantaneous
              (datacentre fail-over, theatre transitions), sometimes longer where the standby system
              itself takes time to start (generator).
            </li>
            <li>
              <strong>Local-area.</strong> Typically 5 s response is adequate — the occupant is not
              evacuating, and 5 s is short enough that the resident or patient is not left in
              extended darkness.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Standard 3 hours.</strong> Default for most UK premises — places of assembly,
              sleeping accommodation, healthcare, education, retail, hospitality, most workplaces.
              Annual full-discharge tests verify the system runs for 3 hours at the required
              illuminance.
            </li>
            <li>
              <strong>1 hour permitted.</strong> Limited circumstances — small premises with simple
              evacuation routes, immediate evacuation possible, no overnight occupancy. Even where 1
              hour is permitted, modern designs commonly adopt 3 hours because the cost difference
              is small and the safety margin is real.
            </li>
            <li>
              ...
              high-rise residential, premises where the local authority or insurer requires more. Up
              to 24 hours is occasionally seen for life-critical healthcare.
            </li>
            <li>
          ...
          <p>
            Duration is set in the design and verified annually. Battery degradation reduces actual
            achievable duration over time; the annual full-discharge test catches the degradation;
            battery replacement restores the duration. The 5-year photometric verification (NEW in
            2025) is at the START of the discharge period — verifies illuminance at the rated level
            on initiation; the duration test verifies it is sustained.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              shallow discharge tolerance, low maintenance. Typical service life 5-7 years. Specific
              energy moderate but adequate for the small capacities needed (1-2 hr at a few watts).
              Most major manufacturers have transitioned to LiFePO₄ as the default chemistry for new
              product launches.
            </li>
            <li>
            ...
            <li>
              <strong>Sealed lead-acid (VRLA).</strong> Used in central battery systems rather than
              self-contained. Long life when well-maintained (8-10+ years), high capacity,
              well-understood chemistry. Specialist maintenance required.
            </li>
          </ul>
          <p>
            When specifying a new self-contained system, the chemistry choice typically follows the
            product line — most current major-brand luminaires use LiFePO₄. The data sheet states
            it. The replacement cycle and procurement plan can then be built around the stated
            service life. Battery replacement labour is a substantial proportion of lifecycle cost;
            design for accessible mounting positions reduces future cost.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              results, raises alerts on failure. Reduces manual testing burden; documentation is the
              system log rather than a paper book.
            </li>
            <li>
              <strong>Wireless self-test.</strong> Each luminaire performs its own scheduled tests
              using internal electronics; results are reported wirelessly (often via a low-power 2.4
              GHz mesh) to a central gateway. No bus-cabling cost; suits retrofit. The gateway
              pushes results to a web portal or BMS.
            </li>
            <li>
              <strong>BMS integration.</strong> Modbus, BACnet, KNX. The emergency-lighting test
              results feed into the building management system; the FM contractor sees a single pane
              of glass. Useful for large estates managed centrally.
            </li>
            <li>
              ...
              appropriate authentication on the management portal. Standards evolving in this space.
            </li>
            <li>
              <strong>Commissioning effort.</strong> Addressable / connected systems require more
              commissioning effort than standard self-contained — bus address mapping, test schedule
              configuration, gateway setup. Cost premium during commissioning; lifetime saving in
              test labour can recover this.
            </li>
          </ul>
        </ConceptBlock>
