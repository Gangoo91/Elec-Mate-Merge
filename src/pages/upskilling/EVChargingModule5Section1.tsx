...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'CT clamps should have accuracy class 1 (±1% error) or better for effective DLM operation. Higher accuracy improves system performance and allows closer operation to maximum capacity limits.',
  },
  {
...
const faqs = [
  {
    ...
    answer:
      'DLM continuously monitors total electrical demand and automatically reduces EV charging power when approaching maximum supply capacity. Safety margins and real-time control ensure the installation never exceeds its design limits.',
  },
  {
    question: 'Can DLM work with existing charge points?',
    answer:
      'Yes, most modern charge points support OCPP (Open Charge Point Protocol) which enables external control. Older units may require retrofit communication modules or replacement with DLM-compatible equipment.',
  },
  {
    question: 'What happens if the DLM system fails?',
    answer:
      'Well-designed systems include fail-safe modes where charge points revert to reduced power operation or predetermined limits. Backup communication paths and redundant monitoring ensure continued safe operation.',
  },
  {
    question: 'What communication protocols do DLM systems use?',
    answer:
      'Common protocols include OCPP for charge point control, Modbus TCP/RTU for meter integration, MQTT for IoT connectivity, and RESTful APIs for third-party system integration.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'A 150kVA office building with 30A spare capacity wants to install 10 × 22kW charge points. What DLM approach is most appropriate?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'DLM enables installation of all 10 charge points while dynamically sharing the available capacity. During typical use, not all vehicles charge simultaneously, and DLM ensures the total load never exceeds the 30A spare capacity. This maximises charging provision without costly infrastructure upgrades.',
  },
];
...
const EVChargingModule5Section1 = () => {
  useSEO({
    ...
    description:
      'Learn to implement intelligent Dynamic Load Management systems for EV charging. Covers algorithms, hardware, control strategies, and BS 7671 compliance.',
  });
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Purpose:</strong> Prevent overloads, maximise capacity
              </li>
              <li>
                <strong>Method:</strong> Real-time monitoring + dynamic allocation
              </li>
              <li>
                <strong>Result:</strong> 2-3× more chargers on same supply
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> CT clamps on incomer, DLM controller box
              </li>
              <li>
                <strong>Use:</strong> Multi-charger sites with limited supply
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Real-time:</strong> Continuous demand measurement
                  </li>
                  <li>
                    <strong>Capacity:</strong> Dynamic available power calculation
                  </li>
                  <li>
                    <strong>Forecasting:</strong> Predictive algorithms
                  </li>
                  <li>
                    <strong>Response:</strong> Sub-second adjustment capability
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Measure:</strong> Data from CTs and meters
                  </li>
                  <li>
                    <strong>Process:</strong> Algorithm calculates allocation
                  </li>
                  <li>
                    <strong>Command:</strong> Transmit to charge points
                  </li>
                  <li>
                    <strong>Verify:</strong> Confirm implementation
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Non-intrusive:</strong> Install on existing cables
                  </li>
                  <li>
                    <strong>Accuracy:</strong> Class 1 or better required
                  </li>
                  <li>
                    <strong>Ratios:</strong> 100:5A, 200:5A, 400:5A
                  </li>
                  <li>
                    <strong>Split-core:</strong> For retrofit installations
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Processing:</strong> ARM Cortex or equivalent
                  </li>
                  <li>
                    <strong>Comms:</strong> Ethernet, WiFi, 4G, RS485
                  </li>
                  <li>
                    <strong>Rating:</strong> IP54 indoor, IP65 outdoor
                  </li>
                  <li>
                    <strong>Certification:</strong> CE, BS EN 61010
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>OCPP:</strong> Industry standard for charge point control
                </li>
                <li>
                  <strong>Modbus:</strong> Industrial protocol for meter integration
                </li>
                <li>
                  <strong>MQTT:</strong> Lightweight IoT messaging
                </li>
                <li>
                  <strong>REST APIs:</strong> Third-party system integration
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Formula:</strong> Available ÷ Active sessions
                  </li>
                  <li>
                    <strong>Pro:</strong> Simple, fair, predictable
                  </li>
                  <li>
                    <strong>Con:</strong> May not optimise throughput
                  </li>
                  <li>
                    <strong>Use:</strong> Workplace, residential
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Factors:</strong> SoC, departure time, user tier
                  </li>
                  <li>
                    <strong>Pro:</strong> Optimises for urgent needs
                  </li>
                  <li>
                    <strong>Con:</strong> More complex to configure
                  </li>
                  <li>
                    <strong>Use:</strong> Fleet, premium services
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Maximum import capacity:</strong> Total available supply
                </li>
                <li>
                  <strong>Base load allocation:</strong> Reserved for building operations
                </li>
                <li>
                  <strong>Safety margin:</strong> 5-10% headroom to prevent overload
                </li>
                <li>
                  <strong>Minimum charging power:</strong> Typically 6A (1.4kW) per session
                </li>
                <li>
                  <strong>Monitoring interval:</strong> 1-60 seconds depending on response needs
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Wrong CT ratio:</strong> — Results in incorrect load readings
                </li>
                <li>
                  <strong>No safety margin:</strong> — System may trip on load spikes
                </li>
                <li>
                  <strong>Poor communication:</strong> — Delayed response to load changes
                </li>
                <li>
                  <strong>Missing fail-safe:</strong> — No backup if DLM fails
                </li>
              </ul>
            </div>
          </div>
