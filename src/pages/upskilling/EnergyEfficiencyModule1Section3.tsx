...
const DESCRIPTION =
  'Learn to identify common sources of electrical energy waste including standby power, motor inefficiencies, poor power factor, oversized equipment, and distribution losses.';

const quickCheckQuestions = [
  {
    id: 'm1s3-check1',
    question:
      "What percentage of a typical commercial building's electricity consumption can be attributed to standby power and unnecessary operation?",
    options: ['1-2%', '5-15%', '25-30%', 'Less than 0.5%'],
    correctIndex: 1,
    explanation:
      "Standby power and unnecessary operation typically account for 5-15% of commercial electricity consumption. This represents a significant 'easy win' for energy savings with minimal capital investment.",
  },
  {
    id: 'm1s3-check2',
    question:
      'A motor operating at 40% of its rated load will typically have what efficiency compared to its full-load efficiency?',
    options: [
      'About the same efficiency',
      'Significantly lower efficiency (10-15% reduction)',
      'Higher efficiency due to less stress',
      'Cannot be determined without more data',
    ],
    correctIndex: 1,
    explanation:
      'Motors operating at partial loads (especially below 50%) experience significant efficiency drops of 10-15% or more. This is because the fixed losses (iron losses, friction) remain constant while useful output decreases.',
  },
  {
    id: 'm1s3-check3',
    ...
    options: [
      'Losses double (2x)',
      'Losses quadruple (4x)',
      'Losses increase by 50%',
      'Losses remain the same',
    ],
    correctIndex: 1,
    explanation:
      'Power loss in cables follows the I squared R formula. When current doubles, the losses increase by the square of 2, meaning they quadruple (4x). This is why correct cable sizing is critical for efficiency.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Incandescent lamps convert approximately 90% of their energy input into heat rather than light, making them the least efficient lighting option.',
  },
  {
    id: 3,
    question:
      'A power factor of 0.7 means the installation is drawing approximately what percentage more current than necessary?',
    options: ['30% more', '43% more', '70% more', '7% more'],
    correctAnswer: 1,
    explanation:
      'At power factor 0.7, current is 1/0.7 = 1.43 times what it would be at unity power factor, meaning 43% more current is drawn.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Oversizing motors is the most common cause of inefficiency. Motors operating significantly below their rated capacity have poor efficiency and power factor.',
  },
  {
    id: 5,
    question:
    ...
    correctAnswer: 2,
    explanation:
      'Since losses are proportional to current squared, reducing current has the greatest impact. Increasing voltage for the same power reduces current proportionally.',
  },
  {
    id: 6,
    question:
      'What percentage of energy can be saved by replacing DOL motor starters with VSDs for variable load applications?',
    options: ['5-10%', '10-20%', '20-50%', '50-70%'],
    correctAnswer: 2,
    explanation:
      'VSDs can save 20-50% energy on variable load applications like fans and pumps by matching motor speed to actual demand rather than running at full speed.',
  },
  {
    id: 7,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Modern office computer systems typically consume 5-15W in standby mode, though this varies by age and configuration.',
  },
  {
    id: 9,
  ...
  },
  {
    id: 10,
    question:
      'What is the recommended minimum loading for a standard induction motor to maintain good efficiency?',
    options: ['25% of rated load', '50% of rated load', '75% of rated load', '100% of rated load'],
    correctAnswer: 1,
    explanation:
      'Motors should ideally operate at 50% or more of their rated load to maintain reasonable efficiency. Below this, efficiency drops significantly.',
  },
];
...
const faqs = [
  {
    question:
      'How can I quickly identify the biggest sources of waste in an electrical installation?',
    answer:
  ...
  },
  {
    ...
    answer:
      'It depends on running hours and loading. For motors running over 4,000 hours/year at good loading (>50%), upgrading to IE3 or IE4 efficiency class can pay back in 2-4 years. For intermittent or lightly loaded motors, focus on right-sizing first. Always calculate total cost of ownership including energy costs.',
  },
  {
    question: 'What is the quickest way to improve power factor?',
    answer:
      'Installing power factor correction capacitors at the main distribution board is the quickest fix. Automatic PFC units monitor and adjust capacitance to maintain target power factor (typically 0.95-0.98). Payback is often under 2 years through reduced maximum demand charges and lower distribution losses.',
  },
  {
    question: 'How much energy do VSDs (Variable Speed Drives) actually save?',
    answer:
      'For fan and pump applications following the affinity laws, reducing speed by 20% reduces power consumption by approximately 50%. Typical savings range from 20-50% depending on the application. VSDs also provide soft starting, reducing mechanical stress and peak demand charges.',
  },
  {
    question: 'Should cables always be oversized for efficiency?',
    answer:
      'While larger cables reduce I squared R losses, there is an economic optimum. BS 7671 provides minimum sizes for safety, but the IET guidance on energy efficiency recommends economic cable sizing that balances capital cost against lifetime energy losses. For long runs or high utilisation, oversizing by one or two sizes is often justified.',
  },
  {
    question: 'How can behavioural waste be addressed effectively?',
    answer:
      'Combine awareness training with technology: automatic controls (PIR sensors, timers, BMS), visual feedback (energy dashboards), clear responsibilities (switch-off procedures), and regular monitoring. Culture change requires sustained effort - quick wins help build momentum and demonstrate value.',
  },
];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-12">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>Standby:</strong> 5-15% of consumption
                </li>
                <li>
                  <strong>Motors:</strong> 10-30% losses if oversized
                </li>
                <li>
                  <strong>Power Factor:</strong> 20-40% excess current
                </li>
                <li>
                  <strong>Cables:</strong> Losses proportional to I squared
                </li>
              </ul>
            </div>
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>Spot:</strong> Equipment running overnight/weekends
                </li>
                <li>
                  <strong>Spot:</strong> Motors at less than 50% load
                </li>
                <li>
                  <strong>Use:</strong> Sub-metering for baseline data
                </li>
                <li>
                  <strong>Use:</strong> Clamp meters for motor loading
                </li>
              </ul>
            </div>
          </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Electrical waste falls into two main categories: technical losses inherent in
                equipment and systems, and operational waste from poor management or behaviour.
                Understanding these categories helps prioritise improvement efforts.
              </p>

              <div className="my-6">
                <p className="text-sm font-medium text-white mb-2 flex items-center gap-2">
                  <Power className="h-4 w-4 text-elec-yellow" /> Standby Power (Vampire Loads):
                </p>
              ...
              <div className="my-6">
                <p className="text-sm font-medium text-white mb-2 flex items-center gap-2">
                  <Lightbulb className="h-4 w-4 text-elec-yellow" /> Inefficient Lighting:
                </p>
                <ul className="text-sm text-white space-y-1 ml-4">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <p className="text-elec-yellow text-sm font-medium mb-2">
                  Easy Wins: Standby and Lighting
                </p>
                <p className="text-sm text-white mb-2">
                  These represent the lowest-hanging fruit for energy savings:
                </p>
                <ul className="text-sm text-white space-y-1">
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Electric motors account for approximately 65-70% of industrial electricity
                consumption. Even small efficiency improvements translate to significant savings.
                Key sources of motor inefficiency include:
              </p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm mt-1">
                      Old standard efficiency motors (IE1) waste 3-5% more energy than IE3/IE4
                      premium efficiency motors. For a 30kW motor running 4,000 hours/year, this
                      represents 3,600-6,000 kWh annually.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm mt-1">
                      Motors are most efficient at 75-100% of rated load. At 50% load, efficiency
                      drops by 5-10%. Below 40% load, efficiency can drop by 10-20% or more.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm mt-1">
                      Fan and pump applications following the affinity laws can save 20-50% with
                      VSDs. Throttling valves and dampers waste energy as pressure drops.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm mt-1">
                      Belt drives waste 3-5% compared to direct drives. Worn bearings, misalignment,
                      and poor lubrication add further losses and reduce motor lifespan.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <table className="w-full text-sm border-collapse">
                  <thead>
                    <tr className="border-b border-white/20">
                      <th className="text-left py-3 px-2 text-white font-semibold">
                        Motor Loading
                      </th>
                      <th className="text-center py-3 px-2 text-white font-semibold">
                        Typical Efficiency
                      </th>
                      <th className="text-center py-3 px-2 text-white font-semibold">
                        Power Factor
                  ...
                  <tbody className="text-white">
                    <tr className="border-b border-white/10">
                      <td className="py-3 px-2">100% load</td>
                      <td className="text-center py-3 px-2">92-95%</td>
                      <td className="text-center py-3 px-2">0.85-0.90</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-3 px-2">75% load</td>
                      <td className="text-center py-3 px-2">91-94%</td>
                      <td className="text-center py-3 px-2">0.80-0.85</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-3 px-2">50% load</td>
                      <td className="text-center py-3 px-2">85-90%</td>
                      <td className="text-center py-3 px-2">0.70-0.78</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-2">25% load</td>
                      <td className="text-center py-3 px-2">70-80%</td>
                      <td className="text-center py-3 px-2">0.50-0.60</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Power factor represents the ratio of real power (kW) doing useful work to apparent
                power (kVA) supplied. A poor power factor means the installation draws more current
                than necessary to perform the same work.
              </p>

              <div className="my-6">
                <p className="text-sm font-medium text-white mb-2 flex items-center gap-2">
                  <AlertTriangle className="h-4 w-4 text-elec-yellow" /> Impact of Poor Power
                  Factor:
                </p>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <p className="text-elec-yellow text-sm font-medium mb-2">
                  Calculating Current Increase
                </p>
                <p className="text-white text-sm mb-2">
                  Current is inversely proportional to power factor. For a load requiring 100kW:
                </p>
                <ul className="text-sm text-white space-y-1">
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Equipment oversizing is common due to safety margins added at each design stage.
                While ensuring reliability, excessive oversizing creates ongoing efficiency
                penalties through poor part-load performance.
              </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4 my-6">
                <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                  <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                    <Settings className="h-4 w-4" /> Motors
                  </p>
                  <ul className="text-sm text-white space-y-1">
                  ...
                  <p className="text-white text-sm mt-2">
                    Studies show 30-40% of industrial motors are oversized by more than 20%.
                  </p>
                </div>
                <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                  <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                    <Gauge className="h-4 w-4" /> Transformers
                  </p>
                  <ul className="text-sm text-white space-y-1">
                  ...
                  <p className="text-white text-sm mt-2">
                    A 1000kVA transformer at 20% load wastes more energy on iron losses than a
                    correctly sized 315kVA unit.
                  </p>
                </div>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Cables dissipate energy as heat due to their resistance. These I squared R losses
                are often overlooked but can be significant, particularly for long cable runs, high
                currents, or cables operating near their rated capacity.
              </p>

              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 my-6">
                <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                  <Cable className="h-4 w-4" /> The I squared R Loss Formula
                </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4 my-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-white mb-2">
                    100m of 16mm squared copper cable carrying 60A:
                  </p>
                  <ul className="text-sm text-white space-y-1">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-white text-sm mb-2">
                  BS 7671 provides minimum sizes for safety. IET guidance recommends considering
                ...
                <table className="w-full text-sm border-collapse">
                  <thead>
                    <tr className="border-b border-white/20">
                      ...
                      <th className="text-center py-3 px-2 text-white font-semibold">
                        Loss Reduction vs Smaller
                      </th>
                    </tr>
                  </thead>
                  <tbody className="text-white">
                    <tr className="border-b border-white/10">
                      <td className="py-3 px-2">10mm squared Cu</td>
                      <td className="text-center py-3 px-2">1.83</td>
                      <td className="text-center py-3 px-2">-</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-3 px-2">16mm squared Cu</td>
                      <td className="text-center py-3 px-2">1.15</td>
                      <td className="text-center py-3 px-2">37% less</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-3 px-2">25mm squared Cu</td>
                      <td className="text-center py-3 px-2">0.727</td>
                      <td className="text-center py-3 px-2">37% less</td>
                    </tr>
                    <tr>
                      <td className="py-3 px-2">35mm squared Cu</td>
                      <td className="text-center py-3 px-2">0.524</td>
                      <td className="text-center py-3 px-2">28% less</td>
                    </tr>
                  </tbody>
                </table>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Technical solutions alone cannot address all energy waste. Human behaviour and
                management practices significantly impact energy consumption. Studies suggest
                behavioural factors account for 10-30% of potential savings.
              </p>

              <div className="grid sm:grid-cols-2 gap-4 my-6">
                <div>
                  <p className="text-sm font-medium text-white mb-2 flex items-center gap-2">
                    <Users className="h-4 w-4 text-elec-yellow" /> Common Behavioural Waste:
                  </p>
                  <ul className="text-sm text-white space-y-1">
                ...
                <div>
                  <p className="text-sm font-medium text-white mb-2 flex items-center gap-2">
                    <Settings className="h-4 w-4 text-elec-yellow" /> Management Issues:
                  </p>
                  <ul className="text-sm text-white space-y-1">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mt-4">
                ...
                <p className="text-white text-sm">
                  Research consistently shows that awareness campaigns combined with feedback can
                  achieve 5-15% savings with minimal capital investment. Key success factors:
                  visible data, clear targets, recognition, and sustained management commitment.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  When Conducting an Energy Audit
                </h3>
                <ul className="text-sm text-white space-y-1 ml-4">
              ...
              <div>
                ...
                <ul className="text-sm text-white space-y-1 ml-4">
                  <li>
                    <strong>Focusing only on technical fixes</strong> - behavioural change is often
                    cheaper and faster
                  </li>
                  <li>
                    <strong>Oversizing replacement equipment</strong> - right-size based on actual
                    measured load
                  </li>
                  <li>
                    <strong>Ignoring power factor</strong> - affects both efficiency and costs
                  </li>
                  <li>
                    <strong>Not monitoring after improvements</strong> - verify savings are achieved
                    and sustained
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            <div className="p-5 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <h3 className="text-sm font-medium text-white mb-4 flex items-center gap-2">
                <Wrench className="h-4 w-4 text-elec-yellow" /> Quick Reference: Identifying
                Electrical Waste
              </h3>
