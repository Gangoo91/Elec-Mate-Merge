...
const DESCRIPTION =
  'Learn about PAT labelling requirements, systems, and best practices for clear identification and tracking of tested equipment.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'Date tested, retest date, and tester identification',
      'Equipment make and model',
      'The test results and readings',
    ],
    correctIndex: 1,
    explanation:
      'As a minimum, PAT labels should show the date of test, when the next test is due, and identification of who performed the test (initials, name, or ID number). Some also include asset ID.',
  },
  {
    id: 'm5s1-check2',
    question: 'How should equipment that has failed PAT testing be labelled?',
    options: [
      'With a standard pass label but marked as borderline',
      'With a clear FAIL or DO NOT USE label',
      'No label is required - just remove from use',
      'With a red pass label',
    ],
    correctIndex: 1,
    explanation:
      'Failed equipment must be clearly labelled with a FAIL or DO NOT USE label to prevent accidental use. The label should be obvious and the equipment should be withdrawn from service immediately.',
  },
  {
    id: 'm5s1-check3',
    ...
    options: [
      ...
      'To track equipment cost for accounting',
      'To link the equipment to its test history in records',
      'To identify the manufacturer',
    ],
    correctIndex: 2,
    explanation:
      'Asset ID numbers create a unique identifier that links physical equipment to its complete test history, location records, and maintenance information in your database or records system.',
  },
];

const quizQuestions = [
  {
    question: 'What is the primary purpose of PAT labels?',
    options: [
      'To satisfy insurance companies',
      'To provide clear evidence of test status and due dates',
      'To make equipment look professional',
      'To track warranty periods',
    ],
    correctAnswer: 1,
  },
  {
    question: 'A PASS label should include:',
    options: [
      'Only the test date',
      'Test date, retest date, and tester ID as minimum',
      'Full test results and readings',
      'Equipment specifications',
    ],
    correctAnswer: 1,
  },
  {
    question: 'Failed equipment should be labelled with:',
    options: [
      'A pass label with notes',
      'A clear FAIL or DO NOT USE label',
      'No label required',
      'A red pass label',
    ],
    correctAnswer: 1,
  ...
  {
    question: 'Colour-coded label systems typically use which colour for pass?',
    options: ['Red', 'Green', 'Yellow', 'Blue'],
    correctAnswer: 1,
  },
  {
    question: 'Where should PAT labels be placed?',
    options: [
      'On the cable',
      'Visible and secure, typically on the equipment body',
  ...
  {
    question: 'Labels should be made from materials that are:',
    options: [
      'Paper for easy replacement',
      'Durable and resistant to the working environment',
  ...
  {
    question: 'Asset ID numbers should be:',
    options: [
      'Changed each test',
      'Unique and consistent throughout equipment life',
      'Based on the test date',
      'The same as the serial number',
    ],
    correctAnswer: 1,
  },
  {
    question: 'Barcode or QR code labels are useful for:',
    options: [
      'Making labels look modern',
      'Quick data entry and linking to electronic records',
      'Proving equipment is genuine',
      'Reducing label cost',
    ],
    correctAnswer: 1,
  },
  {
    question: 'When should a new label be applied?',
    options: [
      'Only on first test',
      'After each test, replacing the previous label',
      'Only if the equipment changes location',
      'Only after a fail',
    ],
    correctAnswer: 1,
  },
  {
    question: 'Monthly colour coding systems help:',
    options: [
      'Reduce label costs',
      'Quick visual identification of test due dates',
      'Satisfy legal requirements',
      'Make equipment look better',
    ],
    correctAnswer: 1,
  },
];
...
const faqs = [
  {
    question: 'Are PAT labels legally required?',
    answer:
      'Labels are not specifically required by law, but they are strongly recommended as part of a practical maintenance system. They provide evidence of testing and prevent use of untested or failed equipment.',
  },
  {
    question: 'What size should labels be?',
    answer:
      'Labels should be large enough to be easily read but small enough to fit the equipment. Typical sizes range from 25x50mm to 50x100mm. The key is that information must be clearly legible.',
  },
  {
    question: 'Can I write labels by hand?',
    answer:
      'Yes, hand-written labels are acceptable if they are clear and legible. However, printed labels (from PAT testers or printers) are more professional and reduce transcription errors.',
  },
  {
    question: 'What if a label falls off?',
    answer:
      'Re-label the equipment at the next test or immediately if you notice. Consider using more durable labels or better placement. Some use cable ties through a hole in the label for security.',
  },
  {
    question: 'Should I label extension leads differently?',
    answer:
      'Extension leads should be labelled the same as other equipment. Place the label where it is visible - often on the socket board body. Some testers also print separate lead identification tags.',
  },
  {
    question: 'How long should labels last?',
    answer:
      'Labels should remain legible until the next test. For annual testing, labels must last at least 12 months. Choose appropriate materials for the environment - laminated or synthetic labels for harsh conditions.',
  },
];
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-8 pb-24">
        ...
        <div className="space-y-3">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              'Describe the purpose and importance of PAT labels',
              'List the minimum information required on labels',
              'Explain pass and fail labelling procedures',
              'Describe asset identification systems',
              'Select appropriate label types for different environments',
              'Apply labels correctly for maximum durability',
            ].map((outcome, i) => (
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg p-4">
              <h4 className="text-elec-yellow font-semibold mb-3 flex items-center gap-2">
                <Calendar className="h-5 w-5" /> Minimum Requirements
              </h4>
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              Asset ID numbers create a unique, permanent identifier for each piece of equipment:
            </p>
            <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg p-4">
              <h4 className="text-elec-yellow font-semibold mb-2 flex items-center gap-2">
                <QrCode className="h-5 w-5" /> ID Number Formats
              </h4>
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg p-4">
                ...
                <ul className="text-white text-sm space-y-1">
                  ...
                  <li>
                    <strong className="text-white">Vinyl:</strong> Good durability, most
                    applications
                  </li>
                  <li>
                    <strong className="text-white">Polyester:</strong> Excellent durability, harsh
                    environments
                  </li>
                  <li>
                    <strong className="text-white">Metallic:</strong> Very durable, high temperature
                  </li>
                </ul>
              </div>
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-5">
              ...
              <ul className="text-white text-sm space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>Remove old labels before applying new ones</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Clean the surface before applying labels</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Use colour coding for quick visual identification</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Consider monthly colour codes for large inventories</span>
                </li>
              </ul>
            </div>
            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-5">
              ...
              <ul className="text-white text-sm space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>Applying labels to dirty or oily surfaces</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                  <span>Using paper labels in harsh environments</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                  <span>Not labelling failed equipment immediately</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                  <span>Reusing asset ID numbers for new equipment</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          <h2 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
            <Zap className="h-5 w-5 text-elec-yellow" /> Quick Reference: PAT Labels
          </h2>
          <div className="grid sm:grid-cols-2 gap-4 text-sm">
            <div className="bg-black/20 rounded-lg p-4">
              <h4 className="text-green-400 font-semibold mb-2">PASS Label Must Show</h4>
              <ul className="text-white space-y-1">
                <li>- Test date</li>
                <li>- Retest date</li>
                <li>- Tester ID</li>
                <li>- Asset ID (recommended)</li>
              </ul>
            </div>
            <div className="bg-black/20 rounded-lg p-4">
              <h4 className="text-red-400 font-semibold mb-2">FAIL Label Must</h4>
              <ul className="text-white space-y-1">
                <li>- Be clearly visible</li>
                <li>- Say FAIL or DO NOT USE</li>
                <li>- Be applied immediately</li>
                <li>- Equipment withdrawn</li>
              </ul>
            </div>
            <div className="bg-black/20 rounded-lg p-4">
              <h4 className="text-elec-yellow font-semibold mb-2">Label Placement</h4>
              <ul className="text-white space-y-1">
                <li>- Visible in normal use</li>
                <li>- Clean, flat surface</li>
                <li>- Away from heat/damage</li>
              </ul>
            </div>
            <div className="bg-black/20 rounded-lg p-4">
              <h4 className="text-elec-yellow font-semibold mb-2">Asset ID Rules</h4>
              <ul className="text-white space-y-1">
                <li>- Unique per equipment</li>
                <li>- Never reuse numbers</li>
                <li>- Permanent for life</li>
              </ul>
            </div>
          </div>
        </section>
