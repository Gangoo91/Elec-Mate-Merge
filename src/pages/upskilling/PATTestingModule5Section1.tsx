  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/electrician/upskilling/pat-testing-module-5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The label is the visible portion of the record. Minimum fields under IET CoP 5th Ed.
          Chapter 16, durable label materials, placement that does not obscure ratings, and how to
          handle a fail.
        </p>
        ...
        >
          <p>
            ...
            specific data fields. Each is on the label for a separate reason and removing any one of
            them strips the label of a function it is doing.
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              asset ID the label is anonymous: you can read it but cannot find the matching record,
              and a record search cannot tell you which physical item is meant.
            </li>
            <li>
            ...
            <li>
              <strong className="text-elec-yellow">Retest date</strong> — when the next test is due.
              Expressed as a calendar date rather than an interval, so the next user does not have
              to add 12 months in their head and there is no dispute about whether
            ...
            <li>
              ...
              unique tester number, or a QR code resolving to a competent-person record. This is the
              audit-trail field: any third party can identify who carried out the test and follow up
              if the result is queried.
            </li>
          </ul>
          <p>
            Pass/fail itself does not need a separate field — it is conveyed by the label format: a
            green PASS label, a red FAIL label, or in some systems a hazard-yellow CAUTION / FOR
        ...
        <RegsCallout
          ...
          clause={
            <>
              Where a label is fixed to the equipment to indicate the result of an inspection and/or
              test, it is recommended that as a minimum the label includes the date of the test, the
              date when the next test is due, and an identification of the person who carried out
              the test. Where an asset register is in use, the label should also include the asset
              identification number to enable the equipment to be linked to its test records.
            </>
          }
        ...
        >
          <p>
            ...
            &ldquo;PASS&rdquo; and shows tester initials. The inspector asks: when was this tested?
            The site manager cannot answer without going to the records. The records say the kettle
            was tested 26 months ago, in a year when annual testing was set as policy. The label has
            been telling everyone &ldquo;OK to use&rdquo; for fourteen months past the retest
            interval, with no visible warning at the equipment.
          </p>
          <p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="2"
            />
            <text x="400" y="72" textAnchor="middle" fill="#22C55E" fontSize="22" fontWeight="bold">
              PASS
            </text>
        ...
        <ContentEyebrow>Choosing a label material that survives the retest interval</ContentEyebrow>
        ...
        >
          <p>
            IET CoP 5th Ed. Chapter 16 expects labels to remain in place and legible across the full
            retest interval. That has to drive material choice:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
            ...
            <li>
              ...
              surfaces and resistance to detergents and oils. Thermally printed black on a coloured
              background — never inkjet.
            </li>
            <li>
            ...
            <li>
              <strong>Hire fleets / shared equipment:</strong> tamper-evident or destructible labels
              are appropriate. Destructible vinyl tears on attempted removal, so a missing or
              interfered-with label is visible at the next inspection — preventing label migration
              between items.
            </li>
            <li>
              <strong>Tools that get washed down or used in damp environments:</strong> labels with
              sealed-edge laminates or labels designed for IP-rated equipment. Standard paper-faced
              PAT labels are unsuitable.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              A label fixed to portable equipment can be used to indicate that it has been inspected
              or tested, and to provide some basic information about the inspection, such as the
              date and the next due date. The label should remain in place and legible until the
              next inspection or test is carried out.
            </>
          }
        ...
        >
          <p>
            IET CoP 5th Ed. Chapter 16 is firm: the label must be visible and durable, but must not
            cover the rating plate, the manufacturer&rsquo;s type-test marks, ventilation openings,
            or any safety warning. The reasoning is functional, not cosmetic — the rating plate is
            what tells the next maintainer which fuse rating, voltage and class the equipment
            requires. Cover it and you have created a future fault.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>On the casing, not on the flex.</strong> Flexes are replaceable; a label on a
              flex migrates with the wrong asset and disappears the moment the lead is changed.
            </li>
            <li>
            ...
            <li>
              <strong>Avoid ventilation grilles.</strong> Heat causes adhesive failure, and blocking
              grilles is a hazard in itself.
            </li>
            <li>
              <strong>Avoid the cord-grip.</strong> Frequent flex movement near the cord-grip rolls
              the label edges and detaches it within months.
            </li>
            <li>
              <strong>Hand-held tools / portable battery items:</strong> a flat surface on the body,
              away from grip surfaces. A label on the trigger area does not survive a week of use.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            When an item fails any of the inspection or test stages, the response is three-part. All
            three steps are required by HSG107 paragraph 67 and IET CoP 5th Ed. Chapter 16:
          </p>
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Remove the item from service.</strong> Physically quarantine — a labelled bin,
              a marked area, an unplugging from any outlet. The item cannot be left where a user
              could pick it up.
            </li>
            <li>
              <strong>Record the failure against the asset ID.</strong> The asset register row gets
              the failure result, the failure mode, the date, and the tester. The label is the
              visible flag; the record is the audit trail.
            </li>
          </ol>
          <p>
            If the item is to be repaired, it stays quarantined until the repair is complete and a
            fresh test is carried out. The new PASS label, if applied, includes a new test date and
            a new retest date — the failure history sits in the asset register, not on the new
            label.
          </p>
          <p>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              labels prevent migration of PASS labels between items. A removed label tears visibly.
              The hire-fleet asset register also records who has the item out and when it is due
              back, allowing the retest to be coordinated with returns.
            </li>
            <li>
              <strong>Multi-component items (e.g. trailing socket assemblies):</strong> the label
              goes on the body of the assembly, not on any one of its components. The asset register
              row covers the whole assembly. If a component is replaced (e.g. the flex), the asset
              register notes the replacement and the assembly retains its asset ID.
            </li>
            <li>
            ...
            <li>
              <strong>Visual-only inspections (no electrical test):</strong> some items only receive
              a user check or formal visual inspection on a given visit — for instance between full
              electrical retests. A different label colour (typically blue or with clear
              &ldquo;visual only&rdquo; wording) prevents this being mistaken for a full electrical
              test pass.
            </li>
          </ul>
        </ConceptBlock>
