...
const DESCRIPTION =
  'Understand Building Management Systems and how HVAC integrates with lighting control in commercial and industrial applications for comprehensive building automation.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'Boiler Management Service',
      'Building Maintenance Schedule',
    ],
    correctAnswer: 1,
    explanation:
      "BMS stands for Building Management System - a centralised system that monitors and controls a building's mechanical, electrical, and electromechanical services including HVAC, lighting, and security.",
  },
  {
    question:
      'Which protocol is commonly used for lighting control in commercial BMS installations?',
    options: [
      'Zigbee',
      'Bluetooth',
    ...
    correctAnswer: 2,
    explanation:
      'DALI is the industry standard for commercial lighting control, offering addressable control of individual fixtures, scene management, and integration with BMS via gateways.',
  },
  {
    question: 'What is the main benefit of linking HVAC and lighting through a BMS?',
    options: [
      'Reduced installation cost',
      'Coordinated response to occupancy for maximum efficiency',
      'Simpler maintenance',
      'Faster installation',
    ],
    correctAnswer: 1,
    explanation:
      'Linking HVAC and lighting allows coordinated responses to occupancy - when a space becomes unoccupied, both systems can enter setback mode simultaneously, maximising energy savings.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'While BMS has traditionally been used in large commercial buildings, smaller-scale BMS solutions and smart building platforms are now available for medium-sized premises. The economics favour larger buildings where savings are greater, but technology costs are decreasing.',
  },
  {
    question: 'Can existing buildings be retrofitted with BMS?',
    answer:
      'Yes, though it may be more complex and costly than new-build installation. Wireless sensors and controllers reduce cabling requirements. Phased implementation can spread costs. The key is ensuring existing systems can be interfaced with the BMS.',
  },
  {
    question: 'What skills are needed to work on BMS installations?',
    answer:
      'BMS work requires understanding of HVAC systems, electrical controls, networking/IT, and building automation protocols. Many manufacturers offer training and certification. It is a specialised field that combines traditional electrical/mechanical knowledge with IT skills.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-3xl mx-auto">
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            ...
            manages a building's mechanical, electrical, and electromechanical services. Also known
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-white text-sm">
                ...
                actuators), controllers (processing control logic), and supervisory level (user
                interface, data logging, analytics). Communication occurs over dedicated networks or
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            BMS relies on standardised communication protocols to enable different systems and
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm">
                Building Automation and Control Networks - the ISO standard protocol for building
                automation. Supports multiple transport layers (Ethernet, MS/TP, IP). Widely
                supported by major BMS manufacturers.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-elec-yellow mb-2">Modbus</h4>
              <p className="text-white text-sm">
                Simple, robust protocol originally for industrial control. Common in HVAC equipment.
                Available in serial (RTU) and TCP/IP versions. Widely supported but limited
                functionality compared to BACnet.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-elec-yellow mb-2">DALI</h4>
              <p className="text-white text-sm">
                Digital Addressable Lighting Interface - specific to lighting control. Allows
                individual fixture addressing, dimming, and scene control. Integrates with BMS via
                gateways that convert DALI to BACnet or Modbus.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-elec-yellow mb-2">KNX</h4>
              <p className="text-white text-sm">
                European standard for building automation, popular for commercial and high-end
                residential. Supports lighting, HVAC, blinds, and security. Can interface with BMS
                systems via gateways.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Integrating HVAC and lighting through a BMS enables coordinated control that maximises
          ...
          <div className="space-y-4 mb-4">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-white text-sm">
                Presence detectors trigger both lighting and HVAC. When a zone becomes occupied,
                lights turn on and HVAC enters comfort mode. When unoccupied, both systems enter
                setback mode simultaneously.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <h4 className="font-medium text-elec-yellow mb-2">Daylight Harvesting</h4>
              <p className="text-white text-sm">
                Light sensors measure natural light levels. Artificial lighting dims or switches off
                when sufficient daylight is available. Can also inform HVAC about solar gain,
                allowing proactive cooling control.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <h4 className="font-medium text-elec-yellow mb-2">Schedule Synchronisation</h4>
              <p className="text-white text-sm">
                Shared schedules ensure HVAC pre-conditions spaces before occupancy while lights
                remain off until actually needed. Integration with calendar systems allows automatic
                adjustment for meetings and events.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            BMS implementation can deliver significant energy savings in commercial buildings,
            though investment costs are substantial.
          </p>
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            ...
            <p className="text-white text-sm">
              Typical payback periods range from 2-5 years for new installations. Retrofit projects
              may take longer due to higher implementation costs. Non-energy benefits include
              improved comfort, extended equipment life through optimised operation, and reduced
              maintenance through predictive analytics.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm">
                Successful BMS requires careful specification. Define control strategies before
                equipment selection. Ensure interoperability between systems. Plan for future
                expansion and technology changes.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-elec-yellow mb-2">Commissioning</h4>
              <p className="text-white text-sm">
                Thorough commissioning is essential. Test all control sequences. Verify sensor
                calibration. Document setpoints and schedules. Train building operators. Allow
                seasonal commissioning to optimise for different conditions.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-elec-yellow mb-2">Ongoing Maintenance</h4>
              <p className="text-white text-sm">
                BMS requires ongoing attention. Regular sensor calibration. Software updates. Trend
                analysis to identify drift. Periodic review of control strategies as building use
                changes.
              </p>
            </div>
          </div>
        ...
        {/* Section Quiz */}
        <section className="mb-10">
          <Quiz title="Section 6 Knowledge Check" questions={quizQuestions} passingScore={80} />
        </section>
        ...
        <section className="mb-10 p-6 rounded-lg bg-elec-yellow/10 border border-elec-yellow/30 text-center">
          ...
          <p className="text-white mb-4">
            ...
            Monitoring. You now understand smart heating, environmental sensors, control strategies,
