...
const BS7671Module4Section6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 6 · Updated for A4:2026"
      ...
      <HubBody>
        <div className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'What an AFDD detects (series and parallel arc faults that MCBs and RCDs miss), where Reg 421.1.7 mandates them in BS 7671:2018+A4:2026, where Reg 710.421.1.7 prohibits them in medical locations, and how to install and verify them per BS EN 62606.'
          }
        </div>
        ...
        >
          <p>
            ...
            homes have residents with reduced mobility and escape capability; HRRBs (above 18 m or 7
            storeys depending on definition) have vertical-escape constraints. In each, an
        ...
        >
          <p>
            ...
            line-to-earth short. (4) MCB or RCD trips — too late; the fire has already started. The
            AFDD intervenes at step 1, before step 2 irreversibly damages the surrounding material.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 710.421.1.7: AFDDs shall not be used in circuits in medical locations of Group 0 or
            Group 2. The signal-processing electronics that detect arcs occasionally false-trip on
            motor-start transients, certain switching signatures, or unusual waveforms — in a normal
            building the disconnection is an inconvenience, in a Group 2 operating theatre or ICU it
            could end a life. The trade-off favours uninterrupted supply over fire-risk mitigation.
            Group 1 (general medical examination / treatment locations) may use AFDDs subject to the
            manufacturer's coordination guidance.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            via carbonised insulation; parallel arc line-to-PE; arc with connected load (resistive,
            inductive, capacitive); arc test with masking-load (a deliberate adjacent normal load
            that could mask the arc signature). Each test is repeated at multiple current levels and
            cable-length conditions. The standard also requires immunity testing against false-trip
            on dozens of normal-operation waveforms — vacuum cleaners, power tools, switching
            transients, fluorescent ballasts. Compliance with both sides of this matrix —
            sensitivity to arcs AND specificity against false trips — is what BS EN 62606
        ...
        >
          <p>
            ...
            Type A AFDD+RCBO at minimum, with Type F and Type B variants available for VSD-heavy or
            three-phase mixed-load installations.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            care home, or HRRB? If yes → AFDDs MANDATORY on single-phase socket circuits ≤ 32 A (Reg
            421.1.7). Standard owner-occupied dwelling, commercial / industrial? AFDDs RECOMMENDED
            but not mandated; designer's choice.
            <strong> Question 2 — Circuit scope.</strong> The mandate applies to single-phase, AC, ≤
            32 A, supplying SOCKET-OUTLETS. Three-phase circuits, fixed-equipment circuits, lighting
            circuits and circuits over 32 A are out of mandatory scope — recommendation only.
            <strong> Question 3 — Medical Group 0 / 2.</strong> If the premises includes any Group 0
            or Group 2 medical locations, AFDDs are PROHIBITED on those circuits (Reg 710.421.1.7).
            Group 1 medical may use AFDDs subject to the manufacturer's equipment-coordination
            guidance.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            manager rather than the end occupant. The fire-risk reduction is quantifiable (insurance
            underwriters increasingly recognise AFDDs in risk-pricing models). The compliance
            argument cuts both ways: where AFDDs are mandated by Reg 421.1.7, the conversation is
            short — they go in, end of discussion. Where they're recommended, the design rationale
            gets documented on the EIC and the customer signs off on the design choice.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            ignitions are the single largest electrical-cause domestic-fire mode. As AFDD technology
            matures (Generation-3 devices have substantially fewer false-trip issues than
            first-generation), the historical 'too many nuisance trips' objection has weakened. The
            pattern matches RCDs through the late 1990s / 2000s — initially optional, then mandatory
            in stages, then default in new builds. AFDDs are at the 'mandatory in stages' point now.
          </p>
        </ConceptBlock>
