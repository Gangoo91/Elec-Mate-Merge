...
const FireAlarmModule6Section3 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 6 · Section 3" title="Fault finding techniques" backTo=".." />
      <HubBody>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              Investigate. If repair cannot complete today, agree an interim measure (proportionate
              to the affected area). Schedule the repair. The fault stays visible until repaired.
              The conformity statement at the next service visit records the fault as open if it
              remains unresolved.
            </li>
          </ul>
          <p>
            The clause is enforceable. An AHJ or insurer reviewing the documentation can compare the
            panel state, the logbook entries, and the service reports — concealment of a
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              service organization cannot complete an effective repair, fault indications should not
              be concealed (e.g. by suppressing the fault indication).
            </>
          }
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Read the LCD.</strong> The current fault message names the most recent fault.
              Note device, loop, address, fault type.
            </li>
            <li>
            ...
            <li>
              <strong>Cross-reference the asset register.</strong> Identify the device by location,
              technology type, install date, last service date, last contamination level. Has it
              been flagged before? Is it near end of life?
            </li>
            <li>
              <strong>Cross-reference the cause-and-effect matrix.</strong> Is the device programmed
              to do something specific? Could the fault arise from a configuration that does not
              match the as-installed reality?
            </li>
            <li>
              <strong>Plan the visit to the device.</strong> Now go to the device with a hypothesis.
              The visit confirms or refutes the hypothesis quickly because you know what you are
              looking for.
            </li>
            <li>
              <strong>Test, repair, retest.</strong> Apply the device-aware test. Repair the fault.
              Retest at the panel and at the device. Confirm clear.
            </li>
            <li>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="2"
            />
            <text x="440" y="42" textAnchor="middle" fill="#FBBF24" fontSize="12" fontWeight="bold">
              START
            </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Damaged cable.</strong> Crushed by a contractor\'s drill, cut by a sharp edge,
              abraded against a containment.
            </li>
            <li>
              <strong>Stuck MCP.</strong> Mechanical fault — the MCP\'s contacts have stuck in the
              alarm position. Often shows as a permanent alarm rather than a short fault, depending
              on the MCP\'s resistance values.
            </li>
            <li>
              <strong>Failed device terminal block.</strong> Internal short within a detector or MCP
              base.
            </li>
          </ul>
          <p>
            Diagnostic: walk the zone; visual inspection at back-boxes; replace suspect MCP / device
            with a known-good substitute; if water ingress, dry the back-box, repair the source of
            leak, retest after drying. Retest the zone for normal impedance.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Cable damage in earthed containment.</strong> The cable insulation is pierced
              and the conductor leaks to the metal containment.
            </li>
            <li>
          ...
          <p>
            ...
            clamp-meter testing on the live loop to identify the leg / location with the leak. Walk
            the loop, identify the earth contact point, repair. Retest IR after repair to confirm
            leak is cleared.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              single break should lose only the device immediately past the break — eight contiguous
              devices missing means the isolators did not contain the break.
            </li>
            <li>
              <strong>Single device missing intermittently.</strong> Loose terminal at the device,
              marginal cable connection, electrical noise on the loop near that device, or a failing
              device.
            </li>
            <li>
              <strong>All devices missing.</strong> Loop driver failure at the panel, complete loop
              break with no isolator return path, or panel power failure.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Address conflicts are most common after device replacements where the engineer forgot
              to re-program the new device, or after refurbishments where multiple devices are added
              without an asset-register address-allocation discipline.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Addressable loop tester</strong> — programs and queries the loop independently
              of the CIE. Useful for diagnosing whether a device is faulty (does not respond to the
              tester either) or the CIE is misconfigured (device responds to the tester but not the
              CIE).
            </li>
            <li>
            ...
            <li>
              <strong>Test smoke and heat sources</strong> — for functional testing of detectors per
              the manufacturer procedure. Test smoke is canned aerosol calibrated to trigger optical
              / ionisation detectors; heat sources are calibrated heat guns or cradles for heat
              detectors.
            </li>
            <li>
            ...
            <li>
              ...
              matrix, the asset register, the manufacturer manuals. Without these, every diagnostic
              step is guesswork.
            </li>
          </ul>
          <p>
            ...
            electronics. A "I just use a multimeter" approach misses faults that need the specialist
            tools.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Whole-system failure</strong> — panel down, no alarm function, no signalling.
              Response: immediate. Continuous fire watch in occupancy. FRS notified if high-risk
              premises (sleeping accommodation, care). Repair within hours. Contractual SLA should
              provide for this.
            </li>
            <li>
            ...
            <li>
              ...
              hours. Cover the immediate area (e.g. local supplemental warning in a sleeping zone).
            </li>
            <li>
              <strong>Single device failure (general area)</strong> — a detector or MCP in a general
              area. Response: at the next service visit if non-urgent, sooner if the pattern
              suggests a developing issue. Disable the failed device; the rest of the system
              continues.
            </li>
            <li>
          ...
          <p>
            ...
            is more urgent than the same failure in an office storeroom. The responsible person owns
            the decision on interim measures; the service organisation advises and documents.
          </p>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            ...
            {
              question: 'Why does "contiguous loss of devices" indicate a single fault, not many?',
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-6/section-4')}
