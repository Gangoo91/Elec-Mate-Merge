...
const inlineChecks = [
  ...
  },
  {
    ...
    question: 'Appendix 6 of BS 7671:2018+A4:2026 contains what?',
    options: [
  ...
  },
  {
    ...
    question: 'What is the practical difference between the EIC and the MEIWC?',
    options: [
  ...
  },
  {
    ...
    question: 'On the EIC, where do departures from BS 7671 get recorded?',
    options: [
  ...
  },
  {
    ...
    question: 'What is an EICR for, and what does it produce?',
    options: [
...
const faqs = [
  {
    question: 'How is Part 6 restructured in A4:2026 — should I throw out my old notes?',
    answer:
  ...
  {
    question: 'What changed in Appendix 6 for A4:2026?',
    answer:
  ...
  {
    question: 'When should I use EIC vs MEIWC for LCT work?',
    answer:
  ...
  {
    question: 'What goes in the "Departures from BS 7671" section of the EIC?',
    answer:
  ...
  {
    question: 'On a hybrid LCT install, how many notifications am I actually making?',
    answer:
  ...
  {
    question: 'How long should I keep the cert evidence bundle?',
    answer:
  ...
  {
    question: 'Are model forms in Appendix 6 the same as MCS-required documentation?',
    answer:
...
export default function RenewableEnergyModule1Section8() {
  ...
  useSEO({
    title: 'Notifications, certs & the paperwork trail | Renewable Energy 1.8 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 8 · BS 7671:2018+A4:2026"
        title="Notifications, certs & the paperwork trail"
        backTo="../renewable-energy-module-1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The complete cert evidence bundle for an LCT install — BS 7671 EIC and Part 6 model forms
          (restructured in A4), CPS Part P notification, DNO G98 / G99 notification, MCS
          certificates, SEG / BUS / ECO funding paperwork, and the Reg 133.1.3 equipment-usage
          records that make the cert the durable audit trail.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">2016</strong> — CENELEC publishes HD 60364-6
              (Harmonisation Document on inspection and testing). BS 7671 Part 6 aligns with HD
              60364-6 at this point. As a structural artefact, chapters 61–63 are not used and Part
              6 starts at Chapter 64.
            </li>
            <li>
              <strong className="text-white">A1 / A2 / A3 (2020–2024)</strong> — Part 6 is largely
              stable during these amendments; the 2016 alignment numbering persists.
            </li>
            <li>
              <strong className="text-white">A4:2026</strong> — Part 6 is further restructured and
              renumbered as the latest tranche of the CENELEC alignment. The technical content is
              largely preserved; the apparatus is updated.
            </li>
          </ul>
          ...
          <p>
            The practical task for the LCT installer is to update working references and cert
            templates to use the A4-aligned numbering. The 2026+ cert citing pre-A4 Part 6 numbers
            is an audit finding even where the underlying work is correct.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">EIC</strong> — Electrical Installation Certificate. For
              new installation, addition or alteration involving new circuits. The standard cert for
              LCT installs that include dedicated new circuits (EV per Section 722, PV / BESS / heat
              pump).
            </li>
            <li>
              <strong className="text-white">MEIWC</strong> — Minor Electrical Installation Works
              Certificate. For work on existing circuits with no new circuit added. Several minor
              works on a single circuit may be covered by one MEIWC.
            </li>
            <li>
              <strong className="text-white">EICR</strong> — Electrical Installation Condition
              Report. The formal inspection report on an existing installation. Assigns observation
              codes (C1 / C2 / C3 / FI) and drives remedial work prioritisation.
            </li>
          </ul>
          <p>
            A4:2026 brought minor changes to the certificates and updated the inspection items for
            new installation work in domestic and similar premises with up to 100 A supply. The
            competent installer uses the A4-aligned forms; pre-A4 forms issued on 2026+ work are an
            audit finding.
          </p>
          <p>EICR observation codes:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">C1 — Danger present</strong>. Immediate action
              required.
            </li>
            <li>
              <strong className="text-white">C2 — Potentially dangerous</strong>. Urgent remedial
              work.
            </li>
            <li>
              <strong className="text-white">C3 — Improvement recommended</strong>. No immediate
              danger but improvement advised.
            </li>
            <li>
              <strong className="text-white">FI — Further investigation required</strong>. The
              inspector cannot determine the condition without more information.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 133.1.3 (Selection of equipment) was modified in A4 to require that certain usage of
            equipment shall be recorded on the appropriate electrical certification specified in
            Part 6 of BS 7671. The recording requirement is triggered where BS 7671 explicitly
            indicates that the usage of a particular item of equipment is to be documented.
          </p>
          <p>LCT-relevant equipment-usage decisions that may fall under 133.1.3:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">PEN-fault protective measure</strong> chosen on
              PME-supplied EV chargepoints (per Reg 722.411.4.1) — integral voltage monitoring, TT
              island, or equivalent
            </li>
            <li>
              <strong className="text-white">Bidirectional protective device</strong> specified per
              Reg 551.7.1(c) on grid-tied PV, BESS or V2G interfaces
            </li>
            <li>
              <strong className="text-white">Specific protective devices</strong> on a BESS
              interface under Chapter 57 — including fuse selection, isolator arrangement, and any
              bidirectional protection
            </li>
            <li>
              <strong className="text-white">RCD type</strong> selected (Type A / B / F) where the
              LCT load requires a specific type
            </li>
          </ul>
          <p>
            The record on the cert is clear and traceable to the circuit, location, or protective
            measure involved. The 2026+ inspector reading the cert in 2031 reads the design intent —
            what was chosen, where, why — rather than inferring it from the install.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">The departure itself</strong> — name the BS 7671
              regulation departed from and describe what was done differently
            </li>
            <li>
              <strong className="text-white">The alternative measure</strong> — describe the
              technical alternative adopted in place of the regulation\'s requirement
            </li>
            <li>
              <strong className="text-white">The equivalent-safety reasoning</strong> — explain how
              the alternative delivers at least equivalent safety to the regulation\'s requirement,
              under Reg 120.3
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              Alternative chargepoint isolation arrangement where the standard route is impractical
            </li>
            <li>PV mounting fixings that depart from the manufacturer\'s standard pattern</li>
          </ul>
          <p>
            An unrecorded departure is non-compliance with documentation, not a Reg 120.3 departure.
            EAWR Reg 4 (the absolute statutory duty under the Electricity at Work Regulations 1989)
            bites on the underlying installation; the missing record removes the BS 7671 defence.
            The cost of recording is small; the cost of an unrecorded departure surfacing in dispute
            is large.
          </p>
        </ConceptBlock>
        ...
        <Pullquote>
          A hybrid install triggers five to seven notifications. Treat it as project management.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Part P via CPS</strong> — within 30 days of completion.
              CPS notifies Building Control on installer\'s behalf. Customer receives Building
              Regulations compliance certificate within weeks.
            </li>
            <li>
              <strong className="text-white">DNO via EREC G98</strong> — within 28 days of
              energisation. Fit-and-notify route for ≤ 16 A per phase generation.
            </li>
            <li>
              <strong className="text-white">DNO via EREC G99</strong> — per the application
              approval timing. Apply-and-wait route for &gt; 16 A per phase generation. Approval
              typically precedes install for G99.
            </li>
            <li>
              <strong className="text-white">MCS certificate registration</strong> — for each MIS /
              MPS combination on the install. The MCS certificate is the customer\'s evidence for
              funding applications.
            </li>
            <li>
              <strong className="text-white">SEG application via supplier</strong> —
              customer-driven, with installer providing MCS cert and DNO notification reference.
              Supplier processes the application and starts export payments.
            </li>
            <li>
              <strong className="text-white">BUS application</strong> — where the heat pump is
              BUS-eligible. Typically installer-driven on behalf of the customer.
            </li>
            <li>
              <strong className="text-white">ECO4 / GBIS application</strong> — where the install is
              funded through the obligated supplier route. Process driven by the delivery partner.
            </li>
            <li>
              <strong className="text-white">
                Planning / listed-building completion notifications
              </strong>{' '}
              — where applicable, the local planning authority is notified of completion.
            </li>
          </ul>
          <p>
            Each notification has its own deadline. Each has its own downstream consumer (Building
            Control, DNO, MCS Service Company, electricity supplier, BUS administrator, ECO
            obligated supplier, LPA). The competent LCT contractor treats the post-install workflow
            as a project management exercise — checklist every notification per job, tick them off
            as completed, audit the workflow at year-end.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">PI insurers at renewal</strong> — every 12 months.
              Bundle quality affects offered cover terms.
            </li>
            <li>
              <strong className="text-white">MCS auditors at scheme audit</strong> — typically
              annual but risk-weighted. Sampled job review.
            </li>
            <li>
              <strong className="text-white">EICR inspectors at periodic inspection</strong> — every
              5–10 years depending on property type. The bundle is the design audit trail.
            </li>
            <li>
              <strong className="text-white">HSE in EAWR investigation</strong> — in the event of an
              electrical incident. The bundle is the contemporaneous evidence of competent practice.
            </li>
            <li>
              <strong className="text-white">Customer at property sale</strong> — the bundle becomes
              part of the conveyancing pack. Affects property value and buyer due diligence.
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">DNO at any future capacity review</strong> — the bundle
              records the original generation / load notification.
            </li>
          </ul>
          ...
          <p>
            The bundle is retained electronically with off-site backup. Practical retention: the
            working life of the installation, plus the limitation period. For LCT installs that is
            typically 25+ years. The cost of retention is minimal; the cost of an unavailable bundle
            when a claim or dispute arises is the unavoidable failure mode.
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-1-section-7')}
