...
const DataCablingModule1Section4 = () => {
  useSEO({
    title: "Network Speed & Future Proofing | Data Cabling Module 1.4",
    description: "Learn about network bandwidth, data rates, and strategies for future-proofing structured cabling infrastructure."
  });
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/upskilling/data-cabling-module-1-section-3">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous Section
            </Link>
          </Button>
