    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Ethernet evolution from 10BASE-T (1990) to 25GBASE-T (2016), the 100 m channel rule
          preserved across every variant, and the specification discipline of future-proofing —
          picking a Class with enough headroom for foreseeable services, generous outlet density,
          pathway capacity, and a BS 7671:2018+A4:2026 §716 PoE growth path that the cabling can
          absorb without re-pulling.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              <strong>10BASE-T (IEEE 802.3i, 1990).</strong> 10 Mbps over 2 pairs of Cat3 / Class C
              cabling, 100 m channel. The variant that started the structured-cabling era — cheap
              UTP replaced expensive coax bus and made the physical-star generic topology
              economically attractive.
            </li>
            <li>
              <strong>100BASE-TX (IEEE 802.3u, 1995).</strong> 100 Mbps over 2 pairs of Cat5 / Class
              D, 100 m channel. The "fast Ethernet" of the 1990s — and the variant that fixed the
              100 m channel rule that every subsequent twisted-pair Ethernet has preserved.
            </li>
            <li>
              <strong>1000BASE-T (IEEE 802.3ab, 1999).</strong> 1 Gbps over 4 pairs of Cat5e / Class
              D, 100 m channel, PAM-5 signalling. The breakthrough that made gigabit economic — and
              the variant against which "gigabit to the desk" became the default expectation. A 1999
              Cat5e office build that was honestly Class D delivered gigabit without re-pulling.
            </li>
            <li>
              <strong>10GBASE-T (IEEE 802.3an, 2006).</strong> 10 Gbps over 4 pairs, full duplex,
              DSQ128 signalling at 400 MHz fundamental. Reach is 100 m on Class EA / Cat6A and only
              55 m on Class E / Cat6 due to alien crosstalk. The variant that drove Cat6A adoption
              as the post-2010 default — 10G to the desk on a single Cat6A install with 100 m
              headroom.
            </li>
            <li>
              <strong>2.5GBASE-T / 5GBASE-T (IEEE 802.3bz, 2016) — "NBASE-T".</strong> Intermediate
              speeds engineered specifically to run on existing Cat5e / Cat6 installations at full
              100 m. Use case: Wi-Fi 5 / 6 APs needing more than gigabit uplinks, in buildings where
              re-cabling Cat5e to Cat6A was uneconomic. A masterful example of preserving the
              channel budget across a speed transition.
            </li>
            <li>
              <strong>25GBASE-T / 40GBASE-T (IEEE 802.3bq, 2016).</strong> 25 / 40 Gbps over 4 pairs
              of Cat8 / Class I or II — 30 m CHANNEL only, 2 connector terminations. This is
          ...
          <p>
            ...
            IEEE 802.3 has variants engineered to specific reach budgets on specific media — but the
            medium is no longer twisted pair.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Information and communication technology (ICT) cables used for the distribution of DC
              power shall comply with Category 5, Category 6, Category 6A, Category 7, Category 7A,
              Category 8.1 or Category 8.2 or other cables as defined in BS EN 50173-1 by reference
              to the specifications given in BS EN 50288 series.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            ...
            <li>
              ...
              F/UTP and S/FTP variants. For PoE-heavy installs (sustained Type 4), screened variants
              control alien crosstalk and offer better thermal performance in tight bundles. For
              general office at moderate PoE, UTP variants are acceptable. The choice affects the
              certificate — a screened cable correctly bonded under §444.5.3.1 will out-perform an
              unscreened equivalent, especially in high-PoE bundles.
            </li>
            <li>
              ...
              Whichever you pick, the certificate is the deliverable, and it is the future-proofing
              artefact.
            </li>
          </ul>
          <p>
            Class headroom is defensible at handover because it is measured, not promised. A future
            contractor reading the certificates can see exactly how much margin was installed and
            can predict — quantitatively — how much further the cabling can be pushed before re-pull
            becomes necessary. That is what future-proofing actually looks like in spec terms.
          </p>
        </ConceptBlock>
          ...
          >
            ...
            {[
              ...
              },
              {
                ...
                caption: 'Long-running default since 1999 · uses all four pairs · PAM-5 line code',
              },
              {
                top: 400,
                name: '100BASE-TX',
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              <strong>Cat6A balanced copper to general outlets.</strong> Class EA at 100 m channel.
              Delivers 10GBASE-T, NBASE-T (2.5 / 5G), 1000BASE-T, 100BASE-TX, all IP-based services,
              and Type 4 PoE within the 750 mA per-conductor cap. Standard RJ45 connectors.
              Industry-standard patch panels. The default building-wide horizontal medium.
            </li>
            <li>
              <strong>Multi-mode fibre (OM4 / OM5) to high-density areas.</strong> Aqua jacket (OM4)
              or lime-green jacket (OM5). Used as risers (BD-FD), data-centre uplinks, AP-cluster
              feeds, broadcast / lab feeds. Reach: OM4 typically delivers 100GBASE-SR4 to 100 m, OM5
              stretches further with SWDM4. LC duplex connectors are the modern default; MPO/MTP for
              40 / 100 GbE parallel optics.
            </li>
            <li>
              ...
              buildings, and any service that needs to be vendor-agnostic on transceiver generation.
              Reach: typically 10 km with appropriate optics; far longer with amplification. The
              conservative future-proof choice for any backbone.
            </li>
          </ul>
          <p>
            Cat8 has a place — short data-centre TOR copper from a top-of-rack switch to servers in
            the same or adjacent rack. Use it there. Do not specify it building-wide. The hybrid
            Cat6A + fibre approach is the defensible 2026 future-proof default.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            ...
            <li>
              ...
              guidance. ANSI/TIA TSB-184-A is the matching TIA reference. Core practical rule: limit
              bundle size, separate bundles physically, use 23 AWG cable (LP-rated where
              appropriate).
            </li>
            <li>
              <strong>Bonding (§444.5.3.1).</strong> Cable basket, screens, sheaths bonded into the
              equipotential bonding network. Mesh size ≤ 2 m × 2 m for areas with susceptible ICT
              equipment (§444.1.3).
            </li>
            <li>
              <strong>Functional earthing (§545.1.2).</strong> Functional earthing conductors
              minimum 2.5 mm² Cu (with mechanical protection) or 4 mm² Cu (without). MFET per §545.2
              if multiple functional bonding conductors exist.
            </li>
            <li>
              <strong>SELV / PELV (§716.410.3.3).</strong> The protective measure SELV or PELV shall
              be applied. Source per §716.414.1.1 — PSE conforming to BS EN IEC 62368-1 + BS EN
              60950-22 + ISO/IEC/IEEE 8802-3 interoperability requirements.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={<>The load current (design current) in any conductor shall not exceed 750 mA.</>}
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A specifier writes "Cat8 horizontal cabling building-wide for future-proofing against
              25 / 40 GbE" and "100 W PoE-ready" into a 2026 tender. Both are wrong: Cat8 is a 30 m
              data-centre TOR cable (it cannot reach 100 m), and there is no 100 W PoE class (Type 4
              is 90 W PSE / 71.3 W PD, with the BS 7671 §716.523.2.101 hard cap at 750 mA per
              conductor). The contractor either bids the wrong product, bids it at unjustified
              premium, or wastes design effort proving the spec is impossible — and the building
              ends up with a non-future-proof install anyway.
            </>
          }
          doInstead={
            <>
              Specify Cat6A / Class EA general copper + fibre (OM4 / OM5 / OS2) to high-density
              areas as the 2026 hybrid future-proof default. Specify PoE compliance to IEEE 802.3bt
              Type 4 (90 W PSE / 71.3 W PD) and to BS 7671:2018+A4:2026 §716 — design current ≤ 750
              mA per conductor (§716.523.2.101), connecting hardware ≥ 750 mA per contact
              (§716.526.101), Cat 5/6/6A/7/7A/8.1/8.2 permitted (§716.521.101). Reference BS EN
              50174-2 / TIA TSB-184-A for bundle thermal management. Quote the clauses verbatim
              where it helps the tender — A4:2026 publishing on 15 April 2026 makes the references
              unambiguous.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              sustained PoE for lighting and access control, future tenant requirements unknown. The
              client wants a single cabling spec that absorbs the whole building life.
            </>
          }
          whatToDo={
            <>
              Specify a HYBRID future-proof default. (1) Horizontal: Cat6A S/FTP (screened) to every
              general work-area outlet and ceiling AP location, certified Class EA with margin
              (record the test results), bonded under §444.5.3.1, design-current analysis showing
              worst-case &lt; 750 mA per conductor at projected Type 4 PoE bundle counts. (2) Outlet
              density: at least two outlets per workpoint plus ceiling-mounted outlets at AP
              positions on a 50 m² grid. (3) Pathway: basket fill ≤ 50 % at first fit, with
              secondary basket runs in each riser shaft for growth; ducts to AP locations sized for
              2× current cable count. (4) Backbone: two diversely-routed 12-core OM4 risers per
              floor (FD-BD), two 12-core OS2 risers per floor for long-life flexibility, single-mode
              counts to allow dense WDM if needed. (5) Inter-building (if applicable): OS2 to the CD
              with appropriate redundancy. (6) Documentation: BS EN 50174-1 / TIA-606-D
              administration record, certificates per channel, design-current per bundle recorded in
              the as-built so future contractors inherit the assumption explicitly.
            </>
          }
          whyItMatters={
            <>
