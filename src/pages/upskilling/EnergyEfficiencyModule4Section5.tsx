    ...
    <div className="min-h-screen overflow-x-hidden bg-[#1a1a1a] text-white">
      ...
      <header className="bg-[#242424] border-b border-gray-700 px-4 py-6">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-elec-yellow flex items-center gap-3">
            ...
            Section 5: ROI Calculators and Energy Saving Tools
          </h1>
          <p className="text-gray-300 mt-2">
            Master the financial tools and calculations needed to evaluate and
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 space-y-10">
        ...
        <section className="space-y-4">
          ...
          <div className="bg-[#242424] rounded-lg p-6 border border-gray-700 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Simple payback period is the most commonly used metric in
                  energy efficiency, representing the time required for energy
                  savings to recover the initial investment cost. While
                  straightforward, understanding its limitations is crucial for
            ...
            {/* Formula Box */}
            <div className="bg-[#1a1a1a] rounded-lg p-4 border border-elec-yellow">
            ...
            {/* Worked Example */}
            <div className="bg-[#2a2a2a] rounded-lg p-5 border border-gray-600">
              ...
              <div className="space-y-3 text-gray-300">
                <p>
                  <strong>Scenario:</strong> A warehouse replaces 100
                  fluorescent fittings with LED equivalents.
                </p>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-[#1a1a1a] p-3 rounded">
                    <p className="text-sm text-gray-400">Project Costs:</p>
            ...
            <div className="bg-orange-900/20 border border-orange-700 rounded-lg p-4">
              ...
              <ul className="text-gray-300 text-sm space-y-1">
                <li>
                  - Does not account for the time value of money (£1 today worth
                  more than £1 in 5 years)
                </li>
                <li>
                ...
                <li>
                  - Cannot compare projects with different lifespans effectively
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-[#242424] rounded-lg p-6 border border-gray-700 space-y-4">
            <div className="flex items-start gap-3">
              <PoundSterling className="w-6 h-6 text-elec-yellow flex-shrink-0 mt-1" />
              <div>
                <h3 className="font-semibold text-lg mb-2">
                  Understanding Time Value of Money
                </h3>
                <p className="text-gray-300">
                  NPV accounts for the fact that money received in the future is
                  worth less than money today. By discounting future cash flows,
                  NPV provides the true value of an investment in today's terms,
                  enabling accurate comparison between projects with different
                  timescales.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#2a2a2a] rounded-lg p-5 border border-gray-600">
              <h4 className="font-semibold text-elec-yellow mb-3">
                UK Standard Discount Rates
              </h4>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-[#1a1a1a] p-4 rounded border border-blue-600">
                  <h5 className="text-blue-400 font-semibold mb-2">
                    Public Sector
                  </h5>
                  <p className="text-2xl font-bold text-white mb-1">3.5%</p>
                  <p className="text-sm text-gray-400">
                    HM Treasury Green Book standard rate for projects up to 30
                    years
                  </p>
                  <p className="text-xs text-gray-500 mt-2">
                    Declining rate schedule for longer-term projects: 3.0% for
                    years 31-75
                  </p>
                </div>
                <div className="bg-[#1a1a1a] p-4 rounded border border-green-600">
                  <h5 className="text-green-400 font-semibold mb-2">
                    Private Sector
                  </h5>
                  <p className="text-2xl font-bold text-white mb-1">8-15%</p>
                  <p className="text-sm text-gray-400">
                    Varies by organisation, typically based on WACC or hurdle
                    rate
                  </p>
                  <p className="text-xs text-gray-500 mt-2">
                    Higher rates reflect risk premium and opportunity cost of
                    capital
                  </p>
                </div>
              </div>
            ...
            <div className="bg-[#2a2a2a] rounded-lg p-5 border border-gray-600">
              ...
              <div className="space-y-3 text-gray-300">
                <p>
                  <strong>Scenario:</strong> Council building HVAC replacement,
                ...
                <div className="bg-green-900/30 border border-green-700 rounded p-3 mt-3">
                  <p className="font-semibold text-green-400">
                    Total NPV = £16,289 (Positive NPV = Financially Viable)
                  </p>
                  <p className="text-sm text-gray-400 mt-1">
                    Excel formula: =NPV(0.035, B2:B11) + B1 (where B1 is the
                    initial cost as negative)
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-[#242424] rounded-lg p-6 border border-gray-700 space-y-4">
            <div className="flex items-start gap-3">
              <Percent className="w-6 h-6 text-elec-yellow flex-shrink-0 mt-1" />
              <div>
                <h3 className="font-semibold text-lg mb-2">
                  The Universal Comparison Metric
                </h3>
                <p className="text-gray-300">
                  IRR is the discount rate at which NPV equals zero. It
                  represents the project's effective annual return, making it
                  ideal for comparing investments of different sizes. If IRR
                  exceeds your required rate of return (hurdle rate), the
            ...
            <div className="bg-[#2a2a2a] rounded-lg p-5 border border-gray-600">
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  <strong>Scenario:</strong> Choose between two energy
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-[#1a1a1a] p-4 rounded border border-blue-600">
                    ...
                    <ul className="text-sm space-y-1">
                      ...
                      <li className="text-blue-400 font-semibold pt-2">
                        IRR: 24.5%
                      </li>
                    </ul>
                  </div>
                  <div className="bg-[#1a1a1a] p-4 rounded border border-purple-600">
                    ...
                    <ul className="text-sm space-y-1">
                      ...
                      <li className="text-purple-400 font-semibold pt-2">
                        IRR: 19.8%
                      </li>
                    </ul>
                  </div>
                ...
                <div className="bg-[#1a1a1a] p-3 rounded">
                  <p className="text-sm">
                    <strong className="text-elec-yellow">Analysis:</strong>{' '}
                    While Project B has a longer payback, Project A's higher IRR
                    (24.5% vs 19.8%) indicates better return per pound invested.
                    However, Project B generates more total savings (£270,000 vs
                    £36,000 over lifetime). Decision depends on budget
                ...
                <div className="bg-[#1a1a1a] p-3 rounded border border-gray-600">
                  <p className="text-sm text-gray-400">
                    <strong className="text-white">Excel Formula:</strong> =IRR(
                    range of cash flows ) where the first value is the negative
                    initial investment
                  </p>
                  <p className="text-sm text-gray-400 mt-1">
        ...
        <section className="space-y-4">
          ...
          <div className="bg-[#242424] rounded-lg p-6 border border-gray-700 space-y-4">
            <div className="flex items-start gap-3">
              <BarChart3 className="w-6 h-6 text-elec-yellow flex-shrink-0 mt-1" />
              <div>
                <h3 className="font-semibold text-lg mb-2">
                  The Complete Picture
                </h3>
                <p className="text-gray-300">
                  Life Cycle Cost (LCC) analysis captures all costs associated
                  with an asset from acquisition through disposal. This
                  comprehensive approach reveals the true cost of ownership and
                  often shows that higher upfront costs deliver lower total
                  costs over the asset's lifetime.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#2a2a2a] rounded-lg p-5 border border-gray-600">
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  <strong>Scenario:</strong> Selecting a 15kW motor with 20-year
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      ...
                      <tr className="border-b border-gray-700 bg-[#1a1a1a]">
                        <td className="py-2 font-semibold">Total LCC</td>
                        <td className="text-right font-semibold text-red-400">
                          £137,400
                        </td>
                ...
                <p className="text-xs text-gray-500">
                  *Based on efficiency of 89% (IE2) vs 92% (IE4), electricity at
                  £0.14/kWh
                </p>
                ...
                <div className="bg-green-900/30 border border-green-700 rounded p-3">
                  ...
                  <p className="text-sm text-gray-400 mt-1">
                    The £600 premium delivers 22x return over the motor's
                    lifetime
                  </p>
                </div>
              </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-[#242424] rounded-lg p-6 border border-gray-700 space-y-4">
            <div className="flex items-start gap-3">
              <FileSpreadsheet className="w-6 h-6 text-elec-yellow flex-shrink-0 mt-1" />
              <div>
                <h3 className="font-semibold text-lg mb-2">
                  Essential Tools for Every Practitioner
                </h3>
                <p className="text-gray-300">
                  Numerous free tools are available to support energy efficiency
                  calculations. Knowing which tool to use for each situation
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-[#2a2a2a] p-4 rounded-lg border border-gray-600">
                ...
                <ul className="text-sm text-gray-300 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Energy efficiency calculators for lighting, motors, HVAC
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <ArrowRight className="w-4 h-4 text-gray-500 flex-shrink-0 mt-0.5" />
              ...
              <div className="bg-[#2a2a2a] p-4 rounded-lg border border-gray-600">
                ...
                <p className="text-xs text-gray-500 mt-2">gov.uk/guidance</p>
              </div>
            </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-[#242424] rounded-lg p-6 border border-gray-700 space-y-4">
            <div className="flex items-start gap-3">
              <Briefcase className="w-6 h-6 text-elec-yellow flex-shrink-0 mt-1" />
              <div>
                <h3 className="font-semibold text-lg mb-2">
                  Convincing Decision-Makers
                </h3>
                <p className="text-gray-300">
                  Technical excellence alone rarely secures project approval. A
                  compelling business case speaks the language of finance,
                  addresses risks, and aligns with organisational priorities.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#1a1a1a] rounded-lg p-4 border border-elec-yellow">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-elec-yellow text-[#1a1a1a] flex items-center justify-center text-sm font-bold flex-shrink-0">
                    1
                  </div>
                  <div>
                    <p className="font-semibold text-white">Executive Summary</p>
                    <p className="text-sm text-gray-400">
                      Key numbers upfront: investment required, annual savings,
                      payback, NPV
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      Link to corporate objectives, net zero targets,
                      regulations
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-white">Options Analysis</p>
                    <p className="text-sm text-gray-400">
                      Compare alternatives including 'do nothing' baseline
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-white">Financial Analysis</p>
                    <p className="text-sm text-gray-400">
                      Payback, NPV, IRR with sensitivity analysis
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      Identify risks and explain how they'll be managed
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        Show ongoing costs of inaction
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        Grants, Salix loans, green finance
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-[#2a2a2a] rounded-lg p-5 border border-gray-600">
              ...
              <p className="text-gray-300 text-sm mb-3">
                Show decision-makers how project viability changes with
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-600">
                      ...
                      <th className="text-right py-2 text-gray-400">NPV</th>
                      <th className="text-right py-2 text-gray-400">Payback</th>
                    </tr>
                  </thead>
                  <tbody className="text-gray-300">
                    <tr className="border-b border-gray-700">
              ...
              <p className="text-xs text-gray-500 mt-2">
                Even conservative estimates show positive NPV, reducing
                perceived risk
              </p>
            </div>
          </div>
        ...
        <section className="bg-gradient-to-r from-[#2a2a2a] to-[#1f1f1f] rounded-lg p-6 border-2 border-elec-yellow">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-[#1a1a1a] p-4 rounded-lg">
              ...
              <p className="text-xs text-gray-400 mt-1">Result in years</p>
            </div>
            <div className="bg-[#1a1a1a] p-4 rounded-lg">
            ...
            <div className="bg-[#1a1a1a] p-4 rounded-lg">
              ...
              <p className="text-xs text-gray-400 mt-1">
                Initial cost as negative value
              </p>
            </div>
            <div className="bg-[#1a1a1a] p-4 rounded-lg">
              ...
              <p className="text-xs text-gray-400 mt-1">
                Include initial cost in range
              </p>
            </div>
            <div className="bg-[#1a1a1a] p-4 rounded-lg">
              <h3 className="font-semibold text-white mb-2">Annual Savings</h3>
              <p className="font-mono text-elec-yellow text-sm">
                Savings = kWh_reduced x £/kWh
              </p>
              <p className="text-xs text-gray-400 mt-1">
                Use actual tariff rates
              </p>
            </div>
            <div className="bg-[#1a1a1a] p-4 rounded-lg">
              <h3 className="font-semibold text-white mb-2">
                UK Public Sector Rate
              </h3>
              <p className="font-mono text-elec-yellow text-sm">
                Discount Rate = 3.5%
              </p>
        ...
        <section className="space-y-4">
          ...
          <Quiz
            ...
            moduleId="energy-efficiency-module-4"
            sectionId="section-5"
          />
        </section>
