...
const inlineChecks = [
  ...
  {
    id: 'm6s5-ik-rating',
    question: 'BS EN 62262:2002 +A1:2021 — what does the IK code measure?',
    options: [
...
const quizQuestions = [
  ...
  {
    question: 'Where does Section 522 (external influences) interact with the wallbox install?',
    options: [
...
export default function RenewableEnergyModule6Section5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 5 · BS 7671:2018+A4:2026 · Reg 522 + 722.551.7.2 + BS EN 62262"
        title="Outdoor install — IP, location, mounting"
        backTo="../renewable-energy-module-6"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The practical physical install of the outdoor wallbox: IP rating per BS EN 60529, IK code
          per BS EN 62262, mounting height + accessibility, cable routing + wall penetration, Reg
          522 external influences assessment, manufacturer instructions integration.
        </p>
        ...
        <Pullquote>
          The IP rating only protects the wallbox if the install keeps it intact. Wrong glanding
          defeats the whole enclosure.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">First digit (solids)</strong> — 0 = no protection; 4 =
              wires &gt; 1 mm; 5 = dust-protected (limited ingress, no harmful deposit); 6 =
              dust-tight
            </li>
            <li>
              <strong className="text-white">Second digit (water)</strong> — 0 = no protection; 4 =
              splashing from any direction; 5 = jets; 6 = powerful jets; 7 = temporary immersion; 8
              = continuous immersion
            </li>
            <li>
              <strong className="text-white">UK outdoor wallbox typical</strong> — IP54 (5+4) for
              sheltered sites (under eaves, side wall); IP65 (6+5) for exposed sites (windward, no
              overhang); IP66 (6+6) for fully exposed marine or industrial
            </li>
            <li>
              <strong className="text-white">Where IP rating fails</strong>— improper cable
              glanding, mounting orientation that allows water pooling near vents, customer
              modifications (drilled extra holes for cable routing), enclosure damage that breaks
              the seal
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong>— records the wallbox’s
              factory IP rating + the install’s cable glanding + photographs showing the entry is
              properly sealed
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">IK00-IK06</strong> — no protection to 1 J. Not used for
              outdoor EV
            </li>
            <li>
              <strong className="text-white">IK07</strong> — 2 J. Some indoor-mounted wallboxes
            </li>
            <li>
              <strong className="text-white">IK08</strong> — 5 J. Common UK 2025-26 outdoor wallbox
              housing rating
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">IK10</strong> — 20 J. Premium / exposed-site wallboxes;
              some commercial / public charging kit
            </li>
            <li>
              <strong className="text-white">Reg 722.551.7.2</strong>
              cross-references BS EN 62262 for enclosure mechanical impact protection; the designer
              selects the rating appropriate to the site
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Non-combustible backboard, manufacturer fixings, IP-rated glanding. Get these three right
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Solid masonry (brick / block)</strong> — direct
              mounting with manufacturer supplied wall plugs. Most common UK 2025-26 domestic site
            </li>
            <li>
              <strong className="text-white">Solid concrete</strong> — concrete fixings (sleeve
              anchors, chemical resin). More cost / time than brick
            </li>
            <li>
              <strong className="text-white">Plasterboard partition</strong>— cannot mount directly.
              Cavity fixings inadequate for the wallbox load + vibration over time. Solution:
              cement-fibre board backboard fixed to studs; wallbox mounts on the board
            </li>
            <li>
              <strong className="text-white">Stud-and-board (timber stud + plasterboard)</strong> —
              backboard onto studs, then wallbox on the backboard. Studs must align with the wallbox
              fixing points
            </li>
            <li>
              <strong className="text-white">External timber / wooden fence</strong> — not
              acceptable for direct mounting. Non-combustible backboard fixed to fence posts (solid
              structural members), wallbox on the backboard. Or relocate to a masonry wall
            </li>
            <li>
              <strong className="text-white">Free-standing post</strong>— pre-fabricated
              EV-charging-post enclosures available from some manufacturers; concrete base +
              galvanised steel post + wallbox + protective shroud. Common where no wall is available
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong>— records mounting surface
              + backboard if used + manufacturer-approved fixings + photographs
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Ergonomic plug-in</strong> — ~1.0-1.3 m for typical
              adult; user not kneeling or stretching
            </li>
            <li>
              <strong className="text-white">Cable strain relief</strong>— cable hangs in a loop
              below the wallbox, not pulled straight from the socket. Strain on the Type 2 connector
              shortens its service life
            </li>
            <li>
              <strong className="text-white">Splash protection</strong>— socket above road-spray
              height during heavy rain. ~0.5 m too low risks dirt + splash
            </li>
            <li>
              <strong className="text-white">Accessibility</strong> — reduced mobility users: ~0.9
              m. Equality Act applies on commercial / public; less commonly applied domestic
            </li>
            <li>
              <strong className="text-white">Cable management</strong> — cable holster (tethered
              wallboxes) at appropriate height so the cable doesn’t drag on the ground when stowed
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong>— records mounting height
              + manufacturer instruction reference + customer-side accessibility considerations
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Through external wall</strong>— drill correct diameter
              hole, insert weather sleeve (typically grey PVC conduit length ~150 mm), drip-loop the
              cable downward on the exterior side, seal both interior and exterior with fire-rated
              mastic / silicone
            </li>
            <li>
              <strong className="text-white">Drip loop on exterior</strong>— cable forms a downward
              U on the outside before entering the wall. Rainwater running along the cable drips off
              at the bottom of the loop, NOT tracking into the wall
            </li>
            <li>
              <strong className="text-white">Fire separation</strong> — fire-rated walls (party
              walls, garage-to-dwelling) need fire-rated mastic at the penetration. Approved
              Document B governs the fire performance requirements
            </li>
            <li>
              <strong className="text-white">Mechanical protection</strong>— hollow walls: steel
              sleeve through cavity to prevent rodent / accidental damage. Low-density blocks: steel
              conduit. Mechanical impact zones (where ladders / garden tools could hit cable): steel
              conduit
            </li>
            <li>
              <strong className="text-white">Outdoor cable type</strong>— 6 mm² SWA typical for the
              outdoor section; T+E indoor. The transition between cable types happens at a junction
              box or at the wallbox itself (some wallboxes accept either directly)
            </li>
            <li>
              <strong className="text-white">Glanding at the wallbox</strong> — IP-rated cable gland
              matched to cable diameter. T+E flat cable needs flat-profile gland or converter
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Vehicle strike protection is real on driveway installs. A bollard or kerb costs less than
          a replacement wallbox + diagnosis.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Steel bollard</strong> — galvanised steel, concreted
              into ground, 0.6-1.0 m above ground. Sized to absorb / deflect vehicle strike. Common
              UK 2025-26 install where space allows
            </li>
            <li>
              <strong className="text-white">Concrete parking stop / kerb</strong> — pre-cast
              concrete kerb at parking-bay limit; low-cost; defines the parking position so the
              customer’s wheel hits the kerb before the wallbox
            </li>
            <li>
              <strong className="text-white">Mount offset from vehicle approach</strong> — wallbox
              on the side wall of the garage rather than the back wall; vehicle can’t roll into it
            </li>
            <li>
              <strong className="text-white">Free-standing pole</strong> — pre-fabricated EV
              charging post on concrete base; steel column protects the wallbox; offset from the
              parking position
            </li>
            <li>
              <strong className="text-white">Customer education</strong> — at handover, demonstrate
              the parking position relative to the wallbox; recommend a reverse-parking sensor /
              camera if the vehicle doesn’t have one
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — records the
              strike-protection arrangement; photographs show the bollard / kerb / offset
            </li>
          </ul>
        </ConceptBlock>
