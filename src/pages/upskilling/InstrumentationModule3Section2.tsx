...
const DESCRIPTION =
  'Exploring industry-standard signal formats including 4-20mA, 0-10V, and pulse signals for system integration.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      'A fault condition',
      'The zero or minimum scale value (0%)',
      'The maximum scale value',
      '50% of the range',
    ],
    correctIndex: 1,
    explanation:
      'In the 4-20mA standard, 4mA represents 0% of the measurement range (zero scale). For example, in a 0-100°C temperature measurement, 4mA = 0°C.',
  },
  {
    id: 'm3s2-q2',
    question: 'What does a 0mA reading indicate in a 4-20mA system?',
    options: [
      'The measurement is at minimum',
      'Normal operation',
      'A fault condition such as broken wire',
      '50% of range',
    ],
    correctIndex: 2,
    explanation:
      'In a 4-20mA system, 0mA indicates a fault condition such as a broken wire, power failure, or sensor malfunction. Normal operation should never produce 0mA.',
  },
  {
    id: 'm3s2-q3',
    ...
    options: [
      ...
      'Pulses can be easily counted for running totals',
      'They require less wiring',
      'They are more accurate than current signals',
    ],
    correctIndex: 1,
    explanation:
      'Pulse signals are ideal for flow totalisation because pulses can be easily counted and totalled, providing natural integration of flow data over time.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      '0-10V voltage signals are most affected by cable length due to voltage drop caused by cable resistance and increased susceptibility to electrical noise.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'In a 4-20mA system, 0mA indicates a fault condition such as a broken wire, power failure, or sensor malfunction.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    options: ['4-20mA', 'Below 3.8mA or above 20.5mA', 'Exactly 12mA', 'Between 0-4mA only'],
    correctAnswer: 1,
    explanation:
      'Readings below 3.8mA (under-range) or above 20.5mA (over-range) typically indicate sensor faults or process conditions outside the normal range.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Standardised signal ranges enable interoperability between devices from different manufacturers and simplify system integration and troubleshooting.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Use the formula: Process Value = (Current - 4) × Full Scale / 16. For example, with a 14mA reading on a 0-100°C transmitter: Temperature = (14-4) × 100/16 = 62.5°C.',
  },
  {
    question: 'What is the maximum cable length for 0-10V signals?',
    answer:
      'Generally 50-100 metres maximum, depending on cable quality and electrical environment. Shielded twisted pair cable with proper grounding extends this range. For longer distances, use 4-20mA signals instead.',
  },
  {
    question: 'How do I calculate total flow from pulse output?',
    answer:
      'Divide the total pulse count by the K-factor. For example, with K-factor = 1000 pulses/litre and 216,000 pulses counted: Total flow = 216,000/1000 = 216 litres.',
  },
  {
    question: 'What causes under-range readings in 4-20mA systems?',
    answer:
      'Under-range readings (below 3.8mA) can indicate sensor failure, incorrect calibration, process conditions below the sensor range, or transmitter power supply issues.',
  },
  {
    question: 'Why do some systems use 1-5V instead of 0-10V?',
    answer:
      '1-5V provides a similar live-zero benefit to 4-20mA, where 0V indicates a fault. It is often created by placing a 250Ω resistor in a 4-20mA loop (4mA × 250Ω = 1V, 20mA × 250Ω = 5V).',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">4-20mA, 0-10V, and pulse signals for system integration</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>4-20mA:</strong> Industry standard, live-zero fault detection
              </li>
              <li>
                <strong>0-10V:</strong> Simple, local applications only
              </li>
              <li>
                <strong>Pulse:</strong> Natural totalising, excellent noise immunity
              </li>
              <li>
                <strong>Standards:</strong> Enable universal compatibility
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> 0mA = fault, 4mA = zero, 20mA = full scale
              </li>
              <li>
                <strong>Use:</strong> 250Ω resistor converts 4-20mA to 1-5V
              </li>
              <li>
                <strong>Calculate:</strong> mA = 4 + (% × 16/100)
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The 4-20mA current loop is the most widely used analogue signal standard in industrial
              instrumentation, chosen for its excellent noise immunity, long-distance transmission
              capability, and built-in fault detection through live-zero operation.
            </p>
            ...
            <div className="my-6">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-white/80 text-sm mt-2">
                  Reverse: Process Value = (Current - 4) × Full Scale / 16
                </p>
              </div>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Example: 0-100°C Temperature Transmitter
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  0°C = 4 + (0/100) × 16 = <strong>4.0mA</strong>
                </li>
                <li>
                  25°C = 4 + (25/100) × 16 = <strong>8.0mA</strong>
                </li>
                <li>
                  50°C = 4 + (50/100) × 16 = <strong>12.0mA</strong>
                </li>
                <li>
                  100°C = 4 + (100/100) × 16 = <strong>20.0mA</strong>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The 4-20mA standard evolved as the optimal solution for industrial process control,
              combining excellent technical performance with practical implementation advantages.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Noise Immunity:</strong> Current loops resist EMI better than voltage
                  signals
                </li>
                <li>
                  <strong>Distance:</strong> Reliable transmission over 1000m+ without amplification
                </li>
                <li>
                  <strong>Two-Wire:</strong> Power and signal in same loop reduces wiring
                </li>
                <li>
                  <strong>Linear:</strong> Direct relationship between current and process value
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Standardisation:</strong> Universal acceptance across manufacturers
                </li>
                <li>
                  <strong>Troubleshooting:</strong> Easy measurement with standard multimeter
                </li>
                <li>
                  <strong>Compatibility:</strong> Direct interface to PLCs and DCS systems
                </li>
                <li>
                  <strong>Training:</strong> Widely understood by technicians worldwide
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The 0-10V voltage standard provides simple analogue signalling for local applications
              where simplicity and direct interfacing are more important than noise immunity or
            ...
            <div className="my-6">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <p className="text-white text-sm font-mono">
                  Voltage (V) = (Process Value / Full Scale) × 10
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Pulse signals encode measurement data through frequency or pulse count, providing
              natural totalising capability and excellent noise immunity for applications like flow
              measurement and speed sensing.
            </p>
            ...
            <div className="my-6">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <p className="text-white text-sm">
                  <strong>Turbine Flow Meter with K-factor: 1000 pulses/litre</strong>
                </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                ...
                <li>
                  <strong>Natural totalising:</strong> Pulse counting provides running totals
                </li>
                <li>
                  <strong>High accuracy:</strong> Each pulse represents precise quantity
                </li>
                <li>
                  <strong>Long distance:</strong> Digital signals transmit reliably
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Understanding normal signal behaviour enables rapid fault diagnosis and system
              troubleshooting. Each standard has characteristic patterns that indicate specific
              problems.
            </p>
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="p-2 border-b border-white/10">
                      Wire break, power loss, sensor failure
                    </td>
                    <td className="p-2 border-b border-white/10">
                      Check wiring, power supply, sensor
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="p-2 border-b border-white/10">
                      Sensor fault, calibration error
                    </td>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>4-20mA:</strong> Use calibrated current source at 4, 12, 20mA
                </li>
                <li>
                  <strong>0-10V:</strong> Use precision voltage source at 0, 5, 10V
                </li>
                <li>
                  <strong>Pulse:</strong> Use function generator at known frequency
                </li>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Confusing 0mA with zero reading</strong> — 0mA always indicates a fault
                </li>
                <li>
                  <strong>Using 0-10V over long distances</strong> — causes signal degradation
                </li>
                <li>
                  <strong>Incorrect K-factor for pulse signals</strong> — causes totalisation errors
                </li>
                <li>
                  <strong>Not checking loop resistance</strong> — high resistance can cause
                  under-range
                </li>
              </ul>
            </div>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="../instrumentation-module-3-section-1">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous Section
            </Link>
          </Button>
          <Button
            ...
            asChild
          >
            <Link to="../instrumentation-module-3-section-3">
              Next Section
