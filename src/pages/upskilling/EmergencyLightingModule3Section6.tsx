...
const inlineChecks = [
  {
    id: 'elm3-s6-software',
    question:
      'The major lighting design software packages used for emergency lighting design are...?',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'Which software packages are commonly used for emergency lighting photometric design?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'BS 5266-1:2025 5-year photometric verification requires the designer / dutyholder to...?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'Manufacturer-specific tools (e.g. Helvar Designer, Tridonic LumKit) are useful because...?',
    options: [
  ...
  },
  {
    id: 9,
    question:
      '5-year photometric verification per BS 5266-1:2025 typically identifies which issues?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Modern emergency lighting design lives in lighting calculation software. Dialux, Relux and
          AGi32 are the dominant general-purpose tools; manufacturer-specific tools sit alongside
          for product workflows. All read LDT / IES photometric data and produce point-by-point grid
          calculations. The 2025 revision adds 5-year photometric re-verification — design software
          must support the workflow not just at install but throughout the life of the installation.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              false-colour images, isolux contour maps. Supports DXF / DWG import for architectural
              backgrounds. Frequent updates.
            </li>
            <li>
              <strong>Relux (Relux Informatik, Switzerland).</strong> Free download. Similar feature
              set to Dialux. Stronger Swiss / German user base. Reads LDT and IES. Has a Relux
              Mobile app for measurements on site. Outputs PDF reports.
            </li>
            <li>
              <strong>AGi32 (Lighting Analysts, US).</strong> Paid licence. Strong US user base and
              roadway / exterior lighting specialism. Reads IES (and LDT via converter). Photometric
              calculations include detailed glare analysis (UGR, BUG ratings). Used by larger UK
              consultancies for complex / specialist projects.
            </li>
            <li>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Helvar Designer.</strong> Tied to Helvar luminaires + Helvar control systems.
              Strong workflow for projects committed to Helvar ecosystem (luminaires + DALI controls
              + emergency monitoring). Includes pre-validated typical layouts for common building
              types.
            </li>
            <li>
              <strong>Tridonic LumKit.</strong> Tridonic luminaires + Tridonic drivers + Tridonic
              emergency components. Workflow optimised for product configuration, particularly where
              Tridonic emergency conversion modules retrofit non-emergency luminaires.
            </li>
            <li>
              <strong>Designplan emergency-lighting-design.</strong> Specialist tool for Designplan
              emergency luminaires (a UK manufacturer focused on emergency / exit signs / refuge
              systems). Excellent product knowledge integration; less general applicability.
            </li>
            <li>
          ...
          <p>
            ...
            tool (or vice versa) for the product configuration / control commissioning. The tools
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              software accepting standard photometric data (LDT or IES). The software shall produce
              point-by-point illuminance values on the target plane with the calculation grid
              spacing, surface reflectance assumptions, maintenance factor and luminaire photometric
              data clearly identified in the output.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>LDT (Eulumdat).</strong> European format, originally developed in Germany in
              the 1990s for fluorescent luminaires. Plain-text file with a fixed structure — header
              lines for manufacturer, luminaire identifier, light source type, total flux, power,
              and a structured table of intensity values at angle increments. Used as default in
              Dialux and Relux. Recognised throughout European lighting practice.
            </li>
            <li>
              <strong>IES (LM-63).</strong> North American format from Illuminating Engineering
              Society standard LM-63. Plain-text file with a different fixed structure — similar
              physical content but different angle conventions, header keywords (TILT=NONE, [TEST],
              [MANUFAC], etc.), and slightly different photometric reference planes. Used as default
              in AGi32 and many US-origin tools.
            </li>
            <li>
              <strong>Mutual convertibility.</strong> Both formats describe the same physical
              content. Conversion between them is loss-less (apart from rounding) and most modern
              software reads both transparently. Manufacturers serving global markets publish BOTH
              for the same luminaire.
            </li>
            <li>
              <strong>Versioning.</strong> Both formats have evolved — IES has versions LM-63-86,
              -91, -95, -02, -19; LDT has its own version progression. Older software may not read
              the latest version; designers occasionally encounter compatibility issues requiring
              software updates or file conversion.
            </li>
            <li>
              <strong>What goes in the file.</strong> Manufacturer name, luminaire model,
              photometric reference (laboratory + test method + date), total luminous flux, input
              power, intensity distribution table, dimensions, photometric centre offsets. Some
              files include manufacturer notes, marketing copy, or non-photometric data — ignored by
              the calculation engine but visible to the designer.
            </li>
          </ul>
          <p>
            Designers download the LDT or IES file from the manufacturer website, place it in a
            project folder, and reference it from the lighting design software's luminaire library.
            The file represents the certified output of the named luminaire variant; calculations
            using it produce the predicted illuminance for that exact luminaire.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              Dialux Evo has a dedicated emergency lighting calculation that forces 0% reflectance
              and applies the BS EN 1838 / BS 5266 rules automatically. Use this mode for emergency
              designs; the software handles the standard requirements without the designer needing
            ...
            <li>
              <strong>Check the report explicitly.</strong> The photometric output report MUST state
              the reflectance values used. If the report shows 70/50/20 (or anything other than
              0/0/0), the calculation is non-evidenced for emergency duty. Re-run with 0%.
            </li>
            <li>
              <strong>Do not rely on a 'sense check'.</strong> A scheme that gives 1.5 lx with
              70/50/20 reflectance might give 0.9 lx with 0% reflectance — looks similar but fails
              the duty. The reflectance contribution is significant (typically 20 to 40 percent of
              total) and the difference between pass and fail can sit entirely in that contribution.
            </li>
            <li>
              ...
              reality — the standard's 0% is a calculation rule, not a physical claim). The measured
              value is typically slightly higher than the software prediction at 0%; if the measured
              value is significantly LOWER than the prediction, investigate.
            </li>
          </ul>
          <p>
            Reflectance is the dominant pitfall. Other common issues — wrong photometric file,
            missing maintenance factor, geometry errors — are typically caught by routine checks.
            Reflectance is missed because the default produces results that look plausible. Make 0%
            the first thing you set on any emergency calculation.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Design intent.</strong> The fire risk assessment and the BS 5266-1:2025 minima
              drive the target lux values. Documented in the design brief.
            </li>
            <li>
              <strong>Software design.</strong> Dialux / Relux / AGi32 / manufacturer tool with LDT
              / IES files, geometry, luminaire positions, photometric distribution, maintenance
              factor, 0% reflectance. Outputs point-by-point grid lux on the target plane.
            </li>
            <li>
              <strong>Photometric output report.</strong> PDF / printable report with grid values,
              min / max / uniformity, identified parameters (reflectance, MF, LDT files, software
              version, date). Filed in the documentation pack.
            </li>
            <li>
            ...
            <li>
              <strong>Installation.</strong> Installer fits the luminaires per the layout drawing
              and schedule. Each luminaire at its specified position, orientation, circuit, mounting
              height.
            </li>
            <li>
              <strong>Commissioning measurement.</strong> Calibrated lux meter measures the actual
              lux at the schedule of test points (typically the worst-case grid points from the
              calculation, plus every safety-equipment vertical-lux point). Recorded in the
              commissioning log.
            </li>
            <li>
              <strong>Comparison.</strong> Measured values compared against software predictions.
              Tolerance typically ±20% (allows for measurement uncertainty, production tolerance,
              environmental factors). Outside tolerance triggers investigation.
            </li>
            <li>
              <strong>Certificate of compliance.</strong> Issued when measurements agree with
              predictions and minima are met. The certificate references the design pack, the
              commissioning log, and the standard against which the system is verified (BS
              5266-1:2025 / BS EN 1838:2024 / BS EN 50172:2024).
            </li>
            <li>
              <strong>Periodic test (BS EN 50172:2024).</strong> Monthly functional test, annual
              rated-duration test, and 5-year photometric re-verification (NEW 2025). Each updates
              the documentation pack.
            </li>
          </ul>
          <p>
            Designers, installers, commissioning engineers and dutyholders share the chain. Each is
            responsible for their link; the building owner is responsible for the chain as a whole.
            A documented break (e.g. measurements outside tolerance) is fixed before the certificate
            issues; a discovered break (e.g. missing photometric file found at periodic test) is
            remediated as soon as identified.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              project from the original design, retrieved from the documentation pack. Without the
              project file, re-verification means re-creating the model — which is possible but slow
              and prone to introducing differences.
            </li>
            <li>
              <strong>Update luminaire light output for depreciation.</strong> LED luminaires
              typically depreciate 10 to 15% over 5 years (variant dependent). Reduce the luminaire
              flux in the model accordingly. Some software supports a 'time advance' feature; manual
              adjustment otherwise.
            </li>
            <li>
              <strong>Update geometry for any changes.</strong> Walls moved, partitions added,
              fittings repositioned, safety equipment relocated. The current building geometry must
              match the model geometry.
            </li>
            <li>
            ...
            <li>
              <strong>Document the result.</strong> Re-verification report — predicted lux at test
              points, comparison with standard minima, any non-compliances and proposed remediation.
              Filed in the documentation pack with the original design.
            </li>
            <li>
              <strong>Take action.</strong> Where the re-verification predicts compliance: continue.
              Where it predicts non-compliance: clean luminaires, replace luminaires that have
              depreciated, modify the design (additional luminaires, repositioning), or re-design as
              required.
            </li>
          </ul>
          <p>
            The 5-year cycle aligns with typical refurbishment intervals — many buildings are
            redecorated, refitted or expanded around the 5-year mark. The verification ties into the
            refurbishment programme; emergency lighting becomes part of the change control. Doing
            the re-verification AFTER non-compliance is identified at periodic test is too late; the
            verification is preventive, not reactive.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The photometric calculation underlying the design shall be re-verified at intervals
              not exceeding 5 years, or following any major change to the building fabric,
              decoration, occupancy or use that could affect the emergency-lighting duty. The
              re-verification shall use the original software project file, updated for current
              luminaire condition (lumen depreciation), current building geometry, and current
              safety-equipment layout. Where the re-verification predicts non-compliance with the
              requirements of this standard, remedial action shall be taken.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="110" y="84" textAnchor="middle" fill="#22D3EE" fontSize="11" fontWeight="bold">
              Inputs
            </text>
            <text x="110" y="104" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              · LDT / IES files
            </text>
            <text x="110" y="118" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              · Building geometry
            </text>
            <text x="110" y="132" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              · Risk assessment
            </text>
            <text x="110" y="146" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              · BS 5266 minima
            </text>
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="340" y="84" textAnchor="middle" fill="#A855F7" fontSize="11" fontWeight="bold">
              Software design
            </text>
            <text x="340" y="104" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              Dialux / Relux / AGi32
            </text>
            <text x="340" y="118" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              + manufacturer tools
            </text>
            <text x="340" y="132" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              ⚠ 0% reflectance MUST be set
            </text>
            <text x="340" y="146" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              MF 0.7 to 0.8
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="570" y="84" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              Photometric output
            </text>
            <text x="570" y="104" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              · Point-by-point grid
            </text>
            <text x="570" y="118" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              · Min / max / uniformity
            </text>
            <text x="570" y="132" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              · Schedule of test points
            </text>
            <text x="570" y="146" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              · Reflectance + MF stated
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="780" y="84" textAnchor="middle" fill="#22C55E" fontSize="11" fontWeight="bold">
              Drawings + schedules
            </text>
            <text x="780" y="104" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              Layout (1:100 / 1:50)
            </text>
            <text x="780" y="118" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              Schedule of luminaires
            </text>
            <text x="780" y="132" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              Safety-equip schedule
            </text>
            <text x="780" y="146" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
            ...
            <text x="120" y="264" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              per drawings + schedule
            </text>
            <text x="120" y="278" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              circuits + orientation
            </text>
            <text x="120" y="292" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              verified pre-commissioning
            </text>
            ...
            <text x="360" y="264" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              calibrated lux meter
            </text>
            <text x="360" y="278" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              at scheduled test points
            </text>
            <text x="360" y="292" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              incl. safety-equip vertical
            </text>
            ...
            <text x="580" y="264" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              measured vs predicted
            </text>
            <text x="580" y="278" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              tolerance ±20%
            </text>
            <text x="580" y="292" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
            ...
            <text x="780" y="264" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              BS 5266 compliance
            </text>
            <text x="780" y="278" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              handed to dutyholder
            </text>
            <text x="780" y="292" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              → documentation pack
            </text>
            ...
            <path
              d="M 780 160 Q 780 190 450 190 Q 120 190 120 220"
              fill="none"
              stroke="rgba(255,255,255,0.4)"
              strokeWidth="1.4"
            />
            ...
            <text
              ...
              fontWeight="bold"
            >
              NEW 2025 · 5-year photometric re-verification (BS 5266-1:2025 §8.2)
            </text>
            <text x="440" y="406" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="10">
              Re-open original software project — update for lumen depreciation + geometry changes
            </text>
            <text x="440" y="422" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="10">
              Re-run calculation at 0% reflectance — compare to standard minima
            </text>
            <text x="440" y="438" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="10">
              Action: maintain / replace / redesign as needed → updated documentation pack
            </text>

            {/* Loop arrows */}
            <path
              d="M 700 360 Q 750 330 750 220"
              fill="none"
            ...
            <text
              ...
              fontWeight="bold"
            >
              Documentation pack carries the chain
            </text>
            <text x="440" y="528" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              Software project files (Dialux / Relux) + LDT / IES files + photometric output report
            </text>
            <text x="440" y="544" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              + layout drawings + schedules + commissioning log + certificate + revision history
            </text>
            <text x="440" y="562" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              Each link evidenced; chain auditable end-to-end; verifiable by third party
            </text>
            <text x="440" y="578" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              A break anywhere = non-evidenced design
            </text>
          </svg>
        </div>
        ...
        <FAQ
          items={[
            ...
            {
              question:
                'What happens if the manufacturer of my chosen luminaire goes out of business?',
              answer:
            ...
            {
              question:
                'Does the 5-year re-verification need a designer with the same Dialux licence as the original designer?',
              answer:
            ...
            {
              question:
                'Can I do the 5-year re-verification myself if I am the building maintenance manager, or do I need a qualified designer?',
              answer:
            ...
            {
              question:
                'What if the building has been renovated and the original Dialux project no longer matches the current building?',
              answer:
            ...
            {
              question:
                'Should the photometric data files be in the documentation pack as well as the manufacturer schedules?',
              answer:
