    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Table 64 minimums, Reg 643.3.2 acceptance, the 1 MΩ floor under Reg 643.3.3, and the
          inspector judgement that turns a number on a meter into a defensible decision on the
          certificate.
        </p>
        ...
        >
          <p>
            The Table 64 structure has not changed substantively in years, but A4:2026 redrafts the
            surrounding regulation (Reg 643.3) and tightens the language about which test voltage
            applies in which situation. The values themselves remain:
          </p>
          ...
          <p>
            Two practical notes attach to the table. First: Table 64 is also applied when verifying
            insulation resistance between non-earthed protective conductors and Earth — relevant on
            IT systems and on functional earth conductors that are not bonded to the main earth.
            Second: FELV circuits are tested at the same test voltage as that applied to the primary
            side of the source and shall meet all the test requirements for low-voltage circuits
            (Reg 643.3.2 explicit).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              value given in Table 64. Table 64 shall be applied when verifying insulation
              resistance between non-earthed protective conductors and Earth.
            </>
          }
        ...
        >
          <p>
            The two floors do not overlap. Table 64 governs the cabling-and-fixed- accessories test
            before sensitive equipment is reconnected. Reg 643.3.3 governs the verification test
            after that equipment is reconnected. Both must pass; one passing does not excuse the
            other failing.
          </p>
          ...
          <p>
            ...
            schedule of test results carries both — typically the Table 64 reading in the IR columns
            and the Reg 643.3.3 reading in comments.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="410" y="42" textAnchor="middle" fill="#FBBF24" fontSize="12" fontWeight="bold">
            ...
            <text x="680" y="245" textAnchor="start" fill="#22C55E" fontSize="10" fontWeight="bold">
              YES
            </text>
            ...
            <text x="555" y="220" textAnchor="start" fill="#FBBF24" fontSize="10" fontWeight="bold">
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong className="text-emerald-300">Hundreds of MΩ to ∞.</strong> Healthy insulation,
              clean termination, dry environment. Record. Move on. This is the expected band on new
              installations and clean periodic inspections.
            </li>
            <li>
              <strong className="text-emerald-300">Tens of MΩ.</strong> Acceptable on most
              installations. Older PVC cabling and slightly damp environments commonly read in this
              band. No action required if consistent across the installation.
            </li>
            <li>
              ...
              not consistent with healthy cabling. Compare against adjacent circuits, look for damp,
              look for contamination, look for a load that was not disconnected. Flag in comments.
            </li>
            <li>
              ...
              EICR, code C2 typically (potentially dangerous) — sometimes C1 if the leakage is at a
              level that creates immediate shock risk.
            </li>
          </ol>
          <p>
            The skill is in band 3. Band 1 and band 2 are clearly pass; band 4 is clearly fail. Band
            3 is where regulation says &lsquo;pass&rsquo; and professional practice says
          ...
          whatToDo={
            <>
              ...
              <span className="block mt-2">
                Investigate. Method 2 from the consumer unit: probe at each driver disconnect point
                along circuit 3. If the reading drops at one specific accessory, you have localised
                the source. Likely causes: damp / contamination at one back-box, a slipped strand
                bridging L–CPC, a partially disconnected driver.
              </span>
              <span className="block mt-2">
                ...
                is damp from a leak, agree the remediation with the client and retest after drying.
                If the cause is a structural defect, raise as a defect on the EIC.
              </span>
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Damp ingress.</strong> A junction box behind a leaking shower seal, a back box
              on an external wall during prolonged wet weather, water pooling in a ceiling void
              after a roof leak. The cable insulation is intact; water across the surfaces is the
              parallel path. Find the source, dry the installation, retest.
            </li>
            <li>
            ...
            <li>
              <strong>Recently energised damp circuit.</strong> The first test after a long shutdown
              can read low because moisture has accumulated in cable terminations. A second test
              after the circuit has run loaded for some hours often reads significantly higher.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              hardened and cracked, PVC that has overheated and gone brittle, conductors exposed by
              insulation breakdown at a hot termination.
            </li>
            <li>
              <strong>Polarity / wiring faults.</strong> A neutral terminated to CPC at an
              accessory, an exposed conductor touching an earthed back box, a wrong- polarity socket
              where the reverse-polarity supply has stressed the wrong insulation.
            </li>
            <li>
        ...
        >
          <p>
            ...
            tracking down behind the wall for months. The kitchen lighting circuit that runs through
            that wall now reads 0.4 MΩ at 500 V DC. Replacing the cable would resolve the low
            reading immediately — but the water source is still there, and the new cable will read
            0.4 MΩ within weeks.
          </p>
          <p>The defensible workflow:</p>
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              Record the failing reading and document the suspected cause (damp, supported by visual
              evidence).
            </li>
            <li>
            ...
            <li>
              If the retest is still below Table 64 after confirmed drying, escalate to a structural
              cause and replace the affected cabling.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Cable capacitance.</strong> Approximately 100&ndash;200 pF/m for T&amp;E. A 50
              m circuit therefore presents ~5&ndash;10 nF, settling time ~5&ndash;10 s.
            </li>
            <li>
          ...
          <p>
            The recorded value is the stabilised reading. The instantaneous value at t=0 is the test
            current charging the capacitance and is not the insulation resistance. Recording the t=0
            value as a fail when it would have settled to a pass is a false fail; recording the t=0
            value as a pass when it has not yet risen to the genuine reading is a false pass on a
            degrading cable.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              direct shock risk in normal use, or a clear path between live conductor and accessible
              exposed-conductive-part. Not common on healthy installations; specifically applies
              where damp has caused open conductive paths, or where insulation has failed to a point
              of contact.
            </li>
            <li>
              <strong>C2 (potentially dangerous).</strong> The default for sub-Table-64 readings on
              intact installations. The reading is below the regulatory minimum; the cause may be
              temporary or structural; danger is reasonably foreseeable if not resolved. Most low-IR
              findings code C2.
            </li>
            <li>
          ...
          <p>
            ...
            explain the C-code in lay terms. &ldquo;The insulation between live conductors and earth
            on this circuit is below the value that BS 7671 requires. Common causes are damp,
            contamination or aged insulation. We recommend investigating and resolving before this
            circuit is left in service&rdquo; is a defensible explanation for a C2. Second: the
            unsatisfactory EICR mandates a follow-up. Do not sign off the EICR without ensuring the
            duty-holder has the path to resolution, including the contact details and timescale.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              <span className="block mt-2">
                Code the three sub-Table-64 circuits as C2 — potentially dangerous. Do not C3 them;
                the regulation has been breached and the cause is real.
              </span>
              <span className="block mt-2">
                Issue the EICR as unsatisfactory. Provide the duty-holder with a written remediation
                path: source repair (plumber), drying time, retest after drying. Confirm the
                timescale for the retest in writing.
              </span>
              <span className="block mt-2">
                When the retest happens, record the new readings and update the EICR to satisfactory
                only if all circuits return to consistent values. If any circuit remains low after
                confirmed drying, escalate to structural cause and replacement.
              </span>
            </>
          }
