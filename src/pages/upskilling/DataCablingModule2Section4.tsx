    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The 8P8C modular connector ('RJ45'), T568A vs T568B wiring, keystone and modular jack
          formats, the three common patch-panel types (punchdown, modular, tool-less), consolidation
          points for flexible layouts, and the BS 7671:2018+A4:2026 §716.526.101 rule of 750 mA per
          contact at the connecting hardware.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            ...
            <li>
              <strong>Keystone.</strong> A small modular plug-receiving body designed to clip into a
              standardised cut-out in patch panels, wall outlets and faceplates. The cable
              terminates into the back of the keystone (typically via IDC); the keystone clips into
              the panel/outlet; the user-side plug engages with the keystone&apos;s front. Available
              unshielded or screened, plain or shuttered. The 2026 commercial default for
              high-density Cat6A panels.
            </li>
            <li>
              ...
              screened cabling installs (BS 7671 §444.5.3.1) — leaving the screen unbonded makes the
              screen electrically useless and the install non-compliant.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Modular connectors and outlets shall be terminated such that the untwisted pair length
              at the insulation displacement contact does not exceed the limit specified for the
              relevant Category. The cable jacket shall be retained inside the connector body
              (strain relief), and the pair twist shall be preserved as close to the IDC as
              physically practicable. Re-termination shall be by replacement of the connector or by
              re-stripping, re-laying and re-punching the affected conductors, not by attempting to
              re-seat already-displaced contacts.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            ...
            <li>
              <strong>UK office default.</strong> T568B at every termination on every link. Document
              the choice; verify with wire-map test on every link.
            </li>
          </ul>
          <p>
            Note: 10BASE-T and 100BASE-TX use only pairs 2 and 3 (TX on one, RX on the other).
            1000BASE-T and 10GBASE-T use ALL FOUR pairs simultaneously, full-duplex on each. That is
            why T568A/B mismatch is invisible on legacy traffic but breaks gigabit and above.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            ...
            <li>
              ...
              standardised keystone cut-outs. Each cable terminates into a separate keystone on the
              bench (controlled lighting, correct tool, proper torque), then the keystone snaps into
              the chassis from the front. Slightly slower at first-fit than punchdown but more
              repeatable Class EA results. Repair = pop out the bad keystone, replace, snap in new
              one. Mix screened and unscreened keystones in the same chassis (rarely useful, but
              possible). The 2026 high-density Cat6A default.
            </li>
            <li>
              <strong>Tool-less patch panel.</strong> Cables clip in mechanically with a screw, cam
              or lever — no impact tool needed. Fastest first-fit, especially in cramped racks.
              Mixed reputation for long-term reliability under PoE thermal load — verify the
              manufacturer&apos;s BS EN 60512-9-3 endurance test results and the BS ISO/IEC 11801-1
              compliance before specifying for sustained Type 4 PoE++.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>One CP per permanent link, maximum.</strong> Each CP adds insertion loss and a
              connector pair; chaining them blows the channel budget.
            </li>
            <li>
              <strong>Distance from FD ≥ 15 m.</strong> Keeps the CP-to-WAO segment short and
              re-routable; if the CP were too close to the FD it would offer no flexibility benefit.
            </li>
            <li>
              <strong>Total permanent link ≤ 90 m.</strong> The 90 m horizontal-cabling limit (M1S1)
              still applies — the CP doesn&apos;t extend it. Test the link as a permanent link with
              the CP in circuit.
            </li>
            <li>
              <strong>CP location.</strong> Mounted to a structural element (soffit, column, floor
              box) — not in mobile furniture. The CP itself doesn&apos;t move; only the run from CP
              to WAO is re-locatable.
            </li>
            <li>
            ...
            <li>
              <strong>EMC continuity.</strong> On screened installs, the CP must preserve the screen
              bonding chain — screened keystones at both sides of the CP, bonded to the structural
              metalwork or back to the rack bonding bar via a dedicated bonding lead.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              with BS ISO/IEC 11801-1 and support a continuous operating current of 750 mA per
              contact. Where connected equipment may be separated under load the connecting hardware
              shall meet the requirements of the endurance test specified in BS EN 60512-9-3 at the
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Patch leads (FD-end and WAO-end).</strong> Stranded conductor (more flex-cycle
              tolerant), Category-matched to the channel, length controlled (the 10 m total cord
              allowance — M1S1). Screened if the channel is screened. Manufacturer-warranted as part
              of the same Class EA system.
            </li>
          </ul>
          <p>
            The deliverable at handover is a Class EA channel certified by TIA-1152-A / BS EN 50346
            field test, with every component documented on the as-built. That is what the warranty
            stands behind.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            ...
            <li>
              <strong>§444.5.3.1 — bond every screen / sheath.</strong> Carried forward from earlier
              editions. Every metallic screen, sheath or armouring of an ICT cable shall be bonded
              to the equipotential bonding network. On screened installs, this anchors the cable
              foil to the screened keystone, the screened patch panel, the rack bonding bar, the TBB
              and ultimately the MET / MFET.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              end-to-end. Non-compliant with §444.5.3.1, the F/UTP cable is doing nothing the U/UTP
              version wouldn&apos;t do, and Class EA certification fails on screen continuity.
            </>
          }
          doInstead={
            <>
        ...
        <Scenario
          ...
          situation={
            <>
              A 96-AP wireless deployment, every AP on Type 4 PoE++ continuously. The IDF will have
              two 48-port Cat6A patch panels feeding the 96 ceiling APs. Build standard wants
          ...
          whatToDo={
            <>
              ...
              leads from the warranty manufacturer. Specify the rack bonding bar, the bonding leads
              from each panel to the bar, and the bonding lead from the bar back to the building TBB
              (BS EN 50310). Specify T568B at every termination. At handover, channel certification
              per TIA-1152-A / BS EN 50346 to Class EA, with screen-continuity tested on every link,
              and margin reviewed at the top test frequency.
            </>
          }
          whyItMatters={
            <>
              ...
              (cheap unshielded keystones, mixed screening, generic patch leads) gives a precarious
              certification that drifts toward fail under thermal load and a warranty manufacturer
              who walks away.
            </>
          }
        />
