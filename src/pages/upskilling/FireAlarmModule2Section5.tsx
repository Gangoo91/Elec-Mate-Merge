...
const FireAlarmModule2Section5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 2 · Section 5" title="False alarm management" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS 5839-1:2025 reorganises Section 3 of the standard into clauses 29-33 and tightens the
          false-alarm management framework. Every event investigated, multi-sensor preferred for
          FA-risk areas, ARC notification and the new false-alarm-notice label at the CIE.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              ageing, contamination beyond drift-compensation range, water ingress, physical damage.
              The system itself is the source. Remediation: service, clean, replace, address the
              underlying defect.
            </li>
            <li>
            ...
            <li>
              ...
              covers (see Section 3), staff/pupil engagement, CCTV monitoring of MCPs, key-lock MCPs
              in selected areas.
            </li>
            <li>
          ...
          <p>
            ...
            direct the right remediation. Without this explanation, users tend to default everything
            to "equipment" (blaming the system) or "environmental" (blaming the air) — both miss the
            malicious and unwanted categories which often have the most available remediation.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              investigation duty. Every false alarm in the logbook gets some level of review — even
              if the conclusion is &quot;single isolated event, no action&quot;.
            </li>
            <li>
            ...
            <li>
              ...
              managerial action (notify cleaners not to use aerosol near detector X), detector-level
              action (clean, relocate, change mode), or system-level action (review zone
              definitions, update cause-and-effect matrix).
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The commissioning/handover organization should advise the user to arrange for suitable
              investigation and, if appropriate, action to be taken on every occasion that a false
              alarm occurs. NOTE: This could, for example, comprise managerial changes within the
              building, modifications to the fire detection and fire alarm system, or further
              separate investigation by the organization that maintains the system.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="410" y="571" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              &quot;Active connection to FRS via ARC — Contact: [tel]&quot; · contractors notify ARC
              before any test
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              repeated events in the same zone, recurring environmental sources, drifty detectors,
              malicious-activation patterns. Produces a remediation plan and a follow-up review at
              the next service.
            </li>
            <li>
              ...
              The medium-to-large system has crossed into territory suggesting fundamental design or
              operational issues. The investigation looks at design assumptions, detector type/mode,
              zone definitions, cause-and-effect matrix, user-management practices, and
            ...
            <li>
              ...
              FA rate over the previous 12 months. The maintaining organisation typically computes
              this from the logbook; the user retains responsibility but rarely has the tooling. The
              number, the categorisation breakdown, and any remediation plan are recorded in the
              logbook and the annual service certificate.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The investigation of false alarms has been simplified to bring the trigger points for
              a preliminary investigation and in-depth investigation in line with the false alarm
              calculation recommended to be carried out every service visit. These trigger points
              have not changed in the new 2025 revision. They are now expressed as preliminary
              investigation when the rate of false alarms over the previous 12 months exceeds four
              false alarms per 100 detectors per annum. With an in-depth investigation recommended
              for systems with more than 40 automatic fire detectors when the average rate of false
              alarms exceeds five false alarms per 100 detectors per annum.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Detector relocation away from environmental sources.</strong> Detectors within
              1.5 m of cooking fume vents, wall fans extracting steam, or aerosol-source bays should
              be relocated. Where relocation is impractical, substitute multi-sensor or apply
              variable-sensitivity programming.
            </li>
            <li>
              <strong>Coincidence filtering.</strong> System-level configuration requiring more than
              one detector to confirm before transmitting an alarm to the ARC. Suppresses
            ...
            <li>
              ...
              human-activity sources are present, higher sensitivity overnight when the building is
              unoccupied. The capability is panel-specific; programmed settings are recorded in the
              cause-and-effect matrix.
            </li>
            <li>
              <strong>MCP measures (see Section 3).</strong> Type B double-action MCPs, transparent
              protective covers, key-locked MCPs in selected areas. Reduces malicious activation.
            </li>
            <li>
            ...
            <li>
              ...
              delayed sounder operation in selected zones (with management response window), staged
              evacuation, or zone-specific responses.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Documentation.</strong> The ARC notification (start, finish, contractor name)
              is recorded in the system logbook and the maintenance certificate.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              recommended to be fixed on, or adjacent to, the CIE to remind the premises management
              that the system has an active connection to the Fire and Rescue Service via an ARC.
              With the FRS now operating call challenging policies to reduce the number of false
              alarm attendances, informing the FRS of the type of premises is important. A new
              recommendation states that the ARC should be provided with all relevant information
              about the premises, for example, if it contains sleeping accommodation, so that this
              information can be passed on to the FRS.
            </>
          }
