        ...
        <div>
          <div className="flex flex-col sm:flex-row gap-3 sm:justify-between sm:items-center">
            <Link to="module-7/section-1" className="order-2 sm:order-1 w-full sm:w-auto">
              <Button variant="outline" className="bg-transparent border-elec-yellow text-elec-yellow hover:bg-elec-yellow hover:text-black transition-all duration-200 w-full sm:w-auto h-12 text-sm sm:text-base">
                <ArrowLeft className="mr-2 h-4 w-4" />
