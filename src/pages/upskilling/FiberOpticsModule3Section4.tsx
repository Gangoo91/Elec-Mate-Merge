...
const DESCRIPTION =
  'Master fibre optic splice enclosure selection, mounting, and installation. Learn dome, inline, and wall-mount closure types, sealing methods, and UK installation best practices.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Standard splice trays maintain a minimum 60mm coil radius for stored fibre, ensuring bend radius compliance and preventing macrobend losses.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Amplify signal',
      'Organise splices and maintain bend radius',
      'Convert connector types',
      'Provide power distribution',
    ],
    correctAnswer: 1,
    explanation:
      'Splice trays organise individual splices and ensure fibres maintain proper bend radius.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    options: [
      'Physical size only',
      'Maximum number of splice trays/fibres',
      'Cable diameter only',
      'Power consumption',
    ],
    correctAnswer: 1,
    explanation:
      'Capacity is specified by the maximum number of splice trays and total fibre count the closure can accommodate.',
  },
  {
    id: 9,
    question: 'When installing an aerial closure, you must:',
    options: [
      'Ensure proper bonding to messenger wire and weatherproofing',
      'Use indoor-rated closures',
      'Avoid any mechanical support',
      'Install horizontally only',
    ],
    correctAnswer: 0,
    explanation:
      'Aerial closures must be properly bonded to messenger wire and fully weatherproofed.',
  },
  {
    id: 10,
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Purpose:</strong> Protect splices from environment
              </li>
              <li>
                <strong>Dome:</strong> Underground/aerial installations
              </li>
              <li>
                <strong>Inline:</strong> Duct runs with straight-through routing
              </li>
              <li>
                <strong>IP68:</strong> Required for buried applications
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Dome, inline, or wall-mount design
              </li>
              <li>
                <strong>Check:</strong> IP rating matches environment
              </li>
              <li>
                <strong>Install:</strong> 60mm minimum fibre coil radius
              </li>
              <li>
                <strong>Seal:</strong> All entries properly before closing
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Splice enclosures (closures) protect fibre splices from environmental damage while
              providing organised storage and bend radius management. Different closure designs suit
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Closures are rated using the IP (Ingress Protection) system to indicate protection
              against dust and water. Selecting the correct IP rating for the installation
              environment is critical for long-term reliability.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>IP54:</strong> Indoor, protected environments
                </li>
                <li>
                  <strong>IP65:</strong> Outdoor, protected from direct water jets
                </li>
                <li>
                  <strong>IP67:</strong> Temporary immersion (up to 1m, 30 min)
                </li>
                <li>
                  <strong>IP68:</strong> Continuous immersion (depth/time varies)
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Indoor (dry):</strong> IP54 minimum
                </li>
                <li>
                  <strong>Indoor (damp/unheated):</strong> IP65 minimum
                </li>
                <li>
                  <strong>External above ground:</strong> IP67 minimum
                </li>
                <li>
                  <strong>Underground chamber:</strong> IP68 (subject to flooding)
                </li>
                <li>
                  <strong>Direct burial:</strong> IP68 with pressure rating
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white">
                IP ratings do not cover temperature. Check closure material specifications for
                operating range. Standard closures: -20C to +60C. Extreme environments may need
                extended range (-40C to +80C). Consider thermal cycling effects on seals in
                locations with large temperature swings.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Splice trays inside closures hold individual splices while managing fibre routing and
              bend radius. Proper tray organisation ensures reliable operation and enables future
              maintenance access.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Splice holders:</strong> Protect individual fusion or mechanical splices
                </li>
                <li>
                  <strong>Fibre guides:</strong> Route fibres maintaining minimum radius
                </li>
                <li>
                  <strong>Coil radius:</strong> 60mm minimum for standard fibre
                </li>
                <li>
                  <strong>Heat shrink storage:</strong> Organised sleeve placement
                </li>
                <li>
                  <strong>Labelling area:</strong> Fibre identification markings
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Initial splice:</strong> Approximately 1m each fibre minimum
                </li>
                <li>
                  <strong>Re-splice allowance:</strong> Additional 0.5m recommended
                </li>
                <li>
                  <strong>Coiled storage:</strong> Must maintain 60mm radius
                </li>
                <li>
                  <strong>Future access:</strong> Allow lifting tray without strain
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The sealing system is critical for environmental protection. Different closure designs
              use various sealing approaches, each with specific installation requirements.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Gel Seals:</strong> Self-healing gel blocks that compress around cables,
                  re-enterable
                </li>
                <li>
                  <strong>Mechanical Glands:</strong> Compression fittings that clamp around cable
                </li>
                <li>
                  <strong>Heat-Shrink Boots:</strong> Individual heat-shrink sleeves over each cable
                  entry
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Proper mounting ensures closure security, cable strain relief, and accessible
              maintenance. Mounting requirements vary by closure type and installation environment.
            </p>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white">
                Always anchor cable strength members (aramid yarn, steel armour) to the closure
                anchor points before sealing. This prevents cable tension from being transmitted to
                splice trays or individual fibres. Use proper clamps - do not rely on seal
                compression to hold cables.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Comprehensive documentation enables future maintenance and troubleshooting. Test
              closure integrity before commissioning to ensure long-term environmental protection.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Location:</strong> GPS coordinates, address, and chamber ID
                </li>
                <li>
                  <strong>Closure ID:</strong> Serial number and type/manufacturer
                </li>
                <li>
                  <strong>Cable records:</strong> Each cable with fibre count and destination
                </li>
                <li>
                  <strong>Splice map:</strong> Tray/position assignments per fibre
                </li>
                <li>
                  <strong>Test results:</strong> Splice loss values, OTDR traces
                </li>
                <li>
                  <strong>Photos:</strong> Exterior and internal organisation
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white">
                For critical installations (direct burial, flood-prone chambers), consider pressure
                testing before final installation. Some closures include pressure test ports. Apply
                low air pressure and verify no leaks with soap solution. This confirms seal
                integrity before the closure becomes inaccessible.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Sealing before testing</strong> - Always test all splices before closing
                </li>
                <li>
                  <strong>Insufficient fibre slack</strong> - Leave adequate fibre for future
                  re-work
                </li>
                <li>
                  <strong>Wrong IP rating</strong> - Match closure to environment requirements
                </li>
                <li>
                  <strong>Not anchoring strength members</strong> - Prevents cable tension on fibres
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="mt-6 p-5 rounded-lg bg-transparent">
            ...
            <p className="text-xs text-white mt-4">
              <strong>Key spec:</strong> Splice tray coil radius: 60mm minimum | Always anchor
              strength members before sealing
            </p>
          </div>
        </section>
