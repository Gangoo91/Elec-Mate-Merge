...
const inlineChecks = [
  {
    ...
    question: 'How is max demand calculated for a heat pump install per Reg 311.1?',
    options: [
  ...
  },
  {
    ...
    question: 'At what point does a heat pump install typically move to three-phase?',
    options: [
...
const quizQuestions = [
  ...
  {
    question:
      'A rural cottage with existing 60 A single-phase supply, 10 kW thermal ASHP proposed. Issue?',
    options: [
  ...
  {
    question:
      'Diversity factor for compressor + immersion + circulation pumps — typical assumption?',
    options: [
  ...
  {
    question:
      'Heat-pump-ready supply upgrade — what does it mean for a customer planning a future heat pump?',
    options: [
...
export default function RenewableEnergyModule8Section2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 2 · BS 7671:2018+A4:2026 · Reg 311.1 + Reg 314 + EREC G98 / G99"
        title="Supply assessment + DNO notification"
        backTo="../renewable-energy-module-8"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Max demand per Reg 311.1, diversity considerations across compressor + immersion +
          circulation pumps + controls, DNO heat pump notification portals (per-phase ≤16 A
          analogous to G98) vs EREC G99 formal, three-phase threshold (~12-13 kW thermal), DNO heat
          pump notification portals, supply upgrade lead times + cost, heat-pump-ready supply
          upgrade as staged service.
        </p>
        ...
        <Pullquote>
          The supply assessment is the single biggest determinant of the project timeline + cost.
          Done badly at quote stage, it derails everything downstream.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Compressor continuous input</strong> — typically 1.5-4
              kW for 5-12 kW thermal output (COP ~3). Use manufacturer rated input, NOT the
              COP-derived theoretical (real-world COP varies with conditions). Diversity: 100%
              coincident at peak
            </li>
            <li>
              <strong className="text-white">Compressor start-up inrush</strong> — 3-8× running
              current for ~100-500 ms; drives protective device curve choice (C or D curve) but not
              max demand calc
            </li>
            <li>
              <strong className="text-white">Immersion backup</strong>— 3 kW typical. Control
              strategy normally schedules immersion OUTSIDE compressor running (boost cycles,
              legionella heat-up, fault fallback). Diversity: typically 0% in normal coincident
              calc; conservative 100% if control uncertain
            </li>
            <li>
              <strong className="text-white">Circulation pumps</strong> — primary + secondary;
              100-300 W combined typical. Diversity: 100% coincident with compressor
            </li>
            <li>
              <strong className="text-white">Controls + sensors</strong>— thermostat + zone valves +
              OAT sensor + controller; 50-150 W combined. Diversity: 100% coincident
            </li>
            <li>
              <strong className="text-white">Existing site base load</strong> — cooker + appliances
              + lighting; 5-7 kW typical for a 4-bed domestic with moderate use. Verify via meter
              reading + customer interview. Diversity: per the existing site’s pattern
            </li>
            <li>
              <strong className="text-white">Future load headroom</strong> — EV charger, PV / BESS
              export, additional electrification. Reserve capacity at the design stage if customer
              planning ahead. UK 2025-26 design horizon typically 5-10 years
            </li>
            <li>
              <strong className="text-white">Peak coincident max demand</strong> — sum × diversity =
              typical 10-12 kW for a domestic ASHP install with no future EV / PV headroom. With
              future loads designed in, can exceed 20 kW — drives three-phase choice
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Single-phase 60 A</strong>— older properties (pre-1970
              frequently, some 1970s-80s). ~14 kW capacity. Often inadequate for modern heat pump
              retrofit; upgrade to 100 A typically required
            </li>
            <li>
              <strong className="text-white">Single-phase 80 A</strong>— transitional; common in
              1970s-90s installs. ~18 kW capacity. Marginal for some heat pump installs; upgrade
              often advisable for headroom
            </li>
            <li>
              <strong className="text-white">Single-phase 100 A</strong>— modern domestic standard
              (1990s-onwards). ~23 kW capacity. Adequate for most UK 2025-26 typical ASHP retrofit +
              base load with diversity
            </li>
            <li>
              <strong className="text-white">Single-phase 125 A</strong>— uncommon larger domestic.
              ~29 kW capacity. Suits large detached with electrified heat + EV (no PV / BESS export)
            </li>
            <li>
              <strong className="text-white">Three-phase 100 A per phase</strong> — typical for
              properties with three-phase supply. ~69 kW capacity. Suits large detached with full
              electrification + PV + BESS + EV three-phase
            </li>
            <li>
              <strong className="text-white">Verification method</strong> — read cut-out fuse rating
              directly; or DNO supply enquiry portal; or clamp meter at meter tails over 24h for
              measured peak (only for loaded supplies)
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong>— cut-out rating photo +
              measured peak + max demand calc + headroom conclusion
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          G98 + G99 originally addressed small-scale generation. DNOs now use them — plus dedicated
          heat pump portals — for significant pure load too. Aggregate load drives grid planning.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              ...
              phase OR three-phase ≤16 A per phase. Fast-track post-installation notification (form
              filled by installer + sent to DNO)
            </li>
            <li>
              <strong className="text-white">G99 scope</strong> — anything above G98 Type A.
              Single-phase &gt;16 A, three-phase &gt;16 A per phase, any V2G, any export. Formal
              pre-installation application + DNO approval + connection agreement
            </li>
            <li>
              <strong className="text-white">Heat pump pure-load case</strong> — typical
              single-phase ASHP runs at ~11-18 A; mostly within G98 threshold. DNO heat pump portal
              (most DNOs now have dedicated heat pump notification separate from G98 / G99)
            </li>
            <li>
              <strong className="text-white">Heat pump + co-located generation case</strong> — heat
              pump + PV + BESS + V2G = generation present = G99 formal regardless of heat pump size.
              UK 2025-26 typical for new-build / major-refurb installs
            </li>
            <li>
              <strong className="text-white">DNO heat pump portals</strong> — UKPN
              heatpumpnotification.co.uk; NGED / National Grid Electricity Distribution heat pump
              form; Northern Powergrid heat pump notification; SP Energy Networks; SSEN; Electricity
              NW. Each DNO has its own portal + form (separate from G98 / G99)
            </li>
            <li>
              <strong className="text-white">Lead times</strong> — G98 notification: weeks
              (post-install). G99 formal: 6-18 weeks DNO design + offer + acceptance. DNO heat pump
              portal: typically 2-4 weeks acknowledgement
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — DNO submission +
              reference + acknowledgement + response + completion confirmation
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Single-phase economic limit</strong> — ~12-13 kW
              thermal output (~4-5 kW electrical input continuous, ~17-22 A on 230 V running). Cable
              + protective device + supply capacity all push toward three-phase above this
            </li>
            <li>
              <strong className="text-white">Three-phase advantages</strong> — balanced 6-8 A per
              phase running current; smaller cable for the same power; less voltage drop on long
              runs; easier supply capacity; supports larger units (16-30 kW thermal)
            </li>
            <li>
              <strong className="text-white">Three-phase models</strong> — Mitsubishi Ecodan
              three-phase, Daikin Altherma 3 H HT three-phase, Vaillant aroTHERM Plus three-phase,
              NIBE F2120 three-phase + others. Manufacturer DoC confirms phase configuration +
              per-phase current
            </li>
            <li>
              <strong className="text-white">Existing supply reality</strong> — most UK domestic
              supplies are single-phase only. Three-phase upgrade required for three-phase heat
              pump; typical 3-12 months DNO lead time + £3-15k cost (UK 2025-26 indicative)
            </li>
            <li>
              <strong className="text-white">Decision point</strong> — heat pump 16+ kW thermal
              forces three-phase. Heat pump 12-16 kW thermal + future EV + PV + BESS is a strong
              case for proactive three-phase upgrade (even if not strictly required for heat pump
              alone)
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — phase choice rationale
              + per-phase current + DNO correspondence + reference + upgrade scope + completion
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          DNO lead times are the silent project killer. A great heat pump quote with a 9-month
          supply upgrade attached is not the same project as one on adequate existing supply.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Cut-out fuse rating swap</strong> — 60/80 A → 100 A
              single-phase (cable + cut-out adequate already). 2-4 weeks; £200-500. Quick win where
              the existing supply cable is adequate
            </li>
            <li>
              <strong className="text-white">Single-phase cable upgrade</strong> — existing cable
              too small for higher capacity. Underground cable replacement. 4-8 weeks; £1-3k typical
            </li>
            <li>
              <strong className="text-white">Single-phase to three-phase upgrade</strong> — full new
              three-phase service: new underground cable + new three-phase fuse + new three-phase
              meter. 3-12 months; £3-15k typical
            </li>
            <li>
              <strong className="text-white">Three-phase capacity upgrade</strong> — existing
              three-phase to higher per-phase capacity (e.g. 60 A → 100 A per phase). 6-12 weeks;
              £1-5k
            </li>
            <li>
              <strong className="text-white">London + south-east reality</strong> — capacity
              pressure in some areas; UKPN publishing capacity heatmaps. Lead times longer end
            </li>
            <li>
              <strong className="text-white">Free upgrades</strong> — where the DNO determines
              existing capacity is inadequate for a reasonable demand, upgrade may be free under
              licence conditions. Customer challenges the DNO’s connection offer to invoke this
            </li>
            <li>
              <strong className="text-white">Heat-pump-ready upgrade pattern</strong> — staged
              service: upgrade the supply now (3-12 months ahead of heat pump install) to manage the
              DNO timeline risk
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — DNO application +
              reference + connection offer + completion confirmation + new supply capacity + new
              metering details
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">DNO application</strong> — customer’s own DNO portal
              submission for supply upgrade. Electrical installer assists with the technical content
              (load calc + reason for upgrade)
            </li>
            <li>
              <strong className="text-white">Supply upgrade</strong> — DNO delivers new cable + new
              fuse + new meter (or meter operator follow-up visit) per the connection offer
            </li>
            <li>
              <strong className="text-white">New CU + dedicated way</strong> — electrical installer
              fits new CU (or replaces existing) with dedicated way reserved for future heat pump.
              Way labelled "future heat pump"
            </li>
            <li>
              <strong className="text-white">Cable + isolator</strong>— outdoor cable run from CU to
              future outdoor unit location terminated at junction box; isolator installed at outdoor
              location. Indoor termination available for the MCS company’s install day
            </li>
            <li>
              <strong className="text-white">Customer-facing cost</strong> — single quote covering
              supply upgrade + CU + cable + isolator. Typical 2025-26 cost £4-15k for a three-phase
              upgrade pattern; £1-3k for a single-phase upgrade pattern
            </li>
            <li>
              <strong className="text-white">Heat pump install day</strong>— MCS company connects to
              the pre-installed termination; refrigerant + hydraulic + commissioning per usual.
              Electrical scope reduces to second-fix + commissioning + EIC
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — Phase 1: supply upgrade
              EIC + DNO completion + isolator location + future heat pump model + planned
              connection; Phase 2: heat pump electrical commissioning EIC linked to the earlier
              upgrade
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-8-section-1')}
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-8-section-3')}
