    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          TIA-606-D (2021) administration and BS EN 50174-1 §6 — the identifier hierarchy that
          uniquely names every cable, outlet, patch panel and port across a structured-cabling
          system. Cable labels, outlet labels, patch-panel port labels, colour-coding conventions,
          and the records discipline that keeps the cabling administrable for its 15-20 year life.
          Every link uniquely identified — no exceptions.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              panel, the records the contractor must produce at handover, and the change-management
              discipline for moves / adds / changes. North American / international standard.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            ...
            <li>
              <strong>Telecoms Room (TR) / Floor Distributor (FD).</strong> Where multiple TRs exist
              on one floor, distinguish by letter (TRA, TRB) or compass position (TR-N, TR-S).
            </li>
            <li>
          ...
          <p>
            Optional layers some schemes add: a service-type prefix (V for voice, D for data, S for
            safety) — though service-type is more often handled by colour-coding; a VLAN suffix for
            IP-segmented services; a physical-link versus channel distinction. Whatever variants are
            used, they go in the labelling-scheme key.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Blue — voice / IP telephony.</strong> The traditional voice colour across most
              schemes.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              Cat6 / Cat6A / fibre type), length, current status (active / spare / faulty). Often a
              CMDB or dedicated structured-cabling administration tool. Updated for every move / add
              / change.
            </li>
            <li>
            ...
            <li>
              <strong>Test results.</strong> Channel test results for every link, to TIA-1152-A / BS
              EN 50346 — insertion loss, NEXT, return loss, propagation delay, DC resistance
            ...
            <li>
              <strong>Labelling-scheme key.</strong> The format of the identifier hierarchy in use,
              with worked examples, and the colour-coding convention if any. Lets a contractor in
              2040 read the labels without prior briefing.
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A small office cabling job, completed under time pressure. Installer uses hand-written
              paper labels with a permanent marker, stuck on with sticky-tape. Six months later,
              half the labels have fallen off; the rest have faded to the point of being unreadable.
              The next contractor doing a fault investigation has to manually trace each cable
              end-to-end. The administration record — if one was ever created — is no longer in sync
              with the physical cabling. The cabling is effectively unlabelled.
            </>
          }
          doInstead={
            <>
              Specify durable label formats at tender / design stage: laser-printed adhesive labels
              in clear protective sleeves, factory-pre-printed cable labels (where the label is part
              of the cable manufacture), engraved plastic / metal plaques for patch panels and
              outlet faceplates. Use a label printer with thermal-transfer ribbon for outlet labels.
              The cost is small; the lifecycle value is enormous. Specify "label format" alongside
              "cable type" in the tender — make it non-optional. Verify durability before approving
              the install.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              patch panel / port appropriately to the actual topology; (3) trace every link from end
              to end (using a tone generator and wand on every patch-panel port — this is the
              longest part); (4) re-label every cable, outlet and patch-panel port to the new scheme
              using durable labels; (5) build the connection-records database fresh, with current
              termination state for every link; (6) produce as-built drawings if none exist; (7)
              channel- test every link to TIA-1152-A / BS EN 50346 to confirm performance; (8) hand
              over the pack. Document any links that cannot be traced as "spares pending
              verification". Cost the work realistically — this is a meaningful project, not a quick
              re-label.
            </>
          }
          whyItMatters={
            <>
              ...
              alongside the connection records); cannot confidently expand the system. The re-label
              exercise restores the cabling to its full structured- cabling value. It is one of the
              highest-leverage interventions in cabling lifecycle management.
            </>
          }
        />
