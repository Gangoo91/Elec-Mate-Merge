...
const DataCablingModule4Section4 = () => {
  useSEO({
    title: "ID Labelling Standards and Colour Codes | Data Cabling Module 4.4",
    description: "Master cable identification standards, colour coding systems, and professional labelling requirements for structured cabling."
  });
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/upskilling/data-cabling-module-4-section-3">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous Section
            </Link>
          </Button>
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/upskilling/data-cabling-module-4-section-5">
              Next Section
