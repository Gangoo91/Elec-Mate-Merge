...
const DESCRIPTION =
  'Learn about fibre optic inspection equipment, cleaning methods, and best practices for maintaining connector quality and system reliability.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Even microscopic contamination causes signal loss and can permanently damage connector end faces when mated. Inspection catches problems before they cause damage or system failures.',
  },
  {
    id: 'inspection-qc2',
    question: 'What magnification is typically used for fibre end-face inspection?',
    options: ['10x-50x', '200x-400x', '1000x-2000x', '50x-100x'],
    correctIndex: 1,
    explanation:
      '200x-400x magnification is standard for fibre inspection, allowing clear viewing of the core, cladding, and contact zones defined in IEC 61300-3-35.',
  },
  {
    id: 'inspection-qc3',
    ...
    correctIndex: 1,
    explanation:
      'First inspection identifies contamination type, cleaning removes it, second inspection verifies the end face is clean. Never skip the verification step.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      'Magnetic particles on the ferrule',
      'The colour of the connector body',
      'Dust, oil, and debris on the end face',
      'Damage to the outer cable jacket',
    ],
    correctAnswer: 2,
    explanation:
      'Dust, oil, fingerprints and debris on the connector end face block light transmission and cause insertion loss.',
  },
  {
    id: 2,
    question: 'What is a video probe microscope used for?',
    options: [
      'Measuring overall cable length',
      'Inspecting connectors in patch panels and adapters',
      'Measuring insertion loss directly',
      'Stripping the cable jacket',
    ],
    correctAnswer: 1,
    explanation:
      'Video probe microscopes have thin probes that can reach connectors installed in adapters and patch panels where handheld scopes cannot access.',
  },
  {
    id: 3,
    question: 'What cleaning method is recommended for connectors in adapters?',
    options: ['Compressed air only', 'A plain water rinse', 'Wet-dry stick cleaners', 'Abrasive cleaning pads'],
    correctAnswer: 2,
    explanation:
      'Stick cleaners (1.25mm for LC, 2.5mm for SC) are designed to reach into adapter ports and clean the ferrule end face.',
  },
  {
    id: 4,
    question: 'How should used cleaning stick tips be handled?',
    options: [
      'Reused until visibly dirty',
      'Washed in IPA and reused',
      'Discarded after a single use',
      'Shared between technicians',
    ],
    correctAnswer: 2,
    explanation:
      'Cleaning sticks are single-use consumables. Reusing them transfers contamination back to connectors.',
  },
  {
    id: 5,
    question: 'What IEC standard defines end-face inspection criteria?',
    options: ['IEC 60793', 'IEC 61754', 'IEC 60794', 'IEC 61300-3-35'],
    correctAnswer: 3,
    explanation:
      'IEC 61300-3-35 defines the inspection zones (A, B, C, D) and acceptance criteria for fibre connector end faces.',
  },
  {
    id: 6,
    question: "What does a 'cassette cleaner' contain?",
    options: [
      'A ribbon of dry cleaning material',
      'Compressed air in a canister',
      'A reservoir of liquid cleaner',
      'A roll of polishing film',
    ],
    correctAnswer: 0,
    explanation:
      'Cassette cleaners contain a ribbon of dry lint-free cleaning material that advances to provide a fresh cleaning surface for each use.',
  },
  {
    id: 7,
    question: 'What contamination type is most likely from skin contact?',
    options: ['Airborne dust', 'Metal particles', 'Oil and fingerprints', 'Condensed water'],
    correctAnswer: 2,
    explanation:
      'Skin oils transfer easily to connector end faces and require wet cleaning with IPA to fully remove.',
  },
  {
    id: 8,
    question: 'When should you use wet cleaning (IPA)?',
    options: [
      'Always as the very first step',
      'When dry cleaning fails to remove contamination',
      'Never on optical fibre',
      'Only on outdoor connectors',
    ],
    correctAnswer: 1,
    explanation:
      'Try dry cleaning first. Use IPA (isopropyl alcohol) wet cleaning when dry methods fail to remove oils or stubborn contamination.',
  },
  {
    id: 9,
    question: 'What can result from mating a contaminated connector?',
    options: [
      'A cleaner, improved connection',
      'A stronger optical signal',
      'No significant effect at all',
      'Scratched and damaged end faces on both connectors',
    ],
    correctAnswer: 3,
    explanation:
      'Contamination gets pressed between end faces, causing scratches and permanent damage to both connectors when mated.',
  },
  {
    id: 10,
    ...
    options: [
      ...
      'In a protective case, lens covers on, away from contamination',
      'On a bench in direct sunlight',
      'Loose in the bottom of a tool bag',
    ],
    correctAnswer: 1,
    explanation:
      'Protect microscope optics with lens caps and cases. Store away from dust and contamination that could affect inspection accuracy.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Every time before mating and after any handling. Even new connectors from packaging should be inspected and cleaned. Make inspection and cleaning a standard step in every connection procedure - it takes seconds and prevents problems that take hours to diagnose.',
  },
  {
    question: 'Can I clean APC connectors the same way as UPC?',
    answer:
      'Yes, the cleaning process is similar. However, some cleaning tools have specific versions for APC (angled) to ensure proper contact with the angled end face. Check your cleaning tool specifications. The angled face may require slightly different technique to ensure full surface contact.',
  },
  {
    question: 'Is compressed air safe for fibre cleaning?',
    answer:
      "Use with caution. Only use filtered, dry, oil-free compressed air designed for electronics. Regular workshop air often contains oil and moisture. Compressed air alone doesn't remove all contamination types - it's best as a first step before other cleaning methods. Never use high pressure directly on end faces.",
  },
  {
    question: "What if contamination won't come off after multiple cleanings?",
    answer:
      "If contamination persists after proper wet and dry cleaning, it may be damage rather than contamination (scratches, chips, or burned-in particles). Inspect closely under magnification. Damaged connectors must be re-terminated or replaced - continued cleaning won't fix physical damage.",
  },
  {
    question: 'Do I need different microscopes for different connector types?',
    answer:
      "The basic microscope can view most connector types, but you need appropriate adapters or tips for different form factors (LC, SC, MPO, etc.). Video probe microscopes are essential for inspecting connectors installed in panels and adapters where handheld microscopes can't reach.",
  },
  {
    question: 'How do I know if my cleaning supplies are contaminated?',
    answer:
      "Store supplies in sealed containers. Discard wipes exposed to dirty environments. Check IPA containers for contamination. If cleaning seems ineffective or you're seeing new contamination appear after cleaning, your supplies may be compromised. Use fresh supplies from sealed packaging.",
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Contamination:</strong> Leading cause of fibre problems
              </li>
              <li>
                <strong>Magnification:</strong> 200-400x for inspection
              </li>
              <li>
                <strong>Rule:</strong> Inspect, clean, inspect again
              </li>
              <li>
                <strong>Tools:</strong> Cassette cleaners and stick cleaners
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Handheld scope:</strong> Patch cords, loose connectors
              </li>
              <li>
                <strong>Video probe:</strong> Adapters, patch panels
              </li>
              <li>
                <strong>Cassette cleaner:</strong> Quick dry cleaning
              </li>
              <li>
                <strong>Stick cleaner:</strong> Cleaning inside adapters
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Contamination is the number one cause of fibre optic network problems. A particle as
              small as 1 micron on a 9-micron singlemode core can block significant light and cause
              signal loss.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Signal loss:</strong> Particles block light transmission
                </li>
                <li>
                  <strong>Back-reflection:</strong> Contamination causes unwanted reflections
                </li>
                <li>
                  <strong>Permanent damage:</strong> Dirt gets pressed into end faces when mated
                </li>
                <li>
                  <strong>Chain reaction:</strong> One dirty connector contaminates others it mates
                  with
                </li>
                <li>
                  <strong>Troubleshooting cost:</strong> Hours finding problems that cleaning
                  prevents
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                For field work, carry both a handheld scope (for patch cords) and a video probe (for
                installed connectors). Many manufacturers offer combined kits. For workshop use, add
                a desktop microscope for detailed analysis and documentation.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              IEC 61300-3-35 defines inspection zones and cleanliness criteria for fibre connector
              end faces. Understanding these zones helps evaluate inspection results.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Zone A (Core):</strong> 0-25 micrometres from centre. NO defects or
                  contamination allowed.
                </li>
                <li>
                  <strong>Zone B (Cladding):</strong> 25-120 micrometres. Limited scratches
                  acceptable, no contamination.
                </li>
                <li>
                  <strong>Zone C (Adhesive):</strong> 120-130 micrometres. Some defects acceptable,
                  not critical.
                </li>
                <li>
                  <strong>Zone D (Contact):</strong> 130-250 micrometres. Ferrule contact area,
                  limited defects.
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                ...
                acceptable. When in doubt, clean again and re-inspect. Never mate a connector with
                visible core contamination.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Different cleaning tools suit different situations. Choose based on whether the
              connector is accessible (patch cord) or installed (in an adapter).
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Proper cleaning technique ensures contamination is removed without damaging the end
              face or spreading contamination.
            </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Cleaning adapters/ports (stick method):
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Reusing cleaning surfaces:</strong> Transfers contamination back
                </li>
                <li>
                  <strong>Skipping final inspection:</strong> Cleaning isn't complete until verified
                </li>
                <li>
                  <strong>Excessive pressure:</strong> Can damage end face
                </li>
                <li>
                  <strong>Circular motion on ferrule:</strong> Use straight wipes
                </li>
                <li>
                  <strong>Letting IPA dry naturally:</strong> Leaves residue
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Proper care of inspection and cleaning equipment ensures reliable performance and
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Make it routine:</strong> Inspect and clean EVERY connection, EVERY time
                </li>
                <li>
                  <strong>Dry first:</strong> Try dry cleaning before wet - often sufficient
                </li>
                <li>
                  <strong>Don't assume:</strong> Even new connectors from packaging need inspection
                </li>
                <li>
                  <strong>Use proper tools:</strong> Right size stick for adapter type
                </li>
                <li>
                  <strong>Document issues:</strong> Photograph persistent problems for analysis
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Try wet cleaning:</strong> IPA removes oils that dry cleaning misses
                </li>
                <li>
                  <strong>Check cleaning supplies:</strong> Are they contaminated?
                </li>
                <li>
                  <strong>Evaluate environment:</strong> Is workspace too dirty?
                </li>
                <li>
                  <strong>Look for damage:</strong> What looks like dirt may be physical damage
                </li>
                <li>
                  <strong>Check mating connector:</strong> May be transferring contamination
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  If contamination won't clean after multiple attempts with wet and dry methods, the
