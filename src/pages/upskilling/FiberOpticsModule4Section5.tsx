...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Compressed air only', 'Wet-dry stick cleaners', 'Water rinse', 'Abrasive pads'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: ['IEC 60793', 'IEC 61300-3-35', 'IEC 61754', 'IEC 60794'],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Cassette cleaners contain a ribbon of dry lint-free cleaning material that advances to provide fresh cleaning surface for each use.',
  },
  {
    id: 7,
    question: 'What contamination type is most likely from skin contact?',
    options: ['Dust', 'Oil and fingerprints', 'Metal particles', 'Water'],
    correctAnswer: 1,
    explanation:
