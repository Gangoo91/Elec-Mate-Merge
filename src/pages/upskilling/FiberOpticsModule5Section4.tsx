...
const DESCRIPTION =
  'Learn how to interpret fibre optic test results including dB/dBm units, OTDR event analysis, fault signatures, bidirectional testing, and remediation decisions.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'dBm is an absolute power measurement referenced to 1 mW. -15 dBm equals 10^(-15/10) = 0.0316 mW. Unlike dB (relative), dBm tells you the actual power level.',
  },
  {
    id: 'interpret-qc2',
    question:
      'An OTDR trace shows a large reflective spike followed by a drop to noise floor. What does this indicate?',
    options: [
      'A fusion splice',
      'A macrobend',
    ...
    correctIndex: 2,
    explanation:
      'A large reflective spike followed by the signal dropping to the noise floor is the signature of a fibre break or unterminated end - the Fresnel reflection from the glass-to-air interface followed by no more fibre to measure.',
  },
  {
    id: 'interpret-qc3',
    ...
    correctIndex: 1,
    explanation:
      'Marginal readings near pass/fail thresholds may be caused by dirty reference cables, poor launch conditions, or temperature variations. Recleaning and retesting from both directions can confirm whether the issue is real before committing to repair work.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      ...
      'dB is used for multimode and dBm for singlemode',
    ],
    correctAnswer: 0,
    explanation:
      'dB measures relative change (ratio), while dBm measures absolute power level referenced to 1 milliwatt.',
  },
  {
    id: 2,
    question: 'A connector shows 0.8 dB loss on OTDR. What is the likely cause?',
    options: [
      'A normal value expected for every connector',
      'The expected value for a good fusion splice',
      'A contaminated or poorly mated connector requiring cleaning',
      'The typical loss of a mechanical splice',
    ],
    correctAnswer: 2,
    explanation:
      '0.8 dB is high for a connector (typical should be 0.3-0.5 dB). Contamination or poor mating is the most common cause.',
  },
  {
    id: 3,
    question: 'What signature indicates a macrobend on an OTDR trace?',
    options: [
      'A large reflective spike above the backscatter line',
      'An end-of-fibre Fresnel reflection',
      'An apparent gain event at the location',
      'A non-reflective loss event where no connection should exist',
    ],
    correctAnswer: 3,
    explanation:
      'Macrobends cause light to escape without reflection, showing as non-reflective loss at a location where no splice or connector should exist.',
  },
  {
    id: 4,
    question: 'Why is bidirectional OTDR testing important?',
    options: [
      'It completes the test faster than a single direction',
      'It averages out measurement variations and accurately characterises splice loss',
      'It is only relevant for multimode fibre',
      'It is a mandatory legal requirement',
    ],
    correctAnswer: 1,
    explanation:
      'Bidirectional testing averages out the effects of different fibre characteristics, giving accurate splice loss values.',
  },
  {
    id: 5,
    question: 'An OTDR shows 0.15 dB gain at a splice. What causes this?',
    options: [
      'The splice is genuinely amplifying the signal',
      'A reflection from a dirty connector',
      'A measurement artefact due to different fibre mode field diameters',
      'A faulty OTDR that needs recalibration',
    ],
    correctAnswer: 2,
    explanation:
      'Gainers are caused by different backscatter coefficients in fibres with different mode field diameters - not actual gain.',
  },
  {
    id: 6,
    question: 'How should insertion loss test results compare with OTDR total link loss?',
    options: [
      'The OTDR should always read higher than insertion loss',
      'Insertion loss should be roughly double the OTDR figure',
      'The two methods should never be compared',
      'They should agree within approximately 0.5 dB for a healthy link',
    ],
    correctAnswer: 3,
    explanation:
      'Both methods should give similar results. Differences greater than 0.5 dB suggest measurement issues or problems.',
  },
  {
    id: 7,
    question: 'What is a typical acceptable loss for a quality fusion splice?',
    options: ['Less than 0.1 dB', 'Less than 1.0 dB', 'Exactly 0 dB', 'Between 0.5 and 1.0 dB'],
    correctAnswer: 0,
    explanation:
      'Quality fusion splices typically achieve less than 0.1 dB loss, often 0.02-0.05 dB with modern equipment.',
  },
  {
    id: 8,
    question: 'When interpreting results, what does ORL (Optical Return Loss) measure?',
    options: [
      'The total loss through the link',
      'The optical power arriving at the receiver',
      'The reflections returning back toward the source',
      'The distance to the first connector',
    ],
    correctAnswer: 2,
    explanation:
      'ORL measures the total reflections returning toward the source - important for laser-based systems sensitive to back-reflections.',
  },
  {
    id: 9,
    ...
    options: [
      ...
      'Add an inline optical amplifier',
      'Clean all connectors and retest to confirm the reading',
      'Accept the failure and document it',
    ],
    correctAnswer: 2,
    explanation:
      'Always clean and retest first - dirty connectors are the most common cause of marginal failures and are easy to fix.',
  },
  {
    id: 10,
    question: 'What distinguishes a high-loss splice from a dirty connector on OTDR?',
    options: [
      'A high-loss splice is non-reflective; a dirty connector typically shows both loss and reflection',
      'The two events look identical on the trace',
      'A dirty connector shows no measurable loss',
      'A high-loss splice always produces a reflection',
    ],
    correctAnswer: 0,
    explanation:
      'Fusion splices are non-reflective (loss only), while dirty connectors typically show both loss and a reflection spike.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'OTDR measures backscatter, which depends on fibre characteristics. If fibres on either side of a splice have different mode field diameters or backscatter coefficients, the splice can appear as a loss from one direction and a gain from the other. Bidirectional testing and averaging gives the true splice loss. This is normal behaviour, not equipment error.',
  },
  {
    question: 'How accurate are OTDR loss measurements compared to insertion loss testing?',
    answer:
      'Insertion loss testing with a calibrated source and power meter is generally more accurate for total link loss measurement (plus or minus 0.1 dB typical). OTDR is better for locating faults and characterising individual events but may have plus or minus 0.2-0.5 dB uncertainty on individual event measurements. Use both methods together for comprehensive testing.',
  },
  {
    question: 'What if my test results are right at the pass/fail threshold?',
    answer:
      'Marginal results warrant additional investigation. First, clean all connectors and reference cables, then retest. Test from both directions and average if using OTDR. Check your test setup and reference method. If results remain marginal after careful retesting, consider environmental factors (temperature) and whether the link will have margin for ageing and future connections.',
  },
  {
    question: 'Can temperature affect my test results?',
    answer:
      'Yes. Fibre loss increases slightly at low temperatures, and macrobend loss can increase significantly in cold conditions. OTDR equipment may need time to stabilise in extreme temperatures. For certification testing, note the ambient temperature. Significant changes between installation and operation conditions should be considered in your loss budget.',
  },
  {
    question: 'How do I know if a high reading is a real problem or a test equipment issue?',
    answer:
      "Verify by: 1) Cleaning and retesting, 2) Testing from both directions, 3) Using known-good reference cables, 4) Checking your test equipment calibration, 5) Testing a known-good link to verify equipment operation. If the issue persists after all verification steps, it's likely a real problem requiring investigation or repair.",
  },
  {
    question: 'What causes ghost reflections on OTDR traces?',
    answer:
      'Ghosts appear when strong reflections bounce multiple times between highly reflective events. They show up at distances that are multiples of the actual event location. Ghosts can be identified because they occur at exact distance multiples and often show higher loss than expected. Reducing reflection by cleaning connectors or using APC connectors minimises ghosts.',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white">Make informed decisions from fibre optic measurements</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>dB:</strong> Relative loss or gain (ratio)
              </li>
              <li>
                <strong>dBm:</strong> Absolute power (ref to 1mW)
              </li>
              <li>
                <strong>Signatures:</strong> Learn fault patterns on OTDR
              </li>
              <li>
                <strong>Decision:</strong> Clean and retest before repair
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Pass/fail:</strong> Compare against loss budget
              </li>
              <li>
                <strong>Marginal:</strong> Clean, retest, verify
              </li>
              <li>
                <strong>High loss:</strong> Identify cause before repair
              </li>
              <li>
                <strong>Bidirectional:</strong> Average for true values
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Decibels (dB) and decibel-milliwatts (dBm) are fundamental to fibre optic
              measurements, but they measure different things. Understanding the distinction is
              essential.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                dB (decibel) - Relative measurement:
              </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                dBm (decibel-milliwatt) - Absolute measurement:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                If a transmitter outputs +2 dBm and the link has 8 dB loss, the received power is +2
                - 8 = -6 dBm. You can subtract dB loss from dBm power because dB represents a ratio.
                The receiver needs the power to be above its sensitivity (e.g., -25 dBm) to work.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Different faults create distinctive patterns on OTDR traces. Learning these signatures
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Testing from both ends of a fibre link is essential for accurate splice loss
              measurement and professional certification.
            </p>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-elec-yellow text-sm font-medium mb-2">
                Calculating True Splice Loss
              </p>
              <p className="text-sm text-white">
                True loss = (Loss from A + Loss from B) / 2. For example, if a splice shows +0.05 dB
                (gainer) from one direction and 0.15 dB loss from the other, the true loss is (0.15
                - 0.05) / 2 = 0.05 dB. Always average bidirectional results for certification.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Different test methods serve different purposes and may give slightly different
              results. Understanding these differences helps interpret results correctly.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Test results drive decisions about whether to accept, clean and retest, or repair a
              fibre link.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Trusting single-direction OTDR:</strong> Always test bidirectionally for
                  splices
                </li>
                <li>
                  <strong>Ignoring gainers:</strong> They indicate fibre differences, not actual
                  gain
                </li>
                <li>
                  <strong>Dirty reference cables:</strong> Can add loss that appears as link loss
                </li>
                <li>
                  <strong>Wrong index of refraction:</strong> Distances will be incorrect
                </li>
                <li>
                  <strong>Ghost events:</strong> Multiple reflections creating false events
                </li>
                <li>
                  <strong>Rushing to repair:</strong> Clean and retest first
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                Before concluding a link has problems: 1) Clean all connectors, 2) Verify reference
                cables on known-good link, 3) Check OTDR settings match fibre type, 4) Test from
                both directions, 5) Compare OTDR total with insertion loss test. If issues persist
                after verification, investigate specific events.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Fusion splice:</strong> Under 0.1 dB (often 0.02-0.05 dB)
                </li>
                <li>
                  <strong>Mechanical splice:</strong> 0.1-0.5 dB
                </li>
                <li>
                  <strong>Connector pair (mated):</strong> 0.3-0.5 dB
                </li>
                <li>
                  <strong>Singlemode fibre:</strong> 0.35 dB/km at 1310nm, 0.25 dB/km at 1550nm
                </li>
                <li>
                  <strong>Multimode fibre (OM3/OM4):</strong> 3.5 dB/km at 850nm
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          <div className="p-5 rounded-lg bg-transparent">
            <h3 className="text-sm font-medium text-white mb-4">
              Quick Reference: Result Interpretation
            </h3>
