...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Less than 1.0 dB', 'Less than 0.1 dB', 'Exactly 0 dB', 'Between 0.5-1.0 dB'],
    correctAnswer: 1,
    explanation:
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">Make informed decisions from fibre optic measurements</p>
        </header>
