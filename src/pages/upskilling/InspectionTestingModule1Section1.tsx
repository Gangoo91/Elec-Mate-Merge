    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Why we inspect and test, and the legal frame the electrician signing the certificate is
          judged against. EAWR 1989, BS 7671 status, GN3 Ch 1, and the duty-holder concept.
        </p>
        ...
        >
          <p>
            ...
            initial verification — every installation, addition or alteration, before being put into
            service, inspected and tested by a skilled person competent to verify compliance with BS
            7671. Chapter 65 covers periodic inspection and testing — existing installations
            re-checked at intervals to determine condition. The output documents follow the same
            split: an Electrical Installation Certificate (EIC) for initial verification, an
            Electrical Installation Condition Report (EICR) for periodic. A Minor Electrical
            Installation Works Certificate (MEIWC) sits inside Chapter 64 for additions to existing
            circuits that do not warrant the full EIC.
          </p>
          <p>
            The legal weight is what differs. An EIC is a statement of compliance — the skilled
            person attests that the installation, as constructed, complies with BS 7671. An EICR is
            a statement of condition — the skilled person reports on what they found and classifies
            defects. Both are duty-holder documents; both are signed under the same statutory
            backdrop; but a signature on an EIC carries the weight of a positive compliance claim,
            while a signature on an EICR carries the weight of an honest assessment.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              requirements of BS&nbsp;7671 have been met.
            </>
          }
        ...
        >
          <p>
            The Reg 643 test sequence (continuity, insulation resistance, polarity, earth electrode
            resistance where relevant, earth fault loop impedance, prospective fault current, RCD
            operation, AFDD where fitted, voltage drop, phase sequence, functional checks) is not an
            arbitrary list. Each test verifies one aspect of safety that cannot be confirmed by any
            other means short of staging the actual fault. Continuity verifies that the protective
            conductor will carry fault current to earth. Insulation resistance verifies that the
            cable insulation has not degraded to a leakage path. Earth fault loop impedance verifies
            that the disconnection time will be met. Together they replace the dangerous experiment
            of waiting for a fault to find out.
          </p>
          <p>
            That is the whole reason inspection and testing is a legal duty rather than a
            recommendation. The alternative — waiting for an installation to demonstrate its safety
            by failing — is unacceptable. EAWR Reg 4 closes that gap by making maintenance,
        ...
        >
          <p>
            ...
            BS 7671 sits beneath all of these as the technical standard the courts and HSE accept as
            defining good practice for installations.
          </p>
          <p>
            "Reasonably practicable" is the qualifier on most of EAWR. It means the duty holder must
            weigh the magnitude of the risk against the cost (in time, money, effort) of averting
            it; if the cost is grossly disproportionate to the risk, the duty does not require it.
            Some EAWR duties are <em>absolute</em> (no defence of reasonable practicability) — most
            relevantly, Reg 14 (work on or near live conductors). A few are qualified by "best
            endeavours". For Reg 4 maintenance, "reasonably practicable" is the test, but in
            practice the cost of periodic inspection on an installation is never grossly
            disproportionate to the risk of an undiscovered defect — so the duty effectively bites
            in every case.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The HSE’s publication HSR25 recommends that records of all maintenance, including test
              results, be kept throughout the working life of an installation. This recommendation
              supports compliance with the Electricity at Work Regulations 1989 (EAWR), Regulation
              4(2).
            </>
          }
        ...
        >
          <p>
            BS 7671 mirrors this exactly. Reg 134.2 requires inspection and testing by &ldquo;one or
            more skilled persons competent to verify that the requirements of BS&nbsp;7671 have been
            met&rdquo;. Reg 651.5 carries the same wording into periodic inspection. The skilled
            person definition in Part 2 of BS 7671 lists adequate education and training, sufficient
            knowledge and practical experience, and the ability to recognise and avoid danger.
          </p>
          <p>
            Practically, what does that mean for the certifying electrician? It means qualifications
            (City &amp; Guilds 2391 / 2394 / 2395 or equivalent) are evidence of competence, not the
            test of competence. A 2391 holder who has not picked up a tester in five years may not
            be competent for a periodic inspection on a complex commercial installation today.
            Honest self-assessment against the specific job is the duty Reg 16 places on you.
            Working outside competence — and certifying that work — is the single most common cause
            of scheme operator action against electricians.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            audit cycle. A typical audit visit is annual, unannounced or short-notice, and consists
            of three things in combination: a sample of recent certificates pulled from the
            certification database; a site visit to a property where work has been carried out; and
            a desk check of insurance, calibration of test equipment, and the company&rsquo;s
            quality management system.
          </p>
          <p>
            The interaction with BS&nbsp;7671 is asymmetric. BS&nbsp;7671 is the technical rulebook
            the scheme audits against — every certificate the assessor pulls is checked for
            compliance with the standard, every site finding is benchmarked to BS&nbsp;7671 clauses,
            every corrective action is written in BS&nbsp;7671 terms. The scheme has no power to
            soften BS&nbsp;7671. It does, however, have the power to suspend or revoke your
            registration if your work demonstrably fails the standard. Loss of registration removes
            your Part P route, which in domestic work is commercially terminal. That is why scheme
            operator action — not HSE prosecution — is statistically the most common professional
            consequence of poor inspection and testing.
          </p>
          <p>
            &ldquo;Competent person&rdquo; in scheme parlance and &ldquo;competent person&rdquo; in
            EAWR Reg 16 are different concepts that share a label. Scheme competent person status is
            a registration status with an operator — the operator has tested and audited you and
            accepts you within their scheme. Reg 16 competence is the substantive technical test for
            the specific work, judged objectively after the fact by HSE or a court. You can be a
            registered competent person under a scheme and still fail the Reg 16 test on a
            particular job; the scheme registration is evidence the Reg 16 test was satisfied, but
            it is not the Reg 16 test itself.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            consumers&rsquo; installations&rdquo; it is reproducing the statutory ESQCR prohibition.
            The ESQCR clause is the law; the BS 7671 NOTE points to it. If you wire a TN-C
            distribution downstream of the cut-out, you have committed an ESQCR breach in addition
            to a BS 7671 non-compliance. Same logic for Reg 9(4) on PME and boats — the statute is
            the prohibition, the BS 7671 reference is signposting.
          </p>
          <p>
        ...
        >
          <p>
            ...
            installation is at least as safe. The departure is legitimate because BS 7671 is not the
            law; safety is. Second, where statute and BS 7671 appear to conflict, statute wins — for
            example, BS 7671 cannot override an ESQCR prohibition. In every other case the practical
            answer is: comply with BS 7671 and you have discharged your statutory duty.
          </p>
          <p>
        ...
        >
          ...
          <p>
            ...
            substance follows Reg 461.2 — every circuit shall be provided with a means of isolation
            from all live supply conductors by a linked switch or a linked circuit-breaker. The
            Schedule of Inspection field now matches the regulation language. Practically: where the
            consumer&rsquo;s intake has no separate isolator and the only means of isolation is the
            main switch in the consumer unit, that is the &ldquo;consumer&rsquo;s means of
            isolation&rdquo; you tick. The wording change makes this position explicit rather than
            something you have to explain in the comments.
          </p>
          <p>
            ...
            makes a missing entry on the EIC / EICR / MEIWC a non-conformity in its own right — the
            duty holder downstream relies on the record to know what equipment was used and how.
            Departures from BS 7671 under Reg 120.3 and 133.1.3 already had to be recorded on the
            certificate; A4 extends the same record discipline to the equipment-usage detail.
          </p>
          <p>
            ...
            certificate and the maintenance record. None of this is technically difficult to comply
            with. All of it is professionally fatal to ignore.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              conductors by a linked switch or a linked circuit-breaker. NOTE: Provision may be made
              for isolation of a group of circuits by a common means, if the service conditions
              allow this.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              mechanical strength, protection) are to be addressed during inspection and testing in
              accordance with BS&nbsp;7671 schedules of tests (continuity, insulation resistance,
              functional checks) to verify compliance.
            </>
          }
        ...
        >
          <p>
            ...
            premises) and additionally under the Landlord and Tenant Act / Housing Act regimes that
            require periodic EICRs at change of tenancy or every five years (England) for private
            rented property. The principal contractor on a CDM project carries duties for the
            construction phase plan and the safe-by-design intent.
          </p>
          <p>
            The duty does not transfer with the certificate. Handing an EIC to the client does not
            absolve you of the EAWR duty for the work you did. Equally, the client receiving the EIC
            does not inherit your competence — they inherit responsibility for maintenance going
            forward, but the design and erection responsibility you signed for stays with you.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Three things follow from this. First, you may not sign for work you have not personally
            inspected and tested (or, where Reg 644.5 applies, where you have not taken the records
            of the other competent persons into account). Second, the schedule of test results is
            the evidence of your verification — incomplete results are equivalent to incomplete
            inspection, regardless of what the front of the certificate says. Third, the
            recommendations on the certificate (interval to first periodic, any limitations, any
            departures) are part of the record and the duty holder downstream relies on them.
          </p>
          <p>
            An EICR is a different signature: it certifies your assessment of the installation, not
            its compliance. The classification codes (C1 immediate danger, C2 potentially dangerous,
            C3 improvement recommended, FI further investigation required) are your professional
            judgement, recorded so the responsible person knows what to remediate. A C2 you missed
            is the same problem as a C1 you missed — you signed off on a condition assessment that
            was wrong. The standard of care is the same.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The records that matter, beyond the EIC / EICR / MEIWC themselves, are the schedules of
            inspection and test results that accompany every certificate, the tester calibration
            certificates that support the test values, the photographs and notes that evidence
            non-numeric findings, and the work-instruction trail that shows what was done and why.
            GN3 Ch 1 is explicit that the records cover both test results and the wider maintenance
            history.
          </p>
          <p>
            Two practical points follow. First, the records belong to the duty holder, not to you —
            the EIC and EICR are issued to the person ordering the work (Reg 644.6 / Reg 653.6). You
            retain a copy; they retain the original. Your copy is your evidence; their copy is their
            evidence; both must match. Second, records are kept in a form that survives. Paper
            copies are still acceptable; encrypted electronic records on cloud-backed job-management
            software is the modern norm. Records on a single laptop with no backup are a single
            hard-drive failure away from being non-existent.
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Duty holder:</strong> identify the person commissioning the work and any other
              duty holders on site. Note in your job record. This determines who receives the
              certificate and any observations.
            </li>
            <li>
            ...
            <li>
              <strong>Competence:</strong> EAWR Reg 16 self-test for this specific installation. If
              marginal, work under supervision or decline.
            </li>
            <li>
              <strong>Records:</strong> what test records, schedules of inspection and condition
              evidence will you create? GN3 Ch 1 / HSR25 / EAWR Reg 4(2) — these are the evidentiary
              trail your future self will rely on.
            </li>
            <li>
