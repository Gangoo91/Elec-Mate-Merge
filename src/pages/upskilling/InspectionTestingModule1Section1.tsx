...
const DESCRIPTION =
  'Understand the legal framework for electrical inspection and testing in the UK, including Health and Safety at Work Act, Electricity at Work Regulations, and BS 7671 requirements.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'BS 7671 Regulation 610',
      'Building Regulations Part P',
    ],
    correctIndex: 1,
    explanation:
      'Regulation 4 of the Electricity at Work Regulations 1989 requires that all systems shall be constructed, maintained and used so as to prevent danger.',
  },
  {
    ...
    options: [
      ...
      'Balance the risk against cost, time and effort',
      'Only comply if convenient',
    ],
    correctIndex: 2,
    explanation:
      'Reasonably practicable means weighing the risk against the sacrifice (time, cost, effort) needed to avert it. If the risk outweighs the sacrifice, action must be taken.',
  },
  {
    id: 'eic-signoff',
    ...
    options: [
      'Any electrician',
      'Only a skilled person competent in inspection and testing',
      'The building owner',
      'Any contractor on site',
    ],
    correctIndex: 1,
    explanation:
      'Only a skilled person who is competent in inspection and testing can sign certification. This requires appropriate training, qualifications and experience.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      ...
      'To increase costs for clients',
      'To provide work for electricians',
    ],
    correctAnswer: 1,
    explanation:
      'The primary purpose is to verify that electrical installations are safe for continued use and comply with relevant standards and regulations.',
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      'The HASAWA 1974 places duties on both employers (to provide safe systems of work) and employees (to take reasonable care and cooperate).',
  },
  {
    id: 3,
    ...
    options: [
      'HASAWA Section 2',
      'EAW Regulations 1989 Reg 4',
      'BS 7671 Part 6',
      'CDM Regulations',
    ],
    correctAnswer: 1,
    explanation:
      'Regulation 4 of the Electricity at Work Regulations 1989 specifically requires that all electrical systems shall be maintained so as to prevent danger.',
  },
  {
    id: 4,
    ...
    options: [
      ...
      'It is a non-statutory standard (code of practice)',
      'It has no legal standing',
    ],
    correctAnswer: 2,
    explanation:
      'BS 7671 is a non-statutory document but compliance with it is likely to achieve compliance with statutory requirements.',
  },
  {
    id: 5,
    question: "Under EAW Regulations, the term 'absolute' means:",
    options: [
      'The duty is qualified by cost considerations',
      'The duty must be complied with regardless of cost',
      'The duty only applies sometimes',
      'The duty is optional',
    ],
    correctAnswer: 1,
    explanation:
      'An absolute duty must be complied with regardless of cost or difficulty. There is no defence of reasonable practicability.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'The City & Guilds 2391 (or equivalent like EAL or NICEIC) specifically demonstrates competence in inspection and testing of electrical installations.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'Serious breaches of EAW Regulations can result in unlimited fines and imprisonment, especially where death or serious injury occurs.',
  },
  {
    id: 8,
    ...
    options: [
      'Every month',
      'Every 6 months',
      'Up to 48 months depending on risk assessment',
      'Never',
    ],
    correctAnswer: 2,
    explanation:
      'The IET Code of Practice suggests that IT equipment in offices may only need formal testing up to every 48 months, based on risk assessment.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'The Health and Safety Executive (HSE) is responsible for enforcing the Electricity at Work Regulations 1989.',
  },
  {
    id: 10,
    question: "A 'skilled person' for electrical work is defined as someone who:",
    options: [
      'Has worked in the trade for 5+ years',
      'Has technical knowledge, experience and can prevent danger',
      'Holds a university degree',
      'Is registered with a government scheme',
    ],
    correctAnswer: 1,
    explanation:
      'A skilled person has technical knowledge or experience, and can recognise and avoid dangers in electrical work.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'While BS 7671 is not statutory, the Electricity at Work Regulations 1989 require that electrical systems are maintained to prevent danger. Periodic inspection is the accepted method of demonstrating compliance with this requirement. For landlords and employers, there are specific legal obligations.',
  },
  {
    question: 'How often must electrical installations be tested?',
    answer:
      'BS 7671 and GN3 provide recommended maximum intervals: domestic properties 10 years (5 years for rented), commercial 5 years, industrial 3 years, construction sites 3 months. These are maximum intervals - risk assessment may require more frequent testing.',
  },
  {
    question: 'Can I test my own work?',
    answer:
      "Yes, the installer should test their own work as part of initial verification. However, for periodic inspection of existing installations, it's often preferable to have independent testing. Some warranty schemes require third-party verification.",
  },
  {
    question: "What happens if I sign a certificate for work I haven't personally inspected?",
    answer:
      "Signing certification for work you haven't inspected is fraudulent and potentially criminal. You could face prosecution, loss of scheme membership, civil liability, and insurance claims. Only sign for work you have personally verified.",
  },
  {
    question: 'Do I need to be registered with a competent person scheme to test?',
    answer:
      'Registration with a competent person scheme (like NICEIC, NAPIT) is not legally required to carry out inspection and testing. However, you must be competent. For notifiable work under Building Regulations Part P, scheme membership or building control notification is required.',
  },
  {
    question: "What's the difference between EIC and EICR?",
    answer:
      'An EIC (Electrical Installation Certificate) is for new installations or additions. An EICR (Electrical Installation Condition Report) is for periodic inspection of existing installations. The EIC confirms compliance; the EICR reports on condition and identifies defects.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Purpose:</strong> Ensure safety, verify compliance, identify defects
              </li>
              <li>
                <strong>Key Law:</strong> Electricity at Work Regulations 1989
              </li>
              <li>
                <strong>Standard:</strong> BS 7671 (non-statutory but accepted)
              </li>
              <li>
                <strong>Penalties:</strong> Unlimited fines, imprisonment possible
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Unsafe installations, deterioration, damage
              </li>
              <li>
                <strong>Use:</strong> EIC for new work, EICR for existing
              </li>
              <li>
                <strong>Apply:</strong> Risk assessment determines test intervals
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Electrical inspection and testing is fundamental to ensuring the safety of people and
              property. Every year in the UK, there are approximately <strong>30 fatalities</strong>{' '}
              and <strong>350,000 injuries</strong> related to electrical accidents in domestic and
              workplace settings.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Safety verification</strong> - Confirming that installations don't pose a
                  risk of electric shock or fire
                </li>
                <li>
                  <strong>Regulatory compliance</strong> - Demonstrating compliance with statutory
                  requirements
                </li>
                <li>
                  <strong>Installation verification</strong> - Confirming work meets BS 7671
                  requirements
                </li>
                <li>
                  <strong>Defect identification</strong> - Finding deterioration, damage or defects
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white">
                ...
                identify many of these risks before they result in fire.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The <strong>Health and Safety at Work Act 1974 (HASAWA)</strong> is the primary piece
              of legislation covering occupational health and safety in Great Britain. It places
              general duties on employers, employees, and others.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The <strong>Electricity at Work Regulations 1989 (EAW)</strong> are the principal
              statutory requirements for electrical safety in the workplace. Unlike BS 7671, these
              are <strong className="text-elec-yellow">legally enforceable</strong>.
            </p>
            ...
            <div className="my-6">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/20">
                ...
                <p className="text-white italic text-sm mt-2">
                  "All systems shall be maintained so as to prevent, so far as is reasonably
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Regulation 16 - Competent Persons
              </p>
              <div className="p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/20">
                <p className="text-white italic text-sm">
                  "No person shall be engaged in any work activity where technical knowledge or
                  experience is necessary to prevent danger... unless he possesses such knowledge or
                  experience, or is under such degree of supervision as may be appropriate."
                </p>
              </div>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Absolute vs Reasonably Practicable
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              <strong>BS 7671</strong> (Requirements for Electrical Installations - IET Wiring
              Regulations) is the national standard for electrical installation in the UK. The
              current edition is the <strong className="text-elec-yellow">18th Edition</strong>,
              with Amendment 3 (A3:2024) being the latest.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Compliance with BS 7671 is likely to achieve compliance with statutory
                  requirements
                </li>
            ...
            <div className="my-6">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10 space-y-2">
                <p className="text-sm">
                  <strong className="text-elec-yellow">Reg 610.1</strong> - Every installation shall
                  be inspected and tested during erection and on completion
                </p>
                <p className="text-sm">
                  <strong className="text-elec-yellow">Reg 631.1</strong> - Initial verification
                  includes visual inspection followed by testing
                </p>
                <p className="text-sm">
                  <strong className="text-elec-yellow">Reg 650.1</strong> - Periodic inspection
                  shall reveal if installations are safe for continued use
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A <strong>'skilled person'</strong> (sometimes called 'competent person') is defined
              in BS 7671 as a person who possesses, as appropriate to the nature of the work:
            </p>
            <ul className="text-sm text-white space-y-1 ml-4">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Failure to comply with electrical safety requirements can have serious consequences
              for duty holders, including criminal prosecution, civil liability, and business
              impacts.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Buildings insurance may be void if electrical installation not properly maintained
                </li>
        ...
        {/* Reference Cards */}
        <section className="mb-10">
          <UnitsPocketCard title="Key Regulations Reference" items={referenceItems} />
