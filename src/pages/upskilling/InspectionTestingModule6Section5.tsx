...
const DESCRIPTION =
  'Master RCD discrimination and selectivity to ensure correct sequential tripping and maintain supply to unaffected circuits during fault conditions.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Discrimination (selectivity) means the RCD nearest the fault trips while upstream RCDs remain closed, maintaining supply to unaffected circuits.',
  },
  {
    id: 's-type-delay',
    ...
    correctIndex: 1,
    explanation:
      'S-type RCDs have a minimum delay of 130ms at rated residual current. They must still trip within 500ms at 1xIdn and 200ms at 5xIdn.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "S-type RCDs have a minimum delay of 50ms at 5xIdn, which doesn't meet the 40ms maximum required for additional protection. General-type 30mA RCDs must be used.",
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Standard', 'Selective (time-delayed)', 'Single-phase', 'Surge-protected'],
    correctAnswer: 1,
    explanation:
      'S-type (Selective) RCDs have an intentional time delay to allow downstream general-type RCDs to trip first, achieving discrimination.',
  },
  {
    id: 3,
    question: 'What is the minimum trip delay for an S-type RCD at 1xIdn?',
  ...
  },
  {
    id: 4,
    question:
      'For discrimination to work between two RCDs in series, what should their Idn ratings be?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'For current discrimination, the upstream RCD should typically be at least 3x the rating of the downstream RCD. This can be combined with time delay for better discrimination.',
  },
  {
    id: 5,
    question:
      'A 30mA general RCD and 100mA S-type RCD are installed in series. Which should be upstream?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'The 100mA S-type should be upstream. Its higher rating and time delay allow the 30mA general RCD to trip first for faults on its circuit while maintaining supply to other circuits.',
  },
  {
    id: 6,
    question: 'What is the maximum trip time for an S-type RCD at 5xIdn?',
    options: ['40ms', '150ms', '200ms', '500ms'],
    correctAnswer: 2,
    explanation:
      'S-type RCDs must trip within 200ms at 5xIdn (compared to 40ms for general-type RCDs), allowing time for downstream devices to operate first.',
  },
  {
    id: 7,
    question:
      'In a domestic installation with an RCBO board, how is discrimination typically achieved?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'An upstream S-type RCD (100mA or 300mA) at the incomer combined with general-type 30mA RCBOs provides discrimination - the RCBO trips first, the incomer remains closed.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Ramp testing reveals the actual trip current of each RCD, confirming the downstream RCD will trip before the upstream device reaches its trip threshold.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Without discrimination, the upstream RCD may trip first, disconnecting all circuits including healthy ones - causing inconvenience and potential safety issues.',
  },
  {
    id: 10,
    question: 'For an S-type RCD at 1xIdn, what is the trip time window?',
    options: ['0 to 300ms', '130ms to 500ms', '40ms to 200ms', '0 to 40ms'],
    correctAnswer: 1,
    explanation:
      'S-type RCDs have a trip time window of 130ms (minimum delay) to 500ms (maximum) at 1xIdn, allowing time for downstream general-type RCDs to operate first.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Yes, but discrimination may not be achievable without time delay. If an upstream 30mA S-type and downstream 30mA general-type are used, the time delay provides some discrimination. However, for better selectivity, the upstream should have a higher rating (e.g., 100mA S-type upstream, 30mA general downstream).',
  },
  {
    question: "What happens if discrimination doesn't work?",
    answer:
      'Without discrimination, a fault on one circuit may trip the upstream RCD, disconnecting all circuits protected by that device. This causes unnecessary disruption to unaffected circuits and can create safety issues if essential equipment (like emergency lighting) loses power.',
  },
  {
    question: 'Why is time-delayed discrimination important in commercial installations?',
    answer:
      'Commercial installations often have critical loads that must remain operational during faults on other circuits. Time-delayed upstream RCDs ensure only the faulty circuit loses power while maintaining supply to essential services like servers, refrigeration, or emergency systems.',
  },
  {
    question: 'Can RCBOs provide discrimination?',
    answer:
      "Individual RCBOs don't provide discrimination between each other as they typically have the same rating and response time. Discrimination is achieved by having an S-type RCD upstream of general-type RCBOs, or by using RCBOs with different ratings where appropriate.",
  },
  {
    question: 'How do I verify discrimination has been achieved?',
    answer:
      "Ramp testing each RCD reveals actual trip thresholds. For discrimination, the downstream RCD's trip current must be below the upstream RCD's minimum sensitivity (50% of Idn). Time discrimination can be verified by comparing trip times at test currents.",
  },
  {
    question: 'Are S-type RCDs suitable for personal protection circuits?',
    answer:
      "S-type RCDs are typically used upstream for discrimination, not for final circuits requiring personal protection. The time delay means they don't provide the rapid disconnection needed for personal protection (max 40ms at 5xIdn) - general-type 30mA RCDs are required for this.",
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Goal:</strong> Only RCD nearest fault trips
              </li>
              <li>
                <strong>S-type:</strong> Time-delayed (130-500ms at 1xIdn)
              </li>
              <li>
                <strong>Current:</strong> Upstream at least 3x downstream
              </li>
              <li>
                <strong>Combine:</strong> Both methods for best results
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>1xIdn:</strong> 130ms - 500ms
              </li>
              <li>
                <strong>2xIdn:</strong> 60ms - 200ms
              </li>
              <li>
                <strong>5xIdn:</strong> 50ms - 150ms
              </li>
              <li>
                <strong>NOT for:</strong> Additional protection circuits
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              ensure that only the device nearest to a fault operates, leaving upstream devices
              closed and maintaining supply to unaffected circuits.
            </p>
            ...
            <p>
              Without discrimination, a fault on a single socket outlet could trip the main RCD and
              disconnect the entire installation - an unacceptable situation in most modern
              installations.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              RCD discrimination can be achieved through two methods, ideally used in combination
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              S-type (Selective) RCDs are designed specifically for upstream installation in
              discriminating systems. They have an intentional time delay before tripping:
            </p>
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="text-white/80">
                  ...
                  <tr>
                    ...
                    <td className="py-2 text-center text-emerald-400" colSpan={2}>
                      No trip
                    </td>
                  </tr>
                </tbody>
            ...
            <p className="text-sm text-amber-300/80">
              <strong>Important:</strong> S-type RCDs are NOT suitable for additional protection
              (personal protection circuits) as they don't meet the 40ms requirement at 5xIdn. Use
              general-type 30mA RCDs for final circuits.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Common discrimination arrangements in UK installations:</p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              To verify discrimination will work in practice, test both RCDs and compare their
              characteristics:
            </p>
            ...
            <div className="my-6 space-y-3">
              {[
                ...
                {
                  step: 3,
                  text: "Verify downstream trips at lower current than upstream's 50% threshold",
                },
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Where discrimination is required, the design and testing should be documented to
              demonstrate compliance and aid future maintenance:
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>S-type must NOT be used</strong> where additional protection is required
                </li>
        ...
        <section className="mb-10">
          ...
          <div className="mt-6 p-5 rounded-lg bg-transparent">
            <h3 className="text-sm font-medium text-white mb-4">
              RCD Discrimination Quick Reference
            </h3>
