    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Type S at the origin, 30 mA general-purpose downstream. The selectivity rule of Reg
          536.4.1.4, and the two tests that prove it on the Schedule of Test Results.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>TN-S / TN-C-S board with a Type S incomer.</strong> 100 mA type S RCCB at the
              origin (or as a sub-main feed) protecting against fire (Reg 422.3.9 / persistent earth
              fault risk) and providing earth-fault disconnection back-up. Below it, 30 mA RCBOs on
              outgoing ways.
            </li>
            <li>
              <strong>TT installation.</strong> A type S RCCB at the origin is effectively mandatory
              because the high earth-electrode resistance Ra means the overcurrent device cannot
              meet the disconnection times of Table 41.1. The upstream IΔn is sized from Table 53.1
              against Ra: at Ra = 167 Ω, max IΔn = 300 mA; at Ra = 500 Ω, max IΔn = 100 mA; at Ra =
              1667 Ω, max IΔn = 30 mA. Below it, 30 mA RCBOs continue to provide the
              additional-protection duty.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Selectivity in case of residual currents, as shown in Figure 536.2, is given under the
              following conditions: (i) the upstream RCD is of selective type (type S or
              time-delayed type with appropriate time delay setting); and (ii) the ratio of the
              rated residual operating current of the upstream RCD to that of the downstream RCD is
              at least 3:1. In the case of RCDs with adjustable rated residual operating current and
              time delay, reference shall be made to manufacturer&rsquo;s instructions for
              selectivity.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              will be marked with the symbol Δt followed by the limiting non-actuating time in ms or
              marked with an [S].
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              must NOT trip during that window — which is what allows the downstream device to clear
              and the upstream device to ride through.
            </li>
          </ul>
          <p>
            ...
            The 3:1 IΔn ratio in Reg 536.4.1.4(b)(ii) is the second half of the equation: it ensures
            that residual currents at the downstream end of the operating range (just above 30 mA,
            say) never reach the upstream IΔn (100 mA) — so the upstream device sees nothing and the
            downstream device handles it cleanly.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Black-out failure (continuity):</strong> upstream trips on a downstream fault.
              No shock, no danger. Typical EICR coding is C3 (improvement recommended) on an
              existing 30 / 30 stack — recommend swap of the upstream device to a Type S to comply
              with Reg 536.4.1.4. Code FI (further investigation) is rarely justified because the
              protective duty was met.
            </li>
            <li>
              <strong>Safety failure (shock / fire):</strong> the downstream device fails to operate
              at all (mechanical fault, wrong type for the load, wired-out neutral, blinding by
              upstream type) AND the upstream is too coarse to clear the fault inside the
              disconnection time. That is C1 / C2 territory — a real danger. Selectivity is
              irrelevant; the question becomes whether the protective measure works at all.
            </li>
          </ul>
          <p>
            Confusing the two on a certificate either over-states danger (an unnecessary C2 on a 30
            / 30 stack) or under-states it (calling a non-functional downstream device a mere
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              compliant. The upstream is also not a selective type, so both 536.4.1.4(b) conditions
              fail simultaneously.
            </li>
          </ul>
          <p>
            The 3:1 figure is not arbitrary. It accounts for component tolerance: a 30 mA device may
            actually trip anywhere from 15 mA to 30 mA per the BS EN 61008 specification, and a 100
            mA upstream device may trip anywhere from 50 mA to 100 mA. Even with worst-case
            tolerance — downstream tripping at 30 mA, upstream tripping at 50 mA — the upstream
            still has a margin against single-circuit faults that the downstream is meant to clear.
            The 3:1 nominal ratio survives the tolerance band; a 2:1 ratio does not.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            {/* Supply incomer */}
            <line x1="40" y1="40" x2="120" y2="40" stroke="rgba(255,255,255,0.4)" strokeWidth="2" />
            ...
            <rect
              ...
              strokeWidth="2"
            />
            <text x="360" y="35" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              UPSTREAM RCD — TYPE S
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="735" y="38" textAnchor="middle" fill="#FBBF24" fontSize="10" fontWeight="bold">
              Reg 536.4.1.4(b)
            </text>
            <text x="735" y="54" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="9">
              100 mA ÷ 30 mA
            </text>
            <text x="735" y="68" textAnchor="middle" fill="#FBBF24" fontSize="10" fontWeight="bold">
              = 3.33 ≥ 3:1 ✓
            </text>
              ...
              return (
                <g key={i}>
                  <line
                    ...
                    strokeWidth="1"
                  />
                  <text x={x} y="428" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9">
                    {t}
                  </text>
                </g>
              );
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              <span className="block">
                4. Test selectivity: inject a residual fault between upstream and downstream (sized
                below 100 mA — typically 30 mA via the downstream device&rsquo;s test facility or
                via a controlled residual injection). Confirm the downstream RCBO clears, the
                upstream type S does NOT operate, and the upstream remains in service.
              </span>
              <span className="block">
                5. Record on the Schedule: upstream IΔn (100 mA), upstream trip time at IΔn,
                downstream IΔn (30 mA), downstream trip times at IΔn and 5×IΔn, and a comments note:
                &quot;Selectivity verified per Reg 536.4.1.4 — downstream operated alone on injected
                fault.&quot;
              </span>
            </>
          }
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              injected at 100 mA (or whatever the device IΔn is). Reading must fall in the ≈ 130–500
              ms band. A reading of 280 ms is normal. A reading of 60 ms indicates the device is
              actually general-purpose (no built-in delay) — investigate before accepting.
            </li>
            <li>
              <strong>Downstream general-purpose at IΔn:</strong> tester set to general-purpose, 30
              mA injected. Reading must be ≤ 300 ms. Typical readings are 20–40 ms on modern RCBOs.
            </li>
            <li>
          ...
          <p>
            ...
            IΔn it was tested at noted unambiguously. A common error is recording only one trip time
            (5×IΔn) and omitting IΔn, which means a future inspector cannot confirm whether the
            device met its own basic spec. Record both.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            upstream did not operate on inter-device residual fault below upstream IΔn — selectivity
            verified per Reg 536.4.1.4.&rdquo; A future inspector reads that and knows exactly what
            was tested.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            For multi-layer stacks the rule is simple: every selective layer except the very bottom
            one must be a type S (or time-delayed) device. A type S in the middle waits long enough
            for the device below it to clear, while still being fast enough to be cleared itself by
            the type S above it. Mixing in a general-purpose device anywhere except the bottom of
            the stack creates a layer with no time discrimination, and the chain breaks at that
            point.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            (without or with an RDC-DD) or Type B, as the load characteristics that the Type A, Type
            F or Type B has been selected for could impair operation of the Type AC RCD.&rdquo; NOTE
            5 names the failure mode: &ldquo;impaired operation is commonly termed as RCD
            blinding.&rdquo;
          </p>
          <p>
        ...
        <ContentEyebrow>The TT system case — where Type S is essentially mandatory</ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Downstream device rows (one per circuit):</strong> IΔn (e.g. 30 mA), trip time
              at IΔn (e.g. 24 ms), trip time at 5×IΔn (e.g. 12 ms — must be ≤ 40 ms for additional
              protection per Reg 415.1.1).
            </li>
            <li>
              <strong>
          ...
          <p>
            ...
            arrangement. The Schedule of Test Results is a durable evidential document — it survives
            the installer leaving, the company changing hands, the meter being upgraded. Every piece
            of protective evidence belongs on it.
          </p>
        </ConceptBlock>
