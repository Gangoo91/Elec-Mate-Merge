...
const PATTestingModule3Section4 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="PAT M3 · Section 4"
        title="Environmental considerations"
        backTo="/electrician/upskilling/pat-testing-module-3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          HSG107 Table 1 categories, BS EN 60529 IP ratings, and how wet / dust / heat / vibration /
          movement drive both equipment selection and inspection frequency.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              potentially less supervised use; cleaning regimes generally good. Frequencies shorter
              than offices but longer than industrial / hire.
            </li>
            <li>
              <strong>Hotels, shops, public buildings.</strong> Mixed environments — staff areas
              similar to offices; public-facing areas with vending / catering equipment that may be
              moved or knocked. Frequencies set to the dominant exposure of the equipment.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              recommendations; the initial integrity and soundness of the equipment; the age of the
              equipment; the working environment in which the equipment is used (for example, wet,
              dusty, hot, corrosive); the frequency of use, and the duty cycle of the equipment.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>IP20</strong> — typical indoor desk equipment. No water protection. Unsuitable
              for damp / outdoor use.
            </li>
            <li>
              <strong>IP44</strong> — splash-proof general industrial / outdoor. Typical minimum for
              site-tools and outdoor extension leads.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              enclosure against access to hazardous parts, ingress of solid foreign objects, ingress
              of water, and to give additional information in connection with such protection. The
              first characteristic numeral indicates the degree of protection provided by the
              enclosure against access to hazardous parts and against ingress of solid foreign
              objects. The second characteristic numeral indicates the degree of protection provided
              by the enclosure against the ingress of water with harmful effects.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Water.</strong> Pin oxidation (green / brown corrosion), insulation resistance
              dropping over time, rust on metal parts, water ingress through cord-grip gaps.
              Equipment must be IP44+ for typical wet exposure; IP65+ for direct washdown.
            </li>
            <li>
              <strong>Dust.</strong> Packed around contacts (insulating the cooling), bridging live
              parts to earth (especially metallic / conductive dust), clogging cooling vents,
            ...
            <li>
              ...
              conductors at strain-reliefs, cracked moulded plug bodies, cord-grip slip. Items that
              travel between rooms, are plugged / unplugged daily, or are mounted on vibrating
              equipment earn a shorter inspection cycle and more robust connectors.
            </li>
          </ul>
          <p>
        ...
        <ContentEyebrow>Movement, plug cycles, and the high-mechanical-stress case</ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Hardened, brittle PVC flex within months of installation. Replace with heat-resisting
              flex (BS EN 50525 H05RR-F or H07RN-F).
            </li>
            <li>
              Discolouration of moulded plug bodies even without a contact fault — the ambient heat
              is doing the work.
            </li>
            <li>
              Equipment with high internal heat (commercial kitchen kit, laundry irons) has its own
              thermal envelope; the lead specification must match.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              dusty, hot or corrosive locations, the equipment shall be selected to be suitable for
              the environment, the inspection regime shall reflect the increased rate at which
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              The hirer&rsquo;s environment may be unknown — the same lead might be used indoors one
              week and outdoors the next.
            </li>
            <li>
            ...
            <li>
              Liability sits with the hire company — the kit going out must be safe; the kit coming
              back must be inspected before the next hire.
            </li>
          </ul>
          <p>
