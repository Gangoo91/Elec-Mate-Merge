...
const DESCRIPTION =
  'Master TIA-568 and ISO 11801 standards for fibre optic testing, including link budget calculations, connector and splice loss allowances, and margin requirements.';

const quickCheckQuestions = [
  {
    id: 'passfail-qc1',
    question: 'What is the maximum connector loss allowance per TIA-568 for a mated pair?',
    options: ['0.25 dB', '0.75 dB', '1.0 dB', '0.50 dB'],
    correctIndex: 1,
    explanation:
      'TIA-568 specifies a maximum of 0.75 dB loss per mated connector pair. This includes both connector ends and the adapter. High-quality connectors typically achieve 0.3 dB or less.',
  },
  {
    id: 'passfail-qc2',
    question: 'What attenuation rate does TIA-568 specify for OS2 singlemode fibre at 1310nm?',
    options: ['0.5 dB/km', '1.0 dB/km', '3.5 dB/km', '0.4 dB/km'],
    correctIndex: 3,
    explanation:
      'TIA-568 specifies 0.4 dB/km maximum attenuation for OS2 singlemode fibre at 1310nm. At 1550nm, the specification is even lower at 0.3 dB/km due to lower absorption.',
  },
  {
    id: 'passfail-qc3',
    question: 'What minimum margin is typically recommended above the calculated link loss budget?',
    options: ['0.5 dB', '1.5 to 3.0 dB', '5.0 dB', 'No margin needed'],
    correctIndex: 1,
    explanation:
      'A margin of 1.5 to 3.0 dB above the calculated loss budget is recommended. This accounts for future repairs, connector ageing, additional splices, and measurement uncertainty.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['1.5 dB/km', '2.5 dB/km', '3.5 dB/km', '4.5 dB/km'],
    correctAnswer: 2,
    explanation:
      'OM3 multimode fibre has a maximum attenuation of 3.5 dB/km at 850nm per TIA-568 specifications.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'ISO 11801 Class EA requires Grade B or better connectors with typical loss of 0.25 dB or less.',
  },
  {
    id: 6,
    question:
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      '1550nm is more sensitive to macrobending losses, revealing installation issues that may not appear at 1310nm.',
  },
  {
    id: 8,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'ISO 11801 Grade A connectors have a maximum insertion loss of 0.15 dB - the highest quality grade.',
  },
  {
    id: 10,
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">Standards-based testing and link budget calculations</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Standards:</strong> TIA-568 and ISO 11801
              </li>
              <li>
                <strong>Connector:</strong> 0.75 dB max per pair
              </li>
              <li>
                <strong>Splice:</strong> 0.3 dB max (fusion)
              </li>
              <li>
                <strong>Margin:</strong> 1.5-3.0 dB recommended
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>OS2 at 1310nm:</strong> 0.4 dB/km max
              </li>
              <li>
                <strong>OS2 at 1550nm:</strong> 0.3 dB/km max
              </li>
              <li>
                <strong>OM3 at 850nm:</strong> 3.5 dB/km max
              </li>
              <li>
                <strong>Test both:</strong> 1310nm and 1550nm
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Fibre optic testing pass/fail criteria are defined by industry standards. Knowing
              which standard applies to your project is essential.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>IEC 61280:</strong> Fibre optic test procedures
                </li>
                <li>
                  <strong>IEC 61300:</strong> Fibre optic connector tests
                </li>
                <li>
                  <strong>IEC 61300-3-35:</strong> Connector end face inspection
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Standards specify maximum allowable loss for each component type. These values are
              used to calculate total link budgets.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Maximum per mated pair:</strong> 0.75 dB
                </li>
                <li>
                  <strong>Typical quality connector:</strong> 0.2-0.5 dB
                </li>
                <li>
                  <strong>High-performance:</strong> Under 0.2 dB
                </li>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Grade A:</strong> 0.15 dB maximum (highest quality)
                </li>
                <li>
                  <strong>Grade B:</strong> 0.25 dB maximum
                </li>
                <li>
                  <strong>Grade C:</strong> 0.50 dB maximum
                </li>
                <li>
                  <strong>Grade D:</strong> 0.75 dB maximum
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Fusion splice maximum:</strong> 0.3 dB
                </li>
                <li>
                  <strong>Typical fusion splice:</strong> 0.02-0.1 dB
                </li>
                <li>
                  <strong>Mechanical splice maximum:</strong> 0.3 dB
                </li>
                <li>
                  <strong>Typical mechanical splice:</strong> 0.1-0.2 dB
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Different fibre types have different attenuation characteristics. Standards specify
              maximum attenuation per kilometre.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>At 1310nm:</strong> 0.4 dB/km maximum
                </li>
                <li>
                  <strong>At 1550nm:</strong> 0.3 dB/km maximum
                </li>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>OM1/OM2 at 850nm:</strong> 3.5 dB/km maximum
                </li>
                <li>
                  <strong>OM3/OM4/OM5 at 850nm:</strong> 3.5 dB/km maximum
                </li>
                <li>
                  <strong>All OM at 1300nm:</strong> 1.5 dB/km maximum
                </li>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                For singlemode, always test at both 1310nm and 1550nm. While 1310nm detects
                connector and splice losses effectively, 1550nm is more sensitive to macrobending. A
                link that passes at 1310nm but fails at 1550nm has installation issues (tight bends,
                stressed cable) that need correction.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A link budget calculates the maximum allowable loss for a fibre link. Measured loss
              must be at or below this calculated budget.
            </p>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white ml-4 p-3 bg-white/5 rounded font-mono">
                Total Budget = (Length x Attenuation) + (Connectors x Loss) + (Splices x Loss) +
                Margin
              </p>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Example calculation (singlemode at 1310nm):
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>Cable length: 2 km</li>
                <li>
                  Fibre attenuation: 2 km x 0.4 dB/km = <strong>0.8 dB</strong>
                </li>
                <li>
                  Connectors: 4 pairs x 0.75 dB = <strong>3.0 dB</strong>
                </li>
                <li>
                  Splices: 2 x 0.3 dB = <strong>0.6 dB</strong>
                </li>
                <li>
                  Margin: <strong>2.0 dB</strong>
                </li>
                <li>
                  <strong>Total budget: 6.4 dB</strong>
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  If measured loss is 5.2 dB: <strong>Pass</strong> (under 6.4 dB budget)
                </li>
                <li>
                  If measured loss is 6.8 dB: <strong>Fail</strong> (exceeds budget)
                </li>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Including margin in your budget accounts for future changes and degradation over the
              link's lifetime.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Future repairs:</strong> Additional splices from cable breaks
                </li>
                <li>
                  <strong>Connector ageing:</strong> Slight degradation over time
                </li>
                <li>
                  <strong>Environmental changes:</strong> Temperature variations
                </li>
                <li>
                  <strong>Additional connections:</strong> Patches added later
                </li>
                <li>
                  <strong>Measurement uncertainty:</strong> Test equipment tolerance
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Minimum:</strong> 1.5 dB for stable environments
                </li>
                <li>
                  <strong>Typical:</strong> 2.0-3.0 dB for most installations
                </li>
                <li>
                  <strong>High-reliability:</strong> 3.0 dB or more
                </li>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Proper documentation of test results is essential for handover, troubleshooting, and
              future reference.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Link identification:</strong> Clear labelling of both ends
                </li>
                <li>
                  <strong>Test date and time:</strong> When testing was performed
                </li>
                <li>
                  <strong>Test equipment:</strong> OTDR/power meter model, serial, calibration date
                </li>
                <li>
                  <strong>Test parameters:</strong> Wavelength, reference method, settings
                </li>
                <li>
                  <strong>Measured values:</strong> Loss, ORL, event table
                </li>
                <li>
                  <strong>Calculated budget:</strong> Show workings
                </li>
                <li>
                  <strong>Pass/fail verdict:</strong> Clear determination
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                For links that pass but with low margin: Document as 'Pass (Low Margin)' and note
                specific recommendations. Identify the highest-loss events and suggest remediation
                priorities. This provides valuable information for future troubleshooting and
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Typical vs Worst-Case Values
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Certification:</strong> Use maximum (worst-case) values from standards
                </li>
                <li>
                  <strong>Design:</strong> May use typical values with adequate margin
                </li>
                <li>
                  <strong>Always document:</strong> Which approach was used
                </li>
                <li>
                  <strong>Worst-case:</strong> Provides inherent safety factor
                </li>
              </ul>
            </div>
