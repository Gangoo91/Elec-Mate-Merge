...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      '12VDC',
      '24VDC plus or minus 10% (21.6V to 26.4V) for reliable transmitter operation',
      '48VDC',
      '5VDC',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'To verify the receiver shows maximum scale value and calculate span accuracy',
      'To check cable resistance',
      'To test alarm functions only',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'That power is removed from the circuit',
      'That cables are labelled',
      'That alarms are disabled',
    ],
    correctAnswer: 1,
    explanation:
