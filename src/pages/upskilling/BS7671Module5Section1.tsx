...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['CAT I — Uw 1.5 kV', 'CAT II — Uw 2.5 kV', 'CAT III — Uw 4 kV', 'CAT IV — Uw 6 kV'],
    correctAnswer: 3,
    explanation:
      ...
      <HubBody>
        ...
        >
          <p>
            ...
            <strong> current</strong> edition with all BSI-declared amendments. Out-of-date editions
            are non-compliant. Equipment to a non-relevant standard (e.g. a continental DIN-only
            accessory with no British or Harmonized equivalent) is non-compliant. The duty sits with
            the designer (Reg 132.1) and the installer (Reg 134.1.1) jointly.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 511.2 is narrow on purpose. The default expectation is that equipment is built to a
            recognised standard. The bespoke route exists for genuine one-offs and for equipment
            ...
            recorded under Reg 120.3 on the EIC with the supporting evidence retained as part of the
            project record. The burden of proof sits with the designer \u2014 it cannot be
        ...
        >
          <p>
            ...
            sometimes cite test-method standards (BS EN 60529 IP testing, BS EN 62262 IK testing, BS
            EN 60068 environmental testing) as if they were product-conformity standards \u2014 they
            are not. A product declared only to test-method standards has not declared conformity to
            its own product standard, and Reg 511.1 is not satisfied. The corresponding product
            standards \u2014 BS EN 60670 (installation boxes), BS EN 60898 (MCBs), BS EN 61008 /
            61009 (RCDs / RCBOs), BS EN 61439 (LV switchgear and controlgear assemblies), BS EN
            60669 (switches), BS EN 60898-2 (DC MCBs), BS EN 62196 (EV connectors), BS EN 50525
            (cables), BS EN 50550 (PEN-fault relays) \u2014 are the ones that have to appear on the
            declaration of conformity. The test-method standards are referenced inside the product
            standard and are not a substitute for it.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The Electrical Equipment (Safety) Regulations 2016 and the EMC Regulations 2016 are the
            UK statutory instruments that require UKCA (and accept CE during transitional periods)
            marking on most LV electrical equipment placed on the GB market. Compliance with these
            regulations is established via conformity-assessment procedures referenced by harmonised
            standards. Reg 511.1 then layers a second, independent installation-side requirement on
            top: the equipment must also conform to the <em>relevant</em> British or Harmonized
            installation standard at its <em>current edition</em>. The two regimes overlap but
            neither subsumes the other. Treat them as two separate locks both needing the right key.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            accessory must cope with sustained 253 V; a sustained 253 V across an undersized coil or
            insulation is a measurable degradation rate, not just a notional possibility.
        ...
        >
          <p>
            ...
            supply, when properly connected and operated. In practice this maps to: RCD selectivity
            (a 30 mA downstream RCBO discriminating from a 100 mA upstream Type S RCD per
            manufacturer time-current curves, not just by sensitivity), RCD-type compatibility (Type
            AC blind to pulsating DC; Type A blind to smooth DC; Type B sees the lot but costs
            4\u20135\u00d7), AFDD compatibility with the protected circuit\u2019s arc signature,
            VFD-induced harmonics within the limits of upstream switchgear and metering, busbar /
            DIN-rail mechanical compatibility within manufacturer\u2019s assemblies, and the EMC
            environment Reg 444 / Section 444 governs separately. \u2018All the parts work
            individually\u2019 is not the test \u2014 the test is whether they work together without
            harmful interaction.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The Reg 522 / Appendix 5 taxonomy gives you a structured language for environment. AA is
            ambient temperature (AA1 = -60 to +5 \u00b0C through AA8 = +50 to +60 \u00b0C). AB is
            humidity. AD is water (AD1 negligible through AD8 immersion). AE is foreign solid bodies
            (dust). AF is corrosion. AG is mechanical impact (AG1 low, AG3 high \u2014 site /
            industrial). AH is vibration. AK / AL are flora / fauna. AN is solar radiation. BA is
            the capability of persons (BA1 ordinary through BA5 skilled, with BA2 children and BA3
            disabled triggering specific requirements in special locations). BB is body resistance
            (reduced by moisture / wet skin). BC is contact with earth potential. BD is escape
            conditions. BE is nature of materials handled. On site, you typically have two or three
            dominant codes \u2014 a kitchen is AA / AB / AD3, a workshop is AG3 / AF / AE, a garden
            room is AD3 / BB / AB. Equipment IP / IK rating, material and orientation follow from
            the dominant codes.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            Where the manufacturer is more restrictive (specific RCD type, tighter terminal torque,
            smaller maximum CPC size, mandatory bend radius, specific upstream device
            ...
            special-location requirement the manufacturer\u2019s instruction does not consider), BS
            7671 governs. A genuine direct conflict is rare and is resolved as a designed departure
            under Reg 120.3 with documented justification, often by selecting different equipment.
            The phrase "the manual\u2019s only a guide" has no regulatory standing.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            equipment must be reachable for the activities listed: operation (e.g. a switch you can
            actually reach), inspection (e.g. terminals you can see), testing (e.g. a place to apply
            test instrument leads), fault-finding (e.g. a way to locate a problem), maintenance
            (e.g. cleaning, lubrication, terminal re-tightening) and repair (e.g. replacement of a
            failed component). The clause is read together with Reg 526.3, which separately requires
            every connection / joint to be accessible for inspection, testing and maintenance \u2014
            with a narrow set of exceptions for compound-filled, brazed / welded / soldered, or
            maintenance-free crimped joints in compliant accessories. A junction box behind sealed
            plasterboard fails both regulations.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            the equipment\u2019s intended use (Reg 511.1). <strong>2. Edition.</strong> Confirm the
            declared edition is current per BSI \u2014 supersedes are public.
            ...
            cable Iz and load Ib per Reg 433.1.1; abnormal currents (inrush, fault) considered (Reg
            512.1.2). <strong>5. Frequency.</strong> 50 Hz UK LV (Reg 512.1.3).{' '}
            <strong>6. Power / breaking capacity.</strong> Icn / Icu \u2265 PSCC at point of
            installation (Reg 512.1.4 / 434.5.1).{' '}
            <strong>7. Impulse withstand / overvoltage category.</strong> CAT I 1.5 kV / CAT II 2.5
            kV / CAT III 4 kV / CAT IV 6 kV per Table 443.2 (Reg 512.1.6).{' '}
