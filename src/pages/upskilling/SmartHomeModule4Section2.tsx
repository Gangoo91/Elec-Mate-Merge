...
const DESCRIPTION =
  'Master the integration of smart controls with different heating system types, including radiator-based systems, gas boilers, and air source heat pumps.';

const quickCheckQuestions = [
  {
    question: 'What is the primary function of a smart TRV?',
    options: [
      'Generate heat for the radiator',
      'Control water flow based on room temperature',
      'Measure boiler efficiency',
      'Filter heating system water',
    ],
    correctAnswer: 1,
    explanation:
      'Smart TRVs regulate the flow of hot water through individual radiators based on the set temperature and actual room temperature, allowing independent control of each radiator.',
  },
  {
    question: 'How does OpenTherm differ from simple relay boiler control?',
    options: [
      'It uses higher voltage',
      'It allows two-way communication and modulation',
      'It only works with oil boilers',
      'It requires no wiring',
    ],
    correctAnswer: 1,
    explanation:
      'OpenTherm enables two-way digital communication between the thermostat and boiler, allowing the boiler to modulate its output rather than simply switching on and off.',
  },
  {
    question: 'Why do heat pumps require different control strategies than gas boilers?',
    options: [
      'They are more expensive',
      'They work most efficiently at lower flow temperatures',
      'They only work in summer',
      'They use more electricity',
    ],
    correctAnswer: 1,
    explanation:
      'Heat pumps achieve their best efficiency at lower flow temperatures (35-45 degrees C), requiring weather compensation and longer heating periods rather than rapid on/off cycling.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'If all TRVs close while the boiler is firing, there is nowhere for the heated water to go, potentially causing boiler lockout or damage. A bypass valve prevents this.',
  },
  {
...
const faqs = [
  {
    ...
    answer:
      'No. Smart TRV heads simply screw onto the existing valve body, replacing the manual head. The valve remains in place and there is no need to drain the system. This makes retrofit installation quick and straightforward.',
  },
  {
    question: 'Can smart heating controls work with combi boilers?',
    answer:
      'Yes. Smart thermostats and TRVs work with combi boilers. The thermostat typically connects to the boiler via a receiver/heat link unit. Some combi boilers have built-in OpenTherm connections for enhanced integration.',
  },
  {
    question: 'Are heat pumps compatible with standard smart thermostats?',
    answer:
      'Basic on/off smart thermostats can control heat pumps, but for optimal efficiency you need a thermostat designed for heat pump operation with weather compensation and optimum start features. Check manufacturer compatibility.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-3xl mx-auto">
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Smart TRVs replace the manual thermostatic heads on radiator valves, adding wireless
            connectivity and programmable temperature control to each radiator.
          </p>
          <div className="space-y-3 mb-4">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <h4 className="font-medium text-elec-yellow mb-2">How They Work</h4>
              <p className="text-white text-sm">
                Smart TRVs contain a motor that adjusts the valve pin position based on temperature
                readings from a built-in sensor. They communicate wirelessly with a hub or bridge to
                receive schedules and setpoint changes.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            ...
            <ul className="text-white text-sm space-y-1">
              <li>
                <span className="text-elec-yellow">M30 x 1.5:</span> Most common UK/European
                standard
              </li>
              <li>
                <span className="text-elec-yellow">M28 x 1.5:</span> Some older Danfoss valves
              </li>
              <li>
                <span className="text-elec-yellow">RA:</span> Danfoss snap-fit (requires adaptor)
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Smart thermostats must communicate with the boiler to control heating output. The
            integration method affects both functionality and efficiency.
          </p>
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-elec-yellow mb-2">Simple Relay (On/Off)</h4>
              <p className="text-white text-sm mb-2">
                The most basic connection uses volt-free contacts to switch the boiler on when heat
                is required. The boiler fires at full output until satisfied.
              </p>
              <p className="text-white text-sm">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                Digital two-way communication protocol. The thermostat can request specific flow
                temperatures and the boiler modulates its output accordingly.
              </p>
              <p className="text-white text-sm">
                <span className="text-elec-yellow">Pros:</span> Higher efficiency, weather
                compensation.
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                Some manufacturers use proprietary communication protocols (eBus, EMS+, Vitoconnect)
                that offer similar features to OpenTherm.
              </p>
              <p className="text-white text-sm">
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Heat pumps require different control strategies than gas boilers. Understanding these
            differences is essential for efficient system operation.
          </p>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-4">
            ...
            <ul className="text-white text-sm space-y-2">
              <li>
                <span className="font-medium">Lower flow temperatures:</span> Heat pumps work best
                at 35-45 degrees C, not the 60-80 degrees C typical of boilers
              </li>
              <li>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            When integrating smart controls with heating systems, several design factors must be
            addressed to ensure reliable operation.
          </p>
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-elec-yellow mb-2">Bypass Protection</h4>
              <p className="text-white text-sm">
                When all smart TRVs close, the boiler needs somewhere to circulate water. Install an
                automatic bypass valve or designate one radiator (e.g., bathroom towel rail) without
                a TRV to provide minimum flow.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-elec-yellow mb-2">Call-for-Heat Logic</h4>
              <p className="text-white text-sm">
                The system must signal the boiler to fire when any zone requires heat. Quality smart
                systems aggregate zone calls to prevent excessive boiler cycling from single TRV
                demands.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm">
                In systems with stored hot water, ensure the smart controls respect hot water
                priority settings to prevent the cylinder running cold during high heating demand
                periods.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                Check calibration has completed. Ensure the valve pin is not stuck. Verify the TRV
                has good wireless signal to the hub.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-white mb-2">Boiler not responding to thermostat</h4>
              <p className="text-white text-sm mb-2">
                Check wiring connections at the receiver/heat link. Verify the thermostat is paired
                with the receiver. Test with manual override if available.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-white mb-2">Radiators staying cold despite demand</h4>
              <p className="text-white text-sm mb-2">
                Check if the call-for-heat signal is reaching the boiler. Verify the TRV is actually
                opening. Check system pressure and bleed radiators if needed.
              </p>
            </div>
          </div>
        </section>
