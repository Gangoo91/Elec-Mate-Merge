    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reading the rating plate. BS EN 61140 and BS EN 60335-1 Annex A prescribe the class
          symbols. The plate also carries IP rating, voltage, current, frequency, conformance marks.
          Every element informs the inspection.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Rated current OR rated power</strong> (sometimes both). E.g. "1500 W" or "6.5
              A". Drives the load-test acceptance and any fuse-rating cross-check at the plug.
            </li>
            <li>
              <strong>Rated frequency</strong> (e.g. "50 Hz" or "50/60 Hz"). Most UK equipment is 50
              Hz; some equipment imported or repaired with international parts may be 50/60 Hz.
            </li>
            <li>
            ...
            <li>
              <strong>IP rating where applicable</strong> (e.g. "IP44"). Ingress protection against
              solids and water.
            </li>
            <li>
          ...
          <p>
            ...
            Reading the plate fluently is one of the practical skills that distinguishes experienced
            inspectors.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Appliances shall be marked with the manufacturer\'s name, trade mark or identification
              mark; the model or type reference; the rated voltage or rated voltage range in volts;
              the symbol for nature of supply (~ for ac); the rated power input or rated current;
              the rated frequency in hertz; the class of protection against electric shock (where
              applicable); the IP rating (where applicable); and any other markings required by the
              relevant clauses.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              The rating plate is usually on the underside of the equipment, on the rear, or under a
              battery cover.
            </li>
            <li>
          ...
          <p>
            Inspectors should make rating-plate examination an explicit step in their formal visual
            workflow. Some plates are weathered, dirty, or partly obscured — clean gently if needed
            and use a torch / phone light. The double-square symbol is robust even on degraded
            plates.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            genuinely SELV, (b) apply the Class III methodology (formal visual + functional check on
            the SELV equipment), and (c) NOT apply 500 V dc IR or PE-continuity tests to the SELV
            side.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Three-conductor flex with green-and-yellow CPC, terminating to an internal earth point
              on the equipment.
            </li>
            <li>
          ...
          <p>
            ...
            explicitly marked it as such. The risk is the equipment that LOOKS Class I (3-pin plug,
            metal casing) but actually has Class II construction internally; this is where the
            rating plate becomes decisive.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            The IP rating drives the formal-visual environment check: is the equipment being used in
            conditions consistent with its IP rating? An IP20 fan heater used outside in a
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>CE mark</strong> — European Conformity. Required for products placed on the EU
              market and (until 2024 / staged transition) on the UK market for many product
              categories.
            </li>
            <li>
            ...
            <li>
              <strong>UKNI mark</strong> — for goods placed on the Northern Ireland market requiring
              UK conformity assessment by a UK Notified Body.
            </li>
            <li>
              <strong>Standards reference (e.g. "BS EN 60335-2-3")</strong> — the specific appliance
              standard the manufacturer declares conformity with. The appliance-specific second-tier
              standards (the "-2-" series under BS EN 60335) are often the operational reference for
              manufacturer test-house verification.
            </li>
          </ul>
          <p>
            For PAT, the conformance marks are evidence of the equipment\'s legitimate market entry.
            Their absence is a procurement defect (equipment may not be safe; equipment may be
            counterfeit; equipment may pre-date current standards). A well-marked plate with current
            conformance is a positive starting position; a missing plate or missing marks is a flag
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              (acceptance 0.1 Ω + flex contribution), IR test live to earth pin (≥ 1 MΩ), functional
              / load test.
            </li>
            <li>
              <strong>1800 W at 230 V ≈ 7.8 A.</strong> The equipment\'s plug should be fitted with
              a 13 A fuse (next standard size up from the 7.8 A operating current, per IET CoP §10 /
              BS 1362). Check the fuse rating at formal visual.
            </li>
            <li>
            ...
            <li>
              ...
              done for cooking-range-specific safety case. Reference the appliance standard for any
              acceptance values not in the IET CoP.
            </li>
          </ol>
          <p>
            Each plate element drives a specific inspection action. Reading the plate competently is
            reading the inspection plan.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Look for the Class II double-square symbol. If present and construction is consistent
              with Class II, classify as Class II.
            </li>
            <li>
            ...
            <li>
              Apply the matching IET CoP test sequence. Class I = PE-continuity + IR. Class II = IR
              (or substitute leakage). Class III = supply verification + functional check.
            </li>
            <li>
