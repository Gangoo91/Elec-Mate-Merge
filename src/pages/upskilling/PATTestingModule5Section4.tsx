    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          There is no &lsquo;annual PAT&rsquo; in law. Risk-based intervals from IET CoP Table 7.1,
          user checks vs formal tests, failure-rate-driven adjustment, and batched scheduling that
        ...
        >
          <p>
            ...
            Edition. It is a marketing simplification that has become a folk requirement. The actual
            framework:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>EAWR Reg 4(2):</strong> systems shall be maintained so as to prevent, so far
              as is reasonably practicable, danger. The duty is on the duty holder to determine what
              &ldquo;reasonably practicable&rdquo; looks like for their estate.
            </li>
            <li>
            ...
            <li>
              ...
              category (Class I / II / III equipment, leads, IT equipment, hand-held vs stationary)
              and environment (offices / shops, schools, public, industrial, construction).
            </li>
            <li>
          ...
          <p>
            ...
            intervals) and potentially inadequate (high-handling Class I equipment in a kitchen may
            need shorter intervals than annual).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              There is no requirement in law to inspect electrical equipment annually. How often you
              should inspect or test depends on the type of equipment and the environment in which
              it is used. The dutyholder should make sure that the frequency of inspection and
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              the equipment, before each use (or daily, depending on the regime). Visual inspection:
              plug condition, flex condition, casing damage, signs of overheating, obvious defects.
              Takes seconds. Catches gross damage between formal layers. Most frequent for
              higher-risk environments.
            </li>
            <li>
              <strong className="text-elec-yellow">Formal visual inspection</strong> — performed by
              a competent person at a documented interval. More thorough than a user check: opening
              accessible covers (where appropriate), checking strain relief, checking polarity at
              plug, checking continuity informally if a fault is suspected. No formal electrical
              test.
            </li>
            <li>
              <strong className="text-elec-yellow">Combined inspection and test</strong> — performed
              by a competent person, with a calibrated PAT instrument. Full electrical test
              sequence: earth continuity (Class I), insulation resistance, leakage, polarity, plus
              visual inspection. The numerical results sit in the test record. Least frequent of the
              three.
            </li>
          </ol>
          <p>
            The frequencies are not the same for every layer. A high-risk environment might run user
            checks daily, formal visual inspections every 3 months, and combined inspection and test
            every 6 months. A low-risk office might rely mainly on user awareness, with formal
            visual inspections annually and combined inspection and test every 24 months. The regime
            is a structure, not a single interval.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            Two things to take from the pattern: (a) IT in an office can defensibly run on extended
            intervals (24 months and longer) provided the failure-rate data supports it; (b)
            hand-held equipment on a construction site requires both a user check before each use
            AND combined inspection and test at 3-monthly intervals — far shorter than
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              Table 7.1, taking into account the type of equipment, the type of environment in which
              it is used, and the conditions of use. Frequencies should be reviewed in the light of
              experience, including the failure rate of equipment subject to test, and adjusted
              accordingly.
            </>
          }
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              tests, calculated per equipment class, per environment, per location. The granularity
              matters — a 5 % overall failure rate may be 1 % in offices and 12 % on site.
            </li>
            <li>
              <strong>Compare against benchmarks.</strong> IET CoP and industry data suggest that a
              category running &lt; 1&ndash;2 % failure rate is in the &ldquo;clean&rdquo; band,
            ...
            <li>
              ...
              consistently below the band over multiple cycles. Document the decision and the data.
            </li>
            <li>
              <strong>Review on schedule.</strong> Annual review of intervals against the cumulative
              failure data. Capture any environmental or operational change that might shift risk.
            </li>
          </ol>
          <p>
            Adjustments need to be evidence-backed and documented. An HSE inspector reviewing the
            regime should be able to see: this is the starting interval (Table 7.1 reference), this
            is the failure-rate data we collected, this is the adjusted interval, this is the date
            of the next review. Without the documentation, an extended interval looks like &ldquo;we
            test less because it&rsquo;s cheaper&rdquo; rather than &ldquo;we test less because the
            data supports it&rdquo;.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="400" y="44" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              START — Table 7.1
            </text>
            ...
            <text x="400" y="466" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              IET CoP 5th Ed. Section 7: starting interval + iterative review = compliance with EAWR
              Reg 4(2).
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Group by site / location / category.</strong> A single visit covers a site\'s
              portable equipment in a defined window. The contractor / in-house tester works through
              the asset register filtered to that group.
            </li>
            <li>
        ...
        >
          <p>
            The reasoning behind the &ldquo;test before next use&rdquo; framing is that construction
            sites generate damage faster than formal test intervals can catch. Damaged flexes,
            cracked plugs, casing breaches all develop in days. Annual or 6-monthly testing leaves a
            gap during which damaged equipment can be in use.
          </p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              A user check by the user of the equipment is the most frequent form of inspection and
              is a means of identifying damage which has occurred during use. The user should be
              encouraged to look for damage to the cable, plug, body of the equipment and any signs
              of overheating, before connecting the equipment to the supply.
            </>
          }
