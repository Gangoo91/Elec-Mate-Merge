...
const DESCRIPTION =
  'Learn about Class II equipment and double insulation principles, including how double-insulated equipment is constructed, identified, and tested.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Class II equipment relies on double or reinforced insulation as its primary safety mechanism, eliminating the need for protective earthing.',
  },
  {
    id: 'm2s3-check2',
    ...
    correctIndex: 1,
    explanation:
      "Class II appliances typically use two-core cables with only live (L) and neutral (N) conductors, as they don't require an earth connection.",
  },
  {
    id: 'm2s3-check3',
    ...
    correctIndex: 1,
    explanation:
      "Earth continuity tests are not required for Class II equipment as they have no accessible earthed parts and don't rely on protective earthing.",
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Basic insulation in Class II equipment protects against direct contact with live parts during normal operation.',
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      'Supplementary insulation provides independent protection against electric shock if the basic insulation fails, creating a double barrier.',
  },
  {
    id: 5,
    question: 'Which test is NOT typically required for Class II equipment?',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Class II equipment is identified by a square within a square symbol, indicating double insulation protection.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Reinforced insulation is a single insulation system that provides the same level of protection as double insulation through enhanced materials and construction.',
  },
  {
    id: 8,
    ...
    correctAnswer: 2,
    explanation:
      'The minimum insulation resistance for Class II equipment is typically 2 megohms when tested at 500V DC.',
  },
  {
    id: 9,
    question: 'Which of these is typically Class II equipment?',
    options: ['Electric kettle', 'Hair dryer', 'Desktop computer', 'Washing machine'],
    correctAnswer: 1,
    explanation:
      'Hair dryers are typically Class II equipment with plastic construction and double insulation, requiring no earth connection.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Visual inspection is critical for Class II equipment because safety depends entirely on insulation integrity - any damage to the insulation could compromise safety.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Class II equipment uses double or reinforced insulation instead of protective earthing. Two independent insulation barriers protect against shock, so even if one fails, the other maintains safety. This design philosophy eliminates the need for earth connections.',
  },
  {
    question: 'How do I identify Class II equipment?',
    answer:
      'Look for the square within a square symbol on the equipment label. Also check for a two-core cable (no earth conductor), plastic construction, and no accessible metalwork connected to internal components.',
  },
  {
    question: 'Can Class II equipment have metal parts?',
    answer:
      'Yes, but any metal parts must be completely isolated from live parts by double or reinforced insulation. The metal cannot be connected to earth and must not be capable of becoming live under any fault condition.',
  },
  {
    question: 'What happens if a Class II appliance fails insulation resistance testing?',
    answer:
      'The equipment should be removed from service immediately. Failed insulation indicates the double insulation barrier may be compromised. Investigate for damage, moisture ingress, or material degradation. The equipment usually needs repair or replacement.',
  },
  {
    question: 'Is Class II equipment safer than Class I?',
    answer:
      'Neither class is inherently safer - they use different approaches to achieve safety. Class I relies on earthing, Class II on insulation. Both are equally safe when properly maintained. Class II may be preferred in some environments where earth connections are unreliable.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Protection:</strong> Double or reinforced insulation
              </li>
              <li>
                <strong>Cable:</strong> Two-core (L, N only)
              </li>
              <li>
                <strong>Symbol:</strong> Square within a square
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> No earth pin, plastic case, double-square symbol
              </li>
              <li>
                <strong>Use:</strong> Insulation resistance test only (no earth test)
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Class II equipment offers an alternative approach to electrical safety through double
              or reinforced insulation rather than protective earthing. This design philosophy
              eliminates the need for earth connections whilst maintaining equivalent safety levels.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Double insulation consists of two independent insulation systems that work together to
              provide comprehensive protection against electric shock.
            </p>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Insulation Materials:</strong> Must resist electrical, thermal, and
                  mechanical stress throughout equipment life
                </li>
                <li>
                  <strong>Clearances and Creepage:</strong> Minimum distances through air and over
                  surfaces between live parts and accessible surfaces
                </li>
                <li>
                  <strong>Barrier Integrity:</strong> Physical barriers must prevent direct access
                  to live parts even with tool assistance
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>No Earthed Metal Parts:</strong> Accessible metalwork must not be
                  connected to earth or capable of becoming live
                </li>
                <li>
                  <strong>Metal Enclosures:</strong> If metal cases are used, they must be
                  completely enclosed by insulating material
                </li>
                <li>
                  <strong>Cable Entry:</strong> Two-core cables only, with proper strain relief and
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Class II equipment has specific testing requirements that differ from Class I
              equipment due to the absence of earthed parts and reliance on insulation for
              protection.
            </p>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-1">
                ...
                <li>
                  <strong>Minimum Resistance:</strong> 2 megohms (BS 7671:2018+A3:2024)
                </li>
                <li>
                  <strong>Test Duration:</strong> Typically 1 minute
                </li>
                <li>
                  <strong>Between:</strong> Live parts and accessible surfaces
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-elec-yellow text-sm font-medium mb-2">
                Case Study: Office Desk Lamp Insulation Failure
              </p>
              <div className="text-sm text-white space-y-2">
                <p>
                  <strong>Situation:</strong> During routine PAT testing, a Class II desk lamp shows
                  an insulation resistance of 0.8 megohms, below the required 2 megohms minimum. The
                  lamp appears undamaged and functions normally.
                </p>
                <p>
                  <strong>Investigation:</strong> Visual inspection reveals the plastic housing has
                  a small crack near the base where the cable enters, potentially compromising the
                  supplementary insulation barrier.
                </p>
                <p>
                  <strong>The Risk:</strong> With compromised double insulation, the lamp no longer
                  meets Class II safety requirements and could present a shock hazard if the basic
                  insulation also fails.
                </p>
                <p>
                  <strong>The Action:</strong> The lamp was immediately removed from service and
                  replaced. The failed unit was examined further, revealing moisture ingress through
                  the crack had affected insulation properties.
                </p>
                <p>
                  <strong>The Lesson:</strong> Class II equipment safety depends entirely on
                  insulation integrity. Small physical damage can compromise the double insulation
                  system, making thorough visual inspection and insulation testing crucial.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Testing Class II Equipment
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Performing earth continuity test</strong> - wastes time and may give
                  misleading results
                </li>
                <li>
                  <strong>Assuming all plastic equipment is Class II</strong> - always verify with
                  symbols
                </li>
                <li>
                  <strong>Ignoring small cracks in housings</strong> - can compromise insulation
                  integrity
                </li>
                <li>
                  <strong>Not checking cable condition</strong> - damaged cable insulation affects
                  safety
                </li>
              </ul>
            </div>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/electrician/upskilling/pat-testing-module-2-section-2">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous Section
            </Link>
          </Button>
