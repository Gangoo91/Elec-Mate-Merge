...
const inlineChecks = [
  {
    ...
    options: [
      'Basic insulation plus a separate, independent supplementary insulation layer.',
      'Two identical layers of the same insulating material applied one over the other.',
      'A conductive metal layer backed by a plastic layer for mechanical protection.',
      'A single insulation layer working together with a protective conductor (CPC).',
    ],
    correctIndex: 0,
    explanation:
      'BS EN 61140 §6.3 defines double insulation as basic + supplementary: two independent layers. Basic insulation is the working insulation around the live conductors; supplementary insulation sits between it and the accessible conductive parts. The independence is the key — a single mechanical or thermal failure cannot pierce both. "Reinforced insulation" is an alternative single-layer engineered design that provides equivalent protection.',
  },
  {
    id: 'patm2-s3-IRpoint',
    question: 'Where is the test probe applied for the Class II IR test?',
    options: [
      'On the earth pin of the plug, exactly as for the Class I IR test.',
      'On both the earth pin and the live pin of the plug simultaneously.',
      'On any accessible conductive part of the equipment — casing, metal trim or handle insert.',
      'On an internal terminal inside the equipment, reached by opening the casing.',
    ],
    correctIndex: 2,
    explanation:
      'The Class II IR test methodology is fundamentally different from Class I. The earth pin is not the test point because there is no protective conductor — Class II has no CPC by design. The accessible conductive parts the user can touch are the test point; the probe is held physically against the casing or handle while the test runs.',
  },
  {
    id: 'patm2-s3-acceptance',
    question: 'IET CoP §15.5 acceptance for Class II IR is...?',
    options: [
      '≥ 1 MΩ — the same minimum value as the Class I IR acceptance.',
      '≥ 0.5 MΩ — a relaxed value because the casing is non-conductive.',
      '≥ 10 MΩ — a very high value reflecting the absence of any earth path.',
      '≥ 2 MΩ — tighter than Class I, because the insulation is the sole protection.',
    ],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Test each accessible conductive part separately; all must meet ≥ 2 MΩ to pass.',
      'Test only the largest accessible conductive part and take it as representative.',
      'Test just the casing, since the casing is the main accessible surface.',
      'Test each part and average the readings, passing if the average meets ≥ 2 MΩ.',
    ],
    correctIndex: 0,
    explanation:
      'The test verifies insulation integrity at every point a user can touch. Each accessible conductive part is its own test point, moving the probe from part to part. A single low reading on any one part means insulation has failed at that location even if other parts pass — recording one reading from the casing while ignoring the handle would miss a localised breakdown.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      'Double or reinforced insulation, with no protective conductor — the insulation alone is the protection.',
      'Basic insulation plus a protective conductor (CPC) bonding the accessible metal parts to earth.',
      'A SELV supply at no more than 50 V ac, so the supply voltage itself is the protective measure.',
      'A single layer of basic insulation only, with no supplementary or reinforced layer.',
    ],
    correctAnswer: 0,
    explanation:
      'Class II uses double insulation (basic + supplementary, two independent layers) OR reinforced insulation (a single engineered layer giving equivalent protection) as the sole protective measure. There is no CPC and no automatic disconnection on earth fault, because there is no earth path in the equipment. Failure of one insulation layer is not catastrophic because the second remains intact — the insulation is the protection.',
  },
  {
    id: 2,
    question:
    ...
    options: [
      'It is purely historic convention, calibrated by committee with no technical reasoning behind it.',
      'Because the Class II test injects a higher test current to stress the insulation harder.',
      'Because the insulation is the sole protection — there is no CPC as a second line of defence.',
      'Because the Class II test is carried out at 1 kV dc rather than the 500 V dc used for Class I.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The plug is a UK shutter-operating convention; the class symbol governs, so test as Class II.',
      'The marking must be wrong — a 3-pin plug means the drill is really Class I and must be retested.',
      'It should be reclassified and tested as Class I, since the symbol is overridden by the plug.',
      'Apply both the Class I and Class II test sequences and record whichever one happens to pass.',
    ],
    correctAnswer: 0,
    explanation:
      'The 3-pin plug on a Class II appliance is a UK convention for operating BS 1363 socket-outlet shutters, not a class indicator. The third pin may terminate to internal earth for EMC filtering or be unconnected — neither makes it Class I. The class symbol on the rating plate takes precedence, so Class II testing applies. A detachable IEC lead is a separate item, tested as a Class I lead in its own right.',
  },
  {
    id: 5,
    question: 'Why is PE-continuity testing INAPPROPRIATE on genuinely Class II equipment?',
    options: [
      'The high test current makes PE-continuity dangerous to run on insulated equipment.',
      'The test takes too long to settle on a Class II appliance to be practical on site.',
      'There is no protective conductor to test — Class II has no CPC by design.',
      'The PE-continuity test draws too much current for a Class II appliance to withstand.',
    ],
    correctAnswer: 2,
    explanation:
      'PE-continuity tests the CPC, and Class II has no CPC by design — its protective measure is double or reinforced insulation. Applying the test gives a meaningless result (typically open-circuit or an artefact), and recording it as a "fail" is wrong because the equipment was never designed to provide a CPC. Modern PAT testers in Class II mode skip the PE-continuity step automatically.',
  },
  {
    id: 6,
    question:
    ...
    options: [
      'Skip the IR test entirely, since there is no accessible metal part to probe.',
      'Hold the probe in the air near the casing and record whatever reading appears.',
      'Apply both the Class I and Class II IR methods and average the two results together.',
      'Use a substitute method — leakage or touch-current at operating voltage — per IET CoP §15.',
    ],
    correctAnswer: 3,
    explanation:
      'For an entirely non-conductive accessible enclosure the standard live-to-accessible-part IR method is impractical. Options are the metal trim or conductive plug pins (appliance switched off), or a substitute leakage / touch-current method at operating voltage. Genuinely all-plastic Class II construction is rare on professional equipment but does occur, and IET CoP §15 provides these alternatives to verify protective insulation integrity.',
  },
  {
    id: 7,
    question:
    ...
    options: [
      'Working as designed — no CPC exists, so "open" is expected; switch to the Class II IR test.',
      'It is a genuine failure of the protective conductor and the drier should be failed and withdrawn.',
      'Switch to the full Class I test sequence and re-run the PE-continuity test from the earth pin.',
      'Reject the equipment, as an open earth path means it is unsafe to use and must be condemned.',
    ],
    correctAnswer: 0,
    explanation:
      'This is an inappropriate test method, not equipment failure. Class II has no CPC connecting the earth pin to internal or external metal parts, so an "open" PE-continuity reading is exactly what the architecture produces — the inspector should not be running that test. The correct test is the Class II IR: probe on the external accessible metal screen.',
  },
  {
    id: 8,
    question:
    ...
    options: [
      'Always, in place of the IR test, for every Class II appliance without any exception.',
      'For Class I equipment only; they have no application at all to Class II testing.',
      'As alternatives where the IR test is impractical — electronic components or non-conductive enclosures.',
      'Never; they are obsolete methods no longer recognised by the IET Code of Practice.',
    ],
    correctAnswer: 2,
    explanation:
      'Substitute leakage and touch-current tests are alternatives or supplements to the Class II IR test, used particularly when electronic components (surge devices, varistors, filters) bias an IR reading downward, the construction is largely non-conductive making probe placement difficult, or equipment-specific guidance directs them. Substitute leakage applies operating voltage and measures leakage current through the accessible parts; touch-current does similar with a body-impedance simulator. Both verify the same protective measure — insulation integrity.',
  },
  {
    id: 9,
    question: 'What does the BS EN 61140 double-square symbol look like, and where is it placed?',
    options: [
      'A single plain square, marked on the rating plate of the equipment.',
      'A circle nested inside a square, marked on the rating plate of the equipment.',
      'A triangle enclosing the class number, marked on the rating plate of the equipment.',
      'Two concentric squares (a smaller square nested in a larger one), on the rating plate.',
    ],
    correctAnswer: 3,
    explanation:
      "The double-square (square within a square) is mandated by BS EN 61140 / BS EN 60335 for Class II equipment and placed on the rating plate or equipment in a clearly visible position. It is one of the most distinctive safety symbols in electrical equipment and is the inspector's primary visual cue: recognising it triggers the Class II test sequence; missing it triggers Class I testing on Class II equipment, a methodology error.",
  },
  {
    id: 10,
    question: 'What is the MOST critical failure mode of Class II equipment that PAT must catch?',
    options: [
      'Insulation breakdown — moisture absorption, mechanical damage, thermal stress or contamination.',
      'Failure of the internal power supply or transformer, stopping the appliance working.',
      'Failure of the on/off switch, so the appliance cannot be controlled by the user.',
      'Cosmetic damage to the casing that affects appearance but not the protective measure.',
    ],
    correctAnswer: 0,
    explanation:
      'Insulation integrity is the load-bearing element of Class II protection: moisture absorption, mechanical damage to the supplementary layer, thermal stress reducing dielectric strength, and surface contamination all degrade it. Because Class II has no CPC backup, an insulation failure leaves the equipment with no protective measure. The IR test is the primary detection mechanism — substitute leakage / touch current where IR is impractical — just as PE-continuity is the load-bearing test for Class I.',
  },
];
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/electrician/upskilling/pat-testing-module-2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS EN 61140 Class II: two independent layers of insulation, no protective conductor, no
          CPC. The insulation alone is the protection — and it is verified by an IR test with a
          tighter acceptance than Class I, because there is no second line of defence.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              independently capable of providing the protective function. Failure of one layer (e.g.
              mechanical pinhole in the supplementary layer) does not defeat the other.
            </li>
            <li>
              <strong>Reinforced insulation</strong> — a single insulation layer engineered to give
              protection equivalent to double insulation. Achieved through thicker material, higher
              dielectric strength, or specific construction (e.g. multi-layer bonded films). Used
              where two physical layers are impractical (small electronics, thin profile equipment).
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Equipment can be Class II AND have an internal "functional earth" for filtering / EMC
              purposes. This conductor is NOT a protective conductor in the BS EN 61140 sense; it
              does not bond accessible parts to earth for fault protection. It exists for noise /
              interference reasons only.
            </li>
          </ul>
          <p>
            The test methodology must respect the architecture. Class II equipment is tested for
            insulation integrity (the IR test); it is NOT tested for CPC integrity (no CPC exists).
            Applying Class I tests to Class II equipment is a methodology error.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              <text x="100" y="200" textAnchor="end" fill="#FBBF24" fontSize="11" fontWeight="bold">
                IR test probe
              </text>
            ...
            <rect
              ...
              strokeWidth="2"
            />
            <text x="430" y="86" textAnchor="middle" fill="#A855F7" fontSize="13" fontWeight="bold">
              CLASS II APPLIANCE
            </text>
            ...
            <text x="430" y="273" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              1 · Live conductors
            </text>
            ...
            <g>
              ...
              <text x="750" y="284" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                (rating plate)
              </text>
            </g>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Visual prerequisite.</strong> Confirm the equipment is Class II (double-square
              marking, construction matches Class II principles, no protective conductor provided).
            </li>
            <li>
            ...
            <li>
              ...
              conductive part — typically the metal trim, a metal handle insert, the metal screen of
              an enclosure, or any conductive part the user can touch.
            </li>
            <li>
          ...
          <p>
            The IR test is fast and decisive. A strong pass (tens of MΩ) confirms intact insulation.
            A reading near or below acceptance indicates insulation degradation — moisture
            absorption, mechanical damage, contamination, age. The defect is invisible to user check
            and to formal visual; only the IR test catches it.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              between the live conductors (line and neutral commoned) and any accessible conductive
              part of the equipment, with the test probe applied to the accessible conductive part.
              The minimum acceptable value is 2 MΩ.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              measures the leakage current that would flow under operating conditions. The result is
              reported in mA. Acceptance per IET CoP §15.6 — typically &le; 0.25 mA for general
            ...
            <li>
              ...
              measures the current flowing through that path during operation. Useful for detecting
              insulation degradation that produces increased leakage but is not severe enough to
              fail the IR test.
            </li>
          </ul>
          <p>
            Modern multifunction PAT testers offer all three alternatives in addition to IR. The
            instrument manual will direct which to use for which equipment category. The underlying
            principle remains: verify the protective insulation is providing adequate protection.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              cleaning, or condensation. The absorbed moisture creates conductive paths through what
              should be insulator. IR reading drops; substitute leakage rises. Drying the equipment
              in a controlled environment can sometimes restore IR; severe or repeated absorption is
              a permanent defect.
            </li>
            <li>
              <strong>Mechanical damage.</strong> Drops, impacts, vibration, repeated handling. Most
              concerning when it punctures the supplementary layer; the basic layer alone is then
              the only protection — the equipment has effectively reverted to Class 0 response on
              insulation failure. The visual inspection looks for signs of impact; the IR test
              catches the electrical consequence.
            </li>
            <li>
            ...
            <li>
              <strong>Chemical contamination.</strong> Solvents, cleaning products, oils, dust with
              conductive content. Surface conductivity rises; IR reading drops. Cleaning the
              contamination can sometimes restore insulation; some chemicals leave permanent damage.
            </li>
            <li>
              <strong>Age.</strong> Cumulative effect of all of the above plus material ageing. Old
              Class II equipment trends downward in IR readings even without obvious stressors. The
              IR trend over multiple test cycles is the diagnostic.
            </li>
          </ul>
          <p>
            The four pillars of HSG107 are calibrated to catch these in different ways. User checks
            catch obvious mechanical damage. Formal visual catches less-obvious damage and signs of
            contamination / overheating. Combined inspection-and-test (IR or substitute leakage)
            catches the invisible: moisture, thermal degradation, age.
          </p>
        </ConceptBlock>
