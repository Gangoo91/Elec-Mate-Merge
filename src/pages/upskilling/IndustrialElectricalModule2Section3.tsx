...
const IndustrialElectricalModule2Section3: React.FC = () => {
  ...
  useSEO({
    ...
    description:
      'Learn about thermal overload relay principles, HRC fuses for motor circuits, BS 88 ratings, Class 10/20/30 trip curves, and type 1 vs type 2 coordination for industrial electrical protection.',
    keywords: [
  ...
  const quickCheckQuestions = [
    ...
    },
    {
      id: 'qc2-hrc-fuses',
      question:
        'Which type of HRC fuse is specifically designed for motor circuit protection and can withstand high starting currents?',
      options: [
        'gG (general purpose)',
        'aM (motor rated)',
        'aR (semiconductor)',
      ...
      correctIndex: 1,
      explanation:
        'aM (accompagnement Moteur) fuses are specifically designed for motor circuits. They can withstand the high inrush currents during motor starting (typically 6-8 times FLC) without blowing, while still providing short-circuit protection.',
    },
    {
      id: 'qc3-coordination',
      question:
  ...
  return (
    <div className="bg-background text-foreground">
      ...
      <section className="max-w-4xl mx-auto px-4 pt-8 pb-6 text-center">
        ...
        <h1 className="text-2xl md:text-3xl font-bold mb-2">Thermal Overloads and Fuses</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 pb-12 space-y-10">
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Thermal overload relays protect motors from damage due to sustained overcurrent
              conditions. Unlike fuses which protect against short-circuits, thermal overloads
              respond to the <strong className="text-foreground">heating effect</strong> of current
              over time, mimicking the motor's own thermal characteristics.
            </p>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <p className="text-sm mb-3">
                ...
                <strong className="text-foreground">bimetallic strips</strong> - two different
                metals (typically brass and invar) bonded together. When heated by motor current:
              </p>
              <ul className="space-y-1 text-sm">
                <li>
                  &bull; Metals expand at different rates due to different thermal expansion
                  coefficients
                </li>
                <li>&bull; The strip bends/deflects proportionally to temperature rise</li>
                <li>
                  &bull; At a predetermined deflection, the mechanism trips open auxiliary contacts
                </li>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <ul className="space-y-1 text-sm">
                <li>
                  &bull; <strong className="text-foreground">Separate mounting:</strong> Standalone
                  units connected via wiring to contactor
                </li>
                <li>
                  &bull; <strong className="text-foreground">Direct mounting:</strong> Clips
                  directly onto contactor base - most common industrial type
                </li>
                <li>
                  &bull; <strong className="text-foreground">Integral:</strong> Built into motor
                  starter/soft starter units
                </li>
              </ul>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Correct overload setting is critical for effective motor protection without nuisance
              tripping. The setting must balance protection against overload damage with allowance
              for normal operating variations.
            </p>
            ...
            <div className="bg-green-500/10 border-l-2 border-green-500/50 rounded-r-lg p-4">
              ...
              <div className="mt-3 grid md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p>
                    Found on motor nameplate - the current drawn when delivering rated output at
                    rated voltage
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    Typically 1.0 to 1.15 - allows for temporary overloads during normal operation
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <div className="space-y-2 text-sm font-mono bg-white/5 p-4 rounded">
                ...
                <p className="mt-2 text-muted-foreground">
                  Set the overload dial to 18.2A (nearest available setting)
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
                ...
                <ul className="space-y-1 text-sm">
                  <li>
                    &bull; <strong className="text-elec-yellow">SF = 1.0:</strong> Continuous duty,
                    no overload expected
                  </li>
                  <li>
                    &bull; <strong className="text-elec-yellow">SF = 1.05:</strong> Light
                    intermittent overloads
                  </li>
                  <li>
                    &bull; <strong className="text-elec-yellow">SF = 1.10:</strong> Moderate duty
                    cycles
                  </li>
                  <li>
                    &bull; <strong className="text-elec-yellow">SF = 1.15:</strong> Heavy duty,
                    frequent starting
                  </li>
                </ul>
              </div>
              <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
                ...
                <ul className="space-y-1 text-sm">
                  <li>
                    &bull; <strong className="text-elec-yellow">Ampere scale:</strong> Set directly
                    in amps
                  </li>
                  <li>
                    &bull; <strong className="text-elec-yellow">Percentage scale:</strong> % of
                    heater rating
                  </li>
                  <li>
                    &bull; <strong className="text-elec-yellow">Numbered positions:</strong> Refer
                    to data table
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-orange-500/10 border-l-2 border-orange-500/50 rounded-r-lg p-4">
              ...
              <p className="text-sm">
                Standard thermal overloads are calibrated at 40 degrees C ambient. For every 10
                degrees C above 40 degrees C, reduce the setting by approximately 5%.
                Temperature-compensated overloads automatically adjust and are recommended for
                installations subject to wide temperature variations.
              </p>
            </div>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <div className="grid md:grid-cols-2 gap-3 text-sm">
                <div>
                  ...
                  <p>
                    Requires physical button press - safer, ensures fault investigation before
                    restart
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    Resets after cooling period - only for non-critical applications with
                    supervision
                  </p>
                </div>
              </div>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              High Rupturing Capacity (HRC) fuses provide short-circuit protection in motor
              circuits. The correct fuse type selection is essential - motors have unique
              characteristics (high starting currents) that require specific fuse types to avoid
              nuisance blowing while maintaining protection.
            </p>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <p className="text-sm mb-3">
                BS 88 (British Standard for cartridge fuses) defines fuse characteristics. Key
                designations:
              </p>
              <ul className="space-y-1 text-sm">
                <li>
                  &bull; <strong className="text-foreground">BS 88-2:</strong> Fuses for industrial
                  applications (up to 1250A)
                </li>
                <li>
                  &bull; <strong className="text-foreground">BS 88-3:</strong> Fuses for domestic
                  applications
                </li>
                <li>
                  &bull; <strong className="text-foreground">BS 88-4:</strong> Fuses for
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-red-500/10 border-l-2 border-red-500/50 rounded-r-lg p-4">
                ...
                <ul className="space-y-1 text-sm">
                  <li>
                    &bull; <strong className="text-foreground">Full range:</strong> Protects against
                    both overloads and short-circuits
                  </li>
                  <li>
                    &bull; <strong className="text-foreground">Characteristic:</strong> Will blow at
                    lower multiples of rating
                  </li>
                  <li>
                    &bull; <strong className="text-foreground">Application:</strong> Cable
                    protection, distribution boards
                  </li>
                  <li>
                    &bull; <strong className="text-red-400">NOT suitable for motor circuits</strong>{' '}
                    - will blow on starting current
                  </li>
                </ul>
              </div>
              <div className="bg-green-500/10 border-l-2 border-green-500/50 rounded-r-lg p-4">
                ...
                <ul className="space-y-1 text-sm">
                  <li>
                    &bull; <strong className="text-foreground">Back-up:</strong> Short-circuit
                    protection only
                  </li>
                  <li>
                    &bull; <strong className="text-foreground">Characteristic:</strong> Withstands
                    high inrush currents (6-10x rating)
                  </li>
                  <li>
                    &bull; <strong className="text-foreground">Application:</strong> Motor circuits
                    with separate overload protection
                  </li>
                  <li>
                    &bull;{' '}
                    <strong className="text-green-400">DESIGNED for motor starting currents</strong>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              <h4 className="font-medium text-foreground mb-3">
                Fuse Selection for Motor Circuits
              </h4>
              <div className="space-y-2 text-sm">
                <p>
                  <strong className="text-elec-yellow">Rule of thumb for aM fuses:</strong>
                </p>
                ...
                <p className="mt-3 text-muted-foreground">
                  Always verify selection against manufacturer coordination tables for Type 2
                  coordination.
                </p>
              </div>
            </div>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <p className="mt-3 text-sm text-muted-foreground">
                Ratings follow the R10 preferred number series. Breaking capacity typically 80kA at
                415V AC.
              </p>
            </div>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Coordination ensures that the correct protective device operates for each fault type,
              while minimizing damage to starter components. IEC 60947-4-1 defines two coordination
              types.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-orange-500/10 border-l-2 border-orange-500/50 rounded-r-lg p-4">
                ...
                <ul className="space-y-1 text-sm">
                  <li>
                    &bull; <strong className="text-foreground">Requirement:</strong> No danger to
                    persons
                  </li>
                  <li>
                    &bull; <strong className="text-foreground">Permitted damage:</strong> Contactor
                    and overload may be damaged beyond repair
                  </li>
                  <li>
                    &bull; <strong className="text-foreground">After fault:</strong> Complete
                    starter replacement may be needed
                  </li>
                  <li>
                    &bull; <strong className="text-foreground">Cost:</strong> Lower initial fuse
                    cost
                  </li>
                  <li>
                    &bull; <strong className="text-foreground">Application:</strong> Non-critical,
              ...
              <div className="bg-green-500/10 border-l-2 border-green-500/50 rounded-r-lg p-4">
                ...
                <ul className="space-y-1 text-sm">
                  <li>
                    &bull; <strong className="text-foreground">Requirement:</strong> No danger +
                    starter remains operational
                  </li>
                  <li>
                    &bull; <strong className="text-foreground">Permitted damage:</strong> Contact
                    welding only (must be separable)
                  </li>
                  <li>
                    &bull; <strong className="text-foreground">After fault:</strong> Replace fuse
                    only, check contacts
                  </li>
                  <li>
                    &bull; <strong className="text-foreground">Cost:</strong> Higher initial cost,
                    lower lifecycle cost
                  </li>
                  <li>
                    &bull; <strong className="text-foreground">Application:</strong> Critical
                    processes, high availability systems
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-foreground">
                      Transition Region (~600% - 1000% FLC)
                    </p>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    Fuse I squared t let-through must be less than contactor/overload withstand
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              <h4 className="font-medium text-foreground mb-2 flex items-center gap-2">
                <Zap className="w-4 h-4 text-elec-yellow" />I squared t Let-Through Energy
              </h4>
              <p className="text-sm">
                I squared t (Joule integral) represents the thermal energy let through by the fuse
                during fault clearance. For Type 2 coordination, the fuse I squared t must be less
                than the contactor's thermal withstand capability. Manufacturer tables provide
                maximum fuse ratings for each contactor frame size based on I squared t matching.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Electronic overload relays use current transformers and microprocessor technology to
              provide more accurate, adjustable, and feature-rich motor protection compared to
              thermal types.
            </p>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p>
                    Trips if any phase current drops below 60% of average - prevents single-phasing
                    damage
                  </p>
                </div>
                <div>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <p>
                  <strong className="text-elec-yellow">1. Current Sensing:</strong> CTs on each
                  phase measure motor current
                </p>
                <p>
                  <strong className="text-elec-yellow">2. Signal Processing:</strong> Microprocessor
                  calculates RMS values
                </p>
                <p>
                  <strong className="text-elec-yellow">3. Thermal Algorithm:</strong> I squared t
                  calculation models motor heating
                </p>
                <p>
                  <strong className="text-elec-yellow">4. Trip Decision:</strong> Compares
                  calculated thermal state to limits
                </p>
                <p>
                  <strong className="text-elec-yellow">5. Output:</strong> Relay contacts open when
                  limits exceeded
                </p>
              </div>
            </div>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Regular testing ensures protective devices operate correctly when needed. Both thermal
              and electronic overloads require periodic verification, while fuses need proper
            ...
            <div className="bg-red-500/10 border-l-2 border-red-500/50 rounded-r-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Never replace a fuse with a higher rating - defeats protection coordination
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="w-4 h-4 text-red-400 mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start gap-2">
                  <AlertTriangle className="w-4 h-4 text-red-400 mt-0.5 flex-shrink-0" />
                  <span>
                    Always investigate cause before resetting/replacing protective devices
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="w-4 h-4 text-red-400 mt-0.5 flex-shrink-0" />
                  <span>
                    Allow thermal overloads to cool before resetting (typically 2-3 minutes)
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <p className="text-sm">
                Record all test results including: date, equipment ID, set current value, test
                current applied, measured trip time, pass/fail status, and technician name. This
                data enables trend analysis to identify deteriorating protection devices before
                failure.
              </p>
            </div>
          </div>
        ...
        <section className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 text-sm">
            <div>
              <h3 className="font-medium text-foreground mb-2 border-b border-white/10 pb-1">
                Key Formulas
              </h3>
              <div className="space-y-1 font-mono text-muted-foreground">
                <p>
                  &bull; <strong className="text-elec-yellow">Overload Setting:</strong> FLC x
                  Service Factor
                </p>
                <p>
                  &bull; <strong className="text-elec-yellow">aM Fuse (DOL):</strong> FLC x 1.5 to
                  2.0
                </p>
                <p>
                  &bull; <strong className="text-elec-yellow">aM Fuse (S-D):</strong> FLC x 1.0 to
                  1.5
                </p>
              </div>
            </div>
            ...
            <div>
              <h3 className="font-medium text-foreground mb-2 border-b border-white/10 pb-1">
                Trip Class Times @ 7.2x
              </h3>
              <div className="space-y-1 text-muted-foreground">
                <p>
                  &bull; <strong className="text-elec-yellow">Class 10A:</strong> 2-10 seconds
                </p>
                <p>
                  &bull; <strong className="text-elec-yellow">Class 10:</strong> 4-10 seconds
                </p>
                <p>
                  &bull; <strong className="text-elec-yellow">Class 20:</strong> 6-20 seconds
                </p>
                <p>
                  &bull; <strong className="text-elec-yellow">Class 30:</strong> 9-30 seconds
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-1 text-muted-foreground">
                <p>
                  &bull; <strong className="text-elec-yellow">gG:</strong> General purpose (overload
                  + short-circuit)
                </p>
                <p>
                  &bull; <strong className="text-elec-yellow">aM:</strong> Motor (short-circuit
                  only, high inrush)
                </p>
                <p>
                  &bull; <strong className="text-elec-yellow">aR:</strong> Semiconductor protection
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-1 text-muted-foreground">
                <p>
                  &bull; <strong className="text-elec-yellow">Type 1:</strong> Damage permitted,
                  replacement needed
                </p>
                <p>
                  &bull; <strong className="text-elec-yellow">Type 2:</strong> Welding only, starter
                  stays operational
                </p>
              </div>
            </div>
          ...
          <div className="mt-4 pt-4 border-t border-white/10">
            ...
            <p className="text-sm text-muted-foreground">
              2, 4, 6, 10, 16, 20, 25, 32, 40, 50, 63, 80, 100, 125, 160, 200, 250, 315, 400, 500,
              630A
            </p>
          </div>
        </section>
