      ...
      <main className="max-w-4xl mx-auto px-4 py-6 space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Master safe testing methods, signal loop verification, and cable fault location
            techniques
          </p>
        </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground leading-relaxed">
              Continuity testing verifies that electrical conductors form a complete, unbroken path
              with acceptably low resistance. This fundamental test is essential for verifying
              protective conductors, bonding connections, and circuit integrity before energisation.
            </p>
            ...
            <div className="bg-background/50 rounded-lg p-4 border border-white/10">
              ...
              <ul className="text-white space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Protective Conductors:</strong> Verify continuous path from distribution
                    board to each point
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <Zap className="w-4 h-4 text-elec-yellow mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Main Bonding:</strong> Test from MET to all extraneous conductive parts
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <Zap className="w-4 h-4 text-elec-yellow mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Supplementary Bonding:</strong> Verify connections between
                ...
                <li className="flex items-start gap-2">
                  <Zap className="w-4 h-4 text-elec-yellow mt-0.5 flex-shrink-0" />
                  <span>
                    <strong>Ring Final Circuits:</strong> Confirm correct ring connection and
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-background/50 rounded-lg p-4 border border-white/10">
                ...
                <p className="text-white text-sm mb-2">
                  Standard method using test leads directly connected to conductor ends. Simple but
                  includes lead resistance in measurement.
                </p>
              ...
              <div className="bg-background/50 rounded-lg p-4 border border-white/10">
                ...
                <p className="text-white text-sm mb-2">
                  Uses separate current and voltage paths to eliminate lead resistance. Essential
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white text-sm">
                    BS 7671 requires continuity testers to produce a test current of at least 200mA
                    with an open-circuit voltage between 4V and 24V DC. This ensures sufficient
                    current to detect high-resistance joints that might otherwise appear
                    satisfactory with lower test currents. Always verify test equipment calibration
                    before use.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-background/50 rounded-lg p-4 border border-white/10">
              ...
              <p className="text-white text-xs mt-2">
                Note: Apply temperature correction factor of 1.2 for conductors at typical operating
                temperature (70°C)
              </p>
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground leading-relaxed">
              Control circuits in industrial installations require careful loop resistance
              verification to ensure reliable operation. Unlike power circuits where voltage drop is
              the primary concern, control circuits must maintain sufficient voltage to operate
            ...
            <div className="bg-background/50 rounded-lg p-4 border border-white/10">
              ...
              <div className="space-y-3 text-white text-sm">
                <p>
                  <strong>Contactor Coils:</strong> Most AC contactors require 85-110% of rated
                  voltage to pull in reliably and hold in at 80-110%. Excessive loop resistance
                  causing voltage drop below these thresholds results in chattering, failure to pick
                  up, or intermittent dropout.
                </p>
                <p>
                  <strong>PLC Inputs:</strong> Digital inputs typically require minimum voltage
                  (often 18V for 24V systems) to register as HIGH. Loop resistance causing voltage
                  drop can create unreliable input sensing.
                </p>
                <p>
                  <strong>Relay Coils:</strong> Control relays have similar requirements to
                  contactors. DC relays are particularly sensitive to voltage drop as there is no AC
                  impedance to limit current.
                </p>
              </div>
            </div>
              ...
              <div className="bg-background/50 rounded-lg p-4 border border-white/10">
                ...
                <div className="bg-background/80 p-3 rounded border border-white/5">
                  <p className="text-sm text-white">
                    <strong>Example:</strong> 24V DC circuit, device requires minimum 20V, coil
                    draws 100mA
                  </p>
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white text-sm">
                    A high resistance joint may measure acceptable when cold but fail under load due
                    to heating effects. When testing suspect circuits, apply rated current for
                    several minutes while monitoring resistance. An increasing resistance indicates
                    a poor joint that will cause problems in service. Thermal imaging during loaded
                    operation can pinpoint such defects.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground leading-relaxed">
              While de-energised testing is always preferred, fault diagnosis often requires testing
              circuits under operating conditions. Voltage tracing identifies where voltage is
              present, lost, or dropped unexpectedly, helping locate faults that may not be apparent
            ...
            <div className="bg-background/50 rounded-lg p-4 border border-white/10">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-elec-yellow pl-4">
                  ...
                  <p className="text-white text-sm">
                    Apply live-dead-live principle: Test on known live source, test the circuit
                    under investigation, test known live source again. This confirms your meter is
                    working before and after testing.
                  </p>
                </div>
                <div className="border-l-4 border-elec-yellow pl-4">
                  <h5 className="font-semibold text-foreground mb-2">
                  ...
                  <p className="text-white text-sm">
                    Establish a reliable reference point (neutral or earth). Verify reference is
                    valid by measuring known supply voltage. Use this same reference throughout
                    testing.
                  </p>
                </div>
                <div className="border-l-4 border-elec-yellow pl-4">
                  ...
                  <p className="text-white text-sm">
                    Trace from supply towards load, checking voltage at each connection point,
                    switch contact, and device terminal. Record readings and note where voltage is
                    lost or reduced.
                  </p>
                </div>
                <div className="border-l-4 border-elec-yellow pl-4">
                  ...
                  <p className="text-white text-sm">
                    Full voltage on one side of component, zero on other = component operated or
                    open. Reduced voltage = excessive resistance (poor connection). Voltage present
                    but device not operating = faulty device or insufficient current path.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-background/50 rounded-lg p-4 border border-white/10">
                ...
                <p className="text-white text-sm mb-2">
                  Measuring across connection points while current flows identifies high-resistance
                  joints:
                </p>
                <ul className="text-sm text-white space-y-1">
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-muted-foreground leading-relaxed">
                The 4-20mA current loop is the dominant analogue signal standard in industrial
                instrumentation. Unlike voltage signals, current signals are immune to voltage drop
                and electrical noise over long cable runs, making them ideal for process control
                applications.
              </p>
            </div>
            ...
            <div className="bg-background/50 rounded-lg p-4 border border-white/10">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    Live zero allows differentiation between 0% signal (4mA) and fault condition
                    (0mA). If cable breaks or transmitter fails, current drops to 0mA, immediately
                    indicating a fault rather than appearing as a valid zero reading.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4 text-sm">
                <div>
                  ...
                  <ul className="text-white space-y-1">
                    <li>
                      <strong>Source Mode:</strong> Generates precise 4-20mA signal to test
                      receivers (PLC inputs, displays, controllers)
                    </li>
                    <li>
                      <strong>Simulate Mode:</strong> Powers and controls 2-wire transmitter
                      simulation
                    </li>
                    <li>
                      <strong>Measure Mode:</strong> Reads mA signal from operating transmitter
                    </li>
                    <li>
                      <strong>Read Mode:</strong> Passive measurement without affecting loop
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <p className="text-white">
                    Non-invasive measurement around a single conductor. Ideal for testing live loops
                    without breaking the circuit. Accuracy typically ±1% of reading. Essential tool
                    for troubleshooting running processes.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-background/50 rounded-lg p-4 border border-white/10">
              ...
              <ol className="text-white space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Verify loop power:</strong> Check 24V DC supply present at transmitter.
                    Low supply voltage affects accuracy.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="font-bold text-elec-yellow">2.</span>
                  <span>
                    <strong>Check loop resistance:</strong> Total loop resistance (including
                    receiver) must be within transmitter capability. Typically 250-600 ohms maximum.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="font-bold text-elec-yellow">3.</span>
                  <span>
                    <strong>Zero calibration:</strong> Apply 0% input to transmitter, verify 4.00mA
                    output (±0.08mA tolerance).
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="font-bold text-elec-yellow">4.</span>
                  <span>
                    <strong>Span calibration:</strong> Apply 100% input, verify 20.00mA output
                    (±0.08mA tolerance).
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Linearity check:</strong> Test at 25%, 50%, 75% points. Maximum
                    deviation typically ±0.25% of span.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="font-bold text-elec-yellow">6.</span>
                  <span>
                    <strong>Verify receiver:</strong> Confirm DCS/PLC displays correct engineering
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white text-sm">
                    HART (Highway Addressable Remote Transducer) superimposes digital communication
                    on the 4-20mA signal using FSK modulation at 1200 and 2200 Hz. When testing HART
                    loops: use DC measurement only, avoid loading that could attenuate digital
                    signals, minimum 250 ohm loop resistance required for HART communication. HART
                    communicators can diagnose transmitter configuration and calibration without
                    physical access.
                  </p>
                </div>
              </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-muted-foreground leading-relaxed">
                When continuity or insulation testing indicates a cable fault, locating the exact
                position saves significant time and disruption compared to complete cable
                replacement. Several techniques exist, each suited to different fault types and
                cable installations.
              </p>
            </div>
            ...
            <div className="bg-background/50 rounded-lg p-4 border border-white/10">
              ...
              <p className="text-white text-sm mb-4">
                TDR sends a fast electrical pulse down the cable and analyses reflections caused by
                impedance changes. Any discontinuity (open, short, splice, or damage) reflects part
                of the pulse back to the instrument.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li>
                      <strong>Upward reflection:</strong> Impedance increase (open circuit,
                      unterminated end)
                    </li>
                    <li>
                      <strong>Downward reflection:</strong> Impedance decrease (short circuit, water
                      ingress)
                    </li>
                    <li>
                      <strong>No reflection:</strong> Matched impedance (properly terminated)
                    </li>
                    <li>
                      <strong>Partial reflection:</strong> Partial fault or splice
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <p className="text-sm text-white">
                    Signals travel slower in cable than in free space. VF expresses cable velocity
                    as ratio of light speed. Typical values: PVC cable 0.66, XLPE cable 0.87,
                    mineral insulated 0.95. Incorrect VF causes distance error - always verify with
                    known cable length.
                  </p>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-background/50 rounded-lg p-4 border border-white/10">
                ...
                <p className="text-white text-sm mb-2">
                  Bridge method using one healthy conductor and the faulty conductor looped at the
                  far end.
                </p>
                ...
                <p className="text-xs text-white mt-2">
                  Advantages: Simple equipment, accurate for LV faults, works with basic bridge
                  meter.
                </p>
              </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-white/10">
                      ...
                      <th className="text-left py-2 px-3 text-elec-yellow">
                        Best Location Technique
                      </th>
                    </tr>
                  </thead>
                  <tbody className="text-white">
            ...
            <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white text-sm">
                    High-voltage cable thumpers (surge generators) used to convert high-resistance
                    faults to low-resistance for easier location can generate dangerous voltages (up
                    to 25kV). Only authorised personnel with specific training should operate this
                    equipment. Ensure all cable ends are isolated and secured, area is cordoned off,
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Proper documentation of test results is not just good practice - it is a legal
                requirement under BS 7671 and essential for system maintenance, fault investigation,
                and demonstrating compliance. Records provide baseline values for comparison during
                future testing.
              </p>
            </div>
            ...
            <div className="bg-background/50 rounded-lg p-4 border border-white/10">
              ...
              <p className="text-white text-sm mb-3">
                The Schedule of Test Results (model forms in Appendix 6 of BS 7671) must record for
                each circuit:
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white text-sm">
                    Recording consistent test data over time enables trend analysis. Gradually
                    increasing resistance values, declining insulation resistance, or widening
                    calibration errors indicate developing problems before they cause failures.
                    Modern CMMS (Computerised Maintenance Management Systems) can automatically flag
                    concerning trends and schedule preventive maintenance.
                  </p>
                </div>
              </div>
            </div>
