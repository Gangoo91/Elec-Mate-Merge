...
const DESCRIPTION =
  'Understanding different RCD types (AC, A, F, B), ratings, and their appropriate applications for electrical inspection and testing.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Type A detects both sinusoidal AC and pulsating DC faults, suitable for electronic equipment.',
  },
  {
    id: 'rcd-30ma',
    ...
    correctIndex: 2,
    explanation:
      '30mA RCDs provide additional protection against electric shock - the 30mA level is below ventricular fibrillation threshold.',
  },
  {
    id: 'rcd-limitation',
    question: 'RCDs do NOT protect against:',
    options: ['Earth faults', 'Line-neutral shocks', 'Leakage to earth', 'Faults via the CPC'],
    correctIndex: 1,
    explanation:
      "RCDs don't protect against L-N shocks (in series with load) as no current leaks to earth.",
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'RCDs detect the difference between current in line and neutral. During an earth fault, some current returns via earth, creating detectable imbalance.',
  },
  {
    id: 2,
    question: 'A 30mA RCD is designed to provide:',
    ...
    correctAnswer: 2,
    explanation:
      '30mA RCDs provide additional protection against electric shock. The 30mA level is below the threshold for ventricular fibrillation.',
  },
  {
    id: 3,
    question: 'Type A RCDs detect:',
    ...
    correctAnswer: 1,
    explanation:
      'Type A detects both sinusoidal AC and pulsating DC faults, making it suitable for equipment with electronic power supplies.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      "Type AC only detects sinusoidal AC faults. It's suitable for simple loads but not for electronic equipment that may produce DC faults.",
  },
  {
    id: 5,
    question: 'An RCBO combines:',
    options: ['RCD and fuse', 'RCD and MCB functions', 'Two RCDs', 'RCD and surge protection'],
    correctAnswer: 1,
    explanation:
      'RCBO = Residual Current Breaker with Overcurrent protection. It combines RCD (earth fault) and MCB (overcurrent) in one device.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      "Higher rated RCDs (100mA, 300mA) provide fire protection by detecting earth leakage before it becomes dangerous, but don't provide personal shock protection.",
  },
  {
    id: 7,
    question: 'RCDs do NOT protect against:',
    ...
    correctAnswer: 1,
    explanation:
      "RCDs don't protect against shocks between line and neutral (series with load) as no current leaks to earth in this scenario.",
  },
  {
    id: 8,
    ...
    correctAnswer: 2,
    explanation:
      'Type B detects all fault types including smooth DC. Required for some EV chargers, medical equipment, and industrial drives.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Type A is marked with both a sine wave (AC) and a half-wave rectified pulse (pulsating DC) symbol.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      '30mA is below the level likely to cause ventricular fibrillation. Most people can let go at this level, and brief exposure is survivable.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'An RCD has a toroidal core through which line and neutral pass. Under normal conditions, currents are equal and opposite, creating no net magnetic field. During an earth fault, current returns via earth instead of neutral, creating imbalance that is detected and triggers disconnection.',
  },
  {
    question: 'Why 30mA rating?',
    answer:
      "30mA is chosen because it's below the threshold likely to cause ventricular fibrillation (the most dangerous cardiac arrhythmia). Tests show most people can let go of a conductor carrying 30mA, and exposure for the few milliseconds before RCD trips is survivable.",
  },
  {
    question: 'When is Type A required instead of Type AC?',
    answer:
      'Type A is required for equipment that may produce pulsating DC fault currents - typically anything with electronic power supplies, rectifiers, or inverters. This includes EV chargers, variable speed drives, and modern electronic equipment.',
  },
  {
    question: "What's the difference between RCCB and RCBO?",
    answer:
      'RCCB (Residual Current Circuit Breaker) provides only earth leakage protection. RCBO (Residual Current Breaker with Overcurrent) combines RCD and MCB functions in one device, providing both earth fault and overcurrent protection.',
  },
  {
    question: 'Can RCDs prevent all electric shocks?',
    answer:
      "No. RCDs don't protect against line-neutral shocks (where you're in series with the load), or shocks between two live conductors. They protect against line-earth faults where current leaks to earth via a person or equipment.",
  },
  {
    question: 'Why use 100mA or 300mA RCDs?',
    answer:
      "Higher rated RCDs (100mA, 300mA) provide fire protection rather than personal shock protection. They're used for circuits where 30mA would cause nuisance tripping but where earth fault detection is still needed.",
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Principle:</strong> Detects imbalance between L and N
              </li>
              <li>
                <strong>30mA:</strong> Additional shock protection
              </li>
              <li>
                <strong>100/300mA:</strong> Fire protection
              </li>
              <li>
                <strong>Types:</strong> AC, A, F, B for different faults
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> RCD type marking on device
              </li>
              <li>
                <strong>Use:</strong> Match type to equipment
              </li>
              <li>
                <strong>Apply:</strong> Correct rating for application
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              During an earth fault, some current takes an alternative path to earth. The RCD
              detects this imbalance and trips.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Different RCD types are designed to detect different types of fault currents:</p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>RCD ratings determine their sensitivity and intended application:</p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>30mA RCD protection is required for:</p>
            ...
            <p className="text-sm text-amber-300/80">
              <strong>Note:</strong> Some exceptions exist for labelled sockets, monitored
              industrial installations, and specific applications. Always check current regulations.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>RCDs do NOT protect against:</p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Using Type AC for electronic loads</strong> - may not detect DC faults
                </li>
                <li>
                  <strong>Ignoring nuisance tripping</strong> - may indicate excessive leakage
                </li>
                <li>
                  <strong>Wrong rating selection</strong> - 30mA for personal, 100/300mA for fire
                </li>
              </ul>
            </div>
          </div>
