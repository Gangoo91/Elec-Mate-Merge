...
const InspectionTestingModule6Section1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 6 · Section 1" title="RCD types and applications" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Type AC, A, F and B explained against the residual-current waveforms each one actually
          detects — and what A4:2026 changed about which type belongs on which circuit.
        </p>
        ...
        >
          <p>
            BS 7671 recognises four RCD types — AC, A, F and B — each tied to a product standard and
            each defined by the residual-current waveforms it must operate on. The hierarchy is
            cumulative: each higher class detects everything the class below does, plus extra
            waveforms.
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong className="text-white">Type AC</strong> — sinusoidal residual AC current only.
              Built to BS EN 61008 / 61009. Will not reliably detect pulsating DC, smooth DC or AC
              superimposed on DC. The waveform restriction is exactly why Reg 531.3.3 limits its
              use.
            </li>
            <li>
              <strong className="text-white">Type A</strong> — sinusoidal AC plus pulsating DC
              residual currents (suddenly applied or smoothly rising). Built to BS EN 61008 / 61009.
              The new general-purpose minimum across BS 7671 work.
            </li>
            <li>
              ...
              on a smooth DC component up to 10 mA. Designed for circuits supplied between line and
              neutral or line and earthed middle conductor — in practice, circuits feeding
            ...
            <li>
              ...
              slowly increased, independent of polarity. Built to BS EN 62423 (or BS EN 60947-2 for
              industrial CBRs / MRCDs).
            </li>
          </ul>
          <p>
            The shorthand rule: AC sees only AC. Type A adds pulsating DC. Type F adds composite
            waveforms and small smooth-DC tolerance. Type B adds true smooth DC and up-to-1 kHz AC,
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              A Type AC SRCD (a socket-outlet incorporating an RCD to BS 7288) on a general-purpose
              socket cannot meet the fixed-equipment condition. The socket may serve any portable
              load. Reg 531.3.4.1(d) restricts BS 7288 SRCDs to Type AC and Type A — Type AC SRCDs
              on general socket-outlets are now ruled out.
            </li>
            <li>
            ...
            <li>
              On an EICR, a Type AC device on a circuit that may contain DC components is typically
              a code C3 (improvement recommended) at minimum, and a code C2 (potentially dangerous)
              where the load demonstrably produces DC residual currents that the device will not
              detect — for example a Type AC RCD upstream of an EV charge point with no RDC-DD.
            </li>
          </ul>
          <p>
            For new work, Type A is the practical floor. Type AC is reserved for circuits where the
            designer can write down — and defend on inspection — that the connected load is fixed
            and produces no DC component.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            current plus residual pulsating direct current, suddenly applied or smoothly increasing.
            Pulsating DC is the residual-current waveform produced when a half-wave rectifier
            earth-fault occurs — exactly the kind of fault a switch-mode power supply can produce,
            and exactly what Type AC misses.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              In AC installations having RCDs that are intended to be operated by ordinary persons,
              the RCDs shall comply with: (a) BS EN 61008 series for Type AC and Type A RCCBs; or
              (b) BS EN 61009 series for Type AC and Type A RCBOs; or (c) BS EN 62423 for Type F and
              Type B RCCBs and RCBOs; or (d) BS 7288 for Type AC and Type A SRCDs and FCURCDs.
            </>
          }
        ...
        >
          <p>
            ...
            residual currents (suddenly applied or slowly rising), and pulsating DC superimposed on
            a smooth DC current of up to 10 mA. The use case is the kind of single-phase
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              appliance and the appliance manufacturer's installation instructions specify Type F or
              higher.
            </li>
            <li>
            ...
            <li>
              A low-current single-phase frequency converter feeds a small motor where Type B would
              be specified-overkill but Type A would be specified-shy.
            </li>
          </ul>
          <p>
        ...
        >
          <p>
            The BS EN 62423 Type B definition is exhaustive: tripping for everything Type F covers,
            plus residual sinusoidal AC up to 1 kHz, AC superimposed on smooth DC, pulsating DC on
            smooth DC, residual rectified DC from two or more phases, and residual smooth DC
            (suddenly applied or slowly increased) <strong>independent of polarity</strong>. The
            polarity-independence requirement is critical: the device must operate whether the DC
            residual flows L-to-E or E-to-L.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              the equipment manufacturer's instructions typically require Type B unless the inverter
              design provides at least simple separation between the AC and DC sides (which removes
              the smooth-DC residual-current path).
            </li>
            <li>
              <strong>Medical group 1 and group 2 locations</strong> — Reg 710.531.3.3.101 prohibits
              Type AC and tightens the RCD selection regime; Type B is commonly specified for
              circuits feeding medical electrical equipment.
            </li>
            <li>
          ...
          <p>
            ...
            medical / pharma / IT installations. Where it appears in a manufacturer's instructions,
            install to spec; where it does not, BS EN 62423 Type B remains the regulatory anchor.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="440" y="42" textAnchor="middle" fill="#A855F7" fontSize="11" fontWeight="bold">
              START
            </text>
            ...
            <text x="440" y="382" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              EV charging (Section 722) · 3-phase VFDs · solar PV / battery storage · medical group
              1/2 · multi-phase rectifier loads
            </text>
            ...
            <text x="160" y="446" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              3-phase bridge rectifier
            </text>
            <text x="440" y="446" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              EV on-board charger
            </text>
            <text x="720" y="446" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              battery-charging / DC bus
            </text>
            <text x="160" y="466" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              PV inverter (no separation)
            </text>
            <text x="440" y="466" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              manufacturer specifies Type B
            </text>
            <text x="720" y="466" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              that side of the board. Reg 314.1 (division of installation into circuits) limits how
              many circuits one RCD may cover precisely so that a single trip does not disconnect,
              for example, all the lighting in a dwelling.
            </li>
            <li>
              ...
              live. Reg 531.3.2(b) supports this pattern explicitly for residential premises, citing
              the reduction of unwanted tripping. Now the dominant design for new domestic consumer
              units.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              residual operating current than the downstream device. A 100 mA upstream over a 30 mA
              downstream achieves this. A 30 mA upstream over a 30 mA downstream does not — both can
              trip simultaneously on the same residual current.
            </li>
            <li>
              A <strong>time delay</strong> — the upstream device must be designed not to operate
              instantly. Type S devices to BS EN 61008-1 / 61009-1 are time-delayed in their product
              standard. Industrial CBRs / MRCDs to BS EN 60947-2 can be field-set with a time delay;
              Reg 531.3.4.201 (A4:2026) requires that any such adjustment by an ordinary person
              needs a key/tool action and visible indication of the setting.
            </li>
          </ul>
          <p>
            Where selectivity is needed, both ingredients are required. A 100 mA non-delayed RCD
            over a 30 mA non-delayed RCBO does not give selectivity: a fault near the trip threshold
            can fire both devices. Type S is the correct upstream class.
          </p>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              The setting (IΔn or time delay) cannot be changed without a deliberate act involving a{' '}
              <strong>key or tool</strong>.
            </li>
            <li>
          ...
          <p>
            ...
            respect the rule on access. A locked panel, a tool-required cover, or a labelled warning
            that movement of the setting requires authorisation are all part of the compliance
            position.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Where an RCD may be operated by an ordinary person, it shall be designed or installed
              so that it is not possible to modify or adjust the setting or the calibration of its
              rated residual operating current (IΔn) or time delay mechanism without a deliberate
              act involving the use of either a key or a tool and resulting in a visible indication
              of its setting or calibration.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              device. RCBOs are 61009; RCCBs are 61008; Type F / Type B household devices are 62423;
              SRCDs and FCURCDs to BS 7288 record 7288. Recording 60898 against an RCBO is wrong —
              60898 is the MCB-only standard.
            </li>
            <li>
              <strong>Type column</strong> — record AC, A, F or B exactly as marked on the device.
              Where the device is a Type A with an RDC-DD function on an EV charging circuit, record
              the RCD type (A) and add a comment referencing the RDC-DD and BS IEC 62955.
            </li>
            <li>
              <strong>IΔn column</strong> — record the rated residual operating current as marked on
              the device. The trip-time columns are populated from the section 6.2 trip-time tests
              at IΔn × 1, IΔn × 5 and IΔn × 0.5.
            </li>
          </ul>
          <p>
            Comments column carries any explanation that does not fit the structured fields: "Type B
            selected per manufacturer instructions for VFD load", "Type S 100 mA at origin for
