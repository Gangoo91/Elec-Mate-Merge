...
const quizQuestions = [
  {
    question:
      'A public DC fast hub install — which PCAR 2023 pillars trigger at the install stage?',
    options: [
...
export default function RenewableEnergyModule7Section7() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 7 · Public Charge Point Regulations 2023 + PAS 1899:2022"
        title="CPO regulations & PCAR 2023"
        backTo="../renewable-energy-module-7"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The UK statutory regulatory framework for public EV charging — Public Charge Point
          Regulations 2023 (PCAR), PAS 1899:2022 accessibility, OPSS enforcement, CPO operational
          obligations, installer vs CPO boundary.
        </p>
        ...
        <Pullquote>
          PCAR 2023 isn’t a BS 7671 wiring regulation. It’s a UK statutory consumer-protection
          regime. Different regulator, different scope, different teeth.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">1. PAYMENT</strong> — contactless bank card mandatory
              at chargers ≥8 kW. No app-only restriction. PCAR-compliant payment processor (Visa /
              Mastercard accepted)
            </li>
            <li>
              <strong className="text-white">2. RELIABILITY</strong> — rapid chargers (50+ kW) must
              achieve ≥99% uptime over rolling 12 months. Below threshold = OPSS enforcement
            </li>
            <li>
              <strong className="text-white">3. PRICING TRANSPARENCY</strong> — price per kWh + any
              ancillary fees displayed at the charger BEFORE session start. Format: kWh-based or
              per-session
            </li>
            <li>
              <strong className="text-white">4. ROAMING</strong> — interoperability via OCPI hub
              (e.g. Hubject). CPO must provide roaming via at least one hub
            </li>
            <li>
              <strong className="text-white">5. 24/7 HELPLINE</strong> — phone number on each
              charger (signage or LCD display). Customer service responding 24h
            </li>
            <li>
              <strong className="text-white">6. OPEN DATA</strong> — CPO’s CPMS publishes uptime +
              pricing + availability via standardised API to UK Government open-data feed
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Accessibility is the silent failing of UK 2020-22 public charging. PAS 1899:2022 puts it
          in writing. PCAR 2023 references it. Local authority planning conditions enforce it.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Designated accessible bays</strong> — typical ratio
              1-in-6 of total bays; varies by local authority planning. Wider bay dimensions
              (typically 3.6 m vs standard 2.4 m); allows wheelchair alongside vehicle door
            </li>
            <li>
              <strong className="text-white">Approach + kerb cut</strong> — level approach to bay;
              kerb cut where needed; no high kerb that obstructs wheelchair access
            </li>
            <li>
              <strong className="text-white">Clear of obstructions</strong>— lighting columns,
              planters, bollards positioned to avoid blocking access path
            </li>
            <li>
              <strong className="text-white">Mounting height</strong> — payment terminal + display
              accessible from wheelchair seated position (typically 0.9-1.1 m above ground). Cable +
              connector holster reachable (typically ~1 m mounting)
            </li>
            <li>
              <strong className="text-white">Audio + tactile</strong> — audio assistance (talking
              payment terminal, audio confirmation of charging start); high contrast displays;
              tactile signage where appropriate
            </li>
            <li>
              <strong className="text-white">Signage</strong> — clear directional signs to
              accessible bays; international accessibility symbol; tactile + Braille where
              appropriate
            </li>
            <li>
              <strong className="text-white">Cable weight</strong> — accessible-bay cables may be
              lighter / smaller diameter where feasible; some operators provide a "buddy" call-out
              service for customers unable to handle the cable
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — PAS 1899 compliance
              evidence per bay + photographs + accessibility audit report
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">NOT Ofgem supplier-licensed</strong> — CPOs are not
              licensed as electricity suppliers. They buy wholesale (or via a contracted supplier) +
              retail to drivers at the chargepoint
            </li>
            <li>
              <strong className="text-white">PCAR 2023 (OPSS enforcement)</strong> — direct
              regulatory regime for operational obligations
            </li>
            <li>
              <strong className="text-white">Consumer Rights Act 2015</strong> — general consumer
              protection framework — services must be of reasonable quality, fit for purpose, fair
              pricing
            </li>
            <li>
              <strong className="text-white">CMA oversight</strong> — competition regulator
              monitoring market structure, pricing, reliability. CMA 2022-23 investigation led to
              PCAR 2023 elements
            </li>
            <li>
              <strong className="text-white">Indirect Ofgem oversight</strong> — via the underlying
              electricity supplier’s licence (the CPO buys from the supplier; supplier is
              Ofgem-licensed)
            </li>
            <li>
              <strong className="text-white">DCC / smart meter framework</strong> — Data
              Communications Company’s smart-meter infrastructure increasingly relevant for V2G +
              flexible-charging interactions with grid
            </li>
            <li>
              <strong className="text-white">UK 2025-26 evolution</strong> — emerging area;
              regulatory framework still maturing. More direct CPO licensing under discussion at
              Ofgem / UK Government
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Driver complaints</strong> — official channel via
              gov.uk; OPSS investigates
            </li>
            <li>
              <strong className="text-white">Open-data monitoring</strong> — published uptime +
              pricing data via UK Government feed; OPSS monitors for repeated breaches
            </li>
            <li>
              <strong className="text-white">CMA market oversight</strong> — competition concerns
              (e.g. motorway service area concentration as investigated 2022-23); CMA can refer to
              OPSS or initiate its own investigation
            </li>
            <li>
              <strong className="text-white">Press / media</strong>— high-profile reliability or
              pricing concerns generate regulatory attention
            </li>
            <li>
              <strong className="text-white">OPSS warning notice</strong> — initial enforcement;
              gives CPO time to remedy
            </li>
            <li>
              <strong className="text-white">Financial penalty</strong> — up to £10k per
              non-compliant chargepoint per breach. Persistent / large-scale breach = significant
              penalty
            </li>
            <li>
              <strong className="text-white">Improvement order</strong> — formal order requiring
              specific remedial actions within a timeframe
            </li>
            <li>
              <strong className="text-white">Licence revocation</strong> — for persistent
              non-compliance; not yet exercised at UK 2025-26 but theoretical sanction
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">CPO ↔ Hubject</strong> — CPO’s CPMS connects to Hubject
              via OCPI. Exposes chargepoint availability + pricing
            </li>
            <li>
              <strong className="text-white">eMSP ↔ Hubject</strong> — eMSP (driver’s app provider)
              connects to Hubject via OCPI. Authorises driver sessions against driver’s account
            </li>
            <li>
              <strong className="text-white">Driver experience</strong> — opens home app (e.g.
              Octopus Electroverse, BP Pulse, Shell Recharge), finds CPO chargepoint, taps "start";
              Hubject routes authorisation; charger starts session
            </li>
            <li>
              <strong className="text-white">Settlement</strong> — Hubject clears transactions
              between CPO and eMSP; CPO receives settlement for energy delivered at agreed wholesale
              roaming tariff
            </li>
            <li>
              <strong className="text-white">PCAR 2023 fulfilment</strong> — Hubject (or equivalent
              OCPI hub) provides the interoperability mandated by PCAR pillar 4. CPOs typically
              integrate with multiple hubs for broad coverage
            </li>
            <li>
              <strong className="text-white">Wholesale roaming pricing</strong> — typically
              discounted from retail; CPO accepts lower margin in exchange for additional sessions
              from roaming customers
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — CPMS account holder +
              OCPI hub connections + roaming tariff configuration documented for CPO ongoing scope
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reliability breach</strong> — CPO reports 96% uptime on
              a 50+ kW chargepoint (below 99% threshold); OPSS warning notice; CPO has remediation
              window; persistent breach → financial penalty
            </li>
            <li>
              <strong className="text-white">Payment terminal non-compliance</strong> — chargepoint
              ≥8 kW without contactless card payment (PCAR pillar 1 breach); driver complaint; OPSS
              investigates; CPO must retrofit + pay penalty
            </li>
            <li>
              <strong className="text-white">Pricing transparency failure</strong> — pricing not
              displayed before session start (PCAR pillar 3); driver complaint; OPSS investigates;
              CPO must update display + pay penalty
            </li>
            <li>
              <strong className="text-white">Open-data publication gap</strong> — CPO not publishing
              uptime + pricing to UK Government open-data feed (PCAR pillar 6); OPSS investigates;
              CPO must configure publication + pay penalty
            </li>
            <li>
              <strong className="text-white">Helpline failure</strong>— phone number on chargepoint
              dead or unanswered (PCAR pillar 5); driver complaint; OPSS investigates; CPO must
              remedy + pay penalty
            </li>
            <li>
              <strong className="text-white">Persistent non-compliance</strong> — multiple breaches
              across pillars over time; escalating penalties; potential licence revocation
            </li>
            <li>
              <strong className="text-white">CMA + OPSS cooperation</strong> — competition concerns
              flagged by CMA can result in joint enforcement action; recent precedent on motorway
              concentration
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Installer delivers</strong> — BS 7671 EIC per charger;
              BS EN IEC 61439-7 assembly conformity; DNO connection agreement; BS EN 61851
              commissioning evidence; PCAR pillar configuration (payment terminal commissioned,
              pricing display operational, helpline signage in place, OCPP / OCPI integration
              tested, open-data publication configured); PAS 1899 bay layout evidence
            </li>
            <li>
              <strong className="text-white">CPO accepts</strong> — ongoing operation; reliability
              target monitoring; payment processing; pricing management; helpline operation;
              open-data publication; OCPI roaming; accessibility maintenance
            </li>
            <li>
              <strong className="text-white">Handover document</strong>— formal acceptance +
              sign-off; cert evidence bundle structure + access + CPO contact details + installer
              support contact
            </li>
            <li>
              <strong className="text-white">First-year warranty</strong> — typically the installer
              carries first-year warranty on the install; CPO covers operational issues;
              manufacturer covers hardware warranty (typically 2-5 years)
            </li>
            <li>
              <strong className="text-white">Ongoing maintenance</strong> — CPO contracts
              maintenance (either with original installer or alternative service provider). Routine
              + reactive maintenance covered
            </li>
            <li>
              <strong className="text-white">EICR ownership</strong> — CPO owns ongoing EICR cycle;
              typically 5-year interval for commercial; some operators on shorter cycles
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle handover</strong> — structured
              digital folder (likely SharePoint / Confluence / similar) — installer hands over with
              read-write access transferred to CPO
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-7-section-8')}
