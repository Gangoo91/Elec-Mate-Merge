...
const DESCRIPTION =
  'Learn how to safely test circuits with sensitive electronic equipment using SERDs and reduced test voltages.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'SERD = Surge and Electronically Rated Device - equipment containing sensitive electronics that may be damaged by high test voltages.',
  },
  {
    id: 'serd-voltage',
    ...
    correctIndex: 2,
    explanation:
      'SERD mode limits test voltage to 250V DC or lower, and often limits current too, to prevent damage to sensitive equipment.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "Always document why testing couldn't be performed as standard, what alternatives were used, and any limitations.",
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'SERD = Surge and Electronically Rated Device - equipment containing electronics that may be damaged by test voltages.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Electronic components (MOVs, capacitors, semiconductors) are often rated for much lower voltages and can be permanently damaged by 500V DC.',
  },
  {
    id: 3,
    question: 'SERD test mode typically limits voltage to:',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Incandescent lamps are simple resistive loads with no sensitive electronics. LED drivers, SPDs, and PIR sensors all contain electronic components.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Connected electronics may create parallel resistance paths, causing lower readings than the actual cable insulation resistance.',
  },
  {
    id: 6,
    question: 'If IR testing cannot be performed due to SERDs, you should:',
    ...
    correctAnswer: 2,
    explanation:
      "Document why testing couldn't be performed, what equipment prevented it, and what alternative verification was carried out.",
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'SPDs contain Metal Oxide Varistors (MOVs) specifically designed to conduct at elevated voltages - exactly what IR test voltage triggers.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Use SERD mode for a basic test, or where possible disconnect electronics and test the wiring separately, then reconnect.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Smart home devices contain sensitive microprocessors and may be damaged by IR test voltages. Disconnect before standard testing.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'While 500V is standard for 230V circuits, using 250V with SERDs connected is a reasonable compromise - but document it clearly.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'SERD stands for Surge and Electronically Rated Device. It refers to equipment containing electronic components that can be damaged by the high test voltages used in insulation resistance testing. This includes most modern electronic equipment.',
  },
  {
    question: 'What does SERD test mode do?',
    answer:
      'SERD mode limits the test voltage to 250V DC or less, and limits the output current to prevent damage. This allows basic insulation testing of circuits with connected electronics, though readings may be affected by the equipment.',
  },
  {
    question: 'Can I just disconnect everything?',
    answer:
      'Ideally yes, but in practice some equipment is hard-wired or disconnection would cause other problems. SERD mode is a compromise allowing testing without disconnection, though with some limitations on accuracy.',
  },
  {
    question: 'Will SERD mode give accurate readings?',
    answer:
      "Not always. Connected electronics may have components that create parallel paths, reducing apparent insulation resistance. Results should be interpreted with this in mind - you're testing cable insulation plus whatever the equipment adds.",
  },
  {
    question: "What if my instrument doesn't have SERD mode?",
    answer:
      "Options: use 250V range (if available), disconnect all sensitive equipment, or document that standard testing couldn't be performed due to sensitive equipment and explain what alternative verification was done.",
  },
  {
    question: 'Is it acceptable to skip IR testing of circuits with electronics?',
    answer:
      'Not ideal, but if testing genuinely cannot be performed safely, document this clearly. State what equipment prevented testing, what alternative checks were made, and recommend re-testing if equipment is replaced.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Problem:</strong> SERDs can't withstand 500V DC
              </li>
              <li>
                <strong>Solution:</strong> SERD mode, disconnect, or document
              </li>
              <li>
                <strong>Instruments:</strong> Many have dedicated SERD test mode
              </li>
              <li>
                <strong>Always:</strong> Document any limitations
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>SPDs:</strong> MOVs conduct at overvoltage
              </li>
              <li>
                <strong>LED Drivers:</strong> Capacitors, semiconductors
              </li>
              <li>
                <strong>Dimmers:</strong> TRIAC and control circuits
              </li>
              <li>
                <strong>PIRs/Alarms:</strong> Detection circuitry
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p>
              SERDs are any equipment containing electronic components that could be damaged by the
              high DC voltages used in insulation resistance testing. Modern buildings contain many
              such devices.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Electronic components are often rated for much lower voltages than the 500V DC test
              voltage:
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Many modern multifunction testers include a{' '}
              <strong className="text-white">SERD test mode</strong> with:
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Check your instrument:</strong> Look for a SERD button or menu option. Consult
              the manual for your specific model's capabilities.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>When testing circuits with SERDs, always document:</p>
