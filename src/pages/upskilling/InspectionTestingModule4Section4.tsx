    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Sensitive Electronic & Residual-current Devices break under a 500 V DC insulation test.
          Reg 643.3.3 sets out the disconnect-or-bridge rule and the 250 V DC post-connection
          verification — this is the section that keeps boards intact.
        </p>
        ...
        >
          <p>
            The 500 V DC test was designed for an installation in which the only thing between line
            and earth was insulation. Modern installations have replaced that picture with a long
            list of intentional, deliberately low-impedance paths between the line and the
            protective conductor — every SPD, every RCD with electronic detection, every AFDD, every
            switch-mode driver. A 500 V DC pulse into those paths is not the test the device was
            designed for. It is an over-stress.
          </p>
          <p>The categories of SERDs you should expect to encounter:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Surge protection (SPDs)</strong> — Type 1, Type 2, Type 3. MOV-based clamping
              voltages typically sit between 350 V and 470 V DC, below the test voltage.
            </li>
            <li>
            ...
            <li>
              <strong>Dimmers and electronic switches</strong> — TRIAC or MOSFET output stages with
              snubber capacitors directly across L–N.
            </li>
            <li>
        ...
        >
          <p>
            ...
            insulation resistance between live conductors. The second limb (Reg 643.3.1(b)) requires
            the insulation resistance between live conductors and the protective conductor. The
            permission inside the second limb — &ldquo;line and neutral conductors may be connected
            together&rdquo; — is the standard practical method for the L–CPC measurement on any
            circuit with electronic loads.
          </p>
          <p>
            The reasoning is electrical. An electronic load (dimmer, driver, PSU) sits between L and
            N. If you measure L to CPC at 500 V DC with N floating, the 500 V appears between L–N
            across the load — a destructive stress. If you link L and N first, the 500 V is between
            (L+N) and CPC, with zero potential difference across the load. Same insulation reading
            to earth, no L–N stress across the electronics that happen to be downstream.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The partial-disconnect failure mode goes like this. You remove one dimmer, leave the LED
            driver in. You apply 500 V DC. The driver&rsquo;s input filter capacitor presents a
            low-impedance path that pulls the reading to a misleading low value — but only after the
            test has already pulsed energy into it. The driver&rsquo;s X-class capacitor weakens.
            The reading you record is dominated by the still- connected driver&rsquo;s leakage, not
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Stage 1 (Table 64).</strong> Every SERD on the circuit out of the path. Either
              physically removed (smoke alarm bases lifted, lamps out, drivers unwired), or bridged
              out per the manufacturer guidance, or upstream of the opened protective device for
              that circuit.
            </li>
            <li>
            ...
            <li>
              <strong>Never run a hybrid.</strong> &ldquo;Most things disconnected, one or two left
              in to save time&rdquo; is the failure pattern.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            Repeated exposure shortens the MOV&rsquo;s life or, on a single over-stress, cracks the
            metal-oxide disc and fails the device. Some Type 1+2 combination SPDs include
            gas-discharge tubes that hold off DC up to higher voltages and are less affected — read
            the data sheet, not the rule of thumb.
          </p>
          <p>
            ...
            looks fine but reads 0.6–0.9 MΩ on the 250 V DC verification. That under-1-MΩ reading is
            what an end-of-life MOV looks like, and Reg 643.3.3 calls that a fail.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            between L (line side) and CPC. If you test the line-side cabling with an AFDD installed
            and the line-side terminals exposed, you can stress that supply through the device. The
            defensive habit: physically remove the AFDD from the busbar for the line-side cabling
            test, or test the line side only with the AFDD removed.
          </p>
        </ConceptBlock>
          ...
          whatToDo={
            <>
              <span className="block">
                Plan stage 1 in three blocks. Block A: meter tails and supply-side cabling with the
                main switch open and the SPD disconnected. Block B: each AFDD/RCBO open, one at a
                time, test the load-side cabling for that circuit, with all electronic dimmers /
                drivers / chargers physically removed from their back-boxes. Block C: smoke alarm
                circuit — lift every alarm head from its base before applying the pulse to the
                shared-neutral group.
              </span>
              <span className="block mt-2">
                Then stage 2 — reverse everything in order, close all devices, reseat all alarm
                heads, and apply the 250 V DC verification with L and N linked. Wait for capacitance
                settling on the lighting and socket circuits. Record the stabilised value on every
                circuit. Reject anything below 1 MΩ.
              </span>
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Equipment list:</strong> the SERDs you disconnected — SPD type, RCD type, AFDD
              model, dimmer modules removed, alarm bases lifted, EV charger isolated. Names matter
        ...
        <Scenario
          ...
          whatToDo={
            <>
              <span className="block">
                Stage 1 — Table 64 at 500 V DC, charger disconnected at its terminals, cabling only.
                Expect a high reading (200+ MΩ on a new T&amp;E run). Record on the schedule.
              </span>
              <span className="block mt-2">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              regulation says &ldquo;at least 1 MΩ.&rdquo; Round-down on the meter is acceptable as
              long as the displayed value is ≥ 1.0.
            </li>
            <li>
            ...
            <li>
              ...
              comments. A genuinely well-installed cable with no connected loads should read tens to
              hundreds of MΩ; single-figure MΩ on a clean run is a clue.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              during an insulation resistance test, the procedure illustrated allows that equipment
              to remain disconnected or removed while the rest of the circuit is tested.
        ...
        <Quiz title="Testing sensitive equipment (SERDs) — Module 4.4" questions={quizQuestions} />
