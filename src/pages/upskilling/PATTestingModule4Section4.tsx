    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Two methods, one safety question. Substitute leakage when IR cannot give a useful reading;
          differential leakage at operating voltage when the equipment can take it. The 0.5 / 0.25
          mA acceptance, plus the BS EN 62368-1 IT-equipment exception.
        </p>
        ...
        >
          <p>
            IET Code of Practice 5th Edition (2020) Chapter 15 names two leakage methods: substitute
            leakage (a low-voltage test scaled to operating voltage equivalent) and differential
            leakage (a full-mains-voltage test that measures L−N current imbalance directly). Both
            produce a single number — the leakage current in mA — that is judged against the IET CoP
            acceptance limits for the appliance class.
          </p>
          <p>
            The leakage test is also a complementary measurement to IR even on traditional
            equipment. Where IR catches resistive insulation faults, leakage catches the real-world
            current flow under operation. On a healthy non-EMC-filtered appliance the two tests give
            congruent results: high IR, low leakage, both pass. On EMC-filtered equipment the two
            diverge: IR may fail (capacitive coupling), leakage passes (current within limits) — the
            appliance is electrically safe and IET CoP allows the substitute leakage to be the
            deciding test.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              equivalent of nominal supply voltage. The substitute leakage current shall not exceed
              0.5 mA for Class I equipment or 0.25 mA for Class II equipment.
            </>
          }
        ...
        >
          ...
          <p>
            Most automatic PAT testers offer both methods. Substitute leakage is the default for the
            &ldquo;in lieu of IR&rdquo; use case and is fast and safe. Differential leakage is
            ...
            substitute-method scaling inappropriate (e.g. equipment with strongly non-linear leakage
            characteristics).
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            into the protective conductor of the fixed installation → to MET. The user is not in the
            path because the protective conductor is the path of least resistance. The PAT test
            measures the current in the protective conductor: that is earth-leakage current.
          </p>
          <p>
        ...
        >
          <p>
            ...
            interpretation is to apply the BS EN 62368-1 limit — up to 3.5 mA for equipment covered
            by the standard.
          </p>
          <p>
            ...
            continuity test has already verified). With both conditions met, a leakage of 2.8 mA on
            a Class I IT appliance is a normal, compliant reading. Without the protective conductor,
            that 2.8 mA would be touch current — a categorical fail.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            For ordinary RC-network EMC filters and ordinary insulation, the scaling is accurate to
            within a few percent — the substitute reading scaled by the voltage ratio matches the
            differential leakage reading at full mains very closely. For appliances with metal-oxide
            varistors (MOVs) at the input, the scaling can break down because the MOV is a
            non-linear device that conducts heavily near its clamping voltage and not at all below
            it. A 30 V test misses the MOV entirely and reads only the resistive / capacitive paths;
            the differential test at 230 V picks up any near-end-of-life MOV that has shifted its
            clamping voltage.
          </p>
          <p>
            ...
            RCDs or excessive differential leakage; the substitute test alone may miss it. Where you
            suspect MOV-related faults (surge-strip mains conditioners, line filters after a known
            surge event), perform differential leakage as confirmation rather than relying on
            substitute alone.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            regime that sits alongside the design standard IEC 60601-1. In PAT terms, it does three
            things differently from IET CoP for general equipment: (1) it measures additional
            leakage paths that do not exist on general appliances (patient-connected electrodes);
            (2) it sets stricter limits than IET CoP — typical patient-applied-part leakage limits
            are in the µA range, not the mA range of general PAT; (3) it requires calibrated
            medical-grade test equipment that meets BS EN 62353 specifically.
          </p>
          <p>
            For most general electricians performing PAT in offices, schools, retail and industrial
            settings, BS EN 62353 is not the relevant standard. Where you encounter medical
            electrical equipment in the wild — community physiotherapy, dental practice, veterinary,
            occupational health rooms, first-aid AEDs — the duty-holder should have identified that
            the equipment is medical and arranged BS EN 62353 testing rather than general PAT. If
            asked to PAT-test an item that the rating plate identifies as medical electrical, query
            the duty-holder before proceeding; the IET CoP general regime may not satisfy the legal
            duty for that equipment.
          </p>
        </ConceptBlock>
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              Confirm earth continuity (M4.1) has passed first. The substitute leakage test applies
              a small voltage between L+N and the protective conductor — if the protective conductor
              is broken, the test is meaningless and the appliance is unsafe.
            </li>
            <li>
            ...
            <li>
              Compare against the appropriate limit: 0.5 mA Class I (general), 0.25 mA Class II, or
              the relevant product-standard limit (e.g. up to 3.5 mA for BS EN 62368-1 IT equipment
              with intact protective conductor).
            </li>
            <li>
              Record the result in mA, the test method (substitute leakage), and the limit applied.
              Note &ldquo;in lieu of IR per IET CoP Ch 15&rdquo; if substitution applied.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              substituted-out per IET CoP). Confirm polarity has passed. Differential leakage is the
              fourth test in the sequence.
            </li>
            <li>
              Confirm the test bench has RCD protection (most PAT testers have this built in).
              Differential leakage applies full mains to the appliance under test; if the appliance
              has a hidden insulation defect, the RCD protects the operator.
            </li>
          ...
          whatToDo={
            <>
              ...
              <span className="block">
                ...
                the general value. BS EN 62368-1 permits up to 3.5 mA for Class I IT equipment with
                a permanently-connected protective conductor.
              </span>
              ...
              <span className="block">
                ...
                Ch 15; BS EN 62368-1 limit 3.5 mA applies). Pass.&rdquo; The audit trail is explicit
                about why the higher limit was used.
              </span>
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              The acceptable leakage current shall not exceed 0.5 mA for Class I equipment, or 0.25
              mA for Class II equipment. Where the equipment under test is covered by a relevant
              product safety standard which permits a higher leakage current (for example, BS EN
              62368-1 for information technology equipment permits up to 3.5 mA for certain Class I
              categories), the higher product-standard limit shall apply.
            </>
          }
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong className="text-amber-300">Marginal — close to the limit.</strong> Investigate
              trend. If previous test cycles show a rising leakage, the EMC components are degrading
              and the appliance is approaching end-of-life on insulation. Pass for now, flag for
              closer inspection at the next cycle.
            </li>
            <li>
              <strong className="text-red-300">Above the limit.</strong> Fail. Causes: insulation
              breakdown (unlikely if IR has been performed), Y-capacitor short, contamination across
              a terminal, water ingress to a connector, internal damage. Investigate and remediate,
              or fail the appliance. Do not retest until the cause is identified.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Test method:</strong> &ldquo;Substitute leakage&rdquo; or &ldquo;Differential
              leakage&rdquo;. Where substitute was applied in lieu of IR, note the substitution and
              the IET CoP Ch 15 reference.
            </li>
            <li>
              <strong>Numeric result:</strong> the reading in mA, expressed at the operating-voltage
              equivalent (the tester does this scaling for the substitute method).
            </li>
            <li>
              <strong>Construction class:</strong> Class I or Class II. The class determines the
              applicable limit (0.5 vs 0.25 mA) and whether the protective conductor is in the test
              path.
            </li>
            <li>
              <strong>Limit applied:</strong> the numeric limit and its source. &ldquo;0.5 mA per
              IET CoP Ch 15 (general Class I)&rdquo; or &ldquo;3.5 mA per BS EN 62368-1 (Class I IT
              equipment with intact protective conductor)&rdquo;. The audit trail includes the
              standard.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            ...
            {
              question: 'What about RCD-protected supplies — does that change PAT leakage limits?',
              answer:
