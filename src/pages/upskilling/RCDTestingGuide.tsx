        ...
        <div className="max-w-3xl mx-auto space-y-4 sm:space-y-6">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-xl text-white">
              Complete practical procedures for residual current device testing
            </p>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-red-950/30 border border-red-500/50 p-4 rounded">
                  ...
                  <ul className="text-sm space-y-1 text-red-200">
                    <li>
                      • Inform all occupants that RCD testing will temporarily remove earth fault
                      protection
                    </li>
                    <li>
                      • Check no life-support equipment is connected to RCD-protected circuits
                    </li>
              ...
              <div className="space-y-3">
                <h3 className="text-lg font-semibold text-yellow-400">
                  2. Equipment Setup & Identification
                </h3>
              ...
              <div className="space-y-3">
                <h3 className="text-lg font-semibold text-yellow-400">
                  4. Manual Test Button Operation
                </h3>
                <div className="bg-card p-4 rounded space-y-3">
                  ...
                  <div className="bg-yellow-950/30 border border-yellow-400/30 p-3 rounded">
                    <p className="text-yellow-200 text-sm">
                      <strong>Important:</strong> If test button fails to trip RCD, do not proceed
                      with electrical testing. RCD is faulty and requires replacement.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-yellow-950/20 border border-yellow-400/30 p-4 rounded space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="bg-card p-3 rounded">
                      ...
                      <ul className="text-sm space-y-1">
                        <li>
                          • <strong>Power ON</strong> your RCD tester (e.g., Megger RCD2, Fluke
                          1653B, Kewtech KT64)
                        </li>
                        <li>
                          • <strong>Select RCD mode</strong> (not insulation or continuity)
                        </li>
                        <li>
                          • <strong>Set RCD rating:</strong> 30mA, 100mA, 300mA or 500mA as
                          appropriate
                        </li>
                        <li>
                          • <strong>Set RCD type:</strong> AC (standard) or A (for electronic
                          equipment circuits)
                        </li>
                        <li>
                          • <strong>Choose test mode:</strong> AUTO (recommended) or MANUAL
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-card p-3 rounded">
                      <h5 className="text-white font-medium mb-2">
                        2. Probe Connection (Socket Outlet Method):
                      </h5>
                      <ul className="text-sm space-y-1">
                        <li>
                          • <strong>Plug RCD tester</strong> into socket outlet on protected circuit
                        </li>
                        <li>
                          • <strong>Verify socket wiring first</strong> - use socket tester or check
                          L-N-E connections
                        </li>
                        <li>
                          • <strong>Red probe:</strong> Phase (Live) terminal in socket
                        </li>
                        <li>
                          • <strong>Black probe:</strong> Earth terminal in socket
                        </li>
                        <li>
                          • <strong>DO NOT connect neutral</strong> for standard RCD testing
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-card p-3 rounded">
                      <h5 className="text-white font-medium mb-2">
                        3. Alternative Direct Connection Method:
                      </h5>
                      <ul className="text-sm space-y-1">
                        <li>
                          • <strong>Isolate circuit</strong> before making connections
                        </li>
                        <li>
                          • <strong>Connect at load side</strong> of RCD (not supply side)
                        </li>
                        <li>
                          • <strong>Red probe to Phase:</strong> downstream terminal of RCD
                        </li>
                        <li>
                          • <strong>Black probe to Earth:</strong> earth bar or terminal
                        </li>
                        <li>
                          • <strong>Re-energise</strong> circuit before testing
                        </li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="bg-card p-4 rounded border border-yellow-400/30">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      <div className="space-y-2">
                        ...
                        <p>
                          Verifying RCD does NOT trip at half its rated current (too sensitive =
                          fault)
                        </p>
                        ...
                        <ul className="space-y-1">
                          <li>
                            • 30mA RCD: Test at <strong>15mA</strong>
                          </li>
                          <li>
                            • 100mA RCD: Test at <strong>50mA</strong>
                          </li>
                          <li>
                            • 300mA RCD: Test at <strong>150mA</strong>
                          </li>
                        </ul>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <ol className="space-y-1 list-decimal list-inside">
                          <li>
                            <strong>Press ½×IΔn button</strong> on tester
                          </li>
                          <li>
                            <strong>Hold for 2 seconds</strong> (or until test completes)
                          </li>
                          <li>
                            <strong>Watch RCD:</strong> Should NOT trip
                          </li>
                          <li>
                            <strong>Read display:</strong> "NO TRIP" or "PASS"
                          </li>
                          <li>
                            <strong>If RCD trips:</strong> Mark as FAIL - too sensitive
                          </li>
                        </ol>

                        <div className="bg-green-950/30 border border-green-500/50 p-2 rounded mt-2">
                          <p className="text-green-200 text-xs">
                            <strong>PASS:</strong> RCD remains energised, no trip indication
                          </p>
                        </div>
                        <div className="bg-red-950/30 border border-red-500/50 p-2 rounded">
                          <p className="text-red-200 text-xs">
                            <strong>FAIL:</strong> RCD trips - replace immediately
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-card p-4 rounded border border-yellow-400/30">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      <div className="space-y-2">
                        ...
                        <ul className="space-y-1">
                          <li>
                            • 30mA RCD: <strong>30mA</strong> ≤ 300ms
                          </li>
                          <li>
                            • 100mA RCD: <strong>100mA</strong> ≤ 300ms
                          </li>
                          <li>
                            • 300mA RCD: <strong>300mA</strong> ≤ 500ms
                          </li>
                      ...
                      <div className="space-y-2">
                        ...
                        <ol className="space-y-1 list-decimal list-inside">
                          <li>
                            <strong>Ensure RCD is reset</strong> from previous test
                          </li>
                          <li>
                            <strong>Press 1×IΔn button</strong> on tester
                          </li>
                          <li>
                            <strong>Watch for immediate trip</strong> - should be quick
                          </li>
                          <li>
                            <strong>Read trip time</strong> on display (in milliseconds)
                          </li>
                          <li>
                            <strong>Reset RCD</strong> - switch OFF then ON
                          </li>
                          <li>
                            <strong>Record result:</strong> Trip time and pass/fail
                          </li>
                        </ol>

                        <div className="bg-green-950/30 border border-green-500/50 p-2 rounded mt-2">
                          <p className="text-green-200 text-xs">
                            <strong>TYPICAL:</strong> 20-100ms (very good), up to 300ms acceptable
                          </p>
                        </div>
                        <div className="bg-red-950/30 border border-red-500/50 p-2 rounded">
                          <p className="text-red-200 text-xs">
                            <strong>FAIL:</strong> No trip or greater than 300ms (greater than 500ms
                            for 300mA)
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="bg-card p-4 rounded border border-purple-500/50">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      <div className="space-y-2">
                        <p className="text-yellow-400 font-medium">What You're Testing:</p>
                        <p>
                          Fast disconnection at high fault current - simulates serious earth fault
                        </p>

                        <p className="text-yellow-400 font-medium">Test Current & Limits:</p>
                        <ul className="space-y-1">
                          <li>
                            • 30mA RCD: <strong>150mA</strong> ≤ 40ms
                          </li>
                          <li>
                            • 100mA RCD: <strong>500mA</strong> ≤ 40ms
                          </li>
                          <li>
                            • 300mA RCD: <strong>1500mA</strong> ≤ 40ms
                          </li>
                      ...
                      <div className="space-y-2">
                        ...
                        <ol className="space-y-1 list-decimal list-inside">
                          <li>
                            <strong>Wait 1-2 minutes</strong> after previous test
                          </li>
                          <li>
                            <strong>Ensure RCD is reset</strong> and circuit energised
                          </li>
                          <li>
                            <strong>Press 5×IΔn button</strong> on tester
                          </li>
                          <li>
                            <strong>Should trip very quickly</strong> - usually less than 25ms
                          </li>
                          <li>
                            <strong>Read trip time</strong> - must be 40ms or less
                          </li>
                          <li>
                            <strong>Reset RCD</strong> and verify circuit restoration
                          </li>
                        </ol>

                        <div className="bg-green-950/30 border border-green-500/50 p-2 rounded mt-2">
                          <p className="text-green-200 text-xs">
                            <strong>TYPICAL:</strong> 10-25ms (excellent response)
                          </p>
                        </div>
                        <div className="bg-red-950/30 border border-red-500/50 p-2 rounded">
                          <p className="text-red-200 text-xs">
                            <strong>FAIL:</strong> No trip or greater than 40ms - RCD fault
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="bg-yellow-950/30 border border-yellow-400/30 p-4 rounded">
                  ...
                  <ul className="text-sm space-y-1 text-yellow-200">
                    <li>
                      • <strong>AUTO mode:</strong> Tester performs all three tests automatically in
                      sequence
                    </li>
                    <li>
                      • <strong>MANUAL mode:</strong> You press each test button individually
                    </li>
                    <li>
                      • <strong>Always wait</strong> 1-2 minutes between high current tests
                    </li>
                    <li>
                      • <strong>Test each RCD separately</strong> - don't test multiple RCDs
                      simultaneously
                    </li>
                    <li>
                      • <strong>If RCD won't reset:</strong> There may be a genuine earth fault -
                      investigate
                    </li>
                    <li>
                      • <strong>Ramp testing:</strong> Some testers can gradually increase current
                      to find exact trip point
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="bg-card p-4 rounded">
                  <h4 className="text-yellow-400 font-semibold mb-2">
                    RCD Trips Randomly (Nuisance Tripping)
                  </h4>
                  <ul className="text-sm space-y-1">
          ...
          <Card className="bg-card border-transparent">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 gap-4">
                <div className="bg-card p-4 rounded border border-yellow-400/30">
                  <h4 className="text-yellow-400 font-semibold mb-2">
                    Testing S-Type (Time Delayed) RCDs
                  </h4>
                  <ul className="text-sm space-y-1">
                    <li>
                ...
                <div className="bg-card p-4 rounded border border-yellow-400/30">
                  <h4 className="text-yellow-400 font-semibold mb-2">
                    Type A and Type AC RCD Testing
                  </h4>
                  <ul className="text-sm space-y-1">
              ...
              <div className="space-y-4">
                <div className="bg-red-950/30 border border-red-500/50 p-4 rounded">
                  <h4 className="text-red-300 font-semibold mb-2">
                    RCD Fails to Trip at Rated Current
                  </h4>
                  <div className="text-sm space-y-2">
                    ...
                    <p>
                      <strong>Action Required:</strong> Replace RCD immediately - installation has
                ...
                <div className="bg-yellow-950/30 border border-yellow-400/30 p-4 rounded">
                  <h4 className="text-yellow-300 font-semibold mb-2">
                    RCD Trips at Half-Rated Current
                  </h4>
                  <div className="text-sm space-y-2">
                    <p>
                      <strong>Possible Causes:</strong>
                ...
                <div className="bg-yellow-950/20 border border-yellow-400/30 p-4 rounded">
                  <h4 className="text-blue-300 font-semibold mb-2">
                    Slow Trip Times (But Within Limits)
                  </h4>
                  <div className="text-sm space-y-2">
                    <p>
                    ...
                    <p>
                      <strong>Likely Causes:</strong> Normal aging, mechanism wear, temperature
                      effects
                    </p>
                    <p>
                      <strong>Recommendation:</strong> Monitor closely and consider replacement
                      planning
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-green-950/30 border border-green-500/50 p-4 rounded">
                  ...
                  <div className="text-sm space-y-2">
                    ...
                    <p>
                      <strong>Investigation Methods:</strong>
                    </p>
                    <ul className="list-disc list-inside space-y-1 text-green-200">
          ...
          <Card className="bg-gradient-to-r from-yellow-400/10 to-yellow-400/10 border-yellow-400/30">
            ...
            <CardContent className="space-y-2 text-sm">
              <p>
                <strong>Section 642.2:</strong> RCD testing requirements and methods
              </p>
              <p>
