    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS 5839-1:2025 L1 to L5: how detection coverage scales with the life-safety risk, what the
          2025 revision changed (sleeping rooms, void walls, flues, stairway lobbies) and how to
          select the correct category from a fire risk assessment.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>L1</strong> — highest life-safety coverage. Automatic detection throughout the
              protected building, except for the limited exceptions listed in Annex D.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Insurance, regulatory or contractual requirements specifically demand L1 (e.g. certain
              healthcare specifications, some HMO licensing conditions).
            </li>
          </ul>
          <p>
            A common L1 design fault is treating Annex D as a checklist of "areas to exclude" rather
            than a checklist of "areas where exclusion is acceptable IF the conditions are met". The
            direction of inference matters: every room starts protected; the designer must
            demonstrate the conditions for exclusion before a detector is omitted.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            Where Annex D and the FRA disagree, the FRA wins. Annex D allows you to exclude; it does
            not require you to. If the FRA flags a particular bathroom as elevated-risk (drying
            clothes, electric-fire hairdryer storage, smoking history), the detector stays in.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              ...
              <text x="254" y="96" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                Escape + high risk
              </text>
              ...
              <text x="206" y="215" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
                sleep
              </text>
              <line
                x1="220"
            ...
            <g>
              ...
              <text x="414" y="96" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                Escape + opens-onto
              </text>
              <rect
                x="406"
            ...
            <g>
              ...
              <text x="574" y="96" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                Escape routes only
              </text>
              <rect
                x="566"
            ...
            <g>
              ...
              <text x="734" y="96" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                Designer-defined
              </text>
              ...
              <text x="734" y="220" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
            ...
            <text x="414" y="384" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              L2 — sleeping rooms now require detection (heat detectors prohibited) · L3 — void-wall
              wording changed to "solid, no holes"
            </text>
            <text x="414" y="397" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              L4 — top-of-flue detector now recommended · Stairway lobbies — automatic detection now
              required
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              designs). Specify smoke or multi-sensor detection instead. Heat detectors respond too
              late for sleeping occupants.
            </li>
            <li>
              The change is NOT retrospective. Existing systems that comply with BS 5839-1:2017 and
              that include heat detectors in sleeping rooms are still compliant. They become subject
              to the 2025 rule when material works (extension, modification, system upgrade, refit
              following a fire) trigger redesign.
            </li>
            <li>
              The trigger for "material works" is essentially the same as that under the Regulatory
              Reform (Fire Safety) Order 2005 and Approved Document B — a substantial refurbishment,
              a change of use, a system extension. A like-for-like replacement of a detector head is
              not a trigger; replacing an entire panel in an extended system is.
            </li>
          </ul>
          <p>
            The 2017 edition allowed heat detectors in sleeping rooms because the L category did not
            demand sleeping-room cover at all in many cases — designers reached for heat detectors
            as a budget compromise. The 2025 revision closes that loophole by both requiring cover
            (the room is now high-risk) and prohibiting the under-performing detector type (heat).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              areas. Similarly, heat detectors should now not be used in rooms where people sleep in
              a category L3 system, albeit the objective of L3 is not to protect persons in that
              room. Despite the previous editions of BS 5839-1 allowing the use of heat detectors in
              sleeping rooms, the new recommendation is not retrospective, so existing systems do
              not need to be changed unless they are undergoing new works e.g. a system upgrade.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              room is covered (because it opens onto the route), the detector type must be smoke or
              multi-sensor, not heat.
            </li>
            <li>
              Void-wall wording: was "fire-resisting construction"; is "solid construction with no
              holes". The objective (smoke must not cross from the void to the route) is identical.
              The verification is now practical.
            </li>
            <li>
              Cross-reference to BS 5839-1:2025 21.2.4 for ceiling-distance limits when siting
              detectors in rooms opening onto escape routes (25 mm to 600 mm for smoke; 25 mm to 150
              mm for heat).
            </li>
          </ul>
          <p>
            An L3 design is the typical 'small office building' default — escape route detection in
            the corridors, plus detection in offices that open onto those corridors. The 'rooms
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              systems and ceiling voids. In the 2017 version, the separation of the void of the room
              off the escape route had to be "fire-resisting construction"; this always raised the
              question of "what is fire-resisting construction?" and "how do you identify it?". The
              aim of the clause is to prevent smoke from the void adjacent to the escape route
              compromising the escape route. Whether the wall between them is of fire-resisting
              construction is largely immaterial. It should just be of solid construction with no
              holes in it.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Detection on the escape routes (corridors, stairs, lobbies — see stairway-lobby update
              below).
            </li>
          ...
          <p>
            ...
            used for sleeping risk; an L3 or L2 (or L1 for vulnerable occupants) is the usual choice
            once sleeping use is in scope. L4 is most often seen in small commercial premises with
            no sleeping risk, simple geometry, and short escape distances.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              recommended that the flue-like structure should have a fire detector at the top.
              However, unlike categories L1, L2, L3 and P1 systems, it does not recommend a detector
              to be placed within approximately 1.5 m of the penetration on every floor.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              A heritage or museum context where a specific gallery requires earlier detection than
              the rest of the building because of irreplaceable contents (this overlaps with P1
              thinking and the system is sometimes specified L5/M).
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              expectations for new buildings and material refurbishments. ADB does not prescribe BS
              5839-1 categories directly, but its guidance frequently leads to L1 / L2 / L3 outcomes
              by way of escape-route and detection expectations.
            </li>
            <li>
            ...
            <li>
              <strong>BS 5839-1:2025 itself.</strong> The category coverage rules; the 2025 changes
              covered above.
            </li>
            <li>
          ...
          <p>
            The fire-alarm designer's role is to translate the responsible person's decision into a
            compliant detection scheme. If the FRA points to L1 and the budget points to L4, the
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              regulations on identification (IEC 60445): the functional earth conductor is
              identified by pink or marked "FE" (changed from cream in earlier editions). Batteries
              should be labelled with the date of installation.
            </li>
            <li>
              <strong>Supply.</strong> Continuous availability of supply is the load-bearing Section
              560 concept. Fire-alarm panels typically use a primary supply backed by standby
              batteries; the BS 5839-1:2025 alarm-transmission rule (14.17 — 90 s indication of fire
              alarm signal at the ARC) depends on supply integrity.
            </li>
            <li>
              <strong>Segregation.</strong> Fire alarm circuits should be segregated from other
              circuits to prevent a fault on a non-fire circuit propagating to the fire system. The
              segregation rules in BS 7671 Section 528 apply.
            </li>
            <li>
              <strong>AFDD relevance.</strong> BS 7671 A4:2026 expands AFDD requirements in certain
              higher-risk premises (sleeping accommodation, certain HMOs). An installation with
              AFDDs reduces the risk of a wiring-fault-driven fire that the BS 5839-1:2025 detection
              system would then need to detect. AFDDs are not a substitute for a fire alarm; they
              are a complementary risk-reduction layer upstream.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <p className="italic text-[14px] text-white/80 border-l-2 border-elec-yellow/50 pl-4 my-2">
            "Other than within rooms in a Category L3 system (see 21.2.5), in voids (see 21.2.7) or
            where a horizontal ceiling comprises a series of small cells (see 21.2.13 and 21.2.14),
            fire detectors should be sited on ceilings, such that their sensitive elements are
            between the following distances below ceilings: a) 25 mm to 600 mm for smoke detectors;
            and b) 25 mm to 150 mm for heat detectors."
          </p>
          <p>
            The 25 mm minimum prevents the detector being too close to the ceiling surface (where
            dust and stagnant air can mask the sensing chamber). The 600 mm / 150 mm maxima keep the
            detector within the smoke layer / ceiling jet that develops in a real fire. Going below
            those depths puts the detector outside the fire-driven flow and delays detection.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Other than within rooms in a Category L3 system (see 21.2.5), in voids (see 21.2.7) or
              where a horizontal ceiling comprises a series of small cells (see 21.2.13 and
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-1/section-2')}
