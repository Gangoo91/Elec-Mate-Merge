...
export default function RenewableEnergyModule9Section7() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 9 · Section 7 · Section 551 + MCS MIS 3008 + Environment Agency + emerging LCT"
        title="Micro-hydro + emerging LCT (hydrogen, fuel cells)"
        backTo="../renewable-energy-module-9"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Micro-hydro from the BS 7671 electrical install perspective. Pelton / Francis / Crossflow
          / Archimedes screw turbines. MCS MIS 3008. Environment Agency abstraction licence + Eel
          Regulations 2009 + ecological assessments. Section 551 + Reg 551.7.5 anti-islanding + long
          cable run + dump load. Plus emerging LCT: UK 2025-26 hydrogen direction (HyDeploy +
          hydrogen-ready boilers + heat pumps) + fuel cells (commercial + emerging applications).
        </p>
        ...
        <Pullquote>
          Micro-hydro is BS 7671 Section 551 + a small civil engineering project + an ecological
          assessment. The electrical install is the smallest scope but bound to the longest project
          timeline.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Pelton</strong> — high head 50m+ (some installs 200m+);
              low flow. Water jet from nozzle hits cup-shaped buckets on rotor. High efficiency
              (~88-92%). Mountain stream + dam installs. UK brands: Gilkes Energy, Hydroplan, Esthec
            </li>
            <li>
              <strong className="text-white">Francis</strong> — medium head 10-100m; medium flow.
              Reaction turbine with adjustable guide vanes (variable output). Most common at small
              commercial scale. Efficiency 85-92%. Suits varied conditions
            </li>
            <li>
              <strong className="text-white">Crossflow (Banki / Mitchell)</strong> — low head 5-50m;
              variable flow. Water passes through rotor twice for efficiency. Rugged + simple +
              lower cost. Suits sites with seasonal flow variation. Efficiency 75-85%
            </li>
            <li>
              <strong className="text-white">Archimedes screw</strong>— very low head 1-10m; high
              flow. Slow rotation (10-30 RPM); fish-friendly (no fast blades); sediment-tolerant.
              Suits rivers + weirs. Efficiency 70-85%. UK 2025-26 increasing share for fish-passable
              installs
            </li>
            <li>
              <strong className="text-white">UK 2025-26 site distribution</strong> — Pelton ~40%
              (Highland / Welsh / Lake District mountains); Francis ~25% (mill / weir established
              sites); Crossflow ~20% (variable rural); Archimedes screw ~15% (rivers +
              fish-sensitive sites, growing share)
            </li>
            <li>
              <strong className="text-white">Sizing</strong> — typical UK domestic / small
              commercial micro-hydro 5-30 kW; community / agricultural 30-100 kW; larger commercial
              / community schemes 100 kW - 5 MW
            </li>
            <li>
              <strong className="text-white">Capacity factor</strong>— 30-60% UK typical, depending
              on site. Much higher than PV (10-12%) or wind (20-25%). Annual kWh per kW installed:
              ~3,000-5,000 (vs PV ~900 + wind ~1,800-2,000)
            </li>
            <li>
              <strong className="text-white">Section 551</strong>— applies fully. Reg 551.1.1(b)
              turbines. Reg 551.7.5 anti-islanding + Reg 551.7.2.1 supply-side + Reg 551.4.2
              multi-source RCD. MCS MIS 3008 installer standard
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Abstraction licence</strong>— required for any water
              abstraction. England: Environment Agency (Water Resources Act 1991). Wales: Natural
              Resources Wales. Scotland: SEPA under CAR. NI: NIEA
            </li>
            <li>
              <strong className="text-white">Application process</strong> — pre-application advice
              (4-8 weeks) → formal application with hydrological + ecological + fish-passage
              assessments → consultation period (4-12 weeks) → determination + grant or refusal
            </li>
            <li>
              <strong className="text-white">Typical timeline</strong>— 3-12 months end-to-end.
              Faster for simple low-impact sites; longer for protected sites / large abstractions /
              controversial sites
            </li>
            <li>
              <strong className="text-white">Cost</strong> — application fee £135-1500; consultant
              fees £3-15k for assessments (hydrologist + ecologist + fisheries specialist)
            </li>
            <li>
              <strong className="text-white">Key licence conditions</strong> — Hands-Off Flow (HOF —
              minimum flow remaining in main watercourse); maximum abstraction rate; operating
              season (some restricted to high-flow months); fish-passage requirements; monitoring
              requirements (typically year 1-3 post-install)
            </li>
            <li>
              <strong className="text-white">Eel Regulations 2009</strong>— implements EU Council
              Regulation 1100/2007. Requires intake screen at any water abstraction (12mm bar
              spacing maximum typical) to prevent eel entrainment
            </li>
            <li>
              <strong className="text-white">Salmon + Freshwater Fisheries Act</strong> — protects
              salmonid species; fish passage requirements at obstructions in salmonid waters
            </li>
            <li>
              <strong className="text-white">Habitats Regulations 2017</strong> — UK retained EU
              Habitats Directive. Habitats Regulations Assessment (HRA) for projects affecting
              protected sites
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — abstraction licence
              reference + conditions + ecological reports + intake screen spec + fish-passage
              details + HOF compliance + monitoring schedule
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Micro-hydro electrical scope is small. The licences, ecology, and civils dwarf it. But the
          dump load + the long cable run are non-negotiable BS 7671 deliverables.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Grid-tie inverter location</strong> — at powerhouse
              (turbine) location; converts turbine variable-frequency AC to grid-synchronised 50 Hz;
              anti-islanding integrated. Three-phase typical
            </li>
            <li>
              <strong className="text-white">Cable run</strong> — from inverter to building / AC
              supply panel. Typical 50-500m at rural / Highland sites. Substantial civils (trenching
              600mm deep typical; sand bedding; marker tape; backfill)
            </li>
            <li>
              <strong className="text-white">Voltage drop calc</strong>— Reg 525.202 + Appendix 4
              Section 6.4 ≤5%. Limiting factor on long runs. Three-phase voltage drop = single-phase
              ÷ √3 (factor of ~0.58)
            </li>
            <li>
              <strong className="text-white">Cable sizing example</strong> — 15 kW three-phase 22 A
              per phase, 300m run: 25 mm² SWA = 2.5% drop (tight); 35 mm² SWA = 1.8% drop
              (comfortable); 50 mm² SWA = 1.3% drop (premium)
            </li>
            <li>
              <strong className="text-white">SWA armour as CPC</strong> — per Reg 543. 35mm² SWA
              armour ~140mm² steel — well above Table 54.7 minimum for 25 mm² circuit
            </li>
            <li>
              <strong className="text-white">Dump load</strong> — resistor bank at powerhouse sized
              to match turbine rated power. Engages automatically on grid-loss; provides resistive
              load to brake generator + dissipate continuing water-driven generation
            </li>
            <li>
              <strong className="text-white">Mechanical penstock valve</strong> — additional safety
              on larger / higher-safety installs. Automatic spring-loaded valve at intake / penstock
              head; closes on grid-loss; diverts water away from turbine. Substantial safety
              redundancy
            </li>
            <li>
              <strong className="text-white">AC isolator</strong>— at inverter for service /
              maintenance isolation. BS EN 60947-3 lockable OFF
            </li>
            <li>
              <strong className="text-white">EREC G99 notification</strong> — typical (sustained
              5-50 kW export &gt; G98 threshold). DNO-witnessed anti-islanding test for larger
              commercial installs
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — cable type +
              cross-section + length + Appendix 4 voltage drop calc + dump load + valve + Section
              551 + EREC G99 + MCS MIS 3008 handover
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">HyDeploy 20% blend trials</strong> — Keele University
              (since 2019) + Winlaton near Gateshead (since 2021). Verified safe operation of
              existing gas appliances on 20% hydrogen blend. Continues at trial scale
            </li>
            <li>
              <strong className="text-white">Hydrogen heating village trials</strong> — Whitby
              (Cheshire) + Redcar; both cancelled / scaled back over public concerns + technical
              issues
            </li>
            <li>
              <strong className="text-white">UK strategic decision</strong> — hydrogen for heating
              decision deferred from original 2026 target. Hydrogen direction stronger for
              industrial decarbonisation + transport + electricity-grid balancing
            </li>
            <li>
              <strong className="text-white">Hydrogen-ready boilers</strong> — Worcester Bosch +
              Vaillant + Ideal + Baxi etc. tested for 20% blend; some 100% hydrogen capable via
              firmware / hardware update. Future-proofing capability; dormant until / unless supply
              changes
            </li>
            <li>
              <strong className="text-white">Hydrogen-ready heat pumps</strong> — some manufacturer
              hydrogen-fed water heater backup designs (heat pump primary + hydrogen-fed backup). UK
              2025-26 limited deployment
            </li>
            <li>
              <strong className="text-white">Commercial fuel cells</strong> — emerging beyond
              micro-CHP residential. Bloom Energy + FuelCell Energy SOFCs; commercial PEM. Data
              centres + hospitals + hydrogen-economy hubs. 5-200 kWe range. Section 551 applies (Reg
              551.1.1(f))
            </li>
            <li>
              <strong className="text-white">Fuel cell economic reality</strong> — capex 2-3× IC
              engine CHP per kWe; longer life + lower maintenance; ROI 8-15 years; mainstream
              economic case developing
            </li>
            <li>
              <strong className="text-white">Other emerging LCT</strong> — ammonia (NH3 as hydrogen
              carrier; shipping fuel + industrial applications); thermo-electric (Seebeck / Peltier
              waste-heat recovery niche); phase-change materials; kinetic / gravity batteries
            </li>
            <li>
              <strong className="text-white">Installer position</strong>— aware of direction; track
              UK regulatory decisions; minimal current install obligation; honest customer
              expectations re hydrogen-ready capability vs current operational reality. Cert
              evidence bundle records any hydrogen-ready capability + manufacturer documentation
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-9-section-8')}
