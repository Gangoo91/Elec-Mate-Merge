...
const DESCRIPTION =
  'Understand the critical differences between RCD test buttons and instrument testing, and why both are necessary for complete verification.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'The test button creates an internal test circuit that bypasses the external installation, only verifying that the internal sensing and tripping mechanism operates.',
  },
  {
    id: 'broken-cpc',
    ...
    correctIndex: 2,
    explanation:
      "The test button bypasses the external circuit. Only instrument testing, which includes the circuit's earth path, can detect issues like a broken CPC or disconnected earth.",
  },
  {
    id: 'test-frequency',
    ...
    correctIndex: 2,
    explanation:
      'BS 7671 recommends that users operate the test button quarterly (every 3 months) to exercise the mechanical components and verify basic functionality.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'The test button is a simple mechanical switch with no timing capability. It can only indicate that the RCD trips, not how quickly it does so.',
  },
  {
    id: 3,
  ...
  },
  {
    id: 5,
    question:
      'An RCD passes its test button test but fails instrument testing at 1xIdn. What does this indicate?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      "This indicates the mechanical trip works (test button passes) but there's an issue with the actual sensing capability or the circuit's earth path that instrument testing reveals.",
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation:
      'The test button applies a current designed to operate the mechanism, typically close to or slightly above Idn, but this is not precisely calibrated and varies by manufacturer.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'Quarterly test button operation is recommended for users. The test button only checks internal mechanisms and cannot verify external circuit integrity.',
  },
  {
    id: 8,
    ...
    correctAnswer: 2,
    explanation:
      'An EICR requires both: verify the test button operates the RCD AND perform instrument testing at 1xIdn and 5xIdn to confirm trip times meet requirements.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      "The test button has its own internal circuit with a resistor. If this component fails, the button may not operate even though the RCD's main function is intact.",
  },
  {
    id: 10,
    question:
      'Why must electricians use calibrated test instruments rather than relying on test buttons?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Calibrated instruments measure disconnection times, apply precise test currents, and test through the actual circuit including the earth path - none of which the test button can do.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'The test button only confirms the internal trip mechanism operates - it creates an internal fault that bypasses the external circuit. Instrument testing verifies the RCD trips within required times AND that the external circuit (including CPCs and earth path) is intact. A broken CPC would not be detected by the test button.',
  },
  {
    question: 'Can I tell the client their RCD is fine after a successful test button press?',
    answer:
      "No. While the test button confirms basic mechanism function, you cannot confirm the RCD meets BS 7671 requirements without instrument testing. The test button doesn't measure trip times or verify the circuit's protective conductor continuity.",
  },
  {
    question: 'How often should the test button be pressed?',
    answer:
      'BS 7671 recommends quarterly (every 3 months) testing by the user. This exercises the mechanical components and provides ongoing verification that basic tripping function is maintained between professional tests.',
  },
  {
    question: "What if the test button doesn't trip the RCD?",
    answer:
      "If pressing the test button doesn't trip the RCD, the unit may be faulty and should not be relied upon for protection. However, first verify the supply is on and the RCD is in the 'on' position. If it still fails, the RCD should be replaced or investigated by a competent person.",
  },
  {
    question: 'Can I use the test button to verify an RCD after replacement?',
    answer:
      'The test button is useful for initial verification that the mechanism operates, but full commissioning must include instrument testing to verify trip times at 1xIdn and 5xIdn, plus functional testing at 1/2xIdn to confirm non-tripping below threshold.',
  },
  {
    question: 'Does the test button apply exactly 30mA on a 30mA RCD?',
    answer:
      'No. The test button applies a current designed to trip the mechanism, typically somewhere between 50% and 100% of Idn. The exact value varies by manufacturer and is not precisely calibrated like test instruments.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Test Button:</strong> Only verifies internal mechanism
              </li>
              <li>
                <strong>Instrument:</strong> Tests complete circuit + times
              </li>
              <li>
                <strong>Frequency:</strong> Users test quarterly
              </li>
              <li>
                <strong>EICR:</strong> Both methods required
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Test Button:</strong> Bypasses external circuit
              </li>
              <li>
                <strong>Instrument:</strong> Includes earth path
              </li>
              <li>
                <strong>Broken CPC:</strong> Only detected by instrument
              </li>
              <li>
                <strong>Trip times:</strong> Only measured by instrument
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The RCD test button creates an internal imbalance by connecting a resistor between
              line and the load side of the current transformer. This simulates an earth fault
              current flowing through the RCD without involving the external circuit.
            </p>
            ...
            <p>
              The test button confirms the sensing and tripping mechanism works but tells you
              nothing about trip times, actual sensitivity, or whether the external protective
              circuit is intact.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              While the test button is a valuable user tool for regular verification, it has
              significant limitations that make it unsuitable as the sole means of RCD verification:
            </p>
            ...
            <div className="my-6 space-y-4">
              <div className="border-l-4 border-red-500 pl-4">
                ...
                <p className="text-white text-sm">
                  No timing capability - just confirms operation.
                </p>
              </div>
              <div className="border-l-4 border-red-500 pl-4">
                <p className="text-red-400 font-semibold">Doesn't Test the Earth Path</p>
                <p className="text-white text-sm">A broken CPC would not be detected.</p>
              </div>
              <div className="border-l-4 border-red-500 pl-4">
                <p className="text-red-400 font-semibold">Uncalibrated Test Current</p>
                <p className="text-white text-sm">Applied current varies by manufacturer.</p>
              </div>
              <div className="border-l-4 border-red-500 pl-4">
                <p className="text-red-400 font-semibold">No Sensitivity Verification</p>
                <p className="text-white text-sm">Cannot determine actual trip threshold.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Professional RCD testing instruments apply precise test currents through the actual
              circuit and measure the disconnection time. This provides comprehensive verification
              that test button testing cannot achieve:
            </p>
            ...
            <div className="my-6 space-y-4">
              <div className="border-l-4 border-emerald-500 pl-4">
                ...
                <p className="text-white text-sm">
                  Confirms compliance with 300ms at 1xIdn, 40ms at 5xIdn.
                </p>
              </div>
              <div className="border-l-4 border-emerald-500 pl-4">
                <p className="text-emerald-400 font-semibold">Tests Through Actual Circuit</p>
                <p className="text-white text-sm">
                  Verifies earth path integrity and CPC continuity.
                </p>
              </div>
              <div className="border-l-4 border-emerald-500 pl-4">
                <p className="text-emerald-400 font-semibold">Calibrated Test Currents</p>
                <p className="text-white text-sm">
                  Applies exact 1xIdn, 5xIdn, and 1/2xIdn currents.
                </p>
              </div>
              <div className="border-l-4 border-emerald-500 pl-4">
                <p className="text-emerald-400 font-semibold">Ramp Testing Capability</p>
                <p className="text-white text-sm">Can determine actual RCD sensitivity.</p>
              </div>
            </div>
          </div>
        </section>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/20">
                    ...
                    <th className="text-center py-2 text-white">Test Button</th>
                    <th className="text-center py-2 text-white">Instrument</th>
                  </tr>
                </thead>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Both testing methods serve important but different purposes and are required at
              different intervals:
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li>
                    <strong>Performed by:</strong> User/occupier
                  </li>
                  <li>
                    <strong>Purpose:</strong> Exercise mechanism, basic verification
                  </li>
                </ul>
              </div>
              <div>
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Instrument Testing (Professional)
                </p>
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Frequency:</strong> Initial verification, periodic inspection
                  </li>
                  <li>
                    <strong>Performed by:</strong> Competent person (electrician)
                  </li>
                  <li>
                    <strong>Purpose:</strong> Full compliance verification
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              During an Electrical Installation Condition Report (EICR), the inspector must perform
              comprehensive RCD testing that includes both methods:
            </p>
            ...
            <p className="text-sm text-amber-300/80">
              <strong>Note:</strong> Relying solely on test button operation would not meet the
              requirements of BS 7671 or the model forms for electrical certification.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>If test button doesn't trip RCD</strong> - treat as serious defect
                </li>
                <li>
                  <strong>Check supply is on</strong> - verify RCD is in 'on' position first
                </li>
                <li>
                  <strong>Recommendation</strong> - RCD should be replaced or investigated
                </li>
              </ul>
            </div>
          </div>
