    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The integral &ldquo;T&rdquo; button is a mechanical functional check — nothing more. What
          each test verifies, where the regulations split the duty, and why the button never
        ...
        >
          <p>
            ...
            the other. The regulation insists on both because both have to be true for the device to
            provide the protection its rating implies.
          </p>
          <p>
            Reg 643.10 has a Note 2 that is often missed: &ldquo;This functional test does not
            replace the functional test indicated by the relevant standards.&rdquo; In other words:
            the integral test button is one functional test; the instrument test required by BS EN
            61557-6 is another functional test; you do both. The note is the reason a competent
            inspector never argues that &ldquo;the button worked, so the device is fine.&rdquo;
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              shall be verified using suitable test equipment according to BS EN 61557-6 (see
              ...
              residual operating current (IΔn): for general non-delay type, 300 ms maximum.
            </>
          }
        ...
        >
          <p>
            ...
            typically slightly above 50 % of IΔn at nominal voltage, calibrated by the manufacturer
            to be sufficient to trip the device but not so high that it stresses the contacts.
          </p>
          <p>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Drift of the device&rsquo;s sensitivity:</strong> the test current is roughly
              fixed by the internal resistor. A device that has drifted sluggish (trips at, say, 35
              mA on a 30 mA rating) will still trip on the button — the internal test current is
              well above 35 mA — and look perfectly fine. The drift only shows up on a ramp test or
              at IΔn instrument test.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="140" y="42" textAnchor="middle" fill="#FBBF24" fontSize="13" fontWeight="bold">
              TEST BUTTON
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="400" y="42" textAnchor="middle" fill="#22C55E" fontSize="13" fontWeight="bold">
              RAMP TEST
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="660" y="42" textAnchor="middle" fill="#3B82F6" fontSize="13" fontWeight="bold">
              TRIP-TIME at IΔn
            </text>
        ...
        >
          ...
          <blockquote className="border-l-4 border-elec-yellow/40 pl-4 italic text-[13.5px] text-white/85 my-2">
            This installation, or part of it, is protected by a device which automatically switches
            off the supply if a fault develops. Test six-monthly by pressing the relevant test
            button(s) which should operate the device. Afterwards, manually switch on the device. If
            the device does not operate, or indicates a fault, seek expert advice.
          </blockquote>
          <p>
            ...
            press-and-reset only — they are not asked to interpret the result, only to call for help
            if the device fails. Third, the same notice can be applied to other user-test devices
            (Note 3 of the regulation): RCBOs, AFDDs with a manually-operated test, integrated
            socket-outlet RCDs (BS 7288).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              part of it, is protected by a device which automatically switches off the supply if a
              fault develops. Test six-monthly by pressing the relevant test button(s) which should
              operate the device. Afterwards, manually switch on the device. If the device does not
              operate, or indicates a fault, seek expert advice.&rsquo; The requirements of this
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              button-only-pass scenario the test button cannot detect on its own. Code C2, recommend
              replacement.
            </li>
            <li>
              <strong className="text-amber-300">
            ...
            <li>
              <strong className="text-red-300">Button does NOT trip, instrument test fails.</strong>{' '}
              Device is comprehensively defective — both the test path AND the main fault path are
              not working. C1 (immediate danger) classification on an EICR; isolate the circuit and
              replace before re-energisation.
            </li>
          </ol>
        </ConceptBlock>
        ...
        <ContentEyebrow>The instrument test — what BS EN 61557-6 actually requires</ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Type S (selective / time-delayed):</strong> between 130 ms minimum and 500 ms
              maximum at IΔn. The minimum exists because Type S is meant to delay so downstream RCDs
              can clear first; if it trips faster than 130 ms it has no selectivity.
            </li>
            <li>
            ...
            <li>
              ...
              for compliance. They remain useful diagnostically (Module 6.3) but are not part of the
              mandatory verification under A4:2026.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              device tripped on press; cross or &ldquo;N&rdquo; if it did not. Reg 643.10 evidence.
            </li>
            <li>
              <strong>RCD operating time at 1×IΔn (ms):</strong> the measured trip time at IΔn from
              the BS EN 61557-6 instrument. Half-cycle worst reading. Reg 643.8 / 643.7.3 evidence.
              Acceptance ≤ 300 ms (non-delay) or 130–500 ms (Type S).
            </li>
            <li>
              <strong>RCD operating current (mA) — ramp:</strong> optional but strongly recommended
              (covered in Module 6.3). The actual mA at which the device trips on ramp.
            </li>
            <li>
              <strong>Comments column:</strong> any anomaly — drift between inspections, button fail
              with instrument pass, instrument fail with button pass, standing leakage noted on the
              circuit. The comments are what the next inspector reads.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            ...
            {
              question: 'Can pressing the test button verify the earth electrode on a TT install?',
              answer:
