    ...
    <HubPage>
      ...
      <HubBody>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              wall/floor must resist fire from one side without spread to the other. Set by Approved
              Document B Vol 2 in England (parallel docs in Wales / Scotland / NI).
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            ...
            <li>
              ...
              basket penetrations. Re-enterable — easy to remove and replace when cables are added
              or changed during the building life. Activated by heat to seal the void. Typical use:
              tray penetrations through compartment walls, riser openings with multiple cable types.
            </li>
            <li>
              <strong>Intumescent sealants and putties.</strong> Acrylic, silicone or putty
              materials that fill small annular gaps around individual cables in core-drilled holes.
              Application depth (typically 25-50 mm) is set by the manufacturer&apos;s tested
              detail. Typical use: 1-6 cable penetrations in a small bore.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              Needs evidence at every fire risk assessment renewal / building inspection / insurance
              review.
            </li>
            <li>
          ...
          <p>
            ...
            specifier; pre-walk every penetration; install using only CE / UKCA-marked products with
            classification reports; photograph every penetration before / during / after; build a
            register linked to cable IDs; hand over the pack at practical completion. The pack is
            the asset.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="60" y="502" fill="#E5E7EB" fontSize="10.5" fontFamily="system-ui">
              DOCUMENT — photos before / during / after, datasheet, classification report → handover
              pack.
            </text>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              is breached. Responsible person carries RRO 2005 liability for the failure; contractor
              carries professional and contractual liability.
            </>
          }
          doInstead={
            <>
              Use only CE / UKCA-marked passive fire-stopping products with a classification report
              (BS EN 13501-2 based on BS EN 1366-3 testing) for the SPECIFIC penetration
              ...
              manufacturer&apos;s tested depth is the typical answer. Document the install with the
              product datasheet, the classification report, and photos before / during / after. Hand
              the pack to the principal contractor or building owner. Specialist intumescent foams
              DO exist and ARE acceptable when CE / UKCA-marked with a classification report — read
              the report; the absence of a classification reference means the product is not
              fire-stopping.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              Pause and check the existing classification report. The original test was for 12 Cat5e
              cables; adding 8 Cat6A changes both the cable count AND the cable type, outside the
              tested envelope. The original classification is invalidated. Three options: (1)
              re-enter the existing seal with a re-enterable system (intumescent pillows / bags)
              rated for 20 cables of the new mixed type, installing per the new manufacturer&apos;s
              tested detail; (2) replace the entire seal with a new tested system rated for the new
              cable count and type; (3) route the 8 new cables through a separate, separately-sealed
              penetration on the same riser. Whichever option, document the change with new photos,
              new datasheet, new classification reference. Update the building&apos;s penetration
              register. Hand the new pack to the responsible person.
            </>
          }
          whyItMatters={
            <>
              ...
              The responsible person&apos;s RRO 2005 compliance is broken at that point, even though
              the original install was correct. The contractor who makes the change carries the
              contractual / professional liability for the breach. Always re-evaluate the seal
