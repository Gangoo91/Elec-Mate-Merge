...
const inlineChecks = [
  {
    ...
    question: 'AC-coupled vs DC-coupled hybrid PV+BESS — what are the architectural differences?',
    options: [
...
const quizQuestions = [
  ...
  {
    id: 4,
    question: 'Customer asks: &ldquo;What about Tesla Powerwall — is it AC or DC coupled?&rdquo;',
    options: [
...
export default function RenewableEnergyModule4Section4() {
  ...
  useSEO({
    title: 'Hybrid PV + BESS topologies | Renewable Energy 4.4 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 4 · BS 7671:2018+A4:2026"
        title="Hybrid PV + BESS topologies"
        backTo="../renewable-energy-module-4"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          AC-coupled vs DC-coupled architectures, round-trip efficiency, UK brand landscape
          (GivEnergy / Tesla / Sigenergy / SolarEdge / Enphase), Reg 570.5.2 PCE selection (Chapter
          57 NEW A4:2026), BS EN IEC 62485 series, and the retrofit vs new-build design decision.
        </p>
        ...
        <Pullquote>
          DC-coupled for new-build. AC-coupled for retrofit. Both authorised by Reg 570.5.2.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Two PCEs</strong> — separate PV inverter + battery
              inverter. Each PCE has its own MPPT, AC output, monitoring, warranty
            </li>
            <li>
              <strong className="text-white">Conversion stages</strong> — PV DC → AC (PV inverter) →
              DC battery (battery inverter charging) → AC (battery inverter discharging) → load.
              Each stage ~95-97% efficient
            </li>
            <li>
              <strong className="text-white">Retrofit-friendly</strong> — existing PV inverter stays
              in place; existing EREC / MCS / DNO documentation continues to apply; install time
              short (battery + cabling only)
            </li>
            <li>
              <strong className="text-white">Component count higher</strong> — two PCEs, two AC
              isolators, more cabling, two sets of monitoring
            </li>
            <li>
              <strong className="text-white">Failure isolation</strong> — PV continues to operate if
              battery inverter fails (and vice versa). Some redundancy benefit
            </li>
            <li>
              <strong className="text-white">Microinverter ecosystem</strong> — Enphase IQ7 + IQ
              Battery is inherently AC-coupled (no DC bus at all)
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Single PCE</strong> — one hybrid inverter handles PV
              MPPT, battery charging/discharging, AC inversion to grid + load
            </li>
            <li>
              <strong className="text-white">Conversion stages</strong> — PV DC → DC battery
              (direct, no AC stage). Saves one conversion stage round-trip. Discharge path: battery
              DC → AC (single conversion) → load
            </li>
            <li>
              <strong className="text-white">New-build friendly</strong> — install designed from
              scratch with hybrid inverter. Cleanest architecture; lowest component count
            </li>
            <li>
              <strong className="text-white">Component count lower</strong> — single PCE, fewer AC
              isolators, less cabling, unified monitoring app
            </li>
            <li>
              <strong className="text-white">Single point of failure</strong> — hybrid inverter
              failure takes both PV and battery offline. Mitigation: warranty + service contract
            </li>
            <li>
              <strong className="text-white">Tight integration</strong> — hybrid inverter\'s logic
              decides power-flow priorities internally (PV → battery → load → grid). No AC-bus
              conflicts
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Chapter 57 explicitly recognises hybrid inverters and both coupling modes.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Battery type compatibility</strong> — PCE must match
              battery chemistry (LFP / NMC / lead-acid / etc.); charge / discharge profiles; voltage
              range
            </li>
            <li>
              <strong className="text-white">Application suitability</strong> — residential vs
              commercial; cycle frequency; load profile; grid-tied vs off-grid
            </li>
            <li>
              <strong className="text-white">Battery manufacturer instructions</strong> — specific
              BMS protocol (CAN bus / Modbus); approved PCE list; warranty conditions
            </li>
            <li>
              <strong className="text-white">Hybrid inverter recognition (NOTE 1)</strong> —
              &ldquo;PCE for stationary battery installations may be incorporated into PCE for
              renewable generation, for example, solar PV system inverters (sometimes termed
              &lsquo;bidirectional&rsquo; or &lsquo;hybrid&rsquo; inverters)&rdquo;
            </li>
            <li>
              <strong className="text-white">Coupling mode recognition (NOTE 2)</strong> —
              &ldquo;PCE may be used to connect batteries to AC systems (sometimes termed &lsquo;AC
              coupling&rsquo;) or DC systems (sometimes termed &lsquo;DC coupling&rsquo;)&rdquo;
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Reg 570.6.1.1.1 / .1.2 / .2.1 — BESS installation requirements
        </ContentEyebrow>

        <Pullquote>
          BS EN IEC 62485 conformance. Terminal V always present. DC earthing permitted with simple
          separation.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 570.6.1.1.1</strong> — BS EN IEC 62485 series
              conformance; bidirectional protective devices where appropriate. Battery PCE OCPDs
              bidirectional (parallels Reg 712.533.101 for PV)
            </li>
            <li>
              <strong className="text-white">Reg 570.6.1.1.2</strong> — battery terminal voltage
              shall be assumed always present. BESS DC isolator at battery terminals; safe
              maintenance per BS EN IEC 62485
            </li>
            <li>
              <strong className="text-white">Reg 570.6.1.2.1</strong> — DC live-conductor earthing
              permitted with simple separation between AC and DC sides. Mirrors Reg 712.312.2 for
              PV. For DC-coupled hybrid: the shared DC bus (PV + BESS) earthing under this provision
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Reg 570.6.1.2.2 / 570.6.3 / 570.6.4 — single-point earthing, ventilation, fault current
        </ContentEyebrow>

        <Pullquote>
          Single-point earthing for TN-S/TT. Ventilate to BS EN IEC 62485. Fault current = battery +
          PCE.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Why single-point</strong> — multiple earth connections
              on the DC side create parallel return paths; current splits between them; earth-fault
              sensing becomes unreliable; corrosion on long DC runs is amplified
            </li>
            <li>
              <strong className="text-white">Where the point goes</strong> — the manufacturer
              specifies. Common: internal to the hybrid inverter (factory-bonded); at the battery
              PCE&rsquo;s DC- input; at the DC distribution combiner. The PEI design pack records
              the location
            </li>
            <li>
              <strong className="text-white">TN-S derivation in UK domestic</strong> — DNO supply is
              TN-C-S; consumer unit has the N-E link; downstream is effectively TN-S. The BESS DC
              side is earthed once, at the manufacturer-specified point
            </li>
            <li>
              <strong className="text-white">TT installs</strong> — own earth electrode; the BESS DC
              single point bonds to the install&rsquo;s earth bar / MET
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — records the DC earthing
              arrangement + the single-point location
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">BS EN IEC 62485-1</strong> — general safety
              requirements
            </li>
            <li>
              <strong className="text-white">BS EN IEC 62485-2</strong> — stationary batteries
              (lead-acid + VRLA + NiCd specifics)
            </li>
            <li>
              <strong className="text-white">BS EN IEC 62485-5</strong> — lithium-ion stationary
              batteries (the relevant standard for UK domestic LFP)
            </li>
            <li>
              <strong className="text-white">PAS 63100:2024</strong> — UK domestic-specific install
              spec; covers placement, ventilation, fire safety, signage. Critical for UK installs
            </li>
            <li>
              <strong className="text-white">Lithium-ion specifics</strong> — no gas under normal
              operation; thermal-runaway scenarios produce CO, HF, flammable hydrocarbons. PAS 63100
              mandates clear escape routes, no installation in habitable spaces, minimum clearances
              from windows / doors
            </li>
            <li>
              <strong className="text-white">Lead-acid / VRLA specifics</strong> — hydrogen emission
              during equalisation charges; ventilation calculation per BS EN IEC 62485-2 Annex A;
              explosion-proof fittings within hazardous zone
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — records battery
              chemistry + install location + ventilation arrangement + PAS 63100 compliance + BS EN
              IEC 62485 series cross-references
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">DC side fault contribution from battery</strong> —
              multi-kAh LFP pack can deliver 10-30 kA prospective short-circuit current for
              milliseconds. DC OCPDs must be rated for this (typically NH-style DC fuses or specific
              DC-rated MCBs per BS EN 60898-2 / IEC 60898-3)
            </li>
            <li>
              <strong className="text-white">AC side fault contribution from PCE</strong> — PCE
              current-limits at ~1.1-1.5 &times; I_n on its own; under fault with DNO present,
              combined contribution applies
            </li>
            <li>
              <strong className="text-white">
                Bidirectional OCPDs (Reg 570.6.1.1.1 + 826.1.2.2)
              </strong>{' '}
              — every BESS OCPD must operate to trip on overcurrent regardless of current direction
            </li>
            <li>
              <strong className="text-white">Selectivity / coordination</strong> — Reg 826.6
              (Section 4.5) — fault current contributions combined across multiple sources analysed
              per operating mode
            </li>
            <li>
              <strong className="text-white">Manufacturer datasheets</strong> — battery I_SC, PCE
              fault contribution. Required for the design pack analysis
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — records the fault
              current analysis + each OCPD selection + the coordination evidence
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          GivEnergy + Solis + Sigenergy dominate UK new-build hybrid. Tesla + Enphase + SolarEdge
          dominate retrofit.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">GivEnergy</strong> — UK-designed and -manufactured
              (Newark, England); Gen3 hybrid range (3-15 kW AC); LFP battery pairing; popular for UK
              new-build; strong app + integration ecosystem
            </li>
            <li>
              <strong className="text-white">Solis (Ginlong)</strong> — Chinese OEM; Hybrid S6
              range; widely used by UK installers; competitive pricing
            </li>
            <li>
              <strong className="text-white">Sigenergy SigenStor</strong> — premium tier; modular
              design; LFP battery; strong telemetry; growing UK presence
            </li>
            <li>
              <strong className="text-white">Huawei LUNA</strong> — established global brand; LUNA
              2000 BESS + SUN2000 hybrid inverter; UK service network
            </li>
            <li>
              <strong className="text-white">FoxESS Hybrid</strong> — value tier; LFP battery;
              popular among cost-conscious installers
            </li>
            <li>
              <strong className="text-white">SolarEdge Energy Hub</strong> — optimiser-ecosystem
              hybrid; DC-coupled battery + optimisers + Energy Hub inverter; tight integration with
              existing SolarEdge installs
            </li>
            <li>
              <strong className="text-white">Tesla Powerwall 3 (DC-coupled mode)</strong> — modern
              flagship; 11.5 kW continuous AC output; integrated MPPT; premium pricing
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Tesla Powerwall 2</strong> — AC-coupled-only
              (2016-2024); pairs with any existing PV inverter via Tesla Gateway 2; ~13.5 kWh usable
              per unit; mature product
            </li>
            <li>
              <strong className="text-white">Tesla Powerwall 3</strong> — supports BOTH AC-coupled
              and DC-coupled modes (2024+); mode chosen at install; premium price
            </li>
            <li>
              <strong className="text-white">Enphase IQ Battery</strong> — AC-coupled-only by
              ecosystem design (Enphase microinverter PV); pairs with IQ7/IQ8 microinverter
              installs; IQ Gateway orchestration
            </li>
            <li>
              <strong className="text-white">GivEnergy AC battery</strong> — retrofit option from
              GivEnergy ecosystem; pairs with any existing PV inverter brand; uses GivEnergy app
            </li>
            <li>
              <strong className="text-white">SolarEdge AC battery</strong> — retrofit option for
              SolarEdge HD-Wave / Energy Hub installs; AC-coupled when DC-coupled retrofit isn\'t
              feasible
            </li>
            <li>
              <strong className="text-white">Sungrow / Sonnen / Senec</strong> — niche UK presence;
              specific feature sets (Sonnen virtual power plant participation, etc.)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          New-build: DC-coupled hybrid. Retrofit: AC-coupled. Both authorised by Reg 570.5.2.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">New-build vs retrofit</strong> — new-build → DC-coupled
              (modern default); retrofit → AC-coupled (preserve existing inverter)
            </li>
            <li>
              <strong className="text-white">Brand ecosystem</strong> — existing Tesla Solar Roof →
              Powerwall (AC or DC depending on Powerwall version); existing Enphase → IQ Battery
              AC-coupled; existing SolarEdge → Energy Hub DC-coupled retrofit or AC battery
            </li>
            <li>
              <strong className="text-white">Cycle frequency</strong> — high-cycling (commercial,
              grid-services, EV+PV+BESS) → DC-coupled efficiency advantage matters; low-cycling
              (residential daily) → smaller absolute difference
            </li>
            <li>
              <strong className="text-white">Capital cost</strong> — DC-coupled hybrid + matched LFP
              typically ~£1,000-£2,000 less than AC-coupled retrofit with same kWh capacity
            </li>
            <li>
              <strong className="text-white">Install time</strong> — retrofit AC-coupled: 1-2 days;
              new-build DC-coupled: 3-5 days (PV + BESS together)
            </li>
            <li>
              <strong className="text-white">Failure isolation</strong> — AC-coupled: PV survives
              battery PCE failure; DC-coupled: hybrid inverter failure takes both offline. Warranty
              + service contract mitigates
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-4-section-3')}
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-4-section-5')}
