...
const inlineChecks = [
  {
    ...
    options: [
      'They must be marked.',
      'They must be ADEQUATELY ILLUMINATED at all material times. Article 14(2)(h) is the operative clause: emergency routes and exits requiring illumination shall be provided with emergency lighting of adequate intensity in case the lighting fails. The duty is on the responsible person, and "adequate" is defined in practice by BS 5266-1 / BS EN 1838.',
      'They must be 1 metre wide.',
      'They must have signs only.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'MAINTENANCE in efficient working order. Article 17 requires that any facilities, equipment or devices provided in respect of the premises (including emergency lighting) are subject to a suitable system of maintenance and are maintained in an efficient state, in efficient working order, and in good repair. The maintenance regime — monthly functional, annual duration, 5-year photometric — is the practical expression of this duty.',
      'Replacement every 5 years.',
      'Insurance only.',
    ],
    correctIndex: 1,
    explanation:
      'RRO 2005 Article 17 turns the design obligation (Article 14) into an ongoing operational obligation. Emergency lighting must work — not just on the day of commissioning, but throughout its life. The maintenance regime under BS 5266-1 / BS EN 50172 implements Article 17 in technical terms.',
  },
  {
    id: 'elm6-s2-fsa2021',
    question: 'The Fire Safety Act 2021 clarified the RRO scope. What did it add?',
    options: [
      'New illuminance levels.',
      'Explicit confirmation that the RRO 2005 applies to the EXTERNAL WALLS, BALCONIES, FLAT ENTRANCE DOORS and STRUCTURE of multi-occupied residential buildings. The Act was a direct response to the Grenfell Tower fire and removed the legal ambiguity about whether the RRO covered the building fabric of blocks of flats. Emergency lighting in common parts is in scope; the RP must include it in the FRA.',
      'Created a new offence.',
      'Replaced the RRO entirely.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Any building.',
      'Residential buildings of at least 18 m or at least 7 storeys, with at least 2 residential units. The Act creates the Building Safety Regulator (BSR), the Accountable Person duty holder, the safety case regime, the resident engagement strategy, and the "golden thread" of digital information. Emergency lighting is part of the safety case — the safety-critical systems must be evidenced and maintained.',
      'Buildings over 100 m only.',
...
const quizQuestions = [
  {
    ...
    options: [
      'Article 8.',
      'Article 14 — Emergency routes and exits. Specifically Article 14(2)(h): emergency routes and exits requiring illumination shall be provided with emergency lighting of adequate intensity in case the lighting fails. The duty falls on the responsible person; "adequate" is defined in practice by BS 5266-1 / BS EN 1838:2024.',
      'Article 25.',
      'Article 38.',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Annual inspection only.',
      'MAINTENANCE in efficient working order. Article 17 requires the responsible person to ensure that any facilities, equipment and devices (including emergency lighting) are subject to a suitable system of maintenance and are maintained in an efficient state, in efficient working order, and in good repair. BS 5266-1 / BS EN 50172 sets out the practical maintenance regime that satisfies the Article 17 duty.',
  ...
  },
  {
    ...
    options: [
      'Fine only.',
      'UNLIMITED FINE and/or imprisonment for up to 2 years (Article 32). Lesser offences carry summary penalties (level 5 fine and/or 6 months imprisonment). The penalties apply where a failure to comply places one or more relevant persons at risk of death or serious injury. Corporate offenders face the unlimited fine; individuals face fine and/or imprisonment.',
      'Verbal warning.',
      '£500 fine.',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'New illuminance levels.',
      'Express confirmation that the RRO 2005 applies to the structure, external walls, balconies, flat entrance doors and any common parts of buildings containing 2 or more sets of domestic premises. A direct response to the Grenfell Tower fire and the Hackitt Review, removing legal doubt about RRO scope in multi-occupied residential buildings. Emergency lighting in common parts is firmly in scope.',
      'Replaced the RRO entirely.',
      'Repealed Article 14.',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Any flat.',
      'Residential buildings AT LEAST 18 m IN HEIGHT or AT LEAST 7 STOREYS, containing AT LEAST 2 residential units. The threshold is OR, not AND — either height or storey count plus the unit count brings a building into the HRB regime. The regime imposes the Accountable Person duty holder, the safety case, the golden thread of digital information, and the Building Safety Regulator (BSR) oversight.',
      '50 m only.',
      '100 m only.',
    ],
    correctAnswer: 1,
    explanation:
      'BSA 2022 HRB threshold: ≥ 18 m OR ≥ 7 storeys, with ≥ 2 residential units. Emergency lighting in HRBs forms part of the safety case the Accountable Person must build and maintain.',
  },
  {
    id: 6,
    ...
    options: [
      'Section 1 only.',
      'Section 5 — Means of escape. Approved Document B Volume 2 (buildings other than dwellinghouses) §5 sets out the means of escape requirements, including where emergency lighting is required by the Building Regulations. The actual technical specification cross-references BS 5266-1. The Building Regulations and the RRO 2005 work together — the Building Regulations apply at construction or material alteration; the RRO applies in occupation.',
      'Annex only.',
      'Not addressed.',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'It is the primary emergency lighting standard.',
      'BS 9999 is the Code of Practice for fire safety in the design, management and use of buildings. It is a fire engineering document — it sets out an integrated approach to evacuation strategy, fire engineering and management. Emergency lighting is one element of the integrated solution. BS 9999 may set design illuminance, switch-on or duration requirements that exceed the BS 5266-1 / EN 1838 minima where the building risk profile justifies it.',
      'It replaces BS 5266-1.',
  ...
  },
  {
    ...
    options: [
      'Battery sharing only.',
      'CAUSE-AND-EFFECT — some installations include emergency lighting actions (early activation, refuge-call lighting, high-risk task lighting activation) in the fire alarm cause-and-effect. The two systems remain separate but their interactions are documented. Common power-supply infrastructure (UPS, central battery) and integrated monitoring may also be common. The cross-reference matters at design stage and at handover.',
      'They are the same system.',
      'No cross-reference.',
    ],
    correctAnswer: 1,
    explanation:
      'BS 5266-1 and BS 5839-1 describe two separate safety services that often share infrastructure and respond together. The cause-and-effect document records the interactions. The cross-reference is documented at design and verified at commissioning.',
  },
  {
    id: 9,
    ...
    options: [
      'HSE.',
      'The Fire and Rescue Service (FRS) for the area in which the premises is located — typically through the Fire Safety inspecting officer. The FRS has powers under Article 27 to enter premises, inspect documentation, and serve enforcement, alterations and prohibition notices. In addition, the BSR has oversight of HRBs under the Building Safety Act 2022; the HSE has overlap where emergency lighting is part of a workplace health and safety question.',
  ...
  },
  {
    ...
    options: [
      'Compliant.',
      'NON-COMPLIANT. The emergency lighting design must be DERIVED FROM the fire risk assessment. The FRA identifies escape routes, high-risk areas, sleeping risk, refuges, place of ultimate safety. The emergency lighting then provides for each. A design that pre-dates the FRA cannot have been derived from it; the design must be revisited against the FRA outputs and adjusted. Section 3 of this module deals with this in depth.',
      'Compliant if BS 5266-1 was followed.',
      'Compliant if luminaires meet 1 lx.',
    ],
    correctAnswer: 1,
    explanation:
      'BS 5266-1:2025 §5 makes the FRA-to-design relationship explicit. The FRA is the input to the design, not a downstream paperwork exercise. A design that pre-dates the FRA, or that ignores the FRA, fails the §5 requirement and fails the underlying RRO Article 9 (risk assessment) duty.',
  },
];
