...
const inlineChecks = [
  ...
  },
  {
    id: 'elm6-s2-bsa2022',
    question:
      'The Building Safety Act 2022 introduced a new regulatory regime for "higher-risk buildings". What is the threshold?',
    options: [
...
const quizQuestions = [
  ...
  {
    id: 4,
    question: 'What did the Fire Safety Act 2021 add to the RRO 2005?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'The Building Safety Act 2022 introduced higher-risk buildings (HRBs). What is the threshold?',
    options: [
  ...
  {
    id: 8,
    question: 'BS 5839-1:2025 (fire alarm) cross-references emergency lighting in what context?',
    options: [
  ...
  },
  {
    id: 10,
    question:
      'A commercial building has had its fire risk assessment, but the emergency lighting was designed before the FRA was commissioned. Is this compliant?',
    options: [
...
const EmergencyLightingModule6Section2 = () => {
  ...
  useSEO({
    title: 'EL integration with fire safety regs | Emergency Lighting Module 6.2 | Elec-Mate',
    description:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Emergency lighting is not a stand-alone obligation. It sits inside a chain of fire safety
          legislation — the Health and Safety at Work etc. Act 1974, the Regulatory Reform (Fire
          Safety) Order 2005, the Fire Safety Act 2021, the Building Safety Act 2022, the Building
          Regulations and the supporting British Standards. This section walks the chain and shows
          how the duties interlock.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Primary legislation (Acts of Parliament).</strong> HSAW 1974, Fire Safety Act
              2021, Building Safety Act 2022. Each is an Act of Parliament passed at Westminster.
              They impose general duties and create offences.
            </li>
            <li>
              <strong>Secondary legislation (Statutory Instruments).</strong> RRO 2005 (made under
              HSAW), the Building Regulations 2010 (made under the Building Act 1984), the Building
              Safety Regulations under BSA 2022. Each is a Statutory Instrument with detailed
              binding provisions.
            </li>
            <li>
              <strong>Approved Documents.</strong> Approved Document B Volume 2 (means of escape in
              non-dwellings), other Approved Documents under the Building Regulations. Approved
              Documents are not statute but are the recognised practical guidance — they tell you
              how to comply with the binding Regulations.
            </li>
            <li>
          ...
          <p>
            The chain is hierarchical. A British Standard cannot reduce a statutory obligation; it
            can only describe how to meet or exceed it. A design departing from BS 5266-1 must still
            meet the underlying RRO Article 14 duty, demonstrated by evidence-based risk assessment.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Article 14(1) — general principle.</strong> The RP must ensure that routes to
              emergency exits, and the exits themselves, are kept clear at all times.
            </li>
            <li>
              <strong>Article 14(2) — specific requirements.</strong> A list of operational
              requirements — number, location, dimensions, signage, and at (h), emergency lighting
              of adequate intensity for routes / exits requiring illumination.
            </li>
            <li>
              <strong>"Adequate" defined by code of practice.</strong> The RRO does not specify lux
              levels; it relies on BS 5266-1 / BS EN 1838 to define adequate. A duty holder claiming
              compliance with Article 14(2)(h) is implicitly claiming compliance with the relevant
              British Standards unless an evidenced equivalent is provided.
            </li>
            <li>
              ...
              Most non-domestic premises require emergency lighting on all escape routes; some small
              low-risk premises may not require any. The FRA decides; the design implements.
            </li>
            <li>
              ...
              person at risk of death or serious injury. Penalties: unlimited fine and / or 2 years
              on indictment; level 5 fine and / or 6 months summarily.
            </li>
          </ul>
          <p>
            Article 14 is therefore the legal hook on which the entire BS 5266-1 regime hangs. Get
            the lighting wrong, and the regulator does not need to prove a BS 5266-1 breach — only
            that the lighting was inadequate, and that the inadequacy placed a person at risk.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              provided with emergency lighting of adequate intensity in the case of failure of their
              normal lighting.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>5-year photometric verification (NEW 2025).</strong> In-service measurement of
              illuminance against design. Catches LED depreciation, surface changes, luminaire
              substitution. Not a replacement for annual tests; an addition.
            </li>
            <li>
            ...
            <li>
              ...
              non-compliance if it is followed by prompt remediation and re-test. A failed test left
              unremediated is non-compliance with Article 17.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              provided in respect of the premises under this Order or under any other enactment,
              including any enactment repealed or revoked by this Order, are subject to a suitable
              system of maintenance and are maintained in an efficient state, in efficient working
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Article 23 — Provisions for employees.</strong> Where dangerous substances are
              present, or where the workplace presents particular risks, additional measures
            ...
            <li>
              <strong>Article 27 — Powers of inspectors.</strong> The FRS Fire Safety officer may,
              at any reasonable time: enter premises; carry out inspections; require the production
              of records (logbook, certificates, FRA); take samples; require persons to provide
              information. Refusal or obstruction is itself an offence under Article 32.
            </li>
            <li>
              <strong>Article 32 — Offences and penalties.</strong> The offence: failing to comply
              with Articles 8 to 22 (the safety duties) where the failure places a relevant person
              at risk of death or serious injury. Other offences: failing to comply with notices
              (alterations, enforcement, prohibition); making false statements; obstructing
              inspectors. Penalties: summary — level 5 fine (unlimited in magistrates' court since
              2015) and / or 6 months imprisonment; on indictment — unlimited fine and / or 2 years
              imprisonment.
            </li>
            <li>
              <strong>Notices the FRS may serve.</strong> Alterations notice (Article 29) — used
              where alterations to the building may significantly increase risk; the RP must notify
              the FRS before making the alteration. Enforcement notice (Article 30) — where the FRS
              finds non-compliance and requires specific actions within a stated time. Prohibition
              notice (Article 31) — where the FRS finds imminent risk of harm and prohibits further
              use until remedied.
            </li>
          </ul>
          <p>
            Article 32 is the consequence-of-failure clause. It is referenced when prosecuting after
            a fire that causes harm, and it carries unlimited fines that have, in some recent cases,
            exceeded £1 million. Emergency lighting failures contribute to prosecutions where they
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Common parts emergency lighting in scope.</strong> Stairs, lobbies, corridors,
              communal entrance halls, plant rooms, refuse rooms — all in scope. The FRA must cover
              them; the design must comply with BS 5266-1; the maintenance must comply with Article
              17.
            </li>
            <li>
            ...
            <li>
              <strong>External walls in scope.</strong> Where external walls form part of an escape
              route (external stairs, balcony evacuation routes), emergency lighting must provide
              for them. The Act did not change BS 5266-1, but the scope clarification means
              installations that may have been incomplete (no external escape lighting on balcony
              routes, for example) need remediation.
            </li>
            <li>
              <strong>Existing buildings caught.</strong> The Act applies to existing buildings from
              its commencement, not just new builds. RPs of blocks of flats had to revisit their
              FRAs and emergency lighting provision once the Act came into force.
            </li>
            <li>
              <strong>Interaction with BSA 2022 HRBs.</strong> Where a building also meets the BSA
              2022 HRB threshold, both regimes apply — the RRO via the Fire Safety Act and the BSA
              HRB regime. The Accountable Person must satisfy both.
            </li>
          </ul>
          <p>
            The Act did not create new technical standards. It clarified what the RRO already
            applied to. For the duty holder, the question changed from 'is this in scope?' to 'does
            this comply?' — and the BS 5266-1 / BS EN 1838 answer is the same as before.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              threshold is OR — a 7-storey building under 18 m still qualifies; an 18 m building of
              5 storeys still qualifies.
            </li>
            <li>
              <strong>Accountable Person (AP).</strong> The duty holder for a part of the HRB.
              Typically the building owner or freeholder for the structure and common parts; may be
              a managing agent or RMC for managed parts.
            </li>
            <li>
              <strong>Principal Accountable Person (PAP).</strong> Where there are multiple APs, the
              PAP is the one with control over the structure and external walls. The PAP
              co-ordinates the safety case across all APs.
            </li>
            <li>
              <strong>Safety case.</strong> A documented case showing how building safety risks are
              identified, mitigated and managed throughout the building's life. Emergency lighting
              evidence — design rationale, photometric calculations, commissioning certificates,
              maintenance records, 5-year verification certificates — sits within the safety case.
            </li>
            <li>
              ...
              logbook entries are all golden-thread items. Paper-only records are insufficient for
              HRBs.
            </li>
            <li>
            ...
            <li>
              ...
              inspection, demand for information, enforcement notices, prosecution. Sits within the
              HSE structure.
            </li>
          </ul>
          <p>
            For emergency lighting, HRB designation does not change the technical standards — BS
            5266-1 / BS EN 1838 / BS EN 50172 still apply. What it changes is the documentation and
            evidence regime. Records must be digital, accessible, current, and demonstrably linked
            to the building's safety case.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              residential units, and is at least 18 metres in height or has at least 7 storeys. The
              Secretary of State may, by regulations, amend the meaning of higher-risk building.
              Provisions of the Act relating to higher-risk buildings, including the Accountable
              Person duties and the safety case regime, apply to a higher-risk building from the
              date of its registration with the regulator.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              appropriate provisions for the early warning of fire, and appropriate means of escape
              in case of fire from the building to a place of safety outside the building capable of
              being safely and effectively used at all material times.'
            </li>
            <li>
              <strong>Approved Document B Volume 2 §5 — means of escape.</strong> Practical guidance
              on how to meet B1. §5.36 onwards (numbering varies by edition) addresses escape
              lighting — when required, where required, performance standards.
            </li>
            <li>
              <strong>Cross-reference to BS 5266-1.</strong> ADB Volume 2 §5 typically says 'escape
              lighting should comply with BS 5266-1' — meaning the Building Regulations duty is met
              by following BS 5266-1. This is a one-way reference: BS 5266-1 is the
              deemed-to-satisfy means of compliance, not a separate legal requirement.
            </li>
            <li>
              <strong>Trigger — when EL is required.</strong> Triggers vary by building type, size,
              occupancy, escape distance. Larger buildings, sleeping risk buildings, places of
              assembly, and any building with significant escape distance need EL. Small,
              low-occupancy, single-storey buildings may not.
            </li>
            <li>
              <strong>Building Control sign-off at completion.</strong> The Building Control Body
              (Local Authority Building Control or Approved Inspector) checks B1 compliance at
              completion. Emergency lighting is part of this check; non-compliance prevents
              completion certification.
            </li>
            <li>
              <strong>Material alterations.</strong> A material alteration to an existing building —
              e.g. a change of use, a major refurbishment, an extension — re-engages B1. Emergency
              lighting that was compliant under the previous regime may need upgrading.
            </li>
          </ul>
          <p>
            The Building Regulations regime catches the building at construction; the RRO regime
            catches the building in occupation. Both apply throughout the life of the building, but
            Building Regulations is the active obligation only at construction or material
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              progressive horizontal, or stay-put evacuation. The strategy affects where emergency
              lighting must operate (and for how long). Phased evacuation in a tall building
              requires emergency lighting able to operate continuously over the phased duration, not
              just 3 h.
            </li>
            <li>
              <strong>Fire engineering.</strong> BS 9999 supports performance-based fire engineering
              as an alternative to prescriptive ADB compliance. Where fire engineering trades off
              one element against another (e.g. wider stairs against shorter travel distance),
              emergency lighting may need to be enhanced to support the engineered case.
            </li>
            <li>
            ...
            <li>
              ...
              illuminance, faster switch-on), the higher standard applies. The minimum is just that
              — a floor.
            </li>
          </ul>
          <p>
            In simpler buildings, BS 9999 is informational; the design proceeds to ADB and BS
            5266-1. In complex or fire-engineered buildings, BS 9999 is the strategic backbone;
            emergency lighting is one workstream within it.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Early activation on fire alarm.</strong> Some installations switch emergency
              lighting from normal-mode to emergency-mode on fire alarm activation, ahead of any
              mains failure. Ensures full output at the moment of evacuation. Documented in
              cause-and-effect.
            </li>
            <li>
            ...
            <li>
              <strong>Common power infrastructure.</strong> Some installations share UPS or central
              battery between fire alarm and emergency lighting. Battery sizing, duration and
              maintenance must satisfy both standards independently.
            </li>
            <li>
              <strong>Test co-ordination.</strong> Annual full-duration emergency lighting tests may
              be co-ordinated with fire alarm full system tests. The combined test schedule is part
              of the maintenance plan.
            </li>
            <li>
              <strong>Evidence trail.</strong> Cause-and-effect document, fire alarm test records
              and emergency lighting test records together evidence the integrated system. Missing
              any one element breaks the chain.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Fire and Rescue Service (FRS) — RRO 2005.</strong> Powers under Article 27:
              entry, inspection, document demand, sample-taking, information demand. Notices under
              Articles 29 (alterations), 30 (enforcement), 31 (prohibition). Prosecution under
              Article 32. The primary emergency-lighting enforcement body in occupied premises.
            </li>
            <li>
              <strong>Building Safety Regulator (BSR) — BSA 2022.</strong> Regulates HRBs. Powers:
              registration, safety case approval, audit, enforcement notices, prohibition,
              prosecution. Sits within the HSE. Emergency lighting evidence in HRBs falls within BSR
              scope as part of the safety case.
            </li>
            <li>
              ...
              prosecution. Overlap with FRS where emergency lighting failure relates to a workplace
              health and safety question (e.g. operator harm during process shutdown).
            </li>
            <li>
              <strong>Local Authority Building Control (LABC) — Building Regulations.</strong>
              Approves construction work, audits compliance, refuses completion certification where
              non-compliant. Approved Inspectors have similar powers in private practice. Engaged at
              new build and material alteration; not continuously.
            </li>
            <li>
              <strong>Insurers — commercial pressure.</strong> Not a statutory enforcement body, but
              commercial insurance is conditional on standards compliance. Non-compliance can void
              cover or load premiums. Insurer audits often align with FRS and BSR requirements but
              may go further (e.g. insisting on automated test systems for large installations).
            </li>
            <li>
          ...
          <p>
            For a typical commercial building, the primary enforcement interaction is with the FRS.
            For an HRB, both FRS and BSR are engaged. For a workplace where employees operate
            dangerous machinery, HSE may also be relevant. The duty holder should map the bodies for
            their building and maintain documentary evidence accessible to all of them.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              5(3) to: fail to comply with the requirements of Articles 8 to 22 or Article 38 where
              that failure places one or more relevant persons at risk of death or serious injury in
              case of fire. A person guilty of an offence under this Article is liable on summary
              conviction to a fine not exceeding the statutory maximum and / or imprisonment for a
              term not exceeding 6 months; on conviction on indictment, to a fine and / or
        ...
        <FAQ
          items={[
            ...
            {
              question:
                'What is the practical difference between the RRO regime and the Building Regulations regime for emergency lighting?',
              answer:
            ...
            {
              question:
                'What happens if the FRS finds emergency lighting non-compliance during an audit?',
              answer:
        ...
        <Quiz title="Integration with fire safety regs — Module 6.2" questions={quizQuestions} />
