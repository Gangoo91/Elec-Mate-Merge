    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Spacing, element offset, void detection and the new obstacle rule. The geometry of
          detector placement is a small set of numbers that, once held in mind, drives every
          flat-ceiling, beam-ceiling and void-ceiling design under BS 5839-1:2025.
        </p>
        ...
        >
          ...
          <p>
            ...
            equivalent smoke design. This cost differential — combined with the 2025 prohibition on
            heat detectors in sleeping rooms — has further accelerated the move to multi-sensor
            (which uses the smoke-detector spacing where the smoke element is the primary trigger).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              in the protected area to the nearest detector does not exceed: 7.5 m for smoke
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>25 mm minimum (smoke and heat).</strong> A static boundary layer exists at the
              ceiling surface where smoke and heat flow are impeded. An element hard against the
              ceiling sees this dead-zone air. 25 mm offset puts the element below the boundary
              layer, in the active flow region.
            </li>
            <li>
            ...
            <li>
              <strong>150 mm maximum (heat).</strong> Heat dissipates with distance from the ceiling
              much faster than smoke does. A heat detector hung 600 mm below the ceiling may be in
              air whose temperature has dropped well below the response point even when the ceiling
              itself is hot. The 150 mm tighter limit reflects this.
            </li>
            <li>
              <strong>Common installation errors.</strong> RECESSED detectors fitted flush with the
              ceiling face — element is at 0-15 mm offset, in the dead zone. PENDANT-MOUNTED heat
              detectors hung from a long pendant — element exceeds 150 mm. BOTH are non-compliant
              with clause 21.2.4 and should be picked up at commissioning.
            </li>
          </ul>
          <p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              ...
              <text x="200" y="455" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="10">
            ...
            <g>
              ...
              <text x="600" y="455" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="10">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              STRUCTURAL CEILING (the upper boundary of the void), with the sensitive element in the
              TOP 125 mm of the void. The void is too shallow to develop a meaningful smoke
            ...
            <li>
              ...
              structural ceiling with the sensitive element in the TOP 10 PERCENT of the void depth.
              For a 1.5 m void, that is the top 150 mm. The 10 percent rule scales the element
              position to the void depth.
            </li>
            <li>
              <strong>Void more than 1.5 m deep.</strong> Treat the void as a NORMAL-HEIGHT ROOM and
              apply standard ceiling-detector rules. Element offset 25-600 mm (smoke) or 25-150 mm
              (heat); spacing 7.5 m / 5.3 m smoke or 5.3 m / 3.7 m heat. The void is effectively a
              separate compartment with its own ceiling.
            </li>
          </ul>
          <p>
            The figure replaces text-only guidance from the 2017 edition that frequently caused
            on-site interpretation errors. Print or screen-grab the figure and bring it to site for
            any void-detection design.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              to highlight at what position and what depth of the void the detector should be
              mounted. Three cases are illustrated: void up to and including 1.25 m deep (detector
              top 125 mm); void more than 1.25 m and up to and including 1.5 m deep (detector top 10
              percent); void more than 1.5 m deep (treated as a normal height room).
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Test (a) — gap above.</strong> The gap between the TOP of the obstruction and
              the ceiling above is LESS than 300 mm.
            </li>
            <li>
          ...
          <p>
            ...
            wall-distance rule. If either fails, the obstruction is NOT treated as a wall; smoke and
            heat flow over and around it.
          </p>
          <p>Worked examples:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>4 m ceiling, 200 mm duct with 250 mm gap above:</strong> Test (a) passes (250
              &lt; 300). Test (b) fails (200 &lt; 400 = 10 percent of 4000). Therefore NOT a wall.
            </li>
            <li>
              <strong>3 m ceiling, 350 mm duct with 200 mm gap above:</strong> Test (a) passes (200
              &lt; 300). Test (b) passes (350 &gt; 300 = 10 percent of 3000). Therefore IS a wall —
              apply 5.3 m / 3.7 m rule.
            </li>
            <li>
              <strong>5 m ceiling, 600 mm duct with 200 mm gap above:</strong> Test (a) passes (200
              &lt; 300). Test (b) passes (600 &gt; 500 = 10 percent of 5000). Therefore IS a wall.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              gap above to the ceiling (clause 21.2.12 note), the beam is not treated as an obstacle
              at all and the 2× depth rule does not apply.
            </li>
            <li>
              ...
              ceiling rather than a flat ceiling with obstructions. Each cell (or group of cells) is
              treated as the detection area. The detection rules for cellular ceilings differ from
              flat ceilings; refer to the relevant clause-21.2 sub-clauses for cell-by-cell or
              grouped-cell siting.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              element controls. Height limit drops to the HEAT-detector value (typically 7.5 m or 9
              m). Designers using AND-logic in tall spaces must work this constraint.
            </li>
            <li>
          ...
          <p>
            ...
            programmed mode. Get the mode wrong at programming and the height limit may accidentally
            drop below the actual mounting height — non-compliance not visible from the panel.
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-2/section-3')}
