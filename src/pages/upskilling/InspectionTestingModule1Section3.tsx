...
const DESCRIPTION =
  'Learn about essential test instruments for electrical inspection and testing, including multifunction testers, calibration requirements, and pre-test checks.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Most instrument manufacturers and calibration bodies recommend annual (12 month) calibration for multifunction testers used in professional testing.',
  },
  {
    id: 'gs38-guidance',
    ...
    correctIndex: 1,
    explanation:
      'GS38 (Electrical test equipment for use on low voltage electrical systems) provides HSE guidance on selecting and using test equipment safely.',
  },
  {
    id: 'prove-test-prove',
    ...
    options: [
      'Just switch it on',
      'Prove it works on a known live source, test, then re-prove',
      'Only test the batteries',
      'Clean the probes only',
    ],
    correctIndex: 1,
    explanation:
      'The prove-test-prove method ensures the voltage indicator is working correctly before and after use, confirming reliable results.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 2,
    explanation:
      'Thermal imaging requires a separate thermal camera. Multifunction testers typically cover continuity, insulation, loop impedance, RCD, and related tests.',
  },
  {
    id: 2,
    question:
    ...
    correctAnswer: 1,
    explanation:
      'For circuits up to 500V, including standard 230V circuits, a 500V DC test voltage is used for insulation resistance testing.',
  },
  {
    id: 3,
    ...
    options: [
      ...
      'Any testing laboratory',
      'National standards (UKAS)',
      'The installer',
    ],
    correctAnswer: 2,
    explanation:
      'Calibration should be traceable to national standards through UKAS (United Kingdom Accreditation Service) accredited laboratories.',
  },
  {
    id: 4,
    ...
    options: [
      ...
      'To provide a known voltage source for testing voltage indicators',
      'To calibrate multimeters',
      'To test RCDs',
    ],
    correctAnswer: 1,
    explanation:
      'A proving unit provides a known voltage (typically 230V or higher) to verify that voltage indicators are functioning correctly.',
  },
  {
    id: 5,
    ...
    options: [
      ...
      'Maximum 4mm exposed tip with finger guards',
      'No finger guards required',
      'Exposed metal only',
    ],
    correctAnswer: 1,
    explanation:
      'GS38 recommends test probes with a maximum 4mm exposed tip and finger guards to prevent accidental contact with live parts.',
  },
  {
    id: 6,
    question: 'What does CAT III rating on a meter indicate?',
    options: [
      "It's suitable for low voltage only",
      "It's suitable for distribution level testing",
      "It's only for domestic use",
      'It cannot be used on live circuits',
    ],
    correctAnswer: 1,
    explanation:
      'CAT III (Category III) indicates suitability for distribution level - fixed installations, distribution boards, and similar.',
  },
  {
    id: 7,
    question: 'Which of these should be checked before using a multifunction tester?',
    options: [
      'Battery condition only',
      'Lead condition and battery',
      'Nothing - just switch it on',
      'Calibration date, battery, lead condition, and zero check',
    ],
    correctAnswer: 3,
    explanation:
      'Pre-use checks should include calibration validity, battery condition, test lead condition, and appropriate zeroing where applicable.',
  },
  {
    id: 8,
    question: 'The uncertainty of a measurement refers to:',
    options: [
      'The tester being broken',
      'The range of values within which the true value lies',
      'The tester needing calibration',
      'The wrong test being selected',
    ],
    correctAnswer: 1,
    explanation:
      'Measurement uncertainty is the range within which the true value probably lies. All measurements have some uncertainty which must be considered.',
  },
  {
    id: 9,
    ...
    options: [
      'In dry conditions',
      "When it's within calibration",
      'When leads are damaged',
      'When batteries are fully charged',
    ],
    correctAnswer: 2,
    explanation:
      'Damaged test leads can give incorrect readings and pose a safety hazard. Never use equipment with damaged leads.',
  },
  {
    id: 10,
    ...
    correctAnswer: 3,
    explanation:
      'IP54 or higher provides protection against dust and water splashes, suitable for outdoor or construction site use.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Most manufacturers recommend annual calibration for multifunction testers. However, if the instrument is heavily used, damaged, or you suspect it's reading incorrectly, it should be calibrated sooner. Keep calibration certificates and check dates before each use.",
  },
  {
    question: 'Can I calibrate my own test equipment?',
    answer:
      "For professional use, calibration should be performed by a UKAS accredited laboratory or the equipment manufacturer. Self-checking against reference instruments is good practice but doesn't replace formal calibration.",
  },
  {
    question: "What's the difference between verification and calibration?",
    answer:
      'Verification checks that an instrument reads within acceptable limits. Calibration adjusts the instrument to read correctly and provides a certificate of accuracy. Verification can be done in-house; calibration should be done by accredited laboratories.',
  },
  {
    question: 'Do I need separate instruments for each test?',
    answer:
      'No - modern multifunction testers combine all required tests in one instrument. However, you may still need a separate voltage indicator (two-pole tester) for safe isolation verification, and possibly a clamp meter for current measurements.',
  },
  {
    question: 'What should I do if my test equipment fails during a job?',
    answer:
      'Stop testing immediately. Do not rely on readings from faulty equipment. Either use backup equipment or postpone testing until the equipment is repaired/replaced. Never guess or estimate test results.',
  },
  {
    question: 'Are budget test instruments acceptable?',
    answer:
      'Instruments must meet the accuracy requirements for the tests being performed. Budget instruments from reputable manufacturers can be suitable if they meet specifications. Avoid unbranded equipment without proper certification or calibration traceability.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>MFT:</strong> Multifunction tester - one instrument for all tests
              </li>
              <li>
                <strong>Calibration:</strong> Annual by UKAS accredited laboratory
              </li>
              <li>
                <strong>Pre-checks:</strong> Essential for reliable results
              </li>
              <li>
                <strong>Prove-test-prove:</strong> Critical safety procedure
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>GS38:</strong> HSE test equipment guidance
              </li>
              <li>
                <strong>CAT III:</strong> Distribution level rating
              </li>
              <li>
                <strong>4mm max:</strong> Probe tip exposure
              </li>
              <li>
                <strong>UKAS:</strong> Calibration accreditation
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Electrical inspection and testing requires specific instruments capable of performing
              all tests required by BS 7671. The main instruments are:
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Clamp meter:</strong> For measuring current without disconnecting
                  conductors
                </li>
                <li>
                  <strong>Socket tester:</strong> Quick check for polarity and basic faults (not a
                  substitute for proper testing)
                </li>
                <li>
                  <strong>Phase rotation meter:</strong> For three-phase installations
                </li>
                <li>
                  <strong>Earth electrode tester:</strong> For TT systems requiring earth electrode
                  testing
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The <strong>multifunction tester (MFT)</strong> is the essential tool for electrical
              testing. Modern MFTs combine all required tests in one portable instrument.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Standard MFT Capabilities
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Calibration ensures test instruments provide accurate, reliable readings. Without
              proper calibration, test results cannot be trusted.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Before using any test instrument, pre-test checks ensure the equipment is safe and
            ...
            <div className="my-6">
              ...
              <ol className="text-sm text-white space-y-2 ml-4">
                <li>
                  ...
                  <strong>Check calibration date</strong> - Verify certificate is current
                </li>
                <li>
                  <span className="text-elec-yellow">2.</span> <strong>Inspect test leads</strong> -
                  Check for damage, cracked insulation, secure connections
                </li>
                <li>
                  <span className="text-elec-yellow">3.</span> <strong>Check battery level</strong>{' '}
                  - Ensure adequate charge for testing
                </li>
                <li>
                  <span className="text-elec-yellow">4.</span> <strong>Zero/null test leads</strong>{' '}
                  - On continuity range, short leads and check zero
                </li>
                <li>
                  <span className="text-elec-yellow">5.</span>{' '}
                  <strong>Check instrument function</strong> - Verify all required tests are working
                </li>
              </ol>
            </div>
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20 my-6">
              ...
              <ol className="text-sm text-white/80 space-y-1 ml-4">
                ...
                <li>
                  2. <strong>TEST</strong> the circuit to confirm dead
                </li>
                <li>
                  3. <strong>PROVE</strong> the indicator still works on the known live source
                </li>
              </ol>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              All measurements have some degree of <strong>uncertainty</strong> - the range within
              which the true value lies. Understanding this is important when comparing results to
              limits.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Selecting the right instrument for the task involves matching capabilities to
              requirements and ensuring safety.
            </p>
            ...
            <p className="text-sm text-orange-400/90">
              <strong>Note:</strong> For electrical installation testing, use instruments rated{' '}
              <strong>CAT III 300V minimum</strong>, preferably{' '}
              <strong>CAT III 600V or CAT IV 300V</strong> for consumer unit and origin testing.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4 mt-2">
                <li>
                  Test probes with maximum <strong>4mm exposed tip</strong>
                </li>
        ...
        {/* Reference Card */}
        <section className="mb-10">
          <UnitsPocketCard title="Test Equipment Reference" items={referenceItems} />
        </section>
