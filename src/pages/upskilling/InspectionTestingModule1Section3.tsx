    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Choosing the right instrument under Reg 643.1, the GS38 rules for probes and leads, what
          CAT III and CAT IV actually mean for your test arrangement, and the calibration cycle that
          keeps your readings legally defensible.
        </p>
        ...
        >
          <p>
            ...
            under Reg 643.2 (continuity), Reg 643.3 (insulation resistance), Reg 643.7 (earth-fault
            loop impedance), Reg 643.8 (RCD) or any of the others, the instrument has to be chosen
            in accordance with BS&nbsp;EN&nbsp;61557. The standard runs to multiple parts and each
            part covers a specific test function:
          </p>
          ...
          <p>
            The &ldquo;no lesser degree of performance and safety&rdquo; escape clause is sometimes
            treated as a free pass. It is not. The duty is on the user to demonstrate equivalence —
            the accuracy class, the test current or voltage, the safety architecture and the
            overvoltage rating all have to be at least equivalent to the relevant
            BS&nbsp;EN&nbsp;61557 part. In a court or insurer dispute, &ldquo;I used a multimeter on
            the lowest ohm range&rdquo; is not equivalence.
          </p>
        </ConceptBlock>
        ...
        >
          <ol className="list-decimal pl-5 space-y-2 text-[14px]">
            <li>
              ...
              2&nbsp;Ω, resolution to 0.01&nbsp;Ω. Multimeters do not meet this. A buzzer absolutely
              does not — it will beep on a high-resistance joint that is electrically dangerous.
            </li>
            <li>
              <strong>Insulation-resistance tester (BS EN 61557-2).</strong> Discharges Reg 643.3.
              Test voltages of 250&nbsp;V&nbsp;DC, 500&nbsp;V&nbsp;DC and 1000&nbsp;V&nbsp;DC, with
              the meter capable of holding the voltage under load and reading megohms or higher. The
              250&nbsp;V test appears specifically for live-to-PE checks where SELV / PELV or
              sensitive electronics are connected — see Reg 643.3.3.
            </li>
            <li>
              ...
              point on the circuit. Modern testers offer a no-trip mode that injects a small current
              over many cycles to compute loop impedance without tripping a 30&nbsp;mA RCD.
            </li>
            <li>
              ...
              2&times;I&Delta;n, 5&times;I&Delta;n and the ramp test. The standard sets the accuracy
              class of the test current and the resolution of the time measurement — without it, the
              trip-time figures on the schedule are not legally robust.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Probes:</strong> finger barriers between the operator hand and the metal tip.
              Maximum exposed metal at the tip commonly cited as 4&nbsp;mm — long enough to make
              contact, short enough that a probe falling sideways onto a busbar cannot bridge
              phase-to-phase.
            </li>
            <li>
            ...
            <li>
              ...
              expected fault current of the test point. The fuse limits the energy released into the
              operator hand and the surrounding equipment if the probe tip slips. Without a fused
              lead, a phase-to-earth slip at the origin can deliver the full prospective
            ...
            <li>
              <strong>Accessories:</strong> crocodile clips with insulated jaws, retractable shrouds
              where used, and clearly marked CAT ratings on the lead.
            </li>
          </ul>
          <p>
            ...
            instrument itself is a valid alternative to lead fusing for some test functions, but it
            has to be present somewhere in the path.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>CAT II:</strong> single-phase appliances and the final circuits supplying them
              — the socket-outlet end. A meter rated CAT II 300&nbsp;V is fine for testing inside a
              portable appliance, not for installation work.
            </li>
            <li>
              <strong>CAT III:</strong> distribution circuits, the consumer unit and downstream
              fixed wiring. This is where most BS 7671 testing happens — Reg 643.2 continuity, 643.3
              insulation, 643.7 Zs at a final-circuit point.
            </li>
            <li>
              <strong>CAT IV:</strong> the origin of the supply. The cut-out, the meter tails, the
              primary distribution board. Testing Ze at the origin or PSCC at the cut-out is CAT IV
              territory because a network-side transient hits there first.
            </li>
          </ul>
          <p>
            ...
            example, a CAT IV test arrangement at 230/400&nbsp;V nominal must withstand a 6&nbsp;kV
            impulse without flashover.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The calibration cycle has three layers, each of which discharges a different duty:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
            ...
            <li>
              <strong>In-service checks.</strong> Daily and per-job checks: short-the-leads zero on
              continuity, battery condition, visual inspection of leads and probes for damage, a
              known-circuit reference test if the meter has been in transit. These do not replace
              UKAS calibration — they catch the failures most likely between cycles.
            </li>
            <li>
              ...
              liquid spill, a service repair or any reason to suspect drift triggers a return to the
              lab before the next test. Quarantine the instrument with a &ldquo;do not use&rdquo;
              tag.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Instruments shall be periodically calibrated. Calibration or checking procedures shall
              follow the manufacturer&rsquo;s recommendations and procedures. Test and calibration
              intervals and methods shall be as recommended by the instrument manufacturer.
            </>
          }
        ...
        >
          <p>
            Per the A4:2026 model forms, a modern Schedule of Test Results expects the following for
            each instrument used during the test session:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
            ...
            <li>
              Optional: accuracy class for each function used, GS38 compliance of leads, CAT rating.
              The model forms do not require these but they are good practice in an EICR for
              industrial or insured installations.
            </li>
          </ul>
          <p>
            A4:2026 did not change the BS&nbsp;EN&nbsp;61557 selection rule. What it did change was
            the column structure on the schedule of test results — additional columns to record
            values that were previously buried in comments. The instrument provenance fields sit
            alongside the per-circuit columns now, not in a free-text afterthought.
          </p>
        </ConceptBlock>
        ...
        >
          <ol className="list-decimal pl-5 space-y-2 text-[14px]">
            <li>
              <strong>Is the calibration current?</strong> Check the calibration label on the meter.
              If it has expired or is within a month of expiry, replace the meter from the spare or
              send it in. Do not test with an expired-cal meter and &ldquo;intend to&rdquo; send it
              later.
            </li>
            <li>
            ...
            <li>
              <strong>Has anything happened to the meter since the last test session?</strong> Drop,
              spill, repair, long transit in cold or hot? If yes, GN3 Reg 4.8 says accuracy must be
              re-established — quarantine and recheck.
            </li>
            <li>
              <strong>
              ...
              Run through every item: meter, leads, probes, clips, connectors. Lowest item sets the
