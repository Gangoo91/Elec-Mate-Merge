...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'BS 7671 recommends 66% diversity for the first 10A of socket outlets, then 40% for the remainder in domestic installations. This reflects the reality that not all sockets are used simultaneously at full load.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Emergency lighting and other safety-critical loads should always be calculated at 100% demand with no diversity applied. These systems must function fully when needed.',
  },
  {
    id: 'motor-diversity',
    ...
    correctIndex: 2,
    explanation:
      'Motor diversity must consider both starting currents (which are typically 6-8x running current and may not be diverse) and running currents (which may have diversity applied based on simultaneous operation).',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Designing for 100% of all connected loads would result in significantly oversized cables, switchgear, and supply capacity. This wastes materials and increases costs by 30-50% without improving safety—since normal operation never reaches these levels. Proper diversity application balances economy with safety.',
  },
  {
    question: 'How do I know which diversity factors to use for commercial installations?',
    answer:
      'Commercial installations require careful load analysis. BS 7671 provides domestic guidance, but commercial diversity depends on specific usage patterns, operating hours, and process requirements. Use load monitoring data where available, or apply conservative factors and document your assumptions.',
  },
  {
    question: 'What happens if I apply too much diversity?',
    answer:
      'Excessive diversity results in undersized installations that experience cable overheating, excessive voltage drop, nuisance tripping, and potential fire hazards. In worst cases, this leads to equipment damage, production downtime, and costly remedial work.',
  },
  {
    question: 'Should I include future expansion in my maximum demand calculation?',
    answer:
      'Yes. Good practice includes 10-20% spare capacity for future growth, plus consideration of known planned loads like EV charging or heat pumps. This prevents expensive upgrades later while maintaining economic initial installation.',
  },
];
...
const quizQuestion = {
  ...
  correctAnswer: 0,
  explanation:
    'BS 7671 recommends 100% for the first 10kW of fixed heating appliances, then 50% for the remainder. This accounts for thermostat control while ensuring adequate capacity for initial heating demand.',
};
...
const BS7671Module3Section2 = () => {
  useSEO({
    ...
    description:
      'Learn to calculate maximum demand using diversity factors per BS 7671 Appendix 1 for economic and safe electrical installation design.',
  });
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Diversity:</strong> Not all loads operate at 100% simultaneously
              </li>
              <li>
                <strong>Benefit:</strong> Reduced cable sizes, switchgear, and supply costs
              </li>
              <li>
                <strong>Key:</strong> Balance economy with safety—too much diversity = undersized
                installation
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>When:</strong> Sizing cables, switchgear, and supply capacity
              </li>
              <li>
                <strong>Where:</strong> BS 7671 Appendix 1 provides diversity tables
              </li>
              <li>
                <strong>Critical:</strong> Safety systems = 100% demand (no diversity)
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Diversity (or demand factor) recognises that connected load rarely equals maximum
              demand. Not all circuits operate simultaneously at full load, allowing for reduced
              cable sizes, switchgear ratings, and supply capacity.
            </p>
            <p>
              Consider a home with a 10kW cooker, 3kW kettle, 2kW toaster, and 1kW microwave. The
              connected load is 16kW, but you'd never operate all four at maximum simultaneously.
              Diversity acknowledges this reality.
            </p>

            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Benefits of Correct Diversity
                </p>
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Reduced cable sizes:</strong> Material savings of 20-40%
                  </li>
                  <li>
                    <strong>Lower switchgear ratings:</strong> MCBs, RCDs correctly sized
                  </li>
                  <li>
                    <strong>Optimised supply:</strong> Avoid expensive over-specification
                  </li>
                  <li>
                    <strong>Future capacity:</strong> Built-in appropriately, not excessively
                  </li>
                </ul>
              </div>
              <div>
                <p className="text-sm font-medium text-red-400/80 mb-2">
                  Risks of Incorrect Diversity
                </p>
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Undersized installation:</strong> Overloading, overheating
                  </li>
                  <li>
                    <strong>Nuisance tripping:</strong> Frequent MCB operation
                  </li>
                  <li>
                    <strong>Voltage drop:</strong> Equipment underperformance
                  </li>
                  <li>
                    <strong>No expansion capacity:</strong> Costly upgrades later
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BS 7671 Appendix 1 provides guidance on diversity factors for typical domestic
              installations. These factors are based on extensive load surveys and provide reliable
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Commercial Diversity Considerations
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Office buildings:</strong> Socket outlets 75-90%, lighting depends on
                  controls
                </li>
                <li>
                  <strong>Retail premises:</strong> Higher diversity due to display lighting and
                  equipment rotation
                </li>
                <li>
                  <strong>Industrial facilities:</strong> Process-dependent, often minimal diversity
                </li>
                <li>
                  <strong>Educational buildings:</strong> Consider term-time vs holiday operation
                  patterns
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A systematic approach ensures accuracy and provides clear documentation for design
              decisions and future modifications.
            </p>
            ...
            <div className="my-6">
              ...
              <ol className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>1. Load Inventory:</strong> List all circuits with connected loads and
                  operating characteristics
                </li>
                <li>
                  <strong>2. Load Categorisation:</strong> Group similar loads and identify
                  appropriate diversity factors
                </li>
                <li>
                  <strong>3. Diversity Application:</strong> Apply BS 7671 or appropriate factors to
                  each category
                </li>
                <li>
                  <strong>4. Load Summation:</strong> Sum diversified loads to determine maximum
                  demand
                </li>
                <li>
                  <strong>5. Safety Margins:</strong> Add appropriate safety margins and future
            ...
            <div className="p-5 rounded-lg bg-white/5 my-6">
              <h3 className="text-sm font-medium text-elec-yellow mb-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <ul className="text-white/90 space-y-1">
                    ...
                    <li>• Kitchen: 2kW</li>
                    <li>
                      <strong>Total connected: 33kW</strong>
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="text-white/90 space-y-1">
                    ...
                    <li>
                      <strong>Max demand: 26.47kW</strong>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="p-5 rounded-lg bg-red-500/5 border border-red-500/20">
            ...
            <p className="text-sm text-white mb-3">
              A contractor applies 50% diversity to all loads in a 24/7 call centre, not considering
              that most equipment operates continuously. During peak operation, the supply
              overloads, causing equipment shutdowns and business interruption costing £50,000 per
              hour.
            </p>
            <div className="p-3 rounded bg-green-500/5 border border-green-500/20">
              ...
              <p className="text-sm text-white">
                Load analysis reveals 24/7 operation with minimal diversity. Design uses 95%
                diversity with load monitoring systems. Installation handles peak demands safely
                with capacity for planned expansion.
              </p>
            </div>
          </div>
        </section>
