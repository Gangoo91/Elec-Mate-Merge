...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['13.5 kWh', '10.8 kWh', '13.5 × 0.8 × 0.92 = 9.94 kWh ≈ 9.9 kWh', '5 kWh'],
    correctAnswer: 2,
    explanation:
...
const faqs = [
  ...
  {
    question:
      'How do Octopus tariffs (Flux, Cosy, Agile, Intelligent Go) change the sizing answer?',
    answer:
  ...
  {
    question:
      'What if the customer’s situation will change — EV next year, heat pump in two years?',
    answer:
...
export default function RenewableEnergyModule5Section6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 6 · BS 7671:2018+A4:2026 · Reg 570.5.1(a)(c)(g)(h)"
        title="Sizing & energy modelling"
        backTo="../renewable-energy-module-5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          How to turn a customer’s daily load and tariff shape into a defensible BESS capacity.
          Nameplate vs usable kWh, C-rate, round-trip efficiency, the knee point on the
          self-consumption curve, and how Octopus Flux / Cosy / Agile / Intelligent Go change the
          answer.
        </p>
        ...
        <Pullquote>
          Nameplate sells. Usable serves. Sizing is the conversion between the two — and the
          customer pays attention.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              ...
              consumption in kWh, broken into baseload, daytime peaks and evening peaks. For UK
              domestic: half-hourly smart-meter data is the gold standard input
            </li>
            <li>
              <strong className="text-white">(c) Charge time and discharge time</strong> — how fast
              can the pack accept energy (PV surplus window, tariff cheap window) and how long must
              it deliver (peak evening hours, outage autonomy if EPS). Both feed kWh capacity AND
              C-rate
            </li>
            <li>
              <strong className="text-white">(g) Charge and discharge profiles</strong> — C-rate
              (cell-level continuous limit), depth of discharge (LFP 80% typical), and rate-related
              ageing. These set the actual kW deliverable, not just the kWh storable
            </li>
            <li>
              <strong className="text-white">
                (h) Load profiles and cyclic operation capability
              </strong>{' '}
              — daily cycling pattern (one cycle, two cycles, seasonal), and the manufacturer’s
              rated cycle life at the DoD you intend to run. Translates directly to expected useful
              life
            </li>
          </ul>
        </ConceptBlock>
...
[and the remaining factors (b)(d)(e)(f)(i)(j) covered elsewhere].`}
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Nameplate kWh</strong> — chemistry-level calculation
              (e.g. 280 Ah LFP cells × 51.2 V nominal × 16 cells = ~9,830 Wh rounded to 9.5 kWh).
              What’s on the cabinet sticker
            </li>
            <li>
              <strong className="text-white">Usable kWh</strong> — nameplate × DoD limit set by the
              BMS. LFP at 80% DoD: 9.5 × 0.8 = 7.6 kWh from the pack
            </li>
            <li>
              <strong className="text-white">Delivered-to-loads kWh</strong> — usable × round-trip
              efficiency on the discharge leg. ~95% on DC-coupled hybrid: 7.6 × 0.95 = ~7.2 kWh
              actually arriving at the loads per full cycle
            </li>
            <li>
              <strong className="text-white">Customer-facing language</strong> — quote BOTH
              "nameplate" and "delivered" in the install proposal. Hiding the gap is the fast route
              to a disappointed customer when their app shows the real throughput
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Daily kWh — by season</strong> — UK domestic typical
              8–15 kWh winter weekday, 6–10 kWh summer weekday; high-cycling households with EV /
              heat pump can hit 25–50 kWh winter
            </li>
            <li>
              <strong className="text-white">Peak shape</strong> — UK domestic evening peak
              typically 17:00–22:00, drawing 60–75% of daily consumption. The peak shape is what the
              BESS is mostly there to displace
            </li>
            <li>
              <strong className="text-white">Daytime baseload</strong> — fridge, freezer, router,
              standby loads. Typically 200–500 W continuous. This sets the minimum PV output that
              goes direct to loads (not via the battery)
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">Seasonal swing</strong> — UK domestic winter / summer
              ratio typically 2:1 for non-electric-heat homes, 4:1 or higher for heat-pump homes
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              ...
              typically written around this. Pack delivers 80% of nameplate before BMS cut-off.
              Cycle life ~6,000-10,000 cycles at this DoD
            </li>
            <li>
              <strong className="text-white">LFP at 50% DoD</strong> — much longer cycle life
              (~15,000-20,000 cycles) but you only get half the energy out per cycle. Rare except in
              heavy-cycling commercial cases
            </li>
            <li>
              <strong className="text-white">Lead-acid at 50% DoD</strong> — chemistry limit, not
              optional. 30 kWh nameplate Pb-acid bank = 15 kWh usable. Cycle life 500-1,500 at 50%
              DoD
            </li>
            <li>
              <strong className="text-white">
                Round-trip efficiency, DC-coupled hybrid one-way
              </strong>{' '}
              — ~95-97% on discharge. PV→battery is single-conversion
            </li>
            <li>
              <strong className="text-white">Round-trip efficiency, AC-coupled cross-charge</strong>{' '}
              — ~85-90% on PV→battery (two inverters in series). Section 5.5 covers the topology
              drivers
            </li>
            <li>
              <strong className="text-white">Temperature derating</strong> — LFP loses ~10-15%
              capacity at 0°C vs 25°C. Reg 570.5.1(j) external influences. UK garage installs in
              winter: factor this in
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              ...
              cannot deliver the customer’s peak evening load even with kWh to spare — the BMS
              throttles output. Customer sees the app showing battery at 60% but grid still
              importing
            </li>
            <li>
              <strong className="text-white">
                Charge time = nameplate × DoD ÷ (C-rate × nameplate)
              </strong>{' '}
              = DoD ÷ C-rate. 0.8 DoD at 0.5C = 1.6 hours empty-to-full from a PCE that can supply
              that much. Faster C-rate halves the charge time but stresses the cells
            </li>
            <li>
              <strong className="text-white">Tariff-window sizing</strong> — if the cheap window is
              6 hours (Octopus Intelligent Go) and the pack needs 80% × usable kWh in that window,
              the C-rate × inverter combination has to deliver. Pack at 0.2C in a 6-hour window: 0.2
              × 6 = 1.2 → caps at 100% of nameplate
            </li>
            <li>
              <strong className="text-white">High peak C-rate is the EV / shower enabler</strong> —
              a customer running an EV charger at 7 kW during EPS island mode needs a pack and
              inverter combination that can sustain 7 kW continuous. Many domestic hybrids cap at 5
              kW continuous; sized-up packs buy more parallel cells but same C-rate ceiling
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">DC-coupled hybrid, PV→battery→load</strong>— ~92-95%
              combined (battery accepts DC directly; only one DC→AC conversion on discharge)
            </li>
            <li>
              <strong className="text-white">AC-coupled, PV→battery→load</strong> — ~85-90% combined
              (PV→AC conversion, then AC→DC into battery, then DC→AC on discharge)
            </li>
            <li>
              <strong className="text-white">Battery→load on either topology</strong> — ~95% on the
              discharge leg alone (the DC→AC conversion is the same for both topologies on the way
              out)
            </li>
            <li>
              <strong className="text-white">
                Grid→battery→load (tariff arbitrage with no PV)
              </strong>{' '}
              — ~88-92%, similar to AC-coupled cross-charge, because you’re going AC→DC→AC
            </li>
            <li>
              <strong className="text-white">Standby losses</strong> — separate from round-trip;
              modern hybrid inverters draw ~20-40 W continuous, costing ~£50-£100/yr at UK
              electricity prices. Material on a backup-only install, noise on a cycling install
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              ...
              annual ~4,500 kWh, daily avg 12.3 kWh, peak day ~30 kWh in June, low day ~3 kWh in
              December
            </li>
            <li>
              <strong className="text-white">PV London east + west split, 5 kWp</strong>— annual
              ~4,100 kWh, flatter daily curve, smaller summer peak — smaller BESS captures the
              surplus more efficiently
            </li>
            <li>
              <strong className="text-white">Octopus Flux export 16:00-19:00</strong> — BESS sized
              for 3-hour discharge window covering the peak; nameplate ≈ peak-hour load × 3 ÷ DoD ÷
              round-trip
            </li>
            <li>
              <strong className="text-white">Octopus Intelligent Go import 23:30-05:30</strong>—
              6-hour cheap window; BESS sized to be empty at start of window and full by end; charge
              C-rate × 6 hours × inverter limit ≥ nameplate × DoD
            </li>
            <li>
              <strong className="text-white">SEG export rate</strong> — typically 5-15p /kWh in
              2025-26. Pushes the model toward self-consumption rather than export; bigger BESS
              captures more surplus before it leaves the meter
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Worked example — UK family of four, 5 kWp PV, no EV, no heat pump
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">(a) Daily demand</strong> — 14 kWh average, with 60%
              (8.4 kWh) in the 17:00-22:00 evening peak. Half-hourly data shows weekday peak
              slightly higher than weekend
            </li>
            <li>
              <strong className="text-white">(a) PV generation</strong> — 5 kWp midlands
              south-facing ≈ 4,500 kWh/yr, avg 12.3 kWh/day. Summer peak day ~28 kWh, winter low day
              ~2 kWh
            </li>
            <li>
              <strong className="text-white">(c) Discharge time target</strong> — cover the
              17:00-22:00 peak from the battery on most days. 5-hour discharge window
            </li>
            <li>
              <strong className="text-white">(c) Charge time target</strong> — fill from PV surplus
              (June-September) OR from Octopus Flux cheap window 02:00-05:00 (rest of year).
              Three-hour minimum charge window in worst case
            </li>
            <li>
              <strong className="text-white">(h) Cycling pattern</strong> — daily cycling year-round
              (1 cycle/day). Cycle life target ~16 years × 365 = 5,840 cycles → LFP at 80% DoD
              (6,000-10,000 rated) is comfortable
            </li>
            <li>
              <strong className="text-white">Capacity arithmetic</strong> — usable kWh target ≈
              evening peak that battery will cover = 8.4 kWh delivered to loads. Working back: 8.4 ÷
              0.95 round-trip ÷ 0.8 DoD = 11.05 kWh nameplate. Nearest pack: GivEnergy 9.5 kWh OR
              13.5 kWh. The 9.5 kWh hits the knee for THIS load profile; the 13.5 kWh oversizes by
              ~2 percentage points of self-consumption uplift
            </li>
            <li>
              <strong className="text-white">(g) C-rate check</strong> — GivEnergy LFP 0.5C
              continuous × 9.5 kWh = 4.75 kW continuous, 1C peak = 9.5 kW peak. Covers the
              customer’s peak loads (kitchen + lounge typically under 4 kW continuous; momentary
              shower spike accepted on peak C-rate)
            </li>
            <li>
              <strong className="text-white">(c) Charge window check</strong> — Flux cheap window
              02:00-05:00 is 3 hours; 9.5 × 0.8 = 7.6 kWh to put in / 3 hours = 2.53 kW average
              inverter throughput, well within the 5 kW hybrid’s capability and within LFP 0.5C
              charge limit (4.75 kW). Pass
            </li>
            <li>
              <strong className="text-white">Final recommendation</strong> — 9.5 kWh LFP, with the
              rationale captured in the cert evidence bundle citing Reg 570.5.1(a)(c)(g)(h).
              Customer told: "nameplate 9.5 kWh, usable 7.6 kWh, delivered-to-loads ~7.2 kWh per
              cycle." Expansion path noted: can add a second 9.5 kWh module if EV / heat pump
              arrives later
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Flux</strong> — three-hour cheap window 02:00-05:00
              (~12p), three-hour peak 16:00-19:00 (~33p), export rate ~33p in the peak. Designed for
              PV+BESS. Sizing targets the 3-hour peak discharge × peak load
            </li>
            <li>
              <strong className="text-white">Cosy</strong> — twin cheap windows (~13p morning + ~13p
              afternoon), expensive evening (~40p). Designed for heat-pump households. BESS can
              two-cycle a day; sizing per cycle rather than per day
            </li>
            <li>
              <strong className="text-white">Agile</strong> — half-hourly variable prices tracking
              wholesale. No fixed windows. BESS needs enough kWh AND enough inverter headroom to
              chase short-duration price spikes. Sizing model is statistical
              (price-volatility-aware) rather than deterministic
            </li>
            <li>
              <strong className="text-white">Intelligent Go</strong> — six-hour cheap window
              23:30-05:30 (~7p), expensive rest of day (~27p). Designed for EV charging but works
              for BESS arbitrage. Wider cheap window means more capacity is reachable per night;
              sizing targets the daily peak-hour displacement
            </li>
            <li>
              <strong className="text-white">SEG-only customer (no time-of-use)</strong>— BESS sized
              purely against PV self-consumption uplift. The pure 1:2 ratio default applies,
              validated against the customer’s smart-meter data
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Step 1</strong> — half-hourly smart-meter data for 12
              months + PVGIS PV output for the actual roof
            </li>
            <li>
              <strong className="text-white">Step 2</strong> — simulate battery operation at five
              candidate sizes (e.g. 4.5, 9.5, 13.5, 19, 27 kWh)
            </li>
            <li>
              <strong className="text-white">Step 3</strong> — read off self-consumption % at each
              size; calculate marginal £/kWh-uplift (incremental cost ÷ incremental annual saving)
            </li>
            <li>
              <strong className="text-white">Step 4</strong> — the knee is the largest size where
              the marginal £/kWh-uplift is still &lt; the customer’s cost-of-capital × pack
              lifetime. Beyond that, the next increment is uneconomic
            </li>
            <li>
              <strong className="text-white">Step 5</strong> — show the curve to the customer with
              the knee marked. Sign off the size as the cert evidence bundle entry against Reg
              570.5.1(h)
            </li>
          </ul>
        </ConceptBlock>
