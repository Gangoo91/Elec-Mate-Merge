...
const quickCheckQuestions = [
  {
    ...
    options: [
      'Red Green Blue Wireless',
      'Red Green Blue White',
      'Reduced Glare Basic White',
      'Remote Governed Brightness Wireless',
    ],
    correctIndex: 1,
    explanation:
      'RGBW stands for Red, Green, Blue, White - the four LED types combined to produce a wide range of colours plus true white light.',
  },
  {
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      '2700K is warm white, similar to traditional incandescent bulbs. Higher values (4000K, 6500K) produce cooler, bluer light.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'LED flicker typically occurs when using incompatible dimmers. Leading-edge dimmers designed for incandescent loads often cause flicker with LEDs.',
  },
  {
  ...
  },
  {
    ...
    options: [
      'Dimmer draws too much current',
      "LED load too small for dimmer's minimum rating",
      'Neutral wire missing',
      'Switch location too far from fixture',
    ],
    correctIndex: 1,
    explanation:
      'Many dimmers have minimum load requirements (e.g., 10W). A single 5W LED may not meet this, causing dimming issues. Multiple LEDs or dummy loads can solve this.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'RGBW for most applications. The dedicated white LED provides clean white light for everyday use, while RGB offers colour options for entertainment and accent lighting. RGB-only bulbs produce inferior white light.',
  },
  {
    question: 'How do I solve LED dimming compatibility issues?',
    answer:
      'First verify the dimmer is trailing-edge and LED-compatible. Check minimum load requirements. Use manufacturer-recommended dimmer/bulb combinations. Consider installing a bypass capacitor or dummy load.',
  },
  {
    question: 'What colour temperature should I recommend for different rooms?',
    answer:
      'Warm white (2700-3000K) for living rooms and bedrooms. Neutral white (3500-4000K) for kitchens and bathrooms. Cool white (5000K+) for task lighting and workspaces. Tunable white offers flexibility.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-4xl mx-auto">
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Dimming smart lights can be achieved through different methods, each with specific
          ...
          <div className="space-y-4 mb-4">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                Traditional dimmers that reduce power by cutting part of the AC waveform.
              </p>
              <div className="space-y-2 mt-3">
                <div className="p-2 rounded bg-white/5">
                  <p className="text-white text-sm">
                    <span className="text-elec-yellow">Leading-edge (TRIAC):</span> Cuts the front
                    of the waveform. Works well with incandescent and halogen. Can cause flicker and
                    buzzing with LEDs.
                  </p>
                </div>
                <div className="p-2 rounded bg-white/5">
                  <p className="text-white text-sm">
                    <span className="text-elec-yellow">Trailing-edge:</span> Cuts the back of the
                    waveform. Smoother dimming, recommended for LED loads. Lower minimum load
                    requirements.
                  </p>
                </div>
              </div>
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm">
                Pulse Width Modulation rapidly switches the LED on and off at frequencies too fast
                for the eye to perceive. The ratio of on-time to off-time determines perceived
                brightness. Used internally by smart bulbs for smooth, flicker-free dimming.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h3 className="text-white font-semibold mb-2">0-10V / DALI Dimming</h3>
              <p className="text-white text-sm">
                Professional control protocols that send dimming commands via separate control
                wires. Used in commercial and high-end residential installations with compatible LED
                drivers.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            RGBW bulbs contain four types of LEDs: Red, Green, Blue, and White. By varying the
            intensity of each colour, millions of colour combinations can be produced.
          </p>
          <div className="space-y-3 mb-4">
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">RGB Only</p>
              <p className="text-white text-sm">
                Mixing red, green, and blue can theoretically produce white, but the result has
                colour casts and lower colour rendering. Not ideal for everyday white lighting.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Dedicated White LED</p>
              <p className="text-white text-sm">
                The W in RGBW provides pure, high-quality white light for everyday use. Colour
                mixing creates accents and effects.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">RGBWW / RGBCCT</p>
              <p className="text-white text-sm">
                Advanced bulbs include both warm and cool white LEDs alongside RGB, enabling tunable
                white plus colour options.
              </p>
            </div>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-white text-sm">
              Use RGB colours for entertainment, parties, and accent lighting. Use the white LED for
              everyday activities like cooking, reading, and working.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            ...
            light. Lower values are warmer (more orange/yellow), higher values are cooler (more
            blue).
          </p>
          <div className="space-y-3 mb-4">
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Similar to traditional incandescent bulbs. Creates cosy, relaxing ambience. Ideal
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Balanced light that appears neither warm nor cool. Good for kitchens, bathrooms, and
                offices where clarity is needed.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Cool White (5000-6500K)</p>
              <p className="text-white text-sm">
                Daylight-like appearance with blue tones. Best for task lighting, workshops, and
                spaces where alertness is desired.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Circadian lighting (human-centric lighting) automatically adjusts colour temperature
            throughout the day to support natural sleep-wake cycles.
          </p>
          <div className="space-y-3 mb-4">
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Morning</p>
              <p className="text-white text-sm">
                Cool, bright light (5000K+) helps wake up and promotes alertness. Simulates natural
                morning sunlight.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Neutral white (4000-5000K) maintains energy and focus during working hours.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Evening</p>
              <p className="text-white text-sm">
                Warm light (2700-3000K) reduces blue light exposure, preparing the body for sleep.
              </p>
            </div>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-white text-sm">
              Blue light suppresses melatonin production. Automatic evening shift to warm light can
              improve sleep quality, particularly for those sensitive to artificial light at night.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-3 mb-4">
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Visible or imperceptible light pulsing caused by incompatible dimmers. Can cause
                headaches and eye strain. Solution: Use trailing-edge LED dimmers.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Buzzing</p>
              <p className="text-white text-sm">
                Audible hum from LED drivers struggling with dimmer output. Solution: Match dimmer
                and bulb from manufacturer compatibility lists.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Limited Dimming Range</p>
              <p className="text-white text-sm">
                LEDs may not dim below 20-30% or may turn off abruptly. Check manufacturer
                specifications for dimming range.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Minimum Load Issues</p>
              <p className="text-white text-sm">
                Dimmer requires higher wattage than LED load provides. Solution: Add more bulbs to
                circuit or use a bypass capacitor.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            ...
            <p className="text-white text-sm mb-3">
              A customer wants bedroom lighting that supports both reading and sleep preparation,
              with colour options for ambience.
            </p>
            <p className="text-white text-sm mb-2">
            ...
            <p className="text-white text-sm mt-3">
              <span className="text-elec-yellow">Result:</span> Versatile lighting supporting
              reading, relaxation, and healthy sleep patterns.
            </p>
          </div>
        </section>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="../section-4">Next Section</Link>
          </Button>
        </nav>
      </article>
    </div>
