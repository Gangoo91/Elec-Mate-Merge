...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "Without accurate as-built drawings, future maintenance becomes dangerous and expensive. Technicians cannot safely modify the system, troubleshooting takes much longer, and there's increased risk of electrical accidents.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Allow minimum 2-4 hours for basic operator training, plus additional time for documentation review. Complex systems may require full-day training sessions. Don't rush this critical phase - inadequate training leads to expensive call-backs.",
  },
  {
    question: "What's the best format for providing documentation to clients?",
    answer:
      'Provide both digital and physical copies. Digital formats (PDF) are easily searchable and shareable, while physical copies serve as emergency backup. Use clear folder structures and consistent naming conventions.',
  },
  {
    question: 'Should I provide ongoing support after handover?',
    answer:
      'Yes, offer structured aftercare - perhaps 30-day phone support and a follow-up visit. This builds client confidence, identifies any issues early, and often leads to additional business opportunities.',
  },
  {
    question: 'What if the client seems overwhelmed during training?',
    answer:
      "Simplify the training focus to absolutely essential daily tasks only. Provide written quick-reference guides and offer follow-up training sessions. Don't try to cover everything in one session.",
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      "In the real-world example, why couldn't the school diagnose a fault after installation?",
    options: [
    ...
    correctAnswer: 2,
    explanation:
      "The school couldn't diagnose the fault because they had no documentation (IO lists, software backups, or as-built drawings) to identify which sensor was malfunctioning or how to access system parameters.",
  },
];
...
const BMSModule7Section6 = () => {
  useSEO({
    ...
    description:
      'Learn professional client handover processes, documentation requirements, and training best practices for BMS installations.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white">Professional project completion and handover requirements</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Handover:</strong> Structured training and documentation for clients
              </li>
              <li>
                <strong>Documentation:</strong> As-built drawings, IO lists, software backups
              </li>
              <li>
                <strong>Training:</strong> Daily operations, alarms, reports, emergency procedures
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Project completion phase, client meetings
              </li>
              <li>
                <strong>Use:</strong> Document everything, train operators thoroughly, build
                relationships
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              how to operate it and has all the documentation required for safe and efficient use. A
              rushed or incomplete handover often leads to confusion, system misuse, and expensive
              call-backs.
            </p>
            <p>
              This phase is crucial for the electrician's reputation and project success. Poor
              handover practices lead to call-backs, disputes, and dissatisfied clients, while
              thorough handover builds trust and leads to future business opportunities.
            </p>
            <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
              <p className="text-sm text-white">
                <strong className="text-elec-yellow">Professional Success:</strong> A thorough
                handover is the difference between a one-time job and a long-term client
                relationship. Professional documentation and training demonstrate quality
                workmanship and build trust.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              structured process prevents misunderstandings and reduces the likelihood of system
              misuse.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Electricians play a crucial supporting role in ensuring successful handover by
              providing accurate documentation and technical assistance during client training.
            </p>
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
              <p className="text-sm font-medium text-red-400 mb-2">
                Critical Consequences of Missing Documentation
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Start documentation early</strong> - don't leave IO list updates until the
                  last day
                </li>
                <li>
                  <strong>Interactive demonstrations</strong> - walk through the system with the
                  client, trigger alarms, change setpoints
                </li>
                <li>
                  <strong>Dual format documentation</strong> - provide both digital and hard copies
                </li>
                <li>
                  <strong>Keep training simple</strong> - focus on daily tasks like checking alarms
                  and generating reports
                </li>
                <li>
                  <strong>Hands-on practice</strong> - let operators practice common tasks during
                  training
                </li>
              </ul>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
              <p className="text-sm font-medium text-red-400 mb-3">
                Incomplete Handover Consequences
              </p>
              ...
              <div className="p-3 rounded bg-red-500/10 mb-4">
                <p className="text-sm text-white">
                  <strong>One month later:</strong> A fault occurred in the ventilation system. The
                  facilities team couldn't diagnose the problem because they had no documentation to
                  identify which sensor was malfunctioning or how to access the relevant control
                  parameters.
                </p>
              </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
              <p className="text-sm text-white">
                <strong className="text-elec-yellow">Key Takeaway:</strong> The short-term pressure
                to complete quickly cost far more than the time needed for proper handover.
                Professional standards protect both the contractor's reputation and the client's
                interests.
              </p>
            </div>
          </div>
