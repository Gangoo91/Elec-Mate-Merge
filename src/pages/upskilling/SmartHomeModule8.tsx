      ...
      <div className="px-4 sm:px-6 py-6 sm:py-8">
          ...
          <div className="group relative overflow-hidden bg-elec-yellow/10 backdrop-blur-sm border border-elec-yellow/30 rounded-xl hover:bg-elec-yellow/15 hover:shadow-lg hover:shadow-elec-yellow/10 transition-all duration-300">
            ...
            <div className="relative p-6">
              ...
              <div className="space-y-3 text-white">
                ...
                <p className="flex items-start gap-2">
                  <span className="text-elec-yellow mt-1">•</span>Review your module notes and key
                  concepts
                </p>
                <p className="flex items-start gap-2">
                  <span className="text-elec-yellow mt-1">•</span>Find a quiet environment with
                  stable internet connection
                </p>
                <p className="flex items-start gap-2">
                  <span className="text-elec-yellow mt-1">•</span>Allow uninterrupted time for the
                  full 60-minute duration
                </p>
                <p className="flex items-start gap-2">
                  <span className="text-elec-yellow mt-1">•</span>Have a calculator and notepad
                  available if needed
                </p>
              </div>
            </div>
        ...
        <div className="flex justify-center pt-6">
          <Link to="/electrician/upskilling/smart-home-mock-exam">
            <Button className="bg-elec-yellow text-black hover:bg-elec-yellow/90 transition-all duration-200 px-8 py-3 text-lg font-semibold min-h-[48px] touch-manipulation active:scale-[0.98]">
