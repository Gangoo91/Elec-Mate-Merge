...
const DESCRIPTION =
  'Master fibre optic troubleshooting tools including visual fault locators, power meters, light sources, and OTDR trace interpretation for effective fault diagnosis.';
...
const quickCheckQuestions = [
  {
    ...
    explanation:
      "A VFL injects visible red laser light (typically 650nm) into the fibre. Light escapes at breaks, tight bends, and faulty connections, making them visible. It's a fast, simple tool for fault location and continuity verification.",
  },
  {
    ...
    explanation:
      'A gainer (apparent gain) occurs when splicing fibres with different backscatter properties. Testing from fibre with lower backscatter into higher backscatter fibre creates an apparent increase in power. Bi-directional testing and averaging reveals the true loss.',
  },
  {
    ...
    options: [
      ...
      {
        text: 'The distance after a reflective event where the OTDR cannot detect other events',
        isCorrect: true,
      },
    ...
    explanation:
      'After a reflective event (connector), the OTDR receiver is saturated and cannot detect other events for a short distance—the dead zone. This limits how close together events can be distinguished. Shorter pulse widths reduce dead zones but also reduce range.',
  },
];
...
const quizQuestions = [
  {
    ...
    explanation:
      'VFLs use visible red light at approximately 650nm so that light escaping at fault points can be seen by the naked eye. Most can also be seen through cable jackets or orange OM1/OM2 fibre coatings.',
  },
  {
    question:
      'When using an optical power meter and light source for loss testing, what is the correct test procedure?',
    options: [
      { text: 'Measure power at transmitter only', isCorrect: false },
      {
        text: 'Set reference with test leads, then measure through link under test',
        isCorrect: true,
      },
    ...
    explanation:
      'The reference measurement establishes the baseline with your test leads connected. The link loss is then the difference between the reference power and the power measured through the link under test.',
  },
  {
    ...
    options: [
      ...
      {
        text: 'Rayleigh backscatter and Fresnel reflections returning to the source',
        isCorrect: true,
      },
    ...
    explanation:
      'The OTDR sends pulses down the fibre and analyses light that returns—both Rayleigh backscatter (continuous low-level return from the fibre itself) and Fresnel reflections (bright returns from connectors, breaks, etc.).',
  },
  {
    ...
    explanation:
      'Fusion splices show as small loss events (0.02-0.1 dB typically) with minimal or no reflection because there is no air gap. Mechanical splices show similar loss but with more reflection from the index matching material.',
  },
  {
    ...
    options: [
      ...
      {
        text: 'It detects problems that unidirectional testing misses completely',
        isCorrect: false,
      },
    ],
    explanation:
      'Bi-directional testing and averaging eliminates gainer effects caused by different backscatter coefficients between fibre sections. The average of both directions gives the true splice loss value.',
  },
  {
    ...
    explanation:
      'Shorter pulse widths provide better resolution (smaller dead zones, ability to see closely-spaced events) but reduce range. Longer pulses provide more energy for long-distance testing but create larger dead zones.',
  },
  {
    ...
    explanation:
      'A non-reflective break (clean fracture) shows as a sudden drop to the noise floor with no reflection. A reflective end-of-fibre (connector or rough break) shows a spike before the drop.',
  },
  {
    ...
    explanation:
      '1625nm (and 1650nm) wavelengths are more sensitive to macrobends and microbends than 1550nm. Testing at these wavelengths can reveal stress points and bends that appear acceptable at shorter wavelengths.',
  },
  {
    ...
    explanation:
      'The OTDR has a dead zone after its own connector. A launch fibre (typically 100-500m) moves the first connection of the link under test outside this dead zone so it can be properly characterised.',
  },
  {
    ...
    explanation:
      'Averaging multiple measurements reduces random noise, producing a cleaner trace. This is especially useful for long links or when looking for small events. More averaging takes more time but improves measurement quality.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Not always. A VFL can quickly locate breaks and tight bends. A power meter and light source can verify link loss. These simpler tools handle many common problems. An OTDR is essential for precisely locating faults in long cables, characterising multiple events, and professional documentation.',
  },
  {
    question: "Why doesn't my OTDR show the first connector properly?",
    answer:
      "The OTDR's dead zone extends from its port for some distance (specified in metres). Events within this zone cannot be characterised. Use a launch fibre to move your first connector beyond the dead zone. The launch fibre length depends on your OTDR's specifications and pulse width setting.",
  },
  {
    question: 'Can I test a live fibre link with an OTDR?',
    answer:
      "Generally no—active traffic will interfere with OTDR measurements and the OTDR's pulses can damage receivers. Some OTDRs can test at 1625nm or 1650nm on live links (these wavelengths aren't used for traffic), but the fibre must be specifically provisioned for this. Always verify the fibre is dark before standard OTDR testing.",
  },
  {
    question: "What's the difference between event dead zone and attenuation dead zone?",
    answer:
      'Event dead zone is the minimum distance at which two separate reflective events can be distinguished. Attenuation dead zone is the minimum distance after a reflection where a non-reflective event (like a splice) can be measured. Attenuation dead zone is always longer than event dead zone.',
  },
  {
    question: 'My OTDR shows a loss much higher than expected—what should I check?',
    answer:
      'First verify the Group Index of Refraction (IOR) setting matches your fibre type. Wrong IOR gives incorrect distance readings. Then check for dirty connectors (including the OTDR port), wrong wavelength selection, or a genuine fault in the link. Compare with a power meter measurement to verify total loss.',
  },
  {
    question: 'When should I test at multiple wavelengths?',
    answer:
      'Multi-wavelength testing (1310nm and 1550nm for singlemode, or 850nm and 1300nm for multimode) provides more complete link characterisation. Wavelength-dependent loss can indicate bends. Testing at 1625nm helps identify marginal bends that pass at shorter wavelengths.',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <div className="sticky top-0 z-50 bg-[#1a1a1a]/95 backdrop-blur-sm border-b border-white/10">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <span className="text-white text-sm">Section 3 of 5</span>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-3 mb-8">
            <div className="bg-[#252525] rounded-lg p-4 border border-white/10">
              ...
              <p className="text-white text-xs">
                Visual fault locators, power meters, light sources
              </p>
            </div>
            <div className="bg-[#252525] rounded-lg p-4 border border-white/10">
              <BarChart3 className="w-6 h-6 text-elec-yellow mb-2" />
              <h3 className="text-white font-semibold text-sm mb-1">OTDR</h3>
              <p className="text-white text-xs">Trace interpretation and fault location</p>
            </div>
          </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white mb-6">
              <p>
                A <strong className="text-white">Visual Fault Locator</strong> is one of the most
                useful basic troubleshooting tools. It injects visible red laser light (typically
                650nm) into the fibre. This light escapes at fault points—breaks, tight bends, and
                bad connections—making them visible to the naked eye.
              </p>
            </div>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">
                      Quickly confirm fibre runs through to far end
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">
                      Visible glow at break point (within ~5km)
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">Light leaks at excessively tight bends</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <div>
                    ...
                    <p className="text-white text-sm">
                      Light at adapter indicates poor connection or uncleaned ends
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">
                      Identify which fibre in a bundle is which
                    </p>
                  </div>
                </li>
              </ul>
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4 mb-6">
              ...
              <p className="text-white text-sm">
                VFLs are typically Class 2 or Class 3R lasers.{' '}
                <strong className="text-white">
                  Never look directly into the output or the end of an illuminated fibre.
                </strong>{' '}
                Even brief exposure can cause eye damage. Always treat VFL light as hazardous.
              </p>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white mb-6">
              <p>
                The <strong className="text-white">optical power meter</strong> and{' '}
                <strong className="text-white">calibrated light source</strong> (or combined "loss
                test set") are essential for measuring insertion loss—the total optical power lost
                through a fibre link.
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="border-b border-white/10 pb-4">
                  <h5 className="text-elec-yellow font-medium mb-2">
                    1-Cord Reference (Most Common)
                  </h5>
                  <p className="text-white text-sm mb-2">
                    Reference set with one test lead. Tests all connectors in the link including
                    both end connections.
                  </p>
                  <div className="bg-[#1a1a1a] p-2 rounded font-mono text-xs text-white">
                ...
                <div className="border-b border-white/10 pb-4">
                  ...
                  <p className="text-white text-sm mb-2">
                    Reference set with both test leads connected. Tests link under test only,
                    excluding end connections.
                  </p>
                  <div className="bg-[#1a1a1a] p-2 rounded font-mono text-xs text-white">
                ...
                <div>
                  ...
                  <p className="text-white text-sm mb-2">
                    Reference includes both test leads and an additional jumper. Most conservative
                    method.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 p-4 rounded-r-lg mb-6">
              ...
              <ol className="text-white text-sm space-y-2">
                <li>
                  <span className="text-elec-yellow font-bold">1.</span> Allow equipment to
                  stabilise (warm up ~5 minutes)
                </li>
                <li>
                  <span className="text-elec-yellow font-bold">2.</span> Clean all test lead
                  connectors and verify with inspection scope
                </li>
                <li>
                  <span className="text-elec-yellow font-bold">3.</span> Connect test leads and set
                  reference (zero the meter)
                </li>
                <li>
                  <span className="text-elec-yellow font-bold">4.</span> Connect link under test
                  (clean all connectors first)
                </li>
                <li>
                  <span className="text-elec-yellow font-bold">5.</span> Record loss reading
                </li>
                <li>
                  <span className="text-elec-yellow font-bold">6.</span> Test at second wavelength
                  if required
                </li>
                <li>
                  <span className="text-elec-yellow font-bold">7.</span> Test in reverse direction
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white mb-6">
              <p>
                An <strong className="text-white">OTDR</strong> is a sophisticated instrument that
                can characterise an entire fibre link from one end. It sends pulses of light down
                the fibre and analyses the returning light to create a graphical "trace" showing
                every event along the link.
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">
                      OTDR transmits short pulses of light down the fibre
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">
                      Microscopic glass impurities scatter small amounts of light back continuously
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">
                      Strong reflections occur at air gaps (connectors, breaks)
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">
                      Return time converts to distance (knowing speed of light in fibre)
                    </p>
                  </div>
                </div>
              </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-white/20">
                      <th className="text-left py-2 px-3 text-white font-medium">Parameter</th>
                      <th className="text-left py-2 px-3 text-white font-medium">Effect</th>
                      <th className="text-left py-2 px-3 text-white font-medium">Trade-off</th>
                    </tr>
                  </thead>
                  <tbody className="text-white">
                    <tr className="border-b border-white/10">
                      ...
                      <td className="py-2 px-3 text-white">
                        Shorter = better resolution, less range
                      </td>
                    </tr>
                    <tr className="border-b border-white/10">
                    ...
                    <tr>
                      ...
                      <td className="py-2 px-3 text-white">
                        Must match fibre type for accuracy
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white mb-6">
              <p>
                Reading an OTDR trace is a critical skill. The trace shows distance (horizontal
                axis) versus return power level in dB (vertical axis). Different events have
            ...
            <div className="bg-[#252525] rounded-lg p-5 border border-white/10 mb-6">
              ...
              <div className="space-y-4">
                <div className="border-b border-white/10 pb-4">
                  ...
                  <p className="text-white text-sm">
                    Sharp spike upward (reflection) followed by a step down (loss). Height indicates
                    reflectance, step indicates insertion loss.
                  </p>
                </div>
                ...
                <div className="border-b border-white/10 pb-4">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h5 className="text-blue-400 font-medium">
                      Non-Reflective Event (Fusion Splice)
                    </h5>
                  </div>
                  <p className="text-white text-sm">
                    Small step down with no spike. Loss only, no reflection. Typical for fusion
                    splices and bends.
                  </p>
                </div>
                ...
                <div className="border-b border-white/10 pb-4">
                  ...
                  <p className="text-white text-sm">
                    Apparent step up (gain). Occurs at splices between fibres with different
                    backscatter. Not real gain—artefact requiring bi-directional averaging.
                  </p>
                </div>
                ...
                <div className="border-b border-white/10 pb-4">
                  ...
                  <p className="text-white text-sm">
                    Large spike then drop to noise floor. Occurs at connectors, cleaved ends, or
                    rough breaks at fibre end.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-white text-sm">
                    Sudden drop to noise floor with no spike. Indicates clean break or fibre
                    immersed in index-matching material.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white mb-6">
              <p>
                <strong className="text-white">Dead zones</strong> are distances after a reflective
                event where the OTDR cannot accurately measure other events. Understanding dead
                zones is essential for proper test setup and interpretation.
              </p>
            </div>
            ...
            <div className="bg-[#252525] rounded-lg p-5 border border-white/10 mb-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-amber-500/10 p-4 rounded-lg border border-amber-500/30">
                  ...
                  <p className="text-white text-sm mb-2">
                    Minimum distance to distinguish two separate reflective events.
                  </p>
                  <p className="text-white text-sm">Typical: 0.5-3m depending on pulse width</p>
                </div>
                <div className="bg-blue-500/10 p-4 rounded-lg border border-blue-500/30">
                  <h5 className="text-blue-400 font-medium mb-2">Attenuation Dead Zone</h5>
                  <p className="text-white text-sm mb-2">
                    Distance after reflection where non-reflective events can be measured.
                  </p>
                  <p className="text-white text-sm">Typical: 3-20m depending on pulse width</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 p-4 rounded-r-lg mb-6">
              ...
              <ul className="text-white text-sm space-y-1">
                <li>
                  • <strong className="text-white">Launch fibre:</strong> 100-500m fibre between
                  OTDR and link under test. Moves first connector outside dead zone.
                </li>
                <li>
                  • <strong className="text-white">Receive fibre:</strong> Similar fibre at far end.
                  Allows characterisation of last connector.
                </li>
                <li>
                  • Launch/receive fibres must match the link fibre type (SM or MM, same core size).
                </li>
              </ul>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white mb-6">
              <p>
                Because different fibres have different backscatter properties, splices between them
                can appear as gainers or show incorrect loss when measured from one direction.{' '}
                <strong className="text-white">Bi-directional testing and averaging</strong> reveals
                the true splice loss.
              </p>
            </div>
            ...
            <div className="bg-[#252525] rounded-lg p-5 border border-white/10 mb-6">
              ...
              <div className="bg-[#1a1a1a] p-4 rounded-lg font-mono text-sm mb-4">
                <p className="text-white mb-2">
                  Direction A→B: Splice appears as +0.2 dB (gainer)
                </p>
                <p className="text-white mb-2">
                  Direction B→A: Splice appears as -0.4 dB (loss)
                </p>
                <p className="text-elec-yellow mt-3">
                  True Loss = (0.2 + 0.4) ÷ 2 = <strong>0.1 dB</strong>
                </p>
              </div>
              <p className="text-white text-sm">
                Many modern OTDRs can automatically perform bi-directional analysis when provided
                with traces from both directions.
              </p>
            </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">
                      Confirm transceivers are powered and not faulty using known-good test
                      equipment
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">
                      Inspect all accessible connectors; clean and re-test before further
                      investigation
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">
                      Use VFL to verify continuity and identify obvious breaks or tight bends
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">
                      Measure total loss with power meter; compare to specification
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">
                      If problem persists, use OTDR to locate and characterise specific faults
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm">
                      Record findings, repair fault, re-test to confirm resolution
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* Quiz Section */}
          <section className="mb-12">
            <Quiz title="Section 3 Knowledge Check" questions={quizQuestions} passingScore={80} />
          </section>
