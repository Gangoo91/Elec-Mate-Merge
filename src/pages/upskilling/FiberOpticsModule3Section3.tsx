...
const DESCRIPTION =
  'Master fibre optic cable routing through tray, conduit, basket, and duct systems. Learn UK containment standards, fill ratios, and installation techniques for reliable networks.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'The standard maximum fill ratio for conduit is 40% of cross-sectional area. This allows for cable movement during pulling and future additions.',
  },
  {
    id: 'fo-m3s3-qc2',
    ...
    options: [
      ...
      'Flexible routing with good ventilation',
      'Fire-rated applications only',
    ],
    correctIndex: 2,
    explanation:
      "Cable basket provides excellent ventilation for heat dissipation, flexible routing options, and easy cable additions. It's ideal for data centres and open ceiling installations.",
  },
  {
    id: 'fo-m3s3-qc3',
    ...
    correctIndex: 2,
    explanation:
      'BS 6701 recommends minimum 50mm separation or a physical barrier between fibre and power cables to prevent damage from heat and electromagnetic interference with any metallic elements.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Yes—fibre cables can share containment with copper data cables (Cat5e, Cat6, Cat6A) as there's no electromagnetic coupling risk. The glass fibre is immune to interference. However, maintain good cable management practices and don't overload containment. Some organisations prefer separation for management simplicity.",
  },
  {
    question: 'Do I need special containment for external fibre routes?',
    answer:
      "External routes typically use underground duct (HDPE or PVC), buried direct (armoured cable), or aerial messenger wire. Standard internal tray/basket isn't rated for outdoor use. Use UV-resistant materials for exposed runs. Duct should be watertight with proper sealing at chambers and building entries.",
  },
  {
    question: 'How do I calculate if my conduit is large enough?',
    answer:
      'Calculate total cable cross-sectional area, divide by conduit internal area—keep below 40% fill. For multiple cables, check jam ratio (conduit diameter ÷ cable diameter) is below 0.8 to prevent jamming. Use manufacturer software or tables for complex pulls. Include spare capacity for future cables.',
  },
  {
    question: "What's the difference between ladder rack and cable tray?",
    answer:
      'Ladder rack has side rails with cross-members (rungs) and open bottom—excellent ventilation, best for heavy cable loads and data centres. Cable tray has a solid or perforated bottom—better for smaller cables, prevents sagging, may meet fire requirements. Both available in steel or aluminium with various finishes.',
  },
  {
    question: 'Can I use plastic conduit for fibre?',
    answer:
      'Yes—PVC and HDPE conduit are commonly used for fibre. PVC is rigid and suits internal use. HDPE (high-density polyethylene) is flexible and used for external/underground routes. Ensure conduit is approved for the application and fire ratings meet building requirements for internal use.',
  },
  {
    question: 'How do I maintain bend radius at containment direction changes?',
    answer:
      'Use appropriate fittings: 90° swept bends with adequate inner radius (not sharp corners), reducers when changing size, tee-pieces with proper radius. For tray, use internal/external radius bends that match or exceed cable bend requirements. Check all direction changes before pulling cable.',
  },
];
      ...
      <main className="container max-w-4xl mx-auto px-4 py-6 space-y-8">
        ...
        <section className="grid sm:grid-cols-2 gap-4">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-sm text-white">
              Conduit fill: 40% max. Tray: maintain bend radius at fittings. Basket: great
              ventilation. Segregate from power (50mm min). Support vertical runs every 1-1.5m.
            </p>
          </div>
          <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
            ...
            <p className="text-sm text-white">
              Plan route before pulling. Check bend radius at all turns. Use appropriate fittings.
              Leave draw cord for future pulls. Label routes and containment.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-3">
            <span className="flex items-center justify-center w-8 h-8 rounded-full bg-elec-yellow text-background font-bold text-sm">
              01
            </span>
          ...
          <div className="space-y-4 text-white">
            <p>
              Cable tray provides a continuous support system for routing fibre cables across long
              horizontal and vertical distances. Available in various configurations, tray systems
              are widely used in commercial buildings, data centres, and industrial facilities.
            </p>
            ...
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              <h4 className="font-semibold text-elec-yellow mb-3">
                Tray Installation Requirements
              </h4>
              <div className="space-y-2 text-sm text-white">
                <div className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                  <span>
                    <strong>Support spacing:</strong> Maximum 1.5-2m for horizontal runs
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                  <span>
                    <strong>Bends:</strong> Use swept bends maintaining minimum cable radius
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                  <span>
                    <strong>Earthing:</strong> Metallic tray must be bonded to earth (BS 7671)
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                  <span>
                    <strong>Cover:</strong> Use where mechanical protection or fire rating required
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                  <span>
                    <strong>Fill:</strong> Leave 25% space for future cables and maintenance access
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-amber-500/10 border-l-2 border-amber-500/50">
              ...
              <p className="text-sm text-white">
                Factory-made tray bends come in standard radii (typically 150mm, 300mm, 450mm inside
                radius). Verify the bend radius of fittings exceeds the minimum bend radius for all
                cables that will be installed. A 90° bend with 150mm inner radius may be
                insufficient for larger fibre cables requiring 200mm minimum radius.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-white">
            <p>
              Conduit provides enclosed protection for fibre cables, particularly useful where
              cables must be concealed in walls, floors, or protected from damage. Proper sizing is
              critical to enable installation and future cable additions.
            </p>
            ...
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              ...
              <div className="space-y-3 text-sm text-white">
                <div>
                  ...
                  <p>
                    Galvanised or stainless steel. High mechanical protection. Requires earthing.
                    Used in industrial environments or where EMI shielding beneficial for any
                ...
                <div>
                  ...
                  <p>
                    Rigid PVC for internal use. Round or oval profiles. Light, easy to install.
                    Check fire rating for building requirements. Common for data cabling.
                  </p>
                </div>
                <div>
                  <h5 className="font-medium text-white">Flexible Conduit</h5>
                  <p>
                    Metal or plastic corrugated tube. Allows routing around obstacles. Not for long
                    runs due to increased friction. Useful for final connection to equipment.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
              ...
              <p className="text-sm mb-3 text-white">
                Maximum fill ratio ensures cables can be pulled without damage and allows for
                expansion:
              </p>
              <ul className="text-sm space-y-1 text-white">
                <li>
                  - <strong>Single cable:</strong> 53% maximum cross-sectional fill
                </li>
                <li>
                  - <strong>Two cables:</strong> 31% maximum
                </li>
                <li>
                  - <strong>Three or more:</strong> 40% maximum
                </li>
                <li>
                  - <strong>Best practice:</strong> Aim for 25-30% for future capacity
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              ...
              <p className="text-sm text-white mb-2">
                For multiple cables, the <strong>jam ratio</strong> predicts whether cables will jam
                during pulling:
              </p>
              ...
              <ul className="text-sm space-y-1 mt-3 text-white">
                <li>
                  - <strong>Below 0.6:</strong> No jamming risk
                </li>
                <li>
                  - <strong>0.6 - 0.8:</strong> Acceptable, careful installation
                </li>
                <li>
                  - <strong>Above 0.8:</strong> High jam risk - use larger conduit
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
              ...
              <p className="text-sm text-white">
                Install <strong>pull boxes</strong> to break up long conduit runs, change direction,
                or provide access points. Recommended at maximum 30m intervals for straight runs,
                and at direction changes exceeding 90° cumulative. Pull boxes make installation
                easier and enable future cable additions without full re-pulls.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-white">
            <p>
              Cable basket (wire mesh tray) has become popular for data and fibre cable
              installations due to its flexibility, ventilation, and ease of cable management. The
              open mesh design allows excellent airflow and simple cable additions.
            </p>
            ...
            <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
              ...
              <p className="text-sm text-white">
                Wire basket is the preferred containment in many data centres. The open design
                allows hot exhaust air from equipment to dissipate rather than being trapped.
                Multiple tiers can run above cabinets—typically separating power, fibre, and copper
                runs. Standard colours (often yellow for fibre) aid identification.
              </p>
            </div>
            ...
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              ...
              <ul className="text-sm space-y-2 text-white">
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                  <span>
                    <strong>Support:</strong> Maximum 1.5m centres, closer for heavy loads
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                  <span>
                    <strong>Fill:</strong> Cables should not extend above basket sides
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                  <span>
                    <strong>Bends:</strong> Use proprietary bend fittings with adequate radius
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                  <span>
                    <strong>Earthing:</strong> Metal basket must be earthed per BS 7671
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                  <span>
                    <strong>Finish:</strong> Zinc plated, hot-dip galvanised, or powder-coated
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-white">
            <p>
              Underground duct provides the primary route for external fibre cables between
              buildings, to street cabinets, and for campus/metropolitan networks. Proper duct
              installation is critical for long-term reliability and future cable capacity.
            </p>
            ...
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              ...
              <div className="space-y-3 text-sm text-white">
                <div>
                  ...
                  <p>
                    High-density polyethylene. Flexible, supplied in coils. Standard for
                    direct-buried and pulled installations. Black or coloured for identification.
                    32mm-110mm typical sizes.
                  </p>
                </div>
                <div>
                  <h5 className="font-medium text-white">PVC Duct</h5>
                  <p>
                    Rigid PVC in straight lengths. Used for building entries and shorter runs.
                    Requires more joints than HDPE. 50mm-150mm typical sizes.
                  </p>
                </div>
                <div>
                  <h5 className="font-medium text-white">Micro-Duct</h5>
                  <p>
                    Small bore (5-14mm) for fibre blowing. Multiple tubes in bundle or within larger
                    duct. Enables incremental fibre deployment. FTTH and metro networks.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              ...
              <div className="space-y-2 text-sm text-white">
                <div className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                  <span>
                    <strong>Depth:</strong> Minimum 450mm in footways, 600mm in carriageways (NJUG
                    guidance)
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                  <span>
                    <strong>Bedding:</strong> 50mm sand bed below duct, 75mm cover above
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                  <span>
                    <strong>Warning:</strong> Marker tape 300mm above duct
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                  <span>
                    <strong>Draw cord:</strong> Install cord/rope for future cable pulls
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5" />
                  <span>
                    <strong>Seal:</strong> Seal duct ends to prevent water/debris ingress
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-green-500/5 border-l-2 border-green-500/50">
              ...
              <p className="text-sm text-white">
                Install <strong>access chambers</strong> at regular intervals (typically 200-300m
                maximum), at direction changes, and at junction points. Chambers allow pulling,
                jointing, and future maintenance access. Size chambers for the number of ducts and
                anticipated work. Include cable racks or saddles for proper cable management within
                chambers.
              </p>
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-white">
            <p>
              While fibre cables are immune to electromagnetic interference,{' '}
              <strong>segregation</strong> from power cables remains important for physical
              protection, heat management, and compliance with installation standards.
            </p>
            ...
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              ...
              <div className="space-y-2 text-sm text-white">
                <div className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Minimum separation:</strong> 50mm or physical barrier
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 text-amber-400 mt-0.5" />
                  <span>
                    <strong>Crossings:</strong> Cross at right angles, minimise parallel runs
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 text-amber-400 mt-0.5" />
                  <span>
                    <strong>High voltage:</strong> Increase separation for &gt;1kV systems
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 text-amber-400 mt-0.5" />
                  <span>
                    <strong>Heat sources:</strong> Consider cable heating from power cables
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-blue-500/5 border-l-2 border-blue-500/50">
              ...
              <p className="text-sm text-white">
                Segregation protects against: <strong>physical damage</strong> during power cable
                maintenance, <strong>heat</strong> from high-current cables degrading fibre jacket,
                and <strong>induced voltage</strong> in any metallic elements (armour, strength
                members). Additionally, regulatory compliance (BS 6701, BS 7671) requires
                segregation regardless of cable type.
              </p>
            </div>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-white">
            <p>
              Vertical cable runs in risers and shafts require special attention to{' '}
              <strong>support</strong> and <strong>strain relief</strong>. Cable weight accumulates
              over height, and without proper support, cables can stretch, stress connectors, or
              pull out of terminations.
            </p>
            ...
            <div className="p-4 rounded-lg bg-amber-500/10 border-l-2 border-amber-500/50">
              ...
              <p className="text-sm text-white">
                For long vertical drops (multi-storey buildings), calculate cumulative cable weight.
                Standard fibre cable weighs 20-50kg per 100m. Over a 30m drop, that's 6-15kg pulling
                on the top termination. Use <strong>intermediate anchor points</strong> or cable
                clamps that grip without crushing to distribute weight.
              </p>
            </div>
        ...
        <section className="p-6 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <div className="grid sm:grid-cols-2 gap-4 text-sm">
            <div className="space-y-2">
              ...
              <div className="space-y-1 text-white">
                <p>
                  <strong>Conduit (multi-cable):</strong> 40% max
                </p>
                <p>
                  <strong>Tray:</strong> 50% or below sides
                </p>
                <p>
                  <strong>Jam ratio:</strong> Keep below 0.8
                </p>
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="space-y-1 text-white">
                <p>
                  <strong>From power:</strong> 50mm or barrier
                </p>
                <p>
                  <strong>From data:</strong> Not required
                </p>
                <p>
                  <strong>Crossings:</strong> Right angles
                </p>
              </div>
            </div>
          </div>
          <div className="mt-4 pt-4 border-t border-elec-yellow/30 text-sm text-white">
            <p>
              <strong>Vertical support:</strong> 1-1.5m intervals | <strong>Tray support:</strong>{' '}
              1.5-2m intervals
            </p>
          </div>
        </section>
        ...
        {/* Quiz Section */}
        <section className="bg-white/5 rounded-xl p-6 border border-white/10">
          <Quiz title="Routing and Containment Quiz" questions={quizQuestions} passingScore={80} />
        </section>
