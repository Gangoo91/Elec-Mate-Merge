...
const inlineChecks = [
  {
    id: 'elm6-s4-coredocs',
    question:
      'Which set of documents must the responsible person be able to produce immediately on demand to a Fire and Rescue Service inspector under RRO 2005 Article 27?',
    options: [
  ...
  },
  {
    id: 'elm6-s4-art31',
    question:
      'A Fire and Rescue Service inspector identifies that emergency lighting in the only escape stair from a basement nightclub has not worked for 3 months. Which notice is most likely?',
    options: [
  ...
  },
  {
    id: 'elm6-s4-bsr',
    question:
      'For an HRB on the BSR register, what additional documentation requirement applies to emergency lighting records?',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'Which document under BS 5266-1:2025 records the design intent and is the foundation of subsequent verification?',
    options: [
  ...
  },
  {
    id: 2,
    question:
      'BS EN 50172:2024 sets the test regime for emergency escape lighting systems. What are the three test cycles?',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'BS EN 60598-2-22 is the product standard most relevant to emergency luminaires. What does it cover?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'What is the difference between an Article 30 enforcement notice and an Article 31 prohibition notice?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'A 7-storey block of flats containing 20 residential units and a single commercial unit at ground floor was registered as an HRB in 2024. The Building Safety Regulator has scheduled a Stage 1 audit. What documentation specifically for emergency lighting should the Accountable Person prepare?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'A fire causes serious injury in a building. The post-incident investigation finds that emergency lighting on the escape route had not worked for 6 months prior to the fire. Logbook entries from the last 6 months are missing. Which offence is most likely?',
    options: [
  ...
  },
  {
    id: 9,
    question:
      'A building changes hands. What documentation must the outgoing RP provide to the new RP for emergency lighting?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Emergency lighting compliance lives or dies on the documentary trail. The system itself
          can be perfect, but if the responsible person cannot produce the design-and-installation
          record, the logbook, the certificates and the FRA on demand, the audit fails. This section
          walks the documentation set the responsible person must hold, the typical FRS audit
          sequence, the notices and offences under RRO 2005 Articles 29-32, the BSA 2022 Higher-Risk
          Building regime, retention and digital-vs-paper tradeoffs, and what to do when an
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              9(6) where 5+ employees / licence / alterations notice; PAS 79-1:2020 (non-housing) or
              PAS 79-2:2020 (housing) methodology. Significant findings + action plan. Annually
              reviewed.
            </li>
            <li>
            ...
            <li>
              ...
              specified illuminance. In-situ measurement at sample points. Signed by the competent
              person.
            </li>
            <li>
              <strong>(4) BS EN 50172:2024 logbook.</strong> The on-going test record. Daily visual
              checks (where applicable to central-battery / addressable systems); monthly functional
              tests of every luminaire; annual full-duration tests of every luminaire. Pass / fail
              per luminaire; remedial actions recorded; closure evidence. Format may be paper or
              digital.
            </li>
            <li>
            ...
            <li>
              ...
              certificates. One per luminaire type. Evidence that the equipment is fit for emergency
              lighting use.
            </li>
            <li>
            ...
            <li>
              ...
              emergency lighting interacts with the fire alarm (early activation, refuge call- point
              lighting, high-risk task lighting on alarm), the cause-and-effect document records the
              integration; the fire alarm logbook supports it.
            </li>
            <li>
              ...
              residential premises — building evacuation plan, Person-Centred Fire Risk Assessments,
              PEEPs for residents needing assistance, FRS information sharing. Reg 9 of SI 2022/547
              requires the RP to provide each resident with fire safety instructions consistent with
              the evacuation strategy. PAS 79 Step 6 / 8 covers non-residential evacuation plans.
              Personal emergency evacuation plans for individuals needing them. EL is a dependency
              for all of these.
            </li>
            <li>
              <strong>(11) Training records.</strong> Article 21 (training) records for employees.
              EL-relevant training: location of escape routes, refuges, assembly points; what to do
              if EL fails; competent person certification for those conducting tests.
            </li>
            <li>
              <strong>(12) Manufacturer data and replacement schedule.</strong> Battery replacement
              schedule (typically 4-year for self-contained units), luminaire lifecycle, spare parts
              availability. The forward plan that turns reactive failures into planned replacements.
            </li>
          </ul>
          <p>
            For HRBs, all twelve sit within the safety case + Golden Thread. For non-HRB premises,
            they are the working compliance pack. Either way, they are the documentation set an
            inspector expects to see and that a court will read first.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              A design-and-installation record should be prepared and retained for the life of the
              installation, recording the design intent, the FRA findings to which the design
              responds, the photometric calculations against BS EN 1838:2024 minima, the equipment
              installed (with reference to BS EN 60598-2-22 certificates of conformity), the layout,
              the circuit topology, the test regime to BS EN 50172:2024, the cause-and-effect
              interactions where applicable, the boundary of design including external escape
              routes, and the commissioning record. The logbook should be retained on the premises
              and made available to the responsible person, the competent person, and any inspector
              authorised under the relevant statutory regime.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>§7.2.1 Daily — visual inspection.</strong> For central battery and addressable
              systems with central monitoring. A brief check of indicator lamps showing system
              status. Recorded in the logbook.
            </li>
            <li>
              <strong>§7.2.2 Monthly — functional test.</strong> Each emergency luminaire operated
              by simulated mains failure for a brief period (sufficient to verify the lamp lights,
              the changeover works, the battery has output). Recorded per luminaire as pass / fail,
              dated, signed.
            </li>
            <li>
              <strong>§7.2.3 Annual — full duration test.</strong> Each emergency luminaire operated
              for its full rated duration (typically 3 hours). Tests battery capacity under load.
              Recorded per luminaire as pass / fail, dated, signed. Failed luminaires recharged
              after test (recharge period typically 24 hours; fault indicators documented).
            </li>
            <li>
            ...
            <li>
              ...
              luminaire identified by location and reference); the test schedule; test entries with
              date, person, result, comments; remedial actions with date opened, action taken, date
              closed, evidence; battery replacement records; modifications.
            </li>
            <li>
              <strong>Format.</strong> Paper or digital. Both must be tamper-evident, signed (or
              digitally authenticated), and producible on demand. Digital logbooks are now industry
              standard but bring portability and contractor-dependence risks.
            </li>
            <li>
              <strong>Storage.</strong> On the premises (typically near the fire alarm panel) or
              immediately accessible electronically. The logbook must be available to: the RP; the
              competent person conducting tests; the FRS inspector under Article 27; the BSR for
              HRBs; the maintenance contractor.
            </li>
            <li>
              <strong>Retention.</strong> 6 years rolling minimum; longer for HRBs (Golden Thread).
              Some operators retain permanently as part of the building's historical record.
            </li>
          </ul>
          <p>
            The logbook is the working document of EL compliance. The FRA is the strategic
            foundation, the design record is the engineering base, the commissioning certificate is
            the day-of-handover evidence — but the logbook is the thing that proves the system has
            been kept alive and maintained.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              remedial action, and dates and brief details of each test, including the duration of
              any test. The logbook should be available for inspection by an authorised person.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Trigger.</strong> 5 years from commissioning, then every 5 years. Or earlier
              if the FRA review identifies a trigger (significant building change, modification,
              repurposing). The cycle aligns with typical periodic EICR cycles in commercial
              premises — many operators run the two together.
            </li>
            <li>
              <strong>Method.</strong> A competent person uses a calibrated illuminance meter to
              measure horizontal illuminance at sample points across the full open width of escape
              routes (with edge exclusions per BS EN 1838:2024 §4.2), in anti-panic open areas,
              vertical illuminance at refuge call-points and at safety signs, and 15 lx / 10 % at
              high-risk task areas. Sample density per BS 5266-1:2025 guidance.
            </li>
            <li>
              <strong>Comparison against design.</strong> The measured values are compared against
              the BS 5266-1:2025 design-and-installation record. Pass if measured ≥ design (with a
              tolerance band per the standard); fail if below.
            </li>
            <li>
            ...
            <li>
              <strong>Certificate.</strong> A signed certificate from the competent person recording
              the measurements, the comparison, the pass / fail result, any remediation actions, and
              the next verification due date.
            </li>
            <li>
              <strong>Integration with FRA review.</strong> A pass on the 5-year verification
              supports the FRA finding that EL is adequate; a fail is itself a significant finding
              feeding the FRA action plan and the safety case for HRBs.
            </li>
            <li>
              <strong>Competent person.</strong> The 5-year verification is more demanding than
              routine maintenance. The competent person should hold relevant training (e.g. the ICEL
              / Industry Committee for Emergency Lighting competence framework) and use calibrated
              equipment.
            </li>
          </ul>
          <p>
            The 5-year photometric is the only direct empirical test that the EL is still doing its
            job. Functional and annual tests confirm the equipment turns on; the photometric
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Article 27(1)(a) — entry.</strong> An inspector may enter any premises at any
              reasonable time for the purpose of carrying out their functions under the Order. No
              notice required. Force may be used, with police support, where entry is refused.
            </li>
            <li>
              <strong>Article 27(1)(b) — examination.</strong> The inspector may make such
              examinations and inspections as are necessary. This includes the EL system — physical
              inspection, sample testing, photographing.
            </li>
            <li>
              <strong>Article 27(1)(c) — direction to leave undisturbed.</strong> The inspector may
              direct that the premises, or any part, or anything in them, be left undisturbed for as
              long as is reasonably necessary for the inspection.
            </li>
            <li>
              <strong>Article 27(1)(d) — sample-taking.</strong> The inspector may take samples of
            ...
            <li>
              <strong>Article 27(1)(g) — production of records.</strong> The inspector may require
              the production of any books, documents, records or other information, inspect them,
              and take copies. The full documentation set described above is in scope.
            </li>
            <li>
              <strong>Article 27(1)(j) — information from any person.</strong> The inspector may
              require any person to give such information as the inspector thinks necessary, and to
              sign a declaration of the truth of their answers.
            </li>
            <li>
              <strong>Article 27(2) — protection of information.</strong> Information so obtained
              must not be disclosed except as required for the purposes of the Order or with the
              consent of the person providing it.
            </li>
            <li>
              <strong>Obstruction is an offence.</strong> Article 32(1)(a) makes obstruction of an
              inspector an offence. False statements under Article 32(2)(a). Destruction of records
              under Article 32(2)(d). All carry the same penalty range as the underlying safety
              offences.
            </li>
          </ul>
          <p>
            The right response to an inspector arriving is co-operation, candour, and competence.
            Co-operation: produce what is asked for. Candour: explain any unavailability honestly.
            Competence: have a duty manager who knows where things are. The wrong response is
            refusal, evasion, or fabrication — each escalates the regulatory position significantly.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              their powers; on entering any premises by virtue of this Article an inspector may take
              with them any other person duly authorised by the inspector's enforcing authority, and
              any equipment or materials required for any purpose for which the power of entry is
              being exercised; carry out such examinations and inspections as are necessary; require
              the production of, inspect and take copies of any books, documents, records or other
              information; require any person to give such information as the inspector thinks
              necessary and to sign a declaration of the truth of their answers.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Article 29 — alterations notice.</strong> Where the FRS is of the opinion that
              the premises constitute, or could constitute, a serious risk to relevant persons, or
              that the premises may, by reason of any alteration to them or to their use, become a
              serious risk, the FRS may serve an alterations notice on the RP. The notice requires
              advance notification of any specified types of alteration so that the FRS can assess
              them. Failure to notify is itself an offence.
            </li>
            <li>
              <strong>Article 30 — enforcement notice.</strong> Where the FRS is of the opinion that
              the RP has failed to comply with the Order, the FRS may serve an enforcement notice.
              The notice specifies the matters constituting the failure, the steps the RP must take
              to remedy them, and a period (≥ 28 days) for compliance. The premises remain in use
              during the notice period. Appeal to a magistrates court within 21 days. Failure to
              comply is itself an offence under Article 32.
            </li>
            <li>
              <strong>Article 31 — prohibition notice.</strong> Where the FRS is of the opinion that
              the use of premises involves or will involve a serious risk to relevant persons in
              case of fire, the FRS may serve a prohibition notice. The notice prohibits or
              restricts the use of part or all of the premises. It can take effect immediately or
              from a specified time. The notice continues until withdrawn by the FRS, typically on
              evidenced remediation. Appeal to a magistrates court within 21 days. Failure to comply
              is itself an offence.
            </li>
            <li>
              <strong>Choice of notice.</strong> The FRS chooses based on the imminence of risk. An
              EL deficiency on a low-risk escape route in a low-occupancy daytime office is
            ...
            <li>
              <strong>Recording and publication.</strong> Notices are recorded against the building.
              The FRS may publish information about prohibition notices. For HRBs, the BSR is
              informed. For commercial premises, lenders, insurers and prospective tenants
              increasingly check fire safety notice history.
            </li>
            <li>
              <strong>Remediation and lifting.</strong> Article 30 notices are deemed satisfied on
              completion of the specified steps; the FRS confirms with a follow-up audit. Article 31
              notices are lifted by the FRS on evidenced remediation; the building cannot be used
              again until lifted.
            </li>
          </ul>
          <p>
            The three notices form an escalation ladder. Most engagements with the FRS that identify
            shortcomings begin with informal advice or a letter; persistent or serious shortcomings
            move to formal notices; immediate risk moves straight to Article 31. EL deficiencies
            feature prominently in all three categories.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Article 32(1) — headline offence.</strong> Failure to comply with the safety
              provisions of Articles 8 to 22, or Article 38, where the failure places one or more
              relevant persons at risk of death or serious injury. Articles 14 (emergency routes and
              exits) and 17 (maintenance) are within scope.
            </li>
            <li>
            ...
            <li>
              <strong>Corporate offenders.</strong> Bodies corporate face the unlimited fine. Where
              the offence is committed with the consent or connivance of, or attributable to neglect
              on the part of, a director, manager, secretary or other similar officer of the body,
              that person is also guilty of the offence (Article 33).
            </li>
            <li>
              <strong>Recent themes.</strong> Sentencing under the Sentencing Council's Definitive
              Guideline for health-and-safety offences has produced fines on turnover-related bands.
              Substantial corporate offenders have received fines exceeding £1 million in the most
              serious cases. Custody for individuals is rarer but not unknown — particularly where
              deliberate falsification or repeat offending is established.
            </li>
            <li>
              <strong>Lessons from prosecutions.</strong> Documentary failures feature heavily —
              missing FRAs, falsified logbooks, expired certificates, no design records. Emergency
              lighting alone rarely founds a prosecution; emergency lighting as part of a wider
              failure pattern is common. The 'reasonable competent person' test is the standard —
              would a reasonable RP have done what was done? If not, conviction is likely.
            </li>
            <li>
              ...
              offence may apply. Sentencing: typically very large fines, publicity orders, remedial
              orders. The Act is particularly relevant for corporate landlords and operators of
              public premises.
            </li>
          </ul>
          <p>
            Prosecution is the end of the enforcement ladder. Most RPs who engage promptly with FRS
            findings, remediate at the agreed pace, and maintain documentary evidence avoid
            prosecution even where significant initial failings existed. RPs who fail to engage —
            repeated overruns, unevidenced closures, falsified records — are at materially greater
            risk.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              installation record, FRA references, commissioning, on-going test history, 5-year
              verification, action plan items and closure evidence all sit within the building
              safety case. The case is reviewed continuously and updated on every significant
              change.
            </li>
            <li>
              <strong>Golden Thread (Building Regs).</strong> Digital, structured, accessible. Each
              EL document has a defined location, format, version control, audit trail. The BSR can
              request any document on demand and expects to receive it digitally.
            </li>
            <li>
              <strong>Gateways 2 and 3 (new construction).</strong> Gateway 2 (before construction)
              — design evidence; the EL design-and-installation record and photometric calculations
              form part of the submission. Gateway 3 (before occupation) — installation evidence;
              commissioning certificate, verification, EIC form part of the submission. BSR sign-off
              is mandatory for both.
            </li>
            <li>
              <strong>Mandatory Occurrence Reporting (MOR).</strong> The Accountable Person must
              report safety occurrences to the BSR within defined timescales. Examples relevant to
              EL: a complete failure of EL across an escape route during occupied hours; a fire
              where EL did not function; a structural / fabric event affecting EL provision. MOR
              submissions form part of the Golden Thread.
            </li>
            <li>
              <strong>Resident engagement.</strong> EL planned tests must be notified to residents;
              failures affecting common parts must be communicated; remediation schedules must be
              transparent. The engagement strategy records the communication.
            </li>
            <li>
              <strong>Audit cadence.</strong> The BSR audits HRBs on a schedule and risk-based
              trigger. Stage 1 audits review documentation; Stage 2 may involve site inspection. EL
              records are routinely sampled.
            </li>
            <li>
              <strong>Change of duty holder.</strong> Where the AP changes (sale, restructure), the
              safety case and Golden Thread transfer; the new AP registers with the BSR; the EL
              evidence transfers as part of the package.
            </li>
            <li>
              <strong>Penalties.</strong> BSA 2022 creates new offences for non-compliance with the
              HRB regime — e.g. failing to register, failing to maintain a safety case, failing to
              comply with a BSR notice. Penalties are substantial.
            </li>
          </ul>
          <p>
            For the duty holder, the practical implication is digital-first record management with
            strong version control, audit trail, and integration into the building safety case
            management system. Paper-only records, fragmented contractor systems without export, and
            ad-hoc filing are all unsustainable for HRBs.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              held permanently while the building exists. Previous versions should be retained to
              evidence review history and significant change tracking. 6 years is the minimum;
              longer is better.
            </li>
            <li>
              <strong>BS 5266-1:2025 design-and-installation record — life of installation.</strong>
              BS 5266-1:2025 §11 expressly requires retention for the life of the installation. The
              record is the foundation of every subsequent maintenance, audit and modification.
              Permanent retention; transfers to new owner on sale.
            </li>
            <li>
            ...
            <li>
              <strong>BS EN 50172:2024 logbook — 6 years rolling minimum.</strong> The on-going test
              record. 6 years aligns with civil limitation periods and most insurance expectations.
              For HRBs, life of building (Golden Thread). Many operators retain permanently as part
              of the building's record.
            </li>
            <li>
              <strong>5-year photometric verification — permanent.</strong> Each verification
              certificate is retained. The series provides the empirical history of EL performance
              over time.
            </li>
            <li>
              <strong>
                BS EN 60598-2-22 luminaire certificates — life of luminaire + replacement.
              </strong>{' '}
              Retained while the luminaire is installed. On replacement, the new certificate
              replaces it; the historic certificate may be retained for provenance.
            </li>
            <li>
              <strong>EIC + EICR — life of installation.</strong> Original EIC retained while the
              installation exists. EICRs retained until superseded by the next periodic; some
              operators retain the full series.
            </li>
            <li>
              <strong>
                Action plan + closure evidence — 6 years rolling minimum, permanent for significant
                remediations.
              </strong>{' '}
              A modification of the building's EL provision is itself a significant event; the
              closure evidence is part of the design history.
            </li>
            <li>
            ...
            <li>
              <strong>HRB Golden Thread — life of building.</strong> All records held within the
              Golden Thread are retained for the life of the building. Transfer on sale.
            </li>
          </ul>
          <p>
            ...
            operator, digital storage with backup is almost always preferable to paper — paper is
            lost, damaged, mis-filed; digital is portable, version-controlled, searchable.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              portable; multi-user access; integrates with building management systems and Golden
              Thread; supports automated test logging via BS EN 62034 self-test luminaires;
              reporting and trend analysis.
            </li>
            <li>
              <strong>Digital risks.</strong> Contractor-system dependency (records held by
              maintenance contractor; loss on contract change); cyber-attack on the host or the RP's
              own systems; format obsolescence (proprietary file formats becoming unreadable); cost
              recurrence (subscription models); access dependency (offline access at audit time may
              not be available).
            </li>
            <li>
            ...
            <li>
              <strong>Paper risks.</strong> Lost; damaged (water, fire, mould); mis-filed; illegible
              (handwriting, fading); not searchable; not portable; difficult to share across
              multiple stakeholders; storage volume.
            </li>
            <li>
              ...
              EICR, evacuation plan). Live logbook entries are typically digital; historical logbook
              archives may be in either format.
            </li>
            <li>
              <strong>Contract terms.</strong> Where records are held in a contractor system, the
              maintenance contract should expressly require: export of all records in a portable
              format on a defined schedule (typically monthly or quarterly); provision of all
              records in a portable format on contract termination; tamper-evident audit trail;
              access for the RP at all times.
            </li>
            <li>
            ...
            <li>
              <strong>RP-side independence.</strong> The RP retains the legal duty regardless of who
              hosts the system. Reliance on a single contractor system without independent retention
              is a single point of failure. Best practice: maintain a second copy of all records on
              RP-controlled storage.
            </li>
          </ul>
          <p>
            Format is a means; legal compliance is the end. Whatever format is used, the records
            must be: complete; current; accurate; tamper-evident; producible on demand; portable on
            transfer of duty. Format choice should serve those requirements, not substitute for
            them.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Confirm identity.</strong> Ask to see the inspector's authority. They will
              have a card; check the issuing authority and the inspector's name. This is not
              obstruction — it is good practice.
            </li>
            <li>
              <strong>Permit entry.</strong> Refusing entry under Article 27 is itself an offence.
              Permit entry promptly.
            </li>
            <li>
              <strong>Notify the RP and competent person.</strong> The RP must know an audit is in
              progress. The competent person (often the maintenance contractor) may need to attend.
            </li>
            <li>
            ...
            <li>
              ...
              locked office, contractor system not accessible, missing — say so honestly. Offer a
              timescale for retrieval. Do not invent records or claim availability that does not
              exist.
            </li>
            <li>
              <strong>Accompany the building walk-through.</strong> The inspector will likely walk
              escape routes, refuges, plant rooms. The duty manager should accompany — witnessing
              what is found is important.
            </li>
            <li>
              <strong>Record what is asked.</strong> Note the inspector's questions and the answers
              given. Note any defects identified, any documents copied or retained, any samples
              taken. The note becomes the duty manager's report to the RP.
            </li>
            <li>
              <strong>Do not sign anything you do not understand.</strong> The duty manager may be
              asked to sign a record of attendance or a statement; only sign what is accurately
              recorded and within the duty manager's knowledge. The RP can refer disputed matters
              back later.
            </li>
            <li>
              <strong>Report to the RP immediately.</strong> A complete handover note: time of
              audit, inspector name and authority, scope, documents produced, defects identified,
              samples taken, departure time. The RP may need to act within hours.
            </li>
            <li>
              <strong>Do not falsify or destroy records.</strong> Whatever the temptation, this is
              the worst possible response. Falsification and destruction are themselves offences and
              they aggravate the underlying findings significantly. Truth and co-operation are the
              right responses, even where the underlying evidence is imperfect.
            </li>
          </ul>
          <p>
            A no-notice audit handled well leaves the building in the same regulatory position it
            was in beforehand — neither better nor worse, simply tested. A no-notice audit handled
            badly compounds the underlying issues and adds new offences on top. The duty manager
            training cost is small; the protection it gives is large.
          </p>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            {
              question:
                'What happens if our maintenance contractor goes out of business and we lose access to the digital logbook?',
              answer:
            ...
            {
              question:
                'How does the BS 5266-1:2025 5-year photometric verification interact with the annual full-duration test?',
              answer:
            ...
            {
              question:
                'Our building is a small 2-employee shop. Do we still need all 12 documents?',
              answer:
            ...
            {
              question:
                'A fire occurs and emergency lighting did not work. What is the documentary impact?',
              answer:
            ...
            {
              question:
                'What is the difference between the design-and-installation record and the commissioning certificate?',
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() =>
              navigate('/electrician/upskilling/emergency-lighting-module-6-section-3')
            }
