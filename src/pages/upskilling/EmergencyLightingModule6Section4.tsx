...
const inlineChecks = [
  {
    ...
    options: [
      ...
      'The CORE EVIDENCE PACKAGE — fire risk assessment (under Article 9), BS 5266-1:2025 design-and-installation record, commissioning certificate, emergency lighting logbook (with monthly functional and annual full-duration test entries per BS EN 50172:2024), 5-year photometric verification certificate (BS 5266-1:2025), Electrical Installation Certificate or current EICR (BS 7671), evacuation plan (and PEEPs for individual residents where relevant), training records, and the BS 5839-1 fire alarm cause-and-effect document where the systems interact. Article 27 gives the inspector entry, demand-for-records and information-demand powers; obstruction is an offence under Article 32.',
      'Building plans only.',
      'Verbal explanation.',
    ],
    correctIndex: 1,
    explanation:
      'The RRO Article 27 power is broad — the inspector can demand any record reasonably required to verify compliance. The core evidence package above is the minimum any RP should expect to produce on demand. Failure to produce, or production of incomplete / out-of-date records, does not just delay the audit — it itself evidences inadequate management.',
  },
  {
    id: 'elm6-s4-art31',
    ...
    options: [
      'No action.',
      'A PROHIBITION NOTICE under RRO 2005 Article 31. Article 31 enables the FRS to prohibit or restrict the use of premises where the inspector is of the opinion that there is a serious risk to relevant persons in case of fire. A failed emergency lighting system on the only escape route from a basement nightclub — high occupancy, sleeping risk if late-night, low ambient light, single escape — is a textbook serious risk. The notice can take effect immediately if the inspector specifies. Lifting requires evidenced remediation. Compare to: Article 29 (alterations notice — pre-modification); Article 30 (enforcement notice — non-imminent breach with reasonable remediation period); Article 31 (prohibition — imminent serious risk).',
      'A friendly letter.',
      'A planning notice.',
    ],
    correctIndex: 1,
    explanation:
      'Prohibition notices under Article 31 are reserved for imminent serious risk and bite immediately. A basement nightclub with failed EL on the only escape route is exactly the scenario the power was designed for. The premises must close until remediated; remediation must be verified; only then is the notice lifted.',
  },
  {
    ...
    options: [
      '12 months.',
      'AT LEAST 6 YEARS as a baseline, longer in many cases. There is no single statutory retention period in the RRO itself — but: (a) the limitation period for civil claims arising from fire injury or death is generally 3 years from injury / 6 years from contract; (b) the limitation period for prosecutions under Article 32 typically runs from the date of the offence, but evidence of historic compliance helps the defence; (c) HRBs under Building Safety Act 2022 require records for the life of the building (Golden Thread). The operating norm: 6 years minimum + permanent retention of design-and-installation records, commissioning certificates and 5-year photometric verifications. Digital storage with backup is preferred.',
      '30 days.',
      '18 months.',
    ],
    correctIndex: 1,
    explanation:
      'Six years is the practical baseline from civil and contractual limitation periods. For HRBs, the Golden Thread effectively means life-of-building retention. Even outside HRBs, design-and-installation records and commissioning certificates should be retained permanently — they are the foundation of any future audit, modification or transfer of duty.',
  },
  {
    id: 'elm6-s4-bsr',
    ...
    options: [
      'Same as non-HRB.',
      'INTEGRATION INTO THE BUILDING SAFETY CASE AND THE GOLDEN THREAD. Building Safety Act 2022 + Building Safety Regulations: HRBs require an Accountable Person to maintain a safety case (s.83) and a digital Golden Thread of building information accessible throughout the life of the building. Emergency lighting evidence — design records, photometric calculations, commissioning, monthly / annual / 5-year test results, FRA reference, action plan items, closure evidence — all flow into the safety case and the Golden Thread. The BSR can demand any of it on demand. Mandatory Occurrence Reporting (MOR) applies for safety-critical occurrences. Paper-only records are insufficient — data must be digital, structured, accessible.',
      'Annual paper file.',
      'Verbal records.',
    ],
    correctIndex: 1,
    explanation:
      'The HRB regime is the most demanding documentation regime for emergency lighting in the UK. Records must be digital, integrated into the safety case, and maintained as part of the Golden Thread for the life of the building. The BSR audit tests integration and accessibility, not just record completeness.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      'The invoice.',
      'The DESIGN-AND-INSTALLATION RECORD. BS 5266-1:2025 §5 + §11 require a design-and-installation record evidencing: the FRA-design linkage; the design strategy (self-contained vs central battery, maintained vs non-maintained); photometric calculations against BS EN 1838:2024 minima; layout drawings; the equipment schedule (luminaires to BS EN 60598-2-22); circuit topology; the test regime; the external escape route boundary (NEW in 2025); cause-and-effect interactions with BS 5839-1; the FRA-design map; the commissioning record. It is the master document from which all subsequent maintenance, testing and verification flows.',
      'The brochure.',
      'The receipt.',
    ],
    correctAnswer: 1,
    explanation:
      'The design-and-installation record is the integrating document. Without it, future maintenance, FRA reviews, and audits have no reference point. BS 5266-1:2025 strengthened the record requirements — pattern-book records are no longer accepted.',
  },
  {
    id: 2,
    ...
    options: [
      ...
      'DAILY visual check (where central-battery or addressable systems require a daily inspection per BS EN 50172 §7.2.2 — a brief check of indicator lamps); MONTHLY functional test of each luminaire (simulated mains failure; pass / fail; recorded in logbook); ANNUAL full-duration test of each luminaire (over its rated duration, typically 3 hours; pass / fail; recorded). BS 5266-1:2025 adds a fourth: 5-YEAR in-service photometric verification (empirical illuminance measurement against design). Each cycle has a defined method, a documentary record requirement, and a failure-handling procedure.',
      'Weekly only.',
      'Annual only.',
    ],
    correctAnswer: 1,
    explanation:
      'BS EN 50172:2024 + BS 5266-1:2025 set out the layered test regime. Each cycle catches a different failure mode. The monthly catches battery / lamp / charger failures; the annual catches batteries that pass functional but cannot sustain duration; the 5-year catches LED depreciation, surface changes, and luminaire substitution against design. Daily applies to central / addressable systems.',
  },
  {
    id: 3,
    ...
    options: [
      'Wiring systems.',
      'PARTICULAR REQUIREMENTS FOR LUMINAIRES FOR EMERGENCY LIGHTING. BS EN 60598-2-22 (the EN 60598 series sub-part 2-22) is the product standard for self-contained and centrally supplied emergency luminaires. It covers: the construction; insulation; mechanical strength; thermal performance; battery integration; charging characteristics; output performance during emergency mode; durability; marking. A certificate of conformity to BS EN 60598-2-22 is the evidence that a luminaire is fit for purpose. The certificate is a core document in the audit pack.',
      'Battery technology only.',
      'Distribution boards.',
    ],
    correctAnswer: 1,
    explanation:
      'BS EN 60598-2-22 is the product standard. The construction-and-equipment certification it underpins is the basis for trust in the luminaire — without it, the photometric calculations are theoretical, not evidential. Certificates of conformity must be retained in the audit pack.',
  },
  {
    id: 4,
    question:
    ...
    options: [
      'Random search only.',
      'NOTIFICATION (often) → ENTRY (Article 27) → INTRODUCTION + SCOPE → DOCUMENT REVIEW (FRA, design record, logbook, certificates, training records, evacuation plan, fire alarm records, action plan) → BUILDING WALK-THROUGH (escape routes, signage, refuges, plant, sample EL test) → INTERVIEW (RP, competent person, employees) → FINDINGS DEBRIEF → FORMAL REPORT (informal advice, alterations notice, enforcement notice, prohibition notice — depending on findings) → REMEDIATION + VERIFICATION. Visits may be unannounced (no-notice) where the FRS suspects serious risk; the rights of entry under Article 27 do not require notice.',
      'Phone call only.',
      'Letter only.',
    ],
    correctAnswer: 1,
    explanation:
      'FRS audits typically follow a recognisable sequence. Knowing the sequence helps the RP prepare. The document review is where most failures are identified — get the documents right and the rest of the audit is straightforward.',
  },
  {
    id: 5,
    ...
    options: [
      'No difference.',
      'ARTICLE 30 — issued where the inspector is of the opinion that the RP has failed to comply with the Order; specifies the matters constituting the failure, the steps required, and a period (≥ 28 days) for compliance. The premises remain in use during the notice period. Appeal to a magistrates court within 21 days. ARTICLE 31 — issued where the inspector is of the opinion of imminent serious risk to relevant persons in case of fire; can prohibit or restrict use of part or all of the premises with immediate effect; the prohibition continues until remedied. Appeal to a magistrates court within 21 days. Both are recorded against the building; both feed into the building safety case where applicable.',
      'Article 30 closes the building.',
      'Article 31 is voluntary.',
    ],
    correctAnswer: 1,
    explanation:
      'Article 30 is the formal "remedy this within X" notice; Article 31 is the immediate "stop using this until remedied" notice. The choice depends on imminence of risk. Both are formal regulatory notices recorded against the building and within the regulatory record.',
  },
  {
    id: 6,
    ...
    options: [
      'None.',
      'THE INTEGRATED EVIDENCE PACK — (a) current FRA covering common parts under PAS 79-2 methodology with EL findings flagged; (b) BS 5266-1:2025 design-and-installation record including photometric calculations, equipment schedule, layout drawings, FRA-design map; (c) commissioning certificate (1838 / 5266-1 acceptance); (d) BS EN 50172:2024 logbook with daily / monthly / annual test history, ideally digital with audit trail; (e) most recent 5-year photometric verification certificate; (f) certificates of conformity for luminaires (BS EN 60598-2-22); (g) Electrical Installation Certificate (BS 7671) and current periodic EICR; (h) BS 5839-1:2025 fire alarm records and cause-and-effect document; (i) building evacuation plan and Person-Centred Fire Risk Assessments / PEEPs for residents needing assistance under the Fire Safety (Residential Evacuation Plans) (England) Regulations 2025 (SI 2025/797); (j) wayfinding signage compliance records under Fire Safety (England) Regulations 2022 (SI 2022/547) Reg 8, secure information box (PIB) records under Reg 4, resident fire safety instructions under Reg 9 and quarterly / annual fire-door check records under Reg 10; (k) Mandatory Occurrence Reports for any EL-related occurrences; (l) integration evidence — extracts from the safety case and Golden Thread showing how EL evidence is held. The pack must be digital.',
      'Photographs only.',
      'Verbal summary.',
    ],
    correctAnswer: 1,
    explanation:
      'HRB Stage 1 audits test integration as well as completeness. The Accountable Person must show that EL evidence is held within the safety case, accessible via the Golden Thread, and current. Paper-only files fail the test on form even before content is examined.',
  },
  {
    id: 7,
    question:
    ...
    options: [
      ...
      'CONDITIONALLY — yes, IF the RP can produce the records on demand at the time of audit; AND retains records on contract termination (the maintenance contract should expressly require export of records on exit); AND ensures records are tamper-evident. Concerns: contractor failure or insolvency could result in loss of records; contractor change requires record migration; cyber-attack on the contractor system could compromise records; some hosted systems have proprietary formats not portable to alternatives. Best practice: RP retains a copy of all records (export at agreed intervals); contract requires the contractor to provide records in a portable format; tamper-evidence is documented.',
      'Always unacceptable.',
      'Acceptable only on paper.',
    ],
    correctAnswer: 1,
    explanation:
      'Digital logbooks are now industry standard but bring risks the paper alternative did not have. The RP retains the legal duty; reliance on a single contractor system without independent retention is a single point of failure. The FRS will check who controls the records, not just whether the records exist.',
  },
  {
    id: 8,
    ...
    options: [
      'No offence.',
      'OFFENCES UNDER MULTIPLE ARTICLES — (a) Article 32 (failure to comply with safety provisions of Articles 8-22 placing relevant persons at risk of death or serious injury — specifically Article 14 emergency lighting and Article 17 maintenance); (b) Article 32 (false statement, where logbook entries have been falsified rather than missing); (c) Manslaughter or corporate manslaughter (Corporate Manslaughter and Corporate Homicide Act 2007) where the failure caused death and was a gross breach. Penalties: unlimited fine; 2 years imprisonment on indictment for individuals; unlimited fine for corporations under Article 32; significantly higher for corporate manslaughter. Investigation by FRS, HSE (workplace overlap) and police; prosecution by CPS or FRS depending on charge.',
      'Civil claim only.',
      'Insurance only.',
    ],
    correctAnswer: 1,
    explanation:
      'Post-incident investigations focus heavily on the documentary trail. Missing logbook entries do not mitigate the breach — they aggravate it. Fabricated entries lead to additional false statement charges. Where a fatality results, corporate manslaughter is on the table for organisations.',
  },
  {
    id: 9,
    ...
    options: [
      'No requirement.',
      'A FULL HANDOVER PACK — current FRA, BS 5266-1:2025 design-and-installation record, commissioning certificate, BS EN 50172:2024 logbook, last 5-year photometric verification, certificates of conformity for luminaires, EIC / EICR, manufacturer data sheets, asset register, maintenance contract details and contractor competence evidence, training records, evacuation plan, fire alarm records and cause-and-effect document, action plan with open and recently closed items. The handover should be in writing with an inventory; the new RP should review and accept (with a defect schedule for any incomplete items). For HRBs, the Golden Thread transfers; the new AP must register with the BSR. Failure to hand over evidence does not transfer the duty — the new RP inherits the building plus the responsibility to evidence ongoing compliance, and must commission a fresh FRA on take-up.',
      'Only the brochure.',
      'A receipt.',
    ],
    correctAnswer: 1,
    explanation:
      'Handover is the most common moment for documentation to be lost. The new RP often takes the building without the records and is left to reconstruct compliance from a cold start. Best practice: the inventory + acceptance protocol should be standard in any conveyance or lease assignment; gaps should be defect-schedule items with cost allocation.',
  },
  {
    id: 10,
    question:
    ...
    options: [
      'Refuse entry.',
      'COMPLY WITH ARTICLE 27 — permit entry; provide such information and assistance as can be given without obstructing or misleading; explain candidly the unavailability of records; offer to retrieve them within a reasonable period. Refusing entry, providing false statements, or destroying / concealing records are themselves offences under Article 32. The inspector will record the inability to produce records and may reschedule a follow-up; persistent non-production is itself a finding. Non-availability of records does not by itself trigger an enforcement or prohibition notice — but combined with any visible deficiency, it materially worsens the regulatory position. Best practice: every duty manager should know where every key record is kept, and the access protocol if they are not on site.',
      'Hide the records.',
      'Lie about availability.',
    ],
    correctAnswer: 1,
    explanation:
      'Article 27 entry powers are wide. Co-operation, including candid explanation of any record unavailability, is the right response. Refusal or false statements escalate the offence. Best practice: ensure that on-site records are immediately accessible to whoever is on duty; off-site records should be retrievable within hours, not days.',
  },
];
