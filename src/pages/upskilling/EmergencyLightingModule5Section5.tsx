...
const inlineChecks = [
  ...
  },
  {
    id: 'elm5-s5-periodic',
    question:
      'What is the difference between an acceptance certificate and a periodic certificate?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 4,
    question:
      'What is the relationship between BS 5266-1 acceptance certificate and the BS 7671 Electrical Installation Certificate (EIC)?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'A departure from full BS 5266-1:2025 compliance has been identified. What is required to record it?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'What categories of departure are now declared NON-compliance (rather than acceptable departures) under BS 5266-1:2025?',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'A commissioning certificate has been signed but the duration test has not yet been carried out. What is the regulatory position?',
    options: [
  ...
  },
  {
    id: 9,
    question:
      'A small premises has emergency lighting installed by an electrician without third-party scheme registration. Is this acceptable?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The certification framework that surrounds the BS 5266-1:2025 acceptance and periodic
          certificates: the model forms, the competent person definition, third-party schemes (BAFE
          SP203-4 the most relevant), the 2025 tightening on what may and may not be recorded as a
          departure, and the structured commissioning checklist that produces the certificate
          evidence.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Acceptance certificate (BS 5266-1:2025 model form).</strong> Issued ONCE at
              commissioning. Records visual / electrical / photometric / switch-on / duration
              verification, departures, competence declaration, documentation pack appendices. The
              legal handover document.
            </li>
            <li>
              <strong>Periodic inspection certificate (BS 5266-1:2025 model form).</strong> Issued
              at each periodic full inspection — typically annually, coinciding with the annual
              duration test. Records the continued compliance against the commissioning baseline.
            </li>
            <li>
              <strong>Five-year photometric report.</strong> Separate document issued at each
              photometric cycle. Tabulated point-by-point readings against design / baseline / BS EN
              1838 minima. Attached to or referenced by the periodic certificate at the cycle.
            </li>
            <li>
              <strong>BS 7671 EIC at commissioning.</strong> Covers the electrical installation work
              for the emergency lighting circuits. Issued at handover alongside the acceptance
              certificate. Cross-referenced by both.
            </li>
            <li>
              <strong>BS 7671 EICR at periodic.</strong> Covers the in-service electrical
              installation. Cycle typically 5-yearly for commercial fixed wiring. Cross-referenced
              by the periodic certificate; aligned with the five-year photometric where possible.
            </li>
            <li>
              <strong>Central battery system certificate (BS EN 50171:2021).</strong> Where
              applicable. Covers the central battery system specifically — capacity, charging
              system, monitoring, fire-rated enclosure compliance. Issued at commissioning and at
              major service.
            </li>
            <li>
              <strong>Battery service / replacement records.</strong> Each major battery service or
              replacement generates a record (date, parts, technician). Filed with the asset
              register and referenced by the periodic certificate.
            </li>
          </ul>
          <p>
            The stack is not optional. Each component covers a scope that the others do not.
            Insurers and fire authorities are increasingly familiar with the full stack and will
            identify gaps. A clean stack is the evidence base; a partial stack invites questions.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Certification of an emergency lighting installation shall be made at the time of
              commissioning by means of a written acceptance certificate, signed by a competent
              person, in the model form set out in this standard. Periodic certification shall be
              made at each periodic inspection cycle. Photometric verification shall be certified
              separately at the cycle specified in clause 12.4. Departures from full compliance
              shall be technically justified, residual-risk-assessed, agreed in writing by the
              responsible person, and explicitly recorded on the relevant certificate.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>1. Installation details.</strong> Address, occupancy class, design reference
              number, design drawing references, date of commissioning, identification of
              commissioning organisation and competent person(s).
            </li>
            <li>
              <strong>2. Standards complied with.</strong> Listed explicitly: BS 5266-1:2025, BS EN
              50172:2024, BS EN 50171:2021 (where applicable), BS 7671:2018+A2:2022, BS EN 1838 (lux
              references). Listing each removes ambiguity about what was verified.
            </li>
            <li>
              <strong>3. Visual and mechanical inspection.</strong> Tick-list confirmation of
              pre-energisation checks complete: luminaire positions, cable type and fire-resistance,
              fixings (mechanical), mounting and orientation, supply arrangements, battery state.
              Defects logged and resolved.
            </li>
            <li>
              <strong>4. Electrical verification (BS 7671 Part 6).</strong> Cross-reference to the
              BS 7671 EIC (separate certificate) plus summary results: continuity, IR, polarity, Zs,
              RCD, ADS. Per-circuit summary tables.
            </li>
            <li>
              <strong>5. Photometric verification (NEW emphasis 2025).</strong> Survey results
              summary — readings against design, against BS EN 1838 minima, uniformity ratio.
              Calibration reference of the lux meter. Reference to the detailed photometric survey
              appendix.
            </li>
            <li>
              <strong>6. Switch-on test.</strong> Per-area: response class achieved, any failures,
              resolution. Verifies every emergency-lit area produces the design response when local
              supply interrupted.
            </li>
            <li>
              <strong>7. Duration test.</strong> Date of duration test, rated duration, observed
              actual duration, end-of-test result (all illuminated), recovery confirmation (≥ 80%
              within 24 h).
            </li>
            <li>
              <strong>8. Central battery system (where applicable).</strong> BS EN 50171
              verification summary — capacity, charging, monitoring, enclosure, warning notices.
              Cross-reference to separate central battery system certificate.
            </li>
            <li>
              <strong>9. Labelling and asset register.</strong> Confirmation that installation
              labels are fitted to all luminaires, asset register populated, photographic record
              assembled.
            </li>
            <li>
              <strong>10. Departures (NEW structured section 2025).</strong> Any departure from full
              BS 5266-1:2025 compliance: clause departed from, technical justification, residual
              risk assessment, agreement of responsible person, compensating measures. Each
              departure structured.
            </li>
            <li>
              <strong>11. Documentation pack.</strong> Listed appendices: as-built drawings, design
              lux calculation, manufacturer manuals, photometric survey detail, central battery
              certificate, BS 7671 EIC, logbook starter, photographic record.
            </li>
            <li>
              <strong>12. Competence declaration (NEW 2025).</strong> The competent person's
              qualifications, training, experience, procedural framework (BAFE SP203-4 / NICEIC /
              ECA / in-house), signed register reference. Made explicit so that insurers, fire
              authorities, or future investigators can verify the competence basis for the
              certificate.
            </li>
            <li>
              <strong>13. Signature and date.</strong> Competent person signature, date of
              certificate, organisation stamp.
            </li>
          </ul>
          <p>
            The 2025 model form runs to several pages. Filling it in fully takes time at handover
            but is the only acceptable output. Legacy single-page templates are missing the
            structured departures, competence declaration, and photometric reference — they should
            not be used for any new commissioning under the 2025 standard.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="40" y="86" fill="rgba(255,255,255,0.6)" fontSize="11" fontWeight="bold">
              At commissioning (year 0)
            </text>
            <rect
              x="40"
              y="100"
            ...
            <text x="130" y="136" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              BS 5266-1:2025 model form
            </text>
            <text x="130" y="150" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              issued ONCE
            </text>
            ...
            <text x="330" y="136" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              underlying electrical install
            </text>
            <text x="330" y="150" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              issued ONCE
            </text>
            ...
            <text
              ...
              fontWeight="bold"
            >
              Central battery cert
            </text>
            <text x="530" y="136" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              BS EN 50171:2021
            </text>
            <text x="530" y="150" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              where applicable
            </text>
            ...
            <text x="720" y="136" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              commissioning baseline
            </text>
            <text x="720" y="150" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              part of acceptance
            </text>

            {/* Middle row — periodic */}
            <text x="40" y="200" fill="rgba(255,255,255,0.6)" fontSize="11" fontWeight="bold">
              Periodic cycles (life of installation)
            </text>
            <rect
              x="40"
              y="214"
            ...
            <text x="130" y="250" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              annual at full inspection
            </text>
            <text x="130" y="264" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              BS 5266-1 model form
            </text>
            ...
            <text x="330" y="250" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              5-yearly commercial
            </text>
            <text x="330" y="264" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              parallel cycle
            </text>
            ...
            <text x="530" y="248" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              ⚠ NEW 2025 emphasis
            </text>
            <text x="530" y="262" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              point-by-point lux survey
            </text>
            ...
            <text x="720" y="250" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              replacement records
            </text>
            <text x="720" y="264" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              3-5 yr typical
            </text>

            {/* Competence schemes */}
            <text x="40" y="314" fill="rgba(255,255,255,0.6)" fontSize="11" fontWeight="bold">
              Competent person — third-party schemes
            </text>
            <rect
              x="40"
              y="328"
            ...
            <text x="130" y="364" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              emergency lighting
            </text>
            <text x="130" y="378" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              design / install / commission
            </text>
            <text x="130" y="392" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              / maintain
            </text>
            ...
            <text x="330" y="364" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              emergency lighting
            </text>
            <text x="330" y="378" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              scheme
            </text>
            ...
            <text x="530" y="364" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              emergency lighting
            </text>
            <text x="530" y="378" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              scheme
            </text>
            ...
            <text x="720" y="364" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              documented QMS
            </text>
            <text x="720" y="378" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              + signed register
            </text>

            {/* Audiences */}
            <text x="40" y="448" fill="rgba(255,255,255,0.6)" fontSize="11" fontWeight="bold">
              Audience — who consumes the stack
            </text>
            <rect
              x="40"
              y="462"
            ...
            <text x="160" y="498" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              acceptance + periodic + photo
            </text>
            <text x="160" y="512" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              + scheme reg + logbook
            </text>
            <text x="160" y="528" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              premium / claim impact
            </text>
            ...
            <text x="420" y="498" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              FRA evidence pack
            </text>
            <text x="420" y="512" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              RRO 2005 compliance
            </text>
            <text x="420" y="528" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              enforcement basis
            </text>
            ...
            <text x="680" y="498" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              post-incident review
            </text>
            <text x="680" y="512" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              contemporaneous evidence
            </text>
            <text x="680" y="528" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              defence basis
            </text>
            ...
            <text x="410" y="588" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9">
              Missing or stale certificates have premium, claim, enforcement, and defence
              implications
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Technical knowledge.</strong> Demonstrated through current qualification — BS
              7671 18th Edition (or current edition equivalent) for the underlying electrical work;
              documented emergency lighting training (BAFE SP203-4 module, ICEL training,
              manufacturer-led courses for specific systems).
            </li>
            <li>
              <strong>Training specific to emergency lighting.</strong> Beyond general electrical
              training. Covers: BS 5266-1 / BS EN 50172 / BS EN 50171 / BS EN 1838 framework, design
              and verification methods, photometric survey method, periodic regime, certification
              framework, RRO 2005 context. Documented training records.
            </li>
            <li>
              <strong>Procedural framework.</strong> The firm's working procedure for commissioning,
              periodic verification, and certification. Typically a Quality Management System (QMS),
              a third-party scheme manual (BAFE / NICEIC / ECA), or an in-house framework. The
              procedure is documented and followed.
            </li>
            <li>
              <strong>Signed register of competent persons.</strong> A list, maintained by the firm,
              of who is signed-off competent for what. Each competent person is named,
              qualifications recorded, scope of competence defined (e.g. "competent for design and
              commissioning of self-contained installations up to 500 luminaires"). The register is
              reviewed periodically (annually typical) and updated for new training, retired
              persons, or expanded scope.
            </li>
          </ul>
          <p>
            These four elements are visible to anyone scrutinising a certificate. An auditor, an
            insurer, a fire authority, or a tribunal investigator can ask: who signed this
            certificate, what is their qualification, what training have they had, what procedure
            did they follow, what register are they on? Each question has a documented answer in a
            properly run firm. The 2025 standard treats this as the baseline; informal "we know our
            people are good" is not the 2025 baseline.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Persons carrying out the design, installation, commissioning, verification, and
              maintenance of emergency lighting installations shall have the technical knowledge,
              training, experience, and procedural framework appropriate to the work. Competence
              shall be documented and verifiable. Third-party certification schemes provide a
              recognised route for demonstrating documented competence at firm and individual level.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Initial audit.</strong> The scheme audits the firm's technical competence
              (qualified people, equipment, training records), procedural framework (QMS, work
              instructions, certificate templates), and quality outcomes (sample of past work,
              customer feedback). Successful audit results in registration.
            </li>
            <li>
              <strong>Annual surveillance audit.</strong> Continued registration requires annual
              surveillance — the scheme returns to verify the firm has maintained the standards.
              Re-audit covers a sample of work done since the last audit; deviations are flagged and
              must be corrected.
            </li>
            <li>
              <strong>Triennial reassessment.</strong> A more comprehensive audit every three years
              — confirms that the firm continues to meet the full scheme requirements rather than
              just the surveillance subset.
            </li>
            <li>
              <strong>Complaints handling.</strong> The scheme handles customer complaints against
              registered firms — a real adjudication mechanism that protects the customer and
              disciplines the registered firm.
            </li>
            <li>
              <strong>Public register.</strong> Registered firms are listed on the scheme's public
              register, searchable by name, location, and registration scope. Customers can verify a
              claimed registration easily.
            </li>
          </ul>
          <p>
            Registration costs (annual fee, audit fees, time investment) are real but proportionate.
            The benefit is external validation of competence — the firm does not have to argue its
            own case in every contract negotiation; the registration is the argument. For commercial
            contracts, the registration is increasingly the threshold for tendering, not a
            differentiator.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Specific design choices justified by risk assessment.</strong> Example: a
              small premises with simple evacuation may be designed to a 1-hour duration rather than
              3 hours, where the risk assessment supports this. Documented in the design and on the
              acceptance certificate.
            </li>
            <li>
              <strong>Heritage / listed building constraints.</strong> Example: a Grade I listed
              building where some luminaire positions cannot be installed at the design grid because
              of heritage protection. Documented justification, compensating measures (additional
              luminaires elsewhere), risk assessment.
            </li>
            <li>
              <strong>Phased implementation with timeline.</strong> Example: a multi-phase
              refurbishment where some areas are commissioned now and others later. Documented
              phasing plan, interim measures for currently-uncommissioned areas, target completion
              date.
            </li>
            <li>
              <strong>Equipment non-availability with substitution plan.</strong> Example: a
              specified luminaire model is no longer manufactured; an equivalent is substituted.
              Technical justification of equivalence, design impact assessment, certificate update.
            </li>
          </ul>
          <p>What is now non-compliance (NOT a departure under 2025):</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Missing periodic photometric verification.</strong> Cannot be excused as a
              departure under 2025. Must be carried out.
            </li>
            <li>
              <strong>Missing logbook.</strong> Cannot be excused. Must be in place from
              commissioning.
            </li>
            <li>
              <strong>Missing competence record.</strong> The signing person must demonstrate
              competence. Without the record, the certificate cannot be signed.
            </li>
            <li>
              <strong>Plastic ties on fire-resistant cable / inadequate fire-rated fixings.</strong>{' '}
              Cannot be excused. Must be remediated.
            </li>
            <li>
              <strong>
                "Sign now, test later" — duration test deferred but certificate signed.
              </strong>{' '}
              Cannot be excused. The certificate represents fact at the time of signing; the
              duration test must be done before signing.
            </li>
            <li>
              <strong>Lockable supply isolator without lock fitted.</strong> The lock is part of the
              protective measure. Without it, the protective measure is incomplete.
            </li>
            <li>
              <strong>Missing five-year photometric on a periodic certificate.</strong> The cycle
              has been broken; cannot be excused as a departure.
            </li>
          </ul>
          <p>
            The 2025 narrowing of departures is one of the most practically significant updates.
            Firms accustomed to recording certain shortcuts as "departures" must understand they no
            longer have that flexibility. The position must be either: full compliance, or
            non-compliance with remediation plan. There is less middle ground.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Section A — Documentation review (8-10 items).</strong> Design lux calculation
              present; as-built drawings present; manufacturer manuals present; photometric data
              sheets present; cause-and-effect description (where staged); acceptance certificate
              template ready; logbook starter ready; photographic record plan ready.
            </li>
            <li>
              <strong>Section B — Pre-energisation visual / mechanical (12-15 items).</strong> Per
              area / per circuit: luminaire positions match as-built; cable type per design; cable
              fire-resistance verified; fixings mechanical; mounting per design; orientation per
              design; obstructions clear; supply arrangements per design; battery state acceptable;
              central battery enclosure compliant.
            </li>
            <li>
              <strong>Section C — BS 7671 Part 6 verification (8-12 items).</strong> Continuity of
              CPCs (per circuit); insulation resistance; polarity at every accessory; Zs at most
              distant point of each circuit; RCD operation where applicable; ADS compliance;
              functional test of switching; warning notices in place.
            </li>
            <li>
              <strong>Section D — Charge confirmation (2-3 items).</strong> Manufacturer-specified
              charge period elapsed; charger LED status confirms full charge; central battery state
              of charge confirms full.
            </li>
            <li>
              <strong>Section E — Photometric survey (6-10 items).</strong> Lux meter calibration in
              date; system in emergency mode; measurement plane confirmed; design grid points
              covered; readings recorded; design comparison; BS EN 1838 minima comparison;
              uniformity ratio computed.
            </li>
            <li>
              <strong>Section F — Switch-on test (4-6 items per area).</strong> Per area: supply
              interruption confirmed; per-luminaire response time observed; per-luminaire
              illumination confirmed; per-luminaire fault flags reviewed; restoration confirmed.
            </li>
            <li>
              <strong>Section G — Duration test (8-10 items).</strong> Pre-test full charge
              confirmed; start time recorded; mid-test observation; end-of-test observation (all
              illuminated); end-of-test lux on critical points (where required); recovery start
              confirmed; 24-h recovery confirmation; per-luminaire results.
            </li>
            <li>
              <strong>Section H — Central battery checks where applicable (6-10 items).</strong>{' '}
              Capacity verified; charging system verified; monitoring functional; warning notices in
              place; lockable isolator with lock fitted; fire-rated enclosure intact; output
              sub-circuits labelled; test facility functional.
            </li>
            <li>
              <strong>Section I — Labelling and asset register (4-6 items).</strong> Installation
              labels fitted; asset register populated; photographic record assembled; logbook
              started.
            </li>
            <li>
              <strong>Section J — Certification (4-6 items).</strong> BS 5266-1:2025 acceptance
              certificate completed (all sections); BS 7671 EIC completed; central battery
              certificate completed (where applicable); documentation pack assembled; competence
              declaration signed; departures recorded (with full structure where any).
            </li>
          </ul>
          <p>
            Going through the checklist takes time. Even on a small installation, a thorough run is
            the better part of a day plus the elapsed times for charge and recovery. On a large
            installation, several days. The checklist is the working tool that ensures the
            certificate is signed against actual verification, not against assumed verification.
          </p>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            ...
            {
              question:
                'What if the building owner is also the competent person? Can they sign the acceptance certificate themselves?',
              answer:
            ...
            {
              question:
                'How does the 2025 update affect existing certificates issued under the previous edition?',
              answer:
            ...
            {
              question:
                'Can a single competent person sign certificates across multiple commissionings on the same day?',
              answer:
            ...
            {
              question:
                'Can the BS 5266-1 acceptance certificate be issued before the BS 7671 EIC?',
              answer:
            ...
            {
              question:
                'How does a small premises (e.g. a small shop) approach the certification stack?',
              answer:
            ...
            {
              question:
                'What if I find a previous acceptance certificate signed by an unidentified or unverifiable person?',
              answer:
        ...
        <Quiz
          title="Certification and commissioning checklists — Module 5.5"
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() =>
              navigate('/electrician/upskilling/emergency-lighting-module-5-section-6')
            }
