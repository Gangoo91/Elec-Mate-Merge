    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Approved Document B Volume 2 cl. 5 plus BS 5266-1:2025 trigger thresholds — the methodical
          walk-through that identifies every space in a premises that needs emergency lighting.
        </p>
        ...
        >
          <p>
            The Approved Document B Vol 2 cl. 5 list (paraphrased — read original Cl. 5 / Table 5.1
            for the canonical wording):
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Internal corridors and circulation routes &gt; 30 m</strong>, particularly
              where they have no natural daylight or where the daylight contribution is insufficient
              outside daylight hours. Includes the connections between corridors and stair
              enclosures and the lobbies between corridors and final exits.
            </li>
            <li>
              <strong>Escape staircases</strong> — every staircase that forms part of the designated
              means of escape. Particularly important where the staircase has no natural daylight,
              is below ground level, or is enclosed for fire-protection purposes.
            </li>
            <li>
              <strong>Underground or windowless accommodation</strong> — basements used for any
              purpose where occupants may be present, windowless rooms used for working, storage or
              assembly. The lack of natural light means an unmitigated mains failure produces total
              darkness.
            </li>
            <li>
              <strong>Places of assembly</strong> — auditoria, theatres, cinemas, dance halls,
              function rooms, restaurants, bars, religious buildings, large meeting halls. Open-area
              / anti-panic lighting is the typical requirement, plus escape lighting on the egress
              routes from the assembly space.
            </li>
            <li>
              <strong>Sleeping accommodation</strong> — hotels, hostels, halls of residence, care
              homes, hospitals, hospices. Special considerations for waking occupants and allowing
              assisted evacuation; longer durations are sometimes required.
            </li>
            <li>
              <strong>Escape routes serving high-risk areas</strong> — the route from a high-risk
              task area to the place of safety. The high-risk task lighting (15 lx / 10%) covers the
              workstation; escape route lighting (1 lx full width with edge exclusions per BS EN
              1838:2024) covers the egress; anti-panic covers any open area passed through.
            </li>
            <li>
            ...
            <li>
              <strong>Service routes and tunnels</strong> — long enclosed services routes, cable
              tunnels, plant access routes that occupants may traverse as part of an evacuation or
              that maintenance staff use.
            </li>
          </ul>
          <p>
            The list is the baseline. Any premises that contains any of these features needs the
            corresponding emergency lighting provision. The risk assessment then adds anything else
            use-specific.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Areas listed in Table 5.1 should have emergency escape lighting, including escape
              routes through internal corridors and staircases, underground or windowless
              accommodation, places of assembly, parts of premises used for sleeping accommodation,
              escape routes serving high-risk areas, lift cars and toilets / sanitary accommodation
              exceeding the size or layout threshold. Emergency lighting should comply with BS
              5266-1.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="410" y="62" textAnchor="middle" fill="#A855F7" fontSize="11" fontWeight="bold">
              BUILDING — TYPICAL LOCATION TRIGGERS
            </text>
            <text x="410" y="76" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9.5">
              cross-section showing where Approved Doc B + BS 5266-1:2025 require provision
            </text>
            ...
            <line
              ...
              strokeDasharray="3,3"
            />
            <text x="34" y="200" fill="rgba(255,255,255,0.55)" fontSize="9">
              Ground floor
            </text>
            <text x="34" y="222" fill="rgba(255,255,255,0.55)" fontSize="9">
              Basement
            </text>
            ...
            <g>
              ...
              <text
                ...
                fontWeight="bold"
              >
                1 · Internal corridor &gt; 30 m
              </text>
              <text x="190" y="132" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
                Escape route lighting · 1 lx full width (edge excl.)
              </text>
              <text x="190" y="143" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9">
                Approved Doc B cl. 5 · BS 5266-1:2025 §5
              </text>
            </g>
            ...
            <g>
              ...
              <text x="469" y="135" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
                Anti-panic · 0.5 lx · max 40:1 ratio
              </text>
              <text x="469" y="149" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
                OR &gt; 10 occupants regardless of size
              </text>
              <text x="469" y="166" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                e.g. assembly hall, restaurant
              </text>
              <text x="469" y="180" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9">
                BS EN 1838:2024 §4
              </text>
            </g>
            ...
            <g>
              ...
              <text x="690" y="135" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
                Every flight · half-landings
              </text>
              <text x="690" y="149" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
                Point of emphasis at each step
              </text>
              <text x="690" y="166" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                2025: half-landings need own
              </text>
              <text x="690" y="180" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                luminaire (no borrowed light)
              </text>
            </g>
            ...
            <g>
              ...
              <text
                ...
                fontWeight="bold"
              >
                4 · Plant / switchgear room
              </text>
              <text x="130" y="267" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
                Windowless · safety-critical
              </text>
              <text x="130" y="281" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
                Workplace Regs Reg 8
              </text>
              <text x="130" y="298" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Egress + responder access
              </text>
              <text x="130" y="314" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9">
                ≥ 1 luminaire per room
              </text>
            </g>
            ...
            <g>
              ...
              <text
                ...
                fontWeight="bold"
              >
                5 · High-risk task area
              </text>
              <text x="360" y="267" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
                15 lx OR 10% of task illuminance
              </text>
              <text x="360" y="281" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
                Switch-on ≤ 0.5 s
              </text>
              <text x="360" y="298" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                2025 NEW · ≥ 2 circuits
              </text>
              <text x="360" y="314" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <g>
              ...
              <text x="570" y="267" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
                Reassurance · alarm button
              </text>
              <text x="570" y="281" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
                Locator for rescue team
              </text>
              <text x="570" y="298" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                BS EN 81-20 cross-ref
              </text>
              <text x="570" y="314" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9">
            ...
            <g>
              ...
              <text x="720" y="267" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
                OR multi-turn escape
              </text>
              <text x="720" y="284" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Single straight-run
              </text>
              <text x="720" y="298" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                small toilets often
              </text>
              <text x="720" y="312" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                covered by corridor
              </text>
            </g>
            ...
            <text
              ...
              fontWeight="bold"
            >
              ⚠ + RRO Article 9 risk assessment overlays the standard checklist
            </text>
            <text x="410" y="416" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              Use-specific drivers — high-risk processes, sleeping accommodation, datacentre standby
              — add locations beyond the baseline list
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>&gt; 60 m² floor area.</strong> Above this size, a sudden plunge into darkness
              produces panic because occupants cannot resolve the geometry of the space. The 0.5 lx
              anti-panic illumination keeps the room's shape legible enough for occupants to orient
              themselves.
            </li>
            <li>
              <strong>&gt; 10 occupants regardless of size.</strong> Even a smaller room can have a
              bottleneck-and-panic problem if there are enough people. A training room with 12
              students moving toward a single door, plunged into darkness, is exactly the scenario
              anti-panic addresses. The trigger is occupancy, not just area.
            </li>
            <li>
              <strong>Anti-panic level.</strong> 0.5 lx minimum across the floor, excluding a 0.5 m
              perimeter strip. Maximum 40:1 ratio of brightest to darkest point.
            </li>
            <li>
              <strong>Combination with escape route.</strong> Anti-panic is the area illumination of
              the room; escape route lighting is the navigational illumination of the path leaving
              the room. Both apply where both functions are needed: the room is anti-panic, the
              corridor leaving is escape-route, the door between them is a point of emphasis.
            </li>
          </ul>
          <p>
            Distinguish the two functions clearly. Anti-panic does NOT replace escape route lighting
            — it complements it. A large open meeting room needs anti-panic in the room AND escape
            route lighting on the corridor leaving the room. Both categories, same incident,
            different illuminance levels and different luminaire positions.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              Why 15 lx? Because that is the level at which printed labels, control panel displays,
              gauges, valves and isolators can still be read. Below it, the operator cannot reliably
              operate the equipment. The 10% rule scales the standard up where the normal task
              illuminance is high (e.g. surgical theatre at 1000 lx → emergency level 100 lx).
            </li>
            <li>
              <strong>Switch-on time ≤ 0.5 s.</strong> Faster than the standard 5 s for escape
              route. The reason: the press is in motion, the reactor is exothermic, the surgical
              incision is open. A 5-second outage of light may be intolerable for the process; the
              lighting must be effectively instantaneous.
            </li>
            <li>
              <strong>Duration appropriate to the task.</strong> The lighting must last long enough
              for the safe-shutdown procedure plus a margin. Often this is just a few minutes — but
              it must be evaluated and documented. Some processes have longer safe-shutdown
              procedures and the high-risk lighting must run for the full duration plus margin.
            </li>
            <li>
              <strong>NEW in 2025: ≥ 2 separate circuits, ≤ 20 luminaires per fault.</strong>
              Segmentation rule. Splits the EL provision so a single circuit fault cannot disable
              the protection in a hazardous area. Designs after 31 October 2025 must meet this rule;
              pre-existing systems are reviewed at the next photometric survey.
            </li>
          </ul>
          <p>
            High-risk task areas need a documented design. Identify the hazardous activity, identify
            the safe-shutdown procedure, time the procedure, define the duration, specify the
            illuminance and the switch-on time, and segment the EL supply per the 2025 rule. The
            design output goes into the BS 5266 design certificate and survives audit.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              required maintained illuminance for the task, but not less than 15 lx. The lighting
              shall be free from harmful stroboscopic effects. The illuminance shall be reached
              within 0.5 s with a uniformity (Emin / Emax) not less than 0.1 (i.e. the
              maximum-to-minimum ratio shall not exceed 10:1).
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>The borrowed source may have failed.</strong> If the corridor luminaire that
              was supposed to spill into the lobby has itself failed (LED module failure, local
              circuit fault), the lobby is in darkness. The premises has no defence against this
              scenario when relying on borrowed light.
            </li>
            <li>
              <strong>The intervening door may be closed.</strong> Many lobbies have fire-resisting
              doors that are closed in a fire situation. Light that spills into the lobby through an
              open door does not spill when the door is closed. The 2016 edition often glossed over
              this; the 2025 edition does not.
            </li>
            <li>
              <strong>The decoration may have changed.</strong> A wall painted dark, a glazed screen
              retro-fitted with privacy film, a partition installed — all reduce the borrowed light
              that was assumed in the original design. Premises change over their life; a design
              dependent on assumed reflectances and light paths is fragile.
            </li>
            <li>
              <strong>
                The standard committee judged the savings disproportionate to the risk.
              </strong>{' '}
              Borrowed-light designs typically save one or two luminaires per affected lobby — 5 to
              15% of the luminaire count for the affected route. The committee judged the cost
              saving disproportionate to the safety risk; the new edition mandates direct
              illumination.
            </li>
          </ul>
          <p>
            The practical impact on retrofits is real but bounded. Audit any 2016-design scheme by
            walking the building with the design drawings; identify every space that is illuminated
            by spill rather than by its own luminaire; specify additional luminaires for those
            spaces; install during the next photometric verification cycle. Cost per affected space
            is small (typically £80-150 for a self-contained LED luminaire plus minor wiring); cost
            across a building can be material.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The illumination required by this standard for any space shall be provided directly by
              emergency luminaires positioned to illuminate that space. Illumination spilled from
              luminaires positioned in adjacent spaces ("borrowed light") shall not be counted as a
              contribution to the design provision for the space. This requirement applies whether
              the adjacent space is connected by an open aperture, a closed door, or a glazed
              partition.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>At each exit door</strong> intended for use in an emergency. Both sides —
              internally to flag the door from the room, and externally (where applicable) to flag
              the assembly area outside the final exit.
            </li>
            <li>
              <strong>Outside each final exit, at the point of safety.</strong> Reassures evacuated
              occupants that they have reached safety; allows the muster point / assembly area to be
              located and used; allows the fire and rescue service to identify the building entry.
            </li>
            <li>
              <strong>At every change of direction</strong> on the escape route. Where the corridor
              turns, where a stair top opens onto a corridor, where two corridors meet at an angle.
              Without an emphasis luminaire, the occupant may continue past the turn.
            </li>
            <li>
              <strong>At each intersection of corridors.</strong> Decision point — which way? The
              luminaire at the intersection (often combined with a directional running-man sign)
              makes the decision support visible.
            </li>
            <li>
              <strong>At every staircase.</strong> Each individual flight of every stair on the
              escape route. From the 2025 edition, half-landings need their own provision (no
              borrowed light).
            </li>
            <li>
              <strong>
                Near each fire alarm call point and near each item of firefighting equipment.
              </strong>{' '}
              5 lx vertical at the fire alarm call point and at the fire extinguisher / hose reel.
              The vertical level allows the occupant to read the instructions on the equipment and
              to operate it correctly.
            </li>
            <li>
              <strong>Near each first-aid post.</strong> Same logic as firefighting equipment;
              first-aid use during or after an evacuation may be required and the responder must be
              able to read instructions and use the equipment.
            </li>
            <li>
              <strong>At every change of floor level.</strong> Steps, ramps, mezzanine transitions.
              These are the highest-risk points in an evacuation for trip and fall injury; emphasis
              lighting reduces the risk.
            </li>
            <li>
              <strong>Near each safety equipment item</strong> generally — emergency stop buttons,
              isolator handles, refuge points for assisted evacuation, evacuation chairs, fire
              blankets in kitchens.
            </li>
          </ul>
          <p>
            The list is exhaustive in concept though contextual in application. A small office may
            have only three or four points of emphasis (final exit, change of direction, fire alarm
            call point); a hospital may have hundreds. The luminaire layout that hits all the points
            of emphasis is the design output.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Emergency escape lighting luminaires shall be provided at the points of emphasis
              listed in this clause. These are the locations on the escape route or associated with
              safety equipment where additional illumination is required to ensure the location is
              identifiable and the equipment is usable. Points of emphasis include but are not
              limited to: exits, changes of direction, intersections, staircases, near fire safety
              equipment, near first-aid posts, and at changes of floor level.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Healthcare — HTM 06-01.</strong> Hospitals, clinics, dental surgeries. Standby
              lighting for operating theatres (under 2025 scope expansion), special durations for
              areas where assisted evacuation is required (longer than 3 hours for some wards),
              local-area lighting for night-time wards, IPS / UPS considerations for life-critical
              equipment per BS EN 50171.
            </li>
            <li>
              <strong>Education — BB 100.</strong> Schools, colleges, universities. Anti-panic in
              halls, sports halls, lecture theatres. Escape route lighting in long corridors.
              Special considerations for SEN provision and disabled-access escape routes, evacuation
              chairs at refuge points.
            </li>
            <li>
              <strong>Places of assembly — Purple Guide / venue-specific.</strong> Theatres,
              cinemas, dance halls, nightclubs, restaurants, sports venues. Anti-panic throughout
              the assembly area; escape route lighting on every egress; special considerations for
              stage / performance lighting interacting with the EL system, blackout transitions,
              audience-direction (audience faces the stage; emergency lighting must illuminate
              without blinding the performance).
            </li>
            <li>
              <strong>Residential care — CQC-regulated.</strong> Care homes, nursing homes,
              hospices, supported living. Local-area lighting in resident bedrooms (under 2024 EN),
              longer durations for assisted evacuation (3 hours minimum, some sectors longer),
              anti-panic in dining and lounge areas, sleep-friendly colour temperatures so
              night-time use does not disturb residents.
            </li>
            <li>
              <strong>Industrial / manufacturing — high-risk task driven.</strong> Factories,
              workshops, plant. High-risk task lighting at hazardous machinery, escape route from
              the workstation through the production area, anti-panic where the production area
              exceeds 60 m², with the 2025 segmentation rule (≥ 2 circuits, ≤ 20 luminaires per
              fault) for the high-risk areas.
            </li>
            <li>
              <strong>Retail / hospitality.</strong> Shops, supermarkets, restaurants, bars, hotels.
              Anti-panic in trading floor and dining areas, escape route lighting on egress through
              stockrooms / kitchens / back-of-house, emphasis at front-of-house exits, hotel
              sleeping accommodation provisions.
            </li>
            <li>
              ...
              durations matched to the operational requirement, BS EN 50171 central battery / IPS
              considerations.
            </li>
          </ul>
          <p>
            The sector overlay is layered ON TOP of BS 5266-1:2025 — it does not replace it. The
            baseline standard delivers the engineering; the sector guidance delivers the
            context-specific decisions. A care home design follows BS 5266-1:2025 plus the relevant
            CQC / care-sector guidance; a hospital follows BS 5266-1:2025 plus HTM 06-01.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Step 1 — The Approved Document B baseline walk.</strong> Walk the building
              with the Approved Document B Vol 2 cl. 5 list as a checklist. Tick each space on your
              survey form: corridor &gt; 30 m, escape stair, basement, place of assembly, sleeping
              accommodation, escape from high-risk area, lift, toilet block, plant room. Output:
              list of premises locations triggering EL by the Approved Document.
            </li>
            <li>
              <strong>Step 2 — The BS 5266-1:2025 trigger overlay.</strong> Apply the technical
              thresholds to every room: floor area &gt; 60 m² or occupancy &gt; 10 (anti-panic);
              &gt; 8 m² toilet or multi-turn (anti-panic / escape); high-risk task identifiable;
              escape route flow defined. Refine the list. Mark each space as one or more of escape /
              anti-panic / high-risk / standby / local-area.
            </li>
            <li>
              <strong>Step 3 — The RRO Article 9 risk-assessment overlay.</strong> What does the
              building actually DO? What activities take place that the standard checklists may not
              capture? Standby lighting requirements for life-critical equipment? Local-area
              lighting for residents who remain in place? High-risk task at unusual workstations?
              Special-premises sector requirements? Add locations and categories that the previous
              steps missed.
            </li>
            <li>
              <strong>Step 4 — The schedule.</strong> Produce a printed schedule listing every
              space, its area, its trigger, its EL category(ies), its target illuminance, the points
              of emphasis it contains, and the special considerations. The schedule is the design
              brief; the design (luminaire layout, supply, controls) is built FROM the schedule, not
              the other way round. The schedule also becomes the photometric-verification reference
              at year 5 — every space and every point of emphasis must be re-verified.
            </li>
          </ol>
          <p>
            This methodical approach is also defensible. If a question is later asked about why a
            particular space was (or was not) provided with EL, the schedule shows the reasoning.
            "Triggered by Approved Document B Vol 2 cl. 5 line 3 — corridor &gt; 30 m without
            natural daylight" is a documented justification; "we put a luminaire there because we
            had one spare" is not.
          </p>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            {
              question: 'Do single private dwellings need emergency lighting?',
              answer:
            ...
            {
              question: 'Are car parks (multi-storey or basement) within scope?',
              answer:
