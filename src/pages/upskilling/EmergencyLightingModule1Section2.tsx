          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent">
                ...
                <p className="text-white text-xs">Direction threshold</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">Each Flight</p>
                <p className="text-white text-xs">Stair coverage</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">2m Max</p>
                <p className="text-white text-xs">Exit sign distance</p>
              </div>
            </div>
          </div>
        </section>
