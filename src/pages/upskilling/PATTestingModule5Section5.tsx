    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The PAT report is a record of work done — not a regulatory certificate. Recommended
          content under IET CoP 5th Ed. Chapter 16, the competent-person sign-off, electronic
          signatures, and PDF/A archival.
        </p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              results, the competent person responsible for the inspection and testing, and the date
        ...
        >
          <p>
            IET CoP 5th Ed. defines the competent person without prescribing a single qualification.
            The criteria are functional:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Knowledge of the hazards</strong> — electric shock, indirect contact, damaged
              insulation, polarity reversal, working with energised equipment during a run / leakage
              test.
            </li>
            <li>
              <strong>Ability to interpret results</strong> — knowing what a 0.43 Ω earth continuity
              reading means in context, what triggers a fail, what is borderline, what to
              investigate.
            </li>
          </ul>
          <p>
            ...
            exposure) plus practical experience. There is no mandated qualification — competence is
            the gate, evidenced by qualification + experience.
          </p>
          <p>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong className="text-elec-yellow">Standards and methodology.</strong> The standards
              / codes of practice followed (IET CoP 5th Ed., HSG107, EAWR 1989). A short statement
              of methodology — categories and intervals applied per IET CoP Table 7.1, user-check /
              formal-visual / combined-test layers if relevant.
            </li>
            <li>
            ...
            <li>
              ...
              section. Each failed item by asset ID, the failure mode, the test that failed with the
              numerical reading, the action taken (quarantined / repaired-and-retested / disposed),
              and the date of action.
            </li>
            <li>
              <strong className="text-elec-yellow">Sign-off.</strong> The competent person\'s name,
              qualifications, signature (wet or electronic), and date. The tester\'s name separately
              if different. Statement of professional responsibility.
            </li>
          </ol>
          <p>
            Optional but commonly included: an executive summary at the top (number of items tested,
            pass / fail counts, headline findings), an appendix with the asset register snapshot at
            test time, and a recommendations section (interval review, equipment replacement,
            training needs).
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="80" y="258" fill="rgba(255,255,255,0.85)" fontSize="9">
              Columns: asset ID · description · class · location · earth continuity (Ω) · insulation
              (MΩ)
            </text>
            ...
            <text x="80" y="454" fill="rgba(255,255,255,0.7)" fontSize="9">
              Name, qualifications, signature (wet or electronic), date. Tester named separately if
              different.
            </text>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              inspection and testing has been carried out by a competent person, in accordance with
              the appropriate procedures, using suitable instruments, and that the results meet the
              criteria for the equipment under inspection.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              any alteration breaks the hash. The signatory\'s identity is in the document metadata.
              Better evidence than a pasted image.
            </li>
            <li>
              <strong>Digital signature certificate (PKI-based).</strong> A cryptographic signature
              tied to a verified identity certificate. The signature is verifiable by anyone with
              the public key, and any alteration to the document invalidates the signature. The
              strongest standard form.
            </li>
            <li>
              <strong>Qualified electronic signature (eIDAS QES).</strong> A digital signature
              certified by a Qualified Trust Service Provider. Legally equivalent to a hand-written
              signature under retained eIDAS. Highest legal standing.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              history be retrieved by asset ID within minutes, not hours. HSE requests rarely allow
              days for retrieval.
            </li>
          </ul>
          <p>
            Paper alone is a single point of failure: fire, water, lost-in-move scenarios are real.
            Thermal-printed labels and instrument printouts fade. Native instrument database files
            become unreadable when the instrument is replaced unless exported. Build the archival
            path into the test process from the start.
          </p>
        </ConceptBlock>
