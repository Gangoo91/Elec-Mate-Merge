    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Unshielded, foiled and shielded twisted pair — the XX/YTP shield notation, the four common
          constructions (U/UTP, F/UTP, U/FTP, S/FTP), when shielding genuinely helps, and how BS
          7671:2018+A4:2026 §444.5.3.1 mandates that every metallic screen, sheath or armouring of a
          data transmission cable is bonded to the equipotential bonding network.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              <strong>U/UTP — plain unshielded twisted pair.</strong> No overall screen, no per-pair
              shield. Lightest, cheapest, fastest to terminate. The 2026 default for ordinary
              commercial office Cat6A. Relies entirely on pair balance and the twist for noise
              rejection.
            </li>
            <li>
              <strong>F/UTP — foil overall, unshielded pairs.</strong> One thin foil wrapped around
              all four pairs together, inside the jacket, plus a drain wire to make contact with the
              screened connector body. Common Cat6A premium construction. Adds margin against alien
              crosstalk and against general external fields without the cost / bulk of an overall
              braid.
            </li>
            <li>
              <strong>U/FTP — unshielded overall, foil per pair.</strong> No overall screen, but
              each of the four pairs is individually wrapped in foil. The standard construction for
              Cat7 / Cat7A and a common premium Cat6A. Excellent inter-pair isolation (NEXT margin)
              and very good alien-crosstalk control between cables. Heaviest demand on termination
              care because there are four foils to capture.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              welders / lift drives, or close proximity to LV submains where Annex A444 separation
              cannot be achieved by distance and containment alone. §444.41 lists the typical
              disturbance sources verbatim. In these environments, balance alone is not enough — the
              screen adds the next decade of margin.
            </li>
            <li>
              ...
              71.3 W PD per IEEE 802.3bt) carries sustained DC current; in tight bundles this raises
              cable temperature and erodes every channel parameter — including alien crosstalk.
              §716.523.1.101 NOTE 1 spells this out: "Any temperature rise of the data cables due to
              the load current they carry, or other causes, will increase the attenuation/insertion
              loss of the cables. Thus the performance of information transmission channels can be
              degraded." Per-pair foil (U/FTP or S/FTP) restores alien-crosstalk margin in hot
              bundles.
            </li>
            <li>
          ...
          <p>
            ...
            shielded RJ45 / screened patch panel; the panel bonds to the rack bonding bar; the rack
            bonds to the Telecommunications Bonding Backbone (TBB) per BS EN 50310; the TBB bonds to
            the MET / MFET (BS 7671 §545). Every link gets tested for screen continuity at handover.
            If any of that is impractical or not going to be done well, you should not be specifying
            screened cable.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Step 1 — cable termination.</strong> Foil + drain wire (or full braid) land in
              a screened keystone or shielded RJ45. The connector body is in continuous metallic
            ...
            <li>
              <strong>Step 4 — TBB (Telecommunications Bonding Backbone).</strong> The rack bonding
              bar runs back to the TBB per BS EN 50310 / ANSI/TIA-607-E.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              A meshed equipotential bonding network is enhanced by the existing metallic structure
              of the building. It is supplemented by conductors forming the square mesh. Mesh size
              should be adapted to the dimensions of the installation to be protected and should be
              in accordance with the recommendations of BS EN 50310. Where concerns exist, the mesh
              size should be adapted to the dimensions of the installation to be protected, but
              should not exceed 2 m × 2 m in areas where equipment susceptible to electromagnetic
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Solid metallic containment C:</strong> NOTE 4 — "no physical separation other
              than that provided by the containment". NOTE 3 defines this as "fully enclosed steel
              containment 1.5 mm minimum wall".
            </li>
            <li>
            ...
            <li>
              <strong>Voltage / current scaling (Table A444.2):</strong> the base separations scale
              with disturbing voltage / current — 240 V → 0.45 m, 415 V → 0.58 m, 3.3 kV → 1 m; 5 A
              → 0.24 m, 50 A → 0.5 m, 300 A → 0.85 m.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              functional earthing of ICT equipment (signal reference, EMC) from protective earthing
              under §543 / §544 (electrical safety). Introduces the MFET (Main Functional Earthing
              Terminal) concept — the ultimate destination of the bonding chain that starts at a
              cable screen. Minimum CSAs: 2.5 mm² Cu (with mechanical protection) or 4 mm² Cu
              (without) per §545.1.2.
            </li>
            <li>
              ...
              considering a screened construction (per-pair foils restore alien-crosstalk margin in
              hot bundles).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              standard unshielded keystones. The installer terminates the cable normally — the foil
              drain wire is cut off because there is nowhere to land it. Channel tester reports PASS
              on wire-map and most parameters but flags a screen-continuity fail on every link. The
              screen is floating end-to-end. The job is non-compliant with §444.5.3.1, electrically
              the cable is acting like U/UTP with extra cost and weight, and the certification
              handover fails Class EA on screen continuity.
            </>
          }
          doInstead={
            <>
              ...
              the budget will not stretch to the bonding work, do not specify a screened cable — go
              U/UTP Cat6A in bonded steel containment instead, and let Annex A444 + §444.5.3.1
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              routes pass within 1.5 m of the LV submains feeding them. The wireless design requires
              high-density ceiling APs (every 8 m), each pulling Type 4 PoE++. The horizontal
              cabling will go in 96-cable bundles down the perforated tray serving the upper roof
              void. Build standard wants 10GBASE-T to every AP.
            </>
          }
          whatToDo={
            <>
              Run the Annex A444 segregation calc first: VSD-fed LV submains in perforated metallic
              containment, parallel to ICT — Table A444.1 says 150 mm minimum. Validate that 150 mm
              can be held the entire route; if it cannot, you are into shielded territory
              regardless. Run the bundle thermal calc per TIA TSB-184-A: 96 cables × Type 4 PoE ×
              ambient warehouse temperature → significant temperature rise; alien-crosstalk margin
              in U/UTP Cat6A would be eroded. Conclusion: F/UTP or U/FTP Cat6A is the correct cable.
              Specify screened keystones and screened patch panels throughout, rack bonding bars,
              bond chains to the TBB, and §716 cable thermal compliance (≤ 750 mA per conductor;
              LP-rated cable considered). Run the cabling on the perforated tray with 150 mm
              separation from the LV submains; tray bonded per §444.5.3.1. Class EA channel
              certification with screen continuity at handover.
            </>
          }
          whyItMatters={
            <>
              ...
              drivers (VSD EMI + dense PoE bundles) push the design firmly into shielded territory;
              in a normal office those same calcs would land at U/UTP. The contractor who can run
              the calcs and explain the answer is the one who delivers a defensible design.
            </>
          }
        />
