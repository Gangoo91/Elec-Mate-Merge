...
const DataCablingModule2Section2 = () => {
  useSEO({
    title: "UTP, FTP, STP Explained | Data Cabling Module 2.2",
    description: "Understand cable shielding types including UTP, FTP, and STP, with grounding requirements and EMI mitigation strategies."
  });
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/upskilling/data-cabling-module-2-section-1">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous Section
            </Link>
          </Button>
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/upskilling/data-cabling-module-2-section-3">
              Next Section
