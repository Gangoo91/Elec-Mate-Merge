    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          PSCC, PEFC and PFC — what the meter is actually measuring, what the DNO is actually
          declaring, and how the number on the screen decides whether the board on the wall is safe.
        </p>
        ...
        >
          ...
          <p>
            ...
            method. On a typical EIC the PFC at the origin is measured directly with a multifunction
            tester. At downstream points it is usually calculated from the origin PFC and the known
            cable impedances back to the source. Both are equally valid provided the reasoning is
            recorded.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            line-to-neutral loop is shorter than the line-to-earth loop. On a TT installation with a
            high earth-electrode resistance the PEFC may be very small relative to the PSCC, with
            disconnection-time consequences that you handle separately under Reg 411.5.3 (covered in
            §6). On a TN-S installation with a low Ze, the two values can be close.
          </p>
          <p>
            The schedule on an EIC asks for PFC. That single number is the worst case at the origin
            (or at the relevant point) and is the value compared against breaking capacity under Reg
            434.5.1. If a meter has a single &ldquo;PFC&rdquo; reading, that is what it latches: the
            higher of the two internal measurements. Some meters expose PSCC and PEFC separately on
            a sub-screen — read both, record the larger as PFC, and write the smaller in the
            comments where it matters for design (TT systems are a common case).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              A device providing protection against both overload and fault current shall be capable
              of breaking, and for a circuit-breaker making, any overcurrent up to and including the
              maximum prospective fault current at the point where the device is installed.
            </>
          }
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Origin PFC (single-phase, TN-C-S):</strong> Z is the source impedance back to
              the transformer plus the service cable. A typical 100 A urban TN-C-S service gives a
              measured PFC in the 1.5–6 kA range. The DNO declaration for the same point will be 16
              kA (the worst-case network design figure).
            </li>
            <li>
              <strong>Origin PFC (three-phase symmetrical):</strong> for a balanced three-phase
              fault, symmetrical PSCC ≈ √3 × the single-phase L–N PSCC when the source impedance is
              dominated by the transformer (which it is, on most LV networks). A 5 kA L–N reading at
              the origin implies ≈ 8.7 kA three-phase symmetrical at the same point.
            </li>
            <li>
              <strong>Downstream PFC:</strong> at a sub-board fed by a 25 m run of 25 mm² cable, the
              cable impedance adds to the source impedance. Z<sub>sub</sub> = Z<sub>origin</sub> + Z
              <sub>cable</sub>. A higher Z means a lower PFC further into the installation — which
              is why the PFC at a final-circuit MCB is much lower than at the consumer-unit incomer.
            </li>
          </ol>
          <p>
            The cable contribution is small in absolute ohms but matters in PFC terms. A 25 m run of
            25 mm² cable adds roughly 25 × (0.727 + 0.727) mΩ/m ≈ 0.036 Ω at 20°C — enough to drop a
            6 kA origin PFC down to about 3.9 kA at the sub-board. That is why a 6 kA MCB at the
            sub-board can be defensible even though the origin PFC exceeds 6 kA.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="205" y="42" textAnchor="middle" fill="#EF4444" fontSize="12" fontWeight="bold">
            ...
            <text x="300" y="96" textAnchor="middle" fill="#EF4444" fontSize="10" fontWeight="bold">
              PFC ≈ 15 kA
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="300" y="130" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              B32 MCB · 6 kA
            </text>
            <rect
              x="255"
              ...
              strokeWidth="1"
            />
            <text x="300" y="160" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              B16 MCB · 6 kA
            </text>
            <rect
              x="255"
              ...
              strokeWidth="1"
            />
            <text x="300" y="190" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              B6 MCB · 6 kA
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="595" y="42" textAnchor="middle" fill="#22C55E" fontSize="12" fontWeight="bold">
            ...
            <text x="690" y="96" textAnchor="middle" fill="#22C55E" fontSize="10" fontWeight="bold">
              PFC = 3.4 kA
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="690" y="130" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              B32 MCB · 6 kA ✓
            </text>
            <rect
              x="645"
              ...
              strokeWidth="1"
            />
            <text x="690" y="160" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              B16 MCB · 6 kA ✓
            </text>
            <rect
              x="645"
              ...
              strokeWidth="1"
            />
            <text x="690" y="190" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              B6 MCB · 6 kA ✓
            </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              (Icn, Icu, Ics) are symmetrical RMS values. Modern multifunction testers report PFC as
              symmetrical RMS by default. Some legacy instruments report peak (kA peak). Check the
              meter manual before applying any conversion factor — assuming a √2 scale blindly will
              under-state PFC and put you in the wrong column on the device data sheet.
            </li>
            <li>
              <strong>The reading reflects the day, not the design case:</strong> a measured PFC of
              4 kA at an origin where the DNO declares 16 kA does not contradict the declaration.
              The DNO figure is the network worst case (low-impedance fault at low-load conditions);
              the measurement is what was available on the day. Record both. Design to the higher
              (declared) value for breaking-capacity selection. A measurement that exceeds the
              declaration is the diagnostic flag — investigate the service connection or the meter
              test setup.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              Its breaking capacity must be ≥ the L–N PSCC value at the busbar — the same number the
              meter reads when the L–N test probes are placed across one phase and neutral.
            </li>
            <li>
              <strong>Line-to-line (L–L) fault on a 3φ board:</strong> approximately √3/2 × the
              three-phase symmetrical value. Almost never the worst case once the three-phase value
              has been considered.
            </li>
          </ul>
          <p>
          ...
          whatToDo={
            <>
              ...
              <span className="block">
                ...
                <strong className="text-red-300">non-compliant</strong>. Same options: higher-rated
                device, cascading, or downstream of cable that drops PFC below 6 kA.
              </span>
              <span className="block">
                Both findings go on the EIC schedule with PFC values stated for L–N (7.2 kA) and 3φ
                (12.5 kA). Each device line shows its rating against the relevant PFC.
              </span>
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              the comments (&lsquo;DNO declared 16 kA&rsquo; / &lsquo;measured at origin 4.8 kA, no
              DNO declaration available&rsquo;).
            </li>
            <li>
              ...
              tester. Include the value on the schedule of distribution-board details for each board
              where Reg 434.5.1 is verified.
            </li>
            <li>
              ...
              PSCC (typical on TT systems), cascading combination relied upon, BS EN 61439-3 + 16 kA
              relief invoked.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            ...
            {
              question: 'My meter shows PFC and the DNO declaration is different. Which do I use?',
              answer:
