...
const FireAlarmModule7Section4 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 7 · Section 4" title="BS 5839-6 requirements" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS 5839-6:2019+A1:2020 is the domestic counterpart to BS 5839-1. It covers fire detection
          and alarm in dwellings: single-family homes, HMOs, supported housing, the inside of flats.
          Six grades (A, C, D1, D2, F1, F2 — post-2020 split). Three categories (LD1, LD2, LD3).
          England has the lowest threshold under Approved Document B Vol 1; Scotland has the
          tightest (post-Cameron House); Wales has its own framework.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Single-family dwellings.</strong> Houses (terraced, semi-detached, detached),
              bungalows. The most common BS 5839-6 application.
            </li>
            <li>
            ...
            <li>
              ...
              lodgings, where unrelated occupants share facilities. Higher risk than family dwelling
              because of the multiple-unrelated-occupant factor; typically Grade A LD1.
            </li>
            <li>
            ...
            <li>
              <strong>Loft conversions.</strong> A new storey added to an existing dwelling triggers
              ADB Vol 1 §2 + BS 5839-6 — interlinked alarms on every storey including the new one.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Hostels, dormitories with high-density transient occupation (BS 5839-1; some supported
              housing patterns sit on the boundary and are case-by-case).
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              and fire alarm systems for use in dwellings. It is intended to assist designers,
              installers, suppliers, users and enforcing authorities in achieving consistent levels
              of protection of life and property within dwellings. Like all British Standards, it is
              a code of practice and provides recommendations rather than mandatory requirements.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Grade A.</strong> A panel-based system with the architecture and installation
              requirements of a BS 5839-1 system, but located in a dwelling. Used in HMOs, supported
              housing, complex / large dwellings. The most comprehensive grade. Requires a fire
              alarm panel, BS 5839-1-style detection / sounders / cabling, proper commissioning and
              maintenance regime. Commonly combined with LD1 coverage.
            </li>
            <li>
              ...
              detectors). REVISED in 2020 to clarify the architecture. Smaller / simpler than Grade
              A. Used where a panel-based architecture is appropriate but full Grade A is
              over-specification. Some larger dwellings, some smaller HMOs, some sheltered housing.
            </li>
            <li>
              <strong>Grade D1.</strong> Mains-powered detector with NON-REMOVABLE rechargeable
              backup. No central panel — alarms are interconnected (interlinked) so any one triggers
              all. The standard new-build solution for typical dwellings. The non-removable battery
              is the key feature: prevents the historic "removed battery to silence false alarms"
              failure mode that killed users for decades. The battery is sealed within the alarm
              housing for the life of the device.
            </li>
            <li>
            ...
            <li>
              <strong>Grade F1.</strong> Battery-only detector (no mains supply) with NON-REMOVABLE
              battery (typically a 10-year sealed lithium cell). The 10-year sealed cell is one of
              the most significant fire safety improvements of the past decade — it eliminates the
              user-replacement failure mode. Used for replacement of existing battery-only alarms or
              where mains-power running is impractical (e.g. some listed buildings).
            </li>
            <li>
          ...
          <p>
            Architecturally: A and C are panel-based. D1, D2 are mains-with-backup detectors. F1, F2
            are battery-only detectors. Resilience: A &gt; C &gt; D1 ≈ D2 &gt; F1 ≈ F2. The choice
            is a function of the FRA / risk assessment and the dwelling type.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>LD2 — escape routes + high-risk rooms.</strong> Detection on the escape route
              (hall, landing) AND in high-risk rooms — must include kitchen (heat detector) and
              principal habitable room (smoke detector), and may include other rooms identified by
              the FRA as elevated risk (utility rooms, bedrooms with high-power appliances, etc.).
              The standard new-build coverage in England under ADB Vol 1.
            </li>
            <li>
              <strong>LD3 — escape routes only.</strong> Detection on the circulation routes only —
              hall and landing. No detection in habitable rooms, kitchen or principal habitable. The
              lowest level. Used as the retrofit minimum where the dwelling is being brought up to a
              baseline standard but full LD2 / LD1 is not justified.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Retrofit upgrade — minimum.</strong> Grade D1 + LD3 typical, or Grade F1 + LD3
              if mains running is impractical.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              A fire detection and fire alarm system in accordance with the relevant recommendations
              of BS 5839-6 should be provided in all dwellinghouses. The system should be at least
              Grade D Category LD3 standard (i.e. mains powered alarms with a battery backup,
              located in circulation areas), and where appropriate should be Category LD2 (i.e. with
              the addition of detectors in the kitchen and the principal habitable room).
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            {/* Column headers */}
            <text x="280" y="64" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              LD1 — full coverage
            </text>
            ...
            <text x="490" y="64" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
            ...
            <text x="700" y="64" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              LD3 — escape only
            </text>
            ...
            <g>
              ...
              <rect
                ...
                strokeDasharray="3,3"
              />
              <text x="490" y="138" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9.5">
                rare —
              </text>
              <text x="490" y="153" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9.5">
              ...
              <rect
                ...
                strokeDasharray="3,3"
              />
              <text x="700" y="138" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9.5">
                rare —
              </text>
              <text x="700" y="153" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9.5">
                unusual combination
              </text>
            </g>
            ...
            <g>
              ...
              <rect
                ...
                strokeDasharray="3,3"
              />
              <text x="700" y="216" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9.5">
                uncommon
              </text>
            </g>
            ...
            <g>
              ...
              <rect
                ...
                strokeWidth="1"
              />
              <text x="490" y="358" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9.5">
                Lower-risk new-build (LD2 / LD3) where user-replaceable battery acceptable —
              </text>
              <text x="490" y="372" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9.5">
            ...
            <g>
              ...
              <text x="490" y="432" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
            ...
            <g>
              ...
              <rect
                ...
                strokeDasharray="3,3"
              />
              <text x="490" y="478" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9.5">
            ...
            <g>
              ...
              <text x="440" y="529" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
                Grades B and E REMOVED in 2020 revision · ★ = England standard new-build per ADB Vol
                1
              </text>
            </g>
          </svg>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              (typically living room) and in every circulation space on each storey (hall, landing).
              Effectively LD1 coverage but expressed in different language.
            </li>
            <li>
            ...
            <li>
              <strong>Interlinking.</strong> All alarms must be interlinked — when one detects, all
              sound. Hard-wired (mains + interlink core) or RF (wireless mesh). The requirement for
              interlinking is unconditional.
            </li>
            <li>
          ...
          <p>
            ...
            fire fatalities, drove a domestic standard now materially higher than ADB Vol 1 England.
            Whether England follows is a political question; the engineering case for interlinked
            alarms in every room is strong.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Coverage.</strong> Smoke alarms on every storey (interlinked) + CO where fixed
              combustion appliances. Tighter than England's Smoke and CO Alarm Regs but lighter than
              Scotland's every-room standard.
            </li>
            <li>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>HMOs.</strong> Houses in Multiple Occupation (HMOs) Act (NI) 2016 — licensing
              regime with fire safety conditions; typically Grade A LD1.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              fires and for giving warnings in the event of a fire or suspected fire. Such provision
              must include — (a) a smoke alarm in the room which is frequently used by the occupants
              of the house for general daytime living purposes; (b) a smoke alarm in every
              circulation space on each storey, such as hallways and landings; (c) a heat alarm in
              every kitchen; and (d) all such alarms being interlinked.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              separate two-core interlink alongside the supply). When one alarm detects, it applies
              a signal voltage to the interlink that the others recognise as "alarm".
            </li>
            <li>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              in the 868 MHz Short Range Devices band in the UK / Europe). At commissioning, alarms
              are paired into a mesh. When one detects, it broadcasts to the mesh.
            </li>
            <li>
            ...
            <li>
              ...
              verification, pairing protocols. Grade D1 alarms with built-in RF interlink are widely
              available.
            </li>
          </ul>
          <p>
            For the contractor, the practical decision is access. New build with cabling accessible:
            hard-wired interlink. Retrofit / listed / impractical-cabling: RF. Both meet BS 5839-6
            when correctly applied. The commissioning verification differs — hard-wired needs
            continuity check; RF needs link-margin / signal-strength verification at every alarm
            position.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Where required (Scotland).</strong> Tolerable Standard — CO alarm in any room
              with a fixed combustion appliance other than a gas cooker. All homes regardless of
              tenure.
            </li>
            <li>
            ...
            <li>
              <strong>Mounting.</strong> CO alarms are typically wall-mounted at a height of 1-3 m,
              in the same room as the fixed combustion appliance, but not directly above or in close
              proximity to the appliance (CO is buoyant when warm but disperses generally; mounting
              too close can produce false alarms from start-up). BS 5839-6 Annex gives detailed
              guidance.
            </li>
            <li>
              <strong>Combined smoke + CO devices.</strong> Available; integrate with fire alarm
              mesh. Useful where one device location can serve both functions (e.g. a hallway near a
              boiler cupboard).
            </li>
            <li>
              <strong>Lifespan.</strong> CO sensors degrade chemically over time. Most units have a
              7-10 year sensor life, marked on the device. Must be replaced (not just
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Licensing thresholds.</strong> Mandatory licensing applies to HMOs occupied by
              5+ persons forming 2+ households (from October 2018; previously was 3 storeys + 5
              persons). Many local authorities have additional licensing schemes capturing smaller
              HMOs.
            </li>
            <li>
              <strong>Fire safety conditions.</strong> The licence will impose conditions including:
              BS 5839-6 Grade A LD1 fire alarm system (typical); fire-resisting doors to bedrooms /
              kitchen; protected escape route; emergency lighting; periodic FRA. The conditions are
            ...
            <li>
              <strong>Fire alarm category — typically Grade A LD1.</strong> Reflects the higher-risk
              nature: multiple unrelated occupants, sleeping at different times, varying fire safety
              culture, often inadequate compartmentation. Grade A allows full BS 5839-1 architecture
              (panel + addressable detection + cable monitoring + logbook) within the dwelling.
            </li>
            <li>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">Course landing</div>
          </button>
        </div>
