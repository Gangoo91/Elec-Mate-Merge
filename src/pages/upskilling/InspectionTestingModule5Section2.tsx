...
const DESCRIPTION =
  'Learn Zs measurement techniques including live testing, two-wire method, and interpretation of results.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Zs must be measured live because it includes Ze (external impedance), which requires connection to the supply.',
  },
  {
    id: 'rcd-trip-reason',
    ...
    correctIndex: 0,
    explanation:
      'Zs testing deliberately creates earth leakage current. RCDs are designed to detect this imbalance and may trip.',
  },
  {
    id: 'temp-correction',
    ...
    correctIndex: 2,
    explanation:
      'Multiply R1+R2 by 1.2 to account for increased resistance at maximum operating temperature.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'The tester creates a momentary controlled fault, measures voltage drop and current, then calculates impedance.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Standard Zs test connects between line and earth (CPC), testing the actual fault path through the protective conductor.',
  },
  {
    id: 4,
    question: 'Why might RCDs trip during Zs testing?',
    ...
    correctAnswer: 0,
    explanation:
      'Zs testing creates deliberate earth leakage. Sensitive RCDs may detect this imbalance and trip.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      "2-wire testing avoids earth leakage by testing L-N. Useful when sensitive RCDs keep tripping, though it doesn't test the CPC.",
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation:
      'Multiply R1+R2 by 1.2 to account for conductor resistance increase at maximum operating temperature.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'Exceeding maximum Zs means the protective device may not operate quickly enough. Investigate and fix before energising.',
  },
  {
    id: 8,
    question: 'Maximum Zs values are found in:',
    options: [
      'BS 7671 Chapter 41 tables',
      'The cable manufacturer data',
      'The meter manual',
      'Chapter 52',
    ],
    correctAnswer: 0,
    explanation:
      'BS 7671 Chapter 41 provides maximum Zs tables for various protective devices and disconnection times.',
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      "Direct measurement gives actual impedance at test temperature. It's already a 'worst case' compared to calculated values at operating temp.",
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Zs testing is live testing. Ensure the supply is on, circuit is accessible, and you have appropriate safety measures in place.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'The test measures actual impedance including the external supply (Ze), which is only present when connected to the live supply. Dead testing only measures R1+R2 - you need Ze to calculate total Zs.',
  },
  {
    question: 'How does the tester work?',
    answer:
      "The tester creates a brief, controlled fault current (typically for a few milliseconds) between line and earth. It measures the voltage drop and current, then calculates impedance using Ohm's law (Z=V/I).",
  },
  {
    question: 'Will testing trip the RCD?',
    answer:
      "Modern testers use a 'no-trip' technique that balances the test current to avoid tripping RCDs. However, very sensitive RCDs may still trip. Some testers have a specific 'no-trip' or '2-wire' mode.",
  },
  {
    question: "What's the 2-wire method?",
    answer:
      "Test between line and neutral instead of line-earth. This measures Zs via the neutral rather than CPC. Useful where RCDs trip during standard testing, but doesn't verify the CPC path.",
  },
  {
    question: 'When do I apply temperature correction?',
    answer:
      "When verifying Zs by calculation (Ze + R1+R2), multiply R1+R2 by 1.2 to account for conductor heating under fault conditions. Direct Zs measurement doesn't need correction - it's already at ambient.",
  },
  {
    question: 'What if measured Zs exceeds the maximum?',
    answer:
      'The circuit fails. Investigate: check connections are tight, verify correct cable size is installed, consider shorter cable run, or use a larger CPC. Re-test after any remedial work.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Live Test:</strong> Zs is measured with circuit energised
              </li>
              <li>
                <strong>Method:</strong> Tester creates brief controlled fault
              </li>
              <li>
                <strong>Compare:</strong> Results must not exceed BS 7671 max values
              </li>
              <li>
                <strong>RCDs:</strong> May trip - use no-trip mode
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Standard:</strong> Line to Earth (L-E)
              </li>
              <li>
                <strong>Alternative:</strong> Line to Neutral (L-N) 2-wire
              </li>
              <li>
                <strong>Location:</strong> Furthest point of circuit
              </li>
              <li>
                <strong>Correction:</strong> x1.2 for calculations
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A Zs tester creates a momentary, controlled fault current and measures the resulting
              impedance:
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p>
              The 1.2 multiplier accounts for conductor resistance increase when operating at
              maximum temperature (70 degrees C for thermoplastic).
            </p>
