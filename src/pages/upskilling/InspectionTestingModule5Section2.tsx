...
const InspectionTestingModule5Section2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 5 · Section 2" title="Zs testing methods" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          High-current loop test vs the low-current no-trip method. What the meter is doing
          internally, why one trips RCDs and the other doesn't, and when the regulation requires an
          alternative method altogether.
        </p>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              Measure the open-circuit (no-load) voltage Uo across L and PE at the test point. This
              is the &ldquo;before&rdquo; reference.
            </li>
            <li>
            ...
            <li>
              ...
              voltage sags by an amount that depends on the impedance of everything between the test
              point and the source — i.e. Zs.
            </li>
            <li>
            ...
            <li>
              Solve for Zs: <strong>Zs = (Uo − Uloaded) / Itest</strong>. The voltage sag divided by
              the test current equals the loop impedance.
            </li>
            <li>
              Disconnect the internal load. Total test duration: a few mains cycles for the
              high-current method (~10–40 ms); several hundred milliseconds to a few seconds for the
              no-trip method.
            </li>
          </ol>
          <p>
            That is the entire physics of the test. The two methods (high-current and no-trip)
            differ only in (a) the size of the internal load — and therefore the size of Itest — and
            (b) how the meter filters out mains noise and load fluctuations to extract the real Zs
            from a noisy signal.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              method. The instrument shall be capable of measuring the relevant loop paths (line to
              earth via the protective conductor and source). The measured earth fault loop
              ...
              instrument may be adversely affected by power converting equipment, such as inverters.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              A test current of 20–25 A is roughly 700× the IΔn of a 30 mA RCD. The device sees the
              test current as a massive earth fault and trips, almost certainly within milliseconds.
            </li>
            <li>
              Even a 100 mA or 300 mA upstream S-type RCD will see 20–25 A as far above its IΔn and
              will trip on its time-delay curve.
            </li>
          </ul>
          <p>
            ...
            defeats the safety system and is rarely justified) or (c) the meter explicitly supports
            a non-tripping high-resolution mode validated by the manufacturer for that circuit
            configuration.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              The internal test load is much higher impedance than for the high-current method. Test
              currents are typically 15 mA peak instantaneously or below — well under the 30 mA IΔn
              of a Type AC / Type A / Type F RCD.
            </li>
            <li>
              Many modern testers use specific test waveforms (e.g. half-cycle pulses with an
              averaging algorithm, or DC-shaped pulses for Type B RCDs) so the residual current seen
              by the RCD is below trip threshold even momentarily.
            </li>
            <li>
              Test duration is longer (a few seconds rather than a fraction of one) because the
              small voltage drop has to be averaged over many cycles to reject mains noise and load
              fluctuations from other appliances on the same supply.
            </li>
          </ul>
          <p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="225" y="40" textAnchor="middle" fill="#EF4444" fontSize="11" fontWeight="bold">
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="655" y="40" textAnchor="middle" fill="#22C55E" fontSize="11" fontWeight="bold">
            ...
            <text x="200" y="130" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              ⚠ TRIPS
            </text>
            ...
            <text x="630" y="130" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              ✓ holds
            </text>
            ...
            <text x="440" y="421" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              terminal and PE on the E terminal. A reversed polarity at a socket-outlet will give a
              wrong (often very low) reading.
            </li>
            <li>
            ...
            <li>
              <strong>Connect the meter at the test point.</strong> For a socket-outlet, plug in the
              dedicated socket lead. For a fixed-wired test point (FCU, isolator, lighting
            ...
            <li>
              <strong>Read Zs.</strong> Note the value to at least two decimal places in ohms. Some
              meters also display Ipf (prospective fault current) which is Uo / Zs at the
            ...
            <li>
              ...
              the relevant device, or the design max-Zs from the Schedule of Circuit Details (which
              uses the A4 max-permitted-Zs column). Apply temperature correction if the cable is
              well below operating temperature when measured.
            </li>
            <li>
              <strong>Move on.</strong> Repeat for every test point on the schedule — typically the
              worst-case (furthest) point of every final circuit, plus distribution circuit tests at
              the relevant boards.
            </li>
          </ol>
        </ConceptBlock>
          ...
          whatToDo={
            <>
              <span className="block">
                1. Continuity already verified (Module 3) — R1+R2 measured 0.36 Ω, within &plusmn;5%
                of calculation.
              </span>
              ...
              <span className="block">
                5. Reading: <strong>0.58 Ω</strong> — measured cold, so a little below the predicted
                70&deg;C value. Cable is well below operating temperature; the reading is consistent
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              measured Zs against 0.8 × the Table 41.3 value. If the measured cold Zs is below that,
              the corrected hot Zs will also be below the table value. This is widely used in
              industry and is conservative.
            </li>
            <li>
              <strong>Modern multifunction tester:</strong> select the cable type and temperature in
              the meter setup; the tester applies the correction automatically and displays a
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Reg 643.7.3 NOTE 1:</strong> &ldquo;The validity of test readings taken with a
              fault loop impedance test instrument may be adversely affected by power converting
              equipment, such as inverters.&rdquo; This is the warning.
            </li>
            <li>
              <strong>Reg 826.7 (prosumer chapter, A4:2026):</strong> &ldquo;Where validity of test
              readings taken with a fault loop impedance test instrument may be adversely affected
              by power converting equipment within the prosumer&rsquo;s installation, an alternative
              method of determining prospective fault current and earth fault loop impedance shall
              be used.&rdquo; This is the obligation.
            </li>
          </ul>
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              before live testing. With the prosumer equipment off, a normal loop test should give a
              clean reading.
            </li>
            <li>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Zs column:</strong> measured Zs at the worst-case point, in ohms, two decimal
              places. State whether the value is the live measurement or a calculated Zs (Ze + R1+R2
            ...
            <li>
              ...
              the limit is the 70&deg;C value, note &ldquo;measured at &lt;temp&gt;&deg;C, corrected
              via Appendix 3&rdquo; or &ldquo;measured cold, &lt; 0.8 × Table 41 limit&rdquo;.
            </li>
          </ul>
        </ConceptBlock>
