    ...
    <div className="min-h-screen overflow-x-hidden bg-[#1a1a1a]">
      ...
      <div className="max-w-3xl mx-auto px-4 py-6 sm:py-8 space-y-8 pb-24">
        ...
        <div className="flex flex-col sm:flex-row gap-4 pt-8 border-t border-white/10">
          <Link to="/study-centre/upskilling/pat-testing-module-4-section-1" className="flex-1">
          ...
          <Link to="/study-centre/upskilling/pat-testing-module-4-section-3" className="flex-1">
