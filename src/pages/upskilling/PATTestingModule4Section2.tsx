    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          500 V DC stress-tests the insulation between live parts and earth. The 1 MΩ acceptance,
          the Class I vs Class II routing, and the substitute-leakage rule that saves switch-mode
          equipment from a false fail.
        </p>
        ...
        >
          <p>
            ...
            the protective conductor where one is provided). The test voltage is selected to stress
            the insulation at well above its operating voltage but without damaging it on a healthy
            appliance. 500 V DC is the standard for 230 V mains equipment — twice nominal
          ...
          <p>
            ...
            installation: insulation resistance between live conductors, and between live conductors
            and earth, verified at the same 500 V DC and judged against the 1 MΩ minimum per
            circuit. PAT extends that principle to the appliance side. Different acceptance per
            appliance class, same principle, same instrument category.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The insulation resistance shall be measured by applying a DC test voltage between the
              line and neutral conductors connected together and the earth pin (Class I) or an
              accessible conductive part of the body (Class II). The test voltage shall be 500 V DC
              for equipment rated up to 500 V AC. The insulation resistance shall not be less than 1
              MΩ.
            </>
          }
        ...
        >
          <p>
            For Class I, the test is geometrically simple: L and N are linked inside the PAT tester
            (most testers do this automatically when IR is selected), and the test voltage is
            applied between that combined live and the earth pin of the plug. The instrument
          ...
          <p>
            ...
            appliance. For a hairdryer with a metal grille, that is the grille. For a fully-enclosed
            plastic appliance with no exposed metal, the IET CoP method is to wrap a metal foil
            around a representative part of the casing and probe the foil with the IR test lead. The
            point is to apply the test voltage across the insulation barrier between live parts and
            any surface a user could touch.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            connects to a patient (an ECG, a defibrillator, a dialysis machine) cannot tolerate the
            same level of leakage as a desk lamp; a single insulation defect can put fault voltage
            onto a patient-connected lead. The CoP raises the floor because the consequence floor is
            also raised.
          </p>
          <p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="150" y="85" textAnchor="middle" fill="#FBBF24" fontSize="12" fontWeight="bold">
              PAT TESTER
            </text>
            ...
            <text x="150" y="259" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              E terminal (Class I)
            </text>
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              Confirm earth continuity has passed first. IR is the second test in the sequence — if
              earth continuity has failed, do not run IR.
            </li>
            <li>
              Identify the construction class from the rating plate. Class I: routes to L+N → E pin.
              Class II: routes to L+N → probe on accessible metal.
            </li>
            <li>
              Confirm the appliance is switched on / in the correct operating state. For most
              appliances this means switched on at the appliance switch (so that all internal wiring
              is in the test path); for thermostatic kit, switched to the highest setting.
            </li>
            <li>
            ...
            <li>
              Class I: no probe needed — the tester applies 500 V DC between the linked L+N and the
              earth pin and reads the resistance. Class II: connect the IR probe / foil to an
            ...
            <li>
              Record the numeric reading in MΩ. A pass with 14 MΩ is recorded as such; a pass at 999
              MΩ (saturation) is also valid. Fails go to investigation, not retest.
            </li>
          </ol>
        </ConceptBlock>
          ...
          whatToDo={
            <>
              ...
              <span className="block">
                ...
                substitute test applies a low test voltage across L+N to E and measures the leakage
                current at the operating-equivalent voltage. Acceptance is ≤ 0.5 mA for Class I
                appliances.
              </span>
              <span className="block">
        ...
        <RegsCallout
          ...
          clause={
            <>
              The instrument shall be capable of measuring insulation resistance with a no-load test
              voltage of 500 V DC, and shall apply the test voltage with a measurement current
              capability of at least 1 mA. The instrument shall include automatic discharge of the
              equipment under test on completion of the measurement.
            </>
          }
        ...
        >
          <p>
            ...
            operator because the test voltage is low. And it gives a meaningful result on equipment
            whose IR reading is misleading — the leakage current at operating voltage is what
            actually matters for user safety, not the resistance at an artificial 500 V DC.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Where the equipment under test contains components which would result in a misleading
              insulation resistance measurement (for example, switch-mode power supplies, EMC filter
              networks, surge protective devices), substitute leakage testing may be performed in
              lieu of insulation resistance testing. The acceptable substitute leakage current shall
              not exceed 0.5 mA for Class I equipment and 0.25 mA for Class II equipment.
            </>
          }
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong className="text-emerald-300">Saturation (e.g. &gt; 999 MΩ).</strong> Healthy,
              dry, well-insulated appliance. Pass. Record the reading or &ldquo;&gt;999 MΩ&rdquo;
              per the tester display.
            </li>
            <li>
              <strong className="text-emerald-300">Tens to hundreds of MΩ.</strong> Typical healthy
              reading. Comfortably above the 1 MΩ minimum. Pass. Record the numeric value.
            </li>
            <li>
              <strong className="text-amber-300">Low single-digit MΩ (1–5 MΩ).</strong> Pass but
              marginal. Possible causes: minor surface contamination at terminations, slight damp in
              the insulation, ageing of motor windings. Flag for closer inspection at the next test
              cycle. Re-test in dry conditions to confirm.
            </li>
            <li>
