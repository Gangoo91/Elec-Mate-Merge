    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The no-trip Zs method, why a high-current loop test trips the RCD on every attempt, and
          the regulation that makes you measure Zs anyway. Reg 643.7.3, Reg 411.5.3 and Table 41.5.
        </p>
        ...
        >
          <p>
            The traditional loop test method, used on circuits without RCDs, briefly creates a real
            (small) line-to-earth fault and measures the resulting voltage drop / current flow at
            the supply to infer the loop impedance. The injected current is in the order of 10–25 A
            for a few mains cycles — small enough not to harm the installation, large enough to give
            a clean reading on a low-impedance loop.
          </p>
          <p>
            On an RCD-protected circuit that approach fails. A 30 mA RCD operates when the residual
            current (vector sum of currents in line + neutral) exceeds 30 mA for long enough to
            operate the trip. A 25 A line-to-earth pulse is approximately 833 × IΔn — the RCD will
            operate within tens of milliseconds, well inside the test cycle window. The meter sees
            the supply disappear and reports an error.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              suitable test equipment according to BS EN 61557-6 to confirm that the relevant
              requirements of Chapter 41 are met, taking into account the operating characteristic
              of the device.
            </>
          }
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              limited by the RCD's operating characteristic so that the pulse's contribution to the
              integrated residual current never reaches IΔn for the I²t profile of the RCD.
            </li>
            <li>
              <strong>Repeated pulses, signal averaging:</strong> a single sub-IΔn pulse produces a
              voltage drop too small to read accurately. The meter pulses several times and
            ...
            <li>
              <strong>Extrapolation to Zs:</strong> from Ohm's law, Z = ΔU / Δi. The meter knows the
              test current it injected, measures the resulting voltage drop, and computes Z. That Z,
              multiplied through the U₀ / Z relationship, gives the prospective fault current at
              IΔn, which the meter back-converts to a Zs reading in ohms.
            </li>
          </ol>
          <p>
            The trade-off is accuracy. BS EN 61557-3 (loop impedance) and BS EN 61557-6 (RCDs)
            permit a wider accuracy band on no-trip than high-current — typically ±15 % to ±20 % vs
            ±5 %. That tolerance comes from the small-signal extrapolation: a real high-current test
            pushes a clean fault and reads it directly; a no-trip test infers from a much smaller
            signal and extrapolates. The reading is fit for purpose for compliance against the Table
            41.3 / 41.5 limits, but borderline readings demand repetition.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="400" y="42" textAnchor="middle" fill="#EF4444" fontSize="12" fontWeight="bold">
            ...
            <text x="500" y="178" textAnchor="start" fill="#EF4444" fontSize="10" fontWeight="bold">
              Cannot give Zs
            </text>
            ...
            <text x="610" y="360" textAnchor="middle" fill="white" fontSize="11" fontWeight="bold">
              Zs = 1.21 Ω
            </text>
        ...
        >
          ...
          <p>
            ...
            workable on TT installations where electrode-only earth pushes Zs into hundreds of ohms.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              the RCD. The requirements of this regulation are met if the earth fault loop impedance
              of the circuit protected by the RCD meets the requirements of Table 41.5.
            </>
          }
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              <span className="block">67.4 Ω &lt;&lt; 1667 Ω → compliant against Table 41.5.</span>
              <span className="block">
                Cross-check Ra × IΔn ≤ 50 V: Ra ≈ 65 Ω (electrode); 65 × 0.030 = 1.95 V →
                comfortably below 50 V. Both compliance routes pass.
              </span>
              <span className="block">
                Earth electrode is well below the 200 Ω stability limit (Table 41.5 NOTE 2). Record
                the electrode reading on the EIC origin schedule, record Zs at the furthest socket
                (67.4 Ω), record the RCD trip time at IΔn from the trip-time test (per Reg 643.8 /
                643.7.3, BS EN 61557-6, &lt;300 ms acceptance for non-delay).
              </span>
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              limit. A trip time approaching 300 ms is a flag that the RCD is drifting and should be
              investigated.
            </li>
            <li>
          ...
          <p>
            Both trip-time results go on the schedule of test results, alongside the Zs reading from
            the no-trip method. The pair is the audit trail that demonstrates Reg 643.7.3 has been
            satisfied — Zs verified, and operating characteristic verified.
          </p>
        </ConceptBlock>
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              supplementary bonding route shorting the CPC. Useful, but not the value to use in the
              Zs sum without investigating.
            </li>
            <li>
              <strong className="text-red-300">Open / very high reading on a TN system.</strong>{' '}
              Broken CPC, missing termination, or a wandering test probe. Fail. Stop and investigate
              before the trip-time test — running the trip-time test on a circuit with a broken CPC
        ...
        <Scenario
          ...
          whatToDo={
            <>
              <span className="block">
                Step 1: Confirm the meter is in no-trip mode (not high-current). The error is almost
                always a misset.
              </span>
              <span className="block">
                Step 2: If the meter is correctly set, the upstream 100 mA RCD is operating at well
                below 30 mA — that is sensitivity drift. The S-type characteristic should give a
                deliberate delay; if it is tripping on a sub-30 mA pulse it has lost selectivity.
              </span>
              <span className="block">
                Step 3: Conduct a trip-time test on the 100 mA upstream RCD at its IΔn (100 mA) and
                at half-IΔn (50 mA — should not trip). Record both.
              </span>
              <span className="block">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Zs column:</strong> the no-trip reading in ohms, two decimals. The same column
              used for any other Zs measurement. The schedule is silent on which method was used —
              the inspector knows from context (RCD presence) that the no-trip method is implied.
            </li>
            <li>
              <strong>RCD trip-time columns:</strong> at IΔn (the &lsquo;1×&rsquo; column) and at 5
              × IΔn for additional protection (the &lsquo;5×&rsquo; column). Times in milliseconds,
              whole numbers. Dashes for sections that do not apply (e.g. 5× column on a circuit
              where the RCD is not providing additional protection).
            </li>
            <li>
              <strong>Comments column:</strong> the fault-protection device when it differs from the
              obvious. On a TT installation, &lsquo;Reg 411.5.3 fault protection by RCD; Table 41.5
              applied&rsquo;. On a TN-C-S socket circuit, no comment is needed — Table 41.3 governs
              by default. Where the Table 41.5 NOTE 2 stability concern applies (electrode
