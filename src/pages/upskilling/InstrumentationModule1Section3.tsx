...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'A closed-loop system uses feedback from the output to adjust the input, creating automatic control that responds to changes in conditions.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Even in automated systems, indication provides essential operator awareness, enables troubleshooting, supports system monitoring, and ensures safety oversight.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Control action is a separate function from indication. Indication presents data through visual, audible, or digital means, while control takes action based on that data.',
  },
  {
    id: 8,
  ...
  },
  {
    id: 10,
    question:
      'Which key measurement characteristic describes how close a measurement is to the true value?',
    options: ['Precision', 'Resolution', 'Accuracy', 'Range'],
    correctAnswer: 2,
    explanation:
      'Accuracy describes how close a measured value is to the true value. Precision refers to repeatability, resolution is the smallest detectable change, and range is the measurement span.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Yes, modern smart instruments often combine these functions. A smart temperature transmitter, for example, can measure temperature, display the value locally, and send control signals to other equipment.',
  },
  {
    question: 'Why do we still need local indication when systems are automated?',
    answer:
      "Local indication provides operators with immediate visual feedback for safety verification, troubleshooting, and manual override situations. It's essential when network or SCADA systems fail.",
  },
  {
    question: "What's the difference between a sensor and a final control element?",
    answer:
      'A sensor is an input device that measures physical quantities, while a final control element is an output device (like a valve or motor) that acts on the process based on control signals.',
  },
  {
    question: 'How does PID control work?',
    answer:
      'PID (Proportional-Integral-Derivative) control calculates the error between the setpoint and measured value, then adjusts the output using three terms: proportional response, accumulated error correction, and rate of change prediction.',
  },
  {
    question: 'When would you use open-loop control instead of closed-loop?',
    answer:
      "Open-loop control is suitable for simple, predictable processes like timer-based systems, batch sequences, or start-up procedures where feedback isn't necessary or available.",
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Measurement:</strong> Capturing and quantifying physical data
              </li>
              <li>
                <strong>Indication:</strong> Displaying or signalling measured values
              </li>
              <li>
                <strong>Control:</strong> Taking automated action based on measurements
              </li>
              <li>
                <strong>Integration:</strong> All three work together in control loops
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Sensors measure, displays indicate, controllers act
              </li>
              <li>
                <strong>Use:</strong> Design systems with appropriate functions for each need
              </li>
              <li>
                <strong>Apply:</strong> Troubleshoot by tracing measurement to control flow
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              <strong>Measurement</strong> is the process of determining the magnitude of a physical
              quantity. It involves sensing the variable, converting it to a usable signal, and
              ensuring the data is accurate and reliable for further processing or decision-making.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>1. Sensing:</strong> Detect physical change in the environment
                </li>
                <li>
                  <strong>2. Conversion:</strong> Transform to electrical signal
                </li>
                <li>
                  <strong>3. Processing:</strong> Condition and scale signal
                </li>
                <li>
                  <strong>4. Output:</strong> Provide usable data for systems
                </li>
              </ul>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Temperature:</strong> Thermocouple measures heat and produces mV signal
                  </li>
                  <li>
                    <strong>Pressure:</strong> Strain gauge sensor converts pressure to resistance
                    change
                  </li>
                  <li>
                    <strong>Flow:</strong> Electromagnetic meter measures liquid velocity
                  </li>
                  <li>
                    <strong>Level:</strong> Ultrasonic sensor measures distance to liquid surface
                  </li>
                  <li>
                    <strong>Vibration:</strong> Accelerometer detects mechanical oscillations
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li>
                    <strong>Precision:</strong> Repeatability of measurements
                  </li>
                  <li>
                    <strong>Resolution:</strong> Smallest detectable change
                  </li>
                  <li>
                    <strong>Range:</strong> Minimum to maximum measurable values
                  </li>
                  <li>
                    <strong>Response Time:</strong> Speed of measurement update
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              <strong>Indication</strong> presents measurement data in a form that operators,
              maintenance personnel, or automated systems can interpret and act upon. It bridges the
              gap between raw measurement data and human understanding or system communication.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              <strong>Control</strong> uses measurement data to make decisions and take automated
              actions to maintain desired system conditions. Control functions ensure processes
              operate within safe, efficient, and optimal parameters without constant human
              intervention.
            </p>
            ...
            <div className="my-6">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-white mb-2">
                    Control action based on feedback from output
                  </p>
                  <ul className="text-sm text-white space-y-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A control loop demonstrates how measurement, indication, and control work together in
              a continuous cycle to maintain desired process conditions. Understanding this
              integration is fundamental to instrumentation system design and operation.
            </p>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Real-World Scenario: Boiler System Pressure Control
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Measurement:</strong> Pressure sensor continuously measures boiler
                  pressure (0-10 bar range) with ±0.1 bar accuracy
                </li>
                <li>
                  <strong>Indication:</strong> Local pressure gauge shows 6.5 bar, control panel
                  displays digital reading, SCADA logs trends
                </li>
                <li>
                  <strong>Control:</strong> When pressure exceeds 8 bar limit, controller
                  automatically shuts down heater and opens relief valve
                </li>
                <li>
                  <strong>Result:</strong> Safe operation through coordinated measurement, clear
                  indication, and automatic protection
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                ...
                <li>
                  Check each function independently: sensor reading, display accuracy, control
                  response
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Confusing functions</strong> — sensors measure, indicators display,
                  controllers act
                </li>
                <li>
                  <strong>Ignoring indication</strong> — local displays are vital for
                  troubleshooting and safety
                </li>
                <li>
                  <strong>Bypassing feedback</strong> — closed-loop systems need proper feedback to
                  function
                </li>
                <li>
                  <strong>Wrong control type</strong> — using open-loop where closed-loop is needed
                </li>
              </ul>
            </div>
          </div>
