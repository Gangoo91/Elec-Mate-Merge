    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS EN 61140 defines four classes of equipment by their protective architecture against
          electric shock. The class IS the protection. Every PAT test method derives from class —
          get class wrong and the test is mis-aimed.
        </p>
        ...
        >
          ...
          <p>
            Each row is a complete, internally-consistent protective architecture. Class I uses the
            protective conductor; Class II uses the insulation itself; Class III uses the voltage
            level. The PAT test methods follow directly from these architectures: test the CPC
            integrity for Class I, test the insulation for Class II, verify the supply for Class
            III.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              The plug arrangement of Class 0 — typically a 2-pin plug with no earth provision — is
              incompatible with UK socket-outlets that have shutters operated by the earth pin (BS
              1363).
            </li>
          </ul>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>CPC connection at the supply</strong> — typically the earth pin of the BS 1363
              plug, connected via the green-and-yellow conductor of the flex to the equipment\'s
              internal earth point.
            </li>
            <li>
              <strong>Earth bonding of all exposed-conductive-parts</strong> — metal casings, metal
              handles, metal trim, any conductive part the user can touch.
            </li>
            <li>
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>PE-continuity test</strong> — measure resistance from earth pin of the plug to
              any accessible conductive part. Acceptance per IET CoP §15.4 / Table 15.1, typically
              &le; 0.1 Ω + 1 mΩ/m of flex. The test verifies the CPC is intact and low-resistance —
              the prerequisite for Class I protection to work.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              accessible conductive part of the equipment shall be measured. The maximum permissible
              value is 0.1 Ω plus the resistance of the flexible cable from the plug to the
              equipment.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              may have a "functional earth" for filtering / noise (typical in IT and AV) but this is
              not a protective conductor.
            </li>
            <li>
              <strong>Double or reinforced insulation</strong> — two independent layers OR a single
              engineered layer giving the equivalent protection.
            </li>
            <li>
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              Applying one is meaningless. (Some PAT instruments offer a "Class II touch current" or
              similar — that is a different test, not a CPC test.)
            </li>
            <li>
              <strong>Insulation resistance</strong> — 500 V dc between live conductors and ANY
              ACCESSIBLE CONDUCTIVE PART (the test probe is held against the casing, the handle, or
              the conductive parts of the equipment itself, not against an earth pin). Acceptance
              &ge; 2 MΩ for Class II per IET CoP §15.5.
            </li>
            <li>
              <strong>Touch current / substitute leakage</strong> — alternative or supplementary
              tests for Class II equipment, especially where the construction makes IR difficult to
              apply (e.g. unusual casing materials).
            </li>
            <li>
          ...
          <p>
            Class II is common for hand-held tools (drills, sanders, hair driers), small appliances
            (toasters, coffee makers), and IT power supplies (laptop bricks, USB chargers). The fail
            mode is insulation breakdown — typically through moisture ingress, mechanical damage, or
            thermal stress. The IR test is the primary instrument-side defence.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              For Class II equipment, the insulation resistance shall be measured between live parts
              and any accessible conductive part of the equipment, with the test probe applied to
              the conductive part. The minimum acceptable value is 2 MΩ.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Separation from earth and from higher voltages</strong> — the SELV circuit is
              electrically isolated from the mains side and from earth, so a single fault cannot
              bring mains voltage onto SELV conductors.
            </li>
            <li>
            ...
            <li>
              <strong>No CPC and no double insulation</strong> on the SELV side — the voltage level
              is the protection.
            </li>
          </ul>
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>NO IR test, NO PE-continuity test</strong> on the SELV equipment itself in the
              conventional sense. The supply is the protection.
            </li>
          </ol>
          <p>
            Class III appliances include door entry equipment, low-voltage lighting (12 V halogen,
            garden lighting), telecoms equipment, and battery-operated equipment. The "PAT" question
            for Class III is largely a question about the supply unit and the separation between
            SELV and mains — not a question about the SELV equipment itself.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            The matrix is the operational reason class identification is the foundation. Each column
            is a complete protective architecture; each row is a verification step. Picking the
            right verification step for the architecture is the inspector\'s job.
          </p>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            ...
            {
              question: 'How do I tell if equipment without a class symbol is Class I or Class II?',
              answer:
