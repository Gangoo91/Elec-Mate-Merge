...
const quizQuestions = [
  ...
  {
    id: 8,
    question: 'The next major revision of BS 7671 after A4:2026 will be:',
    options: [
...
const faqs = [
  ...
  {
    question: 'What is the realistic timeline for the 19th Edition of BS 7671?',
    answer:
...
export default function RenewableEnergyModule1Section1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 1 · BS 7671:2018+A4:2026"
        title="Why renewables now — UK grid, policy & the installer market"
        backTo="../renewable-energy-module-1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The structural forces driving the LCT installer market, the regulatory direction of travel
          under A4:2026, and the strategic decisions that follow for the qualified electrician
          entering renewables.
        </p>
        ...
        >
          <p>
            The Climate Change Act 2008, as amended in 2019, imposes a statutory duty on the
            Secretary of State to ensure that net UK carbon emissions in 2050 are at least 100%
            lower than the 1990 baseline.
          </p>
          <p>
            The five-year statutory carbon budgets (sections 4–10 of the Act) give the duty
            short-term bite. The duty cannot be quietly deferred into the 2040s — it has to be
            visibly on-track each five-year period.
          </p>
          ...
          <p>
            These are policy, not statute. They set the funding gates and the Building Regulations
            changes that drive individual customers to pick up the phone.
          </p>
          <p>
            The duty is durable. Judicial review of climate policy on the basis of the Act has been
            used successfully — the 2022 ClientEarth case forced redrafting of the Net Zero Strategy
            on adequacy grounds. A future government would need primary legislation to weaken the
            duty: politically expensive, procedurally slow.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The Heat Pump Investment Plan targets 600,000 heat pump installations per year by 2028.
            Actual run-rate in 2023–2024 sat at roughly 60,000 per year — a 10× gap.
          </p>
          ...
          <p>
            Where demand is policy-anchored and supply is constrained, price holds. A qualified MCS
            MIS 3003 installer charging the going rate for a heat pump install in 2026 is not in a
            price war — they are in a queue.
          </p>
        </ConceptBlock>

        <Pullquote>
          The installer market is supply-constrained — that's the pricing power.
        </Pullquote>
        ...
        >
          <p>
            The British Energy Security Strategy targets 70 GW of total UK solar capacity by 2035,
            from a baseline of roughly 15 GW in 2023. The political framing is "five times more
            solar".
          </p>
          <p>The operational decomposition is more nuanced. The 70 GW splits across:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Utility-scale ground-mount</strong> — the largest
              single contributor in strategy modelling. Does NOT flow through the domestic MCS PV
              installer network.
            </li>
            <li>
              <strong className="text-white">Large commercial rooftop</strong> — the middle slice.
              Some MCS overlap; mostly commercial PV specialists.
            </li>
            <li>
              <strong className="text-white">Domestic rooftop</strong> — the third slice. The MCS PV
              installer\'s addressable market. Smaller than the headline implies, and growing more
              slowly than the strategy total.
            </li>
          </ul>
          <p>
            The other headline targets need similar disaggregation. Heat pumps: ASHP vs GSHP vs
            hybrid; like-for-like swaps vs whole-system retrofit. EV chargepoints: domestic vs
            workplace vs public DC fast.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 551.7.1 was redrafted in A4 and gained two new indents that change the design
            conversation on every grid-tied LCT install.
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Indent (c)</strong> — a suitable protective device
              shall be provided where energy flow is bidirectional. Engages every grid-tied PV
              inverter, BESS, and V2G charger.
            </li>
            <li>
              <strong className="text-white">Indent (d)</strong> — prohibits connecting a source to
              the load side of an RCD under certain conditions.
            </li>
          </ul>
          <p>
            Together they are the regulatory acknowledgement that the design assumption of
            unidirectional flow no longer matches the operational reality.
          </p>
          <p>
            The cert is the audit trail. The cost of the change is design time on each install; the
            benefit is that the next inspector can read the design intent rather than infer it.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The "reasonably practicable" qualifier in Reg 722.411.4.1 had drifted over the A2:2022
            and A3:2024 period from a genuine practicability test into a routine cost-defence.
          </p>
          <p>
            Many domestic EV chargepoint installs on PME supplies omitted recognised PEN-fault
            protective measures and cited the exception. Through 2022–2024 the incident record built
            — open-PEN faults at the chargepoint location, exposed conductive-part voltage on the
            vehicle chassis, several fatality and serious- injury cases on commercial workplace
            installs.
          </p>
          <p>
            A4 closed the exception. The deeper point is the pattern of revision: BS 7671 is
            increasingly responsive to incident data rather than academic engineering opinion. The
            committee is willing to make the tightening change when the evidence base supports it,
            on a four-year amendment cadence.
          </p>
          <p>
            For the installer tracking the regulatory direction: where you can see the incident
            stream forming, you can anticipate the revision. BESS thermal-runaway incidents are
            featuring in HSE and London Fire Brigade reporting through 2024–2026 — the 19th Edition
            is widely expected to tighten BESS siting, ventilation and isolation requirements.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Chapter 81 is the new energy-efficiency chapter introduced in A4:2026 in place of the
            deleted Appendix 17, and is explicitly framed as the precursor to a new Part 8 of BS
            7671 in a future amendment.
          </p>
          ...
          <p>
            Some of those design decisions become recordable on the appropriate Part 6 certification
            — extending the A4 traceability trajectory from Reg 133.1.3 into the energy-efficiency
            domain.
          </p>
          <p>
            Part 8 already exists in A4, holding Chapter 81 (energy efficiency) and Chapter 82
            (prosumer&apos;s LV installations). Energy-efficiency design becomes the same
            architectural tier as the existing Parts. The LCT designer of 2027 onwards needs Part
            L-aware loss thinking alongside protection coordination.
          </p>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Chapter 82 — the prosumer installation framework (new in A4)
        </ContentEyebrow>
        ...
        >
          <p>
            Chapter 82 is the new Prosumer\'s Electrical Installations chapter in A4:2026. The
            scope: low-voltage installations that include local production and / or storage of
            energy, designated as PEIs and required to comply with Chapter 82 where applicable.
          </p>
          ...
          <p>
            For the hybrid LCT installer, Chapter 82 makes the system-level design discipline a
            regulatory requirement rather than a best-practice option. The chapter sits alongside
            the per-technology chapters and adds requirements for the interactions: load management,
            export coordination, multi-source fault current contribution, multi-source protection
            coordination.
          </p>
          <p>
            Section 722 itself was updated in A4 with an explicit reference to prosumer
            installations — making the EV-chargepoint design conversation cross-chapter on any
            property with local generation. Reg 826.1.4 (within the existing battery storage
            section) addresses transient overvoltages in PEIs and the consideration of surge
            protective devices.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            MCS is voluntary under statute — there is no Act of Parliament that requires an MCS
            certificate. The customer can lawfully pay cash for a non-MCS PV or heat pump install.
          </p>
          <p>What MCS gates is access to the funded market:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Smart Export Guarantee (SEG)</strong> — under the
              Electricity (Smart Export Guarantee) Regulations 2019. Requires an MCS-certified
              installer cert.
            </li>
            <li>
              <strong className="text-white">Boiler Upgrade Scheme (BUS)</strong> — currently £7,500
              per ASHP / GSHP. MCS-gated on installer (MIS 3003) and product (MCS Product List).
            </li>
            <li>
              <strong className="text-white">ECO4 / GBIS</strong> — retrofit funding for eligible
              households via obligated suppliers. Requires MCS on heat pump and PV measures.
            </li>
          </ul>
          <p>
            The structural effect is market segmentation. The funded market — where the customer is
            grant-supported or tariff-supported — is structurally less price-competitive than the
            cash market. The MCS installer is insulated from undercut competition from non-MCS
            entrants in the funded segment.
          </p>
          <p>
            That framing changes the cost-benefit on MIS training. The training overhead is not
            "competence we need to do the work safely" — it is "the price of admission to the
            segment where margin holds".
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The narrative that the heat pump rollout is constrained by installer numbers is correct
            but incomplete. The rollout is also constrained by the upstream electrical
            infrastructure that the heat pump connects to.
          </p>
          ...
          <p>
            The DNO queue in capacity-bound regions of GB now exceeds 12 months for substantial
            connection or upgrade work — central London, parts of Greater Manchester, parts of the
            South East. These are routine constraints on LCT projects in 2026 onwards, not edge
            cases.
          </p>
          <p>
            The strategic implication: the LCT contractor who treats the DNO precheck as a standing
            survey item quotes more honestly, wins more durable contracts, and avoids the most
            expensive failure mode in LCT contracting — the deposit refund after a DNO timeline
            emerges late in the project.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The 18th Edition of BS 7671 was published in 2018. It received four amendments:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              A4 (2026) — Chapter 57 stationary batteries, Appendix 17 energy efficiency, the LCT
              tightening
            </li>
          </ul>
          <p>
            A4 closes the amendment cycle. The next major revision is a new edition. By convention
            it will be the 19th Edition.
          </p>
          <p>
            The 19th Edition is currently in the IET / BSI joint committee. Public consultation is
            expected during 2027–2028, with publication targeted for 2028–2029 and implementation
            transition through 2029–2030. The 18th Edition with A4 amendments remains in force
            across the transition.
          </p>
          <p>The expected direction of the 19th Edition is consolidation:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              The LCT chapters (Section 551, 712, 715, 722, 730, 753, Chapter 57, Appendix 17)
              pulled into a clearer Part 7 LCT framework
            </li>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-1-section-2')}
