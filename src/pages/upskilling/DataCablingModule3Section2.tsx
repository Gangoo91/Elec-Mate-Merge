...
const DataCablingModule3Section2 = () => {
  useSEO({
    title: "Connector Types and Polish Grades | Data Cabling Module 3.2",
    description: "Learn fibre optic connector types (LC, SC, ST), polish grades (PC, UPC, APC), and professional termination techniques."
  });
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/upskilling/data-cabling-module-3-section-1">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous Section
            </Link>
          </Button>
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/upskilling/data-cabling-module-3-section-3">
              Next Section
