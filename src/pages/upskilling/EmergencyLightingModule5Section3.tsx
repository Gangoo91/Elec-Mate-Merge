...
const inlineChecks = [
  {
    id: 'elm5-s3-cadence',
    question:
      'What is the BS EN 50172:2024 / BS 5266-1:2025 testing cadence for an emergency lighting installation?',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'Which set best describes the periodic test cadences for emergency lighting under BS EN 50172 / BS 5266-1?',
    options: [
  ...
  },
  {
    id: 2,
    question:
      'Why is the five-yearly photometric (lux) verification of the escape route important?',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'A monthly functional test due in March is not carried out until 5 April. How should this be treated?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'For a self-contained luminaire installation with no central battery panel, how is the daily check duty satisfied?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'A photometric survey finds two escape-route points reading 0.6 lx and 0.7 lx, where the design was 1.5 lx and the BS EN 1838 minimum is 1 lx. What is the correct response?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The four-cadence periodic regime that BS EN 50172:2024 and BS 5266-1:2025 require: daily
          indicator check on central battery panels, monthly functional test on every luminaire,
          annual full 3-hour duration test, and the five-yearly photometric survey that the 2025
          update made explicit. Cadences, tolerances, scheduling, and how the cycles overlap to
          catch every category of failure.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Daily — visual indicator check.</strong> Central battery panel "system
              healthy" green LED, or self-test addressable controller summary status. Catches: panel
              faults, charge faults, supply faults, comms faults flagged in real time. Duty of the
              on-site responsible person; takes seconds per panel.
            </li>
            <li>
              <strong>Monthly — functional test.</strong> Brief mains-fail simulation, every
              luminaire observed, fault flags reviewed. Catches: failed luminaires (battery, lamp,
              electronics), miswiring, self-test fault flags, fault flags raised since last test.
              Maintenance contractor (or self-test automation).
            </li>
            <li>
              <strong>Annual — full duration test.</strong> Full discharge for rated duration (3 h
              typical), every luminaire observed at end of test, recovery to ≥ 80% within 24 h
              confirmed. Catches: gradual battery capacity decay, charger problems, undersized
              batteries (rare), insulation degradation increasing self-discharge. Maintenance
              contractor (or self-test automation).
            </li>
            <li>
              <strong>Five-yearly — photometric verification (NEW 2025).</strong> Calibrated lux
              meter on defined escape route, point-by-point at design grid, comparison to design /
              baseline / BS EN 1838 minima. Catches: LED output depreciation, optic fogging,
              environmental changes (new partitions, new finishes), luminaire substitutions that
              changed performance. Competent person with calibrated meter.
            </li>
          </ul>
          <p>
            The cadences are layered. A failure that happens this week is caught at the next monthly
            test — within four weeks. A failure that develops over a year is caught at the next
            annual test — within twelve months. A failure that develops over years is caught at the
            next five-yearly survey. The system never has more than the relevant cadence period of
            unverified status.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Inspection and testing of the emergency lighting installation shall be carried out at
              the following intervals: a daily indicator check on central battery panels where
              provided; monthly functional testing of each luminaire; annual full duration testing
              of the rated emergency operating time; and at intervals not exceeding five years,
              photometric verification by point-by-point measurement on the defined escape route.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              Records of all periodic tests shall be maintained including the date of each test, the
              result, any defects identified, and corrective actions taken. The records shall be
              kept available for inspection by the responsible person and by the appropriate
              authorities. Test intervals shall be kept consistent — monthly tests within the
              calendar month and annual tests within the twelve-month anniversary.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="40" y="106" fill="#22C55E" fontSize="12" fontWeight="bold">
              DAILY
            </text>
            <text x="40" y="124" fill="rgba(255,255,255,0.7)" fontSize="10">
              Visual indicator check
            </text>
            <text x="40" y="138" fill="rgba(255,255,255,0.55)" fontSize="9">
              central battery panel · system healthy LED
            </text>
            <text x="40" y="152" fill="rgba(255,255,255,0.55)" fontSize="9">
              duty of on-site responsible person
            </text>
            {/* Daily ticks across */}
            {Array.from({ length: 30 }).map((_, i) => (
              <circle key={i} cx={300 + i * 16} cy={120} r="2.5" fill="#22C55E" />
            ))}
            <text x="555" y="140" fill="rgba(34,197,94,0.7)" fontSize="9">
              ~ daily tick
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="40" y="196" fill="#22D3EE" fontSize="12" fontWeight="bold">
              MONTHLY
            </text>
            <text x="40" y="214" fill="rgba(255,255,255,0.7)" fontSize="10">
              Functional test (every luminaire)
            </text>
            <text x="40" y="228" fill="rgba(255,255,255,0.55)" fontSize="9">
              5-15 min mains-fail simulation
            </text>
            <text x="40" y="242" fill="rgba(255,255,255,0.55)" fontSize="9">
              tolerance: within calendar month
            </text>
            {/* Monthly markers */}
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="40" y="286" fill="#A855F7" fontSize="12" fontWeight="bold">
              ANNUAL
            </text>
            <text x="40" y="304" fill="rgba(255,255,255,0.7)" fontSize="10">
              Full duration test (typically 3 h)
            </text>
            <text x="40" y="318" fill="rgba(255,255,255,0.55)" fontSize="9">
              recovery ≥ 80% within 24 h · BS EN 50171/50172
            </text>
            <text x="40" y="332" fill="rgba(255,255,255,0.55)" fontSize="9">
              tolerance: 12-month anniversary
            </text>
            {/* Annual markers */}
            {[1, 2, 3, 4, 5].map((y, i) => (
              <g key={i}>
                ...
                <text x={374 + i * 80} y={314} textAnchor="middle" fill="#A855F7" fontSize="8">
                  3-h dur.
                </text>
              </g>
            ))}
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="40" y="376" fill="#EF4444" fontSize="12" fontWeight="bold">
              FIVE-YEARLY
            </text>
            <text x="40" y="394" fill="rgba(251,191,36,0.95)" fontSize="10" fontWeight="bold">
              ⚠ NEW emphasis BS 5266-1:2025
            </text>
            <text x="40" y="410" fill="rgba(255,255,255,0.7)" fontSize="10">
              Photometric verification
            </text>
            <text x="40" y="424" fill="rgba(255,255,255,0.55)" fontSize="9">
              point-by-point lux on defined escape route
            </text>
            <text x="40" y="438" fill="rgba(255,255,255,0.55)" fontSize="9">
              vs design · vs baseline · vs BS EN 1838 minima
            </text>
            {/* Five-year marker */}
            <g>
              <rect
              ...
              <text x="720" y={410} textAnchor="middle" fill="#EF4444" fontSize="9">
                photometric
              </text>
              <text x="720" y={422} textAnchor="middle" fill="#EF4444" fontSize="9">
                survey
              </text>
            </g>
            ...
            <text x="40" y="478" fill="rgba(255,255,255,0.55)" fontSize="9">
              ...
              catches step-change panel faults ·{' '}
              <tspan fill="#22D3EE" fontWeight="bold">
                Monthly
              </tspan>{' '}
              catches step-change luminaire failures
            </text>
            <text x="40" y="494" fill="rgba(255,255,255,0.55)" fontSize="9">
              <tspan fill="#A855F7" fontWeight="bold">
                Annual
              </tspan>{' '}
              catches gradual battery capacity decay ·{' '}
              <tspan fill="#EF4444" fontWeight="bold">
                Five-yearly
              </tspan>{' '}
              catches gradual lux output decay
            </text>
            <text x="40" y="510" fill="rgba(255,255,255,0.55)" fontSize="9">
              Each cadence has a different mesh size — skipping any leaves that category of failure
              undetected
            </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Identify the panel.</strong> Central battery panel location is documented; the
              responsible person knows where it is. Typically in a fire-rated battery room or plant
              area.
            </li>
            <li>
              <strong>Observe the indicators.</strong> Green "system healthy" LED illuminated. Any
              amber/red fault LED, audible alarm, or unusual indication is a flag.
            </li>
            <li>
              <strong>Record the check.</strong> A daily check book (paper) or electronic log entry.
              Date, initials, observation (typically just "Healthy" if all green).
            </li>
            <li>
              <strong>If a fault is flagged.</strong> Note the specific indication (which LED, any
              text on the panel display). Call the maintenance contractor with the description. Do
              NOT silence alarms or reset faults without competent advice.
            </li>
            <li>
              <strong>Frequency.</strong> Daily means each business day for offices; each opening
              day for retail; each shift change for 24-h operations. The intent is that no fault
              persists more than approximately one day before being noticed.
            </li>
          </ul>
          <p>
            For self-contained installations (no central battery panel), the equivalent is a
            self-test addressable controller display where one is provided. Where neither is
            provided, the daily-check duty does not apply in the same form — the monthly cadence
            becomes the primary check, supplemented by user reporting of any fault-flagged
            luminaires.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Fix the week.</strong> First Monday of the month is a common choice —
              predictable, visible in the contract calendar, easy to plan around. Alternatives (last
              Friday, mid-month) work equally — pick one and stick to it.
            </li>
            <li>
              <strong>Self-test automation.</strong> Self-test luminaires can be programmed to test
              on a fixed schedule (e.g. test on the 5th of each month, all luminaires staggered
              through the day). The automation enforces the cadence; the human review is monthly.
            </li>
            <li>
              <strong>Tolerance.</strong> Within the calendar month for which the test is due. A
              test that slips from late March to early April is a non-conformance — the March
              cadence has been missed and the April cadence is being moved up to compensate, which
              compresses the next interval.
            </li>
            <li>
              <strong>Documentation of slippage.</strong> Where a test must slip outside the month
              (genuine site access denied, unforeseen circumstances), document in the logbook the
              reason, the corrective action, and the prevention of recurrence. Repeated slippage is
              a contract issue.
            </li>
            <li>
              <strong>Coordination with other safety system tests.</strong> Where the contractor
              maintains both fire alarm (BS 5839-1:2025 user / weekly tests) and emergency lighting,
              the monthly cadences can be aligned for site visit efficiency. Avoid scheduling on the
              same day as a fire drill (which itself stresses systems).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Anchor month.</strong> Pick a month that suits the building (for offices,
              August is sometimes good — low occupancy through holidays; for retail, the
              post-Christmas quiet period; for hospitality, low season). Stick to it year on year.
            </li>
            <li>
              <strong>Anchor week / day.</strong> Within the anchor month, pick a week that aligns
              with low occupancy. The contract calendar carries the date.
            </li>
            <li>
              <strong>Tolerance.</strong> Within the anniversary month is the working tolerance.
              Slipping by more than one month is a non-conformance against schedule consistency.
            </li>
            <li>
              <strong>Coordination with photometric (in five-year years).</strong> Every fifth year,
              the photometric survey is also due. Schedule it to fall in the same week as the
              duration test — same site visit, single planning event, single documentation update.
            </li>
            <li>
              <strong>Coordination with EICR.</strong> The BS 7671 EICR for commercial fixed wiring
              is typically 5-yearly. Aligning EICR with the five-year photometric is a useful
              efficiency — same competent person, same visit, single comprehensive documentation
              update.
            </li>
          </ul>
          <p>
            The annual cadence is the cadence on which the system's substantive verification
            depends. Slippage compounds; a year of slip is a year of unverified capacity. Keep the
            schedule.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Calibrated meter.</strong> Lux meter calibrated within the past 12 months
              (calibration certificate copied into the survey report). Photopic correction;
              cosine-corrected sensor head. Without calibration, readings are not legally
              defensible.
            </li>
            <li>
              <strong>System in emergency mode.</strong> Mains off; system on battery; allow 10-15
              minutes for stable output before measuring.
            </li>
            <li>
              <strong>Design grid.</strong> Use the design measurement grid (typically points across
              the non-excluded width of the escape route at 1-2 m intervals along its length, per BS
              EN 1838:2024; door thresholds; junctions; stair head/foot). Use the same grid as the
              commissioning survey for direct comparison.
            </li>
            <li>
              <strong>Measurement plane.</strong> Per design — typically 0.2 m above floor for
              spatial illumination on escape routes. Use the same plane as commissioning.
            </li>
            <li>
              <strong>Three comparisons per reading.</strong> Compare each measured value to (a) the
              design value, (b) the commissioning baseline, (c) the BS EN 1838 minimum. Each
              comparison tells a different story.
            </li>
            <li>
              <strong>Below BS EN 1838 minimum.</strong> Non-compliance. Investigate, remediate,
              re-survey.
            </li>
            <li>
              <strong>Above minimum but below design and below baseline.</strong> Drift. The system
              is still legally compliant but the trajectory is concerning. Document, schedule
              investigation (likely lamp/luminaire change at next cycle).
            </li>
            <li>
              <strong>Above minimum but above baseline.</strong> Unusual — could indicate room
              finish change (e.g. lighter wall paint reflecting more light) or instrumentation
              difference. Investigate the cause; document.
            </li>
            <li>
              <strong>Output report.</strong> Tabulated readings against the design grid; comparison
              columns against design, baseline, BS EN 1838; observations; remediation plan if
              needed; competent person signature.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Photometric verification shall be carried out at commissioning and at intervals not
              exceeding five years thereafter, by point-by-point measurement on the defined escape
              route using a calibrated photometer. The results shall be compared with the original
              commissioning measurements and with the design illuminance values, and with the
              minimum illuminances specified in BS EN 1838. Any non-compliance shall trigger
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Daily — controller display.</strong> Where a central addressable controller is
              provided, the daily check focal point is the controller display rather than (or in
              addition to) the central battery panel. Same idea — green = healthy, anything else =
              investigate.
            </li>
            <li>
              <strong>Monthly — automated functional test.</strong> Every luminaire tests itself;
              the controller logs results; the competent person reviews the controller log monthly.
              The review confirms (a) every luminaire tested on schedule, (b) every luminaire
              passed, (c) any failures have follow-up actions logged.
            </li>
            <li>
              <strong>Annual — automated full duration test.</strong> Every luminaire (or central
              battery, where applicable) runs the full duration; the controller logs results. The
              competent person reviews the controller log and verifies recovery.
            </li>
            <li>
              <strong>Five-yearly — STILL human-led.</strong> The luminaire cannot measure delivered
              lux at the floor. The photometric survey is human-led with a calibrated lux meter;
              self-test does not replace it.
            </li>
            <li>
              <strong>Visual inspection — STILL human-led.</strong> The luminaire cannot see the
              room around it. Damaged signage, obstructions, label legibility, environmental
              concerns — all need human eyes.
            </li>
            <li>
              <strong>BS 7671 verification — STILL human-led.</strong> The luminaire is not testing
              the wiring. Insulation, continuity, polarity, Zs are on the BS 7671 cycle and need a
              competent electrical inspector with appropriate instruments.
            </li>
          </ul>
          <p>
            Self-test is a multiplier on competent oversight, not a replacement. The competent
            person reviews the automated log and signs the BS 5266-1 logbook entry; the review is
            the ratification.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>EICR cadence.</strong> Typically 5-yearly for commercial fixed wiring (or per
              the previous EICR's recommended next inspection date — sometimes 3-yearly for
              higher-risk premises). The EICR competent person determines the next interval.
            </li>
            <li>
              <strong>Five-year photometric coordination.</strong> Schedule the photometric survey
              to align with the EICR five-year visit where possible. Same competent person, same
              visit, single comprehensive documentation update.
            </li>
            <li>
              <strong>Annual duration coordination.</strong> The annual duration test does not align
              with the EICR cycle (which is 5-yearly), but it sits within the maintenance contract
              calendar. The contractor schedule typically covers monthly functional, annual
              duration, five-year photometric, and the EICR (in five-year years) as a single
              contract.
            </li>
            <li>
              <strong>Cross-references in documentation.</strong> The BS 5266-1 logbook should
              record the most recent EICR date, certificate reference, and recommended next
              inspection. The EICR records the emergency lighting circuits as part of its scope and
              references the BS 5266-1 logbook for the periodic test results.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Daily indicator checks</strong> — approximately 1,250 entries over five years
              (250 business days per year × 5). Each is brief but the cumulative record demonstrates
              continuous oversight.
            </li>
            <li>
              <strong>Monthly functional tests</strong> — 60 entries over five years. Each is a
              per-luminaire or per-circuit observation. Pattern of results over time tells the story
              of the installation's condition.
            </li>
            <li>
              <strong>Annual duration tests</strong> — 5 entries over five years. Each is a
              substantial event with rated-duration verification, recovery confirmation, fault
              investigation. The pattern catches end-of-life battery cohorts and informs planned
              replacement.
            </li>
            <li>
              <strong>Five-yearly photometric</strong> — 1 entry per cycle. Survey report with
              three-way comparison; trajectory of lux output across the cycle is the key insight.
            </li>
            <li>
              <strong>EICR</strong> — typically 1 per cycle (5-yearly for commercial), aligned with
              the photometric where possible.
            </li>
          </ul>
          <p>
            The aggregated evidence is what insurers, fire authorities, and tribunals will examine
            if anything goes wrong. A clean run of records, contemporaneously kept, signed by
            competent persons, is the practical demonstration that the responsible person has
            discharged their RRO 2005 duties. Gaps in the record, retroactive entries, or missing
            cadences expose the responsible person and the contracting chain.
          </p>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            {
              question:
                'Does the daily check apply to a small self-contained installation in a small office?',
              answer:
            ...
            {
              question:
                'Can the monthly test be carried out by the responsible person rather than the maintenance contractor?',
              answer:
            ...
            {
              question:
                'What is the relationship between BS 5266-1:2025 and the previous edition for periodic testing?',
              answer:
            ...
            {
              question:
                'How does the photometric survey handle a building with multiple escape routes?',
              answer:
            ...
            {
              question:
                'Can a single contractor cover daily checks across multiple buildings on an estate?',
              answer:
            ...
            {
              question:
                'What happens if a five-year photometric reveals widespread sub-minimum readings?',
              answer:
            ...
            {
              question:
                'Does the EICR cycle replace the BS 5266-1 logbook entries for the BS 7671 verification?',
              answer:
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Daily.</strong> Building manager checks the controller display each morning.
              Green = healthy, anything else = call contractor. Recorded in the daily check book
              (paper) or the building management electronic system.
            </li>
            <li>
              <strong>Monthly.</strong> First Thursday of each month, contractor visits for 2-3
              hours. Reviews the controller log for the previous month's automated functional tests;
              investigates any flagged faults; replaces any failed batteries on site (carrying
              spares); updates the BS 5266-1 logbook with the visit summary; signs.
            </li>
            <li>
              <strong>Annual (October each year).</strong> Last Saturday of October, contractor
              visits for the duration test. Initiated 18:00, runs to 21:00; observers at start,
              mid-test, end. Recovery monitored to 24 h post-test through Sunday. Logbook updated
              with the duration test entry and recovery confirmation.
            </li>
            <li>
              <strong>Five-yearly (October of year 5, 10, 15...).</strong> Coordinated with the
              annual visit. Photometric survey carried out on the Saturday afternoon (system in
              emergency mode after the duration test, calibrated meter, design grid). Survey report
              delivered within 2 weeks. EICR also scheduled for the same calendar quarter — separate
              visit but coordinated documentation update.
            </li>
            <li>
              <strong>Reactive.</strong> Any fault flagged by the responsible person's daily check
              (or by an occupant's report) triggers an unscheduled visit. Documented as a reactive
              entry in the logbook with the fault, attendance time, corrective action, verification.
            </li>
          </ul>
          <p>
            Total contractor visits per year: 12 monthly + 1 annual (or combined annual/photometric
            in five-year years) + reactive as needed. Total contractor on-site hours per year:
            approximately 30-50 hours for routine cadences. The calendar is predictable, the costs
            are budgetable, and the compliance evidence trail builds continuously.
          </p>
        </ConceptBlock>
        ...
        <Quiz
          title="Monthly and annual testing requirements — Module 5.3"
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() =>
              navigate('/electrician/upskilling/emergency-lighting-module-5-section-4')
            }
