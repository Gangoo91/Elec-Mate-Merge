...
const DESCRIPTION =
  'Learn how to conduct structured customer witness testing, provide training, and complete formal handover procedures for fire alarm systems.';
    ...
    () => [
      {
        ...
        correctAnswer: 1,
        explanation:
          'Use agreed test scripts mapped to the cause and effect matrix for structured, comprehensive witnessing.',
      },
      {
        id: 2,
        ...
        correctAnswer: 1,
        explanation:
          'Coordinate with stakeholders responsible for interfaced systems to safely test all interfaces.',
      },
      {
        id: 3,
        ...
        correctAnswer: 1,
        explanation:
          'Formal sign-off requires signed documentation including witness sheets and certificates.',
      },
      {
        id: 4,
        ...
        correctAnswer: 1,
        explanation:
          'Show system operation across all modes to the Responsible Person for comprehensive understanding.',
      },
      {
        id: 5,
        ...
        correctAnswer: 1,
        explanation:
          'Maintain clear training evidence including attendance, scope and trainer details for handover.',
      },
      {
        id: 6,
        ...
        correctAnswer: 1,
        explanation:
          'Provide full documentation including O&M manuals and panel configuration backup.',
      },
      {
        id: 7,
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          'Accurate timestamps and logs support traceability and demonstrate proper commissioning.',
      },
      {
        id: 10,
        ...
        correctAnswer: 1,
        explanation:
          'Formal acceptance is by the Responsible Person or their appointed representative.',
      },
    ],
    []
  );
      ...
      <div className="px-4 sm:px-6 py-6 max-w-4xl mx-auto space-y-8">
        ...
        <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <ul className="space-y-2 text-white text-sm">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong className="text-white">Scripted witness tests</strong> mapped to cause and
                effect matrix with stakeholder attendance
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Training delivery</strong> with documented attendance
                and scope covered
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Formal sign-off</strong> by Responsible Person with
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    ...
                    Hold readiness review to confirm documentation complete
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Verify drawings, C&E matrix and test records up to date
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Agree test scenarios and sequence with Responsible Person
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Plan isolations and confirm stakeholder attendance
                  </li>
                </ul>
              </div>
            ...
            <div className="space-y-4 text-white">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <p className="text-sm font-semibold text-white mb-3">
                  Demonstrate All System States:
                </p>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    <strong className="text-white">Normal:</strong> System healthy, no faults or
                    alarms
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    <strong className="text-white">Fault:</strong> Device removal, cable fault
                    simulation
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    <strong className="text-white">Disablement:</strong> Zone and device disablement
                    procedures
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    <strong className="text-white">Test:</strong> Weekly test procedures and walk
                    test mode
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    <strong className="text-white">Alarm:</strong> Full alarm activation and
                    response
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10 mt-4">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Verify panel date and time settings are correct
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Capture photographs of key tests and outputs
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Record results on signed witness sheets
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-4 text-white">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    ARC and monitoring routes paused or notified
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Fire wardens briefed and in position
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Interface isolations authorised (HVAC, lifts, doors)
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
                <p className="text-sm text-orange-300 flex items-start gap-2">
                  ...
                  Agree contingency plans and communication protocols before commencing witness
                  tests.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4 text-white">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    CIE controls: silence, reset, disablements and acknowledge
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Weekly test procedures and documentation
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Reading event logs and acknowledging faults
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Basic troubleshooting and fault indicators
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Escalation routes and maintenance contacts
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10 mt-4">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                has been demonstrated and accepted by the client.
              </p>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Signed witness sheets with test results
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Completion and commissioning certificates
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    O&M manuals issued and acknowledged
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Panel configuration backup provided
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
                <p className="text-sm text-orange-300 flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 mt-0.5 flex-shrink-0" />
                  Final sign-off should be by the Responsible Person or their formally appointed
                  representative.
                </p>
              </div>
            </div>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                outstanding items are tracked to completion.
              </p>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <p className="text-sm font-semibold text-white mb-3">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Severity classification for prioritisation
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Close-out evidence and sign-off
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10 mt-4">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Maintenance contact details and response times
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    First maintenance visit scheduling
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    ARC monitoring arrangements confirmed
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Fire drill integration documented
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
            ...
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-sm text-white">
                ...
                Critical safety items must be resolved before acceptance.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/30">
              ...
              <ul className="space-y-2 text-sm text-white">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  Assess training effectiveness with a brief knowledge check or practical
                  demonstration
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              {
                q: 'Can we conduct witness testing during normal working hours?',
                a: 'Yes, with appropriate permits, notices and safety controls. Building occupants should be notified and fire wardens briefed. Some tests may need to be scheduled out of hours.',
              },
              {
                q: 'Who should sign the acceptance certificate?',
                a: 'The Responsible Person under fire safety legislation or their formally appointed representative. Ensure they have authority to accept on behalf of the organisation.',
              },
              {
                q: 'What evidence is required for witness testing?',
                a: 'Signed test scripts, event logs with correct timestamps, photographs of key tests, and signed witness sheets confirming satisfactory demonstration.',
              },
              {
                q: 'How do we handle failed tests during witnessing?',
                a: 'Document the failure, investigate the cause, implement corrective action and retest. Only accept sign-off when all tests pass satisfactorily.',
              },
              {
                q: 'Should we include refresher training arrangements?',
                a: 'Yes, agree a plan for refresher training with the client, particularly for new staff. Document recommended intervals and contact arrangements.',
              },
              {
                q: 'What if the Responsible Person cannot attend witness testing?',
                a: 'They may appoint a competent representative with authority to sign off. Document this delegation clearly and ensure the representative understands their responsibilities.',
              },
            ].map((faq, i) => (
