...
const FireAlarmModule5Section6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 5 · Section 6" title="Handover and documentation" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The end-of-project sign-off: acceptance certificate, operating and O&M manuals,
          as-installed drawings, cause-and-effect (NEW 2025 mandatory), logbook (Annex H 2025),
          third-party certification, ALL variations recorded (NEW 2025), and the responsible
          person's duties under the Regulatory Reform Order 2005.
        </p>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Acceptance certificate (Annex G).</strong> The commissioning sign-off. System
              parameters (category, zones, devices, autonomy), commissioning verifications,
              variations recorded. Issued by commissioning engineer; signed by user.
            </li>
            <li>
              <strong>Operating manual.</strong> The day-to-day operation guide for the user. How to
              silence an alarm, how to reset, how to put the system on test, how to respond to a
              fault indication. Written for non-technical readers — the building manager or the
              receptionist who answers the panel at 02:00.
            </li>
            <li>
              <strong>O&M manual.</strong> Operation and maintenance — written for the service
              organisation. Technical data, panel programming, device addresses, service intervals,
              spare parts, manufacturer data sheets. Used at every service visit.
            </li>
            <li>
            ...
            <li>
              <strong>Logbook (Annex H 2025).</strong> Records system events (alarms, faults, tests,
              service visits), variations (NEW 2025: ALL variations), and other system-relevant
              items. Held by user; updated by service organisation at every visit.
            </li>
            <li>
          ...
          <p>
            The set is sometimes physically delivered as a binder, sometimes electronically (PDF set
            on a USB stick or via a project portal), commonly both. The commissioning organisation
            retains a copy; the user retains the original; the service organisation references the
            user copy at each service visit.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="2"
            />
            <text x="410" y="74" textAnchor="middle" fill="#FBBF24" fontSize="12" fontWeight="bold">
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              recommendation that a cause-and-effect matrix or text description of how the cause and
              effect operates is included with the documentation to be provided to the purchaser or
              user of the system. This could be as simple as &quot;this system operates as a
              simultaneous evacuation&quot; or a cause-and-effect matrix document might be required
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Particularly install / commissioning stage.</strong> Variations agreed during
              install or commissioning — typically because the as-built deviates from the design —
              are explicitly called out for justification. The design-stage variations are usually
              documented; install / commissioning variations were the ones that often went
              unrecorded under 2017.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              premises with more than one zone on any storey, particularly premises in which people
              sleep, MUST have a zone plan (or other suitable diagrammatic representation). The plan
              is the FRS / building-occupant tool for locating an alarm activation. Absence makes
              locating an active fire dangerously slow when seconds matter.
            </li>
            <li>
              ...
              facility for transmission of fire alarm signals to an ARC is mandatory. Both premises
              types have particularly vulnerable occupants who depend on ARC-summoned FRS attendance
              for life safety. The 2025 revision makes the ARC non-negotiable in these specific
              premises.
            </li>
            <li>
              <strong>Why these specifically.</strong> Both reflect specific incident history and
              the FRS / regulatory environment. The 2025 revision is the first edition of BS 5839-1
              to declare any variation unacceptable; the choice of these two specific departures,
              out of all possible variations, reflects the proportionality of the safety case.
            </li>
            <li>
              <strong>Effect on installations.</strong> A new system in scope cannot be signed off
              if either unacceptable variation is present. An existing system needs to be considered
              against these — 2025 wording is generally not retrospective, so an existing system
              with one of these omissions can continue, but the next major works (extension,
              modification) need to remedy the omission.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              recommended in 22.2.5) in premises in which there is more than one zone on any storey,
              particularly premises in which people sleep; or
              <br />
              <br />
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              identified, action taken, outcome). Every fault (date, time, cause, action, outcome).
              Every test event (occupant tests, weekly tests where carried out, ARC tests). The
              logbook is the primary record of system behaviour.
            </li>
            <li>
              <strong>Service visits.</strong> Every service visit (date, engineer name,
              organisation, third-party scheme membership, findings, actions, next-visit-due date).
              The service visit record shows the system has been maintained per clause 43.2.1
              (~6-monthly with ±1 month tolerance).
            </li>
            <li>
              <strong>Variations.</strong> NEW 2025: ALL variations recorded (was &quot;major
              variations only&quot; in 2017). Variations agreed in service-life — typically because
              of building changes or system modifications — recorded with justification.
            </li>
            <li>
              <strong>Modifications.</strong> Per the new Section 7 of the 2025 standard (Extensions
              and modifications, NEW for 2025), every modification is recorded. Includes CIE
              firmware updates (NEW 2025 clarification — firmware update is a modification requiring
              a certificate).
            </li>
            <li>
        ...
        <ContentEyebrow>The responsible person and the Regulatory Reform Order 2005</ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              applies. The fire alarm system design follows the FRA — the FRA identifies risks, the
              system controls them.
            </li>
            <li>
              <strong>Fire detection and warning system maintenance.</strong> The fire detection and
              fire alarm system is appropriate to the risk and maintained in efficient working
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              person, including the requirement to carry out a fire risk assessment, ensure the fire
              detection and fire alarm system is appropriate and maintained, ensure persons on the
              premises receive adequate fire safety information and training, maintain the system in
              efficient working order, and keep appropriate records. Failure to comply with these
              duties is a criminal offence.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              overall system may retain compliance with whichever edition it was originally designed
              to.
            </li>
            <li>
            ...
            <li>
              <strong>Extension or modification certificate.</strong> Certificate name updated from
              &quot;modification certificate&quot; (2017) to &quot;extension or modification
              certificate&quot; (2025). Records the work, the variations introduced, and any updates
              to the documentation set.
            </li>
            <li>
              <strong>Redundant equipment.</strong> Where a system has been modified and existing
              equipment is no longer in use, NEW 2025 wording — redundant devices should be REMOVED
              where practicable, OR clearly identified as no longer in use. Reduces the risk of
              confusion at future service or in an incident.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              extensions. This clarifies that when undertaking an extension to a system, whilst the
              new works undertaken should comply with the current version of the standard, it
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>NSI — National Security Inspectorate.</strong> Multi-discipline certification
              scheme covering fire detection, intruder, CCTV, access control. Audit-based,
              third-party certified. Tier system reflects the breadth of services offered.
            </li>
            <li>
            ...
            <li>
              <strong>UKAS-accredited certification bodies.</strong> The organisation that actually
              issues the certification (BSI, NSI, SSAIB, etc.) is itself accredited by UKAS — the
              United Kingdom Accreditation Service. UKAS accreditation gives trust in the
