...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      'Blocks all frequencies that fall below the cutoff',
      'Allows every frequency to pass through unchanged',
      'Passes frequencies below the cutoff and attenuates higher ones',
      'Amplifies low-frequency signals above the cutoff',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'When incoming signals are already too strong',
      'When handling weak signals from thermocouples or strain gauges',
      'To reduce the noise present on a signal',
      'To convert a current signal into a voltage',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'To protect equipment and improve integrity by breaking ground loops',
      'To increase the amplitude of a weak measurement signal',
      'To filter out high-frequency noise from the signal',
      'To convert analogue signals into a digital form',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    question: 'What does a low-pass filter do?',
    options: [
      'Blocks all frequencies that fall below the cutoff point',
      'Allows every frequency to pass through completely unchanged',
      'Amplifies only the low-frequency signals below the cutoff',
      'Passes frequencies below the cutoff and attenuates higher ones',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only when the incoming signals are already too strong',
      'When handling weak signals from thermocouples or strain gauges',
      'To reduce the noise present on a measurement signal',
      'To convert a current signal into a voltage signal',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Consistently lower cost than equivalent analogue methods',
      'Faster real-time response with no sampling delay',
      'Better accuracy, flexibility and software-based adjustment',
      'Simpler circuit design with fewer components',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Reduced power consumption in the loop',
      'Improved signal quality at the receiver',
      'Better overall system response time',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'They have the fastest response time',
      'They have the simplest circuit design',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Excessive amplification of the measurement signal',
      'High-frequency electrical noise on the supply',
      'Low input impedance at the amplifier stage',
