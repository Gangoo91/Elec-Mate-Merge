...
const DESCRIPTION =
  'Learn OLTS and OTDR testing procedures, reference methods, pass/fail thresholds, and certification requirements for fibre optic links.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 2,
    explanation:
      'The 3-jumper reference method includes test cords at both ends and best represents the patching configuration in service.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Short pulse widths improve near-end event resolution and reduce dead zones, making them ideal for short links.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Use the pre-calculated loss budget so OLTS thresholds are meaningful, auditable, and aligned with system requirements.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "OLTS (Optical Loss Test Set) measures total end-to-end insertion loss with high accuracy - it's the definitive pass/fail test. OTDR characterises events along the fibre, showing location and estimated loss of each component. Use both for comprehensive certification.",
  },
  {
    question: 'How do I choose between 1, 2, and 3-jumper reference methods?',
    answer:
      '1-jumper references out the test cord at one end only. 2-jumper references out both test cords. 3-jumper includes permanent link connectors in the measurement. Choose based on what you want to include/exclude from measurements per standard requirements.',
  },
  {
    question: 'What wavelengths should I test at?',
    answer:
      'For multimode: 850nm and 1300nm. For singlemode: 1310nm and 1550nm. Testing at multiple wavelengths reveals wavelength-dependent issues like bend losses that may affect certain applications.',
  },
  {
    question: 'How do I handle failed test results?',
    answer:
      'First clean and retest - dirt causes most failures. If still failing, use OTDR to locate the problem. Common causes are contaminated connectors, poor splices, tight bends, or crushed cable. Remediate and retest until pass.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'A fibre certification test shows the link passes OLTS but fails Tier 2 OTDR alien crosstalk requirements. What is the most likely action?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'OTDR can reveal issues not visible in end-to-end testing. Poor cable separation or routing near EMI sources can cause issues that require physical investigation and possible re-routing.',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white">OLTS and OTDR certification procedures</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>OLTS:</strong> End-to-end loss, definitive pass/fail
              </li>
              <li>
                <strong>OTDR:</strong> Event location and characterisation
              </li>
              <li>
                <strong>Tier 1 + 2:</strong> Complete certification requires both
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Reference method used noted in results
              </li>
              <li>
                <strong>Use:</strong> Set pass/fail from loss budget, not defaults
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              OLTS (Optical Loss Test Set) provides definitive end-to-end insertion loss
              measurements. This is the primary pass/fail test for fibre certification.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>1-Jumper:</strong> One test cord referenced out
                  </li>
                  <li>
                    <strong>2-Jumper:</strong> Both test cords referenced out
                  </li>
                  <li>
                    <strong>3-Jumper:</strong> Includes both patch connections
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Multimode:</strong> 850nm and 1300nm
                  </li>
                  <li>
                    <strong>Singlemode:</strong> 1310nm and 1550nm
                  </li>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Range:</strong> Slightly beyond known link length
                  </li>
                  <li>
                    <strong>Pulse width:</strong> Short for short links
                  </li>
                  <li>
                    <strong>Averaging:</strong> Balance noise vs time
                  </li>
                  <li>
                    <strong>IOR:</strong> Per cable manufacturer data
                  </li>
                </ul>
              </div>
              <div>
            ...
            <div className="grid grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent">
                ...
                <p className="text-white text-xs">OLTS pass/fail</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">Tier 2</p>
                <p className="text-white text-xs">OTDR + OLTS</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">Full Cert</p>
                <p className="text-white text-xs">Both required</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Link identification:</strong> Unique IDs, core numbers, routes
                </li>
                <li>
                  <strong>Test settings:</strong> Wavelengths, reference method, thresholds
                </li>
                <li>
                  <strong>Equipment:</strong> Model, serial, calibration date, firmware
                </li>
                <li>
                  <strong>Results:</strong> Pass/fail, measured values, bi-directional averages
                </li>
                <li>
                  <strong>Traces:</strong> Save .sor files and PDF exports
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Dirty connectors:</strong> — Number one cause of failures
                </li>
                <li>
                  <strong>Wrong reference:</strong> — Results don't reflect actual performance
                </li>
                <li>
                  <strong>Missing wavelengths:</strong> — Incomplete characterisation
                </li>
                <li>
                  <strong>Poor documentation:</strong> — Warranty and handover issues
                </li>
              </ul>
            </div>
          </div>
