    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The certification framework — Tier 1 OLTS for end-to-end insertion-loss certification,
          Tier 2 OTDR for per-event characterisation, reference Methods 1 / 2 / 3, encircled-flux
          multimode launch, bidirectional dual-wavelength testing, permanent link vs channel
          definitions, and the IEC 61300-3-35 endface-inspection records that round out the
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Calibrate / reference.</strong> Connect the calibration cords as specified by
              the reference method (1, 2 or 3 per IEC 61280-4-1 / -4-2). Set the meter to zero (set
              reference) at each wavelength.
            </li>
            <li>
              <strong>Insert the link.</strong> Disconnect from the reference configuration, insert
              the link to be tested between the launch and tail cords, reconnect.
            </li>
            <li>
            ...
            <li>
              ...
              re-reference, re-measure. The two readings should be similar; the certification value
              is typically the worst-case or the average per the project spec.
            </li>
            <li>
          ...
          <p>
            ...
            budget). This is what the client receives at handover and what the warranty manufacturer
            requires.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              Multimode tests shall be performed under encircled-flux launch conditions (built-in EF
              or mandrel-wrap equivalent). Tests shall be performed at the wavelengths appropriate
              to the cabling type and intended applications. The reference method, launch condition,
              instrument identification, calibration date and test results shall be recorded.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Over-filled launch (OFL).</strong> Legacy LED-based source that populates all
              modes, including high-order modes that quickly leak out. Pessimistic readings. Mostly
              obsolete for OLTS.
            </li>
            <li>
            ...
            <li>
              <strong>Mandrel-wrap.</strong> Field practice equivalent to EF — wrap the launch cord
              around a specified-diameter mandrel for a specified number of turns to strip
              high-order modes. Cheap, instrument-agnostic, gives EF-equivalent results.
            </li>
          </ul>
          <p>
            EF compliance applies to multimode only. Single-mode fibre supports only one propagation
            mode by construction, so there is no modal-launch ambiguity to resolve. The discipline
            for SM is bidirectional + dual-wavelength + reference method — modal-launch profile is
            not in scope.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              Per-event loss tabulated. End-to-end loss per direction. Used as the characterisation
              baseline for future fault-finding.
            </li>
            <li>
              <strong>IEC 61300-3-35 endface inspection records.</strong> Per connector. Pass / fail
              with image evidence per the standard\u2019s zone / defect criteria.
            </li>
            <li>
              <strong>As-built records.</strong> Per BS EN 50174-1 §6 / TIA-606-D. Cable labels,
              port identifiers, panel layouts, splice tray layouts, drawings, administration records
              — typically held in a cabling administration system.
            </li>
            <li>
              ...
              require manufacturer-trained-installer certification (e.g. CommScope SP, Panduit CIP).
            </li>
            <li>
          ...
          <p>
            ...
            cabling-system warranty against a Class EA / OM4 / OS2 specification is what the client
            buys when they accept a slightly more expensive structured-cabling tender. Missing
            documentation is the most common reason warranty claims fail — the install was correct,
            the cable performs, but the records are not there to prove it.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              warranty claim. The manufacturer rejects the claim because the commissioning evidence
              is incomplete. The cost of the channel re-pull falls on the client; the contractor is
              exposed if the original install is found wanting.
            </>
          }
          doInstead={
            <>
              Deliver the complete commissioning package at handover, every time: Tier 1 OLTS + Tier
              2 OTDR + IEC 61300-3-35 endface inspection + BS EN 50174-1 / TIA-606-D as-built
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              with appropriate launch / tail cords. Inspect every connector with a fibre microscope
              per IEC 61300-3-35; clean and re-inspect any failures; document pass / fail per
              connector with image evidence. Compile the as-built record per BS EN 50174-1 §6 /
              TIA-606-D — every fibre labelled, every port identified, every splice-tray layout
              drawn. Sign the conformance declaration. Provide the instrument calibration
              certificates. For the copper side, run the equivalent permanent-link Class EA tests
              per the appropriate standard. Compile everything into a single commissioning package
              and present at handover. Confirm the manufacturer warranty registration is filed.
            </>
          }
          whyItMatters={
            <>
