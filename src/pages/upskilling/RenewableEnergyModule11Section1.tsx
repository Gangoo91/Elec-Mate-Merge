...
const inlineChecks = [
  {
    ...
    question: 'What is Chapter 81 of BS 7671:2018+A4:2026, and why was it introduced?',
    options: [
  ...
  },
  {
    ...
    question: 'What does the inspector now record for a Chapter 81 compliant LCT install?',
    options: [
...
export default function RenewableEnergyModule11Section1() {
  ...
  useSEO({
    title:
      'A4:2026 Chapter 81 landscape — energy efficiency framework | Renewable Energy 11.1 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 11 · Section 1 · BS 7671:2018+A4:2026 · Chapter 81 + Part 8"
        title="A4:2026 Chapter 81 landscape — energy efficiency framework"
        backTo="../renewable-energy-module-11"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          What A4:2026 Chapter 81 introduced + why. Energy-efficiency chapter inside Part 8
          (Functional Requirements) — a signpost to the Building Regs + BS HD 60364-8-1:2019,
          sitting alongside Chapter 82 (PEI). Layered with Reg 525 voltage drop. New evidence
          records for LCT installs.
        </p>
        ...
        <Pullquote>
          A4:2026 widened the brief. BS 7671 used to be safety-only — Chapter 81 says: design for
          efficiency too. The wiring matters, not just the protection.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Cable cross-section</strong> — designer chooses CSA
              based on safety + correctness (Reg 433 / 434 / 523) AND efficiency (Chapter 81
              upsizing where I²R loss reduction payback supports). Records the rationale
            </li>
            <li>
              <strong className="text-white">Voltage drop</strong> — Reg 525 / Appendix 4 caps at 3%
              (lighting) / 5% (other) of nominal — this is the safety + correctness maximum. Chapter
              81 may drive design well below that cap (smaller voltage drop) when payback supports
            </li>
            <li>
              <strong className="text-white">Load-shifting design</strong>— tariff-aware circuits
              sized for off-peak operation (EV + heat pump + immersion diverter). Smart-meter export
              coordination, typically managed by the EEMS (Reg 825.1)
            </li>
            <li>
              <strong className="text-white">LCT integration</strong> — PV / BESS / wind / CHP +
              heat pump + EV sized + coordinated for efficient operation. Annual energy estimate per
              component
            </li>
            <li>
              <strong className="text-white">EEMS</strong> — the Electrical Energy Management System
              (defined at Reg 825.1) coordinates operation of the multi-source PEI. The efficiency
              design records integrate the EEMS configuration
            </li>
            <li>
              <strong className="text-white">Monitoring points</strong>— sub-meters / CT clamps /
              smart-meter export wired during install. Customer sees post-install verification of
              efficiency design
            </li>
            <li>
              <strong className="text-white">Payback model</strong> — designer\'s economic + carbon
              model that justifies the efficiency choices. Records the cost / energy / carbon
              assumptions
            </li>
            <li>
              <strong className="text-white">Customer evidence bundle</strong> — traditional safety
              EIC + Chapter 81 efficiency rationale + design records + monitoring plan
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">UK net-zero policy</strong>— 2050 carbon target;
              electrification of heat + transport; widespread LCT install programme;
              energy-efficiency expectations in supporting regs (Building Regs Part L, EPC, EERS)
            </li>
            <li>
              <strong className="text-white">LCT install volumes</strong>— UK 2025-26 typical
              new-build + many retrofits include PV + BESS + heat pump + EV. Sustained high-current
              loads are the norm, not the exception
            </li>
            <li>
              <strong className="text-white">I²R loss matters at scale</strong> — heat pump running
              4-6 hours per day for 5 months; EV charging 6-8 hours per session 3-5 nights per week;
              PV exporting 4-7 hours per day in summer. Cable losses scale with current squared +
              time
            </li>
            <li>
              <strong className="text-white">IEC + CENELEC alignment</strong> — international
              standards moving toward energy-efficient design in wiring. BS 7671 follows
            </li>
            <li>
              <strong className="text-white">Customer expectation</strong> — UK 2025-26 customer
              paying significant amounts for an LCT package expects the install to perform
              efficiently. The evidence layer matters for trust + future EICR / handover
            </li>
            <li>
              <strong className="text-white">Coherence with Part 8</strong> — Chapter 82
              (Prosumer\'s Low Voltage Electrical Installations, PEI) was already in Part 8. Chapter
              81 makes Part 8 (Functional Requirements) a coherent prosumer + efficiency suite
            </li>
            <li>
              <strong className="text-white">EICR + handover evidence</strong> — future verifier
              needs to see efficiency rationale + monitoring plan + design records, not infer them
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — Chapter 81 introduces a
              new section in the customer handover documentation pack
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Reg 525 says the conductor must not drop more than 5% — that\'s the ceiling. Chapter 81
          says go further below it when efficiency pays back. Together they bracket the design.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 525 maximum</strong>— calculate minimum CSA so
              design voltage drop is below 5% (heat pump is not lighting). The 5% cap is the safety
              + correctness limit
            </li>
            <li>
              <strong className="text-white">Chapter 81 efficiency</strong> — calculate I²R loss at
              design current × expected operating hours per year. Convert to kWh × unit price =
              annual cost of cable losses
            </li>
            <li>
              <strong className="text-white">Upsize CSA</strong> — model the loss reduction from
              going to next CSA up; subtract incremental cable cost; compute payback in years
            </li>
            <li>
              <strong className="text-white">Decide</strong> — if payback is reasonable (typical UK
              2025-26 threshold 5-10 years) and the customer accepts the upfront delta, upsize.
              Record the rationale under Chapter 81
            </li>
            <li>
              <strong className="text-white">Voltage drop margin benefit</strong> — upsized cable
              also gives more headroom at the appliance terminals (better starting performance,
              lower terminal heating, longer equipment life)
            </li>
            <li>
              <strong className="text-white">Other sustained-load candidates</strong> — EV charger
              dedicated circuit; BESS DC + AC; PV DC + AC; immersion diverter; induction hob (high
              peak); cooker circuit at sustained load
            </li>
            <li>
              <strong className="text-white">Where it doesn\'t pay back</strong> — general lighting
              circuits at low duty; occasional socket-use circuits. The Reg 525 minimum-compliant
              conductor is sufficient
            </li>
            <li>
              <strong className="text-white">Cert evidence</strong>— Chapter 81 design record per
              circuit where upsizing applied; rationale + payback model attached to EIC
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 433 overload</strong>— OCPD rated In: design
              current ≤ In ≤ Iz of conductor; protective device operating current I2 ≤ 1.45 × Iz.
              Unchanged by Chapter 81
            </li>
            <li>
              <strong className="text-white">Reg 434 short-circuit</strong> — OCPD breaking capacity
              ≥ PSCC at point of installation; conductor adiabatic check k²S² ≥ I²t. Unchanged
            </li>
            <li>
              <strong className="text-white">Reg 525 voltage drop</strong> — design voltage drop ≤
              3% (lighting) / 5% (other). Unchanged as the maximum; Chapter 81 may drive design well
              below it
            </li>
            <li>
              <strong className="text-white">Chapter 81 upsize scenario</strong> — design current 25
              A (heat pump). Reg 433 OCPD 32 A. Reg 525 minimum CSA 6 mm² T+E (Iz ~ 47 A, voltage
              drop within 5%). Chapter 81 may justify 10 mm² (Iz ~ 64 A, voltage drop much lower,
              I²R loss reduced) — OCPD remains 32 A; cable is larger than Reg 525 minimum
            </li>
            <li>
              <strong className="text-white">Cable economics</strong>— incremental cable cost per
              CSA step; expected operating hours per year + design current squared = annual energy
              loss saved; payback model
            </li>
            <li>
              <strong className="text-white">Equipment life</strong>— secondary benefit of lower
              cable losses: lower terminal temperatures, longer connection life, less drift in
              measurement instrumentation
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — per-circuit design
              record: Reg 433 / 434 / 525 compliance + Chapter 81 efficiency rationale where applied
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Per-circuit cable rationale</strong> — where conductor
              upsized beyond Reg 525 minimum, why (sustained current + payback model)
            </li>
            <li>
              <strong className="text-white">Voltage-drop calculation</strong> — design voltage drop
              per circuit + margin below Reg 525 cap (if Chapter 81 upsizing applied)
            </li>
            <li>
              <strong className="text-white">Load-shifting design notes</strong> — tariff-aware
              circuits sized for off-peak EV / heat pump / immersion diverter operation
            </li>
            <li>
              <strong className="text-white">EEMS configuration</strong>— the Reg 825.1 Electrical
              Energy Management System coordinating PV / BESS / heat pump / EV operation
            </li>
            <li>
              <strong className="text-white">LCT component sizing</strong> — PV kWp, BESS kWh +
              power, heat pump kW + SCOP, EV charger A + max kWh/session, annual energy estimate per
              component
            </li>
            <li>
              <strong className="text-white">Monitoring points</strong>— sub-meters, CT clamps,
              smart-meter export wiring + commissioning
            </li>
            <li>
              <strong className="text-white">Payback model</strong>— economic + carbon assumptions +
              payback in years for the efficiency choices
            </li>
            <li>
              <strong className="text-white">Customer handover</strong>— Chapter 81 evidence bundle
              delivered alongside the safety EIC + schedule of inspection + schedule of test results
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Chapter 81 (BS 7671)</strong>— electrical install
              efficiency design + records + verification. Electrician\'s scope
            </li>
            <li>
              <strong className="text-white">Building Regs Part L (England)</strong> — building
              fabric + services efficiency for new build + significant retrofits. Building Control
              sign-off. Separate framework
            </li>
            <li>
              <strong className="text-white">Part L equivalents</strong>— Wales (Part L), Scotland
              (Section 6), Northern Ireland (Part F). Devolved equivalents apply
            </li>
            <li>
              <strong className="text-white">EPC</strong> — Energy Performance Certificate,
              customer-facing building-energy rating (A-G). Required at sale / let / new build. LCT
              install affects EPC rating
            </li>
            <li>
              <strong className="text-white">SAP / RdSAP</strong>— Standard Assessment Procedure /
              Reduced-data SAP — methodology for EPC assessment. SAP assessor records the LCT
              install + Chapter 81 evidence feeds in
            </li>
            <li>
              <strong className="text-white">MCS handover</strong>— for grant-funded LCT (heat pump
              primarily under BUS), MCS handover pack integrates with the EPC re-assessment +
              Chapter 81 BS 7671 records
            </li>
            <li>
              <strong className="text-white">Cross-references</strong>— Chapter 81 design records
              can be attached to the EPC re-assessment file + Part L compliance documentation. They
              are separate but interlocking
            </li>
            <li>
              <strong className="text-white">Customer evidence bundle</strong> — Chapter 81 + EIC
              (BS 7671) + EPC (SAP) + MCS handover (where applicable) + Building Control sign-off
              (where applicable). The electrician\'s scope is the BS 7671 layer
            </li>
          </ul>
        </ConceptBlock>
