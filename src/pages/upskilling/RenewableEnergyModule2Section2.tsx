...
const RenewableEnergyModule2Section2 = () => {
  useSEO({
    ...
    description:
      'Evaluating site conditions for optimal solar PV system performance - orientation, shading, and irradiance analysis.',
  });
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'South-east (135 degrees) or south-west (225 degrees) facing panels achieve 95-98% of optimal performance.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Most UK locations (51-56 degrees latitude) require 30-45 degree tilt for optimal year-round performance.',
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'Due to the series-connected nature of solar cells, single cell shading can reduce entire string output by 30-50%.',
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'GHI is the total solar radiation received on a horizontal surface, combining direct and diffuse components.',
    },
    {
      question: 'What is the typical annual GHI range in the UK?',
      options: [
        '600-800 kWh/m squared',
        '950-1,200 kWh/m squared',
        '1,400-1,600 kWh/m squared',
        '1,800-2,000 kWh/m squared',
      ],
      correctAnswer: 1,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Solar pathfinder is a manual tool using a dome for visual shading analysis throughout the year.',
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'South-West England typically achieves 950-1,050 kWh/kWp due to higher irradiance and marine climate.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Urban heat island effect can raise temperatures 2-5 degrees C higher than surrounding rural areas.',
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'LiDAR technology provides measurement precision of plus or minus 2cm for site surveys.',
    },
  ];
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              ...
              wrong location is a poor investment.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">South (180°):</strong> Maximum annual yield
                  </li>
                  <li>
                    • <strong className="text-white">SE/SW (135°/225°):</strong> 95-98% performance
                  </li>
                  <li>
                    • <strong className="text-white">East/West (90°/270°):</strong> 85-90%
                  </li>
                  <li>
                    • <strong className="text-white">North:</strong> Not recommended
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">0° (true south):</strong> Optimal
                  </li>
                  <li>
                    • <strong className="text-white">±30°:</strong> &lt;5% loss
                  </li>
                  <li>
                    • <strong className="text-white">±60°:</strong> 10-15% loss
                  </li>
                  <li>
                    • <strong className="text-white">±90°:</strong> 20-25% loss
                  </li>
                </ul>
              </div>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <ul className="text-sm space-y-1">
                <li>
                  • <strong className="text-white">Time-of-use tariffs:</strong> West-facing may
                  benefit evening peak rates
                </li>
                <li>
                  • <strong className="text-white">Self-consumption:</strong> East-facing captures
                  morning usage
                </li>
                <li>
                  • <strong className="text-white">Ground-mount:</strong> Can achieve optimal
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">London (51.5°N):</strong> 35-40°
                  </li>
                  <li>
                    • <strong className="text-white">Birmingham (52.5°N):</strong> 35-40°
                  </li>
                  <li>
                    • <strong className="text-white">Manchester (53.5°N):</strong> 35-40°
                  </li>
                  <li>
                    • <strong className="text-white">Edinburgh (55.9°N):</strong> 40-45°
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Summer optimal:</strong> Latitude - 20°
                  </li>
                  <li>
                    • <strong className="text-white">Winter optimal:</strong> Latitude + 15°
                  </li>
                  <li>
                    • <strong className="text-white">Year-round:</strong> Latitude (51-56°)
                  </li>
                  <li>
                    • <strong className="text-white">Practical:</strong> 30-50° works well
                  </li>
                </ul>
              </div>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <ul className="text-sm space-y-1">
                <li>
                  • <strong className="text-white">Too low (&lt;25°):</strong> Reduced winter
                  performance, dirt accumulation
                </li>
                <li>
                  • <strong className="text-white">Optimal (30-45°):</strong> Maximum yield,
                  self-cleaning rain effect
                </li>
                <li>
                  • <strong className="text-white">Too high (&gt;60°):</strong> Reduced summer
                  performance, wind loading
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Buildings:</strong> Chimneys, dormers
                  </li>
                  <li>
                    • <strong className="text-white">Vegetation:</strong> Trees (future growth)
                  </li>
                  <li>
                    • <strong className="text-white">Infrastructure:</strong> Pylons, poles
                  </li>
                  <li>
                    • <strong className="text-white">Roof features:</strong> Vents, dishes
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Winter:</strong> Sun lower, longer shadows
                  </li>
                  <li>
                    • <strong className="text-white">Summer:</strong> Sun higher, shorter shadows
                  </li>
                  <li>
                    • <strong className="text-white">Critical times:</strong> 9am-3pm
                  </li>
                  <li>
                    • <strong className="text-white">Deciduous trees:</strong> Summer shade only
                  </li>
                </ul>
              </div>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                <div>
                  <p className="mb-1">
                    <strong className="text-white">Single cell shading:</strong>
                  </p>
                  <p>Can reduce string output by 30-50%</p>
                </div>
                <div>
                  <p className="mb-1">
                    <strong className="text-white">Panel corner shading:</strong>
                  </p>
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">DNI:</strong> Direct Normal Irradiance
                  </li>
                  <li>
                    • <strong className="text-white">DHI:</strong> Diffuse Horizontal
                  </li>
                  <li>
                    • <strong className="text-white">GHI:</strong> Global Horizontal
                  </li>
                  <li>
                    • <strong className="text-white">GTI:</strong> Global Tilted
                  </li>
                  <li>
                    • <strong className="text-white">POA:</strong> Plane of Array
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Annual GHI:</strong> 950-1,200 kWh/m²
                  </li>
                  <li>
                    • <strong className="text-white">South England:</strong> 1,100-1,200
                  </li>
                  <li>
                    • <strong className="text-white">North Scotland:</strong> 900-1,000
                  </li>
                  <li>
                    • <strong className="text-white">Peak:</strong> May-July (150+ kWh/m²)
                  </li>
                </ul>
              </div>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <ul className="text-sm space-y-1">
                <li>
                  • <strong className="text-white">Peak Sun Hours (PSH):</strong> Equivalent hours
                  of 1,000 W/m² per day
                </li>
                <li>
                  • <strong className="text-white">STC:</strong> Standard Test Conditions - 1,000
                  W/m², 25°C, AM 1.5
                </li>
                <li>
                  • <strong className="text-white">Performance Ratio:</strong> Actual vs theoretical
                  output
                </li>
              </ul>
            </div>
        ...
        <div className="mb-8 mt-8">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <ul className="text-sm space-y-1">
                <li>
                  • <strong className="text-white">Urban heat island:</strong> 2-5°C higher, reduced
                  efficiency
                </li>
                <li>
                  • <strong className="text-white">Coastal:</strong> Salt air, humidity, marine
                  layer
                </li>
                <li>
                  • <strong className="text-white">Highland:</strong> Temperature extremes,
                  increased UV
                </li>
              </ul>
            </div>
          ...
          <div className="text-white text-sm space-y-2">
            ...
            <div className="p-3 rounded bg-white/5 mt-2">
              ...
              <ul className="space-y-1">
                <li>
                  • <strong className="text-white">Orientation penalty:</strong> 3% loss (45°
                  off-south)
                </li>
                <li>
                  • <strong className="text-white">Tilt penalty:</strong> 2% loss (non-optimal)
                </li>
                <li>
                  • <strong className="text-white">Shading loss:</strong> 8% annual (from tree)
                </li>
                <li>
                  • <strong className="text-white">Total site factor:</strong> 87% of optimal
                </li>
                <li>
                  • <strong className="text-elec-yellow">Recommendation:</strong> Proceed -
                  acceptable losses
                </li>
              </ul>
            </div>
