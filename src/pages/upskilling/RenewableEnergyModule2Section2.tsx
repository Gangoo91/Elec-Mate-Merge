...
import {
  PvModuleCrossSection,
  BypassDiodeTopology,
} from '@/components/study-centre/diagrams/renewableM2';
...
const faqs = [
  {
    question: 'How do I read a PV module datasheet — which fields actually matter?',
    answer:
  ...
  {
    question: 'Why do bypass diodes go in the junction box rather than alongside each cell?',
    answer:
  ...
  {
    question: 'What\'s the difference between "framed" and "frameless" PV modules?',
    answer:
  ...
  {
    question: 'Bifacial modules — what are they and do they make sense in the UK?',
    answer:
  ...
  {
    question: 'BS EN 61730 vs BS EN 61215 — what are these standards?',
    answer:
  ...
  {
    question: "How long do PV modules last in UK conditions — and what's the warranty pattern?",
    answer:
  ...
  {
    question: 'PID (Potential Induced Degradation) — what is it and should I worry about it?',
    answer:
  ...
  {
    question: "How does module mounting interact with the manufacturer's warranty?",
    answer:
...
export default function RenewableEnergyModule2Section2() {
  ...
  useSEO({
    title: 'Modules — from cells to module | Renewable Energy 2.2 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 2 · BS 7671:2018+A4:2026"
        title="Modules — from cells to module"
        backTo="../renewable-energy-module-2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Cells assembled into a module — series cell strings, bypass diodes, electrical
          characteristics (V_oc, I_sc, V_mp, I_mp, P_max, fill factor), module construction and the
          BS 7671 Section 712 requirements that land at module level.
        </p>
        ...
        <Pullquote>
          A module is a series string of cells plus bypass diodes plus a glass-and-encapsulant
          package.
        </Pullquote>
        ...
        >
          <p>
            From front (sun-facing) to back, a standard framed crystalline silicon module consists
            of:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Front tempered low-iron glass</strong> — high light
              transmittance (low iron content), tempered for impact resistance, typically 3.2–4 mm
              thick. The single most expensive component after the cells.
            </li>
            <li>
              <strong className="text-white">EVA encapsulant (front)</strong> — ethylene vinyl
              acetate, melted under heat during lamination to bond the glass to the cell matrix and
              exclude moisture. The encapsulant ages with UV exposure — yellowing of older modules
              is encapsulant browning.
            </li>
            <li>
              <strong className="text-white">Cell matrix</strong> — typically 60 or 72 cells in a
              rectangular array, interconnected with tinned-copper ribbons (busbars on the cell
              front, solder-attached to the next cell\'s back). Half-cell modules use 120 half-cells
              in two parallel groups.
            </li>
            <li>
              <strong className="text-white">EVA encapsulant (back)</strong> — matching the front,
              sealing the cells from below.
            </li>
            <li>
              <strong className="text-white">Polymer backsheet</strong> — typically a multi-layer
              polymer (Tedlar / PET) providing weather protection and electrical insulation.
              Bifacial modules replace the backsheet with rear glass for transparency.
            </li>
            <li>
              <strong className="text-white">Aluminium frame</strong> — perimeter frame providing
              rigidity, edge sealing for the laminate, and standardised fixing holes for mounting
              clamps and brackets.
            </li>
            <li>
              <strong className="text-white">Junction box</strong> — mounted on the rear, containing
              the bypass diodes (typically three per 60-cell module) and the MC4 connector tails for
              string interconnection. The junction box is the module\'s single point of electrical
              interface to the rest of the installation.
            </li>
          </ul>
          <p>
            Each layer has known failure modes. Glass: hail damage, edge chipping. Encapsulant:
            browning, delamination. Cell matrix: cracking from impact or thermal cycling, hotspot
            damage. Backsheet: cracking after years of UV. Frame: corrosion at fixing points.
            Junction box: thermal failure of bypass diodes, MC4 connector degradation.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              Unshaded cells generate their normal current; the series string forces all cells to
              carry the same current
            </li>
            <li>
              A shaded cell generates much less photocurrent — it becomes reverse-biased by the
              unshaded cells\' voltage
            </li>
            <li>
              The reverse-biased shaded cell dissipates the power of the unshaded cells as heat —
              potentially reaching cell temperatures &gt; 150°C
            </li>
            <li>
              The encapsulant near the hotspot browns and degrades; in severe cases the cell or even
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              Current bypasses the shaded sub-string through the diode rather than forcing through
              the shaded cell
            </li>
            <li>
              The bypassed sub-string contributes zero power; the rest of the module operates
              normally
            </li>
            <li>
              Power loss: roughly proportional to the fraction of cells bypassed (~33% for one
              sub-string of three in a 60-cell module)
            </li>
          </ul>
          <p>
            Why three bypass diodes and not one or sixty: one diode would mean any shading takes out
            the whole module; sixty (one per cell) would be prohibitively expensive and add many
            failure points. Three is the standard compromise — sufficient granularity for typical
            shading patterns, manageable cost and reliability.
          </p>
          <p>
            For applications with severe partial shading (chimney shadows, intermittent tree shade,
            complex roof geometries), the limitation of three bypass diodes is what drives the move
            to module-level power optimisers or microinverters (Section 2.5) — those effectively put
            the MPPT and bypass function at the individual module level, eliminating the
            sub-string-bypass loss.
          </p>
        </ConceptBlock>
        ...
        <Pullquote>
          The module datasheet is a contract between the manufacturer and the installer.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">V_oc (open-circuit voltage)</strong> — voltage at zero
              current. Drives string voltage stacking and cold-day V_oc string sizing against the
              inverter input limit.
            </li>
            <li>
              <strong className="text-white">I_sc (short-circuit current)</strong> — current at zero
              voltage. Drives DC cable sizing, fuse / blocking diode rating (multiplied by 1.1–1.25
              safety factor), and string parallel-count limits.
            </li>
            <li>
              <strong className="text-white">V_mp (voltage at maximum power)</strong> — where the
              inverter MPPT will operate. Drives the inverter MPPT input range compatibility check.
            </li>
            <li>
              <strong className="text-white">I_mp (current at maximum power)</strong> — the
              operating current at MPP. Drives the steady-state DC cable thermal rating.
            </li>
            <li>
              <strong className="text-white">P_max (maximum power)</strong> — the STC nameplate.
              Drives the headline kWp rating of the array and the annual yield calculation.
            </li>
          </ul>
          <p>The fill factor cross-check:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>FF = P_max / (V_oc × I_sc)</li>
            <li>Also: P_max should equal V_mp × I_mp</li>
            <li>Typical crystalline silicon FF: 0.75–0.85</li>
            <li>
              FF below 0.70 indicates quality issues (high series resistance, poor contact
              metallisation)
            </li>
          </ul>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              The electrical installation begins at a PV module or set of PV modules connected in
              series with the manufacturer-supplied cables
            </li>
            <li>It continues up to the user\'s installation or the utility supply point</li>
            <li>
              Selection rules in Section 712 modify the general Part 4 / Part 5 framework for the PV
              case
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Heat dissipation</strong> — modules shall be installed
              as specified by the manufacturer to provide adequate heat dissipation under maximum
              solar radiation for the site
            </li>
            <li>
              <strong className="text-white">Blocking diodes (if used)</strong> — connected in
              series with strings; reverse voltage ≥ 2 × Upc max; rated current ≥ 1.1 × Isc max
            </li>
            <li>
              <strong className="text-white">Module overcurrent protection rating</strong> — the PV
              module maximum overcurrent protection rating is the PV module maximum rated current
              (the protective device sizing constraint)
            </li>
          </ul>
          <p>
            The 1.1 multiplier on Isc may need adapting for special conditions (reflections, special
            PV module technologies) per the Reg 712.433.102(b)(ii) note. For routine UK rooftop
            installs the 1.1 multiplier is adequate; the designer documents any adaptation in the
            design pack.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Inadequate crimp</strong> — using a hand- crimp tool
              rather than the manufacturer-specified crimp produces inconsistent crimp quality.
              Elevated contact resistance over years drives progressive heating and eventual
              failure.
            </li>
            <li>
              <strong className="text-white">Inadequate torque</strong> — the connector body relies
              on torque to maintain the spring-contact pressure between mated halves. Finger-tight
              is not enough; spec is typically 4–6 Nm depending on manufacturer.
            </li>
            <li>
              <strong className="text-white">Brand mismatch</strong> — MC4 is the product name but
              connectors from different manufacturers (Stäubli, Phoenix Contact, Multi-Contact,
              others) have subtle dimensional differences. Mixed- brand connections may appear to
              mate but produce unreliable contact.
            </li>
            <li>
              <strong className="text-white">Damaged or wet connections</strong> — connectors left
              disconnected accumulate moisture and contamination. Wiping clean and reseating is
              insufficient; replacement is the right call.
            </li>
          </ul>
          <p>
            The incident pattern: progressively elevated connection resistance dissipates power as
            heat at the connector. Over years (sometimes months), the connector\'s polymer body
            softens; in the worst cases, the connector ignites or generates a DC arc. DC arcs are
            particularly dangerous because DC does not have the zero-crossings that help extinguish
            AC arcs — a DC arc can self-sustain.
          </p>
          <p>
            The PWI common mistakes list explicitly flags &ldquo;not torquing MC4 or isolator
            terminals to spec&rdquo; as a high-frequency installer error. The cert evidence bundle
            should include the torque values and the tool used; MCS audits sample the connector
            workmanship.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Half-cell modules</strong> — each full-size cell is cut
              in half; the laminate is rearranged so the per-string current is halved while voltage
              stays similar. Benefits: lower resistive losses in cell interconnections (~3% power
              gain), better partial-shade tolerance (smaller sub-strings to bypass independently),
              reduced bypass-diode stress.
            </li>
            <li>
              <strong className="text-white">Shingled-cell modules</strong> — overlapping cell
              ribbons rather than ribbon-busbar interconnections, eliminating the inter-cell gaps.
              Benefits: ~2–3% power gain on the same module area, more uniform appearance, reduced
              shading-loss propagation.
            </li>
            <li>
              <strong className="text-white">Bifacial modules</strong> — transparent rear glass
              instead of polymer backsheet, allowing cells to capture rear-side reflected light.
              Benefits: 5–25% total yield gain depending on ground reflectance (albedo), mounting
              height, and tilt. Best suited to ground-mount, carport, and façade installations with
              light-coloured surfaces behind the array.
            </li>
          </ul>
          <p>
            The trade-offs: each innovation typically adds 5–15% to the per-watt cost, recouped
            through the additional yield. The decision criterion at survey stage: does the install
            geometry favour the innovation? Half-cell wins almost universally on UK domestic.
            Shingled wins on premium aesthetic / high-performance installs. Bifacial wins on
            ground-mount with managed albedo.
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-2-section-1')}
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-2-section-3')}
