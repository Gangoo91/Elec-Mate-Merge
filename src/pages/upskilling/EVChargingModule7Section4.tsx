...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 3,
    explanation:
      'Installation records must be retained for a minimum of 10 years. Financial records require 7 years (HMRC), and certain health and safety records must be kept for 40 years.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Critical systems should have an RTO of 4 hours, meaning you can recover operations within that timeframe. Recovery Point Objective (RPO) should be maximum 1 hour data loss.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'The 3-2-1 backup rule means: 3 copies of data, on 2 different media types, with 1 copy stored off-site. This provides robust protection against data loss.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Installation certificates, customer contracts, equipment specifications, test results, training records, insurance certificates, complaint handling documentation, and quality management procedures should all be easily accessible.',
  },
  {
    question: 'How often are OZEV audits conducted?',
    answer:
      'Initial approval audit, annual surveillance audits, random spot checks, and renewal audits every 3 years. Customer complaint investigations may also trigger additional audits.',
  },
  {
    question: 'What are the key GDPR requirements for EV installers?',
    answer:
      'Lawful processing with customer consent, purpose limitation, data minimisation, accuracy, storage limitation, and security. You must also manage subject access requests and report data breaches.',
  },
  {
    question: 'What happens if records are unavailable during an audit?',
    answer:
      'Missing records can result in non-conformities, delayed approval renewal, or in serious cases, suspension of approved installer status. Always maintain comprehensive, organised documentation.',
  },
];
...
const EVChargingModule7Section4 = () => {
  useSEO({
    ...
    description:
      'Master comprehensive record-keeping systems and audit preparation for OZEV compliance and business excellence in EV charging installations.',
  });
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Retention:</strong> 10+ years for installations
              </li>
              <li>
                <strong>Backup:</strong> 3-2-1 rule (3 copies, 2 media, 1 off-site)
              </li>
              <li>
                <strong>RTO:</strong> 4 hours for critical systems
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Initial:</strong> Before approval granted
              </li>
              <li>
                <strong>Annual:</strong> Surveillance audits
              </li>
              <li>
                <strong>Renewal:</strong> Every 3 years
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Comprehensive record-keeping is fundamental for OZEV approved installers.
              Understanding retention periods and mandatory documentation ensures compliance and
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              ...
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Installation records:</strong> 10 years minimum
                  </li>
                  <li>
                    <strong>Financial records:</strong> 7 years (HMRC)
                  </li>
                  <li>
                    <strong>Training certificates:</strong> Validity + 2 years
                  </li>
                  <li>
                    <strong>Insurance records:</strong> 7 years post-expiry
                  </li>
                  <li>
                    <strong>Customer contracts:</strong> 7 years post-completion
                  </li>
                  <li>
                    <strong>H&S records:</strong> Up to 40 years (certain types)
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              compliance. A systematic approach prevents last-minute stress and missed
              documentation.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Step 1:</strong> Review and organise all project files
                </li>
                <li>
                  <strong>Step 2:</strong> Verify document versions and currency
                </li>
                <li>
                  <strong>Step 3:</strong> Check qualification and insurance validity
                </li>
                <li>
                  <strong>Step 4:</strong> Brief staff on audit procedures
                </li>
                <li>
                  <strong>Step 5:</strong> Prepare document index and register
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Incomplete project files:</strong> — Use checklists for every installation
                </li>
                <li>
                  <strong>Outdated qualifications:</strong> — Set expiry alerts for all certificates
                </li>
                <li>
                  <strong>Poor organisation:</strong> — Standardise naming and filing systems
                </li>
                <li>
                  <strong>Weak complaint handling:</strong> — Document all customer interactions
                </li>
              </ul>
            </div>
          </div>
