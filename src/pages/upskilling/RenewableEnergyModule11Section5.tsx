...
const inlineChecks = [
  {
    ...
    question: 'Per Reg 534.4.1.1, where does each SPD Type sit?',
    options: [
  ...
  },
  {
    ...
    question: 'Per Reg 534.4.6, what must remain effective even if the SPD fails?',
    options: [
  ...
  },
  {
    ...
    question: 'Per Reg 712.534.102.1, what determines whether a PV install needs Type 1 SPDs?',
    options: [
...
const quizQuestions = [
  {
    question: 'Reg 443.4 (A4:2026) — when is SPD protection required?',
    options: [
  ...
  {
    question: 'For a typical UK 2025-26 residential PV install — what SPD selection drops out?',
    options: [
...
export default function RenewableEnergyModule11Section5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 11 · Section 5 · BS 7671 Section 443 + Section 534 · BS EN 62305-4 SPDs"
        title="BS EN 62305-4 + Section 443 / 534 surge protective devices (SPDs)"
        backTo="../renewable-energy-module-11"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reg 443.4.1 SPD requirement triggers (A4:2026 redraft). Reg 534.4.1.1 Type 1 / 2 / 3 by
          location. Reg 534.4.4 selection parameters (Up, Uc, In, Iimp). Reg 534.4.6 fault
          protection. Reg 534.4.8 distance effect. Reg 712.534.102.1 PV SPDs. Cert evidence.
        </p>
        ...
        <Pullquote>
          Up below Uw. SPD upstream of equipment within 10 m. Fault protection still works if SPD
          dies. That\'s the SPD trinity per BS 7671 Section 534.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">(a) Life criterion</strong>— consequence of overvoltage
              could result in serious injury to, or loss of, human life. Applies to: medical
              equipment, critical care, public safety installations
            </li>
            <li>
              <strong className="text-white">(b) Deleted</strong>— limb (b) was deleted by the BS
              7671:2018+A2:2022 Corrigendum (May 2023); there is no (b) criterion in the current
              standard
            </li>
            <li>
              <strong className="text-white">(c) Financial / data loss criterion</strong> —
              significant financial or data loss. Applies to: LCT installs (PV / BESS / EV / smart
              meter — high replacement cost + data); commercial IT; servers; control systems
            </li>
            <li>
              <strong className="text-white">Other cases</strong>— SPDs SHALL be provided UNLESS the
              owner of the installation declares it is not required due to any loss or damage being
              tolerable and they accept the risk. Opt-out path requires evidence
            </li>
            <li>
              <strong className="text-white">Annex A443 deleted</strong>— the calculated risk level
              (CRL) method (formerly used to determine SPD requirement) was deleted in A4:2026.
              Simpler category-based test now applies
            </li>
            <li>
              <strong className="text-white">BS EN 62305-2 role</strong>— remains as the formal
              risk-assessment methodology where appropriate (heritage, commercial, high-risk). For
              most LCT installs the Reg 443.4.1 (c) criterion is sufficient justification
            </li>
            <li>
              <strong className="text-white">Practical impact</strong>— SPDs now expected in most
              installs. Owner opt-out documentation required if not installed
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — SPD selection rationale
              + Reg 443.4.1 criterion applied + owner opt-out declaration if applicable + design
              records
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Sources of switching overvoltage</strong> — motor
              switching (start / stop); transformer energising / de-energising; capacitor switching;
              fault clearance by protective devices; arc events in switchgear
            </li>
            <li>
              <strong className="text-white">LCT-specific sources</strong>— PV inverter PWM
              switching; BESS bidirectional switching; EV charger PWM; heat pump VSD switching;
              on/off cycling of all LCT equipment
            </li>
            <li>
              <strong className="text-white">Magnitude</strong>— typically lower than
              lightning-induced surges (hundreds of V to low kV); but higher frequency + cumulative
            </li>
            <li>
              <strong className="text-white">SPD coverage</strong>— Type 2 + Type 3 SPDs handle
              switching surges via 8/20 µs + combination waveform testing. Designed for both
              lightning indirect + switching events
            </li>
            <li>
              <strong className="text-white">Reg 826.1.4 PEI</strong>— Switching overvoltages in a
              PEI may be more frequent + perhaps greater than in a non-PEI installation (due to
              switching between sources, load shedding, load shifting). Consideration is given to
              SPD installation
            </li>
            <li>
              <strong className="text-white">Sensitive electronics</strong>— particularly
              susceptible to switching transients; Reg 534.4.8 + Type 3 SPDs close to equipment
            </li>
            <li>
              <strong className="text-white">SPD ageing</strong>— repeated low-level switching
              activations accumulate; SPDs need visual indicator check + periodic verification
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — SPD selection accounts
              for both lightning + switching; Reg 443.4.2 noted in design records
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Three Types, three jobs, three locations. Type 1 catches the lightning at the door; Type 2
          cleans up downstream; Type 3 wraps up the last 10 metres to the sensitive electronics.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Type 1 SPD</strong>— tested with 10/350 µs impulse
              waveform; classified by Iimp (impulse discharge current). Used at origin in structure
              with external LPS — handles partial direct lightning current that arrives at the
              installation entry. NOTE: Reg 534.4.1.1 — Type 1 SPDs are often referred to as
              "equipotential bonding SPDs"
            </li>
            <li>
              <strong className="text-white">Type 2 SPD</strong>— tested with 8/20 µs surge
              waveform; classified by In (nominal discharge current). Used at LPZ 1/2 boundary
              (sub-boards), OR at origin where no external LPS. Handles indirect lightning surge +
              switching surge
            </li>
            <li>
              <strong className="text-white">Type 3 SPD</strong>— tested with combination waveform;
              for residual surge after upstream SPDs + switching transients originating within the
              building. Used close to sensitive equipment (within 10 m per Reg 534.4.8 if Type 2 is
              upstream + &gt; 10 m away)
            </li>
            <li>
              <strong className="text-white">Combined Type 1+2</strong>— manufacturers offer
              combined devices that meet both Type 1 + Type 2 standards in a single SPD. Useful
              where a single unit covers origin + immediate downstream protection
            </li>
            <li>
              <strong className="text-white">Combined Type 2+3</strong>— manufacturers offer
              combined Type 2 + Type 3 devices for sub-distribution where local sensitive equipment
              is within range
            </li>
            <li>
              <strong className="text-white">Test waveforms</strong>— defined in EN 61643-11 (BS EN
              61643-11 in UK). Type 1 = 10/350 µs; Type 2 = 8/20 µs; Type 3 = combination
            </li>
            <li>
              <strong className="text-white">PV-specific</strong>— PV-DC SPDs tested differently (DC
              waveforms + DC switching); manufacturer DoC specifies. Reg 712.534.102.1 references
              the Type framework
            </li>
            <li>
              <strong className="text-white">Cert evidence</strong>— SPD Type + test waveform +
              manufacturer DoC documented per location
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Up — voltage protection level</strong> — Reg 534.4.4.1
              + 443.6.1. Maximum voltage across protected equipment during SPD operation. Must be
              &lt; Uw (equipment rated impulse withstand voltage)
            </li>
            <li>
              <strong className="text-white">Uw — equipment rated impulse withstand</strong> — Reg
              443.6.1 + Table 443.2. Category IV (origin) 6 kV; Category III (distribution) 4 kV;
              Category II (current-using) 2.5 kV; Category I (specially protected) 1.5 kV. At
              230/400 V nominal
            </li>
            <li>
              <strong className="text-white">Uc — continuous operating voltage</strong> — Reg
              534.4.4.3. Maximum voltage that can be continuously applied to the SPD without
              operation. Must be ≥ nominal supply voltage. Typical 275-385 V for 230 V systems
            </li>
            <li>
              <strong className="text-white">In — nominal discharge current</strong> — Reg
              534.4.4.4. For Type 2 SPDs; 8/20 µs surge current the SPD handles multiple times. 5
              kA, 10 kA, 20 kA, 40 kA, 65 kA typical values
            </li>
            <li>
              <strong className="text-white">Iimp — impulse discharge current</strong> — Reg
              534.4.4.4. For Type 1 SPDs; 10/350 µs partial direct lightning current. 12.5 kA, 25
              kA, 50 kA, 100 kA per pole typical
            </li>
            <li>
              <strong className="text-white">Coordination (Reg 534.4.4.5)</strong> — SPDs in series
              (Type 1 + Type 2 + Type 3) must coordinate — each handles its expected range without
              overloading downstream devices
            </li>
            <li>
              <strong className="text-white">Iscc — expected short-circuit current</strong> — Reg
              534.4.4.6. SPD must withstand + interrupt the prospective short-circuit current at its
              install location. Typical 6-25 kA depending on supply
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — per-SPD selection
              record: Type, Uc, Up, In/Iimp, Iscc + manufacturer DoC + Reg 534.4.4 compliance
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">The mechanism</strong>— cable inductance + capacitance
              form an oscillating circuit when the SPD operates (sudden current change). Voltage at
              the equipment terminals can be up to 2 × Up due to oscillation peaks
            </li>
            <li>
              <strong className="text-white">Threshold</strong>— Reg 534.4.8 specifies 10 m as the
              practical threshold beyond which oscillations significantly affect equipment voltage
            </li>
            <li>
              <strong className="text-white">Effect on coordination</strong> — if Up doubles at the
              equipment, the Up &lt; Uw coordination per Reg 534.4.4.1 may fail; equipment sees
              higher transient than design
            </li>
            <li>
              <strong className="text-white">Solution 1</strong>— add coordinated SPD (Type 2 or
              Type 3) closer to the equipment — within 10 m
            </li>
            <li>
              <strong className="text-white">Solution 2</strong>— select SPD at origin with lower Up
              so that 2 × Up still &lt; Uw at equipment (less common; usually cheaper to add local
              SPD)
            </li>
            <li>
              <strong className="text-white">Solution 3</strong>— reduce cable run if practical
              (rare to be feasible after design)
            </li>
            <li>
              <strong className="text-white">LCT applications</strong>— PV inverter typically 5-10 m
              from DC SPD at the inverter location (within tolerance); long DC string runs (&gt; 10
              m to inverter) may need additional string-level SPDs. EV chargers at end of long
              submain need local SPD
            </li>
            <li>
              <strong className="text-white">Cert evidence</strong>— SPD location vs protected
              equipment distance documented + Reg 534.4.8 compliance per circuit
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">SPD failure modes</strong>— (1) thermal: cumulative
              heat from repeated MOV activations leads to thermal runaway. (2) short-circuit: severe
              surge exceeds energy capability + SPD shorts. (3) end-of-life: impedance drift after
              many minor surges
            </li>
            <li>
              <strong className="text-white">Internal disconnector</strong>— most modern SPDs
              include a thermal disconnector (responds to thermal failure) + short-circuit
              disconnector (responds to MOV short). Visual status indicator window
            </li>
            <li>
              <strong className="text-white">TN systems (Reg 534.4.6(a))</strong> — fault protection
              generally fulfilled by the OCPD on the supply side of the SPD. Appendix 16 Figure 16A1
              illustrates. The OCPD is rated + coordinated with the SPD\'s internal disconnector
            </li>
            <li>
              <strong className="text-white">TT systems (Reg 534.4.6(b))</strong> — fault protection
              by the installation\'s RCD or coordinated OCPD. SPD positioned so any fault current
              path is sensed by upstream RCD
            </li>
            <li>
              <strong className="text-white">Status monitoring</strong>— SPDs have visual status
              indicators (window: green = OK, red = failed). Periodic inspection (often part of EICR
              / LPS inspection) verifies. After known significant surge / strike event, inspect +
              replace if flagged
            </li>
            <li>
              <strong className="text-white">SPD replacement</strong>— once flagged failed, replace
              promptly. The internal disconnector may have isolated the SPD but the protection is
              gone — equipment downstream is unprotected until replacement
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — SPD upstream OCPD
              specification + Reg 534.4.6 compliance + customer instruction sheet on visual status
              check
            </li>
            <li>
              <strong className="text-white">EICR scope</strong>— verifier records SPD status during
              EICR; failed SPDs flagged for replacement
            </li>
          </ul>
        </ConceptBlock>
