...
const modules = [
  {
    ...
    description:
      'L, P and M categories under BS 5839-1 and how to choose the right system for the building.',
    icon: Layers,
    duration: '2-3 hours',
    link: 'module-1',
  },
  {
    ...
    description:
      'Smoke, heat and multisensor detectors, call points, sounders and visual alarm devices.',
    icon: Search,
    duration: '3-4 hours',
    link: 'module-2',
  },
  {
    ...
    description:
      'Zone layouts, addressable vs conventional, cause and effect programming and interfaces.',
    icon: MapPin,
    duration: '3-4 hours',
    link: 'module-3',
  },
  {
    ...
    description:
      'Battery sizing, fire-resistant cables, wiring methods and earth fault monitoring.',
    icon: Battery,
    duration: '2-3 hours',
    link: 'module-4',
  },
  {
    ...
    description: 'Planning, panel and device installation, wiring, commissioning and handover.',
    icon: Wrench,
    duration: '3-4 hours',
    link: 'module-5',
  },
  {
    ...
    description: 'Routine testing, servicing, fault finding, record keeping and certification.',
    icon: FileCheck,
    duration: '3-4 hours',
    link: 'module-6',
  },
  {
    ...
    description: 'Fire safety legislation, Building Regulations and BS 5839 parts 1 and 6.',
    icon: BookOpen,
    duration: '2-3 hours',
    link: 'module-7',
  },
  {
    moduleNumber: 8,
    title: 'Mock exam',
    description: 'Comprehensive assessment covering every fire alarm module.',
    icon: GraduationCap,
    duration: '90 mins',
    link: 'mock-exam',
    isExam: true,
...
export default function FireAlarmCourse() {
  ...
  return (
    ...
    >
      ...
      <ModuleCard
        to="/study-centre/glossary?course=fire-alarm"
