import { ArrowLeft, Shield, CheckCircle, Clock, Layers, Search, MapPin, Battery, Wrench, FileCheck, BookOpen, GraduationCap } from 'lucide-react';
...
const FireAlarmCourse = () => {
  const modules = [
    {
      id: 1,
      title: "Categories of Fire Alarm Systems (L, P, M)",
      duration: "45 mins",
      status: "available",
      icon: Layers
    },
    {
      id: 2,
      title: "Detectors, Call Points, and Alarm Devices",
      duration: "55 mins",
      status: "available",
      icon: Search
    },
    ...
    {
      id: 4,
      title: "Power Supply, Backup, and Cable Routing",
      duration: "50 mins",
      status: "available",
      icon: Battery
    },
    {
      id: 5,
      title: "Installation and Commissioning Procedures",
      duration: "65 mins",
      status: "available",
      icon: Wrench
    },
    ...
    {
      id: 7,
      title: "Regulatory Compliance and BS 5839 Overview",
      duration: "40 mins",
      status: "available",
      icon: BookOpen
    },
