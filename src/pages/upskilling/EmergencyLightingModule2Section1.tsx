...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'What is the maximum allowable max-to-min uniformity ratio along an escape route?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'The first and most familiar functional category of emergency lighting. Defined by BS EN 1838:2024 as illumination of escape routes for safe evacuation: 1 lx minimum across the full width at floor level (with edge exclusions: outer 0.5 m on routes > 2 m, outer ¼ width on routes ≤ 2 m), 40:1 maximum uniformity ratio, 5 second response to 50 % of rated illuminance, 3 hour standard duration.'
          }
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>High-risk task area lighting</strong> (§3) — allow safe shutdown of hazardous
              processes (machinery, hot processes, lifts mid-cycle) before evacuation. 15 lx
              minimum. Geometry: the working plane at the task.
            </li>
          </ul>
          <p>
            The three categories are independent functional answers to three distinct questions. A
            single area can fall into one, two, or all three categories simultaneously, and must
            satisfy each applicable category at every point. A wide corridor with operating
            machinery is escape route AND anti-panic AND high-risk task at the same time, and the
            layout must meet 1 lx on the route, 0.5 lx across the unobstructed area, AND 15 lx at
            the machinery — typically achieved by mixing general escape lighting with dedicated task
            luminaires.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Routes wider than 2 m</strong> — 1 lx full width at floor level, with an outer
              0.5 m strip on each side excluded. The non-excluded width must achieve 1 lx
              throughout, not just on a single centre line.
            </li>
            <li>
              <strong>Routes 2 m wide or narrower</strong> — 1 lx full width at floor level, with an
              outer ¼ width on each side excluded. A 1.6 m corridor excludes 0.4 m each side and the
              central 0.8 m must achieve 1 lx.
            </li>
            <li>
              <strong>Routes that vary in width</strong> — typical in foyers, stair landings, and
              concourses. Each section uses the exclusion appropriate to its width. A corridor that
              widens from 1.5 m to 4 m in a foyer uses ¼ width exclusions at the narrow end and 0.5
              m exclusions at the wide end.
            </li>
            <li>
              <strong>The 1 lx target is unchanged.</strong> The 2024 update did not raise the
              target — it widened where the target must be met and superseded the 2013 centre-line +
              central-band wording.
            </li>
          </ul>
          <p>
          ...
          >
            ...
            <g>
              ...
              <text x="80" y="382" fill="rgba(255,255,255,0.7)" fontSize="10">
                Closer luminaire spacing reduces ratio. Modern LED installations typically achieve
                10:1.
              </text>
              ...
              <text x="80" y="420" fill="rgba(255,255,255,0.7)" fontSize="10">
                100 % within 60 s. Duration: 3 h standard for non-domestic premises (BS
                5266-1:2025).
              </text>
            </g>
          </svg>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Emergency escape route lighting shall provide 50 % of the required illuminance within
              5 s and the full required illuminance within 60 s. The duration shall be appropriate
              to the time required for safe evacuation and shall be at least 1 h.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Straight corridor ≤ 2 m wide.</strong> 1 lx full width at floor level, with
              the outer ¼ width on each side excluded. One row of luminaires down the middle is the
              typical solution; spacing must hold the central half of the corridor at 1 lx, with
              40:1 uniformity along the route.
            </li>
            <li>
              <strong>Straight corridor &gt; 2 m wide.</strong> 1 lx full width at floor level, with
              the outer 0.5 m on each side excluded. Two rows of luminaires, or a grid layout
              matching anti-panic methodology, deliver the wider coverage.
            </li>
            <li>
              ...
              luminaires within 2 m of each top and bottom tread. The route width on a stair is the
              going (depth) of each tread; verification at floor level means at tread level, not
              landing level.
            </li>
            <li>
              <strong>Doorway / threshold.</strong> 1 lx must be maintained at the door threshold. A
              door positioned between two luminaires falls in the dimmest part of the design —
              verify specifically at the threshold, not just at the luminaire positions.
            </li>
            <li>
              <strong>Direction change (corner, junction).</strong> Each branch of the junction is a
              separate route in its own right. Each is verified to 1 lx full width with the
              appropriate edge exclusion. Junctions are also high-uniformity-ratio risk because two
              illuminance patterns superimpose; verify the corner specifically.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              escape, including changes of direction, intersections, exit doors, near each staircase
              and on each landing, in lift cars, near each fire alarm call point, near each first
              aid post and near each piece of fire-fighting equipment.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Near each staircase</strong> — within 2 m horizontally of the top and bottom
              of every flight, so each tread is directly illuminated.
            </li>
            <li>
              <strong>At each change of direction</strong> — corners, junctions, T-pieces. The point
              at which the occupant has to choose a direction.
            </li>
            <li>
              <strong>At each intersection</strong> of corridors.
            </li>
            <li>
              <strong>Outside each final exit</strong> and within 2 m of it externally — to prevent
              occupants stepping from a lit interior into a dark exterior.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>The ratio is longitudinal.</strong> Measured along the route — bright point
              under a luminaire vs darkest point between luminaires. NOT measured between rooms or
              between floors.
            </li>
            <li>
              <strong>Spacing controls the ratio.</strong> Closer luminaire spacing produces higher
              minimum (more overlap between adjacent illuminance patterns) and lower maximum (no
              single luminaire dominates), reducing the ratio.
            </li>
            <li>
              <strong>Mounting height controls the maximum.</strong> A luminaire mounted lower
              produces higher peak directly underneath it. Higher mounting smooths the maximum but
              reduces the minimum elsewhere; designers balance both.
            </li>
            <li>
              <strong>Lumen output controls the minimum.</strong> A higher-output luminaire produces
              higher minimum at the same spacing, but also higher maximum — the ratio does not
              improve unless spacing is also reduced.
            </li>
            <li>
              ...
              calculation that comes back at 35:1 is technically compliant but is a sign the spacing
              is too generous; the layout is one luminaire failure away from a 50:1 non-compliance.
            </li>
          </ul>
          <p>
            In commissioning, take spot lux readings at the brightest and darkest points along each
            route (under a luminaire and between luminaires) and confirm the ratio. Software
            simulations are usually accurate but commissioning verification catches real-world
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              (E_min/E_max) shall be not less than 1/40, equivalent to a maximum to minimum ratio of
              40:1.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>60 s to 100 %.</strong> Allows discharge lamps (sodium, mercury) to warm up.
              Pre-LED installations relied on this allowance; LED systems do not need it.
            </li>
            <li>
              <strong>High-risk task lighting tightens to 0.5 s.</strong> Where occupants may be
              operating machinery (printing presses, woodworking, hot processes) the 5 s rule fails
              — tools spinning down in darkness cause injury. §3 covers this.
            </li>
          </ul>
          <p>
            Verification of response time is part of commissioning under BS EN 50172:2024 — a
            switchover test with a stopwatch, confirming 50 % within 5 s. In service, the monthly
            functional test confirms switchover but does not measure response time quantitatively;
            the annual test does.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>1 h.</strong> Small premises with simple geometry and low occupancy, where the
              risk assessment shows evacuation will complete in well under 30 minutes and re-entry
              is not foreseeable. The basis for the 1 h figure must be documented in the logbook.
            </li>
            <li>
              <strong>Higher than 3 h.</strong> Some specialist premises (large hospitals, certain
              industrial sites) specify 8 h or longer where re-entry and continued occupation under
              power loss are anticipated. Common in life-safety critical environments.
            </li>
          </ul>
          <p>
            The duration is rated — it is the time the system delivers the minimum illuminance after
            mains failure under worst-case battery condition. End-of-life batteries lose 30-50 % of
            original capacity. A 3 h fresh system at year 4 may produce only 2 h of actual duration;
            designing for the rated value gives margin.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Inside an individual dwelling</strong> — exempt. The flat itself does not need
              BS 5266-compliant emergency lighting (though many specify it anyway for resident
              safety).
            </li>
            <li>
              <strong>Common corridor outside the front door</strong> — IN SCOPE. 1 lx escape route
              minimum, 40:1 uniformity, 5 s response, 3 h duration as default.
            </li>
            <li>
              <strong>Common staircase</strong> — IN SCOPE. Mandatory luminaire within 2 m of top
              and bottom of each flight.
            </li>
            <li>
              <strong>Common lobby / entrance hall</strong> — IN SCOPE. Often wide enough to trigger
              the full-width rule; combined with anti-panic methodology where the area exceeds 60
              m².
            </li>
            <li>
              <strong>Outside the final exit</strong> — IN SCOPE up to 2 m from the door. Occupants
              leaving a lit interior must have their first 2 m of pavement / forecourt illuminated
              to avoid stepping into total darkness.
            </li>
            <li>
            ...
            <li>
              <strong>Bin store, plant room, communal car park</strong> — depends on whether they
              form part of an escape route. A bin store accessed only via the dwelling is not in
              scope; one accessed via a fire-rated common corridor IS, because the corridor is in
              scope.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Monthly functional test.</strong> Brief mains-fail (typically 30 s). Luminaire
              lights up. Confirms the switchover relay works and the luminaire produces light. Says
              nothing about whether it would last 3 h.
            </li>
            <li>
              <strong>Annual full-duration test.</strong> Mains failed for the full rated duration
              (3 h for typical non-domestic). Battery discharged completely under load. Output
              measured at end of duration. THIS is the test that catches degradation. If output
              falls below the rated illuminance before the duration is reached, the battery has
              degraded and the luminaire fails.
            </li>
            <li>
              <strong>Self-test luminaires.</strong> Built-in microcontroller runs the monthly and
              annual tests automatically and reports results. Modern installations increasingly use
              self-test as it eliminates the manual labour of testing every luminaire and provides a
              digital record.
            </li>
          </ul>
          <p>
            Section 6 covers the testing regime in detail. The point here is that battery
            degradation is the headline reason annual testing exists — without it, the installation
            drifts into non-compliance without anyone noticing until an actual mains failure exposes
            the gap.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              duration. The illumination provided at the end of the rated duration shall be not less
              than that required by BS EN 1838. The result, including any luminaires not meeting the
              requirement, shall be recorded in the logbook.
            </>
          }
        ...
        <FAQ
          items={[
            ...
            {
              question: 'A corridor is exactly 2 m wide. Which edge exclusion applies?',
              answer:
            ...
            {
              question: 'Does emergency lighting apply inside a private dwelling (a single flat)?',
              answer:
