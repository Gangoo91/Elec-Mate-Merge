...
const inlineChecks = [
  {
    ...
    question: 'Why does Reg 421.11 + Reg 421.1.4 apply to a heat pump outdoor unit?',
    options: [
...
const quizQuestions = [
  {
    question: 'Outdoor unit siting — what clearance + thermal considerations apply?',
    options: [
...
export default function RenewableEnergyModule8Section3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 3 · BS 7671:2018+A4:2026 · Reg 421 + 422 + 522 + BS EN 60529 + BS EN 62262"
        title="Outdoor unit siting + thermal/cable protection"
        backTo="../renewable-energy-module-8"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Heat pump outdoor unit siting + cable / wiring system protection. Reg 421.11 + Reg 421.1.4
          fixed-equipment thermal protection, Reg 422.3.2 enclosure temperature limits, Reg 522.2.1
          wiring protection from external heat, IP / IK ratings (BS EN 60529 + BS EN 62262),
          condensate drainage, defrost cycle, PDR noise + clearance, outdoor isolator.
        </p>
        ...
        <Pullquote>
          The outdoor unit is fixed equipment in the open weather. Every BS 7671 protection
          regulation that applies to fixed equipment, plus every outdoor consideration, lands at
          this install.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Wall clearance</strong> — typically 200-500 mm to the
              wall behind the outdoor unit (manufacturer spec). Permits service access + airflow +
              thermal dissipation
            </li>
            <li>
              <strong className="text-white">Fan-discharge clearance</strong> — typically 1-2 m in
              front of the fan discharge. Airflow path unobstructed. Some models have top-discharge
              configuration (300-500 mm above)
            </li>
            <li>
              <strong className="text-white">Side clearance</strong> — typically 200-500 mm to
              adjacent walls / structures
            </li>
            <li>
              <strong className="text-white">Ventilation</strong> — outdoor unit must NOT be
              enclosed in a poorly ventilated shelter / box. Enclosure restricts airflow → reduces
              efficiency → potential fault shutdowns. Manufacturer specifies minimum free-area +
              airflow volume
            </li>
            <li>
              <strong className="text-white">Vibration isolation</strong>— outdoor unit typically
              mounted on anti-vibration pads / brackets. Reduces transmission of compressor
              vibration to building structure + noise transmission to occupants / neighbours
            </li>
            <li>
              <strong className="text-white">Defrost cycle thermal pulses</strong> — intermittent
              reverse-cycle operation melts frost off coil. Adjacent cable / pipework + condensate
              drainage detail designed to accommodate
            </li>
            <li>
              <strong className="text-white">Combustible material clearance</strong> — outdoor unit
              kept clear of combustible materials (Reg 422.4 CA2 conditions). Cladding, decking,
              vegetation, stored material around outdoor unit considered
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — siting drawing showing
              clearance dimensions + manufacturer spec reference + photographs at commissioning
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            422.3.2 application points where dust / fibre accumulation could cause a fire hazard:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">CU enclosure</strong> — containing heat pump 32 A RCBO
              + immersion 16 A RCBO + main RCD. Verify CU manufacturer DoC declares thermal
              compliance under loaded conditions
            </li>
            <li>
              <strong className="text-white">DHW cylinder enclosure</strong> — immersion access
              cover + cylinder shell. Verify manufacturer thermal spec — immersion + heat pump
              primary together can warm the enclosure
            </li>
            <li>
              <strong className="text-white">Outdoor isolator enclosure</strong> — exposed to direct
              sun + outdoor unit heat. UK summer ambient can be high; verify isolator manufacturer
              thermal spec for outdoor applications
            </li>
            <li>
              <strong className="text-white">Cable termination zones</strong> — at outdoor unit +
              indoor termination. Verify terminal block + cable insulation thermal compatibility per
              manufacturer
            </li>
            <li>
              <strong className="text-white">Junction boxes</strong> — where intermediate
              terminations made. Manufacturer thermal spec applies
            </li>
            <li>
              <strong className="text-white">Thermal imaging at EICR</strong> — optional but
              increasingly used at commercial sites or where surface temperature concern raised.
              EICR-grade FLIR camera. Cert evidence bundle records images + max surface temperatures
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          The outdoor cable is in the British weather for the install’s entire life. SWA +
          gland-sealed entry + appropriate IP rating is not optional — it is the baseline.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Primary flow / return pipework</strong> — 35-55 °C
              typical for heat pump systems. Method (b) distance from cable + (a) shielding if cable
              run forced close. Avoid clipping cable directly against insulated pipework
            </li>
            <li>
              <strong className="text-white">Outdoor unit body proximity</strong> — compressor +
              outdoor coil generate heat. Cable routed away from compressor body via cable
              management built into the unit; entry through factory-provided gland points
            </li>
            <li>
              <strong className="text-white">DHW cylinder cupboard</strong> — restricted ventilation
              + warm-air accumulation from cylinder + immersion + circulation pumps. Cable in the
              cupboard runs at elevated ambient temperature — Method (c) cable rated for the
              expected ambient
            </li>
            <li>
              <strong className="text-white">Loft / roof void</strong> — summer ambient can exceed
              50 °C in poorly ventilated lofts. Cable sized per Appendix 4 for high ambient
              temperature (correction factor Ca per Table 4B1)
            </li>
            <li>
              <strong className="text-white">Through-wall penetration</strong> — cable in conduit /
              sleeved penetration; fire-stopping per Reg 527 + Building Regs Part B
            </li>
            <li>
              <strong className="text-white">Cable in contact with cavity insulation</strong> —
              cavity wall insulation can elevate conductor temperature; Reg 522.2 + Table 4B
              requires thermal sleeve or rated cable
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — cable route survey +
              heat source proximity per zone + chosen protection method + Appendix 4 sizing +
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">IP first digit</strong> — solid object protection 0-6
              (6 = dust-tight; X = unspecified). Outdoor unit typically X (rated by second digit
              only) or 4-5
            </li>
            <li>
              <strong className="text-white">IP second digit</strong>— water ingress 0-9. 4 = splash
              from any direction (standard outdoor domestic); 5 = water jet; 6 = powerful water jet;
              7 = temporary submersion. UK 2025-26 typical outdoor unit IPX4
            </li>
            <li>
              <strong className="text-white">IK rating</strong> — impact resistance per BS EN 62262.
              IK07 = 5 J impact (standard outdoor domestic); IK10 = 20 J (high-impact /
              vandalism-prone)
            </li>
            <li>
              <strong className="text-white">Outdoor unit baseline</strong> — IPX4 / IK07 typical
              for UK 2025-26 domestic ASHP (Vaillant aroTHERM Plus, Mitsubishi Ecodan, Daikin
              Altherma 3 H, NIBE F2120 — all IPX4 minimum)
            </li>
            <li>
              <strong className="text-white">Outdoor isolator selection</strong> — typically Hager
              JK series or similar; IPX4 / IK07 typical; IP66 / IK10 premium for exposed locations
            </li>
            <li>
              <strong className="text-white">Cable gland selection</strong> — metric brass glands
              with rubber sealing washers + neoprene sleeves matched to cable diameter. Maintains IP
              rating across the enclosure boundary
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — outdoor unit IP / IK
              from manufacturer DoC + outdoor isolator product spec + gland model + commissioning
              visual inspection
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">SWA cable type</strong> — steel-wire-armoured cable,
              outer LSF / PVC sheath, copper conductors. Mechanical protection from physical damage
              + UV / weather resistance + armour as CPC where designed
            </li>
            <li>
              <strong className="text-white">Cross-section</strong> — 10 mm² 3-core for single-phase
              32 A circuit (typical UK 2025-26 ASHP up to 12 kW thermal). 6 mm² 5-core for
              three-phase 16 A per phase. Larger sizes for longer runs / higher current
            </li>
            <li>
              <strong className="text-white">CPC arrangement</strong> — armour as CPC per Reg 543
              (provided armour adequately sized + connected at both ends) OR separate green-yellow
              CPC conductor. Manufacturer DoC confirms armour cross-section meets CPC requirements
            </li>
            <li>
              <strong className="text-white">Gland-sealed entry</strong> — brass gland + sealing
              washer + neoprene sleeve at both enclosures (indoor termination + outdoor unit).
              Maintains IP rating
            </li>
            <li>
              <strong className="text-white">Outdoor isolator</strong>— BS EN 60947-3 rotary
              isolator. IPX4 / IK07 enclosure minimum. Visible break window. Padlock-hole for
              lockable OFF. 32 A or 40 A rated typical (single-phase); 32 A 4-pole (three-phase)
            </li>
            <li>
              <strong className="text-white">Isolator position</strong>— 1-2 m from outdoor unit,
              1-1.5 m mounting height for accessibility. Used for safe isolation during service /
              maintenance / refrigerant work
            </li>
            <li>
              <strong className="text-white">Reg 537 isolation framework</strong> — isolator is an
              isolating device per Reg 537. Visible break + lockable OFF + clear marking confirm
              isolation
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — cable type +
              cross-section + length + route + gland + isolator product + IP / IK + commissioning
              visible-break + lockable-OFF verification
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-8-section-4')}
