...
const inlineChecks = [
  ...
  {
    id: 'm8s6-554-2-x',
    question: 'Which BS 7671 Section / Reg covers the immersion electrical install?',
    options: [
  ...
  {
    id: 'm8s6-dual-coil',
    question: 'What is a dual-coil DHW cylinder + why is it used with heat pumps?',
    options: [
  ...
  },
  {
    ...
    question: 'How does the heat pump control coordinate compressor + immersion?',
    options: [
...
const quizQuestions = [
  {
    question: '3 kW immersion in a 200 L unvented cylinder — what circuit design?',
    options: [
  ...
  {
    question: 'Dual-coil DHW cylinder — what does the electrical installer need to wire?',
    options: [
  ...
  {
    question: 'Why does Reg 554.2.1 thermal cut-out matter for immersion safety?',
    options: [
  ...
  {
    question: 'Legionella cycle — what is the BS 7671 framework + how is it managed?',
    options: [
...
export default function RenewableEnergyModule8Section6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 6 · BS 7671:2018+A4:2026 · Section 554 + Reg 415.1.1 + Reg 314 + HSE HSG274"
        title="Backup immersion + DHW cylinder integration"
        backTo="../renewable-energy-module-8"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Hot Water Cylinder backup immersion element — Reg 554.2 / 554.2.1 / 554.3 (heaters for
          liquids having immersed heating elements), 30 mA RCD per Reg 415.1.1, dedicated 16 A
          circuit per Reg 314, dual-coil cylinder pattern, heat-pump-priority logic, legionella
          cycle per HSE HSG274 / HSG L8, thermal cut-out, control wiring.
        </p>
        ...
        <Pullquote>
          The immersion is the backup, not the primary. Heat pump COP ~3, immersion COP 1. Customer
          confusion on this point is the most expensive operational mistake on a heat pump install.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Boost</strong> — supplements heat pump during high DHW
              demand (multiple showers in a row) or low outdoor temperature when heat pump COP drops
              + compressor cannot keep up with demand
            </li>
            <li>
              <strong className="text-white">Legionella cycle</strong>— periodic (typically weekly
              off-peak) cycle raising DHW to ≥60 °C briefly. Kills Legionella pneumophila bacteria
              per HSE HSG274 + ACOP L8. Heat pump alone may not reliably reach 60 °C in cold weather
            </li>
            <li>
              <strong className="text-white">Fault fallback</strong> — if compressor / refrigerant
              fault detected, controller switches to immersion-only operation. Customer notified via
              display / app. DHW (and space heating with controls re-config) maintained until repair
            </li>
            <li>
              <strong className="text-white">Typical specification</strong> — 3 kW element, 1¾" BSP
              fitting, factory-fitted in the cylinder by the cylinder manufacturer
            </li>
            <li>
              <strong className="text-white">Dedicated 16 A circuit</strong> — Type A RCBO C-curve +
              30 mA additional protection + 2.5 mm² T+E. Reg 314 dedicated circuit pattern
            </li>
            <li>
              <strong className="text-white">Not primary heating</strong> — heat pump COP ~3;
              immersion COP 1. Immersion is the BACKUP / BOOST / LEGIONELLA solution — customer
              education is part of handover
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — immersion circuit EIC +
              Section 554 verification + functional test + customer handover documentation
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 554.2.1</strong> — every heater for liquid or other
              substance shall incorporate or be provided with an automatic device to prevent a
              dangerous rise in temperature. THIS IS THE THERMAL CUT-OUT — mandatory
            </li>
            <li>
              <strong className="text-white">Reg 554.3</strong> — water heaters having immersed and
              uninsulated heating elements — additional requirements (typically integrated into
              modern cylinder design by manufacturer)
            </li>
            <li>
              <strong className="text-white">Reg 554.3.1</strong> — every single-phase water heater
              with uninsulated immersed element shall comply with regulations referenced. Standard
              immersion fits this category
            </li>
            <li>
              <strong className="text-white">Thermal cut-out function</strong> — trips at ~80-90 °C
              cylinder temperature; isolates immersion electrical supply; manual reset required
              (deliberate intervention to investigate root cause)
            </li>
            <li>
              <strong className="text-white">Trip causes</strong> — thermostat failure (stuck-closed
              contacts); thermostat sensor failure; blocked outlet causing temperature build-up;
              fault condition
            </li>
            <li>
              <strong className="text-white">Functional test at commissioning</strong> — deliberate
              overheat with thermostat bypassed in controlled condition; verify cut-out trips at the
              manufacturer-declared temperature; reset; restore normal operation
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — cylinder manufacturer
              DoC + thermal cut-out spec + functional test result + reset procedure documented for
              handover
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Dual-coil cylinder + heat-pump-priority logic + scheduled legionella cycle: three elements
          turning the immersion from primary heating into smart backup.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Lower coil (heat pump primary)</strong> — large surface
              area heat exchanger near the bottom of the cylinder. Optimised for low temperature
              heat pump primary flow (35-55 °C). Heat pump returns slightly cooler primary water;
              coil heats the cylinder gradually
            </li>
            <li>
              <strong className="text-white">Upper coil (boiler or future)</strong> — second heat
              exchanger near the top. Available for legacy boiler integration (hybrid configuration)
              or for future system upgrade. May be unused on a pure-heat-pump install
            </li>
            <li>
              <strong className="text-white">Immersion at top</strong> — single 3 kW element
              factory-fitted near the top of the cylinder. Boosts the top of the cylinder where the
              DHW outlet draws
            </li>
            <li>
              <strong className="text-white">Stratification</strong>— hot water rises; heat pump
              heats the bulk; immersion boosts the top. DHW draw comes from the top — customer
              always gets the hottest water even during cylinder warm-up
            </li>
            <li>
              <strong className="text-white">Cylinder thermostat(s)</strong> — typically one or two
              thermostats: one control thermostat for the heat pump primary coil cycle; one control
              thermostat for the immersion. Sensors mounted at specific cylinder heights for
              stratification-aware control
            </li>
            <li>
              <strong className="text-white">Capacity</strong> — 200-300 L typical for UK 2025-26
              domestic (versus 90-120 L for legacy combi boiler indirect cylinders). Larger cylinder
              buffers low-temperature heat pump output
            </li>
            <li>
              <strong className="text-white">Typical UK 2025-26 brands</strong> — Mixergy (smart
              cylinders with stratification control); Telford Tempest (mainstream unvented
              dual-coil); OSO Saga / Optima (Norwegian); Joule (Irish, mainstream); Stiebel Eltron
              WPF (German integrated heat pump + cylinder)
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — cylinder model +
              manufacturer DoC + electrical connection diagram + immersion circuit EIC
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">State 1: Heat pump only</strong> — normal operation.
              Compressor runs as needed; immersion off. Most efficient mode; lowest electricity bill
            </li>
            <li>
              <strong className="text-white">State 2: Heat pump + immersion (boost)</strong> —
              controller detects high DHW demand or low outdoor temperature reducing heat pump
              capacity. Immersion activates supplementally. Both running briefly; immersion
              deactivates when demand met
            </li>
            <li>
              <strong className="text-white">State 3: Scheduled legionella cycle</strong> —
              typically weekly at off-peak hours. Compressor + immersion coordinated to raise
              cylinder to ≥60 °C briefly. Returns to State 1
            </li>
            <li>
              <strong className="text-white">State 4: Fault fallback (immersion only)</strong> —
              compressor / refrigerant fault detected. Controller switches to immersion-only for DHW
              + space heating (with controls re-config). Customer notified
            </li>
            <li>
              <strong className="text-white">State 5: Customer override</strong> — customer can
              manually request immersion-only via controller (e.g. for high-demand event). NOT
              recommended for routine use — much higher electricity bill
            </li>
            <li>
              <strong className="text-white">Verification at commissioning</strong> — exercise each
              state: compressor only, compressor + immersion (force boost mode), scheduled
              legionella cycle (manually trigger), fault simulation (disconnect refrigerant signal),
              customer override
            </li>
            <li>
              <strong className="text-white">Customer handover documentation</strong> — explain each
              state + when to expect each + when NOT to override (immersion-only mode is expensive)
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — control configuration +
              verification results + handover documentation reference
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">HSE HSG274 + ACOP L8</strong> — UK statutory framework
              under Health + Safety at Work Act 1974. Risk assessment per BS 8580. Relevant to
              domestic + commercial DHW systems
            </li>
            <li>
              <strong className="text-white">Legionella pneumophila</strong> — bacterium that can
              colonise stagnant warm water. Causes Legionnaires’ disease. Kill rate: ≥60 °C in 1-2
              min; 50-60 °C significant kill over hours; below 50 °C growth possible
            </li>
            <li>
              <strong className="text-white">Heat pump challenge</strong> — efficient heat pump
              operates primary flow 35-55 °C. Cylinder may not reliably reach 60 °C without backup
              heat. Legionella growth risk
            </li>
            <li>
              <strong className="text-white">Weekly cycle mitigation</strong> — schedule legionella
              cycle at off-peak (typical 02:00 Monday). Compressor + immersion coordinated to raise
              cylinder to ≥60 °C briefly (typically 1-2 hours)
            </li>
            <li>
              <strong className="text-white">Setpoint</strong> — typically 60-65 °C cylinder
              temperature, sustained 1-2 hours minimum. Some installations use higher (70 °C) for
              extra safety margin
            </li>
            <li>
              <strong className="text-white">Frequency</strong> — weekly is typical; some commercial
              / vulnerable-occupant installs run daily or twice-weekly
            </li>
            <li>
              <strong className="text-white">Verification at service visits</strong> — temperature
              probe at cylinder outlet during legionella cycle; verify setpoint achieved + sustained
            </li>
            <li>
              <strong className="text-white">Override for service visits</strong> — temporary
              disable when occupants might be away (legionella growth low if no warm water draw);
              re-enable on resumption
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — legionella cycle
              configuration (setpoint + duration + frequency) + verification result + handover
              documentation
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-8-section-5')}
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-8-section-7')}
