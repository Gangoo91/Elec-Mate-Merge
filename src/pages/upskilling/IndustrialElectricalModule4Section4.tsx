    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-10 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-white/10">
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <span className="text-sm text-muted-foreground">Module 4 &gt; Section 4</span>
        </div>
      </header>
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="text-center space-y-4">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-elec-yellow/10">
            <Network className="w-8 h-8 text-elec-yellow" />
          </div>
        ...
        <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
          ...
          <ul className="text-sm text-muted-foreground space-y-1">
            <li>- Fieldbus vs Industrial Ethernet comparison</li>
            <li>- Modbus RTU and TCP/IP fundamentals</li>
            <li>- PROFIBUS DP and PROFINET configuration</li>
            <li>- EtherNet/IP and EtherCAT implementation</li>
            <li>- Network topology and wiring requirements</li>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground flex items-center gap-3">
            ...
            Fieldbus vs Industrial Ethernet Overview
          </h2>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-4">
              <div className="bg-background/50 rounded-lg p-4">
                <h4 className="font-medium text-blue-400 mb-2">Traditional Fieldbus</h4>
                <ul className="text-muted-foreground text-sm space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                    <span>Specialised cables and connectors</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
              ...
              <div className="bg-background/50 rounded-lg p-4">
                <h4 className="font-medium text-green-400 mb-2">Industrial Ethernet</h4>
                <ul className="text-muted-foreground text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-background/50 rounded-lg p-4">
              <h4 className="font-medium text-elec-yellow mb-3">Protocol Comparison Table</h4>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-white/10">
                      <th className="text-left py-2 px-2 text-muted-foreground">Protocol</th>
                      <th className="text-left py-2 px-2 text-muted-foreground">Type</th>
                      <th className="text-left py-2 px-2 text-muted-foreground">Max Speed</th>
                      <th className="text-left py-2 px-2 text-muted-foreground">Max Nodes</th>
                      <th className="text-left py-2 px-2 text-muted-foreground">Typical Use</th>
                    </tr>
                  </thead>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground flex items-center gap-3">
            ...
            Modbus RTU and TCP/IP Fundamentals
          </h2>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <div className="bg-background/50 rounded-lg p-4 mb-4">
              <h4 className="font-medium text-green-400 mb-3">Modbus Function Codes</h4>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-white/10">
                      <th className="text-left py-2 px-2 text-muted-foreground">Code</th>
                      <th className="text-left py-2 px-2 text-muted-foreground">Function</th>
                      <th className="text-left py-2 px-2 text-muted-foreground">Data Type</th>
                      <th className="text-left py-2 px-2 text-muted-foreground">Access</th>
                    </tr>
                  </thead>
                  <tbody className="text-muted-foreground">
                    <tr className="border-b border-white/5">
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <div className="bg-background/50 rounded-lg p-4 mb-4">
              <h4 className="font-medium text-purple-400 mb-3">PROFIBUS DP Specifications</h4>
              <div className="grid md:grid-cols-2 gap-4 mb-4">
                <div>
            ...
            <div className="bg-background/50 rounded-lg p-4 mb-4">
              <h4 className="font-medium text-green-400 mb-3">PROFINET Overview</h4>
              <p className="text-muted-foreground text-sm mb-3">
                PROFINET uses standard Ethernet infrastructure with three performance classes:
              </p>
              <div className="grid md:grid-cols-3 gap-3">
                <div className="bg-background rounded p-3">
                  <h5 className="font-medium text-blue-400 mb-2 text-sm">NRT (Non-Real-Time)</h5>
                ...
                <div className="bg-background rounded p-3">
                  <h5 className="font-medium text-green-400 mb-2 text-sm">RT (Real-Time)</h5>
                  <ul className="text-muted-foreground text-xs space-y-1">
                    <li>- Prioritised Ethernet frames</li>
                    <li>- 1-10ms cycle time</li>
                    <li>- Standard I/O applications</li>
                  </ul>
                </div>
                <div className="bg-background rounded p-3">
                  <h5 className="font-medium text-orange-400 mb-2 text-sm">IRT (Isochronous RT)</h5>
                  <ul className="text-muted-foreground text-xs space-y-1">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground flex items-center gap-3">
            ...
            Network Topology and Wiring Requirements
          </h2>

          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            <h3 className="font-medium text-foreground mb-3 flex items-center gap-2">
              <Router className="w-5 h-5 text-elec-yellow" />
              Physical Network Design
            </h3>

            <div className="grid md:grid-cols-2 gap-4 mb-4">
              <div className="bg-background/50 rounded-lg p-4">
                <h4 className="font-medium text-blue-400 mb-3">Serial Bus Topology</h4>
                <p className="text-muted-foreground text-sm mb-3">
              ...
              <div className="bg-background/50 rounded-lg p-4">
                <h4 className="font-medium text-green-400 mb-3">Ethernet Topology Options</h4>
                <p className="text-muted-foreground text-sm mb-3">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-white/10">
                      <th className="text-left py-2 px-2 text-muted-foreground">Protocol</th>
                      <th className="text-left py-2 px-2 text-muted-foreground">Cable Type</th>
                      <th className="text-left py-2 px-2 text-muted-foreground">Impedance</th>
                      <th className="text-left py-2 px-2 text-muted-foreground">Max Length</th>
                    </tr>
                  </thead>
                  <tbody className="text-muted-foreground">
                    <tr className="border-b border-white/5">
                      ...
                      <td className="py-2 px-2">120 ohms</td>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <div className="bg-background/50 rounded-lg p-4 mb-4">
              <h4 className="font-medium text-blue-400 mb-3">Essential Diagnostic Tools</h4>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
            ...
            <div className="bg-background/50 rounded-lg p-4 mb-4">
              <h4 className="font-medium text-orange-400 mb-3">Common Problems and Solutions</h4>
              <div className="space-y-3">
                ...
                <div className="bg-background rounded p-3">
                  ...
                  <ul className="text-muted-foreground text-sm space-y-1 ml-6">
                    ...
                    <li>- Optimise data packet sizes</li>
        ...
        <section className="bg-gradient-to-br from-elec-yellow/10 to-elec-yellow/5 rounded-lg p-6 border border-elec-yellow/30">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-xl font-bold text-foreground">Quick Reference Card</h2>
          </div>

          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-semibold text-foreground mb-3 border-b border-white/10 pb-1">
                Modbus RTU Defaults
              </h3>
              <ul className="text-muted-foreground text-sm space-y-1">
                <li>- Baud: 9600 | Data: 8 | Parity: Even | Stop: 1</li>
                <li>- Address Range: 1-247 (0 = broadcast)</li>
                <li>- Termination: 120 ohms at both ends</li>
                <li>- Max Distance: 1200m @ 9600 baud</li>
                <li>- Common Registers: 40001-49999 (holding)</li>
              </ul>

              <h3 className="font-semibold text-foreground mb-3 mt-4 border-b border-white/10 pb-1">
                PROFIBUS DP Quick Facts
              </h3>
              <ul className="text-muted-foreground text-sm space-y-1">
                <li>- Cable: Purple shielded, 150 ohms impedance</li>
            ...
            <div>
              ...
              <ul className="text-muted-foreground text-sm space-y-1">
                ...
                <li>- Test with protocol analyser if available</li>
              </ul>
            </div>
          </div>
        </section>
