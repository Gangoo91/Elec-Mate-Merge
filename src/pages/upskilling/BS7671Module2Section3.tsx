...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'AFDD stands for Arc Fault Detection Device. It detects dangerous arcing conditions that traditional protective devices cannot sense, helping prevent fires caused by damaged cables or poor connections.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Functional earthing is used for equipment operation (like signal integrity or EMI suppression), while protective earthing is specifically for safety.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Amendment 3 requires bidirectional protective devices specifically for prosumer installations that have renewable generation or energy storage capabilities.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Smart home systems and other installations with sensitive electronic equipment that could be affected by electromagnetic interference.',
  },
  {
    question: 'Why were new definitions introduced in Amendment 2?',
    answer:
      'Amendment 2 introduced new definitions to address technological developments like smart homes, renewable energy, and emerging safety challenges.',
  },
  {
    question: 'What is a prosumer installation?',
    answer:
      'An electrical installation that both consumes and produces electrical energy, typically through renewable sources like solar PV.',
  },
];
...
const quizQuestion = {
  ...
  correctAnswer: 1,
  explanation:
    'Amendment 3 focuses on bidirectional protection to manage reverse current flows from renewable energy sources like solar PV and energy storage systems.',
};
...
const BS7671Module2Section3 = () => {
  useSEO({
    ...
    description:
      'Learn new definitions from BS 7671 Amendment 2 & 3 including AFDD, PEI, Functional Earthing, and bidirectional protection terminology for renewable energy systems.',
  });
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>AFDD:</strong> Detects arc faults to prevent fires
              </li>
              <li>
                <strong>PEI:</strong> EMI protection for smart systems
              </li>
              <li>
                <strong>Bidirectional:</strong> Required for prosumer installations
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Amendment 2:</strong> Smart systems, AFDD terminology
              </li>
              <li>
                <strong>Amendment 3:</strong> Effective 31st July 2024
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Arc Fault Detection Devices (AFDDs) represent a significant advancement in electrical
              fire prevention. They detect dangerous arcing conditions that traditional MCBs and
              RCDs cannot identify, providing enhanced protection against electrical fires.
            </p>
            ...
            <div className="p-4 rounded-lg bg-transparent border border-red-500/30 my-6">
              ...
              <p className="text-xs text-white mb-2">
                AFDDs use sophisticated algorithms to distinguish between:
              </p>
              ...
              <p className="text-xs text-white mt-2">
                When a dangerous arc is detected, the AFDD disconnects the circuit within
                milliseconds.
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-transparent border border-white/10 my-6">
              ...
              <div className="grid grid-cols-3 gap-4 text-xs">
                <div>
                  ...
                  <p>
                    Detects overcurrent and short circuits but cannot sense dangerous arcing at
                ...
                <div>
                  ...
                  <p>
                    Detects earth leakage currents but parallel arcs may not create sufficient
                    imbalance to trip
                  </p>
                </div>
                <div>
                  ...
                  <p>
                    Specifically designed to detect the unique signatures of dangerous arcing
                    conditions
                  </p>
                </div>
              </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Installation Requirements (Amendment 2):
              </p>
              <ul className="text-sm text-white space-y-1">
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              PEI addresses the growing need to protect sensitive electronic equipment from
              electromagnetic interference (EMI) in modern smart installations. It's a specialised
              form of equipotential bonding designed for signal integrity rather than basic
              electrical safety.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Functional Earthing is earthing required for proper operation of electrical equipment,
              distinct from protective earthing which is required for safety. This definition
              clarifies the different purposes of earthing connections in modern installations.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Amendment 3, effective from 31st July 2024, introduces critical terminology for
              bidirectional protection in renewable energy and prosumer installations. These
              definitions address the unique challenges of managing reverse current flows from
              generation sources.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div className="p-4 rounded-lg bg-transparent border border-green-500/30">
                ...
                <p className="text-xs text-white mb-2">
                  A protective device that can interrupt fault currents flowing in both directions
                  through the device.
                </p>
                <ul className="text-xs space-y-0.5">
              ...
              <div className="p-4 rounded-lg bg-transparent border border-elec-yellow/30">
                ...
                <p className="text-xs text-white mb-2">
                  An electrical installation that both consumes and produces electrical energy.
                </p>
                <ul className="text-xs space-y-0.5">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-transparent border border-orange-500/30">
              <p className="text-sm font-medium text-orange-400 mb-3">
                Modern Net-Zero Smart Home (2024)
              </p>
              <div className="text-sm space-y-3">
                <p>
                  <strong>Project:</strong> A new-build family home meeting 2024 building
                  regulations with smart automation, 8kW solar PV, 13.5kWh battery storage, and EV
                  charging. Must comply with both Amendment 2 and Amendment 3.
                </p>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="text-xs space-y-0.5">
                      <li>
                        • <strong>AFDD protection:</strong> Socket circuits in timber frame sleeping
                        areas
                      </li>
                      <li>
                        • <strong>PEI implementation:</strong> Smart hub protected from inverter EMI
                      </li>
                      <li>
                        • <strong>Functional earthing:</strong> Signal reference for home automation
                      </li>
                      <li>
                        • <strong>Smart installation:</strong> Integrated energy management
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="text-xs space-y-0.5">
                      <li>
                        • <strong>Bidirectional protection:</strong> For solar PV with grid export
                      </li>
                      <li>
                        • <strong>Prosumer installation:</strong> Consumes and exports energy
                      </li>
                      <li>
                        • <strong>Grid interaction safety:</strong> Bidirectional RCBO
                      </li>
                      <li>
                        • <strong>DNO coordination:</strong> G98 compliance
                      </li>
                    </ul>
                  </div>
                </div>
