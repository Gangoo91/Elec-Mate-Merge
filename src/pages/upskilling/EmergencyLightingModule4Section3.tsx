...
const quizQuestions = [
  {
    id: 1,
    question:
      'What is the standard minimum autonomy duration for emergency lighting in a UK non-domestic building per BS 5266-1:2025?',
    options: [
  ...
  },
  {
    id: 2,
    question:
      'A central battery system supplies emergency luminaires totalling 240 W of emergency load for a 3-hour duration at 24 V dc nominal. Ignoring efficiency and ageing, what is the basic battery capacity in Ah?',
    options: ['30 Ah.', '10 Ah.', '24 Ah.', '72 Ah.'],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 3,
    question:
      'Why is an ageing factor of typically 1.25 applied to the calculated battery capacity?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'What is the maximum recharge time specified by BS EN 50171:2021 / BS EN 50172:2024 after a full discharge?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'Which battery chemistry is most commonly used in self-contained emergency luminaires in UK installations as at 2026?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'A self-contained emergency luminaire has an SLA battery date label showing manufacture in 2022, never changed. As at 2026, what is the correct maintenance action?',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'What does the BS 5266-1:2025 5-year photometric requirement add, beyond the traditional load × duration battery sizing?',
    options: [
  ...
  },
  {
    id: 9,
    question:
      'A 24 V central battery system is sized for 200 W load for 3 hours. Including 90% inverter efficiency and a 1.25 ageing factor, what is the specified Ah?',
    options: ['25 Ah.', '20 Ah.', '34.7 Ah.', '60 Ah.'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 10,
    question:
      'What distinguishes maintenance-free (sealed) from maintainable (vented) batteries in central battery systems?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The battery is the energy store that powers the emergency lighting from mains failure to
          evacuation complete. Sizing it correctly is engineering: load × duration × efficiency ×
          ageing factor, with end-of-discharge voltage as the operating floor. Get any of those
          wrong and the battery passes commissioning then fails its duration test in service.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              autonomy is disproportionate to the risk. Should not be the default; must be
              justified.
            </li>
            <li>
          ...
          <p>
            ...
            scale accordingly. The temptation to under-spec duration to save cost is real and must
            be resisted unless the risk assessment honestly supports the shorter time.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            Charger sizing: must recharge 50 Ah from full discharge to ≥ 80% within 24 h. That means
            at least 50 × 0.8 / 24 = 1.67 A continuous charging current at fully discharged terminal
            voltage, plus losses. A 3-4 A charger (typical for a 50 Ah cabinet) handles this with
            margin.
          </p>
          <p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          <h4 className="text-sm font-bold text-white mb-4">
            Battery sizing flow — worked example: 40 × 6 W luminaires, 3 h autonomy, 24 V central
            battery
          </h4>
          <svg
            viewBox="0 0 880 480"
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="150" y="84" textAnchor="middle" fill="#22C55E" fontSize="11" fontWeight="bold">
              1 · Total emergency load
            </text>
            <text x="150" y="106" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="10">
              P = N × Pn
            </text>
            <text x="150" y="124" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              40 × 6 W = 240 W
            </text>
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="430" y="84" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              2 · Basic ampere-hours
            </text>
            <text x="430" y="106" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="10">
              Ah = (P × t) / V
            </text>
            <text x="430" y="124" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              (240 × 3) / 24 = 30 Ah
            </text>
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="720" y="84" textAnchor="middle" fill="#22D3EE" fontSize="11" fontWeight="bold">
              3 · Apply efficiency
            </text>
            <text x="720" y="106" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="10">
              Ah / η where η = 0.9
            </text>
            <text x="720" y="124" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              30 / 0.9 = 33.33 Ah
            </text>
            ...
            <text x="720" y="256" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="10">
              × 1.25 (SLA, 4 yr life)
            </text>
            <text x="720" y="274" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              33.33 × 1.25 = 41.67 Ah
            </text>
            ...
            <text
              ...
              fontWeight="bold"
            >
              5 · Round up to standard
            </text>
            <text x="430" y="256" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="10">
              Specify next standard ≥ Cmin
            </text>
            <text
              x="430"
              y="274"
            ...
            <text
              ...
              fontWeight="bold"
            >
              Charger requirement (BS EN 50171:2021)
            </text>
            <text x="440" y="366" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="10">
              Recharge to ≥ 80% rated capacity within 24 hours of full discharge
            </text>
            <text x="440" y="384" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              50 Ah × 0.8 / 24 h = 1.67 A continuous → typical 3-4 A charger with margin
            </text>

            {/* Footnote */}
            <text x="440" y="440" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9.5">
              Formula: Cmin = (P × t) / (V × η) × ageing factor Where: P = load (W), t = duration
              (h), V = nominal voltage (V), η = efficiency
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              lead-acid 6-cell battery, 24 V for two in series, 48 V for four. Lithium-ion
              equivalents use different cell counts to reach similar nominal voltages.
            </li>
            <li>
            ...
            <li>
              ...
              not discharge to avoid permanent damage. Typically 1.75-1.80 V/cell for SLA (so
              10.5-10.8 V for a 12 V battery, or 21-21.6 V for a 24 V system). Lithium-ion
              equivalents around 2.5-2.7 V/cell. The cabinet/luminaire low-voltage cut-off enforces
              this.
            </li>
            <li>
              ...
              discharging at higher currents or to higher cut-off voltages reduces effective
              capacity.
            </li>
          </ul>
          <p>
            ...
            calculation accounts for this; a casual one does not, and the battery falls short on its
            duration test.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              or module level. Monitors voltage, current, temperature, cell balance. Cabinet charger
              is integrated with BMS protocol. More complex than SLA charging.
            </li>
            <li>
            ...
            <li>
              ...
              stable than NMC. BS EN 50171:2021 requires appropriate cell protection and BMS for the
              chosen chemistry.
            </li>
          </ul>
          <p>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Nickel-cadmium (NiCd).</strong> Long service life (15-20 years possible), very
              wide temperature tolerance, robust under abuse. Used in extreme-temperature
              ...
              directives), higher capital cost, lower energy density than lithium-ion. Largely being
              phased out of mainstream emergency lighting; persists in specific niches.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              capacity test result. Track capacity vs age. A battery passing capacity at year 1 is
              normal; one passing marginally at year 3 is approaching end-of-life.
            </li>
            <li>
            ...
            <li>
              <strong>At year design-life (e.g. year 4 for SLA).</strong> Replace battery whether or
              not it has technically failed a test. Capacity is declining and the next test cycle is
              at risk. Proactive replacement avoids reactive failures.
            </li>
            <li>
          ...
          <p>
            ...
            environments halving life). Capacity test without date label misses planning — you know
            it failed but you did not see it coming. Both together gives a managed maintenance
            regime.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              installation shall be subject to a photometric verification at intervals not exceeding
              5 years, confirming that the luminaires deliver the design illuminance values
              specified in BS EN 1838 for escape route, open area, and high-risk task areas. The
              photometric verification shall be documented and retained.
            </>
          }
        ...
        <FAQ
          items={[
            ...
            {
              question:
                'Can I use a battery rated for cyclic duty in an emergency lighting application?',
              answer:
            ...
            {
              question:
                'How does the new BS 5266-1:2025 5-year photometric check relate to battery sizing?',
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() =>
              navigate('/electrician/upskilling/emergency-lighting-module-4-section-4')
            }
