      ...
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>• CIBSE TM46 provides UK energy benchmarks</li>
              <li>• DEC ratings show A-G performance scale</li>
              <li>• Degree days normalise for weather</li>
              <li>• DUoS charges vary by time of day</li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-white/5 border-l-2 border-white/30">
            ...
            <ul className="text-sm text-white/70 space-y-1">
              ...
              <li>• Identify cost optimisation opportunities</li>
            </ul>
          </div>
        </div>
        ...
        <section className="space-y-6">
          <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-3">
            ...
            CIBSE TM46 and Display Energy Certificate Benchmarks
          </h2>
        ...
        <section className="space-y-6">
          <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-3">
            ...
            kWh/m² Normalisation and Degree Day Correction
          </h2>
        ...
        <section className="space-y-6">
          <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-3">
            ...
            Typical Consumption Benchmarks by Building Type
          </h2>
        ...
        <section className="space-y-6">
          <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-3">
            ...
            Understanding UK Electricity Tariff Structures
          </h2>
        ...
        <section className="space-y-6">
          <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-3">
            ...
            Identifying Tariff Optimisation Opportunities
          </h2>
        ...
        <section className="space-y-6">
          <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-3">
            ...
            Creating Meaningful Comparisons for Clients
          </h2>
