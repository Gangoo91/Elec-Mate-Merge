          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                ...
                <p className="text-white text-xs mb-2">Individual room or area control</p>
              ...
              <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                ...
                <p className="text-white text-xs mb-2">Central system discharge control</p>
                <ul className="space-y-1 text-white text-sm">
                  <li className="flex items-start gap-2">
            ...
            <div className="bg-white/5 rounded-lg p-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="bg-white/5 rounded p-3">
                  ...
                  <p className="text-white text-xs">Modulates air flow based on demand</p>
                </div>
                <div className="bg-white/5 rounded p-3">
                  <p className="text-white font-medium text-sm">Demand-Based Ventilation</p>
                  <p className="text-white text-xs">CO2-based fresh air control</p>
                </div>
                <div className="bg-white/5 rounded p-3">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4">
                ...
                <p className="text-white text-xs mb-2">Variable air volume and pressure</p>
                <ul className="space-y-1 text-white text-xs">
              ...
              <div className="bg-purple-500/10 border border-purple-500/20 rounded-lg p-4">
                ...
                <p className="text-white text-xs mb-2">Flow and pressure applications</p>
                <ul className="space-y-1 text-white text-xs">
