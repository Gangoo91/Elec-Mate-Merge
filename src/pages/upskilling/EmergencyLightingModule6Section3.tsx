...
const inlineChecks = [
  {
    ...
    options: [
      'A written fire safety policy statement for the premises, on its own.',
      'A suitable and sufficient written fire risk assessment, of which emergency lighting is one general fire precaution.',
      'An annual electrical test of the fixed wiring installation only.',
      'A periodic audit of the escape-route signage only.',
    ],
    correctIndex: 1,
    explanation:
      'RRO 2005 Article 9 requires the responsible person to make a suitable and sufficient written assessment of fire risk, identify general fire precautions, and review it when it may no longer be valid or after a significant change. Emergency lighting is a general fire precaution within Article 9 — the FRA must consider escape routes, sleeping risk, mobility-impaired occupants, external assembly point illumination and any high-risk task lighting. The FRA outputs feed directly into the BS 5266-1:2025 design-and-installation record.',
  },
  {
    id: 'elm6-s3-pas79',
    question: 'PAS 79-1:2020 — what is its role in fire risk assessment?',
    options: [
      'A statutory instrument that places the FRA duty directly into law.',
      'A publicly available specification giving a methodology for fire risk assessment of premises other than housing.',
      'A defined item of field test equipment used to measure escape-route illuminance.',
      'A product standard setting the performance of an individual emergency luminaire.',
    ],
    correctIndex: 1,
    explanation:
      'PAS 79-1:2020 is a publicly available specification giving a methodology for fire risk assessment (PAS 79-2:2020 covers housing). It is not law, but it is the most widely used FRA methodology in the UK, walking the assessor through hazard identification, occupancy analysis, building inspection, the assessment matrix, the action plan and the review schedule. Emergency lighting is assessed at the building inspection step and recorded in the action plan. The legal duty is RRO Article 9; PAS 79 is the standard recipe for satisfying it.',
  },
  {
    id: 'elm6-s3-art22',
    question:
      'A multi-let office building has six tenants and one freeholder. What does RRO 2005 Article 22 require?',
    options: [
      'Each tenant simply works independently, with no duty owed to the others.',
      'A duty for all the responsible persons to co-operate and co-ordinate their fire safety measures.',
      'The freeholder alone holds the entire fire safety duty for the whole building.',
      'The tenants alone hold the entire fire safety duty, including for common parts.',
    ],
    correctIndex: 1,
    explanation:
      'Article 22 applies where two or more responsible persons share, or have duties in respect of, the same premises. Each must co-operate to enable the others to comply, co-ordinate the measures they take, and inform the others of risks. Emergency lighting in shared escape routes (stairs, lobbies) is the classic Article 22 issue — the freeholder typically holds the duty for common parts, tenants for their demised areas, with co-ordination required at the boundary. A tenant whose unit FRA records a stair issue cannot fix it alone; the freeholder must be engaged.',
  },
  {
    id: 'elm6-s3-goldenthread',
    question:
      'A 30-storey residential block is registered as an HRB. The FRA identifies two areas where emergency lighting is below BS EN 1838:2024 minima. Where does this go in the regulatory regime?',
    options: [
      'Onto a stand-alone paper file kept separately from the building records.',
      'Into the building safety case and the golden thread, accessible to the Building Safety Regulator.',
      'Held only by the maintenance contractor as part of their own job records.',
      'Sent only to the individual leaseholders for their personal information.',
    ],
    correctIndex: 1,
    explanation:
      'Under the Building Safety Act 2022, HRBs (≥ 18 m or ≥ 7 storeys, ≥ 2 residential units) require an Accountable Person to maintain a safety case. The FRA is one input; the emergency lighting evidence (design records, photometric calculations, commissioning, maintenance, 5-year verification) sits within it. The golden thread is the digital record of the building maintained throughout its life and accessible to the BSR. Two FRA findings on emergency lighting are golden-thread items — they go into the digital record and the action plan, and the remediation evidence returns on closure.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      'Article 5 — general duties of the responsible person.',
      'Article 14 — emergency routes and exits.',
      'Article 9 — risk assessment by the responsible person.',
      'Article 32 — offences and penalties.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The emergency lighting design is derived from the FRA outputs.',
      'The FRA is written by copying the completed design.',
      'The two are produced independently of each other.',
      'BS 5266-1 requires no link between the FRA and the design.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    id: 3,
    question:
      'BS EN 1838:2024 distinguishes three categories of emergency lighting — what are they, and how does the FRA decide which apply?',
    options: [
      'A single category covering escape routes only.',
      'Escape route, anti-panic open-area, and high-risk task lighting.',
      'Standby and escape lighting only.',
      'High-risk task lighting only.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Only in the action-plan step at the end.',
      'Only at the periodic review step.',
      'Mainly at Step 6 (assess fire safety measures) and Step 7 (action plan).',
      'It does not feature in the PAS 79 methodology.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 5,
    question:
      'BS 5266-1:2025 expanded the design considerations for evacuation. Which of the following is NEW in 2025?',
    options: [
      'The 1 lx minimum on escape routes.',
      'The 0.5 lx anti-panic open-area level.',
      'Refuge call-point illumination at 5 lx.',
      'External escape route lighting to the place of ultimate safety.',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    id: 6,
    question:
      'In a multi-let building, which body holds the FRA duty for the common-parts emergency lighting?',
    options: [
      'Each tenant individually for the whole building.',
      'The responsible person for the common parts — typically the freeholder or managing agent.',
      'The local authority building control body.',
      'The fire alarm maintenance contractor.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It has no effect on the design.',
      'It reduces the emergency lighting requirements overall.',
      'It removes the need for refuge provision.',
      'It escalates the design — refuges, corridor lighting, longer durations.',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    id: 8,
    question:
      'The Fire Safety (England) Regulations 2022, Regulation 8 — what does it require for HRBs?',
    options: [
      'Daily inspection of every common area.',
      'Wayfinding signage in HRB protected stairways, visible in low light or smoke.',
      'An annual structural integrity test.',
      'No specific requirement relating to signage.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'On a fixed 5-year cycle.',
      'Only after an actual fire has occurred.',
      'Whenever it may no longer be valid, or after a significant change.',
  ...
  },
  {
    id: 10,
    question:
      'A commercial premises has had its FRA, but the action plan flagged that emergency lighting in the rear loading bay is below 1 lx. Six months later, no action has been taken. Where does this leave the responsible person?',
    options: [
      'Non-compliant under Articles 9 and 14, and exposed to enforcement.',
      'Compliant, because the assessment has been carried out.',
      'Compliant, provided the budget has been approved.',
      'Compliant, as long as the FRA has been signed.',
    ],
    correctAnswer: 0,
    explanation:
...
const EmergencyLightingModule6Section3 = () => {
  ...
  useSEO({
    title: 'EL in fire risk assessments | Emergency Lighting Module 6.3 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/electrician/upskilling/emergency-lighting-module-6"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Emergency lighting is not specified in isolation. It is one output of the fire risk
          assessment (FRA) duty under RRO 2005 Article 9, applied through BS 5266-1:2025 §5 and BS
          EN 1838:2024. This section walks the FRA-to-design pathway — what the FRA must consider,
          how PAS 79-1/-2:2020 methodology drives it, where emergency lighting sits in the action
          plan, how multi-occupancy and Higher-Risk Buildings change the regime, and what the
          design-and-installation record must say.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Article 9(1) — make a suitable and sufficient assessment.</strong> The RP must
              make a suitable and sufficient assessment of the risks to which relevant persons are
              exposed for the purpose of identifying the general fire precautions needed to comply
              with the requirements and prohibitions imposed on them by the Order.
            </li>
            <li>
              <strong>Article 9(2) — particular regard.</strong> The assessment must have particular
              regard to: matters set out in Schedule 1 (Part 1, dangerous substances); young persons
              (under 18); and persons with disabilities. Emergency lighting is directly engaged for
              the latter two — egress for young persons in unfamiliar surroundings, and for persons
              with mobility, sensory or cognitive impairment.
            </li>
            <li>
              <strong>Article 9(3) — review.</strong> The assessment must be reviewed by the RP
              regularly so as to keep it up to date and in particular if there is reason to suspect
              it is no longer valid, or there has been a significant change. Review is not a fixed
              interval — but annual review is the operating norm, with change-driven re-assessment
              on top.
            </li>
            <li>
              <strong>Article 9(4) — amendment.</strong> Where changes are identified at review, the
              RP must make such changes as are required.
            </li>
            <li>
              <strong>Article 9(6) — record in writing.</strong> The RP must record the significant
              findings of the assessment, including the measures which have been or will be taken by
              them, and any group of persons identified by the assessment as being especially at
              risk, where: there are 5 or more employees; a licence is in force in respect of the
              premises; or an alterations notice requiring it has been served. Most non-domestic
              premises trigger one of these — a written FRA is the practical universal.
            </li>
            <li>
          ...
          <p>
            Article 9 is the foundation. Emergency lighting is a general fire precaution within the
            meaning of the Order. The FRA must therefore consider it; the FRA outputs become inputs
            to the BS 5266-1:2025 design.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              precautions they need to take to comply with the requirements and prohibitions imposed
              on them by or under this Order. The assessment must have particular regard to the
              matters set out in Part 1 of Schedule 1, the matters set out in Part 2 of Schedule 1
              in the case of young persons, and the matters set out in Part 3 of Schedule 1 in
              respect of persons with disabilities. Any such assessment must be reviewed by the
              responsible person regularly so as to keep it up to date.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Design responds to each finding.</strong> For each FRA-identified element, the
              design specifies: the BS EN 1838 category (escape route / anti-panic / standby /
              high-risk task); the photometric requirement; the duration; the luminaire placement;
              the circuit topology; the test regime.
            </li>
            <li>
              <strong>Design-and-installation record evidences the linkage.</strong> The 2025 record
              format requires the FRA reference to be cross-linked to each design decision. A
              pattern-book design with no FRA mapping is non-compliant.
            </li>
            <li>
              <strong>External escape and assembly point — new in 2025.</strong> The 2025 revision
              extends the design boundary beyond the final exit door to the external assembly point.
              The FRA must identify the assembly point; the design must illuminate the route to it.
            </li>
            <li>
              <strong>5-year photometric verification — closing the loop.</strong> The 2025 revision
              requires in-service photometric verification at 5-year intervals. The verification
              provides empirical evidence that the design is delivering against the FRA outputs
              throughout the installation's life. Falls below the design illuminance trigger
              remediation.
            </li>
            <li>
              <strong>FRA-driven design exceptions.</strong> Where a building has unusual features —
              historic fabric constraints, listed building consent restrictions, operational
              lighting overlap — the FRA records the constraint and the design records the
              engineered response. The §5 link is preserved even where the design cannot achieve a
              default solution.
            </li>
          </ul>
          <p>
            §5 is not a retrofit-by-paperwork exercise. Existing installations need to evidence the
            FRA linkage at major refit, recertification or remediation; new installations under the
            2025 regime evidence it from day one.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              relationship between each significant fire risk assessment finding and the emergency
              lighting provision made for it. The boundary of the design should include the route
              from the final exit of the building to the external place of ultimate safety
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="410" y="58" textAnchor="middle" fill="rgba(255,255,255,0.78)" fontSize="10">
              9 steps · plan · gather · identify persons · identify hazards · evaluate · assess
              measures · action · record · review
            </text>
            ...
            <text x="410" y="208" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              Significant findings recorded under Article 9(6); brought to employees under Article
              9(7)
            </text>
            <text x="410" y="220" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              Where multi-occupied — Article 22 co-operation; freeholder common-parts RP / tenant
              demised-area RP
            </text>
            ...
            <text x="410" y="406" textAnchor="middle" fill="rgba(255,255,255,0.78)" fontSize="10">
              Significant findings → action plan → remediation → re-FRA. BS 5266-1 5-year
              photometric closes the loop empirically.
            </text>
            <text x="410" y="420" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              Annual baseline review · change-driven re-assessment · enforcement-driven
              re-assessment
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Escape route lighting (BS EN 1838:2024 §4.2).</strong> 1 lx minimum horizontal
              illuminance across the FULL OPEN WIDTH of every escape route, measured at floor level,
              with edge exclusions: routes wider than 2 m exclude the outer 0.5 m each side; routes
              2 m or narrower exclude the outer ¼ of the width each side. Maximum-to-minimum ratio
              along the route shall not exceed 40:1. The earlier 2013 wording — 1 lx along the
              centre line plus 0.5 lx along a 50 % central band — was superseded by the 2024
              revision. Triggered by any non-domestic escape route. The FRA may identify higher
              values for sleeping risk or mobility-impaired occupancy.
            </li>
            <li>
              <strong>Open-area (anti-panic) lighting (BS EN 1838 §4.3).</strong> 0.5 lx horizontal
              in any open area larger than 60 m². Triggered automatically by area size; the FRA may
              extend the trigger to smaller areas where occupant unfamiliarity or vulnerability is
              high.
            </li>
            <li>
            ...
            <li>
              <strong>High-risk task area lighting (BS EN 1838 §4.4 / §4.5).</strong> 15 lx minimum
              or 10 % of normal task illuminance, whichever is higher. Triggered where the FRA
              identifies a process or activity that, if interrupted by lighting failure, would
              expose persons to danger (a press operator, a chemical lab, a high-voltage switching
              task).
            </li>
            <li>
              <strong>Refuge call-point illumination (BS EN 1838 §4.5).</strong> 5 lx vertical
              illuminance at the call-point. Triggered where the FRA identifies refuges (under BS
              9999 or Approved Document B / Approved Document M).
            </li>
            <li>
              <strong>Sign-luminance (BS EN 1838 §5).</strong> Internally and externally illuminated
              safety signs must achieve specified luminance contrast. Triggered for all escape
              signs.
            </li>
          </ul>
          <p>
            The FRA is the trigger. The designer cannot decide unilaterally to omit a category; the
            FRA must justify any omission. Conversely, the FRA may identify a category not
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              lighting. Standby lighting and high-risk task area lighting are additional categories
              where operational or safety considerations require them. The fire risk assessment
              determines which categories apply at a given location and whether photometric values
              higher than the minima specified in this document are required.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              information, identify the assessor and the RP. Confirm the boundary of the assessment
              (single tenancy, common parts, whole building).
            </li>
            <li>
              ...
              emergency lighting design records, commissioning certificate, logbook, last annual /
              5-year test certificates.
            </li>
            <li>
              ...
              disabilities, sleeping occupants, persons with limited familiarity with the premises.
            </li>
            <li>
            ...
            <li>
              <strong>Step 6 — Assess the existing fire safety measures.</strong> Means of escape;
              means of detection and warning; firefighting; emergency lighting (BS 5266-1 / BS EN
              1838 compliance, condition, maintenance regime); signage; management arrangements;
              emergency plan; training; co-operation with other RPs.
              <em> Emergency lighting is checked here against the standards.</em>
            </li>
            <li>
              <strong>Step 7 — Action plan.</strong> Each shortfall identified at Step 6 becomes an
              action with priority, owner, target date, evidence requirement.
              <em>
                {' '}
                Emergency lighting actions sit here — illuminance shortfalls, missing 5-year
                photometric, missing FRA-design link, etc.
              </em>
            </li>
            <li>
          ...
          <p>
            ...
            adaptation is the treatment of relevant persons (residents, including children, older
            persons and disabled persons in their homes) and the longer evacuation assumptions in
            stay-put strategies for blocks of flats.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              duties in respect of, the same premises, each must co-operate with each other to the
              extent necessary to enable each to comply with their duties.
            </li>
            <li>
              <strong>Article 22(2) — co-ordination.</strong> Each RP must take reasonable steps to
              inform the others of the risks identified, and the measures taken in respect of them.
            </li>
            <li>
              <strong>Common-parts EL — typically freeholder RP.</strong> Stairs, lobbies, lift
              lobbies, plant rooms, refuse rooms, refuges, external escape routes outside any single
              demise. The freeholder commissions the FRA, the design, the commissioning, the
              maintenance.
            </li>
            <li>
              <strong>Demised-area EL — typically tenant RP.</strong> Inside each tenancy. The
              tenant commissions their own FRA, identifies the EL needs, and either has the landlord
              install or installs at their cost.
            </li>
            <li>
              ...
              inside the demised area is tenant. Tenants may rely on the freeholder's common- parts
              EL for the route from their door — but cannot test or change it without co-operation.
            </li>
            <li>
              <strong>Information-sharing duty.</strong> Tenants must inform the freeholder of EL
              issues found in their FRA that affect common parts; the freeholder must inform tenants
              of issues found in the common-parts FRA that affect their unit egress. Most leases now
              include explicit fire safety co-operation clauses to operationalise Article 22.
            </li>
            <li>
              ...
              freeholder. The lead RP holds the building-wide picture and acts as the FRS interface.
            </li>
          </ul>
          <p>
            Article 22 is most often a paper-thin duty in practice — co-operation in name, not in
            substance. FRS audits are increasingly testing it: asking tenants whether they have seen
            the common-parts FRA, and asking freeholders whether they have collated tenant FRAs.
            Building-wide co-ordination is the test.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              (whether on a temporary or a permanent basis), each such person must co-operate with
              the other responsible person concerned so far as is necessary to enable them to comply
              with the requirements and prohibitions imposed on them by or under this Order, take
              all reasonable steps to co-ordinate the measures they take to comply with the
              requirements and prohibitions imposed on them by or under this Order, and take all
              reasonable steps to inform the other responsible persons concerned of the risks to
              relevant persons arising out of or in connection with the conduct of the
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>The FRA continues — Article 9 still applies.</strong> The HRB regime does not
              displace the RRO 2005. The Accountable Person is also (or appoints) the responsible
              person for the building. The Article 9 FRA is required.
            </li>
            <li>
              <strong>The safety case (BSA 2022 s.83-87).</strong> A documented case showing how
              building safety risks are identified, assessed, mitigated and managed throughout the
              building's life. The FRA is one input. Other inputs: structural assessment; services
              failure modes; resident engagement; maintenance regime; competent person arrangements;
              previous incidents.
            </li>
            <li>
              <strong>The Golden Thread (BSA 2022 + Building Regs).</strong> A digital record of the
              building, kept up to date throughout its life, accessible to the duty holders, the BSR
              and (in scope) residents. EL evidence within the Golden Thread: design drawings,
              photometric calculations, commissioning certificate, asset register, logbook, monthly
              / annual / 5-year test results, FRA references.
            </li>
            <li>
              ...
              planned tests; communication of EL deficiencies and remediation; PEEP arrangements for
            ...
            <li>
              <strong>Gateway 2 / Gateway 3 (Building Regulations).</strong> Construction of an HRB
              cannot proceed without BSR approval at Gateway 2 (before construction) and cannot be
              occupied without Gateway 3 (before occupation) approval. EL design and installation
              evidence forms part of the Gateway submissions.
            </li>
          </ul>
          <p>
            For HRBs, the technical EL standards do not change — BS 5266-1:2025, BS EN 1838:2024, BS
            EN 50172:2024 still apply. What changes is the evidence regime. Records must be digital,
            accessible to the BSR, current and demonstrably linked to the safety case.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The principal accountable person for an occupied higher-risk building must prepare a
              safety case report for the building. The report must include an assessment of the
              building safety risks for the building, and a description of the steps being taken to
              prevent the occurrence of the building safety risks and reduce their severity if they
              were to materialise. The principal accountable person must keep the safety case report
              under review and revise it as needed.
            </>
          }
        ...
        <ContentEyebrow>
          Fire Safety (England) Regulations 2022 — Regs 4, 8, 9, 10 + SI 2025/797
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              maintain a secure information box (commonly called the premises information box, PIB)
              accessible to the FRS, containing the name and UK contact details of the RP, hard
              copies of the floor plans, and a single-page building plan identifying key fire safety
              features. EL interaction: the box itself should be locatable and operable under
              emergency conditions if accessed at night, and the FRS-search route to it must remain
              illuminated.
            </li>
            <li>
              <strong>Reg 8 — wayfinding signage (HRBs).</strong> The RP must install signage in
              every protected stairway, visible in low light or smoky conditions, identifying the
              floor number and the flat numbers on each floor. EL interaction: sign-luminance
              requirements under BS EN 1838:2024 §5 must be met; the FRA must verify illuminance at
              the signs throughout the protected stairway.
            </li>
            <li>
              <strong>Reg 9 — information to residents.</strong> The RP must provide each resident
              with fire safety instructions appropriate to the evacuation strategy of the building
              (stay-put, simultaneous evacuation, or phased), plus information on fire doors. The
              instructions must be in an accessible format. EL interaction: residents should know
              whether to expect emergency lighting on their escape route, what to do if it fails,
              and how the lighting supports the evacuation strategy.
            </li>
            <li>
              <strong>Reg 10 — fire doors.</strong> In buildings with two or more sets of domestic
              premises and over 11 m in height, the RP must conduct quarterly checks of fire doors
              in common parts and annual checks of flat entrance doors (so far as is reasonably
              practicable). EL interaction: the fire door inspection is undertaken under normal
              conditions, but the doors form part of the protected escape route that emergency
              lighting must illuminate during evacuation.
            </li>
            <li>
              <strong>
                SI 2025/797 — Fire Safety (Residential Evacuation Plans) (England) Regulations 2025.
              </strong>{' '}
              The standalone residential evacuation-plans regime, introduced after the original 2022
              Regulations. The RP of a relevant residential building must produce a building
              evacuation plan, identify residents who would need assistance to evacuate
              (Person-Centred Fire Risk Assessments / Personal Emergency Evacuation Plans where
              applicable), share information with the FRS, and review the plans on change. EL
              interaction: every plan assumes the emergency lighting works on the routes the plan
              relies on; the FRA must verify it does.
            </li>
            <li>
              <strong>Sharing with the FRS — Reg 4(3), Reg 8(3) and SI 2025/797.</strong> The
              information box, the wayfinding signage strategy, and the evacuation plans (under SI
              2025/797) must all be available to the FRS for inspection and operational planning. EL
              evidence supports each.
            </li>
            <li>
              <strong>Interaction with the BSA 2022 regime.</strong> For HRBs, the Regs 4, 8, 9 and
              10 obligations and the SI 2025/797 evacuation plans also flow into the safety case and
              the Golden Thread. The same evidence serves multiple regulatory channels.
            </li>
          </ul>
          <p>
            These regulations are post-Grenfell instruments responding directly to the Inquiry's
            findings on operational difficulties for residents and firefighters. Emergency lighting
            is a dependency for all of them — visible signs, accessible information boxes, readable
            resident instructions, working fire-door routes, and viable evacuation plans all assume
            the lighting works. The FRA must verify the assumption.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              sections of the full open width of the route on floors 3-7; below BS EN 1838:2024 §4.2
              1 lx minimum (full open width with edge exclusions)' — not 'EL inadequate'.
            </li>
            <li>
              <strong>Priority.</strong> Typically high / medium / low or numerical (P1-P4), tied to
              risk consequence. EL deficiencies on high-occupancy escape routes are usually P1;
              cosmetic issues P3-P4.
            </li>
            <li>
              <strong>Action.</strong> What will be done. 'Replace 12 fittings on stair B floors 3-7
              with LED equivalents to recover design illuminance; commission to BS 5266-1 Annex F'.
            </li>
            <li>
            ...
            <li>
              <strong>Evidence requirement.</strong> What must be produced to close the action. For
              EL: post-remediation photometric verification, updated logbook entry, updated design
              record, updated FRA reference.
            </li>
            <li>
              <strong>Closure record.</strong> Date of closure, evidence attached, assessor
              sign-off. The closed action stays in the action plan — it is part of the audit trail.
            </li>
            <li>
              <strong>Reopen on regression.</strong> If a closed action regresses (e.g. the
              replacement fittings degrade and illuminance falls again), the action reopens with a
              new date. Annual photometric checks and 5-year photometric verification under BS
              5266-1:2025 are the empirical inputs that drive reopening.
            </li>
          </ul>
          <p>
            The action plan is the legal proof that significant findings have been acted on. A
            missing action plan, a stale action plan, or one with unevidenced closures is, in court,
            more damaging than a missing FRA — it evidences awareness without action.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Annual baseline.</strong> Most assessors and insurers expect a routine annual
              review even where nothing significant has changed. Confirms the FRA remains current;
              identifies any creeping changes (occupancy growth, layout drift, unrecorded
              alterations).
            </li>
            <li>
            ...
            <li>
              <strong>Incident.</strong> Any near-miss, false alarm investigation, evacuation drill
              failure, EL failure event. Each is a trigger to review.
            </li>
            <li>
              <strong>Regulation or standard update.</strong> The transition from BS 5266-1:2016 to
              BS 5266-1:2025 is itself a trigger; so was the Fire Safety Act 2021; so was the
              Building Safety Act 2022. RPs of relevant buildings should review on every significant
              statutory or standards change.
            </li>
            <li>
              <strong>Enforcement notice.</strong> An Article 30 enforcement notice or Article 31
              prohibition notice mandates remediation; the FRA must be reviewed to incorporate the
              remediation findings.
            </li>
            <li>
              <strong>BS 5266-1:2025 5-year photometric verification.</strong> The empirical check
              on whether the EL is delivering against design. A failure on the 5-year verification
              is a trigger to revisit the FRA — has the building changed in ways that affect the EL
              design assumptions?
            </li>
            <li>
              <strong>HRB safety case review.</strong> For HRBs, the safety case must be kept under
              review (BSA 2022 s.83). The FRA review feeds the safety case review; significant
              safety case findings feed back to the FRA.
            </li>
          </ul>
          <p>
            ...
            building has genuinely not changed and the assessment has not been updated by virtue of
        ...
        <ContentEyebrow>
          Putting it all together — the design-and-installation record
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>FRA reference.</strong> Date, assessor, version, scope. Each significant FRA
              finding cross-referenced to its corresponding design provision.
            </li>
            <li>
              <strong>Design strategy.</strong> The overall approach (self-contained vs central
              battery; maintained vs non-maintained; addressable vs non-addressable; integrated vs
              stand-alone).
            </li>
            <li>
              <strong>Photometric calculations.</strong> For each escape route, anti-panic area,
              refuge, high-risk task area and external escape route — the calculation evidencing BS
              EN 1838:2024 minima are met (with margin).
            </li>
            <li>
            ...
            <li>
              <strong>Circuit topology.</strong> Distribution, sub-circuits, monitoring, interaction
              with normal lighting (maintained vs non-maintained).
            </li>
            <li>
            ...
            <li>
              <strong>External escape route — NEW in 2025.</strong> Boundary of design extends to
              external assembly point. Photometric calculation and luminaire placement evidenced.
            </li>
            <li>
              <strong>Cause-and-effect interactions.</strong> Where EL is integrated with fire alarm
              cause-and-effect (BS 5839-1:2025), the document records the interactions.
            </li>
            <li>
              <strong>FRA-design map.</strong> A table listing each significant FRA finding against
              the design provision that responds to it. The most visible evidence of §5 compliance.
            </li>
            <li>
              <strong>Commissioning record.</strong> Date, person, results. Results include in-situ
              illuminance measurements at sample points to verify against design.
            </li>
            <li>
              <strong>Logbook reference.</strong> Where the on-going test records will be kept;
              format; location; access arrangements.
            </li>
          </ul>
          <p>
        ...
        <FAQ
          items={[
            ...
            {
              question:
                'What is the difference between the FRA and the BS 5266-1 design-and-installation record?',
              answer:
            ...
            {
              question:
                'Can a contractor rely on the existing FRA when quoting for emergency lighting works?',
              answer:
            ...
            {
              question:
                'How does the BS 5266-1:2025 5-year photometric verification interact with the FRA review?',
              answer:
            ...
            {
              question:
                'In a multi-let building, who pays for emergency lighting fixes in the common parts?',
              answer:
            ...
            {
              question:
                'What happens if the FRA identifies a need that cannot be met because of building constraints (e.g. a listed building)?',
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() =>
              navigate('/electrician/upskilling/emergency-lighting-module-6-section-2')
            }
          ...
          <button
            type="button"
            onClick={() =>
              navigate('/electrician/upskilling/emergency-lighting-module-6-section-4')
            }
