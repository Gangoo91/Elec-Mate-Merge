...
const DESCRIPTION =
  'Understanding different smart home hub options and their applications for various installation scenarios';
...
const faqs = [
  {
    ...
    answer:
      'Yes, multiple hubs can coexist, but this adds complexity. Typically, one primary hub (like Home Assistant) integrates with others via APIs or bridges. However, this requires careful planning to avoid conflicts and ensure reliable automation.',
  },
  {
    question: 'Should I recommend Matter-compatible hubs now?',
    answer:
      'Matter is becoming increasingly important for interoperability. Recommend hubs that support or plan to support Matter, but explain that the ecosystem is still maturing. Current SmartThings and Home Assistant both support Matter.',
  },
  {
    question: 'What hub should I recommend for rental properties?',
    answer:
      'For rental properties, consider portable, easy-to-remove solutions. Proprietary hubs like SmartThings or simple ecosystems (Hue, Ring) are easier to relocate than wired solutions like Home Assistant running on dedicated hardware.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-3xl mx-auto">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white">
                  Understand the role of smart home hubs as central controllers
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
                <span className="text-white">
                  Compare Home Assistant, SmartThings, and proprietary hub options
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
                <span className="text-white">
                  Identify the best hub solution for different customer requirements
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
                <span className="text-white">
                  Explain protocol support, cloud dependency, and local control considerations
                </span>
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              A smart home hub acts as the central brain of a smart home system, coordinating
              communication between devices using different protocols and enabling unified control
              and automation.
            </p>
            ...
            <div className="bg-elec-gray/30 rounded-lg p-5 border border-white/10">
              ...
              <ul className="space-y-2 text-white">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Protocol translation:</strong> Converting between Zigbee, Z-Wave, Wi-Fi,
                    and other protocols
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">-</span>
                  <span>
                    <strong>Automation engine:</strong> Running if-then logic and schedules
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">-</span>
                  <span>
                    <strong>Unified interface:</strong> Single app for controlling diverse devices
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">-</span>
                  <span>
                    <strong>Voice integration:</strong> Connecting to Alexa, Google, and Siri
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 p-4 rounded-r-lg">
              <p className="text-white">
                <strong>Key distinction:</strong> A hub is not the same as a bridge. Bridges
                typically translate one specific protocol, whilst hubs manage multiple protocols and
                provide the automation logic layer.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Home Assistant is an open-source home automation platform that runs locally on
              dedicated hardware (Raspberry Pi, mini PC, or dedicated appliance). It offers the
              widest device compatibility and maximum customisation.
            </p>
            ...
            <p className="text-white">
              <strong>Best for:</strong> Tech-savvy customers who want maximum flexibility, local
              control, and are comfortable with occasional troubleshooting.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              SmartThings is Samsung's consumer-focused smart home platform. The hub includes
              built-in Zigbee and Z-Wave radios, with a cloud-based automation engine and mobile
              app.
            </p>
            ...
            <p className="text-white">
              <strong>Best for:</strong> Customers wanting good device compatibility with easier
              setup than Home Assistant, who are comfortable with cloud dependency.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Proprietary hubs are designed to work specifically with one manufacturer's ecosystem.
              Examples include Philips Hue Bridge, Lutron Caseta Hub, and Apple HomePod (HomeKit).
            </p>
            ...
            <p className="text-white">
              <strong>Best for:</strong> Customers who value simplicity, want professional-grade
              reliability, and are happy to stay within one brand's ecosystem.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Choosing the appropriate hub requires understanding the customer's technical ability,
              existing devices, and priorities.
            </p>
            ...
            <div className="bg-elec-gray/30 rounded-lg p-5 border border-white/10">
              ...
              <ol className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Technical comfort:</strong> How comfortable are they with technology and
                    troubleshooting?
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Existing devices:</strong> What smart devices do they already own or
                    plan to purchase?
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Privacy concerns:</strong> Do they prefer local control or accept cloud
                    services?
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Budget:</strong> Initial investment vs ongoing costs (subscriptions)?
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-elec-yellow font-semibold">5.</span>
                  <span>
                    <strong>Support needs:</strong> Do they want manufacturer support or community
                    resources?
                  </span>
                </li>
              </ol>
