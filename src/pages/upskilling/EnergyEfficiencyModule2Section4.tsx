...
const EnergyEfficiencyModule2Section4: React.FC = () => {
  ...
  const quizQuestions = [
    ...
    {
      question: 'What communication protocol is commonly used by smart meters in the UK for data transmission?',
      options: [
        'Bluetooth only',
        'WiFi only',
        'SMETS2 via the DCC network',
        'USB connection'
      ],
      correctAnswer: 'SMETS2 via the DCC network'
    },
    {
      question: 'What is the minimum sampling interval typically required for identifying short-duration power quality events?',
      options: [
        '1 hour',
        '15 minutes',
        '1 second or faster',
      ...
      correctAnswer: '1 second or faster'
    },
    {
      question: 'Which brand is known for the Fluke 1770 series of power quality analysers?',
      options: [
        'Chauvin Arnoux',
        'Hioki',
        'Fluke',
    ...
    {
      question: 'What is the primary purpose of harmonic analysis in power monitoring?',
      options: [
        'Measuring cable length',
        'Identifying distortion caused by non-linear loads',
        'Checking earth resistance',
        'Testing RCD operation'
      ],
      correctAnswer: 'Identifying distortion caused by non-linear loads'
    },
    {
      question: 'For IoT energy monitors, what is a key consideration for installation in industrial environments?',
      options: [
        'Screen size',
        'Colour options',
        'EMC immunity and robust wireless connectivity',
        'Battery type'
      ],
      correctAnswer: 'EMC immunity and robust wireless connectivity'
    }
  ];
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-2 text-elec-yellow mb-2">
            ...
            <span className="text-sm font-medium">Module 2: Energy Monitoring & Analysis</span>
          </div>
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Section 4: Equipment for Power Monitoring
          </h1>
          <p className="text-gray-300 text-lg">
            Master the tools of the trade - from handheld clamp meters to sophisticated IoT monitoring systems.
            Learn how to select, install, and use power monitoring equipment effectively.
          </p>
        </div>

        {/* Section 1: Clamp Meters and Portable Power Analysers */}
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full bg-elec-yellow/20 flex items-center justify-center">
              <span className="text-elec-yellow font-bold">1</span>
            </div>
            <h2 className="text-2xl font-semibold text-white">Clamp Meters and Portable Power Analysers</h2>
          </div>

          <div className="bg-[#242424] rounded-lg p-6 mb-4">
            <h3 className="text-xl font-medium text-elec-yellow mb-3 flex items-center gap-2">
              <Zap className="w-5 h-5" />
              Clamp Meters
            </h3>
            <p className="text-gray-300 mb-4">
              Clamp meters are the electrician's everyday tool for current measurement. Modern units offer far more
              than basic AC current readings.
            </p>
            ...
            <div className="space-y-4">
              <div className="border-l-2 border-elec-yellow pl-4">
                ...
                <p className="text-gray-300 text-sm">
                  True RMS meters accurately measure non-sinusoidal waveforms common with VFDs, LED drivers, and
                  switched-mode power supplies. Average-responding meters can under-read by 20-40% on distorted
                  waveforms. For energy work, always use True RMS instruments.
                </p>
              </div>
          ...
          <div className="bg-[#242424] rounded-lg p-6">
            ...
            <p className="text-gray-300 mb-4">
              For detailed energy analysis, portable power analysers provide comprehensive measurements including
              voltage, current, power factor, harmonics, and energy consumption over time.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-[#1a1a1a] p-4 rounded-lg">
                ...
                <ul className="text-gray-300 text-sm space-y-1">
                  ...
                  <li>- Transient and event capture</li>
                </ul>
              </div>
              <div className="bg-[#1a1a1a] p-4 rounded-lg">
        ...
        {/* Section 2: Fixed Power Quality Analysers */}
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full bg-elec-yellow/20 flex items-center justify-center">
              <span className="text-elec-yellow font-bold">2</span>
            </div>
            <h2 className="text-2xl font-semibold text-white">Fixed Power Quality Analysers</h2>
          </div>

          <div className="bg-[#242424] rounded-lg p-6">
            <p className="text-gray-300 mb-4">
              For permanent monitoring installations, fixed power quality analysers provide continuous data
              collection and often integrate with building management systems (BMS) or energy management
              software.
            </p>
            ...
            <div className="space-y-3">
              ...
              <div className="grid md:grid-cols-2 gap-3">
                <div className="bg-[#1a1a1a] p-3 rounded">
                  ...
                  <p className="text-gray-400 text-xs">Enterprise-grade, extensive BMS integration</p>
                </div>
                <div className="bg-[#1a1a1a] p-3 rounded">
                  <p className="font-medium text-elec-yellow text-sm">ABB M4M Series</p>
                  <p className="text-gray-400 text-xs">Modular, scalable for various applications</p>
                </div>
                <div className="bg-[#1a1a1a] p-3 rounded">
                  <p className="font-medium text-elec-yellow text-sm">Janitza UMG Series</p>
                  <p className="text-gray-400 text-xs">Excellent harmonic analysis, German quality</p>
                </div>
                <div className="bg-[#1a1a1a] p-3 rounded">
                  <p className="font-medium text-elec-yellow text-sm">Crompton Integra Series</p>
                  <p className="text-gray-400 text-xs">Cost-effective, good UK support</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Section 3: Current Transformers and Rogowski Coils */}
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full bg-elec-yellow/20 flex items-center justify-center">
              <span className="text-elec-yellow font-bold">3</span>
            </div>
            <h2 className="text-2xl font-semibold text-white">Current Transformers (CTs) and Rogowski Coils</h2>
          </div>

          <div className="bg-[#242424] rounded-lg p-6 mb-4">
            <h3 className="text-xl font-medium text-elec-yellow mb-3">Current Transformers (CTs)</h3>
            <p className="text-gray-300 mb-4">
              CTs are essential for measuring high currents safely. They step down the primary current to a
              safe secondary level (typically 5A or 1A) that can be measured by instruments.
            </p>
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm">
                    Never leave a CT secondary circuit open when primary current is flowing. Dangerous voltages
                    (potentially thousands of volts) can develop. Always short-circuit CT secondaries before
                    disconnecting from the meter, or use CTs with built-in shorting links.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-[#242424] rounded-lg p-6">
            <h3 className="text-xl font-medium text-elec-yellow mb-3">Rogowski Coils</h3>
            <p className="text-gray-300 mb-4">
        ...
        {/* Section 4: Smart Meters and Sub-meters */}
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full bg-elec-yellow/20 flex items-center justify-center">
              <span className="text-elec-yellow font-bold">4</span>
            </div>
            <h2 className="text-2xl font-semibold text-white">Smart Meters and Sub-meters</h2>
          </div>
          ...
          <div className="bg-[#242424] rounded-lg p-6 mb-4">
            ...
            <p className="text-gray-300 mb-4">
              The UK smart meter rollout uses SMETS2 (Smart Metering Equipment Technical Specifications 2)
              meters that communicate via the Data Communications Company (DCC) network.
            </p>
          ...
          <div className="bg-[#242424] rounded-lg p-6">
            <h3 className="text-xl font-medium text-elec-yellow mb-3">Sub-metering Systems</h3>
            <p className="text-gray-300 mb-4">
              Sub-meters provide circuit-level monitoring within buildings, enabling detailed energy analysis
              and cost allocation.
            </p>
            ...
            <div className="space-y-4">
              <div className="border-l-2 border-elec-yellow pl-4">
                ...
                <p className="text-gray-300 text-sm mb-2">
                  Required when recharging energy costs to tenants or other parties. Must display the MID
                  conformity marking and have sealed calibration.
                </p>
              ...
              <div className="border-l-2 border-gray-500 pl-4">
                ...
                <p className="text-gray-300 text-sm mb-2">
                  Suitable for internal energy management, identifying waste, and monitoring individual circuits
                  or equipment. Lower cost but not legal for billing.
                </p>
                <p className="text-gray-400 text-xs">
        ...
        {/* Section 5: Data Loggers and IoT Energy Monitors */}
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full bg-elec-yellow/20 flex items-center justify-center">
              <span className="text-elec-yellow font-bold">5</span>
            </div>
            <h2 className="text-2xl font-semibold text-white">Data Loggers and IoT Energy Monitors</h2>
          </div>
          ...
          <div className="bg-[#242424] rounded-lg p-6 mb-4">
            ...
            <p className="text-gray-300 mb-4">
              Modern IoT energy monitors combine local measurement with cloud connectivity, enabling remote
              monitoring, alerts, and advanced analytics.
            </p>

            <div className="grid md:grid-cols-3 gap-4 mb-4">
              <div className="bg-[#1a1a1a] p-4 rounded-lg">
                <h4 className="font-medium text-elec-yellow mb-2">Entry Level</h4>
                <p className="text-gray-300 text-sm mb-2">Single circuit, basic monitoring</p>
              ...
              <div className="bg-[#1a1a1a] p-4 rounded-lg">
                ...
                <p className="text-gray-300 text-sm mb-2">Multi-circuit, business features</p>
                <ul className="text-gray-400 text-xs space-y-1">
              ...
              <div className="bg-[#1a1a1a] p-4 rounded-lg">
                ...
                <p className="text-gray-300 text-sm mb-2">Full energy management platform</p>
                <ul className="text-gray-400 text-xs space-y-1">
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm">
                    Consider network infrastructure before specifying IoT monitors. Options include WiFi,
                    Ethernet, Modbus TCP/RTU, BACnet, LoRaWAN, and cellular (4G/5G). For industrial environments,
                    wired protocols are more reliable. Always plan for local data buffering in case of
                    connectivity loss.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-[#242424] rounded-lg p-6">
            <h3 className="text-xl font-medium text-elec-yellow mb-3">Standalone Data Loggers</h3>
            <p className="text-gray-300 mb-4">
              For temporary monitoring campaigns or locations without network connectivity, standalone data
              loggers store measurements locally for later retrieval.
            </p>
        ...
        {/* Section 6: Selecting the Right Equipment */}
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full bg-elec-yellow/20 flex items-center justify-center">
              <span className="text-elec-yellow font-bold">6</span>
            </div>
            <h2 className="text-2xl font-semibold text-white">Selecting the Right Equipment for the Job</h2>
          </div>
          ...
          <div className="bg-[#242424] rounded-lg p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center py-2 border-b border-gray-700">
                <span className="text-gray-300">Basic clamp meter (True RMS)</span>
                <span className="text-elec-yellow">£100-300</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-gray-700">
                <span className="text-gray-300">Professional power clamp</span>
                <span className="text-elec-yellow">£300-600</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-gray-700">
                <span className="text-gray-300">Portable power analyser</span>
                <span className="text-elec-yellow">£800-4,000</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-gray-700">
                <span className="text-gray-300">Fixed power quality meter</span>
                <span className="text-elec-yellow">£500-3,000</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-gray-700">
                <span className="text-gray-300">Sub-meter with CTs (per circuit)</span>
                <span className="text-elec-yellow">£80-250</span>
              </div>
              <div className="flex justify-between items-center py-2">
                <span className="text-gray-300">IoT monitoring system (basic)</span>
        ...
        {/* Quiz Section */}
        <section className="mb-10">
          <h3 className="text-2xl font-semibold text-white mb-4">Section Quiz</h3>
