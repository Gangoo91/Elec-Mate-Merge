...
const FireAlarmModule7Section1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 7 · Section 1" title="Fire safety legislation" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The Regulatory Reform (Fire Safety) Order 2005 is the day-to-day operating law for fire
          safety in non-domestic premises. The Fire Safety Act 2021 closed the post-Grenfell
          ambiguities. The Building Safety Act 2022 created a parallel regime for higher-risk
          buildings. The fire alarm engineer is the technical route by which clients discharge these
          legal duties — knowing the law is part of the job.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Regulatory Reform (Fire Safety) Order 2005 (RRO).</strong> The operating-stage
              fire safety law for almost all non-domestic premises. Applies to workplaces, common
              parts of HMOs and blocks of flats, places of assembly, retail, hospitality,
              healthcare, education. Came into force 1 October 2006. Consolidated and repealed more
              than 70 earlier instruments including the Fire Precautions Act 1971.
            </li>
            <li>
            ...
            <li>
              <strong>Fire Safety (England) Regulations 2022.</strong> Made under the RRO as amended
              by the Fire Safety Act 2021. Imposes specific operational duties on responsible
              persons of multi-occupied residential buildings: monthly checks of firefighting
              equipment in common parts, quarterly checks of flat entrance doors in HRBs, annual
              checks in non-HRBs, secure information box, wayfinding signage, evacuation alert
            ...
            <li>
              ...
              thread of digital information, mandatory occurrence reporting, and the gateway regime
              for HRB design and construction.
            </li>
            <li>
            ...
            <li>
              ...
              Construction-stage law. Functional requirements B1-B5 cover means of warning / escape,
              internal fire spread, external fire spread, structural stability, FRS access. Approved
              Document B is the route to compliance. Detailed in §2.
            </li>
            <li>
              <strong>Health and Safety at Work etc. Act 1974.</strong> Underlying duty on employers
              to provide a safe workplace. The RRO is more specific for fire; the HSWA underlies it
              and applies broadly.
            </li>
          </ul>
          <p>
            Scotland and Northern Ireland have their own equivalents (Fire (Scotland) Act 2005, Fire
            and Rescue Services (NI) Order 2006) — substantively similar in approach but distinct in
            detail. A contractor working across the UK must check jurisdiction.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              employer, if the workplace is to any extent under his control; (b) in relation to any
              premises not falling within paragraph (a) — (i) the person who has control of the
              premises (as occupier or otherwise) in connection with the carrying on by him of a
              trade, business or other undertaking (for profit or not); or (ii) the owner, where the
              person in control of the premises does not have control in connection with the
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Art 9</strong> — Fire risk assessment duty. Suitable and sufficient assessment
              of risks to relevant persons. Record significant findings in writing where 5+
              employees / licensed / alterations notice in force. Review when no longer valid or
            ...
            <li>
              <strong>Art 17</strong> — Maintenance. Premises and any equipment provided in respect
              of those premises subject to a suitable system of maintenance and maintained in an
              efficient state, in efficient working order, and in good repair.
            </li>
            <li>
              <strong>Art 18</strong> — Safety assistance. Appoint one or more competent persons to
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              on him by or under this Order. Any such assessment must be reviewed by the responsible
              person regularly so as to keep it up to date and particularly if (a) there is reason
              to suspect that it is no longer valid; or (b) there has been a significant change in
              the matters to which it relates including when the premises, special, technical and
              organisational measures, or organisation of the work undergo significant changes,
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Hazards.</strong> Sources of ignition (electrical, hot work, smoking, arson),
              fuel (combustible materials, flammable liquids, gases), oxygen (storage, ventilation).
            </li>
            <li>
            ...
            <li>
              <strong>Evaluation.</strong> The likelihood of fire occurring × the consequence if it
              does. Existing precautions assessed for adequacy: detection, alarm, escape routes,
              signage, lighting, firefighting equipment, compartmentation, fire procedures,
              training.
            </li>
            <li>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              ...
              <text x="105" y="86" textAnchor="middle" fill="white" fontSize="11" fontWeight="bold">
                Non-domestic
              </text>
              <text
                x="105"
              ...
              <text x="105" y="114" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
                RRO Art 1 scope
              </text>
            </g>
            ...
            <g>
              ...
              <text x="315" y="86" textAnchor="middle" fill="white" fontSize="11" fontWeight="bold">
                Responsible
              </text>
              <text
                x="315"
              ...
              <text x="315" y="114" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
                RRO Art 3
              </text>
            </g>
            ...
            <g>
              ...
              <text x="525" y="86" textAnchor="middle" fill="white" fontSize="11" fontWeight="bold">
                Fire risk
              </text>
              <text
                x="525"
              ...
              <text x="525" y="114" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
                RRO Art 9
              </text>
            </g>
            ...
            <g>
              ...
              <text x="750" y="86" textAnchor="middle" fill="white" fontSize="11" fontWeight="bold">
                Action plan +
              </text>
              <text
                x="750"
              ...
              <text x="750" y="114" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
                RRO Art 13, 14
              </text>
            </g>
            ...
            <g>
              ...
              <text x="750" y="244" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
                RRO Art 17
              </text>
            </g>
            ...
            <g>
              ...
              <text x="525" y="244" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
                RRO Art 9(3)
              </text>
            </g>
            ...
            <g>
              ...
              <text x="40" y="344" fill="rgba(255,255,255,0.6)" fontSize="9">
                On indictment: unlimited fine + up to 2 years custody. Corporate manslaughter where
                deaths from management failure.
              </text>
            </g>
            ...
            <g>
              ...
              <text x="40" y="433" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                the responsible person discharges Art 13 (detection / alarm), Art 17 (maintenance),
                Art 38 (firefighter information).
              </text>
            </g>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              detector and every device tested across the year. Plus zone-plan verification, ducted
              detector function test (newly added in 2025), text descriptor verification.
            </li>
            <li>
              <strong>Every 5 years (suggested).</strong> Verify text descriptors on addressable
              systems (responsibility of premises management to inform the servicing organisation of
              changes; periodic verification is prudent).
            </li>
            <li>
          ...
          <p>
            Each of these activities, captured in a logbook with dates, signatures and findings, is
            the evidence of "efficient working order". A missing weekly test entry is a small gap; a
            missing service certificate is a large one; a system out of service for more than the
            documented "permissible disablement" period is an Art 17 breach.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The recommendations in this subclause should be carried out by a competent person (see
              3.13). Successive inspection and servicing visits should be undertaken at intervals of
              approximately 6 months (see Note 1). NOTE 1: It would be acceptable for one
              inspection, test and service of the system to be carried out any time between 5 months
              and 7 months after the previous inspection, test and service. NOTE 2: The date of
              acceptance is to be regarded as the datum for these periods.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Empowered the Secretary of State to make regulations imposing further specific duties.
              Those regulations are the Fire Safety (England) Regulations 2022.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              low-light conditions; instructions to residents on how to report fires; annual checks
              of flat entrance doors (or quarterly in HRBs); monthly checks of the operation of
              lifts, evacuation lifts, fire suppression equipment etc; annual cabinet checks of
              firefighters' switches.
            </li>
            <li>
              <strong>HRBs only.</strong> Secure information box at the building accessible to FRS;
              floor plans and building plans on-site for FRS; quarterly checks of flat entrance
              doors; evacuation alert system where required.
            </li>
          </ul>
          <p>The Building Safety Act 2022 — what it created:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Building Safety Regulator (BSR).</strong> A function of the HSE. The regulator
              for HRBs across design, construction and occupation.
            </li>
            <li>
            ...
            <li>
              <strong>Golden thread.</strong> Mandatory digital record of building information from
              design through construction through occupation. Survives ownership changes.
            ...
            <li>
              <strong>Resident engagement strategy and complaints procedure.</strong> AP must engage
              residents on building safety; residents have routes of escalation to the BSR.
            </li>
          </ul>
          <p>
            For the fire alarm contractor, the operational consequences are significant. In an HRB,
            the design and any modification to the fire alarm system feeds the golden thread —
            drawings, cause-and-effect, commissioning records all become part of the persistent
            record. Service-visit records likewise. Modifications may require BSR notification. The
            contractor's quality of documentation directly supports (or undermines) the AP's
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Enforcement notice (Art 30).</strong> Requires the responsible person to take
              specified steps to remedy a breach within a specified time. Includes the right of
              appeal to a court.
            </li>
            <li>
          ...
          <p>
            ...
            prosecutions where management failures cause death (Corporate Manslaughter and Corporate
            Homicide Act 2007), or gross negligence manslaughter against individual directors /
            senior managers. Civil claims by injured persons run in parallel and are assessed on the
            balance of probabilities (lower bar than criminal).
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              assessment failure in a sheltered housing scheme. At the time, considered a high fine.
            </li>
            <li>
              <strong>2017.</strong> R v New Look Retailers — £400,000 fine and £136,000 costs after
              a fire in an Oxford Street store; the FRA had not adequately assessed the risks of a
              particular storage configuration.
            </li>
            <li>
              <strong>2020.</strong> R v Tesco Stores — £733,500 fine after fire safety failures in
              a number of stores including blocked exits.
            </li>
            <li>
          ...
          <p>
            ...
            real and increasing — the contractor who delivers a compliant, well-documented system is
            delivering material protection. Second, the contractor's own exposure as a contributory
            party (civil claim, regulatory action against the firm, prosecution of individuals) is
            also real — the days of "the responsible person carries it all" are gone where the
            contributory failures are clear (defective design, defective install, missed
            maintenance, defective handover).
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-7/section-2')}
