...
const DESCRIPTION =
  'Understand the Regulatory Reform (Fire Safety) Order 2005, responsible person duties, fire risk assessments and enforcement powers.';
    ...
    () => [
      {
        ...
        options: ['1 January 2005', '1 October 2006', '1 April 2007', '1 January 2008'],
        correctAnswer: 1,
        explanation:
          'The RR(FS)O 2005 came into force on 1 October 2006, replacing previous fire safety legislation with a risk-based approach.',
      },
      {
        id: 2,
        ...
        correctAnswer: 1,
        explanation:
          'The Responsible Person is typically the employer, building owner, landlord or anyone with control of the premises.',
      },
      {
        id: 3,
        ...
        correctAnswer: 2,
        explanation:
          'The RR(FS)O 2005 abolished fire certificates and replaced them with a requirement for fire risk assessments.',
      },
      {
        id: 4,
        question:
          'Which premises are NOT covered by the Regulatory Reform (Fire Safety) Order 2005?',
        options: [
          'Offices and shops',
        ...
        correctAnswer: 1,
        explanation:
          'Single private dwellings are excluded from the RR(FS)O 2005 - they are covered by other regulations including Building Regulations.',
      },
      {
        id: 5,
        ...
        correctAnswer: 2,
        explanation:
          'Fire risk assessments must be reviewed regularly and particularly when there are significant changes to the premises, occupancy or use.',
      },
      {
        id: 6,
        ...
        correctAnswer: 1,
        explanation:
          'An Alterations Notice requires the Responsible Person to notify the fire authority before making changes that could increase fire risk.',
      },
      {
        id: 7,
        ...
        correctAnswer: 2,
        explanation:
          'Failure to comply with an Enforcement Notice can result in up to 2 years imprisonment and/or an unlimited fine on conviction.',
      },
      {
        id: 8,
        ...
        correctAnswer: 0,
        explanation:
          'Article 17 specifically deals with fire detection and warning requirements in regulated premises.',
      },
      {
        id: 9,
        ...
        correctAnswer: 2,
        explanation:
          'The Fire and Rescue Authority is the primary enforcing authority for the RR(FS)O 2005 in most premises.',
      },
      {
        id: 10,
        ...
        correctAnswer: 1,
        explanation:
          'A fire risk assessment must identify fire hazards, people at risk, evaluate the risks and determine appropriate preventive and protective measures.',
      },
    ],
    []
  );
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
        ...
        <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <ul className="space-y-2 text-white/80 text-sm">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong className="text-white">RR(FS)O 2005</strong> replaced fire certificates with
                a risk-based approach from 1 October 2006
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Responsible Person</strong> must conduct and maintain
            ...
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Enforcement</strong> by Fire and Rescue Authority
                with powers including prohibition notices
              </span>
            </li>
          </ul>
        </div>
      ...
      <section className="px-4 sm:px-6 pb-6 max-w-3xl mx-auto space-y-6">
        ...
        <div className="p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <div className="space-y-3 text-sm text-white/70">
            <p>
              ...
              <strong className="text-elec-yellow">1 October 2006</strong>. It applies to England
              and Wales.
            </p>
            <p>
              This legislation replaced over 70 pieces of previous fire safety law with a single,
              risk-based approach. It abolished the old fire certificate system and placed
              responsibility directly on those who control premises.
            </p>
            <div className="bg-white/5 rounded-lg p-3">
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Various sector-specific fire regulations
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <div className="space-y-3 text-sm text-white/70">
            <p>
              ...
              This is defined in Article 3 of the Order.
            </p>
            <div className="bg-white/5 rounded-lg p-3">
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  The person with control of the premises
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  The landlord (for common areas of residential buildings)
                </li>
              </ul>
            </div>
            <p>
              Where multiple people share control of premises, they must cooperate and coordinate
              their fire safety arrangements. Each person is responsible for the parts they control.
            </p>
          </div>
        </div>
        ...
        <div className="p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <div className="space-y-3 text-sm text-white/70">
            <p>
              ...
              This replaced the old fire certificate system.
            </p>
            <div className="bg-white/5 rounded-lg p-3">
              <p className="text-sm font-semibold text-white mb-2">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  <span className="w-5 h-5 rounded-full bg-elec-yellow/20 flex items-center justify-center flex-shrink-0 text-xs font-bold text-elec-yellow">
                    1
                  </span>
                  <span>
                    <strong className="text-white">Identify fire hazards</strong> - sources of
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Identify people at risk</strong> - employees,
                    visitors, vulnerable persons
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-5 h-5 rounded-full bg-elec-yellow/20 flex items-center justify-center flex-shrink-0 text-xs font-bold text-elec-yellow">
                  ...
                  <span>
                    <strong className="text-white">Evaluate risks</strong> - remove/reduce hazards,
                    protect people
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Record findings</strong> - document significant
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Review regularly</strong> - keep assessment up to
                    date
                  </span>
                </li>
              </ul>
        ...
        <div className="p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <div className="space-y-3 text-sm text-white/70">
            ...
            <div className="bg-white/5 rounded-lg p-3">
              ...
              <ul className="space-y-1 text-sm">
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow font-semibold">Art.14:</span> Emergency routes
                  and exits - adequate, kept clear, illuminated
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow font-semibold">Art.17:</span> Fire detection and
                  warning - appropriate detection and alarm systems
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow font-semibold">Art.13:</span> Firefighting
                  equipment - appropriate and accessible
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow font-semibold">Art.21:</span> Training -
                  employees receive adequate instruction
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow font-semibold">Art.22:</span> Cooperation - duty
                  to cooperate with others sharing premises
                </li>
              </ul>
            </div>
            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-3">
              <p className="text-sm text-red-300 flex items-start gap-2">
                ...
                Article 17 specifically requires fire detection and warning systems appropriate to
                the risk - this directly links to fire alarm requirements.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white/5 rounded-lg p-3">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Informal advice</strong> - guidance to improve
                    compliance
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow mt-0.5" />
                  <span>
                    <strong className="text-white">Enforcement Notice</strong> - formal requirement
                    to take action within specified timeframe
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow mt-0.5" />
                  <span>
                    <strong className="text-white">Prohibition Notice</strong> - immediate
                    restriction or closure where serious risk exists
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow mt-0.5" />
                  <span>
                    <strong className="text-white">Alterations Notice</strong> - requirement to
                    notify before making specified changes
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow mt-0.5" />
                  <span>
                    <strong className="text-white">Prosecution</strong> - criminal proceedings for
                    serious breaches
                  </span>
                </li>
              </ul>
        ...
        <div className="p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <div className="space-y-3 text-sm text-white/70">
            ...
            <div className="bg-white/5 rounded-lg p-3">
              <p className="text-sm font-semibold text-white mb-2">
                Maximum Penalties (On Indictment):
              </p>
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  <strong className="text-white">Failure to comply with duty:</strong> Unlimited
                  fine
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
            ...
            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-3">
              <p className="text-sm text-red-300 flex items-start gap-2">
                <AlertTriangle className="h-4 w-4 mt-0.5 flex-shrink-0" />
                Following the Grenfell Tower tragedy, the Fire Safety Act 2021 amended the RR(FS)O
                to clarify that it applies to the structure, external walls and flat entrance doors
        ...
        <div className="space-y-3">
          <div className="p-4 rounded-lg bg-white/5 border border-green-500/20">
            ...
            <ul className="space-y-2 text-sm text-white/70">
              <li className="flex items-start gap-2">
                ...
                they authorise changes
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                Fire risk assessments should inform fire alarm specification - reference them in
                design documentation
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                Keep records of all fire alarm work - these form part of the fire safety
                documentation
              </li>
            </ul>
          </div>
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-red-500/20">
            ...
            <ul className="space-y-2 text-sm text-white/70">
              ...
              <li className="flex items-start gap-2">
                <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                Ignoring the need to notify the fire authority before changes in premises with
                Alterations Notices
              </li>
            </ul>
          </div>
      ...
      <section className="px-4 sm:px-6 pb-6 max-w-3xl mx-auto">
        ...
        <div className="space-y-3">
          {[
            {
              q: 'Does the RR(FS)O 2005 apply to Scotland and Northern Ireland?',
              a: 'No. Scotland has the Fire (Scotland) Act 2005 and Fire Safety (Scotland) Regulations 2006. Northern Ireland has the Fire and Rescue Services (Northern Ireland) Order 2006.',
            },
            {
              q: 'Who should carry out the fire risk assessment?',
              a: 'The Responsible Person can do it themselves if competent, or appoint a competent person. For complex premises, a qualified fire risk assessor is recommended.',
            },
            {
              q: 'How often must fire risk assessments be reviewed?',
              a: 'There is no fixed period - review should be regular and triggered by significant changes such as alterations, changes in occupancy, or after a fire incident.',
            },
            {
              q: 'Does the Order apply to domestic premises?',
              a: 'Single private dwellings are excluded. However, common areas of blocks of flats, HMOs and similar residential buildings are covered.',
            },
            {
              q: 'What happens if there are multiple Responsible Persons?',
              a: 'Article 22 requires them to cooperate and coordinate. Each remains responsible for their area of control, but they must work together.',
            },
            {
              q: 'Can I appeal against an Enforcement Notice?',
              a: "Yes. Appeals are made to the Magistrates' Court (or in Scotland, the Sheriff Court) within 21 days of the notice being served.",
            },
          ].map((faq, i) => (
