...
const inlineChecks = [
  ...
  },
  {
    ...
    options: ['Soft-start', 'Anti-islanding', 'Power factor correction', 'Phase balancing'],
    correctIndex: 1,
    explanation:
...
const faqs = [
  {
    question: "What's the practical difference between G98 fit-and-notify and G99 apply-and-wait?",
    answer:
  ...
  {
    question: 'EREC G100 — when does it actually unlock additional generation capacity?',
    answer:
  ...
  {
    question: 'What does the DNO actually want from an installer applying under G99?',
    answer:
  ...
  {
    question: 'BS EN 50549-1 — what is it, and how does it relate to BS 7671?',
    answer:
  ...
  {
    question: 'How does Chapter 82 (the new PEI chapter) change the DNO conversation?',
    answer:
  ...
  {
    question: 'A4:2026 came into force 15 April 2026. Did the EREC documents change in step?',
    answer:
  ...
  {
    question: 'How should I handle a customer who refuses to accept the DNO timeline?',
    answer:
...
export default function RenewableEnergyModule1Section5() {
  ...
  useSEO({
    title: 'G98, G99 & EREC G100 — DNO conversation and timing | Renewable Energy 1.5 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 5 · BS 7671:2018+A4:2026"
        title="G98, G99 & EREC G100 — DNO conversation and timing"
        backTo="../renewable-energy-module-1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The DNO connection regime for parallel generation — fit-and-notify (G98), apply-and-wait
          (G99), export limitation (G100) — and how it interlocks with BS 7671 Section 551
          (551.7.4–551.7.6) and the new Chapter 82 PEI framework.
        </p>
        ...
        <Pullquote>
          The DNO conversation determines the timeline before the install conversation does.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">EREC G98</strong> — Fit-and-notify for generation units
              up to and including 16 A per phase. Install first, notify DNO within 28 days of
              energisation.
            </li>
            <li>
              <strong className="text-white">EREC G99</strong> — Apply-and-wait for generation units
              above 16 A per phase. Submit application, await DNO approval, then install. Timelines
              vary by region.
            </li>
            <li>
              <strong className="text-white">EREC G100</strong> — Export limitation scheme. Lets a
              customer install nameplate generation above the unconstrained connection capacity by
              capping export via a measurement / control scheme.
            </li>
          </ul>
          <p>
            EREC documents are published by the Energy Networks Association (ENA) on their own
            revision cycle, independent of BS 7671. They are non-statutory — their force comes from
            being the accepted process for connecting parallel generation to the public supply.
          </p>
          <p>
            EREC governs the application / notification process with the DNO. BS 7671 Section 551
            governs the design-and-install requirements. Both apply on every grid-tied LCT install.
            The cert evidence bundle carries both — the DNO notification reference plus the BS 7671
            EIC.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">551.7.4 — Automatic disconnection</strong> on loss of
              supply or deviation of voltage / frequency at the supply terminals from declared
              values (anti-islanding).
            </li>
            <li>
              <strong className="text-white">551.7.5 — Prevention of reconnection</strong> while the
              public supply remains absent or unstable (no autonomous re-engagement during
              restoration).
            </li>
            <li>
              <strong className="text-white">551.7.6 — Means of isolation</strong> — for generating
              sets exceeding 16 A, accessibility complies with national rules and DNO requirements.
              For ≤ 16 A, accessibility complies with BS EN 50549-1.
            </li>
          </ul>
          <p>
            For generating sets up to and including 16 A intended to operate in parallel with a
            system for distribution of electricity to the public, the requirements are given in BS
            EN 50549-1. A G98-listed inverter holds BS EN 50549-1 certification covering all three
            requirements.
          </p>
          <p>
            For generating sets exceeding 16 A, the protection type, sensitivity and operating times
            depend on the public-supply protection scheme and the number of generating sets. The
            design conversation engages the DNO directly, with the protection coordination scheme
            typically forming part of the G99 application.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Chapter 82 provides additional requirements, measures and recommendations for design,
            erection and verification of all types of low voltage electrical installations that
            include local production and / or storage of energy. Such installations are designated
            as Prosumer\'s Electrical Installations (PEIs).
          </p>
          ...
          <p>
            Chapter 82 sits alongside the technology-specific chapters (712 PV, 722 EV, Chapter 57
            BESS) and the generic generator-side chapter (551). It adds the system-level design
            discipline that the per-technology chapters do not, by definition, address.
          </p>
          <p>
            For the DNO conversation, Chapter 82 makes the PEI design holistic — the G99 application
            is for the system, not for individual inverters. The 19th Edition is expected to deepen
            Chapter 82\'s scope.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Current connection</strong> — single-phase /
              three-phase, main fuse rating
            </li>
            <li>
              <strong className="text-white">Available headroom</strong> on the local feeder
            </li>
            <li>
              <strong className="text-white">Queue position</strong> for any required upgrade or
              generation connection
            </li>
            <li>
              <strong className="text-white">Indicative timeline</strong> — in writing where
              possible
            </li>
            <li>
              <strong className="text-white">ANM area status</strong> — is the local feeder in an
              Active Network Management area?
            </li>
            <li>
              <strong className="text-white">G100 viability</strong> — would export limitation
              unlock the connection?
            </li>
          </ul>
          <p>
            ANM (Active Network Management) regions impose additional constraints. In an ANM region,
            the DNO actively manages network flows to keep within capacity — new generation
            connections may be approved with curtailment conditions (limiting export during
            high-demand periods), or refused outright if capacity is unavailable.
          </p>
          <p>
            The DNO publishes capacity heat maps; the queue position is available on request. These
            are not edge-case complications — they are routine constraints on LCT projects in 2026
            onwards.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              Unconstrained region — G98 fit-and-notify proceeds normally; G99 typical timeline
              weeks to months
            </li>
            <li>Capacity-bound — G99 timeline 12+ months; G100 may be the only viable route</li>
            <li>
              ANM region — G99 applications may be approved with curtailment conditions or refused
              outright; G100 export limitation often unlocks the install
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              Yes (to fit capacity) — add G100 documentation; underlying connection assessed under
              G99
            </li>
          </ul>
          <p>
            The three questions, answered at survey, resolve the DNO route on the majority of LCT
            installs. The residual cases (commercial multi-site portfolios, embedded generation
            behind a private network, V2G with complex export profiles) need direct DNO engagement.
          </p>
        </ConceptBlock>
