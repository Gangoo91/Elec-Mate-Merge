...
export default function RenewableEnergyModule5Section8() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 8 · BS 7671:2018+A4:2026 · Part 6 + Chapter 57 + UK Battery Regulations 2009"
        title="Periodic inspection, faults & end-of-life"
        backTo="../renewable-energy-module-5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          EICR on a BESS — what the inspector checks, how to code findings, capacity testing against
          baseline, BMS log review, fault diagnosis sequence, thermal-runaway response,
          decommissioning under UK Battery Regulations 2009 / WEEE / UN 3480-3481, second-life
          options.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Continuity of identity</strong> — kit still matches the
              install record? Any modifications since install? Any module additions to the BESS?
            </li>
            <li>
              <strong className="text-white">Reg 570.6.8.201 + .202 notices</strong> — still
              present, still legible, still in the right positions? Customer hasn’t removed them
            </li>
            <li>
              <strong className="text-white">Reg 570.6.5.201 isolators</strong> — every external
              port still has its means of isolation? Operates correctly? Labelled consistently with
              cable labelling
            </li>
            <li>
              <strong className="text-white">Cabinet + terminals</strong> — visual for corrosion,
              swelling, leakage, displacement, ventilation obstruction; terminal torque
              random-sample verification
            </li>
            <li>
              <strong className="text-white">RCD type</strong> — Type B (BS EN 62423) on
              transformerless hybrid AC side OR manufacturer declaration on file? Trip-time test
              using a Type B-capable instrument (Reg 643.1)
            </li>
            <li>
              <strong className="text-white">Part 6 AC IR test</strong> — Reg 643.3 on the AC final
              circuit to the inverter; Table 64 minima still met
            </li>
            <li>
              <strong className="text-white">BMS log review</strong> — pattern of events since the
              last inspection; comms errors; thermal alarms; cell-level voltage / SoC drift;
              deep-discharge events
            </li>
            <li>
              <strong className="text-white">Capacity test against baseline</strong> — Section 5.7
              baseline kWh delivered vs today’s measurement; fade vs industry 80%-of-rated
              convention; manufacturer’s own fade allowance under warranty
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Cabinet swelling / bulging</strong> — anything other
              than the manufacturer’s factory shape. Indicates cell gas pressure → C1 / C2 depending
              on severity; do not re-energise until manufacturer engineer confirms safe
            </li>
            <li>
              <strong className="text-white">Visible electrolyte / leakage</strong> — LFP normally
              has none; lead-acid would; any sign on an LFP install is a C1 pending investigation
            </li>
            <li>
              <strong className="text-white">Terminal corrosion</strong> — green / blue copper
              oxidation indicates moisture ingress or undersized terminations generating heat; C2
              (potential high-resistance fault, BMS may not see it until cell-level)
            </li>
            <li>
              <strong className="text-white">Mounting / displacement</strong> — backboard detaching,
              fixings loose, cabinet leaning. Reg 570.6.3 / PAS 63100 compliance impaired; C2 or C1
              depending on stability
            </li>
            <li>
              <strong className="text-white">Ventilation obstructed</strong> — customer has stored
              items above / below / against the cabinet. Manufacturer clearance impaired; C2
              (thermal management compromised); customer conversation needed at handover-style
              reminder
            </li>
            <li>
              <strong className="text-white">Notice integrity</strong> — Reg 570.6.8.201 at CU + Reg
              570.6.8.202 at access points still present and legible? C2 if missing; C3 if faded but
              still legible
            </li>
            <li>
              <strong className="text-white">Labelling consistency</strong> — every cable labelled
              at both ends, every isolator labelled, labels match the kit identity? C3 typically; C2
              if confusion could lead to wrong isolation
            </li>
            <li>
              <strong className="text-white">Cable / conduit condition</strong> — no damage, sheath
              intact, glands tight, no DC + AC co-routing introduced since install (customer or
              someone else may have added a cable run)
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Single transient event a year ago</strong>— normal.
              Note it, move on
            </li>
            <li>
              <strong className="text-white">Recurring event on the same cell</strong>— that cell is
              weakening. C3 (FI if uncertain) and recommend manufacturer warranty claim if within
              term
            </li>
            <li>
              <strong className="text-white">Thermal alarm at any time</strong> — even if it
              cleared, deserves manufacturer involvement; thermal alarms shouldn’t happen under
              normal operation
            </li>
            <li>
              <strong className="text-white">Comms errors at increasing frequency</strong> —
              intermittent cable or firmware drift; check the Modbus / CAN cable connections, check
              firmware version against current manufacturer release
            </li>
            <li>
              <strong className="text-white">Deep-discharge cut-off events</strong> — BMS protected
              the pack from over-discharge. Something prevented timely recharge: tariff misconfig,
              PV inverter fault, customer-induced setting change. Diagnose the root cause
            </li>
            <li>
              <strong className="text-white">Charge-rate violations</strong> — BMS refused a charge
              current the inverter / charger requested. Indicates C-rate mismatch between PCE
              settings and battery rating; reconfigure PCE
            </li>
            <li>
              <strong className="text-white">SoC drift</strong> — BMS’s SoC estimate has drifted
              from coulomb-counting reality. Recalibration via a full discharge / charge cycle
              usually fixes it
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Within 95% of baseline</strong> — no fade of concern;
              possibly within test-noise. Pass, record as new baseline
            </li>
            <li>
              <strong className="text-white">85-95% of baseline (5-year point)</strong>— normal LFP
              fade range. Pass, no code, record as new baseline
            </li>
            <li>
              <strong className="text-white">80-85% of baseline</strong> — accelerated fade. C3
              (improvement recommended), recommend manufacturer warranty consultation, schedule
              follow-up inspection sooner than the standard interval
            </li>
            <li>
              <strong className="text-white">Below 80% of baseline</strong> — at or past the
              industry replacement convention. C2 if customer’s functional expectation is no longer
              met; FI if the customer is content. Engage manufacturer; consider module replacement
              or whole-pack swap; warranty may apply
            </li>
            <li>
              <strong className="text-white">No baseline available</strong> — measure today’s
              capacity, compare to manufacturer nameplate × DoD × round-trip as a theoretical
              baseline; record as FI (the comparison is weaker without a real baseline). Recommend
              re-baselining if a fresh commissioning-grade test is feasible
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Step 1 — gather log evidence</strong> — BMS event log
              export, inverter error log download, customer’s description of when the fault first
              appeared, what they’d done recently
            </li>
            <li>
              <strong className="text-white">Step 2 — consult error code table</strong> —
              manufacturer manual maps every error code to likely causes and recommended actions.
              Saves cabinet-open time
            </li>
            <li>
              <strong className="text-white">Step 3 — comms check</strong> — Modbus / CAN cable
              between battery and inverter, both ends. Many "battery offline" faults are physical
              cable issues
            </li>
            <li>
              <strong className="text-white">Step 4 — firmware check</strong> — BMS firmware
              version, inverter firmware version, manufacturer cloud-reported current versions.
              Mismatches after over-the-air updates cause comms errors that look like hardware
              faults
            </li>
            <li>
              <strong className="text-white">Step 5 — config drift</strong> — has the customer
              changed tariff, charge schedule, DoD setting, app settings? Many post-commissioning
              faults are config drift, not hardware
            </li>
            <li>
              <strong className="text-white">Step 6 — physical inspection</strong> — only if Steps
              1-5 don’t identify the fault. Cabinet open per manufacturer safe-state procedure,
              terminal inspection, cable inspection, thermal imaging if available
            </li>
            <li>
              <strong className="text-white">Step 7 — manufacturer engineering</strong> — when none
              of Steps 1-6 isolate the fault, the manufacturer’s engineering line takes over. Often
              results in a module / pack replacement under warranty
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Customer immediate</strong> — evacuate the area, close
              doors / windows behind to slow oxygen ingress, do NOT open the cabinet, do NOT spray
              water, do NOT re-energise via the app or physical switch
            </li>
            <li>
              <strong className="text-white">Call 999 fire and rescue</strong> — UK fire services
              have specific lithium-battery protocols (large volumes of cooling water on cabinet
              exterior, no disassembly attempts, monitored burn-out where containment is achieved)
            </li>
            <li>
              <strong className="text-white">Call manufacturer emergency line</strong> — every major
              UK 2025-26 manufacturer has one; engineering remotely guides the customer / fire
              service / installer
            </li>
            <li>
              <strong className="text-white">Installer attendance</strong> — only after fire and
              rescue have declared the scene safe and after manufacturer engineer instruction. Wear
              appropriate PPE; assume off-gas exposure possible
            </li>
            <li>
              <strong className="text-white">Decommission decision</strong> — most
              post-thermal-event packs are decommissioned rather than repaired; manufacturer
              warranty often covers a full pack replacement; insurance may apply
            </li>
            <li>
              <strong className="text-white">Re-energisation</strong> — never re-energise without
              WRITTEN manufacturer engineer sign-off. The cert evidence bundle records the event,
              the response, the manufacturer engineer’s assessment, and the post-event decision
              (decommission vs repair) with all sign-offs
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Step 1 — discharge to safe state</strong>— via the BMS
              to manufacturer-defined safe-state SoC (typically 30-50%); NOT fully discharged
              (over-discharge creates its own thermal risk)
            </li>
            <li>
              <strong className="text-white">Step 2 — isolate at every Reg 570.6.5.201 port</strong>{' '}
              — AC grid, AC EPS (if EPS), DC battery, DC PV (if hybrid). Lock-off each isolator per
              safe-isolation procedure
            </li>
            <li>
              <strong className="text-white">Step 3 — disconnect in manufacturer order</strong> —
              manufacturer-defined disconnection sequence (battery-side DC interconnects last on
              most LFP units, to keep the BMS powered until the final step). Cap exposed DC
              terminals
            </li>
            <li>
              <strong className="text-white">Step 4 — physical removal</strong> — package per UN
              3480 (lithium-ion, packaged separately) or UN 3481 (lithium-ion, contained in
              equipment) class 9 dangerous-goods rules. Approved packaging; correct labels and
              documentation; transport via authorised carrier
            </li>
            <li>
              <strong className="text-white">Step 5 — destination</strong> — three routes: (a)
              manufacturer take-back where offered (Tesla, GivEnergy offer them — warranty
              registration helps); (b) authorised lithium- battery recycler under UK Battery
              Regulations 2009 / WEEE (Ecobat, Recyclus and similar); (c) second-life specialist for
              healthy packs going to commercial / industrial reuse
            </li>
            <li>
              <strong className="text-white">Step 6 — site close-out</strong> — remove warning
              notices (notice no longer applicable); update CU labelling to remove BESS references;
              restore the consumer unit way for other use (or leave isolated with neutral covered)
              per customer request
            </li>
            <li>
              <strong className="text-white">Step 7 — documentation</strong> — consignment note
              (WEEE), chain of custody, recycler / take-back confirmation. Cert evidence bundle for
              the decommissioning records the full chain
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Connected Energy</strong> — E-STOR platform reuses
              retired EV NMC packs (Renault Kangoo, Nissan Leaf) for stationary commercial /
              grid-scale applications at ~100 kWh-MWh scale
            </li>
            <li>
              <strong className="text-white">Manufacturer second-life schemes</strong> —
              increasingly common as the OEMs build the ecosystem (Tesla, BMW etc.); pricing and
              quality control set by the manufacturer
            </li>
            <li>
              <strong className="text-white">
                Authorised recyclers under UK Battery Regulations 2009
              </strong>{' '}
              — Ecobat, Recyclus and similar; cells are shredded under inert atmosphere, materials
              recovered (lithium, cobalt, nickel, copper, aluminium) into the materials supply chain
            </li>
            <li>
              <strong className="text-white">Chain of custody</strong> — every handover signed; WEEE
              consignment notes recorded; the cert evidence bundle for the decommissioning is a
              piece of legal compliance, not just installer record-keeping
            </li>
            <li>
              <strong className="text-white">Domestic reinstall of legacy packs</strong> —
              discouraged in 2025-26 UK domestic. New LFP at ~£300/kWh nameplate has displaced the
              older NMC / mixed-chemistry second-hand market for domestic. Second-life lives at the
