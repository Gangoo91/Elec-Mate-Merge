...
const inlineChecks = [
  ...
  {
    id: 'm3s6-g100',
    question: 'EREC G100 — export limitation. What is it and when does it apply?',
    options: [
...
const faqs = [
  ...
  {
    question:
      "What if the customer's supply is already heavily loaded — is the PV install still viable?",
    answer:
...
export default function RenewableEnergyModule3Section6() {
  ...
  useSEO({
    title: 'AC-side design & DNO export sign-off | Renewable Energy 3.6 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 6 · BS 7671:2018+A4:2026"
        title="AC-side design & DNO export sign-off"
        backTo="../renewable-energy-module-3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The PV AC side — cable sizing per Reg 712.433.104, Reg 551.7.1(d) new A4:2026
          source-connection rule, Reg 712.531.3.5.1 RCD type per inverter topology, AC SPDs per BS
          EN 61643-11, AC isolators, and the EREC G98 / G99 / G100 DNO application workflow.
        </p>
        ...
        <Pullquote>
          Dedicated RCBO. Type B RCD by default. EREC G98 fit-and-notify, G99 apply-and-wait, G100
          limits.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Dedicated RCBO on CU bus</strong> — the PV inverter
              goes on its own RCBO, connected directly to the CU busbar BEFORE the main RCD. Most
              common A4:2026-compliant arrangement
            </li>
            <li>
              <strong className="text-white">Split-load CU</strong> — CU is split into two sections,
              each with its own main RCD; PV connects to one section, the rest of the installation
              to the other. Slightly older arrangement; valid
            </li>
            <li>
              <strong className="text-white">All-RCBO CU</strong> — every circuit has its own RCBO;
              no shared main RCD. PV gets its own RCBO like every other circuit. Modern preferred
              design
            </li>
            <li>
              <strong className="text-white">Separate distribution unit / sub-board</strong> — PV
              connects to a dedicated sub-board with its own incoming feed before the main CU RCD.
              Used where CU substitution isn\'t practical
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Type B default per BS EN 62423 / 60947-2. Three permitted exceptions,
          manufacturer-evidenced.
        </Pullquote>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">
                Exception (a) — inverter provides simple separation between AC and DC sides
              </strong>
              . The inverter datasheet states this (typically per BS EN 62109-2). Cert evidence
              bundle records the datasheet extract
            </li>
            <li>
              <strong className="text-white">
                Exception (b) — separate transformer windings between inverter and RCD
              </strong>
              : the installation includes a transformer with electrically separate windings between
              the inverter and the RCD, providing simple separation. Galvanically-isolated inverters
              with internal transformers also satisfy this. Cert evidence records the inverter /
              installation arrangement
            </li>
            <li>
              <strong className="text-white">
                Exception (c) — inverter manufacturer states a Type B RCD is not required
              </strong>
              . The manufacturer\'s documented declaration is the evidence. Cert evidence bundle
              records the declaration
            </li>
          </ul>
          <p>
            Where ANY of the three exceptions apply with documented manufacturer evidence, a
            different RCD type may be selected per the manufacturer\'s instructions. NOTE 1 to the
            reg cross-refs Reg 531.3.3 (general rule: Type AC only where load current contains no DC
            components). NOTE 2 recommends installation methods that don\'t require additional RCD
            protection at all (e.g. installs with Class II equipment throughout). Without any
            exception evidence, Type B required.
          </p>
        </ConceptBlock>
        ...
        <Pullquote>
          I_z ≥ inverter rated AC. VD target 1-3%. Coordinate with RCBO characteristic.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Inverter design current per Reg 712.433.104</strong> —
              max AC current from manufacturer datasheet OR 1.1 × rated AC if not specified
            </li>
            <li>
              <strong className="text-white">RCBO rating</strong> — sized at or above inverter
              design current and below cable I_z. Typical 25 A for 5 kW inverter, 32 A for 7-8 kW
            </li>
            <li>
              <strong className="text-white">Cable I_z</strong> — at installed conditions per BS
              7671 Appendix 4. I_z (installed) = I_z (reference) × C_g × C_a × C_i (grouping ×
              ambient × insulation correction)
            </li>
            <li>
              <strong className="text-white">Voltage drop</strong> — 2 × L × R × I for single-phase.
              Target 1-3% of nominal AC (230 V). Cable upsized if VD exceeds limit
            </li>
            <li>
              <strong className="text-white">Cable type</strong> — standard 6491X or equivalent for
              AC; T&E for short runs; SWA for outdoor / buried routes
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Standard reference</strong> — BS EN 61643-11. Type-2
              (Class II) for typical UK residential without external LPS. Type-1 + Type-2 multi-zone
              for installs with external LPS per BS EN 62305
            </li>
            <li>
              <strong className="text-white">Nominal discharge current In</strong> — 5-20 kA for
              Type-2 (8/20 µs waveform)
            </li>
            <li>
              <strong className="text-white">Maximum discharge current Imax</strong> — 20-40 kA for
              Type-2
            </li>
            <li>
              <strong className="text-white">Voltage protection level Up</strong> — coordinated with
              the inverter AC input rating and downstream equipment; typically ≤1.5 kV for 230 V AC
              installs
            </li>
            <li>
              <strong className="text-white">Location</strong> — at the consumer unit (covers the
              inverter AC circuit and the rest of the CU) OR at the inverter AC output (covers the
              inverter AC stage specifically). Modern installs often have both for layered
              protection
            </li>
            <li>
              <strong className="text-white">Indicator</strong> — visual status flag or window;
              periodic inspection at 5-yearly service
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          G98 fit-and-notify ≤16 A. G99 apply-and-wait &gt;16 A. G100 limits export.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Install and commission</strong> — install the PV system
              per the design pack, commission per BS EN 62446-1 (Section 7)
            </li>
            <li>
              <strong className="text-white">Notify the DNO</strong> — submit the G98 form on the
              DNO\'s portal within 28 days of commissioning. The relevant DNO depends on the
              installation\'s region (UK Power Networks for London / SE England; Northern Powergrid
              for NE England; etc.)
            </li>
            <li>
              <strong className="text-white">Information required</strong> — installation address,
              MPAN, generator type (PV), capacity (kWp), inverter manufacturer and model, MCS cert
              number, commissioning date
            </li>
            <li>
              <strong className="text-white">DNO confirmation</strong> — typically within 5-10
              working days. Rarely objects for sub-4 kWp installs
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — archives the G98
              submission, the DNO confirmation, and the MCS certificate
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Application</strong> — submit the G99 application
              BEFORE install. Includes proposed install design, modelling, inverter datasheet,
              MCS-certified contractor reference
            </li>
            <li>
              <strong className="text-white">DNO assessment</strong> — local network capacity,
              voltage rise, thermal capacity, protection coordination, harmonic injection
            </li>
            <li>
              <strong className="text-white">DNO response</strong> — approve / approve with
              conditions / reject. Conditions often include export limitation (per EREC G100),
              voltage limits, or protection settings
            </li>
            <li>
              <strong className="text-white">Install and commission</strong> — after DNO approval;
              per the approved design
            </li>
            <li>
              <strong className="text-white">G99 commissioning notification</strong> — submit after
              commissioning per BS EN 62446-1
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — archives the G99
              application, DNO approval letter (including any conditions), commissioning
              notification, MCS cert
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Inverter built-in export control</strong> — modern
              inverters typically support: CT clamp on the grid connection, configurable export
              limit, inverter modulates output to limit export
            </li>
            <li>
              <strong className="text-white">External export-control device</strong> — separate unit
              with grid CT and signal to inverter; used where inverter doesn\'t support built-in
            </li>
            <li>
              <strong className="text-white">G100 specification requirements</strong> — measurement
              accuracy, response time, failure mode (default to limit-active on device failure)
            </li>
            <li>
              <strong className="text-white">Verification testing at commissioning</strong> —
              simulate over-export conditions; confirm limit holds; document test results
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — export limit,
              implementation method, G100 verification test results, DNO approval (if applicable)
            </li>
          </ul>
        </ConceptBlock>

        <ErecDecisionTree caption="EREC G98 / G99 / G100 decision tree — flowchart starting from the install\'s inverter AC rated current. Branch &le;16 A single-phase → EREC G98 fit-and-notify (28 days). Branch &gt;16 A → EREC G99 apply-and-wait (4-8 weeks assessment). G99 outcome branch → approved / approved with G100 limitation / rejected. G100 used to keep an install under G98 or to comply with G99 condition." />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-3-section-7')}
