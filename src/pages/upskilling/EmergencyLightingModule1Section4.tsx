...
const quizQuestions = [
  {
    id: 1,
    question: 'Which UK standard is the principal Code of Practice for emergency escape lighting?',
    options: [
  ...
  {
    id: 2,
    question: 'BS EN 1838:2024 specifies which of the following emergency lighting requirements?',
    options: [
  ...
  {
    id: 5,
    question: 'BS EN 60598-2-22 is the product standard for:',
    options: [
  ...
  {
    id: 6,
    question: 'What is the relationship between BS 5266-1 and BS EN 1838 / BS EN 50172?',
    options: [
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/electrician/upskilling/emergency-lighting-module-1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS 5266-1:2025 as the UK Code of Practice, the BS EN 1838:2024 / 50172:2024 / 50171 /
          60598-2-22 stack, and the BS 7671 §560 wiring-regulations link — how the documents fit
          together as one regime.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Section 1 — Scope.</strong> Covers escape lighting (escape route, open area /
              anti-panic, high-risk task), local-area lighting, and standby lighting. Borrowed light
              is excluded from design provision (NEW in 2025).
            </li>
            <li>
              <strong>Section 2 — Normative references.</strong> Calls up BS EN 1838:2024 for
              illuminance application, BS EN 50172:2024 for system requirements, BS EN 50171 for
              central battery equipment, BS EN 60598-2-22 for luminaires, BS 7671 for electrical
              installation, plus other supporting references.
            </li>
            <li>
              <strong>Section 3 — Terms and definitions.</strong> The vocabulary used in the
              standard — escape route, open area, high-risk task area, local area, standby lighting,
              point of emphasis, contour limits, maintained / non-maintained / sustained luminaires.
            </li>
            <li>
              <strong>Section 4 — General principles.</strong> Function (the four-plus-one
              purposes), system architecture options (self-contained / central battery / hybrid),
              design approach (risk-driven), durations.
            </li>
            <li>
              <strong>Section 5 — Design.</strong> Calculation methods, points of emphasis,
              illuminance distribution, layout. The borrowed-light exclusion sits here in Cl. 5.2.
              Direct illumination requirement.
            </li>
            <li>
              <strong>Section 6 — Wiring and electrical supplies.</strong> Cross-references BS 7671
              §560. NEW in 2025: high-risk segmentation rule (≥ 2 separate circuits, ≤ 20 luminaires
              per fault).
            </li>
            <li>
            ...
            <li>
              ...
              50172:2024. Test schedule (daily / monthly / annual / 5-year photometric). Log book
              requirements. NEW in 2025: 5-year photometric verification (Cl. 8.3).
            </li>
            <li>
          ...
          <p>
            The structure is broadly continuous with the 2016 edition; the substantive changes are
            concentrated in scope (Section 1), design (Section 5 borrowed-light), wiring (Section 6
            segmentation), and inspection (Section 8 photometric verification). The annexes have
            been refined.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              recommendations. It should not be quoted as if it were a specification or a legal
              document, and particular care should be taken to ensure that claims of compliance are
              not misleading. Following the recommendations in this Code of Practice does not in
              itself guarantee that the law has been complied with; however, it is intended to
              assist the user in complying with relevant statutory provisions.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="410" y="42" textAnchor="middle" fill="#A855F7" fontSize="11" fontWeight="bold">
              LEGAL LAYER · the duty
            </text>
            <text x="410" y="58" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              RRO 2005 · Workplace Regs 1992 · HSAW 1974 · Building Regs (Approved Doc B)
            </text>
            <text x="410" y="72" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9">
              "What you must achieve" — the legal duty on the responsible person
            </text>
            ...
            <text x="410" y="140" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="9.5">
              The integrating document — design, install, commission, operate, maintain
            </text>
            <text x="410" y="156" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              Effective 31 Oct 2025 · "How to deliver the duty" — recommendatory, not statutory
            </text>
            ...
            <text
              ...
              fontWeight="bold"
            >
              EUROPEAN NORM TECHNICAL STANDARDS · the building blocks
            </text>
            <text x="410" y="222" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              Called up as normative references by BS 5266-1:2025
            </text>
            ...
            <g>
              ...
              <text x="122" y="274" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
                Lighting application
              </text>
              <text x="122" y="290" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                1 lx escape · 0.5 lx anti-panic
              </text>
              <text x="122" y="304" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                15 lx high-risk · 5/60/0.5 s
              </text>
              <text x="122" y="318" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                2024: full open-width
              </text>
              <text x="122" y="332" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                2024: local-area lighting
              </text>
              <text
                x="122"
                y="346"
            ...
            <g>
              ...
              <text x="312" y="274" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
                System requirements
              </text>
              <text x="312" y="290" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Daily · monthly · annual
              </text>
              <text x="312" y="304" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                2024 NEW: 5-year photometric
              </text>
              <text x="312" y="318" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Log book §6
              </text>
              <text x="312" y="332" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                System architecture
              </text>
              <text
                x="312"
            ...
            <g>
              ...
              <text x="502" y="274" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
                Central battery equipment
              </text>
              <text x="502" y="290" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Performance · monitoring
              </text>
              <text x="502" y="304" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Charging · environmental
              </text>
              <text x="502" y="318" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Required for central battery
              </text>
              <text x="502" y="332" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <g>
              ...
              <text x="692" y="274" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
                Luminaire product standard
              </text>
              <text x="692" y="290" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Construction · marking
              </text>
              <text x="692" y="304" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Photometric · charging
              </text>
              <text x="692" y="318" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Mode classification (X0/X1/C)
              </text>
              <text x="692" y="332" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Required for all EL fittings
              </text>
              <text
                x="692"
                y="346"
            ...
            <text
              ...
              fontWeight="bold"
            >
              + BS 7671:2018+A4:2026 · Section 560 (Safety services)
            </text>
            <text x="410" y="414" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              Reg 560.5/.6/.7/.8/.10 — supply, wiring, segregation, sources of supply (refined under
              A4:2026)
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Escape route lighting (Cl. 4.3).</strong> 1 lx minimum across the full width
              of the escape route at floor level, with the outer 0.5 m on each side excluded for
              routes wider than 2 m and the outer ¼ width on each side excluded for routes 2 m or
              narrower. The 2024 edition replaces the 2013 wording (1 lx on the centre line + 0.5 lx
              on a 2 m central band) with this full-width rule plus edge exclusions, closing the
              loophole that allowed dim edges.
            </li>
            <li>
              <strong>Open-area / anti-panic lighting (Cl. 4.2).</strong> 0.5 lx minimum across the
              empty core area (excluding 0.5 m perimeter strip). Maximum 40:1 ratio of brightest to
              darkest point. The trigger thresholds (when this category applies) are in BS 5266-1,
              not in 1838.
            </li>
            <li>
              <strong>High-risk task area lighting (Cl. 4.4).</strong> 15 lx OR 10% of normal task
              illuminance, whichever is greater. Maximum 10:1 ratio. Switch-on within 0.5 s. Free
              from harmful stroboscopic effects. The category serves the
              continued-operation-for-safe-shutdown function.
            </li>
            <li>
              <strong>Local-area lighting (Cl. 4.5 — NEW in 2024).</strong> For occupants permitted
              to remain during the mains-failure event. Levels per the application — the 2024
              edition gives recommendations rather than a single minimum illuminance.
            </li>
            <li>
              <strong>Switch-on times (Cl. 4.3, 4.4).</strong> Escape and anti-panic: 50% of
              required illuminance within 5 s; 100% within 60 s. High-risk: 100% within 0.5 s.
            </li>
            <li>
              <strong>Photometric measurement (Cl. 5).</strong> Where measurements are taken, what
              calibration the luxmeter must have, the measurement spacing on the floor, the
              conditions for measurement (clean luminaires, mains disconnected, room in normal
              occupational state).
            </li>
          </ul>
          <p>
            The standard does not specify which premises need which categories — that is BS 5266-1's
            job. 1838 specifies the performance requirements once the category is identified. The
            2024 edition's most material additions — full-width-with-edge- exclusions escape route
            and local-area recognition — flow into the BS 5266-1:2025 design guidance.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The horizontal illuminance at floor level on the escape route shall be not less than 1
              lx across the full width of the route. For escape routes wider than 2 m, an outer
              border of 0.5 m on each side may be excluded. For escape routes of 2 m width or less,
              an outer border of one quarter of the route width on each side may be excluded. The
              maximum ratio of the maximum illuminance to the minimum illuminance along the route
              within the non-excluded width shall not exceed 40:1.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Cl. 4 — Design.</strong> Where emergency luminaires must be placed at a system
              level (escape route, open-area, points of emphasis). Cross-reference to BS EN 1838 for
              the photometric application.
            </li>
            <li>
              <strong>Cl. 5 — System architecture.</strong> Self-contained, central battery, hybrid.
              Cross-reference to BS EN 50171 for central battery equipment.
            </li>
            <li>
              <strong>Cl. 6 — Documentation and log book.</strong> What records must be kept —
              design, installation, commissioning, periodic tests, defects, repairs. Retention
              period (minimum 5 years).
            </li>
            <li>
              <strong>Cl. 7 — Inspection and testing.</strong> THE TEST SCHEDULE — daily visual
              checks for central battery indicator panels, monthly functional test of each
              luminaire, annual full-duration discharge test, NEW IN 2024: 5-year photometric
              verification.
            </li>
            <li>
          ...
          <p>
            The 5-year photometric verification is the highest-impact change in the 2024 edition.
            Previously the test regime stopped at the annual discharge test; actual measured
            illuminance was checked at commissioning and not systematically thereafter. The 2024
            edition introduces the 5-year survey as a mandatory periodic check that the actual
            illuminance still meets the BS EN 1838 levels. This catches lumen depreciation, dirt,
            decoration changes, and layout changes that the annual functional test cannot detect.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              In addition to the periodic functional and duration tests specified in this clause,
              the photometric performance of the emergency lighting installation shall be verified
              at intervals not exceeding five years. The verification shall use a calibrated
              luxmeter to measure the actual illuminance at the points of emphasis, across the full
              width of the escape route (within the BS EN 1838:2024 non-excluded boundary), across
              the empty core of any open area requiring anti-panic lighting, and at any high-risk
              task points. The measured values shall be compared to the values required by BS EN
              1838:2024. The results shall be recorded in the log book and retained for not less
              than five years.
            </>
          }
        ...
        <ContentEyebrow>
          BS EN 50171, BS EN 60598-2-22, BS 7671 §560 — the supporting cast
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Performance.</strong> Battery must support rated load for rated duration
              (typically 3 hours), with end-of-discharge cell voltage above the cut-off limit.
              Charger must replace the discharge in a defined recharge time.
            </li>
            <li>
              <strong>Monitoring.</strong> Indicator panel showing charge state, fault states, test
              results. The daily visual check (BS EN 50172:2024) is performed against this panel.
            </li>
            <li>
              <strong>Test facilities.</strong> Means to initiate functional and full-discharge
              tests; means to record results.
            </li>
            <li>
              <strong>Environmental.</strong> Battery room ventilation (especially for vented
              lead-acid), temperature limits, fire protection of the equipment.
            </li>
            <li>
              <strong>Labelling.</strong> Identification of the system, ratings, hazard warnings.
            </li>
          </ul>
          <p>
            When specifying central battery, require BS EN 50171 compliance in the specification
            document. The manufacturer's declaration of compliance, plus the CE / UKCA marking of
            the equipment, demonstrates conformity. Cross-reference also to BS 7671:2018+A4:2026
            §560 for the electrical installation aspects of the supply.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Mode classification.</strong> Type X0 (non-maintained), Type X1 (maintained),
              Type C (combined / sustained). Each mode has specific requirements for operating
              behaviour.
            </li>
            <li>
              <strong>Battery integration.</strong> The internal battery must be matched to the
              luminaire's load and rated duration. Charging must be controlled to preserve battery
              life. Monitoring must indicate readiness, fault state, and end-of-life.
            </li>
            <li>
              <strong>Changeover.</strong> The luminaire must change from mains operation to battery
              operation automatically and within the BS EN 1838 switch-on time (5 s for general
              escape; 0.5 s for high-risk).
            </li>
            <li>
              <strong>Photometric performance.</strong> The luminaire's declared photometric data
              must be reliable for design calculations. Manufacturer's LDT files (lighting data)
              used in design software conform to standardised formats.
            </li>
            <li>
              <strong>Marking.</strong> Rating plate must show mode, duration, IP rating, voltage,
              lamp type, manufacturer identification, batch / serial number.
            </li>
          </ul>
          <p>
            On site, verify product compliance at procurement (data sheet declares 60598-2-22) and
            at installation (rating plate visible after install). The certificate trail at handover
            includes product compliance evidence — typically the manufacturer's DoC (Declaration of
            Conformity) plus type-test results.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Reg 560.5 (Circuits).</strong> Safety service circuits must be independent of
              other circuits and identified clearly.
            </li>
            <li>
              <strong>Reg 560.6 (Wiring systems).</strong> Cables for safety services have specific
              requirements — fire resistance for circuits whose continued operation is required
              during fire conditions, e.g. central battery feeds to emergency luminaires in some
              applications.
            </li>
            <li>
              <strong>Reg 560.7 (Segregation).</strong> Safety service circuits must be segregated
              from non-safety circuits to prevent fault propagation.
            </li>
            <li>
              <strong>Reg 560.8 (Sources of supply — general).</strong> Requirements for independent
              sources of supply.
            </li>
            <li>
              <strong>Reg 560.10 (Sources of supply — refined under A4:2026).</strong>
              Specific requirements for the source of supply for safety services. The 2026 amendment
              refined the wording and clarified the requirement for monitoring, automatic transfer,
              and changeover behaviour.
            </li>
            <li>
              <strong>Reg 560.11 (Wiring — protection).</strong> Protection from disconnection of
              safety service circuits during faults on other circuits.
            </li>
          </ul>
          <p>
            The certificate trail for emergency lighting therefore includes BOTH a BS 5266
            certification (design / install / commission / photometric) AND a BS 7671 Electrical
            Installation Certificate or EICR covering the supply and wiring of the system. The two
            are produced by complementary disciplines — lighting specialist and electrical
            contractor — though increasingly delivered by integrated teams.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The source of supply for safety services shall be one of the following: (a) storage
              batteries; (b) primary cells; (c) generator sets independent of the normal supply; (d)
              a separate feeder of the supply network independent of the normal feeder. The source
              of supply shall be capable of supplying the rated current of the safety service
              equipment for the rated duration. Automatic transfer between the normal and safety
              supply shall be provided, and the transfer arrangement shall comply with the
              requirements of the relevant product standards for the safety service equipment.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Statutory guidance.</strong> Issued by Department for Levelling Up, Housing
              and Communities (DLUHC) under the Building Regulations 2010. "Statutory guidance"
              means: following it satisfies the regulation; departing from it is permitted but the
              alternative method must demonstrate equivalent or better outcome.
            </li>
            <li>
              <strong>Cl. 5 list of premises.</strong> Internal corridors &gt; 30 m, escape stairs,
              basements / windowless areas, places of assembly, sleeping accommodation, escape
              routes serving high-risk areas, lifts, toilets above threshold, plant rooms.
            </li>
            <li>
              <strong>Reference to BS 5266-1.</strong> "Emergency lighting should comply with BS
              5266-1." The Approved Document tells you what category of premises needs EL; BS 5266-1
              tells you how to engineer it.
            </li>
            <li>
              <strong>Application.</strong> Applies to new build, material alteration, change of
              use. Does not apply retroactively to existing buildings (the RRO applies to existing
              buildings; Approved Document B applies at the point of construction work).
            </li>
            <li>
              <strong>Higher-risk buildings.</strong> Following the Building Safety Act 2022,
              higher-risk buildings are now regulated by the Building Safety Regulator. Approved
              Document B continues to apply but the enforcement authority for HRBs has changed.
            </li>
            <li>
              <strong>Devolution.</strong> Wales has parallel Approved Documents under the Welsh
              Building Regulations; Scotland uses the Technical Handbooks under the Building
              (Scotland) Regulations; Northern Ireland uses the Building Regulations (NI) Technical
              Booklet E. The principles are similar; the document references differ.
            </li>
          </ul>
          <p>
            The combination of Approved Document B (where), BS 5266-1:2025 (how), and the RRO 2005
            (legal duty) is the typical compliance route for new build / alteration projects.
            Building Control checks Approved Document B at design stage; the BS 5266-1 documentation
            pack delivers the technical evidence; the RRO continues to apply once the building is
            occupied.
          </p>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Industry guidance — ICEL, LIA, BAFE, manufacturer technical notes
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>ICEL (Industry Committee for Emergency Lighting).</strong> Industry committee
              producing technical guidance, training, and the ICEL Approved Contractor scheme. ICEL
              guidance documents (e.g. ICEL 1001 Self-contained emergency luminaires; ICEL 1004
              Central battery systems; periodic updates) provide practical detail beyond the
              standard. ICEL Approved Contractor registration is increasingly required by insurers
              and large clients.
            </li>
            <li>
              <strong>LIA (Lighting Industry Association).</strong> Industry body covering lighting
              more broadly. Produces technical statements on emerging topics, interfaces with
              standards committees, runs technical training. LIA-aligned competence (e.g. LIA
              Lighting Diploma) is recognised in the trade.
            </li>
            <li>
              <strong>BAFE SP203.</strong> Competence scheme for fire safety contractors.
              BAFE-registered contractors have demonstrated competence to install, service, and
              maintain emergency lighting (and other fire safety systems). Increasingly a
              procurement requirement.
            </li>
            <li>
              <strong>Manufacturer technical notes.</strong> The major emergency lighting
              manufacturers (Hochiki, Eaton, Mackwell, Beghelli, Tridonic, etc.) publish technical
              notes on product application, lighting design software (Relux, DIALux EVO),
              commissioning support. Specific to their product line but generalisable to similar
              products.
            </li>
            <li>
            ...
            <li>
              <strong>HSE guidance.</strong> The Health and Safety Executive publishes general
              guidance (e.g. HSG107 — though that is PAT-related) and sector specifics that are
              relevant to emergency lighting in some industrial contexts.
            </li>
          </ul>
          <p>
            Industry guidance is supplementary, not substitute. It is updated more frequently than
            standards; it covers practical questions standards do not detail; it provides the trade
            context. Use it alongside the standard, not instead of it. Cite both in your design
            documents.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Healthcare — HTM 06-01 (Electrical services supply and distribution).</strong>{' '}
              Department of Health technical memorandum. Covers hospital electrical infrastructure
              including IPS / UPS / safety services. Cross-references BS 5266 and BS EN 50171.
              Mandatory reading for hospital projects.
            </li>
            <li>
              <strong>Education — BB 100 (Design for fire safety in schools).</strong>
              Department for Education building bulletin. Includes emergency lighting provisions for
              educational premises. Used alongside Approved Document B.
            </li>
            <li>
              <strong>Places of assembly — Purple Guide.</strong> Health and Safety at Outdoor
              Events. Industry guide for organisers. Includes temporary emergency lighting
              provisions. Used alongside event-specific risk assessment.
            </li>
            <li>
              <strong>Care homes — CQC fundamental standards.</strong> Care Quality Commission
              registration requirements. Include fire safety and emergency lighting expectations.
              Used alongside the RRO and BS 5266-1.
            </li>
            <li>
              <strong>Prison estate, MoD, transport — sector-specific.</strong> Each has its own
              supplementary guidance. Project teams in those sectors must reference the applicable
              sector guide.
            </li>
            <li>
              <strong>HMOs — local authority HMO standards.</strong> Many local authorities publish
              HMO licensing standards including emergency lighting in shared parts. Used alongside
              the RRO.
            </li>
          </ul>
          <p>
            Sector-specific overlays do not replace the general standards stack — they sit on top. A
            care home design follows BS 5266-1:2025 PLUS CQC fundamental standards PLUS local
            authority HMO requirements (if applicable). A hospital design follows BS 5266-1:2025
            PLUS HTM 06-01 PLUS the Building Safety Act for higher-risk buildings.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              Workplace Regulations 1992 Reg 8 (workplaces); HSAW Act 1974 (general duty); Building
              Regulations 2010 (applied at construction). Tells you THAT you must provide adequate
              emergency lighting.
            </li>
            <li>
              <strong>Layer 2 — statutory guidance.</strong> Approved Document B Vol 2 cl. 5
              (England); parallel documents in Wales / Scotland / Northern Ireland. Tells you WHERE
              emergency lighting is required as a means of compliance with Building Regs. References
              BS 5266-1.
            </li>
            <li>
              <strong>Layer 3 — UK Code of Practice.</strong> BS 5266-1:2025 — the integrating
              standard. Tells you HOW to design, install, commission, operate, and maintain
              emergency lighting. Calls up the European Norms below.
            </li>
            <li>
              <strong>Layer 4 — European Norms (technical building blocks).</strong> BS EN 1838:2024
              (lighting application — what light to deliver); BS EN 50172:2024 (system requirements
              — how the system works); BS EN 50171 (central battery equipment); BS EN 60598-2-22
              (luminaire product standard). The technical detail underlying BS 5266-1:2025.
            </li>
            <li>
              <strong>Layer 5 — wiring regulations.</strong> BS 7671:2018+A4:2026 Section 560
              (Safety services). The electrical installation requirements — supply, wiring,
              segregation, sources. Refined under A4:2026.
            </li>
            <li>
              <strong>Layer 6 — sector-specific guidance.</strong> HTM 06-01 (healthcare), BB 100
              (education), Purple Guide (events), CQC standards (care), Building Safety Regulator
              (higher-risk buildings). Layered on top for specific premises types.
            </li>
            <li>
              <strong>Layer 7 — industry guidance.</strong> ICEL, LIA, BAFE, manufacturer technical
              notes. Practical detail and competence schemes. Supplementary material.
            </li>
          </ol>
          <p>
            When asked "what standard applies?" the answer is rarely just one. A typical project
            draws on every layer. The deliverable for the responsible person is a documentation pack
            proving compliance with every applicable layer. Cite the layers in the design
            certificate, the commissioning certificate, and the maintenance regime. The pack is the
            defence.
          </p>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            {
              question: 'Is following BS 5266-1:2025 enough for full legal compliance?',
              answer:
            ...
            {
              question: 'Can I still rely on BS 5266-1:2016 for an existing system?',
              answer:
            ...
            {
              question: 'How often are these standards updated?',
              answer:
            ...
            {
              question: 'Do I need to physically own a printed copy of every standard?',
              answer:
