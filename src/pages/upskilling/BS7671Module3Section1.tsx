...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'TN-S provides separate neutral (N) and protective earth (PE) conductors throughout, giving the most reliable earthing arrangement with low earth fault loop impedance.',
  },
  {
    id: 'pme-risk',
    ...
    correctIndex: 2,
    explanation:
      'In TN-C-S systems, if the supply neutral fails, all earthed metalwork can become live because the PEN conductor combines neutral and earth.',
  },
  {
    id: 'tt-system',
    ...
    correctIndex: 1,
    explanation:
      'TT systems have high earth fault loop impedance (often >200Ω) due to the independent earth electrode, making RCD protection essential as conventional overcurrent devices cannot operate fast enough.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "TN-C-S (PME) is most common in UK domestic installations because it's economical for supply networks while providing reliable earthing.",
  },
  {
    question: 'When would you use an IT system?',
    answer:
      "IT systems are used where continuity of supply is critical - operating theatres, intensive care units, process industries, and safety-critical systems where the first fault shouldn't cause disconnection.",
  },
  {
    question: 'Can TN-C-S be used for outdoor or mobile installations?',
    answer:
      'No. TN-C-S cannot be exported for outdoor installations, caravan sites, marinas, or mobile equipment due to the risk of neutral conductor failure.',
  },
  {
    question: 'What is typical earth fault loop impedance for TN-S?',
    answer:
      'TN-S systems typically have Zs of 0.8Ω or less, ensuring reliable automatic disconnection of supply operation.',
  },
];
...
const quizQuestion = {
  ...
  correctAnswer: 2,
  explanation:
    'IT systems allow continued operation during the first earth fault, giving time to locate and repair the fault without interrupting critical medical equipment. An insulation monitoring device provides early warning.',
};
...
const BS7671Module3Section1 = () => {
  useSEO({
    ...
    description:
      'Master electrical earthing systems including TN-S, TN-C-S (PME), TT, and IT. Learn safety implications, protection requirements, and system selection for different installations.',
  });
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>TN-S:</strong> Separate N & PE - most reliable earthing
              </li>
              <li>
                <strong>TN-C-S:</strong> PME - common UK domestic supply
              </li>
              <li>
                <strong>TT:</strong> Independent earth electrode - RCD essential
              </li>
              <li>
                <strong>IT:</strong> Isolated supply - critical applications
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Supply:</strong> What DNO provides
              </li>
              <li>
                <strong>Safety:</strong> Fault current paths
              </li>
              <li>
                <strong>Continuity:</strong> Critical applications
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The TN-S system provides separate neutral (N) and protective earth (PE) conductors
              throughout the entire installation, from the supply transformer to final circuits.
              This separation provides the most reliable earthing arrangement.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Low Zs:</strong> Typically 0.8Ω or less for reliable ADS
                  </li>
                  <li>
                    <strong>No N-E voltage:</strong> Separate conductors eliminate voltage
                  </li>
                  <li>
                    <strong>Predictable faults:</strong> Reliable fault current for protection
                  </li>
                  <li>
                    <strong>EMC performance:</strong> Better compatibility, separate earth
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Commercial:</strong> Office complexes, shopping centres
                  </li>
                  <li>
                    <strong>Industrial:</strong> Data centres, manufacturing plants
                  </li>
                  <li>
                    <strong>Residential:</strong> New housing estates, apartments
                  </li>
                  <li>
                    <strong>Specialist:</strong> Schools, hospitals (non-critical areas)
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              TN-C-S combines neutral and earth (PEN conductor) in the supply network but separates
              them at the service position. The neutral is earthed at multiple points along the
              supply network - hence "Protective Multiple Earthing."
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Economic supply:</strong> 3-core instead of 4-core cables
                  </li>
                  <li>
                    <strong>Reliable earth:</strong> Multiple connections provide stability
                  </li>
                  <li>
                    <strong>Good fault performance:</strong> Low Zs when system intact
                  </li>
                  <li>
                    <strong>Wide availability:</strong> Standard UK domestic supply
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Neutral failure:</strong> All earthed metalwork becomes live
                  </li>
                  <li>
                    <strong>N-E voltage:</strong> Voltage appears under load
                  </li>
                  <li>
                    <strong>Broken neutral:</strong> Over/under voltage on circuits
                  </li>
                  <li>
                    <strong>Export prohibition:</strong> Not for portable/mobile use
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-transparent border border-red-500/30 my-6">
              <p className="text-sm font-medium text-red-400 mb-2">
                Warning: Enhanced Bonding Required
              </p>
              <p className="text-xs text-white mb-2">
                TN-C-S systems require comprehensive main equipotential bonding due to neutral
                failure risk:
              </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              In TT systems, the installation earth is independent of the supply earth. The
              installation requires its own earth electrode, typically with earth fault loop
              impedance exceeding 200Ω. This high impedance makes RCD protection essential.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Independent earth:</strong> Isolated from supply faults
                  </li>
                  <li>
                    <strong>No export restrictions:</strong> Suitable for mobile equipment
                  </li>
                  <li>
                    <strong>Supply independence:</strong> No dependency on supply earth
                  </li>
                  <li>
                    <strong>Retrofit capability:</strong> Where supply earth unavailable
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>RCD essential:</strong> 30mA for sockets and most circuits
                  </li>
                  <li>
                    <strong>Earth electrode:</strong> Proper design and installation
                  </li>
                  <li>
                    <strong>Ra × IΔn ≤ 50V:</strong> Earth resistance calculation essential
                  </li>
                  <li>
                    <strong>Seasonal check:</strong> Resistance changes with weather
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              IT systems have the supply either isolated from earth or connected through high
              impedance. The first earth fault does not require immediate disconnection, allowing
              continued operation whilst the fault is located and repaired.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Continuity:</strong> First fault allows continued operation
                  </li>
                  <li>
                    <strong>Enhanced safety:</strong> Low first fault current
                  </li>
                  <li>
                    <strong>Early warning:</strong> IMD provides advance notice
                  </li>
                  <li>
                    <strong>Planned maintenance:</strong> Repair during scheduled downtime
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>IMD:</strong> Insulation monitoring with audible/visual alarm
                  </li>
                  <li>
                    <strong>Second fault:</strong> Overcurrent or RCD protection required
                  </li>
                  <li>
                    <strong>Skilled personnel:</strong> Competent persons for maintenance
                  </li>
                  <li>
                    <strong>System complexity:</strong> Higher installation requirements
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-transparent border border-white/10 my-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  <ul className="space-y-0.5">
                    <li>
                      <strong>TN-S:</strong> New installations with dedicated supply
                    </li>
                    <li>
                      <strong>TN-C-S:</strong> Standard domestic/commercial supply
                    </li>
                    <li>
                      <strong>TT:</strong> Remote locations or supply restrictions
                    </li>
                    <li>
                      <strong>IT:</strong> Critical applications requiring continuity
                    </li>
                  </ul>
                </div>
                <div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-transparent border border-orange-500/30">
              <p className="text-sm font-medium text-orange-400 mb-3">
                Hospital Emergency Power System Failure
              </p>
              <div className="text-sm space-y-3">
                <p>
                  <strong>Situation:</strong> A contractor installs a TN-C-S system for emergency
                  medical equipment, not realising the critical nature of supply continuity.
                </p>

                <p>
                  <strong>Problem:</strong> During a neutral conductor fault, all emergency
                  equipment loses earth reference simultaneously, compromising patient safety.
                </p>
                ...
                <p>
                  <strong>Correct Solution:</strong> IT system specified with insulation monitoring,
                  ensuring first earth fault doesn't interrupt critical medical equipment. Patient
                  safety maintained through continued supply during fault conditions.
                </p>
              </div>
            </div>
          </div>
