    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Specifying cabling for 15-20 years — Class headroom (Cat 6A / Class EA as the 2026
          default), outlet density for PoE-everything growth, pathway capacity for service
          additions, fibre-to-the-edge for high-bandwidth-emerging zones, and the new BS
          7671:2018+A4:2026 deltas (§716 PoE, §545 ICT functional earthing) that change the design
          constraints from 15 April 2026.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              Class EA is the 2026 default — delivers 10GBASE-T to 100 m, supports Type 4 PoE under
              §716 with proper bundle management, headroom for emerging services. Cat 5e cannot
              deliver 10G at 100 m and is below the §716.521.101 practical default. Cat 7 / 7A and
              Cat 8 are niche. Cat 6A is the right answer for general office, back-of-house, retail,
              education, healthcare general areas.
            </li>
            <li>
              ...
              cable per fixture), ceiling sensors, ceiling cameras, access-control devices at every
              door. Doubling first-fit count is small money during the cable pull.
            </li>
            <li>
              <strong>3. Pathway capacity.</strong> Containment, conduit, trunking, ceiling void
              allocation. Sized at first fit for 2x-3x current cable count so future cable pulls can
              be made without breaking trunking or re-cutting the building. BS EN 50174-2 /
              TIA-569-E recommend pathway fill below 40-50 % at first fit. The cable cost is small;
              the labour cost of re-pulling in inadequate containment is huge. Pathway capacity is
              the second cheap service-independence lever.
            </li>
            <li>
              <strong>4. Fibre-to-the-edge presence.</strong> Single-mode fibre alongside Cat 6A in
              high-density-wireless / broadcast / lecture / data-centre-adjacent zones. Cat 6A
              handles today (Type 4 PoE, 10GBASE-T uplink); fibre handles tomorrow (25/40/100 GBASE
              services of the 2030s). Marginal first-fit cost is small; future-fit cost in an
              occupied building is large. Targeted pattern, not blanket.
            </li>
          </ul>
          <p>
            Each lever is decided at SPEC time. The install delivers the spec to certifiable Class.
            The cabling carries the foreseeable services for 15-20 years.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              §716.523.1.101 NOTE 2 references (PD CLC/TR 50174-99-1, BS ISO/IEC 14763-2, ISO/IEC TS
              29125).
            </li>
            <li>
              <strong>§545 — ICT functional earthing.</strong>{' '}
              <AmendmentBadge regs={['545']} edition="A4:2026" /> Entirely new in A4:2026.
              Distinguishes functional earthing of ICT equipment (signal reference, EMC mitigation,
              BS EN 50310 bonding network) from protective earthing under §543/544 (electrical
              safety, fault-current path). Introduces the MFET (main functional earthing terminal)
              and minimum 2.5 / 4 mm² Cu CSAs for functional earthing conductors. Couples directly
              to the cable-screen functional-earth references in §716.414.1.1 NOTE 2.
            </li>
            <li>
            ...
            <li>
              ...
              combination of §444 + §528 is the practical framework for Band I (data / ELV) vs Band
              II (LV power) separation inside containment.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <br />
              The cross-sectional area of every functional bonding conductor or functional earthing
              conductor shall be capable of withstanding all mechanical and thermal stresses caused
              by the expected operational current. This current shall be determined in accordance
              with the manufacturer{"'"}s instructions or by measurement taking into account the ICT
              equipment or system.
              <br />
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              labour dominates and is similar across grades. The premium is small in absolute terms.
            </li>
            <li>
              <strong>Years 1-3.</strong> Both specifications work for laptops + phones + light PoE.
              No re-cabling cost on either. Service-independent has headroom; minimal-grade does
              not.
            </li>
            <li>
              <strong>Years 3-7.</strong> PoE-everything rollout starts (LED lighting, high-density
              APs, sensors, cameras, access). Service-independent cabling absorbs it without
              re-cabling. Minimal-grade cabling needs partial or full re-pull — at 5-10x the
              first-fit cost differential because access labour in an occupied building is enormous.
            ...
            <li>
              <strong>Years 15-20.</strong> Cabling end-of-life. Service-independent infrastructure
              has delivered 15-20 years of service-independence and is now up for refresh against
              new emerging services. Total lifetime cost: first-fit premium + minimal moves / adds /
              changes. Minimal-grade has been re-cabled once or twice along the way.
            </li>
          </ul>
          <p>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              IP phones for two years. In year three, the tenant rolls out PoE-LED ceiling lighting,
              high-density APs, IP cameras — the cabling cannot deliver: no ceiling outlets, no
              PoE-rated bundle thermal headroom, Cat 5e cannot do 10G to the AP. Re-cabling cost:
              5-10x the original first-fit premium that would have prevented it. Tenant is angry;
              contractor is not on the bid list for the next phase.
            </>
          }
          doInstead={
            <>
              ...
              high-density zones, plan PoE bundle thermal management per BS 7671 §716. Document the
              spec as service-independent in the BS EN 50174-1 / TIA-606-D administration record.
              Quote the lifecycle curve to the QS. Stick to the spec when the QS pushes back. The
              re-cabling cost the contractor avoids is 5-10x the first-fit premium argued over.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              cable to laptop-and-phone density. The tenant wants to roll out full PoE-everything in
              2026: Type 4 PoE-LED lighting, high-density APs, IP cameras, sensors, access control.
              The QS is asking whether a re-cable is necessary or whether the existing Cat 5e can be
              patched up.
            </>
          }
          whatToDo={
            <>
              Three checks. (1) Class / Category: Cat 5e cannot deliver 10GBASE-T at 100 m (it tops
              out at 1 GBASE-T) — high-density APs need 10G uplink. The cable is undersized for the
              service. (2) Outlet density and pathway capacity: a 2008 laptop-and-phone density does
              not include ceiling outlets for APs / lighting / sensors; a re-cable is forced anyway
              to reach the new outlet locations. (3) BS 7671 §716 from 15 April 2026: PoE on Cat 5e
              is permitted by the §716.521.101 cable category list (Cat 5 is in the list), but the
              bundle thermal management requirements and conductor design current cap of 750 mA are
              tighter on the older cable, and Cat 5e is below the 2026 commercial practical default.
              The combination of (1) + (2) + (3) makes the case for a re-cable to Cat 6A LP-rated,
              doubled outlet density, upsized containment, fibre-to-the-edge to the high-density-AP
              zones. The first-fit cost is real; the alternative — living with a constrained service
              set on cabling that cannot absorb the rollout — has zero service-independence over the
              next 15 years.
            </>
          }
          whyItMatters={
            <>
              ...
              pitch lands hardest. The 2008 spec did its job for 15 years; it cannot stretch to 2026
              services. The right answer is rarely "patch and live with it" because the patches do
              not absorb the next 15 years of services either. The right answer is a
              service-independent re-cable that does. Quote Cat 6A, doubled outlets, upsized
              pathways, fibre to high-density zones, BS 7671 §716 compliant PoE thermal management,
              channel-certified to TIA-1152-A Level V with comfortable margins, BS EN 50174-1 /
              TIA-606-D administration. The client buys 15 years; the contractor delivers a job that
              does not need to be re-done in three.
            </>
          }
        />
