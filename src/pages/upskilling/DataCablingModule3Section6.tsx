    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The diagnostic stack — Visible Fault Locator, OTDR baseline comparison, IEC 61300-3-35
          endface inspection — the cleaning protocols (IBC click cleaners, lint-free + IPA), BS EN
          60825-2 laser safety discipline, the complete handover package, and the maintenance
          schedule that lets the FM team manage a fibre infrastructure across its 15-25 year design
          life.
        </p>
        ...
        >
          ...
          <p>
            ...
            before any optical inspection. Use the fibre microscope or video probe in its protected
            mode (most modern devices include filtering / protection automatically). Never override
            the protection.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              the accessible emission limit at any reasonable point of access along the cabling. The
              classification depends on the source power, the wavelength and the accessibility of
              the optical signal. Class 1 systems are inherently safe under normal use; Class 1M
              systems are safe to the naked eye but require precautions where magnifying optics may
              be used; Class 3R systems require restricted access and trained-operator protocols.
              Warning labels and access markings shall be applied where required by the
              classification.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              <strong>Visible Fault Locator (VFL).</strong> 650 nm red laser pen, typically Class 2
              or Class 3R per BS EN 60825-1. Inject visible light into the fibre. See where it leaks
              (macrobend, break, near-end fault). Reach: ~5-10 km on MM, similar on SM. Cannot
              measure loss; cannot characterise splices. Fast pass / fail tool for continuity /
              break / bend questions.
            </li>
            <li>
          ...
          <p>
            ...
            running OTDR traces when a 30-second VFL test would have answered the question is wasted
            time. Equally, declaring a link working from a VFL pass without an OLTS loss test is
            sloppy commissioning.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Never use compressed air on the ferrule endface.</strong> Drives contaminants
              further into the cavity. (Compressed air does have valid applications elsewhere in
              fibre work — port adapters, outer cable surfaces.)
            </li>
            <li>
              <strong>Never accept a connector that fails inspection without cleaning.</strong> The
              five minutes are the loss budget.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>As-built records.</strong> BS EN 50174-1 §6 / TIA-606-D — labels, identifiers,
              panel layouts, splice tray layouts, drawings, administration data.
            </li>
            <li>
            ...
            <li>
              <strong>Manufacturer warranty registration.</strong> Confirmation that the warranty is
              registered against the as-built and the commissioning package.
            </li>
            <li>
              <strong>Fault escalation contacts.</strong> Original contractor, manufacturer support,
              specialist sub-contractors (e.g. fibre splicing).
            </li>
            <li>
            ...
            <li>
              <strong>Conformance declaration.</strong> Signed contractor statement of installation
              conformance to manufacturer guidelines.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Pre-upgrade Tier 1 re-verification.</strong> Before any service-class upgrade
              (e.g. 10G to 25G), re-test against the new transceiver budget. Remediate any excess
              loss before the new service goes live.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              fault-fighting an undocumented system for the rest of its life. For new installations,
              NEVER accept a fibre handover without the complete commissioning package — earn the
              asset by demanding the documentation.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              launch / tail cords. Compare events against the baseline — look for any new event at a
              position consistent with the 8th-floor refurbishment. If found, walk the cable route
              to that position and visually inspect for damage. Likely scenarios: a screw or fixing
              has penetrated the cable, a cable tie has been re-tightened too aggressively
              (macrobend), or a partition support has been added that flexes the cable. Remediate by
              splicing out the damaged section or replacing the affected length. Re-test
              bidirectional dual-wavelength; confirm the new trace matches the baseline (or a new
              baseline if the topology has changed). Document the fault, the cause, the remediation,
              and the new baseline in the as-built record. Brief the FM team on the building-works
              coordination procedure that should have been followed (notification of any work near
              cabling routes), to prevent recurrence.
            </>
          }
          whyItMatters={
            <>
              The day-one baseline is what makes this fault tractable. Without it, the investigation
              is forensic — walking 100 m of riser route with a torch looking for damage. With it,
              the OTDR pinpoints the fault to within a metre, the visual inspection confirms, and
              remediation is a one-day splice job. The 25-year warranty remains intact because the
              fault was caused by third-party damage (post-handover building works), not by the
              original install — but only if the documentation supports that conclusion. The full
              commissioning package is the evidence base.
            </>
          }
        />
