...
const inlineChecks = [
  {
    ...
    options: [
      'In a central cabinet feeding many luminaires.',
      'INSIDE EACH LUMINAIRE — every emergency luminaire contains its own dedicated battery, charging circuit, lamp/LED, and test electronics. The mains supply charges the battery during normal operation; on mains failure, the local battery powers the local lamp for the rated autonomy duration. Each luminaire is electrically independent: a fault in one luminaire (failed battery, failed lamp, failed driver) affects only that luminaire and does not propagate to its neighbours. This independence is the architectural strength of self-contained systems and why they dominate retrofits and small-to-medium installations.',
      'In a remote panel powering only the emergency lamp.',
      'There is no battery — the system runs from mains.',
    ],
    correctIndex: 1,
    explanation:
      'Self-contained = battery inside the luminaire. Each luminaire is independent. The architecture is fault-tolerant by isolation: a failed luminaire takes only itself out. The trade-off is multiple distributed batteries to maintain (one per luminaire) versus one central battery system to maintain.',
  },
  {
    id: 'elm4-s2-central',
    question:
    ...
    options: [
      'No specific standard; any UPS will do; failure has no consequence.',
      'BS EN 50171:2021 — the standard for central power supply systems for safety services. It specifies the cabinet construction, battery management, automatic mains-failure changeover, monitoring, and 24-hour recharge capability. Cabinet failure is catastrophic: every luminaire on the system goes dark simultaneously because all luminaires share the single central battery. This is why BS 8519 typically demands PH120 + water-spray cable on the feeds, why high-criticality systems use redundant cabinets or duty/standby arrangements, and why central battery cabinets are located in fire-protected enclosures with independent supply.',
      'BS EN 50172 only.',
      'Only the manufacturer\'s instructions apply.',
    ],
    correctIndex: 1,
    explanation:
      'BS EN 50171:2021 is the dedicated central-power-supply standard. The single point of failure (the cabinet) is what drives the cable specification, the location requirements, and the redundancy considerations. Central systems concentrate the fault risk in one place; self-contained systems distribute it across many.',
  },
  {
    id: 'elm4-s2-hybrid',
    question:
    ...
    options: [
      'All self-contained.',
      'All central battery.',
      'Hybrid — central battery for the high-criticality areas (plant rooms, escape stair cores, central concourses) where cable specification, redundancy, and centralised maintenance justify the cabinet capital cost, and self-contained luminaires for the medium and low-criticality areas where retrofit ease, distributed fault tolerance, and lower per-luminaire cost dominate. The hybrid architecture matches investment to risk and avoids over-engineering the lower-criticality areas while protecting the high-criticality ones to the highest standard.',
      'A switch between modes depending on day of week.',
    ],
    correctIndex: 2,
    explanation:
      'Hybrid is common in real installations. The decision driver is risk × area type. High-criticality justifies central; lower-criticality is more economic with self-contained. Mixed-use buildings rarely fit a single architecture cleanly.',
  },
  {
    id: 'elm4-s2-recharge',
    question:
    ...
    options: [
      '4 hours.',
      'No requirement.',
      '24 hours to at least 80% of rated capacity, with full recharge typically within a longer window. The 24-hour figure ensures the system is back to at least working capacity within one day of a discharge event — important because the building remains occupied and another mains failure could occur before full recharge. The 80% threshold is the practical "operational" capacity for emergency duty; 100% recharge can take longer and is monitored separately. The same logic appears in BS EN 50172 for the system as a whole.',
      '7 days.',
    ],
    correctIndex: 2,
    explanation:
      'Recharge to 80% within 24 hours is the BS EN 50171 + 50172 requirement. It exists because emergency systems must be operational for the next event, not retired for a week of recovery after the last one.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      'It has no battery.',
      'It contains its own dedicated battery, charging circuit, lamp/LED, and test electronics inside the luminaire body — fully independent of any central supply for emergency duty. The mains charges the battery; on mains failure the battery powers the local lamp for the rated autonomy. Faults are isolated: a failed luminaire affects only itself.',
      'It is bigger than a non-emergency luminaire.',
      'It is mains-only.',
    ],
    correctAnswer: 1,
    explanation:
      'Self-contained = full emergency function inside the luminaire body. The mains supply is a charging path; the local battery is the emergency power source. Each luminaire is electrically independent.',
  },
  {
    id: 2,
    ...
    options: [
      'BS 5266-1 only.',
      'BS EN 50171:2021 — central power supply systems for safety services. Specifies cabinet construction, battery management, automatic mains-failure changeover, monitoring, alarms, 24-hour recharge to 80% capacity, and the integration with downstream luminaires. Works alongside BS EN 50172:2024 (system design) and BS 5266-1:2025 (UK application).',
      'BS 7671 only.',
      'No standard.',
    ],
    correctAnswer: 1,
    explanation:
      'BS EN 50171:2021 is the central-power-supply standard. BS EN 50172 is the system design standard. BS 5266-1 is the UK code of practice for emergency lighting application. All three apply to a central battery installation.',
  },
  {
    id: 3,
    question: 'Why is a self-contained luminaire said to be "fault-tolerant by isolation"?',
    options: [
      'It tolerates faults silently.',
      'A fault in one luminaire — failed battery, failed driver, failed lamp, even failed test electronics — affects only that luminaire. The fault does not propagate to its neighbours, the rest of the circuit, or the rest of the system. The remaining luminaires continue to function in emergency mode if mains fails. This distributed fault tolerance is the architectural advantage of self-contained over central systems, where a single cabinet fault can darken every luminaire.',
      'It has no faults.',
      'Faults are corrected automatically.',
    ],
    correctAnswer: 1,
    explanation:
      'Each luminaire is its own emergency system. Faults are contained within the failed unit. The contrast is with central systems where a cabinet fault is system-wide.',
  },
  {
    id: 4,
    ...
    options: [
      'Cable cost.',
      'Single point of failure — a fault in the cabinet (battery failure, charger failure, control board failure, fire) takes EVERY luminaire downstream offline simultaneously. The cabinet concentrates the risk in one location. Mitigations: locate the cabinet in a fire-protected enclosure with independent supply; use BS EN 50171-rated equipment with monitoring; consider duty/standby cabinets for high-criticality applications; specify PH120 + water-spray cable on luminaire feeds so the cable survives even a fire near the cabinet.',
      'Lamp colour.',
      'No risk.',
    ],
    correctAnswer: 1,
    explanation:
      'Central = single point of failure. The mitigations exist (location, BS EN 50171 compliance, redundancy, fire-rated cable) but the architectural risk is real and must be designed against.',
  },
  {
    id: 5,
    ...
    options: [
      '20 years.',
      'Approximately 4 years under typical UK office/retail conditions, after which the battery should be planned for replacement. The actual life depends on temperature (cooler is better, hot environments halve life), depth-of-discharge cycling, charge regime, and manufacturing quality. The 4-year figure is the planning baseline; the actual replacement is triggered by capacity tests during the annual 3-hour duration test or by self-test electronics flagging end-of-life. Lithium-ion batteries achieve longer service life (typically 5-8 years) but at higher capital cost.',
      '30 years.',
      '10 years.',
    ],
    correctAnswer: 1,
    explanation:
      '4 years is the typical SLA design life for emergency lighting duty. Lithium-ion gives longer life. End-of-life is triggered by capacity test failure or self-test alarm, not just calendar age — but the 4-year figure drives the maintenance budget.',
  },
  {
    id: 6,
    ...
    options: [
      ...
      'Practical and economic. Self-contained luminaires require only standard mains wiring (with PH30 fire-resistant grade for the supply) — no central cabinet, no high-current low-voltage feeds back to a battery room, no dedicated plant room. Each luminaire is fitted in place of (or alongside) a normal luminaire with minimal disruption. Capital cost is low. Maintenance is per-luminaire battery replacement on a known cycle. For a small installation the central-battery alternative would require disproportionate plant space, cabling, and capital — there is no scale benefit until you have many tens of luminaires.',
      'Aesthetic.',
      'Code requirement.',
    ],
    correctAnswer: 1,
    explanation:
      'Self-contained dominates small installations because central architecture has no scale benefit until many tens of luminaires. The plant room, the cabinet, the cabling all become disproportionate. Above ~50-100 luminaires the central economics start to compete.',
  },
  {
    id: 7,
    question: 'What is the BS EN 50171:2021 requirement for automatic mains-failure changeover in a central battery system?',
    options: [
      'Manual changeover only.',
      'Within 0.5 seconds — the cabinet detects mains failure on the input side and switches the luminaire feed to the battery output within 0.5 seconds, ensuring continuity of illumination. The same response time applies to mains restoration when the battery output reverts to charging mode. Status indication and alarms (audible and visual) must signal the changeover state. This rapid changeover is what distinguishes a BS EN 50171 emergency-rated system from a generic UPS that may have longer transfer times.',
      'Within 1 minute.',
      'Within 1 hour.',
    ],
    correctAnswer: 1,
    explanation:
      'BS EN 50171:2021 specifies 0.5 second changeover. The same standard requires monitoring, alarms, and status indication. The response time is what distinguishes emergency-rated equipment from generic UPS gear.',
  },
  {
    id: 8,
    ...
    options: [
      ...
      'The criticality of the area, the duration required, the consequence of single-point failure, and the maintenance regime. High-criticality areas (escape stair cores, hospital corridors, plant rooms, large concourses) typically get central-battery feeds with PH120 + W cable so the cable performance matches the criticality. Lower-criticality areas (offices, storage, retail floors) typically get self-contained luminaires for the distributed fault tolerance and easier retrofit. The decision is per-area, not whole-building.',
      'Cable colour.',
      'Random allocation.',
    ],
    correctAnswer: 1,
    explanation:
      'Criticality × consequence × maintenance economics drives the area-by-area decision. The hybrid is the natural answer for a mixed-use building because the optimum architecture varies across the site.',
  },
  {
    id: 9,
    ...
    options: [
      'No consequence.',
      'Every luminaire fed by that cabinet is offline as soon as the battery autonomy expires (1, 2, or 3 hours). The system runs through the autonomy on battery, then goes dark — and stays dark until the supply is restored. The missing requirement is the BS 7671 §560.11 lockable, labelled isolator: "EMERGENCY LIGHTING — DO NOT SWITCH OFF". A maintenance contractor who sees that label thinks twice; one who sees an unmarked switch flips it without understanding the consequence. The labelled lockable isolator is the cheapest defence against this exact failure pattern.',
      'The lights stay on indefinitely.',
      'The cabinet self-restarts.',
    ],
    correctAnswer: 1,
    explanation:
      'Consequence = the system runs out the autonomy then goes dark. Missing requirement = labelled lockable isolator at every isolation point per BS 7671 §560.11. The label is the engineering control for human-error isolation.',
  },
  {
    id: 10,
    question: 'Compare the lifecycle cost profile of self-contained vs central battery for a 300-luminaire installation.',
    options: [
      'Self-contained always cheaper.',
      'Central always cheaper.',
      'Self-contained typically has LOWER capital cost (no cabinet, no high-current low-voltage cabling, no plant-room space) but HIGHER lifecycle maintenance cost (300 batteries to replace on rotating schedule, distributed test access). Central typically has HIGHER capital cost (BS EN 50171 cabinet, fire-protected plant room, PH120+W cabling throughout) but LOWER lifecycle maintenance cost (one or two cabinets to maintain, centralised test and monitoring, easier battery management). The cross-over depends on scale, building life, and labour rates — typically central wins on lifecycle for ≥200-300 luminaires in a stable building over a 20+ year service life.',
      'They cost the same.',
    ],
    correctAnswer: 2,
    explanation:
      'Capital favours self-contained at small scale; lifecycle favours central at larger scale and longer service life. The cross-over is application-dependent and is a real design decision, not a foregone conclusion.',
  },
];
