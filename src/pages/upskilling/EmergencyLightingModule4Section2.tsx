...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'What standard specifies the requirements for a central battery cabinet supplying emergency lighting?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'A central battery system has a single cabinet feeding 200 luminaires. What is the dominant architectural risk?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'What is the typical design life of a sealed-lead-acid (SLA) battery in a self-contained emergency luminaire?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'A small retail unit with 8 emergency luminaires is being upgraded. Why is self-contained almost always the architecture chosen?',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'What is the BS EN 50171:2021 requirement for automatic mains-failure changeover in a central battery system?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'In a hybrid emergency lighting system, what typically drives the choice between self-contained and central-battery for a given area?',
    options: [
  ...
  },
  {
    id: 9,
    question:
      'A central battery cabinet is sited in an unmarked plant room with no labelling. The maintenance contractor accidentally switches off its supply during a scheduled outage. What is the consequence and what is the missing requirement?',
    options: [
  ...
  },
  {
    id: 10,
    question:
      'Compare the lifecycle cost profile of self-contained vs central battery for a 300-luminaire installation.',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Two architectures, very different trade-offs. Self-contained puts a battery in every
          luminaire — distributed fault tolerance, cheap retrofit, many batteries to maintain.
          Central battery feeds many luminaires from one cabinet — single point of failure if not
          designed carefully, BS EN 50171:2021 governs the cabinet, lower lifecycle cost at scale.
          Most real buildings end up hybrid.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Lamp / LED.</strong> The light source. Modern luminaires almost universally
              use LEDs — high efficacy, long lamp life (≥ 50,000 hours), cold-startable, drivable
              from low-voltage battery supply.
            </li>
            <li>
            ...
            <li>
              ...
              typically in PH30 fire-resistant cable per BS 8519. The feed is a charging path; it is
              not the life-critical signal path.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Distributed fault tolerance.</strong> A failed luminaire is one luminaire
              down. The rest of the system continues to function. The "failure" mode is graceful and
              isolated.
            </li>
            <li>
              <strong>Easy phased rollout.</strong> A retrofit can be done floor-by-floor,
              area-by-area, without requiring the whole building to be done at once. Each area is
              independent.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              small wall-mount units to large floor-standing cabinets serving hundreds of
              luminaires.
            </li>
            <li>
            ...
            <li>
              <strong>Distribution.</strong> The luminaire feeds leave the cabinet on fire-resistant
              cabling — typically PH120 + BS 8434-2 water-spray (BS 8519 Category 3) because the
              cable IS the life-critical signal path. Loss of cable means loss of light; the cable
              must survive the fire and the fire-fighting.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              fire-resistant cable that survives both fire and fire-fighting water. The cable is not
              the failure point.
            </li>
            <li>
              <strong>Duty / standby cabinets.</strong> For high-criticality applications, two
              cabinets — one duty, one standby — with automatic changeover. A cabinet fault fails
              over to the standby; the system continues with no single point of failure.
            </li>
            <li>
            ...
            <li>
              ...
              applications, central-battery luminaires are supplemented by self-contained luminaires
              in the same area — the self-contained units provide a second independent emergency
              path that does not depend on the cabinet at all.
            </li>
          </ul>
          <p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            <g>
              ...
              <text x="225" y="76" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="10">
                Battery in each luminaire
              </text>
              ...
              <line
                ...
                strokeWidth="1.4"
              />
              <text x="240" y="164" fill="rgba(255,255,255,0.55)" fontSize="9">
                PH30 cable
              </text>
              ...
              <circle
                ...
                strokeWidth="1.2"
              />
              <text x="80" y="256" textAnchor="middle" fill="white" fontSize="8">
                B
              </text>
              <circle
                cx="110"
                ...
                strokeWidth="1.2"
              />
              <text x="110" y="256" textAnchor="middle" fill="white" fontSize="8">
                L
              </text>
              <circle
                cx="140"
                ...
                strokeWidth="1.2"
              />
              <text x="140" y="256" textAnchor="middle" fill="white" fontSize="8">
                D
              </text>
              <line
                x1="125"
              ...
              <circle
                ...
                strokeWidth="1.2"
              />
              <text x="200" y="256" textAnchor="middle" fill="white" fontSize="8">
                B
              </text>
              <circle
                cx="230"
                ...
                strokeWidth="1.2"
              />
              <text x="230" y="256" textAnchor="middle" fill="white" fontSize="8">
                L
              </text>
              <circle
                cx="260"
                ...
                strokeWidth="1.2"
              />
              <text x="260" y="256" textAnchor="middle" fill="white" fontSize="8">
                D
              </text>
              <line
                x1="230"
              ...
              <circle
                ...
                strokeWidth="1.2"
              />
              <text x="320" y="256" textAnchor="middle" fill="white" fontSize="8">
                B
              </text>
              <circle
                cx="350"
                ...
                strokeWidth="1.2"
              />
              <text x="350" y="256" textAnchor="middle" fill="white" fontSize="8">
                L
              </text>
              <circle
                cx="380"
                ...
                strokeWidth="1.2"
              />
              <text x="380" y="256" textAnchor="middle" fill="white" fontSize="8">
                D
              </text>
              <line
                x1="350"
              ...
              <text x="60" y="320" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                B = Battery (in luminaire)
              </text>
              <text x="60" y="338" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                L = LED / Lamp
              </text>
              <text x="60" y="356" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                D = Driver + test electronics
              </text>

              <text x="60" y="394" fill="white" fontSize="11" fontWeight="bold">
                Properties
              </text>
              <text x="60" y="412" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                → Each luminaire independent
              </text>
              <text x="60" y="428" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                → Cable failure = mains failure (handled by battery)
              </text>
              <text x="60" y="444" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                → PH30 cable typical (charging path)
              </text>
              <text x="60" y="460" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                → Many distributed batteries to maintain
              </text>
              <text x="60" y="476" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                → Lower capital, higher distributed labour
              </text>
              <text x="60" y="492" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                → Wins on retrofit and small installations
              </text>
            </g>
            ...
            <g>
              ...
              <text x="655" y="76" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="10">
                Single cabinet feeds many luminaires
              </text>
              ...
              <text
                ...
                fontWeight="bold"
              >
                BS EN 50171:2021 cabinet
              </text>
              <text x="655" y="201" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
                Battery bank · charger · changeover · monitoring
              </text>
              <text x="655" y="218" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                0.5 s changeover · 24 h recharge to 80%
              </text>
              ...
              <text x="490" y="394" fill="white" fontSize="11" fontWeight="bold">
                Properties
              </text>
              <text x="490" y="412" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                → Cabinet feeds all luminaires
              </text>
              <text x="490" y="428" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                → Cable failure = light failure (life-critical)
              </text>
              <text x="490" y="444" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                → PH120 + W cable typical
              </text>
              <text x="490" y="460" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                → One cabinet to maintain (centralised)
              </text>
              <text x="490" y="476" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                → Higher capital, lower distributed labour
              </text>
              <text x="490" y="492" fill="rgba(255,255,255,0.7)" fontSize="9.5">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Escape stair cores → central battery.</strong> Highest criticality. Any
              failure here is on the only escape route. Justifies BS EN 50171 cabinet, PH120 + W
              cabling, centralised monitoring. Often duty/standby cabinets for redundancy.
            </li>
            <li>
            ...
            <li>
              <strong>Large concourses, atria, large halls → central battery.</strong> High
              occupancy, high consequence of single-luminaire failure (large area to illuminate from
              many fittings), lifecycle economics favour central.
            </li>
            <li>
            ...
            <li>
              <strong>
                Critical task areas (operating theatres, control rooms, high-risk processes) → BOTH.
              </strong>{' '}
              Sometimes central battery is supplemented with self-contained units in the same space,
              providing two independent emergency paths. The cabinet failure does not extinguish the
              area; the self-contained luminaires continue.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              duration) + plant room + PH120 + W cabling + dedicated supply + commissioning.
              Per-luminaire cost is lower (no battery / charger in the fitting) but the fixed costs
              (cabinet etc.) are substantial.
            </li>
            <li>
              ...
              difficult positions). Per-luminaire test and maintenance. Drives recurring labour
              cost.
            </li>
            <li>
        ...
        <ContentEyebrow>
          Maintenance regimes — different architectures, different work
        </ContentEyebrow>
        ...
        <FAQ
          items={[
            ...
            {
              question:
                'Can a self-contained luminaire and a central-battery luminaire share a circuit?',
              answer:
            ...
            {
              question:
                'Can a central battery cabinet be added to an existing self-contained system?',
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() =>
              navigate('/electrician/upskilling/emergency-lighting-module-4-section-3')
            }
