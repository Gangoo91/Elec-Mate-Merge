...
const DESCRIPTION =
  'Verify that MCBs, RCBOs, fuses and other protective devices operate correctly and coordinate for proper circuit protection.';

const quickCheckQuestions = [
  {
    id: 'rewirable-fuse',
    question:
      'A BS 3036 rewirable fuse carrier has two strands of 15A wire twisted together. Is this acceptable?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'No. Only a single strand of correct rating fuse wire should be used. Multiple strands increase the current-carrying capacity beyond the rating, compromising protection. This must be corrected.',
  },
  {
    id: 'faded-labels',
    question:
      "A consumer unit has labels but they're faded and barely readable. What should be done?",
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Labels should be replaced with clear, durable identification. This is a defect under Regulation 514.9.1. While not dangerous, unclear labelling compromises safe isolation and should be recorded and rectified.',
  },
  {
    id: 'spd-fault',
    question:
      'An SPD installed 3 years ago has a red status indicator. The installation passes all other tests. What should be recorded?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'The SPD fault should be recorded as a C3 observation (improvement recommended) or C2 if deemed potentially dangerous. The occupier should be advised the surge protection is no longer functioning and replacement is recommended.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      "Functional testing of an MCB verifies the switching mechanism operates correctly - it can be switched on and off freely, doesn't stick, and the position indicator shows correctly.",
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Visual inspection of fuse carriers should verify: correct fuse rating matches the circuit design, carrier fits securely without loose connections, and the fuse is the correct type (BS 88, BS 1361, etc.).',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      "If an MCB won't stay ON, either there's a fault on the circuit causing immediate trip (short circuit, earth fault, overload) or the MCB mechanism is defective. Investigation is required.",
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      'An RCBO combines MCB and RCD functions, so both must be functionally tested: verify the switching mechanism operates and the test button trips the device.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Regulation 514.9.1 requires every circuit to be identified. Labels should clearly describe each circuit and be accurate, durable, and legible. This aids safe isolation.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      "A main switch must isolate all circuits it's designed to control. Circuits remaining live indicates a wiring fault or incorrect switch specification - this is a serious safety defect.",
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Enclosure inspection includes: secure mounting, all covers/blanks fitted, no damage compromising IP rating, adequate clearances, and suitable for the environment.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      "Coordination (discrimination) requires upstream devices to be rated appropriately so they don't trip before downstream devices during faults, unless both are designed to trip together.",
  },
  {
    id: 9,
    question:
      'A surge protection device (SPD) has a status indicator showing fault. What action is required?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'SPD fault indication means the device may no longer provide surge protection. It should be replaced or investigated by a competent person to restore protection.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'The schedule of inspections and circuit chart should record device types (MCB, RCBO, fuse), ratings (current and breaking capacity), and any defects or observations noted.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Yes. Every MCB should be switched off and on to verify the mechanism operates correctly. This also confirms the switching doesn't cause issues (arc, sticking, position indicator). Warn occupants before testing as loads will be interrupted.",
  },
  {
    question: 'How do I check if fuse ratings are correct?',
    answer:
      'Compare the fuse rating against the circuit design (check conductor size, load requirements, and cable current-carrying capacity). The fuse rating should not exceed the cable current-carrying capacity and should provide adequate protection for the load.',
  },
  {
    question: 'What if a protective device has no visible rating?',
    answer:
      'All protective devices must have ratings clearly marked. If rating markings are illegible, damaged, or missing, the device should be replaced. You cannot safely verify protection without knowing the rating.',
  },
  {
    question: 'Should I test MCB tripping under fault conditions?',
    answer:
      'No - MCBs are tested during manufacture and certified to standards. Functional testing verifies the mechanism operates (switching on/off). Deliberately overloading or short-circuiting to test tripping is dangerous and unnecessary.',
  },
  {
    question: "What's the difference between isolators and circuit breakers?",
    answer:
      'Circuit breakers (MCBs) provide automatic protection and can break fault currents. Isolators (switch-disconnectors) are designed to disconnect circuits that are already off-load. Verify each type is used correctly for its intended purpose.',
  },
  {
    question: 'Are there special requirements for metal consumer units?',
    answer:
      'Metal consumer units require all cable entries to use appropriate glands or grommets, the enclosure must be earthed, and any unused entries must be blanked. Verify the internal earth bar connections to the enclosure.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Verify MCBs, RCBOs, fuses and other protective devices are correctly installed and
            function
          </p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>MCBs:</strong> Operate every one - verify switching mechanism
              </li>
              <li>
                <strong>RCBOs:</strong> Test button AND switching mechanism
              </li>
              <li>
                <strong>Fuses:</strong> Correct rating, secure carrier fit
              </li>
              <li>
                <strong>Labels:</strong> Every circuit clearly identified (514.9.1)
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Stuck switches, faded labels, SPD faults
              </li>
              <li>
                <strong>Use:</strong> Warn occupants before switching tests
              </li>
              <li>
                <strong>Apply:</strong> Check main switch isolates ALL circuits
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Miniature circuit breakers (MCBs) and residual current circuit breakers with
              overcurrent protection (RCBOs) require both visual and functional verification:
            </p>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white/90">
                Test button should trip the device - verify RCD function operates in addition to MCB
                switching.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Main switches and isolators provide the means of isolation required by Regulation
              537.2. Their correct function is critical for safety:
            </p>
            ...
            <p className="text-sm text-amber-400/70">
              <strong>Critical check:</strong> Verify the main switch actually de-energises all
              circuits. Test each circuit is dead after operating the main switch.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Regulation 514.9.1 requires identification of circuits. Clear, accurate labelling is
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Modern installations may include surge protection devices (SPDs) and other
              supplementary protective devices that require verification:
            </p>
            ...
            <p className="text-sm text-amber-400/70">
              <strong>Important:</strong> If an SPD status indicator shows fault (typically red or
              flashing), the device should be replaced as it may no longer provide surge protection.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Forcing stuck switches</strong> - investigate, don't force
                </li>
                <li>
                  <strong>Ignoring faded labels</strong> - record and recommend replacement
                </li>
                <li>
                  <strong>Missing SPD faults</strong> - always check status indicators
                </li>
                <li>
                  <strong>Not testing main switch isolation</strong> - verify ALL circuits dead
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="p-6 rounded-lg bg-elec-yellow/10 border border-elec-yellow/30 text-center">
            ...
            <p className="text-white/70 mb-3">
              You've mastered polarity testing, phase rotation, functional testing, and protective
              device verification.
            </p>
