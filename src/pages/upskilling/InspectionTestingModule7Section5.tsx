    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reg 643.10 in practice — what to do, device by device, at the board. MCB and RCBO
          function, the A4:2026 AFDD test-button rule, SPD status, isolator and main switch
          operation. The closing functional test before the certificate is signed.
        </p>
        ...
        >
          <p>
            The regulation sits at the close of the test sequence in Part 6 Chapter 64. By the time
            you reach Reg 643.10, every conductor-level test (continuity, insulation resistance,
            polarity, Zs, RCD trip-time) has been done. Reg 643.10 closes the loop: does each device
            on the board actually operate as installed and adjusted? The A4:2026 amendment added a
            single sentence — the AFDD test-facility line — and that sentence is the headline
            change. Before A4, AFDDs sat awkwardly between a functional duty and an
            opinion-of-the-installer position. After A4, the verification path is explicit: press
            the manufacturer’s test button, in the manner the manufacturer specifies, and record the
            result.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              the relevant requirements of BS 7671. Examples of such equipment are: (a) switchgear
              and controlgear assemblies, drives, controls and interlocks; (b) systems for emergency
              switching off and emergency stopping; (c) insulation monitoring. NOTE 1: This list is
              not exhaustive. Protective devices shall be submitted to a test of their function, as
              necessary, to check that they are properly installed and adjusted. Where fault
              protection and/or additional protection is provided by an RCD, the effectiveness of
              any test facility incorporated in the device shall be verified. Where an AFDD is
              installed the effectiveness of any manually operated test facility shall be verified
              in accordance with the manufacturers’ recommendations. NOTE 2: This functional test
              does not replace the functional test indicated by the relevant standards.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="110" y="190" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
            ...
            <text x="230" y="190" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
            ...
            <text x="350" y="190" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
            ...
            <text x="470" y="190" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              Reg 643.7.3 · 643.10
            </text>
            ...
            <text x="590" y="190" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              Reg 643.7.3 (Zs M5)
            </text>
            ...
            <text x="710" y="190" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              Reg 643.10
            </text>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Rating (In)</strong> matches design and the cable-CSA permitted by Chapter 43.
            </li>
            <li>
          ...
          <p>
            An RCBO carries both duties: overcurrent verification (above) and RCD verification under
            Reg 643.7.3 / Reg 643.10. The RCBO integral test button is non-optional — the on-board
            check that the residual-current path is functional.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              RCD disconnects within the time stated below with an alternating current test at rated
              residual operating current (IΔn): (a) for general non-delay type, 300 ms maximum; (b)
              for delay &lsquo;S&rsquo; type RCD, between 130 ms minimum and 500 ms maximum.
            </>
          }
          ...
          whatToDo={
            <>
              <span className="block">
                1. <strong>Visual / appropriate methods</strong> per Reg 643.7.3 — confirm the RCBO
                is 32 A, B-curve, Type A residual, 30 mA IΔn. Match against design.
              </span>
              <span className="block">
                2. <strong>Function test</strong> per Reg 643.10 — operate the lever to OFF and back
                to ON. Mechanical free movement, audible click, indicator changes.
              </span>
              <span className="block">
        ...
        >
          <p>
            The A4:2026 sentence in Reg 643.10 — &ldquo;Where an AFDD is installed the effectiveness
            of any manually operated test facility shall be verified in accordance with the
            manufacturers’ recommendations&rdquo; — does three things at once. It makes the AFDD
            test mandatory where the device is fitted. It places the manufacturer’s instruction at
            the centre of the verification path. And via NOTE 2 it acknowledges that this functional
            test does not replace the type-test the device passed at manufacture under its product
            standard.
          </p>
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Read the manufacturer’s test sequence. Press accordingly — typically a momentary press
              energising the device’s internal trip coil via the test path.
            </li>
            <li>
              Confirm the device trips. Confirm the reset operation returns the device to service.
              Confirm the indication LEDs (where present) show the correct healthy / tripped / fault
              states per the manufacturer.
            </li>
            <li>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              <span className="block">
                Record on the EICR: SPD mode L2-N at end-of-service (red status indicator). Code the
                observation. The equipment downstream of the L2-N path is no longer protected
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              disconnection-time evidence for the overcurrent characteristic of MCB / RCBO. Compared
              against Table 41.3 / A4-max-permitted-Zs.
            </li>
            <li>
              <strong>RCD operating time at IΔn column (ms):</strong> the M6 reading from the BS EN
              61557-6 instrument. Pass criterion ≤ 300 ms for general type, 130–500 ms for S-type.
            </li>
            <li>
              <strong>Function-test column (✓ / ✗):</strong> the Reg 643.10 verification — AFDD
              button, RCBO test button, MCB lever operation, main switch operate, isolator operate,
              time-delay function. One tick, multiple verifications backing it.
            </li>
            <li>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              date against the manufacturer’s recommended service life. End-of-service is a remedial
              action, not a flag.
            </li>
            <li>
