...
const inlineChecks = [
  {
    ...
    question: 'What is the BS EN 1838:2024 minimum illuminance on an escape route up to 2 m wide?',
    options: [
  ...
  {
    id: 'elm2-s4-response',
    question: 'What is the BS EN 1838:2024 escape route lighting response time profile?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              floor level, with the outer ¼ width on each side excluded. A 1.6 m corridor excludes
              0.4 m each side; the central 0.8 m must achieve 1 lx throughout.
            </li>
            <li>
              <strong>Routes wider than 2 m.</strong> 1 lx across the full width of the route at
              floor level, with the outer 0.5 m on each side excluded. A 4 m foyer excludes 0.5 m
              each side; the central 3 m must achieve 1 lx everywhere. The 2013 rule of decomposing
              wide routes into 2 m strips is superseded.
            </li>
            <li>
              <strong>Where the route bends.</strong> At corners and changes of direction, the
              full-width verification follows the curve. Verify illuminance across the non-excluded
              width along the curved path, not just at the geometric centre.
            </li>
            <li>
              <strong>Stairs.</strong> Each tread is a step change in floor level. 1 lx full width
              applies to each tread top surface within the non-excluded boundary. A luminaire is
              mandatory at the head and foot of each flight; intermediate landings count as decision
              points.
            </li>
            <li>
              <strong>Outside the final exit.</strong> Under BS 5266-1:2025 the route continues
              outside the door, along the path to the assembly point. The same full-width 1 lx rule
              applies to the external floor surface within the non-excluded boundary.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              an outer border of one quarter of the route width on each side may be excluded.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              guessed from a sketch — it must be calculated from the photometric data of the actual
              luminaire chosen at the actual mounting height and spacing. Most lighting design
              software (Dialux, Relux, manufacturer tools) reports uniformity as part of the
              calculation output.
            </li>
            <li>
              <strong>Luminaire choice changes the cap headroom.</strong> A wide-distribution
              luminaire (high beta angle, low intensity) achieves better uniformity at wider spacing
              than a narrow-distribution luminaire. For escape routes, a "batwing" photometric
              distribution is ideal — it spreads light along the route axis and evens out the dark
              zones.
            </li>
            <li>
              <strong>The full non-excluded width is in scope.</strong> The 40:1 cap is checked
              across the full width of the route (less the permitted edge border), not just at the
              geometric centre. Designers must verify wall-side illuminance within the non-excluded
              width. A reading of 5 lx near the centre with 0.1 lx near the edge of the non-excluded
              width breaches the cap (50:1) even if the centre alone passes.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Along the length of the escape route within the non-excluded width, the ratio of the
              maximum illuminance to the minimum illuminance shall not exceed 40:1.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          <h4 className="text-sm font-bold text-white mb-4">
            Corridor escape route — 1 lx full width (edge excl.), 40:1 uniformity, spacing 1.5 to 2
            × mounting height
          </h4>
          <svg
            viewBox="0 0 820 420"
          ...
          >
            ...
            <text x="80" y="352" fill="rgba(255,255,255,0.7)" fontSize="10">
              Spacing 1.5 to 2 × mounting height keeps uniformity inside cap; verify with
              photometric data.
            </text>
            <text x="80" y="372" fill="rgba(255,255,255,0.7)" fontSize="10">
              Luminaire mandatory within 2 m of: final exit, exit sign, change of direction, change
              of level,
            </text>
            <text x="80" y="388" fill="rgba(255,255,255,0.7)" fontSize="10">
              intersection, stairs, fire-fighting equipment, first-aid post. Decision points = no
              exceptions.
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>At each exit sign.</strong> Luminaire within 2 m of every emergency exit sign,
              so the sign itself is illuminated externally if non-internally-illuminated. Internally
              illuminated signs do not need an external luminaire but still benefit from one for
              sign legibility under low-adaptation conditions.
            </li>
            <li>
              <strong>At each change of direction.</strong> Corner of a corridor, bend, junction —
              luminaire within 2 m of the geometric corner. Occupants must see clearly which way to
              go.
            </li>
            <li>
            ...
            <li>
              <strong>At each first-aid post.</strong> First-aid kit, defibrillator (AED), eyewash
              station. Same logic — findable and usable.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Emergency luminaires shall be sited within 2 m horizontally of every: (a) exit door;
              (b) exit sign; (c) staircase, change of level, or other tripping hazard; (d) change of
              direction or intersection of corridors; (e) place where fire-fighting equipment or
              fire alarm call points are sited; (f) first-aid post. Compliance with this clause is
              in addition to the full-width illuminance and uniformity requirements of §4.1 and
              §4.2.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>50 % within 5 s.</strong> The eye is mid-adaptation. 50 % of rated illuminance
              allows occupant movement to begin. Walking speed is initially cautious; full
              illumination is not required for the first metre of movement.
            </li>
            <li>
              <strong>100 % within 60 s.</strong> Battery / driver / lamp settling complete.
              Steady-state emergency illumination achieved. Occupants now navigating at near normal
              speed using emergency illumination only.
            </li>
            <li>
              ...
              very bright, the eye takes longer to adapt downward, and the standard permits 50 s to
              full instead of 60 s in those cases. Practical effect: minor; the 60 s figure still
              applies to most escape routes.
            </li>
            <li>
              <strong>High-risk task lighting separate.</strong> Where an area is also a high-risk
              task area (BS EN 1838:2024 §6), the response time tightens to 0.5 s to full output.
              The escape route 5 s / 60 s rule still applies to the route portion; the 0.5 s rule
              applies to the working plane of the task. Two concurrent rules.
            </li>
            <li>
              <strong>Commissioning verification.</strong> Discharge a representative luminaire with
              a stopwatch and lux meter; record time to 50 % illuminance and time to full
        ...
        <RegsCallout
          ...
          clause={
            <>
              For escape route lighting the illuminance shall reach 50 % of the required illuminance
              within 5 s and the full required illuminance within 60 s of the failure of the supply
              to the normal lighting. Where the normal task illuminance is very high, the time to
              reach the full required illuminance may be extended to 50 s in the assessment of
              design.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Sleeping accommodation → 3 h.</strong> Hotels, guest-houses, hostels, halls of
              residence, care homes, hospital wards, sleeping pods in offices. The 3 h supports
              re-entry by fire and rescue services to retrieve occupants who could not
              self-evacuate.
            </li>
            <li>
            ...
            <li>
              <strong>Duration interacts with battery sizing.</strong> A 3 h system needs roughly 3
              × the battery capacity of a 1 h system at the same load. Self-contained luminaires for
              3 h are physically larger and more expensive; central battery banks for 3 h scale
              similarly. Get this right at scheme stage.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              evacuated immediately and re-entry is not allowed until the supply is restored; (b) 3
              h for premises with sleeping accommodation, multi-storey premises, and large premises
              in which evacuation may be prolonged or where re-entry by emergency services is
              anticipated. Where there is doubt as to the appropriate duration, the 3 h minimum
              shall apply.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Step 1 — choose mounting height.</strong> Typical 2.4 to 2.7 m for commercial
              corridors. Higher mounting (3 m+) gives wider light spread and tolerates wider
              spacing, but reduces lux per watt at floor level. Lower mounting (2.2 m) is used in
              low-ceiling refurbishments.
            </li>
            <li>
              <strong>Step 2 — apply spacing heuristic.</strong> Multiply mounting height by 1.5 to
              2.0. At 2.5 m mounting, target spacing is 3.75 to 5.0 m. Use 4 m as a starting figure
              and adjust against photometric verification.
            </li>
            <li>
            ...
            <li>
              <strong>Step 4 — place decision-point luminaires.</strong> Add luminaires within 2 m
              of every decision point identified on the plan. These take precedence over spacing — a
              decision point may require a luminaire closer than the calculated spacing dictates.
            </li>
            <li>
              <strong>Step 5 — verify duration.</strong> Sum the load (W) of all emergency
              luminaires and multiply by duration (h) to get battery / CPS sizing. Confirm battery
              capacity (Ah at the system DC voltage) matches at the end of the rated duration to 50
              % illuminance, not 100 %.
            </li>
            <li>
              ...
              supply (CPS or self-contained); discrimination is critical so a non-emergency circuit
              fault does not cascade into the emergency circuit.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              verified by photometric calculation at the design stage, using the photometric data of
              the actual luminaires proposed. Verification at commissioning shall include direct
              measurement of horizontal illuminance at floor level across the full width of each
              escape route (excluding the permitted edge border) at points selected to represent the
              worst-case inter-luminaire condition.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>1. Competent designer (§5.2).</strong> The designer must be a competent person
              — defined as having the training, qualifications, and experience to undertake the
              work. Acceptable evidence includes IEng / CEng with relevant emergency lighting
              experience, ICEL qualifications, manufacturer-specific design certification, or
              documented experience under a chartered engineer.
            </li>
            <li>
              <strong>2. Design and installation record (§13).</strong> A formal record signed by
              the designer covering: photometric calculations, luminaire schedule, circuit topology,
              risk assessment outputs, commissioning results, and competence declaration. Forms part
              of the building golden thread under the Building Safety Act 2022.
            </li>
            <li>
            ...
            <li>
              <strong>4. Risk-based documentation (§5.5).</strong> The risk assessment must identify
              high-risk task areas, areas where anti-panic lighting is triggered, and any other
              areas where the standard's general rules do not adequately cover the specific hazards.
              The lighting design must respond to each item identified.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The designer of an emergency lighting installation shall produce, sign, and retain a
              design and installation record. The record shall include: (a) the basis of design
              including the risk assessment outputs; (b) the photometric calculations including
              illuminance and uniformity verification; (c) the luminaire schedule including type,
              location, and rating; (d) the circuit topology and protective device coordination; (e)
              the commissioning test results; (f) a declaration that the designer is a competent
              person within the meaning of §5.2.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>External luminaire at every final exit.</strong> IP65 minimum. Within 2 m of
              the door, on the external face. Mounted at 2.5 to 3 m typically (above door-frame
              line, on a bracket or wall-mount).
            </li>
            <li>
              <strong>Steps and kerbs immediately outside.</strong> Any change of level within a
              couple of metres of the door must be illuminated. A single step down with 1 lx on the
              tread, riser visible.
            </li>
            <li>
              <strong>Path to assembly point.</strong> 1 lx full width along the external path (with
              edge exclusions), same 40:1 uniformity. For longer paths this means a series of
              external bollards or wall-mounted bulkheads at the same 1.5 to 2 × mounting-height
              spacing.
            </li>
            <li>
              <strong>Assembly point itself.</strong> A luminaire to identify the point, plus
              sufficient illuminance for a roll-call to be conducted. The exact illuminance is not
              prescribed but 1 lx average is the de-facto target.
            </li>
            <li>
              <strong>Power supply.</strong> External luminaires must be supplied from the same
              emergency supply (CPS or self-contained battery) as the internal scheme. Cable routes
              may need fire-rated containment depending on the building's fire strategy.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The escape route shall be considered to extend from any point in the premises, through
              the internal escape geometry, through each final exit, and along the external path of
              travel to the designated place of safety or assembly point. The illuminance,
              uniformity and luminaire placement requirements of BS EN 1838:2024 §4 shall apply to
              the entire extent of the escape route, including external portions.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Illuminance measurement at worst-case points.</strong> Lux meter horizontal at
              floor level across the route width (within the non-excluded boundary) at mid-span
              between luminaires. Reading must be ≥ 1 lx. Take readings at multiple worst-case
              points along the route.
            </li>
            <li>
              <strong>Uniformity verification.</strong> Reading at brightest point (under luminaire)
              and darkest point (mid-span). Ratio Emax/Emin ≤ 40:1.
            </li>
            <li>
              <strong>Decision-point coverage.</strong> Visual check that every decision point has a
              luminaire within 2 m. Photo each decision point with the emergency lighting only as
              evidence.
            </li>
            <li>
              <strong>Discharge test (full duration).</strong> Hold the system on emergency battery
              for the rated duration (1 h or 3 h). At the end of the duration, illuminance must
              remain at least 50 % of rated value (most luminaires actually hold close to 100 % for
              most of the duration and drop in the last 10 %).
            </li>
            <li>
              <strong>Recharge verification.</strong> After discharge, system must recharge to full
              within 24 h. Confirm by visual inspection and battery management system readout.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              On completion of installation, the system shall be verified by tests including: (a)
              illuminance measurement at floor level across the full width of each escape route
              (within the non-excluded boundary per BS EN 1838:2024) at worst-case positions,
              demonstrating ≥ 1 lx; (b) measurement of response time at representative luminaire
              positions, demonstrating ≤ 5 s to 50 % and ≤ 60 s to 100 %; (c) discharge test for the
              full rated duration, demonstrating maintenance of at least 50 % of rated illuminance
              throughout; (d) verification of decision-point luminaire placement against the design
              plan.
            </>
          }
        ...
        <FAQ
          items={[
            ...
            {
              question: 'My corridor is 2.05 m wide. Which edge exclusion applies?',
              answer:
            ...
            {
              question: 'Are there premises types where 1 lx is not enough?',
              answer:
