  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/electrician/upskilling/data-cabling-module-4"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The 19-inch rack as the universal comms infrastructure — U-sizing, horizontal and vertical
          cable management, patch-cord length discipline, hot-aisle / cold-aisle airflow, PDU
          placement, door access, security, weight loading. TR sizing and environmental envelope per
          ANSI/TIA-569-E + Addendum 1 (2022): 18-27 °C continuous / 8-60 percent RH non-condensing,
          alongside BS 7671 §444.5.3.1 (rack metalwork in the EBN) and §545 (ICT functional
          earthing).
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>2 × 24-port patch panels.</strong> 2 × 1U = 2U. Patches face front; horizontal
              cabling enters from rear.
            </li>
            <li>
          ...
          <p>
            Add it up: 9-10U of active gear, 4U of management, 2U of UPS = 15-16U of a 42U rack used
            at first fit. The remainder absorbs growth, additional patch panels, additional
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              <strong>Vertical managers either side, full height.</strong> Provide the bulk routing
              column for patch leads moving between many panels and switches. Width typically
              100-200 mm. Inside, finger trays or D-rings hold the cords and allow lateral access.
            </li>
            <li>
              <strong>Horizontal managers between active devices.</strong> 1U devices placed between
              every patch panel and every switch / panel transition. Provide local dressing space,
              bend-radius compliance for the 8× cable OD termination rule (Module 4 Section 2), and
              a clean visual transition.
            </li>
            <li>
              <strong>Patch-cord length discipline.</strong> Stock a small range of lengths matched
              to actual rack distances (0.5, 1, 1.5, 2, 3 m). Use the SHORTEST cord that reaches
              each run with proper bend radius. Cords too long create slack arcs that block the
              management; cords too short violate bend radius. Match cord colour to the service-type
              colour-coding from Module 4 Section 4.
            </li>
          </ul>
          <p>
            Done well, the rack remains accessible and usable for the cabling life. Done poorly, the
            rack reaches "the next contractor opens it once" within a year. The cost of doing it
            well is a small percentage of the total rack cost; the lifecycle value is enormous.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <br />
              (a) metallic containment, conductive screens, conductive sheaths or armouring of data
              transmission cables or of information and communications technology equipment;
              <br />
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Aligned airflow direction.</strong> Every device front-to-back. Mixed airflow
              creates short-circuit paths where one device\u2019s exhaust feeds another\u2019s
              intake — escalating temperatures, fan speeds, and failure rates. Convert any
              non-conforming device with a side-to-back duct kit, or isolate it in a separate rack
              column.
            </li>
            <li>
            ...
            <li>
              <strong>PDU placement.</strong> Vertical zero-U (mounted in the rear cable management
              space, full rack height) leaves every front U free for active equipment. Horizontal 1U
              at the base is acceptable for smaller racks. Avoid front-mount horizontal PDUs — they
              waste U-space.
            </li>
            <li>
              <strong>UPS sizing.</strong> Sized to active equipment load + 25 percent margin, with
              runtime appropriate to the building\u2019s power-restoration profile (5-15 minutes
              typical for a TR with diesel-backed grid; longer for sites without backup generation).
            </li>
            <li>
              <strong>Environmental monitoring.</strong> Temperature near each rack inlet (not just
              room ambient), humidity sensor in the room, smoke detection (linked to building
              alarm), water-leak detection (under raised floor / near pipework), intrusion alarm on
              rack and room doors. Larger TRs add airflow / particulate / voltage / current
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              loaded-rack weight. Loaded 42U racks routinely exceed 800 kg. Surveys at design stage
              prevent floor failures at install. TIA-569-E.
            </li>
            <li>
              <strong>Door size and orientation.</strong> 900 mm minimum width, outward- opening (so
              a fault inside cannot block escape), access-controlled (electronic or PIN). Doubles or
              wider where chassis equipment will be moved through. TIA-569-E.
            </li>
            <li>
              <strong>Working clearance.</strong> 1 m minimum in front of every rack (preferably 1.2
              m), and 1 m at the rear if rear access is used for cable management. Working clearance
              is for moves / adds / changes, fault investigation, equipment replacement.
            </li>
            <li>
              <strong>Cable entries.</strong> Fire-stopped at every floor / wall penetration (Module
              4 Section 3). Sized for current cable count plus growth. Routed via ladder rack /
              basket / conduit with the metallic containment placed in the EBN per BS 7671
            ...
            <li>
              ...
              policy may add CCTV coverage, biometric access, or dedicated security-rated cabinets.
            </li>
            <li>
              <strong>Power.</strong> Redundant feeds where availability requires. UPS sized to load
              + 25 percent. RCD protection, AFDD where the building qualifies under §421.1.7
              (typically not commercial offices, but some uses), accessible isolation. BS 7671 §716
              for any in-rack PoE distribution.
            </li>
          </ul>
          <p>
            The TR is a piece of building infrastructure with a 30-year life. The cabling inside it
            has a 15-20 year life. Equipment refreshes every 5-7 years. Get the room right at first
            fit and the cabling and equipment cycles all fit inside it without re-room-design. Get
            it wrong and every refresh fights the room.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Small TR build. Installer fits a 1U horizontal PDU at the top of the rack, accessible
              from the front. Looks tidy on day one. Six months later the team needs to add an
              additional patch panel, but the active U-capacity above the switch is fully consumed
              by patch panels and managers. The PDU at the top now blocks the install. The
              remediation is to move the PDU to the rear or base — a half-day job involving
              disconnecting every active device from power. The first-fit choice cost half a day at
              year one.
            </>
          }
          doInstead={
            <>
              ...
              management space, running full rack height. Every U-position at the front is then free
              for active equipment for the full rack life. For smaller racks, mount a horizontal PDU
              at the BASE of the rack (1U above the floor) — where it does not block growth and
              where its low position keeps the rack centre of mass low. Front-mount horizontal PDUs
              are the worst option — they waste U-space and create an awkward access pattern for
              power maintenance.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              Sense-check the room first: 3 × 3 m is the smaller end of TIA-569-E small-TR guidance
              — workable for a single rack, but tight if a second rack is needed later. Push back to
              3.5 × 3.5 m if the brief allows. Specify floor loading to 12 kPa minimum (likely fine
              on ground floor, check upper floors). Door 900 mm minimum, outward-opening,
              access-controlled. Inside the rack: 9 × 24-port patch panels (216 ports — 200 outlets
              + spare), 1 × 24-port edge switch (1U), 3-4 × horizontal cable managers, 1 × fibre
              patch panel for backbone, vertical cable managers either side, 2-3U UPS at the base,
              zero-U PDUs in the rear. That is about 14U of active gear in a 42U rack, leaving 28U
              for growth — a comfortable 7-year horizon. Environmental: 18-27 °C / 8-60 percent RH
              per TIA-569-E + Addendum 1 (2022); split-AC sized to total heat-rejection + 30
              percent. Monitoring: temperature, humidity, smoke, intrusion. Cable entries
              fire-stopped per Module 4 Section 3. Bonding: rack to MET via building bonding ring
              conductor, per BS 7671 §444.5.3.1; ICT functional earthing under §545 if applicable.
            </>
          }
          whyItMatters={
            <>
              The TR is the heart of the cabling system and a piece of building infrastructure with
              a 30-year life. Get the room wrong and the equipment refresh cycle fights the room
              every time. The first-fit cost of a properly specified TR is a small fraction of the
              lifecycle cost of working around an inadequate TR. Specify generously, document
              everything, and the building absorbs 15-20 years of service refresh inside the same
              room.
            </>
          }
        />
