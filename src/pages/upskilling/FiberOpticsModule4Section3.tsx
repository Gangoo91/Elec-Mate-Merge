...
const DESCRIPTION =
  'Learn about fusion splicers, cleavers, and essential tools for fibre optic splicing. Understand equipment features, selection criteria, and maintenance requirements.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Core alignment splicers use cameras to directly view and align the fibre cores, producing lower loss splices especially on singlemode fibre. Clad alignment only aligns the outer cladding.',
  },
  {
    id: 'equipment-qc2',
    question: 'What component needs regular replacement in a fusion splicer?',
    options: ['The display screen', 'The fibre clamps', 'The electrodes', 'The camera'],
    correctIndex: 2,
    explanation:
      'Electrodes wear with use and need replacement typically every 2,000-5,000 splices. Worn electrodes produce inconsistent arcs and poor splice quality.',
  },
  {
    id: 'equipment-qc3',
    ...
    correctIndex: 1,
    explanation:
      'Fusion splicing requires cleave angles under 1 degree for quality splices. Precision cleavers consistently achieve this accuracy; basic cleavers cannot.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Arc calibration automatically adjusts the arc power to compensate for temperature, pressure, and humidity changes.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Field splicers typically support multiple power options: mains AC, battery, and 12V DC for vehicle operation.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Fibre holders securely position the fibres for precise alignment and stable fusion. Different holders match different fibre types.',
  },
  {
    id: 9,
...
const faqs = [
  {
    ...
    answer:
      "Consider: reliability record, local service/support availability, spare parts accessibility, training availability, and compatibility with your organisation's existing equipment. Major brands (Fujikura, Sumitomo, FITEL) all produce quality equipment. Try before buying if possible, and check user reviews from similar applications.",
  },
  {
    question: 'Is it better to buy or rent a fusion splicer?',
    answer:
      'Depends on usage volume. Regular use (monthly or more) usually justifies purchase. Occasional use (few times yearly) often favours rental. Consider: purchase price (3,000-30,000 pounds+), maintenance costs, calibration requirements, and training. Rental provides access to maintained equipment without capital investment.',
  },
  {
    question: 'Can one splicer handle all fibre types?',
    answer:
      'Most modern splicers handle standard singlemode and multimode fibres. However, specialty fibres (polarisation maintaining, erbium-doped, etc.) may need specific models with appropriate programmes. Check splicer specifications match your fibre types. Ribbon splicers are needed for mass fusion of ribbon cables.',
  },
  {
    question: 'How important is the splice loss estimation accuracy?',
    answer:
      'The displayed estimate is based on alignment geometry, not actual optical measurement. It is a good indicator but not definitive. Always verify with OTDR or power meter testing. If estimated loss is high, consider re-splicing. Modern splicers are quite accurate, but actual loss can vary from estimate.',
  },
  {
    question: 'What maintenance can I do versus what needs the manufacturer?',
    answer:
      "User maintenance: electrode replacement, cleaning V-grooves and mirrors, cleaning fibre clamps, updating software. Manufacturer service: calibration verification, internal repairs, electrode gap adjustment, major component replacement. Follow the manufacturer's maintenance schedule and keep service records.",
  },
  {
    question: 'Do I need different cleavers for different fibres?',
    answer:
      'A quality precision cleaver handles most standard fibres (singlemode, multimode, various coating diameters). However, ribbon cleavers are needed for ribbon fibre, and specialty fibres may have specific requirements. Ensure your cleaver can handle your fibre coating diameter (250 micrometre, 900 micrometre) and has appropriate blade settings.',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-4xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Core vs Clad:</strong> Core alignment for lowest loss
              </li>
              <li>
                <strong>Electrodes:</strong> Replace every 2,000-5,000 splices
              </li>
              <li>
                <strong>Calibration:</strong> Run before each session
              </li>
              <li>
                <strong>Investment:</strong> 3,000-30,000 pounds+
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Electrode wear, inconsistent splices
              </li>
              <li>
                <strong>Use:</strong> Core alignment for SM backbone
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Best splice quality:</strong> Typical loss under 0.02 dB
                </li>
                <li>
                  <strong>Essential for singlemode:</strong> Core alignment critical for SM
                </li>
                <li>
                  <strong>Automatic alignment:</strong> Active core positioning
                </li>
                <li>
                  <strong>Higher cost:</strong> 5,000-30,000 pounds+
                </li>
                <li>
                  <strong>Applications:</strong> Backbone, telecommunications, data centres
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Good for multimode:</strong> Large cores more tolerant
                </li>
                <li>
                  <strong>Lower cost:</strong> 3,000-8,000 pounds
                </li>
                <li>
                  <strong>Simpler optics:</strong> Fewer cameras, less complex
                </li>
                <li>
                  <strong>Higher SM loss:</strong> Relies on core-clad concentricity
                </li>
                <li>
                  <strong>Applications:</strong> Multimode, FTTH, basic installations
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                ...
                simultaneously. Much faster for high-count cables but significantly more expensive
                (15,000-50,000 pounds+). Essential for telecommunications backbone work with ribbon
                cables.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Understanding splicer features helps you use the equipment effectively and select
              appropriate models for your needs.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>LCD/LED display:</strong> Shows fibre view, alignment, and settings
                </li>
                <li>
                  <strong>Touch screen:</strong> Common on modern units for easy navigation
                </li>
                <li>
                  <strong>Multiple views:</strong> X and Y axis views for alignment verification
                </li>
                <li>
                  <strong>Result display:</strong> Estimated loss, cleave angle, splice image
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Battery:</strong> Typically 100-300 splices per charge
                </li>
                <li>
                  <strong>Mains AC:</strong> For workshop/office use
                </li>
                <li>
                  <strong>DC input:</strong> 12V vehicle connection for field work
                </li>
                <li>
                  <strong>Hot-swap:</strong> Some models allow battery changes without shutdown
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Built-in heater:</strong> Shrinks protection sleeves after splicing
                </li>
                <li>
                  <strong>Multiple positions:</strong> Heat next sleeve while splicing
                </li>
                <li>
                  <strong>Cycle time:</strong> Typically 20-40 seconds
                </li>
                <li>
                  <strong>Temperature settings:</strong> Adjustable for different sleeve types
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Arc calibration:</strong> Adjusts arc power for
                  temperature/pressure/humidity
                </li>
                <li>
                  <strong>Fibre identification:</strong> Recognises SM/MM and selects appropriate
                  programme
                </li>
                <li>
                  <strong>Auto-focus:</strong> Camera focus adjustment
                </li>
                <li>
                  <strong>Loss estimation:</strong> Calculates expected splice loss from alignment
                </li>
                <li>
                  <strong>Proof test:</strong> Applies tension to verify splice strength (optional)
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Purpose:</strong> Create flat, perpendicular fibre end face
                </li>
                <li>
                  <strong>Blade:</strong> Diamond or tungsten carbide, multiple positions
                </li>
                <li>
                  <strong>Angle specification:</strong> Must achieve under 1 degree consistently
                </li>
                <li>
                  <strong>Price range:</strong> 200-2,000 pounds depending on quality
                </li>
                <li>
                  <strong>Blade life:</strong> 10,000-20,000 cleaves with position rotation
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Mechanical Strippers:</strong> Fixed or adjustable holes for different
                  coating diameters. Common types: CFS-2 style, Ripley Miller, Jonard.
                </li>
                <li>
                  <strong>Thermal Strippers:</strong> Heated element softens coating for clean
                  removal. Reduces fibre stress. Good for 250 micrometre coated fibre.
                </li>
                <li>
                  <strong>Jacket Strippers:</strong> For removing outer cable jackets. Different
                  tools for different jacket sizes.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Beyond the core splicing equipment, various accessories and support items are needed
              for effective splicing operations.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Fibre holders:</strong> Match splicer model, various coating diameters
                </li>
                <li>
                  <strong>Splice protectors:</strong> Heat shrink sleeves, 40mm/60mm lengths
                </li>
                <li>
                  <strong>Electrodes:</strong> Spare pairs for replacement (consumable)
                </li>
                <li>
                  <strong>Cleaning supplies:</strong> IPA, lint-free wipes, cleaning sticks
                </li>
                <li>
                  <strong>Carrying case:</strong> Protection for transport and storage
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>40mm:</strong> Standard length for most splices
                </li>
                <li>
                  <strong>60mm:</strong> For longer stripped sections or difficult routing
                </li>
                <li>
                  <strong>Strength member:</strong> Steel rod inside for mechanical protection
                </li>
                <li>
                  <strong>Mini sleeves:</strong> For compact splice trays
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>V-groove cleaning:</strong> Clean with cotton swab and IPA after each
                  session
                </li>
                <li>
                  <strong>Mirror/lens cleaning:</strong> Clean viewing optics as needed
                </li>
                <li>
                  <strong>Electrode check:</strong> Inspect for wear, clean if contaminated
                </li>
                <li>
                  <strong>Fibre clamp cleaning:</strong> Remove debris from holder surfaces
                </li>
                <li>
                  <strong>Arc calibration:</strong> Run auto-calibration before splicing
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Life cycle:</strong> Typically 2,000-5,000 splices per pair
                </li>
                <li>
                  <strong>Signs of wear:</strong> Inconsistent arcs, high loss splices, visible
                  pitting
                </li>
                <li>
                  <strong>Replacement:</strong> Follow manufacturer procedure, re-calibrate after
                </li>
                <li>
                  <strong>Stock spares:</strong> Always have replacement electrodes available
                </li>
                <li>
                  <strong>Track usage:</strong> Record splice count for replacement scheduling
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Selecting the right equipment involves balancing performance requirements, budget, and
              operational needs.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Fibre types:</strong> SM only, MM only, or both? Ribbon capability needed?
                </li>
                <li>
                  <strong>Quality requirements:</strong> Backbone (core alignment) vs distribution
                  (clad OK)
                </li>
                <li>
                  <strong>Volume:</strong> Occasional use vs daily production
                </li>
                <li>
                  <strong>Environment:</strong> Workshop, field, or both?
                </li>
                <li>
                  <strong>Support:</strong> Local service availability, training, spare parts
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm font-medium text-elec-yellow mb-2">
                Typical Equipment Costs (2024)
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Core alignment splicer:</strong> 5,000-30,000 pounds+
                </li>
                <li>
                  <strong>Clad alignment splicer:</strong> 3,000-8,000 pounds
                </li>
                <li>
                  <strong>Precision cleaver:</strong> 200-2,000 pounds
                </li>
                <li>
                  <strong>Complete kit (splicer + cleaver + tools):</strong> 4,000-35,000 pounds
                </li>
                <li>
                  <strong>Rental (daily/weekly):</strong> 50-200 pounds/day
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Match equipment to application:</strong> Do not overspend or underspend
                </li>
                <li>
                  <strong>Invest in training:</strong> Equipment is only as good as the operator
                </li>
                <li>
                  <strong>Maintain regularly:</strong> Prevents problems and extends equipment life
                </li>
                <li>
                  <strong>Keep spares:</strong> Electrodes, protectors, cleaning supplies always on
                  hand
                </li>
                <li>
                  <strong>Document everything:</strong> Track maintenance, calibration, and usage
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Check battery:</strong> Ensure sufficient charge before starting
                </li>
                <li>
                  <strong>Run calibration:</strong> Environmental conditions affect arc parameters
                </li>
                <li>
                  <strong>Protect from dust:</strong> Use wind shields and clean work area
                </li>
                <li>
                  <strong>Have backup power:</strong> Vehicle DC adapter or spare battery
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Skipping calibration</strong> - arc calibration should be run before each
                  session
                </li>
                <li>
                  <strong>Using worn electrodes</strong> - causes inconsistent results and re-work
                </li>
                <li>
                  <strong>Poor cleaver maintenance</strong> - leads to poor cleaves and splice
                  failures
                </li>
                <li>
                  <strong>Ignoring V-groove cleaning</strong> - contaminated grooves cause alignment
                  errors
                </li>
                <li>
                  <strong>Storing improperly</strong> - dust and moisture damage sensitive
                  components
                </li>
              </ul>
            </div>
