...
const quizQuestions = [
  {
    id: 1,
    question:
      'What type of inspection frequency is recommended for checking PV module glass condition?',
  ...
  },
  {
    ...
    options: ['Never', 'During annual comprehensive maintenance', 'Only after failures', 'Monthly'],
    correctAnswer: 1,
    explanation:
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">In 30 Seconds:</span> Target 80%
              planned maintenance, 20% reactive
            </p>
          </div>
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">Spot it:</span> Visual quarterly,
              electrical annually, firmware quarterly
            </p>
          </div>
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">Use it:</span> Document findings,
              actions, and recommendations every visit
            </p>
          </div>
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">Key Task:</span> Schedule intensive
              work during low-production months
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 space-y-6 pb-8">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Maintenance Tiers:</span> Daily involves
              remote monitoring checks and alarm review. Weekly includes performance data analysis
              and trend review. Monthly covers basic visual inspection and cleaning assessment.
              Quarterly involves detailed visual inspection and performance analysis. Annually is
              comprehensive maintenance including electrical testing.
            </p>
            <p>
              <span className="text-white font-medium">Schedule Development:</span> Base schedules
              on manufacturer requirements, industry standards, site-specific factors, and
              operational experience. Build in flexibility for weather-dependent tasks. Consider
              site access constraints such as farm cycles or building access times. Align with
              warranty requirements.
            </p>
            <p>
              <span className="text-white font-medium">Resource Planning:</span> Identify required
              skills for each task tier. Plan tool and equipment requirements. Schedule qualified
              personnel availability. Allow contingency time for unexpected findings.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Monthly Walkthrough:</span> Check for obvious
              damage or disturbance. Verify security of enclosures and access points. Note any
              vegetation encroachment. Check for new shading sources. Review monitoring system
              health.
            </p>
            <p>
              <span className="text-white font-medium">Quarterly Detailed Inspection:</span> Inspect
              all module surfaces for damage, soiling, and discolouration. Check mounting structure
              integrity and fixings. Examine cables and conduits for damage or degradation. Verify
              labelling remains legible. Assess drainage and water management.
            </p>
            <p>
              <span className="text-white font-medium">Documentation Standards:</span> Use
              standardised checklists for consistency. Photograph any concerns with location
              reference. Record weather conditions during inspection. Note any changes since
              previous visit. Recommend follow-up actions with priority ratings.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Annual Electrical Testing:</span> Insulation
              resistance testing on all DC circuits. Open circuit voltage measurements for all
              strings. String current comparison under consistent conditions. Earth continuity
              verification. Protection device functional testing including RCDs.
            </p>
            <p>
              <span className="text-white font-medium">Thermal Imaging (Annual):</span> Schedule
              during high-irradiance period for best results. Cover all modules, connections, and
              combiner boxes. Document anomalies with severity classification. Compare with previous
              surveys to track changes. Prioritise remedial actions based on risk.
            </p>
            <p>
              <span className="text-white font-medium">Connection Integrity:</span> Torque-check DC
              connections annually or after thermal anomalies. Verify MC4 and terminal connections
              are secure. Check combiner box connections and fuse contacts. Examine AC connection
              points and distribution equipment.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Quarterly Firmware Review:</span> Check
              manufacturer websites for available updates. Review release notes for relevant
              improvements or fixes. Assess security updates for urgency. Plan update schedule
              during appropriate periods. Test on non-critical equipment first where possible.
            </p>
            <p>
              <span className="text-white font-medium">Update Procedures:</span> Document current
              firmware versions before updating. Create backup of settings where possible. Schedule
              updates during low-production periods. Apply updates systematically, verifying
              operation after each. Document successful updates and any issues encountered.
            </p>
            <p>
              <span className="text-white font-medium">Monitoring Software:</span> Keep monitoring
              platforms updated. Verify data integrity and accuracy regularly. Check alert
              thresholds remain appropriate. Review user access and security settings. Ensure data
              backup procedures are functioning.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Performance-Based Adjustment:</span> Use
              monitoring data to identify systems needing more attention. Reduce frequency for
              consistently well-performing systems. Increase inspection of problem-prone equipment.
              Adjust cleaning schedules based on soiling impact data.
            </p>
            <p>
              <span className="text-white font-medium">Seasonal Considerations:</span> Schedule
              intensive maintenance during low-production months such as winter in the UK. Plan
              cleaning before peak production season. Consider weather impacts on outdoor work.
              Adjust vegetation management for growing seasons.
            </p>
            <p>
              <span className="text-white font-medium">Annual Schedule Review:</span> Assess
              effectiveness of current programme. Review failure and near-miss incidents. Update for
              any equipment or site changes. Benchmark against industry developments. Incorporate
        ...
        <div className="bg-gradient-to-r from-elec-yellow/10 to-amber-500/10 border border-elec-yellow/20 rounded-xl p-4">
          ...
          <div className="space-y-2 text-white text-sm">
            <p>
              ...
              Consider risk-based approaches for large portfolios.
            </p>
            <p>
              <span className="text-white font-medium">Documentation discipline:</span> Consistent
              documentation enables trend analysis and supports warranty claims. Use standardised
              forms and checklists. Store records securely with appropriate backup.
            </p>
            <p>
              <span className="text-white font-medium">Communication with stakeholders:</span> Keep
              system owners informed of maintenance activities and findings. Provide clear
              recommendations with rationale. Build maintenance into long-term asset management
              discussions.
            </p>
          </div>
        </div>
        ...
        {/* Quiz */}
        <Quiz title="Maintenance Schedules Quiz" questions={quizQuestions} />
