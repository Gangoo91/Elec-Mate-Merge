...
const inlineChecks = [
  {
    ...
    options: [
      'Three generations — 50 kW (early), 150 kW (mid-market) and 350 kW (ultra-rapid)',
      'A fixed 7 kW per charger, the same as a single-phase domestic AC wallbox',
      'A maximum of 22 kW per charger, identical to a three-phase Mode 3 unit',
      'A flat 1 MW per charger, standardised across every generation',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'BS EN 61851-1 alone, which is the general-requirements part of the series',
      'BS EN 60898 alone, which is the MCB product standard',
      'BS 7671 alone, with no equipment product standard involved',
      'BS EN 61851-23 — DC EV charging station requirements — with -1 and BS EN IEC 62196-3',
    ],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It is the same connector as Type 2, just relabelled, with no DC pins added',
      'It adds two large DC pins below a Type 2 plug, so one socket takes AC and DC',
      'It is simply another name for the Japanese-market CHAdeMO standard',
      'It is a physically smaller connector that replaces the Type 2 inlet entirely',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A three-phase LV supply at ~250 A per phase, usually needing a DNO upgrade',
      'A domestic 100 A single-phase supply with diversity applied to the house load',
      'A standard unchanged domestic supply, as for a 7 kW home wallbox',
      'A 24 V DC supply drawn from an on-site lead-acid battery bank',
    ],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  {
    question:
      'A public DC fast hub developer wants 8 × 150 kW chargers + 2 × 350 kW ultra-rapid. Total supply requirement?',
    options: [
      '1,900 kW peak — a dedicated substation, ~2,000 kVA transformer and LV switchgear',
      'A 100 A LV supply with diversity applied across the whole hub',
      'A single 32 A three-phase supply shared between all ten chargers',
      'No DNO involvement, as the chargers run from their own on-site storage',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Purely for aesthetics and to match the product styling of the pillar',
      'They are cheaper to manufacture than equivalent dry copper cables',
      'High DC current makes a dry cable too heavy; cooling allows smaller copper',
      'It is a legal requirement for every DC charger regardless of its current',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'They are the same standard published under two different numbers',
      'BS EN IEC 62196-3 applies only to heavy industrial DC equipment',
      '-2 covers AC accessories (Type 2) and -3 covers DC accessories (CCS Combo 2)',
      'BS EN IEC 62196-2 is obsolete and no longer used on new installs',
    ],
    correctAnswer: 2,
    explanation:
  ...
  {
    question:
      'For a 50 kW DC fast charger on a commercial site with existing 200 A LV supply per phase, can the existing supply accommodate?',
    options: [
      'No — a 50 kW charger always exceeds any 200 A per phase commercial supply',
      'Yes — at ~72-80 A per phase it fits on a 200 A supply plus base load',
      'No — a dedicated 1 MW supply is required before any DC charger can run',
      'Yes — even a standard single-phase domestic supply would be adequate here',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Uniformly — the PME-on-EV prohibition and alternatives (b)-(e) apply per charger',
      'They do not apply to DC fast chargers at all, only to AC equipment',
      'They apply only to AC Mode 3 chargers and never to Mode 4 DC fast units',
      'They apply only to domestic installs and never to commercial public hubs',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Exactly the same tests as a Mode 3 AC install, with nothing added on the DC side',
      'No commissioning at all, since the unit fully self-tests on first energise',
      'The customer carries out the additional DC-side tests after the installer leaves',
      'BS EN 61851-23 DC tests on top: DC isolation, contactor, communication, thermal',
    ],
    correctAnswer: 3,
    explanation:
...
export default function RenewableEnergyModule7Section3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 3 · BS 7671:2018+A4:2026 · Section 722 + BS EN 61851-23 + BS EN IEC 62196-3"
        title="Mode 4 DC fast charging"
        backTo="../renewable-energy-module-7"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          DC fast EV charging — BS EN 61851-23 DC charging stations, CCS Combo 2 connector (BS EN
          IEC 62196-3), CHAdeMO + Tesla NACS variants, 50 / 150 / 350 kW generations, liquid-cooled
          cables on high-power units, DNO HV supply infrastructure, transformer + LV switchgear.
        </p>
        ...
        <Pullquote>
          DC fast charging is electrical infrastructure dressed as a customer-facing kiosk. The
          transformer behind the pillar is where the money lives.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Mode 3 AC</strong> — wallbox delivers regulated AC;
              vehicle on-board charger does AC-to-DC + BMS communication. Wallbox size: ~30 × 50 cm,
              ~5-10 kg
            </li>
            <li>
              <strong className="text-white">Mode 4 DC</strong> — charger contains AC-to-DC
              electronics + thermal management + DC contactors + communication. Vehicle’s BMS still
              manages the battery but receives DC directly. Charger size: ~1-2 m tall, 30-200 cm
              wide, 100-2,000 kg
            </li>
            <li>
              <strong className="text-white">Power range</strong> — Mode 3: 3.7-22 kW typical. Mode
              4: 50-350 kW typical; emerging 500 kW + 1 MW for HGV
            </li>
            <li>
              <strong className="text-white">Vehicle compatibility</strong> — Mode 3: works with any
              EV (even slow OBCs fall back gracefully). Mode 4: vehicle must have DC fast charging
              capability (most modern EVs do; some early models or low-end don’t)
            </li>
            <li>
              <strong className="text-white">Charging time</strong> — Mode 3: 8-12 hours for typical
              60 kWh battery. Mode 4 at 150 kW: ~25-40 min to 80%. Mode 4 at 350 kW: ~15-20 min to
              80% (battery + vehicle ramping limits)
            </li>
            <li>
              <strong className="text-white">Cost per unit</strong> — Mode 3: £600-£4,000 (domestic
              to commercial workplace). Mode 4: £15-100k+ depending on power rating
            </li>
            <li>
              <strong className="text-white">Site infrastructure</strong> — Mode 3: typically
              existing supply. Mode 4 50 kW: existing commercial LV may accommodate; 150+ kW:
              usually dedicated DNO upgrade or HV; multi-hub: dedicated substation + transformer
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          One vehicle socket. Two pin sets. Same physical inlet supports AC Mode 3 and DC Mode 4 —
          that’s the genius of CCS Combo 2.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Top (Type 2 portion)</strong> — L1, L2, L3, N, PE, CP,
              PP. Same 7-pin layout as standard Type 2 connector (per BS EN IEC 62196-2). Used for
              AC Mode 3 charging
            </li>
            <li>
              <strong className="text-white">Bottom (DC portion)</strong> — two large DC power pins
              (DC+ and DC-) sized for high current (up to 500+ A on ultra-rapid). Per BS EN IEC
              62196-3
            </li>
            <li>
              <strong className="text-white">Dual mode</strong> — same vehicle inlet accepts both
              plug types. AC plug engages top pins only; DC plug engages top (signalling) + bottom
              (DC delivery)
            </li>
            <li>
              <strong className="text-white">Communication</strong> — DC charging uses ISO 15118
              (Digital Communication, PLC-over-CP) negotiating voltage, current, state-of-charge
              updates, plug-and-charge authentication
            </li>
            <li>
              <strong className="text-white">UK 2025-26 dominance</strong> — virtually every new EV
              sold in UK 2025-26 has CCS Combo 2. Public DC fast hubs predominantly CCS-only or CCS
              + Tesla NACS
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — charger manufacturer
              DoC citing BS EN IEC 62196-3 conformity + ISO 15118 if plug-and-charge supported
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">CCS Combo 2 (dominant)</strong> — per BS EN IEC
              62196-3. Virtually all UK 2025-26 new EVs. New install standard
            </li>
            <li>
              <strong className="text-white">CHAdeMO (declining)</strong> — Japanese origin. Legacy
              Nissan Leaf early models, Mitsubishi, Lexus. UK 2025-26 new installs rarely include
              dedicated CHAdeMO; multi-protocol units may add CHAdeMO outlet
            </li>
            <li>
              <strong className="text-white">Tesla NACS (emerging)</strong> — USA origin; Tesla’s
              North American Charging Standard. Opening to industry adoption. UK 2025-26: appearing
              on Tesla Supercharger sites open to non-Tesla EVs + some new multi-protocol hubs
            </li>
            <li>
              <strong className="text-white">GB/T (Chinese)</strong> — Chinese-market standard. Not
              in UK domestic install scope; appears on imported Chinese EVs (rare in UK)
            </li>
            <li>
              <strong className="text-white">Multi-protocol units</strong> — some commercial DC fast
              chargers include 2 or 3 connector cables (CCS + CHAdeMO, or CCS + NACS) to support
              multiple vehicle types at one bay
            </li>
            <li>
              <strong className="text-white">Adapters</strong> — vehicle-to-connector adapters exist
              (e.g. NACS → CCS for non-Tesla vehicles using Superchargers) but customer-side; not
              installer’s scope
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">50 kW Mode 4</strong> — ~80 A per phase nominal at 400
              V three-phase. Most commercial LV supplies (200-400 A per phase) accommodate one 50 kW
              unit + existing base load + DLM. G99 application typical
            </li>
            <li>
              <strong className="text-white">150 kW Mode 4</strong> — ~240 A per phase nominal.
              Existing commercial LV usually insufficient; DNO upgrade typical (new connection
              ~400-630 A per phase) or HV (11 kV) connection. G99 application + DNO approval
              mandatory
            </li>
            <li>
              <strong className="text-white">350 kW Mode 4</strong> — ~550 A per phase nominal per
              charger. Multi-charger 350 kW hub requires dedicated HV connection + on-site
              transformer (1-2 MVA per hub of 4-8 chargers) + LV switchgear. £100-£500k+ grid
              infrastructure cost; 6-18 month lead time
            </li>
            <li>
              <strong className="text-white">Multi-charger hubs</strong> — 6-12 chargers per hub
              typical. DLM coordinates across all units; peak demand ~60-70% of nominal aggregate
              (utilisation factor). HV connection + substation + transformer + LV switchgear. Real
              estate + planning + civils are major components of the project alongside electrical
            </li>
            <li>
              <strong className="text-white">Transformer sizing</strong> — typically 1.5-2× peak
              nominal demand for margin + future expansion. 1,500-2,000 kVA common at 6-8 × 150 kW
              hubs
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — DNO connection
              agreement + reference + transformer specification + LV switchgear conformity to BS EN
              IEC 61439-1 / -2 + (relevant SLD)
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Dry cable limits</strong> — conventional dry copper
              cable at 500 A sustained needs ~120-150 mm² + thermal headroom = ~7-9 kg/m.
              Uncomfortable for customer to manhandle
            </li>
            <li>
              <strong className="text-white">Liquid-cooled cable</strong> — water-glycol coolant
              pumped through cable around ~50 mm² copper. Operating temperature dropped; cable
              weight ~2-3 kg/m
            </li>
            <li>
              <strong className="text-white">Generation thresholds</strong> — 50 kW typically dry
              cable; 150 kW manufacturer choice; 350 kW always liquid-cooled
            </li>
            <li>
              <strong className="text-white">Cooling system</strong> — pump + reservoir + heat
              exchanger inside the charger pillar. Service interval typically annual
            </li>
            <li>
              <strong className="text-white">Cable lifetime</strong> — 5-7 years typical at 350 kW
              intensive sites; longer at lower utilisation. Cable replacement is a manufacturer /
              service contract item
            </li>
            <li>
              <strong className="text-white">Customer-facing weight</strong> — manageable (2-3 kg/m)
              so end users can plug in without strain; mounted holster on the pillar reduces lifting
              requirement
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — cable type + cooling
              system spec + manufacturer service interval + first cable replacement scheduled date
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">DIN SPEC 70121</strong> — legacy DC communication
              (basic negotiation, no plug-and-charge). Pre-2018 CCS chargers
            </li>
            <li>
              <strong className="text-white">ISO 15118-2</strong> — current standard. Supports
              plug-and-charge with PKI certificate exchange. UK 2025-26 mainstream
            </li>
            <li>
              <strong className="text-white">ISO 15118-20</strong> — next-generation. Supports
              bidirectional V2G + wireless charging + simplified PnC. Emerging in UK 2025-26
            </li>
            <li>
              <strong className="text-white">PLC over CP</strong> — physical implementation.
              HomePlug Green PHY 10 Mbps digital data riding the Control Pilot signal
            </li>
            <li>
              <strong className="text-white">Plug-and-charge</strong> — vehicle certificate
              authenticates to operator’s back-office; charging session authorised without RFID /
              app / contactless card
            </li>
            <li>
              <strong className="text-white">Pricing transparency</strong> — ISO 15118-2 supports
              the charger displaying tariff to the vehicle; vehicle shows price to driver before
              authorising. PCAR 2023 alignment
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — ISO 15118 version +
              plug-and-charge support + manufacturer DoC + commissioning test with a
              known-compatible vehicle
            </li>
          </ul>
        </ConceptBlock>

        <Pullquote>
          Liquid-cooled cable, dedicated HV substation, ISO 15118 plug-and-charge — DC fast is where
          electrical install meets digital infrastructure.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Cooling system inspection</strong> — annual typical.
              Pump function, coolant level, heat exchanger function, leak check
            </li>
            <li>
              <strong className="text-white">Coolant replenishment</strong> — manufacturer-specified
              (water-glycol typical). Service contract item
            </li>
            <li>
              <strong className="text-white">Cable replacement interval</strong> — 5-7 years at 350
              kW intensive (motorway hub 10-15+ sessions/day); longer at lower utilisation.
              Customer-facing cable is the wear part
            </li>
            <li>
              <strong className="text-white">Cable replacement procedure</strong> — disconnect
              charger from grid; isolate DC bus; technician swap cable + plug assembly; cooling
              system flush + refill; commissioning retest. Typically 4-8 hours per cable
            </li>
            <li>
              <strong className="text-white">Leak detection</strong> — modern chargers include
              coolant-pressure / level sensor; alarm raised via OCPP if leak detected; charger
              automatically de-rates or shuts down to prevent damage
            </li>
            <li>
              <strong className="text-white">Service contract</strong> — typical 5-10 year
              manufacturer or 3rd-party service contract. Cost ~£2-5k per charger per year for 350
              kW intensive
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — first cable replacement
              date + service contract reference + cooling system spec. CPO owns the maintenance
