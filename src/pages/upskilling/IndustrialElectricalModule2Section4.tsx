...
const IndustrialElectricalModule2Section4: React.FC = () => {
  ...
  useSEO({
    ...
    description:
      'Master emergency stop categories (0, 1, 2) per BS EN ISO 13850, safety relay modules, interlock circuits for guards and doors, performance levels (PL), SIL ratings, and testing requirements under the Machinery Directive.',
    keywords: [
      'emergency stop',
      'E-stop categories',
      'BS EN ISO 13850',
  ...
  const quickCheckQuestions = [
    {
      ...
      correctIndex: 1,
      explanation:
        'Category 0 is an uncontrolled stop that removes power immediately from machine actuators. Category 1 is a controlled stop where power is available to achieve the stop, then power is removed once standstill is achieved. Category 1 is preferred where sudden power removal could create hazards.',
    },
    {
      id: 'qc2-s4-positive-contacts',
      question:
        'What does "positive-opening contacts" (IEC 60947-5-1) mean in safety circuit design?',
      options: [
      ...
      correctIndex: 2,
      explanation:
        'Positive-opening contacts (also called direct-opening action) have a mechanical link between the actuator and contacts ensuring that when the actuator is operated, the contacts MUST open even if welded or stuck. This is a critical safety requirement - the contacts cannot fail in a closed state.',
    },
    {
      id: 'qc3-s4-performance-level',
      question:
        'According to BS EN ISO 13849-1, which Performance Level (PL) requires the highest reliability for safety functions?',
      options: ['PL a (lowest)', 'PL c (medium)', 'PL d (high)', 'PL e (highest)'],
      correctIndex: 3,
      explanation:
        'Performance Levels range from PL a (lowest) to PL e (highest). PL e requires the highest reliability with a probability of dangerous failure per hour (PFHd) of less than 10^-7. PL e is typically required for high-risk applications where severe or fatal injuries could result from safety function failure.',
    },
  ];
  ...
  const quizQuestions = [
    ...
    {
      question:
        'What type of operation must emergency stop devices have according to BS EN ISO 13850?',
      options: [
      ...
      <main className="max-w-3xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
          ...
          <p className="text-sm text-muted-foreground">
            Emergency stop and interlock systems are the last line of defence against machinery
            hazards. This section covers the legal requirements under the Machinery Directive, the
            technical standards BS EN ISO 13850 and BS EN ISO 13849-1, and the practical
            implementation of safety-related control systems. You will learn to select appropriate
            E-stop categories, design safety circuits with the correct Performance Level, and
            maintain compliance through proper testing and documentation.
          </p>
        </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              BS EN ISO 13850 (Emergency stop function - Principles for design) defines the
              requirements for emergency stop devices and their integration into machinery safety
              systems. The standard works alongside BS EN 60204-1 which defines the three stop
              categories.
            </p>
            ...
            <div className="space-y-3">
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                ...
                <ul className="text-sm text-muted-foreground space-y-1 ml-4">
                  <li>
                    <strong>How it works:</strong> Direct disconnection of mains power
                  </li>
                  <li>
                    <strong>Stopping method:</strong> Free-running/coasting
                  </li>
                  <li>
                    <strong>Use when:</strong> Immediate power removal is safe; simple machines
                  </li>
                  <li>
                    <strong>Example:</strong> Conveyor belt, simple drill press
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-8 h-8 bg-orange-600 rounded-full flex items-center justify-center font-bold text-white text-sm">
                    1
                  </div>
                  <h4 className="font-medium text-orange-400">Category 1 - Controlled Stop</h4>
                </div>
                <p className="text-sm text-muted-foreground mb-2">
                  Power remains available to achieve a controlled stop. Once stopped, power is then
                  removed from actuators.
                </p>
                <ul className="text-sm text-muted-foreground space-y-1 ml-4">
                  <li>
                    <strong>How it works:</strong> Active braking/deceleration, then power removal
                  </li>
                  <li>
                    <strong>Stopping method:</strong> Controlled deceleration to standstill
                  </li>
                  <li>
                    <strong>Use when:</strong> Sudden stop creates hazard; heavy inertia loads
                  </li>
                  <li>
                    <strong>Example:</strong> CNC machine spindle, centrifuge, vertical axis
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg p-4">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-8 h-8 bg-elec-yellow rounded-full flex items-center justify-center font-bold text-black text-sm">
                    2
                  </div>
                ...
                <p className="text-sm text-muted-foreground mb-2">
                  Power remains available during and after stopping. Machine held at standstill by
                  continuous power application.
                </p>
                <ul className="text-sm text-muted-foreground space-y-1 ml-4">
                  <li>
                    <strong>How it works:</strong> Controlled stop with power remaining on
                  </li>
                  <li>
                    <strong>Stopping method:</strong> Active holding at standstill
                  </li>
                  <li>
                    <strong>Use when:</strong> Position must be maintained; gravity loads
                  </li>
                  <li>
                    <strong>Example:</strong> Robot arm, press brake (holding up position)
                  </li>
                  <li className="text-amber-400">
                    <strong>Note:</strong> NOT permitted for emergency stop - use Cat 0 or 1
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-background/50 p-4 rounded-lg border border-white/10">
              <h4 className="font-medium text-elec-yellow mb-3">
                Key Requirements for Emergency Stop (BS EN ISO 13850)
              </h4>
              <div className="grid sm:grid-cols-2 gap-4">
                <ul className="text-sm text-muted-foreground space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Colour:</strong> Red actuator on yellow background
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Type:</strong> Mushroom-head or palm-operated
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Operation:</strong> Latching (maintained) - must stay actuated
                    </span>
                  </li>
                </ul>
                <ul className="text-sm text-muted-foreground space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Reset:</strong> Manual reset only (deliberate action required)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Restart:</strong> Reset must not restart machine automatically
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Priority:</strong> Must override all other functions
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>
                    <strong>Mushroom head:</strong> Standard 40mm or 60mm diameter
                  </li>
                  <li>
                    <strong>Palm-operated:</strong> Large area for quick operation
                  </li>
                  <li>
                    <strong>Pull-wire (rope):</strong> For extended protection zones
                  </li>
                  <li>
                    <strong>Foot-operated:</strong> When hands are occupied
                  </li>
                  <li>
                    <strong>Enabling devices:</strong> 3-position for hold-to-run
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>
                    <strong>Positive-opening:</strong> Mandatory for safety circuits
                  </li>
                  <li>
                    <strong>Contact rating:</strong> Appropriate for safety relay input
                  </li>
                  <li>
                    <strong>Redundancy:</strong> Dual NC contacts for dual-channel
                  </li>
                  <li>
                    <strong>Marking:</strong> IEC 60947-5-1 compliance symbol
                  </li>
                  <li>
                    <strong>IP rating:</strong> Minimum IP65 for industrial use
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <ul className="text-sm text-muted-foreground space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Input monitoring:</strong> Dual-channel input evaluation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Cross-monitoring:</strong> Detects discrepancies between channels
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>EDM:</strong> External Device Monitoring of contactors
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Reset control:</strong> Manual/automatic restart options
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500 flex-shrink-0 mt-0.5" />
                    <span>
                      <strong>Fault detection:</strong> Self-test at each operation
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>
                    <strong>Safety outputs:</strong> Force-guided relay contacts
                  </li>
                  <li>
                    <strong>Redundant outputs:</strong> 2 or 3 NO contacts for actuators
                  </li>
                  <li>
                    <strong>Auxiliary contacts:</strong> For diagnostics/PLC feedback
                  </li>
                  <li>
                    <strong>Delayed outputs:</strong> For controlled stop sequences
                  </li>
                  <li>
                    <strong>Current rating:</strong> Typically 6A per contact at 250V AC
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Safety relays use force-guided (mechanically linked) contacts ensuring that NO
                    and NC contacts cannot be closed simultaneously. This allows fault detection -
                    if the NC contact used for feedback doesn't open when the NO contacts close, a
                    fault is detected. This is essential for External Device Monitoring (EDM) of
                    contactors.
                  </p>
                </div>
              </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Guard interlocks prevent access to hazardous areas while machinery is operating. BS EN
              ISO 14119 specifies the design principles for interlocking devices associated with
              guards. The choice of interlock type depends on the risk level and required
              Performance Level.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <p className="text-sm text-muted-foreground mb-2">
                  Simple interlock that stops machine when guard is opened. Machine can coast to
                  stop.
                </p>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>
                    <strong>Application:</strong> Low-risk machinery
                  </li>
                  <li>
                    <strong>Run-down time:</strong> Less than access time
                  </li>
                  <li>
                    <strong>Types:</strong> Magnetic, mechanical, RFID coded
                  </li>
                  <li>
                    <strong>Typical PL:</strong> PL c to PL d
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <p className="text-sm text-muted-foreground mb-2">
                  Guard is locked closed until hazard has ceased (e.g., spindle stopped, press at
                  top).
                </p>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>
                    <strong>Application:</strong> High-risk, long run-down time
                  </li>
                  <li>
                    <strong>Unlock condition:</strong> Zero speed/safe position verified
                  </li>
                  <li>
                    <strong>Types:</strong> Solenoid lock, trapped key
                  </li>
                  <li>
                    <strong>Typical PL:</strong> PL d to PL e
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div>
              <h4 className="font-medium text-foreground mb-3">
                Interlock Switch Types (BS EN ISO 14119)
              </h4>
              <div className="space-y-3">
                <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                  <div className="flex items-center justify-between mb-2">
                    <h5 className="font-medium text-foreground text-sm">
                      Mechanical Cam/Tongue Switches
                    </h5>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    (easily defeated). Suitable for low-risk applications where deliberate defeat is
                    unlikely.
                  </p>
                </div>
                ...
                <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Non-contact operation with coded magnetic actuator. Higher coding level (harder
                    to defeat with simple magnet). Good for harsh environments.
                  </p>
                </div>
                ...
                <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Highest coding level using unique RFID transponders. Virtually impossible to
                    defeat. Required for high-risk applications where deliberate circumvention is
                    foreseeable.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium text-amber-400 mb-2">
                    Defeat Prevention (BS EN ISO 14119)
                  </h4>
                  <p className="text-sm text-muted-foreground mb-2">
                    The standard requires assessment of the motivation to defeat interlocks.
                    Consider:
                  </p>
                  <ul className="text-sm text-muted-foreground space-y-1 ml-4">
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              to achieve the required Performance Level (PL). The PL represents the probability of
              dangerous failure per hour (PFHd) of the safety function.
            </p>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-white/10">
                      ...
                      <th className="text-left py-2 text-elec-yellow font-medium">
                        PFHd Range (per hour)
                      </th>
                      <th className="text-left py-2 text-elec-yellow font-medium">
                        Typical Application
                  ...
                  <tbody className="text-muted-foreground">
                    ...
                    <tr className="border-b border-white/5">
                      ...
                      <td className="py-2">
                        &gt;=3x10<sup>-6</sup> to &lt;10<sup>-5</sup>
                      </td>
                    ...
                    <tr className="border-b border-white/5">
                      ...
                      <td className="py-2">
                        &gt;=10<sup>-6</sup> to &lt;3x10<sup>-6</sup>
                      </td>
              ...
              <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <div className="grid sm:grid-cols-3 gap-4">
                  <div>
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1">
                      <li>
                        <strong>S1:</strong> Slight (reversible)
                      </li>
                      <li>
                        <strong>S2:</strong> Serious (irreversible/fatal)
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1">
                      <li>
                        <strong>F1:</strong> Seldom/short exposure
                      </li>
                      <li>
                        <strong>F2:</strong> Frequent/long exposure
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1">
                      <li>
                        <strong>P1:</strong> Avoidance possible
                      </li>
                      <li>
                        <strong>P2:</strong> Avoidance impossible
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="mt-4 p-3 bg-elec-yellow/5 rounded border border-elec-yellow/20">
                  <p className="text-sm text-muted-foreground">
                    <strong className="text-elec-yellow">Example:</strong> Press brake with serious
                    crush hazard (S2), frequent operation (F2), impossible to avoid (P2) ={' '}
                    <strong className="text-red-400">PLr = e</strong>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                  <h5 className="text-elec-yellow font-medium mb-2 text-sm">
                    BS EN ISO 13849-1 (PL)
                  </h5>
                  <ul className="text-sm text-muted-foreground space-y-1">
              ...
              <div className="mt-3 bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
                <p className="text-sm text-muted-foreground">
                  <strong className="text-blue-400">Approximate correlation:</strong> PL c ≈ SIL 1,
            ...
            <div>
              ...
              <div className="bg-background/50 p-4 rounded-lg border border-white/10 overflow-x-auto">
                <p className="text-sm text-muted-foreground mb-3">
                  The achieved PL depends on system architecture (Category), component reliability
                  (MTTFd), diagnostic coverage (DC), and common cause failure protection (CCF):
                </p>
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-white/10">
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              Regulations) require that safety-related control systems are properly designed,
              validated, documented, and maintained throughout their lifecycle.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>
                    <strong>Frequency:</strong> Annual or per risk assessment
                  </li>
                  <li>
                    <strong>E-stop test:</strong> Actuate and verify stop function
                  </li>
                  <li>
                    <strong>Interlock test:</strong> Open guard, verify stop
                  </li>
                  <li>
                    <strong>Reset test:</strong> Verify manual reset required
                  </li>
                  <li>
                    <strong>Light curtain:</strong> Break beam, verify response
                  </li>
                  <li>
                    <strong>Record:</strong> Date, tester, results, remedial actions
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    <p className="text-elec-yellow font-medium mb-2 text-sm">
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Any modification to a safety-related control system requires re-validation.
                    Under PUWER, the employer must ensure the machine remains safe after
                    modification. Changes must be documented, PL/SIL recalculated if architecture
                    changes, and validation testing repeated. Failure to properly manage
                    modifications can result in prosecution if an incident occurs.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                <p className="text-sm text-muted-foreground mb-3">
                  ...
                  Applications) is a free tool from IFA (German Social Accident Insurance) for
                  calculating Performance Level according to BS EN ISO 13849-1.
                </p>
                <div className="grid sm:grid-cols-2 gap-4 text-sm">
                  <div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div>
                <h4 className="font-medium text-foreground mb-2 text-sm">
                  E-stop Requirements (BS EN ISO 13850)
                </h4>
                <ul className="text-sm text-muted-foreground space-y-1">
              ...
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>
                    <strong>BS EN ISO 13850:</strong> Emergency stop principles
                  </li>
                  <li>
                    <strong>BS EN ISO 13849-1:</strong> Safety control systems (PL)
                  </li>
                  <li>
                    <strong>BS EN ISO 14119:</strong> Guard interlocking
                  </li>
                  <li>
                    <strong>BS EN 60204-1:</strong> Electrical equipment of machines
                  </li>
                  <li>
                    <strong>IEC 62061:</strong> Functional safety (SIL)
                  </li>
                  <li>
                    <strong>IEC 60947-5-1:</strong> Control circuit devices
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>
                    <strong>Cat 0:</strong> Immediate power removal (uncontrolled)
                  </li>
                  <li>
                    <strong>Cat 1:</strong> Controlled stop, then power removal
                  </li>
                  <li>
                    <strong>Cat 2:</strong> Power maintained (NOT for E-stop)
                  </li>
                </ul>
              </div>
              ...
              <div>
                <h4 className="font-medium text-foreground mb-2 text-sm">
                  Performance Level Quick Guide
                </h4>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>
                    <strong>PL c:</strong> Low-risk interlocks
                  </li>
                  <li>
                    <strong>PL d:</strong> Most E-stop applications
                  </li>
                  <li>
                    <strong>PL e:</strong> Highest risk (potential fatal)
                  </li>
                  <li>
                    <strong>Cat 3/4:</strong> Dual-channel required for PL d/e
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="mt-4 pt-4 border-t border-elec-yellow/20">
              ...
              <p className="text-sm text-muted-foreground">
                <strong className="text-elec-yellow">
                  Positive-opening contacts (IEC 60947-5-1):
                </strong>{' '}
                Must be used for all safety-critical applications. Mechanical linkage ensures
                contacts MUST open even if welded. Look for the standardised marking symbol on
                devices.
              </p>
            </div>
          </div>
