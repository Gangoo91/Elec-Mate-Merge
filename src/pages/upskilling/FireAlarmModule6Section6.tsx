  ...
  return (
    <HubPage>
      ...
      <HubBody>
        ...
        >
          <p>The responsible person\'s relationship to the various BS 5839-1:2025 testing tiers:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Weekly user test.</strong> The duty is the responsible person\'s. Execution is
              typically delegated to a designated person on site (a member of premises management, a
              trained occupier). The responsible person\'s accountability is to ensure the test
              happens, the records are kept, and faults are followed up.
            </li>
            <li>
              <strong>Monthly auxiliary supply test.</strong> The duty sits with premises management
              as part of the wider building\'s standby supply regime. The responsible person ensures
              the regime exists.
            </li>
            <li>
              <strong>Six-monthly inspection and service.</strong> The responsible person contracts
              a competent person (a third-party-certificated organisation) to perform the work. The
              contract documents responsibilities including reporting, logbook updates, and
              emergency-response SLAs.
            </li>
            <li>
              <strong>Modifications and extensions.</strong> The responsible person commissions the
              work, signs the certificates, ensures the documentation pack is updated.
            </li>
            <li>
              <strong>Incident response.</strong> Real alarms initiate evacuation per the fire plan;
              the responsible person ensures the plan is current and staff are trained.
            </li>
          </ul>
          <p>
            The handover training is where the responsible person (or their named representative) is
            briefed on all of the above. It is the moment the system\'s technical complexity is
            translated into operational practice for the people who will live with the system day to
            day.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              facilities, equipment and devices provided in respect of the premises … are subject to
              a suitable system of maintenance and are maintained in an efficient state, in
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>System overview.</strong> Walk the responsible person through the system — CIE
              location, zone layout, detector locations, sounder / VAD locations, MCP locations, ARC
              connection (if applicable). The zone plan is the map.
            </li>
            <li>
            ...
            <li>
              ...
              evacuation per the fire plan, FRS interaction, reset only by a competent person after
              investigation. Brief on the cause-and-effect (what the system does in different alarm
              scenarios — partial evacuation, simultaneous evacuation, lift homing, AOV release).
            </li>
            <li>
            ...
            <li>
              <strong>Cyber-security basics.</strong> User-level guidance on physical access to the
              CIE / comms cabinet, recognising unauthorised remote-access requests, credentials
              discipline, untrusted-device avoidance.
            </li>
            <li>
              <strong>Servicing contract.</strong> Brief on the six-monthly service cycle, the next
              planned visit window, emergency contact details, emergency-response SLA.
            </li>
            <li>
              <strong>Q&A and acknowledgement.</strong> Open questions; the responsible person signs
              the logbook to acknowledge the training and the date.
            </li>
          </ol>
          <p>
            ...
            transforms the responsible person from a passive recipient of the system into an active
            operator with the knowledge and authority to manage it.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="440" y="44" textAnchor="middle" fill="#FBBF24" fontSize="13" fontWeight="bold">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              commissioning engineer and responsible person. Carries the system baseline, the agreed
              variations, the acceptance date.
            </li>
            <li>
            ...
            <li>
              <strong>Zone plan</strong> (per clause 22.2.5). Required unconditionally in multi-zone
              sleeping premises (clause 6 declares its absence unacceptable — Section 6.5).
            ...
            <li>
              <strong>Logbook (Annex H template).</strong> Pre-populated with system identification,
              ready for ongoing entries.
            </li>
            <li>
            ...
            <li>
              <strong>ARC details.</strong> Account number, panel ID, signal types transmitted, ARC
              contact details, escalation procedures.
            </li>
            <li>
              <strong>Cyber-security guidance</strong> (per clause 43.4). Manufacturer guidance on
              physical access, authentication, remote services. User-facing portion appropriate to a
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              only that it needs to be produced. The commissioning technician should inform the user
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Untrusted devices.</strong> Do not connect anything to the CIE / gateway that
              has not been provided by the servicing organisation. USB sticks, laptops, "test
              devices" from unverified parties — refuse and report.
            </li>
            <li>
              <strong>Credentials discipline.</strong> Do not share passwords. Do not write them on
              a sticky note next to the panel. If credentials need to be shared with a new staff
              member, use a documented onboarding procedure with the servicing organisation\'s
              knowledge.
            </li>
            <li>
              <strong>Physical access.</strong> Lock the comms cabinet. Restrict access to the panel
              area. Anyone working on the system should be from the contracted servicing
            ...
            <li>
              ...
              someone claiming to be from the manufacturer, asking for "emergency" remote access, is
              a classic attack. Decline; verify with the contracted servicing organisation; log the
              call. The same applies to emails offering "free firmware updates" or "urgent security
              patches" from unknown parties.
            </li>
            <li>
              <strong>Reporting suspected attacks.</strong> Any suspected unauthorised access,
              strange CIE behaviour, unexpected login attempts visible on the panel — report to the
              servicing organisation immediately. The earlier the report, the better the chance of
              containment.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>User change.</strong> The original designated user has left, retired, changed
              role. The replacement needs the same training the original received. Schedule a
              session with the servicing organisation; record in the logbook.
            </li>
            <li>
            ...
            <li>
              ...
              (residential to mixed, office to laboratory), occupancy has changed significantly, or
              the fire plan has been updated. Re-training aligns the user with the new operational
              reality.
            </li>
            <li>
              <strong>Planned cycle.</strong> Annual or biennial re-training as a matter of good
              practice. Even without a triggering event, periodic re-training keeps knowledge fresh.
            </li>
            <li>
          ...
          <p>
            ...
            scheduled intervals or in response to triggers. The responsible person should request it
            when triggered. Training records are updated in the logbook with date, content, trainer,
            trainee, and signed acknowledgement.
          </p>
        </ConceptBlock>
