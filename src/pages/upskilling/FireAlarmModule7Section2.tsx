...
const DESCRIPTION =
  'Learn about Approved Document B, Building Control notification requirements and competent persons schemes for fire alarm compliance.';
    ...
    () => [
      {
        id: 1,
        question:
          'Which Approved Document specifically covers fire safety requirements in buildings?',
        options: [
        ...
        correctAnswer: 1,
        explanation:
          'Approved Document B provides guidance on meeting Building Regulations requirements for fire safety, including means of escape and fire detection.',
      },
      {
        id: 2,
        question:
          'What is the minimum smoke alarm requirement for a new-build two-storey house under Building Regulations?',
        options: [
        ...
        correctAnswer: 1,
        explanation:
          'Building Regulations require at least one smoke alarm on each storey containing a habitable room, typically positioned in circulation spaces.',
      },
      {
        id: 3,
        ...
        correctAnswer: 2,
        explanation:
          'New-build houses typically require Grade D systems - mains-powered smoke alarms with integral standby supply (battery backup).',
      },
      {
        id: 4,
        ...
        correctAnswer: 2,
        explanation:
          'Fire alarm installation must be notified when part of building work that requires Building Regulations approval, such as new builds or material alterations.',
      },
      {
        id: 5,
        ...
        correctAnswer: 1,
        explanation:
          'Competent Person Schemes allow registered installers to self-certify that work complies with Building Regulations without separate Building Control notification.',
      },
      {
        id: 6,
        ...
        correctAnswer: 1,
        explanation:
          'Approved Document B Volume 1 covers fire safety requirements for dwelling houses, flats and maisonettes.',
      },
      {
        id: 7,
        question: 'In a new-build flat, where must a heat detector be located?',
        options: ['In the living room', 'In the bedroom', 'In the kitchen', 'In the bathroom'],
        correctAnswer: 2,
        explanation:
          'Heat detectors (rather than smoke detectors) should be located in kitchens to provide detection whilst avoiding false alarms from cooking.',
      },
      {
        id: 8,
        ...
        correctAnswer: 1,
        explanation:
          'A Completion Certificate confirms that building work has been inspected and complies with Building Regulations requirements.',
      },
      {
        id: 9,
        question:
          'Which organisation typically administers Competent Person Schemes for fire detection?',
        options: [
          'The Fire Service',
        ...
        correctAnswer: 2,
        explanation:
          'Competent Person Schemes are administered by certification bodies approved by the Department for Levelling Up, Housing and Communities (DLUHC).',
      },
      {
        id: 10,
        question:
          'What happens if fire alarm work is completed without required Building Regulations approval?',
        options: [
        ...
        correctAnswer: 1,
        explanation:
          'Failure to obtain Building Regulations approval can result in enforcement action, including requiring work to be opened up for inspection or even removed.',
      },
    ],
    []
  );
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
        ...
        <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <ul className="space-y-2 text-white text-sm">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong className="text-white">Approved Document B</strong> provides guidance on
                fire safety for Building Regulations compliance
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Building Control notification</strong> required for
                fire alarm work forming part of building work
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Competent Person Schemes</strong> allow
                self-certification without separate notification
              </span>
            </li>
          </ul>
        </div>
      ...
      <section className="px-4 sm:px-6 pb-6 max-w-3xl mx-auto space-y-6">
        ...
        <div className="p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <div className="space-y-3 text-sm text-white">
            <p>
              ...
              buildings. It is published by the government and regularly updated.
            </p>
            <div className="bg-white/5 rounded-lg p-3">
              <p className="text-sm font-semibold text-white mb-2">
                Approved Document B Structure:
              </p>
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  <strong className="text-white">Volume 1:</strong> Dwelling houses, flats and
                  maisonettes
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  <strong className="text-white">Volume 2:</strong> Buildings other than dwellings
                </li>
              </ul>
            </div>
            <p>
              The document covers five key areas: <strong className="text-elec-yellow">B1</strong>{' '}
              Means of warning and escape, <strong className="text-elec-yellow">B2</strong> Internal
              fire spread (linings), <strong className="text-elec-yellow">B3</strong> Internal fire
              spread (structure), <strong className="text-elec-yellow">B4</strong> External fire
              spread, and <strong className="text-elec-yellow">B5</strong> Access and facilities for
              the fire service.
            </p>
          </div>
        </div>
        ...
        <div className="p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <div className="space-y-3 text-sm text-white">
            <p>
              ...
              <strong className="text-elec-yellow">BS 5839-6</strong> for system grades and
              categories.
            </p>
            <div className="bg-white/5 rounded-lg p-3">
              <p className="text-sm font-semibold text-white mb-2">
                Minimum Requirements for Houses:
              </p>
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Smoke alarm on every storey with habitable room
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Heat alarm in principal habitable room (if no separate kitchen)
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Mains powered with integral standby supply (Grade D)
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Interlinked throughout the property
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-3 text-sm text-white">
            ...
            <div className="bg-white/5 rounded-lg p-3">
              ...
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Grade D1 or D2 system (Category LD2 or LD3)
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Smoke alarms in escape routes and principal habitable room
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
            ...
            <div className="bg-white/5 rounded-lg p-3 mt-3">
              ...
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Fire detection system may be required depending on building height and layout
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Typically BS 5839-1 Category L system in common areas
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Must be designed by competent fire engineer for complex buildings
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-3 text-sm text-white">
            ...
            <div className="bg-white/5 rounded-lg p-3">
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Change of use requiring upgraded fire protection
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
            ...
            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-3">
              <p className="text-sm text-red-300 flex items-start gap-2">
                ...
                Standalone fire alarm installations in existing buildings (not part of building
                work) do not require Building Control notification but must still comply with
                relevant standards.
              </p>
            </div>
          </div>
        ...
        <div className="p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <div className="space-y-3 text-sm text-white">
            <p>
              ...
              without requiring separate Building Control inspection.
            </p>
            <div className="bg-white/5 rounded-lg p-3">
              <p className="text-sm font-semibold text-white mb-2">
                Key Features of Competent Person Schemes:
              </p>
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Registered installers assessed for competence
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Self-certification of Building Regulations compliance
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Notification to local authority by scheme operator
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Certificate issued to building owner
                </li>
              </ul>
            </div>
            <div className="bg-white/5 rounded-lg p-3 mt-3">
              <p className="text-sm font-semibold text-white mb-2">
                Fire Detection Scheme Operators Include:
              </p>
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
        ...
        <div className="p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <div className="space-y-3 text-sm text-white">
            ...
            <div className="bg-white/5 rounded-lg p-3">
              <p className="text-sm font-semibold text-white mb-2">
                Route 1 - Building Control Application:
              </p>
              <ul className="space-y-1 text-sm">
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow mt-0.5" />
                  Building Control inspects work at key stages
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow mt-0.5" />
            ...
            <div className="bg-white/5 rounded-lg p-3 mt-3">
              <p className="text-sm font-semibold text-white mb-2">
                Route 2 - Competent Person Scheme:
              </p>
              <ul className="space-y-1 text-sm">
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow mt-0.5" />
                  Registered installer completes work
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow mt-0.5" />
                  Installer self-certifies compliance
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow mt-0.5" />
                  Scheme operator notifies local authority
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow mt-0.5" />
                  Certificate of compliance issued to owner
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="space-y-3">
          <div className="p-4 rounded-lg bg-white/5 border border-green-500/20">
            ...
            <ul className="space-y-2 text-sm text-white">
              <li className="flex items-start gap-2">
                ...
                especially for extensions and conversions
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                Keep up to date with Competent Person Scheme registration - lapsed registration
                means you cannot self-certify
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                Provide clear documentation to the customer including system design, test
                certificates and operating instructions
              </li>
            </ul>
          </div>
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-red-500/20">
            ...
            <ul className="space-y-2 text-sm text-white">
              ...
              <li className="flex items-start gap-2">
                <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                Failing to notify Building Control when required - this can cause problems for
                property sales
              </li>
              <li className="flex items-start gap-2">
                <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                Installing smoke alarms in kitchens - use heat alarms to avoid nuisance alarms from
                cooking
              </li>
            </ul>
          </div>
      ...
      <section className="px-4 sm:px-6 pb-6 max-w-3xl mx-auto">
        ...
        <div className="space-y-3">
          {[
            {
              q: 'Is Approved Document B legally binding?',
              a: 'The Approved Document provides guidance - it is not mandatory. However, following it is the easiest way to demonstrate compliance. Alternative approaches are acceptable if they meet the functional requirements.',
            },
            {
              q: 'Can existing buildings be required to upgrade fire detection?',
              a: 'Building Regulations generally apply only to new work. However, the RR(FS)O may require improvements to fire safety measures in existing buildings based on the fire risk assessment.',
            },
            {
              q: 'What is the difference between a Building Notice and Full Plans?',
              a: 'A Building Notice is a simpler process for smaller works - no plans approval needed. Full Plans involves submitting detailed drawings for approval before work starts - required for larger or complex projects.',
            },
            {
              q: 'Do I need to be on a Competent Person Scheme to install fire alarms?',
              a: 'No - anyone can install fire alarms. But only registered scheme members can self-certify Building Regulations compliance. Others must use Building Control.',
            },
            {
              q: 'How long must Building Regulations records be kept?',
              a: 'Local authorities must keep Building Control records for at least 15 years. You should keep your own records indefinitely as they may be needed for property transactions.',
            },
            {
              q: 'What happens if work does not comply with Building Regulations?',
              a: 'The local authority can require work to be altered or removed. In serious cases, prosecution is possible. Non-compliance can also affect property sales and insurance.',
            },
          ].map((faq, i) => (
