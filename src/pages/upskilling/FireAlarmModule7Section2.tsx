...
const FireAlarmModule7Section2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 7 · Section 2" title="Building Regulations" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Building Regulations Schedule 1 functional requirements B1-B5 are the construction-stage
          law for fire safety. Approved Document B is the prescriptive route to compliance. ADB
          Volume 1 (dwellings) and Volume 2 (other) reference BS 5839-1 / -6 for fire detection and
          alarm. Approved Documents M (accessibility) and Q (security) interact. The Building Safety
          Act 2022 created a parallel HRB Gateway regime overseen by the BSR.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Building Act 1984.</strong> Parent statute. Empowers the Secretary of State to
              make the Building Regulations.
            </li>
            <li>
              <strong>Building Regulations 2010.</strong> Statutory instrument. Schedule 1 contains
              the functional requirements (Parts A-R).
            </li>
            <li>
              <strong>Approved Document B (Fire Safety).</strong> Statutory guidance issued by the
              Secretary of State. Two volumes (Vol 1 dwellings, Vol 2 other). The prescriptive route
              to satisfying B1-B5. Following ADB is presumed compliant — but a designer is free to
              follow an alternative where they can demonstrate equivalence.
            </li>
            <li>
              <strong>BS 5839-1 (non-domestic), BS 5839-6 (domestic).</strong> Codes of practice
              referenced by ADB. Treated as the de facto specification for fire detection and alarm.
              Variations from BS 5839 are not unlawful in themselves but require justification; the
              FRA, AHJ and insurer expect compliance.
            </li>
            <li>
              <strong>BS 9999 (non-residential), BS 9991 (residential).</strong> Alternative codes
              of practice that take an engineered approach to fire strategy. ADB references both as
              recognised alternatives. More flexible than ADB but require more design justification.
            </li>
            <li>
          ...
          <p>
            The contractor working on a normal scheme will encounter ADB plus BS 5839-1 / -6. Larger
            or more complex schemes may use BS 9999 or BS 9991. Bespoke buildings may use BS 7974.
            The contractor must be able to read across — the language of ADB and the language of BS
            5839-1 are not identical, and the fire strategy document is the translation between
            them.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              lighting, signage. ADB references BS 5839-1 / -6 for fire alarm; BS 5266 for emergency
              lighting; BS 5499 for safety signs.
            </li>
            <li>
              <strong>B2 Internal fire spread (linings).</strong> Walls, ceilings, exposed surfaces
              must not contribute to early flame-spread. Class A1, A2, B, C, D rating per BS EN
              13501-1 (fire reaction). ADB sets minimum class by use and area.
            </li>
            <li>
            ...
            <li>
              <strong>B5 Access and facilities for the fire service.</strong> Vehicle access to the
              building. Firefighting shafts. Fire mains. Smoke ventilation. Firefighters' lifts in
              tall buildings. The fire alarm cause-and-effect typically integrates with B5 systems
              (smoke vent, wet riser pump start, lift call-down).
            </li>
          </ul>
          <p>
            ...
            typically interacts with B5 systems. A correctly programmed cause-and-effect is part of
            the technical route to B5 compliance.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              A fire detection and fire alarm system in accordance with BS 5839-1 should be provided
              in all buildings other than dwellinghouses except in those buildings where a manual
              system in accordance with category M of BS 5839-1 is sufficient. The category of
              system installed should be in accordance with the recommendations of BS 5839-1.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              ...
              <text x="150" y="194" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
                prescriptive route
              </text>
            </g>
            ...
            <g>
              ...
              <text x="440" y="194" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
            ...
            <g>
              ...
              <text x="730" y="194" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              accommodation in hotels and care, isolated work areas, areas with high ambient noise).
            </li>
            <li>
              <strong>Standard.</strong> BS EN 54-23 — fire detection and fire alarm systems — fire
              alarm devices — visual alarm devices.
            </li>
            <li>
              <strong>Coverage rating.</strong> VAD category C (ceiling-mounted), W (wall-mounted),
              or O (open class). Numerical rating gives the cubic-volume coverage. e.g. C-3-15
              covers a cylinder of 3 m radius × 15 candela; W-2.4-15 covers a square 2.4 m × 2.4 m
              wall area at 15 cd.
            </li>
            <li>
          ...
          <p>
            ...
            defect that surfaces only when an FRA reviewer or AHJ asks for the coverage calculation.
            Refuge two-way comms is a separate system class but typically integrates with the fire
            alarm at a system level (panel indication of refuge call).
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Maglock release on fire alarm.</strong> BS 7273-4 specifies the categories of
              actuation: A (fail-unlocked on fire signal, automatic re-lock not allowed without
              manual reset), B (fail-unlocked on fire signal, automatic re-lock allowed after fault
              recovery), C (fail-unlocked on fire OR power failure). Category A is used where life
              safety is paramount; Category C where power resilience is the concern.
            </li>
            <li>
              <strong>Final exit doors.</strong> Must release on fire alarm regardless of access
              control state. Manual override (green break-glass call point releasing the lock) is a
              common ADQ-compatible solution.
            </li>
            <li>
          ...
          <p>
            ...
            the cause-and-effect (or equivalent text description) mandatory at handover. This is the
            legal teeth.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              facilities to assist firefighters in the protection of life. (2) Reasonable provision
              shall be made within the site of the building to enable fire appliances to gain access
              to the building.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              the BSR (post-BSA the registration regime tightened). Available across England; often
              faster and more proactive. Charges by project.
            </li>
            <li>
              <strong>Competent Person Schemes (CPS).</strong> Government-authorised schemes whose
              registered installers can self-certify. Removes the need for separate building control
              inspection of the work covered by the CPS. Examples: Part P (electrical) — NICEIC,
              NAPIT, ELECSA; fire detection / alarm — BAFE SP203-1; emergency lighting — BAFE
              SP203-4; gas — Gas Safe.
            </li>
            <li>
              <strong>BSR (HRB only).</strong> Building Safety Regulator. Replaces LABC / AI for HRB
              work. Substantial Gateway 2 / Gateway 3 process. Detailed in next subsection.
            </li>
          </ul>
          <p>
            ...
            competence is a recurring theme, scheme registration is increasingly the minimum market
            expectation. Insurance, public sector contracts, and AHJ acceptance frequently require
            it.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Gateway 3 (completion).</strong> Before occupation can start, the BSR inspects
              and reviews the as-built information. Fire alarm cause-and-effect, fire strategy
              compliance, golden thread completeness, building safety case, occupier resident
              strategy. Approval triggers the issue of a building completion certificate; building
              cannot be occupied without it.
            </li>
            <li>
              <strong>In-occupation.</strong> The HRB must be registered with the BSR before
              occupation begins. The Principal Accountable Person submits a building safety case and
              keeps it current. Mandatory occurrence reporting bites continuously.
            </li>
          </ul>
          <p>
            ...
            will scrutinise. Variations from BS 5839-1 must be justified in writing. The quality of
            documentation is no longer a contractor's internal matter — it is part of the legal
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              awake and familiar; B awake and unfamiliar; C asleep. 1-3 captures fire growth rate: 1
              slow; 2 medium; 3 fast. Combinations (A1, A2, A3, B1, B2, B3, C1, C2, C3) drive the
              level of fire precaution required.
            </li>
            <li>
            ...
            <li>
              <strong>Management of fire safety.</strong> BS 9999 explicitly addresses ongoing fire
              safety management as part of the design — recognising that the as-designed safety case
              requires active management to be sustained.
            </li>
          </ul>
          <p>BS 9991 — key features:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Single source for residential fire safety.</strong> Covers fire alarm systems,
              escape route design, compartmentation, structural fire resistance, external wall
              systems — all in one document.
            </li>
            <li>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-7/section-3')}
