...
const inlineChecks = [
  ...
  {
    id: 'm3s1-tilt',
    question: 'For UK latitudes, what is the optimal PV array tilt for annual yield?',
    options: [
...
const faqs = [
  {
    question: 'What is "Peak Sun Hours" (PSH) and how does it relate to PV yield?',
    answer:
  ...
  {
    question: 'How accurate is PVGIS modelling vs measured yield?',
    answer:
  ...
  {
    question: 'Does the UK PV resource degrade significantly with cloud cover?',
    answer:
  ...
  {
    question: 'How does seasonal yield vary across the UK?',
    answer:
  ...
  {
    question: "What's the optimal tilt for an off-grid / wintertime-priority install?",
    answer:
  ...
  {
    question: 'How significant is the temperature derate at typical UK summer roof conditions?',
    answer:
  ...
  {
    question: "What's the practical workflow for capturing shading at survey stage?",
    answer:
...
export default function RenewableEnergyModule3Section1() {
  ...
  useSEO({
    title: 'Irradiance, orientation, tilt & shading | Renewable Energy 3.1 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 1 · BS 7671:2018+A4:2026"
        title="Irradiance, orientation, tilt & shading"
        backTo="../renewable-energy-module-3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The PV design foundations — UK solar resource, azimuth and tilt effects, shading topology
          analysis, PVGIS modelling, performance ratio derating, and the BS 7671 Reg 712.512.2.1
          site-radiation responsibility.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">South-east England</strong> (Kent, Sussex, London) —
              1,050–1,100 kWh/kWp/year. The UK\'s highest solar resource region.
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">Northern England</strong> — 900–950 kWh/kWp/year.
            </li>
            <li>
              <strong className="text-white">Scotland</strong> — 850–950 kWh/kWp/year. Higher
              latitude (lower solar elevation) and higher annual cloud cover. Still commercially
              viable.
            </li>
          </ul>
          <p>
            These figures assume a well-designed south-facing 30–40° tilt install with minimal
            shading and a performance ratio around 0.80. The PVGIS model handles each location
            precisely from satellite-derived long-term irradiance data; the customer\'s modelled
            yield is set by the modelling, not by a national average.
          </p>
        </ConceptBlock>

        <UkYieldHeatmap caption="UK PV yield heat map — colour-coded annual yield in kWh/kWp/year across England, Scotland, Wales and Northern Ireland. Highest values in south-east England (1,050–1,100); lowest in northern Scotland (850–900). Annotated with the PVGIS source data and the typical performance ratio assumption." />
        ...
        <Pullquote>
          South for peak yield. East-west for daily-profile match. North rarely viable.
        </Pullquote>
        ...
        >
          ...
          <p>
            East-west split arrays (modules across both sides of a typical UK roof ridge) are common
            — each side individually produces ~80–85% of south-facing, but the combined array
            delivers ~85–90% of equivalent south-only capacity with a flatter daily profile. The
            flatter profile (morning east peak + afternoon west peak vs single midday south peak)
            often matches household consumption better — improving self-consumption ratio.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">0° (flat)</strong> — 90–93% of optimum. Common on flat
              roofs with ballasted frames; can rotate modules to face south on the frame
            </li>
            <li>
              <strong className="text-white">15–25° (low pitch)</strong> — 95–98% of optimum.
              Favours summer slightly; loses some winter
            </li>
            <li>
              <strong className="text-white">30–40° (standard UK roof pitch)</strong> — 99–100% of
              optimum
            </li>
            <li>
              <strong className="text-white">45–55° (steep)</strong> — 97–99% of optimum. Favours
              winter slightly; loses some summer
            </li>
            <li>
              <strong className="text-white">60–70° (very steep, off-grid winter- priority)</strong>{' '}
              — 85–90% of annual optimum, but better winter performance for off-grid systems where
              battery autonomy matters
            </li>
            <li>
              <strong className="text-white">90° (vertical)</strong> — 65–75% of optimum. Used for
              BIPV façades and similar architectural-led installs
            </li>
          </ul>
        </ConceptBlock>

        <AzimuthTiltPolar caption="Azimuth and tilt yield polar diagram — circular plot showing annual yield as a percentage of optimum across all azimuth and tilt combinations. South-facing 30–40° at the centre at 100%. East / west at ~80–85%. North-facing at ~45–55%. Practical UK roof pitch range (30–45°) highlighted as the &lsquo;sweet spot&rsquo; band." />
        ...
        <Pullquote>
          Shading is the silent yield-killer. Survey it properly or lose 10–30%.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Trees</strong> — seasonal variation (deciduous vs
              evergreen), morning vs afternoon shade direction, growth over the install\'s 25-year
              life
            </li>
            <li>
              <strong className="text-white">Chimneys</strong> — small footprint but cast long
              shadows in early morning and late afternoon, particularly in winter
            </li>
            <li>
              <strong className="text-white">Neighbouring buildings</strong> — fixed in position;
              predictable shadow pattern; particularly relevant for installs in urban / suburban
              density
            </li>
            <li>
              <strong className="text-white">Self-shading</strong> — the roof itself (dormers,
              gables) or array-on-array shading (front rows shading back rows on flat-roof tilted
              installs)
            </li>
            <li>
              <strong className="text-white">Distant horizon</strong> — hills, larger buildings in
              the distance — relevant at low solar elevation (winter mornings / late afternoons)
            </li>
          </ul>
          <p>The disproportionate impact of partial shading:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              A single shaded cell can trigger bypass-diode bypass of the entire 20-cell sub-string
              (Section 2.2) — losing 1/3 of the module\'s output rather than the shaded fraction
            </li>
            <li>
              Series-string mismatch from shaded modules drags the unshaded modules to the lower
              current — losing more than the shaded area alone (Section 2.3)
            </li>
            <li>
              A 2-module shade on a 12-module string can cost 30–40% during the shade window —
              10–15% annualised
            </li>
            <li>
              Module-level optimisation (microinverters or power optimisers — Section 2.5) recovers
              most of the loss by operating each module at its own MPP
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Stand at the array location</strong> — ideally at the
              lower edge of the proposed array (the most-shaded point)
            </li>
            <li>
              <strong className="text-white">Capture the sky horizon</strong> — point the tool at
              the full sky hemisphere and identify the horizon line including all obstructions
              (trees, buildings, chimneys)
            </li>
            <li>
              <strong className="text-white">Overlay the annual sun path</strong> — the tool
              calculates the sun\'s position across all hours of all days at the site latitude
            </li>
            <li>
              <strong className="text-white">Compute the shading factor</strong> — the ratio of
              unshaded annual irradiance to clear-sky annual irradiance. Typical values: 0.95–1.00
              for unshaded; 0.85–0.95 for light shading; 0.70–0.85 for moderate; below 0.70 for
              heavy shading (module-level optimisation mandatory)
            </li>
            <li>
              <strong className="text-white">Feed into PVGIS</strong> — the system losses input on
              PVGIS accepts a shading-factor-equivalent &ldquo;system losses&rdquo; percentage
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Temperature derate</strong> — typically 5–10% annual
              average loss. Largest single PR component. The 70–100 mm standoff discipline (Section
              2.6) is the standard mitigation
            </li>
            <li>
              <strong className="text-white">Soiling</strong> — typically 1–3% annual average. Dust,
              pollen, bird droppings, leaves. Cleaning frequency 1–2 times per year on typical UK
              domestic installs
            </li>
            <li>
              <strong className="text-white">Mismatch losses</strong> — typically 1–3% on a
              well-designed install. Higher on multi-orientation or mixed-module arrays without
              multi-MPPT or module-level optimisation
            </li>
            <li>
              <strong className="text-white">Inverter conversion losses</strong> — typically 3–5%.
              Modern inverters achieve 96–98% Euro efficiency
            </li>
            <li>
              <strong className="text-white">DC cable losses</strong> — typically 1–2% on a
              well-sized install
            </li>
            <li>
              <strong className="text-white">AC cable losses</strong> — typically 1–2% from inverter
              to consumer unit
            </li>
            <li>
              <strong className="text-white">Inverter standby and downtime</strong> — typically 1–2%
              from inverter not operating at low irradiance or scheduled maintenance
            </li>
          </ul>
          <p>
            The sum of these losses gives the overall PR. A typical UK install: 100% × (1 − 0.075 −
            0.02 − 0.02 − 0.04 − 0.015 − 0.015 − 0.015) ≈ 0.80. Real-world measured PR depends on
            the specific install, the local conditions, and the maintenance regime.
          </p>
        </ConceptBlock>

        <PrWaterfall caption="Performance ratio waterfall diagram — starting from 100% STC nameplate, subtracting each loss component (temperature, soiling, mismatch, inverter, DC cable, AC cable, downtime) to arrive at the realistic PR of ~0.80 for a well-designed UK install. Each loss component labelled with the typical percentage." />
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Site irradiance assessment</strong> — record the
              assessed maximum solar radiation for the site. For most UK domestic sites, ~1,000 W/m²
              (STC reference). For high-altitude / low- latitude / reflective-surroundings sites,
              may be higher
            </li>
            <li>
              <strong className="text-white">Module thermal spec</strong> — read the manufacturer\'s
              spec for module operating temperature at the site\'s maximum solar radiation. Modules
              typically rated for cell temperatures up to ~85°C
            </li>
            <li>
              <strong className="text-white">Mounting arrangement</strong> — verify the install
              meets the manufacturer\'s mounting spec at the site\'s maximum solar radiation. 70–100
              mm standoff above the roof for natural convection cooling is the standard discipline
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — record the site\'s max
              solar radiation assumption, the manufacturer\'s mounting spec, the as-installed
              mounting arrangement, and the resulting expected cell temperature range
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Step 1 — Location</strong>: enter the postcode or GPS
              coordinates. PVGIS pulls the long-term satellite-derived irradiance data for that
              location
            </li>
            <li>
              <strong className="text-white">Step 2 — System configuration</strong>: enter the array
              kWp, azimuth (0–360°), tilt (0–90°), and tracking type (typically &ldquo;fixed&rdquo;
              for residential)
            </li>
            <li>
              <strong className="text-white">Step 3 — System losses</strong>: enter the expected
              system losses as a percentage (typically 14–20% for a well-designed UK install,
              captures the inverse of the performance ratio)
            </li>
            <li>
              <strong className="text-white">Step 4 — Output</strong>: PVGIS returns the modelled
              annual yield in kWh, the monthly breakdown, the daily profile by month, and the
              optional financial calculations (LCoE, payback)
            </li>
            <li>
              <strong className="text-white">Step 5 — Save the report</strong>: PVGIS provides a CSV
              / PDF export. The cert evidence bundle includes the report as the modelling evidence
            </li>
          </ul>
          <p>
            Alternative commercial tools (PVsyst, HelioScope) offer more advanced features for
            larger commercial installs — detailed shading topology, per-string modelling, financial
            analysis with battery storage. For typical residential MCS-funded installs, PVGIS is
            sufficient and the standard reference.
          </p>
        </ConceptBlock>
