...
const DataCablingModule2Section1 = () => {
  useSEO({
    title: "Twisted Pair Basics and Categories | Data Cabling Module 2.1",
    description: "Learn twisted pair cable construction, categories from Cat5e to Cat6A, and performance specifications for structured cabling systems."
  });
