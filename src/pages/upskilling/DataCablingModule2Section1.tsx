    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          How balanced twisted pair actually works — differential signalling, common-mode rejection
          and the twist itself — and the Class / Category landscape from Cat5e (Class D, 100 MHz)
          through to Cat8.2 (Class II, 2000 MHz), aligned with the BS 7671:2018+A4:2026 §716.521.101
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Differential drive.</strong> The transmitter chip pushes +V on one wire and -V
              on the other, simultaneously. The signal of interest is the difference between the two
              — never the absolute voltage on either wire.
            </li>
            <li>
              ...
              contactor, fluorescent ballast harmonics) appears on both sides of the subtraction and
              cancels.
            </li>
            <li>
              <strong>The twist.</strong> The two conductors of the pair are physically wound around
              each other so they share the same magnetic-field environment along the whole run.
              Without the twist, one conductor might run closer to a noise source than the other and
              they would pick up different amounts of noise — common-mode rejection would fail. The
              twist guarantees the common-mode assumption.
            </li>
          </ul>
          <p>
            Common-mode rejection is rated by the receiver chip in dB. Modern Ethernet PHYs achieve
            60-80 dB CMRR (common-mode rejection ratio) at audio frequencies, degrading at higher
            frequencies. The cable&apos;s contribution is to keep the balance high — every
        ...
        <RegsCallout
          ...
          clause={
            <>
              Balanced twisted-pair cabling relies on the matched electrical characteristics of the
              two conductors of each pair, the differential signalling of the connected equipment,
              and the geometric twist of the pair to deliver the specified channel performance.
              Conductor-to-conductor capacitive and inductive imbalance, untwisted-pair length at
              terminations, and asymmetry of insulation displacement contacts all degrade the
              channel&apos;s common-mode rejection and increase return loss.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>NEXT (near-end crosstalk).</strong> Coupling from one pair into another at the
              SAME end as the transmitter. Worst-case coupling because the disturbing signal is at
              full strength near the source. The headline crosstalk figure in every Class / Category
              specification.
            </li>
            <li>
              <strong>FEXT (far-end crosstalk).</strong> Coupling from one pair into another at the
              OPPOSITE end from the transmitter. Weaker than NEXT because the disturbing signal has
              attenuated along the run, but still relevant at high speeds. Specified as ACR-F
              (attenuation-to-crosstalk ratio, far-end) in modern standards.
            </li>
            <li>
          ...
          <p>
            Combined with the BALANCE story, this gives the full design picture: the twist gives the
            pair its common-mode rejection (immunity to outside-the-cable noise); different twist
            rates between pairs give the cable its inter-pair NEXT performance (immunity to
            inside-the-cable crosstalk); and at higher Categories, conductor separators and overall
            constructions add alien-crosstalk control between cables.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            ...
            <li>
              <strong>Cat5e (1999, 100 MHz, Class D).</strong> The "enhanced" Cat5. Tightened NEXT,
              PSNEXT, return loss and delay skew specs. Reliably supports 1000BASE-T (1 Gbps) at 100
              m. Legacy minimum for new installs.
            </li>
            <li>
            ...
            <li>
              ...
              10GBASE-T at the full 100 m channel. Adds alien-crosstalk specification. Construction
              usually includes a pair separator (X-spline / cross-web). ON the §716.521.101 list.
            </li>
            <li>
            ...
            <li>
              ...
              Cat8.1, but uses non-RJ45 connectors (TERA / GG45) for higher performance margins. ON
              the §716.521.101 list.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text
              ...
              fontFamily="system-ui"
            >
              All Categories above are on the BS 7671:2018+A4:2026 §716.521.101 PoE-permitted list.
            </text>
            <text
              x="490"
              y="678"
              ...
              fontFamily="system-ui"
            >
              Cat3 and Cat4 are NOT permitted. §716.521.101 lists Cat5; practical legacy minimum is
              Cat5e.
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Specification.</strong> Choose a Class for the building life and the services
              foreseen. Choose Category components that can deliver that Class (typically Cat6A →
              Class EA in 2026 commercial).
            </li>
            <li>
              <strong>Components.</strong> Cable, connectors, patch panels, patch leads — every
              physical part on the channel — must be of the chosen Category or higher. Mixing Cat6A
              cable with Cat5e jacks gives you a Class D channel, not Class EA.
            </li>
            <li>
            ...
            <li>
              <strong>Test &amp; certify.</strong> Every link tested with a TIA-1152-A Level III or
              higher field tester (or BS EN 50346 equivalent). Permanent-link or channel report
              generated, signed, retained for the warranty period.
            </li>
            <li>
              <strong>Documentation.</strong> Every link labelled (BS EN 50174-1 / TIA-606-D), test
              report linked to label, as-built drawings updated. Class is now traceable per port for
              the building life.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            ...
            <li>
              ...
              ceiling. Per CONDUCTOR — not per pair, not per cable. With 4-pair PoE Type 4 (90 W PSE
              / 71.3 W PD), the worst-case per-conductor current stays well below 750 mA when the
              cable is rated and bundles are managed; this clause is what bounds bundle de-rating
              and LP-rated cable selection.
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              contract. Two years later the building wants 10G to the desk and the channel will not
              link reliably. The client claims the cable was misrepresented; the contractor points
              at the jacket print and says they delivered what was specified. There is no test
          ...
          doInstead={
            <>
              ...
              BS EN 50346 at handover, with a digital test report retained for the warranty period.
              Specify install practices that protect the Class: bend radii (≥ 4× cable OD at
              install, ≥ 8× under stress per BS EN 50174-2), bundle size limits (TIA TSB-184-A under
              loaded PoE), separation from LV power (BS 7671 §444 + §528 + Annex A444),
              torque-controlled terminations. The deliverable is a CHANNEL — Cat6A is just the parts
              list.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A 220-outlet office fit-out. The QS is comparing Cat6 against Cat6A on a cost line and
              asking the design team to justify the Cat6A premium. The architect has already
              specified PoE++ for desk-level lighting and ceiling APs, with a 15-year building life
              expected.
            </>
          }
          whatToDo={
            <>
              Frame the answer around three numbers, not one. (1) Bandwidth headroom: 250 MHz vs 500
              MHz. Cat6 supports 10GBASE-T only on a 55 m de-rated channel with strict
              alien-crosstalk control; Cat6A delivers it at the full 100 m. (2) PoE thermal
              headroom: under continuous Type 4 (90 W PSE) loading in tight bundles, Cat6A&apos;s 23
              AWG construction (vs Cat6&apos;s 23/24 AWG mix) carries the current with less
              temperature rise, leaving more margin against the §716.523.2.101 750 mA hard cap. (3)
              Lifecycle cost: the small per-metre saving across 220 outlets is a few thousand pounds
              once; a selective re-pull to Cat6A in year 5 to support 10G to the desk is tens of
              thousands. The Cat6A premium pays back inside 12-18 months once any 10G service
              request lands.
            </>
          }
          whyItMatters={
            <>
              ...
              parts price alone. With BS 7671:2018+A4:2026 §716 in force from 15 April 2026, the PoE
              regulatory envelope (Category list + 750 mA cap) makes the
