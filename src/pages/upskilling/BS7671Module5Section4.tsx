...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Isolation provides complete disconnection from live supply to ensure safety during maintenance work, preventing accidental energisation and protecting personnel from electric shock.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Emergency switching provides immediate power disconnection in dangerous situations such as fire, electric shock, or other emergencies to prevent injury or damage.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Clear labelling ensures correct identification of isolation points, prevents operation of wrong devices, and enables quick location during emergencies or maintenance work.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Yes, when suitable. MCBs can provide isolation function if they have a clear OFF indication, lockable operating mechanism, and are appropriate for the system voltage. Always verify the MCB is marked as suitable for isolation.',
  },
  {
    question: 'What colour should emergency stop buttons be?',
    answer:
      'Emergency stop buttons must be red with a mushroom-head design. They should be located in prominent, easily accessible positions and operate in a fail-safe manner using normally closed contacts.',
  },
  {
    question: 'How often should emergency controls be tested?',
    answer:
      'Emergency switching devices should be tested regularly - typically monthly for high-risk environments and at least annually for general installations. Testing ensures reliability when needed most.',
  },
  {
    question: 'What is Lock Out Tag Out (LOTO)?',
    answer:
      'LOTO is a safety procedure ensuring equipment is properly isolated before maintenance. It involves locking the isolation device in the OFF position and attaching a tag identifying who locked it and why.',
  },
];
...
const quizQuestion = {
  ...
  correctAnswer: 2,
  explanation:
    'Emergency switching enables immediate disconnection in dangerous situations such as fire, electric shock, or equipment malfunction to prevent injury or damage.',
};
...
const BS7671Module5Section4 = () => {
  useSEO({
    ...
    description:
      'Learn about isolation, switching off for mechanical maintenance, and emergency switching requirements per BS7671. Essential safety controls for electrical installations.',
  });
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Isolation:</strong> Complete disconnection for safe maintenance
              </li>
              <li>
                <strong>Mechanical maintenance:</strong> Controlled disconnect with LOTO
              </li>
              <li>
                <strong>Emergency:</strong> Immediate disconnection in danger
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Isolators:</strong> Lockable, visible break indication
              </li>
              <li>
                <strong>Emergency stops:</strong> Red, accessible, latching OFF
              </li>
              <li>
                <strong>Labelling:</strong> Clear identification, durable
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BS7671 defines three distinct switching functions, each with specific requirements and
              applications. Understanding the differences is essential for safe electrical
              installation design.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Different switching devices suit specific functions based on their operating
              characteristics, current ratings, and ability to safely make and break electrical
              circuits.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Isolator switches:</strong> OFF-load operation, visible break
                  </li>
                  <li>
                    <strong>MCB/MCCB:</strong> Can provide isolation when suitable
                  </li>
                  <li>
                    <strong>Fuse switches:</strong> Combined protection and isolation
                  </li>
                  <li>
                    <strong>Plug/socket:</strong> Isolation for portable equipment
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Emergency stops:</strong> Red mushroom-head buttons
                  </li>
                  <li>
                    <strong>Fire-man's switches:</strong> External isolation for signs
                  </li>
                  <li>
                    <strong>Trip switches:</strong> Rapid disconnection
                  </li>
                  <li>
                    <strong>Safety relays:</strong> System integration
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Proper labelling and accessibility ensure switching devices can be located and
              operated quickly and safely, especially during emergencies.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Identification:</strong> Clear circuit or equipment ID
                  </li>
                  <li>
                    <strong>Durable:</strong> Resistant to environment
                  </li>
                  <li>
                    <strong>Legible:</strong> Appropriate text size and contrast
                  </li>
                  <li>
                    <strong>Function:</strong> "ISOLATOR", "EMERGENCY STOP"
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Location:</strong> Easily accessible to authorised personnel
                  </li>
                  <li>
                    <strong>Unobstructed:</strong> Clear access and operation
                  </li>
                  <li>
                    <strong>Lighting:</strong> Adequate illumination for ID
                  </li>
                  <li>
                    <strong>Emergency:</strong> Immediate access without tools
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Switching devices must be strategically located at entrance points, near machinery,
              and in distribution boards to ensure effective control and safety.
            </p>
            ...
            <div className="p-4 rounded-lg bg-transparent border border-white/10">
              ...
              <ul className="text-sm text-white/90 space-y-1">
                ...
                <li>
                  <strong>Distribution boards:</strong> Centre at 1.4m - 1.8m
                </li>
                <li>
                  <strong>Emergency stops:</strong> 0.8m - 1.7m (accessible range)
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="p-5 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-xs text-white/80">
              <div>
                ...
                <p>
                  High fire risk from cooking equipment, hot oil, and gas supplies requiring
                  immediate power disconnection capability.
                </p>
              </div>
              <div>
                <p className="font-medium text-white mb-1">Solution</p>
                <p>
                  Red mushroom-head emergency stops at three locations connected to safety relay
                  system with clear labelling and staff training.
                </p>
              </div>
            </div>
          </div>
