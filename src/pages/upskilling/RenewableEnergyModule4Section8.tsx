...
const inlineChecks = [
  ...
  {
    id: 'm4s8-pas-63100',
    question: 'PAS 63100:2024 — what is it and how does it relate to hybrid PV+BESS commissioning?',
    options: [
  ...
  },
  {
    ...
    question: "Hybrid PV+BESS commissioning — what's the test sequence?",
    options: [
  ...
  },
  {
    ...
    question: "Off-grid PV+BESS commissioning — what's different from grid-tied hybrid?",
    options: [
  ...
  },
  {
    ...
    question: 'Hybrid PV+BESS cert evidence bundle — what documents at customer handover?',
    options: [
  ...
  },
  {
    ...
    question: "Five-yearly EICR-style inspection of a hybrid PV+BESS install — what's the scope?",
    options: [
  ...
  },
  {
    ...
    question: 'Customer handover for a hybrid PV+BESS install — what does the customer receive?',
    options: [
...
const quizQuestions = [
  ...
  {
    id: 4,
    question: 'BS EN 62446-2 — when does it apply to a hybrid PV+BESS install?',
    options: [
...
export default function RenewableEnergyModule4Section8() {
  ...
  useSEO({
    title: 'Commissioning hybrid & off-grid | Renewable Energy 4.8 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 4 · Section 8 · BS 7671:2018+A4:2026"
        title="Commissioning hybrid & off-grid"
        backTo="../renewable-energy-module-4"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Integrated commissioning workflow — BS EN 62446-1 PV + BS EN IEC 62485 BESS + PAS
          63100:2024 UK spec + Chapter 82 PEI verification + EPS testing + EREC G100 verification +
          cert evidence bundle assembly + 5-yearly EICR-style inspection.
        </p>
        ...
        <Pullquote>
          Hybrid commissioning integrates BS EN 62446-1 + BS EN IEC 62485 + PAS 63100 + Chapter 82 +
          EREC + EPS + G100. Off-grid removes the grid-related half.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">1. Visual inspection</strong> — confirm everything
              matches design pack: PV array layout, BESS placement (ventilation, fire safety per PAS
              63100:2024), hybrid inverter location, cabling routes, labels per Reg 712.514 + Reg
              826.1.1.4 + BESS analogues
            </li>
            <li>
              <strong className="text-white">2. Electrical tests</strong> — BS EN 62446-1 PV tests
              (continuity, IR, polarity); BESS DC isolator + bonding per Chapter 57; main supply
              continuity
            </li>
            <li>
              <strong className="text-white">3. PV-specific commissioning</strong> — V_oc + I_sc per
              string at test conditions; correct to STC; compare to design (±5-10% tolerance);
              record in SoTR per BS EN 62446-1
            </li>
            <li>
              <strong className="text-white">4. BESS-specific commissioning</strong> — BMS-inverter
              handshake; first charge cycle observation; capacity baseline test (manufacturer spec);
              record per BS EN IEC 62485 + PAS 63100:2024
            </li>
            <li>
              <strong className="text-white">5. Hybrid inverter functional</strong> — connect to
              grid; verify direct feeding mode; PV → grid export (if SEG / EREC active); grid → BESS
              charging; BESS → load discharging
            </li>
            <li>
              <strong className="text-white">6. EPS testing (Module 4.6)</strong> — simulate grid
              loss (open DNO main isolator); verify EPS contactor opens within manufacturer spec;
              verify inverter transitions to grid-forming; verify protected-load partition; verify
              RCD operation under island mode (Reg 411 disconnection time)
            </li>
            <li>
              <strong className="text-white">
                7. G100 verification (Module 4.7, if applicable)
              </strong>{' '}
              — over-export simulation; response time; failure mode; record per EREC G100 spec
            </li>
            <li>
              <strong className="text-white">8. SoTR + cert evidence bundle</strong> — Schedule of
              Test Results assembled; cert evidence bundle finalised with all per-domain packs +
              commissioning records + manufacturer datasheets
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          CRITICAL — Reg 643.7.3.1 NOTE 1 + Reg 826.7 fault loop impedance caveat
        </ContentEyebrow>

        <Pullquote>
          Inverter-active ZS readings can be INVALID. Disable the inverter for fault loop impedance
          tests, or use the manufacturer&rsquo;s approved method.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Standard fault loop impedance test methods</strong> may
              give invalid results where the install is supplied by inverter-based sources (PV /
              hybrid / BESS / EV V2X)
            </li>
            <li>
              <strong className="text-white">The NOTE refers</strong> to typical handheld testers
              (Megger MFT, Kewtech KT64, Fluke 1664) — their default modes are calibrated for
              DNO-fed installs
            </li>
            <li>
              <strong className="text-white">Safe practice 1 — inverter OFF</strong> — set inverter
              to off via manufacturer commissioning app + open the AC isolator + verify with voltage
              detector. Then perform ZS test. After test, restore the inverter + verify operation.
              Record this in the commissioning notes
            </li>
            <li>
              <strong className="text-white">
                Safe practice 2 — manufacturer&rsquo;s test method
              </strong>{' '}
              — some inverters (GivEnergy, SolarEdge, Sigenergy) publish specific procedures with
              inverter in &lsquo;commissioning&rsquo; or &lsquo;maintenance&rsquo; mode. Follow
              their method when available
            </li>
            <li>
              <strong className="text-white">Safe practice 3 — high-current method</strong> — fully
              de-energised circuit + high-current source + voltage measurement. Specialist test
              equipment + competence required; rare in domestic; common in commercial
            </li>
            <li>
              <strong className="text-white">Per-mode verification (Reg 826.7)</strong> — direct
              feeding ZS measured with the install in direct feeding (inverter disabled for the
              test); island-mode ZS analysis is theoretical (inverter is the source, contribution
              computed from manufacturer datasheet) since you cannot &lsquo;test&rsquo; the loop
              against an active inverter source
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — records the ZS reading
              + the inverter state during the test + the method used. Failure to record these =
              potential SoTR audit finding
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Reg 570.6.3 — BESS ventilation verification at commissioning
        </ContentEyebrow>

        <Pullquote>
          Ventilation isn&rsquo;t just a design item — verify it at commissioning per Reg 570.6.3 +
          PAS 63100.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Location compliance</strong> — not in habitable spaces
              (bedroom / lounge); not in escape route; manufacturer-permitted location (garage /
              utility / outbuilding / external enclosure for most LFP). PAS 63100 covers this
            </li>
            <li>
              <strong className="text-white">Clearance verification</strong> —
              manufacturer-specified clearances respected. Common: 200-500 mm above + sides; nothing
              combustible within the clearance zone
            </li>
            <li>
              <strong className="text-white">Ventilation openings</strong> — ventilation grilles +
              airflow paths clear; not blocked by storage / insulation / debris
            </li>
            <li>
              <strong className="text-white">Fire detection</strong> — smoke / heat detector in the
              BESS location, interconnected with the dwelling&rsquo;s main fire alarm where present
              (PAS 63100 mandate for most domestic LFP)
            </li>
            <li>
              <strong className="text-white">Signage</strong> — BESS warning signage on the
              enclosure + on the access door to the room (PAS 63100 + Reg 826.1.1.4 multi-source
              notice)
            </li>
            <li>
              <strong className="text-white">Emergency response info</strong> — manufacturer&rsquo;s
              emergency response document handed over + posted in the BESS location (typical:
              GivEnergy / Tesla / Sigenergy all publish these)
            </li>
            <li>
              <strong className="text-white">For vented lead-acid / VRLA</strong> — additional
              ventilation calculation per BS EN IEC 62485-2 Annex A; explosion-proof fittings; rare
              in UK domestic but common in some commercial backup applications
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — photos + checklist +
              cross-reference to BS EN IEC 62485 series + PAS 63100:2024
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          No grid = no anti-islanding, no EREC, no DNO. V/freq trip per Reg 551.2.3 + generator
          integration.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">V/freq trip per Reg 551.2.3</strong> — inverter
              generates V/freq autonomously; verify trip behaviour by simulating overload (load
              exceeding inverter capacity) + low-battery (BESS depleting); verify trip thresholds +
              restart sequence
            </li>
            <li>
              <strong className="text-white">Generator auto-start logic (Section 4.3)</strong> —
              verify trigger SoC threshold (typical 20-30%); verify ATS operation (load transfer
              from inverter to generator); verify auto-stop SoC threshold (typical 70-90%)
            </li>
            <li>
              <strong className="text-white">Three-stage charging</strong> — with generator running
              + BESS accepting charge, verify BULK → ABSORPTION → FLOAT transitions per BMS spec
            </li>
            <li>
              <strong className="text-white">Extended-autonomy verification</strong> — measure BESS
              usable capacity (typically by full charge then controlled discharge to BMS cut-off);
              project to design autonomy days
            </li>
            <li>
              <strong className="text-white">SELV/PELV per Reg 712.414</strong> — for small off-grid
              (boats, caravans, sheds at 12V/24V/48V): verify U_oc_max ≤ 120V DC + basic protection
              where nominal V &gt; 30V DC
            </li>
            <li>
              <strong className="text-white">BS EN 62446-1 PV tests still apply</strong> —
              continuity, IR, polarity, V_oc/I_sc per string
            </li>
            <li>
              <strong className="text-white">
                BS EN IEC 62485 + PAS 63100 BESS tests still apply
              </strong>{' '}
              — BMS handshake, first cycle, ventilation, fire safety
            </li>
            <li>
              <strong className="text-white">NOT APPLICABLE</strong> — anti-islanding (no grid);
              EREC G98/G99/G100; DNO notification
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          5-yearly EICR-style. PV cable + connectors + isolators + performance baseline + BESS
          condition + EPS + G100 + firmware.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">PV cable insulation</strong> — megger test (500V or
              1000V per Reg 712.6 + BS EN 62446-1 methodology); compare to commissioning baseline;
              identify any degradation
            </li>
            <li>
              <strong className="text-white">PV connectors</strong> — visual inspection (corrosion,
              water ingress, UV damage); thermal imaging where possible (hot connectors indicate
              corrosion or loose contact)
            </li>
            <li>
              <strong className="text-white">DC isolator function</strong> — manual operation; DC
              switching capability per Reg 712 + BS EN 60947-3 still working; arc-free operation
            </li>
            <li>
              <strong className="text-white">PV performance baseline</strong> — V_oc + I_sc per
              string vs commissioning record; adjusted for typical module degradation (~5-10% over 5
              years); identify modules with abnormal degradation
            </li>
            <li>
              <strong className="text-white">BESS condition + capacity test</strong> — discharge
              test to measure usable capacity; compare to nameplate + manufacturer warranty curve;
              review BMS log for cell imbalance, temperature alarms, fault codes
            </li>
            <li>
              <strong className="text-white">BESS fire safety per PAS 63100</strong> — separation
              from escape routes; smoke alarm function; visual condition of enclosure
            </li>
            <li>
              <strong className="text-white">EPS / island mode verification</strong> — simulate grid
              loss; verify EPS contactor + island mode + protected loads (Module 4.6 test sequence)
            </li>
            <li>
              <strong className="text-white">G100 verification (if applicable)</strong> —
              over-export simulation; response time; CT cable integrity
            </li>
            <li>
              <strong className="text-white">Firmware review</strong> — current version vs latest;
              check release notes for any safety-affecting changes; update if recommended
            </li>
            <li>
              <strong className="text-white">EICR coding</strong> — C1 (immediate danger); C2
              (potentially dangerous); C3 (improvement recommended); FI (further investigation)
            </li>
            <li>
              <strong className="text-white">Updated cert evidence bundle</strong> — periodic
              inspection record added; firmware version log updated; manufacturer warranty status
              verified
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          10+ documents integrated. The customer\'s long-term asset. Paper + digital archive.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">1. MCS MIS 3002 PV design pack</strong> — site survey,
              yield modelling, schematic, schedule, MPPT calculations, cable sizing, customer
              information (Module 3)
            </li>
            <li>
              <strong className="text-white">
                2. Chapter 57 BESS design pack + PAS 63100:2024 compliance
              </strong>{' '}
              — battery selection, PCE selection per Reg 570.5.2, placement + ventilation + fire
              safety per PAS 63100, BMS spec (Module 5 covers in depth)
            </li>
            <li>
              <strong className="text-white">3. Chapter 82 PEI design pack</strong> — operating
              modes, multi-source isolation, bidirectional OCPDs, transient protection (Module 4.5)
            </li>
            <li>
              <strong className="text-white">
                4. BS EN 62446-1 PV commissioning records + SoTR
              </strong>{' '}
              — continuity, polarity, V_oc/I_sc per string, IR, functional tests of isolators +
              protective devices (Module 3.7)
            </li>
            <li>
              <strong className="text-white">
                5. BS EN IEC 62485 + PAS 63100 BESS commissioning records
              </strong>{' '}
              — BMS handshake, first cycle, ventilation verification, fire safety verification,
              capacity baseline
            </li>
            <li>
              <strong className="text-white">6. EPS test record (Module 4.6)</strong> — switchover
              time, protected-load partition verification, RCD under island mode
            </li>
            <li>
              <strong className="text-white">7. EREC G98/G99/G100 paperwork (Module 4.7)</strong> —
              applications, DNO approvals, G100 verification testing
            </li>
            <li>
              <strong className="text-white">
                8. Manufacturer datasheets + warranty registrations
              </strong>{' '}
              — PV modules, hybrid inverter, BESS, accessories; warranty status confirmation
            </li>
            <li>
              <strong className="text-white">9. Install photographs</strong> — DC routing, AC
              routing, mounting + flashing, modules + frame bonding, BESS placement, isolator
              placements + labels, all signage
            </li>
            <li>
              <strong className="text-white">10. Customer information pack</strong> — operating
              manual, mode descriptions, maintenance schedule, EPS behaviour, emergency contacts,
              manufacturer app credentials
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-4-section-7')}
