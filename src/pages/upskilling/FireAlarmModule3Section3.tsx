    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS 5839-1:2025: cause-and-effect matrices now mandatory at handover, one-stage and
          two-stage and phased evacuation philosophies, coincidence (two-detector) schemes, day /
          night sensitivity settings, and how multi-sensor detector configuration is recorded per
          Annex D.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Effects (outputs)</strong> — every sounder circuit; every voice alarm output;
              every visual alarm device (VAD) circuit; every interface output (relay or volt-free
              contact) to plant, doors, lifts, ventilation, BMS, ARC transmission.
            </li>
            <li>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            <text x="440" y="26" textAnchor="middle" fill="#FBBF24" fontSize="14" fontWeight="bold">
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="265" y="68" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              Sounders
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="355" y="68" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              Sounders
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="445" y="68" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              Sounders
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="535" y="68" textAnchor="middle" fill="#A855F7" fontSize="9" fontWeight="bold">
              Lift recall
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="625" y="68" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              Plant
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="715" y="68" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              Doors
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="805" y="68" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              ARC tx
            </text>
            ...
            <text x="60" y="324" fill="rgba(255,255,255,0.7)" fontSize="10">
              IMMED = output activates as soon as the cause is detected. +60 s = output activates 60
              seconds after the cause.
            </text>
            ...
            <text x="60" y="426" fill="rgba(255,255,255,0.6)" fontSize="9">
              Day / night logic: separate matrix or annotated columns for night-mode behaviour. CIE
              clock checked at every service per BS 5839-1:2025 maintenance clause.
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Small offices</strong> — total population that can clear the building in a few
              minutes via a small number of exits.
            </li>
            <li>
            ...
            <li>
              <strong>Buildings with one or two storeys</strong> and occupant numbers not producing
              stairway congestion at simultaneous evacuation.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              A different audible pattern (intermittent, modulated, voice-message-only) audible only
              to staff areas.
            </li>
            <li>
          ...
          <p>
            The escalation to stage 2 (full evacuation) is critical: too long a delay = a real fire
            develops while staff investigate; too short = the false-alarm-management benefit is
            lost. The matrix records the time-out and the manual escalation paths. Day / night
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              immediate full-building evacuation (overrides the phased sequence). This is because a
              manual call point is a confirmed fire signal from a person who has seen the fire.
            </li>
            <li>
              <strong>Voice alarm integration</strong> — phased evacuation is typically paired with
              a voice alarm system (BS 5839-8) that gives clear evacuation messages per floor and
              per stage.
            </li>
          </ul>
          <p>
            The matrix for a phased system is substantial. Each floor row is an input; each floor
            sounder zone is an output column; each cell records the time at which that floor sounds
            in response to a fire on each other floor. Building-specific; designed alongside the
            fire engineering of the building.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              positioned so a real fire would activate both within a reasonable time window (a fire
              too localised to reach both is a real risk).
            </li>
            <li>
              <strong>Time window</strong> — the maximum interval between the first and second
              activation that still constitutes coincidence. Too short = real fires miss the window;
              too long = false-alarm filtering benefit erodes. Typical 60-180 seconds.
            </li>
            <li>
            ...
            <li>
              <strong>Day / night context</strong> — coincidence is typically used in occupied hours
              when staff can investigate the first-stage signal. At night with no staff present,
              single-detector immediate alarm is often the right choice.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Hospital ward</strong> — day mode: investigation delay 60 s before staff pager
              + ward sounder. Night mode: immediate ward sounder + ARC transmission (staff presence
              is reduced).
            </li>
            <li>
        ...
        >
          ...
          <p>
            The 2025 standard formerly placed Annex E for this; it is now Annex D (renumbered). The
            format is suggested, not mandated — the requirement is that the information IS recorded.
            Without a record, future service visits cannot verify the detector mode against the
            design intent.
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-3/section-4')}
