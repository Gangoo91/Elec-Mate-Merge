...
const FireAlarmModule5Section1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 5 · Section 1" title="Pre-installation planning" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Before any cable is pulled, the install is won or lost on the survey. BS 5839-1:2025
          places explicit weight on the gap between design intent and site reality — and on the CDM
          2015 duty to plan work for safe maintenance.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Void depths.</strong> Above suspended ceilings and under raised floors. A void
              up to and including 1.25 m deep accepts a detector in the top 125 mm; a void between
              1.25 m and 1.5 m accepts a detector in the top 10 % of void depth; a void deeper than
              1.5 m is treated as a normal-height room (detector mounted to ceiling with the
              standard 25-600 mm smoke / 25-150 mm heat below ceiling rule).
            </li>
            <li>
              <strong>Obstructions.</strong> Ducts, light fittings, beams, signs. Per 21.2.12, an
              obstruction is treated as a wall if (a) the gap between the top of the obstruction and
              the ceiling above is less than 300 mm AND (b) the obstruction is deeper than 10 % of
              the overall ceiling height. Closely-spaced beams (approximately 1 m or less
              centre-to-centre per the 2025 clarification) need additional detectors.
            </li>
            <li>
              <strong>Fire-resisting compartments.</strong> Compartment walls and floors must not be
              breached without re-instatement of the fire resistance. Survey records the compartment
              lines so containment routing avoids them where practical and includes fire-stopping
              detail where penetration is unavoidable.
            </li>
            <li>
              ...
              clear. The fire alarm cable routes are re-coordinated against what is actually there.
            </li>
            <li>
            ...
            <li>
              <strong>Access for maintenance.</strong> Where will the maintainer reach this detector
              in five years? Permanent access, fixed ladder, MEWP, scaffold tower? If the answer is
              "we will figure it out" the survey has not done its job.
            </li>
          </ul>
          <p>
            ...
            Requests for Information (RFIs) issued back to the design team where the design and the
            building disagree.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              metres" is not a survey; a tape measurement of 2 870 mm with a photograph is a survey.
              The detector type may switch on that 130 mm difference.
            </li>
            <li>
            ...
            <li>
              <strong>Mark up the drawing.</strong> Annotate measured heights and depths directly on
              the drawing. Highlight TQ items in colour. Date and sign the marked-up drawing.
            </li>
            <li>
            ...
            <li>
              <strong>Issue TQs in writing.</strong> Verbal queries get lost. Issue numbered TQs or
              RFIs through the contract administrator; record the response in the survey report.
            </li>
          </ul>
          <p>
            At the end of the survey there is a single document — a marked-up drawing plus a report
            — that says: this is what the building actually looks like, this is the quantity and
            type of detectors we will install, these are the queries waiting on answers, this is the
            lead-time list. The project runs from this document.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="410" y="32" textAnchor="middle" fill="#FBBF24" fontSize="13" fontWeight="bold">
            ...
            <g>
              ...
              <text x="400" y="164" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9.5">
            ...
            <line x1="40" y1="400" x2="780" y2="400" stroke="rgba(34,197,94,0.3)" strokeWidth="1" />
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>MEP / containment.</strong> Cable trays, ducts, sprinkler pipework, lighting,
            ...
            <li>
              ...
              installed before suspended ceiling tiles. Access panels in plasterboard ceilings must
              be positioned over interfaces and junctions. Wall finishes must permit MCP fixing (and
              its 1.4 m mounting height +200 mm / -300 mm tolerance). Coordinate first-fix sequence
              with the ceiling subcontractor at programme stage.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>CIE.</strong> Control and Indicating Equipment — the panel itself, addressable
              platform, repeater panels if any. Often a long-lead item; PO issued early.
            </li>
            <li>
            ...
            <li>
              ...
              weatherproof, with addressable interface). Transparent protective covers per the 2025
              revision recommendation. Position-confirmation labels.
            </li>
            <li>
              <strong>Sounders, VADs and combined units.</strong> By coverage requirement (65 dB(A)
              general / 75 dB(A) bed-head per BS 5839-1:2025) and visual coverage per BS EN 54-23
              where VAD is the primary signal.
            </li>
            <li>
            ...
            <li>
              ...
              fire-resistant power-limited (PH 30/PH 120) per BS EN 50200, sized per the loop load).
              Length from the routing take-off plus a wastage allowance (typically 10-15 % depending
              on routing complexity).
            </li>
            <li>
              <strong>Containment.</strong> Cable tray, basket, conduit, trunking, conduit fittings.
              Sized for the cable bundle and survey-verified void clearances.
            </li>
            <li>
              <strong>Cable supports.</strong> Fire-resistant supports (metallic, with adequate fire
              performance — a 2017+ point reinforced in 2025 cabling clause 16). No reliance on a
              single point that fails before the cable does in a fire.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              criteria. Inspection regime. Operative training (PASMA / IPAF). Edge protection. Tools
              tethering. Drop-zone management.
            </li>
            <li>
            ...
            <li>
              ...
              cable tray modifications). Hot work permit, fire watch, extinguisher within reach, no
              work in the last hour of shift.
            </li>
            <li>
              <strong>Working live or near live.</strong> Isolation procedures. Lock-off / tag-out.
              Safe isolation tested with a known-good two-pole instrument (proving unit / proving
              voltage / proving unit again). PPE for unavoidable live work (rare, discouraged).
            </li>
            <li>
            ...
            <li>
              <strong>Existing detection during phased work.</strong> Specific risk: disabling part
              of the existing system temporarily. Permit-to-work; written agreement with the
              Responsible Person; compensating measures (fire watch, temporary detection, evacuation
              drill if extended) for the disabled period.
            </li>
            <li>
              ...
              handling specifically — sealed lead-acid batteries are heavy and contain electrolyte.
            </li>
            <li>
              <strong>Public / occupant interface.</strong> Working in occupied premises adjacent to
              staff or public. Barriers, signage, reroute of pedestrian traffic. Out-of-hours
              working for high-disruption activities.
            </li>
          </ul>
          <p>
            For each hazard, the assessment scores risk (probability × severity), the method
            statement describes the controls, and the operatives sign back to confirm understanding
            before the work starts. The PC reviews the RAMS as part of the construction phase plan
            and accepts it for the site.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              provided in respect of the premises by virtue of this Order are subject to a suitable
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              Previously could be excluded as low fire-risk; now require automatic detection. Survey
              must list every stairway lobby.
            </li>
            <li>
            ...
            <li>
              ...
              than 300 mm AND obstruction depth more than 10 % of ceiling height. Both criteria must
            ...
            <li>
              ...
              multi-zone premises (especially sleeping risk) and the absence of ARC transmission in
              supported housing / care homes are NO LONGER acceptable variations. Other variations
              require written justification. Survey identifies any required variation and starts the
              justification log.
            </li>
            <li>
          ...
          <p>
            ...
            2025-spec install will under-deliver on detector type in sleeping rooms, stairway lobby
            coverage, interface placement, cause-and-effect documentation and labelling.
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-5/section-2')}
