...
const quizQuestions = [
  {
    ...
    options: [
      ...
      'The purchase cost of the cable',
      'The physical weight of the cable',
      'Difficulties with colour coding',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: ['100 metres', '10 kilometres', '300-400 metres', '100 kilometres'],
    correctAnswer: 2,
    explanation:
      'OM4 multimode fibre supports 10Gbps up to around 400 metres, making it ideal for building backbones.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    options: [
      'Electromagnetic signals originating from space',
      'Interference between signals in adjacent cables',
      'Reflection of the signal at the connector',
      'Noise caused by an earth ground loop',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Both are equally difficult to tap',
      'Neither type can be tapped at all',
      'Copper, because its emissions can be detected',
      'Fibre, because the light leaks out',
    ],
    correctAnswer: 2,
    explanation:
      "Copper cables emit electromagnetic radiation that can be detected. Fibre doesn't radiate and is very difficult to tap undetected.",
  },
  {
    id: 6,
    question: 'What is the typical weight comparison between equivalent fibre and copper cables?',
    options: [
      'Fibre is significantly heavier than copper',
      'Both weigh roughly the same',
      'It depends only on the manufacturer',
      'Fibre is significantly lighter than copper',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It offers higher peak bandwidth',
      'It can carry power and data via PoE',
      'It provides better physical security',
      'It supports much longer distances',
    ],
    correctAnswer: 1,
    explanation:
      'Copper can deliver power and data simultaneously via PoE, essential for IP phones, WiFi access points, and cameras.',
  },
  {
    id: 8,
    question: 'What is the primary disadvantage of fibre for termination?',
    options: [
      'It results in slower data speeds',
      'It cannot be bent around corners',
      'It requires specialised tools and training',
      'It is always too expensive to use',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It is always more expensive than copper',
      'Often lower, due to longevity and upgrade potential',
      'It is exactly the same as copper',
      'The two cannot be meaningfully compared',
    ],
    correctAnswer: 1,
    explanation:
      "Fibre's longer lifespan and ability to support speed upgrades with just transceiver changes often makes its TCO lower.",
  },
  {
    id: 10,
    question: 'Which standard defines Category 6A copper cable performance?',
    options: ['IEEE 802.3', 'BS 7671', 'ISO 9001', 'TIA-568'],
    correctAnswer: 3,
    explanation:
      'TIA-568 (and its ISO equivalent ISO 11801) defines structured cabling standards including the Category ratings.',
  },
];
