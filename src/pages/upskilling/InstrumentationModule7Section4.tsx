...
const DESCRIPTION =
  'Learn international wiring standards, colour codes, cable types, labelling conventions, and the safety benefits of standardised wiring practices in industrial instrumentation.';
...
const quizQuestions = [
  ...
  },
  {
    id: 6,
    question:
      'What is the typical resistance of 0.75mm squared instrumentation cable per kilometre?',
    options: ['12 ohms/km', '18 ohms/km', '24 ohms/km', '36 ohms/km'],
    correctAnswer: 2,
    explanation:
      '0.75mm squared instrumentation cable has approximately 24 ohms per kilometre resistance. This must be considered in loop resistance calculations for 4-20mA circuits.',
  },
  {
    id: 7,
...
const faqs = [
  {
    ...
    answer:
      "While documentation is important, it's strongly recommended to follow international standards (IEC 60757, ISA-5.1). Non-standard schemes create confusion for maintenance personnel unfamiliar with the site and increase error risk during emergencies.",
  },
  {
    question: 'Is it acceptable to mix cable screening types in the same installation?',
    answer:
      'Yes, but carefully. Use individual screening (IS) for sensitive signals near noise sources and overall screening (OS) for general runs. Document the approach and ensure consistent termination practices throughout.',
  },
  {
    question: 'How often should cable labels be inspected and replaced?',
    answer:
      'Labels should be inspected during routine maintenance (typically annually) and replaced if damaged, faded, or illegible. UV-resistant and chemical-resistant labels last longer in harsh environments.',
  },
  {
    question: "What if existing installations don't follow current colour standards?",
    answer:
      'Legacy installations can remain if well-documented. When making modifications, bring new work up to current standards. Consider a phased upgrade during major maintenance or when safety is compromised.',
  },
  {
    question: 'Are there specific colour requirements for hazardous area (ATEX) installations?',
    answer:
      "ATEX doesn't mandate specific colours beyond standard earth identification. However, intrinsically safe circuits are often run in blue-sheathed cable to distinguish them from non-IS circuits.",
  },
  {
    question: 'What cable size should I use for a 300-metre 4-20mA loop?',
    answer:
      'Calculate loop resistance including cable, transmitter, and load. For 300m runs, 1.0mm squared or 1.5mm squared is typically required to keep voltage drop within acceptable limits. Always verify with manufacturer specifications.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>IEC 60757:</strong> International conductor colour codes
              </li>
              <li>
                <strong>ISA-5.1:</strong> Instrumentation identification standards
              </li>
              <li>
                <strong>Green/Yellow:</strong> Always protective earth (mandatory)
              </li>
              <li>
                <strong>Red/Black:</strong> Typical 4-20mA signal pair
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Standardised colour coding reduces errors by 50-70%
              </li>
              <li>
                <strong>Use:</strong> Always label cables with source, destination, and signal type
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              International wiring standards ensure consistent identification across installations
              worldwide. The IEC 60757 standard defines conductor colours for general electrical
              work, whilst ISA-5.1 provides specific guidance for instrumentation systems.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                IEC 60757 Power Conductor Colours:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong className="text-green-400">Green/Yellow:</strong> Protective earth
                  (mandatory)
                </li>
                <li>
                  <strong className="text-blue-400">Blue:</strong> Neutral conductor
                </li>
                <li>
                  <strong className="text-amber-400">Brown:</strong> Line/Live conductor (single
                  phase)
                </li>
                <li>
                  <strong className="text-white">Black/Brown/Grey:</strong> Three phase L1, L2, L3
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                ISA-5.1 Instrumentation Colours:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong className="text-red-400">Red (+):</strong> Positive 4-20mA signal wire
                </li>
                <li>
                  <strong className="text-white">Black (-):</strong> Negative 4-20mA return wire
                </li>
                <li>
                  <strong className="text-blue-400">Blue:</strong> 24VDC positive supply
                </li>
                <li>
                  <strong className="text-white">White:</strong> 24VDC negative/common
                </li>
                <li>
                  <strong className="text-orange-400">Orange:</strong> Shield/drain wire termination
                </li>
                <li>
                  <strong className="text-purple-400">Purple:</strong> HART communication pairs
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Instrumentation cable selection depends on the application environment, signal type,
              and required noise immunity. Understanding cable construction helps match the right
              product to the installation requirements.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Individual Screen (IS):</strong> Each pair separately screened - best
                  noise immunity
                </li>
                <li>
                  <strong>Overall Screen (OS):</strong> Single screen over all pairs - cost
                  effective
                </li>
                <li>
                  <strong>Collective Screen (CS):</strong> Groups of pairs screened - moderate
                  protection
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>0.5mm squared:</strong> Up to 50mA - not recommended for loops
                </li>
                <li>
                  <strong>0.75mm squared:</strong> Standard for 4-20mA loops up to 100m
                </li>
                <li>
                  <strong>1.0mm squared:</strong> Preferred for long runs (100-300m)
                </li>
                <li>
                  <strong>1.5mm squared:</strong> Heavy duty and very long runs
                </li>
                <li>
                  <strong>2.5mm squared:</strong> Power distribution to instruments
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>LSZH:</strong> Low Smoke Zero Halogen - essential for enclosed spaces
                </li>
                <li>
                  <strong>Fire Retardant:</strong> IEC 60332-1 single cable flame test
                </li>
                <li>
                  <strong>Circuit Integrity:</strong> BS 6387 CWZ for emergency systems
                </li>
                <li>
                  <strong>Temperature Range:</strong> Typically -40 degrees C to +105 degrees C
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Unique Identifier:</strong> Each cable requires unique designation
                </li>
                <li>
                  <strong>Source/Destination:</strong> Clear origin and termination points
                </li>
                <li>
                  <strong>Signal Type:</strong> 4-20mA, 24VDC, HART, etc.
                </li>
                <li>
                  <strong>Circuit Reference:</strong> P and ID tag or loop number
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Functional Grouping:</strong> Power, signals, communications separate
                </li>
                <li>
                  <strong>Signal Direction:</strong> Inputs and outputs clearly separated
                </li>
                <li>
                  <strong>Spare Capacity:</strong> 20% spare terminals for future modifications
                </li>
                <li>
                  <strong>Test Points:</strong> Easy access for maintenance and testing
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Following wiring standards delivers significant operational and safety benefits
              throughout the system lifecycle. The initial investment in proper documentation and
              standard compliance pays dividends during maintenance and emergency situations.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Rapid Identification:</strong> Immediate signal recognition by colour
                </li>
                <li>
                  <strong>Reduced Downtime:</strong> 50-70% reduction in troubleshooting time
                </li>
                <li>
                  <strong>Error Prevention:</strong> Consistent coding prevents connection mistakes
                </li>
                <li>
                  <strong>Knowledge Transfer:</strong> Easier handover between personnel
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Electrical Safety:</strong> Clear identification of live conductors
                </li>
                <li>
                  <strong>Earth Protection:</strong> Unmistakable green/yellow coding
                </li>
                <li>
                  <strong>Emergency Response:</strong> Rapid identification during emergencies
                </li>
                <li>
                  <strong>Regulatory Compliance:</strong> Meets safety standard requirements
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Non-standard colours</strong> - creates confusion and safety hazards
                </li>
                <li>
                  <strong>Missing labels</strong> - impossible to trace signals efficiently
                </li>
                <li>
                  <strong>Inadequate cable size</strong> - voltage drop causes signal errors
                </li>
                <li>
                  <strong>Shield earthed at both ends</strong> - creates ground loops
                </li>
              </ul>
            </div>
          </div>
