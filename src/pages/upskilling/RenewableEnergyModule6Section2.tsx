...
const quickCheckQuestions = [
  {
    id: 'dom-ev-qc1',
    question:
      'What is the minimum cable size typically required for a 7.4 kW single-phase EV charger?',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'PME earthing raises safety concerns when vehicles connect outdoors due to increased risk of touch voltage in fault conditions. Additional protective measures are required.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    id: 6,
    question:
      'What earth electrode resistance is typically required when using an earth rod for EV charging?',
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">Circuit Design, Earthing &amp; Compliance</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Cable:</strong> 6mm² minimum for 32A, check voltage drop
              </li>
              <li>
                <strong>Protection:</strong> Type B RCD or Type A + DC detection
              </li>
              <li>
                <strong>Earthing:</strong> PME outdoors requires additional measures
              </li>
              <li>
                <strong>Compliance:</strong> BS 7671, IET CoP, DNO notification
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Supply type, capacity limits, cable route options
              </li>
              <li>
                <strong>Use:</strong> Site survey checklist, voltage drop calculations
              </li>
              <li>
                <strong>Apply:</strong> Design compliant circuits for each installation
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A thorough site survey is essential before any EV charger installation. This
              identifies the optimal charger location, assesses the existing electrical
              installation, and highlights any potential issues.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Correct circuit design ensures safe operation and complies with BS 7671 requirements.
              Key considerations include cable current carrying capacity, voltage drop, and fault
              protection.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Current carrying capacity (Iz):</strong> Must exceed design current with
                  correction factors
                </li>
                <li>
                  <strong>Voltage drop:</strong> Maximum 5% (11.5V on 230V supply)
                </li>
                <li>
                  <strong>Earth fault loop impedance:</strong> Suitable for protective device
                  operation
                </li>
                <li>
                  <strong>Installation method:</strong> Clipped direct, in conduit, buried, etc.
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Typical Cable Sizes for 32A EV Charger:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Earthing for EV charging requires careful consideration, particularly for PME (TN-C-S)
              supplies where vehicles connect outdoors. The IET Code of Practice provides specific
              guidance based on supply type and installation location.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">PME Earthing Concerns</p>
              <p className="text-sm text-white mb-2">
                PME supplies present a risk when vehicles connect outdoors. If the PEN conductor
                becomes open-circuit, dangerous voltages can appear on exposed metalwork. Options
                include:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Option 1:</strong> Install earth electrode achieving Ra × Ia ≤ 50V
                </li>
                <li>
                  <strong>Option 2:</strong> Protective equipotential bonding of installation
                  location
                </li>
                <li>
                  <strong>Option 3:</strong> Use equipment with protective separation
                </li>
                <li>
                  <strong>Option 4:</strong> Install device that disconnects PME earth if voltage
                  rises
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Selecting appropriate protective devices is critical for safety and compliance. EV
              charging circuits have specific requirements due to the nature of the load and
              potential for DC fault currents.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Proper installation techniques and thorough testing ensure safe, reliable operation.
              Follow manufacturer instructions alongside BS 7671 requirements.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Undersized cables</strong> - always calculate voltage drop
                </li>
                <li>
                  <strong>Wrong RCD type</strong> - ensure DC fault protection
                </li>
                <li>
                  <strong>Ignoring PME issues</strong> - check outdoor connection risks
                </li>
                <li>
                  <strong>Missing DNO notification</strong> - always notify
                </li>
              </ul>
            </div>
          </div>
