    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reg 643.3, Table 64 and the A4:2026 redraft of 643.3.3. What insulation actually is, what
          fails it, why the test is DC, and how the 250 V/500 V/1000 V test voltages map to circuit
          type.
        </p>
        ...
        >
          <p>
            ...
            voltage. Real insulators (PVC, XLPE, EPR, mineral) have very high but finite resistance,
            typically in the hundreds of megohms to gigohms range when new and dry. The test
            measures how close to ideal the real insulation is.
          </p>
          ...
          <p>
            Each of these reduces the measured insulation resistance below the value a healthy cable
            would deliver. The test does not tell you WHICH mechanism is at work — that is the
            inspector&rsquo;s diagnostic job — but a low reading reliably tells you that one or more
            of them is.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The insulation resistance measured with the test voltages indicated in Table 64 shall
              be considered satisfactory if the main switchboard and each distribution circuit
              tested separately, with all its final circuits connected but with current-using
              equipment disconnected, has an insulation resistance not less than the appropriate
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              purely the cable&rsquo;s capacitance charging. The reading appears low, then rises as
              the dielectric polarises. Wait for it to stabilise before recording.
            </li>
            <li>
              ...
              internal resistor at the end of the test; do not assume this on older instruments and
              never disconnect probes from a tested cable without confirming the discharge.
            </li>
            <li>
              <strong>Polarity.</strong> The test is between two specified conductors (e.g. line and
              earth, or live conductors and protective conductor). Polarity of the applied DC
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="130" y="84" textAnchor="middle" fill="#FBBF24" fontSize="12" fontWeight="bold">
              IR TESTER
            </text>
            ...
            <text x="500" y="50" textAnchor="middle" fill="#22C55E" fontSize="12" fontWeight="bold">
            ...
            <text x="500" y="298" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
            ...
            <text x="400" y="402" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="10">
              R = V / I. A healthy cable: tiny I → MΩ in the hundreds or above. A compromised cable:
              more I → MΩ drops.
            </text>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Table 64 — Minimum values of insulation resistance. SELV and PELV: test voltage 250 V
              DC, minimum insulation resistance 0.5 MΩ. Up to and including 500 V with the exception
              of the above systems: test voltage 500 V DC, minimum insulation resistance 1.0 MΩ.
              Above 500 V: test voltage 1000 V DC, minimum insulation resistance 1.0 MΩ. Table 64
              shall be applied when verifying insulation resistance between non-earthed protective
              conductors and Earth. FELV circuits shall be tested at the same test voltage as that
              applied to the primary side of the source and shall meet all the test requirements for
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Step 1 — cable alone, Table 64 voltages.</strong> With current-using equipment
              disconnected (per 643.3.2), apply the Table 64 test voltage for the circuit type —
              typically 500 V DC for a 230 V circuit. Verify ≥ 1.0 MΩ. The cable, its accessories
              and any directly-wired non-vulnerable apparatus form the test scope.
            </li>
            <li>
              <strong>Step 2 — equipment connected, 250 V DC.</strong> Reconnect equipment that was
              disconnected for step 1. Apply 250 V DC between live conductors and the protective
              conductor connected to the earthing arrangement. Verify ≥ 1.0 MΩ. The 250 V controlled
              stress is low enough to spare the equipment but high enough to reveal gross insulation
              breakdown.
            </li>
          </ol>
          <p>
            ...
            case: most data sheets ask for SPD disconnection during IR testing because the clamping
            diodes start conducting at much lower voltages than 250 V DC.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              equipment, in accordance with Table 64. Following connection of the equipment, a test
              at 250 V DC shall be applied between live conductors and the protective conductor
              connected to the earthing arrangement. The insulation resistance shall have a value of
              at least 1 MΩ. NOTE: Manufacturer&rsquo;s instructions may recommend some equipment to
              be disconnected during 250 V DC insulation resistance tests as it may influence the
              results of the test.
            </>
          }
          ...
          whatToDo={
            <>
              <span className="block">
                Step 1 (cable alone, 500 V DC): isolate the circuit at the MCB. Disconnect each LED
                driver at the luminaire — the connector blocks at the driver are the test boundary.
                SPDs at the consumer unit also disconnected per the SPD manufacturer&rsquo;s data
                sheet. Apply 500 V DC between L+N to E and L to N. Verify ≥ 1 MΩ for each test
                (typical reading on a new dry circuit is several hundred MΩ).
              </span>
              <span className="block">
                Step 2 (equipment back, 250 V DC): reconnect the LED drivers and the SPDs. Apply 250
                V DC between L+N (linked) and the protective conductor connected to the earthing
                arrangement. Verify ≥ 1 MΩ. This is the post-connection acceptance test required by
                the A4 redraft of 643.3.3.
              </span>
              <span className="block">
                Record both results on the Schedule of Test Results — the 500 V DC reading from step
                1 in the IR column, and a comment noting the 250 V DC post-connection test was
                performed and met 1 MΩ. The audit trail demonstrates A4:2026 compliance.
              </span>
            </>
          }
        ...
        >
            ...
            <table className="w-full text-[13.5px] my-2">
              ...
              <tbody className="text-white/95">
                ...
                <tr className="border-b border-white/[0.06]">
                  ...
                  <td>0.1–1.0 Ω</td>
                  <td className="text-elec-yellow">Tens to hundreds of MΩ (often beyond range)</td>
                </tr>
                <tr className="border-b border-white/[0.06]">
          ...
          <p>
            ...
            test voltages, and a clear selector for which test you are doing. Press the wrong button
            and you can apply 500 V DC to a continuity probe (damaging the tester) or push 200 mA
            through an insulation tester probe (damaging nothing but giving you a useless reading).
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              filters, RFI suppressors, motor windings, transformer windings — all of these have an
              internal path to earth via Y-capacitors or the winding insulation that reads as
              parallel resistance during an IR test. Disconnect, re-test on the cable alone, and the
              reading typically rises to its true value.
            </li>
            <li>
              <strong>Moisture.</strong> A junction box that has taken on water, a luminaire with
              condensation, an outdoor enclosure with a defective gland. Water across an insulation
              surface gives a measurable conductive path. Dry the affected area, re-test, and watch
              the reading recover. If it doesn&rsquo;t, the cable or termination has absorbed
              moisture and is on a deterioration trajectory.
            </li>
            <li>
            ...
            <li>
              ...
              clamping voltage. Some types start to conduct at well below 500 V DC — and even at 250
              V DC, certain MOV-based SPDs can show measurable leakage. Most SPD data sheets specify
              disconnection during IR testing. Follow the manufacturer instructions and document the
              disconnection in comments.
            </li>
          </ul>
          <p>
            ...
            magnitude above the Table 64 minimum), the cause was the connected equipment / moisture
            / contamination, not the cable insulation. If it does not recover, the cable insulation
            itself is degraded.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              Charging and dielectric absorption complete; steady-state leakage is tiny; resistance
              reads high. Record the steady-state value.
            </li>
            <li>
            ...
            <li>
              ...
              creating a path that gets worse as the test voltage warms it / drives current through
              it. Dielectric absorption is being overwhelmed by genuine conduction. Investigate
              before recording.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Continuity proves the protective conductor is in place before any voltage is applied.
              Without continuity, applying 500 V DC to a circuit means the test voltage has no
              defined return path and the result is meaningless.
            </li>
            <li>
              ...
              follow — a phase-to-earth or phase-to-neutral fault would short-circuit the supply at
              first energisation.
            </li>
            <li>
              The result of insulation resistance is independent of the live tests that follow, so a
              fail on IR can be remediated and re-tested without restarting the entire test
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>IR (L–E) and IR (N–E):</strong> the line-to-earth and neutral-to-earth values
              at the Table 64 test voltage, in megohms. If the meter reads &lsquo;beyond
            ...
            <li>
              ...
              643.3.3 redraft), any equipment that was disconnected for the test, SPDs disconnected
              and reconnected, and any non-standard procedure. The next inspector should be able to
              read your test sequence from the comments alone.
            </li>
          </ul>
        </ConceptBlock>
