...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      'HVAC engineers carry out the electrical termination work',
      'HVAC engineers supply the electrical materials',
      'Electricians wire the actuators and sensors that connect HVAC plant to BMS controllers',
      'It removes the need for a commissioning engineer',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It has no measurable impact on system performance',
      'It only affects the visual appearance of the panels',
      'It improves efficiency by simplifying the circuits',
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white">Professional responsibilities and best practices</p>
        </header>
