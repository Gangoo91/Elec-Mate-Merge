    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reg 643.9 — phase sequence verified at every relevant point. Live test, two-probe
          instrument, and the load-side swap that keeps the rest of the installation untouched.
        </p>
        ...
        >
          <p>
            Reg 643.9 in BS&nbsp;7671:2018+A4:2026 is a single, short obligation that does a lot of
            work. It binds initial verification, periodic inspection, and any addition or alteration
            to a three-phase installation. The verb is verify — by indication, with an instrument
            suitable for the duty (BS EN 61557-7 phase rotation indicator).
          </p>
          <p>
            ...
            unpredictably. The classic failure mode is a portable three-phase appliance — a pump, a
            saw, a hoist — that is plugged into one socket and runs correctly, then plugged into a
            socket on a different sub-board and runs in reverse. Same installation, two different
            phase sequences, no Reg 643.9 check, predictable consequences.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              For polyphase circuits, it shall be verified that the phase sequence is maintained at
        ...
        >
          <p>
            ...
            convention is L1 leads, L2 lags by 120&deg;, L3 lags by 240&deg; (equivalently leads L1
            by 120&deg;). That order — L1, L2, L3 — defines clockwise rotation as observed by a
            phase rotation indicator. A clockwise indication means the installation matches
            convention.
          </p>
          <p>
            Swap any two of those conductors and the order changes. Common notations include "1-3-2"
            or "3-2-1" on alphanumeric instruments, or anti-clockwise disc rotation on older
            mechanical indicators. The motor that was spinning clockwise now spins anti-clockwise:
            same speed, same current, opposite direction, no electrical alarm.
          </p>
          <p>
            The instrument manual is the source of truth for what its indication means. Alphanumeric
            strings, graphical symbols and LED patterns are not standardised between manufacturers —
            always check the legend before recording a result.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Phase rotation is relevant primarily for three-phase induction motors and the plant they
            drive. Reverse rotation is mechanically benign for the motor itself — the rotating
            magnetic field reverses, the rotor follows, the motor draws normal current. But the load
            is rarely so forgiving:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              positive-displacement pumps can be physically damaged in seconds by reverse rotation.
            </li>
            <li>
            ...
            <li>
              <strong>Lifts and hoists:</strong> the cabin or load travels in the opposite direction
              to that commanded. This is a safety-critical failure mode.
            </li>
            <li>
          ...
          <p>
            Reg 643.9 sits where it does in the test sequence because reverse rotation is invisible
            to overcurrent and earth-fault protection. The MCB does not see a fault. The RCD does
            not trip. Only the rotation indicator and the resulting plant behaviour tell you
            something is wrong — which is why the verification is mandated, not recommended.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              The probe tips must be GS38-compliant (max 4 mm exposed metal, finger-guarded shroud)
              and CAT IV-rated for distribution-board work.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Approved voltage testers with two-probe phase rotation facilities offer an increase in
              safety over standard three-wire phase rotation testers because they do not require the
              inspector to attach wires to the installation, needing only two phases to be probed
              with hand-held probes.
            </>
          }
        ...
        >
          <p>The procedure for a live phase rotation check at a three-phase distribution board:</p>
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Risk assess.</strong> Identify the test point. Identify how exposed conductors
              will be presented. Identify escape routes. Identify whether two-person working is
              required (it is, for distribution-board live access in most occupied premises and for
              any supply with prospective fault current that warrants a second person on the
              lock-off).
            </li>
            <li>
              <strong>Dress for the live face.</strong> Arc-rated PPE appropriate to the prospective
              fault energy at the test point. Insulated gloves (BS EN 60903) where contact with bare
              conductors is possible. Eye protection. CAT IV-rated test equipment with
              GS38-compliant leads.
            </li>
            <li>
              ...
              rotation. This is the proving step — never trust an isolator without confirming with a
              tester proven against a known live source before and after.
            </li>
            <li>
              <strong>Re-energise.</strong> Restore supply at the agreed switching point. Stand off
              until any inrush has settled.
            </li>
            <li>
              <strong>Take the rotation indication.</strong> With a two-probe tester, contact any
              two of the three line conductors momentarily; read the indication; release. Repeat for
              a different probe pair to confirm consistency. With a three-wire instrument, attach
              L1/L2/L3 clips before energising the test point, then re-energise; read; de-energise;
              remove clips.
            </li>
            <li>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              low-resistance ohmmeter to identify which conductor reads continuity to the protective
              conductor. That conductor is L1.
            </li>
            <li>
            ...
            <li>
              Re-energise and perform the live rotation indication for the formal Reg 643.9 record.
            </li>
          </ol>
          <p>
        ...
        >
          ...
          <p>
            ...
            parallel transformers), each source has to be checked independently and proved to match.
            A generator that arrives on site with the wrong rotation relative to the public supply
            is a paralleling-fault waiting for the next mains failure — picked up by Reg 643.9
            commissioning and not by the main-supply intake test alone.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            On the A4:2026 Schedule of Test Results, three-phase circuits are recorded with a phase
            sequence column. Three rules:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
            ...
            <li>
              <strong>Note any corrective action</strong> in the comments column where the sequence
              was wrong on first inspection and corrected (e.g. "L2/L3 swapped at motor isolator on
              commissioning, re-tested, sequence now CW"). Document the original non-compliance and
              its remediation.
            </li>
            <li>
          ...
          <p>
            Single-phase circuits derived from the three-phase board do not require a phase sequence
            entry — there is one phase, no sequence to verify. The polarity column covers the L–N
            orientation duty for those circuits.
          </p>
        </ConceptBlock>
