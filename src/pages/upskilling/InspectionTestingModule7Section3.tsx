...
const DESCRIPTION =
  'Learn to verify correct phase sequence (rotation) on three-phase supplies to ensure motors and equipment rotate in the correct direction.';

const quickCheckQuestions = [
  {
    id: 'pump-no-flow',
    question:
      'A centrifugal pump motor runs but produces no water flow. Could phase rotation be the cause?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Yes. If the phase rotation is reversed, the pump impeller spins backwards, unable to create the centrifugal force needed to move water. The pump appears to run but produces no flow or very low pressure.',
  },
  {
    id: 'motor-correction',
    question:
      'If phase rotation is wrong at a single motor but correct at the main board, where should the correction be made?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'At the motor terminals or the local isolator. The fault is in the final wiring to that motor, so correcting at the motor/isolator fixes it without affecting other equipment on the correct supply.',
  },
  {
    id: 'eicr-rotation',
    question:
      'During an EICR, phase rotation is found to be reversed at the main intake. What observation code applies?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Code C2 (potentially dangerous). Reversed phase rotation at the intake affects all three-phase equipment downstream. This requires urgent attention to prevent damage to motors and machinery.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Phase rotation refers to the sequence (order) in which the three phases (L1, L2, L3) reach their positive peak voltage - typically measured as clockwise (positive) or anti-clockwise (negative).',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      "The standard phase sequence in the UK is L1, L2, L3 in clockwise rotation. This is the 'positive' sequence that three-phase motors and equipment are designed for.",
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Incorrect phase rotation causes three-phase induction motors to run in the opposite (reverse) direction. This can be dangerous for machinery like fans, pumps, or conveyors.',
  },
  {
    id: 4,
    question:
      "A phase rotation tester shows 'negative' or 'reverse' sequence. What does this indicate?",
    options: [
    ...
    correctAnswer: 0,
    explanation:
      'A negative/reverse sequence indicates two of the three phases have been swapped somewhere in the installation, reversing the rotation direction from the standard L1-L2-L3 sequence.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Swapping any two phases will reverse the rotation direction. If the sequence is wrong, swapping any pair (e.g., L1 with L2) will correct it to the proper sequence.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Phase rotation should be verified at the incoming supply and at three-phase outlets or equipment terminals, as wiring errors can occur at any point in the distribution system.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'Centrifugal pumps, compressors, fans, and similar rotating equipment can be damaged if run in reverse. Pumps may lose prime, and some machinery has direction-specific lubrication systems.',
  },
  {
    id: 8,
    question:
      'A phase rotation indicator has connections labelled L1, L2, L3. How should it be connected?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "Connect the tester's L1, L2, L3 terminals to the corresponding supply phases. The tester then indicates whether the sequence matches the correct L1-L2-L3 rotation.",
  },
  {
    id: 9,
    question: 'Phase rotation testing is part of which category of tests in BS 7671?',
    options: ['Dead testing', 'Live testing', 'Functional testing', 'Insulation testing'],
    correctAnswer: 2,
    explanation:
      'Phase rotation testing is a functional test as it verifies the correct operation of the three-phase supply. It requires the supply to be energised.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Phase rotation testing is performed live, so the test equipment must be rated for the system voltage and proved functional before and after use using a proving unit.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Three-phase induction motors develop a rotating magnetic field based on the phase sequence. The direction of this field determines motor rotation. Incorrect sequence reverses the field direction, making the motor run backwards - potentially dangerous for connected machinery.',
  },
  {
    question: 'Can phase rotation be wrong at individual outlets but correct at the main board?',
    answer:
      'Yes. Wiring errors at any point (sub-mains, distribution boards, final connections) can cause phase reversal at specific locations while the main supply sequence remains correct. This is why testing at multiple points is important.',
  },
  {
    question: 'Do all three-phase loads require correct phase rotation?',
    answer:
      'Motors and direction-sensitive equipment require correct rotation. However, resistive loads (heaters) and some electronic equipment with internal rectification are not affected by phase sequence - they work regardless of rotation direction.',
  },
  {
    question: 'What does a phase rotation relay do?',
    answer:
      "A phase rotation relay monitors phase sequence and prevents equipment starting if rotation is incorrect. It's a protective device used on critical machinery. However, it should not be used as a substitute for correct installation - the wiring should be corrected.",
  },
  {
    question: 'How often should phase rotation be checked?',
    answer:
      'Phase rotation should be verified during initial verification of any three-phase installation and after any work that involves disconnecting and reconnecting three-phase supplies. During periodic inspection, it should be checked at outlets and equipment terminals.',
  },
  {
    question: 'Can single-phase loads be affected by phase rotation issues?',
    answer:
      'No. Single-phase loads only use one phase and neutral, so phase rotation is irrelevant. However, if phase identification is incorrect (wrong phase marked as L1), this can cause issues with load balancing and monitoring systems.',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Correct:</strong> L1-L2-L3 (clockwise rotation)
              </li>
              <li>
                <strong>Wrong:</strong> Causes motors to run backwards
              </li>
              <li>
                <strong>Fix:</strong> Swap any two phases to correct
              </li>
              <li>
                <strong>Test:</strong> Live functional test at 400V
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Motor running wrong direction, pump no flow
              </li>
              <li>
                <strong>Use:</strong> Phase rotation tester (proved functional)
              </li>
              <li>
                <strong>Apply:</strong> Test at intake AND at equipment
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              that peaks at different times, 120 degrees apart. Phase rotation (or phase sequence)
              describes the order in which these peaks occur.
            </p>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Pumps:</strong> Run dry, lose prime, cavitation damage
                </li>
                <li>
                  <strong>Fans:</strong> Incorrect airflow direction, reduced efficiency
                </li>
                <li>
                  <strong>Compressors:</strong> Damage to valves and bearings
                </li>
                <li>
                  <strong>Conveyors:</strong> Material moves wrong direction
                </li>
                <li>
                  <strong>Lifts:</strong> Direction indicator mismatch (safety hazard)
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p className="text-sm text-amber-400/70">
              <strong>Safety:</strong> This is live testing at 400V. Use appropriate PPE, follow
              safe working procedures, and ensure adequate clearances.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              If phase rotation is incorrect, the solution is simple: swap any two phases. This
            ...
            <p>
              ...
              distribution board or at the specific outlet/equipment affected, depending on where
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>UK harmonised cable colours for three-phase installations:</p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p>
              The Schedule of Inspections includes a check for phase sequence. Mark as satisfactory
              if correct L1-L2-L3 sequence, or as requiring attention if reversed.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Running motors backward briefly</strong> - damage can occur instantly
                </li>
                <li>
                  <strong>Assuming DNO supply is always correct</strong> - verify it
                </li>
                <li>
                  <strong>Forgetting to re-prove the tester</strong> - essential safety step
                </li>
                <li>
                  <strong>Working live without proper PPE</strong> - 400V is lethal
                </li>
              </ul>
            </div>
          </div>
