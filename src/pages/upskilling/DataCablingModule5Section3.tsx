    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The smaller, cheaper, more-replaceable end of the channel — stranded conductor cable for
          flex-cycle tolerance, the 90 m solid + 10 m stranded channel split that bounds insertion
          loss, locking RJ45 plugs and snagless boots for high-density patching, and why patch cord
          choice is the easy lever protecting a Cat6A permanent-link investment.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              fixed pair geometry by the cable jacket and the pair-separator spline. Low attenuation
              per metre. Designed for one-time pulling under controlled tension (BS EN 50174-2
              limits) and IDC termination at both ends. Rated for tens of thousands of hours in
              static installation; not rated for flex.
            </li>
            <li>
              ...
              general-purpose Cat6A cords; or 19 strands of 36 AWG for ultra-flexible variants. The
              stranded construction tolerates flex without conductor breakage. Higher attenuation
              per metre than solid — the standards allocate just 10 m to stranded across the whole
              channel for this reason. Designed for thousands of plug / unplug cycles and for the
              bend / drag / step-on lifecycle of a desk-side cord.
            </li>
          </ul>
          <p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="120" y="504" fill="#E5E7EB" fontSize="10.5" fontFamily="system-ui">
              Both rated to same Category. Channel = 90 m solid permanent link + 10 m stranded cord
              allowance combined.
            </text>
            <text x="60" y="522" fill="#9CA3AF" fontSize="9.5" fontFamily="system-ui">
              ANSI/TIA-568.2-E · BS EN 50173-1 · ISO/IEC 11801-1 — engineered against the per-metre
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              stranded-conductor cable rated to the Category of the channel. The combined length of
              all cords in the channel shall not exceed 10 m. Solid-conductor cable shall be used
              for the permanent link, terminated to insulation displacement connection (IDC)
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              typically a small plastic guard over the standard tab plus a secondary push-to-release
              action — that prevents the plug being pulled out of the panel by accidental tug or by
              the weight of a packed cable bundle above. On 1U-per-24-port and denser panels, the
              bundle weight is non-trivial; a non-locking plug with a fatigued tab can pull out
              under that weight, especially when a technician is working in the loom and
              inadvertently shifts it. The outage looks like a switch fault — but the cord is the
              cause.
            </li>
            <li>
              <strong>Snagless boot.</strong> The moulded sleeve over the back of the RJ45 plug that
              covers the locking tab. When a technician withdraws one cord from a packed panel, the
              cord is drawn through the bundle past adjacent cords; without a snagless boot, the
              locking tab catches on adjacent tabs — either snapping the tab (failing the cord) or
              unseating adjacent plugs (causing intermittent link failures). With snagless boots,
              the cord slides past without catching.
            </li>
            <li>
          ...
          <p>
            ...
            CommScope GS8E, Belden 10GX, Hellermann Tyton). The premium over the cheapest non-rated
            cord cable is small — typically £2-£5 per cord on a £10-£20 cord — and the operational
            cost savings from preventing pulled-out / snagged / snapped cords on a dense panel pay
            back within months. Specify all three by default on Cat6A cord populations.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              panel. Lives in the comms rack, dressed into looms above the panel, exposed to bundle
              weight and a 90-degree bend at the panel face on 1U hardware. Optimisations: locking
              plugs (against bundle weight), snagless boots (against neighbour-cord snags during
              moves), short rack-friendly lengths (0.5 m for inside-rack patches, 1-2 m for
            ...
            <li>
              ...
              dragged when laptops move, plugged and unplugged when the user travels. Optimisations:
              flex-rated cord cable (against bend / flex fatigue), snagless boots (against the user
              {"'"}s coat sleeve / bag strap snagging the tab), user-friendly longer lengths (1 / 2
              / 3 / 5 m to accommodate desk geometries). Locking plugs are typically not used (so
              the user can re-arrange the desk).
            </li>
          </ul>
          <p>
            Most major manufacturers offer both as separate SKUs. The cost differential is small;
            the deployment quality difference is large. Specify both in the project plan, order the
            right quantities, label the boxes clearly so the install crew uses the right cord in the
            right place.
          </p>
        </ConceptBlock>
        ...
        <ContentEyebrow>The chain of evidence — every component rated to the Class</ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              permanent link to Class EA, then patches with cheap Cat5e cords from a tool merchant.
              The channel test (which includes the cords) returns Class D performance because the
              cords are the worst component. The 10G service the building was specified for fails to
              negotiate. Cause: cord choice.
            </li>
            <li>
              <strong>
              ...
              tabs, and intermittent links. Cause: mechanical features — locking plugs and snagless
              boots — were not specified.
            </li>
            <li>
              <strong>
              ...
              short for desks, cable management arms jammed with surplus cord. Cause: equipment cord
              vs work-area cord SKUs were not specified separately.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              Panduit horizontal cable, premium Cat6A keystones, premium 1U-per-24-port Cat6A patch
              panels — each line-itemed in the spec. At the bottom of the BOQ is "patch cords, 250
              off, 2 m". The procurement team picks the cheapest Cat5e cords from a wholesaler on
              the basis that "they are just patch cords". The permanent link certifies to Class EA.
              The end-to-end channel certifies to Class D. The 10G service the building was paid for
              fails to deploy. The client is angry. The cord saving was £400; the remediation costs
              £15,000.
            </>
          }
          doInstead={
        ...
        <Scenario
          ...
          whatToDo={
            <>
              Three points to communicate. (1) The Cat6A horizontal infrastructure was specified and
              certified for 10G services per Class EA. Patching with Cat5e cords downgrades the
              channel to Class D — 1G performance, no 10G capability. The tenant{"'"}s own cords
              undo the building investment. (2) Some Cat5e cords are additionally not rated for
              sustained PoE (Type 3 / Type 4) in continuous bundles per BS 7671 §716; using them
              with PoE access points or PoE lighting may produce thermal issues. (3) The recommended
              action is to supply Cat6A flex-rated cords with snagless boots (and locking plugs on
              the rack side) for the duration of the tenancy, channel-certify the resulting full
              channel to Class EA with the new cords in place, and archive the result. The cost is
              small; the protection of the building investment and the tenant
          ...
          whyItMatters={
            <>
              ...
              multi-tenant commercial buildings. The contractor signed off Class EA on the permanent
              link; two years later, a new tenant patches with Cat5e cords from a drawer; the
              building no longer delivers what it was specified for. The cord chain is part of the
              channel chain — and the cord chain changes whenever tenants change. Documenting the
              cord specification in the BS EN 50174-1 / TIA-606-D administration record, and
              re-certifying the channel whenever the cord population materially changes, are the
              disciplines that protect the long-life value proposition of the original investment.
            </>
          }
        />
