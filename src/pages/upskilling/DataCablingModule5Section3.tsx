...
const DataCablingModule5Section3 = () => {
  useSEO({
    title: "Patch Cord Design and Performance | Data Cabling Module 5.3",
    description: "Understanding patch cord specifications, design principles, and performance criteria for professional network installations."
  });
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/upskilling/data-cabling-module-5-section-4">
              Next Section
