          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent border border-white/10">
                ...
                <p className="text-white text-xs">30-50% energy savings</p>
              </div>
              <div className="p-3 rounded bg-transparent border border-white/10">
                <p className="font-medium text-white mb-1">Meeting Rooms</p>
                <p className="text-white text-xs">40-70% energy savings</p>
              </div>
              <div className="p-3 rounded bg-transparent border border-white/10">
                <p className="font-medium text-white mb-1">Corridors</p>
                <p className="text-white text-xs">50-80% energy savings</p>
              </div>
            </div>
