    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The actual numbers behind a Class certification — frequency response, insertion loss, NEXT
          / PSNEXT / PSANEXT, ACR-F, return loss, propagation delay and delay skew — and how
          sustained PoE current affects rated channel performance under BS 7671:2018+A4:2026
          §716.523.1.101.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              <strong>Wire-map.</strong> Are all 8 conductors connected end-to-end correctly, in the
              right pin-pair groupings? A failed wire-map terminates testing — fix first.
            </li>
            <li>
              <strong>Length.</strong> Time-domain measurement of cable length per pair (separately,
              because pairs have slightly different physical lengths). Used to check the 90 m
              permanent link / 100 m channel rule.
            </li>
            <li>
            ...
            <li>
              <strong>PSANEXT (power-sum alien NEXT).</strong> Coupling from ADJACENT cables in the
              bundle. Cat6A-and-above only. Erodes in hot PoE bundles — the case for shielded
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <path d="M 160 352 Q 240 320, 320 216" fill="none" stroke="#A855F7" strokeWidth="2.2" />
            <circle cx="320" cy="216" r="5" fill="#A855F7" />

            {/* Class E ends at 250 MHz (x=480), ~36 dB at 250 MHz (y~144) */}
            <path d="M 160 352 Q 280 304, 480 144" fill="none" stroke="#3B82F6" strokeWidth="2.2" />
            <circle cx="480" cy="144" r="5" fill="#3B82F6" />

            {/* Class EA ends at 500 MHz (x=640), ~36 dB at 500 MHz (y~144) — emphasised */}
            <path d="M 160 352 Q 320 296, 640 144" fill="none" stroke="#EAB308" strokeWidth="2.8" />
            <circle cx="640" cy="144" r="6" fill="#EAB308" />

            {/* Class I/II ends at 2000 MHz (x=840), ~24 dB at 2000 MHz (30 m only — y~216) */}
            <path d="M 160 352 Q 400 280, 840 216" fill="none" stroke="#22C55E" strokeWidth="2.2" />
            ...
            <text x="358" y="572" fill="#9CA3AF" fontSize="10" fontFamily="system-ui">
              Curves indicate Class insertion-loss limits — actual cable performance must stay below
              the line.
            </text>
          </svg>
        </div>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Balanced twisted-pair cabling channel performance shall be verified by measurement of
              insertion loss, NEXT, PSNEXT, ACR-F, PSACR-F, return loss, propagation delay, delay
              skew, DC resistance and DC resistance unbalance, and (for Cat6A and above) PSANEXT and
              PSAACR-F, against the per-frequency limits specified for the relevant Category. Field
              test instruments shall comply with ANSI/TIA-1152-A Level III, IIIe, IV or V depending
              on the Category being verified.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            ...
            <li>
              ...
              into the pair under test. The parameter that 1000BASE-T / 10GBASE-T need because they
              use all four pairs simultaneously and each pair sees combined disturbance from all
            ...
            <li>
              ...
              ratio, far end) which normalises FEXT for the channel attenuation — gives the headline
              far-end SNR margin.
            </li>
            <li>
            ...
            <li>
              <strong>PSANEXT (power-sum alien NEXT).</strong> Coupling from ADJACENT CABLES in the
              bundle into the pair under test. Cat6A-and-above only — Cat6A is the first Category to
              specify alien crosstalk, because 10GBASE-T was the first Ethernet to be sensitive to
              it.
            </li>
            <li>
          ...
          <p>
            ...
            cable construction (separators, conductor geometry, possible foils) is engineered around
            them. Hot PoE bundles compound the problem — temperature rise erodes alien-crosstalk
            margin first.
          </p>
        </ConceptBlock>
        ...
        <ContentEyebrow>How PoE current actually affects rated channel performance</ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              <strong>Per-conductor current.</strong> IEEE 802.3bt Type 4 PSE = 90 W max, PD = 71.3
              W max, delivered over 4 pairs. Worst-case per-conductor steady-state current is around
              300-650 mA depending on cable loop resistance and PSE / PD voltage — always &lt; the
              750 mA BS 7671 §716.523.2.101 hard cap.
            </li>
            <li>
            ...
            <li>
              ...
              %/°C. Dielectric losses in the insulation rise non-linearly with temperature too. Both
              raise insertion loss.
            </li>
            <li>
              <strong>Channel parameters degrade.</strong> Insertion loss climbs at every frequency.
              ACR-F margin shrinks. PSANEXT margin shrinks (alien-crosstalk limits move closer to
              the measured value). Marginal channels can drop link under thermal load.
            </li>
            <li>
              <strong>Standards-based responses.</strong> §716.523.2.101 caps current at 750 mA per
              conductor; §716.523.1.101 NOTE 2 references PD CLC/TR 50174-99-1 + BS ISO/IEC 14763-2
              + ISO/IEC TS 29125 for bundle planning; TIA TSB-184-A gives the practical bundle
              de-rating curves; LP-rated (limited-power) cables address the thermal spec; 23 AWG
              cable carries less heat per amp than 24 AWG; screened constructions restore
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Wire-map.</strong> Pass = all 8 conductors in correct pin-pair groupings. Fail
              = re-terminate, retest.
            </li>
            <li>
            ...
            <li>
              <strong>ACR-F / PSACR-F.</strong> Far-end SNR margin. Sensitive to cable construction
              quality and to bundle coupling.
            </li>
            <li>
              <strong>PSANEXT / PSAACR-F.</strong> Cat6A-and-above only. Sensitive to bundle density
              and to PoE thermal load. Marginal results here often indicate bundles are too tight
              for the PoE load.
            </li>
            <li>
              <strong>Return loss.</strong> Impedance match. Marginal results here are almost always
              workmanship — sharp bend, rough crimp, mismatched patch lead.
            </li>
            <li>
              <strong>Propagation delay + delay skew.</strong> Delay should match length; delay skew
              should be well under 50 ns / 100 m. Delay-skew issues are usually cable-quality
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              <AmendmentBadge regs={['716.523.1.101']} edition="A4:2026" /> Design current shall not
              exceed the BS EN 50173-1 limit. NOTE 1 = the explicit temperature-vs-insertion-loss
              link. NOTE 2 = bundle planning references (PD CLC/TR 50174-99-1, BS ISO/IEC 14763-2,
              ISO/IEC TS 29125).
            </li>
            <li>
              <strong>§716.523.2.101 — 750 mA per conductor hard cap.</strong>{' '}
              <AmendmentBadge regs={['716.523.2.101']} edition="A4:2026" /> The absolute regulatory
              ceiling. Per CONDUCTOR — not per pair, not per cable. The bundle thermal model in
              §716.523.1.101 NOTE 2 has to deliver compliance with this number under all foreseeable
              bundle / load conditions.
            </li>
            <li>
              ...
              disconnection under load is foreseen) meet BS EN 60512-9-3 endurance testing. Covered
              fully in M2S4.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              presents a one-page summary that says &quot;220/220 PASS&quot;. The client signs off.
              Fifteen months later, after the building loads up Type 4 PoE++ for ceiling APs and PoE
              lighting, intermittent link drops start happening on a handful of links. Investigation
              shows those links had &lt; 1 dB margin at 500 MHz from day one — a workmanship issue
              in termination that survived the static test but degrades under thermal load.
            </>
          }
          doInstead={
            <>
              At handover, review every link&apos;s margin at the top test frequency for the Class.
              For Class EA, that&apos;s 500 MHz. For Class I/II, 2000 MHz. Any link with &lt; 4 dB
              margin on insertion loss / NEXT / PSNEXT / ACR-F / return loss at the top frequency is
              a re-termination candidate. Pull the worst-end connector, re-terminate to BS EN
              50174-2 / TIA-568.2-E practice (untwisted-pair length ≤ 13 mm at the IDC), retest.
              Hand over not just PASS but COMFORTABLE PASS — the file shows the margin and the
              auditor can see it.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              still air at typical office ambient. The build standard wants 10GBASE-T to every AP at
              handover and confirmed 5-year reliability.
            </>
          }
          whatToDo={
            <>
              Bundle thermal calc per TIA TSB-184-A: 96 cables × ~500 mA per conductor average load
              × bundle geometry → centre-of-bundle temperature rise estimated. Compare to BS 7671
              §716.523.2.101 hard cap of 750 mA per conductor — comfortable. Compare to cable
              ...
              4 dB margin at 500 MHz. Periodic spot re-tests at 6 / 12 months under live PoE load to
              confirm no margin drift.
            </>
          }
          whyItMatters={
            <>
              Class certification at handover is a static test. PoE thermal load is dynamic and
              ramps up after handover. The contractor who only certifies the cold cable hands over a
              project that may degrade after the building loads up. The professional discipline
              ...
              post-load spot retests. That is a 5-year reliability deliverable — not just a day-one
              PASS.
            </>
          }
        />
