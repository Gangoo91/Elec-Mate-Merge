...
const FireAlarmModule5SectionTemplate = ({
  ...
  const faqs = [
    { q: `What are the key requirements covered in ${title}?`, a: intro },
    {
      ...
      a: 'All fire alarm system wiring and installation in the UK must comply with BS 5839-1 for fire detection systems and BS 7671 for electrical installation requirements. This section covers specific requirements that support compliant installations.',
    },
    {
      q: 'What documentation is required?',
      a: 'Full design documentation, wiring diagrams, commissioning records, and handover certificates are required. Keep records for maintenance and future modifications.',
    },
  ];
          ...
          <div className="text-center mb-8 sm:mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-elec-yellow/10 border border-elec-yellow/20 mb-4">
              ...
              <span className="text-elec-yellow text-sm font-medium">
                Module 5 • Section {sectionNumber}
              </span>
            </div>
