  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/electrician/upskilling/data-cabling-module-6"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The standards stack for any UK building or campus structured-cabling job. BS EN 50173
          series (-1 general, -2 offices, -3 industrial, -4 residential, -5 data centres, -6
          distributed buildings). BS EN 50174 series (-1 specification & QA, -2 inside buildings, -3
          outside buildings). BS EN 50310 ICT bonding. BS EN 50346 testing. BS 6701
          customer-premises wiring. And — sat alongside — BS 7671:2018+A4:2026 §716, §545 (NEW in
          A4:2026), §444 and §528, with verbatim clauses for the 2 m × 2 m bonding mesh, the
          metal-free-fibre preference between buildings, and the new ICT functional-earthing rules.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              Defines the six-zone topology, the channel / permanent-link model, the Classes (D / E
              / EA / F / FA / I / II), the connector and cable types. Named verbatim in BS
            ...
            <li>
              <strong>BS EN 50173-3 — Industrial premises.</strong> MICE classification (Mechanical,
              Ingress, Climatic, Electromagnetic), ruggedised cable jackets, sealed connectors,
              higher outlet protection.
            </li>
            <li>
              <strong>BS EN 50173-4 — Residential / single-tenant homes.</strong> Outlet density and
              topology for residential / SOHO. UK residential additionally falls under BS 6701 for
              the carrier-side wiring.
            </li>
            <li>
              <strong>BS EN 50173-5 — Data centres.</strong> Main / horizontal / equipment / zone
              distribution areas; data-centre-specific topology. Sits alongside BS EN 50600 (general
              data-centre infrastructure).
            </li>
            <li>
              <strong>BS EN 50173-6 — Distributed building services.</strong> Cabling for
              distributed building services — building automation, access control, IoT. Aligns with
              the {`"`}smart building{`"`} specs that drive PoE++ deployments.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            installation — Testing of installed cabling. It is the EN equivalent of ANSI/TIA-1152-A.
            Test instrument accuracy, parameter coverage, link / channel modes — all defined here.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              50174-1: Information technology — Cabling installation: Installation specification and
              quality assurance; (b) BS EN 50174-2: Information technology — Cabling installation:
              Installation planning and practices inside buildings; (c) BS EN 50310:
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>§444.1.1 — Star network.</strong> Small dwellings, small commercial buildings;
              equipment not interconnected by signal cables. Single-tier topology.
            </li>
            <li>
              <strong>§444.1.2 — Multiple meshed bonding star network.</strong> Small installations
              with several small groups of communicating equipment. A star at the building level
              with mesh networks at each group.
            </li>
            <li>
              <strong>§444.1.3 — Common meshed bonding star network.</strong> ICT-dense
              installations: PABX, centralised data processing, modern comms-rich offices. Mesh size
              limit 2 m × 2 m maximum where susceptible equipment is installed. BS EN 50310
              referenced for design detail.
            </li>
            <li>
              <strong>§444.1.4 — Bonding ring conductor.</strong> Whole-floor or whole-building
              distribution. Copper ring (preferably bare or insulated copper, accessible everywhere)
              on a cable tray, conduit, or surface mount.
            </li>
          </ul>
          <p>
            The choice scales with ICT density. A single-residence build lands on §444.1.1 (star). A
            50-person office lands on §444.1.3 or §444.1.4. A data centre lands on §444.1.3 with the
            full BS EN 50310 detail.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              communicating equipment corresponding to critical applications; see Figure A444.3. It
              is suitable for protection of private automatic branch exchange equipment (PABX) and
              centralized data processing systems. A meshed equipotential bonding network is
              ...
              the installation to be protected and should be in accordance with the recommendations
              of BS EN 50310. Where concerns exist, the mesh size should be adapted to the
              dimensions of the installation to be protected, but should not exceed 2 m × 2 m in
              areas where equipment susceptible to electromagnetic environmental interferences is
              installed.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              optical fibre cables or other non-conducting systems are preferred for signal and data
              transmission, for example, microwave signal transformer for isolation in accordance
              with BS EN 61558-2-1, 2-4, 2-6, 2-15 and either BS EN 60950-1 or BS EN IEC 62368-1.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              bonding conductors are required: insulated for the highest expected voltage, installed
              separately from the protective conductor, connected to the MET only once. If multiple
              functional bonding conductors are present, an MFET (Main Functional Earthing Terminal)
              is installed for ease of connection.
            </li>
            <li>
            ...
            <li>
              <strong>§545.1.3 — Identification.</strong> Functional earthing and bonding conductors
              are identified by colour or alphanumeric designation per Table 51.
            </li>
            <li>
              <strong>§545.1.4 — Continuity.</strong> Electrical continuity rules of §543.3 (except
              .3.5) apply. If part of equipment can be removed, the functional bonding for the
              remaining equipment must NOT be disconnected.
            </li>
            <li>
          ...
          <p>
            ...
            equipotential bonding ring conductors — the optional ring-form MET / MFET that lets ICT
            equipment connect to the bonding system by the shortest practicable route.
        ...
        <RegsCallout
          ...
          clause={
            <>
              Except where BS EN 50310 applies, the following minimum cross-sectional area shall be
              applied for functional earthing conductors and functional bonding conductors: (a) 2.5
              mm² copper or 16 mm² aluminium, if protection against mechanical damage is provided.
              (b) 4 mm² copper or 16 mm² aluminium, if protection against mechanical damage is not
              provided. NOTE 1: BS EN 50310 requires copper conductors.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              protective equipotential bonding system in accordance with Section 444, the functional
              bonding conductors shall be: (a) insulated for the highest voltage expected between
              the functional bonding system and Earth and/or between the functional bonding system
              and simultaneously accessible exposed-conductive-parts; (b) installed separately from
              the protective conductor; (c) connected to the main earthing terminal (MET) only once.
              If there are multiple functional bonding conductors present in the electrical
              installation, a separate main functional earthing terminal (MFET) shall be installed
              for ease of connection for these conductors. The MFET shall be connected to the MET
              only once.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>CDM 2015.</strong> Construction Design and Management Regulations — duties on
              principal contractor, designer, client.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              Two buildings on a campus, each with its own MET, are linked by 50 m of buried Cat 6A
              in armoured duct {`"`}because copper is cheaper than fibre{`"`}. The buildings work
              fine in normal conditions. A nearby lightning strike induces a surge between the two
              earth potentials. The surge propagates along the copper, blowing the switch ports at
              both ends. Investigation shows the install violated BS 7671 §444.4.9 — metal-free
              optical fibre was the preferred medium and was disregarded.
            </>
          }
          doInstead={
            <>
              ...
              non-metallic duct or direct-buried per BS EN 50174-3. If physical damage protection is
              needed, use rodent-resistant non-metallic armour. Inter-building copper Ethernet is a
              §444.4.9 non-conformance and a lightning disaster waiting to happen.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              5 m floor into 2 m × 2 m cells, all bonded at every crossing. Each rack bonded by a
              short conductor (2.5 mm² Cu min — BS 7671 §544 for protective + §545 for functional
              duty) to the nearest mesh intersection. Run an MFET (new under §545.2) for the
              functional bonding conductors; connect the MFET once to the building MET (§545.1.1
              verbatim). Apply BS EN 50310 detailing throughout. Identify functional earthing per
              Table 51 (§545.1.3).
            </>
          }
          whyItMatters={
            <>
              The 2 m × 2 m mesh limit is the headline §444.1.3 number that auditors will check on a
              high-density ICT room. Without the internal mesh, the peripheral bond alone gives a 4
              m × 5 m loop area — well above the limit — and common-mode currents will develop
