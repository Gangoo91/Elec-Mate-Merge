...
const DataCablingModule6Section3 = () => {
  useSEO({
    title: "Building and Campus Standards | Data Cabling Module 6.3",
    description: "Learn structured cabling standards for building and campus infrastructure including telecommunications rooms, pathways, and backbone design."
  });
      ...
      <div className="border-b border-white/10 sticky top-0 z-50 bg-[#1a1a1a]/95 backdrop-blur-sm">
        <div className="px-4 sm:px-6 py-2">
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/upskilling/data-cabling-module-6">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/upskilling/data-cabling-module-6-section-2">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous Section
            </Link>
          </Button>
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/upskilling/data-cabling-module-6-section-4">
              Next Section
