...
const IndustrialElectricalModule4Section3: React.FC = () => {
  useSEO({
    ...
    description:
      'Learn about industrial sensor and actuator integration including proximity sensors, temperature measurement, pressure sensing, solenoid valves, encoders, and EMC considerations for industrial electrical systems.',
    keywords:
      'proximity sensors, inductive sensors, capacitive sensors, photoelectric sensors, RTD, thermocouple, PT100, solenoid valves, encoders, EMC, industrial sensors, actuators',
  });
  ...
  const quickCheckQuestions = [
    ...
    },
    {
      ...
      correctIndex: 2,
      explanation:
        '3-wire sensors have separate power supply lines (+ and -) and a dedicated signal output line. This provides more reliable switching, allows for both PNP and NPN configurations, and prevents voltage drops from affecting sensor operation.',
    },
    {
      id: 'qc-sensor-3',
      question:
        'An incremental encoder with 1024 PPR resolution using quadrature decoding provides how many counts per revolution?',
      options: ['1024 counts', '2048 counts', '4096 counts', '512 counts'],
      correctIndex: 2,
      explanation:
        'Quadrature decoding (x4 decoding) counts all rising and falling edges of both A and B channels. This multiplies the base PPR by 4, so 1024 PPR × 4 = 4096 counts per revolution, providing higher resolution for position feedback.',
    },
  ];
  ...
  const quizQuestions = [
    {
      question:
        'Which type of proximity sensor is best suited for detecting non-metallic objects like plastic bottles?',
      options: [
    ...
    {
      question:
        'What is the typical sensing range relationship between ferrous and non-ferrous metals for inductive sensors?',
      options: [
  ...
  const faqItems = [
    ...
    {
      question:
        'Why does my proximity sensor have a reduced sensing range for aluminum compared to steel?',
      answer:
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Master the selection, wiring, and integration of industrial sensors and actuators for
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">
            Proximity sensors detect the presence of objects without physical contact, making them
            essential for position detection, counting, and safety applications in industrial
            automation.
          </p>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-foreground">Principle:</strong> Detect metallic objects
                  via electromagnetic field disturbance from eddy currents
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Sensing Range:</strong> 1mm to 60mm typical,
                  depends on target size and material
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Correction Factors:</strong> Steel = 1.0,
                  Stainless Steel = 0.7, Brass = 0.5, Aluminum = 0.4, Copper = 0.35
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Mounting:</strong> Flush (shielded) for close
                  metal proximity, Non-flush (unshielded) for longer range
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Principle:</strong> Detect changes in
                  capacitance caused by any material (metal, plastic, liquid, powder)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Applications:</strong> Level detection through
                  non-metallic tank walls, plastic/glass detection
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Sensitivity:</strong> Adjustable potentiometer
              ...
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-foreground">Limitation:</strong> Sensitive to humidity,
                  condensation, and material buildup on sensing face
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Through-Beam:</strong> Separate
                  emitter/receiver, longest range (up to 100m), detects any opaque object
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Retro-Reflective:</strong> Emitter/receiver in
                  one housing, uses reflector, range up to 15m
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Diffuse:</strong> Detects light reflected from
                  target itself, range 0.1-2m, background suppression available
                </span>
              </li>
              <li className="flex items-start gap-2">
                <Info className="w-4 h-4 text-blue-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Light Sources:</strong> Red LED (visible
                  alignment), infrared (longer range), laser (precise small object detection)
                </span>
              </li>
            </ul>
          </div>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">
            Accurate temperature measurement is critical for process control, equipment protection,
            and product quality. Understanding sensor characteristics helps select the right type
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <p className="text-sm text-muted-foreground mb-3">
              RTDs measure temperature through the predictable change in electrical resistance of a
              pure metal element.
            </p>
            ...
            <div className="bg-background/50 rounded p-3 mb-3">
              ...
              <p className="text-muted-foreground text-xs mt-2">
                Temperature coefficient alpha = 0.00385 ohms/ohms/°C (European standard IEC 60751)
              </p>
            </div>

            <ul className="space-y-1 text-sm text-muted-foreground">
              <li>
                - <strong className="text-foreground">Range:</strong> -200°C to +850°C
              </li>
              <li>
                - <strong className="text-foreground">Accuracy:</strong> Class A (±0.15°C at 0°C),
                Class B (±0.3°C at 0°C)
              </li>
              <li>
                - <strong className="text-foreground">Response Time:</strong> Slower than
                thermocouples (seconds)
              </li>
              <li>
                - <strong className="text-foreground">Wiring:</strong> 2-wire, 3-wire, or 4-wire
                connections
              </li>
            </ul>
          </div>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Thermocouples generate a small voltage (millivolts) proportional to temperature
              difference between the measuring junction and reference junction (Seebeck effect).
            </p>
            ...
            <div className="bg-amber-500/10 border border-amber-500/20 rounded p-3">
              ...
              <p className="text-muted-foreground text-sm mt-1">
                Thermocouple extension wire must match the thermocouple type. Using standard copper
                wire creates additional junctions and measurement errors. Extension wire is
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">High Sensitivity:</strong> Large resistance
                  change per degree (good for narrow range precision)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Typical Range:</strong> -40°C to +150°C
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Applications:</strong> HVAC, motor winding
              ...
              <li className="flex items-start gap-2">
                <AlertTriangle className="w-4 h-4 text-amber-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Non-Linear:</strong> Requires linearisation in
                  software or hardware for accurate readings
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <div className="grid md:grid-cols-3 gap-4 text-sm">
              <div className="bg-background/50 rounded p-3">
                ...
                <p className="text-muted-foreground">
                  Measured relative to atmospheric pressure. Most common for industrial
                  applications. Zero at atmosphere.
                </p>
              </div>
              <div className="bg-background/50 rounded p-3">
                <p className="text-elec-yellow font-medium mb-2">Absolute Pressure</p>
                <p className="text-muted-foreground">
                  Measured relative to perfect vacuum. Used for altitude, vacuum systems. Zero at
                  vacuum.
                </p>
              </div>
              <div className="bg-background/50 rounded p-3">
                ...
                <p className="text-muted-foreground">
                  Measures difference between two pressure points. Used for flow, filter monitoring,
                  level.
                </p>
              </div>
            </div>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Strain Gauge:</strong> Piezoresistive element
                  on diaphragm, most common industrial type
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Output Signals:</strong> 4-20mA (most common),
                  0-10V, 0-5V, digital protocols
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Accuracy:</strong> Typically 0.25% to 0.5% of
                  full scale
                </span>
              </li>
              <li className="flex items-start gap-2">
                <Info className="w-4 h-4 text-blue-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">4-20mA Advantage:</strong> 4mA = zero allows
                  wire break detection (0mA indicates fault)
                </span>
              </li>
            </ul>
          </div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 text-muted-foreground">
                  Pressure at bottom of tank proportional to liquid height. Simple, reliable for
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 text-muted-foreground">
                  Non-contact measurement using sound wave reflection time. Good for corrosive
                  liquids, solids.
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 text-muted-foreground">
                  Microwave reflection, unaffected by vapour, temperature, pressure. Higher cost,
                  high accuracy.
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 text-muted-foreground">
                  Probe measures capacitance change with level. Works with conductive and
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 text-muted-foreground">
                  Simple on/off level detection. Low cost, reliable for point level applications.
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <div className="space-y-4 text-sm">
              <div>
                ...
                <p className="text-muted-foreground">
                  Solenoid plunger directly opens/closes the orifice. Works at zero pressure
                  differential. Limited to smaller valve sizes due to force requirements.
                </p>
              </div>
              <div>
                <p className="text-elec-yellow font-medium mb-2">Pilot Operated (Indirect)</p>
                <p className="text-muted-foreground">
                  Solenoid controls small pilot valve that uses line pressure to operate main valve.
                  Requires minimum pressure differential. Larger flow capacity with smaller
                  solenoid.
                </p>
              </div>
              <div>
                ...
                <p className="text-muted-foreground">
                  Combines both principles. Works from zero to full pressure. Used when pressure may
                  vary significantly.
                </p>
              </div>
            </div>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Single-Acting:</strong> Air pressure extends
                  OR retracts, spring returns. Simpler, less air consumption.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Double-Acting:</strong> Air pressure for both
                  extend and retract. More force, precise control both directions.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Rodless:</strong> Carriage moves along
                  cylinder body. Long strokes, compact mounting, no rod protrusion.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Guided:</strong> Built-in linear guide for
                  side loads. Prevents piston rod bending.
                </span>
              </li>
            </ul>
            ...
            <div className="bg-background/50 rounded p-3 mt-3">
              ...
              <p className="text-muted-foreground text-sm mt-1">
                Force (N) = Pressure (Pa) x Piston Area (m²)
                <br />
          ...
          <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-4">
            ...
            <p className="text-muted-foreground text-sm mt-2">
              Always install a flyback diode (DC) or RC snubber (AC) across solenoid coils to
              suppress inductive voltage spikes when de-energised. This protects PLC outputs, relay
              contacts, and nearby electronics from damage. Many industrial solenoids include
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <p className="text-sm text-muted-foreground mb-3">
              Generate pulses proportional to rotation. Require counting electronics and reference
              (homing) after power-up.
            </p>
            ...
            <div className="bg-background/50 rounded p-3">
              ...
              <p className="text-muted-foreground text-sm">
                Encoder: 1000 PPR, X4 decoding = 4000 counts/revolution
                <br />
                Angular resolution: 360° / 4000 = 0.09°/count
                <br />
            ...
            <p className="text-sm text-muted-foreground mt-3">
              <strong className="text-foreground">Index Pulse (Z channel):</strong> Single pulse per
              revolution for absolute reference point.
            </p>
          </div>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Single-Turn:</strong> Unique code for each
                  position within one revolution (e.g., 12-bit = 4096 positions)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Multi-Turn:</strong> Tracks complete
                  revolutions plus position. Battery-backed or Wiegand wire powered.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">No Homing Required:</strong> Position known
              ...
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Output Types:</strong> Parallel binary, Gray
                  code, SSI (Synchronous Serial Interface), fieldbus
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Rotary:</strong> Single or multi-turn,
                  resistive element with wiper contact
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Linear:</strong> Slide potentiometers for
              ...
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Advantages:</strong> Absolute position, simple
                  interface, low cost
                </span>
              </li>
              <li className="flex items-start gap-2">
                <AlertTriangle className="w-4 h-4 text-amber-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Limitations:</strong> Wear over time, noise in
                  output, limited resolution compared to encoders
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <p className="text-muted-foreground">
                  Linear Variable Differential Transformer. AC excitation, excellent resolution,
                  non-contact core movement. Used for precision measurement.
                </p>
              </div>
              <div>
                <p className="text-elec-yellow font-medium mb-2">Magnetostrictive</p>
                <p className="text-muted-foreground">
                  Position magnet on moving element, waveguide in housing. High accuracy, long
                  strokes, absolute position. Common for hydraulic cylinders.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground">
            Proper wiring practices and electromagnetic compatibility (EMC) measures are essential
            for reliable sensor operation in electrically noisy industrial environments.
          </p>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Shielded Cable:</strong> Use for analogue
                  signals (4-20mA, 0-10V), encoder signals, and long digital runs
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Twisted Pair:</strong> Reduces magnetic field
                  pickup. Use for differential signals and long runs.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Cable Ratings:</strong> Oil-resistant (for
                  machine tools), flexible (for moving applications), UV-resistant (outdoors)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Wire Gauge:</strong> Consider voltage drop for
                  long runs. 4-20mA tolerates long runs; voltage signals need heavier gauge.
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Ferrite Cores:</strong> Clamp-on or wound
                  through. Attenuates high-frequency noise. Place near noise source.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Line Filters:</strong> Install on VFD inputs,
                  reduce conducted emissions back to supply.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Surge Suppressors:</strong> MOVs or TVS diodes
              ...
              <li className="flex items-start gap-2">
                <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                <span>
                  <strong className="text-foreground">Isolation:</strong> Optocouplers, isolation
                  amplifiers for galvanic separation between circuits.
                </span>
              </li>
            </ul>
          </div>
        ...
        <section className="bg-gradient-to-br from-elec-yellow/10 to-elec-yellow/5 rounded-lg p-6 border border-elec-yellow/30">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-background/50 rounded-lg p-4">
              <h3 className="font-semibold text-foreground mb-3 border-b border-white/10 pb-2">
                Sensor Selection
              </h3>
