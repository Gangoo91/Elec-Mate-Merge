                    ...
                    <div className="flex justify-center">
                      <Badge 
                        ...
                        className={module.id === "mock-exam" 
                          ? "bg-yellow-600/40 text-yellow-400 hover:bg-green-600/50 font-bold text-xs px-3 py-1 border-0"
                          : "bg-yellow-400/10 text-yellow-400 hover:bg-yellow-400/10 font-bold text-xs px-3 py-1 border-0"
                        }
                      >
