...
const DESCRIPTION =
  'Learn about high voltage and low voltage separation, transformer principles, substation layouts, and safety requirements in UK industrial electrical systems. Covers 11kV/400V systems, DNO responsibilities, and Electricity at Work Regulations 1989.';

const quickCheckQuestions = [
  {
    id: 'hvlv-q1',
    question:
      'In the UK, at what voltage level does a supply become classified as High Voltage (HV)?',
    options: ['Above 230V AC', 'Above 400V AC', 'Above 1000V AC', 'Above 3300V AC'],
    correctIndex: 2,
    explanation:
      'According to UK regulations and BS 7671, High Voltage (HV) is defined as any voltage exceeding 1000V AC or 1500V DC. This threshold determines the additional safety precautions, authorisation requirements, and equipment specifications needed for working with HV systems.',
  },
  {
    id: 'hvlv-q2',
    ...
    correctIndex: 1,
    explanation:
      'Transformer oil serves two critical functions: electrical insulation between windings and the tank, and heat dissipation through natural or forced circulation. The oil absorbs heat from the windings and core, transferring it to the tank walls or external radiators for cooling.',
  },
  {
    id: 'hvlv-q3',
    question:
      'Who is typically responsible for maintaining the 11kV network up to and including the transformer in a standard commercial installation?',
    options: [
      'The building owner',
...
const quizQuestions = [
  {
    id: 1,
    question:
      'What is the standard distribution voltage used by UK DNOs to supply industrial and commercial premises?',
    options: ['3.3kV', '6.6kV', '11kV', '33kV'],
    correctAnswer: 2,
    explanation:
      '11kV is the standard distribution voltage used by UK DNOs for industrial and commercial supplies.',
  },
  {
    id: 2,
    question:
  ...
  },
  {
    id: 4,
    question:
      'Under the Electricity at Work Regulations 1989, which regulation specifically addresses working on or near live conductors?',
    options: ['Regulation 4', 'Regulation 10', 'Regulation 14', 'Regulation 16'],
    correctAnswer: 2,
    explanation:
      'Regulation 14 of the Electricity at Work Regulations 1989 specifically addresses working on or near live conductors.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'CT stands for Current Transformer, used in metering arrangements to step down high currents to measurable levels.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'A typical RMU has two switch disconnectors for the ring and one fused switch or circuit breaker for the transformer tee-off.',
  },
  {
    id: 7,
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>HV Definition:</strong> &gt;1000V AC or &gt;1500V DC
              </li>
              <li>
                <strong>Standard HV:</strong> 11kV distribution network
              </li>
              <li>
                <strong>Standard LV:</strong> 400V three-phase / 230V single-phase
              </li>
              <li>
                <strong>Safety:</strong> Strict access controls and clearances required
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Transformers:</strong> Oil-filled or dry-type designs
              </li>
              <li>
                <strong>DNO boundary:</strong> Defines responsibility split
              </li>
              <li>
                <strong>11kV clearance:</strong> 3.0m for unqualified persons
              </li>
              <li>
                <strong>Regulations:</strong> EAW 1989 governs all HV work
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p>
              The <strong>11kV distribution network</strong> is the most common HV system you will
              encounter in industrial settings. DNOs use this voltage level to efficiently
              distribute power across their network before stepping down to 400V for final
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white">
                ...
                HV systems, 11kV has a tolerance of +/-6%.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-elec-yellow/90 font-mono text-center py-2">
                V1/V2 = N1/N2 (Primary Voltage / Secondary Voltage = Primary Turns / Secondary
                Turns)
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Cooling:</strong> Mineral oil circulation (ONAN, ONAF, OFAF)
                  </li>
                  <li>
                    <strong>Insulation:</strong> Oil-impregnated paper
                  </li>
                  <li>
                    <strong>Advantages:</strong> Better cooling, higher ratings possible
                  </li>
                  <li>
                    <strong>Disadvantages:</strong> Fire risk, requires bunding
                  </li>
                  <li>
                    <strong>Protection:</strong> Buchholz relay, pressure relief valve
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Cooling:</strong> Air natural (AN) or air forced (AF)
                  </li>
                  <li>
                    <strong>Insulation:</strong> Cast resin or VPI
                  </li>
                  <li>
                    <strong>Advantages:</strong> Reduced fire risk, no bunding
                  </li>
                  <li>
                    <strong>Disadvantages:</strong> Higher cost, lower overload capacity
                  </li>
                  <li>
                    <strong>Protection:</strong> Temperature sensors, fan failure alarms
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Common Transformer Ratings (11kV/400V)
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li>
                      <strong>Physical security:</strong> Locked doors, security fencing, intruder
                      alarms
                    </li>
                    <li>
                      <strong>Warning signage:</strong> "Danger of Death" signs on all access points
                    </li>
                    <li>
                      <strong>Authorisation:</strong> Only Authorised Persons may enter HV areas
                    </li>
                    <li>
                      <strong>Key control:</strong> HV keys held only by authorised personnel
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <p className="mt-4">
              Many modern substations incorporate <strong>segregated access</strong>, where LV
              equipment and metering can be accessed through a separate compartment without entering
              the HV area. This allows routine meter reading and LV maintenance without requiring HV
              authorisation.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The interface between HV and LV systems involves not just the physical transformer but
              also the metering arrangements that determine how electricity consumption is measured
              and billed.
            </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Common CT Ratios for LV Metering
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white">
                ...
                scheduling can significantly reduce electricity costs.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50 mb-6">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    Electrical flashover from HV systems can occur across air gaps without direct
                    contact. The safe approach distances specified below are minimum requirements
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Up to 1kV (LV):</strong> Avoid contact - no specific distance
                </li>
                <li>
                  <strong>3.3kV:</strong> AP 0.3m, Competent 1.2m, Unqualified 2.0m
                </li>
                <li>
                  <strong>6.6kV:</strong> AP 0.3m, Competent 1.2m, Unqualified 2.4m
                </li>
                <li>
                  <strong>11kV:</strong> AP 0.4m, Competent 1.5m, Unqualified 3.0m
                </li>
                <li>
                  <strong>33kV:</strong> AP 0.7m, Competent 2.0m, Unqualified 4.0m
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white">
                ...
                calculated arc flash energy must be worn when working within the arc flash boundary.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Regulation 4:</strong> Systems, work activities, and protective equipment
                  must be constructed and maintained to prevent danger
                </li>
                <li>
                  <strong>Regulation 14:</strong> No person shall work on or near live conductors
                  unless it is unreasonable to make them dead
                </li>
                <li>
                  <strong>Regulation 16:</strong> Persons working on electrical systems must be
                  competent to prevent danger and injury
                </li>
                <li>
                  <strong>Regulation 12:</strong> Adequate working space, means of access, and
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Assessing HV/LV Boundaries
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Assuming LV-only access</strong> - always verify what equipment is present
                </li>
                <li>
                  <strong>Ignoring clearance distances</strong> - flashover can occur without
                  contact
                </li>
                <li>
                  <strong>Working without authorisation</strong> - ensure you have the correct
                  permits
                </li>
                <li>
                  <strong>Touching unfamiliar equipment</strong> - never assume anything is dead
                </li>
              </ul>
            </div>
          </div>
