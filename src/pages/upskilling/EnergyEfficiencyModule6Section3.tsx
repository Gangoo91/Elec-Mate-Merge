...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'The OFGEM Register',
      'The Carbon Trust Database',
      'The Energy Technology List (ETL)',
      'The BEIS Product Register',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['1-2 years', 'Up to 12 years', '5-8 years', 'No repayment is required'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A direct government grant scheme',
      'An energy company rebate programme',
      'Property-assessed clean energy loans repaid through property charges',
      'A power purchase agreement for solar generation',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['OFGEM', 'Energy suppliers', 'The Carbon Trust', 'Local councils'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Apply for funding only after completing the works',
      'Combine multiple funding sources without declaring them',
      'Secure funding pre-approval before commencing work',
      'Only apply for grants worth over £10,000',
    ],
    correctAnswer: 2,
    explanation:
