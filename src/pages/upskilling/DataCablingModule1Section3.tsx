  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/electrician/upskilling/data-cabling-module-1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The life-cycle and regulatory split that makes structured cabling pay back. Passive
          infrastructure (the cabling itself, patch panels, outlets, splices, basket) lives 15-20
          years; active equipment (switches, routers, APs, PoE PSE) refreshes every 3-5 years. The
          patch-panel port and the outlet face are the demarcation between Layer-1 and Layer-2, and
          BS 7671:2018+A4:2026 §716 / §545 / §444.5.3.1 specifically regulate the passive metallic
          infrastructure.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              floor boxes at the work-area outlet (TO); the patch panels at the FD; the fibre splice
              trays and cassettes; the LC / SC / MTP/MPO connectors; the jumpers and patch cords;
              the labels and labelling rail; the cable basket / tray / ladder / containment; the
              floor / wall / ceiling penetrations and their fire stops; the consolidation point (CP)
              hardware; the multi-user telecommunications outlet assembly (MUTOA) housing.
            </li>
            <li>
              <strong>ACTIVE equipment (electronics + firmware + power).</strong> The building's
              core / aggregation / access switches; the routers; the wireless controllers and access
              points; the PoE injectors and midspans; the media converters (copper-to-fibre); the
              patch-cord-mounted PoE splitters; the IP phones; the IP cameras; the access-control
              readers and door controllers; the PDUs and UPSs (which are themselves active
              power-distribution gear); the fibre-distribution terminal that contains optical
              splitters (passive splitters yes — the housing and any active monitoring electronics,
              no).
            </li>
          </ul>
          <p>
            ...
            feed); a pure passive patch panel is passive. A "powered" cable assembly (e.g. one with
            embedded boost electronics) is active; a plain copper or fibre cable is passive. The
            discipline of the spec is to declare the split for every item and not let "smart"
            features blur it.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              <strong>Passive infrastructure clock — 15 to 20 years.</strong> Cable lifetime is set
              by insulation degradation, mechanical fatigue at terminations, and eventually by
              performance obsolescence — the moment the building wants a service that the original
              Class cannot deliver at 100 m. A Cat5e install from 2002 is hitting that wall in 2026
              because 10GBASE-T at 100 m is out of scope. A Cat6A install from 2014 is comfortably
              absorbing 10G and Type 4 PoE in 2026. The hardware does not "wear out" in 15 years; it
              gets overtaken by services.
            </li>
            <li>
              ...
              end-of-support around 2025; a 2018 Wi-Fi 5 (802.11ac) AP is superseded by Wi-Fi 6 / 6E
              (2020) and Wi-Fi 7 (2024). Refresh is continuous — planning departments budget for it
              as a known operating cost.
            </li>
            <li>
              <strong>Cost-of-access at year zero vs year five.</strong> At fit-out, with the
              building empty, pulling a Cat6A horizontal run costs perhaps £40-£80 per run including
              labour and termination. Adding the same run two years later, with the building
              occupied, ceilings down, furniture moved, weekend access, can cost £200-£400. Adding
              it five years later, with significant churn already, may require a partial re-fit. The
              first-fit cost is the moment to over-spec density — the labour-cost differential
              dwarfs the cable cost.
            </li>
          </ul>
          <p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="80" y="228" fill="#CBD5E1" fontSize="10.5" fontFamily="system-ui">
              Class EA / Cat6A typical 2026 default · TIA-1152-A or BS EN 50346 field certification
              at handover.
            </text>
            ...
            <text
              ...
              fontFamily="system-ui"
            >
              Demarcation between the two clocks: patch-panel port at the FD and outlet face at the
              work area.
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              <strong>FD-side: the patch-panel port.</strong> A passive RJ45 punch-down (or fibre LC
              / SC port) at the back of the patch panel, where the permanent link's horizontal cable
              terminates. The cabling contractor punches it down, tests it, certifies it, labels it.
              The network operator's patch cord plugs into the FRONT of the same port to connect to
              the switch. The label on the front carries the circuit ID matching the BS EN 50174-1 /
              TIA-606-D record.
            </li>
            <li>
              ...
              other end onto the back, snaps the keystone into the faceplate, labels the front. The
              user's work-area cord plugs into the FRONT to connect the user's device. The label on
              the front again carries the matching circuit ID.
            </li>
            <li>
              <strong>The patch cord — the umbilical.</strong> Stranded, factory-terminated,
              catalogue-purchased patch cord that connects the patch-panel front face to the switch
              port (FD-side) and the outlet front face to the user's device (WA-side). Passive but
              consumable. Replaced when worn. NOT part of the certified permanent link; it is the
          ...
          <p>
            ...
            everything in front, plus the active equipment plus the patch cords. When the contracts
            and the labels match the standards, an inspector or a future contractor can walk into
            the comms room ten years later and immediately understand the system.
          </p>
        </ConceptBlock>
        ...
        <AppendixTable
          ...
          rows={[
            ...
            ['Aggregation / core switch', 'Active', '7-10 years', 'IEEE 802.3 · BS EN IEC 62368-1'],
            [
        ...
        >
          <p>
            ...
            to passive infrastructure, even though the historical instinct of an LV electrician was
            to think of bonding as an active-equipment problem:
          </p>
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              <strong>
              ...
              armouring. All of this is passive infrastructure, and from 15 April 2026 all of it is
              explicitly inside the equipotential bonding network.
            </li>
            <li>
            ...
            <li>
              ...
              Where a centralised DC supply (e.g. −48 V telecom DC, or PoE-bus DC distribution) has
              an earthed pole, that pole's conductor is bonded into the equipotential network. This
              is critical for stray-current management on multi-equipment ICT sites.
            </li>
            <li>
            ...
            <li>
              <strong>(e) Protective conductors.</strong> Standard CPCs from §543, included here for
              completeness — the equipotential bonding network is the destination for both
          ...
          <p>
            ...
            equipment — is governed by §444.1.3: not exceeding 2 m × 2 m where equipment susceptible
            to electromagnetic environmental interferences is installed. That is a
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              functional earthing conductors of antenna systems; (c) conductors of the earthed pole
              of a DC supply for information and communications technology equipment; (d) functional
              earthing conductors; (e) protective conductors.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              comply with Category 5, Category 6, Category 6A, Category 7, Category 7A, Category 8.1
              or Category 8.2 or other cables as defined in BS EN 50173-1 by reference to the
            ...
            <li>
              ...
              (RJ45 jack, plug, patch-panel punch-down) shall support a continuous operating current
              of 750 mA per contact, per BS ISO/IEC 11801-1. Patch panels and outlets are PASSIVE
              infrastructure that have to be selected against this current rating.
            </li>
            <li>
            ...
            <li>
              ...
              aluminium, if protection against mechanical damage is provided. (b) 4 mm² copper or 16
              mm² aluminium, if protection against mechanical damage is not provided." This is a
              passive-infrastructure CSA rule.
            </li>
            <li>
              ...
              conductors are present, a separate MFET shall be installed for ease of connection. The
              MFET may be combined with the MET. Passive-infrastructure terminal hardware —
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              bought. "Class EA" is a measured channel performance — what you have. Tender to Class
              EA, certified at handover. The Cat6A cable is a means; the Class EA channel is the
              deliverable. Let the contractor pick the specific cable from approved vendors.
            </li>
            <li>
              <strong>Specify outlet density generously.</strong> First-fit cost of an extra outlet
              is small (£40-£80 per run). Adding the same outlet two years later may cost 5-10×
              more. Specify two outlets per workpoint as standard; specify ceiling-mounted outlets
              for AP positions; specify outlets in furniture-spine locations even if not occupied at
              fit-out. The over-spec is paid back the first time a department reorganises.
            </li>
            <li>
              <strong>Specify pathway capacity for ~50 % growth.</strong> Cable basket fill is
              governed by BS EN 50174-2 / TIA-569-E recommendations. Spec the basket with fill-ratio
              headroom — adding a basket section later is a brutal exercise in an occupied building.
              The cable basket is passive infrastructure that should outlive multiple cable
              refreshes.
            </li>
            <li>
              ...
              50174-1 / TIA-606-D labelling is a passive-infrastructure requirement that the cabling
              tender owns. Both should be testable at handover. Both survive every active-equipment
              refresh.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              A favoured active-equipment vendor's pre-sales engineer "helps" the customer with the
              cabling spec — recommending their patch panels, their cassettes, their connectors, in
              their colours. The cabling install proceeds against that quasi-vendor spec. Five years
              later, when active equipment is refreshed and the building tries to switch vendors to
              save money, the active-vendor's bespoke fixings turn out to be subtly incompatible
              with the new vendor's kit — port spacing wrong, cassette form factor wrong, fibre
              connector polish wrong. The "saved" money on the active refresh is wiped out by
              partial passive re-fit.
            </>
          }
          doInstead={
            <>
              Specify the passive infrastructure to the GENERIC standards (BS EN 50173-1 / 50174-1,
              ANSI/TIA-568.0-E / -1-E / -2-E / -3-E). Use industry-standard Class / Category,
              industry-standard connector types (LC duplex for fibre, RJ45 for copper),
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              density is generous. (3) Bonding compliant with §444.5.3.1 — verify on site, retrofit
              if needed. (4) §716 conductor current check — Type 4 PoE worst case is around 600 mA
              per pair (4-pair PoE), well within the 750 mA hard cap, so compliant. (5) §716.526.101
              connecting hardware rated 750 mA per contact — confirm patch panel and outlet
              hardware. (6) Bundle thermal — check existing bundle sizes against TIA TSB-184-A
              guidance. The PASSIVE infrastructure absorbs the new Wi-Fi 7 requirement without
              re-pulling. The ACTIVE refresh — new APs, new switches with 10 GbE access ports — is a
              separate procurement on the active clock.
            </>
          }
          whyItMatters={
            <>
              ...
              infrastructure change. The active-layer cost is fully recovered on a 5-7 year refresh
              cycle; the passive infrastructure delivers fifteen-plus years of service against one
              fit-out cost. If the 2018 spec had been Cat5e to save first-fit cost, every one of
              these checks would fail and the building would be re-cabled at extreme inconvenience.
            </>
          }
        />
