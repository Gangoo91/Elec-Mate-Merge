...
const inlineChecks = [
  {
    id: 'm7s1-scope',
    question: 'Commercial EV charging includes which install patterns?',
    options: [
  ...
  },
  {
    ...
    question: 'When does the EV charging install require DNO notification under EREC G98 / G99?',
    options: [
  ...
  {
    id: 'm7s1-61439-7',
    question: 'BS EN IEC 61439-7:2023 covers which assemblies?',
    options: [
  ...
  },
  {
    ...
    question: 'How does Section 722 scale from domestic (M6) to commercial (M7)?',
    options: [
...
export default function RenewableEnergyModule7Section1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 1 · BS 7671:2018+A4:2026 · Section 722 + BS EN IEC 61439-7 + PCAR 2023"
        title="Commercial EV landscape & Section 722 scope"
        backTo="../renewable-energy-module-7"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          How Section 722 scales from domestic single-phase (M6) to commercial / workplace / public
          / fleet / DC fast. The regulatory stack — BS 7671 + BS EN IEC 61439-7 + PCAR 2023 + OZEV
          Workplace Charging Scheme + EREC G98 / G99 + PAS 1899 — and where each layer applies.
        </p>
        ...
        <Pullquote>
          Section 722 doesn’t change between domestic and commercial. What changes is the scale, the
          assembly, and the regulatory layers stacked on top.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Workplace</strong> — employer provides chargers for
              staff / contractors / visitors. Typically Mode 3 7-22 kW per bay; 4-20 bays. Smart
              charging via OCPP; OZEV WCS grant funding common
            </li>
            <li>
              <strong className="text-white">Public AC</strong> — kerbside, council car parks,
              supermarket bays. Typically Mode 3 7-22 kW; payment integration (contactless card +
              RFID + app); PCAR 2023 compliance mandatory
            </li>
            <li>
              <strong className="text-white">Public DC fast</strong> — motorway services, urban
              rapid hubs. Mode 4 50-350 kW. Dedicated HV DNO connection typical; CCS Combo 2 + Tesla
              NACS connectors; PCAR + accessibility mandatory
            </li>
            <li>
              <strong className="text-white">Fleet depot</strong> — overnight charging for taxi /
              LCV / delivery / HGV fleets. Typically Mode 3 7-22 kW per bay; sequential scheduling
              via telematics integration; OCPP for fleet management
            </li>
            <li>
              <strong className="text-white">Commercial-curtilage</strong> — business premises
              (workshop, agricultural, customer-curtilage). Single or small cluster; Mode 3 typical;
              OZEV WCS may apply
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Commercial EV install isn’t one regulation — it’s a stack. Knowing which layer applies to
          which type of site is the design competence.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">1. BS 7671:2018+A4:2026 Section 722</strong> — always
              applies. Earthing-tree per 722.411.4; RCD architecture per 722.531.3.101; dedicated
              circuit per IET CoP; manufacturer conformity per 722.511.101
            </li>
            <li>
              <strong className="text-white">2. BS EN IEC 61439-7:2023</strong>— applies to
              multi-charger assemblies (where ≥2 chargepoints share an enclosure / distribution
              panel)
            </li>
            <li>
              <strong className="text-white">3. EREC G98 / G99</strong>— DNO notification +
              connection agreement. G98 fast-track for Type A. G99 formal application for larger
              installs / generation
            </li>
            <li>
              <strong className="text-white">4. PCAR 2023</strong>— Public Charge Point Regulations
              2023. Applies to chargepoints AVAILABLE TO THE PUBLIC. Payment, reliability, pricing,
              roaming, 24/7 helpline, open data
            </li>
            <li>
              <strong className="text-white">5. PAS 1899:2022</strong>— Accessible Charge Points for
              EVs. Applies to public charging at scale. Mounting heights, connector reach, payment
              terminal accessibility, signage
            </li>
            <li>
              <strong className="text-white">6. OZEV schemes</strong>— Workplace Charging Scheme
              (workplace), EV Chargepoint Grant (domestic landlords / leaseholders), Public Charge
              Point grants. Eligibility + accredited installer requirement
            </li>
            <li>
              <strong className="text-white">7. UK SCP Regulations 2021</strong> — Default off-peak
              + randomised delay + security + data privacy. Workplace included; public excluded
            </li>
            <li>
              <strong className="text-white">
                8. BS EN 61851 series + BS EN IEC 62196 series + BS EN IEC 62955
              </strong>{' '}
              — charging equipment product safety + connector + RDC-PD. Always apply at the
              equipment level
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Q1: Who accesses the chargers?</strong> Public (any) =
              PCAR + PAS 1899 layer. Employees / contractors / visitors = workplace (no PCAR). Fleet
              drivers = fleet. Customer’s own staff / business = commercial-curtilage
            </li>
            <li>
              <strong className="text-white">Q2: Who pays for the electricity?</strong> Public =
              chargepoint operator meters + bills end users (PCAR pricing rules apply). Workplace =
              employer pays (no per-session billing typically). Fleet = company owns electricity
              cost. Commercial-curtilage = business owns
            </li>
            <li>
              <strong className="text-white">Q3: What charger types?</strong> AC Mode 3 7-22 kW =
              workplace, fleet, commercial-curtilage common. DC Mode 4 50-350 kW = public hub,
              motorway services, some fleet (rapid top-up)
            </li>
            <li>
              <strong className="text-white">Q4: What supply is available?</strong> Existing DNO
              supply capacity vs new connection. Below ~100 A three-phase: probably no DNO upgrade
              needed. Above: G99 + new connection (months lead time + cost)
            </li>
            <li>
              <strong className="text-white">Q5: What funding applies?</strong> Customer eligible
              for OZEV WCS (workplace, registered business)? Customer pursuing public charging grant
              funding (Local EV Infrastructure scheme)? Customer self-funded?
            </li>
            <li>
              <strong className="text-white">Output</strong> — site classification + applicable
              regulatory layers + scope document for design + quote. Customer signs off the
              classification before design proceeds. Cert evidence bundle starts here
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 708.55.1.3</strong> — no more than 4 socket-outlets
              grouped per enclosure
            </li>
            <li>
              <strong className="text-white">Reg 708.55.1.5</strong> — socket-outlet minimum 16 A.
              For EV use, the actual current may be higher per Section 722; the pitch socket must
              accommodate
            </li>
            <li>
              <strong className="text-white">Reg 708.55.1.6</strong> — mounting height
            </li>
            <li>
              <strong className="text-white">Reg 708.55.1.7</strong> — switchgear / controlgear
              assembly compliance with BS EN IEC 61439-7
            </li>
            <li>
              <strong className="text-white">Reg 708.533</strong> — every socket-outlet individually
              protected by OCPD
            </li>
            <li>
              <strong className="text-white">Reg 708.537.2.1.1</strong> — at least one means of
              isolation per distribution enclosure
            </li>
            <li>
              <strong className="text-white">Section 722 layered on top</strong> — earthing-tree per
              722.411.4; RCD architecture per 722.531.3.101; dedicated circuit per IET CoP;
              equipment conformity per 722.511.101. Plus BS EN IEC 61851 + 62196-2
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">
                EV Chargepoint Grant — flat residents (landlords)
              </strong>{' '}
              — up to £350 per chargepoint for private leasehold + rental properties. Aimed at
              landlord-owned residential portfolios
            </li>
            <li>
              <strong className="text-white">
                EV Chargepoint Grant — sole-use households without off-street parking
              </strong>{' '}
              — cross-pavement / through-pavement charging solutions
            </li>
            <li>
              <strong className="text-white">Workplace Charging Scheme (WCS)</strong> — up to £350
              per socket, max 40 sockets per applicant. Registered businesses, charities, public
              sector. Most relevant scheme for §7.1 commercial install patterns
            </li>
            <li>
              <strong className="text-white">Local EV Infrastructure (LEVI)</strong>— capital +
              capability funding for local authorities for at-scale public charging rollout. Tens of
              millions per LA award level
            </li>
            <li>
              <strong className="text-white">Verify current rates</strong>— OZEV scheme rates +
              scope evolve. Verify against the live OZEV scheme docs before quoting; rates above are
              UK 2025-26 indicative
            </li>
          </ul>
        </ConceptBlock>

        <Pullquote>
          The classification conversation is more than electrical scoping. It’s the regulatory layer
          applicability — and the grant scheme eligibility.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">G98 single-phase</strong> — up to 16 A per phase
              generation. Fast-track post-installation notification (installer fills the G98 form
              online + sends to DNO)
            </li>
            <li>
              <strong className="text-white">G98 three-phase</strong> — up to 16 A per phase per
              phase. Aggregate generation across the install
            </li>
            <li>
              <strong className="text-white">G99 single-phase</strong> — above 16 A per phase, or
              where the install has generation that doesn’t fit G98 fast-track
            </li>
            <li>
              <strong className="text-white">G99 three-phase</strong> — above 16 A per phase, or
              above 17 kVA total, or with BESS / V2G / connected generation. Formal pre-installation
              application
            </li>
            <li>
              <strong className="text-white">G99 high-power</strong> — above 50 kW (LV) → DNO formal
              connection agreement; above 1 MW → HV connection (11 kV typical for public DC fast
              hubs)
            </li>
            <li>
              <strong className="text-white">Pure-load EV charging</strong> — typically NO G99
              notification needed if the site has no generation. Cert evidence bundle records the
              DNO clarification reference (DNO confirms no notification required)
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Site host</strong> — owns the land, the electricity
              supply, the DNO connection. Responsible for site access + planning + ongoing
              electrical safety. Typically the customer in workplace / commercial-curtilage;
              landlord in public
            </li>
            <li>
              <strong className="text-white">Chargepoint Operator (CPO)</strong>— owns the charging
              hardware + back-office (CPMS) + customer payment relationship. Responsible for PCAR
              2023 compliance + tariff + uptime + customer support. May be site host (vertically
              integrated) or third party
            </li>
            <li>
              <strong className="text-white">Installer</strong> — designs + installs + commissions
              the electrical infrastructure to BS 7671 + BS EN IEC 61439-7. Hands over the cert
              evidence bundle to both site host AND CPO at completion. Responsible for the install
              warranty + post-handover snagging
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle copies</strong>— handed to each
              party in the triad. Site host needs it for insurance + EICR + ongoing electrical
              safety. CPO needs it for PCAR + uptime obligations. Installer keeps a copy for the
              install record + warranty support
            </li>
            <li>
              <strong className="text-white">PCAR responsibility</strong>— the CPO is the
              duty-holder for PCAR 2023 compliance (not the installer or site host). Installer’s
              deliverable is the install infrastructure that enables PCAR compliance; the CPO
              operates within it
            </li>
          </ul>
        </ConceptBlock>
