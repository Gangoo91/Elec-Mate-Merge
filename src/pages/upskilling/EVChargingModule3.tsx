        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 auto-rows-fr">
            {sections.map((section) => {
              const sectionPath = section.id === 1 ? "/ev-charging-module-3-section-1" : 
                                  section.id === 2 ? "/ev-charging-module-3-section-2" :
                                  section.id === 3 ? "/ev-charging-module-3-section-3" :
                                  section.id === 4 ? "/ev-charging-module-3-section-4" :
                                  section.id === 5 ? "/ev-charging-module-3-section-5" : "#";
