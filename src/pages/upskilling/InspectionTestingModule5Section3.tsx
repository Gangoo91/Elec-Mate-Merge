...
const InspectionTestingModule5Section3 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 5 · Section 3" title="Ze testing at origin" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The external earth fault loop impedance, measured at the supply intake. The
          disconnect-and-measure method, the no-disconnect alternative, and what each typical band
          tells you about the supply you are working on.
        </p>
        ...
        >
          <p>
            Reg 313.1 in BS&nbsp;7671:2018+A4:2026 sets out the supply characteristics that must be
            ascertained for an external supply (and determined for a private source) before design
            and verification: nominal voltage, nature of current and frequency, prospective
          ...
          <p>
            ...
            measurement, enquiry or inspection. At design stage on an installation that does not yet
            exist physically, enquiry to the Distribution Network Operator gives a declared maximum
            value to design against. On an existing installation undergoing periodic inspection or
            alteration, measurement at the origin is the default — the declared value goes on the
            certificate as a cross-check, not as the primary record.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            required by Reg&nbsp;313.1 and forms part of the certificate. Second, it is the term you
            add to R1+R2 (corrected to operating temperature) to predict Zs for any circuit on the
            installation: <strong>Zs ≈ Ze + R1 + R2</strong>. That predicted Zs is then the figure
            you compare against the Table&nbsp;41 / A4 max-permitted-Zs limit — which
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              Isolate the consumer unit at the main switch and lock off. Prove dead at the outgoing
              side of the main switch.
            </li>
            <li>
              With the installation dead, disconnect the main earthing conductor at the MET. Tag the
              lifted end with a high-visibility marker so it cannot be accidentally left adrift
              after the test.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Ze is defined here as &lsquo;the earth fault loop impedance of that part of the system
              external to the installation&rsquo;. Regulation 313.1 requires Ze to be determined for
              the external supply as part of supply characteristic assessment.
            </>
          }
        ...
        >
          <p>
            ...
            implementations share the same principle: the meter takes one loop measurement with one
            current path active and a second with another, using a precise low-current comparison
            and the meter&rsquo;s sense leads to subtract the installation contribution. The
            user-facing experience is a single button press that yields a Ze reading without
            breaking the earthing conductor.
          </p>
          <p>
            ...
            external mass (e.g. multiple installations bonded together via a common service trench),
            the no-disconnect mode may not fully isolate the installation contribution and the
            reading can sit slightly low. Second, no-disconnect modes are calibrated for clean
            sinusoidal supplies; on supplies with heavy harmonic distortion or significant DC
            content (rare but possible behind some inverters), the algorithm can misread. When in
            doubt, fall back to Method&nbsp;A and compare.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="305" y="160" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              ⚠ DISCONNECTED
            </text>
            ...
            <text x="540" y="245" textAnchor="start" fill="#22C55E" fontSize="9" fontWeight="bold">
              probe → MET
            </text>
        ...
        >
          ...
          <p>
            When the measured TN-S Ze exceeds the typical band, the suspect chain is: degraded lead
            sheath (PILC corrosion), broken or corroded joint at the cut-out, faulty substation
            neutral-earth bond, or — increasingly common — a TN-S supply that has been silently
            re-presented as TN-C-S after substation refurbishment but still looks like TN-S to the
            customer. Confirm with the DNO before recording.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            The A4:2026 amendment adds an explicit prohibition that no switching or isolating device
            shall be inserted in a PEN conductor (Reg&nbsp;411.4.3 addition). That is not a Ze test
            issue per se, but it is worth flagging during a PME Ze test: anything that looks like a
            switch or fuse on the PEN side of the cut-out is a non-compliance that the DNO needs to
            know about.
          </p>
          <p>
            When TN-C-S Ze drifts upward, the suspect chain is similar to TN-S — corroded joints in
            the service cable, a high-resistance crimp at the cut-out — plus the PME-specific risk
            of a broken PEN conductor in the LV network. A broken PEN can produce a Ze that drifts
            wildly with neighbouring load (because the meter sees return current via every other
            consumer&rsquo;s earthing system), and is the technical reason for the PME hazard
            warnings around EV charging supplies and caravan / boat installations.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Ra × IΔn ≤ 50&nbsp;V</strong> (Reg&nbsp;411.5.3) — where Ra is the resistance
              of the earth electrode plus the protective conductor connecting it to the
              exposed-conductive-parts, and IΔn is the rated residual operating current of the RCD.
              For a 30&nbsp;mA RCD, this allows Ra up to ≈&nbsp;1666&nbsp;Ω, a limit no domestic
              electrode in the UK fails.
            </li>
            <li>
              <strong>Zs ≤ Table&nbsp;41.5 maximum for the RCD rating</strong> — Table&nbsp;41.5
              lists the loop impedance ceilings: 30&nbsp;mA → 1667&nbsp;Ω, 100&nbsp;mA → 500&nbsp;Ω,
              300&nbsp;mA → 167&nbsp;Ω, 500&nbsp;mA → 100&nbsp;Ω.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              the RCD. The circuit meets the regulation if Zs meets Table 41.5 requirements.
            </>
          }
        ...
        >
          <p>
            ...
            path via electrodes, but a first earth fault does not produce significant fault current
            because the source is isolated. Reg&nbsp;411.6 governs IT systems; Ze appears in the
            supply characteristics block but does not drive disconnection compliance the way it does
            on TN. If you are commissioning a medical IT system (Reg&nbsp;710), the relevant tests
            are insulation monitor function, isolation transformer compliance, and the second-fault
            limits — not a TN-style Ze read.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Declared values come in two flavours. The DNO publishes typical maxima for each earthing
            arrangement in their area (for example, &ldquo;TN-C-S supplies in this network are
            declared at 0.35&nbsp;Ω maximum&rdquo;), and on enquiry will provide the specific
            declared maximum for a feeder or service. At design stage on a new installation, the
            declared value is the input to circuit-length and Zs design calculations — you do not
            have an installation to measure yet.
          </p>
          <p>
            At verification, the measured value is what you put in the Supply Characteristics block.
            Best practice is to also note the declared value alongside, either in the same field
            with a slash (e.g. <em>0.21 / 0.35 Ω</em>) or in the comments. That gives the next
            inspector both numbers — invaluable for spotting drift over a five-year periodic
            interval.
          </p>
          <p>Three rules of thumb for reconciling the two numbers:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Measured ≤ declared:</strong> normal. The declared is a worst-case ceiling; in
              service the supply usually has more headroom than that. Record both, move on.
            </li>
            <li>
            ...
            <li>
              <strong>Measured significantly above declared:</strong> investigation flag. Either the
              supply has degraded since installation or the declared figure is wrong for that
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              could give a result anywhere from 0 to 0.06&nbsp;Ω. For Ze on a modern PME supply, you
              want a meter that resolves to 0.01&nbsp;Ω with sub-percent accuracy in that range.
            </li>
            <li>
              <strong>Test current and RCD interaction:</strong> high-current loop tests can trip
              30&nbsp;mA RCDs and even some sensitive 6&nbsp;A Type&nbsp;B MCBs. Most modern meters
              have a low-current or no-trip Ze mode that resolves this; make sure it is selected on
              RCD-protected origins.
            </li>
            <li>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Disconnect</strong> the meter. <strong>Refit</strong> the earthing conductor.
              Continuity-check the refit. Remove the tag <em>only</em> after refit is confirmed.
            </li>
            <li>
          ...
          <p>
            For Method B (no-disconnect Ze), steps 3 and 6 collapse — the conductor never leaves the
            MET — but steps 1, 2 and 7 still apply. The operator&rsquo;s responsibility for safe
            isolation does not change because the meter is doing cleverer things internally.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The A4:2026 model forms tightened the Supply Characteristics block to make those entries
            explicit. Three things to get right every time:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Ze (measured):</strong> the value you read at the origin, in ohms, two decimal
              places. If the no-disconnect mode was used, note that in the comments — it tells the
              next inspector you removed parallel paths electronically, not physically.
            </li>
            <li>
              <strong>Ze (declared):</strong> the DNO&rsquo;s declared maximum for the supply
              arrangement. Where the form gives a single Ze field, conventional practice is to enter
              measured / declared with a slash, or measured in the field and declared in the
              comments.
            </li>
            <li>
              ...
              together — a Ze of 95&nbsp;Ω on a TN-C-S box is an obvious inconsistency and an audit
              flag.
            </li>
          </ul>
          <p>
            ...
            impedance. The Supply Characteristics block on the certificate is that duty expressed as
            a form. Empty the box, and the certificate is incomplete on its face.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The characteristics listed (nominal voltage, nature of current/frequency, prospective
              short-circuit current, Ze, suitability including maximum demand, and type/rating of
              origin protective devices) shall be ascertained for an external supply and shall be
              determined for a private source. The obligation covers supplies from whatever source.
            </>
          }
