...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'Act as a central controller for devices',
      'Boost Wi-Fi signal',
      'Store video recordings',
    ],
    correctIndex: 1,
    explanation:
      'A smart home hub acts as a central controller, translating between different protocols and enabling devices to work together through a unified interface.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Hubless Wi-Fi devices connect directly to the home router, requiring no additional hardware purchase or configuration, making installation simpler for basic setups.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Matter provides a unified application layer that works across multiple protocols and ecosystems, reducing the need for proprietary hubs and bridges.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Cloud-dependent devices require constant internet connectivity and rely on vendor servers. If the vendor discontinues service, devices may become unusable.',
  },
  {
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'A multi-protocol hub allows mixing devices from different protocols under one control system, providing flexibility while maintaining unified automation.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'For basic setups (under 10 devices, single ecosystem), hubless Wi-Fi devices are simpler. For larger installations, multi-protocol needs, or advanced automation, hub-based systems offer more capability and reliability.',
  },
  {
    question: 'What happens if my smart home vendor goes out of business?',
    answer:
      'Cloud-dependent hubless devices may become unusable. Hub-based systems with local processing continue working. Open-source hubs like Home Assistant provide the most protection against vendor lock-in.',
  },
  {
    question: 'Can I start hubless and add a hub later?',
    answer:
      'Yes. Many Wi-Fi devices can be integrated into hub systems. However, some cloud-only devices cannot be moved to local control. Check compatibility before purchasing.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-4xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-white text-sm">
              Centralised control, multi-protocol support, local processing
            </p>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            <p className="text-sm font-medium text-elec-yellow mb-1">Hubless</p>
            <p className="text-white text-sm">
              Simpler setup, direct Wi-Fi connection, cloud-dependent
            </p>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            A smart home hub is a dedicated device that acts as the central brain of a smart home
            system. It communicates with individual devices using their native protocols and
            provides a unified interface for control and automation.
          </p>
          <div className="space-y-3 mb-4">
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Protocol Translation</p>
              <p className="text-white text-sm">
                Hubs translate between protocols (Zigbee, Z-Wave, Wi-Fi) enabling devices from
                different technologies to work together.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Automation Engine</p>
              <p className="text-white text-sm">
                Hubs process automation rules locally, triggering actions based on sensor inputs,
                schedules, or conditions without cloud dependency.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Unified Interface</p>
              <p className="text-white text-sm">
                A single app controls all devices regardless of manufacturer, simplifying the user
                experience.
              </p>
            </div>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-white text-sm">
              The hub is a single point of failure. If it loses power or fails, all connected
              devices lose their smart functionality until it is restored.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Hub-based systems use a central device that communicates with smart devices and manages
            the overall system. This approach has been the traditional model for comprehensive smart
            home installations.
          </p>
          ...
          <div className="space-y-3">
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Samsung hub supporting Zigbee, Z-Wave, and Wi-Fi. Strong ecosystem with good
                third-party support.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Local-first processing with advanced automation. Popular with enthusiasts wanting
                maximum control.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Open-source platform supporting thousands of integrations. Requires more technical
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Hubless systems use Wi-Fi devices that connect directly to the home router and are
            controlled via cloud services. Each device connects individually without a central
            coordinator.
          </p>
          <div className="grid sm:grid-cols-2 gap-4 mb-4">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-white text-sm">
              Wi-Fi-only devices are suitable for customers wanting simple solutions with a few
              devices. Beyond 10-15 devices, hub-based systems typically provide better performance
              and reliability.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Many modern installations use a hybrid approach, combining hub-based control for certain
            devices with standalone Wi-Fi devices for others. Voice assistants like Alexa and Google
            Home often serve as the unifying control layer.
          </p>
          <div className="space-y-3 mb-4">
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Voice Assistant as Hub</p>
              <p className="text-white text-sm">
                Amazon Echo and Google Nest devices can control both native Wi-Fi devices and
                hub-connected devices, providing a unified voice interface.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Selective Protocol Use</p>
              <p className="text-white text-sm">
                Use Zigbee/Z-Wave for sensors and switches where reliability matters, Wi-Fi for
                cameras and high-bandwidth devices.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Matter as Unifier</p>
              <p className="text-white text-sm">
                Matter-certified devices can work across ecosystems, reducing the need for
                protocol-specific hubs while maintaining local operation.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            The smart home landscape is evolving rapidly. Matter and Thread are changing how devices
            communicate and reducing traditional hub requirements.
          </p>
          <div className="space-y-3">
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Matter Controllers</p>
              <p className="text-white text-sm">
                Apple HomePod, Google Nest, and Amazon Echo devices can act as Matter controllers,
                reducing the need for separate hubs.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Thread Border Routers</p>
              <p className="text-white text-sm">
                Many smart speakers now include Thread Border Router functionality, providing mesh
                networking without dedicated hardware.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Local-First Trend</p>
              <p className="text-white text-sm">
                Privacy concerns are driving demand for local processing. Matter's emphasis on local
                control aligns with this trend.
              </p>
            </div>
          </div>
        </section>
