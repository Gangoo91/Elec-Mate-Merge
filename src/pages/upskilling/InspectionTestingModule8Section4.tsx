...
const DESCRIPTION =
  'Learn to correctly complete Electrical Installation Certificates (EICs) for new installations and additions, including all required signatures and declarations.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "An EIC is required for new electrical installations and for additions or alterations to existing installations where new circuits are added. It's a mandatory requirement under BS 7671.",
  },
  {
    id: 'eic-signatures',
    ...
    correctIndex: 2,
    explanation:
      'An EIC requires three signatures: the designer (design responsibility), the constructor (installation responsibility), and the inspector/tester (inspection and testing responsibility).',
  },
  {
    id: 'eic-one-person',
    ...
    correctIndex: 1,
    explanation:
      'One person can sign all three parts if they are qualified and have personally undertaken the design, construction, and inspection/testing. This is common for smaller jobs by competent electricians.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "The designer's signature confirms that the design of the installation complies with BS 7671 and that the characteristics of the supply have been checked and recorded.",
  },
  {
    id: 4,
    question: 'Can one person sign all three parts of an EIC?',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'An EIC must be accompanied by a completed Schedule of Inspections (inspection checklist) and Schedule of Test Results (all measured values for each circuit).',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      "The 'extent and limitations' section describes exactly what work is covered by this certificate, including any parts not inspected/tested due to access limitations.",
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'For domestic installations, a 5-year maximum interval (or on change of occupancy) is typically recommended for periodic inspection and testing. This should be stated on the certificate.',
  },
  {
    id: 8,
    ...
    correctAnswer: 0,
    explanation:
      'The EIC covers only the work carried out (the addition). The extent should clearly state this is for additional circuits only. The existing installation requires its own EICR if inspection is needed.',
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      'Regulation 632.4 requires the original certificate to be given to the person ordering the work. The contractor should retain a copy. For Building Regulations work, a copy goes to Building Control.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'An EIC can only be issued when the installation complies with BS 7671. Dangerous conditions must be rectified before the certificate is issued. The installation cannot be certified until safe.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "The EIC requires separate signatures for design, construction, and inspection. If you didn't design it, the designer should sign their section. If design information isn't available, you may need to assess and take design responsibility before signing.",
  },
  {
    question: "What's the difference between EIC and Minor Works Certificate?",
    answer:
      "An EIC is for new installations, additions, or alterations that include new circuits. A Minor Works Certificate is for work that doesn't add new circuits - such as adding a socket to an existing circuit or replacing a consumer unit.",
  },
  {
    question: 'How long should I keep copies of certificates?',
    answer:
      'Contractors should retain copies of certificates for the recommended inspection interval (e.g., 5 years for domestic) as a minimum. Many recommend keeping them for at least 10 years or longer for professional indemnity purposes.',
  },
  {
    question: 'Does an EIC need to be issued for notifiable work?',
    answer:
      'Yes. For work notifiable under Building Regulations Part P, an EIC is required and a copy must be provided to Building Control (either directly or via a competent person scheme). The EIC demonstrates compliance.',
  },
  {
    question: 'What if I find issues with the existing installation during an addition?',
    answer:
      "Note limitations on the EIC that it covers only the new work. Advise the client in writing about any observed issues with the existing installation and recommend an EICR. Do not try to certify work you haven't done.",
  },
  {
    question: 'Can an apprentice sign an EIC?',
    answer:
      'Only someone competent (qualified and experienced) to undertake the work can sign. An apprentice under supervision would not typically sign - the supervising electrician would sign. The signature confirms competence and responsibility.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>When:</strong> New installations and additions
              </li>
              <li>
                <strong>Signatures:</strong> Designer, Constructor, Inspector/Tester
              </li>
              <li>
                <strong>Accompany:</strong> Schedule of Inspections + Test Results
              </li>
              <li>
                <strong>Original:</strong> Goes to person ordering work
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>One person:</strong> Can sign all 3 if qualified
              </li>
              <li>
                <strong>Domestic:</strong> 5 years retest interval
              </li>
              <li>
                <strong>Extent:</strong> Describe exactly what's covered
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              An Electrical Installation Certificate is required when new circuits are created or
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> The EIC confirms the installation complies with BS 7671 at
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>An EIC requires three signatures, each confirming different responsibilities:</p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>The EIC has several sections that must be completed fully:</p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">Key Sections</p>
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Details:</strong> Address, description, extent and limitations
                </li>
                <li>
                  <strong>Supply:</strong> Type (TN-S, TN-C-S, TT), voltage, PSCC, Ze
                </li>
                <li>
                  <strong>Installation:</strong> Type of wiring, earthing arrangements
                </li>
                <li>
                  <strong>Signatures:</strong> All three with dates
                </li>
                <li>
                  <strong>Recommendation:</strong> Next inspection date
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The 'extent and limitations' section is crucial - it defines exactly what the
              certificate covers:
            </p>
            ...
            <p className="text-sm text-amber-400/80">
              <strong>Important:</strong> Never certify work you haven't done or inspected. If the
              existing installation has issues, note this separately and recommend an EICR.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The EIC should state a recommended maximum interval before the next periodic
              inspection:
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Correct distribution of the certificate is a regulatory requirement:</p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Original:</strong> To the person ordering the work (client)
                </li>
                <li>
                  <strong>Copy:</strong> Retained by the contractor
                </li>
                <li>
                  <strong>Building Control:</strong> Copy if notifiable work
                </li>
                <li>
                  <strong>Scheme Provider:</strong> If registered with competent person scheme
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Back-dating</strong> - sign and date when work is actually complete
                </li>
                <li>
                  <strong>Missing schedules</strong> - EIC requires both inspection and test
                  schedules
                </li>
                <li>
                  <strong>Vague extent</strong> - be specific about what's covered
                </li>
                <li>
                  <strong>Wrong certificate</strong> - EIC is for new circuits, Minor Works for
