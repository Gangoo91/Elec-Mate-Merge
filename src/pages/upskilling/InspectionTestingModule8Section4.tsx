    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The A4:2026 EIC walked section by section — A through J — with the regulatory basis for
          each section, the three-signature requirement of Reg 644.4, and the new A4 additions
          (TN-C-S PNB, AFDD, lighting RCD).
        </p>
        ...
        >
          <p>
            ...
            persons responsible sign for the work they did. A blank signature block, or a signature
            in the wrong block, invalidates the certificate for that part of the work.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The person or persons responsible for the design, construction and verification of the
              installation shall issue the Certificate, which takes account of their respective
              responsibilities, to the person ordering the work, together with the records mentioned
              in Regulation 644.3. The recommendation for the interval between initial verification
              and the first periodic inspection shall be recorded on the Certificate.
            </>
          }
        ...
        >
          <p>
            Section B is the &ldquo;what and where&rdquo;. The installation address is the physical
            location of the work. The description is the plain-English summary (&ldquo;Single-phase
            domestic installation, 23 kW supply, 100 A main switch, 18-way dual-RCD consumer
            unit&rdquo;). The extent is the scope statement: this is the section that fences in your
            liability — what is covered and what is not.
          </p>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              designers (Designer No 1 and Designer No 2 — the latter with the &ldquo;**Where there
              is mutual responsibility for the design&rdquo; note). The designer&rsquo;s
              departures-from-BS-7671 box explicitly cites Regs 120.3, 133.1.2, 133.1.3 and 133.5 —
              the regulations that permit declared departures from the standard. Section C also has
              a &ldquo;Risk assessment attached&rdquo; tick-box for the permitted-exceptions case
              (Reg 411.3.3).
            </li>
            <li>
          ...
          <p>
            ...
            accommodates this: a single-signature EIC is the common domestic case, and is perfectly
            valid under Reg 644.4 provided the signatory is genuinely competent in all three roles.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            <text x="400" y="24" textAnchor="middle" fill="#FBBF24" fontSize="13" fontWeight="bold">
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="150" y="82" textAnchor="middle" fill="#22C55E" fontSize="12" fontWeight="bold">
              FOR DESIGN
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="400" y="82" textAnchor="middle" fill="#FBBF24" fontSize="12" fontWeight="bold">
              FOR CONSTRUCTION
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="650" y="82" textAnchor="middle" fill="#A855F7" fontSize="11" fontWeight="bold">
              FOR INSPECTION
            </text>
            <text x="650" y="98" textAnchor="middle" fill="#A855F7" fontSize="11" fontWeight="bold">
              AND TESTING
            </text>
        ...
        >
          <p>
            ...
            Designer No 2 if applicable, Constructor, Inspector), Section E records the accompanying
            particulars: Name, For/on behalf of (company), Address, Postcode, Tel No. The form
            supports four entries.
          </p>
        </ConceptBlock>
            ...
            <table className="w-full text-[13.5px] my-2">
              ...
              <tbody className="text-white/95">
                ...
                <tr className="border-b border-white/[0.06]">
                  ...
                  <td>TN-C-S (PME)</td>
                  <td>
                    Distributor PEN combined upstream, separated at origin — PME bond at the cut-out
                  </td>
                </tr>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              Installation earth electrode. (TT only requires the installation electrode; TN systems
              use the distributor&rsquo;s facility.)
            </li>
            <li>
              <strong>Maximum Demand.</strong> Maximum demand (load) in kVA or A — designer&rsquo;s
              figure, used for cable and OCPD selection.
            </li>
            <li>
            ...
            <li>
              ...
              continuity verified&rdquo; tick-box. Then the bonded services check-list: water, gas,
              oil, structural steel, lightning protection, &ldquo;Other (Specify)&rdquo;.
            </li>
            <li>
        ...
        >
          ...
          <p>
            ...
            (prosumer installations — PV, battery, EV-V2G installations that export). For each item,
            there is no sub-list on the EIC Section H — the inspector confirms or N/As at the top
            level. The detailed item-by-item list (4.23 AFDD, 5.12 lighting RCD, etc.) is on the
            EICR&rsquo;s Schedule of Inspection, NOT here.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            affects the safety of the addition shall be corrected before the Certificate is issued.
            It also requires the person responsible to record on the EIC or MEIWC any defects found,
          ...
          <p>
            ...
            expected to perform a full EICR on the existing installation just because someone wanted
            a new socket. You are expected to record what you found, and to flag what you could not
            safely or sensibly check.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              For an addition and/or alteration to an existing installation, any defect or omission
              that will affect the safety of the addition or alteration that is revealed during
              inspection and testing shall be corrected before the Certificate is issued. The person
              responsible for the new work, or a person authorized to act on their behalf, shall
              record on the Electrical Installation Certificate or the Minor Electrical Installation
              Works Certificate, any defects found, so far as is reasonably practicable, in the
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            <text x="400" y="22" textAnchor="middle" fill="#FBBF24" fontSize="13" fontWeight="bold">
            ...
            <g>
              ...
              <text x="300" y="146" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9">
                TN-C-S (PNB) added
              </text>
              <text x="300" y="158" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9">
                at A4:2026
              </text>
            </g>
            ...
            <g>
              ...
              <text x="680" y="146" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9">
                Items 1.0 to 14.0
              </text>
              <text x="680" y="158" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9">
                Tick / N/A per item
              </text>
            </g>
            ...
            <g>
              ...
              <text x="205" y="218" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9">
                Reg 644.1.2 — record defects in existing,
              </text>
              <text x="205" y="230" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9">
            ...
            <g>
              ...
              <text x="585" y="218" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9">
                SoI + Circuit Details + Test Results
              </text>
              <text x="585" y="230" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9">
            ...
            <text x="395" y="341" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="10">
              The whole certificate is valid only when Sections A–J are completed AND the schedules
              from Section J are attached.
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Certifying where there are multiple additions, or alterations or remedial works to the
              existing installation which do not extend to new circuits, as an alternative to the
              issue of multiple Minor Electrical Installation Works Certificates
            </li>
          </ol>
          <p>
            The fourth case is the practical convenience: rather than issuing a stack of MEIWCs for
            a programme of remedials, you may use a single EIC. Note &ldquo;may&rdquo; — it is not
            mandatory; multiple MEIWCs are still permitted.
          </p>
          <p>
            The notes also state explicitly: &ldquo;It is not to be used for periodic inspection and
            testing, for which an Electrical Installation Condition Report is to be used. For an
            addition or alteration which does not extend to the introduction of new circuits, a
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              <span className="block">
                Section B: installation address, description (&ldquo;Replacement of consumer unit on
                an existing TN-C-S domestic installation&rdquo;), tick &ldquo;Alteration to an
                existing installation&rdquo;.
              </span>
              <span className="block">
                Section C: sign all three blocks (one competent electrician). Departures: none. Risk
                assessment: not required (Reg 411.3.3 not invoked).
              </span>
              <span className="block">
              ...
              <span className="block">
                Section H Schedule of Inspections: tick items 1.0 through 11.0 as appropriate. Items
                12.0 (bathroom) and 14.0 (prosumer) confirmed if applicable.
              </span>
              <span className="block">
                Section I (Comments on existing): record any defects found in the existing circuits
                during reterminate (e.g. degraded sheath at the back of the old CU, loose neutrals)
                per Reg 644.1.2.
              </span>
              <span className="block">
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              of isolation (where present)&rdquo; promoted to its own item under Section 1.0 INTAKE
              EQUIPMENT, aligning with Reg 462.1.201 main linked switch.
            </li>
            <li>
            ...
            <li>
              ...
              manual test) added, with the &ldquo;Not all AFDDs have a test button&rdquo; footnote.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Quiz title="Electrical Installation Certificate — Module 8.4" questions={quizQuestions} />
