...
const inlineChecks = [
  ...
  },
  {
    ...
    question: 'How is Reg 551.7.5 anti-islanding actually tested at commissioning?',
    options: [
  ...
  },
  {
    ...
    question: 'What is the cert evidence bundle structure across M9 LCT installs?',
    options: [
  ...
  },
  {
    ...
    question: 'What does Reg 643.10 functional testing cover for M9 generating sets?',
    options: [
...
const quizQuestions = [
  ...
  {
    question: 'Anti-islanding fails the commissioning test — what does the installer do?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'How does Reg 644 certification differ for generating-set vs routine circuit installs?',
    answer:
...
export default function RenewableEnergyModule9Section8() {
  ...
  useSEO({
    title: 'Commissioning, Part 6 + handover across other LCT | Renewable Energy 9.8 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 9 · Section 8 · BS 7671:2018+A4:2026 · Part 6 + Section 551"
        title="Commissioning, Part 6 + handover across other LCT"
        backTo="../renewable-energy-module-9"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The unifying commissioning framework across the M9 LCT technologies. BS 7671 Part 6
          standard verification + Section 551 supplementary tests (Reg 551.7.5 anti-islanding, Reg
          551.4.2 multi-source RCD, Reg 551.7.2.1 supply-side connection) + EREC G98 / G99 DNO
          documentation + MCS handover pack per technology + the eight-layer cert evidence bundle
        ...
        <Pullquote>
          The EIC is the legal artefact; the cert evidence bundle is the project deliverable. The
          two are not the same — and on an M9 install, the gap between them is where the customer\'s
          grant claim + insurance + next-buyer due diligence + future-installer handover all live.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              ...
              continuity of protective conductors, insulation resistance (≥1 MΩ at 500 V dc per Reg
              643.3 typical low-voltage), polarity, EFLI calculation + measurement where applicable,
              RCD operating time + I∆n (Reg 643.8). Standard for any new circuit
            </li>
            <li>
              <strong className="text-white">Source-side connection visual (Reg 551.7.2.1)</strong>{' '}
              — generator on supply side of all protective devices; isolator at the source with
              locking-off facility; warning notices per Reg 514 ("DANGER MULTIPLE SOURCES OF
              SUPPLY")
            </li>
            <li>
              <strong className="text-white">Energisation + anti-islanding (Reg 551.7.5)</strong> —
              source brought online; loss-of-mains protection verified per BS EN 50549-1 (G98 Type
              A) or BS EN 50549-2 (G99 Type B/C/D); simulated grid loss; disconnect time recorded
              (typically &lt;2 seconds for G99)
            </li>
            <li>
              <strong className="text-white">Multi-source RCD effectiveness (Reg 551.4.2)</strong> —
              RCD tested with every intended combination of sources contributing fault current; 30
              mA RCD providing additional protection per Reg 415.1.1, its effectiveness verified by
              an AC test at the rated residual operating current I∆n (per the A4:2026 redraft —
              Table 3A deleted, a single AC test at I∆n applies regardless of RCD type)
            </li>
            <li>
              <strong className="text-white">Reg 643.10 functional testing</strong> — assembled
              installation operates as intended: start / stop, sync, controls, safety interlocks,
              heat-network interface (where applicable), energy meter, export limit
            </li>
            <li>
              <strong className="text-white">Reg 644 certification</strong> — EIC issued per
              Appendix 6 with schedules; Section 551 supplementary test results referenced or
              appended; cert evidence bundle assembled
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Equipment type-test</strong> — BS EN 50549-1 (G98 Type
              A) or BS EN 50549-2 (G99 Type B/C/D) certified; listed on the ENA Type Test Register;
              DoC supplied; cert reference recorded
            </li>
            <li>
              <strong className="text-white">Parameter settings</strong> — DNO-area specific
              (Northern Powergrid, UK Power Networks, SSE Distribution, Scottish Power, Western
              Power, Electricity North West, SP Energy Networks); voltage / frequency / ROCOF /
              vector-shift thresholds; record in cert evidence
            </li>
            <li>
              <strong className="text-white">Firmware version</strong> — recorded at commissioning;
              older firmware may not meet current EREC G98 / G99 requirements; update via
              manufacturer toolkit before commissioning if outdated
            </li>
            <li>
              <strong className="text-white">Simulated grid-loss test</strong> — commissioning
              toolkit triggers a controlled grid disconnect; verify generator disconnects within the
              required time (&lt;2 seconds typical for G99); record the measured disconnect time
            </li>
            <li>
              <strong className="text-white">DNO-witnessed alternative</strong> — for larger /
              non-standard installs, DNO engineer attends + witnesses live loss-of-mains test at the
              point of supply; DNO witness sheet signed + recorded in cert evidence bundle
            </li>
            <li>
              <strong className="text-white">Cert evidence</strong> — Section 551 supplementary test
              record includes: equipment make + model + serial, BS EN 50549-1/-2 cert reference,
              firmware version, parameter settings, simulated test result or DNO witness sheet, date
              + signature
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Layer 1 — BS 7671 EIC</strong> (Reg 644.4.201 +
              Appendix 6) — legal artefact; circuit schedule, inspection schedule, test results
              schedule. Signed by designer, installer, inspector
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">Layer 3 — EREC documentation</strong> — G98
              post-install notification + DNO acknowledgement (Type A) OR G99 application + DNO
              design acceptance + DNO completion notification (larger). The DNO reference number is
              critical for any future works
            </li>
            <li>
              <strong className="text-white">Layer 4 — MCS handover pack</strong> — per MIS standard
              (MIS 3001 solar thermal, MIS 3003 wind, MIS 3004 biomass, MIS 3007 micro-CHP, MIS 3008
              micro-hydro); MCS company cert reference; Ofgem reference for any grant / RHI / SEG
              claim
            </li>
            <li>
              <strong className="text-white">Layer 5 — Manufacturer documentation</strong> — DoC, BS
              EN 50549-1/-2 type-test certificate reference, parameter settings, firmware version,
              serial numbers, warranty terms
            </li>
            <li>
              <strong className="text-white">Layer 6 — Building Regs notification</strong> — Part P
              (electrical work in dwellings) via competent person scheme (NICEIC, NAPIT, ELECSA,
              Stroma); Part L (thermal — where applicable); Part J (combustion appliances — biomass,
              CHP)
            </li>
            <li>
              <strong className="text-white">
                Layer 7 — Heat-network / fuel specialist sign-off
              </strong>{' '}
            ...
            <li>
              <strong className="text-white">Layer 8 — Customer pack</strong> — controls user guide,
              maintenance schedule, emergency contact list, warranty docs, energy monitoring app
              credentials (where applicable). The customer-facing layer that turns the install into
        ...
        <Pullquote>
          Section 551 doesn\'t care what fuel the generator runs on. Reg 551.7.5 doesn\'t care
          whether it\'s an inverter or a synchronous machine. Reg 551.4.2 doesn\'t care how many
          sources you have. The framework treats every customer-side electricity source by the same
          safety logic — and the cert evidence bundle is the record that proves it.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Single-source (Section 712 PV)</strong> — covered in
              M2-M4. The simplest case; one inverter + EREC G98 typically; Section 551 framework
              applies through Section 712 specifics
            </li>
            <li>
              <strong className="text-white">Single-source with battery (Chapter 57 BESS)</strong> —
              covered in M5. BESS as a generating set per Reg 551.7.2.1; supply-side connection;
              Section 551 anti-islanding for the BESS inverter
            </li>
            <li>
              <strong className="text-white">Section 551 generating sets</strong> — M9. Wind,
              micro-hydro, micro-CHP, commercial CHP — all under the unifying Section 551 framework.
              Different fuels + physical principles, same BS 7671 safety framework
            </li>
            <li>
              <strong className="text-white">Multi-source PEI (Chapter 82)</strong> — M10. When the
              installation has multiple generating sets + storage + smart controls + selective
              export, Chapter 82 PEI integration is the framework. Section 551 remains the
              per-source anchor; Chapter 82 manages the system-level coordination
            </li>
            <li>
              <strong className="text-white">A4:2026 updates (Chapter 81 + Section 443)</strong> —
              M11. The 2026 amendment changes: AFDD scope, lightning protection coordination, fault
              level assessment, schedule form updates. Affects all M2-M10 technology
            </li>
            <li>
              <strong className="text-white">Testing + commissioning specialist deep dive</strong> —
              M12. Brings together Part 6 + Section 551 supplementary + EREC G98 / G99 + MCS
              variants + periodic inspection across every LCT
            </li>
          </ul>
        </ConceptBlock>
