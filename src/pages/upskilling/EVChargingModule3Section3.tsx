...
const faqs = [
  {
    ...
    answer:
      'Type A RCDs detect AC and pulsating DC residual currents. Type B RCDs detect all residual current types including smooth DC. Type B is preferred for EV charging as it provides protection against DC faults that can occur in vehicle chargers.',
  },
  {
    question: 'Why is Type AC RCD not suitable for EV charging?',
    answer:
      'Type AC RCDs only detect AC residual currents and can be blinded by DC components. EV charging equipment can produce DC residual currents that Type AC cannot detect, creating a safety risk.',
  },
  {
    question: 'What MCB characteristic should I use for EV charging?',
    answer:
      'Type B MCBs are suitable for most EV charging applications. Type C may be required for installations with high inrush currents. The choice depends on the specific equipment characteristics and prospective fault current.',
  },
  {
    question: 'How do I achieve proper discrimination between protective devices?',
    answer:
      'Ensure upstream devices have higher current ratings or time delays. Use time-delayed (S-type) RCDs upstream of instantaneous 30mA RCDs. Verify fault current breaking capacity and test discrimination during commissioning.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'A commercial car park has nuisance tripping affecting multiple EV chargers. What is the most likely cause and solution?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Nuisance tripping affecting multiple circuits usually indicates inadequate RCD discrimination. Installing a selective 300mA S-type RCD upstream with 30mA instantaneous RCDs at individual circuits provides fault containment.',
  },
];
...
const EVChargingModule3Section3 = () => {
  useSEO({
    ...
    description:
      'Master circuit protection and RCD selection for EV charging installations including protective device sizing and coordination.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">Protective device selection and coordination</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>RCD Minimum:</strong> Type A (Type B preferred)
              </li>
              <li>
                <strong>RCD Rating:</strong> 30mA for additional protection
              </li>
              <li>
                <strong>MCB Type:</strong> Type B for most EV applications
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> RCD type marked on device face
              </li>
              <li>
                <strong>Use:</strong> Type B for best protection
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Regulation 722.531.2.101 specifies mandatory RCD protection for EV charging. The type
              of RCD determines what residual currents can be detected.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Charging power:</strong> Higher power benefits from Type B
                </li>
                <li>
                  <strong>Vehicle type:</strong> Consider DC leakage characteristics
                </li>
                <li>
                  <strong>Environment:</strong> External installations need enhanced protection
                </li>
                <li>
                  <strong>Future requirements:</strong> Type B provides better compatibility
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Circuit breakers must be correctly sized for sustained EV charging loads while
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              ...
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Type B:</strong> General EV charging
                  </li>
                  <li>
                    <strong>Type C:</strong> High inrush current
                  </li>
                  <li>
                    <strong>Type D:</strong> Motor loads
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
              ...
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>Uc rating:</strong> ≥ 1.1 × nominal voltage
                </li>
                <li>
                  <strong>Imax:</strong> ≥ expected surge current
                </li>
                <li>
                  <strong>Up:</strong> Protection level appropriate for equipment
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Proper discrimination ensures only the device closest to a fault operates, maintaining
              supply to unaffected circuits.
            </p>
            ...
            <div className="my-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <span>
                    <strong>Incomer:</strong> Main switch/MCCB (time-delayed RCD if required)
                  </span>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  <span className="w-6 h-6 rounded-full bg-elec-yellow/20 text-elec-yellow text-xs flex items-center justify-center">
                  ...
                  <span>
                    <strong>Distribution:</strong> MCB (63-80A, selective RCD if required)
                  </span>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  <span className="w-6 h-6 rounded-full bg-elec-yellow/20 text-elec-yellow text-xs flex items-center justify-center">
                  ...
                  <span>
                    <strong>Final circuit:</strong> MCB + RCD (20-40A, 30mA instantaneous)
                  </span>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  <span className="w-6 h-6 rounded-full bg-elec-yellow/20 text-elec-yellow text-xs flex items-center justify-center">
                  ...
                  <span>
                    <strong>Equipment:</strong> Internal protection in charging unit
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="p-3 rounded bg-transparent border border-red-400/30">
              ...
              <p className="text-sm text-white">
                A commercial car park experienced multiple charger disconnections during faults.
                Investigation found all circuits used 30mA instantaneous RCDs without upstream
                coordination.
              </p>
              <p className="text-sm text-elec-yellow mt-2">
                <strong>Solution:</strong> 300mA S-type RCD upstream with 30mA at individual points.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Type AC RCDs:</strong> — Non-compliant for EV charging
                </li>
                <li>
                  <strong>No discrimination:</strong> — Causes widespread nuisance trips
                </li>
                <li>
                  <strong>Undersized MCBs:</strong> — May trip during normal charging
                </li>
                <li>
                  <strong>Missing SPDs:</strong> — Risk of transient damage to equipment
                </li>
              </ul>
            </div>
          </div>
