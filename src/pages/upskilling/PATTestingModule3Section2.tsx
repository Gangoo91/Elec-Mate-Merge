...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      '1 A, 2 A, 5 A, 10 A',
      '3 A and 13 A only — 5 A is not a BS 1362 rating',
      '6 A, 10 A, 16 A, 20 A',
      '3 A, 5 A, 13 A',
    ],
    correctAnswer: 3,
...
const PATTestingModule3Section2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="PAT M3 · Section 2"
        title="Rewiring and correct fuse ratings"
        backTo="/electrician/upskilling/pat-testing-module-3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          When rewiring is needed, how to size a BS 1362 fuse to the flex, and the cardinal rule
          that keeps appliance leads safe — the fuse must protect the cable.
        </p>
        ...
        <ContentEyebrow>The fuse-to-flex rule — what BS 1362 and BS 1363 are doing</ContentEyebrow>
        ...
        >
          <p>
            ...
            protects the appliance itself. Each device protects what it is sized for. Mis-sizing the
            plug fuse breaks one of those layers.
          </p>
          <p>
            BS 1362 specifies the cartridge fuse used in BS 1363 plugs. The standard ratings made by
            manufacturers and stocked widely are 3 A, 5 A and 13 A. 1 A, 2 A and 7 A also exist but
            are uncommon. The fuse is a high-breaking-capacity (HBC) cartridge — it can interrupt
            fault currents far above its nameplate rating without rupturing.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              flexible cable. The fuse rating should not exceed the current-carrying capacity of the
              flexible cable. Where the manufacturer of the equipment specifies a particular fuse
              rating, that rating shall be followed.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              type, with high breaking capacity, suitable for use in 13 A plugs and connection units
              to BS 1363.
            </>
          }
        ...
        >
          ...
          <p>
            ...
            and the result may not match the table. The flex on the appliance in front of you is the
            fact; the table is the starting point.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="150" y="62" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              Desk lamp · 60 W
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="400" y="62" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              Audio amp · 800 W
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="650" y="62" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              Kettle · 2 kW
            </text>
        ...
        >
            ...
            <table className="w-full text-[13.5px] my-2">
              <thead>
                <tr className="border-b border-white/15">
                  ...
                  <th className="text-center text-white/80 py-2">Typical I rating (3-core PVC)</th>
          ...
          <p>
            For appliances drawing close to 13 A — kettles, fan heaters, irons — heat-resisting flex
            (typically 1.25 mm² or 1.5 mm² with cross-linked or rubber insulation) is the norm. The
            combination of higher current and proximity to a heat source makes ordinary PVC flex
            unsuitable.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              around a pin, damaged cord grip, broken / missing pins. Cut the moulded plug off back
              to undamaged flex, fit a compliant BS 1363 rewireable plug with the correct BS 1362
              fuse for the flex, re-inspect.
            </li>
            <li>
              <strong>Wrong-rating fuse permanently fitted in a moulded plug.</strong> Some moulded
              plugs make fuse change easy; others do not. Where a non-changeable moulded plug
              carries the wrong rating fuse for the flex, conversion to rewireable with the correct
              fuse is the remediation.
            </li>
            <li>
              ...
              conductor and re-terminated, provided the resulting flex is still long enough for the
              appliance’s installed position.
            </li>
            <li>
              <strong>Conversion to a UK plug after import.</strong> Imported equipment fitted with
              a non-UK plug is converted to BS 1363 with the correct fuse. The existing non-UK plug
              is removed entirely (not adapted with a foreign-pattern adaptor in permanent service).
            </li>
          </ol>
          <p>
            Where the flex itself is damaged — outer sheath breached, conductor damaged outside the
            plug, evidence of crushing or melting — rewiring the plug does not fix the underlying
            defect. The lead is replaced.
          </p>
        </ConceptBlock>
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              cleanly through the flex above the moulded body, past any kinking or stretched sheath.
              If re-terminating a rewireable, cut back past any damaged conductor.
            </li>
            <li>
            ...
            <li>
              <strong>Terminate.</strong> Brown to the L terminal (right-hand side, fused side, with
              plug face down). Blue to N (left). Green-and-yellow to E (top). All strands under the
              terminal screw or pillar; no stray strands outside.
            </li>
            <li>
            ...
            <li>
              ...
              visual inspection again — pin condition, cord grip, sheath entry, fuse rating visible
              — before the plug is reconnected.
            </li>
            <li>
              <strong>Re-test.</strong> Continuity, insulation resistance and (where applicable)
              load tests follow per the relevant chapters of M4. The visual inspection is the gate;
              the electrical tests confirm the rewire is sound.
            </li>
          </ol>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              be subjected to mechanical strain. The line and neutral conductors shall be of shorter
              length than the protective conductor. The cord anchorage shall grip the outer sheath
              of the flexible cord and shall not depend on the conductors for its action.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              A label saying &ldquo;replace fuse only with 5 A type&rdquo; means the inspector does
              not fit a 13 A even if the flex would carry it.
            </li>
            <li>
              A label saying &ldquo;3 A&rdquo; on a small appliance with 0.75 mm² flex confirms the
              CoP Table 15.4 default and is followed.
            </li>
            <li>
            ...
            <li>
              If the manufacturer label gives a rating that is higher than the flex rating, that is
              a manufacturing defect on the appliance — investigate, do not blindly fit the higher
              fuse. Refer for engineering inspection if uncertain.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Moulded plug intact, fuse wrong rating</strong> → change the fuse if the plug
              allows; if it does not, convert to rewireable with correct fuse.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              via an approved adaptor only for very short-term use. Permanent use of foreign-pattern
              adaptors is not recommended.
            </>
          }
