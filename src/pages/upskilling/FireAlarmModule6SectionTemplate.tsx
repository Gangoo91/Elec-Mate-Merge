...
const FireAlarmModule6SectionTemplate = ({
  ...
  const faqs = [
    ...
    {
      q: 'How does this relate to BS 5839-1 and BS 7671?',
      a: 'All fire alarm system commissioning and handover in the UK must comply with BS 5839-1 for fire detection systems and BS 7671 for electrical installation requirements. This section covers specific requirements that support compliant commissioning.',
    },
    {
      q: 'What documentation is required for handover?',
      a: 'Full commissioning records, test certificates, as-built drawings, operation and maintenance manuals, and handover certificates are required. Keep records for ongoing maintenance and future modifications.',
    },
  ];
      ...
      <div className="px-4 sm:px-6 py-6 sm:py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8 sm:mb-12">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-elec-yellow/10 border border-elec-yellow/20 mb-4">
              ...
              <span className="text-elec-yellow text-sm font-medium">
                Module 6 • Section {sectionNumber}
              </span>
            </div>
          ...
          <section className="mb-10">
            ...
            {typeof intro === 'string' ? (
              intro.split('\n').map((paragraph, i) => (
                <p key={i} className="text-white leading-relaxed mb-3">
                  {paragraph}
                </p>
              ))
            ) : (
