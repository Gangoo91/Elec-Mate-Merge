...
const DESCRIPTION =
  'Learn about Building Management Systems (BMS): definition, core functions, components, protocols, and why electricians need BMS knowledge.';
...
const faqs = [
  {
    ...
    answer:
      'While basic electrical knowledge is sufficient for most BMS-related work, additional training in building automation and control systems is beneficial. Many manufacturers offer specific training programs for their systems.',
  },
  {
    question: 'Can I damage a BMS by working on connected electrical systems?',
    answer:
      'Yes, improper electrical work can affect BMS operation. Always identify BMS connections before starting work, follow isolation procedures, and coordinate with facilities management when working on integrated systems.',
  },
  {
    question: 'Are there specific regulations governing BMS installations?',
    answer:
      'BMS installations must comply with BS 7671 for electrical work, plus specific standards like BS EN ISO 16484 for building automation systems. Local building regulations may also apply.',
  },
  {
    question: 'How do I know if a building has a BMS?',
    answer:
      'Look for central control panels, multiple sensors throughout the building, integrated lighting controls, and ask facility managers. Modern commercial buildings typically have some form of building automation.',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">Comprehensive introduction to Building Management Systems</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Definition:</strong> Computer-based control system for buildings
              </li>
              <li>
                <strong>Controls:</strong> HVAC, lighting, power, fire, security
              </li>
              <li>
                <strong>Benefits:</strong> 10-30% energy savings, improved comfort
              </li>
              <li>
                <strong>Protocols:</strong> BACnet, Modbus, KNX, LonWorks
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Control panels, sensors, integrated systems
              </li>
              <li>
                <strong>Use:</strong> Installation, troubleshooting, maintenance
              </li>
              <li>
                <strong>Apply:</strong> Compliance, energy management, safety
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A Building Management System (BMS), sometimes called a Building Automation System
              (BAS), is a computer-based control system that monitors and controls the mechanical
              and electrical equipment in a building, including HVAC, lighting, power systems, fire
              systems, and security systems.
            </p>
            <p>
              The BMS acts as the "central nervous system" of modern buildings, collecting data from
              sensors and controlling building services to optimise energy efficiency, occupant
              comfort, and system performance while ensuring safety and regulatory compliance.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Central Processing Unit:</strong> Main controller processing sensor data
                </li>
                <li>
                  <strong>Field Devices:</strong> Sensors, actuators, and local controllers
                </li>
                <li>
                  <strong>User Interface:</strong> Software for monitoring and adjustments
                </li>
                <li>
                  <strong>Communication Network:</strong> Data cables connecting all components
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Automatic scheduling:</strong> Systems operate only when needed
                  </li>
                  <li>
                    <strong>Optimisation:</strong> Continuous adjustment based on occupancy
                  </li>
                  <li>
                    <strong>Monitoring:</strong> Real-time energy consumption tracking
                  </li>
                  <li>
                    <strong>Demand response:</strong> Load shedding during peak periods
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Emergency systems:</strong> Fire alarms, emergency lighting
                  </li>
                  <li>
                    <strong>Regulatory compliance:</strong> Building regulations adherence
                  </li>
                  <li>
                    <strong>Safety monitoring:</strong> Continuous system health checks
                  </li>
                  <li>
                    <strong>Audit trails:</strong> Comprehensive logging for inspections
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                <p className="text-sm font-medium text-white mb-2">
                  Traditional Systems (1970s-1990s)
                </p>
                <ul className="text-sm text-white space-y-1 ml-4">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Modern electricians increasingly encounter BMS during installation, maintenance, and
              troubleshooting work. Understanding these systems is essential for today's electrical
              professionals.
            </p>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Installing BMS Components
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>EMI interference</strong> — running data cables alongside power cables
                </li>
                <li>
                  <strong>Voltage drop</strong> — inadequate cable sizing for long distances
                </li>
                <li>
                  <strong>Poor grounding</strong> — improper earthing of BMS components
                </li>
                <li>
                  <strong>Inaccessibility</strong> — controllers installed in hard-to-reach
                  locations
                </li>
              </ul>
            </div>
        ...
        <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50 mb-10">
          <p className="text-sm text-white">
            <strong className="text-red-400">Safety Warning:</strong> Always isolate electrical
            supplies before working on BMS components. Coordinate with building management to ensure
            safe shutdown procedures and maintain emergency systems operation during maintenance.
          </p>
        </div>
