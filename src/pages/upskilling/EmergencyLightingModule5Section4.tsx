...
const inlineChecks = [
  {
    ...
    options: [
      'Just a number.',
      'A unique luminaire reference (matched to as-built drawing); manufacturer; model; lamp type and wattage; battery installation date (the start of the battery life clock); battery chemistry; circuit reference (the final circuit feeding it); area / location reference. The label is the link between the physical luminaire and the documentation pack — without it, future maintenance cannot identify the right spare, cannot tell battery age, cannot trace circuit. The 2025 standard reinforces the asset-register approach.',
      'Just colour.',
      'Just position.',
    ],
    correctIndex: 1,
    explanation:
      'The luminaire label / asset record turns the physical luminaire into an identifiable asset with a documentation trail. Reference + manufacturer + model + lamp + battery date + chemistry + circuit + location. Each field has an operational purpose; missing fields cost time and money at every future maintenance visit.',
  },
  {
    ...
    options: [
      'It is not.',
      'Because battery life is finite (typically 3-5 years for NiCd, 4-7 years for LiFePO4) and the only reliable way to plan replacement is to track installation dates. Without the date on the label, end-of-life is detected reactively — a duration test fails or a real emergency reveals the failure. With the date on the label, replacement is planned in advance, batteries are ordered, the schedule is kept. The 2025 standard expects this asset-register discipline.',
      'For colour matching.',
      'For weight.',
    ],
    correctIndex: 1,
    explanation:
      'Battery age is the single most predictive failure parameter. Tracking it via labels and asset records turns reactive replacement into planned replacement. The labels are the data; the planning is the use of that data.',
  },
  {
    ...
    options: [
      'Just dates.',
      'Per entry: date and time of test or inspection; type (functional / duration / visual / photometric / fault investigation / repair); scope (whole installation, zone, individual luminaire); method; observations and per-luminaire results (or summary tables for large installations); faults identified; corrective actions; verification re-tests; recovery confirmation (for duration tests); tester / inspector name, qualification, and signature. The logbook is the contemporaneous operational record relied on by insurers, fire authorities, and tribunals.',
      'Just signatures.',
      'Photos.',
    ],
    correctIndex: 1,
    explanation:
      'A logbook entry is a structured record sufficient to reconstruct what was done years later. Date, type, scope, method, observations, faults, corrective action, recovery, signature. The 2025 standard expects this depth; thin entries are inadequate.',
  },
  {
    ...
    options: [
      '6 months.',
      'BS 5266-1:2025 expects logbook records retained for the operational life of the installation. The minimum legally relevant retention under the RRO 2005 is the period for which any incident might still be investigated — typically several years. Insurer-aware practice retains records for the full installation life plus a defined post-decommissioning period (often 6 years). Self-test electronic logs are typically retained indefinitely on the controller; paper logbooks are kept and archived. The retention policy itself should be documented in the building\'s management procedures.',
      '1 day.',
      'Forever immediately.',
    ],
    correctIndex: 1,
    explanation:
      'Retention is a real consideration. The RRO 2005 expects records be available for any future investigation; insurers typically expect 6 years; the 2025 standard expects records to track the operational life of the installation. The policy should be documented and followed.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      'Decoration.',
      'To uniquely identify each emergency luminaire and link it to the documentation pack — the as-built drawing, the design data, the manufacturer manual, the battery age, the circuit, the area. Without it, future maintenance is reactive and inefficient: spare parts cannot be ordered in advance, battery age cannot be tracked, faults cannot be cross-referenced to the design, and the periodic test results cannot be tabulated by luminaire. The label and the record are two ends of the same identification system.',
      'Colour coding.',
      'Decoration only.',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Warning notice for lockable disconnect.',
      'Do-not-switch-off label on supply isolator.',
      'Identification of the system as emergency lighting central battery.',
      'Marketing colour scheme.',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Lamp colour.',
      'Date of last five-year photometric verification — recording when the last point-by-point lux survey was carried out, by whom, and the next due date. The column makes the photometric cycle visible in the logbook so it cannot be silently skipped. Previous logbook templates often had no specific photometric column; the 2025 update adds it as part of the broader emphasis on the periodic photometric being a primary verification, not an optional check.',
      'Cost per luminaire.',
      'Manufacturer phone.',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'A day.',
      'Per the building\'s documented retention policy, typically aligned with the BS 5266-1 logbook retention (operational life of installation, with insurer-aware practice often setting 6 years). The daily checks are evidence of continuous oversight and can be referenced years later in any post-incident review. They are most useful in showing that an incident-day fault was not a longstanding undetected failure — the check book entries before the incident date can demonstrate the system was healthy until the day of the issue.',
      '1 day.',
      'Discard immediately.',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'It looks tidy.',
      'Because the central battery system requires continuous mains supply to keep the batteries charged. If the supply is inadvertently isolated (e.g. by a contractor on unrelated work, or a building user not understanding the function of the isolator), the batteries discharge over time and the system loses its emergency capability. The label is a safety control — it warns anyone considering operating the isolator that doing so will compromise the emergency lighting system, and prompts them to coordinate with the responsible person before any planned isolation.',
      'For colour matching.',
      'Aesthetic.',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'They replace it.',
      'They are integrated AS A COMPONENT of the logbook — the controller log is downloaded periodically (typically monthly) and attached to the BS 5266-1 logbook as an appendix or referenced as a system-of-record. The competent person reviews the log monthly, confirms the cadence has been kept, identifies any failures, signs the BS 5266-1 logbook entry. The visual inspection records, photometric survey records, and BS 7671 verification records remain separate and human-led, joining the controller log to form the complete logbook.',
      'They are paper only.',
      'They are not used.',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'A list of staff.',
      'A structured database (paper or electronic) of every emergency luminaire and every system component, with: unique reference, location, manufacturer, model, lamp/battery details, battery installation date, circuit, photometric design assumption (lux contribution), service history (replacements, faults), and current status. The asset register is the operational backbone — it tells the maintainer everything they need to know about every luminaire without on-site investigation. The 2025 standard reinforces the asset-register approach as the working tool that makes the cadence regime efficient.',
      'A photo album.',
      'A receipt file.',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Decoration.',
      'It supports asset identification (every luminaire visible with its location and any neighbouring features for orientation), maintenance dispatch (a contractor attending a fault knows what to expect before arrival), insurer evidence (the system as installed is recorded photographically), and dispute resolution (any later claim about original installation can be checked against the photographs). The photographic asset record is best done at commissioning when the installation is in its as-handed-over state, with each photograph cross-referenced to the as-built drawing.',
      'Marketing.',
      'Random.',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      ...
      'Two label types are typical. The MANUFACTURER label (factory-fitted) shows manufacturer, model, lamp type and wattage, batch / serial number, and standards compliance (CE / UKCA mark, BS EN 60598 reference). The INSTALLATION label (added by installer) shows the unique luminaire reference, the area, the circuit reference, and the battery installation date (so the battery clock is visible at the luminaire). Together they identify the asset and connect it to the design.',
      'Nothing.',
      'Cost.',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'No reason.',
      'Because in the absence of strong documentation expectations, some installations were maintained on assumed knowledge that was lost when staff changed, contractors changed, or buildings changed hands. The 2025 update treats documentation as load-bearing — the asset register, the labelled luminaires, the contemporaneous logbook, the photographic record, and the structured handover pack together form the operational memory. Insurers, fire authorities, and tribunals increasingly expect this evidence base; the 2025 update aligns the standard with that expectation.',
      'For sales.',
      'Random.',
    ],
    correctAnswer: 1,
