...
const inlineChecks = [
  {
    ...
    question:
      'What is the minimum information that should appear on a luminaire label / asset record?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 5,
    question:
      'Why is "do-not-switch-off" labelling on the central battery supply isolator important?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'Self-test electronic logs are stored on the central addressable controller. How are they integrated with the BS 5266-1 logbook?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'A photographic record of every luminaire is increasingly common at handover. What does it support?',
    options: [
  ...
  },
  {
    id: 9,
    question:
      'What information is shown on a typical emergency luminaire label fixed at the luminaire itself?',
    options: [
  ...
  },
  {
    id: 10,
    question:
      'Why does BS 5266-1:2025 strengthen the documentation expectations relative to previous editions?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The documentation backbone of an emergency lighting installation: luminaire labels and
          asset register, central battery warning notices, photographic record, and the BS
          5266-1:2025 logbook structure (with the new five-year photometric column). The records are
          not bureaucracy — they are the operational memory that makes the periodic regime work and
          the compliance evidence that insurers and fire authorities expect.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Unique luminaire reference.</strong> Matches the as-built drawing. Format is
              design-team choice — typical patterns: EL-001, EL-002... or area-based EL-G-01,
              EL-G-02 (where G = Ground floor).
            </li>
            <li>
              <strong>Manufacturer.</strong> The maker. Identifies the spare parts catalogue, the
              technical manual, and the warranty contact.
            </li>
            <li>
              <strong>Model.</strong> The specific product type. Determines spare lamp / battery
              part number.
            </li>
            <li>
              <strong>Lamp type and wattage.</strong> Identifies the replacement lamp. For LED
              luminaires (most modern installations), the lamp is integrated with the luminaire; the
              model number is sufficient.
            </li>
            <li>
              <strong>Battery chemistry.</strong> NiCd / NiMH / LiFePO4 / SLA. Determines
              replacement battery part. Different chemistries are not interchangeable — substituting
              wrong chemistry damages charging electronics.
            </li>
            <li>
              <strong>Battery installation date.</strong> The start of the battery life clock.
              Critical for planned replacement — typical lives are 3-5 years for NiCd, 4-7 years for
              LiFePO4. The date on the label tells the maintainer at a glance whether the battery is
              mid-life, late-life, or end-of-life.
            </li>
            <li>
              <strong>Circuit reference.</strong> The final circuit feeding the luminaire (e.g.
              DB-G/4 = Distribution board G, way 4). Lets a fault investigation start at the right
              circuit.
            </li>
            <li>
              <strong>Area / location reference.</strong> Where the luminaire is in the building —
              corridor, room, level. Cross-references to the design lux calculation grid.
            </li>
          </ul>
          <p>
            The two labels are typically applied: manufacturer label on the luminaire body (factory)
            and installation label on a fixed surface inside or beside the luminaire enclosure
            (added at commissioning). Both must be readable during routine maintenance access.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Each emergency luminaire shall be uniquely identified and labelled with reference to
              the as-built drawings and the maintenance records. The label shall include sufficient
              information to enable maintenance personnel to identify the luminaire, its
              specifications, and its supply circuit without recourse to off-site documentation.
              Battery installation date shall be recorded on the luminaire or in an associated
              record clearly linked to the luminaire by reference.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Battery: chemistry, capacity (Ah or Wh), installation date, expected end-of-life.
            </li>
            <li>Circuit reference, distribution board reference, protective device.</li>
            <li>
              Location: building, floor, area / room, mounting position (height, orientation).
            </li>
            <li>Photometric design assumption: design lux contribution at design grid points.</li>
            <li>
              Class (maintained / non-maintained / sustained), response class (0.5 s / 5 s / 15 s),
              rated duration.
            </li>
          ...
          <p>
            The register is comprehensive but maintainable — most fields are static (manufacturer,
            model, location) and rarely change; dynamic fields (battery date, status, service
            history) are updated at maintenance visits. Modern facilities management software can
            present the register as a queryable database; legacy spreadsheets work for smaller
            installations.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            {/* Left half — labels */}
            <text x="40" y="36" fill="#FBBF24" fontSize="13" fontWeight="bold">
              Luminaire labels
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="58" y="78" fill="#22D3EE" fontSize="11" fontWeight="bold">
              Manufacturer label (factory)
            </text>
            <text x="58" y="100" fill="rgba(255,255,255,0.85)" fontSize="10">
              EL-PRO 8000-LED
            </text>
            <text x="58" y="116" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              Acme Lighting Ltd
            </text>
            <text x="58" y="132" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              LED 6 W · 320 lm · 4000 K
            </text>
            <text x="58" y="148" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              BS EN 60598 · CE · UKCA
            </text>
            <text x="58" y="164" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              Battery: NiCd 4.8 V 800 mAh
            </text>
            <text x="58" y="180" fill="rgba(255,255,255,0.55)" fontSize="9">
              Serial: 230412-A4823
            </text>
            <text x="58" y="196" fill="rgba(255,255,255,0.55)" fontSize="9">
              Manuf. 2026-01
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="58" y="248" fill="#FBBF24" fontSize="11" fontWeight="bold">
              Installation label (commissioning)
            </text>
            <text x="58" y="270" fill="rgba(255,255,255,0.85)" fontSize="11" fontWeight="bold">
              EL-G-014
            </text>
            <text x="58" y="286" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              Ground · Reception corridor
            </text>
            <text x="58" y="302" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              Circuit: DB-G/4
            </text>
            <text x="58" y="318" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              Class: maintained · 5 s · 3 h
            </text>
            <text x="58" y="338" fill="#FBBF24" fontSize="10" fontWeight="bold">
              Battery installed: 2026-04-15
            </text>
            <text x="58" y="354" fill="rgba(251,191,36,0.7)" fontSize="9">
              expected end-of-life 2030
            </text>
            <text x="58" y="378" fill="rgba(255,255,255,0.55)" fontSize="9">
              As-built drawing ref: EL-AB-12
            </text>
            <text x="58" y="394" fill="rgba(255,255,255,0.55)" fontSize="9">
              Asset reg: AR-EL-014
            </text>
            <text x="58" y="410" fill="rgba(255,255,255,0.55)" fontSize="9">
              Photo: P-EL-014.jpg
            </text>
            ...
            <text x="200" y="510" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              references → asset register
            </text>
            <text x="200" y="524" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9">
              → as-built drawing
            </text>
            <text x="200" y="538" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9">
              → design lux calculation
            </text>
            <text x="200" y="552" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9">
              → logbook entries
            </text>

            {/* Right half — logbook */}
            <text x="430" y="36" fill="#FBBF24" fontSize="13" fontWeight="bold">
              BS 5266-1:2025 logbook columns
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="450" y="76" fill="#FBBF24" fontSize="9.5" fontWeight="bold">
              Date Type Scope Method Result Faults Corr. action 5-yr photo Sig.
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="450" y="118" fill="rgba(255,255,255,0.85)" fontSize="9.5" fontWeight="bold">
              2026-04-04 · Functional · whole · 10-min sim · all pass
            </text>
            <text x="450" y="132" fill="rgba(255,255,255,0.65)" fontSize="9">
              no faults · n/a · 2026-04 due 2031-04 · J. Smith
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="450" y="170" fill="rgba(255,255,255,0.85)" fontSize="9.5" fontWeight="bold">
              2026-10-25 · Duration · whole · 3-h discharge · all pass
            </text>
            <text x="450" y="184" fill="rgba(255,255,255,0.65)" fontSize="9">
              recovery 19 h to 80% · n/a · J. Smith
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="450" y="222" fill="rgba(255,255,255,0.85)" fontSize="9.5" fontWeight="bold">
              2026-10-25 · Photometric · escape route · lux survey
            </text>
            <text x="450" y="236" fill="rgba(255,255,255,0.65)" fontSize="9">
              all ≥ design · 2026-10 next 2031-10 · J. Smith
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="450" y="274" fill="rgba(255,255,255,0.85)" fontSize="9.5" fontWeight="bold">
              2026-11-12 · Reactive · EL-G-014 · battery fail
            </text>
            <text x="450" y="288" fill="rgba(255,255,255,0.65)" fontSize="9">
              batt replaced 2026-11-12 · n/a · J. Smith
            </text>
            ...
            <text
              ...
              fontWeight="bold"
            >
              ⚠ NEW 2025: 5-year photometric column
            </text>
            <text x="615" y="354" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              Surfaces the photometric cadence in the everyday logbook
            </text>
            <text x="615" y="368" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              Date of last + next due — cannot be silently skipped
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="450" y="414" fill="#22D3EE" fontSize="10" fontWeight="bold">
              Retention
            </text>
            <text x="450" y="430" fill="rgba(255,255,255,0.7)" fontSize="9">
              BS 5266-1:2025 · operational life of installation
            </text>
            <text x="450" y="444" fill="rgba(255,255,255,0.7)" fontSize="9">
              Insurer-aware practice: 6 yr post-decommissioning
            </text>

            {/* Footer */}
            <text x="410" y="490" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9">
              The label points the maintainer to the asset register · the asset register is the
              index into the logbook
            </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Lockable supply isolator.</strong> The isolator that feeds the central battery
              from the building supply must be lockable in the ON position. The lock prevents
              unauthorised isolation. The label adjacent reads "EMERGENCY LIGHTING SUPPLY — DO NOT
              SWITCH OFF" or equivalent. The lock has documented key control.
            </li>
            <li>
              <strong>Do-not-switch-off label on the isolator handle.</strong> Even with the lock,
              an additional warning label on the isolator handle reinforces the message.
            </li>
            <li>
              <strong>System identification on the central battery enclosure.</strong> The enclosure
              carries a label identifying the system as emergency lighting central battery, with
              reference to the design and to the responsible person's contact. Anyone encountering
              the enclosure understands what it is and who is responsible.
            </li>
            <li>
              <strong>Fire-rated enclosure marking.</strong> Where the central battery is housed in
              a fire-rated enclosure (typically a separate fire-rated room), the door carries the
              fire rating (e.g. FD60, FD120) and a "KEEP CLOSED" or "FIRE DOOR — KEEP LOCKED" label
              per the design.
            </li>
            <li>
              <strong>Output sub-circuit labels.</strong> The central battery distributes via
              sub-circuits to slave luminaires across the building. Each sub-circuit at the central
              battery is labelled with the area it feeds, the circuit reference, and the design
              load.
            </li>
            <li>
              <strong>Battery hazard warnings.</strong> The battery enclosure carries the
              appropriate hazard warnings — chemistry-specific (e.g. "lead-acid — corrosive
              electrolyte" for SLA, "lithium — fire risk if damaged" for LiFePO4), voltage warning
              (where the system DC voltage is hazardous), and PPE requirements for any maintenance.
            </li>
            <li>
              <strong>Test facility identification.</strong> Where a test facility (key-operated
              test switch, test mode button on the panel) is provided, it is labelled with its
              function and the operating procedure.
            </li>
          </ul>
          <p>
            The labels are not bureaucracy — they are the safety control that prevents inadvertent
            operation. A facility manager moving lightbulb-changing contractors through the building
            can point to the labelled lockable isolator and the warning notices and brief them not
            to operate it without coordination. The labels are the operational interface to the
            safety system.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The central power system shall be clearly identified as serving emergency lighting.
              Warning notices shall be provided at the supply isolator stating that the supply must
              not be interrupted other than under controlled conditions, at the battery enclosure
              indicating any hazards associated with the battery chemistry, and at any test facility
              identifying the function of the controls.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Date and time.</strong> When the activity took place. Start and end times for
              substantial activities (duration tests).
            </li>
            <li>
              <strong>Activity type.</strong> Functional test / duration test / visual inspection /
              photometric survey / fault investigation / repair / battery replacement /
              commissioning. Specific.
            </li>
            <li>
              <strong>Scope.</strong> What was covered — whole installation / specific zone /
              specific circuit / individual luminaire (with reference). For a partial test, document
              why.
            </li>
            <li>
              <strong>Method.</strong> How the activity was carried out — circuit interrupted / test
              facility used / central battery test mode / controller-initiated / lux meter survey at
              design grid. Sufficient to allow reconstruction.
            </li>
            <li>
              <strong>Observations / results.</strong> Per-luminaire results (in summary tables for
              large installations; per-luminaire detail for fault investigations). Self-test
              electronic logs as appendix.
            </li>
            <li>
              <strong>Faults identified.</strong> Any luminaire or system that did not pass.
              Reference, observation, suspected cause.
            </li>
            <li>
            ...
            <li>
              <strong>5-year photometric column (NEW 2025).</strong> Date of last photometric
              verification and date next due. Surfaces the photometric cadence in the everyday
              logbook.
            </li>
            <li>
              <strong>Tester / inspector.</strong> Name, qualification, signature. The competent
              person.
            </li>
            <li>
          ...
          <p>
            The logbook can be paper or electronic. Modern self-test installations typically use the
            central addressable controller as the electronic logbook for the automated test results,
            with the human-led elements appended separately. Either format is acceptable; what
            matters is contemporaneous creation, completeness of fields, and signature by the
            competent person.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The responsible person shall keep a record of any maintenance, testing, or other
              measures taken under the Order in respect of the premises, and shall make these
              records available for inspection by the relevant authority. Records shall be retained
              for the period during which the measures relate to the premises and for such further
              period as may be necessary for any investigation.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Asset identification.</strong> A maintainer attending a fault on a specific
              luminaire reference can pull up the photograph to see exactly what they will encounter
              — type, mounting, accessibility, surroundings. Reduces wasted journeys for the wrong
              spare or wrong access equipment.
            </li>
            <li>
              <strong>Verification of installation.</strong> Comparing as-installed against design
              intent — the photographs confirm the luminaire was actually mounted where the design
              specified and at the design height.
            </li>
            <li>
              <strong>Insurer / fire authority evidence.</strong> Photographs are tangible evidence
              of the system as installed. They support the acceptance certificate by giving the
              auditor visual confirmation.
            </li>
            <li>
              <strong>Dispute resolution.</strong> Any later dispute about original installation
              (e.g. an insurance claim raising whether a luminaire was correctly positioned) can be
              settled by reference to the commissioning photographs.
            </li>
            <li>
              <strong>Post-incident investigation.</strong> Compares the system as-installed to the
              system as found at the incident — identifies any changes (damage, removal,
              modification).
            </li>
          </ul>
          <p>
            Production cost is low — a single competent photographer with a good camera can
            photograph a 200-luminaire installation in a day. The photographs are filed in a
            structured folder (one per luminaire, named by reference) and indexed against the asset
            register. Modern installations sometimes use 360° photography or video walk-throughs for
            further context. The investment pays back across years of operation.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>BS 5266-1 logbook.</strong> Operational life of the installation, plus 6 years
              post-decommissioning for insurer-aware practice. Typical commercial installation life
              15-25 years, so logbooks may be retained for 25+ years.
            </li>
            <li>
              <strong>Asset register.</strong> Same as logbook — operational life plus
              post-decommissioning. The register is typically a single living document updated
              continuously; archive snapshots at major milestones (commissioning, each EICR,
              decommissioning).
            </li>
            <li>
              <strong>Daily check book.</strong> Operational life plus 6 years post-decommissioning,
              aligned with logbook. Volume is small (a small notebook per year typical).
            </li>
            <li>
              <strong>Self-test electronic logs.</strong> Typically retained indefinitely on the
              controller (storage cost is trivial). Periodic exports to long-term archive.
            </li>
            <li>
              <strong>Photometric survey records.</strong> Operational life plus 6 years
              post-decommissioning. Each survey is the baseline for the next; never discard the most
              recent.
            </li>
            <li>
              <strong>Acceptance certificate, design drawings, manuals.</strong> Permanent retention
              until decommissioning, plus 6 years post-decommissioning. These are the foundational
              documents — destroy too early and the installation cannot be properly maintained.
            </li>
            <li>
              <strong>Fault investigation records.</strong> 6 years minimum from the date of
              investigation, longer where the fault has ongoing implications.
            </li>
          </ul>
          <p>
            The retention policy itself should be documented in the building management procedures
            so that staff turnover does not result in records being inadvertently disposed of. The
            cost of retention is low (digital archive, a box of paper); the cost of premature
            disposal can be substantial in any future investigation.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Pre-commissioning preparation.</strong> The asset register template is set up
              (spreadsheet rows or facilities management software records, one per luminaire from
              the as-built drawing). Installation label templates are designed (matching format,
              weatherproof, ready to print). Photograph naming convention agreed.
            </li>
            <li>
              <strong>Visual / mechanical inspection pass.</strong> While walking the as-built
              drawing for the BS 5266-1 visual inspection, the inspector confirms each luminaire
              matches the design, applies the installation label (with the unique reference, area,
              circuit, battery date), and takes a photograph. The asset register row is populated
              with the manufacturer details and the installation details.
            </li>
            <li>
              <strong>BS 7671 verification pass.</strong> Continuity, IR, polarity, Zs at each
              accessible point — the asset register row is updated with the recorded values for that
              luminaire.
            </li>
            <li>
              <strong>Photometric pass.</strong> Lux meter readings on the design grid — the asset
              register photometric row is updated with the design assumption for that luminaire and
              any contribution to specific design grid points.
            </li>
            <li>
              <strong>Switch-on pass.</strong> Per-luminaire response time observation — recorded
              against the asset register row.
            </li>
            <li>
              <strong>Duration pass.</strong> Per-luminaire end-of-test observation — recorded
              against the asset register row.
            </li>
            <li>
              <strong>Handover.</strong> The asset register, the labelled luminaires, the
              photographs, the logbook (with the commissioning entry referenced), and the acceptance
              certificate together form the handover documentation pack.
            </li>
          </ul>
          <p>
            The integrated workflow is standard in installations carried out by BAFE
            SP203-4-registered contractors. Non-registered contractors sometimes treat documentation
            as a post-hoc exercise; the result is gaps, inconsistencies, and rework. The 2025
            standard implicitly favours the integrated workflow by demanding completeness across all
            the documentation elements at handover.
          </p>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            ...
            {
              question:
                'How do I label a luminaire that is hard to access (high ceiling, sealed enclosure)?',
              answer:
            ...
            {
              question:
                "How does the responsible person verify the contractor's logbook entries are honest?",
              answer:
            ...
            {
              question:
                'Can the asset register be replaced by the central addressable controller database?',
              answer:
        ...
        <Quiz
          title="System labelling and maintenance records — Module 5.4"
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() =>
              navigate('/electrician/upskilling/emergency-lighting-module-5-section-5')
            }
