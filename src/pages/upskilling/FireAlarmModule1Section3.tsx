    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS 5839-1:2025 Category M: manual call points only with no automatic detection. When M is
          appropriate, the 2025 MCP siting and mounting clarifications, transparent protective
          covers, sounder use for non-fire signals, and the remote indicator colour rule.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              attended hours, with high staff alertness and direct lines of sight, and where the FRA
              concludes attended observation provides earlier warning than detector response would.
            </li>
            <li>
              <strong>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Any premises with sleeping use — occupants asleep cannot observe a fire to operate an
              MCP. L category is required.
            </li>
            <li>
            ...
            <li>
              Premises with high ignition load — kitchens, plant rooms, equipment-intensive spaces;
              the ignition risk outpaces manual observation.
            </li>
            <li>
              Premises with restricted-mobility occupants or vulnerable occupants — early warning is
              essential.
            </li>
            <li>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="410" y="85" textAnchor="middle" fill="#FBBF24" fontSize="12" fontWeight="bold">
              PROTECTED AREA
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="420" y="304" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              EXIT
            </text>
            ...
            <g>
              ...
              <text x="723" y="232" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
                panel
              </text>
            </g>
            ...
            <text x="410" y="354" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              the FRA, the building geometry or the occupant profile justifies it. A kitchen with an
              active deep-fat fryer warrants an MCP much closer than 30 m. A room used principally
              by mobility-impaired occupants warrants closer placement.
            </li>
            <li>
              <strong>Final exits and routes.</strong> An MCP at every final exit is good practice
              and frequently required by the FRA — occupants leaving the building should be able to
              trigger the alarm as they exit. Routes from rooms to final exits should pass an MCP
              within the distance limits.
            </li>
            <li>
              <strong>Stairway landings.</strong> MCPs on stairway landings (other than at the final
              exit level) are now (per 12.1 a)) incorporated within the ZONE that serves the
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              line and 45 m actual travel distance. As these are the maximum distances, they can be
              shorter if the designer deems it necessary. If manual call points are located on the
              landings of a stairway (see 19.4), the manual call point on each level, other than a
              final exit level from the stairway, should be incorporated within the zone that serves
              the adjacent accommodation on that level.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Accessibility.</strong> Where wheelchair access is the primary consideration,
              the lower end of the tolerance window (1.1 m to 1.2 m) is appropriate. Approved
              Document M (Building Regulations) provides additional accessibility guidance.
            </li>
            <li>
              <strong>Wall finish and surround.</strong> Decorative surrounds, picture rails, tiling
              that boxes around the MCP, signage adjacent — all can affect the visible MCP\'s
              effective height and approachability. The standard\'s tolerance is to the MCP
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              height being 200 mm higher than 1.4 m, and 300 mm lower than 1.4 m.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              tools. Covers requiring a key or special tool to remove DEFEAT the purpose of the MCP
              being operable in seconds.
            </li>
            <li>
            ...
            <li>
              <strong>Robustness.</strong> The cover is a high-touch item; it must withstand routine
              handling, cleaning, knocks. A flimsy cover that breaks on first malicious activation
              is no protection.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              now recommended to be transparent.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              identical to that required in the event of fire — i.e. immediate evacuation by use of
              all escape routes. An emergency-evacuation tone for any reason can use the fire
              sounders.
            </li>
            <li>
              <strong>School class-change.</strong> Permissible to use fire sounders for the start
              or finish of predetermined periods (lessons). Duration limited to 10 seconds (extended
              from 5 seconds in the 2017 edition because addressable systems can take longer to
              propagate the signal).
            </li>
            <li>
              <strong>Lockdown.</strong> Acknowledged as common practice in schools; design follows
              FIA guidance ("Use of fire alarm systems for lockdown — specifically in schools"). The
              lockdown signal must clearly distinguish itself from the fire signal so occupants
              respond appropriately.
            </li>
            <li>
              <strong>Distinct tones / messages.</strong> Each non-fire use must have a tone or
              voice message distinct from the fire tone, so occupants can identify the warning type
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Wiring.</strong> Two-wire connection from the associated detector or MCP; the
              indicator should activate when the device activates (latched until the system resets).
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              correct operation at the annual service visit to ensure they have not been obstructed
              or painted over.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Functional-earth conductor.</strong> Pink or marked 'FE'. Was cream; cream is
              no longer the convention from BS 7671 A2:2022 onwards.
            </li>
            <li>
              <strong>Cable grade.</strong> Fire-resisting cable to the appropriate BS EN 50200 / BS
              8434 / BS 8491 grade. Selection of grade depends on the building category and whether
              the cable supports critical-function circuits (sounders, control links).
            </li>
            <li>
              <strong>Battery labelling.</strong> Date of installation must be visible. Permanent
              marker on the battery is acknowledged custom and practice. Annual service should also
              record battery condition and replace at end-of-life.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              resistant cable to the same grade as the fire detection and fire alarm system, it was
              never clear in the 2017 revision of BS 5839-1 what colour it should be. This has been
              clarified in the 2025 revision to emphasise that all fire alarm cables, and the low
              voltage mains supply should be of a single, common colour with the colour red being
              preferred. Batteries should have a label fixed to them showing the date of
              installation.
            </>
          }
        ...
        <FAQ
          items={[
            ...
            {
              question: 'How does an M-only system differ from an L4 system in installation cost?',
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-1/section-4')}
