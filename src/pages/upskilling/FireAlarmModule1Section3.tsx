...
const DESCRIPTION =
  'Learn about BS 5839-1 M category manual fire alarm systems: when they are appropriate, limitations, and compliance requirements.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'M category systems rely on manual call points (MCPs) and sounders only, with no automatic detection.',
  },
  {
    id: 'm-category-appropriate',
    question:
      'A small office has 6 staff working 9-5 in an open-plan layout. At night and weekends the office is empty. Is M category appropriate?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'M alone may not be appropriate as the premises are unoccupied outside working hours. An L category with automatic detection would provide protection when the building is empty.',
  },
  {
    id: 'm-upgrade-required',
    question:
      'An office with M category is converting to a boutique hotel with 8 bedrooms. What action is required?',
    options: [
      'No change needed',
    ...
    correctIndex: 2,
    explanation:
      'The M system must be upgraded to at least L2 (probably L1) to provide automatic detection for sleeping accommodation. The existing MCPs can remain as part of the upgraded system.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'M category may be suitable where risk is low, space is continuously occupied, and occupants can quickly raise the alarm.',
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'Sleeping risk requires automatic detection as occupants may not be awake to discover and report a fire.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'M systems depend entirely on humans noticing a fire and activating a call point, delaying warning until discovery.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'MCPs should be positioned on escape routes so occupants can raise the alarm while evacuating.',
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation:
      'BS 5839-1 recommends MCPs be positioned so that no one needs to travel more than 45m to reach one.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'Sounders must achieve 65 dB(A) minimum throughout, or 75 dB(A) at bed head level where sleeping risk exists.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'M is often combined with L or P categories - MCPs supplement automatic detection for manual alarm raising.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'At least one MCP should be tested weekly, rotating through all call points over time.',
  },
  {
    id: 10,
    question:
      'If a building currently has M category but changes to sleeping use, what is required?',
    options: [
      'No change needed',
    ...
    correctAnswer: 1,
    explanation:
      'Sleeping accommodation requires automatic detection - the system must be upgraded to L1, L2, or appropriate L category.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Rarely - most buildings now require some automatic detection. M is often combined with L or P categories.',
  },
  {
    question: 'Can I add a few smoke detectors to an M system?',
    answer:
      'Yes - this would make it a combined category. Document clearly which areas have automatic detection.',
  },
  {
    question: 'Do MCPs need to be glass break type?',
    answer:
      'Not necessarily - resettable MCPs are available. Glass break remains common and familiar to users.',
  },
  {
    question: 'What is the minimum number of MCPs for M category?',
    answer:
      'No fixed minimum - positioning is based on travel distance (45m max) and exit/landing locations.',
  },
  {
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>M category:</strong> Manual call points + sounders only
              </li>
              <li>
                <strong>No automatic:</strong> Detection relies on humans
              </li>
              <li>
                <strong>Suitable:</strong> Low-risk, continuously occupied premises
              </li>
              <li>
                <strong>Not suitable:</strong> Sleeping accommodation or unoccupied periods
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Sleeping risk = M not suitable
              </li>
              <li>
                <strong>Use:</strong> 45m max travel to any MCP
              </li>
              <li>
                <strong>Apply:</strong> Review when building use changes
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              M category is a manual-only fire alarm system consisting of manual call points (MCPs),
              alarm sounders, and a fire alarm control panel. There is no automatic detection.
            </p>
            ...
            <p>
              The system relies entirely on human detection - someone must see, smell, or otherwise
              notice a fire and then manually activate a call point.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>M category may be acceptable where all of the following apply:</p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">Suitability Criteria:</p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Low fire risk</strong> - minimal fire load and ignition sources
                </li>
                <li>
                  <strong>Continuously occupied</strong> - people present to detect fire
                </li>
                <li>
                  <strong>Simple layout</strong> - fire visible from occupied areas
                </li>
                <li>
                  <strong>No sleeping</strong> - occupants awake and alert
                </li>
                <li>
                  <strong>Trained occupants</strong> - know how to raise alarm
                </li>
              </ul>
            </div>

            <p>
              Typical examples include small single-storey offices with open-plan layout and
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm font-medium text-white mb-2">
                M Category Is NOT Suitable When:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Manual call points must be positioned so occupants can easily reach one while
              evacuating.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Alarm sounders must achieve adequate sound levels throughout the building.</p>
            ...
            <p>Even M systems with no sleeping risk must achieve 65 dB(A) minimum throughout.</p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>M category must be upgraded to an L category when:</p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Always question whether M is truly appropriate - err on the side of automatic
                  detection
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Specifying M to save cost</strong> - when automatic detection is needed
                </li>
                <li>
                  <strong>Not upgrading when building use changes</strong> - to include sleeping
                </li>
                <li>
                  <strong>Assuming small or simple means M is suitable</strong> - always assess
                  properly
                </li>
              </ul>
            </div>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/electrician/upskilling/fire-alarm-course/module-1/section-2">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous Section
            </Link>
          </Button>
          <Button
            ...
            asChild
          >
            <Link to="/electrician/upskilling/fire-alarm-course/module-1/section-4">
              Next Section
