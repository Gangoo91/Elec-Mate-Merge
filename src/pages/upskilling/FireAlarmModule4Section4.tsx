    ...
    <HubPage>
      ...
      <HubBody>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              straighten as it softens), and the support nearest the bend takes the sustained load.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              the cable is retained in its installed position for the duration corresponding to its
              PH classification. Supports shall be of fire-resistant materials (typically metallic)
              capable of retaining their mechanical function throughout the cable&apos;s rated
              fire-survival period. Plastic cable clips, ties or fixings shall not be used as the
              sole means of support for fire-resistant cable systems. Support intervals shall be in
              accordance with the cable manufacturer&apos;s technical data and the application
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="2"
            />
            <text x="80" y="226" textAnchor="middle" fill="#22D3EE" fontSize="12" fontWeight="bold">
              CIE
            </text>
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="200" y="62" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              support at bend
            </text>
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="387" y="35" textAnchor="middle" fill="#D97706" fontSize="9" fontWeight="bold">
              FR wall
            </text>
            <circle
              cx="387"
            ...
            <rect
              ...
              strokeDasharray="4,3"
            />
            <text x="680" y="58" textAnchor="middle" fill="#A855F7" fontSize="10" fontWeight="bold">
              CEILING VOID
            </text>
            <circle
              cx="680"
              ...
              strokeWidth="1.8"
            />
            <text x="680" y="96" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              det.
            </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              cable tray. Metal containment retains its mechanical strength at the temperatures the
              cable is designed to survive. Plastic trunking is not acceptable for fire-rated cable
              systems — it softens and collapses early in fire, dropping the cable.
            </li>
            <li>
              <strong>Fire-rated brackets.</strong> The brackets that support the containment must
              themselves be fire-rated to match the cable category. A steel basket on plastic-fixing
              brackets is the same failure mode as a cable on plastic clips — the brackets fail, the
              basket falls, the cable goes with it.
            </li>
            <li>
            ...
            <li>
              <strong>Fixings into the substrate.</strong> Where brackets fix into a wall or ceiling
              slab, the fixings (anchors, bolts) are themselves fire-rated. Generic
              plastic-plug-and-screw fixings are not adequate; specific fire-rated anchors (rated by
              BS EN test methods) are specified.
            </li>
            <li>
              <strong>Cable category preservation.</strong> Where multiple categories of fire alarm
              cable share the same containment, the segregation within the containment is designed
              in. Some installations use separate compartments; some use fire-rated barriers; the
              design records specify which.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              part of the trunking construction, not added afterwards. Common in commercial fit-outs
              where running separate trunking is impractical.
            </li>
            <li>
              <strong>Separate cable trays.</strong> Adjacent trays or stacked trays with a vertical
              separation maintained. The trays are separate; the brackets may be shared. Spacing
              between trays sufficient to prevent thermal / mechanical interaction in fire.
            </li>
            <li>
              ...
              divider) creates a separated zone within the containment. The barrier must be rated to
              match the cable category and installed to the manufacturer&apos;s tested-system
              specification.
            </li>
            <li>
          ...
          <p>
            Segregation is documented in the design records — the chosen method, the rationale, the
            specific dimensions and barriers. At inspection the segregation is verified against the
            design intent. Loss of segregation (e.g. a barrier removed during later works, a
            partition broken to add a cable) is a remediation action.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              Segregation shall be by separation through use of separate cable enclosures, by use of
              fire-rated partitions within a common enclosure, or by spatial separation sufficient
              to ensure that a fault on a non-safety circuit does not adversely affect a safety
              circuit. Cables of fire detection and fire alarm systems shall be identifiable and
              shall be installed such that, as far as reasonably practicable, a fire affecting any
              part of the general electrical installation does not adversely affect the operation of
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Topology.</strong> Cable forms a closed loop from the CIE, around all devices,
              and back to the CIE. The CIE has connections at both ends of the loop.
            </li>
            <li>
            ...
            <li>
              <strong>Single open fault.</strong> The loop becomes two unidirectional spurs. The CIE
              polls one spur from one end, the other spur from the other end. ALL devices remain
              operational and supervised. Fault is reported to the CIE; protection is not lost.
            </li>
            <li>
              <strong>Single short fault.</strong> Isolators on the loop (typically every 32 devices
              or per the design) clamp the short by isolating the affected segment. Devices outside
              the isolated segment remain operational. Fault reported; protection preserved for most
              of the loop.
            </li>
            <li>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Normal operation.</strong> CIE polls each device through the radial; the full
              radial is supervised.
            </li>
            <li>
              <strong>Single open fault.</strong> All devices BEYOND the fault are isolated from the
              CIE. They no longer report; they are no longer supervised. The CIE indicates a fault;
              protection is lost beyond the fault location until the cable is repaired.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              (open circuit or short circuit) on the wiring does not prevent the rest of the circuit
              from continuing to operate. This requirement is met by Class A loop topology with
              bidirectional CIE communication and segment isolators at appropriate intervals. Class
              B (radial / spur) topology may be used for sub-circuits where the design analysis
              permits and the consequence of single-fault loss is acceptable.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              acceptable; the manufacturer&apos;s fire-rated junction box product line is the right
              choice.
            </li>
            <li>
              <strong>Accessible.</strong> The joint box is positioned so a maintainer can reach it
              for inspection or repair. Buried in walls, sealed within voids, or otherwise
            ...
            <li>
              <strong>Identified.</strong> The joint box has an external identifier (label, marking)
              that distinguishes it as a fire-alarm joint. Future works in the area will then know
              the box is part of the fire alarm system.
            </li>
            <li>
              <strong>Logged.</strong> The joint location is recorded in the as-installed drawings
              and the system logbook. Future maintenance has a complete picture of the cable system,
              including where joints exist.
            </li>
          </ul>
          <p>
            Joints introduced as installation conveniences (rather than design necessities) are the
            worst case. They typically end up unrated, undocumented, and inaccessible, with no
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-4/section-5')}
