...
const IndustrialElectricalModule1Section5: React.FC = () => {
  useSEO({
    ...
    description:
      'Master industrial earthing and bonding strategies including TN-S/TN-C-S systems, earth fault loop impedance, lightning protection, and clean earth systems per BS 7671 Chapter 54.',
    keywords: [
      'industrial earthing',
      'bonding strategies',
      'TN-S system',
  ...
  const quickCheckQuestions = [
    {
      ...
      correctIndex: 1,
      explanation:
        'In a TN-S (Terre-Neutre-Separe) system, the earth is provided via a separate protective conductor from the supply transformer. This gives a dedicated earth path with typically low impedance, making it ideal for industrial installations requiring reliable fault clearance.',
    },
    {
      id: 'qc2-bonding-requirement',
      question:
        'What is the minimum cross-sectional area for main protective bonding conductors to extraneous-conductive-parts in a TN system with 25mm squared line conductors?',
      options: ['4mm squared', '6mm squared', '10mm squared', '16mm squared'],
      correctIndex: 2,
      explanation:
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-10">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <p className="text-sm text-muted-foreground">
              TN-S vs TN-C-S systems, main earthing terminal, supplementary bonding, Zs calculations
            </p>
          </div>
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            <h3 className="font-semibold text-sm mb-1">Standards</h3>
            <p className="text-sm text-muted-foreground">
              BS 7671 Chapter 54, BS EN 62305, Section 534 SPDs
            </p>
          </div>
        </div>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Industrial installations in the UK typically receive supply via{' '}
            <strong className="text-foreground">TN-S</strong> (separate earth) or{' '}
            <strong className="text-foreground">TN-C-S</strong> (PME - Protective Multiple Earthing)
            systems. The choice significantly impacts installation design, safety provisions, and
          ...
          <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  TN-C-S (PME) earthing has restrictions for certain installations including petrol
                  stations, caravan parks, swimming pools, and locations where earth electrode
                  resistance is critical. A broken PEN conductor can result in
                  exposed-conductive-parts rising to dangerous voltages. BS 7671 Regulation 411.4.2
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            The <strong className="text-foreground">Main Earthing Terminal (MET)</strong> is the
            central connection point for all protective conductors in an installation. BS 7671
            Chapter 54 mandates specific arrangements and sizing requirements for industrial
            installations.
          </p>
          ...
          <p className="text-muted-foreground leading-relaxed">
            Main bonding connects{' '}
            <strong className="text-foreground">extraneous-conductive-parts</strong> to the MET. In
            industrial premises, this typically includes:
          </p>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Supplementary bonding creates local equipotential zones where automatic disconnection
            alone cannot guarantee safety. BS 7671 Regulation 415.2.2 requires supplementary bonding
            when disconnection times cannot be met or where simultaneous contact with conductive
            parts is possible.
          </p>
          ...
          <div className="space-y-3">
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              <h4 className="font-semibold text-sm text-elec-yellow mb-1">
                Motor to Structural Steel
              </h4>
              <p className="text-sm text-muted-foreground">
                When a motor frame is within arm's reach (2.5m) of structural steelwork,
                supplementary bonding ensures touch voltage is 50V or less during faults.
              </p>
            </div>
            <div className="bg-elec-yellow/5 border-l-2 border-green-500/50 rounded-r-lg p-4">
              <h4 className="font-semibold text-sm text-green-400 mb-1">Motor to Metal Pipework</h4>
              <p className="text-sm text-muted-foreground">
                Pump motors connected to metal pipework systems require bonding between motor frame
                and accessible pipework sections.
              </p>
            </div>
            <div className="bg-elec-yellow/5 border-l-2 border-blue-500/50 rounded-r-lg p-4">
              ...
              <p className="text-sm text-muted-foreground">
                Multiple drive motors on conveyor systems should be bonded to the conveyor framework
                creating a unified equipotential zone.
              </p>
            </div>
          </div>
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4 mt-4">
            <h4 className="font-semibold text-sm text-yellow-400 mb-2">
              Touch Voltage Verification
            </h4>
            <p className="text-sm text-muted-foreground">
              Where supplementary bonding is installed, verify: R &lt;= 50V / Ia, where R is
              resistance between simultaneously accessible parts and Ia is the operating current of
              the protective device (5-second characteristic for distribution circuits).
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <div className="text-sm text-muted-foreground space-y-1">
              <p>
                <strong className="text-foreground">Ze</strong> = External earth fault loop
                impedance (supply side)
              </p>
              <p>
                <strong className="text-foreground">R1</strong> = Resistance of phase conductor
              </p>
              <p>
                <strong className="text-foreground">R2</strong> = Resistance of protective conductor
              </p>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mt-4">
            <div className="bg-elec-yellow/5 border-l-2 border-green-500/50 rounded-r-lg p-4">
              ...
              <p className="text-sm text-muted-foreground">
                Multiply tabulated Zs by <strong className="text-elec-yellow">0.8</strong> to
                account for conductor temperature rise during fault conditions. This provides a
                design margin ensuring compliance under worst-case conditions.
              </p>
            </div>
            <div className="bg-elec-yellow/5 border-l-2 border-blue-500/50 rounded-r-lg p-4">
              <h4 className="font-semibold text-sm text-blue-400 mb-2">Verification Stage</h4>
              <p className="text-sm text-muted-foreground">
                Measured Zs at ambient temperature must not exceed tabulated maximum values from
                Tables 41.2 to 41.4. Compare measured values directly without correction if testing
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 mt-4">
            <h4 className="font-semibold text-sm mb-3">
              Maximum Zs Values - Common MCBs (TN Systems)
            </h4>
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Industrial buildings require lightning protection risk assessment per BS EN 62305-2. The
            standard defines four Lightning Protection Levels (LPL I-IV) with corresponding
            protection measures. Industrial sites with tall structures, hazardous materials, or
            critical processes typically require LPL I or II.
          </p>
          ...
          <div className="grid sm:grid-cols-3 gap-4 mt-4">
            <div className="bg-elec-yellow/5 border-l-2 border-red-500/50 rounded-r-lg p-4">
              ...
              <p className="text-sm text-muted-foreground">
                Rods, mesh network, or catenary systems intercept lightning strikes. Mesh size and
                rod spacing depend on LPL (5m-20m typical).
              </p>
            </div>
            <div className="bg-elec-yellow/5 border-l-2 border-yellow-500/50 rounded-r-lg p-4">
              ...
              <p className="text-sm text-muted-foreground">
                Minimum 2 down conductors per structure, spaced 10-25m depending on LPL. Copper tape
                25x3mm or 50mm squared stranded typical.
              </p>
            </div>
            <div className="bg-elec-yellow/5 border-l-2 border-green-500/50 rounded-r-lg p-4">
              <h4 className="font-semibold text-sm text-green-400 mb-2">Earth Termination</h4>
              <p className="text-sm text-muted-foreground">
                Type A (vertical/horizontal electrodes) or Type B (ring conductor). Target
                resistance 10 ohms or less, interconnected with installation earthing.
              </p>
            </div>
          </div>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 mt-4">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              BS 7671 Section 534 requires SPD installation assessment based on risk. SPDs protect
              against transient overvoltages from lightning (conducted and induced) and switching
              surges.
            </p>
            <div className="space-y-2">
              <div className="flex items-center gap-3 bg-background rounded p-3">
                ...
                <div className="text-sm">
                  ...
                  <span className="text-muted-foreground ml-2">
                    - Handles direct strikes - Up to 100kA
                  </span>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-background rounded p-3">
          ...
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4 mt-4">
            ...
            <p className="text-sm text-muted-foreground">
              Maintain minimum <strong className="text-elec-yellow">10 metres</strong> cable length
              between Type 1 and Type 2 SPDs for proper energy coordination. If distance is less,
              use coordinated SPD sets from the same manufacturer or install decoupling inductors.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Modern industrial facilities contain sensitive electronic equipment - PLCs, SCADA
            systems, variable speed drives, and data networks - requiring{' '}
            <strong className="text-foreground">functional earthing</strong> separate from
            protective earthing. This provides a stable voltage reference and reduces
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 mt-4">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-full bg-cyan-600 flex items-center justify-center text-white font-bold text-xs flex-shrink-0">
                  1
                </div>
                <div>
                  <h5 className="font-semibold text-sm text-cyan-400">Technical Earth Bar (TEB)</h5>
                  <p className="text-sm text-muted-foreground">
                    Insulated copper bar, typically 50x6mm, mounted on insulators in technical
                    space. Single cable connection to MET using 25mm squared minimum green/yellow
                    conductor.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Individual conductors radiate from TEB to each equipment rack/item. No
                    daisy-chaining or interconnection between equipment earths.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Optional dedicated earth electrode (target 10 ohms or less) connected to TEB
                    improves high-frequency performance. Must still have connection to MET for
                    safety.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4 mt-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Clean earth and technical earth systems must{' '}
                  <strong className="text-foreground">always</strong> be connected to the MET for
                  protective purposes per BS 7671 Regulation 411.3.1.1. "Isolated" or "floating"
                  earths that are completely separate from the installation earth are non-compliant
                  and dangerous.
                </p>
              </div>
            </div>
        ...
        <section className="bg-elec-yellow/5 border border-elec-yellow/20 rounded-lg p-6 space-y-4">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                <li>
                  <span className="text-elec-yellow">Chapter 54:</span> Earthing arrangements and
                  protective conductors
                </li>
                <li>
                  <span className="text-elec-yellow">Reg 411.3.2:</span> Maximum disconnection times
                </li>
                <li>
                  <span className="text-elec-yellow">Reg 415.2:</span> Supplementary bonding
                  requirements
                </li>
                <li>
                  <span className="text-elec-yellow">Section 534:</span> Surge protective devices
                </li>
                <li>
                  <span className="text-elec-yellow">Table 54.7:</span> Earthing conductor sizing
                </li>
                <li>
                  <span className="text-elec-yellow">Table 54.8:</span> Main bonding conductor
                  sizing
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                <li>
                  <span className="text-elec-yellow">TN-S Ze:</span> Typically 0.35 ohms
                </li>
                <li>
                  <span className="text-elec-yellow">TN-C-S Ze:</span> Max 0.8 ohms (typically 0.35
                  ohms)
                </li>
                <li>
                  <span className="text-elec-yellow">Design factor:</span> 0.8 x tabulated Zs
                </li>
                <li>
                  <span className="text-elec-yellow">Final circuit time:</span> 0.4s (230V), 0.2s
                  (400V)
                </li>
                <li>
                  <span className="text-elec-yellow">Distribution time:</span> 5s (TN systems)
                </li>
                <li>
                  <span className="text-elec-yellow">Touch voltage limit:</span> 50V AC
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                <li>
                  <span className="text-elec-yellow">Type 1:</span> Main intake (lightning current)
                </li>
                <li>
                  <span className="text-elec-yellow">Type 2:</span> Sub-boards (induced surges)
                </li>
                <li>
                  <span className="text-elec-yellow">Type 3:</span> Equipment (fine protection)
                </li>
                <li>
                  <span className="text-elec-yellow">Coordination:</span> 10m minimum between types
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="text-sm text-muted-foreground space-y-1 font-mono">
                <li>
                  <span className="text-elec-yellow">Zs</span> = Ze + (R1 + R2)
                </li>
                <li>
                  <span className="text-elec-yellow">If</span> = Uo / Zs
                </li>
                <li>
                  <span className="text-elec-yellow">R</span> &lt;= 50V / Ia (supp. bonding)
                </li>
                <li>
                  <span className="text-elec-yellow">Design Zs</span> = 0.8 x Zs max
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-3">
            <div className="flex items-start gap-3">
              <CheckCircle className="w-4 h-4 text-green-500 mt-0.5 flex-shrink-0" />
              <p className="text-sm text-muted-foreground">
                Always verify Ze with the DNO before design - declared values may differ from actual
                measurements.
              </p>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle className="w-4 h-4 text-green-500 mt-0.5 flex-shrink-0" />
              <p className="text-sm text-muted-foreground">
                Document all bonding connections with photographs for verification and future
                maintenance.
              </p>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle className="w-4 h-4 text-green-500 mt-0.5 flex-shrink-0" />
              <p className="text-sm text-muted-foreground">
                Consider electromagnetic compatibility early in design - retrofit clean earth
                systems are costly.
              </p>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle className="w-4 h-4 text-green-500 mt-0.5 flex-shrink-0" />
              <p className="text-sm text-muted-foreground">
                Test earth electrode resistance seasonally - soil conditions affect resistance
                significantly.
              </p>
            </div>
          </div>
