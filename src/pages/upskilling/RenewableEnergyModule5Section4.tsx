...
const inlineChecks = [
  ...
  {
    id: 'm5s4-pas-63100',
    question: 'PAS 63100:2024 — what is it, and how does it interact with BS 7671 Chapter 57?',
    options: [
  ...
  },
  {
    ...
    question: "How does the installer verify a BESS product's BS EN IEC 62485 conformance?",
    options: [
...
const faqs = [
  ...
  {
    question:
      'BS EN IEC 62485-4 (small Li-ion) vs -5 (Li-ion stationary) — which applies to UK domestic BESS?',
    answer:
  ...
  {
    question:
      'Does the customer need to do anything to maintain PAS 63100 compliance over the install life?',
    answer:
...
export default function RenewableEnergyModule5Section4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 4 · BS 7671:2018+A4:2026 · Chapter 57"
        title="BS EN IEC 62485 series + PAS 63100:2024"
        backTo="../renewable-energy-module-5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The international product-safety standard family + the UK domestic install specification.
          -1 general, -2 stationary Pb-acid, -5 Li-ion stationary. PAS 63100 location rules, fire
          detection, signage. Reg 570.6.7.203 + 570.6.1.1.1 anchor both in Chapter 57.
        </p>
        ...
        <Pullquote>
          Chapter 57 = framework. BS EN IEC 62485 = product safety. PAS 63100 = UK domestic install.
          All three matter.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Part -1 General safety information</strong> — common
              safety principles across all secondary battery installations: electrical safety,
              chemical safety, thermal safety, mechanical safety, maintenance procedures. Foundation
              for the chemistry-specific parts
            </li>
            <li>
              <strong className="text-white">Part -2 Stationary batteries</strong> — Pb-acid (VRLA,
              GEL), NiCd, alkaline. Covers hydrogen ventilation calculations (Annex A), equalisation
              procedures, electrolyte handling, monthly maintenance
            </li>
            <li>
              <strong className="text-white">Part -3 Traction batteries</strong> — industrial trucks
              (forklifts), AGVs (automated guided vehicles). Not relevant for UK domestic
            </li>
            <li>
              <strong className="text-white">Part -4 Small Li-ion batteries</strong> — consumer /
              portable Li-ion, hand tools, small backup. Generally not BS 7671 scope;
              manufacturer-level product safety
            </li>
            <li>
              <strong className="text-white">Part -5 Li-ion stationary</strong> — the part directly
              applicable to UK domestic LFP BESS. Covers: thermal-runaway prevention + propagation,
              BMS function, cell-level safety, commissioning tests, end-of-life
            </li>
          </ul>
          <p>
            The competent installer references the applicable parts in the cert evidence bundle. UK
            domestic LFP: Part -1 + Part -5. Legacy Pb-acid off-grid: Part -1 + Part -2.
          </p>
        </ConceptBlock>
        ...
        <Pullquote>
          PAS 63100: no habitable rooms. Smoke detection. Signage. The UK domestic install rulebook.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Install location</strong> — prohibited rooms (habitable
              spaces), permitted locations (garage, utility, outbuilding, fire-rated external),
              adjacent-room considerations
            </li>
            <li>
              <strong className="text-white">Clearances</strong> — from windows / doors / openings
              to habitable spaces (typically &gt;1 m); from ignition sources; from fuel storage
            </li>
            <li>
              <strong className="text-white">Fire detection</strong> — smoke / heat detector
              required in BESS location; BS 5839-6 grade; interconnection with dwelling alarm;
              testing schedule
            </li>
            <li>
              <strong className="text-white">Signage</strong> — supports Reg 570.6.8.x warning
              notices; specific wording + placement + visibility
            </li>
            <li>
              <strong className="text-white">Multi-occupancy considerations</strong> — fire-rated
              separation, fire strategy consultation, building-level coordination
            </li>
            <li>
              <strong className="text-white">Commissioning</strong> — install verification, customer
              handover, documentation requirements
            </li>
            <li>
              <strong className="text-white">Customer information pack</strong> — operating
              instructions, maintenance schedule, emergency procedures, manufacturer support
              contacts
            </li>
            <li>
              <strong className="text-white">Maintenance + inspection</strong> — periodic inspection
              schedule, customer responsibilities
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">PROHIBITED — habitable rooms</strong> — bedrooms,
              lounge, dining, kitchen, study/office, any room where people regularly sleep / live /
              work
            </li>
            <li>
              <strong className="text-white">PROHIBITED — main escape routes</strong> — corridors /
              hallways used as primary escape from upper floors
            </li>
            <li>
              <strong className="text-white">PROHIBITED — under stairs in dwellings</strong> —
              restricts access in event of incident
            </li>
            <li>
              <strong className="text-white">PREFERRED — integral garage</strong> — fire-rated
              separation from dwelling already provided by Building Regs; good ventilation;
              accessible
            </li>
            <li>
              <strong className="text-white">ACCEPTABLE — utility room</strong> — if separated by
              fire-rated construction from habitable spaces; clearances respected; ventilation
              adequate
            </li>
            <li>
              <strong className="text-white">ACCEPTABLE — outbuilding</strong> — separate from
              dwelling; weatherproof; accessible; signage
            </li>
            <li>
              <strong className="text-white">ACCEPTABLE — fire-rated external enclosure</strong> —
              purpose-built cabinet on external wall; weatherproof; ventilated
            </li>
            <li>
              <strong className="text-white">Adjacent-room consideration</strong> — even in
              acceptable locations, consider thermal-runaway exposure to adjacent rooms; fire-rated
              walls preferred
            </li>
            <li>
              <strong className="text-white">Multi-occupancy / flat</strong> — significantly higher
              bar; fire-rated separation 60-90 min; fire strategy consultation; possible
              building-level prohibition
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Manufacturer DoC + test reports + UKCA/CE marking. The installer verifies via paperwork —
          not cell-by-cell.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Manufacturer Declaration of Conformity (DoC)</strong> —
              formal statement listing all standards applied: BS EN IEC 62485 parts, BS EN 62619,
              IEC 62133 (cell safety), product-specific standards. Signed by the
              manufacturer&rsquo;s authorised representative
            </li>
            <li>
              <strong className="text-white">Accredited test lab reports</strong> — TÜV Rheinland,
              UL, Intertek, SGS, BSI — accredited bodies that test the product against the relevant
              standards. Manufacturer references the test report number + lab in the DoC
            </li>
            <li>
              <strong className="text-white">UKCA marking</strong> — UK post-Brexit conformity
              assessment. Declares compliance with UK regulations: Electrical Equipment (Safety)
              Regulations 2016, EMC Regulations 2016, Radio Equipment Regulations 2017
            </li>
            <li>
              <strong className="text-white">CE marking</strong> — EU conformity mark. Valid for
              Northern Ireland; accepted in GB during transition. Many BESS carry both UKCA + CE
            </li>
            <li>
              <strong className="text-white">Product datasheets</strong> — safety specs (V/I limits,
              T range, fault response); install requirements (clearances, mounting); performance
              specs (capacity, cycle life, warranty)
            </li>
            <li>
              <strong className="text-white">Installer&rsquo;s job</strong> — collect these
              documents at install delivery; verify product matches the DoC; include in cert
              evidence bundle
            </li>
            <li>
              <strong className="text-white">Customer handover</strong> — DoC + datasheet copy +
              manufacturer support contact in customer information pack
            </li>
          </ul>
        </ConceptBlock>
