...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Star wiring creates multiple unterminated branches which cause signal reflections, leading to communication errors and network instability. Daisy-chain topology maintains proper impedance matching.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Use MSTP for local device-level control where cost is a factor (HVAC field controllers). Use BACnet/IP for large buildings, campus systems, or when integrating with IT infrastructure.',
  },
  {
    question: "What's the maximum cable length for MSTP?",
    answer:
      'The maximum segment length is 1200m (4000ft) using proper shielded twisted pair cable with 120Ω impedance.',
  },
  {
    question: 'Do I need special training to install BACnet systems?',
    answer:
      'Basic electrical knowledge covers cabling, but understanding device addressing, termination, and commissioning requires BMS-specific training or close coordination with integrators.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Missing termination resistors and using star topology instead of daisy-chain are the most common installation errors that cause MSTP failures.',
  },
];
...
const BMSModule5Section2 = () => {
  useSEO({
    ...
    description:
      'Learn about BACnet device types, MSTP and BACnet/IP network installation for building automation systems.',
  });
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>MSTP:</strong> RS-485 twisted pair, 127 devices max, daisy-chain only
              </li>
              <li>
                <strong>BACnet/IP:</strong> Ethernet, scalable, needs IT coordination
              </li>
              <li>
                <strong>Key rule:</strong> Always terminate RS-485 at both ends
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> 3-wire connections (A+, B-, REF) = RS-485 MSTP
              </li>
              <li>
                <strong>Spot:</strong> RJ45 Ethernet ports = BACnet/IP
              </li>
              <li>
                <strong>Use:</strong> Match cabling to protocol requirements
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BACnet defines devices by their role within the network. Understanding these device
              types helps electricians plan cable runs and ensure proper power supply to each device
              category.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BACnet supports several types of communication media. The two most common for
              electricians are MSTP (RS-485) and BACnet/IP (Ethernet). Each has distinct
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BACnet MSTP (RS-485) installation requires specific cable types, termination, and
              wiring topology to ensure reliable communication. Poor installation practices are the
              leading cause of MSTP failures.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Star wiring</strong> - instead of daisy-chain topology
                </li>
                <li>
                  <strong>Missing termination</strong> - or incorrect resistor values
                </li>
                <li>
                  <strong>Wrong cable</strong> - unshielded or wrong impedance
                </li>
                <li>
                  <strong>Polarity reversal</strong> - on RS-485 connections
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BACnet/IP uses standard Ethernet infrastructure, making it scalable and fast. However,
              it requires coordination with IT departments and careful network planning to avoid
              conflicts with corporate systems.
            </p>
