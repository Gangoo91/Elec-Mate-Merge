...
const IndustrialElectricalModule2Section1: React.FC = () => {
  ...
  useSEO({
    ...
    description:
      'Learn about motor starting methods including Direct Online (DOL), Star-Delta, Soft Starters, and Variable Speed Drives (VSDs). Covers UK standards, inrush currents, and IE efficiency classes.',
    keywords: [
  ...
  const quickCheckQuestions = [
    {
      id: 'qc1-motor-types',
      question:
        'What is the typical inrush current multiple for a Direct Online (DOL) motor start?',
      options: ['2-3 times FLC', '4-5 times FLC', '6-8 times FLC', '10-12 times FLC'],
      correctIndex: 2,
      explanation:
        'DOL starting draws 6-8 times the Full Load Current (FLC) during startup. This high inrush current can cause voltage dips on the supply network, which is why DOL is typically limited to smaller motors (usually below 7.5kW in the UK).',
    },
    {
      id: 'qc2-star-delta',
      question:
      ...
      options: [
        'Reduces by half (50%)',
        'Reduces to one-third (33%)',
        'Reduces by two-thirds (67%)',
        'Reduces to one-quarter (25%)',
      ],
      correctIndex: 1,
      explanation:
        'Star-Delta starting reduces both starting current AND starting torque to approximately one-third (1/sqrt3 squared) of DOL values. The motor starts in star configuration (lower voltage per winding) then switches to delta for normal running.',
    },
    {
      id: 'qc3-vsd',
      question:
        'Which motor starting method provides the best energy efficiency for variable load applications?',
      options: [
        'DOL with contactor',
        'Star-Delta starter',
        'Soft starter',
      ...
      correctIndex: 3,
      explanation:
        'VSDs (also called VFDs or inverters) provide the best energy efficiency by adjusting motor speed to match the load requirement. They can save 20-50% energy on pump and fan applications by following the Affinity Laws where power varies with the cube of speed.',
    },
  ];
      ...
      <div className="max-w-3xl mx-auto px-4 pb-12 space-y-10">
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-foreground">Inrush current:</strong> 6-8 times Full Load
                    Current (FLC) - causes voltage dips
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-foreground">Starting torque:</strong> 100-200% of full
                    load torque - high breakaway capability
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-foreground">Cost:</strong> Lowest capital cost of all
                    starting methods
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="w-4 h-4 text-orange-400 mt-0.5 flex-shrink-0" />
                  <span>
                    <strong className="text-foreground">Mechanical stress:</strong> High torque
                    impulse can damage driven equipment
                  </span>
                </li>
              </ul>
            </div>
            ...
            <p>
              In UK industrial practice, DOL starting is typically limited to motors below{' '}
              <strong className="text-foreground">7.5kW</strong> on standard supplies. Larger
              installations may require approval from the Distribution Network Operator (DNO) due to
              potential supply disturbances. The{' '}
              <strong className="text-foreground">G59/G99 Engineering Recommendations</strong>{' '}
              govern connection of larger loads.
            </p>

            <div className="bg-blue-500/10 border-l-2 border-blue-500/50 rounded-r-lg p-4">
              <p className="text-sm">
                <strong className="text-foreground">Practical Note:</strong> DOL starters are ideal
                for small motors driving pumps, fans, and conveyors where the load permits instant
                full-speed starting. Consider the mechanical coupling's ability to withstand
                starting torque peaks.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Star-Delta (Y-Delta) starting is a traditional reduced voltage starting method that
              uses the motor's winding connections to limit inrush current. The motor must have all
              six winding terminals available and be rated for 400V delta connection in UK
              applications.
            </p>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-elec-yellow text-black flex items-center justify-center text-sm font-bold flex-shrink-0">
                    1
                  </span>
                  <div>
                    <strong className="text-foreground">Star Connection (Starting):</strong>{' '}
                    Windings connected in star receive 230V each (400V / sqrt3). Starting current
                    and torque reduced to{' '}
                    <strong className="text-foreground">1/3 of DOL values</strong>.
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-elec-yellow text-black flex items-center justify-center text-sm font-bold flex-shrink-0">
                  ...
                  <div>
                    <strong className="text-foreground">Transition:</strong> After timed
                    acceleration (typically 5-15 seconds), contactors switch configuration. Open
                    transition causes brief disconnection.
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-elec-yellow text-black flex items-center justify-center text-sm font-bold flex-shrink-0">
                  ...
                  <div>
                    <strong className="text-foreground">Delta Connection (Running):</strong> Full
                    400V applied to each winding. Motor operates at rated performance.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-orange-500/10 border-l-2 border-orange-500/50 rounded-r-lg p-4">
              ...
              <p className="text-sm">
                The open-transition changeover causes a current transient of{' '}
                <strong className="text-foreground">2-3x FLC</strong> as the out-of-phase motor
                reconnects. This can trip protective devices and cause mechanical shock.{' '}
                <strong className="text-foreground">Closed-transition Star-Delta starters</strong>{' '}
                use a fourth contactor with resistors to maintain connection during changeover,
                reducing this spike.
              </p>
            </div>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Soft starters use <strong className="text-foreground">thyristors (SCRs)</strong> to
              gradually increase the voltage applied to the motor, providing smooth acceleration and
              controlled starting current. They offer precise control over the starting process
              without the mechanical contactors of Star-Delta systems.
            </p>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <p className="text-sm mb-3">
                Ideal for applications where controlled acceleration is beneficial:
              </p>
              <ul className="space-y-1 text-sm">
                <li>
                  &bull; <strong className="text-foreground">Centrifugal pumps:</strong> Soft stop
                  prevents water hammer
                </li>
                <li>
                  &bull; <strong className="text-foreground">Conveyors:</strong> Gradual
                  acceleration prevents product damage
                </li>
                <li>
                  &bull; <strong className="text-foreground">Fans:</strong> Reduced belt slip and
                  mechanical stress
                </li>
                <li>
                  &bull; <strong className="text-foreground">Compressors:</strong> Unloaded starting
            ...
            <p>
              Most modern soft starters include a{' '}
              <strong className="text-foreground">bypass contactor</strong> that switches the
              thyristors out of circuit once the motor reaches full speed. This eliminates running
              losses and reduces heat generation, improving efficiency and extending component life.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              ...
              inverters, provide complete control over motor speed, torque, and acceleration. They
              convert fixed frequency AC supply to variable frequency and voltage output using power
              electronics.
            </p>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-3">
                  <span className="w-8 h-8 rounded bg-blue-600 flex items-center justify-center text-sm font-bold flex-shrink-0">
                    AC
                  </span>
                  <div>
                    <strong className="text-foreground">Rectifier Stage:</strong> Converts incoming
                    AC (50Hz) to DC using diode or thyristor bridge.
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="w-8 h-8 rounded bg-gray-600 flex items-center justify-center text-sm font-bold flex-shrink-0">
                    DC
                  </span>
                  <div>
                    <strong className="text-foreground">DC Link:</strong> Large capacitors smooth
                    the DC voltage and provide energy storage for dynamic response.
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="w-8 h-8 rounded bg-green-600 flex items-center justify-center text-sm font-bold flex-shrink-0">
                    VAC
                  </span>
                  <div>
                    <strong className="text-foreground">Inverter Stage:</strong> IGBTs switch the DC
                    to create PWM output at variable frequency (0-50Hz+) and voltage.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              <h3 className="font-medium text-foreground mb-2">
                Affinity Laws - Energy Savings Potential
              </h3>
              ...
              <ul className="text-sm space-y-1">
                <li>
                  &bull; <strong className="text-foreground">Flow is proportional to Speed</strong>{' '}
                  - Reduce speed to 80% = 80% flow
                </li>
                <li>
                  &bull;{' '}
                  ...
                  - Reduce speed to 80% = 64% pressure
                </li>
                <li>
                  &bull;{' '}
                  <strong className="text-foreground">Power is proportional to Speed cubed</strong>{' '}
                  - Reduce speed to 80% = <strong className="text-foreground">51% power!</strong>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-orange-500/10 border-l-2 border-orange-500/50 rounded-r-lg p-4">
              ...
              <ul className="text-sm space-y-1">
                <li>
                  &bull; <strong className="text-foreground">Harmonics:</strong> 5th and 7th
                  harmonics pollute supply - may need filters
                </li>
                <li>
                  &bull; <strong className="text-foreground">Cable length:</strong> Long runs cause
                  reflected wave voltage spikes - use output filters
                </li>
                <li>
                  &bull; <strong className="text-foreground">Motor bearings:</strong> EDM damage
                  risk - use shaft grounding or insulated bearings
                </li>
                <li>
                  &bull; <strong className="text-foreground">EMC:</strong> Screened cables and
                  proper earthing essential for EMC compliance
                </li>
                <li>
                  &bull; <strong className="text-foreground">Motor rating:</strong> Standard motors
                  may need derating below 25Hz due to reduced cooling
                </li>
              </ul>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  &bull; <strong className="text-foreground">DOL:</strong> Motors up to 7.5kW with
                  adequate supply, low starting frequency
                </li>
                <li>
                  &bull; <strong className="text-foreground">Star-Delta:</strong> Motors 7.5-55kW
                  with light starting loads, 6-terminal motor required
                </li>
                <li>
                  &bull; <strong className="text-foreground">Soft Starter:</strong> When current
                  limiting and soft stop needed, moderate duty cycles
                </li>
                <li>
                  &bull; <strong className="text-foreground">VSD:</strong> Variable speed required,
                  energy savings priority, frequent starts, or precise control
                </li>
              </ul>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              The International Efficiency (IE) classification system defined in{' '}
              <strong className="text-foreground">IEC 60034-30-1</strong> rates motor efficiency.
              Under EU Ecodesign regulations (retained in UK law), minimum efficiency requirements
              apply to motors placed on the market.
            </p>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center gap-3 p-2 rounded bg-white/5">
                  <span className="w-12 h-8 rounded bg-gray-600 flex items-center justify-center text-sm font-bold flex-shrink-0">
                    IE1
                  </span>
                  <div>
                    <strong className="text-foreground">Standard Efficiency</strong> - No longer
                    permitted for most new motors
                  </div>
                </div>
                <div className="flex items-center gap-3 p-2 rounded bg-white/5">
                  <span className="w-12 h-8 rounded bg-blue-600 flex items-center justify-center text-sm font-bold flex-shrink-0">
                    IE2
                  </span>
                  <div>
                    <strong className="text-foreground">High Efficiency</strong> - Minimum for
                    motors with VSD only
                  </div>
                </div>
                <div className="flex items-center gap-3 p-2 rounded bg-white/5">
                  <span className="w-12 h-8 rounded bg-green-600 flex items-center justify-center text-sm font-bold flex-shrink-0">
                    IE3
                  </span>
                  <div>
                    <strong className="text-foreground">Premium Efficiency</strong> - Current
                    minimum for 0.75-1000kW motors (DOL/Star-Delta)
                  </div>
                </div>
                <div className="flex items-center gap-3 p-2 rounded bg-white/5">
                  <span className="w-12 h-8 rounded bg-purple-600 flex items-center justify-center text-sm font-bold flex-shrink-0">
                    IE4
                  </span>
                  <div>
                    <strong className="text-foreground">Super Premium</strong> - Best available,
                    often permanent magnet or copper rotor
                  </div>
                </div>
                <div className="flex items-center gap-3 p-2 rounded bg-white/5">
                  <span className="w-12 h-8 rounded bg-elec-yellow text-black flex items-center justify-center text-sm font-bold flex-shrink-0">
                    IE5
                  </span>
                  <div>
                    <strong className="text-foreground">Ultra Premium</strong> - Emerging class,
                    typically synchronous reluctance or PM motors
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-500/10 border-l-2 border-green-500/50 rounded-r-lg p-4">
              ...
              <p className="text-sm">
                Motor purchase price represents only{' '}
                <strong className="text-foreground">2-5%</strong> of total lifecycle cost. Energy
                consumption accounts for <strong className="text-foreground">95-97%</strong> over a
                typical 15-20 year motor life. A 75kW motor running 6,000 hours/year at 0.15
                pounds/kWh costs approximately{' '}
                <strong className="text-foreground">67,500 pounds/year</strong> in electricity. Even
                1% efficiency improvement saves 675 pounds annually.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 text-sm">
            <div>
              ...
              <ul className="space-y-1 text-muted-foreground">
                <li>
                  &bull; <strong className="text-foreground">DOL:</strong> 6-8x FLC (full voltage,
                  full torque)
                </li>
                <li>
                  &bull; <strong className="text-foreground">Star-Delta:</strong> 2-3x FLC (1/3
                  voltage, 1/3 torque in star)
                </li>
                <li>
                  &bull; <strong className="text-foreground">Soft Starter:</strong> 2-4x FLC
                  (adjustable limit)
                </li>
                <li>
                  &bull; <strong className="text-foreground">VSD:</strong> 1-1.5x FLC (full torque
                  available)
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-1 text-muted-foreground">
                <li>
                  &bull; <strong className="text-foreground">DOL limit:</strong> Typically 7.5kW on
                  standard supplies
                </li>
                <li>
                  &bull; <strong className="text-foreground">Star-Delta:</strong> Common for
                  7.5-55kW range
                </li>
                <li>
                  &bull; <strong className="text-foreground">Soft Start/VSD:</strong> Any size,
                  application dependent
                </li>
                <li>
                  &bull; <strong className="text-foreground">DNO consultation:</strong> Motors
                  &gt;15kW or multiple starts
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-1 text-muted-foreground">
                <li>
                  &bull; <strong className="text-foreground">IE3 minimum:</strong> 0.75-1000kW
                  (DOL/Star-Delta)
                </li>
                <li>
                  &bull; <strong className="text-foreground">IE2 + VSD:</strong> Alternative
                  compliance route
                </li>
                <li>
                  &bull; <strong className="text-foreground">Exemptions:</strong> Hazardous areas,
                  high altitude, etc.
                </li>
                <li>
                  &bull; <strong className="text-foreground">IE4 recommended:</strong> High running
                  hours applications
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-1 text-muted-foreground">
                <li>
                  &bull; <strong className="text-foreground">IEC 60034-30-1:</strong> IE efficiency
                  classification
                </li>
                <li>
                  &bull; <strong className="text-foreground">IEC 60034-25:</strong> Inverter-duty
                  motors
                </li>
                <li>
                  &bull; <strong className="text-foreground">BS 7671:</strong> Wiring Regulations
                  (motor circuits)
                </li>
                <li>
                  &bull; <strong className="text-foreground">G59/G99:</strong> DNO connection
                  requirements
                </li>
              </ul>
            </div>
