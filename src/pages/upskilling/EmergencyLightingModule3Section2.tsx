...
const inlineChecks = [
  {
    id: 'elm3-s2-points',
    question:
      'BS 5266-1:2025 lists which positions as REQUIRED luminaire locations on an escape route?',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'BS 5266-1:2025 specifies luminaires near each of the following positions on an escape route — which is NOT in the list?',
    options: [
  ...
  },
  {
    id: 2,
    question:
      'What is the floor-level illuminance rule for a defined escape route per BS EN 1838:2024?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'A toilet compartment is 6 m² with a single straight exit path. What does BS 5266-1:2025 require?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'Borrowed light (illumination from an adjacent space through glazing or open doorway) under BS 5266-1:2025 is...?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'A 30 m corridor with one 90-degree turn and an exit at each end. Minimum luminaire positions per BS 5266-1?',
    options: [
  ...
  },
  {
    id: 9,
    question:
      'A defined escape route passes through a 200 m² atrium 8 m wide. How does BS EN 1838:2024 apply?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Where luminaires must go. BS 5266-1:2025 enumerates the positions — every exit, every
          stair, every change of direction, every intersection, every safety device. Plus the rules
          that decide whether a toilet, a lift or a small ancillary space falls within scope. The
          2025 revision removes the borrowed-light allowance that 2016 permitted; every space stands
          on its own dedicated luminaires.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              door designated as a secondary exit. The luminaire is positioned to light the door AND
              the area immediately outside it (so the user transitions into lit external space).
            </li>
            <li>
            ...
            <li>
              ...
              where two or more escape routes meet. Each leg must be lit so the user identifies the
              route ahead and the route they are joining.
            </li>
            <li>
              ...
              luminaire on them; internally illuminated signs are self-contained but the surrounding
              area also needs route lighting.
            </li>
            <li>
              <strong>Near each first-aid post.</strong> 5 lx vertical on the post / cabinet face,
              so a user in distress can identify and operate the equipment. The first-aid post is
              also typically a mustering point for casualty management.
            </li>
            <li>
            ...
            <li>
              ...
              protected lobbies. 5 lx vertical on the call point face. Refuge points are discussed
              at length in §4 (risk-based design).
            </li>
            <li>
              <strong>Outside any final exit.</strong> A luminaire on the external face so the user
              transitioning out of the building sees the immediate surrounding area, not stepping
              from a lit interior into a dark courtyard.
            </li>
          </ul>
          <p>
            Add to this list any location identified by the fire risk assessment as safety-critical
            for evacuation. The §5.5 list is the minimum; project-specific factors may add
            positions. Subtraction is not permitted.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Emergency luminaires shall be provided at the following positions: at each exit door
              intended to be used in an emergency; near each escape stair so that each flight
              receives direct light; near each change of direction of the escape route; near each
              intersection of corridors; near each emergency exit sign; near each first-aid post;
              near each piece of firefighting equipment; near each fire alarm manual call point;
              near each refuge call point; outside the building on the external face of each final
              exit. Additional luminaires shall be installed as required to meet the illuminance
              requirements of BS EN 1838.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              covers 1 to 1.5 m per second. They look 5 to 10 m ahead to plan footfall and identify
              obstacles. The lit field must extend at least that far in the direction of travel from
              any point on the route.
            </li>
            <li>
              <strong>Sign visibility.</strong> Directional emergency exit signs (running-man
              pictogram) are sized for legibility at 100 × the height of the pictogram (the viewing
              distance). A 200 mm pictogram is legible at 20 m; a 150 mm pictogram at 15 m. The next
              sign must be within visible range from the current position, lit so it can be read.
            </li>
            <li>
              ...
              directional cue, then continues. Decision points need a luminaire AND a sign visible
              from the previous decision point.
            </li>
            <li>
              <strong>Forward-throw photometric distribution.</strong> Some emergency luminaires are
              designed with a forward-throw distribution (asymmetric optic) that pushes light along
              the corridor in the direction of the next exit. Useful where the corridor is straight
              and the exit is some distance away — light in the direction of travel rather than
              directly below.
            </li>
          </ul>
          <p>
            A common design failure is to light the floor uniformly without considering forward
            visibility — the lux meter reads 1 lx everywhere, but the user looking ahead sees dim
            space and hesitates. The fix is photometric distribution selection plus positioning that
            aligns the brightest part of the beam with the direction of travel.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Standard cubicle (1.5 m² with straight exit).</strong> Below 8 m², single turn
              — EXEMPT. Corridor lighting outside satisfies the exit requirement.
            </li>
            <li>
              <strong>Single-occupant accessible WC (4 m² with straight exit).</strong> Below 8 m²,
              single turn — EXEMPT.
            </li>
            <li>
              <strong>Larger accessible WC with vestibule (12 m² total, two turns).</strong>
              Above 8 m² OR multi-turn — REQUIRED. A luminaire inside the vestibule, possibly a
              second inside the WC compartment if the layout creates a sub-room.
            </li>
            <li>
              <strong>
                Multi-cubicle public WC (e.g. office washroom, 40 m² with multiple cubicles).
              </strong>{' '}
              Above 8 m² — REQUIRED. Luminaires positioned in the circulation space serving the
              cubicles; cubicles themselves typically rely on light spilling under the door.
            </li>
            <li>
              <strong>Lobbied WC (lobby + WC compartments separated).</strong> Apply the rule per
              discrete space. The lobby is one compartment; each WC compartment behind it is
              another. The lobby may exceed 8 m² and need its own luminaire even if each cubicle is
              below.
            </li>
          </ul>
          <p>
            The thresholds reflect the disorientation risk. A small straight-exit cubicle is quickly
            evacuated even in darkness — the door is one step away, the egress is obvious. A larger
            or multi-turn space presents real risk; the occupant cannot find the door without
            illumination.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Inside the car — BS EN 81-20.</strong> The lift manufacturer provides the car
              emergency lighting as part of the lift package. Verifies on commissioning per lift
              standards (LiftSafe, BS EN 81 family). The electrical contractor for the building does
              NOT design the car lighting; the lift contractor does.
            </li>
            <li>
              <strong>Lift lobby — BS 5266-1.</strong> The space outside the lift door on each floor
              is part of the building. It is on the escape route from the lift (when the lift opens,
              the user steps into the lobby), and it is on the escape route to / from the
              surrounding building. 1 lx escape route, 5 lx vertical at any safety equipment, 0.5 lx
              anti-panic if the lobby is open ≥60 m².
            </li>
            <li>
              <strong>Motor room (overhead or basement).</strong> Plant-room lighting on a BS 5266
              basis where escape from the motor room to a final exit is required. Often a small
              switched circuit serving a 1 to 2 luminaire installation.
            </li>
            <li>
              <strong>Firefighters lifts (BS EN 81-72).</strong> Stricter requirements — the lift
              continues to operate during a fire, used by fire service personnel. Emergency lighting
              inside the car is to a tighter spec; the lobby on each floor is typically a protected
              lobby with its own dedicated emergency lighting on a longer duration.
            </li>
          </ul>
          <p>
            Coordinate at design stage. The BS 5266 designer agrees with the lift contractor what is
            in their respective scopes. A common gap: nobody designs the motor-room lighting,
            because the lift contractor scope ends at the car and the BS 5266 designer treats the
            motor room as out of scope. The motor room IS in BS 5266 scope and needs lighting.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              control panel, alarm device and the floor area to a minimum of 5 lx for at least 1 h
              after the failure of the normal supply. The emergency lighting source shall be
              self-contained within the car or otherwise arranged to remain operational independent
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Different switching.</strong> The donor space might be switched off when the
              receiver space is occupied — a meeting room with the lights off behind a glazed wall
              does not illuminate the corridor on the other side.
            </li>
            <li>
              <strong>Different integrity.</strong> The donor space might use luminaires of a
              different rating, on a different circuit, with a different test regime. A failure in
              the donor's emergency system removes light from the receiver too.
            </li>
            <li>
              <strong>Closed door at incident.</strong> A donor space with luminaires shining
              through a normally-open door fails when the door is closed for any reason (security,
              draught, smoke containment).
            </li>
            <li>
              <strong>Verification difficulty.</strong> Periodic testing per BS EN 50172 inspects
              each luminaire individually. Verifying that borrowed light is delivering the required
              lux in the receiving space requires a coordinated test of two circuits — easily missed
              in a maintenance regime.
            </li>
          </ul>
          <p>
            ...
            reviewed at the next maintenance interval and dedicated luminaires added where borrowed
            light was being relied on. New installations under BS 5266-1:2025 cannot use borrowed
            light in the design.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              emergency luminaires sufficient to meet the illuminance and uniformity requirements of
              BS EN 1838 within that space alone. Illumination borrowed from luminaires in adjacent
              spaces shall not be counted toward the requirements of this standard.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="220" y="88" textAnchor="middle" fill="#22D3EE" fontSize="12" fontWeight="bold">
              Open-plan office (250 m²)
            </text>
            <text x="220" y="104" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9.5">
              anti-panic 0.5 lx + escape 1 lx full-width
            </text>
            ...
            <text
              ...
              fontWeight="bold"
            >
              Escape corridor — 1 lx full width (edge excl. per 2024)
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="480" y="88" textAnchor="middle" fill="#A855F7" fontSize="11" fontWeight="bold">
              Stair
            </text>
            <text x="480" y="104" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9.5">
              direct light on every tread
            </text>
            ...
            <text x="630" y="104" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              &gt;8 m² → req
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="760" y="88" textAnchor="middle" fill="#22C55E" fontSize="11" fontWeight="bold">
              Lift lobby
            </text>
            <text x="760" y="104" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              BS 5266-1
            </text>
            <text x="760" y="118" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              car: BS EN 81-20
            </text>
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="40" y="316" textAnchor="middle" fill="#22C55E" fontSize="11" fontWeight="bold">
              EXIT
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="200" y="274" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="9">
              door
            </text>
            ...
            <text x="200" y="252" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              door
            </text>
            ...
            <text x="40" y="252" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              exit
            </text>
            <text x="820" y="252" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              exit
            </text>
            ...
            <circle
              ...
              strokeWidth="2"
            />
            <text x="40" y="392" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              ext.
            </text>
            <circle
              cx="820"
              ...
              strokeWidth="2"
            />
            <text x="820" y="392" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              ext.
            </text>
            ...
            <text x="480" y="68" textAnchor="middle" fill="#A855F7" fontSize="9" fontWeight="bold">
              stair head
            </text>
            <text x="480" y="258" textAnchor="middle" fill="#A855F7" fontSize="9" fontWeight="bold">
              foot
            </text>

            {/* Intersection at stair / corridor — required */}
            <circle cx="480" cy="310" r="9" fill="#FBBF24" stroke="#22D3EE" strokeWidth="2" />
            <text x="480" y="338" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              int.
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="327" y="305" textAnchor="middle" fill="#fff" fontSize="9" fontWeight="bold">
              M
            </text>
            <text x="327" y="338" textAnchor="middle" fill="#EF4444" fontSize="8" fontWeight="bold">
              MCP — 5 lx vert
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="567" y="305" textAnchor="middle" fill="#fff" fontSize="9" fontWeight="bold">
              F
            </text>
            <text x="567" y="338" textAnchor="middle" fill="#EF4444" fontSize="8" fontWeight="bold">
              extinguisher
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="36" y="450" fill="#FBBF24" fontSize="11" fontWeight="bold">
              Legend — required luminaire positions per BS 5266-1:2025 §5.5
            </text>

            <circle cx="40" cy="468" r="6" fill="#FBBF24" />
            <text x="54" y="472" fill="rgba(255,255,255,0.85)" fontSize="10">
              photometric (1 lx route, 0.5 lx anti-panic)
            </text>

            <circle cx="240" cy="468" r="7" fill="#FBBF24" stroke="#EF4444" strokeWidth="2" />
            <text x="254" y="472" fill="rgba(255,255,255,0.85)" fontSize="10">
              at exit door (mandatory §5.5)
            </text>

            <circle cx="430" cy="468" r="7" fill="#FBBF24" stroke="#A855F7" strokeWidth="2" />
            <text x="444" y="472" fill="rgba(255,255,255,0.85)" fontSize="10">
              at stair head/foot (mandatory)
            </text>

            <circle cx="640" cy="468" r="7" fill="#FBBF24" stroke="#22D3EE" strokeWidth="2" />
            <text x="654" y="472" fill="rgba(255,255,255,0.85)" fontSize="10">
              at intersection / change of direction
            </text>
            ...
            <circle
              ...
              strokeWidth="2"
            />
            <text x="54" y="496" fill="rgba(255,255,255,0.85)" fontSize="10">
              external (outside final exit)
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="254" y="496" fill="rgba(255,255,255,0.85)" fontSize="10">
              safety device — 5 lx vertical on face
            </text>

            <text x="450" y="496" fill="rgba(34,197,94,0.85)" fontSize="10">
              → direction of escape (forward visibility at every point)
            </text>
          </svg>
        </div>
        ...
        <FAQ
          items={[
            ...
            {
              question:
                'A corridor has a slight curve, not a sharp turn — does the curve count as a change of direction?',
              answer:
            ...
            {
              question:
                'External final-exit luminaires — are they part of BS 5266 or part of external lighting?',
              answer:
            ...
            {
              question:
                'A stairwell is dark in normal use (no daytime lighting at all) — what does that mean for emergency lighting?',
              answer:
            ...
            {
              question:
                'A WC compartment has frosted glass in the door letting some corridor light in — does that satisfy emergency?',
              answer:
            ...
            {
              question:
                'A passenger lift in a small office building — is the BS EN 81-20 car lighting on a separate test regime?',
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() =>
              navigate('/electrician/upskilling/emergency-lighting-module-3-section-3')
            }
