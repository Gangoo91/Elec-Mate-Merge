...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "Ongoing KPI monitoring identifies 'savings drift' where performance degrades over time due to changed patterns, sensor drift, or control changes. It also reveals new optimisation opportunities as building use evolves.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Savings drift occurs when initial energy savings gradually decrease over time due to changed occupancy patterns, sensor calibration drift, or unauthorised control changes. Prevention requires regular monitoring, scheduled recommissioning, and change management procedures.',
  },
  {
    question: 'How do you prioritise which energy-saving measures to implement first?',
    answer:
      'Prioritise based on: 1) Payback period (quick wins first), 2) Ease of implementation (low disruption), 3) Capital availability, 4) Interaction benefits (measures that enable others). Often PIR lighting and scheduling deliver fastest ROI.',
  },
  {
    question: 'What typical energy savings can integrated BMS strategies achieve?',
    answer:
      'Well-implemented integrated strategies typically achieve: 30-50% HVAC savings, 40-60% lighting savings, 20-30% overall building energy reduction. Actual results depend on baseline efficiency and occupancy patterns.',
  },
  {
    question: 'How do you measure the success of energy-saving strategies?',
    answer:
      'Use normalised metrics: kWh/m²/year for benchmarking, energy intensity by occupant, degree-day adjusted consumption for weather effects, and comparison to CIBSE TM46 benchmarks for building type.',
  },
];
...
const BMSModule4Section5 = () => {
  useSEO({
    ...
    description:
      'Master integrated HVAC and lighting energy strategies in BMS. Learn combined control approaches, ROI calculations, commissioning best practices, and performance monitoring for maximum efficiency.',
  });
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Combined:</strong> HVAC + Lighting + Shading coordination
              </li>
              <li>
                <strong>HVAC Savings:</strong> 30-50% with proper integration
              </li>
              <li>
                <strong>Lighting Savings:</strong> 40-60% with daylight/occupancy
              </li>
              <li>
                <strong>Critical:</strong> Commissioning determines success
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Coordinated schedules, shared sensors, central control
              </li>
              <li>
                <strong>Use:</strong> Maximum efficiency, consistent comfort, lower bills
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The most effective energy management comes from coordinating multiple building systems
              rather than optimising each in isolation. Combined strategies leverage shared data and
              coordinated responses to achieve savings beyond what individual systems can deliver.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Shared Occupancy Data:</strong> One PIR feeds both HVAC and lighting
                </li>
                <li>
                  <strong>Coordinated Schedules:</strong> Systems start/stop together
                </li>
                <li>
                  <strong>Solar Coordination:</strong> Shading affects both cooling and lighting
                </li>
                <li>
                  <strong>Demand Response:</strong> Unified response to peak events
                </li>
              </ul>
            </div>
            ...
            <div className="grid sm:grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent border border-white/10">
                ...
                <p className="text-white text-xs">20-30% savings</p>
              </div>
              <div className="p-3 rounded bg-transparent border border-white/10">
                <p className="font-medium text-white mb-1">Lighting Only</p>
                <p className="text-white text-xs">30-40% savings</p>
              </div>
              <div className="p-3 rounded bg-transparent border border-white/10">
                <p className="font-medium text-elec-yellow mb-1">Combined</p>
                <p className="text-white text-xs">40-60% total savings</p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Successful energy projects require solid business cases that demonstrate return on
              investment. Understanding cost structures, savings calculations, and risk factors
              helps secure project approval and set realistic expectations.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Capital:</strong> Sensors, controllers, wiring
                  </li>
                  <li>
                    <strong>Installation:</strong> Labour, commissioning
                  </li>
                  <li>
                    <strong>Ongoing:</strong> Maintenance, monitoring
                  </li>
                  <li>
                    <strong>Opportunity:</strong> Disruption during install
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Energy:</strong> Reduced kWh consumption
                  </li>
                  <li>
                    <strong>Demand:</strong> Lower peak charges
                  </li>
                  <li>
                    <strong>Maintenance:</strong> Extended equipment life
                  </li>
                  <li>
                    <strong>Productivity:</strong> Improved comfort
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>PIR lighting control:</strong> 1-2 years
                </li>
                <li>
                  <strong>Daylight harvesting:</strong> 2-3 years
                </li>
                <li>
                  <strong>HVAC scheduling:</strong> 1-3 years
                </li>
                <li>
                  <strong>Full BMS integration:</strong> 3-5 years
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Commissioning is where potential energy savings become actual savings. Systems
              installed without proper commissioning often operate at default settings that don't
              reflect real building conditions, losing 20-40% of potential savings.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Phase 1:</strong> Pre-functional testing (wiring, connections)
                </li>
                <li>
                  <strong>Phase 2:</strong> Functional testing (individual system operation)
                </li>
                <li>
                  <strong>Phase 3:</strong> Integrated testing (systems working together)
                </li>
                <li>
                  <strong>Phase 4:</strong> Seasonal commissioning (summer/winter tuning)
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Energy performance naturally degrades over time without active monitoring. Continuous
              measurement and verification (M&V) identifies savings drift early and reveals new
              optimisation opportunities as building use patterns evolve.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>kWh/m²/year:</strong> Building energy intensity benchmark
                </li>
                <li>
                  <strong>kWh/occupant:</strong> Efficiency per person
                </li>
                <li>
                  <strong>DEC Rating:</strong> Display Energy Certificate (UK)
                </li>
                <li>
                  <strong>Peak demand:</strong> Maximum kW and timing
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-red-400/80 mb-2">
                Warning Signs of Savings Drift:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm text-white">
                <strong>Challenge:</strong> 12-floor office building with 8 tenants, energy costs
                35% above CIBSE benchmark. Previous BMS installed but never properly commissioned.
                Variable occupancy patterns making fixed schedules ineffective.
              </p>
            </div>
            ...
            <div className="p-3 rounded bg-transparent border border-white/10 text-sm">
              <p className="text-white">
                <strong>Key Learning:</strong> The largest savings came from proper commissioning of
                existing equipment rather than new installations. Recommissioning alone delivered
                60% of total savings.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10 mt-12">
          <SingleQuestionQuiz title="Test Your Knowledge" questions={bmsModule4Section5QuizData} />
        </section>
