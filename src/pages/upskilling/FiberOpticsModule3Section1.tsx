...
const DESCRIPTION =
  'Master fibre optic cable construction types including indoor, outdoor, and armoured cables. Learn selection criteria, environmental ratings, and installation requirements for UK applications.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'Lower cost',
      'Fire safety - reduced toxic fumes',
      'Easier stripping',
    ],
    correctIndex: 2,
    explanation:
      'Low Smoke Zero Halogen (LSZH) sheathing emits minimal smoke and no toxic halogen gases when burned, crucial for occupied buildings per UK building regulations.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Increase bandwidth',
      'Protect fibres from moisture and allow thermal expansion',
      'Improve bend radius',
      'Reduce weight',
    ],
    correctAnswer: 1,
    explanation:
      'Gel provides moisture protection and allows fibres to move freely during temperature cycling.',
  },
  {
    id: 3,
    question: "What does 'CST' stand for in fibre cable construction?",
    options: [
      'Copper Shielded Tube',
      'Corrugated Steel Tape',
      'Central Strength Tube',
      'Cable Support Tray',
    ],
    correctAnswer: 1,
    explanation:
      'CST stands for Corrugated Steel Tape, a type of metallic armour for rodent protection.',
  },
  {
    id: 4,
    ...
    options: [
      'PVC sheathed',
      'PE sheathed',
      'LSZH sheathed with Euroclass ratings',
      'Armoured only',
    ],
    correctAnswer: 2,
    explanation:
      'UK installations use LSZH sheathing with Euroclass fire ratings (Cca, Dca, etc.) equivalent to US plenum ratings.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    options: [
      'Combustible, poor performance',
      'Non-combustible',
      'Limited fire spread with low smoke',
      'No rating required',
    ],
    correctAnswer: 2,
    explanation:
      'Cca indicates limited flame spread with low smoke production, suitable for most indoor installations.',
  },
  {
    id: 7,
  ...
  },
  {
    ...
    options: [
      'Grounding',
      'Aerial/overhead installation support',
      'Rodent protection',
      'Termination',
    ],
    correctAnswer: 1,
    explanation:
      'Messenger wire supports fibre cables in overhead/aerial installations between poles.',
  },
  {
    id: 9,
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">Indoor, outdoor, and armoured cable construction</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Indoor:</strong> Tight-buffer, LSZH sheath
              </li>
              <li>
                <strong>Outdoor:</strong> Loose-tube, water-blocked, PE
              </li>
              <li>
                <strong>Armoured:</strong> SWA/CST for burial/rodent protection
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Environment:</strong> Indoor, outdoor, buried?
              </li>
              <li>
                <strong>Fire rating:</strong> LSZH/Cca for buildings
              </li>
              <li>
                <strong>Protection:</strong> Armour for mechanical risk
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Fibre optic cables are engineered structures designed to protect delicate glass fibres
              while enabling practical installation and long-term reliability. The{' '}
              <strong>buffer type</strong>—how fibres are protected within the cable—is the primary
              construction difference affecting cable selection.
            </p>
            ...
            <div className="my-6 grid sm:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm text-white mb-2 ml-4">
                  Fibre coated directly with 900µm buffer
                </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>1. Fibre:</strong> 125µm glass with coating (250µm total)
                </li>
                <li>
                  <strong>2. Buffer:</strong> 900µm tight or loose-tube with gel
                </li>
                <li>
                  <strong>3. Strength Members:</strong> Aramid yarn (Kevlar) or fibreglass rods
                </li>
                <li>
                  <strong>4. Water Blocking:</strong> Gel, tapes, or swellable elements
                </li>
                <li>
                  <strong>5. Armour:</strong> Steel wire or tape (if required)
                </li>
                <li>
                  <strong>6. Outer Sheath:</strong> LSZH, PE, PVC depending on application
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Indoor fibre cables are designed for installation within building envelopes where fire
              safety, flexibility, and ease of termination are priorities. The key requirement is{' '}
              <strong>LSZH (Low Smoke Zero Halogen)</strong> sheathing to meet UK building
              regulations and protect occupants during fire events.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Distribution Cable (Tight-Buffer):</strong> Multiple 900µm tight-buffered
                  fibres in a common sheath. Flexible, easy to route. Used for backbone and
                  horizontal runs within buildings. Typically 4-48 fibres.
                </li>
                <li>
                  <strong>Breakout Cable:</strong> Individual tight-buffered fibres each with own
                  sub-unit jacket. Direct termination without fan-out kits. Higher cost but faster
                  installation. Typically 2-24 fibres.
                </li>
                <li>
                  <strong>Patch Cable / Jumper:</strong> Single or duplex fibre with connectors
                  factory-fitted. Used for equipment connections. Simplex (1 fibre) or duplex (2
                  fibres in figure-8 or zip-cord format).
                </li>
                <li>
                  <strong>Riser Cable:</strong> Enhanced fire-retardant rating for vertical runs
                  between floors. Prevents fire spreading through risers. Must meet Euroclass Cca or
                  better in UK applications.
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white mb-2 ml-4">
                The Construction Products Regulation (CPR) requires cables in buildings to have
                Euroclass fire ratings:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Cca:</strong> Most common for indoor backbone/distribution (low flame
                  spread, limited smoke)
                </li>
                <li>
                  <strong>Dca:</strong> Minimum for general areas (moderate performance)
                </li>
                <li>
                  <strong>B2ca:</strong> Enhanced protection for sensitive areas
                </li>
                <li>
                  <strong>Eca:</strong> Basic compliance, limited applications
                </li>
              </ul>
            </div>
            ...
            <p>
              ...
              (chlorine, bromine) when burned—critical for occupied buildings. PVC produces dense
              smoke and toxic hydrogen chloride gas. While PVC is cheaper, LSZH is required by BS
              6701 and building regulations for most UK commercial installations. PVC may be
              acceptable in industrial/well-ventilated areas only.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Outdoor (external) fibre cables are engineered to withstand environmental extremes:
              temperature cycling, moisture ingress, UV exposure, and mechanical stress.{' '}
              <strong>Loose-tube construction</strong> is standard for external cables, allowing
              fibres to move freely within gel-filled tubes as temperature changes cause expansion
              and contraction.
            </p>
            ...
            <div className="my-6 grid sm:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm text-white mb-2 ml-4">
                  For installation in underground ducts
                </p>
                <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <p>
              <strong>Transition at Building Entry:</strong> External cables cannot be used inside
              buildings due to PE sheath (fire hazard). At building entry points, external cables
              must transition to internal cables via a <strong>splice enclosure</strong> or{' '}
              <strong>transition box</strong>. This is typically within 15m of building entry. Plan
              for adequate splice space and protect the transition point.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Armoured fibre cables add a metallic layer for mechanical protection against crushing,
              impact, rodent attack, and dig-in damage. The choice of armour type depends on the
              specific threats and installation method.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Direct burial:</strong> SWA provides protection against accidental dig-in
                </li>
                <li>
                  <strong>Rodent risk:</strong> CST or SWA in areas with known rodent activity
                </li>
                <li>
                  <strong>Shared ducts:</strong> Protection from other cable pulls and maintenance
                </li>
                <li>
                  <strong>Industrial areas:</strong> Mechanical protection from vehicles/equipment
                </li>
                <li>
                  <strong>Specification requirement:</strong> Client or network operator mandates
                  armour
                </li>
              </ul>
            </div>
            ...
            <p>
              <strong>Earthing Requirements:</strong> Steel armour must be{' '}
              <strong>earthed at both ends</strong> to prevent induced voltages and ensure safety.
              Use proper armour glands and earth connections per BS 7671. The armour should be
              continuous—don't cut through during mid-span work. Some cables use aluminium armour
              (lighter, no earthing required but less mechanical protection).
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Beyond standard indoor, outdoor, and armoured cables, specialised types address
              specific installation requirements or environments.
            </p>
            ...
            <div className="my-6 space-y-4">
              <div>
                ...
                <p className="text-sm text-white ml-4">
                  Combine fibre with copper conductors in single cable. Used for applications
                  needing both data (fibre) and power or legacy signals (copper). Common in CCTV,
                  access control, and industrial applications. Reduces installation complexity but
                  requires careful segregation at termination.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-white ml-4">
                  Fibres arranged in flat ribbons of 4, 8, or 12 fibres. Enables mass fusion
                  splicing (12 fibres at once). Used in high-fibre-count applications (96-864
                  fibres). Requires ribbon splicing equipment but dramatically reduces installation
                  time for large counts.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-white ml-4">
                  Ultra-small diameter cables for blowing into micro-ducts. Typical 4-6mm diameter
                  for 12-48 fibres. Used in FTTH deployments for efficient duct utilisation.
                  Requires specialist blowing equipment but allows future capacity addition.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-white ml-4">
                  Ruggedised cable for temporary installations. Heavy-duty crush-resistant jacket.
                  Used in military, events, and emergency services. Designed for repeated
                  deployment/recovery. Often pre-terminated.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Selecting the correct cable type requires evaluating the{' '}
              <strong>installation environment</strong>, <strong>physical protection needs</strong>,{' '}
              <strong>regulatory requirements</strong>, and <strong>future scalability</strong>.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>1.</strong> Indoor only? → Tight-buffer, LSZH, Cca rated
                </li>
                <li>
                  <strong>2.</strong> External in duct? → Loose-tube, PE sheath, water-blocked
                </li>
                <li>
                  <strong>3.</strong> Direct burial? → SWA armoured, PE sheath, water-blocked
                </li>
                <li>
                  <strong>4.</strong> Aerial? → ADSS or figure-8, UV resistant, wind/ice rated
                </li>
                <li>
                  <strong>5.</strong> Rodent risk? → Add CST or SWA armour
                </li>
                <li>
                  <strong>6.</strong> Building entry transition? → Plan splice enclosure location
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Using indoor cable for external run</strong> — even in duct
                </li>
                <li>
                  <strong>Using PE-sheathed cable inside buildings</strong> — fire hazard
                </li>
                <li>
                  <strong>Under-specifying fire rating</strong> — for the location
                </li>
                <li>
                  <strong>Not allowing spare fibres</strong> — for future growth
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-xs text-white">
              <div>
                ...
                <ul className="space-y-0.5">
                  <li>
                    <strong>Construction:</strong> Tight-buffer
                  </li>
                  <li>
                    <strong>Sheath:</strong> LSZH
                  </li>
                  <li>
                    <strong>Fire Rating:</strong> Cca or better
                  </li>
                  <li>
                    <strong>Use:</strong> Building backbone, risers
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-0.5">
                  <li>
                    <strong>Construction:</strong> Loose-tube
                  </li>
                  <li>
                    <strong>Sheath:</strong> PE/MDPE
                  </li>
                  <li>
                    <strong>Features:</strong> Water-blocked, UV resistant
                  </li>
                  <li>
                    <strong>Use:</strong> Duct, direct burial, aerial
                  </li>
                </ul>
              </div>
            </div>
            <p className="text-xs text-white mt-4 pt-4 border-t border-elec-yellow/30">
              <strong>Armour Options:</strong> SWA = direct burial, crush protection | CST = rodent
              protection, duct/tray
            </p>
          </div>
        </section>
