...
const InspectionTestingModule8Section5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 8 · Section 5" title="Minor Works &amp; EICR" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The two certificates that complete the BS 7671:2018+A4:2026 Appendix 6 set: Minor Works
          (MEIWC) for additions and alterations, and EICR for periodic inspection — including the C1
          / C2 / C3 / FI coding system.
        </p>
        ...
        >
          <p>
            ...
            Certificate is intended to be used for additions and alterations to an installation that
        ...
        <RegsCallout
          ...
          clause={
            <>
              Where electrical installation work does not include the provision of a new circuit or
              replacement of a distribution board or consumer unit, a Minor Electrical Installation
              Works Certificate, based on the model given in Appendix 6, may be provided for each
              circuit that has been added to or altered as an alternative to an Electrical
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Description of the minor works.</strong> Plain-English description of what was
              done — &ldquo;Added one twin socket-outlet to existing kitchen ring; new socket
            ...
            <li>
              <strong>
                ...
                circuit altered or extended (Regulation 120.3, 133.1.2, 133.1.3 and 133.5). Details
                of permitted exceptions (Regulation 411.3.3).
              </strong>{' '}
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              presence (tick-box). Main protective bonding conductor(s) — tick-boxes for Water, Gas,
              Oil, Structural steel, &ldquo;Other (Specify)&rdquo;.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Circuit No, Circuit description, Reference method (footnote: see Table 4A2 of Appendix
              4 of BS 7671:2018+A4:2026)
            </li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              RCD disconnection time at rated residual operating current (IΔn) ms; Satisfactory test
              button operation: tick-box
            </li>
            <li>
              AFDD satisfactory test button operation: tick-box. Note on form: &ldquo;NOTE: Not all
              AFDDs have a test button&rdquo;
            </li>
            <li>
          ...
          <p>
            ...
            from Module 8.3 — the regulatory acknowledgement that not every device has a test-button
            or indicator.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Section E is the most important sentence on the form. It is a declaration that the minor
            works do not impair the safety of the existing installation. That is the regulatory hook
            of the whole certificate: a MEIWC is not a certificate for the existing installation, it
            is a certificate that your specific addition or alteration has not made things worse —
            and has been designed, constructed and verified to BS 7671 in its own right.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="400" y="270" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="10">
              Examples within MEIWC scope: add a socket to existing ring, relocate a switch, replace
              a luminaire / accessory. Outside scope: add a new lighting circuit, replace the CU.
            </text>
          </svg>
        </div>
        ...
        >
          <p>
            ...
            dangerous conditions impairing safety; non-compliances with BS 7671 that might give rise
            to danger; Schedule(s) of Inspection (per Reg 642); Schedule(s) of Circuit Details and
            Schedule(s) of Test Results (per Reg 643); and guidance for the recipient(s) based on
            the model in Appendix 6.
          </p>
          <p>
            Reg 653.2 was updated at A4:2026 to add a note &ldquo;pointing out that photographic
            and/or thermographic images can be appended to the report&rdquo;. Section K of the EICR
            Notes confirms: &ldquo;Photographic and/or thermographic images can be attached to the
            report to support observations made in this Section&rdquo;.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              any damage, deterioration, defects or dangerous conditions, which might impair safety;
              any non-compliance with the requirements of BS 7671 which might give rise to danger;
              Schedule(s) of Inspection as appropriate to those detailed in Section 642; Schedule(s)
              of Circuit Details and Schedule(s) of Test Results of the appropriate tests detailed
              in Section 643; guidance for the recipient(s) based on the model in Appendix 6.
            </>
          }
              ...
              <tbody className="text-white/95">
                ...
                <tr className="border-b border-white/[0.06]">
                  ...
                  <td className="text-elec-yellow">
                    Default limitations include "No checks for safety alerts, corrective actions or
                    product recalls" (A4:2026 wording) — narrows liability
                  </td>
                </tr>
                <tr className="border-b border-white/[0.06]">
                  ...
                  <td className="text-elec-yellow">
                    SATISFACTORY / UNSATISFACTORY verdict. Driven by C1 / C2 only. C3 and FI do NOT
                    drive Unsatisfactory
                  </td>
                </tr>
                <tr className="border-b border-white/[0.06]">
                ...
                <tr className="border-b border-white/[0.06]">
                  ...
                  <td>Declaration</td>
                  <td>
                    Signatures: "Inspected and tested by" + "Report authorized for issue by" — both
                    with name, position, address, date
                  </td>
                </tr>
                <tr className="border-b border-white/[0.06]">
                ...
                <tr className="border-b border-white/[0.06]">
                  ...
                  <td>
                    Same fields as EIC Section G — earthing, max demand, electrode, main protective,
                    main switch
                  </td>
                </tr>
                <tr>
        ...
        >
          ...
          <p>
            ...
            be marked as unsatisfactory&rdquo;. Pre-A4 the inclusion of FI was sometimes treated as
            automatically Unsatisfactory; A4 made the position explicit — only C1 and C2 drive
            Unsatisfactory.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="400" y="440" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="10">
              Verdict in Section E: any C1 or C2 = UNSATISFACTORY. C3 / FI alone = SATISFACTORY (Reg
              653 / EICR Notes 12, 15).
            </text>
          </svg>
        </div>
          ...
          whatToDo={
            <>
              <span className="block">
                Lighting RCD absence: C3 (Improvement recommended). The current Reg 411.3.4 was not
                in force when the lighting was installed. Per EICR Note 4, &ldquo;An installation
                which was designed to an earlier version of BS 7671 ... is not necessarily unsafe
                for continued use, or require upgrading&rdquo;.
              </span>
              <span className="block">
              ...
              <span className="block">
                Verdict in Section E: UNSATISFACTORY (because of the C2). The two C3s do not affect
                the verdict but are recorded in the lower sub-table of Section K.
              </span>
              <span className="block">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              through 3.8 covering distributor&rsquo;s earthing, electrode, labels, conductor sizes,
              accessibility, connections.
            </li>
            <li>
              <strong>4.0 CONSUMER UNIT(S) / DISTRIBUTION BOARD(S).</strong> Items 4.1 through 4.23
              — including{' '}
              <strong className="text-elec-yellow">
            ...
            <li>
              ...
              with the bullet list, now including &ldquo;Final circuits supplying luminaires within
              domestic (household) premises (411.3.4)&rdquo;.
            </li>
            <li>
