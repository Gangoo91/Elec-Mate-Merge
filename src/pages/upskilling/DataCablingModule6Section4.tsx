    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The discipline that makes a structured cabling system maintainable across its 15-20 year
          service-independent life. ANSI/TIA-606-D (2021) administration and BS EN 50174-1 §6 — the
          identifier hierarchy, as-built drawings, test results, manufacturer warranty registration,
          the handover pack and ongoing change control. How BS 7671:2018+A4:2026 Part 6
          certification interacts with cabling administration on a §716 PoE / §545 functional
          earthing install — verbatim §544.1.2 as an example of documentation that must follow
          connections.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>ANSI/TIA-606-D (2021).</strong> Administration Standard for Telecommunications
              Infrastructure. Defines the identifier hierarchy, the labelling rules, the records to
              be maintained, the change-management discipline.
            </li>
            <li>
          ...
          <p>
            Both standards prescribe the same five core artefacts: an identifier scheme, a labelling
            discipline, an administration register, as-built drawings, and a change-control
            mechanism. Sections below take each in turn.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            work-area end carries the same identifier (often with an additional WA-position suffix).
            The administration register binds them together with all the link metadata.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            ...
            <li>
              ...
              outlets keyed by identifier (B1-FL3-TR2-PP1-P14 format). Each row carries cable type,
              Class, location, install date, test result, and any §716 / §545 metadata. The lookup
              key for everything else.
            </li>
            <li>
              <strong>4. Manufacturer warranty registration evidence.</strong> Proof of registration
              with the cabling system manufacturer (typically 20-25 year warranty), evidence of
              approved-installer status, and the test pack used to satisfy the Class-certification
          ...
          <p>
            ...
            installation, Minor Works for any subsequent additions, EICR for periodic inspection. On
            a §716 PoE / §545 functional-earthing install from 15 April 2026, both packs are
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              point or union, the connection shall be made to the consumer{`'`}s hard metal pipework
              and before any branch pipework. Where practicable the connection shall be made within
              600 mm of the meter outlet union or at the point of entry to the building if the meter
              is external.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              alterations. Schedule of Inspections. Schedule of Test Results (insulation resistance,
              continuity, earth fault loop impedance, RCD operation). The EICR at periodic
              inspection. Where §716 / §545 / §444 are in play, the certificates carry the relevant
              declarations (PoE circuit design current, MFET location, EMC segregation distances).
              Retained for the life of the installation.
            </li>
            <li>
              <strong>Cabling administration pack (TIA-606-D / BS EN 50174-1 §6).</strong> As-built
              drawings, link test results, identifier register, manufacturer warranty registration,
              change-control log, indexed cross-reference. Retained for 15-25 years (system life and
              warranty period).
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>MFET.</strong> §545.2 main functional earthing terminal — declared on the EIC,
              location on as-built, connections detailed in the cabling pack.
            </li>
            <li>
            ...
            <li>
              <strong>EMC segregation.</strong> §444.6.2 (130 mm to HID lamps) and Annex A444 Tables
              A444.1 / A444.2 segregation distances declared on the EIC and shown on as-builts.
            </li>
            <li>
        ...
        <AppendixTable
          ...
          rows={[
            ...
            ['§545 MFET location and CSAs', 'BS 7671 pack', '§545.1.1 + §545.1.2 (NEW IN A4:2026)'],
            [
            ...
            ['Link test results (Class certification)', 'Cabling pack', 'BS EN 50346 / TIA-1152-A'],
            ...
            ['Indexed cross-reference', 'Cabling pack', 'best-practice / professional discipline'],
            [
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              outlets relocated, patches re-routed, two TRs commissioned. None of the changes are in
              the pack. The original pack is now historical fiction. A fault appears in year 4; the
              technician reaches for the pack; the pack does not describe the actual cabling. Every
              move/add/change becomes a continuity-tester exercise. By year 7 the system is
          ...
          doInstead={
            <>
              ...
              as-built mark-up, a test record for the new / modified link, and a BS 7671 Minor Works
              certificate where §716 or §545 is touched. The discipline costs ~10-30 minutes per
              change — trivial compared to the operational value. Build the discipline into the
              facilities-management workflow: no patch-panel change happens without a change-log
              entry. By year 7 the records are still trustworthy and the system is still
              maintainable.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              produce as-built drawings from a measured survey; channel-test every link to its Class
              (Class EA at 500 MHz expected for Cat 6A); document what is found in a retrospective
              administration register; contact the manufacturer about retrospective warranty status
              (often unrecoverable but worth asking — sometimes possible with evidence of
              approved-installer original install). Produce a handover pack from the recovered
              records and treat that as the new baseline. From that point forward, run change
              control as if the system had been documented from day one. For the planned PoE
              upgrade, the cabling pack now provides the basis for §716 design current declarations
              on the new EIC.
            </>
          }
          whyItMatters={
            <>
              Recovery typically costs 5-15 % of original install cost. Re-cabling costs 100 %. The
              arithmetic is straightforward — recover the records and run the rest of the system
              {`'`}s life from a documented baseline. The PoE++ upgrade is the forcing function:
              §716 §716.523.2.101 (750 mA / conductor) requires the contractor to know the design
              current per link, which requires the link identifier hierarchy, which requires the
              survey. The records get rebuilt as a by-product of doing the upgrade properly.
            </>
          }
        />
