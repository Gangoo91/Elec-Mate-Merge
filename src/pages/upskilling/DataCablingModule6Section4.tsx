...
const DataCablingModule6Section4 = () => {
  useSEO({
    title: "Record-Keeping and Documentation | Data Cabling Module 6.4",
    description: "Learn documentation standards for structured cabling systems including test records, labelling schemes, and change management procedures."
  });
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/upskilling/data-cabling-module-6-section-3">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous Section
            </Link>
          </Button>
