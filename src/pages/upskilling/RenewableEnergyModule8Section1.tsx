...
const quizQuestions = [
  ...
  {
    question:
      'A new build with 8 kW ASHP + MVHR + future EV charging — what is the supply design implication?',
    options: [
  ...
  {
    question:
      'Heat-pump-ready electrical infrastructure as a separate scope from heat pump install — what does this mean?',
    options: [
...
export default function RenewableEnergyModule8Section1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 1 · BS 7671:2018+A4:2026 · Fixed equipment scope"
        title="Heat pumps in the UK electrical context"
        backTo="../renewable-energy-module-8"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          ASHP / GSHP / exhaust-air heat pumps from the installer’s electrical perspective. What an
          electrician’s scope covers vs the MCS / MIS 3005-I / -D:2025 / F-Gas framework that
          surrounds it. UK 2025-26 install patterns, typical load profiles, multi-trade delivery
          model, where BS 7671 enters.
        </p>
        ...
        <Pullquote>
          BS 7671 has no Section for heat pumps. The wiring regs don’t need one — fixed equipment
          under Parts 4-7 already covers it. The heat pump industry has its own standards on top.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">ASHP air-to-water</strong> — outdoor unit (compressor +
              outdoor coil + fan) + indoor hydraulic interface + DHW cylinder. UK 2025-26 dominant
              (~85% new domestic installs)
            </li>
            <li>
              <strong className="text-white">ASHP air-to-air</strong> — split-system style (no water
              loop); less common in UK heating context but used in some apartment / commercial
              settings
            </li>
            <li>
              <strong className="text-white">GSHP borehole</strong> — vertical bore (typical 50-150
              m deep per kW thermal); specialist drilling required; indoor unit only. Higher upfront
              cost; longer payback; minority share
            </li>
            <li>
              <strong className="text-white">GSHP horizontal collector</strong> — trenched ground
              loop (typical 1-1.5 m deep); needs land area (~150-300 m² per kW thermal); rural /
              agricultural pattern
            </li>
            <li>
              <strong className="text-white">Exhaust-air</strong> — extracts heat from the home’s
              exhaust ventilation air; integrated unit; suits MVHR-equipped airtight new builds
            </li>
            <li>
              <strong className="text-white">Hybrid (gas + heat pump)</strong>— heat pump as
              primary; gas / oil boiler as cold-peak backup. Niche but growing for properties where
              full heat pump sizing would be prohibitive
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Sizing methodology</strong> — BS EN 12831 room-by-room
              heat loss calc + SAP / PHPP for whole-house; the heat pump is sized to match the
              building’s loss at design temperature
            </li>
            <li>
              <strong className="text-white">Product approval</strong> — only MCS-approved heat
              pumps qualify for UK Government grants. Approved products listed on the MCS website
              per category + capacity
            </li>
            <li>
              <strong className="text-white">Installer competence</strong> — company must be
              MCS-certified to issue the handover. Individual installers trained per MCS curriculum
              (typically LCL Awards Level 3 Award in the Installation + Maintenance of Heat Pumps)
            </li>
            <li>
              <strong className="text-white">Customer handover documentation</strong>— MCS pack
              includes sizing calc + commissioning record + product details + warranties +
              maintenance schedule + EIC (from the electrical install) + F-Gas record (from the
              refrigerant scope)
            </li>
            <li>
              <strong className="text-white">Boiler Upgrade Scheme grant</strong> — UK Government
              grant £7,500 typical 2025-26; administered by Ofgem; customer claim submitted by MCS
              company; requires MCS handover + MCS-approved product
            </li>
            <li>
              <strong className="text-white">Boundary with BS 7671</strong> — MCS is the heat pump
              industry framework; BS 7671 is the wiring regs framework. Both apply to the same
              install; the cert evidence bundle records each
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Electrical install is one engineering layer of four on a heat pump job. Knowing where your
          scope ends — and where the next person’s starts — is the install competence.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">MCS-certified company</strong> — sizing per MIS
              3005-D:2025 + BS EN 12831-1:2017; product selection from MCS approved list; customer
              contract; MCS handover pack; Boiler Upgrade Scheme grant claim
            </li>
            <li>
              <strong className="text-white">F-Gas Cat 1 person (REFCOM)</strong> — refrigerant
              circuit. Makes the install-time connection of the factory-charged outdoor unit; tests
              for leaks; commissions the refrigerant side; F-Gas record. NOT an electrical scope
            </li>
            <li>
              <strong className="text-white">Heating engineer</strong> — hydraulic loop, radiators /
              UFH, hot water cylinder hydraulic connections, circulation pumps, expansion vessel,
              system fill + balance. Traditional plumber / heating engineer trade
            </li>
            <li>
              <strong className="text-white">BS 7671 electrical installer</strong> — this course’s
              scope. Supply assessment + DNO liaison; dedicated circuit + protective devices; RCD
              architecture; ADS verification + Zs; cable + isolator; immersion backup circuit;
              control wiring; commissioning per Part 6; EIC
            </li>
            <li>
              <strong className="text-white">Boundary clarity at quote stage</strong> — define which
              trade does what. Especially important at the refrigerant / electrical interface (the
              outdoor unit electrical connection follows the refrigerant connection — sequence
              matters)
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle structure</strong> — electrical
              scope delivers the BS 7671 EIC + Schedule of Inspections + Schedule of Test Results;
              MCS handover pack includes the EIC as one input alongside the F-Gas record + sizing
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Refrigerants governed</strong> — fluorinated greenhouse
              gases (R32, R410A legacy, R134a) + recently R290 propane (technically a hydrocarbon,
              F-Gas framework still relevant). High GWP = high regulatory attention
            </li>
            <li>
              <strong className="text-white">Cat 1 certified person</strong> — required for
              refrigerant connection + leak repair + commissioning + decommissioning. UK 2025-26
              typical accreditation via REFCOM
            </li>
            <li>
              <strong className="text-white">R290 propane</strong> — emerging premium refrigerant;
              lower GWP (3 vs 675 for R32); used in some new ASHP models (Vaillant aroTHERM Plus,
              Mitsubishi Ecodan R290). Hydrocarbon — flammable; additional siting + safety
              considerations
            </li>
            <li>
              <strong className="text-white">Electrical installer’s role</strong> — none on
              refrigerant; presence at install for sequencing + electrical commissioning
              coordination
            </li>
            <li>
              <strong className="text-white">Sequencing on install day</strong> — typically:
              hydraulic + electrical first fix (cable terminated at junction box at outdoor
              location); refrigerant Cat 1 person makes refrigerant connection + tests; electrical
              installer makes electrical connection at outdoor unit + commissioning
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — electrical scope
              records: F-Gas Cat 1 person’s name + REFCOM number + refrigerant connection date on
              file (for handover-pack cross-reference); electrical install only proceeds after
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Single-phase 7 kW thermal ASHP</strong> — 2-3 kW
              electrical input continuous (COP ~3); 10-13 A on 230 V running; standard for 3-bed
              terraced / semi-detached property
            </li>
            <li>
              <strong className="text-white">Single-phase 12 kW thermal ASHP</strong> — 3-4 kW
              electrical input continuous; 13-18 A on 230 V running; standard for 4-bed detached
              property
            </li>
            <li>
              <strong className="text-white">Start-up inrush</strong>— 3-8× running current for
              ~100-500 ms (motor compressor starting + stabilising). Compressor start-current driver
              of protective device curve choice (C or D curve preferred over B)
            </li>
            <li>
              <strong className="text-white">Backup immersion</strong>— 3 kW typical; used for boost
              + legionella cycle + fault fallback. Reg 554.x applies (Section 6 details)
            </li>
            <li>
              <strong className="text-white">Circulation pumps</strong>— primary (between heat pump
              + buffer) + secondary (between buffer + emitters); 100-300 W combined typical
            </li>
            <li>
              <strong className="text-white">Controls + sensors</strong>— 50-150 W typical
              (thermostat + zone valves + OAT sensor + controller)
            </li>
            <li>
              <strong className="text-white">Three-phase threshold</strong> — units &gt;12 kW
              thermal (typical 16, 20, 25, 30 kW thermal for larger properties / agricultural /
              light commercial) move to three-phase 400 V supply for electrical reasons (higher
              input current would need uneconomically large single-phase cable / supply)
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — manufacturer’s rated
              electrical input + sustained operating current + inrush characteristics; supply max
              demand calc; protective device selection rationale
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Retrofit gas-boiler swap</strong> — dominant pattern.
              Customer’s existing supply often inadequate (typical 60-100 A single-phase). New
              dedicated circuit for ASHP from CU. Possibly supply upgrade for larger units. Customer
              experience disruptive (heating off for 1-3 days)
            </li>
            <li>
              <strong className="text-white">New-build first-fit</strong> — heat pump + electrical
              infrastructure designed in from start. Three-phase often default. Dedicated CU way +
              outdoor cable run + isolator at design stage. Boiler Upgrade Scheme grant applicable
            </li>
            <li>
              <strong className="text-white">Upgrade from existing electric heating</strong> —
              replacing old direct-electric heating (storage heaters, electric boilers,
              immersion-only DHW) with heat pump. Electrical demand DROPS (heat pump uses ~1/3 the
              energy of direct electric for same output). Supply usually already adequate
            </li>
            <li>
              <strong className="text-white">Leisure / agricultural / commercial-curtilage</strong>{' '}
              — caravan parks, holiday lets, rural cottages, agricultural buildings, small
              commercial premises. Often three-phase. Specialist supply considerations
            </li>
            <li>
              <strong className="text-white">Heat-pump-ready prep</strong> — emerging UK 2025-26
              service offering. Customer pays for electrical infrastructure now (CU way + outdoor
              cable + isolator + supply upgrade if needed); heat pump installed later when customer
              is financially ready or technology has matured further
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-8-section-2')}
