...
const PATTestingModule3Section3 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="PAT M3 · Section 3"
        title="Signs of overheating or modification"
        backTo="/electrician/upskilling/pat-testing-module-3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The defect catalogue: discolouration, scorching, melting, hardened insulation, foil fuses,
          bypassed cut-outs and removed earth pins. The “do not test, fail it” rule in practice.
        </p>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              lightening on dark plastic, localised around a pin or a contact area. The plastic has
              been hot enough to begin chemical change — typically above its rated temperature for
              many cycles. <em>Inspection fail.</em>
            </li>
            <li>
              ...
              slightly bulged. The plug or connector may be loose in its socket because the geometry
              has shifted. <em>Inspection fail.</em>
            </li>
            <li>
            ...
            <li>
              ...
              appliance / lead is fail-and-investigate — there is a fault that the part was visibly
              trying to warn about. <em>Quarantine and refer.</em>
            </li>
          </ol>
          <p>
            ...
            inspect socket). Scorching at the appliance inlet usually means an internal fault in the
            equipment (refer for engineering inspection).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              the plug body, signs of arcing or burning at the pins or connector contacts, melted or
              distorted plastic on the plug or connector body, and any sign of scorching on the
              equipment, the appliance inlet or the supply socket. Where any sign of overheating is
              found, the equipment shall not be put back into service until the cause has been
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Surface cracking.</strong> Fine longitudinal or circumferential cracks across
              the sheath. The flex will fail in service shortly — the cracks propagate until the
              inner cores are exposed.
            </li>
            <li>
              <strong>Discolouration.</strong> Yellowing of white sheath, lightening of dark sheath,
              or visible browning. Heat-induced chemical change in the PVC.
            </li>
            <li>
              <strong>Melted / fused to the appliance body.</strong> The flex has touched a hot part
              of the appliance and the sheath has welded itself to the body. The flex is damaged at
              that contact point; the appliance routing is wrong.
            </li>
            <li>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Current passing through the contact dissipates more heat than before — even a few tens
              of milliohms times tens of amps² is several watts at a small contact area.
            </li>
            <li>
            ...
            <li>
              Eventually the contact either welds (mechanical damage on next removal), arcs (visible
              scorching, possible flashover), or fails open (appliance simply stops working).
            </li>
          </ol>
          <p>
            The diagnostic implication: when you find heat damage on the plug body around a pin, the
            matching socket has the same heat history. Inspect the socket, flag it for fixed-wiring
            inspection, and treat it as failed until the fixed-wiring electrician has cleared it.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Wrong-rating fuses fitted to stop nuisance blowing.</strong> 13 A in place of
              5 A or 3 A on equipment that legitimately blows the smaller fuse. Removes effective
              overload protection.
            </li>
            <li>
            ...
            <li>
              ...
              the reel’s 10 A overload cut-out. Removes the de-rating safety for partly-unwound use.
              Immediate quarantine.
            </li>
            <li>
              <strong>Twisted-and-taped flex joints.</strong> Flex extended or repaired by twisting
              two flexes together inside insulation tape. High contact resistance, no mechanical
              retention, no proper insulation barrier. Fail.
            </li>
            <li>
              <strong>Strip-connectors as flex couplers.</strong> Chocolate-block / strip-connector
              used inside shrink tubing to join two flexes. Not an approved coupler for flexible
              cables in service. Fail.
            </li>
            <li>
            ...
            <li>
              ...
              adaptor in long-term use, typically with no fuse. Should be a BS 1363 plug conversion.
              Fail.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              fault that the tester cannot see — and which the test sequence may bring out under the
            ...
            <li>
              ...
              visible fail at the visual stage misleads the next inspector and the duty-holder. Far
              better to record the visual fail and the action.
            </li>
            <li>
              <strong>Speed.</strong> Time spent testing a failed item is time not spent on the rest
              of the inventory. The CoP&rsquo;s position is pragmatic as well as principled.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              fixed-wiring inspection. Record on the PAT register that the socket was the suspected
              co-cause and which socket / room.
            </li>
            <li>
            ...
            <li>
              ...
              lead may also need replacing, but the heat source is inside the equipment — refer for
              engineering inspection.
            </li>
            <li>
              <strong>Junction-box / fused connection unit serving an appliance</strong> shows heat
              damage → fixed-wiring inspection territory; out of scope for the PAT inspector but
              flagged on the register and reported to the duty-holder.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="150" y="56" textAnchor="middle" fill="#EF4444" fontSize="11" fontWeight="bold">
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="400" y="56" textAnchor="middle" fill="#EF4444" fontSize="11" fontWeight="bold">
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="650" y="56" textAnchor="middle" fill="#EF4444" fontSize="11" fontWeight="bold">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Description of the defect — not just a code. &ldquo;Discolouration on plug body around
              L pin&rdquo; is more useful than &ldquo;visual fail&rdquo;.
            </li>
            <li>
            ...
            <li>
              Action taken — quarantined, replaced, repaired and re-inspected, sent for engineering
              inspection.
            </li>
            <li>
            ...
            <li>
              Duty-holder notification — who was told and when. For unauthorised modifications, this
              is mandatory feedback so management can address the source.
            </li>
          </ul>
          <p>
