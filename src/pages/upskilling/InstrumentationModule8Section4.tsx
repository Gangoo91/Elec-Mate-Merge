...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'To run equipment to failure and replace it only once it breaks down',
      'To replace all equipment on a fixed schedule irrespective of condition',
      'To generate documentation purely for audit purposes',
    ],
    correctAnswer: 0,
  },
  {
    question: 'How often should critical process instruments typically be calibrated?',
    options: ['Every 5 years', 'Only after a confirmed fault', 'Every 6 months', 'Weekly'],
    correctAnswer: 2,
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      'To run every instrument to failure so its full service life is used before replacement',
      'To replace all field equipment on a fixed time schedule regardless of its condition',
      'To find and address developing faults before they cause failures, cutting downtime and cost',
      'To generate inspection paperwork that satisfies management reporting requirements',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Only the calibration certificates',
      'Just the live sensor readings',
      'Only the as-built documentation',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'They are the most expensive single component in the enclosure to replace',
      'They are the quickest item to check, so they make a good time-filler on a round',
      'They maintain the IP appearance and finish of the enclosure for inspections',
      'They seal cable entries against moisture ingress, which otherwise causes corrosion and signal failure',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A paper logbook kept in the plant room and updated by hand each visit',
      'Each technician keeping their own task list and working from memory',
      'A CMMS (Computerised Maintenance Management System) or electronic scheduling system',
      'A shared spreadsheet with no automated reminders or maintenance history',
    ],
    correctAnswer: 2,
    explanation:
