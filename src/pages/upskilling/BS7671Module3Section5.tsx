...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "ADS stands for Automatic Disconnection of Supply—the protective measure that ensures automatic disconnection during earth faults to prevent electric shock. It's the most common protective measure in UK installations.",
  },
  {
    id: 'tt-protection',
    ...
    correctIndex: 2,
    explanation:
      'TT systems have high earth fault loop impedance (typically 20-200Ω) because the earth electrode resistance is relatively high. This means overcurrent devices cannot achieve fast enough disconnection, making RCD protection essential.',
  },
  {
    id: 'selv-definition',
    ...
    correctIndex: 0,
    explanation:
      'SELV is Safety Extra Low Voltage—a supply not exceeding 50V AC or 120V DC ripple-free, with safety isolation from higher voltages. SELV circuits have no connection to earth, providing protection through voltage limitation alone.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Socket outlets present higher risk because they're accessible to anyone, may be used with portable equipment held by hand, and are more likely to experience cord damage or wet contact. The 0.4-second maximum ensures rapid disconnection before dangerous currents can cause harm to people directly holding equipment.",
  },
  {
    question: "What's the difference between SELV and PELV?",
    answer:
      'SELV (Safety Extra Low Voltage) has no earthed points—protection relies entirely on voltage limitation and separation. PELV (Protective Extra Low Voltage) may have an earthed point but maintains the same voltage limits. PELV is used where earthing is needed for functional purposes (e.g., some control circuits).',
  },
  {
    question: 'How do I know if my Zs value is acceptable?',
    answer:
      'Compare your measured Zs against the maximum values in BS 7671 Table 41.2-41.5 for the specific protective device type and rating. The measured value must be lower than the tabulated maximum. Remember to apply the 0.8 multiplier to account for cable temperature rise under fault conditions.',
  },
  {
    question: 'When should I use an IT system instead of TN or TT?',
    answer:
      "IT systems are used where continuity of supply is critical (hospitals, laboratories, mines) because the first earth fault doesn't cause disconnection—only an alarm. This allows continued operation while the fault is located and repaired. IT systems require continuous insulation monitoring.",
  },
];
...
const quizQuestion = {
  ...
  correctAnswer: 1,
  explanation:
    'Socket outlets at 230V require maximum 0.4 second disconnection time due to the increased risk of direct contact and portable equipment use. This is specified in BS 7671 Table 41.1 and applies to all final circuits not exceeding 63A.',
};
...
const BS7671Module3Section5 = () => {
  useSEO({
    ...
    description:
      'Learn to select appropriate protective measures for different earthing systems including ADS, RCDs, SELV, and PELV per BS 7671 requirements.',
  });
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>ADS:</strong> Most common measure—disconnection during earth fault
              </li>
              <li>
                <strong>Socket circuits:</strong> 0.4s max disconnection time
              </li>
              <li>
                <strong>TT systems:</strong> RCD protection essential (high Zs)
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Zs test:</strong> Verifies protective device will operate in time
              </li>
              <li>
                <strong>SELV/PELV:</strong> Protection through voltage limitation (≤50V AC)
              </li>
              <li>
                <strong>Reference:</strong> BS 7671 Chapter 41
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ADS is the most common protective measure in UK installations. It works by ensuring
              that during an earth fault, the protective device (MCB, RCD, fuse) disconnects the
              supply quickly enough to prevent dangerous shock.
            </p>

            <div className="p-5 rounded-lg bg-white/5 my-6">
              <h3 className="text-sm font-medium text-elec-yellow mb-3">
                Disconnection Time Requirements (230V)
              </h3>
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <ul className="text-white/90 space-y-1">
                    ...
                    <li>
                      <strong>TT systems:</strong> 0.2 seconds (or 1s with RCD)
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="text-white/90 space-y-1">
                    ...
                    <li>
                      <strong>TT systems:</strong> 1 second maximum
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Earthing:</strong> All exposed-conductive-parts connected to earth
                  </li>
                  <li>
                    <strong>Bonding:</strong> Main equipotential bonding in place
                  </li>
                  <li>
                    <strong>Low Zs:</strong> Earth fault loop impedance allows fault current
                  </li>
                  <li>
                    <strong>Correct device:</strong> Protective device trips in required time
                  </li>
                </ul>
              </div>
              <div>
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Testing ADS Effectiveness
                </p>
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Zs test:</strong> Measure earth fault loop impedance
                  </li>
                  <li>
                    <strong>Compare:</strong> Check against BS 7671 maximum values
                  </li>
                  <li>
                    <strong>Apply factor:</strong> Multiply measured by 0.8 (temp rise)
                  </li>
                  <li>
                    <strong>Document:</strong> Record on schedule of test results
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Different protective devices have different characteristics. The choice depends on the
              earthing system, circuit type, and required disconnection time.
            </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                RCD Selection for TT Systems
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>30mA:</strong> Required for socket outlets, additional protection
                </li>
                <li>
                  <strong>100mA:</strong> May be used for fire protection where 30mA not practical
                </li>
                <li>
                  <strong>300mA:</strong> Suitable for equipment with high earth leakage
                </li>
                <li>
                  <strong>Time-delayed:</strong> For discrimination with downstream RCDs
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Where ADS cannot provide adequate protection, or where enhanced safety is required,
              SELV or PELV systems provide protection through voltage limitation rather than
              disconnection.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li>
                    <strong>Use:</strong> Swimming pools, bathrooms, special locations
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li>
                    <strong>Use:</strong> Control circuits, machine tools
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Zs is the total impedance of the earth fault loop—from the source, through the live
              conductor, fault, and back via the earth path. Low Zs ensures high fault current for
              fast disconnection.
            </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <ul className="text-white/90 space-y-1">
                    ...
                    <li>
                      <strong>R1:</strong> Line conductor resistance
                    </li>
                    <li>
                      <strong>R2:</strong> CPC resistance
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="text-white/90 space-y-1">
                    ...
                    <li>
                      <strong>TN-C-S:</strong> 0.20Ω typical, 0.35Ω max
                    </li>
                    <li>
                      <strong>TT:</strong> 20-200Ω (earth electrode)
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="my-6">
              ...
              <ol className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>1.</strong> Measure Zs at furthest point of circuit
                </li>
                <li>
                  <strong>2.</strong> Multiply measured value by 0.8 (temperature correction)
                </li>
                <li>
                  <strong>3.</strong> Compare against BS 7671 maximum for device type/rating
                </li>
                <li>
                  <strong>4.</strong> If exceeded, upsize CPC or add RCD protection
                </li>
              </ol>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="p-5 rounded-lg bg-red-500/5 border border-red-500/20">
            ...
            <p className="text-sm text-white mb-3">
              A TN-C-S system circuit with a long cable run fails the Zs test. The measured Zs of
              1.8Ω exceeds the 1.15Ω maximum for the 32A Type B MCB installed. The installer
              selected cable based only on current-carrying capacity, not earth fault requirements.
            </p>
            <div className="p-3 rounded bg-white/5 text-sm mb-3">
              <p>
                <strong>Problem:</strong> Long cable run increased R1+R2 beyond acceptable limits.
              </p>
            </div>
