    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The four tables in Chapter 41 — fuses at 0.4 s, circuit-breakers, fuses at 5 s, RCDs — and
          how the A4:2026 max-permitted-Zs column on the Schedule of Circuit Details pins the design
          intent into the verification step.
        </p>
        ...
        >
          <p>
            Reg 411.4.4 expresses the maximum permitted earth fault loop impedance for a protective
            device as:
          </p>
          ...
          <p>
            ...
            the current causing operation of the protective device within the required disconnection
            time, and <strong>Cmin</strong> is the minimum voltage factor (taken as 0.95 in the BS
            7671 table derivations — see NOTE 1 to Table 41.2). For Up = 230 V and a Type B 32 A MCB
            with Ia ≈ 160 A (5× rated current for the magnetic trip), the formula gives 230 × 0.95 /
            160 ≈ 1.37 Ω — which is exactly the published Table 41.3 value at Up = 230 V for that
            device. NOTE 2 then governs how a field measurement taken cold is compared against that
            limit, not a separate derating of the table figure itself.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Regulations 411.4.4 to 411.5.4 state that the maximum earth fault loop impedance for a
              protective device is given by the expression Zs = Up × Cmin / Ia where Up is the
        ...
        >
          ...
          <p>
            ...
            value of 2.30 Ω at 13 A: for a fused spur appliance, the plug-top fuse is the protective
            device the spur cable has to be sized to disconnect, and that figure is the Zs limit on
            the appliance side of the FCU.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              (Zs) values for a 0.4 s disconnection time at Up = 230 V for the following ratings: 2
              A: 33.1 Ω; 4 A: 15.6 Ω; 6 A: 7.80 Ω; 10 A: 4.65 Ω; 16 A: 2.43 Ω; 20 A: 1.68 Ω; 25 A:
              1.29 Ω; 32 A: 0.99 Ω; 40 A: 0.75 Ω; 50 A: 0.57 Ω; 63 A: 0.44 Ω. These Zs values shall
              not be exceeded for these fuse ratings when using such fuses to comply with 411.3.2.2.
            </>
          }
        ...
        >
          ...
          <p className="text-[12px] text-white/50 italic">
            Highlighted rows: 20 A and 32 A — by far the most common ratings on modern domestic and
            small commercial boards. Values are at Up = 230 V; consult the full table for other
            ratings and for the explicit 0.4 s vs 5 s split where it applies.
          </p>
          <p>
            The pattern is mechanical: for the same rating, Type C limits are roughly half Type B,
            and Type D limits are roughly half Type C again. That is the magnetic trip multiplier at
            work — Type B trips at 5× rated current, Type C at 10×, Type D at 20×. To deliver those
            higher fault currents, the loop impedance has to be correspondingly lower.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="348" y="89" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              Max Zs
            </text>
            <text x="348" y="101" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              (Ω) A4
            </text>
            ...
            <text x="347" y="125" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              1.37
            </text>
            ...
            <text x="347" y="150" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              0.45 *
            </text>
            ...
            <text x="347" y="175" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              7.67
            </text>
            ...
            <text x="347" y="200" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              1.37
            </text>
            ...
            <text x="347" y="225" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              0.69
            </text>
            ...
            <text x="205" y="335" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="640" y="89" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              Zs (Ω)
            </text>
            ...
            <text x="640" y="125" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              0.51
            </text>
            ...
            <text x="640" y="150" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              0.41
            </text>
            ...
            <text x="640" y="175" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              0.66
            </text>
            ...
            <text x="640" y="200" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              0.43
            </text>
            ...
            <text x="640" y="225" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              0.40
            </text>
            ...
            <text x="610" y="335" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              disconnection of supply requirements of Regulations 411.3.2.2 (0.4 s) and 411.3.2.3 (5
              s), including use of a table (Table 41.3) as an alternative to calculation for Up =
              230 V.
            </>
          }
        ...
        >
          <p>
            ...
            downstream final-circuit boards do not directly serve sockets or hand-held equipment, so
            the touch-voltage exposure is via downstream protection, not via direct contact with a
            faulted distribution conductor. The trade-off is that the table values are larger — a
            100 A BS 88-2 fuse in a sub-main is typically allowed Zs up to ≈ 0.46 Ω at 5 s vs ≈ 0.29
            Ω at 0.4 s.
          </p>
          <p>
            If the distribution circuit is also RCD-protected (now common on TT systems and
            increasingly required on TN-C-S where additional protection has been mandated), then the
            Reg 411.5 / Table 41.5 RCD-based limits apply in parallel and the binding constraint is
        ...
        >
          ...
          <p>
            ...
            limit is unachievable and Table 41.5 is the binding constraint. On any circuit where the
            overcurrent device cannot meet its Table 41.2 / 41.3 limit, an RCD upstream is the
        ...
        >
          ...
          <p>
            ...
            multifunction testers accept a cable temperature input and do the correction internally,
            presenting a single corrected reading; others present the raw measurement and leave the
            correction to the schedule of test results. Which one your meter does is on the
            manual&rsquo;s spec page — read it once and configure consistently.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              the line conductors are at the appropriate maximum permitted operating temperature, as
              given in Table 52.2; and (b) the circuit protective conductors are at the appropriate
              assumed initial temperature, as given in Tables 54.2 to 54.5. If the conductors are at
              a different temperature when tested, the reading should be adjusted accordingly (see
              Appendix 3).
            </>
          }
        ...
        >
          ...
          <p>
            ...
            bridge between measurement-temperature and operating-temperature conditions. It is not a
            meter accuracy allowance, not a parallel-path correction, and not a manufacturer
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              Read the maximum permitted Zs for the device from Table 41.3 (or the design value from
              the A4:2026 schedule of circuit details column).
            </li>
          ...
          <p>
            ...
            1.10 Ω. Anything below 1.10 Ω cold is comfortably compliant; anything between 1.10 Ω and
            1.37 Ω needs the explicit temperature correction; anything above 1.37 Ω cold fails on
            inspection.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              <span className="block">
                <strong>Step 4 — investigate.</strong> Likely: cable run longer than designed, joint
                degradation, or design error. Either re-design the circuit (larger CPC, shorter run)
                or change the protective device (Type C will not help — Table 41.3 32 A C = 0.69 Ω
                is tighter still; smaller rating? RCD-only fault protection? consider TT-style RCD
                compliance via Table 41.5).
              </span>
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong className="text-elec-yellow">Maximum permitted Zs</strong> — the design limit
              for this circuit, taken from Table 41.3 (or 41.2 / 41.4 / 41.5 as appropriate){' '}
              <em>or tighter</em> if the design demands it
            </li>
          </ul>
          <p>
            The Schedule of Test Results then carries the measured values: continuity (R1+R2),
            insulation resistance, polarity, measured Zs, RCD trip times, etc. The verification step
            becomes mechanical: for each circuit row, compare the measured Zs (corrected to
            operating temperature, or compared via the 0.8 expression) against the max permitted Zs
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong className="text-emerald-300">Comfortably below 0.8 × table:</strong> Pass with
              margin. Record. Move to the next circuit.
            </li>
            <li>
              ...
              marginal, document and consider a smaller protective device or larger CPC on a future
              alteration.
            </li>
            <li>
              ...
              Fail at design temperature. Investigate cable run length, terminations, and CPC size.
              Most often a longer-than-designed cable or a degraded joint.
            </li>
            <li>
            ...
            <li>
              ...
              Pass via the RCD route. Document explicitly that compliance is via Reg 411.5.3 / Table
              41.5, not Reg 411.4 / Table 41.3.
            </li>
            <li>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Schedule of Circuit Details — Maximum Permitted Zs column:</strong> the design
              limit, in ohms, two decimals. Default is the raw Table 41.2 / 41.3 / 41.4 / 41.5 value
              for the protective device. Tighter if the designer has tightened it; the design notes
              should state why (long run, voltage-drop budget, future-load allowance).
            </li>
            <li>
            ...
            <li>
              ...
              RCD-protected circuit with the binding constraint at the RCD limit, not the MCB limit.
              Long cable run noted.
            </li>
          </ul>
          <p>
