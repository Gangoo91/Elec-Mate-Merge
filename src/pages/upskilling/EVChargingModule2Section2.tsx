...
const faqs = [
  {
    ...
    answer:
      'Tethered systems typically cost £200-400 more initially, but when factoring in cable purchase for socketed systems (£150-300 for a quality Type 2 cable), the gap narrows. Over 5 years, tethered systems cost 20-30% more due to higher maintenance.',
  },
  {
    question: 'Can I convert a socketed EVSE to tethered or vice versa?',
    answer:
      'Generally no - the internal wiring and safety systems differ between types. Some manufacturers offer modular systems with interchangeable components, but these are the exception rather than the rule.',
  },
  {
    question: 'How long does a tethered cable typically last?',
    answer:
      'A quality tethered cable should last 5-10 years under normal domestic use. Commercial installations with heavy use may see cables degrade faster (3-5 years). Cable replacement typically costs £150-300.',
  },
  {
    question: 'Are there any safety differences between socketed and tethered?',
    answer:
      'Both types must meet the same safety standards (IEC 61851). Socketed systems may have marginally better contact reliability due to less wear, while tethered systems eliminate user error from poor cable connections.',
  },
];
...
const EVChargingModule2Section2 = () => {
  useSEO({
    ...
    description:
      'Compare socketed and tethered EV charging solutions, understanding advantages, applications, and selection criteria for different installation scenarios.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">Choosing the right connection type for your installation</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Socketed:</strong> User supplies cable - universal compatibility
              </li>
              <li>
                <strong>Tethered:</strong> Attached cable - maximum convenience
              </li>
              <li>
                <strong>Choice:</strong> Based on location, users, and budget
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Socket outlet = socketed; hanging cable = tethered
              </li>
              <li>
                <strong>Use:</strong> Public = tethered; multi-vehicle = socketed
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              their own cable. The charger contains all control and safety systems but relies on the
              user to provide the connection to their vehicle.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Universal:</strong> Works with any cable/connector type
                  </li>
                  <li>
                    <strong>Lower cost:</strong> £400-800 vs £600-1200 tethered
                  </li>
                  <li>
                    <strong>Less vandalism:</strong> No exposed cable to damage
                  </li>
                  <li>
                    <strong>Lower maintenance:</strong> No cable wear from weather
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>User cable required:</strong> £150-300 additional cost
                  </li>
                  <li>
                    <strong>Less convenient:</strong> Must carry and connect cable
                  </li>
                  <li>
                    <strong>Compatibility risk:</strong> User may have wrong cable
                  </li>
                  <li>
                    <strong>Not public-friendly:</strong> Visitors unlikely to have cables
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Tethered EVSE includes a permanently attached charging cable (typically 5-8m) with a
              vehicle connector. The cable includes all control conductors and is designed for
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Maximum convenience:</strong> Plug in and charge immediately
                  </li>
                  <li>
                    <strong>Always available:</strong> No forgotten cables
                  </li>
                  <li>
                    <strong>Public-ready:</strong> 95% of public chargers are tethered
                  </li>
                  <li>
                    <strong>Guaranteed compatibility:</strong> Matched connector
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Higher cost:</strong> £200-400 premium over socketed
                  </li>
                  <li>
                    <strong>Weather exposure:</strong> Cable degrades over time
                  </li>
                  <li>
                    <strong>Vandalism target:</strong> Cable can be damaged or stolen
                  </li>
                  <li>
                    <strong>Connector lock-in:</strong> Type 2 only (most common)
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Materials:</strong> UV-resistant TPU sheath, XLPE insulation
                </li>
                <li>
                  <strong>Temperature:</strong> Rated -30°C to +50°C operation
                </li>
                <li>
                  <strong>Security:</strong> Locking holster, tamper-resistant attachment
                </li>
                <li>
                  <strong>Durability:</strong> 10,000+ insertion cycles rated
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              When comparing EVSE types, consider total cost of ownership over 5+ years, not just
              initial purchase price. Maintenance, cable replacement, and operational factors
              significantly affect long-term costs.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Wrong connector type:</strong> — Check customer's vehicle before
                  specifying tethered
                </li>
                <li>
                  <strong>Ignoring maintenance:</strong> — Budget for annual cable inspection on
                  tethered units
                </li>
                <li>
                  <strong>Public socketed:</strong> — Almost never appropriate for public/visitor
                  charging
                </li>
                <li>
                  <strong>Short cable length:</strong> — Ensure 5-8m reach for vehicle positioning
                  flexibility
                </li>
              </ul>
            </div>
