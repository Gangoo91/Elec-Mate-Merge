...
export default function RenewableEnergyModule6Section6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 6 · BS 7671:2018+A4:2026 · BS EN IEC 62196-2:2022 + BS EN 61851-1"
        title="Connector, CP/PP signalling & dynamic load management"
        backTo="../renewable-energy-module-6"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The Type 2 connector standard (BS EN IEC 62196-2:2022), tethered vs untethered choice,
          Control Pilot (CP) PWM signalling protocol, Proximity Pilot (PP) cable-rating
          identification, and how DLM coordinates the EV charge rate via CP duty cycle.
        </p>
        ...
        <Pullquote>
          Type 2 plug looks simple. The signalling underneath is what makes Mode 3 a system instead
          of a socket.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              ...
              PP all active. UK 2025-26 three-phase 22 kW wallbox (rare domestic, common commercial
              / fleet — M7 scope)
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">Standard family</strong> — BS EN IEC 62196-1 (general);
              -2 (AC accessories — Type 2); -3 (DC accessories — CCS Combo 2 for Mode 4 DC fast)
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Customer cable</strong> — kept in vehicle boot; typical
            ...
            <li>
              <strong className="text-white">Cable rating</strong> — PP signalling reads the cable’s
              resistor; wallbox caps its CP duty cycle accordingly. 13 A cable on a 32 A wallbox →
              charge limited to 13 A
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">No vehicle (open circuit)</strong> — CP voltage at +12
              V, no PWM. Wallbox contactor open
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">Charging in progress</strong> — CP remains at ±6 V with
              PWM. Vehicle draws up to the PWM-announced current limit
            </li>
            <li>
            ...
            <li>
              ...
              ±12 V / ±9 V / ±6 V states. Wallbox enters fault mode; display / app shows error code;
              contactor open
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">±12 V swing</strong> — CP is a bipolar signal. Positive
              half-cycle signals charging state; negative half-cycle is for vehicle acknowledgement
              timing. The bipolar nature also provides electrical safety isolation
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              <strong className="text-white">100 Ω</strong> — cable rated 63 A (commercial / fleet)
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              <strong className="text-white">Household load rises</strong> — electric shower starts;
              wallbox’s CT clamp reads increased household current; calculation says less available
              for EV (e.g. 16 A); wallbox modulates CP PWM to 25% duty (16 A); vehicle reads new
              limit and reduces draw within sub-second
            </li>
            <li>
              <strong className="text-white">Household load falls</strong> — shower stops; CT reads
              reduced household current; wallbox calculates more available (32 A again); CP PWM
              increases to 53%; vehicle ramps draw back up
            </li>
            <li>
              <strong className="text-white">Minimum charge rate</strong> — IEC 61851-1 sets 6 A as
              the minimum Mode 3 charge rate. If DLM calculation would require less than 6 A, the
              wallbox pauses charging entirely (CP held at vehicle-detected state without PWM
        ...
        <Pullquote>
          Two EVs, one supply. DLM is no longer optional — it is the only way the maths works on a
          100 A domestic supply.
        </Pullquote>
