    ...
    <HubPage>
      ...
      <HubBody>
        <div className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'Part 2 is the load-bearing layer of BS 7671. Every duty in Parts 3 to 7 is read through it. Learn the structure, the lookup discipline, the Reg 110.1.3 override, the A4:2026 additions, and the points where IET Codes of Practice diverge.'
          }
        </div>
        ...
        >
          <p>
            ...
            somehow"). The standard's power to fix safety outcomes is delivered by its definitions.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The alphabetical layout exists because most regulations turn on a single term — find the
            term, find its boundary, and the regulation immediately becomes operable. The Symbols
            and Abbreviations sub-section exists because BS 7671 is full of acronyms that would
            otherwise have no fixed meaning: CPC (Circuit Protective Conductor), PEN (Combined
            Protective and Neutral Conductor), MET (Main Earthing Terminal), RCBO (Residual Current
            Operated Circuit Breaker with Integral Overcurrent Protection), ADS (Automatic
            Disconnection of Supply). Both sub-sections do the same job — the difference is only how
            the term is written.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            discipline is to read both halves of the loop — definition AND regulation — every time.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            A worked example: you are applying Reg 411.3.1.2 ("protective equipotential bonding") to
            a domestic kitchen with a metallic incoming gas service. <strong>(1) Part 2:</strong>{' '}
            ...
            <strong>(2) Reg 411.3.1.2:</strong> requires connection of every
            extraneous-conductive-part to the MET. <strong>(3) Special location?</strong> No —
            kitchen is not a Part 7 location, so the Part 2 definition controls. The gas service, if
            continuous metal back to the gas main, is liable to introduce Earth potential and must
            be bonded with a 10 mm² conductor (Reg 544.1.1) within 600 mm of the gas meter outlet
            (per IGEM/G/5).
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            of Parts 1 to 6, not a replacement for them — anything Part 7 does not modify continues
            to apply unmodified.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Step 1 — Part 2.</strong> "Extraneous-conductive-part: a conductive part liable
            to introduce a potential, generally Earth potential, and not forming part of the
            electrical installation." Two boundary conditions: it must be liable to introduce a
            potential (typically by being electrically continuous to true Earth via metallic
            plumbing, structural steelwork, or an external service), AND it must not be part of the
            electrical installation (so a flue bolted to a Class I appliance is not an
          ...
          <p>
            ...
            bonding requirements depending on whether the location meets the omission conditions of
            Reg 701.415.2.
          </p>
          <p>
        ...
        >
          <p>
            ...
            Lock-off, removed fuse, captive key — these exist because Part 2 demands them. Reg 537.3
            (switching for mechanical maintenance) is built on a different Part 2 term: the device
            interrupts current for non-electrical maintenance, but BS 7671 does not require the same
            lock-off-grade security — because the work being protected is mechanical, not
        ...
        >
          <p>
            ...
            stable. What changes across editions is the source-and-isolation framework around SELV,
            PELV and FELV (Section 414 and Reg 411.7) and the conditions under which each can be
          ...
          <p>
            ...
            artificial neutral." The class includes CPC, bonding conductors, the earthing conductor
            and equipotential bonding conductors — one Part 2 term, multiple Part 5 sub-types (Reg
            543).
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The structural twin of the alphabetical defined-term list, the Symbols and Abbreviations
            sub-section is read with the same lookup discipline. Cite as "Part 2 — Symbols and
            Abbreviations" when you reference an acronym formally. Do NOT substitute Wikipedia or
            trade-magazine definitions when a Part 2 entry exists; the certificate is read against
            BS 7671, and BS 7671's acronyms are the ones in Part 2.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>AFDD (Arc Fault Detection Device).</strong> A device complying with BS EN 62606.
            Underwrites Reg 421.1.7 — recommendations and (in some scenarios) requirements for AFDD
            use in single-phase final circuits, particularly in higher-fire-risk premises (HMOs,
            care homes, specified locations).
          </p>
          <p>
            ...
            battery plus EV charging is the canonical example. Underwrites Section 712 (PV) and the
            wider prosumer regulations introduced through A4.
          </p>
          <p>
            <strong>Bidirectional energy transfer.</strong> The technical language for energy moving
            in both directions across a connection — V2G EV charging, battery export, microgrid
            interconnection. Underwrites the EV (Section 722), PV (Section 712) and wider
            energy-management regulations and is the structural basis for treating a prosumer
            installation as a single coherent system rather than two parallel ones.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            beyond the minimum bonding regime in older buildings, applying tighter test intervals on
            industrial plant. Where the CoP glossary uses a term in a way that differs from Part 2,
            the right discipline is: design to the CoP, certify to BS 7671, and document any
            departure from BS 7671 (in either direction) under Reg 120.3.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The discipline is small but compounding. Every regulation read this way is a regulation
            defensible at audit, in court, against an insurer dispute, against an EICR appeal. Every
            regulation read without it is a regulation read on hope. The standard's authors built
            Part 2 to be load-bearing precisely so the rest of the standard could be operable — the
            corresponding duty on the user is to read it.
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-black truncate">2.2 Key terms</div>
          </button>
        </div>
      </HubBody>
    </HubPage>
