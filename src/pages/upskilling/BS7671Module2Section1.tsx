...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Part 2 serves as the regulatory dictionary, providing consistent definitions for all terminology used throughout BS 7671.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Consistent interpretation ensures uniform understanding, prevents misapplication, and maintains safety standards across all electrical installations.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "Misunderstanding 'isolator' could lead to installing inadequate switching devices that don't provide proper isolation, creating safety risks and non-compliance.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Every regulation in BS 7671 is underpinned by these definitions, ensuring consistent terminology and interpretation across all Parts.',
  },
  {
    question: 'What is the legal significance of Part 2 definitions?',
    answer:
      'Part 2 definitions form the legal basis for interpreting regulations and determining compliance, making them critical for professional practice.',
  },
  {
    question: 'Do Part 2 definitions get updated?',
    answer:
      'Yes, Part 2 is regularly revised to reflect technological advances and changes in the electrical industry.',
  },
  {
    question: 'Why is understanding definitions important for electricians?',
    answer:
      'Misunderstanding definitions can lead to dangerous misapplications, safety risks, compliance failures, and legal exposure.',
  },
];
...
const quizQuestion = {
  ...
  correctAnswer: 1,
  explanation:
    'Isolation is defined as the function intended to cut off for reasons of safety the supply from all, or a discrete section, of the installation by separating it from every source of electrical energy.',
};
...
const BS7671Module2Section1 = () => {
  useSEO({
    ...
    description:
      'Learn how Part 2 definitions shape application of BS 7671 regulations. Understand the regulatory dictionary and its impact on electrical installation compliance and safety.',
  });
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>What:</strong> Part 2 is the regulatory dictionary
              </li>
              <li>
                <strong>Why:</strong> Consistent interpretation prevents misapplication
              </li>
              <li>
                <strong>Impact:</strong> Every regulation depends on these definitions
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> When a regulation uses a specific term
              </li>
              <li>
                <strong>Use:</strong> Look up the exact definition in Part 2
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Part 2 of BS 7671 is titled "Definitions" and serves as the regulatory dictionary for
              the entire set of wiring regulations. Every regulation within BS 7671 is underpinned
              by these definitions, ensuring consistent interpretation and application across all
              electrical work.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Key Characteristics of Part 2:
              </p>
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                <ul className="space-y-1">
                  <li>
                    <strong>Comprehensive coverage:</strong> Defines all technical terms
                  </li>
                  <li>
                    <strong>Legal significance:</strong> Forms basis for regulatory interpretation
                  </li>
                  <li>
                    <strong>International alignment:</strong> Based on IEC standards
                  </li>
                  <li>
                    <strong>Regular updates:</strong> Revised to reflect technological advances
                  </li>
                </ul>
                <ul className="space-y-1">
                  <li>
                    <strong>Cross-referencing:</strong> Referenced throughout all other Parts
                  </li>
                  <li>
                    <strong>Practical application:</strong> Directly impacts installation methods
                  </li>
                  <li>
                    <strong>Safety focus:</strong> Definitions support safety objectives
                  </li>
                  <li>
                    <strong>Professional clarity:</strong> Eliminates ambiguity
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Consistent interpretation of definitions is crucial for safety, compliance, and
              professional practice. When terms are understood differently by different people, the
              risk of errors and accidents increases significantly.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Safety assurance:</strong> Uniform understanding prevents dangerous
                    misapplications
                  </li>
                  <li>
                    <strong>Regulatory compliance:</strong> Consistent interpretation ensures
                    installations meet requirements
                  </li>
                  <li>
                    <strong>Professional communication:</strong> Clear terminology enables effective
                    communication
                  </li>
                  <li>
                    <strong>Quality assurance:</strong> Standardised definitions support consistent
                    quality
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Safety compromises:</strong> Misunderstood definitions lead to
                    inadequate protection
                  </li>
                  <li>
                    <strong>Compliance failures:</strong> Incorrect interpretation results in
                    non-compliance
                  </li>
                  <li>
                    <strong>Legal exposure:</strong> Misapplication can lead to liability
                  </li>
                  <li>
                    <strong>Professional reputation:</strong> Errors damage credibility
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Every term defined in Part 2 directly influences how regulations are applied in
              practice. Understanding these definitions is not an academic exercise — it's essential
              for safe, compliant electrical work.
            </p>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-transparent border border-orange-500/30">
              <p className="text-sm font-medium text-orange-400 mb-3">
                The "Isolator" Misunderstanding
              </p>
              <div className="text-sm space-y-3">
                <p>
                  <strong>Situation:</strong> An electrician is asked to install an "isolator" for a
                  lighting circuit in a commercial building. Without consulting Part 2, they install
                  a standard single-pole switch, thinking it will provide adequate isolation.
                </p>

                <p>
                  <strong>The Problem:</strong> Part 2 defines an isolator as a device that must
                  "cut off for reasons of safety the supply from all, or a discrete section, of the
                  installation by separating the installation or section from every source of
                  electrical energy."
                </p>
                ...
                <p>
                  <strong>Correct Solution:</strong> Install a double-pole isolator with visible
                  indication, capable of being locked in the off position, providing true isolation
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Part 2 definitions carry significant legal weight. In the event of an incident,
              investigation, or legal proceedings, these definitions form the basis for determining
              whether work complies with recognised standards.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Expert witness testimony:</strong> Part 2 definitions used to assess
                    competence
                  </li>
                  <li>
                    <strong>HSE investigations:</strong> Compliance measured against Part 2
                    standards
                  </li>
                  <li>
                    <strong>Insurance claims:</strong> Definitions determine coverage validity
                  </li>
                  <li>
                    <strong>Court proceedings:</strong> Definitions establish technical benchmarks
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Design decisions:</strong> Definitions influence system selection
                  </li>
                  <li>
                    <strong>Safety measures:</strong> Determine appropriate protective devices
                  </li>
                  <li>
                    <strong>Testing procedures:</strong> Define test requirements and methods
                  </li>
                  <li>
                    <strong>International compatibility:</strong> Enable global project work
                  </li>
                </ul>
              </div>
            </div>
