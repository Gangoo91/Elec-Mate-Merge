...
const InspectionTestingModule1Section4 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 1 · Section 4" title="Safety during testing" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The duty under Reg 641.4 to take precautions during inspection and testing — and how that
          duty plays out in safe isolation, the narrow scope of legitimate live tests, supervision
          under EAWR Reg 16, lone-working and the PPE that keeps you alive when something slips.
        </p>
        ...
        >
          <p>
            ...
            641.2 (information), Reg 641.3 (comparison with criteria) and Reg 641.6 (competence). It
            is the safety umbrella over the whole inspection-and-testing activity. Everything in Reg
            643 — every test method, every acceptance criterion — is carried out under the
            precautions duty.
          </p>
          <p>
            The duty is also referenced in BS 7671 Part 2 definitions. &ldquo;Inspection&rdquo; and
            &ldquo;Testing&rdquo; are activities that involve direct interaction with electrical
            equipment, often live or partially live, often in places where the public or other
            workers are present. The precautions duty is the legal hinge that connects the technical
            requirements of the verification to the broader duty of care under the Health and Safety
            at Work etc. Act 1974 and the EAWR 1989.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>EAWR Reg 16:</strong> persons to be competent to prevent danger and injury. No
              person shall be engaged in any work activity where technical knowledge or experience
              is necessary unless they have it, or are under appropriate supervision. The legal
              definition of &ldquo;skilled person&rdquo; in BS 7671 Part 2 is the practical
              discharge of this duty.
            </li>
          </ul>
          <p>
            GN3 explicitly cross-references EAWR Reg 16 in Ch 4 Reg 4.9 (live diagnostic work). The
            HSE publication HSR25 is the authoritative guidance on EAWR — it is cross-referenced
            from BS 7671 Part 2 person definitions and from GN3 record-keeping guidance.
          </p>
        </ConceptBlock>
        ...
        >
          <ol className="list-decimal pl-5 space-y-2 text-[14px]">
            <li>
              ...
              circuit-checker if available, with the occupant where appropriate. The circuit you are
              about to isolate is the circuit you intend to be working on. A wrong-circuit isolation
              leaves you working on something that is still live.
            </li>
            <li>
              <strong>Switch off at the appropriate isolator.</strong> For a final circuit, the MCB
              / RCBO at the consumer unit. For the whole installation or work inside the consumer
              unit itself, the main switch. For DC sources (PV) — the dedicated DC isolator. Open
              all sources, not just one.
            </li>
            <li>
            ...
            <li>
              <strong>Prove the voltage indicator on a known live source.</strong> Use a proprietary
              voltage indicator (BS EN 61243-3 / GS38-compliant). Test it on a known live
              socket-outlet or a dedicated proving unit. Confirm L-N, L-E and N-E reads on the
              indicator. If the indicator does not light or display, do not proceed — replace or
              recheck.
            </li>
            <li>
              <strong>Test for absence of voltage at the point of work.</strong> Test L-N, L-E, N-E
              (and L-L on three-phase) at the actual conductor you will be touching. The point of
              work is not the consumer unit it is the socket / FCU / luminaire / JB you are about to
              open. Reg 643.1 / general isolation duty: prove dead on every conductor.
            </li>
            <li>
              ...
              indicator now fails to light on the known live source, your &ldquo;dead&rdquo; reading
              at step 5 was meaningless — the indicator was already broken. Stop, replace, start
              again.
            </li>
          </ol>
          <p>
            The &ldquo;prove – test – prove&rdquo; pattern (steps 4, 5, 6) is the part most commonly
            skipped under time pressure. It is also the part that has saved most lives. Make it
            muscle memory.
          </p>
        </ConceptBlock>
        ...
        <ContentEyebrow>The legitimate live tests — and how each one is controlled</ContentEyebrow>
        ...
        >
          ...
          <p>
            ...
            every accessory, ring-final r1/r2/rn — are dead tests. Performing them live is not just
            a Reg 641.4 breach, it is an EAWR Reg 14 breach: the test could reasonably be done dead,
            so the live work cannot pass the three-limb test.
          </p>
        </ConceptBlock>
        ...
        >
          <ol className="list-decimal pl-5 space-y-2 text-[14px]">
            <li>
              ...
              conductive jewellery, sleeves rolled down, hair tied back. Long enough to break a fall
              onto a charged bus, secure enough that nothing dangles.
            </li>
            <li>
              <strong>Live-test layer.</strong> Insulated rubber mat or platform under the operator,
              especially at consumer units and origin tests. Insulated gloves rated to the working
              voltage of the test point (Class 0 for up to 1000 V — typical domestic / light
              commercial). Arc-rated long-sleeve layer (FR cotton or equivalent — the layer that
              does not melt onto skin in an arc event). Arc-rated face shield or arc-rated eye
              protection at the origin.
            </li>
            <li>
              ...
              the IEEE 1584 / NFPA 70E framework are routinely referenced. This is outside the scope
              of routine domestic and light commercial work but inside the scope of any commercial
              origin Ze on a CT-metered supply.
            </li>
          </ol>
          <p>
        ...
        >
          <p>
            The HSE expects employers (and self-employed sole traders) to assess lone-working risks.
            For testing, the key controls are:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Check-in / check-out:</strong> a colleague or family member knows you are on
              site, has the address, has an expected end time, and an escalation procedure if you do
              not check out. Phone-based safety apps (lone-worker GPS check-in) are widely used.
            </li>
            <li>
              <strong>Site walkround before live work:</strong> egress route clear, occupant briefed
              (or not present), pets controlled, lighting adequate, no slip hazards.
            </li>
            <li>
          ...
          <p>
            ...
            certificate marked clearly. The procedural cost of pressing on through a degraded safety
            boundary is a fatality and a HSE prosecution. Reg 641.4 is the regulatory hook; it is
            also a survival heuristic.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Live work exclusion.</strong> An instructed person may handle the dead tests,
              the proving steps and the recording, with the supervisor checking. The live tests (Ze,
              Zs, RCD) are done by the skilled person — full stop — until competence has been signed
              off in formal training records.
            </li>
            <li>
          ...
          <p>
            ...
            supervision has lapsed and EAWR Reg 16 is no longer being discharged. The trainee should
            put the tools down for that period. Documentation of supervision and training
