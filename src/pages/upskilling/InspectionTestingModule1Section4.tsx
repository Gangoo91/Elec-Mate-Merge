...
const DESCRIPTION =
  'Essential safety procedures for electrical inspection and testing, including hazard identification, safe isolation, PPE requirements, and emergency response.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 2,
    explanation:
      'Around 10mA at 50Hz is the typical let-go threshold - above this level, muscle contraction prevents the person from releasing the conductor.',
  },
  {
    id: 'live-working',
    ...
    correctIndex: 2,
    explanation:
      "Regulation 14 permits live working only when it's unreasonable to work dead AND suitable precautions are taken to prevent injury.",
  },
  {
    id: 'shock-response',
    ...
    options: [
      ...
      'Call an ambulance',
      'Safely isolate the supply or remove them from contact',
      'Check their pulse',
    ],
    correctIndex: 2,
    explanation:
      "The priority is to safely break the circuit - isolate the supply or remove the person from contact using non-conductive material. Never touch them while they're in contact with the source.",
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 2,
    explanation:
      "Low voltage is defined as up to 1000V AC or 1500V DC. Standard 230V/400V supplies are 'low voltage' despite being potentially lethal.",
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      '50V AC is generally considered the safe touch voltage threshold in normal dry conditions. Lower limits apply in wet or high-risk environments.',
  },
  {
    id: 3,
    question: 'Arc flash is most likely to occur when:',
    options: [
      'Using low-powered equipment',
      'Working on isolated circuits',
      'Working on or near energised high-current equipment',
      'Testing with a voltage indicator',
    ],
    correctAnswer: 2,
    explanation:
      "Arc flash occurs when high fault currents ionize air between conductors. It's most dangerous at distribution boards and high-current equipment.",
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'GS38 specifies maximum 4mm exposed probe tip with finger guards to prevent accidental contact with live parts.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Class 0 gloves are rated to 1000V AC and suitable for low voltage work. They must be tested/inspected before each use.',
  },
  {
    id: 6,
    ...
    options: [
      ...
      'High-risk activities like live working or work on HV systems',
      'Only construction sites',
    ],
    correctAnswer: 2,
    explanation:
      'Permits to work provide formal control for high-risk activities, documenting hazards, precautions, and authorisation.',
  },
  {
    id: 7,
    question: 'How should you remove someone who is in contact with a live conductor?',
    options: [
      'Grab their clothing and pull',
      'Use a non-conductive item to break contact',
      'Push them away with your hands',
      'Wait until power is automatically cut off',
    ],
    correctAnswer: 1,
    explanation:
      "Use a non-conductive item (wooden broom, plastic chair, dry rope) to break contact. Never touch them directly while they're in contact with the live source.",
  },
  {
    id: 8,
    ...
    options: [
      'Any injury at all',
      'Over 7 days incapacity, specified injuries, or death',
      'Only death',
      'Only hospital treatment',
    ],
    correctAnswer: 1,
    explanation:
      "RIDDOR requires reporting of deaths, specified injuries, and injuries causing over 7 days' incapacity. Some near-miss dangerous occurrences must also be reported.",
  },
  {
    id: 9,
    ...
    options: [
      ...
      'Present until the RCD trips',
      'Only present if the RCD fails to trip',
      'Not a concern at 30mA',
    ],
    correctAnswer: 1,
    explanation:
      'During RCD testing, the test instrument draws current through the earth path. The tester is at risk until the RCD operates. This is why we test with escalating currents.',
  },
  {
    id: 10,
    question: 'The two-person rule for live working requires:',
    options: [
      'Two people to share the workload',
      'A second competent person present who can isolate supply and provide first aid',
      'Two sets of test equipment',
      'Two separate isolation points',
    ],
    correctAnswer: 1,
    explanation:
      'The second person must be competent to isolate the supply in an emergency and provide first aid if required. They should not be distracted by other tasks.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Live working is only permitted under Regulation 14 of EAW when it's unreasonable to work dead AND all suitable precautions are taken. Examples include fault-finding that requires the circuit to be energised, or testing that can only be done live. A risk assessment must justify the decision.",
  },
  {
    question: 'What PPE do I need for electrical testing?',
    answer:
      'For standard low voltage testing: safety boots, appropriate clothing (avoid loose items), safety glasses, and GS38 compliant test equipment. For work near exposed live parts: Class 0 insulating gloves, face shield, and flame-resistant clothing may be needed based on risk assessment.',
  },
  {
    question: 'Do I need to isolate every circuit before testing?',
    answer:
      'Dead tests (continuity, insulation resistance) require isolation. Live tests (loop impedance, RCD) obviously require the supply connected. The sequence in BS 7671 ensures dead tests are completed first, confirming the circuit is safe before live testing.',
  },
  {
    question: 'What should I do if I discover a dangerous situation?',
    answer:
      "Make it safe if you can do so without risk to yourself - isolate the supply, apply warning labels. If you can't make it safe, warn others and prevent access to the danger. Report to the duty holder/client. Never leave a known dangerous situation unaddressed.",
  },
  {
    question: 'How do I perform a risk assessment for electrical testing?',
    answer:
      'Identify hazards (shock, arc flash, burns, falls), assess who might be harmed, evaluate the risks and existing controls, implement additional controls if needed, record significant findings, and review regularly. Consider the specific nature of the installation and environment.',
  },
  {
    question: 'What training is required for electrical testing?',
    answer:
      'Formal qualifications like 2391 demonstrate competence in testing. You also need training in safe isolation procedures, first aid awareness (ideally specific to electrical injuries), and understanding of relevant regulations. Competence includes experience as well as qualifications.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Electricity kills:</strong> Even LV can cause fatal injuries
              </li>
              <li>
                <strong>Safe isolation:</strong> Prove-test-prove every time
              </li>
              <li>
                <strong>Live work:</strong> Only when absolutely necessary
              </li>
              <li>
                <strong>PPE:</strong> Last line of defence, not first
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>50V AC:</strong> Safe touch voltage (dry)
              </li>
              <li>
                <strong>10mA:</strong> Let-go threshold
              </li>
              <li>
                <strong>30mA:</strong> Fibrillation risk
              </li>
              <li>
                <strong>Class 0:</strong> Gloves for 1000V AC
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Electrical testing exposes workers to several serious hazards. Understanding these
              risks is the first step in preventing injuries.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              from all sources of supply and taking steps to ensure it cannot become live during
              work.
            </p>
            ...
            <div className="my-6">
              ...
              <ol className="text-sm text-white space-y-2 ml-4">
                <li>
                  <span className="text-elec-yellow">1.</span> <strong>Identify</strong> - Identify
                  all sources of supply to the equipment/circuit
                </li>
                <li>
                  <span className="text-elec-yellow">2.</span> <strong>Isolate</strong> - Disconnect
                  from all sources using a suitable device
                </li>
                <li>
                  <span className="text-elec-yellow">3.</span> <strong>Secure</strong> - Apply
                  lock-off devices and warning labels
                </li>
                <li>
                  <span className="text-elec-yellow">4.</span> <strong>Prove</strong> - PROVE
                  voltage indicator on known live source
                </li>
                <li>
                  <span className="text-elec-yellow">5.</span> <strong>Test</strong> - TEST the
                  circuit is dead at the point of work
                </li>
                <li>
                  <span className="text-elec-yellow">6.</span> <strong>Re-prove</strong> - RE-PROVE
                  voltage indicator still works on known live source
                </li>
              </ol>
            </div>

            <p className="text-sm text-orange-400/90">
              <strong>Never rely on</strong> neon indicators, circuit breaker positions, or
              statements from others that a circuit is dead. Always prove dead yourself using
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              PPE is the last line of defence - it doesn't eliminate the hazard but protects you if
              other controls fail. PPE must be appropriate for the specific hazards present.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Standard PPE for Electrical Testing
              </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Additional PPE for High-Risk Work
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Arc flash suit:</strong> For high fault current environments
                </li>
                <li>
                  <strong>Face shield:</strong> When exposed live parts are accessible
                </li>
                <li>
                  <strong>Flame-resistant clothing:</strong> For arc flash protection
                </li>
                <li>
                  <strong>Insulating matting:</strong> Additional protection on conductive floors
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              <strong>Regulation 14</strong> of the Electricity at Work Regulations covers work on
              or near live conductors. The default position is that live working is prohibited
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Live Work May Be Justified
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                ...
                <li>
                  <strong>Two-person rule</strong> - second competent person to isolate and give
                  first aid
                </li>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A <strong>safe system of work</strong> is a formal procedure resulting from systematic
              examination of work activities to identify hazards and implement controls.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Knowing how to respond to electrical emergencies can save lives. Preparation and quick
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20 my-6">
              ...
              <ol className="text-sm text-white/80 space-y-2 ml-4">
                ...
                <li>
                  ...
                  <strong>Isolate the supply</strong> if you can do so safely and quickly
                </li>
                <li>
                  <span className="text-red-400 font-bold">3.</span>{' '}
                  <strong>If you can't isolate</strong>, use non-conductive material to move them
                  from the source
                </li>
                <li>
                  <span className="text-red-400 font-bold">4.</span> <strong>Call 999</strong> and
                  state it's an electrical injury
                </li>
                <li>
                  <span className="text-red-400 font-bold">5.</span> <strong>Begin CPR</strong> if
                  they're not breathing normally
                </li>
              </ol>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Cardiac arrest</strong> can occur even after apparent recovery - always
                  seek medical attention
                </li>
                <li>
                  <strong>Internal burns</strong> may not be visible - entry and exit wounds may
                  appear minor
                </li>
                <li>
                  <strong>Don't cool</strong> electrical burns with water until sure victim is clear
        ...
        {/* Reference Card */}
        <section className="mb-10">
          <UnitsPocketCard title="Safety Reference" items={referenceItems} />
        </section>
