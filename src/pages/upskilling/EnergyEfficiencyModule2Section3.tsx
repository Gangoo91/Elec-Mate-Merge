...
const DESCRIPTION =
  'Understand the differences between kW (real power), kVA (apparent power), and kWh (energy consumption). Learn about power factor, the power triangle, and UK billing implications.';

const quickCheckQuestions = [
  {
    id: 'm2s3-qc1',
    question:
      'A motor draws 10 kVA from the supply but only produces 8 kW of useful work. What is the power factor?',
    options: ['0.6', '0.8', '1.0', '1.25'],
    correctIndex: 1,
    explanation:
      'Power Factor = kW / kVA = 8 / 10 = 0.8. This means 80% of the apparent power is converted to useful work, while 20% is reactive power circulating in the system.',
  },
  {
    id: 'm2s3-qc2',
    ...
    correctIndex: 3,
    explanation:
      'Energy (kWh) = Power (kW) x Time (hours) = 3 kW x 5 h = 15 kWh. This is the actual energy consumed and what you would be billed for on a domestic tariff.',
  },
  {
    id: 'm2s3-qc3',
    ...
    correctIndex: 1,
    explanation:
      'DNOs use kVA because it represents the total current flowing through their equipment. Even reactive current (which does no useful work) still heats cables and transformers, so equipment must be sized for the full apparent power (kVA).',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'A circuit has 12 kVA apparent power and 9 kW real power. What is the reactive power (kVAr)?',
    options: ['3 kVAr', '7.94 kVAr', '21 kVAr', '15 kVAr'],
    correctAnswer: 1,
    explanation:
      'Using Pythagoras: kVAr = sqrt(kVA squared - kW squared) = sqrt(144 - 81) = sqrt(63) = 7.94 kVAr.',
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'kWh (kilowatt-hours) measures energy consumed over time and is the standard billing unit for electricity.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Capacitors supply reactive power locally, reducing the reactive power that needs to flow from the supply. This reduces total current and improves power factor.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-3xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>kW:</strong> Real power - does useful work
              </li>
              <li>
                <strong>kVA:</strong> Apparent power - total current flow
              </li>
              <li>
                <strong>kWh:</strong> Energy consumed over time
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> High kVA for low kW = poor power factor
              </li>
              <li>
                <strong>Use:</strong> Power factor correction, cable sizing
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Real power, measured in kilowatts (kW), is the power that actually performs useful
              work. It is what heats your kettle, turns your motor shaft, and lights up your bulbs.
              This is the "working" power.
            </p>
            <p>
              Think of real power as the water that actually comes out of your tap and fills your
              glass. It is the useful output you are paying for and the work being accomplished.
            </p>
            <div className="my-6">
            ...
            <p>
              For purely resistive loads like heaters, incandescent bulbs, and kettles, real power
              equals apparent power - all the power drawn is converted to useful work (as heat or
              light). The power factor is 1.0 or "unity".
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Apparent power, measured in kilovolt-amperes (kVA), is the total power drawn from the
              electrical supply. It is the product of voltage and current, regardless of whether
              that power does useful work. This is what your cables and transformers must be sized
              to handle.
            </p>
            <p>
              Apparent power is like the total water flowing through the pipe - including any water
              that sloshes back and forth without leaving the tap. The pipe must be big enough to
              handle all this flow, even if some of it does not reach your glass.
            </p>
            <div className="my-6">
            ...
            <p>
              In AC circuits with motors, transformers, and other inductive or capacitive loads, the
              current and voltage get out of sync (out of phase). The result is that more current
              flows than strictly necessary to deliver the useful power. This extra current does no
              useful work but still heats your cables.
            </p>
            <p>
              Formula: Apparent Power (S) = V x I - simply voltage times current, no power factor
              involved.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Reactive power, measured in kilovolt-amperes reactive (kVAr), is the "wasted" power
              that oscillates between the source and load, doing no useful work. It is essential for
              creating magnetic fields in motors and transformers, but it does not turn shafts or
              produce heat.
            </p>
            <p>
              Imagine pouring a pint of beer. The liquid beer is your real power (kW) - it is what
              you actually drink. The frothy head is your reactive power (kVAr) - it takes up space
              in the glass but does not quench your thirst. The total volume (liquid + head) is your
              apparent power (kVA).
            </p>
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Formula:</strong> Power Factor (PF) = kW / kVA
                </li>
                <li>
                  <strong>PF = 1.0:</strong> All power is useful (purely resistive - heaters,
                  kettles)
                </li>
                <li>
                  <strong>PF = 0.8:</strong> 80% useful, 20% reactive (typical motor load)
                </li>
                <li>
                  <strong>PF = 0.5:</strong> Only 50% useful - very inefficient
                </li>
              </ul>
            </div>
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Lagging:</strong> Current lags behind voltage - caused by inductive loads
                  (motors, transformers). Most common in industry.
                </li>
                <li>
                  <strong>Leading:</strong> Current leads voltage - caused by capacitive loads or
                  over-correction with capacitors. Can cause voltage rise issues.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Energy, measured in kilowatt-hours (kWh), is power consumed over time. While kW and
              kVA measure instantaneous power (rate of energy flow), kWh measures the total energy
              used. This is what domestic customers see on their electricity bills.
            </p>
            <p>
              Think of kW as your car's speed (how fast you are travelling) and kWh as the distance
              covered (how far you have gone). A 100 kW motor running for 1 hour uses 100 kWh, just
              like a car at 100 km/h travels 100 km in an hour.
            </p>
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">UK Billing Structures:</p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Domestic:</strong> Pay per kWh consumed (typically 25-35p/kWh) - simple
                  energy only
                </li>
                <li>
                  <strong>Small Commercial:</strong> Pay per kWh, possibly with day/night rates and
                  standing charges
                </li>
                <li>
                  <strong>Large Commercial/Industrial:</strong> Pay for kWh plus capacity charges
                  based on maximum kVA demand. May face power factor penalties if PF falls below
                  0.95
                </li>
              </ul>
            </div>
            <p>
              Formula: Energy (kWh) = Power (kW) x Time (hours). 1 kWh = 1 "unit" of electricity on
              your bill.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The power triangle is a visual representation of the relationship between real power
              (kW), reactive power (kVAr), and apparent power (kVA). Understanding this triangle is
              essential for power factor correction calculations.
            </p>
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">Power Triangle Relationships:</p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>kW (Real Power):</strong> Adjacent side (horizontal)
                </li>
                <li>
                  <strong>kVAr (Reactive Power):</strong> Opposite side (vertical)
                </li>
                <li>
                  <strong>kVA (Apparent Power):</strong> Hypotenuse
                </li>
              </ul>
            </div>
            <div className="my-6">
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white">
                A factory draws 80 kW of real power with a power factor of 0.8 lagging:
              </p>
              ...
              <p className="text-sm text-white mt-2">
                This means 60 kVAr of reactive power is circulating in the system, requiring larger
                cables and transformers than if the load were purely resistive.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Distribution Network Operators (DNOs) size their infrastructure based on kVA, not kW.
              Understanding why this matters is crucial for electricians designing installations and
              advising customers on supply upgrades.
            </p>
            <div className="my-6">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4 mt-2">
                <li>
                  <strong>At PF = 0.7:</strong> kVA = 80 / 0.7 = 114 kVA, Current = 285A - needs 120
                  kVA supply
                </li>
                <li>
                  <strong>At PF = 0.95:</strong> kVA = 80 / 0.95 = 84 kVA, Current = 210A - 100 kVA
                  supply is fine
                </li>
              </ul>
              <p className="text-sm text-white mt-2">
            ...
            <p>
              Many UK suppliers penalise customers with poor power factor. Charges may apply if PF
              falls below 0.95 or 0.90, adding 5-15% to electricity bills. Power factor correction
              equipment often pays for itself in 1-3 years.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Confusing kW with kVA</strong> - they are only equal at unity power factor
                </li>
                <li>
                  <strong>Over-sizing capacitors</strong> - can cause leading power factor and
                  resonance issues
                </li>
                <li>
                  <strong>Ignoring harmonics</strong> - distorted waveforms affect power factor
                  readings
                </li>
              </ul>
            </div>
