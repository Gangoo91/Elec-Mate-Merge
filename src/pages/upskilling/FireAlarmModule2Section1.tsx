...
const FireAlarmModule2Section1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 2 · Section 1" title="Detector technologies" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The chamber, the heat element, the CO cell, the line-heat cable, the aspirating
          pipe-network — six fundamentally different ways of sensing fire. BS 5839-1:2025 recognises
          all of them, but clause 20.11 puts the designer on the hook for recording type, mode and
          configuration.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Weaker on clean-flaming fires.</strong> Alcohol, methanol and very-clean paper
              fires produce SMALL particles that scatter less light. Detection is slower than
              ionisation. This is the historical reason ionisation was preferred in some
              applications — a gap now filled by multi-sensor (optical + heat) instead of
              ionisation.
            </li>
            <li>
              <strong>False-alarm sources.</strong> Steam (water droplets), cooking aerosol, aerosol
              propellant, dust raised by sweeping. All scatter light and look like smoke to a
              single-sensor optical chamber. Multi-sensor (O+H AND-logic) eliminates most of these.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              technician and recorded in the operating and maintenance manual for the system. NOTE:
              A suitable means of recording the information is given in Annex D, Figure D.1.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Strong on clean-flaming fires.</strong> Alcohol, methanol, paper fast-flaming
              produce SMALL combustion particles that ionisation chambers detect efficiently —
              sometimes faster than optical chambers see the same fire. Historically this is why
              ionisation was used in escape routes and clean storage areas.
            </li>
            <li>
            ...
            <li>
              <strong>Market shift.</strong> Multi-sensor detectors (optical + heat) match or exceed
              ionisation performance on most fires WITHOUT the radioactive duty. This is the
              operational reason ionisation has receded from new BS 5839-1:2025 designs even though
              it remains technically permitted.
            </li>
          </ul>
          <p>
            The standard does not prohibit ionisation; it just no longer treats it as a default.
            Where you encounter ionisation in service, treat the source as you would any radioactive
            item — handle, log and dispose under the operator&apos;s radioactive-substances regime.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            <g>
              ...
              <text x="135" y="60" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="10">
              ...
              <text x="78" y="184" textAnchor="middle" fill="black" fontSize="8" fontWeight="bold">
                L
              </text>
            ...
            <g>
              ...
              <text x="410" y="60" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="10">
                Am-241 dual-chamber
              </text>
              <rect
                x="305"
              ...
              <text x="374" y="150" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                open
              </text>
              <rect
                x="425"
              ...
              <text x="464" y="150" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                sealed
              </text>
              <circle cx="419" cy="180" r="6" fill="#FBBF24" stroke="black" strokeWidth="1" />
              <text x="419" y="184" textAnchor="middle" fill="black" fontSize="7" fontWeight="bold">
                Am
              </text>
            ...
            <g>
              ...
              <text x="685" y="60" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="10">
                thermistor sensing
              </text>
              <rect
                x="580"
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              (typically 7.5 m either side for an optimised beam). One beam can replace a row of 30+
              point detectors.
            </li>
            <li>
        ...
        >
          ...
          <p>
            ...
            sampling-hole sizing and pressure-drop calculations all come from manufacturer software
            and BS 5839-1 detection-zoning rules. The product standard is BS EN 54-20.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              living/office spaces). The lowest-temperature class — fastest response to fire, lowest
              tolerance for ambient swings.
            </li>
            <li>
          ...
          <p>
            ...
            respond until the fire is well-developed (class too high). The design margin is between
            the highest expected ambient and the static response point.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              a category L3 system. The new recommendation is not retrospective, so existing systems
              do not need to be changed unless they are undergoing new works (e.g. a system
              upgrade).
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              minimal. Used where speed-of-response matters more than false-alarm management (escape
              routes, high-life-risk).
            </li>
            <li>
              <strong>AND-logic (alarm only when BOTH confirm).</strong> Strong false-alarm
              suppression. Optical alone (steam, aerosol, dust) will not trigger; only smoke + heat
              together will. Trade-off: response is slightly slower because the heat element must
              catch up. Used in known-false-alarm-risk areas (kitchens-adjacent, cleaning-bay
              corridors).
            </li>
            <li>
          ...
          <p>
            ...
            OR mode is, in practical terms, a smoke-or-heat detector — different behaviour from the
            same device in AND mode. The commissioning technician must know the mode to programme
            correctly; the maintainer must know the mode to test the right response. Skipping the
            documentation collapses the system to whatever the panel default happens to be — often
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              safety device. Reports TOXIC GAS locally. Detection algorithm is calibrated to the CO
              signature of leaking flueless appliances. Does not connect to a fire alarm panel.
            </li>
            <li>
              ...
              because the BS EN 50291 alarms are not on the loop. The system fails on commissioning
              when the test scenario is run. Fix: specify the standard explicitly. CO FIRE detection
              on a BS 5839-1 system is BS EN 54-26.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Identify false-alarm risk.</strong> Kitchens, kitchen-vent zones, housekeeping
              bays, smoking-area corridors → multi-sensor with AND-logic. Recently
            ...
            <li>
              ...
              D Figure D.1 gives a documentation template. The record passes to commissioning and
              into the operating and maintenance manual.
            </li>
          </ol>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              multi-sensors has been clarified. If the multi-sensor is configured to operate ONLY on
              detection of heat AND smoke, then its maximum mounting height as per Table 3 should be
              to the lowest form of detection i.e. heat.
            </>
          }
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-2/section-2')}
