...
const DESCRIPTION =
  'Learn about Zener barriers, galvanic isolators, intrinsic safety principles, energy limitation, ATEX/IECEx certification requirements, and installation best practices for hazardous areas.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "Zone 0 has the strictest requirements as explosive atmosphere is continuously present, requiring 'ia' rated equipment only with two-fault tolerance.",
  },
  {
    id: 'm7s5-qc3',
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Intrinsically safe loops are required in hazardous areas classified as Zone 0, 1, or 2 where explosive gas/vapour atmospheres may be present, ensuring electrical energy cannot cause ignition.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'ATEX (European Union) and IECEx (International) are the primary certification schemes for equipment used in explosive atmospheres, ensuring Ex-rated equipment meets safety requirements.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Hydrogen has a minimum ignition energy of approximately 20 microjoules, making it one of the most sensitive gases and classified as Group IIC.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      "Zone 1 requires 'ia' (two-fault tolerant) or 'ib' (one-fault tolerant) equipment. 'ic' is only suitable for Zone 2 where explosive atmosphere is unlikely.",
  },
  {
    id: 8,
    ...
    correctAnswer: 2,
    explanation:
      'A minimum of 50mm separation is required between IS circuits and non-IS circuits to prevent energy transfer that could compromise intrinsic safety.',
  },
  {
    id: 9,
...
const faqs = [
  {
    ...
    answer:
      'No. IS circuits must be segregated from non-IS circuits with dedicated cable trays or minimum 50mm separation. This prevents energy transfer that could compromise intrinsic safety.',
  },
  {
    question: 'How do I verify my IS loop calculation is correct?',
    answer:
      "Calculate total cable capacitance and inductance, add transmitter parameters, and verify the combination doesn't exceed barrier output limits. Many barrier manufacturers provide online calculation tools.",
  },
  {
    question: 'What happens if the IS earth connection fails?',
    answer:
      'The barrier cannot properly shunt fault energy, potentially allowing dangerous voltage levels to reach the hazardous area. Some modern systems include earth monitoring with alarms.',
  },
  {
    question: 'Can I use a galvanic isolator instead of a Zener barrier?',
    answer:
      "Yes, galvanic isolators can provide intrinsic safety and offer advantages like no earth requirement. However, they're more complex and expensive. Choice depends on application requirements.",
  },
  {
    question: 'What documents do I need for an IS installation audit?',
    answer:
      'Equipment certificates, system calculations, cable schedules, installation drawings, inspection records, competent person declarations, and maintenance procedures.',
  },
  {
    question: 'How often should IS systems be inspected?',
    answer:
      'Typically annually for general inspection and every 3 years for detailed inspection. Critical systems may require more frequent inspection based on risk assessment.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Intrinsic Safety:</strong> Limits energy below ignition thresholds
              </li>
              <li>
                <strong>Zener Barriers:</strong> Clamp voltage, limit current
              </li>
              <li>
                <strong>Galvanic Isolators:</strong> Electrical separation via transformer/optical
              </li>
              <li>
                <strong>Zone Classification:</strong> Zone 0 (continuous), Zone 1 (likely), Zone 2
                (unlikely)
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Blue-sheathed cables often indicate IS circuits
              </li>
              <li>
                <strong>Use:</strong> Always verify earth connection before energising IS barriers
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Zener barriers are passive safety devices that limit electrical energy entering
              hazardous areas. They use Zener diodes to clamp voltage and series resistors to limit
              current, ensuring that even under fault conditions, the energy cannot ignite an
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Voltage Limitation:</strong> Zener diodes clamp maximum voltage (typically
                  28V)
                </li>
                <li>
                  <strong>Current Limitation:</strong> Series resistors limit fault current
                  (typically 93mA)
                </li>
                <li>
                  <strong>Energy Limitation:</strong> Combination keeps power below 0.65W
                </li>
                <li>
                  <strong>Response Time:</strong> Less than 1 microsecond clamping speed
                </li>
                <li>
                  <strong>Ground Reference:</strong> Requires dedicated earth connection
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Mounting Location:</strong> Must be in safe area on DIN rail
                </li>
                <li>
                  <strong>Earthing:</strong> Dedicated earth bar with maximum 1 ohm resistance
                </li>
                <li>
                  <strong>Cable Separation:</strong> Minimum 50mm from non-IS circuits
                </li>
                <li>
                  <strong>Cable Types:</strong> IS-approved cable throughout hazardous zone
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Transformer Isolation:</strong> Magnetic coupling for AC signals, high
                  isolation voltage
                </li>
                <li>
                  <strong>Optical Isolation:</strong> Light-based coupling, immune to EMI, fast
                  response
                </li>
                <li>
                  <strong>Capacitive Isolation:</strong> Capacitive coupling, compact design, low
                  power
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Ground Loop Elimination:</strong> Breaks earth paths between systems
                </li>
                <li>
                  <strong>Voltage Spike Protection:</strong> Isolates transients from control
                  systems
                </li>
                <li>
                  <strong>No Earth Required:</strong> Useful where dedicated earth is impractical
                </li>
                <li>
                  <strong>Signal Integrity:</strong> Reduces noise pickup in long cable runs
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Hydrogen (Group IIC):</strong> 20 microjoules - most sensitive
                </li>
                <li>
                  <strong>Acetylene:</strong> 19 microjoules - very sensitive
                </li>
                <li>
                  <strong>Methane:</strong> 280 microjoules - typical process gas
                </li>
                <li>
                  <strong>Propane (Group IIA):</strong> 250 microjoules - common hydrocarbon
                </li>
                <li>
                  <strong>IS Design:</strong> Must be below 50% of minimum ignition energy
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>'ia' (Zone 0):</strong> Safe with two faults - highest protection
                </li>
                <li>
                  <strong>'ib' (Zone 1):</strong> Safe with one fault - standard protection
                </li>
                <li>
                  <strong>'ic' (Zone 2):</strong> Safe under normal conditions only
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Capacitive Energy:</strong> E = half of CV squared (joules)
                </li>
                <li>
                  <strong>Inductive Energy:</strong> E = half of LI squared (joules)
                </li>
                <li>
                  <strong>Safety Factor:</strong> Design to 50% of minimum ignition energy
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Zone 0:</strong> Explosive atmosphere continuously present - 'ia' only
                </li>
                <li>
                  <strong>Zone 1:</strong> Explosive atmosphere likely during operation - 'ia' or
                  'ib'
                </li>
                <li>
                  <strong>Zone 2:</strong> Explosive atmosphere unlikely - 'ia', 'ib', or 'ic'
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Equipment Certificates:</strong> Ex d, Ex e, Ex ia certification
                </li>
                <li>
                  <strong>System Calculations:</strong> Loop energy analysis and verification
                </li>
                <li>
                  <strong>Installation Drawings:</strong> Cable schedules and as-built documentation
                </li>
                <li>
                  <strong>Inspection Records:</strong> Maintenance procedures and competent person
                  declarations
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Dedicated IS Earth Bar:</strong> Maximum 1 ohm resistance, no shared
                  earths
                </li>
                <li>
                  <strong>Cable Segregation:</strong> Separate trays, 50mm minimum spacing
                </li>
                <li>
                  <strong>Clear Identification:</strong> Labelling of IS and non-IS circuits
                </li>
                <li>
                  <strong>System Verification:</strong> End-to-end testing before commissioning
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 rounded-lg bg-card/50 border border-white/10">
            <h3 className="text-sm font-medium text-elec-yellow mb-2">
              Oil Refinery Tank Level Monitoring - Zone 1
            </h3>
            <p className="text-sm text-white mb-3">
              A tank farm uses intrinsically safe loops for level monitoring in a Zone 1 hazardous
              area. The system prevents spark risk whilst providing reliable measurement for
              overflow prevention.
            </p>
            <div className="text-sm text-white space-y-2">
              <p>
                <strong>Setup:</strong> 12 radar level transmitters (Ex ia IIA T4) connected via
                Zener barriers (24V, 93mA) to DCS in control room. 300m cable runs using IS-approved
                multicore cable.
              </p>
              <p>
              ...
              <p>
                ...
                inspections confirm system integrity. Reliable level data prevents overflow
                incidents whilst maintaining full ATEX compliance.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Poor earthing</strong> - compromises barrier operation and safety
                </li>
                <li>
                  <strong>Cable mixing</strong> - IS and non-IS in same tray defeats protection
                </li>
                <li>
                  <strong>Wrong gas group</strong> - IIA equipment in IIC area is dangerous
                </li>
                <li>
                  <strong>Missing calculations</strong> - audit failure and potential unsafe
                  condition
                </li>
              </ul>
            </div>
