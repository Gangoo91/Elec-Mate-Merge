    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reg 643.3.1 in practice. The on-site sequence — pre-test posture, the live-conductor and
          live-to-earth tests, neutral lifting, the L-N link, reading the steady-state value, and
          recording.
        </p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The insulation resistance shall be measured between: (a) live conductors; and (b) live
              conductors and the protective conductor connected to the earthing arrangement. During
              this measurement, line and neutral conductors may be connected together.
            </>
          }
        ...
        >
          <p>
            The (a) limb covers leakage between conductors at different potentials in service — L-N
            on single-phase (peak ±325 V), L-L on three-phase (peak ±566 V). Dielectric degradation
            between lives turns working voltage directly into heat in the cable insulation,
            accelerating its own decay. The (b) limb covers leakage from any live to earth — the
            path that under fault would energise exposed-conductive-parts and demand protective
            device operation. The L-N link permission turns the (b) test into a single L+N-to-E
            reading on single-phase: if either L-E or N-E has degraded, the combined reading drops.
          </p>
        </ConceptBlock>
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Close the circuit MCB / switch-disconnector.</strong> This is where the logic
              feels backwards. The supply is off, but the circuit&apos;s own MCB has to be in the
              closed position so that when you put your test leads on the busbar (or on the
            ...
            <li>
              ...
              appliances — all closed. The test only proves the conductors that are in its loop, and
              an open switch isolates a section.
            </li>
            <li>
              <strong>
        ...
        >
          <p>
            ...
            L and N are the only two live conductors — but the geometry still has to be right. The N
            at the bar is connected to every other circuit&apos;s N. If you leave it on the bar, the
            meter sees: L of this circuit through the cable insulation to N of this circuit (the
            path you want), in parallel with L of this circuit through the cable insulation to N of
            this circuit by way of the bar to every other circuit&apos;s N (a path you do not want).
            On a healthy installation the parallel paths are all very high resistance and contribute
            little — but on an installation with marginal insulation elsewhere the parallel paths
            drag the reading down and you record a fail that does not belong to the circuit you
            tested.
          </p>
          <p>
            The cleanest discipline: lift the neutral at the bar before any L-N or L-E test on the
            circuit. A short pigtail of insulation tape and a labelled flag (&ldquo;CIRCUIT N LIFTED
            — DO NOT RE-ENERGISE&rdquo;) prevents the most common closeout mistake, which is
            forgetting the lift and turning the supply on with the neutral floating.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            circuit&rsquo;s switch-disconnector closed, lift the circuit&apos;s neutral at the bar.
            Run the meter&rsquo;s automated sequence. Record the worst-case value on the schedule.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="90" y="105" textAnchor="middle" fill="#EF4444" fontSize="10" fontWeight="bold">
              MCB
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="210" y="105" textAnchor="middle" fill="#3B82F6" fontSize="9" fontWeight="bold">
              N BAR
            </text>
            ...
            <text x="155" y="152" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              N LIFTED
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="92" y="216" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              E BAR
            </text>
        ...
        >
          <p>
            The L-N link is fitted at the consumer unit, downstream of the MCB and downstream of the
            lifted neutral. With the link in place, both lives are tied to a single node. One meter
            probe goes on this combined node; the other goes on the CPC. The meter is now reading
            the combined L+N to E insulation resistance — the regulation&apos;s permitted
            simplification of the (b) test.
          </p>
          <p>
            On a three-phase circuit, the analogous arrangement is to link L1, L2, L3 and N at the
            consumer unit (or sub-distribution board). The combined node is then probed against the
            CPC. Multifunction testers automate this through their internal switching matrix, and
            the reported value is the worst case of L1-E, L2-E, L3-E and N-E (or the value with all
            four linked, depending on the meter&apos;s declared method).
          </p>
          <p>
            The CPC end of the meter probe lands on the earthing terminal at the consumer unit (the
            main earth bar). The reg requires the protective conductor &ldquo;connected to the
            earthing arrangement&rdquo; — that is the earth bar, not the metalwork of the enclosure
            or the bonded gas pipe. Test current flows from the meter, through the combined live
            node, through the cable insulation, into the CPC, back to the earth bar, and into the
            meter&apos;s second probe. The cable insulation is the thing being measured.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="220" y="105" textAnchor="middle" fill="#3B82F6" fontSize="9" fontWeight="bold">
              N BAR
            </text>

            {/* Lifted N */}
            <circle cx="180" cy="135" r="4" fill="#FBBF24" />
            <text x="180" y="152" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              N LIFTED
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="145" y="125" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              L–N LINK
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="102" y="236" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              E BAR
            </text>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              <span className="block">
                5. (a) test: meter on 500 V DC, probe L (at MCB output) and N (at lifted tail), hold
                8-10 seconds, record steady-state. Expect &gt;100 MΩ on a healthy cable.
              </span>
              <span className="block">
                6. Fit the L-N link. (b) test: meter probes between combined L+N node and the earth
                bar. Hold, record. Expect &gt;100 MΩ.
              </span>
              <span className="block">
        ...
        >
          <p>
            Three currents flow under 500 V DC and decay at different rates: charging current (cable
            capacitance charging, decays with R·C — fractions of a second on T&amp;E, several
            seconds on long SWA), polarisation current (dielectric dipoles realigning, decays over
            seconds to tens of seconds), and leakage current (steady-state conduction through the
            insulation — what the meter is computing once everything else has settled). On healthy
            modern cable the steady-state value is hundreds of MΩ to GΩ; most meters cap the display
            at &gt;199 MΩ or &gt;999 MΩ.
          </p>
        </ConceptBlock>
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              periodic inspection of an older installation; a flag on a new install. Note the value
              and any remediation in comments.
            </li>
            <li>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              <span className="block">
                1. Re-confirm Reg 643.3.3 disconnections. Are there dimmers? Smoke alarms wired into
                the lighting? Anything electronic? Disconnect any candidate, re-test.
              </span>
              <span className="block">
                2. If reading still 0.7 MΩ, split the circuit. Disconnect the run at the junction
                box or ceiling rose halfway down the circuit. Re-test the upstream half. If reading
                rises &gt;100 MΩ, the fault is in the downstream half. If still 0.7 MΩ, the fault is
              ...
              <span className="block">
                4. Once the section is identified, the remediation is replacement or re-termination
                of that section. Re-test after.
              </span>
            </>
          }
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Steady-state value.</strong> Record in MΩ to one decimal. Where the meter caps
              at &gt;199 MΩ, record the cap rather than guessing a higher value.
            </li>
            <li>
            ...
            <li>
              <strong>Reg 643.3.3 audit trail.</strong> Comments column lists what was disconnected
              and the 250 V re-test reading. Example:
        ...
        <FAQ
          items={[
            ...
            {
              question: 'A two-way lighting circuit — do I have to test in both switch positions?',
              answer:
