...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      'What is the main advantage of open protocols like BACnet over proprietary protocols?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      "Open protocols like BACnet allow equipment from different manufacturers to work together, giving building owners freedom to choose products based on performance and cost rather than being locked to a single vendor's ecosystem.",
  },
  {
    id: 'osi-layers',
    question: 'At which OSI layer do BACnet and Modbus primarily operate?',
    options: ['Physical layer', 'Data link layer', 'Application layer', 'Transport layer'],
    correctIndex: 2,
    explanation:
      'BACnet and Modbus are application layer protocols. They define how data is structured and exchanged between applications, while relying on lower layers (Ethernet, RS-485) for physical transmission.',
  },
  {
    id: 'electrician-role',
...
const faqs = [
  {
    ...
    answer:
      'BACnet is specifically designed for building automation with rich object models and is typically used for HVAC, lighting, and fire systems. Modbus is simpler and more generic, often used for industrial equipment, power meters, and plant machinery. Both can coexist in the same building.',
  },
  {
    question: 'Why do some buildings use multiple protocols?',
    answer:
      'Different systems may use different protocols - HVAC might use BACnet, power metering uses Modbus, lighting uses DALI. Protocol gateways translate between them, allowing all data to be visible through a central BMS interface.',
  },
  {
    question: 'What happens if I wire RS-485 incorrectly?',
    answer:
      'Incorrect wiring (swapped A/B, missing termination, broken shield) causes communication failures, intermittent operation, or data corruption. Always verify polarity, use proper termination resistors, and maintain shield continuity.',
  },
  {
    question: 'Can I use CAT6 cable for RS-485 Modbus?',
    answer:
      "Yes, but use a twisted pair for the data signals (A/B) and ensure proper shielding. Many installers use dedicated RS-485 cable because it's designed for the application, but CAT6 can work for shorter runs with proper practices.",
  },
];
...
const BMSModule5Section1 = () => {
  useSEO({
    ...
    description:
      'Master BMS communication protocols including BACnet, Modbus, LonWorks, and KNX. Learn protocol selection, physical requirements, and electrician responsibilities for reliable building automation.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white">Communication protocol fundamentals for building automation</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Protocol:</strong> Standardised communication rules
              </li>
              <li>
                <strong>BACnet:</strong> Building-specific, most common
              </li>
              <li>
                <strong>Modbus:</strong> Simple, industrial applications
              </li>
              <li>
                <strong>Open vs Proprietary:</strong> Interoperability matters
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> RS-485 cables, Ethernet networks, gateways
              </li>
              <li>
                <strong>Use:</strong> System integration, data exchange, monitoring
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Communication protocols are standardised sets of rules that enable different devices
              to exchange data. In building automation, protocols allow sensors, controllers,
              actuators, and management systems from various manufacturers to work together as an
              integrated system.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Syntax:</strong> Data format and structure rules
                </li>
                <li>
                  <strong>Semantics:</strong> Meaning of data and commands
                </li>
                <li>
                  <strong>Timing:</strong> When and how fast data is sent
                </li>
                <li>
                  <strong>Error Handling:</strong> Detection and correction methods
                </li>
              </ul>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Layer 1:</strong> Physical (RS-485, Ethernet)
                  </li>
                  <li>
                    <strong>Layer 2:</strong> Data Link (MSTP, IP)
                  </li>
                  <li>
                    <strong>Layer 7:</strong> Application (BACnet, Modbus)
                  </li>
                </ul>
              </div>
              <div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The choice between open and proprietary protocols significantly impacts long-term
              system flexibility, maintenance costs, and vendor relationships. Understanding this
              distinction helps inform installation decisions.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div className="p-3 rounded bg-transparent border border-white/10">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>BACnet:</strong> ASHRAE standard
                  </li>
                  <li>
                    <strong>Modbus:</strong> Industry standard
                  </li>
                  <li>
                    <strong>KNX:</strong> European standard
                  </li>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Several protocols dominate the building automation industry, each with specific
              strengths and typical applications. Understanding their characteristics helps in
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              While commissioning engineers handle protocol configuration and programming,
              electricians are responsible for the physical infrastructure that makes reliable
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Cable Selection:</strong> RS-485, CAT6, fibre as specified
                </li>
                <li>
                  <strong>Termination:</strong> Proper polarity, shield grounding
                </li>
                <li>
                  <strong>Routing:</strong> Segregation from power cables
                </li>
                <li>
                  <strong>Labelling:</strong> Clear network and address marking
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-12">
          <SingleQuestionQuiz title="Test Your Knowledge" questions={bmsModule5Section1QuizData} />
        </section>
