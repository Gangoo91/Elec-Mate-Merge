...
const inlineChecks = [
  {
    id: 'm2s8-what-is-sld',
    question: 'What is a PV single-line diagram (SLD)?',
    options: [
  ...
  {
    id: 'm2s8-sld-purpose',
    question: 'Who actually reads the SLD?',
    options: [
  ...
  },
  {
    ...
    question: 'How does the SLD communicate the protection arrangement?',
    options: [
  ...
  },
  {
    ...
    question: 'How does the SLD communicate the isolation arrangement?',
    options: [
  ...
  },
  {
    ...
    question: 'The SLD is part of the cert evidence bundle. What other documents accompany it?',
    options: [
...
const faqs = [
  {
    question: 'What software is used to produce PV SLDs?',
    answer:
  ...
  {
    question: 'How detailed should the SLD be — is there a standard level?',
    answer:
  ...
  {
    question: 'Does the SLD need to be drawn to scale?',
    answer:
  ...
  {
    question: 'What standard symbols should I use?',
    answer:
  ...
  {
    question: 'Should the SLD show the DC string operating voltage or just nominal?',
    answer:
  ...
  {
    question: 'Should I produce a separate SLD for the AC side and DC side?',
    answer:
  ...
  {
    question: 'How do I show the protection coordination on the SLD?',
    answer:
  ...
  {
    question: "What's the difference between an SLD and a wiring diagram?",
    answer:
  ...
  {
    question: "How does the SLD evolve through the install's 25+ year operational life?",
    answer:
...
export default function RenewableEnergyModule2Section8() {
  ...
  useSEO({
    title: 'Reading a PV single-line diagram | Renewable Energy 2.8 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 8 · BS 7671:2018+A4:2026"
        title="Reading a PV single-line diagram"
        backTo="../renewable-energy-module-2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The PV SLD as the design artefact — what it shows, what symbols mean, how to read
          protection and isolation, and how it serves multiple audiences over the install\'s 25+
        ...
        <Pullquote>
          The SLD is the system\'s design map. The cert evidence bundle is built around it.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">PV modules</strong> — typically shown grouped into
              strings; each string annotated with module count, model, STC V_oc and cold-day V_oc
            </li>
            <li>
              <strong className="text-white">DC cabling</strong> — single line per string showing
              the run from modules to combiner box / inverter; cable cross-section annotated where
              it affects the design
            </li>
            <li>
              <strong className="text-white">Combiner box (if used)</strong> — showing per-string
              fuses (where Reg 712.431 requires) and any DC surge protective device
            </li>
            <li>
              <strong className="text-white">DC isolator</strong> — at the inverter input (or at the
              combiner box on multi-string designs); annotated with rating
            </li>
            <li>
              <strong className="text-white">Inverter</strong> — type (string, microinverter, power
              optimiser + central, hybrid); model number; AC output rating; MPPT range and number of
              MPPTs; BS EN 62109-1/-2 conformity
            </li>
            <li>
              <strong className="text-white">AC isolator</strong> — at the inverter output, readily
              accessible
            </li>
            <li>
              <strong className="text-white">Protective devices at consumer unit</strong> — RCBO of
              correct type per Reg 531.3.3 and the inverter datasheet (Type A or B); rating per the
              inverter\'s AC output
            </li>
            <li>
              <strong className="text-white">Generation meter</strong> — where applicable for SEG /
              commercial export metering
            </li>
            <li>
              <strong className="text-white">Grid connection</strong> — the point of common coupling
              with the DNO supply; the import / export metering arrangement
            </li>
            <li>
              <strong className="text-white">Warning notices</strong> — at the incomer and at the
              roof / array per OSG signposting (Module 1 Section 3)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          IEC 60617 symbols plus PV conventions. Read once; produce consistently.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">PV module</strong> — rectangle with diagonal slash and
              small triangles representing cells; sometimes shown as multiple rectangles grouped
              into a string
            </li>
            <li>
              <strong className="text-white">String interconnection</strong> — single lines
              representing the series-connected modules; polarity marked at each end (+ and −)
            </li>
            <li>
              <strong className="text-white">DC isolator</strong> — standard switch symbol with
              &ldquo;DC&rdquo; or arrows indicating disconnection of both positive and negative
              poles
            </li>
            <li>
              <strong className="text-white">Inverter</strong> — rectangle with an internal symbol
              indicating DC-AC conversion (often a wave or sine-wave shape); annotated with model
              and rating
            </li>
            <li>
              <strong className="text-white">AC isolator</strong> — standard switch symbol with
              &ldquo;AC&rdquo; or single-pole / three-pole annotation
            </li>
            <li>
              <strong className="text-white">Fuse</strong> — rectangle with diagonal line (IEC
              60617); annotated with rating and type (gPV for PV application)
            </li>
            <li>
              <strong className="text-white">MCB / RCBO</strong> — standard BS 7671 consumer unit
              conventions; annotated with rating and type
            </li>
            <li>
              <strong className="text-white">RCD type</strong> — annotated next to the RCD symbol —
              &ldquo;Type A&rdquo;, &ldquo;Type B&rdquo;, &ldquo;Type F&rdquo;
            </li>
            <li>
              <strong className="text-white">Surge protective device (SPD)</strong> — rectangle with
              diagonal arrow; class (Type 1, Type 2, Type 1+2) annotated
            </li>
            <li>
              <strong className="text-white">Meter</strong> — &ldquo;M&rdquo; in a circle for
              utility meter; separate symbols for generation meter and import meter
            </li>
            <li>
              <strong className="text-white">Battery</strong> — rectangle with battery markings;
              capacity in kWh annotated
            </li>
            <li>
              <strong className="text-white">Grid / DNO connection</strong> — triangle or
              transformer symbol depending on the connection type; annotated with supply
              characteristics (TN-S, TN-C-S, TT)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Every protective device, every isolation point, every warning notice — visible on the SLD.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Per-string fuses</strong> (where Reg 712.431 requires)
              — gPV fuses to BS EN 60269-6, in MC4-compatible holders or DIN-rail combiner box.
              Rating per the string sizing calculation (typically 1.25–1.5 × Isc_max)
            </li>
            <li>
              <strong className="text-white">DC surge protective device</strong> — at the combiner
              box, protecting the DC side against lightning-induced transients. Type 1 or Type 1+2
              depending on the lightning risk
            </li>
            <li>
              <strong className="text-white">AC isolator</strong> — at the inverter output, readily
              accessible. Annotated rating
            </li>
            <li>
              <strong className="text-white">RCBO at consumer unit</strong> — Type A or B per Reg
              531.3.3 and inverter datasheet; dedicated inverter circuit per Reg 551.7.1(d).
              Annotated with type and rating
            </li>
            <li>
              <strong className="text-white">AC surge protective device</strong> — at the consumer
              unit, protecting the AC side against transients
            </li>
            <li>
              <strong className="text-white">Bidirectional protective device</strong> — per Reg
              551.7.1(c) on grid-tied LCT, annotated with the regulatory basis
            </li>
          </ul>
          <p>Isolation items the SLD captures:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">DC isolator</strong> — at the inverter input (or
              combiner box on multi-string); readily accessible for safe- isolation. Switching both
            ...
            <li>
              <strong className="text-white">Lockable disconnection</strong> — per Reg 551.7.6 / DNO
              requirements. Location agreed with DNO; accessible per national rules
            </li>
            <li>
              <strong className="text-white">Battery isolator</strong> (on hybrid installs) — at the
              battery interface; readily accessible
            </li>
          </ul>
          <p>Warning and instruction notices the SLD references (per BS 7671 Section 712):</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">At the origin of the electrical installation</strong> —
              PV instruction notice indicating the presence of a photovoltaic system on the building
              (per Reg 712 instruction notice requirement)
            </li>
            <li>
              <strong className="text-white">At the metering position</strong> — if remote from the
              origin of the electrical installation, the PV instruction notice shall also be fixed
              at the metering position
            </li>
            <li>
              <strong className="text-white">
                At the consumer unit or distribution board supplied by the inverter
              </strong>{' '}
              — PV instruction notice at the CU / DB to which the inverter output is connected
            </li>
            <li>
              <strong className="text-white">At combiner boxes and inverter DC isolators</strong> —
              permanent warning notice about residual energisation after isolation. PV arrays and
              BESS can continue to feed live parts after local isolation (multiple interconnections,
              energy storage); the permanent warning informs operatives
            </li>
            <li>
              <strong className="text-white">At the roof / array</strong> — &ldquo;DC conductors
              live during daylight&rdquo; (OSG signposting; durable weather-resistant material)
            </li>
            <li>
              <strong className="text-white">At the battery</strong> (on hybrid installs) —
              battery-specific warnings per the manufacturer\'s requirements and Chapter 57 / IET
              CoP for EESS
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              String of 10–14 modules (annotated with module model, count, STC V_oc, cold-day V_oc)
            </li>
            <li>DC cable to inverter (annotated cross-section)</li>
            <li>DC isolator at inverter input (annotated rating)</li>
            <li>
              String inverter (model number, AC output rating, MPPT range, BS EN 62109-1/-2
              conformity)
            </li>
            <li>AC isolator at inverter output</li>
            <li>
              Dedicated RCBO at consumer unit (Type A or B per inverter datasheet, rating per AC
              output)
            </li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Sheet 1 — PV side</strong> — sub-arrays per pitch,
              combiner boxes with per-string protection per Reg 712.431, DC isolators, cable runs to
              inverter inputs
            </li>
            <li>
              <strong className="text-white">Sheet 2 — Inverter side</strong> — multi- MPPT inverter
              or multiple inverters; internal architecture; AC output arrangement
            </li>
            <li>
              <strong className="text-white">Sheet 3 — BESS side</strong> — battery topology;
              battery management system; isolation; Chapter 57 / Chapter 82 requirements
            </li>
            <li>
              <strong className="text-white">Sheet 4 — AC distribution</strong> — main AC
              distribution board; sub-distribution to EV chargepoints; circuit ratings and
              protection
            </li>
            <li>
              <strong className="text-white">Sheet 5 — DNO interface</strong> — main switch, current
              transformers, DNO meter, G99 protection scheme
            </li>
            <li>
              <strong className="text-white">Cross-reference sheet</strong> — overview showing how
              the sheets connect
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Every install change updates the SLD. The version history is the install\'s design audit
          trail.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Battery addition</strong> — Chapter 57 + Chapter 82
              design records; SLD updated to show battery topology; hybrid inverter or AC-coupled
              battery inverter on the SLD
            </li>
            <li>
              <strong className="text-white">EV chargepoint addition</strong> — Section 722 design
              records; SLD updated to show chargepoint circuit; PEN-fault protection arrangement per
              Reg 722.411.4.1 annotated
            </li>
            <li>
              <strong className="text-white">Heat pump addition</strong> — Section 712
              cross-reference if PV+heat pump coordination matters; load management arrangement on
              the PEI design pack; SLD updated to show heat pump circuit
            </li>
            <li>
              <strong className="text-white">Inverter replacement</strong> — new inverter datasheet;
              BS EN 62109-1/-2 conformity verified; RCBO type check per new inverter\'s datasheet;
              SLD updated with new inverter model and ratings
            </li>
            <li>
              <strong className="text-white">Module replacement</strong> (whole-string) — new module
              datasheet; new string sizing calculations (cold-day V_oc, MPPT range); SLD updated
              with new module model
            </li>
            <li>
              <strong className="text-white">Layout change</strong> — new physical layout drawing;
              SLD updated if electrical topology changes
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              Updated SLD post-each-change (with the change\'s own design records, EIC update, etc.)
            </li>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-2-section-7')}
