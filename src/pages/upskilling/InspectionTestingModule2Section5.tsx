...
const InspectionTestingModule2Section5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 2 · Section 5" title="Working on isolated systems" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Isolation is the start, not the end. What changes once the lock is on — back-feed sources,
          PEN faults on TN-C-S, dead-side testing rules, and the boundary you are now responsible
          for.
        </p>
        ...
        >
          <p>
            ...
            path, (b) supply-side faults that can lift the installation earth, or (c) the live parts
            that are still present on the live side of the boundary you have just opened.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              connected to more than one supply, a durable warning notice shall be placed in such a
              position that any person, before gaining access to live parts, will be warned of the
              need to isolate those parts from the various supplies unless an interlocking
        ...
        >
          <p>
            ...
            supply requiring its own isolator and its own warning notice. A permanent warning notice
            at DC-side equipment such as combiner boxes and inverter inputs is required precisely
            because the &ldquo;normal&rdquo; isolation cue (AC supply switched off) does not apply.
          </p>
          <p>
            Anti-islanding (G98 / G99 inverter behaviour) is a fault-protection feature, not an
            isolation method. It disconnects the inverter from the grid on loss of grid voltage; it
            does not prove the DC side is dead, and it does not prevent the inverter feeding a local
            island if its detection logic is fooled by a particular load arrangement.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 462.3 and Reg 537.2.4 both require that isolation devices are designed and installed
            to prevent unintentional or inadvertent closure. A changeover switch that someone could
            flip during your work is not, in that moment, doing what those regulations ask.
            Padlocking the changeover in a known position, or removing the starter key on a
            manual-start set, is the procedural counterpart to the locked isolator at the DB.
          </p>
          <p>
        ...
        >
          <p>
            ...
            not remove it. BYPASS routes the load to raw mains and idles the inverter; OFF is meant
            to disconnect the load from both feeds, but you verify by isolating each upstream feed
            and proving dead at the rack — never by trusting a single switch position on a
            multi-source system.
          </p>
          <p>
            EV charge points fed from the same DB do not back-feed your final circuit, but they
            share the protective conductor and bonding network. A fault on the charger circuit while
            you are working can put fault voltage onto the CPC of the conductor you are touching.
            Where the work is on the same earth/bonding system, isolate the charger circuit too. Reg
            722.312 requirements for EV circuits also remind us that a PEN conductor is not
            permitted on a TN-system EV circuit downstream of the origin.
          </p>
          <p>
            ...
            black-start or off-grid feature, the battery can re-feed the loads independently of the
            mains supply. Confirm the BESS is in a safe-isolated state per its manufacturer
            instructions, isolate the AC and DC sides separately, and do not rely on a single system
            controller saying it is &ldquo;off&rdquo;.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="400" y="18" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="400" y="288" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              LOCK-OFF · circuit X
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="130" y="72" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              SOLAR PV
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="670" y="72" textAnchor="middle" fill="#F87171" fontSize="11" fontWeight="bold">
              GENERATOR
            </text>
          ...
          whatToDo={
            <>
              <span className="block">
                1. Isolate the PV at the AC isolator at the inverter; isolate the DC at the array DC
                isolator. Note discharge time on the inverter.
              </span>
              <span className="block">
              ...
              <span className="block">
                ...
                lighting; if any of its outputs share earthing/bonding with your work area, isolate
                the UPS input and output too.
              </span>
              <span className="block">
        ...
        >
          <p>
            In a TN-C-S (PME) system, all exposed-conductive-parts of an installation are connected
            to the PEN conductor via the main earthing terminal and the neutral terminal, with these
            terminals linked together. The supply-side PEN is earthed at multiple points along the
            network. The whole arrangement assumes a continuous, low-impedance PEN.
          </p>
          <p>
            A broken supply-side PEN inverts the assumption. With load current still flowing on the
            line conductors and trying to return via the (now broken) PEN, the path of least
            impedance for that return current becomes the parallel earth paths via bonded metalwork
            — copper water service, gas service, structural steel — and the earth electrode if there
            is one. The MET, and everything bonded to it, sits at a voltage relative to true earth
            set by the impedance of those paths. That voltage can comfortably exceed 50 V AC and has
            been measured at over 200 V on real PEN faults.
          </p>
          <p>
            Practical signs of a developing PEN fault: tingles from a metal sink while standing on a
            concrete floor, lights flickering on one phase but not another in a three-phase
        ...
        >
          ...
          <p>
            ...
            (a) and (c) are addressed at the source — padlocked changeovers, disabled ATS, isolated
            black-start. (b) is addressed by the visible notice and the key on your person, not in
            your toolbox.
          </p>
          <p>
            Team working changes the model. Each person whose work depends on the isolation should
            ideally have their own padlock on the same multi-lock hasp, removed only by that person
            when they personally are clear. This is borrowed from process-industry lock-out /
            tag-out practice and is the most reliable control where multiple trades are on the same
            circuit.
          </p>
        </ConceptBlock>
          ...
          whatToDo={
            <>
              ...
              <span className="block">
                ...
                close the JB cover during the break, or put a screen/barrier across the access point
                and a notice on the ladder.
              </span>
              <span className="block">
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Continuity (Reg 643.2.1, GN3 Ch 2):</strong> low-resistance ohmmeter, injected
              current, reading in ohms. Safe to use on a re-connected circuit because the injected
              voltage is low. Right tool for verifying CPC and bonding before re-energisation.
            </li>
            <li>
              ...
              is likely to influence the result or be damaged by the test, the test is applied prior
              to the connection of such equipment. After re-connection, a 250 V DC test between live
              conductors and protective conductor is permitted with a 1 MΩ acceptance criterion.
            </li>
            <li>
              ...
              conductor BEFORE re-energising. The reconnection step is non-negotiable — leaving the
              electrode disconnected and re-energising is a direct breach of fault-protection.
            </li>
            <li>
        ...
        >
          <p>
            Voltage indicators are preferred over multimeters for proving dead. A multimeter set to
            volts can give a confident-looking zero reading because the rotary switch is on ohms,
            the leads are open-circuit, the battery is flat, or the fuse is blown. A two-pole
            voltage indicator with a beacon and an audible signal is purpose-built for the task and
            removes most of those failure modes. Where a multimeter is used, the
            proving-on-known-live before and after is the only protection.
          </p>
          <p>
            The proving-source test box (a small mains-powered or battery-powered known voltage) is
            the modern norm and the safest practical option. If the only known live source on site
            is a socket on the same circuit you have just isolated, that is not a known live source
            — it is the source you have made dead. Find a known live elsewhere, or carry a proving
            unit.
          </p>
        </ConceptBlock>
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Isolate each supply at its own controls. Lock or padlock each isolation point. Disable
              automatic systems (ATS, hybrid black-start) per their own manuals (Reg 462.1, Reg
              462.3, Reg 537.2.4).
            </li>
            <li>Apply the multi-supply warning notice at the work area if not already present.</li>
            <li>
              Prove dead at the point of work using a GS38-compliant tester proven before and after
            ...
            <li>
              Carry out the work using only dead-side tests with the correct instrument. Continuity
              = low-resistance ohmmeter; insulation resistance = IR tester at the Table 64 voltage
              with equipment disconnected, then 250 V DC after re-connection; polarity =
