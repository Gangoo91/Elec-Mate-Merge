    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reg 643.1 makes the order of the pre-energisation tests normative, not advisory. This
          section walks the 643.2–643.10 sequence as a flow, names what each test depends on, and
          ties every output to the A4:2026 model forms.
        </p>
        ...
        >
          <p>
            Reg 643.1 sets two ground rules. First, the measuring instruments and methods used shall
            comply with the relevant parts of BS&nbsp;EN&nbsp;61557 (or equivalent performance and
            safety). Second, the tests of Regulations 643.2 to 643.6 inclusive, where relevant,
            shall be carried out in that order and shall be completed prior to the installation
            being energised. The phrase &ldquo;in that order&rdquo; is the load-bearing wording — it
            is the basis on which an inspector justifies a result on the schedule.
          </p>
          <p>
            ...
            insulation defects. A polarity reversal at the origin means Zs measured on the presumed
            earth path is meaningless. An IPFC measured before the device characteristic is known
            cannot be compared against the device&rsquo;s breaking capacity. Reg 643.1 is the rule
            that keeps every downstream reading defensible.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              BS&nbsp;EN&nbsp;61557 or other equipment providing no lesser degree of performance and
              safety. The tests of Regulations 643.2 to 643.6, where relevant, shall be carried out
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>643.2.1 Continuity of protective conductors and bonding</strong> — every CPC,
              every main protective bonding conductor, every supplementary bond. R1+R2 by Method 1
              or R2 by Method 2 (wandering lead). Records the conductor-only earth path that Zs
              depends on.
            </li>
            <li>
              <strong>643.2.1 Continuity of ring final live conductors</strong> — r1, rn, r2 and the
              (r1+r2)/4 derivation per ring. Records the ring is intact and equally loaded.
            </li>
            <li>
            ...
            <li>
              <strong>643.4 SELV / PELV / electrical separation</strong> — confirms separation by IR
              measurement against Table 64. Only relevant where these protective measures are used.
            </li>
            <li>
            ...
            <li>
              ...
              switching and protective devices in line conductor only. Edison-screw and bayonet-cap
              (other than E14/E27 BC) outer contact to neutral.
            </li>
            <li>
            ...
            <li>
              ...
              continuity test (643.2) already passed. Measured Zs ≤ maximum permitted Zs from Table
              41.x or the tighter design value recorded on the new A4 max-permitted-Zs column of the
            ...
            <li>
              <strong>643.8 Additional protection</strong> — RCDs intended for additional protection
              (typically 30&nbsp;mA), verified per BS&nbsp;EN&nbsp;61557-6 against the 300&nbsp;ms
              maximum for general non-delay type. Where additional protection is provided by
              supplementary protective equipotential bonding, the bonding is verified against
              Chapter 41.
            </li>
            <li>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            <defs>
              <marker id="arrSeq" markerWidth="10" markerHeight="8" refX="9" refY="4" orient="auto">
                <path d="M0,0 L10,4 L0,8 z" fill="rgba(251,191,36,0.85)" />
              </marker>
              <marker id="arrDep" markerWidth="10" markerHeight="8" refX="9" refY="4" orient="auto">
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="440" y="32" textAnchor="middle" fill="#3B82F6" fontSize="12" fontWeight="bold">
              STAGE A — DEAD TESTS · Reg 643.2 to 643.6 · Supply isolated · Order is normative (Reg
              643.1)
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="220" y="82" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
            ...
            <line
              ...
              markerEnd="url(#arrSeq)"
            />
            <text x="240" y="462" textAnchor="start" fill="#FBBF24" fontSize="10" fontWeight="bold">
            ...
            <text x="440" y="822" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="11">
              Reg 643.7.2: failure of any test triggers re-test of that test AND any preceding test
              the result of which
            </text>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>IR (643.3) → polarity (643.6).</strong> Polarity is verified by continuity of
              the line from origin to point. If the IR test damaged a sensitive item that was not
              properly disconnected, the polarity reading at that point is suspect. The redrafted
              Reg 643.3.3 mandates a 250&nbsp;V DC IR test after equipment is reconnected — that
              step closes the gap.
            </li>
            <li>
            ...
            <li>
              ...
              trip-time is being measured against the wrong loop impedance and the result is not the
              protective characteristic the regulation is asking for.
            </li>
            <li>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              <span className="block">
                1. Re-run the failed IR on that circuit. The fault may have masked a second defect.
              </span>
              <span className="block">
              ...
              <span className="block">
                3. Only after both passes do you continue with polarity, then Stage B (Ze, Zs, IPFC,
                RCD, AFDD). Record the rectification on the certificate.
              </span>
            </>
          }
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Table 3A deleted.</strong> The old Time/current performance criteria for RCDs
              by Type are gone from Appendix 3. No more lookup tables that varied by Type AC / A / F
              / B.
            </li>
            <li>
              <strong>Single AC test at IΔn.</strong> Reg 643.3 explicitly states that regardless of
              RCD Type, an AC test at rated residual operating current is used to verify
              effectiveness. Reg 643.8 NOTE keeps the time limits: 300&nbsp;ms maximum for general
              non-delay; 130–500&nbsp;ms for S-type RCDs.
            </li>
            <li>
              <strong>Practical effect on your test sheet.</strong> One IΔn trip-time column instead
              of a Type-conditional set. Record the device Type alongside (still useful for context
              and for selecting the correct device on a fault report), but the acceptance number is
              now a single AC test result.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            button. Reg 643.10 wording is &lsquo;any manually operated test facility&rsquo; — so if
            a manual button is provided, it gets pressed at commissioning. If only automatic
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>AFDD details.</strong> Where AFDDs are installed under Reg 421.1.7, the model
              forms include AFDD recording fields and the schedule of test results includes an AFDD
              test column for the manual / automatic test outcome under Reg 643.10.
            </li>
            <li>
              <strong>TN-C-S (PNB) earthing.</strong> Reg 312.2.1.1 now includes an explicit
              Protective Neutral Bonding figure and requirements; the Schedule of Inspections items
              recording &ldquo;Earthing arrangement&rdquo; reflect TN-C-S with PNB as a distinct
              option (rather than only TN-C-S/PME), and the certificate captures it.
            </li>
            <li>
            ...
            <li>
              ...
              of Circuit Details for the design&rsquo;s max permitted Zs — which may be tighter than
              the Table 41.x value where the designer has imposed it. The measured Zs on the test
              schedule is judged against this column.
            </li>
            <li>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Electrical Installation Certificate (EIC) — Reg 644 / Appendix 6.</strong> For
              a new installation, an addition or an alteration that includes a new circuit. Includes
              Schedule of Inspections and Schedule of Test Results. Signed by designer, constructor
              and inspector (may be the same person).
            </li>
            <li>
              <strong>
                Minor Electrical Installation Works Certificate — Reg 644.4.201 / Appendix 6.
              ...
              existing ring, replacing an accessory like-for-like, installing a single light point.
              The relevant Reg 643 tests still apply at the affected circuit (continuity, IR,
              polarity, Zs, RCD trip-time where present).
            </li>
            <li>
              <strong>
                Electrical Installation Condition Report (EICR) — Reg 653 / Appendix 6.
              </strong>{' '}
              For periodic inspection and testing of an existing installation. Records Observations
              with classification codes (C1 immediate danger, C2 potentially dangerous, C3
              improvement recommended, FI further investigation). Schedule of Test Results attached.
              Signed by the inspector.
            </li>
          </ul>
          <p>
            The decision tree is short. New circuit anywhere in the work? EIC. Periodic inspection?
            EICR. Neither? Minor Works. EIC is never wrong (it is more comprehensive) but it is the
            wrong form to issue for periodic — Reg 653 names EICR for that.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            Not every column applies on every job. Empty columns where the test was not relevant (no
            ring on this circuit, no RCD, no AFDD) are recorded as N/A. Empty columns where the test
            was relevant and was missed are non-conformities, and the certificate is incomplete
            until they are filled or the omission is justified in the comments.
          </p>
        </ConceptBlock>
