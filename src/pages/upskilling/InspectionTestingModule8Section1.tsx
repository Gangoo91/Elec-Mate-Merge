    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The duty that precedes every test. Reg 642 sets the order, the 642.3 list of items, and
          the Appendix 6 Schedule of Inspections — updated for A4:2026 with AFDDs, luminaire RCDs
          and a Section D recalls disclaimer.
        </p>
        ...
        >
          ...
          <p>
            The safety rationale is twofold. First, the inspector is not exposed to live parts while
            looking inside a consumer unit, lifting an accessory front, or following a cable run.
            Second, an obvious defect found by eye — a partially burnt cable, a loose CPC under a
            clamp, a single-pole switch in the neutral — is addressed before any test current is
            pushed through it. Test current applied to a defective conductor either reads as a fail
            (forcing a re-test after remediation), or worse, reads as a pass because parallel paths
            are doing the work.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              applicable British or harmonised standard. Evidence is normally the conformity mark on
              the device, or certification furnished by the installer or the manufacturer. Section
              511 is the gateway: a CE/UKCA mark plus a statement of conformity to the relevant
              product standard usually closes this limb in seconds for branded consumer-unit
              components.
            </li>
            <li>
              <strong>
              ...
              — the design choice (cable size, OCPD rating, accessory type) shall match the BS 7671
              requirements AND the manufacturer’s installation instructions. This is where
          ...
          <p>
            ...
            certification furnished by the installer or the manufacturer&rdquo;. You do not need to
            re-test or re-certify a CE/UKCA-marked accessory at every visit — but you do need to
            read the mark, and you do need to flag where one is missing or damaged beyond
            recognition.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The inspection shall be made to verify that the installed electrical equipment is: (a)
              in compliance with the requirements of Section 511 (this may be ascertained by mark or
              by certification furnished by the installer or the manufacturer); and (b) correctly
              selected and erected in accordance with BS 7671, taking into account manufacturers’
              instructions; and (c) not visibly damaged or defective so as to impair safety.
            </>
          }
        ...
        >
          <p>
            The Reg 642.3 list is the spine of the visual inspection. Each item maps to one or more
            line entries on the Schedule of Inspections in Appendix 6. The list begins with the
            connection-and-identification fundamentals and ends with surge protection and EMC. The
            headlines:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>(a) connection of conductors</strong> — terminations tight, no hairs, correct
              conductor in correct terminal, no double-occupancy in single-conductor terminals.
            </li>
            <li>
            ...
            <li>
              <strong>
                (c) routing of cables in prescribed zones, or protection against mechanical damage,
                in compliance with Section 522
              </strong>
              .
            </li>
            <li>
            ...
            <li>
              <strong>
                (e) connection of single-pole devices for protection or switching in line conductors
                only
              </strong>
              .
            </li>
          ...
          <p>
            ...
            Bathrooms (Section 701), agricultural premises (Section 705), construction sites (704),
            EV charging (722), solar PV (712) — each adds its own inspection items on top of the
            base 642.3 list.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              relevant: (a) connection of conductors; (b) identification of conductors; (c) routing
              of cables in prescribed zones, or protection against mechanical damage, in compliance
              with Section 522; (d) selection of conductors for current-carrying capacity and
              voltage drop, in accordance with the design; (e) connection of single-pole devices for
              protection or switching in line conductors only; (f) correct connection of accessories
              and equipment; (g) presence of fire barriers, suitable seals and protection against
              thermal effects; (h) methods of protection against electric shock; … The inspection
              shall include all particular requirements for special installations or locations (Part
              7).
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="120" y="142" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              MAIN SW
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="200" y="142" textAnchor="middle" fill="#A855F7" fontSize="9" fontWeight="bold">
              SPD
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="270" y="140" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              AFDD/
            </text>
            <text x="270" y="152" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              RCBO
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="340" y="140" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              RCBO
            </text>
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="620" y="134" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              EARTH BAR (MET)
            </text>
            ...
            <line
              ...
              strokeWidth="1.2"
            />
            <text x="120" y="218" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              1
            </text>
            ...
            <line
              ...
              strokeWidth="1.2"
            />
            <text x="200" y="218" textAnchor="middle" fill="#A855F7" fontSize="9" fontWeight="bold">
              2
            </text>
            ...
            <line
              ...
              strokeWidth="1.2"
            />
            <text x="270" y="278" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              3
            </text>
            ...
            <line
              ...
              strokeWidth="1.2"
            />
            <text x="340" y="278" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              4
            </text>
            ...
            <line
              ...
              strokeWidth="1.2"
            />
            <text x="405" y="218" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              5
            </text>
            ...
            <line
              ...
              strokeWidth="1.2"
            />
            <text x="620" y="218" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              6
            </text>
            ...
            <line
              ...
              strokeWidth="1.2"
            />
            <text x="710" y="278" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              7
            </text>
            ...
            <text x="410" y="410" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="10">
              A4:2026 added items 4.23 (AFDD operational indication) and 5.12 (luminaire RCD ≤ 30 mA
        ...
        >
          <p>
            ...
            installation earthing and bonding, consumer unit, distribution circuits, final circuits,
            special locations, isolation and switching, safety services, identification and notices,
            accessories and current-using equipment) with a tick-box and a comment column against
            each line. Per A4:2026:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Schedule simplified for initial verification</strong> — fewer redundant lines,
              better grouped by Reg 642.3 family. The cert is leaner without losing the audit trail.
            </li>
            <li>
          ...
          <p>
            The numeric tags matter: GN3 cross-references &ldquo;tag 4.23&rdquo; to AFDD operational
            indication, &ldquo;tag 5.12&rdquo; to luminaire RCD requirements, and so on. The tag is
            not a page number — it is a stable reference into the regulations, which is why the same
            tag appears on the example checklist, the schedule of inspections, and the underlying
            Reg.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            installations. GN3 is explicit that &ldquo;the inspector cannot comment if AFDDs are not
            installed when their use was a matter for the designer to decide&rdquo;. So the EICR
            coding flow is:
          </p>
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>AFDDs designed-in and present, indicators healthy</strong> — pass against item
              4.23.
            </li>
            <li>
            ...
            <li>
              ...
              — the prohibition under Reg 710.421.1.7 / 710.421.1.7.101 bites; presence of AFDDs on
              those circuits is itself a non-compliance.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          <p>
            This is a hard requirement, not a recommendation. The inspection sequence on a domestic
            EICR:
          </p>
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
            ...
            <li>
              Confirm each one is provided with additional protection by an RCD whose rated residual
              operating current is ≤ 30 mA. Evidence: device markings on the protective device (RCBO
              label or shared RCD), consumer-unit labelling, and circuit identification on the
              schedule.
            </li>
            <li>
              Where the lighting circuit is on a Type B MCB only (no RCD), record the non-compliance
              with Reg 411.3.4 and apply the appropriate observation code (typically C3 for
              non-compliance with current standards on an existing installation; consider C2 where
              touch shock risk is elevated).
            </li>
          </ol>
          <p>
            The exception path for older installations is the standard EICR coding judgement, not an
            exception from the inspection. The inspector still records the absence of RCD protection
            — the question is which code to apply, not whether to comment.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              protection by an RCD with a rated residual operating current not exceeding 30 mA shall
              be provided for AC final circuits supplying luminaires.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              comments. The Section D disclaimer caveats that the inspection cannot identify future
              recalls or recalls of equipment outside the scope of the additions or alterations.
            </li>
          </ul>
          <p>
            The same principle is in the GN3 note: &ldquo;the recall check applies not only to named
            items but to similar protective devices and switching equipment encountered during
            additions and alterations&rdquo;. The wording &ldquo;switch, circuit-breakers, RCBOs,
            RCCBs, etc.&rdquo; is illustrative — the duty is to recall-check protective and
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Isolate</strong> — open the appropriate isolation device. Confirm the isolator
              location is suitable for the part being inspected. Lock off where the isolator is
              remote from the work or accessible to others.
            </li>
            <li>
            ...
            <li>
              <strong>Test</strong> — only now does the multifunction tester come out. Tests of Reg
              643.2 to 643.6 are carried out in that order before energisation; tests of Reg 643.7
              onwards follow energisation.
            </li>
          </ol>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Testing shall not commence until the inspection required by Regulation 642.1 has been
              completed and any defects that would render testing unsafe or invalid have been
              addressed.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              required by design&rdquo;) so a future inspector knows it was considered, not skipped.
            </li>
            <li>
          ...
          <p>
            On A4:2026 EICRs, the Section D &ldquo;next inspection&rdquo; recommendation and the new
            safety alerts / recalls disclaimer sit alongside this coded outcome. The recommendation
            interval is the designer’s judgement; the disclaimer is the inspector’s scope-of-work
            caveat.
          </p>
        </ConceptBlock>
