...
const DESCRIPTION =
  'Master visual inspection techniques to identify defects, damage, and non-compliance before performing electrical tests.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Visual inspection must be performed before energising the installation and before electrical testing. This identifies obvious hazards and defects that could make testing dangerous.',
  },
  {
    id: 'defect-percentage',
    question: 'What percentage of defects can visual inspection typically identify?',
    options: ['About 10-20%', 'About 30-40%', 'About 60-70%', 'About 90-100%'],
    correctIndex: 2,
    explanation:
      'Industry estimates suggest 60-70% of defects can be identified through careful visual inspection alone. This highlights the importance of thorough visual examination before testing.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Exposed live conductors present immediate danger. The installation must not be energised until the defect is rectified. This is a fundamental safety requirement.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Visual inspection checks physical conditions: conductor connections, insulation condition, cable routing, equipment damage, labelling, and compliance with requirements. Electrical values are checked during testing.',
  },
  {
    id: 4,
    question: 'An exposed conductor is found during visual inspection. What action is required?',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Chapter 61 requires inspection and testing. Section 611 specifically covers visual inspection requirements, listing items that must be verified before testing.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Visual inspection verifies cables are suitable for their installed conditions (temperature, moisture, mechanical protection) and appropriately sized for their protective device ratings.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Thermal damage (discolouration, melting, burning) around terminals indicates overheating, usually from loose connections causing high-resistance joints. This is a serious defect requiring investigation.',
  },
  {
    id: 8,
    question:
      'During visual inspection of a consumer unit, what IP rating aspects should be checked?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'IP rating protection is verified by checking: all cable entries properly sealed, unused entries blanked, covers intact, no holes or damage that would allow ingress of moisture or foreign objects.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Regulation 132.12 requires adequate space for safe operation, inspection, testing, and maintenance. This includes space to operate switchgear safely and perform future work.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'All defects should be recorded with appropriate codes. A damaged but functional accessory is typically C2 (potentially dangerous) or C3 (improvement recommended) depending on the nature of damage.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Visual inspection identifies obvious hazards (exposed conductors, damage, incorrect wiring) that could make energising or testing dangerous. It also identifies issues that wouldn't be detected by electrical tests alone, such as incorrect cable types or inadequate mechanical protection.",
  },
  {
    question: 'What access do I need for visual inspection?',
    answer:
      'Visual inspection requires access to all parts of the installation where practically possible. This includes consumer units, distribution boards, junction boxes, accessories, and anywhere that can be accessed without damage. Limitations should be recorded.',
  },
  {
    question: 'Can I skip visual inspection if the installation looks fine?',
    answer:
      'No. Visual inspection is a mandatory part of initial verification and periodic inspection. Many serious defects are not obvious at first glance. A systematic approach ensures all aspects are checked regardless of initial appearance.',
  },
  {
    question: "What if I can't access certain parts of the installation?",
    answer:
      'Record any limitations in the inspection schedule and on the certificate. For EICR, areas that cannot be inspected should be noted and may affect the overall assessment. The client should be informed of any limitations.',
  },
  {
    question: 'Should I remove every accessory faceplate during inspection?',
    answer:
      'During initial verification, yes - all connections should be verified. During periodic inspection, a representative sample may be acceptable, with any limitations recorded. However, any accessories showing signs of damage should always be opened.',
  },
  {
    question: 'How do I record visual inspection results?',
    answer:
      'Results are recorded on the Schedule of Inspections. Each item is marked as satisfactory, not applicable (N/A), or with a limitation (LIM). Defects are detailed in the observations section with appropriate C1, C2, C3, or FI codes.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>When:</strong> FIRST, before any testing or energising
              </li>
              <li>
                <strong>Finds:</strong> 60-70% of all defects
              </li>
              <li>
                <strong>Regulation:</strong> BS 7671 Chapter 61, Section 611
              </li>
              <li>
                <strong>If danger found:</strong> Do NOT energise
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Check:</strong> Connections, insulation, protection
              </li>
              <li>
                <strong>Record:</strong> Schedule of Inspections
              </li>
              <li>
                <strong>Code:</strong> C1, C2, C3 as appropriate
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Visual inspection is the critical first step in verifying an electrical installation.
              Performed before energising and testing, it identifies hazards that could make testing
              dangerous and defects that electrical tests alone cannot detect.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Why Visual Inspection First?
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BS 7671 Section 611 provides a comprehensive list of items to inspect. Key areas
              include:
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Common defects found during visual inspection and their classification codes:</p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> C1 or C2 findings require immediate action - the
              installation must not be energised until dangerous conditions are rectified.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A systematic approach ensures nothing is missed. Work through the installation
              logically:
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>1.</strong> Intake and main earthing arrangements
                </li>
                <li>
                  <strong>2.</strong> Consumer unit / distribution boards
                </li>
                <li>
                  <strong>3.</strong> Fixed wiring and cable routes
                </li>
                <li>
                  <strong>4.</strong> Accessories - sockets, switches, FCUs
                </li>
                <li>
                  <strong>5.</strong> Fixed equipment and luminaires
                </li>
                <li>
                  <strong>6.</strong> Special locations (bathrooms, outdoor)
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Look for visible signs that indicate damage, overheating, or deterioration:</p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Visual inspection results are recorded on the Schedule of Inspections. Each item is
              marked:
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong className="text-green-400">✓</strong> — Satisfactory - acceptable
                  condition
                </li>
                <li>
                  <strong className="text-elec-yellow">N/A</strong> — Not applicable to this
                  installation
                </li>
                <li>
                  <strong className="text-amber-400">LIM</strong> — Limitation - could not be
                  inspected
                </li>
                <li>
                  <strong className="text-red-400">C1/C2/C3</strong> — Defect found - see
                  observations
                </li>
              </ul>
            </div>
            ...
            <p>
              All defects must be described in detail in the observations section, with appropriate
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Rushing</strong> — take time to inspect thoroughly
                </li>
                <li>
                  <strong>Assuming areas are OK</strong> — check everything accessible
                </li>
                <li>
                  <strong>Poor recording</strong> — document all findings clearly
                </li>
                <li>
                  <strong>Ignoring limitations</strong> — always record what couldn't be inspected
                </li>
              </ul>
            </div>
          </div>
