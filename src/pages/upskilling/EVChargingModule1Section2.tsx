...
const faqs = [
  {
    ...
    answer:
      'Domestic charging focuses on overnight use for a single household, typically 7kW single-phase. Commercial installations handle multiple users, require payment systems, load management, and higher power infrastructure (often three-phase up to 22kW per point or DC rapid charging).',
  },
  {
    question: 'Do I need DNO notification for a domestic charger?',
    answer:
      'For loads ≤32A per phase, you can install under G98 with simple notification. For higher loads (>16A per phase in some cases), G99 applies requiring formal application. Always check current DNO requirements as these may vary.',
  },
  {
    question: 'What additional requirements apply to public charging installations?',
    answer:
      'Public installations require accessibility compliance (DDA), payment systems meeting OZEV regulations, adequate lighting, signage, GDPR compliance for user data, and often planning permission depending on location and scale.',
  },
  {
    question: 'Can a domestic installation be upgraded to commercial later?',
    answer:
      'It depends on the supply capacity and infrastructure. If designed with future expansion in mind (adequate supply, suitable cable routes), upgrading may be straightforward. Otherwise, significant infrastructure changes may be needed.',
  },
];
...
const EVChargingModule1Section2 = () => {
  useSEO({
    ...
    description:
      'Understand the key differences between domestic and commercial EV charging installations including power requirements, costs, and compliance.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">Understanding the key differences and requirements</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Domestic:</strong> 7kW typical, overnight charging, £800-£2,500
              </li>
              <li>
                <strong>Commercial:</strong> 7-350kW, payment systems, £3k-£50k+
              </li>
              <li>
                <strong>Key difference:</strong> Scale, management, and compliance
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Wallboxes (domestic), pedestals with RFID (commercial)
              </li>
              <li>
                <strong>Use:</strong> IET Code of Practice for design and sizing
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Power:</strong> 3.7kW - 22kW (typically 7kW)
                  </li>
                  <li>
                    <strong>Supply:</strong> 230V single / 400V three-phase
                  </li>
                  <li>
                    <strong>Current:</strong> 16A - 32A
                  </li>
                  <li>
                    <strong>Connector:</strong> Type 2 (universal)
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Use pattern:</strong> Overnight, predictable
                  </li>
                  <li>
                    <strong>Users:</strong> Household members only
                  </li>
                  <li>
                    <strong>Authentication:</strong> Simple or none
                  </li>
                  <li>
                    <strong>Maintenance:</strong> Minimal, user responsibility
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>7kW unit:</strong> £500-£800
                </li>
                <li>
                  <strong>Installation:</strong> £300-£600
                </li>
                <li>
                  <strong>Materials/cable:</strong> £100-£300
                </li>
                <li>
                  <strong>Total:</strong> £900-£1,700 (before any grants)
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Commercial installations serve multiple users with higher power requirements, payment
              systems, and load management. They range from workplace charging to public rapid
              charging hubs.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Power:</strong> 7kW - 22kW
                  </li>
                  <li>
                    <strong>Users:</strong> Employees and visitors
                  </li>
                  <li>
                    <strong>Duration:</strong> 8+ hours (working day)
                  </li>
                  <li>
                    <strong>Payment:</strong> Free/subsidised typically
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Power:</strong> 7kW - 350kW
                  </li>
                  <li>
                    <strong>Users:</strong> General public
                  </li>
                  <li>
                    <strong>Duration:</strong> 30min - 4 hours
                  </li>
                  <li>
                    <strong>Payment:</strong> Pay-per-use
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Load management:</strong> Static or dynamic power allocation
                </li>
                <li>
                  <strong>Payment systems:</strong> RFID, app, contactless
                </li>
                <li>
                  <strong>User authentication:</strong> Access control and billing
                </li>
                <li>
                  <strong>Monitoring:</strong> Remote diagnostics and maintenance
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Understanding the financial aspects helps select appropriate solutions and set
              realistic expectations for both installers and clients.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Running cost:</strong> 14-35p/kWh (home tariff)
                  </li>
                  <li>
                    <strong>Smart tariff savings:</strong> £200-£500/year
                  </li>
                  <li>
                    <strong>vs petrol:</strong> Typically 3-4x cheaper per mile
                  </li>
                  <li>
                    <strong>Maintenance:</strong> £50-£100/year
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Capital per point:</strong> £5,000-£10,000 (22kW)
                  </li>
                  <li>
                    <strong>Charging tariff:</strong> 25-45p/kWh
                  </li>
                  <li>
                    <strong>Utilisation rate:</strong> 20-60%
                  </li>
                  <li>
                    <strong>Payback:</strong> 3-7 years typical
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Underestimating load:</strong> — Account for 100% capacity simultaneously
                  possible
                </li>
                <li>
                  <strong>No expansion planning:</strong> — Second EV common within 2-3 years
                </li>
                <li>
                  <strong>Ignoring accessibility:</strong> — DDA applies to public installations
                </li>
                <li>
                  <strong>Missing payment requirements:</strong> — OZEV mandates for public chargers
                </li>
              </ul>
            </div>
          </div>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/upskilling/ev-charging-module-1-section-1">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous Section
            </Link>
          </Button>
