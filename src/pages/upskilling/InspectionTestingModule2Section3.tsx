    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reg 462.3 says the isolation device must prevent inadvertent closure. This is how you
          actually deliver that on site — single-padlock, multi-hasp, MCB lock-off, tag information,
          and the rules around removal.
        </p>
        ...
        >
          <p>
            ...
            precautions: (a) located within a lockable space or lockable enclosure, (b) padlocking,
            (c) located adjacent to the associated equipment.
          </p>
          <p>
            ...
            isolators. But the three named examples are the ones you can cite verbatim if a client,
            an inspector, or an HSE investigator asks how the isolation was secured.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              unintentional opening. This may be achieved, for example, by locating the device in a
              lockable space or lockable enclosure or by padlocking. Alternatively, the off-load
        ...
        >
          <p>
            ...
            that does, or you secure the device by Reg 462.3(a) (lockable cabinet) or 537.2.4 (other
            suitable means).
          </p>
          <p>
            ...
            tool-store security and circuit isolation has a problem waiting to happen — a tool-store
            lock can be cut by anyone with bolt-croppers and an opinion.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Each subsequent operative does the same — their own padlock, their own key, their own
              hole.
            </li>
          ...
          <p>
            Variations: extended-length hasps (8–12 holes) for larger teams; interlocking hasps that
            chain together for very large teams; lockout boxes that hold the keys to multiple
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              ...
              <text x="285" y="216" textAnchor="middle" fill="#fff" fontSize="9" fontWeight="bold">
                A
              </text>
            ...
            <g>
              ...
              <text x="320" y="216" textAnchor="middle" fill="#fff" fontSize="9" fontWeight="bold">
                B
              </text>
            ...
            <g>
              ...
              <text x="355" y="216" textAnchor="middle" fill="#fff" fontSize="9" fontWeight="bold">
                C
              </text>
            ...
            <g>
              ...
              <text x="390" y="216" textAnchor="middle" fill="#fff" fontSize="9" fontWeight="bold">
                S
              </text>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Clip the jaw over the toggle. Test by trying to push the toggle back to ON with normal
              hand pressure — it should not move. If it does, the jaw is wrong; do not proceed.
            </li>
            <li>
            ...
            <li>
              Where multiple MCBs feed the same work area, lock off every one. Reg 462.2 + 537.2.1.1
              require every circuit to be capable of individual isolation; the converse duty in
              practice is that every supply route to your work has to be actually isolated, not just
              one of them.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            marker, not pencil. Attached with non-reusable cable ties, not string loops — a tag that
            can be lifted off, moved, and re-tied is a tag that can end up on the wrong device.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Confirm no other operatives are still working downstream of the point you are about to
              clear.
            </li>
        ...
        >
          <p>
            ...
            uncontactable, system cannot remain isolated — has a structured answer. The structure is
            what stops the procedure being abused for ordinary convenience.
          </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              that recovers all its lock-off kit at the end of the job has a stronger audit position
            ...
            <li>
              <strong>Times</strong> of isolation, prove-dead, work commenced, work finished, locks
              removed, re-energisation. Five timestamps minimum.
            </li>
            <li>
              <strong>Sign-offs</strong> for each transition. The supervisor signing the final
              re-energisation row is the closing entry that says &lsquo;this isolation is released,
              the system is live, the next job can begin’.
            </li>
          </ul>
          <p>
            ...
            the named issuer / receiver. The lock-off physically delivers what the permit specifies.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              conductors, ensure the main switch is off and secured by a safety locking device. This
              prevents inadvertent energisation during testing and is part of the safe isolation
              procedure prior to conducting continuity measurements.
            </>
          }
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              multi-hasp + padlocks, MCB lock-off jaw, breaker lock-out kit, lockout box). Reg 462.3
              / 537.2.4 / 537.2.5.
            </li>
            <li>
          ...
          <p>
            ...
            lock-off is a procedure that mostly does not. Both together is the regime BS 7671 + EAWR
            + HSG85 are written to deliver.
          </p>
        </ConceptBlock>
