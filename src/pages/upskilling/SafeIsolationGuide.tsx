  ...
  const isolationSteps = [
    {
      ...
      description:
        'Secure proper authorisation and gather essential information before beginning isolation',
      details: [
          ...
          <Card className="bg-gradient-to-r from-red-900/30 to-elec-gray border-red-500/30">
            ...
            <CardContent className="space-y-4">
              <p className="text-white">
                Safe isolation is the most critical safety procedure in electrical work. Failure to
                follow correct procedures can result in serious injury or death. The
                prove-test-prove sequence is mandatory and must never be compromised.
              </p>
              <div className="bg-red-900/20 p-4 rounded-lg">
                <h4 className="font-semibold text-red-300 mb-2">
                  Remember: Dead circuits can kill
                </h4>
              ...
              {equipmentRequirements.map((equipment, index) => (
                <Card key={index} className="bg-transparent border-transparent">
                  <CardHeader>
                    ...
                    <Badge
                      variant="secondary"
                      className="bg-cyan-600/20 text-cyan-300 text-xs w-fit"
                    >
