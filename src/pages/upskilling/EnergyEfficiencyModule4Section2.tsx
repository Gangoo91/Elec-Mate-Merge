...
const EnergyEfficiencyModule4Section2: React.FC = () => {
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: [
        'Only when the existing motor fails completely',
        'Never - IE2 motors should always be repaired instead',
        'When total energy savings exceed the motor replacement cost',
        'Only for motors rated above 100kW',
      ],
      correctAnswer: 'When total energy savings exceed the motor replacement cost',
    },
    {
      question: 'Which type of load benefits MOST from VSD installation for energy savings?',
      options: [
        'Variable-torque loads such as centrifugal pumps',
        'Constant-torque loads such as conveyors',
        'Constant-power loads such as winders',
        'Intermittent loads such as hoists',
      ],
      correctAnswer: 'Variable-torque loads such as centrifugal pumps',
    },
    {
      question: 'What is the typical harmonic spectrum produced by a 6-pulse VSD?',
      options: [
        '2nd, 4th and 6th harmonics',
        '3rd, 9th and 15th harmonics',
        '5th, 7th, 11th and 13th harmonics',
        'No significant harmonics are produced',
      ],
      correctAnswer: '5th, 7th, 11th and 13th harmonics',
    },
    {
      question:
      ...
      options: [
        ...
        'RCD protection is never required for drive circuits',
        'Type AC RCDs are always suitable for drives',
        'Only Type D MCBs may be used',
      ],
    ...
    },
    {
      ...
      options: [
        'Physical axial movement of the shaft',
        'The measured level of bearing wear',
    ...
    },
    {
      ...
      options: [
        'The motor paint colour specification',
        'Its insulation class and inverter-duty rating',
        'The manufacturer’s country of origin',
        'The original date of purchase',
      ],
      correctAnswer: 'Its insulation class and inverter-duty rating',
    },
    {
      question: 'What is the purpose of the DC bus capacitors in a VSD?',
      options: [
        'To smooth the rectified DC voltage',
        'To provide supply power factor correction',
        'To generate the variable output frequency',
        'To limit the motor starting current',
      ],
      correctAnswer: 'To smooth the rectified DC voltage',
    },
    {
      question:
        'For a pump running at 50% speed using a VSD, what percentage of full-load power is approximately consumed?',
    ...
    },
    {
      ...
      options: [
        'No EMC requirements apply to drives',
        'C1 category in every environment',
        'C3 category in every environment',
        'C1 or C2/C3 depending on the installation environment',
      ],
      correctAnswer: 'C1 or C2/C3 depending on the installation environment',
    },
  ];
