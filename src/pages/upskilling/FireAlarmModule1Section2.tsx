...
const DESCRIPTION =
  'Learn about BS 5839-1 P categories for property protection: P1 and P2 coverage, insurer requirements, and system selection.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'P category systems are designed for property protection, aiming to minimise damage to buildings and contents.',
  },
  {
    id: 'p1-vs-p2',
    question:
      'A distribution warehouse stores high-value goods. The insurer wants comprehensive fire protection. Which P category is appropriate?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'P1 provides comprehensive detection throughout all storage areas to detect any fire at the earliest stage and protect high-value stock.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Combined categories are common - L categories address life safety while P categories address property protection objectives.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'P1 provides automatic detection throughout all areas to detect any fire at the earliest possible stage for property protection.',
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'P2 provides targeted detection in defined high-value or high-risk areas where property protection is specifically required.',
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      'Insurers commonly specify P1 for comprehensive coverage or P2 for targeted high-value area protection.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Server rooms and data centres contain high-value equipment requiring targeted property protection.',
  },
  {
    id: 6,
    question: 'Can P and L categories be combined in the same building?',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'While coverage may be similar, L1 prioritises early warning for evacuation whereas P1 prioritises early detection for asset protection.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Insurers frequently require third-party certified contractors (BAFE, LPCB) to ensure installation quality and reduce risk.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Warehouses with high-value goods typically require P1 for comprehensive early detection throughout all storage areas.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'P category coverage should be defined in the fire strategy and design documentation, often informed by insurer requirements.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Not necessarily - P categories focus on property protection. Life safety should be addressed through appropriate L category coverage.',
  },
  {
    question: 'What certification do insurers typically require?',
    answer:
      'Third-party certification such as BAFE SP203-1 or LPCB LPS 1014 for fire detection and alarm installation companies.',
  },
  {
    question: 'Can P2 be specified without any L category?',
    answer:
      'Technically yes, but most buildings need some life safety provision. P2 alone would not address evacuation warning requirements.',
  },
  {
    question: 'How do I know if an insurer requires P1 or P2?',
    answer:
      'Contact the insurer or broker directly. Requirements depend on building use, value, and risk profile.',
  },
  {
    question: 'Does P1 require monitoring to a remote centre?',
    answer:
      'Not by default, but insurers often require Alarm Receiving Centre (ARC) connection for high-value premises.',
  },
  {
    question: 'What happens if insurer requirements are not met?',
    answer:
      'Insurance cover may be invalidated or claims may be reduced. Always confirm and document compliance.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>P categories:</strong> Protect property and assets, not life safety
              </li>
              <li>
                <strong>P1:</strong> Full coverage throughout for maximum protection
              </li>
              <li>
                <strong>P2:</strong> Targeted high-value areas only
              </li>
              <li>
                <strong>Insurers:</strong> Commonly specify P categories to reduce loss
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> High-value stock or equipment = P category
              </li>
              <li>
                <strong>Use:</strong> Engage insurers early in design
              </li>
              <li>
                <strong>Apply:</strong> Combine with L categories for full protection
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              P categories under BS 5839-1 are designed to protect property and assets. The primary
              objective is early detection to minimise damage to buildings, contents, and enable
              rapid response to protect business continuity.
            </p>
            <p>
              The "P" stands for "Property" protection. These systems prioritise detection coverage
              to protect valuable assets and reduce financial loss from fire damage.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              P1 provides automatic fire detection throughout all areas of the building. The aim is
              to detect any fire anywhere at the earliest possible stage.
            </p>
            ...
            <p>
              Typical applications include warehouses with valuable stock, manufacturing facilities,
              and data centres requiring comprehensive protection.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              P2 provides detection in defined high-value or high-risk areas only. This is a
              targeted approach where comprehensive coverage is not justified.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                P2 Target Areas Typically Include:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <p>
              Typical applications include office buildings with server rooms, and retail premises
              with high-value stockrooms.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Insurers commonly specify P category systems to reduce their risk exposure.
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm text-white">
                <strong>Warning:</strong> Failure to meet insurer requirements may invalidate cover
                or result in claim reduction.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              It is common to combine L and P categories in the same building when both life safety
              and property protection objectives apply.
            </p>
            ...
            <p>
              When categories are combined, specify clearly which areas fall under which category in
        ...
        <section className="mb-10 mt-10">
          <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-3">
            <span className="text-elec-yellow/80 text-sm font-normal">06</span>P vs L - Key
            Differences
          </h2>
          <div className="text-white space-y-4 leading-relaxed">
            <p>While P1 and L1 may have similar coverage, their objectives differ significantly.</p>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                ...
                <li>
                  Use third-party certified contractors to satisfy both insurer and quality
                  requirements
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Assuming P categories provide life safety</strong> - they do not replace L
                  categories
                </li>
                <li>
                  <strong>Not confirming insurer requirements</strong> - before specifying system
                  category
                </li>
                <li>
                  <strong>Using uncertified contractors</strong> - for insurance-required
                  installations
                </li>
              </ul>
            </div>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/electrician/upskilling/fire-alarm-course/module-1/section-1">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous Section
            </Link>
          </Button>
