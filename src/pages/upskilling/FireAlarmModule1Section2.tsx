    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS 5839-1:2025 Categories P1 and P2: comprehensive vs targeted property protection, the /M
          manual-call-point suffix, hybrid L/P specifications, the new alarm-transmission timings
          (14.17 and 14.18), and how insurer requirements drive the design.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>P1</strong> — automatic detection throughout the protected building, with the
              same Annex D exceptions for areas of low fire risk that apply to L1. Comprehensive
              cover for the whole building.
            </li>
            <li>
              <strong>P2</strong> — automatic detection in defined high-value or high-risk areas
              only. The footprint is determined by the designer with the responsible person and the
              insurer; the rest of the building has no P-system cover.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              The building or its contents are high-value (museums, archives, data centres, cultural
              collections, irreplaceable scientific equipment).
            </li>
            <li>
            ...
            <li>
              ...
              summons) needs to begin promptly regardless of where in the building the fire starts.
            </li>
          </ul>
          <p>
            P1 is sometimes combined with L cover in a hybrid spec — typically L1/P1 (life and
            property both covered everywhere) or L2/P1 (life-safety on escape routes plus high-risk
            rooms; property cover everywhere). The hybrid means a single physical system serves both
            objectives; the documentation states both.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              ...
              <text x="210" y="290" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9.5">
            ...
            <g>
              ...
              <text x="610" y="160" textAnchor="middle" fill="rgba(255,255,255,0.35)" fontSize="11">
                no det.
              </text>
              <text x="499" y="200" textAnchor="middle" fill="rgba(255,255,255,0.35)" fontSize="11">
                no det.
              </text>
              <text x="719" y="200" textAnchor="middle" fill="rgba(255,255,255,0.35)" fontSize="11">
                no det.
              </text>
              <text x="499" y="250" textAnchor="middle" fill="rgba(255,255,255,0.35)" fontSize="11">
                no det.
              </text>
              <text x="719" y="250" textAnchor="middle" fill="rgba(255,255,255,0.35)" fontSize="11">
                no det.
              </text>

              <text x="610" y="290" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9.5">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              A plant room within a warehouse — fire in the plant would disable the warehouse; fire
              in the warehouse storage areas is the insurer's main concern but may be addressed by
              sprinklers rather than detection.
            </li>
            <li>
            ...
            <li>
              A dedicated machine room (CNC, robotic assembly) within a low-value general production
              area.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              premises that are designated as being of high fire hazard or where the consequence of
              fire would be of particular significance, having regard to the property at risk.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>L5</strong> — bespoke; MCPs are at the designer's discretion. L5 (no MCPs) or
              L5/M (with MCPs) are both valid; the spec must state which.
            </li>
            <li>
          ...
          <p>
            MCP siting in any /M-suffixed system follows the BS 5839-1:2025 distance rules: maximum
            30 m straight-line distance and 45 m actual travel distance from any point in the
            protected area to the nearest MCP. Mounting height is 1.4 m above floor level, with a
            tolerance of +200 mm / -300 mm (i.e. anywhere between 1.1 m and 1.6 m). MCPs on stairway
            landings are now to be incorporated within the zone serving the adjacent accommodation
            (per 12.1 a)) — a 2025 wording clarification.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>L1/P1</strong> — life cover throughout AND property cover throughout. The same
              detector layout serves both. Used in hospitals, large care facilities, complex
              mixed-use buildings.
            </li>
            <li>
            ...
            <li>
              ...
              targeted property cover in designated zones. Often used in hotels, where bedrooms (L2)
              and back-of-house (P2) are both protected but the rest of the building is not
          ...
          <p>
            ...
            for the L scope; a single combined record showing how the two scopes overlap or diverge.
            Maintenance routines apply to both scopes. Modifications must be reviewed against both
            scopes.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Where a separate power supply unit is used to power the alarm transmission equipment,
              it should conform to either BS EN 54-4 or BS EN 50131-6 Grade 4.
            </li>
            <li>
              A new label (false-alarm notice) is recommended for the CIE indicating that the system
              has an active connection to the fire and rescue service and giving the ARC's contact
              telephone number — to reduce false-alarm attendances during testing.
            </li>
            <li>
              Where practicable, the alarm signal transmitted to the ARC should indicate the nature
              of the triggering device and whether coincidence filtering is in place. This lets the
              ARC pass useful information to the FRS.
            </li>
          </ul>
          <p>
            The split between 14.17 and 14.18 reflects the urgency profile. A delay in receiving an
            L-system alarm extends time-to-evacuation; a delay in receiving a P-system alarm extends
            property loss. Both matter; L is more urgent. The same logic applies to the
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>P2 in server rooms.</strong> The server room is the highest-loss area in most
              office buildings; targeted P2 cover protects it without burdening the rest of the
              building with detection that would not materially reduce loss elsewhere.
            </li>
            <li>
              <strong>
            ...
            <li>
              ...
              often require additional confirmation before alarm transmission to reduce false-alarm
              load on the FRS — typical of high-sums-insured properties.
            </li>
            <li>
        ...
        >
          ...
          <p>
            ...
            be justified (especially if proposed at installation or commissioning stage rather than
            design stage) and must be recorded in the system logbook.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              earlier BS 7671 / IEC 60445 versions). Aligns with BS 7671 A2:2022.
            </li>
            <li>
            ...
            <li>
              <strong>Standby supply.</strong> Continuous availability is the load-bearing concept.
              A P-system's standby battery must support the system for the design duration with
              margin; a marginal battery that fails to support a real fire alarm is the difference
              between successful early detection and silent loss.
            </li>
            <li>
            ...
            <li>
              <strong>TN-C-S (PNB) clarifications under A4:2026.</strong> Earthing arrangements for
              safety-service circuits within a TN-C-S installation must respect Section 560
        ...
        <FAQ
          items={[
            {
              question: 'Can a building have both an L category and a P category at the same time?',
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-1/section-3')}
