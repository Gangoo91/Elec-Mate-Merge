...
export default function RenewableEnergyModule6Section7() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 7 · UK Electric Vehicles (Smart Charge Points) Regulations 2021"
        title="Smart Charge Points Regulations + EV tariffs"
        backTo="../renewable-energy-module-6"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          UK SI 2021/1467 — default off-peak charging, randomised delay up to 600 s, security and
          data privacy. Octopus Intelligent Go / Flux / Cosy EV tariff structures. PV-tracking solar
          diverter functionality. Customer handover education on the smart-charging behaviour.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              <strong className="text-white">2. Randomised delay</strong> — when a charging schedule
              begins, the chargepoint waits a random duration (up to 600 seconds / 10 minutes)
              before drawing current. Prevents synchronised UK-wide demand spikes
            </li>
            <li>
            ...
            <li>
              ...
              customer data processed by the chargepoint or its cloud services. Manufacturer privacy
              notice required
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Vehicle compatibility</strong>— Octopus integrates with
              most major EV OEMs via their APIs (Tesla, VW Group, Volvo, Renault, Polestar, BMW,
            ...
            <li>
              <strong className="text-white">Override</strong> — customer can charge immediately if
              needed (e.g. "drive in 2 hours"); Octopus charges at the higher rate for that session
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              <strong className="text-white">PV + BESS sweet spot</strong> — PV charges BESS during
              day (free); BESS discharges to loads / exports during 16:00-19:00 peak (sells at
              33p/kWh); EV charges from grid during 02:00-05:00 cheap window (12p/kWh)
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Twin cheap windows</strong> — morning ~04:00-07:00 and
              afternoon ~13:00-16:00. Heat pump runs through both, batching its heat production
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">Tariff vs rate</strong> — Cosy not as cheap per kWh as
              Intelligent Go (13p vs 7p) but designed for multi-cycle heat-pump households where the
              twin windows fit the pattern
            </li>
            <li>
              <strong className="text-white">Customer decision</strong> — Intelligent Go = cheapest
              pure EV; Cosy = best for heat pump + EV combination
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              <strong className="text-white">CT clamp on tails</strong> — required for PV-tracking.
              Reads household import / export direction. Same hardware serves DLM
            </li>
            <li>
              <strong className="text-white">Operating modes</strong> — typical: ECO (charges only
              on surplus PV); ECO+ (charges on surplus + small grid top-up if PV insufficient); FAST
              (ignores PV, charges full rate)
            </li>
            <li>
              <strong className="text-white">Customer benefit</strong> — self-consumed PV vs
              exported. ~25p/kWh import avoided vs 5-15p SEG export = ~10-20p/kWh net benefit. Over
              a year, can be £100-£400 saving for customer with PV + EV
            </li>
            <li>
              <strong className="text-white">Combination with tariff</strong> — PV-tracking during
              day + Intelligent Go / Flux at night. The wallbox switches automatically: day = follow
              PV; night = follow cheap-window
            </li>
            <li>
        ...
        <Pullquote>
          UK 2025-26 EV peak demand could double grid load at 17:00. Smart charging is the
          engineering response. The customer earns the savings; the grid earns the stability.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">UK EV stock</strong> — ~2 million in early 2026; ~30%
              YoY growth. Projected ~6 million by 2030
            </li>
            <li>
              <strong className="text-white">Average per-vehicle daily charge</strong> — ~10 kWh (UK
              average ~50 km/day at ~5 km/kWh)
            </li>
            <li>
              <strong className="text-white">Synchronised peak risk</strong> — if all charged at
              17:00 simultaneously, ~14 GW additional load. UK overnight low load is ~25 GW; peak is
              ~45 GW. A synchronised EV pulse would land in the same window as the existing evening
              peak — un-buildable without massive grid investment
            </li>
            <li>
              <strong className="text-white">Demand-shifting to overnight</strong> — 23:00-07:00
              window has ~10-15 GW spare capacity vs daytime peak. Spreading EV charging across this
              window is essentially free for the grid
            </li>
            <li>
              <strong className="text-white">Smart-charging response</strong> — SCP Regulations 2021
              (default off-peak + randomised delay) is the regulatory mechanism that engineers the
              demand-shift WITHOUT requiring customer-side intervention. Aligned with EV tariffs
              that pay the customer for the shift
            </li>
            <li>
              <strong className="text-white">The customer’s savings</strong> — ~£400/year on Octopus
              Intelligent Go vs flat-rate import (typical UK 2025-26 driver). The customer is the
              engineering response’s beneficiary
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — records SCP Regulations
              2021 compliance + the customer’s tariff choice. The engineering response and the
              customer-side outcome both documented
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Installer ownership</strong> — BS 7671 install +
              Section 722 compliance + manufacturer DoC + SCP Regulations factory configuration +
              commissioning + cert evidence bundle + customer handover education
            </li>
            <li>
              <strong className="text-white">Customer ownership</strong> — choice of electricity
              supplier + tariff; ongoing payment of bills; customer-side override of charging
              schedule for specific sessions; ongoing maintenance / use of the wallbox app
            </li>
            <li>
              <strong className="text-white">Supplier ownership</strong> — tariff rates + windows +
              smart-charging integration with the customer’s wallbox / vehicle; billing; supplier
              app
            </li>
            <li>
              <strong className="text-white">Wallbox manufacturer ownership</strong> — product
              conformity + Declaration of Conformity + firmware updates + cloud services + customer
              support for product issues
            </li>
            <li>
              <strong className="text-white">Handover documentation</strong> — installer hands
              customer the cert evidence bundle + customer-facing operating instructions; customer
              keeps the bundle for warranty / EICR / property-sale evidence
            </li>
            <li>
              <strong className="text-white">Tariff change scenario</strong> — customer switches
              from Octopus Intelligent Go to Octopus Flux (e.g. they’ve added PV+BESS). Customer
              reconfigures the wallbox app to the new tariff windows; no installer involvement
              needed; cert evidence bundle remains valid (install didn’t change). Customer may
              notify installer for service contract update
            </li>
            <li>
              <strong className="text-white">Common support-call confusion</strong> — customer calls
              installer about tariff savings being lower than expected. Installer’s role is to
              verify the install is operating correctly (default off-peak + randomised delay still
              working) and route the customer to the supplier for tariff queries. The customer /
              supplier / installer triangle requires polite boundary discipline
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-6-section-8')}
