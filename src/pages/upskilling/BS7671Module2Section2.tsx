...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'The CPC provides a path for fault current back to the source, allowing protective devices to operate and disconnect the supply automatically.',
  },
  {
    id: 'selv-vs-pelv',
    ...
    correctIndex: 1,
    explanation:
      'SELV (Separated Extra Low Voltage) requires complete isolation from earth, while PELV (Protective Extra Low Voltage) allows earthing.',
  },
  {
    id: 'rcd-detection',
    ...
    correctIndex: 2,
    explanation:
      'An RCD detects the imbalance between line and neutral currents, which indicates current leaking to earth (residual current).',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'ADS is the most commonly used protective measure in most electrical installations, providing both basic and fault protection.',
  },
  {
    question: 'Which system allows earth connection — SELV or PELV?',
    answer:
      'PELV (Protective Extra Low Voltage) allows earth connection, while SELV (Separated Extra Low Voltage) must be completely isolated from earth.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'SELV is used in wet locations like bathrooms and swimming pools, medical areas, and other environments where the risk of electric shock is increased.',
  },
];
...
const quizQuestion = {
  ...
  correctAnswer: 1,
  explanation:
    'SELV provides the highest level of safety through complete separation from earth, which is essential in wet conditions where the risk of electric shock is significantly increased.',
};
...
const BS7671Module2Section2 = () => {
  useSEO({
    ...
    description:
      'Learn essential BS 7671 terminology including CPC, ADS, SELV, PELV and protective devices. Understanding key terms for electrical safety and protection systems.',
  });
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>CPC:</strong> Carries fault current for automatic disconnection
              </li>
              <li>
                <strong>ADS:</strong> Most common protective measure
              </li>
              <li>
                <strong>SELV/PELV:</strong> Extra low voltage systems ≤50V AC
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Green/yellow conductor = CPC
              </li>
              <li>
                <strong>Use:</strong> SELV in wet locations, ADS elsewhere
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The Circuit Protective Conductor (CPC) is fundamental to electrical safety. It
              provides the path for fault current to return to the source, enabling automatic
              disconnection when dangerous faults occur.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Primary function:</strong> Carries fault current safely back to source
                  </li>
                  <li>
                    <strong>Identification:</strong> Green and yellow insulation
                  </li>
                  <li>
                    <strong>Sizing:</strong> Based on fault current and disconnection time
                  </li>
                  <li>
                    <strong>Continuity:</strong> Must be continuous throughout circuit
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Connection:</strong> Links all exposed metalwork
                  </li>
                  <li>
                    <strong>Testing:</strong> Requires continuity verification
                  </li>
                  <li>
                    <strong>Protection:</strong> Cannot be switched or fused
                  </li>
                  <li>
                    <strong>Materials:</strong> Copper or appropriate conductor
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Automatic Disconnection of Supply (ADS) is the most common protective measure used in
              electrical installations. It combines basic protection (preventing contact with live
              parts) and fault protection (protection during fault conditions).
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Basic protection:</strong> Insulation, barriers, enclosures
                  </li>
                  <li>
                    <strong>Fault protection:</strong> Automatic disconnection when fault occurs
                  </li>
                  <li>
                    <strong>Protective devices:</strong> MCBs, RCDs, or fuses
                  </li>
                  <li>
                    <strong>Earthing system:</strong> Provides fault current return path
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Final circuits ≤32A:</strong> 0.4 seconds maximum
                  </li>
                  <li>
                    <strong>Distribution circuits:</strong> 5 seconds maximum
                  </li>
                  <li>
                    <strong>Special locations:</strong> Reduced times (e.g., 0.04s)
                  </li>
                  <li>
                    <strong>TT systems:</strong> RCD required, typically 30mA
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              SELV (Separated Extra Low Voltage) and PELV (Protective Extra Low Voltage) are special
              protective measures using extra low voltage (typically not exceeding 50V AC or 120V
              DC) to provide safety.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Protective devices are essential components that detect abnormal conditions and
              automatically disconnect circuits to prevent danger. Each type serves specific
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-transparent border border-orange-500/30">
              <p className="text-sm font-medium text-orange-400 mb-3">
                Swimming Pool Installation Challenge
              </p>
              <div className="text-sm space-y-3">
                <p>
                  <strong>Situation:</strong> An electrician needs to install lighting around a
                  swimming pool. The area is classified as Zone 1 (area likely to be wet) and
                  requires special consideration for electrical safety.
                </p>

                <p>
                  <strong>Challenge:</strong> Normal mains voltage (230V) cannot be used in Zone 1
                  due to the increased risk of electric shock in wet conditions.
                </p>
                ...
                <p>
                  <strong>Alternative Considered:</strong> PELV could be used with earthing, but
                  SELV provides higher level of safety in this wet environment.
                </p>
              </div>
            </div>
          </div>
