...
export default function BS7671Module1Section2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 2 · Updated for A4:2026"
      ...
      <HubBody>
        <div className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'Where BS 7671:2018+A4:2026 applies, where it stops, and how it interacts with the equipment / machinery / hazardous-area standards that bracket it.'
          }
        </div>
        ...
        >
          <p>
            ...
            nominal. <RegBadge>Reg 110.1.2</RegBadge> lists the categories of installation covered:
            residential, commercial, public, industrial, agricultural, prefabricated, caravan parks,
            marinas, construction sites, exhibitions, fairgrounds, medical locations, mobile or
            transportable units, photovoltaic, low-voltage generating sets.
          </p>
          <p>
            The list is not exhaustive but it shows the intent — fixed installations forming part of
            the built environment, including outdoor and temporary structures with defined supply
            infrastructure. Most things an electrician installs day-to-day fall inside this list.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            ...
            <li>
              <strong className="text-white">Aircraft and ships at sea</strong> — separate aerospace
            ...
            <li>
              <strong className="text-white">Lightning protection systems</strong> — BS EN 62305. BS
              7671 covers the bonding interface only.
            </li>
            <li>
              <strong className="text-white">Lifts</strong> — BS EN 81-20 / -50 for the lift itself.
              BS 7671 covers the supply up to the lift&apos;s isolator.
            </li>
            <li>
        ...
        >
          <p>
            ...
            machine&apos;s dedicated isolator. The isolator, supply cable, OPD and any EAWR-required
            local switching are BS 7671. The control panel, drives, motors, sensors and field wiring
            inside the machine are BS EN 60204-1.
          </p>
          <p>
          ...
          <p>
            ...
            boundary. Equipment within the zone must be Ex-rated under BS EN 60079; the installation
            method is also defined by the BS EN 60079 series. BS 7671 still applies to the safe-area
            side, but the boundary equipment must satisfy both.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="What A4:2026 changed in scope">
          ...
          <p>
            ...
            from the deleted informative Appendix 17 to a normative chapter in Part 8. Refers out to
            the Building Regulations and BS HD 60364-8-1:2019 for the detailed requirements.
          </p>
          <p>
            <strong className="text-white">New Chapter 57 — Stationary secondary batteries.</strong>{' '}
        ...
        >
          <p>
            ...
            handover at equipment isolators. The cases where the tree pays off are the awkward ones
            — a PoE network in a leisure-centre changing room, an EV charger on an old TN-C-S with a
            small PV, a Zone 2 area in a workshop. Walking the tree forces the correct boundaries
            onto the cert before the install starts, not after a complaint.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The scope of BS 7671 is not static — A4:2026 is a clear demonstration that the committee
            responds to technologies that have outgrown the pre-existing special-location framework.
            PoE was a data-cabling concern in 2018; by 2026 it is a Section 716 special location
            with a normative home. The same pressure is building around DC microgrids in commercial
            buildings, V2G bi-directional EV charging, and battery-storage-as-a-service models.
            Designers who walk the scope-decision tree consistently — voltage, category, Part 7,
            equipment handover — are positioned to absorb the next amendment with minimal friction.
            The ones who defaulted to &lsquo;BS 7671 covers everything electrical&rsquo; or
            &lsquo;BS 7671 doesn&apos;t cover data&rsquo; will keep getting caught out.
          </p>
          <p>
            For CPD purposes, watch the IET&apos;s &lsquo;Wiring Matters&rsquo; bulletins, the BSI
            Standards Update feed for IEC 60364-x amendments (which feed through to BS 7671 via the
            JPEL/64 committee), and the MCS scheme-rule revisions — those three sources are the
            leading indicators of what the next amendment is going to formalise. Your cert templates
            should be referenceable enough to update with a search-and-replace when a new section
            drops, not rewritten from scratch.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong className="text-white">EIC schedule of inspection.</strong> A4 added entries for
            Section 716 (PoE) installations and the energy-efficiency considerations of Chapter 81.
            On a project that includes PoE distribution, the inspection schedule must show the
            Section 716 entries explicitly inspected — not just the data-cabling standard. On a
            project where Chapter 81 design considerations applied (e.g. a commercial fit-out with
            Building Regulations Part L overlap), the energy-efficiency entries should be
            referenced.
          </p>
          <p>
            ...
            polarity, AC-side and DC-side fault loop, BESS-to-installation interface verification).
          </p>
          <p>
            ...
            require a full EIC. The same logic applies to Chapter 57 — adding a battery module to an
            existing BESS may be Minor Works; a new BESS install needs a full EIC.
          </p>
          <p>
            ...
            entries are reported as deviations from the current edition rather than defects. Per GN3
            (Section K), each observation gets a single classification (C1 / C2 / C3 / FI). A pre-A4
            PoE distribution with no documentation typically attracts a C3 (improvement recommended)
            where there is no other risk factor; a Chapter 57 BESS without manufacturer
            documentation may attract a C2 if safety information is missing entirely.
          </p>
        </ConceptBlock>
