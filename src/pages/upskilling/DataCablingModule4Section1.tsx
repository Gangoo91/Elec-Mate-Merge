      ...
      <HubBody>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              <strong>Wire basket tray.</strong> Welded steel mesh, typically 50 mm by 100 mm grid,
              side rails of 1.5 mm steel. Light, easy to cut and join with manufacturer joint
              plates. Open mesh dissipates heat from continuous-PoE bundles by natural convection.
              Allows lateral cable additions without re-pulling — the dominant argument for it on
              horizontal runs above ceilings. Dominant horizontal carrier for general-purpose Cat6A.
            </li>
            <li>
              <strong>Ladder rack.</strong> Two heavy steel side rails connected by rungs at fixed
              centres (typically 225 mm or 300 mm). Designed for high cable counts, long unsupported
              spans, and heavy loadings (chassis switch lacing, large fibre bundles). Open-rung
              construction also helps thermal dissipation. The standard choice in comms rooms,
              equipment rooms and risers.
            </li>
            <li>
              <strong>Cable tray (solid or perforated steel).</strong> Sheet-steel channel, 1.0-1.5
              mm wall, with side flanges. Perforated tray (up to 20 percent perforation per Annex
              A444 Note 2) qualifies as "open metallic containment B" for separation purposes.
              Solid-walled enclosed steel tray (1.5 mm minimum, fully enclosed) qualifies as "solid
              metallic containment C" — zero physical separation needed from LV power.
            </li>
            <li>
              ...
              bonded, and §521.10.202 fire-collapse compliance under Note 2. Plastic / PVC trunking
              is permitted as a wiring system but Note 3 to §521.10.202 fails it as the SOLE means
              of support — it must be supplemented or the wiring inside it independently supported.
            </li>
          </ul>
          <p>
            ...
            rooms, perforated tray across plant rooms, and trunking for wall drops into outlets. The
            competent design picks the right family for each segment.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <br />
              NOTE 3: This regulation precludes, for example, the use of non-metallic cable clips or
              cable ties as the sole means of support where cables are clipped direct to exposed
              surfaces or suspended under cable tray, and the use of non-metallic cable trunking as
              the sole means of support of the cables therein.
              <br />
              NOTE 4: Suitably spaced steel or copper clips, saddles or ties are examples that will
              meet the requirements of this regulation.
              <br />
              NOTE 5: The intent of this regulation is to prevent the general collapse of wiring
              systems as a result of exposure to the effects of fire such that they would hinder the
              safe evacuation, rescue or access to firefighters. It is not the intent of this
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="60" y="516" fill="#9CA3AF" fontSize="10" fontFamily="system-ui">
              BS 7671:2018+A4:2026 — applies from 15 April 2026 · BS EN 50174-2 sets capacity / fill
              / install practice
            </text>
          </svg>
        </div>
        ...
        >
          <p>§521.10.202 has five Notes that together define the practical compliance envelope:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Note 2.</strong> Cables installed in or on steel cable containment are DEEMED
              to meet the regulation. This is the lowest-friction compliance route — steel
              containment, no further argument.
            </li>
            <li>
              <strong>Note 3.</strong> Non-metallic cable ties / clips as the SOLE means of support
              fail. Non-metallic trunking as the SOLE support of the cables therein fails. "Sole" is
              the key word — these materials can play supporting roles, but cannot be the only thing
              holding cables up.
            </li>
            <li>
            ...
            <li>
              <strong>Note 5.</strong> Intent is to prevent collapse blocking escape routes — NOT to
              maintain circuit integrity in fire. Fire-rated cable for life-safety / fire-fighting
              circuits is Chapter 56 and BS 5266 / 5839 / 8519. §521.10.202 is a different
              regulation.
            </li>
          </ul>
          <p>
            The practical reading: design with steel containment AND steel fixings. Treat plastic as
            accessories. Document the design so the inspector sees the steel content of the support
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              foreseeable additions. Industry rule of thumb: 40-50 percent fill at first fit. Lower
              fill on basket allows lateral additions; higher fill on enclosed trunking forces
              re-pulling for adds.
            </li>
            <li>
              <strong>PoE bundle de-rating.</strong> Continuous-PoE current heats the bundle. TIA
              TSB-184-A (2017) and PD CLC/TR 50174-99-1:2015 (referenced from §716.523.1.101 Note 2)
              provide the de-rating curves. Tight bundles run hotter; bundle interior cables run
              hotter than bundle exterior. Mitigations: limit bundle size, separate bundles, use 23
              AWG cable, use LP (limited-power) rated cables.
            </li>
            <li>
              <strong>Bend-radius space.</strong> Cat6A solid cable wants a minimum 4× cable OD bend
              radius during install (8× at terminations). Basket / tray drops to outlets need enough
              vertical clearance to maintain that radius — typically 100-150 mm. (Module 4 Section 2
              covers bend radius in detail.)
            </li>
            <li>
            ...
            <li>
              <strong>Separation from HID / CFL lamps.</strong> §444.6.2 fixes a 130 mm minimum from
              data cabling to discharge lamps — including CFL. Plan basket routes to clear lamp
              positions.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Lateral access.</strong> Open-mesh basket allows cables to be dropped in from
              above without disturbing existing dressed bundles. Closed trunking does not — adds
              force re-pulling.
            </li>
            <li>
              <strong>Spacing for clipping.</strong> Cables in basket dressed with steel ties at
              sensible centres (typically 300 mm), with enough room around bundles that ties can be
              cut and re-tied to incorporate adds. Over-tight dressing blocks adds.
            </li>
            <li>
            ...
            <li>
              <strong>Identifiable cables.</strong> Every cable in the basket labelled at both ends
              per BS EN 50174-1 and TIA-606-D — so adds can be made without disturbing the wrong
              link. (Module 4 Section 4 covers labelling.)
            </li>
            <li>
              <strong>Documented routes.</strong> As-built drawings of every basket / ladder / tray
              route, with capacity and current fill recorded. The next contractor cannot plan an add
              without knowing what the access path looks like.
            </li>
          </ul>
          <p>
            The economic argument is the same as the structured-cabling argument generally:
            first-fit cost is slightly higher; lifecycle cost is dramatically lower. The containment
            that absorbs a service refresh without re-pulling pays for itself the first time the
            building churns.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              over the years using black plastic cable ties to the structural steel beams above the
              suspended ceiling. No basket. No ladder. Just plastic ties holding 80 Cat5e cables
              across the void. Inspector arrives, lifts a tile, and fails the install on §521.10.202
              Note 3 — non-metallic ties as the sole means of support do not meet the fire-collapse
              rule.
            </>
          }
          doInstead={
            <>
              ...
              steel ties or saddles at sensible spacing to dress them. Where steel basket cannot be
              installed (existing fire compartmentation, structural constraint), use steel clips or
              saddles to the structure at appropriate centres — Note 4 to §521.10.202 explicitly
              recognises steel or copper clips, saddles or ties as compliant. The cost of doing it
              once properly is materially less than the cost of repeated remedial visits and the
              eventual full re-pull.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              A new-build commercial fit-out. The QS has priced plastic basket tray at half the cost
              of steel basket and is pushing back on the steel spec on cost grounds. The architect
              has not weighed in. The cabling will run continuous PoE++ for a future high-density AP
              cluster.
            </>
          }
          whatToDo={
            <>
              ...
              non-metallic basket as the sole means of support — the plastic basket would need to be
              supplemented with steel fixings, eliminating the cost saving and making the install
              messier; (2) §444.5.3.1 places metallic containment in the equipotential bonding
              network — plastic basket is not bondable, so the EMC screening role of metallic
              containment is lost and the building would need to rely entirely on cable screens
              (with the EBN-bonding question pushed onto every screen termination); (3) PoE bundle
              thermal management — open steel mesh dissipates heat by convection; plastic mesh has
              lower thermal conductivity, trapping more heat in the bundle interior. Document the
              rationale in writing so the QS owns the decision if it gets escalated.
            </>
          }
          whyItMatters={
            <>
              ...
              channel test results. The competent design holds the line on steel and documents why.
            </>
          }
        />
