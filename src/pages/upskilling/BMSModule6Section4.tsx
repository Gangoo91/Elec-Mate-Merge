...
const DESCRIPTION =
  'Learn about automated systems for intelligent building response and comprehensive reporting in Building Management Systems.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Signal integrity ensures automation systems receive accurate, uncorrupted data for decision-making. Poor signal integrity can cause false triggers, missed events, incorrect automation responses, and unreliable reports, potentially compromising building safety, comfort, and efficiency.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Time-based triggers execute actions according to schedules, such as switching lights at sunset, starting HVAC before occupancy, or generating weekly energy reports.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Proper cable separation from power circuits prevents data corruption that could cause false triggers or missed events, ensuring reliable automation responses.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'During commissioning, verify sensor readings against known conditions, test automation responses, confirm emergency overrides function correctly, and validate alarm and notification systems.',
  },
  {
    id: 9,
...
const faqs = [
  {
    ...
    answer:
      'Test during planned maintenance windows or use simulation inputs when possible. For critical safety triggers, coordinate with facility management and notify all affected parties. Use BMS override functions to prevent unwanted equipment operation during testing.',
  },
  {
    question: 'What should I do if automation systems respond unexpectedly?',
    answer:
      'Document the unexpected behaviour, check all relevant I/O connections and signal integrity, verify sensor readings, and consult with BMS programmers. Do not modify automation logic yourself - report issues to qualified BMS specialists for proper resolution.',
  },
  {
    question: 'How often should automated reports be generated?',
    answer:
      'This depends on the audience and purpose. Operational staff might need daily summaries, energy managers weekly analysis, and senior management monthly overviews. The key is providing actionable information without overwhelming users with too much data.',
  },
  {
    question: 'Can event triggers interfere with each other?',
    answer:
      'Yes, poorly designed trigger logic can create conflicts. For example, energy-saving triggers might conflict with comfort triggers. This is why BMS programming requires careful priority management and why electricians should understand the overall automation strategy.',
  },
  {
    question: 'What documentation is essential for automation systems?',
    answer:
      'Maintain accurate I/O lists, cable schedules, device locations, calibration records, and as-built drawings. Include contact details for BMS specialists and system passwords/access procedures. This documentation is crucial for troubleshooting and future modifications.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>What:</strong> Automated rules that make buildings respond to conditions
              </li>
              <li>
                <strong>Why:</strong> Faster responses, consistent operation, reduced manual work
              </li>
              <li>
                <strong>Types:</strong> Time-based, sensor-based, alarm-based, occupancy-based
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Scheduled lighting changes, HVAC adjusting to occupancy
              </li>
              <li>
                <strong>Use:</strong> Ensure reliable signal paths and proper cable separation
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Event triggers are the intelligent decision-making rules that allow buildings to
              respond automatically to changing conditions. They monitor specific parameters and
              execute predefined actions when trigger conditions are met.
            </p>
            <p>
              Modern Building Management Systems do not just monitor - they respond intelligently to
              changing conditions. Event triggers automate building responses, whilst auto-reporting
              ensures stakeholders receive timely, relevant information without manual intervention.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong className="text-elec-yellow">Time-based triggers:</strong> Execute actions
                  according to schedules - switching lights at sunset, starting HVAC before
                  occupancy, or generating weekly energy reports
                </li>
                <li>
                  <strong className="text-elec-yellow">Sensor-based triggers:</strong> Respond to
                  environmental conditions - activating cooling when temperature exceeds setpoints,
                  switching to natural ventilation when outdoor air quality improves
                </li>
                <li>
                  <strong className="text-elec-yellow">Alarm-based triggers:</strong> Provide safety
                  and security responses - evacuating lifts during fire alarms, notifying security
                  of after-hours access
                </li>
                <li>
                  <strong className="text-elec-yellow">Occupancy-based triggers:</strong> Optimise
                  building services based on usage patterns - reducing lighting in unoccupied areas,
                  adjusting ventilation for crowd levels
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                IF (outdoor temperature &gt; 25°C) AND (occupancy detected) AND (time between
                08:00-18:00) THEN (activate cooling, open motorised blinds, send comfort
                notification to facilities team).
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Auto-reporting transforms building data into meaningful information delivered
              automatically to stakeholders. This eliminates manual report generation whilst
              ensuring timely access to critical building performance data.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong className="text-elec-yellow">Energy reports:</strong> Provide consumption
                  analysis, efficiency trends, and cost breakdowns for strategic energy management
                </li>
                <li>
                  <strong className="text-elec-yellow">Maintenance reports:</strong> Highlight
                  equipment performance, filter replacement needs, and scheduled service
                  requirements
                </li>
                <li>
                  <strong className="text-elec-yellow">Alarm summaries:</strong> Consolidate all
                  building alarms showing frequency, resolution times, and recurring issues
                </li>
                <li>
                  <strong className="text-elec-yellow">Compliance reporting:</strong> Automatically
                  generate documentation for regulatory requirements and energy certificates
                </li>
                <li>
                  <strong className="text-elec-yellow">Custom dashboards:</strong> Provide tailored
                  information for different stakeholders without data overload
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                Automated reporting ensures consistent data collection, reduces human error,
                provides timely alerts, and enables proactive building management by highlighting
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Reliable automation depends on accurate, stable data inputs. Your installation work
              provides the foundation that allows intelligent building systems to make correct
              decisions and generate trustworthy reports.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong className="text-elec-yellow">Signal integrity:</strong> Properly
                  terminated communications cables, appropriate cable separation from power
                  circuits, and correct earthing prevent data corruption
                </li>
                <li>
                  <strong className="text-elec-yellow">Power supply reliability:</strong> UPS
                  systems, proper load balancing, and backup power connections maintain automation
                  functionality
                </li>
                <li>
                  <strong className="text-elec-yellow">Sensor calibration:</strong> Regular
                  verification that sensors provide correct readings ensures trigger setpoints
                  operate as designed
                </li>
                <li>
                  <strong className="text-elec-yellow">Safety integration:</strong> Understanding
                  how automation interacts with fire alarms, emergency stops, and security systems
                </li>
                <li>
                  <strong className="text-elec-yellow">Documentation:</strong> As-built drawings,
                  cable schedules, and I/O lists enable efficient troubleshooting
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm font-medium text-elec-yellow mb-2">
                Hospital Emergency Response Automation
              </p>
              <p className="text-sm text-white mb-3">
                A major hospital implemented comprehensive event triggers for emergency response.
                When a fire alarm activates, the system automatically: recalls all lifts to ground
                floor, pressurises stairwells, switches air handling to smoke extraction mode,
                unlocks all security doors, and sends notifications to fire brigade and senior
                staff.
              </p>
              <p className="text-sm text-white mb-3">
                <strong>The Challenge:</strong> During testing, the automation responded incorrectly
                - lifts went to wrong floors, some air handling units did not switch modes, and
                notification delays occurred.
              </p>
              <p className="text-sm text-white mb-3">
                <strong>The Investigation:</strong> Electricians discovered multiple issues: fire
                alarm contacts had been wired to wrong BMS inputs, communications cables had
                interference from adjacent power circuits, and some devices lacked proper surge
                protection causing intermittent failures.
              </p>
              <p className="text-sm text-white">
                <strong>The Solution:</strong> Correct I/O wiring, proper cable separation, improved
                earthing, and comprehensive surge protection resolved all issues. The automation now
                provides reliable emergency response, potentially saving lives during real
                incidents.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Ignoring cable separation</strong> - causes interference and false
                  triggers
                </li>
                <li>
                  <strong>Poor documentation</strong> - makes troubleshooting difficult
                </li>
                <li>
                  <strong>Skipping commissioning tests</strong> - leaves faults undetected
                </li>
                <li>
                  <strong>Modifying automation logic without authorisation</strong> - can compromise
                  safety
                </li>
              </ul>
            </div>
