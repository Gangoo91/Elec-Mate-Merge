...
const quickCheckQuestions = [
  {
    ...
    options: ['4 Parts', '6 Parts', '8 Parts', '10 Parts'],
    correctIndex: 2,
    explanation:
      'BS 7671 has 8 main Parts, from Part 1 (Scope and Fundamental Principles) through Part 8 (Prosumer Electrical Installations).',
  },
  {
    id: 'inspection-testing-part',
    question: 'Which Part covers inspection and testing?',
    options: ['Part 1', 'Part 6', 'Part 5', 'Part 3'],
    correctIndex: 1,
    explanation:
      'Part 6 covers inspection and testing procedures, including both initial verification and periodic inspection.',
  },
  {
    id: 'formulas-location',
    question: 'Where are formulas and reference tables found in BS 7671?',
    options: ['Part 8', 'Introduction', 'Appendices', 'Index'],
    correctIndex: 2,
    explanation:
      'Appendices contain formulas, reference tables, charts, and other supporting information referenced throughout the regulations.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Parts 4, 6, and 7 are most frequently referenced in day-to-day work. Part 4 (Protection for Safety) is essential for understanding safety principles, Part 6 for inspection and testing, and Part 7 for special locations.',
  },
  {
    question: "What's the numbering system in BS 7671?",
    answer:
      'The system is hierarchical: Parts (1-8), then Chapters (e.g., 41, 42), then Sections (e.g., 411, 412), then individual Regulations (e.g., 411.3.3). The first digit indicates the Part number.',
  },
  {
    question: 'Which Appendix has cable current ratings?',
    answer:
      'Appendix 4 contains current-carrying capacity tables for cables, including installation method factors, grouping factors, and voltage drop calculations. Appendix 3 has time/current characteristics for protective devices.',
  },
  {
    question: 'How can I navigate BS 7671 faster?',
    answer:
      'Use the index for topic searches, tab mark frequently used sections, memorise Part numbers and their focus areas, and practice finding specific regulations. Being quick here saves significant time during exams and on-site work.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 2,
    explanation:
      'Section 708 covers marinas and similar locations. Section 701 is bathrooms, 710 is medical locations, and 721 is agricultural premises. These are all in Part 7 - Special Installations or Locations.',
  },
];
...
const BS7671Module1Section3 = () => {
  useSEO({
    ...
    description:
      'Master the structure of BS 7671 including Parts, Chapters, Sections, Appendices, and efficient navigation techniques.',
  });
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>8 Parts:</strong> From fundamentals to prosumer installations
              </li>
              <li>
                <strong>Chapters:</strong> Specific principles within each Part
              </li>
              <li>
                <strong>Appendices:</strong> Formulas, tables, and reference data
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> First digit = Part number (411 = Part 4)
              </li>
              <li>
                <strong>Use:</strong> Index, tabs, and bookmarks for fast navigation
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BS 7671 follows a logical hierarchy designed to take you from fundamental principles
              through to specific application requirements. Understanding this structure is
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
              ...
              <div className="space-y-2 text-sm text-white/90">
                <div className="flex items-center gap-3">
                  ...
                  <span>
                    <strong>Parts 1–8:</strong> Core requirements, definitions, design, safety,
                    inspection
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <span>
                    <strong>Chapters:</strong> Narrow down specific principles within Parts
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-green-400 rounded-full flex-shrink-0 ml-0.5"></span>
                  <span>
                    <strong>Sections:</strong> Drill further into specific application detail
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="w-2 h-2 bg-elec-yellow rounded-full flex-shrink-0 ml-0.5"></span>
                  <span>
                    <strong>Appendices:</strong> Formulas, charts, tables, reference material
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-lg bg-transparent border border-white/10">
                <div className="flex items-start gap-3">
                  <span className="bg-elec-yellow text-[#1a1a1a] rounded-full w-6 h-6 flex items-center justify-center font-bold text-xs flex-shrink-0">
                    1
                  </span>
                  <div>
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                <div className="flex items-start gap-3">
                  <span className="bg-red-500 text-white rounded-full w-6 h-6 flex items-center justify-center font-bold text-xs flex-shrink-0">
                    4
                  </span>
                  <div>
                    <p className="font-medium text-white">
                    ...
                    <p className="text-xs text-red-400 mt-1">
                      Most referenced for safety requirements
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
                <div className="flex items-start gap-3">
                  <span className="bg-blue-500 text-white rounded-full w-6 h-6 flex items-center justify-center font-bold text-xs flex-shrink-0">
                    6
                  </span>
                  <div>
                    <p className="font-medium text-white">
              ...
              <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/20">
                <div className="flex items-start gap-3">
                  <span className="bg-orange-500 text-white rounded-full w-6 h-6 flex items-center justify-center font-bold text-xs flex-shrink-0">
                    7
                  </span>
                  <div>
                    <p className="font-medium text-white">
                    ...
                    <p className="text-xs text-orange-400 mt-1">
                      Additional requirements for challenging environments
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
                <div className="flex items-start gap-3">
                  <span className="bg-green-500 text-white rounded-full w-6 h-6 flex items-center justify-center font-bold text-xs flex-shrink-0">
                    8
                  </span>
                  <div>
                    <p className="font-medium text-white">
                    ...
                    <p className="text-xs text-green-400 mt-1">
                      Modern energy systems and future technologies
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              regulations. These are your go-to resources for calculations, tables, and technical
              data.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div>
                ...
                <ul className="text-sm text-white space-y-2 ml-4">
                  <li>
                    <strong>Index:</strong> Alphabetical topic listing with regulation refs
                  </li>
                  <li>
                    <strong>Contents:</strong> Hierarchical structure overview
                  </li>
                  <li>
                    <strong>Cross-references:</strong> Links between related regulations
                  </li>
                  <li>
                    <strong>Page headers:</strong> Show current Part and Chapter
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-2 ml-4">
                  <li>
                    <strong>Tab marking:</strong> Physical tabs for frequent sections
                  </li>
                  <li>
                    <strong>Bookmarks:</strong> Mark key regulation numbers
                  </li>
                  <li>
                    <strong>Memorisation:</strong> Learn Part numbers and focus areas
                  </li>
                  <li>
                    <strong>Practice:</strong> Time yourself finding regulations
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
              ...
              <div className="space-y-2 text-sm text-white/90">
                ...
                <p>
                  <strong>Result:</strong> What could take 30 minutes of searching is done in 5
                  minutes, allowing more time for practical testing.
                </p>
              </div>
            </div>
          </div>
