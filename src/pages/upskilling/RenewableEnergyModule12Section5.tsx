...
const inlineChecks = [
  ...
  },
  {
    ...
    question: 'What are EICR classification codes (C1, C2, C3, FI) + how apply to LCT findings?',
    options: [
  ...
  },
  {
    ...
    question: 'PV EICR-equivalent — what items extend the standard AC EICR?',
    options: [
...
const quizQuestions = [
  ...
  {
    question: 'EV charger EICR-equivalent — what items extend the standard AC EICR?',
    options: [
  ...
  {
    question: 'EICR-equivalent on a heat pump (ASHP outdoor unit + indoor controller). What items?',
    options: [
  ...
  {
    question: 'Wind turbine EICR-equivalent — what specialist items?',
    options: [
...
export default function RenewableEnergyModule12Section5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 12 · Section 5 · BS 7671:2018+A4:2026 · Chapter 65 + Reg 651-653"
        title="EICR cycle + per-technology specifics"
        backTo="../renewable-energy-module-12"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Chapter 65 Periodic Inspection + Testing. Reg 652.1 frequency factors. EICR classification
          codes (C1, C2, C3, FI). Per-technology EICR-equivalent specifics across PV / BESS / EV /
          heat pumps / wind / CHP / hydro. Coordinated multi-source LCT EICR + cert evidence bundle
          integration.
        </p>
        ...
        <Pullquote>
          Initial verification proves it works on day one. The EICR cycle proves it still works on
          day 1825. Both anchor the install lifecycle.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 651.1</strong>— periodic inspection + testing of
              every electrical installation shall be carried out (where required); purpose:
              determine satisfactory condition for continued service
            </li>
            <li>
              <strong className="text-white">Reg 651.3</strong>— periodic inspection + testing shall
              not cause danger to persons or livestock + shall not cause damage to property or
              equipment even if the circuit is defective. Instruments per BS EN 61557
            </li>
            <li>
              <strong className="text-white">Reg 651.4</strong>— details of any damage,
              deterioration, defects or dangerous conditions shall be recorded in a report
            </li>
            <li>
              <strong className="text-white">Reg 651.5</strong>— periodic inspection + testing shall
              be carried out by one or more skilled persons competent in such work
            </li>
            <li>
              <strong className="text-white">Reg 652.1</strong>— frequency determined having regard
              to type + use + operation + maintenance + external influences + previous reports
            </li>
            <li>
              <strong className="text-white">Reg 653.1-653.2</strong>— notes for the person
              producing the report (Appendix 6); guidance for the recipient(s); photographic +
              thermographic images may be appended
            </li>
            <li>
              <strong className="text-white">EICR report format</strong> — industry-standard
              template (NICEIC / IET) with circuit-by-circuit Schedule + observations +
              classifications + recommendations
            </li>
            <li>
              <strong className="text-white">For LCT</strong>— standard AC EICR + per-technology
              extensions detailed in this section + §12.3 (BESS specific)
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">C1 — Danger present, risk of injury</strong> —
              examples: exposed live conductor at PV combiner box; missing protective conductor on
              EV charger; failed isolator; thermal damage at BESS DC busbar (visible char or melt);
              failed OPDD on outdoor EV (under current Reg 722.411.4)
            </li>
            <li>
              <strong className="text-white">C2 — Potentially dangerous, urgent action</strong> —
              examples: PV DC string IR approaching Table 64 threshold with degrading trend; cell
              imbalance + over-temp events on BESS without intervention; loose AC terminations with
              thermal evidence; Type AC RCD on LCT circuit (per Reg 531.3.3)
            </li>
            <li>
              <strong className="text-white">C3 — Improvement recommended</strong> — examples: older
              Type A RCD adequate for current install but not future-proof; no AFDD where A4:2026
              now suggests; older PV install pre-2018 Section 712
            </li>
            <li>
              <strong className="text-white">FI — Further Investigation</strong> — examples: BMS
              reporting intermittent fault not yet root-caused; SoH trend anomaly worth
              investigating; loop impedance at upper limit
            </li>
            <li>
              <strong className="text-white">Coding judgement</strong>— applied consistently;
              defensible; documented rationale; cross-referenced to relevant regs + manufacturer DoC
            </li>
            <li>
              <strong className="text-white">Reporting flow</strong>— EICR document → customer copy
              + installer audit + insurance / DNO where applicable; classification + recommendations
              + timeline; cert evidence bundle updated
            </li>
            <li>
              <strong className="text-white">Customer-facing summary</strong> — plain-English
              explanation of findings + actions; technical detail in appendix; clear communication
              essential
            </li>
            <li>
              <strong className="text-white">Re-inspection after remediation</strong> — when
              remediation completed, re-test relevant items + update EICR + cert evidence bundle
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          One EICR cycle, many technology layers. Standard AC EICR baseline + per-source extensions
          + multi-source cross-checks + single customer touchpoint.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">DC string IR re-test</strong> — per Section 712 + Table
              64 + manufacturer; weather + module temp + irradiance recorded; trend vs baseline
            </li>
            <li>
              <strong className="text-white">Reg 712.421.101 IMD</strong> — self-test via inverter;
              event log review; BS EN 61557-8 compliance maintained
            </li>
            <li>
              <strong className="text-white">DC + AC isolators</strong>— Section 537 + mechanical
              operation + electrical isolation verified; weather seal integrity outdoor
            </li>
            <li>
              <strong className="text-white">Module condition</strong> — visible inspection
              (binoculars / drone for high-roof); cracks, delamination, frame corrosion,
              junction-box ingress, hot spots; thermal imaging where access permits
            </li>
            <li>
              <strong className="text-white">Mounting + earthing</strong> — Section 712 frame
              mounting integrity + earthing bonding to MET; check for movement / wind damage /
              corrosion
            </li>
            <li>
              <strong className="text-white">Anti-islanding</strong>— Reg 551.7.5 inverter self-test
              or DNO-witnessed simulated grid-loss; record result
            </li>
            <li>
              <strong className="text-white">Inverter functional + firmware</strong> — generation
              profile vs irradiance; firmware updates applied; manufacturer DoC + warranty status
            </li>
            <li>
              <strong className="text-white">Yield review</strong>— portal data over period vs
              modelled output; sustained underperformance indicates degradation / soiling / shading
            </li>
            <li>
              <strong className="text-white">Warning notices per Reg 712.514</strong> — at origin +
              metering + CU; intact + legible
            </li>
            <li>
              <strong className="text-white">Thermal imaging</strong>— DC combiner + inverter DC +
              AC + isolator contacts; identifies high-resistance points
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 722.411.4 OPDD</strong> — presence verified +
              manufacturer self-test triggered where supported + event log reviewed for prior trips
            </li>
            <li>
              <strong className="text-white">Reg 722.531 RCD + RDC-DD</strong> — Type A + RDC-DD or
              Type B per manufacturer; BS EN 61557-6 functional test; RDC-DD function verified per
              DoC
            </li>
            <li>
              <strong className="text-white">Charger physical condition</strong> — enclosure intact;
              mounting secure; no corrosion / damage / vandalism / vehicle impact
            </li>
            <li>
              <strong className="text-white">Cable + connector integrity</strong> — strain relief +
              sheath condition + no cuts / abrasion; connector latch operates + contacts visible no
              arcing / wear
            </li>
            <li>
              <strong className="text-white">Earthing arrangement</strong> — PME + OPDD architecture
              or TT earth electrode resistance per Reg 643.7.3 + Reg 411.5.3 trend
            </li>
            <li>
              <strong className="text-white">Functional charge test</strong> — test load or vehicle;
              charge cycle initiates + completes; communication with vehicle handshake; emergency
              stop functional
            </li>
            <li>
              <strong className="text-white">Firmware + CMS</strong> — installed version +
              manufacturer updates applied; commercial OCPP communication + cloud connectivity
              (where applicable)
            </li>
            <li>
              <strong className="text-white">Warning notices</strong>— manufacturer warning +
              isolation labelling intact; ratings + DoC reference visible
            </li>
            <li>
              <strong className="text-white">Thermal imaging</strong>— AC supply terminations +
              contactor + protection device contacts; identify high-resistance heating
            </li>
            <li>
              <strong className="text-white">Customer education refresh</strong> — emergency stop +
              fault response + contacts
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Outdoor unit electrical install</strong> — vibration
              impact on terminations (retorque); weatherproofing seals; frame mounting; surrounding
              clearance (debris, vegetation)
            </li>
            <li>
              <strong className="text-white">Reg 643 testing on dedicated supply circuit</strong> —
              continuity, IR at 500 V, polarity, loop impedance at outdoor unit isolator, RCD per
              Type per manufacturer DoC, PFC
            </li>
            <li>
              <strong className="text-white">Earthing arrangement</strong> — TT or PME with
              appropriate architecture; outdoor LCT good practice per §12.4; earth electrode
              resistance trend where TT
            </li>
            <li>
              <strong className="text-white">VSD compressor electronics</strong> — manufacturer
              service interface re-check; fault history review; recurring trip events investigated
            </li>
            <li>
              <strong className="text-white">BMS + control wiring</strong> — communication with CH
              control; thermostat + weather compensation sensor + cylinder sensor wiring integrity
            </li>
            <li>
              <strong className="text-white">Refrigerant + thermal check</strong> — F-gas qualified
              specialist scope; coordinate visit
            </li>
            <li>
              <strong className="text-white">Functional verification</strong> — heat pump starts +
              reaches setpoint + cycle normal; defrost + auxiliary heater + DHW (where integrated)
              functional
            </li>
            <li>
              <strong className="text-white">Firmware + manufacturer service</strong> — annual
              service per manufacturer schedule; service record alongside EICR-equivalent in cert
              evidence bundle
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Wind turbine</strong>— mast + turbine structural
              (climbing / rope access; manufacturer service); electrical install at base; DC interim
              bus where present; anti-islanding + EREC; lightning protection per BS EN 62305
            </li>
            <li>
              <strong className="text-white">CHP unit</strong>— engine + flue + fuel supply
              specialist; electrical install (generator + grid-tie + parallel operation per Section
              551); anti-islanding; heat-network interface specialist
            </li>
            <li>
              <strong className="text-white">Micro-hydro</strong>— turbine + civils (intake,
              pipework, tailrace) specialist; Environment Agency abstraction licence + monitoring;
              electrical install at turbine + control room; DC interim bus where present
            </li>
            <li>
              <strong className="text-white">Solar thermal</strong>— collectors + controllers +
              circulation pumps; heating engineer + electrician on controls + pumps scope
            </li>
            <li>
              <strong className="text-white">Biomass</strong>— combustion + flue + fuel feed
              specialist (HETAS / biomass installer); electrical install on controls + auger +
              ignition + fans + flue extract
            </li>
            <li>
              <strong className="text-white">Section 551 framework</strong> — anti-islanding per Reg
              551.7.5; supply-side connection per Reg 551.7.2.1; multi-source RCD per Reg 551.4.2
            </li>
            <li>
              <strong className="text-white">EREC G98 / G99</strong>— generation export compliant;
              DNO reference; periodic confirmation
            </li>
            <li>
              <strong className="text-white">Coordinated visit</strong> — schedule specialist trades
              alongside electrician for comprehensive periodic; single customer touchpoint; cert
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-12-section-6')}
