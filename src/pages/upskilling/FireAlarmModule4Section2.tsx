import { ChevronLeft, ChevronRight, Battery } from 'lucide-react';
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS 5839-1:2025 Annexe E — the standby battery sizing formula Cmin = 1.25 × (T1·I1 +
          D·I2·T2), the 4-year ageing factor, the 1.75 alarm de-rating, the standby PSU standards
          (BS EN 54-4 and the new 2025 BS EN 50131-6 Grade 4 alternative), and the 2025 battery date
          label requirement.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>1.25 — the four-year ageing factor.</strong> Sealed lead-acid (SLA) batteries
              on continuous float charge lose capacity over their service life. By the end of the
              four-year design replacement cycle, capacity has typically fallen to around 75-80% of
              nominal. The 1.25 multiplier sizes the battery so that the END-OF-LIFE capacity meets
              the requirement, not the new capacity. A battery that only meets the formula when new
              will fail to meet it long before its replacement date.
            </li>
            <li>
              <strong>T1·I1 — the standby capacity term.</strong> Standby current (I1) multiplied by
              standby duration (T1) gives the Ah needed to keep the system alive through mains
              failure. T1 is 24 h by default (reducible to 6 h only with reliable automatic standby
              generation). I1 is the quiescent draw of the CIE plus all always-energised interface
              devices.
            </li>
            <li>
              <strong>D·I2·T2 — the alarm capacity term.</strong> Alarm current (I2) multiplied by
              alarm duration (T2 = 0.5 h) gives the nominal Ah needed to drive the alarm event. The
              de-rating factor D = 1.75 accounts for SLA high-discharge capacity loss — the battery
              delivers substantially less than its 20 h-rated capacity when discharged at the high
              current required by a full bank of sounders.
            </li>
            <li>
              <strong>Sum and 1.25 multiplier.</strong> The standby and alarm portions are summed
              inside the bracket, then the whole sum is multiplied by 1.25 for ageing. Both standby
              AND alarm performance degrade with age; the 1.25 must be applied to both, which is why
              the brackets are around the sum.
            </li>
          </ul>
          <p>
            The result, Cmin, is the minimum required nominal battery capacity in Ah at the standard
            20-hour discharge rate (the rate at which SLA batteries are nominally specified). The
            battery selected for fitting is the next available standard size equal to or greater
            than Cmin — rounding up only.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>I1 (standby current) = 0.2 A.</strong> Sum of the CIE quiescent draw plus any
              always-energised interface devices (door-closer hold-open magnets, addressable loop
              quiescent, etc.).
            </li>
            <li>
          ...
          <p>
            ...
            selecting 12 Ah meets the formula with modest margin. The correct selection is 12 Ah. On
            a 24 V CIE topology this is typically two 12 V 12 Ah batteries in series; on a dual-bank
            topology it might be 4 × 6 V 12 Ah batteries.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              label may be a printed adhesive label, an engraved tag, or a permanent marker applied
              to the battery casing. The installation date is the datum for the design replacement
              cycle, and the battery should be replaced at intervals not exceeding the design cycle.
              The 2025 revision acknowledges the long-standing custom and practice of marking
              batteries with installation date and formalises it as a recommendation.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="105" y="50" textAnchor="middle" fill="#22D3EE" fontSize="11" fontWeight="bold">
              Standby current I1
            </text>
            <text
              x="105"
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="295" y="50" textAnchor="middle" fill="#22D3EE" fontSize="11" fontWeight="bold">
              Standby duration T1
            </text>
            <text
              x="295"
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="485" y="50" textAnchor="middle" fill="#EF4444" fontSize="11" fontWeight="bold">
              Alarm current I2
            </text>
            <text
              x="485"
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="675" y="50" textAnchor="middle" fill="#EF4444" fontSize="11" fontWeight="bold">
              Alarm duration T2
            </text>
            <text
              x="675"
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              acceptable time after mains loss — typically tens of seconds. Battery has to cover the
              gap between mains failure and generator stabilisation.
            </li>
            <li>
              <strong>Reliable.</strong> The generator is regularly maintained, periodically
              test-started under load, and has fuel reserves sufficient for the credible mains-fail
              event. A generator that is rarely tested or that has unreliable starting does not
          ...
          <p>
            Where all four conditions are met, T1 = 6 h is justifiable. The battery sizing for a 6 h
            system is materially smaller than the 24 h equivalent, which produces real cost savings
            and physical-space savings on large installations. The justification must be documented
            in the design records — both the standby duration choice and the evidence base for the
            generator reliability claim.
          </p>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              reference for the CIE&apos;s integrated PSU and for any external standby PSUs feeding
              fire alarm equipment.
            </li>
            <li>
              <strong>
                BS EN 50131-6 Grade 4 — Intruder alarm systems: Power supplies, Grade 4 reliability.
              </strong>{' '}
          ...
          <p>
            Designers and installers should read the equipment marking to verify which standard the
            unit is built to. A BS EN 54-4-marked PSU is acceptable for fire alarm primary and
            secondary power. A BS EN 50131-6 Grade 4-marked PSU is acceptable for alarm transmission
            equipment power. Grade 1, 2 or 3 BS EN 50131-6 PSUs do NOT qualify; only Grade 4.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              power supply should conform to either BS EN 54-4 or BS EN 50131-6 Grade 4. The 2025
              revision recognises BS EN 50131-6 Grade 4 as an acceptable alternative to BS EN 54-4
              for this specific application, reflecting the equivalent reliability achieved at the
              highest grade of the intruder-alarm power supply standard.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              voltage and frequency, and rides through brief mains dips without interrupting output.
            </li>
            <li>
              <strong>Charge regime.</strong> Supplies the SLA battery with the correct float
              voltage (typically around 13.6-13.8 V per 12 V battery, temperature-compensated), and
              limits charge current to the manufacturer-specified safe level.
            </li>
            <li>
              <strong>Battery monitoring.</strong> Continuously monitors the battery — open circuit,
              short circuit, low capacity at periodic load test. Reports faults to the CIE.
            </li>
            <li>
            ...
            <li>
              <strong>Environmental tolerance.</strong> Operates over the temperature range expected
              in service, with humidity, vibration and other environmental constraints defined.
            </li>
          </ul>
          <p>
            The standards mark allows the designer to select equipment without having to test all of
            these characteristics individually — the third-party certification is the evidence that
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              and adding 4 years. Without dates, scheduling depends on the system logbook (which may
            ...
            <li>
              <strong>Independent verification.</strong> An auditor or fire-risk assessor can check
              battery replacement compliance directly from the batteries themselves, not only from
              documentation. The label is on-site evidence.
            </li>
          </ul>
          <p>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-4/section-3')}
