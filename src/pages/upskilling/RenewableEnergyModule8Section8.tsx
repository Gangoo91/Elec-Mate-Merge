...
const inlineChecks = [
  {
    ...
    question: 'What is the heat pump commissioning sequence per BS 7671 Part 6?',
    options: [
  ...
  },
  {
    ...
    question: 'What test instruments does the commissioning electrician need?',
    options: [
  ...
  {
    id: 'm8s8-eic-content',
    question: 'What does the heat pump install EIC document?',
    options: [
  ...
  {
    id: 'm8s8-eicr-cycle',
    question: 'What is the EICR cycle for a domestic heat pump install?',
    options: [
...
const quizQuestions = [
  {
    question: 'Standard UK 2025-26 domestic ASHP install — commissioning + handover delivery?',
    options: [
  ...
  {
    question: 'Three-phase heat pump install — what differs in commissioning?',
    options: [
  ...
  {
    question: 'Customer handover education — what should the electrician cover?',
    options: [
  ...
  {
    question: 'Heat pump cert evidence bundle structure — what does it integrate?',
    options: [
...
export default function RenewableEnergyModule8Section8() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 8 · BS 7671:2018+A4:2026 · Part 6 + Chapter 64 + BS EN 61557"
        title="Commissioning, Part 6 inspection + handover"
        backTo="../renewable-energy-module-8"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Heat pump commissioning sequence per BS 7671 Part 6 — Reg 642 visual inspection, Reg 643
          testing per dedicated circuit, BS EN 61557 instrument requirements, EIC + Schedule of
          Inspections + Schedule of Test Results per Chapter 64, MCS handover pack integration,
          customer handover education, EICR cycle.
        </p>
        ...
        <Pullquote>
          Commissioning is where M8.1-M8.7 prove themselves. Reg 643 testing per circuit, per phase,
          per element, per device. Schedule of Test Results is the structured truth that the EICR
          ten years later relies on.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Installation per design</strong> — heat pump model +
              outdoor unit + indoor unit + cylinder + CU layout matches the design / quote
            </li>
            <li>
              <strong className="text-white">Manufacturer instructions followed</strong> — outdoor
              unit clearance per spec; vibration isolation pads; cable routing; gland-sealed
              entries; cylinder installation per manufacturer
            </li>
            <li>
              <strong className="text-white">Polarity</strong> — at every accessory + outdoor
              isolator + CU dedicated way. Mismatch indicates wiring error
            </li>
            <li>
              <strong className="text-white">Conductor terminations</strong> — secure (correct
              torque per manufacturer); no bare strands outside terminals; no over-insulation under
              terminal clamp
            </li>
            <li>
              <strong className="text-white">CPC arrangement</strong>— armour-as-CPC (continuity
              from outdoor unit through armour to CU earth) OR separate green-yellow CPC verified
            </li>
            <li>
              <strong className="text-white">IP / IK at outdoor</strong> — outdoor unit + isolator
              IP rating maintained; cable glands sealed; no water ingress points; no UV-degradation
              of outer sheath
            </li>
            <li>
              <strong className="text-white">Cable thermal protection</strong> — Reg 522.2
              compliance verified per route; shielding / distance / higher-rated cable / local
              reinforcement as appropriate
            </li>
            <li>
              <strong className="text-white">Warning notices + labelling</strong> — Reg 514 RCD test
              notice + heat pump circuit identification at CU + outdoor isolator labelled
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — Schedule of Inspections
              + photographs + manufacturer install manual reference
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Continuity (Reg 643.2)</strong> — R1+R2 measured
              end-to-end of the circuit (CU terminal to outdoor unit terminal). Typical 32 A heat
              pump circuit: ~0.15 Ω for 6 mm² indoor + 10 mm² SWA outdoor + 15 m
            </li>
            <li>
              <strong className="text-white">Insulation resistance (Reg 643.3)</strong> — between
              line + neutral; line + earth; neutral + earth. At 500 V DC. ≥1 MΩ per Table 64 (Reg
              643.3.2). Typical actual ~500-2000 MΩ for new install
            </li>
            <li>
              <strong className="text-white">Polarity (Reg 643.6)</strong> — line + neutral + earth
              correctly connected; verified at outdoor unit terminals + CU dedicated way + outdoor
              isolator
            </li>
            <li>
              <strong className="text-white">ADS / Zs (Reg 643.7)</strong> — measured at outdoor
              unit terminals (furthest point). Typical 32 A C-curve on 230 V TN-C-S: ≤0.68 Ω.
              Measured ~0.3-0.5 Ω typical
            </li>
            <li>
              <strong className="text-white">RCD trip-time (Reg 643.7.3 + BS EN 61557-6)</strong> —
              at IΔn (30 mA): ≤300 ms required; typical actual ~25-50 ms. At 5 × IΔn (150 mA): ≤40
              ms required; typical actual ~10-20 ms. Test at sine-wave for Type A; Type B-capable
              instrument test for Type B
            </li>
            <li>
              <strong className="text-white">Prospective fault current (Reg 643.7.3.201)</strong> —
              at origin + at relevant points. Typical 100 A TN-C-S supply: ~6 kA at origin; ~3 kA at
              heat pump circuit
            </li>
            <li>
              <strong className="text-white">Additional protection verification (Reg 643.8)</strong>{' '}
              — RCD effectiveness for additional protection at IΔn
            </li>
            <li>
              <strong className="text-white">Functional test (Reg 643.10)</strong> — exercise each
              circuit; verify operation under normal conditions
            </li>
            <li>
              <strong className="text-white">Per-circuit results</strong> — recorded in Schedule of
              Test Results per BS 7671 Appendix 6 model form
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          EIC is the structured truth. Ten years later, the EICR engineer reads the original EIC +
          Schedule of Test Results + walks the property. Clear initial documentation makes the EICR
          straightforward.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Customer details</strong> — name + address (property +
              correspondence if different) + contact
            </li>
            <li>
              <strong className="text-white">Installer details</strong> — installer name + company +
              competent person scheme + registration number + signature
            </li>
            <li>
              <strong className="text-white">Supply characteristics</strong> — TN-S / TN-C-S / TT;
              max demand (kVA or kW); nominal voltage; nominal frequency; Ze (external supply
              impedance); prospective fault current at origin
            </li>
            <li>
              <strong className="text-white">Particulars of installation</strong> — domestic /
              commercial / industrial; new install / addition / alteration; main switch; earthing
              arrangement; protective conductor + main earthing terminal + bonding
            </li>
            <li>
              <strong className="text-white">Schedule of Inspections</strong> — comprehensive
              checklist per Reg 642 / Appendix 6. Items ticked / N/A
            </li>
            <li>
              <strong className="text-white">Schedule of Test Results</strong> — per-circuit table:
              circuit ID + description + protective device + cable + R1+R2 + IR + Zs (measured +
              maximum permitted) + RCD trip-time at IΔn + at 5 × IΔn + prospective fault current +
              functional
            </li>
            <li>
              <strong className="text-white">Declaration</strong>— competent person’s declaration of
              compliance with BS 7671 + signature + date
            </li>
            <li>
              <strong className="text-white">Recommendations</strong>— next inspection (typical
              10-year cycle for domestic owner-occupied; 5-year for landlord-rented; 5-year for
              commercial)
            </li>
            <li>
              <strong className="text-white">Schedule of Departures</strong> — if any departures
              from BS 7671 made (none expected on standard install)
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — EIC + Schedule of
              Inspections + Schedule of Test Results + photographs + instrument records + customer
              handover docs
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Phase rotation verification</strong> — phase-sequence
              tester at outdoor unit terminals BEFORE first energising the heat pump compressor.
              Confirm L1→L2→L3 clockwise. Wrong rotation: swap any two phases at the outdoor
              isolator + re-verify
            </li>
            <li>
              <strong className="text-white">Per-phase Zs</strong>— L1-PE, L2-PE, L3-PE measured
              separately at outdoor unit terminals. Each ≤ Table 41.3 for the protective device.
              Per-phase imbalance within ~10% expected (cable + supply transformer + earth-electrode
              tolerance)
            </li>
            <li>
              <strong className="text-white">4-pole RCD trip-time per phase</strong> — induce fault
              on L1 → verify trip; reset; L2 → verify; reset; L3 → verify. Trip-time at 1× IΔn + at
              5 × IΔn per phase
            </li>
            <li>
              <strong className="text-white">Balanced load verification</strong> — at running steady
              state with compressor running, measure per-phase current. Should be within 10% of
              average across L1, L2, L3
            </li>
            <li>
              <strong className="text-white">Functional test</strong>— three-phase compressor starts
              smoothly; defrost cycle exercised; immersion functional (note typically single-phase
              on L1 from the three-phase supply); zone valves operate
            </li>
            <li>
              <strong className="text-white">EREC G99 completion notification</strong> — if formal
              G99 application made, submit completion to DNO. Reference recorded in cert evidence
              bundle
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — per-phase Zs + phase
              rotation + 4-pole RCD trip-time per phase + balanced load + functional test + DNO
              completion
            </li>
          </ul>
        </ConceptBlock>
