    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Cord-sets, IEC leads, extension leads and re-wireable plugs. The brown/blue/green-yellow
          colour rule, the historical red/black/green issue, and the pin-to-conductor check that
          catches the reversed-lead fault.
        </p>
        ...
        >
          <p>
            IET Code of Practice 5th Edition (2020) Chapter 15 directs polarity testing specifically
            at equipment where conductor identification is exposed to error: detachable mains cords
            (kettle leads, monitor leads, IEC cord-sets generally), extension leads, and any
            re-wireable BS 1363 plug-top fitted to a flex by hand. Moulded-plug sealed appliances —
            where the manufacturer has factory-fitted the plug and the user cannot open the
            connection — are inspected visually at the plug only; the conductor identity inside is
            taken as factory-correct.
          </p>
          <p>
            ...
            socket-outlet, ensuring single-pole switching always interrupts the line conductor. PAT
            applies the same principle to the appliance side. Reg&nbsp;643.6 exists because every
            fatality from a "switched-off" appliance traces back to single-pole switching in the
            wrong conductor.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Polarity of supply leads, including extension leads and detachable cord-sets, shall be
              verified to confirm that the line conductor connects only to the line pin of the plug
              and to the line contact of the appliance connector. Polarity testing shall be
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              fuse in the plug between the appliance and neutral. Under a fault, the fuse may still
              operate (fault current still flows back to the supply), but the appliance is left
              line-connected up to the point of fault. The protective effect is degraded relative to
              the line-side fuse design.
            </li>
            <li>
              ...
              believing the fan is isolated, and is shocked when working on the fan because the line
              conductor was never interrupted.
            </li>
            <li>
              <strong>Appliance internal switch:</strong> A two-pole switch on a kettle handles both
              line and neutral. A single-pole switch on a desk lamp handles line only. A reversed
              cord turns the single-pole switch into a neutral-only switch — the lamp "off" still
              has the bulb live to ground potential, and a finger inside an open lamp holder
              receives a shock the user did not expect.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            The pin layout in a UK BS 1363 plug, viewed from the face (pin side towards you): earth
            at the top (12 o&apos;clock), line on the right, neutral on the left. The earth pin is
            longer than line and neutral by design — it makes contact first on insertion and breaks
            contact last on withdrawal, so the protective conductor is always the first connected
        ...
        >
          ...
          <p>
            ...
            recommend replacement at the next opportunity. The polarity test on a pre-2004 cord-set
            passes / fails on the same pin-to-conductor verification — colours do not affect the
            test outcome; they affect the safety of any future intervention.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="130" y="100" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9.5">
              (face view)
            </text>
            ...
            <text x="83" y="240" textAnchor="middle" fill="#3B82F6" fontSize="10" fontWeight="bold">
              N (left)
            </text>
            ...
            <rect
              ...
              strokeWidth="0.8"
            />
            <text x="283" y="129" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              Green/yellow
            </text>
            <rect
              x="270"
              ...
              strokeWidth="0.8"
            />
            <text x="300" y="257" textAnchor="middle" fill="#C8855B" fontSize="9" fontWeight="bold">
              Brown
            </text>
            <rect
              x="240"
              ...
              strokeWidth="0.8"
            />
            <text x="264" y="301" textAnchor="middle" fill="#3B82F6" fontSize="9" fontWeight="bold">
              Blue
            </text>
            ...
            <text x="405" y="258" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              L
            </text>
            <circle cx="440" cy="235" r="5" fill="#22C55E" />
            <text x="440" y="258" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              E
            </text>
            <circle cx="475" cy="235" r="5" fill="#3B82F6" />
            <text x="475" y="258" textAnchor="middle" fill="#3B82F6" fontSize="9" fontWeight="bold">
              N
            </text>
            ...
            <text x="420" y="343" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              Confirm earth continuity (M4.1) and IR (M4.2) have passed. Polarity is the third test
              in the sequence and assumes those have completed.
            </li>
            <li>
            ...
            <li>
              Initiate the polarity test. The tester runs continuity between L pin and L contact, N
              pin and N contact, E pin and E contact. Pass / fail is shown for each.
            </li>
            <li>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              <span className="block">
                At the plug, the brown conductor must go to the L pin (right) and the blue conductor
                to the N pin (left), looking at the plug face. If the colours are swapped, swap
                them, re-fit the cover, and re-test.
              </span>
              <span className="block">
        ...
        <RegsCallout
          ...
          clause={
            <>
              A test of polarity shall be made and it shall be verified that every fuse, single-pole
              control device and switch is connected in the line conductor only. Edison-screw and
              similar lampholders, except E14 and E27 lampholders to BS EN 60238 in which the outer
              or screwed contact connects to the neutral conductor, and that wiring is correctly
              connected to socket-outlets and similar accessories.
            </>
          }
        ...
        >
          ...
          <p>
            IET CoP Ch 15 and BS 1363 require the fuse rating to be appropriate to the appliance and
            the supply flex csa. A wrong-rated fuse — especially over-rated — fails the inspection
            and removes the appliance from service until the correct fuse is fitted. The BS 1362
            fuse is itself a serviceable component: its glass body should not be cracked, the fuse
            element should not be visibly degraded, and the fuse should not be loose in the carrier.
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>BS 1362 fuse rating:</strong> the fuse rating found at inspection (3 A, 13 A,
              etc). On any re-wireable plug, the fuse rating verification is part of the polarity /
              inspection workflow.
            </li>
            <li>
