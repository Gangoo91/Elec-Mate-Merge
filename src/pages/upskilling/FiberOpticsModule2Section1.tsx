...
const DESCRIPTION =
  'Understand the key differences between singlemode and multimode optical fibres, their applications, and how to choose the right type for your installation.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 2,
    explanation:
      'Singlemode fibre has a very small core of 8-10um (typically 9um) which allows only one mode of light to propagate, eliminating modal dispersion.',
  },
  {
    id: 'fo-m2s1-qc2',
    ...
    correctIndex: 2,
    explanation:
      'Singlemode fibre is preferred for distances over 500m due to its lower attenuation and absence of modal dispersion. Multimode has distance limitations.',
  },
  {
    id: 'fo-m2s1-qc3',
    ...
    options: [
      'Temperature changes',
      'Different light paths arriving at different times',
      'Connector dirt',
      'Cable bending',
    ],
    correctIndex: 1,
    explanation:
      'In multimode fibre, light travels via multiple paths (modes) of different lengths. These arrive at different times, spreading the signal - this is modal dispersion.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Singlemode OS2 has the lowest attenuation at around 0.4 dB/km, compared to multimode which is typically 2-3 dB/km.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Singlemode fibre requires laser sources at 1310nm or 1550nm wavelengths due to the small core size.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    options: [
      ...
      'A path that light can travel through the fibre',
      'The connector type',
      'The installation method',
    ],
    correctAnswer: 1,
    explanation:
      'A mode is a path that light can take through the fibre. Singlemode has one path, multimode has many.',
  },
  {
    id: 7,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "Standard telecommunications fibre has a cladding diameter of 125um regardless of whether it's singlemode or multimode.",
  },
  {
    id: 10,
    ...
    options: [
      'Reduce cost',
      'Support higher data rates over longer distances',
      'Make installation easier',
      'Improve appearance',
    ],
    correctAnswer: 1,
    explanation:
      'OM3/OM4 are laser-optimised to support higher data rates (10-100Gbps) over longer distances than older OM1/OM2 grades.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'No. Singlemode and multimode are not compatible. The different core sizes and light sources mean connecting them directly causes massive signal loss. Use appropriate media converters if you must bridge between types.',
  },
  {
    question: 'Is singlemode always better than multimode?',
    answer:
      'Not necessarily. For short distances (&lt;300-500m), multimode is often more cost-effective because it uses cheaper LED/VCSEL sources. Singlemode excels at longer distances and higher bandwidths but requires more expensive laser transceivers.',
  },
  {
    question: 'Can I use singlemode transceivers with multimode fibre?',
    answer:
      'No. The laser beam from a singlemode transceiver would cause significant problems in multimode fibre. Always match transceiver type to fibre type. Mode-conditioning patch cords exist for specific legacy situations but are not a general solution.',
  },
  {
    question: 'Why does multimode fibre come in different grades (OM1-OM5)?',
    answer:
      'Each grade represents improved performance. OM1/OM2 are legacy grades. OM3/OM4 are laser-optimised for high-speed transmission. OM5 adds support for wavelength division multiplexing. Higher grades support faster speeds at longer distances.',
  },
  {
    question: 'What distance can I achieve with multimode vs singlemode?',
    answer:
      'At 10Gbps: OM3 reaches ~300m, OM4 reaches ~400m, while singlemode can reach 10km+. At higher speeds, multimode distances decrease significantly. Singlemode can span 40-80km with appropriate equipment.',
  },
  {
    question: 'How can I tell singlemode from multimode fibre?',
    answer:
      'Check the jacket colour (yellow typically = singlemode, orange/aqua = multimode) and markings. The cable should be labelled with fibre type (OS2, OM3, etc.). When in doubt, test with OTDR or verify documentation.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-4xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Singlemode:</strong> 9um core, one light path, long distance
              </li>
              <li>
                <strong>Multimode:</strong> 50/62.5um core, multiple paths, short distance
              </li>
              <li>
                <strong>Key:</strong> Never mix them in a link
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Yellow jacket:</strong> Singlemode
              </li>
              <li>
                <strong>Orange/Aqua jacket:</strong> Multimode
              </li>
              <li>
                <strong>&gt;500m?</strong> Use singlemode
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The term "mode" refers to a path that light can take through an optical fibre. The
              number of modes depends on the core diameter relative to the wavelength of light being
              used.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                Think of modes as different paths or "lanes" that light can travel. In a larger
                core, light can bounce at many different angles, creating multiple paths. In a tiny
                core, only one path is possible.
              </p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-sm text-white">
                  Core so small (9um) that only one mode propagates. Light travels in essentially a
                  straight line down the centre. No modal dispersion.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                In multimode fibre, light rays travelling straight down the centre arrive before
                rays bouncing off the sides (longer path). This time difference "spreads" the signal
                pulse, limiting how fast data can be sent and how far it can travel. Singlemode
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>OS1:</strong> Indoor, tight-buffered. Attenuation &lt;1.0 dB/km
                  </li>
                  <li>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-2">
                <li>
                  <strong>Distance &gt;500m?</strong> Singlemode (OS2) is the clear choice
                </li>
                <li>
                  <strong>Distance &lt;300m, 10G or less?</strong> Multimode (OM3/OM4) is
                  cost-effective
                </li>
                <li>
                  <strong>Data centre with 40G/100G?</strong> OM4 for short runs, singlemode for
                  longer
                </li>
                <li>
                  <strong>Maximum future-proofing?</strong> Singlemode handles any foreseeable speed
                </li>
                <li>
                  <strong>Budget is primary concern?</strong> Multimode transceivers cost less for
                  short links
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <ul className="text-sm text-white space-y-1 ml-4">
                    <li>
                      <strong>Yellow</strong> = Singlemode
                    </li>
                    <li>
                      <strong>Orange</strong> = Multimode (OM1/OM2)
                    </li>
                    <li>
                      <strong>Aqua</strong> = Multimode (OM3/OM4)
                    </li>
                    <li>
                      <strong>Lime</strong> = Multimode (OM5)
                    </li>
                  </ul>
                </div>
                <div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Mixing singlemode and multimode</strong> in a link
                </li>
                <li>
                  <strong>Using wrong transceivers</strong> for the fibre type
                </li>
                <li>
                  <strong>Installing OM1/OM2</strong> in new projects (use OM3/OM4 minimum)
                </li>
                <li>
                  <strong>Not verifying</strong> fibre type matches transceiver type
                </li>
                <li>
                  <strong>Assuming all orange cable</strong> is the same (OM1 vs OM2)
                </li>
              </ul>
            </div>
          </div>
