...
const InstrumentationModule6Section2 = () => {
  useSEO({
    ...
    description:
      'Learn about essential calibration equipment, reference standards, measurement traceability, and environmental factors affecting calibration accuracy.',
    keywords: [
    ...
    <div className="bg-background text-foreground">
      ...
      <div className="px-4 py-6 max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white">Module 6 · Section 2 · 18 min read</p>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <p className="text-white leading-relaxed">
              Accurate calibration depends entirely on the quality and traceability of the equipment
              used. Each measurement type requires specialised equipment designed to generate or
              measure precise reference values.
            </p>
                ...
                <div className="grid gap-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="ml-1">
                        Primary pressure standards using known masses on a piston to generate
                        precise pressure. Considered the gold standard for pressure calibration.
                      </span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="ml-1">
                        Portable electronic standards with built-in pressure generation. Ideal for
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="ml-1">
                        Pneumatic and hydraulic reference instruments for comparing gauge readings
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <span className="font-medium text-blue-400">
                        Hand Pumps and Vacuum Pumps:
                      </span>
                      <span className="ml-1">
                        Manual pressure generation for positive and negative pressure calibration in
                        the field.
                      </span>
                    </div>
                  </div>
                ...
                <div className="grid gap-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="ml-1">
                        Portable temperature sources with metal blocks that heat or cool to precise
                        temperatures. Fast stabilisation, minimal maintenance.
                      </span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="ml-1">
                        Liquid temperature references using oil or water. Better uniformity than dry
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="ml-1">
                        Generate electrical signals that simulate temperature sensor outputs.
                        Essential for testing control systems without actual temperature changes.
                      </span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="ml-1">
                        Precisely maintained 0°C reference using ice and water mixture. Simple but
                        highly accurate reference point.
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid gap-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="ml-1">
                        High-accuracy electrical measurement instruments with 6.5 to 8.5 digit
                        resolution for laboratory-grade measurements.
                      </span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="ml-1">
                        Versatile instruments capable of generating and measuring multiple signal
                        types (voltage, current, resistance, frequency).
                      </span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="ml-1">
                        Precision signal generators for calibrating 4-20mA loops and voltage-based
                        instruments.
                      </span>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <span className="ml-1">
                        Fixed or adjustable resistors with precisely known values for calibrating
                        ohmmeters and bridges.
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="space-y-6">
            <p className="text-white leading-relaxed">
              Traceability is the unbroken chain of calibrations linking a measurement to a stated
              reference, typically national or international standards. Each link in the chain has
              documented measurement uncertainty, ensuring measurements made anywhere in the world
              can be compared and trusted.
            </p>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                Without traceability, there is no guarantee that a measurement made in one location
                is equivalent to a measurement made elsewhere. Traceability provides confidence that
                a temperature reading of 100°C in London means the same as 100°C in Tokyo, enabling
                international trade, regulatory compliance, and scientific collaboration.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="space-y-6">
            <p className="text-white leading-relaxed">
              Measurement standards are organised in a hierarchy, with each level calibrated against
              the level above. This creates the traceability chain from your working instrument all
              the way to the SI units maintained by national laboratories.
            </p>
              ...
              <div className="space-y-3">
                <div className="bg-elec-yellow/20 border border-elec-yellow/40 rounded-lg p-3">
                  ...
                  <p className="text-white text-sm mt-1">
                    ...
                    Direct realisation of SI units with the lowest possible uncertainty. Used to
                ...
                <div className="bg-purple-500/20 border border-purple-500/40 rounded-lg p-3 ml-4">
                  ...
                  <p className="text-white text-sm mt-1">
                    Calibrated against primary standards. Used by commercial calibration
                    laboratories. UKAS-accredited laboratories maintain secondary standards with
                ...
                <div className="bg-blue-500/20 border border-blue-500/40 rounded-lg p-3 ml-8">
                  ...
                  <p className="text-white text-sm mt-1">
                    Used for day-to-day calibration work in industry. Calibrated against secondary
                    standards. Typically portable and ruggedised for field use. Also called transfer
                    standards.
                  </p>
                </div>
                ...
                <div className="bg-green-500/20 border border-green-500/40 rounded-lg p-3 ml-12">
                  <h4 className="font-semibold text-green-400 text-sm">
                    Level 4: Process Instruments
                  </h4>
                  <p className="text-white text-sm mt-1">
                    The instruments actually used for process control and measurement. Calibrated
                    against working standards. Require regular calibration to maintain accuracy
            ...
            <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                Each calibration step adds uncertainty. A primary standard might have ±0.001°C
                uncertainty. By the time you reach a working standard, uncertainty might be ±0.05°C,
                and the process instrument ±0.2°C. The calibration equipment must always have
                significantly lower uncertainty than the instrument being calibrated (typically 4:1
                ratio or better).
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <p className="text-white leading-relaxed">
              Environmental conditions significantly affect calibration accuracy. Professional
              calibration laboratories maintain strict environmental controls. Even field
              calibrations require awareness of these factors and appropriate corrections.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="space-y-6">
            <p className="text-white leading-relaxed">
              A calibration certificate is the official record of calibration. It must contain
              specific information to be valid and traceable. Understanding what should appear on a
              certificate helps identify fraudulent or incomplete documentation.
            </p>
        ...
        <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-500/30 rounded-lg p-4 mb-10">
          ...
          <p className="text-green-400 text-sm italic">
            The plant passes the audit successfully, maintaining their food safety certification and
            avoiding potential production shutdowns.
          </p>
        </div>
          ...
          <div className="space-y-4">
            <div className="bg-card/50 rounded-lg p-4 border border-border">
              ...
              <p className="text-white text-sm">
                The calibration standard should be at least 4 times more accurate than the
                instrument being calibrated. This ensures the uncertainty of the reference does not
                significantly affect the calibration result. For example, calibrating an instrument
                with ±1% accuracy requires a standard with at least ±0.25% accuracy.
              </p>
            </div>

            <div className="bg-card/50 rounded-lg p-4 border border-border">
              <h3 className="font-semibold text-white mb-2">
                Can I use non-UKAS calibrated equipment?
              </h3>
              <p className="text-white text-sm">
                Yes, but only where regulations do not require accredited calibration. Non-UKAS
                calibration may be acceptable for non-critical measurements or internal quality
                checks. However, regulated industries (food, pharmaceutical, aerospace) typically
                require UKAS-traceable calibration for legal compliance.
              </p>
            </div>
            ...
            <div className="bg-card/50 rounded-lg p-4 border border-border">
              ...
              <p className="text-white text-sm">
                Working standards typically require annual recalibration, though this depends on
                usage frequency, stability, and regulatory requirements. Equipment showing drift,
                damage, or out-of-tolerance readings should be recalibrated immediately regardless
                of schedule.
              </p>
            </div>
            ...
            <div className="bg-card/50 rounded-lg p-4 border border-border">
              ...
              <p className="text-white text-sm">
                Calibration is the process of comparing an instrument to a standard and recording
                the differences. Adjustment is the physical act of correcting the instrument to read
                correctly. Calibration certificates should record as-found readings before any
                adjustment, then as-left readings after adjustment if performed.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4 pt-6 border-t border-border">
          <Link
            to="/electrician/upskilling/instrumentation-module-6-section-1"
