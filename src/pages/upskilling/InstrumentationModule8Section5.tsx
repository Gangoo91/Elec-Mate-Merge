...
const DESCRIPTION =
  'Learn professional fault documentation and service report writing for instrumentation systems, including templates, best practices, and compliance requirements.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'It makes the finished service report look more professional to clients',
      'It is a strict mandatory requirement of every insurance policy',
      'It increases the number of billable hours charged for the job',
    ],
    correctAnswer: 0,
  },
  {
    ...
    options: [
      'To make each individual report noticeably longer',
      'Because management simply insists on using them',
      'To ensure consistent information capture across all technicians',
      'To reduce the amount of thinking required on each job',
    ],
    correctAnswer: 2,
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      'They make the finished report look more professional to clients',
      'They are required by law in every single case without exception',
      'They prove the fault existed and verify the repair was successful',
      'They increase the overall cost that can be charged for the service',
    ],
    correctAnswer: 2,
    explanation:
      'Before-and-after readings provide evidence that a fault existed and demonstrate that the repair was successful, creating accountability and verification of work quality.',
  },
  {
    id: 'im8s5-q2',
    question: 'What should every service report include?',
    options: [
      'Device ID, date and time, technician, fault, actions, and verification',
      'Only the final result and overall outcome of the completed repair work',
      'Just the part numbers of the individual components that were replaced',
      'Only photographs of the affected equipment taken before and after work',
    ],
    correctAnswer: 0,
    explanation:
      'Every service report should include device identification, timestamps, technician details, fault description, actions taken, and verification results to ensure complete documentation.',
  },
  {
    id: 'im8s5-q3',
    question: 'How can reports help identify trends?',
    options: [
      'Reports cannot reveal any trends at all on their own',
      'Only when each individual report is extremely detailed',
      'By comparing the labour cost charged for each separate job',
      'By reviewing multiple reports over time to spot recurring patterns',
    ],
    correctAnswer: 3,
    explanation:
      "Reviewing multiple reports over time reveals patterns like recurring failure modes, environmental factors, or design weaknesses that aren't apparent from individual incidents.",
  },
  {
    id: 'im8s5-q4',
    question: "What's the benefit of using a template?",
    options: [
      'It mainly makes the finished report look more professional to clients',
      'It ensures consistent capture of mandatory information across technicians',
      'It is always quicker for a technician to fill in and complete',
      'It reduces the total amount of paper used out on site each day',
    ],
    correctAnswer: 1,
    explanation:
      'Templates ensure consistent information capture across all technicians, guarantee mandatory fields are completed, and create standardised formats that support quality control and database integration.',
  },
  {
    id: 'im8s5-q5',
    question: 'Why attach photos or test data?',
    options: [
      'To make the finished report longer overall',
      'To impress management with the thoroughness of the work',
      'To provide visual evidence and support future diagnostics',
      'Because the camera equipment was an expensive investment',
    ],
    correctAnswer: 2,
    explanation:
      'Photos and test data provide visual evidence of faults, document repair quality, support warranty claims, and give future technicians actual measurements and visual references for similar problems.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Detailed enough that another technician could understand what happened without asking questions. Include symptoms, when and how the fault was discovered, duration, frequency (intermittent or continuous), and impact on operations.',
  },
  {
    question: "What if I don't have time for detailed documentation?",
    answer:
      'Use voice recording or quick notes during the job, then complete the formal report immediately after. Templates speed up the process significantly. Poor documentation costs more time in the long run when faults recur or warranty claims fail.',
  },
  {
    question: 'Should I document even minor repairs?',
    answer:
      'Yes. Minor repairs today can indicate developing problems. A pattern of minor issues on the same equipment often predicts major failure. This data is also valuable for maintenance planning and budgeting.',
  },
  {
    question: 'How long should I keep service reports?',
    answer:
      "Follow your organisation's retention policy, but typically 7-10 years minimum for compliance purposes. Many organisations keep records for the entire asset lifecycle. Electronic systems make long-term storage practical and searchable.",
  },
];
      ...
      <div className="px-4 pb-24 max-w-4xl mx-auto">
          ...
          <div className="bg-card/30 rounded-lg p-4 space-y-3">
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-300 text-sm">
                Know what should be included in a fault report
              </p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-elec-yellow/20 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <p className="text-gray-300 text-sm">
                Learn the value of clear, professional documentation
              </p>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 rounded-full bg-elec-yellow/20 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <p className="text-gray-300 text-sm">
                Link documentation to maintenance and compliance
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              Good fault documentation supports future diagnostics, proves compliance, and creates a
              knowledge base. Professional documentation transforms individual fault-finding
              experiences into organisational knowledge.
            </p>
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 text-gray-300">
            <p>
              Using templates ensures consistency across all technicians and guarantees that
              critical information is never overlooked.
            </p>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-gray-400 text-xs mt-1">
                    Tag Number: _______ Location: _______
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-xs mt-1">
                    [ ] Calibrated [ ] Cleaned [ ] Replaced [ ] Repaired
                  </p>
                </div>
                <div>
                  <p className="text-elec-yellow text-xs font-medium">VERIFICATION</p>
                  <p className="text-gray-400 text-xs mt-1">
                    Technician Sign: _______ Date: _______
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mb-8">
          ...
          <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/30 rounded-lg p-4">
            ...
            <p className="text-gray-300 text-sm mb-4">
              ...
              reviews past service logs and discovers a recurring moisture issue affecting multiple
              assets, prompting a systematic design upgrade.
            </p>
            <div className="space-y-2 mb-4">
              ...
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm text-gray-300">
                  Common thread: moisture-related failures in similar locations
                </p>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-blue-400 font-mono text-xs">3</span>
                <p className="text-sm text-gray-300">
                  Root cause: poor drainage around junction boxes
                </p>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-blue-400 font-mono text-xs">4</span>
                <p className="text-sm text-gray-300">
                  Cost of reactive repairs: GBP12,000 over 6 months
                </p>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-blue-400 font-mono text-xs">5</span>
                <p className="text-sm text-gray-300">
                  Solution: upgraded IP rating and improved drainage
                </p>
              </div>
            </div>
            <div className="bg-green-500/10 border border-green-500/30 rounded p-3">
              ...
              <p className="text-gray-300 text-sm">
                The systematic documentation allowed the team to identify a design weakness that
                wasn't obvious from individual failures. The GBP8,000 upgrade investment eliminated
                future moisture-related failures, saving an estimated GBP24,000 annually in
                maintenance costs.
              </p>
            </div>
          </div>
        ...
        {/* Quiz Section */}
        <div className="mb-12">
          <Quiz title="Section 8.5 Knowledge Check" questions={quizQuestions} />
        </div>

        {/* Bottom Navigation */}
        <div className="flex justify-between items-center pt-8 border-t border-white/10">
          <Link to="/electrician/upskilling/instrumentation-module-8-section-4">
            <Button
              variant="outline"
          ...
          <Link to="/electrician/upskilling/instrumentation-module-8-section-6">
