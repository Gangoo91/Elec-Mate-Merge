...
const DESCRIPTION =
  'Learn professional fire alarm servicing procedures, preventive maintenance schedules and parts replacement per BS 5839-1.';
    ...
    () => [
      {
        ...
        correctAnswer: 1,
        explanation:
          'Fire alarm service engineers should hold FIA (Fire Industry Association) or equivalent competency certification demonstrating fire alarm specific knowledge and skills.',
      },
      {
        id: 2,
        question:
          'How often should a routine service visit be scheduled for most commercial premises?',
        options: ['Monthly', 'Quarterly', 'Six-monthly', 'Annually only'],
        correctAnswer: 2,
        explanation:
          'BS 5839-1 recommends six-monthly service visits for most commercial premises, with some high-risk premises requiring quarterly visits.',
      },
      {
        id: 3,
        question: 'What is the typical recommended replacement interval for smoke detectors?',
        options: ['5 years', '8-10 years', '15 years', 'Only when they fail testing'],
        correctAnswer: 1,
        explanation:
          'Smoke detectors should typically be replaced every 8-10 years due to sensor degradation, regardless of testing performance.',
      },
      {
        id: 4,
        ...
        correctAnswer: 1,
        explanation:
          'Always notify the monitoring station before maintenance to prevent false alarms. Implement fire watch procedures if the system will be impaired.',
      },
      {
        id: 5,
        ...
        correctAnswer: 1,
        explanation:
          'Cleaning removes dust, insects, and contamination that can cause false alarms or reduce detector sensitivity to real smoke.',
      },
      {
        id: 6,
        ...
        correctAnswer: 2,
        explanation:
          'Replace batteries when capacity testing shows inadequate performance or every 3-5 years as preventive maintenance, whichever comes first.',
      },
      {
        id: 7,
        ...
        correctAnswer: 1,
        explanation:
          'A comprehensive service report documenting all tests performed, findings, defects, and recommendations must be provided after every visit.',
      },
      {
        id: 8,
        ...
        correctAnswer: 2,
        explanation:
          'Cable damage compromises system integrity. Repair or replace damaged sections immediately and document all remedial work undertaken.',
      },
      {
        id: 9,
        ...
        correctAnswer: 1,
        explanation:
          'MCPs require testing for correct operation, cleaning of electrical contacts, and verification of LED indicators during service visits.',
      },
      {
        id: 10,
        question:
          'What action is required if a service engineer identifies a critical safety defect?',
        options: [
        ...
        correctAnswer: 2,
        explanation:
          'Critical safety defects require immediate notification to the responsible person with temporary protective measures implemented before leaving site.',
      },
    ],
    []
  );
      ...
      <div className="px-4 sm:px-6 py-6 max-w-3xl mx-auto space-y-8">
        ...
        <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <ul className="space-y-2 text-white/80 text-sm">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong className="text-white">Service visits</strong> should occur six-monthly for
                most premises, quarterly for high-risk
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Preventive maintenance</strong> includes detector
                cleaning, battery testing, and cable inspections
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Component replacement</strong> schedules prevent
                failures - smoke detectors every 8-10 years
              </span>
            </li>
          </ul>
        </div>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 text-white/70">
              <p>
                ...
                maintenance whilst minimising disruption to building operations.
              </p>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    High-risk premises: Quarterly visits
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Sleeping accommodation: Enhanced frequency
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Complex systems: May require additional visits
                  </li>
                </ul>
              </div>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 text-white/70">
              <p>
                ...
                to ensure safety and prevent false alarms.
              </p>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Inform building management and occupants
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Implement fire watch if system will be disabled
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Review previous service reports and logbook
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Prepare required tools and replacement parts
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
                <p className="text-sm text-orange-300 flex items-start gap-2">
                  ...
                  Never disable a fire alarm system without implementing appropriate fire safety
                  measures.
                </p>
              </div>
            </div>
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 text-white/70">
              <p>
                ...
                sensitivity and prevent false alarms.
              </p>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Clean chamber using approved methods (vacuum/air)
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Verify secure mounting and correct orientation
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Functional test using approved test equipment
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Record sensitivity readings on addressable systems
                  </li>
                </ul>
              </div>
              <p className="text-sm text-white/60 italic">
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-4 text-white/70">
              <p>
                ...
                mains failure. Regular testing ensures adequate capacity.
              </p>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Measure float voltage (typically 13.5-13.8V for 12V)
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Load test to verify adequate capacity annually
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Check charger output current and voltage
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
            ...
            <div className="space-y-4 text-white/70">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Standby batteries: 3-5 years
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Control panel: 15-20 years (consider upgrade)
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    MCP glasses: As required after activation
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/30">
            ...
            <div className="space-y-4 text-white/70">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Date, time, and engineer details
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Tests performed and devices checked
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Defects found with severity classification
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Remedial work completed during visit
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
                    Outstanding recommendations and timescales
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-elec-yellow" />
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
            ...
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-sm text-white/70">
                ...
                findings and actions in the service report.
              </p>
            </div>
          </div>
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
            ...
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-sm text-white/70">
                ...
                account for this gradual degradation that standard testing may not detect.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              {
                q: 'Can the building owner perform their own maintenance?',
                a: 'Weekly tests can be conducted by trained staff, but formal service visits must be performed by competent fire alarm engineers.',
              },
              {
                q: 'What if a detector type is obsolete?',
                a: 'Source compatible replacements from the manufacturer or approved suppliers. System upgrade may be required if components are no longer available.',
              },
              {
                q: 'How long should a typical service visit take?',
                a: 'Duration varies by system size. Allow approximately 2-4 hours for small systems, longer for large or complex installations.',
              },
              {
                q: 'Should I clean detectors during every visit?',
                a: 'Visual inspection every visit, thorough cleaning annually or when contamination is identified. Some environments may need more frequent cleaning.',
              },
              {
                q: 'What qualifications should service engineers hold?',
                a: 'FIA or equivalent competency certification, manufacturer training for specific systems, and appropriate health and safety qualifications.',
              },
              {
                q: 'Can service intervals be extended if no faults are found?',
                a: 'No - BS 5839-1 service intervals are based on proactive maintenance principles. Consistent fault-free results indicate good maintenance, not reduced need.',
              },
            ].map((faq, i) => (
