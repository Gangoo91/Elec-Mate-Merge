...
const FireAlarmModule6Section2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 6 · Section 2" title="Servicing and maintenance" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS 5839-1:2025 reframes servicing through three load-bearing definitions: who counts as a
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Necessary instructions.</strong> The specific manufacturer's product manuals,
              the system's as-installed documentation, the cause-and-effect matrix, the
              site-specific risk assessment. Without these, the engineer is improvising on the day.
            </li>
            <li>
              <strong>CPD.</strong> Annual training updates, attendance at standards-update seminars
              (BS 5839-1:2025 introduction events being a current example), manufacturer-product
              update briefings. Recorded by the employer; produced on request.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              provided with the necessary instructions, to enable the required task(s) to be carried
              out correctly. NOTE: Maintenance of competence is likely to require continuing
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Compliance status of historic visits.</strong> A 2024 visit at the 6-month + 3
              weeks mark was technically non-compliant on the strict 2017 reading. Under 2025 it
            ...
            <li>
              ...
              the previous visit date. This prevents drift if successive visits happen to each slip
              by a few days — without a fixed datum, eight or ten cycles can compound into months of
              slippage. The datum keeps the schedule pinned to the original anniversary.
            </li>
            <li>
              <strong>Outside the window remains non-compliant.</strong> A visit at four months and
              three weeks is too early; a visit at seven months and one week is too late. Both
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="430" y="44" textAnchor="middle" fill="#FBBF24" fontSize="13" fontWeight="bold">
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Panel visual inspection</strong> — confirm normal status. Check for any zones
              / outputs disabled. Check the date / time clock and adjust as necessary (load-bearing
              for day / night sensitivity logic). Inspect battery condition and connections. Inspect
              any configuration changes against the as-commissioned baseline.
            </li>
            <li>
              ...
              tested and the outcome. Use manufacturer-approved test methods (canned test smoke for
              smoke detectors; electrical test pulse for heat detectors; mechanical operation for
              MCPs; cause-and-effect verification for interfaces).
            </li>
            <li>
            ...
            <li>
              <strong>Briefing + report</strong> — meet with the responsible person before leaving.
              Walk them through the report, the asset register update, the open defects, the
              conformity statement. Have them sign the logbook entry. Agree the next visit window.
            </li>
          </ol>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              the system, this should be kept to a practicable minimum, and the premises management
              or their appointed representative should be informed of the areas affected. This also
              applies to disablement of sounders or visual alarms.
            </>
          }
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              present and legible. (BS 5839-1:2025 explicitly acknowledges the long-standing custom
              of marker-pen labelling.) If no label exists, add one with the install date as
              inferred from the asset register; if the date is more than four years back, raise
              replacement.
            </li>
            <li>
              ...
              Significantly high (above ~14.0 V) suggests a charger overcharging — a separate fault
              to investigate, but the battery is also being shortened in life.
            </li>
            <li>
              <strong>Load-test evidence.</strong> Two methods. First, initiate the panel's built-in
              battery test (most modern CIEs run a brief discharge into a known load and infer
              back-up capacity). Record the result. Second, on systems where the built-in test is
              inadequate (older panels) perform an off-line load test with a constant-current load
              and a stopwatch — discharge a percentage of the battery capacity and confirm the
              discharge curve is consistent with rated capacity. The result is compared to the
              design back-up duration recorded in the as-commissioned documentation.
            </li>
          </ol>
          <p>
            Replacement at design life — typically four years for sealed lead-acid — is planned into
            the service contract. The four-year mark is conservative for many environments but ages
            quickly in hot panel locations or where the panel cycles frequently. Any indication of
            trending performance decline should bring the replacement forward. Replacement is
            documented (model, capacity, install date, fitter's name, removed battery disposal) and
            the new installation-date label is fitted.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              Read the level for every detector tested at this visit. Record in the asset register.
              Detectors above the manufacturer threshold (often 70-80%) are flagged for clean or
              replace at this visit.
            </li>
            <li>
              <strong>Clean per manufacturer procedure.</strong> Most modern detectors have a
              specific clean process — either an in-place gentle vacuum / canned-air procedure, or a
              head-removal-and-clean procedure. Some are non-cleanable and the maintenance action is
              replacement.
            </li>
            <li>
            ...
            <li>
              ...
              not cleaned, post-clean contamination level, sensitivity OK / drift / replaced. Trend
              the data — detectors that re-contaminate quickly are in the wrong location for their
              type and may need design review.
            </li>
            <li>
              <strong>End-of-life replacement.</strong> Manufacturer-specified detector replacement
              intervals (often 10 years from manufacture) are observed regardless of cleanability.
              The asset register tracks the install date for every detector; the planning system
              flags replacement-due in advance.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              ports. The first defence is preventing a casual physical connection by an unauthorised
              person.
            </li>
            <li>
              <strong>Authentication of remote-access requests</strong> — the CIE or its gateway
              should authenticate any request to accept a remote connection. Default passwords must
              be changed at commissioning. Two-factor authentication where the product supports it.
              Connection-request logs reviewed at each service visit.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              any risk that the remote service might compromise the correct functioning of the CIE,
              the responsible individual must ensure that the system is fully operational upon
              completion of the remote service.
            </>
          }
        ...
        <FAQ
          items={[
            ...
            {
              question: 'How is "datum = acceptance date" different from "datum = previous visit"?',
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-6/section-3')}
