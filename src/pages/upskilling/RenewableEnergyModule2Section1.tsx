...
const RenewableEnergyModule2Section1 = () => {
  useSEO({
    ...
    description:
      'Understanding monocrystalline, polycrystalline, and thin-film photovoltaic panel technologies and their characteristics.',
  });
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 2,
      explanation:
        'Monocrystalline panels offer the highest commercially available efficiency at 18-22%.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Polycrystalline panels have a distinctive bluish hue with visible grain patterns from multiple silicon crystals.',
    },
    {
      question: 'What is the temperature coefficient for thin-film panels?',
      options: [
        '-0.4% to -0.5% per degree C',
        '-0.45% to -0.5% per degree C',
        '-0.25% to -0.4% per degree C',
        '-0.1% to -0.2% per degree C',
      ],
      correctAnswer: 2,
      explanation:
        'Thin-film panels have the best temperature coefficient at -0.25% to -0.4% per degree C, meaning better high-temperature performance.',
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'CIGS (Copper Indium Gallium Selenide) offers the highest thin-film efficiency at 10-12%.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Monocrystalline panels have excellent degradation rates of 0.4-0.5% per year, maintaining performance longest.',
    },
    {
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'PERC (Passivated Emitter Rear Cell) technology has 80%+ market adoption with minimal cost premium.',
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'Bifacial panels have a bifaciality factor of 70-95%, meaning rear-side efficiency is 70-95% of front-side.',
    },
    {
      ...
      options: [
        ...
        'CE marking only',
        'UL certification only',
      ],
      correctAnswer: 1,
      explanation:
        'IEC 61215 (performance) and IEC 61730 (safety) are the key international standards for PV panel quality.',
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'Most quality panels offer performance warranties guaranteeing 80% output after 25 years.',
    },
  ];
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 pb-24">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            <p>
              ...
              very dark blue colour with uniform appearance and rounded corners.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Efficiency:</strong> 18-22% (highest)
                  </li>
                  <li>
                    • <strong className="text-white">Temp coefficient:</strong> -0.4% to -0.5%/°C
                  </li>
                  <li>
                    • <strong className="text-white">Lifespan:</strong> 25-30 years
                  </li>
                  <li>
                    • <strong className="text-white">Degradation:</strong> 0.4-0.5%/year
                  </li>
                </ul>
              </div>
            ...
            <p>
              <strong className="text-white">Best suited for:</strong> Limited roof space, premium
              residential installations, and applications where space efficiency matters more than
              upfront cost.
            </p>
          </div>
        </div>
        ...
        <div className="mb-8 mt-8">
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            <p>
              ...
              with visible grain patterns and square cells with sharp corners.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <h4 className="text-white font-medium mb-2">Key Characteristics</h4>
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Efficiency:</strong> 15-18%
                  </li>
                  <li>
                    • <strong className="text-white">Temp coefficient:</strong> -0.45% to -0.5%/°C
                  </li>
                  <li>
                    • <strong className="text-white">Manufacturing:</strong> Less energy-intensive
                  </li>
                  <li>
                    • <strong className="text-white">Degradation:</strong> 0.5-0.6%/year
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            ...
            <p>
              <strong className="text-white">Best suited for:</strong> Budget-conscious residential
              installations, projects with ample roof space, and applications where upfront cost is
              the primary concern.
            </p>
          </div>
        </div>
        ...
        <div className="mb-8 mt-8">
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <ul className="text-sm space-y-1">
                <li>
                  • <strong className="text-white">Flexible and lightweight:</strong> Suitable for
                  unconventional installations
                </li>
                <li>
                  • <strong className="text-white">Better in diffuse light:</strong> Maintains
                  output in cloudy conditions
                </li>
                <li>
                  • <strong className="text-white">Lower temperature coefficient:</strong> Better
                  high-temperature performance
                </li>
                <li>
                  • <strong className="text-white">Aesthetic options:</strong> Can be integrated
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <p className="text-elec-yellow text-xs mt-2">
                  Lower = better long-term performance
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">IEC 61215/61730:</strong> Key certifications
                  </li>
                  <li>
                    • <strong className="text-white">Flash test results:</strong> Power accuracy
                  </li>
                  <li>
                    • <strong className="text-white">Visual inspection:</strong> Cell/solder quality
                  </li>
                  <li>
                    • <strong className="text-white">Mechanical testing:</strong> Hail/wind rated
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Product:</strong> 10-25 years materials
                  </li>
                  <li>
                    • <strong className="text-white">Performance:</strong> 80% after 25 years
                  </li>
                  <li>
                    • <strong className="text-white">Linear:</strong> ≤0.6%/year degradation
                  </li>
                  <li>
                    • <strong className="text-white">Tier 1:</strong> Bankable manufacturers
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="mb-8 p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/30">
          ...
          <div className="space-y-2 text-white/80 text-sm">
            ...
            <p>
              <strong className="text-white">Budget-conscious residential:</strong> Polycrystalline
              - best balance of cost and performance
            </p>
            <p>
              <strong className="text-white">Hot climate installations:</strong> Thin film - better
              temperature coefficient
            </p>
            <p>
              <strong className="text-white">Flexible/curved surfaces:</strong> Thin film - flexible
              substrate options
            </p>
            <p>
              <strong className="text-white">Utility-scale projects:</strong> Monocrystalline -
              lowest levelised cost of energy
            </p>
          </div>
        </div>
