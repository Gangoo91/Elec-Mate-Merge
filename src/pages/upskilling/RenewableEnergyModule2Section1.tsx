...
const inlineChecks = [
  {
    ...
    question: 'What actually happens in a PV cell when sunlight hits it?',
    options: [
  ...
  },
  {
    ...
    question: 'What sets the short-circuit current (I_sc) of a PV cell?',
    options: [
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'Why does PV efficiency NOT improve when the cell heats up — and in fact reduces?',
    options: [
  ...
  {
    id: 4,
    question: 'PV cell I_sc scales roughly proportionally with what?',
    options: [
...
const faqs = [
  {
    question: "How does the photovoltaic effect actually work — what's happening in the silicon?",
    answer:
  ...
  {
    question: 'Why is silicon the dominant PV material — what makes it special?',
    answer:
  ...
  {
    question: 'What is "fill factor" on a PV cell datasheet?',
    answer:
  ...
  {
    question: 'Bypass diodes are mentioned in PV module context — what do they do?',
    answer:
  ...
  {
    question: 'How does BS EN 61730 relate to PV module specification?',
    answer:
  ...
  {
    question: 'Half-cell and shingled-cell modules are appearing on UK datasheets — what are they?',
    answer:
...
export default function RenewableEnergyModule2Section1() {
  ...
  useSEO({
    title: 'Cells — the photovoltaic effect | Renewable Energy 2.1 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 1 · BS 7671:2018+A4:2026"
        title="Cells — the photovoltaic effect"
        backTo="../renewable-energy-module-2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The silicon physics, p-n junction and photovoltaic effect that turns a photon into
          current. Cell types and their trade-offs. The BS 7671 framing of PV cells as generating
          sets.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Photon arrives</strong> — a particle of light carrying
              energy proportional to its wavelength (red ~1.8 eV, green ~2.3 eV, blue ~2.7 eV,
              ultraviolet higher)
            </li>
            <li>
              <strong className="text-white">Energy transfer</strong> — if the photon energy exceeds
              the silicon band gap (~1.1 eV), it can free an electron from its covalent bond in the
              silicon lattice
            </li>
            <li>
              <strong className="text-white">Electron-hole pair created</strong> — the freed
              electron leaves a "hole" (the absence of an electron) behind
            </li>
            <li>
              <strong className="text-white">Separation at the junction</strong> — the p-n
              junction\'s built-in electric field drives the electron one way (to the n-side) and
              the hole the other (to the p-side)
            </li>
            <li>
              <strong className="text-white">Voltage and current</strong> — separated charges
              accumulate at the cell\'s terminals as a voltage; connecting an external circuit lets
              the electrons flow back to recombine with the holes, producing current
            </li>
          </ul>
          <p>
            No moving parts. No thermal intermediate. The cell operates by quantum mechanics, which
            is why its efficiency does not improve with temperature — in fact the opposite.
          </p>
        </ConceptBlock>

        <PvCellCrossSection caption="The photovoltaic effect in a crystalline silicon cell: a photon frees an electron in the depletion region (the p–n junction), and the built-in electric field drives the electron to the n-side and the hole to the p-side — producing a DC current." />
        ...
        <Pullquote>
          The cell voltage is set by physics. The cell current is set by sunlight.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">V_oc (open-circuit voltage)</strong> — the voltage
              produced when no current is drawn. For crystalline silicon at STC, ~0.5–0.6 V per
              cell. Set by the silicon band gap and junction physics — independent of cell size.
            </li>
            <li>
              <strong className="text-white">I_sc (short-circuit current)</strong> — the current
              produced when the cell terminals are shorted. For a 156×156 mm crystalline silicon
              cell at STC (1000 W/m²), ~9–10 A. Roughly proportional to irradiance and active cell
              area.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              Half-cell modules: same V_oc per cell, twice the cell count for the same module area,
              similar V_oc total
            </li>
          </ul>
          <p>
            The DC string voltage of an installed system (~400–600 V typical for residential, &gt;
            1000 V for utility-scale) is set by how many modules are wired in series at the string
            level — module-level design covered in Section 2.2, string-level in Section 2.3.
          </p>
        </ConceptBlock>

        <IVCurve caption="The I-V curve at STC. The maximum power point (MPP) sits at the knee; the fill factor is the ratio of the MPP rectangle to the V_oc × I_sc rectangle. Across irradiance (1000 / 500 / 250 W/m²), I_sc scales roughly linearly while V_oc changes only logarithmically." />
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Monocrystalline silicon</strong> — grown from a single
              silicon crystal via the Czochralski process. Highest commercial efficiency (~20–22% at
              module level). Premium price. Dark-grey / black appearance. The default for high-yield
              residential installs.
            </li>
            <li>
              <strong className="text-white">Polycrystalline silicon</strong> — cast from multiple
              silicon crystals in a mould. Efficiency ~17–19%. Lower price than mono. Identifiable
              by the &ldquo;blue speckled&rdquo; grain appearance from the crystal boundaries.
              Common on cost-driven installs.
            </li>
            <li>
              <strong className="text-white">Amorphous silicon thin-film</strong> — vapour-deposited
              silicon, no crystalline structure. Efficiency ~8–10% (lower than crystalline). Lower
              temperature coefficient (better hot-weather performance per nameplate). Better
              partial-shade tolerance. Form-factor flexibility (can be deposited on flexible
              substrates, walkable surfaces, curved architectural elements).
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              ...
              technology with ~14–18% module efficiency. Lower cost per W than crystalline. Some
              environmental concerns around cadmium content (managed via end-of-life recycling
              programs by the manufacturers).
            </li>
            <li>
              <strong className="text-white">CIGS (copper indium gallium selenide)</strong> —
              thin-film with module efficiency ~13–16%. Excellent low-light performance. Smaller
              market share than CdTe or amorphous.
            </li>
          </ul>
          <p>At the research-to-commercial boundary:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Perovskite cells</strong> — lab efficiency above 25%
              with low-cost manufacturing potential. Durability is the remaining barrier; early
              perovskite cells degraded rapidly under moisture and UV. Several manufacturers
              reaching MCS Product List eligibility in early 2026.
            </li>
            <li>
              <strong className="text-white">Perovskite-silicon tandem cells</strong> — using
              perovskite to capture wavelengths silicon is less efficient at. Lab efficiencies above
              33%. Expected to be mainstream by ~2030.
            </li>
          </ul>
        </ConceptBlock>

        <CellTypeComparison caption="Monocrystalline, polycrystalline and amorphous thin-film compared on efficiency, temperature coefficient, cost per watt and typical application — with perovskite-silicon tandem flagged as the emerging technology." />
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">P_max (power)</strong> — typically -0.3 to -0.5%/°C for
              crystalline silicon. The most operationally important number — drives the energy-yield
              derate.
            </li>
            <li>
              <strong className="text-white">V_oc (open-circuit voltage)</strong> — typically -0.3
              to -0.4%/°C. Critical for cold-day V_oc calculations — a winter morning at -5°C can
              produce V_oc above STC by 10–15%.
            </li>
            <li>
              <strong className="text-white">I_sc (short-circuit current)</strong> — typically +0.04
              to +0.06%/°C (slightly positive). Current rises slightly with temperature, but the
              V_oc loss dominates.
            </li>
          </ul>
          <p>
            Amorphous and thin-film cells have lower temperature coefficients (typically -0.2 to
            -0.3%/°C for P_max) — meaning they suffer less power loss at hot operating temperatures.
            This partly offsets their lower nameplate efficiency on hot-climate or hot-roof
            applications.
          </p>
          <p>The two practical design impacts:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Cold-day V_oc</strong> — the string V_oc on a cold
              winter morning may exceed the STC V_oc by 10–15%. Sizing a string against the STC V_oc
              without applying the cold-day calculation can put the string voltage above the
              inverter\'s maximum input voltage — a common design error.
            </li>
            <li>
              <strong className="text-white">Hot-day power</strong> — the operating- conditions
              P_max is materially below STC. Annual yield calculations apply a performance ratio
              (typically 0.75–0.85) to lump in this and other losses.
            </li>
          </ul>
        </ConceptBlock>

        <PvTemperatureCurve caption="P-V curves at 25 °C (STC), 50 °C and 75 °C — maximum power falls visibly as cell temperature rises, which is why a 70–100 mm standoff for natural-convection cooling matters on a UK roof." />

        <TempDerationFigure caption="A 400 W module at STC with a P_max coefficient of −0.36 %/°C, running at 55 °C on a UK summer roof: (55 − 25) °C × −0.36 %/°C × 400 W = −43 W, so real output ≈ 357 W — the gap between the nameplate and the roof." />
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">
                PV arrays or modules used as the electrical energy source
              </strong>{' '}
              are considered generating sets within Section 551\'s scope
            </li>
            <li>
              <strong className="text-white">Section 551.7.1(c)</strong> applies — a bidirectional
              protective device where energy flow is bidirectional (the A4:2026 requirement)
            </li>
            <li>
              <strong className="text-white">Section 551.7.2.1</strong> applies — the generating set
              on the supply side of all protective devices
            </li>
            <li>
          ...
          <p>
            Section 712 then applies the PV-specific particular requirements on top — the prohibited
            protective measures (712.410.3.5 / .6), the permitted double or reinforced insulation
            (712.412), the PV string protection rules (712.431). Module 2 Section 3 covers
            string-level protection in detail.
          </p>
          <p>
            At the cell / module level, BS EN 61730 is the product safety standard (Part 1
            construction, Part 2 testing). Module datasheets and the MCS Product List (MPS 010)
            reference BS EN 61730 conformity. For an MCS-funded install, the module must be on the
            MCS Product List AND should carry BS EN 61730 conformity — the two layers are
            complementary.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">STC (Standard Test Conditions)</strong> — 1000 W/m²
              irradiance, 25°C cell temperature, AM 1.5 spectrum. The laboratory reference under IEC
              60904. Module datasheets quote P_max, V_oc, I_sc, V_mp, I_mp at STC.
            </li>
            <li>
              <strong className="text-white">NOCT (Nominal Operating Cell Temperature)</strong> —
              typically ~45–48°C. The cell temperature reached at 800 W/m² irradiance with 20°C
              ambient and 1 m/s wind. A more realistic operating reference for UK conditions.
            </li>
            <li>
              <strong className="text-white">AM 1.5</strong> — Air Mass 1.5, the standard reference
              spectrum representing sunlight after passing through 1.5 atmosphere-equivalents (sun
              ~48° from zenith). AM 1.5G includes diffuse light; AM 1.5D is direct only. Terrestrial
              PV testing uses AM 1.5G.
            </li>
          </ul>
          <p>
            MCS MIS 3002 design pack requirements include the derated performance calculation — STC
            nameplate × performance ratio (typically 0.75–0.85) accounts for temperature, soiling,
            mismatch, inverter losses and cable losses against actual local irradiance. The cert
            evidence bundle includes the design calculation back-up.
          </p>
        </ConceptBlock>
        ...
        >
          <p>The 19th Edition\'s expected direction for PV-related content:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              Consolidation of the scattered LCT chapters into a coherent Part 7 LCT framework
            </li>
            <li>Deeper integration with the international BS EN 60364 series</li>
            <li>
              Possible expansion of Chapter 82 PEI requirements covering the hybrid-system case
            </li>
            <li>
              Continued recordkeeping trajectory — design-time decisions on PV string topology,
              inverter selection and PEI architecture made recordable on the cert
            </li>
          </ul>
          <p>
            Cell-level physics is not regulatory territory and will not change. What may change: how
            the chapter map names and locates the PV-related rules. The installer who learns the
            current map cleanly can re-map to the consolidated framework with minimal rework.
          </p>
        </ConceptBlock>
