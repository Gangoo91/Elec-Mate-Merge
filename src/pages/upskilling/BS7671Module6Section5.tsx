    ...
    <HubPage>
      ...
      <HubBody>
        <div className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'The errors that destroy certs and the careers behind them — wrong code, missing schedules, no measured Ze, undocumented departures, wrong system arrangement, inherited non-compliances, and the PI exposure each one carries.'
          }
        </div>
        ...
        >
          <p>
            Reg 644.1 makes the EIC the primary record of initial verification. Reg 651.1 makes the
            EICR the primary record of in-service condition. Both regulations require the schedule
            of inspection and the schedule of test results to accompany the cert as integral parts
            of the document set. The cert is signed by the designer, constructor and inspector —
            each signature is a personal declaration that the named person has discharged the duty
            for that role. Reg 134.1.1 separately requires that good workmanship and proper
            materials be used. Together these regulations establish that the cert is not a receipt
            for work done; it is a sworn statement of compliance.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 644.1 calls out both schedules as part of the certified document set. A common error
            is to record the test results on the schedule but leave the schedule of inspection
            partially blank — or vice versa. Both schedules are mandatory; both must be completed;
            both must be attached to the EIC delivered to the customer. The new A4:2026 cert form
            adds new columns to the schedule of test results (RCD functionality, AFDD presence,
            EV-charging-circuit identification, surge protection status) — these must be completed
            where applicable.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            inspector to make the danger safe on the day (typically by isolation and labelling), to
            advise the duty-holder verbally and in writing, and to record the finding on the cert.
            C2 requires the inspector to advise urgent remediation and to record the finding. C3
            requires the inspector to record the recommendation. FI requires the inspector to record
            what could not be determined and what investigation is needed. Under-coding (treating a
            C2 as C3) is the most common error and the most dangerous; over-coding (treating a C3 as
            C2) is less common and less dangerous but still a coding error.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            the standard but not recording the departure on the cert. From a regulatory perspective
            this is indistinguishable from non-compliance — a future inspector reading the cert has
            no way to tell that the design was conscious. From a PI perspective it is worse than
            non-compliance: insurers typically repudiate cover where the insured cannot demonstrate
            the design was deliberate and justified.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            the exception. Without the documented assessment, accompanying the cert and signed by a
            competent person, the exception does not exist and the regulation applies in full. A
        ...
        >
          <p>
            ...
            bonding sizes (Table 54.8 — typically 16 mm² for TN-C-S 100 A vs 10 mm² historic TN-S),
            wrong Ze assumption, wrong Zs targets, wrong RCD type-selection logic, missed open-PEN
            considerations on EV / generator interfaces (Reg 722.312.2.1, A4), and a cert that
            misrepresents the installation. From a legal perspective it is a falsification of the
            document; from a PI perspective it is the kind of error insurers exclude.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            scoping it to their work. Six months later a fault on the inherited section causes harm
            and the new installer is the named designer on the cert. Defending that position is hard
            — the cert is the document, the signature is the personal declaration, and there is no
            audit trail showing the installer scoped their work narrowly.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            standard. Each requirement maps to a cert error. A cert error is rarely just a technical
            defect — it is typically a policy event. Treat the cert as the policy interface and most
            PI exposure manages itself.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            cannot produce their EIC ten years from now, the installer’s archive should be able to.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The checklist is mechanical but it eliminates the league-table errors above. Many firms
            now require a second pair of eyes on every EIC before issue — a peer walking the
            checklist on someone else’s cert. Cost: a few minutes per cert. Liability reduction:
            substantial. Where this is in place, the cert error rate drops to near zero and most PI
            events stop being cert events at all — they become genuine technical defects in the
        ...
        >
          <p>
            The point is not to frighten — it is to scale the discipline appropriately. The cost of
            getting the cert right is small (a structured review, a checklist, a peer
            second-pair-of-eyes). The cost of getting it wrong is variable, with a long tail towards
            severe outcomes. The expected-value calculation strongly favours process discipline.
            Every established firm in the UK has reached the same conclusion: the cert is the
            cheapest place to invest in risk reduction.
          </p>
        </ConceptBlock>
