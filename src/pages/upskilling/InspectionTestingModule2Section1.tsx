...
const DESCRIPTION =
  'Learn the fundamental principles of safe electrical isolation including GS38 requirements, isolation points, and the essential steps to work safely on electrical systems.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      'To test the circuit',
      'To prevent electrical contact while working',
      'To save energy',
      'To reset circuit breakers',
    ],
    correctIndex: 1,
    explanation:
      'Safe isolation ensures that electrical equipment is disconnected from all sources of supply and cannot become live while work is being carried out.',
  },
  {
    ...
    options: [
      ...
      'The handle position may not reflect the contact position',
      "They're always faulty",
      'Building regulations forbid it',
    ],
    correctIndex: 1,
    explanation:
      'Circuit breaker handles can move without the contacts operating, or contacts can fail internally. Always prove dead with an approved voltage indicator.',
  },
  {
    id: 'gs38-guidance',
    ...
    correctIndex: 1,
    explanation:
      'GS38 (Electrical test equipment for use on low voltage electrical systems) is the HSE guidance document covering safe isolation procedures and test equipment.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      ...
      'Disconnecting from all sources of supply to prevent re-energisation',
      'Putting barriers around equipment',
      'Testing the circuit',
    ],
    correctAnswer: 1,
    explanation:
      'Isolation means disconnecting from all sources of electrical supply and taking steps to prevent re-energisation.',
  },
  {
    id: 2,
    question: 'Which of these is NOT an acceptable isolation device?',
    options: [
      'Isolating switch (BS EN 60947-3)',
      'Circuit breaker used as an isolator',
      'Plug and socket',
      'Lamp switch',
    ],
    correctAnswer: 3,
    explanation:
      "Lamp switches and similar control switches don't meet isolation requirements. Isolators must have visible contact separation or position indication.",
  },
  {
    id: 3,
    question: 'Safe isolation is required under which regulation?',
    options: [
      'EAW Regulation 4 only',
      'EAW Regulation 12 and 13',
      'BS 7671 only',
      'Building Regulations',
    ],
    correctAnswer: 1,
    explanation:
      'EAW Regulations 12 (means of cutting off supply) and 13 (precautions for dead working) require safe isolation procedures.',
  },
  {
    id: 4,
    ...
    options: [
      'Always one',
      'One or more - all must be identified and isolated',
      'Maximum of two',
      "It doesn't matter",
    ],
    correctAnswer: 1,
    explanation:
      'Circuits may have multiple supply sources (generators, solar PV, UPS, alternative supplies). All sources must be identified and isolated.',
  },
  {
    id: 5,
    ...
    options: [
      "Assume it's safe",
      "Ask someone if it's isolated",
      'Personally verify isolation using proved test equipment',
      'Check the circuit label',
    ],
    correctAnswer: 2,
    explanation:
      'You should personally verify isolation using approved voltage testing equipment that you have proved working before and after testing.',
  },
  {
    id: 6,
    ...
    options: [
      'Be automatic',
      'Provide reliable position indication of contacts',
      'Be electronic',
      'Be remotely controlled',
    ],
    correctAnswer: 1,
    explanation:
      'Isolation devices must indicate contact position reliably - either through visible contact gap or a reliable position indicator.',
  },
  {
    id: 7,
    question: 'GS38 recommends that safe isolation should be:',
    options: [
      'Done only by qualified electricians',
      'Carried out by any person working on electrical equipment',
      'Optional for low-risk work',
      'Done remotely',
    ],
    correctAnswer: 1,
    explanation:
      "Any person working on electrical equipment should follow safe isolation procedures - it's not limited to qualified electricians.",
  },
  {
    id: 8,
    question: 'When working on a circuit with stored energy (capacitors), you should:',
    options: [
      'Ignore it - isolation is enough',
      'Allow time for discharge and verify',
      'Only worry about batteries',
      'Wear rubber gloves',
    ],
    correctAnswer: 1,
    explanation:
      'Capacitors can hold dangerous charges even after isolation. Allow time for discharge and verify the energy is dissipated.',
  },
  {
    id: 9,
    ...
    options: [
      ...
      'Do not proceed until all sources are identified',
      'Ask the client',
    ],
    correctAnswer: 2,
    explanation:
      'Never proceed with isolation until you have positively identified all sources of supply. Unknown sources could re-energise the equipment.',
  },
  {
    id: 10,
    ...
    options: [
      ...
      "All electrical work where there's risk of contact with live parts",
      'Commercial premises only',
    ],
    correctAnswer: 2,
    explanation:
      "Safe isolation applies to all electrical work where there's risk of contact with live conductors - domestic, commercial, industrial, any voltage.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Switching off is simply operating a switch to stop current flow. Isolation is a formal process of disconnecting from ALL supply sources and taking steps (locking off, proving dead) to ensure the circuit cannot become live while work is carried out.',
  },
  {
    question: 'Can I use a consumer unit main switch as an isolator?',
    answer:
      'Modern consumer unit main switches are typically designed as switch-disconnectors (isolators) and can be used for isolation. However, you should verify this from the device markings. The main switch must be locked off and the installation proved dead.',
  },
  {
    question: 'Do I need to isolate for every inspection and test?',
    answer:
      'Dead tests require isolation. Visual inspection should be done with the supply isolated where possible. Live tests obviously require the supply connected - but dead tests must be completed first to confirm the installation is safe.',
  },
  {
    question: "What if someone else says they've isolated the circuit?",
    answer:
      "Never rely on someone else's word that a circuit is dead. You must personally verify isolation using approved test equipment that you have proved working. This is a fundamental safety principle - you are responsible for your own safety.",
  },
  {
    question: 'How do I identify all supply sources?',
    answer:
      "Examine documentation, trace wiring, check for alternative feeds, standby generators, solar PV, UPS systems, and battery supplies. If in doubt, speak to the duty holder. Never assume there's only one source.",
  },
  {
    question: 'Can I isolate at the socket for a portable appliance?',
    answer:
      'Yes - removing a plug from a socket provides isolation for portable equipment. However, for fixed equipment or testing an installation, you need to isolate at the distribution board or upstream isolation point.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Purpose:</strong> Prevent electrical contact while working
              </li>
              <li>
                <strong>Key:</strong> Disconnect from ALL supply sources
              </li>
              <li>
                <strong>Verify:</strong> Never trust switch position alone
              </li>
              <li>
                <strong>Prove:</strong> Use approved voltage indicator
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>GS38:</strong> HSE electrical test equipment guidance
              </li>
              <li>
                <strong>EAW Reg 12:</strong> Means of cutting off supply
              </li>
              <li>
                <strong>EAW Reg 13:</strong> Precautions for dead working
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              <strong>Safe isolation</strong> is the process of disconnecting electrical equipment
              from all sources of supply and taking steps to ensure it cannot become live while work
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Identification</strong> of ALL sources of supply
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <Lock className="h-5 w-5 text-elec-yellow flex-shrink-0 mt-0.5" />
                  <span>
                    <strong>Disconnection</strong> using suitable isolation devices
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <Shield className="h-5 w-5 text-elec-yellow flex-shrink-0 mt-0.5" />
                  <span>
                    <strong>Securing</strong> against re-energisation (locking off)
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <Eye className="h-5 w-5 text-elec-yellow flex-shrink-0 mt-0.5" />
                  <span>
                    <strong>Verification</strong> that the circuit is dead (prove-test-prove)
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The human body is vulnerable to electric current. Even low voltages can cause fatal
              injuries under certain conditions.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-3">
                What Can Go Wrong Without Proper Isolation
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              An <strong>isolation device</strong> is a device capable of cutting off the supply to
              all or part of an installation and which meets specific requirements for contact
              separation and position indication.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Switch-Disconnectors</strong> - BS EN 60947-3
                  </li>
                  <li>
                    <strong>Isolating Switches</strong> - Visible contact gap
                  </li>
                  <li>
                    <strong>Fuse Links (Removed)</strong> - Definite disconnection
                  </li>
                  <li>
                    <strong>Plugs and Sockets</strong> - Up to 16A
                  </li>
                </ul>
              </div>
              <div>
                <p className="text-sm font-medium text-red-400 mb-2">
                  NOT Acceptable for Isolation
                </p>
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Control Switches</strong> - Light switches, starters
                  </li>
                  <li>
                    <strong>Contactors</strong> - Magnetically held
                  </li>
                  <li>
                    <strong>Semiconductor Devices</strong> - No physical gap
                  </li>
                  <li>
                    <strong>MCBs (usually)</strong> - Unless marked suitable
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              One of the most dangerous assumptions is that equipment has only one source of supply.
              Modern installations often have multiple supplies.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Mains supply</strong> - The normal DNO supply
                </li>
                <li>
                  <strong>Standby generators</strong> - May auto-start during power cuts
                </li>
                <li>
                  <strong>Solar PV</strong> - Can back-feed during daylight even if mains isolated
                </li>
                <li>
                  <strong>Battery systems / UPS</strong> - Provides power during mains failure
                </li>
                <li>
                  <strong>Alternative mains feeds</strong> - Second supply for critical loads
                </li>
                <li>
                  <strong>Capacitors</strong> - Store energy that must be discharged
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The safe isolation procedure is a systematic approach that ensures equipment is safely
              disconnected from all supply sources before work begins.
            </p>
            ...
            <div className="my-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-4">
                  <span className="flex items-center justify-center w-8 h-8 rounded-full bg-orange-500/20 text-orange-400 font-bold flex-shrink-0">
                    4
                  </span>
                  <div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          <svg
            ...
            role="img"
            aria-label="Safe Isolation Procedure Flowchart showing the six essential steps: Identify, Isolate, Secure, Prove, Test Dead, Re-Prove"
          >
            {/* Step 1: IDENTIFY */}
            <rect
              x="275"
              ...
              strokeWidth="2"
            />
            <text x="400" y="32" textAnchor="middle" fill="#FBBF24" fontSize="13" fontWeight="bold">
              1. IDENTIFY
            </text>
            <text x="400" y="50" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="11">
            ...
            <text x="400" y="126" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="11">
              Disconnect using isolation devices
            </text>
            {/* Arrow 2→3 */}
            <line
              x1="400"
            ...
            <text x="400" y="202" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="11">
              Lock off &amp; apply warning notices
            </text>
            {/* Arrow 3→4 */}
            <line
              x1="400"
            ...
            <text x="400" y="302" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="11">
            ...
            <text x="400" y="378" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="11">
              Test circuit at point of work
            </text>
            {/* Arrow 5→6 */}
            <line
              x1="400"
            ...
            <text x="400" y="454" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="11">
              Prove tester still works
            </text>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Safe isolation isn't just good practice - it's a legal requirement under the
