    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The legal duty under EaWR 1989, the BS 7671 design duty under Reg 462 / Reg 537, and the
          JIB nine-step procedure that turns those duties into a defensible system of work.
        </p>
        ...
        >
          <p>
            Reg 4 is the umbrella: all systems shall be of such construction, maintained and used so
            as to prevent danger so far as is reasonably practicable. Reg 13 is the duty when
            working on equipment that has been made dead — adequate precautions must be taken to
            prevent that equipment from becoming electrically charged during the work. Reg 14 is the
            live-work test, and is the one prosecutors lean on after a serious incident: live work
            is only permissible where it is unreasonable for the conductor to be dead, reasonable
            for the work to be done, and suitable precautions are taken. All three limbs must be
            satisfied — &ldquo;it&apos;s only a quick test&rdquo; is not a defence.
          </p>
          <p>
            Reg 16 sets the competence floor: no person shall be engaged in any work activity where
            technical knowledge or experience is necessary to prevent danger or injury, unless they
            possess such knowledge or experience, or they are under such degree of supervision as
            may be appropriate having regard to the nature of the work. In practice, that is the
            inspector / electrician with a current 2391 (or equivalent) qualification, an 18th
            Edition certificate to BS 7671, and either direct experience or proper supervision for
            the specific installation type in front of them.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              that working on a live conductors is permissible provided that: (a) it is unreasonable
              in all the circumstances for it to be dead; (b) it is reasonable in all the
              circumstances for the work to be carried out; and (c) suitable precautions are taken
              to prevent injury. Live testing of electrical installations is, therefore, reasonable
              as it is a recognized method of assessing the suitability and safety of an electrical
              installation. However, suitable precautions must be taken including employing the
              correct test equipment and suitable personal protective equipment. Although live
              testing and diagnosis for fault finding may be justifiable, there could be no
              justification for any subsequent repair work to be carried out live.
            </>
          }
        ...
        >
          <p>
            ...
            supply&rdquo; pulls in PV / battery / generator inputs as well as the DNO supply — every
            separately energisable source needs its own isolation provision. Reg 462.2 then steps
            down to circuit level: every circuit shall be provided with isolation means for all live
            conductors. The exception in Reg 461.2 is narrow (essentially: where a group of circuits
            sharing a common supply can be treated together because the service conditions allow
            it). Treat the default as &ldquo;every circuit, all live conductors&rdquo; and document
            any exception.
          </p>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              Plug-and-socket combinations are sometimes acceptable per Table 537.4 — but only when
              the table flags them as suitable for isolation, and only with overvoltage category
              considered (Reg 537.2.3).
            </li>
            <li>
            ...
            <li>
              <strong>Reg 537.2.4 / 537.2.5:</strong> devices shall be selected and installed so as
              to prevent unwanted or unintentional closure. Lockable enclosure, padlocking, or
              interlocking are all acceptable; what is not acceptable is a device that can be closed
              by accidental contact during the work.
            </li>
            <li>
              <strong>Reg 537.2.6:</strong> multipole switching is preferred. Single-pole devices
              located adjacent to each other are not excluded, but the all-pole break is the default
              that Reg 462.2 (and the system requirements for TT / IT) effectively requires.
            </li>
            <li>
            ...
            <li>
              ...
              isolation purposes, the link shall (a) require a tool to remove and (b) be accessible
              only to skilled persons.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            involves some degree of hazard. It is therefore the inspector&apos;s duty to provide for
            their own safety, and that of others, in the performance of the test procedures.&rdquo;
            GN3 Reg 10.1 reinforces it: &ldquo;It is the test operative&apos;s duty to ensure their
            own safety, and the safety of others, while working through test procedures.&rdquo; The
            legal force of those statements is reg 14 / 16 of the EaWR backed by reg 4. They are not
            advice — they are how you are judged after a fault.
          </p>
          <p>
            That is why the JIB nine-step procedure (below) is structured the way it is. Every step
            exists because something has gone wrong without that step somewhere on a job in the
            past, and an operative ended up in court, in hospital, or dead. The procedure is a
            defensible system of work; following it is the difference between &ldquo;the precautions
            taken were suitable&rdquo; (a complete defence under reg 14(c)) and &ldquo;the operative
            did not test the indicator before use&rdquo; (the headline of the prosecution).
          </p>
        </ConceptBlock>
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Prove the indicator on a known live source.</strong> Apply the indicator to a
              dedicated proving unit (or other known live source) at the rated voltage of the
            ...
            <li>
              ...
              or fuse-switch. On TT and IT systems, ensure all live conductors including neutral are
              disconnected.
            </li>
            <li>
              <strong>Lock off and tag.</strong> Apply a personal padlock and tag bearing the
              operative&apos;s name and date. Where the device cannot be locked directly, fit an MCB
              lock-off device or remove and retain the fuse. Multi-hasp where multiple operatives
              need to apply locks.
            </li>
            <li>
              <strong>Test for absence of voltage at the point of work.</strong> Apply the indicator
              to all relevant conductor combinations (single phase: L-N, L-E, N-E; three phase:
              L1-L2, L1-L3, L2-L3, L1-N, L2-N, L3-N, L1-E, L2-E, L3-E, N-E). Confirm each reads
              zero. This is the &ldquo;test&rdquo; of prove-test-prove.
            </li>
            <li>
              <strong>Re-prove the indicator on the known live source.</strong> Apply to the proving
              unit again. Confirm it still reads correctly. This is the second &ldquo;prove&rdquo; —
              the bracketing step that turns a zero reading into evidence.
            </li>
            <li>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              ...
              <text x="140" y="68" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="11">
                1. Identify isolation point
              </text>
              <text x="140" y="86" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="11">
                2. Check indicator + proving unit
              </text>
              <text x="140" y="104" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="11">
            ...
            <g>
              ...
              <text x="400" y="74" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="11">
                4. Operate means of isolation
              </text>
              <text x="400" y="96" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="11">
                5. Lock off + tag
              </text>
            </g>
            ...
            <g>
              ...
              <text x="660" y="74" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="11">
            ...
            <g>
              ...
              <text x="660" y="240" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="11">
                7. Apply to known live source
              </text>
              <text x="660" y="258" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="10">
            ...
            <g>
              ...
              <text x="660" y="380" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="11">
                8. Display warning notice
              </text>
              <text x="660" y="402" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="11">
                9. Begin work
              </text>
            </g>
            ...
            <text x="40" y="288" fill="rgba(255,255,255,0.6)" fontSize="10">
              A faulty indicator reads &ldquo;0 V&rdquo; on a live conductor. The bracketing proves
              it was working.
            </text>
            ...
            <text x="400" y="496" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="10.5">
              EaWR 1989 reg 14 — &ldquo;suitable precautions&rdquo;. EaWR 1989 reg 16 — competence.
              BS 7671 Reg 462 / 537.2.
            </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Phase to neutral:</strong> L1-N, L2-N, L3-N — confirms each line is dead with
            ...
            <li>
              <strong>Neutral to earth:</strong> N-E — the often-skipped one. A floating neutral can
              sit at hazardous potential to earth on TT/IT and on TN with a damaged PEN/return.
            </li>
          </ul>
          <p>
        ...
        >
          <p>
            ...
            certificate in the requirements for electrical installations BS 7671.&rdquo;
          </p>
          <p>
            ...
            accessories to HSE GS38; and the operator with the training to use them. &ldquo;Suitable
            precautions&rdquo; under EaWR reg 14(c) requires all three.
          </p>
        </ConceptBlock>
