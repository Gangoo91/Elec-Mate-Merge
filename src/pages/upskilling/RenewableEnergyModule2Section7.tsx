...
const inlineChecks = [
  {
    id: 'm2s7-dc-coupling',
    question: 'DC-coupled hybrid PV+BESS — what does the energy flow look like?',
    options: [
  ...
  {
    id: 'm2s7-ac-coupling',
    question: 'AC-coupled hybrid PV+BESS — what does the energy flow look like?',
    options: [
  ...
  },
  {
    ...
    question: 'When does DC-coupled hybrid architecture win the design conversation?',
    options: [
  ...
  },
  {
    ...
    question: 'When does AC-coupled hybrid architecture win the design conversation?',
    options: [
  ...
  },
  {
    ...
    question: 'Many DC-coupled hybrid inverters include a backup port — what does it do?',
    options: [
...
const faqs = [
  ...
  {
    question: 'How does the backup port on a hybrid inverter actually work during a grid outage?',
    answer:
  ...
  {
    question: 'Which loads typically go on the backup-port circuit during a grid outage?',
    answer:
  ...
  {
    question: 'How does the cert evidence bundle differ for DC-coupled vs AC-coupled hybrid?',
    answer:
...
export default function RenewableEnergyModule2Section7() {
  ...
  useSEO({
    title: 'DC vs AC coupling on hybrid PV+BESS | Renewable Energy 2.7 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 7 · BS 7671:2018+A4:2026"
        title="DC vs AC coupling on hybrid PV + BESS"
        backTo="../renewable-energy-module-2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The architectural choice between DC-coupled hybrid inverter and AC-coupled separate PV +
          battery inverters. Conversion-loss arithmetic, retrofit vs new-build decisions, and
          Chapter 82 PEI framing.
        </p>
        ...
        <Pullquote>
          DC-coupled for new-build. AC-coupled for retrofit. Both are PEIs under Chapter 82.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">PV → load</strong> — PV input stage with MPPT → common
              DC bus → DC-AC output → load. One DC-AC conversion (~96–98%)
            </li>
            <li>
              <strong className="text-white">PV → battery</strong> — PV input stage with MPPT →
              common DC bus → battery DC-DC stage → battery. One DC-DC conversion (~98%) — the
              lowest-loss path
            </li>
            <li>
              <strong className="text-white">Battery → load</strong> — battery → battery DC-DC stage
              → common DC bus → DC-AC output → load. One DC-AC conversion (~96–98%)
            </li>
            <li>
              <strong className="text-white">PV → grid (export)</strong> — PV → DC bus → DC-AC →
              grid. One DC-AC conversion
            </li>
            <li>
              <strong className="text-white">Battery → backup port</strong> — battery → DC-AC →
              backup port (during grid outage). One DC-AC conversion; the inverter\'s internal
              transfer switch isolates the backup port from the grid
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              <strong className="text-white">Overall round-trip: ~89–91%</strong> — the lowest-loss
              path for PV-via-battery to grid
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">PV → load</strong> — PV → PV string inverter → AC
              consumer unit → load. One DC-AC conversion (~96–98%) — same as DC-coupled equivalent
            </li>
            <li>
              <strong className="text-white">PV → battery</strong> — PV → PV string inverter → AC →
              battery inverter → battery. DC-AC (~96%) plus AC-DC (~96%) = ~92% on the conversions
              alone. Higher loss than DC-coupled equivalent
            </li>
            <li>
              <strong className="text-white">Battery → load</strong> — battery → battery inverter →
              AC consumer unit → load. One DC-AC conversion (~96–98%) — same as DC-coupled
              equivalent
            </li>
            <li>
              <strong className="text-white">PV → grid (export)</strong> — PV → PV inverter → AC →
              grid. One DC-AC conversion
            </li>
            <li>
              <strong className="text-white">Battery → backup port</strong> — typically requires a
              dedicated battery inverter with backup capability. Some battery inverters provide a
              backup port; others do not. Check the product spec
            </li>
          </ul>
          <p>Round-trip efficiency on PV → battery → later grid export:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              <strong className="text-white">Overall round-trip: ~84%</strong> — the cost of the
              additional AC-DC conversion stage
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          The architecture follows the install history. New-build = DC. Retrofit-battery = AC.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">New-build PV+BESS together</strong> — DC-coupled hybrid
              is the natural choice. Single product, fewest conversions, lowest hardware cost.
            </li>
            <li>
              <strong className="text-white">Retrofit battery onto existing PV</strong> — AC-coupled
              is the natural choice if existing PV inverter has useful life remaining.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              ...
              consider both; the cost-benefit balances conversion-loss savings against PV inverter
              replacement cost
            </li>
            <li>
              <strong className="text-white">&gt; 10 years old, near end-of-life</strong> — PV
              inverter replacement is in scope anyway; specify DC-coupled hybrid as the replacement
            </li>
          </ul>
          <p>Question 3 — backup-power capability required?</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Yes — backup required</strong> — DC-coupled hybrid with
              backup port is the standard choice. Most modern hybrid inverters include this
              functionality
            </li>
            <li>
              <strong className="text-white">No — backup not required</strong> — AC-coupled or
              DC-coupled both work; decision driven by Question 1 and 2
            </li>
          </ul>
          <p>Question 4 — single-product or multi-product preference?</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Single-product preferred</strong> — DC-coupled hybrid
              (one inverter on the wall, one product to support)
            </li>
            <li>
              <strong className="text-white">Multi-product acceptable</strong> — either architecture
              works
            </li>
            <li>
              <strong className="text-white">Different ownership / vendor for PV vs battery</strong>{' '}
              — AC-coupled may be required (e.g. utility-owned battery on customer-owned PV)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Coupling architecture is the engineering. Chapter 82 PEI is the regulatory layer.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Load management coordination</strong> — orchestrating
              PV export, battery charge / discharge, EV charging, heat pump operation, household
              loads. The PEI design specifies the priority logic and the override conditions
            </li>
            <li>
              <strong className="text-white">Multi-source fault current contribution</strong> —
              under a fault, both PV and battery can contribute fault current. The protection design
              handles the combined contribution; the cert evidence bundle records the fault current
              calculation
            </li>
            <li>
              <strong className="text-white">Protection coordination across sources</strong> — the
              bidirectional protective device under Reg 551.7.1(c) applies per source. DC-coupled
              has fewer protection points (one inverter); AC-coupled has two (PV inverter + battery
              inverter)
            </li>
            <li>
              <strong className="text-white">Anti-islanding coordination</strong> — both inverters
              in an AC-coupled system must disconnect cleanly on grid loss. The hybrid inverter in
              DC-coupled handles this in one product
            </li>
            <li>
              <strong className="text-white">G99 notification</strong> — the aggregate generation
              capacity (PV + battery export capability) drives the EREC G98 / G99 threshold
              determination, regardless of coupling architecture
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Backup port rating</strong> — typical residential 2–5
              kW continuous; commercial 5–20+ kW. The rating limits which loads can be powered
              simultaneously
            </li>
            <li>
              <strong className="text-white">Transfer time</strong> — 20–100 ms typical. Sensitive
              loads (computers, medical devices) may need UPS-grade transfer (&lt; 10 ms); discuss
              with the customer if applicable
            </li>
            <li>
              <strong className="text-white">Essential-loads consumer unit</strong> — dedicated
              consumer unit fed from the backup port. Essential circuits (fridge, freezer, lighting
              some, broadband router, boiler controls, security alarm) are routed via this consumer
              unit. Standard CU handles non-essential loads (oven, shower, EV, heat pump, immersion
              heater)
            </li>
            <li>
              <strong className="text-white">Battery management during outage</strong> — PV
              continues to supply during daylight (subject to PV generation exceeding load); battery
              discharges during dark or low-PV periods. Customer\'s essential-loads runtime depends
              on battery capacity and load profile
            </li>
            <li>
              <strong className="text-white">Black-start capability</strong> — some hybrid inverters
              can start from battery alone (no grid, no PV), enabling grid-outage recovery from
              low-PV / nighttime conditions. Verify manufacturer\'s spec
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-2-section-8')}
