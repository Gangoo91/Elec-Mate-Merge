...
const quizQuestions = [
  {
    id: 1,
    question:
      'State the two-part BS 5266-1:2025 high-risk-area requirement for emergency lighting circuits.',
    options: [
      'At least two separate circuits, and no single fault disabling more than 20 luminaires.',
  ...
  },
  {
    id: 2,
    question:
      'A 60-luminaire high-risk area must be split into how many sub-zones to comply with the 2025 requirement?',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'What does BS 7671 §528.1 require for emergency lighting cables in relation to other circuits?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'What is the labelling requirement for the means of isolation of emergency lighting per BS 7671 Reg 560.11?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'BS 7671 §560.10 covers sources of supply for safety services. List three acceptable sources.',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'A cable tray supporting emergency lighting circuits passes through a 90-minute fire-rated floor. What additional installation is required at the floor penetration?',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'Why is a single shared cable tray with both emergency lighting and general lighting cables non-compliant with BS 7671 §528.1?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'What is a Class A circuit topology in BS EN 50172 fault-tolerance terms, compared with Class B?',
    options: [
  ...
  },
  {
    id: 9,
    question:
      "What documentation does BS 5266-1:2025 require for the emergency lighting installation's segregated and high-risk-area architecture?",
    options: [
  ...
  },
  {
    id: 10,
    question:
      'A central battery cabinet has a dedicated mains supply from a non-essential distribution board. The DB is upstream of any RCD-protected circuits. Is this compliant?',
    options: [
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/electrician/upskilling/emergency-lighting-module-4"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The 2025 edition of BS 5266-1 reframes circuit design: high-risk areas need at least two
          separate emergency lighting circuits with no single fault disabling more than 20
          luminaires. Add BS 7671 §528.1 segregation, §560 safety services, certified fire-stopping
          at compartment penetrations, and the labelled lockable isolator — and you have the
          architecture that survives both real fires and routine maintenance errors.
        </p>
        ...
        <ContentEyebrow>
          The 2025 high-risk-area rule — architectural fault tolerance
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              is — short circuit, cable damage, MCB trip, control fault, driver failure propagating
              along a control bus — it must not extinguish more than 20 luminaires. This forces
              sub-zoning within circuits. A circuit of 50 luminaires must be sub-divided so that a
              fault in one section affects only that section (≤ 20 luminaires), not the whole 50.
            </li>
            <li>
              ...
              at least two circuits. Common implementations: three circuits of 20 (simplest); two
              circuits each with three sub-zones via fused taps or distribution; two circuits with
              self-contained backup providing the third independent path.
            </li>
            <li>
          ...
          <p>
            ...
            offices, and storage continue to use the standard single-circuit approach (with all the
            other emergency lighting requirements applying). The architectural complexity is
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              separation between circuits shall be physical as well as electrical, with cable routes
              arranged so that a single fire or mechanical event cannot disable both circuits
              simultaneously.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              leaves a coherent emergency lighting pattern from the other two. Simple to understand;
              symmetric. Common in linear corridors and large halls.
            </li>
            <li>
              <strong>Two circuits with sub-zoning.</strong> Two circuits of larger luminaire
              counts, each sub-divided via fused taps or distribution boxes so that a fault in any
              sub-zone affects only that sub-zone (≤ 20 luminaires). Reduces circuit count at the
              supply but increases distribution complexity.
            </li>
            <li>
              <strong>Central battery + self-contained backup.</strong> A central battery provides
              the primary emergency lighting; self-contained luminaires distributed in the same area
              provide a second independent path. The central is split into sub-zones for the
              20-luminaire rule; the self-contained units are not on the central battery and so are
              immune to cabinet failure. Used in high-criticality applications (operating theatres,
              ICUs, control rooms).
            </li>
            <li>
              <strong>Duty/standby cabinets.</strong> Two central battery cabinets, one duty and one
              standby, with automatic failover. Each feeds the area independently; a fault on one
              cabinet fails over to the other. Common in stair cores and other escape-critical
              paths.
            </li>
            <li>
              <strong>Hybrid supply sources.</strong> A central battery + generating set arrangement
              per BS 7671 §560.10. The battery covers changeover (0.5 second) and the first minutes
              of an event; the generator picks up after start-up. Provides extended duration and
              source diversity.
            </li>
          </ul>
          <p>
            The designer documents the pattern, the rationale, and the calculation showing the ≥ 2
            circuits + ≤ 20 luminaires-per-fault rule is met. Auditors and successor designers read
            the documentation to confirm compliance and to plan modifications.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="440" y="74" textAnchor="middle" fill="#EF4444" fontSize="11" fontWeight="bold">
              Central battery cabinet
            </text>
            <text x="440" y="92" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              BS EN 50171:2021
            </text>

            {/* Two circuits leaving */}
            <line x1="400" y1="110" x2="400" y2="150" stroke="#22C55E" strokeWidth="2" />
            <text x="375" y="135" textAnchor="end" fill="#22C55E" fontSize="10" fontWeight="bold">
              Circuit A
            </text>
            <line x1="480" y1="110" x2="480" y2="150" stroke="#22D3EE" strokeWidth="2" />
            <text x="505" y="135" fill="#22D3EE" fontSize="10" fontWeight="bold">
              Circuit B
            </text>
            ...
            <text x="220" y="180" fill="rgba(34,197,94,0.65)" fontSize="9">
              left riser, PH120 + W
            </text>

            <line x1="480" y1="150" x2="680" y2="150" stroke="#22D3EE" strokeWidth="2" />
            <line x1="680" y1="150" x2="680" y2="220" stroke="#22D3EE" strokeWidth="2" />
            <text x="660" y="180" textAnchor="end" fill="rgba(34,211,238,0.65)" fontSize="9">
              right riser, PH120 + W
            </text>
            ...
            <text
              ...
              fontWeight="bold"
            >
              Sub-zone 1 · 20 luminaires
            </text>
            <text x="180" y="278" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              Circuit A · fused tap 1
            </text>
            ...
            <text
              ...
              fontWeight="bold"
            >
              Sub-zone 2 · 20 luminaires
            </text>
            <text x="440" y="278" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              Circuit B · fused tap 1
            </text>
            {[0, 1, 2, 3, 4].map((c) =>
              [0, 1, 2, 3].map((r) => (
                <circle
            ...
            <text
              ...
              fontWeight="bold"
            >
              Sub-zone 3 · 20 luminaires
            </text>
            <text x="700" y="278" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              Circuit A · fused tap 2
            </text>
            {[0, 1, 2, 3, 4].map((c) =>
              [0, 1, 2, 3].map((r) => (
                <circle
            ...
            <text x="440" y="412" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="9.5">
              ≥ 2 circuits ✓ (A and B, independent risers) Single fault disables ≤ 20 luminaires ✓
              (each sub-zone has its own fused tap)
            </text>
            <text x="440" y="428" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
              Cable routes physically separate (left/right risers) — no common-mode failure
            </text>
            <text x="440" y="442" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              Worst-case: fault on Circuit A loses 40 luminaires, Circuit B keeps 20 lit (sub-zone
              2). Reverse: A keeps 40, B loses 20.
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              compartments. Each compartment is sealed and continuous; the partitions must be the
              trunking manufacturer's certified separation.
            </li>
            <li>
              <strong>Separate conduits.</strong> Where cables run in conduit, emergency lighting in
              its own conduit, non-safety in another. Shared conduit defeats segregation.
            </li>
            <li>
              <strong>Maintained physical clearance.</strong> Where cables run in free air or in
              building voids, a maintained clearance (typical 50-100 mm depending on cable type and
              the relevant standard) provides functional separation. Clearance is harder to evidence
              than physical separation but is recognised in the standard.
            </li>
            <li>
              <strong>Operational segregation.</strong> Independent isolation — the means of
              isolating the non-safety circuit must not also isolate the safety circuit. The safety
              circuit has its own labelled lockable isolator (Reg 560.11).
            </li>
          </ul>
          <p>
            Mixed cables in a single tray defeat segregation. The fix is dedicated
            trays/compartments for safety services or maintained physical clearance. The cost is
            more containment but the benefit is fault isolation and operational independence.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Cables of safety service circuits shall be segregated from cables of other circuits so
              that any failure of one circuit cannot affect the other. Segregation may be achieved
              by physical separation in dedicated containment, by compartmented trunking, by
              separate conduit, or by maintained physical clearance appropriate to the cable type.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              emergency lighting), and shuts down on mains restoration. Used in larger installations
              and where extended duration matters; combined with central battery for start-up
              coverage.
            </li>
            <li>
          ...
          <p>
            ...
            supply fails. The whole point of emergency lighting is to provide light when the normal
            supply has gone. The supply architecture must be designed so that the safety supply is
            independent of the normal supply (different source, different path, separate isolation,
            separate protection).
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              maintenance work. BS 7671 + Electricity at Work Regulations + safe-isolation practice.
              The maintenance electrician locks it off, works safely, unlocks it when done. The lock
              is what gives the worker confidence the isolator will not be re-energised without
              their knowledge.
            </li>
            <li>
              ...
              attachment. NOT a sticky label — those fall off, get covered, get scuffed off, and the
              warning is lost.
            </li>
            <li>
            ...
            <li>
              ...
              board way isolator, cabinet supply isolator, any in-line isolators. Anywhere a person
              could reasonably switch off the supply without realising what it does.
            </li>
            <li>
              <strong>Visible from the operator's position.</strong> The label is visible to the
              person who would otherwise flip the switch — at the front of the panel, on the lid of
              the box, or on the cover of the device. A label hidden inside an enclosure that the
              operator opens AFTER the switch flip is no use.
            </li>
          </ul>
          <p>
            The label is the engineering control for human-error isolation. It is cheap, simple, and
            effective. Inspection regimes specifically check for it. Its absence is one of the most
            common defects on existing emergency lighting installations and one of the cheapest to
            remedy.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              fire-stopping. A 120-minute floor needs 120-minute fire-stopping. The fire-stop system
              carries a tested rating that must equal or exceed the element rating.
            </li>
            <li>
              ...
              not be valid for 12 × MICC. The manufacturer's certification specifies the applicable
              configurations.
            </li>
            <li>
              <strong>Match to containment.</strong> Cable in a tray, cable in a conduit, cable in a
              basket, single cable through a small hole — each needs its own type of fire-stop.
            ...
            <li>
              ...
              void the certification. Site improvisation (e.g. swapping in a generic mastic because
              it looks similar) destroys compliance.
            </li>
            <li>
          ...
          <p>
            Fire-stopping is the most-skipped element of life-safety installations because it comes
            at the end, when trades are under time pressure. It is also the most heavily checked at
            inspection because it is highly visible and a known weak point. Doing it right first
            time is far cheaper than retrofitting under client pressure.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              that path extinguishes the luminaire. Lower capital cost; lower fault tolerance. Used
              in lower-criticality areas where the consequence of single luminaire loss is
              tolerable.
            </li>
            <li>
            ...
            <li>
              <strong>Mixed topology.</strong> Most buildings have Class A in the
              highest-criticality zones and Class B in the rest. The transition is documented on the
              as-built; the test regime adapts to the topology.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Riser diagrams.</strong> Vertical sections showing the supply path from source
              (cabinet / DB) to each zone, the circuit identity, and the routing through the
              building. Critical for verifying the physical separation of redundant circuits.
            </li>
            <li>
              ...
              and how the redundancy plays out. Used in commissioning to verify the design works as
              intended.
            </li>
            <li>
            ...
            <li>
              <strong>Fire-stopping log.</strong> Every penetration with photo, location,
              certificate reference, installation date, installer. Plus the as-built drawings
              flagging each penetration.
            </li>
            <li>
          ...
          <p>
            ...
            it for the operational life of the installation. Inspectors, insurers, and post-incident
            investigators read it. Modifications must be reflected.
          </p>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            {
              question:
                'How do I know which areas in my building are "high-risk" for the 2025 rule?',
              answer:
            ...
            {
              question:
                'What if my high-risk area has fewer than 20 luminaires? Do I still need 2 circuits?',
              answer:
            ...
            {
              question:
                'Can I use a single cable tray with internal partitions to run two redundant circuits?',
              answer:
            ...
            {
              question:
                'What is the difference between segregation (BS 7671 §528.1) and the 2025 high-risk rule?',
              answer:
            ...
            {
              question:
                'Can I use the same cable tray for emergency lighting and a fire alarm circuit?',
              answer:
            ...
            {
              question:
                'What documentation does a duty-holder need to maintain over the operational life?',
              answer:
        ...
        <Quiz
          title="Circuit segregation and fire integrity — Module 4.4"
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() =>
              navigate('/electrician/upskilling/emergency-lighting-module-4-section-5')
            }
