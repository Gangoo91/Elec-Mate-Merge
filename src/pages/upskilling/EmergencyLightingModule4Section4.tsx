    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white">Maintaining circuit integrity under fire conditions</p>
        </header>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent">
                ...
                <p className="text-white text-xs">Physical routes</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">Protected</p>
                <p className="text-white text-xs">Fire enclosure</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">Fire-resistant</p>
                <p className="text-white text-xs">Cable types</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="/electrician/upskilling/emergency-lighting-module-4-section-5">
              Next Section
