...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Both Zigbee and Z-Wave use mesh networking, where devices relay signals to each other, extending the effective range of the network.',
  },
  {
...
const faqs = [
  {
    ...
    answer:
      'Not directly, as they use different protocols and frequencies. However, smart home hubs like SmartThings or Hubitat can support both protocols, allowing you to control all devices from a single interface.',
  },
  {
    question: 'Which protocol should I recommend for a new installation?',
    answer:
      "Consider Matter-compatible devices for future-proofing. For existing ecosystems, match the protocol to the customer's hub. Z-Wave is excellent for reliability, while Zigbee offers more device variety at lower cost.",
  },
  {
    question: 'Do wireless protocols interfere with each other?',
    answer:
      'Zigbee can experience interference with Wi-Fi since both use 2.4 GHz. Z-Wave avoids this by using sub-GHz frequencies. Proper channel selection and device placement minimise interference issues.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-4xl mx-auto">
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            A wireless protocol is a standardised set of rules that defines how devices communicate
            without physical connections. In smart homes, protocols determine how sensors,
            controllers, and actuators exchange data to create automated systems.
          </p>
          <p className="text-white mb-4">
            Each protocol has specific characteristics affecting range, power consumption, data
            throughput, and security. Understanding these differences is essential for selecting the
            right technology for each installation.
          </p>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            <p className="text-sm font-medium text-elec-yellow mb-1">Electrician Insight</p>
            <p className="text-white text-sm">
              Protocol selection often determines the hub requirements, device compatibility, and
              long-term expandability of a smart home system.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            The choice of wireless protocol affects every aspect of a smart home installation.
            Different protocols excel in different situations, and mismatching protocols to
            applications can lead to poor performance, reliability issues, and unhappy customers.
          </p>
          <div className="space-y-3 mb-4">
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Interoperability</p>
              <p className="text-white text-sm">
                Devices must speak the same language to communicate. Mixing incompatible protocols
                requires bridges or limits functionality.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Range and Coverage</p>
              <p className="text-white text-sm">
                Protocols have different effective ranges. Mesh protocols extend coverage while
                point-to-point protocols may need repeaters.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Power Consumption</p>
              <p className="text-white text-sm">
                Battery-powered devices need low-power protocols. Mains-powered devices can use
          ...
          <div className="space-y-4 mb-4">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                An open standard operating on 2.4 GHz with mesh networking support. Zigbee devices
                are widely available and relatively affordable. Supports over 65,000 devices per
                network.
              </p>
              <p className="text-white text-sm">
                <span className="text-elec-yellow">Best for:</span> Large installations,
                battery-powered sensors, cost-effective deployments
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                A proprietary protocol using sub-GHz frequencies (868 MHz in UK/EU). Excellent for
                avoiding Wi-Fi interference and penetrating walls. Limited to 232 devices per
                network.
              </p>
              <p className="text-white text-sm">
                <span className="text-elec-yellow">Best for:</span> Reliability-critical
                applications, areas with Wi-Fi congestion, security systems
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                Uses existing home networks, no hub required. High bandwidth suitable for cameras
                and streaming devices. Higher power consumption limits battery-powered applications.
              </p>
              <p className="text-white text-sm">
                <span className="text-elec-yellow">Best for:</span> Smart displays, cameras, devices
                near power outlets, simple installations
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                Bluetooth Low Energy offers short-range, low-power communication. Often used for
                device setup and direct smartphone control. Limited range without mesh support.
              </p>
              <p className="text-white text-sm">
                <span className="text-elec-yellow">Best for:</span> Wearables, smartphone-controlled
                devices, proximity-based triggers
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                A newer IP-based mesh protocol designed for IoT. Low power, secure, and IPv6
                addressable. Foundation for the Matter standard.
              </p>
              <p className="text-white text-sm">
                <span className="text-elec-yellow">Best for:</span> Future-proof installations,
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                A unifying application layer standard backed by Apple, Google, Amazon, and Samsung.
                Works over Wi-Fi, Thread, and Ethernet to provide cross-platform compatibility.
              </p>
              <p className="text-white text-sm">
                <span className="text-elec-yellow">Best for:</span> Multi-ecosystem homes, maximum
                compatibility, new installations
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-3">
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Match the protocol to devices the customer already owns. Switching ecosystems is
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Thick walls and metal structures favour sub-GHz protocols like Z-Wave. Open-plan
                spaces work well with any protocol.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Network Size</p>
              <p className="text-white text-sm">
                Large installations with many devices benefit from Zigbee's scalability. Small
                systems can use simpler Wi-Fi devices.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Future Expansion</p>
              <p className="text-white text-sm">
                Matter-compatible devices offer the best future-proofing as the ecosystem grows and
                standards mature.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            <p className="text-white font-semibold mb-2">
              Scenario: Multi-Protocol Home Installation
            </p>
            <p className="text-white text-sm mb-3">
              A customer wants smart lighting throughout their home, a video doorbell, and
              battery-powered window sensors. They use Amazon Alexa for voice control.
            </p>
            <p className="text-white text-sm mb-2">
