    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reg 643.10 — does the kit actually work in the installation, not just in the catalogue?
          Mechanical-only first, then live verification. AFDD manual test button now an A4:2026
          explicit duty.
        </p>
        ...
        >
          <p>
            ...
            into operating reality. Every other test in Part 6 measures something — a resistance, an
            impedance, a voltage. Reg 643.10 does not measure: it operates. The functional test
            answers the question "does it actually work in this installation, in this configuration,
            with these terminations?".
          </p>
          <p>
            The regulation gives a non-exhaustive list of equipment categories explicitly within its
            scope:
          </p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Equipment shall be subjected to functional testing, as appropriate, to verify that it
              is properly mounted, adjusted and installed and operates correctly in accordance with
              the relevant requirements of BS&nbsp;7671. Examples of such equipment are:
              <br />
        ...
        <ContentEyebrow>Functional test vs trip test — the load-bearing distinction</ContentEyebrow>
        ...
        >
          <p>
            ...
            high-energy event. The thermal-magnetic mechanism still operates the toggle. The handle
            moves between ON and OFF normally. A functional test — operate the handle, observe
            ON/OFF — passes. But the contacts no longer fully separate at the rated breaking
            capacity. When the next fault arrives, the MCB does not interrupt cleanly: it arcs,
            possibly burns through, and downstream protection is left to do the breaking.
          </p>
          <p>
            That is why Reg 643.10 functional testing is an addition to, not a replacement for, Reg
            643.7 (effectiveness of automatic disconnection) and Reg 643.8 (additional protection).
            Both test types appear on the schedule. The functional test confirms the user can
            operate the device. The trip test confirms it operates in fault conditions to the
            regulation\'s disconnection time.
          </p>
          <p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="150" y="62" textAnchor="middle" fill="#22C55E" fontSize="11" fontWeight="bold">
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="650" y="62" textAnchor="middle" fill="#3B82F6" fontSize="11" fontWeight="bold">
              2. CONTACT INTEGRITY
            </text>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              protects you for the wiring tests still applies here. Isolate at the supply, lock-off,
              prove dead at the test point with an approved tester proven against a known live
            ...
            <li>
              ...
              This step catches mechanical failures (seized linkages, stripped gears, jammed levers)
              before any energy is applied.
            </li>
            <li>
              <strong>Energise.</strong> Restore supply at the agreed switching point, having first
              confirmed nothing downstream is exposed.
            </li>
            <li>
              <strong>Live verification.</strong> Confirm with an approved voltage tester that the
              device makes and breaks the circuit electrically as the mechanical operation suggests.
              For an isolator: load side dead with handle OFF, load side live with handle ON. For an
              RCD: pressing T button trips. For an emergency stop: pressing button removes supply at
              the relevant equipment immediately.
            </li>
          </ol>
          <p>
        ...
        >
          <p>
            AFDDs (arc-fault detection devices) are now a real protective measure under BS&nbsp;7671
            — particularly post-A4:2026 where they are required or strongly recommended in specific
            high-risk locations. The A4 amendment binds them to 643.10 functional testing in two
            ways:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Manual test button (where fitted):</strong> press it. The device should trip.
              Confirm trip, reset, confirm normal indication. Manufacturer-specified interval for
              periodic re-test (typically 6 months, advised to user via on-site notice).
            </li>
            <li>
              <strong>Automatic self-test (where fitted):</strong> some AFDDs have an automatic test
              facility which will trip the device in the event of a malfunction; where this
              automatic test exists it will be indicated on the device. No manual six-monthly action
              is implied for such devices beyond following manufacturer instructions.
            </li>
          </ul>
          <p>
            Two practical points. First, the A4 wording binds the test facility, not the arc-fault
            detection itself — there is no installer-side test for arc-fault sensing beyond what the
            manufacturer\'s built-in self-test offers. Second, AFDDs are listed in GN3 as devices
            that can present a low-resistance path during insulation testing, so order matters:
            insulation tests at 500 V DC happen with the AFDD disconnected; the functional test of
            its manual button happens after the AFDD is connected and the circuit is energised.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              The user has been verbally walked through how to operate the test button(s) and what a
              healthy / unhealthy result looks like.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              The product-standard functional test (carried out by the manufacturer, attested by the
              CE / UKCA marking and the test certificate) is the test that demonstrates the device
              is fit for its rated service. Your installer\'s test does not subsume that.
            </li>
            <li>
          ...
          <p>
            Where manufacturers specify a functional-test procedure beyond the basic press-and-watch
            (typical for AFDDs, smart switchgear, motor protection relays, and transfer switches),
            follow it. The A4:2026 AFDD addition is explicit: "in accordance with the manufacturers'
            recommendations". Read the IFU before you press anything.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              Confirm the IMD is energised and showing a healthy state (typically a green indicator,
              no alarm condition).
            </li>
            <li>
            ...
            <li>
              Confirm the visual indication operates (alarm LED, display message, or relay contacts
              to a remote panel) — and confirm the audible alarm sounds.
            </li>
          ...
          <p>
            Insulation monitoring is a continuous-running protective measure, so the functional test
            is doubly important: a silent-failed IMD on an IT system means the first earth fault is
            undetected, and the system continues running with degraded protection until the second
            fault arrives. Reg 643.10 catches a silent IMD at commissioning before the first fault.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            On the standard Schedule of Inspections (consumer-unit / switchgear section), the 643.10
            duties map across:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Item 7.11 — Operation of main switch(es) (functional check) (643.10):</strong>{' '}
            ...
            <li>
              <strong>
                Item 7.13 — Confirmation that integral test button/switch causes RCD(s) to trip when
                operated (functional check) (643.10):
              </strong>{' '}
              T-button on each RCD pressed and trip observed.
            </li>
            <li>
              <strong>Items further down the schedule</strong> for emergency switching, interlocks,
              insulation monitoring, where present.
            </li>
          </ul>
          <p>
            For AFDDs specifically, item 7.12 covers the manual functional test (handle-style
            operation), and where the manufacturer specifies a separate AFDD self-test routine, that
            is recorded in the comments column with reference to the manufacturer\'s IFU.
          </p>
          <p>
            Where a functional test failed and remediation was carried out before re-test, record
            both the original failure and the remediation in the comments column. The next inspector
            reading the report needs to know what was wrong and what was done — an unannotated
            "pass" hides the diagnostic history.
          </p>
        </ConceptBlock>
