...
const DESCRIPTION =
  'Master functional testing to verify that electrical equipment, controls, and safety systems operate correctly as intended.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "This is a functional fault, likely caused by incorrect wiring of the strappers or a faulty switch. While electrical continuity tests might pass, the circuit doesn't function as intended.",
  },
  {
    id: 'emergency-stop',
    question:
      'An emergency stop button de-energises the machine but it can immediately be restarted. Is this acceptable?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'No. Emergency stop circuits should be self-latching - a deliberate reset action should be required before the machine can restart. This prevents accidental restart while the hazard may still exist.',
  },
  {
    id: 'recording-functional',
    question:
      'Should functional testing be recorded on the Schedule of Inspections or Schedule of Test Results?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'The Schedule of Inspections. Functional testing verifies operation (satisfactory or not) rather than measuring electrical values. The inspection schedule includes items for switchgear and controlgear operation.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Functional testing verifies that assemblies, including switchgear, controls, interlocks, and equipment, operate correctly as intended by their design and the installation requirements.',
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      'Functional testing is performed after all other tests (continuity, insulation resistance, polarity, earth fault loop, RCD) confirm the installation is safe. This prevents operating faulty equipment.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Regulation 643.10 requires functional testing of switchgear and controlgear to verify they are properly mounted, adjusted, and work correctly.',
  },
  {
    id: 4,
    question: 'Testing that an RCD trips when its test button is pressed is an example of:',
    options: ['Dead testing', 'Instrument testing', 'Functional testing', 'Continuity testing'],
    correctAnswer: 2,
    explanation:
      'Operating the RCD test button is a functional test - it verifies the device operates as intended. This is separate from instrument testing which measures trip times.',
  },
  {
    id: 5,
    question:
      'A door interlock prevents a panel being opened when energised. Functional testing should verify:',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Functional testing of interlocks must verify both functions: the interlock prevents unsafe access when energised, and it correctly de-energises the equipment if the interlock is defeated.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Fire alarm functional testing verifies the complete system operates: detectors trigger alarms, sounders operate, the panel indicates correctly, and any outputs (fire doors, dampers) function.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'Functional testing reveals operational issues - whether controls work throughout their range. A dimmer not reaching full brightness is a functional fault, not an electrical measurement issue.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Emergency lighting functional testing must simulate mains failure to verify the system performs its safety function - maintaining illumination during a power outage for the required duration.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Functional test results are typically recorded as satisfactory operation or defects identified. Unlike electrical measurements, functional tests verify operation rather than measure values.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      "This is a functional fault - the time switch isn't performing its intended function. Investigation might reveal programming issues, a faulty switch, or incorrect wiring to the switching contacts.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Dead tests (continuity, insulation) and live tests (earth fault loop, RCD trip times) measure electrical values against standards. Functional testing verifies equipment and systems operate correctly as intended - controls switch, interlocks function, timers operate, etc.',
  },
  {
    question: 'Is functional testing required by BS 7671?',
    answer:
      'Yes. Regulation 643.10 requires assemblies such as switchgear, controlgear, and interlocks to be subjected to functional testing to verify they are properly mounted, adjusted, and installed in accordance with requirements.',
  },
  {
    question: 'What if functional testing reveals a problem?',
    answer:
      'Functional faults must be investigated and rectified. The cause might be incorrect installation, programming errors, faulty equipment, or issues with associated circuits. Document defects and actions taken on the certification.',
  },
  {
    question: 'Should I test every light switch?',
    answer:
      "Yes, every switching device should be functionally tested to verify it controls its intended load. This is also an opportunity to verify polarity - if a switch doesn't control the lamp, further investigation is needed.",
  },
  {
    question: 'How do I functionally test a PIR sensor?',
    answer:
      'Walk through the detection zone and verify the light operates. Test sensitivity and time delay settings match requirements. Check for dead spots in coverage and verify the light extinguishes after the time delay expires.',
  },
  {
    question: 'Is testing RCD test buttons a functional test?',
    answer:
      'Yes. Operating the test button verifies the mechanical tripping function works. This is separate from instrument testing which measures actual trip times and currents. Both are required for complete RCD verification.',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Purpose:</strong> Verify equipment operates as intended
              </li>
              <li>
                <strong>When:</strong> AFTER all other tests confirm safety
              </li>
              <li>
                <strong>What:</strong> Switches, controls, interlocks, safety systems
              </li>
              <li>
                <strong>Record:</strong> Satisfactory or defects found
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Controls not working through full range
              </li>
              <li>
                <strong>Use:</strong> Operate every switch, test every interlock
              </li>
              <li>
                <strong>Apply:</strong> Simulate failures for safety systems
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Every switching and control device should be functionally tested to verify correct
              operation:
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Interlocks are critical safety devices that must be comprehensively tested:</p>
              ...
              <div className="grid grid-cols-1 gap-3 text-sm">
                <div className="p-3 rounded bg-transparent">
                  ...
                  <p className="text-white/90 text-xs">
                    Verify interlock prevents unsafe action when equipment is energised
                  </p>
                </div>
                <div className="p-3 rounded bg-transparent">
                  <p className="font-medium text-white mb-1">De-energisation Test</p>
                  <p className="text-white/90 text-xs">
                    Verify equipment de-energises if interlock is defeated or door opened
                  </p>
                </div>
                <div className="p-3 rounded bg-transparent">
                  <p className="font-medium text-white mb-1">Indication Test</p>
                  <p className="text-white/90 text-xs">
                    Verify any associated indicators show correct status
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Emergency systems require thorough functional testing to ensure they perform when
              needed:
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Heating, ventilation, and air conditioning systems have multiple functional aspects to
              verify:
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Unlike electrical measurements, functional tests record whether operation is
              satisfactory or identifies defects found:
            </p>
            ...
            <p>
              For complex installations, detailed functional test records may be prepared as
              separate documentation attached to the electrical installation certificate.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Skipping "obvious" switches</strong> - test every one
                </li>
                <li>
                  <strong>Not testing through full range</strong> - dimmers should reach max/min
                </li>
                <li>
                  <strong>Forgetting safety systems</strong> - always simulate failure conditions
                </li>
                <li>
                  <strong>Poor documentation</strong> - record defects clearly for follow-up
                </li>
              </ul>
            </div>
          </div>
