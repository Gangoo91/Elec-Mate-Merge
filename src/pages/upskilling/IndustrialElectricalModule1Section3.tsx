...
const quickCheckQuestions = [
  ...
  },
  {
    id: 'qc3-mcc-section3',
    question:
      'At what incident energy level (cal/cm squared) does arc flash PPE Category 2 begin according to IEEE 1584?',
    options: ['1.2 cal/cm squared', '4 cal/cm squared', '8 cal/cm squared', '25 cal/cm squared'],
    correctIndex: 1,
    explanation:
      'PPE Category 2 begins at 4 cal/cm squared and extends to 8 cal/cm squared. Category 1 covers 1.2-4 cal/cm squared, Category 3 covers 8-25 cal/cm squared, and Category 4 covers 25-40 cal/cm squared. Above 40 cal/cm squared, live work is prohibited.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Form 2b additionally provides separation of terminals from busbars, while Form 2a only separates busbars from functional units.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'IEC 61850 and Modbus TCP are commonly used for Ethernet-based SCADA integration in modern intelligent switchgear.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Industrial installations should be inspected every 3-5 years depending on the environment, with more critical or hazardous installations requiring more frequent inspection.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Icw is the rated short-time withstand current - the current the device can carry for a specified time (typically 1 second) without damage.',
  },
  {
    id: 9,
    question:
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'PPE Category 3 requires a minimum ATPV rating of 25 cal/cm squared to protect against incident energies of 8-25 cal/cm squared.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'MCBs handle up to 125A with fault ratings to 10kA for final circuits. MCCBs cover 16A-1600A with fault ratings to 150kA for sub-main distribution. ACBs handle 800A-6300A with fault ratings to 150kA+ for main incomers. ACBs offer advanced protection settings and can be withdrawable.',
  },
  {
    question: 'How often should thermographic surveys be performed on MCC panels?',
    answer:
      'Industry best practice recommends annual thermographic surveys for MCCs under normal conditions. High-criticality installations or those with high harmonic content should be surveyed every 6 months. Surveys should also be conducted after significant load changes or following maintenance work.',
  },
  {
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>MCC:</strong> Centralised motor control and protection assembly
              </li>
              <li>
                <strong>Switchgear:</strong> MCB, MCCB, ACB for different current ranges
              </li>
              <li>
                <strong>Forms:</strong> BS EN 61439 separation levels (1-4)
              </li>
              <li>
                <strong>Arc Flash:</strong> PPE categories based on incident energy
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>ACB:</strong> 800A-6300A for main incomers
              </li>
              <li>
                <strong>MCCB:</strong> 16A-1600A for sub-mains
              </li>
              <li>
                <strong>Form 4b:</strong> Highest level of separation
              </li>
              <li>
                <strong>&gt;40 cal/cm sq:</strong> Live work prohibited
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A <strong>Motor Control Centre (MCC)</strong> is a floor-mounted assembly containing
              motor starters, variable speed drives, protection devices, and control equipment in a
              unified enclosure. MCCs are the backbone of industrial electrical distribution,
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white/90">
                ...
                require section isolation for any work.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Selecting the correct switchgear requires understanding current ratings, fault levels,
              and application requirements. The three main types each serve specific purposes in the
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>MCB:</strong> 0.5A-125A, up to 10kA fault rating, final circuits, fixed
                  curves
                </li>
                <li>
                  <strong>MCCB:</strong> 16A-1600A, up to 150kA fault rating, sub-mains/feeders,
                  some adjustable
                </li>
                <li>
                  <strong>ACB:</strong> 800A-6300A, up to 150kA+ fault rating, main incomer, fully
                  adjustable, withdrawable
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Icu:</strong> Ultimate short-circuit breaking capacity - maximum fault
                  current the device can interrupt (may sustain damage)
                </li>
                <li>
                  <strong>Ics:</strong> Service short-circuit breaking capacity - fault current
                  device can interrupt and remain serviceable
                </li>
                <li>
                  <strong>Icw:</strong> Rated short-time withstand current - current device can
                  carry for specified time (typically 1s) without damage
                </li>
                <li>
                  <strong>Icm:</strong> Rated short-circuit making capacity - maximum asymmetric
                  current device can close onto
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Bus bars distribute power from the incomer to individual outgoing circuits.{' '}
              <strong>BS EN 61439</strong> defines Forms of internal separation that determine how
              functional units, busbars, and terminals are segregated within the assembly.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Forms of Separation (BS EN 61439)
              </p>
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Form 1:</strong> No internal separation - opening any door exposes all
                  live parts. Lowest cost.
                </li>
                <li>
                  <strong>Form 2a:</strong> Busbars separated from functional units. Allows access
                  to units with busbars energised.
                </li>
                <li>
                  <strong>Form 2b:</strong> Form 2a plus terminals separated from busbars.
                </li>
                <li>
                  <strong>Form 3a:</strong> Separation between functional units AND from busbars.
                  Individual units can be accessed independently.
                </li>
                <li>
                  <strong>Form 3b:</strong> Form 3a plus terminals separated from busbars.
                </li>
                <li>
                  <strong>Form 4a:</strong> All Form 3a separation plus terminals separated from
                  functional units.
                </li>
                <li>
                  <strong>Form 4b:</strong> Form 4a plus terminals separated from each other.
                  Maximum protection and arc fault containment.
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Modern MCCs incorporate intelligent electronic devices (IEDs) that provide advanced
              protection, monitoring, and communication capabilities. This enables integration with
              SCADA systems, predictive maintenance, and energy management.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Modbus RTU:</strong> Serial RS485
                  </li>
                  <li>
                    <strong>Modbus TCP:</strong> Ethernet based
                  </li>
                  <li>
                    <strong>PROFIBUS:</strong> Industrial fieldbus
                  </li>
                  <li>
                    <strong>PROFINET:</strong> Industrial Ethernet
                  </li>
                  <li>
                    <strong>IEC 61850:</strong> Substation automation
                  </li>
                  <li>
                    <strong>EtherNet/IP:</strong> CIP protocol
                  </li>
                </ul>
              </div>
              <div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              An arc flash is an explosive release of energy caused by an electrical fault through
              air. Temperatures can reach 20,000 degrees C, causing severe burns, blast injuries,
              and fatalities. <strong>IEEE 1584</strong> provides methods for calculating incident
              energy levels.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Category 1:</strong> 1.2-4 cal/cm sq - AR shirt/trousers, safety glasses,
                  face shield (min 4 ATPV)
                </li>
                <li>
                  <strong>Category 2:</strong> 4-8 cal/cm sq - AR shirt/trousers, flash suit hood,
                  face shield (min 8 ATPV)
                </li>
                <li>
                  <strong>Category 3:</strong> 8-25 cal/cm sq - AR flash suit, hood with face
                  shield, AR gloves (min 25 ATPV)
                </li>
                <li>
                  <strong>Category 4:</strong> 25-40 cal/cm sq - Multi-layer AR flash suit, full
                  hood, AR gloves (min 40 ATPV)
                </li>
                <li>
                  <strong>&gt;40 cal/cm sq:</strong> Live work NOT permitted
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>IEC 61482-2:</strong> Arc flash protective clothing testing
                </li>
                <li>
                  <strong>GS38:</strong> HSE guidance on electrical test equipment
                </li>
                <li>
                  <strong>BS EN 166:</strong> Eye protection specifications
                </li>
                <li>
                  <strong>BS EN 60903:</strong> Electrical insulating gloves
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Regular maintenance ensures switchgear operates safely and reliably. BS 7671 and
              manufacturer guidelines specify testing requirements. Maintenance regimes should be
              based on criticality, environment, and operating conditions.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Industrial:</strong> 3 years maximum
                </li>
                <li>
                  <strong>Hospitals/Medical:</strong> 1 year
                </li>
                <li>
                  <strong>Fire alarms/Emergency lighting:</strong> 1 year
                </li>
                <li>
                  <strong>Hazardous areas:</strong> 1 year
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Underrating fault capacity</strong> - always verify PFC and allow safety
                  margin
                </li>
                <li>
                  <strong>Ignoring arc flash hazards</strong> - conduct studies and provide
                  appropriate PPE
                </li>
                <li>
                  <strong>Skipping thermographic surveys</strong> - hot spots indicate developing
                  faults
                </li>
                <li>
                  <strong>Neglecting breaker maintenance</strong> - trip units can drift over time
                </li>
              </ul>
            </div>
          </div>
