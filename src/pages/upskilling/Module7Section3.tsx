      ...
      <header className="px-4 sm:px-6 lg:px-8 pt-8 pb-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-4">
            <Badge variant="secondary" className="bg-elec-yellow text-black">Module 7.3</Badge>
      ...
      <footer className="px-4 sm:px-6 lg:px-8 pb-8">
        <div>
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <Link to="/study-centre/upskilling/inspection-testing-module-7-section-2" className="w-full sm:w-auto">
              <Button
                variant="outline"
            ...
            <Link to="/study-centre/upskilling/inspection-testing-module-7-section-4" className="w-full sm:w-auto">
