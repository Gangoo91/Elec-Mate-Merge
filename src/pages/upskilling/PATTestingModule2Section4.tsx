...
const inlineChecks = [
  {
    ...
    options: [
      'Voltage ≤ 50 V ac / 120 V dc, from a safety isolating source, separated from earth.',
      'Any voltage below 230 V, regardless of how it is supplied or whether it is earthed.',
      'Any low-voltage output taken from a transformer, regardless of its standards conformance.',
      'A battery supply at any voltage, separated from earth but with no defined voltage limit.',
    ],
    correctIndex: 0,
    explanation:
      'BS 7671 / BS EN 61140 define SELV by three conditions: voltage not exceeding 50 V ac (or 120 V ripple-free dc); supply from a safety isolating transformer to BS EN 61558 (or batteries / engine-driven generator separated from earth); and electrical separation from earth and from any higher-voltage circuits including PELV. The voltage limit alone is not SELV (PELV shares it but is earthed); the source alone is not SELV. All three must be met.',
  },
  {
    id: 'patm2-s4-pelv',
    question: 'How does PELV (Protective Extra-Low Voltage) differ from SELV?',
    options: [
      'PELV operates at a higher voltage limit than SELV (above 120 V dc).',
      'PELV uses a higher current but the same voltage limits as SELV.',
      "PELV shares SELV's voltage limits but is not separated from earth — it may be deliberately earthed.",
      'PELV is restricted to outdoor use, whereas SELV is for indoor circuits only.',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'BS 7671 only — the wiring regulations define the transformer construction directly.',
      'The IET Code of Practice only, as the controlling document for in-service testing.',
      'BS 3535 only, which remains the current standard for isolating transformers.',
      'BS EN 61558 (specifically BS EN 61558-2-6 for safety isolating transformers).',
    ],
    correctIndex: 3,
    explanation:
      "BS EN 61558-2-6 prescribes the construction, the insulation between primary and secondary, the basic-and-supplementary insulation between live parts and accessible parts, and the overall safety case. A bell transformer or generic mains transformer with a 12 V secondary is NOT automatically a safety isolating transformer, and a 12 V circuit it supplies is NOT automatically SELV — the transformer's standards conformance is part of the SELV verification.",
  },
  {
    id: 'patm2-s4-classiii-test',
    question: 'The IET CoP test methodology for Class III equipment is fundamentally what?',
    options: [
      'Verify the SELV supply integrity and functionally check the equipment — no IR or PE test on the SELV side.',
      'The same full sequence as Class I — PE-continuity then a 500 V dc insulation test.',
      'The same sequence as Class II — a 500 V dc insulation test to the accessible parts.',
      'No test at all, since extra-low voltage equipment is outside the scope of PAT.',
    ],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'Double insulation between live parts and accessible parts, as in a Class II appliance.',
      'SELV — Separated Extra-Low Voltage, where the supply itself is the protective measure.',
      'Basic insulation backed by a protective conductor (CPC) bonding accessible metal to earth.',
      'No protective measure is needed because the equipment carries no significant electrical energy.',
    ],
    correctAnswer: 1,
    explanation:
      'Class III uses SELV as the protective measure: supplied from a safety isolating transformer (BS EN 61558) or batteries, voltage not exceeding 50 V ac or 120 V dc, separated from earth and from higher-voltage circuits. Even direct contact with the conductors at SELV voltage cannot deliver enough current through the body to injure. The architecture differs fundamentally from Class I (CPC + disconnection) and Class II (insulation), and all three SELV conditions must be met.',
  },
  {
    id: 2,
    question: 'The voltage limits for SELV are which of the following?',
    options: [
      '110 V ac (rms) or 230 V dc, matching the reduced-low-voltage site transformer output.',
      '12 V exactly — SELV is defined as a fixed 12 V limit for both ac and dc.',
      '230 V ac with no separate dc limit applied to the circuit.',
      '50 V ac (rms) or 120 V dc (ripple-free), measured between conductors and to earth.',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Class I — the metal case must be bonded to earth through a protective conductor.',
      'Class II — double insulation between the cells and the accessible casing.',
      'Class III — battery-supplied, well below the SELV limits, separated from any higher voltage.',
      'Class 0 — basic insulation only, with no second line of protection at all.',
    ],
    correctAnswer: 2,
    explanation:
      'Battery-only equipment satisfies the Class III architecture: SELV from batteries, voltage well below 50 V ac / 120 V dc, separated from any higher-voltage source. PAT scope on the device itself is essentially formal-visual under PUWER Reg 6 — there is no mains energy and no significant electrical danger. Where the device has a charger, the charger is tested as Class I or Class II separately.',
  },
  {
    id: 4,
    question:
    ...
    options: [
      'Only if the source is a BS EN 61558 safety isolating transformer and the circuit is separated from earth and higher voltage.',
      'Always — any transformer producing a 12 V output creates a SELV circuit by definition.',
      'Only when the lighting is installed outdoors, where SELV separation is mandatory.',
      'Only if the supply cable to the fittings is buried below the required depth.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It is an oversight in the Code of Practice that future editions will correct.',
      'It is required, but carried out separately by the installer rather than the PAT operator.',
      'The portable PAT instrument is not capable of generating a 500 V dc test output.',
      'Because the protective measure is the SELV supply itself, not the insulation of the equipment.',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Just the handset that has stopped working, by formal visual and functional check.',
      'The transformer under its mains-side class, plus formal visual + functional on the SELV side.',
      'Just the transformer — once it passes, the SELV-side equipment needs no inspection.',
      'Nothing — door-entry systems are exempt from the in-service inspection regime.',
    ],
    correctAnswer: 1,
    explanation:
      'PAT scope follows the energy. The transformer (mains-side, Class I or Class II per its rating plate) gets the full regime including PE-continuity if Class I. The 24 V dc panel and handsets get formal visual + functional check; the SELV cabling between them gets visual inspection only (no IR or PE test). The boundary between mains-side and SELV-side dictates the methodology, and the transformer that creates the SELV is the focal item.',
  },
  {
    id: 7,
    question: 'How is the SELV "separation from higher-voltage circuits" verified in practice?',
    options: [
      'Visual inspection of cable routing alone, with no electrical test at the supply unit.',
      'A continuity test connected directly between the SELV conductors and the mains conductors.',
      'Visual inspection of the supply unit plus an IR test of the transformer across the supply boundary.',
      'By applying a 500 V dc insulation test directly to the SELV circuit conductors.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The charger is Class II and the USB-powered device is Class III — class depends on which side of the boundary.',
      'Both the charger and the device are Class III, since the whole chain runs at extra-low voltage.',
      'The charger is Class I, with its metal case bonded to earth through the supply lead.',
      'The charger is Class 0, relying on basic insulation only between mains and the 5 V output.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'PELV operates above the SELV voltage limits, in the reduced-low-voltage band.',
      "PELV shares SELV's voltage limits and source requirements but is not separated from earth.",
      'PELV is a measure for high-voltage equipment rather than extra-low-voltage circuits.',
      'PELV is an obsolete term withdrawn from the current wiring regulations.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Because Class III equipment is low-risk and therefore not considered important to test.',
      'Because Class III equipment is rare and rarely encountered in workplace settings.',
      'Because the electrical tests for Class III are too expensive to justify on cheap equipment.',
      'Because the protective measure is the supply, not anything inherent to the SELV equipment.',
    ],
    correctAnswer: 3,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Class III uses the supply itself as the protective measure. Voltage limited,
          source-defined, and separated from earth and from higher-voltage circuits. The PAT focus
          is the supply boundary, not the SELV equipment.
        </p>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Voltage limit.</strong> Not exceeding 50 V ac (rms) or 120 V dc (ripple-free),
              measured between conductors and between any conductor and earth. Common applications
              use 12 V, 24 V or 48 V — well within the limits.
            </li>
            <li>
              <strong>Source type.</strong> Supply from a safety isolating transformer conforming to
              BS EN 61558 (specifically BS EN 61558-2-6 for safety isolating transformers), OR from
              batteries, OR from an engine-driven generator electrically separated from earth.
              Generic mains transformers with low-voltage secondaries are NOT safety isolating
              transformers and do NOT create SELV.
            </li>
            <li>
              <strong>Separation.</strong> The SELV circuit is electrically separated from earth AND
              from any higher-voltage circuit (including PELV). The separation must be at least
              equivalent to that between mains and SELV in a safety isolating transformer.
            </li>
          </ol>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              the following requirements: the nominal voltage cannot exceed 50 V ac or 120 V dc; the
              supply must be from one of the sources specified in Reg 414.3; the conditions of
              installation specified in Reg 414.4 must be fulfilled, including electrical separation
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              construction on its mains-equivalent side. Treat as the relevant class on the LV side.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Reinforced or double insulation between windings.</strong> The primary (mains)
              winding and the secondary (SELV) winding are separated by insulation equivalent to the
              Class II protective measure — so a single insulation failure cannot bring mains
              voltage onto the SELV secondary.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              marked with the symbol of the safety isolating transformer and with the rated voltage,
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>NO IR test, NO PE-continuity test</strong> on the SELV side. Applying 500 V dc
              to a 12 V SELV circuit could damage the equipment without verifying the protective
              measure.
            </li>
            <li>
          ...
          <p>
            ...
            protective architecture is fundamentally different. The supply IS the protection, so the
            supply IS the test focus.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              under-cabinet lighting. 12 V or 24 V from a BS EN 61558 transformer or LED driver. The
              transformer / driver is the supply unit; the lights are SELV.
            </li>
            <li>
              <strong>Telecoms / signalling</strong> — telephone lines, fire-alarm cabling
              (depending on the system, may be SELV or fire-rated separation), security signalling.
            </li>
            <li>
              <strong>USB-powered equipment</strong> — the USB charger / PSU is mains-side Class II;
              the USB output is SELV; the device is Class III for protection purposes.
            </li>
            <li>
              <strong>Battery-powered equipment</strong> — torches, battery tools (when used without
              charger connected), portable electronics.
            </li>
            <li>
            ...
            <li>
              <strong>Audio-visual equipment</strong> — speaker-level connections (typically SELV),
              HDMI / display interfaces (SELV-equivalent under standards).
            </li>
          </ul>
          <p>
            Each application has the same Class III PAT logic: identify the supply, test the supply
            under its mains-side class, verify the SELV separation, formal-visual + functional on
            the SELV-side equipment.
          </p>
        </ConceptBlock>
