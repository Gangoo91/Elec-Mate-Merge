...
const DESCRIPTION =
  'Learn about Class III equipment and Safety Extra-Low Voltage (SELV) systems, including voltage limits, applications, and testing requirements.';

const quickCheckQuestions = [
  {
    id: 'm2s4-check1',
    question: 'What is the maximum voltage for SELV systems under normal conditions?',
    options: ['25V AC or 60V DC', '50V AC or 120V DC', '12V AC or 30V DC', '100V AC or 150V DC'],
    correctIndex: 1,
    explanation:
      'SELV systems are limited to 50V AC or 120V DC under normal conditions to ensure safety through low voltage.',
  },
  {
    id: 'm2s4-check2',
    ...
    correctIndex: 2,
    explanation:
      'Class III equipment must be supplied from sources with electrical separation from mains, typically through safety transformers.',
  },
  {
    id: 'm2s4-check3',
    ...
    correctIndex: 1,
    explanation:
      'The extra-low voltage in Class III equipment makes electric shock unlikely under normal conditions, reducing testing requirements.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'SELV stands for Safety Extra-Low Voltage, indicating a system designed for safety through voltage limitation.',
  },
  {
    id: 3,
    question: 'What is the key requirement for Class III equipment power supplies?',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Class III equipment is marked with the Roman numeral III symbol to indicate extra-low voltage operation.',
  },
  {
    id: 5,
    question: 'Why do Class III appliances require minimal PAT testing?',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Safety transformers with double insulation between primary and secondary provide the isolation required for SELV systems.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'SELV transformers must be located outside bathroom zones to maintain the safety integrity of the system.',
  },
  {
    id: 8,
    ...
    correctAnswer: 2,
    explanation:
      'Mobile phone charger outputs operate at SELV voltages (typically 5V), making the connected device Class III equipment.',
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      'Visual inspection is the primary requirement for Class III equipment as electrical tests are typically not required due to the inherent safety of low voltage.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'SELV circuits must have no connection to earth to maintain their safety characteristics and isolation from other circuits.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'SELV (Safety Extra-Low Voltage) specifically requires electrical separation from mains and earth. The low voltage alone is not enough - the system must be isolated through safety transformers or equivalent means to prevent any connection to higher voltages.',
  },
  {
    question: 'Do I need to PAT test laptop chargers?',
    answer:
      "The charger itself (the mains-connected unit) may need testing as it could be Class I or II depending on design. However, the laptop and its low-voltage cable are Class III and require only visual inspection. Always check the charger's classification markings.",
  },
  {
    question: 'Why are battery-powered devices considered Class III?',
    answer:
      'Battery-powered devices operate at extra-low voltage and have complete electrical separation from mains supply (when not charging). This makes them inherently safe from mains-voltage electric shock, meeting Class III requirements.',
  },
  {
    question: 'Can Class III equipment be used in bathrooms?',
    answer:
      'Yes, Class III equipment is ideal for bathrooms and other wet locations because the low voltage reduces shock risk. However, the SELV source (transformer) must be located outside the bathroom zones, with only the low-voltage circuit entering the bathroom.',
  },
  {
    question: 'What happens if a SELV transformer fails?',
    answer:
      'Safety transformers are designed so that if they fail, the secondary voltage cannot rise above SELV limits. However, the SELV source should be inspected regularly and replaced if damaged. The connected Class III equipment would stop working but should not become dangerous.',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="mb-12">
          ...
          <p className="text-white">Understanding safety through voltage limitation</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Voltage:</strong> 50V AC or 120V DC maximum
              </li>
              <li>
                <strong>Protection:</strong> Inherent safety through low voltage
              </li>
              <li>
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Battery-powered, transformer-fed, III symbol
              </li>
              <li>
                <strong>Use:</strong> Visual inspection only (minimal testing)
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Class III equipment represents the safest category of electrical appliances, using
              extra-low voltage to minimise the risk of electric shock. These devices operate at
              voltages so low that under normal conditions, contact with live parts is not
              dangerous.
            </p>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                Class III equipment is designed to operate from Safety Extra-Low Voltage (SELV)
                sources and has no internal voltages higher than the SELV limits. Protection against
                electric shock relies on the supply voltage being limited to extra-low voltage.
              </p>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>AC:</strong> 50V RMS maximum
                  </li>
                  <li>
                    <strong>DC:</strong> 120V ripple-free maximum
                  </li>
                  <li>
                    <strong>Pulsating DC:</strong> 140V peak maximum
                  </li>
                </ul>
              </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Safety Transformer Requirements
              </p>
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Double Insulation:</strong> Primary and secondary windings separated by
                  double insulation equivalent to Class II
                </li>
                <li>
                  <strong>No Earth Connection:</strong> Secondary circuit must have no connection to
                  earth or other circuits
                </li>
                <li>
                  <strong>Voltage Limitation:</strong> Output voltage limited by design, not just by
                  loading
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Cable Separation:</strong> SELV circuits must be physically separated from
                  higher voltage circuits
                </li>
                <li>
                  <strong>Marking and Identification:</strong> SELV circuits should be clearly
                  identified and marked
                </li>
                <li>
                  <strong>Access and Maintenance:</strong> Design should prevent accidental
                  connection to higher voltage circuits
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white mb-2">
                Class III equipment requires the least PAT testing of all classes because the low
                voltage makes electric shock unlikely under normal conditions.
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-elec-yellow text-sm font-medium mb-2">
                Case Study: Bathroom Mirror Light SELV System
              </p>
              <div className="text-sm text-white space-y-2">
                <p>
                  <strong>Situation:</strong> A hotel bathroom features LED mirror lighting supplied
                  from a 12V transformer. During refurbishment, an electrician discovers the
                  transformer is installed within the bathroom zone rather than outside.
                </p>
                <p>
                  <strong>Investigation:</strong> Although the LED lights are Class III and operate
                  safely at 12V, the transformer supplying them is not suitable for bathroom
                  installation and could create a safety risk.
                </p>
                <p>
                  <strong>The Issue:</strong> The SELV source (transformer) must be located outside
                  bathroom zones to maintain the safety integrity of the system.
                </p>
                <p>
                  <strong>The Solution:</strong> The transformer was relocated outside the bathroom
                  with appropriate cable routing to maintain separation between SELV and mains
                  circuits.
                </p>
                <p>
                  <strong>The Lesson:</strong> Class III equipment safety depends not just on the
                  equipment itself, but on the entire SELV system including the source and
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Testing Class III Equipment
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Ignoring the power supply</strong> - the charger/transformer may need full
                  testing
                </li>
                <li>
                  <strong>Assuming all low voltage is SELV</strong> - SELV requires specific
                  isolation
                </li>
                <li>
                  <strong>Skipping visual inspection</strong> - still essential for Class III
                </li>
                <li>
                  <strong>Not checking installation</strong> - transformer location and cable
                  routing matter
                </li>
              </ul>
            </div>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="/electrician/upskilling/pat-testing-module-2-section-5">
              Next Section
