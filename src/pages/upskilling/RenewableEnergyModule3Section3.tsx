...
import {
  ...
  FixingByRoofType,
  FlashingOrientation,
} from '@/components/study-centre/diagrams/renewablePvSiting';
...
const inlineChecks = [
  ...
  {
    id: 'm3s3-wind-uplift',
    question: 'Wind uplift on a PV array — where on the roof is the wind-uplift pressure highest?',
    options: [
...
const quizQuestions = [
  ...
  {
    id: 4,
    question: "A UK customer's roof is metal sheet (corrugated profile). Mounting approach?",
    options: [
...
const faqs = [
  {
    question:
      'What does the Risk Assessment and Method Statement (RAMS) for PV roof work need to cover?',
    answer:
  ...
  {
    question:
      "What happens if the structural assessment reveals the roof can't take the proposed array?",
    answer:
...
export default function RenewableEnergyModule3Section3() {
  ...
  useSEO({
    title: 'Roof safety, mounting & structural integration | Renewable Energy 3.3 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 3 · BS 7671:2018+A4:2026"
        title="Roof safety, mounting & structural integration"
        backTo="../renewable-energy-module-3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Work at Height Regulations 2005, structural assessment, fixings by roof type, the 70-100
          mm standoff discipline, flashing-tile waterproofing, and the PWI common-mistakes that
          drive UK PV install failures.
        </p>
        ...
        <Pullquote>
          Scaffolding goes up first. Standoff at 70-100 mm. Fixings into the rafter, not the tile.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">AVOID work at height</strong> — where reasonably
              practicable, don\'t do work at height. For PV, this rarely applies. Ground-mount and
              BIPV facade avoid roof work
            </li>
            <li>
              <strong className="text-white">PREVENT falls</strong> — collective protection: full
              perimeter scaffolding with handrail and toe-board; MEWP (cherry picker, scissor lift);
              tower scaffold for shorter installs. The typical UK standard
            </li>
            <li>
              <strong className="text-white">MINIMISE consequences</strong> — collective fall-arrest
              (safety nets); personal fall-arrest (harness + anchor + lanyard). PFAS alone is the
              fallback — only acceptable when PREVENT isn\'t reasonably practicable
            </li>
          </ul>
          <p>
            The RAMS (Risk Assessment and Method Statement) records the chosen control measures, the
            rationale, and the emergency rescue plan. RAMS is a HSE requirement under the WAH
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Single-sided vs surround</strong> — single-sided where
              access from one elevation; surround for split arrays
            </li>
            <li>
              <strong className="text-white">Working platform height</strong> — typically 1-1.5 m
              below the lowest module position
            </li>
            <li>
              <strong className="text-white">Access</strong> — ladder access from ground or stair
              access through scaffold
            </li>
            <li>
              <strong className="text-white">Duration</strong> — typical residential PV scaffolding
              5-10 days. Survey-stage estimate informs the customer (typically £500-£1,500 for a
              small domestic install)
            </li>
          </ul>
        </ConceptBlock>

        <WahHierarchy caption="WAH Regulations hierarchy diagram for PV roof work — vertical flowchart from AVOID at top to MINIMISE at bottom. AVOID branches to ground-mount / BIPV. PREVENT branches to scaffolding / MEWP / tower. MINIMISE branches to safety nets / harness fall-arrest. Annotated with WAH Regs 2005 and RAMS requirement." />
        ...
        <Pullquote>
          10-15 kg/m² added load. Visual assessment for typical roofs. Engineer for the rest.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Rafter dimensions and spacing</strong> — typical UK
              domestic: 100 × 50 mm at 400-600 mm centres. Confirm by measurement or building
              records
            </li>
            <li>
              <strong className="text-white">Timber condition</strong> — visual inspection from loft
              for decay, beetle damage, fungal growth, distortion. Probe suspect areas with awl
            </li>
            <li>
              <strong className="text-white">Existing loading</strong> — tiles + felt + insulation
              typically 50-80 kg/m². Slate heavier; thatched lighter
            </li>
            <li>
              <strong className="text-white">Modifications</strong> — any roof modifications (loft
              conversion, dormers, removed walls) flagged for structural engineer review
            </li>
            <li>
              <strong className="text-white">PV load distribution</strong> — module + mounting load
              distributed across the array footprint; confirm rafter capacity in each fixing
              location
            </li>
            <li>
              <strong className="text-white">Wind-uplift zoning</strong> — corner / edge zones
              flagged; fixings in those zones may need additional reinforcement
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Quantified structural capacity</strong> — kg/m²
              acceptable for the specific roof condition
            </li>
            <li>
              <strong className="text-white">Bracket / fixing recommendations</strong> — specific to
              rafter dimensions and timber condition. May require reinforcement
            </li>
            <li>
              <strong className="text-white">Wind-uplift analysis</strong> — BS EN 1991-1-4 applied
              to specific site / orientation / layout
            </li>
            <li>
              <strong className="text-white">Sign-off documentation</strong> — engineer\'s report
              part of the cert evidence bundle
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          70-100 mm of air. Cell temperature 10-15°C above ambient instead of 25-35°C.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Natural convection</strong> — warm air rises from cell
              surface; cooler air enters from below; airflow removes heat
            </li>
            <li>
              <strong className="text-white">70-100 mm is the manufacturer-typical spec</strong> —
              sufficient airflow for residential array sizes and UK conditions
            </li>
            <li>
              <strong className="text-white">Less than 70 mm</strong> — airflow restricted, cooling
              impaired, cell operates hotter; manufacturer warranty may be void
            </li>
            <li>
              <strong className="text-white">More than 100 mm</strong> — diminishing returns;
              wind-uplift load increases; aesthetic impact
            </li>
            <li>
              <strong className="text-white">Roof-integrated PV (BIPV)</strong> — no standoff. Cell
              temperatures higher; design must account for higher temperature derate
            </li>
          </ul>
        </ConceptBlock>
        ...
        <StandoffCrossSection caption="Roof standoff cross-section — side view of module sitting on rail bracket. Standoff dimension labelled 70-100 mm between module backsheet and tile / slate surface. Airflow arrows showing convection. Annotated: cell temperature 10-15°C above ambient with standoff vs 25-35°C without." />
        ...
        <Pullquote>
          Tile: flashing-tile through to rafter. Slate: slate-hook around. Metal: clamp-on-rib.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Generic L-bracket + sealant</strong> — sealant degrades
              within 2-5 years; water enters; loft damage; insurance claim; rectification cost
            </li>
            <li>
              <strong className="text-white">Lead flashing handcrafted on-site</strong> — depends on
              installer skill; the flashing-tile is more consistent and warrantied
            </li>
            <li>
              <strong className="text-white">Cracked tile around fixing</strong> — penetrating an
              unsupported tile causes localised cracking; flashing-tile is designed for the
              penetration
            </li>
          </ul>
          <p>
            Common manufacturers: K2 Systems, Schletter, MAGE / Solar-Mountage, Conergy. The cert
            evidence bundle records the flashing-tile manufacturer and part number.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Slate hook material</strong> — stainless steel
              (typically 316) for corrosion resistance over 25-year life
            </li>
            <li>
              <strong className="text-white">Batten condition</strong> — older slate roofs may have
              decayed battens; structural assessment confirms batten + rafter integrity
            </li>
            <li>
              <strong className="text-white">Slate fragility</strong> — handling care during
              install; some slates may need replacement
            </li>
            <li>
              <strong className="text-white">Bonding</strong> — slate roofs may have lead flashings;
              cert evidence bundle shows bonding arrangement
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Clamp-on-rib (preferred)</strong> — no penetration; no
              waterproofing risk; simple install
            </li>
            <li>
              <strong className="text-white">Rivet-through (when rib doesn\'t suit clamp)</strong> —
              rivet through sheet into purlin; EPDM butyl pad above rivet
            </li>
            <li>
              <strong className="text-white">Standing-seam (raised seam profile)</strong> —
              specialised clamp that wraps around the seam
            </li>
            <li>
              <strong className="text-white">Electrical bonding</strong> — metal sheet may become
              extraneous-conductive-part; bonding to supplementary bonding network may be required
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Membrane protection</strong> — slip pads / rubber pads
              between frame and membrane to prevent abrasion and puncture
            </li>
            <li>
              <strong className="text-white">Drainage</strong> — frame must not obstruct roof
              drainage paths
            </li>
            <li>
              <strong className="text-white">Wind-uplift</strong> — flat roofs have high uplift at
              perimeter / corner zones; ballast calculated per BS EN 1991-1-4
            </li>
            <li>
              <strong className="text-white">Array tilt</strong> — typical flat-roof PV uses 10-15°
              (gentle) to balance yield vs wind / snow load
            </li>
            <li>
              <strong className="text-white">Inter-row spacing</strong> — needed to avoid
              self-shading (front rows shading back rows in low-elevation winter sun)
            </li>
          </ul>
        </ConceptBlock>

        <FixingByRoofType caption="Fixing methods by roof type — four-panel diagram. Panel 1 (tile): flashing-tile cross-section with raised collar downslope, bolt into rafter, EPDM gasket. Panel 2 (slate): slate-hook over batten, no penetration of slate. Panel 3 (metal-sheet): clamp-on-rib vs rivet-through with EPDM butyl pad. Panel 4 (flat): ballasted tilted frame with slip pads on membrane." />
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Centre zone (interior)</strong> — lowest wind pressure;
              typical PV placement zone
            </li>
            <li>
              <strong className="text-white">Edge zone (along ridge / eaves / verges)</strong> —
              moderate pressure; typically 1.2-1.5× centre zone
            </li>
            <li>
              <strong className="text-white">Corner zone (within ~1 m of corner)</strong> — highest
              pressure; typically 1.5-2× centre zone; PV modules generally avoided here
            </li>
          </ul>
          <p>
            UK design wind speed 22-30 m/s by region per BS EN 1991-1-4 Annex NA. The structural
            assessment quantifies the force per module; the bracket and fixing pull-out capacity
            must exceed it with appropriate factor of safety.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Flashing-tile orientation</strong> — raised collar on
              downslope side; water flows from upper tile, around the collar, onto the lower tile
            </li>
            <li>
              <strong className="text-white">EPDM gasket</strong> — intact, undamaged, square on the
              bracket-to-flashing interface; bolt torqued to manufacturer spec
            </li>
            <li>
              <strong className="text-white">Adjacent tiles</strong> — re-fitted to lap correctly
              over the flashing-tile
            </li>
            <li>
              <strong className="text-white">Install photos</strong> — taken at each fixing showing
              flashing-tile orientation, EPDM gasket, bracket bolt; archived in cert evidence bundle
            </li>
            <li>
              <strong className="text-white">5-yearly inspection</strong> — customer information
              pack lists periodic inspection
            </li>
          </ul>
        </ConceptBlock>

        <FlashingOrientation caption="Flashing-tile correct vs incorrect orientation — side-by-side. Correct: raised collar downslope, water flows over the collar and around it. Incorrect: raised collar upslope, water pools above the penetration and enters through the bolt thread / gasket. Annotated with water-flow arrows and failure mode." />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-3-section-2')}
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-3-section-4')}
