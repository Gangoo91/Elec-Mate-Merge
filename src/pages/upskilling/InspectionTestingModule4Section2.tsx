    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reg 643.3, Table 64 and the A4:2026 redraft of 643.3.3. Which DC voltage applies to which
          circuit, the minimum acceptance values, and the 250 V re-test that protects connected
          equipment.
        </p>
        ...
        >
          <p>
            ...
            clarify where to disconnect, and add a named follow-up test. Both are now in 643.3.3 as
            concrete steps rather than implied good practice.
          </p>
          <p>
            The other A4 change in 643.3 is at the geometry level: the regulation makes plain that
            Table 64 applies whenever an insulation resistance verification is being done, including
            between non-earthed protective conductors and Earth. The structure is the same as
            previous editions — three rows, three voltages, three minimums — but the wording now
            removes any ambiguity about when the table is the correct authority.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            hence the 250 V row and the relaxed 0.5 MΩ minimum. The middle row is where almost every
            domestic and commercial circuit lives: 230 V single-phase final circuits and 400 V
            three-phase distribution both fall in &ldquo;up to and including 500 V&rdquo;. The third
            row is rare in domestic and commercial work but routine on industrial and utility-scale
            supplies.
          </p>
          <p>
        ...
        >
          <p>
            ...
            circuit you have L1-L2, L1-L3, L2-L3, plus each line to N — six combinations in theory.
            Multifunction testers automate this with a single button-press through an internal
            switching matrix; the reading reported is the worst case across all combinations.
          </p>
          <p>
            Limb (b) is between live conductors and the protective conductor. The regulation&apos;s
            explicit permission to link L and N together for this measurement turns what would be
            two readings into one — the meter sees the combined live conductors as one node and
            reads through to E. On a final circuit this is the everyday pattern. Where the
            regulation forbids linking is implicit: any circuit where N is being tested as an
            independent live conductor (rare in standard installations, relevant on some IT systems)
            requires the L-N link to be left off.
          </p>
          <p>
            ...
            end-to-end will read open (∞) on the L–E test even if the cable insulation between L and
            the CPC is perfect — because the test loop is open. That is why the Reg 643.2 continuity
            test sits before insulation resistance in the Reg 643 sequence: continuity confirms the
            CPC is in place, then IR can rely on the CPC as its return path.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            insulation resistance tests as it may influence the results of the test.&rdquo; That is
            the regulation pointing you to the device documentation as the source of truth for
          ...
          <p>
            ...
            influence failure mode is a measurement problem: the SPD&apos;s MOV starts to conduct in
            the few hundreds of volts, the meter reads the MOV&apos;s leakage path in parallel with
            the cable insulation, the reading drops well below the cable&apos;s true value, the test
            &ldquo;fails&rdquo; spuriously. The damage failure mode is a hardware problem: the
            thyristor stack in a dimmer is rated for the working voltage of the circuit (a few
            hundred volts peak), the 500 V DC test punches through it, the dimmer is destroyed.
          </p>
          <p>
            The 250 V re-test is engineered around both. 250 V DC is below the breakdown of the vast
            majority of modern electronic loads, so the equipment survives. It is also above the
            working AC peak of a 230 V circuit (≈325 V peak when the AC mains is at peak — though
            the 250 V test is DC and is applied with the circuit isolated, the figure gives the
            right intuition). A 1 MΩ minimum at 250 V DC catches genuine insulation breakdowns
          ...
          whatToDo={
            <>
              <span className="block">
                Stop. The reading almost certainly reflects the SPD conducting at 500 V DC, not the
                cable. Procedure:
              </span>
              <span className="block">
        ...
        >
          <p>
            The full physics matter when the reading misbehaves. Three things happen when you apply
            500 V DC across a cable:
          </p>
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              capacitance. On a 50 m run of T&amp;E this is fractions of a second. On a 200 m run of
              large SWA it can be several seconds.
            </li>
            <li>
              <strong>Polarisation / absorption current</strong> — dielectric materials reorient
              their molecular dipoles under DC stress. This produces a slowly decaying current that
              takes seconds to a minute to settle. On clean modern cable insulation this current is
              small; on aged PVC or damp cable it can be significant and is itself a diagnostic
              indicator (used in the so-called Polarisation Index test on motors).
            </li>
            <li>
          ...
          <p>
            ...
            continuously circulate capacitive current. The reading would be dominated by capacitive
            impedance, not insulation resistance, and would change with cable length, cable type and
            frequency. AC also stresses the dielectric at the peak of the waveform, which on an
            RMS-rated AC test instrument is approximately 1.41× the displayed RMS value — meaning a
            &ldquo;500 V AC&rdquo; test would actually expose the insulation to 707 V peak. DC at
            500 V is exactly 500 V, applied steadily.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The 1.0 MΩ minimum in Table 64 is a pass/fail threshold for compliance — not the target
            value for new work. The relationship between insulation resistance and leakage current
            is straightforward:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              installation with several circuits at this level can accumulate enough leakage on the
              upstream RCD to cause nuisance tripping.
            </li>
          </ul>
          <p>
            The 0.5 MΩ floor for SELV/PELV reflects the fact that the working voltage is much lower
            (≤50 V AC), so the leakage current at the floor is also much lower:
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              from Reg 643.3.1(b). With L and N linked, this is one reading. The N-E column on some
              forms is for the case where the link is not used; if you used the link, write the
              reading in L-E and put a dash or &ldquo;link&rdquo; in N-E.
            </li>
            <li>
          ...
          <p>
            The A4:2026 model forms tightened the wording around &ldquo;all measured values shall be
            recorded&rdquo;. A single reading where two were taken is a procedural defect on the
            certificate, even if both readings passed.
          </p>
        </ConceptBlock>
