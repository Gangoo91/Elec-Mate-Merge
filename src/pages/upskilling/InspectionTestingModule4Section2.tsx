...
const DESCRIPTION =
  'Learn which test voltages to use for different circuit types and why voltage selection matters for safe, accurate IR testing.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'SELV and PELV circuits are tested at 250V DC to avoid damaging their lower-rated insulation.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      '400V is below 500V, so 500V DC test voltage is appropriate for three-phase 400V systems.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "250V doesn't stress 230V-rated insulation sufficiently. Weaknesses may not be revealed, giving false confidence in poor insulation.",
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      '230V circuits are tested at 500V DC per BS 7671 Table 6A. This applies to all LV circuits up to 500V nominal.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Circuits with nominal voltage between 500V and 1000V are tested at 1000V DC per BS 7671.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'The test voltage stresses insulation enough to reveal weaknesses, while not being high enough to damage good insulation.',
  },
  {
    id: 5,
    ...
    correctAnswer: 2,
    explanation:
      'SELV circuit insulation is only rated for extra-low voltage. Applying 500V could permanently damage the insulation.',
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation:
      '400V is below the 500V threshold, so 500V DC test voltage is appropriate for three-phase 400V systems.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'BS 7671 Table 6A specifies the DC test voltages for insulation resistance testing based on circuit nominal voltage.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'The minimum acceptable insulation resistance of 1 MΩ applies regardless of which test voltage is used.',
  },
  {
    id: 9,
    ...
    correctAnswer: 0,
    explanation:
      '24V circuits (below 50V) are classified as extra-low voltage and tested at 250V DC.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'A 500V-only instrument cannot perform compliant insulation tests on SELV/PELV circuits, which require 250V.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Test voltages are approximately double the circuit's nominal voltage to stress the insulation adequately. This reveals weaknesses without being so high as to cause breakdown of good insulation. It's a balance between thorough testing and avoiding unnecessary stress.",
  },
  {
    question: 'Can I use 500V on SELV circuits?',
    answer:
      'No. SELV circuits operate at extra-low voltage (typically 12V or 24V) and their insulation may not withstand 500V test voltage. Use 250V DC maximum to avoid insulation damage on these circuits.',
  },
  {
    question: 'What if the instrument only has 500V?',
    answer:
      "For SELV/PELV circuits, you cannot perform a compliant test with a 500V-only instrument. Either use an instrument with 250V range, or record that the test couldn't be performed with appropriate voltage.",
  },
  {
    question: 'When would I use 1000V DC?',
    answer:
      "1000V DC is used for systems with nominal voltages between 500V and 1000V, such as 660V industrial motor circuits. It's also sometimes used for enhanced testing of HV cable insulation, though specialist equipment may be required.",
  },
  {
    question: 'Does higher test voltage give more accurate results?',
    answer:
      "Not necessarily. Using voltage higher than specified can stress insulation unnecessarily and may even cause breakdown, giving false 'fail' results. Always use the voltage appropriate for the circuit being tested.",
  },
  {
    question: 'What about testing 400V three-phase circuits?',
    answer:
      '400V three-phase systems are tested at 500V DC. The line-to-neutral voltage (230V) and line-to-line voltage (400V) are both below the 500V threshold, so 500V test voltage is appropriate.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>SELV/PELV:</strong> 250V DC test voltage
              </li>
              <li>
                <strong>Up to 500V:</strong> 500V DC test voltage
              </li>
              <li>
                <strong>500V-1000V:</strong> 1000V DC test voltage
              </li>
              <li>
                <strong>Reference:</strong> BS 7671 Table 6A
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Match:</strong> Voltage to circuit rating
              </li>
              <li>
                <strong>Protect:</strong> Don't damage equipment
              </li>
              <li>
                <strong>Document:</strong> Record voltage used
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Test voltages are specified in BS 7671 Table 6A based on circuit nominal voltage:</p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p>
              <strong className="text-white">SELV</strong> (Separated Extra-Low Voltage) and{' '}
              <strong className="text-white">PELV</strong> (Protective Extra-Low Voltage) circuits
              operate at 50V AC or 120V DC maximum.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Warning:</strong> Using 500V on these circuits risks damaging insulation not
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Test voltages are approximately twice the circuit voltage because:</p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Before each test, verify instrument is set to correct voltage for the circuit type
                </li>
