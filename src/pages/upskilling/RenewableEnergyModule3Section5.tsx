...
const faqs = [
  {
    question:
      "What's the difference between functional bonding, protective earthing, and equipotential bonding?",
    answer:
  ...
  {
    question:
      'How does the inverter manufacturer specify whether functional bonding is required or permitted?',
    answer:
  ...
  {
    question:
      'How does the IET CoP for Grid-Connected Solar PV Installations cover bonding and lightning?',
    answer:
...
export default function RenewableEnergyModule3Section5() {
  ...
  useSEO({
    title: 'Functional bonding, DC earthing & lightning | Renewable Energy 3.5 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 5 · BS 7671:2018+A4:2026"
        title="Functional bonding, DC earthing & lightning"
        backTo="../renewable-energy-module-3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reg 712.542.102 functional bonding (galvanic isolation conditions, single-point), Reg
          712.521.102 lightning-loop minimisation, equipotential bonding of the array, SPDs per BS
          EN 61643, and BS EN 62305 LPS integration.
        </p>
        ...
        <Pullquote>
          Single-point bonding. DC and bonding side-by-side. SPDs on both sides.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Protective earthing (CPC)</strong> — earth conductor to
              exposed-conductive-parts of Class I equipment (inverter chassis, metal combiner
              enclosure). Provides fault-current return path. Mandatory for Class I equipment
            </li>
            <li>
              <strong className="text-white">Equipotential bonding</strong> — bonding conductors
              connect all metal structures (module frames, rails, metal mounting structure) so
              they\'re at the same potential. Achieves safety in fault conditions and lightning
              equipotentialisation. Mandatory on PV installs
            </li>
            <li>
              <strong className="text-white">Functional bonding (Reg 712.542.102)</strong> —
              optional bonding of one DC polarity to earth for system functional reasons. ONLY safe
              with galvanically-isolated inverters. ONLY applied when module manufacturer specifies.
              Single-point only
            </li>
            <li>
              <strong className="text-white">Supplementary bonding</strong> — additional bonding of
              extraneous-conductive-parts where the structural / electrical context makes them
              fault-current paths. May apply to metal-sheet roof surfaces
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Module frame to rail</strong> — module clamp provides
              electrical contact between the frame and the rail. Manufacturer-specified clamp +
              torque
            </li>
            <li>
              <strong className="text-white">Rail-to-rail joints</strong> — rail joiners with
              anti-corrosion gel; electrical continuity tested per BS EN 62446-1 commissioning
            </li>
            <li>
              <strong className="text-white">Rail to bonding conductor</strong> —
              manufacturer-supplied lug or clamp on the rail; bonding conductor (typically minimum 4
              mm² copper equivalent (Reg 712.542.3.101), green/yellow per BS 7671 Table 54.8)
            </li>
            <li>
              <strong className="text-white">Bonding conductor route to inverter</strong> —
              alongside the DC conductors (minimise lightning loop per Reg 712.521.102); same
              conduit / containment where possible
            </li>
            <li>
              <strong className="text-white">Termination at inverter / MET</strong> — single point;
              either at inverter earth terminal or at building MET (or local PV earth bar feeding
              the MET)
            </li>
          </ul>
        </ConceptBlock>

        <EquipotentialBonding caption="PV equipotential bonding system diagram — top-down view of array with mounting rails. Each module frame clamped to rail; rail-to-rail joints with anti-corrosion gel; single bonding conductor from rail to inverter location; bonding conductor routed alongside DC conductors (loop minimisation per Reg 712.521.102); termination at building MET. Annotated with conductor sizes and BS 7671 Table 54.8 reference." />
        ...
        <ContentEyebrow>
          Reg 712.542.102 — functional bonding (galvanic isolation conditions)
        </ContentEyebrow>

        <Pullquote>
          Galvanic isolation. Module manufacturer-specified. Single point. Otherwise: don\'t.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Module manufacturer datasheet specifies it</strong> —
              typically marked "negative pole earthed" or "positive pole earthed" — some SunPower,
              some n-type / TOPCon, some thin-film modules
            </li>
            <li>
              <strong className="text-white">Inverter is galvanically isolated</strong> —
              transformer between DC and AC stages. Inverter datasheet states "transformer-isolated"
              or "galvanic isolation"
            </li>
            <li>
              <strong className="text-white">Single bonding point</strong> — at the combiner or
              inverter; not at module level; not at multiple points (multiple = earth loops, EMI,
              lightning hazard)
            </li>
            <li>
              <strong className="text-white">Bonding conductor</strong> — connected from the
              specified DC polarity to the building earthing system; sized per BS 7671 Table 54.8
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — records the
              manufacturer datasheets (module + inverter), the design decision, the single
              bonding-point location and conductor size
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Module datasheet</strong> — extracts showing the
              bonding requirement
            </li>
            <li>
              <strong className="text-white">Inverter datasheet</strong> — extracts showing the
              compatibility statement
            </li>
            <li>
              <strong className="text-white">Design decision</strong> — &ldquo;functional bonding
              not applied; inverter internal circuitry provides the manufacturer-specified leakage
              management&rdquo;
            </li>
            <li>
              <strong className="text-white">Cross-check at commissioning</strong> — inverter
              setting matches the module type; leakage detection thresholds verified
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          DC and bonding side-by-side. Same conduit if possible. Minimise the loop area.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Route DC + bonding side-by-side</strong> — same path
              from array to inverter / combiner. Minimises the enclosed area to a few square
              millimetres
            </li>
            <li>
              <strong className="text-white">Same conduit / containment</strong> — when practical,
              route DC positive, DC negative, and equipotential bonding conductor in the same
              conduit or strapped together
            </li>
            <li>
              <strong className="text-white">Avoid splitting</strong> — don\'t take the bonding
              conductor down one side of the roof while the DC goes the other; don\'t route bonding
              outside the building while DC is inside
            </li>
            <li>
              <strong className="text-white">Cable strapping</strong> — where conductors can\'t
              share a conduit, strap them together at intervals (typically every 1-2 m)
            </li>
            <li>
              <strong className="text-white">Multi-conductor cable</strong> — some PV cable
              manufacturers offer cables with integrated positive, negative, and bonding conductors
              in a single sheath — automatically achieves minimal loop area
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Type-2 SPDs typical UK residential. Sacrificial. Replace after a strike event.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">DC-side SPD per BS EN 61643-31</strong> — formerly BS
              EN 50539-11. Type-2 (Class II) for typical residential. In = 5-20 kA, Imax = 20-40 kA,
              Up ≤ inverter max DC × 0.8
            </li>
            <li>
              <strong className="text-white">AC-side SPD per BS EN 61643-11</strong> — Type-2 (Class
              II) for typical residential. Same In / Imax / Up criteria scaled to AC voltage
            </li>
            <li>
              <strong className="text-white">Location DC</strong> — at the combiner box or at the
              inverter DC input. Closer to the array entry point is better (catches the spike before
              it propagates)
            </li>
            <li>
              <strong className="text-white">Location AC</strong> — at the consumer unit (covers the
              AC circuit feeding the inverter) OR at the inverter AC output (covers the inverter AC
              stage)
            </li>
            <li>
              <strong className="text-white">Indicator</strong> — SPDs have a status window / flag
              indicating whether they\'ve operated. Routine visual inspection checks the status.
              After a known strike event, electrical test to confirm function
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Confirm LPS class</strong> — BS EN 62305 LPS classes
              I-IV based on risk assessment. Higher class = closer-spaced air terminations
            </li>
            <li>
              <strong className="text-white">PV within protected zone</strong> — air-termination
              grid casts a cone of protection; PV array entirely within the cone (array tips not
              above air terminations)
            </li>
            <li>
              <strong className="text-white">Separation distance</strong> — minimum separation
              between PV components and LPS air terminations per BS EN 62305-3 (typically 0.5-1 m
              depending on risk class)
            </li>
            <li>
              <strong className="text-white">Bonding integration</strong> — PV equipotential bonding
              connects to LPS bonding network at a single point
            </li>
            <li>
              <strong className="text-white">SPDs per BS EN 62305-4</strong> — multi-zone SPD
              strategy (Type-1 at LPS interface, Type-2 at PV combiner / inverter, etc.)
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — records the LPS class,
              the integration design, the SPD strategy, and the structural / electrical sign-off
            </li>
          </ul>
        </ConceptBlock>
