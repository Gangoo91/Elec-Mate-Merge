...
const inlineChecks = [
  {
    id: 'elm5-s1-prereq',
    question:
      'Before energising an emergency lighting installation, which checks must be complete?',
    options: [
  ...
  },
  {
    id: 'elm5-s1-photo',
    question:
      'BS 5266-1:2025 has introduced an explicit photometric verification requirement. When is it carried out?',
    options: [
  ...
  },
  {
    id: 'elm5-s1-switchon',
    question:
      'During the switch-on test (mains-fail simulation), all luminaires must operate within what response time?',
    options: [
  ...
  },
  {
    id: 'elm5-s1-cert',
    question:
      'What is the formal output of initial inspection and verification of an emergency lighting installation?',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'Which standards govern initial inspection and verification of an emergency lighting installation?',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'During pre-energisation visual inspection, which of the following is NOT typically checked?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'BS 5266-1:2025 has introduced an explicit five-yearly photometric verification. What does this mean in practice for the inspector?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'Which of the following BS 7671 Part 6 tests are relevant to an emergency lighting circuit?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'What documentation is required at handover, in addition to the acceptance certificate?',
    options: [
  ...
  },
  {
    id: 9,
    question:
      'Who is the "competent person" entitled to sign the BS 5266-1:2025 acceptance certificate?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS 5266-1:2025 commissioning of an emergency lighting installation: documentation review,
          pre-energisation visual and mechanical, BS 7671 Part 6 electrical verification,
          photometric survey (the 2025 update made this an explicit five-yearly recurring duty),
          switch-on test, three-hour duration test, recovery confirmation, and the acceptance
          certificate that transfers the installation from installed to commissioned.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>BS 7671:2018+A2:2022 Part 6</strong> — the underlying electrical verification:
              visual, continuity, IR, polarity, Zs, RCD operation, ADS compliance. Applies to the
              wiring of the emergency lighting circuits exactly as it does to any other circuit. No
              exemption.
            </li>
            <li>
              <strong>BS 5266-1:2025</strong> — the UK code of practice. Defines the
              emergency-lighting-specific design (luminaire positions, escape route definition, lux
              levels, response classes) and the commissioning verification (visual against design,
              switch-on test, duration test, photometric survey, acceptance certificate model form).
              The 2025 update is the current document.
            </li>
            <li>
              <strong>BS EN 50172:2024</strong> — the European system standard for emergency escape
              lighting. Defines the test cycles (functional monthly, duration annually), the
              response time classes, the system-level requirements. Underpins BS 5266-1.
            </li>
            <li>
              <strong>BS EN 50171:2021</strong> — central battery systems. Where the installation
              uses a central battery (rather than self-contained luminaires), this is the standard
              governing the central battery design, charging, monitoring, and recovery. Applies in
              addition to BS 5266-1.
            </li>
            <li>
              <strong>Regulatory Reform (Fire Safety) Order 2005</strong> — the LEGAL driver.
              Article 14 places the duty for emergency escape route lighting on the responsible
              person; Article 17 places the duty for ongoing maintenance; Article 23 places the duty
              for record-keeping. Compliance with the technical standards demonstrates discharge of
              these legal duties.
            </li>
          </ul>
          <p>
            At commissioning, the inspector is verifying compliance with a stack of documents at
            once. The acceptance certificate is the single piece of paper that records that
            compliance — but the verification behind it is multi-layered.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Before a new emergency lighting installation is taken into service, it shall be
              subjected to inspection and tests sufficient to verify that the installation has been
              carried out in accordance with the design and that it operates satisfactorily under
              emergency conditions. The verification shall include visual inspection, electrical
              testing in accordance with BS 7671, photometric verification on the defined escape
              route, a switch-on test simulating mains failure, and a full duration test of the
              rated emergency operating time.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Periodic photometric (five-yearly).</strong> Previously, the commissioning lux
              survey was sometimes the last lux measurement ever taken, with later periodic testing
              relying on functional and duration tests only. The 2025 standard makes a five-yearly
              point-by-point lux survey explicit. This catches gradual luminaire output decay (LED
              depreciation, optic fogging, lamp ageing).
            </li>
            <li>
              <strong>Acceptance certificate model form.</strong> The model form has been reissued
              with new fields including the five-year photometric reference, a competence
              declaration, and an explicit departures section. Use the 2025 model form, not a legacy
              template.
            </li>
            <li>
              <strong>Competence.</strong> The 2025 standard is firm on competence — documented
              training, current qualification, procedural framework. Third-party schemes (BAFE
              SP203-4) are explicitly recognised as the route to demonstrate competence.
            </li>
            <li>
              <strong>Departures.</strong> Some past-practice departures are now non-compliance —
              most notably missing periodic photometric, missing logbook, missing competence record.
              The competent person must read the 2025 text on what is and is not acceptable as a
              departure.
            </li>
            <li>
              <strong>Documentation pack.</strong> The 2025 standard tightens the handover
              documentation pack — design data, as-built drawings, manuals, logbook, training.
              Missing items are now non-compliance.
            </li>
          </ul>
          <p>
            The thread running through the 2025 updates: assumptions are no longer enough. Lux
            output is verified, not assumed. Competence is documented, not implied. Departures are
            written and agreed, not waved through.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Documentation review.</strong> Design lux calculation, as-built drawings,
              manufacturer technical / installation manuals, photometric data sheets,
              cause-and-effect description (where staged or zoned operation is provided). Verify all
              are on file before site work begins.
            </li>
            <li>
              <strong>Pre-energisation visual and mechanical inspection.</strong> Luminaire
              positions match the as-built drawing; cable type meets fire-resistance specification;
              fixings are mechanical (e.g. metal P-clips, not plastic ties — fire-resistant cable on
              plastic ties fails first); mounting heights, orientations, and obstructions per
              design; supply arrangements; battery state (self-contained luminaires) or central
              battery state.
            </li>
            <li>
              <strong>BS 7671 Part 6 electrical verification.</strong> Continuity of protective
              conductors; insulation resistance; polarity; earth fault loop impedance (Zs) at most
              distant point of each emergency circuit; RCD operating time where RCD protection
              provided; ADS compliance. Same Part 6 tests as any circuit.
            </li>
            <li>
              <strong>Energise and initial charge.</strong> Apply mains and allow the
              manufacturer-specified charge period (typically 24 h for self-contained internal
              batteries; per manufacturer for central battery systems). Without full charge, the
              duration test is invalid.
            </li>
            <li>
              <strong>Initial photometric survey.</strong> Point-by-point lux meter readings on the
              defined escape route, in emergency mode (mains off, system on battery), at the height
              specified by the design (typically 0.2 m above floor for spatial illumination),
              recorded against design calculation and BS EN 1838 minima (1 lx escape route, 0.5 lx
              anti-panic, 15 lx high-risk).
            </li>
            <li>
              <strong>Switch-on test (mains-fail simulation).</strong> Interrupt the local supply to
              each emergency-lit area in turn, observe and time the changeover at each luminaire,
              verify response class (0.5 s / 5 s / 15 s) per design.
            </li>
            <li>
              <strong>Full 3-hour duration test.</strong> Run the system on emergency power for the
              rated duration (3 h is standard; some applications specify 1 h — design dependent). At
              the end, every luminaire must still be illuminated and achieving the minimum design
              lux.
            </li>
            <li>
              <strong>Recovery confirmation.</strong> After restoration of mains, the batteries
              (self-contained or central) must recharge to ≥ 80% of rated capacity within 24 h per
              BS EN 50171/50172.
            </li>
            <li>
              <strong>BS 5266-1:2025 acceptance certificate.</strong> Issue the model-form
              certificate signed by the competent person. Include any departures with technical
              justification and risk assessment.
            </li>
            <li>
              <strong>Documentation pack handover.</strong> Drawings, calculations, manuals,
              certificates, logbook starter, manufacturer literature, spares list,
              responsible-person briefing summary.
            </li>
          </ol>
          <p>
            The sequence is the sequence. Skipping or reordering invalidates the verification. The
            2025 standard expects this discipline; the acceptance certificate signed against an
            out-of-order verification is not defendable.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="120" y="40" fill="#FBBF24" fontSize="11" fontWeight="bold">
              1 · Documentation review
            </text>
            <text x="120" y="55" fill="rgba(255,255,255,0.7)" fontSize="10">
              Design lux calc · as-built drawings · manuals · cause-and-effect
            </text>
            <line
              x1="410"
              y1="64"
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="120" y="102" fill="#FBBF24" fontSize="11" fontWeight="bold">
              2 · Pre-energisation visual + mechanical
            </text>
            <text x="120" y="117" fill="rgba(255,255,255,0.7)" fontSize="10">
              Luminaire positions · cable type/fire-resistance · fixings · mounting · supply
            </text>
            <line
              x1="410"
              y1="126"
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="120" y="164" fill="#22D3EE" fontSize="11" fontWeight="bold">
              3 · BS 7671 Part 6 electrical verification
            </text>
            <text x="120" y="179" fill="rgba(255,255,255,0.7)" fontSize="10">
              Continuity · IR · polarity · Zs · RCD · ADS
            </text>
            <line
              x1="410"
              y1="188"
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="120" y="226" fill="#A855F7" fontSize="11" fontWeight="bold">
              4 · Energise and charge
            </text>
            <text x="120" y="241" fill="rgba(255,255,255,0.7)" fontSize="10">
              Manufacturer-specified period (typically 24 h)
            </text>
            <line
              x1="410"
              y1="250"
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="120" y="288" fill="#FBBF24" fontSize="11" fontWeight="bold">
              5 · Initial photometric survey (NEW emphasis 2025)
            </text>
            <text x="120" y="303" fill="rgba(255,255,255,0.7)" fontSize="10">
              Point-by-point lux on escape route · BS EN 1838 minima · 1 lx / 0.5 lx / 15 lx
            </text>
            <line
              x1="410"
              y1="312"
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="120" y="350" fill="#22D3EE" fontSize="11" fontWeight="bold">
              6 · Switch-on test (mains-fail simulation)
            </text>
            <text x="120" y="365" fill="rgba(255,255,255,0.7)" fontSize="10">
              Every luminaire transitions within design class · 0.5 s / 5 s / 15 s
            </text>
            <line
              x1="410"
              y1="374"
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="120" y="412" fill="#22D3EE" fontSize="11" fontWeight="bold">
              7 · Full 3-hour duration test
            </text>
            <text x="120" y="427" fill="rgba(255,255,255,0.7)" fontSize="10">
              Sustain rated duration on battery · all luminaires illuminated at end
            </text>
            <line
              x1="410"
              y1="436"
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="120" y="474" fill="#A855F7" fontSize="11" fontWeight="bold">
              8 · Recovery confirmation
            </text>
            <text x="120" y="489" fill="rgba(255,255,255,0.7)" fontSize="10">
              Recharge to ≥ 80% within 24 h · BS EN 50171/50172
            </text>
            <line
              x1="410"
              y1="498"
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="120" y="536" fill="#22C55E" fontSize="11" fontWeight="bold">
              9 · BS 5266-1:2025 acceptance certificate
            </text>
            <text x="120" y="551" fill="rgba(255,255,255,0.7)" fontSize="10">
              Model form · competent person signature · departures recorded
            </text>
            <line
              x1="410"
              y1="560"
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="120" y="598" fill="#22C55E" fontSize="11" fontWeight="bold">
              10 · Documentation pack handover
            </text>
            <text x="120" y="613" fill="rgba(255,255,255,0.7)" fontSize="10">
              Drawings · calcs · manuals · logbook starter · responsible-person brief
            </text>

            {/* Footer */}
            <text x="410" y="650" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9">
              Each step gates the next — out-of-order verification is invalid even if individual
              readings are good
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Luminaire positions and references.</strong> Every luminaire shown on the
              as-built present at the indicated position; every luminaire on site referenced on the
              as-built. Mismatches are common in first-fix; resolve them before commissioning.
            </li>
            <li>
              <strong>Cable type and fire-resistance.</strong> The cable specified in the design is
              the cable installed (e.g. enhanced fire-resistance per BS EN 50200 PH 30/60/120 class
              — design-dependent). Cable markings visible at junctions, panel terminations, and
              accessible drop-points.
            </li>
            <li>
              <strong>Fixings.</strong> Fire-resistant cable on plastic cable ties is a system
              failure waiting to happen — the ties fail at low temperatures and the cable falls.
              Metal P-clips, metal cable cleats, or fire-resistant cable trunking are the correct
              fixings. ICEL guidance and BS 5266-1 are explicit on this.
            </li>
            <li>
              <strong>Mounting heights, orientations, obstructions.</strong> Luminaires mounted at
              the height the design assumed (changes affect lux delivery); orientation correct
              (escape-route exit signs visible from the direction of escape); no obstructions
              blocking light or sightlines.
            </li>
            <li>
              <strong>Supply arrangements.</strong> Maintained luminaires fed from a non-switched
              (always-on) supply; non-maintained luminaires fed via the local supply (so they detect
              local mains failure). Final-circuit isolators present and labelled. Central battery
              slaves fed from the central battery sub-circuits.
            </li>
            <li>
              <strong>Battery state (self-contained).</strong> Battery installed, connected, dated;
              no obvious physical damage; manufacturer date code legible (recorded for the logbook).
            </li>
            <li>
              <strong>Central battery state (where applicable).</strong> Central battery enclosure
              correctly located (own fire-resistant compartment per BS EN 50171), correctly
              ventilated, correctly accessed, warning notices in place (locked-off disconnect,
              do-not-switch-off labels).
            </li>
            <li>
              <strong>Exit and directional signage.</strong> Position, orientation, viewing distance
              match design; sign type matches BS ISO 7010 / BS 5499 specification (running-figure /
              arrow); no obstructions; mounting height per code.
            </li>
          </ul>
          <p>
            The pre-energisation visual takes time. A 200-luminaire installation is a half-day of
            careful work, not a 30-minute walk. Compress it and defects propagate into the live
            testing where they are harder and more expensive to find.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The visual inspection at commissioning shall verify that the installation matches the
              design as recorded on the as-built drawings, that the luminaires are of the type and
              rating specified, that cabling is of the type and routing specified including any
              fire-resistance requirements, that fixings are mechanical and appropriate to the cable
              type, and that the mounting and orientation of luminaires and signs is consistent with
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Continuity of protective conductors.</strong> Test from the MET to every
              accessible CPC at each luminaire position and accessory. R₁ + R₂ recorded for each
              circuit. Discontinuity is rejection.
            </li>
            <li>
              <strong>Insulation resistance.</strong> 500 V dc between live conductors and earth,
              between line and neutral. Acceptance ≥ 1 MΩ per BS 7671; many specifications expect ≥
              100 MΩ as a quality threshold for a new installation. Low IR readings indicate cable
              damage, moisture, or wiring errors.
            </li>
            <li>
              <strong>Polarity.</strong> At every accessory and luminaire — line is on the line
              terminal. Reverse polarity in an emergency lighting circuit is dangerous because some
              electronics depend on it.
            </li>
            <li>
              <strong>Earth fault loop impedance (Zs).</strong> Measured at the most distant point
              of each emergency lighting circuit. Must satisfy the disconnection-time requirement in
              BS 7671 Table 41 for the protective device.
            </li>
            <li>
              <strong>RCD operating time.</strong> Where RCD protection is provided (commonly 30 mA
              RCD for socket circuits supplying maintenance, sometimes 30 mA RCD on the emergency
              lighting circuit itself), verify trip time per BS 7671. Note: RCDs are NOT generally
              provided on the emergency lighting final circuit because tripping them defeats the
              safety function — refer to the design.
            </li>
            <li>
              <strong>ADS compliance.</strong> Confirm automatic disconnection of supply meets the
              BS 7671 Chapter 41 requirements for the system earthing arrangement (TN-S, TN-C-S/PNB,
              or TT). On a TT system, RCD protection is mandatory for ADS; on TN, the protective
              device disconnection time + Zs verification is the route.
            </li>
          </ul>
          <p>
            The BS 7671 verification is the foundation. The emergency-lighting-specific verification
            (photometric, switch-on, duration) is the upper layer. Both must be complete; missing
            either is a gap.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>System in emergency mode.</strong> Mains off (isolated at the relevant
              supply); the system on battery; allow 10-15 minutes for stable output (most batteries
              deliver design lux from the start, but stabilisation removes any inrush effects).
            </li>
            <li>
              <strong>Lux meter.</strong> Calibrated within the past 12 months (calibration
              certificate recorded). Photopic correction; cosine-corrected sensor head.
            </li>
            <li>
              <strong>Measurement height.</strong> Per design — typically 0.2 m above floor for
              spatial illumination on escape routes (the BS EN 1838 reference). Higher-level surveys
              for task lighting (15 lx) are at the relevant working plane.
            </li>
            <li>
              <strong>Measurement points.</strong> At the design measurement grid — typically across
              the route width at 1-2 m intervals along its length (within the BS EN 1838:2024
              non-excluded width); at every change of direction; at every escape-route door; at the
              foot and head of every staircase; at every junction.
            </li>
            <li>
              <strong>Acceptance.</strong> Each reading must equal or exceed the design value AND
              the BS EN 1838 minimum. The minima: 1 lx across the escape route full width within the
              non-excluded boundary; 0.5 lx on anti-panic open area (excluding 0.5 m perimeter
              strip); 15 lx on high-risk task areas.
            </li>
            <li>
              <strong>Uniformity.</strong> Along the route within the non-excluded width, the
              maximum:minimum ratio must not exceed 40:1. A single high reading near a luminaire
              next to a low reading mid-span fails uniformity even if the absolute minimum is met.
            </li>
            <li>
              <strong>Record.</strong> Plot or tabulate every reading against the design grid.
              Photograph the lux meter in position with the reading visible — provides evidence and
              audit trail.
            </li>
          </ol>
          <p>
            The five-yearly survey uses the same method as the commissioning survey. The comparison
            is to (a) the original commissioning readings (drift over time), (b) the design values
            (compliance), and (c) the BS EN 1838 minima (legal floor). All three are reported.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The illuminance produced by the emergency lighting installation shall be verified by
              measurement at commissioning and at intervals not exceeding five years thereafter. The
              measurement shall be carried out with a calibrated photometer at the design
              measurement plane on the defined escape route and in any anti-panic and high-risk task
              areas. The measured values shall be compared with the design values and with the
              minimum values specified in BS EN 1838.
            </>
          }
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Identify the area.</strong> Each emergency-lit area on the design has its own
              supply. Identify the local final circuit feeding the maintained / non-maintained
              luminaire (or the slave luminaire on a central battery system).
            </li>
            <li>
              <strong>Interrupt the supply.</strong> Open the local final-circuit breaker, or
              operate the test facility provided. The luminaires on that circuit lose mains.
            </li>
            <li>
              <strong>Observe and time.</strong> Each luminaire must transition to emergency
              operation within the design response class — 0.5 s for high-risk areas with stairs or
              hazardous processes, 5 s for general escape routes, 15 s for low-risk back-of-house.
            </li>
            <li>
              <strong>Verify illumination.</strong> Each luminaire must produce light at the design
              level. A luminaire that switches but produces dim light has a battery problem.
            </li>
            <li>
              <strong>Restore mains.</strong> After the test, restore the local supply. Verify the
              luminaire returns to charging mode (or maintained mains-on mode for maintained
              luminaires).
            </li>
            <li>
              <strong>Repeat for every area.</strong> Every emergency-lit area must be tested. A
              central battery system simplifies this somewhat (the central battery transfer is a
              single test, then each slave luminaire is verified by interrupting its local
              maintained-supply detection).
            </li>
            <li>
              <strong>Record.</strong> Per area: time of test, luminaires tested, response time
              observed, pass/fail per luminaire. Any failure is a defect; commissioning cannot
              proceed until resolved.
            </li>
          </ol>
          <p>
            The 3-hour duration test is run after a clean switch-on test. Disconnect the mains feed
            to the entire emergency lighting installation (or the central battery, where used) and
            run the system for the rated duration on battery alone. At the end of the rated time,
            every luminaire must still be illuminated and (per BS 5266-1:2025) still delivering the
            minimum design lux on the escape route. The duration test is destructive of battery life
            if done frequently — once at commissioning and once per year thereafter is the design
            assumption.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Installation details.</strong> Address, occupancy class, design reference
              number, date of commissioning, identification of commissioning organisation.
            </li>
            <li>
              <strong>Standards complied with.</strong> BS 5266-1:2025, BS EN 50172:2024, BS EN
              50171:2021 (where applicable), BS 7671:2018+A2:2022, BS EN 1838 (lux references). List
              explicitly.
            </li>
            <li>
              <strong>Visual and mechanical.</strong> Tick-list confirmation of the pre-energisation
              checks complete, with any defects logged and resolved.
            </li>
            <li>
              <strong>Electrical verification.</strong> BS 7671 Part 6 results — by circuit:
              continuity, IR, polarity, Zs, RCD operation. Cross-reference to the BS 7671 EIC if
              separate.
            </li>
            <li>
              <strong>Photometric.</strong> Survey results summary — readings against design,
              against BS EN 1838 minima, uniformity ratio, calibration reference of the lux meter.
              Detail the survey grid and full readings as a separate appendix.
            </li>
            <li>
              <strong>Switch-on.</strong> Per area: response class achieved, any failures,
              resolution.
            </li>
            <li>
              <strong>Duration.</strong> Date of duration test, rated duration, result (all
              luminaires illuminated at end), recovery confirmation (charge restored within 24 h).
            </li>
            <li>
              <strong>Departures.</strong> Any departure from full BS 5266-1:2025 compliance, with
              technical justification, residual risk assessment, and agreement of the responsible
              person. The 2025 standard is firm on what may and may not be a departure.
            </li>
            <li>
              <strong>Competence declaration.</strong> The competent person's qualifications,
              training, and procedural framework (e.g. BAFE SP203-4 registration). Signed.
            </li>
            <li>
              <strong>Documentation pack.</strong> Listed appendices — drawings, calculations,
              manuals, logbook starter, etc.
            </li>
          </ul>
          <p>
            The certificate is the document insurers and fire authorities will look at. Make it
            complete. A certificate with empty fields, missing appendices, or missing competence
            declaration is a regulatory exposure for the signing person and the contracting
            organisation.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>As-built drawing not available.</strong> The verifier walks the site without
              the design reference. The visual cannot be a comparison. The correct response: stop.
              Demand the as-built. If it is unobtainable, the installation is not commissionable;
              record the position and refer back to the contracting chain. Do not commission against
              an absent reference.
            </li>
            <li>
              <strong>Photometric survey reading below design but above BS EN 1838.</strong> Design
              said 5 lx; survey reads 2.5 lx; BS EN 1838 minimum is 1 lx. Pass or fail? Strictly:
              pass against the legal floor, fail against the design. Record both. The pragmatic
              position is pass — the legal duty is met. The professional position is to investigate
              why design and reality differ; usually a luminaire substitution or reflectance
              assumption that did not hold. Document on the certificate.
            </li>
            <li>
              <strong>Photometric survey reading below BS EN 1838.</strong> Fail. Cannot be
              commissioned without remediation. Report to the responsible person; identify the
              remediation (additional luminaire, lamp upgrade, optic clean, design revision);
              re-survey after remediation.
            </li>
            <li>
              <strong>One luminaire fails switch-on test.</strong> A single luminaire does not
              respond. The defect could be: failed battery, failed inverter, miswiring, failed lamp.
              Diagnose, correct, re-test that luminaire. The system is not commissioned with a known
              failure; record the fault, the corrective action, and the re-test result.
            </li>
            <li>
              <strong>Duration test interrupted.</strong> Two hours into a 3-hour test, the test is
              interrupted (mains restored unintentionally, fire alarm triggers manual intervention).
              The test is invalid; restart from full charge. Do not extrapolate to claim a pass.
            </li>
            <li>
              <strong>Recovery to less than 80% in 24 h.</strong> The batteries do not recover
              within the BS EN 50171/50172 window. Could indicate: battery problem (replace),
              charger problem (rectify), undersized charger (design issue). Investigate and
              remediate; the system cannot be commissioned with a known recovery deficit.
            </li>
            <li>
              <strong>Departure proposed by the responsible person.</strong> The client wants to
              omit a category — e.g. "we don't need photometric, just functional". The departure
              must be technically justified, residual-risk-assessed, and agreed in writing. If the
              proposed departure is not justifiable under the 2025 standard, refuse to sign on those
              terms. The responsible person can choose not to commission; you cannot misrepresent
              compliance.
            </li>
          </ul>
          <p>
            The common thread: when a verification step is unsatisfactory, the resolution is to
            stop, investigate, remediate, re-test. Not to soften the certificate to make it pass.
            The certificate is a representation of fact; if it does not reflect fact, the signing
            person is exposed.
          </p>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            ...
            {
              question:
                'Can the duration test be a sample (e.g. 1 in 10 luminaires) instead of the full installation?',
              answer:
            ...
            {
              question:
                'What if the building owner refuses to allow a 3-hour duration test on commissioning?',
              answer:
            ...
            {
              question:
                'What if I find a defect during commissioning that the installer cannot fix?',
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() =>
              navigate('/electrician/upskilling/emergency-lighting-module-5-section-2')
            }
