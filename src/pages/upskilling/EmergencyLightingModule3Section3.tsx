...
const inlineChecks = [
  {
    ...
    options: [
      'About 0.5 m above the floor at skirting level, so the light grazes the floor to pick out trip hazards.',
      'Around 5 to 6 m above the floor, high on the wall or soffit, to maximise spacing between fittings.',
      '2 to 3 m above floor — good spread, above head height to avoid glare, and suits standard ceilings.',
      'At least 10 m above the floor wherever the structure allows, so one fitting covers the largest area.',
    ],
    correctIndex: 2,
    explanation:
      'BS 5266-1:2025 references the 2 to 3 m mounting band for typical escape routes — a reasonable spread of light, above head height to avoid glare in the field of view, suiting standard ceilings. Above 3 m widens spacing but lowers floor lux; below 2 m causes glare except as bulkheads above doors. Manufacturer photometric data is published for this range; mounting outside it requires bespoke calculation.',
  },
  {
    id: 'elm3-s3-reflectance',
    question:
      'Surface reflectances assumed in BS EN 1838:2024 emergency lighting calculations are...?',
    options: [
      '0% reflectance — direct illuminance only, with reflected light not counted toward the duty.',
      '70% ceiling, 50% wall, 20% floor, the typical office values used in normal lighting design.',
      '50% on all surfaces, taken as a reasonable average across a typical building interior.',
      '100% mirror surfaces, treating the room as fully reflective for a best-case figure.',
    ],
    correctIndex: 0,
    explanation:
      'BS EN 1838:2024 requires emergency illumination to be calculated on a 0% reflectance basis — direct light only. Reflected light is not counted because, over the life of the installation, surfaces darken with dirt, walls are repainted and soft furnishings are added or moved. Designing to direct lux is the conservative approach the standard mandates.',
  },
  {
    id: 'elm3-s3-spacingtoheight',
    question: 'Spacing-to-height ratio (S/h) in luminaire layout is...?',
    options: [
      'A measure of luminaire body weight relative to mounting bracket rating, used for fixing selection.',
      'A figure always fixed at exactly 1:1 for emergency luminaires, whatever the optic or height.',
      'A parameter relevant only to large industrial spaces, never to corridors or escape routes.',
      'The ratio of luminaire spacing along the route (S) to mounting height above floor (h).',
    ],
    correctIndex: 3,
    explanation:
      'S/h is the working tool for layout. Manufacturers publish a maximum S/h per distribution at standard mounting heights; the designer reads off the maximum and lays out at or below it. At 2.5 m mounting, S/h of roughly 1.5–2.0 gives 1 lx with margin and very wide optics allow up to 3.0. Exceeding the published S/h is the most common cause of dim spots between luminaires.',
  },
  {
    id: 'elm3-s3-ldties',
    question: 'LDT and IES files are...?',
    options: [
      'Spreadsheet exchange formats tabulating luminaire pricing and stock data for wholesalers.',
      'Standardised photometric data formats describing the luminaire intensity distribution.',
      'Project-management file formats used to schedule luminaire installation and commissioning.',
      'Wiring-diagram interchange formats describing the luminaire control and supply connections.',
    ],
    correctIndex: 1,
    explanation:
      'LDT (Eulumdat) is the European photometric file format; IES (LM-63) is the North American equivalent. Each describes the luminaire output as a polar intensity distribution, used by lighting software (Dialux, Relux, AGi32) to compute illuminance on a target plane from luminaire position, orientation and room geometry. Without LDT/IES data the software cannot calculate; designers verify the manufacturer publishes the file before specifying a luminaire.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      'About 0.5 m above the floor at skirting level, grazing light across the floor surface.',
      'Around 5 m above the floor, high on the soffit, to achieve the widest possible spacing.',
      '2 to 3 m above floor — manufacturer photometric data is published for this range and the lux calculations assume this band.',
      'There is no standard band; mounting height is left entirely to installer preference.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 2,
    question:
      'Surface reflectance assumption in BS EN 1838:2024 emergency lighting calculations is...?',
    options: [
      '0% — direct illuminance only; reflected light is not counted toward the emergency duty.',
      '70% ceiling, 50% wall, 20% floor, matching the standard reflectances used in normal interior lighting design.',
      '50% on all surfaces, taken as a reasonable average across a typical building interior.',
      '100% on all surfaces, treating the room as fully reflective to give a best-case illuminance figure.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The rated wattage of the luminaire relative to its emergency battery capacity.',
      'The correlated colour temperature of the output, expressed against a reference white.',
      'The physical body length of the luminaire relative to the width of the route it serves.',
      'The ratio of luminaire spacing (S) along the route to mounting height (h) above floor.',
    ],
    correctAnswer: 3,
    explanation:
      'S/h is the layout sizing tool — a manufacturer-published maximum that limits how far apart luminaires can be while still meeting the photometric duty. Designers read the maximum for each luminaire / distribution at standard mounting heights and lay out at or below it. Exceeding S/h causes dim regions between luminaires.',
  },
  {
    id: 4,
    question:
      'Photometric distribution types referenced in some manufacturer tools (BR-A, BR-B, BR-C, BR-D) describe...?',
    options: [
      'Different battery chemistries available for the self-contained emergency supply.',
      'Variants of the mounting bracket supplied for ceiling, wall or recessed fixing.',
      'Categories of beam shape, from narrow through to very wide / asymmetric distributions.',
      'Power-supply ratings denoting the input voltage range the luminaire accepts.',
    ],
    correctAnswer: 2,
    explanation:
      'BR-A through BR-D (or similar manufacturer-specific naming) describe beam categories — narrow (BR-A) through to very wide / asymmetric (BR-D) — used to match a luminaire to the route geometry. Narrow beams suit high mountings; wide beams suit low mountings and corridor coverage. The category drives the maximum S/h at each mounting height; selecting the wrong distribution wastes light and produces non-compliant layouts.',
  },
  {
    id: 5,
    ...
    options: [
      ...
      'CAD geometry files describing the physical shape of the luminaire for clash detection in building models.',
      'Manufacturer pricing files listing the cost and lead time of each luminaire variant.',
      'Type-test certificates confirming the luminaire meets BS EN 60598-2-22 for emergency use.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It is a long-standing convention carried over from earlier editions with no engineering basis.',
      'Because reflective or light-coloured paint is prohibited on escape routes by the standard.',
      'For aesthetic reasons, to avoid designers relying on decorative finishes that may change.',
      'Because surface reflectance varies and degrades over the life of the installation.',
    ],
    correctAnswer: 3,
    explanation:
      'Zero reflectance is a long-life design assumption. Real-world surfaces darken with dirt over years, may be repainted to a darker scheme, and soft furnishings, notice boards and fittings absorb light. The 0% basis ensures the emergency duty is met regardless of what happens to the surfaces over the installation life.',
  },
  {
    id: 7,
    question:
      'A luminaire mounted at 4 m has a published max S/h of 1.8. Maximum spacing along the route is...?',
    options: [
      '4 m — taking the mounting height itself as the maximum spacing.',
      '1.8 m — using the S/h ratio directly as the spacing in metres.',
      '7.2 m — calculated as S = (S/h) × h = 1.8 × 4 m.',
      '10 m — rounding the mounting height and ratio up to a convenient figure.',
    ],
    correctAnswer: 2,
    explanation:
      'S = (S/h) × h. The ratio multiplied by the mounting height gives the maximum spacing: 1.8 × 4 m = 7.2 m. Designers can space at or below this; beyond it the lux drops below 1 lx between luminaires.',
  },
  {
    id: 8,
    question:
      'Why are higher mounting heights generally accompanied by wider spacing AND lower at-floor lux?',
    options: [
      'Inverse-square law and beam geometry — higher mounting cuts point lux but widens coverage.',
      'The opposite — higher mounting always raises at-floor lux because the beam spreads further.',
      'It is manufacturer policy to recommend wider spacing at greater heights, with no physical basis.',
      'It is a coincidence of how the S/h tables are written rather than a real optical effect.',
    ],
    correctAnswer: 0,
    explanation:
      'The inverse-square law governs point illuminance: a luminaire at twice the height gives roughly one-quarter the lux at a point but covers about twice the radius. Designers can space wider while the lux at any point falls — fewer luminaires for the same coverage, but more critical photometric calculation. Manufacturer S/h tables capture this trade-off.',
  },
  {
    id: 9,
    question:
      'For a 30 m corridor with luminaires at 2.5 m mounting and a published max S/h of 2.0, the design must place at least...?',
    options: [
      'A single luminaire at the centre, since one wide-distribution fitting can cover 30 m.',
      '15 luminaires, spacing them at the 2.5 m mounting height intervals along the run.',
      '30 luminaires, placing one fitting per metre of corridor for full coverage.',
      '7 luminaires — max spacing 5.0 m (2.0 × 2.5), so 30 / 5 = 6 spacings = 7 positions.',
    ],
    correctAnswer: 3,
    explanation:
      'Layout calculation: max spacing 5.0 m (2.0 × 2.5), corridor 30 m, so 30 / 5 = 6 spacings = 7 positions (0, 5, 10, 15, 20, 25 and 30 m). In practice designers round up for margin and verify with photometric software. The S/h sets the upper bound; designers may go closer if the layout requires.',
  },
  {
    id: 10,
    question: 'Manufacturer photometric data is supplied at...?',
    options: [
      'Purely theoretical values derived by calculation rather than measurement of a real luminaire.',
      'Marketing figures chosen by the manufacturer to present the product in the best light.',
      'Tested luminous flux from a representative production luminaire, with declared tolerance bands.',
      'Aggregated customer-review data on perceived brightness in real installations.',
    ],
    correctAnswer: 2,
    explanation:
      'Photometric data comes from laboratory testing (goniophotometer measurement) of a representative production luminaire, usually by an independent lab. The LDT/IES file is the certified output at rated input voltage; designers apply a maintenance factor (typically 0.7 to 0.8) for production tolerance, lumen depreciation over life and dirt accumulation.',
  },
];
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/electrician/upskilling/emergency-lighting-module-3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The physics behind the layout. Emergency lighting design lives or dies on the photometric
          calculation — luminaire mounting height, beam distribution, spacing-to-height ratio, and
          the BS EN 1838 zero-reflectance rule that strips away any reliance on bouncing light. Get
          the photometrics right and the lux meter passes; get them wrong and no number of
          luminaires saves the design.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              doorways, in lobbies, on stair landings. Below standard ceiling and just above door
              head height. Used where the geometry suits — narrow corridors, immediate door
              illumination, exit signage with integrated luminaire.
            </li>
            <li>
            ...
            <li>
              <strong>2.8 to 3.5 m — high standard ceiling.</strong> Atria, retail anchor stores,
              gymnasium-type spaces. Manufacturer photometric data is typically published for these
              heights. Wider spacing achievable but more critical to S/h.
            </li>
            <li>
              <strong>3.5 to 6 m — high bay.</strong> Industrial, warehouse, large retail. High-bay
              luminaires with narrow / focused beams. Bespoke photometric calculation with the
              manufacturer's specific high-bay model — generic luminaires designed for 3 m mounting
              do not scale up.
            </li>
            <li>
          ...
          <p>
            Mounting at the lower end of the band (around 2.0 to 2.4 m) places the luminaire close
            to the user and increases the lux at floor; mounting at the upper end widens coverage
            but drops the lux. For the same luminaire and the same nominal 1 lx target, the lower
            mounting needs more luminaires (closer spacing); the higher mounting needs fewer but
            each provides less margin. Designers choose for the specific geometry and verify with
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              photometric data and shall provide direct illumination to the area being lit. Where
              mounting heights fall outside the range for which photometric data is published,
              bespoke calculation shall be performed and verified by point-by-point measurement at
              commissioning.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Reflectance varies over installation life.</strong> A pristine white-painted
              office ceiling at install gives 80% reflectance; ten years on, grimed and yellowed by
              age, may give 60%. Walls repainted in fashionable dark tones drop from 50% to 15%.
              Soft furnishings, fabric notice boards, mounted artwork all absorb light.
            </li>
            <li>
            ...
            <li>
              <strong>Smoke absorbs light.</strong> In the actual incident emergency lighting must
              work for, smoke is in the air. Reflected light reduces sharply in smoke; direct light
              penetrates better. Designing against direct light only matches the worst-case
              operating environment.
            </li>
            <li>
              <strong>Verification simplicity.</strong> A direct-light-only calculation can be
              verified by physical measurement at commissioning — point the lux meter, read the
              value. A reflected-light calculation is harder to verify because the reflectance
              environment at commissioning may not match the calculation assumption.
            </li>
          </ul>
          <p>
            The practical effect: emergency lighting designs typically need MORE luminaires than a
            comparable normal-lighting design. A scheme that gives 100 lx normal at the working
            plane (with reflectance contribution) might need to be designed for 200 lx direct
            (reflectance excluded) to deliver the same work-plane illuminance — that is exactly what
            the EN 1838 zero-reflectance rule means for emergency lux numbers.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Calculations of escape-route, anti-panic and high-risk task area illumination shall be
              performed assuming surface reflectances of zero. The contribution of indirect
              (reflected) illumination shall not be counted toward the minimum illuminance values
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Look up the published max S/h.</strong> From the luminaire datasheet at the
              chosen mounting height. Typical values: 1.5 to 2.0 for standard escape-route
              luminaires at 2.5 m mounting; up to 3.0 for wide-distribution luminaires optimised for
              corridor coverage.
            </li>
            <li>
              <strong>Calculate max spacing in metres.</strong> S = (S/h) × h. At 2.5 m mounting
              with S/h of 1.8, max spacing is 4.5 m. The first and last luminaires are typically
              half-spaced from the wall (so a 4.5 m spacing through the corridor centre with 2.25 m
              end gaps).
            </li>
            <li>
              <strong>Round down for margin.</strong> Designers commonly use 80 to 90% of the max
              published S/h to allow for tolerance, environmental variation and minor positioning
              errors. A published 1.8 might be designed at 1.5.
            </li>
            <li>
              <strong>Verify photometrically.</strong> The S/h is a guideline; the final
              verification is point-by-point photometric calculation using LDT/IES data in Dialux or
              Relux. S/h gives the rule-of-thumb starting point; software gives the evidence.
            </li>
          </ul>
          <p>
            Manufacturer S/h tables typically distinguish between "axial" S/h (along the route) and
            "transverse" S/h (across the route) for asymmetric distributions. A forward-throw
            luminaire might have axial S/h of 3.0 (very wide spacing along the corridor) but
            transverse S/h of only 0.8 (close spacing across the corridor) — suiting it to long
            straight corridors but not to open areas.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Narrow (BR-A / similar).</strong> Beam concentrated within ±15 to 20 degrees
              of vertical. Suits high mountings (above 4 m) and focused tasks. Floor lux directly
              below is high; coverage narrow. Used in high-bay industrial settings, some focused
              emergency applications. Poorly suited to corridor escape routes at standard mounting
              heights.
            </li>
            <li>
              <strong>Medium (BR-B / similar).</strong> Beam ±20 to 35 degrees. The general- purpose
              distribution for ceiling-mounted recessed downlighters at standard heights. Good
              balance of floor lux and coverage. The default choice for most escape route
              applications.
            </li>
            <li>
              <strong>Wide (BR-C / similar).</strong> Beam ±35 to 50 degrees. Suits corridors where
              luminaires are spaced widely; gives good corridor coverage with fewer luminaires.
              Lower floor lux directly below than medium distribution; better at filling between.
            </li>
            <li>
              <strong>Asymmetric / forward-throw (BR-D / similar).</strong> Beam tilted along the
              route — most light goes forward (in the direction of travel) rather than straight
              down. Suits long straight corridors where the user is moving forward; aligns the
              brightest part of the beam with the line of sight. Direction-of- escape friendly.
            </li>
            <li>
              <strong>Bulkhead / wall-mount.</strong> Wall-mounted with a horizontal-throw
              distribution. Suits stair landings, doorways, lobbies. Throws light across the floor
              at low mounting; specifically designed photometric for the geometry.
            </li>
          </ul>
          <p>
            Designers reading manufacturer datasheets see the photometric distribution as a polar
            diagram (the candela distribution in vertical and horizontal planes) and an S/h table.
            Selection is by matching the route to the published distribution; the S/h table gives
            the spacing implications. Wrong distribution choice is one of the most common design
            errors and reveals itself only at point-by-point photometric calculation.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Header information.</strong> Luminaire identifier, manufacturer, type, light
              source, total luminous flux, photometric centre offsets.
            </li>
            <li>
              <strong>Intensity distribution.</strong> Candela values at every vertical angle
              (typically 0 degrees / nadir to 180 degrees / zenith in 5-degree increments) and every
              horizontal azimuth (0 to 360 degrees in 22.5- or 15-degree increments). The full 3D
              distribution.
            </li>
            <li>
              <strong>Reference data.</strong> Light source flux, luminaire power, ballast losses,
              beam efficiency. Used by software to compute energy figures alongside illuminance.
            </li>
            <li>
              <strong>Tolerance and test conditions.</strong> Test laboratory, test method
              (typically goniophotometer), tolerance bands. The data is laboratory-tested at rated
              input voltage; real-world output is subject to tolerance.
            </li>
          </ul>
          <p>
            Designers verify that the manufacturer publishes LDT/IES files for the specific variant
            being specified — not just the family. A 12 W LED emergency luminaire and a 7 W LED
            emergency luminaire from the same product family have different photometric files; using
            the wrong one produces wrong calculations. Manufacturer downloads typically include LDT
            and IES variants of the same luminaire for designers in different markets.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Calculations shall be performed using photometric data in standard format (LDT or IES)
              supplied by the luminaire manufacturer, applied through approved lighting calculation
              software. The calculation shall produce a point-by-point illuminance grid at the
              relevant target plane (floor for horizontal duties; vertical face for safety
              equipment) with the resulting minimum, maximum and uniformity clearly identified.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <line
              ...
              strokeWidth="2"
            />
            <text x="240" y="396" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              floor (target plane)
            </text>
            ...
            <text x="100" y="427" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              high lux ↓ small spread
            </text>
            ...
            <text x="240" y="427" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              balanced lux + spread
            </text>
            ...
            <text x="380" y="427" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              lower lux ↓ wider spread
            </text>
            ...
            <text x="240" y="484" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              double the height → quarter the lux at target point
            </text>
            <text x="240" y="500" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              but coverage radius approximately doubles → S/h captures the trade-off
            </text>
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="670" y="86" textAnchor="middle" fill="#22C55E" fontSize="13" fontWeight="bold">
              Photometric distributions
            </text>

            {/* Narrow */}
            <text x="510" y="120" fill="#22C55E" fontSize="11" fontWeight="bold">
              Narrow (BR-A)
            </text>
            <line
              x1="555"
              ...
              strokeWidth="6"
            />
            <text x="585" y="155" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              ±15 to 20° beam — high lux directly below, narrow coverage; high-bay only
            </text>

            {/* Medium */}
            <text x="510" y="200" fill="#22C55E" fontSize="11" fontWeight="bold">
              Medium (BR-B)
            </text>
            <polygon points="555,215 540,250 570,250" fill="rgba(34,211,238,0.5)" />
            <text x="585" y="240" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              ±20 to 35° — general purpose, default for ceiling-mount escape routes
            </text>

            {/* Wide */}
            <text x="510" y="280" fill="#22C55E" fontSize="11" fontWeight="bold">
              Wide (BR-C)
            </text>
            <polygon points="555,295 525,335 585,335" fill="rgba(34,211,238,0.4)" />
            <text x="595" y="320" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              ±35 to 50° — corridor coverage, fewer luminaires, lower direct lux
            </text>

            {/* Asymmetric */}
            <text x="510" y="360" fill="#22C55E" fontSize="11" fontWeight="bold">
              Asymmetric (BR-D / forward-throw)
            </text>
            <polygon points="555,375 540,415 600,415 580,395" fill="rgba(34,211,238,0.4)" />
            <text x="610" y="400" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              tilted along route
            </text>
            <text x="610" y="414" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              direction-of-escape friendly
            </text>
            ...
            <text x="670" y="474" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              max spacing S = (S/h) × h — manufacturer publishes per distribution / height
            </text>
            <text x="670" y="490" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              narrow ≈ 1.0 to 1.5 · medium ≈ 1.5 to 2.0 · wide ≈ 2.0 to 3.0
            </text>
          </svg>
        </div>
        ...
        <FAQ
          items={[
            ...
            {
              question:
                'If reflectance is 0% in the calculation, why does the room look lit by emergency luminaires in real life?',
              answer:
            ...
            {
              question:
                'My corridor has a beam crossing at the ceiling — does it affect the calculation?',
              answer:
        ...
        <Quiz
          title="Mounting heights and photometric considerations — Module 3.3"
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() =>
              navigate('/electrician/upskilling/emergency-lighting-module-3-section-4')
            }
