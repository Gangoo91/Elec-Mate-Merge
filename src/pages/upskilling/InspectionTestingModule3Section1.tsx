    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The first test in the Reg 643.2 sequence. Methods 1 and 2, the maths from GN3 Table BI,
          and the reading that feeds every Zs verification.
        </p>
        ...
        >
          <p>
            Reg 643.2.1 in BS&nbsp;7671:2018+A4:2026 splits the continuity duty into two limbs. The
            first applies universally: continuity of every protective conductor and every
            ...
            those conductors. The second limb applies only to ring final circuits: continuity of the
            line and neutral conductors must also be measured by resistance.
          </p>
          <p>
            The wording &ldquo;if any&rdquo; in the regulation is the conditional gate. If a circuit
            has no exposed-conductive-parts and no extraneous-conductive-parts in scope, the
            protective-conductor continuity duty does not bite for that circuit — but that is rare
            in any installation that includes accessories with earth terminals, metal-clad
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              verified by a measurement of resistance. The continuity of every protective conductor
              of every circuit and, in the case of ring final circuits, every live conductor, shall
              be verified by a measurement of resistance.
            </>
          }
        ...
        >
          <p>
            Continuity in Reg 643.2.1 means the protective conductor is electrically continuous and
            of low resistance — not merely connected. A green-and-yellow conductor that terminates
            loosely under a clamp or that has a single broken strand pinching the rest will pass a
            casual buzzer test and fail a low-resistance ohmmeter measurement. The regulation chose
            &ldquo;measurement of resistance&rdquo; as the verification verb for that exact reason:
            a numeric reading reveals connections that look good but are not.
          </p>
          <p>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              At the distribution board, fit a temporary link between the line conductor and the CPC
              of the circuit under test. Use a brightly coloured / labelled flying lead.
            </li>
            <li>
              At the furthest point on the circuit (the worst-case socket, FCU, luminaire, whatever
              the circuit terminates at), measure resistance between L and E with the ohmmeter. This
              is R1 + R2.
            </li>
            <li>
            ...
            <li>
              Remove the temporary link before any breaker on the board is closed. This is the step
              that gets forgotten and the step that destroys boards.
            </li>
          </ol>
          <p>
            GN3 Reg 2.13 is the regulation that makes the Method 1 reading mean R1+R2 specifically —
            with one important caveat: the reading equals R1+R2 only if the wiring is all-insulated
            and the cable accessories are not in contact with earth. If the cable passes through
            metal containment that is itself bonded to earth (steel conduit, SWA, tray with earthed
            clamps), parallel paths short the CPC and the reading under-represents the true R2. In
            that situation, Method 1 still confirms the connection is electrically continuous but
            should not be substituted into a Zs sum without re-thinking what the parallel path is
            doing.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Record each reading on the schedule. The expected value at any point is the calculated
              R2 from the MET to that point only — line resistance does not enter the path.
            </li>
          </ol>
          <p>
            Method 2&rsquo;s practical strength is that it lets you locate where in the circuit a
            high-resistance joint sits. Method 1 gives you a single number at the far end; Method 2
            gives you a string of numbers along the run. If the third socket reads 0.4 Ω and the
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="177" y="163" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              LINK
            </text>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="75" y="100" textAnchor="middle" fill="#22C55E" fontSize="10" fontWeight="bold">
              CPC
            </text>
            ...
            <line
              ...
              strokeDasharray="4,3"
            />
            <text x="560" y="160" textAnchor="start" fill="#22C55E" fontSize="10" fontWeight="bold">
              Probe at the
            </text>
            <text x="560" y="174" textAnchor="start" fill="#22C55E" fontSize="10" fontWeight="bold">
              accessory CPC
            </text>
            ...
            <text x="400" y="322" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="10">
              The 0.56 Ω jump between Socket 2 and Socket 3 isolates the suspect joint to the cable
              / termination between those two points.
            </text>
            <text
              x="400"
              y="340"
        ...
        >
          <p>
            The table publishes mΩ/m for each conductor csa. To calculate R1+R2 for a circuit with a
            different line and CPC csa (typical T&E with reduced CPC), you add the line csa&rsquo;s
            r1 to the CPC csa&rsquo;s r2 and multiply the sum by the circuit length. Common values
            from Table BI / OSG Table I1 at 20&deg;C:
          </p>
          ...
          <p>
            The values are at 20&deg;C. Cable in service runs hotter — typically up to 70&deg;C for
            thermoplastic insulated cable at full load. Conductor resistance has a positive
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              resistance of the line conductor, R1, plus the resistance of the protective conductor,
              R2, for that circuit. The resistance of the test leads should either be measured and
              deducted from the readings obtained, or be nulled out using the instrument&rsquo;s
              zeroing function.
            </>
          }
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              Investigate first, decide later. Common causes: loose terminal, corroded joint, cable
              longer than the route assumed, wrong cable size at one section, cable damage, or a
              junction-box termination using an inadequate connector. Use Method 2 to localise.
            </li>
            <li>
        ...
        >
          <p>
            The sum is straightforward: <strong>Zs = Ze + R1 + R2</strong>. The judgement around it
            is what matters:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Use R1+R2 corrected to operating temperature (typically &times;1.20 for thermoplastic
              cable) when comparing against the Table 41 limits at 70&deg;C.
            </li>
            <li>
            ...
            <li>
              ...
              does not exempt RCD-protected circuits.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            The A4:2026 model forms tightened the column structure on the Schedule of Test Results.
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              Method 2 result. Parallel earth paths, calculated values used in lieu of measured, or
              accessories disconnected for the test — all flagged in comments so the next inspector
