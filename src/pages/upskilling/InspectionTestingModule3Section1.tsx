...
const DESCRIPTION =
  'Master R1+R2 continuity testing for protective conductors. Learn test methods, acceptance values, and calculation of circuit protective conductor continuity.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'The furthest point will have the maximum R1+R2, and therefore the highest Zs. If protection is adequate at the worst-case point, it will be adequate throughout the circuit.',
  },
  {
    id: 'zs-calculation',
    question: 'If Ze = 0.40\u03A9 and measured R1+R2 = 0.35\u03A9, what is the calculated Zs?',
    options: ['0.05\u03A9', '0.75\u03A9', '0.14\u03A9', '1.40\u03A9'],
    correctIndex: 1,
    explanation:
      'Earth fault loop impedance Zs equals the external impedance Ze plus the circuit impedance R1+R2. This calculated value can be compared with both measured Zs and maximum permitted values.',
  },
  {
    id: 'link-removal',
    question:
      'What must you remember to do at the distribution board after completing R1+R2 testing?',
    options: [
      'Replace all fuses',
    ...
    correctIndex: 1,
    explanation:
      "Forgetting to remove the link creates a dead short when the circuit is re-energised. This will cause an immediate trip at minimum, or potentially a fire if the protective device doesn't operate fast enough.",
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      'Ring circuit resistance',
      'Resistance of line conductor plus CPC in series',
      'Resistance of both line conductors',
      'Insulation resistance between conductors',
    ],
    correctAnswer: 1,
    explanation:
      'R1+R2 is the resistance of the line conductor (R1) plus the circuit protective conductor (R2) measured in series from the distribution board to the furthest point. This value is used for Zs verification.',
  },
  {
    id: 2,
    question:
      'What is the minimum test current required for continuity testing according to BS 7671?',
    options: ['50mA', '100mA', '200mA', '500mA'],
    correctAnswer: 2,
    explanation:
      'A minimum test current of 200mA is required for continuity testing. This ensures reliable readings through potentially corroded or poorly connected conductors and meets the requirements of BS 7671 and GN3.',
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'R1+R2 must be measured at the furthest point from the distribution board. This gives the highest (worst-case) resistance value, ensuring protection is adequate throughout the entire circuit length.',
  },
  {
    id: 4,
    question:
      'If a 2.5mm\u00B2 line conductor has a resistance of 7.41m\u03A9/m and the 1.5mm\u00B2 CPC has 12.1m\u03A9/m, what is r1+r2 per metre?',
    options: ['9.76m\u03A9/m', '14.85m\u03A9/m', '19.51m\u03A9/m', '4.69m\u03A9/m'],
    correctAnswer: 2,
    explanation:
      'r1+r2 = 7.41 + 12.1 = 19.51m\u03A9/m. This value is used to calculate expected R1+R2 by multiplying by the circuit length in metres.',
  },
  {
    id: 5,
    question: 'How does temperature affect R1+R2 measurements?',
    options: [
      'Temperature has no effect on conductor resistance',
      'Higher temperature means lower resistance',
      'Higher temperature means higher resistance',
      'Only affects measurements above 50\u00B0C',
    ],
    correctAnswer: 2,
    explanation:
      'Conductor resistance increases with temperature. Copper has a positive temperature coefficient of approximately 0.4% per degree Celsius. Published resistance values are at 20\u00B0C, so measurements at higher temperatures will read higher.',
  },
  {
    id: 6,
    question: 'The relationship Zs = Ze + R1 + R2 is used for what purpose?',
    options: [
      'Calculating cable size required',
      'Verifying earth fault loop impedance compliance',
      'Determining RCD rating needed',
      'Calculating voltage drop',
    ],
    correctAnswer: 1,
    explanation:
      'The formula Zs = Ze + R1 + R2 allows calculation of expected earth fault loop impedance. By measuring Ze at the origin and R1+R2 at the circuit end, you can verify the calculated Zs is within permitted limits.',
  },
  {
    id: 7,
    question:
      'What should you do if R1+R2 measures significantly higher than the calculated expected value?',
    options: [
      'Record the measured value and continue',
      'Investigate the cause - check connections, cable size, and route',
      'Add a correction factor and accept',
      'Assume the calculation was wrong',
    ],
    correctAnswer: 1,
    explanation:
      'Unexpectedly high R1+R2 values indicate a potential problem: poor connections, wrong cable size, longer route, or conductor damage. These must be investigated and resolved, not simply accepted or adjusted.',
  },
  {
    id: 8,
    question: 'When testing R1+R2 at a socket outlet, what test configuration is used?',
    options: [
      'L terminal to E terminal at the socket',
      'L terminal at DB to E terminal at socket',
      'Link L and E at DB, measure L-E at socket',
      'L to N at socket',
    ],
    correctAnswer: 2,
    explanation:
      'The standard method is to temporarily link L and CPC (E) at the distribution board, then measure the resistance between L and E at the furthest socket. This puts R1 and R2 in series for measurement.',
  },
  {
    id: 9,
    question:
      'What is the typical acceptable range for R1+R2 on a 20m circuit using 2.5/1.5mm\u00B2 cable?',
    options: [
      'Less than 0.05\u03A9',
      'Approximately 0.39\u03A9 (20m \u00D7 19.51m\u03A9/m)',
      'Approximately 1.0\u03A9',
      'Greater than 2.0\u03A9',
    ],
    correctAnswer: 1,
    explanation:
      'For 2.5/1.5mm\u00B2 T&E, r1+r2 \u2248 19.51m\u03A9/m. For 20m: R1+R2 = 0.01951 \u00D7 20 = 0.39\u03A9 approximately. This should be compared with your calculation based on actual cable length and type.',
  },
  {
    id: 10,
    ...
    options: [
      ...
      'To compensate for test lead resistance and ensure accurate low-resistance readings',
      'To reset the instrument memory',
      "It's not important for this test",
    ],
    correctAnswer: 1,
    explanation:
      'Nulling (zeroing) the test leads subtracts their resistance from measurements. Since R1+R2 values are typically below 1\u03A9, even small lead resistance (0.1-0.3\u03A9) would significantly affect accuracy if not compensated.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'The furthest point has the highest resistance and therefore the highest Zs value. Testing here gives you the worst-case figure for the circuit. If protection is adequate at the furthest point (highest Zs), it will be adequate everywhere on that circuit. Testing at intermediate points would miss potential problems at the circuit extremity.',
  },
  {
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>R1+R2:</strong> Line conductor + CPC resistance in series
              </li>
              <li>
                <strong>Test:</strong> At furthest point for worst-case value
              </li>
              <li>
                <strong>Formula:</strong> Zs = Ze + R1 + R2
              </li>
              <li>
                <strong>Current:</strong> Minimum 200mA test current required
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Poor connections, damaged conductors
              </li>
              <li>
                <strong>Use:</strong> Zs verification, protection compliance
              </li>
              <li>
                <strong>Apply:</strong> Every radial circuit at furthest point
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              R1+R2 testing verifies the integrity and resistance of the earth fault current path
              within a circuit. This is critical because when a fault occurs, current must flow
              through this path to operate the protective device quickly enough to prevent electric
              shock.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>R1 (Line Conductor):</strong> Phase conductor from DB to furthest point
                </li>
                <li>
                  <strong>R2 (Circuit Protective Conductor):</strong> Earth (CPC) from furthest
                  point back to DB
                </li>
                <li>
                  <strong>Combined:</strong> Total resistance of the fault current path within the
                  circuit
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5">
              ...
              <p className="text-sm text-white">
                During an earth fault, current flows through R1 (to the fault) and R2 (back to the
                source via the CPC). The total resistance of this path (along with Ze) determines
                the fault current, which must be high enough to operate the protective device within
                the required time.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The standard method involves temporarily linking the line and CPC at the distribution
              board, then measuring the combined resistance at the circuit's furthest point.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>1. Isolate and Prove Dead:</strong> Ensure the circuit is safely isolated
                </li>
                <li>
                  <strong>2. Null Test Leads:</strong> Zero the instrument with leads shorted
                  together
                </li>
                <li>
                  <strong>3. Link L and CPC at DB:</strong> Temporarily connect line to earth at the
                  board using a flying lead
                </li>
                <li>
                  <strong>4. Measure at Furthest Point:</strong> Test between L and E at the
                  furthest socket/point on the circuit
                </li>
                <li>
                  <strong>5. Record Result:</strong> Note the reading in ohms on the test schedule
                </li>
                <li>
                  <strong>6. Remove Link:</strong> Don't forget to remove the temporary link before
                  re-energising!
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-red-400/80 italic">
              <strong>Critical Reminder:</strong> Always remove the temporary link between L and CPC
              before re-energising the circuit. Forgetting this creates a direct short circuit when
              power is restored.
            </p>
          </div>
        </section>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          <h4 className="text-sm font-bold text-white mb-4">
            R1+R2 Continuity Test Setup (Method 1)
          </h4>
          <svg
            viewBox="0 0 800 320"
            className="w-full h-auto"
            role="img"
            aria-label="CPC continuity test setup showing temporary link between Line and CPC at the distribution board, with low-resistance ohmmeter measuring at the furthest socket outlet"
          >
            {/* Distribution Board */}
            <rect
              x="50"
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="177" y="163" textAnchor="middle" fill="#FBBF24" fontSize="8" fontWeight="bold">
              LINK
            </text>
            ...
            <text x="575" y="177" fill="rgba(255,255,255,0.4)" fontSize="7">
              L to E
            </text>
            ...
            <text x="400" y="288" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="10">
              Reading = R1 + R2 (line resistance + CPC resistance in series via the temporary link)
            </text>
            <text
              x="400"
              y="303"
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Before testing, calculate the expected R1+R2 value. This allows you to verify your
              measurement makes sense and helps identify potential problems.
            </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Common Cable Values (m\u03A9/m at 20\u00B0C):
              </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-green-500/10">
              ...
              <div className="text-sm text-white space-y-1">
                <p>
                  <strong>Circuit:</strong> Socket outlet circuit, 25m of 2.5/1.5mm\u00B2 T&E
                </p>
                <p>
                  <strong>r1+r2:</strong> 19.51 m\u03A9/m (from table)
                </p>
                <p>
                  <strong>Calculation:</strong> 25 x 0.01951 ={' '}
                  <span className="text-elec-yellow font-bold">0.49\u03A9</span>
                </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              R1+R2 values allow calculation of the expected earth fault loop impedance (Zs) without
              the need for a live test. This is particularly useful for RCD-protected circuits where
              live Zs testing is not always reliable.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>1.</strong> Measure Ze at Origin (e.g., Ze = 0.35\u03A9 at the consumer
                  unit)
                </li>
                <li>
                  <strong>2.</strong> Measure R1+R2 at Circuit End (e.g., R1+R2 = 0.49\u03A9 at
                  furthest socket)
                </li>
                <li>
                  <strong>3.</strong> Calculate Zs: 0.35 + 0.49 ={' '}
                  <span className="text-elec-yellow">0.84\u03A9</span>
                </li>
                <li>
                  <strong>4.</strong> Compare with Maximum Zs (For B32: Max Zs = 1.37\u03A9.
                  0.84\u03A9 = Compliant)
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5">
              ...
              <p className="text-sm text-white">
                For verification purposes, R1+R2 values at operating temperature (typically
                70\u00B0C for conductors) should be used. Apply multiplier of approximately 1.2 to
                values measured at 20\u00B0C for comparison with maximum Zs.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              R1+R2 testing can reveal various installation faults. Understanding what different
              results indicate helps with diagnosis and correction.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>High resistance:</strong> Loose terminal screws, corroded connections
                </li>
                <li>
                  <strong>Open circuit:</strong> CPC not connected, earth bar loose, cable damage
                </li>
                <li>
                  <strong>Variable reading:</strong> Intermittent connection, loose strands
                </li>
                <li>
                  <strong>Wrong value:</strong> Wrong cable size used, additional cable in series
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              R1+R2 values are recorded on the Schedule of Test Results (schedule of circuit
              details) as part of the electrical installation certificate or periodic inspection
              report.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Tip: Use R1+R2 for Diagnosis
              </p>
              <p className="text-sm text-white">
                Recorded R1+R2 values are useful for future fault finding. If a circuit develops
                problems later, comparing current measurements with original recorded values can
                help identify where changes have occurred.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                ...
                <li>
                  Use a brightly coloured flying lead for the L-CPC link - easier to spot for
                  removal
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Forgetting to null test leads</strong> - adds ~0.2\u03A9 to readings
                </li>
                <li>
                  <strong>Testing at midpoint</strong> - doesn't give worst-case value
                </li>
                <li>
                  <strong>Using wrong r1+r2 values</strong> - check cable size carefully
                </li>
                <li>
                  <strong>Leaving the link in place</strong> - creates short circuit
                </li>
                <li>
                  <strong>Not investigating high readings</strong> - could indicate dangerous
                  connection
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>BS 7671:</strong> Regulation 643 - Continuity of protective conductors
                </li>
                <li>
                  <strong>GN3:</strong> Inspection and Testing guidance
                </li>
                <li>
                  <strong>OSG Table I1:</strong> Cable resistance values
                </li>
                <li>
                  <strong>Chapter 41:</strong> Maximum Zs values for protective devices
                </li>
              </ul>
            </div>
          </div>
