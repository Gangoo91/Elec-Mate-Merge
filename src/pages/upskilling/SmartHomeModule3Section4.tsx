...
const DESCRIPTION =
  'Master the principles of matching smart lighting controls to different load types, including LED compatibility, dimmer selection, and troubleshooting common issues.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      'Power Watt Modulation',
      'Pulse Width Modulation',
      'Periodic Wave Management',
      'Programmable Wattage Mode',
    ],
    correctAnswer: 1,
    explanation:
      'PWM (Pulse Width Modulation) rapidly switches the LED on and off at varying duty cycles to control perceived brightness without changing voltage.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      ...
      'Only leading-edge dimmers',
      'Either leading or trailing-edge dimmers',
      'No dimmers at all',
    ],
    correctAnswer: 2,
    explanation:
      'Resistive loads like incandescent lamps are compatible with both leading-edge and trailing-edge dimmers, as they have no minimum load issues or phase sensitivity.',
  },
  {
  ...
  },
  {
    ...
    options: [
      'The lamp will overheat',
      'The dimmer may not reach minimum load threshold',
      'The circuit breaker will trip',
      'The lamp will change colour',
    ],
    correctAnswer: 1,
    explanation:
      'Many dimmers require 25-40W minimum load to function properly. A single 5W LED may not meet this threshold, causing the dimmer to behave erratically.',
  },
  {
...
const faqs = [
  {
    ...
    answer:
      "No. LEDs require dimmers specifically designed for LED loads, typically trailing-edge types. Standard leading-edge dimmers can cause flickering, buzzing, reduced lifespan, and limited dimming range. Always check the dimmer manufacturer's LED compatibility list before installation.",
  },
  {
    question: 'Why do my LED lamps buzz when dimmed?',
    answer:
      "Buzzing usually indicates incompatibility between the dimmer and LED driver. The dimmer's switching frequency may be causing vibration in the driver components. Solutions include using a compatible trailing-edge dimmer, fitting a bypass/bleeder module, or selecting lamps specifically rated for the installed dimmer.",
  },
  {
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-3xl mx-auto">
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Understanding load types is essential for selecting compatible controls. Different loads
            respond differently to dimming methods and switching frequencies.
          </p>
          <div className="space-y-3">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <h4 className="font-medium text-elec-yellow mb-2">Resistive Loads</h4>
              <p className="text-white text-sm">
                Incandescent and halogen lamps are purely resistive. They work with virtually any
                dimmer type and respond smoothly across the full dimming range. Power factor is
                unity (1.0), making calculations straightforward.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <h4 className="font-medium text-elec-yellow mb-2">Inductive Loads</h4>
              <p className="text-white text-sm">
                Magnetic (wire-wound) transformers for low-voltage halogen are inductive. They
                require leading-edge dimmers and can cause issues with electronic dimmers due to
                current phase lag.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-white text-sm">
                Electronic transformers and most LED drivers are capacitive. They work best with
                trailing-edge dimmers. The current leads the voltage, requiring smooth switching to
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            The two main dimmer technologies differ in when they cut the AC waveform, affecting
            their compatibility with different load types.
          </p>
          ...
          <p className="text-white text-sm">
            For mixed installations, universal dimmers automatically detect load type and adjust
            their operation accordingly. These are more expensive but offer flexibility.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            LEDs present unique challenges for dimming due to their low power consumption and driver
            electronics. Common issues include:
          </p>
          <div className="space-y-4 mb-4">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-white mb-2">Flickering</h4>
              <p className="text-white text-sm mb-2">
                Occurs when the dimmer cannot regulate properly, often due to minimum load not being
                met or incompatible driver electronics.
              </p>
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                Caused by the dimmer's switching frequency resonating with LED driver components.
                More common with leading-edge dimmers.
              </p>
              <p className="text-elec-yellow text-sm">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                The LED may not dim below 20-30% or may jump between levels rather than dimming
                smoothly.
              </p>
              <p className="text-elec-yellow text-sm">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                LEDs glow faintly even when switched off, caused by residual current through the
                dimmer or two-way wiring inductance.
              </p>
              <p className="text-elec-yellow text-sm">
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Smart controls offer various methods for adjusting lighting, each with specific load
          ...
          <div className="space-y-3">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm">
                On/off control only, suitable for any load type including non-dimmable LEDs, motors,
                and fluorescent fittings. No compatibility concerns with load type.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-elec-yellow mb-2">Smart Dimmers</h4>
              <p className="text-white text-sm">
                Variable brightness control, typically trailing-edge for LED compatibility. Check
                manufacturer specifications for minimum/maximum load ratings.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-elec-yellow mb-2">PWM Controllers</h4>
              <p className="text-white text-sm">
                Direct control of LED strips and fixtures via rapid on/off switching. Provides
                flicker-free dimming when operating at high frequencies (above 1kHz).
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-elec-yellow mb-2">0-10V Dimming</h4>
              <p className="text-white text-sm">
                Analogue signal dims compatible LED drivers. Requires additional control wiring but
                provides smooth, flicker-free operation for commercial installations.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <h4 className="font-medium text-elec-yellow mb-2">DALI Controllers</h4>
              <p className="text-white text-sm">
                Digital addressable system for commercial lighting. Each fixture can be individually
                addressed and controlled. Supports dimming, scenes, and monitoring.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Follow these guidelines to ensure reliable operation when selecting controls for
              ...
              <tbody>
                <tr className="border-b border-white/10">
                  ...
                  <td className="py-3 px-4 text-white">
                    Trailing-edge dimmer, check compatibility
                  </td>
                </tr>
                <tr className="border-b border-white/10">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            <p className="text-white text-sm">
              ...
              specifying a project, calculate the total connected load and ensure it falls within
              the dimmer's minimum and maximum ratings. Add a bypass module if the LED load is below
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Before finalising an installation, test for common issues to ensure reliable operation
            for the client.
          </p>
          <ol className="space-y-3 list-decimal list-inside text-white mb-4">
            <li className="pl-2">
              <span className="font-medium">Full range test</span> - Dim from 100% to minimum and
              back, checking for smooth operation at all levels
            </li>
            <li className="pl-2">
              <span className="font-medium">Low-level stability</span> - Leave at 10-20% for several
              minutes, watching for flickering or dropout
            </li>
            <li className="pl-2">
              <span className="font-medium">Listen for buzzing</span> - With the room quiet, check
              for audible noise from both dimmer and lamps
            </li>
            <li className="pl-2">
              <span className="font-medium">Off-state check</span> - Turn completely off and verify
              no ghost glow from lamps
            </li>
            <li className="pl-2">
              <span className="font-medium">Multiple switching</span> - Rapidly turn on/off several
              times to check for startup issues
            </li>
          </ol>
          <p className="text-white text-sm">
            Document any issues and their solutions for future reference. Inform the client if lamp
            replacement requires matching the original specification for dimmer compatibility.
          </p>
        </section>
