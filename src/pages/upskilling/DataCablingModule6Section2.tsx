    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The performance Classes — frequency response, channel and permanent-link models, and
          Class-to-Category mapping. Class D (Cat 5e, 100 MHz, 1 Gbps), Class E (Cat 6, 250 MHz),
          Class EA (Cat 6A, 500 MHz, 10 GbE to 100 m — the modern default), Class F (Cat 7, 600 MHz)
          and FA (Cat 7A, 1000 MHz), Class I (Cat 8.1) and Class II (Cat 8.2, both 2000 MHz, ~30 m
          data-centre top-of-rack). The 100 m channel + 90 m permanent-link rule across Classes —
          and the verbatim BS 7671:2018+A4:2026 §716.521.101 list of acceptable PoE cable
          Categories.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Cat 7 → Class F.</strong> 600 MHz, screened TP. ISO/EN only — never adopted in
              ANSI/TIA-568. Niche.
            </li>
            <li>
            ...
            <li>
              <strong>Cat 8.2 → Class II.</strong> 2000 MHz, 25/40 Gbps to ~30 m with non-RJ45 (TERA
              / GG45) connectors. Data-centre top-of-rack with specialist ecosystem.
            </li>
          </ul>
          <p>
            The relationship runs in one direction: a Cat 6A install COULD certify to Class EA (and
            that is the design intent), but the install practice determines whether it actually
            does. A Class EA channel REQUIRES Cat 6A components — you cannot {`"`}upgrade
            {`"`} a Cat 6 channel to Class EA without replacing the cable. So Category is the upper
            bound; Class is the actual measurement.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          <h4 className="text-sm font-bold text-white mb-4">
            Class / Category cross-reference — TIA Category ↔ ISO/EN Class with frequency and reach
          </h4>
          <svg
            viewBox="0 0 900 720"
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Class I (Cat 8.1) / Class II (Cat 8.2).</strong> Channel approximately 30 m, 2
              connectors max. Top-of-rack data-centre only. Outside the 100 m model.
            </li>
          </ul>
          <p>
            The corollary: a contractor cannot deliver a {`"`}Class EA install{`"`} on Cat 5e cable.
            The Class is bounded above by the Category. Buying Cat 5e and installing it perfectly
            produces Class D. Buying Cat 6A and installing it badly produces Class D (or worse) on
            Class-EA-capable components. Both ends matter.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>ACR-F (Attenuation-to-Crosstalk Ratio Far-end).</strong> Far-end equivalent of
              NEXT, normalised by attenuation.
            </li>
            <li>
            ...
            <li>
              ...
              matters for PoE — uneven resistance between conductors of a pair concentrates current
              asymmetrically and overheats one conductor. TIA TSB-184-A and BS 7671 §716 bracket
              this concern.
            </li>
          </ul>
          <p>
            The test instrument level required (TIA-1152-A) scales with the Class: Class D (Cat 5e)
            — Level III at minimum; Class E (Cat 6) — Level III, IIIe preferred; Class EA (Cat 6A) —
            Level III is permissible but Level IV / V gives more reliable certification at 500 MHz;
            Class F / FA — Level IV / V; Class I / II — Level V is the sensible requirement at 2000
            MHz.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Predictable supply chain and cost.</strong> Pricing is stable; lead times are
              short; specifying Cat 6A is not a procurement event.
            </li>
            <li>
              <strong>Compatible with PoE-DC under §716.</strong> Listed verbatim in §716.521.101
              alongside every other modern Category. The 750 mA per-conductor cap is well within Cat
              6A{`'`}s thermal envelope at typical bundle sizes.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              on the patch panel side. Test report comes back marked Class E pass on most links and
              sub-Class-E pass on a few. Project sign-off is given on {`"`}pass{`"`} without
              checking that the Class matches the spec. Six months later, 10GBASE-T deployment fails
              — the cabling delivered Class E performance from Cat 6A components and the active
              equipment auto-negotiates down or stays offline.
            </>
          }
          doInstead={
            <>
              Read the Class line on every test report. Cat 6A specified means Class EA certified —
              anything less is either rework or commercial discount. The test instrument must be at
              TIA-1152-A Level III minimum (Level IV/V preferred for Class EA at 500 MHz),
              calibrated within date, with adapters appropriate to the Class. Reject any test report
              without Class line, or with Class lower than specified — it is the commercial
        ...
        <Scenario
          ...
          situation={
            <>
              A facilities manager inherits a 2010 office building cabled to {`"`}Cat 5e throughout
              {`"`}. The new tenant needs 10GBASE-T to every desk for video editing workflows. The
              FM asks whether {`"`}network upgrade{`"`} can be done in software.
            </>
          }
          whatToDo={
            <>
              Pull a recent test report. If Class D / Cat 5e is confirmed, explain that the cable
              cannot deliver 10GBASE-T at any useful distance — its 100 MHz frequency response and 1
              Gbps insertion-loss budget were specified for 1000BASE-T. The fix is selective
              re-cabling to Cat 6A / Class EA on the affected runs, not a software setting. Estimate
              the cost: per-desk cabling rework, re-termination, channel testing to Class EA.
              Compare against fibre-to-the-desk if the density justifies it. The original 2010 spec
              did its job; the requirement changed beyond what was foreseeable.
            </>
          }
          whyItMatters={
            <>
              Service-independence has limits. A spec that was reasonable in 2010 (Cat 5e for
              gigabit) cannot deliver 10GBASE-T at 100 m. That is a legitimate re-cable trigger and
              a clear example of where the Class-versus-Category distinction matters: there is no
              install practice that turns Cat 5e into a Class EA channel. The components are the
              upper bound. New components, then re-test.
            </>
          }
        />
