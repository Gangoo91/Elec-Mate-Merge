...
const InspectionTestingModule2Section4 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 2 · Section 4" title="Proving dead techniques" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Prove-test-prove with a GS38-compliant two-pole voltage indicator. The single test that
          converts “I think it’s isolated” into “I know it’s dead” — done correctly, every time,
          before any conductor is touched.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              (TT/IT — disconnect all live conductors), Reg 641.4 (precautions during inspection and
              testing).
            </li>
            <li>
            ...
            <li>
              <strong>Electrical Safety First Best Practice Guide 2</strong>: industry consensus on
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              isolation is appropriate to prevent danger during inspection and testing, circuits and
              equipment shall be safely isolated and locked off in accordance with BS&nbsp;7671 safe
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              voltage detectors and BS&nbsp;EN&nbsp;61010 or BS&nbsp;EN&nbsp;61557 for instruments.
              The safety measures and procedures in HSE GS38 shall be observed for all instruments,
              leads, probes and accessories.
            </>
          }
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              frayed leads, loose finger-guards, missing fuse covers. OSG 12.5 requires this as the
              first stage. A damaged indicator goes back in the bag, not on the conductors.
            </li>
            <li>
              <strong>Prove (before)</strong>: connect the two probes to a known voltage source — a
              dedicated proving unit, or a known-live socket on a separately energised circuit. The
              indicator must display voltage at the expected level (typically 50 V / 230 V / 400 V
              depending on the proving unit setting).
            </li>
            <li>
              <strong>Test</strong>: connect the two probes to each pair of conductors at the point
              of work, in turn. Single-phase: L–E, L–N, N–E. Three-phase: every pairing of L1, L2,
              L3, N, E (10 readings). Every reading must be 0 V or indistinguishable from 0 V on the
              indicator&rsquo;s display.
            </li>
            <li>
            ...
            <li>
              ...
              circuit is dead and work may begin. If either prove failed, or any test read non-zero,
              work does not begin until the cause is identified and resolved.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              Industry-standard option, and the only one that does not require any live work to use.
              Examples: Martindale VI-15700, Megger PT 100. Battery condition matters — a flat
              proving unit fails the prove silently in the wrong direction (it reads zero, you
              assume a successful test, you accept a broken indicator).
            </li>
            <li>
              ...
              circuit that is not the one being tested for absence of voltage. A 13 A socket-outlet
              on a different ring is the typical option. Risk-assess briefly — you are doing a
              deliberate live test on the indicator, with exposed terminals.
            </li>
            <li>
              <strong>Known-live conductor at the supply side:</strong> in a board where the
              incoming side is live and the outgoing circuit is isolated, the incoming terminals can
              be used as the known source. Higher-risk live work; document it in the day&rsquo;s
              risk-assessment.
            </li>
            <li>
              <strong>NOT a non-contact voltage tester.</strong> A non-contact tester is a detector
              — it senses the presence of an electric field. It does not generate a known voltage
              and is not a source. Using one as a proving unit is one of the most common and most
              dangerous safe-isolation failures (see Common Mistake below).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Insulated leads</strong> rated for the system voltage and overvoltage category
              at the test point.
            </li>
            <li>
              <strong>Probes with finger guards</strong> and exposed metal tip length not exceeding
              4 mm. Older instruments with longer tips are non-compliant; tape the tips down to 4 mm
              or replace.
            </li>
            <li>
            ...
            <li>
              ...
              current, which discriminates between real voltage and capacitively coupled or induced
              voltage. Pure-voltmeter-input devices can be fooled by stray voltage; a loaded
              indicator is harder to fool.
            </li>
            <li>
              <strong>Internal fuse</strong> for fault-current protection on the probes. Check fuse
              condition as part of the OSG 12.5 inspection step.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>CAT II</strong> — equipment supplied from the fixed installation (appliances,
              plug-in tools). Not appropriate for fixed-installation testing.
            </li>
            <li>
            ...
            <li>
              <strong>CAT IV</strong> — origin of the supply, between the building entrance and the
              primary distribution board. Cut-out, meter, meter tails, the consumer unit incoming
              side. CAT IV is defined as &lsquo;CAT III plus equipment installed at or near the
              origin&rsquo;.
            </li>
          </ul>
          <p>
            Voltage rating: rated for the line-to-earth voltage of the system. UK single-phase 230 V
            → indicator rated &ge;300 V. UK three-phase 400 V → indicator rated &ge;600 V.
          </p>
          <p>
            GN3 also notes a critical point about the test set-up as a whole: &ldquo;the equivalent
            overvoltage category for a test arrangement is the lowest overvoltage category of any
            equipment, including test instruments, leads, probes, connectors, and similar, connected
            in the test arrangement.&rdquo; A CAT IV indicator with CAT II probes is a CAT II test
            set-up. The probes, leads, and any adapter all have to match.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              distribution board (consumer unit). CAT IV may include electricity meters and primary
        ...
        >
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            ...
            <li>
              ...
              L–E test would miss if the indicator measures line-to-line through capacitive coupling
              and reads partial).
            </li>
            <li>
          ...
          <p>
            Reg 537.3.3 (TT/IT) explicitly requires disconnection of all live conductors, which on a
            TT supply specifically means line + neutral. The three-reading set reflects that
        ...
        >
          <p>
            ...
            at the building. For a three-phase TN-S / TN-C-S system, the neutral is tied to earth at
            the substation, so N–E is normally near zero by design — but the reading still has to be
            taken, both as a sanity check and because a broken PEN / PEN-like fault on TN-C-S can
            leave the neutral floating with respect to earth at potentially dangerous voltages.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>At the point of work itself</strong> — the conductors you are about to touch.
            </li>
            <li>
              <strong>At the nearest accessible point</strong> when (1) is not physically possible,
              and you have walked the route to confirm no alternative supply can feed in between.
            </li>
            <li>
              <strong>At the isolation point only</strong> as a last resort, with explicit
              acknowledgement in the day&rsquo;s risk-assessment that you have verified there are no
              downstream sources (UPS, emergency lights, PV, generator, transfer switch) that could
              re-feed the work area.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Test results</strong> — the three (single-phase) or ten (three-phase) pairings
              with their readings.
            </li>
            <li>
            ...
            <li>
              ...
              the indicator on the proving unit and of the indicator at the work point displaying 0
              V.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            The next section (2.5 Working on isolated systems) covers what to do once prove-dead is
            complete: re-prove after any break in work, control of the work area, hand-over between
            operatives, and the closing sequence at the end of the job that re-energises safely.
          </p>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            {
              question: 'Can I use a multimeter instead of a dedicated two-pole voltage indicator?',
              answer:
            ...
            {
              question: 'My indicator does not have a calibration certificate — is that a problem?',
              answer:
