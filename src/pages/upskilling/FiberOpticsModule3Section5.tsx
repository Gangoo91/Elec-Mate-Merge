...
const DESCRIPTION =
  'Learn fire barrier penetration requirements, firestop systems, building regulations compliance, and proper sealing techniques for fibre optic cable installations.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Firestop systems must achieve the same fire-resistance rating as the barrier they penetrate - a 2-hour wall requires a 2-hour rated firestop system.',
  },
  {
    id: 'firestop-qc3',
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Cold smoke seals prevent smoke migration at ambient temperature before fire conditions develop.',
  },
  {
    id: 10,
...
const faqs = [
  {
    ...
    answer:
      'Yes. Although fibre cables do not conduct electricity, they create penetrations through fire barriers that must be sealed. Additionally, cable jackets are combustible and can propagate fire. The same firestopping principles apply to all cable types penetrating fire-rated barriers.',
  },
  {
    question: 'Can I use general-purpose sealant for fire stopping?',
    answer:
      'No. Fire stopping requires specifically tested and certified materials designed for fire resistance. General-purpose sealants like standard silicone or mastic will fail in fire conditions. Use only products with appropriate fire testing certification (BS EN 1366-3) and follow manufacturer specifications.',
  },
  {
    question: 'What happens if firestopping is not installed correctly?',
    answer:
      'Incorrect or missing firestopping can allow rapid fire spread between compartments, produce toxic smoke migration throughout a building, and compromise the designed fire safety strategy. This creates life safety risks and may result in prosecution under fire safety legislation and invalidate insurance.',
  },
  {
    question: 'How do I know which firestop product to use?',
    answer:
      'Selection depends on: the fire rating required (matching the barrier), penetration type (sleeve, opening, transit), cable types and quantities, environmental conditions, and whether re-entry is needed. Use manufacturer selection guides and ensure the specific configuration has been tested to relevant standards.',
  },
  {
    question: 'Who can install firestop systems?',
    answer:
      'While regulations do not mandate specific qualifications, competent installation is essential. Many specify third-party certified installers through schemes like FIRAS, BRE, or IFC. For critical applications and compliance demonstration, certified installers with documented training are recommended.',
  },
  {
    question: 'How do I handle existing penetrations with no firestopping?',
    answer:
      'Existing unsealed penetrations should be addressed using appropriate retrofit firestop solutions. Assess the barrier rating required, cable fill, and environmental conditions. Various products exist for retrofitting including wrap strips, collars, and re-enterable systems. Document all remedial work and include in fire safety records.',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">Fire barrier integrity, sealing systems, and compliance</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Purpose:</strong> Maintain fire compartmentation
              </li>
              <li>
                <strong>Match rating:</strong> Firestop must equal barrier rating
              </li>
              <li>
                <strong>Fill ratio:</strong> Maximum 60% cable fill typically
              </li>
              <li>
                <strong>Document:</strong> All installations in fire safety file
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Red/orange intumescent materials
              </li>
              <li>
                <strong>Spot:</strong> Transit frames in walls/floors
              </li>
              <li>
                <strong>Use:</strong> Tested and certified products only
              </li>
              <li>
                <strong>Use:</strong> Manufacturer-specified procedures
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Building Regulations (England and Wales):</strong> Approved Document B
                  covers fire safety requirements for new buildings and alterations
                </li>
                <li>
                  <strong>Regulatory Reform (Fire Safety) Order 2005:</strong> Requires fire risk
                  assessments and maintenance of fire safety measures in occupied buildings
                </li>
                <li>
                  <strong>BS 476 / BS EN 1366-3:</strong> Test standards for fire resistance of
                  service penetrations
                </li>
                <li>
                  <strong>BS 8519:</strong> Code of practice for fire stopping
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>30 minutes (FD30):</strong> Standard internal doors and partitions
                </li>
                <li>
                  <strong>60 minutes (FD60):</strong> Compartment walls, protected shafts
                </li>
                <li>
                  <strong>90 minutes:</strong> High-risk occupancies
                </li>
                <li>
                  <strong>120 minutes (2-hour):</strong> Fire walls, critical barriers
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>E = Integrity:</strong> Prevents flame and hot gas passage
                </li>
                <li>
                  <strong>I = Insulation:</strong> Limits temperature rise on unexposed face
                </li>
                <li>
                  <strong>EI 60:</strong> Both integrity and insulation for 60 minutes
                </li>
                <li>
                  <strong>S = Smoke sealing:</strong> Prevents cold smoke migration
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              penetration type, cable density, fire rating required, and whether future re-entry is
              needed.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Intumescent sealants:</strong> Gun-applied, expands 3-5x volume
                </li>
                <li>
                  <strong>Intumescent wraps:</strong> Wrapped around cables, expands to crush
                </li>
                <li>
                  <strong>Intumescent collars:</strong> Fixed around penetrations
                </li>
                <li>
                  <strong>Intumescent pillows:</strong> Removable blocks for transit openings
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Ablative coatings:</strong> Applied to cables, chars to protect
                </li>
                <li>
                  <strong>Ablative batts:</strong> Mineral-based boards that resist fire
                </li>
                <li>
                  <strong>Composite systems:</strong> Multiple materials for enhanced protection
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Transit Systems (Cable Transits):
              </p>
              <p className="text-sm text-white mb-2">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Modular frames:</strong> Pre-fabricated frames with removable modules
                </li>
                <li>
                  <strong>Block systems:</strong> Interlocking blocks around cables
                </li>
                <li>
                  <strong>Sleeve seals:</strong> Individual cable entry points
                </li>
                <li>
                  <strong>Multi-cable transits:</strong> High-density penetration management
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Fire rating required:</strong> Match to barrier specification
                </li>
                <li>
                  <strong>Cable types:</strong> Data, power, fibre have different characteristics
                </li>
                <li>
                  <strong>Fill ratio:</strong> Maximum cable area in opening (typically 60%)
                </li>
                <li>
                  <strong>Re-entry needs:</strong> Will cables be added/removed later?
                </li>
                <li>
                  <strong>Environment:</strong> Indoor, outdoor, vibration, movement
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white">
                Firestop systems are only valid when installed exactly as tested and specified by
                the manufacturer. Substituting materials, changing depths, or exceeding fill ratios
                invalidates the fire rating and creates a non-compliant installation.
              </p>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Sleeved:</strong> Metal or plastic sleeve with annular seal
                </li>
                <li>
                  <strong>Unsleeved:</strong> Direct through opening with firestop
                </li>
                <li>
                  <strong>Transit frame:</strong> Modular system in larger openings
                </li>
                <li>
                  <strong>Cable tray:</strong> Tray through wall with appropriate sealing
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Risers:</strong> Dedicated vertical shafts requiring sealing
                </li>
                <li>
                  <strong>Core holes:</strong> Individual penetrations through slab
                </li>
                <li>
                  <strong>Raised floors:</strong> Seal at structural floor level
                </li>
                <li>
                  <strong>Cable openings:</strong> Maintain 60% fill maximum
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Movement joints:</strong> Use flexible firestop systems
                </li>
                <li>
                  <strong>Mixed services:</strong> Separate cable and pipe penetrations
                </li>
                <li>
                  <strong>Cavity barriers:</strong> Seal within ceiling/floor voids
                </li>
                <li>
                  <strong>External walls:</strong> Consider weather and fire protection
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Steel sleeves:</strong> Non-combustible, minimum 1.5mm thickness, seal
                  annular gap
                </li>
                <li>
                  <strong>Plastic sleeves:</strong> Use intumescent collar, collar crushes melting
                  sleeve
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Modular transit systems:</strong> Remove specific modules, add cables,
                  replace modules. System maintains rating throughout if procedures followed.
                </li>
                <li>
                  <strong>Removable pillows/bags:</strong> Intumescent pillows can be removed and
                  rearranged around new cables. Easy re-entry but requires sufficient space.
                </li>
                <li>
                  <strong>Sealant systems:</strong> Some sealants allow cutting, cable insertion,
                  and resealing. Check manufacturer specifications for approved procedures.
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-red-400/80 mb-2">
                Warning: Complete Replacement
              </p>
              <p className="text-sm text-white">
                If a firestop system cannot be properly re-entered (damaged, no procedures, wrong
                type), it must be completely removed and replaced. Partial repairs or ad-hoc
                additions are not acceptable and invalidate the fire rating.
              </p>
            </div>

            <p>
              Where frequent changes are anticipated (e.g., data centres, communications rooms),
              specify re-enterable transit systems from the outset. The additional initial cost is
              offset by easier future modifications and maintained compliance.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Firestop certificates:</strong> For each penetration or group
                </li>
                <li>
                  <strong>Product data sheets:</strong> Specifications and test certificates
                </li>
                <li>
                  <strong>Installation photographs:</strong> Before, during, and after
                </li>
                <li>
                  <strong>Location drawings:</strong> All firestop positions marked
                </li>
                <li>
                  <strong>Installer qualifications:</strong> Training certificates
                </li>
                <li>
                  <strong>Test certificates:</strong> BS EN 1366-3 or equivalent
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white">
                Firestop documentation must be retained for the life of the building as part of the
                fire safety file (new buildings) or O&M manual. Under the Fire Safety Order, the
                responsible person must maintain this information. Electronic records with
                photographs are increasingly standard.
              </p>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>FIRAS:</strong> Warrington Fire accredited installers
                </li>
                <li>
                  <strong>IFC Certification:</strong> Third-party installer scheme
                </li>
                <li>
                  <strong>BRE Global:</strong> LPCB certified contractors
                </li>
                <li>
                  <strong>Manufacturer training:</strong> Product-specific certification
                </li>
              </ul>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Plan penetrations early:</strong> Design fire barrier crossings as part of
                  cable routing, not as afterthought
                </li>
                <li>
                  <strong>Group cables logically:</strong> Separate data, power, and fibre where
                  practical for easier firestopping
                </li>
                <li>
                  <strong>Leave spare capacity:</strong> Allow for future cables within fill ratio
                  limits
                </li>
                <li>
                  <strong>Photograph everything:</strong> Before, during, and after - essential for
                  records
                </li>
                <li>
                  <strong>Label clearly:</strong> Firestop type, date, and reference on both sides
                  of barrier
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Wrong product</strong> - Using products not tested for the specific
                  application
                </li>
                <li>
                  <strong>Exceeded fill ratio</strong> - Overcrowding penetrations beyond 60%
                  capacity
                </li>
                <li>
                  <strong>Incomplete seal</strong> - Gaps, voids, or insufficient depth of material
                </li>
                <li>
                  <strong>Mixed products</strong> - Combining materials from different manufacturers
                </li>
                <li>
                  <strong>No documentation</strong> - Failing to complete certificates and
                  photographs
                </li>
                <li>
                  <strong>Improper re-entry</strong> - Ad-hoc modifications without proper
                  procedures
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Bend radius:</strong> Maintain minimum bend radius through and around
                  firestop
                </li>
                <li>
                  <strong>Cable protection:</strong> Use innerduct or protection where cables
                  contact sealant
                </li>
                <li>
                  <strong>Tight-buffer vs loose-tube:</strong> Loose-tube cables need careful
                  handling in firestop
                </li>
                <li>
                  <strong>Testing after:</strong> Verify optical performance not degraded by
                  installation stress
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          <div className="mt-6 p-5 rounded-lg bg-transparent">
            ...
            <p className="text-xs text-white mt-4">
              <strong>Key regulations:</strong> Building Regs Approved Doc B | Fire Safety Order
              2005 | BS 8519 | BS EN 1366-3
            </p>
          </div>
        </section>
