...
const IndustrialElectricalModule2Section5: React.FC = () => {
  ...
  const quickCheckQuestions = [
    ...
    },
    {
      id: 'qc2-interlocking',
      question:
        'Why must both mechanical AND electrical interlocking be used in a reversing starter?',
      options: [
  ...
  const quizQuestions = [
    ...
    {
      question:
        'In a reversing contactor arrangement, what type of auxiliary contact from the forward contactor is wired in series with the reverse contactor coil?',
      options: [
    ...
    {
      question:
        'What is the purpose of a mechanical interlock bar between forward and reverse contactors?',
      options: [
    ...
    {
      question:
        'When using a VSD for forward/reverse control, how is direction change typically achieved?',
      options: [
  ...
  const faqItems = [
    {
      question:
        'Why is the reversing contactor wiring "crossed" on only two phases and not all three?',
      answer:
        'Swapping any two phases reverses the rotating magnetic field direction - mathematically equivalent to changing the phase sequence from ABC to ACB (or vice versa). Swapping all three phases would result in the same phase sequence relationship (ABC becomes BCA, which is still the same rotation direction), so only two phases need to be crossed. Typically L1 and L3 are crossed while L2 passes straight through, though any two phases can be chosen.',
    },
    {
      question: 'How do I size contactors for a reversing application?',
      answer:
        'Reversing contactors experience higher duty than standard DOL starters due to the inductive load switching and potential plugging currents. Select contactors rated for AC-3 (normal inductive switching) or AC-4 (plugging/inching) utilisation category depending on the application. For AC-4 duty, derate the contactor by approximately 50% from its AC-3 rating. Also consider the mechanical life rating - reversing applications accumulate switching operations faster than single-direction starters.',
    },
    {
      question: 'What timing delay should I use between forward and reverse operations?',
      answer:
        'The delay depends on motor and load inertia, acceptable mechanical stress, and process requirements. Typical values range from 0.5 seconds for small motors with low inertia to 3+ seconds for large motors or high-inertia loads. Some applications (conveyors, mixers) may require 5-10 seconds. Use a timer relay or VSD parameter to implement the delay, and consider installing a zero-speed switch for positive confirmation rather than relying solely on time-based delays.',
    },
    {
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            anti-plugging protection, VSD electronic reversal, and rotation direction testing
            procedures per BS 7671.
          </p>
        </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Three-phase induction motors rotate because the stator windings create a rotating
              magnetic field. The <strong className="text-elec-yellow">phase sequence</strong>{' '}
              (order in which phases reach their peak voltage) determines the direction of this
              rotating field, and thus the motor rotation direction.
            </p>
            ...
            <div className="bg-background/50 p-4 rounded-lg border border-white/10">
              ...
              <p className="text-sm text-muted-foreground mb-3">
                A phase rotation meter (phase sequence indicator) is essential for verifying supply
                phase sequence before connecting motors. Connect the instrument leads to L1, L2, and
                L3 - the rotating disc or LED indication shows the rotation direction that a motor
                would produce.
              </p>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Standard motor terminals are marked U1, V1, W1 (or U, V, W in older notation).
                    Connecting L1 to U1, L2 to V1, and L3 to W1 with a positive phase sequence
                    produces clockwise rotation when viewed from the drive end. This is the IEC
                    60034 standard convention.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-sm text-muted-foreground">
              Interlocking prevents both forward and reverse contactors from closing simultaneously,
              which would cause a{' '}
              <strong className="text-elec-yellow">phase-to-phase short circuit</strong> through the
              crossed phase connections. BS 7671 and IEC standards require redundant protection
              using both methods.
            </p>
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Never rely on a single method of interlocking. Mechanical interlocking protects
                    against electrical failures (welded contacts, relay failures), while electrical
                    interlocking provides the primary control logic. Both methods together provide
                    the required level of safety per BS EN 60204-1 (Safety of machinery - Electrical
                    equipment).
                  </p>
                </div>
              </div>
            ...
            <div className="bg-background/50 p-4 rounded-lg border border-white/10">
              <h4 className="font-medium text-foreground mb-3">
                Interlocking Circuit Diagram (Simplified)
              </h4>
...
Note: Both circuits share common STOP button and OL contact`}</pre>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              The reversing starter uses two contactors wired so that one provides normal phase
              sequence and the other provides reversed sequence. Only two phases need to be crossed
              - typically L1 and L3 are swapped while L2 passes through both contactors unchanged.
            </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-elec-yellow/5 rounded p-4">
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    Direct connection - normal sequence
                  </p>
                </div>
                <div className="bg-elec-yellow/5 rounded p-4">
                  ...
                  <div className="font-mono text-sm text-muted-foreground space-y-1">
                    <p>
                      L1 ────&gt; W (Motor) <span className="text-orange-400">&lt;- Crossed</span>
                    </p>
                    <p>L2 ────&gt; V (Motor)</p>
                    <p>
                      L3 ────&gt; U (Motor) <span className="text-orange-400">&lt;- Crossed</span>
                    </p>
                  </div>
                  <p className="text-xs text-muted-foreground mt-2">
                    L1 and L3 swapped - reversed sequence
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Select AC-3 rated for normal reversing duty, or AC-4 rated for
                      plugging/inching applications. AC-4 rating is typically 50% of AC-3 rating.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Single thermal or electronic overload relay protects both directions. Position
                      after motor terminals (common to both contactors).
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Manufacturers offer pre-assembled reversing starter units with factory-fitted
                mechanical interlocking and pre-wired electrical interlocks. These are preferred for
                reliability and compliance, and are available as standard catalogue items from major
                manufacturers (Schneider TeSys, ABB AF, Siemens SIRIUS, Eaton DILM).
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Plugging (reversing a spinning motor) subjects the motor, drive train, and electrical
              system to extreme stress. The combined motor speed and reverse field torque can draw
              currents of
              <strong className="text-elec-yellow"> 15-20 times full load current</strong>, and
              mechanical shock loads can damage couplings, gearboxes, and driven equipment.
            </p>
            ...
            <div className="bg-background/50 p-4 rounded-lg border border-white/10">
              ...
              <div className="space-y-3">
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Tachometer, encoder, or proximity sensor provides shaft speed signal. Relay
                    monitors direction and speed continuously.
                  </p>
                </div>
                <div className="border-l-4 border-green-500 pl-4">
                  <h5 className="text-green-400 font-medium text-sm">Reversal Permission</h5>
                  <p className="text-sm text-muted-foreground">
                    Output contact only closes when speed is below set threshold. This contact is
                    wired in series with the reverse contactor coil.
                  </p>
                </div>
                <div className="border-l-4 border-orange-500 pl-4">
                  <h5 className="text-orange-400 font-medium text-sm">Coast-Down Monitoring</h5>
                  <p className="text-sm text-muted-foreground">
                    Some relays include coast-time monitoring - if motor takes longer than expected
                    to stop, an alarm indicates possible mechanical binding or brake failure.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Anti-plugging protection is essential for: conveyors with heavy loads, fans with
                high inertia, pumps with non-return valves, hoists and cranes, and any application
                where reverse rotation under load could cause damage. For applications requiring
                rapid braking, consider DC injection braking or regenerative drives rather than
                plugging.
              </p>
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Variable Speed Drives (VSDs/VFDs) reverse motor direction electronically by changing
              the output phase sequence in the inverter stage. This eliminates mechanical contactors
              for direction control, providing smooth, controlled transitions without arc erosion or
              mechanical wear.
            </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="space-y-3">
                  <div className="bg-elec-yellow/5 rounded p-3">
                    <h5 className="text-elec-yellow font-medium text-sm mb-1">
                      Digital Input Control
                    </h5>
                    <p className="text-xs text-muted-foreground">
                      Dedicated forward and reverse digital inputs. Only one active at a time, with
                      logic to handle simultaneous inputs (priority or stop).
                    </p>
                  </div>
                  <div className="bg-elec-yellow/5 rounded p-3">
                    <h5 className="text-elec-yellow font-medium text-sm mb-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Analogue input where positive voltage = forward, negative = reverse. Common
                      with 4-20mA or 0-10V signals centred at 50%/0V.
                    </p>
                  </div>
                </div>
                <div className="space-y-3">
                  <div className="bg-elec-yellow/5 rounded p-3">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Control word bit or register value via Modbus, PROFIBUS, EtherNet/IP, or other
                      industrial protocol from PLC/SCADA.
                    </p>
                  </div>
                  <div className="bg-elec-yellow/5 rounded p-3">
                    <h5 className="text-elec-yellow font-medium text-sm mb-1">Keypad/Parameter</h5>
                    <p className="text-xs text-muted-foreground">
                      Manual selection via drive keypad or configuration parameter. Used for
                      commissioning or fixed-direction applications.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-background/50 p-4 rounded-lg border border-white/10">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between items-center py-2 border-b border-white/10">
                  ...
                  <span className="text-elec-yellow text-xs">
                    Coast/Ramp/DC Brake before reverse
                  </span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-muted-foreground">Flying Start Enable</span>
                  <span className="text-elec-yellow text-xs">
                    Catch spinning motor (if required)
                  </span>
                </div>
              </div>
            </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              fans (blade damage, inefficient operation), and conveyors (product spillage, belt
              tracking issues).
            </p>
            ...
            <div className="bg-background/50 p-4 rounded-lg border border-white/10">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h5 className="text-elec-yellow font-medium text-sm">
                      Verify Supply Phase Sequence
                    </h5>
                    <p className="text-xs text-muted-foreground">
                      Connect phase rotation meter to incoming supply (L1, L2, L3). Record the
                      indicated rotation direction in commissioning documentation. This establishes
                      the baseline before motor connection.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h5 className="text-elec-yellow font-medium text-sm">
                      Test Both Directions (Reversing Starters)
                    </h5>
                    <p className="text-xs text-muted-foreground">
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground mt-2 space-y-1">
                    <li>
                      - Never bump test a coupled motor without confirming the load can accept
                      reverse rotation
                    </li>
                    <li>- Ensure all personnel are clear of rotating parts and pinch points</li>
                    <li>
                      - Verify lockout/tagout procedures are in place if working on connected
                      equipment
                    </li>
                    <li>
                      - Use non-contact rotation direction indicator if shaft cannot be observed
                      directly
                    </li>
                  </ul>
                </div>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Regulation 526.3 requires correct conductor identification. Motor connections must
                be clearly marked and documented. Schedule of Test Results should include
                verification of correct rotation direction for motor circuits. The Electrical
                Installation Certificate must confirm the installation is safe for continued use,
                which includes motor direction verification for applications where incorrect
                rotation could cause danger.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg p-5">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>
                    <span className="text-elec-yellow">Reversal:</span> Swap any two of three phases
                  </li>
                  <li>
                    <span className="text-elec-yellow">Standard sequence:</span> L1-L2-L3 =
                    Clockwise
                  </li>
                  <li>
                    <span className="text-elec-yellow">Interlocking:</span> Both mechanical AND
                    electrical required
                  </li>
                  <li>
                    <span className="text-elec-yellow">Timing delay:</span> 0.5-5s typical
                    coast-down
                  </li>
                  <li>
                    <span className="text-elec-yellow">Plugging current:</span> Up to 20x FLC
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>
                    <span className="text-elec-yellow">AC-3:</span> Normal inductive switching
                  </li>
                  <li>
                    <span className="text-elec-yellow">AC-4:</span> Plugging/inching (50% of AC-3)
                  </li>
                  <li>
                    <span className="text-elec-yellow">Auxiliary:</span> Min 1 NC + 1 NO per
                    contactor
                  </li>
                  <li>
                    <span className="text-elec-yellow">Overload:</span> Single unit after motor
                    terminals
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>
                    <span className="text-elec-yellow">1.</span> Phase rotation meter on supply
                  </li>
                  <li>
                    <span className="text-elec-yellow">2.</span> Confirm motor uncoupled
                  </li>
                  <li>
                    <span className="text-elec-yellow">3.</span> Bump test - observe direction
                  </li>
                  <li>
                    <span className="text-elec-yellow">4.</span> Verify interlock operation
                  </li>
                  <li>
                    <span className="text-elec-yellow">5.</span> Document in commissioning records
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>
                    <span className="text-elec-yellow">Reg 422.3:</span> Motor circuit protection
                  </li>
                  <li>
                    <span className="text-elec-yellow">Reg 526.3:</span> Conductor identification
                  </li>
                  <li>
                    <span className="text-elec-yellow">Section 537:</span> Isolation and switching
                  </li>
                  <li>
                    <span className="text-elec-yellow">BS EN 60204-1:</span> Machine safety
                    (interlocking)
                  </li>
                </ul>
              </div>
        ...
        <section className="space-y-4">
          <div className="bg-elec-yellow/5 border border-elec-yellow/20 rounded-lg p-6">
            ...
            <p className="text-sm text-muted-foreground text-center mb-6">
              ...
              covering phase sequence, interlocking methods, VSD operation, and BS 7671
              requirements.
            </p>
