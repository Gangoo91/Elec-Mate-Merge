    ...
    <HubPage>
      ...
      <HubBody>
        <div className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'Limitations are the agreed scope exclusions of an inspection; safety observations are everything safety-relevant outside the C1/C2/C3/FI coding scheme. Get the wording specific, the date right, and the third-party reader will know exactly what the cert does and does not cover.'
          }
        </div>
        ...
        >
          <p>
            ...
            C2, C3 or FI) requires evidence — you saw the thing, you tested the thing, you have the
            measurement or the photograph or the visual confirmation that supports the code. A
            limitation explicitly DOES NOT have that evidence — by definition the inspection didn't
            happen. Coding an un-inspected item C1/C2/C3 is wrong because the basis for the code is
            missing. Leaving an un-inspected item blank or ticking it satisfactory is also wrong
            because it overstates the coverage of the cert. The schedule of inspection accordingly
            has a fourth response — "LIM" — purely to mark un-inspected items.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            <strong> (d)</strong> confirmation that the installation is not damaged or deteriorated
            so as to impair safety, and that defects and non-compliance with the regulations are
            identified. Read against this, every limitation is a gap in coverage against one or more
            of (a)–(d). That is why limitations matter, why they have to be specific, and why a cert
            riddled with vague limitations against critical safety items loses its meaning.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            it is to record them with enough specificity that a future reader can act on them. "Loft
            cabling not accessible — agreed with [client name] [date], cabling buried under
            insulation, recommend re-inspection if loft is cleared in future" is correct; "loft not
            done" is not. Similarly "kitchen ring final circuit accessories behind fitted units
            inspected via accessory removal at sockets only — concealed cable runs not verified
            beyond accessory positions" is specific and traceable; "kitchen partly inspected" is
            not.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            record both: an operational limitation excluding the area from the inspected scope, AND
            a safety observation drawing attention to the underlying environmental hazard with a
            recommended remedial route (asbestos survey, structural engineer, water management).
        ...
        >
          <p>
            GN3 (Section 5) treats limitations as binding scope agreements — they have legal weight
            because they define what the cert claims to cover. Vague wording creates ambiguity in
            exactly the situation where ambiguity is most expensive: a downstream dispute about
            whether a defect later found in a previously-uninspected area "should" have been picked
            up. Specific wording closes that question conclusively. The same specificity also helps
            the client: they can read the cert, identify the gaps, and decide whether to commission
            additional work to close them.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            binding (the inspector has a duty to flag them), but they are flagged in narrative prose
            rather than in the coded schedule.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The reason mid-inspection limitations have to follow the same pattern is that Reg 653.2
            doesn't carve out an exception for them — the duty to AGREE the limitation applies
            whenever a limitation is being added to the cert. Inspectors who unilaterally decide to
            add an item as a limitation, without consulting the person who ordered the inspection,
            are technically issuing a cert that doesn't comply with Reg 653.2 even if the limitation
            itself is clearly recorded. Practically, the agreement is usually quick; legally, it has
            to happen.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            by buyers' solicitors checking what was inspected at a given point in time, by insurers
            reviewing the property's safety history, by mortgage providers assessing risk. If certs
            could be retrospectively amended, none of those uses would be reliable. Reg 653
            implicitly assumes a one-shot issuance: agree, inspect, record, sign, date, issue —
            done. Subsequent inspections create new certs, which may reference the originals but do
            not edit them.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            A common worry from less-experienced inspectors is that limitations make the cert "look
            bad" or commercially weaker. The opposite is generally true. A cert with no limitations
            on a complex installation often raises more questions than a careful cert with several
            specific, dated limitations — downstream readers experienced in cert review (insurers,
            mortgage providers' panel surveyors) will rapidly identify the former as either
            impossibly thorough or carelessly issued, and will commission their own follow-up
            inspection at the seller's expense. A clean, specific limitations section is,
            paradoxically, a sign of a careful inspector.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            clear that BS 7671 itself is the standard), but it is the working interpretation of the
            regs, and certs that diverge from GN3 typically do so for the worse.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            responses — never blank. Blank rows are the single most common cert-quality failure and
            the easiest for an experienced cert reader to spot. The combination of a clean schedule
            (every row has a response) and a clean limitations section (every LIM row on the
            schedule has a corresponding written limitation entry that names it) is what a
        ...
        >
          <p>
            Reg 653 is a small section of BS 7671 — a few clauses — but the surrounding GN3 guidance
            and Appendix 6 form structure make it one of the highest-leverage parts of the regs in
            commercial reality. Every cert in the field is read by someone, often years after issue,
            often in a context (sale, insurance claim, incident investigation) where the original
            inspector is unavailable to clarify. The cert has to do its own talking. A careful Reg
            653 entry — limitations specific, observations evidenced, safety observations narrated —
