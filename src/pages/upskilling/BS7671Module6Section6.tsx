...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Limitations include access restrictions (locked rooms, sealed units), operational constraints (live systems, occupied premises), time constraints, environmental conditions, safety restrictions, and any areas not inspected due to practical constraints. All limitations must be clearly documented.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Observations record actual defects, non-compliance issues, or areas requiring attention found during inspection. Limitations record areas that could not be inspected or tested. Observations require action, while limitations explain scope restrictions.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'C1 = Danger present (immediate action required), C2 = Potentially dangerous (urgent remedial action required), C3 = Improvement recommended (non-urgent), FI = Further investigation needed. These codes classify the severity and urgency of safety issues found.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "There's no fixed number, but professional judgment is required. If limitations affect more than 25% of the installation or exclude critical safety systems (main distribution, earthing arrangements), the certificate may not provide meaningful safety assurance.",
  },
  {
    question: 'Should I refuse to issue a certificate if there are extensive limitations?',
    answer:
      'In some cases, yes. If limitations are so extensive that the inspection cannot meaningfully assess installation safety, it may be appropriate to decline certification and recommend arranging proper access before inspection.',
  },
  {
    question: 'How should I communicate C1 defects to clients?',
    answer:
      "C1 defects require immediate verbal communication followed by written notification. Explain the danger clearly, recommend immediate isolation of affected circuits, and document the client's response. Never leave without ensuring the client understands the urgency.",
  },
];

const quizQuestion = {
  question:
    'During an EICR, you cannot access 40% of the installation due to tenant restrictions. What is the correct approach?',
  options: [
...
const BS7671Module6Section6 = () => {
  useSEO({
    ...
    description:
      'Learn how to properly record limitations and observations on electrical certificates, including C1, C2, C3, and FI coding.',
  });
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Limitations:</strong> What couldn't be inspected and why
              </li>
              <li>
                <strong>Observations:</strong> Defects found with C1/C2/C3/FI codes
              </li>
              <li>
                <strong>Purpose:</strong> Legal protection and client transparency
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Inaccessible areas, defects, non-compliance issues
              </li>
              <li>
                <strong>Use:</strong> Clear documentation protects everyone involved
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Limitations record aspects of the installation that could not be inspected or tested
              due to practical constraints. They protect electricians from liability for
              undiscovered defects in inaccessible areas while informing clients of inspection scope
              restrictions.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-transparent border border-white/10">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Physical barriers:</strong> Locked rooms, sealed voids
                  </li>
                  <li>
                    <strong>Height restrictions:</strong> Specialist access needed
                  </li>
                  <li>
                    <strong>Safety restrictions:</strong> Hazardous areas, asbestos
                  </li>
                  <li>
                    <strong>Occupied premises:</strong> Areas in continuous use
                  </li>
                  <li>
                    <strong>Third-party:</strong> Tenant areas, separate ownerships
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-transparent border border-white/10">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Live systems:</strong> Circuits that cannot be isolated
                  </li>
                  <li>
                    <strong>Critical processes:</strong> IT systems, medical equipment
                  </li>
                  <li>
                    <strong>Time constraints:</strong> Limited inspection windows
                  </li>
                  <li>
                    <strong>Environmental:</strong> Weather, seasonal access
                  </li>
                  <li>
                    <strong>Equipment:</strong> Specialist test equipment unavailable
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20 my-6">
              <p className="text-sm font-medium text-elec-yellow mb-2">
                Impact on Certificate Validity
              </p>
              <p className="text-sm text-white mb-3">
                Extensive limitations may affect certificate validity. Professional judgment
                determines whether sufficient inspection was completed to provide meaningful safety
                certification.
              </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Observations record defects and non-compliance issues found during inspection. Each
              observation is classified using standardised codes that indicate severity and required
              response time.
            </p>
            ...
            <div className="space-y-3 my-6">
              <div className="flex items-start gap-3 p-3 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    Installation or circuits should be isolated immediately until remedial action is
                    completed
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-3 rounded-lg bg-orange-500/10 border border-orange-500/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    Could become dangerous under fault conditions or with deterioration - rectify
                    urgently
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-3 rounded-lg bg-elec-yellow/10 border border-elec-yellow/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    Does not comply with current standards but not dangerous - improvement would
                    enhance safety
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-3 rounded-lg bg-blue-500/10 border border-blue-500/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    Requires additional investigation to determine if defect exists - may need
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Effective communication ensures clients understand both limitations and observations,
              enabling informed decisions about remedial action and future inspections.
            </p>
            ...
            <div className="my-6">
              ...
              <div className="grid grid-cols-3 gap-3 text-center text-sm">
                <div className="p-3 rounded bg-red-500/10 border border-red-500/20">
                  ...
                  <p className="text-white text-xs">Immediate isolation</p>
                  <p className="text-white text-xs">Emergency referral</p>
                </div>
                <div className="p-3 rounded bg-orange-500/10 border border-orange-500/20">
                  ...
                  <p className="text-white text-xs">Priority scheduling</p>
                  <p className="text-white text-xs">Urgent remediation</p>
                </div>
                <div className="p-3 rounded bg-elec-yellow/10 border border-elec-yellow/20">
                  ...
                  <p className="text-white text-xs">Planned improvement</p>
                  <p className="text-white text-xs">Future consideration</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              Inadequate documentation can create liability exposure and compromise insurance
              coverage.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
            <p className="text-sm font-medium text-elec-yellow mb-2">
              Victorian School Conversion - Complex EICR
            </p>
            <p className="text-sm text-white mb-3">
              A landlord EICR for a Victorian school building converted to apartments required
              extensive limitation and observation documentation due to multiple constraints.
            </p>
            ...
            <p className="text-sm text-elec-yellow/80">
              <strong>Outcome:</strong> Clear documentation protected the electrician while enabling
              the client to understand inspection scope and plan future access for complete testing.
            </p>
          </div>
        </section>
          ...
          <div className="grid sm:grid-cols-2 gap-4 text-xs text-white">
            <div>
              ...
              <ul className="space-y-0.5">
                <li>
                  <strong>C1:</strong> Isolate immediately, emergency remediation
                </li>
                <li>
                  <strong>C2:</strong> Schedule urgent repairs within days
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-0.5">
                <li>
                  <strong>C3:</strong> Plan improvements, not urgent
                </li>
                <li>
                  <strong>FI:</strong> Arrange further investigation
                </li>
              </ul>
            </div>
          </div>
