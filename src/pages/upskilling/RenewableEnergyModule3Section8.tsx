...
export default function RenewableEnergyModule3Section8() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 8 · BS 7671:2018+A4:2026"
        title="Section 712 in plain language — the integrated reading"
        backTo="../renewable-energy-module-3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Every Section 712 clause mapped to the design / install / commissioning workflow; the cert
          evidence bundle structure; IET CoP for Grid-Connected Solar PV Installations
          operationalisation; A4:2026 changes; preparation for 19th Edition.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              ...
              712.432.103 (gPV per BS EN 60269-6 / fuse-combination per BS EN 60947-3 / DC-MCBs per
              BS EN 60947-2 / 60898-2 / IEC 60898-3)
            </li>
            <li>
              ...
              EN 62852), isolator BS EN 60947-3. Install: compatible MC4 pairs, manufacturer-torque,
              flashing-tile, cables NOT directly on roof surface, notices per Reg 712.514.102 / 103.
              Commissioning: functional test of isolator under load + IMD verification
            </li>
            <li>
            ...
            <li>
              ...
              — design. Sizing 1.1 × I_sc_max &lt; I_n ≤ I_mod_max_ocer; both polarities protected;
              blocking diodes NOT acceptable; devices gPV (BS EN 60269-6) / fuse-combination (BS EN
              60947-3) / DC-MCBs (BS EN 60947-2 / 60898-2 / IEC 60898-3)
            </li>
            <li>
              <strong className="text-white">
            ...
            <li>
              ...
              parts can remain energized after isolation" at each DC access point; "Isolate both AC
              and DC sides before servicing" on inverter
            </li>
            <li>
            ...
            <li>
              ...
              — design. Type B per BS EN 62423 or BS EN 60947-2 default, with three exceptions: (a)
              inverter simple AC/DC separation; (b) transformer-winding separation; (c) manufacturer
              states Type B not required. Cross-refs Reg 531.3.3 (general rule restricting Type AC)
            </li>
            <li>
              <strong className="text-white">
              ...
              direct-strike LPS separation not maintained; minimum I_n = 5 kA; LPS separation per BS
              EN 62305-3
            </li>
            <li>
              <strong className="text-white">
            ...
            <li>
              ...
              commissioning. Authorises BS EN 62446 series commissioning workflow; SoTR records the
              result
            </li>
            <li>
              <strong className="text-white">712.1 (scope)</strong> — design. Section 712 covers PV
              generators (a) supplying an installation not connected to the public grid, (b) in
              parallel with the grid, or (c) as an alternative to the grid. NOTE: stand-alone
              (off-grid) PV power supply systems are &ldquo;under consideration&rdquo; — Section 712
              does NOT yet fully cover them. Off-grid PV (covered in Module 4) draws additional
              design discipline from manufacturer specs and the IET CoP
            </li>
            <li>
              <strong className="text-white">712.410.102 (permitted DC protective measures)</strong>{' '}
              — design. On the DC side, ONE of: (a) double or reinforced insulation per Section 412;
              OR (b) extra-low voltage (SELV / PELV) per Section 414. Typical UK domestic PV uses
              (a) Class II — V_oc_max far exceeds the 120 V DC SELV/PELV limit of Reg 712.414.1.1
            </li>
            <li>
              <strong className="text-white">
              ...
              obstacles and placing out of reach (Section 417); non-conducting location (Reg 418.1);
              earth-free local equipotential bonding (Reg 418.2); electrical separation for the
              supply of more than one item of current-using equipment (Reg 418.3). Practical
              implication: typical UK PV must use Class II (Reg 712.412.101) — the alternatives are
              excluded
            </li>
            <li>
              <strong className="text-white">
              ...
              — design. If SELV / PELV is chosen, U_oc_max ≤ 120 V DC and basic protection required
              where nominal V &gt; 30 V DC. Typical UK domestic PV (V_oc_max 400-600 V) is OUTSIDE
              the SELV / PELV envelope — Class II (Reg 712.412.101) is the operational choice
            </li>
            <li>
            ...
            <li>
              ...
              — design. Earthing of one DC live conductor permitted with at least simple separation
              between AC and DC; the foundational reg behind functional bonding (712.542.102). NOTE:
              corrosion prevention per BS EN 13636 / BS EN 15112
            </li>
            <li>
              <strong className="text-white">
                712.421.101 / 712.421.101.2 (functional-earthing fault interruption)
              </strong>{' '}
              — install. Where functional earthing applied to a DC live conductor, means provided to
              interrupt fault current; the automatic disconnecting device per Reg 712.2 satisfies
              this
            </li>
            <li>
            ...
            <li>
              ...
              voltage ≥ 2 × U_oc_max of string; rated current ≥ 1.1 × I_sc_max; connected in series
              with PV strings
            </li>
            <li>
              <strong className="text-white">712.533.101 (bidirectional OCPDs)</strong> — design.
              DC-side overcurrent protective devices SHALL be bidirectional. Voltage U_e ≥ U_oc_max;
              breaking capacity ≥ I_sc_max of array
            </li>
            <li>
              <strong className="text-white">
                712.534.102.2 + Table 712.1 (SPD U_imp selection)
              </strong>{' '}
              — design. Where manufacturer info not provided, rated impulse withstand voltage U_imp
              selected from Table 712.1 by V_oc_max
            </li>
            <li>
        ...
        <Reg712WorkflowMap caption="Section 712 reg-to-workflow map — table layout. Columns: Reg, Workflow stage (Design / Install / Commissioning), Operational source (which course section), Evidence in cert bundle. Rows for each Section 712 reg covered in Module 3 Sections 1-7, plus A4:2026 NEW regs (551.7.1(d), 531.3.3, Chapter 82)." />
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 551.7.1(d) — source connection rule (NEW)</strong>:
              PV / BESS inverter must NOT be on the load side of an RCD protecting the rest of the
              installation. Triggers dedicated RCBO, split-load CU, or all-RCBO CU. Detailed in
              Section 6
            </li>
            <li>
              <strong className="text-white">
            ...
            <li>
              ...
              : regulatory framework for batteries in electrical installations. Detailed in Module 5
              (BESS)
            </li>
            <li>
              <strong className="text-white">
              ...
              : Type AC RCDs shall only be used to serve fixed equipment where it is KNOWN the load
              current contains no DC components. For PV inverter circuits specifically, the
              PV-specific rule is Reg 712.531.3.5.1 — Type B default per BS EN 62423 or BS EN
              60947-2, with three exceptions: (a) inverter provides simple separation between AC and
              DC; (b) separate transformer windings between inverter and RCD; (c) inverter
            ...
            <li>
              ...
              planning framework for energy-efficient installation design is now in the body of the
              standard, not an informative appendix
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">Reg 722.411.4.1 PME exception (REMOVED)</strong>: A3\'s
              "reasonably practicable" exception to the PME requirement for EV charging was removed
              in A4. Detailed in Module 6 (EV charging)
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              ...
              routing, mounting + flashing-tile, modules + frame bonding, MC4 connector + crimping,
              isolator placements + labelling, all labels (residual-energy warnings, isolator
              labels)
            </li>
            <li>
              <strong className="text-white">3. BS EN 62446-1 commissioning records</strong> —
              continuity, polarity, V_oc / I_sc per string (with test conditions), I-V curve (where
              measured), IR test (test voltage + measured + conditions), functional tests of
              isolators and protective devices. Schedule of Test Results signed off
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">7. Customer handover pack</strong> — operating manual,
              maintenance schedule, warranty details, emergency contacts, scheduled inspection
              reminders. Customer signs receipt
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">MCS audit</strong> — random sample of installs; auditor
              reads design pack against BS 7671 Section 712 + MCS MIS 3002; gaps trigger major
              findings requiring rectification
            </li>
            <li>
              <strong className="text-white">
            ...
            <li>
              <strong className="text-white">Customer service / fault investigation</strong> — fault
              diagnosis references the design pack, SoTR baseline, install photographs to localise
              the root cause efficiently
            </li>
            <li>
              <strong className="text-white">Property ownership transfer</strong> — bundle transfers
              to new owner; supports property valuation (PV cert + EPC) and continuity of SEG export
              tariff
            </li>
            <li>
        ...
        <CertBundleStructure caption="Cert evidence bundle structure diagram — folder layout with 7 sections labelled. Each section labelled with content summary and the workflow stage that produces it. Annotated with the use cases over the install life (MCS audit, EICR, customer service, ownership transfer, insurance, end-of-life)." />
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">BS 7671:2018+A4:2026 Section 712</strong> — regulatory
              framework. Legal requirements for safe and compliant PV electrical installations. What
              the install MUST achieve. Currently A4:2026 (effective 15 April 2026). Next major
              update: 19th Edition (planned late-2020s)
            </li>
            <li>
              <strong className="text-white">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              <strong className="text-white">Refined Type B RCD criteria</strong> — with the growth
              of transformerless-with-internal-DC-management inverters, the three permitted
              exceptions in Reg 712.531.3.5.1 (and the general Reg 531.3.3 rule) may be refined
            </li>
            <li>
              <strong className="text-white">Tighter BESS / prosumer integration</strong> — Chapter
              57 (BESS) and Chapter 82 (PEIs) added in A4:2026 will mature in 19th Edition with more
              integrated cross-references and design workflows
            </li>
            <li>
              <strong className="text-white">
                Energy efficiency — Appendix 17 deleted, now Chapter 81 in Part 8
              </strong>{' '}
            ...
            <li>
              <strong className="text-white">MCS MIS 3002 evolution</strong> — likely additions for
              prosumer / BESS / EV-coupled installs; refined audit criteria
            </li>
          </ul>
        </ConceptBlock>
