    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The six-subsystem model, the 100 m channel rule, and the layered UK standards landscape —
          ANSI/TIA-568.0-E, ISO/IEC 11801, BS EN 50173, BS 6701, and the new BS 7671:2018+A4:2026
          sections (§716 PoE, §545 ICT functional earthing) — that together govern data cabling work
          in commercial premises from 15 April 2026.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              facilities at the building edge, equipment room at the core, backbone connecting core
              to floors, floor distributors at each level, horizontal cabling out to work areas.
              This shape is identical across ANSI/TIA-568, ISO/IEC 11801 and BS EN 50173. Every job
              in scope of these standards has the same six-zone model.
            </li>
            <li>
              <strong>Performance structure.</strong> Defined performance Classes (D, E, EA, F, FA,
              I, II in the EN/ISO world) or Categories (5e, 6, 6A, 7, 7A, 8 in the TIA world) that
              bound the channel's frequency response, return loss, near-end crosstalk, propagation
              delay and other electrical / optical parameters. A Class EA installation is testable,
              certifiable, and warrantable to a known specification — regardless of what active
              equipment plugs into it.
            </li>
          </ul>
          <p>
            ...
            infrastructures. TIA-568 (and shortly afterwards ISO/IEC 11801) collapsed that into one
            generic, application-independent topology: balanced twisted-pair copper + optical fibre,
            defined Classes/Categories, defined channel model. That is the "structured" we still
            mean today.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              guidelines for buildings prior to knowing what telecommunications applications will be
              run on the cabling. The intent is service-independence over an extended installed
              life.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              incoming Openreach copper, BT fibre, leased lines, ISP delivery — physically enter the
              building. Houses the demarcation between the carrier's network and the
            ...
            <li>
              ...
              building's telecoms infrastructure. Houses the main cross-connect (MC, also called the
              "campus distributor" CD in BS EN 50173 terminology), the building distributor (BD),
              and the active core equipment (chassis switches, routers, PBX). Environmentally
              controlled, secured.
            </li>
            <li>
            ...
            <li>
              ...
              work-area outlets — the "last mile" inside the building. Maximum 90 m permanent link.
              Balanced twisted-pair copper (Cat6A / Class EA is the typical 2026 default) or fibre.
            </li>
            <li>
              <strong>6. Work Area (WA).</strong> The end-user space — the desk, the wall socket,
              the AP location, the camera mount. Includes the outlet itself and the short cord that
              connects the outlet to the user's device.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              parameters and / or BS EN 50346 compliance. This is what the contractor certifies and
              warrants.
            </li>
            <li>
              <strong>Cords (combined 10 m max).</strong> Three cords add up to the cord allowance:
              (a) the patch cord at the FD (between the patch panel and the floor switch), (b) the
              equipment cord at the ER (where backbone terminates), and (c) the work-area cord
              (between the outlet and the user device). All cords are stranded conductor — more
              flexible, more flex-cycle tolerant, slightly higher attenuation per metre than solid.
            </li>
            <li>
              ...
              Ethernet variant from 100BASE-TX (1995) to 10GBASE-T (2006) and 25GBASE-T / 40GBASE-T
              (2016) preserves this 100 m budget when run on the appropriate Class / Category —
              Cat6A and above for 10G+.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The maximum length of the horizontal cabling permanent link shall be 90 m. The maximum
              length of the channel — comprising the permanent link plus all cords used to connect
              the channel to active equipment and end-user devices — shall be 100 m. The 10 m
              allowance for cords is a combined budget across the patch cord at the cross-connect,
              the equipment cord, and the work-area cord.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              50173-1 (general), -2 (offices), -3 (industrial), -4 (residential), -5 (data centres),
              -6 (distributed buildings) and the linked ISO/IEC 11801 family. Defines Classes (D, E,
              EA, F, FA, I, II) — what the channel must measure when tested.
            </li>
            <li>
            ...
            <li>
              <strong>"How do I earth and bond the comms infrastructure?" — bonding.</strong> BS EN
              50310 — the bonding network for ICT installations. Telecommunications Bonding Backbone
              (TBB), Telecommunications Grounding Busbar (TGB), Telecommunications Main Grounding
              Busbar (TMGB). From A4:2026 this couples to BS 7671 §545 (functional earthing of ICT
              equipment).
            </li>
            <li>
              <strong>
            ...
            <li>
              <strong>"What is the North American / international equivalent?" — TIA / ISO.</strong>{' '}
              ANSI/TIA-568.0-E (generic), -1-E (commercial), -2-E (balanced twisted-pair), -3-E
              (optical fibre); ANSI/TIA-569-E + Addendum 1 (2022) for telecoms spaces; -606-D (2021)
              for administration; -607-E (2024) for bonding. ISO/IEC 11801 family for international.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              Requirements address bundle thermal management, conductor temperature limits, LP-rated
              (limited-power) cable selection, ELV DC circuit protection, and disconnection /
            ...
            <li>
              ...
              separation between ICT cables and HID lamps. Annex A444 Tables A444.1 / A444.2 give
              the segregation distances against containment type and supply current.
            </li>
            <li>
              ...
              §528.3.x covers proximity to non-electrical services (heat, condensation, lift wells).
              The combination of §444 + §528 is the practical framework for Band I (data / ELV) vs
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>The IP-voice migration.</strong> An office cabled to Class EA / Cat6A in 2014
              needed no re-pulling when the analogue PBX was replaced with IP voice in 2019. The
              same horizontal infrastructure carried the IP phones. A Class D / Cat5 installation
              from 2002 needed re-pulling — it was specified for 100 Mbps Ethernet and could not
              deliver the per-port bandwidth a modern IP-voice deployment expects.
            </li>
            <li>
          ...
          <p>
            The opposing case — ad-hoc point-to-point cabling — looks cheaper at year zero. The cost
            shows up in years two through twenty: every service refresh requires new cables; every
            fault is a forensic exercise; every move/add/change is a new pull. The lifecycle TCO
            crosses break-even on most office fit-outs inside 4-5 years. Beyond that, structured
            cabling is purely cheaper.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              Specify Cat6A AND specify the install practice that delivers Class EA in the channel:
              maximum bundle sizes (per BS EN 50174-2 / TIA TSB-184-A), separation from LV power (BS
              7671 §444 + §528), proper bend radii at terminations, factory or torque-controlled
              terminations, and end-of-job channel testing to TIA-1152-A / BS EN 50346 with
              documented results. Class is what gets installed; Category is what gets bought.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              basement comms room and three upper floors, plus "Cat6A horizontal" on each floor. The
              QS has costed it as a single budget line. You have been engaged to design.
            </>
          }
          whatToDo={
            <>
              Translate "fibre backbone" into the structured-cabling six-zone model: Building
              Distributor in the basement ER, Floor Distributors on each upper floor, fibre between
              them. Pick a fibre type against the distance and service horizon — OM4 multimode is
              the typical 10G/40G choice within a building under 150 m; OS2 single-mode for longer
              reaches and higher per-fibre service rates. Pick a core count against current and
              future floor-switch uplink demand, plus growth spares. Specify the patch panels, the
              connector type (LC duplex is the modern default), and the pulling / splicing practice
              (BS EN 50174-2). Site each FD so every horizontal Cat6A run on the floor stays inside
              90 m of cable run; if it doesn't, the FD moves or the floor takes a second FD. Then —
              and only then — price it.
            </>
          }
          whyItMatters={
            <>
              ...
              The horizontal is sized against the 90 m permanent-link rule, which directly drives FD
              location and therefore room layout. Get the design wrong at spec stage and you are
              re-pulling cable inside three years.
            </>
          }
        />
