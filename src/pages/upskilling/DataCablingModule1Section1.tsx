          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent">
                ...
                <p className="text-white text-xs">Typical lifespan</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">6 subsystems</p>
                <p className="text-white text-xs">Standard structure</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">Multiple services</p>
                <p className="text-white text-xs">On one infrastructure</p>
              </div>
            </div>
          </div>
        </section>
