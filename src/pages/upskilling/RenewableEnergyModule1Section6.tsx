...
const inlineChecks = [
  {
    ...
    question: 'What is the most accurate framing of the LCT site survey?',
    options: [
  ...
  },
  {
    ...
    question: 'What three CU items must the LCT survey check?',
    options: [
...
const quizQuestions = [
  ...
  {
    id: 8,
    question: 'A site survey delivers the project plan. Which framing is most useful?',
    options: [
...
const faqs = [
  ...
  {
    question: 'How do I make the DNO precheck a fast workflow rather than a project blocker?',
    answer:
  ...
  {
    question: 'What does "CU readiness" actually mean as a survey item?',
    answer:
  ...
  {
    question: 'What about neighbour engagement — when does that become a survey item?',
    answer:
  ...
  {
    question: 'What gets recorded as a customer-acknowledged risk in the survey?',
    answer:
...
export default function RenewableEnergyModule1Section6() {
  ...
  useSEO({
    title: 'Site survey first principles for LCT | Renewable Energy 1.6 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 6 · BS 7671:2018+A4:2026"
        title="Site survey first principles for LCT"
        backTo="../renewable-energy-module-1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The LCT site survey is the discovery exercise that finds every binding constraint that
          could invalidate the proposed install timeline, scope or cost — captured in writing before
        ...
        <Pullquote>
          The survey is the project plan. The quote is the commercial reflection of the survey.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Supply</strong> — earthing arrangement (TN-S / TN-C-S /
              TT), main fuse rating, single-phase / three-phase, meter type (SMETS1 / SMETS2 /
              legacy)
            </li>
            <li>
              <strong className="text-white">DNO precheck</strong> — capacity, local feeder
              headroom, queue position for any required upgrade, ANM region status
            </li>
            <li>
              <strong className="text-white">CU readiness</strong> — spare ways, RCBO type
              compatibility, CU rated capacity vs projected load
            </li>
            <li>
              <strong className="text-white">Load projection</strong> — existing diversified load
              plus the new LCT loads, against the main fuse rating
            </li>
            <li>
              <strong className="text-white">Structural / mechanical</strong> — roof condition for
              PV, BESS siting (ventilation, fire detection, escape route proximity), heat pump
              siting (noise, defrost), EV chargepoint location
            </li>
            <li>
              <strong className="text-white">Access</strong> — working at height, cable routing,
              future maintenance / replacement access
            </li>
            <li>
              <strong className="text-white">Planning / listed-building</strong> —
              permitted-development status, conservation area, listed-building designation, local
              planning restrictions
            </li>
            <li>
              <strong className="text-white">Customer-acknowledged risks</strong> — where the
              customer has chosen to proceed despite a recommendation against (ageing roof,
              sub-optimal BESS siting, marginal supply)
            </li>
          </ul>
          <p>
            Each item is captured in writing in the survey artefact. The quote is then priced
            against the survey — not against the imagined project the customer described before the
            survey took place.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">TN-S</strong> — separate neutral and earth from the
              supply. Less common in newer GB domestic. No specific LCT complication beyond standard
              design.
            </li>
            <li>
              <strong className="text-white">TN-C-S (PME)</strong> — combined neutral and earth in
              the supply, separated at the consumer\'s installation. The most common GB domestic
              arrangement. Triggers specific EV design under Reg 722.411.4.1 (PEN-fault protective
              measure now unconditional).
            </li>
            <li>
              <strong className="text-white">TT</strong> — installation earth via a local earth
              electrode, not the supply. Common on overhead-supply rural properties and some
              commercial. EV chargepoint design simpler in some respects (no PEN-fault concern), but
              supply-side earthing arrangement determines protection coordination.
            </li>
          </ul>
          <p>
            A4:2026 Reg 722.411.4.1 deleted the "reasonably practicable" exception on PME EV
            chargepoints. The survey on a PME property must identify which recognised PEN-fault
            protective route the install will use — integral chargepoint voltage-monitoring, TT
            island arrangement, or equivalent. Where the chargepoint hardware will provide the
            integral PEN-fault measure, the manufacturer\'s certification is the audit evidence.
          </p>
        </ConceptBlock>
        ...
        <Pullquote>
          The CU upgrade is often the silent cost item the customer didn\'t expect.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Spare ways</strong> — Section 722 requires a dedicated
              EV circuit; PV inverter circuit is dedicated; BESS connection is dedicated; heat pump
              circuit is dedicated. A typical hybrid install wants 3–4 spare ways. Older CUs often
              don\'t have them.
            </li>
            <li>
              <strong className="text-white">RCBO type compatibility</strong> — Type A or Type F is
              common for PV / heat pump loads. Type B may be required where DC fault sensing is
              needed by the chargepoint hardware. Older CUs may only support Type AC, which is
              insufficient for modern LCT loads.
            </li>
            <li>
              <strong className="text-white">Rated capacity</strong> — adding sustained-load LCT
              circuits to an older CU may push it past its design point. The CU rated capacity
              (typically 80 A or 100 A) is the ceiling on what the installation can demand.
            </li>
          </ul>
          <p>
            The load projection is the second half of the CU conversation. Project the existing
            diversified load plus the new LCT loads against the main fuse rating. A common worked
            example:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              Existing diversified load (cooking, shower, lights, sockets) — typically 40–55 A
            </li>
            ...
            <li>
              Result: peak diversified load often 90–110 A on a property with an 80 A or 100 A main
              fuse
            </li>
          </ul>
          <p>
            Where the projected load exceeds the main fuse rating, the supply needs uprating — and
            the supply uprating triggers the DNO precheck timeline.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Combined diversified load</strong> — projecting the
              post-install peak demand including the interaction between PV self-consumption, BESS
              charge / discharge cycles, EV charging timing and heat pump operating profile
            </li>
            <li>
              <strong className="text-white">Multi-source fault current contribution</strong> — the
              protective device handling a fault must cope with fault current from the supply AND
              from the local sources (PV inverter, BESS, V2G)
            </li>
            <li>
              <strong className="text-white">Export coordination</strong> — which source exports
              when, particularly under variable-tariff conditions where the customer may want to
              prioritise PV export over BESS-stored export
            </li>
            <li>
              <strong className="text-white">Load management strategy</strong> — how PV, BESS, EV
              charging and heat pump are sequenced under peak demand to stay within the main fuse
              rating
            </li>
            <li>
              <strong className="text-white">Multi-source protection coordination</strong> — the
              bidirectional protective device required under 551.7.1(c) per source, and how the
              protective devices coordinate across the combined installation
            </li>
          </ul>
          <p>
            The PEI survey items are the discipline Chapter 82 introduces. They don\'t live in any
            per-technology chapter or survey by definition. On a hybrid install the PEI survey is
            what catches the system-level failure modes — and the 19th Edition is expected to deepen
            Chapter 82\'s requirements.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">PV roof-mount</strong> — roof condition, tile / slate
              type, fixing accessibility, structural load capacity, shading from chimneys / trees /
              adjacent buildings, azimuth and tilt
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">EV chargepoint location</strong> — proximity to parked
              vehicle, cable route from CU, weather protection, accessibility for users, vandalism
              risk on public-facing locations
            </li>
            <li>
              <strong className="text-white">Heat pump outdoor unit</strong> — noise emissions and
              neighbour proximity, defrost-water management, airflow clearance, planning constraints
              (size, location, listed-building status), service-access path
            </li>
          </ul>
          <p>
            On BESS specifically, the IET Code of Practice for Electrical Energy Storage Systems is
            the operational reference for siting decisions. Under-stairs cupboards, garage attics,
            and bedrooms are typically unsuitable. Utility rooms, garages with adequate ventilation,
            and external enclosures with fire- rated separation are typical acceptable locations.
          </p>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          The customer conversation — converting constraints into the plan
        </ContentEyebrow>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">
                Date, time, persons present, weather conditions
              </strong>{' '}
              — the contextual record
            </li>
            <li>
              <strong className="text-white">Photographs</strong> — supply intake, CU, proposed
              install locations, structural elements, pre-existing defects, cable routes
            </li>
            <li>
              <strong className="text-white">Measured items</strong> — main fuse rating, earth
              electrode resistance (where TT), spare CU ways, earthing arrangement, roof dimensions
              for PV
            </li>
            <li>
              <strong className="text-white">DNO precheck reference and response</strong> — the
              binding constraint in writing
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">Sign-off by both surveyor and customer</strong> — the
              audit trail close
            </li>
          </ul>
          <p>
            The bundle becomes part of the project file alongside the EIC, the design pack, the MCS
            evidence, the DNO notification reference and the manufacturer certifications. PI
            underwriters increasingly differentiate cover terms based on the quality of this bundle
            — the structured-survey installer attracts more favourable terms than the cursory-survey
            installer.
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-1-section-5')}
