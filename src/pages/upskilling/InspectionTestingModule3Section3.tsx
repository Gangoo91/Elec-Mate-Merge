...
const DESCRIPTION =
  'Learn to test main protective bonding conductors connecting extraneous-conductive-parts to the main earthing terminal. Understand minimum sizes, connection points, and test methods.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 2,
    explanation:
      "Gas bonding must be within 600mm of the meter AND on the consumer's side (outlet/downstream). This ensures the bonding is under the customer's control and protects all gas pipework within the building.",
  },
  {
    id: 'bonding-size-tn',
    question:
      'What minimum main bonding conductor size is required for a TN-C-S installation with a 16mm² earthing conductor?',
    options: ['4mm²', '6mm²', '8mm²', '10mm²'],
    correctIndex: 3,
    explanation:
      'Main bonding should be at least half the earthing conductor CSA. Half of 16mm² is 8mm², but standard cable sizes are 6mm² or 10mm², so 10mm² is used. This is also the commonly recommended minimum for TN supplies.',
  },
  {
    id: 'bonding-label',
    ...
    correctIndex: 2,
    explanation:
      'This BS 7671 required label warns anyone working on pipework (plumbers, gas fitters) that the connection is for electrical safety and must not be removed. Removing it could leave the installation dangerous.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      'To provide a path for normal load current',
      'To reduce voltage differences between extraneous-conductive-parts and earth',
      'To increase the earth fault loop impedance',
      'To protect cables from mechanical damage',
    ],
    correctAnswer: 1,
    explanation:
      "Main bonding limits touch voltages by ensuring extraneous-conductive-parts (incoming metal services) are at the same potential as the electrical installation's earth. This prevents dangerous voltage differences during a fault.",
  },
  {
    id: 2,
    ...
    options: [
      'Plastic water pipe',
      'Metallic gas pipe after the meter',
      'Telephone cable',
      'Fibre optic cable',
    ],
    correctAnswer: 1,
    explanation:
      "Metallic gas pipes after the meter require main bonding because they're conductive and connected to the ground outside. Plastic pipes don't conduct. Telephone and fibre cables are either non-conductive or separately earthed at the exchange.",
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      "Main bonding should be connected within 600mm of where the service enters the building (and for gas, within 600mm of the meter on the consumer's side). This ensures protection as close to the entry point as practical.",
  },
  {
    id: 4,
    question:
      'What is the minimum main bonding conductor size for a TN-C-S supply where 16mm² is the earthing conductor?',
    options: ['4mm²', '6mm²', '8mm²', '10mm²'],
    correctAnswer: 2,
    explanation:
      'Main bonding must be at least half the CSA of the earthing conductor. Half of 16mm² = 8mm². However, the absolute minimum for TN supplies is 6mm², and the calculated 8mm² exceeds this, so 8mm² (or 10mm² standard) would be required.',
  },
  {
    id: 5,
    ...
    correctAnswer: 2,
    explanation:
      "BS 7671 requires the label 'SAFETY ELECTRICAL CONNECTION - DO NOT REMOVE' at main bonding connections. This warns people not to remove the connection during plumbing or other work, which could leave the installation unsafe.",
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation:
      'BS 951 bonding clamps are specifically designed for making reliable connections to metal pipes. They grip the pipe securely, provide good electrical contact, and accommodate pipe movement and temperature changes.',
  },
  {
    id: 7,
    question:
      'What reading would you expect when testing main bonding continuity on a short conductor?',
    options: ['Zero exactly', 'Less than 0.05Ω typically', 'Between 1-2Ω', 'Greater than 5Ω'],
    correctAnswer: 1,
    explanation:
      'Main bonding conductors are typically short and large CSA, so resistance should be very low - often less than 0.05Ω including contact resistance. Higher readings indicate poor connections or undersized conductors.',
  },
  {
    id: 8,
    ...
    options: [
      '10mm² regardless',
      '2.5mm² if mechanically protected, 4mm² if not',
      '6mm² minimum regardless',
      '16mm² to match earthing conductor',
    ],
    correctAnswer: 1,
    explanation:
      'For TT systems, minimum main bonding is 2.5mm² if mechanically protected, or 4mm² if not. This is smaller than TN systems because TT systems use RCD protection, and the primary protection is through disconnection, not bonding.',
  },
  {
    id: 9,
    question:
      'If a metallic water pipe has 3m of plastic before entering a house, does it require main bonding?',
    options: [
      'Yes, always bond metallic services',
      'No, the plastic isolates it from earth',
      'Only if the pipe is accessible',
      'Only for bathrooms',
    ],
    correctAnswer: 1,
    explanation:
      'If the plastic section completely isolates the internal metalwork from earth, bonding may not be required. However, best practice is often to bond anyway as future changes could reintroduce earth connection. Risk assessment should guide the decision.',
  },
  {
    id: 10,
    ...
    correctAnswer: 2,
    explanation:
      "Gas main bonding must be within 600mm of the meter AND on the consumer's side (outlet/downstream). This ensures the bonding is under the customer's control and protects all gas pipework within the building.",
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Purpose:</strong> Equalise potential of metal services with earth
              </li>
              <li>
                <strong>Location:</strong> Within 600mm of service entry point
              </li>
              <li>
                <strong>Services:</strong> Gas, water, oil, structural steel
              </li>
              <li>
                <strong>Size:</strong> Minimum 10mm² copper for TN supplies
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Missing bonding, corroded clamps, wrong sizes
              </li>
              <li>
                <strong>Use:</strong> Low-resistance ohmmeter testing
              </li>
              <li>
                <strong>Apply:</strong> Every incoming metallic service
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Main protective bonding connects extraneous-conductive-parts (metal services entering
              the building from outside) to the main earthing terminal (MET). This ensures all metal
              parts that could become energised are at the same electrical potential.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Prevents Touch Voltage:</strong> If a fault energises metalwork, bonding
                  ensures all metal rises together - no potential difference to touch
                </li>
                <li>
                  <strong>Equalises Potential:</strong> Creates equipotential zone - all bonded
                  parts at same voltage relative to earth
                </li>
                <li>
                  <strong>Assists Fault Clearance:</strong> Provides additional path for fault
                  current, helping protective devices operate
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10">
              ...
              <p className="text-sm text-white">
                These are conductive parts NOT part of the electrical installation but which could
                introduce a potential (usually earth potential) into the building. Examples: metal
                water pipes, gas pipes, structural steel, ducting connected to earth.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Any metallic service that enters the building and could introduce earth potential
              requires main bonding. The key is whether the metal is or could be connected to the
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Metallic Water Pipes:</strong> Bond within 600mm of entry, before any
                  branch connections
                </li>
                <li>
                  <strong>Metallic Gas Pipes:</strong> Bond within 600mm of meter, on consumer's
                  side (outlet)
                </li>
                <li>
                  <strong>Metallic Oil Pipes:</strong> Bond near entry point, similar to water
                </li>
                <li>
                  <strong>Structural Metalwork:</strong> Steel frames, beams in contact with earth
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-green-500/10">
              <p className="text-sm font-medium text-green-400 mb-2">
                Services NOT Requiring Bonding
              </p>
              <ul className="text-sm text-white space-y-1">
            ...
            <p className="text-sm text-elec-yellow/70 italic">
              <strong>When in Doubt - Bond It:</strong> If you're uncertain whether a service needs
              bonding, it's safer to bond it. Bonding a service that doesn't strictly need it does
              no harm. Not bonding one that does need it is dangerous.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Main bonding conductor size depends on the earthing system type and the size of the
              earthing conductor. There are minimum sizes that apply regardless of calculation.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10">
              ...
              <p className="text-sm text-white">
                Most domestic installations use 10mm² main bonding conductors as standard,
                regardless of the calculated minimum. This allows for future increases in supply
                size without needing to upgrade bonding.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Main bonding continuity is tested with a low resistance ohmmeter from the main
              earthing terminal to each bonded service.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>1. Isolate Supply (if testing at MET):</strong> Or test from earth bar in
                  CU if more accessible
                </li>
                <li>
                  <strong>2. Null Test Leads:</strong> Zero the instrument with leads shorted
                </li>
                <li>
                  <strong>3. Connect to MET/Earth Bar:</strong> One test lead to main earthing
                  terminal or earth bar
                </li>
                <li>
                  <strong>4. Test to Each Bonded Service:</strong> Other lead to bonding clamp on
                  each pipe/service
                </li>
                <li>
                  <strong>5. Record Results:</strong> Should be very low (typically less than 0.05Ω)
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Main bonding connections must be made using approved methods and labelled correctly.
              Poor connections can result in high resistance or complete failure of the bonding.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Main bonding test results are recorded on the Electrical Installation Certificate or
              Periodic Inspection Report, confirming the continuity of each bonding conductor.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Service bonded:</strong> Water, Gas, Oil, etc.
                </li>
                <li>
                  <strong>Conductor size:</strong> CSA of bonding conductor
                </li>
                <li>
                  <strong>Continuity reading:</strong> Measured resistance in ohms
                </li>
                <li>
                  <strong>Location:</strong> Where bonding connection is made
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10">
              ...
              <p className="text-sm text-white">
                If main bonding is missing or inadequate, this is a C1 (danger present) observation
                on a periodic report. The installation is unsafe until bonding is installed or
                corrected.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Missing bonding to gas</strong> - very common on older installations
                </li>
                <li>
                  <strong>Bonding disconnected</strong> - after plumbing work
                </li>
                <li>
                  <strong>Undersized bonding conductor</strong> - especially on upgraded supplies
                </li>
                <li>
                  <strong>Corroded connections</strong> - giving high resistance
                </li>
                <li>
                  <strong>Wrong side of gas meter</strong> - bonded on utility side
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>BS 7671:</strong> Regulation 411.3.1.2 - Main bonding
                </li>
                <li>
                  <strong>Table 54.8:</strong> Minimum bonding conductor sizes
                </li>
                <li>
                  <strong>BS 951:</strong> Specification for bonding clamps
                </li>
                <li>
                  <strong>Regulation 514.13:</strong> Safety label requirements
                </li>
              </ul>
            </div>
          </div>
