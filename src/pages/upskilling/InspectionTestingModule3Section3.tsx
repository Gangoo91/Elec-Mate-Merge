    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reg 411.3.1.2 says you must bond every extraneous-conductive-part to the MET. Reg 643.2.1
          says you must test every one of those bonds by resistance measurement. This is how the
          test is done, what the conductor must be sized at, and what the readings tell you.
        </p>
        ...
        >
          ...
          <p>
            ...
            pipes enter a building and are then connected to metallic pipes within the building, the
            metallic pipes within the building do not normally require protective bonding as they
            are unlikely to be extraneous-conductive-parts. Read &lsquo;normally&rsquo; as
            &lsquo;verify with a resistance test before deciding&rsquo;. If the metalwork has a path
            to true earth that produces a resistance below the IET threshold of 22 kΩ from any other
            location, it is an extraneous-conductive-part and the duty applies.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              earthing terminal by protective bonding conductors complying with Chapter 54. Examples
              of extraneous-conductive-parts can include:
              <br />
              (a) metallic water installation pipes; (b) metallic gas installation pipes; (c) other
              metallic installation pipework and ducting; (d) central heating and air conditioning
              systems; (e) exposed metallic structural parts of the building.
              <br />
              NOTE: Where non-metallic pipes (e.g. plastic) enter a building and are then connected
              to metallic pipes within the building, the metallic pipes within the building do not
              normally require protective bonding as they are unlikely to be
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>Main bonding csa ≥ half the csa of the earthing conductor of the installation.</li>
            <li>
            ...
            <li>
              Where the installation serves more than one building, csa not less than 6 mm² and need
              not exceed 25 mm² for copper.
            </li>
          </ul>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <br />
              Except for highway power supplies and street furniture, where PME conditions apply the
              main protective bonding conductor shall be selected in accordance with the PEN
              conductor of the supply and Table 54.8.
              <br />
              <br />
              Table 54.8 — Minimum copper-equivalent csa of the main protective bonding conductor in
              relation to the PEN conductor of the supply:
              <br />
        ...
        <RegsCallout
          ...
          clause={
            <>
              The main protective bonding connection to any extraneous-conductive-part such as gas,
              water or other metallic pipework or service shall be made as near as practicable to
              the point of entry of that part into the premises. Where there is a meter, isolation
              point or union, the connection shall be made to the consumer&rsquo;s hard metal
              pipework and before any branch pipework. Where practicable the connection shall be
              made within 600 mm of the meter outlet union or at the point of entry to the building
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Place one probe on the MET (or as close to the MET as the test point allows — a fixing
              screw on the main earth bar is the canonical choice).
            </li>
            <li>
              Take the other probe to the extraneous-conductive-part itself — the bare metal beyond
              the bonding clamp. For a gas pipe, this is the consumer-side hard pipework downstream
              of the clamp; for a water pipe, the same; for structural steel, the clean metal beyond
              the lug.
            </li>
            <li>
          ...
          <p>
            ...
            conductor resistance (length × mΩ/m from GN3 Table BI for the conductor csa) plus a few
            mΩ of clamp contact resistance, plus a few mΩ of MET termination resistance. A 4 m run
            of 10 mm² copper bond is around 4 × 1.83 mΩ/m = 7.3 mΩ of conductor — call it 0.01 Ω.
            Add the terminations and you should be reading 0.02–0.05 Ω in total. Anything in the
            tenths of an ohm is investigated; anything in the ones of an ohm is a definite fail.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="400" y="388" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              Supply
            </text>
            <text x="400" y="402" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              earth
            </text>
          ...
          whatToDo={
            <>
              ...
              <span className="block">
                ...
                MET, the gas-to-water reading should be the sum of both bonds back to the MET = 0.04
                + 0.05 = 0.09 Ω. The reading is 0.06 Ω, lower than that sum.
              </span>
              <span className="block">
                The lower reading means there is a parallel path between the gas and water services
                that does not go via the MET. In a 1985 semi this is almost certainly the copper
                hot-water cylinder: the cold water feed and the gas to the boiler both terminate at
                metalwork that is electrically continuous via the cylinder/heat exchanger.
              </span>
              <span className="block">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Each main bond from MET to its extraneous-conductive-part is tested individually. The
              cross-bond does not invalidate that reading — the reading still represents the bond +
            ...
            <li>
              ...
              the installation by a substantial fraction. Note the cross-bond on the certificate so
              future inspectors expect this if the metalwork changes.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              another earthed part could see a touch voltage above the safe envelope during a fault.
            </li>
            <li>
              Use a low-current insulation tester or a dedicated continuity tester. Probe to a
              separate true-earth reference (an earth electrode driven into clean ground at least a
              metre from any buried bonded service).
            </li>
          </ul>
          <p>
            ...
            NOTE&rsquo; is the wording that withstands an audit five years later when somebody asks
            why the kitchen radiator is not bonded.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            A reading of 0.10 Ω on the same bond is twice the expected value — investigate the clamp
            and the MET termination. A reading of 0.50 Ω is ten times — definitely a fault, almost
            certainly a clamp on paint or oxide. A reading of 5 Ω or more is effectively no bond,
            regardless of whether the conductor is physically present.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              verified by a measurement of resistance using a low-resistance ohmmeter; the measured
              resistance shall demonstrate a low-resistance continuous path between bonded services
              / extraneous-conductive-parts and the main earthing terminal.
            </>
          }
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Comments column:</strong> any cross-bond identified during testing, any series
              resistance higher than expected (with calculated value for comparison), any clamp
              re-fitted during the test (clean back to bare metal, etc.).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              <span className="block">
                Sizing per Reg 544.1.1 / Table 54.8: PEN ≤ 35 mm² → main bond minimum 10 mm² copper.
                Specify 10 mm² G/Y singles for all three bonds.
              </span>
              <span className="block">
                Routing per Reg 544.1.2: all three connections on consumer’s hard pipework, before
                any branch, within 600 mm of meter outlet (or building entry for the oil pipe, since
                the meter is external in the case of gas and the entry is the practical reference).
              </span>
              <span className="block">
