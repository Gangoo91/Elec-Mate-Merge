      ...
      <footer className="px-4 sm:px-6 lg:px-8 pb-8">
        <div>
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <Link to="/study-centre/upskilling/inspection-testing-module-5-section-5" className="w-full sm:w-auto">
              <Button
                variant="outline"
            ...
            <Link to="/study-centre/upskilling/inspection-testing-module-5-section-7" className="w-full sm:w-auto">
              <Button
