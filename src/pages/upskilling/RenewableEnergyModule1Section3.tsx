...
const inlineChecks = [
  ...
  {
    id: 'm1s3-gn3-role',
    question: 'Guidance Note 3 (GN3) sits in the BS 7671 documentation stack as:',
    options: [
  ...
  },
  {
    ...
    question: 'GN3 defines "relevant criteria" for inspection and testing as:',
    options: [
  ...
  },
  {
    ...
    question: 'GN3 sets the rule on test instruments. What is the basic obligation?',
    options: [
...
const quizQuestions = [
  ...
  {
    id: 4,
    question: 'GN3 Section 2.6 is the reference for what?',
    options: [
  ...
  {
    id: 8,
    question: 'The On-Site Guide and GN3 are non-statutory. What gives them weight in practice?',
    options: [
...
const faqs = [
  {
    question: 'Is the On-Site Guide a replacement for BS 7671 on simple jobs?',
    answer:
  ...
  {
    question: 'Are OSG and GN3 revised in step with each BS 7671 amendment?',
    answer:
  ...
  {
    question: 'If the OSG and GN3 are non-statutory, can I simply not follow them?',
    answer:
  ...
  {
    question: 'How will the 19th Edition affect the OSG and GN3?',
    answer:
...
export default function RenewableEnergyModule1Section3() {
  ...
  useSEO({
    title: 'On-Site Guide & Guidance Note 3 for LCT | Renewable Energy 1.3 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 3 · BS 7671:2018+A4:2026"
        title="On-Site Guide & Guidance Note 3 — how they apply to LCT"
        backTo="../renewable-energy-module-1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The IET On-Site Guide and Guidance Note 3 (Inspection & Testing) operationalise BS 7671
          for the everyday installer and the inspector — including the &lsquo;relevant
          criteria&rsquo; doctrine, the inspect-then-test sequence and the LCT-specific signposts.
        </p>
        ...
        >
          <p>
            The On-Site Guide is the IET\'s mass-market distillation of BS 7671 for the general
            electrician. It takes the most commonly used parts and presents them in a more navigable
            form.
          </p>
          <p>
            The OSG is not a complete substitute for BS 7671. On edge cases, on LCT work that
            touches multiple chapters, or on departures from standard practice, the OSG points back
            to the standard or to the relevant IET Code of Practice.
          </p>
          <p>
            Guidance Note 3 is the practical companion to BS 7671 Part 6 (Inspection and Testing).
            GN3 provides:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Section 2.6</strong> — detailed test procedures
            </li>
            <li>
              <strong className="text-white">Section 5</strong> — example completed model forms
            </li>
            <li>
              <strong className="text-white">Chapter 4</strong> — instrument selection and
              calibration guidance
            </li>
            <li>
              <strong className="text-white">Throughout</strong> — the inspector-judgement framework
              BS 7671 stays general on
            </li>
          </ul>
          <p>
            Both are non-statutory — like BS 7671 itself. Their weight comes from being the accepted
            reference for competent practice. Courts, PI insurers, MCS auditors and EICR inspectors
            treat consultation as the baseline evidence of how a competent installer or inspector
            would have approached the work.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            GN3\'s "relevant criteria" definition is one of the most important rules in the BS 7671
            documentation stack, and one of the least understood by installers coming to LCT from
            general electrical contracting.
          </p>
          <p>The rule:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              Default: the requirements of the Regulations (BS 7671) applicable to the particular
              inspection or test
            </li>
            <li>
              Override: where the designer has specified particular requirements, those are the
              relevant criteria
            </li>
          </ul>
          <p>
            On routine domestic work the rule rarely bites. On LCT work it frequently does. Hybrid
            installs commonly have designer-specified items that exceed (or differ from) the BS 7671
            minimum:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
          ...
          <p>
            For the inspector: ask for the designer\'s spec at the start. The inspector who applies
            BS 7671 alone and ignores the designer\'s particular requirements has not applied the
            relevant criteria as GN3 defines them — even where the BS 7671 work is technically
            compliant.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            On a periodic inspection of a five-year-old hybrid install where the original design
            pack is no longer accessible, GN3 directs the inspector to forward test results to the
            designer (or a competent designer assessor) rather than unilaterally applying default
            acceptance.
          </p>
          <p>
            For the LCT installer doing initial verification of their own work, the equivalent
            discipline is to ensure the cert carries enough detail of the design-time decisions that
            a future inspector can read the design intent. A4\'s Reg 133.1.3 change (equipment-usage
            recording) moves the cert deliberately in this direction.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Technical</strong> — testing a defective installation
              may injure personnel or damage equipment
            </li>
            <li>
              <strong className="text-white">Procedural</strong> — testing cannot make a defective
              installation safe; only correction can
            </li>
          </ul>
          <p>
            On LCT work the rule frequently meets commercial pressure pushing the other direction.
            The installer arrives with a tight handover deadline. The visual inspection shows a
            loose PV module clamp, an inverter warning notice weathered to illegible, or a DC
            isolator label that has fallen off. The temptation is to test first, log the defects,
            treat them as commissioning-stage rectifications.
          </p>
          <p>
            GN3 says this is wrong. All three defects should be corrected before any testing
            instrument is connected.
          </p>
          <p>
            The corollary is also worth absorbing: testing is not a search for defects. Insulation
            resistance testing on a PV string is not a way to discover whether the string is
            properly isolated; it is a confirmation that the string is properly isolated after the
            visual and mechanical inspection has confirmed the same thing.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Photovoltaic systems warning notice</strong> — PV
              arrays require durable warning notices at the incomer / consumer unit and on the roof
              / array location
            </li>
            <li>
              <strong className="text-white">Isolation identification multiple devices</strong> —
              where multiple devices provide isolation (AC isolator at CU, DC isolator at inverter,
              BESS isolator), each must be labelled
            </li>
            <li>
              <strong className="text-white">Outbuildings</strong> — separate buildings on the same
              premises (garages, sheds, garden offices) — common siting for domestic BESS and some
              PV inverter installations
            </li>
            <li>
              <strong className="text-white">Periodic inspection</strong> — EICR scope in dwellings
              now routinely includes LCT installations
            </li>
          </ul>
          <p>
            The OSG is not the detailed reference for any of these. The detailed reference lives in
            BS 7671 itself, GN3 and the relevant IET CoP. The OSG is the navigation layer that puts
            the everyday installer in the right place in the documentation stack.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Annual formal calibration</strong> by a UKAS-accredited
              or manufacturer-authorised lab. Evidenced by a calibration certificate with instrument
              serial number, date and validity period.
            </li>
            <li>
              <strong className="text-white">Mid-cycle check-box verification</strong> — a device
              with clearly defined electrical characteristics (known resistance, known loop
              impedance, known continuity) used to verify the instrument hasn\'t drifted between
              formal calibrations.
            </li>
          </ul>
          <p>
            For LCT work the discipline matters disproportionately. DC string insulation resistance,
            BESS isolation impedance and PV continuity testing all involve borderline-acceptance
            judgements. An out-of-calibration tester producing a borderline reading is worse than no
            test at all — the false confidence is the failure mode.
          </p>
          <p>
            On a borderline reading that later goes to dispute, the audit trail — instrument was in
            calibration, check-box verification was within tolerance, the reading was correctly
            recorded — is what defends the acceptance call.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              A1, A2, A3 amendments each followed by aligned OSG / GN3 editions within 6–12 months
            </li>
          ...
          <p>
            What will change is the reference apparatus — the consolidated 19th Edition Part 7 LCT
            framework will replace the scattered chapter references currently used in the OSG and
            GN3.
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-1-section-4')}
