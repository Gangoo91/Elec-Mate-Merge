    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Calculated vs measured, the ±10 % tolerance band, the four diagnostic outcomes, and how
          the R1+R2 reading feeds Zs verification under Reg 643.7.3.1.
        </p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              of: (a) protective conductors, including protective bonding conductors; and (b) in the
              case of ring final circuits, live conductors.
            </>
          }
        ...
        >
          ...
          <p>
            Worked example: a 22 m radial in 2.5/1.5 mm² T&amp;E. Calculated R1+R2 at 20&deg;C = 22
            × 19.51 mΩ/m = 0.43 Ω. That is the comparator number for the next step.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            proceed. A reading of 0.55 Ω is 28 % high — investigate. A reading of 0.30 Ω is 30 % low
            — investigate, with parallel paths the leading suspect.
          </p>
          <p>
            The tolerance band is not an excuse to record measurements you have not nulled the leads
            on, or to accept readings from a meter you have not verified against a known short. The
            band absorbs honest variation; it does not absorb procedural shortcuts.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="400" y="42" textAnchor="middle" fill="#FBBF24" fontSize="12" fontWeight="bold">
              CALCULATED R1+R2
            </text>
            ...
            <text x="400" y="420" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="10">
              Compare against the maximum permitted Zs from the Schedule of Circuit Details (A4:2026
              column).
            </text>
          </svg>
        </div>
        ...
        >
          <p>
            This is the only outcome where the next action is to record and proceed without further
            investigation. The calculated R1+R2 was 0.43 Ω; the measured value is 0.41 Ω; you write
            0.41 in the R1+R2 column on the Schedule of Test Results, and you move on. Note: you
            record the MEASURED value, not the calculated one — the schedule documents what the
            meter saw, not what the meter should have seen.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Predicted Zs goes up. If the high reading drives Zs past the Reg 411.3.2 / Table 41.1
              limit, ADS will not operate within the disconnection time and the circuit is
              non-compliant for fault protection.
            </li>
            <li>
              A high-resistance joint is a heat source under fault current. The joint that reads 0.7
              Ω at the far end of a 32 A radial dissipates 32² × 0.7 = 717 W under sustained fault
              current — at the location of the joint, in the wall, with no thermal protection. The
              MCB trip time is the only thing standing between that and a fire.
            </li>
            <li>
          ...
          whatToDo={
            <>
              <span className="block">
                ...
                Schedule of Circuit Details, 32 A B-curve at 70&deg;C) ≈ 1.37 Ω, so the high reading
                does NOT yet drive the circuit out of compliance for ADS.
              </span>
              <span className="block">
                But the reading is 28 % high, well outside ±10 %. Switch to Method 2 from the MET,
                walk the circuit socket-by-socket, and look for the jump. Likely candidates: the FCU
                spur halfway along, the back-box terminations at the furthest socket, or a junction
                in the loft that is not on the drawing.
              </span>
              <span className="block">
        ...
        >
          <p>
            A reading lower than calculated feels like a pass. It usually is not. The danger is that
            the parallel path is doing the CPC&rsquo;s job, and on the day someone removes that path
            — refurbishment, re-routing, replacing a gas pipe with plastic — the CPC is exposed as
            inadequate with no warning to anyone.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Bonded services.</strong> A gas pipe bonded at the meter and routed alongside
              / clipped to a CPC at an accessory. Touch them and the CPC is short-circuited at that
              accessory.
            </li>
            <li>
            ...
            <li>
              ...
              The R1+R2 of one circuit reads in parallel with the other circuit&rsquo;s CPC back to
              the MET.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              Re-confirm isolation at the source. The cable is dead and locked off — re-prove with a
              verified voltage indicator.
            </li>
            <li>
              Walk the cable from origin to far end, checking each junction box, accessory and
              termination for a broken or loose CPC. Method 2 (wandering lead from the MET) lets you
              bisect — measure halfway, measure quarter, narrow it down.
            </li>
            <li>
            ...
            <li>
              ...
              the entire fault protection for the circuit is absent. Reg 644.1.1 requires this to be
              corrected before the Certificate is issued for new work.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          <p>
            The arithmetic is simple, but the order matters. The continuity test you just performed
            reads the cable at ambient — 20 °C in a typical UK property, sometimes less in winter.
            The Zs limit you are comparing against is the value at which the circuit must still
            operate within its disconnection time at full operating temperature. So:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
            ...
            <li>
              ...
              against the limit directly — it is already at the cable&rsquo;s operating temperature.
              Use the corrected calculated Zs only as the predicted value to cross-check the live
              measurement.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              method. An electrical continuity test shall be carried out according to Regulation
              643.2 before carrying out the earth fault loop impedance measurement. The measured
              earth fault loop impedance shall comply with Chapter 41.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Use R1+R2 corrected to operating temperature (typically &times;1.20 for thermoplastic)
              for the comparison against Table 41 limits at 70&deg;C.
            </li>
            <li>
              ...
              Circuit Details — use the value in that column when the design has set a tighter
              limit, not the BS&nbsp;7671 Table 41.3 raw value.
            </li>
            <li>
              Where the circuit is RCD-protected and disconnection times rely on the RCD rather than
              the overcurrent device, the R1+R2 still has to be measured and recorded — Reg 643.2.1
              does not exempt RCD-protected circuits, and a high R1+R2 is still a conductor defect
              that needs investigation regardless of the protective measure.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              <span className="block">
                Step 1 — calculated R1+R2 at 20&deg;C = 22 × 19.51 mΩ/m = 0.43 Ω. ±10 % band = 0.39
                to 0.47 Ω.
              </span>
              <span className="block">
              ...
              <span className="block">
                Step 3 — apply temperature correction for the Zs prediction: 0.43 × 1.20 = 0.52 Ω at
                70&deg;C (you use the calculated value corrected, not the measured value, because
                the limit is at operating temperature).
              </span>
              <span className="block">
                Step 4 — predicted Zs = Ze + corrected R1+R2 = 0.32 + 0.52 = 0.84 Ω. Compare to 1.37
                Ω limit → comfortably compliant.
              </span>
              <span className="block">
                Step 5 — proceed to the live Zs test (Reg 643.7.3) to confirm. Live Zs comes back at
                0.81 Ω — within the predicted value, well under the limit. Record on the schedule.
                Move on.
              </span>
            </>
          }
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              test (r1, r2 and rn at each socket / furthest socket), the column takes the far-socket
            ...
            <li>
              ...
              circuit. Where the design has set a tighter limit than the BS&nbsp;7671 Table 41.3 raw
              value, this column carries the design value and the inspector compares the live Zs
            ...
            <li>
              ...
              accessories disconnected for the test, supplementary bond removed for the measurement,
              ring final tested at the furthest socket only — all flagged in comments so the next
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Low R1+R2 due to confirmed parallel earth path:</strong> typically not coded,
              but the parallel path itself must be assessed. If removing the parallel path would
              expose the CPC as inadequate, the parallel path is doing CPC duty and that is a Reg
              543 issue, classified per the residual risk.
            </li>
            <li>
