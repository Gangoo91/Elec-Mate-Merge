...
const DESCRIPTION =
  'Learn to interpret continuity test results, calculate expected values, and identify faults from test data.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'From BS 7671 Table 5B, 1.5mm² copper has a resistance of 12.10 mΩ/m at 20 degrees C.',
  },
  {
    id: 'temp-correction',
    ...
    correctIndex: 2,
    explanation:
      '1.2 multiplier accounts for conductor resistance increase at maximum operating temperature (typically 70 degrees C) compared to 20 degrees C test conditions.',
  },
  {
    id: 'high-r1r2',
    ...
    correctIndex: 1,
    explanation:
      'Higher than expected R1+R2 may indicate safety issues like poor connections or damaged conductors. Always investigate the cause.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'From BS 7671 Table 5B, 2.5mm² copper has a resistance of approximately 7.41 mΩ/m at 20 degrees C.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Higher resistance than expected often indicates smaller conductor CSA, poor connections, or longer cable run than assumed.',
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      'A multiplier of 1.2 is applied to account for conductor resistance increase at maximum operating temperature (typically 70 degrees C for thermoplastic).',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Total earth fault loop impedance (Zs) = External impedance (Ze) + Circuit impedance (R1+R2).',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'From BS 7671 Table 5B, 1.5mm² copper has a resistance of approximately 12.10 mΩ/m at 20 degrees C.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'Variations of plus/minus 10-15% are generally acceptable, accounting for actual vs nominal CSA, connection resistances, and measurement tolerances.',
  },
  {
    id: 8,
    ...
    correctAnswer: 2,
    explanation:
      'A healthy ring shows approximately equal r1+r2 values at each socket position, following the r1/4 + r2/4 pattern.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'The 1.2 multiplier accounts for conductor resistance increase when operating at maximum temperature compared to test conditions at ambient temperature.',
  },
  {
    id: 10,
    ...
    correctAnswer: 0,
    explanation:
      'Lower than expected resistance suggests the actual conductor CSA is larger than assumed in calculations, which is acceptable.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Use BS 7671 Table 5B/5C for conductor resistance (mΩ/m). Multiply by circuit length. Add R1 (line) + R2 (CPC) values together. For example: 20m circuit with 2.5/1.5mm² = (7.41x20) + (12.10x20) = 390.2mΩ = 0.39Ω.',
  },
  {
    question: 'What if measured values exceed calculated values?',
    answer:
      'Investigate: (1) Poor connections at terminals, (2) Damaged conductor reducing CSA, (3) Incorrect conductor size actually installed, (4) Longer cable route than assumed, (5) High resistance joint or accessory. Re-test after checking.',
  },
  {
    question: 'Why apply temperature correction?',
    answer:
      'Tables give resistance at 20 degrees C. Copper resistance increases ~0.4% per degree C above this. At 30 degrees C, multiply by 1.04. At 10 degrees C, multiply by 0.96. This matters for accurate fault loop impedance verification.',
  },
  {
    question: 'How do I use R1+R2 for Zs verification?',
    answer:
      'Zs = Ze + (R1+R2). Measure Ze at origin. Add measured R1+R2 for the circuit. The sum must not exceed maximum Zs values from BS 7671 Chapter 41. Apply temperature correction factor (multiply R1+R2 by 1.2 for max operating temp).',
  },
  {
    question: "What's an acceptable tolerance on calculated values?",
    answer:
      'Measured values should be within plus/minus 10-15% of calculated. Minor differences are normal due to: actual vs nominal CSA, connection resistances, temperature variations. Significant deviations warrant investigation.',
  },
  {
    question: 'How do ring circuit results differ?',
    answer:
      'Ring circuits should show approximately equal resistance at each socket (r1/4 + r2/4 pattern). Significant variation between sockets indicates broken ring, crossed connections, or interconnections.',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Compare:</strong> Measured vs calculated R1+R2
              </li>
              <li>
                <strong>Tolerance:</strong> plus/minus 10-15% acceptable
              </li>
              <li>
                <strong>Zs Formula:</strong> Zs = Ze + (R1+R2 x 1.2)
              </li>
              <li>
                <strong>High Reading:</strong> Investigate connections
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              ...
              <li>
                <strong>Use:</strong> Table 5B resistance values
              </li>
              <li>
                <strong>Apply:</strong> Temperature correction x1.2
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="my-6 p-4 rounded-lg bg-transparent border border-white/10">
              ...
              <p className="text-center font-mono text-elec-yellow text-xl">
                R1+R2 = (mΩ/m<sub>line</sub> + mΩ/m<sub>CPC</sub>) x Length
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>When measured R1+R2 differs from calculated values:</p>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-amber-500/10">
              ...
              <p className="text-sm text-white">
                For Zs verification, multiply R1+R2 by 1.2 to account for maximum operating
                temperature.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Document Your Calculations:</strong> Record both expected and measured
                  values. This demonstrates competence and helps identify patterns
                </li>
                <li>
                  <strong>Check Cable Routes:</strong> Actual cable routes may be longer than direct
                  distances. Add 10-15% for typical building layouts
                </li>
                <li>
                  <strong>Re-test After Remedial Work:</strong> If you tighten connections or make
                  repairs, always re-test to verify the improvement
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Ignoring temperature:</strong> Not applying correction for Zs verification
                </li>
                <li>
                  <strong>Wrong cable length:</strong> Using direct distance instead of actual route
                </li>
                <li>
                  <strong>Forgetting connections:</strong> Not accounting for joint resistances
                </li>
                <li>
                  <strong>Wrong CSA:</strong> Assuming cable size without verification
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>BS 7671 Table 5B:</strong> Conductor resistance at 20 degrees C
                </li>
                <li>
                  <strong>Chapter 41:</strong> Maximum Zs values for devices
                </li>
                <li>
                  <strong>Regulation 612.2:</strong> Continuity testing requirements
                </li>
                <li>
                  <strong>GN3:</strong> Detailed testing guidance
                </li>
              </ul>
            </div>
          </div>
