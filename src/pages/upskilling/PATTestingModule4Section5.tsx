    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Manual, automatic and advanced PAT testers. The BS EN 61557 / BS EN 61010 standards, GS38
          lead-set requirements, annual calibration, and how the test instrument fits inside the
          wider competent-person framework.
        </p>
        ...
        >
          <p>
            ...
            of 50+ appliances this becomes a fatigue problem — fatigue-driven errors rise, and tests
            get skipped or recorded incorrectly.
          </p>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Pre-configured pass/fail.</strong> The Class I appliance profile sets ≤ 0.1 Ω
              + cable R for earth continuity, ≥ 1 MΩ for IR, ≤ 0.5 mA for substitute leakage. The
              operator does not interpret the reading against the limit — the tester does.
            </li>
            <li>
              <strong>On-board storage.</strong> Results are saved against the appliance ID, with
              timestamp, test method and pass/fail. The record is structured and audit-ready without
              manual transcription.
            </li>
          </ul>
          <p>
            The disadvantages are mostly cost (a mid-range automatic tester costs roughly twice what
            a manual tester costs) and the small risk that pre-configured limits are wrong for the
            appliance under test (most testers handle this by allowing custom test profiles). For a
            fleet of more than a few dozen appliances, the trade is unequivocally in favour of
            automatic.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              manufacturers offer their own, with API hooks for third-party). The operator does not
              transcribe; the records flow direct to the duty-holder system.
            </li>
            <li>
              <strong>Barcode reading.</strong> Each appliance has a unique barcode label (typically
              applied at the previous test cycle); the tester reads the barcode, looks up the
              previous test record, and presents the test profile and history to the operator before
              testing starts.
            </li>
            <li>
              <strong>Calibration-check function.</strong> A built-in or external reference unit
              with known-resistance and known-IR test points. The operator runs a check at the start
              of each session; the tester verifies its measurements against the reference and either
              confirms in-spec or flags a calibration concern.
            </li>
          </ul>
          <p>
            The break-even on advanced versus mid-range automatic depends on appliance volume. For a
            contractor handling 5000+ appliances per year, the advanced features pay back in months.
            For a small site with 50 appliances tested annually, the automatic tester is sufficient
            and the advanced features are over-spec.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="85" y="121" textAnchor="middle" fill="#FBBF24" fontSize="10" fontWeight="bold">
              EARTH
            </text>
            <rect
              x="125"
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="405" y="65" textAnchor="middle" fill="#FBBF24" fontSize="13" fontWeight="bold">
              AUTOMATIC
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="660" y="65" textAnchor="middle" fill="#22C55E" fontSize="13" fontWeight="bold">
              ADVANCED
            </text>
        ...
        >
          ...
          <p>
            A multifunction tester that does both PAT and installation testing typically meets Parts
            1, 2, 3, 4 and 6 — the dual-use kit covers both portable equipment and the
            fixed-installation tests in BS 7671 643.x. A PAT-only tester typically meets Parts 1, 2
            and 4. The compliance is declared on the manufacturer\'s data sheet; if it is not
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Voltage-rated insulation:</strong> the lead body insulation must be rated for
              the voltage category of the supply being tested. PAT lead sets are typically rated CAT
              II 600 V or CAT III 1000 V depending on the model.
            </li>
            <li>
              <strong>Fused leads where appropriate:</strong> for live troubleshooting work, leads
              with an in-line BS 1362 fuse limit short-circuit fault current and reduce the risk of
              arc flash. Standard PAT leads are not always fused (the tester provides the
        ...
        >
          <p>
            ...
            the tester was within manufacturer spec on a specific date; subsequent test results are
            auditable against that reference. Most testing organisations align the annual
            calibration with the start of their financial year so the calibration certificate covers
            a known operational period.
          </p>
          <p>
            ...
            session; if the tester reads 0.10 Ω against the 0.10 Ω reference, the tester is in spec
            for that day. Run the same check against the IR reference. Done in two minutes, the
            in-session check catches the most common cause of bad PAT records: the tester drifted
            out of spec mid-cycle and nobody noticed until the next annual.
          </p>
          <div className="overflow-x-auto">
            <table className="w-full text-[13.5px] my-2">
              <thead>
          ...
          whatToDo={
            <>
              ...
              <span className="block">
                ...
                whether the previous two days\' tests need repeating. The fail margin (0.27 vs 0.10
                Ω) is enough to flip a borderline appliance from pass to fail, so the answer is
                normally yes.
              </span>
              <span className="block">
        ...
        <RegsCallout
          ...
          clause={
            <>
              Suitable test equipment, in good condition and fit for purpose, will form an essential
              part of any combined inspection and testing regime. Calibration of test equipment must
              be carried out at periods recommended by the manufacturer and / or as appropriate to
              the type of testing. The competence of the person performing the tests must be matched
              to the test regime adopted; in particular, combined inspection and testing requires
              the operator to have a sound knowledge of test methods, instrument operation, and the
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>User checks (no formal training required).</strong> Everyday users are trained
              to spot obvious damage — a frayed flex, a cracked plug, a smell of burning, a wobbling
              kettle base. Daily / pre-use; reports problems but does not test.
            </li>
            <li>
              <strong>Formal visual inspection (basic training).</strong> The trained inspector
              conducts a thorough visual check at intervals (typically weekly to annually, depending
              on equipment risk per HSG107 risk assessment). Removes from service items with visible
              damage. No instrument-based testing.
            </li>
            <li>
              <strong>
                Combined inspection-and-testing (formal training to a recognised standard, typically
                C&amp;G 2377 or equivalent).
              </strong>{' '}
              Performs the IET CoP test sequence with appropriate test equipment. Records pass /
              fail per appliance with numeric test results. The full PAT regime as described in this
              module.
            </li>
          </ol>
          <p>
            The C&amp;G 2377 (or equivalent) formal qualification is the industry-recognised
            evidence of competence at the third tier. The qualification covers test methods, IET CoP
            acceptance values, equipment under test (Class I / II / III, IT equipment, medical edge
            cases), instrument operation, and the legal framework. Most insurance and duty-holder
            policies require operators at this tier to hold a current qualification and demonstrate
