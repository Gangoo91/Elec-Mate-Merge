...
const quizQuestions = [
  {
    id: 1,
    question:
      'What is the formal structure of a client handover for an emergency lighting installation?',
    options: [
  ...
  },
  {
    id: 2,
    question:
      'Why is a cause-and-effect description required for staged or zoned emergency lighting systems?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'How is the emergency lighting handover related to the broader fire safety handover for a new building?',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'Why must the handover include a demonstration of the test facility (where one is provided)?',
    options: [
  ...
  },
  {
    id: 9,
    question:
      'A handover is being completed and the responsible person says "we don\'t need the manuals — the contractor will handle everything". What is the correct response?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The structured handover that transfers an emergency lighting installation from the
          contractor to the responsible person. Documentation pack assembly, responsible-person
          briefing on RRO 2005 duties and operational regime, cause-and-effect description for
          staged or zoned systems, photographic asset record, demonstration of test facilities, and
          the signed handover register that records the regulatory transfer.
        </p>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Documentation pack assembly.</strong> Before the handover meeting, assemble
              the complete pack: design drawings, as-builts, lux calculation, BS 5266-1:2025
              acceptance certificate, BS 7671 EIC, central battery system certificate (where
              applicable), manufacturer manuals, photometric data sheets, cause-and-effect
              description, logbook starter, warranty documentation, spares list, photographic
              record. Verify completeness against the BS 5266-1 expectations.
            </li>
            <li>
              <strong>Documentation pack walk-through.</strong> At the meeting, walk through each
              element of the pack with the responsible person. Explain what each document is, why it
              matters, where it should be filed, and how it will be used during operation.
            </li>
            <li>
              <strong>Responsible-person briefing.</strong> Deliver the structured briefing: RRO
              2005 duties (Articles 14, 17, 23), daily check (where applicable), fault response,
              periodic regime, documentation use, contractor contacts. Use a briefing record /
              checklist; the responsible person initials each topic as covered.
            </li>
            <li>
              <strong>Demonstration.</strong> On site, demonstrate: the central battery panel and
              its indicators (where applicable), the test facility (key-operated test switch or test
              mode), the self-test controller (where applicable), the lockable supply isolator, the
              warning notices. The responsible person performs each operation under guidance.
            </li>
            <li>
              <strong>Periodic schedule agreement.</strong> Agree the planned schedule for monthly
              functional, annual duration, and five-year photometric tests. Calendar dates
              committed; the responsible person prepares site access and notifies building users for
              each window.
            </li>
            <li>
              <strong>Contacts and escalation.</strong> Confirm contractor contact details, normal
              hours support, out-of-hours support, and the procedure for raising fault calls.
              Document in the responsible person's management procedures.
            </li>
            <li>
              <strong>Signed handover register.</strong> A formal record signed by both parties
              confirming: documentation pack received, briefing completed, demonstration witnessed,
              schedule agreed, contacts established. Date, signatures, copies retained by both
              parties.
            </li>
          </ol>
          <p>
            Each step has a documented output. At the end of the meeting, the documentation pack is
            in the responsible person's possession, the briefing record is signed, the schedule is
            committed, the contacts are recorded, and the handover register is signed. The transfer
        ...
        <RegsCallout
          ...
          clause={
            <>
              On completion of commissioning, the contractor shall hand over the emergency lighting
              installation to the responsible person by means of a structured handover including
              delivery of the complete documentation pack, briefing of the responsible person on
              their duties under the relevant fire safety legislation, demonstration of any test
              facilities and central battery systems, agreement of the periodic test schedule, and
              execution of a signed handover register. The handover documentation shall form part of
              the building fire safety records.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              person shall ensure that emergency routes and exits are indicated by signs and that
              emergency routes and exits requiring illumination are provided with emergency lighting
              of adequate intensity in the case of failure of their normal lighting.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="40" y="98" fill="#22D3EE" fontSize="11" fontWeight="bold">
              Design documents
            </text>
            <rect
              x="40"
            ...
            <text x="120" y="148" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              escape routes · luminaires
            </text>
            ...
            <text x="290" y="148" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              installed reality
            </text>
            ...
            <text x="460" y="148" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              DIALux / Relux model
            </text>
            ...
            <text x="650" y="148" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              staged / zoned systems
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="40" y="208" fill="#22C55E" fontSize="11" fontWeight="bold">
              Certificates
            </text>
            <rect
              x="40"
            ...
            <text x="120" y="258" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              BS 5266-1:2025
            </text>
            ...
            <text x="290" y="258" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
            ...
            <text x="460" y="258" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              BS EN 50171:2021
            </text>
            ...
            <text x="650" y="258" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="40" y="318" fill="#A855F7" fontSize="11" fontWeight="bold">
              Manuals and data
            </text>
            <rect
              x="40"
            ...
            <text x="120" y="368" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              per product type
            </text>
            ...
            <text x="290" y="368" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              per luminaire
            </text>
            ...
            <text x="460" y="368" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              manufacturer terms
            </text>
            ...
            <text x="650" y="368" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              recommended stock
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="40" y="428" fill="#FBBF24" fontSize="11" fontWeight="bold">
              Operational records
            </text>
            <rect
              x="40"
            ...
            <text x="120" y="478" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              BS 5266-1 model
            </text>
            ...
            <text x="290" y="478" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              populated
            </text>
            ...
            <text x="460" y="478" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              one per luminaire
            </text>
            ...
            <text x="650" y="478" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              RP signature
            </text>
            ...
            <text x="410" y="558" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              Contractor + responsible person both sign · documentation accepted · briefing
              completed · schedule agreed
            </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Input list.</strong> Every signal that affects the emergency lighting
              operation: local mains failure (per circuit), central battery mains failure, fire
              alarm activation (panel signal), test facility operation (test switch, test mode
              button), supply isolator operation, manual override switches.
            </li>
            <li>
              <strong>Output list.</strong> Every response the system can make: per-luminaire
              switching to emergency mode, central battery transfer, slave luminaire activation,
              override of normal lighting, response within design class (0.5 s / 5 s / 15 s),
              high-risk task light activation.
            </li>
            <li>
              <strong>Logic table.</strong> Row per input, column per output (or vice versa),
              describing the relationship. Example: input "Local mains failure on circuit DB-G/4" →
              output "Maintained luminaires on DB-G/4 switch to battery and continue to illuminate;
              non-maintained luminaires on DB-G/4 switch on for 3 hours; signage continues to
              illuminate".
            </li>
            <li>
              <strong>Narrative.</strong> Explain the design intent — why the logic is what it is.
              Example: "The high-risk task light in the laboratory activates only on fire alarm
              signal because in normal evacuation the laboratory is exited via the main escape route
              which has its own emergency lighting; the high-risk task light supports controlled
              shutdown of equipment, which is only required if the fire alarm has activated."
            </li>
            <li>
              <strong>Test references.</strong> For each logic row, reference how it was verified at
              commissioning — typically the switch-on test for that area, the duration test, any
              fire-alarm-triggered test.
            </li>
            <li>
              <strong>Update history.</strong> Where the system has been modified since
              commissioning, the cause-and-effect document is updated and old versions retained as
              historical record.
            </li>
          </ul>
          <p>
            For simple all-on-mains-fail installations, the cause-and-effect can be a single page.
            For complex installations with fire-alarm integration, central battery zoning, and
            addressable controllers, it can run to several pages. The 2025 standard reinforces this
            as part of the documentation pack — it is no longer optional for systems beyond the
            simplest.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>RRO 2005 duties.</strong> Article 14 (emergency escape route lighting),
              Article 17 (maintenance), Article 23 (records). Plain language summary of what the
              responsible person is legally obliged to do.
            </li>
            <li>
              <strong>The system.</strong> What has been installed: self-contained / central battery
              / hybrid; how many luminaires; key system features (self-test addressable controller,
              fire alarm integration, zoned operation).
            </li>
            <li>
              <strong>Daily check (where applicable).</strong> The brief indicator scan on the
              central battery panel or self-test controller. Green = healthy, anything else = call
              contractor. Demonstrate the check; provide the daily check book / electronic log.
            </li>
            <li>
              <strong>User reporting.</strong> Building users may notice a flagged luminaire (LED
              status, beep). Establish the procedure for them to report: who do they tell? Typically
              the responsible person via the building management system or directly.
            </li>
            <li>
              <strong>Fault response.</strong> When a fault is identified, the procedure is: do NOT
              silence alarms or reset faults; record the observation; call the maintenance
              contractor with the description; await response. Provide the contractor contact
              details.
            </li>
            <li>
              <strong>Periodic regime schedule.</strong> Walk through the planned schedule — monthly
              functional, annual duration, five-year photometric. Confirm the scheduled dates, what
              each test involves, what the responsible person needs to do (typically: confirm site
              access, notify building users, provide the contractor with access).
            </li>
            <li>
              <strong>Documentation pack location.</strong> Confirm where the pack will be stored.
              Walk through how to use it — how to find a luminaire on the as-built, how to reference
              a manufacturer manual, how to read the logbook.
            </li>
            <li>
              <strong>Escalation.</strong> Out-of-hours support, escalation to senior contractor
              staff, regulatory escalation (fire authority contact in extreme circumstances).
            </li>
            <li>
              <strong>Briefing record.</strong> A checklist signed by the responsible person
              confirming each topic was covered. Filed in the documentation pack.
            </li>
          </ul>
          <p>
            The briefing is structured so that any responsible person — competent in fire safety
            overall but not specifically in emergency lighting — can carry out their duties
            confidently. The contractor is not just installing equipment; they are equipping the
            responsible person with the operational understanding to use it correctly.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>One photograph per luminaire.</strong> Capture the luminaire in its location
              with enough surrounding context for orientation. The installation label must be
              readable in the photograph (zoom in if necessary, or take a second close-up of the
              label).
            </li>
            <li>
              <strong>Naming convention.</strong> File name matches the unique luminaire reference
              (e.g. EL-G-014.jpg). Filing structure organised by area or by reference. Consistent
              across the installation.
            </li>
            <li>
              <strong>Quality.</strong> Sharp, well-lit, taken with a competent camera (a modern
              smartphone is generally adequate). Dark or blurred photographs add no value.
            </li>
            <li>
              <strong>Index.</strong> The asset register has a column for the photograph reference;
              the photograph file folder has the matched filename. The index is the link.
            </li>
            <li>
              <strong>Cross-reference to as-built.</strong> The luminaire reference cross-references
              to the as-built drawing position; the photograph confirms the installation matches the
              as-built.
            </li>
            <li>
              <strong>Update at significant changes.</strong> Where a luminaire is replaced or
              relocated, take a new photograph and supersede the original. Old photographs retained
              as historical record.
            </li>
            <li>
              <strong>Backup.</strong> Photographs stored with backup discipline — they are part of
              the documentation pack and should not be lost in a single hard-drive failure.
            </li>
          </ul>
          <p>
            The photographic record adds about 5-10% to commissioning effort but pays back many
            times over. Maintenance dispatch is faster (the maintainer knows what to expect);
            insurer audits are quicker (visual evidence of the system); investigations are more
            decisive (as-installed vs as-found can be compared directly). Modern installations
            should treat the photographic record as a standard handover deliverable.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Central battery panel.</strong> Where applicable. Show the panel location, the
              indicator LEDs, the panel display, the daily-check focal point. Show what each
              indication means; show what an alarm condition looks like (some panels have a test
              mode that simulates alarms safely).
            </li>
            <li>
              <strong>Test facility (key-operated test switch or test mode button).</strong> Where
              provided. Show the location; show how to operate; show what to expect (luminaires
              switching to emergency mode for the duration of the test; LEDs change). Show how to
              restore.
            </li>
            <li>
              <strong>Self-test addressable controller.</strong> Where applicable. Show the
              controller location, how to log on, how to read the test logs, how to identify a
              flagged luminaire. The responsible person's daily / weekly review of the controller is
              the equivalent of the central battery panel daily check.
            </li>
            <li>
              <strong>Lockable supply isolator.</strong> Show the isolator location, the lock, the
              key control. Confirm the key holder. Demonstrate that the lock is fitted; the
              responsible person handles the lock and key.
            </li>
            <li>
              <strong>Warning notices.</strong> Walk past the warning notices on the isolator, the
              central battery enclosure, the fire-rated battery room. Confirm the responsible person
              understands what each notice means.
            </li>
            <li>
              <strong>Fire-rated battery enclosure.</strong> Where applicable. Show the enclosure,
              confirm the door seal, the keep-closed expectation, the access control.
            </li>
            <li>
              <strong>Spare parts location.</strong> Where the spares list nominates on-site stock
              (batteries, lamps), show the storage location, the inventory log, the rotation
              procedure (spares should be exercised periodically — the contractor uses on-site
              spares first, replacing them at the next visit).
            </li>
          </ul>
          <p>
            The demonstration takes 15-30 minutes for a typical installation. It makes the
            difference between a responsible person who has read about the system and one who has
            actually operated it. The 2025 standard supports the demonstration as part of the
            structured handover.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Header.</strong> Building address, design reference, contractor
              identification, responsible person identification, date of handover.
            </li>
            <li>
              <strong>Documentation pack receipt.</strong> Item-by-item list (design drawings,
              as-builts, lux calculation, certificates, manuals, cause-and-effect, logbook,
              warranty, spares list, photographs, briefing record). Each ticked off as received; the
              responsible person initials.
            </li>
            <li>
              <strong>Briefing topics.</strong> List of topics covered (RRO duties, daily check,
              fault response, periodic regime, documentation use, contacts). Each ticked off as
              covered.
            </li>
            <li>
              <strong>Demonstrations witnessed.</strong> List of items demonstrated (central battery
              panel, test facility, self-test controller, lockable isolator, warning notices, spares
              location). Each ticked off.
            </li>
            <li>
              <strong>Schedule agreement.</strong> The dates committed for the next monthly
              functional, annual duration, and five-year photometric tests.
            </li>
            <li>
              <strong>Contacts.</strong> Contractor primary contact, normal hours, out-of-hours,
              escalation. Email and phone.
            </li>
            <li>
              <strong>Signatures.</strong> Contractor competent person signature, responsible person
              signature, date.
            </li>
            <li>
              <strong>Distribution.</strong> Both parties retain a signed copy. The responsible
              person's copy is filed in the documentation pack.
            </li>
          </ul>
          <p>
            The register is typically a single document of 2-4 pages — concise but covering all the
            elements. Once signed, it is the dispositive record of the handover. Insurers, fire
            authorities, and any future investigation can verify the transfer took place properly.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Combined briefing where practical.</strong> The responsible person's RRO 2005
              duties cover the whole fire safety system. A combined briefing covering detection,
              escape, lighting, fighting, and passive protection is more efficient than separate
              briefings.
            </li>
            <li>
              <strong>Cross-referenced documentation packs.</strong> The emergency lighting
              cause-and-effect description should reference the fire alarm cause-and-effect where
              the systems are integrated. The fire risk assessment should reference both the
              emergency lighting and the fire detection certification.
            </li>
            <li>
              <strong>Aligned periodic schedules.</strong> Where the same contractor maintains both
              fire alarm and emergency lighting (common pattern), monthly cadences can be
              coordinated. Annual duration tests should NOT coincide with annual fire alarm tests
              (avoid two safety systems in test simultaneously); space them across the year.
            </li>
            <li>
              <strong>Fire risk assessment integration.</strong> The FRA is the responsible person's
              overall fire safety document. Emergency lighting documentation feeds into the FRA
              evidence base; FRA review cycles (typically annual) should reference the most recent
              emergency lighting periodic certificate.
            </li>
            <li>
              <strong>Unified responsible person record.</strong> The responsible person's fire
              safety records are typically held as a single fire safety file covering all
              components. The BS 5266-1 logbook sits within this file alongside the BS 5839-1
              logbook and the FRA review records.
            </li>
          </ul>
          <p>
            The handover is most efficient when seen in the broader fire safety context. The 2025 BS
            5266-1 update implicitly supports this by treating the documentation pack as part of the
            building fire safety records, not a standalone artefact.
          </p>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            {
              question:
                'Can the documentation pack be delivered electronically rather than as a physical folder?',
              answer:
            ...
            {
              question:
                'What if the building is being sold and the existing maintenance contractor is being replaced at the same time?',
              answer:
            ...
            {
              question:
                'What if the responsible person changes after handover (e.g. building sale, manager change)?',
              answer:
            ...
            {
              question:
                'Is the handover meeting required for a small installation (e.g. a small shop with 6 luminaires)?',
              answer:
            ...
            {
              question:
                'Can the signed handover register be the same document as the acceptance certificate?',
              answer:
