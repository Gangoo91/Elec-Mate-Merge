...
const inlineChecks = [
  {
    ...
    options: [
      ...
      'A comprehensive pack including: design drawings (showing escape routes, luminaire positions, lux design); as-built drawings (showing the installed reality including any deviations); photometric design calculation (the lux model); BS 5266-1:2025 acceptance certificate; BS 7671 Electrical Installation Certificate; central battery system certificate (where applicable); manufacturer technical / installation manuals for every product type; photometric data sheets; cause-and-effect description (for staged or zoned operation); BS 5266-1 logbook (started, with the commissioning entry); manufacturer warranty documentation; spares list and recommended stock; photographic record (one per luminaire); responsible-person briefing summary. The pack is the operational memory of the installation.',
      'Just an invoice.',
      'Just photos.',
    ],
    correctIndex: 1,
    explanation:
      'The pack is comprehensive — design + as-built + calculation + certificates + manuals + cause-and-effect + logbook + warranty + spares + photographs + briefing. Each element supports operation, future maintenance, periodic verification, and any future investigation.',
  },
  {
    id: 'elm5-s6-training',
    ...
    options: [
      'Nothing.',
      'A structured briefing covering: their RRO 2005 duties (Article 14 emergency lighting, Article 17 maintenance, Article 23 records); the daily indicator check on central battery panels (where applicable); the user duty to notice and report any flagged luminaires; the response procedure when a fault is identified (call the maintenance contractor, do not silence alarms or reset faults); the planned periodic regime (when functional / duration / photometric tests are scheduled, what to expect); the documentation pack location and how to use it; the contractor contact details. The training is recorded in the documentation pack and signed by the responsible person.',
      'Lamp colours.',
      'Battery weight.',
    ],
    correctIndex: 1,
    explanation:
      'Responsible person training is the bridge between the technical handover and the operational regime. RRO duties, daily checks, fault response, periodic schedule, documentation, contacts. Recorded and signed. Without it, the responsible person cannot discharge their duty.',
  },
  {
    ...
    options: [
      'Never.',
      'Where the emergency lighting installation operates in stages or zones — for example, where different escape routes have different response times, where some luminaires illuminate only on a specific signal (fire alarm activation triggering high-risk task lighting), where central battery sub-circuits feed different areas, or where addressable systems have programmed sequences. The cause-and-effect description is a written explanation of what input triggers what output: which mains-fail signal turns on which luminaire group, which fire-alarm signal activates which override, which panel button does what. Without it, future maintainers, future verifiers, and future investigators cannot reconstruct the system intent.',
      'Always optional.',
      'Only for fire alarm.',
    ],
    correctIndex: 1,
    explanation:
      'Cause-and-effect is required where the system has staged or zoned behaviour — anything beyond simple "all lights on when mains off". The description is text + diagram (typically a logic table) and forms part of the handover documentation pack. The 2025 standard reinforces the documentation expectation.',
  },
  {
    id: 'elm5-s6-photo',
    ...
    options: [
      'Marketing.',
      'Multiple operational and evidential purposes: asset identification (a maintainer attending a fault knows what the luminaire looks like and where it is before arrival); verification of installation (compares as-installed with design intent at handover); insurer / fire authority evidence (tangible record of the system as installed); dispute resolution (any later claim about original installation can be checked against handover photographs); post-incident investigation (as-installed vs as-found at incident, identifies any changes). One photograph per luminaire, indexed against the asset register and as-built drawings, filed in the documentation pack.',
      'Decoration.',
      'Aesthetic.',
    ],
    correctIndex: 1,
    explanation:
      'The photographic record is operationally and evidentially valuable across the installation life. Cost is low at commissioning; benefit is real and ongoing. The 2025 update implicitly supports the practice through the emphasis on documentation pack completeness.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      'Hand over the keys.',
      'A structured event covering: documentation pack delivery (drawings, calculations, certificates, manuals, logbook starter, photographs); responsible-person briefing on RRO 2005 duties and operational regime; demonstration of the daily check (where applicable) and any test facilities; agreement on the periodic maintenance schedule; review of contact details and escalation procedures; signed handover register confirming the responsible person has accepted the documentation pack and the briefing. The handover is the moment of regulatory transfer — from contractor to responsible person — and must be documented to be defensible.',
      'A coffee.',
      'Random.',
    ],
    correctAnswer: 1,
    explanation:
      'Handover is a structured event with documented outputs. Documentation pack + briefing + demonstration + schedule agreement + contacts + signed register. The signed register is the transfer document — without it, the responsibility transfer is not formal.',
  },
  {
    id: 2,
    ...
    options: [
      'No reason.',
      'Because without it, future maintainers, future verifiers, and future investigators cannot understand what the system is supposed to do. A complex installation may have: different response times in different areas (some 0.5 s, some 5 s, some 15 s); some luminaires that only operate on fire alarm activation (high-risk task lighting); central battery sub-circuits feeding different zones; addressable controller sequences. The cause-and-effect description is a text + logic table that documents what input triggers what output. The 2025 standard tightens this — for any system beyond simple all-on operation, cause-and-effect must be in the handover pack.',
      'For sales.',
      'Random.',
    ],
    correctAnswer: 1,
    explanation:
      'Cause-and-effect is the system intent in writing. Without it, the system\'s purpose can be lost as soon as the original design team disperses. The 2025 standard reinforces this for any non-trivial installation.',
  },
  {
    id: 3,
    question: 'The responsible person briefing at handover must include which of the following?',
    options: [
      'Lamp colour preferences.',
      'RRO 2005 duties (Article 14 emergency lighting, Article 17 maintenance, Article 23 records); the daily indicator check duty (where central battery is provided); the user duty to notice and report flagged luminaires; the response procedure when a fault is identified; the planned periodic test regime and what to expect; the documentation pack location and use; the contractor contact details and escalation procedures. The briefing is recorded in the documentation pack and signed by the responsible person as accepted.',
      'Random.',
      'Manufacturer history.',
    ],
    correctAnswer: 1,
    explanation:
      'The briefing covers the responsible person\'s duties (RRO), the daily check, the fault response, the schedule, the documentation, and the contacts. Recorded and signed. Anything less is a partial handover.',
  },
  {
    id: 4,
    ...
    options: [
      'Sales pitch.',
      'To enable rapid maintenance response. The spares list identifies the consumables (batteries, lamps, luminaire bodies, fuses) and the quantities recommended to be held on or near site for routine fault response. Without the list, a maintenance contractor attending a fault must identify the right spare via manufacturer / model / chemistry every time — slowing the response and increasing the risk of substitution errors. With the list, the right spare is on hand and the maintenance is fast. The 2025 update reinforces this as part of the documentation pack expectations.',
      'Decoration.',
      'Pricing.',
    ],
    correctAnswer: 1,
    explanation:
      'The spares list is operational. Right spare on hand = fast response = system back to compliance quickly. Without it, every fault response starts with an identification exercise. Part of the documentation pack handover.',
  },
  {
    id: 5,
    ...
    options: [
      'Unrelated.',
      'Closely related — emergency lighting is one element of the broader fire safety package along with fire detection (BS 5839-1:2025), means of escape design (Approved Document B), fire-fighting systems (sprinklers / dry risers / fire mains), passive fire protection (compartmentation, fire doors), and the building fire risk assessment (FRA). The responsible person\'s overall fire safety duty under the RRO 2005 is the umbrella; the emergency lighting handover is one component handover that contributes to the FRA evidence base. Practical handovers often combine the components into a single fire safety handover event.',
      'Replaces it.',
      'Random.',
    ],
    correctAnswer: 1,
    explanation:
      'Emergency lighting is one fire safety component. The responsible person\'s overall duty under the RRO covers the whole fire safety system; each component (detection, escape, lighting, fighting, passive) has its own handover that contributes to the umbrella FRA.',
  },
  {
    id: 6,
    ...
    options: [
      'Marketing.',
      'Asset identification across the installation life (maintainers know what to expect before arrival); verification of as-installed against design (snapshot at the start state); insurer / fire authority evidence (tangible record of the system); dispute resolution (any later claim about original positioning can be checked); post-incident investigation (as-installed vs as-found). One photograph per luminaire, indexed against the asset register, included in the handover pack and updated at significant changes.',
      'Decoration.',
      'Random.',
    ],
    correctAnswer: 1,
    explanation:
      'Photographic asset record is operational + evidential. Identification, verification, evidence, dispute resolution, investigation. Low cost at commissioning, real benefit across years.',
  },
  {
    id: 7,
    ...
    options: [
      'Tradition.',
      'Because the responsible person needs to understand how to operate the test facility safely and correctly — typically a key-operated test switch on the consumer unit or a test mode button on the central battery panel. Without the demonstration, the responsible person may not know the test facility exists, may not have the key, or may operate it incorrectly. The demonstration covers: location of the facility, how to operate it, what to expect (luminaires switching to emergency mode, panel indicators changing), how to restore normal operation, and any safety considerations. The demonstration is recorded in the handover documentation.',
      'For coffee.',
      'Random.',
    ],
    correctAnswer: 1,
    explanation:
      'The test facility is a tool for monthly functional testing (where the responsible person carries out the test in-house) or for fault investigation. The responsible person must know it exists and how to use it. The demonstration is part of the handover.',
  },
  {
    id: 8,
    ...
    options: [
      'They are unrelated.',
      'The handover is the start point. The acceptance certificate establishes the commissioning baseline; the documentation pack provides the design references; the responsible person\'s briefing transfers the operational duties; the schedule agreement starts the periodic cadence. From the day of handover, the daily check begins (where applicable), the next monthly is one calendar month away, the next annual is one year away, the next five-year photometric is five years away. The handover documentation is the day-zero reference for everything that follows.',
      'They are separate.',
      'Random.',
    ],
    correctAnswer: 1,
    explanation:
      'Handover is day zero. The clocks start. All subsequent periodic activities are referenced back to the handover documentation pack. Without a clean handover, the periodic regime starts on weak foundations.',
  },
  {
    id: 9,
    ...
    options: [
      'Agree.',
      'Decline politely. The responsible person under the RRO 2005 has duties that cannot be delegated to the contractor — particularly the duty to ensure ongoing maintenance and records (Articles 17 and 23). The manuals, drawings, and documentation pack must be in the responsible person\'s possession because they are the operational memory the responsible person needs to discharge those duties. The contractor handles the technical work; the responsible person retains the legal duty and the supporting documentation. Hand over the pack and explain why.',
      'Throw them away.',
      'Keep them yourself.',
    ],
    correctAnswer: 1,
    explanation:
      'RRO duties cannot be delegated away. The responsible person needs the documentation pack to discharge their statutory duties. The contractor handles the technical work; the documentation supports the responsible person\'s legal position. Hand it over and explain.',
  },
  {
    id: 10,
    ...
    options: [
      'Optional.',
      'The 2025 update tightens the documentation expectations at handover. The pack must be complete — design, as-built, calculations, certificates, manuals, cause-and-effect, logbook starter, manufacturer literature, spares list, photographs, briefing record, signed handover register. Missing items are non-compliance, not departures. The certificate cannot honestly be signed if the pack is incomplete. The pack is the operational memory; without it, future maintenance, future verification, and any future investigation all fail.',
      'No requirement.',
      'Whatever the contractor wants.',
    ],
    correctAnswer: 1,
    explanation:
      'The 2025 update treats the documentation pack as load-bearing. Missing items are non-compliance under the new departures policy. The certificate represents fact at signing; an incomplete pack cannot be honestly certified.',
  },
];
