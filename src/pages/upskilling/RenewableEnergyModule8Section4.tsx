...
const inlineChecks = [
  ...
  },
  {
    ...
    question: 'What protective device curve is suitable for a heat pump compressor inrush?',
    options: [
  ...
  },
  {
    ...
    question: 'Where does the Zs measurement happen on a heat pump circuit?',
    options: [
...
const quizQuestions = [
  ...
  {
    question: 'Three-phase 16 kW thermal ASHP — what changes vs single-phase 7 kW?',
    options: [
  ...
  {
    question: 'Heat pump start-up inrush — what happens electrically + how to protect?',
    options: [
...
export default function RenewableEnergyModule8Section4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 4 · BS 7671:2018+A4:2026 · Reg 314 + Reg 411.4 + Reg 525.202 + Reg 543 + Appendix 4"
        title="Wiring + dedicated circuit + ADS"
        backTo="../renewable-energy-module-8"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Heat pump electrical wiring design — dedicated final circuit per Reg 314, protective
          device + curve selection (C / D) for compressor inrush, cable sizing per Appendix 4
          (sustained current + voltage drop), Reg 543 protective conductor selection
          (armour-as-CPC), Reg 411.4 ADS + Zs verification at outdoor unit, three-phase variants.
        </p>
        ...
        <Pullquote>
          Heat pump dedicated circuit design is M6 / M7 EV-pattern applied to a different motor.
          Same Reg 314 + Reg 411 + Reg 525.202 + Appendix 4 Section 6.4 framework; different load
          profile.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Fault isolation</strong> — heat pump RCBO trip on
              insulation fault doesn’t cascade to cooker / lighting / sockets / other circuits
            </li>
            <li>
              <strong className="text-white">Safe maintenance</strong> — service engineer /
              refrigerant Cat 1 person isolates the heat pump electrically via the outdoor isolator
              + the CU RCBO; other circuits unaffected
            </li>
            <li>
              <strong className="text-white">Protective device matching</strong> — RCBO type + curve
              + rating + RCD architecture designed for the heat pump load (compressor inrush + VSD
              smooth-DC considerations §8.5)
            </li>
            <li>
              <strong className="text-white">Cable matching</strong> — cable cross-section + thermal
              rating + voltage drop matched to the heat pump continuous + inrush load
            </li>
            <li>
              <strong className="text-white">Part 6 verification</strong> — per-circuit IR + Zs +
              RCD trip-time + ADS produces clear per-circuit EIC + Schedule of Test Results. EICR
              5-10 years later equally clear
            </li>
            <li>
              <strong className="text-white">Backup immersion circuit</strong> — typically a SECOND
              dedicated circuit for the immersion (16 A RCBO, separate cable to the cylinder). §8.6
              details
            </li>
            <li>
              <strong className="text-white">Controls wiring</strong> — low-voltage low-current; can
              share a controls-circuit way at CU or be fed from the heat pump’s integrated control
              circuit (manufacturer topology). §8.7 details
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — dedicated circuit ID +
              CU way + protective device + cable + Zs + verification
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">RCBO standard</strong> — BS EN 61009-1 (residual
              current operated circuit-breaker with integral overcurrent protection) + BS EN 62423
              (Type A / F / B)
            </li>
            <li>
              <strong className="text-white">Type A</strong> — AC + pulsating DC fault currents. UK
              2025-26 default for heat pump where manufacturer DoC does NOT declare smooth-DC fault
              current from VSD compressor
            </li>
            <li>
              <strong className="text-white">Type F</strong> — adds high-frequency fault current
              detection (VSD-compatible). UK 2025-26 emerging for VSD heat pumps where manufacturer
              declares
            </li>
            <li>
              <strong className="text-white">Type B</strong> — adds smooth-DC fault current
              detection. Required where VSD compressor declares smooth-DC leakage &gt; Type A
              capability. §8.5 RCD architecture details
            </li>
            <li>
              <strong className="text-white">B curve</strong> — 3-5× rated current trip. Not
              suitable for direct-on-line compressor inrush
            </li>
            <li>
              <strong className="text-white">C curve</strong> — 5-10× rated current trip. UK 2025-26
              default for heat pump dedicated circuit
            </li>
            <li>
              <strong className="text-white">D curve</strong> — 10-20× rated current trip.
              Hard-starting compressors / low-Zs sites
            </li>
            <li>
              <strong className="text-white">30 mA additional protection</strong> — Reg 415.1 —
              integrated into the RCBO. Verify trip-time at 1 × IΔn ≤300 ms; at 5 × IΔn ≤40 ms
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — RCBO product + type +
              curve + rating + manufacturer DoC + RCD trip-time verification
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Appendix 4 sustained current carrying capacity. Reg 525.202 voltage drop. Two calcs, one
          cable choice. Long runs and three-phase change the maths.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Indoor T+E Method C</strong> — clipped direct to wall /
              surface. 6 mm² T+E single-phase capacity ~41 A at 30 °C ambient; 10 mm² ~57 A. Typical
              heat pump 32 A circuit fits on 6 mm² with headroom
            </li>
            <li>
              <strong className="text-white">Outdoor SWA Method E</strong> — free in air, not
              buried, not in conduit. 10 mm² 3-core SWA single-phase capacity ~55 A at 30 °C
              ambient; 6 mm² ~41 A. Typical heat pump 32 A on 10 mm² with margin
            </li>
            <li>
              <strong className="text-white">Buried SWA Method D</strong> — direct in ground or in
              duct. Capacity reduced vs Method E (heat dissipation worse). Use for cable in trench
              from building to remote outdoor unit. 10 mm² buried Method D ~50 A
            </li>
            <li>
              <strong className="text-white">Three-phase cable</strong> — 5-core SWA (3L + N + PE).
              Per-phase capacity per Appendix 4. 6 mm² 5-core typical for three-phase 16 kW thermal
              heat pump (8-9 A per phase running)
            </li>
            <li>
              <strong className="text-white">Correction factors</strong>— Ca (ambient) per Table
              4B1; Cg (grouping) per Table 4C1; Cs (soil) per Table 4B2; Ci (insulated cavity) per
              manufacturer guidance. Apply product of all relevant correction factors
            </li>
            <li>
              <strong className="text-white">Adiabatic check</strong>— Reg 543.1 protective
              conductor cross-section: S² × t = k² where S = CPC cross-section, t = disconnection
              time, k = material constant. For 10 mm² SWA armour acting as CPC: armour cross-section
              ~70-100 mm² — well above the adiabatic minimum
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — Appendix 4 calc page +
              chosen cable + Method + correction factors + capacity vs design current margin
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 525.202 limit</strong> — 5% from supply origin to
              final circuit terminals for non-lighting circuits. Heat pump = non-lighting; 5% limit
              applies
            </li>
            <li>
              <strong className="text-white">Calc formula</strong> — voltage drop (V) = cable
              per-mV/A/m × length (m) × current (A) / 1000
            </li>
            <li>
              <strong className="text-white">Cable per-mV/A/m values</strong> — 6 mm² single-phase
              ~7.3 mV/A/m; 10 mm² single-phase ~4.4 mV/A/m; 6 mm² three-phase ~4.2 mV/A/m; 10 mm²
              three-phase ~2.5 mV/A/m. Values per Appendix 4 Tables 4D1-4E5
            </li>
            <li>
              <strong className="text-white">Total drop</strong> — sum drops for each cable segment
              (indoor T+E + outdoor SWA). Compare to 5% of nominal voltage (230 V × 5% = 11.5 V for
              single-phase; 400 V × 5% = 20 V for three-phase line-to-line)
            </li>
            <li>
              <strong className="text-white">Typical 15 m result</strong> — 6 mm² indoor (5 m) + 10
              mm² SWA outdoor (10 m) at 32 A single-phase: 1.2 + 1.4 = 2.6 V = 1.1% of 230 V (5%
              margin)
            </li>
            <li>
              <strong className="text-white">Long run (30 m) result</strong> — if cable is 6 mm²
              throughout 30 m at 32 A: 7 V = 3% (tight to 5%). Upgrade to 10 mm² indoor: 30 × 32 ×
              4.4 / 1000 = 4.2 V = 1.8% (comfortable)
            </li>
            <li>
              <strong className="text-white">Three-phase advantage</strong> — same cable + length +
              load: voltage drop is ÷√3 (~58% of single-phase). Three-phase 6 mm² 5-core SWA + 15 m
              + 8 A per phase: 0.6 V = 0.15% of 400 V line-line
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — per-segment drop calc +
              total drop + % of nominal + margin to 5% limit
            </li>
          </ul>
        </ConceptBlock>
