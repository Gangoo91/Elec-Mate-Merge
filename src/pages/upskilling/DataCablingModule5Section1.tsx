    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The IDC families an installer meets in the field — 110-style, Krone/LSA-PLUS, 66-block and
          modern tool-less keystones — the strip lengths and 13 mm pair-untwist limit that decide
          Class EA on Cat6A, the T568A vs T568B colour schemes, and the consistent end-to-end pinout
          discipline that separates a 15-year channel from a six-month channel.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              keystone, patch panel and IDC distribution strip uses 110-style or a tool-less variant
              of it. Standard 110 punchdown tool with a 110 blade. 22 / 23 / 24 AWG slot ratings —
              match cable gauge to slot. Used on every new data job in 2026.
            </li>
            <li>
              ...
              and orientation from 110 — the blade has a "cut" side that must face the cable end so
              excess conductor is trimmed in the same stroke. Common on legacy analogue-voice frames
              and some industrial-controls termination strips. Not normally used on new data jobs.
            </li>
            <li>
          ...
          <p>
            ...
            the IDC slot rating — using 22 AWG cable in a 24 AWG slot cracks the slot; using 26 AWG
            telephony wire in a 22-24 AWG slot produces poor contact, and (2) use the right blade in
            the right orientation — 110 blades, Krone blades and 66-block blades are not
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text
              ...
              fontFamily="system-ui"
            >
              All four families are IDC; failure modes are identical — gauge mismatch, wrong blade,
              over-strip, excess untwist.
            </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              balanced twisted-pair carries 10GBASE-T at all is that the equal and opposite signals
              on the two conductors of each pair, twisted together, cancel common-mode noise and
              induce equal-and-opposite EMF in any neighbouring pair — the basis of low NEXT. The
              moment you untwist a pair, that cancellation collapses across the untwisted region.
              NEXT degrades. The certifier flags it.
            </li>
            <li>
              ...
              construction. Strip too much jacket, splay the pairs, untwist them, and you change the
              local geometry — which causes a discontinuity in the impedance. The signal sees that
              as a reflection, which shows up as elevated return loss and inflated effective length
              on the certifier.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Strip length:</strong> per manufacturer instructions — typically 20-30 mm for
              keystones, 25-30 mm for patch panels. Use a strip tool with a depth stop.
            </li>
            <li>
            ...
            <li>
              ...
              many Cat6A keystones provide a guide that holds each pair at the correct entry angle.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              instructions. Pair untwist at the termination shall not exceed the limit specified for
              the cabling Category, typically 13 mm for Category 6A. The cable jacket shall be
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              pin 3 white-green, pin 4 blue, pin 5 white-blue, pin 6 green, pin 7 white-brown, pin 8
              brown. Orange pair on pins 1-2; green pair on pins 3-6.
            </li>
            <li>
          ...
          <p>
            ...
            mixing. A T568A outlet patched with a T568B cord becomes a wired crossover (pins 1-2 to
            pins 3-6), which:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
            ...
            <li>
              ...
              legacy hubs, building-automation gateways) do not have auto-MDI/MDI-X and simply fail
              to communicate.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              strip on a Cat6A keystone (instead of the 25 mm specified) splays the pairs across the
              keystone hood. The pair-to-pair separation that the cable construction was certified
              at is gone. The return-loss measurement spikes near the connector. The certifier
              reports a Class EA marginal pass or fail. Cause: strip-length discipline.
            </li>
            <li>
              <strong>Excess pair untwist → NEXT degradation.</strong> A 25 mm untwist (vs the 13 mm
              cap) on the orange pair removes the cancellation across half the IDC region. NEXT
            ...
            <li>
              ...
              floor terminated half in T568A and half in T568B works for the office laptops because
              the switches auto-negotiate. The same floor fails the access-control rollout because
              the door controllers do not have auto-MDI/MDI-X. Cause: pinout-consistency discipline.
            </li>
          </ul>
          <p>
            All three are termination practice. None is the cable{"'"}s fault. None is the keystone
            {"'"}s fault. All three are caught at certification — if the contractor certifies. None
            are caught at all if the contractor does not certify.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              set to the manufacturer{"'"}s strip length. Untwist only the last 13 mm of each pair.
              Seat in one stroke with the correct blade. Certify every link to TIA-1152-A / BS EN
              50346 with documented results. Re-terminate any marginal passes before handover. Treat
              each termination as where Class EA is built — because that is where it is.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              meeting-room cluster. The on-call electrician has Cat6A cable and Cat6A keystones, but
              is more familiar with T568A from previous jobs. The client says "as long as it works".
            </>
          }
          whatToDo={
            <>
              Three rules govern the remedial work. (1) Match the existing site scheme — T568B,
              every outlet, every patch-panel termination. The site discipline of consistent pinout
              is more important than the electrician{"'"}s personal habit. (2) Use the same
              termination practice as the original install: manufacturer strip length, 13 mm untwist
              limit, correct IDC blade in the correct orientation. (3) Certify the three new links
              to TIA-1152-A / BS EN 50346, archive the results alongside the original 2024
              certification, and update the site administration record per BS EN 50174-1 / TIA-606-D
              so the patch panel labels reflect the new outlets.
            </>
          }
          whyItMatters={
            <>
              Remedial work is where most consistent-pinout violations creep in — a different
              electrician, a different default, three outlets that "work for now". Two years later,
              when the meeting-room cluster gets a refresh and the new IP phones do not have
              auto-MDI/MDI-X, those three outlets fail and nobody can trace the cause. The fix is to
              enforce site discipline at every remedial touch: same scheme, same termination
              practice, same certification regime, same documentation update. The cost of doing it
              right is fifteen extra minutes per outlet; the cost of doing it wrong is a half-day
              fault-find two years later.
            </>
          }
        />
