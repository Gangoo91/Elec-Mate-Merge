    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The second limb of Reg 643.2.1 — the only test in the regulation that asks for
          live-conductor continuity. Three measurements that prove a ring is a ring, not a figure of
          eight.
        </p>
        ...
        >
          <p>
            ...
            that singles out ring final circuits and adds an extra duty: live-conductor continuity,
          ...
          <p>
            ...
            conductor at one point leaves every socket fed from the other direction, so every socket
            still works. The fault is silent — until the day the alternative path is loaded, the
            surviving conductor is run beyond its rating, and the cable cooks.
          </p>
          <p>
            The same is true of a figure-of-eight: a ring whose ends are paired wrongly at the board
            so that line outgoing connects to neutral returning. Every socket still has line and
            neutral. Voltage reads correctly. But the conductors are not a parallel loop and the
            current-carrying capacity assumed by the design no longer applies. Only the
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              extraneous-conductive-parts, if any, shall be verified by a measurement of resistance
              of:
              <br />
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              Isolate the circuit at the source. Prove dead. Lock off. The ring must be disconnected
              from any other circuit and from the consumer-unit busbar — the whole test depends on
              having the four ends of the ring (two line, two neutral) and the two ends of the CPC
            ...
            <li>
              Connect the meter between the two line ends and read the resistance — this is r1 (the
              end-to-end line conductor resistance, going round the ring).
            </li>
          ...
          <p>
            The first sanity check is r1 ≈ rn within a few percent. They are the same length of the
            same cable, so they should read the same. A noticeable disagreement at Step 1 means one
            of the ends is not paired with its real other end — typically a single broken strand
            pinched at a terminal, or an end that has been confused with a spur tail of similar
            colour.
          </p>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              protective conductors and the correct wiring of every ring final circuit. The purpose
              of this three-step test is to confirm continuity and detect incorrect interconnection
              or broken conductors or &lsquo;figure of eight&rsquo; configurations.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              When you cross-connect L outgoing to N returning at the board, the line conductor and
              the neutral conductor become one continuous loop that goes round the ring twice — once
              on the line and once on the neutral.
            </li>
            <li>
            ...
            <li>
              Two equal halves in parallel = a quarter of the whole. So the reading at every socket
              is (r1 + rn) / 4.
            </li>
            <li>
              Critically, this is the same at every socket. Whether you measure at the closest
              socket or the furthest socket, the parallel combination of the two halves is the same
              number — the geometry is symmetric.
            </li>
          </ul>
          <p>
        ...
        >
          <p>
            ...
            now the CPC instead of the neutral. Each socket sees half the cable in parallel with the
            other half, so the reading at every socket is (r1 + r2) / 4.
          </p>
          <p>
            ...
            reading. For the worked example above with r2 = 0.69 Ω, Step 3 = (0.41 + 0.69)/4 = 0.275
            Ω at every socket.
          </p>
          <p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="80" y="114" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              L1
            </text>
            <rect
              x="125"
              ...
              strokeWidth="1.5"
            />
            <text x="150" y="114" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              L2
            </text>
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="80" y="174" textAnchor="middle" fill="#3B82F6" fontSize="9" fontWeight="bold">
              N1
            </text>
            <rect
              x="125"
              ...
              strokeWidth="1.2"
            />
            <text x="150" y="174" textAnchor="middle" fill="#3B82F6" fontSize="9" fontWeight="bold">
              N2
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="80" y="234" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              CPC1
            </text>
            <rect
              x="125"
              ...
              strokeWidth="1.5"
            />
            <text x="150" y="234" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              CPC2
            </text>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          <p className="text-[12.5px] text-white/65 mt-3 leading-relaxed">
            ...
            every socket. e.g. 35 m of 2.5/1.5 T&amp;E → expected Step 3 ≈ 35 × 4.88 = 171 mΩ ≈ 0.17
            Ω at 20°C, multiplied by 1.20 ≈ 0.21 Ω at 70°C for the Zs verification.
          </p>
        </div>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              <span className="block">
                Walk the ring at Step 2 — every socket should read 0.12 Ω ± a few mΩ. Walk the ring
                at Step 3 — every socket should read 0.16 Ω ± a few mΩ. Take the worst Step 3
                reading (say 0.17 Ω at the furthest socket) as the R1+R2 for the schedule.
              </span>
              <span className="block">
                Zs verification (corrected to 70°C): Zs = Ze + (R1+R2 × 1.20) = 0.27 + (0.17 × 1.20)
                = 0.27 + 0.20 = 0.47 Ω. Compare against the Table 41 limit for 32 A B-curve at 0.4 s
                on a TN-C-S supply (typically 1.37 Ω applied to A4 max-permitted). Comfortable
                headroom.
              </span>
            </>
          }
        ...
        >
          ...
          <p>
            ...
            broken under the screw; a junction-box terminal where the conductor is held by paint and
            not by metal; a damaged cable from a recent floor-board lift; a never-completed second
            drop at a final socket where the installer ran one cable to the box and forgot to bring
            the second back.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            GN3 Reg 2.19 explicitly notes the spur signature: a single isolated high reading at one
            socket against a consistent value at the rest. The high reading is not a fault in itself
            — spurs are permitted under the OSG ring rules — but every spur should be identified,
            recorded, and counted against the spur-per-ring limit (one spur for every socket on the
            ring, in a domestic 32 A ring).
          </p>
          <p>
            A spur is confirmed by inspection at the back-box: one cable in is a spur; two cables in
            is a ring connection. If the readings suggest a spur but the back-box has two cables,
            the &lsquo;ring&rsquo; cable is actually a junction tail to a second spur further on,
            and the ring is misjoined under that accessory.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Step 1 looks correct: r1 ≈ rn, magnitudes match the calculation. So the bare continuity
            test passes. Step 2 is what reveals the fault. Instead of the same reading at every
            socket, the readings rise progressively from the start of the ring to a peak roughly
            halfway round, then fall back to the start value.
          </p>
          <p>
            GN3 Reg 2.19 captures this as the diagnostic profile of a figure-of-eight. The fix is at
            the board: re-identify the four ends, pair line outgoing with neutral returning
        ...
        >
          <p>
            ...
            jump (or drop) sharply between two adjacent sockets and remain at the new value for the
            rest of the loop. The boundary between the two values isolates the suspect joint — it is
            in the cable run between those two sockets.
          </p>
          <p>
            ...
            through. Less commonly: a forgotten dual-feed at a kitchen extractor where two ring legs
            are landed at the same accessory terminal. Trace the cable physically between the two
            sockets and identify the joint.
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              socket position, and the expected vs measured spur reading. The next inspector should
              not have to re-derive the topology from the readings.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              error (e.g., line and neutral not joined correctly at opposite ends) will be apparent
              from readings taken at socket-outlets progressing around the ring: readings
              progressively increase towards the midpoint and then decrease towards the other end of
              the ring.
            </>
          }
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong className="text-amber-300">Flat line with one spike.</strong> Every socket on
              the ring reads (r1+r2)/4. One additional socket (the spur) reads roughly twice that.
              Spur — record on the schedule.
            </li>
            <li>
              <strong className="text-amber-300">Hill profile.</strong> Readings rise smoothly to a
              midpoint and fall back. Figure-of-eight — wrong pairing at the board. Re-pair and
              re-test from Step 1.
            </li>
            <li>
