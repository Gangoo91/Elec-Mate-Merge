...
const inlineChecks = [
  {
    ...
    options: [
      'Open Charge Point Protocol — the open standard for chargepoint to management-system communication',
      'Optional Charger Power Profile — a manufacturer setting capping a single charger’s output current',
      'Onboard Charging Performance Profile — the vehicle-side standard for how fast a car accepts charge',
      'Operator Charge Payment Platform — the back-office billing system issuing customer invoices',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The physical charger unit mounted on the wall or pedestal at the charging bay',
      'A heavy-duty charging cable rated for the site’s maximum current draw',
      'A software platform that manages a fleet of chargers via OCPP — auth, billing, monitoring',
      'A piece of metering hardware only, with no software or remote management role',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'By entering a unique password set by the site operator before each charging session',
      'By speaking a voice command to the charger to start the charging session',
      'No authentication is required at any public chargepoint anywhere in the UK',
      'By RFID tap, app, ISO 15118 plug-and-charge or contactless card, validated by the CPMS',
    ],
    correctIndex: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It does not; OCPP has no role in coordinating charging across multiple chargers',
      'The CPMS sends SetChargingProfile messages and chargers apply them via CP PWM',
      'The site operator manually switches each charger on and off to balance the load',
      'It can only apply fixed daily schedules that never adapt to actual site conditions',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      ...
      'Per charger: CPMS endpoint, credentials and identifier, then test boot, heartbeat and auth',
      'Only the supply cable size; the OCPP link needs no installer configuration',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      '1.6 is widespread and mature, while 2.0.1 adds ISO 15118 plug-and-charge, richer authentication, enhanced smart-charging and mandatory TLS security',
      'They are the same protocol with only a version-number change and no functional difference',
      'Version 2.0.1 is already obsolete and should not be specified on new installs',
      'Version 1.6 no longer exists and every UK charger now runs 2.0.1',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It makes the vehicle charge more slowly to protect the high-voltage battery',
      'It provides wireless inductive charging with no physical cable plugged in',
      'Vehicle and charger exchange credentials over the CP wire, so the car is recognised and billed',
      'It is simply another name for tapping an RFID card to start a session',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'The whole site is unaffected and the offline charger keeps full CPMS functions',
      'The customer simply receives an email and no further action is possible',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Ethernet must always be used and cellular is never acceptable for chargers',
      'Cellular must always be used because wired networks are not reliable enough',
      'No network connection is needed for an OCPP charger to function',
      'Ethernet is preferred where wired network exists; cellular is essential for remote sites and as backup, with Wi-Fi the least reliable option',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'There is no install implication; TLS is handled entirely by the vehicle',
      'The customer is responsible for generating and managing all charger certificates',
      'No certificates are needed because TLS uses passwords instead',
      'Each charger needs a TLS client certificate from the CPMS operator’s CA, loaded at commissioning, with expiry and renewal recorded in the cert evidence',
    ],
    correctAnswer: 3,
    explanation:
