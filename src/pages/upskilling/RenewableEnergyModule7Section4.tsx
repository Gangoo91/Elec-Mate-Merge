        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">In 30 Seconds:</span> Document
              symptoms first, then work backwards from the fault
            </p>
          </div>
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">Spot it:</span> Zero current with
              voltage = open circuit; low voltage = bypassed cells
            </p>
          </div>
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">Use it:</span> Compare to
              commissioning records and baseline performance
            </p>
          </div>
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">Key Rule:</span> Test IR and verify
              protection before re-energising
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 space-y-6 pb-8">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Information Gathering:</span> Document all
              symptoms including error codes, performance data, and fault timing. Review monitoring
              history for patterns. Check recent weather events and maintenance activities. Note any
              changes to site conditions or equipment.
            </p>
            <p>
              <span className="text-white font-medium">Fault Tree Analysis:</span> Start with the
              observed symptom and work backwards through possible causes. Test hypotheses
              systematically, ruling out possibilities until root cause is identified. Consider
              multiple simultaneous faults in complex situations.
            </p>
            <p>
              <span className="text-white font-medium">Test and Verify:</span> Use appropriate test
              equipment to confirm hypotheses. Compare measurements to expected values and
              commissioning records. After repair, test to confirm the fault is resolved before full
              re-commissioning.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Voltage Anomalies:</span> Low Voc indicates
              bypassed cells from shading, cell failure, or stuck bypass diodes. Very low or zero
              Voc suggests complete string open circuit. Inconsistent string voltages warrant
              individual string investigation.
            </p>
            <p>
              <span className="text-white font-medium">Current Anomalies:</span> Zero current with
              normal voltage indicates open circuit such as blown fuse, open isolator, or loose
              connector. Low current suggests partial shading, soiling, or cell degradation. Use DC
              clamp meter to compare string currents.
            </p>
            <p>
              <span className="text-white font-medium">Ground Faults:</span> Ground fault
              indications typically result from insulation breakdown. Check cables for damage,
              especially at penetrations and junction boxes. Water ingress is a common cause. Use
              insulation resistance testing to locate the fault.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Error Code Interpretation:</span> Codes
              indicate what the inverter detected, not necessarily the root cause. Grid voltage
              errors may result from DNO issues or internal sensing faults. Ground fault codes may
              indicate array problems or inverter sensor failures. Review manufacturer documentation
              for specific code meanings.
            </p>
            <p>
              <span className="text-white font-medium">Efficiency Loss:</span> Compare DC input
              power to AC output power. Gradual efficiency decline often indicates capacitor
              degradation. Sudden drops may indicate failed components. Check for cooling system
              issues causing thermal derating.
            </p>
            <p>
              <span className="text-white font-medium">Communication Failures:</span> Check physical
              connections first such as RS485, Ethernet, and WiFi. Verify network configuration and
              IP settings. Review firewall and port settings. Try manufacturer diagnostic tools
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Critical Safety Issues:</span> Signs of
              thermal runaway such as swelling, smoke, unusual heat, or strange odours require
              immediate isolation and evacuation. Do not attempt diagnosis. Contact fire services if
              necessary and manufacturer emergency support.
            </p>
            <p>
              <span className="text-white font-medium">Performance Issues:</span> Check cell voltage
              balance as excessive imbalance indicates failing cells. Review temperature
              distribution and look for abnormal hot spots. Verify BMS operation and communication.
              Compare capacity tests to specifications.
            </p>
            <p>
              <span className="text-white font-medium">Charging/Discharging Faults:</span> Verify
              inverter settings match battery requirements. Check communication between BMS and
              inverter. Review protection settings such as voltage limits and current limits.
              Confirm cooling system operation is adequate for ambient conditions.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Before Re-Energisation:</span> Perform
              insulation resistance testing on affected circuits. Verify all connections are
              correctly made and torqued. Confirm protection devices are functional. Remove all
              tools and temporary equipment.
            </p>
            <p>
              <span className="text-white font-medium">Functional Testing:</span> Energise the
              system and observe initial operation. Verify error codes have cleared. Check
              performance metrics return to expected values. Monitor for any recurrence of symptoms.
            </p>
            <p>
              <span className="text-white font-medium">Documentation:</span> Record fault symptoms,
              diagnosis process, and repair actions. Document test results before and after repair.
              Note any recommendations for preventing recurrence. Update maintenance records and
              commissioning data.
            </p>
          </div>
        </section>
        ...
        <div className="bg-gradient-to-r from-elec-yellow/10 to-amber-500/10 border border-elec-yellow/20 rounded-xl p-4">
          ...
          <div className="space-y-2 text-white text-sm">
            <p>
              ...
              Always rule out the obvious before assuming major faults.
            </p>
            <p>
              <span className="text-white font-medium">Use manufacturer resources:</span> Technical
              support lines, diagnostic software, and documentation can save significant time. Build
              relationships with manufacturer technical teams.
            </p>
            <p>
              <span className="text-white font-medium">Build diagnostic skills over time:</span>{' '}
              Document every fault diagnosis to build personal and team knowledge. Patterns emerge
              that speed future diagnosis of similar issues.
            </p>
          </div>
        </div>
        ...
        {/* Quiz */}
        <Quiz title="Fault-Finding Quiz" questions={quizQuestions} />
