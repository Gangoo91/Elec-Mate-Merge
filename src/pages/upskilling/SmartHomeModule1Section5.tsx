      ...
      <header className="px-4 sm:px-6 lg:px-8 pt-8 pb-8 bg-[#1a1a1a]/95">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            <Building2 className="h-8 w-8 text-elec-yellow drop-shadow-lg" />
            <Badge 
              variant="secondary" 
      ...
      <main className="px-4 sm:px-6 lg:px-8 pb-8">
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="flex justify-between pt-8">
            <Link to="/study-centre/upskilling/smart-home-module-1-section-4">
            ...
            <Link to="/study-centre/upskilling/smart-home-module-1-section-6">
