...
const faqs = [
  {
    ...
    answer:
      'Use a protocol analyser to measure actual response times. Life safety systems need <100ms, HVAC control <500ms, and monitoring <2 seconds. Test under peak load conditions.',
  },
  {
    question: "What's the 75% rule for device counts?",
    answer:
      'To maintain reliable performance, limit device counts to 75% of maximum: 24 devices for Modbus RTU (32 max), 95 devices for BACnet MSTP (127 max). This allows headroom for expansion and peak loads.',
  },
  {
    question: 'When should I segment a network?',
    answer:
      "Segment when response times exceed targets, when device counts approach limits, or when geographic distances make single segments impractical. Plan segmentation during design - it's expensive to retrofit.",
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Segmenting the network into smaller sections (e.g., 4 x 25 devices) dramatically reduces token rotation time and improves response times. Increasing baud rate has limited effect, and adding termination resistors would cause problems.',
  },
];
...
const BMSModule5Section6 = () => {
  useSEO({
    ...
    description:
      'Learn network design, segmentation strategies, and latency management for building automation systems.',
  });
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Modbus RTU:</strong> Max 32 devices, 1200m cable
              </li>
              <li>
                <strong>BACnet MSTP:</strong> Max 127 devices, segment at ~75
              </li>
              <li>
                <strong>Key rule:</strong> Plan segmentation during design
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Slow response times = overloaded segment
              </li>
              <li>
                <strong>Use:</strong> 75% rule for device counts
              </li>
              <li>
                <strong>Test:</strong> Protocol analyser during commissioning
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Network planning ensures all devices communicate efficiently. Poorly planned networks
              result in data clashes, long delays, or complete loss of control. Understanding
              technical limits is essential.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Electrical loading:</strong> Each device adds capacitance and resistance
                </li>
                <li>
                  <strong>Token passing time:</strong> More devices = longer communication cycle
                </li>
                <li>
                  <strong>Address space:</strong> Limited unique addresses available
                </li>
                <li>
                  <strong>Collision domain:</strong> More devices increase data conflict chance
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              approach provides multiple benefits for BMS performance and reliability.
            </p>

            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                <p className="text-sm font-medium text-red-400/80 mb-2">
                  Before Segmentation (100 devices)
                </p>
                <ul className="text-sm text-white space-y-1">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Segmentation Design Steps
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>1.</strong> Device inventory - count by type and location
                </li>
                <li>
                  <strong>2.</strong> Calculate segment loading - apply 75% rule
                </li>
                <li>
                  <strong>3.</strong> Design topology - group logically, plan cable routes
                </li>
                <li>
                  <strong>4.</strong> Validate and document - verify requirements met
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              latency means commands take too long to action - critical for life safety systems.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-red-400/80 mb-2">Safety Critical Warning</p>
              <p className="text-sm text-white">
                High latency in life safety systems can be dangerous. Fire dampers must respond
                within seconds. BS EN 54 requires fire safety system response times under 10
                seconds.
              </p>
            </div>
            ...
            <div className="my-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm text-white">
                    Time to gain network access (token passing). Increases linearly with device
                    count.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-sm text-white">
                    Device CPU processing. 5-20ms simple devices, 100ms+ complex controllers.
                  </p>
                </div>
                <div>
                  <p className="text-xs font-medium text-white mb-1">Transmission Time</p>
                  <p className="text-sm text-white">
                    Physical data transmission. ~1ms per 10 characters at 9600 baud.
                  </p>
                </div>
                <div>
                  <p className="text-xs font-medium text-white mb-1">Physical Response</p>
                  <p className="text-sm text-white">
                    Actuator movement. Dampers 15-90s, valves 30-300s typical.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>1.</strong> Baseline testing - minimal load response times
                </li>
                <li>
                  <strong>2.</strong> Load testing - add devices, measure impact
                </li>
                <li>
                  <strong>3.</strong> Stress testing - maximum load conditions
                </li>
                <li>
                  <strong>4.</strong> EMI testing - near noise sources
                </li>
                <li>
                  <strong>5.</strong> Documentation - record all results
                </li>
              </ul>
            </div>
          </div>
