    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Modern emergency lighting is digitally addressable, automatically self-tested, and
          remotely monitored. DALI bus to gateway to BMS to cloud to logbook. Less manual labour,
          better data, exception-based maintenance — provided the system is properly designed, the
          cyber hygiene is in place, and the duty-holder still keeps a logbook (because automated
          detection without curated audit trail is incomplete).
        </p>
        ...
        >
          ...
          <p>
            The protocol turns each luminaire from a dumb fitting into an addressable asset. Status,
            test, fault — all available digitally without walking the building. The maintenance
            regime becomes data-driven: the gateway tells you which luminaires need attention; the
            contractor attends those specifically rather than a periodic inspection sweep of every
            fitting.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              Most modern systems use mesh networking — luminaires relay messages to extend range. A
              typical floor with 30 luminaires forms a self-organising mesh covering 1000+ m².
            </li>
            <li>
            ...
            <li>
              <strong>Power.</strong> The radio adds a small but non-zero standby current draw from
              the luminaire battery. Modern designs minimise this; the impact on autonomy duration
              is typically negligible but should be considered in battery sizing.
            </li>
            <li>
              <strong>Vendor lock-in.</strong> Proprietary RF protocols mean the luminaires are tied
              to that vendor's gateway. BLE and Zigbee are more open but compatibility is still
              limited in practice. Wired DALI is more vendor-neutral.
            </li>
          </ul>
          <p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              ...
              <text x="130" y="100" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
                DALI Type 1 / DALI-2
              </text>
            ...
            <text x="255" y="190" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              DALI bus
            </text>
            ...
            <text x="495" y="190" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              BACnet / MQTT
            </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              emergency mode (battery feed) for a defined interval — typically 10-30 seconds — long
              enough to confirm the lamp lights, the driver functions, and the battery is supplying
              current. Results captured per-luminaire: pass / fail / fault flag. Staggered across
              the day or week to avoid simultaneous emergency operation.
            </li>
            <li>
            ...
            <li>
              ...
              fail, fault flags (lamp / driver / battery / charger / circuit), capacity reading (Ah
              delivered or end-voltage at duration), and any anomaly notes. Stored on the gateway
              and pushed to BMS / cloud / reports.
            </li>
            <li>
              <strong>Exception reporting.</strong> Faults trigger immediate alerts (email, SMS, BMS
              alarm). Pass results accumulate in the historical record. The duty-holder reads the
              daily / weekly fault summary; pass results are confirmed at the periodic review rather
              than examined individually.
            </li>
            <li>
              <strong>5-year photometric (NEW 2025).</strong> The traditional functional + duration
              regime is supplemented by a 5-yearly photometric verification. Most current automated
              systems do not yet automate this — it remains a manual lux-meter measurement at design
              points. Future generations may estimate delivered lux from internal LED drive current
              and lumen depreciation models.
            </li>
          </ul>
          <p>
            Automated scheduling does not remove the duty-holder's responsibility — it changes the
            work pattern. Less manual testing; more reviewing of automated reports and attending to
            exceptions. The labour saving is substantial; the test quality improves (every test runs
            on time, every result captured, no missed inspections).
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              where the design illuminance is to be delivered. The 5-year check measures at the same
              points.
            </li>
            <li>
            ...
            <li>
              <strong>Run the system in emergency mode.</strong> Either by simulating mains failure
              or by test command. Allow stabilisation (30 seconds for LED, longer for fluorescent
              legacy).
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              lighting installation shall be subject to a photometric verification at intervals not
              ...
              The verification shall use a calibrated illuminance meter at the design points and
              shall be documented and retained as part of the maintenance record.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              summaries (luminaires-in-service, luminaires-faulted), specific alarms (battery fault,
              charger fault, cabinet door open, mains failure), test events (test start, test
          ...
          <p>
            BMS integration is increasingly standard in commercial and institutional buildings. For
            small standalone installations (single retail unit, small office), a dedicated gateway
            with cloud monitoring is more proportionate. The choice depends on the building
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Per-luminaire dashboard.</strong> Map view (luminaires plotted on floor plan),
              list view (sortable by status / age / fault), detail view (per-luminaire test history,
              battery state trend, fault flags).
            </li>
            <li>
            ...
            <li>
              <strong>Compliance reports.</strong> Auto-generated monthly / annual / 5-year summary
              reports for inclusion in the logbook. Demonstrates the test schedule was run, the
              results captured, the faults addressed.
            </li>
            <li>
              <strong>Multi-site management.</strong> A property manager with 50 buildings sees them
              all in one dashboard. Cross-site fault patterns become visible (a manufacturing defect
              across multiple sites becomes obvious in the data).
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Inspection records.</strong> Annual third-party inspection results, NICEIC or
              equivalent reports, fire risk assessment outputs.
            </li>
            <li>
          ...
          <p>
            The logbook can be paper or electronic. Modern installations increasingly use electronic
            logbooks fed automatically from the cloud monitoring service, with the duty-holder
            counter-signing reviews. Paper logbooks persist in smaller installations and where
            electronic records are not yet trusted. Either is acceptable provided it is retained,
            reviewed, and signed.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Network segmentation.</strong> Place the emergency lighting gateway on its own
              VLAN, separate from user traffic and IT systems. Firewall rules / ACLs control what
              can reach the gateway. The general LAN cannot directly access the gateway; only
            ...
            <li>
              ...
              credentials, ideally multi-factor where supported. Default vendor passwords changed at
              commissioning and recorded securely. Account separation (commissioning admin,
              operational read-only, etc.).
            </li>
            <li>
              <strong>Firmware updates.</strong> Vendor firmware updates applied promptly,
              particularly security patches. Maintain awareness of vendor security advisories. Test
              updates on a staging unit if practical before rolling to production.
            </li>
            <li>
            ...
            <li>
              ...
              room, restricted access). Physical access to the device is itself a vector — a console
              port + physical access often defeats network controls.
            </li>
            <li>
            ...
            <li>
              ...
              is suspected compromised? Disconnect from cloud / BMS, fail back to manual inspection
              regime, vendor engagement, forensic preservation if needed.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              data, and command channels. Controls shall include network segmentation, authenticated
              access, encrypted communications, and management of vendor security advisories.
            </>
          }
