...
const quickCheckQuestions = [
  ...
  },
  {
    id: 'pq-check-3',
    question:
      'What type of filter is most effective at eliminating specific harmonic frequencies from an installation?',
    options: [
      'Low-pass filter',
      'High-pass filter',
...
const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      'What is the typical THD current level produced by a standard 6-pulse VFD without filtering?',
    options: ['5-10%', '15-25%', '30-50%', '60-80%'],
    correctAnswer: 2,
    explanation:
      'A standard 6-pulse VFD typically produces 30-50% THD current with dominant 5th and 7th harmonics.',
  },
  {
    id: 4,
    question:
      'A voltage sag is typically defined as a reduction in RMS voltage to what percentage range?',
    options: ['0-10% of nominal', '10-90% of nominal', '90-95% of nominal', '95-99% of nominal'],
    correctAnswer: 1,
    explanation:
      'A voltage sag (or dip) is a reduction in RMS voltage to 10-90% of nominal, lasting from half a cycle to one minute.',
  },
  {
    id: 5,
    question:
      'Which UK standard specifically addresses harmonic emissions from customer installations?',
    options: ['BS 7671', 'EN 50160', 'ENA Engineering Recommendation G5/5', 'IEC 61000-3-2'],
    correctAnswer: 2,
    explanation:
      'ENA Engineering Recommendation G5/5 is the UK-specific standard for assessing harmonic emissions from customer installations connecting to DNO networks.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Active harmonic filters use power electronics to inject equal and opposite harmonic currents in real-time, cancelling out the harmonics.',
  },
  {
    id: 9,
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-12">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>THD Limit:</strong> 8% voltage (EN 50160)
                </li>
                <li>
                  <strong>VFD THD-I:</strong> 30-50% without filtering
                </li>
                <li>
                  <strong>Sag:</strong> 10-90% nominal, 0.5 cycle to 1 min
                </li>
                <li>
                  <strong>Flicker Pst:</strong> Less than or equal to 1.0
                </li>
              </ul>
            </div>
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>Spot:</strong> Transformer overheating
                </li>
                <li>
                  <strong>Spot:</strong> Capacitor failures
                </li>
                <li>
                  <strong>Use:</strong> G5/5 for DNO compliance
                </li>
                <li>
                  <strong>Use:</strong> Power quality analysers
                </li>
              </ul>
            </div>
          </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Power quality</strong> refers to how closely the electrical supply matches
                the ideal sinusoidal waveform at the correct voltage, frequency, and with minimal
                distortion. In the UK, the ideal supply is 230V RMS at 50Hz with a pure sine wave.
              </p>

              <p>
                Poor power quality manifests in several ways: waveform distortion (harmonics),
                voltage variations (sags, swells, flicker), frequency deviations, and transient
                events. Each affects equipment and processes differently.
              </p>

              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                  <Zap className="h-4 w-4" /> Why Power Quality Matters
                </p>
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Equipment life:</strong> Harmonic heating accelerates insulation
                    degradation in motors and transformers
                  </li>
                  <li>
                    <strong>Energy efficiency:</strong> Distorted waveforms increase I squared R
                    losses and reduce power factor
                  </li>
                  <li>
                    <strong>Process reliability:</strong> Voltage sags cause control system dropouts
                    and production losses
                  </li>
                  <li>
                    <strong>Regulatory compliance:</strong> DNOs enforce limits on harmonic
                    emissions from customer installations
                  </li>
                </ul>
              </div>
              ...
              <p>
                ...
                <strong>1-2 billion pounds annually</strong> due to power quality issues.
                Understanding and addressing these factors is essential for energy-efficient
                installations.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Harmonics</strong> are sinusoidal voltages or currents at frequencies that
                are integer multiples of the fundamental 50Hz supply. The 3rd harmonic is 150Hz, 5th
                is 250Hz, 7th is 350Hz, and so on.
              </p>

              <div className="grid sm:grid-cols-2 gap-4 my-6">
                <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                  <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                    <Activity className="h-4 w-4" /> Three-Phase Non-Linear Loads
                  </p>
                  <ul className="text-sm text-white space-y-1">
              ...
              <p>
                A standard <strong>6-pulse VFD</strong> typically produces 30-50% THD current with
                dominant 5th (20-25%) and 7th (10-15%) harmonics. The characteristic harmonics for a
                6-pulse rectifier are n = 6k plus or minus 1 where k = 1, 2, 3... giving 5th, 7th,
                11th, 13th, etc.
              </p>

              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                  <AlertTriangle className="h-4 w-4" /> Effects of Harmonics
                </p>
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Transformer overheating:</strong> Additional eddy current and hysteresis
                    losses; may require derating or K-rated transformers
                  </li>
                  <li>
                    <strong>Capacitor failure:</strong> Harmonic resonance can cause dramatic
                    overcurrents and premature failure
                  </li>
                  <li>
                    <strong>Neutral overload:</strong> Triplen harmonics (3rd, 9th, 15th) add in the
                    neutral, potentially exceeding phase current
                  </li>
                  <li>
                    <strong>Motor heating:</strong> Harmonic currents cause additional rotor losses
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mt-4">
                ...
                <p className="text-white text-sm font-mono bg-[#2a2a2a] p-2 rounded text-center">
                  THD = root(V2 squared + V3 squared + V4 squared + ... + Vn squared) / V1 x 100%
                </p>
                <p className="text-white text-sm mt-2">
                  Where V1 is the fundamental and V2 through Vn are harmonic magnitudes. Measure
                  both THD-V (voltage distortion, typically less than 8%) and THD-I (current
                  distortion, varies widely).
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="grid sm:grid-cols-3 gap-3 my-6">
                <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                  <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                    <BarChart3 className="h-4 w-4" /> Voltage Sag (Dip)
                  </p>
                  <p className="text-white text-sm mb-1">
                    Reduction to <strong>10-90%</strong> of nominal voltage
                  </p>
                  <p className="text-white text-sm mb-1">
                    <strong>Duration:</strong> 0.5 cycle to 1 minute
                  </p>
                  <p className="text-white text-sm">
                    <strong>Causes:</strong> Network faults, large motor starting
                  </p>
                </div>
                <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                  <p className="text-elec-yellow text-sm font-medium mb-2">Voltage Swell</p>
                  <p className="text-white text-sm mb-1">
                    Increase to <strong>110-180%</strong> of nominal voltage
                  </p>
                  <p className="text-white text-sm mb-1">
                    <strong>Duration:</strong> 0.5 cycle to 1 minute
                  </p>
                  <p className="text-white text-sm">
                    <strong>Causes:</strong> Load rejection, single-phase faults
                  </p>
                </div>
                <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                  <p className="text-elec-yellow text-sm font-medium mb-2">Transients</p>
                  <p className="text-white text-sm mb-1">
                    Rapid voltage changes <strong>&gt;180%</strong> or impulsive
                  </p>
                  <p className="text-white text-sm mb-1">
                    <strong>Duration:</strong> Microseconds to milliseconds
                  </p>
                  <p className="text-white text-sm">
                    <strong>Causes:</strong> Lightning, switching, capacitor energisation
                  </p>
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                  <Lightbulb className="h-4 w-4" /> Practical Impact
                </p>
                <p className="text-white text-sm">
                  A voltage sag to 80% for just 100ms can cause AC contactors to drop out, PLCs to
                  reset, and VFDs to trip on undervoltage. The <strong>CBEMA/ITIC curve</strong>{' '}
                  defines equipment tolerance limits - most IT equipment can ride through sags above
                  70% lasting less than 0.5 seconds, but deeper or longer sags cause problems.
                </p>
              </div>

              <p>
                <strong>Protection strategies</strong> include: voltage ride-through settings on
                VFDs, contactor hold-in devices, UPS systems for critical loads, dynamic voltage
                restorers (DVR) for sensitive processes, and soft starters to reduce starting
                current impacts.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Flicker</strong> is the visible variation in light output caused by voltage
                fluctuations. It's measured using the <strong>Pst</strong> (short-term flicker
                severity) and <strong>Plt</strong> (long-term flicker severity) indices.
              </p>

              <p>
                The human eye is most sensitive to flicker at frequencies around{' '}
                <strong>8-10Hz</strong>. Even voltage variations of 0.5% at these frequencies can be
                perceptible and irritating.
              </p>

              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 my-6">
                <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                  <Gauge className="h-4 w-4" /> Common Causes of Flicker
                </p>
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Arc furnaces:</strong> The largest industrial source due to erratic arc
                    impedance variations
                  </li>
                  <li>
                    <strong>Large motor starting:</strong> DOL starting of motors can draw 6-8x FLC,
                    causing voltage drops
                  </li>
                  <li>
                    <strong>Welding equipment:</strong> Spot welders and arc welders create
                    repetitive load variations
                  </li>
                  <li>
                    <strong>Wind turbines:</strong> Tower shadow and wind gusts cause power output
                    fluctuations
                  </li>
                  <li>
                    <strong>Heat pumps and compressors:</strong> Cyclic loading patterns
                  </li>
                </ul>
              </div>
              ...
              <p>
                <strong>Mitigation</strong> includes: soft starters and VFDs for motor starting,
                static VAR compensators (SVC) for arc furnaces, increasing supply capacity to reduce
                source impedance, and separating flicker-producing loads onto dedicated feeders.
              </p>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 my-6">
                <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                  <FileCheck className="h-4 w-4" /> EN 50160 - Voltage Characteristics
                </p>
                <p className="text-white text-sm mb-2">
                ...
                <div className="grid sm:grid-cols-2 gap-4 text-sm">
                  <ul className="text-white space-y-1">
                    <li>
                      <strong>Voltage magnitude:</strong> 230V +10%/-6%
                    </li>
                    <li>
                      <strong>Frequency:</strong> 50Hz plus or minus 1%
                    </li>
                    <li>
                      <strong>THD voltage:</strong> Less than or equal to 8%
                    </li>
                  </ul>
                  <ul className="text-white space-y-1">
                    <li>
                      <strong>Individual harmonics:</strong> Specified limits per order
                    </li>
                    <li>
                      <strong>Flicker Pst:</strong> Less than or equal to 1.0
                    </li>
                    <li>
                      <strong>Unbalance:</strong> Less than or equal to 2%
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Stage 1:</strong> Simplified assessment for small installations - if
                    equipment meets IEC 61000-3-2/3-12, no further assessment needed
                  </li>
                  <li>
                    <strong>Stage 2:</strong> Emission assessment comparing equipment emissions to
                    allocated limits at the point of connection
                  </li>
                  <li>
                    <strong>Stage 3:</strong> Detailed network harmonic study for large or complex
                    installations
                  </li>
                </ul>
              </div>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mt-4">
                <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                  <AlertTriangle className="h-4 w-4" /> Important for Electricians
                </p>
                <p className="text-white text-sm">
              ...
              <div className="my-6">
                ...
                <ul className="text-sm text-white space-y-1 ml-4">
                  <li>
                    <strong>IEC 61000-3-2:</strong> Harmonic current limits for equipment 16A or
                    less
                  </li>
                  <li>
                    <strong>IEC 61000-3-12:</strong> Harmonic current limits for equipment greater
                    than 16A but 75A or less
                  </li>
                  <li>
                    <strong>IEEE 519:</strong> Harmonic limits at PCC (used internationally)
                  </li>
                  <li>
                    <strong>BS 7671:</strong> Includes requirements for harmonic consideration in
                    installation design
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="grid sm:grid-cols-2 gap-4 my-6">
                <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                  <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                    <Wrench className="h-4 w-4" /> Passive Harmonic Filters
                  </p>
                  <p className="text-white text-sm mb-2">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                  <Shield className="h-4 w-4" /> Practical Selection Guide
                </p>
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Single VFD, moderate harmonics:</strong> 3-5% DC link choke or AC line
                    reactor
                  </li>
                  <li>
                    <strong>Multiple VFDs, DNO compliance required:</strong> Active harmonic filter
                    at PCC
                  </li>
                  <li>
                    <strong>Large single drive (&gt;100kW):</strong> Multi-pulse rectifier or AFE
                    drive
                  </li>
                  <li>
                    <strong>Existing capacitor resonance:</strong> Detuning reactors (typically 7%
                    or 14%)
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                  When Installing Non-Linear Loads
                </h3>
                <ul className="text-sm text-white space-y-1 ml-4">
              ...
              <div>
                ...
                <ul className="text-sm text-white space-y-1 ml-4">
                  <li>
                    <strong>Adding capacitor PFC to harmonic-rich installations</strong> - risk of
                    resonance; use detuned PFC
                  </li>
                  <li>
                    <strong>Undersizing neutrals</strong> - triplen harmonics can exceed phase
                    current
                  </li>
                  <li>
                    <strong>Ignoring DNO requirements</strong> - can result in connection refusal
                  </li>
                  <li>
                    <strong>Using standard transformers for harmonic loads</strong> - specify
          ...
          <section className="mb-10">
            <div className="p-5 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <h3 className="text-sm font-medium text-white mb-4 flex items-center gap-2">
                <BookOpen className="h-4 w-4 text-elec-yellow" /> Quick Reference Card
              </h3>
