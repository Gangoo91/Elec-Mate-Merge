...
const inlineChecks = [
  {
    ...
    question: 'What does V2G (Vehicle-to-Grid) mean + how does it differ from V2H + V2L?',
    options: [
  ...
  },
  {
    ...
    question: 'What V2G hardware is actually deployed in UK 2025-26?',
    options: [
  ...
  },
  {
    ...
    question: 'What BS 7671 sections cover a V2G install?',
    options: [
  ...
  },
  {
    ...
    question: 'What’s the UK 2025-26 economic case for residential V2G?',
    options: [
...
const quizQuestions = [
  ...
  {
    question: 'What is ISO 15118-20 and why does it matter for V2G?',
    options: [
  ...
  {
    question: 'Why does V2G require a special Type B RCD on the supply circuit?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'Can the customer’s existing unidirectional Zappi / Easee / Wallbox be upgraded to V2G?',
    answer:
...
export default function RenewableEnergyModule10Section5() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 10 · Section 5 · BS 7671:2018+A4:2026 · Section 722 + 551 + Chapter 82"
        title="V2G — Vehicle-to-Grid bidirectional charging"
        backTo="../renewable-energy-module-10"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          V2G (Vehicle-to-Grid), V2H (Vehicle-to-Home), V2L (Vehicle-to-Load). Bidirectional EV
          charging integration with the UK 2025-26 PEI. The EV battery becomes another generating
          source under Section 551 + Chapter 82. UK 2025-26 reality: Wallbox Quasar 1 (CHAdeMO) +
          emerging Quasar 2 (CCS), Octopus Power Pack successor schemes, ISO 15118-20 + OCPP 2.0.1
          maturing, OEM warranty constraints significant. Not mainstream yet — limited but growing.
        </p>
        ...
        <Pullquote>
          V2G is the most regulation-intensive single feature in M10. EV (Section 722) + generating
          set (Section 551) + multi-source PEI (Chapter 82) + DNO interface (G99 + G100) +
          commercial tariff (Octopus) + OEM warranty + protocol stack (ISO 15118-20) — all converge
          on one charger.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">V2G — Vehicle-to-Grid</strong> — bidirectional charger
              discharges EV battery to the public DNO grid. Customer earns grid-services revenue
              (Octopus Power Pack successor: £300-700/year). Subject to full Section 722 + Section
              551 + Chapter 82 + EREC G99 + G100 + ISO 15118-20 + OCPP 2.0.1 + OEM warranty
            </li>
            <li>
              <strong className="text-white">V2H — Vehicle-to-Home</strong> — bidirectional charger
              powers the home during DNO outage (island mode) or during peak-tariff windows
              (load-shifting, no export). Subject to Section 722 + Section 551 + Chapter 82
              ISLAND-MODE requirements (Reg 826.1.1.2.2 N-E switching + Reg 826.1.1.5 island-mode
              switching device + grid-forming bidirectional charger or coordinated backup gateway)
            </li>
            <li>
              <strong className="text-white">V2L — Vehicle-to-Load</strong> — vehicle provides AC
              power output via a socket integrated into the EV (Hyundai IONIQ 5, Kia EV6, MG4, BYD,
              Ford F-150 Lightning). Camping kettle, power tools, emergency lighting. NO charger
              install scope — it’s a feature of the vehicle. No BS 7671 install scope (the load
              plugged in is covered by its own product compliance). UK 2025-26 mainstream
            </li>
            <li>
              <strong className="text-white">V2X umbrella</strong>— industry term covering all
              bidirectional EV uses (V2G + V2H + V2L + V2B Vehicle-to-Building). OCPP 2.0.1 + ISO
              15118-20 support V2X session negotiation
            </li>
            <li>
              <strong className="text-white">Hardware separation</strong> — V2L is purely a vehicle
              feature (built-in socket). V2G + V2H both require bidirectional CHARGER hardware. V2H
              requires additional island-mode capability (grid- forming + N-E switching
              coordination)
            </li>
            <li>
              <strong className="text-white">UK 2025-26 customer-facing reality</strong> — V2L: ask
              vehicle features. V2G: ask whether vehicle + charger + OEM warranty + tariff align.
              V2H: ask whether site has backup gateway + V2G charger supports island mode (rare
              currently)
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — V2L: no install
              evidence needed (vehicle feature). V2G + V2H: integrated PEI EIC + Section 722 + 551 +
              Chapter 82 + V2G charger DoC + EREC + EMS + customer handover noting OEM warranty
              implications
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Wallbox Quasar 1</strong>— 7.4 kW single-phase CHAdeMO
              bidirectional. Octopus Power Pack trial workhorse 2020-2023. CHAdeMO compatibility:
              Nissan LEAF (UK widespread; ageing fleet), Mitsubishi Outlander PHEV (small UK fleet).
              £5,000-7,000 unit cost. Discontinued in some markets as CCS becomes default
            </li>
            <li>
              <strong className="text-white">Wallbox Quasar 2</strong>— 7.4 kW (single-phase) / 11
              kW (three-phase) CCS bidirectional. Announced 2022; UK 2025-26 deployment limited. ISO
              15118-20 + OCPP 2.0.1 compatible. £7,000-10,000 unit cost
            </li>
            <li>
              <strong className="text-white">dnata DC bidirectional</strong>— commercial fleet DC
              bidirectional unit. CCS. ~11-22 kW power. £10,000-15,000. UK 2025-26 pilot deployments
            </li>
            <li>
              <strong className="text-white">V2X.energy</strong> — commercial bidirectional units;
              fleet-focused. UK 2025-26 emerging
            </li>
            <li>
              <strong className="text-white">ABB Terra series</strong>— commercial DC fast chargers;
              some models bidirectional-capable for fleet use. £20,000+ per unit
            </li>
            <li>
              <strong className="text-white">EVgo / Fortum / others</strong>— emerging commercial
              bidirectional product lines as ISO 15118-20 matures
            </li>
            <li>
              <strong className="text-white">Cost gap</strong>— V2G charger £7-15k vs unidirectional
              Zappi / Easee / Wallbox Pulsar £700-1.5k. £5-9k uplift = the dominant economic barrier
              to V2G adoption. Gap closing slowly
            </li>
            <li>
              <strong className="text-white">Future trajectory</strong> — ISO 15118-20 + OCPP 2.0.1
              ecosystem alignment 2024-2027 should reduce cost premium as volumes grow; OEM warranty
              expansion (more brands V2G-friendly); commercial tariff schemes (Octopus successor +
              competitors) expanding. UK 2030: 5-10% of new chargers V2G; 2035: meaningful market
              share
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          V2G turns the EV from a load into a source. The moment that happens, Section 722 alone is
          not enough — Section 551 generating-set rules apply, Chapter 82 multi-source rules apply,
          EREC G99 amendment applies. The install’s complexity multiplies.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 551.1.1 classification</strong> — V2G EV is a
              generating set (battery + bidirectional inverter together). Categorically in scope of
              Section 551 framework
            </li>
            <li>
              <strong className="text-white">Reg 551.7.5 anti-islanding</strong> — V2G charger must
              detect DNO supply loss + cease discharging. Built into the V2G charger’s control
              (RoCoF + voltage / frequency windows — G99 disallows Vector Shift for type-tested
              generation, so RoCoF is the required loss-of-mains method on the type-tested inverters
              used in virtually all LCT installs; Vector Shift is legacy / non-type-tested only).
              Verified at commissioning per ENA G99 or G98 procedure
            </li>
            <li>
              <strong className="text-white">Reg 551.7.2.1 supply-side</strong> — V2G charger
              connects on supply side of protective devices, identical to BESS inverter or PV
              inverter. Battery (the EV) is the source, charger is the inverter, both sit upstream
              of the consumer unit RCDs
            </li>
            <li>
              <strong className="text-white">Reg 551.4.2 RCD effectiveness</strong> — V2G adds
              another source combination to the PEI. Per-source RCD + central RCD architecture
              verified effective for: V2G alone, V2G + PV, V2G + BESS, V2G + PV + BESS, etc.
            </li>
            <li>
              <strong className="text-white">Reg 551.6 control</strong> — manual + automatic control
              of V2G discharge handled by OCPP backend + EMS + ELS (if G100); customer-side control
              via vendor app
            </li>
            <li>
              <strong className="text-white">EREC G99 amendment</strong> — adding a V2G source to
              existing PEI requires G99 amendment notifying the DNO of the new generating set +
              capacity. DNO updates connection agreement
            </li>
            <li>
              <strong className="text-white">EREC G100 recommissioning</strong> — if site has export
              limit, V2G added to curtailment hierarchy. New G100 cert filed
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — Section 722 EV charging
              section + Section 551 generating set updates + Chapter 82 multi-source updates + V2G
              charger product DoC + commissioning test result per source combination
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 826.1.1.1 protection in all modes</strong> — add
              V2G to source- combination matrix. Existing PV+BESS+DNO had ~7 configurations; add V2G
              → ~15 configurations. Each verified
            </li>
            <li>
              <strong className="text-white">Reg 826.1.1.4 multi-source isolation</strong> — V2G
              charger isolator added to per-source isolation list. Warning notice updated. UK
              2025-26 typical 5-source PEI: DNO + PV AC + PV DC + BESS AC + BESS DC + V2G charger
              isolator = 6+ isolation points
            </li>
            <li>
              <strong className="text-white">Reg 826.1.2.1 overcurrent</strong> — V2G discharge
              contributes to fault current at MET. Worst-case PSCC recalculated at main consumer
              unit considering DNO + PV + BESS + V2G simultaneous max output. Modest contribution
              (V2G ≈7.4 kW → ≈32 A); breaker breaking capacity check
            </li>
            <li>
              <strong className="text-white">Reg 826.1.2.2 direction + polarity</strong> — V2G adds
              bidirectional energy flow on the EV charging circuit. Protective devices selected
              considering both directions; reverse-current relays where applicable
            </li>
            <li>
              <strong className="text-white">Reg 826.1.3 outage behaviour</strong> — with V2G in
              PEI, on DNO loss: either (a) V2G + BESS + PV all disconnect (Reg 551.7.5 default —
              most UK 2025-26 V2G chargers grid-following only); or (b) V2G joins island mode (V2H,
              rare, requires grid-forming V2G hardware + backup gateway coordination)
            </li>
            <li>
              <strong className="text-white">Reg 826.1.4 surge protection</strong> — V2G charging
              cycles add switching events; SPD review per Reg 826.1.4
            </li>
            <li>
              <strong className="text-white">EMS coordination</strong>— EMS includes V2G in priority
              logic: V2G discharge to home or to grid based on tariff + customer preference + OCPP
              scheduling + ELS limit
            </li>
            <li>
              <strong className="text-white">Cert evidence</strong>— integrated PEI EIC updated;
              Chapter 82 compliance summary; Section 722 + 551 + 826 cross-references; V2G charger
              DoC; EMS architecture diagram; OCPP backend record; EREC correspondence; customer
              handover with OEM warranty note
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-10-section-4')}
