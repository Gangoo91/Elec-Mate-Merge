    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Part 6 of BS 7671:2018+A4:2026 — restructured, renumbered, and the source of every test on
          the schedule. Chapters 64 and 65, Reg 643.x in sequence, and the A4 changes you must apply
          from 15 April 2026.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              application), Reg 642 (inspection), Reg 643 (testing — the substantive test sequence),
              and Reg 644 (certification: EIC, MEIWC).
            </li>
            <li>
              <strong>Chapter 65 — Periodic inspection and testing.</strong> Covers Reg 651 (general
              — inspection scope and competence), Reg 652 (frequency of periodic inspection and
              testing), and Reg 653 (reporting — production of the EICR).
            </li>
            <li>
              <strong>Appendix 6 — Model forms.</strong> The actual EIC, MEIWC, EICR, schedules of
              inspection and schedules of test results, plus a non-mandatory checklist of inspection
              items. A4 simplified the schedule of inspections and added the non-mandatory
              checklist.
            </li>
          </ul>
          <p>
            Within Chapter 64 the substantive test obligations live at Reg 643.x. That is where the
            practical &ldquo;what tests must I run&rdquo; question is answered. Within Chapter 65
            the operational obligations live at Reg 651.4 (recording defects), Reg 651.5
        ...
        <RegsCallout
          ...
          clause={
            <>
              The tests of Regulations 643.2 to 643.11, where relevant, shall be carried out and the
              results compared with relevant criteria. Measuring instruments and monitoring
        ...
        >
          <p>
            ...
            capable of resolving below 0.1&nbsp;Ω with lead-resistance compensation. A multimeter on
            the lowest ohms range is not adequate, and a buzzer is wrong for the regulation — the
            reg requires &ldquo;measurement of resistance&rdquo;, which is a numeric value, not a
            beep.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            sentence: where connected equipment is likely to influence the measurement or be damaged
            by the test, the test shall be applied prior to connection of that equipment. Reg
            643.3.3 second sentence: following re-connection of that equipment, a test at 250&nbsp;V
            DC shall be applied between live conductors and the protective conductor connected to
            the earthing arrangement.
          </p>
          <p>
            The 250&nbsp;V DC follow-up is a new compliance step in A4 territory. It exists because
            LED drivers, surge devices, AFDDs and modern electronic loads cannot tolerate the
            500&nbsp;V DC primary insulation test, but their connected state still needs to be
        ...
        >
          <p>
            In practice 643.4 only applies when one of those protective measures has been chosen for
            the installation or part of it (typical examples: a 12&nbsp;V garden lighting system fed
            from a SELV transformer, a battery system as a SELV source, or an
        ...
        >
          <p>
            ...
            non-competent persons. A reversed polarity at a socket means the appliance switch breaks
            the neutral, leaving the line conductor live to chassis. Reg 643.6 makes polarity
            verification a pre-energisation requirement specifically because the consequence of
            getting it wrong is that downstream protection cannot do its job.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            A4:2026, against the explicit max-permitted-Zs column on the schedule of circuit details
            where the design specified a tighter limit than the BS 7671 table.
          </p>
          <p>
            Reg 643.7.3.201 imports Reg 434.1 into the test phase: the prospective short-circuit
            current and prospective earth fault current shall be measured, calculated or determined
            at the origin and at other relevant points. The Ipf at the origin sits on the EIC; Ipf
            at distribution boards downstream sits on the schedule of circuit details so that
            breaking capacity can be verified for every protective device.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            switch, manual operation of every protective device, and any specific functional checks
            the design called for (interlocks, emergency stops, changeover sequences) belong here.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="40" y="62" fill="rgba(255,255,255,0.5)" fontSize="10">
              Supply isolated, locked off. Each test’s validity depends on the previous test’s pass.
            </text>
            ...
            <g>
              ...
              <text x="105" y="130" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                CPCs, bonding, ring
              </text>
            </g>
            <g>
              ...
              <text x="245" y="130" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                L–L, L–E + 250 V DC
              </text>
            </g>
            <g>
              ...
              <text x="385" y="130" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                SELV / PELV / sep.
              </text>
            </g>
            <g>
              ...
              <text x="525" y="130" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Reg 418 only
              </text>
            </g>
            <g>
              ...
              <text x="680" y="130" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <g>
              ...
              <text x="110" y="370" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <g>
              ...
              <text x="250" y="370" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Type-correct, ×1, ×5
              </text>
            </g>
            <g>
              ...
              <text x="380" y="370" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                3-phase only
              </text>
            </g>
            <g>
              ...
              <text x="530" y="370" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Main sw + OCPDs + RCDs
              </text>
            </g>
            <g>
              ...
              <text x="690" y="370" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Calc only, normally
              </text>
            </g>
            ...
            <text x="400" y="420" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="10">
              Each test result is recorded against the specific Reg on the Schedule of Test Results
              — measured value, not just pass / fail.
            </text>
            <text
              x="400"
              y="434"
        ...
        >
          <p>
            Section 511 covers compliance with the relevant standards — equipment carries the right
            marks, the right approvals, the right ratings. &ldquo;Mark or certification furnished by
            the installer or the manufacturer&rdquo; is permitted evidence (642.2(a) note).
            Selection and erection per BS 7671 and manufacturers’ instructions is the broad umbrella
            under which the rest of the inspection sits. Visible damage / defect is the on-the-day
            check.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The 642.3 list covers, broadly: connection of conductors; identification of conductors;
            routing of cables in safe zones; selection of conductors for current-carrying capacity
            and voltage drop; presence and correct rating of protective devices; selection of
            equipment and protective measures appropriate to external influences; identification of
            circuits, fuses, switches and terminals; presence of warning notices and labels;
            presence of diagrams, instructions and schematics; protection against electric shock;
            protection against thermal effects; protection against overcurrent; isolation and
            switching; condition of accessories including socket-outlets, switches and joint boxes
            (Reg 651.2(e)).
          </p>
          <p>
            When formulating bespoke schedules for larger or complex installations, GN3 is explicit:
            the bespoke schedule shall be based on the requirements of Reg 642.3 — it is not a
            free-form template.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The recording duty in Reg 651.4 is the source of the EICR classification codes (C1, C2,
            C3, FI). The codes themselves come from Appendix 6 model forms; the duty to record the
            defect comes from the regulation. A defect not recorded is a regulatory failure
        ...
        >
          <p>
            These are <em>maximum</em> intervals — the inspector is required to apply judgement. GN3
            makes the point that Reg 652.1 gives guidance but does not remove the inspector’s
            obligation to make a reasonable and informed decision. A 10-year interval is the default
            for an owner-occupied dwelling in benign external influences with documented
            maintenance; it is not the mandatory interval for every dwelling.
          </p>
          <p>
            Reg 652.2 permits replacement of periodic inspection by an adequate regime of continuous
            monitoring and maintenance, where the installation is under an effective management
            system for preventative maintenance in normal use, and the monitoring is by skilled
            persons competent in such work. This is the route taken by major industrial / data
            centre / hospital estates with permanent in-house teams. The clause uses
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              max-permitted-Zs column on the Schedule of Circuit Details. Where the design specifies
              a tighter Zs than the BS 7671 Table 41 maximum, that tighter design value goes in the
              column — and the verification under Reg 643.7 / 411 is against the column value, not
              the table value.
            </li>
            <li>
              <strong>Reg 643.3 redraft.</strong> The 250 V DC follow-up test after equipment
              reconnection (covered above). Pre-A4 testers / forms did not have a column or workflow
              for this; A4-aware ones do.
            </li>
            <li>
              <strong>Appendix 6 model forms.</strong> EIC, MEIWC, EICR templates updated. Schedule
              of Inspections simplified. New non-mandatory checklist of inspection items added
              (guidance, not required to be issued with the certificate).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 644.5 explicitly permits the certificate to be compiled and signed or authenticated
            by more than one person — for example, a separate designer, constructor and inspector.
            Each person signs for the parts of the work for which they are competent. This is the
            regulatory mechanism for the standard three-signature EIC workflow on larger jobs.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            standard’s amendment notes flags that the Appendix 6 notes for the person producing the
            report shall be taken into account when producing the EICR. Practitioners shall ensure
            they are using the A4 edition — the previous editions did not require those notes to be
            applied.
          </p>
        </ConceptBlock>
