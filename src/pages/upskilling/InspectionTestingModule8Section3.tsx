...
const DESCRIPTION =
  'Learn to correctly complete the Schedule of Test Results, recording all electrical measurements from initial verification and periodic inspection.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'The Schedule of Test Results provides a permanent record of all electrical test values, enabling comparison with requirements and future inspections.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'R1+R2 should be recorded for each circuit as this value is used to calculate maximum Zs. Where R2 is measured separately for main bonding, this should also be recorded.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      "The actual measured insulation resistance in megohms should be recorded. If the reading exceeds the meter range (e.g., >200MΩ), record '>200MΩ' or similar.",
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Record trip times at x1 IΔn (max 300ms) and x5 IΔn (max 40ms), plus confirmation of no trip at 1/2 IΔn. Both positive and negative half-cycle tests where applicable.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Zs should be recorded in ohms to sufficient precision (typically 2 decimal places) to demonstrate compliance with maximum values in BS 7671 tables.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      "N/A indicates the test is not applicable to that circuit. For example, RCD tests don't apply to circuits not protected by an RCD.",
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Circuit references must match those on the distribution board circuit chart/schedule. This enables cross-referencing and identification for future work.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'A tick indicates correct polarity was verified. Incorrect polarity requires detailed explanation in observations and appropriate coding.',
  },
  {
    id: 9,
    question:
      'The maximum Zs column shows the limiting value for the circuit. Where does this come from?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Maximum Zs values are taken from BS 7671 Chapter 41 tables, based on the protective device type (MCB curve B/C/D, fuse type) and rating.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Record the actual measured value, add details to the observations section, and assign an appropriate defect code (C1, C2, or C3). Never falsify results.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Actual values provide baseline data for future inspections, demonstrate compliance margins, and help diagnose problems. A value just within limits now might fail next time - trending data helps predict issues.',
  },
  {
    question: 'Should I test and record every circuit individually?',
    answer:
      "Yes. Each circuit should be tested and recorded separately. This identifies which specific circuits have issues and provides comprehensive data for future reference. Group testing doesn't provide adequate information.",
  },
  {
    question: "What if my meter shows '>200MΩ' for insulation resistance?",
    answer:
      "Record '>200MΩ' (or your meter's maximum displayed value). This indicates excellent insulation well above the minimum requirement of 1.0MΩ. The exact value above the display limit isn't significant.",
  },
  {
    question: 'How do I record ring final circuit continuity?',
    answer:
      'Record r1, rn, and r2 values from the three-step test. Also record the R1+R2 value at the furthest point. Some schedules have specific columns for ring circuits; otherwise use the remarks column.',
  },
  {
    question: 'Do I need to record Ze separately from Zs?',
    answer:
      'Ze (external earth fault loop impedance) should be measured and recorded, typically on the main form or the first page of results. Zs values for individual circuits build on this Ze value.',
  },
  {
    question: 'What units should be used throughout?',
    answer:
      'Use standard units: ohms for impedance and resistance, megohms (MΩ) for insulation resistance, milliseconds (ms) for RCD trip times, milliamps (mA) for RCD ratings, amps (A) for device ratings.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Record:</strong> Actual measured values, not just pass/fail
              </li>
              <li>
                <strong>Test:</strong> Every circuit tested separately
              </li>
              <li>
                <strong>Units:</strong> Ohms, MΩ, ms, mA, A
              </li>
              <li>
                <strong>Match:</strong> Circuit references to distribution board
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Continuity:</strong> R1+R2 in ohms
              </li>
              <li>
                <strong>Insulation:</strong> MΩ (min 1.0MΩ)
              </li>
              <li>
                <strong>Zs:</strong> Ohms (compare to max)
              </li>
              <li>
                <strong>RCD:</strong> Trip times in ms
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The Schedule of Test Results is a vital document that records all electrical
              measurements from testing. It serves multiple purposes:
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> The schedule must accompany every EIC and EICR - it's not
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Understanding each column ensures complete and accurate recording:</p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Continuity test results confirm protective conductor integrity and enable Zs
              calculation:
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>R1+R2:</strong> Value in ohms (e.g., 0.45 Ohms)
                </li>
                <li>
                  <strong>R2 (bonding):</strong> Value in ohms (e.g., 0.12 Ohms)
                </li>
                <li>
                  <strong>Ring circuit:</strong> r1, rn, r2 values
                </li>
              </ul>
            </div>

            <p className="text-sm text-amber-400/80">
              <strong>Important:</strong> Remember to subtract test lead resistance from readings,
              or null leads before testing.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Insulation resistance values demonstrate conductor insulation integrity:</p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">Recording Format</p>
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Minimum acceptable:</strong> 1.0 MΩ
                </li>
                <li>
                  <strong>Typical new installation:</strong> &gt;200 MΩ
                </li>
                <li>
                  <strong>Test voltage (SELV/LV):</strong> 250V / 500V
                </li>
              </ul>
            </div>

            <p>
              If your meter shows &gt;200MΩ or similar, record this. For values near the limit (1-2
              MΩ), record the exact value as this may warrant investigation or observation.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>RCD test results require multiple values to be recorded:</p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">RCD Test Values</p>
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>x1 IΔn trip time:</strong> Value in ms (max 300ms)
                </li>
                <li>
                  <strong>x5 IΔn trip time:</strong> Value in ms (max 40ms)
                </li>
                <li>
                  <strong>1/2 IΔn:</strong> &gt;200ms or 'NT' (no trip)
                </li>
                <li>
                  <strong>Test button:</strong> Tick (operates)
                </li>
              </ul>
            </div>

            <p className="text-sm text-white/90 italic">
              <strong>Note:</strong> Some schedules require positive (+) and negative (-) half-cycle
              tests. Record both values where applicable.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Before signing off, verify the schedule is complete:</p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Remember:</strong> Incomplete schedules are unprofessional and may not be
              accepted by building control or scheme providers.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Never falsify results</strong> — inaccurate records are professional
                  misconduct and dangerous
                </li>
                <li>
                  <strong>Don't leave blanks</strong> — use N/A where tests don't apply
                </li>
                <li>
                  <strong>Don't round excessively</strong> — precision demonstrates compliance
                </li>
                <li>
                  <strong>Don't forget test lead resistance</strong> — affects continuity readings
                </li>
              </ul>
            </div>
          </div>
