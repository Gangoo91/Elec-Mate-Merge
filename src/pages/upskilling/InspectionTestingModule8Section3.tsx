...
const InspectionTestingModule8Section3 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 8 · Section 3" title="Schedule of Test Results" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Every column on the A4:2026 Generic Schedule of Test Results, what each one records, and
          how they cross-check each other and the Schedule of Circuit Details.
        </p>
        ...
        >
          <p>
            ...
            of the work covered, plus (a) Schedule(s) of Inspection, and (b) Schedule(s) of Circuit
            Details and Schedule(s) of Test Results. The schedules must be based on the models in
            Appendix 6 — meaning the BS 7671:2018+A4:2026 Generic Schedule of Circuit Details and
            Generic Schedule of Test Results, exactly as published.
          </p>
          <p>
            The note for the person producing the EIC reinforces this: &ldquo;This Certificate is
            only valid if the Schedule of Inspection has been completed to confirm that all relevant
            inspections have been carried out and the relevant Schedule(s) of Circuit Details and
            Schedule(s) of Test Results have been attached (Regulation 644.3).&rdquo; Issue an EIC
            without the schedules and you have issued an invalid certificate.
          </p>
        </ConceptBlock>
              ...
              <tbody className="text-white/95">
                ...
                <tr className="border-b border-white/[0.06]">
                  ...
                  <td className="text-elec-yellow">
                    The design limit. § footnote: where it is not from Chapter 41, state the source
                    in column 31 Remarks
                  </td>
                </tr>
                <tr className="border-b border-white/[0.06]">
        ...
        >
            ...
            <table className="w-full text-[13.5px] my-2">
              ...
              <tbody className="text-white/95">
                ...
                <tr className="border-b border-white/[0.06]">
                  ...
                  <td>
                    Method 2 wandering-lead reading (R2-only, for circuits where Method 2 was used)
                  </td>
                </tr>
                <tr className="border-b border-white/[0.06]">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    — and the source of any column 12 value not from Chapter 41
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <p>
            Note the columns shaded in elec-yellow above. They are the columns A4:2026 either added
            (column 30) or repositioned to anchor against specific regulations (12, 27, 28). The
            schedule is not just a record — it is the regulation made auditable.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="110" y="60" textAnchor="middle" fill="#22C55E" fontSize="10" fontWeight="bold">
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="310" y="60" textAnchor="middle" fill="#FBBF24" fontSize="10" fontWeight="bold">
              CONTINUITY (Ω)
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="510" y="60" textAnchor="middle" fill="#3B82F6" fontSize="10" fontWeight="bold">
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="710" y="60" textAnchor="middle" fill="#A855F7" fontSize="10" fontWeight="bold">
              POLARITY
            </text>
            ...
            <rect
              ...
              strokeWidth="2"
            />
            <text x="510" y="208" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              ⚠ NEW AT A4:2026
            </text>
            <text
              x="510"
          ...
          whatToDo={
            <>
              <span className="block">
                Calculated R1+R2 at 20°C = 28 m × 16.71 mΩ/m = 0.47 Ω. Measured 0.51 Ω is within 10
                % — accept.
              </span>
              <span className="block">
                Predicted Zs at 20°C = 0.31 + 0.51 = 0.82 Ω. Live-measured (col 27) = 0.86 Ω.
                Discrepancy 0.04 Ω — within tolerance for a TN-S circuit (some warming of conductors
        ...
        >
          <p>
            ...
            the Schedule of Test Results records the manual test button operation specifically. The
            pairing makes both regulations auditable in a single inspection.
          </p>
          <p>
            For circuits where no AFDD is fitted, column 30 is blank (or N/A). For circuits where an
            AFDD with a test button is fitted, column 30 records the result of pressing that button.
            For an AFDD without a test button, the †† footnote applies — the column is N/A, and item
            4.23 of the Schedule of Inspection records the indicator-light check instead.
          </p>
        </ConceptBlock>
        ...
        >
          <ol className="list-decimal pl-5 space-y-2 text-[14px]">
            ...
            <li>
              <strong className="text-elec-yellow">Col 27 vs Ze + col 21.</strong> Live-measured Zs
              should match the dead-test sum (Ze + R1+R2) within a few hundredths of an ohm for a TN
              system. A larger discrepancy means either Ze has changed since the header, a parallel
              path was lost during the live test, or a joint heated up under test current.
            </li>
            <li>
            ...
            <li>
              <strong className="text-elec-yellow">Col 18 vs col 19, ratio col 20 ÷ col 18.</strong>{' '}
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Col 21 high, col 27 high (proportionally).</strong> The fault is in the cable
              / CPC of the affected circuit — loose joint, damaged conductor, or undersized CPC.
            </li>
            <li>
              <strong>Col 21 normal, col 27 high.</strong> The Ze has shifted — likely a problem at
              the supply or main earthing arrangement. Re-measure Ze; if it has risen, the fault is
              upstream of the consumer unit.
            </li>
            <li>
              <strong>Col 21 low (lower than calculated), col 27 normal.</strong> Parallel earth
              paths via metalwork are masking a degraded CPC. The day someone removes the metalwork,
              Zs jumps. Investigate the CPC under disconnection of containment.
            </li>
            <li>
              <strong>Col 28 longer than 300 ms.</strong> RCD past its design life, or wiring fault
              increasing the residual current threshold. Replace the RCD or investigate stray
              neutral-to-earth currents on the circuit.
            </li>
            <li>
            ...
            <li>
              ...
              connections at the board are not on the same conductor. Investigate the ring topology
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="400" y="42" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              START
            </text>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              <span className="block">
                Cross-check 1: r₁ (0.40) vs rₙ (0.62) — should be approximately equal on a sound 2.5
                mm² ring. They are not. Either the neutral has an extra length, a spur is on the
                ring on one leg only, or the ring is broken on the neutral.
              </span>
              <span className="block">
              ...
              <span className="block">
                Cross-check 3: col 27 (1.41 Ω) &gt; col 12 (1.37 Ω) — fails Reg 411.4 disconnection
            ...
            <table className="w-full text-[13px] my-2">
              ...
              <tbody className="text-white/95">
                ...
                <tr className="border-b border-white/[0.06]">
                  <td className="py-2">**</td>
                  <td>
                    &ldquo;RCD Effectiveness is verified using an alternating-current test at rated
                    residual operating current (IΔn).&rdquo;
                  </td>
                ...
                <tr className="border-b border-white/[0.06]">
                  <td className="py-2">‡‡</td>
                  <td>
                    &ldquo;Where this schedule forms part of an Electrical Installation Certificate,
                    insulation resistance testing should be performed at the test voltage stated in
                    Table 64.&rdquo;
                  </td>
                ...
                <tr className="border-b border-white/[0.06]">
                  <td className="py-2">‡</td>
                  <td>
                    (On Schedule of Circuit Details col 4) &ldquo;See Table 4A2 of Appendix 4 of BS
                    7671:2018+A4:2026&rdquo;
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    12 is taken from a source other than the tabulated values given in Chapter 41 of
                    BS 7671:2018+A4:2026, state the source of the data in the appropriate cell for
                    the circuit in the Remarks column 31 of the Schedule of Test Results.&rdquo;
                  </td>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Iₚf (kA):</strong> Prospective fault current at the origin. Equals the greater
              of prospective short-circuit and prospective earth fault currents (per the EIC notes).
            </li>
            <li>
            ...
            <li>
              ...
              Earth electrode resistance. Each row gets the instrument that actually performed that
              test. One multifunction tester for all → same serial in every row. Different
