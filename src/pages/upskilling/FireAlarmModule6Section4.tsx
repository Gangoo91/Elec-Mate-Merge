...
const FireAlarmModule6Section4 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 6 · Section 4" title="Record keeping and logbooks" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The logbook is the operational diary of the fire-alarm system and the audit trail for the
          responsible person\'s RRO 2005 duty. BS 5839-1:2025 keeps the function but tightens the
          content: all variations are now recorded (the 2017 'major variations only' wording is
          gone), Annex H replaces Annex F as the template, and clause 43.4 introduces a
          remote-access / cyber-security log component. The asset register works alongside the
          logbook as the device-level data spine.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>For the AHJ.</strong> Single document on which to focus an inspection / audit.
              The presence of well-maintained logbook entries is a strong indicator of a well-run
              system; the absence is a red flag.
            </li>
            <li>
            ...
            <li>
              <strong>For the court (post-incident).</strong> The contemporaneous record of what the
              system did and what was done to it. Reconstruction tool. The logbook is read out in
              evidence in many post-incident inquiries.
            </li>
          </ul>
          <p>
            A logbook is not "compliance paperwork" — it is the system\'s memory. Treat every entry
            as if a future investigator will read it. Date, time, person, event, outcome, signature.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Monthly auxiliary supply tests</strong> (where applicable). Date, time, supply
              tested, observed alarm panel behaviour during changeover, restoration, signature.
            </li>
            <li>
              <strong>Six-monthly inspection and service visits.</strong> Summary entry referencing
              the full service report. Engineer name, arrival / departure times, conformity
              statement, next visit window, signature.
            </li>
            <li>
              <strong>Real fire alarms.</strong> Detailed entry — date / time / originating device,
              evacuation outcome, FRS attendance, cause, damage, reset, follow-up.
            </li>
            <li>
            ...
            <li>
              <strong>Variations.</strong> Per clause 6 — every agreed variation recorded (NEW 2025
              — was "major" only). Justification, agreement parties, scope.
            </li>
            <li>
              <strong>Training and competence events.</strong> Initial handover training, refresher
              training, change of designated weekly-test operator.
            </li>
          </ul>
          <p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="440" y="46" textAnchor="middle" fill="#FBBF24" fontSize="13" fontWeight="bold">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Date and time.</strong> Connection start, connection end. The event log of the
              CIE / gateway is the source.
            </li>
            <li>
            ...
            <li>
              ...
              operational at the end of the connection. Where any issues, what was done to restore.
            </li>
            <li>
          ...
          <p>
            The cyber-security log is reviewed at every six-monthly service visit. Anomalies (failed
            authentications, write actions without risk-assessment references, connections from
            unexpected IP addresses) are flagged and investigated. The servicing organisation
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              servicing organisation reviews the pattern, identifies the dominant cause, recommends
              action.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Location</strong> — zone, room, height, mounting position, building reference.
            </li>
            <li>
              <strong>Install date</strong> — original installation, replacement install if later.
            </li>
            <li>
              <strong>Last test date</strong> — updated at every six-monthly visit when this device
              is tested.
            </li>
            <li>
            ...
            <li>
              <strong>Replacement-due date</strong> — calculated from manufacturer-specified end of
              life and any sensitivity-drift threshold.
            </li>
            <li>
              <strong>Open defect status</strong> — current open faults or watch-list items.
            </li>
            <li>
              <strong>Logbook cross-reference</strong> — links to the chronological logbook entries
              where this device appears.
            </li>
          </ul>
          <p>
            The asset register lives with the logbook (often as an appendix or separately maintained
            spreadsheet / database with logbook cross-references). At every six- monthly visit, the
            engineer updates the rows for devices tested during the visit, and reviews the rows for
            devices not tested to plan the next visit\'s sample. The register is the spine that
            delivers the annual full-coverage requirement (Section 6.1).
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-6/section-5')}
