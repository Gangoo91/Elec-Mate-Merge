...
const DESCRIPTION =
  'Master fire alarm documentation requirements: logbook entries, maintenance records and compliance evidence per BS 5839-1.';
    ...
    () => [
      {
        ...
        options: ['1 year minimum', '2 years minimum', '3 years minimum', '5 years minimum'],
        correctAnswer: 2,
        explanation:
          'BS 5839-1 requires fire alarm records to be retained for a minimum of 3 years for inspection by fire authorities and insurers.',
      },
      {
        id: 2,
        ...
        correctAnswer: 1,
        explanation:
          'Weekly test entries must include date, time, name of person conducting the test, zone or device tested, results, and any faults found.',
      },
      {
        id: 3,
        ...
        correctAnswer: 2,
        explanation:
          'The logbook should be accessible to responsible persons, fire authorities during inspections, insurance assessors, and service engineers.',
      },
      {
        id: 4,
        ...
        correctAnswer: 1,
        explanation:
          'Fault records must include full details: discovery date/time, exact location, fault description, immediate actions, remedial work, and completion verification.',
      },
      {
        id: 5,
        ...
        correctAnswer: 1,
        explanation:
          'The logbook should be kept in a secure but accessible location near the main fire alarm control panel for easy access during tests and inspections.',
      },
      {
        id: 6,
        ...
        correctAnswer: 2,
        explanation:
          'False alarms require detailed recording including cause investigation and measures taken to prevent recurrence, supporting unwanted alarm reduction programmes.',
      },
      {
        id: 7,
        ...
        correctAnswer: 2,
        explanation:
          'Service visit details must be entered in the logbook before the engineer leaves site, ensuring immediate documentation of all work performed.',
      },
      {
        id: 8,
        ...
        correctAnswer: 1,
        explanation:
          'All system modifications must be documented, including device additions/removals, zone changes, programming alterations, and any system extensions.',
      },
      {
        id: 9,
        ...
        correctAnswer: 1,
        explanation:
          'Digital systems must maintain comprehensive audit trails showing user identification, date/time of entries, and any modifications made to records.',
      },
      {
        id: 10,
        question:
          'What should be recorded when the system is taken out of service for maintenance?',
        options: [
          'Nothing special',
        ...
        correctAnswer: 1,
        explanation:
          'System outages require recording start/end times, affected areas, and compensatory fire safety measures implemented during the maintenance period.',
      },
    ],
    []
  );
      ...
      <div className="px-4 sm:px-6 py-6 max-w-4xl mx-auto space-y-8">
        ...
        <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <ul className="space-y-2 text-white text-sm">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong className="text-white">Logbooks</strong> must record all tests, faults,
                false alarms, and system changes
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Retention period</strong> is minimum 3 years per BS
                5839-1 for authority inspection
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Entries must be immediate</strong> - made before
                leaving site after any work or test
              </span>
            </li>
          </ul>
        </div>
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10 space-y-3">
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <ul className="space-y-1 text-sm text-white">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Records available for fire authority inspection
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Insurance companies may require access
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Evidence of competent person involvement
                </li>
              </ul>
            </div>
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10 space-y-3">
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <ul className="space-y-1 text-sm text-white">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Installation certificate and design data
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Weekly test records
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Fault and remedial action log
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  False alarm register
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  System modifications record
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10 space-y-3">
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <ul className="space-y-1 text-sm text-white">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Zone or device tested (rotating through all)
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Any faults observed with description
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10 space-y-3">
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <ul className="space-y-1 text-sm text-white">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Exact location (zone, device, address)
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Nature of fault (detailed description)
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10 space-y-3">
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <ul className="space-y-1 text-sm text-white">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Zone and device that activated
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Cause of activation (if known)
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Fire brigade attendance (if applicable)
                </li>
              </ul>
            </div>
            <p className="text-sm text-white italic">
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10 space-y-3">
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <ul className="space-y-1 text-sm text-white">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Comprehensive audit trail of all entries
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Ability to produce printed reports
                </li>
              </ul>
            </div>
            <p className="text-sm text-white italic">
        ...
        <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <div className="p-3 rounded-lg bg-white/5">
            <p className="text-sm text-white">
              ...
              relocation, or type change - all documented with justification.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {[
              {
                q: 'Can I use a spreadsheet as my logbook?',
                a: 'Yes, if it meets security requirements - audit trails, access control, and tamper evidence. A dedicated fire alarm record system is preferable.',
              },
              {
                q: 'Who is responsible for maintaining the logbook?',
                a: 'The responsible person (typically building owner/manager) has overall responsibility, but may delegate entries to trained staff or service engineers.',
              },
              {
                q: 'What if the logbook is lost or destroyed?',
                a: 'Report to the responsible person immediately. Reconstruct what records are possible from service company copies. Implement better security for replacement.',
              },
              {
                q: 'Must service engineers update the logbook?',
                a: 'Yes - service visit details must be entered before leaving site. Engineers should also review the logbook for any reported issues since the last visit.',
              },
              {
                q: 'How detailed should fault descriptions be?',
                a: 'Detailed enough that another engineer could understand the issue without attending site. Include symptoms, location, suspected cause, and actions taken.',
              },
              {
                q: 'Should evacuations during tests be recorded?',
                a: 'Yes - record any evacuation drills conducted, including timing, participation, and any issues identified. This demonstrates emergency procedure compliance.',
              },
            ].map((faq, i) => (
