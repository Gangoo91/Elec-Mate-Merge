    ...
    <HubPage>
      ...
      <HubBody>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              affects maintenance risk; designers must consider maintenance access from the outset.
            </li>
            <li>
            ...
            <li>
              <strong>Practical interpretation</strong> — interface boxes mounted on accessible wall
              surfaces in defined plant rooms / risers / service voids; not buried in ceiling voids
              without access hatches; not behind permanent finishes; not inside live switchgear
              cabinets.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              Therefore, as a common example, this might preclude the siting of the interface within
              an enclosure provided for other equipment, as access might not be possible without the
              need for attendance by other parties or might involve removing power to the other
              equipment.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            <text x="440" y="28" textAnchor="middle" fill="#FBBF24" fontSize="14" fontWeight="bold">
            ...
            <rect
              ...
              strokeWidth="2"
            />
            <text x="440" y="92" textAnchor="middle" fill="#FBBF24" fontSize="13" fontWeight="bold">
              CIE
            </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              This is the architectural property: no separate signal needed. A fire that damages the
              supply causes the door to close.
            </li>
            <li>
              <strong>Monitored output</strong> — the fire alarm CIE provides a monitored interface
              output that drops the magnet supply on fire alarm. Continuous monitoring detects cable
              faults; at fire-alarm time the monitored output drops the supply intentionally.
            </li>
            <li>
              <strong>Coordination with door hardware</strong> — the door must have a self-closer
              strong enough to overcome any swelling / friction. The magnet must be powerful enough
              to hold the door open in normal conditions but weaker than the self-closer under
              release.
            </li>
            <li>
              <strong>Manual release</strong> — door holders typically include a local manual
              release button to allow the door to be closed without triggering the fire alarm (e.g.
              for fire drills, security checks).
            </li>
          </ul>
          <p>
            Door holders are widely used in commercial buildings, hospitals, schools, and wherever
            free passage is needed during normal operation but compartmentation must be restored on
            alarm. The cause-and-effect matrix records the release trigger.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            safety). The two systems are commissioned together and tested together at every service.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Gas isolation valves</strong> — close to remove gas as a fuel source from the
              affected area. Often a building-wide gas valve at the meter; sometimes zone-specific
              valves for laboratories / kitchens.
            </li>
            <li>
              <strong>Fuel shut-offs</strong> — fuel oil pumps, biomass feeds, hydrogen / other fuel
              supply lines. Critical in industrial premises.
            </li>
            <li>
          ...
          <p>
            ...
            interface output is monitored for life-safety reasons. The matrix records the activation
            logic; the commissioning tests verify each interface operates as specified.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              loss. Magnetic locks (maglocks) do this by design — the lock holds when energised and
              releases when de-energised. Electric strikes need to be specified fail-safe-mode (also
              de-energised = released).
            </li>
            <li>
              <strong>Direct power drop OR signalling</strong> — the simplest design is for the fire
              alarm interface to drop the lock supply directly. More sophisticated designs signal
              the access control system, which logs the event and releases the relevant doors.
            </li>
            <li>
              <strong>Independent override</strong> — break-glass green call points adjacent to each
              access-controlled exit door provide manual override. These are NOT fire alarm call
              points; they are escape-door overrides.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Where necessary in order to safeguard the safety of relevant persons in case of fire,
              the responsible person must ensure that emergency routes and exits are kept clear at
              all times and that any door or gate on an escape route can be easily and immediately
              opened by any person who may require to use it in an emergency. Any fire detection and
              fire alarm system or other safety system that is interfaced with door release / access
              control should ensure that locked doors release immediately on the fire alarm signal.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              installations. Fire / fault / isolation status as separate contacts read by the BMS as
              digital inputs.
            </li>
            <li>
              <strong>Serial / network protocol</strong> — BACnet, Modbus, or vendor-proprietary —
              for richer data including zone-level status, device-level addressable information, and
              historical event logs.
            </li>
            <li>
              <strong>Cyber security boundary</strong> (per BS 5839-1:2025 clause 43.4) — the
              interface to BMS / corporate network must not allow the BMS to control the fire alarm.
              Authentication, network segregation, and risk assessment per the 2025 cyber-security
              clause apply.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              cause-and-effect matrix specifies which message zones activate on which causes. Phased
              evacuation in a tall building uses voice alarm extensively because spoken messages can
              give specific instructions per floor.
            </li>
            <li>
              <strong>Message zones</strong> — areas of the building covered by specific loudspeaker
              groups. Often align with fire detection zones; not always (a single voice alarm zone
              may cover several detection zones).
            </li>
            <li>
              <strong>Pre-recorded vs live</strong> — pre-recorded messages for standard evacuation;
              live announcements via microphone for staff use during managed response.
            </li>
            <li>
              <strong>Audibility and intelligibility</strong> — voice alarm must be loud enough AND
              clear enough. Speech transmission index (STI) is the metric; specific values per BS
              5839-8.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>The refuge</strong> — a fire-resisting protected space within or adjacent to a
              stairway / escape route. Equipped with an evacuation chair, the EVC handset, and
            ...
            <li>
              ...
              handset / panel; a control point (fire warden station / reception) has a master panel
              that takes calls from any active refuge handset. BS 8893 specifies the technical
              requirements.
            </li>
            <li>
              <strong>Fire alarm interface</strong> — the fire alarm CIE signals fire status to the
              EVC system. The EVC system may automatically switch to a "fire" state where it
            ...
            <li>
              ...
              evacuation lifts are managed in coordination with the fire alarm and the EVC. They are
              dispatched to refuges to evacuate occupants who cannot use stairs.
            </li>
          </ul>
          <p>
            The 2025 normative reference to BS 8893 signals the maturity of EVC systems as standard
            life-safety infrastructure. Designers of new buildings (and refurbishments of existing
            ones) increasingly include EVC as part of an inclusive evacuation strategy.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              added to the normative references in BS 5839-1:2025. EVC systems are a normal
              expectation in fire detection and fire alarm system design where disabled refuges are
              provided per the Equality Act 2010 and Approved Document M of the Building
              Regulations.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Sounder circuits</strong> — always monitored. A failed sounder cable means an
              audible alarm not heard.
            </li>
            <li>
            ...
            <li>
              <strong>Service / maintenance signals</strong> — may be unmonitored. Engineering test
              outputs, indication-only signals.
            </li>
          </ul>
          <p>
            The design specifies monitored vs unmonitored per output. The CIE configuration matches.
            Commissioning verifies the monitoring is operational. The 6-monthly service tests cable
            monitoring by introducing controlled faults at the interface and observing the CIE
            response.
          </p>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            ...
            {
              question: 'On a fire alarm, do firefighting lifts get recalled with passenger lifts?',
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-3/section-5')}
