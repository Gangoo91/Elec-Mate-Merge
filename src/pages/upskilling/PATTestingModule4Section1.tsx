    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The first electrical test in the PAT sequence. Three methods, one acceptance rule, and the
          lead-resistance step that catches half the false fails.
        </p>
        ...
        >
          ...
          <p>
            ...
            installation: continuity of every protective conductor by measurement of resistance. PAT
            picks up the same principle on the appliance side. Different acceptance value, same
            principle, same instrument category.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            square-within-a-square symbol (▢) marks Class II; if you see it, do not connect an earth
            continuity test — the equipment is built to dispense with the protective conductor and
            an open-circuit reading is the correct outcome. Document &ldquo;Class II — earth
            continuity not applicable&rdquo; and move to insulation resistance / live-side leakage
            tests as appropriate.
          </p>
          <p>
            Class I equipment is the typical workshop, kitchen and office Class I cohort: kettles,
            toasters, desktop PCs, photocopiers, vacuum cleaners, power tools with a metal body, fan
            heaters with a metal casing. The plug has three pins, the flex has a green/yellow, and
            somewhere inside the appliance the green/yellow is bonded to every accessible metal
            part. The earth continuity test verifies that bond is intact end-to-end.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            that could be damaged or stressed by a 25 A current flowing down the earth path. Modern
            IT equipment frequently bonds the chassis earth to PCB ground planes via EMC capacitors
            and filtering networks; a 25 A pulse can punch through those parts. The soft test avoids
            that risk while still confirming a real low-resistance earth connection.
          </p>
          <p>
            Acceptance is unchanged: ≤ 0.1 Ω + the resistance of the supply cable. The soft test
            produces the same numeric result as the hard test on a healthy appliance — what differs
            is the diagnostic confidence. A loose joint that carries 100 mA without arcing may still
            arc at 25 A, which is why the soft test is sometimes paired with a visual inspection or
            a load test for very critical kit. For ordinary office and IT use, the soft test alone
            is the IET CoP recommendation.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            instrument; testers that offer 25 A also typically offer the soft test as a menu option,
            so the right test is a button choice, not a separate instrument.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            IET CoP names this as the third valid current option. The argument is that an earth path
            which can carry 1.5× the appliance's rated current proves it can handle a realistic
            short-circuit fault while still being a measured, controlled test. It avoids both the
            under-testing risk of 100 mA on a heavy appliance and the over-stress risk of 25 A on
            smaller equipment.
          </p>
          <p>
            In practice most testers default to either the soft test or 25 A and the 1.5× option is
            configured manually where appropriate. The acceptance criterion does not change — the
            same 0.1 Ω + cable-resistance rule applies regardless of which test current is used. The
            choice is about diagnostic confidence, not about the threshold.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              choice of test current shall take account of the construction of the equipment and the
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="150" y="84" textAnchor="middle" fill="#FBBF24" fontSize="13" fontWeight="bold">
              PAT TESTER
            </text>
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="108" y="206" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              MAINS OUT
            </text>
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="194" y="206" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              E PROBE
            </text>
            ...
            <text x="327" y="238" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              L
            </text>
            <text x="349" y="238" textAnchor="middle" fill="#3B82F6" fontSize="9" fontWeight="bold">
              N
            </text>
            <text x="371" y="238" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              E
            </text>
            ...
            <path
              ...
              strokeDasharray="6,3"
            />
            <text x="430" y="268" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
        ...
        >
          <p>
            The 0.1 Ω part is fixed. The cable contribution scales with the flex. For a typical 1.0
            mm² flex at room temperature, conductor resistance is approximately 18 mΩ/m. A 1.5 m
            kettle lead therefore adds about 27 mΩ; the total acceptance is around 0.13 Ω. For a
          ...
          <p>
            Modern PAT testers handle the calculation automatically once the flex csa and length are
            entered as part of the appliance record. The tester applies the rule, displays pass /
            fail against the calculated limit, and stores the result. The role of the tester is to
            enforce a per-appliance acceptance value, not a flat 1.0 Ω limit — that flat limit dates
            from older equipment and is not what IET CoP says.
          </p>
        </ConceptBlock>
          ...
          whatToDo={
            <>
              ...
              <span className="block">
                ...
                the plug terminals (earth pin and the cordgrip earth tail), the reel's slip ring or
                terminal block, and the socket-end earth contacts.
              </span>
              <span className="block">
                If a single termination is loose or a contact is corroded, tightening / cleaning may
                drop the reading by 0.05–0.10 Ω. Re-test and record. If everything is sound and the
                reading is still on the limit, the reel is at its end-of-life threshold and should
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              Visual / preliminary inspection first (covered in M3.1). A failure on visual stops the
              test sequence. Damaged flex, cracked plug, missing earth pin — fail and remove from
              service before any electrical test.
            </li>
            <li>
              Confirm appliance is Class I (rating plate, no Class II symbol). Class II → skip earth
              continuity; record &ldquo;N/A — Class II&rdquo;.
            </li>
            <li>
              Null the test leads. Short the test probes to each other (or to the supplied null
              lead) and press the zero button. Record the lead resistance value if your tester does
              not auto-null.
            </li>
            <li>
            ...
            <li>
              Record the numeric result against the appliance ID. If fail or borderline, investigate
              the cause before retesting (loose terminal, corroded bond, painted earth screw); do
              not simply retest hoping for a different number.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            earth continuity is the prerequisite for safely doing the IR test (M4.2) and the leakage
            / touch-current tests (M4.4). If earth continuity fails, the appliance is removed from
            service — there is no point running further tests on a defective protective path.
          </p>
          <p>
            The reading itself feeds nothing downstream — unlike R1+R2 in the fixed installation
            (which feeds Zs verification), the earth continuity reading on a portable appliance has
            no further downstream calculation. It is recorded against the appliance ID with a
            pass/fail annotation and a numeric value to two decimal places in ohms. Trend analysis
            over multiple test cycles is the secondary value: an appliance whose reading rises from
            0.08 Ω to 0.11 Ω over three cycles is degrading, even if all three readings pass the
        ...
        <RegsCallout
          ...
          clause={
            <>
              The continuity of every protective conductor of every circuit, and in the case of ring
              final circuits, every live conductor, shall be verified by a measurement of
              resistance.
            </>
          }
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Acceptance value:</strong> the calculated limit derived from cable length and
              csa (e.g. &ldquo;limit 0.13 Ω for 1.5 m × 1.0 mm² flex&rdquo;). The appliance record
              needs both the reading and what it was compared against.
            </li>
            <li>
              <strong>Test current option:</strong> 100 mA / 1.5× rated / 25 A. Same appliance
              tested at different currents on different cycles can give slightly different readings
              — recording the test option keeps the trend honest.
            </li>
            <li>
