...
const inlineChecks = [
  {
    ...
    question: 'Building Regulations Part P (England) governs what?',
    options: [
  ...
  {
    id: 'm1s7-part-s',
    question: 'Building Regulations Part S (England), effective 2022, requires what?',
    options: [
  ...
  },
  {
    ...
    question: 'For LCT work in Scotland and Northern Ireland, which framework applies?',
    options: [
...
const faqs = [
  ...
  {
    question: 'What counts as "notifiable" electrical work in dwellings under Part P?',
    answer:
  ...
  {
    question: "How do I tell whether a customer's LCT install needs planning permission?",
    answer:
  ...
  {
    question: "What's the relationship between Building Control notification and CPS notification?",
    answer:
  ...
  {
    question: "What's the impact of Building Regulations Part B (fire safety) on a BESS install?",
    answer:
  ...
  {
    question: 'Where does Approved Document Q (security) fit in?',
    answer:
...
export default function RenewableEnergyModule1Section7() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 7 · BS 7671:2018+A4:2026"
        title="Building Regulations Part L, Part P & Building Control for LCT"
        backTo="../renewable-energy-module-1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Where the Building Regulations bite on LCT installs — Part L energy efficiency (and the
          Future Homes Standard), Part P electrical safety in dwellings, Part S EV infrastructure,
          plus the Scottish, Welsh and Northern Irish equivalents.
        </p>
        ...
        <Pullquote>
          Part P is the safety route. Part L is the efficiency route. Part S is the EV route.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Part P</strong> — Electrical safety in dwellings.
              Notifiable work either CPS self-certified or Building Control notified.
            </li>
            <li>
              <strong className="text-white">Part L</strong> — Energy efficiency. L1A (new
              dwellings), L1B (existing dwellings), L2A (new non-domestic), L2B (existing
              non-domestic). The Future Homes Standard from 2025 tightens Part L1A substantially.
            </li>
            <li>
              <strong className="text-white">Part S</strong> — EV chargepoint provision in new
              dwellings and non-domestic buildings (effective June 2022).
            </li>
            <li>
              <strong className="text-white">Part F</strong> — Ventilation. Heat pump installs in
              well-sealed properties can shift the ventilation balance and trigger Part F
              considerations.
            </li>
            <li>
              <strong className="text-white">Part B</strong> — Fire safety. Particularly relevant
              where BESS is paired (siting, compartmentation, escape route preservation).
            </li>
            <li>
              <strong className="text-white">Part Q</strong> — Security in dwellings. Rarely the
              primary regulation but engaged where the LCT install requires modifications to
              security features.
            </li>
          </ul>
          <p>
            Wales has its own equivalents of these Approved Documents — typically similar in scope
            but distinct in detail. Scotland and Northern Ireland use different regulatory
            frameworks entirely.
          </p>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Part P notification — the CPS route vs the Building Control route
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">CPS self-certification</strong> — installer completes
              the work, notifies the CPS scheme (NICEIC, NAPIT, ELECSA, Stroma) within 30 days,
              scheme notifies Building Control on the installer\'s behalf, customer receives a
              Building Regulations compliance certificate within weeks.
            </li>
            <li>
              <strong className="text-white">Building Control notification</strong> — installer
              notifies Building Control before commencement, pays an inspection fee (typically
              £100–£300), Building Control inspects during or after the work, Building Control
              issues a completion certificate.
            </li>
          </ul>
          <p>
            For a CPS-registered LCT installer, the self-certification route is materially cheaper
            and faster:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
          ...
          <p>
            The Building Control route is the non-CPS installer\'s only lawful route on notifiable
            work. The Building Control fee plus the inspection time cost typically exceeds the
            annual CPS membership fee within 5–10 notifiable jobs — meaning CPS membership pays for
            itself for any installer doing routine LCT work.
          </p>
        </ConceptBlock>
        ...
        >
          <p>Part L covers energy efficiency in buildings. The four documents:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Part L1A</strong> — Conservation of fuel and power in
              new dwellings
            </li>
            <li>
              <strong className="text-white">Part L1B</strong> — Conservation of fuel and power in
              existing dwellings (the retrofit framework)
            </li>
            <li>
              <strong className="text-white">Part L2A</strong> — Conservation of fuel and power in
              new non-domestic buildings
            </li>
            <li>
              <strong className="text-white">Part L2B</strong> — Conservation of fuel and power in
              existing non-domestic buildings
            </li>
          </ul>
          <p>
            The Future Homes Standard takes effect in England from 2025. The target is a 75–80%
            reduction in CO₂ emissions from new dwellings vs 2013 standards. Practical compliance
            routes:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              Improved building services (mechanical ventilation with heat recovery, where
              applicable)
            </li>
          ...
          <p>
            For the LCT installer, the Future Homes Standard is the regulatory driver behind the
            heat pump demand projections. The MIS 3003 investment is a market-access requirement for
            the new-build heating market from 2025 onwards.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">New dwellings with parking</strong> — must have an EV
              chargepoint, or where impractical, cable provision for a future chargepoint
            </li>
            <li>
              <strong className="text-white">New non-domestic buildings with parking</strong> —
              specified proportions of parking spaces with chargepoints, depending on building type
              and number of spaces
            </li>
            <li>
              <strong className="text-white">Major renovations</strong> — may trigger Part S
              requirements where the renovation affects the parking provision or the electrical
              infrastructure
            </li>
          </ul>
          <p>
            The chargepoint must meet BS 7671 Section 722 (including A4:2026\'s 722.411.4.1
            PEN-fault protective measure on PME supplies) and the manufacturer\'s installation
            instructions. The cert evidence bundle is standard — EIC, MCS where applicable, DNO
            notification.
          </p>
          <p>
            For the LCT installer, Part S creates two distinct customer-acquisition patterns.
            Retrofit chargepoints sold direct to end customers (the traditional market). New-build
            chargepoints sold via housebuilder relationships (the Part S-driven market). The two
            markets have different economics — new-build is higher-volume, lower-margin,
            longer-relationship; retrofit is lower-volume, higher-margin, transaction-based.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">England</strong> — Building Regulations 2010 with
              Approved Documents P, L (L1A/L1B/L2A/L2B), S, F, B, Q. Future Homes Standard effective
              2025.
            </li>
            <li>
              <strong className="text-white">Wales</strong> — Own Approved Documents similar in
              scope to English ADs. Welsh Part P is the parallel to English Part P. CPS schemes
              operate in Wales the same way.
            </li>
            <li>
              <strong className="text-white">Scotland</strong> — Building (Scotland) Regulations
              2004 with the Technical Handbooks. Section 4 (safety, including Standard 4.5
              electrical safety) is the Part P parallel. Section 6 (energy) is the Part L parallel.
              Notification via local authority Building Standards.
            </li>
            <li>
              <strong className="text-white">Northern Ireland</strong> — Building Regulations (NI)
              2012 with Technical Booklets. Technical Booklet E (electrical) is the Part P parallel.
              Notification via District Council Building Control. Electricity at Work Regulations
              (NI) 1991 replaces EAWR 1989.
            </li>
          </ul>
          <p>The funding mechanisms also differ by nation:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">England and Wales</strong> — Boiler Upgrade Scheme,
              SEG, ECO4 / GBIS
            </li>
            <li>
              <strong className="text-white">Scotland</strong> — Home Energy Scotland grants and
              loans, SEG
            </li>
            <li>
              <strong className="text-white">Northern Ireland</strong> — NI Energy Strategy grants,
              SEG-equivalent arrangements
            </li>
          </ul>
          <p>
            MCS is the UK-wide scheme — the installer competence layer travels across the four
            nations. The Building Regulations and the funding mechanisms are the nation-specific
            layers.
          </p>
        </ConceptBlock>
        ...
        <Pullquote>
          Planning is a survey-stage conversation, not an install-stage discovery.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Rooftop PV</strong> — PD subject to size limits and the
              array not protruding above the roof ridge
            </li>
            <li>
              <strong className="text-white">Heat pump outdoor unit</strong> — PD subject to size,
              siting and noise limits (the MIS 3003 noise calculation is the operational reference)
            </li>
            <li>
              <strong className="text-white">EV chargepoint</strong> — PD in most cases for domestic
              chargepoints
            </li>
            <li>
              <strong className="text-white">Domestic BESS</strong> — generally PD when installed in
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              ...
              public-realm installs (PV on a road-facing roof slope, externally mounted heat pump
              units, externally visible EV chargepoints) may lose PD rights
            </li>
            <li>
              <strong className="text-white">Listed buildings</strong> — listed-building consent
              typically required for external alterations regardless of PD status
            </li>
            <li>
              <strong className="text-white">Article 4 Directions</strong> — local planning
              authority restrictions that further constrain PD rights in specified areas
            </li>
            <li>
              <strong className="text-white">Flats and maisonettes</strong> — more restrictive PD
              framework; freeholder consent typically required
            </li>
          </ul>
          <p>
            The survey captures the property designation in writing. The planning conversation
            precedes the install quote. Where planning permission or listed-building consent is
            required, the timeline becomes part of the project plan.
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-1-section-6')}
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-1-section-8')}
