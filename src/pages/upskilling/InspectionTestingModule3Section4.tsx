    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reg 415.2 sets a measurable acceptance criterion — R ≤ 50/Ia — and Reg 701.415.2 carves
          out the bathroom omission rule. This section is how you verify the bond, judge the
          reading, and code the result.
        </p>
        ...
        >
          <p>
            Reg 415.2.1 is the duty-stating regulation. It tells you what is in the bonding net. The
            wording &ldquo;simultaneously accessible&rdquo; is the boundary: parts you cannot touch
            at the same time are out of scope. The 2.50 m horizontal-reach yardstick from Reg
            417.3.1 is a useful default — anything within that distance of an
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              including where practicable the main metallic reinforcement of constructional
              reinforced concrete. The supplementary protective equipotential bonding system shall
              be connected to the protective conductors of all equipment including those of
              socket-outlets.
            </>
          }
        ...
        >
          <p>
            The derivation is direct: under fault conditions a current Ia flows through the bonding
            resistance R, lifting the touch voltage by (R × Ia) volts. To keep the touch voltage at
            or below the conventional 50 V limit, R must satisfy R ≤ 50/Ia. The criterion is always
            tighter for an overcurrent device than for an RCD, because the overcurrent
            device&rsquo;s 5 s operating current is much higher than 30 mA. A radial protected by a
            32 A B-curve MCB has Ia ≈ 160 A and an R limit of 0.31 Ω. The same bond on a 30 mA RCD
            has Ia = 0.030 A and R limit of 1666 Ω — which is why we never argue acceptance from the
            RCD alone.
          </p>
          <p>
          ...
          <p>
            Memorise the order of magnitude: a domestic 32 A B-curve gives roughly a 0.30 Ω ceiling.
            Any bond reading materially above that, on that circuit, fails Reg 415.2.2 regardless of
            how good the joint looks.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              <br />
              where Ia is the operating current in amperes (A) of the protective device or: (a) for
              RCDs, IΔn; (b) for overcurrent devices, the 5 s operating current.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              shall be established connecting together the terminals of the protective conductor of
              each circuit supplying Class I and Class II equipment to the accessible
              extraneous-conductive-parts, within a room containing a bath or shower, including:
              metallic pipes supplying services and metallic waste pipes (for example, water, gas);
              metallic central heating pipes and air conditioning systems; accessible metallic
              ...
              protective equipotential bonding may be omitted where all of the following conditions
              are met: (d) all final circuits of the location comply with the requirements for
              automatic disconnection according to Regulation 411.3.2; (e) all final circuits of the
              location have additional protection by means of an RCD in accordance with Regulation
              415.1.1; (f) all extraneous-conductive-parts of the location are effectively connected
              to the protective equipotential bonding according to Regulation 411.3.1.2.
            </>
          }
        ...
        >
          <p>
            ...
            Condition (e) is verified by inspecting the protective device on every circuit entering
            the location and confirming additional protection by an RCD with IΔn ≤ 30 mA. Condition
            (f) is verified by main protective bonding inspection and continuity test back to the
            MET — and by establishing the resistance-to-MET of the extraneous-conductive-part.
          </p>
          <p>
            The note appended to Reg 701.415.2 is important: &ldquo;The effectiveness of the
            connection of extraneous-conductive-parts in the location to the main earthing terminal
            may be assessed, where necessary, by the application of Regulation 415.2.2.&rdquo; In
            other words, the same R ≤ 50/Ia formula is used to judge whether the
            extraneous-conductive-part is effectively bonded — it is not a different criterion for
            the omission case.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            />
            <text x="400" y="80" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Presence.</strong> Each simultaneously accessible exposed-conductive-part and
              extraneous-conductive-part is in the bonding network. Pipes, radiators, structural
              metalwork — eyes-on each one.
            </li>
            <li>
              <strong>Route.</strong> The bonding conductor follows a sensible, accessible route.
              Loops back through inaccessible voids are flagged because they cannot be re-tested in
              the future.
            </li>
            <li>
              <strong>CSA.</strong> The conductor cross-section satisfies Reg 544.2.1 (sheathed) or
              Reg 544.2.2 (unsheathed, 4 mm² minimum). 2.5 mm² unsheathed is a defect.
            </li>
            <li>
              <strong>Mechanical protection.</strong> Where the conductor is in a position liable to
              mechanical damage and is not 4 mm², it shall be sheathed or otherwise protected — Reg
              544.2 series.
            </li>
            <li>
              <strong>Termination quality.</strong> Earth clamps to BS 951 on round pipework, clean
              metal under the clamp, no paint or insulation lacquer, and the warning label
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Repeat for every pair of simultaneously accessible parts in scope. The bond passes if
              every pair-wise reading satisfies R ≤ 50/Ia for the worst-case Ia in the path.
            </li>
          </ol>
          <p>
            GN3 Ch 5 (special locations) frames the supplementary bonding test exactly this way: an
            inspection AND a low-resistance continuity measurement, with acceptance referred to Reg
            415.2.2. Either activity alone is insufficient — a present bond can fail electrically; a
            passing reading does not prove correct CSA or mechanical protection.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              50 V given conventional human body impedance assumptions. Bonding is not required and
              may even be actively unhelpful — bonding such a part connects an otherwise isolated
              piece of metal into the bonding network, importing potential rather than equalising
              it.
            </li>
            <li>
          ...
          <p>
            ...
            plastic pipework, modern stainless steel sinks with composite waste pipes, and suspended
            metal ceiling grids. The test answers the question definitively per part, per location.
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong className="text-red-300">C1 — Danger present.</strong> A supplementary bonding
              conductor is acting as a current-carrying conductor (e.g. a broken neutral returning
              via the bonding network) → danger present, immediate action.
            </li>
            <li>
            ...
            <li>
              <strong className="text-amber-300">C3 — Improvement recommended.</strong> Bond exists,
              terminates correctly, passes R ≤ 50/Ia, but lacks the BS 951 warning label (Reg
              514.13.1) or is run in a way that complicates future testing without creating
              immediate risk.
            </li>
            <li>
