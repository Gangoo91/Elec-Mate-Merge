...
const DESCRIPTION =
  'Learn supplementary bonding requirements, testing methods, and compliance verification for special locations.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Supplementary bonding creates a local equipotential zone by connecting all simultaneously accessible conductive parts, reducing touch voltage during faults.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'R ≤ 50V ÷ 0.03A = 1667Ω. This is the calculated maximum, though good connections will measure much lower.',
  },
  {
    id: 'supp-bonding-size',
    question:
      'What minimum conductor size is required for supplementary bonding if mechanically protected?',
    options: ['1.5mm²', '2.5mm²', '4mm²', '6mm²'],
    correctIndex: 1,
    explanation:
      'Per BS 7671 Table 54.8, minimum 2.5mm² if mechanically protected, 4mm² if not mechanically protected.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'The resistance must satisfy R ≤ 50V ÷ Ia, where Ia is the operating current of the protective device (typically RCD trip current).',
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      'R ≤ 50V ÷ 0.03A = 1667Ω. However, practical connections should be much lower than this maximum.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Plastic pipes are not extraneous-conductive-parts and do not require bonding. Only metallic parts that could introduce a potential need bonding.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Regulation 701.415.2 permits omission if automatic disconnection requirements are met, all circuits have ≤30mA RCD protection, and main protective bonding is effective.',
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation:
      'A low-resistance ohmmeter measures the small resistances in bonding conductors, typically giving readings in milliohms.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Simultaneously accessible means parts that could be touched at the same time, creating a potential shock hazard if at different potentials.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'The supplementary bonding conductor must be not less than half the CPC, with an absolute minimum of 2.5mm² (protected) or 4mm² (unprotected).',
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      'Soldered connections are not acceptable for protective bonding as the solder could melt under fault conditions, compromising the protective connection.',
  },
  {
    id: 10,
    ...
    correctAnswer: 0,
    explanation:
      'While the formula allows up to 1667Ω for a 30mA RCD, practical bonding connections should be <1Ω, indicating sound metallic connections throughout.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Required in special locations like bathrooms (zones 1-3), swimming pools, saunas, and any location where BS 7671 specifies increased shock risk protection. Also needed where automatic disconnection times cannot be achieved.',
  },
  {
    question: 'What parts need supplementary bonding in a bathroom?',
    answer:
      'All accessible extraneous-conductive-parts: metallic pipes (hot/cold water, gas), radiators, metal baths, exposed metallic structural parts, and any Class I equipment. CPCs of circuits serving the location must also be included.',
  },
  {
    question: 'What resistance value indicates compliance?',
    answer:
      'The resistance between any two simultaneously accessible parts must satisfy: R ≤ 50V ÷ Ia. For a 30mA RCD, this gives R ≤ 50/0.03 = 1667Ω. In practice, much lower values (typically <1Ω) indicate good connections.',
  },
  {
    question: 'Can supplementary bonding be omitted from bathrooms?',
    answer:
      'Yes, under Regulation 701.415.2, supplementary bonding can be omitted if: (a) all circuits comply with automatic disconnection requirements, (b) all circuits are RCD-protected at ≤30mA, and (c) all extraneous-conductive-parts are effectively connected to the protective equipotential bonding.',
  },
  {
    question: 'How do you test supplementary bonding?',
    answer:
      'Use a low-resistance ohmmeter. Connect between the CPC at the local distribution point and each extraneous-conductive-part requiring bonding. Also test between simultaneously accessible parts. Resistance should be very low (<1Ω typically).',
  },
  {
    question: 'What size conductor is required for supplementary bonding?',
    answer:
      'Per BS 7671 Table 54.8: minimum 2.5mm² if mechanically protected, 4mm² if not. The CSA must be not less than half the CPC of the circuit, with a minimum of 2.5mm².',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Purpose:</strong> Local equipotential zone in special locations
              </li>
              <li>
                <strong>Formula:</strong> R ≤ 50V ÷ Ia (device operating current)
              </li>
              <li>
                <strong>30mA RCD:</strong> Max 1667Ω, practical {'<'}1Ω
              </li>
              <li>
                <strong>Minimum:</strong> 2.5mm² protected, 4mm² unprotected
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Missing bonding in bathrooms, broken connections
              </li>
              <li>
                <strong>Use:</strong> Low-resistance ohmmeter between bonded parts
              </li>
              <li>
                <strong>Apply:</strong> Bathrooms, pools, saunas, special locations
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              <strong>Supplementary bonding</strong> is an additional protective measure that
              connects all simultaneously accessible exposed-conductive-parts and
              extraneous-conductive-parts within a specific location. It creates a local
              equipotential zone to reduce touch voltage during faults.
            </p>

            <div className="my-6 p-4 rounded-lg bg-blue-500/10">
              <p className="text-sm font-medium text-blue-400 mb-2">
                Key Difference from Main Bonding
              </p>
              <p className="text-sm text-white">
                Main protective bonding connects at the origin of the installation; supplementary
                bonding provides additional local protection in high-risk areas like bathrooms and
                swimming pools.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BS 7671 requires supplementary bonding in <strong>special locations</strong> where
              there is increased shock risk:
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Special Locations Requiring Supplementary Bonding:
              </p>
            ...
            <p className="text-sm text-amber-400/80 italic">
              <strong>Also required:</strong> Where automatic disconnection times cannot be met, or
              where touch voltage limits require additional protection.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>1. Isolate:</strong> Isolate the installation safely
                </li>
                <li>
                  <strong>2. Instrument:</strong> Use a low-resistance ohmmeter (not an insulation
                  tester)
                </li>
                <li>
                  <strong>3. CPC Test:</strong> Connect between the CPC at the local distribution
                  point and each bonded part
                </li>
                <li>
                  <strong>4. Cross Test:</strong> Also test between simultaneously accessible parts
                </li>
                <li>
                  <strong>5. Record:</strong> Record all readings - should be {'<'}1Ω typically
                </li>
                <li>
                  <strong>6. Verify:</strong> Verify calculation: R ≤ 50V ÷ Ia
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              <strong>Regulation 701.415.2</strong> permits omission of supplementary bonding in
              bathrooms when ALL conditions are met:
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5">
              ...
              <p className="text-sm text-white">
                Even when omitted, you must verify main bonding is effective and document your
                reasoning on the certificate.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                ...
                <li>
                  Check for plastic inserts in modern plumbing - don't assume metal pipes are
                  continuous
                </li>
                <li>Test continuity even if bonding appears to be in place</li>
                <li>
                  Apply "SAFETY ELECTRICAL CONNECTION - DO NOT REMOVE" labels to all bonding
                  connections
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Using soldered connections</strong> - may melt under fault conditions
                </li>
                <li>
                  <strong>Forgetting CPCs</strong> - circuits in the location need including
                </li>
                <li>
                  <strong>Assuming plastic is throughout</strong> - check for metal sections
                </li>
                <li>
                  <strong>Missing accessible parts</strong> - check under baths, behind panels
                </li>
                <li>
                  <strong>Not documenting omission reasoning</strong> - must record why omitted
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>BS 7671:</strong> Section 415 - Additional protection by supplementary
                  bonding
                </li>
                <li>
                  <strong>Regulation 701.415:</strong> Bathrooms supplementary bonding
                </li>
                <li>
                  <strong>Table 54.8:</strong> Minimum protective conductor sizes
                </li>
                <li>
                  <strong>GN3:</strong> Supplementary bonding testing guidance
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="mt-6 p-5 rounded-lg bg-transparent">
            <h3 className="text-sm font-medium text-white mb-4">
              Supplementary Bonding Quick Reference
            </h3>
