...
const inlineChecks = [
  {
    ...
    question: 'What does MPPT (Maximum Power Point Tracking) do?',
    options: [
  ...
  },
  {
    ...
    question: 'On a PV module I-V curve, where is the Maximum Power Point (MPP)?',
    options: [
  ...
  {
    id: 'm2s4-mpp-shifts',
    question: 'What causes the MPP to move during a day?',
    options: [
  ...
  {
    id: 'm2s4-multi-mppt',
    question: 'Why do modern residential hybrid inverters typically have 2 or 3 MPPT inputs?',
    options: [
...
const faqs = [
  {
    question: 'How does the inverter actually adjust the PV string operating voltage?',
    answer:
  ...
  {
    question: 'How fast does MPPT actually update?',
    answer:
  ...
  {
    question: 'Do MPPT efficiencies on inverter datasheets matter?',
    answer:
  ...
  {
    question: 'Why does the MPPT range matter when selecting an inverter?',
    answer:
  ...
  {
    question: 'Can MPPT track multiple MPPs (e.g. under partial shading)?',
    answer:
  ...
  {
    question: 'Does MPPT change anything for the cert evidence bundle or the BS 7671 design?',
    answer:
  ...
  {
    question: 'Will adding a power optimiser to one module in a string improve the rest?',
    answer:
  ...
  {
    question: 'What MPPT specifications matter most when comparing inverters?',
    answer:
...
export default function RenewableEnergyModule2Section4() {
  ...
  useSEO({
    title: 'MPPT — Maximum Power Point Tracking | Renewable Energy 2.4 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 4 · BS 7671:2018+A4:2026"
        title="MPPT — Maximum Power Point Tracking"
        backTo="../renewable-energy-module-2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The algorithm that continuously adjusts PV string voltage to operate at maximum power. I-V
          and P-V curves, perturb-and-observe vs incremental conductance, multi-MPPT inverter
          architecture, and MPPT range matching.
        </p>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">
                Sits at the &ldquo;knee&rdquo; of the I-V curve
              </strong>{' '}
              — where the curve transitions from current-source behaviour (near I_sc) to
              voltage-source behaviour (near V_oc)
            </li>
            <li>
              <strong className="text-white">Voltage at MPP: V_mp</strong> — typically ~80% of V_oc
              for crystalline silicon (e.g. 33.3 V for a module with 41.6 V V_oc)
            </li>
            <li>
              <strong className="text-white">Current at MPP: I_mp</strong> — typically ~92–96% of
              I_sc (e.g. 11.8 A for a module with 12.5 A I_sc). I_mp is always strictly less than
              I_sc on a real I-V curve — the MPP sits below I_sc on the current axis
            </li>
            <li>
              <strong className="text-white">Power at MPP: P_max = V_mp × I_mp</strong> — this is
              the module\'s nameplate power at STC
            </li>
          </ul>
          <p>How conditions change the MPP:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Irradiance changes</strong> — scale I_sc roughly
              linearly. Brighter sun, higher I_sc, higher MPP power, V_mp changes only slightly
            </li>
            <li>
              <strong className="text-white">Temperature changes</strong> — shift V_oc and V_mp via
              the temperature coefficient. Hot cells, lower V_oc and V_mp; cold cells, higher V_oc
              and V_mp
            </li>
            <li>
              <strong className="text-white">Partial shading</strong> — bypass diodes engage on
              shaded sub-strings, creating multiple local MPPs on the P-V curve. The MPPT must find
              the global maximum
            </li>
            <li>
              <strong className="text-white">Module degradation</strong> — gradual long-term shift;
              MPPT tracks it without issue
            </li>
          </ul>
          <p>
            The MPPT algorithm runs in the inverter (for grid-tied PV) or the charge controller (for
            off-grid PV with batteries). It commands the DC-DC converter stage in the inverter to
            vary the PV string operating voltage, measures the resulting power, and adjusts to find
            or maintain V_mp.
          </p>
        </ConceptBlock>
        ...
        <VideoCard
          url="https://www.youtube.com/watch?v=BJpCWKgW8Ac"
          title="How an MPPT Solar Charge Controller Works"
          channel="The Engineering Mindset"
          topic="Maximum power point tracking — how the controller keeps the panel at its MPP across changing irradiance and temperature."
        />
        ...
        <Pullquote>
          Step. Measure. Repeat. The perturb-and-observe algorithm in three words.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Step 1</strong> — Measure current array power P_k at
              operating voltage V_k
            </li>
            <li>
              <strong className="text-white">Step 2</strong> — Perturb V by a small step (typically
              ΔV ≈ 0.5–1 V on a residential inverter)
            </li>
            <li>
              <strong className="text-white">Step 3</strong> — Measure new array power P_(k+1) at
              new operating voltage V_(k+1) = V_k + ΔV
            </li>
            <li>
              <strong className="text-white">Step 4</strong> — Compare. If P_(k+1) &gt; P_k, the
              perturbation moved toward MPP — continue in same direction. If P_(k+1) &lt; P_k,
              reverse direction (next perturbation will be -ΔV)
            </li>
            <li>
              <strong className="text-white">Step 5</strong> — Repeat — the algorithm cycle
              typically runs at 5–10 Hz (100–200 ms per cycle)
            </li>
          </ul>
          <p>Adaptive P&O refinements in modern inverters:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Variable step size</strong> — larger ΔV under
              fast-changing conditions (cloud transitions), smaller ΔV under steady-state — reducing
              oscillation loss
            </li>
            <li>
              <strong className="text-white">Global MPPT scan</strong> — periodic full V_oc-to-V_min
              sweep to find the global MPP under partial shade (where local maxima from
              bypass-diode-isolated sub-strings can trap a simple P&O algorithm)
            </li>
            <li>
              <strong className="text-white">Cloud-detection logic</strong> — distinguish between a
              P&O perturbation effect and a real irradiance change, to avoid mis-tracking during
              cloud transitions
            </li>
          </ul>
          <p>
            Modern P&O implementations achieve &gt; 99% MPPT efficiency under steady-state
            conditions and &gt; 98% under typical UK partial-cloud variability. The remaining 1–2%
            loss is the cost of the algorithm\'s tracking method; a hypothetical perfect-tracking
            algorithm would be the benchmark, never achievable in practice.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">At MPP</strong> — dP/dV = 0 (the slope of the P-V curve
              is zero at the peak)
            </li>
            <li>
              <strong className="text-white">Differentiation</strong> — P = V × I, so dP/dV = I + V
              × dI/dV
            </li>
            <li>
              <strong className="text-white">At MPP</strong> — dP/dV = 0 means I + V × dI/dV = 0,
              which gives dI/dV = -I/V
            </li>
            <li>
              <strong className="text-white">Algorithm</strong> — measure dI and dV between
              consecutive samples, compute the ratio, compare to -I/V. If dI/dV &gt; -I/V, we are
              below MPP voltage — increase V. If dI/dV &lt; -I/V, we are above MPP voltage —
              decrease V. If dI/dV = -I/V (within tolerance), we are at MPP — hold
            </li>
          </ul>
          <p>Comparison with P&O:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Tracking speed</strong> — incremental conductance
              reaches the new MPP in 1 measurement cycle after a step-change in irradiance; P&O
              takes 2–3 cycles
            </li>
            <li>
              <strong className="text-white">Steady-state oscillation</strong> — incremental
              conductance can hold exactly at MPP (no oscillation needed); P&O always oscillates by
              ±ΔV
            </li>
            <li>
              <strong className="text-white">Computation</strong> — incremental conductance requires
              division and derivative calculation; P&O requires only comparison
            </li>
            <li>
              <strong className="text-white">Noise sensitivity</strong> — incremental conductance is
              more sensitive to current and voltage measurement noise (the dI/dV calculation
              amplifies noise)
            </li>
          </ul>
          <p>
            Most residential inverters use enhanced P&O variants for the simpler implementation.
            Some premium inverters use incremental conductance or hybrid algorithms combining both —
            using P&O for steady-state and incremental conductance during rapid changes. For UK
            partial-cloud conditions, the choice rarely makes more than a 1–2% annual yield
        ...
        <Pullquote>
          One MPPT per orientation. One MPPT per shade pattern. One MPPT per design constraint.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Single MPPT</strong> — all strings combine into one
              MPPT input. Viable for single-orientation arrays with matched strings. Common on
              entry-level and lowest-cost inverters.
            </li>
            <li>
              <strong className="text-white">Dual MPPT</strong> — two independent MPPTs, typically
              with one or more parallel strings per MPPT. Standard on modern residential hybrid
              inverters. Handles two-orientation roofs and some partial-shade variation.
            </li>
            <li>
              <strong className="text-white">Triple MPPT</strong> — three independent MPPTs on the
              same inverter. More flexibility for complex roof geometries or premium / commercial
              installs.
            </li>
            <li>
              <strong className="text-white">Six+ MPPTs</strong> — commercial-scale inverters with
              many independent inputs. Each input may host multiple parallel strings, all operating
              at the same MPPT.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">
                Single orientation, single roof pitch, no shade
              </strong>{' '}
              — single MPPT is adequate
            </li>
            <li>
              <strong className="text-white">Two orientations</strong> — dual MPPT eliminates the
              orientation mismatch loss
            </li>
            <li>
              <strong className="text-white">Two orientations + partial shade</strong> — dual MPPT
              plus possible module-level optimisation
            </li>
            <li>
              <strong className="text-white">Three or more orientations</strong> — triple MPPT
              inverter, or module-level optimisation (microinverters / power optimisers)
            </li>
            <li>
              <strong className="text-white">Heavy partial shading on any orientation</strong> —
              module-level optimisation regardless of inverter count
            </li>
          </ul>
          <p>
            The cost differential between single and dual MPPT inverters is typically £150–300 on
            residential pricing. The yield gain from eliminating orientation mismatch on a
            multi-orientation array is typically £100–200 per year. The payback is 1–3 years; the
            25-year value is substantial. Always specify multi-MPPT on multi-orientation installs.
          </p>
        </ConceptBlock>
        ...
        <Pullquote>
          Cold-morning V_oc below absolute max. Hot-day V_mp above MPPT min. Cool V_mp below MPPT
          max.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">
                Rule 1 — Cold-morning V_oc &lt; inverter absolute maximum DC input voltage
              </strong>{' '}
              (with margin). String V_oc rises with falling temperature; cold-morning V_oc can be
              8–15% above STC. Exceeding the inverter limit risks over-voltage damage. Covered in
              Section 2.3.
            </li>
            <li>
              <strong className="text-white">
                Rule 2 — Hot-day V_mp &gt; inverter MPPT minimum voltage
              </strong>
              . String V_mp falls with rising temperature; on a hot UK roof V_mp can drop 8–15%
              below STC. If V_mp falls below MPPT min, the inverter cannot track at MPP and yield
              drops during peak production hours.
            </li>
            <li>
              <strong className="text-white">
                Rule 3 — Cool-condition V_mp &lt; inverter MPPT maximum voltage
              </strong>
              . On cool days V_mp sits closer to its STC value; on long strings this can approach
              the MPPT max. Exceeding MPPT max forces the inverter to operate off-MPP at the upper
              end.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              Module temperature coefficient (V_oc or V_mp coefficient, typically -0.25 to -0.35
              %/°C)
            </li>
            <li>
              Site design temperature (minimum cell temp for Rule 1, maximum cell temp for Rule 2,
              design typical for Rule 3)
            </li>
          ...
          <p>
            Margin: 5–10% headroom on each rule is good practice. The cert evidence bundle records
            each calculation with the inputs used; MCS audit samples the design pack and looks for
            all three calculations completed.
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-2-section-5')}
