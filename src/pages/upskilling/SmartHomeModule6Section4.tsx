...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Many legacy integration methods (especially IR blasters) are one-way communication only. The smart system cannot confirm if the command was received or what the current device state is.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Multiple bridges from different manufacturers add complexity to the system. Each may have its own app, update schedule, and potential for conflicts with other systems or the main hub.',
  },
  {
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Home Assistant can integrate multiple bridges and protocols into a single interface, allowing unified control and automation across devices that would otherwise require separate apps.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Most devices with some form of remote control (IR, RF, wired) can be integrated using appropriate bridges or relays. However, some devices may have limited functionality or one-way control only. Always assess each device individually.',
  },
  {
    question: 'Is it better to replace legacy devices or integrate them?',
    answer:
      'It depends on the device age, functionality, and cost. Integration is often more cost-effective for high-quality devices like audio systems or air conditioning. Replacement may be better for unreliable older devices or where full smart functionality is required.',
  },
  {
    question: 'How do I handle devices that have both IR and app control?',
    answer:
      'Prefer app/cloud integration where available as it usually provides two-way communication and better functionality. Use IR blasters as backup or for functions not available via the app. Document which method is used for each function.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-3xl mx-auto">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white">
                  Understand different methods for integrating legacy devices into smart systems
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
                <span className="text-white">
                  Select appropriate bridging solutions for different device types
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
                <span className="text-white">
                  Identify limitations and workarounds for common integration challenges
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
                <span className="text-white">
                  Document integration methods for customer handover and future maintenance
                </span>
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Bridges are devices that translate between different communication protocols or
              systems, enabling devices that cannot communicate directly to work together in a
              unified smart home.
            </p>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-white text-sm">
                    Translate between Zigbee, Z-Wave, or Thread devices and Wi-Fi/Ethernet networks.
                    Examples: Philips Hue Bridge, IKEA DIRIGERA.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-elec-yellow text-sm">IR/RF Bridges</h4>
                  <p className="text-white text-sm">
                    Convert smart commands to infrared or radio frequency signals for legacy
                    devices. Examples: Broadlink, Logitech Harmony.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-elec-yellow text-sm">API Bridges</h4>
                  <p className="text-white text-sm">
                    Software integrations that connect cloud services or local APIs to smart home
                    platforms. May not require physical hardware.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              IR blasters enable smart control of devices that use infrared remote controls, such as
              TVs, air conditioning units, fans, and audio equipment.
            </p>
            ...
            <div className="bg-elec-gray/30 rounded-lg p-5 border border-white/10">
              ...
              <ul className="space-y-2 text-white">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Line of sight:</strong> IR blaster must have clear line of sight to
                    device
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">-</span>
                  <span>
                    <strong>Range:</strong> Typically 5-10 metres depending on model
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">-</span>
                  <span>
                    <strong>Learning:</strong> Most require learning existing remote codes
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">-</span>
                  <span>
                    <strong>Multiple devices:</strong> One blaster can often control multiple
                    devices
                  </span>
                </li>
              </ul>
            ...
            <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4">
              <p className="text-white">
                <strong>Limitation:</strong> IR control is typically one-way only. The smart system
                cannot confirm if commands were received or know the current device state.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Smart relay modules add remote control capability to existing wired circuits without
              replacing visible hardware. They fit behind switches, in junction boxes, or in
              consumer units.
            </p>
            ...
            <div className="bg-elec-gray/30 rounded-lg p-5 border border-white/10">
              ...
              <ul className="space-y-2 text-white">
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">-</span>
                  <span>
                    <strong>Lighting circuits:</strong> Add smart control whilst keeping existing
                    switches
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">-</span>
                  <span>
                    <strong>Boiler controls:</strong> Smart enable/disable of heating systems
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">-</span>
                  <span>
                    <strong>Immersion heaters:</strong> Scheduled control of water heating
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">-</span>
                  <span>
                    <strong>Extract fans:</strong> Humidity-triggered or scheduled operation
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-4 text-white">
            <div className="bg-elec-gray/30 rounded-lg p-5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                <strong>Challenge:</strong> Many legacy integrations cannot confirm if commands were
                received.
              </p>
              <p className="text-white text-sm">
                <strong>Solutions:</strong> Use power monitoring where available, implement "assumed
                state" with periodic resync commands, or add feedback sensors where practical.
              </p>
            </div>
            ...
            <div className="bg-elec-gray/30 rounded-lg p-5 border border-white/10">
              ...
              <p className="text-white text-sm">
                <strong>Solutions:</strong> Use a universal hub like Home Assistant to consolidate
                control, or choose bridges with broad voice assistant compatibility.
              </p>
            </div>
            ...
            <div className="bg-elec-gray/30 rounded-lg p-5 border border-white/10">
              ...
              <p className="text-white text-sm">
                <strong>Solutions:</strong> Choose quality bridges with good track records, maintain
                manual backup controls, and document recovery procedures.
              </p>
            </div>
          </div>
        </section>
