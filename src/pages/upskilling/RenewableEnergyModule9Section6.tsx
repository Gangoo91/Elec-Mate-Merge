...
const quizQuestions = [
  {
    question:
      'Hospital install — 500 kWe natural gas CHP for combined heat + electrical demand. What scope?',
    options: [
  ...
  {
    question:
      'Reg 551.7.5 anti-islanding for commercial CHP — how is the DNO-witnessed test conducted?',
    options: [
  ...
  {
    question:
      'Multi-source commercial site (PV + BESS + CHP + grid) — Section 551 + Chapter 82 implications?',
    options: [
...
export default function RenewableEnergyModule9Section6() {
  ...
  useSEO({
    title:
      'Commercial CHP + biofuel / biogas / hydrogen variants | Renewable Energy 9.6 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 9 · Section 6 · BS 7671:2018+A4:2026 · Section 551 + Reg 551.7.5 + EREC G99 + BS EN 50549"
        title="Commercial CHP + biofuel / biogas / hydrogen variants"
        backTo="../renewable-energy-module-9"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Commercial CHP scale 10 kWe - 5 MWe. Natural gas dominant + biogas (anaerobic digestion) +
          biofuel + hydrogen-blend variants. BS 7671 Section 551 + Reg 551.7.5 anti-islanding
          (DNO-witnessed test) + Reg 551.7.2.1 supply-side + Reg 551.4.2 multi-source RCD + EREC G99
          formal + Chapter 82 PEI integration + grid-services revenue + heat-network integration +
        ...
        <Pullquote>
          Commercial CHP is a multi-million-pound infrastructure project with electrical install
          inside. Section 551 + heat-network + grid-services + permits all stack — each layer is
          mandatory.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">10-50 kWe — light commercial</strong> — larger
              residential blocks, small hotels, community buildings. Borderline with MCS MIS 3007
              micro-CHP. Three-phase typical
            </li>
            <li>
              <strong className="text-white">50-500 kWe — mainstream commercial</strong> — hospitals
              (~100-500 kWe typical), leisure centres (~50-200 kWe), large hotels (~100-300 kWe),
              breweries, food processing
            </li>
            <li>
              <strong className="text-white">
                500 kWe - 5 MWe — large commercial / industrial
              </strong>{' '}
              — district heating schemes (university campuses, hospital sites, urban regeneration),
              anaerobic digestion sites, sewage works, large industrial process heat
            </li>
            <li>
              <strong className="text-white">UK 2025-26 customer types</strong> — hospitals (24/7
              heat + electrical demand; high utilisation; resilience value); leisure centres (pool
              heating constant + facility electrical); hotels (heat demand 6-12 months / year + 24/7
              electrical); food processing (process heat + electrical); breweries; large
              agricultural (biogas-CHP)
            </li>
            <li>
              <strong className="text-white">Fleet size</strong>— UK 2025-26 several thousand
              commercial CHPs operational. Combined output 1-2 GWe (significant fraction of UK
              generation capacity)
            </li>
            <li>
              <strong className="text-white">New install pipeline</strong> — focus on biogas /
              hydrogen-blend / industrial decarbonisation projects vs natural-gas baseline
            </li>
            <li>
              <strong className="text-white">Project economics</strong>— capex £500k-£3M+ per MWe;
              payback 5-10 years with grid services revenue + heat sales; 15-20 year operational
              life
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — substantial cross-trade
              record: Section 551 + EREC G99 + Environment Agency permit + manufacturer
              commissioning + heat-network integration + grid-services compliance
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Natural gas CHP</strong> — UK dominant. Gas grid supply
              via meter upgrade (typically dedicated commercial meter); Gas Safe install +
              commissioning; engine spec standard. Environment Agency MCPD permit (1-50 MWth)
            </li>
            <li>
              <strong className="text-white">Biogas CHP from anaerobic digestion</strong> — 50-65%
              methane + 35-50% CO2 + trace H2S + water vapour + siloxanes. Pre-treatment (H2S
              scrubbing + drying + siloxane removal) mandatory; engine spec biogas-rated; reduced
              engine life vs natural gas; Environment Agency permit
            </li>
            <li>
              <strong className="text-white">Biogas sources</strong>— agricultural (cattle + crop
              waste); sewage works (sludge digestion); food processing (food waste); landfill
              (methane capture); dedicated AD plants
            </li>
            <li>
              <strong className="text-white">Biofuel / bioliquid CHP</strong> — vegetable oil,
              biodiesel, palm oil-derived fuels. Specialist installs; less common UK 2025-26;
              sustainability certification (RED II) requirement
            </li>
            <li>
              <strong className="text-white">Hydrogen-blend CHP</strong> — 20% blend tested in
              HyDeploy programme. Manufacturer-tested + verified safe with existing engines (Clarke
              Energy, Centrica, ENGIE + others have hydrogen-ready engines). Customer\'s gas supply
              unlikely to be hydrogen-blended currently — future-proofing value
            </li>
            <li>
              <strong className="text-white">100% hydrogen CHP</strong> — emerging; some
              manufacturers have tested engines on pure hydrogen; very limited deployment; supply
              infrastructure question
            </li>
            <li>
              <strong className="text-white">Engine spec per fuel</strong> — manufacturer DoC
              declares fuel compatibility + emission limits + service interval per fuel. Fuel
              switching may require engine reconfiguration / replacement parts
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — fuel supply spec +
              engine fuel compatibility DoC + Gas Safe (where applicable) + Environment Agency
              permit + Industrial Emissions / MCPD compliance documentation
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          The combined-efficiency value of CHP only works if both heat and electricity find use.
          Heat-network integration + grid-services revenue + multi-source EMS are what make
          commercial CHP economic.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Buffer thermal store</strong> — 5,000-50,000 L typical
              commercial; 100,000+ L for district heating. Smooths CHP output vs demand. CHP runs at
              optimal capacity + banks heat for peak demand
            </li>
            <li>
              <strong className="text-white">Heat exchanger interface</strong> — separates CHP
              primary loop from building secondary loop. Different temperature regimes; simpler
              maintenance (CHP primary maintenance doesn\'t require draining building heating)
            </li>
            <li>
              <strong className="text-white">LTHW central heating</strong> — Low Temperature Hot
              Water (typically 70-80 °C flow / 50-60 °C return). UK 2025-26 commercial buildings
              standard
            </li>
            <li>
              <strong className="text-white">District heating</strong>— multiple buildings sharing
              CHP via insulated underground pipework. UK 2025-26 examples: university campuses (UCL,
              Birmingham), hospital sites (NHS Trust campus heating), urban regeneration (London
              Olympic Park, Manchester Civic Centre)
            </li>
            <li>
              <strong className="text-white">Boiler coordination</strong> — CHP as primary
              (base-load); existing gas / oil / electric boilers supplement during peak demand OR
              backup during CHP outage. Smart sequencing controls
            </li>
            <li>
              <strong className="text-white">Customer-side substations</strong> — for district
              heating: each consumer building has a substation (heat exchanger + flow + return
              meters + controls) taking heat from network
            </li>
            <li>
              <strong className="text-white">Control signal scope</strong> — CHP controller ↔
              heating controller ↔ BMS via Modbus / BACnet field-bus. Low-current LV cabling. BS
              7671 framework: Reg 314 dedicated controls way + Reg 415.1 RCD + Reg 522.2.1 cable
              thermal (cable near hot pipework)
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — heat-network
              commissioning record (heating engineer) + control signal wiring (electrical scope) +
              BMS integration verified + customer-side substation electrical commissioning per
              substation
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Smart Export Guarantee (SEG)</strong> — UK Government
              tariff for renewable / low-carbon electricity export. Applies to CHP. Tariff rates
              vary by supplier (4-15p / kWh exported). Covered M10
            </li>
            <li>
              <strong className="text-white">Firm Frequency Response (FFR)</strong> —
              milliseconds-to-seconds frequency control; CHP rapidly increases / decreases output to
              balance grid frequency. Revenue £10-30k per MWe per year typical. NESO procures via
              auction
            </li>
            <li>
              <strong className="text-white">
              ...
              — newer faster-response frequency products (post-2020). Revenue per MW per hour.
              Growing market share vs FFR
            </li>
            <li>
              <strong className="text-white">Capacity Market</strong>— multi-year availability
              payments (4-15 years contract typical) for generators committing to be available
              during system stress. Auction-based. Revenue £5-20k per MWe per year typical
            </li>
            <li>
              <strong className="text-white">Balancing Mechanism</strong> — short-term operation
              adjustments procured by NESO during real-time grid operation. Revenue per dispatched
              MWh. Suits flexible CHPs
            </li>
            <li>
              <strong className="text-white">Aggregator function</strong> — packages multiple
              distributed generators (CHPs, BESS, demand response loads, EV charging clusters) to
              bid into NESO services. Customer signs aggregator contract; aggregator coordinates
              with NESO; revenue split between customer + aggregator
            </li>
            <li>
              <strong className="text-white">Reg 551.7.4 capability</strong> — generator must meet
              voltage / frequency response requirements per ENA EREC G99 + grid-services contract.
              Typically integrated into CHP control electronics + aggregator coordination layer
            </li>
            <li>
              <strong className="text-white">UK 2025-26 reality</strong> — commercial CHP
              grid-services revenue often 20-40% of total project revenue alongside heat +
              electrical generation. Substantial economic driver
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — aggregator contract +
              grid-services compliance documentation + Section 551 + Reg 551.7.4 capability
              verification
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-9-section-7')}
