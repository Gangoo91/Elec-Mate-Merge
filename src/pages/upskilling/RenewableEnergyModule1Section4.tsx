...
const inlineChecks = [
  ...
  {
    id: 'm1s4-mis-mapping',
    question: 'Which MCS Installation Standard (MIS) corresponds to heat pump installations?',
  ...
  },
  {
    ...
    question: 'Which framing of MCS is most useful to the LCT installer business?',
    options: [
  ...
  {
    id: 'm1s4-mcs-audit',
    question: 'What does an MCS audit actually check on a sampled installer job?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'MIS 3008 — added to the MCS scheme in 2023 to cover heat batteries',
      'MIS 3002 — the PV installation standard',
      'MIS 3005 — the solar thermal hot-water standard',
      'No extra certification — heat batteries are not covered by MCS',
    ],
    correctAnswer: 0,
    explanation:
...
const faqs = [
  ...
  {
    question: 'How does MCS relate to TrustMark and the Consumer Code?',
    answer:
  ...
  {
    question: "What's the difference between MIS standards and MPS standards in the MCS scheme?",
    answer:
  ...
  {
    question: 'Can I be MCS-registered through multiple MIS standards at once?',
    answer:
  ...
  {
    question: 'What does an MCS audit actually find on a typical installer?',
    answer:
  ...
  {
    question: 'How does the LCT installer scheme look in Scotland, Wales and Northern Ireland?',
    answer:
  ...
  {
    question: 'What direction is MCS itself moving in?',
    answer:
...
export default function RenewableEnergyModule1Section4() {
  ...
  useSEO({
    title: 'MCS, MIS standards & the competent-person umbrella | Renewable Energy 1.4 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 4 · BS 7671:2018+A4:2026"
        title="MCS, MIS standards & the competent-person umbrella"
        backTo="../renewable-energy-module-1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          How the MCS scheme, the MIS technology-specific installer standards, the IET Codes of
          Practice and the Competent Person Schemes (NICEIC, NAPIT, ELECSA, Stroma) interlock — and
          the commercial reality of being an MCS-registered LCT installer.
        </p>
        ...
        >
          <p>
            MCS was established in 2007 as the industry response to the Feed-in Tariff scheme.
            Operated by the MCS Service Company since 2018.
          </p>
          <p>
            MCS is non-statutory. Lawful LCT installation in the UK requires BS 7671 compliance,
            Part P notification, and DNO notification — but not MCS.
          </p>
          <p>What MCS becomes is the gate to the funded market:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">SEG (2020)</strong> — under the Electricity (Smart
              Export Guarantee) Regulations 2019, requires MCS certificate as the supplier\'s
              evidence for the export payment
            </li>
            <li>
              <strong className="text-white">BUS</strong> — £7,500 per ASHP / GSHP grant, MCS-gated
              on both installer (MIS 3003) and product (MCS Product List)
            </li>
            <li>
              <strong className="text-white">ECO4 / GBIS</strong> — retrofit measures involving heat
              pumps or PV require MCS at both layers
            </li>
          </ul>
          <p>
            The strategic implication is that MCS is best understood as a market- segmentation
            mechanism. The funded market is structurally less price- competitive than the cash
            market. The MIS training spend and audit overhead are the price of admission to the less
            competitive segment.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">MIS 3002</strong> — Solar Photovoltaic
            </li>
            <li>
              <strong className="text-white">MIS 3003</strong> — Heat Pumps (ASHP, GSHP, WSHP)
            </li>
            <li>
              <strong className="text-white">MIS 3004</strong> — Solid Biomass Heating
            </li>
            <li>
              <strong className="text-white">MIS 3005</strong> — Solar Thermal
            </li>
            <li>
              <strong className="text-white">MIS 3006</strong> — Small Wind Turbines
            </li>
            <li>
              <strong className="text-white">MIS 3007</strong> — Micro-Hydro
            </li>
            <li>
              <strong className="text-white">MIS 3008</strong> — Heat Batteries (added 2023)
            </li>
          </ul>
          <p>
            Each MIS contains the design, install, commissioning and handover steps the auditor will
            check on a sampled job.
          </p>
          <p>
            Each MIS is a separate certification, requiring technology-specific training, practical
            assessment, and ongoing audit. Training is typically 5–10 days plus practical
            assessment, costed at £1.5k–£3k per MIS.
          </p>
          <p>
            The first MIS is the most expensive — it requires building the scheme infrastructure
            (audit trail, customer documentation templates, design-pack format, MCS Service Company
            registration). Subsequent MIS additions are marginally cheaper.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">MPS 010</strong> — PV modules
            </li>
            <li>
              <strong className="text-white">MPS 011</strong> — Wind turbines
            </li>
            <li>
              <strong className="text-white">MPS 012</strong> — Hydro
            </li>
            <li>
              <strong className="text-white">MPS 013</strong> — Solar thermal collectors
            </li>
            <li>
              <strong className="text-white">MPS 014</strong> — Heat pump units
            </li>
            <li>
              <strong className="text-white">MPS 015</strong> — Biomass appliances
            </li>
            <li>
              <strong className="text-white">MPS 016</strong> — Heat batteries
            </li>
          </ul>
          <p>
            For a funded install, both halves of MCS certification are required: the installer holds
            the relevant MIS, AND the product specified is on the MCS Product List.
          </p>
          <p>
            Specifying a non-listed product — even from a reputable manufacturer, even where
            technically equivalent — voids funding eligibility. The customer cannot claim BUS, SEG,
            or ECO with a non-listed product on the cert.
          </p>
        </ConceptBlock>
        ...
        <Pullquote>
          CPS for Part P. MCS for the funding gate. Different schemes, parallel memberships.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">CPS</strong> — general electrical safety in dwellings,
              Part P self-certification route as alternative to Building Control notification on
              every notifiable job
            </li>
            <li>
              <strong className="text-white">MCS</strong> — LCT technology-specific competence in
              the funded market (SEG, BUS, ECO4 eligibility)
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              MCS-registered without CPS — LCT where Part P notification is via Building Control
            </li>
            <li>Both — the typical mature LCT business operating in dwellings</li>
          </ul>
          <p>
            On a domestic LCT install in England or Wales, both scheme memberships are operationally
            in play: the CPS membership for the Part P notification, the MCS membership for the
            funding-gate evidence. Both notifications occur on the same install.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Design pack</strong> — heat-loss calculations and
              hydraulic schematics on heat pumps; shading analysis and string sizing on PV;
              depth-of-discharge calculations and chemistry-aware siting on BESS
            </li>
            <li>
              <strong className="text-white">On-site install</strong> — workmanship, labelling,
              isolation arrangements, signage
            </li>
            <li>
              <strong className="text-white">Commissioning evidence</strong> — aligned with
              manufacturer protocols and the relevant BS EN standard (BS EN 62446 for PV)
            </li>
            <li>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              Products specified that are not on the MCS Product List (substituted on availability
              grounds)
            </li>
            <li>Design or commissioning signatures missing from required roles</li>
          </ul>
          <p>
            Findings are issued formally. Minor findings typically have a rectification period
            (30–60 days); major findings may result in suspended registration pending rectification.
            Repeated or serious findings can result in expulsion.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">IET Code of Practice</strong> — the BS 7671- aligned
              technical operational reference, cross-referenced from GN3
            </li>
            <li>
              <strong className="text-white">MIS for the technology</strong> — the MCS scheme
              conformity standard (design pack format, customer handover, scheme-specific procedural
              steps)
            </li>
            <li>
              <strong className="text-white">MCS Product List entry</strong> — the product-side
              evidence layer for the equipment installed
            </li>
          </ul>
          <p>
            PI insurers, MCS auditors and EICR inspectors all expect to see the full evidence stack.
            PI underwriters increasingly differentiate cover terms based on the installer\'s
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Smart Export Guarantee (SEG, 2020)</strong> — statutory
              successor to FIT. Licensed electricity suppliers with &gt; 150,000 domestic customers
              must offer at least one export tariff to small-scale generators (≤ 5 MW). MCS
              certificate is the supplier\'s evidence for the export payment.
            </li>
            <li>
              <strong className="text-white">Boiler Upgrade Scheme (BUS)</strong> — up- front grants
              for low-carbon heating, currently £7,500 per ASHP or GSHP. MCS-gated on both halves
              (MIS 3003 installer, MCS Product List unit).
            </li>
            <li>
              <strong className="text-white">ECO4 / GBIS (2022–2026)</strong> — retrofit funding for
              eligible households via obligated suppliers. Heat pump or PV measures require MCS at
              both installer and product layers.
            </li>
          </ul>
          <p>
            Scotland operates Home Energy Scotland grants and loans as the parallel route to BUS.
          </p>
        </ConceptBlock>
