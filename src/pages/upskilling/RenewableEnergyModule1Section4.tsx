...
const RenewableEnergyModule1Section4 = () => {
  useSEO({
    ...
    description:
      'Understand Net Zero commitments, smart energy initiatives, and the policy frameworks driving renewable deployment.',
  });
  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'The UK became the first major economy to enshrine Net Zero in law through the Climate Change Act 2008 (2050 Target Amendment) Order 2019.',
    },
    {
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'CfDs provide 15-year contracts giving price certainty for low-carbon generation projects.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'The Smart Export Guarantee replaced Feed-in Tariffs for new small-scale renewable installations from 2020.',
    },
    {
      question:
        'What is the maximum capacity for rooftop solar under permitted development rights?',
      options: ['100kW', '250kW', '500kW', '1MW'],
      correctAnswer: 3,
      explanation:
        'Most rooftop solar installations under 1MW require no planning permission under permitted development rights.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'The Committee on Climate Change monitors UK progress toward Net Zero and recommends policies.',
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        "Ofgem's RIIO-2 price control allocates £25bn for network investment including smart grid technologies.",
    },
    {
      question: 'What is the difference between Net Zero and carbon neutral?',
      options: [
        'They are the same',
        'Net Zero covers only CO2, carbon neutral covers all GHGs',
        'Net Zero covers all GHGs, carbon neutral only CO2',
        'Net Zero is voluntary, carbon neutral is mandatory',
      ],
      correctAnswer: 2,
      explanation:
        'Net Zero covers all greenhouse gases and requires deep decarbonisation, while carbon neutral only addresses CO2.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'The Paris Agreement (2015) set the framework for international climate action and national targets.',
    },
    {
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 pb-24">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            <p>
              ...
              commitment requires net zero greenhouse gas emissions by 2050.
            </p>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Binding commitment:</strong> Legally binding
                ...
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong className="text-white">Carbon budgets:</strong> Five-year caps on UK
                    emissions providing stepping stones
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong className="text-white">Independent oversight:</strong> Committee on
                    Climate Change monitors progress
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span>
                    <strong className="text-white">Sectoral targets:</strong> Specific goals for
                    electricity, transport, buildings, and industry
                  </span>
                </li>
              </ul>
            </div>
            <p>
              <strong className="text-white">Electricity sector targets</strong> include a fully
              decarbonised electricity system by 2030, 50GW offshore wind by 2030, 70GW solar by
              2035 (industry ambition), and 30GW storage by 2030. These are supported by £12bn Green
              Bond programme and £1bn Net Zero Innovation Portfolio.
            </p>
          </div>
        </div>
        ...
        <div className="mb-8 mt-8">
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            ...
            <p>
              <strong className="text-white">Smart Grid Investments:</strong> Ofgem's RIIO-2 price
              control (2021-2026) allocates £25bn for network investment, including advanced
              monitoring and control systems, flexibility services procurement, enhanced grid
              resilience, and EV charging infrastructure support.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-sm mb-3">
                Long-term contracts (15 years) that provide price certainty for low-carbon
                generation. Generators receive the difference between a strike price and market
                price.
              </p>
              <ul className="text-sm space-y-1">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-sm mb-3">
                Replaced Feed-in Tariffs for new installations from 2020. Covers small-scale
                renewables up to 5MW.
              </p>
              <ul className="text-sm space-y-1">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <div className="text-sm space-y-1">
                <p>
                  • <strong className="text-white">Offshore Wind:</strong> 11GW at £37.35/MWh
                </p>
                <p>
                  • <strong className="text-white">Solar PV:</strong> 3.5GW at £47.87/MWh
                </p>
                <p>
                  • <strong className="text-white">Onshore Wind:</strong> 1.5GW at £52.29/MWh
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">2022 updates:</strong> 31% carbon reduction for
                    new homes
                  </li>
                  <li>
                    • <strong className="text-white">Fabric first:</strong> Improved insulation
                    standards
                  </li>
                  <li>
                    • <strong className="text-white">Low carbon heating:</strong> Heat pumps
                    preferred
                  </li>
                  <li>
                    • <strong className="text-white">EV charging:</strong> Mandatory for new
                    buildings
                  </li>
                  <li>
                    • <strong className="text-white">Future Homes Standard:</strong> Zero carbon
                    from 2025
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Solar PV:</strong> No planning for most rooftop
                    installations
                  </li>
                  <li>
                    • <strong className="text-white">Size limits:</strong> Up to 1MW for
                    non-domestic
                  </li>
                  <li>
                    • <strong className="text-white">Ground-mounted:</strong> Up to 9m² for domestic
                  </li>
                  <li>
                    • <strong className="text-white">Wind turbines:</strong> Limited permitted
                    development
                  </li>
                  <li>
                    • <strong className="text-white">Heat pumps:</strong> Permitted with noise
                    considerations
                  </li>
                </ul>
              </div>
        ...
        <div className="mb-8 mt-8">
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            ...
            <p>
              <strong className="text-white">Key International Initiatives:</strong> IRENA (global
              renewable transformation roadmap), Mission Innovation (accelerating clean energy
              innovation), Global Green Growth Institute (supporting developing countries), and
              RE100 (corporate renewable procurement commitment).
            </p>
          </div>
        </div>
        ...
        <div className="mb-8 p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/30">
          ...
          <div className="space-y-2 text-white/80 text-sm">
            ...
            <p>
              <strong className="text-white">For Customers:</strong> Understand available financial
              incentives like SEG rates and any local authority schemes in your area.
            </p>
            <p>
              <strong className="text-white">For Businesses:</strong> CfD rounds offer opportunities
              for larger projects - monitor allocation round announcements and strike price trends.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-between items-center pt-6 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="/electrician/upskilling/renewable-energy-module-1">Complete Module 1</Link>
          </Button>
        </div>
      </div>
    </div>
