...
const DESCRIPTION =
  'Master the selection and use of isolation equipment and personal protective equipment for safe electrical work. Learn about approved voltage indicators, proving units, and PPE requirements.';

const quickCheckQuestions = [
  {
    id: 'proving-sequence',
    question:
      'Why must the proving sequence include testing the voltage indicator AFTER testing the circuit?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      "The second prove is crucial because an instrument fault could have developed during testing. Without this confirmation, a 'dead' reading might be due to instrument failure rather than the circuit actually being isolated.",
  },
  {
    id: 'gs38-tip-length',
    question:
      'What is the maximum recommended exposed probe tip length according to GS38 for general electrical testing?',
    options: ['2mm', '4mm', '6mm', '10mm'],
    correctIndex: 1,
    explanation:
      'GS38 specifies 4mm maximum exposed tip to limit penetration depth into terminals, reducing the risk of short circuits or contact with adjacent conductors. 2mm is preferred for socket testing due to the close spacing of contacts.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'The air test is a quick field check that reveals holes too small to see visually. Any air leak indicates the glove is damaged and must not be used, as it could allow electric shock.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'According to GS38, what is the maximum recommended exposed probe tip length for general use?',
    options: ['2mm', '4mm', '6mm', '10mm'],
    correctAnswer: 1,
    explanation:
      'GS38 recommends a maximum of 4mm exposed probe tip for general use, with 2mm preferred for probing socket outlets. This limits penetration depth and reduces the risk of short circuits or contact with adjacent live conductors.',
  },
  {
    id: 2,
    question: 'What is the primary purpose of a proving unit?',
    options: [
      'To provide a power source for the voltage indicator',
      'To verify the voltage indicator is working correctly before and after testing',
      'To increase the range of the voltage indicator',
      'To provide earth reference for single-pole detectors',
    ],
    correctAnswer: 1,
    explanation:
      'A proving unit generates a known voltage to verify that the voltage indicator is functioning correctly. This must be done immediately before AND after testing to confirm the instrument was working throughout the proving dead procedure.',
  },
  {
    id: 3,
    question:
      'Which CAT rating is required for testing at a distribution board fed from the main supply?',
    options: ['CAT I', 'CAT II', 'CAT III', 'CAT IV'],
    correctAnswer: 2,
    explanation:
      'CAT III is required for distribution-level testing including distribution boards, submains, and fixed wiring. CAT IV is for the origin (utility connection), CAT II for local level (socket outlets), and CAT I for protected electronics only.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'GS38 recommends fused test leads with a rating of 500mA or less to limit energy in the event of accidental short circuit or arc. This fuse blows quickly if the probes accidentally bridge live conductors, protecting against arc flash.',
  },
  {
    id: 5,
    question:
      'Why should non-contact voltage detectors NOT be used as the sole method for proving dead?',
    options: [
      'They are too expensive',
      'They can give false negatives due to shielded cables or low voltage',
      'They are not accurate enough',
      'They require special training',
    ],
    correctAnswer: 1,
    explanation:
      'Non-contact detectors can give false negatives due to: shielded/armoured cables, low voltage levels, poor earth reference, or instrument failure. They detect electric fields, not actual voltage, so metallic enclosures can block detection. Two-pole testing is required for proving dead.',
  },
  {
    id: 6,
    question: 'What does IP2X rating mean for a voltage indicator?',
    options: [
      'It can withstand 2 bar water pressure',
      'It is protected against finger contact with live parts',
      'It has 2-year warranty',
      'It operates on 2 batteries',
    ],
    correctAnswer: 1,
    explanation:
      'IP2X indicates protection against solid objects larger than 12.5mm (finger-safe). For voltage indicators, this means the enclosure and probe design prevent finger contact with live parts during use. The X indicates no specific water protection rating is claimed.',
  },
  {
    id: 7,
    ...
    options: [
      ...
      'By electrical testing with a megger',
      'By air inflation and visual inspection for holes/damage',
      'By immersion in water',
    ],
    correctAnswer: 2,
    explanation:
      'Before each use, insulating gloves should be air-tested by rolling from the cuff to trap air, then inspecting for air leaks, holes, tears, or signs of deterioration. Visual inspection should check for cuts, cracks, UV damage, chemical contamination, or swelling. Electrical testing is done periodically at approved test facilities.',
  },
  {
    id: 8,
    ...
    correctAnswer: 3,
    explanation:
      'Insulating gloves use colour coding: Beige/Natural = Class 00 (500V AC max), Red = Class 0 (1000V AC max), White = Class 1 (7500V AC max), Yellow = Class 2 (17000V AC max). Most LV work uses Class 0 (red) or Class 00 (beige) gloves. Always check the voltage rating label.',
  },
  {
    id: 9,
    question: 'When selecting an MCB lock-off device, what must you verify?',
    options: [
      'It matches the colour of the distribution board',
      'It completely prevents the MCB from being switched ON',
      'It has a key rather than a combination',
      'It is made of metal for durability',
    ],
    correctAnswer: 1,
    explanation:
      'The lock-off device must completely prevent the MCB from being operated (switched ON) when applied. Different MCB types (DIN rail, BS types, different manufacturers) need specific lockout devices. Always verify the lock physically prevents operation - test it after applying.',
  },
  {
    id: 10,
    question:
      'According to best practice, when should a voltage indicator be proved with a proving unit?',
    options: [
      'Only before testing',
      'Only after testing',
      'Before AND after testing',
      'Once per day at the start of work',
    ],
    correctAnswer: 2,
    explanation:
      "The proving sequence is: Prove the indicator works (proving unit), test the circuit (indicator), prove the indicator still works (proving unit). This confirms the instrument was working throughout the test. Testing only before doesn't prove it worked during the critical proving dead test.",
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Voltage indicators:</strong> Two-pole, GS38-compliant, proved before AND
                after testing
              </li>
              <li>
                <strong>Test leads:</strong> 500mA fuses, shrouded probes (4mm max tip), correct CAT
                rating
              </li>
              <li>
                <strong>PPE selection:</strong> Based on voltage level and arc flash risk
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>GS38:</strong> HSE guidance on test equipment
              </li>
              <li>
                <strong>CAT III:</strong> Required for distribution board work
              </li>
              <li>
                <strong>Prove-Test-Prove:</strong> Essential proving sequence
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Voltage indicating devices (VIDs) are the primary instruments used to confirm the
              presence or absence of hazardous voltages. For safe isolation work,{' '}
              <strong>two-pole testers</strong> are essential because they simultaneously verify
              instrument operation while testing.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Two-Pole Voltage Indicator Features
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Clear indication:</strong> LED and/or LCD display with voltage range shown
                </li>
                <li>
                  <strong>Self-test function:</strong> Automatic or push-button self-check on
                  power-up
                </li>
                <li>
                  <strong>Phase rotation:</strong> Many indicate L1-L2-L3 sequence for 3-phase
                  systems
                </li>
                <li>
                  <strong>Continuity test:</strong> Some models include audible continuity for CPC
                  verification
                </li>
                <li>
                  <strong>Voltage ranges:</strong> Typically 12V to 690V AC/DC for LV applications
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-red-400/80 mb-2">
                Types NOT Suitable for Proving Dead
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Non-contact detectors:</strong> Can miss shielded cables, low voltages, or
                  through enclosures
                </li>
                <li>
                  <strong>Neon screwdrivers:</strong> Unreliable, no proving capability, not GS38
                  compliant
                </li>
                <li>
                  <strong>Test lamps:</strong> Risk of bulb failure, no fused leads, can mask low
                  voltage
                </li>
                <li>
                  <strong>Single-pole indicators:</strong> Require earth reference, can give false
                  readings
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A <strong>proving unit</strong> generates a known voltage output (typically 50V, 100V,
              and 230V AC or DC) that allows you to verify your voltage indicator is functioning
              correctly. This verification must be performed immediately before AND after testing a
              circuit.
            </p>
            ...
            <div className="my-6">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-4">
                  <span className="flex items-center justify-center w-8 h-8 rounded-full bg-elec-yellow/20 text-elec-yellow font-bold flex-shrink-0">
                    1
                  </span>
                  <div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Why Both Proves?</strong> The second prove confirms the instrument was working
              correctly during the circuit test. If your indicator fails the second prove, you
              cannot trust the "dead" reading - a fault may have developed during testing.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              HSE Guidance Note GS38 specifies essential safety requirements for electrical test
              equipment. Non-compliant test leads have contributed to serious injuries and
              fatalities. All test probes and leads must meet these criteria:
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Shrouded probes:</strong> Probes must have insulated barriers preventing
                  finger contact
                </li>
                <li>
                  <strong>Exposed tip:</strong> Maximum 4mm for general use, 2mm recommended for
                  socket testing
                </li>
                <li>
                  <strong>Finger guards:</strong> Physical barrier preventing fingers sliding onto
                  probe tip
                </li>
                <li>
                  <strong>Fused leads:</strong> Maximum 500mA fuse rating to limit arc energy
                </li>
                <li>
                  <strong>CAT rated:</strong> Appropriate category for the installation type being
                  tested
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3 p-2 rounded bg-red-500/10">
                  <span className="w-12 h-6 bg-red-500 rounded flex items-center justify-center text-white text-xs font-bold">
                    IV
                  </span>
                  <div>
                ...
                <div className="flex items-center gap-3 p-2 rounded bg-orange-500/10">
                  <span className="w-12 h-6 bg-orange-500 rounded flex items-center justify-center text-white text-xs font-bold">
                    III
                  </span>
                  <div>
                ...
                <div className="flex items-center gap-3 p-2 rounded bg-yellow-500/10">
                  <span className="w-12 h-6 bg-yellow-500 rounded flex items-center justify-center text-black text-xs font-bold">
                    II
                  </span>
                  <div>
                ...
                <div className="flex items-center gap-3 p-2 rounded bg-green-500/10">
                  <span className="w-12 h-6 bg-green-500 rounded flex items-center justify-center text-white text-xs font-bold">
                    I
                  </span>
                  <div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              PPE for electrical work provides a last line of defence against arc flash, electric
              shock, and other hazards. The specific PPE required depends on the voltage level,
              prospective fault current, and arc flash risk assessment for the task.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Safety glasses:</strong> Minimum requirement - protect against debris and
                  minor arc
                </li>
                <li>
                  <strong>Safety goggles:</strong> Better seal, protect against molten metal splash
                </li>
                <li>
                  <strong>Face shield:</strong> Required for higher arc flash risk, protects full
                  face
                </li>
                <li>
                  <strong>Arc-rated balaclava:</strong> For highest risk work, protects neck and
                  ears
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Non-conductive footwear:</strong> Insulated soles rated for electrical
                  work
                </li>
                <li>
                  <strong>Flame-resistant clothing:</strong> FR coveralls or shirt/trousers for arc
                  flash protection
                </li>
                <li>
                  <strong>Safety helmet:</strong> Class E rated for electrical work when head
                  protection needed
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Lock-off devices physically prevent isolated equipment from being re-energised.
              Different types of equipment require specific lockout devices to ensure they cannot be
              operated when applied.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Physical prevention:</strong> Must completely prevent operation when
                  applied
                </li>
                <li>
                  <strong>Unique padlock:</strong> Each worker applies their personal padlock
                </li>
                <li>
                  <strong>Multi-hasp:</strong> Allows multiple padlocks when multiple people working
                </li>
                <li>
                  <strong>Verification:</strong> Always test the lockout prevents operation after
                  applying
                </li>
              </ul>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Always Verify:</strong> After applying any lock-off device, attempt to operate
              the switch/breaker to confirm it is truly locked off. Some lockout devices can appear
              to be fitted but not actually prevent operation.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Regular inspection and maintenance of test equipment and PPE is essential for safety.
              Faulty equipment has contributed to many electrical accidents.
            </p>
            ...
            <div className="my-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3 p-2 rounded bg-white/5">
                  <span className="w-10 h-6 bg-elec-yellow/20 rounded flex items-center justify-center text-elec-yellow text-xs font-bold">
                    6M
                  </span>
                  <div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Keep a complete isolation kit together - indicator, proving unit, lock-off
                  devices, padlock, warning labels
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Using non-contact detectors alone</strong> - always use two-pole tester
                </li>
                <li>
                  <strong>Skipping the second prove</strong> - critical for confirming instrument
                  worked during test
                </li>
                <li>
                  <strong>Using damaged equipment "just this once"</strong> - never compromise on
                  safety
                </li>
                <li>
                  <strong>Borrowing someone else's padlock</strong> - defeats the purpose of LOTO
                </li>
                <li>
                  <strong>Using lockout devices that don't properly fit</strong> - verify they
                  prevent operation
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>GS38:</strong> Electrical test equipment for use on low voltage systems
                </li>
                <li>
                  <strong>HSG85:</strong> Electricity at Work - Safe working practices
                </li>
                <li>
                  <strong>EAW Reg 4(4):</strong> Equipment must be suitable for intended use
                </li>
                <li>
                  <strong>BS EN 61243-3:</strong> Voltage detectors specification
                </li>
                <li>
                  <strong>BS EN 60903:</strong> Specification for insulating gloves
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          <UnitsPocketCard
            ...
            items={[
              {
                label: 'Voltage Indicator',
                value: 'Two-pole, GS38 compliant, proved before AND after',
              },
              ...
              {
                label: 'Lock-Off Device',
                value: 'Must physically prevent operation, unique padlock',
              },
            ]}
          />
        </section>
