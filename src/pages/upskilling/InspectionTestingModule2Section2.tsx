        ...
        <nav className="px-4 pb-safe">
          <div className="flex gap-3">
            <Button
              ...
              onClick={() => navigate('/study-centre/upskilling/inspection-testing/module-2/section-1')}
            >
            ...
            <Button
              variant="ios-primary"
              className="flex-1 h-12"
              onClick={() => navigate('/study-centre/upskilling/inspection-testing/module-2/section-3')}
            >
              Next Section
