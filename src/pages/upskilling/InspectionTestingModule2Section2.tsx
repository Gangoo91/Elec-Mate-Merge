...
const InspectionTestingModule2Section2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 2 · Section 2" title="Isolation equipment and PPE" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The kit that turns the legal duty into a defensible system of work — BS EN 61243-3 voltage
          detectors, GS38 leads, MCB lock-offs, multi-hasps, and risk-driven PPE for the energised
          approach to switchgear.
        </p>
        ...
        >
          <p>
            ...
            detectors used in safe isolation. The standard sets requirements for impulse withstand,
            shrouding, indication, and the input impedance that distinguishes a voltage detector
            from a measuring instrument.
          </p>
          <p>The technical reasons a multimeter fails the prove-dead duty:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Phantom voltage (induced / capacitively coupled):</strong> a multimeter has a
              high input impedance, typically 10 MΩ. On a long cable run that is dead but runs
              parallel to live conductors, capacitive coupling induces a voltage on the dead
              conductor that the multimeter reads as 50–150 V — a phantom. A two-pole detector to BS
              EN 61243-3 has a lower input impedance and a small internal load that &ldquo;burns
              off&rdquo; the phantom, reading 0 V correctly.
            </li>
            <li>
              ...
              the result. A multimeter requires reading a remote display, which on a cluttered DB or
              in poor light invites contact errors.
            </li>
            <li>
              <strong>Shrouded GS38 probes by design:</strong> the probes are part of the device
              construction, not a separately-bought lead set that may or may not meet GS38. A BS EN
              61243-3 detector is sold ready-compliant.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              safety standards such as BS EN 61243-3 for two-pole voltage detectors and BS EN 61010
              or BS EN 61557 for instruments. Checking before each use that all leads, probes,
              accessories (including all devices such as crocodile clips used to attach to
              conductors) and instruments including the proving unit are clean, undamaged and
              functioning, also checking that isolation can be safely effected and that any locks or
              other means necessary for securing the isolation are available and functional.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              ...
              <text x="130" y="84" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="11">
                Proving unit
              </text>
              <text
                x="130"
            ...
            <g>
              ...
              <text x="670" y="84" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="11">
                Same proving unit
              </text>
              <text
                x="670"
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Overvoltage category match:</strong> CAT II for plug-connected appliance work,
              CAT III for fixed-installation work downstream of the consumer unit, CAT IV at or near
              the origin (between the building entrance and the primary distribution board). Reg
              537.2.3 sets the same logic for isolation devices: III or IV.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              category applies to both plug-connected equipment and permanently connected equipment.
              CAT IV: As CAT III, plus equipment installed at or near the origin of the electricity
              supply to a building, between the building entrance and the primary distribution board
              (consumer unit). Such equipment may include electricity meters and primary overcurrent
              protective devices.
            </>
          }
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              triple-pole versions for different MCB ranges) — the wrong brand fits poorly and does
              not satisfy &ldquo;prevent unintentional closure&rdquo;.
            </li>
            <li>
              <strong>RCBO lock-off:</strong> as MCB lock-off but matched to the RCBO body and the
              test-button location. Some manufacturers ship lock-offs as part of the product range.
            </li>
            <li>
            ...
            <li>
              ...
              padlocked. The fuse cannot be replaced without the operative returning. This is robust
              lock-off but it is single-operative-only — see multi-hasps below.
            </li>
            <li>
            ...
            <li>
              ...
              inappropriate — they break the &ldquo;only the operative can remove&rdquo; discipline.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Layer 0 — instruments and accessories:</strong> BS EN 61243-3 detector, BS EN
              61010 / 61557 instruments, GS38 leads and probes, proving unit. This is the base layer
              for any work, energised or not. Reg 537.2.3 / GN3 Reg 10.1.
            </li>
            <li>
              ...
              0, 1, 2, 3, 4 — class is selected against the system voltage. Class 0 is rated for use
              up to 1000 V AC. Periodic re-test (typically 6-monthly) and a visual / inflation check
              before each use.
            </li>
            <li>
            ...
            <li>
              ...
              minimum on every job; arc-rated face shield where Layer 2 applies. The face shield is
              graduated like the clothing — cal/cm² rating against incident energy.
            </li>
            <li>
              <strong>Layer 4 — insulated tools:</strong> 1000 V insulated screwdrivers / pliers to
              BS EN 60900. The grip of the tool stays insulated even if the tip slips against a live
              part.
            </li>
          </ul>
          <p>
            The competent person duty under EaWR reg 16 sits on top of all of this: the operative
            must have the technical knowledge to assess the risk, select the layer set, and use each
            item correctly. PPE without competence is a false comfort.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            this to the instruments: &ldquo;Manufacturers may provide multifunction test instruments
            to BS EN IEC 61557-10 that combine more than one, or all, of the functions listed&rdquo;
            — competence includes knowing which functions of a multifunction tester are appropriate
            for the job at hand, and which are not.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Carrying out a prospective-fault-current / clearing-time assessment to decide whether
              arc-rated clothing is required for the energised approach to a switchboard, rather
              than applying the same PPE on every job.
            </li>
            <li>
              Verifying the proving unit, detector, leads and locks before each use — not at weekly
              intervals, before each use, per GN3 Reg 10.1 (c).
            </li>
          </ul>
        </ConceptBlock>
