...
const FireAlarmModule5Section5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 5 · Section 5" title="Commissioning procedures" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The full commissioning sequence for a BS 5839-1:2025 fire alarm system: visual to
          handover. Cause-and-effect verification, sound level survey, battery autonomy, ARC
          alarm-transmission timings (NEW 2025: L ≤90 s / P ≤120 s under clauses 14.17 / 14.18), and
          the new commissioning-organisation duty to brief the user on false-alarm investigation
          (clause 29.6, NEW 2025).
        </p>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Continuity tests.</strong> Loop continuity end-to-end (panel SLC OUT to panel
              SLC RETURN); sounder zone continuity; mains feed continuity; FE continuity. Verifies
              physical wiring is continuous before any voltage applied.
            </li>
            <li>
            ...
            <li>
              ...
              design schedule. Walk-through pre-energisation finds the back-to-front device and the
              swapped address.
            </li>
            <li>
              <strong>First power-up.</strong> Loop devices re-fitted, panel energised under
              controlled conditions. Initial loop diagnostic from panel — device count, loop length,
              isolator status, fault status. Address any reported faults before proceeding.
            </li>
            <li>
            ...
            <li>
              ...
              indication on the panel; correct zone identified; correct cause-and-effect triggered.
            </li>
            <li>
            ...
            <li>
              <strong>Battery autonomy / mains-fail simulation.</strong> Calculation + load test at
              commissioning; full-duration test annually thereafter.
            </li>
            <li>
              <strong>ARC interface tests.</strong> Alarm transmission within timings (L ≤90 s / P
              ≤120 s); fault transmission; catastrophic-failure simulation within timings (L ≤3 min
              / P ≤31 min).
            </li>
            <li>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text
              ...
              fontWeight="bold"
            >
              Cause-and-effect verification + clause 29.6 false-alarm advice are NEW 2025 mandatory
              items
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              system designer. Mandatory documentation under BS 5839-1:2025. May be a formal matrix
              table for complex systems, or a text description for simple systems (&quot;this system
              operates as a simultaneous evacuation&quot;).
            </li>
            <li>
              <strong>The verification team.</strong> Two engineers — one at the panel, one walking
              the building — communicating by radio or phone. Single engineer verification is
              acceptable for very small systems but is slow.
            </li>
            <li>
              <strong>Trigger each cause.</strong> Every detector activated by test smoke / test
              heat / magnetic test wand per the device manufacturer instruction. Every MCP operated
              by the test key (not the break-glass — preserve the device for service). Every
              interface input simulated.
            </li>
            <li>
            ...
            <li>
              <strong>Tick the matrix.</strong> Each cell of the matrix is a cause-and-effect pair;
              verified means the effect occurs when the cause is triggered. Failures are noted,
              investigated, rectified, re-tested.
            </li>
            <li>
          ...
          <p>
            ...
            cause-and-effect verification; the 2025 revision elevates the matrix / text description
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              end of the bed, 1.4 m above floor. Reflects the higher level needed to wake a sleeping
              occupant.
            </li>
            <li>
          ...
          <p>
            The 65 / 75 / +5 figures are the floor — sounders should be designed to give margin over
            them. A 65 dB(A) reading at the deepest point of the system, with all sounders
            operational, leaves no margin for sounder degradation, occupant noise, or door closure.
            Design for 70-75 dB(A) deepest at commissioning to allow for service-life degradation.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              typically a cylinder for ceiling-mounted, a square prism for wall-mounted. The volume
              specifies where the VAD is guaranteed to deliver the rated luminous flux.
            </li>
            <li>
            ...
            <li>
              <strong>Verification at commissioning.</strong> Device certification confirmed (label
              / data sheet); spacing matches design; activation observed at the VADs during
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Capacity calculation.</strong> Quiescent load (mA) × autonomy (hours) + alarm
              load (mA) × alarm duration (hours) = required Ah. Installed battery Ah must exceed
              required Ah by a margin (typically ≥25%).
            </li>
            <li>
              <strong>Load test (commissioning, abbreviated).</strong> Mains isolated, panel runs on
              batteries for typically 30-60 min. Battery voltage and current monitored. At end of
              period, alarm triggered to verify alarm-load capability.
            </li>
            <li>
              <strong>Full-duration test (annual).</strong> Mains isolated for full design autonomy
              (24 h or 72 h) followed by alarm period. Full battery runtime verified.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Category P · clause 14.18.</strong> Alarm to ARC ≤120 s. Catastrophic failure
              indication at ARC and CIE ≤31 min. Longer catastrophic timing reflects lower immediacy
              of property protection vs life.
            </li>
            <li>
            ...
            <li>
              <strong>Power supply for transmission equipment.</strong> Where a separate PSU powers
              the alarm transmission equipment, it should conform to BS EN 54-4 or BS EN 50131-6
              Grade 4. The 2025 revision cross-references these.
            </li>
            <li>
              <strong>False alarm notice label.</strong> NEW figure in the 2025 revision (FIA Guide
              §13) showing a recommended &quot;False alarm notice — this fire alarm has an active
              connection to the fire and rescue service&quot; label, fixed on or adjacent to the CIE
              to remind premises management before any test.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              at the ARC and the CIE within 3 min.
              <br />
              <br />
              14.18 — For Category P systems, in the event of a fire alarm signal, an indication
              should be received at the ARC within a maximum of 120 s; a catastrophic failure of the
              transmission system (whereby no alarm signals can be transmitted) should be indicated
              at the ARC and the CIE within 31 min.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              the user — not just hand over a manual. The briefing is recorded; user acknowledges by
              signature.
            </li>
            <li>
            ...
            <li>
              ...
              (e.g. detector relocation, multi-sensor in place of point smoke), or engaged separate
              investigator (e.g. for systemic problems beyond user capability).
            </li>
            <li>
              <strong>Categories of false alarm.</strong> Now in commentary to clause 30 (moved from
              the terms and definitions in 2025). Categories include unwanted-fire-alarm,
            ...
            <li>
              ...
              greater emphasis to multi-sensor selection where point smoke detectors present higher
              false alarm risk; Annex D (was Annex E) gives the selection guidance.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              suitable investigation and, if appropriate, action to be taken on every occasion that
              a false alarm occurs. NOTE — This could, for example, comprise managerial changes
              within the building, modifications to the fire detection and fire alarm system or
              further separate investigation by the organisation that maintains the system.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              verification record, sound level survey record, battery autonomy record, ARC interface
              record. The certificate references these; the records are appended.
            </li>
            <li>
            ...
            <li>
              ...
              qualification, organisation, third-party scheme membership (if applicable — FIA / BAFE
              / NSI / SSAIB).
            </li>
            <li>
            ...
            <li>
              <strong>Format.</strong> Annex G of BS 5839-1:2025 gives a model form. Project may use
              an organisation-specific form provided it captures all the Annex G elements.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-5/section-6')}
