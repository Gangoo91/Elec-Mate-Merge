      ...
      <HubBody>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>ISO/IEC 11801 (international).</strong> Joint ISO/IEC standard, multi-part: -1
              general, -2 offices, -3 industrial, -4 single-tenant homes, -5 data centres, -6
          ...
          <p>
            ...
            TIA-568 and ISO/IEC 11801 remain valid international references — and are usually called
            up in multi-region procurement — but the UK regulatory pointer is to the EN series.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>
                ANSI/TIA-568.0-E (2020) — Generic Telecommunications Cabling for Customer Premises.
              </strong>{' '}
              The umbrella. Common requirements applicable across commercial / data-centre /
              residential / industrial sub-standards. Defines the six-zone topology, the 90 m / 100
              m / 10 m channel model, and shared performance language.
            </li>
            <li>
              <strong>
            ...
            <li>
              <strong>ANSI/TIA-568.3-E — Optical Fiber Cabling and Components Standard.</strong> The
              fibre components part. Defines OM1 through OM5 multimode and OS1a / OS2 single-mode
              performance, connector types (LC, SC, ST, MTP/MPO), and the permanent-link / channel
              models for fibre.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              Pathways and Spaces. Defines the TR (Telecommunications Room), ER (Equipment Room), EF
              (Entrance Facility), pathway types, environmental envelope. Addendum 1 (2022) updated
              TR conditions to <strong>18-27 °C / 8-60 % RH non-condensing</strong> — do not quote
              the older 18-24 °C / 40-55 % numbers.
            </li>
            <li>
              <strong>ANSI/TIA-606-D (2021).</strong> Administration Standard for Telecommunications
              Infrastructure. Labelling, identifiers, records — covered in full in Section 4 of this
              module.
            </li>
            <li>
            ...
            <li>
              <strong>ANSI/TIA-942-C (2024).</strong> Telecommunications Infrastructure Standard for
              Data Centers. Defines four redundancy classes — Rated 1 (basic), Rated 2 (redundant
              components), Rated 3 (concurrently maintainable), Rated 4 (fault tolerant). Note: TIA
              uses {`"`}Rated{`"`}; the Uptime Institute uses {`"`}Tier
              {`"`}; they are related but not identical.
            </li>
            <li>
              <strong>ANSI/TIA-1152-A (2016).</strong> Requirements for Field Test Instruments and
              Measurements for Balanced Twisted-Pair Cabling. Defines instrument accuracy Levels III
              / IIIe / IV / V (V is the current top accuracy). A {`"`}Class EA pass
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              50173-1:2018+A1:2020. Defines the six-zone topology, the channel model (90 m permanent
              link + 10 m cords = 100 m channel), the Classes (D, E, EA, F, FA, I, II), the
              connector and cable types in scope. The umbrella that the other parts inherit from.
              NOTE: BS 7671 §716.2(a) names BS EN 50173-1 normatively.
            </li>
            <li>
              <strong>Part 2 — Office premises.</strong> Outlet density (typically 2 outlets per 10
              m² work area), pathway capacity, building distributor / floor distributor placement.
              The standard a typical UK office is designed against.
            </li>
            <li>
              <strong>Part 3 — Industrial premises.</strong> Tougher MICE classification
              (Mechanical, Ingress, Climatic, Electromagnetic — the environmental rating system for
              industrial cabling). Higher outlet protection, sealed connectors, ruggedised cable
              jackets.
            </li>
            <li>
              <strong>Part 4 — Single-tenant homes / residential.</strong> Outlet density and
              topology for residential / SOHO. UK residential work additionally falls under BS 6701
              for the carrier-side wiring.
            </li>
            <li>
              <strong>Part 5 — Data centres.</strong> Computer-room cabling, main / horizontal /
              equipment / zone distribution areas, the data-centre-specific topology. Sits alongside
              BS EN 50600 (general data-centre infrastructure) and the international ANSI/TIA-942-C
              reference.
            </li>
            <li>
          ...
          <p>
            ...
            cabling requirements for remote powering — i.e. PoE — also referenced in §716.523.1.101
            NOTE 2). Together with BS EN 50174-2 they give the install-practice envelope for PoE
            bundles.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              referenced document (including any amendments) applies. (a) BS EN 50173-1, Information
              technology — Generic cabling for customer premises — Part 1: General requirements. (b)
              BS EN 60512-99-001, Connectors for electronic equipment — Tests and measurements —
              ...
              power. (c) BS EN 60512-9-3, Connectors for electronic equipment — Tests and
              measurements — Part 9-3: Endurance tests — Test 9c: Mechanical operation
        ...
        <AppendixTable
          ...
          rows={[
            ...
            ['Residential / single-tenant homes', 'TIA-568.4', 'ISO/IEC 11801-4', 'BS EN 50173-4'],
            ['Data centres', 'TIA-942-C (2024)', 'ISO/IEC 11801-5', 'BS EN 50173-5 + BS EN 50600'],
            ['Distributed building services', '— (TSBs only)', 'ISO/IEC 11801-6', 'BS EN 50173-6'],
            [
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Temperature:</strong> 18-27 °C continuous (Class A1 ASHRAE-aligned). NOT 18-24
              °C — that figure is pre-2022.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Layer 1 — Performance.</strong> What Class does the channel measure to? BS EN
              50173 series (with ISO/IEC 11801 / TIA-568 as international cross-reference).
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              with ANSI/TIA-568-C{`"`}. Twelve years later, that revision has been superseded twice
              (D in 2018, E in 2020). The drawings circulate; the contractor procures to the old
              channel limits and the older bend-radius / bundle figures; testing is done to the
              older instrument-accuracy expectation. Months later, an audit catches the discrepancy
              and the install has to be re-evaluated against the current spec.
            </>
          }
          doInstead={
            <>
        ...
        <Scenario
          ...
          situation={
            <>
              A US-headquartered tenant is fitting out a London office and the procurement document
              specifies {`"`}compliance with ANSI/TIA-568, ISO/IEC 11801, and BS EN 50173
              {`"`}. The UK installer suspects this is over-specification but does not want to lose
              the bid by pushing back without grounds.
            </>
          }
          whatToDo={
            <>
              ...
              Class EA / Cat 6A install built to BS EN 50174-2 will satisfy all three certifications
              without modification — same six-zone topology, same 90 m / 100 m channel, same Class
          ...
          whyItMatters={
            <>
              ...
              agreeing without analysis loses the margin. The right answer is {`"`}yes — here is one
              install that satisfies all three{`"`} with the cross-reference table to back it up.
              That is professional competence and it is the framing every Module 6 conversation
              starts from.
            </>
          }
        />
