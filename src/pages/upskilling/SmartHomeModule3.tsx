        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 auto-rows-fr">
            {sections.map((section) => (
              <Link
                key={section.id}
                to={section.id === 1 ? "smart-home-module-3-section-1" : 
                    section.id === 2 ? "smart-home-module-3-section-2" : 
                    section.id === 3 ? "smart-home-module-3-section-3" : 
                    section.id === 4 ? "smart-home-module-3-section-4" : 
                    section.id === 5 ? "smart-home-module-3-section-5" : "#"}
                className="h-full"
              >
                <Card 
