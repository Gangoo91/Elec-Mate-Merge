...
const IndustrialElectricalModule4Section2: React.FC = () => {
  ...
  const quizQuestions = [
    ...
    {
      question: 'What happens to a CTU counter when the CU input has a rising edge and CV is less than PV?',
      options: [
        'CV decrements by 1',
        'CV increments by 1',
        'CV resets to 0',
      ...
      <main className="max-w-3xl mx-auto px-4 py-6 space-y-8">
        ...
        <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
          ...
          <p className="text-sm text-muted-foreground">
            This section covers the five IEC 61131-3 programming languages, ladder logic fundamentals,
            timer types (TON, TOF, TP), counter operations (CTU, CTD, CTUD), Function Block Diagram basics,
            and an introduction to Structured Text programming.
          </p>
        </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground">
              The <strong className="text-foreground">IEC 61131-3 standard</strong> defines five programming languages
              for programmable logic controllers, providing a common framework across different PLC manufacturers.
              This standardisation allows programmers to apply their skills across various platforms and enables
            ...
            <div className="space-y-3">
              ...
              <div className="bg-background/50 rounded-lg p-4 border-l-4 border-blue-500">
                <h4 className="font-semibold text-foreground mb-2">2. Function Block Diagram (FBD)</h4>
                <p className="text-muted-foreground text-sm">
                  Graphical language using interconnected blocks representing functions. Excellent for continuous
                  processes, analogue control, and complex data flow applications.
                </p>
              </div>
              ...
              <div className="bg-background/50 rounded-lg p-4 border-l-4 border-orange-500">
                <h4 className="font-semibold text-foreground mb-2">5. Sequential Function Chart (SFC)</h4>
                <p className="text-muted-foreground text-sm">
                  Graphical language for organising programs into steps and transitions. Ideal for batch processes,
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    ...
                    and analogue processing, ST for calculations, and SFC for overall sequence coordination.
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground">
              ...
              organised into <strong className="text-foreground">rungs</strong> connected between two vertical
              <strong className="text-foreground"> rails</strong> representing power flow from left (L1) to right (L2/N).
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-background/50 rounded-lg p-4">
                ...
                <div className="space-y-2 font-mono text-sm">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-muted-foreground">Normally Open (NO) - TRUE when input is ON</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-red-400 w-16">|/|</span>
                    <span className="text-muted-foreground">Normally Closed (NC) - TRUE when input is OFF</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-blue-400 w-16">|P|</span>
                    <span className="text-muted-foreground">Positive Transition - TRUE on rising edge</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-purple-400 w-16">|N|</span>
                    <span className="text-muted-foreground">Negative Transition - TRUE on falling edge</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-background/50 rounded-lg p-4">
                ...
                <div className="space-y-2 font-mono text-sm">
                  <div className="flex items-center gap-4">
                    <span className="text-green-400 w-16">( )</span>
                    <span className="text-muted-foreground">Standard Coil - Energised when rung is TRUE</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-red-400 w-16">(/)</span>
                    <span className="text-muted-foreground">Negated Coil - Energised when rung is FALSE</span>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-blue-400 w-16">(S)</span>
                    <span className="text-muted-foreground">Set (Latch) - Sets bit ON, stays ON</span>
                  </div>
                  <div className="flex items-center gap-4">
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground">
              ...
              three standard timer types, each with specific behaviour for different applications.
            </p>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    IEC 61131-3 TIME format: <code className="bg-background/50 px-1 rounded">T#5s</code> (5 seconds),
                    <code className="bg-background/50 px-1 rounded">T#1m30s</code> (1 minute 30 seconds),
                    <code className="bg-background/50 px-1 rounded">T#500ms</code> (500 milliseconds).
...
5. Motor_Run output feeds back to OR for latching`}
            ...
            <h3 className="text-lg font-semibold text-foreground">FBD vs Ladder Logic Comparison</h3>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    ...
                    (like timers or latches) to prevent undefined behaviour.
                  </p>
                </div>
              </div>
            </div>
...
PartsProduced := PartCounter.CV;`}
            ...
            <h3 className="text-lg font-semibold text-foreground">When to Choose Structured Text</h3>
