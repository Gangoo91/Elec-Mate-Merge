...
const IndustrialElectricalModule4Section2: React.FC = () => {
  ...
  useSEO({
    title:
      'Ladder Logic and Function Blocks | Industrial Electrical Module 4 Section 2 | Elec-Mate',
    description:
      'Master IEC 61131-3 programming languages including ladder logic, function block diagrams, timers, counters, and structured text for PLC programming.',
    keywords: [
      'ladder logic',
  ...
  const quickCheckQuestions = [
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation:
        'A TON timer delays the activation of the output. When the input goes TRUE, the timer starts counting, and the output only turns ON after the preset time has elapsed while the input remains TRUE.',
    },
    {
      id: 'counter-type',
      ...
      correctIndex: 2,
      explanation:
        'CTUD (Counter Up/Down) can count in both directions. It has separate inputs for counting up (CU) and counting down (CD), plus a reset input, making it versatile for tracking quantities that can increase or decrease.',
    },
  ];
  ...
  const quizQuestions = [
    ...
    {
      question:
        'Which programming language is best suited for complex mathematical calculations in PLCs?',
      options: [
        'Ladder Diagram (LD)',
        'Function Block Diagram (FBD)',
        'Structured Text (ST)',
  ...
  const faqItems = [
    {
      question:
        'Why is ladder logic still widely used when more modern programming languages exist?',
      answer:
        'Ladder logic remains popular because it directly mirrors the relay-based wiring diagrams that electricians and maintenance technicians already understand. This visual representation makes troubleshooting intuitive - technicians can trace current flow through the logic just like tracing wires in a control panel. Additionally, many existing industrial systems use ladder logic, creating a large base of legacy code. For simple discrete control (ON/OFF operations), ladder logic is often the most efficient and readable choice. Most PLCs also support real-time monitoring of ladder logic, showing which rungs are energised during operation.',
    },
    {
  ...
  return (
    <div className="bg-background text-foreground">
      ...
      <header className="sticky top-0 z-10 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-white/10">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <span className="text-sm text-muted-foreground">Module 4 &gt; Section 2</span>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 py-6 space-y-8">
        ...
        <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
          ...
          <p className="text-sm text-muted-foreground">
            This section covers the five IEC 61131-3 programming languages, ladder logic
            fundamentals, timer types (TON, TOF, TP), counter operations (CTU, CTD, CTUD), Function
            Block Diagram basics, and an introduction to Structured Text programming.
          </p>
        </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground">
              The <strong className="text-foreground">IEC 61131-3 standard</strong> defines five
              programming languages for programmable logic controllers, providing a common framework
              across different PLC manufacturers. This standardisation allows programmers to apply
              their skills across various platforms and enables code portability between systems.
            </p>
            ...
            <div className="space-y-3">
              <div className="bg-background/50 rounded-lg p-4 border-l-4 border-elec-yellow">
                <h4 className="font-semibold text-foreground mb-2">1. Ladder Diagram (LD)</h4>
                <p className="text-muted-foreground text-sm">
                  Graphical language resembling electrical relay schematics. Most widely used for
                  discrete control. Ideal for electricians and maintenance personnel familiar with
                  relay logic.
                </p>
              </div>
              ...
              <div className="bg-background/50 rounded-lg p-4 border-l-4 border-blue-500">
                ...
                <p className="text-muted-foreground text-sm">
                  Graphical language using interconnected blocks representing functions. Excellent
                  for continuous processes, analogue control, and complex data flow applications.
                </p>
              </div>

              <div className="bg-background/50 rounded-lg p-4 border-l-4 border-green-500">
                <h4 className="font-semibold text-foreground mb-2">3. Structured Text (ST)</h4>
                <p className="text-muted-foreground text-sm">
                  High-level text-based language similar to Pascal. Best for complex calculations,
                  data manipulation, and algorithm implementation. Preferred by programmers with
                  software development backgrounds.
                </p>
              </div>

              <div className="bg-background/50 rounded-lg p-4 border-l-4 border-purple-500">
                <h4 className="font-semibold text-foreground mb-2">4. Instruction List (IL)</h4>
                <p className="text-muted-foreground text-sm">
                  Low-level text language similar to assembly code. Deprecated in IEC 61131-3 3rd
                  edition but still found in legacy systems. Offers compact code but lower
                  readability.
                </p>
              </div>
              ...
              <div className="bg-background/50 rounded-lg p-4 border-l-4 border-orange-500">
                ...
                <p className="text-muted-foreground text-sm">
                  Graphical language for organising programs into steps and transitions. Ideal for
                  batch processes, machine sequences, and state-based control. Often combined with
                  other languages.
                </p>
              </div>
            </div>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Modern PLC projects often combine multiple languages. Use LD for discrete I/O,
                    FBD for PID and analogue processing, ST for calculations, and SFC for overall
                    sequence coordination. The best language depends on the application, team
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground">
              Ladder logic uses a visual representation based on electrical relay circuits. Programs
              are organised into <strong className="text-foreground">rungs</strong> connected
              between two vertical
              <strong className="text-foreground"> rails</strong> representing power flow from left
              (L1) to right (L2/N).
            </p>
                ...
                <div className="space-y-2 font-mono text-sm">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-muted-foreground">
                      Normally Open (NO) - TRUE when input is ON
                    </span>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-red-400 w-16">|/|</span>
                    <span className="text-muted-foreground">
                      Normally Closed (NC) - TRUE when input is OFF
                    </span>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-blue-400 w-16">|P|</span>
                    <span className="text-muted-foreground">
                      Positive Transition - TRUE on rising edge
                    </span>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-purple-400 w-16">|N|</span>
                    <span className="text-muted-foreground">
                      Negative Transition - TRUE on falling edge
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-background/50 rounded-lg p-4">
                ...
                <div className="space-y-2 font-mono text-sm">
                  <div className="flex items-center gap-4">
                    <span className="text-green-400 w-16">( )</span>
                    <span className="text-muted-foreground">
                      Standard Coil - Energised when rung is TRUE
                    </span>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-red-400 w-16">(/)</span>
                    <span className="text-muted-foreground">
                      Negated Coil - Energised when rung is FALSE
                    </span>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-blue-400 w-16">(S)</span>
                    <span className="text-muted-foreground">
                      Set (Latch) - Sets bit ON, stays ON
                    </span>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-purple-400 w-16">(R)</span>
                    <span className="text-muted-foreground">Reset (Unlatch) - Resets bit OFF</span>
                  </div>
                </div>
              </div>
            </div>

            <h3 className="text-lg font-semibold text-foreground">Logic Implementation</h3>
    ...
    Both contacts must be TRUE for output to energise`}
              </pre>
            </div>
    ...
    Either contact TRUE will energise output`}
              </pre>
            </div>
    ...
    Motor drops out when Stop_PB pressed (NC contact opens)`}
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    PLCs execute ladder logic from top to bottom, left to right. Outputs are updated
                    at the end of each scan cycle. Be aware of the scan time when designing
                    time-critical logic - the output state reflects input conditions from the
                    previous scan.
                  </p>
                </div>
              </div>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground flex items-center gap-3">
            ...
            Timers: TON, TOF, TP Types
          </h2>

          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground">
              Timers are essential function blocks for controlling time-based operations. IEC
              61131-3 defines three standard timer types, each with specific behaviour for different
              applications.
            </p>

            <div className="flex items-center gap-2">
              <Timer className="w-5 h-5 text-elec-yellow" />
              <h3 className="text-lg font-semibold text-foreground">Standard Timer Types</h3>
            </div>
            ...
            <div className="bg-background/50 rounded-lg p-4 border-l-4 border-green-500">
              ...
              <p className="text-muted-foreground text-sm mb-3">
                Delays turning the output ON. The timer starts when input (IN) goes TRUE. Output (Q)
                turns ON after preset time (PT) elapses. If IN goes FALSE before PT, timer resets.
              </p>
              <div className="bg-background/70 rounded p-3 font-mono text-xs overflow-x-auto">
...
ET (Elapsed Time) counts from 0 to PT while IN is TRUE`}
              ...
              <p className="text-muted-foreground text-xs mt-2">
                <strong>Use case:</strong> Motor start delay, anti-short-cycle protection,
                debouncing inputs
              </p>
            </div>
            ...
            <div className="bg-background/50 rounded-lg p-4 border-l-4 border-blue-500">
              ...
              <p className="text-muted-foreground text-sm mb-3">
                Delays turning the output OFF. Output (Q) turns ON immediately when input (IN) goes
                TRUE. When IN goes FALSE, Q remains ON for the preset time (PT) before turning OFF.
              </p>
              <div className="bg-background/70 rounded p-3 font-mono text-xs overflow-x-auto">
                <pre className="text-muted-foreground">
...
ET counts from 0 to PT after IN goes FALSE`}
              ...
              <p className="text-muted-foreground text-xs mt-2">
                <strong>Use case:</strong> Exhaust fan run-on, cooling-down periods, keep-alive
                signals
              </p>
            </div>
            ...
            <div className="bg-background/50 rounded-lg p-4 border-l-4 border-purple-500">
              ...
              <p className="text-muted-foreground text-sm mb-3">
                Generates a pulse of fixed duration. When input (IN) has a rising edge, output (Q)
                turns ON for exactly the preset time (PT), regardless of input state changes during
                the pulse.
              </p>
              <div className="bg-background/70 rounded p-3 font-mono text-xs overflow-x-auto">
                <pre className="text-muted-foreground">
...
Pulse is non-retriggerable during active pulse`}
              ...
              <p className="text-muted-foreground text-xs mt-2">
                <strong>Use case:</strong> One-shot operations, fixed injection times, trigger
                pulses
              </p>
            </div>

            <h3 className="text-lg font-semibold text-foreground mt-4">Timer Parameters</h3>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    ...
                    <code className="bg-background/50 px-1 rounded">T#5s</code> (5 seconds),
                    <code className="bg-background/50 px-1 rounded">T#1m30s</code> (1 minute 30
                    seconds),
                    <code className="bg-background/50 px-1 rounded">T#500ms</code> (500
                    milliseconds). Resolution depends on PLC scan time and timer implementation.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground">
              Counters track the number of events or pulses. IEC 61131-3 defines three counter types
              for counting up, down, or both directions. Counters are edge-triggered - they respond
              to signal transitions, not continuous states.
            </p>

            <div className="flex items-center gap-2">
              <Hash className="w-5 h-5 text-elec-yellow" />
              <h3 className="text-lg font-semibold text-foreground">Counter Types</h3>
            </div>
            ...
            <div className="bg-background/50 rounded-lg p-4 border-l-4 border-green-500">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <h5 className="text-sm font-semibold text-muted-foreground mb-2">Inputs</h5>
                  <ul className="text-muted-foreground text-sm space-y-1">
                    <li>
                      <code className="text-green-400">CU</code> - Count Up (rising edge)
                    </li>
                    <li>
                      <code className="text-green-400">R</code> - Reset (level TRUE)
                    </li>
                    <li>
                      <code className="text-green-400">PV</code> - Preset Value (INT)
                    </li>
                  </ul>
                </div>
                <div>
                  <h5 className="text-sm font-semibold text-muted-foreground mb-2">Outputs</h5>
                  <ul className="text-muted-foreground text-sm space-y-1">
                    <li>
                      <code className="text-blue-400">Q</code> - Done (CV &gt;= PV)
                    </li>
                    <li>
                      <code className="text-blue-400">CV</code> - Current Value
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="bg-background/50 rounded-lg p-4 border-l-4 border-blue-500">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <ul className="text-muted-foreground text-sm space-y-1">
                    <li>
                      <code className="text-green-400">CD</code> - Count Down (rising edge)
                    </li>
                    <li>
                      <code className="text-green-400">LD</code> - Load PV into CV
                    </li>
                    <li>
                      <code className="text-green-400">PV</code> - Preset Value (INT)
                    </li>
                ...
                <div>
                  ...
                  <ul className="text-muted-foreground text-sm space-y-1">
                    <li>
                      <code className="text-blue-400">Q</code> - Done (CV &lt;= 0)
                    </li>
                    <li>
                      <code className="text-blue-400">CV</code> - Current Value
                    </li>
              ...
              <p className="text-muted-foreground text-xs mt-2">
                <strong>Use case:</strong> Remaining inventory, countdown sequences, magazine
                capacity
              </p>
            </div>
            ...
            <div className="bg-background/50 rounded-lg p-4 border-l-4 border-purple-500">
              ...
              <p className="text-muted-foreground text-sm mb-3">
                ...
                Two outputs indicate upper (QU: CV &gt;= PV) and lower (QD: CV &lt;= 0) limits
                reached.
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <ul className="text-muted-foreground text-sm space-y-1">
                    ...
                    <li>
                      <code className="text-green-400">R</code> - Reset (CV = 0)
                    </li>
                    <li>
                      <code className="text-green-400">LD</code> - Load (CV = PV)
                    </li>
                    <li>
                      <code className="text-green-400">PV</code> - Preset Value
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="text-muted-foreground text-sm space-y-1">
                    <li>
                      <code className="text-blue-400">QU</code> - Upper limit (CV &gt;= PV)
                    </li>
                    <li>
                      <code className="text-blue-400">QD</code> - Lower limit (CV &lt;= 0)
                    </li>
                    <li>
                      <code className="text-blue-400">CV</code> - Current Value
                    </li>
              ...
              <p className="text-muted-foreground text-xs mt-2">
                <strong>Use case:</strong> Buffer level tracking, parking garage capacity,
                bi-directional flow
              </p>
            </div>
...
Q Output:  __________________________|^^^^
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Counter values are typically stored as signed integers (INT: -32768 to +32767)
                    or double integers (DINT). Always reset counters appropriately to prevent
                    overflow. Some PLCs have overflow/underflow flags; check your specific platform
                    documentation.
                  </p>
                </div>
              </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground">
              ...
              Blocks are connected by lines showing data flow, similar to electronic circuit
              diagrams.
            </p>

            <div className="flex items-center gap-2">
              <GitBranch className="w-5 h-5 text-elec-yellow" />
              <h3 className="text-lg font-semibold text-foreground">FBD Structure</h3>
            </div>
    ...
    * Lines connect outputs to next block's inputs`}
            ...
            <h3 className="text-lg font-semibold text-foreground">Standard Logic Blocks</h3>
...
Q = NOT A`}
            ...
            <div className="bg-background/50 rounded-lg p-4">
              <h4 className="font-semibold text-elec-yellow mb-3">
                Complex FBD Example: Motor Control with Timer
              </h4>
              <pre className="text-muted-foreground text-xs overflow-x-auto">
                {`
              +-----+      +---------------+
 Start_PB ---+     |      |               |
              | OR  +------+IN          Q  +-------- Motor_Run
...
5. Motor_Run output feeds back to OR for latching`}
            ...
            <h3 className="text-lg font-semibold text-foreground">
              FBD vs Ladder Logic Comparison
            </h3>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="text-muted-foreground">
                  <tr className="border-b border-white/10">
                    <td className="py-2 px-3 font-semibold text-foreground">Best for</td>
                    <td className="py-2 px-3">Analogue, continuous processes</td>
                    <td className="py-2 px-3">Discrete, ON/OFF control</td>
                  </tr>
                  <tr className="border-b border-white/10">
                    <td className="py-2 px-3 font-semibold text-foreground">Data flow</td>
                    <td className="py-2 px-3">Left-to-right, block-to-block</td>
                    <td className="py-2 px-3">Top-to-bottom, rung-by-rung</td>
                  </tr>
                  <tr className="border-b border-white/10">
                    <td className="py-2 px-3 font-semibold text-foreground">Strengths</td>
                    <td className="py-2 px-3">PID loops, maths, data manipulation</td>
                    <td className="py-2 px-3">Interlocks, sequences, boolean</td>
                  </tr>
                  <tr>
                    <td className="py-2 px-3 font-semibold text-foreground">User familiarity</td>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    FBD blocks execute based on data dependencies. A block executes after all its
                    input values are available. Most PLCs evaluate FBD networks from left to right,
                    but explicit execution order can be defined if needed. Avoid feedback loops
                    without memory elements (like timers or latches) to prevent undefined behaviour.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground flex items-center gap-3">
            ...
            Structured Text and When to Use It
          </h2>

          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground">
              Structured Text (ST) is a high-level programming language similar to Pascal or modern
              scripting languages. It offers powerful constructs for complex logic, mathematical
              operations, and data manipulation that would be cumbersome in graphical languages.
            </p>

            <div className="flex items-center gap-2">
              <Code className="w-5 h-5 text-elec-yellow" />
              <h3 className="text-lg font-semibold text-foreground">ST Syntax Fundamentals</h3>
            </div>
...
UNTIL StepCount >= MaxSteps;`}
            ...
            <div className="bg-background/50 rounded-lg p-4">
              <h4 className="font-semibold text-purple-400 mb-3">
                Timer/Counter in Structured Text
              </h4>
              <pre className="text-muted-foreground text-sm overflow-x-auto">
...
PartsProduced := PartCounter.CV;`}
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    IEC 61131-3 allows mixing languages within a project. A common approach: use SFC
                    for overall sequence control, ST for calculations and data handling, and LD for
                    I/O interface and safety interlocks. This leverages each language's strengths
                    while maintaining readability for different maintenance personnel.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="bg-elec-yellow/5 border border-elec-yellow/30 rounded-lg p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              <h3 className="font-bold text-foreground mb-3 border-b border-white/20 pb-2">
                Ladder Logic Symbols
              </h3>
              <div className="space-y-2 text-sm font-mono">
                <div className="flex justify-between">
                  <span className="text-muted-foreground">| |</span>
                  <span className="text-muted-foreground">Normally Open Contact</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">|/|</span>
                  <span className="text-muted-foreground">Normally Closed Contact</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">( )</span>
                  <span className="text-muted-foreground">Output Coil</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">(S) (R)</span>
                  <span className="text-muted-foreground">Set / Reset Coil</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">|P| |N|</span>
                  <span className="text-muted-foreground">Rising / Falling Edge</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-muted-foreground">Delay output ON</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-blue-400 font-semibold">TOF</span>
                  <span className="text-muted-foreground">Delay output OFF</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-purple-400 font-semibold">TP</span>
                  <span className="text-muted-foreground">Fixed-width pulse</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-orange-400 font-semibold">RTO</span>
                  <span className="text-muted-foreground">Retentive on-delay</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-muted-foreground">Count Up (Q when CV&gt;=PV)</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-blue-400 font-semibold">CTD</span>
                  <span className="text-muted-foreground">Count Down (Q when CV&lt;=0)</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-purple-400 font-semibold">CTUD</span>
                  <span className="text-muted-foreground">Up/Down (QU and QD)</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-muted-foreground">Ladder Diagram</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-elec-yellow font-semibold">FBD</span>
                  <span className="text-muted-foreground">Function Block Diagram</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-elec-yellow font-semibold">ST</span>
                  <span className="text-muted-foreground">Structured Text</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-elec-yellow font-semibold">IL</span>
                  <span className="text-muted-foreground">Instruction List (deprecated)</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-elec-yellow font-semibold">SFC</span>
                  <span className="text-muted-foreground">Sequential Function Chart</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm font-mono">
                ...
                <div className="flex justify-between">
                  <span className="text-muted-foreground">AND OR NOT XOR</span>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm font-mono">
                <div className="flex justify-between">
                  <span className="text-muted-foreground">T#100ms</span>
                  <span className="text-muted-foreground">100 milliseconds</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">T#5s</span>
                  <span className="text-muted-foreground">5 seconds</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">T#1m30s</span>
                  <span className="text-muted-foreground">1 min 30 sec</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">T#2h15m</span>
                  <span className="text-muted-foreground">2 hr 15 min</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            <p className="text-muted-foreground mb-4">
              Test your understanding of ladder logic, function blocks, timers, and counters with
        ...
        <nav className="flex flex-col sm:flex-row justify-between gap-4 pt-6 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/upskilling/industrial-electrical/module-4/section-1">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous: Section 1 - PLC Architecture
            </Link>
          </Button>
          <Button
