    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The most-misunderstood part of PAT. There is no statutory frequency — only the duty to
          inspect at suitable intervals, set by risk assessment, reviewed against history, and
          recorded. IET CoP Table 7.1 is a starting point, not a rule.
        </p>
        ...
        >
          <p>
            The reason for the deliberate absence of fixed frequencies is the diversity of equipment
            and environments. A 13 A IEC lead in a quiet office sees barely any mechanical handling
            and lives in a benign environment; a 13 A IEC lead in a hire shop sees thousands of plug
            cycles per year and rough handling. A fixed annual frequency would over-test the office
            lead (introducing wear at terminations and creating false confidence) and under-test the
            hire lead (missing real defects). HSE and IET have both consistently rejected fixed
            frequencies for that reason.
          </p>
          <p>
            The duty-holder framing is therefore not "what does the law require" but "what does risk
            assessment justify, with what evidence, reviewable when the data tells me to revise it".
            That framing is the defendable answer to any HSE inspector or claim.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Equipment type and class.</strong> Hand-held equipment is at higher risk than
              stationary; Class I depends on a working CPC and so the consequence of a fault is
              touch-voltage and disconnection-time risk; Class II depends on insulation integrity.
              Different equipment categories have different risk profiles and deserve different
              intervals.
            </li>
            <li>
            ...
            <li>
              <strong>Type of user.</strong> The IT manager who is the only user of a single desktop
              is a different risk than a multi-user open-plan staff kitchen. Trained site operatives
              following a tool inspection routine are a different risk from temporary agency staff
              with no induction.
            </li>
            <li>
              <strong>History of defects.</strong> Past test results, defects found at user checks,
              near-misses, equipment-specific failure modes. The single most important input on the
              second cycle and beyond.
            </li>
          </ol>
          <p>
            The first cycle of a new programme draws frequency from Table 7.1 because the history
            input is empty. From the second cycle on, history dominates: the data tells you whether
            the original frequency was too short (consistent low defect rate, room to extend), too
            long (rising defect rate, must shorten), or appropriate (steady, defendable rate).
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            indicative of the magnitude — refer to IET CoP 5th Ed Table 7.1 for the precise numbers,
            which the duty-holder should be using as the first-cycle starting point and then
            revising against history.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Hand-held + harsh environment = shortest interval.</strong> Hand-held tools on
              construction sites have the highest defect rate of any combination, and the shortest
              starting frequency reflects that.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              used as a starting point, but should be amended by the duty-holder taking into account
              the actual results of previous inspections and tests.
            </>
          }
        ...
        >
          <p>IET CoP §7.4 and HSG107 §11 align on the principle. The data signals to listen for:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
          ...
          <p>
            The review process — defect-rate analysis, reasoning, documented frequency decision — is
            itself the artefact that satisfies HSG107 §11. Without it, the duty of "review in the
            light of experience" has not been discharged.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Each handling event is an opportunity for damage — drops, kinks, twists at the strain
              relief.
            </li>
            <li>
              Pass-result fatigue: when 99 % of items pass, the inspector\'s attention drops on the
              1 % that fail. The data drowns the signal.
            </li>
            <li>
              The Edwards balancing test cuts both ways: more testing increases cost AND introduces
              wear. If the marginal benefit (catching defects) is lower than the marginal cost
              (introducing defects), more testing makes things worse.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>New equipment entering service</strong> — formal visual + record entry, before
              first use.
            </li>
            <li>
            ...
            <li>
              <strong>Floods, fires, water ingress</strong> — affected equipment requires triggered
              inspection. "It looks dry" is not an acceptable substitute; absorbed moisture lowers
              IR and is invisible.
            </li>
            <li>
          ...
          <p>
            ...
            procedures, because relying on the calendar alone fails Reg 6 in any incident involving
        ...
        >
          ...
          <p>
            Each of these four is short. The whole package for a typical small employer is a page or
            two. The point is that they exist, are dated, are signed off, and are version-controlled
            — not that they are voluminous.
          </p>
        </ConceptBlock>
        ...
        <Quiz title="Frequency of inspection and testing — Module 1.4" questions={quizQuestions} />
