...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      'What is the maximum time allowed for anti-islanding protection to disconnect after grid loss?',
    options: ['1 second', '3 seconds', '5 seconds', '10 seconds'],
    correctIndex: 2,
    explanation:
      'Anti-islanding protection must disconnect the system within 5 seconds of detecting grid loss to prevent dangerous islanding conditions where local generation continues to energise the grid.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Bidirectional power flow occurs when electrical installations can both consume power from the grid AND export power back to it. This happens with solar PV, battery storage, and V2G (vehicle-to-grid) EV charging systems.',
  },
  {
    question: 'Why do standard RCDs need upgrading for renewable energy?',
    answer:
      'Standard RCDs may not operate correctly when current flows in the reverse direction (from installation to grid). Bidirectional RCDs are designed to provide protection regardless of current flow direction.',
  },
  {
    question: 'What is anti-islanding protection?',
    answer:
      'Anti-islanding protection prevents a renewable energy system from continuing to energise the local grid during power outages. This protects utility workers and equipment from unexpected live circuits.',
  },
  {
    question: 'Do existing installations need upgrading for Amendment 3?',
    answer:
      "Existing compliant installations don't need immediate upgrades. However, when adding renewable energy systems or making major alterations, Amendment 3 requirements apply to the new/modified work.",
  },
];
...
const BS7671Module4Section7 = () => {
  useSEO({
    ...
    description:
      'Understand Amendment 3 requirements for bidirectional protection in renewable energy, EV charging, and battery storage installations.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Effective:</strong> 31st July 2024 (mandatory)
              </li>
              <li>
                <strong>Applies to:</strong> Solar PV, battery storage, V2G EV charging
              </li>
              <li>
                <strong>Key:</strong> Protection for both current directions
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Any installation that exports power
              </li>
              <li>
                <strong>Use:</strong> Bidirectional RCDs, G98/G99 compliance
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              requirements for bidirectional protection in electrical installations. This
              fundamentally changes how we approach installations that can both consume and generate
              electricity.
            </p>
            <p>
              The key driver is the rapid growth in renewable energy installations - solar PV,
              battery storage, EV charging with V2G capability, and heat pumps. These technologies
              create bidirectional power flows that traditional protection devices were not designed
              to handle safely.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <ul className="text-xs space-y-1">
                  <li>
                    <strong>Bidirectional Protection:</strong> Devices isolating faults in either
                    direction
                  </li>
                  <li>
                    <strong>Consumer Unit Upgrades:</strong> Enhanced components for renewables
                  </li>
                  <li>
                    <strong>Grid Interaction Safety:</strong> Anti-islanding and grid code
                    compliance
                  </li>
                  <li>
                    <strong>Updated Testing:</strong> New commissioning procedures
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <p className="text-xs">
                  Non-compliance can result in dangerous back-feed conditions, equipment damage,
                  fire risks, and potential liability issues. Insurance coverage may be affected for
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Bidirectional protection is mandatory where installations can generate power that
              flows back into the supply system. Traditional protection devices may not operate
              correctly under reverse current conditions.
            </p>

            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-white/5">
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Traditional Flow (Grid → Installation)
                </p>
                <ul className="text-xs space-y-1">
              ...
              <div className="p-4 rounded-lg bg-white/5">
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Bidirectional Flow (Installation ↔ Grid)
                </p>
                <ul className="text-xs space-y-1">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Systems Requiring Bidirectional Protection:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Solar PV with Battery Storage:</strong> Energy flows based on
                  generation/consumption
                </li>
                <li>
                  <strong>V2G EV Charging:</strong> Vehicle-to-grid creates reverse current flows
                </li>
                <li>
                  <strong>Domestic Solar:</strong> Consumer unit upgrades may be required
                </li>
                <li>
                  <strong>Commercial Renewables:</strong> G98/G99 compliant protection schemes
                </li>
                <li>
                  <strong>Heat Pump with Solar:</strong> Load balancing and export control
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Anti-islanding protection prevents renewable energy systems from continuing to
              energise the local grid during power outages, protecting utility workers and
              equipment.
            </p>
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20 my-6">
              ...
              <p className="text-xs text-white">
                Anti-islanding must disconnect within 5 seconds of grid loss detection. G98/G99 grid
                code compliance is required for renewable installations.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10 mb-4">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Scenario 1: Domestic Solar with Battery Storage
              </p>
              <p className="text-xs mb-2">
                <strong>Challenge:</strong> 4kW solar PV system with 10kWh battery storage on
                existing installation.
              </p>
              <p className="text-xs mb-2">
                <strong>Requirements:</strong> Consumer unit must handle bidirectional current, RCD
                protection effective in both directions, anti-islanding mandatory.
              </p>
              <p className="text-xs">
                <strong>Solution:</strong> Upgrade to Type A RCD, install G98-compliant inverter
                with anti-islanding, verify all MCBs suitable for reverse current.
              </p>
            </div>

            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Scenario 2: Commercial EV Charging Hub with V2G
              </p>
              <p className="text-xs mb-2">
                <strong>Challenge:</strong> 50kW bidirectional EV charging station with grid support
                functionality.
              </p>
              <p className="text-xs mb-2">
                <strong>Requirements:</strong> G99 compliance, comprehensive protection
                coordination, smart grid communication.
              </p>
              <p className="text-xs">
                <strong>Solution:</strong> Dedicated protection panel with bidirectional devices,
                smart control system, comprehensive testing regime.
              </p>
            </div>
          </div>
        </section>
