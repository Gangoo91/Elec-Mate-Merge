...
const FireAlarmModule4Section5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 4 · Section 5" title="Earth fault monitoring" backTo=".." />
      <HubBody>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Visual indication.</strong> The CIE&apos;s common fault indicator (typically a
              yellow LED) is illuminated; the specific zone / loop / device showing the fault is
              identified on the CIE display. Both general indication AND specific location are
              required.
            </li>
            <li>
              <strong>Audible indication.</strong> The CIE&apos;s integral fault buzzer sounds. The
              buzzer is acknowledgeable (silenceable) but the visual indication remains until the
              fault is cleared.
            </li>
            <li>
              <strong>Logged event.</strong> The fault is recorded in the CIE&apos;s event log with
              timestamp and identification. The log persists for the system\'s defined retention
              period and is available for inspection during maintenance / audit.
            </li>
            <li>
              <strong>Transmitted to ARC where applicable.</strong> Where the system has alarm
              transmission to an Alarm Receiving Centre, fault conditions are typically transmitted
              alongside fire alarm signals — separately identified — so the ARC knows the system has
              a fault and can pass that to the responsible person.
            </li>
            <li>
              <strong>Continued monitoring.</strong> The CIE continues to monitor the fault while it
              persists. Intermittent faults (appear and disappear) are logged with each event; the
              maintainer sees the pattern in the log.
            </li>
          </ul>
          <p>
            The 100 s window is for the FIRST report of the fault. Once reported, the fault
            indication remains until the fault is cleared (the conditions that caused the report are
            no longer present) or until the system is reset by a competent person. The indication is
            not auto-cleared on a timer; the user must act on it.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              alarm system, the control and indicating equipment shall indicate the fault condition
              within 100 seconds of the fault occurring. The indication shall include visual
              indication of the fault state and audible indication that may be silenced by
              acknowledgment but shall not be silenced by means that would also clear the visual
              indication. The fault indication shall persist until the underlying fault is repaired
              or the system is reset by a competent person.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              polls one spur from the &quot;A&quot; end, the other spur from the &quot;B&quot; end.
              Every device is reachable from at least one direction. CIE indicates a fault (loop
              integrity lost) but every device remains supervised and operational.
            </li>
            <li>
              <strong>Single short fault.</strong> The short would draw excessive current if left in
              place. Loop isolators (typically every 32 devices, or per design) automatically
            ...
            <li>
              <strong>Single earth fault.</strong> The earth-fault monitoring detects the impedance
              change and reports the fault. The loop continues to function (the fault is to earth,
              not to the other loop conductor); detection / sounder operation is not affected
              directly. The fault is reported per the 100 s rule.
            </li>
            <li>
              <strong>Repair urgency.</strong> Class A&apos;s fault tolerance gives the maintainer
              time. The fault is reported as urgent maintenance (typically a 24-hour response window
              for non-critical premises, sooner for life-safety-critical premises), but the
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Single open fault.</strong> All devices BEYOND the fault are isolated. They no
              longer report, no longer respond, no longer contribute to the system\'s detection. The
              CIE indicates the fault and identifies the affected branch / segment. Protection is
              LOST in the affected area until repair.
            </li>
            <li>
            ...
            <li>
              <strong>Single earth fault.</strong> Reported per the 100 s rule. Whether the circuit
              continues to function depends on the specific fault and the EOL arrangement; in some
              cases protection is degraded even on Class B earth faults.
            </li>
            <li>
              <strong>Repair urgency.</strong> Class B&apos;s loss of protection beyond the fault
              makes repair urgent. Compensating measures (fire watch in the affected area) are often
              required while the repair is pending. The fault is treated as urgent emergency repair,
          ...
          <p>
            ...
            inspection (single cable run from CIE returning to CIE = Class A; cable runs outward and
            terminates at last device = Class B) is the diagnostic.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="225" y="45" textAnchor="middle" fill="#22D3EE" fontSize="14" fontWeight="bold">
              CLASS A — closed loop
            </text>
            ...
            <circle
              ...
              strokeWidth="1.4"
            />
            <text x="100" y="204" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              D1
            </text>
            <circle
              cx="100"
              ...
              strokeWidth="1.4"
            />
            <text x="100" y="284" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              D2
            </text>
            <circle
              cx="350"
              ...
              strokeWidth="1.4"
            />
            <text x="350" y="204" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              D3
            </text>
            <circle
              cx="350"
              ...
              strokeWidth="1.4"
            />
            <text x="350" y="284" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              D4
            </text>
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="655" y="45" textAnchor="middle" fill="#EF4444" fontSize="14" fontWeight="bold">
              CLASS B — radial / spur
            </text>
            ...
            <circle
              ...
              strokeWidth="1.4"
            />
            <text x="655" y="211" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              D1
            </text>
            <circle
              cx="655"
              ...
              strokeWidth="1.4"
            />
            <text x="655" y="291" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              D2
            </text>
            <circle
              cx="655"
              ...
              strokeDasharray="3,2"
            />
            <text x="655" y="351" textAnchor="middle" fill="#94A3B8" fontSize="9" fontWeight="bold">
              D3
            </text>
            <circle
              cx="655"
              ...
              strokeDasharray="3,2"
            />
            <text x="655" y="411" textAnchor="middle" fill="#94A3B8" fontSize="9" fontWeight="bold">
              D4
            </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Quiescent state.</strong> The CIE applies a low-level test signal between each
              loop conductor and FE. The current that flows is proportional to the
              conductor-to-earth admittance. In a healthy installation, the current is at the noise
              floor of the measurement; the CIE registers no fault.
            </li>
            <li>
              <strong>Partial fault developing.</strong> Insulation degrades over time — typically
              environmental factors. The conductor-to-earth admittance rises; the current rises; the
              CIE registers an increase that may be below the fault threshold but is logged as a
              trend. Some CIEs report this as a &quot;maintenance alert&quot; without going to full
              fault state.
            </li>
            <li>
            ...
            <li>
              <strong>Localisation.</strong> On addressable systems, the CIE may be able to localise
              the fault to a specific portion of the loop based on signal-strength differences from
              each direction. On simpler systems the fault is reported at loop level and the
              maintainer must localise by isolation.
            </li>
            <li>
          ...
          <p>
            ...
            fault — not to dismiss them as &quot;intermittent noise&quot; or to acknowledge them and
            move on.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              end and at all branch / device points, removing the addressable devices from the test
              path. Apply 500 V DC IR between the loop conductors and earth. The cable&apos;s
            ...
            <li>
              ...
              provide loop diagnostics: continuous earth-fault impedance monitoring, loop integrity
              check, voltage and current measurements at the loop terminals. These diagnostics
              provide much of the information an IR test would give, without disconnecting devices.
              The CIE&apos;s manual gives the specific diagnostic procedures and the readings to
              expect on a healthy installation.
            </li>
            <li>
              <strong>Use a low-voltage method.</strong> Some specialist test equipment provides
              insulation testing at voltages below the threshold for damaging fire-alarm electronics
              — typically tens of volts rather than 500 V. The result is less discriminating than
              500 V testing of bare cable but is appropriate to live installations with electronic
              devices.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              specifically designed for live installations with electronic devices. The test method
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              occupancy positions. All non-compliant — the user must be able to see the fault state.
            </li>
            <li>
            ...
            <li>
              ...
              indication has been silenced; but the underlying condition remains and protection may
              be degraded. BS 5839-1:2025 expects acknowledgment to be a step toward repair, not a
              substitute for it.
            </li>
            <li>
              <strong>Indefinite delay.</strong> A fault that was reported six months ago,
              acknowledged daily, and never repaired is a system that is not being maintained. Where
              genuine repair delays exist (parts on order, specialist visit pending), the management
              plan documents the delay, the compensating measures, and the target repair date.
              Indefinite delay without documentation is not acceptable.
            </li>
            <li>
          ...
          <p>
            The principle is simple: the system communicates its state to the user; the user acts on
            what the system communicates. Anything that breaks the communication chain is
        ...
        <FAQ
          items={[
            ...
            {
              question: 'How quickly should an earth fault be repaired after it has been reported?',
              answer:
