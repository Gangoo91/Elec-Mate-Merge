...
const DESCRIPTION =
  'Learn about earth fault monitoring requirements, fault location methods, insulation resistance testing and troubleshooting for BS 5839-1 fire alarm systems.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Earth faults can disrupt correct operation, cause false alarms or prevent proper fault indication.',
  },
  {
    id: 'ir-minimum',
    ...
    correctIndex: 1,
    explanation:
      'Maintain high insulation values, minimum 2M ohms, to earth to ensure correct operation.',
  },
  {
    id: 'fault-location',
    ...
    correctIndex: 1,
    explanation:
      'Use divide-and-conquer: disconnect sections systematically to narrow down the fault location.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'Clearly displayed at the CIE',
      'Only recorded internally',
      'Ignored unless multiple',
    ],
    correctAnswer: 1,
    explanation:
      'Faults must be clearly indicated so they can be investigated and rectified promptly.',
  },
  {
    id: 4,
    question:
      'The minimum insulation resistance for fire alarm circuits per BS 5839-1 is typically:',
    options: ['100 ohms', '1k ohms', '2M ohms to earth', '100M ohms'],
    correctAnswer: 2,
    explanation:
      'BS 5839-1 expects at least 2M ohms insulation resistance between circuits and earth to ensure reliable operation.',
  },
  {
    id: 5,
    question: 'Earth fault monitoring in modern panels typically:',
    options: [
      'Only checks at commissioning',
      'Continuously monitors circuit insulation',
      'Requires external equipment',
      'Checks once per year',
    ],
    correctAnswer: 1,
    explanation:
      'Modern panels have built-in earth fault monitoring that continuously checks insulation to earth.',
  },
  {
    id: 6,
    question: 'Tracking down an earth fault is best done by:',
  ...
  },
  {
    ...
    options: [
      ...
      'Field devices, junction boxes and cable entries',
      'The control panel display',
      'Nowhere specific',
    ],
    correctAnswer: 1,
    explanation:
      'Water enters at devices and connection points, reducing insulation resistance and causing earth faults.',
  },
  {
    id: 8,
    ...
    options: [
      ...
      'Record readings and compare to minimum standards and manufacturer data',
      'Only test the supply cable',
      'Use mains voltage for testing',
    ],
    correctAnswer: 1,
    explanation:
      'Record all readings, compare against minimum 2M ohms and any manufacturer-specific requirements.',
  },
  {
    id: 9,
    ...
    options: [
      ...
      'Moisture, loose connections or damaged insulation that varies with conditions',
      'Correct installation',
      'High-quality materials',
    ],
    correctAnswer: 1,
    explanation:
      'Intermittent faults often relate to environmental conditions (humidity, temperature) affecting marginal insulation.',
  },
  {
    id: 10,
    question: 'Split earth monitoring reports:',
    options: [
      'Overall system health only',
      'Earth faults on positive and negative circuits separately',
      'Battery voltage',
      'Loop addresses',
    ],
    correctAnswer: 1,
    explanation:
      'Split monitoring helps identify which side of the circuit has the fault for faster diagnosis.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'No - the system is compromised and a second fault could cause serious malfunction. Investigate promptly.',
  },
  {
    question: 'What IR test voltage should I use?',
    answer:
      'Typically 500V DC unless the manufacturer specifies otherwise. Disconnect sensitive electronics first.',
  },
  {
    question: 'How do I test IR with devices connected?',
    answer:
      'Generally you should disconnect devices or test at the panel with circuits isolated. Follow manufacturer guidance.',
  },
  {
    question: 'What causes intermittent earth faults?',
    answer:
      'Usually moisture-related - condensation, humidity changes or minor water ingress that varies with conditions.',
  },
  {
    question: 'Should I record earth fault events?',
    answer:
      'Yes - log all faults, investigations and repairs in the system log book and maintenance records.',
  },
  {
    question: 'Can damaged cable cause earth faults?',
    answer:
      'Yes - crushed, nicked or water-damaged insulation is a common cause. Check for physical damage during investigation.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Minimum IR:</strong> 2M ohms to earth per BS 5839-1
              </li>
              <li>
                <strong>Monitoring:</strong> Continuous, split +ve/-ve indication
              </li>
              <li>
                <strong>Common cause:</strong> Water ingress at devices/JBs
              </li>
              <li>
                <strong>Method:</strong> Divide-and-conquer to locate fault
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Earth fault = investigate immediately
              </li>
              <li>
                <strong>Use:</strong> 500V DC IR test (disconnect electronics)
              </li>
              <li>
                <strong>Apply:</strong> Record all IR readings for trending
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Fire alarm systems use floating DC circuits. Earth faults - unintended connections to
              earth - can cause unpredictable behaviour and compromise life safety.
            </p>

            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm text-white">
                <strong>Critical:</strong> A single earth fault may not cause immediate problems,
                but a second fault could create a short circuit bypassing normal protection, causing
                false alarms, missed alarms or system failure.
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BS 5839-1 specifies minimum insulation resistance values to ensure reliable operation.
              These must be tested during commissioning and periodically.
            </p>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>Between circuits and earth:</strong> 2M ohms minimum
                </li>
                <li>
                  <strong>Test voltage:</strong> 500V DC (unless manufacturer specifies otherwise)
                </li>
                <li>
                  <strong>Disconnect sensitive equipment</strong> before testing
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Modern fire alarm panels incorporate continuous earth fault monitoring. Understanding
              how this works helps with fault diagnosis.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Systematic fault-finding minimises disruption and quickly locates the problem.</p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Check panel event log for timing patterns - correlate with weather/environmental
                  changes
                </li>
                <li>
                  Keep a torch handy - many earth faults are visible as water staining or corrosion
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Ignoring intermittent earth faults</strong> - they indicate a developing
                  problem that will worsen
                </li>
                <li>
                  <strong>Not recording commissioning IR readings</strong> - makes future
                  troubleshooting much harder
                </li>
                <li>
                  <strong>Replacing devices without investigating root cause</strong> - the problem
                  often returns
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-sm text-white">
              You have completed all sections covering power supplies, batteries, cables, wiring
              methods and earth fault monitoring. Continue to Module 5 to learn about detection
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="/upskilling/fire-alarm-course/module-5">
              Next Module
