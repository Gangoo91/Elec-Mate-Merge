...
const FireAlarmModule4Section5 = () => {
  ...
  const questions: QuizQuestion[] = useMemo(() => [
    ...
    { id: 11, question: 'A typical EOL resistor value for conventional fire alarm zones is:', options: ['1 kΩ', '4.7 kΩ or 10 kΩ depending on manufacturer', '100 Ω', '1 MΩ'], correctAnswer: 1, explanation: 'Common values are 4.7 kΩ or 10 kΩ, but always use the manufacturer-specified value for the particular panel to ensure correct supervision.' },
    { id: 12, question: 'Short-circuit isolators on addressable loops automatically:', options: ['Increase loop speed', 'Disconnect faulted sections and restore after fault clearance', 'Change device addresses', 'Reduce power consumption'], correctAnswer: 1, explanation: 'Isolators detect short-circuits, disconnect the affected segment, and automatically restore connection once the fault is cleared.' },
    { id: 13, question: 'The maximum number of devices between isolators should be determined by:', options: ['Personal preference', 'Manufacturer loading limits and acceptable fault impact area', 'Always 32 devices', 'Cable colour'], correctAnswer: 1, explanation: 'Balance manufacturer limits with the impact of losing devices in a faulted segment; strategic placement minimises disruption.' },
    { id: 14, question: 'During commissioning, loop polarity should be verified to ensure:', options: ['It doesn\'t matter for addressable systems', 'Correct communication and device operation', 'The cable looks neat', 'Batteries charge faster'], correctAnswer: 1, explanation: 'Correct polarity is essential for reliable communications and device operation; reversed polarity can cause communication failure.' },
    { id: 15, question: 'When an isolator operates, the panel should:', options: ['Ignore the event', 'Provide a clear indication of which isolator and the affected zone/segment', 'Shut down completely', 'Reset all devices'], correctAnswer: 1, explanation: 'Clear indication of isolator activation helps maintenance staff quickly identify and locate the faulted section for repair.' }
  ], []);
