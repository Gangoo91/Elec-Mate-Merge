    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Fibre testing fundamentals — link power budget, component loss values, OTDR pulse width
          and dynamic range, bidirectional dual-wavelength measurement, launch and tail cords, trace
          interpretation including ghost reflections, and the relationship between Tier 1 OLTS
          insertion-loss certification and Tier 2 OTDR characterisation.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              dB/km specified, ~0.32-0.38 typical. OS2 at 1550 nm: ~0.25 dB/km. OS1 / OS1a indoor at
              1310 nm: ~1.0 dB/km. OM4 MM at 850 nm: ~3.5 dB/km; at 1300 nm: ~1.5 dB/km.
            </li>
            <li>
            ...
            <li>
              <strong>Headroom.</strong> Add ~1 dB for ageing, future patching, minor contamination
              drift over time. Some specifications use 0.5 dB, others 1.5 dB — check the project
              specification.
            </li>
          </ul>
          <p>
            ...
            Total: 1.88 dB. Add 1 dB headroom: budget ~ 2.9 dB. Test the link with OLTS at 1310 nm;
            if measurement &lt; 2.9 dB, pass. Compare against the transceiver budget for the target
            service (10GBASE-LR ~ 6.2 dB, 25GBASE-LR varies) for service compatibility headroom.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              OLTS) shall be performed in both directions and at the appropriate wavelengths for the
              cabling type. Tier 2 testing (OTDR) where specified shall similarly be performed in
              both directions and at dual wavelengths. The reference method (one-cord, three-cord)
              shall be specified, and the launch conditions (encircled flux for MM) shall comply
              with the relevant test method. Test results shall be documented and retained as part
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              attenuation. Constant slope means uniform fibre; a change in slope is a long-distance
              loss change (rare).
            </li>
            <li>
            ...
            <li>
              <strong>Step down with a peak above the trend.</strong> A connector pair or mechanical
              splice. The mating-face refractive-index discontinuity reflects light (the peak), and
              the small geometric / contamination losses give a step (the loss). UPC connectors give
              a small peak; APC connectors give a much smaller peak because the angled face reflects
              light into the cladding.
            </li>
            <li>
          ...
          <p>
            ...
            (sees further down the fibre) but worse resolution (events within the pulse width worth
            of distance merge into one event). Narrower pulse = better resolution but less dynamic
            range. Standard OTDR practice on a long link is to run multiple traces at different
            pulse widths — short pulse for the near-end events, wider pulse for the far end — and
            combine.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text
              ...
              fontFamily="system-ui"
            >
              Tier 2 OTDR — characterisation tool, not the certification pass / fail (that is Tier 1
              OLTS)
            </text>
            <text
              x="450"
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              <strong>Bidirectional measurement.</strong> Run the OTDR from each end of the link and
              average the per-event loss results. This cancels the artefact caused by
            ...
            <li>
              ...
              1300 nm (MM). Macrobends and microbends attenuate long wavelengths much more strongly
              than short — a 0.3 dB step at 1310 nm may be 1.5 dB at 1550 nm. Comparing the two
              traces immediately identifies bend-induced losses for re- routing.
            </li>
            <li>
              <strong>Ghost reflections.</strong> Artefacts of the OTDR\u2019s pulsed nature. The
              launched pulse partially reflects off a strong reflective event (typically the far-end
              connector), travels back, partially re-reflects at the launch end, travels forward,
              and is received again. Signature: a small peak with no associated loss step, located
              at exactly 2 × the distance to the strong reflector. Suppression: APC connectors
              (lower return loss), reduce pulse energy, longer averaging.
            </li>
            <li>
              <strong>End-of-fibre echo.</strong> Very strong reflection from the glass-air
              interface at an open fibre end, or from the last connector. Beyond this peak the trace
              is noise. Always check that this peak corresponds to the expected link length.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              OLTS measurement against the channel budget — not an OTDR estimate. The project has to
              be re-tested with a power meter / light source set to obtain the Tier 1 number,
          ...
          doInstead={
            <>
              ...
              characterisation measurement, used to LOCATE excess loss and to baseline the link for
              future maintenance. Most projects specify both at commissioning. Document each
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              absent at 1310 nm. Identify the position. Walk the cable route to that position; look
              for sharp corners, over-tight cable ties, or a kink in the cable. Re-route to respect
              the manufacturer\u2019s minimum bend radius (typically 10× outer diameter unloaded,
              20× loaded). Re-test bidirectionally at both wavelengths. Document the finding and the
              remediation in the as-built record.
            </>
          }
          whyItMatters={
            <>
              ...
              mandatory because it catches exactly this class of fault. The macrobend remediation is
              cheap; finding it after the building hands over is not.
            </>
          }
        />
