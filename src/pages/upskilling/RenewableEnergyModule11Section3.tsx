...
const inlineChecks = [
  {
    ...
    question: 'What does the BS EN 62305 standard series cover, and how does it relate to BS 7671?',
    options: [
  ...
  },
  {
    ...
    question: 'BS EN 62305-2 defines four risk categories. What are they?',
    options: [
  ...
  {
    id: 'm11s3-lpz-zones',
    question: 'What are Lightning Protection Zones (LPZ) per BS EN 62305-1?',
    options: [
  ...
  },
  {
    ...
    question: 'What is "separation distance s" in BS EN 62305-3, and why does it matter for PV?',
    options: [
...
const quizQuestions = [
  ...
  {
    question: 'How does the LPZ concept drive SPD type selection — Type 1 vs Type 2 vs Type 3?',
    options: [
...
export default function RenewableEnergyModule11Section3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 11 · Section 3 · BS EN 62305-1 / -2 · External standard referenced by BS 7671"
        title="BS EN 62305-1 / -2 lightning protection framework"
        backTo="../renewable-energy-module-11"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The BS EN 62305 standard series: -1 general principles, -2 risk management. Lightning
          Protection Zones (LPZ 0A / 0B / 1 / 2 / 3). Risk categories R1 (life), R2 (services), R3
          (heritage), R4 (economic). Tolerable risk thresholds. Separation distance s. How BS 7671
        ...
        <Pullquote>
          BS EN 62305 sits next to BS 7671, not inside it. Lightning is an external threat; the
          wiring regs reference the lightning standard for the methodology.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">BS EN 62305-1 General principles</strong> — defines
              lightning parameters (peak current, charge, specific energy), Lightning Protection
              Zones (LPZ 0A / 0B / 1 / 2 / 3), Lightning Protection Level (LPL I / II / III / IV),
              introduces the protection methods used in -3 + -4. Referenced by BS 7671 Reg
              534.4.4.4.2
            </li>
            <li>
              <strong className="text-white">BS EN 62305-2 Risk management</strong> — methodology
              for calculating lightning risk per category (R1-R4). Compares calculated risk to
              tolerable threshold (R_T). If R &gt; R_T, protection measures required. Referenced by
              BS 7671 Reg 443.1.1
            </li>
            <li>
              <strong className="text-white">BS EN 62305-3 Physical damage</strong> — external
              Lightning Protection System (LPS): air termination network, down conductors, earth
              termination, bonding, separation distance s. Referenced by BS 7671 Reg 712.534.101
              (PV) + Reg 542.2.3 + Reg 534.4.4.4.2(a)+(b)
            </li>
            <li>
              <strong className="text-white">BS EN 62305-4 Electrical + electronic systems</strong>{' '}
              — Surge Protective Devices (SPDs) + coordinated protection within structures.
              Referenced by BS 7671 Section 534 (covered in M11 §5)
            </li>
            <li>
              <strong className="text-white">IEC 61400-24</strong>— wind-turbine-specific lightning
              standard, subsidiary of the BS EN 62305 framework. Covers blade + nacelle + bearings +
              slip rings
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — for LCT installs: BS EN
              62305-2 risk assessment summary; BS EN 62305-3 separation calculation (where PV / wind
              inside LPS protected volume); BS EN 62305-4 SPD coordination per BS 7671 Section 534;
              IEC 61400-24 wind turbine DoC (where applicable)
            </li>
            <li>
              <strong className="text-white">Specialist input</strong>— full LPS design + risk
              assessment typically uses a chartered lightning-protection specialist (UK 2025-26
              ATLAS members accredited). Designer / electrician coordinates BS 7671 SPD + bonding
              scope alongside
            </li>
            <li>
              <strong className="text-white">UK 2025-26 typical domestic</strong> — short BS EN
              62305-2 risk summary + Reg 534 Type 2 SPDs at origin + at inverter is sufficient for
              most residential PV installs without LPS
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">LPZ 0A</strong> — direct lightning strike possible +
              full electromagnetic field. Outside any LPS shield. Example: roof of building without
              LPS; nacelle of wind turbine; PV array on unprotected roof
            </li>
            <li>
              <strong className="text-white">LPZ 0B</strong> — no direct strike (shielded by air
              termination network) but full electromagnetic field still present. Example: PV array
              inside the LPS protected volume on a building with LPS, where separation distance s is
              kept
            </li>
            <li>
              <strong className="text-white">LPZ 1</strong> — limited electromagnetic field.
              Typically first protected zone inside a structure with LPS + Type 1 / Type 2 SPDs at
              zone interface. Example: main switchgear room with SPDs at origin
            </li>
            <li>
              <strong className="text-white">LPZ 2</strong> — further reduced field. Typically
              deeper inside structure with additional Type 2 SPDs at LPZ 1/2 boundary. Example:
              sub-distribution boards
            </li>
            <li>
              <strong className="text-white">LPZ 3</strong> — innermost protection zone with
              sensitive electronics. Type 3 SPDs at LPZ 2/3 boundary, within ~10 m of equipment (Reg
              534.4.8). Example: server rooms, medical equipment
            </li>
            <li>
              <strong className="text-white">Zone boundary SPDs</strong>— Reg 534.4.1.2: "where a
              cable crosses the zonal interface, further SPDs shall be installed to preserve the
              zone integrity"
            </li>
            <li>
              <strong className="text-white">PV application</strong>— array on roof LPZ 0A or 0B; DC
              cables descend through zone interface to LPZ 1 at inverter location → SPD at DC entry
              to inverter. AC output through CU = Type 2 SPDs at LPZ 0/1 (origin)
            </li>
            <li>
              <strong className="text-white">Wind application</strong>— nacelle in LPZ 0A; mast
              structure provides partial shielding for cables inside; building entry = LPZ 1
              boundary → Type 1 (direct partial current possible) typically with Type 2
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          R = N × A × P × L. Calculate per category. Compare to tolerable. If higher, add
          protection. That\'s the BS EN 62305-2 loop.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">R1 — Loss of human life</strong>— risk that lightning
              causes injury or death (direct strike, step voltage, touch voltage, fire). Tolerable
              R_T typically 10⁻⁵ per year (1 in 100,000). Strictest threshold
            </li>
            <li>
              <strong className="text-white">R2 — Loss of service to public</strong> — risk to
              public services (telecoms, power, water, gas). Tolerable R_T typically 10⁻³ per year.
              Applicable to substations, pumping stations, exchanges
            </li>
            <li>
              <strong className="text-white">R3 — Loss of cultural heritage</strong> — risk to
              irreplaceable buildings + artefacts (historic sites, museums, religious buildings).
              Tolerable R_T typically 10⁻³ per year
            </li>
            <li>
              <strong className="text-white">R4 — Economic loss</strong>— risk to building +
              contents + business continuity. No mandated threshold — owner-assessed based on
              insurance + commercial impact
            </li>
            <li>
              <strong className="text-white">Calculation formula</strong>— R = N × A × P × L, where
              N = lightning ground flash density (per km²/year, UK typically 0.2-1.0), A = area
              equivalent factor (structure size + position), P = probability of damage per event, L
              = loss factor (severity)
            </li>
            <li>
              <strong className="text-white">Standard data</strong>— BS EN 62305-2 Annex provides P
              + L factors per damage type + protection measure. N from local lightning density data
              (Met Office + lightning detection networks)
            </li>
            <li>
              <strong className="text-white">Iteration</strong> — if R &gt; R_T, designer adds
              protection measures (LPS per BS EN 62305-3; SPDs per BS EN 62305-4 + BS 7671 Section
              534; bonding; shielded cabling) + recalculates. Iterate until R &lt; R_T
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — BS EN 62305-2 risk
              assessment report: structure description + calculated R per category + tolerable R_T +
              protection measures applied + post-protection R verification
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">LPL I (most stringent)</strong>— maximum lightning
              current 200 kA peak; covers ~99% of natural lightning events. Used for high-risk: fuel
              depots, ammunition, nuclear, hospitals, military
            </li>
            <li>
              <strong className="text-white">LPL II</strong>— maximum lightning current 150 kA peak;
              covers ~97% of events. Industrial + commercial high-value sites
            </li>
            <li>
              <strong className="text-white">LPL III</strong>— maximum lightning current 100 kA
              peak; covers ~91% of events. Most residential + standard commercial. Common default
              for UK LCT installs
            </li>
            <li>
              <strong className="text-white">LPL IV (least stringent)</strong>— maximum lightning
              current 100 kA peak (some parameters relaxed vs LPL III). Lower-risk structures
            </li>
            <li>
              <strong className="text-white">LPL → LPS design</strong>— LPL drives air termination
              mesh size (Faraday cage spacing), down conductor count + spacing, earth termination
              resistance requirements per BS EN 62305-3
            </li>
            <li>
              <strong className="text-white">LPL → SPD selection</strong>— LPL determines partial
              lightning current Iimp through SPD; affects Type 1 SPD selection per BS EN 62305-4 +
              BS 7671 Reg 534.4.4.4
            </li>
            <li>
              <strong className="text-white">Wind turbine LPL</strong>— IEC 61400-24 specifies LPL
              per turbine class — typically LPL I or II for utility-scale; LPL III for small wind
            </li>
            <li>
              <strong className="text-white">Designer records</strong>— chosen LPL + rationale based
              on BS EN 62305-2 risk assessment + customer requirements. Cert evidence bundle records
              the LPL + resulting LPS / SPD design
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Formula (BS EN 62305-3 Section 6.3)</strong> — s = (ki
              × kc × L) / km, where ki = isolation factor based on LPL (0.04 for LPL III/IV
              typical), kc = current sharing factor (1.0 single down conductor, less for multiple),
              L = path length along LPS from point of separation to nearest equipotential bonding
              point (m), km = isolation material factor (1.0 air; 0.5 solid material)
            </li>
            <li>
              <strong className="text-white">Typical residential</strong>— LPL III, single down
              conductor, L ~10-15 m: s typically 0.4-0.6 m (air separation). Achievable on most
              pitched roofs with rooftop-mounted PV
            </li>
            <li>
              <strong className="text-white">Typical commercial</strong>— LPL II, multiple down
              conductors, L ~5-20 m: s typically 0.2-0.4 m (current sharing reduces effective
              single-path current)
            </li>
            <li>
              <strong className="text-white">If s achieved</strong>— PV array is "isolated" from
              LPS. Standard Reg 712.534.102.1 Type 2 SPDs apply. No bonding between PV frame + LPS
              needed at the array
            </li>
            <li>
              <strong className="text-white">If s not achieved</strong>— two options per BS EN
              62305-3: (a) move PV elements to gain separation; (b) bond PV frame + mounting
              structure to LPS at designated points + accept that direct partial lightning current
              will flow through PV elements
            </li>
            <li>
              <strong className="text-white">Option (b) consequence</strong>— Reg 712.534.102.1: if
              direct strike protection specified + s not kept, Type 1 SPDs required (typically with
              Type 2 downstream). PV cables carry possible partial direct lightning current to
              inverter + structure
            </li>
            <li>
              <strong className="text-white">PV layout decision</strong>— designer + LPS specialist
              coordinate. Sometimes adjusting array position or adding LPS air terminations recovers
              separation. Sometimes bonding + Type 1 is the practical choice
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — BS EN 62305-3
              separation distance calculation attached to design; SPD selection per Reg
              712.534.102.1; bonding diagram (if option b); LPS specialist sign-off
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Domestic PV, no LPS</strong>— designer-led. Short BS EN
              62305-2 risk summary (R1 + R4 typical) + Reg 443 / 534 Type 2 SPD selection.
              Sufficient
            </li>
            <li>
              <strong className="text-white">Domestic PV, existing LPS</strong> — coordinate with
              LPS specialist for separation distance + Reg 712.534.101 application. LPS specialist
              may sign off the BS EN 62305-3 part; designer / electrician handles BS 7671 SPD
            </li>
            <li>
              <strong className="text-white">Commercial PV, no LPS</strong>— may be designer-led OR
              LPS specialist input depending on size + risk + customer policy. Larger arrays +
              commercial value typically justify specialist input
            </li>
            <li>
              <strong className="text-white">Commercial PV, existing LPS</strong> — LPS specialist
              input typical. Coordinate the integration; designer / electrician handles BS 7671 SPD
              + bonding + LPS specialist sign-off
            </li>
            <li>
              <strong className="text-white">Wind turbine</strong>— LPS specialist + turbine
              manufacturer DoC (IEC 61400-24). Designer / electrician handles BS 7671 SPD + bonding
              scope per the LPS design
            </li>
            <li>
              <strong className="text-white">Heritage / high-risk</strong>— full LPS specialist +
              full BS EN 62305 application. Designer / electrician role is the BS 7671 layer
            </li>
            <li>
              <strong className="text-white">UK 2025-26 accreditation</strong>— ATLAS (Association
              of Technical Lightning + Access Specialists) is the UK industry body. Chartered
              electrical engineers (CEng IET) with LPS specialism may also undertake the work
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — LPS specialist report
              attached to design package; designer/electrician BS 7671 SPD + bonding records
              reference the specialist\'s LPS design
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-11-section-2')}
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-11-section-4')}
