    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          What emergency lighting is for, who has the legal duty to provide it, and how the layered
          UK regime — RRO 2005, Workplace Regulations 1992, Approved Document B, BS 5266-1:2025 —
          fits together.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              spaces such as shop floors, dining halls, dance floors, lecture theatres. Minimum 0.5
              lx across the area excluding a 0.5 m perimeter strip. Maximum 40:1 ratio of brightest
              to darkest point — preventing dazzle and dark spots that would impede escape. Reduces
              panic by giving the room enough light to make the geometry comprehensible.
            </li>
            <li>
              <strong>High-risk task area lighting.</strong> The illumination at workstations where
              occupants must safely shut down a hazardous process before evacuating — printing
              presses, chemical reactors, large machinery, X-ray equipment, surgical rooms. Minimum
              15 lx OR 10% of the normal task illuminance, whichever is greater. Switch-on time ≤
              0.5 s (effectively instantaneous). Allows controlled shutdown rather than abrupt
              abandonment of a process that would itself become hazardous if left running.
            </li>
            <li>
              <strong>Standby lighting.</strong> NEW in BS 5266-1:2025 scope. Illumination allowing
              normal activity to continue during mains failure where the activity must continue —
              operating theatres, datacentre racks during controlled fail-over, broadcast studios.
              Levels and duration are use-specific; designed against the continuity-of-operation
              requirement, not the escape requirement.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              where required for the use of the premises, the provision of standby lighting to allow
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Escape route lighting solves <em>navigation</em> — does the occupant know which way to
              go? 1 lx is the level at which the human eye can read directional signs and see floor
              obstacles in a familiar route.
            </li>
            <li>
            ...
            <li>
              High-risk task lighting solves <em>continued operation safely</em> — can the operator
              continue to operate the equipment for the few seconds needed to make it safe? 15 lx or
              10% of task illuminance is the level at which control surfaces (buttons, gauges,
              valves, isolators) can still be read.
            </li>
            <li>
              Standby lighting solves <em>continuity of activity</em> — can the activity itself
              continue? Different from any of the above. Surgical operations cannot be paused for 3
              hours of mains failure; they must continue. Standby illuminance is set against task
              performance, not safe egress.
            </li>
          </ul>
          <p>
            ...
            a hospital theatre with adjoining recovery and corridor — need three or four overlaid.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="410" y="58" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="9.5">
              Responsible person — employer / owner / occupier / person with control of the premises
            </text>
            <text x="410" y="74" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              Duty cannot be discharged by appointing a contractor; engagement supports compliance,
            ...
            <g>
              ...
              <text x="122" y="166" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Recorded if 5+ employees
              </text>
              <text x="122" y="178" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <g>
              ...
              <text x="312" y="166" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Control · monitoring
              </text>
              <text x="312" y="178" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                Review of measures
              </text>
            </g>
            <g>
              ...
              <text x="502" y="178" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <g>
              ...
              <text x="692" y="178" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <g>
              ...
              <text x="160" y="286" textAnchor="middle" fill="rgba(255,255,255,0.72)" fontSize="9">
                UK Code of Practice — design,
              </text>
              <text x="160" y="299" textAnchor="middle" fill="rgba(255,255,255,0.72)" fontSize="9">
                install, commission, maintain,
              </text>
              <text x="160" y="312" textAnchor="middle" fill="rgba(255,255,255,0.72)" fontSize="9">
                verify (incl. 5-yr photometric)
              </text>
              <text x="160" y="325" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <g>
              ...
              <text x="410" y="286" textAnchor="middle" fill="rgba(255,255,255,0.72)" fontSize="9">
                Lighting applications —
              </text>
              <text x="410" y="299" textAnchor="middle" fill="rgba(255,255,255,0.72)" fontSize="9">
                illuminance levels (1 lx, 0.5 lx,
              </text>
              <text x="410" y="312" textAnchor="middle" fill="rgba(255,255,255,0.72)" fontSize="9">
                15 lx) + 2024 full-width rule
              </text>
              <text x="410" y="325" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <g>
              ...
              <text x="660" y="286" textAnchor="middle" fill="rgba(255,255,255,0.72)" fontSize="9">
                Emergency escape lighting
              </text>
              <text x="660" y="299" textAnchor="middle" fill="rgba(255,255,255,0.72)" fontSize="9">
                systems — testing regime
              </text>
              <text x="660" y="312" textAnchor="middle" fill="rgba(255,255,255,0.72)" fontSize="9">
                (daily / monthly / annual)
              </text>
              <text x="660" y="325" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <text x="410" y="392" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              In relation to a workplace — <strong>the employer</strong>, if the workplace is to any
              extent under the employer's control.
            </li>
            <li>
              In relation to any premises not falling within paragraph (a) above —{' '}
              <strong>the person who has control of the premises</strong> (as occupier or otherwise)
              in connection with the carrying on by them of a trade, business or other undertaking
              (for profit or not); or, if there is no such person, <strong>the owner</strong>.
            </li>
          </ul>
          <p>
            ...
            responsible persons can co-exist within one building (an HMO with communal landlord plus
            individual tenants; a shopping centre with the centre landlord plus each unit operator)
            and must cooperate (Art 22).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              person must ensure that — (a) emergency routes and exits are kept clear at all times;
              (b) the routes and exits lead as directly as possible to a place of safety; (h){' '}
              <strong>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              and EL-specific training to operate the test facilities, interpret discharge readings,
              identify and rectify faults, and (for the photometric survey) operate a calibrated
              luxmeter against the BS EN 1838 levels.
            </li>
            <li>
              <strong>Documented regime.</strong> Tests carried out, dates, results, defects found,
              defects rectified, signature, identity of tester. The log book per BS EN 50172:2024 §6
              is the legal record. A clean log is part of the responsible person's defence.
            </li>
            <li>
              <strong>Action on defects.</strong> Article 17 requires "efficient working order and
              good repair". A defect identified by a test that is not rectified breaks the duty. The
              defect, the date identified, the date rectified, and the corrective action all go into
              the log.
            </li>
            <li>
              <strong>Periodic re-verification.</strong> The system that worked at commissioning may
              not work after 10 years of lumen depreciation, dirt, decoration changes, and room
              layout shifts. The 5-year photometric survey (NEW in 2025) is the periodic
              re-verification that closes the gap between annual functional checks and actual site
              illuminance.
            </li>
          </ul>
          <p>
            Together, Articles 9, 11, 14, 17 and 32 form the legal architecture. Article 9 tells the
            responsible person to assess; Article 11 tells them to plan, organise and monitor;
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              5(3) to — (a) fail to comply with any requirement or prohibition imposed by articles 8
              to 22 and 38 (other than article 9(7)) where that failure places one or more relevant
              persons at risk of death or serious injury in case of fire. A person guilty of an
              offence under paragraph (1) is liable — (a) on summary conviction, to a fine; (b) on
              conviction on indictment, to a fine, or to imprisonment for a term not exceeding two
              years, or to both.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              available to a worker. Includes corridors, stairs, plant rooms, service areas as well
              as the working zones themselves.
            </li>
            <li>
              <strong>Particularly exposed to danger.</strong> The risk test. Operating machinery,
              working at height, working with hazardous substances, working alone without fixed-link
              communications — all candidates. The test is whether sudden lighting failure creates a
              real safety risk as distinct from inconvenience.
            </li>
            <li>
            ...
            <li>
              ...
              press: high-risk task lighting is needed so the press can be safely shut down. The Reg
              8 duty links to BS 5266-1:2025 as the technical delivery route.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Section 2.</strong> General duty to employees — health, safety and welfare so
              far as is reasonably practicable. Where lighting failure creates a workplace risk,
              providing emergency lighting is reasonably practicable in almost all premises.
            </li>
            <li>
              <strong>Section 3.</strong> Duty to non-employees — visitors, contractors, members of
              the public. Important in retail, hospitality, healthcare, education — where the people
              at risk are not on the employer's payroll.
            </li>
            <li>
          ...
          <p>
            ...
            the RRO (which is the specific fire-safety statute) rather than HSAW (the general duty).
            But HSAW operates in parallel. A failure at scale may attract charges under both
            regimes.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Escape routes should have lighting which provides illumination of suitable intensity,
              considered against the risks identified. Areas listed in Table 5.1 should have
              emergency escape lighting, including (a) escape routes through internal corridors and
              staircases, (b) underground or windowless accommodation, (c) places of assembly, (d)
              parts of premises used for sleeping accommodation, (e) escape routes serving high-risk
              areas. Emergency lighting should comply with BS 5266-1.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Escape routes through internal corridors &gt; 30 m, including the connections between
            ...
            <li>
              Places of assembly — auditoria, theatres, cinemas, dance halls, function rooms, large
              public areas. Open-area / anti-panic lighting typically required.
            </li>
            <li>
            ...
            <li>
              Escape routes serving high-risk areas — the route from the high-risk task area to the
              place of safety. High-risk task lighting at the workstation; escape route lighting on
              the egress path; anti-panic in any open area passed through.
            </li>
            <li>
          ...
          <p>
            The list is the starter checklist, not the entire job. The risk assessment may identify
            other rooms — a workshop with overhead crane, a chemical store, a datacentre rack room —
            where the local circumstances put EL on the list even though Approved Document B does
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Section 1 — Scope.</strong> Covers escape lighting (escape route + anti-panic
              + high-risk task), local-area lighting, AND standby lighting. Borrowed light is
              excluded as a source of design provision.
            </li>
            <li>
              <strong>Section 2 — Normative references.</strong> Calls up BS EN 1838:2024 for
              illuminance levels, BS EN 50172:2024 for system requirements and testing, BS EN 50171
              for central power supplies, BS EN 60598-2-22 for luminaire product standard, BS 7671
            ...
            <li>
              <strong>Section 5 — Design.</strong> Calculation methods, points of emphasis (at each
              exit, change of direction, intersection of corridors, every staircase, outside each
              final exit, near each fire alarm call point and firefighting equipment, near first-aid
              post, change of floor level), illuminance distribution rules.
            </li>
            <li>
            ...
            <li>
              <strong>Section 7 — Installation, commissioning, certification.</strong> Documentation
              pack — design certificate, installation certificate, commissioning certificate,
              photometric survey at handover.
            </li>
            <li>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              2016 edition may be deficient in 2025 if the premises has spaces that need local-area
              or standby coverage (care home bedrooms; hospital wards; operating theatres; broadcast
              studios; data-centre racks during fail-over).
            </li>
            <li>
              <strong>Borrowed-light exclusion.</strong> Light spilling in from an adjacent space no
              longer counts as design provision. Every space needing emergency lighting must be
            ...
            <li>
              <strong>5-year photometric verification.</strong> NEW periodic check. Every five years
              a calibrated luxmeter survey verifies that actual measured illuminance on the escape
              route, in open areas, and at high-risk points still meets the BS EN 1838:2024 levels.
              Catches lumen depreciation, dirt, decoration changes, and layout changes that an
              annual functional test cannot detect.
            </li>
            <li>
              <strong>High-risk area segmentation.</strong> NEW rule. Emergency luminaires in
              high-risk areas must be split across at least 2 separate circuits, each fault-isolated
              to ≤ 20 luminaires. A single circuit fault cannot disable the emergency provision in a
              hazardous area at the moment it is needed.
            </li>
          </ol>
          <p>
            Other 2025 changes — clarified handover documentation, refined illuminance calculation
            methodology, updated cross-references to BS EN 1838:2024 and BS EN 50172:2024, expanded
            annex on special premises — are also worth reading, but the four above are the ones that
            change design briefs and contract scopes.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              exceeding five years. The verification should establish that the measured illuminance
              at the points of emphasis, across the full width of the escape route (within the BS EN
              1838:2024 non-excluded boundary), across the open areas, and at the high-risk task
              points, is not less than the values specified in BS EN 1838:2024. Records should be
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Informal advice.</strong> First contact often a routine inspection identifying
              defects. The responsible person is given a list and a reasonable timeframe. Most
              premises rectify and the matter ends.
            </li>
            <li>
              <strong>Enforcement notice (RRO Art 30).</strong> Formal written notice requiring
              specific work within a stated period. Failure to comply is itself an offence. Notices
              are public record and routinely show up in due-diligence searches; insurer impact
              begins here.
            </li>
            <li>
              <strong>Prohibition notice (RRO Art 31).</strong> Serious — restricts or prohibits use
              of premises, in part or whole, until rectification. Issued where the use poses a risk
              so serious it must stop. Commercially devastating; few small businesses survive a long
              prohibition.
            </li>
            <li>
            ...
            <li>
              ...
              compliance with statute and relevant standards. A documented RRO breach is grounds for
              the insurer to void the policy retroactively or refuse to indemnify on the particular
              claim. The civil consequence of an EL failure can dwarf the criminal fine.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Maintenance log book (BS EN 50172:2024 §6).</strong> Daily / monthly / annual
              test records. Defects identified and rectified. Tester identity and competence record.
            </li>
            <li>
            ...
            <li>
              ...
              person's assessment that drove the EL provision in the first place and continues to be
              reviewed.
            </li>
            <li>
        ...
        <FAQ
          items={[
            ...
            {
              question: 'BS 5266-1 is a Code of Practice — can I follow a different design method?',
              answer:
