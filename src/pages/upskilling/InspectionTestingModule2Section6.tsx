...
const InspectionTestingModule2Section6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 2 · Section 6" title="Re-energisation procedures" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The closing-out sequence: final dead checks, the careful first close, what happens if a
          breaker trips, the live readings that prove the design works under power, and the
          handover.
        </p>
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              temporary line-to-CPC link at the board MUST be physically removed and the conductors
              restored to their normal terminals. A high-visibility flying lead helps — but
              verifying its removal at the board is the actual control.
            </li>
            <li>
              <strong>All conductors landed in their correct terminals.</strong> Reg 526.1 requires
              that all conductor connections, including connections to busbars, are correctly
              located in terminals and are tight and secure. Visually verify each outgoing way: line
              on line, neutral on neutral, CPC on the earth bar.
            </li>
            <li>
              <strong>No foreign objects in the enclosure.</strong> Cable offcuts, screwdriver tips,
              washers, sleeving offcuts. A loose conductor strand bridging two terminals is
              indistinguishable, in fault terms, from a designed short circuit. Sweep the enclosure
              with a torch and inspect.
            </li>
            <li>
              <strong>Terminations torque-checked.</strong> To the manufacturer&rsquo;s stated value
              using a calibrated torque screwdriver, where the manufacturer specifies one. Reg 526.1
              and Section 543 expect tight and secure terminations; the temperature rise that a
              loose termination produces under load is the failure mode this prevents.
            </li>
            <li>
              <strong>Earthing and bonding reconnected.</strong> Any earthing conductor disconnected
              for an earth-electrode test, any bonding conductor temporarily lifted to break a
              parallel path during R1+R2, must be reconnected. Reg 643 and the GN3 procedure for
              EFLI testing both require reconnection BEFORE re-energisation.
            </li>
            <li>
              <strong>Insulation resistance results reviewed.</strong> Confirm every circuit tested
              is above the Table 64 minimum (1.0 MΩ at 500 V DC for low-voltage circuits; 0.5 MΩ at
              250 V DC for SELV/PELV; 1.0 MΩ at 250 V DC post-equipment-connection per Reg 643.3.3).
              A circuit that scraped past 1.0 MΩ deserves a comment in the record, not just a tick.
            </li>
            <li>
              ...
              supply this is checking that line is on line and neutral is on neutral at the cut-out.
              On three-phase, sequence as well.
            </li>
            <li>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              Confirm all outgoing OCPDs are OFF / withdrawn. Confirm RCDs / RCBOs are also in their
              OFF position (an RCD in ON with no load is fine; in OFF removes it from the circuit
              during the close).
            </li>
            <li>
              Stand to one side. Close the main switch in one decisive motion. Listen for any arc,
              smell for any insulation breakdown, look for any visible flash. If anything unexpected
              happens, open the main switch immediately.
            </li>
            <li>
              With main switch on and outgoing ways off, verify supply polarity at the origin using
              a GS38 voltage indicator. Reg 643.6 lists this as a pre-energisation test but it
              remains valid as a confirmatory check at first close.
            </li>
            <li>
              Pre-test the RCD (test button) before any load is on it. The test button verifies the
              trip mechanism mechanically and electronically. A failed test-button trip means the
              device is replaced before the circuit is energised.
            </li>
            <li>
              Close the first outgoing OCPD. Pause two seconds. Does it hold? Are there any obvious
              symptoms downstream — light not coming on when expected, smoke from a socket, the
              customer&rsquo;s alarmed face? If clear, move to the next.
            </li>
            <li>
              Close each outgoing OCPD in turn. RCBO / RCD-protected circuits last where practical,
              so the RCD&rsquo;s own load-side conditions are tested with the rest of the
              installation already up.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Where relevant, the polarity of the supply at the origin of the installation shall be
              verified before the installation is energized. Where single-pole switching devices are
              not permitted in the neutral conductor, a test shall be made to verify that all such
        ...
        >
          <p>
            ...
            A4:2026 maximum-permitted-Zs column on the Schedule of Circuit Details where the design
            has set a tighter limit). For RCD-protected circuits where disconnection relies on the
            RCD rather than the OCPD, the additional acceptance criterion is IΔn × Zs ≤ 50 V (the
            touch-voltage limit).
          </p>
          <p>
            Live measured Zs is normally close to the calculated Zs from the dead test, but expect a
            small difference: cable runs hotter when energised under load, conductor resistance has
            a positive temperature coefficient, and instrument tolerance adds its own scatter. A
            measured Zs that is wildly higher than calculated is a flag — loose termination,
            parallel earth path that contributed to a misleadingly low dead R1+R2, longer cable than
            assumed, wrong device size — and needs investigation, not acceptance.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 643.7.3 and Reg 643.8 are both satisfied by an alternating-current test at the rated
            residual operating current (1×IΔn). The acceptance is that the device disconnects within
            the time required by Chapter 41: for a general non-delay type, a 300 ms maximum; for a
          ...
          <p>
            ...
            ms general-type limit is what the A4 form expects on the Schedule of Test Results.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              suitable test equipment according to BS EN 61557-6 (see Regulation 643.1) to confirm
              that the relevant requirements of Chapter 41 are met, taking into account the
              operating characteristic of the device. NOTE: Regardless of RCD Type, effectiveness is
              deemed to have been verified where an RCD disconnects within the stated time with an
              AC test at the rated residual operating current (IΔn) — for a general non-delay type,
              300 ms maximum.
            </>
          }
        ...
        >
          <p>
            ...
            voltage indicator at the right combinations of terminals confirms or denies in seconds.
            A wrong-polarity socket will read L–E as live and N–E as live, instead of L–E live and
            N–E near-zero.
          </p>
        </ConceptBlock>
          ...
          whatToDo={
            <>
              <span className="block">
                1. Final dead checks (the eight items): link removed, terminations torqued, earthing
                and bonding reconnected, no offcuts in the enclosure, IR results documented,
                polarity at origin verified, all RCBOs OFF.
              </span>
              <span className="block">
              ...
              <span className="block">
                ...
                neutral. RCD trip-time test at 1×IΔn at the furthest point of each RCBO group.
              </span>
              <span className="block">
                6. Live Zs at the furthest point of each final circuit. Compare to the A4
                max-permitted-Zs column on the Schedule of Circuit Details. Flag any that have crept
                up versus the calculated values.
              </span>
              <span className="block">
                7. Hand over: walk the duty holder through the certificate, the Schedule of
                Inspection, and the Schedule of Test Results. Highlight the live Zs and RCD readings
                as the live evidence the design works.
              </span>
            </>
          }
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              no load present is most likely a magnetic trip on a short circuit. An RCD tripping is
              a residual-current event — likely L–E or N–E fault, or a borrowed neutral. An RCBO can
              be either; check the indicator.
            </li>
            <li>
              <strong>Visual.</strong> Open the enclosure. Look for the obvious — a wire shorted to
              the metal back, a screwdriver tip, a strand bridging terminals, a damaged cable from
              cable management.
            </li>
            <li>
              <strong>Insulation resistance test on the affected circuit.</strong> 500 V DC L–N,
              L–E, N–E with the equipment disconnected per Reg 643.3.3. Anything below 1.0 MΩ is the
              fault. A near-zero reading L–E is a short to earth and is your trip cause; investigate
              the cable run, check J-boxes and accessories.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Where the main isolation is and how it is operated (Reg 462.1.201 — main linked switch
              as near as practicable to the origin).
            </li>
            <li>
            ...
            <li>
              The Schedule of Circuit Details — which way feeds which circuit, the protective device
              rating and type, the maximum permitted Zs (especially where the A4 max-permitted-Zs
              column has been used to set a tighter limit than Table 41 raw).
            </li>
            <li>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              measured Zs, RCD trip time at 1×IΔn. Two decimal places for resistance, milliseconds
              for the trip time.
            </li>
            <li>
            ...
            <li>
              ...
              earth paths, calculated values used in lieu of measured, equipment disconnected for a
              test, defects in the existing installation. The comments box is where the next
        ...
        <FAQ
          items={[
            ...
            {
              question: 'What if my live Zs reading is significantly LOWER than the calculated Zs?',
              answer:
