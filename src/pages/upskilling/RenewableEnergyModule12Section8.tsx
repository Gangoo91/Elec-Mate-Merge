...
const inlineChecks = [
  ...
  },
  {
    ...
    question: "How do M1-M11 + M12 fit together in the Renewable Electrician's mental model?",
    options: [
  ...
  },
  {
    ...
    question: 'What does the upcoming mock exam aim to assess?',
    options: [
  ...
  },
  {
    ...
    question: 'What continued professional development (CPD) is appropriate beyond this course?',
    options: [
...
const quizQuestions = [
  ...
  {
    question: 'UK 2025-26 LCT retrofit pipeline — what is the dominant install pattern?',
    options: [
  ...
  {
    question: 'Mock exam preparation — what is the recommended approach?',
    options: [
  ...
  {
    question: "What does the Renewable Electrician's career look like UK 2025-30?",
    options: [
  ...
  {
    question: 'Beyond the mock exam — what next?',
    options: [
...
export default function RenewableEnergyModule12Section8() {
  ...
  useSEO({
    title:
      'The Renewable Electrician — synthesis + mock exam preview | Renewable Energy 12.8 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 12 · Section 8 · Course-closing synthesis + mock exam preview"
        title="The Renewable Electrician — synthesis + mock exam preview"
        backTo="../renewable-energy-module-12"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The course-closing synthesis. The Renewable Electrician identity — BS 7671 expert + LCT
          specialist + customer-facing professional + lifecycle thinker. M1-M12 integrated mental
          model. UK 2025-26 LCT install pipeline + career trajectory. Mock exam framing +
          preparation approach + what next. Beyond the course — continued professional development +
          the lifelong build.
        </p>
        ...
        <Pullquote>
          You came here to upgrade from electrician to Renewable Electrician. You\'ve walked through
          11 modules of frameworks + technologies + verification + handover. The mock exam is next —
          the practice begins after.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">BS 7671 + A4:2026 foundation</strong> — fully-qualified
              electrician with current standard knowledge; C&G 2382 + 2391 typical; ongoing CPD
            </li>
            <li>
              <strong className="text-white">LCT-specific competencies</strong> — Section 712 PV +
              Chapter 57 BESS + Section 722 EV + Part 4-7 + manufacturer for heat pumps + Section
              551 generating sets + Chapter 82 PEI + Reg 722.411.4 outdoor + Chapter 64 + 65
              verification
            </li>
            <li>
              <strong className="text-white">Manufacturer-certified-installer status</strong> —
              across the relevant LCT manufacturers; warranty + commissioning + warranty support
              pathways
            </li>
            <li>
              <strong className="text-white">Multi-trade coordination</strong> — MCS company
              orchestrates; F-gas refrigerant specialist; civils + planning; the electrician
              integrates the BS 7671 install
            </li>
            <li>
              <strong className="text-white">Systems thinking</strong> — multi-source LCT is not the
              sum of technologies but an integrated energy system; design + verify + support the
              integration
            </li>
            <li>
              <strong className="text-white">Customer-facing professional</strong> — handover
              meeting + operating guide + annual touchpoint + lifecycle management + property sale
              transitions
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle discipline</strong> —
              comprehensive lifecycle record per install supports safety + customer + warranty +
              audit + property + reputation
            </li>
            <li>
              <strong className="text-white">Lifelong build</strong> — CPD + manufacturer cycles +
              emerging tech + industry engagement + peer + mentor. The Renewable Electrician
              identity matures over years
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">M1 Foundations</strong>— LCT landscape + UK
              decarbonisation context + regulatory frameworks (BS 7671 + MCS + EREC + BUS + SEG)
            </li>
            <li>
              <strong className="text-white">M2-M4 Solar PV</strong>— dominant LCT in UK 2025-26;
              Section 712 + Reg 712.421.101 IMD + anti-islanding + EREC + MIS 3002
            </li>
            <li>
              <strong className="text-white">M5 BESS</strong>— storage increasingly paired with PV;
              Chapter 57 + Section 551 + BMS lifecycle
            </li>
            <li>
              <strong className="text-white">M6-M7 EV charging</strong> — mass-market growth path;
              Section 722 + Reg 722.411.4 + OPDD + RDC-DD
            </li>
            <li>
              <strong className="text-white">M8 Heat pumps</strong>— heating decarbonisation pillar;
              BUS grant gateway; Part 4-7 + MIS 3005
            </li>
            <li>
              <strong className="text-white">M9 Other LCT</strong>— wind + solar thermal + biomass +
              CHP + hydro + hydrogen; Section 551 unifying framework + per-MIS technology standards
            </li>
            <li>
              <strong className="text-white">M10 Hybrid + EMS + smart export</strong> — multi-source
              integration; Chapter 82 PEI; SEG + EREC G100; V2G; grid-forming
            </li>
            <li>
              <strong className="text-white">M11 Chapter 81 + lightning + fault levels</strong> —
              regulatory framework integration + BS EN 62305 LPS + fault contribution from
              multi-source
            </li>
            <li>
              <strong className="text-white">M12 Verification + EICR + handover</strong> — lifecycle
              discipline; Chapter 64 IV + Chapter 65 EICR + MCS handover + customer education + cert
              evidence bundle
            </li>
            <li>
              <strong className="text-white">Cross-cutting</strong>— BS 7671:2018+A4:2026
              throughout; cert evidence bundle audit trail; skilled-person competency;
              customer-facing professional standard
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          The next generation of homes will be born with PV, BESS, heat pumps, and EV chargers
          integrated. The next decade of retrofits will dwarf the last. The Renewable Electrician is
          the trade for that pipeline.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">PV install volume</strong> — ~150-250k/yr UK 2025-26;
              growing toward higher with falling install costs + improving payback
            </li>
            <li>
              <strong className="text-white">BESS install volume</strong> — ~30-80k/yr UK 2025-26;
              accelerating as costs fall + customers experience PV self-consumption value + grid
              arbitrage potential
            </li>
            <li>
              <strong className="text-white">Heat pump install volume</strong> — ~50-100k/yr UK
              2025-26 driven by BUS grant; UK 2030 target 600k/yr; substantial scaling required
            </li>
            <li>
              <strong className="text-white">EV charger install volume</strong> — high-volume;
              ~500k+ EV chargers total UK; growth aligned with EV adoption (~1m/yr EV sales by 2030)
            </li>
            <li>
              <strong className="text-white">Multi-source integration</strong> — increasingly
              standard new-build + retrofit pattern; the Renewable Electrician\'s integrated
              competency is the value proposition
            </li>
            <li>
              <strong className="text-white">Commercial + industrial LCT</strong> — leisure centres,
              hospitals, offices, warehouses, farms scaling LCT; larger projects + grid services +
              smart export + V2G
            </li>
            <li>
              <strong className="text-white">Lifecycle services</strong> — installed base growing
              means EICR-equivalent + monitoring + warranty + repair + replacement scales; recurring
              revenue
            </li>
            <li>
              <strong className="text-white">Emerging tech</strong>— hydrogen (policy direction);
              fuel cells; V2G expanding 2026-30; grid-forming inverters; advanced BMS chemistries
              (solid-state, sodium-ion)
            </li>
            <li>
              <strong className="text-white">Policy backstop</strong> — UK 2030 + 2050 net-zero +
              heat decarbonisation + EV transition all support sustained LCT growth
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Regulatory knowledge</strong> — reg cites + meaning +
              application across Section 712 / Chapter 57 / Section 722 / Section 551 / Chapter 64 /
              Chapter 65
            </li>
            <li>
              <strong className="text-white">Technology-specific scenarios</strong> — PV / BESS / EV
              / heat pumps / wind / solar thermal / biomass / CHP / micro-hydro / hydrogen +
              emerging
            </li>
            <li>
              <strong className="text-white">Multi-source integration</strong> — Chapter 82 PEI +
              Reg 551.4.2 + Reg 551.7.5 + coordinated architecture + integrated EICR-equivalent
            </li>
            <li>
              <strong className="text-white">Verification + EICR + cert evidence bundle</strong> —
              Chapter 64 IV + Chapter 65 EICR + MCS handover pack + classification codes
              (C1/C2/C3/FI)
            </li>
            <li>
              <strong className="text-white">Customer-facing scenarios</strong> — handover meeting +
              fault response + warranty events + property sale transitions
            </li>
            <li>
              <strong className="text-white">Format</strong>— applied judgment on realistic install
              + verification + lifecycle problems; multiple choice + scenario application
            </li>
            <li>
              <strong className="text-white">Preparation</strong>— systematic M1-M12 review; key
              regs revisit; applied scenarios; multi-source thinking; common mistakes; FAQs; cert
              evidence bundle thinking
            </li>
            <li>
              <strong className="text-white">Rest + day-of</strong>— rest before exam; engaged not
              exhausted; on exam day read questions carefully + identify context + apply mental
              model + answer methodically
            </li>
            <li>
              <strong className="text-white">Outcome</strong>— passing validates Renewable
              Electrician competency; supports professional standing + customer + manufacturer + DNO
              + Ofgem credibility
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">BS 7671 amendments</strong> — A4:2026 current at course
              writing; future amendments will follow; track via IET / NICEIC / ECA publications
            </li>
            <li>
              <strong className="text-white">MCS standard updates</strong> — MIS 3001-3008 evolve;
              product approval lists updated; track via MCS website + installer membership
            </li>
            <li>
              <strong className="text-white">Manufacturer-certified-installer training</strong> —
              ongoing courses + product updates + new technology; maintain certification cycles
            </li>
            <li>
              <strong className="text-white">Emerging LCT</strong>— hydrogen + fuel cells + V2G +
              grid-forming inverters + advanced BMS chemistries; track emerging
            </li>
            <li>
              <strong className="text-white">Industry CPD</strong>— IET (Institution of Engineering
              + Technology) + NICEIC + ECA + Solar Energy UK + Heat Pump Federation + IEEE
              conferences + IET Wiring Regulations conferences
            </li>
            <li>
              <strong className="text-white">Hands-on practice</strong> — install + verification +
              EICR experience builds tacit competency; deliberate reflection on completed installs
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle review</strong> — your own
              installs over time are rich learning when reviewed at EICR-equivalent + warranty
              events
            </li>
            <li>
              <strong className="text-white">Peer + manufacturer + DNO engagement</strong> —
              community learning + technical support + connection engineering insight
            </li>
            <li>
              <strong className="text-white">Mentoring + apprentice training</strong> — next
              generation of Renewable Electricians; deepen own understanding via teaching
            </li>
            <li>
              <strong className="text-white">UK 2025-26 to 2050</strong> — the field will evolve
              substantially; the lifelong build is continuous; the Renewable Electrician identity
              matures over years
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Tools acceleration</strong> — circuit designer for LCT
              supply circuits + RCD + protective architecture; RAMS for site safety; cost engineer
              for quote + project pricing
            </li>
            <li>
              <strong className="text-white">Inspection + EICR digital</strong> — Schedule of
              Inspections + Schedule of Test Results + EICR-equivalent reports digital; cert
              evidence bundle storage
            </li>
            <li>
              <strong className="text-white">Reference + lookup</strong> — BS 7671 regs +
              LCT-specific framework + manufacturer DoCs; on-demand
            </li>
            <li>
              <strong className="text-white">Mate AI agent</strong> — on-demand assistance for
              regulatory questions + scenario navigation + reference lookup
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — comprehensive lifecycle
              record per install; supports customer + warranty + audit + property + reputation
            </li>
            <li>
              <strong className="text-white">Customer-facing workflow</strong> — handover meeting
              digital tools + operating guide generation + annual touchpoint scheduling
            </li>
            <li>
              <strong className="text-white">Multi-trade coordination</strong> — MCS company +
              refrigerant specialist + manufacturer commissioning + electrician on integrated
              platform
            </li>
            <li>
              <strong className="text-white">Lifecycle services</strong> — EICR-equivalent +
              monitoring + warranty + customer annual touchpoint at scale; recurring revenue
            </li>
            <li>
              <strong className="text-white">Reality 2025-26</strong> — competent + tooled Renewable
              Electrician = productivity + quality + customer + business growth benchmark; the
              future of UK electrical contracting
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RenewableElectricianSynthesis caption="The Renewable Electrician — M1-M12 synthesis + lifecycle + career diagram. Top: M1-M12 integrated model — M1 Foundations / M2-M4 PV / M5 BESS / M6-M7 EV / M8 heat pumps / M9 other LCT / M10 hybrid + EMS / M11 Chapter 81 + lightning + fault / M12 verification + EICR + handover. Middle: competency stack — BS 7671 + A4:2026 + LCT-specific + manufacturer-certified-installer + multi-trade coordination + systems thinking + customer-facing + cert evidence bundle discipline. Lower middle: UK 2025-30 trajectory — install demand growing across PV / BESS / heat pumps / EV / commercial-industrial; competent installer shortage; integration standard; emerging tech (hydrogen, V2G, grid-forming); UK 2030 + 2050 net-zero targets. Bottom: lifelong build — mock exam validation + ongoing CPD + manufacturer training cycles + industry engagement + hands-on practice + cert evidence bundle review + peer + mentoring + the Renewable Electrician identity matures over years." />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-12-section-7')}
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-mock-exam')}
