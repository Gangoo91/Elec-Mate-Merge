...
const DESCRIPTION =
  "Learn which equipment types are covered by PAT testing, understand Class I and Class II classifications, and identify what's included and excluded from PAT testing scope.";
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Class I equipment relies on earthing for protection and must have earth continuity tested. Class II equipment uses double insulation for protection and typically only needs visual inspection and insulation resistance testing.',
  },
  {
    id: 'kettle-testing',
    ...
    correctIndex: 2,
    explanation:
      'A kettle is Class I portable equipment that requires both visual inspection and electrical testing (including earth continuity) as part of PAT.',
  },
  {
    id: 'fixed-equipment',
    ...
    correctIndex: 1,
    explanation:
      'Wall-mounted air conditioning units are considered fixed equipment and fall outside the scope of PAT testing, even if they have plugs for electrical connection.',
  },
  {
    id: 'battery-tools',
    ...
    correctIndex: 1,
    explanation:
      "Hand-held battery tools with no mains connection (purely battery operated) are excluded from PAT testing as they don't connect to the mains electrical supply.",
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Class I equipment relies on earthing for protection and must be tested. Class II equipment uses double insulation and typically only needs visual inspection.',
  },
  {
    id: 2,
    question: 'Does a kettle need PAT testing?',
    ...
    correctAnswer: 2,
    explanation:
      'A kettle is Class I portable equipment that requires both visual inspection and electrical testing as part of PAT.',
  },
  {
    id: 3,
    question: "Is a wall-mounted air conditioning unit 'portable'?",
    ...
    correctAnswer: 1,
    explanation:
      'Wall-mounted air conditioning units are considered fixed equipment and fall outside the scope of PAT testing, even if they have plugs.',
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      'Laptop chargers are portable equipment and should be included in PAT testing as they can pose electrical safety risks.',
  },
  {
    id: 5,
    question: 'Which item is excluded from PAT testing?',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Class II equipment is marked with a square within a square symbol, indicating double insulation protection without requiring an earth connection.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Hand-held power tools on construction sites typically need the most frequent testing (every 3 months) due to harsh conditions and high risk of damage.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'A freestanding vending machine with a plug is considered portable equipment for PAT purposes, regardless of weight, as it can be moved and connected to different locations.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      "Equipment is 'portable' if it can be moved while in operation or moved between different locations for use. Weight alone doesn't determine portability.",
  },
  {
    id: 10,
    ...
    correctAnswer: 2,
    explanation:
      "Class I and Class II equipment require different testing approaches. Class I needs earth continuity testing, while Class II (double insulated) doesn't require earth testing.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Class II equipment is marked with a square-within-square symbol and has no earth connection in the plug. Class I equipment typically has metal parts that could become live if insulation fails and has an earth connection. If unsure, check the rating plate or manufacturer documentation.',
  },
  {
    question: 'Does personal equipment brought into work need PAT testing?',
    answer:
      'Yes, personal equipment used in the workplace (phone chargers, fans, heaters) should be included in PAT testing. Employers remain responsible for electrical safety of all equipment used on their premises, regardless of ownership.',
  },
  {
    question: 'Are extension leads considered portable equipment?',
    answer:
      'Yes, extension leads are definitely portable equipment and should be included in PAT testing. They often fail tests due to damage from being moved, trodden on, and repeatedly connected/disconnected. Many consider them high-priority items.',
  },
  {
    question: 'What about equipment with detachable leads?',
    answer:
      'Both the equipment and its detachable lead should be tested. The IEC lead (kettle lead/figure-8 lead) is itself portable equipment and should be tested separately. Keep leads with their equipment or test and label them individually.',
  },
  {
    question: 'Is medical equipment covered by PAT?',
    answer:
      'Medical equipment has separate, more stringent testing requirements under different regulations. While general workplace PAT principles apply, medical devices typically require specialised testing by qualified biomedical engineers following specific standards.',
  },
  {
    question: 'Do battery chargers need PAT testing?',
    answer:
      "Yes, mains-powered battery chargers (for tools, phones, laptops, etc.) are portable equipment requiring PAT testing. The charger connects to mains supply and poses the same risks as other portable equipment. The battery-powered tool itself doesn't need PAT.",
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Class I:</strong> Earthed equipment - requires full testing
              </li>
              <li>
                <strong>Class II:</strong> Double insulated - visual + insulation test
              </li>
              <li>
                <strong>Portable:</strong> Can be moved while in use or between uses
              </li>
              <li>
                <strong>Excluded:</strong> Fixed installations, battery-only tools
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Square-in-square symbol = Class II
              </li>
              <li>
                <strong>Use:</strong> Check rating plates for classification
              </li>
              <li>
                <strong>Apply:</strong> Different tests for different classes
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Not everything with a plug needs PAT testing — but many things do. Understanding the
              classification system helps you identify which equipment requires testing and what
              tests to apply.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-sm text-white mb-2">
                  Double insulated — visual + insulation test
                </p>
                <ul className="text-sm text-white space-y-1">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Key point:</strong> Class II equipment is marked with a square-within-square
              symbol (□) and has no earth wire in the plug.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              PAT testing covers a wide range of portable electrical equipment used in workplaces.
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Important:</strong> Just because something has a plug doesn't make it
              'portable' for PAT purposes. Fixed equipment that happens to use a plug connection is
              still considered fixed installation.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Not all equipment carries the same risk. Understanding risk levels helps prioritise
              testing resources and determine appropriate testing frequencies.
            </p>
            ...
            <div className="grid sm:grid-cols-3 gap-4 my-6">
              <div>
                ...
                <p className="text-xs text-elec-yellow/70 mt-2">
                  Requires frequent testing and careful attention
                </p>
              </div>
              <div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm font-medium text-elec-yellow mb-2">
                Case Study: Hair Salon Equipment Oversight
              </p>
              <div className="space-y-3 text-sm text-white">
                <p>
                  <strong>Situation:</strong> A hair salon tested dryers, clippers, and extension
                  cords — but missed the washing machine, assuming it was out of scope because it
                  was "too heavy to move."
                </p>
                <p>
                  <strong>The Reality:</strong> The washing machine was portable equipment with a
                  standard plug that should have been included in PAT testing. Weight doesn't
                  determine portability.
                </p>
                <p>
                  <strong>The Lesson:</strong> Equipment weight or movement frequency doesn't
                  determine PAT scope — connection type and workplace use do. If it has a plug and
                  can theoretically be moved, it needs testing.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Creating Equipment Registers
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Assuming heavy = fixed</strong> — weight doesn't determine if equipment is
                  portable
                </li>
                <li>
                  <strong>Missing extension leads</strong> — they're high priority items often
                  overlooked
                </li>
                <li>
                  <strong>Forgetting chargers</strong> — laptop and phone chargers need testing too
                </li>
                <li>
                  <strong>Excluding personal items</strong> — everything used at work should be
                  tested
                </li>
              </ul>
            </div>
