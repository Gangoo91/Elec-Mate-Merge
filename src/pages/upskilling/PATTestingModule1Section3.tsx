    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The scope question. The IET Code of Practice §3 splits in-service equipment by mobility
          and by construction class. The decisive question is not 'is it portable' but 'is it
          in-service equipment whose maintenance is the duty-holder concern under EAWR / PUWER'.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Equipment connected by spur (a fused connection unit feeding a hand drier, a heater, a
              fixed luminaire with on-board electronics) — in scope.
            </li>
            <li>Equipment connected by industrial connector (BS EN 60309) — in scope.</li>
            <li>
              Equipment connected by IEC C13 / C19 cordsets — both the equipment AND the cordset are
              in scope as separate items.
            </li>
            <li>
              Hard-wired fixed equipment in service — in scope, with adapted test methods (the unit
              is energised in situ rather than via the tester).
            </li>
          </ul>
        ...
        >
            ...
            <table className="w-full text-[13.5px] my-2">
              ...
              <tbody className="text-white/95">
                ...
                <tr className="border-b border-white/[0.06]">
                  ...
                  <td>
                    Equipment having a mass exceeding 18 kg and not provided with a carrying handle.
                ...
                <tr className="border-b border-white/[0.06]">
                  ...
                  <td>
                    Less than 18 kg, intended to be moved while in operation or which can easily be
                    moved from one place to another while connected.
                  </td>
          ...
          <p>
            Hand-held equipment carries the tightest acceptance values for PE continuity (§15.4) and
            the shortest recommended starting frequencies in Table 7.1 — because it has the most
            mechanical handling and the user is in direct contact with the casing during fault.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              They wear independently of the equipment — frequent connect / disconnect cycles, cable
              damage near the cord entry on both ends.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              one fuse, sometimes mixing 13 A and BS 4343 connectors via informal adaptors. The IET
              CoP and HSG107 advise against daisy-chaining.
            </li>
            <li>
          ...
          <p>
            ...
            place these on a 12-month or shorter cycle in offices and a 3-month or shorter cycle in
            construction / harsh environments — separately from the equipment they connect.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            A portable RCD whose test button works but whose internal magnetic / electronic trip has
            failed will pass the user check and fail the instrument test — the value of including
            portable RCDs in the formal regime.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>110 V extension leads</strong> (yellow BS 4343 connectors, 16 A / 32 A) — each
              lead a separate item.
            </li>
            <li>
            ...
            <li>
              <strong>110 V temporary lighting sets</strong> — strings of festoon, work-lights, area
              lights.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>IR</strong> — between each line and earth, between each pair of lines, at 500
              V dc.
            </li>
            <li>
        ...
        <ContentEyebrow>Edge cases — battery, landlord-supplied, contractor-brought</ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              of misuse). Charger: full PAT regime (Class I or Class II per the rating plate, lead,
              plug, IR / continuity).
            </li>
            <li>
              <strong>Cordless tools with integrated chargers</strong> (rare on professional tools,
              more common on consumer-grade) — full PAT regime applies because the unit is
              mains-connectable.
            </li>
            <li>
        ...
        >
          <p>
            The IET CoP §3.6 expressly covers landlord-supplied equipment. The frequency question is
            risk-assessed but typically the starting position is:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
            ...
            <li>
              ...
              2020 regulations); equipment supplied by the tenant is out of scope of the landlord\'s
              programme.
            </li>
          </ul>
          <p>
            Records remain the defendable artefact. A landlord-supplied kettle without a test record
            is the same compliance gap as a workplace kettle without one.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Risk-assessed frequency</strong> with effective date and reasoning reference.
            </li>
            <li>
          ...
          <p>
            The register format (paper, spreadsheet, dedicated PAT software) does not matter to the
            regulator — what matters is that it exists, is current, and is retrievable. The IET CoP
            and HSG107 are agnostic on format; they are prescriptive on content.
          </p>
        </ConceptBlock>
