...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'RTDs (Resistance Temperature Detectors) work on the principle that the electrical resistance of certain metals increases predictably with temperature.',
  },
  {
    id: 'high-temp-sensor',
    question: 'Which sensor is best for high-temperature environments?',
    options: ['Thermistor', 'RTD', 'Thermocouple', 'Infrared sensor'],
    correctIndex: 2,
    explanation:
      'Thermocouples can withstand the highest temperatures (up to 2000°C or more) and are most suitable for harsh, high-temperature industrial environments.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Thermistors offer the highest sensitivity and precision for temperature measurement, but only within their specific, relatively narrow temperature range.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      'Resistance change with temperature',
      'Voltage generated from joined dissimilar metals',
      'Capacitance variation with applied heat',
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Thermocouples can withstand the highest temperatures (up to 2000°C or more with the right type) and are most suitable for harsh, high-temperature industrial environments.',
  },
  {
    id: 3,
    question: "What's the main advantage of a thermistor?",
    options: [
      'A very wide usable temperature range',
      'High sensitivity and precision in narrow temperature ranges',
      'Rugged construction for harsh sites',
      'Self-powered operation with no excitation',
    ],
    correctAnswer: 1,
    explanation:
      'Thermistors offer the highest sensitivity and precision for temperature measurement, but only within their specific, relatively narrow temperature range.',
  },
  {
    ...
    options: [
      'It is the most expensive sensor option',
      'It generally has poor measurement accuracy',
      'It requires no external excitation current',
      'Its fragile element is susceptible to vibration and shock',
    ],
    correctAnswer: 3,
    explanation:
      'RTDs have delicate wire elements that can be damaged by vibration, shock, and mechanical stress, making them less suitable for harsh industrial environments.',
  },
  {
    id: 5,
    question: 'Which sensor offers the fastest response time?',
    options: ['RTD', 'Thermistor', 'Thermocouple', 'Bimetallic strip'],
    correctAnswer: 2,
    explanation:
      'Thermocouples have the fastest response time due to their small thermal mass and direct junction construction, making them ideal for rapid temperature changes.',
  },
  {
    id: 6,
    question: 'What does Pt100 indicate about an RTD?',
    options: [
      'A maximum operating temperature of 100°C',
      'A 100% accuracy rating across its range',
      '100 ohms resistance at 0°C',
      'A 100mA maximum excitation current',
    ],
    correctAnswer: 2,
    explanation:
      'Pt100 indicates a platinum RTD with 100 ohms resistance at 0°C. This is the most common RTD specification used in industrial applications.',
  },
  {
    id: 7,
    ...
    options: [
      ...
      'A change in capacitance with applied pressure',
      'A change in inductance with position',
      'A voltage generated when dissimilar metals are joined and heated',
    ],
    correctAnswer: 3,
    explanation:
      'The Seebeck effect is the generation of a voltage when two dissimilar metals are joined and exposed to a temperature difference, which is the operating principle of thermocouples.',
  },
  {
    id: 8,
    question: 'What is cold junction compensation?',
    options: [
      'Actively cooling the sensor to improve accuracy',
      'Correcting for the temperature at a thermocouple reference junction',
      'A method of preventing frost damage to the sensor',
      'A technique for reducing the sensor thermal lag',
    ],
    correctAnswer: 1,
    explanation:
      'Cold junction compensation corrects for the temperature at the reference junction (where thermocouple wires connect to measurement equipment) to ensure accurate readings.',
  },
  {
    id: 9,
    question: 'Why is a 3-wire RTD configuration commonly used?',
    options: [
      'It is simply cheaper than a 2-wire arrangement',
      'It gives a noticeably faster response time',
      'It provides a higher maximum temperature capability',
      'It improves accuracy by compensating for lead-wire resistance',
    ],
    correctAnswer: 3,
    explanation:
      'A 3-wire configuration compensates for lead wire resistance, providing better accuracy than 2-wire while being more cost-effective than 4-wire arrangements.',
  },
  {
    id: 10,
...
const faqs = [
  {
    ...
    answer:
      'Consider: temperature range (thermocouples for high temps, RTDs for moderate, thermistors for narrow ranges), accuracy requirements (RTDs best, then thermistors, then thermocouples), environment (thermocouples for harsh conditions), and cost (thermocouples cheapest).',
  },
  {
    question: 'Why do thermocouples need cold junction compensation?',
    answer:
      'Thermocouples measure the temperature difference between two junctions. The cold (reference) junction temperature must be known or compensated for to determine the absolute temperature at the measurement junction.',
  },
  {
    question: 'Can I replace an RTD with a thermocouple?',
    answer:
      'Not directly. They have different operating principles and output signals. RTDs output resistance changes while thermocouples output voltage. The instrumentation must be compatible with the sensor type.',
  },
  {
    question: 'What causes self-heating in RTDs?',
    answer:
      'The measurement current flowing through the RTD element generates heat due to resistance. This self-heating can cause measurement errors. Using lower excitation currents and proper sensor mounting minimises this effect.',
  },
  {
    question: 'How do I choose between Type K and Type J thermocouples?',
    answer:
      'Type K (Chromel-Alumel) is more versatile with a wider temperature range and better oxidation resistance. Type J (Iron-Constantan) has higher sensitivity but limited range and is not suitable for oxidising atmospheres.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Thermocouples:</strong> Voltage from dissimilar metals, wide range, rugged
              </li>
              <li>
                <strong>RTDs:</strong> Resistance change with temp, high accuracy, stable
              </li>
              <li>
                <strong>Thermistors:</strong> High sensitivity, narrow range, fast response
              </li>
              <li>
                <strong>Selection:</strong> Match sensor to application requirements
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Identify sensor type by connections and output signal
              </li>
              <li>
                <strong>Use:</strong> Select based on temp range, accuracy, and environment
              </li>
              <li>
                <strong>Apply:</strong> Match wiring configuration to accuracy needs
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Thermocouples operate on the <strong>thermoelectric effect</strong> (Seebeck effect),
              where a voltage is generated when two dissimilar metals are joined at one end and
              exposed to a temperature difference. This simple yet robust principle makes
              thermocouples the most widely used temperature sensors in harsh industrial
              environments.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              resistance of pure metals with temperature. Platinum RTDs are the most common due to
              their excellent stability, linearity, and wide temperature range, making them the
            ...
            <div className="my-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li>
                      <strong>Pt100:</strong> 100Ω at 0°C (most common)
                    </li>
                    <li>
                      <strong>Pt1000:</strong> 1000Ω at 0°C (higher sensitivity)
                    </li>
                    <li>
                      <strong>Pt500:</strong> 500Ω at 0°C (compromise option)
                    </li>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              exhibit large, predictable changes in electrical resistance with small temperature
              variations. Their high sensitivity makes them ideal for precise temperature control
              and measurement in narrow temperature ranges.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Selecting the appropriate temperature sensor requires careful consideration of
              application requirements, environmental conditions, performance specifications, and
              cost constraints.
            </p>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Real-World Scenario: Commercial HVAC System
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Indoor Climate Control (RTDs):</strong> Zone temperature control requiring
                  ±0.5°C accuracy in clean, stable conditions (18°C to 26°C range)
                </li>
                <li>
                  <strong>Boiler Room Monitoring (Thermocouples):</strong> High-heat equipment
                  monitoring in hot, harsh environments with vibration (50°C to 800°C range)
                </li>
                <li>
                  <strong>Result:</strong> Optimal comfort control with reliability and
                  cost-effectiveness by matching sensor type to application
                </li>
              </ul>
            </div>
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Installing Temperature Sensors
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Wrong sensor type</strong> — matching temperature range and accuracy to
                  application
                </li>
                <li>
                  <strong>Poor thermal contact</strong> — air gaps cause measurement errors
                </li>
                <li>
                  <strong>Ignoring lead resistance</strong> — use 3-wire or 4-wire RTD
                  configurations
                </li>
                <li>
                  <strong>Missing cold junction compensation</strong> — essential for accurate
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="../instrumentation-module-2-section-3">
              Next Section
