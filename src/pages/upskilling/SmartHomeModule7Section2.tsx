...
const DESCRIPTION =
  'Learn systematic commissioning procedures and device pairing techniques for reliable smart home system operation.';

const quickCheckQuestions = [
  {
    question: 'What should be the first step when commissioning a smart home system?',
    options: [
      'Pair all devices immediately',
    ...
    correctIndex: 1,
    explanation:
      'Verifying network connectivity and infrastructure ensures a stable foundation before attempting to pair devices, preventing connection issues later.',
  },
  {
    question: "What is 'pairing mode' on a smart device?",
    options: [
      'A diagnostic self-test',
      'A state where the device broadcasts its presence for discovery',
      'Power saving mode',
      'A security lockout',
    ],
    correctIndex: 1,
    explanation:
      'Pairing mode is when a device broadcasts its identity to be discovered by the hub or controller, allowing it to join the smart home network.',
  },
  {
    question: 'Why is it important to commission devices one at a time rather than all together?',
    options: [
      'To save battery power',
      'To avoid network congestion and ensure each device pairs correctly',
      'It takes less time',
      'The hub cannot handle multiple devices',
    ],
    correctIndex: 1,
    explanation:
      "Commissioning devices individually prevents confusion, allows verification of each device's operation, and avoids potential pairing conflicts on the network.",
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Testing both local (physical switch) and remote (app) operation confirms the device is fully functional and properly communicating with the system.',
  },
  {
...
const faqs = [
  {
    ...
    answer:
      'Allow 24-48 hours for the mesh network to fully optimise. During this time, devices discover the best communication routes. Avoid making major changes to device positions during this period. If issues persist after 48 hours, consider adding repeater devices or repositioning the hub.',
  },
  {
    question: 'Can I commission devices using multiple apps simultaneously?',
    answer:
      'This is generally not recommended. Use a single primary app or hub for initial commissioning to avoid confusion and conflicts. Once devices are commissioned, they can often be controlled by multiple platforms (e.g., Apple HomeKit, Google Home) through bridges or integrations.',
  },
  {
    question: 'What should I do if a device keeps dropping offline after commissioning?',
    answer:
      'First check signal strength at the device location. For wireless devices, ensure the mesh network has adequate repeaters. Verify power supply stability and check for interference sources. Review firmware versions and update if available. If problems persist, the device may be faulty or incompatible.',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-4xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-white text-sm">
              Systematic approach ensures reliable device integration
            </p>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            <h3 className="font-semibold text-white mb-1">Time Investment</h3>
            <p className="text-white text-sm">
              Thorough commissioning prevents callbacks and customer issues
            </p>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            ...
            <p>
              ...
              app. Document any weak areas requiring access points or mesh extenders. For Z-Wave and
              Zigbee systems, plan device commissioning order to build a strong mesh network from
              the hub outward.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Different wireless protocols have distinct pairing procedures. Understanding these
              differences ensures efficient commissioning regardless of device type.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Consistent naming conventions make systems easier to manage, troubleshoot, and explain
              to customers. Establish a naming scheme before commissioning.
            </p>
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 p-4 rounded-r-lg">
            ...
            <p>
              Group devices by room immediately after pairing. This enables room-based voice
              commands ("Turn off the kitchen") and simplifies automation setup. Consider creating
              zones for multi-room control (e.g., "Downstairs", "All Lights").
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Every commissioned device requires thorough testing before handover. Document test
              results as part of the commissioning record.
            </p>
            ...
            <div className="grid gap-3">
              <div className="flex gap-3 items-start">
                ...
                <span className="text-white">
                  Test physical operation, app control, voice command response
                </span>
              </div>
              <div className="flex gap-3 items-start">
                <span className="font-medium text-elec-yellow min-w-[100px]">Sensors:</span>
                <span className="text-white">
                  Trigger sensor, verify status update in app, test automation response
                </span>
              </div>
              <div className="flex gap-3 items-start">
                <span className="font-medium text-elec-yellow min-w-[100px]">Thermostats:</span>
                <span className="text-white">
                  Verify temperature reading, test setpoint changes, confirm heating/cooling
                  response
                </span>
              </div>
              <div className="flex gap-3 items-start">
                ...
                <span className="text-white">
                  Test open, close, and percentage positions via app and manual control
                </span>
              </div>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Even with proper procedures, pairing issues occur. Understanding common problems and
              solutions enables efficient troubleshooting.
            </p>
            <div className="grid gap-4">
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                <h5 className="font-medium text-elec-yellow mb-2">
                  Wi-Fi Device Connection Failure
                </h5>
                <ul className="list-disc list-inside space-y-1 text-white text-sm">
