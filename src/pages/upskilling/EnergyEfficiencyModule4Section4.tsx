...
const EnergyEfficiencyModule4Section4: React.FC = () => {
  useSEO({
    ...
    description:
      'Learn about no-cost and low-cost energy savings through behavioural change, awareness campaigns, feedback mechanisms, and sustaining engagement in UK workplaces.',
    keywords: [
  ...
  const quickCheckQuestions = [
    {
      id: 'qc1',
      question:
        'What percentage of energy savings can typically be achieved through behavioural measures alone in commercial buildings?',
      options: ['1-3%', '5-20%', '25-40%', '50-60%'],
      correctIndex: 1,
      explanation:
        'Behavioural measures can typically achieve 5-20% energy savings in commercial buildings at no or low cost. This makes them one of the most cost-effective energy management strategies available.',
    },
    {
      id: 'qc2',
      ...
      correctIndex: 1,
      explanation:
        'Green Champions act as local energy advocates and peer influencers within their departments. They promote energy-efficient behaviours, share best practices, and provide a link between staff and the energy management team.',
    },
    {
      id: 'qc3',
      question:
        'Which feedback mechanism has been shown to be most effective for changing energy behaviour?',
      options: [
      ...
      correctIndex: 2,
      explanation:
        'Real-time energy displays are most effective because they provide immediate feedback, allowing occupants to see the direct impact of their actions. Studies show real-time feedback can achieve 5-15% savings compared to 0-10% for historical feedback.',
    },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-8">
        ...
        <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
          <p className="text-white leading-relaxed">
            ...
            <span className="text-elec-yellow font-semibold">5-20% energy savings</span> through
            behavioural change - often the most cost-effective energy management strategy available.
            Learn to build a culture of energy awareness that delivers lasting results.
          </p>
        </div>
        ...
        <section className="bg-white/5 rounded-xl p-5 border border-white/10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Occupant behaviour is one of the most significant yet often overlooked factors in
              building energy consumption. Research consistently shows that{' '}
              <span className="text-elec-yellow font-semibold">
                behavioural measures can achieve 5-20% energy savings
              </span>{' '}
              in commercial buildings - often at zero or minimal cost.
            </p>
              ...
              <div className="grid md:grid-cols-3 gap-3">
                <div className="bg-white/5 rounded p-3">
                  ...
                  <p className="text-sm text-white">
                    Awareness of energy-efficient practices and their impact
                  </p>
                </div>
                <div className="bg-white/5 rounded p-3">
                  <h4 className="font-semibold text-elec-yellow text-sm mb-2">Motivation</h4>
                  <p className="text-sm text-white">
                    Personal values, social norms, incentives, and perceived benefits
                  </p>
                </div>
                <div className="bg-white/5 rounded p-3">
                  <h4 className="font-semibold text-elec-yellow text-sm mb-2">Opportunity</h4>
                  <p className="text-sm text-white">
                    Physical environment, time constraints, and enabling factors
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li>
                  <strong className="text-white">Make it easy:</strong> Remove barriers to desired
                  behaviour - convenient recycling bins, automatic settings
                </li>
                <li>
                  <strong className="text-white">Make it social:</strong> Use peer influence and
                  social norms - "Most people switch off..."
                </li>
                <li>
                  <strong className="text-white">Make it timely:</strong> Prompt at the point of
                  decision - stickers on switches
                </li>
                <li>
                  <strong className="text-white">Make it attractive:</strong> Frame messages
                  positively, use engaging formats
                </li>
                <li>
                  <strong className="text-white">Loss aversion:</strong> People respond more to
                  potential losses than gains
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="bg-white/5 rounded-xl p-5 border border-white/10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Effective awareness campaigns go beyond posters on walls. They create genuine
              engagement, make energy visible, and give people the knowledge and motivation to
            ...
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              ...
              <div className="space-y-3">
                <div className="bg-white/5 rounded-lg p-4">
                  ...
                  <ul className="text-sm space-y-1 ml-4 text-white">
                    <li>
                      <strong className="text-white">Senior managers:</strong> Focus on cost
                      savings, corporate reputation, compliance
                    </li>
                    <li>
                      <strong className="text-white">Finance teams:</strong> Emphasise ROI and
                      budget impacts
                    </li>
                    <li>
                      <strong className="text-white">General staff:</strong> Environmental benefits,
                      easy actions, team involvement
                    </li>
                    <li>
                      <strong className="text-white">Technical staff:</strong> Data, efficiency
                      metrics, technical solutions
                    </li>
                  </ul>
                </div>
                <div className="bg-white/5 rounded-lg p-4">
                ...
                <div className="bg-white/5 rounded-lg p-4">
                  ...
                  <p className="text-sm text-white">
                    Weekly to fortnightly communications maintain engagement without fatigue. Use
                    seasonal themes and link to relevant events (Energy Awareness Week, Earth Day).
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <p className="text-sm text-white">
                A UK local authority implemented a comprehensive behaviour change programme across
                50 buildings. Key elements included Green Champions in each location, monthly energy
                newsletters, inter-building competitions, and real-time energy displays in reception
                areas. After 12 months, the programme achieved 14% energy reduction, saving
                approximately 180,000 annually with a programme cost of just 25,000.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white/5 rounded-xl p-5 border border-white/10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Feedback is essential for behaviour change - people cannot modify what they cannot
              measure. The type, timing, and presentation of feedback significantly affects its
              impact on behaviour.
            </p>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <ul className="text-sm space-y-2 text-white">
                    <li>
                      <strong className="text-elec-yellow">Simplicity:</strong> Avoid information
                      overload - focus on 2-3 key metrics
                    </li>
                    <li>
                      <strong className="text-elec-yellow">Context:</strong> Compare to targets,
                      historical data, or similar buildings
                    </li>
                    <li>
                      <strong className="text-elec-yellow">Actionable:</strong> Link consumption to
                      behaviours people can control
                    </li>
                    <li>
                      <strong className="text-elec-yellow">Visual:</strong> Use colours, gauges, and
                      graphics rather than numbers alone
                    </li>
                    <li>
                      <strong className="text-elec-yellow">Location:</strong> Place where people
                      naturally pause - entrances, break areas
                    </li>
                  </ul>
                </div>
                <div className="bg-white/5 rounded-lg p-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm text-white">Green: Below target - excellent</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-6 h-6 rounded-full bg-yellow-500"></div>
                      <span className="text-sm text-white">
                        Amber: Near target - maintain vigilance
                      </span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-6 h-6 rounded-full bg-red-500"></div>
                      <span className="text-sm text-white">
                        Red: Above target - action needed
                      </span>
                    </div>
                  </div>
                  <p className="text-xs mt-3 text-white">
                    Studies show traffic light systems with comparative data achieve highest
                    engagement
                  </p>
                </div>
              </div>
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              ...
              <p className="text-sm text-white">
                Be aware of the Hawthorne Effect - energy savings often increase when people know
                they are being monitored. This can inflate initial results but fade over time. To
                address this: establish baselines before announcing programmes, plan for some
                regression, and use ongoing engagement to maintain awareness. The monitoring itself
                has value, but sustainable change requires genuine behaviour modification.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white/5 rounded-xl p-5 border border-white/10">
          ...
          <div className="space-y-4 text-white">
            <p>
              ...
              departments. They provide peer influence, which research shows is one of the most
            ...
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              <h3 className="text-lg font-semibold text-elec-yellow mb-3">
                Establishing a Champion Network
              </h3>
              <div className="space-y-3">
                <div className="bg-white/5 rounded-lg p-4">
        ...
        <section className="bg-white/5 rounded-xl p-5 border border-white/10">
          ...
          <div className="space-y-4 text-white">
            <p>
              While voluntary behaviour change is powerful, it must be supported by clear policies
              and procedures. These provide the framework within which good behaviour becomes the
              default, and poor behaviour is harder to sustain.
            </p>
            ...
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              ...
              <div className="space-y-3">
                <div className="bg-white/5 rounded-lg p-4">
                  ...
                  <p className="text-sm text-white mb-2">
                    A high-level statement of commitment signed by senior leadership:
                  </p>
                  <ul className="text-sm space-y-1 ml-4 text-white">
                ...
                <div className="bg-white/5 rounded-lg p-4">
                  ...
                  <p className="text-sm text-white mb-2">
                    Practical procedures that embed efficiency into daily operations:
                  </p>
            ...
            <div className="bg-white/5 rounded-lg p-4 border border-white/10">
              ...
              <div className="bg-white/5 rounded-lg p-4">
                <h4 className="font-semibold text-white mb-2">
                  Standard Operating Procedure: End of Day Energy Check
                </h4>
                <div className="text-sm space-y-2 text-white">
                  <p>
                    <strong className="text-white">Purpose:</strong> Ensure energy-consuming
                    equipment is switched off when not required
                  </p>
                  <p>
                    <strong className="text-white">Scope:</strong> All staff, all office areas
                  </p>
                  <p>
                    <strong className="text-white">Procedure:</strong>
                  </p>
                  <ol className="list-decimal ml-5 space-y-1 text-white">
                  ...
                  <p>
                    <strong className="text-white">Responsibility:</strong> All staff / Green
                    Champions to remind
                  </p>
                </div>
              </div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              ...
              <p className="text-sm text-white">
                The most effective policies make energy-efficient behaviour the easiest option.
                Examples: automatic PC power management settings as default, meeting room lights on
                occupancy sensors, print double-sided by default, heating setpoints locked within an
                efficient range. When the efficient choice is also the convenient choice, compliance
                follows naturally.
              </p>
            </div>
          </div>
        ...
        <section className="bg-white/5 rounded-xl p-5 border border-white/10">
          ...
          <div className="space-y-4 text-white">
            <p>
              The challenge with behavioural programmes is not achieving initial savings but
              sustaining them over time. Effective measurement and continuous engagement are
              essential to prevent backsliding.
            </p>
                ...
                <div>
                  ...
                  <ul className="text-sm space-y-2 text-white">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-white">Energy intensity:</strong> kWh/m2 or
                        kWh/employee
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <TrendingUp className="w-4 h-4 text-elec-yellow mt-0.5" />
                      <span>
                        <strong className="text-white">Weather-normalised consumption:</strong>{' '}
                        Degree-day adjusted
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <TrendingUp className="w-4 h-4 text-elec-yellow mt-0.5" />
                      <span>
                        <strong className="text-white">Out-of-hours usage:</strong> Baseload as % of
                        total
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <TrendingUp className="w-4 h-4 text-elec-yellow mt-0.5" />
                      <span>
                        <strong className="text-white">Cost per unit output:</strong> Where
                        applicable
                      </span>
                    </li>
                  </ul>
                ...
                <div>
                  ...
                  <ul className="text-sm space-y-2 text-white">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-white">Training completion:</strong> % staff trained
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5" />
                      <span>
                        <strong className="text-white">Campaign reach:</strong> Communication
                        engagement metrics
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5" />
                      <span>
                        <strong className="text-white">Champion activity:</strong> Actions taken,
                        issues reported
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5" />
                      <span>
                        <strong className="text-white">Behaviour surveys:</strong> Self-reported
                        behaviour scores
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 rounded-lg p-4">
                  ...
                  <ul className="text-sm space-y-2 text-white">
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5" />
                      <span>
                        <strong className="text-white">Embed in culture:</strong> Make efficiency
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5" />
                      <span>
                        <strong className="text-white">Continuous communication:</strong> Regular
                        but varied messaging
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5" />
                      <span>
                        <strong className="text-white">Refresh champions:</strong> Recruit new
                        volunteers, rotate roles
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5" />
                      <span>
                        <strong className="text-white">Celebrate success:</strong> Publicise
                        achievements and recognise contributors
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5" />
                      <span>
                        <strong className="text-white">Link to purpose:</strong> Connect to broader
                        sustainability and organisational goals
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-4 h-4 text-green-400 mt-0.5" />
                      <span>
                        <strong className="text-white">Induction integration:</strong> Train every
                        new starter from day one
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <p className="text-sm text-white">
                ...
                behavioural programme. Key success factors included: integration with mandatory
                staff training, visible senior leadership commitment, monthly energy league tables
                between departments, reinvestment of savings into patient care (demonstrating
                tangible benefits), and linking energy to the Trust's public health mission. The
                programme has now been running for seven years with savings maintained.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gradient-to-br from-elec-yellow/20 to-elec-yellow/5 rounded-xl p-5 border border-elec-yellow/30">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-semibold text-white mb-3 border-b border-white/20 pb-2">
                Key Numbers to Remember
              </h3>
              <ul className="space-y-2 text-sm">
                <li className="flex justify-between">
                  <span className="text-white">Behavioural savings potential:</span>
                  <span className="text-elec-yellow font-semibold">5-20%</span>
                </li>
                <li className="flex justify-between">
                  <span className="text-white">Typical payback period:</span>
                  <span className="text-elec-yellow font-semibold">Less than 6 months</span>
                </li>
                <li className="flex justify-between">
                  <span className="text-white">Real-time feedback savings:</span>
                  <span className="text-elec-yellow font-semibold">5-15%</span>
                </li>
                <li className="flex justify-between">
                  <span className="text-white">Champion ratio target:</span>
                  <span className="text-elec-yellow font-semibold">1:25-50</span>
                </li>
                <li className="flex justify-between">
                  <span className="text-white">1 degree C setpoint change:</span>
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  ...
                  <span className="text-white">Switch-off reminders at light switches</span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-4 h-4 border border-elec-yellow rounded flex-shrink-0"></div>
                  <span className="text-white">PC power settings optimised</span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-4 h-4 border border-elec-yellow rounded flex-shrink-0"></div>
                  <span className="text-white">Heating setpoints reviewed</span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-4 h-4 border border-elec-yellow rounded flex-shrink-0"></div>
                  <span className="text-white">Green Champions recruited</span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-4 h-4 border border-elec-yellow rounded flex-shrink-0"></div>
                  <span className="text-white">Feedback display installed</span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-4 h-4 border border-elec-yellow rounded flex-shrink-0"></div>
                  <span className="text-white">End-of-day procedure established</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1 text-sm text-white">
                <li>
                  <strong className="text-elec-yellow">Daily:</strong> Visual reminders (posters,
                  stickers)
                </li>
                <li>
                  <strong className="text-elec-yellow">Weekly:</strong> Energy tips (email,
                  intranet)
                </li>
                <li>
                  <strong className="text-elec-yellow">Monthly:</strong> Performance updates and
                  newsletters
                </li>
                <li>
                  <strong className="text-elec-yellow">Quarterly:</strong> Theme refresh and
                  competitions
                </li>
                <li>
                  <strong className="text-elec-yellow">Annually:</strong> Energy Awareness events
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="bg-white/10 rounded p-3">
                ...
                <ul className="text-xs space-y-1 text-white">
                  <li>
                    <strong className="text-white">B</strong>ehaviour change requires:
                  </li>
                  <li>
                    <strong className="text-white">M</strong>otivation (why should I?)
                  </li>
                  <li>
                    <strong className="text-white">A</strong>bility (can I do it easily?)
                  </li>
                  <li>
                    <strong className="text-white">T</strong>rigger (what reminds me?)
                  </li>
                </ul>
              </div>
            </div>
