...
const quizQuestions = [
  {
    id: 1,
    question:
      'Which charging mode requires no communication between the vehicle and the charging equipment?',
  ...
  },
  {
    id: 8,
    question:
      'Which factor most significantly affects DC fast charging speed as the battery approaches full?',
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">Charging Modes, Connectors &amp; Technology</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Modes:</strong> 1-4 define charging configurations and safety
              </li>
              <li>
                <strong>Connectors:</strong> Type 2 for AC, CCS Combo 2 for DC in Europe
              </li>
              <li>
                <strong>Power:</strong> 3.6-22 kW AC, 50-350 kW DC rapid
              </li>
              <li>
                <strong>Integration:</strong> Smart charging enables renewable synergy
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Connector types, charging mode indicators, power ratings
              </li>
              <li>
                <strong>Use:</strong> Matching charger to vehicle and application requirements
              </li>
              <li>
                <strong>Apply:</strong> Specifying appropriate solutions for customers
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The IEC 61851 standard defines four charging modes, each with different power levels,
              safety features, and communication requirements. Understanding these modes is
              fundamental to specifying appropriate charging solutions.
            </p>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white">
                Direct connection to a standard domestic socket without any dedicated protection or
                communication. Limited to 16A single-phase (3.6 kW). This mode is not permitted in
                the UK due to safety concerns and is primarily used in some developing markets.
              </p>
            </div>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Mode 2 - AC Charging with IC-CPD
              </p>
              <p className="text-sm text-white">
                Uses a standard domestic socket with an In-Cable Control and Protection Device
                (IC-CPD). The IC-CPD provides residual current protection and basic communication
                with the vehicle. Limited to 3.6 kW for safety, this mode serves as a backup or
                temporary charging solution.
              </p>
            </div>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white">
                The standard for home and workplace charging, using a dedicated EVSE with full
                communication via the Control Pilot signal. Supports single-phase (up to 7.4 kW) or
                three-phase (up to 22 kW for AC, 43 kW for some systems). Includes load management
                capability and smart charging features.
              </p>
            </div>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white">
                High-power DC charging with the charger converting AC to DC externally. Power ranges
                from 50 kW to 350 kW or higher. Communication uses CAN bus or PLC for precise
                control of voltage and current. Primarily used for public rapid charging
                infrastructure.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Multiple connector standards exist globally, with Europe standardising on Type 2 for
              AC and CCS Combo 2 for DC charging. Installers must understand connector capabilities
              and compatibility.
            </p>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white">
                Japanese DC fast charging standard, declining in Europe but still present at many
                sites. Supports up to 62.5 kW and notably supports bidirectional charging (V2G/V2H)
                from early versions.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Understanding the fundamental difference between AC and DC charging is essential for
              specifying appropriate solutions and advising customers on their charging needs.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Modern EV charging relies on communication between the vehicle and charging equipment
              to ensure safe operation and enable smart features.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Control Pilot States (IEC 61851):
              </p>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white">
                Advanced communication protocol enabling automatic authentication, dynamic tariff
                information, and bidirectional power transfer. Uses Power Line Communication (PLC)
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Electric vehicles represent both a challenge and opportunity for renewable energy
              integration. Smart charging strategies can align EV demand with renewable generation,
              while V2G technology enables vehicles to support grid stability.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Time-of-use optimisation:</strong> Scheduling charging during off-peak
                  periods
                </li>
                <li>
                  <strong>Solar matching:</strong> Adjusting charge rate to match generation
                </li>
                <li>
                  <strong>Demand response:</strong> Reducing or shifting load on grid signals
                </li>
                <li>
                  <strong>Load balancing:</strong> Managing multiple EVs within site capacity
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 my-6">
              <p className="text-elec-yellow text-sm font-medium">
                Key Insight: With average EV batteries of 50-70 kWh and typical daily driving
                requiring only 10-15 kWh, significant capacity is available for grid services.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Assessing Customer Requirements
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Matching Charger to Application
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                ...
                <li>
                  <strong>Ignoring onboard charger limits</strong> - AC charging limited by vehicle
                </li>
                <li>
                  <strong>Underestimating supply requirements</strong> - always check capacity
                </li>
                <li>
                  <strong>Forgetting future-proofing</strong> - consider larger cable sizes
                </li>
              </ul>
            </div>
          </div>
