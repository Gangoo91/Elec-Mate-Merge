...
const inlineChecks = [
  {
    ...
    question: 'What is the Chapter 81 cable-upsize payback model — the typical calculation?',
    options: [
  ...
  },
  {
    ...
    question: 'What is "tariff-aware design" under Chapter 81 + the EEMS (Reg 825.1)?',
    options: [
  ...
  },
  {
    ...
    question: 'What goes in the Chapter 81 post-install monitoring plan?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'What happens if year-1 monitoring shows actual energy use much higher / lower than design?',
    answer:
...
export default function RenewableEnergyModule11Section2() {
  ...
  useSEO({
    title:
      'Chapter 81 applied — efficiency design + verification | Renewable Energy 11.2 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 11 · Section 2 · BS 7671:2018+A4:2026 · Chapter 81 design + verification"
        title="Chapter 81 applied — efficiency design + verification"
        backTo="../renewable-energy-module-11"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Practical Chapter 81 design (methodology per BS HD 60364-8-1:2019): cable CSA payback
          model, voltage-drop margins below the Reg 525 floor, tariff-aware load shifting, EEMS
          integration (Reg 825.1), monitoring plan, per-circuit design table. Verification at
          commissioning + cert evidence bundle.
        </p>
        ...
        <Pullquote>
          Chapter 81 is payback-driven, not aspiration-driven. The customer sees the math: cable
          upsize cost, annual loss saving, payback years. That\'s the rationale.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Design current I</strong>— typical operating current
              (A). For sustained-load circuits use a load-profile-weighted average if available;
              otherwise use rated / design current
            </li>
            <li>
              <strong className="text-white">Run length L</strong>— total cable run from origin to
              load (m). For T+E circuits double the line + neutral path doesn\'t double the I²R
              (loss is per-conductor, so 2 × loss for line + neutral OR use combined R per metre)
            </li>
            <li>
              <strong className="text-white">Operating hours per year t</strong> —
              load-profile-based. Heat pump 5-month heating season at 4-6 h/day ≈ 750 h. EV charger
              6-8 h/session × 3-5 nights/week × 50 weeks ≈ 1,200 h. PV daylight at near MPP ≈ 1,000
              h equivalent
            </li>
            <li>
              <strong className="text-white">Cable resistance R/m</strong>— from manufacturer data
              at operating temperature (typically 70°C for 70°C-rated cable). UK common: 6 mm² T+E
              ~3.0 mΩ/m per conductor at 70°C; 10 mm² ~1.8 mΩ/m; 16 mm² ~1.15 mΩ/m
            </li>
            <li>
              <strong className="text-white">Annual I²R loss</strong>— kWh/year = I² × R × L × t /
              1000. For two-conductor circuit multiply by 2 (line + neutral)
            </li>
            <li>
              <strong className="text-white">Loss difference</strong>— annual kWh saving from upsize
              = (loss at Reg 525 minimum) − (loss at Chapter 81 upsize)
            </li>
            <li>
              <strong className="text-white">Annual £ saving</strong>— kWh saving × unit price
              (£/kWh). UK 2025-26 typical residential 25-30 p/kWh; commercial varied
            </li>
            <li>
              <strong className="text-white">Incremental cost</strong>— cable material delta +
              install labour delta (modest for single CSA step). Cert evidence: payback per circuit
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Inputs</strong> — design current I = 25 A average; run
              length L = 25 m; operating hours t = 750 h/year; unit price 28 p/kWh
            </li>
            <li>
              <strong className="text-white">Reg 525 minimum</strong>— 6 mm² T+E. R/m ~3.0 mΩ/m per
              conductor. Loss = 2 × 25² × 0.003 × 25 × 750 / 1000 = ~70 kWh/year. £19.6/year at 28
              p/kWh
            </li>
            <li>
              <strong className="text-white">Chapter 81 upsize</strong>— 10 mm² T+E. R/m ~1.8 mΩ/m
              per conductor. Loss = 2 × 25² × 0.0018 × 25 × 750 / 1000 = ~42 kWh/year. £11.8/year at
              28 p/kWh
            </li>
            <li>
              <strong className="text-white">Annual saving</strong>— £19.6 − £11.8 = £7.8/year. ~28
              kWh/year I²R loss avoided
            </li>
            <li>
              <strong className="text-white">Incremental cost</strong>— 10 mm² T+E ~£3-4/m material
              delta over 6 mm²; 25 m run = ~£75-100 delta; labour delta modest
            </li>
            <li>
              <strong className="text-white">Payback</strong>— ~10 years on cable alone. Within UK
              2025-26 reasonable threshold (5-10 years). Secondary benefit: equipment life,
              voltage-drop headroom, future load capacity
            </li>
            <li>
              <strong className="text-white">Sensitivity</strong>— if customer is high-usage (8-9
              h/day heating season ≈ 1,200 h/year) payback shortens to ~6 years. If unit price rises
              payback shortens. Designer records assumptions
            </li>
            <li>
              <strong className="text-white">Decision</strong>— Chapter 81 records 10 mm² T+E choice
              + rationale. Customer evidence bundle: per-circuit table with these inputs + decision
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Off-peak is the discount. EEMS is the dispatcher. Chapter 81 is the design that says:
          schedule the heavy loads to where the electricity costs least.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">EV charger</strong> — scheduled to off-peak window
              (typical 00:30-05:30 or 23:30-07:30 depending on tariff). Octopus Go ~7.5 p/kWh
              off-peak vs ~30 p/kWh peak; saving on 3,000 kWh/year EV use ~£675 vs flat tariff
            </li>
            <li>
              <strong className="text-white">Heat pump</strong>— Cosy tariff has heat-pump-optimised
              windows (cheap morning + cheap afternoon, peak evening). EEMS or smart-controller
              schedules heat-up pre-peak using thermal mass + lower-cost evening top-up
            </li>
            <li>
              <strong className="text-white">BESS charging</strong>— schedule charging to
              lowest-cost window (typically deep off-peak 23:30-05:30) + discharge during peak
              (16:00-19:00). EEMS / BESS controller coordinates. Saving on 13 kWh × 365 cycles ×
              tariff spread = ~£100-300/year
            </li>
            <li>
              <strong className="text-white">Immersion diverter</strong>— diverts excess PV to
              immersion DHW first (free). Where no excess PV, may schedule overnight off-peak top-up
              via timer / EEMS
            </li>
            <li>
              <strong className="text-white">Export coordination</strong>— PV + BESS export when SEG
              (Smart Export Guarantee) rate is favourable. Some tariffs (Octopus Outgoing Agile) pay
              half-hourly variable export; EEMS coordinates discharge to peak SEG window
            </li>
            <li>
              <strong className="text-white">Designer records</strong>— tariff identified +
              load-shift schedule + EEMS configuration + annual £ saving estimate vs flat tariff
            </li>
            <li>
              <strong className="text-white">Customer monitoring</strong>— sub-meter + smart-meter
              export wired; customer can see actual vs design schedule + £ saving
            </li>
            <li>
              <strong className="text-white">Cert evidence</strong>— Chapter 81 tariff-aware design
              section + EEMS (Reg 825.1) commissioning sheet
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Coordinated devices</strong>— PV inverter, BESS, heat
              pump controller, EV charger, immersion diverter, smart thermostats, smart-meter
            </li>
            <li>
              <strong className="text-white">Tariff signal</strong>— smart-meter Time-of-use signal
              OR cloud API from tariff provider (e.g. Octopus API for half-hourly Agile prices)
            </li>
            <li>
              <strong className="text-white">Load priority</strong>— customer-set: e.g. self-consume
              PV first → BESS charge → EV charge → export. Or: heating priority → EV priority →
              export priority
            </li>
            <li>
              <strong className="text-white">Schedule</strong> — EEMS computes optimal operation
              schedule based on PV forecast + load forecast + tariff schedule + customer preference
            </li>
            <li>
              <strong className="text-white">Override</strong>— customer can override the schedule
              (manual EV charge now, heat boost). EEMS respects override + resumes optimal schedule
            </li>
            <li>
              <strong className="text-white">Monitoring + reporting</strong> — EEMS dashboard / app
              shows generation + storage + consumption + cost; customer-facing efficiency report
            </li>
            <li>
              <strong className="text-white">Commissioning</strong>— installer configures EEMS at
              install; verifies coordinated operation across PV / BESS / heat pump / EV; trains
              customer
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — Chapter 81 design
              records integrate the EEMS scope; EEMS (Reg 825.1) commissioning sheet +
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Sub-meter points</strong>— per LCT component: PV
              inverter output kWh; BESS kWh in + out; heat pump dedicated kWh; EV charger dedicated
              kWh; immersion diverter kWh (if separate)
            </li>
            <li>
              <strong className="text-white">CT clamp</strong>— on smart-meter incoming + outgoing
              feeds (import + export). Some smart meters report export natively
            </li>
            <li>
              <strong className="text-white">Data-logger / portal</strong> — manufacturer cloud
              (SolarEdge ONE, MyEnergi, Enphase, GivEnergy, Tesla) OR open-protocol Home Assistant +
              MQTT
            </li>
            <li>
              <strong className="text-white">Customer app</strong>— visualisation: PV daily /
              monthly / annual; BESS cycle; heat pump kWh + SCOP; EV kWh + cost; export £
            </li>
            <li>
              <strong className="text-white">Reporting cadence</strong>— monthly customer review +
              annual verification
            </li>
            <li>
              <strong className="text-white">Year-1 verification</strong> — compare actual annual
              kWh per component to Chapter 81 design estimate; significant deviation (&gt;20%
              typical threshold) triggers investigation
            </li>
            <li>
              <strong className="text-white">Investigation triggers</strong> — customer load profile
              differs from assumption (more / less EV use); equipment performance differs from
              manufacturer claim; tariff change; install fault
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — Chapter 81 monitoring
              plan attached to design records; year-1 verification report
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Circuit name</strong>— descriptive (e.g. "Heat pump
              dedicated"; "EV charger dedicated"; "PV DC string 1")
            </li>
            <li>
              <strong className="text-white">Design current I (A)</strong>— load-profile-based;
              sustained-current average if available
            </li>
            <li>
              <strong className="text-white">Run length L (m)</strong>— origin to load
            </li>
            <li>
              <strong className="text-white">Operating hours / year t (h)</strong> — load-profile
              estimate based on customer use pattern
            </li>
            <li>
              <strong className="text-white">Reg 525 minimum CSA</strong>— calculated for the design
              voltage-drop cap
            </li>
            <li>
              <strong className="text-white">Chapter 81 upsize candidate</strong> — typically one
              CSA step above the minimum
            </li>
            <li>
              <strong className="text-white">R/m (Ω/m at 70°C)</strong>— from cable manufacturer
              data
            </li>
            <li>
              <strong className="text-white">Annual loss saving (kWh/year)</strong> — calculated I²R
              difference × t × 2 (line + neutral)
            </li>
            <li>
              <strong className="text-white">Annual £ saving</strong>— kWh × unit price
            </li>
            <li>
              <strong className="text-white">Incremental cost (£)</strong>— cable + labour delta for
              the upsize
            </li>
            <li>
              <strong className="text-white">Payback (years)</strong>— incremental cost / annual £
              saving
            </li>
            <li>
              <strong className="text-white">Designer decision</strong>— upsize / no upsize + brief
              rationale
            </li>
            <li>
              <strong className="text-white">Customer evidence</strong>— table signed off + attached
              to EIC
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-11-section-1')}
