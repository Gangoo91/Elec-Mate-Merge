...
const DESCRIPTION =
  'Explore instrumentation applications across HVAC, Process Control, BMS, and Renewable Energy systems with real-world examples and benefits.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 0,
    explanation:
      'HVAC systems commonly use temperature sensors, humidity sensors, pressure sensors, and flow meters for climate control and system monitoring.',
  },
  {
    id: 'bms-energy',
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Solar systems use instrumentation to monitor power output, solar irradiance, panel temperature, system efficiency, and fault conditions for optimal performance.',
  },
  {
    id: 5,
...
const faqs = [
  {
    ...
    answer:
      'Each industry has unique operational challenges, safety regulations, and performance objectives. Process industries need high-temperature and pressure sensors, while HVAC focuses on comfort-related measurements. The instrumentation must match the specific environmental conditions and accuracy requirements of each application.',
  },
  {
    question: 'How does BMS instrumentation reduce energy costs?',
    answer:
      'BMS uses sensors to detect when spaces are unoccupied, adjusting HVAC and lighting accordingly. It monitors outdoor conditions to optimise heating/cooling, implements time-based schedules, and provides data for identifying energy waste. Typical savings range from 15-30% on energy bills.',
  },
  {
    question: 'What happens if process control instrumentation fails?',
    answer:
      "In process industries, instrumentation failures can result in safety hazards, environmental damage, production losses, and regulatory violations. That's why critical systems have redundant sensors, safety instrumented systems (SIS), and regular maintenance programmes to ensure reliability.",
  },
  {
    question: 'Why is renewable energy instrumentation important?',
    answer:
      'Renewable energy systems need instrumentation to maximise energy capture (tracking sun/wind conditions), ensure grid compatibility, predict maintenance needs, and verify performance. Without accurate instrumentation, systems cannot operate at peak efficiency or integrate safely with the grid.',
  },
  {
    question: 'What is predictive maintenance and how does instrumentation enable it?',
    answer:
      'Predictive maintenance uses instrumentation data (vibration, temperature, power consumption) to identify equipment problems before they cause failures. By trending sensor data, maintenance can be scheduled when needed rather than on fixed intervals, reducing downtime and costs.',
  },
  {
    question: 'How do smart buildings use instrumentation data?',
    answer:
      'Smart buildings analyse instrumentation data to automatically adjust conditions for comfort and efficiency, predict equipment failures, optimise energy use based on weather forecasts, and provide occupants with personalised environment control through mobile apps and interfaces.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>HVAC:</strong> Temperature, humidity, airflow control
              </li>
              <li>
                <strong>Process:</strong> Pressure, flow, level, composition
              </li>
              <li>
                <strong>BMS:</strong> Energy management, occupancy, security
              </li>
              <li>
                <strong>Renewable:</strong> Performance monitoring, grid integration
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Safety:</strong> Preventing hazardous conditions
              </li>
              <li>
                <strong>Efficiency:</strong> 20-40% energy savings possible
              </li>
              <li>
                <strong>Quality:</strong> Consistent product and service standards
              </li>
              <li>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              HVAC (Heating, Ventilation, and Air Conditioning) systems rely heavily on
              instrumentation to maintain comfortable indoor environments while optimising energy
              consumption and ensuring air quality standards.
            </p>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 my-6">
              ...
              <div className="grid sm:grid-cols-3 gap-4 text-sm">
                <div>
                  <strong>Comfort:</strong> Precise temperature and humidity control for occupant
                  satisfaction
                </div>
                <div>
                  <strong>Efficiency:</strong> Energy savings of 20-40% through optimised operation
                </div>
                <div>
                  <strong>Health:</strong> Improved indoor air quality and ventilation control
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Process industries including chemicals, pharmaceuticals, food and beverage, and
              petrochemicals depend on sophisticated instrumentation for safe, efficient, and
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50 my-6">
              ...
              <p className="text-sm text-white">
                In process industries, instrumentation failures can result in safety hazards,
                environmental damage, production losses, and regulatory violations costing millions
                of pounds.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Building Management Systems integrate multiple building services through comprehensive
              instrumentation networks, delivering significant energy savings, improved comfort, and
              enhanced security across commercial, institutional, and residential buildings.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Renewable energy systems require sophisticated instrumentation to maximise energy
              capture, ensure system reliability, and integrate effectively with electrical grids.
              From solar photovoltaic to wind turbines, instrumentation is crucial for optimal
              performance.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Under-specifying for harsh environments</strong> — leads to premature
                  failures
                </li>
                <li>
                  <strong>Ignoring interoperability</strong> — creates integration problems
                </li>
                <li>
                  <strong>Skipping redundancy in critical applications</strong> — single point of
                  failure risk
                </li>
                <li>
                  <strong>Inadequate operator training</strong> — reduces system effectiveness
                </li>
              </ul>
            </div>
          </div>
