...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 2,
    explanation:
      'Off-peak charging typically reduces electricity costs by 40-60% compared to peak rates. Some super off-peak tariffs can achieve even greater savings during overnight periods.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Economy 7 typically provides off-peak rates from 00:30 to 07:30 (7 hours). Exact times may vary by region and supplier, so always check with your energy provider.',
  },
  {
...
const faqs = [
  {
    ...
    answer:
      'Most smart chargers allow manual override for urgent needs. Use this sparingly as peak rates can be 3-4x higher than off-peak. Consider public rapid chargers for emergency top-ups during peak periods.',
  },
  {
    question: 'How do I know my local off-peak times and rates?',
    answer:
      "Check your electricity supplier's tariff details. Economy 7 typically runs 00:30-07:30, but times vary by region. Many suppliers offer apps showing real-time and forecast pricing.",
  },
  {
    question: "Can smart charging damage my vehicle's battery?",
    answer:
      'No, smart charging at standard AC rates (3-22kW) is actually better for battery longevity than rapid DC charging. Slower overnight charging reduces thermal stress and can extend battery life.',
  },
  {
    question: 'Do I need a special electricity meter for off-peak charging?',
    answer:
      'Economy 7 requires a dual-rate meter, but modern smart meters can handle multiple tariff periods automatically. Time-of-use tariffs work with existing smart meters without additional hardware.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'A household with a 40kWh EV charges three times per week. At standard rate (26p/kWh) vs off-peak (12p/kWh), what is the approximate annual saving?',
    options: [
      'Around £200 per year',
      'Around £450 per year',
      'Around £870 per year',
...
const EVChargingModule5Section4 = () => {
  useSEO({
    ...
    description:
      'Master off-peak charging strategies to optimise costs and grid impact through intelligent scheduling and tariff management.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">Optimising charging times for cost and grid impact</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Savings:</strong> 40-60% cost reduction vs peak rates
              </li>
              <li>
                <strong>Timing:</strong> Typically 00:30-07:30 off-peak
              </li>
              <li>
                <strong>Method:</strong> Smart charger scheduling
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> ToU tariff, smart charger app, timer settings
              </li>
              <li>
                <strong>Use:</strong> Schedule overnight, set departure times
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Understanding tariff structures is essential for maximising the economic benefits of
              EV charging whilst supporting grid stability.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Single rate:</strong> 24-28p/kWh average
                  </li>
                  <li>
                    <strong>Standing charge:</strong> 40-50p/day
                  </li>
              ...
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Off-peak:</strong> 9-15p/kWh (00:30-07:30)
                  </li>
                  <li>
                    <strong>Peak:</strong> 30-35p/kWh (07:30-00:30)
                  </li>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Super off-peak (02:00-05:00):</strong> 5-10p/kWh - renewable surplus
                  periods
                </li>
                <li>
                  <strong>Off-peak (23:00-07:00):</strong> 12-18p/kWh - standard overnight rate
                </li>
                <li>
                  <strong>Peak (16:00-19:00):</strong> 35-50p/kWh - high demand periods
                </li>
                <li>
                  <strong>Agile tariffs:</strong> Half-hourly variable pricing based on wholesale
                  markets
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Smart charging enables automated optimisation of charging times based on tariffs, grid
            ...
            <div className="grid grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent">
                ...
                <p className="text-white text-xs">Fixed off-peak times</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">Departure</p>
                <p className="text-white text-xs">Ready-by time target</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">Dynamic</p>
                <p className="text-white text-xs">Price-responsive</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>V2G preparation:</strong> Bidirectional capability for export revenue
                </li>
                <li>
                  <strong>Frequency response:</strong> Dynamic Containment service participation
                </li>
                <li>
                  <strong>Demand response:</strong> Pause charging during grid stress events
                </li>
                <li>
                  <strong>Aggregation:</strong> Combined fleet services for smaller installations
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>DNO notification:</strong> — required for loads &gt;3.68kW
                </li>
                <li>
                  <strong>G99 compliance:</strong> — grid connection requirements for installations
                  &gt;16A
                </li>
                <li>
                  <strong>Fire safety:</strong> — protocols for underground car parks
                </li>
                <li>
                  <strong>Voltage limits:</strong> — must stay within ±6% of nominal
                </li>
              </ul>
            </div>
          </div>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="/study-centre/upskilling/ev-charging-module-5-section-5">
              Next Section
