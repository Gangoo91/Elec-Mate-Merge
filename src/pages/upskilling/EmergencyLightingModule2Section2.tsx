...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'BS 5266-1 requires minimum 0.5 lux horizontal illumination across the open area floor. This is lower than escape route lighting (1 lux) as the primary purpose is preventing panic, not detailed navigation.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Anti-panic (open area) lighting applies to areas exceeding 60m² floor area. Smaller areas are typically covered by escape route lighting. The 60m² threshold is specified in BS 5266-1.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'The same 40:1 uniformity ratio applies to open area lighting as escape routes. This ensures consistent illumination without excessively dark patches that could cause disorientation.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Escape route lighting (1 lux) illuminates defined exit paths. Anti-panic lighting (0.5 lux) covers large open areas (>60m²) to prevent panic and allow safe movement towards escape routes.',
  },
  {
    question: 'Do I need both escape route and anti-panic lighting?',
    answer:
      'Typically yes. A large hall needs anti-panic lighting across the floor area (0.5 lux) plus escape route lighting (1 lux) along defined exit paths. They serve different purposes.',
  },
  {
    question: 'How do I calculate luminaire spacing for open areas?',
    answer:
      'Use manufacturer spacing tables or photometric software for 0.5 lux minimum with 40:1 uniformity. Luminaires are typically positioned in a grid pattern based on their light distribution.',
  },
  {
    question: 'What happens at the boundary between open area and escape route?',
    answer:
      'The illumination must transition smoothly. Where escape routes pass through open areas, 1 lux must be achieved along the escape path while 0.5 lux covers the general area.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'A conference hall of 150m² has emergency lighting installed. What minimum illumination must be achieved across the floor area?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Areas exceeding 60m² require anti-panic lighting at 0.5 lux minimum. At 150m², this hall qualifies as an open area requiring anti-panic illumination across the entire floor.',
  },
];
...
const EmergencyLightingModule2Section2 = () => {
  useSEO({
    ...
    description:
      'Learn about open area anti-panic emergency lighting systems, BS 5266-1 requirements, 0.5 lux illuminance levels, and design for large open spaces.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Level:</strong> 0.5 lux minimum
              </li>
              <li>
                <strong>Area threshold:</strong> &gt;60m² floor area
              </li>
              <li>
                <strong>Purpose:</strong> Prevent panic
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Anti-panic:</strong> 0.5 lux (open areas)
              </li>
              <li>
                <strong>Escape route:</strong> 1 lux (defined paths)
              </li>
              <li>
                <strong>Uniformity:</strong> 40:1 for both
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BS 5266-1 specifies requirements for anti-panic lighting that differ from escape route
              lighting due to the different functional purpose.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Minimum:</strong> 0.5 lux horizontal
                  </li>
                  <li>
                    <strong>Uniformity:</strong> Maximum 40:1
                  </li>
                  <li>
                    <strong>Coverage:</strong> Entire floor area
                  </li>
                  <li>
                    <strong>Height:</strong> At floor level
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li>
                    <strong>Full output:</strong> 60 seconds
                  </li>
                  <li>
                    <strong>Duration:</strong> 3 hours minimum
                  </li>
                  <li>
                    <strong>Disability glare:</strong> Limited
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent">
                ...
                <p className="text-white text-xs">Minimum level</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">&gt;60m²</p>
                <p className="text-white text-xs">Area threshold</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">40:1</p>
                <p className="text-white text-xs">Max uniformity</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Calculate area:</strong> Confirm &gt;60m² requirement
                </li>
                <li>
                  <strong>Grid layout:</strong> Even luminaire distribution
                </li>
                <li>
                  <strong>Spacing:</strong> Use manufacturer photometric data
                </li>
                <li>
                  <strong>Verify uniformity:</strong> Check 40:1 ratio achieved
                </li>
                <li>
                  <strong>Integrate:</strong> Coordinate with escape route lighting
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Ignoring 60m² threshold:</strong> — Calculate all open areas
                </li>
                <li>
                  <strong>No escape route distinction:</strong> — 1 lux still needed on routes
                </li>
                <li>
                  <strong>Poor uniformity:</strong> — Check dark areas between luminaires
                </li>
                <li>
                  <strong>Ceiling height ignored:</strong> — Affects spacing significantly
                </li>
              </ul>
            </div>
          </div>
