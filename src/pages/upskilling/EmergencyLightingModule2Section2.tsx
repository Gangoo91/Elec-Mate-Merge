    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS EN 1838:2024 anti-panic methodology: 0.5 lx minimum across the unobstructed area
          excluding a 0.5 m perimeter, 40:1 maximum uniformity, 5 s response time, triggered when
          unobstructed area exceeds 60 m² OR occupancy exceeds 10 persons. Independent of escape
          route lighting; both apply where both triggers fire.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>It does not light an escape route.</strong> Once the occupant has identified a
              route and started moving along it, escape route lighting (1 lx) takes over. The
            ...
            <li>
              ...
              excludes the 0.5 m perimeter; excludes internal obstructions. The bounded area is what
              0.5 lx covers, no more.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              the walls and obstacles. The maximum to minimum ratio of illuminance shall not exceed
              40:1.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Walls.</strong> A 0.5 m strip running along every wall is excluded. In a 10 m
              × 8 m room, the verification area is 9 m × 7 m = 63 m² (not the gross 80 m²).
            </li>
            <li>
              <strong>Internal columns.</strong> A 0.5 m strip around each column is also excluded.
              A row of columns down the centre of an open office produces a series of small
              unilluminated zones around their perimeters.
            </li>
            <li>
            ...
            <li>
              ...
              generally NOT excluded because the layout could change. The verification area assumes
              the room could be cleared; the design must work whether the desks are there or not.
            </li>
            <li>
          ...
          <p>
            ...
            still illuminates the wall and the perimeter band — that light is welcome. The exclusion
            just means the calculated minimum is verified excluding those zones; the light that does
            fall there is a bonus, not a requirement.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Lecture theatre 200 m², 150 occupants.</strong> Both fire. Anti-panic applies
              to the central unobstructed walking space (between fixed seating); seating itself is
              the obstruction.
            </li>
          </ul>
          <p>
            The 60 m² figure is roughly an 8 m × 8 m room. The 10-occupant figure catches small
            meeting rooms that designers often miss because the area looks fine. Both triggers must
            be evaluated on every space — area alone is not enough.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Open area (anti-panic) lighting shall be provided where the unobstructed area exceeds
              60 m² or where the occupancy exceeds 10 persons, whichever applies first. Where the
              area is small but the occupancy is high, the occupancy trigger shall apply.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Geometry of measurement.</strong> Route uniformity is along the route, roughly
              one-dimensional. Area uniformity is across a two-dimensional grid. Verification
              typically uses a grid of measurement points (every 1-2 m).
            </li>
            <li>
            ...
            <li>
              ...
              under 1.5:1 to give comfortable area uniformity. A spacing-to-height ratio of 3:1 will
              struggle to meet 40:1 across an area, even if it passes 40:1 along a route.
            </li>
            <li>
              <strong>Edge effects.</strong> Anti-panic verification at the 0.5 m perimeter boundary
              often gives the worst-case minimum because the room's far edge sees the least overlap
              from luminaires. Designers add perimeter luminaires to address this.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The illuminance for open area lighting shall reach 50 % within 5 s and 100 % within 60
              s. The minimum duration shall be that determined for the building, not less than the
              duration applied to escape route lighting.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Lamp warm-up.</strong> LED is effectively instant. Discharge lamps could take
              10-30 s to full output (the 60 s allowance covered this in older installations).
              Modern installations are LED-only and the 5 s test is trivial to meet.
            </li>
            <li>
            ...
            <li>
              ...
              (mechanical wear) may take 10-15 s instead of 1 s. Looks fine on monthly visual test,
              fails 5 s rule. Battery testing alone misses this — the relay timing has to be
              checked.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Escape route is more demanding numerically.</strong> 1 lx is double 0.5 lx. A
              layout that produces 1 lx along the route generally produces 0.5 lx in the surrounding
              area as a side effect — provided the spacing is reasonably tight.
            </li>
            <li>
              <strong>Verification differs.</strong> Verify route compliance across the full width
              at floor level, with the BS EN 1838:2024 edge exclusions (outer 0.5 m on routes &gt; 2
              m, outer ¼ width on routes ≤ 2 m). Verify anti-panic compliance across the
              unobstructed area excluding the 0.5 m perimeter. Two different measurement geometries;
              one luminaire layout has to satisfy both.
            </li>
            <li>
            ...
            <li>
              <strong>Mandatory locations apply from escape route.</strong> The mandatory luminaire
              locations from BS 5266-1:2025 §6 (exit doors, change of direction, top and bottom of
              stairs, etc.) carry through. Anti-panic does not relax these.
            </li>
            <li>
              <strong>The risk: designing for anti-panic alone.</strong> A layout designed for 0.5
              lx everywhere may fall to 0.6 lx along the route — passes anti-panic but fails escape
              route 1 lx. Always design for the more demanding metric where both apply.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Where an escape route passes through an open area subject to anti-panic lighting, the
              requirements of §4 (escape route lighting) and §5 (open area lighting) shall both
              apply. Compliance with §4 along the route does not relieve the requirement to comply
              with §5 across the unobstructed area.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Reception areas.</strong> Often around 30-50 m² with variable occupancy. Apply
              anti-panic if the rated occupancy reaches 11+ at any time, or if the unobstructed area
              exceeds 60 m². Reception desks and seating are obstructions; the walk-through area is
              the unobstructed component.
            </li>
            <li>
            ...
            <li>
              ...
              triggers. Larger washroom areas with multiple cubicles where the unobstructed walking
              area exceeds 8 m² require escape route lighting (per BS 5266-1:2025 mandatory
              locations); anti-panic only if the open area trigger fires.
            </li>
            <li>
            ...
            <li>
              ...
              open areas for anti-panic if covered and forming part of the building's escape route.
              Verify on actual area used and occupancy.
            </li>
            <li>
