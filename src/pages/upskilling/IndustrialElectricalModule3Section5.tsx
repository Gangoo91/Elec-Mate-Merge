...
const IndustrialElectricalModule3Section5: React.FC = () => {
  ...
  useSEO({
    title:
      'Functional Testing and Documentation | Industrial Electrical Module 3 Section 5 | Elec-Mate',
    description:
  ...
  const quickCheckQuestions = [
    ...
    },
    {
      ...
      question:
        'Under BS EN 61439, which type of verification must be performed on every manufactured assembly?',
      options: [
        'Type testing only',
    ...
    },
    {
      ...
      question:
        'What document confirms that a switchgear assembly meets the essential requirements of the Low Voltage Directive?',
      options: [
        'Test certificate',
        'O&M manual',
  ...
  const faqItems = [
    {
      question:
        'What is the difference between type testing and routine verification under BS EN 61439?',
      answer:
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">
            BS EN 61439 verification requirements, FAT/SAT procedures, test certificates, and
            technical documentation packages for industrial switchgear assemblies
          </p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                This section covers the essential testing and documentation requirements for
                industrial switchgear assemblies. You will learn about Factory Acceptance Testing
                (FAT), Site Acceptance Testing (SAT), BS EN 61439 routine verification procedures,
                point-to-point wiring verification, functional sequence testing, and the technical
                documentation packages required for compliance.
              </p>
            </div>
          </div>
        </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-sm text-muted-foreground">
              Factory Acceptance Testing (FAT) is performed at the manufacturer's premises before
              the switchgear assembly is dispatched to site. It provides the opportunity to verify
              compliance with specifications and identify issues while corrections can still be made
              cost-effectively in controlled factory conditions.
            </p>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Verify construction quality, component installation, labelling, and general
                      workmanship against drawings
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Check door operation, interlocks, withdrawable units, and earthing provisions
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Insulation resistance, protective circuit continuity, dielectric withstand (if
                      required)
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Control circuit operation, protection relay settings, metering accuracy,
                      sequence testing
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Verify all certificates, test records, and O&M documentation complete and
                      correct
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm mt-1 text-muted-foreground">
                    Many contracts require customer witness of FAT. The customer or their
                    representative attends to observe testing, review results, and formally accept
                    the equipment. A witness point schedule should be agreed in advance, and the
                    customer must be given adequate notice (typically 5-10 working days) before each
                    witness hold point. The customer signs off each witnessed test on the ITP.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-sm text-muted-foreground">
              Point-to-point (P2P) testing verifies that every wire connection in the assembly
              matches the schematic drawings. This is a critical quality check that must be
              performed on 100% of circuits, not by sampling. Modern methods combine manual
              verification with continuity testing.
            </p>
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-muted-foreground">
                    Every power circuit connection verified against single-line diagram
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle size={16} className="text-green-400 flex-shrink-0" />
                  <span className="text-muted-foreground">
                    All control circuit wiring checked against schematic drawings
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle size={16} className="text-green-400 flex-shrink-0" />
                  <span className="text-muted-foreground">
                    Phase rotation and polarity confirmed (L1, L2, L3 sequence)
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle size={16} className="text-green-400 flex-shrink-0" />
                  <span className="text-muted-foreground">
                    Neutral and protective earth connections traced and verified
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle size={16} className="text-green-400 flex-shrink-0" />
                  <span className="text-muted-foreground">
                    External interface terminals correctly identified and labelled
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle size={16} className="text-green-400 flex-shrink-0" />
                  <span className="text-muted-foreground">
                    Ferrule/sleeve identification matches drawing references
                  </span>
                </div>
              </div>
            </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-sm text-muted-foreground">
              Functional sequence testing verifies that control circuits operate in the correct
              sequence and all interlocks function as designed. This goes beyond simple continuity
              testing to prove the system logic works correctly under simulated operating
              conditions.
            </p>

            <div className="bg-background/50 rounded-lg p-4 border border-white/10">
              <h3 className="font-medium text-foreground mb-3">
                Motor Starter Sequence Test Example
              </h3>
              <div className="space-y-3 text-sm">
                <div className="border-l-2 border-elec-yellow/50 pl-4">
                  <p className="font-medium text-foreground">Step 1: Pre-conditions</p>
                  <p className="text-muted-foreground">
                    Verify isolator closed, control supply on, no fault conditions active, door
                    closed (if interlocked)
                  </p>
                </div>
                <div className="border-l-2 border-elec-yellow/50 pl-4">
                  <p className="font-medium text-foreground">Step 2: Start Command</p>
                  <p className="text-muted-foreground">
                    Apply start signal - verify contactor energises, run indication activates,
                    ammeter shows current flow (if motor connected)
                  </p>
                </div>
                <div className="border-l-2 border-elec-yellow/50 pl-4">
                  <p className="font-medium text-foreground">Step 3: Stop Command</p>
                  <p className="text-muted-foreground">
                    Apply stop signal - verify contactor de-energises, run indication clears,
                    circuit ready for restart
                  </p>
                </div>
                <div className="border-l-2 border-elec-yellow/50 pl-4">
                  <p className="font-medium text-foreground">Step 4: Overload Trip</p>
                  <p className="text-muted-foreground">
                    Simulate overload (test button) - verify trip, fault indication active, restart
                    blocked until reset
                  </p>
                </div>
                <div className="border-l-2 border-elec-yellow/50 pl-4">
                  ...
                  <p className="text-muted-foreground">
                    Test E-stop function - verify immediate de-energisation, latched until manually
                    reset
                  </p>
                </div>
              </div>
            ...
            <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg p-4">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm mt-1 text-muted-foreground">
                    During FAT, external signals are typically simulated using temporary links,
                    signal generators, or dedicated test panels. PLC inputs can be forced for
                    testing (with appropriate safety measures). Document all temporary modifications
                    and ensure complete removal before dispatch. Some tests may require actual motor
                    connection or load banks for full verification.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-sm text-muted-foreground">
              BS EN 61439 defines mandatory routine verification tests that must be performed on
              every manufactured assembly before it can be CE/UKCA marked. These tests confirm that
              the individual unit has been constructed correctly according to the verified design.
            </p>

            <div className="bg-background/50 rounded-lg p-4 border border-white/10">
              <h3 className="font-medium text-foreground mb-3">
                Mandatory Routine Verification Tests
              </h3>
              <div className="space-y-4">
                <div className="bg-background/70 p-4 rounded border border-white/5">
                  <h4 className="text-elec-yellow font-medium mb-2 text-sm">
                    1. Degree of Protection (IP Rating)
                  </h4>
                  <p className="text-sm text-muted-foreground">
                    Visual inspection to verify that the enclosure construction provides the
                    declared IP rating. Check seals, gaskets, cable entries, ventilation openings,
                    and access covers.
                  </p>
                </div>
                ...
                <div className="bg-background/70 p-4 rounded border border-white/5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Verify adequate spacing between live parts and between live parts and earth.
                    Compare with values established during design verification for the rated voltage
                ...
                <div className="bg-background/70 p-4 rounded border border-white/5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Check barriers, enclosures, and insulation providing protection against direct
                    contact. Verify all exposed conductive parts are connected to protective
                    circuit.
                  </p>
                </div>
                ...
                <div className="bg-background/70 p-4 rounded border border-white/5">
                  <h4 className="text-elec-yellow font-medium mb-2 text-sm">
                    4. Installation of Switching Devices and Components
                  </h4>
                  <p className="text-sm text-muted-foreground">
                    Verify correct installation, ratings, settings, and condition of all devices.
                    Check position indicators, rating labels, and operating mechanisms.
                  </p>
                </div>
                ...
                <div className="bg-background/70 p-4 rounded border border-white/5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Point-to-point verification of all wiring against drawings. Confirm conductor
                    sizes, routing, and termination quality.
                  </p>
                </div>
                ...
                <div className="bg-background/70 p-4 rounded border border-white/5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Check terminal suitability for declared conductor size range. Verify marking,
                    accessibility, and tightening torque capability.
                  </p>
                </div>
                ...
                <div className="bg-background/70 p-4 rounded border border-white/5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Test operation of all moving parts - doors, covers, drawout mechanisms,
                    interlocks, padlock provisions, and indicating devices.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm mt-1 text-muted-foreground">
                    A dielectric withstand test may be performed instead of design verification.
                    Test voltage is 2Un + 1000V for circuits rated ≤690V (minimum 1500V). Applied
                    for 1 second between live parts and earth, and between separate circuits. This
                    test is typically only required for power frequency withstand verification on
                    assemblies using non-type-tested arrangements.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-sm text-muted-foreground">
              The technical file is a legal requirement that demonstrates compliance with BS EN
              61439 and enables the manufacturer to affix CE/UKCA marking. It must be retained for
              10 years and made available to enforcement authorities on request.
            </p>
            ...
            <div className="bg-background/50 rounded-lg p-4 border border-white/10">
              ...
              <p className="text-sm mb-3 text-muted-foreground">
                The Declaration of Conformity (DoC) is the manufacturer's formal statement that the
                product meets all applicable requirements. It must contain:
              </p>
              <div className="space-y-2 text-sm">
                <div className="flex items-start gap-2">
                ...
                <div className="flex items-start gap-2">
                  <CheckCircle size={16} className="text-green-400 mt-0.5 flex-shrink-0" />
                  <span className="text-muted-foreground">
                    Product identification (type, serial number, description)
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle size={16} className="text-green-400 mt-0.5 flex-shrink-0" />
                  <span className="text-muted-foreground">
                    Reference to BS EN 61439 and applicable parts
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle size={16} className="text-green-400 mt-0.5 flex-shrink-0" />
                  <span className="text-muted-foreground">
                    Reference to applicable EU Directives (LVD 2014/35/EU, EMC 2014/30/EU)
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle size={16} className="text-green-400 mt-0.5 flex-shrink-0" />
                  <span className="text-muted-foreground">
                    Signature of authorised representative with date and place
                  </span>
                </div>
              </div>
            </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-sm text-muted-foreground">
              Site Acceptance Testing (SAT) is performed after installation at the final location to
              verify the assembly has not been damaged during transport, site connections are
              correct, and the system integrates properly with other site equipment and services.
            </p>
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm mt-1 text-muted-foreground">
                    Define hold points in the commissioning plan where work stops until
                    witness/approval is given. Typical SAT hold points include: completion of visual
                    inspection, pre-energisation sign-off, first energisation, protection testing
                    completion, and final acceptance. Proceeding past a hold point without proper
                    authorization may void warranties or contractual obligations.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="bg-background/50 rounded-lg p-4 border border-white/10">
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>
                    <span className="text-elec-yellow">1.</span> Visual inspection of construction
                  </li>
                  <li>
                    <span className="text-elec-yellow">2.</span> IP rating verification
                  </li>
                  <li>
                    <span className="text-elec-yellow">3.</span> Clearances and creepage
                  </li>
                  <li>
                    <span className="text-elec-yellow">4.</span> Wiring and connections
                  </li>
                  <li>
                    <span className="text-elec-yellow">5.</span> Insulation resistance (≥1MΩ)
                  </li>
                  <li>
                    <span className="text-elec-yellow">6.</span> Protective circuit continuity
                  </li>
                  <li>
                    <span className="text-elec-yellow">7.</span> Mechanical operation
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-background/50 rounded-lg p-4 border border-white/10">
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>
                    <span className="text-green-400">✓</span> Declaration of Conformity
                  </li>
                  <li>
                    <span className="text-green-400">✓</span> Test certificates (FAT/SAT)
                  </li>
                  <li>
                    <span className="text-green-400">✓</span> As-built drawings
                  </li>
                  <li>
                    <span className="text-green-400">✓</span> O&M manual
                  </li>
                  <li>
                    <span className="text-green-400">✓</span> Setting schedules
                  </li>
                  <li>
                    <span className="text-green-400">✓</span> Component datasheets
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-background/50 rounded-lg p-4 border border-white/10">
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li>
                    <span className="text-elec-yellow">BS EN 61439-1:</span> General rules
                  </li>
                  <li>
                    <span className="text-elec-yellow">BS EN 61439-2:</span> Power switchgear
                  </li>
                  <li>
                    <span className="text-elec-yellow">LVD 2014/35/EU:</span> Safety directive
                  </li>
                  <li>
                    <span className="text-elec-yellow">EMC 2014/30/EU:</span> EMC directive
                  </li>
                  <li>
                    <span className="text-elec-yellow font-medium">Retention:</span> 10 years
                    minimum
                  </li>
                </ul>
              </div>
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            Test your knowledge of functional testing and documentation requirements. You need 70%
            to pass.
          </p>
          <Button
