...
const InstrumentationModule3Section4 = () => {
  useSEO({
    ...
    description:
      'Learn signal scaling techniques, analogue-to-digital conversion, and error management in instrumentation systems.',
  });
  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      correct: 1,
      explanation:
        'Converting voltage to current (typically 4-20mA) improves noise immunity and enables reliable long-distance transmission, as current signals are less affected by cable resistance and electrical interference.',
    },
    {
      id: 4,
    ...
    },
    {
      ...
      correct: 1,
      explanation:
        "Converting RTD resistance changes to temperature values in degrees Celsius is a common instrumentation conversion, where the sensor's resistance variation is mathematically converted to meaningful temperature units.",
    },
  ];
      ...
      <div className="px-4 py-6 max-w-4xl mx-auto">
        ...
        <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 mb-8">
          ...
          <p className="text-white text-sm">
            Signal scaling and conversion ensure different system components interpret measurement
            data correctly. Understanding error sources in these processes is essential for
            maintaining measurement integrity throughout the signal chain.
          </p>
        </div>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4 text-white">
            <p>
              Signal scaling ensures that different system components can properly interpret
              measurement data by converting between different ranges and units.
            </p>
            ...
            <div className="bg-card/50 rounded-lg p-4">
              ...
              <div className="bg-background/50 rounded p-3 font-mono text-sm text-white">
                <p className="mb-2">
                  <strong>Formula:</strong> Output = (Input - Input_Min) x (Output_Range /
                  Input_Range) + Output_Min
                </p>
                <p className="mb-1">
                  <strong>Example:</strong> Converting 0-10V sensor to 0-100 degrees C display
                </p>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4 text-white">
            <p>
              Signal conversion transforms signals between different formats (analogue/digital) and
              types (voltage/current) to enable compatibility between system components.
            </p>
                ...
                <div>
                  ...
                  <div className="bg-background/50 rounded p-3">
                    <ul className="text-sm text-white space-y-1">
                      <li>
                        <strong>12-bit:</strong> 1 part in 4,096 (0.024% resolution)
                      </li>
                      <li>
                        <strong>16-bit:</strong> 1 part in 65,536 (0.0015% resolution)
                      </li>
                      <li>
                        <strong>24-bit:</strong> 1 part in 16,777,216 (0.000006% resolution)
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="bg-background/50 rounded p-3">
                  ...
                  <p className="text-white text-xs">
                    Simple precision resistor converts current to proportional voltage for ADC
                    input.
                  </p>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4 text-white">
            <p>
              Every conversion and scaling operation introduces potential sources of error that can
              degrade measurement accuracy. Understanding these error sources enables proper system
              design.
            </p>
            ...
            <div className="bg-card/50 rounded-lg p-4">
              ...
              <p className="text-white text-sm mb-3">
                The inherent error in representing continuous analogue signals with discrete digital
                values.
              </p>
              <div className="bg-background/50 rounded p-3">
                <p className="text-white text-sm mb-2">
                  <strong>Maximum Error = plus or minus 0.5 LSB (Least Significant Bit)</strong>
                </p>
                ...
                <p className="text-white text-xs">
                  Maximum quantisation error = plus or minus 1.22mV
                </p>
              </div>
            </div>
            ...
            <div className="bg-card/50 rounded-lg p-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <ul className="space-y-1 text-sm text-white">
                    <li>
                      <strong>INL:</strong> Deviation from ideal transfer function
                    </li>
                    <li>
                      <strong>DNL:</strong> Unequal step sizes between codes
                    </li>
                    <li>
                      <strong>Gain Error:</strong> Incorrect scaling factor
                    </li>
                    <li>
                      <strong>Offset Error:</strong> Zero-point deviation
                    </li>
                  </ul>
                </div>
                <div>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-4 text-white">
            <p>
              Understanding the distinction between resolution and accuracy is crucial for proper
              system design. High resolution does not guarantee high accuracy.
            </p>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              <p className="text-white text-sm">
                <strong>Design Principle:</strong> Match resolution to accuracy requirements.
                Excessive resolution beyond accuracy capabilities wastes resources and can give
                false confidence in measurement quality.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="bg-card/50 rounded-lg p-4">
            ...
            <p className="text-white text-sm mb-4">
              A PLC system scales 0-10V sensor output to represent 0-200 bar pressure for data
              logging and control.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white text-xs">
                    0-10V scaled to 0-200 bar: Pressure = (Voltage / 10) x 200. For 5V input = 100
                    bar output.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white text-xs">
                    12-bit ADC provides 4096 steps over 10V = 2.44mV resolution, equivalent to 0.049
                    bar pressure resolution.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white text-xs">
                    Two-point calibration at 0V (0 bar) and 10V (200 bar) corrects gain and offset
                    errors.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white text-xs">
                    Achieves plus or minus 0.5% accuracy specification with 6-month calibration
                    intervals.
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-4">
            <div className="bg-card/50 rounded-lg p-4">
              <h3 className="font-semibold text-white mb-2">
                When should I use linear vs non-linear scaling?
              </h3>
              <p className="text-white text-sm">
                Use linear scaling when the sensor output is directly proportional to the measured
                parameter. Use non-linear scaling for sensors like thermocouples, RTDs, or flow
                sensors where the relationship is not linear.
              </p>
            </div>

            <div className="bg-card/50 rounded-lg p-4">
              <h3 className="font-semibold text-white mb-2">
                How often should I recalibrate conversion systems?
              </h3>
              <p className="text-white text-sm">
                Calibration intervals depend on accuracy requirements and environmental conditions.
                Critical systems may need monthly calibration, while stable environments may allow
                annual calibration. Always recalibrate after significant temperature changes or
            ...
            <div className="bg-card/50 rounded-lg p-4">
              ...
              <p className="text-white text-sm">
                Choose ADC resolution based on required measurement precision. For 0.1% accuracy,
                you need at least 10 bits (1024 steps). For 0.01% accuracy, you need at least 14
                bits. Always select 2-4 bits more than the minimum for noise margin.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-3 pt-6 border-t border-border">
          <Link
            to="/electrician/upskilling/instrumentation-module-3-section-3"
          ...
          <Link
            to="/electrician/upskilling/instrumentation-module-3-section-5"
            className="w-full sm:w-auto"
          >
