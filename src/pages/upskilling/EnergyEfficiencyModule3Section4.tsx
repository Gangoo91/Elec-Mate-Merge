...
const EnergyEfficiencyModule3Section4: React.FC = () => {
  useSEO({
    ...
    description:
      'Master energy audit tools including thermal imaging cameras, power quality analysers, audit software platforms, and mobile apps. Build your professional audit toolkit with UK-specific recommendations.',
    keywords:
      'energy audit tools, thermal imaging cameras, power quality analyser, energy audit software, FLIR camera, data logger, electrical audit equipment UK',
  });
  ...
  const quickCheckQuestions = [
    ...
    },
    {
      id: 'qc2-m3s4',
      question:
        'Which power quality parameter is most important to measure when investigating unexplained equipment failures?',
      options: [
        'Frequency only',
      ...
      correctIndex: 1,
      explanation:
        'When investigating equipment failures, measuring voltage (including sags/swells), current (including imbalance), and harmonics provides comprehensive data. Harmonics from non-linear loads can cause overheating and premature failure of motors, transformers, and capacitors.',
    },
    {
      id: 'qc3-m3s4',
      question:
        'What is the minimum recommended data logging period to capture a full operational profile for an energy audit?',
      options: ['1 hour', '24 hours', '7 days minimum, ideally 2-4 weeks', '1 year'],
      correctIndex: 2,
      explanation:
        'A minimum of 7 days captures weekday/weekend variations, but 2-4 weeks is ideal to account for different operational patterns, seasonal variations, and any anomalies. This provides statistically meaningful data for accurate baseline assessment and identifying optimisation opportunities.',
    },
  ];
  ...
  const quizQuestions = [
    ...
    {
      question:
        'What is the recommended minimum resolution for a thermal camera used in electrical audits?',
      options: [
        '80x60 pixels',
        '160x120 pixels',
        '320x240 pixels or higher',
  ...
  return (
    <div className="bg-[#1a1a1a]">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-12">
        ...
        <section className="space-y-6">
          ...
          <div className="bg-white/5 rounded-lg p-6 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white">
                  Thermal cameras detect infrared radiation emitted by objects and convert it to
                  visible images showing temperature variations. For electrical audits, they reveal
                  loose connections, overloaded circuits, failing components, and imbalanced loads
                  before they cause failures or fires.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-4">
              <div className="bg-white/5 rounded-lg p-4">
                ...
                <ul className="text-white text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Resolution:</strong> Minimum 320x240 pixels for professional work;
                      160x120 for basic surveys
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle size={16} className="text-green-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Thermal Sensitivity (NETD):</strong> 50mK or better for detecting
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle size={16} className="text-green-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Temperature Range:</strong> -20°C to +350°C covers most electrical
                      applications
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle size={16} className="text-green-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Focus:</strong> Manual focus offers more control; auto-focus faster
                      for surveys
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 rounded-lg p-4">
                <h4 className="font-semibold text-elec-yellow mb-2">
                  Recommended Models (UK Pricing)
                </h4>
                <ul className="text-white text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    <PoundSterling size={16} className="text-elec-yellow mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Entry (£500-£1,500):</strong> FLIR C5, FLIR ONE Pro, Seek Thermal Pro
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <PoundSterling size={16} className="text-elec-yellow mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Professional (£2,000-£5,000):</strong> FLIR E54, Testo 871, Fluke
                      Ti401
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <PoundSterling size={16} className="text-elec-yellow mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Advanced (£5,000+):</strong> FLIR T540, Fluke Ti480 PRO
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Star size={16} className="text-yellow-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Best Value:</strong> FLIR E54 (£3,500) - excellent all-rounder
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4 mt-4">
              ...
              <div className="text-white text-sm space-y-2">
                <p>
                  <strong>
                    Temperature Rise Categories (above ambient or identical components):
                  </strong>
                </p>
                <ul className="list-disc list-inside ml-2 space-y-1">
                  <li>
                    <span className="text-green-400">1-10°C:</span> Monitor - possible developing
                    issue
                  </li>
                  <li>
                    <span className="text-yellow-400">10-25°C:</span> Priority attention - schedule
                    repair soon
                  </li>
                  <li>
                    <span className="text-orange-400">25-40°C:</span> Urgent - repair as soon as
                    possible
                  </li>
                  <li>
                    <span className="text-red-400">40°C+:</span> Critical - immediate action
                    required
                  </li>
                </ul>
              </div>
          ...
          <div className="bg-white/5 rounded-lg p-6 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white">
                  Power quality analysers measure electrical parameters beyond basic voltage and
                  current, including harmonics, power factor, transients, sags, swells, and energy
                  consumption patterns. This data is essential for identifying waste, diagnosing
                  equipment issues, and validating improvement measures.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-4">
              <div className="bg-white/5 rounded-lg p-4">
                ...
                <ul className="text-white text-sm space-y-2">
                  <li>
                    <strong>Fluke 1770 Series (£4,000-£8,000):</strong> Industry standard,
                    comprehensive PQ analysis
                  </li>
                  <li>
                    <strong>Hioki PW3198 (£3,500):</strong> Excellent value, good software
                  </li>
                  <li>
                    <strong>Chauvin Arnoux C.A 8336 (£3,000):</strong> Compact, reliable
                  </li>
                  <li>
                    <strong>Fluke 1732/1734 (£1,800-£2,500):</strong> Energy logger for basic audits
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 rounded-lg p-4">
                ...
                <ul className="text-white text-sm space-y-2">
                  <li>
                    <strong>Onset HOBO (£150-£500):</strong> Temperature, humidity, light
                  </li>
                  <li>
                    <strong>Tinytag (UK made, £100-£300):</strong> Robust, simple deployment
                  </li>
                  <li>
                    <strong>Efergy/OWL (£50-£150):</strong> Basic CT energy monitoring
                  </li>
                  <li>
                    <strong>Lascar EL-USB (£50-£200):</strong> USB data loggers
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-4 mt-4">
              <div className="bg-white/5 rounded-lg p-4">
                <h4 className="font-semibold text-green-400 mb-3">
                  Professional Cloud Platforms (UK Market)
                </h4>
        ...
        <section className="space-y-6">
          ...
          <div className="bg-white/5 rounded-lg p-6 space-y-4">
            <p className="text-white">
              ...
              efficient data capture, photo documentation, and real-time calculations during site
              surveys.
            </p>
            ...
            <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg p-4">
              ...
              <p className="text-white text-sm">
                ...
                thermal images with corresponding visual photos, and voice-record observations. Use
                consistent naming conventions (e.g., "Building-Floor-Room-Item") for easy
          ...
          <div className="bg-white/5 rounded-lg p-6 space-y-4">
            ...
            <div className="bg-white/5 rounded-lg p-4">
              <h4 className="font-semibold text-elec-yellow mb-3">
                Key Excel Functions for Energy Analysis
              </h4>
                  ...
                  <tbody className="text-white font-mono text-xs">
                    ...
                    <tr className="border-b border-white/10">
                      ...
                      <td className="py-2 px-3">
                        Identify baseload (5th percentile) and peak demand
                      </td>
                    </tr>
                    <tr className="border-b border-white/10">
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              <h4 className="font-semibold text-blue-400 mb-2">
                Half-Hourly Data Analysis Formula
              </h4>
              <p className="text-white text-sm mb-2">
                To calculate baseload from half-hourly data (identifies minimum overnight
                consumption):
              </p>
        ...
        <section className="space-y-6">
          ...
          <div className="bg-white/5 rounded-lg p-6 space-y-4">
            ...
            <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg p-4">
              ...
              <ul className="text-white text-sm space-y-1">
                <li>
                  • Maintain calibration records - recalibrate annually for critical instruments
                </li>
        ...
        {/* Quiz Section */}
        <section className="space-y-6">
          <h3 className="text-xl font-bold text-elec-yellow">Section Knowledge Check</h3>
          <Quiz questions={quizQuestions} />
        </section>

        {/* FAQs */}
        <section className="space-y-4">
          <h3 className="text-xl font-bold text-elec-yellow">Frequently Asked Questions</h3>
