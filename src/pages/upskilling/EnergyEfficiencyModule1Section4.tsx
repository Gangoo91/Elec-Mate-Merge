...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      'Which motor efficiency class represents the highest efficiency level under current standards?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'From July 2023, what is the minimum efficiency class required for new motors between 75kW and 200kW in the EU/UK?',
    options: [
      'IE2 High Efficiency',
      'IE3 Premium Efficiency',
    ...
    correctAnswer: 2,
    explanation:
      'From July 2023, motors between 75kW and 200kW must meet IE4 Super Premium Efficiency standards.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'BS EN 16247-2 specifically covers energy audits for buildings, while Part 1 covers general requirements.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'BS EN 15232 assesses the impact of building automation and control systems (BACS) on energy efficiency.',
  },
  {
    id: 5,
    question:
  ...
  },
  {
    id: 7,
    question:
      'What is the minimum efficacy requirement for general lighting in new non-domestic buildings under Part L 2021?',
    options: [
      '60 lumens per watt',
      '80 lumens per watt',
      '95 lumens per watt',
    ...
    correctAnswer: 2,
    explanation:
      'Part L 2021 requires a minimum lighting efficacy of 95 lumens per watt for general lighting in new non-domestic buildings.',
  },
  {
    id: 8,
  ...
  },
  {
    id: 9,
    question:
      'Which standard provides the framework for calculating building energy performance certificates (EPCs)?',
    options: ['ISO 50001', 'BS EN 16247', 'BS EN 15232', 'BS EN ISO 52000 series'],
    correctAnswer: 3,
    explanation:
      'The BS EN ISO 52000 series provides the calculation methodology for building energy performance certificates.',
  },
  {
    id: 10,
    question:
      'What percentage energy savings can typically be achieved by upgrading from IE2 to IE4 motors?',
    options: ['1-2%', '3-5%', '10-15%', '25-30%'],
    correctAnswer: 1,
    explanation:
      "Upgrading from IE2 to IE4 motors typically achieves 3-5% energy savings, which compounds significantly over the motor's lifetime.",
  },
];
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <header className="text-center mb-12">
            ...
            <p className="text-white">
              Understanding the key standards framework for energy efficiency compliance and best
              practice in the UK
            </p>
          </header>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-12">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>ISO 50001:</strong> Energy management systems
                </li>
                <li>
                  <strong>BS EN 16247:</strong> Energy audit methodology
                </li>
                <li>
                  <strong>BS EN 15232:</strong> BACS efficiency classes
                </li>
                <li>
                  <strong>IE1-IE5:</strong> Motor efficiency standards
                </li>
              </ul>
            </div>
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>Spot:</strong> Motor nameplates for IE class
                </li>
                <li>
                  <strong>Spot:</strong> EPC ratings on buildings
                </li>
                <li>
                  <strong>Use:</strong> ESOS compliance requirements
                </li>
                <li>
                  <strong>Use:</strong> Part L for new installations
                </li>
              </ul>
            </div>
          </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ISO 50001 is the international standard for Energy Management Systems (EnMS). First
                published in 2011 and updated in 2018, it provides organisations with a systematic
                approach to achieving continual improvement in energy performance.
              </p>

              <div className="my-6">
                <p className="text-sm font-medium text-white mb-2 flex items-center gap-2">
                  <Target className="h-4 w-4 text-elec-yellow" /> Key Principles of ISO 50001:
                </p>
                <ul className="text-sm text-white space-y-2 ml-4">
                  <li>
                    <strong>Plan-Do-Check-Act (PDCA)</strong> - Continuous improvement cycle
                    embedded in all processes
                  </li>
                  <li>
                    <strong>Energy Policy</strong> - Top management commitment with defined
                    objectives and targets
                  </li>
                  <li>
                    <strong>Energy Review</strong> - Analysis of energy use and consumption patterns
                  </li>
                  <li>
                    <strong>Energy Performance Indicators (EnPIs)</strong> - Measurable metrics to
                    track progress
                  </li>
                  <li>
                    <strong>Energy Baseline</strong> - Reference point for measuring improvements
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                BS EN 16247 is a multi-part European standard that defines requirements for energy
                audits. It ensures audits are conducted systematically and produce comparable,
                actionable results.
              </p>

              <div className="my-6">
                <p className="text-sm font-medium text-white mb-2 flex items-center gap-2">
                  <FileCheck className="h-4 w-4 text-elec-yellow" /> Standard Parts Overview:
                </p>
                <div className="space-y-3">
                  <div className="p-3 rounded-lg bg-elec-yellow/5">
                    ...
                    <p className="text-white text-sm">
                      Common methodology, auditor competence, reporting requirements applicable to
                      all sectors
                    </p>
                  </div>
                  <div className="p-3 rounded-lg bg-elec-yellow/5">
                    ...
                    <p className="text-white text-sm">
                      Specific requirements for building energy audits including HVAC, lighting, and
                      building fabric
                    </p>
                  </div>
                  <div className="p-3 rounded-lg bg-elec-yellow/5">
                    ...
                    <p className="text-white text-sm">
                      Industrial and manufacturing processes, production equipment, and process
                      heating/cooling
                    </p>
                  </div>
                  <div className="p-3 rounded-lg bg-elec-yellow/5">
                    ...
                    <p className="text-white text-sm">
                      Fleet operations, logistics, and transport-related energy consumption
                    </p>
                  </div>
                  <div className="p-3 rounded-lg bg-elec-yellow/5">
                    <p className="text-elec-yellow text-sm font-medium">
                    ...
                    <p className="text-white text-sm">
                      Qualification requirements, knowledge, skills, and professional conduct
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-white text-sm">
                  Under ESOS Phase 3, qualifying organisations must conduct energy audits compliant
                  with BS EN 16247 or maintain ISO 50001 certification. Audits must cover at least
                  90% of total energy consumption and be conducted by approved lead assessors.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                BS EN 15232 (now part of BS EN ISO 52120) provides a method for assessing the energy
                impact of Building Automation and Control Systems (BACS) and Technical Building
                Management (TBM). It classifies systems from A (most efficient) to D (least
                efficient).
              </p>

              <div className="my-6">
                <p className="text-sm font-medium text-white mb-2 flex items-center gap-2">
                  <Building2 className="h-4 w-4 text-elec-yellow" /> BACS Efficiency Classes:
                </p>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <p className="text-elec-yellow text-sm font-medium mb-2">
                  Typical Energy Savings by Class Upgrade
                </p>
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>D to C:</strong> 10-15% savings
                  </li>
                  <li>
                    <strong>C to B:</strong> 15-25% savings
                  </li>
                  <li>
                    <strong>B to A:</strong> 10-20% savings
                  </li>
                  <li>
                    <strong>D to A:</strong> 40-50% total savings achievable
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Motor efficiency classes are defined by IEC 60034-30-1 and enforced through the UK
                Ecodesign regulations. Electric motors account for approximately 70% of industrial
                electricity consumption, making efficiency standards crucial for energy reduction.
              </p>

              <div className="my-6">
                <p className="text-sm font-medium text-white mb-2 flex items-center gap-2">
                  <Settings className="h-4 w-4 text-elec-yellow" /> International Efficiency (IE)
                  Classes:
                </p>
              ...
              <div className="grid sm:grid-cols-2 gap-4 my-6">
                <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                  <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                    <Factory className="h-4 w-4" /> Current UK Requirements (2024)
                  </p>
                  <ul className="text-sm text-white space-y-1">
                ...
                <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                  <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                    <Gauge className="h-4 w-4" /> Cost-Benefit Example
                  </p>
                  ...
                  <ul className="text-sm text-white space-y-1">
                    ...
                    <li className="text-green-400 font-medium">
                      IE2 to IE4 savings: 727 pounds/year
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Lighting typically accounts for 15-25% of a building's electricity consumption. UK
                Building Regulations Part L sets minimum efficiency requirements, supported by
                various BS EN standards for design and performance.
              </p>

              <div className="my-6">
                <p className="text-sm font-medium text-white mb-2 flex items-center gap-2">
                  <Lightbulb className="h-4 w-4 text-elec-yellow" /> Part L 2021 Lighting
                  Requirements:
                </p>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <div className="grid sm:grid-cols-2 gap-3 text-sm">
                  <div>
                    <p className="text-white">
                      <strong>BS EN 12464-1:</strong> Lighting of indoor work places - light levels,
                      uniformity, glare limits
                    </p>
                  </div>
                  <div>
                    <p className="text-white">
                      <strong>BS EN 12464-2:</strong> Lighting of outdoor work places
                    </p>
                  </div>
                  <div>
                    <p className="text-white">
                      <strong>BS EN 15193:</strong> Energy requirements for lighting - LENI
                      calculation
                    </p>
                  </div>
                  <div>
                    <p className="text-white">
                      <strong>BS 5266:</strong> Emergency lighting - design, installation, and
                      maintenance
                    </p>
                  </div>
                </div>
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mt-4">
                ...
                <p className="text-white text-sm">
                  Lighting Energy Numeric Indicator (LENI) expressed in kWh/m squared/year is the
                  standard metric for comparing lighting energy performance. Part L uses LENI values
                  in building energy calculations, with typical targets of 10-15 kWh/m squared/year
                  for well-designed office lighting.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Energy efficiency standards do not exist in isolation - they form an interconnected
                framework supporting UK regulatory requirements. Understanding how these standards
                integrate helps professionals deliver compliant, efficient solutions.
              </p>

              <div className="my-6">
                <p className="text-sm font-medium text-white mb-2 flex items-center gap-2">
                  <ClipboardCheck className="h-4 w-4 text-elec-yellow" /> UK Compliance Framework:
                </p>
                <div className="space-y-3">
                  <div className="p-4 rounded-lg bg-elec-yellow/5">
                    <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                      <Shield className="h-4 w-4" /> ESOS (Energy Savings Opportunity Scheme)
                    </p>
                  ...
                  <div className="p-4 rounded-lg bg-elec-yellow/5">
                    <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                      <Shield className="h-4 w-4" /> SECR (Streamlined Energy and Carbon Reporting)
                    </p>
                    <ul className="text-sm text-white space-y-1 ml-6">
                      <li>Applies to quoted companies and large unquoted companies</li>
                      <li>Annual disclosure of energy use and carbon emissions</li>
                      <li>
                        Requires at least one intensity ratio (e.g., kWh/m squared or kgCO2/revenue)
                      </li>
                  ...
                  <div className="p-4 rounded-lg bg-elec-yellow/5">
                    <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                      <Shield className="h-4 w-4" /> Building Regulations Part L
                    </p>
                    <ul className="text-sm text-white space-y-1 ml-6">
                  ...
                  <div className="p-4 rounded-lg bg-elec-yellow/5">
                    <p className="text-elec-yellow text-sm font-medium mb-2 flex items-center gap-2">
                      <Shield className="h-4 w-4" /> MEES (Minimum Energy Efficiency Standards)
                    </p>
                    <ul className="text-sm text-white space-y-1 ml-6">
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1 ml-4">
                  <li>
                    Check motor efficiency class matches current regulations (IE3/IE4 minimum)
                  </li>
              ...
              <div>
                ...
                <ul className="text-sm text-white space-y-1 ml-4">
                  <li>
                    <strong>Installing non-compliant motors</strong> - check IE class before
                    ordering
                  </li>
                  <li>
                    <strong>Ignoring Part L on refurbishments</strong> - triggered by substantial
                    work
                  </li>
                  <li>
                    <strong>Missing ESOS deadlines</strong> - plan audits well in advance
                  </li>
                  <li>
                    <strong>Not considering BACS efficiency</strong> - major impact on building
                    performance
                  </li>
                </ul>
              </div>
          ...
          <section className="mb-10">
            <div className="p-5 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <h3 className="text-sm font-medium text-white mb-4 flex items-center gap-2">
                <Award className="h-4 w-4 text-elec-yellow" /> Quick Reference: Key Standards
                Summary
              </h3>
              <div className="grid sm:grid-cols-2 gap-4 text-xs text-white">
                <div>
                  ...
                  <ul className="space-y-0.5">
                    <li>
                      <strong>ISO 50001:</strong> Energy Management System framework (PDCA cycle)
                    </li>
                    <li>
                      <strong>BS EN 16247-1 to 5:</strong> Energy audit requirements and methodology
                    </li>
                    <li>
                      <strong>BS EN ISO 52000:</strong> Energy performance of buildings (EPCs)
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-0.5">
                    <li>
                      <strong>BS EN 15232:</strong> BACS efficiency classes (A-D)
                    </li>
                    <li>
                      <strong>BS EN 12464:</strong> Workplace lighting requirements
                    </li>
                    <li>
                      <strong>BS EN 15193:</strong> LENI lighting energy calculation
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-0.5">
                    <li>
                      <strong>IEC 60034-30:</strong> Motor efficiency classes IE1-IE5
                    </li>
                    <li>
                      <strong>Current minimum:</strong> IE3 (0.75-75kW), IE4 (75-200kW)
                    </li>
                    <li>
                      <strong>Part L 2021:</strong> 95 lm/W minimum lighting efficacy
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-0.5">
                    <li>
                      <strong>ESOS:</strong> Large organisations - ISO 50001 or BS EN 16247 audit
                    </li>
                    <li>
                      <strong>MEES:</strong> Minimum EPC Band E for commercial lettings
                    </li>
                    <li>
                      <strong>Part L:</strong> All new builds and major refurbishments
                    </li>
                  </ul>
                </div>
              </div>
