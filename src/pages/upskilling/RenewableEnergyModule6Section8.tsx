...
export default function RenewableEnergyModule6Section8() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 8 · BS 7671:2018+A4:2026 · Part 6 + Section 722 + SCP Regulations 2021"
        title="Commissioning, EICR & customer handover"
        backTo="../renewable-energy-module-6"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The commissioning sequence that ties together Sections 6.1-6.7 into a defensible install.
          Part 6 testing + Section 722-specific tests + SCP Regulations 2021 verification + OZEV /
          EVCS documentation + customer handover + the year-5 EICR pattern.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              <strong className="text-white">2. IR test at 500 V DC</strong> — Reg 643.3 + Table 64;
              minimum 1 MΩ live-to-PE on the AC final circuit
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">7. RDC-DD self-test</strong> — Reg 722.531 + BS EN IEC
              62955 compliance; wallbox’s built-in test injects 6 mA DC; verify contactor opens
            </li>
            <li>
              <strong className="text-white">8. CP/PP signalling check</strong> — plug a test cable
              / vehicle; verify CP transitions through ±12 V → ±9 V → ±6 V; verify PP rating reading
              matches cable label
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              <strong className="text-white">Installer accreditation</strong> — installation company
              must hold OZEV accreditation; individual installers under the company’s accreditation
              umbrella
            </li>
            <li>
              <strong className="text-white">Installer obligations</strong> — install meets BS 7671
              / Section 722 + SCP Regulations 2021 + manufacturer DoC; chargepoint model approved on
              the OZEV product list
            </li>
            <li>
              <strong className="text-white">Claim process</strong> — customer applies via OZEV
              portal; installer claims via OZEV system against the customer invoice; grant deducted
              from customer’s install cost
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Install identity</strong>— wallbox manufacturer, model,
              serial number, install date, installer company + accreditation
            </li>
            <li>
            ...
            <li>
              ...
              7671 + statutory requirements (PRS Regs for landlords); manufacturer service interval
              if separate
            </li>
            <li>
        ...
        <Pullquote>
          Year-5 EICR is the install’s first big test. The cert evidence bundle from install day is
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              ...
              verify normal operation; observe CP signalling and indication lights; brief charge to
            ...
            <li>
              <strong className="text-white">OPDD self-test re-run</strong> — wallbox built-in test
              mode; verify contactor opens correctly
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">Cable / connector inspection</strong> — visible damage;
              thermal discolouration at connector ends; PP resistor still reading correctly
              (multimeter test if uncertain)
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">Document findings</strong> — cert evidence bundle entry
              for the EICR; coding (C1/C2/C3/FI) for each finding; comparison to install-day
              baseline
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          The instrument decides what the EICR can actually verify. A Type B install needs a Type
          B-capable tester — anything else is reconstruction theatre.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Type B test waveform</strong> — the instrument must
              generate a smooth-DC residual test current to exercise the Type B detection. Type AC /
              A-only testers don’t include this generator
            </li>
            <li>
              <strong className="text-white">BS EN 61557 compliance</strong> — Reg 643.1 mandates
              instrument compliance with BS EN 61557 series. Type B testers are part-3 (insulation),
              part-4 (low-resistance), part-6 (RCD) compliant
            </li>
            <li>
              <strong className="text-white">Calibration</strong> — annual calibration to
              manufacturer spec; calibration certificate kept by the inspecting electrician + serial
              number recorded in each EICR
            </li>
            <li>
              <strong className="text-white">Cost</strong> — Type B-capable instrument ~£800-£1,500
              (UK 2025-26); significantly more than Type AC / A-only instruments at ~£400-£700.
              Investment for the EV install business
            </li>
            <li>
              <strong className="text-white">EICR consequence of wrong instrument</strong> — testing
              a Type B RCD with a Type AC / A-only instrument invalidates the Reg 643.1 compliance
              of the inspection itself; the EICR may be challenged
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Schedule of Inspections</strong> — wallbox identity
              (manufacturer, model, serial); earthing-tree route per Reg 722.411.4 (b/c/d/e); RCD
              architecture per Reg 722.531; AFDD decision per Reg 722.421.1.7.201; isolation point
              identified and labelled; warning notices present (570.6.8.x equivalent); IP / IK
              ratings; mounting integrity; cable routing inspected
            </li>
            <li>
              <strong className="text-white">Schedule of Test Results — standard columns</strong> —
              circuit ID; OCPD type, rating, and BS EN reference; live conductor CSA; cpc CSA;
              R1+R2; Zs measured; IR live-live; IR live-earth; RCD trip-time at IΔn; polarity
              confirmed
            </li>
            <li>
              <strong className="text-white">Schedule of Test Results — EV extensions</strong> —
              OPDD self-test (per Reg 722.411.4(d), manufacturer-defined procedure, result); RDC-DD
              self-test (per BS EN IEC 62955, manufacturer-defined procedure, result); BS EN 61851
              functional test (manufacturer-defined initiation / draw / clean-disconnect sequence);
              CP/PP signalling verified
            </li>
            <li>
              <strong className="text-white">SCP Regulations 2021 verification</strong> — default
              off-peak schedule active; randomised delay enabled; manufacturer DoC for SCP-Regs
              compliance attached
            </li>
            <li>
              <strong className="text-white">Test instrument declaration</strong> — instrument(s)
              used (make, model, serial, calibration date) recorded on the EIC. For an EV install
              with Type B testing: instrument must be Type B-capable
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle index</strong> — EIC + Schedule of
              Inspections + Schedule of Test Results + manufacturer DoCs + photographs + customer
              handover signed
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Wallbox end-of-life candidacy</strong> — UK 2025-26
              wallbox typical service life 7-15 years. At year-10, depreciation is significant;
              capacity / functionality may be reduced. Replacement candidacy assessed
            </li>
            <li>
              <strong className="text-white">Manufacturer support</strong> — some brands consolidate
              / shut down over 10 years; cloud services for smart-charging may be deprecated;
              firmware updates may stop. Customer may be on an unsupported product
            </li>
            <li>
              <strong className="text-white">Regulatory evolution</strong> — BS 7671 amendments
              expected over 10 years (A4:2026 itself was a major change; A5 / future amendments will
              add further); SCP Regulations may have been amended; OZEV / EVCS scheme may have
              changed
            </li>
            <li>
              <strong className="text-white">Cable / connector wear</strong> — Type 2 connector
              rated 10,000 mating cycles; daily charging customer at ~3,650-7,300 cycles by year-10
              — half-life. Cable visible wear common
            </li>
            <li>
              <strong className="text-white">Replacement trigger</strong> — combination of degraded
              protective function (OPDD / RDC-DD failures), end-of-life cable, unsupported
              manufacturer software, or customer preference for current standards drives the
              replacement decision
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle evolution</strong> — year-10 EICR
              adds to the bundle; if replacement happens, new install pack starts a fresh thread
              alongside the closed legacy bundle. The history is the long-term truth
            </li>
          </ul>
        </ConceptBlock>
