...
const faqs = [
  {
    ...
    answer:
      'Fail-safe locks release (unlock) when power is removed - used on fire exits. Fail-secure locks remain engaged (locked) when power is removed - used for high-security areas like server rooms. The choice is often mandated by fire regulations.',
  },
  {
    question: 'What cable is used for access control door hardware?',
    answer:
      'Typically 4-core or 6-core alarm cable for simple locks, with additional cores for door contacts, request-to-exit buttons, and monitoring. CAT6 is increasingly used for IP-based readers. All cables must be fire-rated where required.',
  },
  {
    question: 'How does anti-passback work?',
    answer:
      "Anti-passback prevents a card from being used to enter an area if it hasn't first been used to exit. This prevents card sharing and ensures accurate occupancy counts. Hard anti-passback denies entry; soft anti-passback logs violations but allows access.",
  },
  {
    question: 'What testing is required for fire alarm integration?',
    answer:
      'Monthly fire alarm tests must verify that access-controlled fire exits release correctly. Annual full system tests should include all doors. Results must be documented in the fire safety logbook for compliance.',
  },
];
...
const BMSModule4Section3 = () => {
  useSEO({
    ...
    description:
      'Master access control integration with BMS. Learn door relay wiring, electromagnetic locks, fail-safe/fail-secure operation, fire alarm integration, and security system commissioning.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white">Security integration and door control systems in BMS</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Access Control:</strong> Card readers, door locks, BMS integration
              </li>
              <li>
                <strong>Door Relays:</strong> Interface between control and lock hardware
              </li>
              <li>
                <strong>Fail-Safe:</strong> Unlocks when power removed (fire exits)
              </li>
              <li>
                <strong>Integration:</strong> Energy saving, security, fire systems
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Maglocks, card readers, door release buttons
              </li>
              <li>
                <strong>Use:</strong> Controlled entry, energy management, audit trails
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Access control systems restrict and monitor movement through buildings. When
              integrated with BMS, they become intelligent operational tools that manage energy,
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Energy Management:</strong> Badge-in triggers lighting/HVAC (30% savings)
                </li>
                <li>
                  <strong>Security:</strong> Automated alarm and CCTV triggering
                </li>
                <li>
                  <strong>Audit Trails:</strong> Comprehensive access logging for compliance
                </li>
                <li>
                  <strong>Time Recording:</strong> Badge events double as time tracking
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Door relays interface between electronic access control and physical security. They
              receive low-voltage control signals and switch higher-power circuits that operate
              locks, strikes, and security hardware.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Electromagnetic (Maglocks):</strong> 12/24V DC, 300-500kg holding,
                  fail-safe
                </li>
                <li>
                  <strong>Electric Strikes:</strong> 12V DC, frame-mounted, configurable fail mode
                </li>
                <li>
                  <strong>Electric Mortice:</strong> 12V motor, 1000kg+, highest security
                </li>
                <li>
                  <strong>Electrified Hardware:</strong> Built into panic bars, hinges
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Access-controlled doors on fire escape routes must integrate with fire alarm systems
              to ensure automatic unlocking during emergencies. This is a legal requirement under BS
              7273-4.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Automatic Release:</strong> Fire alarm triggers door unlock
                </li>
                <li>
                  <strong>Hardwired:</strong> Fire panel outputs to access control relays
                </li>
                <li>
                  <strong>Override:</strong> Fire service key switches for emergency access
                </li>
                <li>
                  <strong>Testing:</strong> Monthly verification with documentation
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Proper wiring ensures reliable operation and safety compliance. Access control
              circuits typically use low-voltage DC power with separate control and monitoring
              conductors.
            </p>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-white mb-6">
            Case Study: Corporate HQ Integration
          </h2>
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm text-white">
                <strong>Project:</strong> Corporate headquarters integrated access control with BMS
                for comprehensive building automation. Employee badge events trigger personalised
                environment settings throughout the building.
              </p>
            </div>
        ...
        <section className="mb-10 mt-12">
          <SingleQuestionQuiz title="Test Your Knowledge" questions={bmsModule4Section3QuizData} />
        </section>
