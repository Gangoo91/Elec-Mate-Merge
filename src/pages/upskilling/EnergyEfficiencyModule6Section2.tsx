...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'The inflation rate used in the calculations',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Initial costs plus operating costs only',
  ...
  },
  {
    ...
    options: [
      'It is too complicated for most people to calculate',
      'It always underestimates the true investment value',
      'It cannot be applied to lighting projects',
  ...
  },
  {
    ...
    options: ['=PAYBACK()', '=FV(rate, nper, pmt)', '=NPV(rate, values)', '=IRR(values)'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Cannot be determined without calculating NPV',
  ...
  },
  {
    ...
    options: [
      ...
      '0% as it is public money',
      'A 10% commercial rate',
    ],
    correctAnswer: 0,
    explanation:
