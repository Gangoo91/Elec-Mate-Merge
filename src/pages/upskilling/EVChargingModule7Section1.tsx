...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'OZEV grants require installation by an OZEV approved installer using OZEV approved equipment. This ensures quality standards and protects public investment.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'WCS (Workplace Charging Scheme) is for businesses, charities, and public sector organisations. EVHS (Electric Vehicle Homecharge Scheme) is for residential properties. Both provide up to £350 per socket/charger.',
  },
  {
    question: 'Can domestic landlords apply for OZEV grants?',
    answer:
      'Yes, residential landlords can apply for grants to install chargers in rental properties, allowing tenants with EVs to charge at home. Specific eligibility criteria apply.',
  },
  {
    question: 'What happens if installation costs exceed the grant amount?',
    answer:
      'Grants cover up to 75% of costs, with a maximum of £350 per socket. The customer pays the difference between total cost and grant value. Always provide clear quotes showing grant contribution.',
  },
  {
    question: 'How long does the grant application process take?',
    answer:
      'Typical processing is 4-8 weeks from application to payment. Installation must be completed within 6 months of approval, and evidence submitted within 30 days of completion.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'A business wants to install 50 charging points under WCS. What is the maximum grant they can receive?',
    options: [
      '£17,500 (50 × £350)',
    ...
    correctAnswer: 1,
    explanation:
      'WCS limits grants to a maximum of 40 sockets per applicant. Even though 50 points are requested, only 40 qualify for grant funding: 40 × £350 = £14,000 maximum. The remaining 10 points must be fully funded by the customer.',
  },
];
...
const EVChargingModule7Section1 = () => {
  useSEO({
    ...
    description:
      'Learn about OZEV grants, workplace charging schemes, and government incentives for EV infrastructure installations.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>WCS:</strong> Up to £350/socket, max 40 sockets
              </li>
              <li>
                <strong>EVHS:</strong> Up to £350 or 75% of costs
              </li>
              <li>
                <strong>Requirement:</strong> OZEV approved installer
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Equipment:</strong> OZEV approved, min 3.6kW
              </li>
              <li>
                <strong>Smart charging:</strong> Mandatory capability
              </li>
              <li>
                <strong>Mode 3:</strong> Type 1 or Type 2 required
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              various grant schemes to accelerate EV charging infrastructure deployment across the
              UK.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              WCS provides vouchers towards the purchase and installation of EV charge points for
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              All OZEV-funded installations must meet specific technical standards to ensure quality
              and protect the public investment.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Non-approved equipment:</strong> — always check OZEV database
                </li>
                <li>
                  <strong>Missing smart capability:</strong> — mandatory for all grants
                </li>
                <li>
                  <strong>Incomplete documentation:</strong> — leads to delayed payments
                </li>
                <li>
                  <strong>Expired installer approval:</strong> — invalidates the grant
                </li>
              </ul>
            </div>
          </div>
