...
const DESCRIPTION =
  'Master low-resistance measurement techniques including lead nulling, four-terminal testing, and minimising errors.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'The 200mA test current is specified to break through thin oxide films that naturally form on metal surfaces, revealing the true resistance of the connection.',
  },
  {
    id: 'lead-nulling',
    ...
    correctIndex: 2,
    explanation:
      'Shorting leads together and nulling subtracts their inherent resistance, ensuring accurate measurements of the circuit under test.',
  },
  {
    id: 'open-circuit',
    ...
    correctIndex: 3,
    explanation:
      'OL (Over Limit) or ∞ (infinity) symbol indicates the resistance is too high to measure - meaning there is no continuous path (open circuit).',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 2,
    explanation:
      'BS 7671 specifies a minimum test current of 200mA for continuity testing to ensure oxide layers are penetrated and true resistance is measured.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Nulling subtracts the inherent resistance of the test leads from all subsequent measurements, ensuring only the circuit resistance is measured.',
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'Four-terminal measurement uses separate current and voltage sensing leads, eliminating lead and contact resistance from the measurement.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Corroded or loose connections add resistance to the circuit, causing higher than expected readings. This could indicate a potentially dangerous connection.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Test leads should be connected together (shorted) and the instrument nulled to zero to subtract their resistance from subsequent measurements.',
  },
  {
    id: 6,
    ...
    correctAnswer: 3,
    explanation:
      'OL (Over Limit) or ∞ (infinity) indicates an open circuit with no continuous path. Good connections should read in the milliohm to low ohm range.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'The 200mA current is sufficient to break through thin oxide films on connections, revealing the true resistance of the metallic path.',
  },
  {
    id: 8,
    question: 'Which affects low-resistance readings most significantly?',
    options: ['Ambient humidity', 'Barometric pressure', 'Conductor temperature', 'Time of day'],
    correctAnswer: 2,
    explanation:
      'Conductor resistance varies with temperature. Copper has a positive temperature coefficient - resistance increases with temperature.',
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      'Continuity tests measure milliohm values. A resolution of 0.01Ω (10mΩ) is typically needed to accurately assess conductor and connection quality.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'In 2-wire measurement, lead resistance is included in the reading. This is why nulling is essential - it compensates for the lead resistance.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Standard multimeters use very small currents which are insufficient to measure milliohm resistances accurately. A 200mA test current generates a measurable voltage drop even across very low resistances, following Ohm's law (V=IR).",
  },
  {
    question: 'What is lead nulling and why is it important?',
    answer:
      'Lead nulling subtracts the resistance of the test leads themselves from the measurement. Test leads typically have 0.01-0.05Ω resistance. Without nulling, this would be added to every reading, causing significant errors when measuring values under 1Ω.',
  },
  {
    question: 'How does four-terminal (Kelvin) measurement work?',
    answer:
      "Two terminals carry the test current through the resistance, while two separate terminals measure the voltage drop. Because the voltage-sensing terminals carry almost no current, lead and contact resistances don't affect the measurement.",
  },
  {
    question: 'What test current should be used for continuity testing?',
    answer:
      'BS 7671 requires a test current of no less than 200mA. This current is sufficient to break down resistive oxide layers on connections and provide accurate readings of the true metallic resistance.',
  },
  {
    question: 'How do dirty or corroded connections affect readings?',
    answer:
      'Oxidation and contamination create a resistive layer on connection surfaces. The 200mA test current helps penetrate light corrosion, but heavy contamination will cause elevated readings. Clean connection points if results seem inconsistent.',
  },
  {
    question: 'What causes fluctuating readings?',
    answer:
      'Common causes: poor probe contact, loose connections in the circuit under test, inductive effects on long cable runs, or interference from nearby equipment. Ensure firm probe pressure and re-test for consistent results.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Test Current:</strong> 200mA minimum (BS 7671)
              </li>
              <li>
                <strong>Resolution:</strong> 0.01Ω (10mΩ) typical
              </li>
              <li>
                <strong>Lead Nulling:</strong> Essential before every test
              </li>
              <li>
                <strong>Kelvin Method:</strong> Four-terminal for best accuracy
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> High readings, fluctuating values, OL display
              </li>
              <li>
                <strong>Use:</strong> Low-resistance ohmmeter, proper probes
              </li>
              <li>
                <strong>Apply:</strong> All continuity and bonding tests
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Continuity testing measures very small resistances - typically in the{' '}
              <strong>milliohm (mΩ) range</strong>. Standard multimeters cannot accurately measure
              such low values because they use insufficient test current and lack the necessary
              resolution.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-blue-500/10">
              ...
              <p className="text-sm text-white">
                A 20m length of 2.5mm² copper conductor has a theoretical resistance of about 0.15Ω.
                You need equipment that can resolve 0.01Ω to measure this accurately.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Test leads have their own resistance (typically 0.01-0.05Ω). Without nulling, this is
              added to every measurement, causing significant errors on low readings.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-elec-yellow/20 text-elec-yellow text-xs font-bold mr-2">
                    1
                  </span>
                  Connect test leads together (short circuit)
                </li>
                <li>
                  <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-elec-yellow/20 text-elec-yellow text-xs font-bold mr-2">
                    2
                  </span>
                  Press the NULL or ZERO button on instrument
                </li>
                <li>
                  <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-elec-yellow/20 text-elec-yellow text-xs font-bold mr-2">
                    3
                  </span>
                  Display should read 0.00Ω
                </li>
                <li>
                  <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-elec-yellow/20 text-elec-yellow text-xs font-bold mr-2">
                    4
                  </span>
                  All subsequent readings exclude lead resistance
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              For the most accurate low-resistance measurements, four-terminal (Kelvin) testing
              eliminates lead and contact resistance entirely.
            </p>
                ...
                <tbody className="text-white/80">
                  ...
                  <tr className="border-b border-white/5">
                    ...
                    <td className="py-2 text-amber-400">
                      Acceptable but investigate if unexpected
                    </td>
                  </tr>
                  <tr className="border-b border-white/5">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Firm Probe Pressure:</strong> Press probes firmly to ensure good contact.
                  Light contact adds resistance and causes fluctuating readings
                </li>
                <li>
                  <strong>Wait for Stability:</strong> Allow readings to stabilise before recording.
                  Initial readings may fluctuate as contact settles
                </li>
                <li>
                  <strong>Check Calibration:</strong> Verify instrument calibration periodically.
                  Use a known resistance to check accuracy
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Forgetting to null:</strong> Always null before testing sequence
                </li>
                <li>
                  <strong>Testing energised circuits:</strong> Can damage the instrument
                </li>
                <li>
                  <strong>Parallel paths:</strong> Check for alternative paths that could affect
                  readings
                </li>
                <li>
                  <strong>Ignoring battery state:</strong> Low battery affects accuracy
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>BS 7671:</strong> Regulation 612.2 - Continuity testing
                </li>
                <li>
                  <strong>GN3:</strong> Guidance Note 3 - Inspection and Testing
                </li>
                <li>
                  <strong>Table 5B:</strong> Conductor resistance values at 20 degrees C
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="mt-6 p-5 rounded-lg bg-transparent">
            <h3 className="text-sm font-medium text-white mb-4">
              Low-Resistance Testing Reference
            </h3>
