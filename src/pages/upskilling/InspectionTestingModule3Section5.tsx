    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          What the meter is doing inside, why the 200 mA test current matters, how lead nulling
          actually works, and when to trust an absolute reading versus a comparative one.
        </p>
        ...
        >
          <p>
            The regulation has two limbs. First: instruments shall be chosen in accordance with the
            relevant parts of BS EN 61557. Second: if other measuring equipment is used, it shall
            provide no lesser degree of performance and safety. The second limb is deliberately a
            high bar — it does not mean &ldquo;cheaper instruments are fine if they roughly
            work&rdquo;, it means an alternative instrument must be demonstrably as capable as a
            61557-compliant equivalent across measurement accuracy, test current, safety category,
            and protection against operator error.
          </p>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Constant-current source.</strong> An active circuit regulates the test current
              to a fixed value (typically 200 mA into 0.5 Ω, i.e. into a low-resistance load)
              regardless of small variations in conductor resistance under test.
            </li>
            <li>
            ...
            <li>
              <strong>Voltmeter.</strong> High-impedance voltmeter measures the voltage drop across
              the conductor. The high impedance means it draws negligible current, so the full
              constant-current goes through the conductor under test.
            </li>
            <li>
              <strong>Computed display.</strong> R = V / I_test. The instrument knows I_test because
              it is regulating it, and measures V, so R falls out automatically.
            </li>
            <li>
              <strong>Lead-resistance null block.</strong> Software or analogue circuit that stores
              a measured lead resistance and subtracts it from subsequent readings — the
              &ldquo;zero&rdquo; or &ldquo;null&rdquo; function.
            </li>
          </ol>
          <p>
            The four-terminal (Kelvin) sensing on premium instruments deserves a note. In a standard
            two-terminal measurement, the lead resistance is part of the measurement path and must
            be nulled out. In a four-terminal arrangement, two leads carry the test current and two
            separate leads sense the voltage drop directly across the conductor under test — the
            voltage-sensing leads carry essentially no current and their resistance is irrelevant.
            UK installation testers are mostly two-terminal with a null function; bench instruments
            and dedicated micro-ohmmeters are four-terminal.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="400" y="349" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
        ...
        >
          <p>
            The earlier editions of BS EN 61557-4 stated the test current minimum explicitly: 200 mA
            when measuring a 0.5 Ω load, with an open-circuit voltage between 4 V and 24 V (DC or
            AC). The later editions phrase it more functionally — &ldquo;capable of low-resistance
            measurement&rdquo; — but the 200 mA figure remains the de facto benchmark on UK MFT spec
            sheets, and any instrument that does not push at least 200 mA at low impedance is
            unlikely to satisfy the &ldquo;no lesser degree of performance&rdquo; clause in Reg
            643.1.
          </p>
          <p>
            ...
            down to 200 mA by the constant-current source — fine; 1 V / 0.5 Ω = 2 A, still adequate;
            0.5 V / 0.5 Ω = 1 A, marginal). Above 24 V the open-circuit voltage becomes a
            touch-voltage hazard in wet/damp conditions, which is why Reg 643.11 singles out tests
            above 25 V AC / 60 V DC for special care.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Press the &ldquo;NULL&rdquo; or &ldquo;ZERO&rdquo; button. The display reads the lead
              resistance momentarily, then changes to 0.00 Ω. The lead resistance is now stored.
            </li>
            <li>
              Verify by separating the leads — display reads &ldquo;OL&rdquo; (open loop). Re-touch
              — display reads 0.00 Ω. Null is confirmed.
            </li>
            <li>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              end-of-lead alligator clips oxidise. The null was correct when set but the actual lead
              resistance has drifted upward through the day. Re-null at the start of every test
              session, not just at job start.
            </li>
            <li>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Write &ldquo;LEADS = 0.18 Ω&rdquo; on a piece of tape stuck to the meter, or directly
              on the meter housing in marker.
            </li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              path. For a clean, well-made joint this is microohms (≪ 0.001 Ω); for a degraded joint
              it can be milliohms to ohms.
            </li>
            <li>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              expected R_bulk from GN3 Table BI. You measure. You compare. If your reading is within
              ±10 % of calculated, the conductor is electrically fine. This is the standard method
              for new work where you have the design data.
            </li>
            <li>
              <strong>Comparative method.</strong> You do not know the exact length, or the cable
              history is uncertain. You measure two paths that should be similar (e.g. r1 vs rn on a
              ring final, or two CPCs in parallel, or two identical sub-circuits) and look for a
          ...
          <p>
            The comparative method is the implicit logic behind the ring final continuity test. You
            measure r1, r2 and rn end-to-end. r1 should equal rn (both line conductors) and r2
            should be 1.67× the line value (1.5 mm² CPC vs 2.5 mm² line). If r1 ≠ rn by more than a
            small tolerance, one leg of the ring is broken or has a high-resistance joint. The
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Annual UKAS calibration.</strong> The certificate is the audit trail. Keep it
              filed by serial number and accessible if a measurement is challenged.
            </li>
            <li>
              <strong>Field check.</strong> A 1.0 Ω calibration resistor (a small precision resistor
              with a known value to ±0.5 %) tells you in seconds whether the instrument is reading
              near-nominal. Carry one in the test kit.
            </li>
            <li>
