...
// Quiz Questions for Quiz component
const quizQuestions = [
  {
      ...
      <div className="bg-[#1a1a1a]/95 border-b border-gray-800">
        <div className="max-w-3xl mx-auto px-4 py-6">
          <div className="flex items-center gap-3 mb-2">
            <LayoutDashboard className="w-8 h-8 text-elec-yellow" />
            <span className="text-elec-yellow text-sm font-medium">Module 5 - Section 2</span>
          </div>
          <h1 className="text-2xl md:text-3xl font-bold text-white mb-2">
            Energy Dashboards and Cloud Portals
          </h1>
          <p className="text-gray-400">
            Master the design, deployment, and management of energy monitoring platforms
          </p>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-8">
        ...
        <section className="bg-[#242424] rounded-xl p-6 border border-gray-800">
          <div className="flex items-center gap-3 mb-4">
            <div className="bg-elec-yellow/20 p-2 rounded-lg">
              <LayoutDashboard className="w-6 h-6 text-elec-yellow" />
            </div>
            <h2 className="text-xl font-semibold text-white">1. Dashboard Design Principles for Energy Management</h2>
          </div>
            ...
            <div className="bg-[#1a1a1a] rounded-lg p-4">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span><strong>Primary Zone:</strong> Key KPIs and alerts at top or centre - users should see critical information within 3 seconds</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow mt-1">•</span>
                  <span><strong>Secondary Zone:</strong> Trend charts and comparisons - supporting context for primary metrics</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow mt-1">•</span>
                  <span><strong>Tertiary Zone:</strong> Detailed data tables and drill-down options - for investigation and analysis</span>
                </li>
              </ul>
            </div>
        ...
        <section className="bg-[#242424] rounded-xl p-6 border border-gray-800">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-semibold text-white">2. Key Performance Indicators (KPIs) to Display</h2>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-gray-800">
                  <tr>
                    <td className="py-3 px-4">Total Consumption</td>
                    <td className="py-3 px-4">kWh</td>
                    <td className="py-3 px-4">All users</td>
                    <td className="py-3 px-4">15-30 seconds</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4">Peak Demand</td>
                    <td className="py-3 px-4">kW</td>
                    <td className="py-3 px-4">Energy Manager</td>
                    <td className="py-3 px-4">Real-time</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4">Energy Use Intensity (EUI)</td>
                    <td className="py-3 px-4">kWh/m²</td>
                    <td className="py-3 px-4">Executives, FM</td>
                    <td className="py-3 px-4">Daily</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4">Cost to Date</td>
                    <td className="py-3 px-4">£</td>
                    <td className="py-3 px-4">Finance, Executives</td>
                    <td className="py-3 px-4">Daily</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4">Carbon Emissions</td>
                    <td className="py-3 px-4">kgCO₂e</td>
                    <td className="py-3 px-4">Sustainability Team</td>
                    <td className="py-3 px-4">Daily</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4">Power Factor</td>
                    <td className="py-3 px-4">ratio (0-1)</td>
                    <td className="py-3 px-4">Technical Staff</td>
                    <td className="py-3 px-4">15 minutes</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4">Baseload</td>
                    <td className="py-3 px-4">kW</td>
                    <td className="py-3 px-4">Energy Manager</td>
                    <td className="py-3 px-4">Daily (overnight min)</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="bg-[#1a1a1a] rounded-lg p-4">
              ...
              <div className="grid md:grid-cols-2 gap-3">
                <div className="bg-[#242424] rounded p-3">
                  ...
                  <p className="text-sm mt-1">Show percentage variance from budget or reduction target</p>
                </div>
                <div className="bg-[#242424] rounded p-3">
                  <span className="text-elec-yellow font-medium">Same Period Last Year</span>
                  <p className="text-sm mt-1">Year-on-year comparison accounting for seasonality</p>
                </div>
                <div className="bg-[#242424] rounded p-3">
                  <span className="text-elec-yellow font-medium">Degree Day Normalisation</span>
                  <p className="text-sm mt-1">Weather-adjusted consumption for fair comparison</p>
                </div>
                <div className="bg-[#242424] rounded p-3">
                  <span className="text-elec-yellow font-medium">Benchmark Comparison</span>
                  <p className="text-sm mt-1">Industry or portfolio averages for context</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-[#242424] rounded-xl p-6 border border-gray-800">
          <div className="flex items-center gap-3 mb-4">
            <div className="bg-elec-yellow/20 p-2 rounded-lg">
              <Cloud className="w-6 h-6 text-elec-yellow" />
            </div>
            <h2 className="text-xl font-semibold text-white">3. Cloud vs On-Premise Platform Considerations</h2>
          </div>
          ...
          <div className="space-y-4 text-gray-300">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-[#1a1a1a] rounded-lg p-4 border border-blue-800/50">
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4 border border-orange-800/50">
                <div className="flex items-center gap-2 mb-3">
            ...
            <div className="bg-[#1a1a1a] rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span><strong>Data Protection:</strong> Ensure cloud providers comply with UK GDPR. Check if data centres are UK/EU-based.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span><strong>Integration Needs:</strong> On-premise may be required for tight integration with legacy BMS systems.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span><strong>Multi-Site Operations:</strong> Cloud platforms excel for portfolio management across multiple locations.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-elec-yellow">•</span>
                  <span><strong>Budget Structure:</strong> Cloud suits OpEx budgets; on-premise suits CapEx availability.</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="bg-[#242424] rounded-xl p-6 border border-gray-800">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-semibold text-white">4. Data Visualisation Best Practices</h2>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-[#1a1a1a] rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-medium">Line/Area Charts</h4>
                </div>
                <p className="text-sm mb-2">Best for showing trends over time</p>
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4">
                ...
                <p className="text-sm mb-2">Best for comparing categories</p>
                <ul className="text-xs text-gray-400 space-y-1">
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-medium">Gauges/Dials</h4>
                </div>
                <p className="text-sm mb-2">Best for current status vs limits</p>
                <ul className="text-xs text-gray-400 space-y-1">
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-medium">Pie/Donut Charts</h4>
                </div>
                <p className="text-sm mb-2">Limited use - part-to-whole only</p>
                <ul className="text-xs text-gray-400 space-y-1">
            ...
            <div className="bg-amber-900/20 border border-amber-800 rounded-lg p-4">
              ...
              <div className="grid md:grid-cols-3 gap-3 text-sm">
                <div>
                  ...
                  <p className="text-xs text-gray-400">On target, normal operation, good performance</p>
                </div>
                <div>
                  <span className="text-amber-400 font-medium">Amber/Yellow</span>
                  <p className="text-xs text-gray-400">Warning, approaching limits, attention needed</p>
                </div>
                <div>
                  <span className="text-red-400 font-medium">Red</span>
                  <p className="text-xs text-gray-400">Alert, exceeded threshold, immediate action</p>
                </div>
              </div>
            ...
            <div className="bg-[#1a1a1a] rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between items-center py-2 border-b border-gray-800">
                  <span>Real-time monitoring displays</span>
                  <span className="text-elec-yellow">15-30 seconds</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-800">
                  <span>Process/production monitoring</span>
                  <span className="text-elec-yellow">5-15 seconds</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-800">
                  <span>Trend analysis dashboards</span>
                  <span className="text-elec-yellow">5-15 minutes</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-800">
                  <span>Management summary dashboards</span>
        ...
        <section className="bg-[#242424] rounded-xl p-6 border border-gray-800">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-semibold text-white">5. User Roles and Access Management</h2>
          </div>
          ...
          <div className="space-y-4 text-gray-300">
            ...
            <div className="space-y-3">
              <div className="bg-[#1a1a1a] rounded-lg p-4 border-l-4 border-gray-500">
                ...
                <p className="text-sm text-gray-400 mb-2">Read-only access to assigned dashboards and reports</p>
                <ul className="text-xs text-gray-500 grid grid-cols-2 gap-1">
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4 border-l-4 border-blue-500">
                ...
                <p className="text-sm text-gray-400 mb-2">Day-to-day monitoring and alarm response</p>
                <ul className="text-xs text-gray-500 grid grid-cols-2 gap-1">
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4 border-l-4 border-elec-yellow">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-medium">Energy Manager</h4>
                </div>
                <p className="text-sm text-gray-400 mb-2">System configuration and analysis</p>
                <ul className="text-xs text-gray-500 grid grid-cols-2 gap-1">
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4 border-l-4 border-red-500">
                ...
                <p className="text-sm text-gray-400 mb-2">Full system access and user management</p>
                <ul className="text-xs text-gray-500 grid grid-cols-2 gap-1">
        ...
        <section className="bg-[#242424] rounded-xl p-6 border border-gray-800">
          <div className="flex items-center gap-3 mb-4">
            <div className="bg-elec-yellow/20 p-2 rounded-lg">
              <Globe className="w-6 h-6 text-elec-yellow" />
            </div>
            <h2 className="text-xl font-semibold text-white">6. Popular UK Energy Management Platforms</h2>
          </div>
          ...
          <div className="space-y-4 text-gray-300">
            ...
            <div className="space-y-4">
              {/* Energy Elephant */}
              <div className="bg-[#1a1a1a] rounded-lg p-4 border border-green-800/50">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">Cloud-based portfolio management</p>
                  </div>
                </div>
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4 border border-blue-800/50">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">AMR and sub-metering specialists</p>
                  </div>
                </div>
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
              ...
              <div className="bg-[#1a1a1a] rounded-lg p-4 border border-orange-800/50">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">Bureau services and managed energy</p>
                  </div>
                </div>
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
            ...
            <div className="bg-[#1a1a1a] rounded-lg p-4">
              ...
              <div className="grid md:grid-cols-2 gap-3 text-sm">
                <div>
                  <span className="font-medium">Systemslink</span>
                  <p className="text-xs text-gray-400">Bureau services and utility management</p>
                </div>
                <div>
                  <span className="font-medium">Inspired Energy</span>
                  <p className="text-xs text-gray-400">Procurement and optimisation services</p>
                </div>
                <div>
                  <span className="font-medium">GridDuck</span>
                  <p className="text-xs text-gray-400">IoT-focused monitoring for SMEs</p>
                </div>
                <div>
                  <span className="font-medium">Schneider EcoStruxure</span>
                  <p className="text-xs text-gray-400">Enterprise BMS integration</p>
                </div>
              </div>
            </div>
        ...
        <section className="bg-gradient-to-br from-elec-yellow/20 to-elec-yellow/5 rounded-xl p-6 border border-elec-yellow/30">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <ul className="text-sm text-gray-300 space-y-1">
                <li>• <span className="text-green-400">Energy Elephant:</span> Portfolio & sustainability</li>
                <li>• <span className="text-blue-400">ECON:</span> AMR & sub-metering</li>
                <li>• <span className="text-orange-400">Stark:</span> Bureau & procurement</li>
              </ul>
            </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4 pt-6">
          <Button
            onClick={() => navigate('/upskilling/energy-efficiency/module-5/section-1')}
            variant="outline"
            className="flex items-center gap-2 min-h-[44px] touch-manipulation active:scale-[0.98] border-gray-600 text-white hover:bg-gray-800"
          >
            <ChevronLeft className="w-5 h-5" />
            <span>Previous: Section 1 - Data Collection Systems</span>
          </Button>
          ...
          >
            <span>Next: Section 3 - Automated Reporting</span>
