import { ArrowLeft, Wrench, Tag, TestTube, Settings, FileCheck, Users } from 'lucide-react';
        ...
        <div className="space-y-6">
          <div>
            <h1 className="text-4xl font-bold text-white mb-4">
              Module 5: Installation and Commissioning Procedures
            </h1>
            <p className="text-xl text-gray-400 mb-6">
              Installation practices and commissioning requirements
            </p>
