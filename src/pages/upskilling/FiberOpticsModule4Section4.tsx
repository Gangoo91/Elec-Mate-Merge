...
const quizQuestions = [
  {
    ...
    options: [
      'It needs no equipment to install',
      'It is the fastest method to install',
      'Lowest possible loss - fusion spliced to a factory pigtail',
      'It requires no testing afterwards',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Applied pressure alone',
      'A chemical activator spray',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To remove epoxy from the connector body',
      'To create a smooth, scratch-free end face for low loss',
      'To clean the outside of the ferrule',
      'To adjust the overall connector length',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A flat polish only',
      'The same polish as UPC connectors',
      'A special angled polishing process',
      'No polishing is needed for APC',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Any reasonably smooth surface',
      'A clearly visible fibre core',
      'A clean, scratch-free, properly polished surface',
  ...
  },
  {
    ...
    options: [
      'They always give better performance',
      'Faster installation with no polishing equipment needed',
      'They have a lower cost per connector',
      'They work on any fibre type without selection',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'An external protective cap',
      'A built-in cleaning tool',
      'A strain-relief boot',
      'A factory-terminated fibre inside the connector the field fibre joins to',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Coiled loosely while maintaining the minimum bend radius',
      'Cut off close to the connector body',
      'Left extended in a straight line',
      'Taped tightly against the cable',
    ],
    correctAnswer: 0,
    explanation:
      'Excess fibre should be coiled loosely while maintaining the minimum bend radius to avoid signal loss from excessive bending.',
  },
  {
    id: 10,
    ...
    options: [
      ...
      'The connector brand only',
      'Insertion loss, return loss and visual inspection results',
      'None, as connectors are standardised',
    ],
    correctAnswer: 2,
    explanation:
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-4xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white">Field-installable connector methods and best practices</p>
        </header>
