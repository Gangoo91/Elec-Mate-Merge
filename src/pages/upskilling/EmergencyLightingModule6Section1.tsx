...
const quizQuestions = [
  ...
  {
    id: 8,
    question: 'BS 5266-1:2025 explicit position on "borrowed light" from adjacent compartments?',
    options: [
...
const EmergencyLightingModule6Section1 = () => {
  ...
  useSEO({
    title: 'Key clauses BS 5266-1:2025 / EN 1838:2024 | Emergency Lighting Module 6.1 | Elec-Mate',
    description:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The 2024 / 2025 standards cycle has reshaped emergency lighting. BS 5266-1:2025 (effective
          31 Oct 2025), BS EN 1838:2024 (effective Dec 2024) and BS EN 50172:2024 (effective Jul
          2024) sit on every duty holder's compliance shelf. This section walks each, clause by
          clause, with the changes that matter on site.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>§2 Normative references.</strong> Cross-references to BS EN 1838, BS EN 50172,
              BS EN 60598-2-22 (luminaire performance), BS EN 50171 (central battery systems), and
              BS 7671 §560 (safety services wiring). The references are normative — compliance with
              BS 5266-1 requires compliance with the referenced documents in the relevant respects.
            </li>
            <li>
              <strong>§3 Terms and definitions.</strong> Updated terminology — "local area lighting"
              is a new defined term, "borrowed light" is now defined as a non-compliant arrangement,
              and "photometric verification" is introduced as a new defined check.
            </li>
            <li>
            ...
            <li>
              ...
              identifies escape routes, high-risk areas, sleeping risk, disabled occupant provision,
              and place of ultimate safety. The emergency lighting then provides for each. Section 3
              of this module deals with this in depth.
            </li>
            <li>
              <strong>§6 Design.</strong> Photometric calculation, luminaire selection, location
              rules, switch-on response, duration, redundancy. The 2025 high-risk circuit rule (≥ 2
              circuits, ≤ 20 luminaires per fault) sits here.
            </li>
            <li>
              <strong>§7 Wiring and circuits.</strong> Cross-references BS 7671 §560. Cable survival
              in fire, segregation, terminations, supports. The wiring side of the installation.
            </li>
            <li>
            ...
            <li>
              ...
              duration test, certification (the acceptance certificate). The handover document set.
            </li>
            <li>
          ...
          <p>
            The 2025 revision is a substantial rewrite, not a minor update. Designers using the 2016
            edition produce work that may not satisfy the 2025 obligations. The Fire and Rescue
            Service audit (Module 6 §4) tests against the current edition.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              and local area lighting for high-risk task areas. The recommendations do not apply to
              "borrowed light" arrangements relying on luminaires in adjacent compartments; each
              escape route shall be provided with its own emergency luminaires.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              operators must safely shut down dangerous processes if normal lighting fails. 15 lx OR
              10% of normal task illuminance, whichever higher (BS EN 1838:2024 §4.4). Switch-on 0.5
              s to 100%. Duration as long as the process needs for safe shutdown.
            </li>
            <li>
              <strong>Standby lighting.</strong> Illumination that allows normal activity to
              continue when normal lighting fails. Common in hospitals (operating theatres), control
              rooms, security-sensitive areas. Illuminance per the activity (often equal to normal
              lighting). Duration per the activity. Standby lighting is NOT escape lighting; it
              serves a different purpose and is sized differently.
            </li>
            <li>
              <strong>Local area (high-risk) lighting (NEW 2024 / 2025).</strong> A subset of
              high-risk task lighting for specific machine or workstation locations where the wider
              area lighting is sufficient for escape but the local task requires more. The 2024 EN
              1838 introduced this; BS 5266-1:2025 codifies the design approach.
            </li>
          </ul>
          <p>
            ...
            route only (1 lx along a defined path) but actually serving as anti-panic (0.5 lx across
            an open area) may pass the escape-route full-width check yet fail the open-area check.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Escape route — 1 lx, full width with edge exclusions.</strong> §4.2. Minimum 1
              lx horizontally on the floor across the full width of the route, with the outer 0.5 m
              on each side excluded for routes wider than 2 m and the outer ¼ width on each side
              excluded for routes 2 m or narrower. The 2024 update replaces the 2013 centre-line +
              central-band wording with this full-width rule. Designers measure or calculate at
              floor level across the non-excluded cross-section. A single dark patch within the
              non-excluded width — a column shadow, an unlit corner — fails the requirement.
            </li>
            <li>
              <strong>Anti-panic — 0.5 lx, 40:1 max:min.</strong> §4.3. Minimum 0.5 lx horizontally
              across the open area. Maximum-to-minimum ratio not exceeding 40:1. The uniformity
              ratio prevents glare and dark patches that disorientate occupants in large undefined
              spaces. A foyer with one bright luminaire over the desk and dim corners can pass the
              0.5 lx minimum and still fail the 40:1 uniformity.
            </li>
            <li>
              <strong>
                High-risk task — 15 lx OR 10% of normal task illuminance, whichever higher.
              </strong>{' '}
              §4.4. Higher of the two values. Maximum-to-minimum ratio not exceeding 10:1. Examples:
              a workshop with 200 lx normal task lighting needs 20 lx high-risk emergency (10%
              wins); a workshop with 100 lx normal needs 15 lx (the floor wins). Process safety
              analysis identifies which task locations qualify.
            </li>
            <li>
              <strong>Vertical illuminance at fire equipment — 5 lx.</strong> §4.5. Fire
              extinguishers, fire alarm call-points, emergency stop buttons, refuge call-points must
              be illuminated to 5 lx vertically on the equipment face. The vertical requirement
              ensures the equipment is identifiable and operable, not just locatable in plan.
            </li>
          </ul>
          <p>
            ...
            maintenance factor for surface ageing). A new installation should comfortably exceed the
            targets; the 5-year photometric verification confirms it still does.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              maximum to minimum ratio along the route within the non-excluded width shall not
              exceed 40:1.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              reach 50% of their declared emergency illuminance within 5 seconds, and 100% within 60
              seconds. The two-stage profile reflects battery and inverter response — instant full
              output is rarely achievable; partial output is achievable quickly.
            </li>
            <li>
            ...
            <li>
              <strong>High-risk task lighting — 0.5 s to 100%.</strong> Full illuminance within half
              a second. Achieved by uninterruptible architectures — central battery on an always-on
              inverter, or self-contained luminaires with capacitor-supported switching. The
              half-second figure is calibrated to the time it takes a typical operator to react and
              reach an emergency stop.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              battery (one battery serving many luminaires) gives easier maintenance and longer life
              but needs fire-survival cabling. Self-contained (battery in each luminaire) gives
              circuit independence but needs more frequent battery replacement. Hybrid combines the
              two for different parts of the same building.
            </li>
            <li>
              <strong>Test facility.</strong> Every system must include a means to test operation
              without disconnecting the supply at the consumer unit. Self-contained luminaires
              achieve this with a key switch or remote test panel; central battery systems achieve
              this with the system controller.
            </li>
            <li>
              <strong>Test cycles.</strong> Monthly functional test (luminaires light when supply
              removed); annual full-duration test (luminaires sustain rated duration — typically 3
              h). 2024 reaffirms the cycles and tightens the recording obligation.
            </li>
            <li>
              <strong>Monitoring.</strong> Self-contained luminaires must have a visible status
              indicator (charging LED). Larger installations should consider automated test systems
              (ATS) that record functional and duration tests and flag faults automatically.
            </li>
            <li>
              <strong>Fault indication.</strong> Faults must be visible to operating staff. Common
              faults: battery failure, lamp failure, charger failure. Each requires distinct
              indication.
            </li>
            <li>
              <strong>Cabling.</strong> Cross-references BS 7671 §560. Cable survival in fire (PH 30
              / PH 60 / PH 90 — minutes of survival at 842 °C). Segregation from other circuits.
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              month, with each luminaire energised by simulating a failure of the normal supply and
              verified to operate. The test shall be of sufficient duration to verify operation
              without significantly discharging the battery. At intervals not exceeding 12 months,
              the system shall be subjected to a full-duration test verifying that each luminaire
              operates for its rated duration. The results shall be recorded.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="80" y="534" fill="rgba(255,255,255,0.85)" fontSize="10">
              • Documentation/handover clarified — acceptance certificate now mandatory at
              commissioning
            </text>
            <text x="80" y="552" fill="rgba(255,255,255,0.85)" fontSize="10">
              • EN 1838:2024 escape route now FULL WIDTH with edge exclusions (was centre line + 2 m
              central band)
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              Alternatively, a re-run of the original photometric calculation with current surface
              reflectances and current luminaire output (manufacturer data plus measured
            ...
            <li>
              ...
              figure. Margin: design figures are minima at end of life, so a new installation should
              comfortably exceed; a 5-year verification should still be at or above design.
            </li>
            <li>
              ...
              supplementary luminaires; redecorate (lighter surfaces increase reflected light). The
              remediation must restore compliance and be documented.
            </li>
            <li>
          ...
          <p>
            ...
            ambient temperature. A new installation comfortably above 1 lx may, after 5 years, have
            dropped below 1 lx in places. The verification catches this before the auditor does.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Identify high-risk areas.</strong> The fire risk assessment identifies spaces
              where operators must safely shut down dangerous machinery if normal lighting fails.
              Examples: presses, mixers, robot cells, chemical handling areas, hot work stations.
            </li>
            <li>
              ...
              such that loss of either circuit leaves the area still illuminated to a useful level.
            </li>
            <li>
              <strong>Cap at 20 luminaires per fault.</strong> No single circuit fault may
              extinguish more than 20 luminaires. In small high-risk areas, this is easily met (a
              single circuit may have 5 luminaires). In larger high-risk areas, the 20 cap forces
              additional circuit splits.
            </li>
            <li>
              <strong>Self-contained alternative.</strong> Self-contained luminaires
              (battery-in-luminaire) achieve the redundancy at the luminaire level — each luminaire
              is its own micro-circuit. The 2-circuit rule applies primarily to central battery and
              centrally-supplied installations.
            </li>
            <li>
          ...
          <p>
            The rule is targeted — it applies to high-risk areas only, not to general escape route
            lighting. A corridor with a single emergency lighting circuit serving its luminaires
            remains compliant under the 2025 edition. The design team must identify where the
            high-risk rule applies and design accordingly.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              For high-risk task area lighting, the supply arrangement shall provide redundancy such
              that the failure of any single circuit does not extinguish all the emergency
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Fire doors close.</strong> Most building fire doors are held open by magnetic
              releases that drop the door closed on fire alarm. The instant the alarm sounds,
              borrowed light from the adjacent room is cut off. The escape route relying on it goes
              dark.
            </li>
            <li>
              <strong>Smoke layer.</strong> Smoke ingress reduces transmitted light through doors
              and openings. Even a partially open door admits less light through smoke than through
              clear air.
            </li>
            <li>
              <strong>Compartment failure.</strong> If the adjacent compartment is the source of the
              fire, its lighting may be lost (luminaires damaged, circuits compromised). The escape
              route loses its light at the worst moment.
            </li>
            <li>
              <strong>Post-Grenfell evidence.</strong> Investigations after major fires have
              consistently shown that compartments cannot be relied on as light sources for adjacent
              compartments. The lighting must be inside the compartment that needs it.
            </li>
            <li>
              <strong>Practical impact.</strong> Existing installations relying on borrowed light
              must be remediated. The 5-year photometric verification will catch them — without the
              adjacent light, the route fails the 1 lx full-width check. Remediation is
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Segregation.</strong> Safety service cables must be segregated from non-safety
              circuits. Segregation by separate containment, separate cable routes, or use of cables
              with intrinsic mineral insulation (MI cable). The principle: a fault or fire on a
              non-safety circuit must not compromise the safety service.
            </li>
            <li>
            ...
            <li>
              ...
              interaction with TN-C-S (PNB) earthing, and updates the worked examples for emergency
              lighting and fire alarm circuits.
            </li>
          </ul>
          <p>
            ...
            commissioning must confirm BS 7671 §560 compliance alongside the BS 5266-1 photometric
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Early activation.</strong> Some installations switch emergency lighting to its
              emergency state on fire alarm activation, ahead of any mains failure. This ensures
              full emergency illumination at the moment of evacuation, not 60 s later when the fire
              damages mains.
            </li>
            <li>
            ...
            <li>
              ...
              shutdown (e.g. machinery stops on fire alarm), the high-risk emergency lighting must
              be active to allow operators to verify safe shutdown.
            </li>
            <li>
              <strong>Common power supply considerations.</strong> Fire alarm and emergency lighting
              are separate systems but may share power infrastructure (UPS, central battery). The
              cause-and-effect document records the interactions.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>RRO 2005 Article 14 — escape routes adequately illuminated.</strong> The duty
              is to provide adequate emergency lighting. BS 5266-1 defines what 'adequate' means. A
              duty holder asserting compliance with Article 14 is implicitly asserting compliance
              with BS 5266-1 unless they can evidence an equivalent alternative.
            </li>
            <li>
              <strong>Court tests of reasonable practice.</strong> Where a fire causes harm and the
              matter goes to court, the question is: did the duty holder act as a reasonable
              competent person would? The court tests this against published codes of practice. BS
              5266-1 is the published code for emergency lighting; departures invite the question
              'why'.
            </li>
            <li>
              <strong>FRS audit benchmarks.</strong> The Fire and Rescue Service auditor checks
              installations against current BS 5266-1. Non-compliances are recorded; enforcement
              action escalates from informal advice through enforcement notices to prohibition
              notices and prosecution.
            </li>
            <li>
              <strong>Insurer expectations.</strong> Commercial insurance policies typically require
              BS 5266-1 compliance. Non-compliance is a defence to claims and a basis for premium
              loadings or refusal of cover.
            </li>
            <li>
              <strong>Justified departures.</strong> A departure must be evidence-based. Examples of
              justifiable departure: a heritage building where the architectural form prevents
              standard luminaire placement, with risk assessment showing equivalent safety via
              alternative means. Examples of unjustifiable departure: 'we did it that way last
              time'. The risk assessment is the test.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              This British Standard takes the form of guidance and recommendations. It should not be
              quoted as if it were a specification, and particular care should be taken to ensure
              that claims of compliance are not misleading. Compliance with a British Standard
              cannot confer immunity from legal obligations. The recommendations have been prepared
              on the assumption that they are applied by competent persons.
            </>
          }
        ...
        <FAQ
          items={[
            {
              question:
                'When did BS 5266-1:2025 come into force, and what does that mean for existing installations?',
              answer:
            ...
            {
              question:
                'Why does BS EN 1838:2024 require 1 lx across the FULL WIDTH of an escape route (with edge exclusions), not just the centre line?',
              answer:
            ...
            {
              question:
                'Is the 5-year photometric verification really necessary if the annual tests pass?',
              answer:
            ...
            {
              question:
                'How does the new "local area lighting" category differ from "high-risk task" lighting?',
              answer:
        ...
        <Quiz title="Key clauses BS 5266-1 / EN 1838 — Module 6.1" questions={quizQuestions} />
