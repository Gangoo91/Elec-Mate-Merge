    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The record is what discharges the EAWR and HSAW duty. Minimum data set under HSG107, why
          numerical readings matter, retention under the Limitation Act 1980, and GDPR for asset
          registers.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Asset identification</strong> — the unique asset ID linking the record to the
              physical item.
            </li>
            <li>
            ...
            <li>
              ...
              readings to a calibrated instrument. A reading from an out-of-calibration meter is not
              evidence.
            </li>
            <li>
              <strong>Numerical test results</strong> — earth continuity in ohms, insulation
              resistance in megohms, leakage current in milliamps, polarity, and any specific tests
              carried out (e.g. functional check, flex check). For visual-only inspections, the
          ...
          <p>
            The numerical readings are not optional. A &ldquo;pass&rdquo; with no readings cannot be
            reconstructed: a future investigator has no way to know whether the item was borderline,
            whether the tester actually carried out the tests, or whether the instrument was even
            working. Numerical readings are the audit trail.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              the equipment identification, type and condition, the date of any inspection or test,
              the name of the person carrying out the inspection or test, and the results.
            </>
          }
        ...
        >
          <p>
            ...
            practicable&rdquo; is the load-bearing one — it requires the duty holder to weigh up the
            risk and the cost/effort of mitigation, and to act where the risk-cost balance favours
            action.
          </p>
          <p>
            ...
            maintenance unless there is some other compelling evidence (which there rarely is). This
            is why HSG107 — published by HSE itself — frames record-keeping as the practical way the
            EAWR duty is discharged.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            is reasonably practicable&rdquo; phrase is interpreted by reference to the evidence the
            duty holder can produce. The case law tradition (going back to{' '}
            <em>Edwards v National Coal Board</em>) treats the duty as discharged when the cost and
            effort of further measures would be grossly disproportionate to the risk averted. That
            is a question of evidence: what did the employer actually do, when, with what care.
          </p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              maintenance is being carried out, but more importantly to provide an audit trail that
              the work has been done. Records can also be useful in formulating the appropriate
              frequency for re-inspection or retesting.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Latent damage (Section 14A):</strong> the date-of-knowledge extension applies,
              with a long-stop of 15 years.
            </li>
          </ul>
          <p>
            ...
            civil-claim windows and aligns with the broader retention periods used by insurers. For
            some sectors (healthcare, education involving children, regulated industries) longer
            retention is required — healthcare records, for example, can require retention until the
            patient reaches a specific age. Check sector-specific guidance.
          </p>
          <p>
            Equipment that has been involved in an HSE-relevant incident gets longer retention. The
            records of the incident, the prior testing, the post-incident testing and any corrective
            action are the evidential file for any subsequent prosecution or claim, and should be
            retained until the matter is fully concluded plus the relevant limitation period. This
            can mean 10+ years.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              years from the date on which the cause of action accrued. (Section 5) An action
        ...
        >
          ...
          <p>
            ...
            that the printers, kettles and fan heaters in the building have been tested. A PAT round
            is not evidence that the cooker circuit has been verified. The two documents live
            alongside each other and are produced by separate processes.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            UK GDPR and the Data Protection Act 2018 apply when personal data is processed. Personal
            data is any information relating to an identified or identifiable natural person. PAT
            records cross into personal data territory in several common ways:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Assignee data:</strong> the asset register includes &ldquo;assigned to&rdquo;
              columns with named employees. The register now combines employee data with equipment
              data — the employee is identifiable.
            </li>
            <li>
              <strong>Home addresses:</strong> for homeworkers, the &ldquo;location&rdquo; field is
              the employee&rsquo;s home address. Home addresses are personal data and are considered
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              legal obligation under EAWR — or Article 6(1)(f) — legitimate interests for workplace
              safety).
            </li>
            <li>
            ...
            <li>
              Apply <strong>access controls</strong>. The register should not be openly accessible;
              access is restricted to people who need it for the safety-management purpose.
            </li>
            <li>
              Handle <strong>subject access requests</strong>. If an employee asks what data relates
              to them in the register, that has to be supplied within the standard 1 month.
            </li>
            <li>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>An asset register with status flags.</strong> Active / disposed / under repair
              / quarantined. Disposed rows retained for the limitation period; not deleted.
            </li>
            <li>
              <strong>A retention policy.</strong> Documented: typically 6 years post-disposal, with
              extensions for incident-relevant items and sector-specific requirements.
            </li>
            <li>
              <strong>Access controls.</strong> Role-based, with a clear list of who can read / edit
              / export the register. Privacy notice if personal data is in the register.
            </li>
          </ol>
          <p>
