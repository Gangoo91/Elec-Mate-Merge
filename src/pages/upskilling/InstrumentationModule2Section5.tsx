...
const DESCRIPTION =
  'Understand the differences between digital and analogue sensor outputs, signal processing, and choosing appropriate output types for control systems.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'An ADC converts continuous analogue signals into discrete digital values that can be processed by digital systems like PLCs and computers.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'A proximity sensor with on/off output is a classic example of a digital output device - it provides discrete states (object present/absent) rather than continuous values.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Digital sensors are preferred in safety systems because they provide excellent noise immunity and clear, definitive on/off states essential for reliable safety decisions.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      '0-10V signals are susceptible to voltage drops due to cable resistance and noise pickup from electromagnetic interference, making them less reliable over long cable runs.',
  },
  {
    id: 9,
...
const faqs = [
  {
    ...
    answer:
      "4-20mA current loops are preferred because the signal is independent of cable resistance (unlike voltage signals), they have excellent noise immunity, can travel long distances without degradation, and the 'live zero' at 4mA allows easy detection of wiring faults (0mA indicates a broken wire).",
  },
  {
    question: 'What is the difference between 2-wire and 4-wire transmitters?',
    answer:
      '2-wire (loop-powered) transmitters draw their operating power from the 4-20mA signal loop, simplifying wiring but limiting features. 4-wire transmitters have separate power supply connections, allowing more features, higher accuracy, and isolated outputs, but require additional wiring.',
  },
  {
    question: 'How does HART communication work with analogue signals?',
    answer:
      'HART (Highway Addressable Remote Transducer) superimposes digital communication signals on the 4-20mA analogue signal using frequency-shift keying. The digital data does not affect the analogue measurement, allowing configuration, diagnostics, and additional process variables on existing wiring.',
  },
  {
    question: 'What resolution ADC do I need for instrumentation?',
    answer:
      'For most industrial applications, 12-bit (4096 levels) provides adequate resolution. Higher accuracy applications may require 16-bit (65536 levels) or 24-bit for precision measurement. The required resolution depends on your measurement accuracy needs and signal-to-noise ratio.',
  },
  {
    question: 'When should I use digital fieldbus instead of analogue signals?',
    answer:
      'Digital fieldbus (Profibus, Foundation Fieldbus, Modbus) is preferred when you need multiple measurements from one device, extensive diagnostics, remote configuration, or when reducing wiring costs on large installations. Traditional 4-20mA remains common for simple, reliable point-to-point connections.',
  },
  {
    question: 'How do I protect analogue signals from electrical noise?',
    answer:
      'Use shielded twisted-pair cables with the shield grounded at one end only, route signal cables away from power cables, use signal isolators where needed, ensure proper grounding, and consider current loops (4-20mA) instead of voltage signals for better noise immunity.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Analogue:</strong> 4-20mA, 0-10V, continuous values
              </li>
              <li>
                <strong>Digital:</strong> On/off, pulse, serial communication
              </li>
              <li>
                <strong>ADC/DAC:</strong> Convert between analogue and digital
              </li>
              <li>
                <strong>Selection:</strong> Based on application and control system
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> 4-20mA wiring, digital fieldbus connectors
              </li>
              <li>
                <strong>Use:</strong> Match output to PLC input type
              </li>
              <li>
                <strong>Apply:</strong> Signal conditioning, noise reduction
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Analogue outputs provide continuous signals that can represent any value within their
              specified range. They are ideal for applications requiring precise measurement data
              and smooth control responses.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">4-20mA Current Loop</p>
              <p className="text-sm text-white mb-2">
                Industry standard for long-distance signal transmission with excellent noise
                immunity.
              </p>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white mb-2">
                Common voltage signal for local measurements and control applications.
              </p>
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <p className="text-sm font-medium text-white mb-1">Advantages</p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Millivolt Sensor Outputs
              </p>
              <p className="text-sm text-white mb-2">
                Low-level signals from sensors like thermocouples and strain gauges.
              </p>
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Digital outputs provide discrete states or data packets, offering excellent noise
              immunity and direct compatibility with digital control systems.
            </p>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white mb-2">
                Simple two-state outputs for presence detection and switching applications.
              </p>
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <p className="text-sm font-medium text-white mb-1">Characteristics</p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Pulse/Frequency Outputs
              </p>
              <p className="text-sm text-white mb-2">
                Variable frequency signals proportional to measured values.
              </p>
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
                  <p className="text-sm font-medium text-white mb-1">Advantages</p>
            ...
            <div className="my-6">
              ...
              <p className="text-sm text-white mb-2">
                Structured data packets containing measurement values and status information.
              </p>
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Modern control systems often require conversion between analogue and digital signals,
              along with various signal processing functions to ensure optimal performance.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <p className="text-sm text-white mb-2">
                  Converts continuous analogue signals into discrete digital values.
                </p>
              ...
              <div>
                ...
                <p className="text-sm text-white mb-2">
                  Converts digital control signals into analogue outputs for actuators.
                </p>
                <div className="space-y-2">
                  <p className="text-sm font-medium text-white mb-1">Key Parameters</p>
                  <ul className="text-sm text-white space-y-1 ml-4">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Selecting the appropriate output type depends on application requirements, control
              system compatibility, and environmental factors.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Mismatched signal types</strong> — connecting 4-20mA to voltage input
                  damages equipment
                </li>
                <li>
                  <strong>Ignoring loop resistance</strong> — long cables can exceed transmitter
                  drive capability
                </li>
                <li>
                  <strong>Poor cable routing</strong> — running signal cables near VFDs causes
                  interference
                </li>
                <li>
                  <strong>Ground loops</strong> — multiple ground connections cause measurement
                  errors
                </li>
              </ul>
            </div>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="../instrumentation-module-2-section-6">
              Next Section
