...
const inlineChecks = [
  {
    ...
    question: 'Why is solar thermal NOT a Section 551 generating set?',
    options: [
  ...
  },
  {
    ...
    question: 'Flat plate vs evacuated tube solar thermal collectors — what are the differences?',
    options: [
  ...
  },
  {
    ...
    question: 'How does the differential-temperature controller work?',
    options: [
...
const quizQuestions = [
  ...
  {
    question: 'Reg 522.2.1 — why does it matter for solar thermal cable routing?',
    options: [
  ...
  {
    question: 'Drainback vs pressurised solar thermal systems — electrical implications?',
    options: [
  ...
  {
    question: 'Differential-temperature controller commissioning — what do you verify?',
    options: [
  ...
  {
    question: 'Existing immersion remaining as DHW backup on solar thermal install — what scope?',
    options: [
...
export default function RenewableEnergyModule9Section3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 9 · Section 3 · Reg 314 + Reg 415.1 + Reg 522.2.1 + Section 554 + MCS MIS 3001"
        title="Solar thermal (collectors + electrical scope)"
        backTo="../renewable-energy-module-9"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Solar thermal heating — NOT a Section 551 generating set (heat-only, no electrical
          generation), but real electrical install scope. Differential-temperature controller +
          circulation pumps + sensors + drainback vs pressurised. MCS MIS 3001 framework. BS EN
          12975 / 12976 collector + system standards. Reg 522.2.1 cable thermal protection near hot
          primary pipework.
        </p>
        ...
        <Pullquote>
          Solar thermal doesn\'t generate electricity but does generate work for the electrician.
          Controller + pump + sensors + cable-near-hot-pipework — small scope but real.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Differential-temperature controller</strong> — 230 V AC
              mains-powered; compares collector vs cylinder temperature; switches pump on/off based
              on delta-T logic
            </li>
            <li>
              <strong className="text-white">Circulation pump(s)</strong>— typically 40-200 W
              single-phase AC; smaller (40-80 W) for pressurised systems; larger (100-200 W) for
              drainback systems (lift-against-gravity)
            </li>
            <li>
              <strong className="text-white">Temperature sensors</strong> — Pt1000 or NTC
              thermistors at collector outlet (T1), cylinder coil inlet (T2), and optionally outlet
              / additional points. 2-core LV cable to controller
            </li>
            <li>
              <strong className="text-white">
                Drainback / pressurised system electrical elements
              </strong>{' '}
              — pressure sensor (pressurised only), expansion vessel monitoring, drainback reservoir
              level detection (drainback only)
            </li>
            <li>
              <strong className="text-white">Freeze protection</strong>— glycol-based: monitoring
              sensor on glycol concentration / pH; drainback: inherent (no water in collector when
              pump off); controller logic manages either approach
            </li>
            <li>
              <strong className="text-white">Existing immersion integration</strong> — retained as
              backup for low-solar weeks + HSE HSG274 legionella; Section 554 framework applies
            </li>
            <li>
              <strong className="text-white">Cable thermal protection</strong> — Reg 522.2.1 applies
              because solar primary pipework reaches 90+ °C in summer + stagnation; cable runs near
              pipework protected by distance / shielding / higher-rated cable
            </li>
            <li>
              <strong className="text-white">NO electrical generation</strong> — no inverter, no
              export metering, no EREC G98 / G99, no anti-islanding device. Section 551 + Chapter 82
              PEI do NOT apply
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Flat plate collector</strong> — rectangular panel
              typically 1.5-2.5 m². Metal absorber (copper / aluminium with selective coating) under
              low-iron glass cover. Insulated rear. Heat transfer fluid through absorber pipes. Cost
              £400-700 per panel UK 2025-26
            </li>
            <li>
              <strong className="text-white">Flat plate thermal efficiency</strong> — moderate;
              significant heat loss through glass cover in cold conditions. Better in clear / warm
              conditions
            </li>
            <li>
              <strong className="text-white">Evacuated tube collector</strong> — parallel rows of
              glass tubes (8-30 per panel). Inner absorber in vacuum-insulated tube → very low heat
              loss. Cost £700-1,500 per equivalent panel UK 2025-26
            </li>
            <li>
              <strong className="text-white">Evacuated tube efficiency</strong> — higher across all
              conditions, especially cold + low-irradiance. Better suits UK\'s cool / overcast
              climate. Slightly more fragile (glass tubes)
            </li>
            <li>
              <strong className="text-white">Product standards</strong> — BS EN 12975-1 + -2
              (collectors), BS EN 12976 (system-level). MCS-approved products carry DoC
            </li>
            <li>
              <strong className="text-white">Roof mounting</strong>— both: integrated (replaces
              tiles) or on-roof (mounted above existing roof). Structural roof assessment (load +
              wind uplift) required for either
            </li>
            <li>
              <strong className="text-white">Sizing</strong> — typical UK 4-bed household: 4-5 m² of
              flat plate OR 4-6 m² evacuated tube; covers ~50-70% of annual DHW demand
            </li>
            <li>
              <strong className="text-white">Electrical install scope identical</strong> — same
              controller, pump, sensors, cable. The differences are mechanical / hydraulic
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          The differential-temperature controller does one job: ‘is the sun hot enough to put heat
          in the cylinder?’ It runs the pump or it doesn\'t. Everything else is mechanical.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Sensor connections + polarity</strong> — Pt1000 / NTC
              at collector outlet (T1), cylinder coil (T2), optional outlet (T3). 2-core LV
              (0.5-0.75 mm²) cable. Verify each sensor reads accurately per controller display
            </li>
            <li>
              <strong className="text-white">Sensor reading verification</strong> — compare DTC
              display vs known thermometer at each sensor location. ±2 °C typical acceptable.
              Significant deviation indicates wrong sensor type, wrong polarity, or cable error
            </li>
            <li>
              <strong className="text-white">Delta-T_on threshold</strong> — typically 6-8 K factory
              default. Adjust per manufacturer / system needs. Higher delta-T_on = less pump cycling
              but slower heat transfer initiation
            </li>
            <li>
              <strong className="text-white">Delta-T_off threshold</strong> — typically 2-4 K. Must
              be lower than delta-T_on (hysteresis). Prevents pump short-cycling
            </li>
            <li>
              <strong className="text-white">Pump engagement test</strong> — heat collector sensor
              above cylinder sensor by delta-T_on threshold (use controlled hot water or heat gun on
              sensor temporarily). Verify pump activates. Listen for pump running; check flow
              indicator
            </li>
            <li>
              <strong className="text-white">Pump deactivation test</strong> — let collector sensor
              cool back. Verify pump deactivates when delta drops to delta-T_off
            </li>
            <li>
              <strong className="text-white">Over-temperature shutdown</strong> — simulate cylinder
              reaching setpoint (60-70 °C); verify pump stops even with collector hot. Prevents
              cylinder overheating
            </li>
            <li>
              <strong className="text-white">Reverse-flow prevention</strong> — verify pump does NOT
              run when cylinder reads higher than collector (e.g. night with warm cylinder + cold
              ambient collector). Critical to prevent cylinder cooling overnight
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — controller model +
              configuration + sensor calibration + functional test results
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Drainback pump sizing</strong> — must lift water back
              up to the collector when started (loop volume + static head). Typically 100-200 W vs
              40-80 W pressurised. Higher start current — verify Reg 411.4 ADS + Reg 415.1 RCD
              margin
            </li>
            <li>
              <strong className="text-white">Drainback pump cycle</strong> — at startup, pump runs
              longer to prime + fill collector loop (typical 30-60 seconds). Controller logic
              manages this
            </li>
            <li>
              <strong className="text-white">Drainback freeze protection</strong> — inherent (no
              water in collector when pump off, cannot freeze). NO glycol management
            </li>
            <li>
              <strong className="text-white">Drainback reservoir monitoring</strong> — some systems
              monitor reservoir level (level switch input to controller); alarms if low (leak)
            </li>
            <li>
              <strong className="text-white">Pressurised pump sizing</strong> — lower-power pump
              (40-80 W typical), continuous circulation when active
            </li>
            <li>
              <strong className="text-white">Pressurised expansion vessel</strong> — accommodates
              thermal expansion of glycol mix; sized 5-10% of loop volume. Pre-charged at install
            </li>
            <li>
              <strong className="text-white">Pressurised pressure sensor</strong> — monitors loop
              pressure; 4-20 mA or 0-10 V signal to controller. Pressure drop → leak alarm. Pressure
              rise → expansion vessel failure or overheat alarm
            </li>
            <li>
              <strong className="text-white">Pressurised freeze protection</strong> — via glycol
              concentration; typically 30-40% propylene glycol in water. Degrades over years;
              replacement every 7-10 years (separate plumbing scope, not electrical)
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — system type +
              controller features + commissioning test specific to type
            </li>
          </ul>
        </ConceptBlock>
