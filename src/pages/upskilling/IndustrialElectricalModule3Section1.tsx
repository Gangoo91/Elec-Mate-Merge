  ...
  const quizQuestions = [
    {
      ...
      options: [
        'Dust-protected, with low-pressure water jet protection',
        'Protected against solid objects over 1mm and dripping water',
        'Totally dust-tight and protected against water jets',
        'Dust-protected and protected against temporary immersion',
      ],
      correctAnswer: 'Totally dust-tight and protected against water jets',
      explanation:
        'In IP65 the first digit 6 means fully dust-tight and the second digit 5 means protection against water jets from any direction. IP66 is needed for the more powerful jets.',
    },
    {
      question:
        'When calculating heat dissipation in a control panel, which factor is NOT normally included?',
      options: [
        'The colour of the internal wiring insulation',
        'Power losses from contactors and relays',
        'Heat generated by variable speed drives',
        'Solar radiation on outdoor panels',
      ],
      correctAnswer: 'The colour of the internal wiring insulation',
      explanation:
        'Heat-load calculations sum the real power losses (drives, contactors, PSUs) plus external gains like solar load. Wiring insulation colour has no bearing on heat dissipation.',
    },
    {
      question:
      ...
      options: [
        '25mm on all sides',
        '50mm above and below, 25mm at the sides',
        '100mm above and below, 50mm at the sides',
        '150mm on all sides',
      ],
      correctAnswer: '100mm above and below, 50mm at the sides',
      explanation:
        'VSDs are major heat generators, so a typical minimum is 100mm above and below to let hot air rise away and cool air enter, with around 50mm at the sides. Always confirm against the datasheet.',
    },
    {
      question: 'According to BS EN 61439, what is a "design verification"?',
      options: [
        'A visual inspection performed on site',
        'A customer acceptance test on handover',
        'Verification by testing, calculation or the application of design rules',
        'An annual maintenance check of the assembly',
      ],
      correctAnswer: 'Verification by testing, calculation or the application of design rules',
      explanation:
        'BS EN 61439 design verification confirms the assembly meets requirements through testing, calculation or established design rules — distinct from the routine verification done on each finished unit.',
    },
    {
      question:
        'What is the primary purpose of internal Form separation (Forms 1 to 4) in switchgear assemblies?',
      options: [
        'To improve the appearance of the panel',
        'To provide degrees of separation between busbars, functional units and terminals',
        'To reduce manufacturing costs',
        'To increase the overall IP rating',
      ],
      correctAnswer:
        'To provide degrees of separation between busbars, functional units and terminals',
      explanation:
        'Forms 1 to 4 define increasing internal separation so faults are contained and work can be done on one section while others stay live. They are about safety and segregation, not looks or IP.',
    },
    {
      question:
        'Which software is specifically designed for electrical panel schematic and wiring documentation?',
      options: ['Microsoft Visio', 'Adobe Illustrator', 'EPLAN Electric P8', 'SketchUp'],
      correctAnswer: 'EPLAN Electric P8',
      explanation:
        'EPLAN Electric P8 is a dedicated electrical CAD package with schematic-driven design, automatic cross-referencing and BOM generation. The others are general drawing or 3D tools.',
    },
    {
      question:
        'What is the typical power loss (heat) for a modern variable speed drive at full load?',
      options: ['1-2% of rated kW', '2-4% of rated kW', '5-8% of rated kW', '10-15% of rated kW'],
      correctAnswer: '2-4% of rated kW',
      explanation:
        'A modern VSD is around 96-98% efficient, so roughly 2-4% of its rated power is dissipated as heat inside the panel — the figure used when sizing cooling.',
    },
    {
      question:
        'When sizing a panel enclosure, what spare capacity is recommended for future expansion?',
      options: ['5-10%', '10-15%', '20-30%', '40-50%'],
      correctAnswer: '20-30%',
      explanation:
        'Allowing about 20-30% spare rail, duct and enclosure space accommodates future additions and makes the original installation and wiring far easier to work in.',
    },
    {
      question:
        'Which enclosure construction is most suitable for harsh industrial environments with corrosive atmospheres?',
      options: ['Painted mild steel', 'Galvanised steel', 'Aluminium', '316 stainless steel'],
      correctAnswer: '316 stainless steel',
      explanation:
        '316 (marine-grade) stainless steel contains molybdenum for superior resistance to chlorides and corrosive atmospheres, outperforming painted, galvanised or aluminium enclosures in severe conditions.',
    },
    {
      question:
      ...
      options: [
        ...
        'In the middle, close to heat-generating components',
      ...
      explanation:
        'Heat rises, so the top is generally the coolest zone and is kept for sensitive electronics, while major heat generators like VSDs go lower where their hot air can rise away from them.',
    },
  ];
