    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white">Understanding fibre optic cable types and applications</p>
        </header>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent">
                ...
                <p className="text-white text-xs">Aqua jacket</p>
              </div>
              <div className="p-3 rounded bg-transparent">
              ...
              <div className="p-3 rounded bg-transparent">
                ...
                <p className="text-white text-xs">VCSEL wavelength</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/electrician/upskilling/data-cabling-module-2-section-5">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous Section
            </Link>
          </Button>
          <Button
            ...
            asChild
          >
            <Link to="/electrician/upskilling/data-cabling-module-3-section-2">
              Next Section
