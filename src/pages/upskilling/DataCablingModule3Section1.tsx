    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Core / cladding geometry, OM1-OM5 multimode grades and OS1 / OS1a / OS2 single-mode
          classes, the published reach table by Ethernet variant, jacket colour conventions, and the
          BS 7671:2018+A4:2026 §444.4.9 preference for metal-free fibre between buildings on
          separate equipotential systems.
        </p>
        ...
        >
          <p>
            ...
            reach and bandwidth. There is no modal dispersion — only chromatic and polarisation-mode
            dispersion, both of which are small. The cost is precision: the tiny core is harder to
            align at a splice or connector, and SMF transceivers (DFB lasers, direct-modulated or
            externally-modulated) are more expensive than the VCSELs used in multimode systems.
          </p>
          <p>
            Multimode fibre with a 50 / 62.5 µm core admits many modes. Each mode follows a slightly
            different geometric path along the fibre and arrives at the far end with a slightly
            different propagation delay — modal dispersion. A single transmitted pulse spreads in
            time as it propagates. As the bit rate rises, the symbol time shrinks until the
            modal-delay spread consumes the symbol gap, and the receiver cannot distinguish bits.
            Modal dispersion is the dominant limit on multimode reach at high data rates. OM3 / OM4
            / OM5 use carefully graded refractive-index profiles to equalise the mode delays — that
            is what gives them their high effective modal bandwidth (2000 MHz·km for OM3, 4700
            MHz·km for OM4, ~28 000 MHz·km effective for OM5).
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>62.5/125 µm — legacy multimode.</strong> OM1. Was the dominant office fibre in
              the 1990s; supports 1 GbE only at modest reach, 10 GbE at 33 m maximum.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>OM1 — 62.5/125 µm, LED.</strong> Legacy. 200 MHz·km. 1 GbE to 275 m at 850 nm;
              10 GbE only to 33 m. Found in older buildings; not specified for new work.
            </li>
            <li>
            ...
            <li>
              <strong>OM3 — 50/125 µm, laser-optimised VCSEL.</strong> 2000 MHz·km. 10 GbE to 300 m
              at 850 nm; 40 / 100 GbE parallel-optic to 100 m. Aqua jacket. Standard floor fibre in
              many 2010s designs.
            </li>
            <li>
              <strong>OM4 — 50/125 µm, laser-optimised VCSEL.</strong> 4700 MHz·km. 10 GbE to 400 m
              at 850 nm; 40 / 100 GbE parallel-optic to 150 m. Aqua jacket (sometimes Erika violet
              for differentiation). Modern default for in-building high-capacity multimode.
            </li>
            <li>
              ...
              across 850-953 nm — multiple wavelengths on a single fibre pair. 100 GbE SWDM4 to 150
              m on duplex LC; backwards-compatible with OM4. Lime-green jacket.
            </li>
          </ul>
          <p>
            The reach values below come from the published industry standards manifest used
            throughout this course — IEEE 802.3 (Ethernet variants), ISO/IEC 11801 / TIA-568.3-E for
            fibre cabling, and ANSI/TIA-492 for the OM grade specifications themselves. They are
            reproduced verbatim, not invented.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>OS1.</strong> Tight-buffered indoor cable, 9/125 µm SMF, 1.0 dB/km attenuation
              specification. Suitable for indoor / short campus runs to ~10 km. Older standard;
              superseded by OS1a in most new specifications.
            </li>
            <li>
              <strong>OS1a.</strong> Indoor-rated low-water-peak update aligned with ITU-T G.652.D.
              Removes the historical attenuation peak around 1383 nm caused by hydroxyl impurities,
              so the full 1260-1625 nm transmission window is usable — important if CWDM (coarse
              wavelength-division multiplexing) services are planned. Same 9/125 µm core; same 10 km
              indoor reach.
            </li>
            <li>
              <strong>OS2.</strong> Loose-tube outside-plant cable, 9/125 µm SMF, ≤ 0.4 dB/km
              maximum attenuation. Designed for outdoor / direct-buried / aerial / duct deployment,
              with mechanical and environmental ratings to match. Reach is transceiver-limited; with
              appropriate optics, link distances up to ~200 km are achievable.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Orange.</strong> OM1 (62.5/125) or OM2 (50/125 LED). Both are legacy and share
              the colour because the convention pre-dates OM3.
            </li>
            <li>
          ...
          <p>
            ...
            capability; OS2 over OM4 buys 200 km reach. Both add cost — OS2 mostly at the optic, OM5
            mostly at the cable. Specify the lowest grade that absorbs the foreseeable services with
            comfortable headroom; document the choice.
          </p>
        </ConceptBlock>
        ...
        <CommonMistake
          ...
          doInstead={
            <>
              ...
              attenuation, future-proof) AND specify metal-free / all-dielectric construction under
              §444.4.9. Multimode is correct in-building where reach is short and 850 nm VCSEL
              optics are cheaper. Document the choice on the design drawing against the reach table.
            </>
          }
        />
        ...
        <Scenario
          ...
          situation={
            <>
              ...
              ~80 m vertical riser between basement and the highest FD. Brief is "Cat6A horizontal,
              fibre backbone, future-flex for 25 G / 40 G to the floor in 5-10 years". A separate
              annex building (~120 m away across a service yard) needs inter-building fibre.
            </>
          }
          whatToDo={
            <>
              Pick OM4 (or OM5) for the in-building riser — the 80 m riser reach is well within OM4
              at 10 / 25 / 40 G; OM5 adds SWDM upgrade on duplex LC for 100 G. Use LC duplex
              connectors throughout. For the 120 m inter-building run, pick OS2 single-mode in an
              all-dielectric (metal-free) outside-plant loose-tube construction — §444.4.9 preferred
              medium. Single-mode optics at the floor switches (10GBASE-LR or 25GBASE-LR depending
              on uplink demand). Site each FD so every horizontal Cat6A on the floor reaches its
              outlet within 90 m. Document the fibre type, OM grade / OS class, jacket colour,
              connector type, and the §444.4.9 reasoning on the design package. Run all cable on
              steel containment to meet §521.10.202.
            </>
          }
          whyItMatters={
            <>
              ...
              would either fail at 40 G+ on the longer run or invite §444.4.9 non-compliance on the
              inter-building section. Specifying OS2 for both works but burns money on expensive
              single-mode optics where multimode VCSELs would do.
            </>
          }
        />
