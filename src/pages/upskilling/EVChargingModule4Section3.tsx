...
const faqs = [
  {
    ...
    answer:
      'Split-core CTs are ideal for retrofit installations as they can be installed without disconnecting existing cables. They provide adequate accuracy for most monitoring applications and are quick to install.',
  },
  {
    question: 'How often should monitoring equipment be calibrated?',
    answer:
      'Annual calibration is typically required for revenue-grade metering. For monitoring applications, bi-annual calibration may be acceptable. Always follow manufacturer recommendations and applicable standards.',
  },
  {
    question: 'Can monitoring systems help with predictive maintenance?',
    answer:
      'Yes, advanced monitoring with trend analysis can identify degradation before failure occurs. Monitoring current harmonics, power quality, and temperature trends enables proactive maintenance scheduling.',
  },
  {
    question: 'What communication protocols do modern relays support?',
    answer:
      'Modern multifunction relays support Modbus RTU/TCP, IEC 61850, DNP3, and often have Ethernet connectivity. This allows integration with building management systems and remote monitoring platforms.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'A commercial charging hub requires monitoring for 20 charging points with individual billing. What CT accuracy class is most appropriate?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Class 0.5 is most appropriate for commercial charging with individual billing. It provides adequate accuracy for billing purposes while being cost-effective. Class 0.2S is typically reserved for utility revenue metering where higher accuracy justifies the additional cost.',
  },
];
...
const EVChargingModule4Section3 = () => {
  useSEO({
    ...
    description:
      'Learn to install and configure monitoring devices and relays for enhanced EV charging protection. Covers CTs, voltage relays, and power quality monitoring.',
  });
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>CTs:</strong> Class 0.5 for billing, Class 1 for monitoring
              </li>
              <li>
                <strong>Voltage:</strong> 90% UV trip, 106% OV trip typical
              </li>
              <li>
                <strong>Power quality:</strong> THD &lt;8%, power factor &gt;0.85
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> CT donut on cable, relay with LCD display
              </li>
              <li>
                <strong>Use:</strong> Load balancing, billing, predictive maintenance
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              protection, and billing in EV charging installations. Selection depends on application
              requirements and accuracy needs.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li>
                    <strong>Window-type:</strong> New installations, best accuracy
                  </li>
                  <li>
                    <strong>Rogowski coils:</strong> Flexible, high-frequency
                  </li>
                  <li>
                    <strong>Precision:</strong> Revenue-grade metering
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>7kW single:</strong> 50/5A, Class 1
                  </li>
                  <li>
                    <strong>22kW three-phase:</strong> 100/5A, Class 0.5
                  </li>
                  <li>
                    <strong>Distribution board:</strong> 200/5A, Class 0.5
                  </li>
                  <li>
                    <strong>Main incomer:</strong> 400/5A, Class 0.2S
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Clearance:</strong> Minimum 200mm from adjacent conductors
                </li>
                <li>
                  <strong>Lead length:</strong> Keep secondary leads under 4m
                </li>
                <li>
                  <strong>Cabling:</strong> Twisted pair for EMI immunity
                </li>
                <li>
                  <strong>Protection:</strong> IP54 minimum for environmental protection
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              overvoltage, phase loss, and phase sequence faults. Proper configuration ensures
              equipment protection while avoiding nuisance tripping.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>UV trip:</strong> 90% (207V), 5s delay
                  </li>
                  <li>
                    <strong>OV trip:</strong> 106% (244V), 1s delay
                  </li>
                  <li>
                    <strong>Phase unbalance:</strong> 3%, 10s delay
                  </li>
                  <li>
                    <strong>Phase loss:</strong> 80% (184V), 2s delay
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Phase sequence:</strong> L1-L2-L3 verification
                  </li>
                  <li>
                    <strong>Auto reconnect:</strong> When voltage normalises
                  </li>
                  <li>
                    <strong>Indication:</strong> LED status and alarms
                  </li>
                  <li>
                    <strong>Communication:</strong> Remote monitoring interface
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Variation:</strong> ±10% limits
                  </li>
                  <li>
                    <strong>Flicker:</strong> P99 &lt;1.0
                  </li>
                  <li>
                    <strong>Frequency:</strong> ±1% (49.5-50.5Hz)
                  </li>
                  <li>
                    <strong>Unbalance:</strong> &lt;2% for three-phase
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>THD:</strong> &lt;8% at nominal power
                  </li>
                  <li>
                    <strong>DC injection:</strong> &lt;6mA
                  </li>
                  <li>
                    <strong>Power factor:</strong> &gt;0.85
                  </li>
                  <li>
                    <strong>Individual harmonics:</strong> Per IEC 61851
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Monitoring Thresholds (EV Charging):
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Voltage THD:</strong> 6% monitoring threshold, 8% limit
                </li>
                <li>
                  <strong>Current THD:</strong> 6% monitoring threshold, 8% limit
                </li>
                <li>
                  <strong>DC injection:</strong> 4mA monitoring, 6mA limit
                </li>
                <li>
                  <strong>Power factor:</strong> 0.90 monitoring, 0.85 minimum
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Open CT secondary:</strong> — Dangerous voltages, always use shorting
                  links
                </li>
                <li>
                  <strong>Wrong CT ratio:</strong> — Incorrect readings affect billing and
                  protection
                </li>
                <li>
                  <strong>Sensitive settings:</strong> — Causes nuisance tripping, adjust for
                  environment
                </li>
                <li>
                  <strong>Missing earth:</strong> — CT secondary must be single-point earthed
                </li>
              </ul>
            </div>
          </div>
