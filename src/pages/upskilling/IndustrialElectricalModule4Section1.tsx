...
const IndustrialElectricalModule4Section1: React.FC = () => {
  ...
  useSEO({
    ...
    description:
      'Learn PLC system architecture, digital and analogue I/O configuration, sinking vs sourcing concepts, and I/O wiring best practices for Siemens, Allen-Bradley, and Schneider PLCs.',
    keywords: [
      'PLC architecture',
      'PLC inputs outputs',
      'sinking sourcing',
  ...
  const quickCheckQuestions = [
    ...
    },
    {
      ...
      correctIndex: 1,
      explanation:
        'A PNP (sourcing) sensor provides positive voltage when active, so it must connect to a SINKING input module that provides the current path to common/ground. Remember: sourcing outputs connect to sinking inputs, and vice versa.',
    },
    {
      id: 'qc3-live-zero',
      ...
      <main className="max-w-4xl mx-auto px-4 py-6 space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Understanding CPU, memory, I/O systems, and proper wiring configurations for industrial
            PLCs
          </p>
        </div>
        ...
        <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
          ...
          <p className="text-sm text-muted-foreground">
            This section covers PLC system architecture, digital I/O concepts including sinking vs
            sourcing, analogue signal types (4-20mA and 0-10V), modular vs compact PLC selection,
            and wiring best practices essential for reliable industrial control systems.
          </p>
        </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground">
              A Programmable Logic Controller (PLC) consists of three core components working
              together: the <span className="text-elec-yellow font-semibold">CPU</span> (Central
              Processing Unit),
              <span className="text-elec-yellow font-semibold"> memory systems</span>, and
              <span className="text-elec-yellow font-semibold"> Input/Output modules</span>.
              Understanding this architecture is essential for programming, troubleshooting, and
              system design.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-3">
              <div className="bg-background/50 rounded-lg p-3 border border-white/10">
                ...
                <p className="text-muted-foreground text-sm">
                  The "brain" that executes the program logic, performs calculations, and manages
                  communication. Modern CPUs include Siemens S7-1500, Allen-Bradley ControlLogix,
                  and Schneider M340.
                </p>
              </div>
              <div className="bg-background/50 rounded-lg p-3 border border-white/10">
                ...
                <p className="text-muted-foreground text-sm">
                  <strong>RAM:</strong> Working memory for program execution.
                  <br />
                  <strong>ROM/Flash:</strong> Stores firmware and retentive data.
                  <br />
            ...
            <div className="bg-background/50 rounded-lg p-4 border-l-2 border-elec-yellow">
              ...
              <ol className="text-muted-foreground text-sm space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-foreground">Input Scan:</strong> Read all physical
                    inputs into the Input Image Table
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="bg-elec-yellow text-background rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold flex-shrink-0">
                  ...
                  <span>
                    <strong className="text-foreground">Program Execution:</strong> Execute logic
                    using image table data (top to bottom, left to right)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="bg-elec-yellow text-background rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold flex-shrink-0">
                  ...
                  <span>
                    <strong className="text-foreground">Output Scan:</strong> Write Output Image
                    Table values to physical outputs
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="bg-elec-yellow text-background rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold flex-shrink-0">
                  ...
                  <span>
                    <strong className="text-foreground">Housekeeping:</strong> Communications,
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm text-muted-foreground">
                  ...
                  <ul className="mt-2 space-y-1">
                    <li>
                      <strong>Allen-Bradley:</strong> I:1/0 (Input slot 1, bit 0), O:2/5 (Output
                      slot 2, bit 5)
                    </li>
                    <li>
                      <strong>Siemens S7:</strong> %I0.0 (Input byte 0, bit 0), %Q1.3 (Output byte
                      1, bit 3), %IW64 (Input word 64)
                    </li>
                    <li>
                      <strong>Schneider:</strong> %I0.1.2 (Input rack 0, module 1, channel 2)
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground">
              Understanding sinking and sourcing is crucial for correctly wiring sensors to PLC
              inputs. These terms describe the direction of current flow relative to the I/O point.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-background/50 rounded-lg p-4 border border-green-500/30">
                ...
                <p className="text-muted-foreground text-sm mb-3">
                  The input module <strong className="text-foreground">provides</strong> (sources)
                  positive voltage to the sensor/switch. Current flows OUT of the input terminal.
                </p>
                <div className="bg-background/70 rounded p-3 text-sm">
                  <p className="text-muted-foreground">
                    Connects to: <span className="text-elec-yellow">NPN (sinking) sensors</span>
                  </p>
                  <p className="text-muted-foreground mt-1">
                    Common wire: Connected to supply positive (+24V)
                  </p>
                </div>
              ...
              <div className="bg-background/50 rounded-lg p-4 border border-blue-500/30">
                ...
                <p className="text-muted-foreground text-sm mb-3">
                  The input module <strong className="text-foreground">receives</strong> (sinks)
                  current from the sensor. Current flows INTO the input terminal.
                </p>
                <div className="bg-background/70 rounded p-3 text-sm">
                  <p className="text-muted-foreground">
                    Connects to: <span className="text-elec-yellow">PNP (sourcing) sensors</span>
                  </p>
                  <p className="text-muted-foreground mt-1">
                    Common wire: Connected to supply negative (0V)
                  </p>
                </div>
                <div className="mt-3 text-xs text-muted-foreground">
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-muted-foreground mt-1">
                    <strong className="text-foreground">PNP sensors (sourcing)</strong> &rarr;
                    Connect to <strong className="text-foreground">Sinking inputs</strong>
                    <br />
                    <strong className="text-foreground">NPN sensors (sinking)</strong> &rarr;
                    Connect to <strong className="text-foreground">Sourcing inputs</strong>
                  </p>
                  <p className="text-muted-foreground mt-2 text-xs">
                    Remember: Current must have a complete path. Sourcing provides positive, sinking
                    provides ground.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-background/50 rounded-lg p-4">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div className="text-muted-foreground">
                  <strong className="text-foreground">Europe/Asia:</strong> PNP (sourcing) sensors
                  preferred. Positive switching is considered safer - a ground fault will not
                  activate the sensor.
                </div>
                <div className="text-muted-foreground">
                  <strong className="text-foreground">North America:</strong> NPN (sinking) sensors
                  common, though PNP is increasingly adopted. Check existing system standards before
                  specifying.
                </div>
              </div>
            </div>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            ...
            <div className="space-y-4">
              <div className="bg-background/50 rounded-lg p-4 border-l-4 border-purple-500">
                ...
                <p className="text-muted-foreground text-sm mb-3">
                  Mechanical contacts that physically open and close. Provides complete electrical
                  isolation between PLC logic and load circuit.
                </p>
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
                ...
                <p className="text-muted-foreground text-xs mt-3">
                  <strong>Typical rating:</strong> 2A @ 240VAC or 30VDC. Best for: pilot lights,
                  small contactors, solenoids, and mixed voltage applications.
                </p>
              </div>
              ...
              <div className="bg-background/50 rounded-lg p-4 border-l-4 border-blue-500">
                ...
                <p className="text-muted-foreground text-sm mb-3">
                  Solid-state switching using NPN or PNP transistors. Fast, reliable, long-lasting
                  for DC loads.
                </p>
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
                ...
                <p className="text-muted-foreground text-xs mt-3">
                  <strong>Typical rating:</strong> 0.5-2A @ 24VDC. Best for: high-speed
                  applications, stepper drives, proportional valves, DC solenoids.
                </p>
              </div>
              ...
              <div className="bg-background/50 rounded-lg p-4 border-l-4 border-orange-500">
                ...
                <p className="text-muted-foreground text-sm mb-3">
                  Solid-state switching for AC loads. Combines transistor reliability with AC
                  capability.
                </p>
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
                ...
                <p className="text-muted-foreground text-xs mt-3">
                  <strong>Typical rating:</strong> 0.5-1A @ 240VAC. Best for: AC solenoids, small
                  heaters, AC motor starters (via contactor).
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground">
              Analogue signals represent variable process values like temperature, pressure, level,
              or flow. The two most common industrial standards are{' '}
              <span className="text-elec-yellow font-semibold">4-20mA current loops</span> and{' '}
              <span className="text-elec-yellow font-semibold">0-10V voltage signals</span>.
            </p>
              ...
              <div className="bg-background/50 rounded-lg p-4 border border-cyan-500/30">
                ...
                <div className="space-y-3 text-sm text-muted-foreground">
                  <div className="bg-background/70 rounded p-3">
                    ...
                    <p className="mt-1">
                      4mA = 0% of range (not 0mA)
                      <br />
                      20mA = 100% of range
                    </p>
                    <p className="text-muted-foreground text-xs mt-2">
                      This allows distinguishing between "true zero" (4mA) and a fault/broken wire
                      (0mA).
                    </p>
                  </div>
                  <ul className="space-y-1">
                    <li>
                      <CheckCircle2 className="w-4 h-4 inline text-green-400 mr-1" /> Immune to
                      voltage drop over long cable runs
                    </li>
                    <li>
                      <CheckCircle2 className="w-4 h-4 inline text-green-400 mr-1" />{' '}
                      Self-diagnostic (0mA = fault)
                    </li>
                    <li>
                      <CheckCircle2 className="w-4 h-4 inline text-green-400 mr-1" /> Two-wire power
                      + signal possible
                    </li>
                    <li>
                      <CheckCircle2 className="w-4 h-4 inline text-green-400 mr-1" /> Industry
              ...
              <div className="bg-background/50 rounded-lg p-4 border border-green-500/30">
                ...
                <div className="space-y-3 text-sm text-muted-foreground">
                  <div className="bg-background/70 rounded p-3">
                    ...
                    <p className="text-muted-foreground text-xs mt-2">
                      Simple scaling but no built-in fault detection (0V could be fault or true
                      zero).
                    </p>
                  </div>
                  <ul className="space-y-1">
                    <li>
                      <CheckCircle2 className="w-4 h-4 inline text-green-400 mr-1" /> Simple to
                      implement and measure
                    </li>
                    <li>
                      <CheckCircle2 className="w-4 h-4 inline text-green-400 mr-1" /> Common for
                      HVAC and drives
                    </li>
                    <li>
                      <CheckCircle2 className="w-4 h-4 inline text-green-400 mr-1" /> Low-cost
                      transmitters available
                    </li>
                    <li>
                      <AlertTriangle className="w-4 h-4 inline text-yellow-400 mr-1" /> Susceptible
                      to voltage drop on long runs
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="bg-background/50 rounded-lg p-4 border-l-2 border-elec-yellow">
              <h4 className="text-elec-yellow font-semibold mb-3">
                Analogue Resolution and Scaling
              </h4>
              <div className="text-sm text-muted-foreground space-y-2">
                <p>
                  <strong className="text-foreground">Resolution:</strong> Determined by the ADC/DAC
                  bit depth. Common values:
                </p>
                <ul className="ml-4 space-y-1">
                  <li>
                    <strong>12-bit:</strong> 4096 counts (0-4095), ~0.024% resolution
                  </li>
                  <li>
                    <strong>14-bit:</strong> 16384 counts, ~0.006% resolution
                  </li>
                  <li>
                    <strong>16-bit:</strong> 65536 counts, ~0.0015% resolution
                  </li>
                </ul>
                <div className="bg-background/70 rounded p-3 mt-3">
                  <strong className="text-elec-yellow">
                    Example Calculation (4-20mA, 12-bit, 0-100 degrees C):
                  </strong>
                  <p className="mt-1 font-mono text-xs">
                    If raw count = 2048 (50% of 4095)
                    <br />
                    Signal = 4 + (16 x 0.5) = 12mA
                    <br />
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              <div className="flex items-start gap-2">
                <Info className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                <div className="text-sm text-muted-foreground">
                  <strong className="text-blue-400">Wiring Tip:</strong> For 4-20mA signals, use
                  shielded twisted-pair cable with the shield grounded at one end only (typically
                  the PLC end). This prevents ground loops while providing EMI protection.
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground">
              Choosing between modular and compact PLCs impacts cost, flexibility, and future
              expandability. Both have valid use cases depending on application requirements.
            </p>
            ...
            <div className="bg-background/50 rounded-lg p-4">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div className="space-y-2">
                  <p className="text-muted-foreground">
                    <strong className="text-foreground">I/O Count:</strong> &lt;50 points = compact,
                    &gt;100 = consider modular
                  </p>
                  <p className="text-muted-foreground">
                    <strong className="text-foreground">Expansion Needs:</strong> Future growth?
                    Choose modular
                  </p>
                  <p className="text-muted-foreground">
                    <strong className="text-foreground">Budget:</strong> Compact typically 30-50%
                    lower initial cost
                  </p>
                </div>
                <div className="space-y-2">
                  <p className="text-muted-foreground">
                    <strong className="text-foreground">Spare Parts:</strong> Modular = replace only
                    failed module
                  </p>
                  <p className="text-muted-foreground">
                    <strong className="text-foreground">Special I/O:</strong> High-speed counters,
                    thermocouple inputs &rarr; modular
                  </p>
                  <p className="text-muted-foreground">
                    <strong className="text-foreground">Processing Power:</strong> Complex maths,
                    large programs &rarr; modular CPUs
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground">
              Proper wiring practices ensure reliable operation, easier troubleshooting, and
              compliance with safety standards. These guidelines apply to all PLC brands and
              installations.
            </p>
            ...
            <div className="space-y-4">
              <div className="bg-background/50 rounded-lg p-4 border-l-4 border-green-500">
                <h4 className="text-green-400 font-semibold mb-2">
                  Wire Colour Standards (24VDC Systems)
                </h4>
              ...
              <div className="bg-background/50 rounded-lg p-4 border-l-4 border-blue-500">
                ...
                <ul className="text-sm text-muted-foreground space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Keep 24VDC control wiring separate from AC power cables (min 100mm or separate
                      trunking)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      Use shielded cable for analogue signals, shield grounded at PLC end only
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      Cross power and signal cables at 90 degree angles when they must cross
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      VFD output cables: Use shielded motor cable, keep away from other signals
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-background/50 rounded-lg p-4 border-l-4 border-purple-500">
                ...
                <ul className="text-sm text-muted-foreground space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
                    <span>
                      Label both ends of every wire with matching designators (e.g., "DI-001")
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="w-4 h-4 text-green-400 flex-shrink-0 mt-0.5" />
              ...
              <div className="bg-background/50 rounded-lg p-4 border-l-4 border-orange-500">
                ...
                <div className="text-sm text-muted-foreground space-y-2">
                  <p className="mb-2">
                    Always install suppression devices to protect outputs and reduce EMI:
                  </p>
                  <div className="grid md:grid-cols-2 gap-3">
                    <div className="bg-background/70 rounded p-3">
                      <strong className="text-elec-yellow">DC Loads:</strong>
                      <p className="text-xs mt-1">
                        Flyback diode across coil (cathode to positive)
                      </p>
                    </div>
                    <div className="bg-background/70 rounded p-3">
                      <strong className="text-elec-yellow">AC Loads:</strong>
                      <p className="text-xs mt-1">
                        RC snubber (0.1uF + 100 Ohm) or MOV across coil
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-muted-foreground mt-1">
                    E-stop circuits and safety functions must be hardwired through safety relays or
                    safety PLCs - never through standard PLC logic alone. Follow IEC 62443 and
                    relevant machinery directives for safety circuit design.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="bg-elec-yellow/5 border border-elec-yellow/30 rounded-lg p-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <h4 className="text-foreground font-semibold border-b border-white/20 pb-1">
                Sinking vs Sourcing Match
              </h4>
              <div className="text-sm text-muted-foreground space-y-1">
                <p>
                  <span className="text-elec-yellow">PNP sensor (sourcing)</span> &rarr; Sinking
                  input
                </p>
                <p>
                  <span className="text-elec-yellow">NPN sensor (sinking)</span> &rarr; Sourcing
                  input
                </p>
                <p className="text-xs mt-1">Opposites attract: source matches sink</p>
              </div>

              <h4 className="text-foreground font-semibold border-b border-white/20 pb-1 pt-2">
                Analogue Signal Maths
              </h4>
            ...
            <div className="space-y-3">
              ...
              <div className="text-sm text-muted-foreground space-y-1">
                <p>
                  <span className="text-purple-400">Relay:</span> AC/DC loads, isolation needed
                </p>
                <p>
                  <span className="text-blue-400">Transistor:</span> DC loads, high speed, PWM
                </p>
                <p>
                  <span className="text-orange-400">Triac:</span> AC loads, solid-state reliability
                </p>
              </div>

              <h4 className="text-foreground font-semibold border-b border-white/20 pb-1 pt-2">
                Common I/O Address Formats
              </h4>
              <div className="text-sm font-mono bg-background/50 rounded p-2 text-muted-foreground">
          ...
          <div className="mt-4 pt-4 border-t border-white/20">
            ...
            <div className="flex flex-wrap items-center gap-2 text-sm">
              <span className="bg-elec-yellow text-background px-3 py-1 rounded font-medium">
                1. Read Inputs
              </span>
              <ArrowRight className="w-4 h-4 text-muted-foreground" />
              <span className="bg-blue-600 text-white px-3 py-1 rounded font-medium">
                2. Execute Program
              </span>
              <ArrowRight className="w-4 h-4 text-muted-foreground" />
              ...
              <ArrowRight className="w-4 h-4 text-muted-foreground" />
              <span className="bg-purple-600 text-white px-3 py-1 rounded font-medium">
                4. Housekeeping
              </span>
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            <p className="text-muted-foreground mb-4">
              Test your understanding of PLC architecture, I/O types, sinking vs sourcing, and
