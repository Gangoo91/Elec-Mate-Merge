...
const DESCRIPTION =
  'Learn to identify and diagnose common fibre optic faults including macrobends, microbends, connector failures, splice problems, and cable damage with their characteristic symptoms.';

const quickCheckQuestions = [
  {
    question:
      'What is the minimum bend radius typically specified for standard singlemode fibre during installation?',
    options: [
    ...
    explanation:
      'Standard singlemode fibre typically requires a minimum bend radius of 10-15× the cable outer diameter, usually around 15mm minimum. Bend-insensitive fibre (G.657) allows tighter bends down to 5-7.5mm.',
  },
  {
    ...
    explanation:
      'Longer wavelengths (1550nm) are more sensitive to bend losses than shorter wavelengths (1310nm). This is why bend loss testing is often performed at 1550nm or 1625nm to detect potential problems.',
  },
  {
    ...
    explanation:
      'Contaminated end-faces cause increased insertion loss (signal attenuation) and, particularly with APC connectors, increased reflectance (back-reflection). Severe contamination can cause complete failure.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      ...
      {
        text: 'Light escaping the core due to angle changes exceeding critical angle',
        isCorrect: true,
      },
    ...
    explanation:
      'When fibre is bent too tightly, the angle at which light hits the core/cladding boundary can exceed the critical angle required for total internal reflection, causing light to escape into the cladding and be lost.',
  },
  {
    ...
    options: [
      ...
      {
        text: 'Microbends are small, localised distortions along the fibre length',
        isCorrect: true,
      },
    ...
    explanation:
      'Microbends are small, localised axis deformations caused by pressure points, rough surfaces, or manufacturing defects. Unlike macrobends (visible curves), microbends are typically too small to see but cause cumulative loss.',
  },
  {
    ...
    explanation:
      'High reflectance is caused by air gaps between mated connectors (from contamination, damage, or incomplete seating) or from damaged/contaminated end-face surfaces that prevent proper physical contact.',
  },
  {
    ...
    explanation:
      'Fusion splices appear as small loss events (typically 0.02-0.1 dB) with little or no reflectance because there is no air gap at the joint. Mechanical splices show similar loss but with more reflectance.',
  },
  {
    question:
      'What symptom indicates stress on a fibre cable that may not have caused immediate failure?',
    options: [
    ...
    explanation:
      'Stressed fibre (from bending or crush) shows increased loss at longer wavelengths (1550nm, 1625nm) compared to shorter wavelengths. This wavelength-dependent loss is a key indicator of bend-related problems.',
  },
  {
    question:
      'What type of damage is most likely if a fibre link shows intermittent failures that vary with temperature?',
    options: [
      { text: 'Connector contamination', isCorrect: false },
      { text: 'Fibre break', isCorrect: false },
      {
        text: 'Poor splice or stress point that expands/contracts with temperature',
        isCorrect: true,
      },
      { text: 'Wrong fibre type installed', isCorrect: false },
    ],
    explanation:
      'Temperature-related intermittent faults often indicate stress points (tight bends, crush damage) or poor splices where thermal expansion and contraction causes the fault to appear and disappear.',
  },
  {
    ...
    options: [
      ...
      {
        text: 'Gradual weakening of glass from sustained stress, leading to eventual fracture',
        isCorrect: true,
      },
    ...
    explanation:
      'Fibre fatigue is the slow growth of microscopic cracks in stressed glass fibre. Even stress below the immediate breaking point can cause gradual crack propagation, eventually leading to fibre breakage.',
  },
  {
    ...
    options: [
      ...
      {
        text: 'Testing from one direction through a splice between different fibre types',
        isCorrect: true,
      },
    ...
    explanation:
      'A gainer (apparent gain) occurs when splicing fibres with different backscatter coefficients. Testing from the fibre with lower backscatter into higher backscatter fibre makes the splice appear to add power. Bi-directional averaging resolves this.',
  },
  {
    ...
    explanation:
      'Damage to the fibre core area (chips, cracks, deep scratches across the core) causes the highest loss because it directly affects light transmission. Damage outside the core area has less impact.',
  },
  {
    ...
    explanation:
      'Industry studies consistently show that connector contamination is the leading cause of fibre link problems. Proper cleaning and inspection practices prevent the majority of field failures.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Use a visual fault locator (VFL) or light source to verify the fibre path is continuous. Then swap transceivers or use known-good equipment at each end. If the problem persists with different equipment, the fault is in the cabling. An OTDR can pinpoint the exact location of fibre faults.',
  },
  {
    question: 'Why does my link work sometimes but not others?',
    answer:
      'Intermittent faults are often caused by: contaminated connectors that vary with mating pressure; loose connections that shift with vibration or temperature; stressed fibre at a bend or crush point that changes with temperature; or damaged connectors with poor alignment. Systematic testing under different conditions helps identify the cause.',
  },
  {
    question: "What's the difference between insertion loss and return loss?",
    answer:
      'Insertion loss (IL) measures how much optical power is lost passing through a connector or component (expressed in dB, lower is better). Return loss (RL) measures how much light is reflected back towards the source (expressed in dB, higher is better). Both affect link performance.',
  },
  {
    question: "Can a fibre be repaired if it's broken?",
    answer:
      'Yes, a broken fibre can be repaired using fusion splicing. The break point is cut back to clean fibre on each side, the ends are cleaved, and then fusion spliced. A good fusion splice adds only 0.02-0.1 dB loss. For permanent repairs, splice enclosures protect the joint.',
  },
  {
    question: 'Why is bend loss worse at 1550nm than 1310nm?',
    answer:
      'Longer wavelengths have a larger mode field diameter (the area where light travels in the fibre). This makes them more sensitive to bends because more of the light is travelling closer to the core/cladding boundary where it can escape during bends.',
  },
  {
    question: "What causes fibre to 'go dark' suddenly after working for years?",
    answer:
      'Sudden failures after long service are often caused by: accumulated stress finally breaking the fibre (fatigue failure); environmental damage (water, rodents, dig-ups); connector degradation from repeated mating cycles; or thermal stress from temperature extremes. OTDR testing reveals the failure location and type.',
  },
];
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white/80 mb-6">
              <p>
                ...
                from the core because the angle of incidence exceeds the critical angle for total
                internal reflection.
              </p>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white/80 mb-6">
              <p>
                ...
                coupling light from guided modes into cladding modes that are lost.
              </p>
            </div>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4 mb-6">
              ...
              <p className="text-white/70 text-sm">
                ...
                1310nm, suspect bend-related problems.
              </p>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white/80 mb-6">
              <p>
                ...
                failure modes helps prevent and diagnose problems.
              </p>
            </div>
            ...
            <div className="bg-[#252525] rounded-lg p-5 border border-white/10 mb-6">
              <h4 className="font-semibold text-white mb-4">
                End-Face Inspection Zones (IEC 61300-3-35)
              </h4>
          ...
          <section className="mb-12">
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4 mb-6">
              ...
              <p className="text-white/70 text-sm">
                ...
                eventually resulting in sudden fibre failure. This is why proper bend radius and
                cable support are critical for long-term reliability.
              </p>
            </div>
          </section>
