  ...
  const quizQuestions = [
    {
      ...
      options: [
        'A type of locking cable connector used on instrument racks',
        'A dedicated protective device fitted at the earth bar',
        'Multiple ground points at different potentials causing current to flow',
        'A calibration technique for differential transmitters',
      ],
      correct: 2,
      explanation:
        'A ground loop occurs when multiple earth connections sit at slightly different potentials, driving unwanted current through signal cables and creating noise.',
    },
    {
      id: 2,
      question: 'Which type of cable is best for reducing electromagnetic interference on a signal?',
      options: [
        'Unshielded twisted pair',
        'Shielded cable with a drain wire',
        'Plain single-conductor cable',
        'Standard coaxial power cable',
      ],
      correct: 1,
      explanation:
        'Shielded cable with a drain wire contains external electric fields and gives induced currents a low-impedance path to earth, protecting the signal from interference.',
    },
    {
      id: 3,
      question: 'How should a cable shield typically be grounded for a low-frequency signal?',
      options: [
        'At both ends in every case',
        'At one end only, to prevent a ground loop',
        'At no point along its length',
        'At whichever end is most convenient to reach',
      ],
      correct: 1,
      explanation:
        'For low-frequency signals, the shield is earthed at one end only to avoid a ground loop. High-frequency applications may need both ends bonded for effective screening.',
    },
    {
      id: 4,
      question: 'What is common mode noise?',
      options: [
        'Noise that appears differently on each signal wire',
        'Noise caused purely by mechanical vibration of the cable',
        'Interference confined to the audio frequency band',
        'Noise that appears equally on both signal wires relative to earth',
      ],
      correct: 3,
      explanation:
        'Common mode noise appears equally on both conductors relative to earth and can be rejected by a differential amplifier with a good common mode rejection ratio (CMRR).',
    },
    {
      id: 5,
      question: 'Why should signal cables be separated from power cables?',
      options: [
        'To save physical space in the cable tray',
        'To make cable identification easier on site',
        'To prevent electromagnetic coupling and interference',
        'To reduce the overall installation cost',
      ],
      correct: 2,
      explanation:
        'Power cables generate electromagnetic fields that couple into nearby signal cables and cause interference; physical separation reduces this coupling significantly.',
    },
  ];
    ...
    <div className="bg-background">
      ...
      <div className="px-4 py-6 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-3 pt-6 border-t border-border">
          ...
          <Link to="/electrician/upskilling/instrumentation-module-4" className="w-full sm:w-auto">
