...
const inlineChecks = [
  {
    id: 'm8s7-oat-sensor',
    question: 'What is the Outside Air Temperature (OAT) sensor + why is it electrically wired?',
    options: [
  ...
  },
  {
    ...
    question: 'OpenTherm vs EBus vs manufacturer-proprietary controls — what are they?',
    options: [
  ...
  {
    id: 'm8s7-zone-valves',
    question: 'Zone valves + multi-zone heating — what does the electrical installer wire?',
    options: [
  ...
  },
  {
    ...
    question: 'Smart meter integration with heat pump for time-of-use tariff optimisation?',
    options: [
...
const quizQuestions = [
  {
    question: 'Standard UK 2025-26 heat pump controls install — what wiring scope?',
    options: [
  ...
  {
    question: 'OAT sensor mounting — what location is correct vs incorrect?',
    options: [
  ...
  {
    question: 'Wiring centre + heat pump install — what is it + where?',
    options: [
  ...
  {
    question: 'Customer-facing controller / app — what does the electrical installer commission?',
    options: [
...
export default function RenewableEnergyModule8Section7() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 8 · Section 7 · Controls + electrical interface · Operational layer above BS 7671"
        title="Controls + electrical interface"
        backTo="../renewable-energy-module-8"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Heat pump control system electrical scope — Outside Air Temperature (OAT) sensor, weather
          compensation, OpenTherm / EBus / proprietary protocols, zone valves + wiring centre,
          smart-meter integration + time-of-use tariff coordination, customer-facing controller +
          app.
        </p>
        ...
        <Pullquote>
          Controls are where the heat pump install meets the customer’s daily experience. The wiring
          is small-conductor low-current; the customer-facing impact is everything.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Sensor type</strong> — NTC thermistor typical (negative
              temperature coefficient — resistance drops as temperature rises). 10 kΩ at 25 °C
              reference is the manufacturer standard. Some manufacturers use proprietary sensors —
              match to model
            </li>
            <li>
              <strong className="text-white">Cable</strong> — 2-core LV screened cable (0.5-0.75 mm²
              conductor typical). Screen earthed at one end (controller end). Resistance over the
              cable run adds to sensor impedance — long runs may need calibration adjustment
            </li>
            <li>
              <strong className="text-white">Mounting location</strong> — north or east wall (shaded
              from south-westerly sun in UK); 2-3 m from outdoor unit (avoid unit-affected air);
              away from kitchen / dryer / bathroom vents; at least 1 m above ground; exposed to
              genuine outdoor ambient
            </li>
            <li>
              <strong className="text-white">Mounting hardware</strong> — typically a small
              enclosure with cable entry gland, screwed to the wall. IPX4 minimum (splash
              resistance). Bracket holds sensor 50-100 mm off the wall to avoid wall thermal mass
              effect
            </li>
            <li>
              <strong className="text-white">Avoid INCORRECT locations</strong> — south-facing in
              direct sun (false high in summer — controller thinks outdoor warmer); near extract
              vents (false high from warm exhaust); behind cladding (reads building fabric); inside
              porch / sheltered area (reads false warm)
            </li>
            <li>
              <strong className="text-white">Functional verification at commissioning</strong> —
              compare sensor reading to a known thermometer in open air at commissioning. ±1 °C
              typical acceptable. If reading deviates significantly: investigate location + cable +
              connections
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — sensor model + cable
              type + length + mounting location photograph + commissioning verification reading
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Outdoor temperature range</strong> — typically -10 °C
              to +20 °C across the curve
            </li>
            <li>
              <strong className="text-white">Primary flow range</strong> — typically 30 °C (mild
              outdoor) to 55 °C (very cold outdoor). Lower flow temperature = higher COP
            </li>
            <li>
              <strong className="text-white">Curve slope</strong> — steeper for poor insulation
              (more compensation as outdoor drops); shallower for good insulation (less compensation
              needed)
            </li>
            <li>
              <strong className="text-white">Parallel shift</strong> — vertical offset of the curve.
              Customer adjusts via "comfort" or "temperature" control to fine-tune indoor
              temperature during the heating season
            </li>
            <li>
              <strong className="text-white">Design temperature</strong> — point on curve where
              building reaches its design indoor temperature at design outdoor temperature
              (typically -3 °C to -5 °C UK design outdoor). MCS sizing process determines
            </li>
            <li>
              <strong className="text-white">First-season tuning</strong> — installer / customer
              adjusts curve over the first heating season based on comfort + bill experience. Many
              installers schedule a 6-month review visit
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — initial curve
              configuration + design temperature + customer comfort temperature setpoint +
              post-tuning curve if revisited
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          OpenTherm is the open door. EBus is the Vaillant garden. Daikin / Mitsubishi / NIBE are
          their own walled cities. The customer’s thermostat choice depends on which gate is open.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">OpenTherm</strong> — open standard developed by
              Honeywell, now industry-supported. 2-wire bidirectional. Widely third-party thermostat
              compatible (Tado, Nest 3rd gen + Learning + Heat Link, Hive, Honeywell evohome,
              Drayton Wiser, Worcester Bosch Wave, Salus). UK 2025-26 OpenTherm-compatible heat
              pumps: Vaillant aroTHERM Plus (some), Worcester Bosch (some), Viessmann Vitocal
              (some). Verify per model
            </li>
            <li>
              <strong className="text-white">EBus</strong> — Vaillant + Bosch proprietary 2-wire.
              Higher-bandwidth than OpenTherm; supports advanced control features. Restricted to
              vendor-compatible thermostats (Vaillant multiMATIC, Bosch CT200)
            </li>
            <li>
              <strong className="text-white">Daikin proprietary</strong> — P1/P2 2-wire bus. Daikin
              Onecta thermostats + interface. Daikin Onecta app integration
            </li>
            <li>
              <strong className="text-white">Mitsubishi MELCloud</strong> — Wi-Fi-based for app
              integration; MELCloud app + MELCloud WiFi adapter (WF-RAC); remote controller
              hard-wired separately (PAR-32MAA / PAR-21MAA series). Older Mitsubishi protocols
              proprietary
            </li>
            <li>
              <strong className="text-white">NIBE myUplink</strong>— proprietary 2-wire bus + Wi-Fi
              for app. Restricted to NIBE accessories
            </li>
            <li>
              <strong className="text-white">Hybrid integrations</strong>— some heat pumps support
              both OpenTherm + manufacturer bus simultaneously; customer can use either. Less common
            </li>
            <li>
              <strong className="text-white">Cable + wiring</strong>— 2-core LV screened (typically
              0.5-0.75 mm² conductor) for any protocol; screen earthed at one end. Run length limits
              per manufacturer spec
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — protocol declared +
              chosen thermostat + commissioning verification of communication
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Zone valve type</strong> — 2-port spring-return motor
              typical (Honeywell V4043, Drayton ZV2, Esbe SRZ). 230 V AC coil; spring closes valve
              on de-energise. Auxiliary switch confirms valve open before primary flow
            </li>
            <li>
              <strong className="text-white">Zone valve flex</strong> — 5-core 0.75 mm² flex from
              each zone valve back to wiring centre. L, N, E, control wire (energises coil),
              auxiliary switch return wire
            </li>
            <li>
              <strong className="text-white">Wiring centre</strong> — Honeywell ST9420C
              (single-channel) or ST9520C (two-channel) typical UK 2025-26 product. Drayton wiring
              centre equivalent. Houses terminal strip + neutral / earth bus + relays for zone valve
              control
            </li>
            <li>
              <strong className="text-white">Thermostat wiring</strong> — wired thermostat 2-3 core
              LV to wiring centre. Wireless thermostat via receiver / wiring centre (battery
              transmitter at thermostat + plug-in receiver near wiring centre)
            </li>
            <li>
              <strong className="text-white">Heat pump controller integration</strong> — protocol
              cable (OpenTherm / EBus / proprietary) from wiring centre to heat pump controller.
              Wiring centre relays the zone demand to compressor + opens relevant zone valve
            </li>
            <li>
              <strong className="text-white">Functional test sequence</strong> — at commissioning,
              exercise each zone individually: thermostat call → wiring centre relay → zone valve
              coil energises → spring opens valve → auxiliary switch confirms → primary flow
              directed; on demand-met: valve de-energises → spring closes → auxiliary switch returns
              → primary flow re-directed
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — wiring centre product +
              zone valve product per zone + thermostat per zone + functional test result per zone
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">ALCS</strong> — Auxiliary Load Control Switch. Relay
              output from SMETS2 smart meter / IHD. Signals cheap-tariff hours via contact closure
            </li>
            <li>
              <strong className="text-white">ALCS wiring</strong> — from smart meter / IHD to heat
              pump controller dedicated input. 2-core LV signal cable. Heat pump controller
              schedules accordingly
            </li>
            <li>
              <strong className="text-white">Wi-Fi tariff API</strong> — heat pump controller on
              customer’s Wi-Fi reads live tariff prices from the energy supplier’s API. UK 2025-26
              emerging for some controllers (Mixergy app, Vaillant multiMATIC with smart tariff
              plugin)
            </li>
            <li>
              <strong className="text-white">Octopus Cosy</strong>— 3 cheap-tariff windows per day
              at specific hours (changes seasonally). Heat pump compressor + immersion priority
              during windows
            </li>
            <li>
              <strong className="text-white">Octopus Heat Pump tariff</strong> — dedicated heat pump
              MPAN; entire heat pump load on a separate meter at lower continuous rate. Higher
              install complexity (separate metering) but largest savings
            </li>
            <li>
              <strong className="text-white">Cylinder over-heat strategy</strong> — during cheap
              hours, controller heats cylinder to 65-70 °C (above normal 60 °C). Stored heat coasts
              through expensive hours
            </li>
            <li>
              <strong className="text-white">Not BS 7671 normative</strong> — tariff integration is
              operational. The smart meter + ALCS wiring is electrical scope; the tariff itself is
              customer-supplier agreement
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — tariff in use + smart
              meter MPAN + ALCS wiring (if applicable) + Wi-Fi integration verified + customer
              education
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-8-section-6')}
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-8-section-8')}
