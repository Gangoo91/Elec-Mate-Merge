...
const PATTestingModule3Section1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="PAT M3 · Section 1"
        title="Cable and plug damage checks"
        backTo="/electrician/upskilling/pat-testing-module-3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The formal visual inspection — sheath integrity, cord grip, pin condition and IEC
          connector checks. The single highest-yield step in any PAT regime.
        </p>
        ...
        >
          <p>
            IET Code of Practice for In-service Inspection and Testing of Electrical Equipment, 5th
            Edition (2020), Chapter 15 lists the formal visual inspection items. HSG107 (HSE)
            endorses the same approach — the formal visual inspection is the principal fault-finding
            stage of an in-service inspection regime. Electrical testing exists to verify what
            cannot be seen (insulation resistance, earth continuity numerics, leakage under load).
          </p>
          <p>
            The CoP names the items to check on every inspection: damage to the flex, damage to the
            plug, damage to the appliance, signs of overheating, evidence of unauthorised
        ...
        >
          <p>
            ...
            damage that exposes the inner cores or their insulation is a fail. A surface scuff that
            has not penetrated the sheath is recorded as wear and may be acceptable in a low-risk
            environment, but a cut, split, or crush mark that exposes the cores is failed at the
            visual stage.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Crush marks across the sheath</strong> — chair leg, trolley wheel, door being
              closed on the flex. The conductors may be damaged inside even if the sheath looks
              intact. Inspect carefully.
            </li>
            <li>
              <strong>Melted or hardened sheath</strong> — heat exposure. Investigate the
              environment (Section 4) — the lead may be wrong for the location, or the appliance may
              be over-heating.
            </li>
            <li>
            ...
            <li>
              <strong>Sheath stretched at the cord grip</strong> — the flex has been pulled and the
              cord grip is no longer on undamaged sheath. Replace, do not re-clamp.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Insulation taken back the correct distance — short enough that bare conductor does not
              protrude beyond the terminal, long enough that the insulation is not crushed under the
              screw.
            </li>
            <li>
              Cores not crossed inside the plug — line on the right with the plug face down (BS 1363
              fused side), neutral on the left, earth at the top.
            </li>
            <li>
              Earth conductor longest inside the plug, so that if the cord grip ever lets go, L and
              N pull out before earth.
            </li>
          </ul>
          <p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <line
              ...
              strokeWidth="1"
            />
            <text x="272" y="178" textAnchor="end" fill="#3B82F6" fontSize="10.5" fontWeight="bold">
              Neutral pin (N)
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="421" y="282" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              BS 1362
            </text>
            ...
            <line
              ...
              strokeWidth="1"
            />
            <text x="272" y="260" textAnchor="end" fill="#FBBF24" fontSize="10.5" fontWeight="bold">
              BS 1362 fuse
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="420" y="402" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="9.5">
              strain relief
            </text>
            ...
            <line
              ...
              strokeWidth="1"
            />
            <text x="272" y="396" textAnchor="end" fill="#FBBF24" fontSize="10.5" fontWeight="bold">
              Sheath entry
            </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Earth pin longer than L/N pins.</strong> First to make contact when inserted,
              last to break when withdrawn. A bent or short earth pin is a fail.
            </li>
            <li>
              <strong>L and N pins half-sleeved.</strong> The half closest to the plug body is
              insulated so that finger contact during partial insertion cannot bridge live metal. A
              worn or missing sleeve is a fail.
            </li>
            <li>
              <strong>BS 1362 fuse fitted, rating clearly visible.</strong> 3 A or 13 A are the two
              domestic ratings; 5 A is also permitted for certain appliances. The rating must match
              the flex (next section).
            </li>
            <li>
            ...
            <li>
              <strong>Plug body intact.</strong> No cracks, no missing chunks of moulded plastic, no
              exposure of internal metalwork through the body.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The line and neutral pins of a 13 A plug shall be partially insulated such that, when
              the plug is partially withdrawn, accidental contact with a live conductor by a finger
              is prevented. The earth pin shall be of greater length than the line and neutral pins.
              The plug shall be fitted with a means of cable retention (cord anchorage) that grips
              the outer sheath of the flexible cord, and the cable anchorage shall not depend on the
              conductors for its action.
            </>
          }
        ...
        <ContentEyebrow>Pin condition — what oxidation, pitting and arcing tell you</ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              usually acceptable. In damp environments it is a flag — the pin is at the start of the
              corrosion sequence.
            </li>
            <li>
              <strong>Green-brown discolouration.</strong> Moisture corrosion. Contact resistance is
              rising. The plug fails on this. Inspect the matching socket — the same corrosion is
              likely on the socket contacts.
            </li>
            <li>
              <strong>Pitting / black spots / scorched plug body around the pin.</strong> Arcing.
              The plug has been making and breaking under load with poor contact, or the socket has
              been worn. Fail the plug; flag the socket for fixed-wiring inspection.
            </li>
          </ul>
          <p>
            Pin alignment matters too. A pin that is bent, splayed or twisted out of true is a fail
            — the BS 1363 dimensional tolerance is tight, and a misaligned pin will not seat cleanly
            in a compliant socket. The result is the same: rising contact resistance, heat, eventual
            failure.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              body cracks, pin pitting (especially L), scorching at the appliance inlet, latch clip
              on the lead end intact (where fitted), no missing pins.
            </li>
            <li>
            ...
            <li>
              ...
              bricks. Inspect: all three pins present (some counterfeit cables omit the earth), body
              intact, no scorching.
            </li>
            <li>
              <strong>C7 / C8 (2.5 A, 70 °C) — the figure-of-eight.</strong> Two-pin only — used on
              Class II equipment. Body integrity, pin pitting, no scorching.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              without damage the mechanical and thermal stresses likely to occur in normal service.
              After the test of resistance to abnormal heat and to fire, the sample shall show no
              damage that impairs further safe use.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>Cracked or broken plug body, broken / missing pins, scorched body around pins.</li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              that fails the visual inspection should be removed from service immediately and should
              not be subject to combined inspection and testing until it has been repaired and the
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>Action taken (passed, repaired and re-inspected, replaced, failed and removed).</li>
            <li>
          ...
          <p>
            Modern PAT testers store these as fields in their internal database, but the duty-holder
            is the owner of the register — the data should be exported and held in the workplace
            records, not only in the tester memory.
          </p>
        </ConceptBlock>
