...
const DESCRIPTION =
  'Understand Class I equipment and protective earthing, including how earth continuity works, testing requirements, and common failures in earthed appliances.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Class I equipment relies on basic insulation for normal protection, with protective earthing providing safety in case the basic insulation fails.',
  },
  {
    id: 'm2s2-check2',
    question:
      'What is the maximum acceptable earth continuity resistance for most Class I appliances?',
    options: ['0.05 ohms', '0.1 ohms', '1.0 ohms', '2.0 ohms'],
    correctIndex: 1,
    explanation:
      'The maximum earth continuity resistance is typically 0.1 ohms for Class I appliances, ensuring effective fault current flow for rapid disconnection.',
  },
  {
    id: 'm2s2-check3',
    ...
    correctIndex: 1,
    explanation:
      'If the earth connection fails, Class I equipment may continue to operate normally, but if a fault develops, the metal casing could become live and dangerous.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'The maximum earth continuity resistance is typically 0.1 ohms for Class I appliances.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Class I equipment requires three-core cables to provide live, neutral, and earth conductors, with the earth being essential for safety.',
  },
  {
    id: 4,
    question: 'What happens if the earth connection fails in Class I equipment?',
    ...
    correctAnswer: 1,
    explanation:
      'If the earth connection fails, Class I equipment may continue to operate normally, but becomes dangerous if a fault develops.',
  },
  {
    id: 5,
    ...
    correctAnswer: 2,
    explanation:
      'Both tests are critical: earth continuity ensures the safety path works, while insulation resistance confirms the basic insulation is intact.',
  },
  {
    id: 6,
    question: 'What test current is typically applied during earth continuity testing?',
    options: ['1A or 5A', '10A or 25A', '100A or 200A', '500mA or 1A'],
    correctAnswer: 1,
    explanation:
      'Earth continuity testing typically uses a test current of 10A or 25A to measure the resistance accurately.',
  },
  {
    id: 7,
    ...
    correctAnswer: 3,
    explanation:
      'Excessive cable length is not a failure but may require adjusted limits. Common failures include broken conductors, loose connections, and corrosion.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Power tools with metal cases, kettles, and industrial equipment commonly use Class I protection with protective earthing.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Protective earthing creates a low-impedance path for fault current, enabling rapid automatic disconnection before shock can occur.',
  },
  {
    id: 10,
    ...
    correctAnswer: 2,
    explanation:
      'Class I equipment is identified by the earth symbol, indicating it requires connection to protective earth.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Earth continuity is the primary backup protection in Class I equipment. If basic insulation fails, the earth path carries fault current to trip the protective device rapidly. Without a good earth connection, the metal case could become live and remain so, creating a serious shock hazard.',
  },
  {
    question: 'Can Class I equipment work without an earth connection?',
    answer:
      'Yes, Class I equipment will typically continue to operate normally without an earth connection. However, this makes it extremely dangerous because if an insulation fault occurs, there is no protection against electric shock. This is why earth continuity testing is essential.',
  },
  {
    question: 'What is the difference between earth continuity and insulation resistance tests?',
    answer:
      'Earth continuity tests verify the protective earth path is intact with low resistance. Insulation resistance tests verify the basic insulation between live parts and accessible metalwork is intact. Both are needed for complete Class I equipment safety verification.',
  },
  {
    question: 'How often should Class I equipment be PAT tested?',
    answer:
      'Testing frequency depends on the environment and use. High-risk environments like construction sites may need 3-monthly testing, whilst office equipment might be tested annually. The IET Code of Practice provides guidance based on equipment type and environment.',
  },
  {
    question: 'What should I do if earth continuity fails but the equipment looks fine?',
    answer:
      'Never use equipment with failed earth continuity. Investigate the cause - it could be a broken internal conductor, loose connection in the plug, or corroded terminals. The equipment should be repaired and retested before returning to service.',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="mb-12">
          ...
          <p className="text-white">Understanding earthed equipment and earth continuity testing</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Protection:</strong> Basic insulation + earth path
              </li>
              <li>
                <strong>Cable:</strong> Three-core (L, N, E)
              </li>
              <li>
                <strong>Earth limit:</strong> 0.1 ohms maximum
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Metal case, 3-pin plug, earth symbol
              </li>
              <li>
                <strong>Use:</strong> Earth continuity + insulation tests required
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Class I equipment represents the most common type of electrical appliance found in
              workplaces and homes. These appliances rely on a dual protection system: basic
              insulation for normal operation and protective earthing as a safety backup.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The earth continuity path must have sufficiently low resistance to ensure effective
              fault current flow. PAT testing verifies this critical safety parameter.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Standard Equipment:</strong> Maximum 0.1 ohms (covers most Class I
                  appliances)
                </li>
                <li>
                  <strong>Heating Appliances:</strong> Maximum 0.1 ohms + 0.02 ohms per metre of
                  cable
                </li>
                <li>
                  <strong>IT Equipment:</strong> Maximum 0.1 ohms (same as standard)
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Step 1:</strong> Disconnect equipment from supply and remove any removable
                  parts
                </li>
                <li>
                  <strong>Step 2:</strong> Connect test leads between earth pin and accessible
                  earthed metalwork
                </li>
                <li>
                  <strong>Step 3:</strong> Apply test current (typically 10A or 25A) and measure
                  resistance
                </li>
                <li>
                  <strong>Step 4:</strong> Compare result against appropriate limit for equipment
                  type
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Understanding how earthing protection can fail helps PAT testers identify potential
              problems and emphasises the importance of regular testing.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Common Earth Path Failures
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                ...
                general wear. Regular PAT testing identifies these degradations before they
                compromise safety, ensuring the protective earthing system remains effective
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-elec-yellow text-sm font-medium mb-2">
                Case Study: Workshop Drill Earth Failure
              </p>
              <div className="text-sm text-white space-y-2">
                <p>
                  <strong>Situation:</strong> During routine PAT testing, a workshop drill shows
                  earth continuity of 2.5 ohms, well above the 0.1 ohm limit. The drill appears to
                  function normally and shows no visible damage.
                </p>
                <p>
                  <strong>Investigation:</strong> Further inspection reveals the earth conductor has
                  broken inside the cable near the plug due to repeated flexing, but the other
                  conductors remain intact.
                </p>
                <p>
                  <strong>The Risk:</strong> If an insulation fault developed, the metal drill case
                  could become live at mains voltage with no protective disconnection occurring.
                </p>
                <p>
                  <strong>The Action:</strong> The drill was immediately removed from service and
                  the cable replaced, restoring earth continuity to 0.05 ohms.
                </p>
                <p>
                  <strong>The Lesson:</strong> Equipment can appear and function normally whilst
                  having dangerous earth path failures - only PAT testing reveals these hidden
                  hazards.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Testing Class I Equipment
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Skipping earth test for working equipment</strong> - equipment can
                  function with broken earth
                </li>
                <li>
                  <strong>Only testing earth pin</strong> - test to actual earthed metalwork
                </li>
                <li>
                  <strong>Ignoring borderline results</strong> - investigate any readings close to
                  the limit
                </li>
                <li>
                  <strong>Not flexing cables during test</strong> - intermittent faults may not show
                </li>
              </ul>
            </div>
          </div>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/electrician/upskilling/pat-testing-module-2-section-1">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous Section
            </Link>
          </Button>
          <Button
            ...
            asChild
          >
            <Link to="/electrician/upskilling/pat-testing-module-2-section-3">
              Next Section
