    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The most common construction for mains-powered equipment with metal casings. Basic
          insulation as the first line of defence; CPC bonding + automatic disconnection as the
          second. Get the CPC wrong and Class I silently reverts to Class 0.
        </p>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Basic insulation fails.</strong> A live conductor inside the equipment touches
              a metal part — most commonly the casing, the heating element shroud, or a metal trim
              element. Cause: thermal stress, mechanical damage, moisture ingress, age.
            </li>
            <li>
            ...
            <li>
              ...
              operates within its rated time (≤ 40 ms at I&Delta;n typically). The supply is removed
              before the user can be injured.
            </li>
            <li>
          ...
          <p>
            ...
            during the fault is exposed to a brief, low-voltage event rather than a sustained 230 V
            shock. That is Class I doing its job.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              The internal terminal at the equipment, where the green-and-yellow conductor lands on
              the equipment\'s earth point.
            </li>
            <li>
          ...
          <p>
            A defect anywhere in this chain inflates the reading. Typical defect locations (in order
            of frequency): loose conductor at the plug terminal, broken / loose conductor at the
            equipment internal earth point, corroded plug pin, broken internal bonding conductor in
            the chassis, undersize earth conductor used in a flex repair.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="395" y="134" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              L
            </text>
            <circle cx="421" cy="146" r="3.5" fill="#3B82F6" />
            <text x="421" y="162" textAnchor="middle" fill="#3B82F6" fontSize="9" fontWeight="bold">
              N
            </text>
            <circle cx="408" cy="218" r="4.5" fill="#22C55E" />
            <text x="408" y="232" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              E pin
            </text>
            ...
            <rect
              ...
              strokeWidth="2"
            />
            <text x="670" y="98" textAnchor="middle" fill="#A855F7" fontSize="12" fontWeight="bold">
              CLASS I APPLIANCE
            </text>
            <text x="670" y="112" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9.5">
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="410" y="318" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="10.5">
            ...
            <text x="410" y="376" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="9.5">
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              construction, presence of CPC at plug). If Class I cannot be confirmed, do not proceed
              with this test.
            </li>
            <li>
            ...
            <li>
              ...
              conductive part — start with the most clearly bonded (the main casing) and then check
              additional accessible parts (handles, trims, switch plates, removable covers).
            </li>
            <li>
              <strong>Read result.</strong> The instrument displays the resistance in Ω. Compare to
              the acceptance value computed from cable length (0.1 + 0.001 × m).
            </li>
            <li>
            ...
            <li>
              <strong>Record the worst reading.</strong> The reading recorded for the equipment as a
              whole is the highest reading across all tested points — that is the part with the
              weakest bond, and it is the one that determines the equipment\'s Class I integrity.
            </li>
          </ol>
          <p>
            The PE-continuity test is fast (seconds per item with modern instruments) and decisive.
            A pass means the CPC path is intact end-to-end. A fail means the path is broken or has
            high resistance — Class I protection cannot be relied on.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The continuity of the protective conductor of Class I equipment shall be tested using
              a low-resistance ohmmeter or an instrument incorporating such a function. The maximum
              permissible resistance is 0.1 Ω plus the resistance of the flexible supply cable,
              taken as 1 mΩ per metre of cable length.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              The instrument manual usually specifies "soft test" mode or "Class IT" mode for these
              cases.
            </li>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              The instrument applies 500 V dc between the line and neutral pins (commoned together)
              and the earth pin.
            </li>
            <li>
              Read the result in MΩ. The acceptance value for Class I per IET CoP §15.5 is typically
              &ge; 1 MΩ (general) or &ge; 1 MΩ for portable equipment with heating element ≥ 3 kW.
              (Specific values consult IET CoP 5th Ed Table 15.2.)
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              incorporating filters, electronic devices or other circuits that make the measurement
              inappropriate, an alternative method (such as protective conductor / touch current)
              may be used.
            </>
          }
        ...
        <FAQ
          items={[
            ...
            {
              question: 'I have replaced the flex on a Class I appliance. What testing do I need?',
              answer:
