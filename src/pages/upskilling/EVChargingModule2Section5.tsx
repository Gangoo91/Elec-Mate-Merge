...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Since 2019, all Tesla vehicles sold in Europe use CCS2 (Combined Charging System Type 2) for DC charging and Type 2 for AC charging, complying with EU standardisation requirements.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      "Yes - install a socketed Type 2 outlet for maximum flexibility. This works with all European EVs for AC charging. For DC capability, you'd need to know the vehicle (CCS2 is standard for most new EVs in Europe).",
  },
  {
    question: 'Why do some vehicles charge slower than their maximum rated speed?',
    answer:
      "Actual charging speed depends on: battery temperature (cold batteries charge slower), state of charge (speed reduces above 80%), charger capability, and the vehicle's Battery Management System protecting battery health.",
  },
  {
    question: 'Should I recommend a three-phase supply upgrade for home charging?',
    answer:
      'Only if the customer has a vehicle that supports three-phase charging (BMW iX, Audi e-tron, etc.) and regularly needs faster home charging. Many EVs only support single-phase AC, making the upgrade unnecessary.',
  },
  {
    question: 'What about older EVs with CHAdeMO - are they still supported?',
    answer:
      'CHAdeMO infrastructure is declining but still available. Public rapid chargers often have both CCS and CHAdeMO. For home installation, focus on AC charging (Type 2) which all CHAdeMO vehicles support.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'A customer has a BMW iX and wants the fastest possible home charging. What would you recommend?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      "The BMW iX supports 22kW three-phase AC charging. A 22kW Type 2 installation maximises the vehicle's AC charging capability. DC rapid chargers are impractical for home use (cost, supply requirements), and slower options don't utilise the vehicle's full capability.",
  },
];
...
const EVChargingModule2Section5 = () => {
  useSEO({
    ...
    description:
      'Understand vehicle-specific charging requirements for Tesla, BMW, Volkswagen, Nissan, and other major EV manufacturers.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Europe:</strong> Type 2 AC + CCS2 DC standard
              </li>
              <li>
                <strong>Speeds vary:</strong> 3.7kW to 350kW by model
              </li>
              <li>
                <strong>Check vehicle:</strong> Not all support three-phase
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Check vehicle spec sheet for AC/DC speeds
              </li>
              <li>
                <strong>Use:</strong> Match charger to vehicle's max AC rate
              </li>
            </ul>
          </div>
        </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  European Models (2019+)
                </p>
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>AC:</strong> Type 2, 11kW three-phase
                  </li>
                  <li>
                    <strong>DC:</strong> CCS2, up to 250kW
                  </li>
                  <li>
                    <strong>Model 3/Y:</strong> 250kW peak DC
                  </li>
                  <li>
                    <strong>Model S/X Plaid:</strong> 250kW peak DC
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>AC:</strong> Proprietary, up to 11.5kW
                  </li>
                  <li>
                    <strong>DC:</strong> Proprietary Supercharger
                  </li>
                  <li>
                    <strong>V3 Supercharger:</strong> 250kW peak
                  </li>
                  <li>
                    <strong>Opening to CCS:</strong> Via adapters/Magic Dock
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              competitive DC speeds. Many models support three-phase charging, making the most of
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Japanese manufacturers historically used CHAdeMO for DC charging but are transitioning
              to CCS for new models. AC charging speeds are often more limited than European brands.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Leaf (2018+):</strong> AC 6.6kW, DC 50-100kW CHAdeMO
                  </li>
                  <li>
                    <strong>Ariya:</strong> AC 22kW, DC 130kW CHAdeMO/CCS2
                  </li>
                  <li>
                    <strong>Note:</strong> V2G capability via CHAdeMO
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Ioniq 5/6, EV6:</strong> AC 11kW, DC 220kW CCS2
                  </li>
                  <li>
                    <strong>Architecture:</strong> 800V E-GMP platform
                  </li>
                  <li>
                    <strong>Feature:</strong> V2L vehicle-to-load output
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Regional Compatibility Matrix (UK/Europe):
              </p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Oversizing:</strong> — 22kW charger for 6.6kW vehicle wastes money
                </li>
                <li>
                  <strong>Wrong phase:</strong> — Three-phase charger on single-phase supply
                </li>
                <li>
                  <strong>Ignoring onboard limit:</strong> — Vehicle limits AC regardless of charger
                </li>
                <li>
                  <strong>CHAdeMO assumption:</strong> — Check if Nissan has CCS2 (Ariya does)
                </li>
              </ul>
            </div>
          </div>
