...
const DESCRIPTION =
  'Learn systematic fault-finding techniques for low insulation resistance readings including common causes and solutions.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Disconnect at the midpoint and test each half. The faulty section shows low IR. Repeat to narrow down location efficiently.',
  },
  {
    id: 'accessory-check',
    ...
    correctIndex: 1,
    explanation:
      'Disconnect accessories and test cable alone. If cable passes, the accessory is faulty. This avoids unnecessary cable replacement.',
  },
  {
    id: 'moisture-test',
    ...
    correctIndex: 1,
    explanation:
      'Improved readings after drying confirm moisture was the cause. However, the moisture source must still be identified and addressed.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Moisture is the most common cause - from water ingress, condensation, or humidity. It creates conductive paths on insulation surfaces.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'Disconnect at the midpoint, test each half separately. The faulty section shows low reading. Repeat to narrow down location.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Each split halves the area: 100-50-25-12.5-6.25-3.125-1.56-0.78m. Seven splits locate to under 1m.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Only L-E failing indicates a specific problem with phase conductor insulation to earth - possibly damage or contamination affecting only that core.',
  },
  {
    id: 5,
    question: 'When checking accessories for IR faults:',
    ...
    correctAnswer: 1,
    explanation:
      "Disconnect accessories and test them individually. A faulty accessory can pull down the whole circuit's IR reading.",
  },
  {
    id: 6,
    question: 'If IR improves after drying, this indicates:',
    ...
    correctAnswer: 1,
    explanation:
      'Improved readings after drying confirm moisture was the cause. However, the source of moisture must be identified and addressed.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Rodent damage creates localised insulation damage with characteristic bite marks. It often affects multiple conductors in the same location.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'PI testing compares IR at 1 minute vs 10 minutes. Good insulation shows increasing reading; degraded insulation shows decreasing or stable reading.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Investigate thoroughly first. The fault may be easily repairable (moisture, poor termination, damaged accessory) without cable replacement.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Junction boxes are common fault locations due to moisture ingress, contamination, loose connections causing heat, or poor installation.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Moisture is the most common cause - either from water ingress, condensation, or high humidity. The good news is moisture-related failures often improve when dried out, though the source must be identified and addressed.',
  },
  {
    question: 'How does the half-split method work?',
    answer:
      'Disconnect the circuit at the midpoint. Test both halves separately. The faulty half reads low. Then split that half again and repeat. Each step halves the search area. A 100m cable takes only 7 tests to locate fault to within 1m.',
  },
  {
    question: 'Can damaged insulation be repaired?',
    answer:
      'Minor damage can sometimes be repaired using appropriate insulation tape or heat-shrink for cables, or by replacing damaged accessories. Significant or multiple damage points usually require cable replacement.',
  },
  {
    question: 'Why would only one conductor have low IR?',
    answer:
      'Single conductor failure often indicates mechanical damage affecting only that core, or water tracking along one conductor. It could also be a poor termination at one end allowing moisture into that specific core.',
  },
  {
    question: 'Should I test individual accessories?',
    answer:
      'Yes. Disconnect accessories and test them separately. A faulty socket, switch, or junction box with degraded insulation will affect the whole circuit reading. Also check accessory internal wiring.',
  },
  {
    question: 'What if the cable route is inaccessible?',
    answer:
      'Test from both ends and at any accessible intermediate points. Consider megger testing with extended test duration - degraded insulation may show decreasing readings over time under sustained test voltage (Polarisation Index testing).',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Method:</strong> Systematic isolation and testing
              </li>
              <li>
                <strong>Common:</strong> Moisture, damage, contamination
              </li>
              <li>
                <strong>Technique:</strong> Half-split to locate quickly
              </li>
              <li>
                <strong>Check:</strong> Accessories, junction boxes first
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Moisture:</strong> Water ingress, condensation
              </li>
              <li>
                <strong>Mechanical:</strong> Nails, screws, crushing
              </li>
              <li>
                <strong>Heat:</strong> Overloading, poor connections
              </li>
              <li>
                <strong>Age:</strong> Natural degradation over time
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>1.</strong> Test full circuit - confirm low IR
                </li>
                <li>
                  <strong>2.</strong> Disconnect at approximate midpoint
                </li>
                <li>
                  <strong>3.</strong> Test each half separately
                </li>
                <li>
                  <strong>4.</strong> Identify which half has low IR
                </li>
                <li>
                  <strong>5.</strong> Disconnect that half at its midpoint
                </li>
                <li>
                  <strong>6.</strong> Repeat until fault located
                </li>
              </ul>
            </div>

            <p className="text-sm text-elec-yellow/70">
              <strong>Example:</strong> A 100m cable takes only 7 half-splits to locate fault to
              within 1m (100-50-25-12.5-6.25-3.1-1.6-0.8m)
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Before extensive testing, visual inspection often reveals the cause:</p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Accessories are common fault locations:</p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Test Method:</strong> Disconnect accessory and test cable alone. If cable
              passes, the accessory is faulty.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Moisture is the most common cause. Confirm by:</p>
            ...
            <p className="text-sm text-red-400/80">
              <strong>Warning:</strong> Even if drying improves IR, identify and fix the moisture
              source or it will recur.
            </p>
          </div>
        </section>
