    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          When IR comes in below Table 64. The 250 V step-up under Reg 643.3.3, divide-and-conquer
          at the CU, borrowed neutrals, and the EICR coding decision.
        </p>
        ...
        >
          <p>
            ...
            looking for ≥ 1 MΩ. The A4:2026 redraft was a clarification, not a relaxation: skip the
            250 V post-connection step and the schedule of test results is incomplete; skip the
            pre-connection step on an affected circuit and the value you record is equipment leakage
            in parallel with the wiring, not the wiring on its own.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            confirms nothing in the equipment is creating a leakage path the wiring-only test could
            not see.
          </p>
        </ConceptBlock>
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              being dragged down by parallel combination with that one bad circuit. Localise to one
              outgoing way, then divide-and-conquer the cable.
            </li>
            <li>
              <strong className="text-amber-300">Parallel leakage.</strong> Many or all circuits
              read similarly low (e.g. 0.8–1.2 MΩ). No outlier. Common cause: damp ingress affecting
              a whole zone (post-flood, condensing roof void, leaking screed), or generalised
              insulation ageing across a tired installation. Treat as an installation-wide
              condition, not a single fault.
            </li>
            <li>
              ...
              The neutrals are physically joined at a downstream accessory — a back-box, JB, or the
              spur of a radial circuit. Locate the shared accessory and separate the neutrals.
            </li>
            <li>
              ...
              equipment, and apply the 250 V DC test with a 1 MΩ acceptance. The cable is fine — the
              equipment&rsquo;s own leakage is the leakage path.
            </li>
          </ol>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="120" y="42" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              STAGE 1 — WHOLE CU
            </text>
            <text x="120" y="60" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="10">
              All circuits in parallel
            </text>
            <text x="120" y="78" textAnchor="middle" fill="#EF4444" fontSize="13" fontWeight="bold">
              IR (L–E) = 0.4 MΩ ⚠
            </text>
            ...
            <text x="455" y="245" textAnchor="start" fill="#FBBF24" fontSize="10" fontWeight="bold">
          ...
          <p className="mt-3 text-[12.5px] text-white/60">
            ...
            combination of all six circuits; the kitchen ring outlier at Stage 2 is the single-fault
            contributor. By Stage 4 the fault is localised to a single back-box — almost always damp
            inside the box, a nicked conductor on insertion, or a stray strand making contact with
            the metal box.
          </p>
        </div>
        ...
        >
          <p>
            Equipment with electronic protection (RCBOs, AFDDs, SPDs), capacitive PFC, switched-mode
            supplies, or any manufacturer&rsquo;s &ldquo;disconnect during IR test&rdquo; note must
            be disconnected for the headline Table 64 test, then reconnected and re-tested at 250 V
            DC with the 1 MΩ acceptance. 500 V DC produces stress that electronic input stages and
            SPDs are not specified to survive; 250 V respects manufacturer envelopes. 1 MΩ is wide
            enough that normal background leakage will not fail it but tight enough that real
            insulation faults will.
          </p>
        ...
        >
          <p>
            A borrowed neutral happens when one circuit&rsquo;s neutral has been taken from another
            circuit&rsquo;s neutral at a shared accessory — typically a JB, ceiling rose carrying
            multiple circuits, or a backbox holding two switches. Separate at the CU, joined
            downstream. The IR signature is distinctive:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Either circuit reads fine when the other circuit&rsquo;s neutral is lifted at the CU.
            </li>
          </ul>
          <p>
            The leakage path on each circuit is being pulled into the other&rsquo;s test current via
            the shared neutral. Separating at the CU isolates each circuit and the readings recover.
            Remediation: find the shared accessory and physically separate the neutrals. A borrowed
            neutral is non-compliant under any modern interpretation — RCD operation and
            disconnection times are not predictable when neutrals are shared between circuits with
        ...
        >
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              IR drops over hours, improves on drying. Often affects multiple conductors of the same
              cable (L–E and N–E both low — water wicked into the sheath). Embedded screed cables
              stay damp for weeks; re-test after the substrate has dried before condemning the
              cable.
            </li>
            <li>
              <strong className="text-red-300">Nail / screw penetration.</strong> Single conductor
              low — usually L–E or N–E, rarely both. L–N infinite. Local and dry; no improvement on
              heating. Visual at likely locations (recent furniture/rail fixings, behind kitchen
              units from a refit) finds the breach.
            </li>
            <li>
              <strong className="text-purple-300">Back-box / accessory humidity.</strong>{' '}
              Whole-circuit IR near the limit; isolating the accessory and testing cable alone reads
              healthy. Bathroom switches, outdoor sockets with failed gland seals, garage/outhouse
              JBs. Hairdryer heat lifts the reading temporarily — confirms cause; fix is reseal or
              IP-rated enclosure.
            </li>
            <li>
              <strong className="text-amber-300">Common neutral on radial spur.</strong> Some 1990s
              installations ran a single neutral from a JB to feed two radial-circuit spurs that
              should have been independent. Tests like a borrowed neutral but only on the spurred
              section.
            </li>
            <li>
              <strong className="text-orange-300">Heat-damaged flex / cable.</strong> Local IR fail
              at a hot terminal. Discoloured insulation. Permanent damage — remake the terminal and
              cut back to clean copper / clean insulation.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            A 0.45 MΩ ring final in a kitchen is C2 — water and metalwork present, limit breached. A
            1.05 MΩ lighting circuit in a dry loft is C3 — limit just cleared, trend worth noting. A
            dead short L–E behind a child&rsquo;s bedroom socket is C1 — isolate and document
            immediately.
          </p>
        </ConceptBlock>
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Whole CU.</strong> Test at 500 V DC, current-using equipment disconnected (Reg
              643.3.2). If pass, no diagnostic needed.
            </li>
            <li>
            ...
            <li>
              ...
              at Table 64 voltage; if wiring passes, reconnect and apply 250 V DC across L–E with 1
              MΩ acceptance. Record both.
            </li>
            <li>
            ...
            <li>
              <strong>Half-split the cable.</strong> Disconnect at the midpoint accessory, test each
              half, half-split the failing half. Seven splits on 100 m gets to under 1 m.
            </li>
            <li>
            ...
            <li>
              <strong>Remediate, retest, record.</strong> Replace, re-terminate, re-seal, or cut and
              joint per Reg 526.5. Re-test, apply the Reg 643.3.3 250 V step where equipment is back
              in circuit, record final value on the schedule.
            </li>
          </ol>
        </ConceptBlock>
          ...
          whatToDo={
            <>
              <span className="block">
                Wiring-only is fine — the freezer is the leakage path. Document the kitchen ring at
                1.7 MΩ as the wiring-only result; document the 0.55 MΩ at 250 V DC with equipment
                connected as the post-connection result; flag the appliance as a Reg 651.4
                observation.
              </span>
              <span className="block">
                ...
                from service or repaired by an appliance engineer before the circuit is returned to
                normal use.
              </span>
              <span className="block">
                Do not blame the cable. Do not disable the RCBO. Do not transfer load to a different
                circuit as a workaround. Document, recommend, retest after remediation.
              </span>
            </>
          }
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>IR L–E:</strong> wiring-only at Table 64 voltage, between live conductors and
              the protective conductor connected to the earthing arrangement.
            </li>
            <li>
              <strong>Reg 643.3.3 follow-up (where applicable):</strong> 250 V DC, post-connection,
              between live conductors and PE. Acceptance ≥ 1 MΩ. Both readings have to be on the
              page.
            </li>
            <li>
