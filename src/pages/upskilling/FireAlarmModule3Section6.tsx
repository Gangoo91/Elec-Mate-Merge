...
const FireAlarmModule3Section6 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 3 · Section 6" title="Design documentation" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The BS 5839-1:2025 documentation set: zone plan, block diagram, schematic, riser,
          cause-and-effect matrix (NEW mandatory at handover), acceptance certificate (Annex G),
          extension or modification certificate (clause 47, firmware = modification),
          all-variations-in-logbook rule, and the logbook (Annex H — renumbered from Annex F in
          2017).
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Design package</strong> — zone plan, block diagram, schematic drawings, riser
              diagram, cable schedule, interface schedule, device schedule, design rationale.
            </li>
            <li>
            ...
            <li>
              <strong>System logbook</strong> — Annex H (was Annex F in 2017); the running record of
              events, faults, disablements, tests, services, modifications, variations.
            </li>
            <li>
              <strong>Extension or modification certificates</strong> — clause 47; one per extension
              or modification (including firmware updates).
            </li>
            <li>
          ...
          <p>
            ...
            (typically at or near the CIE for the operational documents); reviewed at every service
            visit; updated on every modification.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              user of the system. The commissioning technician should inform the user that it is
              important to keep the documentation provided up to date and available to interested
              parties.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.8"
            />
            <text x="440" y="72" textAnchor="middle" fill="#22D3EE" fontSize="12" fontWeight="bold">
              DESIGN PACKAGE
            </text>
            ...
            <text
              ...
              fontWeight="bold"
            >
              Extension OR modification certificate (clause 47) — one per change · firmware updates
              = modifications (NEW 2025)
            </text>
            <text x="440" y="512" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              ALL agreed variations recorded in the logbook (Annex H) · 2025 unacceptable variations
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              per clause 22.2.5. The user-facing location reference. Absence in multi-zone sleeping
              premises is now an unacceptable variation (NEW 2025). Updated on extensions /
              modifications.
            </li>
            <li>
              <strong>Block diagram</strong> — system architecture: CIE(s), loops, repeater panels,
              network connections, key interfaces, sounder zones. High-level structural view, no
              electrical detail. Used by service organisations and fire-fighters to understand the
              system at a glance.
            </li>
            <li>
            ...
            <li>
              ...
              through compartment lines. Used by installation engineers and for fire risk assessment
              of penetrations.
            </li>
          </ul>
          <p>
        ...
        <ContentEyebrow>The certificates — commissioning, acceptance, modification</ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Commissioning certificate</strong> — issued by the commissioning organisation
              after commissioning is complete. Certifies that the system as installed and configured
              meets the design and BS 5839-1:2025. The technical statement of compliance.
            </li>
            <li>
            ...
            <li>
              <strong>Extension or modification certificate (clause 47)</strong> — issued after any
              extension or modification of the system. Documents what was changed, by whom, when.
              Filed alongside the original commissioning / acceptance certificates so the evolution
              of the system is traceable.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              the unacceptable-variation list. The variation is then a documented departure that all
              subsequent service / modification reflects.
            </li>
            <li>
              ...
              transmission in supported housing (Grade A BS 5839-6:2019) or residential care homes.
              These cannot be variations; a system with one of these departures is non-conforming,
              not 'compliant by variation'.
            </li>
            <li>
              <strong>Logbook recording</strong> — every agreed variation, regardless of size, with:
              what the variation is, why it was agreed (technical justification), who agreed it (the
              parties), the date. The logbook entry stands as the variation record for the
              system\&apos;s life.
            </li>
            <li>
              <strong>Review at modification</strong> — when the system is extended or modified, the
              existing variations are reviewed: do they still apply? are they still valid? does the
              modification require new variations to be agreed? The new modification certificate
              references any variations that apply to the modification.
            </li>
          </ul>
          <p>
            ...
            loopholes that were exploited to defeat life-safety functions. Designers who previously
            argued for these variations on cost grounds no longer have that option.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              safety of life that they should not be regarded as acceptable variations: absence of a
              zone plan in premises with more than one zone on any storey; absence of a facility for
              transmission of fire alarm signals to an ARC in supported housing requiring Grade A BS
              5839-6:2019 or in a residential care home. All agreed variations should now be
              recorded within the system logbook (Annex H).
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>System tests</strong> — weekly user test, monthly battery / load test (per BS
              5839-1 schedules), other periodic tests.
            </li>
            <li>
          ...
          <p>
            The logbook should be paper-and-ink (or a hybrid with electronic entry where the vendor
            system supports it, but always with a paper copy retained at the premises for
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              reason, every extension or modification of the system, and every agreed variation from
              the recommendations of this part of BS 5839. The logbook (Annex H) has been updated to
              reflect the information that is within clause 48.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Operating instructions</strong> — for the responsible person and staff: how to
              read the CIE display; how to acknowledge / silence / reset events; how to handle
            ...
            <li>
              ...
              D.1 record (address, location, mode, sensitivity, schedule); for addressable systems,
              the device list with text descriptors; for any programmable element (day / night
              schedules, coincidence settings), the configuration is documented.
            </li>
            <li>
          ...
          <p>
            ...
            the service organisation. It is the document they jointly maintain; gaps are identified
            and closed.
          </p>
        </ConceptBlock>
