...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Without proper seasonal settings, systems might heat and cool simultaneously (fighting each other), or operate at inappropriate setpoints year-round. This wastes significant energy and reduces occupant comfort.',
  },
  {
...
const faqs = [
  {
    ...
    answer:
      'Local comfort overrides typically expire after 30 minutes to 2 hours. Meeting room overrides are commonly set to 2 hours, while general office area overrides may be limited to 30-60 minutes to prevent energy waste.',
  },
  {
    question: 'How does the BMS handle heating-to-cooling changeover?',
    answer:
      "The BMS uses outdoor temperature sensors and deadband programming to prevent simultaneous heating and cooling. Typically, there's a temperature deadband (e.g., heating disabled above 18°C, cooling disabled below 22°C) to prevent system hunting.",
  },
  {
    question: 'What happens to overrides during a fire alarm?',
    answer:
      'Fire alarms typically override all comfort-related BMS functions. Safety systems take priority - AHUs shut down, smoke dampers open, and any comfort overrides are immediately cancelled. Fire system integration must be hardwired for reliability.',
  },
  {
    question: 'How often should override usage be reviewed?',
    answer:
      'Active overrides should be reviewed weekly at minimum. Many organisations review daily, with automated alerts for overrides exceeding 4-8 hours. Regular review helps identify training needs and system issues causing excessive override use.',
  },
];
...
const BMSModule3Section5 = () => {
  useSEO({
    ...
    description:
      'Master BMS override functions and seasonal control strategies. Learn manual override implementation, seasonal programming, safety protocols, and commissioning procedures for optimal building performance.',
  });
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Overrides:</strong> Temporary manual control with auto-expiry
              </li>
              <li>
                <strong>Seasonal:</strong> Auto-adapt heating/cooling by season
              </li>
              <li>
                <strong>Energy Impact:</strong> 15-30% savings with proper settings
              </li>
              <li>
                <strong>Misuse Risk:</strong> £85,000/year waste from forgotten overrides
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Override switches, outdoor temp sensors, status LEDs
              </li>
              <li>
                <strong>Use:</strong> Maintenance, special events, seasonal transitions
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Override functions provide essential manual control capabilities while maintaining
              system safety and operational integrity. Different types of overrides serve different
              purposes and have varying levels of authority and safety implications.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Override Types and Authority Levels:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Emergency (Highest):</strong> Manual reset only, any user - fire override,
                  emergency stop
                </li>
                <li>
                  <strong>Safety (Very High):</strong> Manual reset, authorised personnel -
                  lockout/tagout
                </li>
                <li>
                  <strong>Operator (High):</strong> 2-8 hour limit, BMS operators - equipment
                  testing
                </li>
                <li>
                  <strong>Local (Medium):</strong> 30min-2hr, local users - room comfort, fan boost
                </li>
                <li>
                  <strong>Scheduled (Low):</strong> Pre-programmed, automatic - extended hours,
                  events
                </li>
              </ul>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Room switches:</strong> Extend HVAC for 2 hours
                  </li>
                  <li>
                    <strong>Equipment buttons:</strong> Manual start for testing
                  </li>
                  <li>
                    <strong>Zone panels:</strong> ±2°C temperature adjustment
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Force commands:</strong> ON/OFF/AUTO states
                  </li>
                  <li>
                    <strong>Setpoint override:</strong> Temporary adjustment
                  </li>
                  <li>
                    <strong>Schedule override:</strong> Special events
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Buildings have dramatically different operational requirements throughout the year.
              Seasonal control strategies automatically adapt system operation to changing
              environmental conditions, occupancy patterns, and energy costs.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Winter:</strong> Heat 20-21°C, cool disabled, heat recovery active,
                  boilers primary
                </li>
                <li>
                  <strong>Spring:</strong> Heat 19-20°C, cool 24-25°C, free cooling priority,
                  economisers
                </li>
                <li>
                  <strong>Summer:</strong> Heat disabled, cool 23-24°C, max fresh air, chillers
                  primary
                </li>
                <li>
                  <strong>Autumn:</strong> Heat 20-21°C, cool 24-25°C, mixed mode, variable
                  equipment
                </li>
              </ul>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Boiler staging:</strong> Lead/lag rotation
                  </li>
                  <li>
                    <strong>Heat recovery:</strong> 30-50% load reduction
                  </li>
                  <li>
                    <strong>Frost protection:</strong> Automatic glycol circulation
                  </li>
                  <li>
                    <strong>Warm-up:</strong> Optimised pre-heating
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Chiller sequencing:</strong> Capacity staging
                  </li>
                  <li>
                    <strong>Free cooling:</strong> 100% when conditions suit
                  </li>
                  <li>
                    <strong>Pre-cooling:</strong> Thermal mass overnight
                  </li>
                  <li>
                    <strong>Humidity control:</strong> Dehumidification
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Electricians enable override and seasonal control strategies through proper
              installation, wiring, and testing of control devices, sensors, and safety systems.
              Their work ensures these critical functions operate safely and reliably throughout the
              building's lifecycle.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Override System Installation Requirements:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Physical switches:</strong> Appropriate rating, clear labelling, status
                  LEDs
                </li>
                <li>
                  <strong>Outdoor sensors:</strong> Weather-resistant, 3-4m height, representative
                  location
                </li>
                <li>
                  <strong>Safety segregation:</strong> Separate circuits for life safety vs comfort
                </li>
                <li>
                  <strong>Testing capability:</strong> Verify BMS recognition of manual commands
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Proper commissioning of override and seasonal control systems ensures safe, reliable
              operation throughout all operating conditions. Testing must verify both automatic
              seasonal operation and manual override capabilities.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Step 1:</strong> Test each override switch and software function
                </li>
                <li>
                  <strong>Step 2:</strong> Simulate seasonal conditions via sensor adjustment
                </li>
                <li>
                  <strong>Step 3:</strong> Verify automatic expiry of time-limited overrides
                </li>
                <li>
                  <strong>Step 4:</strong> Test safety override priority - comfort cannot override
                  safety
                </li>
                <li>
                  <strong>Step 5:</strong> Verify proper documentation and logging
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-white mb-6">
            Case Study: Commercial Office Override Misuse
          </h2>
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm text-white">
                <strong>Problem:</strong> 15-storey office building with high energy bills despite
                modern BMS. Investigation found 12 of 15 major plant items had active manual
                overrides, some lasting weeks. Staff were leaving overrides on after maintenance
                without resetting to automatic.
              </p>
            </div>
            ...
            <div className="p-3 rounded bg-transparent border border-white/10 text-sm">
              <p className="text-white">
                <strong>Result:</strong> 15% energy reduction within 3 months, £63,000/year savings,
                95% reduction in inappropriate override usage.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10 mt-12">
          <SingleQuestionQuiz title="Test Your Knowledge" questions={bmsModule3Section5QuizData} />
        </section>
