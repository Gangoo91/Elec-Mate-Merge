...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      'It guarantees the lowest possible calibration price',
      'It ensures calibration laboratories meet quality standards and provides traceability',
      'It removes the need for periodic recalibration',
      'It exempts equipment from manufacturer warranties',
    ],
    correctIndex: 1,
    explanation:
      'UKAS accreditation provides confidence that calibration laboratories operate competently and generate valid results with proper traceability to national standards.',
  },
  {
    id: 'standards-purpose',
    question: 'Name one reason standards are essential in instrumentation.',
    options: [
      'They allow each manufacturer to use unique methods',
      'To ensure accuracy, safety, and regulatory compliance',
      'They remove the need for calibration entirely',
      'They guarantee equipment never requires maintenance',
    ],
    correctIndex: 1,
    explanation:
      'Standards ensure instrumentation systems meet accuracy requirements, maintain safety levels, enable interoperability, and support regulatory compliance across industries.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'They have no bearing on legal compliance',
      'By providing accepted benchmarks for demonstrating due diligence and regulatory conformity',
      'Only by adding cost to a project',
      'By increasing the complexity of every system',
    ],
    correctAnswer: 1,
    explanation:
      'Standards provide recognised benchmarks that regulators and courts use to assess whether organisations have met their legal obligations for safety and quality.',
  },
  {
    id: 5,
    question: 'Which industry is typically required to follow ISO standards strictly?',
    options: [
    ...
    correctAnswer: 0,
    explanation:
      'Pharmaceutical manufacturing requires strict adherence to ISO standards (including ISO/IEC 17025) to ensure product safety, efficacy, and regulatory approval from authorities like the MHRA.',
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation:
      'BS EN stands for British Standard European Norm - these are European standards adopted as British Standards to ensure consistency across European markets.',
  },
  {
    id: 7,
    question: 'What is traceability in measurement terms?',
    options: [
      'A method of physically tracking equipment around a site',
      'A log of instrument serial numbers and asset tags',
      'A procedure for recovering lost test equipment',
      'An unbroken chain of measurements linking to national or international standards',
    ],
    correctAnswer: 3,
    explanation:
      'Traceability means measurements can be related to appropriate standards (usually national or international) through an unbroken chain of comparisons with stated uncertainties.',
  },
  {
    id: 8,
    question: 'Which BS EN standard covers safety requirements for measurement equipment?',
    options: ['BS EN 60204', 'BS EN 61010', 'BS EN 62305', 'BS EN 60898'],
    correctAnswer: 1,
    explanation:
      'BS EN 61010 specifies safety requirements for electrical equipment used for measurement, control, and laboratory use.',
  },
  {
    id: 9,
    question: 'What is the UKAS assessment cycle for accredited laboratories?',
    options: [
      'A single one-off assessment only',
    ...
    correctAnswer: 2,
    explanation:
      'UKAS conducts annual surveillance visits to accredited laboratories and performs a full re-assessment every four years to maintain accreditation status.',
  },
  {
    id: 10,
    ...
    options: [
      ...
      'It matters only inside accredited calibration laboratories',
      'It removes the need to document measurement uncertainty',
      'It allows instruments to skip routine calibration',
    ],
    correctAnswer: 0,
    explanation:
      'Repeatability ensures that measurement procedures produce consistent results, enabling reliable quality control, calibration intervals, and confidence in measurement data.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Not all businesses require UKAS accredited calibration, but regulated industries (pharmaceuticals, aerospace, automotive, nuclear) typically mandate it. Even non-regulated businesses benefit from traceable calibration for quality assurance.',
  },
  {
    question: 'How often should instruments be calibrated?',
    answer:
      'Calibration frequency depends on the instrument type, usage intensity, environmental conditions, and industry requirements. Typically ranges from 6 months to 2 years, with critical instruments requiring more frequent calibration.',
  },
  {
    question: 'What happens if equipment fails calibration?',
    answer:
      'If equipment fails calibration, it must be adjusted, repaired, or replaced. Historical data may need review to assess if measurements taken were affected. Some industries require impact assessments and corrective actions.',
  },
  {
    question: 'Are international standards the same as British standards?',
    answer:
      "Many British standards (BS) are identical to international (ISO/IEC) or European (EN) standards. The prefix indicates the standard's origin: BS = British, EN = European, ISO = International. BS EN indicates European norms adopted as British standards.",
  },
  {
    question: 'What is measurement uncertainty?',
    answer:
      'Measurement uncertainty quantifies the doubt about the result of a measurement. It includes all possible sources of error and is expressed as a range within which the true value is expected to lie with a stated confidence level.',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>BS EN:</strong> European norms adopted as British Standards
              </li>
              <li>
                <strong>UKAS:</strong> UK's National Accreditation Body
              </li>
              <li>
                <strong>ISO/IEC 17025:</strong> International standard for lab competence
              </li>
              <li>
                <strong>Purpose:</strong> Ensure accuracy, safety, and compliance
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> UKAS logo on calibration certificates
              </li>
              <li>
                <strong>Use:</strong> Verify calibration traceability for critical measurements
              </li>
              <li>
                <strong>Apply:</strong> Select accredited suppliers for regulated industries
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Key BS EN Standards for Instrumentation:
              </p>
              <div className="grid sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li>
                      <strong>BS EN 61010:</strong> Safety requirements for measurement, control,
                      and laboratory equipment
                    </li>
                    <li>
                      <strong>BS EN 61326:</strong> EMC requirements for measurement, control, and
                      laboratory equipment
                    </li>
                    <li>
                      <strong>BS EN 50581:</strong> Technical documentation for RoHS assessment
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li>
                      <strong>BS EN 60751:</strong> Industrial platinum resistance thermometers
                    </li>
                    <li>
                      <strong>BS EN 62058:</strong> Electricity metering equipment requirements
                    </li>
                    <li>
                      <strong>BS EN 61298:</strong> Process measurement device performance
                      evaluation
                    </li>
                  </ul>
                </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>BS EN 61508:</strong> Functional safety of E/E/PE safety-related systems
                  </li>
                  <li>
                    <strong>BS EN 61511:</strong> Safety instrumented systems for process industry
                  </li>
                  <li>
                    <strong>BS EN 62061:</strong> Safety of machinery control systems
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>BS EN 50325:</strong> Industrial communications (CAN-based)
                  </li>
                  <li>
                    <strong>BS EN 61158:</strong> Fieldbus specifications
                  </li>
                  <li>
                    <strong>BS EN 62541:</strong> OPC unified architecture specifications
                  </li>
                </ul>
              </div>
            </div>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Note:</strong> Despite Brexit, the UK continues to recognise many BS EN
              standards as they remain technically valid and support international trade
              compatibility.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              provides confidence in measurement results and is often mandatory for regulated
              industries.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ISO/IEC 17025 is the international standard that specifies the general requirements
              for the competence, impartiality and consistent operation of testing and calibration
              laboratories. It is the foundation standard for all laboratory accreditation
              worldwide.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>2017 Revision:</strong> The current version emphasises risk-based thinking,
              customer focus, and flexibility in quality management system implementation while
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Standards provide the framework for consistent, reliable, and legally defensible
              instrumentation practices. They ensure measurements are accurate, comparable, and
              traceable while supporting safety, quality, and regulatory compliance across all
              industries.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Core Benefits of Standards Compliance:
              </p>
              <div className="grid sm:grid-cols-3 gap-4">
                <div>
                  <p className="text-sm font-medium text-elec-yellow/80 mb-1">Traceability</p>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                Real-World Scenario: Pharmaceutical Manufacturing Compliance
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Step 1:</strong> Internal calibration lab achieves UKAS accreditation to
                  ISO/IEC 17025 for temperature, pressure, and analytical measurements
                </li>
                <li>
                  <strong>Step 2:</strong> All process instrumentation calibrated with certificates
                  traceable to national standards, with documented uncertainty budgets
                </li>
                <li>
                  <strong>Step 3:</strong> Calibration procedures integrated with GMP quality
                  system, including risk assessments and validation protocols
                </li>
                <li>
                  <strong>Step 4:</strong> MHRA audit successfully completed, with product licence
                  approved based on demonstrated measurement capability
                </li>
              </ul>
            </div>
            ...
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Selecting Calibration Suppliers
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Ignoring accreditation scope</strong> — UKAS accreditation must cover the
                  specific measurements required
                </li>
                <li>
                  <strong>Missing calibration intervals</strong> — out-of-calibration equipment
                  invalidates measurements
                </li>
                <li>
                  <strong>Incomplete records</strong> — traceability requires documented calibration
                  history
                </li>
                <li>
                  <strong>Assuming all certificates are equal</strong> — non-UKAS certificates may
