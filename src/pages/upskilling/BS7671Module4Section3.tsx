...
const quickCheckQuestions = [
  {
    ...
    options: ['0.1 seconds', '0.4 seconds', '1.0 seconds', '5.0 seconds'],
    correctIndex: 1,
    explanation:
      'For socket circuits in TN systems, BS 7671 requires disconnection within 0.4 seconds to ensure safety against electric shock. This applies to all final circuits ≤32A where direct contact during a fault is likely.',
  },
  {
    id: 'zs-purpose',
    ...
    correctIndex: 1,
    explanation:
      'Testing Zs (earth fault loop impedance) verifies that the impedance is sufficiently low to allow protective devices to disconnect within the required time limits during an earth fault. Low Zs = high fault current = fast disconnection.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'In TT systems, the high resistance of the earth electrode path (typically 20-200Ω) means overcurrent devices alone cannot generate sufficient fault current for fast disconnection. RCDs detect the small imbalance current and disconnect rapidly.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Measured Zs values should not exceed 80% of the tabulated maximum values in BS 7671. This allows for conductor temperature rise under fault conditions—cables heat up during a fault, increasing resistance and Zs. Example: If tabulated Zs limit is 2.30Ω, measured value should not exceed 1.84Ω (2.30 × 0.8).',
  },
  {
    question: 'Why do socket outlets have stricter disconnection times than fixed equipment?',
    answer:
      "Socket outlets present higher risk: they're accessible to anyone, used with portable equipment held by hand, more likely to experience cord damage, and may be used in wet conditions. The 0.4-second maximum ensures rapid disconnection before dangerous currents cause harm to people holding equipment.",
  },
  {
    question: 'What components make up the fault path?',
    answer:
      'The complete fault path includes: source transformer winding → line conductor to fault point → fault itself → CPC back to installation → main earthing terminal → earthing conductor → earth electrode (TT) or PEN conductor (TN-C-S) → source neutral. Any high resistance or break prevents adequate fault current.',
  },
  {
    question: 'How do Amendment 3 requirements affect EV charging installations?',
    answer:
      'Amendment 3 requires Type B RCDs (or equivalent) for EV charging points to detect DC fault currents up to 6mA DC. Standard Type A RCDs cannot detect DC faults. Enhanced disconnection time requirements and DC fault monitoring ensure safety during vehicle charging.',
  },
];
...
const quizQuestion = {
  ...
  correctAnswer: 1,
  explanation:
    'As conductor temperature increases, resistance increases (copper has a positive temperature coefficient). Under fault conditions, cables heat up rapidly, increasing Zs beyond the cold measurement. The 80% rule accounts for this temperature rise.',
};
...
const BS7671Module4Section3 = () => {
  useSEO({
    ...
    description:
      'Learn about required disconnection times, Zs testing, the 80% rule, and fault path integrity requirements per BS 7671.',
  });
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Socket circuits (TN):</strong> 0.4s maximum disconnection
              </li>
              <li>
                <strong>Distribution circuits:</strong> 5s maximum
              </li>
              <li>
                <strong>TT systems:</strong> RCD essential (high earth resistance)
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Zs test:</strong> Verifies fault path can operate device in time
              </li>
              <li>
                <strong>80% rule:</strong> Measured Zs must be ≤80% of limit
              </li>
              <li>
                <strong>Fault path:</strong> Must be continuous and low impedance
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Different circuits and systems have different disconnection time requirements based on
              their risk level and likelihood of human contact during fault conditions.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Final circuits ≤32A:</strong> 0.4s maximum
                  </li>
                  <li>
                    <strong>Socket outlets:</strong> Always 0.4s
                  </li>
                  <li>
                    <strong>Distribution circuits:</strong> 5s maximum
                  </li>
              ...
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li>
                    <strong>High earth electrode resistance:</strong> 20-200Ω typical
                  </li>
                  <li>
                    <strong>Low fault current:</strong> Insufficient for MCB operation
                  </li>
                  <li>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Zs testing verifies that the earth fault loop impedance is low enough to allow
              protective devices to disconnect within required time limits during an earth fault.
            </p>
            ...
            <div className="p-5 rounded-lg bg-white/5 my-6">
              ...
              <div className="text-center mb-4">
                <p className="text-lg font-mono text-white">
                  Measured Zs ≤ 0.8 × Tabulated Maximum
                </p>
              </div>
            ...
            <div className="my-6">
              ...
              <ol className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>1.</strong> Connect test instrument between line and earth at furthest
                  point
                </li>
                <li>
                  <strong>2.</strong> Ensure circuit is live and other parallel paths are considered
                </li>
                <li>
                  <strong>3.</strong> Record measured Zs value
                </li>
                <li>
                  <strong>4.</strong> Apply 80% factor to tabulated limit
                </li>
                <li>
                  <strong>5.</strong> Compare measured value against corrected limit
                </li>
                <li>
                  <strong>6.</strong> Document results on schedule of test results
                </li>
              </ol>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              For protective devices to operate correctly, there must be a continuous, low-impedance
              path for fault current from the point of fault back to the source. Any break or high
              resistance compromises safety.
            </p>

            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Fault Path Components
                </p>
                <ul className="text-sm text-white space-y-1">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Continuity testing:</strong> Verify all connections intact using low-ohm
                  tester
                </li>
                <li>
                  <strong>Zs testing:</strong> Overall earth fault loop impedance verification
                </li>
                <li>
                  <strong>Visual inspection:</strong> Check for damage, corrosion, loose connections
                </li>
                <li>
                  <strong>R1+R2 measurement:</strong> Calculate expected Zs from Ze + (R1+R2)
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Amendment 3 introduced significant updates for modern installations including EV
              charging, energy storage, and smart devices.
            </p>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20 my-6">
              ...
              <p className="text-sm text-white">
                Amendment 3 recommends AFDD protection for final circuits in sleeping accommodation
                and locations with combustible materials. AFDDs detect dangerous arc faults that
                traditional protection cannot sense, providing enhanced fire protection.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="p-5 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
            <h3 className="text-sm font-medium text-elec-yellow mb-3">
              Commercial Building Zs Testing
            </h3>
            <p className="text-sm text-white mb-3">
              Socket circuits protected by 20A Type B MCBs in a TN-C-S system. Tabulated Zs limit =
              2.30Ω.
            </p>
