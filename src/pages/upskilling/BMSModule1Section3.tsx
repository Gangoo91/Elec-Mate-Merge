...
const DESCRIPTION =
  'Learn the three main benefits of Building Management Systems: energy efficiency, occupant comfort, and centralised control. ROI analysis and implementation strategies.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'BMS extends equipment life through operational optimisation (running at optimal efficiency points) and predictive maintenance based on actual equipment performance data.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Modern buildings typically achieve 15-30% energy reduction through intelligent system optimisation, with payback periods of 2-5 years through energy savings alone.',
  },
  {
    question: 'How does BMS improve occupant productivity?',
    answer:
      'Research indicates proper environmental control can improve cognitive performance by up to 15% and reduce sick building syndrome symptoms significantly through optimal temperature, humidity, and air quality management.',
  },
  {
    question: 'What compliance standards does BMS help with?',
    answer:
      'BMS supports EN 15232 (building automation energy performance), MEES regulations, Building Regulations Part L, BREEAM/LEED certifications, and corporate ESG reporting requirements.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Energy:</strong> 15-30% reduction, 2-5 year payback
              </li>
              <li>
                <strong>Comfort:</strong> Up to 15% productivity improvement
              </li>
              <li>
                <strong>Control:</strong> Centralised monitoring, faster response
              </li>
              <li>
                <strong>Compliance:</strong> EN 15232, Part L, BREEAM/LEED
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Energy reports, comfort complaints, maintenance logs
              </li>
              <li>
                <strong>Use:</strong> Client discussions, project justification
              </li>
              <li>
                <strong>Apply:</strong> ROI calculations, compliance documentation
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Energy efficiency represents the most quantifiable benefit of BMS implementation.
              Modern buildings typically achieve <strong>15-30% energy reduction</strong> through
              intelligent system optimisation, translating directly to operational cost savings.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Demand-Based Control:</strong> Systems operate based on actual occupancy,
                  not fixed schedules
                </li>
                <li>
                  <strong>Load Shedding:</strong> Non-critical systems reduce power during peak
                  demand periods
                </li>
                <li>
                  <strong>Free Cooling:</strong> Maximise outside air when conditions permit
                </li>
                <li>
                  <strong>Equipment Optimisation:</strong> Motors, pumps, fans operate at optimal
                  efficiency
                </li>
                <li>
                  <strong>Thermal Mass Management:</strong> Pre-cooling/heating during off-peak
                  periods
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Optimal environmental conditions directly impact occupant productivity, health, and
              satisfaction. Research indicates proper environmental control can improve cognitive
              performance by <strong>up to 15%</strong>.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Temperature:</strong> ±1°C accuracy with zone-based management
                  </li>
                  <li>
                    <strong>Humidity:</strong> 40-60% RH for optimal comfort
                  </li>
                  <li>
                    <strong>Air Quality:</strong> CO₂, VOCs, and particulate monitoring
                  </li>
                  <li>
                    <strong>Lighting:</strong> Daylight harvesting and circadian support
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Offices:</strong> Productivity optimisation
                  </li>
                  <li>
                    <strong>Healthcare:</strong> Infection control and patient comfort
                  </li>
                  <li>
                    <strong>Education:</strong> Learning environment optimisation
                  </li>
                  <li>
                    <strong>Retail:</strong> Customer experience enhancement
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Centralised control transforms building operations from reactive maintenance to
              proactive management. Facility managers gain unprecedented visibility into all
              building systems through integrated dashboards.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Beyond immediate operational benefits, BMS delivers substantial long-term value
              through compliance support, asset protection, and future-proofing capabilities.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>EN 15232:</strong> Building automation energy performance
                  </li>
                  <li>
                    <strong>MEES:</strong> Minimum Energy Efficiency Standards
                  </li>
                  <li>
                    <strong>Part L:</strong> Energy conservation compliance
                  </li>
                  <li>
                    <strong>BREEAM/LEED:</strong> Sustainability certification
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Predictive Maintenance:</strong> Data-driven scheduling
                  </li>
                  <li>
                    <strong>Equipment Optimisation:</strong> Reduced wear
                  </li>
                  <li>
                    <strong>Fault Prevention:</strong> Early detection
                  </li>
                  <li>
                    <strong>Documentation:</strong> Complete operational history
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Initial:</strong> Hardware, software, installation, commissioning
                  </li>
                  <li>
                    <strong>Ongoing:</strong> Licensing, support, maintenance, training
                  </li>
                  <li>
                    <strong>Payback:</strong> Typically 2-5 years through energy savings
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Energy:</strong> 15-30% cost reductions
                  </li>
                  <li>
                    <strong>Maintenance:</strong> 10-20% savings
                  </li>
                  <li>
                    <strong>Equipment Life:</strong> 20-40% extension
                  </li>
                  <li>
                    <strong>Building Value:</strong> Premium rental rates
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm text-white">
                <strong>Phased Implementation:</strong> Large installations benefit from starting
                with high-impact areas (HVAC and lighting), demonstrating value early and allowing
                operational experience before full deployment.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Highlight energy savings as primary selling point - measurable and immediate
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Unrealistic expectations</strong> — set clear performance metrics and
                  timelines
                </li>
                <li>
                  <strong>Insufficient training</strong> — staff training is essential for system
                  effectiveness
                </li>
                <li>
                  <strong>No follow-up reviews</strong> — regular optimisation ensures continued
                  performance
                </li>
              </ul>
            </div>
        ...
        <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-10">
          <p className="text-sm font-medium text-elec-yellow mb-2">
            Case Study: Retail Chain BMS Implementation
          </p>
          ...
          <ul className="text-sm text-white space-y-1">
            <li>
              <strong>18% energy reduction</strong> across all sites
            </li>
            <li>
              <strong>£400,000 annual savings</strong> in energy costs
            </li>
            <li>
              <strong>24-month payback period</strong>
            </li>
            <li>
              <strong>30% maintenance cost reduction</strong>
            </li>
          </ul>
        </div>
