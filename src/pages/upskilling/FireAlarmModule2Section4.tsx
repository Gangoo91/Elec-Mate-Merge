...
const FireAlarmModule2Section4 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 2 · Section 4" title="Sounders and VADs" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The output side of the system. Audible signals to wake or alert occupants, visual signals
          to reach those who cannot hear. BS 5839-1:2025 sets sound pressure levels, tone
          characteristics, and the new clause 15.1.12 framework for non-fire use of fire alarm
          tones.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              manufacturing ambient noise (40-55 dB(A)). Reliably above the perception threshold for
              an alert adult. The 65 dB(A) floor ensures the alarm signal is unambiguously
            ...
            <li>
              ...
              obstructions (added soft furnishings, partition walls erected post-commissioning) can
              erode commissioning-time margins. A design that just-meets the minimum at
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Universal recognisability.</strong> The BS 5839-1 evacuation tone is the same
              across all UK BS 5839-1 systems. A person who has heard it before in any building
              recognises it elsewhere. This harmonisation is a deliberate design choice.
            </li>
            <li>
              ...
              clearer instructions but requires different system architecture and is not the default
              for BS 5839-1. PA-VAD is the right tool for very large or complex premises (stadiums,
              airports) where directional evacuation guidance is needed.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              ...
              <text x="120" y="129" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                door closed
              </text>
              {/* Bed graphic */}
              <rect
              ...
              <text x="120" y="320" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              ...
              <text x="332" y="236" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <g>
              ...
              <text x="510" y="240" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                1 m
              </text>
              ...
              <text x="565" y="240" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                3 m
              </text>
              ...
              <text x="640" y="240" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                10 m
              </text>
              ...
              <text x="730" y="240" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                30 m
              </text>
              ...
              {/* Caption */}
              <text x="615" y="295" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                SPL falls ~6 dB per doubling of distance
              </text>
              <text x="615" y="310" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                design must place sounders so EVERY listening point
              </text>
              <text x="615" y="324" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <g>
              ...
              <text x="615" y="550" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Plant rooms.</strong> Boilers, AHUs, compressors. Continuous SPL in the 70–85
              dB(A) range is normal; sounders must be specified accordingly.
            </li>
            <li>
            ...
            <li>
              ...
              hold above 60 dB(A) for the busy hours; design for the worst sustained period, not the
              quiet-night minimum.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              building that requires the same evacuation as fire — using the fire tone is permitted
              because the human response is the same. The signal is unambiguous because the response
              is unambiguous.
            </li>
            <li>
            ...
            <li>
              <strong>Lockdown / invacuation — acknowledged.</strong> The 2025 edition acknowledges
              that fire alarm infrastructure is increasingly used for lockdown or invacuation alarms
              (a different response from fire — staying inside, securing rooms). The lockdown signal
              must be DIFFERENT from the fire evacuation tone, so that occupants distinguish
              'evacuate immediately' from 'lock down and stay'. FIA guidance (Use of fire alarm
              systems for lockdown — specifically in schools) is cross-referenced.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              predetermined periods. In these cases, the duration of class change signals should not
              exceed 10 s. NOTE: Guidance on the use of a fire alarm system as a lockdown alarm is
              available in FIA guidance document Use of fire alarm systems for lockdown
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              classrooms, NOT by a fire MCP. The cause-and-effect matrix routes the lockdown trigger
              to lockdown sounders and the fire trigger to fire sounders, even where the physical
              sounders are shared.
            </li>
            <li>
              <strong>FIA guidance.</strong> The FIA Guidance Note on Use of fire alarm systems for
              lockdown (specifically in schools) provides design templates, signal specifications,
              and operational guidance. The 2025 BS 5839-1 cross-reference anchors this guidance
              into the standard's framework.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>BS EN 54-23 product designations.</strong> Devices are categorised by mounting
              type and coverage volume. Ceiling-mounted (C) devices have specifications of the form
              C-3-3 (3 m × 3 m × 3 m coverage at floor level). Wall-mounted (W) devices have
              specifications of the form W-2.4-6 (mounted at 2.4 m height, projection 6 m).
              Open-area devices (O) are also defined for areas without conventional walls.
            </li>
            <li>
              ...
              on visual signal), BS EN 54-23 compliance is mandatory. The product must be tested and
              certified against the standard.
            </li>
            <li>
              <strong>Supplementary VAD.</strong> Where the VAD supports compliant audible coverage
              (most accessibility-driven installations), BS EN 54-23 compliance is recommended but a
              less-stringent product may be permitted by the design. Manufacturer literature
              increasingly defaults to BS EN 54-23 for all VADs regardless of role.
            </li>
            <li>
              <strong>Accessibility drivers.</strong> Approved Document M (Building Regulations), BS
              8300 (designing inclusive built environments) and the Equality Act 2010 collectively
              drive WHERE VADs are required in addition to audible. Typical: accessible bedrooms in
              hotels (5-10 percent of stock), accessible toilets, quiet rooms, prayer rooms, and any
              space where audible coverage genuinely cannot meet the SPL minima.
            </li>
            <li>
              <strong>Flash rate and colour.</strong> BS EN 54-23 specifies flash characteristics —
              typically 0.5 to 2 Hz — and colour (red). Flash rates outside this band can trigger
              photosensitive epilepsy in some occupants; the standard balances conspicuity against
              safety.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              where the audible alarm is impractical (acoustic isolation requirements, non-magnetic
              hardware constraints). Visual signal becomes primary. Specialist MR-compatible VADs
              are required.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Alarm current.</strong> Sum of operating currents of all sounders and VADs on
              the circuit. Sounders typically draw 30-60 mA each; VADs 30-200 mA each depending on
              intensity. Total must be within the panel circuit rating (often 0.5 A or 1 A per
              sounder circuit on conventional systems; loop current limits on addressable systems).
            </li>
            <li>
              <strong>Cable voltage drop.</strong> Cable resistance × alarm current = voltage drop.
              End-of-line voltage must remain above the manufacturer's minimum operating voltage
              (typically 18-21 V on a 24 V system). Long runs with high alarm current can drop
              end-of-line voltage below the threshold; the fix is larger cable or shorter circuit
              segments.
            </li>
            <li>
              ...
              alarm operation, with appropriate margins for battery ageing. Quiescent current (panel
              + detectors + interfaces, typically 100-500 mA total for a small system) drives the
              24-hour requirement; alarm current drives the 30-minute requirement. The battery sizes
              typically work out to 7-50 Ah depending on system size.
            </li>
            <li>
              <strong>End-of-line monitoring.</strong> Conventional sounder circuits use an
              end-of-line resistor to allow the panel to detect open or short faults on the circuit.
              Addressable systems typically use isolators and built-in monitoring. The end-of-line
              component must be specified in the design and present at commissioning.
            </li>
          </ul>
          <p>
            ...
            load-calculation software is the practical tool; experienced engineers cross-check with
            manual calculations on critical or unusual installations.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              quiescent state for at least 24 hours, after which it should be capable of supporting
              full alarm load for at least 30 minutes. Where the building is unoccupied for periods
              exceeding 24 hours, the quiescent period may need to be extended (e.g. 72 hours) to
              ensure faults can be addressed before battery exhaust. Battery capacity calculations
              should include appropriate ageing margins and the maximum expected fault-condition
              current.
            </>
          }
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-2/section-5')}
