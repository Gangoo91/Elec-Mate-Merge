...
const DESCRIPTION =
  'Understand BS 5839-1 for non-domestic fire detection systems including L and P categories, M systems, design principles and installation standards.';
    ...
    () => [
      {
        ...
        correctAnswer: 1,
        explanation:
          'L categories are designed primarily for Life safety, providing early warning to enable safe evacuation of building occupants.',
      },
      {
        id: 2,
        ...
        correctAnswer: 2,
        explanation:
          'L1 provides the highest level of life safety protection with automatic detection throughout all areas of the building.',
      },
      {
        id: 3,
        ...
        correctAnswer: 1,
        explanation:
          'P categories are designed for Property protection, minimising damage to the building and contents by providing early fire detection.',
      },
      {
        id: 4,
        ...
        correctAnswer: 1,
        explanation:
          'M (Manual) systems consist of manual call points only, with no automatic fire detection. They rely on people discovering and reporting fires.',
      },
      {
        id: 5,
        question:
          'Which L category provides detection in escape routes PLUS rooms opening onto them?',
        options: ['L1', 'L2', 'L3', 'L4'],
        correctAnswer: 2,
        explanation:
          'L3 provides detection in escape routes and all rooms that open directly onto escape routes, providing early warning if a fire develops near an escape path.',
      },
      {
        id: 6,
        question:
          'What is the maximum spacing between point smoke detectors in rooms up to 5m high?',
        options: ['5.3m centres', '7.5m centres', '10.6m centres', '12.5m centres'],
        correctAnswer: 2,
        explanation:
          'BS 5839-1 recommends 10.6m spacing between point smoke detectors in rooms up to 5m high for flat ceilings.',
      },
      {
        id: 7,
        question: 'How far from walls should point smoke detectors generally be positioned?',
        options: ['At least 300mm', 'At least 500mm', 'At least 1000mm', 'No minimum distance'],
        correctAnswer: 1,
        explanation:
          'Point detectors should be at least 500mm from walls and obstructions to avoid dead air spaces that could delay smoke reaching the detector.',
      },
      {
        id: 8,
        question:
          'What minimum sound level must fire alarms achieve at bed head height in sleeping areas?',
        options: ['65dB(A)', '70dB(A)', '75dB(A)', '85dB(A)'],
        correctAnswer: 2,
        explanation:
          'Fire alarms must achieve a minimum 75dB(A) at bed head height in sleeping areas to ensure occupants are awakened.',
      },
      {
        id: 9,
        ...
        correctAnswer: 1,
        explanation:
          'BS 5839-1 requires a minimum 24-hour standby power capacity followed by a 30-minute alarm period, or 72 hours for some enhanced systems.',
      },
      {
        id: 10,
        ...
        correctAnswer: 2,
        explanation:
          'L4 provides automatic detection in escape routes only (corridors, stairways, lobbies) and is the minimum automatic coverage for life safety.',
      },
    ],
    []
  );
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
        ...
        <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <ul className="space-y-2 text-white text-sm">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong className="text-white">L categories</strong> (L1-L5) provide life safety
                protection with varying levels of coverage
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">P categories</strong> (P1-P2) are designed for
                property protection
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">M systems</strong> provide manual call points only
            ...
            <div className="bg-white/5 rounded-lg p-3">
              ...
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  ...
                  Commercial premises (offices, shops, factories)
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
            ...
            <div className="bg-white/5 rounded-lg p-3">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Full coverage:</strong> Detection throughout ALL
                    areas including toilets, cupboards and voids
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-6 h-5 rounded bg-elec-yellow/20 flex items-center justify-center flex-shrink-0 text-xs font-bold text-elec-yellow">
                  ...
                  <span>
                    <strong className="text-white">Escape routes + high risk:</strong> Detection in
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Escape routes + rooms:</strong> Detection in
                    escape routes and rooms opening onto them
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-6 h-5 rounded bg-elec-yellow/20 flex items-center justify-center flex-shrink-0 text-xs font-bold text-elec-yellow">
                  ...
                  <span>
                    <strong className="text-white">Escape routes only:</strong> Detection in
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Engineered solution:</strong> Coverage to satisfy
          ...
          <div className="space-y-3 text-sm text-white">
            ...
            <div className="bg-white/5 rounded-lg p-3">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Full property coverage:</strong> Detection
                    throughout ALL areas for maximum property protection
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-6 h-5 rounded bg-elec-yellow/20 flex items-center justify-center flex-shrink-0 text-xs font-bold text-elec-yellow">
                  ...
                  <span>
                    <strong className="text-white">Defined areas:</strong> Detection in specified
                    high-value or high-risk areas only
                  </span>
                </li>
              </ul>
            </div>
            <div className="bg-white/5 rounded-lg p-3 mt-3">
              ...
              <ul className="space-y-1 text-sm">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Relies on people discovering and reporting fires
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Minimum requirement for many premises
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Often combined with L or P categories for automatic detection
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <div className="space-y-3 text-sm text-white">
            <p>
              ...
              whilst avoiding excessive installation costs.
            </p>
            <div className="bg-white/5 rounded-lg p-3">
              <p className="text-sm font-semibold text-white mb-2">
                Point Smoke Detector Spacing (Flat Ceilings up to 5m):
              </p>
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  <strong>Maximum spacing:</strong> 10.6m between detectors
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  <strong>Maximum from walls:</strong> 7.5m to nearest detector
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  <strong>Minimum from walls:</strong> 500mm from any wall or obstruction
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  <strong>Maximum from ceiling:</strong> 25-150mm depending on type
                </li>
              </ul>
            </div>
            <div className="bg-white/5 rounded-lg p-3 mt-3">
              ...
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  <strong>Maximum spacing:</strong> 7.5m between detectors
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  <strong>Maximum from walls:</strong> 5.3m to nearest detector
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <div className="space-y-3 text-sm text-white">
            <p>
              ...
              the alarm, regardless of location.
            </p>
            <div className="bg-white/5 rounded-lg p-3">
              <p className="text-sm font-semibold text-white mb-2">
              ...
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  <strong>General areas:</strong> 65dB(A) minimum, or 5dB(A) above background noise
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  <strong>Sleeping areas:</strong> 75dB(A) at bed head height
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  <strong>BS 5839-1:</strong> Recommends 65dB(A) at 3m for sounders
                </li>
              </ul>
            </div>
            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-3">
              <p className="text-sm text-red-300 flex items-start gap-2">
                ...
                Visual alarm devices (VADs) should be provided where hearing-impaired people may be
                present, particularly in sanitary facilities.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 rounded-lg bg-white/5 border border-white/10">
          ...
          <div className="space-y-3 text-sm text-white">
            <p>
              ...
              to maintain operation during mains failure.
            </p>
            <div className="bg-white/5 rounded-lg p-3">
              <p className="text-sm font-semibold text-white mb-2">
              ...
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  <strong>Primary supply:</strong> Dedicated mains supply from building distribution
                  board
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  <strong>Standby batteries:</strong> Minimum 24 hours standby + 30 minutes alarm
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  <strong>Enhanced standby:</strong> 72 hours for systems requiring extended
                  autonomy
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  <strong>Automatic changeover:</strong> Between mains and battery supplies
                </li>
              </ul>
            </div>
            <div className="bg-white/5 rounded-lg p-3 mt-3">
              ...
              <ul className="space-y-1 text-sm">
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Sealed lead-acid or nickel-cadmium batteries typically used
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Automatic charging with fault indication
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Design life typically 4-5 years for lead-acid
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Capacity calculation must account for system load
                </li>
              </ul>
            </div>
        ...
        <div className="space-y-3">
          <div className="p-4 rounded-lg bg-white/5 border border-green-500/20">
            ...
            <ul className="space-y-2 text-sm text-white">
              ...
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                Consider combining L and P categories - e.g. L3 for life safety plus P2 for server
                room protection
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                Document your category selection rationale in the design specification for future
                reference
              </li>
            </ul>
          </div>
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-red-500/20">
            ...
            <ul className="space-y-2 text-sm text-white">
              ...
              <li className="flex items-start gap-2">
                <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                Installing detectors too close to walls where dead air can prevent smoke reaching
                them
              </li>
              <li className="flex items-start gap-2">
                <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
      ...
      <section className="px-4 sm:px-6 pb-6 max-w-3xl mx-auto">
        ...
        <div className="space-y-3">
          {[
            {
              q: 'Can L and P categories be combined in the same building?',
              a: 'Yes - it is common to specify an L category for life safety plus a P category for additional property protection in high-value areas like server rooms or archives.',
            },
            {
              q: 'When should L1 be specified rather than L2?',
              a: 'L1 is typically required for premises with sleeping risk (hotels, care homes), complex escape routes, or where the fire risk assessment identifies the need for full coverage.',
            },
            {
              q: 'What is an L5 system and when is it used?',
              a: 'L5 is a bespoke category where detection is engineered to satisfy a specific fire safety objective that does not fit L1-L4 patterns - for example, protecting a specific process area.',
            },
            {
              q: 'Do all buildings require automatic detection?',
              a: 'No - some low-risk premises may only need M (manual) systems. The fire risk assessment determines what level of detection is appropriate.',
            },
            {
              q: 'How do I calculate battery standby capacity?',
              a: 'Calculate the total system load (quiescent current), multiply by standby duration (typically 24 hours), then add the alarm load for the alarm period (typically 30 minutes).',
            },
            {
              q: 'Can detector spacing be reduced in high-ceiling areas?',
              a: 'Detector spacing may need reducing in areas over 5m ceiling height. BS 5839-1 provides specific guidance for different ceiling heights and detector types.',
            },
          ].map((faq, i) => (
