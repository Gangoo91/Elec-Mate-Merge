...
const FireAlarmModule7Section3 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 7 · Section 3" title="BS 5839-1 requirements" backTo=".." />
      <HubBody>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Referenced by ADB.</strong> Approved Document B Volume 2 references BS 5839-1
              as the route to B1 (warning and escape) compliance for non-domestic premises.
            ...
            <li>
              <strong>Variations and unacceptable variations.</strong> The 2025 revision retains the
              variations concept but introduces "unacceptable variations" — departures that are so
              detrimental to safety that they should not be regarded as acceptable variations. These
              are explicitly listed.
            </li>
            <li>
              <strong>Logbook recording of variations.</strong> The 2025 revision changed the
              logbook clause to require ALL agreed variations to be recorded (was "major" variations
              in 2017, with "major" undefined). Every departure from BS 5839-1 recommendations must
              now appear in the logbook with justification.
            </li>
          </ul>
          <p>
            ...
            experience, technological change (IP networking, multi-sensor detectors, cyber-connected
            CIE), and post-Grenfell regulatory pressure. The new section on extensions and
            modifications (Section 7) recognises that most fire alarm work in the UK is on existing
            systems, not new build.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Compliance with a British Standard cannot confer immunity from legal obligations. This
              British Standard is a code of practice. It takes the form of guidance and
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Category M — Manual only.</strong> Manual call points (MCPs) and sounders. No
              automatic detection. Used in premises where the FRA concludes that human detection is
              reliable and timely (small offices, low-risk shops).
            </li>
            <li>
            ...
            <li>
              ...
              people sleep where any AFD is provided in those rooms (objective remains escape route,
              but heat detection in sleeping rooms is inappropriate even where it is added).
            </li>
            <li>
              <strong>Category L4 — Life protection, circulation spaces.</strong> AFD in circulation
              spaces forming part of the escape routes only. Smaller scope than L3. Used where the
              FRA / fire strategy concludes that limited detection is adequate. 2025 CHANGE: where
              flue-like structures are present, a detector at the top of the flue is now recommended
              (unlike L1, L2, L3, P1, no detector required at every floor penetration in L4).
            </li>
            <li>
              ...
              fire strategy says detection is needed for life safety but the L1-L4 frameworks don't
              fit cleanly.
            </li>
            <li>
              <strong>Category P1 — Property protection, full coverage.</strong> AFD throughout the
              protected premises (excluding the same low-risk locations as L1) but with the primary
              objective of property / business continuity protection rather than life safety. Often
              combined with Cat L for premises with both life and property concerns.
            </li>
            <li>
              <strong>Category P2 — Property protection, defined area.</strong> AFD in defined parts
              of the premises only — typically high-value or high-criticality areas (server rooms,
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              selection and configuration. The commissioning technician programs the device per the
              design and records the setting in the operating and maintenance manual. Annex D Figure
              D.1 gives a recommended recording format.
            </li>
            <li>
              <strong>Sprinkler heads as heat detection.</strong> Where sprinkler heads are used to
              initiate a fire condition on the CIE (a long-standing BS 5839-1 acceptance), the 2025
              revision adds a new recommendation: the indication of sprinkler operation should be
              such that there can be no confusion between the area in which the sprinkler has
              operated and any of the fire detection zones. The sprinkler zone should not overlap
              with more than one fire detection zone. (Avoids ambiguity at cause-and-effect — the
              FRS arriving sees clearly which area the sprinkler has operated in.)
            </li>
            <li>
          ...
          <p>
            For the contractor, the operational consequence is that any 2025+ design or significant
            upgrade in a premises with sleeping risk must specify smoke or multi-sensor in those
            rooms. Quotations for upgrades should explicitly confirm or exclude the sleeping-room
            detection upgrade — silence is not acceptable.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              that include lobby ventilation (i.e. lobbies separating accommodation from stairways).
              Common in residential blocks, hotels, hospitals, multi-let offices.
            </li>
            <li>
            ...
            <li>
              ...
              rather than with the stairway — so that the alarm panel indicates the floor of origin
              clearly to FRS arriving.
            </li>
            <li>
              <strong>Cause-and-effect.</strong> Stairway lobby detection typically initiates local
              sounders (the alarm in the affected area), and may interact with smoke ventilation,
              AOV (automatic opening vent) operation, and lift call-down depending on the building's
              fire strategy.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Causes.</strong> Each input device (or category of device) and the zone / area
              it covers. Smoke detector in zone 3, heat detector in zone 4, MCP at exit X, etc.
            </li>
            <li>
            ...
            <li>
              <strong>Mapping.</strong> For each cause, which effects activate. For complex systems
              with phased evacuation, two-stage alarm, or zoned response, the matrix shows which
              causes trigger which combinations of effects.
            </li>
            <li>
          ...
          <p>
            ...
            cause-and-effect is a primary Article 38 artefact. Without it, the responsible person is
            in default of Article 38; the contractor who handed the system over without one is in
            default of professional duty. The 2025 BS 5839-1 explicit requirement closes the
            loophole.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              should be included with the documentation that is provided to the purchaser or user of
              the system. NOTE: For a system that operates as a simultaneous evacuation, this could
              be as simple as a statement to that effect. For more complex strategies, a
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              ...
              <text x="440" y="188" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="9">
                flat entrance
              </text>
              <text x="440" y="200" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="9">
                door
              </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              interface. Anti-tamper plugs in patch leads that would otherwise be accessible. Limit
              physical access to the equipment to authorised persons.
            </li>
            <li>
              <strong>Authentication.</strong> Remote-connection requests should be authenticated in
              the CIE or gateway software before remote access is allowed. The principle: no
              unauthenticated remote connection.
            </li>
            <li>
              <strong>Risk assessment before remote work.</strong> Particularly for read / control /
              write functions, a risk assessment evaluates the impact on CIE operation. If there is
              risk that the remote service might compromise CIE function, the responsible individual
              must ensure full operational verification on completion.
            </li>
            <li>
              <strong>Audit trail.</strong> Remote service activities should leave an audit trail in
              the CIE log.
            </li>
            <li>
              <strong>Network architecture.</strong> Where the fire alarm system shares network with
              other building systems, isolation / segmentation should prevent cross-contamination of
              cyber risk.
            </li>
          </ul>
          <p>
            This is a new operational area for many fire alarm contractors. The competence expected
            post-2025 includes basic cyber-aware practice — segregating fire alarm networks from
            general IT, configuring authentication, conducting risk assessment before remote
            intervention. Contractors who treat their CIE network port as "just another connection"
            are not 2025-compliant.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Cat P — catastrophic-fail indication:</strong> ≤ 31 minutes (at ARC AND CIE).
            </li>
            <li>
              <strong>Power supply for transmission equipment.</strong> Where a separate PSU is used
              to power alarm transmission equipment, it should conform to BS EN 54-4 OR BS EN
            ...
            <li>
              <strong>False alarm notice.</strong> The 2025 revision recommends a label fixed to or
              adjacent to the CIE: "False alarm notice — this fire alarm has an active connection to
              the fire and rescue service. Contact telephone: [ARC number]." Reduces FRS attendance
              to false alarms by reminding premises management to notify the ARC before testing.
            </li>
            <li>
              <strong>ARC information.</strong> The ARC should be provided with all relevant
              information about the premises (e.g. whether sleeping accommodation is present), so it
              can pass that information to FRS on alarm. Where practicable, the alarm signal should
              indicate the nature of the triggering device (smoke / heat / MCP) and whether
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              should be received at the ARC within a maximum of 90 s; a catastrophic failure of the
              transmission system (whereby no alarm signals can be transmitted) should be indicated
              at the ARC and the CIE within 3 min. 14.18 For Category P systems, in the event of a
              fire alarm signal, an indication should be received at the ARC within a maximum of 120
              s; a catastrophic failure of the transmission system (whereby no alarm signals can be
              transmitted) should be indicated at the ARC and the CIE within 31 min.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>LV mains supply to FA system.</strong> Same colour. Red preferred. This is the
              2025 clarification — the 2017 was silent on the mains supply colour.
            </li>
            <li>
              <strong>FE (functional earth) conductor.</strong> Pink. Marked or coloured pink with
              the alphanumeric designation "FE". This change reflects BS 7671 / IEC 60445 amendment
              2 (2022). Previous colour was cream.
            </li>
            <li>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Protective covers.</strong> Where used, recommended to be transparent (so the
              MCP indicator remains visible).
            </li>
            <li>
              ...
              should be incorporated within the zone that serves the adjacent accommodation on that
              level." Cleaner wording, same operational effect.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              diagrammatic representation as recommended in §22.2.5) in premises with more than one
              zone on any storey, particularly premises in which people sleep. The reasoning:
            ...
            <li>
              <strong>ARC absence in supported housing / residential care.</strong> The absence of a
              facility for transmission of fire alarm signals to an Alarm Receiving Centre in either
              (a) supported housing in which the facility is considered necessary to meet the
              recommendations of BS 5839-1 (where a Grade A system per BS 5839-6 is necessary), or
              (b) a residential care home. The reasoning: in premises with vulnerable sleeping
              occupants and limited self-evacuation capability, ARC connection is the difference
              between a 90-second response and an unsignalled fire.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              variations. These are: (a) The absence of a zone plan (or other suitable diagrammatic
              representation as recommended in 22.2.5) in premises in which there is more than one
              zone on any storey, particularly premises in which people sleep; (b) The absence of a
              facility for transmission of fire alarm signals to an ARC in either (i) supported
              housing in which the facility is considered necessary to meet the recommendations of
              BS 5839-1 (where a Grade A system according to BS 5839-6:2019 is necessary); or (ii) a
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Subsequent visits.</strong> Each at approximately 6 months from the previous,
              with the same 5-7 tolerance band.
            </li>
            <li>
              <strong>Outside the window.</strong> Non-compliant. The system is "no longer compliant
              with this part of BS 5839" in the language of the 2017 revision.
            </li>
            <li>
            ...
            <li>
              ...
              management informs the servicing organisation of any text-descriptor changes; periodic
              verification (e.g. every 5 years) is prudent. The 2025 standard does not require text
              descriptor verification at every routine service.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-7/section-4')}
