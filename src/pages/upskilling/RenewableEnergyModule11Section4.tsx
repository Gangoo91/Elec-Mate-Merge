...
const inlineChecks = [
  ...
  },
  {
    ...
    question: 'How does LPS apply to a 12 m wind turbine mast in a rural location?',
    options: [
  ...
  },
  {
    ...
    question: 'What earth resistance target does BS EN 62305-3 set for the LPS earth termination?',
    options: [
...
const quizQuestions = [
  ...
  {
    question: 'What is the BS EN 62305-3 inspection cycle for an LPS, and who does it?',
    options: [
...
export default function RenewableEnergyModule11Section4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 11 · Section 4 · BS EN 62305-3 · LPS for PV / wind · Reg 712.534.101"
        title="BS EN 62305-3 lightning protection for PV / wind installs"
        backTo="../renewable-energy-module-11"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          External Lightning Protection System (LPS) per BS EN 62305-3 — air termination, down
          conductors, earth termination, bonding. PV separation distance s. Bonding alternative per
          Reg 712.534.101 / .102.1. Wind turbine mast LPS + IEC 61400-24.
        </p>
        ...
        <Pullquote>
          Air termination catches the strike. Down conductor carries it. Earth termination disperses
          it. Bonding equalises everything else. Three jobs, one system.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Rolling sphere</strong>— geometric method. A sphere of
              LPL-specific radius is rolled across the structure; anywhere the sphere cannot touch
              is "protected". Radius: LPL I = 20 m, II = 30 m, III = 45 m, IV = 60 m. Used for
              complex roof geometries
            </li>
            <li>
              <strong className="text-white">Mesh method</strong>— horizontal conductor grid on the
              roof with LPL-specific spacing. Mesh: LPL I = 5 m × 5 m, II = 10 m × 10 m, III = 15 m
              × 15 m, IV = 20 m × 20 m. Suitable for flat / large roofs
            </li>
            <li>
              <strong className="text-white">Protection angle</strong>— each air termination rod
              creates a cone of protection downward at an LPL- + height-specific angle. Best for
              simple structures with rods at corners + ridges
            </li>
            <li>
              <strong className="text-white">Materials + size</strong>— copper minimum 50 mm² (rods
              + horizontal conductors); aluminium 75 mm²; galvanised steel 50 mm². BS EN 62305-3
              Table 6 specifies
            </li>
            <li>
              <strong className="text-white">Connection</strong>— air termination conductors connect
              to down conductors via low-impedance bonded joints. Critical for current path
            </li>
            <li>
              <strong className="text-white">Natural air termination</strong>— metallic roof
              elements (ridge tiles, metal flashing, antennae) may serve if adequate cross-section +
              bonded into the LPS. BS EN 62305-3 Section 5.2 specifies criteria
            </li>
            <li>
              <strong className="text-white">PV interaction</strong>— PV array adds raised metallic
              mass; air termination must protect it OR PV is bonded to LPS (Reg 712.534.101).
              Designer coordinates array layout vs air termination
            </li>
            <li>
              <strong className="text-white">Cert evidence</strong>— air termination layout diagram
              + method (rolling sphere / mesh / protection angle) + LPL chosen + material
              specifications
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Spacing</strong>— LPL I = 10 m, II = 10 m, III = 15 m,
              IV = 20 m typical around structure perimeter. More conductors = better current sharing
              kc factor for separation distance s
            </li>
            <li>
              <strong className="text-white">Routing</strong>— vertical along external walls;
              shortest practical path from air termination to earth; avoid loops (which can induce
              voltages during current pulse)
            </li>
            <li>
              <strong className="text-white">Materials</strong>— copper 50 mm² minimum; aluminium 70
              mm²; galvanised steel 50 mm² equivalent. BS EN 62305-3 Table 6
            </li>
            <li>
              <strong className="text-white">Bonding to floors</strong>— at every floor level, the
              down conductor bonds to the structure\'s equipotential bonding bar on that floor.
              Equalises potential during strike
            </li>
            <li>
              <strong className="text-white">Inspection access</strong>— at top (connection to air
              termination) + bottom (connection to earth termination); test joint for continuity
              measurement
            </li>
            <li>
              <strong className="text-white">Structural steel as natural down conductor</strong> —
              per BS EN 62305-3 Section 5.3.5, continuous structural steel (frame, columns) with
              adequate cross-section + electrical continuity may serve as down conductor. Common in
              modern commercial / industrial
            </li>
            <li>
              <strong className="text-white">Wind turbine mast</strong>— steel monopole / tubular
              mast that is continuous + adequate CSA serves as the down conductor; otherwise
              dedicated copper 50 mm² routed along mast
            </li>
            <li>
              <strong className="text-white">Cert evidence</strong>— down conductor count + spacing
              + routing diagram + material specifications + continuity test report
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Keep s, or bond + protect. The PV designer\'s lightning question reduces to those two
          paths — and the SPD type follows from the choice.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Path 1: Maintain s</strong>— PV "isolated" from LPS.
              Calculate s per BS EN 62305-3 Section 6.3; plan array layout so all PV metal parts
              (frame, mounting, DC cable) are at distance ≥ s from LPS air termination + down
              conductors. Reg 712.534.102.1: Type 2 SPDs apply on DC + AC sides
            </li>
            <li>
              <strong className="text-white">Path 2: Bonded</strong>— PV "non-isolated" from LPS.
              Bond PV frame at corners + intervals to LPS at designated coordination points; accept
              that partial direct lightning current can flow through PV elements. Reg 712.534.102.1:
              Type 1 SPDs required (typically with Type 2 downstream)
            </li>
            <li>
              <strong className="text-white">Path choice factors</strong>— roof geometry (s
              achievable?); aesthetic / planning constraints (visible air termination changes?);
              cost of bonding + Type 1 SPDs vs cost of re-routing LPS to gain s; customer preference
              + LPS specialist recommendation
            </li>
            <li>
              <strong className="text-white">Hybrid approach</strong>— large arrays may have some
              strings isolated + others bonded. Cert evidence per zone of array
            </li>
            <li>
              <strong className="text-white">Bonding details (Path 2)</strong> — 16 mm² Cu minimum
              bonding conductor at array corners + at intervals ~10-15 m along frame; shortest path
              to nearest LPS down conductor; DC cable shields (if used) bonded at both ends; BS EN
              62305-3 Annex specifies conductor cross-section per material
            </li>
            <li>
              <strong className="text-white">Type 1 SPD location (Path 2)</strong> — at PV DC entry
              to building (where DC cables cross LPZ 0/1 boundary); also at AC side at origin if
              structure has LPS. Followed by Type 2 downstream
            </li>
            <li>
              <strong className="text-white">Bonding does NOT replace SPDs</strong> — bonding
              equalises potential during strike; SPDs limit residual transient voltage at equipment.
              Both required in Path 2
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — path chosen + BS EN
              62305-3 calculation (s or bonding diagram) + SPD selection (Type 1 / 2 per path) + LPS
              specialist sign-off
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Risk assessment</strong>— short BS EN 62305-2 summary:
              R1 + R4 calculated; R1 typically 10⁻⁶-10⁻⁷ per year (below tolerable 10⁻⁵); R4
              owner-assessed (LCT replacement cost £8-15k)
            </li>
            <li>
              <strong className="text-white">SPD requirement trigger</strong> — Reg 443.4.1
              (A4:2026) — significant financial / data loss (c) criterion applies to LCT install;
              SPD required unless owner explicitly opts out
            </li>
            <li>
              <strong className="text-white">SPD selection</strong>— Reg 712.534.102.1: Type 2
              generally for PV; no LPS = no direct strike protection scope = no Type 1 requirement
            </li>
            <li>
              <strong className="text-white">SPD locations</strong>— (1) AC side at origin: Type 2
              SPD at consumer unit; (2) DC side near inverter: Type 2 SPD on DC strings before
              inverter. Reg 534.4.1.1 + Reg 534.4.8 ≤10 m criterion
            </li>
            <li>
              <strong className="text-white">Bonding</strong>— PV frame bonded to inverter / system
              protective earth per BS 7671 Reg 411.3 + Reg 543; no LPS bonding needed (no LPS
              present)
            </li>
            <li>
              <strong className="text-white">Earth electrode</strong>— typical TT or TN-C-S / TN-S
              supply earthing per BS 7671 Chapter 54; no LPS earth termination to coordinate
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — BS EN 62305-2 risk
              summary (1-2 paragraphs); SPD selection record (Type 2 × 2 locations); Reg
              712.534.102.1 compliance noted; PV manufacturer DoC; standard PV documentation + BS
              7671 EIC
            </li>
            <li>
              <strong className="text-white">Customer evidence</strong>— short + clear; no LPS
              specialist required; designer-led end-to-end
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Turbine-side protection (manufacturer)</strong> — per
              IEC 61400-24. Blade tip receptors connected via internal down conductors through blade
              root to hub. Hub + main shaft bonded to nacelle. Yaw + pitch bearings protected via
              slip rings / brush contacts. Nacelle electromagnetic shielding
            </li>
            <li>
              <strong className="text-white">LPL choice</strong>— per IEC 61400-24 + risk
              assessment. LPL II typical for utility-scale turbines; LPL III for small wind ≤50 kW.
              Manufacturer DoC declares LPL
            </li>
            <li>
              <strong className="text-white">Mast as down conductor</strong>— steel monopole /
              tubular mast continuous metallic structure serves as down conductor if cross-section
              adequate (steel typically 50 mm² equivalent or much greater for structural mast).
              Bonded to turbine nacelle base at top + earth termination at bottom
            </li>
            <li>
              <strong className="text-white">Dedicated down conductor</strong>— if mast is not
              continuous (composite, sectional, bolted with non-conductive interfaces), dedicated
              copper 50 mm² down conductor runs along mast exterior
            </li>
            <li>
              <strong className="text-white">Earth termination at base</strong> — dedicated
              electrode arrangement: multiple rods in array OR ring earth around mast base; &lt;10 Ω
              target; bonded to local equipotential network + building earth where mast is close to
              building
            </li>
            <li>
              <strong className="text-white">Cable entry SPDs</strong>— DC power + control cables
              from nacelle to ground control panel cross LPZ 0/1 boundary at building entry; Type 1
              SPDs (direct partial lightning current possible) typically with Type 2 downstream;
              bonded at entry to common equipotential bonding bar
            </li>
            <li>
              <strong className="text-white">Equipotential bonding</strong>— mast earth termination
              + building main earthing terminal bonded together per Reg 411.3.1.2; structural steel
              + buried services also bonded
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — manufacturer DoC (IEC
              61400-24); BS EN 62305-3 mast LPS design; earth resistance test; LPS specialist
              sign-off; BS 7671 SPD + bonding records; EIC
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Risk assessment</strong>— BS EN 62305-2 full or
              detailed summary; rural exposed terrain + tall isolated structure typically warrants
              LPL III mast LPS
            </li>
            <li>
              <strong className="text-white">Turbine DoC</strong>— manufacturer-supplied per IEC
              61400-24; covers blade / hub / nacelle / bearing strike protection; LPS specialist
              verifies
            </li>
            <li>
              <strong className="text-white">Mast LPS</strong>— usually the monopole steel mast
              structure is the down conductor (continuous + adequate CSA); LPS specialist confirms
              continuity + cross-section
            </li>
            <li>
              <strong className="text-white">Earth termination challenge</strong> — rural soil
              conditions vary widely; rocky / sandy / dry soil makes &lt;10 Ω hard to achieve.
              Solutions: multiple rod array (4-8 rods in 3-5 m spacing); ring earth around mast
              base; chemical earth enhancement (bentonite); deep-driven rods. Earth resistance test
              confirms
            </li>
            <li>
              <strong className="text-white">Cable run from turbine</strong> — DC power + control
              cables from nacelle to ground control panel; typically armoured cables with shield
              bonded at both ends; shortest practical path
            </li>
            <li>
              <strong className="text-white">Building entry SPDs</strong>— Type 1 SPDs at the
              control panel entry (direct partial lightning current possible from mast cables); Type
              2 downstream at sub-distribution + at inverter input
            </li>
            <li>
              <strong className="text-white">Multi-source PEI integration</strong> — if combined
              with PV + BESS (Chapter 82), each source contributes to LCT + fault current
              architecture; SPD + bonding coordinated across all sources
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — turbine manufacturer
              DoC + BS EN 62305-2 risk + BS EN 62305-3 LPS design + earth resistance test + LPS
              specialist sign-off + BS 7671 SPD + EIC + MCS MIS 3003 small wind handover pack
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-11-section-3')}
