...
const DESCRIPTION =
  'Learn how to test RCD trip times at rated and 5x rated current, and interpret results for BS 7671 compliance.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Fastest time', 'Average of times', 'Longer of the two times', 'Shortest time only'],
    correctIndex: 2,
    explanation:
      'Record the longer (worst case) trip time as this determines compliance with maximum limits.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Instant tripping', 'Trip within 300ms', 'No trip', 'Trip within 40ms'],
    correctAnswer: 2,
    explanation:
      "The x1/2 test confirms the RCD doesn't trip at currents below threshold, avoiding nuisance tripping.",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Testing both angles confirms the RCD operates correctly regardless of where in the AC cycle the fault occurs.',
  },
  {
    id: 6,
    question: 'When recording trip times, note the:',
    ...
    correctAnswer: 2,
    explanation:
      'Record the longer trip time (worst case) as this determines compliance with maximum limits.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'S-type RCDs are deliberately time-delayed for discrimination. They have different (longer) maximum trip times.',
  },
  {
    id: 8,
    question: 'If a 30mA RCD trips in 350ms at rated current:',
    options: ['This is acceptable', 'This is a failure', 'Retest at 180 degrees', 'Check the fuse'],
    correctAnswer: 1,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'RCD testing requires live supply. The test injects current to simulate a fault and measures trip response.',
  },
  {
    id: 10,
    question: 'At 15mA (x1/2 of 30mA RCD), the expected result is:',
    options: ['Trip within 40ms', 'Trip within 300ms', 'No trip', 'Trip within 1 second'],
    correctAnswer: 2,
    explanation:
      "At half rated current, the RCD should NOT trip. This confirms it won't nuisance trip at normal leakage levels.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      "At IΔn (rated current): 300ms maximum. At 5xIΔn: 40ms maximum. Time-delayed (S-type) RCDs have different, longer limits as they're designed for discrimination.",
  },
  {
    question: 'Why test at both x1 and x5?',
    answer:
      'The x1 test confirms the RCD operates at its threshold. The x5 test verifies fast operation for higher fault currents - important for shock protection where the dangerous current is greater.',
  },
  {
    question: 'What does the x1/2 test confirm?',
    answer:
      "Testing at half rated current (15mA for a 30mA RCD) confirms the RCD does NOT trip. This verifies it won't nuisance trip at normal leakage levels. No trip should occur within the test period.",
  },
  {
    question: 'Why test at both 0 degrees and 180 degrees phase angles?',
    answer:
      'Fault currents can occur at any point in the AC waveform. Testing at both 0 degrees and 180 degrees checks the RCD operates correctly regardless of when the fault occurs. Record the longer of the two times.',
  },
  {
    question: 'What if trip time is just at the limit?',
    answer:
      'If trip time is at or near the maximum, the RCD passes but may be deteriorating. Note this and recommend monitoring or replacement. Significantly over the limit is a failure.',
  },
  {
    question: 'How do I test a 30mA RCD?',
    answer:
      'Set tester to 30mA (x1) for standard trip test. For x5, set to 150mA. Record actual trip time displayed. Compare to maximum allowed (300ms at 30mA, 40ms at 150mA).',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>x1 Test:</strong> Must trip within 300ms
              </li>
              <li>
                <strong>x5 Test:</strong> Must trip within 40ms
              </li>
              <li>
                <strong>x1/2 Test:</strong> Must NOT trip
              </li>
              <li>
                <strong>Record:</strong> Longer of two phase angles
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>30mA x5:</strong> 150mA test current
              </li>
              <li>
                <strong>30mA x1/2:</strong> 15mA test current
              </li>
              <li>
                <strong>S-type x1:</strong> 130-500ms
              </li>
              <li>
                <strong>S-type x5:</strong> 50-150ms
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              RCDs must disconnect within specific time limits to provide effective protection. BS
              EN 61008/61009 specify maximum trip times:
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Follow this sequence for comprehensive RCD testing:</p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Each test current serves a specific purpose:</p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Faults can occur at any point in the AC cycle. Testing at both 0 degrees and 180
              degrees confirms reliable operation:
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Record:</strong> The longer of the two trip times - this is the worst-case
              performance.
            </p>
          </div>
        </section>
