    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The three-step trip-time sequence per BS EN 61557-6, the must-trip and must-not-trip
          windows from BS EN 61008-1 / 61009-1, and why every test is run twice — once at 0° and
          once at 180°.
        </p>
        ...
        >
          <p>
            Reg 643.8 is the BS 7671 verification regulation for RCDs. It applies wherever an RCD is
            providing additional protection — which, after A4:2026 and earlier amendments, is
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Visual inspection plus testing — both elements are required. A test result on its own
              is not the verification; the inspector must also have looked at the device, its
              labelling and its installation.
            </li>
            <li>
              The test must be carried out using equipment to BS EN 61557-6. A general-purpose
              multifunction tester that does not include RCD test functions to that standard is not
              acceptable.
            </li>
            <li>
          ...
          <p>
            ...
            necessary one. A device that disconnects within tighter product-standard limits (e.g. 40
            ms at 5×IΔn for a 30 mA non-delayed RCD) is automatically within the 300 ms upper bound.
            The product-standard limits are what most installers actually test against, because that
            is what the test instruments report.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              protection is fulfilled by visual inspection and testing. Where RCDs are required for
              additional protection, the effectiveness of automatic disconnection of supply by RCDs
              shall be verified using suitable test equipment according to BS EN 61557-6 to confirm
              that the relevant requirements of Chapter 41 are met. NOTE: Regardless of RCD Type,
              effectiveness is deemed to have been verified where an RCD disconnects within the time
              stated below with an alternating current test at rated residual operating current
              (IΔn): for general non-delay type, 300 ms maximum.
            </>
          }
        ...
        >
          <p>
            ...
            not operate when subjected to a residual current equivalent to 50% of its rated tripping
            current. The test instrument applies that current for a defined duration (typically 2
            seconds for portable testers) and reports either a non-operation ("pass") or the trip
            time if it did open.
          </p>
          <p>
            Why the test matters in service: an RCD whose mechanism has aged or been contaminated
            can become unintentionally sensitive. The visible symptom is "the RCD keeps tripping for
            no reason". The 0.5×IΔn test is the one that proves it is the device, not the circuit. A
            device that fails the 0.5×IΔn test should be replaced, not blamed on the user.
            Conversely, a device that passes 0.5×IΔn (does not trip) and also trips at the correct
            time at IΔn × 1 has a healthy operating envelope.
          </p>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              BS EN 61008-1 / 61009-1. The minimum is critical: a Type S that trips faster than 130
              ms cannot give selectivity over a downstream non-delayed device.
            </li>
            <li>
          ...
          <p>
            ...
            recorded by the product-standard performance requirements. The instrument generates the
            test residual current starting at either the positive (0°) or negative (180°)
            zero-crossing of the supply voltage. An RCD whose magnetic latching has worn
            asymmetrically may respond slowly — or not at all — on one of the two half-cycles, even
            though the other half-cycle produces a fast trip. The pair test is what catches this;
            recording only one value would let the defective device pass.
          </p>
          <p>
            For Type A, F and B devices, the 1×IΔn test on most modern instruments includes
            waveform-specific test currents — pulsating DC for Type A, composite for Type F, smooth
            DC for Type B — alongside the standard AC test. The Schedule of Test Results records the
            AC 1×IΔn time for the column-28 entry; waveform-specific results are captured in the
            test instrument's downloaded record where applicable.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>30 mA non-delayed RCD providing additional protection</strong> — 40 ms maximum
              at 5×IΔn (i.e. 150 mA test current). This is the BS EN 61008-1 / 61009-1 figure, and
              the one most domestic and small-commercial RCDs are tested against.
            </li>
            <li>
            ...
            <li>
              <strong>Type S (time-delayed)</strong> — the 5×IΔn test for selectivity-class devices
              has a different acceptance window; the device must remain time-delayed in its
              operation. Test instrument settings should reflect the Type S selection.
            </li>
          </ul>
          <p>
            Like the 1×IΔn test, the 5×IΔn test is run at 0° and 180° on Type A / F / B devices. The
            longer of the two readings is the recorded value. A device that trips at 18 ms at 0° and
            24 ms at 180° passes; a device that trips at 22 ms at 0° and 65 ms at 180° fails (65 ms
            &gt; 40 ms limit) and must be replaced regardless of the 0° result.
          </p>
          <p>
            The 5×IΔn test current is briefly substantial — 150 mA on a 30 mA device — and the test
            duration is short. The instrument terminates the test current as soon as the device
            opens; an RCD that fails to open results in the instrument cutting the test after a
            defined safety timeout (typically 200 ms or so) and reporting "trip time exceeded".
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          <h4 className="text-sm font-bold text-white mb-4">
            Trip-time test sequence — IΔn × 0.5, IΔn × 1, IΔn × 5 with the must-trip / must-not-trip
            outcomes and the 0° / 180° pair
          </h4>
          <svg
            viewBox="0 0 880 600"
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="440" y="35" textAnchor="middle" fill="#A855F7" fontSize="12" fontWeight="bold">
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="155" y="92" textAnchor="middle" fill="#22C55E" fontSize="11" fontWeight="bold">
              STEP 1 — IΔn × 0.5
            </text>
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="440" y="92" textAnchor="middle" fill="#A855F7" fontSize="11" fontWeight="bold">
              STEP 2 — IΔn × 1
            </text>
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="725" y="92" textAnchor="middle" fill="#EF4444" fontSize="11" fontWeight="bold">
              STEP 3 — IΔn × 5
            </text>
            ...
            <text x="80" y="395" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              0° start
            </text>
            ...
            <text x="230" y="395" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              180° start
            </text>
            ...
            <text x="440" y="498" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              Test instrument shall comply with BS EN 61557-6 — Reg 643.8 references this directly.
            </text>
        ...
        >
          <p>
            The mechanical reality: an RCD's tripping mechanism uses a small permanent-magnet latch.
            The current transformer detects the residual current and produces a small signal that
            releases the latch when the residual current matches the device rating. The latch
            geometry and the magnet polarity mean the release sensitivity is not guaranteed to be
            identical for currents that start at the positive vs the negative voltage zero-crossing.
          </p>
          <p>
            ...
            suffered contamination or vibration, the asymmetry can grow large. The 0° / 180° pair is
            what the test-equipment standard BS EN 61557-6 mandates and what the RCD product
          ...
          <p>
            ...
            column-28 entry on the GN3 model Schedule of Test Results. A device that trips at 22 ms
            at 0° and 180 ms at 180° has a column-28 entry of 180 ms — pass against the 200 ms
            limit, but with very limited margin. A device that trips at 22 ms at 0° and fails to
            trip at 180° within the test timeout has a column-28 entry that records the failure, and
            the device is condemned.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The instrument needs three live connections — line, neutral and CPC — at the test point
            downstream of the RCD. From those it can:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Detect the supply voltage zero-crossings and synchronise the test current to start at
              either 0° or 180°.
            </li>
            <li>
            ...
            <li>
              Limit the test duration to a safety timeout (typically 200 ms or a defined value from
              the product standard) so that a non-tripping device does not let large residual
              current flow indefinitely.
            </li>
          </ul>
          <p>
            The test current really does flow in the earth-fault loop. For the duration of the test
            the upstream Zs path is briefly carrying the residual current. A long Zs path (high
            earth-fault loop impedance) can cause the test current to fall short of its target
            value, which the instrument typically reports as a "test current too low" warning. That
            is one of the reasons Reg 643.7.3.1 requires the earth-fault loop impedance test to
            precede the RCD trip-time test in the verification sequence.
          </p>
          <p>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Type B test: includes smooth DC residual current at variable polarity. Type B testing
              requires an instrument explicitly declared compliant with BS EN 61557-6 including the
              Type B test extension.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              fail. The device is operating as a non-delayed RCD; selectivity is lost. A downstream
              non-delayed RCBO can race the Type S to the trip and both can drop.
            </li>
            <li>
            ...
            <li>
              ...
              fail. The device is too slow; under a sustained residual-current condition it does not
              clear within product-standard limits.
            </li>
          </ul>
          <p>
            The instrument settings matter. Selecting "non-delay" mode on a Type S device will
            produce the wrong limits comparison and the result printed by the instrument may report
            a "fail" against limits that do not apply to the device. Read the instrument's setting
            carefully and match it to the device under test. The Schedule of Test Results comments
            column carries the device class — "Type S 100 mA 130-500 ms band" — so the next
            inspector knows what limits the recorded value was assessed against.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>5×IΔn trip time (where present)</strong> — the longer of the 0° / 180° pair at
              5×IΔn, in milliseconds. Typical entries for a healthy 30 mA non-delayed device: 12,
              18, 28.
            </li>
            <li>
          ...
          <p>
            The 0.5×IΔn non-tripping check is performed but typically not recorded as a numeric time
            — the result is binary. Where the form provides a column for it, "tick / did not trip"
            or "&gt;2000 ms" is the entry.
          </p>
        </ConceptBlock>
