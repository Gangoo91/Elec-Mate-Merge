        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">In 30 Seconds:</span> CAT III minimum
              rating for all PV test equipment
            </p>
          </div>
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">Spot it:</span> DC clamp meters
              enable non-intrusive current measurement
            </p>
          </div>
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">Use it:</span> I-V curve tracing
              needs minimum 700 W/m² irradiance
            </p>
          </div>
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">Key Tool:</span> Thermal imaging
              reveals hot spots and faults
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 space-y-6 pb-8">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white/80 text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Digital Multimeter:</span> Must be True RMS
              capable for accurate inverter output measurement. Require CAT III rating minimum (CAT
              IV preferred) for fixed installations. DC voltage capability to at least 1000V for
              most PV systems and DC current measurement via series connection or separate clamp.
            </p>
            <p>
              <span className="text-white font-medium">DC Clamp Meter:</span> Enables non-intrusive
              current measurement on live strings. Must be specifically DC capable as standard AC
              clamps will not work. Hall effect type for DC measurement. Useful for comparing string
              currents without disconnection.
            </p>
            <p>
              <span className="text-white font-medium">Insulation Resistance Tester:</span> 1000V
              test capability for standard PV systems. Higher voltages may be needed for 1500V
              systems. Must generate sufficient test voltage under load. Important for detecting
              degraded insulation and ground faults.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white/80 text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Camera Selection:</span> Higher resolution
              enables better identification of small defects. Temperature accuracy of 2 degrees C or
              better is recommended. Wide temperature range covers normal operation to fault
              conditions. Field of view should suit inspection distances.
            </p>
            <p>
              <span className="text-white font-medium">Optimal Conditions:</span> Best results with
              minimum 500 W/m² irradiance, ideally above 700 W/m². System should be operating at
              significant load. Uniform lighting avoids reflection issues. Early morning or overcast
              conditions reduce glare.
            </p>
            <p>
              <span className="text-white font-medium">Interpretation:</span> Hot cells may indicate
              internal short circuits, cell cracks, or bypass diode failures. Hot connections
              suggest high resistance from loose terminals. Compare relative temperatures between
              modules and strings. Document anomalies with severity classification.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white/80 text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">I-V Curve Tracers:</span> These measure
              complete current-voltage characteristics of modules and strings. They reveal fill
              factor, series resistance, shunt resistance, and degradation. Require good irradiance
              (minimum 700 W/m²) for accurate results. Compare results to manufacturer
              specifications.
            </p>
            <p>
              <span className="text-white font-medium">Irradiance Meters:</span> These measure solar
              radiation for performance normalisation. Reference cells match module spectral
              response. Pyranometers provide broader spectral measurement. Essential for accurate
              yield calculations and performance analysis.
            </p>
            <p>
              <span className="text-white font-medium">Data Loggers:</span> These record
              time-stamped measurements for trend analysis. Multiple channels monitor various
              parameters simultaneously. Important for performance monitoring and fault
              investigation. Ensure adequate memory and battery life for monitoring period.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white/80 text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Voltage Measurement:</span> Verify meter
              settings before connecting. Check Voc (open circuit voltage) with load disconnected.
              Measure Vmpp during operation for MPPT verification. Compare string voltages for
              consistency.
            </p>
            <p>
              <span className="text-white font-medium">Current Measurement:</span> Use clamp meters
              where possible to avoid circuit interruption. For series measurement, ensure meter is
              correctly rated. Compare string currents under consistent irradiance. Document
              irradiance conditions during testing.
            </p>
            <p>
              <span className="text-white font-medium">Insulation Testing:</span> Isolate the system
              and prove dead before testing. Apply test voltage matching system voltage rating.
              Allow reading to stabilise before recording. Test positive to earth, negative to
              earth, and positive to negative.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white/80 text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Daily Checks:</span> Inspect test leads for
              damage before use. Check battery condition. Verify meter zeroing and basic function.
              Ensure correct range selection.
            </p>
            <p>
              <span className="text-white font-medium">Calibration Requirements:</span> Annual
              calibration is typical for most test equipment. More frequent calibration may be
              needed for critical measurements. Keep calibration certificates available. Calibration
              should be traceable to national standards.
            </p>
            <p>
              <span className="text-white font-medium">Storage and Transport:</span> Store equipment
              in protective cases. Protect from extreme temperatures and humidity. Remove batteries
              for long-term storage. Keep accessories and manuals together with instruments.
            </p>
          </div>
        </section>
        ...
        <div className="bg-gradient-to-r from-elec-yellow/10 to-amber-500/10 border border-elec-yellow/20 rounded-xl p-4">
          ...
          <div className="space-y-2 text-white/80 text-sm">
            <p>
              ...
              workload justifies. Consider rental or outsourcing for expensive equipment used
              infrequently.
            </p>
            <p>
              <span className="text-white font-medium">Safe testing practices:</span> Always verify
              equipment ratings match the system. Use appropriate PPE. Follow safe isolation
              procedures. Never assume systems are de-energised without verification.
            </p>
            <p>
              <span className="text-white font-medium">Documentation:</span> Record all test results
              with conditions and equipment used. Maintain calibration records. Keep equipment
        ...
        {/* Quiz */}
        <Quiz title="Test Equipment Quiz" questions={quizQuestions} />
