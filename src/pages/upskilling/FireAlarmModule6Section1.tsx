    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS 5839-1:2025 sets two distinct testing rhythms running in parallel — the weekly user
          test (a duty of the responsible person under RRO 2005), and the six-monthly
          competent-person inspection and service. The 2025 revision clarifies the tolerance window
          (five to seven months), explicitly adds duct-mounted smoke detectors and CIE
          zone-identification verification to the twelve-monthly visit, and tightens the recording
          obligation.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Weekly user test</strong> — gross failure of the alarm function, sounder / VAD
              failure, ARC signalling failure, panel fault not being attended to. Catches the "would
              the system make a noise tomorrow morning if there was a fire" question.
            </li>
            <li>
            ...
            <li>
              ...
              failures, battery performance trend, panel event log review for accumulated faults, a
              representative sample functional test.
            </li>
            <li>
              <strong>Annual full coverage</strong> — every individual device proven to operate. The
              two six-monthly visits together cover 100% of the device population. The asset
              register tracks which device was tested when.
            </li>
          </ul>
          <p>
            The standard does not say "service the system once a year". It says "service the system
            twice a year and over those two visits cover everything". The distinction is
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Notify.</strong> Inform any ARC the test is about to take place (so a real FRS
              dispatch is not generated in error). Inform any premises occupants who need to know.
            </li>
            <li>
            ...
            <li>
              ...
              the alarm signal is audible and visible. (Ideally rotate the listening locations week
              to week so audibility is verified building-wide over the cycle.)
            </li>
            <li>
            ...
            <li>
              <strong>Log.</strong> Record date, time, identity of the operator, MCP tested, outcome
              (pass or any anomaly), and any follow-up action initiated.
            </li>
          </ol>
          <p>
            The test takes a competent user perhaps three to five minutes. Done weekly across a
            year, it functionally verifies every MCP, exercises the sounders / VADs frequently, and
            produces a continuous trickle of operational evidence in the logbook.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="450" y="44" textAnchor="middle" fill="#FBBF24" fontSize="13" fontWeight="bold">
            ...
            <text x="52" y="374" fill="rgba(255,255,255,0.6)" fontSize="9">
              Every detector · MCP · sounder · VAD · interface · duct detector (NEW 2025) · zone ID
              verified vs zone plan (NEW 2025)
            </text>
            <line
              x1={40 + 6 * 60}
              y1="384"
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              supply taking over). No alarm should be initiated; no fault other than the mains-fail
              indication should be present.
            </li>
            <li>
          ...
          <p>
            ...
            For systems with one, the monthly test is the test that proves the standby supply chain
            — without it, the supply could degrade silently between annual tests and only be
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              interventions by other parties. Identify any pattern (recurring fault, repeated false
              alarm location).
            </li>
            <li>
              <strong>Panel event log.</strong> Read the panel's event memory. Compare to the
              logbook. Faults the panel logged but the logbook does not show should be investigated.
              Pre-existing alarm conditions or persistent faults should be resolved.
            </li>
            <li>
              <strong>Panel visual inspection.</strong> Confirm normal status. Check for any
              disabled zones / disabled outputs. Check the date / time. Check the configuration has
              not been altered without the certificate trail.
            </li>
            <li>
              ...
              calibrated to deliver 100% annual coverage when combined with the next visit's sample.
              Record each device tested and the outcome.
            </li>
            <li>
            ...
            <li>
              ...
              disablement) confirmed transmitted to the ARC and acknowledged. Where the transmission
              path is dual (e.g. cellular plus IP), each path is exercised.
            </li>
            <li>
          ...
          <p>
            ...
            being maintained per BS 5839-1:2025 and per the responsible person's RRO 2005 duty. The
            report and logbook entries are the audit trail — see Section 6.4.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              have the alarm signals that are sent to the ARC checked. Where more than one form of
              alarm signal can be transmitted (e.g. fire and fault signals), the correct
              transmission of each signal should be confirmed. … The functional testing of smoke
              detectors in ventilation ducts has now been added to the list of actions undertaken at
              the 12 monthly service visit. During the 12 monthly service visit, the zone
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>By zone.</strong> Visit 1 tests zones 1, 3, 5, 7. Visit 2 tests zones 2, 4, 6,
              8. Simple to plan, easy to evidence, predictable for clients.
            </li>
            <li>
            ...
            <li>
              <strong>Hybrid.</strong> Most real schedules mix the above — by zone for detectors, by
              area for sounders, all interfaces every visit. Whatever the split, the deliverable is
              full coverage across the two visits.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              test (which transiently loads the battery and reads back-projected back-up duration),
              or perform an off-line load test with a constant-current load and a stopwatch. The
              result is compared to the design back-up duration (typically 24 or 72 hours of
              quiescent + half an hour of alarm — depends on category and application). A battery
              that no longer meets the design duration is at end of life irrespective of its age.
            </li>
          </ol>
          <p>
            Replacement at design life is planned; replacement on failure is reactive. Any servicing
            organisation worth its certification plans replacement at year four (or earlier if
            performance trending down), notifies the responsible person in writing, and has the
            replacement battery on hand at the V3b or V4a visit before performance has dropped to
            non-compliance.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              authority. Notify the FRS if the building is high-risk (sleeping accommodation, care).
              Restrict occupancy or close affected areas if possible. Repair within hours.
            </li>
            <li>
            ...
            <li>
              <strong>Single device failure.</strong> Disable that device. Cover it physically if a
              smoke detector (to prevent false alarms during repair). The rest of the system
              functions. Repair at the next service visit if non-urgent, sooner if the device covers
              a high-risk area.
            </li>
            <li>
          ...
          <p>
            All interim measures are recorded in writing in the logbook with a clear start time and
            clear end time at repair. A weekly test that is logged as "failed — fire watch
            instituted" is a system being managed responsibly. A weekly test that is logged as "OK"
            when the panel is buzzing fault is a logbook entry that may be evidence of gross
            negligence.
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-6/section-2')}
