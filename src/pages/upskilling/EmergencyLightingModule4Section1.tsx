...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'What additional test does PH120 enhanced fire-resistant cable pass beyond the basic PH classification?',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'Which BS standard provides the code for selection and installation of fire-resistant cables for life-safety circuits?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'A self-contained emergency luminaire has its own internal battery. The mains supply cable to the luminaire is the charging path. If that cable fails in a fire, what happens to the emergency function of the luminaire?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'BS 5266-1:2025 introduces a high-risk-area requirement. How many separate emergency lighting circuits are required, and what is the maximum number of luminaires lost per single fault?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'A drawing specifies "FP200 Gold cable, fixed with metal saddles at 300 mm intervals on a metal tray". The installer fits the cable with plastic saddles to "save time on the snag list". What is the consequence?',
    options: [
  ...
  },
  {
    id: 7,
    question:
      'Cable for an emergency lighting circuit passes through a fire compartment wall. What additional installation requirement applies at the penetration?',
    options: [
  ...
  },
  {
    id: 8,
    question:
      'MICC (mineral-insulated copper-clad) cable is specified for an emergency lighting circuit in a particularly demanding application. What is the dominant advantage over FP200 Gold?',
    options: [
  ...
  },
  {
    id: 9,
    question:
      'BS 7671 Section 560 covers safety services. What do its source-of-supply regulations specifically address?',
    options: [
  ...
  },
  {
    id: 10,
    question:
      'When designing the cable installation for a new emergency lighting system, what is the correct sequence of decisions?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Fire-resistant cabling is the backbone of any emergency lighting installation. PH30 for
          general use, PH120 + water-spray for life-critical paths, BS 8519 as the
          selection-and-installation code, BS 5266-1:2025 segregation, BS 7671 §560 framework. Cable
          type, fixings, routing, and fire-stopping work as a system — undermining any one element
          undermines the lot.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              500-800 °C in 5-10 minutes. Standard cable is short-circuit, open-circuit, or
              earth-fault long before evacuation is complete.
            </li>
            <li>
          ...
          <p>
            The investment in fire-resistant cabling is the single largest material cost
            differentiator between a compliant emergency lighting installation and a non-compliant
            one. Cutting corners here is detected by inspection, by post-incident investigation, and
            by the consequence of failure during real evacuation.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              BS 8434-2" or marketed as "enhanced 120-minute" — meaning it passes BS EN 50200 to
              PH120 AND the BS 8434-2 water-spray test. This is the cable BS 8519 specifies for
              life-critical circuits.
            </li>
          </ul>
          <p>
          ...
          >
            ...
            <g>
              ...
              <circle
                ...
                strokeWidth="1.6"
              />
              <text x="225" y="115" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                LSZH outer sheath
              </text>
              ...
              <circle
                ...
                strokeDasharray="5,3"
              />
              <text x="225" y="148" textAnchor="middle" fill="#22D3EE" fontSize="9.5">
            ...
            <g>
              ...
              <circle
                ...
                strokeWidth="1.6"
              />
              <text x="655" y="105" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
                LSZH outer sheath
              </text>
              ...
              <circle
                ...
                strokeDasharray="3,2"
              />
              <text x="655" y="125" textAnchor="middle" fill="#A855F7" fontSize="9.5">
                Mechanical / water barrier
              </text>
              ...
              <circle
                ...
                strokeDasharray="5,3"
              />
              <text x="655" y="148" textAnchor="middle" fill="#22D3EE" fontSize="9.5">
                Enhanced mica/ceramic insulation
              </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Fire load.</strong> Plant rooms, storage areas, kitchens, and laboratories
              have higher fire loads than offices. Cables in or near high-fire-load areas need
              higher category.
            </li>
            <li>
            ...
            <li>
              ...
              from a deep basement, all push toward the highest category regardless of building
              size.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              the system performance — cable, fixings, supports, joints, and containment — meets the
              category throughout the cable route.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="220" y="158" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              FP200 Gold
            </text>
            <text x="220" y="174" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              Office, retail unit
            </text>
            ...
            <text x="440" y="158" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              FP200 Gold
            </text>
            <text x="440" y="174" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              Small mixed-use
            </text>
            ...
            <text x="660" y="158" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              FP PLUS
            </text>
            <text x="660" y="174" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              Small central plant
            </text>
            ...
            <text x="220" y="268" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              FP200 Gold (PH60)
            </text>
            <text x="220" y="284" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              Hotel, school, clinic
            </text>
            ...
            <text x="440" y="268" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              FP PLUS
            </text>
            <text x="440" y="284" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              Mixed-use medium
            </text>
            ...
            <text x="660" y="268" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              FP PLUS / MICC
            </text>
            <text x="660" y="284" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              Large central battery
            </text>
            ...
            <text x="220" y="378" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              FP PLUS
            </text>
            <text x="220" y="394" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              Hospital, care home
            </text>
            ...
            <text x="440" y="378" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              FP PLUS / MICC
            </text>
            <text x="440" y="394" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <text x="660" y="378" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              MICC preferred
            </text>
            <text x="660" y="394" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              High-rise, hospital
            </text>

            {/* Footnote */}
            <text x="440" y="450" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
              "+ W" = additional BS 8434-2 water-spray test rating · Categories illustrative —
              confirm against full BS 8519 risk assessment
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>FP200 Gold.</strong> The workhorse for general emergency lighting and fire
              alarm cabling. Available in PH30 (most common), PH60, and PH120 grades. Easy to work
              with — terminates like ordinary cable, no specialist tooling. Fixings on metal saddles
              or clips at manufacturer-specified intervals (typically 300 mm horizontal, 400 mm
            ...
            <li>
              <strong>MICC (mineral-insulated copper-clad).</strong> The gold-standard
              fire-resistant cable. Compressed magnesium oxide insulation in a continuous copper
              sheath — inorganic, non-combustible, performance well above PH120 in many test
              conditions. Used in the most demanding applications: hospitals, high-rise residential,
              deep basements, plant rooms, petrochemical, marine. Trade-offs: specialist termination
              tooling and gland kits, larger bend radius, higher cost, more weight, slower install.
            </li>
            <li>
              <strong>Other named products.</strong> Draka Firetuf, Prysmian Total, Pyro, etc.
              Always check the actual classification on the product datasheet (PH grade, BS 8434-2
              rating, BS 8519 category) — the marketing name does not by itself guarantee a
              category.
            </li>
          </ul>
          <p>
            The cable spec on the drawings should be unambiguous: "FP200 Gold PH30, 1.5 mm², 2C+E,
            metal clip-fixed at 300 mm horizontal / 400 mm vertical, fire-stopped at all compartment
            penetrations". A spec that says only "fire-resistant cable" is incomplete and gets
            specified up by the contractor (which the client may not have priced for).
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Containment.</strong> Where cable runs in conduit or trunking, the
              conduit/trunking must be metal (typically galvanised or stainless steel). Plastic
              conduit melts and provides no protection. Where the cable runs on tray, the tray
              itself is the containment.
            </li>
            <li>
            ...
            <li>
              ...
              independently. Sharing a single cable tray, a single junction box, or a single conduit
              run defeats the segregation purpose because a single fire/mechanical event can take
              both out.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Containment.</strong> Tray, ladder, conduit, trunking — type, rating,
              supports.
            </li>
            <li>
        ...
        <FAQ
          items={[
            ...
            {
              question:
                'Can I use ordinary PVC/PVC twin-and-earth for emergency lighting if it is in conduit?',
              answer:
            ...
            {
              question:
                'What is the minimum specification for a labelled emergency lighting isolator?',
              answer:
        ...
        <Quiz
          title="Cable types and installation requirements — Module 4.1"
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() =>
              navigate('/electrician/upskilling/emergency-lighting-module-4-section-2')
            }
