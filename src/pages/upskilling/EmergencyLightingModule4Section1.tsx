...
const inlineChecks = [
  {
    ...
    options: [
      'No fire rating required — it is a 230 V circuit and standard PVC/PVC twin-and-earth is fine.',
      'PH30 fire-resistant cable per BS EN 50200 — survives a 30-minute fire test at controlled temperature without loss of circuit integrity. This is the standard fire-resistant grade for general emergency lighting where a low-risk fire load and short escape times do not justify enhanced cable. The cable holds the circuit live long enough for occupants to evacuate the affected area before the cable fails.',
      'PH120 enhanced fire-resistant cable plus BS 8434-2 water-spray classification.',
      'SWA armoured cable in steel conduit.',
    ],
    correctIndex: 1,
    explanation:
      'PH30 per BS EN 50200 is the standard fire-resistant grade. The 30-minute test exposes the cable to a defined fire curve (around 830 °C) for 30 minutes while maintaining circuit integrity at rated voltage. PH120 is the enhanced grade for high-risk areas, central battery feeds to luminaires, or BS 8519 Category 2/3 applications.',
  },
  {
    id: 'elm4-s1-ph120',
    question:
    ...
    options: [
      'PH30 — same as self-contained luminaires.',
      'PH120 enhanced fire-resistant cable per BS EN 50200 plus the water-spray test of BS 8434-2 — survives a 120-minute fire-resistance test AND a water-spray exposure (simulating sprinkler discharge or fire-fighting hose). This is the enhanced grade required for central-battery-to-luminaire feeds because the cable carries the only power path; if the cable fails, every luminaire downstream goes dark. Self-contained luminaires by contrast each have their own internal battery, so a single cable failure only affects the feed to that one luminaire and does not extinguish its emergency function.',
      'Standard PVC/PVC.',
      'Steel-wire-armoured cable in PVC conduit.',
    ],
    correctIndex: 1,
    explanation:
      'BS 8519 categorises fire-resistant cable applications. The cable supplying a centrally-powered emergency luminaire is in the highest category because there is no local battery backup at the luminaire — if the cable fails, the light goes out. PH120 + BS 8434-2 water-spray gives the integrity required for the full duration of evacuation including under fire-fighting conditions.',
  },
  {
    id: 'elm4-s1-fixings',
    question:
    ...
    options: [
      'No issue — the cable itself is fire resistant.',
      'No issue — plastic ties are heat-stabilised.',
      'The plastic ties soften and fail at well below the cable rating temperature, the cable falls from the wall, mechanical loads on the cable rise, and circuit integrity is lost LONG before the cable rating would otherwise have failed. The fire-resistance grade of the cable is only realised when supports, fixings, joints, and containment are themselves fire-resistant. BS 8519 explicitly requires metallic fixings (clips, cleats, saddles) at intervals not exceeding the manufacturer-specified maximum (typically 300 mm horizontal, 400 mm vertical) for fire-resistant cable installations. Plastic clips, cable ties, or push-fit accessories defeat the system.',
      'The cable just hangs from its terminations.',
    ],
    correctIndex: 2,
    explanation:
      'Fire-resistant cable performance is a SYSTEM specification — cable, fixings, supports, joints, containment all must be fire-rated. BS 8519 §6 (selection and installation) addresses this. The cable rating is meaningless if a plastic clip fails at 200 °C and drops the cable into a heap on the floor.',
  },
  {
    ...
    options: [
      'No effect — it is an electrical design issue, not a cable issue.',
      'It directly drives cable installation: the two circuits MUST be physically separated so that a single fire event cannot disable both. That means independent cable routes, segregation of containment, fire-stopping at compartment penetrations, and consideration of common-mode failures (a single junction box, a single distribution board, a single cable tray supporting both feeds). The cable specification (PH30 or PH120) addresses fire SURVIVAL of each cable, but the segregation requirement addresses architectural FAULT TOLERANCE — surviving the loss of one of the two paths. Both must be designed in.',
      'Use a higher cable rating instead.',
      'Use a single circuit with 100 luminaires and a residual-current device.',
    ],
    correctIndex: 1,
    explanation:
      'The 2025 high-risk requirement is a fault-tolerance architecture: two independent circuits, max 20 luminaires lost per fault. Cables on the two circuits must be routed so that a single fire/mechanical event does not take out both. Cable spec is about survival; routing/segregation is about avoiding common-mode failure.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      'The cable is rated for 30 °C maximum operating temperature.',
      'Per BS EN 50200, PH30 is the cable fire-resistance test classification meaning the cable maintains circuit integrity at rated voltage for 30 minutes when exposed to the standard fire-resistance test (controlled flame at approximately 830 °C). It is the standard fire-resistant grade for emergency lighting and fire alarm cabling in lower-risk applications. PH60 (60 minutes), PH90 (90 minutes), and PH120 (120 minutes) are higher classifications used where longer survival is required.',
      'The cable has 30 mm of insulation.',
  ...
  },
  {
    ...
    options: [
      'A higher voltage test only.',
      'BS 8434-2 — the water-spray test simulating sprinkler discharge or fire-fighting hose stream during a fire. The cable must maintain circuit integrity not only against the fire itself but also against the cooling/thermal-shock effect of water hitting hot cable. This combined fire + water exposure represents real-world fire-fighting conditions and is required for life-safety circuits where evacuation may take 60+ minutes (large buildings, complex layouts, vulnerable occupants) and where the cable must survive into the fire-fighting phase.',
      'A bend radius test only.',
      'A chemical resistance test.',
    ],
    correctAnswer: 1,
    explanation:
      'BS 8434-2 adds water spray to the BS EN 50200 fire test. PH120 + BS 8434-2 (sometimes annotated PH120-W or "enhanced") survives 120 minutes of fire AND water-spray exposure. This is BS 8519 Category 2/3 cable for high-risk and life-critical applications.',
  },
  {
    id: 3,
    ...
    options: [
      'BS 7671 only.',
      'BS 5266-1 only.',
      'BS 8519 — the dedicated code of practice for fire-resistant power and control cable systems for life safety. It works alongside BS 5266-1 (emergency lighting), BS 5839-1 (fire alarm), BS 7671 (general wiring), and the cable-test standards (BS EN 50200, BS 8434-2). BS 8519 covers cable selection (matching grade to risk/category), installation (fixings, supports, containment, segregation, fire stopping), and integration with the rest of the life-safety infrastructure.',
      'BS EN 50172.',
    ],
    correctAnswer: 2,
    explanation:
      'BS 8519 is the code of practice. The cable test standards (BS EN 50200, BS 8434-2) tell you what classification a cable has; BS 8519 tells you which classification to use for which application and how to install it.',
  },
  {
    id: 4,
    ...
    options: [
      'It immediately fails with the cable.',
      'It continues to operate from its internal battery for the rated autonomy duration (1, 2, or 3 hours). The mains cable is the charging supply; loss of mains is the trigger for the emergency function. A burned cable is functionally indistinguishable from a power cut to the luminaire — the luminaire enters emergency mode and runs from its battery. This is precisely why self-contained luminaires can use lower cable grades than central-battery feeds: the cable is not the life-critical signal path. It is, however, still wired in fire-resistant cable so that adjacent unaffected luminaires (sharing the circuit) are not extinguished by a single fault upstream.',
      'It explodes.',
  ...
  },
  {
    ...
    options: [
      'One circuit, no luminaire limit.',
      'At least TWO separate emergency lighting circuits, with no single fault disabling more than 20 luminaires. The two-circuit requirement provides architectural redundancy: a fault on one circuit (cable damage, MCB operation, control fault) does not extinguish all emergency lighting in the high-risk area because the second circuit remains operational. The 20-luminaire limit caps the consequence of any single fault — if a circuit covers 60 luminaires it must be split into three sub-zones such that no single fault takes down more than 20. This is a NEW 2025 requirement reflecting lessons from major incidents where single-circuit failures left areas dark during evacuation.',
      'Two circuits, no luminaire limit.',
      'Five circuits, max 5 luminaires per fault.',
    ],
    correctAnswer: 1,
    explanation:
      'The 2025 requirement is two-fold: ≥2 circuits AND ≤20 luminaires per fault. Both must be satisfied. It is an architectural fault-tolerance requirement, not a cable-grade requirement (though it does drive cable routing/segregation decisions).',
  },
  {
    id: 6,
    ...
    options: [
      'No consequence — the cable rating is unchanged.',
      'The fire-resistance performance of the SYSTEM is destroyed even though the cable itself is unchanged. Fire-resistant cable performance is system-level: cable + fixings + supports + containment together. Plastic saddles soften and fail well below the temperature at which the cable would lose integrity. The cable falls from the tray, mechanical loads on cores increase, joints stress, and circuit integrity is lost. The compliance certificate cannot be signed. BS 8519 §6 requires metallic fixings throughout the fire-rated route. The "time saved" is a defect that must be rectified at the installer\'s cost.',
      'The cable will work but only for 15 minutes.',
      'The cable will work for double the rated time.',
    ],
    correctAnswer: 1,
    explanation:
      'Fire-resistance is a system property. A plastic fixing on a fire-rated cable defeats the fire rating of the system. BS 8519 mandates metallic fixings, and reasonable engineering judgement says the same.',
  },
  {
    id: 7,
    ...
    options: [
      ...
      'A fire-stopping seal must be installed to restore the fire-resistance rating of the wall. This is a Building Regulations requirement (Approved Document B) and a BS 8519 requirement. The seal must match the wall rating (typically 30, 60, or 120 minutes), be tested and certified for the cable type and containment used, and be installed per the manufacturer\'s instructions. Common methods: intumescent compound, fire-rated mortar, fire collars on plastic conduit, fire pillows for cable bundles. The fire-stopping is documented on the as-built drawings and is checked at hand-over.',
  ...
  },
  {
    ...
    options: [
      'Lower cost.',
      'Inorganic insulation (compressed magnesium oxide) and a continuous copper sheath give MICC exceptional fire performance — survival temperatures well above 1000 °C and extended duration well beyond PH120 in many test conditions. The cable is also mechanically robust, intrinsically EMC-shielded, and has decades of in-service history in the most demanding life-safety applications. The trade-offs are higher capital cost, higher installation skill (MICC requires specialist termination tools and gland kits), larger bend radius, and additional weight. It is the choice where the application justifies the cost — typically very-long-duration fire scenarios, high-temperature plant areas, or where mechanical protection is also a priority.',
      'Faster installation.',
      'Smaller diameter.',
    ],
    correctAnswer: 1,
    explanation:
      'MICC trades cost and labour for the highest fire performance available. It is a specialist cable for the most demanding applications. FP200 Gold is the workhorse for general emergency lighting where PH30/PH60 is sufficient.',
  },
  {
    id: 9,
    question: 'BS 7671 §560 covers safety services. What does Reg 560.10 specifically address?',
    options: [
      'Cable colours.',
      'Sources of supply for safety services — central battery sets, generating sets, primary cells, dedicated mains feeds with priority restoration, and combinations thereof. The regulation lists the acceptable supply sources for emergency lighting and other safety services, the conditions for use, the segregation from non-safety circuits, and the priority arrangements. Reg 560.11 then addresses circuits — segregation, fire-resistant wiring, dedicated isolators labelled "EMERGENCY LIGHTING — DO NOT SWITCH OFF", and the avoidance of common cause failures. Together §560 forms the BS 7671 framework that the BS 5266-1 / BS 8519 cable specification slots into.',
      'Cable testing only.',
      'Earthing only.',
    ],
    correctAnswer: 1,
    explanation:
      'BS 7671 §560 governs safety services. 560.10 = supply sources; 560.11 = circuits and segregation. The two regulations work together to define the electrical infrastructure that BS 5266-1 then designs the emergency lighting layout into.',
  },
  {
    id: 10,
    ...
    options: [
      'Pick a cable, then design the system around it.',
      'Risk-assess → select fire-resistance category (BS 8519: Cat 1/2/3 → PH30/PH60/PH120) → select cable type within category (FP200 Gold, MICC, etc.) → design routes considering segregation requirements (BS 5266-1:2025 high-risk = ≥2 circuits, ≤20 luminaires per fault) → specify fixings, supports, and containment matching the cable category → identify fire-compartment penetrations and specify fire-stopping → integrate with BS 7671 §560 supply and circuit requirements → document on as-built drawings, riser diagrams, and zone plans. Selection follows risk; installation realises selection. Doing it the other way round produces undersized cables in over-engineered routes, or vice versa.',
      'Use the cheapest cable and hope.',
      'Copy the previous job.',
    ],
    correctAnswer: 1,
    explanation:
      'The decision flow is risk → category → cable → route → fixings → fire-stopping → BS 7671 integration → documentation. Each step constrains the next. Skipping risk assessment lands you with under- or over-specification; skipping documentation makes hand-over and future maintenance impossible.',
  },
];
