...
const inlineChecks = [
  {
    ...
    question: 'Reg 722.55 — what does it require for an EV charging point’s supply circuit?',
    options: [
  ...
  },
  {
    ...
    question: 'Reg 722.311.201 — what does it permit?',
    options: [
...
const quizQuestions = [
  ...
  {
    question: 'Reg 722.311.201 vs Reg 311.1 — what is the relationship for EV circuit sizing?',
    options: [
...
export default function RenewableEnergyModule6Section4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 4 · BS 7671:2018+A4:2026 · Reg 722.55 + 311.1 + 722.311.201"
        title="Cable, RCBO & dedicated final circuit"
        backTo="../renewable-energy-module-6"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Single-phase 7 kW Mode 3 wallbox circuit: 32 A continuous load, Reg 722.55 dedicated final
          circuit, cable sizing per Appendix 4, Reg 311.1 max demand with Reg 722.311.201 load
          curtailment (DLM), Type A / Type B RCBO selection, isolation discipline.
        </p>
        ...
        <Pullquote>
          Dedicated final circuit. Right-sized cable. Right RCBO. DLM where capacity is tight. The 7
          kW install is a pattern, not a puzzle.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Continuous high current</strong> — 32 A for hours
              during a charging cycle. Mixing with intermittent household loads stresses the shared
              circuit thermally and triggers nuisance overload protection
            </li>
            <li>
              <strong className="text-white">Protective architecture specificity</strong> — the Type
              B / Type A + RDC-DD architecture is calibrated for the wallbox’s fault profile; adding
              other loads to the same circuit may put other devices outside the protective intent
            </li>
            <li>
              <strong className="text-white">Isolation clarity</strong> — a single dedicated
              isolation point lets the customer / next electrician disconnect the EV without
              touching any other circuit. Critical for emergency response and routine maintenance
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle alignment</strong> — each Section
              722 layer (earthing-tree, RCD architecture, BS EN 61851 conformance) maps to one
              circuit with one wallbox. Shared circuits muddy the documentation
            </li>
            <li>
              <strong className="text-white">Reg 722.55 is binding</strong>— the wording uses
              "shall" — dedicated final circuit is a mandatory requirement, not guidance
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          32 A continuous changes the cable sizing math. Voltage drop and grouping derating bite
          earlier than on intermittent loads.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Current carrying capacity</strong>— Appendix 4 Tables
              4D5 (T+E) / 4D4 (SWA). 6 mm² T+E Method C (clipped direct): ~41 A; Method 102 (in
              conduit): ~32-34 A. 10 mm² T+E Method C: ~57 A; Method 102: ~46 A
            </li>
            <li>
              <strong className="text-white">Grouping derating</strong> — cables bunched in conduit
              or trunking derate per Appendix 4 Table 4C1. 6 cables grouped: factor 0.57; 4 cables
              grouped: factor 0.65; 2 cables grouped: factor 0.80
            </li>
            <li>
              <strong className="text-white">Ambient derating</strong> — cables in warm environments
              (loft, near hot water tanks, in insulated walls) derate per Appendix 4. UK garage /
              outdoor: ambient typically 25-30°C, derating modest
            </li>
            <li>
              <strong className="text-white">Voltage drop</strong> — 5% on the final circuit per
              Appendix 4 (excluding any drop on the distribution circuit upstream). 6 mm² T+E over
              15 m at 32 A: ~2.2% drop. 10 mm² same conditions: ~1.3% drop. Voltage drop rarely
              binding on typical UK domestic runs; current-carrying capacity usually is
            </li>
            <li>
              <strong className="text-white">Outdoor cable</strong> — 6 mm² SWA is the typical UK
              2025-26 outdoor choice. Mechanical protection, UV resistance, glanding into IP-rated
              enclosures. Section 6.5 covers outdoor installation in depth
            </li>
            <li>
              <strong className="text-white">Sizing calculation template</strong> — Iz ≥ In after
              derating; voltage drop ≤ limit; protective device characteristics satisfied (Zs ≤
              table 41.3 value etc.). Cert evidence bundle records the calc with each input
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Max demand and load curtailment — Reg 311.1 + Reg 722.311.201
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Survey method</strong> — smart- meter half-hourly data
              + visual inspection of circuits. 7-day survey typical
            </li>
            <li>
              <strong className="text-white">Diversity</strong> — Reg 311.1 permits diversity in the
              calculation (e.g. electric shower + cooker rarely simultaneous). Diversity factors per
              On-Site Guide tables or engineering judgement
            </li>
            <li>
              <strong className="text-white">Diversity is NOT curtailment</strong> — Reg 311.1
              forbids diversity from being used as a means of load curtailment. Diversity is a paper
              calculation aid; curtailment is active hardware enforcement
            </li>
            <li>
              <strong className="text-white">EV circuit contribution</strong> — full 32 A without
              DLM; curtailed value with DLM per Reg 722.311.201
            </li>
            <li>
              <strong className="text-white">DNO supply capacity</strong>— typically 80-100 A
              single-phase UK domestic. Some new builds have lower (60 A); some old / large
              properties higher
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">CT clamp around incoming tails</strong> — measures
              household total current draw at the meter / consumer unit
            </li>
            <li>
              <strong className="text-white">Wallbox reads the CT signal</strong> — typically via a
              wired connection (CT to wallbox terminals); some wallboxes use a smart-meter
              integration alternative
            </li>
            <li>
              <strong className="text-white">Wallbox calculates available current</strong> — supply
              limit (e.g. 95 A) minus household draw (e.g. 70 A) = available for EV (25 A in this
              example)
            </li>
            <li>
              <strong className="text-white">CP signalling to vehicle</strong> — wallbox announces
              the current limit to the vehicle via the Control Pilot PWM duty cycle. Vehicle
              complies by drawing at or below that limit
            </li>
            <li>
              <strong className="text-white">Dynamic response</strong> — household draw rises
              (electric shower starts) → wallbox throttles EV down. Household draw falls (shower
              stops) → wallbox ramps EV back up. Response in seconds
            </li>
            <li>
              <strong className="text-white">Minimum charge rate</strong> — manufacturer-defined;
              typically 6 A (the lowest Mode 3 charge rate per BS EN 61851). If household load is so
              high the wallbox would need to drop below 6 A, the wallbox pauses charging entirely
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong>— records: CT clamp
              location and orientation; supply limit configured; DLM-enabled max demand calc;
              commissioning test result (verify DLM throttles correctly under simulated load)
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Current rating</strong> — In = 32 A for a 7 kW
              single-phase wallbox. Match to the wallbox’s rated current
            </li>
            <li>
              <strong className="text-white">Residual current threshold</strong> — 30 mA for
              additional protection per Section 415. Standard on all RCBOs used for socket /
              EV-charging contexts
            </li>
            <li>
              <strong className="text-white">RCD type</strong> — Type A (BS EN 61009) where wallbox
              has integrated RDC-DD; Type B (BS EN 62423) where it doesn’t. Section 6.3 covers this
            </li>
            <li>
              <strong className="text-white">Characteristic</strong> — typically B-curve for general
              final circuits; C-curve if inrush considerations from the wallbox’s power electronics
              trigger nuisance trips on B (rare in 2025-26 — most wallboxes have soft-start)
            </li>
            <li>
              <strong className="text-white">Zs compatibility</strong> — measured Zs at the wallbox
              must be ≤ the Table 41.3 value for the RCBO’s type and rating. Type A 32 A B-curve: Zs
              ≤ 1.37 Ω per Table 41.3(a). Type B RCBO: similar but consult Table 41.3(b) for
              C-curve, etc.
            </li>
            <li>
              <strong className="text-white">Site limit</strong> — apply the GN3 0.80 factor for
              cold-measured site values. 1.37 Ω × 0.80 = 1.10 Ω site limit for the Type A 32 A
              B-curve example
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — records: RCBO
              manufacturer + model + rating + type + BS EN reference; Zs measured at wallbox; ADS
              calc against Table 41.3
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Primary isolation</strong> — dedicated RCBO in the CU.
              Toggle-down lockable for lock-off / tag-out work. Padlock-compatible isolation point
            </li>
            <li>
              <strong className="text-white">Secondary isolation (optional)</strong> — separate AC
              isolator near the wallbox. Common for outdoor installs where the CU is far from the
              wallbox. Per Reg 537 maintenance isolation
            </li>
            <li>
              <strong className="text-white">Labelling</strong> — circuit ID at CU + wallbox AC
              terminal + isolator (if fitted) all match. Reg 514.x requires clear, durable labelling
            </li>
            <li>
              <strong className="text-white">Outdoor isolator considerations</strong> — IP65
              minimum, weather- resistant, lockable. BS EN 60669-2-4 isolator standard
            </li>
            <li>
              <strong className="text-white">Customer handover</strong>— explain the isolation
              point, demonstrate operation, note that the customer can use the CU RCBO for routine
              isolation (e.g. while replacing a tethered cable end)
            </li>
          </ul>
        </ConceptBlock>
