...
const InspectionTestingModule6Section3 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 6 · Section 3" title="RCD ramp testing" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The supplementary RCD test that finds the actual trip current. What ramp testing does that
          1×IΔn trip-time testing cannot — and how to read the result against the BS EN 61008
          acceptance band.
        </p>
        ...
        >
          <p>
            The change matters in court. Pre-A4 testing required time/current performance per Table
            3A. Post-A4, the verification test is fixed: alternating current at IΔn, regardless of
            RCD Type, with the device disconnecting in 300 ms (non-delay) or between 130 ms and 500
            ms (Type S). Ramp testing was not removed from the toolkit — it was clarified as
            supplementary, with GN3 Ch 4 Reg 4.6 describing the procedure.
          </p>
          <p>
            In practice, you reach for the ramp when (a) you are investigating a nuisance trip, (b)
            you are verifying discrimination between a Type S upstream and a non-delay downstream,
            (c) you are commissioning a Type B device on power-electronic loads where smooth-DC
            sensing matters, or (d) you are recording a drift baseline on periodic inspection. None
            of these are mandatory tests; all of them prevent recalls.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              In addition to trip time testing, instruments may provide a tripping-current threshold
              test where a ramp current is applied starting from less than 50 % of the RCD rating
              and increasing to 110 % of the rating. The current at which the RCD trips is recorded
              as the measured tripping threshold.
            </>
          }
            ...
            <table className="w-full text-[13.5px] my-2">
              <thead>
                <tr className="border-b border-white/15">
                  ...
                  <th className="text-center text-white/80 py-2">50 % floor (do-not-trip below)</th>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect x="60" y="30" width="700" height="80" fill="rgba(239,68,68,0.06)" stroke="none" />
            ...
            <text x="410" y="365" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="10">
              * Example values shown for a 30 mA RCD. The band scales with IΔn (e.g. 100 mA → 50–100
              mA, 300 mA → 150–300 mA).
            </text>
          </svg>
        </div>
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              high-impedance loop will pull more voltage onto the protective conductor than the ramp
              implies. GN3 Reg 2.31 wants this verified first.
            </li>
            <li>
              Select ramp test mode on the multifunction tester. Set the device&rsquo;s rated
              residual operating current (IΔn) — 10 mA, 30 mA, 100 mA, 300 mA, 500 mA — and the RCD
              type (AC, A, F, B). The instrument selects the correct waveform on the basis of the
              type setting.
            </li>
            <li>
            ...
            <li>
              Initiate the test. The instrument injects current rising from below 50 % of IΔn up to
              110 % of IΔn over approximately 2 seconds. The device trips; the instrument latches
              the trip current.
            </li>
            <li>
            ...
            <li>
              ...
              its own trip current reading; all three should be inside the band for the device to be
              compliant.
            </li>
            <li>
              Account for standing leakage. Either disconnect downstream loads, OR measure standing
              earth leakage with a clamp meter on the CPC and add it to the displayed trip current.
              The result is the actual residual current at the toroid at the moment of trip.
            </li>
            <li>
        ...
        >
          ...
          <p>
            ...
            installation, or on a periodic inspection where you have a previous ramp value to trend,
            you run both. Reg 643.8 of A4:2026 made the AC at IΔn test the only mandatory one, so a
            quiet, well-behaved board can be certified on trip-time alone.
          </p>
        </ConceptBlock>
        ...
        <ContentEyebrow>The diagnostics — what the trip current actually tells you</ContentEyebrow>
        ...
        >
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              Pass. Record the actual mA value. This is the baseline against which next year&rsquo;s
              inspection will trend.
            </li>
            <li>
            ...
            <li>
              ...
              mA-marked device that trips at 35 mA in service is a 35 mA device, regardless of what
              the label says. Replace.
            </li>
          </ol>
        </ConceptBlock>
        ...
        >
          <p>
            BS 7671 Reg 531.3.3 (and the special-installation regs that point back to it — 712, 722,
            705, 704) require the right RCD type for the load. Selecting the right type at design
            time gets you a compliant installation on paper. Verifying the type is doing its job at
            commissioning gets you a compliant installation in practice. The ramp test is the
            verification — and the only practical way to do it for the DC sensing paths.
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Type AC (BS EN 61008-1):</strong> AC ramp only. Acceptance band 50–100 % of
              IΔn on the AC waveform. Increasingly disallowed for new circuits — most loads contain
              electronic switching and need at least Type A.
            </li>
            <li>
              <strong>Type A (BS EN 61008-1):</strong> AC ramp + pulsed-DC ramp. The pulsed-DC
              acceptance current is multiplied per the device standard (the multiplier and the exact
              waveform are baked into the multifunction tester&rsquo;s Type A mode). The instrument
              reports trip current for each waveform — both shall be inside band.
            </li>
            <li>
              <strong>Type F (BS EN 62423):</strong> AC + pulsed-DC + composite waveform (mixed-
              frequency, simulating single-phase VFD output). All three shall be inside band. Common
              on washing-machine / heat-pump circuits.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              identified as &lsquo;0°&rsquo; and &lsquo;180°&rsquo; on test instruments. The longer
              operating time recorded from the tests started on the two half-cycles shall be the
              value used.
            </>
          }
        ...
        <FAQ
          items={[
            ...
            {
              question: 'What if I cannot disconnect downstream loads to remove standing leakage?',
              answer:
