...
const DESCRIPTION =
  'Master RCD ramp testing techniques to determine actual trip current sensitivity and verify RCD performance meets BS 7671 requirements.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Yes, this is acceptable. 22mA falls within the required range of 15mA (50%) to 30mA (100%) of the rated 30mA IΔn.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Ramp testing reveals the actual trip sensitivity of each RCD, allowing verification that upstream RCDs have higher trip thresholds than downstream ones for correct discrimination.',
  },
  {
    id: 'ramp-baseline',
    question:
      'What advantage does recording actual ramp test values provide over recording just pass/fail?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Recording actual values creates a baseline for comparison during future inspections, allowing detection of sensitivity changes or degradation that might not yet cause a fail but indicate developing problems.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Ramp testing gradually increases the residual current until the RCD trips, determining the actual trip current rather than just whether it trips within time at rated current.',
  },
  {
    id: 2,
    question: 'For a 30mA RCD, what is the acceptable ramp test trip current range?',
    options: ['0 to 15mA', '15mA to 30mA', '30mA to 45mA', '30mA to 60mA'],
    correctAnswer: 1,
    explanation:
      'A 30mA RCD must trip between 50% and 100% of its rated residual current (IΔn), so between 15mA and 30mA. This range confirms proper sensitivity.',
  },
  {
    id: 3,
    question: 'What starting current is typically used for a ramp test?',
    options: ['100% of IΔn', '50% of IΔn', 'Zero or very low current', '5 times IΔn'],
    correctAnswer: 2,
    explanation:
      'Ramp testing starts from zero or very low current and gradually increases until the RCD trips. This determines the actual trip threshold.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'BS EN 61008 and 61009 require RCDs to trip at any current between 50% and 100% of rated IΔn. Tripping at lower values within this range is normal and expected.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Standard testing only confirms the RCD trips within time at rated current. Ramp testing reveals the actual trip threshold, showing how sensitive the RCD actually is.',
  },
  {
    id: 6,
    ...
    correctAnswer: 0,
    explanation:
      '40mA is below 50mA (50% of 100mA). This RCD is operating outside its acceptable range and is either faulty or there is standing leakage affecting the result.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Ramp testing is particularly valuable when assessing discrimination (selectivity) between upstream and downstream RCDs to ensure correct sequential tripping.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Ramp testing uses a gradually increasing current, typically rising over 2 seconds or more, to accurately determine the actual trip threshold.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      '280mA is within the acceptable range of 150mA to 300mA (50% to 100% of rated 300mA IΔn), so the RCD passes the ramp test.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      "The actual trip current (in mA) should be recorded from ramp testing. This provides valuable information about the RCD's actual sensitivity for future comparison.",
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Ramp testing is not mandatory for every RCD test. However, it's valuable when assessing discrimination between series RCDs, investigating nuisance tripping, or when detailed knowledge of RCD sensitivity is required. Standard trip time testing is the primary requirement.",
  },
  {
    question: 'Why do RCDs have a 50% to 100% trip range?',
    answer:
      'This tolerance range accounts for manufacturing variations and ensures safety while preventing nuisance tripping. RCDs must trip before reaching rated current (100%) but are permitted to trip at any current from 50% upward. This ensures protection while allowing reasonable manufacturing tolerance.',
  },
  {
    question: 'Can ramp testing damage an RCD?',
    answer:
      'No, ramp testing does not damage RCDs when performed correctly with appropriate test equipment. The test uses the same fault currents the RCD is designed to detect and interrupt. However, excessive repeated testing over a short period should be avoided.',
  },
  {
    question: 'How does standing leakage affect ramp test results?',
    answer:
      'Standing earth leakage current on the circuit adds to the test current, potentially causing the RCD to trip at a lower applied test current than expected. For accurate results, either account for measured standing leakage or disconnect loads that contribute to leakage current.',
  },
  {
    question: 'What if the ramp test result is outside the 50-100% range?',
    answer:
      "If an RCD trips below 50% of IΔn, check for excessive standing leakage or consider if the RCD is oversensitive. If it doesn't trip until above 100% of IΔn, the RCD is faulty and must be replaced as it doesn't provide adequate protection.",
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Purpose:</strong> Find actual trip current, not just time
              </li>
              <li>
                <strong>Range:</strong> Must trip between 50-100% of IΔn
              </li>
              <li>
                <strong>30mA RCD:</strong> Acceptable range 15-30mA
              </li>
              <li>
                <strong>Use:</strong> Discrimination assessment
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>30mA RCD:</strong> 15-30mA acceptable
              </li>
              <li>
                <strong>100mA RCD:</strong> 50-100mA acceptable
              </li>
              <li>
                <strong>300mA RCD:</strong> 150-300mA acceptable
              </li>
              <li>
                <strong>Ramp Duration:</strong> ≥2 seconds typical
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Ramp testing is an advanced RCD test method that gradually increases the applied
              residual current from zero until the RCD trips. Unlike standard testing which applies
              a fixed current and measures time, ramp testing reveals the actual current at which
              the RCD operates.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                What Ramp Testing Reveals:
              </p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          <h4 className="text-sm font-bold text-white mb-4">
            RCD Test Connection — Trip Time &amp; Ramp Testing
          </h4>
          <svg
            viewBox="0 0 800 360"
            className="w-full h-auto"
            role="img"
            aria-label="RCD test connection diagram showing tester connected between line and protective earth at a socket outlet downstream of the RCD"
          >
            {/* Consumer Unit */}
            <rect
              x="40"
            ...
            <text x="120" y="116" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9">
              Type A
            </text>
            {/* RCD test button */}
            <rect
              ...
              strokeWidth="1"
            />
            <text x="120" y="134" textAnchor="middle" fill="rgba(251,191,36,0.6)" fontSize="7">
              TEST BUTTON
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="120" y="176" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="9">
              MCB B32
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="120" y="217" textAnchor="middle" fill="#22C55E" fontSize="9">
              MET
            </text>

            {/* Cable run */}
            <line x1="200" y1="100" x2="420" y2="100" stroke="#EF4444" strokeWidth="2" />
            <text x="310" y="92" textAnchor="middle" fill="#EF4444" fontSize="9">
              Line
            </text>
            <line x1="200" y1="120" x2="420" y2="120" stroke="#3B82F6" strokeWidth="2" />
            <text x="310" y="135" textAnchor="middle" fill="#3B82F6" fontSize="9">
              Neutral
            </text>
            ...
            <text x="310" y="180" textAnchor="middle" fill="#22C55E" fontSize="9">
              CPC
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="467" y="130" fill="#EF4444" fontSize="9" fontWeight="bold">
              L
            </text>
            <text x="503" y="130" fill="#3B82F6" fontSize="9" fontWeight="bold">
              N
            </text>
            <text x="485" y="116" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              E
            </text>
            ...
            {/* Tester controls */}
            <text x="635" y="180" fill="rgba(255,255,255,0.4)" fontSize="8">
              1×IΔn
            </text>
            <text x="675" y="180" fill="rgba(255,255,255,0.4)" fontSize="8">
              5×IΔn
            </text>
            <text x="715" y="180" fill="rgba(255,255,255,0.4)" fontSize="8">
              Ramp
            </text>
            <text x="675" y="195" textAnchor="middle" fill="rgba(255,255,255,0.4)" fontSize="8">
              0° / 180°
            </text>
            ...
            <text x="575" y="105" textAnchor="middle" fill="#EF4444" fontSize="8">
              L
            </text>
            <text x="575" y="178" textAnchor="middle" fill="#22C55E" fontSize="8">
              PE
            </text>
            ...
            <text
              ...
              fontWeight="bold"
            >
              Maximum Trip Times (BS EN 61008/61009)
            </text>
            <text x="150" y="312" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="10">
              ½×IΔn
            </text>
            <text
              x="150"
            ...
            <text x="320" y="312" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="10">
              1×IΔn (non-delay)
            </text>
            <text
              x="320"
            ...
            <text x="500" y="312" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="10">
              5×IΔn (non-delay)
            </text>
            <text
              x="500"
            ...
            <text x="660" y="312" textAnchor="middle" fill="rgba(255,255,255,0.5)" fontSize="10">
              S-type at 5×IΔn
            </text>
            <text
              x="660"
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Modern multifunction installation testers include ramp test functionality:</p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Both test methods serve different purposes:</p>

            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Standard Trip Time Testing
                </p>
                <ul className="text-sm text-white space-y-1">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Standing earth leakage current from connected equipment can significantly affect ramp
              test results:
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Unlike standard testing which is recorded as pass/fail with trip time, ramp test
              results should include the actual trip current measured:
            </p>
