...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Inaccurate sensor calibration creates systematic errors in logged data. A miscalibrated sensor might show normal readings when conditions are actually problematic, compromising fault diagnosis and compliance reporting.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Logging frequency must balance data quality with storage requirements. Too frequent logging creates excessive data storage overhead, while too slow logging might miss important events or rapid changes.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Typically 1-2 years for operational data, longer for compliance records. Some critical safety data may need retention for 5+ years. Consider storage capacity and regulatory requirements.',
  },
  {
    question: 'What happens if a sensor fails during logging?',
    answer:
      'The BMS should flag sensor faults and log error states rather than false readings. This prevents misleading historical data and alerts operators to sensor problems.',
  },
  {
...
const quizQuestion = {
  ...
  correctAnswer: 2,
  explanation:
    "The case study shows why commissioning must verify the entire signal path from sensor to logged data. Simply checking wiring continuity isn't enough - you must confirm sensors are powered and readings are accurate.",
};
...
const BMSModule6Section2 = () => {
  useSEO({
    ...
    description:
      'Learn about data logging and historical analysis for Building Management Systems including sensor installation, calibration, and data reliability.',
  });
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Continuous:</strong> Regular intervals (temp every 15 min)
              </li>
              <li>
                <strong>Event-based:</strong> On change (pump on/off, alarms)
              </li>
              <li>
                <strong>Uses:</strong> Fault diagnosis, energy saving, compliance
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Trend graphs showing temperature over time
              </li>
              <li>
                <strong>Use:</strong> Shielded cabling for analog signals
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Trend logging is the <strong>process of recording values at set intervals</strong> to
              create a historical record. Think of it as creating a diary for your building systems
              - every temperature reading, pressure measurement, and equipment status is recorded
              with a timestamp.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
                ...
                <p className="text-sm text-white">
                  Captures measurements at regular intervals - every 5 minutes, hourly, etc. Used
                  for temperature, humidity, CO2 levels, and energy consumption.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
                <p className="text-sm font-medium text-green-300 mb-2">Event-Based Logging</p>
                <p className="text-sm text-white">
                  Only records when something changes or events occur. Pump on/off, alarms
                  triggering, valve positions. Saves storage while capturing key behaviour.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-purple-500/10 border border-purple-500/20">
              ...
              <p className="text-sm text-white">
                A chiller's flow temperature is logged every 10 minutes. When it trips on a fault,
                engineers can review the historical graph to see if low flow or high return
                temperature caused the problem - essential for root cause analysis.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Historical data transforms your BMS from a simple control system into a powerful
              analytical tool. It's like having a witness that never sleeps, recording everything
              that happens in your building.
            </p>
            ...
            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <p className="text-sm text-white">
                  Trace back through logs to see exactly what conditions led to a problem. Was it
                  gradual deterioration or sudden failure? Did other systems contribute?
                </p>
              </div>
              <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
                <p className="text-sm font-medium text-green-300 mb-2">Energy Optimisation</p>
                <p className="text-sm text-white">
                  Identify wasteful patterns: equipment running during unoccupied hours, heating and
                  cooling simultaneously, inefficient schedules costing thousands annually.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
                <p className="text-sm font-medium text-yellow-300 mb-2">Compliance Evidence</p>
                <p className="text-sm text-white">
                  Legionella prevention, energy reporting, safety system testing - all require
                  documented proof. Historical data provides evidence automatically.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
              ...
              <p className="text-sm text-white">
                A school discovered through trend analysis that their boilers were running overnight
                due to incorrect scheduling. One simple correction saved £3,000 annually.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              As an electrician, you're the foundation of reliable data logging. Every sensor you
              install, every wire you connect, and every calibration you perform directly impacts
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Correct wiring:</strong> Sensors to correct input types
                  </li>
                  <li>
                    <strong>Sensor calibration:</strong> Verify before connecting
                  </li>
                  <li>
                    <strong>Shielded cabling:</strong> For analog signals (0-10V, 4-20mA)
                  </li>
                  <li>
                    <strong>Clear labelling:</strong> Every wire, terminal, input
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Test signal path:</strong> Sensor to logged data
                  </li>
                  <li>
                    <strong>Simulate conditions:</strong> Heat sensors, apply pressure
                  </li>
                  <li>
                    <strong>Verify timestamps:</strong> Correct time and date
                  </li>
                  <li>
                    <strong>Compare readings:</strong> Against independent instruments
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/20">
              ...
              <p className="text-sm text-white">
                If source signals are wrong, stored history becomes useless. A sensor wired to the
                wrong input type will give meaningless data that corrupts the entire historical
                record.
              </p>
            </div>
          </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-transparent border border-white/10">
                ...
                <p className="text-sm text-white">
                  Indicates sensor power issues, wiring problems, or sensor failures. Check power
                  supply, wiring integrity, and sensor operation.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-transparent border border-white/10">
                <p className="text-sm font-medium text-orange-300 mb-2">Noisy/Erratic Data</p>
                <p className="text-sm text-white">
                  Points to interference, poor connections, or improper grounding. Analog signals
                  are susceptible to noise from motors, VFDs, or switching equipment.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-transparent border border-white/10">
                <p className="text-sm font-medium text-yellow-300 mb-2">Out-of-Range Readings</p>
                <p className="text-sm text-white">
                  Suggests calibration problems, incorrect sensor selection, or input configuration
                  errors. A -40C reading in a heated building indicates issues.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
              ...
              <p className="text-sm text-white">
                Always verify data quality during commissioning by comparing logged values with
                independent measurements. Use a separate thermometer, pressure gauge, or multimeter
                to confirm sensor readings match reality.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-white mb-6">
            Case Study: The Phantom CO2 Problem
          </h2>
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
              <p className="text-sm font-medium text-red-300 mb-2">Problem</p>
              <p className="text-sm text-white">
                An office building logged CO2 levels as constant 400 ppm for weeks, despite air
                quality complaints from occupants.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/20">
              <p className="text-sm font-medium text-orange-300 mb-2">Investigation</p>
              <p className="text-sm text-white">
                The CO2 sensor was wired to the BMS but never powered - the system logged default
                values instead of actual readings.
              </p>
            </div>
            <div className="p-4 rounded-lg bg-green-500/10 border border-green-500/20">
              <p className="text-sm font-medium text-green-300 mb-2">Result</p>
              <p className="text-sm text-white">
                Once powered and calibrated, logs showed peaks above 1500 ppm, triggering necessary
