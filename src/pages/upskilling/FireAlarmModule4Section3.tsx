...
const DESCRIPTION =
  'Learn about fire-resisting cable types (FP200, MICC), enhanced vs standard cables, LSZH requirements, terminations and applications for BS 5839-1.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Where circuits must remain operational for a defined period, enhanced performance cable may be required.',
  },
  {
    id: 'lszh-meaning',
    question: 'LSZH means:',
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Earthing at one end prevents earth loop currents while providing screening effectiveness.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'Excellent fire survivability with correct termination',
      'Only data transmission',
      'No mechanical strength',
    ],
    correctAnswer: 1,
    explanation:
      'Mineral insulated copper cable (MICC) offers high fire resistance when properly installed and terminated.',
  },
  {
    id: 3,
    question: 'LSZH means:',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'FP200 Gold is an enhanced fire-resisting cable tested to maintain circuit integrity for 120 minutes at 842C per BS 8491.',
  },
  {
    id: 5,
    ...
    options: [
      'Ignored',
      'Per manufacturer data to avoid damage',
      'As tight as possible',
      'Only a visual estimate',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Lower cost',
      'Reduced electromagnetic interference pickup',
      'Easier to strip',
      'Better fire resistance',
    ],
    correctAnswer: 1,
    explanation:
      'Screened cables with properly earthed screens reduce EMC susceptibility, important near sources of electrical noise.',
  },
  {
    id: 7,
    ...
    options: [
      ...
      'Using proper sealing glands with compound or sleeves',
      'Wrapping in electrical tape',
      'Painting the end',
    ],
    correctAnswer: 1,
    explanation:
      'MICC terminations require proper sealing glands and moisture-excluding compound to prevent magnesium oxide insulation degradation.',
  },
  {
    id: 8,
    ...
    options: [
      ...
      'BS EN 50200 PH classification (IEC 60331)',
      'Domestic cable standards only',
      'CAT5e data cable standards',
    ],
    correctAnswer: 1,
    explanation:
      'Standard performance fire alarm cables should meet BS EN 50200 (formerly IEC 60331) for circuit integrity under fire conditions.',
  },
  {
    id: 9,
    ...
    options: [
      'Memory only',
      'Permanent identification per BS 7671 and manufacturer requirements',
      'Pencil markings',
      'Coloured tape that can fall off',
    ],
    correctAnswer: 1,
    explanation:
      'Proper permanent identification of cores aids installation, testing, maintenance and troubleshooting throughout system life.',
  },
  {
    id: 10,
    question: 'Enhanced cable is often required for:',
    options: [
      'Circuits supporting evacuation/critical control',
      'Decorative lighting',
      'Temporary tools',
      'Spare cores',
    ],
...
const faqs = [
  {
    ...
    answer:
      'No - only where the fire strategy or design requires extended survivability. Most circuits use standard fire-resistant cable.',
  },
  {
    question: 'Is MICC better than FP-type?',
    answer:
      'Both can meet requirements. MICC offers superior fire resistance but requires specialist skills. FP-type is easier to install with good performance.',
  },
  {
    question: 'What about LSZH requirements?',
    answer:
      'Use LSZH where specified or where reduced toxic smoke is required. Most fire alarm cables are now LSZH as standard.',
  },
  {
    question: 'How do I identify cable ratings?',
    answer:
      'Check manufacturer data sheets. Cable markings should include fire rating standards (e.g., BS EN 50200, BS 8491).',
  },
  {
    question: 'Can I use standard domestic cable?',
    answer:
      'No - fire alarm circuits require fire-resistant cables to maintain operation during a fire. PVC cables are not suitable.',
  },
  {
    question: 'What size cable for sounder circuits?',
    answer:
      'Calculate based on device current and volt drop. Typically 1.5mm2, increasing to 2.5mm2 for long runs or high loads.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Standard:</strong> FP200 - 30 min fire resistance
              </li>
              <li>
                <strong>Enhanced:</strong> FP200 Gold - 120 min at 842C
              </li>
              <li>
                <strong>MICC:</strong> Excellent but needs specialist termination
              </li>
              <li>
                <strong>LSZH:</strong> Low Smoke Zero Halogen - reduce toxic fumes
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Check fire strategy for enhanced requirement
              </li>
              <li>
                <strong>Use:</strong> Screened cable near EMC sources
              </li>
              <li>
                <strong>Apply:</strong> Earth screen at panel end only
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Fire alarm cables must maintain circuit integrity during fire conditions. BS 5839-1
              distinguishes between standard and enhanced performance requirements.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Low Smoke Zero Halogen (LSZH) cable sheaths are essential in fire alarm installations
              to minimise toxic smoke during a fire.
            </p>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm text-white">
                <strong>Note:</strong> Fire-resisting cables for fire alarms should always have LSZH
                sheaths. Check specification requirements carefully.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Correct termination is essential to maintain fire resistance ratings and ensure
              reliable operation.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Different circuits have different requirements. Match cable selection to the circuit
              function and fire strategy.
            </p>
            ...
            <div className="space-y-4 my-6">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <p className="text-sm text-white">
                  Standard fire-resistant, screened if near interference sources. Consider 1.5mm2
                  for long runs to manage volt drop.
                </p>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <p className="text-sm font-medium text-white mb-1">Sounder/VAD Circuits</p>
                <p className="text-sm text-white">
                  Standard or enhanced depending on evacuation strategy. Size for current and volt
                  drop (1.5mm2 or 2.5mm2 typical).
                </p>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                <p className="text-sm font-medium text-white mb-1">Critical Interface Circuits</p>
                <p className="text-sm text-white">
                  Enhanced cable for fire/smoke control, emergency lighting interfaces. Consider
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Correct handling protects cable integrity and maintains fire performance ratings.</p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">Key Practices:</p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Observe minimum bend radius throughout installation - not just at terminations
                </li>
                <li>
                  Avoid mechanical damage - do not stand on cables or crush during installation
                </li>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Check fire strategy document early - it specifies where enhanced cable is required
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Using standard cable where enhanced is specified</strong> - in the fire
                  strategy
                </li>
                <li>
                  <strong>Damaging cable sheath or insulation</strong> - with tight bends or
                  crushing during installation
                </li>
                <li>
                  <strong>Earthing cable screens at both ends</strong> - creating earth loops and
