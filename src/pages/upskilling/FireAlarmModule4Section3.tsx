import { ChevronLeft, ChevronRight, Cable } from 'lucide-react';
    ...
    <HubPage>
      ...
      <HubBody>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              voltage signal or power (typically a representative load). The cable must continue to
              carry that signal without short circuit or open circuit for the full 30 minutes.
              Failure (short or open) ends the test.
            </li>
          </ul>
          <p>
            A PH30-classified cable has passed this combined-stress test for 30 minutes. The
            classification is what gives the design engineer confidence that the cable will continue
            to operate during a real fire event for at least the standard duration.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              throughout. Standard PH30 may be insufficient if the phased evacuation period exceeds
              30 minutes, which it often does in tall buildings.
            </li>
            <li>
              <strong>Extended evacuation.</strong> Buildings with long evacuation routes,
              restricted-mobility populations, or complex layout that drives evacuation times beyond
              30 minutes. Hospitals, care homes, large public assembly buildings, deep basements,
              complex underground stations — all may require enhanced cable to match their
              evacuation duration.
            </li>
            <li>
            ...
            <li>
              ...
              evacuation characteristics. Even where a simultaneous evacuation strategy is nominally
              adopted, the practical evacuation time is long, and the enhanced cable gives the
              system survival headroom.
            </li>
            <li>
              ...
              fire-engineering solutions for non-standard buildings produce specific cable survival
              demands above standard PH30.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              application — power, control, detection, voice alarm — and references the appropriate
              product standards.
            </li>
            <li>
            ...
            <li>
              <strong>Joints.</strong> Where joints are unavoidable, they are made within fire-rated
              junction boxes designed to maintain the system&apos;s PH category. Plastic junction
              boxes do not qualify; metal fire-rated boxes with the appropriate seal / gland system
              do.
            </li>
            <li>
            ...
            <li>
              ...
              alternative routing where fire-source proximity is unavoidable, and consideration of
        ...
        <RegsCallout
          ...
          clause={
            <>
              This British Standard gives recommendations for the selection of fire-resistant cables
              and methods of their installation in fire-resistant cable systems for the life-safety
              circuits of buildings. It covers cable selection by application, the selection and
              installation of fire-rated supports and containment, the avoidance or fire-rating of
              joints, the segregation of life-safety circuits from non-safety circuits, and the
              documentation requirements for the as-installed cable system.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              ...
              <text x="135" y="129" textAnchor="middle" fill="#000" fontSize="7" fontWeight="bold">
                L
              </text>
              <text x="165" y="129" textAnchor="middle" fill="#FFF" fontSize="7" fontWeight="bold">
                N
              </text>
              <text x="150" y="149" textAnchor="middle" fill="#000" fontSize="7" fontWeight="bold">
                CPC
              </text>
              <text
                x="150"
              ...
              <text x="150" y="258" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="11">
                PH30 Standard
              </text>
              <text x="150" y="275" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                red LSZH sheath
              </text>
              <text x="150" y="290" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                mica/glass-tape insulation
              </text>
              <text x="150" y="305" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <g>
              ...
              <text x="425" y="129" textAnchor="middle" fill="#000" fontSize="6" fontWeight="bold">
                L
              </text>
              <text x="455" y="129" textAnchor="middle" fill="#FFF" fontSize="6" fontWeight="bold">
                N
              </text>
              <text
                x="440"
              ...
              <text x="440" y="258" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="11">
                PH120 Enhanced
              </text>
              <text x="440" y="275" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                red LSZH sheath
              </text>
              <text x="440" y="290" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                + extra fire barrier layer
              </text>
              <text x="440" y="305" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
            ...
            <g>
              ...
              <text x="730" y="258" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="11">
                PH120+ extreme duty
              </text>
              <text x="730" y="275" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                copper sheath + MgO
              </text>
              <text x="730" y="290" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
                refineries, tunnels, marine
              </text>
              <text x="730" y="305" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              stock item with most fire alarm wholesalers. The default routine cable for the bulk of
              UK fire alarm work.
            </li>
          </ul>
          <p>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Construction.</strong> Same conductor / inner insulation / sheath architecture
              as FP200 Gold, with an additional intermediate fire-barrier layer that provides the
              extended fire-survival capability. Maintains the LSZH / low-smoke-zero-halogen
              properties.
            </li>
            <li>
            ...
            <li>
              ...
              life-critical interfaces. Cost is higher than FP200 Gold; that cost is justified only
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              mechanically intact at temperatures that would have destroyed polymeric cables an hour
              earlier; the MgO insulation maintains its dielectric properties through the event.
              Real-world performance is documented in service in extreme environments — refinery
              process areas, tunnel installations, marine vessels — where polymeric cables would not
            ...
            <li>
              <strong>Service life.</strong> Documented installations from the 1960s and 1970s still
              operating. The all-metal construction has no plastic that ages or embrittles. Where
              life-cycle cost matters, MICC&apos;s long service life can offset its higher initial
              cost.
            </li>
            <li>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-4/section-4')}
