...
const DESCRIPTION =
  'Learn about detector mounting, manual call point positioning and sounder installation requirements per BS 5839-1.';

const quickCheckQuestions = [
  {
    id: 'device-1',
    question:
      'A hotel bedroom door when closed reduces corridor sounder level to 60 dB(A). Is this compliant for sleeping accommodation?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'No - 75 dB(A) is required at bed-head level in sleeping accommodation. A sounder or sounder-beacon would need to be installed within the bedroom to achieve compliance.',
  },
  {
    id: 'device-2',
    ...
    correctIndex: 1,
    explanation:
      'Unsynchronised flashing can cause disorientation and may trigger photosensitive conditions in susceptible individuals. Synchronisation ensures a consistent, recognisable alarm signal.',
  },
  {
    id: 'device-3',
    question:
      'A warehouse has a 15m high ceiling. Which detector type would be most appropriate and why?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Beam detectors would be appropriate for a 15m ceiling. Point detectors become less effective at greater heights due to smoke cooling and dispersing before reaching ceiling level. Beam detectors can be positioned at optimal height for early detection.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'BS 5839-1 recommends MCPs be mounted at 1.4m above floor level to the operating element for accessibility and compliance with DDA requirements.',
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      'MCPs should be positioned so that no person need travel more than 45m to reach a call point on the floor. Near exits is preferable.',
  },
  {
    id: 3,
    question:
      'What is the typical mounting height for point-type smoke detectors on flat ceilings?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Point detectors should be mounted at ceiling level or within 50mm of the ceiling surface to detect rising smoke effectively.',
  },
  {
    id: 4,
    question:
      'What minimum sound level must fire alarm sounders achieve at bed-head level in sleeping accommodation?',
    options: ['55 dB(A)', '65 dB(A)', '75 dB(A)', '85 dB(A)'],
    correctAnswer: 2,
    explanation:
      'BS 5839-1 requires a minimum of 75 dB(A) at bed-head level in sleeping areas to ensure occupants are awakened by the alarm.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'A minimum of 65 dB(A) is required throughout all areas of the building, or 5 dB(A) above ambient noise if this is higher.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Detectors should be positioned at least 300mm from walls and obstructions to avoid dead air spaces where smoke may not reach the detector.',
  },
  {
    id: 7,
    question: 'When installing beam detectors, what is the typical height range above floor level?',
    options: ['1-2m', '3-5m', '6-25m typically', 'Any height'],
    correctAnswer: 2,
    explanation:
      'Beam detectors are typically used for high ceiling applications, generally between 6m and 25m, where point detectors would be impractical.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'VADs must be positioned considering their coverage pattern, mounting height requirements, and any obstructions that could reduce visibility.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'MCPs at final exits should be positioned adjacent to and on the same side as the door opening to allow easy activation when evacuating.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Detector bases in suspended ceilings must have independent support to the structure above, not rely solely on ceiling tiles which may not support the weight.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Generally no - heat detectors are preferred due to cooking fumes causing false alarms. Multi-sensor detectors with appropriate algorithms may be suitable in some situations.',
  },
  {
    question: 'What about detectors in bathrooms and shower rooms?',
    answer:
      'Heat detectors can be used if detection is required. Smoke detectors are generally unsuitable due to steam. Consider whether detection is actually needed based on risk assessment.',
  },
  {
    question: 'How do I handle sloped ceilings?',
    answer:
      'Detectors should be mounted at the apex or within 600mm of it. For steeper pitches, additional detectors may be needed at lower levels. Refer to BS 5839-1 guidance.',
  },
  {
    question: 'Can MCPs be recessed into walls?',
    answer:
      'Yes, provided the operating element remains easily identifiable and accessible. The recess must not obstruct operation or visibility.',
  },
  {
    question: 'What if the design shows fewer sounders than needed for coverage?',
    answer:
      'Raise a technical query with the designer before proceeding. Sound level verification at commissioning may reveal the issue - better to address early.',
  },
  {
    question: 'Do all VADs need to be the same colour?',
    answer:
      'VADs for fire alarm should produce red or white flashing light. Consistency within a building aids recognition. Check specification requirements.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Detectors:</strong> Mount at ceiling level, 300mm from walls/obstructions,
                with spacing per manufacturer data
              </li>
              <li>
                <strong>MCPs:</strong> At 1.4m height, within 45m travel distance, adjacent to exits
              </li>
              <li>
                <strong>Sounders:</strong> Must achieve 75 dB(A) at bed-head in sleeping areas, 65
                dB(A) elsewhere
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>VADs:</strong> Coverage per BS EN 54-23, synchronised if multiple visible
              </li>
              <li>
                <strong>Fixings:</strong> Independent support for suspended ceiling detectors
              </li>
              <li>
                <strong>Spacing:</strong> Per manufacturer data sheets for specific detector types
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Point-type detectors (smoke, heat, multi-sensor) are the most common device type.
              Correct positioning ensures reliable detection of fire conditions.
            </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Typical Coverage (flat ceilings up to 10.5m):
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Manual call points (MCPs) allow building occupants to manually trigger the alarm.
              Positioning is critical for accessibility and rapid evacuation.
            </p>
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
              <p className="text-sm text-white">
                <strong>Important:</strong> MCPs at final exits must be positioned on the same side
                as the door opening so occupants can activate while evacuating.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Fire alarm sounders must achieve minimum sound pressure levels throughout the building
              to ensure all occupants are alerted.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Sleeping areas:</strong> 75 dB(A) minimum at bed-head level
                </li>
                <li>
                  <strong>All other areas:</strong> 65 dB(A) minimum throughout
                </li>
                <li>
                  <strong>High ambient noise:</strong> 5 dB(A) above ambient level
                </li>
                <li>
                  <strong>Plant rooms:</strong> Consider hearing protection requirements
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Visual alarm devices supplement sounders to alert those who are deaf or hard of
              hearing, or in areas where audible alarms may not be effective.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>W (Wall):</strong> Mounted on wall, coverage in front
                </li>
                <li>
                  <strong>C (Ceiling):</strong> Mounted on ceiling, coverage below
                </li>
                <li>
                  <strong>O (Open):</strong> Coverage in all directions
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Selecting the correct fixings for different substrates ensures devices remain secure
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Concrete/masonry:</strong> Nylon plugs with appropriate screws
                </li>
                <li>
                  <strong>Plasterboard:</strong> Spring toggles or cavity fixings
                </li>
                <li>
                  <strong>Suspended ceilings:</strong> Independent support to structure
                </li>
                <li>
                  <strong>Metal surfaces:</strong> Self-tapping screws or threaded studs
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
              <p className="text-sm text-white">
                <strong>Warning:</strong> Detector bases in suspended ceilings must be independently
                supported from the structure above - never rely on ceiling tiles alone.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Beyond point detectors, several specialist detector types address specific application
              requirements.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Positioning detectors too close to air conditioning vents</strong> —
