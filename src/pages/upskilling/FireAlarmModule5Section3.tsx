...
const FireAlarmModule5Section3 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 5 · Section 3" title="Device installation" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Detectors, manual call points, sounders, VADs, beam and linear heat. The 2025 revision
          changes detector use in sleeping rooms, clarifies MCP mounting tolerance and recognises
          new product standards for linear heat cable.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              Standard ceiling installation is base flush to ceiling; the element is then naturally
              inside the band depending on detector geometry. Pendant or stalk-mounted installations
              push the element down — verify the offset.
            </li>
            <li>
              <strong>Heat detectors.</strong> Sensing element 25 mm to 150 mm below the ceiling.
              Tighter range than smoke. The shorter heat-plume reach means sensor must be closer to
              the ceiling.
            </li>
            <li>
            ...
            <li>
              ...
              1.25-1.5 m deep — top 10 % of void depth; voids &gt; 1.5 m deep — treated as a normal
              room with the standard ceiling rule applied.
            </li>
            <li>
              <strong>L3 rooms off escape route.</strong> Per 21.2.5, smoke detection in rooms that
              open onto an escape route. The 25-600 mm smoke rule applies; ceiling construction is
              usually solid construction (the 2025 revision removed the previous "fire-resisting
              construction" wording in favour of "solid construction with no holes" — easier to
              verify).
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Affected categories.</strong> L2 systems where the bedroom is part of the area
              requiring early warning. L3 systems where bedrooms open onto escape routes. Even
              though L3 detection is escape-route-protective rather than person-protective, the 2025
              revision now excludes heat in sleeping rooms in L3 too.
            </li>
            <li>
              <strong>Replacement detectors.</strong> Smoke detector (optical preferred for bedrooms
              — fewer false alarms from cooking and steam ingress to a closed bedroom) or
            ...
            <li>
              ...
              for-like under the existing system. New work and system upgrades follow the new rule.
            </li>
            <li>
              <strong>Stairway lobbies.</strong> Now require automatic detection in L2 (was excluded
              as low fire risk). Survey lists every stairway lobby; detectors added.
            </li>
            <li>
              <strong>Sprinkler-head zone overlap.</strong> Sprinkler heads can be used to initiate
              fire-alarm conditions; the indication of sprinkler operation must not overlap with
              more than one fire detection zone (2025 clarification).
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              room. Despite previous editions of BS 5839-1 allowing the use of heat detectors in
              sleeping rooms, the new recommendation is not retrospective.
            </>
          }
          ...
          >
            ...
            <g>
              ...
              <rect
                ...
                strokeWidth="1.6"
              />
              <text x="625" y="425" textAnchor="middle" fill="#fff" fontSize="14" fontWeight="bold">
                MCP
              </text>
              ...
              <text x="540" y="460" textAnchor="end" fill="#FBBF24" fontSize="10" fontWeight="bold">
                1.40 m
              </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              tolerance +200 mm / -300 mm (range 1.1 m to 1.6 m). 2025 makes the tolerance explicit.
            </li>
            <li>
            ...
            <li>
              ...
              text; addressable systems show the address on the panel after operation. Local signage
              (a "FIRE ALARM CALL POINT" label) where the local environment makes the MCP less
              visible (cluttered corridor, dim lighting).
            </li>
            <li>
              <strong>Protective covers.</strong> 2025 recommends transparent (clear plastic)
              protective covers; the 2017 revision recommended covers in general but did not specify
              transparent. Transparent covers preserve the visual recognition of the MCP while
          ...
          <p>
            MCP mounting at the wrong height is a common audit finding. The 2025 explicit tolerance
            removes the "is 1.7 m close enough to 1.4 m?" debate — 1.7 m is outside the +200 mm
            bound, so it is non-compliant. Set the height at install; do not let second-fix moves
        ...
        <RegsCallout
          ...
          clause={
            <>
              If manual call points are located on the landings of a stairway, the manual call point
              on each level, other than a final exit level from the stairway, should be incorporated
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              target on the receiver, or signal-strength indicator on the receiver showing the live
              attenuation reading. Beam aimed using the sight; fine-tuned using the signal- strength
              reading.
            </li>
            <li>
              <strong>Signal strength.</strong> Set within manufacturer-specified margin — typically
              a "green zone" on the indicator. Excessive signal strength causes saturation; too low
              triggers fault.
            </li>
            <li>
            ...
            <li>
              <strong>Documentation.</strong> As-installed signal strength recorded; beam path drawn
              on the drawing; reflector / receiver position recorded. Service visits re-verify
              alignment.
            </li>
            <li>
              <strong>Limit testing.</strong> Manufacturer test filters simulate smoke attenuation;
              beam alarms at a calibrated attenuation level. Limit-testing at commissioning verifies
              the beam triggers at the correct attenuation.
            </li>
          </ul>
          <p>
            Beam detector misalignment is the dominant in-service failure mode for beams. The cause
            is typically building movement or temporary obstructions; the detection is fault signal;
            the remediation is re-alignment during a service visit. Robust install alignment reduces
            the likelihood.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>75 dB(A) at the bed-head in sleeping accommodation.</strong> Higher threshold
              to wake a sleeping occupant. Verified at the bed-head position with the bedroom door
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Test method.</strong> Manufacturer-specified — typically a heat source applied
              at a designated test point, simulating activation. Limit-testing at commissioning
              verifies the cable activates at the correct temperature.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Location.</strong> Room name, position within room (e.g. "centre of ceiling",
              "at MCP-1.4 m").
            </li>
            <li>
              <strong>Type.</strong> Optical smoke, ionisation smoke (rare in new work), heat (with
              class — typically A1R or A2S), multi-sensor (with operating mode set — smoke-only,
              heat-only, smoke + heat with priority, etc.), beam, linear heat (with BS EN 54-22 / BS
              EN 54-28 type), aspirating (with sensitivity setting).
            </li>
            <li>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-5/section-4')}
