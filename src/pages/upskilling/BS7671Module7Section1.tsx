    ...
    <HubPage>
      ...
      <HubBody>
        <div className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            "How BS 7671:2018+A4:2026 treats wet, immersed and high-touch-current locations — Section 701 (bath / shower), Section 702 (swimming pools), Section 703 (sauna heaters). Zones, IP ratings, RCDs, supplementary bonding omission and the way A4's Reg 411.3.4 layers on top."
          }
        </div>
        ...
        >
          <p>
            Part 7 of BS 7671 covers <strong>special installations or locations</strong> — Sections
            701 to 753. The thread that links bathrooms, pools, saunas, fountains, marinas and
            construction sites is that the standard touch-current model from Chapter 41 no longer
            describes the worst-case occupant. In a bathroom the bather is wet, often gripping fixed
            metal taps and standing on a damp floor. In a pool, occupants are immersed in a
            conductive medium and may be partly out of the water gripping a metal grab rail. In a
            sauna, skin is hot and wet. The reduced body resistance moves the line at which
            electrical injury occurs, so Part 7 layers <em>additional</em> requirements on top of
            the general requirements of Parts 1 to 6.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            hotel, swimming-pool changing-room showers — the requirement uplifts to IPX5 throughout
            zones 1 and 2 (Reg 701.512.2). The trigger is the cleaning regime, not the water flow
            during normal use.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>Zone 0 (inside the bath / shower):</strong> only SELV-supplied equipment to 12 V
            AC RMS / 30 V DC ripple-free, IPX7, fixed for use in this zone (Reg 701.55). Switches
            and sockets PROHIBITED.
            <strong> Zone 1 (above the bath up to 2.25 m):</strong> fixed luminaires, water heaters,
            ventilation fans, towel rails, electric showers, whirlpool units — IPX4, suitable for
            the zone, on a 30 mA RCD. Switches PROHIBITED unless SELV (cord-pull switches outside
            the zones are the usual answer). Sockets PROHIBITED except SELV / shaver.
            <strong> Zone 2 (0.6 m horizontal beyond Zone 1, up to 2.25 m):</strong> as Zone 1 plus
            shaver supply units to BS EN 61558-2-5, located at least 0.6 m horizontally from Zone 1.
            Standard sockets are still PROHIBITED in Zone 2 — but the wall surface just beyond Zone
            2 is unzoned and a normal socket is permitted there.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            immersion heater, electric shower, towel rail, extractor fan, shaver point. Reg 411.3.4
            (new in A4, in force 15 April 2026) layers on top by requiring the same 30 mA cover on
            every AC final circuit supplying luminaires within ANY domestic premises. There's no
            exemption from either: a documented risk assessment under Reg 411.3.3 only ever touched
            non-domestic socket-outlet circuits and was never available for bathroom or
            domestic-luminaire circuits.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            <strong> (ii)</strong> all final circuits of the location have additional protection by
            an RCD with rated residual operating current not exceeding 30 mA per Reg 415.1.1;
            <strong> (iii)</strong> all extraneous-conductive-parts of the location are effectively
            connected to the protective equipotential bonding by main protective bonding conductors
            complying with Reg 411.3.1.2 — bonded all the way back to the MET. If any one of the
            three is not satisfied, supplementary bonding within the location is required, sized per
            Reg 415.2.1 and Reg 544.2 (4 mm² minimum where mechanical protection is not provided,
            2.5 mm² minimum where it is).
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 702.32 defines the pool zones. <strong>Zone 0</strong> is the interior of the basin
            (including any niches, steps and recesses in the pool wall). <strong>Zone 1</strong>{' '}
            extends 2 m horizontally outwards from the rim of the pool and 2.5 m vertically upwards
            from any walkable surface within Zone 1. <strong>Zone 2</strong> is a further 1.5 m
            horizontal extension beyond Zone 1, up to the same 2.5 m vertical height. Section 702
            also applies to "basins for general use of which the water has a depth greater than 0.3
            m" — which catches private hot tubs, plunge pools and inflatable spas where water depth
            exceeds 30 cm.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 702.410.3.4.1 / 702.55 sets the Zone 0 SELV limit. The <em>nominal</em> voltage must
            not exceed 12 V AC RMS or 30 V DC ripple-free. The safety isolating source (transformer
            to BS EN 61558-2-6) must be located outside Zones 0 and 1. Zone 1 equipment is permitted
            at higher voltages but with strict equipment lists, IPX5 minimum and 30 mA RCD
            additional protection. Zone 2 permits more equipment again with similar IP and RCD
            requirements. The pattern is the same as a bathroom — but with bigger zones and tighter
            Zone 0 voltage.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            is NOT subject to a 701.415.2-style omission, because the consequence of touch potential
            between two metal items in a pool location (one earthy, one elevated by fault) is
            materially different from a bathroom. The bonding must be installed before the deck is
            poured / tiled, with continuity tested back to the MET as part of the initial
            verification.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            immediately around the heater (highest air temperature), <strong>Zone 2</strong> is the
            upper part of the cabin, <strong>Zone 3</strong> is the lower part. Equipment in each
            zone must be temperature-rated to the maximum air temperature of that zone. Wiring
            within the cabin is restricted to that needed to supply equipment within the cabin (Reg
            703.521.1).
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            cord-pull. Many fans have integrated 12 V SELV variants with the transformer in the loft
            — this lets the fan itself sit anywhere up to Zone 0 (with the transformer outside the
            zones).
            <strong> Shaver point.</strong> BS EN 61558-2-5 shaver supply unit, located in Zone 2 at
            least 0.6 m horizontally from Zone 1 (i.e. on the back wall, away from the bath), or
            beyond Zone 2 entirely. Built-in safety isolating transformer.
            <strong> Electric shower.</strong> Hard-wired through a flex outlet plate in Zone 1, fed
            by a dedicated 30 mA RCD or RCBO at the consumer unit, isolator pull-cord outside Zone
            2, IPX4 minimum.
            <strong> Towel rail.</strong> Hard-wired or fed via fused connection unit (NOT a 13 A
            plug) outside Zone 2 — the flex enters the zones via a flex outlet plate. IPX4 minimum.
            <strong> Downlights.</strong> IPX4 minimum within Zones 1 and 2 (so practically IP65 LED
            downlights are universal). Reg 411.3.4 means the lighting circuit needs 30 mA RCD cover
            regardless of zone.
          </p>
        </ConceptBlock>
