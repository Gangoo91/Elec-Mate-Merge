...
const DESCRIPTION =
  'Learn about smart home core components: sensors, actuators, and controllers. Understand how these devices work together to create intelligent automation systems.';
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A smart home hub coordinates communication between devices that may use different protocols (Zigbee, Z-Wave, Wi-Fi) and provides centralised automation processing.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A multi-protocol hub can communicate with devices using Zigbee, Z-Wave, Wi-Fi, and other protocols, allowing integration of devices from different manufacturers.',
  },
  {
    id: 9,
...
const faqs = [
  {
    ...
    answer:
      'Wired sensors connect via cables, offering reliable power and communication but requiring installation runs. Wireless sensors use batteries and radio protocols (Zigbee, Z-Wave), offering flexible placement but requiring battery maintenance. Many systems use a mix of both.',
  },
  {
    question: 'How often do wireless sensor batteries need replacing?',
    answer:
      'Battery life varies significantly: door/window sensors typically last 2-5 years, motion sensors 1-3 years, and environmental sensors 1-2 years depending on reporting frequency. Smart home apps usually alert when batteries are low.',
  },
  {
    question: 'Can I use sensors from different manufacturers together?',
    answer:
      'If sensors use the same protocol (e.g., Zigbee or Z-Wave) and are compatible with your hub, they can generally work together. Multi-protocol hubs like Hubitat or Home Assistant can integrate devices from many manufacturers.',
  },
  {
    question: 'What happens if my smart home hub fails?',
    answer:
      'If your hub fails, automation and device coordination will stop, but many individual devices can still be controlled manually or through their own apps. Having a backup hub or using cloud-based systems provides redundancy.',
  },
  {
    question: 'Do I need a hub for all smart home devices?',
    answer:
      'Not all devices require a hub. Wi-Fi devices often connect directly to your router and cloud services. However, Zigbee and Z-Wave devices require a compatible hub. A hub provides better integration, automation, and often improved reliability.',
  },
  {
    question: 'What is the advantage of local processing versus cloud processing?',
    answer:
      'Local processing (at the hub) provides faster response times, works during internet outages, and keeps data private. Cloud processing offers easier remote access and often more sophisticated AI features but depends on internet connectivity.',
  },
];
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">Sensors, actuators, and controllers in smart home systems</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Sensors:</strong> Detect conditions (motion, temp, light)
              </li>
              <li>
                <strong>Actuators:</strong> Perform actions (switch, move, adjust)
              </li>
              <li>
                <strong>Controllers:</strong> Process data and execute logic
              </li>
              <li>
                <strong>Integration:</strong> Components work together as a system
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> PIR sensors, contact sensors, smart hubs
              </li>
              <li>
                <strong>Use:</strong> Component selection, system design
              </li>
              <li>
                <strong>Apply:</strong> Matching sensors to applications
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Sensors are the eyes and ears of a smart home system. They detect environmental
              conditions and convert them into electrical signals that can be processed by
              controllers to trigger automated responses.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>PIR (Passive Infrared):</strong> Detects body heat movement, common for
                  lighting control
                </li>
                <li>
                  <strong>Microwave:</strong> Detects movement through Doppler effect, works through
                  thin walls
                </li>
                <li>
                  <strong>Ultrasonic:</strong> Uses sound waves, detects fine movements
                </li>
                <li>
                  <strong>Dual-technology:</strong> Combines PIR and microwave for reduced false
                  triggers
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Temperature:</strong> Monitors room and outdoor temperatures for HVAC
                  control
                </li>
                <li>
                  <strong>Humidity:</strong> Detects moisture levels for ventilation and mould
                  prevention
                </li>
                <li>
                  <strong>Light:</strong> Measures ambient light for daylight harvesting
                </li>
                <li>
                  <strong>Air Quality:</strong> Monitors CO2, VOCs, and particulates
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Contact Sensors:</strong> Magnetic reed switches for doors and windows
                </li>
                <li>
                  <strong>Glass Break:</strong> Acoustic sensors detecting breaking glass
                </li>
                <li>
                  <strong>Smoke/CO:</strong> Life safety sensors with smart connectivity
                </li>
                <li>
                  <strong>Water Leak:</strong> Conductivity sensors for flood detection
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Protocol-specific hubs:</strong> Support one protocol (Philips Hue for
                  Zigbee lights)
                </li>
                <li>
                  <strong>Multi-protocol hubs:</strong> Support multiple protocols (SmartThings,
                  Hubitat)
                </li>
                <li>
                  <strong>DIY platforms:</strong> Flexible systems like Home Assistant, OpenHAB
                </li>
                <li>
                  <strong>Professional systems:</strong> Proprietary systems like Control4, Crestron
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>1. Detection:</strong> Sensor detects a condition change (motion detected)
                </li>
                <li>
                  <strong>2. Transmission:</strong> Sensor sends signal to controller via protocol
                </li>
                <li>
                  <strong>3. Processing:</strong> Controller evaluates against automation rules
                </li>
                <li>
                  <strong>4. Decision:</strong> Controller determines required action
                </li>
                <li>
                  <strong>5. Command:</strong> Controller sends command to actuator
                </li>
                <li>
                  <strong>6. Action:</strong> Actuator performs the physical action (light turns on)
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Detection range:</strong> Match to room size and layout
                </li>
                <li>
                  <strong>Power source:</strong> Battery vs mains powered
                </li>
                <li>
                  <strong>Protocol compatibility:</strong> Must work with your hub
                </li>
                <li>
                  <strong>Environmental rating:</strong> Indoor vs outdoor use
                </li>
                <li>
                  <strong>Response time:</strong> How quickly does it react?
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Load capacity:</strong> Must handle the connected load
                </li>
                <li>
                  <strong>Load type:</strong> LED, incandescent, motor, resistive
                </li>
                <li>
                  <strong>Wiring requirements:</strong> Neutral wire, two-wire, etc.
                </li>
                <li>
                  <strong>Physical size:</strong> Must fit in available space
                </li>
                <li>
                  <strong>Manual override:</strong> Can it be operated manually?
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Mismatched protocols</strong> - sensors and hub must be compatible
                </li>
                <li>
                  <strong>Undersized actuators</strong> - always allow headroom for load capacity
                </li>
                <li>
                  <strong>Poor sensor placement</strong> - results in unreliable detection
                </li>
                <li>
                  <strong>Ignoring battery life</strong> - plan for maintenance access
                </li>
              </ul>
            </div>
          </div>
