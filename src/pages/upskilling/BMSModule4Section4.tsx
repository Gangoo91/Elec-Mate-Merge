...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'To remove the need for mechanical ventilation',
      'To reduce the cost of the glazing specification',
      'To eliminate the need for HVAC entirely',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To reduce mechanical wear on the blind motors',
      'To synchronise shading with neighbouring buildings',
      'To adjust shading position based on where sunlight is actually coming from',
      'To satisfy a planning condition on the building',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To monitor outdoor air quality for the BMS',
      'To calculate the energy savings of the shading',
      'To trim HVAC setpoints on windy days',
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent border border-white/10">
                ...
                <p className="text-white text-xs">Retract at 10-15 m/s</p>
              </div>
              <div className="p-3 rounded bg-transparent border border-white/10">
                <p className="font-medium text-white mb-1">Rain Sensor</p>
                <p className="text-white text-xs">Protect fabric blinds</p>
              </div>
              <div className="p-3 rounded bg-transparent border border-white/10">
                <p className="font-medium text-white mb-1">Sun Sensor</p>
                <p className="text-white text-xs">Light level + direction</p>
              </div>
            </div>
