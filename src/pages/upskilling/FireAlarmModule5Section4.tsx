...
const DESCRIPTION =
  'Learn about fire alarm cable installation, termination techniques, testing and compliance with BS 5839-1 and BS 7671.';

const quickCheckQuestions = [
  {
    id: 'wiring-1',
    question:
      'Fire alarm cables need to run through common trunking with mains power cables. What segregation is required?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'A physical barrier (earthed metal partition) must separate the fire alarm cables (Band I) from mains cables (Band II), or they must be in separate compartments. Simply running them on opposite sides without a barrier is not compliant.',
  },
  {
    id: 'wiring-2',
    question:
      'An addressable loop uses 800m of 1.5mm square cable. What is the approximate loop resistance and is this likely to be acceptable?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      '800m of 1.5mm square cable = approximately 0.8 x 12 = 9.6 ohms outgoing + 9.6 ohms return = 19.2 ohms total loop resistance. This is typically within acceptable limits (most panels allow 20-50 ohms) but check specific manufacturer documentation.',
  },
  {
    id: 'wiring-3',
    ...
    correctIndex: 1,
    explanation:
      'Testing before connection identifies faults while cables are accessible and before potential damage to equipment. A short circuit could damage the panel. Insulation faults may not show immediately but cause intermittent problems later.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'What type of cable is typically required for fire alarm circuits that need to continue operating during a fire?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Fire-resistant cables meeting BS 7629 or BS 8434 are required for circuits that must maintain operation during a fire, such as certain sounder and mains supply circuits.',
  },
  {
    id: 2,
    question:
      'What is the maximum permitted loop resistance for most addressable fire alarm systems?',
    options: [
      '10 ohms',
    ...
    correctAnswer: 1,
    explanation:
      'Maximum loop resistance varies by manufacturer but is typically between 20-50 ohms. Always check the specific panel documentation for exact limits.',
  },
  {
    id: 3,
    question:
      'When installing fire alarm cables in trunking, what segregation is required from mains cables?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'BS 7671 requires segregation between fire alarm (Band I) and mains cables (Band II). This can be achieved with barriers, separate compartments, or spacing as specified.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'The screen provides protection against electromagnetic interference which could cause false alarms or communication failures on addressable loops.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Screen termination varies by manufacturer. Typically, the screen is only earthed at the panel end to avoid earth loops, but always follow manufacturer guidance.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'A minimum insulation resistance of 2 M ohms is typically required between conductors and earth, tested at 500V DC.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Detection circuits typically use 1.0mm square or 1.5mm square cable, with larger sizes for longer runs to keep resistance within limits and ensure adequate current capacity.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Ferrules prevent strand separation, ensure consistent contact area, and prevent damage from terminal tightening. They should match the conductor size.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Cable testing should include continuity of each conductor, insulation resistance between conductors and to earth, plus checks for short circuits.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Cables must be clearly labelled at the panel with circuit purpose, zones served and destinations to aid maintenance and fault finding.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Yes, but they must be accessible for maintenance, fire-rated where required, and clearly labelled. Minimise joints where possible as they are potential fault points.',
  },
  {
    question: 'What if insulation resistance is below 2 M ohms?',
    answer:
      'Investigate and rectify. Common causes include moisture ingress, damaged insulation, or contamination at terminations. Do not connect faulty cables to equipment.',
  },
  {
    question: 'Can fire alarm cables share containment with data cables?',
    answer:
      'Generally yes - data cables are also Band I. However, check for EMC requirements especially with network cables. Some panel manufacturers have specific guidance.',
  },
  {
    question: 'Why do some cables have 4 cores?',
    answer:
      'Some addressable systems use 4-core cable for outgoing and return paths, or for combined detection and sounder circuits. Check system design and panel requirements.',
  },
  {
    question: 'How do I know if fire-resistant cable is required?',
    answer:
      'Check the system design. Generally required for any circuit that must operate during evacuation - sounders, voice alarm, emergency lighting interfaces and certain supply cables.',
  },
  {
    question: 'What about cables in ceiling voids?',
    answer:
      'Must be properly supported, protected from damage, and routed to allow access for maintenance. Fire stopping required at compartment boundaries.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Fire-resistant cables:</strong> BS 7629/8434 required for circuits operating
                during fire conditions
              </li>
              <li>
                <strong>Segregation:</strong> Required from mains cables per BS 7671 to prevent
                interference
              </li>
              <li>
                <strong>Testing:</strong> All cables tested for continuity and insulation before
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Ferrules:</strong> Use bootlace crimps on all stranded conductors
              </li>
              <li>
                <strong>Screens:</strong> Earth at panel end only per manufacturer guidance
              </li>
              <li>
                <strong>Labelling:</strong> Both ends with circuit purpose and destination
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Correct cable selection ensures system reliability and compliance. Different circuits
              have different requirements based on their function during a fire.
            </p>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Fire-Resistant Cable (BS 7629/8434):
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Cables must be installed with appropriate support and protection to ensure long-term
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
              <p className="text-sm text-white">
                <strong>Warning:</strong> Fire-resistant cables lose their rating if damaged during
                installation. Handle with care and use appropriate bend radii.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BS 7671 requires segregation between fire alarm and mains cables to prevent
              electromagnetic interference and ensure circuit integrity.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Band I (Fire Alarm) vs Band II (Mains) Segregation:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Proper termination ensures reliable connections that will not deteriorate over the
              system's lifespan.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              All cables must be tested before connection to panel and devices to identify faults
              early.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Continuity:</strong> End-to-end resistance of each conductor
                </li>
                <li>
                  <strong>Insulation:</strong> Minimum 2 M ohms at 500V DC between conductors and
                  earth
                </li>
                <li>
                  <strong>Short circuit:</strong> No shorts between conductors
                </li>
                <li>
                  <strong>Screen continuity:</strong> If screened cable used
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Proper documentation and labelling is essential for maintenance and fault finding
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Using standard cable where fire-resistant is required</strong> —
                  non-compliant and unsafe
                </li>
                <li>
                  <strong>Not using ferrules on stranded conductors</strong> — leads to poor
                  connections
                </li>
                <li>
                  <strong>Earthing cable screens at both ends</strong> — creates earth loops causing
                  interference
                </li>
                <li>
                  <strong>Exceeding bend radius on fire-resistant cables</strong> — damages
                  insulation
                </li>
              </ul>
            </div>
