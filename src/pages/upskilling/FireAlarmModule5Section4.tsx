...
const FireAlarmModule5Section4 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 5 · Section 4" title="Wiring and terminations" backTo=".." />
      <HubBody>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              by being a single colour throughout. Mixing colours within the system blurs
              identification.
            </li>
            <li>
          ...
          <p>
            ...
            mains feed to the panel is a fire safety circuit in everything but designation; treating
            it as a general-circuit feed in green / brown / black blurs that. Second, the inspection
            argument — visual identification of the fire alarm wiring is faster and more reliable
            when one colour identifies the whole installation.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              alarm system, should be of a single, common colour, with the colour red being
              preferred. Where another colour has to be used, this should be recorded as a variation
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Protective Earth (PE) / CPC.</strong> Green-and-yellow striped, BS 7671 §514.
              The fault-current path. On the panel mains feed, on metal casework that requires
              bonding.
            </li>
            <li>
            ...
            <li>
              ...
              60446 — for the LV mains feed. Loop conductors on a fire alarm system are identified
              by the cable colour scheme (red overall jacket, internal cores follow manufacturer
              convention).
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              and modules, and returns to the panel SLC RETURN terminals. Isolators are distributed
              around the loop — typically one per zone, one per floor, or one per ~32 devices. A
              single open-circuit fault opens the loop into two short-circuit fault current paths,
              isolators on either side of the fault open, and the panel re-feeds the two unbroken
              legs from both ends. All devices except those immediately either side of the fault
            ...
            <li>
              ...
              open-circuit at the panel end disables every device beyond the break. A short-circuit
              anywhere on the spur disables the whole spur until cleared.
            </li>
            <li>
              <strong>Selection.</strong> Class A is the design default for category L1, L2, L3 and
              most addressable systems. Class B is acceptable for some smaller / less critical
              installations where the design risk-assessment justifies it. Manufacturer datasheets
              for the panel and the cable specify the maximum loop length and device count for each
              topology.
            </li>
            <li>
              <strong>Hybrid.</strong> Some panels mix Class A loops with Class B spurs feeding to a
              Class A backbone. The drawing must clearly identify which segments are Class A and
          ...
          <p>
            ...
            omitting the return) produces a partially functional system that LOOKS correct on first
            power-up but fails the cause-and-effect test under simulated fault conditions during
            commissioning.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="2"
            />
            <text x="80" y="78" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              PANEL
            </text>
            ...
            <line
              ...
              strokeLinecap="round"
            />
            <text x="385" y="48" textAnchor="middle" fill="#EF4444" fontSize="10" fontWeight="bold">
              OPEN
            </text>

            <text x="60" y="140" fill="rgba(255,255,255,0.7)" fontSize="10">
              ○ device · ▭ isolator · ✗ fault — devices on either side stay online via panel re-feed
            </text>
            ...
            <rect
              ...
              strokeWidth="2"
            />
            <text x="80" y="248" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              PANEL
            </text>
            ...
            <text x="60" y="406" fill="rgba(255,255,255,0.75)" fontSize="10">
              Both topologies — terminate per panel manual; verify Class A as a closed loop in panel
              diagnostic at commissioning.
            </text>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              provides a low-impedance path to a reference. Currents induced in the screen create a
              counter-field that cancels the noise field at the loop conductors. The cancellation
              works because the screen is referenced to a stable potential.
            </li>
            <li>
              <strong>One-end termination.</strong> The screen is connected to the panel functional
              earth at one end. Induced noise flows along the screen to the panel FE and is drained.
              No second connection means no return path, so no circulating current.
            </li>
            <li>
              <strong>Two-end termination.</strong> The screen is connected to functional earth at
              BOTH ends. Any potential difference between the two earth references (and there always
              is one) drives a current along the screen. The screen is now a noise SOURCE, not a
              noise drain.
            </li>
            <li>
          ...
          <p>
            ...
            fire alarm system from a system that limps through commissioning with random comm faults
            that the engineer cannot pin down. Get it right at first-fix.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text
              ...
              fontWeight="bold"
            >
              ⚠ Polarity must be maintained at every base — (+) red continuous, (−) blue continuous
            </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              specific to the fire alarm system. Sharing with general circuits, IT cabling or other
              life-safety systems is the design exception, not the rule. Where sharing is
            ...
            <li>
              ...
              require strut or trapeze. The cable must not sag under self-weight or under the weight
              of subsequent cables on the same containment.
            </li>
            <li>
              ...
              exceeds the wall / floor rating. A cable run through an unstopped penetration breaches
              the compartment regardless of cable rating.
            </li>
            <li>
          ...
          <p>
            ...
            penetrations, bend radius respected, identified throughout. Anything else is opportunity
            for a service-life failure.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Cable containment.</strong> Continues into the void on the planned route. Same
              fire rating, same identification, same support intervals.
            </li>
            <li>
            ...
            <li>
              ...
              identified on the as-installed drawing by zone and address; access tiles in suspended
              ceilings are commonly marked to identify which detector is above.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Fire-rated.</strong> Where a JB is unavoidable, body and gland system rated to
              match the cable rating. A 60-minute cable in a 0-minute JB is a 60-minute cable rated
              0 minutes.
            </li>
            <li>
            ...
            <li>
              ...
              label so the JB is identified in service. Unlabelled JBs get torn out by future trades
              who do not know what they are.
            </li>
            <li>
              <strong>Recorded.</strong> Position, reason and date on the as-installed drawing.
              Future service engineers find the JB on the drawing before they open the building up.
            </li>
          </ul>
          <p>
            The four words: AVOIDED, FIRE-RATED, ACCESSIBLE, RECORDED. JBs that fail any of the four
            are non-compliant and a service-life liability.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            For addressable devices, set the address per the design schedule BEFORE fitting the head
            to the base. Wrong address = device communicates but is reported by the panel at the
            wrong location = false-alarm investigation goes to the wrong place. The address schedule
            is in the as-installed drawing; the address on each device matches.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              sounders to their bases / boxes. Re-connect loop to panel SLC. Now the system is ready
              for first power-up.
            </li>
          </ol>
          <p>
            Some panel manufacturers offer a low-voltage diagnostic that runs after first
            energisation — this is NOT a substitute for the pre-energisation cable IR. The cable IR
            proves the wiring is fit to be energised; the panel diagnostic proves the loop
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Earthing per BS 7671:2018+A4:2026 §560.</strong> Section 560 deals with Safety
              Services. Fire alarm power supplies are safety services; their earthing is per §560.
              The panel mains feed CPC terminates at the panel earth bar; the battery negative
              terminal is panel-internal and follows the panel manufacturer's arrangement (typically
              isolated from earth, with the earth bar providing the reference for the LV mains side
              only).
            </li>
            <li>
              ...
              min alarm, or 72 h quiescent + 30 min alarm. The capacity calculation is in the design
              documentation; the installed batteries match.
            </li>
            <li>
              <strong>Charge regime.</strong> The panel monitors charge voltage and battery
              impedance / load test capability. Battery faults are reported on the CIE. Replacement
              is triggered by service-life (typically 4-5 years sealed lead-acid) or by a service
              finding (low voltage, high impedance, capacity test fail).
            </li>
            <li>
              <strong>Care during install.</strong> Batteries are charged at delivery — handle with
              insulated tools, avoid short-circuit between terminals. Wear eye protection — sealed
              lead-acid can vent under abuse. Dispose of old batteries via a licensed waste-stream
              operator under the Batteries and Accumulators Regulations 2009.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Labelled.</strong> Identification clearly stating the function. Format varies
              by project; typical wording &quot;FIRE ALARM SYSTEM — MAINS ISOLATOR — DO NOT SWITCH
              OFF&quot;.
            </li>
            <li>
            ...
            <li>
              <strong>Used under controlled conditions.</strong> Operation of the isolator follows a
              documented procedure (typically: notify ARC, inform building management, perform
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              have been consolidated into a single clause in the 2025 edition. A dedicated, clearly
              labelled mains isolator, accessible to authorised persons and used under controlled
              conditions, should be provided for the fire alarm system.
            </>
          }
        ...
        <FAQ
          items={[
            ...
            {
              question: 'Can I use plastic cable cleats on fire-resistant cable? They are cheaper.',
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-5/section-5')}
