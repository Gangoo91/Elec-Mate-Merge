...
const DESCRIPTION =
  'Learn how to interpret PAT test results correctly and identify common failure modes and their causes.';

const quickCheckQuestions = [
  {
    id: 'm4s6-check1',
    question:
      'An earth continuity reading of 0.45 ohms on a 3m cable appliance. What is the result?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Maximum for 3m cable = 0.1 + (0.1 x 3) = 0.4 ohms. A reading of 0.45 ohms exceeds this slightly. However, if test lead resistance was not nulled, this could account for the excess. Investigate further.',
  },
  {
    id: 'm4s6-check2',
    question:
      'A Class II hairdryer shows an insulation resistance of 1.5 megohms. What is the result?',
    options: [
      'Pass - above 1 megohm',
      'Fail - Class II requires 2 megohms minimum',
      'Borderline - acceptable for domestic use',
      'Need to check earth continuity first',
    ],
    correctIndex: 1,
    explanation:
      'Class II appliances require a minimum of 2 megohms insulation resistance. 1.5 megohms is below this threshold, so the appliance fails. Class II has stricter limits because there is no earth protection.',
  },
  {
    id: 'm4s6-check3',
    ...
    correctIndex: 1,
    explanation:
      'Loose terminal screws in the plug are the most common cause of high earth continuity readings. This is often easily fixed by tightening the terminals and retesting.',
  },
];

const quizQuestions = [
  {
    question: 'What is the first thing to check when an appliance fails earth continuity?',
    options: [
      'Replace the fuse',
      'Check plug terminal connections',
      'Replace the cable',
  ...
  {
    question: 'An insulation resistance reading showing OL or infinity indicates:',
    options: [
      'A fault condition',
  ...
  {
    question: 'A borderline result should be:',
    options: [
      'Passed if close to the limit',
      'Investigated and monitored',
      'Ignored if the appliance works',
      'Recorded as a pass',
    ],
    correctAnswer: 1,
  },
  {
    question: 'Common causes of insulation failure include:',
    options: [
      'Normal usage',
  ...
  {
    question: 'If polarity is reversed, the correct action is:',
    options: [
      'Use the appliance with care',
      'Rewire correctly or replace',
      'Record as advisory',
      'Test again later',
    ],
    correctAnswer: 1,
  ...
  {
    question: 'When retesting a repaired appliance, you should:',
    options: [
      'Only test the repaired component',
      'Perform a full test sequence',
  ...
  {
    question: 'Trending test results over time helps identify:',
    options: [
  ...
  {
    question: 'A Class I appliance with 0.8 megohms insulation resistance:',
    options: [
      'Passes - above minimum',
      'Fails - below 1 megohm',
  ...
  {
    question: 'After a fail result, the appliance should be:',
    options: [
      'Retested immediately',
      'Labelled, withdrawn, and investigated',
      'Discarded without further action',
      'Put back in service with a warning',
    ],
    correctAnswer: 1,
  },
  {
    ...
    options: [
      'Only pass results',
      'All results including fails',
      'Only results over 12 months old',
      'Only results for expensive equipment',
    ],
    correctAnswer: 1,
  },
];
...
const faqs = [
  {
    question: 'Should I record failed test results?',
    answer:
      'Yes, always. Recording failures provides evidence of your testing process, documents that unsafe equipment was identified and withdrawn, and helps identify patterns or problem equipment types.',
  },
  {
    question: 'Can I repair and retest failed equipment?',
    answer:
      'Yes, if the repair is straightforward (like tightening plug terminals) and you are competent to do so. After repair, perform a full retest. For complex repairs, consider whether replacement is more cost-effective.',
  },
  {
    question: 'What if a result is just slightly outside limits?',
    answer:
      'Borderline results warrant investigation. Check test lead resistance, ensure good probe contact, and consider environmental factors. If genuinely borderline, the appliance should be monitored more closely.',
  },
  {
    question: 'How do I handle equipment that fails repeatedly?',
    answer:
      'Repeatedly failing equipment may indicate a design issue, inappropriate use, or end of life. Consider whether the equipment is suitable for its environment and usage, and whether replacement is the better option.',
  },
  {
    question: 'What labels should I apply after testing?',
    answer:
      'Pass labels should include test date, next test due, and tester ID. Failed equipment should be clearly labelled as unsafe and removed from use. Some organisations use colour-coded labels for quick identification.',
  },
  {
    question: 'Who can authorise return to service after a fail?',
    answer:
      'After repair and successful retest, the competent person performing the test can authorise return to service. Document the repair and retest results. For repeated failures, consider management review.',
  },
];
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-8 pb-24">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-lg bg-elec-yellow/10">
              <FileX className="h-6 w-6 text-elec-yellow" />
            </div>
            <span className="text-elec-yellow/80 text-sm font-medium">Module 4 - Section 6</span>
          </div>
        ...
        <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <ul className="text-sm text-white space-y-1">
            <li>- Interpret results by comparing to limits for the appliance class</li>
            <li>- Common failures include loose connections, moisture ingress, and cable damage</li>
            <li>- Document all results and investigate borderline readings</li>
            <li>- Always check appliance class before applying limits</li>
          </ul>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="grid sm:grid-cols-2 gap-2">
            {[
              'Correctly interpret test results against limits',
              'Identify common failure modes and their causes',
              'Take appropriate action on failed equipment',
              'Handle borderline results appropriately',
              'Document and record test outcomes',
              'Recognise patterns indicating equipment problems',
            ].map((outcome, i) => (
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-white flex items-center gap-2">
            ...
            Common Earth Continuity Failures
          </h2>
          <div className="space-y-4 text-white leading-relaxed">
              ...
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="border-b border-white/20">
                    <th className="text-left py-3 px-2 text-white font-semibold">Symptom</th>
                    <th className="text-left py-3 px-2 text-white font-semibold">Likely Cause</th>
                ...
                <tbody className="text-white">
                  <tr className="border-b border-white/10">
                    ...
                    <td className="py-3 px-2">Tighten screws, retest</td>
                  </tr>
                  <tr className="border-b border-white/10">
                    <td className="py-3 px-2">Erratic reading</td>
                    <td className="py-3 px-2">Intermittent connection</td>
                    <td className="py-3 px-2">Check all connections</td>
                  </tr>
                  <tr className="border-b border-white/10">
                    <td className="py-3 px-2">No reading (OL)</td>
                    <td className="py-3 px-2">Open circuit - broken wire</td>
                    <td className="py-3 px-2">Replace cable or repair</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-2">Very high reading</td>
                    <td className="py-3 px-2">Corroded connections</td>
                    <td className="py-3 px-2">Clean or replace terminals</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-white flex items-center gap-2">
            ...
            Common Insulation Resistance Failures
          </h2>
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-5">
              ...
              <ul className="text-white text-sm space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>Record all results, including failures, for complete documentation</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Investigate borderline results rather than just passing them</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Compare current results to previous tests to identify trends</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="h-4 w-4 text-green-400 mt-0.5 flex-shrink-0" />
                  <span>Consider the environment and usage when interpreting results</span>
                </li>
              </ul>
            </div>
            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-5">
              ...
              <ul className="text-white text-sm space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>Passing borderline results without investigation</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                  <span>Not recording failed test results</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                  <span>Returning equipment to service after repair without full retest</span>
                </li>
                <li className="flex items-start gap-2">
                  <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                  <span>Applying wrong limits (Class I vs Class II)</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          <h2 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
            <Zap className="h-5 w-5 text-elec-yellow" /> Quick Reference: Results Interpretation
          </h2>
          <div className="grid sm:grid-cols-2 gap-4 text-sm">
            <div className="bg-black/20 rounded-lg p-4">
              <h4 className="text-green-400 font-semibold mb-2">PASS Actions</h4>
              <ul className="text-white space-y-1">
                <li>- Apply pass label</li>
                <li>- Record result</li>
                <li>- Schedule next test</li>
              </ul>
            </div>
            <div className="bg-black/20 rounded-lg p-4">
              <h4 className="text-red-400 font-semibold mb-2">FAIL Actions</h4>
              <ul className="text-white space-y-1">
                <li>- Apply fail label</li>
                <li>- Withdraw immediately</li>
                <li>- Investigate and repair/replace</li>
              </ul>
            </div>
            <div className="bg-black/20 rounded-lg p-4">
              <h4 className="text-elec-yellow font-semibold mb-2">Common Failures</h4>
              <ul className="text-white space-y-1">
                <li>- Loose plug terminals</li>
                <li>- Moisture contamination</li>
                <li>- Cable damage</li>
              </ul>
            </div>
            <div className="bg-black/20 rounded-lg p-4">
              <h4 className="text-elec-yellow font-semibold mb-2">After Repair</h4>
              <ul className="text-white space-y-1">
                <li>- Full retest required</li>
                <li>- Document the repair</li>
                <li>- Apply new pass label</li>
              </ul>
            </div>
          </div>
        </section>
