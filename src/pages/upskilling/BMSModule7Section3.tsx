...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Proper device mapping ensures sensor values appear correctly on dashboards and in trend logs, and that actuators respond to the right commands from the BMS.',
  },
  {
    id: 'testing-stage',
...
const faqs = [
  {
    ...
    answer:
      'Communication conflicts will occur, and the BMS will either see data from only one device or receive corrupted data. Both devices must be reconfigured with unique addresses.',
  },
  {
    question: 'How do I know which addressing method to use?',
    answer:
      'The addressing method depends on the communication protocol: BACnet uses Device IDs, Modbus uses numeric addresses (1-247), and KNX uses physical addresses in Area.Line.Device format.',
  },
  {
    question: 'Why is device mapping separate from addressing?',
    answer:
      'Addressing identifies the device on the network, while mapping connects the physical I/O points to their software representation. Both are needed for proper BMS operation.',
  },
  {
    question: "What's the difference between physical and logical addresses in KNX?",
    answer:
      'Physical addresses (Area.Line.Device format) identify where the device is physically located on the network. Logical group addresses link devices together for control functions.',
  },
];
...
const BMSModule7Section3 = () => {
  useSEO({
    ...
    description:
      'Learn device configuration and network addressing for BMS communication including BACnet, Modbus, and KNX protocols.',
  });
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Addressing:</strong> Gives each device a unique identity on the network
              </li>
              <li>
                <strong>Mapping:</strong> Links physical I/O signals to BMS software
              </li>
              <li>
                <strong>Protocols:</strong> BACnet, Modbus, and KNX each have unique addressing
                methods
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Device labels with addresses, IO lists, network diagrams
              </li>
              <li>
                <strong>Use:</strong> Assign unique addresses, verify mapping, test communication
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p>
              <strong>Addressing</strong> ensures each device is uniquely recognised on the network.{' '}
              <strong>Mapping</strong> links each input/output (I/O) point to the correct device and
              function in the BMS software. For electricians, this means more than just plugging
              things in: it's about checking addresses, labelling devices, and verifying that
              physical connections match the software configuration.
            </p>
          </div>
        </section>
            ...
            <div className="my-6 space-y-4">
              <div className="p-4 rounded-lg bg-transparent border border-white/10">
                ...
                <p className="text-sm text-white">
                  ...
                  (for BACnet MSTP). Each Device ID must be unique across the entire BACnet network.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-transparent border border-white/10">
                ...
                <p className="text-sm text-white">
                  ...
                  temperature = Register 30001). No two devices on the same RS485 segment can share
                  an address.
                </p>
              </div>
              ...
              <div className="p-4 rounded-lg bg-transparent border border-white/10">
                ...
                <p className="text-sm text-white">
                  Devices use physical addresses in Area.Line.Device format (e.g., 1.1.12). Logical
                  group addresses then link devices for control functions.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Mapping links real-world signals to their representation in the BMS software. A CO2
              sensor wired to Analog Input 3 on a controller must be mapped in software as "Room 101
              CO2 Sensor" — not left as a generic "AI-3."
            </p>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 space-y-3">
              <div className="flex items-start gap-4 p-4 rounded-lg bg-transparent border border-white/10">
                <span className="bg-elec-yellow text-[#1a1a1a] rounded-full w-8 h-8 flex items-center justify-center font-bold text-sm flex-shrink-0">
                  1
                </span>
                <div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Modern BMS installations often require connecting devices using different
              communication protocols. Gateways bridge between protocols, requiring careful
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Duplicate addresses:</strong> Multiple devices respond, causing data
                  corruption
                </li>
                <li>
                  <strong>Address gaps:</strong> Missing devices cause polling delays
                </li>
                <li>
                  <strong>Wrong subnets:</strong> IP devices can't communicate with controllers
                </li>
                <li>
                  <strong>Mapping errors:</strong> Physical points show incorrect data
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Network scanners:</strong> Discover active devices and identify conflicts
                </li>
                <li>
                  <strong>Protocol analysers:</strong> Monitor traffic for communication errors
                </li>
                <li>
                  <strong>Ping tests:</strong> Verify IP device connectivity
                </li>
                <li>
                  <strong>Data validation:</strong> Compare BMS readings with field measurements
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Leaving factory defaults:</strong> Always assign unique addresses during
                  installation
                </li>
                <li>
                  <strong>Missing labels:</strong> Unlabelled devices cause confusion during
                  maintenance
                </li>
                <li>
                  <strong>Skipping communication tests:</strong> Always verify data flows correctly
                </li>
                <li>
                  <strong>Ignoring security:</strong> Change default passwords and avoid predictable
                  addressing patterns
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 rounded-lg bg-transparent border border-white/10">
            <h3 className="text-sm font-medium text-red-400/80 mb-2">
              Commercial Tower Block Project
            </h3>
