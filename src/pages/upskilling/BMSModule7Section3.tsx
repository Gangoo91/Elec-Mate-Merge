            ...
            <div className="my-6">
              ...
              <div className="grid grid-cols-3 gap-3 text-center text-sm">
                <div className="p-3 rounded bg-transparent border border-white/10">
                  ...
                  <p className="text-white text-xs">Main controllers<br/>Device IDs: 100001+</p>
                </div>
                <div className="p-3 rounded bg-transparent border border-white/10">
                  <p className="font-medium text-white mb-1">Modbus RTU</p>
                  <p className="text-white text-xs">Energy meters<br/>Addresses: 1-247</p>
                </div>
                <div className="p-3 rounded bg-transparent border border-white/10">
                  <p className="font-medium text-white mb-1">KNX</p>
                  <p className="text-white text-xs">Lighting control<br/>Area.Line.Device</p>
                </div>
              </div>
            </div>
