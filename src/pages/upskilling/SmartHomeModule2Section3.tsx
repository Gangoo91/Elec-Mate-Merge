...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "Wi-Fi's high power consumption makes it unsuitable for battery-powered devices, which would need frequent battery changes or larger batteries.",
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Thread provides native mesh networking capability, allowing devices to relay messages and extend network range. Traditional Bluetooth LE was point-to-point only (though Bluetooth Mesh now exists).',
  },
  {
    question: 'What is the primary purpose of Matter?',
    options: [
      'Replace all existing protocols',
    ...
    correctIndex: 2,
    explanation:
      'Matter is an application layer standard that enables devices from different manufacturers and ecosystems (Apple, Google, Amazon) to work together seamlessly.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Matter was developed by the Connectivity Standards Alliance with Apple, Google, Amazon, and Samsung as key founding members.',
  },
  {
...
const faqs = [
  {
    ...
    answer:
      'Not immediately. Matter is an application layer that can work alongside existing protocols. Many existing Zigbee devices can be upgraded to support Matter through hub firmware updates. Z-Wave devices require a bridge.',
  },
  {
    question: 'Do I need a Thread Border Router for Matter devices?',
    answer:
      'Only for Thread-based Matter devices. Matter over Wi-Fi or Ethernet does not require a Thread Border Router. Apple HomePod Mini, Google Nest Hub, and Amazon Echo (4th gen) include Thread Border Router functionality.',
  },
  {
    question: 'Is Bluetooth being replaced by Thread?',
    answer:
      'Bluetooth remains essential for device setup and configuration, even with Thread devices. Many Matter devices use Bluetooth for initial pairing before joining the Thread or Wi-Fi network.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-4xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-white text-sm">
              Wi-Fi for bandwidth, Bluetooth for setup and proximity
            </p>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            <p className="text-sm font-medium text-elec-yellow mb-1">Future Standards</p>
            <p className="text-white text-sm">
              Thread for mesh, Matter for universal compatibility
            </p>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Wi-Fi is the most familiar wireless technology, already present in nearly every home.
            Smart devices using Wi-Fi connect directly to the home router without requiring an
            additional hub.
          </p>
          <div className="space-y-3 mb-4">
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                No hub required, high bandwidth for cameras and displays, familiar technology for
                customers, easy remote access.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Limitations</p>
              <p className="text-white text-sm">
                High power consumption, can overload home routers with many devices, no mesh
                capability in standard Wi-Fi devices.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Best Applications</p>
              <p className="text-white text-sm">
                Video doorbells, security cameras, smart displays, streaming devices, smart
                speakers.
              </p>
            </div>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-white text-sm">
              Check router capacity before specifying many Wi-Fi smart devices. Budget routers may
              struggle with 20+ connected devices. Consider recommending a mesh Wi-Fi system for
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Bluetooth Low Energy (BLE) provides short-range, low-power wireless communication. While
            not typically used for whole-home automation, it plays important roles in smart home
            ecosystems.
          </p>
          <div className="space-y-3 mb-4">
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Most smart devices use Bluetooth for initial configuration and pairing with
                smartphone apps before joining Wi-Fi or Thread networks.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Proximity Control</p>
              <p className="text-white text-sm">
                Bluetooth beacons enable presence detection and location-based automation within
                rooms or zones.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                A newer standard enabling mesh networking for lighting and other applications,
                though adoption remains limited compared to Zigbee.
              </p>
            </div>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-white text-sm">
              BLE range is typically 10-30 metres. For devices relying solely on Bluetooth control,
              ensure the customer understands they must be in range of their smartphone.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Thread is a relatively new protocol designed specifically for IoT devices. Built on
            IPv6, it combines the low-power benefits of Zigbee with internet-style addressing and
            routing.
          </p>
          <div className="space-y-3 mb-4">
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Every Thread device has a unique IPv6 address, enabling direct addressing and
                eliminating the need for protocol translation.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Self-Healing Mesh</p>
              <p className="text-white text-sm">
                Like Zigbee and Z-Wave, Thread uses mesh networking with automatic route discovery
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Thread networks can have multiple Border Routers. If one fails, others maintain
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Connects Thread mesh to IP networks (Wi-Fi/Ethernet). Modern smart speakers often
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            Matter is an application layer protocol that sits on top of existing transport
            technologies (Wi-Fi, Thread, Ethernet). Developed by the Connectivity Standards Alliance
            with backing from Apple, Google, Amazon, and Samsung, it aims to solve the smart home
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 mb-4">
            ...
            <p className="text-white text-sm">
              A Matter-certified device will work with Apple HomeKit, Google Home, Amazon Alexa, and
              Samsung SmartThings without needing separate certifications or apps.
            </p>
          </div>
          <div className="space-y-3 mb-4">
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Devices certified for Matter work across all major ecosystems. Customers are no
                longer locked into single-vendor solutions.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Local Control</p>
              <p className="text-white text-sm">
                Matter emphasises local operation. Devices can function even if internet
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                A single device can be controlled by multiple ecosystems simultaneously. For
                example, the same light can be in HomeKit and Google Home.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Device Categories</p>
              <p className="text-white text-sm">
                Initial Matter support covers lighting, switches, sensors, thermostats, door locks,
                and media devices. More categories are being added.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            ...
            <p className="text-white text-sm mb-3">
              A customer building a new home wants a smart home system that will remain compatible
              with future devices and platforms. They use iPhones but may switch to Android in
              future.
            </p>
            <p className="text-white text-sm mb-2">
              <span className="text-elec-yellow">Recommendation:</span>
            </p>
            ...
            <p className="text-white text-sm mt-3">
              <span className="text-elec-yellow">Result:</span> The customer can use any ecosystem
              now and switch freely in future without replacing devices.
            </p>
          </div>
        </section>
