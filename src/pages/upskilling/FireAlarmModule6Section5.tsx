...
const DESCRIPTION =
  'Learn fire alarm system verification, certificates of compliance, third-party approval and BS 5839-1 certification requirements.';
    ...
    () => [
      {
        ...
        correctAnswer: 1,
        explanation:
          'System verification confirms that the installed system meets the original design specification and complies with BS 5839-1 requirements.',
      },
      {
        id: 2,
        ...
        correctAnswer: 2,
        explanation:
          'The Certificate of Compliance must be issued by a competent person representing the company responsible for installation or maintenance.',
      },
      {
        id: 3,
        ...
        correctAnswer: 1,
        explanation:
          'Third-party certification provides independent verification that a company has competent staff, quality management systems, and follows industry standards.',
      },
      {
        id: 4,
        ...
        correctAnswer: 1,
        explanation:
          'The certificate should be accompanied by comprehensive documentation including as-fitted drawings, zone charts, operating instructions, and device schedules.',
      },
      {
        id: 5,
        ...
        correctAnswer: 1,
        explanation:
          'Verification testing should be performed at completion of new installations and following any significant modifications to the system.',
      },
      {
        id: 6,
        question: 'What percentage of devices must be tested during verification?',
        options: ['25% sampling', '50% sampling', '75% sampling', '100% - all devices'],
        correctAnswer: 3,
        explanation:
          'Verification requires 100% testing of all devices to confirm every component functions correctly within the system.',
      },
      {
        id: 7,
        ...
        correctAnswer: 1,
        explanation:
          'BAFE (British Approvals for Fire Equipment) is a UKAS-accredited third-party certification body that certifies fire protection companies.',
      },
      {
        id: 8,
        ...
        correctAnswer: 1,
        explanation:
          'Non-compliance must be documented, deficiencies rectified, and re-testing performed. Certification can only be issued when full compliance is achieved.',
      },
      {
        id: 9,
        ...
        correctAnswer: 1,
        explanation:
          'Insurance companies often require third-party certification, as do many landlords and building control authorities, particularly for larger or higher-risk premises.',
      },
      {
        id: 10,
        ...
        correctAnswer: 1,
        explanation:
          "Records should be retained for minimum 3 years per BS 5839-1, though best practice is to keep them for the system's lifetime for reference and compliance evidence.",
      },
    ],
    []
  );
        ...
        <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <ul className="space-y-2 text-white text-sm">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong className="text-white">Verification</strong> confirms 100% of devices work
                correctly and system meets design spec
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Certificates</strong> are issued by competent persons
            ...
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                <strong className="text-white">Third-party approval</strong> (BAFE) provides
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10 space-y-3">
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <ul className="space-y-1 text-sm text-white">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Verify coverage meets system category requirements
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Validate sound levels meet minimum requirements
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10 space-y-3">
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <ul className="space-y-1 text-sm text-white">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Every manual call point - activation and reset
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Every sounder/beacon - operation and audibility/visibility
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Control panel - all functions and indications
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Power supplies - mains and standby battery
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Ancillary interfaces - door holders, dampers, lifts
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10 space-y-3">
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <ul className="space-y-1 text-sm text-white">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  System category and type (L1/L2/P1/P2 etc.)
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Declaration of compliance with BS 5839-1
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Any departures from standard with justification
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Company details and third-party certification
                </li>
              </ul>
            </div>
            <div className="p-3 rounded-lg bg-amber-500/10 border border-amber-500/20">
              <p className="text-sm text-amber-300 flex items-start gap-2">
                ...
                Never issue a certificate if the system does not fully comply - document variations
                first.
              </p>
            </div>
          </div>
        ...
        <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <div className="p-3 rounded-lg bg-white/5">
            <p className="text-sm text-white">
              ...
              certificate should not be issued until the issue is resolved or formally documented.
            </p>
          </div>
        </div>
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10 space-y-3">
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <ul className="space-y-1 text-sm text-white">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Competent personnel with verified qualifications
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Appropriate insurance and trading history
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10 space-y-3">
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <ul className="space-y-1 text-sm text-white">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Zone chart with device schedules
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10 space-y-3">
            ...
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <ul className="space-y-1 text-sm text-white">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
                  Notify responsible person immediately
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-elec-yellow" />
        ...
        <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          ...
          <div className="p-3 rounded-lg bg-white/5">
            <p className="text-sm text-white">
              ...
              expected for commercial premises. Some building control authorities also require it.
            </p>
          </div>
        </div>
            ...
            {[
              {
                ...
                a: 'Duration depends on system size. Allow approximately 1-2 days for small systems, proportionally longer for large installations. Plan adequately to avoid rushing.',
              },
              {
                q: 'Can the installer verify their own work?',
                a: 'Yes, but ideally verification should involve someone independent of the installation team to provide objectivity. Large organisations often have separate commissioning teams.',
              },
              {
                q: 'What if modifications are made after certification?',
                a: 'Significant modifications require re-verification of affected areas and potentially a new or amended certificate. Minor modifications should be documented in the logbook.',
              },
              {
                q: 'Is there a standard certificate format?',
                a: 'BS 5839-1 provides model certificates in the annexes. Third-party certified companies use approved formats. The content must meet standard requirements regardless of format.',
              },
              {
                q: 'Who keeps the original certificate?',
                a: 'The original certificate should be kept with the system logbook at the premises. Copies should be retained by the installing/maintaining company and may be required by insurers.',
              },
              {
                q: 'Can certification be withdrawn?',
                a: 'Third-party certification can be withdrawn if audits reveal non-compliance. This is serious and should be avoided through maintaining quality standards.',
              },
            ].map((faq, i) => (
