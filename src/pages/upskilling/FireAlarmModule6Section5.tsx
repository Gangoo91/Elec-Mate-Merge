    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The certification chain runs from acceptance (Annex G) through every modification (Section
          7, NEW 2025) and every periodic service. BS 5839-1:2025 renames the modification
          certificate to extension or modification certificate, formally classes firmware updates as
          modifications, and tightens the variation rules in clause 6 — some variations are now
          declared unacceptable. Third-party schemes (BAFE SP203, FIA, NSI, SSAIB) are the practical
          assurance route for AHJs and insurers.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              commissioned in accordance with BS 5839-1:2025 (or the applicable edition at the date
              of work).
            </li>
            <li>
          ...
          <p>
            ...
            acceptance. The acceptance date is the datum for the servicing cycle and does not move.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              (devices, cabling, design choices) that do not all conform to current standards — this
              is explicitly accommodated by the 2025 wording.
            </li>
            <li>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              certification chain — acceptance → extensions / modifications → periodic inspections.
            </li>
            <li>
              <strong>Description of the work.</strong> What was added or changed, where, and why.
            </li>
            <li>
              <strong>Compliance statement for the new works.</strong> The new works comply with the
              current standard at the date of the work. (For extensions to legacy systems, the
          ...
          <p>
            The renaming of "modification certificate" to "extension or modification certificate" is
            the visible 2025 change; the substantive change is the explicit accommodation of
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Absence of a zone plan</strong> (or other suitable diagrammatic representation
              as recommended in clause 22.2.5) in premises in which there is more than one zone on
              any storey, particularly premises in which people sleep. The zone plan is the
              responder\'s tool for locating the source of the alarm; in multi-zone sleeping
              premises its absence is now treated as fundamentally inconsistent with safe operation.
            </li>
            <li>
              <strong>
                Absence of a facility for transmission of fire alarm signals to an ARC
              </strong>{' '}
              in either supported housing in which the facility is considered necessary to meet the
              recommendations of BS 5839-1 (where a Grade A system according to BS 5839-6:2019 is
              necessary), or in a residential care home. In these premises types, the ARC
              transmission is the link to FRS dispatch and is essential for occupant rescue; absence
              is now declared unacceptable.
            </li>
          </ul>
          <p>
            ...
            5839-1:2025. The next service visit should re-evaluate the historical variation against
            the new wording and recommend remediation. The responsible person\'s insurer is likely
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              variations. These are: the absence of a zone plan … in premises in which there is more
              than one zone on any storey, particularly premises in which people sleep; or the
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              qualifications (the FIA units cover design, installation, commissioning, maintenance),
              training programmes, and member-organisation quality standards. FIA member
              organisations operate to declared standards; individual engineers often hold FIA unit
              certificates as evidence of training and knowledge.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Test outcomes.</strong> Functional tests performed (devices tested, outcomes),
              battery service results, ARC transmission test results, any panel event log review
              findings.
            </li>
            <li>
            ...
            <li>
              <strong>Defects and recommendations.</strong> Open defects, recommended remedial works
              (with quoted urgency), pending decisions from the responsible person.
            </li>
            <li>
          ...
          <p>
            ...
            acceptance through every modification and every periodic visit until the system reaches
            end of life or replacement. The full chain is the audit trail.
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-6/section-6')}
