    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS 7671 Annex A444 Tables A444.1 and A444.2 — the 200 / 150 / 0 mm separation hierarchy by
          containment type, layered with the voltage / current scaling. §444.6.1 referencing §528,
          §528.2 same-band segregation, §444.6.2 130 mm from HID / CFL. Plus the 4× / 8× cable OD
          bend-radius rule that determines lifelong Cat6A performance.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              ...
              basket (e.g. 50 mm × 100 mm grid) qualifies as type A — open metallic containment with
              screening performance equivalent to Note 1's reference (DC to 100 MHz). Default
            ...
            <li>
              ...
              other than the containment itself is required (Note 4). This is the "use trunking and
              the trunking is the separation" rule.
            </li>
          </ul>
          <p>
            The rule is read symmetrically — it considers both the data side and the power side. If
            the data is on basket (type A) and the power is in solid steel trunking (type C), the
            more screened side dominates and separation drops to 0 mm. If both sides are on basket,
            you are at the 200 mm baseline. Mixed containment is normal; read the better-screened
            side as the binding factor.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              voltage Band I (extra-low voltage) which share the same cable management system or the
              same route, shall be installed according to the requirements of Regulations [528.1,
              528.2, 528.3].
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              discharge, neon and mercury vapour (or other high-intensity discharge) lamps shall be
              130 mm. In this regard, low energy lamps (CFL) are to be considered as gas discharge
              sources. Data wiring racks and electrical equipment shall always be separated.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            <li>
              <strong>4× cable outer diameter — during installation.</strong> The looser of the two
              rules. Applies during the pull, including any temporary deflection around obstacles.
              For a 7.5 mm OD Cat6A, that is 30 mm minimum bend radius. BS EN 50174-2 / TIA-568.0-E
              install-practice rule.
            </li>
            <li>
              <strong>
              ...
              inside patch panels, at consolidation points, and at any other final-state bend. For a
              7.5 mm OD Cat6A, 60 mm minimum bend radius.
            </li>
            <li>
              <strong>Stranded cord cable.</strong> Patch / equipment / work-area cords have
              separate, looser bend-radius rules — typically built into the cord assembly itself by
              the manufacturer. Cords are designed for flex; solid horizontal cable is not.
            </li>
          </ul>
          <p>
            The deeper reason is the physics of balanced twisted pair. The four pairs are twisted at
            different rates so adjacent pairs reject each other's electromagnetic fields by phase
            cancellation — that is what gives Cat6A its NEXT performance. Deform the twist lay and
            the cancellation breaks down. The break-down is local to the bend, but the channel sees
            its insertion-loss penalty over the full link length. Cat6A and Cat8 are more sensitive
            to this than Cat5e because their performance margin is tighter.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="60" y="440" fill="#E5E7EB" fontSize="10.5" fontFamily="system-ui">
              Pair-twist geometry deforms when bent too tight. Damage is CUMULATIVE and PERSISTENT.
            </text>
            <text x="60" y="458" fill="#9CA3AF" fontSize="10" fontFamily="system-ui">
              Insertion loss rises, return loss degrades, NEXT increases — and stays degraded. Test
              to TIA-1152-A / BS EN 50346.
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            ...
            <li>
              <strong>§528.3.2 — below condensation services.</strong> Where wiring is routed below
              services liable to cause condensation (water, steam, gas), precautions shall be taken
              to protect the wiring system from deleterious effects.
            </li>
            <li>
              <strong>§528.3.3 — proximity to non-electrical services.</strong> Where an electrical
              service is in proximity to non-electrical services, it shall be arranged so
              foreseeable operation on the other services will not damage the electrical service or
              vice versa.
            </li>
            <li>
              <strong>§528.3.4 — close proximity.</strong> Both: the wiring system shall be suitably
              protected against hazards arising from the other services in normal use; AND fault
              protection per Section 411.
            </li>
            <li>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              Three options, in order of preference: (1) install a steel divider (partition) inside
              the basket to create two compartments — the divider screens the two cable bundles,
              qualifying the data side as effectively type B (perforated metallic containment) and
              dropping the separation requirement; (2) install solid steel trunking around the power
              circuit for the shared 3 m, converting the power side to type C and removing the
              physical separation requirement entirely (Note 4); (3) physically separate the two by
              200 mm in free air for the shared stretch with no shared basket. Option (1) is usually
              cheapest and cleanest. Whichever option, also check Table A444.2 — at 240 V, the
              voltage scaling is 0.45 m in free air, so the containment-based options dominate.
            </>
          }
          whyItMatters={
            <>
