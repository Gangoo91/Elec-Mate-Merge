...
const inlineChecks = [
  ...
  },
  {
    ...
    question: 'What MCS Installer Standards cover the M9 technologies?',
    options: [
  ...
  {
    id: 'm9s1-erec-g99',
    question: 'Why does most M9 generating-set technology trigger EREC G99 rather than G98?',
    options: [
  ...
  },
  {
    ...
    question: 'What is "anti-islanding" + why does Reg 551.7.5 apply to all M9 generating sets?',
    options: [
...
const quizQuestions = [
  ...
  {
    question: 'CHP — Combined Heat and Power — what is unique vs the other M9 technologies?',
    options: [
  ...
  {
    question: 'Hydrogen for heating — what is the UK 2025-26 installer position?',
    options: [
...
export default function RenewableEnergyModule9Section1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 9 · Section 1 · BS 7671:2018+A4:2026 · Section 551 + Reg 551.1.1"
        title="The other-LCT landscape + Section 551 framework"
        backTo="../renewable-energy-module-9"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The technologies beyond solar PV / BESS / EV / heat pumps — wind, solar thermal, biomass,
          CHP, micro-hydro, hydrogen. BS 7671 Section 551 as the unifying framework for generating
          sets. Reg 551.1.1 power-source taxonomy, Reg 551.7 parallel operation requirements, Reg
        ...
        <Pullquote>
          Section 551 doesn\'t care what fuel the generator runs on or what physical principle
          drives the turbine — it treats every customer-side electricity source by the same safety
          rules. That\'s the unifying anchor.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">(a) Combustion engines</strong> — CHP (gas, biogas,
              biofuel, hydrogen blend); biomass with engine-driven generator; emergency diesel
              generators (back-up). M9 §9.5 (micro-CHP) + §9.6 (commercial CHP)
            </li>
            <li>
              <strong className="text-white">(b) Turbines</strong> — wind (HAWT / VAWT — M9 §9.2);
              micro-hydro (Pelton / Francis / Crossflow / Archimedes — M9 §9.7); gas turbine CHP at
              larger commercial scale
            </li>
            <li>
              <strong className="text-white">(c) Electric motors</strong>— rare; pumped storage at
              utility scale. Not typically encountered in domestic / light-commercial M9 install
              scope
            </li>
            <li>
              <strong className="text-white">(d) Photovoltaic cells</strong> — covered in M2-M4.
              Listed here for completeness; Section 551 applies uniformly
            </li>
            <li>
              <strong className="text-white">(e) Batteries</strong>— covered in M5. Reg 551.7.2.1
              explicitly classifies BESS as a generating set (not a load) — placed on the supply
              side of protective devices
            </li>
            <li>
              <strong className="text-white">(f) Other suitable sources</strong> — fuel cells
              (emerging LCT — M9 §9.7); hydrogen-fed generators; future technologies. Section 551
              framework future-proofs for these via this open category
            </li>
            <li>
              <strong className="text-white">Solar thermal exception</strong> — NOT in Reg 551.1.1
              because it doesn\'t generate electricity. But it has real electrical install scope
              (controllers + circulation pumps + sensors) — M9 §9.3 covers this
            </li>
            <li>
              <strong className="text-white">Biomass exception</strong>— heat-only biomass (most
              domestic UK 2025-26 biomass) is NOT in Reg 551.1.1; biomass with engine-driven CHP IS
              (under (a) combustion engines). M9 §9.4 covers both heat-only + CHP-biomass interfaces
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">M2-M4 (Solar PV)</strong>— Section 712 + PV-specific
              framework. Section 551 applies as the generating-set anchor
            </li>
            <li>
              <strong className="text-white">M5 (BESS)</strong>— Chapter 57 + Section 826 PEI. Reg
              551.7.2.1 treats BESS as generating set
            </li>
            <li>
              <strong className="text-white">M6-M7 (EV)</strong> — Section 722 EV-specific. EV is
              LOAD (not generating set) in this course\'s framing; bidirectional V2G covered in M10
            </li>
            <li>
              <strong className="text-white">M8 (heat pumps)</strong>— fixed equipment + Part 4-7
              general regs. Not a generating set — pure load
            </li>
            <li>
              <strong className="text-white">M9 (this module — other LCT)</strong> — wind, solar
              thermal, biomass, CHP, micro-hydro, hydrogen / emerging LCT. Most are Section 551
              generating sets; solar thermal is the heat-only exception
            </li>
            <li>
              <strong className="text-white">M10 (hybrid + EMS + smart export)</strong> —
              multi-source integration. SEG, EREC G100 export limit, V2G, grid forming. Builds on
              Section 551 + Chapter 82
            </li>
            <li>
              <strong className="text-white">M11 (Chapter 81 + lightning + fault levels)</strong> —
              A4:2026 Chapter 81 energy efficiency + BS EN 62305 lightning protection for PV / wind.
              Fault contribution from multi-source sites
            </li>
            <li>
              <strong className="text-white">M12 (testing + commissioning + handover)</strong> —
              Part 6 on LCT, IV / IR on DC, BESS health, PEN faults, MCS handover packs. Closing
              module
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          One technology, one safety framework. Solar thermal aside, every M9 generating set obeys
          Reg 551.7 + Reg 551.7.5 — anti-islanding is non-negotiable.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 551.7.1</strong> — bidirectional energy flow
              protective device + prohibition of source connection on load side of an RCD under
              certain conditions
            </li>
            <li>
              <strong className="text-white">Reg 551.7.2.1</strong> — generating set on supply side
              of all protective devices; BESS explicitly treated as generating set (not load)
            </li>
            <li>
              <strong className="text-white">Reg 551.7.4</strong> — means of automatic switching to
              disconnect the generating set on loss of supply or deviation of voltage / frequency at
              the supply terminals; above 16 A output the protection type, sensitivity and operating
              times must be agreed with the distributor
            </li>
            <li>
              <strong className="text-white">Reg 551.7.5</strong> — anti-islanding requirement
              verbatim: "Means shall be provided to prevent the connection of a generating set to
              the system for distribution of electricity to the public in the event of loss of that
              supply or deviation of the voltage or frequency at the supply terminals from values
              required by Regulation 551.7.4."
            </li>
            <li>
              <strong className="text-white">Anti-islanding device</strong> — typically integrated
              into inverter / generator controller. Loss-of-mains (LoM) detection — ROCOF (rate of
              change of frequency) with voltage / frequency protection, or active anti-islanding
              methods. G99 disallows Vector Shift for type-tested generation, so RoCoF is the
              standard required method for the type-tested inverters in virtually all LCT installs;
              VS is legacy / non-type-tested sites only
            </li>
            <li>
              <strong className="text-white">Commissioning verification</strong> — at install,
              anti-islanding tested via DNO-witnessed simulated grid-loss OR via manufacturer
              self-test feature with documented procedure
            </li>
            <li>
              <strong className="text-white">EREC G98 / G99 framework</strong> — DNO notification
              for generation. G98 fast-track ≤16 A per phase; G99 formal for larger / multi-source.
              Most M9 technologies trigger G99 due to sustained export
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — anti-islanding device
              type + manufacturer DoC + commissioning test result + DNO correspondence
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Per-source RCD</strong> — each generator has its own
              RCD on its supply connection. Typical 30 mA Type A or Type B per Reg 415.1 + Reg
              531.3.3 (RCD type depends on generator electronics — VSD wind / hydro / CHP may need
              Type B per manufacturer DoC)
            </li>
            <li>
              <strong className="text-white">Central coordination</strong> — main RCD architecture
              (Type S 100 mA upstream + 30 mA RCBOs per circuit) coordinates with the per-source
              RCDs. Reg 531.3.6 discrimination
            </li>
            <li>
              <strong className="text-white">Reg 551.7.1(d) prohibition</strong> — source must NOT
              be connected on load side of an RCD under certain conditions (the RCD would not see
              the source\'s fault contribution correctly)
            </li>
            <li>
              <strong className="text-white">Verification</strong>— at commissioning, induce a fault
              under each combination of sources operating; verify the appropriate RCD trips. Reg 643
              testing per circuit + Reg 551.4.2 multi-source verification
            </li>
            <li>
              <strong className="text-white">Type B for VSD sources</strong> — wind / hydro /
              VSD-driven CHP can produce smooth DC fault currents (per the §8.5 analysis for heat
              pump VSD compressors). Type B RCD where manufacturer DoC declares smooth-DC leakage
              exceeds Type A capability
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — RCD architecture
              diagram per multi-source site + per-combination commissioning test results +
              manufacturer DoC per source
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">MIS 3001 — Solar Thermal</strong> — solar collectors +
              DHW integration. Hydraulic + control specialist scope. M9 §9.3
            </li>
            <li>
              <strong className="text-white">MIS 3003 — Small Wind</strong> — wind turbines ≤50 kW.
              Mast + turbine + electrical + planning. M9 §9.2
            </li>
            <li>
              <strong className="text-white">MIS 3004 — Biomass</strong> — wood pellet + log biomass
              boilers. Combustion + flue + control specialist scope. M9 §9.4
            </li>
            <li>
              <strong className="text-white">MIS 3005 — Heat Pumps</strong> — covered in M8. ASHP /
              GSHP / exhaust-air
            </li>
            <li>
              <strong className="text-white">MIS 3007 — micro-CHP</strong> — micro-CHP ≤50 kW.
              Combined heat + electrical generation. M9 §9.5
            </li>
            <li>
              <strong className="text-white">MIS 3008 — Micro-hydro</strong> — micro-hydro ≤50 kW.
              Turbine + civils + grid connection. M9 §9.7
            </li>
            <li>
              <strong className="text-white">Grant funding</strong>— UK 2025-26 Boiler Upgrade
              Scheme covers heat pumps (M8) primarily; limited / no current grants for solar
              thermal, biomass, wind, hydro, CHP for domestic. Verify current scheme rates per
              technology at quote stage
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — MCS handover pack per
              technology integrates: MCS sizing + product details + commissioning report + BS 7671
              EIC + customer handover documentation
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Wind</strong> — MCS company + turbine specialist + mast
              erector + electrical installer + planning consultant
            </li>
            <li>
              <strong className="text-white">Solar thermal</strong> — MCS company + heating engineer
              + plumber + electrical installer (controls + pumps scope)
            </li>
            <li>
              <strong className="text-white">Biomass</strong> — MCS company + biomass installer +
              flue specialist (chimney sweep / HETAS if domestic) + electrical installer
            </li>
            <li>
              <strong className="text-white">CHP</strong> — MCS company + CHP specialist + heating
              engineer (heat-network interface) + electrical installer + gas / fuel specialist
            </li>
            <li>
              <strong className="text-white">Micro-hydro</strong> — MCS company + civils contractor
              (intake + pipework + tailrace) + turbine specialist + electrical installer +
              Environment Agency consultant (abstraction licence)
            </li>
            <li>
              <strong className="text-white">Hydrogen / fuel cell</strong> — emerging. Typically R&D
              + specialist trials. Mainstream trade delivery model not yet established
            </li>
            <li>
              <strong className="text-white">Electrical installer scope</strong> — dedicated supply
              circuit + AC isolator + RCD architecture (Reg 551.4.2 + Reg 415.1) + controls wiring +
              Reg 551.7.5 anti-islanding verification + Reg 643 testing + EIC
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — BS 7671 EIC delivered
              to MCS company for inclusion in the MCS handover pack
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-9-section-2')}
