  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/electrician/upskilling/data-cabling-module-2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The install-practice layer that protects Class certification — BS EN 50174-2 bend radii
          (4× OD install / 8× OD service), pulling tensions (~110 N for 4-pair UTP), supports per BS
          7671 §521.10.202 (steel clips / saddles / cable basket), Band I / II separation per Annex
          A444, sensible cable management, and the BS EN 50174-1 / TIA-606-D labelling and as-built
          discipline.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Installation (4× OD).</strong> During the pull, the cable is in active tension
              and the bend is transient — the cable will straighten out as it&apos;s pulled through.
              A tighter bend at this stage is tolerated provided the bend doesn&apos;t become
              permanent. Pulling tension and bend together stress the conductors, but only briefly.
            </li>
            <li>
              <strong>Service (8× OD).</strong> Long-term static bends are different. The cable sits
              in the bend for years; the conductors creep into the deformed geometry permanently;
              the dielectric flows under sustained stress; the pair geometry changes for the
              cable&apos;s life. The 8× number is what the cable can tolerate indefinitely without
              electrical degradation.
            </li>
            <li>
              <strong>Pinch points.</strong> The most common bend-radius failures: at the entry to a
              patch panel (cable falls off basket, gets pulled into rear of panel sharply — use a
              horizontal cable manager); at a 90° corner in trunking (route in slow curves, never
              sharp angle); at any place where a cable rests against a rigid edge (use an edge
              protector or radius bead).
            </li>
            <li>
              <strong>Larger / heavier cables.</strong> Cat7 / Cat7A with overall braid have larger
              minimum radii than Cat6A. Cat8.x at 30 m channels is rarely a bend-radius problem
              because it&apos;s short and well-managed. Always read the manufacturer datasheet — the
              4× / 8× figures are typical, not universal.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              copper elongates plastically, twist geometry deforms, dielectric can crack. Damage is
              permanent.
            </li>
            <li>
              <strong>What raises the pull tension above 110 N.</strong> Friction at corners,
              binding round 90° bends, gravity on vertical drops, free-spinning reel that fights the
              pull, sticky surfaces on tray, lack of lubrication. Combine two of these and
            ...
            <li>
              <strong>Pull from the box.</strong> Cable boxes are designed to feed from the centre.
              The cable spirals up out of the box smoothly, no resistance, no tangling. A free reel
              needs to be unspooled actively as you pull and adds friction.
            </li>
            <li>
            ...
            <li>
              <strong>Slow curves not sharp angles.</strong> Route the cable through slow curves at
              every direction change. Never pull a cable directly into a 90° corner — the cable
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Steel cable basket / tray (NOTE 2).</strong> Cables resting in steel basket or
              tray are deemed to meet the requirement automatically — the basket supports the
              cables; the basket itself is metal and survives fire long enough that cables remain in
              place. The 2026 commercial default for high-density horizontal runs.
            </li>
            <li>
              ...
              rule) is a separate clause about non-sheathed cables; §521.10.202 is the fire-collapse
              rule.
            </li>
            <li>
              <strong>Steel clips / saddles direct to surface (NOTE 4).</strong> Cables clipped
              direct to walls or soffits with steel clips / saddles at sensible intervals (typically
              250-300 mm) meet the requirement.
            </li>
            <li>
            ...
            <li>
              <strong>What does NOT meet the requirement.</strong> Plastic single-use cable ties as
              the sole support of cables clipped direct or suspended under tray (NOTE 3 explicitly
              precludes). Non-metallic cable trunking as the sole means of support of the cables
              therein (NOTE 3). Bare cables resting on plasterboard ceiling tiles, on suspended
              ceiling grid (no support if grid melts), on low-melt plastic conduit.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              installed in or on steel cable containment systems are deemed to meet the requirements
              of this regulation. NOTE 3: This regulation precludes, for example, the use of
              non-metallic cable clips or cable ties as the sole means of support where cables are
              clipped direct to exposed surfaces or suspended under cable tray, and the use of
              non-metallic cable trunking as the sole means of support of the cables therein. NOTE
              4: Suitably spaced steel or copper clips, saddles or ties are examples that will meet
              the requirements of this regulation. NOTE 5: The intent of this regulation is to
              prevent the general collapse of wiring systems as a result of exposure to the effects
              of fire such that they would hinder the safe evacuation, rescue or access to
              firefighters. It is not the intent of this regulation to provide support to maintain
              circuit integrity for life safety and/or firefighting applications under fire
              conditions. These requirements are addressed in Chapter 56 and in Codes of Practice BS
              5266, BS 5839 and BS 8519.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Annex A444 Table A444.1 (containment).</strong> Open / no metallic containment
              A: 200 mm in free air. Perforated open metallic containment B (NOTE 2: equivalent to
              steel tray ≤ 20 % perforation, 1.0 mm wall): 150 mm. Solid metallic containment C
              (NOTE 3: fully-enclosed steel, ≥ 1.5 mm wall): NOTE 4 — no physical separation other
              than that provided by the containment.
            </li>
            <li>
              <strong>Annex A444 Table A444.2 (voltage / current).</strong> 115 V → 0.25 m; 240 V →
              0.45 m; 415 V → 0.58 m; 3.3 kV → 1 m; 6.6 kV → 1.25 m; 11 kV → 1.4 m. 5 A → 0.24 m; 15
              A → 0.35 m; 50 A → 0.5 m; 100 A → 0.6 m; 300 A → 0.85 m; 600 A → 1.05 m.
            </li>
            <li>
              <strong>§444.6.2 (HID lamps).</strong> 130 mm minimum between ICT cables and discharge
              / neon / mercury vapour / other HID lamps (CFL is an HID source). "Data wiring racks
              and electrical equipment shall always be separated."
            </li>
            <li>
              <strong>§444.5.3.1 (bonding).</strong> Containment bonded to the equipotential bonding
              network. Without bonding, the containment isn&apos;t a screen and the Annex A444
            ...
            <li>
              ...
              the calculated separation, redesign — relocate the route, change the containment type,
              or screen the cable per M2S2.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              a tensioner. Trim flush. Tail finger-tight only — the tie should rotate freely round
              the bundle.
            </li>
            <li>
            ...
            <li>
              ...
              what holds the pairs in twisted geometry up to the IDC; pulling the jacket out of the
              connector destroys the strain relief and stresses the IDC contacts.
            </li>
            <li>
              <strong>Bundle size for sustained PoE.</strong> &lt;= 24 cables per bundle for Type 4
              PoE++ continuous load; physical separation between bundles for airflow; 23 AWG /
            ...
            <li>
              ...
              heat. Keep PoE bundles together (so the de-rating model applies cleanly) and separate
              from low-load bundles (so non-PoE channels keep their margin).
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The design current in any conductor shall not exceed the limit specified in BS EN
              50173-1. NOTE 1: Any temperature rise of the data cables due to the load current they
              carry, or other causes, will increase the attenuation/insertion loss of the cables.
              Thus the performance of information transmission channels can be degraded. NOTE 2:
              Guidance on the effect of the number of loaded conductors, in a multi-cable bundle, on
              the temperature rise of the cables is given in PD CLC/TR 50174-99-1:2015 and
              requirements and recommendations in relation to planning and installation of such
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Link identifiers.</strong> A unique label per link, applied at every end point
              (outlet, patch panel) and at every consolidation point. BS EN 50174-1 / TIA-606-D give
              the format conventions; the discipline is one ID per link, no duplicates, printed (not
              handwritten), durable label stock.
            </li>
            <li>
              <strong>As-built drawings.</strong> Cable route, link IDs along the route, patch panel
              layouts, outlet locations, any non-standard design decisions (CPs, separation calcs,
              screen-bonding chains). Update at handover; retain for the warranty period.
            </li>
            <li>
            ...
            <li>
              ...
              screen-continuity test results per link, plus the documented bonding chain (cable foil
              → screened keystone → screened panel → rack bonding bar → TBB → MET / MFET) per BS
              7671 §444.5.3.1 / §545 / BS EN 50310.
            </li>
          </ul>
          <p>
            Without these four artefacts, the next contractor cannot find a circuit, a fault cannot
            be isolated to the right link, and re-cabling becomes the cheapest fix — destroying the
            whole long-life value proposition of structured cabling.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-2 text-[14px]">
            ...
            <li>
              ...
              producing heat / smoke / fumes. §528.3.5: no cable in lift wells unless it&apos;s lift
              cabling.
            </li>
            <li>
            ...
            <li>
              ...
              <AmendmentBadge
                ...
                edition="A4:2026"
              />{' '}
              Cable Category list (M2S1), 750 mA per conductor hard cap (M2S3), connector rating 750
              mA per contact (M2S4), bundle thermal references in NOTE 2.
            </li>
            <li>
        ...
        <CommonMistake
          ...
          whatHappens={
            <>
              ...
              fire-rated structural bar with plastic single-use ties at 100 mm intervals. Looks neat
              in the photo. Three faults emerge over time. (1) Class EA channel certification is
              marginal at the top test frequency — the tight ties have locally crushed the cables
              and PSANEXT margin has eroded. (2) Under sustained Type 4 PoE++ load, the centre of
              the bundle runs hot — temperature rise of 15-25 °C above ambient — and channel margin
              shrinks further (§716.523.1.101 NOTE 1). (3) §521.10.202 NOTE 3 is breached: the
              plastic ties are the SOLE means of support, and in a fire they would melt and the
              cables would fall across the egress route.
            </>
          }
          doInstead={
            <>
              Specify the bundle layout in advance: subdivide 96 cables into 4 × 24 sub-bundles with
              airflow gaps between them; use hook-and-loop straps OR plastic ties applied hand-tight
              (rotating freely round the bundle); add periodic STEEL ties at intervals so the cables
              are supported by steel even if every plastic component melts (§521.10.202 NOTE 4).
              Better still — run the bundle in bonded steel cable basket / tray (§521.10.202 NOTE 2
              deems compliant). Specify 23 AWG / LP-rated Cat6A; verify bundle thermal model against
              PD CLC/TR 50174-99-1; channel-certify with comfortable margin at the top test
              frequency.
            </>
          }
        />
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              ordinary classrooms; Cat6A F/UTP under the AP bundles where sustained PoE thermal load
              + alien crosstalk concerns warrant screening. Outlets. Shuttered keystones throughout
              — children, dust, longevity. Termination. T568B at every connector; ≤ 13 mm
              untwisted-pair length at the IDC. Bundles. Sub-bundles ≤ 24 cables, hook-and-loop
          ...
          whyItMatters={
            <>
              ...
              conditions. The install-practice rules — §521.10.202 supports, Annex A444 separation,
              §716.523.x PoE thermal, §444.5.3.1 bonding, BS EN 50174-1 labelling — are not separate
              concerns; they overlap on every route. The contractor who runs the calcs, picks bonded
              steel cable basket as the default containment, specifies shuttered keystones for
              children, and hands over a labelled / certified / documented system has delivered a
              15-year asset. The one who zip-ties cables to a roof rafter has delivered a problem.
            </>
          }
        />
