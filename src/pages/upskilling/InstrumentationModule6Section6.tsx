...
const InstrumentationModule6Section6 = () => {
  useSEO({
    ...
    description:
      'Master advanced calibration techniques, measurement uncertainty calculations, troubleshooting methods, and future trends in calibration technology.',
    keywords: [
    ...
    <div className="bg-background text-foreground">
      ...
      <div className="px-4 py-6 max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white">Module 6 · Section 6 · 20 min read</p>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <p className="text-white leading-relaxed">
              Every measurement has uncertainty - a range within which the true value is expected to
              lie. Understanding and calculating measurement uncertainty is essential for
              professional calibration work and regulatory compliance.
            </p>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <p className="text-white text-sm">
                The combined uncertainty (uc) is calculated by taking the square root of the sum of
                the squares of all individual uncertainty components (root sum of squares method).
                For reporting, this is typically multiplied by a coverage factor (k=2 for 95%
                confidence) to give expanded uncertainty (U).
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="space-y-6">
            <p className="text-white leading-relaxed">
              Beyond basic calibration, advanced techniques address complex measurement challenges
              and optimise calibration efficiency. These methods are essential for sophisticated
              applications and cost-effective calibration programmes.
            </p>
            ...
            <div className="bg-card/50 rounded-lg p-4 border border-border">
              ...
              <p className="text-white text-sm mb-3">
                Comprehensive calibration across the full measurement range with multiple reference
                points.
              </p>
              <ul className="space-y-2 text-white text-sm">
                <li className="flex items-start gap-2">
            ...
            <div className="bg-card/50 rounded-lg p-4 border border-border">
              ...
              <ul className="space-y-2 text-white text-sm">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400">•</span>
                  <strong>Installation Effects:</strong> Includes mounting, wiring, interference
                  factors
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400">•</span>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <p className="text-white leading-relaxed">
              Calibration problems can be frustrating and time-consuming. Understanding common
              issues and their solutions helps resolve problems efficiently and prevent recurrence.
            </p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="bg-card/50 rounded-lg p-4 border border-border">
                ...
                <p className="text-white text-xs italic mb-2">
                  Inconsistent readings during calibration
                </p>
                <ul className="space-y-1 text-white text-sm">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-red-400">•</span>
                    <strong>Solutions:</strong> Allow stabilisation time, add shielding, control
                    environment
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-card/50 rounded-lg p-4 border border-border">
                ...
                <p className="text-white text-xs italic mb-2">
                  Different readings ascending vs descending
                </p>
                <ul className="space-y-1 text-white text-sm">
                  <li className="flex items-start gap-2">
              ...
              <div className="bg-card/50 rounded-lg p-4 border border-border">
                ...
                <p className="text-white text-xs italic mb-2">
                  Non-proportional response across range
                </p>
                <ul className="space-y-1 text-white text-sm">
                  <li className="flex items-start gap-2">
              ...
              <div className="bg-card/50 rounded-lg p-4 border border-border">
                ...
                <p className="text-white text-xs italic mb-2">
                  Baseline measurement changes over time
                </p>
                <ul className="space-y-1 text-white text-sm">
                  <li className="flex items-start gap-2">
                    <span className="text-blue-400">•</span>
              ...
              <div className="bg-card/50 rounded-lg p-4 border border-border">
                ...
                <p className="text-white text-xs italic mb-2">
                  Readings affected by ambient conditions
                </p>
                <ul className="space-y-1 text-white text-sm">
                  <li className="flex items-start gap-2">
                    <span className="text-green-400">•</span>
              ...
              <div className="bg-card/50 rounded-lg p-4 border border-border">
                ...
                <p className="text-white text-xs italic mb-2">
                  Calibration equipment affects measurement
                </p>
                <ul className="space-y-1 text-white text-sm">
                  <li className="flex items-start gap-2">
                    <span className="text-purple-400">•</span>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="space-y-6">
            <p className="text-white leading-relaxed">
              Following best practices ensures consistent, reliable calibration results. These
              practices apply whether you perform calibration in-house or manage external
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <p className="text-white leading-relaxed">
              Calibration technology is evolving rapidly. Understanding emerging trends helps you
              prepare for future developments and make informed decisions about calibration
              investments.
            </p>
        ...
        <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-500/30 rounded-lg p-4 mb-10 mt-10">
          ...
          <p className="text-white text-sm leading-relaxed mb-3">
            A pharmaceutical manufacturing facility with 500+ critical instruments needed to comply
            with FDA validation requirements whilst optimising costs and minimising production
            disruptions.
          </p>
          <div className="bg-card/50 rounded-lg p-3 border border-border mb-3">
            <h4 className="font-medium text-elec-yellow text-sm mb-2">
          ...
          <p className="text-green-400 text-sm italic">
            Result: 40% reduction in calibration costs, 95% reduction in production downtime, and
          ...
          <div className="space-y-4">
            <div className="bg-card/50 rounded-lg p-4 border border-border">
              <h3 className="font-semibold text-white mb-2">
                How do I create an uncertainty budget?
              </h3>
              <p className="text-white text-sm">
                Start by identifying all sources of uncertainty in your measurement. For each
                source, determine whether it is Type A (statistically evaluated) or Type B (from
                other sources). Convert each uncertainty to a standard uncertainty (usually by
                dividing by appropriate factors), then combine using root sum of squares. Multiply
                by coverage factor (typically k=2) for expanded uncertainty.
              </p>
            </div>

            <div className="bg-card/50 rounded-lg p-4 border border-border">
              <h3 className="font-semibold text-white mb-2">
                When should I use in-situ versus laboratory calibration?
              </h3>
              <p className="text-white text-sm">
                Use in-situ calibration when: removal is impractical, installation effects are
                significant, downtime is critical, or you need to verify performance under actual
                operating conditions. Use laboratory calibration when: highest accuracy is required,
                environmental conditions must be tightly controlled, or complex procedures are
                needed.
              </p>
            </div>
            ...
            <div className="bg-card/50 rounded-lg p-4 border border-border">
              ...
              <p className="text-white text-sm">
                For most industrial applications, k=2 is used, providing approximately 95%
                confidence that the true value lies within the stated uncertainty range. For higher
                confidence (99%), use k=3. Some regulated industries may specify required coverage
                factors in their standards.
              </p>
            </div>

            <div className="bg-card/50 rounded-lg p-4 border border-border">
              <h3 className="font-semibold text-white mb-2">
                How can I reduce calibration costs without compromising quality?
              </h3>
              <p className="text-white text-sm">
                Implement risk-based calibration intervals based on historical performance data. Use
                trend analysis to identify instruments that can safely have extended intervals.
                Consider in-situ calibration to reduce downtime. Automate data capture and
                documentation. Group similar instruments for batch processing. Train technicians to
                perform routine calibrations in-house.
              </p>
            </div>
          </div>
        </section>
