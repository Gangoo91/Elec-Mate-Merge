...
const quizQuestions = [
  ...
  {
    question: 'Where does the EIC fit in the larger LCT handover documentation?',
    options: [
...
export default function RenewableEnergyModule12Section1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 12 · Section 1 · BS 7671:2018+A4:2026 · Chapter 64 + Reg 641-644"
        title="Part 6 Initial Verification framework applied to LCT"
        backTo="../renewable-energy-module-12"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The Chapter 64 + Reg 641-644 initial verification framework applied to renewable-energy
          installations. BS EN 61557 instrument family. Reg 642 inspection + Reg 643 testing
          sequence. Multi-source extensions beyond single-source AC verification. Per-source +
          cross-source verification with cert evidence bundle as the integrating record.
        </p>
        ...
        <Pullquote>
          Verification doesn\'t happen at the end. It happens during erection and on completion
          before being put into service. Read Reg 641.1 — that\'s the whole framework right there.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 641.1</strong> — during erection AND on completion
              before being put into service. For LCT: continuous + final. Pre-energisation DC string
              IR + post-energisation AC IR
            </li>
            <li>
              <strong className="text-white">Reg 641.2</strong> — assessment of fundamental
              principles + general characteristics + Reg 514.9.1 information shall be available to
              verifier. Design + drawings + DoCs + commissioning procedure as pre-requisites
            </li>
            <li>
              <strong className="text-white">Reg 641.3</strong> — comparison of results with
              relevant criteria to confirm BS 7671 requirements met. For LCT: per-source criteria +
              multi-source extensions
            </li>
            <li>
              <strong className="text-white">Reg 641.4</strong> — precautions to avoid danger to
              persons + livestock + damage to property + installed equipment during inspection +
              testing. LCT: PV array covered / shaded; DC isolators open; BESS DC bus open; AC
              isolated
            </li>
            <li>
              <strong className="text-white">Reg 641.5</strong> — addition / alteration shall comply
              AND not impair safety of existing. PV / BESS retrofit triggers existing-CU assessment
              + frequent upgrade
            </li>
            <li>
              <strong className="text-white">Reg 641.6</strong> — verification by skilled persons
              competent in such work. For LCT: BS 7671 + LCT-specific + manufacturer commissioning
              competencies
            </li>
            <li>
              <strong className="text-white">Reg 644.5</strong> — EIC compiled + signed by skilled
              person competent to verify. The cert evidence bundle signature anchor
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — EIC + Schedule of
              Inspections + Schedule of Test Results + per-source supporting docs + manufacturer
              commissioning records + MCS handover pack as the integrating record
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">(a) Connection of conductors</strong> — terminations
              torque-tightened, no loose strands. LCT: DC string + BESS DC + AC inverter
              terminations all checked
            </li>
            <li>
              <strong className="text-white">(b) Identification of conductors</strong> — colour code
              + labelling. LCT: brown live / blue neutral / green-yellow CPC; DC red positive /
              black or grey negative (per manufacturer)
            </li>
            <li>
              <strong className="text-white">(c) Routing of cables</strong> — in prescribed zones or
              protected against mechanical damage per Section 522. LCT: roof PV cables clipped +
              clear of moving parts; BESS DC routed safely
            </li>
            <li>
              <strong className="text-white">(d) Conductor selection</strong> — current-carrying
              capacity + voltage drop per design. LCT: PV DC cable Isc + 1.25 factor; AC cable per
              inverter rating
            </li>
            <li>
              <strong className="text-white">(e)-(g)</strong> — single-pole devices in line
              conductors only; correct accessory connection; fire barriers. LCT: PV DC isolator
              polarity-correct; combiner box gland fire-rated
            </li>
            <li>
              <strong className="text-white">(h)-(j)</strong> — basic + fault + additional
              protection methods. LCT: Class II PV DC per Reg 712.412.101; Reg 415.1 30 mA RCD; Type
              B where DC fault leakage
            </li>
            <li>
              <strong className="text-white">(k)-(m)</strong> — mutual detrimental influence;
              isolation + switching; undervoltage. LCT: generation isolators per Section 537;
              anti-islanding device
            </li>
            <li>
              <strong className="text-white">(n)-(r)</strong> — labelling + external influences +
              connections + warning notices + erection methods. LCT: PV warning notices per Reg
              712.514; G98 / G99 reference; cert evidence bundle records each item
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          The right tester for the right test, calibrated, in date, with the right BS EN 61557 part
          on its datasheet. If the tester is not compliant, neither is the verification.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Part 1 General</strong> — general safety + accuracy
              requirements for the tester. Covers all subsequent parts
            </li>
            <li>
              <strong className="text-white">Part 2 IR</strong> — insulation resistance. LCT: PV
              string IR at 500 V or 1000 V DC; BESS DC bus IR; AC IR at 500 V per Reg 643.3 + Table
              64
            </li>
            <li>
              <strong className="text-white">Part 3 Loop impedance</strong> — Zs measurement. LCT:
              confirms ADS time per Reg 411.4 / Reg 411.5 on the new LCT circuits
            </li>
            <li>
              <strong className="text-white">Part 4 Continuity</strong> — R1+R2 + R2 measurements.
              LCT: protective conductor continuity on PV + BESS + EV charging point earth path
            </li>
            <li>
              <strong className="text-white">Part 5 Earth electrode resistance</strong> — TT
              earthing or supplementary local earth. LCT: outdoor PV / wind / hydro may use TT or
              local earth electrodes
            </li>
            <li>
              <strong className="text-white">Part 6 RCD operation</strong> — RCD trip current + time
              per type. LCT: Type AC / A / B selection depends on source electronics; Type B
              critical for DC-fault-leakage sources
            </li>
            <li>
              <strong className="text-white">Part 8 IMD</strong> — insulation monitoring device.
              LCT: Reg 712.421.101 PV IMD compliance + IMD self-test at IV
            </li>
            <li>
              <strong className="text-white">Part 10 Multi-function</strong>— the typical MFT tester
              combines Parts 2, 3, 4, 6 in one instrument. LCT: ensure the model covers Type B RCD
              testing where the install requires it
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Per-source IV</strong> — PV per Section 712 (DC IR + AC
              IR + IMD + anti-islanding); BESS per Chapter 57 (DC bus + AC + BMS); EV per Section
              722 (PME architecture + Type B / RDC-DD); heat pump per Part 4-7 + manufacturer
            </li>
            <li>
              <strong className="text-white">Reg 551.4.2 RCD multi-source</strong> — verify each
              combination of sources triggers correct RCD on fault. Test matrix: PV-only, PV + BESS,
              PV + BESS + EV charging, etc. Record results
            </li>
            <li>
              <strong className="text-white">Reg 551.7.5 anti-islanding</strong> — verify per source
              the generator disconnects on grid loss. DNO-witnessed or manufacturer-self-test
            </li>
            <li>
              <strong className="text-white">DC IV procedures</strong>— PV DC at 500 V or 1000 V per
              Voc; BESS DC bus per manufacturer; EV DC fast per CHAdeMO / CCS commissioning. §12.2
              covers DC IR specifics
            </li>
            <li>
              <strong className="text-white">BMS commissioning</strong>— BESS BMS verified per
              manufacturer: cell balance, communications, fault tolerance, SoC + SoH baseline. §12.3
              covers BESS health
            </li>
            <li>
              <strong className="text-white">PEN-fault verification</strong> — outdoor LCT (EV,
              outdoor PV, outdoor BESS, ASHP outdoor unit): OPDD / RDC-DD verification per Reg
              722.411.4 + Section 712. §12.4 covers PEN faults
            </li>
            <li>
              <strong className="text-white">Documentation</strong>— single EIC covers the work with
              per-source detail in Schedule of Test Results; cert evidence bundle assembles
              per-source MCS handover packs around the EIC
            </li>
            <li>
              <strong className="text-white">Skilled person</strong>— Reg 641.6 + Reg 644.5: BS 7671
              + LCT competency + manufacturer commissioning. Multi-trade boundary: electrician\'s
              EIC + technology specialist commissioning
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">New circuit compliance</strong> — PV / BESS / EV / heat
              pump circuit must meet BS 7671:2018+A4:2026 (RCD architecture, AFDD where applicable,
              Type B where source electronics, Section 712 / Chapter 57 / Section 722 specifics)
            </li>
            <li>
              <strong className="text-white">Existing-install assessment</strong> — CU age +
              condition + spare ways + RCD architecture + earthing arrangement (TN-C-S PME
              considerations for outdoor LCT, TT for outdoor PV / wind)
            </li>
            <li>
              <strong className="text-white">Pre-1980s installations</strong> — frequently no main
              RCD, rubber-insulated cables degraded, no Type B; substantial remediation may be
              needed before LCT can be added safely
            </li>
            <li>
              <strong className="text-white">1980s-2000s installations</strong> — CU often
              functional but lacks Type S architecture or has only Type AC; PV / BESS / EV add
              typically triggers a CU change ~£600-1500
            </li>
            <li>
              <strong className="text-white">Post-2008 installations</strong> — typically
              RCD-protected; LCT add usually fits with minor additions (extra MCB / RCBO ways)
            </li>
            <li>
              <strong className="text-white">Earthing arrangement</strong> — TN-C-S PME + outdoor
              LCT (EV per Reg 722.411.4, outdoor PV inverter) requires OPDD or alternative
              architecture. §12.4 covers PEN faults in detail
            </li>
            <li>
              <strong className="text-white">AFDD A4:2026</strong> — A4 update introduced AFDD
              requirements in certain final circuits; LCT additions may need AFDD per current rules
            </li>
            <li>
              <strong className="text-white">Documentation</strong>— Reg 641.5 verification recorded
              on the EIC alongside the new-circuit IV; cert evidence bundle includes the
              existing-install assessment + any remediation
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">BS 7671 baseline</strong> — C&G 2391 Initial
              Verification + Periodic Inspection; 18th Edition / A4:2026 qualification; electrical
              installation experience appropriate to the install scope
            </li>
            <li>
              <strong className="text-white">PV competency</strong>— MCS PV competency
              (MCS-affiliated installer); IET COP for Solar PV; manufacturer inverter commissioning
              training (typically certified installer status with the inverter manufacturer)
            </li>
            <li>
              <strong className="text-white">BESS competency</strong>— MCS Battery Storage (where
              applicable); manufacturer BMS commissioning training (Tesla Powerwall certified
              installer, GivEnergy pro, etc); Chapter 57 understanding
            </li>
            <li>
              <strong className="text-white">EV competency</strong>— IET COP for EV Charging
              Installations; manufacturer EV charger commissioning (Zappi, Ohme, Hypervolt, Easee,
              etc); Section 722 + Reg 722.411.4 understanding
            </li>
            <li>
              <strong className="text-white">Heat pump competency</strong> — MCS Heat Pump certified
              (MIS 3005); manufacturer heat pump training; Part 4-7 + Reg 314 understanding
            </li>
            <li>
              <strong className="text-white">Other LCT competency</strong> — MIS 3001 solar thermal,
              MIS 3003 wind, MIS 3004 biomass, MIS 3007 micro-CHP, MIS 3008 micro-hydro;
              technology-specific manufacturer commissioning
            </li>
            <li>
              <strong className="text-white">Multi-trade boundary</strong> — the electrician\'s EIC
              covers BS 7671 electrical install; the MCS company\'s handover pack integrates this
              with the technology-specific commissioning by the technology specialist
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — every skilled person\'s
              name + signature + competency evidence retained for audit + customer record + DNO
