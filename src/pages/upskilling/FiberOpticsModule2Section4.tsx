...
const DESCRIPTION =
  'Understand fibre optic connector polish grades including PC, UPC, and APC. Learn return loss specifications, colour coding, and selection criteria for UK installations.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 2,
    explanation:
      'UPC (Ultra Physical Contact) polish achieves return loss of -50 dB or better, significantly reducing back-reflections compared to standard PC polish.',
  },
  {
    id: 'fo-m2s4-qc2',
    ...
    correctIndex: 2,
    explanation:
      'APC (Angled Physical Contact) connectors have the ferrule polished at an 8-degree angle, directing reflections away from the fibre core.',
  },
  {
    id: 'fo-m2s4-qc3',
    ...
    correctIndex: 2,
    explanation:
      'APC connectors use green colour coding (housing or boot) by industry convention to distinguish them from UPC connectors which use blue.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: ['Physical Contact', 'Polished Connection', 'Precision Core', 'Permanent Coupling'],
    correctAnswer: 0,
    explanation:
      'PC stands for Physical Contact - the ferrule end faces make direct physical contact when mated.',
  },
  {
    id: 2,
    question: 'Standard PC polish typically achieves a return loss of:',
    options: ['-20 dB', '-50 dB', '-30 to -35 dB', '-65 dB'],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: [
      'It offers lower insertion loss than UPC',
      'It allows a faster physical connection',
      'Fewer back-reflections cause less signal distortion',
      'It is cheaper to manufacture than UPC',
    ],
    correctAnswer: 2,
    explanation:
      "APC's extremely low back-reflections prevent interference patterns in analogue signals like CATV.",
  },
  {
    id: 4,
    question: 'Can you connect an APC connector to a UPC adaptor?',
    options: [
      'No, it will damage both ferrule end faces',
      'Yes, they are fully interchangeable',
      'Only when using multimode fibre',
      'Only at low optical power levels',
    ],
    correctAnswer: 0,
    explanation:
      'APC and UPC are not interchangeable - forcing them together damages both ferrule end faces.',
  },
  {
    id: 5,
    question: 'The curved end face of a UPC connector is polished with radius of approximately:',
    options: ['5-10mm', '50-100mm', 'It is completely flat', '10-25mm'],
    correctAnswer: 3,
  ...
  },
  {
    ...
    options: ['APC', 'PC', 'SPC', 'UPC'],
    correctAnswer: 0,
    explanation:
      'APC is required for CATV and RF-over-fibre due to its superior return loss performance.',
  },
  {
    id: 7,
    question: 'The 8-degree angle in APC connectors directs reflections:',
    options: [
      'Into the core for maximum power',
      'Straight back towards the source',
      'Into the cladding, away from the core',
      'Into adjacent fibres in the cable',
    ],
    correctAnswer: 2,
    explanation:
      "The 8-degree angle causes reflections to exceed the fibre's numerical aperture and escape into the cladding.",
  },
  {
    id: 8,
    question: 'What insertion loss increase might be expected with APC vs UPC?',
    options: ['None - identical insertion loss', '0.5 dB higher', '1.0 dB higher', '0.1-0.2 dB higher'],
    correctAnswer: 3,
    explanation:
      'APC connectors typically have slightly higher insertion loss (0.1-0.2 dB) than UPC due to the angled interface.',
  },
  {
    id: 9,
    question: 'Blue coloured connector housings typically indicate:',
    options: ['APC polish', 'Multimode fibre', 'UPC polish', 'A high-power rating'],
    correctAnswer: 2,
  ...
  },
  {
    ...
    options: ['-30 dB', '-50 dB', '-40 dB', '-65 dB'],
    correctAnswer: 2,
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>PC:</strong> Basic polish, -30dB return loss
              </li>
              <li>
                <strong>UPC:</strong> Extended polish, -50dB, blue colour
              </li>
              <li>
                <strong>APC:</strong> 8-degree angle, -65dB, green colour
              </li>
              <li>
                <strong>Rule:</strong> Never mix APC with UPC
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Blue = UPC, Green = APC
              </li>
              <li>
                <strong>Use:</strong> UPC for data, APC for CATV/analogue
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              loss (signal attenuation). Proper polish selection is essential for system
              performance, particularly in singlemode applications.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                ...
                return loss) at an unpolished air gap. Physical contact polishing eliminates the air
                gap and dramatically reduces reflections - critical for laser sources sensitive to
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong className="text-elec-yellow">PC (Physical Contact):</strong> Original
                  standard polish with curved end face. Achieves -30 to -35 dB return loss. Suitable
                  for basic applications.
                </li>
                <li>
                  <strong className="text-elec-yellow">UPC (Ultra Physical Contact):</strong>{' '}
                  Extended polishing process for superior surface finish. Achieves -50 dB or better
                  return loss. Standard for data/telecom.
                </li>
                <li>
                  <strong className="text-elec-yellow">APC (Angled Physical Contact):</strong>{' '}
                  8-degree angled ferrule face directing reflections into cladding. Achieves -65 dB
                  or better return loss. Required for CATV/analogue.
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>End face geometry:</strong> Domed, 10-25mm radius
                </li>
                <li>
                  <strong>Return loss:</strong> 50 dB or better typical
                </li>
                <li>
                  <strong>Insertion loss:</strong> 0.25 dB or better typical
                </li>
                <li>
                  <strong>Colour code:</strong> Blue (singlemode)
                </li>
                <li>
                  <strong>Applications:</strong> Data, telecom, enterprise networks
                </li>
              </ul>
            </div>
            ...
            <p>
              ...
              air gaps at the critical light-carrying centre. Under a microscope, a properly
              polished UPC ferrule shows no visible scratches in the core zone.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>End face angle:</strong> 8 degrees
                </li>
                <li>
                  <strong>Return loss:</strong> 65 dB or better typical
                </li>
                <li>
                  <strong>Insertion loss:</strong> 0.30 dB or better typical
                </li>
                <li>
                  <strong>Colour code:</strong> Green (universal)
                </li>
                <li>
                  <strong>Fibre type:</strong> Singlemode only
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>Blue:</strong> UPC singlemode - standard for data/telecom
                </li>
                <li>
                  <strong>Green:</strong> APC - always singlemode, CATV/analogue
                </li>
                <li>
                  <strong>Beige/Cream:</strong> Multimode (OM1-OM5) - always UPC/PC
                </li>
                <li>
                  <strong>Aqua:</strong> OM3/OM4/OM5 laser-optimised multimode
                </li>
              </ul>
            </div>
            ...
            <p>
              ...
              match connector polish grade colour - using a blue UPC adaptor with green APC
              connectors is as damaging as mixing the connectors directly.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>UPC connector + UPC adaptor:</strong> Compatible
                </li>
                <li>
                  <strong>APC connector + APC adaptor:</strong> Compatible
                </li>
                <li>
                  <strong>PC connector + UPC adaptor:</strong> Compatible
                </li>
                <li>
                  <strong>UPC connector + APC adaptor:</strong> DAMAGE - never connect
                </li>
                <li>
                  <strong>APC connector + UPC adaptor:</strong> DAMAGE - never connect
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Is it multimode?</strong> Use UPC (or PC)
                </li>
                <li>
                  <strong>Is the signal analogue (RF, video, CATV)?</strong> Use APC
                </li>
                <li>
                  <strong>Does equipment specify greater than 60 dB return loss?</strong> Use APC
                </li>
                <li>
                  <strong>Is existing infrastructure APC?</strong> Match with APC
                </li>
                <li>
                  <strong>None of the above?</strong> Use UPC (standard digital singlemode)
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Assuming all singlemode connectors are compatible</strong> - check polish
                  grade
                </li>
                <li>
                  <strong>Ignoring adaptor polish grade</strong> - adaptors must match too
                </li>
                <li>
                  <strong>Using APC connectors for multimode</strong> - unnecessary, doesn't exist
                </li>
                <li>
                  <strong>Forcing tight connections</strong> - could indicate polish mismatch
                </li>
              </ul>
            </div>
          </div>
