    ...
    <HubPage>
      ...
      <HubBody>
        <div className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'The Reg 641 / Reg 642 framework for verifying every new installation, alteration or addition before it is energised. Design data in, inspection before test, Section 643 sequence, EIC issued — and what A4:2026 changes about the model forms.'
          }
        </div>
        ...
        >
          <p>
            ...
            regulations governing the verification regime. It tells the inspector that verification
            happens during erection (continuous, by the installer themselves) and on completion (a
            final, documented inspection-and-test pass before energisation). It also tells the
            inspector that defects revealed during verification shall be made good before the
            installation is put into service — you cannot issue a satisfactory EIC on an
            installation with outstanding defects.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            set must be sufficient for the inspector to determine compliance with BS 7671 — that is
            the test. If a reasonable inspector could not, with the documents provided, decide
        ...
        >
          <p>
            ...
            cable, protective device and earthing decisions in Part 5 (Selection and Erection); the
            inspector verifies that what was selected and erected matches what was assessed and
            designed. Break the chain and the cert stops being defensible.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            disconnected from the supply during inspection (and during the dead tests that follow).
            The inspection is structured by the Schedule of Inspection in Appendix 6, which itemises
            every aspect that must be visually verified — connection of conductors, identification
            of conductors, routing, conductor selection, erection methods, presence of devices for
            isolation and switching, presence of undervoltage-protection devices, choice and setting
            of protective devices, presence of warning notices, presence of circuit charts and
            diagrams.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            otherwise corrupt or endanger a later test. IR before energisation prevents you putting
            test voltage onto a circuit with damaged insulation; polarity before energisation
            prevents you energising a circuit with reversed L and N at an accessory. Live testing
            only happens once the dead-test sequence has cleared the installation as fundamentally
            safe to energise.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The Schedule of Test Results is the evidence underpinning the inspector's declaration on
            the EIC. A circuit that shows a Zs reading exceeding the maximum permitted for the
            ...
            measured Zs above the limit is not a paperwork issue — it is certifying compliance that
        ...
        >
          <p>
            ...
            integral part of the certificate — an EIC without its schedules is incomplete and not a
            valid record of verification.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            signature commits the signer to the statement that the construction of the installation
            complies with BS 7671 except for any departures recorded. The Inspector signature
            commits the signer to the statement that the inspection and testing have been carried
            out in accordance with the regulations and that the results meet the requirements. Three
            signatures, three commitments, three records — and on a sole-trader job, all three sit
            on the same competent person.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 120.3 cross-references Reg 133.5 (departures from product / protection requirements)
            and gives the EIC field — "Details of Departures from BS 7671 (Reg 120.3 and 133.5)" —
            for recording them. Each departure entry should capture (a) the regulation departed
            from, (b) the reason for the departure, (c) the technical evidence that the resulting
            degree of safety is not less than that of full compliance (calculations, manufacturer
            data, alternative-standard compliance), and (d) the competent person's sign-off.
            Attached evidence travels with the cert pack.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The recommended period is informed by the Section 311 assessment of external influences
            captured at design stage — a wet, dusty agricultural environment ages an installation
            faster than a clean, dry office. The inspector adjusts the typical interval up or down
            based on these factors and the observed condition. A shorter interval is appropriate
            where conditions are harsh, use is intensive, or there are early signs of degradation; a
            typical interval is appropriate for benign environments with normal use. The reasoning
            behind a non-typical interval should accompany the cert in the inspector's notes.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            pre-A4 form for work completed under A4:2026 leaves the cert lacking the schedule items
            for the requirements you certified against — a documentation defect that will be picked
            up at the next periodic inspection. RCP scheme uploads, building-control filings and
            insurer records all expect A4 forms after the in-force date. Update your cert templates,
            your software (commercial cert tools all release A4 updates around the in-force date)
            and your training material before 15 April 2026.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            checklist is not bureaucracy; it is the inspector's safety case for their own signature
            on the cert. Every item exists because, somewhere, an inspector has been prosecuted or
            sued for missing it.
          </p>
        </ConceptBlock>
