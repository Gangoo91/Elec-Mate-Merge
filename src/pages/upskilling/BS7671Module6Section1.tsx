...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Initial verification is a legal requirement under EaWR 1989 and BS7671 that ensures the installation is safe, compliant with regulations, and fit for service before energisation.',
  },
  {
    id: 'work-categories',
    ...
    correctIndex: 2,
    explanation:
      'New circuits require full initial verification with an Electrical Installation Certificate (EIC). Minor additions to existing circuits can use a Minor Works certificate.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Only a skilled person competent in electrical installation work and testing can sign an EIC. This is typically someone qualified, experienced, and registered with a competent person scheme.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'An EIC (Electrical Installation Certificate) is for new installations, new circuits, or major alterations. An MEIWC (Minor Works) is for minor additions to existing circuits, like adding a socket or light point to an existing circuit.',
  },
  {
    question: 'Does replacing a consumer unit require an EIC?',
    answer:
      'Yes. Consumer unit replacement is notifiable work requiring an EIC. It involves significant changes to protective devices and earthing arrangements that must be fully verified.',
  },
  {
    question: 'Can I self-certify my own work?',
    answer:
      "If you're registered with a competent person scheme, yes. Otherwise, you must notify Building Control who will arrange third-party inspection and certification.",
  },
  {
    question: "What happens if I don't provide certification?",
    answer:
      "Non-compliance can result in prosecution, invalidated insurance, difficulty selling the property, and personal liability for any accidents. It's a legal requirement under Building Regulations Part P.",
  },
];
...
const quizQuestion = {
  ...
  correctAnswer: 1,
  explanation:
    'Initial verification (visual inspection and testing) must be completed before energisation. This ensures the installation is safe and compliant before any live testing can proceed.',
};
...
const BS7671Module6Section1 = () => {
  useSEO({
    ...
    description:
      "Learn about initial verification requirements under BS7671 including when it's required, mandatory checks, and certification responsibilities.",
  });
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Legal:</strong> Required by EaWR 1989 and BS7671
              </li>
              <li>
                <strong>Safety:</strong> Confirms protection against shock and fire
              </li>
              <li>
                <strong>Documentation:</strong> Evidence for client, insurers, regulators
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>New installations:</strong> Complete new builds, rewires
              </li>
              <li>
                <strong>Additions:</strong> New circuits, consumer units
              </li>
              <li>
                <strong>Alterations:</strong> Significant changes to existing work
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Initial verification is not merely a recommended practice—it's a fundamental legal
              requirement. This process serves as the critical bridge between installation
              completion and safe energisation.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Initial verification applies to any new installation, addition, or significant
              alteration. The scope determines the certificate type required.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BS7671 Chapter 61 mandates a specific sequence: visual inspection first (with
              installation de-energised), then electrical testing.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Equipment:</strong> Selection and suitability
                  </li>
                  <li>
                    <strong>Environment:</strong> IP ratings, fire resistance
                  </li>
                  <li>
                    <strong>Cables:</strong> Correct sizing and installation
                  </li>
                  <li>
                    <strong>Protection:</strong> Devices correctly rated
                  </li>
                  <li>
                    <strong>Earthing:</strong> Proper bonding arrangements
                  </li>
                  <li>
                    <strong>Labelling:</strong> Circuit identification
                  </li>
                </ul>
              </div>
              <div>
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Electrical Testing (Reg 612)
                </p>
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Dead tests:</strong> Continuity, insulation, polarity
                  </li>
                  <li>
                    <strong>Live tests:</strong> Zs, RCD operation, PFC
                  </li>
                  <li>
                    <strong>Functional:</strong> Switches, controls, devices
                  </li>
                  <li>
                    <strong>Recording:</strong> All results documented
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The person signing certificates assumes full legal responsibility for the accuracy of
              all recorded information and the safety of the installation.
            </p>
          ...
          <div className="p-5 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-xs text-white">
              <div>
                ...
                <p>
                  12 circuits with reversed polarity, main earth resistance of 2.3Ω, and 2 faulty
                  RCDs not tripping within time limits.
                </p>
              </div>
              <div>
                <p className="font-medium text-white mb-1">Outcome</p>
                <p>
                  All defects corrected, re-tested satisfactorily, and safe installation handed over
                  with proper EIC documentation.
                </p>
              </div>
            </div>
          </div>
