...
const inlineChecks = [
  {
    id: 'elm3-s5-symbols',
    question:
      'Standard symbols for emergency luminaires on a layout drawing follow which standard?',
    options: [
  ...
  },
  {
    id: 'elm3-s5-docs',
    question:
      'BS 5266-1:2025 documentation requirements for the emergency lighting design include...?',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question:
      'BS 5266-1:2025 references which standard for graphic symbols on emergency-lighting layout drawings?',
    options: [
  ...
  },
  {
    id: 4,
    question:
      'On an emergency-lighting drawing, each luminaire symbol typically carries which information?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'A photometric calculation report (Dialux output) for an emergency lighting design should include...?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The drawing IS the design. Every luminaire position, every photometric calculation, every
          safety-equipment vertical-lux mapping is on the layout. BS 5266-1:2025 §7 expands
          documentation requirements — the drawing alone is no longer sufficient; the design pack
          must include schedules, photometric output and the risk-assessment trail. Done well, the
          pack survives the design team and supports the building through its life.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              primary and secondary escape routes from each occupiable area to the final exits. The
              route lighting design follows this layer.
            </li>
            <li>
              <strong>Luminaire positions.</strong> Each emergency luminaire as a symbol (per IEC
              60617 / BS 5266) at its specified location. Mounting orientation arrow for asymmetric
              optics. Reference label (e.g. EM1, EM2) linking to the schedule. Circuit number
              annotation.
            </li>
            <li>
              <strong>Photometric grid.</strong> Calculation grid (typically 0.5 m × 0.5 m or 1 m ×
              1 m) overlaid on the target plane (floor for horizontal duties; vertical face for
              safety equipment). Each grid intersection carries the calculated lux value, or the
              area is presented as a contour map.
            </li>
            <li>
              <strong>Safety-equipment overlay.</strong> Fire alarm call points, firefighting
              equipment, first-aid posts, refuge call points marked with their identifiers. Each
              linked by a leader to its dedicated luminaire (the one providing 5 lx vertical on the
              device face).
            </li>
            <li>
            ...
            <li>
              <strong>Cross-section views.</strong> Where height-critical (stairs, high-bay, atria,
              refuges), additional cross-section views show the vertical relationship between
              luminaire and target. Plan-view alone does not communicate stair tread illumination or
              atrium mezzanine coverage.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              calculation, the location of safety equipment requiring vertical illuminance, and the
              location of emergency exit signs. The drawings shall be supported by a schedule of
              luminaires, a schedule of test points, and the photometric calculation output.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              luminaires, half-circle for wall-mounted, etc. The body shape distinguishes luminaire
              family.
            </li>
            <li>
              <strong>Emergency function marking.</strong> Letter inside or beside the body — M
              (maintained, lit in normal use, continues on mains failure), NM (non-maintained, dark
              in normal use, illuminates on mains failure), HR (high-risk task), or combinations
              such as M/HR. The letter immediately tells the installer how the luminaire wires.
            </li>
            <li>
              <strong>Supply marking.</strong> SC (self-contained, integral battery), CB (central
              battery, fed from a central UPS / battery system). Critical for the installer because
              the wiring is fundamentally different — SC needs only normal supply with a permanent
              live for charging detection; CB needs a separate emergency-supply circuit from the
              central battery.
            </li>
            <li>
              <strong>Mounting orientation arrow.</strong> Asymmetric / forward-throw luminaires
              have a tapered arrow showing the direction the bright part of the beam goes. Symmetric
              luminaires omit the arrow. The installer must orient to the arrow.
            </li>
            <li>
              <strong>Reference label.</strong> Short identifier (e.g. EM1 for emergency luminaire
              type 1, EM2 for type 2, EM3 for type 3) linking the symbol to the schedule of
              luminaires. Multiple instances of the same type carry the same reference.
            </li>
            <li>
              <strong>Circuit number annotation.</strong> The final circuit feeding the luminaire
              (e.g. C1, C2, or full origin reference such as DB1/MCB-3). Important for high-risk
              areas where the 2-circuit redundancy rule needs verification.
            </li>
          </ul>
          <p>Drawing scales:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>1:50 — detail areas.</strong> Refuge points, high-risk task areas, sign detail
              close-ups, intersection details where multiple duties combine. Larger scale lets the
              photometric grid annotations be read alongside the symbols.
            </li>
            <li>
              <strong>1:200 — overview only, not for compliance.</strong> Sometimes used for
              site-wide overview at very large facilities. The symbols and grid annotations cannot
              be read at this scale without zoom; not acceptable as the primary design drawing.
            </li>
            <li>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              full-width verification (within the BS EN 1838:2024 non-excluded width), anti-panic
              open areas, high-risk task surfaces. Captures localised minima.
            </li>
            <li>
              <strong>1 m × 1 m for large open areas.</strong> Where the open area is substantial
              (1000 m² or more) and uniformity is the dominant duty, 1 m grids reduce computation
              time without missing duty-relevant minima.
            </li>
            <li>
              <strong>0.1 m or finer at safety equipment.</strong> The 5 lx vertical at a call point
              is a localised duty; very fine grids confirm the lux value at the precise call-point
              face position.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Manufacturer.</strong> Specific manufacturer (e.g. Helvar, Tridonic, Eaton,
              Designplan). Avoid generic descriptions; the design depends on the specific
              photometric data of the named manufacturer.
            </li>
            <li>
              <strong>Model number.</strong> Specific model variant. Manufacturers often have
              product families with multiple variants differing in photometric distribution, light
              output, supply voltage, IP rating. The schedule names the specific variant.
            </li>
            <li>
              <strong>Photometric file.</strong> LDT or IES file reference (e.g. EM1_3W_Wide.ldt)
              that was used in the design calculation. The commissioning engineer can re-verify with
              the same file.
            </li>
            <li>
            ...
            <li>
              <strong>Mounting.</strong> Recessed / surface / suspended / wall-mounted / bulkhead.
              With mounting height (e.g. 2.5 m).
            </li>
            <li>
              <strong>Photometric distribution.</strong> Narrow / medium / wide / asymmetric with
              the manufacturer code (e.g. BR-B, BR-D).
            </li>
            <li>
              <strong>Beam orientation.</strong> For asymmetric luminaires, the cardinal direction
              the bright part of the beam goes. Matches the arrow on the drawing symbol.
            </li>
            <li>
              <strong>Circuit number.</strong> Final circuit reference (e.g. C-EM-1, EM-A, or full
              origin). Critical for high-risk areas.
            </li>
            <li>
              <strong>Duration rating.</strong> 1 h / 2 h / 3 h. Verified at commissioning by the
              rated-duration test.
            </li>
            <li>
              <strong>Commissioning notes.</strong> Any specific test method, expected photometric
              reading, or unique commissioning action for this luminaire.
            </li>
          </ul>
          <p>
            The schedule is typically a table on the drawing or a separate document referenced by
            the drawing. Either format works; the schedule must accompany the drawing wherever the
            drawing is used.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Pictogram size.</strong> Drives viewing distance: viewing distance = 100 ×
              pictogram height. A 200 mm pictogram is legible at 20 m; a 300 mm pictogram at 30 m.
              The drawing must show the pictogram dimension to evidence the viewing-distance choice.
            </li>
            <li>
              <strong>Mounting height.</strong> Typically 2.0 to 2.5 m above floor for head-height
              visibility along the route; higher (3 m) for sightline above large fixtures or crowds.
            </li>
            <li>
              <strong>Lit classification.</strong> Internally illuminated (self-contained luminous
              sign), externally illuminated (sign panel lit by an adjacent emergency luminaire), or
              non-lit (uncommon, only acceptable in spaces with continuous ambient lighting from
              emergency luminaires).
            </li>
            <li>
              <strong>Direction.</strong> Which way the running-man pictogram points — left, right,
              up, down, or pointing to a specific exit. The drawing arrow on the symbol matches.
            </li>
          </ul>
          <p>Safety-equipment schedule entries:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Device reference.</strong> Identifier for the device (e.g. MCP-G-01 for the
              first manual call point on ground floor).
            </li>
            <li>
              <strong>Device type.</strong> Manual call point / extinguisher / hose reel / first-aid
              post / refuge call point.
            </li>
            <li>
              <strong>Location.</strong> Wall, room, height — typically 1.2 to 1.5 m above floor for
              call points, varying for other devices.
            </li>
            <li>
            ...
            <li>
              <strong>Photometric verification.</strong> Calculated vertical lux at the device face
              (e.g. 6.4 lx vertical). The verification value is part of the photometric output.
            </li>
          </ul>
          <p>
            The safety-equipment schedule is the trail that lets an inspector verify each device has
            its required vertical light. Without it, the inspector must reverse-engineer from the
            layout drawing and the photometric output — possible but slow and error-prone.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Each emergency exit sign shall be specified on the design drawings with its location,
              pictogram type, pictogram size, mounting height and direction of pointing. Where the
              sign is internally illuminated, its self-contained classification shall be stated;
              where externally illuminated, the dedicated luminaire that illuminates it shall be
              referenced. Pictogram dimensions shall be consistent with the maximum viewing distance
              from the most distant occupant position to the sign.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <line
              ...
              strokeWidth="2"
            />
            <text x="370" y="100" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="10">
              corridor (1.8 m wide)
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="32" y="190" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              EXIT
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="420" y="254" textAnchor="middle" fill="rgba(255,255,255,0.75)" fontSize="9">
              door
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="710" y="190" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              EXIT
            </text>
            ...
            <text x="370" y="175" textAnchor="middle" fill="rgba(34,197,94,0.85)" fontSize="9">
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="91" y="166" textAnchor="middle" fill="#000" fontSize="10" fontWeight="bold">
              M
            </text>
            <text x="91" y="186" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              EM1
            </text>
            <text x="91" y="198" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              SC · C-EM-1
            </text>
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="251" y="166" textAnchor="middle" fill="#000" fontSize="10" fontWeight="bold">
              NM
            </text>
            <text x="251" y="186" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              EM1
            </text>
            <text x="251" y="198" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              SC · C-EM-1
            </text>
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="411" y="166" textAnchor="middle" fill="#000" fontSize="10" fontWeight="bold">
              M
            </text>
            <polygon points="424,151 432,161 424,171" fill="#FBBF24" />
            <text x="411" y="186" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              EM2
            </text>
            <text x="411" y="198" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              SC · BR-D · C-EM-1
            </text>
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="571" y="166" textAnchor="middle" fill="#000" fontSize="10" fontWeight="bold">
              NM
            </text>
            <text x="571" y="186" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              EM1
            </text>
            <text x="571" y="198" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              SC · C-EM-2
            </text>
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="671" y="166" textAnchor="middle" fill="#000" fontSize="10" fontWeight="bold">
              M
            </text>
            <text x="671" y="186" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              EM3
            </text>
            <text x="671" y="198" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              SC · C-EM-2
            </text>

            {/* Photometric grid lux values */}
            <text x="120" y="220" textAnchor="middle" fill="rgba(34,211,238,0.85)" fontSize="9">
              1.4
            </text>
            <text x="160" y="220" textAnchor="middle" fill="rgba(34,211,238,0.85)" fontSize="9">
              1.2
            </text>
            <text x="200" y="220" textAnchor="middle" fill="rgba(34,211,238,0.85)" fontSize="9">
              1.1
            </text>
            <text x="240" y="220" textAnchor="middle" fill="rgba(34,211,238,0.85)" fontSize="9">
              1.4
            </text>
            <text x="280" y="220" textAnchor="middle" fill="rgba(34,211,238,0.85)" fontSize="9">
              1.2
            </text>
            <text x="320" y="220" textAnchor="middle" fill="rgba(34,211,238,0.85)" fontSize="9">
              1.0
            </text>
            <text x="360" y="220" textAnchor="middle" fill="rgba(34,211,238,0.85)" fontSize="9">
              1.1
            </text>
            <text x="400" y="220" textAnchor="middle" fill="rgba(34,211,238,0.85)" fontSize="9">
              1.5
            </text>
            <text x="440" y="220" textAnchor="middle" fill="rgba(34,211,238,0.85)" fontSize="9">
              1.6
            </text>
            <text x="480" y="220" textAnchor="middle" fill="rgba(34,211,238,0.85)" fontSize="9">
              1.4
            </text>
            <text x="520" y="220" textAnchor="middle" fill="rgba(34,211,238,0.85)" fontSize="9">
              1.2
            </text>
            <text x="560" y="220" textAnchor="middle" fill="rgba(34,211,238,0.85)" fontSize="9">
              1.4
            </text>
            <text x="600" y="220" textAnchor="middle" fill="rgba(34,211,238,0.85)" fontSize="9">
              1.2
            </text>
            <text x="640" y="220" textAnchor="middle" fill="rgba(34,211,238,0.85)" fontSize="9">
              1.3
            </text>
            ...
            <text
              ...
              fontWeight="bold"
            >
              photometric grid 1 m × 1 m · 0% reflectance · min 1.0 lx
            </text>
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="668" y="135" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              EXIT →
            </text>
            <text x="668" y="118" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              200 mm pictogram (20 m view)
            </text>
            ...
            <rect
              ...
              strokeWidth="1.4"
            />
            <text x="342" y="255" textAnchor="middle" fill="#fff" fontSize="9" fontWeight="bold">
              M
            </text>
            <text x="342" y="278" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              MCP-G-01
            </text>
            <text x="342" y="290" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              linked → EM2 · 6.4 lx vert
            </text>
            ...
            <text
              ...
              fontWeight="bold"
            >
              Schedule of luminaires (extract)
            </text>

            <text x="40" y="358" fill="#FBBF24" fontSize="9" fontWeight="bold">
              Ref
            </text>
            <text x="80" y="358" fill="#FBBF24" fontSize="9" fontWeight="bold">
              Mfr / Model
            </text>
            <text x="220" y="358" fill="#FBBF24" fontSize="9" fontWeight="bold">
              Fn
            </text>
            <text x="250" y="358" fill="#FBBF24" fontSize="9" fontWeight="bold">
              Sup
            </text>
            <text x="290" y="358" fill="#FBBF24" fontSize="9" fontWeight="bold">
              Dist
            </text>
            <text x="340" y="358" fill="#FBBF24" fontSize="9" fontWeight="bold">
              Mt
            </text>
            <text x="380" y="358" fill="#FBBF24" fontSize="9" fontWeight="bold">
              Cct
            </text>
            <text x="430" y="358" fill="#FBBF24" fontSize="9" fontWeight="bold">
              Dur
            </text>
            ...
            <text x="40" y="382" fill="rgba(255,255,255,0.85)" fontSize="9">
              EM1
            </text>
            <text x="80" y="382" fill="rgba(255,255,255,0.85)" fontSize="9">
              Helvar / iL3-Wide
            </text>
            <text x="220" y="382" fill="rgba(255,255,255,0.85)" fontSize="9">
              M/NM
            </text>
            <text x="250" y="382" fill="rgba(255,255,255,0.85)" fontSize="9">
              SC
            </text>
            <text x="290" y="382" fill="rgba(255,255,255,0.85)" fontSize="9">
              BR-C
            </text>
            <text x="340" y="382" fill="rgba(255,255,255,0.85)" fontSize="9">
              2.7
            </text>
            <text x="380" y="382" fill="rgba(255,255,255,0.85)" fontSize="9">
              EM-1/2
            </text>
            <text x="430" y="382" fill="rgba(255,255,255,0.85)" fontSize="9">
              3 h
            </text>

            <text x="40" y="402" fill="rgba(255,255,255,0.85)" fontSize="9">
              EM2
            </text>
            <text x="80" y="402" fill="rgba(255,255,255,0.85)" fontSize="9">
              Tridonic / FT-Asym
            </text>
            <text x="220" y="402" fill="rgba(255,255,255,0.85)" fontSize="9">
              M
            </text>
            <text x="250" y="402" fill="rgba(255,255,255,0.85)" fontSize="9">
              SC
            </text>
            <text x="290" y="402" fill="rgba(255,255,255,0.85)" fontSize="9">
              BR-D
            </text>
            <text x="340" y="402" fill="rgba(255,255,255,0.85)" fontSize="9">
              2.7
            </text>
            <text x="380" y="402" fill="rgba(255,255,255,0.85)" fontSize="9">
              EM-1
            </text>
            <text x="430" y="402" fill="rgba(255,255,255,0.85)" fontSize="9">
              3 h
            </text>

            <text x="40" y="422" fill="rgba(255,255,255,0.85)" fontSize="9">
              EM3
            </text>
            <text x="80" y="422" fill="rgba(255,255,255,0.85)" fontSize="9">
              Eaton / EX-Bulkhead
            </text>
            <text x="220" y="422" fill="rgba(255,255,255,0.85)" fontSize="9">
              M
            </text>
            <text x="250" y="422" fill="rgba(255,255,255,0.85)" fontSize="9">
              SC
            </text>
            <text x="290" y="422" fill="rgba(255,255,255,0.85)" fontSize="9">
              Wide
            </text>
            <text x="340" y="422" fill="rgba(255,255,255,0.85)" fontSize="9">
              2.2
            </text>
            <text x="380" y="422" fill="rgba(255,255,255,0.85)" fontSize="9">
              EM-2
            </text>
            <text x="430" y="422" fill="rgba(255,255,255,0.85)" fontSize="9">
              3 h
            </text>
            ...
            <text x="560" y="358" fill="#FBBF24" fontSize="9" fontWeight="bold">
              Ref
            </text>
            <text x="615" y="358" fill="#FBBF24" fontSize="9" fontWeight="bold">
              Type
            </text>
            <text x="700" y="358" fill="#FBBF24" fontSize="9" fontWeight="bold">
              Linked lum
            </text>
            <text x="800" y="358" fill="#FBBF24" fontSize="9" fontWeight="bold">
              V-lx
            </text>
            ...
            <text x="560" y="382" fill="rgba(255,255,255,0.85)" fontSize="9">
              MCP-G-01
            </text>
            <text x="615" y="382" fill="rgba(255,255,255,0.85)" fontSize="9">
              Call point
            </text>
            <text x="700" y="382" fill="rgba(255,255,255,0.85)" fontSize="9">
              EM2
            </text>
            <text x="800" y="382" fill="rgba(255,255,255,0.85)" fontSize="9">
              6.4 lx
            </text>

            <text x="560" y="402" fill="rgba(255,255,255,0.85)" fontSize="9">
              EXT-G-01
            </text>
            <text x="615" y="402" fill="rgba(255,255,255,0.85)" fontSize="9">
              Extinguisher
            </text>
            <text x="700" y="402" fill="rgba(255,255,255,0.85)" fontSize="9">
              EM1 (mid)
            </text>
            <text x="800" y="402" fill="rgba(255,255,255,0.85)" fontSize="9">
              5.6 lx
            </text>

            <text x="560" y="422" fill="rgba(255,255,255,0.85)" fontSize="9">
              FA-G-01
            </text>
            <text x="615" y="422" fill="rgba(255,255,255,0.85)" fontSize="9">
              First-aid post
            </text>
            <text x="700" y="422" fill="rgba(255,255,255,0.85)" fontSize="9">
              dedicated
            </text>
            <text x="800" y="422" fill="rgba(255,255,255,0.85)" fontSize="9">
              5.2 lx
            </text>

            {/* Title block */}
            <rect x="20" y="568" width="840" height="10" fill="rgba(255,255,255,0.04)" />
            <text x="30" y="576" fill="rgba(255,255,255,0.55)" fontSize="9">
              Project · Floor G · Drawing EM-G-001 · Rev C · Scale 1:100 · BS 5266-1:2025 / BS EN
              1838:2024
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              positions, escape routes, photometric grids, safety-equipment overlay, sign positions,
              cross-sections.
            </li>
            <li>
            ...
            <li>
              <strong>Photometric calculation output.</strong> Dialux / Relux / AGi32 report with
              point-by-point grids, minimum / maximum / uniformity, reflectance set to 0%,
              maintenance factor stated.
            </li>
            <li>
              <strong>Risk-assessment cross-reference.</strong> Mapping each design uplift
              (above-minimum lux, refuge provision, high-risk circuit redundancy) to the fire risk
              assessment factor that drove it. Traceability from risk to design.
            </li>
            <li>
              <strong>Schedule of test points.</strong> Where the commissioning engineer must
              physically measure lux to verify the design. Typically the worst-case grid points from
              the photometric calculation, plus every safety-equipment vertical-lux point.
            </li>
            <li>
              <strong>Schedule of safety-equipment vertical-lux points.</strong> Already described —
              the per-device mapping.
            </li>
            <li>
              <strong>Manufacturer datasheets.</strong> For every luminaire model in the schedule.
              Photometric polar diagrams, S/h tables, IP rating, certifications.
            </li>
            <li>
              <strong>Photometric data files.</strong> The LDT / IES files used in the calculation.
              The commissioning engineer can re-run the calculation with the same data; future
              design modifications can refer to the actual photometric used.
            </li>
            <li>
          ...
          <p>
            ...
            dutyholder retains it and provides it on request to fire safety inspectors, insurance
            auditors, and any future design team modifying the system.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              points, schedule of commissioning test points, manufacturer photometric data files,
              maintenance factor justification, and a cross-reference to the fire risk assessment
              identifying the basis for any design above the minimum values stated in this standard.
            </>
          }
        ...
        <FAQ
          items={[
            ...
            {
              question:
                'What if the photometric calculation report does not state 0% reflectance explicitly?',
              answer:
            ...
            {
              question:
                'Can the schedule of luminaires be combined with the schedule of test points?',
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() =>
              navigate('/electrician/upskilling/emergency-lighting-module-3-section-6')
            }
