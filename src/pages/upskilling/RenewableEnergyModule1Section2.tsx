...
const inlineChecks = [
  ...
  },
  {
    ...
    question: 'What did A4:2026 do with Appendix 17, the energy-efficiency appendix?',
    options: [
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'Reg 551.8 was deleted by A4:2026. Where did its content go?',
    options: [
  ...
  {
    id: 5,
    question: 'Section 753 was extended in A4:2026. What does its extended scope now cover?',
    options: [
  ...
  {
    id: 7,
    question: 'Section 730 in A4:2026 has what scope?',
    options: [
...
const faqs = [
  ...
  {
    question: 'How do the IET Codes of Practice relate to the BS 7671 LCT chapters in practice?',
    answer:
  ...
  {
    question: 'Section 715 (extra-low voltage lighting) — is this LCT-relevant?',
    answer:
  ...
  {
    question: 'Will the 19th Edition consolidate the LCT chapters into a single Part?',
    answer:
...
export default function RenewableEnergyModule1Section2() {
  ...
  useSEO({
    title: 'The LCT chapter map in BS 7671:2018+A4:2026 | Renewable Energy 1.2 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 2 · BS 7671:2018+A4:2026"
        title="The LCT chapter map in BS 7671:2018+A4:2026"
        backTo="../renewable-energy-module-1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          How BS 7671 splits low-carbon technology across Sections 551, 712, 715, 722, 730, 753,
          Chapter 57 and Chapter 81 — how the chapters interlock on hybrid installs, and where the
          IET Codes of Practice slot in.
        </p>
        ...
        <Pullquote>
          The chapter map is the artefact of historical accretion, not architectural intent.
        </Pullquote>
        ...
        >
          <p>
            BS 7671 has absorbed low-carbon technology over the last fifteen years in distinct
            waves:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Section 551</strong> was already in the standard,
              originally written with diesel standby and small CHP in mind.
            </li>
            <li>
              <strong className="text-white">Section 712</strong> (solar PV) was added when
              grid-tied domestic PV became a mainstream technology.
            </li>
            <li>
              <strong className="text-white">Section 722</strong> (EV charging) was added when EV
              adoption began to scale.
            </li>
            <li>
              <strong className="text-white">Chapter 57</strong> (stationary batteries) was carved
              out in A4:2026 — content moved out of Section 826 and Section 551.8, which were both
              deleted.
            </li>
            <li>
              <strong className="text-white">Chapter 82</strong> (Prosumer\'s Electrical
              Installations) was added in A4:2026 — the new system-level chapter for installations
              with local production and / or storage of energy, treating hybrid LCT installs as
              coherent systems rather than collections of separate per-technology installs.
            </li>
            <li>
              <strong className="text-white">Chapter 81</strong> (energy efficiency) is the latest
              addition — A4:2026 deleted the old Appendix 17 and moved the subject into the body of
              the standard as Part 8-1.
            </li>
          </ul>
          <p>
            The 19th Edition (currently in IET / BSI joint committee, expected publication
            2028–2029) is widely expected to consolidate the LCT chapters into a clearer Part 7
            framework. The 18th Edition + A4 remains in force across the transition.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Section 551 is titled "Low voltage generating sets". In 2008 that meant diesel gensets
            and small CHP. In 2026 it means every grid-tied PV inverter, every grid-tied BESS, every
            V2G EV chargepoint.
          </p>
          <p>The A4:2026 changes to Section 551 are concentrated in two places:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">551.7.1 redrafted</strong> — indent (c) added:
              protective device where energy flow is bidirectional. Indent (d) added: source not to
              be connected to the load side of an RCD under certain conditions.
            </li>
            <li>
              <strong className="text-white">551.7.2 split into two regulations</strong> — 551.7.2.1
              requires the generating set on the supply side of all protective devices and
              explicitly treats stationary batteries (Chapter 57) as a generating set. 551.7.2.2
              covers LV switchgear requirements when the generating set is connected via switchgear.
            </li>
            <li>
              <strong className="text-white">Reg 551.8 deleted</strong> — content moved into the new
              Chapter 57. "See Chapter 57" replaces the old battery provisions.
            </li>
          </ul>
          <p>The trio 551.7.4 / 551.7.5 / 551.7.6 sets the DNO operational interface:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">551.7.4</strong> — automatic disconnection from the
              public supply on loss of supply or deviation of voltage / frequency (anti-islanding).
            </li>
            <li>
              <strong className="text-white">551.7.5</strong> — prevention of reconnection while the
              public supply remains absent.
            </li>
            <li>
              <strong className="text-white">551.7.6</strong> — means of isolation per national
              rules and DNO requirements.
            </li>
          </ul>
          <p>
            All three are typically discharged via the inverter\'s EREC G98 / G99 certification —
            the equipment evidence is the audit trail.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Section 712 (712.1 scope) covers the electrical installation of PV generators intended
            to supply all or part of an installation and to feed electricity into the public grid or
            local distribution. The chapter starts at the PV module or set of modules and extends
            through the DC string, the DC isolation, the inverter and the AC interface.
          </p>
          <p>Section 712 modifies the general Part 4 protective-measures toolkit:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">712.410.3.5 — Prohibited:</strong> obstacles and
              placing out of reach
            </li>
            <li>
              <strong className="text-white">712.410.3.6 — Prohibited:</strong>
              non-conducting location; earth-free local equipotential bonding; electrical separation
              for the supply of more than one item of current-using equipment
            </li>
            <li>
              <strong className="text-white">712.412 — Permitted:</strong> double or reinforced
              insulation (maps to Class II module construction)
            </li>
            <li>
              <strong className="text-white">712.431.102 — PV string protection</strong> — the
              specific protective device requirements for PV strings
            </li>
          </ul>
          <p>
            Commissioning evidence is typically BS EN 62446 IV-curve, insulation resistance and
            string-current testing. The IET Code of Practice for Grid-Connected Solar PV
            Installations builds on top of the BS 7671 framework.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            installations. The international parent is the BS EN 61851 family, which governs the EV
            supply equipment hardware, communication protocol and mode classifications.
          </p>
          <p>A4:2026 changes to Section 722 sit in two areas:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">
                722.411.4.1 — Reasonably practicable exception deleted.
              </strong>{' '}
              PEN-fault protective measures on PME-supplied chargepoints are now unconditional.
              (Covered in detail in Section 1.1.)
            </li>
            <li>
              <strong className="text-white">Prosumer reference added.</strong>
              Recognition that the chargepoint is no longer a one-way load when the customer has PV,
              a battery, and a V2G-capable vehicle.
            </li>
          </ul>
          <p>
            The prosumer addition does not radically restructure Section 722 itself. It changes how
            722 interlocks with the other LCT chapters. A chargepoint connected to a property with
            grid-tied PV (Section 712) and a BESS (Chapter 57) engages Section 551 for the
            bidirectional interface, and the V2G capability makes the chargepoint itself a
            generating set under 551.7.2.1.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Chapter 57 is the new chapter A4:2026 added to Part 5 (Selection and Erection of
            Equipment). The stated purpose is to provide requirements where the designed purpose of
            the battery installation is for storage and supply of electrical installations.
          </p>
          <p>Chapter 57 exclusions:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Pluggable UPS</strong> — governed by BS EN 62040
            </li>
            <li>
              <strong className="text-white">Fire and emergency lighting systems</strong> — governed
              by BS EN 50171, BS EN 60598-2-22, BS EN 50172
            </li>
            <li>
              <strong className="text-white">Central safety power supply systems</strong> — governed
              by BS EN 50171
            </li>
            <li>
              <strong className="text-white">
                Any battery in a product covered by a product safety standard
              </strong>
            </li>
          </ul>
          <p>
            The interplay with Section 551 is set by Reg 551.7.2.1 — a stationary battery under
            Chapter 57 is treated as a generating set under 551, not as a load. The bidirectional
            protective device, the supply-side installation, the automatic disconnection and the
            isolation requirements all apply to the BESS exactly as they apply to a PV inverter or a
            V2G charger.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong className="text-white">Section 715</strong> — Extra-low voltage lighting
            installations. Scope: ELV lighting supplied from a source with a maximum rated voltage
            of 50 V AC or 120 V DC (Reg 715.1). A4 made only minor changes. Becomes relevant on:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              Off-grid dwellings with 12 V or 24 V DC lighting drawn directly from the battery bank
            </li>
            <li>RV and marine LCT systems with DC distribution</li>
            <li>
              Certain garden / outbuilding installations running from a small dedicated battery
            </li>
          </ul>
          <p>
            <strong className="text-white">Section 730</strong> — Onshore units of electrical shore
            connections for inland navigation vessels. An entirely new section in A4. Scope: onshore
            installations dedicated to the supply of inland navigation vessels for commercial and
            administrative purposes, berthed in ports and berths. Sits alongside Section 729
            (marinas) but addresses a distinct case — commercial inland vessels rather than
            recreational marina berths. Niche but real for canal-and-river commercial LCT.
          </p>
          <p>
            <strong className="text-white">Section 753</strong> — Heating cables and embedded
            heating systems. Retitled and scope extended in A4. Now covers:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
          ...
          <p>
            Out of scope: industrial / commercial heating systems complying with BS EN 60519, BS EN
            62395 or BS EN 60079. For the LCT installer the practical implication is that a heat
            pump install paired with electric UFH engages Section 753.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Chapter 81 is the new energy efficiency chapter introduced in A4:2026, replacing the
            deleted Appendix 17. The scope is recommendations for the design and erection of
            installations, including those with local production and storage of energy, to optimise
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              Part 8 already exists in A4: Chapter 81 (energy efficiency) and Chapter 82
              (prosumer&apos;s LV installations)
            </li>
          </ul>
          <p>
            The implication for the LCT designer is that the cert workflow built today should
            accommodate the energy-efficiency design decisions that will become recordable on Part 6
            certs as the trajectory plays out. A4\'s Reg 133.1.3 equipment-usage recording change
            and Chapter 81 are part of the same direction.
          </p>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Chapter 82 — Prosumer\'s Electrical Installations (new in A4)
        </ContentEyebrow>
        ...
        >
          <p>
            ...
            installations designated as Prosumer\'s Electrical Installations, where local production
            and / or storage of energy is present. Compliance required where applicable.
          </p>
          <p>The stated objective of Chapter 82:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              Compatibility with current and future ways to deliver electrical energy to
              current-using equipment
            </li>
            <li>Supply from the public network OR from local sources (or both, in parallel)</li>
            <li>
              Coherent design, erection and verification of the install as a single system rather
              than separate per-technology installations
            </li>
          </ul>
          <p>How Chapter 82 interlocks with the per-technology chapters:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Per-technology chapters still apply</strong> — Section
              712 governs PV-side design, Section 722 governs EV-side design, Chapter 57 governs
              BESS-side design, Section 551 governs the generator-side interface
            </li>
            <li>
              <strong className="text-white">Chapter 82 adds the system layer</strong> — load
              management, export coordination, multi-source fault current contribution, multi-source
              protection coordination
            </li>
            <li>
              <strong className="text-white">Section 722 was updated in A4</strong> with an explicit
              reference to prosumer installations — making the EV-chargepoint design conversation
              cross-chapter on any property with local generation
            </li>
            <li>
              <strong className="text-white">Reg 826.1.4 addresses PEI overvoltages</strong> —
              transient overvoltages in PEIs may be more frequent / greater than in non-PEI
              installs; SPD installation should be considered
            </li>
          </ul>
          <p>
            The 19th Edition is expected to deepen Chapter 82\'s treatment. A4 introduced the
            framework; the consolidation in the next edition is expected to extend the PEI
            requirements alongside the broader Part 7 LCT consolidation.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">
                IET CoP for Grid-Connected Solar Photovoltaic Installations
              </strong>{' '}
              — complement to Section 712. Covers PV inspection, testing (linking to BS EN 62446),
              routine maintenance, periodic inspection. Currently in 5th edition.
            </li>
            <li>
              <strong className="text-white">IET CoP for Electrical Energy Storage Systems</strong>{' '}
              — complement to Chapter 57. Covers chemistry-aware design, siting and fire-detection
              arrangements, ventilation requirements, isolation philosophy, emergency response
              procedures. Currently in 5th edition.
            </li>
            <li>
              <strong className="text-white">
                IET CoP for Electric Vehicle Charging Equipment Installation
              </strong>{' '}
              — complement to Section 722. Covers the PEN-fault decision tree, load management
              approaches, commissioning steps. Currently in 5th edition.
            </li>
          </ul>
          <p>
            GN3 explicitly cross-references all three Codes. The faster revision cadence (compared
            to BS 7671\'s four-year amendment cycle) reflects how quickly LCT practice evolves.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              Consolidation of LCT chapters (551, 712, 715, 722, 730, 753, Chapter 57, Chapter 81)
              into a clearer Part 7 framework
            </li>
            <li>
              Chapter 81 built out further — A4:2026 already promoted energy efficiency out of
              Appendix 17 into Part 8
            </li>
          ...
          <p>
            For the installer working today, the practical advice is to learn the current chapter
            map well — the consolidation preserves technical content rather than invents new
            requirements. The cert workflow built for A4 is the same workflow the 19th Edition will
            expect.
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-1-section-1')}
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-1-section-3')}
