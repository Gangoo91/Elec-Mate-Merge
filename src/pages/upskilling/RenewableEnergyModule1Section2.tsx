...
const DESCRIPTION =
  'Understanding how Solar PV, Wind, Hydro, and Biomass technologies work, their applications, and comparative strengths.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Modern commercial solar panels achieve 15-22% efficiency, with UK capacity factors of 15-25% depending on location and orientation.',
  },
  {
    id: 'wind-power',
    ...
    correctIndex: 2,
    explanation:
      'Wind power is proportional to wind speed cubed (P proportional to V cubed), meaning doubling wind speed increases power output eightfold.',
  },
  {
    id: 'hydro-efficiency',
    question: 'What efficiency can hydroelectric systems achieve?',
    options: ['30-50%', '50-70%', 'Over 90%', 'Around 80%'],
    correctIndex: 2,
    explanation:
      'Hydroelectric systems can achieve over 90% efficiency, making them one of the most efficient forms of electricity generation available.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Solar PV cells use the photovoltaic effect where photons knock electrons loose from atoms in semiconductor materials, creating electric current.',
  },
  {
    id: 2,
    question: 'What is a typical capacity factor for UK offshore wind farms?',
    options: ['15-20%', '25-35%', '45-55%', '70-80%'],
    correctAnswer: 2,
    explanation:
      'UK offshore wind farms typically achieve 45-55% capacity factors due to stronger and more consistent winds compared to onshore locations.',
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'Cut-in speed is the minimum wind speed (typically 3-4 m/s) at which a wind turbine begins generating electricity.',
  },
  {
    id: 4,
    ...
    correctAnswer: 3,
    explanation:
      'Hydroelectric plants have very long lifespans of 50-100 years, making them one of the most durable renewable energy technologies.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      "Biomass is considered carbon neutral because the CO2 released during combustion was recently absorbed from the atmosphere during the plants' growth cycle.",
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Pumped storage uses excess electricity to pump water uphill, then releases it to generate power when needed, providing energy storage and grid balancing services.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'Thin-film panels offer flexibility, lower temperature coefficients, and better performance in diffuse light and high-temperature conditions.',
  },
  {
    id: 8,
    question: "What is the UK's installed wind capacity (2023)?",
    options: ['About 10GW', 'About 28.8GW', 'About 50GW', 'About 100GW'],
    correctAnswer: 1,
    explanation:
      "The UK had approximately 28.8GW of installed wind capacity in 2023, making it one of the world's leading wind energy producers.",
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Anaerobic digestion breaks down organic materials without oxygen to produce biogas, which can be used for electricity generation or heating.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Wind tends to be stronger at night and in winter when solar output is lower, meaning combined systems can provide more consistent generation.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Solar PV is typically most suitable for homes due to its scalability, modularity, and ease of rooftop installation. Heat pumps can also be excellent for heating and hot water. The choice depends on property orientation, roof space, energy usage, and local planning.',
  },
  {
    question: 'How efficient are solar panels in the UK?',
    answer:
      'Modern solar panels achieve 15-22% efficiency, with UK capacity factors of 15-25%. Despite less sunshine than sunnier countries, solar is economically viable, generating about 1,000kWh per year per kW installed in southern England.',
  },
  {
    question: 'Why is offshore wind more expensive than onshore?',
    answer:
      'Offshore wind requires specialised vessels, subsea cables, and offshore substations. However, offshore winds are stronger and more consistent, leading to higher capacity factors (45-55% vs 25-35% onshore) that offset additional costs.',
  },
  {
    question: 'Is biomass really renewable if it produces CO2?',
    answer:
      'Biomass is considered renewable because the CO2 released was recently absorbed during plant growth, creating a short carbon cycle. However, this assumes sustainable sourcing - if from deforestation, it may not provide net climate benefits.',
  },
  {
    question: 'How long do renewable energy systems last?',
    answer:
      'Lifespans vary: solar panels 25-30 years, wind turbines 20-25 years, small hydro 50+ years, and large hydro 50-100+ years. Long lifespans and minimal fuel costs often make renewables cheaper over their lifetime.',
  },
  {
    question: 'Can renewables really replace all fossil fuel generation?',
    answer:
      'Studies suggest renewables could provide 80-100% of electricity needs with the right mix of technologies, storage, grid flexibility, and demand management. Key challenges are seasonal storage and ensuring adequate grid services.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Solar PV:</strong> 15-22% efficiency, highly scalable
              </li>
              <li>
                <strong>Wind:</strong> Power proportional to wind speed cubed
              </li>
              <li>
                <strong>Hydro:</strong> &gt;90% efficiency, 50-100 year lifespan
              </li>
              <li>
                <strong>Biomass:</strong> Dispatchable, uses organic materials
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Rooftop panels, wind farms, reservoirs
              </li>
              <li>
                <strong>Use:</strong> Technology selection for specific sites
              </li>
              <li>
                <strong>Apply:</strong> Understanding trade-offs for project planning
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Solar photovoltaic (PV) systems convert sunlight directly into electricity using the
              photovoltaic effect, where photons knock electrons loose from atoms in semiconductor
              materials.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Capacity Factor:</strong> 15-25% (UK average)
                </li>
                <li>
                  <strong>Module Efficiency:</strong> 15-22% (commercial panels)
                </li>
                <li>
                  <strong>System Lifespan:</strong> 25-30 years with warranty
                </li>
                <li>
                  <strong>Annual Degradation:</strong> 0.5-0.8% per year
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Wind turbines harness kinetic energy from moving air, converting it to rotational
              mechanical energy, then to electricity through generators.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              ...
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Cut-in:</strong> 3-4 m/s minimum for generation
                  </li>
                  <li>
                    <strong>Rated:</strong> 12-15 m/s for maximum output
                  </li>
                  <li>
                    <strong>Cut-out:</strong> 25 m/s for safety shutdown
                  </li>
                  <li>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Installed Capacity:</strong> 28.8GW (2023)
                </li>
                <li>
                  <strong>Capacity Factor:</strong> 25-35% onshore, 45-55% offshore
                </li>
                <li>
                  <strong>Best UK Regions:</strong> Scotland, Wales, SW England
                </li>
                <li>
                  <strong>Offshore Potential:</strong> World's largest offshore market
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Hydroelectric systems convert the potential and kinetic energy of flowing water into
              electricity, providing one of the most reliable and efficient renewable energy
              sources.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Large scale:</strong> Dams with reservoirs (&gt;30MW)
                  </li>
                  <li>
                    <strong>Small scale:</strong> Run-of-river systems (&lt;30MW)
                  </li>
                  <li>
                    <strong>Micro hydro:</strong> Very small installations (&lt;100kW)
                  </li>
                  <li>
                    <strong>Pumped storage:</strong> Energy storage and generation
                  </li>
                </ul>
              </div>
              <div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Total Capacity:</strong> ~1.9GW (large scale) + ~500MW small scale
                </li>
                <li>
                  <strong>Pumped Storage:</strong> 2.8GW (Dinorwig, Ffestiniog)
                </li>
                <li>
                  <strong>Best Regions:</strong> Scotland, Wales, Northern England
                </li>
                <li>
                  <strong>Annual Generation:</strong> ~2% of UK electricity
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Biomass energy systems burn organic materials to produce heat and electricity,
              offering a renewable alternative that provides controllable, dispatchable power.
            </p>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50 my-6">
              ...
              <p className="text-white text-sm">
                Biomass is considered renewable because CO2 released during combustion was recently
                absorbed during plant growth, creating a short carbon cycle. Sustainability depends
                on responsible sourcing practices.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Ignoring site conditions</strong> - resource assessment is critical
                </li>
                <li>
                  <strong>Oversizing systems</strong> - match capacity to actual demand
                </li>
                <li>
                  <strong>Forgetting maintenance</strong> - all systems need regular care
                </li>
                <li>
                  <strong>Underestimating costs</strong> - include grid connection and commissioning
                </li>
              </ul>
            </div>
          </div>
