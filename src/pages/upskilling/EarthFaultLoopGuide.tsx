            ...
            <CardContent className="space-y-8">
              ...
              <div className="bg-transparent/80 p-6 rounded-lg border-l-4 border-elec-yellow">
                <h3 className="text-white text-xl font-semibold mb-4 flex items-center gap-3">
                  <span className="bg-elec-yellow text-white w-10 h-10 rounded-full flex items-center justify-center font-bold">
                    1
                  </span>
                  ...
                  <div className="bg-red-600/20 p-4 rounded-lg border border-red-600/30">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h4 className="text-red-400 font-semibold">
                        SAFETY FIRST - This is LIVE Testing
                      </h4>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-transparent p-4 rounded-lg">
                        <div className="flex items-center gap-3 mb-2">
                          <span className="bg-elec-yellow text-white w-6 h-6 rounded-full flex items-center justify-center text-sm font-bold">
                            1
                          </span>
                      ...
                      <div className="bg-transparent p-4 rounded-lg">
                        ...
                        <ul className="text-white text-sm space-y-1 ml-9">
                          ...
                          <li>
                            • Connect LINE test lead to incoming LIVE terminal (before main switch)
                          </li>
              ...
              <div className="bg-transparent/80 p-6 rounded-lg border-l-4 border-green-500">
                <h3 className="text-white text-xl font-semibold mb-4 flex items-center gap-3">
                  <span className="bg-green-600 text-white w-10 h-10 rounded-full flex items-center justify-center font-bold">
                    2
                  </span>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-elec-yellow/20 p-4 rounded-lg border border-elec-yellow/30">
                    ...
                    <p className="text-yellow-200 text-sm">
                      If circuit has RCD protection, you MUST use "no-trip" test mode or the RCD
                      will trip during testing. Set your meter to "Zs no-trip" or "Low current"
                      mode.
                    </p>
                  </div>
                  ...
                  <div>
                    <h4 className="text-green-400 font-semibold mb-3">
                      Testing at Socket Outlets - Step by Step:
                    </h4>
                    <div className="space-y-4">
                      <div className="bg-transparent p-4 rounded-lg">
                        <div className="flex items-center gap-3 mb-2">
                      ...
                      <div className="bg-transparent p-4 rounded-lg">
                        ...
                        <ul className="text-white text-sm space-y-1 ml-9">
                          ...
                          <li>
                            • Insert EARTH test probe into TOP slot of socket (Earth terminal)
                          </li>
                      ...
                      <div className="bg-transparent p-4 rounded-lg">
                        ...
                        <ul className="text-white text-sm space-y-1 ml-9">
                          ...
                          <li>
                            • Record all readings - document which socket gave highest reading
                          </li>
                    ...
                    <div className="space-y-2">
                      <div>
                        ...
                        <p className="text-white text-sm">
                          Switch to "no-trip" mode or calculate Zs = Ze + (R1+R2)
                        </p>
                      </div>
                      <div>
                        <p className="text-red-300 font-medium text-sm">Very High Reading:</p>
                        <p className="text-white text-sm">
                          Check test lead connections, verify you're in correct socket terminals
                        </p>
                      </div>
                      <div>
                        <p className="text-red-300 font-medium text-sm">Infinite Reading:</p>
                        <p className="text-white text-sm">
                          No earth connection present - STOP and investigate immediately
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="bg-purple-600/20 p-4 rounded border-l-4 border-purple-400">
                    <p className="text-purple-200 text-sm">
                      <strong>When to Use:</strong> When direct measurement trips RCDs, for
                      verification, or when circuits can't be energised safely.
                    </p>
                  </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-white text-sm">
                            From your external loop test (Step 1 above)
                          </p>
                  ...
                  <div className="bg-elec-yellow/20 p-3 rounded border-l-4 border-elec-yellow">
                    <p className="text-yellow-200 text-sm">
                      <strong>Important:</strong> Calculated values are often slightly higher than
                      measured values. Both methods are acceptable for BS 7671 compliance.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <Card className="bg-transparent border-transparent">
            ...
            <CardContent>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg p-4 mt-6">
                ...
                <p className="text-white text-sm">
                  If you're not 100% confident about any aspect of these tests, seek guidance from a
                  qualified supervisor. These are live electrical tests that require proper training
            ...
            <CardContent className="space-y-4">
              <div className="bg-elec-yellow/20 p-4 rounded-lg border border-blue-600/30">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="text-elec-yellow font-semibold">
                    Where to Find Maximum Zs Values in BS 7671
                  </h4>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="text-blue-200 text-sm space-y-1">
                      <li>
                        • <strong>Table 41.2:</strong> Maximum earth fault loop impedance (Zs) for
                        0.4s disconnection
                      </li>
                      <li>
                        • <strong>Table 41.3:</strong> Maximum earth fault loop impedance (Zs) for
                        5s disconnection
                      </li>
                      <li>
                        • <strong>Table 41.4:</strong> Maximum earth fault loop impedance for RCD
                        protection
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="text-blue-200 text-sm space-y-1">
                      <li>
                        • <strong>Section 411:</strong> Protective measures (ADS)
                      </li>
                      <li>
                        • <strong>Section 643:</strong> Initial verification
                      </li>
                      <li>
                        • <strong>Section 654:</strong> Periodic inspection
                      </li>
                      <li>
                ...
                <div className="bg-elec-yellow/20 p-3 rounded mt-3">
                  <p className="text-yellow-200 text-sm">
                    <strong>Important:</strong> Always use the current edition of BS
                    7671:2018+A3:2024. Values may change between editions.
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-transparent/80 p-4 rounded-lg">
                  ...
                  <p className="text-white text-sm mb-2">
                    Impedance of the supply system before your installation
                  </p>
                ...
                <div className="bg-transparent/80 p-4 rounded-lg">
                  ...
                  <p className="text-white text-sm mb-2">
                    Complete earth fault loop path impedance
                  </p>
                ...
                <div className="bg-transparent/80 p-4 rounded-lg">
                  <div className="flex items-center gap-3 mb-2">
                    <Badge className="bg-purple-600/40 text-purple-300 border-0 font-mono">
                      R1+R2
                    </Badge>
                  </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-orange-600/20 p-4 rounded-lg border border-orange-600/30">
                ...
                <p className="text-orange-200 text-sm">
                  Your measured Zs must be LESS than these values for safe operation. If higher, the
                  protective device may not operate quickly enough during an earth fault.
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-transparent/80 p-4 rounded-lg">
                  ...
                  <p className="text-white text-sm">
                    Ensures protective devices will operate quickly enough to prevent dangerous
                    touch voltages
                  </p>
                </div>
                ...
                <div className="bg-transparent/80 p-4 rounded-lg">
                  ...
                  <p className="text-white text-sm">
                    BS 7671 requires earth fault loop impedance to be measured and recorded
                  </p>
                </div>
                ...
                <div className="bg-transparent/80 p-4 rounded-lg">
                  ...
                  <p className="text-white text-sm">
                    Verifies that Zs values allow protective devices to operate within required
                    times
                  </p>
                </div>
                ...
                <div className="bg-transparent/80 p-4 rounded-lg">
                  ...
                  <p className="text-white text-sm">
                    Confirms the earth fault path is effective and has adequate capacity
                  </p>
                </div>
              </div>
              ...
              <div className="bg-red-600/20 p-4 rounded-lg border border-red-600/30">
                ...
                <p className="text-red-200 text-sm">
                  If Zs is too high, protective devices won't operate fast enough during earth
                  faults, potentially causing dangerous touch voltages that could be fatal.
                </p>
              </div>
            </CardContent>
          </Card>
