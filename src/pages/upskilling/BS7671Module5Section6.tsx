    ...
    <HubPage>
      ...
      <HubBody>
        <div className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'Selecting equipment and wiring systems for the environment. IP ratings (BS EN 60529), IK ratings (BS EN 50102), bathroom zoning, fire-resistant cables for safety services, fire stopping at compartmentation, and outdoor / harsh-environment enclosures.'
          }
        </div>
        ...
        >
          <p>
            ...
            <strong> 0</strong> none, <strong>1</strong> vertical drips, <strong>2</strong> drips at
            up to 15 degrees, <strong>3</strong> spraying water at up to 60 degrees,{' '}
            <strong>4</strong> splashing from any direction, <strong>5</strong> water jets,{' '}
            <strong>6</strong> powerful water jets, <strong>7</strong> temporary immersion (up to 1
            m for up to 30 minutes), <strong>8</strong> continuous submersion (depth and duration
            declared by the manufacturer), <strong>9</strong> high-pressure / high-temperature water
            jets (used in food and dairy washdown environments).
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            IP69K. Submersible fittings (pond pumps, swimming-pool fixtures) need IP68 to the depth
            and duration declared. Always cross-check the manufacturer's IP claim against the BS EN
            60529 test routine — some lower-end products quote IP ratings without independent
            certification.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            J, <strong>IK02</strong> 0.2 J, <strong>IK03</strong> 0.35 J, <strong>IK04</strong> 0.5
            J, <strong>IK05</strong> 0.7 J, <strong>IK06</strong> 1 J, <strong>IK07</strong> 2 J,{' '}
            <strong>IK08</strong> 5 J, <strong>IK09</strong> 10 J, <strong>IK10</strong> 20 J. The
            test is a defined hammer (mass, head shape) dropped from a defined height, delivered to
            the most vulnerable face of the enclosure. Some specifications now refer to non-standard
            IK11 (50 J) for car-park and external-pillar use — that grade is not part of the
            published standard.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Zone 0 is the interior of the bath, basin or shower tray — water everywhere, hence IPX7
            (immersion). Zone 1 is the volume bounded by the upper edge of zone 0 and the horizontal
            plane 2.25 m above the floor (or, where the showerhead is fixed higher than 2.25 m, by
            the showerhead's height). Zone 2 is the volume bounded by zone 1's outer surface and a
            parallel surface 0.6 m horizontally outward — also up to 2.25 m. Equipment in zones 1
            and 2 needs IPX4 minimum; where water jets are used for cleaning, IPX5. Outside the
            zones, normal indoor IP applies but Section 701 still demands 30 mA RCD additional
            protection on every circuit serving the location.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            The integrity class is declared by the cable manufacturer to BS EN 50200 (small cables)
            or BS 8434 / BS 8491 (larger sizes). FP200 (Prysmian, mineral fire-resistant insulation)
            covers small power and signal applications; FP400 has a more robust LSZH outer sheath;
            MICC (mineral-insulated copper-clad) is the heritage solution still used on the most
            demanding fire-fighter and life-safety circuits.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            hydrochloric acid in moist airways, eyes and mucous membranes. In a confined evacuation
            route — Tube station, tunnel, ship's corridor, hospital ward — that gas cloud blocks
            escape and damages equipment. LSZH (also written LS0H) cables use halogen-free polymers
            (typically thermosetting EVA or polyolefin compounds) that produce minimal smoke and no
            halogen acid gas in fire. They cost more, are stiffer and have lower flexibility — but
            on the right job, they're not optional.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 527.2 reads:{' '}
            <em>
              Where a wiring system passes through elements of building construction such as floors,
              walls, roofs, ceilings, partitions or cavity barriers, the openings remaining after
              passage of the wiring system shall be sealed according to the degree of fire
              resistance prescribed for the respective element of building construction.
            </em>{' '}
            ...
            cable transit boxes (Roxtec). The seal must be tested to BS EN 1366-3 / BS 476-20 to the
            same fire-resistance time as the element penetrated.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            valves, internal heaters where required by Reg 522.3 / 522.4 and equipment manufacturer
            guidance).
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            UK domestic refurbishment: IP20 indoor, IP44 outdoor under cover, IP55+ outdoor exposed,
            IPX4 in bathroom zones 1-2, IPX7 in zone 0. For commercial: same indoor logic, IK08-IK10
            on accessible boards, fire-resistant cable on every safety service, fire stopping at
            every compartmentation penetration. Document the AD / AE / AG codes against the location
            on the design log — that's the audit trail Reg 522.1 expects.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <strong>1. Safety service requirement.</strong> BS 5266-1 specifies maintained emergency
            lighting on the escape route with 60-minute autonomy and PH 30 minimum cable integrity
            (some commercial occupancies require PH 60 — check the fire strategy).{' '}
            <strong>2. Cable selection.</strong> FP200 Gold (Prysmian) or equivalent to BS EN 50200
            PH 30 — 1.5 mm² for the lighting circuit, sized against Ib and Iz per Appendix 4.{' '}
            <strong>3. Support specification.</strong> Steel cable cleats / clips every 300 mm
            horizontal, 400 mm vertical (Reg 522.8) — NOT plastic cable ties; they melt in fire and
            the cable falls in the early stages, defeating the integrity class.{' '}
            ...
            run. <strong>5. Compartment penetrations.</strong> Identify each fire-rated wall / floor
            crossing on the drawing; specify the firestop product (e.g. Hilti CP 658 firestop collar
            around plastic conduit, mineral wool batt around cable tray openings); book a certified
            installer; photograph each seal with a labelled ticket. <strong>6. Termination.</strong>{' '}
            Brass / stainless glands rated for the cable type, with proper torque per manufacturer;
            gland-plate IP rating matched to the luminaire's environmental rating.{' '}
            <strong>7. Testing.</strong> Continuity, IR (segregated from main lighting on the IR
            test), polarity, Zs, RCD operation; plus the BS 5266 commissioning test of full 3-hour
            discharge with photometric verification at completion. <strong>8. Cert entries.</strong>{' '}
            EIC schedule of test results: cable type FP200 Gold, integrity PH 30, all penetrations
            sealed and recorded, supplementary photographic record of firestopping installations,
            commissioning certificate per BS 5266-1.
          </p>
        </ConceptBlock>
