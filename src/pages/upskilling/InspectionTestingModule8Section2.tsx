    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reg 514 in full: circuit identification, the four prescribed notices (periodic, RCD,
          bonding, SPD), conductor identification, and the A4:2026 model-form changes — including
          the new ‘consumer’s means of isolation’ wording and Reg 514.16.1 SPD notice.
        </p>
        ...
        >
          ...
          <p>
            The &ldquo;no possibility of confusion&rdquo; gate is real but narrow. A single isolator
            immediately adjacent to a single piece of equipment, where there is no other isolator
            within sight, can sit unlabelled. A consumer unit with twelve protective devices cannot
            — every MCB, every RCBO, every isolator gets a description of what it controls.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              identification shall be provided to indicate the purpose of each item of switchgear
              ...
              applicable, with BS EN 60073 and BS EN 60447, shall be fixed in a position visible to
              the operator.
            </>
          }
        ...
        >
          <p>
            The prescribed wording is in the regulation itself. The notice tells the next person who
            opens the cupboard when the installation was last verified and when it is due again. On
            a new EIC, the &ldquo;date of last inspection&rdquo; is today; on an EICR, it is the
            EICR date. The next-inspection date is the designer / inspector’s recommendation in
            Section D of the certificate.
          </p>
          <p>
            ...
            verification, or an Electrical Installation Condition Report, complete with the Guidance
            for Recipients as detailed in Appendix 6, has been issued to the person ordering the
            work. The exception is conditional on issuing both the certificate AND the complete
            Guidance for Recipients — not one or the other.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              on its condition obtained, as prescribed in BS 7671 Requirements for Electrical
              Installations. Date of last inspection ............. Recommended date of next
              inspection .............
            </>
          }
        ...
        >
          ...
          <RegsCallout
            ...
            clause={
              <>
                ...
                relevant test button(s) which should operate the device. Afterwards, manually switch
                on the device. If the device does not operate, or indicates a fault, seek expert
                advice.
              </>
            }
          ...
          <p>
            ...
            domestic (household) premises where certification for initial verification, or an EICR,
            complete with the Guidance for Recipients as detailed in Appendix 6, has been issued to
            the person ordering the work. As before, the exception is conditional on the complete
            documentation being issued — and the test instruction itself is included in that
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>(c)</strong> the main earthing terminal, where separate from main switchgear.
            </li>
          </ul>
          <p>
            The &ldquo;may be provided on the clamp&rdquo; provision is the practical concession: BS
            951 clamps are typically supplied with the warning label embossed on or attached to the
            clamp. That counts as compliance with 514.13.1 for that location, provided the label is
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              Connection — Do Not Remove&rsquo; shall be securely fixed in a visible position at or
              near: (a) the point of connection of every earthing conductor to an earth electrode;
              and (b) the point of connection of every bonding conductor to an
        ...
        >
          ...
          <RegsCallout
            ...
            clause={
              <>
                The presence of SPDs in an installation shall be indicated by an information notice
                at or near the relevant distribution board(s). The requirements of this regulation
                need not be applied for domestic (household) premises or similar installations where
                the information is recorded on the appropriate certification for initial
                verification, or an Electrical Installation Condition Report, complete with the
                guidance for recipients as detailed in Appendix 6, and issued to the person ordering
                the work.
              </>
            }
          ...
          />
          <p>
            A4:2026 also expects the <strong>SPD type per board</strong> to be identifiable — Type 1
            (high-energy lightning current at the origin), Type 2 (overvoltage at distribution
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="410" y="455" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              at every earthing-electrode connection, every bonding-to-extraneous connection, and at
              the MET if separate from switchgear.
            </text>
          </svg>
        </div>
          ...
          whatToDo={
            <>
              <span className="block">
                1. Update the circuit chart inside the door (Reg 514.9.1) to add way 7 — EV charger
                — protective device rating, type, RCD type. Domestic exception: also record on the
                Minor Works Certificate with Appendix 6 Guidance for Recipients.
              </span>
              <span className="block">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>
                (d) Any circuit or equipment vulnerable to the electrical tests as required by Part
                6
              </strong>{' '}
          ...
          <p>
            ...
            circuit chart inside the consumer-unit door is). The A4:2026 domestic exception relieves
            the duty to fix the chart on the board only where the certificate / EICR with full
            Guidance for Recipients has been issued.
          </p>
          <p>
            ...
            where appropriate, BS EN 81346-1.&rdquo; In practice that means using IEC 60617 symbols
            on diagrams and following standard naming for circuit references.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>514.4.2 — Protective conductor — green-and-yellow, exclusively</strong>. Each
              colour shall cover at least 30 % and at most 70 % of the surface. Single-core cables
              with green-and-yellow throughout shall only be used as protective conductors and shall
              not be overmarked at terminations except as permitted by 514.4.3.
            </li>
            <li>
              <strong>514.4.3 — PEN conductor</strong> — when insulated, marked either (a)
              green-and-yellow throughout with blue markings at terminations, or (b) blue throughout
              with green-and-yellow markings at terminations. The choice depends on whether the
              conductor is primarily protective (option a) or primarily neutral (option b).
            </li>
            <li>
              <strong>514.4.4 — Other conductors per Table 51</strong> — line of single-phase
              circuit (brown), L1/L2/L3 of three-phase (brown / black / grey), DC circuits, control
              circuits etc. all per the table.
            </li>
            <li>
              <strong>514.4.5 — single colour green forbidden</strong> for live conductors in power
              circuits, protective conductors, and functional earthing/bonding conductors.
            </li>
          </ul>
          <p>
            ...
            the change-over point inside the joint box gets sleeving on every conductor, identifying
            which old core is which new function.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              and at most 70 % of the surface being coloured, while the other colour shall cover the
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Circuit chart present and current (Reg 514.9.1)</strong> — the inside-of-door
              schedule matches the as-installed circuits.
            </li>
            <li>
              <strong>Periodic inspection notice present (Reg 514.12.1)</strong> — fixed at or near
              the board, with date fields completed.
            </li>
            <li>
          ...
          <p>
            ...
            creates a real safety risk (e.g. unidentified circuits in a board that has also lost RCD
            protection), which can elevate to C2.
          </p>
        </ConceptBlock>
