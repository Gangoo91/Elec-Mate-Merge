...
const DESCRIPTION =
  'Learn strategies for planning fibre network upgrades, capacity assessment, technology migration paths, and expansion planning for growing bandwidth demands.';

const quickCheckQuestions = [
  {
    question:
      'What is the primary advantage of upgrading transceivers rather than replacing fibre infrastructure?',
    options: [
      { text: 'Transceivers are always more reliable', isCorrect: false },
      {
        text: 'Lower cost and less disruption—existing fibre can often support higher speeds',
        isCorrect: true,
      },
    ...
    explanation:
      'Fibre infrastructure typically has capacity headroom. Upgrading to faster transceivers (10G to 25G, for example) on existing fibre is far less expensive and disruptive than replacing cabling, provided the fibre type and loss budget support the new speed.',
  },
  {
    question:
      'Why is OM4 or OM5 multimode fibre preferred over OM3 for future-proofed installations?',
    options: [
      { text: 'OM4/OM5 cables are more flexible', isCorrect: false },
      {
        text: 'OM4/OM5 has higher bandwidth enabling longer distances at higher data rates',
        isCorrect: true,
      },
    ...
    explanation:
      'OM4 has higher modal bandwidth (4700 MHz·km vs 2000 MHz·km for OM3 at 850nm), supporting higher speeds over longer distances. OM5 adds wideband capability for SWDM, enabling 40G/100G over duplex fibres.',
  },
  {
    question:
      'When expanding a fibre network, what should be verified about existing infrastructure first?',
    options: [
      { text: 'Only the number of spare fibres', isCorrect: false },
      {
        text: 'Spare fibre count, fibre type, current loss, and pathway capacity',
        isCorrect: true,
      },
    ...
    explanation:
      'A proper capacity assessment examines: available spare fibres, fibre type (SM/MM grade), current loss measurements to verify condition, and pathway capacity for additional cables if needed.',
  },
];
...
const quizQuestions = [
  {
    question:
      'What is SWDM (Shortwave Wavelength Division Multiplexing) and why is it significant for upgrades?',
    options: [
    ...
    explanation:
      'SWDM uses multiple wavelengths (850-953nm) over a single fibre pair, enabling 40G or 100G over duplex OM5 fibre instead of requiring 8 or more fibres with parallel optics. This effectively quadruples fibre capacity.',
  },
  {
    ...
    options: [
      ...
      {
        text: 'When future speed requirements exceed multimode distance limits or for maximum flexibility',
        isCorrect: true,
      },
    ...
    explanation:
      'Singlemode should be considered when: multimode distance limits are insufficient for required speeds, maximum bandwidth flexibility is needed, or when lifecycle cost analysis favours singlemode despite higher transceiver costs.',
  },
  {
    ...
    explanation:
      'Spare (dark) fibres installed during initial construction add minimal cost but provide valuable expansion capacity. Re-pulling new cables later is far more expensive than installing extra fibres initially.',
  },
  {
    question:
      'What factor most often limits the ability to upgrade from 10G to 40G on existing multimode fibre?',
    options: [
    ...
    explanation:
      'Modal bandwidth determines how far multimode can support high data rates. OM3 supports 10G to 300m but only 100m for 40G parallel optics. If existing links exceed these limits, upgrade options are constrained.',
  },
  {
    ...
    options: [
      ...
      {
        text: 'Upgrading in stages, prioritising critical links while maintaining service',
        isCorrect: true,
      },
    ...
    explanation:
      'Phased migration upgrades critical links first while maintaining overall service, spreads cost over time, allows learning from early phases, and minimises risk of widespread outages from unforeseen problems.',
  },
  {
    ...
    explanation:
      'Each splice adds loss (typically 0.1 dB for fusion). Before adding splices, verify the existing link has sufficient loss budget margin to accommodate the additional loss while still meeting application requirements.',
  },
  {
    question:
      'Why might wavelength division multiplexing (WDM) be preferred over adding more fibre pairs?',
    options: [
      { text: 'WDM equipment is always cheaper', isCorrect: false },
      {
        text: 'WDM allows capacity increase on existing fibres without pulling new cables',
        isCorrect: true,
      },
    ...
    explanation:
      'WDM multiplies capacity on existing fibres by transmitting multiple wavelengths simultaneously. When pathway capacity is limited or re-cabling is expensive/disruptive, WDM can be more cost-effective than new fibre installation.',
  },
  {
    ...
    options: [
      ...
      {
        text: 'As-built drawings, test results, fibre assignments, and capacity inventory',
        isCorrect: true,
      },
    ...
    explanation:
      "Effective upgrade planning requires: as-built drawings (current infrastructure), original test results (baseline), current fibre assignments (what's in use), and capacity inventory (spare fibres, pathway space).",
  },
  {
    question:
      'When evaluating a fibre plant for higher-speed operation, what test is most important?',
    options: [
      { text: 'Continuity test only', isCorrect: false },
      {
        text: 'Full OTDR characterisation to verify loss and identify potential issues',
        isCorrect: true,
      },
    ...
    explanation:
      'OTDR testing reveals the current condition of each fibre—total loss, individual event losses, potential problem areas. This data determines if existing fibres can support higher-speed applications within their tighter loss budgets.',
  },
  {
    ...
    options: [
      ...
      {
        text: 'They enable full duplex on a single fibre strand, doubling effective capacity',
        isCorrect: true,
      },
    ...
    explanation:
      'BiDi transceivers use WDM to transmit and receive on different wavelengths over a single fibre strand. This allows duplex communication on one fibre instead of two, effectively doubling available fibre capacity.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Consider upgrading when: applications consistently need more bandwidth than available, equipment is end-of-life or unsupported, multiple links are at or near capacity, or technology changes make upgrades cost-effective. If problems are intermittent or isolated, troubleshooting is usually appropriate first.',
  },
  {
    question: 'Can I mix different fibre types (OM3/OM4) in the same link?',
    answer:
      'Yes, but the link will perform to the limitations of the lowest-grade fibre. An OM3/OM4 mixed link functions as OM3. Also ensure proper splicing procedures are used—mismatched core diameters between old OM1/OM2 and newer OM3/OM4 cause significant loss.',
  },
  {
    question: 'Is it worth upgrading from multimode to singlemode?',
    answer:
      "Replacing multimode with singlemode is expensive (new cables, new transceivers, new test equipment). It's justified when: multimode can't meet distance/speed requirements, long-term bandwidth needs significantly exceed multimode capability, or overall lifecycle cost analysis supports it.",
  },
  {
    question: 'How far in advance should upgrade planning begin?',
    answer:
      'Start planning 12-24 months ahead for significant upgrades. This allows time for: capacity assessment, budget approval, design development, procurement, scheduling installation windows, and coordination with affected users. Rushed upgrades often result in poor outcomes.',
  },
  {
    question: "What's the most cost-effective way to increase backbone capacity?",
    answer:
      'In order of typical cost-effectiveness: 1) Upgrade transceivers if fibre supports it, 2) Use WDM on existing fibres, 3) Light up spare dark fibres, 4) Add new cables to existing pathways, 5) Install new pathways and cables. Always start with option 1 and move down only if needed.',
  },
  {
    question: 'How do I handle upgrade projects that span multiple buildings or sites?',
    answer:
      'Break the project into phases, typically by building or functional area. Establish clear dependencies and milestones. Ensure each phase can stand alone if subsequent phases are delayed. Document lessons learned from early phases to improve later ones.',
  },
];
          ...
          <section className="mb-12">
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 p-4 rounded-r-lg mb-6">
              ...
              <p className="text-white text-sm">
                ...
                Often, existing fibre has significant untapped capacity—upgrading electronics is far
                cheaper than re-cabling.
              </p>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="bg-[#252525] rounded-lg p-5 border border-white/10 mb-6">
              ...
              <div className="space-y-3">
                ...
                <div className="text-white text-sm">
                  ...
                  <p className="mt-1">
                    <strong className="text-white">10G → 25G:</strong> Similar distance limits to
                    10G on OM3/OM4—often feasible
                  </p>
                  <p className="mt-1">
                    <strong className="text-white">25G → 40/100G:</strong> Requires parallel optics
                    (8+ fibres) or SWDM on OM5
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#252525] rounded-lg p-5 border border-white/10 mb-6">
              ...
              <div className="space-y-3">
                ...
                <div className="text-white text-sm">
                  ...
                  <p className="mt-1">
                    <strong className="text-white">Distance typically not limiting:</strong> Loss
                    budget usually the constraint, not bandwidth
                  </p>
                  <p className="mt-1">
                    <strong className="text-white">WDM options:</strong> CWDM/DWDM can multiply
                    capacity without adding fibres
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#252525] rounded-lg p-5 border border-white/10 mb-6">
              <h4 className="font-semibold text-white mb-4">
                Distance Constraints by Speed (Multimode @ 850nm)
              </h4>
          ...
          <section className="mb-12">
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4 mb-6">
              ...
              <ul className="text-white text-sm space-y-1">
                ...
                <li>
                  • <strong className="text-white">Schedule during low-usage periods</strong>
                  —nights, weekends, maintenance windows
                </li>
                <li>
                  • <strong className="text-white">Test before going live</strong>—full OTDR and
                  power meter testing of upgraded links
                </li>
                <li>
                  • <strong className="text-white">Have contingency plans</strong>—what if the
                  upgrade doesn't work as expected?
                </li>
              </ul>
            </div>
          </section>
