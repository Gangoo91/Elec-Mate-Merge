...
const DESCRIPTION =
  'Learn detailed techniques for verifying polarity on single-phase circuits including sockets, lighting, and switches in domestic and commercial installations.';

const quickCheckQuestions = [
  {
    id: 'switch-off-test',
    question:
      'With the light switch OFF, you test from CU line to the lamp holder centre contact and find continuity. What does this indicate?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'The switch is incorrectly wired in the neutral conductor. The lamp holder remains live when switched off - this is a dangerous condition requiring immediate rectification.',
  },
  {
    id: 'fcu-switch-off',
    question:
      'At a switched FCU with the switch OFF, should there be continuity between the supply line and the load line terminals?',
    options: [
      'Yes, always',
    ...
    correctIndex: 2,
    explanation:
      'With the switch OFF, the internal switch (in series with the fuse) should break the line path, so there should be no continuity between supply and load line terminals.',
  },
  {
    id: 'radial-fault',
    question:
      'Three socket outlets on a radial circuit all show reversed polarity, but sockets nearer the CU are correct. Where is the fault likely to be?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'The fault is likely in a junction box or the last correctly wired socket, where all cables for the affected section join. The L and N conductors have been crossed at that point, affecting all downstream outlets.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'When testing socket outlet polarity with a continuity tester, which terminals should show continuity to their respective CU terminals?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Each socket terminal (L, N, E) must show continuity only to its corresponding terminal at the consumer unit, confirming correct wiring throughout.',
  },
  {
    id: 2,
    question:
      'On a lighting circuit with the switch OFF, testing between line at CU and the lamp holder centre contact should show:',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'With the switch off, the circuit is broken, so no continuity should exist between line at CU and the lamp holder. This proves the switch is in the line conductor.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'For correct two-way polarity, the line feeds the common terminal of one switch, and the common terminal of the second switch feeds the lamp. Strappers connect the L1 and L2 terminals.',
  },
  {
    id: 4,
    question:
      'Testing polarity at a switched fused connection unit (FCU), the switch should break:',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Like all single-pole switches, the switch in an FCU must break the line conductor only. The neutral passes straight through.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Correct polarity requires the socket and cooker outlet both have correct L, N, and E connections, with the switch controlling the line to the cooker circuit.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      "Socket testers use LED patterns to indicate wiring status. The correct pattern varies by manufacturer but typically shows two LEDs for correct wiring. Always refer to the device's indication chart.",
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      'The switched line should connect to the centre contact of the lamp holder (the safest contact when changing lamps), while neutral connects to the outer sleeve.',
  },
  {
    id: 8,
    ...
    correctAnswer: 2,
    explanation:
      'Polarity must be verified at every point of utilisation. All 12 sockets must be tested as wiring errors can occur at any point in the circuit.',
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      'Safe isolation must be performed and the circuit proved dead before any continuity-based polarity testing. This is a fundamental safety requirement.',
  },
  {
    id: 10,
    ...
    correctAnswer: 0,
    explanation:
      'Even with an isolation transformer, the supply-side polarity must be correct with line feeding the primary through any switch, ensuring proper isolation when switched off.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Test that the line at CU connects to the common terminal of the first switch. With both switches in one position, verify continuity from the second switch common terminal to the lamp centre contact. The strappers (L1 and L2) should interconnect both switches regardless of switch positions.',
  },
  {
    question: 'Can I use the R1+R2 test to verify polarity?',
    answer:
      'Yes, the R1+R2 test inherently verifies polarity if performed correctly. By testing continuity between line at the origin and the line terminal at each socket (with a link at the CU), you confirm the line conductor runs to the correct terminal throughout.',
  },
  {
    question: 'What if I find reversed polarity at a single socket on a ring circuit?',
    answer:
      'This indicates incorrect wiring at that specific socket - the line and neutral conductors have been swapped at that accessory. The socket must be rewired correctly. Check how the fault occurred to identify if other points need verification.',
  },
  {
    question: 'Do I need to test polarity at junction boxes?',
    answer:
      "Junction boxes themselves don't have polarity requirements, but any switches or outlets fed from them do. You must verify that line conductors continue correctly through junction boxes to their destinations.",
  },
  {
    question: 'How should polarity be tested on a circuit with intermediate switches?',
    answer:
      'Verify the line at CU connects to one two-way switch common. With all switches in the correct positions, there should be continuity through the strappers, intermediates, to the second two-way switch common, and to the lamp centre contact.',
  },
  {
    question: "What's the most common cause of polarity errors?",
    answer:
      'Incorrect termination at accessories - connecting brown to N terminal and blue to L terminal. This often happens due to rushing, poor lighting, or confusion with old colour codes. Always double-check connections before replacing faceplates.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Sockets:</strong> Test every socket - L to L, N to N, E to E
              </li>
              <li>
                <strong>Switch OFF:</strong> No continuity from CU line to lamp centre
              </li>
              <li>
                <strong>Switch ON:</strong> Continuity from CU line to lamp centre
              </li>
              <li>
                <strong>Always:</strong> Isolate and prove dead before testing
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Wrong terminal connections at accessories
              </li>
              <li>
                <strong>Use:</strong> Long wandering lead from CU
              </li>
              <li>
                <strong>Apply:</strong> Combine with R1+R2 testing for efficiency
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Socket outlets require verification that each terminal is connected to the correct
              conductor throughout the circuit. Using a long wandering lead from the consumer unit:
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Socket Polarity Test Steps
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Lighting circuits must verify that the switch is in the line conductor, ensuring the
              lamp holder is dead when switched off:
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Two-way lighting circuits require careful polarity verification to ensure the line
              feeds through both switches correctly:
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Two-Way Circuit Polarity
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Switch 1 COM:</strong> Receives permanent line from CU
                </li>
                <li>
                  <strong>Switch 1 L1 and L2:</strong> Connect to switch 2 L1 and L2 (strappers)
                </li>
                <li>
                  <strong>Switch 2 COM:</strong> Supplies switched line to lamp
                </li>
                <li>
                  <strong>Neutral:</strong> Direct to lamp (not through switches)
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Fused connection units and cooker control outlets have internal switches that must be
              verified for correct polarity:
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Ring final circuits require polarity verification at every socket outlet, as errors
              can occur at any point in the ring:
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Ring Circuit Polarity Test Strategy
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>When polarity faults are found, systematic investigation identifies the cause:</p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Assuming new = correct</strong> - even new installations can have wiring
                  errors
                </li>
                <li>
                  <strong>Testing only a sample</strong> - polarity must be verified at every outlet
                </li>
                <li>
                  <strong>Forgetting the switch test</strong> - verify lighting switches break line
                </li>
                <li>
                  <strong>Not checking FCU outputs</strong> - verify load side polarity too
                </li>
              </ul>
            </div>
          </div>
