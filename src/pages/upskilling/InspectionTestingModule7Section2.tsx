    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The on-site method: L–CPC link at the board, then ohmmeter at every switched accessory,
          FCU, ceiling rose and socket. What a passing reading looks like, what a failure looks
          like, and how the result lands on the schedule of test results.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Use an insulated flying lead — never a bare strap. The link will be touched repeatedly
              during the test, and if the consumer unit is energised on a different circuit, an
              exposed link terminal at the live bus is a flash hazard.
            </li>
            <li>
              Crocodile clips are acceptable for short tests but not for prolonged work — they shake
              loose. A spring-loaded clamp or a screw terminal block at each end is more reliable.
            </li>
            <li>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              ...
              <text x="55" y="92" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
                IN (L)
              </text>
              {/* Output terminal */}
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="80" y="310" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              MCB L
            </text>
            <rect
              x="60"
              ...
              strokeWidth="1.5"
            />
            <text x="80" y="350" textAnchor="middle" fill="#3B82F6" fontSize="9" fontWeight="bold">
              N bar
            </text>
            <rect
              x="60"
              ...
              strokeWidth="1.5"
            />
            <text x="80" y="390" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              E bar
            </text>
            {/* L-CPC link */}
            <path
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="162" y="350" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              L–CPC LINK
            </text>
            ...
            <text x="385" y="365" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              ...
              <tbody className="text-white/95">
                <tr className="border-b border-white/[0.06] align-top">
                  ...
                  <td className="py-2 text-elec-yellow">
                    Pass — line is on the input, switch is interrupting line, switch is in line not
                    neutral
                  </td>
                </tr>
                <tr className="border-b border-white/[0.06] align-top">
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              all-red T&E lighting wiring with marker tape on the switched line — the marker should
              be at every termination of that conductor.
            </li>
          </ol>
          <p>
            ...
            the switch is irrelevant. The user reports &lsquo;the switch does not work&rsquo; — and
            a mis-diagnosis can leave the fault in place if you only look at the switch end.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>N terminal → CPC:</strong> open. The neutral conductor is not the line — it is
              not connected to the L–CPC link path.
            </li>
          </ul>
          <p>
          ...
          <p>
            ...
            sub-clause-(c) duty: every socket is a separate test point, and the readings give you a
            chain of evidence along the ring. A single reversed socket on a ring is a localised
            fault that the ring continuity test (r1, r2, rn) on its own does not necessarily reveal
            — the polarity test at every socket is what catches it.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Approved two-pole voltage indicator (GS 38 compliant) at the incoming side of the main
              switch. Read L–E. Expect ≈ 230 V (single-phase). Read N–E. Expect ≈ 0–10 V on TN-C-S,
              or close to 0 V on TT.
            </li>
            <li>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Fail on first test, corrected before completion:</strong> tick, with a comment
              in the comments column. Recommended format: &lsquo;[Accessory ref] — [fault] —
          ...
          <p>
            ...
            the accessory and the action taken protects the inspector if the work is queried later.
          </p>
        </ConceptBlock>
