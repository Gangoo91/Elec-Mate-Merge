...
const VisualInspectionGuide = () => {
  const inspectionSteps = [
    {
      ...
      description:
        'Begin with reviewing all available documentation and preparing your inspection checklist',
      details: [
    ...
    distributionBoard: [
      {
        ...
        whatToLook:
          'Each protective device should have clear, permanent labelling indicating the circuit it protects',
        assessorExpects:
          'Recognition that whilst not immediately dangerous, proper labelling is essential for maintenance and emergency situations',
      },
      {
        ...
        assessorExpects:
          'Understanding that damaged enclosures compromise protection and could lead to danger',
      },
      {
    ...
    wiring: [
      {
        ...
        whatToLook:
          'Cables should run vertically or horizontally from accessories within 150mm zones',
        assessorExpects:
          'Understanding of safe zone requirements and recognition of compliant installations',
      },
      {
        ...
        whatToLook:
          'Cables should be supported at appropriate intervals to prevent mechanical strain',
        assessorExpects:
          'Knowledge of support requirements and recognition of potential long-term issues',
      },
      {
        ...
        assessorExpects:
          'Immediate recognition of danger and understanding of urgent remedial action required',
      },
    ],
  };
  ...
  const commonMistakes = [
    ...
    },
    {
      ...
      example:
        "Instead of 'damaged cable', write 'damaged T&E cable in kitchen, outer sheath cut exposing inner conductors'",
    },
    {
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <Card className="bg-transparent border-elec-yellow/30">
            ...
            <CardContent className="text-white space-y-4">
              <p>
                Visual inspection is the first and most critical stage of electrical installation
                inspection and testing. Assessors will evaluate your ability to systematically
                examine an installation, identify defects, and accurately record findings using the
                correct observation codes.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-elec-yellow/20 p-4 rounded-lg">
                  <h4 className="font-semibold text-blue-300 mb-2">Knowledge</h4>
                  <p className="text-sm">
                    Understanding of current regulations and inspection requirements
                  </p>
                </div>
                <div className="bg-green-600/20 p-4 rounded-lg">
                  <h4 className="font-semibold text-green-300 mb-2">Skills</h4>
                  <p className="text-sm">
                    Systematic inspection methodology and defect recognition
                  </p>
                </div>
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-elec-yellow mb-6">
            ...
            {inspectionSteps.map((step) => (
              <Card
                key={step.step}
                className="bg-transparent border-transparent hover:border-elec-yellow/30 transition-all duration-300"
              >
                <CardHeader>
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-elec-yellow mb-6">
              Common Defects and Observation Codes
            </h2>
                ...
                <Card key={index} className="bg-transparent border-transparent">
                  <CardHeader>
                    <CardTitle className="text-lg flex items-center gap-2">
                      <AlertTriangle
                        className={`h-5 w-5 ${index === 0 ? 'text-red-400' : index === 1 ? 'text-orange-400' : 'text-elec-yellow'}`}
                      />
                      <span
                        className={
                          index === 0
                    ...
                    <ul className="space-y-2">
                      {defect.examples.map((example, exIndex) => (
                        <li key={exIndex} className="text-white text-sm flex items-start gap-2">
                          <span
                            className={`mt-1 ${index === 0 ? 'text-red-400' : index === 1 ? 'text-orange-400' : 'text-elec-yellow'}`}
                          >
                            •
                          </span>
                          {example}
          ...
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-elec-yellow mb-6">
              Professional Tips for Assessment Success
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {assessorTips.map((tip, index) => (
                <Card
                  key={index}
                  className="bg-gradient-to-br from-elec-gray to-[#323232] border-elec-yellow/30"
                >
                    ...
                    <Card key={index} className="bg-transparent border-transparent">
                      ...
                      <CardContent className="space-y-3 pt-0">
                        ...
                        <div className="space-y-2">
                          <p className="text-xs text-elec-yellow font-semibold">
                            Regulation: {example.regulation}
                          </p>
                          <p className="text-xs text-white">
                            <span className="font-semibold">Look for:</span> {example.whatToLook}
                          </p>
                          <p className="text-xs text-orange-400">
                            <span className="font-semibold">Assessor expects:</span>{' '}
                            {example.assessorExpects}
                          </p>
                        </div>
                      </CardContent>
                    </Card>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {commonMistakes.map((mistake, index) => (
                <Card
                  key={index}
                  className="bg-gradient-to-br from-red-900/20 to-elec-gray border-red-500/20"
                >
                  <CardHeader>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {advancedTechniques.map((technique, index) => (
                <Card
                  key={index}
                  className="bg-gradient-to-r from-elec-gray to-[#323232] border-elec-yellow/30"
                >
                  <CardHeader>
                    <CardTitle className="text-elec-yellow text-lg">
                      {technique.technique}
                    </CardTitle>
