    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          BS 5839-1:2025 networked architectures: ring vs star topology, BS EN 54-13 system
          compatibility, BS EN 50200 / BS 8519 cabling, distributed vs centralised CIE, network
          monitoring, fault tolerance, and the NEW clause 43.4 cyber-security requirements for
          connected systems.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Phased installation</strong> — a building extended over time; new panels added
              for new wings or new buildings; networked to existing panels for unified indication.
            </li>
            <li>
            ...
            <li>
              <strong>Vendor / protocol scale limits</strong> — most vendor systems have a practical
              maximum number of devices / loops per panel; networked panels go beyond that limit.
            </li>
          </ul>
          <p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            {/* Left — Ring */}
            <text x="160" y="60" textAnchor="middle" fill="#22D3EE" fontSize="12" fontWeight="bold">
              RING (loop)
            </text>
            ...
            <circle
              ...
              strokeWidth="1.4"
            />
            <text x="160" y="105" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              P1
            </text>
            <circle
              cx="234"
              ...
              strokeWidth="1.4"
            />
            <text x="234" y="153" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              P2
            </text>
            <circle
              cx="220"
              ...
              strokeWidth="1.4"
            />
            <text x="220" y="231" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              P3
            </text>
            <circle
              cx="100"
              ...
              strokeWidth="1.4"
            />
            <text x="100" y="231" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              P4
            </text>
            <circle
              cx="86"
              ...
              strokeWidth="1.4"
            />
            <text x="86" y="153" textAnchor="middle" fill="#22D3EE" fontSize="9" fontWeight="bold">
              P5
            </text>
            ...
            {/* Centre — Star */}
            <text x="440" y="60" textAnchor="middle" fill="#FBBF24" fontSize="12" fontWeight="bold">
              STAR
            </text>
            ...
            <circle
              ...
              strokeWidth="1.4"
            />
            <text x="440" y="105" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              P1
            </text>
            ...
            <circle
              ...
              strokeWidth="1.4"
            />
            <text x="514" y="153" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              P2
            </text>
            ...
            <circle
              ...
              strokeWidth="1.4"
            />
            <text x="514" y="237" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              P3
            </text>
            ...
            <circle
              ...
              strokeWidth="1.4"
            />
            <text x="366" y="237" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              P4
            </text>
            ...
            <circle
              ...
              strokeWidth="1.4"
            />
            <text x="366" y="153" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              P5
            </text>
            ...
            {/* Right — Bus */}
            <text x="720" y="60" textAnchor="middle" fill="#A855F7" fontSize="12" fontWeight="bold">
              BUS
            </text>
            ...
            <circle
              ...
              strokeWidth="1.4"
            />
            <text x="620" y="185" textAnchor="middle" fill="#A855F7" fontSize="9" fontWeight="bold">
              P1
            </text>
            ...
            <circle
              ...
              strokeWidth="1.4"
            />
            <text x="675" y="185" textAnchor="middle" fill="#A855F7" fontSize="9" fontWeight="bold">
              P2
            </text>
            ...
            <circle
              ...
              strokeWidth="1.4"
            />
            <text x="730" y="185" textAnchor="middle" fill="#A855F7" fontSize="9" fontWeight="bold">
              P3
            </text>
            ...
            <circle
              ...
              strokeWidth="1.4"
            />
            <text x="785" y="185" textAnchor="middle" fill="#A855F7" fontSize="9" fontWeight="bold">
              P4
            </text>
            ...
            <circle
              ...
              strokeWidth="1.4"
            />
            <text x="820" y="185" textAnchor="middle" fill="#A855F7" fontSize="9" fontWeight="bold">
              P5
            </text>
            ...
            <text x="60" y="396" fill="rgba(251,191,36,0.85)" fontSize="10">
              STAR — simple; hub = single point of failure; cable break loses one panel from network
            </text>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              alarm systems, shall be of fire-resistant construction tested to BS EN 50200, with the
              appropriate PH grade selected according to the building risk profile and BS 8519
              guidance. Cable installation shall provide mechanical protection, appropriate fixings,
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Smaller networks</strong> — 2-3 panels, where a single master is feasible and
              the remote panels are typically unmanned.
            </li>
            <li>
            ...
            <li>
              <strong>Cost-driven retrofits</strong> — extending an existing system with additional
              panels but keeping the existing CIE as master.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Authentication of any request to accept a remote connection</strong> — the CIE
              / gateway authenticates the requester. Not just 'IP address allowed'; identity
              verification.
            </li>
            <li>
              <strong>Risk assessment before remote service</strong> — particularly when executing
              read, control, or write functions. The risk assessment evaluates the potential impact
              on the operation of the CIE.
            </li>
            <li>
              <strong>System fully operational on completion</strong> — the responsible individual
              must ensure the system is fully operational when the remote service ends. Not 'left in
              a degraded state.'
            </li>
          </ul>
          <p>
            ...
            completion. Applied to fire alarm, the same principles produce a proportionate baseline.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              security are now given more prominence. The 2025 revision acknowledges the use of such
              technology and includes recommendations for preventing unauthorised access to the
              system, access points, and network pathways by physical means such as locking the
              comms cabinet or fitting anti-tamper plugs to patch leads. A method of authentication
              of a request to accept a remote connection should be included in the CIE or gateway
              software before remote access is allowed. Prior to performing any remote service,
              particularly when executing read, control, or write functions, a thorough risk
              assessment should be conducted to evaluate the potential impact on the operation of
              the CIE. If there is any risk that the remote service might compromise the correct
              functioning of the CIE, the responsible individual must ensure that the system is
              fully operational upon completion of the remote service.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Battery age and capacity</strong> — backup battery monitoring per panel; aged
              batteries with reduced capacity are a common pre-failure signal.
            </li>
            <li>
          ...
          <p>
            ...
            reviews them. Trends are reported in the service record; emerging issues are flagged for
            repair before they become hard failures.
          </p>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            ...
            {
              question: "What does 'fire-resistant cable' actually mean for a fire alarm network?",
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-3/section-6')}
