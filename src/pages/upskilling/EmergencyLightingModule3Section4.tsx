...
const inlineChecks = [
  {
    ...
    options: [
      'Never — the published minima are an absolute ceiling that designs must not exceed.',
      'Where the fire risk assessment identifies factors the minima do not capture, such as sleeping risk, vulnerable occupants or crowded places of assembly.',
      'Only where the local building control body explicitly mandates a higher figure in writing.',
      'Only in buildings taller than 18 m, where the upper-storey escape distance is longer.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A fire-fighting lobby reserved exclusively for the fire and rescue service during an incident.',
      'A protected area, typically a stair lobby, where a mobility-impaired person waits safely for assisted evacuation, with a two-way call point and emergency lighting.',
      'A pressurised smoke-control vestibule whose only function is to keep the protected stair free of smoke.',
      'A designated assembly point sited outside the building at a safe distance from the structure.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    id: 'elm3-s4-circuits',
    question:
      'BS 5266-1:2025 NEW requirement for high-risk areas regarding circuit arrangement is...?',
    options: [
      'A single dedicated circuit is permitted provided it is RCBO-protected and separately monitored.',
      'At least 2 separate final circuits, with no single circuit serving more than 20 luminaires, so one fault cannot lose more than half the high-risk lighting.',
      'A minimum of 3 separate circuits in every high-risk area, irrespective of the luminaire count.',
      'Any number of luminaires on one circuit, provided each has its own self-contained battery.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'It keeps the luminaire surface temperature within the IP-rated enclosure limit.',
      'A direct view of a high-luminance source disrupts dark-adapted vision, so an occupant looking away into shadow is momentarily blinded; BS EN 1838:2024 caps the luminous intensity.',
      'It reduces the standby power the luminaire draws from the central battery system.',
      'It limits the blue-light content that could disturb circadian rhythm in occupied spaces.',
    ],
    correctIndex: 1,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      'Whenever the fire risk assessment identifies factors the minima do not capture.',
      'Never — the minima are an absolute ceiling.',
      'Only in retail premises with high footfall.',
      'Only when the paying customer specifically requests it.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Just 1 lx escape lighting, the same as any route.',
      'No dedicated emergency lighting beyond the corridor.',
      'At least 1 lx route, 5 lx vertical on the call point, plus lobby lighting.',
      'A 50 lx flood across the whole lobby.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A single circuit of any luminaire count.',
      'At least 2 circuits, with a maximum of 20 luminaires per circuit.',
      'A minimum of 5 separate circuits.',
      'No limit on circuits or luminaire count.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Hotels only, not other premises.',
      'Care homes only, not hotels or hospitals.',
      'Daytime-occupied premises only.',
      'Any premises where occupants normally sleep.',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    id: 5,
    question:
      'Places of assembly with elderly or disabled patrons (e.g. day-care, sheltered housing common rooms, accessible theatre seating) typically require...?',
    options: [
      'Lower illuminance, to save energy for these occupants.',
      'Higher illuminance than minima — typically 2 to 3 lx route and 1 lx anti-panic.',
      'No emergency lighting beyond the building default.',
      'Only the stairwells need emergency lighting.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'They are entirely unrelated standards.',
      'BS 9999 fully replaces BS 5266 for emergency lighting.',
      'BS 9999 sets the strategy; BS 5266 sets the lighting to deliver it.',
      'BS 5266 only applies to buildings outside BS 9999 scope.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 7,
    question:
      'A high-risk area has 30 luminaires across 2 circuits — does this meet BS 5266-1:2025?',
    options: [
      'Yes, in every case with 2 circuits.',
      'Yes, provided it was installed in 2024.',
      'Only if each of the 2 circuits carries no more than 20 luminaires.',
      'No, because the total luminaire count is too high.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'BS EN 1838:2024 luminous-intensity limits in glare-critical viewing angles.',
      'Building height and massing regulations.',
      'Aesthetic preference of the specifier alone.',
      'Manufacturer marketing claims for the luminaire.',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'The 1 lx escape-route minimum, unchanged.',
      '0.5 lx anti-panic level only.',
      '15 lx high-risk task lighting throughout.',
      'A risk-based uplift, typically 2 to 3 lx route with 2 h duration.',
    ],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'Roused occupants wake disoriented and unsteady with reduced reaction times.',
      'Marketing differentiation of the building.',
    ],
    correctAnswer: 2,
    explanation:
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The minima are the floor, not the ceiling. Where the fire risk assessment identifies
          sleeping occupants, vulnerable users, complex layouts, places of assembly or other factors
          that the standard cannot encode, the design must uplift above the minimum. The 2025
          revision adds explicit circuit redundancy rules for high-risk areas and tightens guidance
          on disabled refuge points.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              education, industrial premises with general adult workforce. The 1 lx / 0.5 lx / 3 h
              minima from BS 5266-1:2025 §5.4 deliver compliant evacuation lighting.
            </li>
            <li>
              <strong>Sleeping risk → 2 h + uplift.</strong> Premises where occupants normally sleep
              need 2 h duration (BS 5266-1:2025 §5.4) and typically risk-based uplift to route lux
              to support post-rousing disorientation.
            </li>
            <li>
              <strong>Vulnerable users → uplift.</strong> Care homes, sheltered housing, day-care
              centres, accessible theatre seating, sheltered employment workshops. Higher
              illuminance supports reduced visual / mobility / cognitive capacity.
            </li>
            <li>
              <strong>Places of assembly → uplift.</strong> Theatres, cinemas, concert venues,
              stadiums, conference halls, places of worship. Crowd density slows evacuation; higher
              illuminance supports flow management and sign legibility at distance.
            </li>
            <li>
            ...
            <li>
              <strong>High-contrast or low-contrast environments → uplift.</strong> Display lighting
              in retail (high-contrast adaptation), windowless basements (no daylight fallback),
              spaces with mirrored or highly reflective finishes (visual confusion).
            </li>
          </ul>
          <p>
            The risk-assessment-driven approach replaces a one-size-fits-all rule with a
            context-sensitive design. The standard minima are the legal floor; risk-based uplift is
            professional duty of care. Designers who quote minima only on every project miss the
            risk-assessment translation step that makes the design fit for purpose.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              hazards — the design shall provide illumination above the minimum values stated in
              this standard, sufficient to manage the identified risk.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>2 h duration (mandatory).</strong> Per BS 5266-1:2025 §5.4. Reflects slower
              evacuation in sleeping accommodation.
            </li>
            <li>
              <strong>Route lux uplift (typical 2 to 3 × minimum).</strong> Common designs use 2 to
              3 lx escape route in sleeping accommodation common areas (against the 1 lx minimum).
              Hotel corridors, care home corridors, hospital ward corridors typically designed at
              this level.
            </li>
            <li>
              <strong>Anti-panic uplift.</strong> Communal living areas in sheltered housing, hotel
              function rooms, hospital day rooms — anti-panic typically uplifted to 1 lx (against
              0.5 lx minimum).
            </li>
            <li>
              ...
              mandatory under BS 5266 minima but typically specified by the fire risk assessment in
              care environments.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Mobility impairment.</strong> Refuge points (see below); wider escape routes;
              level access throughout; lighting on every change of level.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Emergency lighting throughout the refuge.</strong> The user may wait several
              minutes for assistance; the refuge must be lit during the wait. Typically designed to
              escape-route minimum (1 lx) or higher per the risk assessment.
            </li>
            <li>
              <strong>Lighting on the route TO the refuge.</strong> The user navigates from their
              normal occupancy point to the refuge; the route is part of the escape lighting design
              and meets the relevant route minimum.
            </li>
            <li>
              <strong>Lighting on the route FROM the refuge to the final exit.</strong> When
              assistance arrives, the assisted evacuation continues. The full route from refuge to
              final exit must be lit to escape-route minimum.
            </li>
            <li>
              <strong>Signage.</strong> Refuge identification signage at the refuge door (lit per BS
              5266 sign duty) and directional signage from the floor to the refuge.
            </li>
          </ul>
          <p>
            Coordination is critical. The architect designs the protected lobby (BS 9999); the fire
            alarm designer specifies the two-way communication; the BS 5266 designer specifies the
            lighting. All three must align on the location, dimensions and dependencies of the
            refuge.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Refuges shall be provided with emergency lighting in accordance with BS 5266-1. The
              lighting shall achieve the escape-route illuminance minimum throughout the refuge
              area, with vertical 5 lx on the face of the two-way communication call point. The
              route from the refuge to the final exit shall be similarly lit to support assisted
              evacuation.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              30-luminaire high-risk area needs 2 circuits with at most 20 on either (e.g. 15-15
              split, or 20-10). A 50-luminaire installation needs 3 circuits.
            </li>
            <li>
              <strong>Geometric distribution.</strong> Best practice — alternate which luminaire is
              on which circuit through the layout. So if circuit A fails, circuit B luminaires are
              spread across the area and continue to deliver acceptable lux. A clustered allocation
              (all circuit-A luminaires on one side, all circuit-B on the other) loses half the area
              on a single fault, which is worse than alternating.
            </li>
            <li>
              <strong>Switching.</strong> Each circuit may have its own changeover gear; in a
              self-contained system, each luminaire has its own battery. Either approach achieves
              the redundancy provided the circuits and the luminaires meet the count rules.
            </li>
            <li>
              <strong>Monitoring.</strong> Each circuit is monitored independently per BS EN
              50172:2024. A circuit fault triggers a fault indication on the central monitor; the
              maintenance team responds before the residual circuits become single-point- of-failure
              too.
            </li>
          </ul>
          <p>
            The 20-luminaire cap is conservative. It means a high-risk installation cannot use a
            single 32 A radial circuit serving 30 luminaires regardless of cable / load
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              luminaires. The luminaires shall be allocated to circuits such that the failure of any
              single circuit, distribution board or supply does not reduce the illuminance below the
              minimum for the high-risk task area at any point.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Louvres / cut-off optics.</strong> Physical baffles preventing direct view of
              the LED source from glare-critical angles. Used in deep recessed luminaires.
            </li>
            <li>
              <strong>Indirect lighting.</strong> Luminaire facing upward to ceiling or wall; the
              user sees the lit surface, not the source. Effective for glare avoidance but requires
              more luminaires for the same floor lux (some light absorbed by the surface).
            </li>
            <li>
              <strong>Asymmetric optics with cut-off.</strong> Forward-throw photometric with a hard
              cut-off at horizontal — light goes forward and down, no upward component to glare into
              oncoming view.
            </li>
          </ul>
          <p>
            Designers verify glare control by reading the manufacturer's photometric data —
            specifically the luminous intensity at viewing angles 60 to 90 degrees from vertical. BS
            EN 1838:2024 §4.6 caps the intensity per the standard formula; values within the cap are
            compliant. Bare-LED indicator-style luminaires used in cheap emergency-light products
            typically fail the cap and should not be specified for positions where occupants view
            them in evacuation.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The luminous intensity of emergency-lighting luminaires in viewing angles likely to be
              in the field of view of evacuating persons shall not exceed the values given in Table
              2 of this standard. Manufacturers shall publish photometric data identifying intensity
              at the relevant viewing angles for verification by the designer.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="440" y="88" textAnchor="middle" fill="#22D3EE" fontSize="12" fontWeight="bold">
              BS 5266-1:2025 minima
            </text>
            <text x="440" y="104" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
              1 lx route · 0.5 lx anti-panic · 3 h
            </text>

            {/* Decision diamond */}
            <polygon
              points="440,140 540,200 440,260 340,200"
            ...
            <text x="440" y="210" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9.5">
            ...
            <line
              ...
              strokeWidth="1.4"
            />
            <text x="570" y="194" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              no
            </text>
            ...
            <line
              ...
              strokeWidth="1.4"
            />
            <text x="425" y="278" fill="#A855F7" fontSize="9" fontWeight="bold">
              yes
            </text>
            ...
            <text x="120" y="328" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              → 2 h duration
            </text>
            <text x="120" y="342" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              → 2 to 3 lx route
            </text>
            ...
            <text x="300" y="328" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              → 2 to 3 × route lux
            </text>
            <text x="300" y="342" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              → refuge planning
            </text>
            ...
            <text x="480" y="328" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              → uplift route + sign
            </text>
            <text x="480" y="342" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              → legibility @ distance
            </text>
            ...
            <text x="660" y="328" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              → 1 lx in refuge
            </text>
            <text x="660" y="342" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="9.5">
              → 5 lx vert at call pt
            </text>
            ...
            <text
              ...
              fontWeight="bold"
            >
              High-risk task area (NEW 2025 circuit rules)
            </text>
            <text x="440" y="422" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="10">
              → 15 lx OR 10% of task lux, 0.5 s switch-on, 10:1 uniformity
            </text>
            <text x="440" y="438" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="10">
              → ≥2 separate circuits AND ≤20 luminaires per circuit
            </text>
            <text x="440" y="454" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="10">
              → residual lux on single-circuit fault must still meet minimum
            </text>
            ...
            <text
              ...
              fontWeight="bold"
            >
              Glare control — applies to ALL designs
            </text>
            <text x="440" y="518" textAnchor="middle" fill="rgba(255,255,255,0.85)" fontSize="10">
              BS EN 1838:2024 §4.6 luminous-intensity caps in glare-critical viewing angles
            </text>
            ...
            <text
              ...
              fontWeight="bold"
            >
              The fire risk assessment selects the branch(es); designer implements all applicable
              uplifts in combination
            </text>
          </svg>
        </div>
        ...
        <FAQ
          items={[
            ...
            {
              question:
                'What if a high-risk area has only 4 luminaires — do I still need 2 circuits?',
              answer:
            ...
            {
              question:
                'A school hall is used for assembly and as an exam venue — does risk-based design apply?',
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() =>
              navigate('/electrician/upskilling/emergency-lighting-module-3-section-5')
            }
