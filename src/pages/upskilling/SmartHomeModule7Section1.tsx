...
const DESCRIPTION =
  'Professional installation practices for safe, reliable, and compliant smart home electrical systems covering wiring methods, power supply requirements, and proper containment techniques.';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      'For earth bonding',
      'To power the internal electronics',
      'To increase switching speed',
      'For dimming capability',
    ],
    correctIndex: 1,
    explanation:
      'Smart switches contain microprocessors and wireless modules that require continuous power from the neutral conductor to operate their internal electronics.',
  },
  {
    question:
      'What type of containment is recommended for smart home data cables running alongside mains wiring?',
    options: [
      'Same trunking compartment',
      'Separate compartments or segregated trunking',
      'No containment needed',
      'Metal conduit only',
    ],
    correctIndex: 1,
    explanation:
      'Data cables must be segregated from mains wiring using separate compartments or trunking to prevent electromagnetic interference and comply with regulations.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Bathroom zones have specific IP rating requirements. Containment and equipment must have appropriate IP ratings for their location to ensure safety.',
  },
  {
    question:
...
const faqs = [
  {
    ...
    answer:
      "Not all, but most do. Some manufacturers produce 'no-neutral' smart switches that work with a small current through the load, but these have limitations including minimum load requirements and potential compatibility issues with LED lighting. Where possible, installing a neutral at switch positions is the preferred professional approach.",
  },
  {
    question: 'Can I use existing surface-mounted mini trunking for smart home cables?',
    answer:
      'Existing trunking can often be used if it has sufficient capacity and appropriate compartmentalisation. However, you must ensure mains and data cables are properly segregated, and the trunking is suitable for the environment (IP rating, fire resistance where required).',
  },
  {
    question: 'What power supply type is best for smart LED lighting installations?',
    answer:
      'Constant voltage LED drivers (typically 12V or 24V DC) are most common for smart LED strip installations. Choose drivers with sufficient wattage headroom (typically 20% above calculated load), appropriate IP rating for the location, and compatibility with your chosen smart controller.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-3xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-white text-sm">
              BS 7671 18th Edition compliance for all electrical work
            </p>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            <h3 className="font-semibold text-white mb-1">Key Focus</h3>
            <p className="text-white text-sm">
              Proper wiring practices for reliable smart device operation
            </p>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Smart devices have specific wiring requirements that differ from traditional
              electrical installations. Understanding these requirements is essential for reliable
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Many smart home devices operate on extra-low voltage (ELV), typically 5V, 12V, or 24V
              DC. Selecting and installing appropriate power supplies is critical for system
              reliability.
            </p>
            ...
            <div className="grid gap-4">
              ...
              <div className="p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <p className="text-white text-sm">
                  Constant voltage (CV) or constant current (CC) depending on LED type. Size with
                  20% headroom. Consider IP rating for location requirements.
                </p>
              </div>
            </div>
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 p-4 rounded-r-lg">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                Maintain minimum 50mm separation between mains and data cables, or use physical
                barrier
              </li>
            ...
            <div className="grid gap-3">
              <div className="flex gap-3">
                ...
                <span className="text-white">
                  Surface-mounted, good for retrofit. Choose compartmentalised types.
                </span>
              </div>
              <div className="flex gap-3">
                <span className="font-medium text-elec-yellow min-w-[140px]">Dado Trunking:</span>
                <span className="text-white">
                  Multiple compartments for power, data, and AV. Professional finish.
                </span>
              </div>
              <div className="flex gap-3">
                <span className="font-medium text-elec-yellow min-w-[140px]">Conduit:</span>
                <span className="text-white">
                  Concealed installations. Separate runs for mains and data.
                </span>
              </div>
              <div className="flex gap-3">
                <span className="font-medium text-elec-yellow min-w-[140px]">Floor Boxes:</span>
                <span className="text-white">
                  Central room positions. Combined power and data outlets.
                </span>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            ...
            <p>
              When installing smart devices in bathrooms, kitchens, or outdoor areas, ensure
              compliance with the relevant special location requirements in Part 7 of BS 7671. This
              includes IP ratings, zone restrictions, and supplementary bonding requirements.
            </p>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm">
                ...
                certificates as required. Include smart device specifications in the schedule of
                items tested.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                Install larger containment than immediately required (50% spare capacity typical)
              </li>
