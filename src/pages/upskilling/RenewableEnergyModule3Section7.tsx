...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'IR test on a 6 kWp PV install. System V_oc_max = 600 V. Test voltage chosen?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'How are the test conditions (irradiance, temperature) factored into the V_oc / I_sc measurements?',
    answer:
  ...
  {
    question:
      'How does the IET CoP for Grid-Connected Solar PV Installations operationalise BS EN 62446-1?',
    answer:
...
export default function RenewableEnergyModule3Section7() {
  ...
  useSEO({
    title: 'BS EN 62446-1 commissioning & test results | Renewable Energy 3.7 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 7 · BS 7671:2018+A4:2026 · BS EN 62446-1:2016+A1:2018"
        title="BS EN 62446-1 commissioning & test results"
        backTo="../renewable-energy-module-3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The commissioning evidence pack — continuity, polarity, V_oc / I_sc per string, I-V curve,
          insulation resistance, functional test of isolators and protective devices, Schedule of
          Test Results, and the baseline records for future diagnostic reference.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Documentation requirements</strong> — design pack,
              single-line schematic, component schedule, manufacturer datasheets, MCS cert
            </li>
            <li>
              <strong className="text-white">Visual inspection</strong> — physical install
              inspection: module mounting, cable routing, connector engagement, labels, isolator
              accessibility
            </li>
            <li>
              <strong className="text-white">Electrical tests</strong> — continuity, polarity, V_oc
              / I_sc per string, I-V curve (recommended for larger installs), insulation resistance,
              functional test of isolators / protective devices
            </li>
            <li>
              <strong className="text-white">Commissioning test report</strong> — narrative summary
              of the commissioning visit, findings, rectifications
            </li>
            <li>
              <strong className="text-white">Schedule of Test Results</strong> — structured record
              of every test result, including test conditions, methodology, pass / fail criterion,
              measured value
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Module-to-rail</strong> — measure resistance from
              module frame (test probe on frame) to nearest rail (test probe on rail). Confirms
              module clamp electrical contact
            </li>
            <li>
              <strong className="text-white">Rail-to-rail joints</strong> — measure across each rail
              joint. Confirms anti-corrosion gel applied and torque correct
            </li>
            <li>
              <strong className="text-white">Rail-to-bonding conductor</strong> — measure from rail
              to the start of the dedicated bonding conductor
            </li>
            <li>
              <strong className="text-white">Bonding conductor end-to-end</strong> — measure full
              length from rail termination to inverter / MET termination
            </li>
            <li>
              <strong className="text-white">Inverter chassis to MET</strong> — measure the inverter
              CPC continuity
            </li>
            <li>
              <strong className="text-white">Each section recorded in SoTR</strong> — section
              identifier, measured R, pass / fail (against 0.5 Ω criterion)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Polarity test before energisation. Reverse polarity at inverter input = inverter
          destroyed.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">String output</strong> — multimeter red probe on string
              positive, black on string negative. Expected: positive V_oc reading (typical 300-600 V
              for UK domestic). Negative reading = reversed string polarity at the modules /
              module-to-module connections
            </li>
            <li>
              <strong className="text-white">Combiner output</strong> — multimeter on combiner
              output positive and negative. Same expected positive reading. Reversal indicates a
              combiner internal mis-wiring
            </li>
            <li>
              <strong className="text-white">Inverter input</strong> — multimeter on inverter input
              positive and negative. Same expected positive reading. Reversal would destroy the
              inverter on energisation
            </li>
            <li>
              <strong className="text-white">Record in SoTR</strong> — measured V_oc per interface
              with confirmed polarity
            </li>
            <li>
              <strong className="text-white">Rectification before energisation</strong> — any
              reversal traced back to source; corrected; re-tested
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Measure V_oc / I_sc at test conditions. Translate to equivalent-STC. Compare against
          design.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Measure V_oc / I_sc</strong> — at test conditions,
              recorded with irradiance and ambient / cell temperature
            </li>
            <li>
              <strong className="text-white">Correct V_oc to STC</strong> — V_oc rises at low
              temperature: V_oc (STC) = V_oc (measured) − V_oc_coefficient × (25°C −
              cell_temp_at_test)
            </li>
            <li>
              <strong className="text-white">Correct I_sc to STC</strong> — I_sc rises linearly with
              irradiance: I_sc (STC) = I_sc (measured) × 1000 / measured_irradiance
            </li>
            <li>
              <strong className="text-white">Compare against design / nameplate</strong> — typical
              tolerance ±5-10% on V_oc / I_sc per string
            </li>
            <li>
              <strong className="text-white">Larger deviations</strong> — investigate per-module
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Smooth curve, V_oc and I_sc as modelled</strong> —
              install OK
            </li>
            <li>
              <strong className="text-white">"Step" partway down the curve</strong> — bypass diode
              activated; partial shading, cracked module, mismatched module
            </li>
            <li>
              <strong className="text-white">Low MPP power</strong> — module degradation or
              installation fault reducing string output below expected
            </li>
            <li>
              <strong className="text-white">Low fill factor</strong> — series resistance increase;
              loose connection, corroded connector, module damage
            </li>
            <li>
              <strong className="text-white">Low V_oc</strong> — one or more modules
              under-performing; investigate per-module
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Disconnect inverter from DC</strong> — modern
              transformerless inverters\' earth-leakage detection can interfere; disconnect to
              isolate the IR test to the array side
            </li>
            <li>
              <strong className="text-white">Short-circuit the array at the inverter end</strong> —
              join positive and negative DC conductors with a temporary jumper
            </li>
            <li>
              <strong className="text-white">Connect IR meter</strong> — between the temporary short
              (positive+negative joined) and the bonding / earth conductor
            </li>
            <li>
              <strong className="text-white">Select test voltage</strong> — 500 V DC for ≤500 V
              V_oc_max system; 1,000 V DC for higher
            </li>
            <li>
              <strong className="text-white">Apply test voltage</strong> — typically for ~10
              seconds; record the measured IR
            </li>
            <li>
              <strong className="text-white">Pass criterion</strong> — ≥1 MΩ for systems up to 100
              kW
            </li>
            <li>
              <strong className="text-white">Record in SoTR</strong> — test voltage, measured IR,
              test conditions (irradiance, ambient temperature, humidity)
            </li>
            <li>
              <strong className="text-white">Reconnect inverter</strong> — after test complete;
              verify normal inverter operation
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Step 1 — Re-test in dry conditions</strong> — if test
              conditions were humid / wet, condensation aggravates IR. Dry conditions and re-test
            </li>
            <li>
              <strong className="text-white">Step 2 — Test per string</strong> — disconnect strings
              at combiner; test each string separately. Localises fault to one string
            </li>
            <li>
              <strong className="text-white">Step 3 — Test per cable run</strong> — within the
              faulty string, disconnect and test the DC cable separately (no modules connected) and
              the modules separately. Localises to cable or module
            </li>
            <li>
              <strong className="text-white">Step 4 — Test per module</strong> — within the faulty
              section, test modules individually. Identifies the specific module with degraded
              insulation
            </li>
            <li>
              <strong className="text-white">Rectification</strong> — repair / replace the affected
              component (cable, connector, module); re-test; re-record in SoTR
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          DC isolator under load. AC RCD via test button. String fuses inspected.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">DC isolator</strong> — open under load (during daylight
              operation). Confirms BS EN 60947-3 DC-21 utilisation. Test: with array active,
              manually open the isolator; verify clean break, no sustained arc, full contact
              separation. Re-close under load; verify clean engagement
            </li>
            <li>
              <strong className="text-white">AC isolator / RCBO</strong> — test button operates:
              press the RCD test button; verify RCBO trips and disconnects the circuit. Manual trip:
              trip the RCBO by hand; verify clean operation
            </li>
            <li>
              <strong className="text-white">String overcurrent devices (if fitted)</strong> —
              visual inspection: correct rating per design pack per Reg 712.432; correct device
              standard per Reg 712.432.103 (gPV per BS EN 60269-6, BS EN 60947-3 fuse-combination,
              or DC-rated MCBs per BS EN 60947-2 / 60898-2 / IEC 60898-3); both polarities protected
              per Reg 712.432.101; secure mounting; ventilation per manufacturer spec
            </li>
            <li>
              <strong className="text-white">SPDs</strong> — visual inspection: correct type / class
              per design (Type 2 default per Reg 712.534.102.1; Type 1 only where direct-strike LPS
              separation isn\'t maintained); BS EN 61643-31 (DC) / BS EN 61643-11 (AC); I_n ≥ 5 kA
              per Reg 712.534.102.4; mounted correctly; indicator window shows healthy status
            </li>
            <li>
              <strong className="text-white">IMD (Insulation Monitoring Device)</strong> — verify
              present and operating per Reg 712.421.101.1 / 712.538.101 / BS EN 61557-8 (or
              inverter-integrated per BS EN 62109-2). Test by simulated insulation fault per
              manufacturer procedure where supported; confirm fault annunciation / inverter trip
            </li>
            <li>
              <strong className="text-white">Inverter</strong> — power-on test: confirm inverter
              starts up, identifies the array, begins MPPT tracking, exports AC. Check inverter
              telemetry for fault codes including any IMD alarms
            </li>
            <li>
              <strong className="text-white">Notices and labels</strong> — verify Reg 712.514.101
              instruction notice at origin / metering / CU; Reg 712.514.102 "SOLAR DC — Live parts
              can remain energized after isolation" at each DC access point; Reg 712.514.103
              "Isolate both AC and DC sides before servicing" on the inverter
            </li>
            <li>
              <strong className="text-white">Record in SoTR</strong> — each device tested, test
              method, result
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          SoTR is the baseline. Future EICRs compare against it. Archived for the install life.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Header</strong> — install address, MCS cert number,
              commissioning date, commissioning engineer name, test instruments used (with cal
              certs)
            </li>
            <li>
              <strong className="text-white">System overview</strong> — kWp, modules, inverter,
              strings, mounting type. Cross-reference to the design pack
            </li>
            <li>
              <strong className="text-white">Continuity</strong> — per-segment R measurements, pass
              / fail per 0.5 Ω criterion
            </li>
            <li>
              <strong className="text-white">Polarity</strong> — per-interface verification
            </li>
            <li>
              <strong className="text-white">V_oc / I_sc per string</strong> — measured at test
              conditions; corrected to STC; comparison to design
            </li>
            <li>
              <strong className="text-white">I-V curve (where measured)</strong> — per string;
              embedded image or appendix
            </li>
            <li>
              <strong className="text-white">Insulation resistance</strong> — test voltage, measured
              IR, test conditions
            </li>
            <li>
              <strong className="text-white">Functional tests</strong> — per-device result
            </li>
            <li>
              <strong className="text-white">Findings and rectifications</strong> — any
              commissioning-stage rectifications, with before / after
            </li>
            <li>
              <strong className="text-white">Sign-off</strong> — commissioning engineer signature;
              date; competency reference (MCS, scheme membership)
            </li>
          </ul>
        </ConceptBlock>

        <SoTRStructure caption="SoTR document structure — table-format layout with header (install / engineer / instruments), system overview, continuity test rows, polarity test rows, V_oc / I_sc per string rows, IR test row, functional test rows, findings & rectifications section, sign-off block. Annotated with BS EN 62446-1 reference and the baseline-for-future-EICR purpose." />
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-3-section-6')}
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-3-section-8')}
