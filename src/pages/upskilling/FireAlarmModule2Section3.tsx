...
const FireAlarmModule2Section3 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 2 · Section 3" title="Manual call points" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The human override on every fire alarm system. BS 5839-1:2025 simplifies the distance
          rules, clarifies the mounting tolerance, recommends transparent covers, and rewrites the
          stairway zoning rule. Small numbers, real consequences.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              and wheelchair users. The 1.6 m cap is the upper bound of broadly inclusive operation
              height.
            </li>
            <li>
            ...
            <li>
              <strong>Clarified in 2025.</strong> The 2017 edition stated the 1.4 m nominal but with
              less clear tolerance language; some installations interpreted "approximately 1.4 m"
              generously. The 2025 wording locks down the tolerance.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              ...
              <text x="154" y="261" textAnchor="middle" fill="black" fontSize="7" fontWeight="bold">
                FIRE
              </text>
              <text x="154" y="282" textAnchor="middle" fill="rgba(255,255,255,0.95)" fontSize="6">
                PUSH
              </text>
              ...
              <text x="92" y="358" textAnchor="end" fill="#FBBF24" fontSize="11" fontWeight="bold">
                1.4 m
              </text>
            ...
            <g>
              ...
              <rect x="640" y="160" width="20" height="120" rx="2" fill="rgba(255,255,255,0.18)" />
              ...
              <text x="615" y="320" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="9">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Type A — single-action, default.</strong> Used in most UK installations. Press
              the frangible element (a thin polycarbonate or plastic flap, or a glass element) and
              the alarm initiates. Resetting requires a key or a replacement element.
            </li>
            <li>
              <strong>Type B — double-action, malicious-activation hedge.</strong> Lift the cover,
              then press the frangible element. Two actions in under a second for a person aware of
              fire intent. The cover slows or eliminates casual or accidental triggers (a
            ...
            <li>
              ...
              double-action behaviour without specifying a different EN 54-11 type. Modern practice
              often specifies this combination.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              stairway-landing MCP → Zone 3 (third-floor accommodation). Fourth-floor → Zone 4. Etc.
            </li>
            <li>
              <strong>The reasoning.</strong> When the third-floor MCP operates, the panel's
              location indication should direct the FRS to the third floor (where the actual fire or
              near-fire is). A generic 'stairway' zone gives the FRS no useful location information.
            </li>
            <li>
              <strong>The exception — final-exit level.</strong> The MCP at the final-exit level of
              the stairway can be zoned with the stairway or with the ground-floor accommodation
              depending on design intent. Most designs use the ground-floor accommodation zone for
              consistency.
            </li>
            <li>
              <strong>The 2025 wording change.</strong> The 2017 edition referred to 'enclosed
              stairway' which some interpreted as requiring a single stairway zone. The 2025 clause
              12.1a removes the 'enclosed' qualifier and states the zoning rule directly. The change
              is a clarification, not a substantive change of design intent — but the practical
              effect on field installations is significant.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              If manual call points are located on the landings of a stairway (see 19.4), the manual
              call point on each level, other than a final exit level from the stairway, should be
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Adjacent to final exits.</strong> Place an MCP within arm-reach of every final
              exit door. A person leaving the building has a natural opportunity to operate it;
              conversely, anyone reaching the door knows an MCP is there.
            </li>
            <li>
            ...
            <li>
              ...
              label are the visual signal. Position the device so that approaching occupants see the
              red and the label well before reaching it.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Cause-and-effect.</strong> Panel triggers configured outputs — sounders, VADs,
              magnetic door release, lift homing, ventilation, ARC notification. The
            ...
            <li>
              <strong>Reset.</strong> Older designs require replacement of the frangible element (a
              stock spare part). Modern designs use a key-reset that resets the latching switch and
              re-arms the device for re-use without replacement. The element is typically a
            ...
            <li>
              ...
              action. The 2025 edition emphasises the false-alarm investigation workflow (clause 29)
              — see Section 5 of this module.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <ol className="list-decimal pl-5 space-y-2 text-[14px]">
            ...
            <li>
              ...
              m to 1.6 m measured to the operating element. Refurbishments routinely lift floors and
              bring devices below 1.1 m, or relocate to satisfy a finishes plan and break the BS
            ...
            <li>
              <strong>Cover variant inconsistency.</strong> A site mixing Type A (single-action) and
              Type B (covered) call points without a documented reason is a finding. The fire risk
              assessment should justify Type B (e.g. a school where deliberate operation is a known
              risk); without that justification, Type A throughout is the default.
            </li>
          </ol>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-2/section-4')}
