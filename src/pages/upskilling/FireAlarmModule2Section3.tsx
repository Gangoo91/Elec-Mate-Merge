...
const DESCRIPTION =
  'Learn about manual call point types, siting requirements per BS 5839-1, exit route positioning, and accessibility considerations.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'BS 5839-1 specifies MCPs should be mounted between 1.2 m and 1.4 m from finished floor level, typically at 1.4 m for consistency and accessibility.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'BS 5839-1 recommends that no person should have to travel more than 45 metres on any single level to reach a manual call point.',
  },
  {
    id: 'mcp-resettable',
    ...
    correctIndex: 1,
    explanation:
      'Resettable MCPs can be activated for testing and then reset with a key without needing replacement glass elements, reducing maintenance costs and delays.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'BS 5839-1 specifies MCPs should be mounted between 1.2 m and 1.4 m from finished floor level.',
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      'BS 5839-1 recommends no more than 45 metres travel distance on any single level to reach an MCP.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'MCPs should be positioned adjacent to exit doors on the exit route side so people can raise the alarm as they leave.',
  },
  {
    id: 4,
    ...
    correctAnswer: 2,
    explanation:
      'Standard fire alarm MCPs are red. Yellow is used for gas release, green for emergency door release.',
  },
  {
    id: 5,
    question:
      'Which type of manual call point can be reset after activation without replacement parts?',
    options: ['Break glass', 'Resettable (plastic element)', 'Both types equally', 'Neither type'],
    correctAnswer: 1,
    explanation:
      'Resettable MCPs use a plastic element that can be pushed and reset with a key, avoiding the need for replacement glass.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Each zone should have indication of which device activated, either at the control panel or via zone plan location.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'The standard 1.2 m to 1.4 m range is accessible for most wheelchair users. Lower mounting may be considered in specific cases.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Protective covers deter accidental or malicious false alarms while still allowing genuine activation. They also provide an audible warning when lifted.',
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      'M category systems rely solely on manual call points for fire alarm activation, with no automatic detection.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Break glass MCPs require the glass element to be replaced before the system can be properly reset and returned to service.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Yes - manual call points are required in all categories (L and P) to allow anyone discovering a fire to raise the alarm immediately.',
  },
  {
    question: 'Can MCPs be mounted on columns instead of walls?',
    answer:
      'Yes - provided they are clearly visible, accessible, and at the correct height. Ensure adequate signage directs people to them.',
  },
  {
    question: 'What about outdoor MCPs for loading bays?',
    answer:
      'Weatherproof MCPs are available for external use. Ensure they are clearly visible and protected from physical damage.',
  },
  {
    question: 'How often should MCPs be tested?',
    answer:
      'Weekly functional testing on rotation per BS 5839-1, with annual inspection and servicing of all units.',
  },
  {
    question: 'Are break glass MCPs still acceptable?',
    answer:
      'Yes - both break glass and resettable types comply with standards. Many organisations prefer resettable for maintenance convenience.',
  },
  {
    question: 'Can I use different coloured MCPs for different purposes?',
    answer:
      'Yes - red for fire, yellow for gas release, green for emergency door release. Ensure clear labelling and staff training.',
  },
];
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Height:</strong> 1.2 m to 1.4 m from finished floor level
              </li>
              <li>
                <strong>Max travel distance:</strong> 45 metres on any single level
              </li>
              <li>
                <strong>Position:</strong> Adjacent to exit doors on exit route side
              </li>
              <li>
                <strong>Colour:</strong> Red for fire alarm activation
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Every final exit must have adjacent MCP
              </li>
              <li>
                <strong>Use:</strong> Resettable types reduce maintenance costs
              </li>
              <li>
                <strong>Apply:</strong> Protective covers deter false alarms
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Manual call points (MCPs) allow anyone who discovers a fire to immediately raise the
              alarm without waiting for automatic detection. They are required in all fire alarm
              system categories.
            </p>
            <p>
              MCPs provide a simple, recognisable means of activation that requires no training -
              the "break glass and push" or "lift and push" action is intuitive for building
              occupants.
            </p>

            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm text-white">
                <strong>Key Principle:</strong> MCPs allow human detection to supplement or replace
                automatic detection. Even in fully automatic systems, a person may discover a fire
                before detectors activate.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <p>
              Both types comply with BS EN 54-11. The choice often depends on maintenance
              considerations and false alarm risk in the environment.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BS 5839-1 provides clear guidance on MCP positioning to ensure they are accessible,
              visible, and positioned where people will naturally pass during evacuation.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                ...
                <li>
                  <strong>Travel distance:</strong> Maximum 45 m on any single level
                </li>
                <li>
                  <strong>Exit position:</strong> Adjacent to exit doors on exit route side
                </li>
                <li>
                  <strong>Floor level changes:</strong> At each storey exit point
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm text-white">
                <strong>Exit Door Rule:</strong> Position the MCP on the exit route side of the
                door, so people can activate it as they leave - not on the side they are evacuating
                from.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The 45 metre maximum travel distance ensures that anyone on a floor level can reach an
              MCP without excessive travel. This is measured as walking distance, not straight-line
              distance.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow mb-2">
                Planning MCP Distribution:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm text-white">
                <strong>Practical Note:</strong> In open plan areas, 45 m radius coverage is often
                achievable. In areas with partitions and corridors, the walking route must be
                calculated.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Different coloured call points serve different functions. This colour coding is
              essential to prevent confusion and ensure correct response.
            </p>
            ...
            <p>
              Always ensure clear labelling accompanies colour coding to prevent confusion in
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              In areas prone to accidental or malicious activation, protective measures can reduce
              unwanted alarms whilst maintaining accessibility.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Hinged covers:</strong> Must be lifted before activation - provides
                  audible warning
                </li>
                <li>
                  <strong>Lockable covers:</strong> For high-risk areas - staff carry keys
                </li>
                <li>
                  <strong>CCTV monitoring:</strong> Deters malicious activation
                </li>
                <li>
                  <strong>Double-knock activation:</strong> Two-stage operation required
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-lg bg-orange-500/10 border-l-2 border-orange-500/50">
              <p className="text-sm text-white">
                <strong>Warning:</strong> Protective measures must not prevent genuine activation.
                Any cover must be easily operated without tools by anyone, including those with
                limited dexterity.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Always position MCPs where people will naturally pass during evacuation - not
                  tucked away in corners
                </li>
                <li>
                  Consider sightlines - an MCP hidden behind an open door or column is ineffective
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Wrong side of door:</strong> MCP should be on exit route side, not the
                  side people evacuate from
                </li>
                <li>
                  <strong>Exceeding travel distance:</strong> Always check worst-case walking
                  routes, not straight lines
                </li>
                <li>
                  <strong>Overly restrictive covers:</strong> Protection should deter, not prevent,
                  activation
                </li>
              </ul>
            </div>
