...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 2,
    explanation:
      'BS 7671 requires that customers receive their installation certificate and associated documentation within 28 days of installation completion.',
  },
  {
...
const faqs = [
  {
    ...
    answer:
      'Providing the certificate is a legal requirement. The customer must be informed that without it, they have no proof of compliance and may face insurance and legal issues. The installation is not complete until certificate handover.',
  },
  {
    question: "What happens if test results don't meet the required standards?",
    answer:
      'The installation cannot be certified until all test results are satisfactory. Investigate and rectify any failures, then retest. Only issue the certificate when all tests pass the required standards.',
  },
  {
    question: 'How long should certificates and test results be retained?',
    answer:
      'Certificates and test results must be retained for the lifetime of the installation. Recommend customers keep copies in a safe place and consider digital backups for long-term storage.',
  },
  {
    question: 'Is notification to Building Control always required?',
    answer:
      'Notification is required unless the work is carried out by a competent person registered with an approved scheme. Most EV charging installations by registered electricians are self-certifying under Building Regulations Part P.',
  },
];
...
const EVChargingModule6Section6 = () => {
  useSEO({
    ...
    description:
      'Master certification completion, test sheet documentation, and handover pack preparation for EV charging installations. Ensure compliance and professional delivery.',
  });
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Certificate:</strong> EIC required by BS 7671 and Part P
              </li>
              <li>
                <strong>Deadline:</strong> Documentation within 28 days
              </li>
              <li>
                <strong>Retention:</strong> Lifetime of installation
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Building Control:</strong> Notification or self-cert
              </li>
              <li>
                <strong>Competent person:</strong> Must sign certificate
              </li>
              <li>
                <strong>Test records:</strong> All results documented
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The EIC is a legal document required by BS 7671 for all new installations. It confirms
              the installation complies with regulations and is safe for use.
            </p>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/20">
                    ...
                    <th className="text-left py-2 text-elec-yellow/80 font-medium">
                      Example Result
                    </th>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A professional handover package includes all documentation the customer needs for safe
              operation, maintenance, and future reference.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Delayed certificates:</strong> — must be within 28 days legally
                </li>
                <li>
                  <strong>Missing signatures:</strong> — invalidates the certificate
                </li>
                <li>
                  <strong>Incomplete test results:</strong> — all tests must be recorded
                </li>
                <li>
                  <strong>No limitation notes:</strong> — record any access restrictions
                </li>
              </ul>
            </div>
          </div>
