...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Decorative and facade lighting is a typical non-critical load that can be safely shed during peak demand periods without affecting safety, comfort, or essential building operations.',
  },
  {
...
const faqs = [
  {
    ...
    answer:
      'Demand-based control continuously adjusts equipment output to match actual requirements, while load shedding temporarily disconnects non-critical loads when demand exceeds safe or cost-effective limits. Demand control is proactive optimization; load shedding is reactive protection.',
  },
  {
    question: 'Which loads should never be included in load shedding schemes?',
    answer:
      "Life safety systems (fire alarms, emergency lighting, smoke extract), critical process equipment, security systems, and essential HVAC for server rooms or medical facilities must never be shed. These must be on dedicated circuits clearly marked as 'NO LOAD SHED'.",
  },
  {
    question: 'How quickly should load shedding respond to peak demand conditions?',
    answer:
      'Most utility demand charges are calculated on 15-30 minute rolling averages, so load shedding must respond within 30 seconds to 2 minutes to be effective. Response time from shed command to actual load disconnection should be tested and verified.',
  },
  {
    question: 'What happens if load shedding fails during a peak demand event?',
    answer:
      'The building may exceed its contracted maximum demand, triggering significant penalty charges from the utility. In severe cases, it could cause transformer overload, equipment damage, or even trigger utility disconnection. Proper failsafe design and regular testing are essential.',
  },
];
...
const BMSModule3Section4 = () => {
  useSEO({
    ...
    description:
      'Master demand-based control and load shedding strategies in BMS. Learn peak load management, energy optimisation, load prioritisation, and real-time demand response for maximum efficiency.',
  });
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Demand Control:</strong> Real-time adjustment to actual needs
              </li>
              <li>
                <strong>Load Shedding:</strong> Strategic reduction during peaks
              </li>
              <li>
                <strong>Energy Savings:</strong> 20-50% possible with proper implementation
              </li>
              <li>
                <strong>ROI:</strong> Often recovered in 3-6 months
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Power meters, load control contactors, priority labels
              </li>
              <li>
                <strong>Use:</strong> Reducing utility demand charges, protecting equipment
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Demand-based control represents a fundamental shift from fixed-schedule operation to
              intelligent, responsive energy management. The system continuously monitors actual
              demand and adjusts equipment output accordingly.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Occupancy-Based:</strong> PIR/CO2 sensors, 1-5 min response, 20-40%
                  savings
                </li>
                <li>
                  <strong>Temperature Reset:</strong> External sensors, 5-15 min response, 15-25%
                  savings
                </li>
                <li>
                  <strong>Load-Based:</strong> Flow/pressure sensors, 30s-2 min response, 25-45%
                  savings
                </li>
                <li>
                  <strong>Predictive:</strong> Weather/schedule data, 1-4 hour lookahead, 30-50%
                  savings
                </li>
              </ul>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>HVAC:</strong> Mild weather reduces chiller demand by 30%
                  </li>
                  <li>
                    <strong>Ventilation:</strong> 40% occupancy = 60% airflow
                  </li>
                  <li>
                    <strong>Boilers:</strong> 200kW needed of 600kW = 2 boilers off
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Trim and Respond:</strong> Reduce until zone calls
                  </li>
                  <li>
                    <strong>Optimal Start/Stop:</strong> Calculate start time
                  </li>
                  <li>
                    <strong>Adaptive Control:</strong> Learn building characteristics
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Load shedding activates when overall demand threatens to exceed limits - either the
              building's design capacity or thresholds where electricity costs rise sharply.
              Strategic load shedding protects critical systems while minimising operational
              disruption.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Load Classification and Priority Levels:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Critical (Never Shed):</strong> Fire systems, emergency lighting, life
                  safety
                </li>
                <li>
                  <strong>Essential (Never Shed):</strong> Main chillers, primary pumps, core HVAC
                </li>
                <li>
                  <strong>Important (3rd to shed, 2-4hr max):</strong> Office HVAC, general lighting
                </li>
                <li>
                  <strong>Discretionary (2nd to shed, 8+ hr):</strong> Electric heating, some
                  ventilation
                </li>
                <li>
                  <strong>Deferrable (1st to shed, indefinite):</strong> Decorative lighting,
                  irrigation
                </li>
              </ul>
            </div>
            ...
            <div className="grid sm:grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent border border-white/10">
                ...
                <p className="text-white text-xs">Decorative, car park, corridors</p>
              </div>
              <div className="p-3 rounded bg-transparent border border-white/10">
                <p className="font-medium text-white mb-1">HVAC</p>
                <p className="text-white text-xs">Electric reheat, toilet extract, car park vent</p>
              </div>
              <div className="p-3 rounded bg-transparent border border-white/10">
                <p className="font-medium text-white mb-1">Ancillary</p>
                <p className="text-white text-xs">HW pumps, irrigation, non-critical motors</p>
              </div>
            </div>

            <div className="my-6">
              <p className="text-sm font-medium text-red-400/80 mb-2">
                Automatic Shedding Triggers:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Electricians are fundamental to enabling demand-based strategies through proper
              installation, wiring, and labelling of control systems. Their work directly impacts
              system safety, reliability, and effectiveness.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Sensor Installation:</strong> Temperature, flow, power monitoring with
                  appropriate cabling
                </li>
                <li>
                  <strong>Load Control Devices:</strong> Relays, contactors, smart switches for BMS
                  control
                </li>
                <li>
                  <strong>Circuit Segregation:</strong> Clear separation of safety-critical vs
                  sheddable circuits
                </li>
                <li>
                  <strong>Documentation:</strong> Clear labelling and as-built drawings with
                  priority levels
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Proper commissioning ensures demand control and load shedding systems operate safely
              and effectively. Testing must verify both automatic operation and manual override
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Step 1:</strong> Pre-testing verification of wiring, labelling, and
                  protection
                </li>
                <li>
                  <strong>Step 2:</strong> Individual circuit testing for correct operation
                </li>
                <li>
                  <strong>Step 3:</strong> Demand threshold testing with simulated high loads
                </li>
                <li>
                  <strong>Step 4:</strong> Sequence and priority testing - correct shed order
                </li>
                <li>
                  <strong>Step 5:</strong> Manual override testing and emergency restoration
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-white mb-6">
            Case Study: Data Centre Load Shedding
          </h2>
          <div className="space-y-4">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm text-white">
                <strong>Challenge:</strong> 500-rack data centre with £40,000/month demand charges
                due to peak loads exceeding contracted capacity during summer cooling. Required 100%
                IT uptime maintained.
              </p>
            </div>
        ...
        <section className="mb-10 mt-12">
          <SingleQuestionQuiz title="Test Your Knowledge" questions={bmsModule3Section4QuizData} />
        </section>
