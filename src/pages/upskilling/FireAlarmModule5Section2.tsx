...
const FireAlarmModule5Section2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 5 · Section 2" title="Control panel installation" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The Control and Indicating Equipment is the single most important physical asset in the
          system. BS 5839-1:2025 codifies its siting, mounting, mains supply, batteries, earthing,
          cyber security and labelling — all of which the installer must get right before
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              Reception staff are the operator under normal conditions; the CIE is in their line of
              sight or within a few paces.
            </li>
            <li>
            ...
            <li>
              <strong>Unobstructed approach.</strong> No stored items, no locked doors that require
              a key the FRS does not have, no chairs in front of the panel. This is a management
              duty under the RRO 2005; the contractor highlights and records, the Responsible Person
              maintains.
            </li>
            <li>
              <strong>Adequate lighting.</strong> Including emergency lighting per BS 5266-1 so the
              panel is readable on mains failure.
            </li>
            <li>
              <strong>Temperature and environment.</strong> Within the CIE’s rated operating range.
              Most CIEs are designed for indoor environments; outdoor or high-temperature
              environments need a rated enclosure or a different siting.
            </li>
            <li>
              <strong>Ambient noise.</strong> Quiet enough for the audible CIE buzzer to be heard. A
              panel in a noisy plant room is not heard until the operator passes by.
            </li>
            <li>
          ...
          <p>
            ...
            FRS-access wins. The operator is the secondary user; the FRS arriving in an emergency is
            the primary user.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              manufacturer instruction; resin-anchored on lightweight blocks where pull-out strength
              is critical.
            </li>
            <li>
              <strong>Plumb and level.</strong> The CIE is read at an angle; tilted mounting creates
              parallax error.
            </li>
            <li>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="410" y="30" textAnchor="middle" fill="#FBBF24" fontSize="13" fontWeight="bold">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              captive lock-off clip). The lock-off is fitted only when isolation is actually
              required (under permit-to-work for maintenance). It is not fitted as "always on"
              decoration.
            </li>
            <li>
              <strong>Accessible only to authorised personnel.</strong> The distribution board is in
              a riser, plant room or lockable cupboard. Occupants do not have routine access.
            </li>
            <li>
              <strong>Position in the supply hierarchy.</strong> Fed from before any local switching
              device that could be operated by an occupant in error. A switched-fused spur in a
              corridor, accessible to anyone, is not acceptable.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Type.</strong> VRLA (valve-regulated lead-acid), sealed, designed for stand-by
              use. Specific manufacturer family per the CIE specification.
            </li>
            <li>
              ...
              (de-rating below 20 °C). Standby duration typically 24 h followed by 30 min alarm for
              Category L systems with ARC monitoring; longer for systems without ARC. Specific
            ...
            <li>
              <strong>Cabling to CIE.</strong> Sized for the maximum charge / discharge current with
              margin. Polarity verified before energising — wrong polarity damages the CIE charging
              circuit.
            </li>
            <li>
          ...
          <p>
            Battery replacement runs to a schedule typically every 4 years (manufacturer-specific).
            The dated install label is the lifecycle anchor; without it the maintainer is guessing.
            Service visits (every 6 months per §22 / clause 43.2.1) check battery condition and
            replace as needed.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Physical lock-off of the comms cabinet.</strong> The cabinet that contains the
              CIE network connection is locked. An attacker cannot plug a rogue laptop into the
              network port without opening a locked cabinet — a discrete and detectable action.
            </li>
            <li>
              <strong>Anti-tamper plugs on patch leads.</strong> The RJ45 (or other connector) going
              into and out of the CIE network port has an anti-tamper sleeve that prevents covert
              removal and re-plugging. Tampering leaves visible evidence.
            </li>
            <li>
              <strong>Authentication of remote-connection requests.</strong> Before remote access is
              allowed, the CIE or gateway software authenticates the request — typically
            ...
            <li>
              <strong>Risk assessment for remote service.</strong> Before any remote read / control
              / write operation, a risk assessment evaluates the potential impact on CIE operation.
              Remote service that compromises the CIE during execution is not acceptable.
            </li>
            <li>
              <strong>Post-service operability check.</strong> The responsible individual ensures
              the system is fully operational on completion of the remote service. A remote service
              that ends with the CIE in a non-operational state is an explicit failure of the
              clause.
            </li>
            <li>
              <strong>Documented in the logbook.</strong> Remote service events are recorded — what
              was done, by whom, when, with what authentication, and the post-service operability
              confirmation.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              anti-tamper plugs to patch leads. A method of authentication of a request to accept a
              remote connection should be included in the CIE or gateway software before remote
              access is allowed.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>ARC contact.</strong> ARC name (or simply "ARC") and the telephone number that
              premises management calls before testing. The number must be the live, in-service ARC
              number at the time of fitment.
            </li>
            <li>
              <strong>Position.</strong> Fixed on or adjacent to the CIE so it is the first thing a
              person looking at the panel reads. Not behind, not below floor furniture, not covered.
            </li>
            <li>
            ...
            <li>
              <strong>Update procedure.</strong> If the ARC contract changes, the label is updated.
              The logbook records the update.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>CIE identification.</strong> Manufacturer, model, serial number, installation
              date (often on a separate plate or inside the door).
            </li>
            <li>
              ...
              one zone per BS 5839-1:2025 §22.2.5; absence is now NOT an acceptable variation under
              §6 in multi-zone premises (especially sleeping risk).
            </li>
            <li>
            ...
            <li>
              <strong>FRS access signage.</strong> External and internal signage pointing to the CIE
          ...
          <p>
            ...
            gaps for inspection. Better practice: produce the label set as part of the install pack,
            apply at completion, photograph and record. The labels are part of the system, not a
            tidy-up afterthought.
          </p>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-5/section-3')}
