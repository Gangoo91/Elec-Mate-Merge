...
const inlineChecks = [
  {
    ...
    question: 'The string inverter topology — what is it?',
    options: [
  ...
  },
  {
    ...
    question: 'The microinverter topology — what is it?',
    options: [
  ...
  },
  {
    ...
    question: 'The power optimiser topology — what is it?',
    options: [
  ...
  },
  {
    ...
    question: 'The hybrid inverter topology — what does it integrate?',
    options: [
  ...
  {
    id: 'm2s5-bs-en-62109',
    question: 'BS 7671 references a specific product standard for inverters. Which?',
    options: [
...
const faqs = [
  ...
  {
    question: "What's the typical UK pricing for the four topologies per W of array?",
    answer:
  ...
  {
    question: 'BS EN 62109-1 and BS EN 62109-2 — what do they actually cover?',
    answer:
  ...
  {
    question: 'What is "rapid shutdown" and when is it required?',
    answer:
  ...
  {
    question: 'How does anti-islanding work in PV inverters?',
    answer:
  ...
  {
    question: 'What does the inverter\'s "European efficiency" rating actually measure?',
    answer:
  ...
  {
    question: 'How does Reg 551.7.1(d) practically affect where I connect the PV inverter?',
    answer:
  ...
  {
    question: 'How long do PV inverters last vs PV modules?',
    answer:
  ...
  {
    question: 'Are G83/1 and G59/1 still the DNO connection requirements for PV inverters in 2026?',
    answer:
...
export default function RenewableEnergyModule2Section5() {
  ...
  useSEO({
    title: 'Inverter topologies | Renewable Energy 2.5 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 5 · BS 7671:2018+A4:2026"
        title="Inverter topologies"
        backTo="../renewable-energy-module-2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          String, microinverter, power optimiser and hybrid inverters — how each works, where each
          wins, the cost-yield-reliability trade-offs, and the BS 7671 / BS EN 62109 framing that
          applies to inverter selection and connection.
        </p>
        ...
        <Pullquote>
          String for simplicity. Microinverter for module-level optimisation. Hybrid for PV plus
          battery.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Architecture</strong> — DC string from modules → DC
              isolator → inverter input. MPPT performed by the inverter. DC-AC conversion in the
              inverter. AC output to grid via dedicated consumer unit circuit
            </li>
            <li>
              <strong className="text-white">MPPT inputs</strong> — typically 1, 2 or 3 independent
              MPPTs on a single inverter (Section 2.4 covers multi-MPPT)
            </li>
            <li>
              <strong className="text-white">Typical residential cost</strong> — £200–280 per kW of
              array
            </li>
            <li>
              <strong className="text-white">Wins on</strong> — clean single-orientation arrays,
              matched-module strings, cost-sensitive customers, simple roof geometries
            </li>
            <li>
              <strong className="text-white">Loses on</strong> — multi-orientation arrays (mismatch
              losses without enough MPPT inputs), heavy partial shade, installs where module-level
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              ...
              microinverter on rear → AC daisy-chain to next module → ... → AC trunk cable →
              consumer unit
            </li>
            <li>
              <strong className="text-white">Module-level MPPT</strong> — each module operates at
              its own MPP independent of all other modules. Eliminates string-level mismatch losses
              entirely
            </li>
            <li>
              <strong className="text-white">No high-voltage DC on the roof</strong> — the AC trunk
              operates at 230 V AC; if a module is to be removed, isolating the AC trunk and
              disconnecting the relevant connectors is straightforward
            </li>
            <li>
              <strong className="text-white">Typical residential cost</strong> — £500–650 per kW of
              array (significantly higher than string inverter)
            </li>
            <li>
              <strong className="text-white">Wins on</strong> — heavily-shaded arrays,
              multi-orientation arrays, BIPV / complex roof geometries, installs where module-level
              monitoring and rapid shutdown are required, installs where eliminating the
              central-inverter single point of failure matters
            </li>
            <li>
              <strong className="text-white">Loses on</strong> — cost-sensitive installs, arrays
              where mismatch is minimal (no payback for the per-module hardware), installs in
              extreme climate (microinverter reliability degrades at sustained high temperatures)
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Architecture</strong> — Module + power optimiser on
              rear → DC string at fixed optimised voltage → central inverter → AC output. Optimiser
              does MPPT; central inverter does only DC-AC conversion (no MPPT)
            </li>
            <li>
              <strong className="text-white">Module-level MPPT</strong> — each module operates at
              its own MPP via its dedicated DC-DC stage. Eliminates string-level mismatch (like
              microinverters)
            </li>
            <li>
              <strong className="text-white">Per-module monitoring and rapid shutdown</strong> — the
              optimiser communicates with the central inverter, providing per-module power data and
              the ability to bring the array to rapid- shutdown voltage on command
            </li>
            <li>
              <strong className="text-white">DC string retained</strong> — the familiar
              string-inverter installation pattern; the central inverter still exists (and can still
              fail, taking down the array)
            </li>
            <li>
              <strong className="text-white">Typical residential cost</strong> — £400–500 per kW of
              array (between string and microinverter)
            </li>
            <li>
              <strong className="text-white">Wins on</strong> — partial-shade arrays where
              module-level MPPT is wanted but a string inverter architecture is preferred; installs
              requiring per-module monitoring; installs requiring rapid shutdown without going to
              microinverters
            </li>
            <li>
              <strong className="text-white">Loses on</strong> — clean arrays where mismatch is
              minimal (no payback); installs where central-inverter SPOF must be eliminated
              (microinverter wins those)
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Architecture</strong> — PV string(s) → DC-DC stage with
              MPPT → common DC bus → battery DC-DC stage with battery management → DC-AC inverter
              stage → grid AC output. Backup port (where fitted) provides AC supply to dedicated
              loads during a grid outage
            </li>
            <li>
              <strong className="text-white">Combines two products into one</strong> — replaces a
              separate PV inverter + separate battery inverter, lower hardware cost overall, fewer
              components to fail
            </li>
            <li>
              <strong className="text-white">DC-coupled architecture</strong> — energy from PV to
              battery stays on the DC side, avoiding the DC→AC→DC conversion losses of an AC-coupled
              BESS retrofit (Section 2.7 covers this in detail)
            </li>
            <li>
              <strong className="text-white">Typical residential cost</strong> — PV-only hybrid
              ~£350–450 per kW; hybrid + battery ~£800–1,200 per kW depending on battery capacity
            </li>
            <li>
              <strong className="text-white">Wins on</strong> — PV+BESS installs (the natural
              choice); future-proofing for BESS retrofit (install hybrid now, add battery later);
              installs requiring backup-power capability during grid outages
            </li>
            <li>
              <strong className="text-white">Loses on</strong> — PV-only installs where no battery
              is planned (slight cost premium over PV-only string inverter); AC-coupled retrofit
              installs (where the existing PV inverter is being kept and only the battery is being
              added)
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">BS EN 62109-1</strong> — general safety requirements
              for power conversion equipment used in PV systems. Construction, isolation, marking,
              documentation, mechanical / thermal / electrical hazards.
            </li>
            <li>
              <strong className="text-white">BS EN 62109-2</strong> — particular requirements for
              inverters. Output isolation, anti-islanding (links to Section 551), DC residual
              current monitoring where applicable, inverter- specific test methodology.
            </li>
            <li>
              <strong className="text-white">Installer verification</strong> — checking manufacturer
              documentation, markings, and certification before connection. The verification is
              documentary; the cert evidence bundle retains the verification record.
            </li>
            <li>
              <strong className="text-white">MCS Product List</strong> — also requires BS EN 62109
              conformity as part of the inverter product approval; for funded installs the MCS
              Product List entry is the second layer of verification
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Type AC is not appropriate for inverter circuits. Type A minimum; Type B for
          transformerless.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Type AC</strong> — detects sinusoidal AC residual
              currents only. NOT appropriate for circuits with DC-component sources per Reg 531.3.3.
            </li>
            <li>
              <strong className="text-white">Type A</strong> — detects sinusoidal AC and pulsating
              DC residual currents (up to a defined threshold). Acceptable where smooth DC residual
              currents cannot occur.
            </li>
            <li>
              <strong className="text-white">Type F</strong> — Type A plus detection of composite
              high-frequency residual currents from variable-frequency drives. Useful where mixed
              power-electronics on the same circuit.
            </li>
            <li>
              <strong className="text-white">Type B</strong> — full DC-sensitive detection including
              smooth DC residual currents. In accordance with BS EN 62423 or BS EN 60947-2. Required
              for PV inverters by default, except where one of the three exceptions applies.
            </li>
          </ul>
          <p>The three exceptions to the Type B requirement:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Exception (a) — Internal simple separation</strong>.
              The PCE (Power Conversion Equipment / inverter) provides at least simple separation
              between the AC and DC sides internally. Where this is documented by the manufacturer,
              Type B is not required.
            </li>
            <li>
              <strong className="text-white">
                Exception (b) — External transformer separation
              </strong>
              . A transformer with separate windings provides the simple separation externally. The
              PV inverter feeds a dedicated isolating transformer; the RCD downstream may be other
              than Type B.
            </li>
            <li>
              <strong className="text-white">Exception (c) — Manufacturer declaration</strong>. The
              PCE manufacturer explicitly states Type B is not required for the specific product.
              The manufacturer\'s statement / documentation must be obtained and retained as
              evidence to justify the non-Type-B selection.
            </li>
          </ul>
          <p>The selection process:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              Read the inverter datasheet for the required RCD type and any exception statements
            </li>
            <li>
              Modern transformerless PV inverters typically include internal DC residual current
              monitoring (an RDC-DD — Residual Direct Current Detecting Device), which often
              qualifies for Exception (c) — &ldquo;Type A acceptable, Type B not required&rdquo; per
              manufacturer documentation
            </li>
            <li>
              Where none of the three exceptions applies, Type B is mandatory per BS EN 62423 or BS
              EN 60947-2
            </li>
            <li>
              Type B RCDs cost £150–300 more than Type A on a residential consumer unit — the
              manufacturer declaration that allows Type A is a material BoM saving where applicable
            </li>
            <li>
              Cert evidence bundle retains the manufacturer\'s statement justifying any non-Type-B
              selection
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Leakage interaction</strong> — an inverter connected
              downstream of a general RCD shares the RCD\'s 30 mA threshold with other loads,
              potentially causing nuisance tripping from cumulative leakage
            </li>
            <li>
              <strong className="text-white">Protection coordination</strong> — on a fault upstream
              of the inverter, the shared RCD may not provide the intended protection because the
              inverter\'s fault current behaviour is different from a passive load\'s
            </li>
            <li>
              <strong className="text-white">DNO interface</strong> — the inverter is a generating
              set under Section 551 (Reg 551.1.1(d) — covered in Section 2.1); its output protection
              arrangement must satisfy Section 551 rules, not just general consumer-unit RCD rules
            </li>
          </ul>
          <p>The standard arrangement on a residential consumer unit:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              Dedicated inverter circuit on its own RCBO (Type A or Type B per inverter datasheet)
            </li>
            <li>
              RCBO sized to the inverter\'s maximum AC output current (with appropriate margin)
            </li>
            <li>
              Lockable / labelled isolator at the inverter location for safe-isolation during
              maintenance
            </li>
            <li>
              Cert evidence bundle records the RCBO type, the inverter datasheet RCD specification,
              and the dedicated-circuit arrangement
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          >
            ...
            <div className="mt-1 text-[14px] font-semibold text-white truncate">MPPT</div>
          </button>
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-2-section-6')}
