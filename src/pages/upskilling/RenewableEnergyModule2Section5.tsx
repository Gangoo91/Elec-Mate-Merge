  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Combiner boxes combine multiple string outputs into a single connection to the inverter.',
    },
    {
      question: 'Where should DC isolators be located?',
      options: [
        'Inside the building only',
        'Near the PV array, accessible and visible',
        'At the distribution board',
        'Underground',
      ],
      correctAnswer: 1,
      explanation:
        'DC isolators should be located near the PV array and be accessible and visible for safety.',
    },
    {
      ...
      options: [
        ...
        'Stop grid export',
        'Prevent generation during grid outage',
        'Limit current',
      ],
      correctAnswer: 2,
      explanation:
        'Anti-islanding protection prevents the system from generating power during grid outages to protect utility workers.',
    },
    {
    ...
    },
    {
      ...
      options: [
        'Faster inverter startup',
        'Voltage reduction to less than 80V within 10 seconds',
        'Higher system efficiency',
        'Better monitoring',
      ],
      correctAnswer: 1,
      explanation:
        'Rapid shutdown systems reduce voltage to less than 80V within 10 seconds for firefighter safety.',
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'Module-level architecture with microinverters or optimisers provides panel-level MPPT and monitoring.',
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'AC coupling allows battery storage to work with any existing inverter, making retrofits easier.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'IEC 60364 is the international standard for electrical installations including grid-connected PV systems.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Modbus RTU/TCP is the industrial standard protocol for PV system monitoring and integration.',
    },
    {
      ...
      options: [
        ...
        'Automatic reset',
        'Being locked in open position',
        'Wireless control',
      ],
      correctAnswer: 2,
      explanation:
        'Isolation devices must be lockable in the open position to ensure safe working conditions during maintenance.',
    },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 pb-24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">String cables:</strong> DC panel connections
                  </li>
                  <li>
                    • <strong className="text-white">Combiner boxes:</strong> Multiple strings
                  </li>
                  <li>
                    • <strong className="text-white">DC isolators:</strong> Safety isolation
                  </li>
                  <li>
                    • <strong className="text-white">Surge protection:</strong> DC SPDs
                  </li>
                  <li>
                    • <strong className="text-white">Monitoring:</strong> Current/voltage
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Panel strings:</strong> Series-connected
                  </li>
                  <li>
                    • <strong className="text-white">String routing:</strong> Array to inverter
                  </li>
                  <li>
                    • <strong className="text-white">Polarity:</strong> Separate DC+/DC-
                  </li>
                  <li>
                    • <strong className="text-white">Grounding:</strong> EGC conductor
                  </li>
                  <li>
                    • <strong className="text-white">Labelling:</strong> Clear circuit ID
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Inverters:</strong> DC to AC conversion
                  </li>
                  <li>
                    • <strong className="text-white">AC isolators:</strong> Load-break switches
                  </li>
                  <li>
                    • <strong className="text-white">Generation meters:</strong> PV output
                  </li>
                  <li>
                    • <strong className="text-white">Distribution boards:</strong> Protection
                  </li>
                  <li>
                    • <strong className="text-white">Grid connection:</strong> Export meter
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Inverter output:</strong> Single/three-phase
                  </li>
                  <li>
                    • <strong className="text-white">AC isolation:</strong> Switching/protection
                  </li>
                  <li>
                    • <strong className="text-white">Metering:</strong> Generation/consumption
                  </li>
                  <li>
                    • <strong className="text-white">Distribution:</strong> Loads and export
                  </li>
                  <li>
                    • <strong className="text-white">Protection:</strong> RCD and OCPD
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="mb-8 mt-8">
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <ul className="text-sm space-y-1">
                <li>
                  • <strong className="text-white">AC coupling:</strong> Battery on AC side - works
                  with any inverter
                </li>
                <li>
                  • <strong className="text-white">DC coupling:</strong> Direct DC connection -
                  higher efficiency
                </li>
                <li>
                  • <strong className="text-white">Critical loads:</strong> Backup power circuit
                  design
                </li>
              </ul>
            </div>
        ...
        <div className="mb-8 mt-8">
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/30">
              ...
              <ul className="text-sm space-y-1">
                <li>
                  • <strong className="text-white">DC isolators:</strong> Near PV array, accessible
                  and visible
                </li>
                <li>
                  • <strong className="text-white">AC isolators:</strong> Before distribution board
                  connection
                </li>
                <li>
                  • <strong className="text-white">Emergency isolation:</strong> Rapid shutdown
                  capability
                </li>
                <li>
                  • <strong className="text-white">Maintenance isolation:</strong> Safe working
                  procedures
                </li>
                <li>
                  • <strong className="text-white">Grid isolation:</strong> DNO-controlled main
                  switch
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">DC cables:</strong> Red (+), Black (-)
                  </li>
                  <li>
                    • <strong className="text-white">AC cables:</strong> Standard coding
                  </li>
                  <li>
                    • <strong className="text-white">Earth:</strong> Green/yellow
                  </li>
                  <li>
                    • <strong className="text-white">Markers:</strong> Every 3m
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="mb-8 p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/30">
          ...
          <div className="space-y-2 text-white/80 text-sm">
            ...
            <p>
              <strong className="text-white">Label everything:</strong> Future maintenance workers
              will thank you. Use durable labels that withstand UV and weather exposure.
            </p>
            <p>
              <strong className="text-white">Document as-built:</strong> Keep accurate records of
              actual cable routes, component locations, and any deviations from design drawings.
            </p>
          </div>
        </div>
