...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Appendix 6 contains all model forms including EIC, MEIWC, EICR, and associated schedules. These forms are the basis for certification requirements.',
  },
  {
    ...
    correctIndex: 0,
    explanation:
      'An EIC must be accompanied by both a Schedule of Inspections (visual inspection checklist) and Schedule of Test Results showing all measured values.',
  },
  {
    ...
    correctIndex: 0,
    explanation:
      'C1 indicates danger present requiring immediate remedial action. C2 is potentially dangerous, C3 is recommended improvement, and FI means further investigation required.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'The designer, constructor (installer), and person responsible for inspection and testing must all sign. This may be one person if they performed all roles, or three different qualified persons.',
  },
  {
    question: 'When is a Minor Electrical Installation Works Certificate appropriate?',
    answer:
      "MEIWC is for minor works that don't include new circuits. Examples: adding a socket to an existing circuit, replacing a consumer unit like-for-like. New circuits always require full EIC.",
  },
  {
    question: 'How often should periodic inspection be carried out?',
    answer:
      'IET Guidance Note 3 recommends intervals based on installation type: domestic every 10 years (or change of occupancy), commercial 5 years, industrial 3 years, but risk assessment may require more frequent inspection.',
  },
  {
    question: "What's the difference between a limitation and an observation?",
    answer:
      "Limitations explain parts of installation that couldn't be inspected/tested (e.g., access restrictions). Observations are defects or issues found during inspection, coded C1, C2, C3, or FI.",
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'A socket outlet is being added to an existing ring final circuit. What certification is required?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Adding a socket to an existing circuit is minor work not involving a new circuit. A Minor Electrical Installation Works Certificate (MEIWC) is appropriate, covering the addition and confirming the existing circuit remains satisfactory.',
  },
];
...
const BS7671Module8Section2 = () => {
  useSEO({
    ...
    description:
      'Master BS 7671 model forms, certification requirements, and documentation best practices for electrical installations.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white">Documentation tools and quality control for certification</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Appendix 6:</strong> All model certification forms
              </li>
              <li>
                <strong>EIC:</strong> New installations + major alterations
              </li>
              <li>
                <strong>EICR:</strong> Periodic inspection + condition reports
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Every completed electrical job requires certification
              </li>
              <li>
                <strong>Use:</strong> Select correct form, complete fully, retain records
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BS 7671 requires specific certification for different types of work. Choosing the
              correct form is essential for compliance and legal protection.
            </p>

            <div className="grid grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">EIC</p>
                <p className="text-white text-xs">New installations</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">MEIWC</p>
                <p className="text-white text-xs">Minor works</p>
              </div>
              <div className="p-3 rounded bg-transparent">
                <p className="font-medium text-white mb-1">EICR</p>
                <p className="text-white text-xs">Periodic inspection</p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The Schedule of Inspections is a systematic checklist covering all aspects of visual
              inspection. It must accompany both EIC and EICR.
            </p>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>✓ (tick):</strong> Inspected and satisfactory
                </li>
                <li>
                  <strong>✗ (cross):</strong> Inspected, not satisfactory
                </li>
                <li>
                  <strong>N/A:</strong> Not applicable to this installation
                </li>
                <li>
                  <strong>LIM:</strong> Limitation - could not inspect
                </li>
              </ul>
            </div>

            <p>
              Every item must be marked. Blank entries suggest incomplete inspection and undermine
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Electrical Installation Condition Reports use standardised codes to classify the
              severity of defects found during periodic inspection.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li>
                    <strong>C2:</strong> Potentially dangerous - urgent action
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Satisfactory:</strong> No C1, C2, or FI codes
                  </li>
                  <li>
                    <strong>Unsatisfactory:</strong> Any C1, C2, or FI present
                  </li>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>C1:</strong> Live parts exposed, missing cover on CU
                </li>
                <li>
                  <strong>C2:</strong> Earthing conductor undersized, absent bonding
                </li>
                <li>
                  <strong>C3:</strong> Obsolete wiring accessories, improvement to labelling
                </li>
                <li>
                  <strong>FI:</strong> Hidden junction box location unknown
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Proper documentation protects both the client and the electrician. Quality control
              processes ensure certificates are accurate and complete.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Wrong form:</strong> — Using MEIWC for new circuit
                </li>
                <li>
                  <strong>Incomplete schedules:</strong> — Blank entries or missing pages
                </li>
                <li>
                  <strong>Missing signatures:</strong> — Not all responsible parties signed
                </li>
                <li>
                  <strong>No copy retained:</strong> — No record for contractor files
                </li>
              </ul>
            </div>
          </div>
