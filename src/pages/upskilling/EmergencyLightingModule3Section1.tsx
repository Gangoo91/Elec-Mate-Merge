...
const inlineChecks = [
  {
    ...
    options: [
      '0.2 lx.',
      '0.5 lx.',
      '1 lx — measured at floor level across the FULL WIDTH of the escape route, with edge exclusions: outer 0.5 m on routes wider than 2 m, outer ¼ width on routes 2 m or narrower. The 2013 edition specified 1 lx on the centre line + 0.5 lx on a 2 m central band — that wording is now superseded.',
      '5 lx.',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      '1 lx everywhere.',
      '0.5 lx minimum horizontal at floor level over the open area (excluding a 0.5 m perimeter) AND a maximum to minimum uniformity ratio of 40:1. Duration matches the escape-route requirement for the building.',
      '5 lx with no uniformity rule.',
      '0.2 lx with no perimeter exclusion.',
    ],
    correctIndex: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      '1 lx.',
      '5 lx.',
      '15 lx OR 10% of the maintained illuminance required for the task — whichever is greater — within 0.5 s of mains failure, with maximum:minimum uniformity 10:1.',
      '50 lx.',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      '30 min.',
      '1 h — for premises with simple, short evacuation only.',
      '3 h — the default duration for most non-domestic buildings, sized to cover full evacuation, fire-service investigation and re-occupation if safe. 1 h is permitted only for buildings emptied immediately on alarm and not re-occupied during the same operating period; 2 h applies to healthcare and sleeping risks where evacuation may be extended.',
      '8 h.',
    ],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    ...
    options: [
      '0.2 lx.',
      '1 lx at floor level across the FULL WIDTH of the escape route, with edge exclusions (outer 0.5 m on routes > 2 m, outer ¼ width on routes ≤ 2 m). The 2013 centre-line + central-band wording is superseded.',
      '5 lx.',
      '15 lx.',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      '0.5 lx at floor level over the open area excluding a 0.5 m perimeter, with maximum:minimum uniformity 40:1.',
      '1 lx with no uniformity rule.',
      '0.2 lx with no perimeter exclusion.',
      '15 lx.',
    ],
    correctAnswer: 0,
  ...
  },
  {
    ...
    options: [
      '1 lx within 5 s.',
      '15 lx or 10% of normal task illuminance, whichever is greater, within 0.5 s of mains failure, with 10:1 uniformity.',
      '0.5 lx within 15 s.',
      '50 lx within 1 s.',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      '1 lx.',
      '5 lx vertical at the location of the device — call point, extinguisher, hose reel, dry riser inlet, first-aid post — measured on the equipment face.',
      '15 lx.',
      '50 lx.',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      '30 min.',
      '1 h.',
      '3 h — the default for most non-domestic buildings; 2 h is reserved for healthcare and sleeping risks where evacuation is extended; 1 h is permitted only for buildings vacated immediately on alarm and not re-occupied during the same operating period.',
      '8 h.',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      '5 s to 50% of the rated value and 60 s to full rated output for general escape-route lighting; 0.5 s to full output for high-risk task areas.',
      '15 s to 50%.',
      '2 min to full.',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Always.',
      'Only where the building is evacuated immediately on alarm and is NOT re-occupied during the same operating period — and where the AHJ accepts the 1 h on a documented risk basis. Most buildings cannot meet both conditions and must use 3 h (or 2 h for sleeping/healthcare).',
      'In all schools.',
      'In all retail premises.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      '10 m².',
      '60 m² or any space without defined escape routes, regardless of size, where occupants could become disoriented in darkness.',
      '500 m².',
      '1000 m².',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Replace escape lighting.',
      'Allow normal activities to continue substantially unchanged during a mains failure, where business continuity, safety of process, or critical care requires it. Standby lighting is OUTSIDE the scope of escape lighting and is sized by task duration, not by evacuation duration.',
      'Provide 1 lx everywhere.',
      'Run only 30 min.',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      '1 lx escape route only.',
      'Both: 1 lx across the full width of the escape route (with edge exclusions per BS EN 1838:2024) from any point in the room to the exit, AND 0.5 lx anti-panic lighting across the open studio area (excluding 0.5 m perimeter, 40:1 uniformity), because the room is open ≥60 m². Duration 3 h. Switch-on 5 s to 50%, 60 s to full.',
