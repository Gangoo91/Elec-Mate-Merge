...
const inlineChecks = [
  {
    id: 'elm3-s1-escape',
    question:
      'BS EN 1838:2024 minimum escape route illumination at floor level on a defined escape route is...?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 4,
    question:
      'What vertical illuminance is required at fire alarm call points and firefighting equipment?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'Switch-on time for general escape-route emergency lighting per BS EN 1838:2024 is...?',
    options: [
  ...
  },
  {
    id: 10,
    question:
      'A fitness studio of 90 m² with one defined exit. What lighting category applies and to what level?',
    options: [
    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The numerical backbone of every emergency lighting design. BS EN 1838:2024 sets the
          illuminance floors — 1 lx on escape routes, 0.5 lx for anti-panic, 15 lx for high-risk
          tasks, 5 lx vertical at safety equipment. BS 5266-1:2025 sets durations — 3 h default, 2 h
          for sleeping risk, 1 h conditional only. Get the numbers wrong and the design is
          non-compliant before a luminaire is positioned.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Full width with edge exclusions.</strong> 1 lx applies across the full usable
              width of the route. The outer 0.5 m each side is excluded for routes wider than 2 m;
              the outer ¼ width each side is excluded for routes 2 m or narrower. This replaces the
              2013 centre-line + central-band approach.
            </li>
            <li>
              <strong>Floor level.</strong> Horizontal plane at the floor surface. Some designers
              measure at 0.2 m to allow for furniture obstruction; the standard requires the floor
              plane unless the AHJ accepts an alternative.
            </li>
          </ul>
          <p>
            The 1 lx value is calibrated to the threshold at which a person with normal vision can
            perceive obstacles, follow a defined route, and read directional signage at typical
            viewing distance. Lower values (0.5 lx and below) leave the route navigable but increase
            trip risk and reduce sign legibility.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>40:1 uniformity.</strong> Brightest point on the area divided by darkest must
              not exceed 40. A point at 20 lx with another at 0.4 lx is non-compliant (50:1) even
              though both points individually exceed the minimum. The rule prevents designs that
              lump luminaires together leaving large dim regions between.
            </li>
            <li>
              <strong>0.5 m perimeter.</strong> Excluded because furniture, fittings, walls
              inevitably reduce illuminance close to the boundary. Including the strip would force
              impractical levels at the centre. Designers should still consider perimeter obstacles
              for navigation.
            </li>
          </ul>
          <p>
            Anti-panic supplements escape-route lighting; it does not replace it. A room ≥60 m² with
            a defined escape route gets BOTH: 1 lx on the route, 0.5 lx across the open floor.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              not less than 0.5 lx on the empty floor area, excluding a peripheral border of 0.5 m.
              The maximum to minimum illuminance ratio shall not exceed 40:1.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              illuminance of 500 lx requires 50 lx high-risk emergency (10% × 500), not 15 lx. A
              general office at 300 lx requires 30 lx (10% × 300). The rule is "whichever is
            ...
            <li>
              <strong>10:1 uniformity.</strong> Tighter than anti-panic (40:1). Visual work requires
              consistent contrast across the task plane. A bright spot beside a shadow degrades the
              operator's ability to discriminate.
            </li>
            <li>
              <strong>Risk-assessment driven.</strong> The high-risk classification comes from the
              fire risk assessment or process safety analysis. The designer does not self-select;
              the dutyholder identifies high-risk areas and the designer engineers to the standard.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              operating height (1.2 to 1.5 m above floor). Achieved by positioning a luminaire so
              that direct light reaches the vertical surface. A luminaire directly overhead throws
              light DOWN and may give zero vertical illuminance on a wall-mounted device 4 m away.
            </li>
            <li>
              <strong>Why vertical.</strong> The user looks AT the device — reading the instruction
              label on the extinguisher, operating the call-point button, locating the refuge phone.
              The face of the device must be visible. A 50 lx pool on the floor at the user's feet
              does not light the device.
            </li>
            <li>
              <strong>Devices covered.</strong> Fire alarm manual call points (MCPs); firefighting
              equipment — portable extinguishers, fixed hose reels, dry/wet riser inlets, fire
              blanket cabinets; first-aid posts; disabled refuge call points; any building safety
              device requiring identification or operation in mains failure.
            </li>
            <li>
              <strong>Practical placement.</strong> A luminaire 2 m to the side of a wall-mounted
              device, set with appropriate beam spread, gives the vertical illuminance. Designers
              locate the safety equipment FIRST on the layout drawing, then place a dedicated
              luminaire to illuminate it. Reverse-engineering from a ceiling-grid layout often
              misses the vertical lux requirement.
            </li>
          </ul>
          <p>
            The 5 lx vertical applies in addition to whichever horizontal category covers the area
            (escape route, anti-panic, high-risk). It is not "instead of" — a device in a corridor
            needs both 1 lx on the route AND 5 lx on the device face.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The vertical illuminance at the location of safety equipment shall not be less than 5
              lx at the position where the equipment is mounted. Safety equipment includes, but is
              not limited to, fire alarm call points, firefighting equipment, first-aid posts and
              refuge call points.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>60 s to full output.</strong> Full rated emergency illuminance must be reached
              by 1 minute. Most modern LED conversion gear hits full output within 1 to 2 seconds;
              the 60 s allowance is historical (covers older fluorescent and HID technologies with
              extended warm-up).
            </li>
            <li>
              <strong>0.5 s to full for high-risk.</strong> Half a second from mains failure to full
              output. Achieved by maintained luminaires (always-on so transition is instantaneous as
              supply switches from mains-fed to battery-fed) or by sustained operation of the lamp
              through changeover. Non-maintained luminaires struck from cold cannot meet 0.5 s and
              are excluded from high-risk applications.
            </li>
            <li>
              <strong>Mains-monitoring.</strong> The detection of mains failure and the trigger of
              emergency operation is per BS EN 50172:2024 and tested as part of commissioning.
              Switch-on time is from the instant of detection, not from the instant the user notices
              a flicker.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The escape-route lighting and the anti-panic lighting shall reach 50% of the required
              illuminance within 5 s and full required illuminance within 60 s. The high-risk task
              area lighting shall reach the full required illuminance within 0.5 s.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>3 h — the default.</strong> Offices, retail, places of assembly, education,
              industrial premises, museums, libraries, places of worship, cinemas, theatres,
              restaurants, bars. Sized to cover full evacuation, fire-service investigation, and
              re-occupancy if the incident permits. The 3 h figure derives from incident analysis
              showing fire-service operations typically conclude within that envelope.
            </li>
            <li>
              <strong>2 h — sleeping and healthcare risk.</strong> Hospitals, care homes, hotels,
              hostels, halls of residence, residential accommodation. Evacuation is slower because
              occupants are asleep, infirm, or under medical care; the 2 h is additional to the
              building-specific evacuation strategy and on top of the staff-led horizontal/vertical
              movement times.
            </li>
            <li>
              <strong>1 h — the narrow case.</strong> Permitted only where (a) the building is
              evacuated immediately on alarm, (b) the building is not re-occupied during the same
              operating period, AND (c) the AHJ accepts the 1 h on documented risk grounds. Most
              buildings cannot meet all three. Common 1 h cases: small, single-occupancy workshops
              where staff leave for the day on alarm and the next operating period begins after the
              mains is restored.
            </li>
          </ul>
          <p>
            Duration is determined at design stage by the risk assessment and reflected in the
            specification. Luminaires are rated and labelled with their duration (typically 3 h on
            UK installations). Verifying the rated duration is a commissioning test — the luminaire
            must deliver rated output across the whole rating period.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The minimum duration of operation of emergency lighting shall be 3 h for non- domestic
              premises, except where (a) the premises are evacuated immediately on alarm and not
              re-occupied during the same operating period, in which case 1 h may be permitted
              subject to risk assessment, or (b) the premises are healthcare or sleeping
              accommodation, in which case 2 h shall be provided in addition to the evacuation
              strategy.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Escape lighting.</strong> Sized for evacuation. 1 lx route, 0.5 lx anti-panic,
              15 lx high-risk task, 5 lx vertical at safety equipment. Duration 1/2/3 h. Defined by
              BS EN 1838 and BS 5266-1.
            </li>
            <li>
              <strong>Standby lighting.</strong> Sized for the task. May be 200, 500, 750 lx —
              whatever the task demands. Duration is sized to the task, not evacuation — could be
              minutes (controlled shutdown of a chemical plant) or hours (running a hospital
              operating theatre through a mains outage). Defined by the task safety case, not by BS
              EN 1838.
            </li>
            <li>
              <strong>Source.</strong> Standby is typically generator-fed (longer run, full task
              lux) rather than battery (limited run, limited lux). A standby system using
              battery-backed luminaires sized to standby duty is technically possible but rare.
            </li>
            <li>
              <strong>Escape duty within standby spaces.</strong> A space requiring standby lighting
              still requires escape lighting on its escape route. The two systems may be implemented
              in the same luminaires (large output, long duration) or in separate luminaires (one
              for task, one for evacuation). Either is acceptable; both duties must be evidenced.
            </li>
          </ul>
          <p>
            Standby lighting is part of the design conversation but is engineered separately from
            this course's emergency lighting scope. We mention it to mark the boundary — when a
            designer says "I need 500 lx maintained on the operating table during a mains outage,"
            that is standby, not emergency, and a generator + UPS is the typical source.
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="320" y="80" textAnchor="middle" fill="#EF4444" fontSize="11" fontWeight="bold">
              1 h — conditional
            </text>
            <text x="320" y="94" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
              immediate evac, no re-occ
            </text>
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="530" y="80" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              2 h — sleeping / healthcare
            </text>
            <text x="530" y="94" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="740" y="80" textAnchor="middle" fill="#22C55E" fontSize="11" fontWeight="bold">
              3 h — default
            </text>
            <text x="740" y="94" textAnchor="middle" fill="rgba(255,255,255,0.6)" fontSize="9">
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="30" y="138" fill="#22D3EE" fontSize="12" fontWeight="bold">
              Escape route
            </text>
            <text x="30" y="154" fill="rgba(255,255,255,0.85)" fontSize="11">
              1 lx horizontal
            </text>
            <text x="30" y="169" fill="rgba(255,255,255,0.6)" fontSize="9.5">
              full width + edge exclusions
            </text>
            <text x="30" y="183" fill="rgba(255,255,255,0.6)" fontSize="9.5">
              5 s/60 s switch-on
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="320" y="160" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="11">
              applies (rare)
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="530" y="160" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="11">
              applies + sleeping factor
            </text>
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="30" y="228" fill="#A855F7" fontSize="12" fontWeight="bold">
              Anti-panic
            </text>
            <text x="30" y="244" fill="rgba(255,255,255,0.85)" fontSize="11">
              0.5 lx + 40:1 unif.
            </text>
            <text x="30" y="259" fill="rgba(255,255,255,0.6)" fontSize="9.5">
              ≥60 m² open spaces
            </text>
            <text x="30" y="273" fill="rgba(255,255,255,0.6)" fontSize="9.5">
              5 s/60 s switch-on
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="320" y="250" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="11">
              applies (rare)
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="530" y="250" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="11">
              applies
            </text>
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="30" y="318" fill="#EF4444" fontSize="12" fontWeight="bold">
              High-risk task
            </text>
            <text x="30" y="334" fill="rgba(255,255,255,0.85)" fontSize="11">
              15 lx OR 10% task
            </text>
            <text x="30" y="349" fill="rgba(255,255,255,0.6)" fontSize="9.5">
              10:1 uniformity
            </text>
            <text x="30" y="363" fill="rgba(255,255,255,0.6)" fontSize="9.5">
              0.5 s switch-on
            </text>
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="30" y="408" fill="#FBBF24" fontSize="12" fontWeight="bold">
              Safety equipment
            </text>
            <text x="30" y="424" fill="rgba(255,255,255,0.85)" fontSize="11">
              5 lx VERTICAL on face
            </text>
            <text x="30" y="439" fill="rgba(255,255,255,0.6)" fontSize="9.5">
              MCPs, extinguishers,
            </text>
            <text x="30" y="453" fill="rgba(255,255,255,0.6)" fontSize="9.5">
              first-aid, refuge points
            </text>
            ...
            <text
              ...
              fontWeight="bold"
            >
              Standby lighting — separate duty, sized to task continuity, additional to escape
              lighting
            </text>
        ...
        <FAQ
          items={[
            ...
            {
              question:
                'A wall-mounted call point is at 1.5 m. What does "5 lx vertical" mean exactly?',
              answer:
            ...
            {
              question:
                'My building has hospital wards on the upper floors and offices on the ground floor. What duration?',
              answer:
        ...
        <Quiz
          title="Minimum illumination levels and durations — Module 3.1"
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() =>
              navigate('/electrician/upskilling/emergency-lighting-module-3-section-2')
            }
