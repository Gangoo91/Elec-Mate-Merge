    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The statutory pyramid behind PAT. HSWA 1974 sets the over-arching duty; EAWR 1989 narrows
          it to electrical danger; PUWER 1998 narrows it to work equipment. All three apply to
          portable equipment simultaneously, and the records that discharge them are the same
          records.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>s.2(3)</strong> — the duty (where there are five or more employees) to produce
              a written safety policy. PAT programmes typically appear as a sub-policy.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              The contractor owes s.2 to their own operatives AND s.3 to the site employees and any
              other contractors who could be affected by the contractor tools.
            </li>
            <li>
              The site occupier owes s.2 to their own employees AND s.3 to the contractor operatives
              — including verifying (proportionately, via PQQ / RAMS) that the contractor has a
              maintenance programme.
            </li>
            <li>
              CDM 2015 layers additional construction-specific duties on top, but does not displace
              s.3.
            </li>
          </ul>
          <p>
            The practical implication is that &ldquo;we hire competent contractors&rdquo; is a true
            but incomplete defence. A site occupier still owes s.3 — they cannot ignore obvious
            defects in a contractor equipment, and they should hold evidence of having verified the
            contractor programme proportionately to the risk.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            s.7 is sometimes overlooked in PAT discussion. It matters for two reasons: it underpins
            the legitimacy of mandating user checks (employees must co-operate), and it engages the
            employee&rsquo;s own potential liability if they continue to use visibly dangerous
            equipment. The HSE has prosecuted under s.7 in egregious cases — the more common outcome
            is contributory consideration in civil claims.
          </p>
          <p>For PAT programme design, s.7 implies:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              User-check training must be documented (toolbox talks, intranet briefings, attendance
              logs).
            </li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              means to do something, it shall be for the accused to prove that it was not
              practicable or not reasonably practicable to do more than was in fact done.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Reg 4(1)</strong> — all systems shall at all times be of such construction as
        ...
        <RegsCallout
          ...
          clause={
            <>
              &ldquo;System&rdquo; means an electrical system in which all the electrical equipment
              is, or may be, electrically connected to a common source of electrical energy, and
        ...
        >
          <p>
            ...
            keeping it that way: a qualification is evidence of competence, not a substitute for it.
            The duty-holder must be able to show that the inspector competence is matched to the
            equipment and environment under test.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              Three-phase mobile equipment, wash-down environments, hazardous areas — scope requires
              specialist competence beyond a generic PAT qualification.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              The HSE ACOP L22 makes clear &ldquo;efficient&rdquo; here is about safety and health,
              not productivity. A kettle that boils water but has a damaged earth wire is not in
              efficient working order in the Reg 5 sense.
            </li>
            <li>
          ...
          <p>
            Reg 5 differs from EAWR Reg 4(2) in lens: Reg 4(2) is about the prevention of electrical
            danger; Reg 5 is about the equipment function as a safe work tool. In practice they
            overlap, and the same records discharge both — but each adds a distinct layer of duty.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              conditions. Inspect after installation and before first use, after assembly at any new
              location.
            </li>
            <li>
              <strong>Reg 6(1)(b)</strong> — equipment exposed to conditions causing deterioration
              which is liable to result in dangerous situations. Inspect at suitable intervals, and
              after any exceptional event liable to compromise safety.
            </li>
            <li>
          ...
          <p>
            ...
            repeatedly bent, plugs are repeatedly inserted and removed, equipment is moved, dropped,
            exposed to dust or moisture. The HSE expectation is that PUWER Reg 6 is actively running
            in parallel with EAWR Reg 4(2), and the records of a PAT programme should explicitly
            cover both.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              location, to ensure that it has been installed correctly and is safe to operate. Every
              employer shall ensure that work equipment exposed to conditions causing deterioration
              which is liable to result in dangerous situations is inspected at suitable intervals,
              and each time that exceptional circumstances which are liable to jeopardise the safety
              of the work equipment have occurred, to ensure that health and safety conditions are
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              The wear-and-false-confidence argument under HSG107 §10 is the rare case where more is
              worse — and the duty-holder needs evidence of having considered this if they are
          ...
          <p>
            The Edwards test is what HSWA s.40 reverses the burden on. A duty-holder who cannot show
            the balance was struck — because no risk assessment exists, or because the assessment
            was not maintained — cannot discharge the s.40 burden. The records are the answer.
          </p>
        </ConceptBlock>
        ...
        >
            ...
            <table className="w-full text-[13.5px] my-2">
              ...
              <tbody className="text-white/95">
                ...
                <tr className="border-b border-white/[0.06]">
                  ...
                  <td>
                    HSWA 2(2)(c) (info / training); HSWA s.7 (employee duty); EAWR 4(2) (continuous
                    monitoring)
                  </td>
                </tr>
                <tr className="border-b border-white/[0.06]">
          ...
          <p>
            The single design rule that makes one programme satisfy three statutes is to capture the
            why alongside the what. The why is the risk-based reasoning that turns a calendar entry
            into evidence of having struck the Edwards balance.
          </p>
        </ConceptBlock>
