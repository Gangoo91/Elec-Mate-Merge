    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The three-tier hierarchy of HSG107. User checks every use; formal visual at periodic
          intervals; combined inspection-and-test at the longer cycle. Each tier catches different
          defects, runs at a different cadence, and produces different records.
        </p>
        ...
        >
          ...
          <p>
            ...
            highest-prevalence defects. If user checks did not exist, the formal-visual cycle would
            have to be daily for every item — an impossible expense. If the combined
            inspection-and-test did not exist, hidden defects in CPC continuity and insulation would
            be invisible.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              A simple user check is the first line of defence in maintaining the safety of portable
              electrical equipment. It is intended to identify obvious damage or deterioration, and
              is carried out by the user before each use of the equipment.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Damage to the cable sheath — cuts, abrasion, exposed inner cores, kinks at the strain
              relief.
            </li>
            ...
            <li>
              Signs of overheating on the equipment casing or on the cable near the equipment entry.
            </li>
          ...
          <p>
            The user check is not a formal procedure with a clipboard. It is the trained-into-habit
            of looking at the equipment before plugging it in, and the trained-into-habit of taking
            it out of service if something is wrong. The system around it — training, reporting,
            tagging, withdrawal — is what the duty-holder records.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>In-line connectors, switches, FCUs, transformers</strong> — any device in the
              supply path between the plug and the equipment. Each is its own check point.
            </li>
            <li>
            ...
            <li>
              <strong>Switches, indicators, controls</strong> — operate as intended, securely fixed,
              no broken parts.
            </li>
            <li>
              <strong>Environmental signs of misuse</strong> — dust ingress on a non-IP-rated unit,
              water ingress on a non-IP-rated unit, equipment sited where its rating is exceeded.
            </li>
            <li>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              15.1 — depend on flex length and conductor csa. Typically &le; 0.1 Ω + 1 mΩ/m of flex.
            </li>
            <li>
              <strong>Insulation resistance.</strong> 500 V dc test between live conductors (line +
              neutral together) and earth (Class I) or any accessible conductive part (Class II).
              Acceptance &ge; 1 MΩ for most equipment; tighter for high-power heating elements per
              IET CoP §15.5.
            </li>
            <li>
          ...
          <p>
            The combined inspection-and-test catches defects that are invisible: degraded CPCs that
            pass a buzzer but fail under load, insulation that has absorbed moisture and fails at
            500 V, polarity-reversed leads that defeat fuse protection on equipment whose fuse is in
            the line conductor. None of these is detectable by the user or by the formal visual.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Refresher training cadence</strong> (e.g. annual, after incident, on equipment
              changes) — recorded.
            </li>
            <li>
          ...
          <p>
            Together these records are the evidence the user-check pillar exists and runs. After an
            incident, the question "did you have a system that supports user checks?" is answered by
            these records — not by individual transactional logs.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            The formal visual record satisfies PUWER Reg 6(3) for the visual side of the inspection.
            Trended over time, it is the data that drives frequency review under IET CoP §7.4.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            instrument prints / exports the readings directly, which is why instruments with stored
            data are the practical default.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            Two patterns emerge. Visible defects are caught at multiple tiers — redundancy is good.
            Invisible defects (CPC integrity, IR breakdown, polarity, RCD function) are caught only
            by the combined inspection-and-test — there is no redundancy. The user check and formal
            visual are the cadence layer; the combined inspection-and-test is the depth layer.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Log the defect.</strong> Equipment ID, date, defect description, who found it
              (user / inspector), tier (user check / formal visual / combined I&amp;T).
            </li>
            <li>
              <strong>Triage.</strong> Severity assessment. Some defects are immediate fail (broken
              plug, cut flex). Some allow controlled use under supervision (rare; case by case).
            </li>
            <li>
              <strong>Decide.</strong> Repair (and re-test); replace; dispose / scrap (with evidence
              of disposal). The decision is recorded.
            </li>
            <li>
              <strong>Action.</strong> The chosen path is followed. Repair-then-re-test: the re-test
              is a full combined inspection-and-test of the affected components, with numerical
              readings. Replacement: new item enters the register with formal visual at entry to
              service.
            </li>
            <li>
              <strong>Document.</strong> All of the above as part of the equipment\'s test history.
              The defect — repair — re-test sequence is one of the most important evidence streams
              in any subsequent investigation.
            </li>
          </ol>
          <p>
            The workflow is the same regardless of which tier found the defect. The user-check tier
            is connected to the formal-visual / combined-test tier by the defect-reporting system;
            that connection is what makes the regime function.
          </p>
        </ConceptBlock>
