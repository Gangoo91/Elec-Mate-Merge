            ...
            {sections.map((section) => {
              ...
              return (
                <Link
                  ...
                  className="h-full"
                >
                  <Card className="bg-transparent border-transparent hover:border-elec-yellow/30 transition-all duration-300 hover:bg-transparent/80 cursor-pointer group h-full flex flex-col min-h-[48px]">
