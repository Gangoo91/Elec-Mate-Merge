...
const quizQuestions = [
  {
    question:
      'Taxi depot with 30 vehicles + 24h operation. What is the typical charging install pattern?',
    options: [
  ...
  {
    question:
      'Delivery van depot (LCV — light commercial vehicle) - what’s different from taxi depot?',
    options: [
...
export default function RenewableEnergyModule7Section6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 7 · Section 6 · Fleet EV install patterns"
        title="Fleet charging — depot, scheduling, telematics"
        backTo="../renewable-energy-module-7"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Fleet EV charging install patterns — taxi / LCV / corporate / HGV / bus. Depot scheduling,
          telematics integration, CPMS fleet variants, utilisation factor sizing, ultra-rapid for
          emerging HGV / bus electrification.
        </p>
        ...
        <Pullquote>
          Fleet charging is electrical infrastructure inside an operations problem. The CPMS doesn’t
          care about vehicles; it cares about routes + drivers + departure times.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Duty cycle</strong> — 24h operation with varied driver
              shifts; vehicles return at unpredictable times
            </li>
            <li>
              <strong className="text-white">Charger type</strong> — 22 kW three-phase Mode 3
              typical (faster charging given operational urgency)
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">Utilisation factor</strong> — 0.5-0.6 typical; varies
              by depot size + driver shift pattern
            </li>
            <li>
              <strong className="text-white">Site sizing</strong> — supply for peak DESIGN (chargers
              × per-bay × utilisation); often 50-70% of NOMINAL
            </li>
            <li>
              <strong className="text-white">CPMS</strong> — fleet variant (Spirii Fleet, Driivz
              Fleet, ChargePoint Fleet) with taxi-specific reporting
            </li>
            <li>
              <strong className="text-white">Telematics</strong> — taxi fleet management platform
              (iCabbi, Autocab, Drive 4 You) integration with CPMS
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Duty cycle</strong> — single working shift (typically
              8-12h); single overnight charging window
            </li>
            <li>
              <strong className="text-white">Charger type</strong> — 7-11 kW Mode 3 typical
              (sufficient given overnight window)
            </li>
            <li>
              <strong className="text-white">Vehicle battery</strong> — 40-100 kWh (Mercedes
              eSprinter, Ford E-Transit, Renault Master E-Tech, Volkswagen ID. Buzz Cargo)
            </li>
            <li>
              <strong className="text-white">Scheduling</strong> — next-day morning departure
              schedule drives priority
            </li>
            <li>
              <strong className="text-white">Utilisation factor</strong> — 0.6-0.7 typical within
              overnight window
            </li>
            <li>
              <strong className="text-white">Site sizing</strong> — overnight peak supply; daytime
              supply much lower (chargers offline)
            </li>
            <li>
              <strong className="text-white">CPMS + telematics</strong> — fleet CPMS + LCV
              telematics integration (Geotab, Samsara) for route + driver assignment
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Pattern</strong> — workplace charging during working
              hours + home charging overnight; reimbursement scheme via CPMS
            </li>
            <li>
              <strong className="text-white">Workplace install</strong> — Section 722 + OZEV WCS
              (covered in M6 + M7.1)
            </li>
            <li>
              <strong className="text-white">Home install</strong> — driver’s home wallbox enrolled
              in corporate CPMS; session data flows via OCPP
            </li>
            <li>
              <strong className="text-white">Reimbursement logic</strong> — CPMS calculates cost per
              session (kWh × tariff rate); employer reimburses driver via payroll or expense
            </li>
            <li>
              <strong className="text-white">Provider brands</strong> — Octopus EV Salary Sacrifice,
              Drax Electric Vehicles, Centrica Home Solutions, Hitachi Capital, Tusker, ALD
              Automotive
            </li>
            <li>
              <strong className="text-white">Tax efficiency</strong> — salary-sacrifice +
              Benefit-in-Kind rate (low UK 2025-26) makes corporate EV adoption economically
              attractive
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Battery size</strong> — HGV 300-600 kWh; bus 200-400
              kWh (vs car 50-100 kWh)
            </li>
            <li>
              <strong className="text-white">Charging rate</strong> — 150-350 kW per bay typical;
              emerging 1 MW for HGV (Megawatt Charging System — MCS standard developing)
            </li>
            <li>
              <strong className="text-white">Charging windows</strong> — depot dwell windows (bus
              route turnaround 15-30 min; HGV between shifts; overnight overnight)
            </li>
            <li>
              <strong className="text-white">Site supply</strong> — dedicated HV connection (11 kV
              typical) + on-site substation + transformer 1-2 MVA per cluster
            </li>
            <li>
              <strong className="text-white">Project scope</strong> — major grid infrastructure
              project; £500k-£1.5m+ per site; 12-24 month lead time
            </li>
            <li>
              <strong className="text-white">UK 2025-26 early operators</strong> — Tesla Semi
              pilots; Stagecoach + First Bus depot electrification; Royal Mail HGV trials; UK Power
              Networks DEFP programme
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — substantial: Section
              722 + BS EN IEC 61439-7 + DNO HV + substation + transformer + LV switchgear +
              ultra-rapid chargers + fleet CPMS + telematics + route scheduling
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Sequential scheduling is the difference between a fleet depot that works + a fleet depot
          that’s constantly short of charged vehicles in the morning.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Departure time</strong> — vehicles departing soonest
              get higher priority
            </li>
            <li>
              <strong className="text-white">Current SoC</strong> — lower SoC vehicles get higher
              priority (more charge needed)
            </li>
            <li>
              <strong className="text-white">Required SoC for route</strong> — vehicles with greater
              shortfall (current SoC vs required) get higher priority
            </li>
            <li>
              <strong className="text-white">Driver / vehicle priority</strong> — operator-defined
              overrides (VIP customer fleet, emergency vehicle, etc.)
            </li>
            <li>
              <strong className="text-white">Real-time updates</strong> — as new vehicles plug in,
              priorities recalculated; allocations updated via OCPP SetChargingProfile
            </li>
            <li>
              <strong className="text-white">Minimum current</strong> — 6 A per Mode 3 minimum (~1.4
              kW); CPMS allocates at least this to active sessions; vehicles below priority
              threshold may wait
            </li>
            <li>
              <strong className="text-white">Configuration</strong> — CPMS rule engine; operator
              defines priority weights + thresholds + override rules
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Vehicle telematics</strong>— OBD-II adapter
              (aftermarket) or factory-fitted CAN bus integration reports: SoC, location (GPS),
              speed, engine state, driver
            </li>
            <li>
              <strong className="text-white">Fleet management platform</strong> — receives
              telematics data; manages routes + drivers + schedules
            </li>
            <li>
              <strong className="text-white">CPMS integration</strong> — fleet platform exposes
              vehicle data via REST API / webhook; CPMS subscribes / polls
            </li>
            <li>
              <strong className="text-white">Scheduling signals</strong> — CPMS receives priority
              signals + sends OCPP SetChargingProfile to chargers
            </li>
            <li>
              <strong className="text-white">Closed loop</strong> — vehicle plugged in → telematics
              reports SoC + route → CPMS allocates → charger applies current → vehicle charges →
              telematics updates SoC
            </li>
            <li>
              <strong className="text-white">Reporting</strong> — per-vehicle energy + cost + route
              efficiency + driver behaviour all flow back through the integration for fleet ops +
              finance + ESG
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — integration
              architecture diagram + API endpoint / credentials (test) + data flow + authentication
              / security details
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          A fleet depot is 30 dedicated final circuits, one sequential scheduler, and a thousand
          operational decisions per day.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Install-time</strong> — per-charger EIC, BS EN IEC
              61439-7 multi-charger LV assembly DoC, DNO connection agreement, transformer + LV
              switchgear specs, CPMS commissioning results
            </li>
            <li>
              <strong className="text-white">Design baseline</strong> — utilisation factor assumed
              (e.g. 0.55), peak DESIGN demand calc, sequential scheduling logic, telematics
              integration architecture
            </li>
            <li>
              <strong className="text-white">Operational baseline</strong> — typical day-pattern
              (vehicle returns + plug-in profile), expected energy throughput, expected per-vehicle
              session count
            </li>
            <li>
              <strong className="text-white">Verification points</strong>— actual utilisation factor
              vs assumed; actual site supply peak vs supply capacity; sequential scheduling working
              as designed; per-driver + per-vehicle reporting flowing
            </li>
            <li>
              <strong className="text-white">EICR readiness</strong> — 5-yearly commercial EICR
              reviews the design + operational records together. Operator pre-EICR checklist
              included in cert evidence bundle
            </li>
            <li>
              <strong className="text-white">ESG + grant reporting</strong>— energy delivered, CO₂
              saved, % renewable (PV self-consumption + grid green tariff), grant compliance for
              LEVI / OZEV WCS where applicable
            </li>
            <li>
              <strong className="text-white">Multi-party copies</strong> — site operator + installer
              + CPMS / fleet platform operator + telematics vendor + grant administrator (if
              applicable) all retain copies
            </li>
          </ul>
        </ConceptBlock>
