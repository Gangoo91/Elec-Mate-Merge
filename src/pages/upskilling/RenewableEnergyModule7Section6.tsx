...
const quickCheckQuestions = [
  ...
  },
  {
    id: 'safety-qc3',
    question:
      'What minimum waiting time is recommended after DC isolation before working on inverters?',
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">In 30 Seconds:</span> Isolate AC
              first, then DC; wait 5 minutes for capacitor discharge
            </p>
          </div>
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">Spot it:</span> PV arrays generate
              voltage whenever exposed to light
            </p>
          </div>
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">Use it:</span> LOTO (Lockout Tagout)
              prevents accidental re-energisation
            </p>
          </div>
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">Key Risk:</span> DC arcs sustain
              indefinitely - no natural zero crossing
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 space-y-6 pb-8">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Cannot De-Energise:</span> PV arrays generate
              voltage whenever exposed to light. Even on cloudy days significant voltage is present.
              Covering panels reduces but does not eliminate voltage. This fundamental
              characteristic affects all safety planning.
            </p>
            <p>
              <span className="text-white font-medium">Arc Hazards:</span> DC arcs can sustain
              indefinitely because there is no natural zero crossing where current passes through
              zero. AC arcs naturally extinguish 100 times per second at 50Hz. This makes DC arc
              flash particularly dangerous and requires specific arc-rated PPE.
            </p>
            <p>
              <span className="text-white font-medium">Shock Hazards:</span> PV system voltages
              (typically 400-1000V DC) exceed the extra-low voltage threshold. DC causes muscle
              tetany differently from AC, potentially making it harder to release grip. Touch
              voltage limits are lower for DC than AC.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Isolation Sequence:</span> First isolate AC
              supply (main switch or isolator). Then isolate DC strings (string isolators at
              inverter). Where possible, reduce load before DC isolation by waiting for low
              irradiance. Allow minimum 5 minutes for capacitor discharge before working on
              inverter.
            </p>
            <p>
              <span className="text-white font-medium">Prove Dead:</span> After isolation, prove
              dead using an approved voltage indicator. Prove the indicator on a known live source
            ...
            <p>
              <span className="text-white font-medium">Lockout Tagout (LOTO):</span> Apply personal
              locks to all isolation points. Attach tags identifying the person who applied the lock
              and the reason. Only the person who applied the lock should remove it. Use multi-lock
              hasps for work involving multiple people.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Electrical PPE:</span> Arc-rated clothing
              appropriate to incident energy level is essential. Voltage-rated insulated gloves
              match the system voltage (Class 0 for 1000V systems). Face shields or safety glasses
              with side protection are required. Insulated footwear provides additional protection.
            </p>
            <p>
              <span className="text-white font-medium">Working at Height:</span> Full body harness
              with appropriate attachment points. Lanyards or fall arresters suitable for the work.
              Anchor points must be rated for fall arrest loads. Consider rescue equipment and
              procedures.
            </p>
            <p>
              <span className="text-white font-medium">General PPE:</span> Hard hat for overhead
              hazards. High-visibility clothing where required. Appropriate gloves for manual
              handling. Sun protection for extended outdoor work. Weather-appropriate clothing for
              conditions.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Risk Assessment Content:</span> Identify all
              hazards including electrical, working at height, manual handling, and environmental.
              Assess likelihood and severity of harm. Identify existing controls and additional
              measures required. Record findings and communicate to all workers.
            </p>
            <p>
              <span className="text-white font-medium">Method Statement Content:</span> Step-by-step
              work procedure. Sequence of isolation and restoration. PPE requirements at each stage.
              Competency requirements for personnel. Emergency procedures.
            </p>
            <p>
              <span className="text-white font-medium">Dynamic Risk Assessment:</span> Conditions
              may change during work such as weather, site access, or discovered issues. Workers
              should continuously assess conditions and stop work if new hazards arise. Authority to
              stop work should be clearly established.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Electrical Incidents:</span> Do not touch the
              casualty if they may still be in contact with live parts. Isolate supply where
              possible. Call emergency services (999). Provide first aid including CPR if qualified
              and required. AED availability is recommended for electrical work.
            </p>
            <p>
              <span className="text-white font-medium">Falls and Rescue:</span> Plan rescue
              procedures before starting work at height. Ensure rescue equipment is available and
              personnel are trained. Suspension trauma is a serious risk if a fallen worker is
              suspended in a harness. Time is critical for rescue.
            </p>
            <p>
              <span className="text-white font-medium">Fire Response:</span> Know location of fire
              extinguishers and their suitability. Be aware that PV systems may remain energised
              during fire. Communicate PV presence to fire services. Follow site-specific fire
              procedures.
            </p>
          </div>
        </section>
        ...
        <div className="bg-gradient-to-r from-elec-yellow/10 to-amber-500/10 border border-elec-yellow/20 rounded-xl p-4">
          ...
          <div className="space-y-2 text-white text-sm">
            <p>
              ...
              unsafe practices. Learn from near-misses as well as incidents.
            </p>
            <p>
              <span className="text-white font-medium">Competence development:</span> Ensure all
              workers have appropriate training for tasks assigned. Supervise less experienced
              workers appropriately. Maintain training records and refresher schedules.
            </p>
            <p>
              <span className="text-white font-medium">Documentation:</span> Keep records of risk
              assessments, method statements, and training. Document all incidents and near-misses
              for learning. Review and update procedures based on experience.
            </p>
          </div>
        </div>
        ...
        {/* Quiz */}
        <Quiz title="Safety & Working Procedures Quiz" questions={quizQuestions} />
