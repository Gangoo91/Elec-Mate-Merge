...
const inlineChecks = [
  {
    ...
    question: 'What is the purpose of the handover meeting at install completion?',
    options: [
  ...
  },
  {
    ...
    question: 'What should the customer be taught about fault response?',
    options: [
  ...
  },
  {
    ...
    question: 'What ongoing monitoring expectations should the customer be taught?',
    options: [
  ...
  },
  {
    ...
    question: 'What is the value of an annual touchpoint between installer + customer?',
    options: [
...
const quizQuestions = [
  {
    question: 'Customer handover meeting — how long should it be + what activities?',
    options: [
  ...
  {
    question: 'Multi-source customer education — how to avoid overwhelming the customer?',
    options: [
  ...
  {
    question: 'Operating guide content — what topics must the customer-facing guide cover?',
    options: [
  ...
  {
    question: 'Property sale + LCT install — what handover information transfers to new owner?',
    options: [
...
export default function RenewableEnergyModule12Section7() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 12 · Section 7 · Customer engagement + lifecycle delivery"
        title="Customer education + handover delivery"
        backTo="../renewable-energy-module-12"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The handover meeting, the operating guide, fault response, monitoring expectations, the
          annual touchpoint, avoiding silent failures, multi-source customer journey, property-sale
          handover. The non-technical but business-critical layer of the LCT install — done well,
          prevents most support calls + supports warranty + insurance + EICR-equivalent across the
          install lifecycle.
        </p>
        ...
        <Pullquote>
          The customer is the final mile of every LCT install. A great install with poor customer
          handover ends in confusion + support calls. Invest the 90 minutes.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Walk-through (15 min)</strong> — show customer the
              install in their property; outdoor equipment + isolators + safety labels + cable
              routing
            </li>
            <li>
              <strong className="text-white">System demo (15-20 min)</strong> — start a charging
              cycle / show generation; demonstrate emergency stop; show normal operating signs
            </li>
            <li>
              <strong className="text-white">Portal walkthrough (15-20 min)</strong> — log customer
              into manufacturer portal on phone + computer; show key views; configure alerts
            </li>
            <li>
              <strong className="text-white">Maintenance + warranty (10 min)</strong> — annual
              schedule + EICR-equivalent cycle + manufacturer service + warranty terms summary
            </li>
            <li>
              <strong className="text-white">Fault response (10 min)</strong> — observation
              procedure + emergency vs non-emergency + categorical no-open + emergency contacts
            </li>
            <li>
              <strong className="text-white">MCS handover pack delivery (5-10 min)</strong> — paper
              + digital handover; structure walkthrough; signpost key documents
            </li>
            <li>
              <strong className="text-white">Q&A (5-10 min)</strong>— invite customer questions;
              capture for follow-up
            </li>
            <li>
              <strong className="text-white">Sign-off acknowledgement</strong> — customer signs to
              confirm receipt + understanding; cert evidence bundle records
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">System overview</strong>— plain-English description of
              what each source does + how they interact
            </li>
            <li>
              <strong className="text-white">Operating modes + controls</strong> — normal + holiday
              mode + boost + manufacturer-specific features
            </li>
            <li>
              <strong className="text-white">Portal access</strong>— written instructions for
              first-time login + key views
            </li>
            <li>
              <strong className="text-white">Maintenance schedule</strong> — customer self-check +
              annual + EICR-equivalent cycle + manufacturer service
            </li>
            <li>
              <strong className="text-white">Warranty terms</strong>— manufacturer + installer
              workmanship; what counts as warranty event; claim process
            </li>
            <li>
              <strong className="text-white">Fault response</strong> — observation + emergency vs
              non-emergency + contacts (visible)
            </li>
            <li>
              <strong className="text-white">Emergency stop</strong>— location per source +
              procedure
            </li>
            <li>
              <strong className="text-white">Do-not-open + do-not-modify</strong> — categorical
              safety message + warranty void if breached
            </li>
            <li>
              <strong className="text-white">Future considerations</strong> — additions,
              replacements (inverter 10-15 yr), end-of-life (BESS 15-20 yr; PV 25-30 yr)
            </li>
            <li>
              <strong className="text-white">FAQ</strong>— common questions (holidays, SEG
              optimisation, power cut behaviour, bill alongside system)
            </li>
            <li>
              <strong className="text-white">Contacts page</strong> — clear visible list (installer
              24-hr, non-emergency, manufacturer support, DNO, emergency services)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          The system that\'s monitored is the system that lasts. The silent failure caught early is
          the warranty claim handled smoothly. The annual touchpoint is the relationship — and the
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Continuous BMS / inverter monitoring</strong> —
              automatic background self-monitoring; alerts on fault state; portal app + email
              notification; safety-critical coverage independent of customer engagement
            </li>
            <li>
              <strong className="text-white">Monthly customer self-check</strong> — 2-5 min portal
              review (yield + SoC + alerts); habit established at handover; catches
              non-safety-critical issues (yield drift, soiling, minor degradation)
            </li>
            <li>
              <strong className="text-white">Annual installer / manufacturer touchpoint</strong> —
              paid service typical £50-150/yr residential; comprehensive review beyond customer
              self-check; relationship maintenance
            </li>
            <li>
              <strong className="text-white">5-10 yr professional EICR-equivalent</strong> — Reg
              652.1 frequency; comprehensive periodic + LCT-specific extensions (covered §12.5)
            </li>
            <li>
              <strong className="text-white">Warranty events</strong> — at half-life (~5 yr) review
              + approaching warranty floor (~10 yr); manufacturer engagement as needed
            </li>
            <li>
              <strong className="text-white">Manufacturer scheduled monitoring</strong> — many
              manufacturers offer paid monitoring with installer or manufacturer-direct service;
              configurable at handover
            </li>
            <li>
              <strong className="text-white">Customer configurations</strong> — portal alerts
              customised at handover for customer\'s phone + email; default settings may not be
              optimal
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle integration</strong> — each
              monitoring layer feeds the lifecycle record; comprehensive picture for warranty +
              insurance + EICR
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Portal alert configuration</strong> — push notification
              to customer phone on fault state; email to customer + copy to installer for critical
            </li>
            <li>
              <strong className="text-white">Customer self-check habit</strong> — monthly portal
              review established at handover; 2-5 min checks the headline metrics
            </li>
            <li>
              <strong className="text-white">Make abnormal visible</strong> — at handover educate
              customer on \"normal\" patterns (PV yield curve, BESS SoC daily pattern, heat pump
              cycling); \"abnormal\" patterns prompt action
            </li>
            <li>
              <strong className="text-white">Annual touchpoint</strong> — installer or
              manufacturer-initiated check covers even disengaged customers
            </li>
            <li>
              <strong className="text-white">Manufacturer scheduled monitoring</strong> — paid
              service from manufacturer; automated alerts even if customer doesn\'t check
            </li>
            <li>
              <strong className="text-white">Installer fleet monitoring</strong> — installer keeps
              eye on fleet via portal aggregation; identifies outliers (one customer\'s yield down
              vs others in similar conditions)
            </li>
            <li>
              <strong className="text-white">Customer-facing alerts</strong> — clear language
              (\"your inverter has stopped\" not \"error code 1234\"); calls to action (\"contact
              installer\")
            </li>
            <li>
              <strong className="text-white">Common silent failures avoided</strong> — dead inverter
              (PV no yield months); BESS 0% stuck (cell failure, BMS misbehaviour); EV charger
              failure (weekly user gap); heat pump defrost loop (high consumption + no heat)
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Integrated portal</strong> — Tesla app covers Powerwall
              + EV + solar; GivEnergy portal covers PV inverter + BESS; manufacturer-agnostic
              platforms (SolarEdge ONE) emerging. Use as primary customer interface where available
            </li>
            <li>
              <strong className="text-white">Layered detail</strong> — top-level dashboard for daily
              check; deeper drilldown for those who want it
            </li>
            <li>
              <strong className="text-white">One-page summary card</strong> — physical card /
              sticker / handover pack page with: key contacts, emergency stops, fault response,
              portal login
            </li>
            <li>
              <strong className="text-white">System-thinking</strong>— \"this is your energy
              system\" not \"your PV + your BESS + your heat pump + your EV charger\"; customer
              doesn\'t think about technology boundaries
            </li>
            <li>
              <strong className="text-white">Follow-up email</strong> — within 24-48 hr of handover;
              summary, key contacts, portal logins, support FAQ; written reference
            </li>
            <li>
              <strong className="text-white">Annual touchpoint integrated</strong> — covers all
              sources in one visit/call; refresh + update + relationship maintenance
            </li>
            <li>
              <strong className="text-white">Avoid jargon</strong>— \"battery\" not \"BESS\";
              \"solar\" not \"PV\"; \"heat pump\" not \"ASHP\"; \"charger\" not \"EVSE\"
            </li>
            <li>
              <strong className="text-white">Tailor depth</strong>— engaged customers love technical
              detail; disengaged customers want minimal; gauge + adapt
            </li>
            <li>
              <strong className="text-white">Reality</strong>— most customers settle on
              hands-off-with-occasional-engagement; the layered monitoring catches issues regardless
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">MCS handover pack</strong> — physical + digital copy
              travels with property in conveyancing; new owner takes possession at completion
            </li>
            <li>
              <strong className="text-white">Manufacturer warranty</strong> — typically
              transferable; some require notification via installer; cert evidence bundle records
              the transfer
            </li>
            <li>
              <strong className="text-white">BUS grant</strong>— tied to property + system; new
              owner inherits asset + grant validity + ongoing obligations
            </li>
            <li>
              <strong className="text-white">SEG tariff</strong>— re-registration with new owner\'s
              energy supplier; existing MCS + DNO + handover pack evidence supports
            </li>
            <li>
              <strong className="text-white">Installer service relationship</strong> — new owner
              option to continue or switch; original installer has knowledge + relationship
              advantages
            </li>
            <li>
              <strong className="text-white">Portal account reassignment</strong> — manufacturer
              portals need reassignment from original owner to new owner; installer facilitates
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — remains with installer;
              transferable to new servicing company on customer request
            </li>
            <li>
              <strong className="text-white">EICR-equivalent continuity</strong> — new owner uses
              property\'s existing cert + MCS handover pack as lifecycle baseline
            </li>
            <li>
              <strong className="text-white">Documentation gaps</strong> — older installs may have
              incomplete records; sale process more complicated; cert evidence bundle reconstruction
              may be needed
            </li>
            <li>
              <strong className="text-white">Property value</strong> — well-documented LCT installs
              add measurable property value; poorly-documented installs may detract; investment in
              handover + cert pays back at sale
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-12-section-8')}
