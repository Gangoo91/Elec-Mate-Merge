...
export default function RenewableEnergyModule5Section1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 1 · BS 7671:2018+A4:2026 · Chapter 57 NEW"
        title="BESS fundamentals & chemistry"
        backTo="../renewable-energy-module-5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The new Chapter 57 (Stationary Secondary Batteries) — Reg 570.1 scope, Reg 570.5.1 ten
          selection factors. LFP vs NMC vs lead-acid vs flow chemistry comparison; cycle vs calendar
          life; UK 2025-2026 brand landscape.
        </p>
        ...
        <Pullquote>
          Chapter 57 is the new BESS home. LFP is the chemistry. 10 selection factors set the
          design.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Stationary</strong> — fixed location; wall-mounted,
              floor-stacked, or in a battery room. Not portable, not pluggable
            </li>
            <li>
              <strong className="text-white">Secondary</strong> — rechargeable (vs primary /
              single-use battery). Charges from PV / grid / generator; discharges to loads
            </li>
            <li>
              <strong className="text-white">Installation</strong> — wired into a fixed electrical
              installation (not a self-contained product like a pluggable UPS)
            </li>
            <li>
              <strong className="text-white">
                Source of supply for the electrical installation
              </strong>{' '}
              — supplies energy back to the installation\'s loads (or to the grid via PCE)
            </li>
            <li>
              <strong className="text-white">Typical UK domestic</strong> — 5-15 kWh LFP, modular
              (stackable), wall-mounted in garage / utility / outbuilding / fire-rated external
              enclosure
            </li>
            <li>
              <strong className="text-white">Typical commercial</strong> — 50-500 kWh, often
              containerised, on the customer\'s curtilage
            </li>
            <li>
              <strong className="text-white">Typical grid-scale</strong> — multi-MWh containerised;
              outside the scope of Module 5 (covered in commercial / grid modules)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Reg 570.5.1 sets ten factors (a)-(j). Skip one, and the spec is wrong.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">(a) Nature of demand</strong> — what the customer needs
              the battery for: daily self-consumption shifting; backup duration; peak shaving;
              grid-services. Different uses drive different chemistry + sizing
            </li>
            <li>
              <strong className="text-white">(b) Battery voltage</strong> — nominal DC voltage at
              battery terminals. Typical UK domestic 48V nominal (small / modular systems) or HV
              battery (high-voltage 200-500V DC for direct hybrid-inverter coupling)
            </li>
            <li>
              <strong className="text-white">(c) Charge time and discharge time</strong> — how fast
              must the battery accept charge (PV midday surplus) and deliver discharge (evening
              peak)? Drives C-rate spec
            </li>
            <li>
              <strong className="text-white">
                (d) Generation profiles of locally connected generators (e.g. solar PV)
              </strong>{' '}
              — PV output curve drives the charge availability; BESS sized to absorb the peak (or
              accept some curtailment)
            </li>
            <li>
              <strong className="text-white">(e) PCE connection and coupling mode</strong> —
              AC-coupled (separate PCE) or DC-coupled (hybrid inverter integrated PCE). Module 4
              Section 4 covered this; Reg 570.5.2 governs PCE selection separately
            </li>
            <li>
              <strong className="text-white">
                (f) Supplied equipment&rsquo;s utilization voltage range
              </strong>{' '}
              — the AC system voltage compatibility (UK 230V single-phase / 400V three-phase) and
              the PCE output range
            </li>
            <li>
              <strong className="text-white">(g) Battery charge and discharge profiles</strong> —
              V-curve, current limits, C-rate by SoC. LFP discharge is flat across SoC (~3.2V/cell)
              — easy for PCE matching; NMC slope is steeper (~3.7V/cell falling to 2.8V)
            </li>
            <li>
              <strong className="text-white">
                (h) Load profiles and cyclic operation capability
              </strong>{' '}
              — daily-cycle vs occasional vs backup-only. Drives DoD discipline + cycle life
              expectation
            </li>
            <li>
              <strong className="text-white">(i) Suitability for fixed installation</strong> —
              mounting, vibration tolerance, IP rating, BS EN IEC 62485 compliance, manufacturer\'s
              fixed-install spec
            </li>
            <li>
              <strong className="text-white">(j) Relevant external influences</strong> — temperature
              range, humidity, altitude, electromagnetic environment. LFP optimal 15-25°C; degraded
              performance below 0°C and above 40°C
            </li>
          </ul>
          <p>
            The NOTE explicitly mentions chemistry: &ldquo;The selection of type of battery might
            include consideration of battery chemistry and construction, for example cell plate
            configuration and possibility of evolution of flammable, or harmful, gases.&rdquo;
            Translation: the chemistry choice (LFP / NMC / lead-acid / flow) is itself part of the
            selection criteria.
          </p>
        </ConceptBlock>
        ...
        <Pullquote>
          LFP for UK domestic. NMC for EVs. Lead-acid for legacy only. Flow for commercial-scale
          only.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Thermal-runaway threshold</strong> — ~270°C cell-level;
              significantly above NMC ~210°C. Runaway is slower + less violent (less oxygen release,
              lower peak temperature)
            </li>
            <li>
              <strong className="text-white">Cycle life</strong> — 6,000-10,000 cycles at 80% DoD
              typical. Some premium cells (newer LFP chemistries) claim 10,000-12,000
            </li>
            <li>
              <strong className="text-white">Calendar life</strong> — 15-20 years typical; some
              brands warrant &ge;70% retention at 10 years
            </li>
            <li>
              <strong className="text-white">Energy density</strong> — ~160 Wh/kg / ~330 Wh/L. Lower
              than NMC but ample for fixed installs
            </li>
            <li>
              <strong className="text-white">Cost</strong> — ~£250-£400 per kWh installed UK
              2025-2026 (battery only, excluding install labour)
            </li>
            <li>
              <strong className="text-white">Supply chain</strong> — no cobalt (NMC requires cobalt
              with ethical / sourcing concerns); iron + phosphate readily available
            </li>
            <li>
              <strong className="text-white">Discharge curve</strong> — flat ~3.2V/cell across most
              of SoC range — easy for PCE matching, predictable BMS algorithms
            </li>
            <li>
              <strong className="text-white">Temperature</strong> — optimal 15-25°C; reduced
              capacity below 0°C; accelerated degradation above 40°C
            </li>
            <li>
              <strong className="text-white">UK domestic dominance</strong> — virtually all new
              domestic BESS installs 2025-2026 are LFP
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Thermal-runaway threshold</strong> — ~210°C cell-level;
              lower than LFP; runaway faster + more violent (oxygen release, higher peak
              temperature). Approved Document B fire-safety implications
            </li>
            <li>
              <strong className="text-white">Cycle life</strong> — 2,000-3,000 cycles at 80% DoD.
              Better at shallow DoD (50%): 4,000-6,000 cycles
            </li>
            <li>
              <strong className="text-white">Calendar life</strong> — 10-12 years typical
            </li>
            <li>
              <strong className="text-white">Energy density</strong> — ~250 Wh/kg / ~700 Wh/L — the
              headline advantage. ~2&times; LFP per L
            </li>
            <li>
              <strong className="text-white">Cost</strong> — historically more expensive than LFP
              per kWh; cobalt content drives cost + supply-chain risk
            </li>
            <li>
              <strong className="text-white">Discharge curve</strong> — sloped from ~4.2V/cell
              (full) to ~2.8V/cell (empty). PCE must accommodate the wider voltage range
            </li>
            <li>
              <strong className="text-white">EV dominance</strong> — most UK EV batteries are NMC
              variants (energy density critical for range / weight)
            </li>
            <li>
              <strong className="text-white">UK domestic decline</strong> — Tesla switched Powerwall
              3 (2024+) from NMC to LFP. UK 2025-2026 new domestic NMC installs essentially zero
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Cycle life</strong> — 500-1,500 cycles at 50% DoD; LESS
              than half of LFP. Deep cycling shortens life dramatically
            </li>
            <li>
              <strong className="text-white">Calendar life</strong> — 5-10 years typical;
              significantly less than LFP
            </li>
            <li>
              <strong className="text-white">Cost per kWh</strong> — initially lower than Li-ion
              historically; with LFP price falls, gap closing or reversed by 2025-2026
            </li>
            <li>
              <strong className="text-white">Hydrogen evolution</strong> — Pb-acid emits hydrogen
              during charging (especially equalisation). Ventilation calculation per BS EN IEC
              62485-2 Annex A; explosion-proof fittings within hazardous zone
            </li>
            <li>
              <strong className="text-white">Weight</strong> — ~30-40 Wh/kg — much heavier per kWh
              than Li-ion
            </li>
            <li>
              <strong className="text-white">DoD discipline</strong> — limited to 50% DoD for any
              reasonable cycle life
            </li>
            <li>
              <strong className="text-white">Use cases 2025-2026</strong> — legacy off-grid
              maintenance, niche industrial, low-cycling marine. Not for new UK domestic BESS
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Cycle life</strong> — 20,000+ cycles; effectively
              unlimited cycling — capacity comes from electrolyte volume, not cell ageing
            </li>
            <li>
              <strong className="text-white">Footprint</strong> — large tanks of electrolyte; not
              viable at domestic scale (cellar / garage size minimum for tens of kWh)
            </li>
            <li>
              <strong className="text-white">Duration</strong> — 8-12 hour discharge ideal; longer
              durations than Li-ion at the same kWh
            </li>
            <li>
              <strong className="text-white">Use cases</strong> — grid-scale energy storage;
              commercial peak-shaving over many hours; industrial backup at sites with space
            </li>
            <li>
              <strong className="text-white">UK 2025-2026 status</strong> — small but growing
              commercial market; not a UK domestic product
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Useful life = min(cycle life, calendar life). For UK domestic daily-cycled LFP, both land
          at ~15 years.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Cycle life</strong> — depends on chemistry + DoD
              discipline + temperature. LFP @ 80% DoD: 6,000-10,000 cycles. NMC @ 80% DoD:
              2,000-3,000. Pb-acid @ 50% DoD: 500-1,500
            </li>
            <li>
              <strong className="text-white">DoD discipline trade-off</strong> — shallow cycling
              (50% DoD) doubles or triples cycle life vs deep cycling (90% DoD). LFP at 50% DoD can
              reach 15,000-20,000 cycles
            </li>
            <li>
              <strong className="text-white">Calendar life</strong> — degradation in storage even
              without cycling. LFP ~2-3% per year; ~15-20 years calendar life
            </li>
            <li>
              <strong className="text-white">Temperature factor</strong> — LFP optimal 15-25°C;
              sustained &ge;35°C doubles degradation rate; sustained &ge;40°C triples
            </li>
            <li>
              <strong className="text-white">Useful life</strong> — min(cycle, calendar).
              Daily-cycled domestic typically cycle-bound (~15 years); backup-only typically
              calendar-bound (~15-20 years)
            </li>
            <li>
              <strong className="text-white">Warranty alignment</strong> — UK 2025-2026
              manufacturers typically warrant 10 years OR 6,000 cycles, whichever comes first;
              &ge;70-80% retention
            </li>
            <li>
              <strong className="text-white">Design implication</strong> — for low-cycling installs,
              the customer can spec a smaller / cheaper pack; the cycle life is irrelevant
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          GivEnergy + Tesla Powerwall 3 + Sigenergy lead the UK new-install market. All LFP.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              ...
              (Newark, England). Gen3 hybrid inverter + 5/9.5/13.5 kWh LFP battery range. Dominant
              UK market share. Strong app + integration ecosystem. ~£4,500-£6,500 installed for 10
              kWh
            </li>
            <li>
              <strong className="text-white">Tesla Powerwall 3</strong> — Premium tier; 13.5 kWh LFP
              (Powerwall 2 was NMC, Powerwall 3 changed Q2 2024); built-in MPPT + EPS; sleek
              wall-mount; ~£8,000-£10,000+ installed
            </li>
            <li>
              <strong className="text-white">Sigenergy SigenStor</strong> — Premium-tier modular
              LFP; SP series with stackable modules; strong telemetry / app; growing UK market
              share; ~£6,500-£8,500 installed for 10 kWh
            </li>
            <li>
              <strong className="text-white">Huawei LUNA 2000</strong> — Mainstream LFP; pairs with
              Huawei SUN2000 hybrid inverter; established global brand; ~£5,500-£7,500 installed
            </li>
            <li>
              <strong className="text-white">FoxESS</strong> — Value tier LFP; H1 hybrid + battery
              range; popular among cost-sensitive customers; ~£4,000-£5,500 installed
            </li>
            <li>
              <strong className="text-white">SolarEdge</strong> — Energy Hub LFP for new-build; AC
              battery for retrofit; tight integration with SolarEdge HD-Wave / optimiser ecosystem;
              ~£6,000-£8,500 installed
            </li>
            <li>
              <strong className="text-white">Enphase IQ Battery</strong> — AC-coupled LFP; pairs
              with Enphase microinverter PV; IQ Gateway orchestration; ~£6,500-£8,500 installed
            </li>
            <li>
              <strong className="text-white">BYD Battery Box</strong> — Mainstream LFP; modular;
              partners with various hybrid inverter brands
            </li>
            <li>
              <strong className="text-white">Sungrow / Sonnen / Senec</strong> — Niche UK presence;
              specific feature sets (Sonnen Virtual Power Plant participation, Senec
