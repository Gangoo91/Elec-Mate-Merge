    ...
    <HubPage>
      ...
      <HubBody>
        <div className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'Section 522 of BS 7671 — the classification system for environmental, utilisation and construction influences, and how those classes drive IP rating, IK rating, material selection and cable derating on every installation.'
          }
        </div>
        ...
        >
          <p>
            ...
            foreign solid bodies, AF corrosive or polluting substances, AG impact, AH vibration, AK
            flora, AL fauna, AM electromagnetic / electrostatic / ionising influences, AN solar
            radiation, AP seismic, AQ lightning, AR wind. Group B (utilisation) covers BA capability
            of persons (ordinary, children, disabled, instructed, skilled), BB body resistance, BC
            contact with earth (none, low, frequent, continuous, immersed), BD evacuation
            conditions, BE handled materials (combustible, fire-propagating, explosive,
            ...
            7671 cert decision that flows from environment, occupant or building fabric traces back
            to one or more of these classes.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            First digit (solids): 0 unprotected, 1 objects greater than or equal to 50 mm (hand), 2
            greater than or equal to 12.5 mm (finger), 3 greater than or equal to 2.5 mm (tools), 4
            greater than or equal to 1 mm (wires), 5 dust-protected (limited ingress permitted, no
            harmful effect), 6 dust-tight. Second digit (water): 0 unprotected, 1 vertical drips, 2
            drips at 15 deg tilt, 3 spray to 60 deg, 4 splash from any direction, 5 jets (6.3 mm
            nozzle, 12.5 l/min, 3 min), 6 powerful jets (12.5 mm nozzle, 100 l/min), 7 temporary
            immersion (1 m, 30 min), 8 continuous immersion (per manufacturer spec, typically depth
            and time), 9K high-temperature high-pressure jet (80 degC, 80-100 bar, 14-16 l/min). The
            X placeholder ("IPX5") is used when only one digit is being asserted.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            garage outlets, condensation in cold-roof loft spaces, splash in kitchens, shower spray
            in bathrooms. The defence is per-position IP specification, not a room-wide minimum —
            and the cert design log should record both the AD class identified and the IP specified
            at each accessory.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            temperatures from 25 degC up to 90 degC, for both thermoplastic (PVC, 70 degC conductor
            temperature) and thermosetting (XLPE, EPR, 90 degC conductor temperature) cables. Below
            30 degC, Ca is greater than 1 (the cable can carry slightly more than tabulated). At 30
            degC, Ca = 1.0. Above 30 degC, Ca falls. The factors must be combined with Cg (grouping,
            Table 4C1), Ci (thermal insulation, Reference Methods 100-103 / Table 52.2) and Cs (soil
            thermal resistivity for buried cables) — all applied multiplicatively to It to give Iz.
            Iz must then exceed Ib (design current) and meet Reg 433.1.1 with respect to In.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 522.10 (formerly Reg 522.5 in some printings) requires equipment to be selected and
            erected so no harmful effect arises from the corrosive or polluting substances likely to
            be present, including water. The defensible material chain is: identify the substances
            (chloride, alkali, acid, organic solvent, biological), identify the concentration and
            frequency, pick the material from a known-resistance reference (e.g. 316 stainless for
            chloride, GRP for hydrofluoric acid environments, certain polymers for hydrocarbons),
            and specify the entire fixing system to match — screws, bolts, glands, tape and sealants
            are part of the same chain. A 316 enclosure with zinc-plated screws fails at the screws.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            the Section 522 reasoning brings the real specification up. The cert defensibility is in
            the design log showing both chains were walked.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            cable sheath or conductor during installation, use and maintenance is prevented. This is
            not a separate check from Reg 522.6 — it sits alongside it as the installation-time
        ...
        >
          <p>
            ...
            with a ceiling forming one face); 101 (cable surrounded on one side by insulation, with
            the other side in free air); 102 (cable in a stud wall with insulation on both sides);
            103 (cable enclosed in conduit / trunking within insulation). Each method has its own
            tabulated It in App 4. Where a cable crosses an insulated zone for greater than 0.5 m,
            Ci is applied; where it is a short crossing (less than 0.5 m), the local effect is
            treated as negligible. The defensible record on the cert is the reference method chosen
            for each cable run, evidenced in the cable-calc design log.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            in 2-3 years of direct UK summer sun; UV-rated cable or UV-protected containment is the
            response. AQ (lightning) is the trigger for the SPD requirements of Section 443 — Reg
            443.4 sets when SPDs are required, Reg 534 sets the installation method. The AQ class
            (AQ1 negligible, AQ2 indirect exposure, AQ3 direct exposure) feeds into the Type 1 /
            Type 2 / Type 3 SPD selection.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            The defensible structure: column 1 location / accessory ID; column 2 environment classes
            (AA, AD, AE, AF, AG, AH, AN as applicable); column 3 utilisation classes (BA, BB, BC, BD
            as applicable); column 4 construction classes (CA, CB if applicable); column 5 minimum
            IP (with reasoning); column 6 minimum IK (with reasoning); column 7 material constraint
            (if any); column 8 Part 7 overlay reference (if applicable); column 9 equipment selected
            (model and data-sheet reference). Together with the cable-calc design log this evidences
            Reg 132.5 (selection of equipment) and Section 522 in a form the inspector can audit
            row-by-row.
          </p>
        </ConceptBlock>
