...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'AE1 refers to environmental conditions where rain protection is not required—typically indoor dry locations. The AE codes cover climatic conditions related to presence of water.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'BE codes relate to mechanical influences including impact (AG), vibration (AH), and other physical forces that could damage electrical equipment. These determine enclosure strength requirements.',
  },
  {
    id: 'chemical-exposure',
    question: 'What code relates to corrosion and chemical exposure risk?',
    options: ['AE (climatic)', 'BE (mechanical)', 'AF (chemical)', 'AD (water)'],
    correctIndex: 2,
    explanation:
      'AF codes relate to chemical influences including corrosive substances, pollutants, and chemicals that can damage electrical equipment and cables. Critical in industrial environments.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Environmental conditions are often the determining factor between successful long-term installations and premature failure. Poor assessment leads to cable insulation degradation, corrosion hazards, water ingress, and UV damage—resulting in equipment failure, safety hazards, and costly replacements within months instead of the expected 25+ year lifespan.',
  },
  {
    question: 'How do I identify the correct IP rating for an enclosure?',
    answer:
      'First assess the environmental influence codes (AD for water, AE for humidity/condensation, BE for solids). Then cross-reference with IP rating requirements in BS 7671 or manufacturer guidance. For example, AD4 (water splashes) typically requires IP X4 minimum, while AD7 (immersion) requires IP X7 or higher.',
  },
  {
    question: 'What materials should I use in chemically aggressive environments?',
    answer:
      'Avoid standard PVC in chemical environments—it becomes brittle when exposed to many solvents and cleaning agents. Consider stainless steel conduit, specialised polymer containment systems, or LSZH (Low Smoke Zero Halogen) cables depending on the specific chemicals present. Always verify material compatibility.',
  },
  {
    question: 'Do I need UV-resistant cables for all outdoor installations?',
    answer:
      'Yes. Standard cable sheathing degrades under UV exposure, becoming brittle and cracked over time. For outdoor installations use cables with UV-stabilised outer sheathing, or install in UV-protected containment. Even indirect sunlight through windows can cause damage over extended periods.',
  },
];
...
const quizQuestion = {
  ...
  correctAnswer: 1,
  explanation:
    'UV radiation degrades many cable insulation materials, causing them to become brittle, crack, and fail over time. This creates electrical hazards and requires premature replacement. UV-stabilised materials or protective enclosures are essential for outdoor installations.',
};
...
const BS7671Module3Section3 = () => {
  useSEO({
    ...
    description:
      'Learn to assess environmental conditions and select appropriate materials and IP ratings using BS 7671 influence codes for reliable electrical installations.',
  });
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Purpose:</strong> Environmental conditions determine material and method
                selection
              </li>
              <li>
                <strong>Codes:</strong> AD (water), AE (humidity), AF (chemical), AG (impact), AH
                (vibration)
              </li>
              <li>
                <strong>Critical:</strong> Wrong materials = premature failure, safety hazards,
                costly replacement
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Survey:</strong> Assess every location before specifying materials
              </li>
              <li>
                <strong>Reference:</strong> BS 7671 Chapter 32 and Appendix 5
              </li>
              <li>
                <strong>IP ratings:</strong> Match enclosure protection to environmental codes
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BS 7671 Chapter 32 provides a systematic classification for environmental conditions
              using alphanumeric codes. These codes describe the environment's characteristics and
              directly influence equipment selection and installation methods.
            </p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The IP (Ingress Protection) rating system defines the protection level of enclosures
              against solid objects and water. Understanding IP codes is essential for selecting
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <ul className="text-white/90 space-y-1">
                    ...
                    <li>
                      <strong>4:</strong> Objects &gt;1mm (tools/wires)
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="text-white/90 space-y-1">
                    ...
                    <li>
                      <strong>6:</strong> Powerful jets
                    </li>
                    <li>
                      <strong>7:</strong> Temporary immersion
                    </li>
                    <li>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>IP20:</strong> Indoor dry locations (domestic consumer units)
                </li>
                <li>
                  <strong>IP44:</strong> Protected outdoor locations (under canopy)
                </li>
                <li>
                  <strong>IP55:</strong> Exposed outdoor equipment
                </li>
                <li>
                  <strong>IP65:</strong> Wash-down areas, food processing
                </li>
                <li>
                  <strong>IP66:</strong> High-pressure cleaning environments
                </li>
                <li>
                  <strong>IP67:</strong> Temporary submersion possible
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Different environmental conditions require specific material choices. Standard
              materials that work in domestic settings may fail rapidly in industrial, outdoor, or
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>SWA:</strong> Mechanical protection, direct burial
                  </li>
                  <li>
                    <strong>LSZH:</strong> Low smoke for escape routes
                  </li>
                  <li>
                    <strong>UV-stabilised:</strong> Outdoor exposure
                  </li>
                  <li>
                    <strong>Oil-resistant:</strong> Industrial environments
                  </li>
                  <li>
                    <strong>Fire-resistant:</strong> Emergency circuits
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Stainless steel:</strong> Corrosive environments
                  </li>
                  <li>
                    <strong>GRP:</strong> Chemical resistance
                  </li>
                  <li>
                    <strong>Galvanised steel:</strong> General industrial
                  </li>
                  <li>
                    <strong>PVC:</strong> Indoor dry locations only
                  </li>
                  <li>
                    <strong>HDPE:</strong> Underground/direct burial
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A systematic environmental survey before installation prevents costly errors. Document
              all conditions and match them to BS 7671 influence codes.
            </p>
            ...
            <div className="my-6">
              ...
              <ol className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>1. Water exposure:</strong> Rain, splashing, immersion, humidity,
                  condensation
                </li>
                <li>
                  <strong>2. Temperature range:</strong> Ambient, extremes, thermal cycling
                </li>
                <li>
                  <strong>3. Chemical presence:</strong> Cleaning agents, process chemicals,
                  pollutants
                </li>
                <li>
                  <strong>4. Mechanical risks:</strong> Impact, vibration, vehicle traffic
                </li>
                <li>
                  <strong>5. UV/solar exposure:</strong> Direct sunlight, indirect through glazing
                </li>
                <li>
                  <strong>6. Dust/particles:</strong> Type, quantity, abrasiveness
                </li>
                <li>
                  <strong>7. Future changes:</strong> Planned process alterations, building
                  modifications
                </li>
              </ol>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="p-5 rounded-lg bg-red-500/5 border border-red-500/20">
            <h3 className="text-sm font-medium text-red-400 mb-3">
              Food Factory Installation Failure
            </h3>
            <p className="text-sm text-white mb-3">
              A contractor installs PVC conduit in a food factory where regular cleaning uses
              caustic chemicals. Within months, the conduit is brittle and damaged—non-compliant due
              to poor material selection. The entire installation requires replacement at
              significant cost.
            </p>
            <div className="p-3 rounded bg-green-500/5 border border-green-500/20">
              ...
              <p className="text-sm text-white">
                Environmental survey identifies AF2 (chemical exposure). Specification includes
                chemical-resistant conduit (stainless steel or specialised polymer) and IP66-rated
                enclosures. Installation remains compliant and safe for decades.
              </p>
            </div>
          </div>
        </section>
