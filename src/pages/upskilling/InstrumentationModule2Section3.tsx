      ...
      <div className="px-4 sm:px-6 lg:px-8 pt-6 pb-8 sm:pt-8 sm:pb-12">
        ...
        <div className="max-w-3xl mx-auto space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3 sm:gap-0 pt-6 sm:pt-8">
            <Link to="/study-centre/upskilling/instrumentation-module-2-section-2" className="w-full sm:w-auto">
            ...
            <Link to="/study-centre/upskilling/instrumentation-module-2-section-4" className="w-full sm:w-auto">
