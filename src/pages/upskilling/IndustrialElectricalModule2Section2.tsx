  ...
  return (
    <div className="bg-background text-foreground">
      ...
      <div className="max-w-3xl mx-auto px-4 pb-12 space-y-10">
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              ...
              <strong className="text-foreground">IEC 60617</strong> to represent electrical
              components and their interconnections. Understanding these symbols is fundamental to
              interpreting and designing control systems.
            </p>
            ...
            <div className="bg-blue-500/10 border-l-2 border-blue-500/50 rounded-r-lg p-4">
              ...
              <ul className="space-y-1 text-sm">
                <li>
                  &bull; Circuits are drawn in the{' '}
                  <strong className="text-foreground">de-energised state</strong> (power off)
                </li>
                <li>
                  &bull; Read diagrams from{' '}
                  <strong className="text-foreground">left to right</strong>, top to bottom
                </li>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Contactors are electromechanical switches designed for high-current switching
              applications. Proper selection requires understanding{' '}
              <strong className="text-foreground">AC utilisation categories</strong> defined in IEC
              60947-4-1.
            </p>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <div className="space-y-3 text-sm">
                <div className="bg-white/5 p-3 rounded border-l-4 border-green-500">
                  ...
                  <p className="mt-1">
                    Resistive heating, incandescent lighting. Make/break at rated current with power
                    factor &gt;= 0.95
                  </p>
                </div>
                <div className="bg-white/5 p-3 rounded border-l-4 border-blue-500">
                  ...
                  <p className="mt-1">
                    Starting and switching off during running. Breaking current = rated current,
                    recovery voltage = 20% of rated
                  </p>
                </div>
                <div className="bg-white/5 p-3 rounded border-l-4 border-orange-500">
                  ...
                  <p className="mt-1">
                    Inching, plugging, reversing. Breaking current = 6x rated, recovery voltage =
                    100% of rated
                  </p>
                </div>
              </div>
            ...
            <div className="bg-orange-500/10 border-l-2 border-orange-500/50 rounded-r-lg p-4">
              ...
              <p className="text-sm">
                A contactor rated 30A AC-3 is <strong className="text-foreground">NOT</strong> rated
                30A AC-4. Typical derating is 40-50% between categories. Always verify the rating
                matches your specific application duty cycle.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Auxiliary contacts are low-current contacts mechanically linked to the main contactor.
              They provide <strong className="text-foreground">status feedback</strong> and enable{' '}
              <strong className="text-foreground">control logic</strong> without handling power
              circuit currents.
            </p>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div className="space-y-2">
                  ...
                  <p>
                    Terminal numbers ending in <strong className="text-foreground">3-4</strong>
                  </p>
                ...
                <div className="space-y-2">
                  ...
                  <p>
                    Terminal numbers ending in <strong className="text-foreground">1-2</strong>
                  </p>
                  <ul className="text-muted-foreground space-y-1">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
                ...
                <ul className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-foreground">Seal-in:</strong> NO contact bypasses
                      start button
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">&bull;</span>
                    <span>
                      <strong className="text-foreground">Interlock:</strong> NC contact prevents
                      opposing contactor
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-elec-yellow">&bull;</span>
                    <span>
                      <strong className="text-foreground">Status:</strong> Drives pilot lamps or PLC
                      inputs
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
                ...
                <p className="text-sm">
                  Additional contacts can be added via snap-on auxiliary contact blocks. Common
                  configurations:
                </p>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Selecting the appropriate control voltage affects safety, reliability, and system
              compatibility. Common options include{' '}
              <strong className="text-foreground">24V AC</strong>,{' '}
              <strong className="text-foreground">110V AC</strong>, and{' '}
              <strong className="text-foreground">230V AC</strong>.
            </p>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <p className="text-sm mb-3">
                Control transformers must handle both sealed load and inrush current during
                contactor pickup.
              </p>
              <div className="bg-white/5 p-3 rounded text-sm font-mono">
                ...
                <p className="text-muted-foreground mt-2">
                  Where: Inrush VA approximately 6-10 x Sealed VA for that contactor
                </p>
              </div>
              <p className="text-sm mt-3">
                <strong className="text-foreground">Example:</strong> 3 contactors at 15VA sealed
                each = 45VA. Add inrush for one picking up: 15VA x 6 = 90VA. Total minimum = 45 + 90
                = 135VA (use 150VA transformer)
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Control circuits must maintain their state after operator input. Two primary methods
              achieve this: <strong className="text-foreground">seal-in circuits</strong> using
              auxiliary contacts and{' '}
              <strong className="text-foreground">maintained switches</strong>.
            </p>
    ...
    Position 2: ON (closed)`}</pre>
            ...
            <div className="bg-green-500/10 border-l-2 border-green-500/50 rounded-r-lg p-4">
              ...
              <p className="text-sm">
                Seal-in circuits with momentary push buttons are generally preferred for motor
                control because the operator must deliberately press START after a power loss.
                Maintained switches may cause unexpected restart, creating a safety hazard.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted-foreground">
            <p>
              Systematic troubleshooting requires understanding circuit operation and using
              appropriate test equipment. The{' '}
              <strong className="text-foreground">half-split method</strong> and{' '}
              <strong className="text-foreground">voltage presence testing</strong> are key
              techniques.
            </p>
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
              ...
              <ol className="space-y-3 text-sm">
                <li className="flex gap-3">
                  <span className="w-6 h-6 rounded-full bg-elec-yellow text-black flex items-center justify-center font-bold shrink-0">
                    1
                  </span>
                  <div>
                ...
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p>
                      Measure voltage at circuit midpoint to isolate fault to upstream or downstream
                    </p>
                  </div>
                </li>
                <li className="flex gap-3">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-3 pb-3 border-b border-white/10">
                  ...
                  <div>
                    ...
                    <p>
                      No voltage at coil - trace back through series elements (stop buttons, OL
                      contacts, interlocks)
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3 pb-3 border-b border-white/10">
                  ...
                  <div>
                    ...
                    <p>
                      Check coil continuity, mechanical jam, low voltage (should be within +/- 10%
                      of rating)
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3 pb-3 border-b border-white/10">
                  ...
                  <div>
                    ...
                    <p>
                      Low voltage, loose connections, worn pole faces, shading ring broken (AC
                      coils)
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-red-500/10 border-l-2 border-red-500/50 rounded-r-lg p-4">
              ...
              <p className="text-sm">
                Always isolate and lock out power circuits before working on control components.
                Control circuits may remain energised even when main power is off. Use appropriate
                PPE and follow safe isolation procedures per your site requirements.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-6 text-sm">
            <div>
              ...
              <ul className="space-y-1 text-muted-foreground">
                <li>
                  &bull; <strong className="text-elec-yellow">1-2, 3-4, 5-6:</strong> Main power
                  contacts
                </li>
                <li>
                  &bull; <strong className="text-elec-yellow">13-14, 23-24:</strong> NO auxiliary
                  contacts
                </li>
                <li>
                  &bull; <strong className="text-elec-yellow">11-12, 21-22:</strong> NC auxiliary
                  contacts
                </li>
                <li>
                  &bull; <strong className="text-elec-yellow">A1, A2:</strong> Coil terminals
                </li>
                <li>
                  &bull; <strong className="text-elec-yellow">95-96, 97-98:</strong> Overload relay
                  contacts
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1 text-muted-foreground">
                <li>
                  &bull; <strong className="text-elec-yellow">AC-1:</strong> Resistive loads (cos
                  phi &gt;= 0.95)
                </li>
                <li>
                  &bull; <strong className="text-elec-yellow">AC-2:</strong> Slip-ring motor
                  starting
                </li>
                <li>
                  &bull; <strong className="text-elec-yellow">AC-3:</strong> Squirrel cage motor
                  starting
                </li>
                <li>
                  &bull; <strong className="text-elec-yellow">AC-4:</strong> Inching, plugging,
                  reversing
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1 text-muted-foreground">
                <li>
                  &bull; <strong className="text-elec-yellow">Pickup:</strong> Must pick up at 85%
                  of rated voltage
                </li>
                <li>
                  &bull; <strong className="text-elec-yellow">Hold-in:</strong> Must hold at 70% of
                  rated voltage
                </li>
                <li>
                  &bull; <strong className="text-elec-yellow">Maximum:</strong> Continuous operation
                  at 110% rated
                </li>
              </ul>
            </div>
