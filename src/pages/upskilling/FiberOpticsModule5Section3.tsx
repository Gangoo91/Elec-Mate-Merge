...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'A complete fibre break',
      'Selecting the wrong test wavelength',
    ],
    correctIndex: 0,
    explanation:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Reflections at connector interfaces',
      'Microscopic density variations in the glass',
      'Macrobends along the cable route',
      'Fusion and mechanical splice points',
    ],
    correctAnswer: 1,
    explanation:
  ...
  {
    id: 3,
    question: 'On an OTDR trace, what does a gradual downward slope indicate?',
    options: [
      'Signal strength increasing along the fibre',
  ...
  },
  {
    ...
    options: [
      'A reflective event such as a connector or break',
      'A fusion splice',
      'A macrobend',
      'A length of normal fibre',
    ],
    correctAnswer: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Wider pulses always improve resolution',
      'Pulse width has no measurable effect',
  ...
  },
  {
    ...
    options: ['1-5 metres', '10-20 metres', '100 metres to 2 kilometres', '5-10 kilometres'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      'An upward slope in the trace',
      'No visible change at the event point',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Absorption of light within the core',
      'Continuous low-level scattering in the glass',
      'Refractive index changes at interfaces (glass-to-air)',
      'Bending of the fibre below its minimum radius',
    ],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'A section of fibre carrying no signal',
      'The minimum distance after a reflection before another event can be detected',
      'The region before the launch cable begins',
      'A length of fibre with zero attenuation',
    ],
    correctAnswer: 1,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To boost the optical signal strength',
      'To reduce reflections at the far connector',
