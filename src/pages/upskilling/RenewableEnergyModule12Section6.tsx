...
const inlineChecks = [
  {
    ...
    question: 'What is the purpose of an MCS handover pack?',
    options: [
  ...
  },
  {
    ...
    question: 'What does the BS 7671 electrician contribute to the MCS handover pack?',
    options: [
  ...
  },
  {
    ...
    question: 'What are MIS 3001-3008 + how do they relate to the handover pack structure?',
    options: [
  ...
  },
  {
    ...
    question: 'What UK 2025-26 grants are relevant to MCS handover packs?',
    options: [
...
const quizQuestions = [
  {
    question: 'PV install: 6 kWp domestic. What does the MCS handover pack typically contain?',
    options: [
  ...
  {
    question: 'BESS install — MCS standard + handover pack components?',
    options: [
  ...
  {
    question: 'Cert evidence bundle vs MCS handover pack — same thing?',
    options: [
  ...
  {
    question: 'DNO submission within the MCS handover pack — what is typically included?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'What if the installer is not MCS certified — can they still complete the LCT install?',
    answer:
...
export default function RenewableEnergyModule12Section6() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 12 · Section 6 · BS 7671:2018+A4:2026 · MCS framework + Reg 644.5"
        title="MCS handover packs — common structure across LCT"
        backTo="../renewable-energy-module-12"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The MCS handover pack as the integrating customer-facing document — sizing report +
          commissioning record + product DoCs + BS 7671 EIC + grant submission + customer operating
          guide. Shared structure across MIS 3001-3008. The BS 7671 electrician\'s contribution +
          integration with the cert evidence bundle. UK 2025-26 grant landscape + DNO submission.
        </p>
        ...
        <Pullquote>
          The MCS handover pack is what the customer takes away. The cert evidence bundle is what
          the installer keeps. Both matter — neither replaces the other.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">MCS sizing report</strong> — yield modelling / heat
              loss survey / capacity sizing per MCS methodology + technology-specific MIS standard
            </li>
            <li>
              <strong className="text-white">Product details + DoCs</strong> — manufacturer
              datasheets + DoCs for modules / inverter / BMS / heat pump / mounting / ancillary
            </li>
            <li>
              <strong className="text-white">Commissioning record</strong> — manufacturer engineer
              commissioning (inverter + BMS); Reg 712.421.101 IMD (PV); Reg 551.7.5 anti-islanding
              (generators); grid synchronisation
            </li>
            <li>
              <strong className="text-white">BS 7671 EIC + Schedules</strong> — electrician\'s
              Electrical Installation Certificate + Schedule of Inspections + Schedule of Test
              Results; Reg 644.5 signed
            </li>
            <li>
              <strong className="text-white">DNO submission</strong> — EREC G98 / G99 + SLD +
              inverter DoC + anti-islanding test + DNO reference (where grid-paralleled)
            </li>
            <li>
              <strong className="text-white">Grant submission paperwork</strong> — BUS / SEG /
              regional scheme + customer consent + property eligibility (EPC) + Ofgem submission
            </li>
            <li>
              <strong className="text-white">Warranty registrations</strong> — manufacturer
              warranties (modules, inverter, BMS, heat pump per technology); installer workmanship
              guarantee
            </li>
            <li>
              <strong className="text-white">Customer operating guide</strong> — system overview,
              monitoring portal access, fault response, emergency shutdown, maintenance schedule,
              contacts
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">BS 7671 EIC per Reg 644.5</strong> — work description,
              designer, installer, verifier, customer, date, protective device data, Schedule
              references; signed by skilled person
            </li>
            <li>
              <strong className="text-white">Schedule of Inspections per Reg 642.3</strong> — items
              (a)-(r) checked + observation; supports the EIC
            </li>
            <li>
              <strong className="text-white">Schedule of Test Results per Reg 643</strong> —
              circuit-by-circuit: continuity, IR, polarity, loop impedance, RCD operation, PFC; LCT
              extensions
            </li>
            <li>
              <strong className="text-white">Reg 641.5 addition / alteration verification</strong> —
              existing-install assessment + remediation record where applicable
            </li>
            <li>
              <strong className="text-white">Protective architecture</strong> — RCD types, OPDD or
              TT alternative + rationale; multi-source coordination per Reg 551.4.2 + Reg 415.1
            </li>
            <li>
              <strong className="text-white">Section / Chapter cross-references</strong> — Section
              712 (PV) + Chapter 57 (BESS) + Section 722 (EV) + Section 551 (generating sets) per
              applicable LCT
            </li>
            <li>
              <strong className="text-white">
                Photographic / thermographic evidence per Reg 653.2 NOTE
              </strong>{' '}
              — supports findings + provides audit trail
            </li>
            <li>
              <strong className="text-white">DNO supporting documentation</strong> — anti-islanding
              test record + protective device data + SLD; integrates with the MCS company\'s DNO
              submission
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          MIS 3001 to 3008 is the alphabet of LCT installer competency. Each standard wraps the same
          BS 7671 install in technology-specific sizing + commissioning + customer education.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">MIS 3001 Solar Thermal</strong> — collectors + DHW
              integration; sizing methodology + commissioning + customer guide. Niche UK 2025-26 (M9
              §9.3)
            </li>
            <li>
              <strong className="text-white">MIS 3002 Solar PV</strong> — yield modelling per MCS PV
              methodology; product approval list; commissioning + customer guide; SEG paperwork.
              Dominant UK 2025-26 LCT
            </li>
            <li>
              <strong className="text-white">MIS 3003 Small Wind</strong> — wind turbines ≤50 kW;
              sizing + mast + electrical + planning + DNO. Lower-volume UK 2025-26 (M9 §9.2)
            </li>
            <li>
              <strong className="text-white">MIS 3004 Biomass</strong> — wood pellet + log biomass
              boilers; combustion + flue + control + customer guide. Wales BUS grant; not BUS
              England / Scotland 2025-26 (M9 §9.4)
            </li>
            <li>
              <strong className="text-white">MIS 3005 Heat Pumps</strong> — ASHP / GSHP /
              exhaust-air; heat loss survey + sizing + commissioning + BUS grant pathway. Dominant
              UK 2025-26 LCT (M8 covered)
            </li>
            <li>
              <strong className="text-white">MIS 3006</strong>— older GSHP standard; consolidated
              into MIS 3005
            </li>
            <li>
              <strong className="text-white">MIS 3007 micro-CHP</strong> — ≤50 kW; Stirling engine +
              fuel cell + IC variants; Section 551 + heat-network. Limited UK 2025-26 deployment (M9
              §9.5)
            </li>
            <li>
              <strong className="text-white">MIS 3008 micro-hydro</strong> — ≤50 kW; turbine +
              civils + Environment Agency + grid connection. Rural niche UK 2025-26 (M9 §9.7)
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Boiler Upgrade Scheme (BUS)</strong> — government
              grant; ASHP £7,500 typical; GSHP £7,500; biomass £5,000 (Wales) / not BUS England +
              Scotland 2025-26. Requires MCS-certified + MCS handover pack + EPC + Ofgem submission
            </li>
            <li>
              <strong className="text-white">Smart Export Guarantee (SEG)</strong> — DNO-licensed
              suppliers offer export tariff for generation up to 5 MW; per-supplier rates ~1-15p/kWh
              2025-26; requires MCS install + EREC G98 / G99 + appropriate metering
            </li>
            <li>
              <strong className="text-white">Historical schemes</strong> — FIT closed 2019 (20-25 yr
              existing contracts); RHI closed 2022 (7 yr existing contracts)
            </li>
            <li>
              <strong className="text-white">Regional variation</strong> — Wales HEEP (Home Energy
              Efficiency Programme); Scotland HES (Home Energy Scotland) grants + loans; NI separate
              schemes
            </li>
            <li>
              <strong className="text-white">Eligibility + EPC</strong> — most schemes require valid
              EPC + property eligibility + customer consent. Verify at quote stage
            </li>
            <li>
              <strong className="text-white">Submission process</strong> — typically via Ofgem
              portal (BUS) or DNO + energy supplier (SEG); installer submits with MCS handover pack
              as supporting evidence
            </li>
            <li>
              <strong className="text-white">Payment route</strong>— BUS typically paid to installer
              who deducts from customer invoice; SEG paid by energy supplier to customer per tariff
              + export
            </li>
            <li>
              <strong className="text-white">Future evolution</strong> — UK energy policy continuing
              through 2025-30 horizon; grant schemes likely to evolve; track current rates +
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">MCS handover pack</strong> — customer-facing; snapshot
              at completion; given to customer + grant body + property records
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — installer-side;
              lifecycle record; opens at install + grows over install life
            </li>
            <li>
              <strong className="text-white">Overlap</strong>— at completion both contain: sizing +
              commissioning + EIC + DoCs + customer guide + warranty + grant paperwork
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle additions</strong> — periodic
              EICR-equivalent reports; firmware updates; alarm events + responses; manufacturer
              correspondence; warranty claims; customer touchpoints; thermal images over time;
              modifications + additions; end-of-life
            </li>
            <li>
              <strong className="text-white">Customer access to cert evidence bundle</strong> —
              customer can request relevant items at periodic reviews + warranty events; default
              retention is installer-side
            </li>
            <li>
              <strong className="text-white">Installer obligation</strong> — retain cert evidence
              bundle for install lifecycle + audit period (typically 6-10 yr post-install)
            </li>
            <li>
              <strong className="text-white">Property sale</strong> — customer\'s MCS handover pack
              travels with property; installer\'s cert evidence bundle remains with installer (or
              transfers to new servicing company)
            </li>
            <li>
              <strong className="text-white">Digital + paper</strong> — UK 2025-26 coexistence;
              cloud-based platforms emerging for both customer + installer access
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Integrated single pack</strong> — preferred for
              new-build + simultaneous multi-source install; single MCS company contracts customer +
              integrates per-MIS contributions; single BS 7671 EIC; single customer touchpoint
            </li>
            <li>
              <strong className="text-white">Per-source packs</strong> — when sources added at
              different times by different installers; each MCS-certified installer provides their
              MCS handover pack for their technology
            </li>
            <li>
              <strong className="text-white">Hybrid approach</strong> — most common UK 2025-26
              reality; customer accumulates multiple packs over years (initial PV + later BESS +
              later heat pump + later EV)
            </li>
            <li>
              <strong className="text-white">MCS company coordination</strong> — same MCS company
              across multiple installs helps continuity; alternative: customer-side integration at
              the property record level
            </li>
            <li>
              <strong className="text-white">BS 7671 EIC per addition</strong> — each LCT addition
              gets its own EIC per Reg 641.5 alteration + Reg 644.5; multi-source schedules can be
              on single EIC or per-addition EICs
            </li>
            <li>
              <strong className="text-white">Property-level cert record</strong> — customer
              maintains property-level cert record integrating all MCS handover packs + EIC + EICR
              over time
            </li>
            <li>
              <strong className="text-white">Future EICR-equivalent</strong> — verifier accesses all
              available records; where records incomplete (older installs without proper handover),
              the EICR-equivalent reconstructs baseline + records the gap
            </li>
            <li>
              <strong className="text-white">UK 2025-26 trend</strong> — increasing integration as
              multi-source becomes the standard new-build + retrofit pattern; MCS framework adapting
            </li>
          </ul>
        </ConceptBlock>
