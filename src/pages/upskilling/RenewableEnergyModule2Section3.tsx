  ...
  const quizQuestions = [
    {
      ...
      options: [
        ...
        'Voltage Overcurrent',
        'Optimal Circuit Voltage',
      ],
      correctAnswer: 1,
      explanation:
        'VOC is Open Circuit Voltage - the maximum voltage a panel produces with no load connected.',
    },
    {
    ...
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'Cold weather causes voltage to increase significantly - this is why string design must account for lowest expected temperatures.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Typical temperature coefficient is around -0.4% per degree C, meaning voltage decreases 0.4% for every degree above 25 degrees C.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'In series connections, voltages add together while current remains the same as individual panels.',
    },
    {
      ...
      correctAnswer: 2,
      explanation:
        'UK regulations specify 1000V as the maximum system voltage for LV (low voltage) PV installations.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'A 10% safety margin is recommended - designing for 900V maximum when 1000V is the limit.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Parallel connections allow each string to perform independently - one underperforming string does not affect others.',
    },
    {
      question: 'What is a common cause of undervoltage problems?',
      options: [
        'Too few panels per string',
        'Too many panels per string',
        'Using different panel types',
        'Incorrect fusing',
      ],
      correctAnswer: 0,
      explanation:
        'Too few panels per string causes string VMP to fall below MPPT minimum, especially in hot weather.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'PVsyst is industry-standard professional software for PV system design, simulation, and yield prediction.',
    },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 pb-24">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              ...
              design table - do not mismatch your string and inverter specifications.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">VOC:</strong> Open Circuit Voltage (~45V)
                  </li>
                  <li>
                    • <strong className="text-white">VMP:</strong> Max Power Voltage (~37V)
                  </li>
                  <li>
                    • <strong className="text-white">Temp effect:</strong> Decreases with heat
                  </li>
                  <li>
                    • <strong className="text-white">Design key:</strong> VOC sets string limits
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">ISC:</strong> Short Circuit Current (~11A)
                  </li>
                  <li>
                    • <strong className="text-white">IMP:</strong> Max Power Current (~10A)
                  </li>
                  <li>
                    • <strong className="text-white">Temp effect:</strong> Slightly increases
                  </li>
                  <li>
                    • <strong className="text-white">Design key:</strong> ISC sets fusing
                  </li>
                </ul>
              </div>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-sm">
                All panel ratings are given at STC: 1000 W/m² irradiance, 25°C cell temperature, AM
                1.5 spectrum. Real-world conditions vary significantly from STC.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Minimum:</strong> String VMP &gt; MPPT min
                  </li>
                  <li>
                    • <strong className="text-white">Maximum:</strong> String VOC &lt; MPPT max
                  </li>
                  <li>
                    • <strong className="text-white">Residential:</strong> 125V to 600V typical
                  </li>
                  <li>
                    • <strong className="text-white">Commercial:</strong> 250V to 1000V
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Min panels:</strong> MPPT min ÷ Panel VMP
                  </li>
                  <li>
                    • <strong className="text-white">Max panels:</strong> MPPT max ÷ Panel VOC
                  </li>
                  <li>
                    • <strong className="text-white">Example:</strong> 600V ÷ 45V = 13 max
                  </li>
                  <li>
                    • <strong className="text-white">Safety:</strong> Leave 10% buffer
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Voltage:</strong> Adds together
                  </li>
                  <li>
                    • <strong className="text-white">Current:</strong> Same as individual
                  </li>
                  <li>
                    • <strong className="text-white">Advantage:</strong> Lower current losses
                  </li>
                  <li>
                    • <strong className="text-white">Risk:</strong> Worst panel limits string
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Voltage:</strong> Same as individual
                  </li>
                  <li>
                    • <strong className="text-white">Current:</strong> Adds together
                  </li>
                  <li>
                    • <strong className="text-white">Advantage:</strong> Independent strings
                  </li>
                  <li>
                    • <strong className="text-white">Risk:</strong> Larger conductors needed
                  </li>
                </ul>
              </div>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <ul className="text-sm space-y-1">
                <li>
                  • <strong className="text-white">Shading:</strong> One shaded panel reduces entire
                  string
                </li>
                <li>
                  • <strong className="text-white">Matching:</strong> Use panels from same
                  batch/manufacturer
                </li>
                <li>
                  • <strong className="text-white">Bypass diodes:</strong> Minimise series shading
                  losses
                </li>
                <li>
                  • <strong className="text-white">Safety:</strong> Higher voltages require extra
                  precautions
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-4 text-white leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Cold:</strong> Voltage increases
                  </li>
                  <li>
                    • <strong className="text-white">Hot:</strong> Voltage decreases
                  </li>
                  <li>
                    • <strong className="text-white">Coefficient:</strong> Typically -0.4%/°C
                  </li>
                  <li>
                    • <strong className="text-white">UK winter:</strong> -10°C to -15°C possible
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Formula:</strong> V(temp) = V(STC) x factor
                  </li>
                  <li>
                    • <strong className="text-white">Factor:</strong> [1 + (T - 25) x coeff]
                  </li>
                  <li>
                    • <strong className="text-white">Example:</strong> 45V at -10°C = 51.3V
                  </li>
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <ul className="text-sm space-y-1">
                <li>
                  • <strong className="text-white">UK regulations:</strong> 1000V max for LV
                  installations
                </li>
                <li>
                  • <strong className="text-white">Safety margin:</strong> Design for 900V maximum
                </li>
                <li>
                  • <strong className="text-white">Components:</strong> All DC parts rated for
                  system voltage
                </li>
                <li>
                  • <strong className="text-white">String fusing:</strong> Required for parallel
                  strings
                </li>
              </ul>
            </div>
        ...
        <div className="mb-8 p-4 rounded-lg bg-elec-yellow/10 border border-elec-yellow/30">
          ...
          <div className="space-y-2 text-white text-sm">
            ...
            <p>
              <strong className="text-white">Power optimisers:</strong> Consider for shaded sites -
              panel-level MPPT provides 15-25% premium but excellent shade tolerance.
            </p>
            <p>
              <strong className="text-white">String matching:</strong> Always use panels from the
              same batch/manufacturer in each string to minimise mismatch losses.
            </p>
          </div>
        </div>
        ...
        {/* Quiz */}
        <div className="mb-8">
          <Quiz title="Section 3 Quiz: String Design" questions={quizQuestions} passingScore={70} />
        </div>
