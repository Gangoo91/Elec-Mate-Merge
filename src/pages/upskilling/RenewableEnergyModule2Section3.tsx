...
const faqs = [
  {
    question: 'How do I calculate the cold-morning V_oc for string sizing?',
    answer:
  ...
  {
    question: 'When does Reg 712.431 require per-string overcurrent protection?',
    answer:
  ...
  {
    question: 'What is a "combiner box" in PV terminology, and when do I need one?',
    answer:
  ...
  {
    question: 'Why does mixing module orientations within a string cause large losses?',
    answer:
  ...
  {
    question: 'Are PWM and MPPT charge controllers actually different in off-grid PV?',
    answer:
  ...
  {
    question: 'What records does an MCS PV install need to capture about strings?',
    answer:
...
export default function RenewableEnergyModule2Section3() {
  ...
  useSEO({
    title: 'Strings and arrays | Renewable Energy 2.3 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 3 · BS 7671:2018+A4:2026"
        title="Strings and arrays"
        backTo="../renewable-energy-module-2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Series stacking for voltage, parallel addition for current. The BS 7671 Reg 712.431
          string-protection rules, cold-morning V_oc calculations, mismatch losses and the
          architectural choices that drive PV system yield.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Series</strong> — modules wired positive-to-negative in
              a chain. Voltages add; the current through the chain is the single-module current (the
              same current flows through every module). String V_oc = Number of modules × module
              V_oc. String I_sc = module I_sc.
            </li>
            <li>
              <strong className="text-white">Parallel</strong> — strings (or modules) connected
              positive-to-positive and negative-to-negative. Voltages share (all parallel branches
              at the same voltage); currents add. Array I_sc = Number of strings × string I_sc.
              Array V_oc = string V_oc.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              <strong className="text-white">Configuration A:</strong> 1 string of 12 series —
              string V_oc = 12 × 41.6 = 499 V, string I_sc = 12.5 A
            </li>
            <li>
              <strong className="text-white">Configuration B:</strong> 2 strings of 6 parallel —
              string V_oc = 6 × 41.6 = 250 V, array I_sc = 2 × 12.5 = 25.0 A
            </li>
            <li>
              <strong className="text-white">Configuration C:</strong> 3 strings of 4 parallel —
              string V_oc = 4 × 41.6 = 167 V, array I_sc = 3 × 12.5 = 37.5 A
            </li>
          </ul>
          <p>
            The configuration choice is driven by the inverter\'s input voltage and MPPT range, the
            cable size constraints, and the desired roof layout. Higher string voltage means lower
            string current (lower I²R cable losses), but demands the inverter accepts the higher
            voltage and tolerates the cold-day V_oc rise. Configuration A is the typical residential
            pattern for hybrid inverters with 400–600 V MPPT ranges.
          </p>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          The cold-morning V_oc calculation — the most-missed design check
        </ContentEyebrow>

        <Pullquote>
          The cold-morning V_oc is the most-missed UK PV string sizing calculation.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Step 1</strong> — Module datasheet: read V_oc at STC
              and the V_oc temperature coefficient (typically -0.25 to -0.35 %/°C, meaning V_oc
              decreases at high temperature, increases at low temperature)
            </li>
            <li>
              <strong className="text-white">Step 2</strong> — Site design minimum cell temperature:
              typically -5 to -10°C for UK sites, per MIS 3002 / IET CoP methodology
            </li>
            <li>
              <strong className="text-white">Step 3</strong> — Temperature delta from STC: ΔT = 25°C
              − T_min (e.g. 25 − (-10) = 35°C)
            </li>
            <li>
              <strong className="text-white">Step 4</strong> — Cold-morning module V_oc = V_oc_STC ×
              (1 + ΔT × |coefficient|)
            </li>
            <li>
              <strong className="text-white">Step 5</strong> — Cold-morning string V_oc = number of
              modules × cold-morning module V_oc
            </li>
            <li>
              <strong className="text-white">Step 6</strong> — Compare against inverter absolute
              maximum DC input voltage — leave margin (5–10% headroom is typical good practice)
            </li>
          </ul>
          <p>
            Worked example — a 14-module string with V_oc 41.6 V, coefficient -0.27 %/°C, design
            minimum cell temp -10°C:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              Against an inverter with 600 V absolute maximum DC input — 637 V is ABOVE the limit.
              The string is one module too long. Reduce to 13 modules (13 × 41.6 × 1.0945 ≈ 591 V —
              within the 600 V limit with margin).
            </li>
          </ul>
          <p>
            The opposite end — hot-day V_mp must remain above the inverter\'s MPPT minimum voltage.
            Same calculation method, opposite direction: hot-day cell temperature (typically 60–70°C
            on a UK summer roof), V_mp temperature coefficient applied. If hot-day V_mp drops below
            the inverter MPPT minimum, the inverter cannot operate the string at MPP and yield
            collapses during peak production hours.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Uoc_max default</strong> — where no information is
              available about the expected minimum site temperature OR about the PV module\'s V_oc
              temperature coefficient, Uoc_max shall be chosen as 1.2 × Uoc_stc (20% conservative
              margin)
            </li>
            <li>
              <strong className="text-white">Isc_max default</strong> — where no temperature data is
              available, Isc_max shall be at least 1.25 × Isc_stc (25% conservative margin to
              account for irradiance enhancement and temperature effects)
            </li>
          </ul>
          <p>
            These are the fallback multipliers when datasheet information is unavailable. On most
            modern installs the datasheet provides explicit temperature coefficients, and the
            calculated Uoc_max / Isc_max values are tighter than the conservative defaults —
            capturing more headroom for the string length while staying compliant.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">PV string cable</strong> — where overcurrent protection
              is required (per the Reg 712.431.101 inequality), the cable\'s continuous
              current-carrying capacity Iz shall be ≥ Isc_max of the string
            </li>
            <li>
              <strong className="text-white">PV sub-array cable</strong> — Reg 712.433.102: in
              arrays with one or two sub-arrays, no overcurrent protective device of the sub-array
              cables is required. The cable\'s Iz shall be ≥ Isc_max of the sub-array
            </li>
            <li>
              <strong className="text-white">DC isolator / switching device</strong> — selection per
              Isc_max as design current; voltage rating per Uoc_max as nominal voltage
            </li>
          </ul>
          <p>
            The distinction between string protection (Reg 712.431.101) and sub-array cable
            protection (Reg 712.433.102) matters on larger commercial installs where multiple
            strings combine into sub-arrays before reaching the inverter. Residential single-string
            installs don\'t engage the sub-array rules; commercial multi-string-per-MPPT installs
            typically do.
          </p>
        </ConceptBlock>
        ...
        <Pullquote>
          One string or two? No overcurrent protection. Three or more? Check the inequality.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Stage 1 — Small array exemption</strong>: arrays with 1
              PV string or 2 PV strings in parallel are EXEMPT from per-string overcurrent
              protection. This is explicit in Reg 712.431.
            </li>
            <li>
              <strong className="text-white">Stage 2 — Inequality for 3+ strings</strong>: where the
              array has more than 2 parallel strings, apply the inequality 1.35 × Imop_max_ocer &lt;
              (Ns − 1) × Isc_max. Where the inequality is met, protective devices shall be provided
              to protect each PV string.
            </li>
          </ul>
          <p>The inequality\'s rationale:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Left side: 1.35 × Imop_max_ocer</strong> — the scaled
              maximum operating current of a single string
            </li>
            <li>
              <strong className="text-white">Right side: (Ns − 1) × Isc_max</strong> — the back-feed
              current from the other Ns-1 parallel strings if the string under consideration faults
            </li>
            <li>
              Where the back-feed current exceeds the scaled operating current, the string\'s cable
              / connectors could be overstressed without per-string protection — so protection is
              required
            </li>
          </ul>
          <p>
            In practice, for Ns ≥ 3 with typical residential module values (Imop_max ≈ I_sc_max ≈
            11–12 A), the inequality always holds: 1.35 × Isc_max &lt; 2 × Isc_max. Per-string
            protection is the default design choice for any array with 3+ parallel strings.
          </p>
          <p>Implementation choices for per-string protection:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">gPV fuses</strong> to BS EN 60269-6 in MC4-compatible
              in-line holders or DIN-rail combiner boxes — the standard PV-specific fuse type
            </li>
            <li>
              <strong className="text-white">Fuse rating</strong> typically 1.25–1.5 × Isc_max — the
              exact value per the design pack calculation
            </li>
            <li>
              <strong className="text-white">Combiner box</strong> hosts the per-string fuses, the
              DC isolator, the array surge protective device, and the cable-management to the
              inverter DC input
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Module-model mismatch</strong> — replacing a failed
              module with a different make/model. The mismatched module has different V_mp / I_mp /
              I_sc, dragging the string off-MPP. Fix: replace the whole string with matched modules,
              OR move the mismatched module to a separate MPPT input.
            </li>
            <li>
              <strong className="text-white">Orientation mismatch</strong> — modules facing
              different directions in the same string. Each orientation produces different
              irradiance at any moment; the string is dragged to the lowest-current orientation.
              Fix: separate strings for each orientation, into separate MPPT inputs.
            </li>
            <li>
              <strong className="text-white">Partial shade mismatch</strong> — shaded cells force
              the bypass diode to engage; the bypassed sub-string contributes nothing. Cumulative
              shade across multiple modules in a string can take down most of the string. Fix:
              redesign the layout to eliminate shade; OR use module-level optimisation
              (microinverters / power optimisers — Section 2.5).
            </li>
          </ul>
          <p>
            The PWI grounding flags &ldquo;all solar panels in an array must face in the same
            direction&rdquo; as a design rule explicitly — &ldquo;each cell receives the same amount
            of light, which is important for optimum power production&rdquo;. Where this can\'t be
            achieved (multi-pitch roofs, chimney shadows, complex shading), the design moves to
            multi-MPPT or module-level architecture.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">String V_oc</strong> — measured at the combiner box /
              inverter input under the test conditions
            </li>
            <li>
              <strong className="text-white">String I_sc</strong> — or short-circuit current per BS
              EN 62446-1 methodology (typically using a clamp meter on the shorted string with
              appropriate safety precautions)
            </li>
            <li>
              <strong className="text-white">Insulation resistance to earth</strong> — typically
              &gt; 1 MΩ, tested at the manufacturer-specified test voltage (often 500 V or 1000 V DC
              depending on system voltage)
            </li>
            <li>
              <strong className="text-white">Continuity</strong> — of the protective conductor on
              the array frame earthing
            </li>
            <li>
              <strong className="text-white">Test conditions</strong> — date, time, ambient
              temperature, cell temperature (calculated or measured), incident irradiance (measured
              with a pyranometer or inferred from nearby meteorological data)
            </li>
          </ul>
          <p>
            The future diagnostic value: a 5-year periodic inspection compares the current V_oc
            against the commissioning baseline at similar conditions. A significant drop indicates
            module degradation, cell-level damage, or connection resistance. The PWI flags
            &ldquo;not recording baseline Voc/Isc for comparison&rdquo; as a common-mistake item —
            the install completes but the diagnostic toolkit for the future is incomplete.
          </p>
          <p>
            The cert evidence bundle therefore includes both the design-time calculations (cold-day
            V_oc, MPPT compatibility, per-string protection sizing) AND the as-installed
            commissioning readings. The two together form the durable record for the install\'s 25+
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-2-section-2')}
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-2-section-4')}
