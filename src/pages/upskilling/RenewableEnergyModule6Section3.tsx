...
const inlineChecks = [
  ...
  },
  {
    ...
    question: 'What is the trigger threshold of an RDC-DD per BS EN IEC 62955?',
    options: [
  ...
  },
  {
    ...
    question: 'Reg 722.421.1.7.201 — AFDD requirement and exception. What does it say?',
    options: [
...
const quizQuestions = [
  ...
  {
    question: 'The Control Pilot (CP) wire in a Mode 3 install — what does it actually do?',
    options: [
...
const faqs = [
  ...
  {
    question:
      "What's the actual cost difference: Type B RCBO vs Type A RCBO + RDC-DD-equipped wallbox?",
    answer:
...
export default function RenewableEnergyModule6Section3() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 6 · Section 3 · BS 7671:2018+A4:2026 · Reg 722.531 + 722.421"
        title="RCD architecture & RDC-DD — Reg 722.531"
        backTo="../renewable-energy-module-6"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Two acceptable RCD architectures per Reg 722.531: Type B (BS EN 62423 / 60947-2) OR Type A
          combined with RDC-DD (BS EN IEC 62955 6 mA DC). Why transformerless wallboxes need
          smooth-DC detection. AFDD conjunctive exception per Reg 722.421.1.7.201.
        </p>
        ...
        <Pullquote>
          Type B is one device. Type A + RDC-DD is two devices that do the same job. Same fault
          coverage, different cost.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Wallbox is transformerless</strong> — no galvanic
              isolation between AC input and DC electronics. UK 2025-26 default
            </li>
            <li>
              <strong className="text-white">Internal DC fault</strong> — insulation failure between
              the wallbox’s DC bus and a touchable conductive part; or between vehicle-side DC and
              chassis
            </li>
            <li>
              <strong className="text-white">Smooth DC current flows</strong> — the fault current
              pattern is smooth DC (steady-state DC, not pulsating). Visible to a
              smooth-DC-sensitive detector
            </li>
            <li>
              <strong className="text-white">Type AC RCD blind</strong> — Type AC operates only on
              sinusoidal AC residual current. Smooth DC: zero response
            </li>
            <li>
              <strong className="text-white">Type A RCD blind</strong> — Type A handles AC +
              pulsating DC. Smooth DC: zero response
            </li>
            <li>
              <strong className="text-white">Type B detects directly</strong> — Type B is
              specifically designed to handle the full waveform set: AC, pulsating DC, smooth DC.
              Single device covers all cases
            </li>
            <li>
              <strong className="text-white">RDC-DD detects directly</strong> — a separate 6 mA DC
              residual detector inside the wallbox; on detection, opens the wallbox contactor.
              Combined with upstream Type A: same coverage as Type B
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Type B = one expensive device. Type A + RDC-DD = two cheaper devices. UK 2025-26 default =
          Type A + integrated RDC-DD.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Standards</strong> — BS EN 62423 (RCD with integral
              overcurrent — i.e. RCBO equivalent) or BS EN 60947-2 (general circuit-breaker with
              integrated Type B residual current detection)
            </li>
            <li>
              <strong className="text-white">Detection</strong> — AC sinusoidal + pulsating DC +
              smooth DC residual currents. Sensitive to 6 mA DC component within the overall
              threshold
            </li>
            <li>
              <strong className="text-white">Threshold</strong> — typically 30 mA for the ADS
              additional protection on a Mode 3 EV circuit. Some three-phase commercial installs use
              100 mA / 300 mA upstream with 30 mA at the wallbox-side
            </li>
            <li>
              <strong className="text-white">Cost</strong> — ~3-5× a Type A RCBO of equivalent
              current rating. UK 2025-26 Type B RCBO ~£150-200
            </li>
            <li>
              <strong className="text-white">Testing</strong> — requires Type B-capable RCD test
              instrument (Megger MFT1731, Fluke 1664 FC, Kewtech KT64DL or equivalent). Older Type
              AC / A-only testers cannot correctly verify Type B
            </li>
            <li>
              <strong className="text-white">When to choose</strong> — wallbox model doesn’t include
              integrated RDC-DD; commercial sites with high-volume EV charging; installer preference
              for single-device architecture; specific manufacturer recommendation
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Type A standards</strong> — BS EN 61008 (RCD without
              overcurrent) or BS EN 61009 (RCBO with integral overcurrent). Both detect AC +
              pulsating DC residual currents
            </li>
            <li>
              <strong className="text-white">RDC-DD standard</strong> — BS EN IEC 62955 —
              specifically defines the 6 mA DC threshold device integrated into EV charging
              equipment
            </li>
            <li>
              <strong className="text-white">Mechanism</strong> — Type A operates on AC + pulsating
              DC at 30 mA (separately from the RDC-DD). RDC-DD operates on smooth DC at 6 mA inside
              the wallbox. RDC-DD operation opens the wallbox’s internal contactor — upstream Type A
              doesn’t need to operate (the fault was smooth DC, invisible to Type A)
            </li>
            <li>
              <strong className="text-white">Test sequence</strong> — Type A tested via standard RCD
              tester at install. RDC-DD tested via the wallbox’s built-in self-test mode
              (manufacturer-defined; simulates 6 mA DC fault). Cert evidence bundle records both
              tests
            </li>
            <li>
              <strong className="text-white">Cost</strong> — Type A RCBO ~£25-40; incremental
              wallbox cost for integrated RDC-DD ~£30-80. Total architecture cost ~£75 vs Type B at
              ~£150
            </li>
            <li>
              <strong className="text-white">
                Common brands with integrated RDC-DD (UK 2025-26)
              </strong>{' '}
              — PodPoint Solo, EO Mini Pro 3, Wallbox Pulsar Plus, MyEnergi Zappi, Hypervolt,
              Andersen, Ohme. Verify via DoC on the specific model
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          RCD selectivity, three-phase architecture & the Type B internals
        </ContentEyebrow>

        <Pullquote>
          Type B inside the device is a sum-of-current toroid plus a smooth-DC sensitive Hall-effect
          coil. Two detection mechanisms on one core.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              ...
              sums L and N currents through a toroidal core; net flux drives a secondary winding
              whose voltage is the residual current signal. Sensitive to AC + pulsating DC
            </li>
            <li>
              <strong className="text-white">Hall-effect coil</strong> — additional sensor oriented
              in the same toroid; detects smooth DC magnetic flux directly. Sensitive to smooth DC
              fault current (the gap that Type AC and Type A miss)
            </li>
            <li>
              <strong className="text-white">Comparator electronics</strong> — combines the two
              detection signals; either triggering above threshold (30 mA on the primary; smaller
              smooth-DC threshold typically in the 6 mA region) opens the device contacts
            </li>
            <li>
              <strong className="text-white">Threshold split</strong> — BS EN 62423 sets the 30 mA
              primary residual threshold; smooth-DC threshold separately specified to coordinate
              with the RDC-DD-DD coverage profile
            </li>
            <li>
              <strong className="text-white">Test instrument requirement</strong> — Reg 643.1
              instruments per BS EN 61557; specifically Type B-capable testers generate the
              smooth-DC test waveform. Megger MFT1731, Fluke 1664 FC, Kewtech KT64DL etc. Older AC /
              A-only testers cannot exercise the Hall-effect path
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">4-pole device</strong> — L1 + L2 + L3 + N switched
              together. Both Type B RCBOs and Type A RCBOs available in 4-pole form
            </li>
            <li>
            ...
            <li>
              ...
              deliver balanced load when charging (32 A on each phase simultaneously); the supply
              doesn’t experience large imbalance from the EV alone
            </li>
            <li>
              <strong className="text-white">DNO notification</strong> — three-phase installs often
              above G98 notification thresholds; require G98 / G99 notification + DNO approval
              before commissioning. Cert evidence bundle records the DNO correspondence
            </li>
            <li>
              <strong className="text-white">Cost</strong> — 4-pole Type B RCBO typically 3-5× the
              cost of single-pole Type B; multiply through for 4 poles + the higher Type B premium =
              ~£400-£700 for a 4-pole Type B RCBO vs ~£150 for single-phase
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            ...
            <li>
              ...
              device adds a short trip delay (~30-300 ms) that lets the downstream device clear
              first
            </li>
            <li>
              <strong className="text-white">Type compatibility</strong> — if downstream is Type B
              (smooth-DC capable), upstream should also be at least Type A — otherwise smooth-DC
              fault current passes through both and trips the upstream first
            </li>
            <li>
              <strong className="text-white">No upstream RCD scenario</strong> — modern consumer
              units with all-RCBO arrangement (each circuit on its own RCBO, no main-incomer RCD)
              avoid the selectivity question entirely
            </li>
            <li>
              <strong className="text-white">Commissioning verification</strong> — operate the 30 mA
              EV test button; confirm only the EV RCBO trips, not the upstream device. Record in
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">General rule</strong> — Section 421 / Reg 421.1.7
              requires AFDD on AC final circuits in dwellings (with various carve-outs and
              conditions). EV circuits in dwellings would fall under this general requirement
            </li>
            <li>
              <strong className="text-white">Reg 722.421.1.7.201 exception</strong> — where the EV
              charging equipment conforms to BS EN 61851 series AND incorporates socket-outlets or
              vehicle connectors conforming to BS EN IEC 62196-2, AFDD is NOT required on the EV
              circuit
            </li>
            <li>
              <strong className="text-white">Conjunctive exception</strong> — BOTH conformities
              required simultaneously. Manufacturer DoC must declare both. If only BS EN 61851
              declared, or only BS EN IEC 62196-2 declared, exception doesn’t apply and AFDD is
              needed
            </li>
            <li>
              <strong className="text-white">Why the exception exists</strong> — BS EN
              61851-compliant wallboxes integrate electronic protection that addresses the same
              arc-fault profile that AFDD detects. The exception recognises this without forcing a
              duplicate device
            </li>
            <li>
              <strong className="text-white">UK 2025-26 reality</strong> — virtually all reputable
              wallbox brands declare both conformities. The exception is the standard route; AFDD
              rarely fitted on UK domestic EV circuits. Where the installer is uncertain about the
              wallbox’s declarations, fitting AFDD is the conservative choice
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — records the AFDD
              decision: exception invoked with both DoC references, OR AFDD fitted with Section 421
              compliance
            </li>
          </ul>
        </ConceptBlock>
