import { Gauge, Thermometer, FlaskConical } from 'lucide-react';
...
const sections = [
  ...
  },
  {
    ...
    icon: Thermometer,
    description: 'Temperature measurement devices, principles and applications.',
  },
  {
    id: 3,
    title: 'Pressure and flow sensors',
    icon: Gauge,
    description: 'Pressure and flow measurement for fluid and gas systems.',
  },
  {
    id: 4,
    title: 'Level, position and proximity sensors',
    icon: Gauge,
    description: 'Spatial awareness sensors for level, position and proximity.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    icon: Gauge,
    description:
      'Decision framework for selecting sensors against technical and environmental criteria.',
  },
  {
    id: 7,
    ...
    icon: FlaskConical,
    description:
      'Conductivity and pH — what they can and cannot tell you, why probe geometry enters the reading, and why these sensors are consumable.',
  },
];
...
export default function InstrumentationModule2() {
  useSEO({
    ...
    description:
      'Temperature, pressure, flow, level, position and proximity sensors — operating principles and selection.',
  });
