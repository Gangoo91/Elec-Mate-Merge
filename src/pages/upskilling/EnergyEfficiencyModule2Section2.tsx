...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Load Factor = (Actual Energy Used) / (Max Demand x Hours). 180,000 kWh / (500kW x 720 hours) = 180,000 / 360,000 = 0.50 or 50%. A 50% load factor indicates reasonable but improvable utilisation.',
  },
  {
    id: 'm2s2-qc2',
    question:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Maximum Demand / Average Demand x 100',
      'Average Demand / Maximum Demand x 100',
      'Total Energy / Connected Load x 100',
      'Peak Load / Base Load x 100',
    ],
    correctAnswer: 1,
    explanation:
      'Load Factor = (Average Demand / Maximum Demand) x 100. This shows what percentage of your maximum capacity is being utilised on average.',
  },
  {
    id: 3,
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'A load factor above 70% is generally considered good. Typical values vary by sector: process industries often achieve 70-85%, commercial buildings 30-50%, and retail 25-40%. Improve load factor by spreading production across more hours, using thermal storage, scheduling high-demand processes off-peak, and staggering equipment start-up times.',
  },
  {
    question: 'How does half-hourly metering data help identify savings opportunities?',
    answer:
      'Half-hourly data reveals patterns invisible in monthly bills: unexpected overnight loads, demand spikes from poor motor starting, consumption during unoccupied periods, and gradual increases suggesting maintenance issues. Many businesses find 10-20% savings opportunities through HH data analysis.',
  },
  {
    question: 'What are DUoS bands and why do they matter?',
    answer:
      'Distribution Use of System (DUoS) charges vary by time band: Red (peak, typically 4pm-7pm weekdays) has the highest charges, Amber (shoulder periods) is moderate, and Green (overnight and weekends) is lowest. The ratio between red and green rates can be 10:1 or more, making load shifting highly valuable.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-3xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white/80">
            Master load profiling techniques to identify energy savings and optimise electricity
            costs
          </p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              ...
              <li>
                <strong>Good Target:</strong> Above 70% utilisation
              </li>
              <li>
                <strong>Triads:</strong> Three peak half-hours Nov-Feb
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> High overnight base load, demand spikes
              </li>
              <li>
                <strong>Use:</strong> Load shifting, Triad avoidance, staggered starts
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              A load profile is a graphical representation of electrical demand over time, typically
              showing kW or kVA on the vertical axis and time on the horizontal axis. These profiles
              reveal consumption patterns essential for energy management and cost optimisation.
            </p>
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">Types of Load Profiles:</p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Daily Load Profile:</strong> Shows 24-hour demand pattern, revealing peak
                  times, base load, and consumption during occupied vs unoccupied periods
                </li>
                <li>
                  <strong>Weekly Load Profile:</strong> Reveals weekday vs weekend patterns, helping
                  identify unnecessary weekend consumption
                </li>
                <li>
                  <strong>Annual Load Profile:</strong> Shows seasonal variations driven by heating,
                  cooling, and lighting demands
                </li>
                <li>
                  <strong>Load Duration Curve:</strong> Ranks demand from highest to lowest, showing
                  percentage of time at each level
                </li>
              </ul>
            </div>
            <p>
              Sites with maximum demand above 100kW are required to have half-hourly (HH) metering
              in the UK. This provides 48 data points per day, enabling detailed load analysis. From
              2024-2025, smart meter rollout is extending half-hourly settlement to smaller
              consumers.
            </p>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Base Load Components (24/7 regardless of occupancy):
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <p>
              ...
              demand to expected essential loads. A typical commercial building should see overnight
              demand drop to 20-30% of peak. If it remains above 50%, investigate for equipment left
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Formula:</strong> Load Factor = (Average Demand / Maximum Demand) x 100%
                </li>
                <li>
                  <strong>Below 40%:</strong> Poor - highly variable demand, poor utilisation
                </li>
                <li>
                  <strong>40-70%:</strong> Moderate - typical for commercial buildings
                </li>
                <li>
                  <strong>Above 70%:</strong> Good - consistent demand, efficient operation
                </li>
              </ul>
            </div>
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Formula:</strong> Diversity Factor = Sum of Individual Max Demands /
                  Actual Combined Max Demand
                </li>
                <li>
                  A diversity factor greater than 1.0 indicates loads do not peak simultaneously
                </li>
                <li>
                  Example: Three loads (50kW + 75kW + 100kW = 225kW total) with combined max of
                  180kW gives diversity factor of 1.25
                </li>
              </ul>
            </div>
            <p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Distribution Use of System (DUoS) charges vary significantly by time band.
              Understanding these is essential for optimising tariff selection and scheduling
              flexible loads.
            </p>
            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                DUoS Time Bands (typical - varies by DNO region):
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Red Band (Peak):</strong> Typically 16:00-19:00 weekdays - highest cost
                  when network stress is greatest
                </li>
                <li>
                  <strong>Amber Band (Shoulder):</strong> Daytime hours outside peak (e.g.,
                  07:00-16:00 and 19:00-23:00) - moderate cost
                </li>
                <li>
                  <strong>Green Band (Off-Peak):</strong> Overnight (23:00-07:00) and weekends -
                  lowest cost with spare capacity
                </li>
              </ul>
            </div>
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Winter (Nov-Feb):</strong> Higher heating loads, extended lighting hours,
                  Triad exposure period
                </li>
                <li>
                  <strong>Summer (May-Aug):</strong> Higher cooling loads, reduced lighting demand,
                  generally lower overall demand in UK climate
                </li>
              </ul>
            </div>
            <p>
              The ratio between red and green rates can be 10:1 or more. For a business with
              flexible loads, shifting consumption from red to green periods can reduce DUoS costs
              by 50% or more.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              the total electricity bill. Understanding these charges is crucial for cost
              management.
            </p>
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Supply Capacity Charges (£/kVA/month):</strong> Based on your Agreed
                  Supply Capacity with the DNO
                </li>
                <li>
                  <strong>Maximum Demand Charges (£/kVA):</strong> Based on your highest half-hourly
                  average demand in the billing period
                </li>
                <li>
                  <strong>Triad Charges (£/kW/year):</strong> Based on demand during three peak
                  national demand half-hours (Nov-Feb), typically £40-50/kW
                </li>
              </ul>
            </div>
            <div className="my-6">
              ...
              <p className="text-sm text-white">
                A single 30-minute spike can set your maximum demand for the entire month. For
                example, if three large motors start simultaneously and spike demand from 400kVA to
                600kVA, at £5/kVA/month that 30-minute spike costs an extra £1,000 that month.
              </p>
            </div>
            <p>
              Many tariffs include charges for excessive reactive power (poor power factor). If your
              power factor falls below 0.95, you may face additional charges or your kVA demand will
              be inflated.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Out-of-Hours Analysis:</strong> Compare night/weekend demand to expected
                  essential loads - typically 10-25% of consumption is avoidable
                </li>
                <li>
                  <strong>Peak Demand Analysis:</strong> Identify coincident equipment operation
                  that could be staggered - 15-30% peak reduction possible
                </li>
                <li>
                  <strong>Load Shifting Opportunities:</strong> Identify flexible loads that could
                  move from red to green band - 20-50% DUoS cost reduction
                </li>
                <li>
                  <strong>Anomaly Detection:</strong> Look for step changes in base load,
                  consumption not correlating with occupancy, or gradual drift upward
                </li>
              </ul>
            </div>
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Immediate Actions:</strong> Stagger motor start times, schedule high-load
                  processes off-peak, implement time controls
                </li>
                <li>
                  <strong>Investment Options:</strong> Power factor correction, BEMS upgrades,
                  thermal energy storage, battery storage for peak shaving
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Conducting Load Analysis
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  Obtain at least 12 months of half-hourly data to capture seasonal variations
                </li>
                <li>
                  Compare weekday vs weekend profiles to identify unnecessary out-of-hours
                  consumption
                </li>
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Ignoring power factor</strong> - it significantly affects kVA demand
                  charges
                </li>
                <li>
                  <strong>Not checking DUoS bands</strong> - time-of-use savings can be substantial
                </li>
                <li>
                  <strong>Oversizing supplies</strong> - pay for capacity you don't use
                </li>
              </ul>
            </div>
          </div>
