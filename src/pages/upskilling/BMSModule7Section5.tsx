...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'To shorten the overall commissioning programme',
      'To satisfy the building insurer before energisation',
      'To complete operator training ahead of handover',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To verify that individual cable terminations are correct',
      'To measure the control panel power supply voltages',
      'To test complete sequences and system integration',
      'To label devices, panels and field wiring',
    ],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    options: [
      'To confirm system performance under normal running conditions',
      'To calibrate sensors and actuators against reference instruments',
      'To verify the communication protocols between controllers',
