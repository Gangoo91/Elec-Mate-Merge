...
const inlineChecks = [
  ...
  {
    id: 'elm2-s6-annual',
    question: 'What is the BS 5266-1:2025 annual full-duration test requirement?',
    options: [
  ...
  },
  {
    ...
    question: 'What does BS EN 62034 self-test technology offer in terms of routine maintenance?',
    options: [
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'What is the BS 5266-1:2025 annual test requirement?',
    options: [
  ...
  {
    id: 4,
    question: 'How long must emergency lighting test records typically be retained?',
    options: [
  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/electrician/upskilling/emergency-lighting-module-2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The maintenance regime that keeps emergency lighting actually emergency-ready. BS EN
          50172:2024 + BS 5266-1:2025 set the testing cadence: daily check (CPS only), monthly
          functional test of every luminaire and sign, and annual full-duration discharge test. The
          logbook records every test against every luminaire. The Regulatory Reform (Fire Safety)
          Order 2005 article 17 puts the legal duty on the responsible person; BS EN 62034 self-test
          luminaires automate the labour.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              battery system: confirm healthy indicator (typically green LED), no fault lights, no
              audible alarms, battery temperature within range. Performed by site staff at the start
              of each working day. Self-contained luminaire systems do not require a daily check (no
              centralised infrastructure to inspect). Records: a daily log entry with a tick or note
              of any issue.
            </li>
            <li>
              ...
              Each luminaire confirmed energising correctly. Typical test duration 5 minutes — long
              enough to verify switchover, battery drive-up, and steady illumination; short enough
              to avoid significant battery drain. Recorded in the logbook by luminaire reference.
              Done monthly without exception.
            </li>
            <li>
              <strong>Annual full-duration discharge test.</strong> Every luminaire held on
              emergency battery for the full rated duration (1 h or 3 h depending on system design).
              Illuminance / luminance must remain at least 50 % of rated value at the end of the
              duration. After discharge, the system must recharge fully within 24 h. The annual test
              is the most aggressive battery test in the regime; many failures appear only in the
              last 30 minutes of a 3 h discharge and are invisible to the monthly 5-minute test.
            </li>
            <li>
              <strong>Recharge verification.</strong> After each annual discharge, confirm full
              recharge within 24 h by inspection of CPS / battery management system data, or by a
              follow-up functional test 24 h after the discharge. A system that fails to recharge
              fully within 24 h has a charger or battery problem and is not fit for service until
              rectified.
            </li>
            <li>
              ...
              during the discharge, and a coincident mains failure during the test would leave no
              emergency illumination. Best practice is to test out-of-hours or in low-occupancy
              periods, or to test in zones so that any single zone is offline for only a portion of
              the period.
            </li>
            <li>
              <strong>Test records.</strong> Logbook entry per test per luminaire. Date, time,
              luminaire reference, test type (monthly / annual), result (pass / fail), tester name.
              Faults flagged for remedial action.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              normal operation; (b) monthly, simulation of failure of the normal lighting supply and
              verification of the operation of every emergency luminaire and sign for a period
              sufficient to verify their function (typically not less than 5 min); (c) annually,
              simulation of failure of the normal lighting supply and verification of the operation
              of every emergency luminaire and sign for the full rated duration of the system. The
              system shall recover to full charge within 24 h.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Operate the test key.</strong> Turn the key switch (or operate the test push
              button) on the luminaire — or operate the circuit-level test switch on the local DB.
              The luminaire transitions to emergency mode (battery drive).
            </li>
            <li>
              <strong>Verify illumination.</strong> Confirm the luminaire is producing light at
              emergency level. For non-maintained luminaires, the lamp / LED illuminates from cold;
              for maintained luminaires, the lamp / LED stays illuminated through the transition.
            </li>
            <li>
              <strong>Hold for typically 5 minutes.</strong> The 5-minute period verifies that the
              battery is supporting the lamp / LED, not just providing initial drive-up. Some
              testers hold for as little as 1 minute (sufficient for switchover verification) but 5
              minutes is the typical figure.
            </li>
            <li>
              <strong>Restore mains.</strong> Release the test key / restore the DB. Confirm the
              luminaire returns to normal mode. For maintained luminaires the lamp / LED stays on;
              for non-maintained it switches off.
            </li>
            <li>
            ...
            <li>
              <strong>Repeat for every luminaire.</strong> The standard is "every luminaire" without
              exception; sample testing is not permitted. For a building with many luminaires this
              is significant labour — see the self-test option below.
            </li>
            <li>
              <strong>Test cycle.</strong> Some installations test all luminaires on a single day
              each month; others split the test across the month (e.g. 25 % per week) to spread the
              labour. Either approach is acceptable; the requirement is that every luminaire is
              tested in each calendar month.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Every emergency luminaire and emergency exit sign shall be subject, at intervals not
              exceeding one month, to a functional test simulating failure of the normal lighting
              supply, of duration sufficient to verify the function of the luminaire and its supply.
              The test shall be recorded in the logbook required by §13.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Schedule out-of-hours where possible.</strong> The test takes the system out
              of emergency service during the discharge. A coincident mains failure during the test
              would leave no emergency illumination. Best practice: test out-of-hours or in
              low-occupancy periods, or test in zones so that any single zone is offline for only a
              portion of the rated duration.
            </li>
            <li>
            ...
            <li>
              ...
              test) or 1 hour (for a 3 h test) confirm all luminaires still illuminated. Note any
              that have failed early; these batteries are seriously degraded.
            </li>
            <li>
              <strong>Hold for full rated duration.</strong> 1 h or 3 h. At the end of the duration,
              walk the building with a lux meter / luminance meter. Each luminaire and sign must
              read at least 50 % of rated value.
            </li>
            <li>
              <strong>Restore mains.</strong> Release the test key / DB isolation. System returns to
              normal mode. Begin recharge timing.
            </li>
            <li>
              ...
              batteries have recovered. Or, for CPS systems, inspect the battery management system
              data to confirm full recharge.
            </li>
            <li>
            ...
            <li>
              <strong>Battery replacement programme.</strong> Failures detected at the annual test
              typically appear in clusters because batteries installed at the same time age at the
              same rate. A failure rate over about 5 % at one annual test indicates the battery
              population is reaching end-of-life and a comprehensive replacement programme should be
              planned.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Every emergency luminaire and emergency exit sign shall be subject, at intervals not
              exceeding twelve months, to a test of the full rated duration of the installation. At
              the end of the rated duration each luminaire and sign shall continue to provide an
              illuminance or luminance of not less than 50 % of the value declared by the
              manufacturer. After the test, the system shall be confirmed to have recharged to full
              capacity within 24 h. The test results shall be recorded in the logbook.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Design and installation record.</strong> The signed competent-designer record
              covering risk assessment outputs, photometric calculations, luminaire schedule,
              circuit topology, commissioning results, competence declaration. Forms the technical
              baseline of the installation.
            </li>
            <li>
              <strong>Luminaire schedule.</strong> Every luminaire and sign in the system listed by
              reference, location, type, function (escape route / anti-panic / high-risk task / exit
              sign), rated duration, battery type, installation date.
            </li>
            <li>
              <strong>Test records.</strong> Date and time of every test, type (monthly / annual),
              luminaire reference, result (pass / fail), tester name. The bulk of the logbook over
              time.
            </li>
            <li>
            ...
            <li>
              ...
              changes of layout, change of duration, change of luminaire type. Cross-reference to
              design and installation record updates.
            </li>
            <li>
            ...
            <li>
              <strong>Risk assessment outputs.</strong> Fire risk assessment outputs that drove the
              design (anti-panic triggers, high-risk task identification, sleeping-risk).
            </li>
            <li>
              <strong>Manufacturer documentation.</strong> Data sheets, instruction manuals, spare
              parts lists for the installed products. Useful for remedial work years later when the
              original installer is no longer involved.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              lighting installation. The logbook shall include: (a) the date of the commissioning of
              the installation; (b) the date of each periodic inspection and test, the result, and
              the identity of the person carrying out the inspection; (c) a record of any defect
              found and the remedial action taken; (d) the dates of any modifications to the
              installation; (e) the design and installation record required by §5.2 and the
              commissioning record. The logbook shall be retained for the life of the installation
              and made available for inspection by the enforcing authority on request.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>"Efficient state, working order and good repair".</strong> The luminaires and
              signs actually work to specification at any time the building is occupied. Latent
              failures (luminaires that have failed quietly between tests) are caught by the test
              cadence; if the cadence is too long the latent failures accumulate.
            </li>
            <li>
              <strong>Non-delegable.</strong> The responsible person can hire a competent person to
              perform the tests, but the legal duty for the outcome stays with the responsible
              person. A maintenance contractor's failure to do their job correctly does not
              exonerate the responsible person; it merely creates a contractual claim against the
              contractor.
            </li>
            <li>
              ...
              reactive inspections (responding to occupant complaints or post-incident), and through
              cross-checks with insurers and other regulators.
            </li>
            <li>
            ...
            <li>
              ...
              5266-1:2025 compliance as a policy condition. Failure to maintain may void cover in
              the event of a fire-related incident, leaving the responsible person personally liable
              for damages.
            </li>
            <li>
              <strong>Higher-Risk Buildings.</strong> Under the Building Safety Act 2022, higher
              duties apply for HRBs (residential buildings 18m+ or 7+ storeys). The Building Safety
              Regulator can intervene in addition to the Fire and Rescue Service. The emergency
              lighting logbook forms part of the building golden thread under the Act.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          BS 5266-1:2025 competent person and the design and installation record
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Original design.</strong> The designer of the original installation must be a
              competent person. The design and installation record (BS 5266-1:2025 §13) includes a
              competence declaration signed by the designer.
            </li>
            <li>
              <strong>Major remedial work.</strong> Significant changes to the installation (adding
              luminaires, changing layout, changing duration, changing supply architecture) are
              treated as design changes and require a competent person.
            </li>
            <li>
              <strong>Routine testing and minor maintenance.</strong> Monthly / annual tests and
              like-for-like luminaire / battery replacements do not require the same level of design
              competence. A trained tester with a documented training programme is generally
              sufficient. The responsible person should still satisfy themselves that the tester is
              competent for the specific task.
            </li>
            <li>
              <strong>ICEL qualifications.</strong> The Industry Committee for Emergency Lighting
              offers various levels of certification covering design, installation, and maintenance.
              ICEL membership / certification is the most widely recognised UK qualification for
              emergency lighting work.
            </li>
            <li>
              <strong>IEng / CEng with emergency lighting experience.</strong> Chartered engineers
              (CEng) and incorporated engineers (IEng) with documented project experience in
              emergency lighting are accepted as competent for design.
            </li>
            <li>
              <strong>Manufacturer certifications.</strong> Some manufacturers (Hochiki, Mackwell,
              Whitecroft, etc.) offer product-specific design certifications. Acceptable for designs
              using those products provided the manufacturer\'s scope covers the design approach.
            </li>
            <li>
              <strong>Documented experience under a chartered engineer.</strong> A designer without
              formal qualifications can still be competent if they have documented project
              experience under the supervision of a chartered engineer who signs off the competence.
            </li>
            <li>
              <strong>Audit trail.</strong> The design and installation record carries the
              competence declaration. Test reports and remedial-work records carry the competence of
              the person performing each action. The audit trail is retained as part of the logbook.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Emergency lighting design, installation and major remedial work shall be undertaken by
              a competent person, defined as a person with the training, qualifications and
              experience to undertake the work. The competent person shall declare their competence
              as part of the design and installation record required by §13.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              full-duration tests run on schedule without manual intervention. Test result reported
              via LED indicator (typically green = pass, red = fault) or via addressable network.
            </li>
            <li>
              <strong>Addressable network reporting.</strong> Premium self-test products report via
              DALI, KNX, BACnet, proprietary RF, or proprietary wired bus. A central panel shows the
              status of every luminaire in real time. Logbook entries can be auto-populated from the
              network data.
            </li>
            <li>
              <strong>LED-indicator-only.</strong> Lower-cost self-test products show status only by
              an LED on the luminaire face. The responsible person\'s contractor walks the building
              monthly to read the indicators rather than to perform the tests; still a significant
              labour saving.
            </li>
            <li>
              <strong>RRFSO article 17 duty unchanged.</strong> Self-test reduces labour, not legal
              duty. The responsible person must still review test results, ensure failures are
              remediated, retain logbook records, and demonstrate efficient working order on demand.
            </li>
            <li>
              <strong>Cost-benefit.</strong> Capital cost premium is around 20-40 % over standard
              luminaires; payback typically 2-4 years for installations over about 100 luminaires.
              Self-test economics improve further at scale.
            </li>
            <li>
              <strong>Network architecture choices.</strong> Self-contained self-test luminaires
              with addressable network reporting are typical for new builds; central battery systems
              with DALI-2 emergency are typical for very large installations. The choice depends on
              building size, refurbishment vs new build, and existing infrastructure.
            </li>
            <li>
              <strong>Test-cycle scheduling.</strong> Self-test luminaires schedule their own tests;
              some products allow the responsible person to choose the test time of day and time of
              year. Annual full-duration tests should be scheduled out-of-hours where possible to
              avoid leaving the system unavailable during a coincident mains failure.
            </li>
            <li>
              <strong>Calibration drift.</strong> Self-test electronics rely on internal sensors and
              clocks; calibration can drift over years. Periodic verification (e.g. every 5 years)
              by manual test is good practice to confirm the self-test is producing accurate
              results.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Automatic test systems shall provide testing of the emergency lighting installation in
              accordance with the requirements of BS EN 50172. The system shall verify the operation
              of each luminaire at intervals not exceeding one month and shall verify the rated
              duration of each luminaire at intervals not exceeding twelve months. Test results
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              like-for-like, retest. Typical service life 4-5 years SLA / NiCd, 8-10 years LiFePO4.
            </li>
            <li>
              <strong>Lamp / LED end-of-life.</strong> Detected at the monthly test (luminaire does
              not illuminate, or illuminates dimly). Remediation: replace lamp / LED module, retest.
              LED service life is long (typically 50 000+ hours) but defective drivers can shorten
              this; LED + driver typically replaced as a unit.
            </li>
            <li>
              <strong>Charger fault.</strong> Detected at the monthly test (luminaire fails to hold
              charge, or shows fault indicator). Remediation: replace charger module or full
              luminaire, retest. Common in older self-contained luminaires where the charger
              electronics are a separate module.
            </li>
            <li>
              <strong>Supply fault.</strong> Detected at the monthly test (luminaire does not
              respond to test key). Remediation: trace supply, repair or replace. Possible causes:
              tripped MCB, broken cable, blown fuse, faulty test switch.
            </li>
            <li>
            ...
            <li>
              ...
              check (luminance below 5 cd/m² floor). Remediation: replace LED module or full sign.
              Luminance degradation is gradual and may not appear at functional tests; a periodic
              luminance check (every 1-2 years) catches it.
            </li>
            <li>
              <strong>Spares stock.</strong> Maintain a small stock of replacement batteries / LEDs
              / drivers / luminaires for rapid remediation. Typical stock: 5-10 % of installed
              luminaires for batteries, 2-5 % for full luminaire replacements. Larger stock for
            ...
            <li>
              ...
              annual test indicates a batch ageing event; plan a comprehensive replacement programme
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Lifetime of installation — best practice.</strong> Many estate managers retain
              emergency lighting records for the full lifetime of the installation as routine
              practice. Cheap insurance against future enforcement.
            </li>
            <li>
              <strong>Higher-Risk Buildings — lifetime of building.</strong> Building Safety Act
              2022: HRBs must retain golden-thread fire safety information for the lifetime of the
              building. Includes commissioning records, design and installation records, test
              records, and maintenance records. Transferred with ownership.
            </li>
            <li>
              <strong>Digital vs paper.</strong> Either is acceptable provided the records are
              retained in a readable form. Digital records should have backup; paper records should
              be stored securely. Hybrid approach is common — paper test sheets digitised
              periodically.
            </li>
            <li>
              <strong>Building handover.</strong> When a building is sold or management is
              transferred, the logbook should be transferred to the new responsible person. This is
              a frequent failure point — logbooks lost during handover. Maintain handover
            ...
            <li>
              ...
              article 17 enforcement. Recovery requires recreating the records from any available
              data (test certificates, contractor records, manufacturer data) and expressly noting
              the gap. Penalty risk is significant.
            </li>
            <li>
              <strong>Insurance implications.</strong> Insurers may require evidence of BS
        ...
        <RegsCallout
          ...
          clause={
            <>
              Records of the emergency lighting installation including the design and installation
              record, the commissioning record and the logbook of routine inspections and tests
              shall be retained for the life of the installation. For Higher-Risk Buildings within
              the meaning of the Building Safety Act 2022, the records form part of the building
              golden thread of fire safety information and shall be retained for the life of the
              building. Records shall be transferred with the building on change of ownership or
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Alteration notice.</strong> Requires the responsible person to notify the FRS
              of any proposed alterations to the building before they are made, so the FRS can
              confirm fire safety implications. Issued where a building has fire safety concerns
              that need to be managed during change.
            </li>
            <li>
            ...
            <li>
              ...
              the premises. Issued where there is an imminent risk to life — for example, a building
              with no working emergency lighting whatsoever in a multi-storey hotel. Prohibition
              takes effect immediately on service; lifted only on remediation.
            </li>
            <li>
              <strong>Prosecution.</strong> The FRS can prosecute under the RRFSO 2005. Penalties on
              conviction: unlimited fines and up to 2 years\' imprisonment for corporate officers
              (directors, managers, secretaries, similar officers, or persons purporting to act in
              such capacity).
            </li>
            <li>
              <strong>Insurance implications.</strong> Insurers may require evidence of BS
            ...
            <li>
              <strong>Building Safety Regulator (HRBs).</strong> For Higher-Risk Buildings under the
              Building Safety Act 2022, the Building Safety Regulator has additional enforcement
              powers including the power to issue building completion certificates, contravention
              notices, and to refer matters for prosecution.
            </li>
            <li>
              <strong>Reputational damage.</strong> Enforcement notices are public records.
              Prohibition notices and prosecutions attract media coverage. Reputational damage often
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              prohibition notice on the responsible person where the authority is satisfied that the
              responsible person is failing to comply with this Order. A person guilty of an offence
              under this Order is liable on conviction on indictment to a fine, or on summary
              conviction to a fine. The enforcing authority may institute proceedings for an offence
              under this Order.
            </>
          }
        ...
        <FAQ
          items={[
            ...
            {
              question: 'What happens to ongoing testing during a major refurbishment?',
              answer:
            ...
            {
              question: 'Is there a national database of competent persons for emergency lighting?',
              answer:
