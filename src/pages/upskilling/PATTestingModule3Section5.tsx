...
const PATTestingModule3Section5 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="PAT M3 · Section 5"
        title="Risk-based approaches to test intervals"
        backTo="/electrician/upskilling/pat-testing-module-3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          HSG107 replaced fixed-interval PAT with a risk-based regime. Use IET CoP Table 7.1 as the
          starting point, adjust for environment, equipment type, frequency of use and user
          awareness, and let the data drive the cycle.
        </p>
        ...
        >
          <p>
            The fixed-interval PAT regime — annual PAT, every appliance, regardless of context — had
            three problems:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Over-inspection of low-risk equipment.</strong> A static PC in a clean office
              does not benefit much from annual electrical testing. The equipment’s defect rate is
              far below an annual cycle.
            </li>
            <li>
              <strong>Under-inspection of high-risk equipment.</strong> A site-tool that is dragged
              through dust, dropped, used in the wet, and passed between users every day will
              develop defects in weeks — not waiting for the next annual cycle.
            </li>
            <li>
          ...
          <p>
            HSG107 reframed the duty: the duty-holder runs a risk assessment, sets frequency on that
            basis, and adjusts the regime in response to recorded data. The IET CoP 5th Edition
            aligns with this framing throughout Ch 7.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              There is no single answer to the question “how often should equipment be inspected or
              tested?”. The frequency must be determined on the basis of a risk assessment that
        ...
        >
          ...
          <p>
            ...
            principle is the takeaway. A duty-holder applies the row appropriate to the environment,
            then adjusts for equipment age, condition, recorded fail rate, and the other HSG107
            factors.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              The frequency of inspection and testing of equipment depends on the type of equipment,
              the manufacturer&rsquo;s recommendations, the initial integrity and soundness of the
              equipment, the working environment, the frequency of use, and the duty cycle of the
              equipment. Table 7.1 provides initial frequencies of inspection and combined
              inspection and testing as a guide; these initial frequencies should be reviewed by the
              duty-holder on a regular basis on the basis of the maintenance history and any
              failures of the equipment in service.
            </>
          }
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              external visual — flex, plug, appliance body. No tools, no records typically; the user
              reports problems and quarantines the item. Catches recent damage and obvious-on-day
              defects.
            </li>
            <li>
              ...
              sheath, plug, terminations (where accessible), pin condition, fuse rating, signs of
              overheating, modifications, environment suitability. Recorded on the PAT register.
              Catches defects the user check would not pick up — fuse mis-rating, construction
              defects, wear inside moulded plugs.
            </li>
            <li>
              <strong>Combined inspection and test.</strong> Carried out by a competent person with
              PAT instrument at less frequent intervals (per Table 7.1). Scope: formal visual
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="110" y="52" textAnchor="middle" fill="#22C55E" fontSize="10" fontWeight="bold">
              1. Identify
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="270" y="52" textAnchor="middle" fill="#FBBF24" fontSize="10" fontWeight="bold">
              2. Starting freq
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="430" y="52" textAnchor="middle" fill="#FBBF24" fontSize="10" fontWeight="bold">
              3. Adjust
            </text>
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="640" y="52" textAnchor="middle" fill="#22C55E" fontSize="10" fontWeight="bold">
            ...
            <text x="160" y="380" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              iterate
            </text>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Persistent zero-fail data over multiple cycles in a controlled environment with stable
            ...
            <li>
              Manufacturer recommendation supporting longer cycles for the specific equipment class.
            </li>
          </ul>
          <p>
            The change is documented on the duty-holder’s risk assessment with the basis. The cycle
            is reviewed at the next assessment with the data from the new cycle.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              the inspection and testing regime so that intervals are appropriate to the actual rate
              at which faults are developing in the equipment under the conditions of its use. A
              high failure rate is an indication that the inspection interval is too long or that
              the conditions of use are unsuitable.
            </>
          }
        ...
        <ContentEyebrow>Special cases — receipt, post-repair, hire, after-incident</ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              Counterfeit BS 1363 plugs are surprisingly common; the receipt inspection catches them
              before the equipment enters service. Adds the equipment to the asset register and the
              cycle.
            </li>
            <li>
              <strong>Return from repair.</strong> A repaired item is re-inspected and
              re-electrically-tested before returning to service. Visible signs of overheating that
              triggered the original fail must be confirmed cleared; new-fitted plugs / fuses must
              be confirmed correct.
            </li>
            <li>
              <strong>Hire issue and return.</strong> Hire equipment is inspected before issue and
              on return; HSG107 puts hire kit at this maximum-frequency end. The quarantine-and-test
              process between hires is the per-hire regime.
            </li>
            <li>
        ...
        <ContentEyebrow>The duty-holder, the competent person, and the legal frame</ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              instruments to do the work safely and accurately. Reports results, defects and trends
              back to the duty-holder.
            </li>
            <li>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              necessary to prevent danger, all systems shall be maintained so as to prevent, so far
              as is reasonably practicable, such danger.&rdquo; The PAT regime is one of the ways
              the maintenance duty is discharged for portable electrical equipment.
            </li>
            <li>
