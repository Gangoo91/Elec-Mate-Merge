        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">In 30 Seconds:</span> Preventive
              maintenance prevents failures and maintains optimal performance
            </p>
          </div>
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">Spot it:</span> Quarterly visual
              inspections, annual thermal imaging
            </p>
          </div>
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">Use it:</span> Condition-based
              cleaning rather than fixed schedules
            </p>
          </div>
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-3">
            <p className="text-white text-sm">
              <span className="font-semibold text-elec-yellow">Key Component:</span> Inverters
      ...
      <div className="px-4 space-y-6 pb-8">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white/80 text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Programme Objectives:</span> The primary
              goals are to prevent unexpected failures that cause downtime, maintain optimal energy
              production through system cleanliness and tuning, extend equipment lifespan through
              proactive care, ensure continued compliance with safety requirements, and protect
              warranty entitlements through documented maintenance.
            </p>
            <p>
              <span className="text-white font-medium">Maintenance Types:</span> Preventive
              maintenance includes scheduled inspections and servicing to prevent failures.
              Predictive maintenance uses monitoring data to anticipate issues before they cause
              problems. Corrective maintenance addresses faults and failures as they occur. A good
              programme balances all three, targeting 80% planned and 20% reactive maintenance.
            </p>
            <p>
              <span className="text-white font-medium">Programme Development:</span> Start with
              manufacturer recommendations as a baseline. Adjust for local environmental conditions
              such as coastal, industrial, or agricultural settings. Consider system age and
              technology type, as newer systems may need less frequent attention. Review and refine
              annually based on experience and performance data.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white/80 text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Visual Inspections (Quarterly):</span> Check
              module surfaces for soiling, damage, discolouration, or delamination. Inspect mounting
              structures for corrosion, loose fixings, and structural integrity. Verify cable
              management and protection. Check inverter and combiner enclosures for damage or water
              ingress. Assess vegetation growth and shading changes.
            </p>
            <p>
              <span className="text-white font-medium">Thermal Imaging (Annual):</span> Conduct
              during high-irradiance conditions (minimum 500 W/m², ideally above 700 W/m²). Identify
              hot spots indicating cell defects, bypass diode failures, or loose connections.
              Document anomalies with location and severity. Compare year-on-year to track
              developing issues. Schedule repairs based on severity and safety risk.
            </p>
            <p>
              <span className="text-white font-medium">Electrical Testing (Annual):</span>{' '}
              Insulation resistance testing confirms cable and connection integrity. Open circuit
              voltage verification checks module health. String current comparison identifies
              underperforming strings. Earth continuity testing verifies safety of exposed
              metalwork. Protection device testing confirms safety systems function correctly.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white/80 text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Soiling Assessment:</span> Monitor
              performance ratio trends to quantify soiling impact. Compare dirty versus clean module
              output during the same conditions. Consider seasonal patterns such as higher pollen in
              spring. Assess cost-benefit by comparing cleaning cost versus recovered production.
            </p>
            <p>
              <span className="text-white font-medium">Cleaning Methods:</span> Use deionised water
              to prevent mineral deposits. Clean during cool periods such as early morning to avoid
              thermal shock. Use soft brushes or squeegees and avoid abrasive materials. Never use
              high-pressure washers that can damage seals and frames. Consider robotic cleaning
              systems for large commercial arrays.
            </p>
            <p>
              <span className="text-white font-medium">Environmental Considerations:</span> Coastal
              sites may need salt deposit removal. Agricultural areas face seasonal pollen and dust
              challenges. Urban sites may accumulate traffic pollutants. Areas with bird activity
              may need more frequent cleaning. Sites with adequate rainfall may need minimal
              intervention.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white/80 text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">PV Modules (25-30+ years):</span> Modules
              degrade gradually at 0.5-0.8% per year. Performance warranties typically guarantee 80%
              output at 25 years. Most module failures occur in first year (infant mortality) or
              late life. Plan financial provisions for eventual replacement.
            </p>
            <p>
              <span className="text-white font-medium">Inverters (10-15 years):</span> String
              inverters typically last 10-15 years. Microinverters and optimisers may last longer
              but are harder to replace. Capacitor degradation is a common failure mode. Plan for at
              least one replacement during system lifetime. Consider extended warranties or service
              contracts.
            </p>
            <p>
              <span className="text-white font-medium">Balance of System:</span> Mounting structures
              should last the system lifetime with proper maintenance. DC cables may degrade in
              harsh UV environments. Isolators and protection devices need periodic testing and
              eventual replacement. Combiner boxes and enclosures need seal maintenance.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-white/80 text-sm leading-relaxed">
            ...
            <p>
              <span className="text-white font-medium">Maintenance Records:</span> Document every
              maintenance visit with date, time, personnel, and conditions. Record all findings
              including both issues and confirmation of good condition. List actions taken and parts
              used with serial numbers where applicable. Note any recommendations for future
              attention.
            </p>
            <p>
              <span className="text-white font-medium">Performance Tracking:</span> Maintain
              performance records to track degradation trends. Compare actual versus expected output
              over time. Document any performance changes following maintenance. Use data to justify
              maintenance investment and optimise schedules.
            </p>
            <p>
              <span className="text-white font-medium">Programme Review:</span> Review maintenance
              programmes annually. Assess effectiveness of current schedules and tasks. Incorporate
              lessons learned from failures and near-misses. Update for any changes to site
              conditions or equipment. Benchmark against industry best practice.
            </p>
          </div>
        </section>
        ...
        <div className="bg-gradient-to-r from-elec-yellow/10 to-amber-500/10 border border-elec-yellow/20 rounded-xl p-4">
          ...
          <div className="space-y-2 text-white/80 text-sm">
            <p>
              ...
              frequent initial inspections help establish baseline condition and appropriate ongoing
              frequencies.
            </p>
            <p>
              <span className="text-white font-medium">Cost optimisation:</span> Every pound spent
              on preventive maintenance typically saves three to five pounds in avoided failures.
              Focus resources on high-impact activities and use monitoring data to prioritise
              interventions.
            </p>
            <p>
              <span className="text-white font-medium">Building customer relationships:</span>{' '}
              Regular maintenance visits provide opportunities to discuss system performance,
              identify upgrade opportunities, and build long-term customer relationships.
            </p>
          </div>
        </div>
        ...
        {/* Quiz */}
        <Quiz title="Preventive Maintenance Quiz" questions={quizQuestions} />
