...
const inlineChecks = [
  {
    id: 'm3s4-iz-isc',
    question: "DC cable thermal sizing on the PV side. What's the binding inequality, and why?",
    options: [
  ...
  {
    id: 'm3s4-cable-spec',
    question: "PV DC cables — what's the standard per Reg 712.521.1041?",
    options: [
  ...
  {
    id: 'm3s4-volt-drop',
    question: 'PV DC cable voltage drop. Industry typical practice limits VD on the DC side to:',
    options: [
  ...
  {
    id: 'm3s4-fire-reg',
    question: 'BS 7671 Reg 712.421 covers what specific risk on the PV DC side?',
    options: [
...
const faqs = [
  ...
  {
    question:
      'How does the IET CoP for Grid-Connected Solar PV Installations operationalise the DC-side regulations?',
    answer:
...
export default function RenewableEnergyModule3Section4() {
  ...
  useSEO({
    title: 'DC cable sizing, protection & fire | Renewable Energy 3.4 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 3 · Section 4 · BS 7671:2018+A4:2026"
        title="DC cable sizing, protection & fire"
        backTo="../renewable-energy-module-3"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The PV DC side — cable sizing per Iz ≥ Isc_max, cable selection per Reg 712.521.1041 (BS
          EN 50618), protective devices per Reg 712.432.103 (gPV / MCBs), IMD per Reg 712.421.101.1
          / BS EN 61557-8, MC4 connectors per Reg 712.526, DC isolator per BS EN 60947-3, and Reg
          712.421 fire protection.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Start with I_sc_stc</strong> — from the module
              datasheet (typical modern modules 11-12.5 A)
            </li>
            <li>
              <strong className="text-white">Apply Reg 712.433.101.1 conservative default</strong> —
              I_sc_max = 1.25 × I_sc_stc (or use manufacturer temperature coefficient + site
              irradiance extremes if data available)
            </li>
            <li>
              <strong className="text-white">For single string</strong> — cable current = I_sc_max
            </li>
            <li>
              <strong className="text-white">For parallel strings on a combiner</strong> — combiner
              output current = Ns × I_sc_max
            </li>
            <li>
              <strong className="text-white">Check I_z ≥ this current</strong> — at installed
              conditions (after grouping, ambient, reference method corrections)
            </li>
            <li>
              <strong className="text-white">If I_z &lt; I_sc_max</strong> — upsize the cable
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">
                I_z (installed) = I_z (reference) × C_g × C_a × C_i
              </strong>
            </li>
            <li>
              C_g = grouping correction factor (BS 7671 Appendix 4, depends on number of grouped
              cables)
            </li>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              4 mm² PV DC cable, reference method E (clipped to surface): I_z reference = 50 A
            </li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Voltage rating</strong> — 1.5 kV DC (covers V_oc_max
              for typical UK PV arrays up to ~1,000 V_oc_max with margin)
            </li>
            <li>
              <strong className="text-white">Temperature rating</strong> — 90°C continuous operating
              (for high-radiation roof installs and continuous current carrying)
            </li>
            <li>
              <strong className="text-white">UV resistance</strong> — outdoor-rated for 25+ year
              exposure on roof
            </li>
            <li>
              <strong className="text-white">Double insulation</strong> — inner and outer insulation
              layers (Class II equivalent), additional safety margin on the DC side
            </li>
            <li>
              <strong className="text-white">Halogen-free</strong> — fire behaviour: doesn\'t
              release toxic / corrosive halogen gas if burned (important for indoor-routed sections
              of the DC cable run)
            </li>
            <li>
              <strong className="text-white">Single-core construction</strong> — each polarity
              (positive / negative) on its own cable, no shared sheath
            </li>
            <li>
              <strong className="text-white">Tinned-copper conductor</strong> — corrosion-resistant
              for outdoor / connector use
            </li>
            <li>
              <strong className="text-white">Cross-linked polyolefin insulation</strong> —
              UV-stable, halogen-free, durable
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 712.526.1 compatibility</strong> — each pair shall
              be electrically and mechanically compatible and suitable for the environment.
              Manufacturer-certified compatibility evidence is the cleanest path
            </li>
            <li>
              <strong className="text-white">Reg 712.526.101 standard</strong> — connectors per BS
              EN 62852:2015+A1:2020 (or BS EN 62852)
            </li>
            <li>
              <strong className="text-white">Brand matching (practical)</strong> — Stäubli MC4 with
              Stäubli MC4; Tongling with Tongling. Simplest way to evidence Reg 712.526.1
              compatibility without manufacturer cross-certification
            </li>
            <li>
              <strong className="text-white">Manufacturer-specified crimping tool</strong> —
              calibrated for the specific connector. Generic crimpers leave loose contact,
              overheating, fire risk
            </li>
            <li>
              <strong className="text-white">Torque to spec</strong> — manufacturer datasheet
              specifies; typically 1.5-2.5 Nm for the body
            </li>
            <li>
              <strong className="text-white">Mechanical test</strong> — pull-test before
              commissioning (manufacturer specifies the test force)
            </li>
            <li>
              <strong className="text-white">Key/tool isolation</strong> — connectors accessible to
              ordinary persons require key/tool isolation per Reg 712.526.101
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — records connector
              brand, BS EN 62852 reference, manufacturer compatibility evidence (if mixed), crimping
              tool used
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          VD = 2 × L × R × I. Target 1-3% of V_mp. Compounds over the install life.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">2.5 mm² tinned copper</strong> — ~7.41 mΩ/m
            </li>
            <li>
              <strong className="text-white">4 mm² tinned copper</strong> — ~4.61 mΩ/m
            </li>
            <li>
              <strong className="text-white">6 mm² tinned copper</strong> — ~3.08 mΩ/m
            </li>
            <li>
              <strong className="text-white">10 mm² tinned copper</strong> — ~1.83 mΩ/m
            </li>
            <li>
              <strong className="text-white">16 mm² tinned copper</strong> — ~1.15 mΩ/m
            </li>
          </ul>
          <p>Worked example:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
          ...
          <p>
            If the same string had a 40 m route, VD = 4.35 V = 0.91% — still within. At 60 m, VD =
            6.53 V = 1.37% — still within but heading toward upsize. The design pack records the VD
            calculation per cable segment.
          </p>
        </ConceptBlock>
        ...
        <Pullquote>
          gPV fuses OR DC-rated MCBs. Both polarities. Blocking diodes ≠ protection. Sized 1.1 ×
          I_sc_max &lt; I_n ≤ I_mod_max_ocer.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">1 or 2 parallel strings</strong> — no overcurrent
              device required (explicit reg statement); cable sized per Reg 712.433.101(a) for I_z ≥
              (Ns-1) × I_sc_max
            </li>
            <li>
              <strong className="text-white">3+ parallel strings with condition MET</strong> —
              overcurrent protection required per Reg 712.431.101
            </li>
            <li>
              <strong className="text-white">3+ parallel strings with condition NOT MET</strong> —
              overcurrent device not required by the inequality; cable still sized to handle reverse
              current
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">gPV fuses per BS EN 60269-6</strong> — most common at
              combiner. Designed for PV DC fault characteristics: slow current rise, no AC
              zero-crossing for arc clearing, UV environment
            </li>
            <li>
              <strong className="text-white">Fuse-combination units per BS EN 60947-3</strong> —
              fuse + integral switching capability
            </li>
            <li>
              <strong className="text-white">Circuit-breakers per BS EN 60947-2</strong> —
              industrial DC-rated MCBs
            </li>
            <li>
              <strong className="text-white">
                Circuit-breakers per BS EN 60898-2 / BS IEC 60898-3
              </strong>{' '}
              — DC-rated domestic MCBs (more common in residential combiners with switching needs)
            </li>
          </ul>
          <p>Sizing per Reg 712.432:</p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">String device rating</strong> — 1.1 × I_sc_max of the
              string &lt; I_n ≤ I_mod_max_ocer. With I_sc_max = 1.25 × I_sc_stc: lower bound = 1.375
              × I_sc_stc (typically 1.4× in practice); upper bound = module reverse-current rating
            </li>
            <li>
              <strong className="text-white">
                Sub-array device rating (where 3+ sub-arrays parallel)
              </strong>{' '}
              — 1.1 × I_sc_max of the sub-array &lt; I_n ≤ I_mod_max_ocer (analogous formula for
              sub-arrays per Reg 712.433.102)
            </li>
            <li>
              <strong className="text-white">Multiple parallel strings on one device</strong> — Np ×
              1.1 × I_sc_max ≤ I_n ≤ I_mod_max_ocer − (Np − 1) × I_sc_max
            </li>
            <li>
              <strong className="text-white">Voltage rating</strong> — DC voltage rating ≥ V_oc_max
              of the system
            </li>
            <li>
              <strong className="text-white">Breaking capacity</strong> — typically 10-30 kA
              depending on the prospective fault current
            </li>
            <li>
              <strong className="text-white">Pole count</strong> — both polarities protected per Reg
              712.432.101
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          DC arcs don\'t self-extinguish. Spec the cable. Match the connectors. Rate the isolator.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">DC arc faults</strong> — DC arcs sustain themselves (no
              AC zero-crossing). Cable insulation breakdown can sustain an arc until physically
              interrupted. Mitigation: BS EN 50618 / 62930 cable with double-insulation;
              module-level rapid-shutdown where required
            </li>
            <li>
              <strong className="text-white">Connector failures (most common source)</strong> —
              mixed-brand or improperly-crimped MC4 connectors create micro-arcs that overheat and
              ignite. Mitigation: matched-brand, manufacturer-torque crimping, mechanical test,
              periodic inspection
            </li>
            <li>
              <strong className="text-white">Cable insulation degradation</strong> — UV /
              temperature / age. Mitigation: BS EN 50618 / 62930 cable spec; periodic visual
              inspection
            </li>
            <li>
              <strong className="text-white">Inverter / DC isolator failures</strong> — AC-only
              isolator can\'t break DC under load, sustaining an arc. Mitigation: BS EN 60947-3
              DC-21 utilisation category
            </li>
            <li>
              <strong className="text-white">Rodent / mechanical damage</strong> — rodents can chew
              through cable in lofts. Mitigation: protected conduit / armoured cable in vulnerable
              sections; periodic inspection
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Insulation Monitoring Device (IMD) — Reg 712.421.101.1 / 712.538.101
        </ContentEyebrow>

        <Pullquote>
          IMD per BS EN 61557-8. Continuous DC insulation monitoring throughout the array life.
          Often inverter-integrated.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 712.421.101.1 mandate</strong> — IMD shall be
              installed to verify insulation status on the DC side throughout the life cycle of the
              PV array
            </li>
            <li>
              <strong className="text-white">Reg 712.538.101 standard</strong> — IMD shall be
              selected in accordance with BS EN 61557-8
            </li>
            <li>
              <strong className="text-white">Inverter-integrated option</strong> — where IMD is
              integral to the inverter, the IMD function shall be in accordance with BS EN 62109-2
              or BS EN 61557-8
            </li>
            <li>
              <strong className="text-white">Fault response</strong> — IMD detects insulation
              degradation and either trips the inverter offline (transformerless) or interrupts the
              fault current path (functional-earthing arrangement per Reg 712.421.101.2)
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — records the IMD source
              (inverter-integrated vs separate device), manufacturer datasheet extract confirming BS
              EN 61557-8 (or BS EN 62109-2) compliance, and the commissioning test result
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">DC switching capability</strong> — BS EN 60947-3
              utilisation category DC-21 or higher
            </li>
            <li>
              <strong className="text-white">Voltage rating</strong> — DC voltage rating ≥ array
              V_oc_max (typically 1,000 V or 1,500 V depending on the array)
            </li>
            <li>
              <strong className="text-white">Current rating</strong> — rated for ≥ I_sc_max of the
              array (or per parallel-string segment if multiple isolators)
            </li>
            <li>
              <strong className="text-white">Pole count</strong> — both polarities (positive and
              negative) isolated simultaneously by a 2-pole isolator
            </li>
            <li>
              <strong className="text-white">Location</strong> — accessible without tools for
              emergency shutdown; typically immediately before the inverter on the DC input side
            </li>
            <li>
              <strong className="text-white">Labelling</strong> — clearly marked "PV DC ISOLATOR —
              LIVE WHEN ILLUMINATED"; warning that the array remains live during daylight even when
              the isolator is open
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          <p>
            Permanent residual-energy warning label requirements (per Section 8 of this module —
            recap):
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 712.514.102 (DC access points)</strong> — "SOLAR DC
              — Live parts can remain energized after isolation" at each point of access to live
              parts on the DC side (combiner boxes, DC isolator)
            </li>
            <li>
              <strong className="text-white">Reg 712.514.103 (inverter)</strong> — "WARNING —
              Isolate both AC and DC sides before servicing" on all inverters
            </li>
            <li>
              <strong className="text-white">Reg 712.514.101 (origin / metering / CU)</strong> —
              instruction notice indicating the presence of a PV system at the origin of the
              electrical installation, the metering position (if remote), and the consumer unit / DB
              to which the supply from the inverter is connected
            </li>
            <li>
              <strong className="text-white">Format</strong> — weatherproof, UV-resistant, durable
              for the install life
            </li>
            <li>
              <strong className="text-white">Cert evidence</strong> — install photos document the
              labels in place
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-3-section-3')}
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-3-section-5')}
