...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Time synchronisation ensures accurate data logging timestamps, coordinated equipment scheduling, and proper alarm sequencing across the system. Without it, trend data becomes unreliable and troubleshooting becomes difficult.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Miswired controllers can cause upload failures, program corruption, or worse - incorrect equipment operation that could damage plant or create safety hazards. Poor labelling leads to programming the wrong controller, causing delays and rework.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Software upload loads the control logic, device mappings, setpoints, and operational parameters into BMS controllers, enabling them to operate connected equipment according to the designed control sequences.',
  },
  {
    question: 'Why must controllers be powered and stable before upload?',
    answer:
      'Controllers need stable power to maintain memory during upload, process incoming software packages, and validate program integrity. Unstable power can corrupt uploads, damage controller memory, or cause programming failures.',
  },
  {
    question: 'What should be tested after software upload?',
    answer:
      'Test all I/O point responses, verify safety function operation, check network communication, confirm parameter settings, and validate that physical equipment responds correctly to BMS commands.',
  },
  {
    question: 'What common methods are used for uploading software to controllers?',
    answer:
      'Common methods include USB connection (direct laptop to controller), Ethernet/IP (network connection for multiple controllers), and Serial/RS-485 (for older or simpler controllers).',
  },
];
...
const BMSModule7Section4 = () => {
  useSEO({
    ...
    description:
      'Learn about uploading software to BMS controllers and configuring them for operation including communication methods and best practices.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white">System configuration and deployment for BMS controllers</p>
        </header>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Upload:</strong> Loads control logic, mappings, and setpoints into
                controllers
              </li>
              <li>
                <strong>Setup:</strong> Addressing, network config, clock sync, parameter
                verification
              </li>
              <li>
                <strong>Methods:</strong> USB, Ethernet/IP, or RS-485 serial connections
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> USB ports, Ethernet jacks, RS-485 terminals on controllers
              </li>
              <li>
                <strong>Use:</strong> Verify power, test communication, support upload process
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Once design documentation is complete, devices are wired, and addresses assigned, the
              next step is to upload software to BMS controllers and configure them for operation.
              This stage translates the control logic (function blocks, Boolean sequences, PID
              loops) into the hardware that actually runs the system.
            </p>
            <p>
              For electricians, the focus is on ensuring controllers are powered, connected, and
              communicating correctly so software uploads and configuration go smoothly. A
              controller that is miswired, incorrectly addressed, or unstable will fail during
              programming, wasting hours on site.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-3 gap-3 my-6 text-center text-sm">
              <div className="p-3 rounded bg-transparent border border-white/10">
                ...
                <p className="text-white text-xs">
                  Direct laptop to controller. Fast and reliable for individual controllers.
                </p>
              </div>
              <div className="p-3 rounded bg-transparent border border-white/10">
                <p className="font-medium text-white mb-1">Ethernet/IP</p>
                <p className="text-white text-xs">
                  Network connection via switch. Can upload to multiple controllers remotely.
                </p>
              </div>
              <div className="p-3 rounded bg-transparent border border-white/10">
                <p className="font-medium text-white mb-1">Serial/RS-485</p>
                <p className="text-white text-xs">
                  Multi-drop bus for older controllers. Requires correct termination.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              After software upload, controllers must be configured to operate correctly within the
              BMS network. This involves setting unique identifiers, network parameters, timing
              references, and validating operational parameters.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Address and ID Assignment:
              </p>
              <div className="grid grid-cols-3 gap-3 text-sm">
                <div className="p-3 rounded bg-transparent border border-white/10">
                  <p className="font-medium text-white mb-1">BACnet Device IDs</p>
                  <p className="text-white text-xs">
                    Unique 6-digit identifier (e.g., 100001). Must be unique across entire network.
                  </p>
                </div>
                <div className="p-3 rounded bg-transparent border border-white/10">
                  <p className="font-medium text-white mb-1">Modbus Addresses</p>
                  <p className="text-white text-xs">
                    Range 1-247 per segment. Sequential numbering recommended.
                  </p>
                </div>
                <div className="p-3 rounded bg-transparent border border-white/10">
                  <p className="font-medium text-white mb-1">KNX Addresses</p>
                  <p className="text-white text-xs">
                    Area.Line.Device format (e.g., 2.3.15). Physical topology based.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>NTP Server:</strong> Network Time Protocol for automatic synchronisation
                </li>
                <li>
                  <strong>BMS Master:</strong> Central time reference for all controllers
                </li>
                <li>
                  <strong>Importance:</strong> Accurate logging, coordinated scheduling, alarm
                  sequencing
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                IP Network Configuration (for Ethernet controllers):
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>IP Address:</strong> Unique on subnet (e.g., 192.168.1.100)
                </li>
                <li>
                  <strong>Subnet Mask:</strong> Network boundary (e.g., 255.255.255.0)
                </li>
                <li>
                  <strong>Default Gateway:</strong> Router IP for remote access
                </li>
                <li>
                  <strong>Coordination:</strong> Always coordinate with IT for address allocation
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Electricians play a crucial role in ensuring successful software uploads by providing
              the proper electrical infrastructure, access, and support needed for engineers to
              complete programming efficiently and safely.
            </p>

            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  Pre-Upload Responsibilities
                </p>
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Power verification:</strong> Stable 24VDC supplies within ±5%
                  </li>
                  <li>
                    <strong>Wiring continuity:</strong> Test all communication cables
                  </li>
                  <li>
                    <strong>Polarity check:</strong> Verify RS-485 A/B connections
                  </li>
                  <li>
                    <strong>Termination:</strong> Install 120Ω resistors at bus ends
                  </li>
                </ul>
              </div>
              <div>
                <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                  During Upload Support
                </p>
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Monitor status:</strong> Watch controller LEDs during upload
                  </li>
                  <li>
                    <strong>Check stability:</strong> Monitor power supply under load
                  </li>
                  <li>
                    <strong>Field testing:</strong> Operate switches and sensors for verification
                  </li>
                  <li>
                    <strong>Document issues:</strong> Record any hardware problems
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Unstable power:</strong> Don't assume power is stable - always test under
                  load
                </li>
                <li>
                  <strong>Wrong polarity:</strong> Don't assume RS-485 polarity is correct - verify
                  A/B
                </li>
                <li>
                  <strong>Missing termination:</strong> Don't skip termination resistor verification
                </li>
                <li>
                  <strong>Duplicate addresses:</strong> Never leave controllers with the same
                  address
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 rounded-lg bg-transparent border border-white/10">
            ...
            <p className="text-sm text-white leading-relaxed mb-3">
              ...
              several VAV controllers. The upload process would start normally but then timeout or
              fail with communication errors partway through.
            </p>
            <p className="text-sm text-white leading-relaxed mb-3">
              After two days of delays, electricians discovered that RS-485 communication wiring had
              been installed with reversed polarity. Cable manufacturers used different colour
              coding than expected, and installers followed colours rather than checking polarity.
              Basic communication worked due to RS-485 fault tolerance, but complex uploads failed
            ...
            <div className="mt-4 p-3 rounded bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-xs text-white">
                Always verify communication wiring polarity before software deployment. Simple
                connectivity tests aren't always sufficient - full communication integrity must be
                verified under the load conditions that occur during programming.
              </p>
            </div>
          </div>
        </section>
