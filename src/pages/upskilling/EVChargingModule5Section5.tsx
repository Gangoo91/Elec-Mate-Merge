...
const quickCheckQuestions = [
  {
    ...
    options: [
      'Limited electrical supply capacity shared across all units',
      'Finding suitable chargepoint locations in car parks',
      'Obtaining planning permission for each chargepoint',
      'The cost of the charging cables themselves',
    ],
    correctIndex: 0,
    explanation:
  ...
  },
  {
    ...
    options: [
      'Free electricity included in the rent',
      'A fixed annual flat fee per resident',
      'A flat charge per charging session only',
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <header className="text-center mb-12">
          ...
          <p className="text-white">Managing EV charging in flats and shared sites</p>
        </header>
