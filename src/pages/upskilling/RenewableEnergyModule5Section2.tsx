...
const inlineChecks = [
  ...
  {
    id: 'm5s2-soc-vs-soh',
    question: "SoC vs SoH — what's the difference and how does the BMS calculate each?",
    options: [
...
export default function RenewableEnergyModule5Section2() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 2 · BS 7671:2018+A4:2026 · Chapter 57"
        title="BMS, cell balancing, SoC & SoH"
        backTo="../renewable-energy-module-5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The Battery Management System — the electronic brain inside the BESS. Architecture, cell
          balancing, SoC vs SoH, BMS-PCE communication (CAN / Modbus / proprietary), temperature
          derating, fault modes. Reg 570.5.2 PCE selection + Reg 570.6.1.1.1 BS EN IEC 62485 series.
        </p>
        ...
        <Pullquote>
          The BMS is the brain. The PCE is the muscle. The EEMS is the conductor. All three must
          agree.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Cell voltage monitoring</strong> — every cell&rsquo;s V
              read continuously; cell V outside the safe window (~2.5V to ~3.65V for LFP) triggers
              protective action
            </li>
            <li>
              <strong className="text-white">Cell temperature monitoring</strong> — per cell or per
              cell group; T outside safe window (typically -20°C to +60°C cell-level operating,
              narrower for charging) triggers derating or shutdown
            </li>
            <li>
              <strong className="text-white">Cell balancing</strong> — passive resistor-based
              balancing during charging keeps cells at matched SoC despite manufacturing tolerance +
              ageing differences
            </li>
            <li>
              <strong className="text-white">SoC calculation</strong> — coulomb counting
              (integrating current flow) + V-curve corrections + temperature compensation. Reported
              as 0-100% via app
            </li>
            <li>
              <strong className="text-white">SoH calculation</strong> — full-cycle capacity tracking
              + internal-resistance measurement + calendar-age model. Reported as % vs original
              nameplate
            </li>
            <li>
              <strong className="text-white">Pack contactor control</strong> — opens the
              high-current contactor on any fault condition, isolating the battery from the PCE /
              install
            </li>
            <li>
              <strong className="text-white">PCE communication</strong> — publishes max
              charge/discharge current, V limits, SoC, SoH, fault state via CAN bus or Modbus
            </li>
            <li>
              <strong className="text-white">Firmware updates</strong> — modern UK BMS supports
              over-the-air (OTA) updates via the manufacturer cloud; fixes bugs, adds features,
              supports new PCE pairings
            </li>
            <li>
              <strong className="text-white">Fault logging</strong> — every fault timestamped +
              categorised; readable via customer app + manufacturer remote diagnostics
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Cells drift. The BMS balances. UK domestic: passive resistor balancing is standard.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Manufacturing tolerance</strong> — typical ~1-3%
              cell-to-cell capacity variation (50-100 mAh on a 2000 mAh cell). Better cells matched
              at factory; cheaper packs use looser tolerance
            </li>
            <li>
              <strong className="text-white">Internal resistance tolerance</strong> — small
              differences in cell impedance cause uneven voltage drops under load
            </li>
            <li>
              <strong className="text-white">Temperature gradients</strong> — cells at the edge of a
              pack are cooler than centre cells; cooler cells age slower; centre cells age faster
            </li>
            <li>
              <strong className="text-white">Cycle history</strong> — small SoC differences compound
              over many cycles
            </li>
            <li>
              <strong className="text-white">Result without balancing</strong> — pack&rsquo;s usable
              capacity = weakest cell&rsquo;s capacity; loses ~10-30% capacity over a few years
            </li>
            <li>
              <strong className="text-white">Result with balancing</strong> — pack stays at ~98-99%
              of factory matched capacity for the cycle life of the cells
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">When it runs</strong> — primarily during top-of-charge
              (cells past ~3.4V), where V differences are most apparent for LFP&rsquo;s flat-curve
              chemistry
            </li>
            <li>
              <strong className="text-white">How it works</strong> — BMS slave board includes a
              small resistor + transistor per cell; transistor switches the resistor across the cell
              when V exceeds the balancing threshold
            </li>
            <li>
              <strong className="text-white">Current magnitude</strong> — typically 50-200 mA per
              cell; small fraction of charge current; energy dissipated as heat (negligible for the
              pack as a whole)
            </li>
            <li>
              <strong className="text-white">Efficiency cost</strong> — ~0.1-0.5% pack-level
              overall; not a noticeable round-trip-efficiency penalty
            </li>
            <li>
              <strong className="text-white">Customer-visible</strong> — modern apps may show
              balancing-active status; usually invisible during normal operation
            </li>
            <li>
              <strong className="text-white">UK examples</strong> — GivEnergy, FoxESS, Pylontech,
              BYD Battery Box, Sigenergy, Huawei LUNA — all use passive balancing in their UK LFP
              BESS products
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">How it works</strong> — switched capacitor / inductor
              circuits transfer charge from over-V cells to under-V cells; energy preserved rather
              than dissipated
            </li>
            <li>
              <strong className="text-white">Efficiency</strong> — pack-level ~99.5%+ overall;
              slight improvement over passive ~98-99%
            </li>
            <li>
              <strong className="text-white">Complexity</strong> — significantly more circuit
              complexity; more components; higher BoM cost
            </li>
            <li>
              <strong className="text-white">Customer cost impact</strong> — £200-500 extra at pack
              level; not material for domestic install but adds up at commercial scale
            </li>
            <li>
              <strong className="text-white">When justified</strong> — EVs (extreme cycling,
              weight-critical, cost justifies); commercial / grid-scale BESS (efficiency at MWh
              scale); premium home BESS where marketing differentiation matters
            </li>
            <li>
              <strong className="text-white">UK domestic 2025-2026</strong> — rare; passive is the
              standard and adequate for the slow drift LFP exhibits in low-stress home use
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          SoC = how full now. SoH = how aged. Both reported by the BMS via the customer app.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Coulomb counting</strong> — primary method. BMS
              measures current via shunt resistor or Hall sensor; integrates over time; tracks Ah
            </li>
            <li>
              <strong className="text-white">V-curve correction</strong> — at top of charge (~3.5V+
              per cell) and bottom of discharge (&lt;3.0V per cell), the V curve is steeper and
              provides good SoC calibration; mid-range LFP&rsquo;s flat curve makes pure-V SoC
              unreliable
            </li>
            <li>
              <strong className="text-white">Temperature compensation</strong> — usable capacity
              varies with T; BMS reports SoC against current T-corrected capacity, not raw Ah
            </li>
            <li>
              <strong className="text-white">Self-correction at full / empty</strong> — every time
              the battery hits 100% charge or low-V cutoff, the BMS &ldquo;re-anchors&rdquo; the
              coulomb count to the known SoC point
            </li>
            <li>
              <strong className="text-white">Customer-visible</strong> — most apps show SoC as % +
              remaining kWh + estimated runtime at current load
            </li>
            <li>
              <strong className="text-white">Accuracy</strong> — typical SoC accuracy ~2-3% for
              modern BMS in normal operation; better after self-correction events
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Capacity tracking</strong> — every full-cycle (or
              near-full) discharge measures actual Ah delivered; compared to original spec; trend
              tracked over months
            </li>
            <li>
              <strong className="text-white">Internal resistance measurement</strong> — periodic
              test pulses measure cell impedance; impedance rises as cells age; correlates with
              capacity loss
            </li>
            <li>
              <strong className="text-white">Calendar-age model</strong> — BMS includes the
              manufacturer&rsquo;s expected calendar-degradation curve; combined with
              cycle-degradation from capacity measurements
            </li>
            <li>
              <strong className="text-white">Typical LFP trajectory</strong> — year 1: 99-100%; year
              3: ~95-97%; year 5: ~92-95%; year 10: ~75-85%; warranty endpoint ~70-80%
            </li>
            <li>
              <strong className="text-white">Customer-visible</strong> — most UK BESS apps show SoH
              explicitly; manufacturer warranty curve as reference
            </li>
            <li>
              <strong className="text-white">Commissioning baseline</strong> — cert evidence bundle
              records SoH at commissioning (typically 99-100%); future inspections compare against
              this baseline
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          BMS publishes the limits. PCE respects them. Mismatched protocols = silent failure.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">CAN bus (Controller Area Network)</strong> —
              automotive-derived, fast (typically 250-500 kbps), robust against noise. Used widely
              between BMS and PCE in same vendor ecosystem (GivEnergy, Pylontech, BYD, Sigenergy).
              Some open-standard CAN messages exist (Pylontech CAN protocol is widely supported)
            </li>
            <li>
              <strong className="text-white">Modbus RTU over RS-485</strong> — industrial standard,
              slower than CAN (~9.6-115.2 kbps) but flexible address maps. Common in commercial /
              multi-brand integrations. Some UK domestic systems use Modbus for telemetry while CAN
              handles real-time control
            </li>
            <li>
              <strong className="text-white">Proprietary protocols</strong> — Tesla
              Gateway-to-Powerwall (encrypted, undocumented); Enphase IQ Gateway-to-Battery
              (IQ-specific). Tight integration within the brand ecosystem; locks customer into that
              brand for expansion
            </li>
            <li>
              <strong className="text-white">Wireless / IoT</strong> — some commercial BESS use
              ZigBee / proprietary RF for telemetry — not common in UK domestic BMS-PCE control loop
            </li>
            <li>
              <strong className="text-white">Compatibility matrix</strong> — every reputable
              inverter manufacturer publishes a list of supported batteries (and vice versa). The
              competent installer consults this list BEFORE quoting; cert evidence bundle records
              the verified pairing
            </li>
            <li>
              <strong className="text-white">Firmware version stacks</strong> — sometimes specific
              firmware versions required on both sides for full compatibility; out-of-date firmware
              can prevent communication or trigger spurious faults
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          The BMS opens the pack contactor on fault. Most faults are recoverable; some need
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Cell over-voltage</strong> — any cell exceeds the upper
              threshold (LFP ~3.65V cell). Pack contactor opens; usually self-resets after
              rebalancing
            </li>
            <li>
              <strong className="text-white">Cell under-voltage</strong> — any cell falls below the
              lower threshold (LFP ~2.5V cell). Pack contactor opens; manual or auto-reset depending
              on severity
            </li>
            <li>
              <strong className="text-white">Over-temperature</strong> — any cell exceeds ~60°C
              (LFP); pack contactor opens; cooling-down period before reset
            </li>
            <li>
              <strong className="text-white">Under-temperature</strong> — any cell below ~-10°C
              charge limit or ~-20°C discharge limit; charging suspended (discharge may continue at
              reduced rate)
            </li>
            <li>
              <strong className="text-white">Cell voltage imbalance</strong> — sustained
              cell-to-cell V delta &gt;100-150 mV; balancing can&rsquo;t keep up; suggests
              cell-level ageing or fault
            </li>
            <li>
              <strong className="text-white">Over-current charge / discharge</strong> — current
              exceeds manufacturer C-rate spec; pack contactor opens; typically auto-resets after
              current returns to safe range
            </li>
            <li>
              <strong className="text-white">Short-circuit</strong> — instantaneous over-current
              trip; contactor opens; manual reset + diagnostic required
            </li>
            <li>
              <strong className="text-white">Communication loss</strong> — CAN bus / Modbus message
              timeout between BMS and PCE; pack may open or run on conservative defaults until comms
              restored
            </li>
            <li>
              <strong className="text-white">BMS internal fault</strong> — self-test fail, firmware
              error, sensor failure; manufacturer support typically required
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">&gt;15°C</strong> — full charge / discharge rate.
              Optimal operating range
            </li>
            <li>
              <strong className="text-white">10-15°C</strong> — full discharge; reduced charge (~75%
              of max)
            </li>
            <li>
              <strong className="text-white">5-10°C</strong> — full discharge but capacity reduced
              ~5%; charge significantly reduced (~25-50% of max)
            </li>
            <li>
              <strong className="text-white">0-5°C</strong> — discharge at ~85-90% capacity; charge
              minimal (~10-20% of max)
            </li>
            <li>
              <strong className="text-white">&lt;0°C</strong> — discharge at ~80% capacity; charge
              typically suspended (lithium plating risk)
            </li>
            <li>
              <strong className="text-white">High temperature (&gt;40°C)</strong> — capacity
              reduced; accelerated calendar degradation; BMS may derate charge to protect cells
            </li>
            <li>
              <strong className="text-white">Mitigation options</strong> — install location with
              year-round 10°C+ minimum (utility room, indoor garage, kitchen-adjacent location);
              enclosure insulation; premium BESS with internal heating (rare for UK domestic)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-5-section-1')}
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-5-section-3')}
