...
const DESCRIPTION =
  'Learn how to select the correct BS 5839-1 fire alarm category based on fire risk assessment, building use, and fire strategy requirements.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Category selection must be based on fire risk assessment findings and the requirements of the fire strategy.',
  },
  {
    id: 'office-scenario',
    question:
      'A new 4-storey office building has open-plan floors, a basement car park, server room, and ground floor restaurant. How would you approach category selection?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'L2 for life safety (escape routes + high-risk rooms like the restaurant kitchen), P2 for the server room. Car park may need separate consideration for ventilation system integration.',
  },
  {
    id: 'review-trigger',
    question:
      'An L3 office building is adding a 24-hour call centre that will have night shift workers. Does the category need reviewing?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Yes - the change to 24-hour occupation may affect the risk assessment. Consider whether L3 still provides adequate warning during night shifts when fewer people are present to raise manual alarm.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'The fire strategy document defines life safety provisions including the required fire alarm category.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'The choice depends on whether the fire strategy requires comprehensive (L1) or targeted (L2) detection.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'Different zones may have different needs - life safety for offices, property protection for warehouse.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Category selection may involve multiple stakeholders depending on building type and requirements.',
  },
  {
    id: 6,
    question:
      'If the fire risk assessment identifies sleeping risk, which categories are typically considered?',
    options: ['M or P2 only', 'L1 or L2 depending on building layout', 'L4 only', 'P1 only'],
    correctAnswer: 1,
    explanation:
      'Sleeping risk requires enhanced life safety detection, typically L1 for full coverage or L2 for targeted.',
  },
  {
    id: 7,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Cause-and-effect should be agreed during design to ensure the system meets all operational requirements.',
  },
  {
    id: 9,
    ...
    correctAnswer: 2,
    explanation:
      'Category selection is based on risk, occupancy, and strategy - not aesthetic factors.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'Schools typically require L2 - escape route protection plus detection in high-risk areas like labs.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'The category should be defined in the fire strategy. The designer specifies a system to meet those requirements, which may be reviewed by building control.',
  },
  {
    question: 'Can the client choose a lower category to save money?',
    answer:
      'Not if it conflicts with fire strategy requirements or risk assessment findings. Life safety must take priority over cost.',
  },
  {
    question: 'What if insurer and fire strategy requirements differ?',
    answer:
      'Meet both - the higher standard applies. Document clearly which areas serve which purpose.',
  },
  {
    question: 'How often should category selection be reviewed?',
    answer:
      'Whenever there are significant changes to building use, layout, or occupancy. Also when the fire risk assessment is updated.',
  },
  {
    question: 'Can I specify a higher category than required?',
    answer:
      'Yes - there is no upper limit. A client may choose L1 where L2 would suffice, though this increases cost and false alarm potential.',
  },
  {
    question: 'What documentation is needed for category selection?',
    answer:
      'Design certificate, specification, cause-and-effect matrix, and reference to fire strategy. Keep records of stakeholder consultations.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Fire risk assessment:</strong> Drives category selection
              </li>
              <li>
                <strong>Fire strategy:</strong> Defines required category
              </li>
              <li>
                <strong>Stakeholders:</strong> Fire engineer, insurer, building control
              </li>
              <li>
                <strong>Documentation:</strong> Record rationale and justification
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Changes in use = review category
              </li>
              <li>
                <strong>Use:</strong> Consult stakeholders early
              </li>
              <li>
                <strong>Apply:</strong> Document all decisions
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Fire alarm category selection is a systematic process driven by risk, not by cost or
              convenience.
            </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>The following factors influence category selection:</p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">Influencing Factors:</p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Occupancy type</strong> - sleeping, public, vulnerable persons
                </li>
                <li>
                  <strong>Fire load</strong> - fuel, storage, processes
                </li>
                <li>
                  <strong>Ignition sources</strong> - electrical, heating, cooking
                </li>
                <li>
                  <strong>Building layout</strong> - escape routes, compartmentation
                </li>
                <li>
                  <strong>Evacuation strategy</strong> - simultaneous, phased, progressive
                </li>
                <li>
                  <strong>Asset value</strong> - high-value equipment, stock, data
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Category selection may require consultation with multiple parties:</p>

            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">Key Stakeholders:</p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Fire engineer</strong> - fire strategy, system design
                </li>
                <li>
                  <strong>Building control</strong> - Building Regulations compliance
                </li>
                <li>
                  <strong>Insurer</strong> - property protection requirements
                </li>
                <li>
                  <strong>Client/operator</strong> - operational needs, false alarm management
                </li>
                <li>
                  <strong>Fire and rescue service</strong> - for complex or high-risk buildings
                </li>
              </ul>
            </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm text-white">
                <strong>Important:</strong> Record all consultations and agreements in design
                documentation.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>The cause-and-effect matrix documents what happens when the fire alarm activates:</p>
            ...
            <p>Develop cause-and-effect during design stage with all relevant stakeholders.</p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>Category selection should be reviewed when:</p>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Selecting category based on cost</strong> - without proper risk
                  justification
                </li>
                <li>
                  <strong>Not reviewing category</strong> - when building use changes
                </li>
                <li>
                  <strong>Failing to consult stakeholders</strong> - during design
                </li>
              </ul>
            </div>
          </div>
        ...
        <nav className="flex flex-col-reverse sm:flex-row sm:justify-between gap-3 pt-8 border-t border-white/10">
          <Button
            ...
            asChild
          >
            <Link to="/electrician/upskilling/fire-alarm-course/module-1/section-3">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Previous Section
            </Link>
          </Button>
