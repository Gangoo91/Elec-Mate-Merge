    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          How BS 5839-1:2025 category selection flows from the Regulatory Reform (Fire Safety) Order
          2005 fire risk assessment, Approved Document B, insurer requirements and sector-specific
          regulation — and how the 2025 changes to documentation, variations, maintenance and
          modifications affect the design and life-cycle of a system.
        </p>
        ...
        <ContentEyebrow>The decision flow — how category selection actually happens</ContentEyebrow>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Approved Document B cross-check.</strong> ADB sets the design expectations for
              new buildings and material refurbishments. Where ADB and the FRA point to different
              categories, the more demanding wins. ADB rarely prescribes BS 5839-1 categories
              directly but the escape-route and detection expectations frequently demand L1 / L2 /
              L3 outcomes.
            </li>
            <li>
            ...
            <li>
              <strong>Insurer requirements.</strong> Property insurers may require P-grade detection
              or specific configuration as a condition of cover. Insurer requirements are commercial
              but binding on the project.
            </li>
            <li>
              ...
              arrangement, sounder design, etc., follow the BS 5839-1:2025 recommendations for that
              category. Variations from the standard are documented per clause 6.
            </li>
          </ol>
          <p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <g>
              ...
              <text x="140" y="156" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
              ...
              <text x="140" y="216" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
              ...
              <text x="140" y="276" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
              ...
              <text x="140" y="336" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
            ...
            <g>
              ...
              <text x="400" y="206" textAnchor="middle" fill="rgba(255,255,255,0.8)" fontSize="10">
                Most demanding input
              </text>
              <text x="400" y="220" textAnchor="middle" fill="rgba(255,255,255,0.8)" fontSize="10">
                drives the category
              </text>
            ...
            <g>
              ...
              <text x="670" y="138" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
              ...
              <text x="670" y="208" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
              ...
              <text x="670" y="278" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9">
            ...
            <text x="410" y="404" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
              Inputs feed in order of legal weight: FRA is the master driver. ADB constrains design.
              Sector / insurer add specifics. BS 5839-1:2025 implements.
            </text>
            <text x="410" y="418" textAnchor="middle" fill="rgba(255,255,255,0.65)" fontSize="9.5">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>Outputs.</strong> Each sounder zone, voice-alarm zone, ancillary output (door
              release, lift homing, ventilation shutdown, ARC transmission, smoke-control fan
              activation).
            </li>
            <li>
              <strong>Mappings.</strong> Which input drives which output, with timings (immediate /
              delayed / phased), conditional logic (if X and Y then Z), and override rules (manual
              evacuation overrides phased; staff alarm latches to general alarm after X minutes).
            </li>
            <li>
              <strong>Default behaviour.</strong> What happens on a fire alarm signal (the headline
              behaviour, the simplest case).
            </li>
            <li>
          ...
          <p>
            ...
            existing behaviour; a maintenance test plan needs to know what each input is supposed to
            do; an investigation needs to compare actual behaviour during an incident with specified
            behaviour. Without the description, all three are guesswork.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              user of the system. This could be as simple as "this system operates as a simultaneous
              evacuation" or a cause-and-effect matrix document might be required for more complex
              strategies. The standard does not dictate the manner of the cause-and-effect matrix
              only that it needs to be produced.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>As-built drawings.</strong> Showing detector locations, MCPs, sounders, panel
              position, cable routes (where relevant), zone boundaries.
            </li>
            <li>
            ...
            <li>
              <strong>Zone plan (or other suitable diagrammatic representation per 22.2.5).</strong>{' '}
              Required in any premises with more than one zone on any storey, especially in premises
              with sleeping accommodation. Absence is one of the variations that is NOT acceptable.
            </li>
            <li>
            ...
            <li>
              <strong>System logbook.</strong> Records of acceptance, services, modifications, fault
              calls, false alarms (with categorisation), variations.
            </li>
            <li>
            ...
            <li>
              <strong>Operating and maintenance manual.</strong> Tells the user how to operate, test
              (user-led tests), reset, log faults, schedule servicing.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              in 22.2.5) in premises with more than one zone on any storey, particularly premises in
              which people sleep.
            </li>
            <li>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              Every variation (not just major ones) must be recorded in the system logbook with the
              rationale and any agreement with the responsible person, the enforcing authority or
              the insurer.
            </li>
            <li>
          ...
          <p>
            ...
            installations: missing zone plans in sleeping premises (because nobody enforced "major"
            recording for diagrammatic representation), and missing ARC transmission in
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Approximately 6-monthly servicing.</strong> Successive services within 5 to 7
            ...
            <li>
              ...
              verification (zone identification on the CIE matches the zone plan); checking the time
              clock and day/night settings; verifying ARC alarm transmission of all signal types
              (fire, fault, etc.); reviewing the false-alarm rate and trigger investigation if the
              rates exceed the BS 5839-1:2025 30 thresholds.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              the current version of the standard (BS 5839-1:2025), even if the existing system was
              designed to an earlier edition. The standard acknowledges that the overall system may
              not conform fully to the current standard; the extension itself does.
            </li>
            <li>
            ...
            <li>
              <strong>Cause-and-effect update.</strong> Any modification that affects behaviour must
              be reflected in an updated cause-and-effect description.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              plugs on patch leads; physical-key access to the CIE; tamper-evident seals on critical
              interfaces.
            </li>
            <li>
              <strong>Logical access controls.</strong> Authentication of remote-access requests in
              the CIE or gateway software. Strong passwords; multi-factor authentication where
            ...
            <li>
              ...
              responsible individual must verify the system is fully operational. Remote operations
              that do not include this verification step risk leaving the system in an indeterminate
              state.
            </li>
            <li>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              higher-risk premises increasingly require AFDDs upstream of fire-alarm circuits. AFDDs
              reduce ignition risk — directly complementing fire detection.
            </li>
            <li>
              <strong>Section 560 supply continuity.</strong> Continuous availability of supply is
              load-bearing for fire alarms; standby battery and backup arrangements must be designed
              in coordination with the electrical contractor.
            </li>
            <li>
            ...
            <li>
              <strong>EIC schedule column updates.</strong> A4:2026 updates the schedule columns in
              the model EIC; if the fire alarm is part of the documented installation, the EIC
