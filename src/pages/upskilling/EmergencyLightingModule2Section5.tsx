    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The visual beacons that turn an escape route into a navigable path. ISO 7010 E001 / E002
          running-man pictograms, the d = s × p viewing-distance formula (p = 100 internal, p = 200
          external), 5 to 500 cd/m² sign-face luminance with a 10:1 internal uniformity cap, Pantone
          354c safety colour at ≥ 50 % of the sign area, and the BS 5266-1:2025 strengthening of
          external signage at final exits.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>E001 — door on LEFT, figure running RIGHT.</strong> Used where the occupant is
              travelling toward the right at the sign location. The figure points to where the exit
              is.
            </li>
            <li>
            ...
            <li>
              <strong>Selection follows actual travel direction.</strong> The pictogram should point
              in the direction of travel relative to the occupant's approach. A sign at a T-junction
              with the exit to the right uses E001; the same sign for an exit to the left uses E002.
            </li>
            <li>
              <strong>Down-arrow / up-arrow modifiers.</strong> Where the exit is below or above the
              current floor (stair signage), additional ISO 7010 down-arrow or up-arrow pictograms
              are placed adjacent to the running-man sign to indicate level change.
            </li>
            <li>
              <strong>Stairs supplementary pictogram.</strong> ISO 7010 also includes stair
              pictograms (E001 with stairs) for situations where the route involves a descent /
              ascent — common in multi-storey escape signage.
            </li>
            <li>
              <strong>Other related pictograms.</strong> E007 (assembly point), E003 (first aid),
              E009 (eye-wash) — same green / white scheme but different functional category. Do not
              mix them with the running-man pictogram on the same sign.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Emergency exit signs shall use the ISO 7010 pictogram for safe condition signs (E001 /
              E002 running man through door) on a green background. The safety colour shall occupy
              at least 50 % of the area of the sign. Legend-only signs (text without pictogram)
              shall not be used as the primary emergency exit sign.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>150 mm pictogram, internal.</strong> d = 0.15 × 100 = 15 m. The most common
              size in commercial offices.
            </li>
            <li>
          ...
          <p>
            ...
            sight lines, externally illuminated signs are typically more cost-effective because the
            same maximum viewing distance can be achieved with a smaller (and cheaper) sign face
            plus a separate luminaire.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              shall be determined by the formula d = s × p, where s is the height of the pictogram
              on the sign and p is a distance factor with the value p = 100 for internally
              illuminated signs and p = 200 for externally illuminated signs. Where the actual
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          <h4 className="text-sm font-bold text-white mb-4">
            Emergency exit sign anatomy — d = s × p (worked example: 150 mm pictogram externally
            illuminated, d = 30 m)
          </h4>
          <svg
            viewBox="0 0 820 440"
          ...
          >
            ...
            <path
              d="M 250 180 L 280 180 L 275 173 M 280 180 L 275 187"
            ...
            <text x="80" y="344" fill="#EF4444" fontSize="11" fontWeight="bold">
              Sign-face luminance: ≥ 5 cd/m² (visibility floor) · ≤ 500 cd/m² (glare cap) ·
              Lmax/Lmin ≤ 10:1 (uniformity).
            </text>
            <text x="80" y="362" fill="rgba(255,255,255,0.7)" fontSize="10">
              Safety colour Pantone 354c green ≥ 50 % of sign area; pictogram rendered
              white-on-green.
            </text>
            <text x="80" y="380" fill="rgba(255,255,255,0.7)" fontSize="10">
              Mounting height typically 2.0 to 2.5 m to underside; high-bay → larger pictogram per d
              = s × p.
            </text>
            <text x="80" y="398" fill="rgba(255,255,255,0.7)" fontSize="10">
              Response: 5 s to 50 % luminance, 60 s to 100 %. Maintained = always on; non-maintained
              = on at mains failure.
            </text>
          </svg>
        </div>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              colour. Calibrated against typical wall luminance during evacuation (around 0.5 to 2
              cd/m²); the sign must be at least 2 to 10 times brighter than the surrounding walls to
              function as a beacon.
            </li>
            <li>
              <strong>≤ 500 cd/m² ceiling.</strong> The maximum brightness anywhere on the safety
              colour. Above 500 cd/m² the eye experiences glare; the sign becomes uncomfortable to
              look at and the escape route around the sign appears darker by contrast (eye stops
              adapting downward). 500 cd/m² is roughly the brightness of a typical office-grade
              computer monitor at full white.
            </li>
            <li>
              <strong>Lmax/Lmin ≤ 10:1.</strong> Uniformity across the safety-colour area. A
              back-lit sign with a single LED behind the centre of the panel and no diffuser
              produces a hot-spot at the centre and dim corners; this fails 10:1. Modern back-lit
              signs use edge-lit light-guide panels to achieve 3:1 or better.
            </li>
            <li>
              <strong>Pictogram (white area) is separate.</strong> The 10:1 cap applies to the green
              safety-colour area. The white pictogram is the contrasting element and is allowed to
              be brighter or dimmer than the green area; the contrast is the sign's identifiability.
              White-on-green typically reads at about 1.5 to 3× the luminance of the green area.
            </li>
            <li>
              <strong>Verification at commissioning.</strong> Calibrated luminance meter held normal
              to the sign face, measuring at multiple points on the safety-colour area. Record min,
              max, and ratio. Each must fall inside the published rule.
            </li>
            <li>
              <strong>Internally vs externally illuminated.</strong> The luminance rules apply to
              both. Internally illuminated signs typically deliver 50 to 200 cd/m² uniform.
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              lighting shall be not less than 5 cd/m² and not more than 500 cd/m². The ratio of the
              maximum to minimum luminance within the safety colour area shall not exceed 10:1.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              medical waiting areas, places of worship. Occupants do not know the layout and must be
              guided by always-visible signage during normal operation as well as emergency.
            </li>
            <li>
            ...
            <li>
              <strong>Energy considerations.</strong> Maintained signs consume slightly more energy
              continuously (typically 3 to 8 W per sign) but modern LED maintained signs are very
              low-power. The energy difference between maintained and non-maintained is marginal at
              scale.
            </li>
            <li>
            ...
            <li>
              <strong>Lifecycle implications.</strong> Maintained signs have their LEDs always on;
              lifetime (typical 50 000 to 100 000 hours at constant on) means about 6 to 11 years of
              continuous service. Non-maintained signs have their LEDs only on during emergencies
              and tests; lifetime in years is much longer, but battery life governs replacement
              cycle.
            </li>
            <li>
              <strong>Hybrid switching ("switched maintained").</strong> Some premises use signs
              that are maintained during occupied hours and non-maintained during unoccupied hours,
              controlled by a building management system. Acceptable under BS 5266-1:2025 provided
              the sign achieves maintained behaviour whenever the premises are occupied.
            </li>
          </ul>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              Maintained emergency exit signs shall be installed in premises where the occupants are
              not necessarily familiar with the means of escape, including but not limited to
              ...
              occupants are familiar with the means of escape, non-maintained signs are acceptable
              provided the response time and luminance requirements of BS EN 1838:2024 §5 are met.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>2.0 to 2.5 m typical.</strong> Above the head of an average occupant (1.7 m)
              plus arm-up clearance. Provides clear sight-line from anywhere along the escape route
              at floor level.
            </li>
            <li>
              <strong>High-bay applications.</strong> Warehouses, hangars, sports halls — sign
              mounting may be 4 m or higher. Pictogram height stepped up accordingly. d = s × p is
              calculated against actual sight-line distance, not horizontal distance; in tall spaces
              the sight line may be 1.5× the horizontal distance.
            </li>
            <li>
              <strong>Low-level supplementary signage.</strong> ISO 16069 + BS 5266-1:2025 allow
              additional way-finding lighting at 0.4 to 0.6 m from the floor (low-level escape route
              lighting). This complements the high-level signage during smoke-logging conditions
              where the upper part of a corridor may be obscured by smoke. Used in cinemas,
              theatres, large enclosed spaces.
            </li>
            <li>
              <strong>Sight-line verification.</strong> Walk the route at design stage with a
              printed sign-size template held at the proposed mounting position. Confirm the sign is
              unambiguously visible from the start of the corresponding leg of the escape route. If
              not, reposition or upsize.
            </li>
            <li>
              <strong>Distance from final exit.</strong> Sign within 2 m of every final exit (BS EN
              1838:2024 §4.5 decision-point rule). The sign visually marks the exit; an exit without
              an adjacent sign is a navigation failure even if the door is otherwise obvious.
            </li>
            <li>
              <strong>Distance between signs along a route.</strong> Maximum sign-to-sign spacing =
              d, where d is calculated from the formula. In practice spacing is somewhat tighter to
              provide redundancy; if one sign is obscured by smoke or fixture damage, the next sign
              should still be visible from the previous one.
            </li>
            <li>
              <strong>Avoid sign placement where it can be obscured.</strong> Behind doors when
              open, behind hanging banners, behind racking that may be erected at retail fit-out,
              behind moveable partitions. Site survey must consider not just the building as built
              but the building as USED.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              away from the building, identifying the exit from outside. Helps emergency services
              find the building entry / exit; helps occupants who have just left re-orient if
              needed.
            </li>
            <li>
              <strong>IP65 minimum.</strong> Weather-rated for outdoor exposure. Indoor-rated signs
              (typically IP20) are not permitted at external locations regardless of how sheltered
              the position appears.
            </li>
            <li>
              <strong>Same luminance rules.</strong> 5 to 500 cd/m², 10:1 uniformity. Same Pantone
              354c green, same ISO 7010 pictogram.
            </li>
            <li>
              <strong>Path-of-travel signage.</strong> Where the route to the assembly point is long
              or has changes of direction, intermediate external signs are required to guide
              occupants along the path. ISO 7010 directional pictograms (running man with
              appropriate arrow) are used.
            </li>
            <li>
              <strong>Assembly point sign (E007).</strong> The assembly point itself is marked with
              an ISO 7010 E007 pictogram (assembly point). This is a different pictogram (figures
              gathered around a meeting point) and a different sign function — it identifies the
              destination, not the route to it. Same Pantone 354c green, same luminance rules.
            </li>
            <li>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              with the same luminance, uniformity and pictogram requirements as internal signs of BS
              EN 1838:2024 §5, and shall have an ingress-protection rating appropriate to the
              location, with IP65 the minimum for normally-exposed external locations. The assembly
              point shall be identified by an emergency safety sign in accordance with ISO 7010
              E007.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Self-contained internal — small premises.</strong> Lowest install cost. One
              product per sign, mains feed only, internal battery. Maintenance by sign-by-sign
              replacement at end-of-life. Suitable for offices, small retail, small warehouses.
            </li>
            <li>
              <strong>Self-contained external — flexible retrofit.</strong> Two products (sign +
              luminaire) but no centralised infrastructure. Useful for retrofit where a CPS is not
              present. The luminaire is the emergency-rated element; the sign is often a passive
              printed face.
            </li>
            <li>
              ...
              cost at scale (one battery bank rather than hundreds of internal batteries). Suitable
              for hospitals, large hotels, shopping centres, transport hubs.
            </li>
            <li>
              ...
              and report status via an LED indicator or addressable network. Reduce manual testing
              labour; covered in detail in Module 2 §6.
            </li>
            <li>
              <strong>Cable considerations.</strong> Internal sign feeds are typically standard
              low-voltage cable. Central battery feeds in escape routes typically require fire-rated
              cable (e.g. BS 8434-2 / BS EN 50200 PH classification) to maintain circuit integrity
              during fire conditions for the rated duration.
            </li>
            <li>
              <strong>Circuit protection.</strong> BS 7671:2018+A2:2022 §560 applies. Final circuit
              OCPDs must coordinate with the emergency supply. Discrimination is critical — a
              non-emergency-circuit fault must not propagate into the emergency circuit.
            </li>
            <li>
              <strong>Test switches.</strong> BS 5266-1:2025 §8 requires accessible test facilities
              at each sign (or sign group) to allow simulated mains failure during routine
              inspections. Lockable test key switches are typical.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Pictogram correctness.</strong> ISO 7010 E001 / E002 at every sign, handedness
              matches direction of travel. Photo each sign for the record.
            </li>
            <li>
              <strong>Mounting position.</strong> Within 2 m of decision point. Mounting height 2.0
              to 2.5 m to underside (or as designed). No sight-line obstructions.
            </li>
            <li>
              <strong>Luminance.</strong> Calibrated luminance meter on safety-colour area. Multiple
              points per sign. Confirm 5 to 500 cd/m², 10:1 ratio.
            </li>
            <li>
            ...
            <li>
              <strong>Discharge test.</strong> Hold sign on emergency supply for full rated duration
              (1 h or 3 h). Confirm luminance remains ≥ 50 % of rated value at end of duration. Sign
              self-recovers fully within 24 h.
            </li>
            <li>
              <strong>External signs.</strong> Same checks plus IP65 verification (visual check of
              seals, gland integrity, luminaire enclosure). Confirm external luminaire is connected
              to emergency supply, not security supply.
            </li>
            <li>
              <strong>Records.</strong> Commissioning sheet records each sign by location and test
              result. Cross-references the BS 5266-1:2025 design and installation record produced by
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              recorded sign-by-sign in the commissioning record, which shall form part of the design
              and installation record retained by the responsible person.
            </>
          }
        ...
        <FAQ
          items={[
            {
              question: 'When should I use E001 vs E002 — is there a default?',
              answer:
            ...
            {
              question: 'Can I use a 100 mm pictogram in a typical office corridor?',
              answer:
            ...
            {
              question: 'How do I confirm my sign uses Pantone 354c?',
              answer:
            ...
            {
              question: 'What about exit signs in stair cores — do they need different treatment?',
              answer:
            ...
            {
              question: 'What is the IP rating required for a covered-loading-bay external sign?',
              answer:
            ...
            {
              question: 'How do I record sign luminance for the design and installation record?',
              answer:
