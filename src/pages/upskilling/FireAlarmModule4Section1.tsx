      ...
      <HubBody>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Origin-point connection.</strong> The dedicated MCB sits at the origin of the
              consumer&apos;s installation — the consumer unit, the main switch, the position that
              BS 7671 calls the origin. Taking the supply from any sub-distribution further
              downstream introduces additional protective devices, additional joints, and additional
              opportunities for isolation.
            </li>
            <li>
              <strong>Single load.</strong> The MCB feeds the CIE alone. Spurs to other equipment —
              door entry boxes, signage, even a "useful" socket for the engineer&apos;s laptop — are
              forbidden. Once a second load is on the circuit, the dedication is broken; the circuit
              is no longer a fire alarm circuit.
            </li>
            <li>
            ...
            <li>
              ...
              NOT SWITCH OFF". The label is permanent (engraved or printed onto a durable substrate,
              not handwritten on a sticky note), legible (sized to be read at the consumer unit),
              and visible (located on or immediately adjacent to the lockable means of isolation,
              not hidden inside the consumer unit lid).
            </li>
          </ul>
          <p>
            Each of the four elements above is independent: you can have a dedicated circuit without
            a lockable isolator, or a labelled isolator that feeds a shared circuit, and the system
            is non-compliant in either direction. Compliance requires all four simultaneously.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              reliability of the sub-board itself. The probability of any one of those failing rises
              with the count.
            </li>
            <li>
              ...
              context where the only person who would isolate it is the person specifically working
              on the fire alarm.
            </li>
            <li>
          ...
          <p>
            ...
            always be installations where the consumer unit and the CIE are physically separated and
            an intermediate route is unavoidable. The principle is to minimise the chain, and to
            document any departures with a justified variation per BS 5839-1:2025 clause 6
            (Variations).
          </p>
        </ConceptBlock>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="75" y="208" textAnchor="middle" fill="#A855F7" fontSize="11" fontWeight="bold">
              DNO incomer
            </text>
            ...
            <text x="360" y="263" textAnchor="middle" fill="rgba(255,255,255,0.55)" fontSize="8.5">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              adhesive backing rated for the environment, or a similarly durable label. Handwritten
              on tape or paper does not survive the lifetime of the installation.
            </li>
            <li>
              <strong>Legible.</strong> Text size large enough to be read from working distance — an
              electrician at the consumer unit door, a fire-risk assessor doing a survey, a
              layperson doing a routine check. Tiny print defeats the purpose.
            </li>
            <li>
              <strong>Visible.</strong> Located on or immediately adjacent to the lockable means of
              isolation — typically the face of the MCB, or the trim around it. A label hidden
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              padlocked. Manufacturer-specific; the wrong accessory on the wrong MCB does not lock.
            </li>
            <li>
              <strong>Lockable isolator.</strong> A separate isolator (rotary or knife-blade type)
              with a built-in lock-off mechanism, fitted in the dedicated final circuit upstream of
              the protective device or as the protective device itself.
            </li>
          </ul>
          <p>
            The correct compliance pattern: at the consumer unit, the dedicated MCB is itself
            lockable (or fitted with the manufacturer&apos;s lock-off accessory), AND it carries the
            prescribed label, AND it serves no other load. A padlocked consumer-unit door does not
            meet the requirement because the circuit-breaker itself remains free to operate (the
            door simply prevents access).
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              affect operation. BS 5839-1 narrows this to specific cable categories — fire-resistant
              cable to BS EN 50200 with PH classification, see §3 of this module — and BS 8519
              provides the broader code of practice for fire-resistant power and control cable
              systems.
            </li>
            <li>
              <strong>Protection coordination.</strong> Section 560 requires that the protection of
              the safety-services supply not be compromised by faults on other circuits. This aligns
              with the BS 5839-1 dedicated-circuit principle — an unrelated circuit cannot trip the
              safety-services supply.
            </li>
            <li>
              <strong>Switchgear identification.</strong> Section 560 requires the means of
              isolation of safety-services supplies to be clearly identified. BS 5839-1 narrows this
              to the prescribed label wording.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              circuit, will not significantly affect their operation. The supply for safety services
              shall not be unintentionally interrupted by the operation of a protective device of
              another circuit.
            </>
          }
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>The mains feed is red.</strong> The dedicated final circuit from the consumer
              unit MCB to the CIE input terminals is a red fire-resistant cable — typically FP200
              Gold or equivalent — not a grey twin-and-earth.
            </li>
            <li>
            ...
            <li>
              ...
              opening a void or a riser cannot misidentify a fire alarm cable as a general LV cable.
              Mistaken disconnection during unrelated work is the most common non-equipment failure
              mode in service; end-to-end colour discipline is one of the cheapest engineering
              controls available to prevent it.
            </li>
          </ul>
          <p>
            ...
            consistent across the whole installation, distinct from general LV cabling. Where red is
            used, all fire alarm cabling is red; where an alternative is used, all fire alarm
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              alarm system, should be of a single common colour. The colour red is preferred. The
              intention is to enable identification of fire alarm cabling throughout the
        ...
        >
          <p>
            The 2025 identification, per IEC 60445:2021 / BS 7671 Amendment 2:2022 (now consolidated
            in BS 7671:2018+A4:2026):
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              distinct from brown (L), and distinct from the universal-grey of older installations.
            </li>
            <li>
            ...
            <li>
              <strong>Existing installations.</strong> The change is not retrospective in the sense
              that compliant cream-identified installations from before A2:2022 do not automatically
              become non-compliant. But ANY new work, modification, or extension applies the new
              identification — see BS 5839-1:2025 Section 7 (Extensions and modifications) for how
              the rule applies to additions to existing systems.
            </li>
          </ul>
          <p>
            ...
            addressable loop. Conventional CIEs often do not. Read the manual; do not assume one way
            or the other.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              identification is by colour alone, the colour shall be applied to the entire length of
              the conductor or to a sleeve at each termination. The alphanumeric designation FE may
              be used in addition to the colour to provide further identification. This
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>FE on PE bar.</strong> A common legacy mistake is to land the functional-earth
              conductor onto the protective-earth bar at the consumer unit. The two earths are now
              electrically connected. Any potential difference between FE and PE that the CIE was
              designed to filter out is now imposed onto the protective earth. Symptoms include
              earth-fault indications on the loop that come and go, false alarms triggered by mains
              transients, and corrupted addressable communication.
            </li>
            <li>
              <strong>PE on FE terminal.</strong> The reverse: the protective earth has been landed
              on the FE terminal of the CIE. The CIE&apos;s safety earth is now sitting on the
              functional-earth path, which is not designed to carry fault current. An earth fault
              inside the CIE may not clear promptly because the FE path impedance is too high for
              ADS to operate.
            </li>
            <li>
              ...
              inspection. When the colours are wrong or inconsistent, they are invisible until they
              cause a symptom.
            </li>
          </ul>
          <p>
            Pink + FE is one of the smallest 2025 changes by word count, and one of the most
            significant in field consequences. Apply it on every new installation, every extension,
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Normal operation.</strong> Standby load + battery charger demand is typically
              well under 1 A. The mains supply runs at low load most of the time.
            </li>
            <li>
            ...
            <li>
              ...
              directly from the mains. The upstream MCB has to clear it. The MCB rating must be LOW
              ENOUGH that this fault is detected and cleared, AND the MCB type must be FAST ENOUGH
              that the prospective fault current produces an instantaneous trip.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              protected by an overcurrent protective device of a type and rating recommended by the
              manufacturer of the control and indicating equipment. The rating should not be
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-4/section-2')}
