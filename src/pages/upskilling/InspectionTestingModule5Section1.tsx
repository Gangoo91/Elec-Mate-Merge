...
const InspectionTestingModule5Section1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 5 · Section 1" title="Earth fault path principles" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The earth fault loop from transformer star point to MET to CPC and back. Why Zs = Ze + R1
          + R2 governs disconnection time, and how TN, TT and IT differ on the return path.
        </p>
        ...
        >
          <p>
            Reg 411.3.2 of BS&nbsp;7671:2018+A4:2026 sets out the principle: when an earth fault of
            negligible impedance occurs between a line conductor and an exposed-conductive-part or a
            protective conductor, a protective device shall automatically disconnect the supply
            within the disconnection time required by Reg 411.3.2.2. The whole regulation rests on
            the assumption that the fault current can flow round a complete loop — out via the line
            conductor, through the fault, back via the protective conductor and the supply earthing
            arrangement to the source. If any segment of that loop is broken or high-impedance, the
            device cannot operate. That is the entire reason the loop is tested.
          </p>
          <p>
            The loop has a name, a symbol, and a regulatory definition. It is called the earth fault
            loop. Its impedance is Zs. And BS&nbsp;7671 says Zs is the impedance of the loop
            comprising (a) the source, (b) the line conductor up to the point of the fault, and (c)
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Transformer secondary winding</strong> — the source. The secondary winding has
              internal impedance (typically a small fraction of an ohm at the LV side). The star
              point is the reference earth for the system.
            </li>
            <li>
            ...
            <li>
              ...
              cut-out, the line meter tail to the meter, the meter, the line tail from the meter to
              the consumer unit / origin.
            </li>
            <li>
              <strong>Final-circuit line conductor (R1)</strong> — from the protective device
              terminal at the consumer unit, along the line conductor of the final circuit, all the
              way to the fault point.
            </li>
            <li>
              <strong>The fault itself</strong> — assumed to be of negligible impedance for the
              purposes of the regulation. A real fault may have some arc resistance; design assumes
              zero so that the worst case (highest current) is captured.
            </li>
            <li>
            ...
            <li>
              <strong>Transformer star point</strong> — the loop closes here. The current completes
              its journey back into the transformer secondary, ready to flow round again.
            </li>
          </ol>
          <p>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            <circle
              ...
              strokeWidth="2"
            />
            <text x="80" y="218" textAnchor="middle" fill="#FBBF24" fontSize="10" fontWeight="bold">
              XFMR
            </text>
            ...
            <rect
              ...
              strokeWidth="1.2"
            />
            <text x="580" y="305" textAnchor="middle" fill="#22C55E" fontSize="9" fontWeight="bold">
              MET
            </text>
            <line
              x1="605"
            ...
            <text x="600" y="390" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              ⚠ FAULT
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="440" y="40" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              Zs = Ze + R1 + R2
            </text>
            <text x="440" y="56" textAnchor="middle" fill="rgba(255,255,255,0.7)" fontSize="9">
              External (Ze): source + supply L + supply PEN. Internal: R1 (final-circuit line) + R2
              (final-circuit CPC).
            </text>
        ...
        >
          <p>
            ...
            connection to Earth by means of an earth electrode in accordance with Chapter 54 is made
            to the main earthing terminal — except for outbuildings of dwellings served by the
            installation. This recommendation does not change the loop topology: the primary
        ...
        >
          <p>
            On TN-S, the protective conductor (PE) is separate from the neutral throughout — it may
            be the metallic sheath / armour of the supply cable or a discrete PE core. On TN-C-S,
            the supply uses a combined PEN conductor up to the cut-out, and the consumer earthing is
            taken off that PEN at the supplier&rsquo;s terminal block. Reg 411.4.3 permits a single
            conductor to serve as both protective and neutral conductor (a PEN conductor) only in
            fixed installations and only subject to Reg 543 conductor-sizing rules; the A4 amendment
            also adds that no switching or isolating device shall be inserted in a PEN conductor.
          </p>
          <p>
            For TN-C-S in particular, all exposed-conductive-parts of the installation are connected
            to the PEN conductor via the main earthing terminal and the neutral terminal, with these
            terminals linked together at the origin. Open-PEN risk on PME is the well-known
            consequence of this topology — and the reason BS&nbsp;7671 imposes additional bonding
            and protection requirements on EV charging and similar high-risk circuits.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            names two protective device options — an RCD or an overcurrent device — with the former
            being preferred. NOTE 1 to 411.5.2 acknowledges that an overcurrent device may be used
            &ldquo;provided a suitably low value of Zs is permanently and reliably assured&rdquo;,
            which on a TT system is rare in practice.
          </p>
          <p>
            The acceptance condition for RCD-based fault protection on TT is the touch-voltage
            equation in Reg 411.5.3: Ra × IΔn ≤ 50 V, where Ra is the sum of the resistances of the
            ...
            The note to Reg 411.5.3 permits Zs to be used in place of Ra where Ra is not known — and
            Table 41.5 publishes maximum Zs values for non-delayed and S-type RCDs for Uo of 230 V
            (1667 Ω for a 30 mA RCD; 500 Ω for a 100 mA RCD; 167 Ω for 300 mA; 100 Ω for 500 mA).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              earth electrode and the protective conductor connecting it to the
              exposed-conductive-parts (in ohms), and IΔn is the rated residual operating current of
              the RCD.
            </>
          }
        ...
        >
          <p>
            ...
            condition Ra × Id ≤ 50 V for the first fault, where Id is the first fault current taking
            account of leakage and total earthing impedance.
          </p>
          <p>
            Reg 411.6.3 lists the monitoring and protective devices that may be used: insulation
            monitoring devices (IMDs), residual current monitoring devices (RCMs), insulation fault
            location systems (IFLS), overcurrent protective devices (OCPDs), and RCDs. Reg 411.6.4
            requires that where an IT system is designed not to disconnect on the first fault, the
            first-fault occurrence shall be indicated by an audible and/or visual signal which
            continues for as long as the fault persists.
          </p>
          <p>
            For verification, Reg 643.7.3 item (c) sets out two cases: where conditions are similar
            to a TT system, verify as for a TT system; where similar to a TN system, verify by
            measuring the loop impedance with a deliberate connection of negligible impedance
            between a live conductor and earth at the origin and confirm that the measured value is
            less than 50 % of the maximum allowed loop impedance.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            Reg 411.3.2.2 sets the table of maximum disconnection times that apply to final circuits
            with a rated current not exceeding 63 A with one or more socket-outlets, or 32 A
            supplying only fixed connected current-using equipment. For a 230 V TN system, the limit
            is 0.4 s. For a 230 V TT system, the limit is 0.2 s — reflecting the higher
        ...
        <RegsCallout
          ...
          clause={
            <>
              Compliance with Regulation 411.4.4 is achieved when the calculated or measured values
              fulfil Zs × Ia ≤ Up × Cmin. If the inequality holds, the protective device
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              voltage factor (0.95) that accounts for variations in supply voltage on the low side.
            </li>
            <li>
              For a Type B 32 A MCB, the magnetic-trip current Ia is approximately 5 × In (the worst
              case used in Tables 41.3) — so 5 × 32 = 160 A.
            </li>
            <li>
              To trip within 0.1 s on the magnetic curve, Zs must be no greater than Uo × Cmin / Ia
              = 230 × 0.95 / 160 = 1.366 Ω → that is the value in Table 41.3 for a 32 A Type B
              circuit-breaker.
            </li>
          </ul>
          <p>
            Tables 41.2 (BS 88 / BS 3036 / BS 1362 fuses), 41.3 (Type B / C / D MCBs and RCBOs) and
            41.4 (5 s fuse limits) pre-solve this for every common protective device, so on site you
            compare the measured Zs against the table value rather than recalculating. Note 2 to
            each table is the same: the Zs values shall not be exceeded when the line conductors are
            at maximum permitted operating temperature and the CPCs at the assumed initial
            temperature; if the conductors are at a different temperature when tested, the reading
            should be adjusted.
          </p>
        </ConceptBlock>
        ...
        <Scenario
          ...
          whatToDo={
            <>
              ...
              <span className="block">
                Estimated If: 230 × 0.95 / 0.872 ≈ 250 A. That is comfortably above the 5 × In = 160
                A magnetic threshold, so the device will operate on the instantaneous portion of its
                time-current curve in well under 0.1 s.
              </span>
            </>
          }
        ...
        >
          <p>
            ...
            disconnection time. Reg 543.2.4 requires a CPC of types (a) to (d) of Reg 543.2.1 and of
            cross-sectional area 10 mm² or less to be of copper — the dominant material assumption
            underlying GN3 Table BI&rsquo;s mΩ/m values.
          </p>
          <p>
            ...
            local earth electrode in TT. The MET is the single point where the consumer side of the
            loop meets the supply side.
          </p>
          <p>
            Supplementary equipotential bonding (e.g. in a bathroom under Reg 415.2) is a
            touch-voltage limiter, not a fault-current carrier. It does not appear in the Zs sum for
            the relevant circuit; it appears as a parallel path that can affect a continuity
            measurement (relevant for Module 3) but does not change the regulated disconnection time
            in Reg 411.3.2.2.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            converting equipment within the prosumer&rsquo;s installation, an alternative method of
            determining prospective fault current and earth fault loop impedance shall be used.
          </p>
          <p>
            The practical alternative methods are: (1) calculate Zs from a known Ze at the origin
            plus a measured / calculated R1+R2 — the same chain Module 3 builds; (2) measure Zs with
            the prosumer equipment isolated; (3) use a loop tester with active inverter compensation
            if the manufacturer specifies and validates that mode.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>R1+R2 column (per circuit):</strong> measured value at the worst-case point of
              the circuit, recorded for every final circuit.
            </li>
            <li>
              <strong>Zs column (per circuit):</strong> either a measured live Zs or a calculated Zs
              (Ze + corrected R1+R2). Note in the comments which it is. The A4 model forms
        ...
        <FAQ
          items={[
            ...
            {
              question: 'Does the A4 amendment change anything about earth fault loop principles?',
              answer:
