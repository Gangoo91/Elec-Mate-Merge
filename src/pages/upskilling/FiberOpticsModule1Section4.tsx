...
const quizQuestions = [
  {
    ...
    options: [
      'Class 1, 2, 3R, 3B, or 4 depending on the equipment',
      'Class 1 in every system',
      'Always the most hazardous Class 4',
      'Class 5 high-energy industrial lasers',
    ],
    correctAnswer: 0,
    explanation:
      "Different fibre equipment uses different laser classes, from eye-safe Class 1 to hazardous higher classes. Know what you're working with and follow the appropriate precautions.",
  },
  {
    id: 2,
    question: 'Isopropyl alcohol (IPA) used for connector cleaning requires:',
    options: [
      'No particular precautions during use',
      'Heating to above 40°C before application',
      'Good ventilation and keeping away from ignition sources',
      'A full air-fed hazmat suit and respirator',
    ],
    correctAnswer: 2,
    explanation:
      'IPA is flammable and a mild irritant, so it should be used with good ventilation and away from ignition sources.',
  },
  {
    id: 3,
    question: 'What should you do before working on any fibre link?',
    options: [
      'Verify the link is not active or transmitting using a power meter',
      'Briefly check the end face with your eye',
      'Assume fibre is always safe and start work',
      'Simply cap the far-end connector',
    ],
    correctAnswer: 0,
    explanation:
      'Always verify a link is dark (not transmitting) using a fibre optic power meter before inspection or work.',
  },
  {
    id: 4,
    ...
    options: [
      ...
      'Testing fibre continuity',
      'Marking the work area boundary',
      'Collecting fibre off-cuts safely',
    ],
    correctAnswer: 3,
    explanation:
      'The sticky pad safely collects fibre off-cuts and cleaved ends, preventing the sharp shards from scattering.',
  },
  {
    id: 5,
    question: 'Why is eating and drinking prohibited in fibre work areas?',
    options: [
      'To avoid spilling liquids on test equipment',
      'Fibre shards could be ingested accidentally',
      'It speeds up the termination process',
      'Food smells interfere with adhesive curing',
    ],
    correctAnswer: 1,
    explanation:
      'Microscopic fibre shards could contaminate food and drink and be accidentally ingested, so eating and drinking are banned in the work area.',
  },
  {
    id: 6,
    question: 'If a fibre shard penetrates the skin, you should:',
    options: [
      'Rub the area firmly to dislodge it',
      'Leave it, as glass fibre dissolves harmlessly',
      'Use tape to remove it and seek medical attention if needed',
      'Wash the area with isopropyl alcohol',
    ],
    correctAnswer: 2,
    explanation:
      'Use adhesive tape to attempt removal. If you cannot remove it or you experience pain, seek medical attention; never rub, as that pushes it deeper.',
  },
  {
    id: 7,
    question: 'What indicates a fusion splicer is operating?',
    options: [
      'An audible alarm with no visible activity',
      'A steady red indicator light only',
      'No visible or detectable sign at all',
      'An electric arc that can cause eye damage if viewed',
    ],
    correctAnswer: 3,
    explanation:
      'Fusion splicers create a bright electric arc that can damage eyes. Never look directly at the arc during a splice.',
  },
  {
    id: 8,
    ...
    options: [
      ...
      'Carpeted floors to cushion dropped fibres',
      'Dimmed lighting to spot the laser beam',
      'Sealed rooms with no ventilation',
    ],
    correctAnswer: 0,
    explanation:
      'Good lighting helps you see fibres clearly, and clean surfaces prevent contamination and help you locate dropped fibre shards.',
  },
  {
    id: 9,
    question: 'When using UV cure adhesive, protection is needed against:',
    options: [
      'Excessive heat radiated from the lamp',
      'Loud noise from the curing unit',
      'UV light exposure during curing',
      'Strong odours released during curing',
    ],
    correctAnswer: 2,
    explanation: 'The UV light used to cure adhesives can damage eyes, so UV-blocking glasses are required.',
  },
  {
    id: 10,
    question: 'The COSHH regulations apply to fibre work because:',
    options: [
      'Optical fibre itself is a toxic material',
      'Cleaning chemicals and adhesives are hazardous substances',
      'COSHH applies only inside laboratories',
      'They do not actually apply to fibre work',
    ],
    correctAnswer: 1,
    explanation:
      'Chemicals used in fibre work, such as IPA and adhesives, are hazardous substances controlled under COSHH.',
  },
];
