...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Machine/Equipment', 'Method/Procedure', 'Manpower/People', 'Material'],
    correctIndex: 2,
    explanation:
...
const faqItems = [
  ...
  {
    question: 'How detailed should fault reports be in a busy industrial environment?',
    answer:
  ...
  {
    question: 'When should I escalate a fault for formal RCA rather than standard repair?',
    answer:
  ...
  {
    question: 'How can I contribute to continuous improvement as a maintenance electrician?',
    answer:
  ...
  {
    question: 'What tools can help with root cause analysis beyond paper-based methods?',
    answer:
...
const IndustrialElectricalModule5Section5: React.FC = () => {
  // SEO Configuration
  useSEO({
    title: 'Root Cause Analysis and Reporting | Industrial Electrical Module 5 Section 5',
    description:
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Transform fault data into lasting improvements through systematic analysis and
        ...
        <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
          ...
          <ul className="text-white space-y-1 text-sm">
            <li className="flex items-start gap-2">
              ...
              <span>
                Apply the 5 Whys technique to identify true root causes of electrical faults
              </span>
            </li>
            <li className="flex items-start gap-2">
              <CheckCircle2 className="w-4 h-4 text-green-500 mt-0.5 flex-shrink-0" />
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-foreground flex items-center gap-2">
            <span className="text-elec-yellow/80 text-sm font-normal">01</span>5 Whys Analysis
            Technique
          </h2>

          <p className="text-white leading-relaxed">
            The 5 Whys is a simple yet powerful technique developed by Toyota for root cause
            analysis. By repeatedly asking "why" a problem occurred, you drill down through symptoms
            to uncover the underlying cause. Despite its simplicity, this method is highly effective
            for most electrical fault investigations.
          </p>

          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            <h3 className="font-semibold text-foreground mb-4 flex items-center gap-2">
              <GitBranch className="w-5 h-5 text-elec-yellow" />5 Whys Example: VSD Failure
            </h3>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3 bg-background/50 p-3 rounded-lg border-2 border-elec-yellow/50">
                ...
                <div>
                  ...
                  <p className="text-white text-sm">
                    No preventive maintenance schedule existed for VSD filter replacement
                  </p>
                  <p className="text-elec-yellow text-sm mt-1 font-medium">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              <h4 className="font-semibold text-green-400 mb-2 flex items-center gap-2">
                <CheckCircle2 className="w-5 h-5" />5 Whys Best Practices
              </h4>
          ...
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white text-sm">
                  Complex failures often have multiple contributing causes. When your "why" question
                  has more than one valid answer, branch the analysis to follow each path. The true
                  root cause may be where multiple chains converge, or there may be several root
                  causes that each need addressing.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          <p className="text-white leading-relaxed">
            The Fishbone diagram, also called an Ishikawa or cause-and-effect diagram, provides a
            structured framework for brainstorming potential causes of a problem. It organises
            causes into categories, ensuring comprehensive analysis without overlooking important
            factors.
          </p>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <ol className="text-white space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong className="text-foreground">Define the problem</strong> - Write the effect
                  (fault) clearly at the "head" of the fish. Be specific: "Motor M-101 tripped on
                  overload" not just "Motor problem".
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="bg-elec-yellow text-background w-6 h-6 rounded-full flex items-center justify-center text-sm font-bold flex-shrink-0">
                ...
                <span>
                  <strong className="text-foreground">Draw the backbone</strong> - Create the main
                  horizontal line with angled lines (bones) for each category relevant to your
                  analysis.
                </span>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong className="text-foreground">Brainstorm causes</strong> - For each
                  category, identify potential causes. Add smaller bones for sub-causes. Involve the
              ...
              <li className="flex items-start gap-3">
                ...
                <span>
                  <strong className="text-foreground">Analyse and prioritise</strong> - Review all
                  potential causes, gather evidence, and identify the most likely root causes for
          ...
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white text-sm">
                  Fishbone diagrams are most valuable for complex problems where the cause is not
                  immediately obvious, when team brainstorming would add value, or when you want to
                  ensure comprehensive analysis. For straightforward faults where the cause is
                  clear, the 5 Whys alone may be sufficient. Use the right tool for the complexity
                  of the problem.
                </p>
              </div>
            </div>
        ...
        <section className="space-y-4">
          ...
          <p className="text-white leading-relaxed">
            Fault Tree Analysis (FTA) is a top-down, deductive analysis method that uses Boolean
            logic to identify how combinations of events can lead to a system failure. While more
            complex than 5 Whys or Fishbone diagrams, FTA is powerful for analysing safety-critical
            systems and complex failure scenarios.
          </p>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <p className="text-white text-sm">
                  Output occurs only when ALL input events occur simultaneously. Example: Motor
                  starts only when start button pressed AND interlocks satisfied AND overload reset.
                </p>
              </div>
              ...
              <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <p className="text-white text-sm">
                  Output occurs when ANY input event occurs. Example: Motor stops if stop button
                  pressed OR overload trips OR emergency stop activated.
                </p>
              </div>
              ...
              <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <p className="text-white text-sm">
                  A fundamental event that cannot be further developed (bottom of analysis).
                  Example: Fuse fails, cable breaks, contact welds.
                </p>
              </div>
              ...
              <div className="bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <p className="text-white text-sm">
                  The undesired event being analysed (top of the tree). Example: Complete loss of
                  power to critical process, fire in MCC.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white text-sm">
                  FTA is most valuable for: safety-critical system analysis, complex failures with
                  multiple potential cause combinations, reliability engineering and failure
                  probability calculations, and regulatory compliance documentation. For routine
                  electrical faults, simpler methods like 5 Whys are usually sufficient. FTA
        ...
        <section className="space-y-4">
          ...
          <p className="text-white leading-relaxed">
            A well-written fault report transforms a repair into organisational learning. It
            captures the knowledge gained during fault investigation, enabling faster diagnosis of
            future similar faults and providing data for reliability improvement. Poor reports waste
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              ...
              <p className="text-white text-sm">
                "Contactor K3 failed to energise. Coil measured open circuit (infinite resistance
                vs. normal 45 ohms). Coil showed signs of overheating - insulation discoloured. Root
                cause: Control transformer tap set incorrectly, supplying 130V to 110V coil.
                Replaced contactor, corrected transformer tap setting. Recommendation: Verify
                transformer tap settings on all MCCs during next PM."
              </p>
            </div>
        ...
        <section className="space-y-4">
          ...
          <p className="text-white leading-relaxed">
            CAPA is a structured approach to addressing problems that goes beyond simply fixing
            faults. It ensures that both the immediate issue is corrected and steps are taken to
            prevent recurrence. CAPA is a cornerstone of quality management systems and continuous
            improvement.
          </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="bg-background/50 p-4 rounded-lg border-l-4 border-blue-500">
                ...
                <div className="mt-3 p-2 bg-background/50 rounded text-xs text-white">
                  <strong>Example:</strong> After a cable overheated due to undersizing, replace
                  with correct size cable and update the design standard to prevent the same error.
                </div>
              </div>
              ...
              <div className="bg-background/50 p-4 rounded-lg border-l-4 border-green-500">
                ...
                <div className="mt-3 p-2 bg-background/50 rounded text-xs text-white">
                  <strong>Example:</strong> After the cable failure above, audit all similar
                  installations for undersized cables before they fail.
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-4 bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <div>
                  ...
                  <p className="text-white text-sm">
                    Record the nonconformity or potential issue clearly. Gather all relevant data
                    and evidence.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <div>
                  ...
                  <p className="text-white text-sm">
                    Take immediate action to contain the problem and prevent further impact while
              ...
              <div className="flex items-start gap-4 bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <div>
                  ...
                  <p className="text-white text-sm">
                    Apply appropriate RCA techniques (5 Whys, Fishbone, FTA) to identify the true
                    root cause.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <div>
                  ...
                  <p className="text-white text-sm">
                    Develop specific, measurable actions with assigned owners and deadlines.
              ...
              <div className="flex items-start gap-4 bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <div>
                  ...
                  <p className="text-white text-sm">
                    Monitor to confirm actions have resolved the issue. Check that the problem does
                    not recur.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 bg-background/50 p-4 rounded-lg border border-white/10">
                ...
                <div>
                  ...
                  <p className="text-white text-sm">
                    Document closure, share lessons learned, and update procedures or training as
                    needed.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white text-sm">
                  For any incident involving electrical safety - shocks, arc flash, fires, or
                  near-misses - formal CAPA is mandatory under UK health and safety law (RIDDOR
                  reporting may apply). These require thorough investigation, documented actions,
                  and management sign-off. Never dismiss a safety incident with a quick fix.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="space-y-4">
          ...
          <p className="text-white leading-relaxed">
            Effective knowledge management transforms individual fault-finding experiences into
            organisational capability. By capturing, organising, and sharing lessons learned, you
            help colleagues avoid repeating mistakes and accelerate their diagnostic skills.
          </p>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <p className="text-white mb-4">
              Modern Computerised Maintenance Management Systems (CMMS) like Maximo, SAP PM, or
              Maintenance Connection provide powerful tools for capturing and retrieving fault
              knowledge:
            </p>
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4">
            ...
            <p className="text-white mb-4">
              After significant incidents or complex fault investigations, a structured lessons
              learned session captures insights for the whole team:
            </p>
            ...
            <div className="space-y-3">
              <div className="bg-background/50 p-3 rounded-lg border border-white/10">
                ...
                <p className="text-white text-sm">
                  Identify effective diagnostic approaches, good teamwork, or resources that helped.
                </p>
              </div>
              ...
              <div className="bg-background/50 p-3 rounded-lg border border-white/10">
                ...
                <p className="text-white text-sm">
                  Identify gaps in tools, documentation, training, or processes that hindered
                  diagnosis.
                </p>
              </div>
              ...
              <div className="bg-background/50 p-3 rounded-lg border border-white/10">
                ...
                <p className="text-white text-sm">
                  Agree specific actions to implement improvements - assign owners and deadlines.
                </p>
              </div>
              ...
              <div className="bg-background/50 p-3 rounded-lg border border-white/10">
                ...
                <p className="text-white text-sm">
                  Identify key insights to share with other shifts, sites, or teams.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-white text-sm">
                  The most effective maintenance teams treat every fault as a learning opportunity.
                  This requires psychological safety - people must feel able to report problems and
                  near-misses without fear of blame. Focus on improving systems, not punishing
                  individuals. Celebrate good catches and shared learning. Over time, this creates a
                  culture where knowledge flows freely and reliability continuously improves.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-gradient-to-br from-elec-yellow/10 to-amber-600/10 border border-elec-yellow/30 rounded-lg p-6">
          ...
          <div className="grid sm:grid-cols-2 gap-6 text-sm">
            <div>
              <h3 className="text-foreground font-semibold mb-2 border-b border-white/20 pb-1">
                5 Whys Checklist
              </h3>
        ...
        <section className="bg-elec-yellow/5 border border-elec-yellow/30 rounded-lg p-6">
          ...
          <p className="text-white mb-4">
            Test your knowledge of root cause analysis, fault reporting, CAPA implementation, and
        ...
        <div className="text-center space-y-2 pt-4">
          ...
          <p className="text-muted-foreground text-sm">
            Root cause analysis transforms repairs into lasting improvements that benefit the entire
            organisation.
          </p>
        </div>
      </main>
