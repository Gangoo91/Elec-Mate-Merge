        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <Card className="bg-transparent border-transparent">
            ...
            <CardContent className="space-y-4">
              {testVoltages.map((voltage, index) => (
                <div key={index} className="bg-transparent/80 p-4 rounded-lg">
                  <div className="flex items-center gap-3 mb-2">
                    <Badge className="bg-elec-yellow/40 text-blue-300 border-0">
                      {voltage.voltage}
                    </Badge>
              ...
              <div className="bg-elec-yellow/20 p-4 rounded-lg border border-blue-600/30">
                ...
                <p className="text-blue-200 text-sm">
                  For standard UK domestic and commercial installations (230V single phase), always
                  use <strong>500V DC</strong> test voltage.
                </p>
              </div>
            </CardContent>
          </Card>
                ...
                <div className="space-y-4">
                  <div className="bg-purple-600/20 p-4 rounded border-l-4 border-purple-400">
                    <p className="text-purple-200 text-sm">
                      <strong>You have:</strong> 500V insulation resistance tester, single phase
                      circuit isolated and proven dead
                    </p>
                  </div>
            ...
            <CardContent className="space-y-4">
                  ...
                  <div key={index} className="bg-transparent/80 p-4 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span
                        ...
                        dangerouslySetInnerHTML={{ __html: result.range }}
                      ></span>
                    </div>
              ...
              <div className="bg-elec-yellow/20 p-4 rounded-lg border border-blue-600/30">
                ...
                <ul className="text-blue-200 text-sm space-y-1">
                  <li>
                    • <strong>1MΩ minimum</strong> - Below this is a failure
                  </li>
                  <li>
                    • <strong>2MΩ threshold</strong> - Readings below 2MΩ should be investigated
                  </li>
                  <li>
                    • <strong>Higher is better</strong> - New installations typically give &gt;100MΩ
                  </li>
                ...
                <CardContent className="space-y-6">
                  <div className="bg-transparent/80 p-6 rounded-lg">
                    <h3 className="text-green-400 font-semibold mb-4">
                      Example 1: New Domestic Installation
                    </h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                      ...
                      <div>
                        ...
                        <div className="bg-transparent p-3 rounded space-y-1">
                          <p className="text-green-400 font-mono text-sm">
                            Line to Neutral: &gt;999MΩ ✓
                          </p>
                          <p className="text-green-400 font-mono text-sm">
                            Line to Earth: &gt;999MΩ ✓
                          </p>
                          <p className="text-green-400 font-mono text-sm">
                            Neutral to Earth: &gt;999MΩ ✓
                          </p>
                        </div>
                      </div>
                    </div>
                    <p className="text-white text-sm mt-3">
                      <strong>Conclusion:</strong> Excellent readings typical of new installation.
                      All values well above minimum requirements.
                    </p>
                  </div>

                  <div className="bg-transparent/80 p-6 rounded-lg">
                    <h3 className="text-elec-yellow font-semibold mb-4">
                      Example 2: Older Installation Requiring Investigation
                    </h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <h4 className="text-white font-medium mb-2">Installation Details:</h4>
                      ...
                      <div>
                        ...
                        <div className="bg-transparent p-3 rounded space-y-1">
                          <p className="text-green-400 font-mono text-sm">
                            Line to Neutral: 85MΩ ✓
                          </p>
                          <p className="text-elec-yellow font-mono text-sm">
                            Line to Earth: 1.8MΩ ⚠
                          </p>
                          <p className="text-elec-yellow font-mono text-sm">
                            Neutral to Earth: 1.5MΩ ⚠
                          </p>
                        </div>
                      </div>
                    </div>
                    <p className="text-white text-sm mt-3">
                      <strong>Action Required:</strong> Line to earth and neutral to earth readings
                      below 2MΩ require investigation. Check for moisture ingress, damaged
                      insulation, or poor connections.
                    </p>
                  </div>

                  <div className="bg-transparent/80 p-6 rounded-lg">
                    <h3 className="text-red-400 font-semibold mb-4">
                      Example 3: Failed Test Requiring Immediate Action
                    </h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <h4 className="text-white font-medium mb-2">Installation Details:</h4>
                      ...
                      <div>
                        ...
                        <div className="bg-transparent p-3 rounded space-y-1">
                          <p className="text-green-400 font-mono text-sm">
                            Line to Neutral: 150MΩ ✓
                          </p>
                          <p className="text-red-400 font-mono text-sm">Line to Earth: 0.3MΩ ✗</p>
                          <p className="text-red-400 font-mono text-sm">
                            Neutral to Earth: 0.4MΩ ✗
                          </p>
                        </div>
                      </div>
                    </div>
                    <p className="text-white text-sm mt-3">
                      <strong>Action Required:</strong> Circuit fails insulation test. Do not
                      energise. Investigate cable route for damage, likely cause of RCD tripping.
                    </p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="bg-elec-yellow/20 p-4 rounded-lg border border-elec-yellow/30">
                    ...
                    <p className="text-yellow-200 text-sm">
                      In your practical assessment, if readings are affected by environmental
                      conditions, note this on your test certificate and explain how you would
                      address it in a real installation.
                    </p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-6">
                  <div className="bg-transparent/80 p-6 rounded-lg">
                    <h3 className="text-purple-400 font-semibold mb-4">
                      Section Testing for Fault Location
                    </h3>
                    <p className="text-white text-sm mb-3">
                      When overall circuit reading is low, test individual sections to locate the
                      problem:
                    </p>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      <div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="bg-orange-600/20 p-4 rounded-lg border border-orange-600/30">
                    ...
                    <p className="text-orange-200 text-sm">
                      If you're unsure whether equipment can handle the test voltage, always
                      disconnect it. It's better to be safe than damage expensive equipment or get
                      false readings.
                    </p>
                  </div>
                </CardContent>
          ...
          <Card className="bg-transparent border-transparent">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-4">
                ...
                <div className="bg-transparent/80 p-4 rounded-lg">
                  <h3 className="text-red-400 font-semibold mb-3">
                    Problem: Reading Won't Stabilise
                  </h3>
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div>
                      <h4 className="text-white font-medium mb-2">Possible Causes:</h4>
            ...
            <CardContent>
              ...
              <div className="bg-green-600/20 p-4 rounded-lg border border-green-600/30 mt-6">
                ...
                <ul className="text-green-200 text-sm space-y-1">
                  ...
                  <li>
                    • Environmental conditions affect readings - note temperature and humidity
                  </li>
          ...
          <Card className="bg-transparent border-transparent">
            ...
            <CardContent className="space-y-6">
              <div className="bg-transparent/80 p-6 rounded-lg">
                <h3 className="text-purple-400 font-semibold mb-4">
                  Sequential Testing for Large Installations
                </h3>
                <div className="space-y-4">
                  <p className="text-white text-sm">
                    For commercial or industrial installations with multiple circuits, use a
                    systematic approach:
                  </p>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    <div>
                      <h4 className="text-white font-medium mb-2">
                        Phase 1: Distribution Board Level
                      </h4>
                      <ul className="text-white text-sm space-y-1">
                  ...
                  <div className="bg-elec-yellow/20 p-4 rounded">
                    <p className="text-blue-200 text-sm">
                      <strong>Pro Tip:</strong> Always test the worst-performing circuit first
                      during detailed investigation. This often reveals the root cause affecting
                      multiple circuits.
                    </p>
                  </div>
                </div>
                    ...
                    <div className="bg-transparent p-4 rounded">
                      <div className="space-y-3">
                        <div>
                          ...
                          <p className="text-white text-sm">
                            Moisture on surfaces creates false current paths
                          </p>
                        </div>
                    ...
                    <div className="bg-transparent p-4 rounded">
                      <div className="space-y-3">
                        <div>
                          <p className="text-elec-yellow font-medium text-sm">Challenge:</p>
                          <p className="text-white text-sm">
                            Long cable runs and control circuits take time to charge
                          </p>
                        </div>
            ...
            <CardContent className="space-y-6">
              <div className="bg-transparent/80 p-6 rounded-lg">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div>
                    <h4 className="text-white font-medium mb-3">
                      Basic Requirements (Training/Domestic)
                    </h4>
                    <div className="bg-transparent p-4 rounded">
                      <ul className="text-white text-sm space-y-2">
                ...
                <div className="mt-4 bg-elec-yellow/20 p-4 rounded border-l-4 border-elec-yellow">
                  <p className="text-yellow-200 text-sm">
                    <strong>Calibration Critical:</strong> BS 7671 requires test instruments to be
                    calibrated. Never use an out-of-calibration tester for compliance testing.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-transparent/80 p-6 rounded-lg">
                ...
                <div className="space-y-4">
                  <div className="bg-transparent p-4 rounded">
                    <h4 className="text-white font-medium mb-3">
                      Essential Checks Before Each Test Session
                    </h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                  ...
                  <div className="bg-red-600/20 p-4 rounded border-l-4 border-red-400">
                    <p className="text-red-200 text-sm">
                      <strong>Safety Check:</strong> Always perform a prove-before-use test. Test on
                      a known good circuit first to verify the tester is working correctly.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div className="bg-transparent p-4 rounded">
                    <h4 className="text-elec-yellow font-medium mb-3">
                      Scenario 1: "The Circuit That Wouldn't Pass"
                    </h4>
                    <div className="space-y-3">
                      <p className="text-white text-sm">
                        <strong>Situation:</strong> Ring final circuit showing 0.8MΩ line to earth,
                      ...
                      <div className="bg-green-600/20 p-3 rounded">
                        <p className="text-green-200 text-sm">
                          <strong>Examiner Expects:</strong> Logical fault-finding sequence, safety
                          awareness, and clear documentation of the investigation process.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-transparent p-4 rounded">
                    <h4 className="text-elec-yellow font-medium mb-3">
                      Scenario 2: "Mixed Results Interpretation"
                    </h4>
                    <div className="space-y-3">
                      <p className="text-white text-sm">
