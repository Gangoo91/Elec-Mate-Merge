...
const inlineChecks = [
  {
    id: 'm2s6-on-roof',
    question: 'On-roof PV mounting — what is it?',
    options: [
  ...
  {
    id: 'm2s6-in-roof',
    question: 'In-roof PV mounting — what is it?',
    options: [
  ...
  },
  {
    ...
    question: 'Ground-mount PV — when is it the right architecture?',
    options: [
  ...
  {
    id: 'm2s6-bipv',
    question: 'BIPV (Building-Integrated PV) — what does it cover?',
    options: [
  ...
  {
    id: 'm2s6-shading',
    question: 'Shading topology — what should the survey capture?',
    options: [
...
const faqs = [
  ...
  {
    question: 'What roof types are suitable for on-roof PV?',
    answer:
  ...
  {
    question: 'Why is the 70–100 mm standoff such a recurring rule?',
    answer:
  ...
  {
    question: 'How does ground-mount PV compare with rooftop on a £/kWp basis?',
    answer:
  ...
  {
    question: 'Is BIPV worth the cost premium on a typical residential install?',
    answer:
  ...
  {
    question: 'How do solar carports integrate with EV charging?',
    answer:
  ...
  {
    question: 'What aspects of BS 7671 Section 712 are architecture-specific?',
    answer:
  ...
  {
    question: 'What\'s a "sub-array" and when do I have one?',
    answer:
...
export default function RenewableEnergyModule2Section6() {
  ...
  useSEO({
    title: 'PV system architectures | Renewable Energy 2.6 | Elec-Mate',
    description:
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 2 · Section 6 · BS 7671:2018+A4:2026"
        title="PV system architectures"
        backTo="../renewable-energy-module-2"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          On-roof, in-roof, ground-mount, BIPV and solar carport architectures. Mounting,
          structural, shading and orientation considerations, plus the BS 7671 Section 712 heat
          dissipation discipline that lands on each architecture.
        </p>
        ...
        <Pullquote>
          The architecture follows the building. The electrical follows the architecture.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Architecture</strong> — rails fixed above roof covering
              via tile hooks / slate hooks / clamps; modules clamp to rails; 70–100 mm standoff for
              natural-convection cooling
            </li>
            <li>
              <strong className="text-white">Best for</strong> — retrofit installs on existing
              pitched roofs; new-builds where standard aesthetic is acceptable; installs where roof
              replacement is not in scope
            </li>
            <li>
              <strong className="text-white">Pricing</strong> — the baseline against which other
              architectures are compared. Typical UK 2026 residential pricing ~£1,500–2,000 per kWp
              installed (full system including modules, mounting, inverter, install)
            </li>
            <li>
              <strong className="text-white">Constraints</strong> — visible-from-public- realm in
              Conservation Areas may require planning permission; listed buildings typically need
              listed-building consent; rafter and structural load must support the additional weight
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Architecture</strong> — proprietary mounting system
              replaces tiles / slates over the array area; modules become the weatherproof covering;
              perimeter flashings seal the boundary with surrounding tile / slate
            </li>
            <li>
              <strong className="text-white">Best for</strong> — new-builds where the roof can be
              designed around the PV; major roof refurbishments where the covering is being replaced
              anyway; installs where the on-roof aesthetic is unacceptable to the customer or
              planning authority
            </li>
            <li>
              <strong className="text-white">Pricing</strong> — typically 10–25% premium over
              on-roof retrofit due to the more complex mounting and flashing system, offset partly
              by the saved tile / slate cost on new-build
            </li>
            <li>
              <strong className="text-white">Constraints</strong> — module heat dissipation is lower
              than on-roof (less airflow under modules) — modelled yield may be 2–5% below an
              equivalent on-roof install; warranty conditions per the mounting system supplier vary
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Architecture</strong> — frame structure (steel or
              aluminium) supporting modules at a fixed tilt; foundations are concrete ballast or
              driven piles; full ventilation front and rear of modules
            </li>
            <li>
              <strong className="text-white">Best for</strong> — sites with limited roof area but
              available land; rural / agricultural settings; commercial / utility-scale installs;
              where peak yield from optimal orientation / tilt matters
            </li>
            <li>
              <strong className="text-white">Pricing</strong> — 10–25% lower £/kWp than rooftop for
              equivalent system size (easier access, simpler mounting, no roof-penetration sealing,
              better cooling = no derate)
            </li>
            <li>
              <strong className="text-white">Constraints</strong> — land take (~6–8 m² per kWp
              installed including spacing for maintenance access); planning permission may be
              required above certain thresholds; visual impact for neighbouring properties; theft /
              vandalism risk on open sites
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              ...
              conventional building cladding on vertical or inclined surfaces. Premium commercial /
              architectural use. Lower per-W yield (vertical PV captures less sun than tilted) but
              high architectural value
            </li>
            <li>
              <strong className="text-white">PV glazing</strong> — translucent PV modules replacing
              conventional glass in curtain walling, skylights or conservatory roofs. Generates
              electricity while transmitting visible light
            </li>
            <li>
              <strong className="text-white">Walkable PV</strong> — PV surfaces designed to bear
              pedestrian or light vehicular loads, used in terraces, walkways, car-park surfaces.
              Amorphous thin-film is the typical cell technology
            </li>
            <li>
              <strong className="text-white">Solar carports</strong> — PV roof structures over
              parking. Often paired with EV charging — covered in detail below
            </li>
          </ul>
          <p>
            BIPV economics are architectural, not energy. The cost premium per kWp is paid for by
            the building\'s aesthetic / brand / planning-acceptability value rather than by direct
            yield economics. The market is small but growing, particularly on premium new-build and
            architectural-led refurbishment.
          </p>
        </ConceptBlock>
        ...
        <Pullquote>
          The carport is the natural home for PV + EV charging — Section 712 + Section 722 + Chapter
          82 in one project.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Structural design</strong> — handles PV load +
              vehicle-impact loads on supports. Typically requires structural engineer involvement.
              Foundations more substantial than typical ground-mount
            </li>
            <li>
              <strong className="text-white">PV electrical design</strong> — Section 712 applies as
              for any PV install. Sub-arrays organised per carport bay or per inverter MPPT input.
              Multi-MPPT inverter typical for the geometry
            </li>
            <li>
              <strong className="text-white">EV charging integration</strong> — chargepoints per
              parking bay, typically AC chargers at 7.4 kW per bay (residential / light commercial)
              or 22 kW three-phase (workplace). DC fast charging (50–150 kW) for fleet / public
              installations
            </li>
            <li>
              <strong className="text-white">PEI framing</strong> — A4:2026 Chapter 82 treats the
              install as a Prosumer\'s Electrical Installation (Module 1 Section 5). System-level
              design discipline above the per-technology chapters
            </li>
            <li>
              <strong className="text-white">BESS integration</strong> — often paired to smooth PV
              output, peak-shave demand, or provide buffer storage for EV charging. Chapter 57
              applies (Module 5 covers BESS in detail)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <Pullquote>
          Every architecture has its own survey items. Skipping any one creates the failure mode.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              Roof structural capacity for PV load + wind uplift (typically 15–20 kg/m² static plus
              wind loads — competent surveyor or structural engineer signs off where loading
              approaches design limits)
            </li>
            <li>
              Roof covering condition and remaining service life vs the 25+ year PV array life
            </li>
            <li>
              Rafter / batten arrangement and the appropriate fixings (tile hooks, slate hooks,
              metal-sheet clamps)
            </li>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              Roof structure capable of accepting in-roof mounting system perimeter flashings and
              integrated waterproofing
            </li>
            <li>
              Existing tile / slate that will be removed and how the perimeter integrates with the
              remaining covering
            </li>
            <li>
              Mounting system supplier\'s specific installation requirements (including warranty
              conditions)
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              Ground conditions — soft ground / clay / chalk / shallow rock determines foundation
              type (ballast vs piles)
            </li>
            <li>
              Geotechnical assessment for pile foundations (typically a borehole or trial pit)
            </li>
            <li>Planning permission threshold for the proposed array size and location</li>
            <li>
              Wind uplift loads at the site (the open-ground location typically has higher wind
              exposure than rooftop)
            </li>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              Engagement with the building designer / architect — BIPV is rarely an add-on after
              design completion
            </li>
            ...
            <li>
              Specific BIPV product specifications (often requires bespoke modules rather than
              off-the-shelf)
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Azimuth (orientation)</strong> — 180° (south) is
              theoretical optimum. East (90°) or west (270°) loses ~15–25% vs south. North-facing
              (0°/360°) loses ~50%+ — generally not viable
            </li>
            <li>
              <strong className="text-white">Tilt</strong> — 30–40° is optimal for UK latitudes.
              Flatter tilts capture more summer sun but lose winter; steeper tilts capture more
              winter sun but lose summer. The 30–40° range balances the annual sum
            </li>
            <li>
              <strong className="text-white">Roof pitch</strong> — typical UK domestic roofs are
              30–45° pitch, often close to optimal. The visual / structural cost of modifying the
              roof for &ldquo;perfect&rdquo; orientation is rarely justified
            </li>
            <li>
              <strong className="text-white">Multi-orientation arrays</strong> — covered in Section
              2.3 and Section 2.4 (multi-MPPT inverter solves the mismatch). PVGIS models each
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Identify shading sources</strong> — trees, chimneys,
              neighbouring buildings, distant horizon objects. Walk the proposed array area at
              survey and note potential shadow casters
            </li>
            <li>
              <strong className="text-white">Track shadows across the day</strong> — morning,
              midday, afternoon — and seasonally (winter sun is lower, shadows are longer).
              Shade-analysis tools (SunEye, Solmetric, mobile apps) automate this
            </li>
            <li>
              <strong className="text-white">Map shadows to modules</strong> — which modules in the
              proposed array are affected at which times
            </li>
            <li>
              <strong className="text-white">Architectural mitigation</strong> — multi-MPPT inverter
              for orientation-driven mismatch; module-level optimisation for shading-driven mismatch
              (Section 2.5)
            </li>
            <li>
              <strong className="text-white">Survey artefact</strong> — the shading analysis becomes
              part of the cert evidence bundle, justifying the topology choice
            </li>
          </ul>
        </ConceptBlock>
