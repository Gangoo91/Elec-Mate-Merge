  ...
  const quizQuestions = [
    {
      ...
      correctAnswer: 1,
      explanation:
        'Standard convention shows power flow left to right, top to bottom in single-line diagrams.',
    },
    {
    ...
    },
    {
      ...
      options: [
        'AC isolator, then inverter',
        'DC isolator, then inverter',
        'Generation meter first',
        'Distribution board first',
      ],
      correctAnswer: 1,
      explanation:
        'Energy flows from PV array through DC isolator, then to the inverter for DC-AC conversion.',
    },
    {
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'Thick lines indicate power conductors, while thin lines show control circuits in SLDs.',
    },
    {
      ...
      options: [
        'Designer photo',
        'Colour coding only',
        'Title blocks with revision control',
        'Manufacturer logos',
      ],
      correctAnswer: 2,
      explanation:
        'Professional SLDs require title blocks with project information, drawing numbers, and revision control.',
    },
    {
      ...
      correctAnswer: 1,
      explanation:
        'AutoCAD Electrical is industry-standard professional software for schematic design.',
    },
    {
      ...
      options: [
        ...
        'Final installation records',
        'Warranty claims only',
      ],
      correctAnswer: 2,
      explanation:
        'As-built drawings record the final installation, including any deviations from original design.',
    },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 pb-24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Solar panel:</strong> Rectangle with diagonal
                    lines
                  </li>
                  <li>
                    • <strong className="text-white">Inverter:</strong> Rectangle with AC/DC
                    notation
                  </li>
                  <li>
                    • <strong className="text-white">DC isolator:</strong> Switch with DC marking
                  </li>
                  <li>
                    • <strong className="text-white">AC isolator:</strong> Switch with AC marking
                  </li>
                  <li>
                    • <strong className="text-white">Meter:</strong> Circle with M or kWh
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Power flow:</strong> Left to right, top to
                    bottom
                  </li>
                  <li>
                    • <strong className="text-white">Line types:</strong> Thick for power, thin for
                    control
                  </li>
                  <li>
                    • <strong className="text-white">Labels:</strong> Ratings and identifications
                  </li>
                  <li>
                    • <strong className="text-white">References:</strong> Grid refs for complex
                    drawings
                  </li>
                  <li>
                    • <strong className="text-white">Standards:</strong> IEC 60617 symbols
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <div className="space-y-2 text-sm">
                <p>
                  <strong className="text-elec-yellow">1.</strong> PV Array - Solar panels generate
                  DC electricity
                </p>
                <p>
                  <strong className="text-elec-yellow">2.</strong> DC Isolator - Safety isolation
                  near array
                </p>
                <p>
                  <strong className="text-elec-yellow">3.</strong> Inverter - DC to AC conversion
                </p>
                <p>
                  <strong className="text-elec-yellow">4.</strong> AC Isolator - AC side safety
                  isolation
                </p>
                <p>
                  <strong className="text-elec-yellow">5.</strong> Generation Meter - Measures PV
                  output
                </p>
                <p>
                  <strong className="text-elec-yellow">6.</strong> Distribution Board - Protection
                  and distribution
                </p>
                <p>
                  <strong className="text-elec-yellow">7.</strong> Loads/Export - Building
                  consumption or grid
                </p>
              </div>
            </div>
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <ul className="text-sm space-y-1">
                <li>
                  • <strong className="text-white">Inverter location:</strong> Accessible,
                  ventilated, protected
                </li>
                <li>
                  • <strong className="text-white">Meter placement:</strong> DNO accessible location
                </li>
                <li>
                  • <strong className="text-white">Isolator positioning:</strong> Visible for
                  emergency use
                </li>
                <li>
                  • <strong className="text-white">Cable routes:</strong> Shortest paths with
                  protection
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Generation meter:</strong> Total PV output
                  </li>
                  <li>
                    • <strong className="text-white">Export meter:</strong> Grid export
                  </li>
                  <li>
                    • <strong className="text-white">Import meter:</strong> Standard consumption
                  </li>
                  <li>
                    • <strong className="text-white">Net metering:</strong> Bidirectional
                  </li>
                  <li>
                    • <strong className="text-white">Smart meters:</strong> Remote reading
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm space-y-1">
                  <li>
                    • <strong className="text-white">Inverter monitoring:</strong> Built-in logging
                  </li>
                  <li>
                    • <strong className="text-white">String monitoring:</strong> Individual strings
                  </li>
                  <li>
                    • <strong className="text-white">Panel-level:</strong> Optimiser systems
                  </li>
                  <li>
                    • <strong className="text-white">Weather:</strong> Irradiance/temperature
                  </li>
                  <li>
                    • <strong className="text-white">Remote access:</strong> Cloud platforms
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="mb-8 mt-8">
          ...
          <div className="space-y-4 text-white/80 leading-relaxed">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <ul className="text-sm space-y-1">
                <li>
                  • <strong className="text-white">IEC 61730:</strong> PV module safety
                  qualification
                </li>
                <li>
                  • <strong className="text-white">IEC 62446:</strong> Grid-connected PV
                  documentation
                </li>
                <li>
                  • <strong className="text-white">BS 7909:</strong> Temporary electrical systems
                </li>
                <li>
                  • <strong className="text-white">MCS standards:</strong> Microgeneration
                  certification
                </li>
                <li>
                  • <strong className="text-white">DNO requirements:</strong> Network operator
                  specifications
                </li>
              </ul>
            </div>
            <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm space-y-1">
                <li>
                  • <strong className="text-white">Title blocks:</strong> Project info, drawing
                  number, revision
                </li>
                <li>
                  • <strong className="text-white">Drawing standards:</strong> Consistent line
                  weights, text sizes
                </li>
                <li>
                  • <strong className="text-white">Cross-references:</strong> Links to other
                  drawings
                </li>
                <li>
                  • <strong className="text-white">Approval signatures:</strong> Engineer and
                  checker
                </li>
              </ul>
            </div>
        ...
        <div className="flex justify-between items-center pt-6 border-t border-white/10">
          ...
          <Button
            ...
            asChild
          >
            <Link to="/electrician/upskilling/renewable-energy-module-2">Complete Module 2</Link>
          </Button>
        </div>
      </div>
    </div>
