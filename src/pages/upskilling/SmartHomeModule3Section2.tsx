...
const DESCRIPTION =
  'Programming lighting scenes and automated schedules for comfort and efficiency';
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      'Lights that frustrate users by changing unexpectedly',
      'Faster bulb wear',
      'Reduced Wi-Fi speed',
    ],
    correctIndex: 1,
    explanation:
      'Over-automation can lead to lights changing when users do not expect or want them to, creating frustration and undermining the user experience.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: [
      'Add as many automations as possible',
      'Ensure manual override is always available',
      'Hide all controls from users',
      'Use only time-based triggers',
    ],
    correctIndex: 1,
    explanation:
      'Always providing easy manual override ensures users can adjust lighting when automation does not match their current needs.',
  },
  {
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Manufacturer apps like the Philips Hue app or SmartThings app provide interfaces for creating, editing, and triggering lighting scenes.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Start with 4-6 core scenes per main living area: Morning, Day, Evening, Night, Entertainment, and Away. Add specialised scenes based on customer requests. Too many scenes become confusing.',
  },
  {
    question: 'Should schedules run locally or in the cloud?',
    answer:
      'Prefer local execution where possible. Local schedules continue working during internet outages. Check whether your hub supports local schedule execution.',
  },
  {
    question: 'How do I handle multi-user households with different preferences?',
    answer:
      'Create personal scenes for individual preferences and shared scenes for common activities. Use presence detection or manual selection to activate appropriate scenes.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-4xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-white text-sm">
              Pre-programmed multi-light configurations for different activities
            </p>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            <p className="text-sm font-medium text-elec-yellow mb-1">Schedules</p>
            <p className="text-white text-sm">
              Automated triggers based on time, events, or conditions
            </p>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <p className="text-white mb-4">
            A lighting scene is a saved configuration of multiple lights with specific brightness
            levels, colours, and on/off states. Activating a scene applies all these settings
          ...
          <div className="space-y-3 mb-4">
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Main lights off, bias lighting behind TV at 10% warm white, floor lamp at 5% dim
                amber. One tap transforms the room for watching films.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Example: Morning Scene</p>
              <p className="text-white text-sm">
                Kitchen lights at 80% cool white, bedroom lights gradually increasing over 15
                minutes, hallway at 50%. Helps wake up naturally.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Example: Away Scene</p>
              <p className="text-white text-sm">
                Randomised lights simulating occupancy, exterior lights on, interior lights cycling
                between rooms. Deters burglars while owners are away.
              </p>
            </div>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <p className="text-white text-sm">
              Name scenes based on activities (Movie, Dinner, Reading) rather than technical
              descriptions (Dim Warm Lights). This makes them intuitive for all household members.
            </p>
          </div>
        </section>
          ...
          <div className="space-y-4 mb-4">
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                Trigger at specific times regardless of other factors.
              </p>
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                Trigger in response to specific events or actions.
              </p>
              <ul className="text-white text-sm space-y-1 ml-4">
            ...
            <div className="p-4 rounded-lg bg-white/5 border border-white/10">
              ...
              <p className="text-white text-sm mb-2">
                Trigger based on environmental or system conditions.
              </p>
              <ul className="text-white text-sm space-y-1 ml-4">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-3">
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Transform entire room lighting with a single tap or voice command instead of
                adjusting each light individually.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Energy Efficiency</p>
              <p className="text-white text-sm">
                Automated schedules ensure lights turn off when not needed, reducing electricity
                consumption.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Away schedules simulate occupancy, making properties appear lived-in during
                vacations.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Circadian lighting schedules adjust colour temperature throughout the day,
        ...
        <section className="mb-10">
          ...
          <div className="space-y-3 mb-4">
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Interview customers about daily routines, activities, and preferences before
                creating scenes. Do not assume what they want.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Start Simple</p>
              <p className="text-white text-sm">
                Begin with a few essential scenes. Add complexity gradually based on feedback rather
                than overwhelming users from the start.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Always Provide Manual Override</p>
              <p className="text-white text-sm">
                Ensure users can easily override any automation. Frustration occurs when smart
                systems prevent manual control.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Test Thoroughly</p>
              <p className="text-white text-sm">
                Test scenes at different times of day and under various conditions. What looks good
                at night may be too dim during daytime.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-3">
            <div className="p-3 rounded-lg bg-white/5">
              ...
              <p className="text-white text-sm">
                Too many automated triggers can result in lights changing unexpectedly, frustrating
                users. Less is often more.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Conflicting Automations</p>
              <p className="text-white text-sm">
                Multiple automations affecting the same lights can fight each other. Document all
                automations and check for conflicts.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Ignoring Edge Cases</p>
              <p className="text-white text-sm">
                Night-time bathroom visits should not trigger daytime brightness. Consider all
                scenarios when programming schedules.
              </p>
            </div>
            <div className="p-3 rounded-lg bg-white/5">
              <p className="text-white font-medium mb-1">Poor Transition Design</p>
              <p className="text-white text-sm">
                Abrupt changes (instant on/off) can be jarring. Use gradual transitions for comfort,
                especially for evening and morning scenes.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="p-4 rounded-lg bg-white/5 border border-white/10">
            ...
            <p className="text-white text-sm mb-3">
              A family with young children wants smart lighting that works for parents' evening
              relaxation and children's bedtime routine.
            </p>
            <p className="text-white text-sm mb-2">
              <span className="text-elec-yellow">Recommended Scenes:</span>
            </p>
            <ul className="text-white text-sm space-y-1 ml-4">
              <li>
                <span className="font-medium">Bedtime:</span> Children's rooms dim warm white,
                landing nightlight on, main living areas unchanged
              </li>
              <li>
                <span className="font-medium">Evening:</span> Living room 40% warm white, kitchen
                off, landing nightlight on
              </li>
              <li>
                <span className="font-medium">Night Check:</span> Minimal hallway lighting for
                parents checking on children without fully waking
              </li>
            </ul>
            <p className="text-white text-sm mt-3">
              <span className="text-elec-yellow">Schedule:</span> Bedtime scene triggered at 7:30 PM
              weekdays, transitioning to Evening scene 30 minutes later.
            </p>
          </div>
        </section>
