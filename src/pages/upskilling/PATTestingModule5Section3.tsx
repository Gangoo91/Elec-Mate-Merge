...
const DESCRIPTION =
  'Learn how to create and maintain a comprehensive electrical equipment asset register for effective PAT testing management and compliance.';
...
const quickCheckQuestions = [
  {
    ...
    options: [
      ...
      'To identify and locate all testable equipment',
      'To record employee names',
      'To store warranty information only',
    ],
    correctIndex: 1,
    explanation:
      'The primary purpose is to identify, locate and track all portable appliances requiring testing to ensure none are missed.',
  },
  {
    id: 'm5s3-qc2',
    ...
    options: [
      'Random numbers',
      'Sequential with location prefix',
      'Manufacturer serial only',
      'Employee initials',
    ],
    correctIndex: 1,
    explanation:
      'Sequential numbers with location or department prefixes allow easy identification and organisation while maintaining uniqueness.',
  },
  {
    id: 'm5s3-qc3',
    ...
    correctIndex: 2,
    explanation:
      'Annual audits ensure the register remains accurate, capturing new equipment, disposals, and location changes.',
  },
];
...
const quizQuestions = [
  {
    ...
    options: [
      ...
      'Asset ID, description, location, and test status',
      'Only purchase price',
  ...
  },
  {
    ...
    options: [
      ...
      'Fast, accurate identification and reduced data entry errors',
      'They are colourful',
      'They are waterproof',
    ],
    correctAnswer: 1,
  },
  {
    ...
    options: [
      'Only register expensive items',
      'Conduct a comprehensive site walkthrough',
  ...
  },
  {
    ...
    options: [
      ...
      'Include in register and test before use',
      'Only test if it looks old',
      'Let the owner test it',
    ],
    correctAnswer: 1,
  },
  {
  ...
  },
  {
    ...
    options: [
      "Nothing - location doesn't matter",
      'Update the register with new location',
  ...
  },
  {
    ...
    options: [
      ...
      'Mark as disposed with date and retain record',
      'Ignore it',
  ...
  },
  {
    ...
    options: [
      'Haunted equipment',
      'Equipment in register but no longer exists',
      'New equipment',
      'Equipment on loan',
    ],
    correctAnswer: 1,
  ...
  },
  {
    ...
    options: [
      'Only annual review',
      'Purchase, transfer in, or discovery of unregistered items',
      'Only when testing',
      'Never - register is fixed',
    ],
    correctAnswer: 1,
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Assign your own unique asset ID using a sequential numbering system. Attach a permanent label with this ID to the equipment. Document the lack of manufacturer serial number in your records.',
  },
  {
    question: 'Should I include fixed appliances in the PAT register?',
    answer:
      'Fixed (hardwired) appliances are not portable and are typically covered by periodic fixed installation testing. However, you may include them in a general electrical equipment register for completeness.',
  },
  {
    question: 'How do I manage equipment shared between departments?',
    answer:
      "Assign a 'home' location for the equipment and track loans via a sign-out system. Alternatively, assign it to a 'shared equipment' category with defined custodian responsibility.",
  },
  {
    question: "What's the best way to handle new equipment entering the site?",
    answer:
      'Establish a process where all new equipment is registered before use. Include goods receiving in the process so equipment is captured at delivery. New items should be tested and labelled before deployment.',
  },
  {
    question: "Should contractors' equipment be in our register?",
    answer:
      "Contractors' equipment remains their responsibility. However, you should verify they have a testing regime and may record their test certificates. Your register should note contractor equipment is on-site but managed externally.",
  },
  {
    question: "How do I handle equipment that's rarely used?",
    answer:
      'Include all equipment in the register regardless of usage frequency. Rarely used equipment may actually need more attention as faults may go unnoticed. Test before use if left idle for extended periods.',
  },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8 space-y-8 pb-24">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              An asset register is a comprehensive database of all portable electrical equipment
              that requires PAT testing. It serves as the foundation of your testing programme,
              ensuring every item is identified, tracked, and tested at appropriate intervals.
            </p>

            <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-lg p-4">
              <h4 className="font-semibold text-elec-yellow mb-3">
                Core Functions of an Asset Register
              </h4>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              Creating a comprehensive asset register requires a systematic approach. The initial
              setup is the most time-consuming phase, but getting it right establishes a solid
              foundation for ongoing management.
            </p>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              Effective identification systems enable rapid equipment location and accurate record
              linking. The choice of system depends on organisation size, budget, and operational
              requirements.
            </p>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              An asset register is a living document that requires regular maintenance. Without
              ongoing management, it quickly becomes inaccurate and loses its value as a compliance
              tool.
            </p>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-white leading-relaxed">
            <p>
              Regular audits verify register accuracy and identify gaps. They ensure your testing
              programme covers all equipment and records remain reliable.
            </p>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-white/20">
                      <th className="text-left py-2 text-elec-yellow font-medium">Audit Type</th>
                      <th className="text-center py-2 text-elec-yellow font-medium">Frequency</th>
                  ...
                  <tbody className="text-white">
                    <tr className="border-b border-white/10">
                      ...
                      <td className="py-2">All equipment, all locations</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-2">Spot checks</td>
                      <td className="text-center py-2">Quarterly</td>
                      <td className="py-2">Random sample per department</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-2">Department review</td>
                      <td className="text-center py-2">As needed</td>
                      <td className="py-2">Following reorganisation or moves</td>
                    </tr>
                    <tr>
                      <td className="py-2">New equipment verification</td>
                      <td className="text-center py-2">Monthly</td>
                      <td className="py-2">Cross-check with procurement records</td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        <section className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
          <h2 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
            <Zap className="h-5 w-5 text-elec-yellow" /> Quick Reference: Asset Register Setup
          </h2>
          <div className="grid sm:grid-cols-2 gap-4 text-sm">
