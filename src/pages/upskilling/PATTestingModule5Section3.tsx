    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The register is the master list. Structure, the if-it\'s-not-on-the-register rule, hired
          and shared equipment, retiring assets, and integration with maintenance management.
        </p>
        ...
        >
          <p>
            ...
            every electrical item the duty holder is responsible for. The minimum useful column set:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Unique asset ID</strong> — the load-bearing column. One per physical item.
              Format is the duty holder\'s choice (e.g. EM-0001, IT-PRT-042) but the format must be
              stable across the lifetime of the register.
            </li>
            <li>
            ...
            <li>
              ...
              tracking. Not strictly required by IET CoP 5th Ed. Chapter 16, but commonly included.
            </li>
            <li>
              <strong>Equipment class</strong> — Class I, Class II, or Class III. Drives which tests
              apply (earth continuity is Class I only; insulation resistance and leakage differ
              across classes).
            </li>
            <li>
            ...
            <li>
              <strong>Next test due</strong> — calendar date. Drives scheduling and drift detection.
            </li>
            <li>
            ...
            <li>
              <strong>Link to test history</strong> — pointer / foreign key / file reference to the
              per-item test records.
            </li>
            <li>
        ...
        >
          <p>
            ...
            tester is given a list of items due for test, locates each, tests it, records the result
            against its asset ID. At the end of the round, the register shows everything tested. The
            duty holder gets a clean summary.
          </p>
          <p>
            The failure mode is also simple. Items are added to the workplace over time — casual
            purchases, employee bring-ins, project deliveries, hire returns, equipment moved between
            sites. Without an explicit process for adding new items to the register, those items
            never appear on a tester\'s list, and so never get tested. The register and the physical
            reality drift apart.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              hire-in status; returned equipment is logged out (and the register row either archived
              or, for items the duty holder owns, kept as ACTIVE under a new location).
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Hired equipment (short-term):</strong> verify the hire firm\'s in-service test
              certificate on receipt. If the certificate is acceptable (in date, from a competent
              test regime, with numerical results), accept it and log the row as ON HIRE IN with the
              hire reference and dates. If not acceptable, re-test and log normally. On return, mark
              the row HIRE RETURNED with date.
            </li>
            <li>
              <strong>Loaned equipment (between businesses):</strong> handle as for hired, except
              the loan agreement should explicitly cover the test status of the equipment and where
              the records live during the loan period.
            </li>
            <li>
              <strong>
                Shared equipment (between sites or departments within the same duty holder):
              </strong>{' '}
              the register row carries a current-location field that is updated when the item moves.
              Test history follows the item, not the location.
            </li>
            <li>
              <strong>Personal equipment (employees bringing their own kit):</strong> two acceptable
              policies. (a) Personal equipment is permitted, in which case it is tested by the duty
              holder, labelled, and registered — extending the regime over it. (b) Personal
              equipment is prohibited, in which case the policy is documented, communicated, and
              enforced. An undocumented &ldquo;we don\'t test those&rdquo; is a gap.
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Unique:</strong> never re-used. When an item is disposed, its ID retires with
              it; new items get new IDs. Re-using IDs creates audit confusion years later.
            </li>
            <li>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              failure, end of life, redundancy. The reason is recorded. Authorisation (typically the
              responsible department / line manager) is recorded.
            </li>
            <li>
              <strong>Physical disposal.</strong> The equipment leaves the workplace via the
              appropriate route (WEEE recycling, donation, scrapping). For failed items, the plug is
              typically cut off as a final safeguard against re-use.
            </li>
            <li>
            ...
            <li>
              ...
              typically at least 6 years post-disposal, longer where the item was incident- involved
              or where sector retention is longer.
            </li>
          </ol>
          <p>
            The register grows over time. Rows accumulate as new items come in and old items go out.
            Filter by status when working live (ACTIVE, QUARANTINED, ON HIRE IN), and by full
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              with a fail outcome and creates a fault ticket — repair workflow, retest workflow, or
              disposal workflow.
            </li>
            <li>
          ...
          <p>
            ...
            transcription point and a drift source. With integration the asset register is a living
            management tool rather than a backwards-looking record. For estates above a few hundred
            items, the integration earns its keep within months.
          </p>
        </ConceptBlock>
