  ...
  return (
    <HubPage>
      <HubMasthead
        ...
        backTo="/electrician/upskilling/pat-testing-module-1"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The phrase 'PAT testing' is shorthand. The reality is in-service inspection and testing of
          electrical equipment — a documented, risk-based regime that discharges EAWR Reg 4(2) and
          HSWA s.2 duties. Stickers do not evidence compliance; programmes do.
        </p>
        ...
        >
          <p>
            The IET Code of Practice for In-service Inspection and Testing of Electrical Equipment
            (5th Edition, 2020) is the document the trade is actually following when it says "PAT".
            The CoP scope covers equipment connected to a fixed installation by flexible cable, plug
            and socket, or by spur — equipment that is moved, repositioned, or whose location is
            fluid in normal use. The IET CoP deliberately uses the verbose phrase because the term
            "PAT" undersells what is being done.
          </p>
          <p>
            HSE HSG107 ("Maintaining portable and transportable electrical equipment", 4th Edition)
            is the regulator's view of how to discharge the underlying statutory duty. HSG107 is
            guidance, not law — but in any HSE investigation or civil claim, it is the benchmark the
            duty-holder will be measured against. Diverging from HSG107 is permissible if the
            alternative produces equivalent or better risk control; diverging from it without
            evidence is the opposite of defensible.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong className="text-elec-yellow">HSWA 1974 s.2(1)</strong> — every employer shall
              ensure, so far as is reasonably practicable, the health, safety and welfare at work of
              all employees. The over-arching civil and criminal duty.
            </li>
            <li>
              <strong className="text-elec-yellow">EAWR 1989 Reg 4(2)</strong> — system maintenance
              to prevent danger. The electrical-specific application of HSWA. This is the regulation
              that "PAT" most directly discharges.
            </li>
            <li>
              <strong className="text-elec-yellow">PUWER 1998 Reg 5</strong> — work equipment shall
              be maintained in efficient working order and good repair, with a maintenance log where
              appropriate.
            </li>
            <li>
          ...
          <p>
            ...
            you do PAT?" — it is "did you have a system that satisfies HSWA s.2 / EAWR Reg 4(2), and
            can you show the records that prove it?". The IET CoP and HSG107 are the measuring
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              place at fixed intervals. The frequency of inspection and testing should be determined
              by the duty-holder, taking into account the type of equipment, how often and how it is
        ...
        >
          <p>
            BS 7671 Reg 110.1.1 is explicit about its scope. It applies to the design, erection and
            verification of electrical installations — and stops there. Items connected via a 13 A
            plug or a 16 A / 32 A industrial connector and intended to be moved in normal use fall
            outside Reg 110.1.1 and inside the IET CoP.
          </p>
          <p>
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              EICR (Chapter 65), Reg 134 "good workmanship". Tests are continuity, IR, polarity, Zs,
              RCD, prospective fault current — all on the fixed installation.
            </li>
            <li>
            ...
            <li>
              ...
              condition is increasingly inspected under the broader CoP umbrella as "transportable"
              or "fixed equipment" — the IET CoP §3.1 covers this and gives test guidance specific
              to fixed appliances.
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <p>
            The records side of the user-check pillar is light: a poster, a toolbox-talk attendance
            log, a "fault report" route (sticker, email, in-app) that produces an auditable record
            of what users found and what was done about it. That last line — what was done about it
            — is what differentiates a real programme from a theoretical one.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              The presence and legibility of equipment markings — class symbol, voltage, current, IP
              rating, manufacturer
            </li>
          </ol>
          <p>
            The visual inspection alone resolves the majority of defects HSG107 §40 attributes to
            in-service portable equipment — the bulk of which are flex damage, plug top damage, and
            incorrect fuse ratings. A combined inspection-and-test that does not include a formal
            visual is effectively skipping the test step that finds most faults.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              A formal visual inspection should be carried out at intervals which are appropriate to
              the type of equipment and the environment in which it is used. The formal visual
              inspection should be carried out by a person who is competent to do so. The inspection
              should not require the dismantling of the equipment.
            </>
          }
        ...
        >
          <p>
            The combined inspection and test is the activity at the heart of what most engineers do.
            The IET CoP Chapter 14 prescribes the test sequence, the acceptance values, and the
            order of tests. The headline tests are:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
            ...
            <li>
              <strong>Insulation resistance</strong> — measured at 500 V dc between live conductors
              and earth (Class I) or between live conductors and any accessible conductive part
              (Class II). Pass &ge; 1 MΩ for portable equipment with heating element &ge; 3 kW; &ge;
              1 MΩ general; check IET CoP §15.5 for category-specific values.
            </li>
            <li>
          ...
          <p>
            The combined inspection-and-test step generates the numerical evidence (continuity, IR,
            leakage values) that supports the pass/fail. A pass label without underlying numerical
            readings is not what HSG107 §22 calls a record — it is a claim.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            HSG107 §22-25 makes records the practical demonstration of compliance. The records that
            matter:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Equipment register / asset list</strong> — every item in scope, with a unique
              ID, location, owner, class, rating, and acquisition history.
            </li>
            <li>
              <strong>Risk assessment</strong> — the reasoning behind the frequency assigned to each
              equipment class. References the environment, user, history, and IET CoP Table 7.1
              starting point. Reviewed and revised, with version history.
            </li>
            <li>
        ...
        >
          <p>
            The HSE has long published that around a quarter of all reportable workplace electrical
            accidents involve portable equipment of some kind. The dominant defect categories —
            drawn from HSG107 commentary and the IET CoP introduction — are:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
            ...
            <li>
              <strong>Class I PE-continuity loss</strong> — the protective conductor at the plug or
              at the equipment terminal becoming open or high-resistance.
            </li>
            <li>
              <strong>Insulation breakdown</strong> — moisture or dust ingress, mechanical puncture,
          ...
          <p>
            Pillar 1 (user checks) and pillar 2 (formal visual) together catch the majority of these
            — most are visible. Pillar 3 (combined inspection and test) catches the rest,
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              <strong>The user</strong> performs pillar 1 user checks, reports defects, and does not
              use equipment they have reason to suspect is unsafe.
            </li>
            <li>
          ...
          <p>
            ...
            user know what to check? Did the engineer record the right things? Each role is a place
            where the trail can fail — and most failed cases fail at the duty-holder's role because
            that is where the system either exists or does not.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              the health, safety and welfare at work of all his employees. The matters to which that
              duty extends include, in particular, the provision and maintenance of plant and
              systems of work that are, so far as is reasonably practicable, safe and without risks
              to health.
            </>
          }
        ...
        >
          <p>
            Module 2 then moves to the equipment-classification framework — Class I, Class II, Class
            III — which is the foundation for every test method that follows in Modules 3 and 4. By
            the end of Module 1, the framing is: what is the legal duty, what equipment is in scope,
            how often, and by whom. That is the programme.
          </p>
        </ConceptBlock>
