...
const DESCRIPTION =
  "Learn what PAT testing involves, why it's essential for workplace safety, and understand the comprehensive scope of portable appliance testing across different sectors.";
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'PAT stands for Portable Appliance Testing - the routine inspection and testing of electrical appliances to ensure they are safe to use.',
  },
  {
    id: 'pat-purpose',
    ...
    correctIndex: 1,
    explanation:
      'The primary purpose of PAT testing is to prevent electrical accidents by identifying faulty appliances before they can cause harm to users.',
  },
  {
    id: 'pat-approach',
    ...
    correctIndex: 2,
    explanation:
      'PAT testing involves both thorough visual inspection and electrical testing. Visual checks identify obvious damage, while electrical tests verify safety parameters.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'PAT testing frequency depends on factors including equipment class, usage intensity, environmental conditions, and user competence - ranging from daily checks to several years.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'PAT testing is essential to prevent electrical accidents, fires, and electrocution by identifying faulty appliances before they can cause harm to users.',
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'PAT testing is required across multiple sectors including offices, construction sites, schools, healthcare, and any workplace using portable electrical equipment.',
  },
  {
    id: 4,
    question: 'What does a comprehensive PAT testing programme include?',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'The main electrical tests in PAT are earth continuity testing (for Class I appliances) and insulation resistance testing (for all appliance classes).',
  },
  {
    id: 6,
    question: 'How often should PAT testing typically be carried out?',
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Detailed PAT testing records demonstrate due diligence, prove legal compliance, and provide essential documentation for insurance and regulatory purposes.',
  },
  {
    id: 8,
    ...
    correctAnswer: 1,
    explanation:
      'Insulation breakdown poses the greatest risk as it can lead to electric shock, electrocution, and electrical fires - all preventable through proper PAT testing.',
  },
  {
    id: 9,
    ...
    correctAnswer: 1,
    explanation:
      'Multiple environmental factors including moisture, dust, heat, chemical exposure, and physical abuse can accelerate equipment degradation and create safety hazards.',
  },
  {
    id: 10,
    ...
    correctAnswer: 1,
    explanation:
      'The primary goal is comprehensive safety management: preventing accidents, protecting people, ensuring legal compliance, and reducing liability exposure.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'PAT testing applies to portable electrical equipment that can be moved or connected to different locations. This includes office equipment (computers, printers), kitchen appliances (kettles, microwaves), power tools, extension leads, and any device with a plug that connects to the mains supply.',
  },
  {
    question: 'Is PAT testing a legal requirement?',
    answer:
      "While PAT testing isn't explicitly named in UK legislation, it's widely recognised as an effective way to comply with the Electricity at Work Regulations 1989 (EAWR) and PUWER. These laws require employers to maintain electrical equipment in a safe condition.",
  },
  {
    question: 'How often should equipment be PAT tested?',
    answer:
      'Testing frequency depends on the equipment type, usage intensity, and environment. Construction site tools may need testing every 3 months, office equipment annually, and IT equipment in controlled environments every 2-4 years. Risk assessment guides frequency.',
  },
  {
    question: 'Can anyone perform PAT testing?',
    answer:
      "PAT testing should be carried out by a competent person with appropriate training and understanding of electrical safety. While formal qualifications aren't legally required, proper training ensures accurate testing and correct interpretation of results.",
  },
  {
    question: 'What happens if equipment fails a PAT test?',
    answer:
      'Failed equipment must be immediately removed from service and labelled as unsafe. It should either be repaired by a competent person and retested, or disposed of safely. Never allow failed equipment to be used, even temporarily.',
  },
  {
    question: "What's the difference between visual inspection and electrical testing?",
    answer:
      "Visual inspection checks for obvious damage like frayed cables, cracked casings, or damaged plugs. Electrical testing uses specialised equipment to measure earth continuity, insulation resistance, and other safety parameters that aren't visible to the eye.",
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>PAT:</strong> Portable Appliance Testing
              </li>
              <li>
                <strong>Purpose:</strong> Prevent electrical accidents
              </li>
              <li>
                <strong>Method:</strong> Visual inspection + electrical testing
              </li>
              <li>
                <strong>Scope:</strong> All portable electrical equipment
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Equipment with plugs, cables, portable devices
              </li>
              <li>
                <strong>Use:</strong> Systematic safety checks, documentation
              </li>
              <li>
                <strong>Apply:</strong> Risk-based testing frequencies
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              PAT testing is a systematic safety methodology for electrical appliances that could be
              moved or connected to different locations. It combines systematic visual inspection
              with precise electrical measurements to identify potential hazards before they cause
              harm.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-2">
                Key characteristics of PAT testing:
              </p>
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Systematic approach:</strong> Regular, scheduled testing using
                  standardised procedures
                </li>
                <li>
                  <strong>Preventive measure:</strong> Identifies faults before they cause accidents
                </li>
                <li>
                  <strong>Documentation:</strong> Creates audit trail for compliance evidence
                </li>
                <li>
                  <strong>Risk management:</strong> Forms part of comprehensive electrical safety
                  strategy
                </li>
                <li>
                  <strong>Legal compliance:</strong> Demonstrates due diligence under EAWR and PUWER
                </li>
              </ul>
            </div>
            ...
            <div className="my-6">
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                Equipment requiring PAT testing:
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              PAT testing combines two complementary inspection methods to provide comprehensive
              safety assurance. Both stages are essential for thorough equipment assessment.
            </p>
            ...
            <p className="text-sm text-elec-yellow/70">
              <strong>Important:</strong> Visual inspection alone identifies approximately 95% of
              faults, but electrical testing catches hidden dangers that could cause serious harm.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              <div>
                <p className="text-sm font-medium text-white mb-2">
                  Safety Risks Without PAT Testing
                </p>
                <ul className="text-sm text-white space-y-1">
            ...
            <div className="my-6">
              ...
              <ul className="text-sm text-white space-y-2 ml-4">
                <li>
                  <strong>Normal wear and tear:</strong> Regular use causes gradual deterioration of
                  cables, plugs, and internal components through thermal cycling and mechanical
                  stress.
                </li>
                <li>
                  <strong>Environmental damage:</strong> Moisture, dust, heat, and chemical exposure
                  accelerate equipment degradation significantly.
                </li>
                <li>
                  <strong>User damage:</strong> Incorrect handling, dropping equipment, and pulling
                  cables cause immediate or progressive damage.
                </li>
                <li>
                  <strong>Manufacturing defects:</strong> Even new equipment may contain latent
                  defects that manifest over time.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm font-medium text-elec-yellow mb-2">
                Cost-Benefit Example: 200 Employee Office
              </p>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Setting Up a PAT Programme
              </h3>
              <ul className="text-sm text-white space-y-1 ml-4">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Missing equipment</strong> — ensure all portable appliances are included
                  in the register
                </li>
                <li>
                  <strong>Inconsistent testing</strong> — stick to scheduled frequencies
                </li>
                <li>
                  <strong>Poor documentation</strong> — records must be complete and accessible
                </li>
                <li>
                  <strong>Untrained testers</strong> — competence is essential for valid results
                </li>
              </ul>
            </div>
          </div>
