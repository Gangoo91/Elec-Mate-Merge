...
const BS7671ExamGuide = () => {
  const keyTopics = [
    {
      ...
      weight: '20-25%',
      details:
        'TN-S, TN-C-S, TT systems. Know the differences, applications, and Zs values for each system.',
    },
    {
      topic: 'Protection Devices',
      weight: '15-20%',
      details:
        'RCDs, MCBs, AFDDs, SPDs. Understand selection criteria, ratings, and installation requirements.',
    },
    {
      topic: 'Cable Selection & Sizing',
      weight: '15-20%',
      details:
        'Current carrying capacity, grouping factors, ambient temperature corrections, and voltage drop calculations.',
    },
    {
      topic: 'Testing & Inspection',
      weight: '15-20%',
      details:
        'Test sequences, acceptable values, and certification requirements including EIC and EICR.',
    },
    {
      topic: 'Special Locations',
      weight: '10-15%',
      details:
        'Bathrooms (701), Swimming pools (702), Agricultural premises (705), and EV charging (722).',
    },
    {
  ...
  const examTechniques = [
    {
      ...
      description:
        'Use the index first, then contents page. Keep finger bookmarks on frequently used sections during the exam.',
    },
    {
      technique: 'Strategic Time Allocation',
      description:
        "Spend 30 seconds reading, 60 seconds finding info, 30 seconds answering. If you can't find it quickly, move on and return later.",
    },
    {
      technique: 'Cross-Reference Following',
      description:
        "When a regulation references another (e.g., 'see 543.1'), follow it immediately - don't assume you know the answer.",
    },
    {
      technique: 'Table Reading Method',
      description:
        'Use a ruler or finger to trace rows/columns in complex tables. Check footnotes before finalising answers.',
    },
    {
      technique: 'Question Keywords',
      description:
        "Circle keywords like 'maximum', 'minimum', 'appropriate' - they guide you to specific values or regulations.",
    },
  ];
  ...
  const lastWeekPrep = [
    ...
    },
    {
      day: '5 Days Before',
      tasks: [
        'Focus on calculations practice',
        'Review Amendment 2 changes',
        'Test regulation navigation speed',
      ],
    },
    {
      day: '3 Days Before',
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <div className="px-4 sm:px-6 py-8 sm:py-12 max-w-4xl mx-auto">
        <div className="space-y-8">
          {/* Header */}
          <div>
            <h1 className="text-2xl font-bold text-white mb-4">BS 7671 Exam Success Guide</h1>
            ...
            <Alert className="border-yellow-400/30 bg-yellow-400/10 mb-6">
              ...
              <AlertDescription className="text-white">
                <strong>Open Book Exam:</strong> You can use BS 7671, IET Guidance Notes, and the
                On-Site Guide during the exam. Success depends on navigation speed and knowing where
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    <li className="text-white">
                      <span className="text-white font-mono">411.3.2</span> - Maximum Zs values
                    </li>
                    <li className="text-white">
                      <span className="text-white font-mono">411.4.5</span> - RCD requirements
                    </li>
                    <li className="text-white">
                      <span className="text-white font-mono">415.1</span> - Fault protection
                    </li>
                    <li className="text-white">
                      <span className="text-white font-mono">543.1</span> - Protective conductor
                      sizing
                    </li>
                    <li className="text-white">
                      <span className="text-white font-mono">531.2</span> - Device selection
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    <li className="text-white">
                      <span className="text-white font-mono">433.1</span> - Overload protection
                    </li>
                    <li className="text-white">
                      <span className="text-white font-mono">525.1</span> - Cable voltage drop
                    </li>
                    <li className="text-white">
                      <span className="text-white font-mono">522.6</span> - Current carrying
                      capacity
                    </li>
                    <li className="text-white">
                      <span className="text-white font-mono">433.2</span> - Ring final circuits
                    </li>
                    <li className="text-white">
                      <span className="text-white font-mono">314.1</span> - Circuit division
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    ...
                    <li className="text-white">
                      <span className="text-white font-mono">651.1</span> - Periodic inspection
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <CardContent>
              <div className="space-y-6">
                <Alert className="border-yellow-400/30 bg-yellow-400/10">
                  <BookOpen className="h-4 w-4 text-yellow-400" />
                  <AlertDescription className="text-white">
                    Use different coloured tabs for different types of information. Suggested
                    system: <span className="text-yellow-400">Yellow</span> for tables,{' '}
                    <span className="text-yellow-400">Blue</span> for calculations,{' '}
                    <span className="text-green-400">Green</span> for testing,{' '}
                    <span className="text-red-400">Red</span> for special locations.
                  </AlertDescription>
                </Alert>
                ...
                <div className="bg-card/50 p-4 rounded-lg">
                  <h4 className="text-lg font-semibold text-yellow-400 mb-2">
                    Pro Tip: Finger Bookmarks
                  </h4>
                  <p className="text-gray-400 text-sm">
                    During the exam, keep your finger in the index page and use your other hand to
                    navigate. This saves precious seconds when you need to look up multiple
                    regulations quickly.
                  </p>
                </div>
              </div>
            ...
            <CardContent className="space-y-4">
              {lastWeekPrep.map((day, index) => (
                <div key={index} className="flex gap-4">
                  <Badge
                    variant="outline"
                    className="border-yellow-400 text-yellow-400 min-w-[100px] justify-center"
                  >
                    {day.day}
                  </Badge>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Maximum time per question including lookup and answering
                </p>
              </div>
              <div>
