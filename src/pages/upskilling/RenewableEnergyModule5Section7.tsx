...
export default function RenewableEnergyModule5Section7() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 5 · Section 7 · BS 7671:2018+A4:2026 · Chapter 57 + PAS 63100:2024 + BS EN IEC 62485"
        title="Installation, commissioning & ventilation"
        backTo="../renewable-energy-module-5"
      />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Siting (PAS 63100:2024 + Chapter 57), thermal effects (Reg 570.6.3), DC cabling (BS EN
          50618), Type B RCD (Reg 712.411.3.2.1.2), warning notices (Reg 570.6.8.201 / .202),
          commissioning per BS EN IEC 62485 + Part 6 IR testing, and the customer handover pack.
        </p>
        ...
        <Pullquote>
          Install is where the topology drawing meets a brick wall, a manufacturer pack and a
          customer doorbell. Get the boring steps right and the cert evidence bundle writes itself.
        </Pullquote>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Integral garage, wall-mounted</strong> — the most
              common UK 2025-26 location. Non-combustible backboard, manufacturer clearance,
              ventilation per the spec sheet. Customer keeps full vehicle access; BESS is out of the
              way
            </li>
            <li>
              <strong className="text-white">Utility room / plant room</strong> — common where there
              is no garage. Manufacturer clearance to washing machine / dryer / boiler often the
              constraining factor. Local building control may add comments
            </li>
            <li>
              <strong className="text-white">External enclosure</strong> — required where no
              internal space is available; manufacturer must explicitly support external siting
              (most LFP packs are IP rated for it but check). Add temperature management for UK
              winter (LFP loses ~10-15% capacity at 0 °C)
            </li>
            <li>
              <strong className="text-white">Loft</strong> — PAS 63100:2024 generally restrictive.
              Manufacturer permission usually required. Accessibility for service is a key
              constraint. Avoid where alternative sites exist
            </li>
            <li>
              <strong className="text-white">Habitable rooms</strong> — generally precluded.
              Customer who pushes for a bedroom / living-room BESS gets the PAS 63100 conversation
              early
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Workshop / industrial unit</strong> — BESS often sized
              20-100 kWh; fire strategy usually allows external siting with appropriate separation,
              or internal in dedicated battery / plant room with active suppression
            </li>
            <li>
              <strong className="text-white">Office / retail</strong> — fire strategy typically
              restrictive on interior siting; external IP-rated enclosure on customer curtilage is
              the common answer
            </li>
            <li>
              <strong className="text-white">Multi-occupancy (flats with shared services)</strong> —
              fire strategy frequently involves shared escape routes; BESS siting in any space
              affecting escape requires explicit fire-engineering sign-off
            </li>
            <li>
              <strong className="text-white">Agricultural</strong> — often externally sited; the
              fire strategy must account for stored fuels / chemicals nearby, with separation
              distances per BS EN IEC 62485 series
            </li>
            <li>
              <strong className="text-white">Cert evidence bundle</strong> — index into the fire
              strategy document, the suppression / separation arrangement, and any third-party fire
              engineer sign-off
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">LFP (UK 2025-26 default)</strong> — natural ventilation
              per manufacturer clearance; thermal management is the binding constraint; no gassing
              hazard under normal operation
            </li>
            <li>
              <strong className="text-white">NMC</strong> — similar ventilation pattern to LFP under
              normal operation; higher thermal-runaway energy density means the spacing and
              fire-rated separation requirements tighten
            </li>
            <li>
              <strong className="text-white">Flooded lead-acid (legacy off-grid)</strong>— hydrogen
              gassing during charge requires forced ventilation per BS EN IEC 62485-2; DSEAR zone
              classification applies; spark-free lighting / switchgear in the zone
            </li>
            <li>
              <strong className="text-white">Sealed VRLA / gel</strong> — limited gassing under
              normal operation; natural ventilation usually adequate; manufacturer spec sheet drives
              the numbers
            </li>
            <li>
              <strong className="text-white">Reg 570.5.1(j) external influences</strong>— ambient
              temperature, humidity, corrosive atmospheres all factor in; UK garage installs in
              winter and rural agricultural sites in summer are the two common edges
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Reg 570.6.8.201</strong> — at the consumer unit / DB
              that the battery supplies. Where multiple DBs are involved, each gets its own notice.
              The notice indicates BESS presence AND location (so the next electrician knows where
              to find the kit and where to isolate)
            </li>
            <li>
              <strong className="text-white">Reg 570.6.8.202</strong> — at EVERY point of access to
              the battery room or enclosure. A garage wall BESS with front cover access: one notice.
              A battery room with two doors: two notices. Example wording from the regulation:
              "BATTERY - Live parts can remain energized after isolation"
            </li>
            <li>
              <strong className="text-white">Exception — fire strategy plans</strong>
              provide BESS locations to fire and rescue services and operational personnel: the
              location detail can be omitted from the warning notice under Reg 570.6.8.201 (the
              plans fulfil that requirement); the presence detail still required
            </li>
            <li>
              <strong className="text-white">Format</strong> — durable, weather- resistant if
              external; lettering legible under normal lighting at expected reading distance;
              manufacturer-supplied labels usually meet this
            </li>
            <li>
              <strong className="text-white">Documentation</strong> — cert evidence bundle records
              the notice positions with photographs at handover. A missing notice three years later
              is then traceable to a customer-removed event, not an install omission
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              ...
              manufacturer-supplied where possible; BS EN 50618 cable + manufacturer lugs +
              manufacturer torque where bespoke. Cross-section sized for worst-case DC current per
              the C-rate from Section 5.6
            </li>
            <li>
              <strong className="text-white">PV array → PCE DC</strong> — already covered by Section
              712; BS EN 50618 is the typical choice. Reg 712.433.103 covers the protection of PV
              array cable; the PV side of the DC bus follows Section 712 even on a BESS install
            </li>
            <li>
              <strong className="text-white">Routing</strong> — short, direct, in conduit /
              trunking, segregated from AC compartments (Section 5.5). Label every DC cable at both
              ends — function, polarity, voltage, isolator reference
            </li>
            <li>
              <strong className="text-white">Reg 570.6.1.2.1 — DC earthing</strong>
              permitted (not required) provided at least simple separation between AC and DC sides.
              Most modern hybrids are transformerless → no simple separation → DC NOT earthed; DC
              functional bonding per manufacturer
            </li>
            <li>
              <strong className="text-white">BS EN 13636 / BS EN 15112</strong>
              referenced (NOTE to Reg 570.6.1.2.2) for DC earth corrosion guidance where earthing IS
              done — typically lead-acid legacy systems with explicit separation
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Cost</strong> — Type B is 3-5× more expensive than Type
              AC / A. This is a real budget line on the quote
            </li>
            <li>
              <strong className="text-white">Position</strong> — usually as a Type B RCBO on the
              dedicated CU way feeding the inverter’s AC port. Some installers fit a Type B
              main-incomer RCD; this is overkill for the BESS and creates cross-tripping risks for
              the rest of the install
            </li>
            <li>
              <strong className="text-white">Exception — manufacturer declaration</strong> — some
              isolated-topology hybrids ship with a declaration that they cannot feed DC fault
              current; Type AC / A then allowed. Read the declaration carefully; KEEP it
            </li>
            <li>
              <strong className="text-white">EICR consequence</strong> — wrong RCD type on a
              transformerless hybrid without manufacturer declaration is a Code C2 (potential
              danger) finding. Common defect on retrofit installs where the original PV inverter was
              a small transformer-isolated unit and the new BESS hybrid is transformerless
            </li>
            <li>
              <strong className="text-white">Three-phase</strong> — same principle, 4-pole Type B
              RCD on three-phase hybrid inverters. Cost penalty larger; worth confirming
              manufacturer position on declaration at quote stage
            </li>
          </ul>
        </ConceptBlock>
        ...
        <ContentEyebrow>
          Commissioning — Part 6 + BS EN IEC 62485 + BMS + baseline capacity
        </ContentEyebrow>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">1. Visual + dead-test</strong> — Part 6 schedule of
              inspections walk-through; AC continuity (ring final continuity if applicable); IR test
              at 500 V DC on the AC final circuit (Reg 643.3.1 / .2 — 1 MΩ minimum per Table 64 for
              circuits up to 500 V)
            </li>
            <li>
              <strong className="text-white">2. Reg 643.3.3 follow-up</strong> — after connecting
              the inverter at the AC final-circuit termination, IR test at 250 V DC between live
              conductors and CPC, 1 MΩ minimum
            </li>
            <li>
              <strong className="text-white">3. Manufacturer DC commissioning</strong>— per the BESS
              / inverter pack. Typically: DC polarity check, DC voltage check at each port,
              manufacturer-defined DC IR procedure (NOT the same as Part 6 IR procedure on AC),
              torque verification with calibrated tool
            </li>
            <li>
              <strong className="text-white">4. BMS configuration</strong> — deep- discharge cut-off
              voltage, charge profile, discharge profile, comms link to inverter (Modbus / CAN),
              Wi-Fi to manufacturer cloud, time zone, tariff window (if applicable)
            </li>
            <li>
              <strong className="text-white">5. Baseline capacity test</strong> — full charge from
              grid (or AC supply if hybrid), then controlled discharge to manufacturer-defined
              end-state, with cell-level voltage logging via BMS. The Ah / kWh result is the
              BASELINE that future EICR capacity tests compare against
            </li>
            <li>
              <strong className="text-white">6. RCD tests</strong> — operate / trip-time test on the
              Type B RCD per Part 6 (Reg 643.7.1) — but use a Type B-capable RCD tester; some older
              test instruments only handle Type AC / A
            </li>
            <li>
              <strong className="text-white">7. Final SoR + customer walkthrough</strong> — sign
              Schedule of Inspections + Schedule of Test Results; complete EIC; walk customer
              through the handover pack (next ConceptBlock)
            </li>
          </ul>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[13.5px] text-white/85 leading-relaxed">
            <li>
              <strong className="text-white">Identity</strong> — manufacturer / model / chemistry /
              serial numbers of inverter and battery; nameplate kWh / usable kWh /
              delivered-to-loads kWh figures (Section 5.6)
            </li>
            <li>
              <strong className="text-white">Reg 570.5.1 rationale</strong> — the ten-factor
              walk-through with the customer’s actual figures, especially (d) generation profile,
              (e) coupling mode, (g) C-rate / DoD, (h) load profile + cycling target
            </li>
            <li>
              <strong className="text-white">Topology drawing</strong> — SLD showing the four
              families (Section 5.5) chosen here, with Reg 570.6.5.201 isolator schedule and
              locations labelled
            </li>
            <li>
              <strong className="text-white">Protection picture</strong> — RCD type (Type B with
              reference to BS EN 62423, or Type AC / A with manufacturer declaration attached), CU
              way assignments, schedule of test results for Part 6
            </li>
            <li>
              <strong className="text-white">Commissioning results</strong> — manufacturer DC
              commissioning checklist signed; BMS configuration parameters (deep-discharge cut-off,
              charge / discharge profile); baseline capacity test result (the future-EICR-reference
              number)
            </li>
            <li>
              <strong className="text-white">Notices</strong> — Reg 570.6.8.201 (CU level) and Reg
              570.6.8.202 (each point of access) positions, with handover-day photographs
            </li>
            <li>
              <strong className="text-white">Customer-facing</strong> — BMS app login credentials,
              manufacturer cloud account, warranty registration confirmation, EPS scope walkthrough
              (if EPS — which circuits work in island mode, which don’t), tariff (if applicable) and
              the charge / discharge schedule programmed
            </li>
            <li>
              <strong className="text-white">Index into bundle</strong> — Section 712 PV pack (where
              PV present), Chapter 57 BESS pack, Chapter 82 PEI pack, fire strategy reference
              (non-dwellings)
            </li>
          </ul>
        </ConceptBlock>
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/renewable-energy-module-5-section-8')}
