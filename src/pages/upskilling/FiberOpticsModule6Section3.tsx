...
const DESCRIPTION =
  'Learn how to calculate optical loss budgets, understand length limitations, connector and splice loss allowances, and ensure your fibre installation meets performance requirements.';

const quickCheckQuestions = [
  {
    question:
      'What is the typical loss allowance for a mated SC connector pair in a loss budget calculation?',
    options: [
    ...
    explanation:
      'TIA-568 standards allow 0.5 dB maximum loss per mated connector pair for loss budget calculations. Field terminations should achieve better than this, but the budget uses worst-case values.',
  },
  {
    question:
      'If OM3 multimode fibre has an attenuation of 3.5 dB/km at 850nm, what is the loss for a 300m run?',
    options: [
    ...
    explanation:
      'Fibre loss = Length (km) × Attenuation (dB/km). So 0.3 km × 3.5 dB/km = 1.05 dB. Always convert metres to kilometres before calculating.',
  },
  {
    ...
    explanation:
      "The safety margin accounts for future repairs requiring additional splices, fibre ageing, temperature effects, possible connector degradation, and any unforeseen losses over the system's lifetime.",
  },
];
...
const quizQuestions = [
  {
    ...
    explanation:
      'Total link loss = Fibre attenuation loss + All connector pair losses + All splice losses + Safety margin. This total must be less than the available power budget.',
  },
  {
    ...
    explanation:
      'OS2 singlemode fibre has a maximum attenuation of 0.35 dB/km at 1310nm and 0.22 dB/km at 1550nm. These low values enable long-distance transmission.',
  },
  {
    ...
    explanation:
      'Fusion splices typically achieve 0.1 dB or less loss. Loss budgets use this value, though actual measured losses are often better (0.02-0.05 dB).',
  },
  {
    question:
      'A link has 4 connector pairs and 2 fusion splices. What is the total connection loss allowance?',
    options: [
    ...
    explanation:
      'Connection loss = (4 × 0.5 dB connectors) + (2 × 0.1 dB splices) = 2.0 dB + 0.2 dB = 2.2 dB total.',
  },
  {
    ...
    options: [
      ...
      {
        text: 'The difference between transmitter output power and receiver sensitivity',
        isCorrect: true,
      },
    ...
    explanation:
      'Power budget = Transmitter output power (dBm) - Receiver sensitivity (dBm). This gives the maximum allowable loss in dB that the link can tolerate.',
  },
  {
    question:
      'If a transmitter outputs -3 dBm and the receiver sensitivity is -23 dBm, what is the power budget?',
    options: [
    ...
    explanation:
      'Power budget = -3 dBm - (-23 dBm) = -3 + 23 = 20 dB. This is the maximum loss the system can handle while maintaining communication.',
  },
  {
    question:
      'What is the maximum channel length for OM4 multimode fibre at 10 Gigabit Ethernet (850nm)?',
    options: [
    ...
    explanation:
      'OM4 supports 10GbE up to 400m at 850nm. This is limited by modal dispersion rather than attenuation. OM3 supports 300m for the same application.',
  },
  {
    question:
      'Why are multimode fibre length limits often determined by bandwidth rather than attenuation?',
    options: [
      { text: 'Multimode fibre has very high attenuation', isCorrect: false },
      {
        text: 'Modal dispersion causes signal spreading that limits data rates over distance',
        isCorrect: true,
      },
    ...
    explanation:
      'In multimode fibre, different modes travel at slightly different speeds (modal dispersion), causing pulses to spread and overlap. This limits the distance more than attenuation at high data rates.',
  },
  {
    ...
    options: [
      ...
      {
        text: 'Channel includes equipment cords; permanent link tests only installed cabling',
        isCorrect: true,
      },
    ...
    explanation:
      'Channel testing includes equipment cords and patch leads (end-to-end). Permanent link testing excludes these, testing only the installed infrastructure. Both have different loss limits.',
  },
  {
    question:
      'What typical safety margin should be included in a loss budget for a critical telecommunications link?',
    options: [
    ...
    explanation:
      "A 3 dB safety margin is standard for most installations. This accounts for future repairs, ageing, temperature variations, and any unforeseen degradation over the system's lifetime.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Loss budgets use worst-case (maximum) values to ensure the link will work reliably under all conditions. Using typical values might result in links that work initially but fail after temperature changes, ageing, or when a connector is remated. Standards specify maximum allowable values specifically for this purpose.',
  },
  {
    question: 'Can I use measured loss values instead of calculated budgets?',
    answer:
      'Measured values are essential for certification but the calculated loss budget remains important for design. You should first calculate the budget to verify the design is feasible, then test to confirm actual performance. If measured losses significantly exceed calculations, investigate for problems.',
  },
  {
    question: 'How does temperature affect fibre loss?',
    answer:
      'Temperature variations can increase fibre attenuation, particularly at extreme cold or hot temperatures. Macrobending effects can also worsen with temperature as cable jackets expand or contract. Standard loss budgets include temperature effects within the safety margin.',
  },
  {
    question: 'What happens if my link loss exceeds the power budget?',
    answer:
      "If link loss exceeds the power budget, the receiver won't get enough signal to operate correctly. Options include: reducing the number of connections, using lower-loss components, using fibre with lower attenuation, or specifying transceivers with higher power output or better receiver sensitivity.",
  },
  {
    question: 'Why are singlemode fibre distance limits much longer than multimode?',
    answer:
      'Singlemode fibre has both lower attenuation (0.35 dB/km vs 3.5 dB/km) and no modal dispersion because only one mode propagates. This allows distances of tens of kilometres compared to hundreds of metres for multimode at high data rates.',
  },
  {
    question: 'What is modal bandwidth and how does it affect distance?',
    answer:
      'Modal bandwidth (measured in MHz·km) indicates how much data can be transmitted over distance before modal dispersion degrades the signal. Higher bandwidth ratings (OM3: 2000 MHz·km, OM4: 4700 MHz·km at 850nm) allow longer distances at high data rates.',
  },
];
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white/80 mb-6">
              <p>
                ...
                expected losses in the link (fibre attenuation, connector losses, splice losses)
                against the available power margin (transmitter power minus receiver sensitivity).
              </p>
              <p>
                Loss budget calculations are essential during the design phase—before any cable is
                installed. They ensure the proposed design will work and identify any potential
            ...
            <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 p-4 rounded-r-lg mb-6">
              ...
              <p className="text-white/70 text-sm">
                ...
                If your calculated link loss exceeds the available power budget, the link will not
                work reliably and the design must be modified.
              </p>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white/80 mb-6">
              <p>
                ...
                your specific fibre type and operating wavelength.
              </p>
            </div>
            ...
            <div className="bg-[#252525] rounded-lg p-5 border border-white/10 mb-6">
              <h4 className="font-semibold text-white mb-4">
                Multimode Fibre Attenuation (Maximum)
              </h4>
            ...
            <div className="bg-[#252525] rounded-lg p-5 border border-white/10 mb-6">
              <h4 className="font-semibold text-white mb-4">
                Singlemode Fibre Attenuation (Maximum)
              </h4>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white/80 mb-6">
              <p>
                ...
                losses should be better than these values.
              </p>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white/80 mb-6">
              <p>
                ...
                maximum loss a link can tolerate while still functioning correctly.
              </p>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white/80 mb-6">
              <p>
                ...
                distance) and <strong className="text-white">bandwidth</strong> (signal spreads over
                distance due to dispersion). For multimode fibre at high data rates, bandwidth is
            ...
            <div className="bg-[#252525] rounded-lg p-5 border border-white/10 mb-6">
              <h4 className="font-semibold text-white mb-4">
                Multimode Fibre Distance Limits (850nm)
              </h4>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-white/80 mb-6">
              <p>
                ...
                <strong className="text-white">permanent link</strong> (installed infrastructure
                only, excluding equipment patch cords).
              </p>
            </div>
