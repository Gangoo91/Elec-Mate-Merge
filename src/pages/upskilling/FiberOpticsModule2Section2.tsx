...
const DESCRIPTION =
  'Master OM1-OM5 multimode and OS1/OS2 singlemode fibre classifications. Understand bandwidth capabilities, transmission distances, and specification selection for UK installations.';
...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 0,
    explanation:
      'OM stands for Optical Multimode, referring to multimode fibre classifications from OM1 to OM5.',
  },
  {
    id: 'fo-m2s2-qc2',
    ...
    correctIndex: 3,
    explanation:
      'OM5 (wideband multimode) has the highest modal bandwidth at 28,000 MHz.km at 953nm, designed for wavelength division multiplexing.',
  },
  {
    id: 'fo-m2s2-qc3',
    ...
    correctIndex: 1,
    explanation:
      'OS2 is low water peak fibre with reduced attenuation at 1383nm, enabling full spectrum transmission including CWDM wavelengths.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'OM1 is the only multimode grade with a 62.5um core. All other OM grades use 50um.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'The water peak is increased attenuation at ~1383nm caused by hydroxyl (OH) ions absorbed during manufacturing.',
  },
  {
    id: 7,
...
const faqs = [
  {
    ...
    answer:
      'While physically possible, mixing OM grades is strongly discouraged. The lowest grade determines the link performance. For example, connecting OM4 to OM2 will limit the entire link to OM2 bandwidth specifications. Always use consistent grades throughout a link for predictable performance.',
  },
  {
    question: 'Why is OM1 being phased out of new installations?',
    answer:
      'OM1 (62.5um core) cannot reliably support 10 Gigabit Ethernet over meaningful distances. Its larger core causes excessive modal dispersion with modern VCSEL laser sources. New standards focus on OM3-OM5 grades which support 10G, 40G, and 100G applications.',
  },
  {
    question: 'How do I identify fibre grade from cable markings?',
    answer:
      'Look for the OM or OS designation printed on the cable jacket. Jacket colour provides guidance: orange typically indicates OM1/OM2, aqua indicates OM3/OM4/OM5, and yellow indicates singlemode. However, always verify with cable markings as colour alone is not definitive.',
  },
  {
    question: 'Is OS2 always better than OS1?',
    answer:
      'For new installations, yes. OS2 has lower attenuation, supports all wavelengths including CWDM, and is designed for both indoor and outdoor use. The cost difference is negligible, so OS2 is the standard choice for modern singlemode installations.',
  },
  {
    question: 'What is the practical difference between OM4 and OM5?',
    answer:
      "OM4 and OM5 perform identically at single 850nm wavelength. OM5's advantage is its extended wavelength support (850-953nm) for SWDM applications, enabling 100G and 400G transmission over 4 wavelengths on a single fibre pair. If not using SWDM, OM4 is equally suitable.",
  },
  {
    question: 'How far can I run 10 Gigabit Ethernet on each OM grade?',
    answer:
      'Maximum distances for 10GBASE-SR: OM1 = 33m, OM2 = 82m, OM3 = 300m, OM4 = 400m, OM5 = 400m. These are based on IEEE 802.3 standards using 850nm VCSEL sources. Actual distances may vary based on link quality.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-4xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>OM:</strong> Optical Multimode (OM1-OM5)
              </li>
              <li>
                <strong>OS:</strong> Optical Singlemode (OS1-OS2)
              </li>
              <li>
                <strong>Higher number:</strong> Better performance
              </li>
              <li>
                <strong>Modern:</strong> OM3+ and OS2 for new installs
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Orange:</strong> OM1/OM2 (legacy)
              </li>
              <li>
                <strong>Aqua:</strong> OM3/OM4 (current)
              </li>
              <li>
                <strong>Lime:</strong> OM5 (wideband)
              </li>
              <li>
                <strong>Yellow:</strong> OS1/OS2 (singlemode)
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The OM (Optical Multimode) and OS (Optical Singlemode) classification system
              standardises fibre optic cable specifications for consistent procurement and
              installation. Defined in ISO/IEC 11801 and EN 50173, these standards ensure
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                OM grades define the <strong>modal bandwidth</strong> of multimode fibre - how much
                data can travel through the cable. OS grades define the <strong>attenuation</strong>{' '}
                of singlemode fibre - how much signal is lost over distance. Both enable engineers
                to calculate maximum transmission distances.
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              OM1 and OM2 represent the legacy multimode fibre grades, originally designed for LED
              light sources. While still encountered in existing installations, these grades are no
              longer recommended for new deployments due to limited bandwidth for modern
              applications.
            </p>

            <div className="my-6">
              <p className="text-sm font-medium text-white mb-3">
                OM1 Specifications (62.5/125um):
              </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
              <p className="text-sm font-medium text-red-400 mb-2">
                Important: Core Size Difference
              </p>
              <p className="text-sm text-white">
                OM1 has a 62.5um core while OM2-OM5 all have 50um cores. Connecting 62.5um to 50um
                fibre causes significant insertion loss (~3dB) due to core size mismatch. Always
                verify core size when working with legacy installations.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Core:</strong> 50um
                  </li>
                  <li>
                    <strong>EMB @850nm:</strong> 2000 MHz.km
                  </li>
                  <li>
                    <strong>10GBASE-SR:</strong> 300m
                  </li>
                  <li>
                    <strong>40G/100G:</strong> 100m
                  </li>
                  <li>
                    <strong>Jacket:</strong> Aqua
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li>
                    <strong>EMB @850nm:</strong> 4700 MHz.km
                  </li>
                  <li>
                    <strong>10GBASE-SR:</strong> 400m
                  </li>
                  <li>
                    <strong>40G/100G:</strong> 150m
                  </li>
                  <li>
                    <strong>Jacket:</strong> Aqua
                  </li>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                OM3 and OM4 use Effective Modal Bandwidth (EMB) rather than older overfilled launch
                (OFL) measurements. EMB more accurately represents performance with laser sources by
                measuring bandwidth under conditions that simulate actual VCSEL launch
                characteristics.
              </p>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                For most new multimode installations, OM4 is recommended over OM3. The cost premium
                is typically 15-25% but provides 33% greater 10GbE distance and 50% greater
                40/100GbE distance. This future-proofs the installation for bandwidth upgrades.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              shortwave wavelength division multiplexing (SWDM). Unlike previous grades, OM5
              maintains bandwidth performance across an extended wavelength range from 850nm to
              953nm.
            </p>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                Shortwave Wavelength Division Multiplexing uses four wavelengths (850nm, 880nm,
                910nm, 940nm) on a single fibre pair to achieve 100Gbps (4x25G) or 400Gbps (4x100G)
                transmission. This enables high bandwidth over existing duplex cabling
                infrastructure.
              </p>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
              ...
              <p className="text-sm text-white">
                OM5 fibre carries a 50-100% cost premium over OM4. Unless SWDM deployment is
                planned, OM4 provides equivalent single-wavelength performance at lower cost. OM5
                adoption remains limited primarily to data centres with specific roadmaps for 100G+
                SWDM transmission.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              The OS (Optical Singlemode) grades classify singlemode fibre based on attenuation
              performance and intended application. Unlike multimode grades which focus on
              bandwidth, singlemode fibre has effectively unlimited bandwidth - the limiting factor
              is signal attenuation over distance.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li>
                    <strong>Core:</strong> 9um
                  </li>
                  <li>
                    <strong>Max atten. @1310nm:</strong> 1.0 dB/km
                  </li>
                  <li>
                    <strong>Max atten. @1550nm:</strong> 1.0 dB/km
                  </li>
                  <li>
                    <strong>Construction:</strong> Tight-buffered
                  </li>
                  <li>
                    <strong>Application:</strong> Indoor premises
                  </li>
                </ul>
              </div>
              <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li>
                    <strong>Max atten. @1310nm:</strong> 0.4 dB/km
                  </li>
                  <li>
                    <strong>Max atten. @1550nm:</strong> 0.4 dB/km
                  </li>
                  <li>
                    <strong>Water Peak:</strong> Low (LWP)
                  </li>
                  <li>
                    <strong>Application:</strong> All applications
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <p className="text-sm text-white">
                The water peak refers to increased attenuation at approximately 1383nm caused by
                hydroxyl (OH) ions absorbed during fibre manufacturing. This affects CWDM systems
                using wavelengths in the 1360-1460nm range. OS2's low water peak (LWP) specification
                ensures consistent low attenuation across all wavelengths from 1310nm to 1625nm.
              </p>
            </div>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Selecting the correct fibre grade requires matching the specification to the
              application's bandwidth requirements, transmission distances, and budget constraints.
            </p>

            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              <p className="text-sm font-medium text-elec-yellow mb-2">
                Jacket Colour Identification
              </p>
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>Orange:</strong> OM1 / OM2 Multimode
                </li>
                <li>
                  <strong>Aqua:</strong> OM3 / OM4 Multimode
                </li>
                <li>
                  <strong>Lime Green:</strong> OM5 Wideband Multimode
                </li>
                <li>
                  <strong>Yellow:</strong> OS1 / OS2 Singlemode
                </li>
            ...
            <div className="my-6 p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
              ...
              <ul className="text-sm text-white space-y-1">
                <li>
                  <strong>1G to 100m:</strong> OM3, OM4, or OS2
                </li>
                <li>
                  <strong>10G to 300m:</strong> OM3 minimum, OM4 recommended
                </li>
                <li>
                  <strong>40G/100G to 150m:</strong> OM4 minimum
                </li>
                <li>
                  <strong>100G SWDM:</strong> OM5 required
                </li>
                <li>
                  <strong>Any distance &gt;500m:</strong> OS2 singlemode
                </li>
                <li>
                  <strong>Outdoor/campus:</strong> OS2 singlemode
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 p-4 rounded-lg bg-red-500/10 border-l-2 border-red-500/50">
              ...
              <p className="text-sm text-white">
                Never rely solely on jacket colour for grade identification. Always verify by
                reading the cable marking printed on the outer jacket. Markings will include
                manufacturer, cable type, fibre count, and the OM or OS grade designation.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="text-sm text-white space-y-1 ml-4">
                <li>
                  <strong>Assuming all orange fibre is the same</strong> (OM1 vs OM2 core size
                  differs)
                </li>
                <li>
                  <strong>Connecting 62.5um to 50um fibre</strong> (causes ~3dB loss)
                </li>
                <li>
                  <strong>Using OM1/OM2 for new 10GbE installations</strong> (insufficient distance)
                </li>
                <li>
                  <strong>Specifying OM5 without SWDM deployment plans</strong> (unnecessary cost)
                </li>
              </ul>
            </div>
          </div>
