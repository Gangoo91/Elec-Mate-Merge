...
const quizQuestions = [
  ...
  {
    id: 4,
    question: 'Per BS EN 50171/50172, what recovery (recharge) requirement applies after a duration test?',
    options: [
  ...
  {
    id: 10,
    question: 'BS 5266-1 emphasises consistency in test scheduling. What does that mean for a maintenance contractor?',
    options: [
