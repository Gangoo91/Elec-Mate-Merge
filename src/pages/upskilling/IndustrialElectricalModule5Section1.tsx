...
const quickCheckQuestions = [
  {
    id: 'qc-fault-1',
    question:
      'When using the half-split technique on a 10-stage control circuit, how many tests would you typically need to locate a fault?',
    options: ['10 tests', '5 tests', '3-4 tests', '1 test'],
    correctIndex: 2,
    explanation:
      'The half-split technique works on a binary search principle. For 10 stages, you would need approximately log2(10) = 3-4 tests to isolate the fault. Each test eliminates half of the remaining circuit, making it far more efficient than sequential testing.',
  },
  {
    id: 'qc-fault-2',
    question:
      'According to GS38, what is the maximum exposed metal probe tip length for test leads used on live systems?',
    options: ['10mm', '4mm', '2mm', '6mm'],
    correctIndex: 2,
    explanation:
      'GS38 specifies a maximum 2mm exposed probe tip to minimise the risk of accidental short circuits and arc flash when testing live equipment. The probes should also be fused and have finger guards positioned to prevent accidental contact with live parts.',
  },
  {
    id: 'qc-fault-3',
    ...
    options: [
      'The coil resistance',
      'Control voltage is present at the coil terminals',
      'The contact condition',
      'Motor winding resistance',
    ],
    correctIndex: 1,
    explanation:
      'Always verify that control voltage is actually reaching the component before condemning it. Many "faulty" contactors are actually fine - the problem lies upstream in the control circuit. This systematic approach prevents unnecessary parts replacement and identifies the true root cause.',
  },
];
...
const IndustrialElectricalModule5Section1: React.FC = () => {
  ...
  useSEO({
    ...
    description:
      'Master systematic fault-finding methodology, half-split technique, circuit diagram interpretation, safe testing procedures, and time-saving troubleshooting strategies for industrial electrical systems.',
    keywords: [
    ...
    <div className="bg-background text-foreground">
      ...
      <main className="max-w-3xl mx-auto px-4 py-6 space-y-8">
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground leading-relaxed">
              Effective fault-finding is not about luck or intuition alone - it requires a
              structured approach that minimises diagnostic time while maximising safety. The
              systematic methodology follows a logical sequence that experienced maintenance
              electricians apply instinctively.
            </p>
            ...
            <div className="bg-background/50 rounded-lg p-4 border border-white/10">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-4">
                  <div className="bg-elec-yellow text-background w-8 h-8 rounded-full flex items-center justify-center font-bold flex-shrink-0">
                    1
                  </div>
                  <div>
                    <h4 className="font-semibold text-foreground">Gather Information</h4>
                    <p className="text-muted-foreground text-sm">
                      Interview operators, review alarm logs, check maintenance history, note any
                      recent changes or work carried out
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Identify what works and what does not work. This immediately narrows down the
                      search area
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Review circuit diagrams, operation manuals, and identify the relevant circuits
                      before testing
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Develop a logical test sequence, starting with the most likely causes and
                      safest access points
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Perform tests in sequence, recording results. Use the half-split method to
                      efficiently isolate fault location
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      After repair, test the system thoroughly. Document the fault, cause, and
                      repair for future reference
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Rushing to test without gathering information first wastes time. Five minutes
                    spent talking to the operator can save an hour of unnecessary testing. The
                    operator often holds the key clue - "It was working fine until..." is valuable
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground leading-relaxed">
              The half-split (or binary search) technique is the most efficient method for locating
              faults in series circuits. Instead of testing each component sequentially from start
              to finish, you test at the midpoint to eliminate half the circuit with each
              measurement.
            </p>
              ...
              <div className="space-y-4">
                <div className="bg-background/50 rounded-lg p-4">
                  <p className="text-muted-foreground mb-3">
                    Consider a control circuit with 8 series components (switches, contacts, etc.).
                    The fault causes an open circuit - the contactor will not energise.
                  </p>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3 bg-background/50 p-3 rounded-lg">
                    <div className="bg-elec-yellow text-background w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0">
                      1
                    </div>
                    <div>
                      <p className="text-foreground font-medium">
                        Test at midpoint (between 4 and 5)
                      </p>
                      <p className="text-muted-foreground text-sm">
                        Voltage present = fault is in components 5-8. No voltage = fault is in 1-4
                      </p>
                      <p className="text-green-400 text-sm mt-1">
                        Result: Voltage present - fault in right half
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 bg-background/50 p-3 rounded-lg">
                    ...
                    <div>
                      <p className="text-foreground font-medium">
                        Test at midpoint of right half (between 6 and 7)
                      </p>
                      <p className="text-muted-foreground text-sm">
                        Now testing components 5-8 only
                      </p>
                      <p className="text-green-400 text-sm mt-1">
                        Result: No voltage - fault in 5-6
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 bg-background/50 p-3 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Final test to isolate the faulty component
                      </p>
                      <p className="text-green-400 text-sm mt-1">
                        Result: Voltage present at input of 5, no voltage at output = Component 5 is
                        faulty
                      </p>
                    </div>
                  </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground leading-relaxed">
              When production is stopped and management is asking for updates, the pressure to
              diagnose quickly can lead to mistakes. Developing a systematic approach to circuit
              diagram interpretation helps maintain accuracy under stress.
            </p>
            ...
            <div className="bg-background/50 rounded-lg p-4 border border-white/10">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-elec-yellow pl-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Find L and N (or +/-) rails first. Note the voltage - this tells you what
                    readings to expect. Control circuits typically run at 24V DC, 24V AC, 110V AC,
                    or 230V AC.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-elec-yellow pl-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Follow the circuit from supply, through all series components, to the load, and
                    back to neutral. Every component in this path must be working for the load to
                    operate.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-elec-yellow pl-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Auxiliary contacts are cross-referenced to their main device. If contact K1/2
                    does not close, check why contactor K1 is not energised - the problem may be in
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Physically trace the circuit path with your finger on the diagram. This prevents
                    your eye from jumping across the page and missing components. Mark your starting
                    point and trace slowly. For complex diagrams, use a highlighter to mark the
            ...
            <div className="bg-background/50 rounded-lg p-4 border border-white/10">
              <h3 className="font-semibold text-foreground mb-3">
                Common Diagram Symbols Reference
              </h3>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground leading-relaxed">
              Test equipment is your primary diagnostic tool, but incorrect use can damage
              equipment, give false readings, or cause serious injury. Understanding GS38
              requirements and proper test procedures is essential for safe and accurate
              fault-finding.
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-red-400">
                    GS38 Compliant Test Equipment Requirements
                  </h4>
                  <ul className="text-muted-foreground text-sm mt-2 space-y-1">
                    ...
                    <li>
                      - Category rating appropriate for application (CAT III/IV for industrial)
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-4 bg-background/50 p-4 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Test your proving unit on a known live source to confirm it is working
                      correctly
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4 bg-background/50 p-4 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Test all conductors to earth and between phases/poles to confirm dead
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4 bg-background/50 p-4 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Test again on the known live source to confirm the proving unit did not fail
                      during testing
                    </p>
                  </div>
                </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground leading-relaxed">
              Understanding the logical sequence of control circuits helps predict expected states
              and identify where the logic breaks down. This is particularly important when
              troubleshooting complex automated systems with multiple interlocks and sequences.
            </p>
              ...
              <div className="space-y-4">
                <div className="bg-background/50 p-4 rounded-lg">
                  ...
                  <p className="text-muted-foreground text-sm mb-2">
                    All conditions must be true for the output to energise. Common in safety
                    circuits where multiple guards must be closed.
                  </p>
                ...
                <div className="bg-background/50 p-4 rounded-lg">
                  ...
                  <p className="text-muted-foreground text-sm mb-2">
                    Any one condition being true will energise the output. Common for multiple start
                    stations or alternative triggers.
                  </p>
                  <div className="bg-background/80 p-2 rounded text-center font-mono text-sm text-muted-foreground">
                ...
                <div className="bg-background/50 p-4 rounded-lg">
                  ...
                  <p className="text-muted-foreground text-sm mb-2">
                    The output is blocked when the condition is true. Used for stops, trips, and
                    interlocks.
                  </p>
                  <div className="bg-background/80 p-2 rounded text-center font-mono text-sm text-muted-foreground">
            ...
            <div className="bg-background/50 rounded-lg p-4 border border-white/10">
              <h3 className="font-semibold text-foreground mb-4">
                Sequence Analysis Example: Star-Delta Starter
              </h3>
                ...
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <div className="flex-1 bg-blue-500/10 p-2 rounded">
                    ...
                    <span className="text-muted-foreground">
                      {' '}
                      Main + Star contactors energise, timer starts
                    </span>
                  </div>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <div className="flex-1 bg-green-500/10 p-2 rounded">
                    ...
                    <span className="text-muted-foreground">
                      {' '}
                      Motor accelerates at reduced voltage (58%)
                    </span>
                  </div>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <div className="flex-1 bg-amber-500/10 p-2 rounded">
                    ...
                    <span className="text-muted-foreground">
                      {' '}
                      Timer times out, Star drops, Delta energises
                    </span>
                  </div>
                </div>
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <div className="flex-1 bg-green-500/10 p-2 rounded">
                    ...
                    <span className="text-muted-foreground">
                      {' '}
                      Motor runs at full voltage, full speed
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 p-3 bg-orange-500/10 border border-orange-500/30 rounded">
                <p className="text-sm text-muted-foreground">
                  ...
                  If the motor starts but never transitions to delta, check: 1) Timer operation, 2)
                  Star contactor auxiliary contact (must open to allow delta), 3) Delta contactor
                  coil, 4) Interlock between star and delta.
                </p>
              </div>
            </div>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    When fault-finding PLC-controlled systems, use the programming software to
                    monitor I/O status live. If an input shows ON but the field device is clearly
                    OFF (or vice versa), you have found a wiring or input card fault. If logic shows
                    output ON but the load does not operate, the fault is between the PLC output and
                    the load.
                  </p>
                </div>
              </div>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-elec-yellow/5 border-l-2 border-elec-yellow/50 rounded-r-lg p-4 space-y-4">
            <p className="text-muted-foreground leading-relaxed">
              Experience teaches that certain faults occur repeatedly. Knowing the common failure
              points for different equipment types allows you to check the most likely causes first,
              significantly reducing diagnostic time.
            </p>
              ...
              <div className="space-y-4">
                <div className="bg-background/50 p-4 rounded-lg">
                  ...
                  <ol className="text-muted-foreground text-sm mt-2 space-y-1 list-decimal list-inside">
                    <li>
                      Check overload trip flag/indicator - reset if tripped (investigate cause)
                    </li>
                ...
                <div className="bg-background/50 p-4 rounded-lg">
                  ...
                  <ol className="text-muted-foreground text-sm mt-2 space-y-1 list-decimal list-inside">
                    <li>
                      Check all terminations for tightness - loose connections are the top cause
                    </li>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    80% of faults are caused by 20% of possible causes. In industrial settings, the
                    most common causes are: loose connections, worn contacts, tripped protective
                    devices, blown fuses, and failed sensors. Always check these first before
