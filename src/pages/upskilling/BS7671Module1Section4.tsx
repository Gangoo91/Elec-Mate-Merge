...
export default function BS7671Module1Section4() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 4 · Updated for A4:2026"
      ...
      <HubBody>
        <div className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'Cross-cutting overview of every substantive change in BS 7671:2018+A4:2026 — additions, amendments, deletions and model-form impact. Each item links to the module that covers it in depth.'
          }
        </div>
        ...
        >
          <p>
            ...
            previous edition — BS 7671:2018+A2:2022+Corrigendum (May 2023)+A3:2024 — remains current
            alongside A4 until 15 October 2026, at which point it is withdrawn. The transition
            window allows ongoing projects designed under A3 to complete; any new design started
            after 15 October 2026 must comply with A4. <AmendmentBadge regs={['A4:2026']} />
          </p>
          <p>
        ...
        >
          ...
          <p>
            ...
            practice; A4 makes it the only compliant route for new dwelling lighting circuits. On a
            CU change in an existing dwelling, the lighting circuit must come back onto a 30 mA RCD
            or RCBO. There is no equivalent unconditional requirement in non-domestic premises —
        ...
        >
          <p>
            ...
            411.3.2 cannot be achieved — typically because the source has limited prospective fault
            current. Examples: small inverters supplying a discrete circuit, DC-side PV,
            ...
            source-side current limitation. The designer documents which alternative was chosen and
            why on the EIC. <AmendmentBadge regs={['419']} />
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            failure mode amplified by the conductive vehicle body — a person in contact with the car
            body and any earthed surface (drainage grate, garden tap, garage floor rebar) becomes
            the fault path. Compliant routes: (a) split N and PE before the EV circuit (TN-S
            configuration), typically with an open-PEN protection device; (b) apply one of the
            alternative protective measures in Section 722 — e.g. separate earth electrode taking
            the EV onto a TT-like island. <AmendmentBadge regs={['722.312.2.1']} />
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            <AmendmentBadge regs={['Chapter 57']} />. Covered in Module 5. BESS, PV+battery hybrid,
            off-grid hybrid systems. Excludes batteries inside product-safety-standard equipment
            (UPSs, central emergency-lighting power supplies — those remain governed by their
            product standards).
          </p>
          <p>
            <strong className="text-white">Chapter 81 — Energy efficiency</strong>{' '}
            <AmendmentBadge regs={['Chapter 81']} />. Covered in Module 8. Promoted from the deleted
            informative Appendix 17 to a normative Part 8 chapter. References the Building
          ...
          <p>
            ...
            functional equipotential bonding for information and communication technology equipment
            (broadcast, comms, server-room ICT). Specifies minimum CSA, identification, electrical
            continuity and combined PE+FE conductor requirements. Replaces what previously sat as
            scattered guidance across BS 7671 and BS EN 50310.
          </p>
          <p>
            ...
            balanced data cabling — cameras, access points, lighting controls, displays. References
            BS EN 50173-1 and BS EN IEC 62368-3. The first time PoE is brought formally inside BS
            7671.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            <AmendmentBadge regs={['411.3.3']} />. Scope tightened to socket-outlets up to 32 A. The
            documented-risk-assessment exception is constrained to category (b) (other-location,
            non-domestic, not BA1/BA2). Categories (a) ordinary-person sockets and (c) outdoor
            mobile equipment cannot be excepted under any circumstance. The skilled person
            (electrically) signing the assessment must be named on the EIC.
          </p>
          <p>
            ...
            circuits supplying socket-outlets and luminaires in higher-fire-risk locations and those
            with sleeping accommodation (HMOs, care homes, student accommodation, timber-frame
            buildings, wooden-flooring buildings). A documented risk-based exception route exists
            outside dwellings. The Schedule of Test Results gains AFDD column 30.
          </p>
          <p>
            <strong className="text-white">Reg 461.2 — PEN switching absolute prohibition</strong>{' '}
            <AmendmentBadge regs={['461.2']} />. Pre-A4 the wording was scattered and could be read
            permissively in edge cases. A4 redrafted to a clean, single-sentence prohibition: no
            switching or isolating device shall be inserted in a PEN conductor on a TN-C or TN-C-S
            system. That includes main switches, isolators, fuses, links and disconnectors.
          </p>
          <p>
            ...
            final circuits. Type F for high-frequency residual on VSDs / inverter-driven appliances.
            Type B for smooth DC residual on three-phase VSDs, EV without integral 6 mA DC, larger
            PV / battery hybrids.
          </p>
          <p>
            <strong className="text-white">
            ...
            <AmendmentBadge regs={['551.7.1']} />. New indents (c) and (d). (c) requires a suitable
            protective device where energy flow is bidirectional. (d) prohibits connecting a
            parallel source to the load side of an RCD under specified conditions. Pairs with the
            new Section 530.3.201.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            DELETED. Pre-A4 the CRL formula was an alternative to the risk-classification approach
            for deciding when SPDs were required. A4 simplifies: <RegBadge>443.4.1</RegBadge> risk
            classification is now the single route. <AmendmentBadge regs={['443.5']} />
          </p>
          <p>
            <strong className="text-white">Annex A443 — informative SPD examples</strong> — DELETED.
            Content was already drifting out of date relative to BS EN 61643 product standards;
            rather than maintain a parallel set of examples, A4 removes the annex.
          </p>
          <p>
        ...
        >
          <p>
            ...
            the model-form additions. Every EIC / EICR you generate from 15 April 2026 onwards needs
            to reflect:
          </p>
          <ul className="list-disc pl-5 space-y-1.5">
            <li>
              ...
              — protective neutral bonding now recognised distinct from PME (Reg 312.2.1.1 gained a
              PNB figure under A4).
            </li>
            <li>
              <strong className="text-white">
            ...
            <li>
              <strong className="text-white">Maximum permitted Zs column</strong> in circuit details
              — design-time Zs value carried alongside the measured value, so the inspector can see
              the design margin at a glance.
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">Maximum demand (kVA / A)</strong> field — design value
              documented per board, supporting cable-size and OPD-rating verification.
            </li>
            <li>
              <strong className="text-white">Section D safety alerts and product recalls</strong>{' '}
              disclaimer — protects the inspector from being deemed to have certified product-level
              safety the manufacturer has subsequently flagged.
            </li>
            <li>
            ...
            <li>
              <strong className="text-white">FI no longer unsatisfactory</strong> — Appendix 6 rule
              change. FI observations no longer automatically force an unsatisfactory report.
            </li>
          </ul>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            <li>
              <strong className="text-white">C1 — danger present</strong>: real, present-day hazard
              requiring immediate action. Edition mismatch alone is rarely C1; C1 is reserved for
              live exposed metalwork, broken CPC, fire damage.
            </li>
            <li>
              <strong className="text-white">C2 — potentially dangerous</strong>: a reasonable fault
              scenario produces a dangerous condition. Example: pre-A4 dwelling lighting circuit on
              an MCB without RCD, with damaged metal-bodied luminaires or BA2 occupants present —
              the absence of 30 mA RCD becomes load-bearing.
            </li>
            <li>
            ...
            <li>
              ...
              inspector cannot complete the assessment of a particular item (e.g. cannot access the
              back of a board, cannot determine the supply earthing arrangement). Under A4, FI no
              longer automatically forces an unsatisfactory report.
            </li>
          </ul>
          <p>
            Reference the in-force edition (A4:2026) on the cover page as the basis of assessment.
            Where a pre-A4 deviation is coded C3, name the regulation and explain the recommendation
            in plain English in the observations field.
          </p>
        </ConceptBlock>
        ...
        >
          <ul className="list-disc pl-5 space-y-1.5">
            ...
            <li>
              ...
              312.2.1.1 PNB figure, Reg 411.4 / 411.5 / 411.6 system-earthing detail, Reg 461.2 PEN
            ...
            <li>
              <strong className="text-white">Module 5 — Selection and erection</strong>: Chapter 57
              (stationary batteries), Section 545 (ICT functional earthing), Section 514
              (identification), Reg 551.7.1 (parallel sources).
            </li>
            <li>
              <strong className="text-white">Module 6 — Inspection and certification</strong>: every
              cert-form change line by line, AFDD column 30, max-permitted-Zs column,
            ...
            <li>
              <strong className="text-white">Module 8 — Reference materials and appendices</strong>:
