...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Amendment 3 primarily focuses on bidirectional protective devices and their application in modern installations with renewable energy systems that can export power.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Bidirectional protective devices are required for installations with renewable energy sources like solar PV and battery storage that can export power to the grid.',
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'Bidirectional protective devices can detect and safely interrupt fault currents flowing in both directions, essential for installations that both consume and generate electricity.',
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Amendment 3 to BS 7671:2018 came into effect on July 31st, 2024. It is now the current version of BS 7671, and installations must comply with these latest requirements.',
  },
  {
    question: "What's the difference between Amendment 2 and Amendment 3?",
    answer:
      'Amendment 2 (March 2022) introduced Part 8 - Prosumer Installations and AFDD requirements. Amendment 3 (July 2024) builds upon this with specific requirements for bidirectional protective devices and enhanced consumer unit requirements for renewable energy systems.',
  },
  {
    question: 'Do all prosumer installations need bidirectional protection?',
    answer:
      'Bidirectional protection is required for prosumer installations where power can flow in both directions - typically solar PV with export, battery storage systems, and vehicle-to-grid (V2G) charging points.',
  },
  {
    question: 'Can I still use standard MCBs in prosumer installations?',
    answer:
      'Standard unidirectional MCBs may still be used for consumption-only circuits, but circuits with potential reverse current flow from generation or storage systems require bidirectional MCBs or RCBOs to comply with Amendment 3.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'What consumer unit requirement is introduced in Amendment 3 for prosumer installations?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Amendment 3 introduces enhanced consumer unit requirements specifically for prosumer installations to handle bidirectional power flow safely, including proper protective device selection and coordination.',
  },
];
...
const BS7671Module1Section4 = () => {
  useSEO({
    ...
    description:
      'Understand Amendment 3 changes including bidirectional protection requirements, consumer unit provisions, and prosumer installation safety.',
  });
    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Effective:</strong> 31st July 2024 (current version)
              </li>
              <li>
                <strong>Focus:</strong> Bidirectional protection for prosumers
              </li>
              <li>
                <strong>Applies to:</strong> Solar PV, batteries, V2G systems
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Any installation that can export power
              </li>
              <li>
                <strong>Use:</strong> Specify bidirectional MCBs/RCBOs for two-way circuits
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
              <p className="text-sm text-white">
                <strong className="text-red-400">Current Standard:</strong> Amendment 3 is now the
                current version of BS 7671. Installations must comply with these requirements for
                legal compliance and professional best practice.
              </p>
            </div>

            <p>
              Amendment 3 addresses the critical gap in protective device technology for
              installations with bidirectional power flow, building upon Amendment 2's prosumer
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
              ...
              <p className="text-sm text-white">
                ...
                power flow in modern renewable energy installations where power can flow both to and
                from the grid.
              </p>
            </div>
            ...
            <div>
              <p className="text-sm font-medium text-elec-yellow/80 mb-2">
                When Bidirectional Protection is Required
              </p>
        ...
        <section className="mb-10 mt-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              ...
              renewable energy sources to ensure safe bidirectional power management and grid
              interaction.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4 my-6">
              <div>
                ...
                <ul className="text-sm text-white space-y-2 ml-4">
                  <li>
                    <strong>Bidirectional MCBs/RCBOs:</strong> For circuits with reverse current
                    flow
                  </li>
                  <li>
                    <strong>Enhanced Breaking Capacity:</strong> Handle faults from both sources
                  </li>
                  <li>
                    <strong>Coordination:</strong> Proper discrimination between generation and load
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="text-sm text-white space-y-2 ml-4">
                  <li>
                    <strong>Labelling:</strong> Clear identification of bidirectional circuits
                  </li>
                  <li>
                    <strong>Isolation:</strong> Safe isolation for maintenance
                  </li>
                  <li>
                    <strong>Testing:</strong> Verification of bidirectional operation
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
              ...
              <div className="space-y-2 text-sm text-white/90">
                ...
                <p>
                  <strong>Problem:</strong> During a fault condition where the battery discharges
                  into a short circuit on the AC side, the unidirectional MCBs fail to detect the
                  reverse fault current, creating a dangerous situation.
                </p>
                <p>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              Amendment 3 addresses critical safety gaps in renewable energy installations. As
              bidirectional power flow becomes standard, proper protection is essential for safety
              and grid stability.
            </p>
