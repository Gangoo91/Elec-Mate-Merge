...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      "BS 7671 is not law itself, but it's the accepted standard for demonstrating compliance with legal duties under the Electricity at Work Regulations 1989.",
  },
  {
    id: 'eawr-link',
    ...
    correctIndex: 2,
    explanation:
      'EAWR 1989 places specific duties on electrical safety in the workplace. BS 7671 compliance demonstrates due diligence under these regulations.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      "While BS 7671 isn't law, not following it makes it very difficult to demonstrate compliance with legal electrical safety duties. Courts use it as the benchmark for assessing competence.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      'BS 7671 is published jointly by the Institution of Engineering and Technology (IET) and the British Standards Institution (BSI). The current 18th Edition came into effect on 1st January 2019, with Amendment 2 published in March 2022.',
  },
  {
    question: 'Can I be prosecuted for not following BS 7671?',
    answer:
      "You cannot be prosecuted purely for BS 7671 non-compliance, as it's not statutory law. However, non-compliance is used as evidence in prosecutions under EAWR to prove you failed to meet required safety standards.",
  },
  {
    question: 'How does Building Regulations Part P relate to BS 7671?',
    answer:
      'Part P makes BS 7671 compliance mandatory for notifiable electrical work in domestic dwellings. This includes new builds, extensions, consumer unit replacements, and work in special locations like bathrooms.',
  },
  {
    question: "What about insurance if I don't follow BS 7671?",
    answer:
      'Professional indemnity policies expect BS 7671 compliance. Non-compliance may void insurance coverage, result in rejected warranty claims, and lead to higher premiums or difficulty obtaining cover.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 2,
    explanation:
      'BS 7671 applies to electrical installations within its scope, both new and existing, to ensure compliance with the Electricity at Work Regulations.',
  },
];
...
const BS7671Module1Section1 = () => {
  useSEO({
    ...
    description:
      'Understand the regulatory framework and legal standing of BS 7671, its relationship to UK law, and the role of EAWR in electrical safety.',
  });
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>BS 7671:</strong> Not law itself, but the accepted industry standard
              </li>
              <li>
                <strong>EAWR:</strong> Primary legislation for workplace electrical safety
              </li>
              <li>
                <strong>Compliance:</strong> Demonstrates meeting legal safety duties
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-sm text-white space-y-1">
              <li>
                <strong>Spot:</strong> Courts, insurers, and HSE all use BS 7671 as benchmark
              </li>
              <li>
                <strong>Use:</strong> Follow BS 7671 to prove legal compliance and protect yourself
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <p>
              BS 7671, more commonly referred to as the IET Wiring Regulations, is the national
              standard for electrical installation design, erection, and verification in the United
              Kingdom. It's issued jointly by the Institution of Engineering and Technology (IET)
            ...
            <div className="grid sm:grid-cols-2 gap-6 my-6">
              ...
              <div>
                ...
                <ul className="text-sm text-white space-y-1 ml-4">
                  <li>
                    <strong>IET:</strong> Institution of Engineering and Technology
                  </li>
                  <li>
                    <strong>BSI:</strong> British Standards Institution
                  </li>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/20">
              <p className="text-sm text-white">
                <strong className="text-orange-400">Key Point:</strong> BS 7671 is NOT law in
                itself, but it's the accepted standard for demonstrating compliance with legal
                requirements.
              </p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-elec-yellow/5 border border-elec-yellow/20">
              ...
              <p className="text-sm text-white">
                ...
                use it as the benchmark for assessing whether electrical work meets required safety
                standards.
              </p>
            </div>
          </div>
          ...
          <div className="text-white space-y-4 leading-relaxed">
            <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/20">
              <p className="text-sm font-medium text-orange-400 mb-3">
                Case Study: Consumer Unit Upgrade Gone Wrong
              </p>
            ...
            <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
              <p className="text-sm text-white">
                <strong className="text-red-400">Key Lesson:</strong> The contractor wasn't
                prosecuted for "breaking BS 7671" but for failing their legal duty under EAWR. BS
                7671 non-compliance was the evidence used to prove they hadn't met required safety
                standards.
              </p>
            </div>
          </div>
