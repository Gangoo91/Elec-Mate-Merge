...
export default function BS7671Module1Section1() {
  ...
  return (
    <HubPage>
      <HubMasthead
        section="Module 1 · Section 1 · Updated for A4:2026"
      ...
      <HubBody>
        <div className="max-w-3xl text-[13px] leading-relaxed text-white">
          {
            'BS 7671:2018+A4:2026 is non-statutory but unavoidable. Where it sits in the UK legal stack, what changed under A4 (Reg 133.1.3), and how that lands on your certification.'
          }
        </div>
        ...
        >
          <p>
            BS 7671:2018+A4:2026 is published jointly by the IET and BSI as a British Standard. That
            status is voluntary — there is no legal mechanism to prosecute someone for breaching BS
            7671 in the way HSE prosecutes for breaches of the Electricity at Work Regulations 1989
          ...
          <p>
            ...
            danger. HSE, courts and insurers all use BS 7671 to test whether that absolute duty was
            discharged. Compliance is not a defence in itself — it is evidence.
          </p>
          <p>
            For dwellings, Building Regulations Part P (England) and equivalents in Wales and
            Scotland make compliance with BS 7671 a practical requirement for notifiable work. Part
            P is statutory; it adopts BS 7671 as the standard for satisfying the safety requirement.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            ...
            electrical installations at nominal voltages up to and including 1000 V AC or 1500 V DC.
            It covers the consumer&apos;s installation downstream of the supply terminals — so the
            cut-out and meter sit at the boundary, with the DNO supply network governed by the
            Electricity Safety, Quality and Continuity Regulations 2002 (ESQCR) instead.
          </p>
          <p>
            <RegBadge>Reg 110.1.3</RegBadge> and <RegBadge>Reg 110.2</RegBadge> list the exclusions:
            equipment on board ships, mobile and fixed offshore installations, aircraft, hovercraft,
            the electrical apparatus of motor vehicles (with limited 7XX-series exceptions), railway
            rolling stock and traction signalling, certain mining installations, lightning
            protection systems (which sit under BS EN 62305), and radio-interference equipment.
            Photovoltaic installations, EV charging and battery storage are explicitly IN scope via
            Sections 712, 722 and 730.
          </p>
          <p>
            ...
            Welfare) Regulations 1992, CDM 2015 and the Regulatory Reform (Fire Safety) Order 2005.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <p>
            ...
            undertaking. Unlike EAWR Reg 4, the SFAIRP qualifier applies — but BS 7671 still defines
            the floor of reasonably practicable.
          </p>
          <p>
            ...
            version; Scotland uses the Building Standards. Notifiable work must be either done under
            a Competent Person Scheme (NICEIC, NAPIT, ELECSA, Stroma) or notified to Building
            Control. Compliance with BS 7671 is the route to satisfying the Part P requirement.
          </p>
        </ConceptBlock>
        ...
        >
          <p>
            <RegBadge>Reg 120.3</RegBadge> is the bridge between the voluntary nature of BS 7671 and
            the absolute duty under EAWR Reg 4. The standard explicitly contemplates that there will
            be circumstances where strict compliance is impractical or inappropriate — heritage
            buildings, retrofit constraints, novel technology, contradictory requirements between
            standards. In those cases the regulation says: depart, but only if you can show the
            result is at least as safe.
          </p>
          <p>
            ...
            creates the audit trail the next inspector, the HSE, the insurer and the court will all
            want to see. A departure that is not recorded is not a Reg 120.3 departure; it is
            non-compliance.
          </p>
          <p>
            In practice, a defensible Reg 120.3 entry reads like: &quot;Reg [X] not applied because
            [reason]. Alternative measure: [Y]. Equivalent safety established by [Z — calculation,
            reference to other standard, manufacturer&apos;s certification, risk assessment]. Signed
            [designer name + qualifications + PI insurer].&quot; That entry is the difference
            between a defensible departure and an EAWR Reg 4 case waiting to happen.
          </p>
        </ConceptBlock>
        ...
        <ConceptBlock title="What changed under A4:2026 in this section">
          ...
          <p>
            ...
            from now. Where a designer leans on 133.1.3 to specify equipment for a particular usage,
            the next inspector is no longer guessing why — the cert carries the record.
          </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5">
            ...
            <li>
              <strong className="text-white">Competent Person Scheme rules</strong> — NICEIC, NAPIT,
              ELECSA, Stroma all impose BS 7671 compliance as a condition of registration and
              assessment.
            </li>
            <li>
              <strong className="text-white">Insurance policy wording</strong> — most PI and public
              liability policies require compliance with applicable standards. Cover may be voided
        ...
        >
          <p>
            The decision tree resolves &gt;95% of legal-status questions in seconds. The residual 5%
            are typically novel-technology cases (battery storage in unusual locations, mixed AC /
            DC microgrids, V2G EV charging) where BS 7671 is being applied by analogy and a Reg
            120.3 departure is more or less inevitable. In those cases, involve a chartered
          ...
          <p>
            ...
            answer is &quot;EAWR Reg 4 imposes the duty; BS 7671 is the standard evidence&quot;. The
            latter is the qualified-electrician answer. It also happens to be the answer that
        ...
        >
          <p>
            ...
            A4&apos;s Reg 133.1.3 change being one example, the new Schedule columns being another.
          </p>
          <p>
            Practical CPD implication: invest now in a cert workflow that captures more, not less.
            Photos at first-fix and second-fix, GPS-tagged test-instrument data, electronic sign-off
            with PI-insurer-traceable identity, and a structured departure register tied to each
            cert. None of this is mandated yet at the level of the IET model forms, but all of it is
            the direction of travel and is already standard practice on regulated / high-value
            commercial work.
          </p>
          <p>
            ...
            (Chapter 81, A4) all require the designer to read across multiple standards. The cert of
            the future cites them all by their dated reference.
          </p>
        </ConceptBlock>
