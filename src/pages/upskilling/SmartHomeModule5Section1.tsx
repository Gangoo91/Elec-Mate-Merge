...
const quickCheckQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'Retrofit smart locks fit inside the door and work with the existing external cylinder, preserving the traditional appearance whilst adding smart functionality.',
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Time-limited PIN codes ensure that access is automatically revoked after the intended period, preventing misuse by contractors or guests who no longer require entry.',
  },
  {
    question:
      'What is the recommended backup for smart locks in case of power or connectivity failure?',
    options: [
      'Remote cloud access',
    ...
    correctAnswer: 2,
    explanation:
      'A physical key override ensures that occupants can always gain entry even if batteries fail, Wi-Fi is down, or the smart system malfunctions.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['PIN codes', 'RFID cards', 'Biometric scanning', 'Bluetooth proximity'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Auto-lock automatically engages the lock after a configurable time period, ensuring the door is secured even if the occupant forgets to lock it manually.',
  },
  {
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "Smart locks on fire doors must maintain the door's fire rating and comply with building regulations. Some smart locks are not suitable for fire doors.",
  },
];
...
const faqs = [
  {
    ...
    answer:
      'Most standard wooden and composite doors can accommodate smart locks, but door thickness, material, and existing cutouts must be checked. Fire doors, multipoint locking systems, and doors with non-standard dimensions may require specialist solutions or may not be suitable.',
  },
  {
    question: 'How long do smart lock batteries typically last?',
    answer:
      'Battery life varies by model and usage but typically ranges from 6 to 12 months on standard AA or CR123A batteries. Low battery warnings are sent via the app well in advance, and most locks include a physical key backup for emergencies.',
  },
  {
    question: 'Are smart locks secure against hacking?',
    answer:
      'Reputable smart locks use AES-128 or AES-256 encryption and secure authentication protocols. However, security depends on firmware updates, strong user passwords, and proper network configuration. Always choose locks with good security track records and keep firmware updated.',
  },
];
      ...
      <article className="px-4 sm:px-6 py-8 sm:py-12 max-w-4xl mx-auto">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white">
                  Understand the differences between retrofit and full replacement smart locks
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
                <span className="text-white">
                  Compare authentication methods including PIN, RFID, biometric, and app-based
                  access
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
                <span className="text-white">
                  Identify key features such as auto-lock, access logs, and temporary codes
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
                <span className="text-white">
                  Apply best practices for smart lock installation and security configuration
                </span>
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Smart locks come in two main configurations, each suited to different installation
            ...
            <div className="bg-elec-gray/30 rounded-lg p-5 border border-white/10">
              ...
              <p className="text-white mb-3">
                Retrofit locks mount on the inside of the door and attach to the existing deadbolt
                or cylinder. The external appearance remains unchanged, which appeals to customers
                who want to maintain traditional aesthetics or comply with lease restrictions.
              </p>
            ...
            <div className="bg-elec-gray/30 rounded-lg p-5 border border-white/10">
              ...
              <p className="text-white mb-3">
                Full replacement locks replace the entire lock mechanism with an integrated smart
                unit. These typically include a keypad, touchscreen, or fingerprint reader on the
                exterior face.
              </p>
              <ul className="space-y-2 text-white">
                <li className="flex items-start gap-2">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Smart locks support various authentication methods, often combining multiple options
              for flexibility and security layering.
            </p>
            ...
            <div className="grid gap-4">
              <div className="bg-elec-gray/30 rounded-lg p-4 border border-white/10">
                ...
                <p className="text-white text-sm">
                  Numeric codes entered via keypad. Support permanent codes for household members
                  and temporary time-limited codes for guests or contractors. Most systems allow
                  10-50 unique codes with activity logging.
                </p>
              </div>
              ...
              <div className="bg-elec-gray/30 rounded-lg p-4 border border-white/10">
                ...
                <p className="text-white text-sm">
                  Contactless cards, fobs, or smartphone NFC for tap-to-unlock access. Useful for
                  users who prefer not to remember codes. Cards can be individually registered and
                  revoked.
                </p>
              </div>
              ...
              <div className="bg-elec-gray/30 rounded-lg p-4 border border-white/10">
                ...
                <p className="text-white text-sm">
                  Fingerprint readers provide secure, personal authentication. Multiple fingerprints
                  can be enrolled per user. Not recommended as sole access method due to potential
                  sensor failures.
                </p>
              </div>
              ...
              <div className="bg-elec-gray/30 rounded-lg p-4 border border-white/10">
                ...
                <p className="text-white text-sm">
                  Bluetooth proximity unlock or manual app control. Enables remote unlocking for
                  visitors and real-time notifications. Requires phone battery and app connectivity.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4 text-white">
            <div className="bg-elec-gray/30 rounded-lg p-5 border border-white/10">
              ...
              <p className="text-white">
                Automatically engages the lock after a configurable time period (typically 30
                seconds to 5 minutes). Ensures security even when occupants forget to lock manually.
                Some models include door sensor confirmation to prevent locking when the door is
                ajar.
              </p>
            </div>
            ...
            <div className="bg-elec-gray/30 rounded-lg p-5 border border-white/10">
              ...
              <p className="text-white">
                Records timestamped entries showing which code or user unlocked the door. Valuable
                for monitoring contractor access, children arriving home, or investigating security
                incidents. Logs typically stored locally and in the cloud.
              </p>
            </div>
            ...
            <div className="bg-elec-gray/30 rounded-lg p-5 border border-white/10">
              ...
              <p className="text-white">
                Time-limited codes that automatically expire after a set period or number of uses.
                Ideal for Airbnb hosts, cleaners, or tradespeople. Eliminates the need to share
                permanent codes or physical keys.
              </p>
            </div>
            ...
            <div className="bg-elec-gray/30 rounded-lg p-5 border border-white/10">
              ...
              <p className="text-white">
                Connect with smart home hubs for automation scenes. Examples include unlocking
                triggering lights and disarming alarms, or locking activating night mode.
                Integration via Z-Wave, Zigbee, or proprietary bridges.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Professional installation ensures optimal security and reliability. Key considerations
              include:
            </p>
            ...
            <div className="bg-elec-gray/30 rounded-lg p-5 border border-white/10">
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Door Assessment:</strong> Check door thickness (typically 35-70mm
                    supported), material, and existing cutouts. Verify the door closes and latches
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    <strong>Fire Door Compliance:</strong> Verify the lock maintains fire door
                    certification if applicable. Not all smart locks are suitable for fire doors.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-elec-yellow font-semibold">3.</span>
                  <span>
                    <strong>Physical Key Backup:</strong> Always ensure a physical key override is
                    available and test it before completing installation.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-elec-yellow font-semibold">4.</span>
                  <span>
                    <strong>Wi-Fi Signal:</strong> Check signal strength at the door location. Weak
                    signals cause connectivity issues and delayed notifications.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-elec-yellow font-semibold">5.</span>
                  <span>
                    <strong>Battery Access:</strong> Ensure batteries can be easily replaced without
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4">
              <p className="text-white">
                <strong>Important:</strong> Smart locks are only as secure as their configuration.
                Always guide customers through proper security setup.
              </p>
            </div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                <span className="text-elec-yellow">-</span>
                <span>
                  Disable unused authentication methods (e.g., turn off Bluetooth if only using
                  Wi-Fi)
                </span>
              </li>
              <li className="flex items-start gap-3">
