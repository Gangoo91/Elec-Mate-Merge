...
const FireAlarmModule3Section2 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 3 · Section 2" title="Addressable vs conventional" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          The two fire alarm architectures, the resolution difference at the CIE, Class A loop
          versus Class B spur, BS EN 54-13 system compatibility, hybrid systems, and the BS
          5839-1:2025 maintenance clarifications on text-descriptor verification.
        </p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Each circuit = one zone.</strong> The wiring topology defines the zoning; you
              cannot mix devices from different zones on one circuit.
            </li>
            <li>
              <strong>Detectors are simple.</strong> The detector senses smoke / heat and pulls the
              circuit into a low-impedance state. No address, no protocol, no individual identity.
            </li>
            <li>
              <strong>End-of-line monitoring</strong> — an end-of-line device (typically a resistor)
              lets the CIE distinguish open-circuit (cable break) from standby. The resistor sets
              the standby current; lower current = open; higher current = fire.
            </li>
            <li>
          ...
          <p>
            ...
            simple buildings (≤ 4–8 zones, single storey or simple multi-storey). Its limitation is
            resolution at the CIE: zone-level only.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Each device has a unique digital address.</strong> Programmed at commissioning
              (typically by setting DIP switches / rotary switches on the device or via the CIE\'s
              programming menu).
            </li>
            <li>
            ...
            <li>
              <strong>Device-level resolution at the CIE.</strong> The CIE displays the address and
              (typically) a text descriptor. The 60 m search distance rule is relaxed because the
          ...
          <p>
            ...
            fewer cables, and faster fire-finding. Trade-off: higher device unit cost, more complex
            commissioning (each address and descriptor must be programmed).
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              a fire (i.e. to identify a fire detector or manual call point operated as a result of
              a fire) should not exceed 60 m, unless the system provides an indication at the CIE of
              the particular detector or manual call point operated.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <text x="220" y="26" textAnchor="middle" fill="#22D3EE" fontSize="13" fontWeight="bold">
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="100" y="92" textAnchor="middle" fill="#22D3EE" fontSize="11" fontWeight="bold">
              CIE
            </text>
            ...
            <text x="660" y="26" textAnchor="middle" fill="#FBBF24" fontSize="13" fontWeight="bold">
            ...
            <rect
              ...
              strokeWidth="1.6"
            />
            <text x="540" y="92" textAnchor="middle" fill="#FBBF24" fontSize="11" fontWeight="bold">
              CIE
            </text>
            ...
            <text x="700" y="64" textAnchor="middle" fill="#EF4444" fontSize="10" fontWeight="bold">
              1.014 operates
            </text>
            ...
            <text x="235" y="488" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
              ✓ network continues
            </text>
            ...
            <text x="720" y="488" textAnchor="middle" fill="#EF4444" fontSize="9" fontWeight="bold">
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              isolate the affected section. Devices in that section may be lost; devices everywhere
              else continue to operate.
            </li>
            <li>
          ...
          <p>
            ...
            higher (the loop runs as a ring, returning to the CIE — typically twice as much cable as
            a Class B spur for the same coverage), but the safety margin is materially greater.
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              ...
              fault-induced loss of detection is property damage, not life safety. Even here, the BS
              5839-1 design conversation typically lands on Class A.
            </li>
            <li>
              <strong>Short spurs from a Class A loop</strong> — sometimes a small group of devices
              in a specific area is wired as a short Class B spur off a Class A loop, if the cable
              run is short and the area is contained. The spur is a known fault-tolerance compromise
              documented in the design.
            </li>
            <li>
              <strong>Conventional installations</strong> — Class A / Class B terminology applies to
              addressable; conventional radial circuits are intrinsically Class B in topology but
              the zone-per-circuit architecture means a single cable break loses exactly one zone
              (which is the BS 5839-1 architectural rule anyway).
            </li>
          </ul>
          <p>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Original building conventional + extension addressable.</strong> The original
              wiring is retained; new coverage on a new loop. The loop is added as a new zone or set
              of zones; CIE has spare zone / loop capacity.
            </li>
            <li>
              <strong>Addressable detection + conventional sounders.</strong> Some addressable CIEs
              drive sounders on conventional radial circuits (for cable-cost reasons or because the
              sounder population predates addressable sounders).
            </li>
            <li>
              ...
              54-13 system-certification perspective this is non-compliant; the design conversation
              must drive toward a single-vendor system at the next major refurbishment.
            </li>
          </ul>
          <p>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              should comply with the current version of this part of BS 5839, but the overall system
              might not conform to the current standard. A certificate (extension or modification
              certificate) should be issued after any extension or modification has been completed.
              Updating the firmware of a CIE is a modification and as such requires a certificate to
              be produced.
            </>
          }
        ...
        >
          ...
          <p>
            The clarification matters because, in practice, text descriptors drift out of date over
            a system\&apos;s 10-15 year service life. The 2025 standard does not put the continuous
            burden on the servicing organisation; it puts the change-notification responsibility on
            the building management and a sensible periodic check on the service organisation.
          </p>
        </ConceptBlock>
        ...
        <FAQ
          items={[
            {
              question: 'Can I have a single zone with both conventional and addressable devices?',
              answer:
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          ...
          <button
            type="button"
            onClick={() => navigate('/electrician/upskilling/fire-alarm-course/module-3/section-3')}
