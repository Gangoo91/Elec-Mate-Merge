...
const InspectionTestingModule7Section1 = () => {
  ...
  return (
    <HubPage>
      <HubMasthead section="Module 7 · Section 1" title="Polarity testing methods" backTo=".." />
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Reg 643.6 in detail. Why polarity is a safety duty, the OSG cross-reference that hands you
          the test for free, and the difference between the dead and the live polarity check.
        </p>
        ...
        >
          <p>
            ...
            but every clause is load-bearing. The opening sentence requires that the polarity of the
            supply at the origin be verified before the installation is energised — a duty that
            lands on the supplier&rsquo;s side of the cut-out as much as the installer&rsquo;s. The
            second clause requires that all single-pole switching devices are in the line conductor
            only, where single-pole switching of the neutral is prohibited (Reg 132.14.2).
          </p>
          <p>
            The three lettered sub-clauses then tighten the verification: every fuse and single-pole
            control and protective device is in the line conductor only; lampholder outer / screwed
            contacts are on neutral on earthed-neutral systems (with the BS EN 60238 E14 / E27
            exception); and wiring throughout the installation is correctly connected. The third
            sub-clause is the catch-all that makes polarity a whole-installation check, not a
            per-accessory check.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              devices are connected in the line conductor(s) only. During the polarity test, it
              shall be verified that: (a) every fuse and single-pole control and protective device
              is connected in the line conductor only; and (b) except for E14 and E27 lampholders to
              BS EN 60238, in circuits having an earthed neutral conductor, centre contact bayonet
              and Edison screw lampholders have the outer or screwed contacts connected to the
              neutral conductor; and (c) wiring has been correctly connected throughout the
              installation.
            </>
          }
        ...
        <RegsCallout
          ...
          clause={
            <>
              A single-pole fuse, switch or circuit-breaker shall be inserted in the line conductor
              only.
            </>
          }
        ...
        >
          <p>
            Polarity is the foundation, not a finishing touch. Four canonical failures all reduce to
            a polarity fault:
          </p>
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              at the plug, but if the socket is wired with line on the left terminal and neutral on
              the right, every appliance plugged in presents 230 V on what its internal design
            ...
            <li>
              ...
              lampholder is exposed when the lamp is loosely fitted or being changed. If the centre
              contact is on neutral, the shell is on line — and the shell is what the user&rsquo;s
              fingers touch as they screw the lamp in.
            </li>
          </ol>
          <p>
        ...
        >
          <p>
            ...
            probe placed on the line terminal at any accessory should read the link resistance plus
            R1+R2 to that point — i.e. continuous. A reading of open circuit at a point where the
            circuit is supposed to terminate is a polarity flag (the line conductor is not arriving
            at this terminal as expected).
          </p>
          ...
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            ...
            <li>
              ...
              line and neutral at the holder; with one in place, a swapped switch wire elsewhere on
              the circuit can read as electrically continuous via the lamp and mask the polarity
              fault.
            </li>
            <li>
            ...
            <li>
              ...
              ohmmeter from line terminal at each accessory to the CPC at that accessory. Continuity
              at every expected line terminal is the pass.
            </li>
            <li>
          ...
          <p>
            ...
            the polarity step is the last one because it depends on every previous step being clean.
            Run them out of order and you get readings you cannot interpret.
          </p>
        </ConceptBlock>
        ...
        <RegsCallout
          ...
          clause={
            <>
              ...
              10.3.1). Polarity is confirmed when the results of the continuity tests and insulation
              resistance measurements are checked for acceptability.
            </>
          }
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-6 my-6">
          ...
          >
            ...
            <rect
              ...
              strokeWidth="1.5"
            />
            <text x="90" y="117" textAnchor="middle" fill="#EF4444" fontSize="10" fontWeight="bold">
              L
            </text>
            <rect
              x="70"
              ...
              strokeWidth="1.5"
            />
            <text x="90" y="162" textAnchor="middle" fill="#3B82F6" fontSize="10" fontWeight="bold">
              N
            </text>
            <rect
              x="70"
              ...
              strokeWidth="1.5"
            />
            <text x="90" y="207" textAnchor="middle" fill="#22C55E" fontSize="10" fontWeight="bold">
              E
            </text>
            ...
            <rect
              ...
              strokeWidth="1"
            />
            <text x="167" y="163" textAnchor="middle" fill="#FBBF24" fontSize="9" fontWeight="bold">
              L–CPC LINK
            </text>
            ...
            <line
              ...
              strokeDasharray="4,3"
            />
            <text x="745" y="270" textAnchor="start" fill="#FBBF24" fontSize="10" fontWeight="bold">
              Probe at
            </text>
            <text x="745" y="282" textAnchor="start" fill="#FBBF24" fontSize="10" fontWeight="bold">
              permanent
            </text>
            <text x="745" y="294" textAnchor="start" fill="#FBBF24" fontSize="10" fontWeight="bold">
              line
            </text>
        ...
        >
          <p>
            The pre-energisation polarity test is the core of the verification. You have isolation,
            lock-off, and a confirmed dead state at the point of work. The test workflow is:
          </p>
          <ol className="list-decimal pl-5 space-y-1.5 text-[14px]">
            <li>
              Isolate the circuit, prove dead at the point of work, lock off at the source. Confirm
              the protective-conductor continuity test (Method 1) is already complete and the L–CPC
              link is in place at the board.
            </li>
            <li>
              Remove all lamps from any lighting circuit on the test path. This is non-negotiable on
              lighting circuits — a lamp filament reads as continuous L-to-N and can mask a swapped
              switch wire.
            </li>
            <li>
              Confirm insulation resistance is acceptable. Polarity readings taken on a circuit with
              a live-to-earth IR fault are not interpretable.
            </li>
            <li>
              With the L–CPC link in place, ohmmeter from the line terminal at each accessory to the
              CPC at that accessory. Continuous = line conductor lands here as expected. Open =
              polarity flag.
            </li>
            <li>
              Verify single-pole device positions. At every switch, FCU and isolator on the circuit,
              the line conductor must enter the device and the switched line must leave it — never
              the neutral being broken.
            </li>
            <li>
              Visual check at any termination the ohmmeter cannot reach. Back-of-rose, behind FCU
              plates, joints inside ceiling voids — confirm the conductor colour codes correspond to
              the design terminals.
            </li>
            <li>
        ...
        >
          <p>
            The live polarity check is targeted, not exhaustive. The classic failure modes the live
            test catches:
          </p>
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Supplier&rsquo;s tails reversed at the cut-out.</strong> The dead test proves
              the installation is internally consistent. If line and neutral are swapped at the
              cut-out, the whole installation is internally consistent but every line conductor is
              actually neutral. Only a live two-pole indicator at the origin catches this.
            </li>
            <li>
            ...
            <li>
              <strong>Phase swap at a meter on a three-phase supply.</strong> Out of scope here, but
              the same logic applies: the dead test cannot tell you which phase the supplier
        ...
        <RegsCallout
          ...
          clause={
            <>
              Where relevant, the polarity of the supply at the origin of the installation shall be
              verified before the installation is energized.
            </>
          }
        ...
        >
            ...
            <table className="w-full text-[13.5px] my-2">
              ...
              <tbody className="text-white/95">
                ...
                <tr className="border-b border-white/[0.06] align-top">
                  ...
                  <td className="py-2 text-elec-yellow">
                    Dead test: continuity from line terminal at switch input to L–CPC link at board,
                    plus visual at the switch
                  </td>
                </tr>
                <tr className="border-b border-white/[0.06] align-top">
                  ...
                  <td className="py-2 text-elec-yellow">
                    Dead test at the rose with lamp removed: continuity from centre contact terminal
                    to L–CPC link at board
                  </td>
                </tr>
                <tr className="align-top">
                  <td className="py-2">(c) Wiring correctly connected throughout</td>
                  <td className="py-2">
                    Switch wire / line swap at a junction; reversed socket-back; reversed sub-board
                    tails
                  </td>
                  <td className="py-2 text-elec-yellow">
                    Dead test at every accessory + visual at every termination + live test at origin
                    and sub-boards
                  </td>
                </tr>
              </tbody>
          ...
          <p>
            ...
            line at every test point is actually the line conductor that left the board. There is no
            shortcut.
          </p>
        </ConceptBlock>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-[14px]">
            <li>
              <strong>Pass entry:</strong> a tick. The implication is that all four duties (origin,
              single-pole line, lampholder, wiring throughout) have been evidenced for that circuit.
            </li>
            <li>
            ...
            <li>
              <strong>N/A entry:</strong> rare. Reserved for circuits where polarity does not apply
              (a true single-conductor SELV circuit with no return polarity, for example). On any
              standard single-phase final circuit, N/A is the wrong entry — polarity always applies.
            </li>
          </ul>
          <p>
            ...
            alongside an updated certificate. A failed circuit cannot be left on the certificate as
            &lsquo;passed&rsquo; with a comment explaining the failure — the column is binary, not
            advisory.
          </p>
        </ConceptBlock>
