    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="px-4 py-6 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-3 pt-6 border-t border-border">
          <Link to="/study-centre/upskilling/instrumentation-module-4-section-2" className="w-full sm:w-auto">
            <Button variant="outline" className="w-full sm:w-auto">
              <ArrowLeft className="mr-2 h-4 w-4" />
              Back
            </Button>
          </Link>
          <Link to="/study-centre/upskilling/instrumentation-module-4-section-4" className="w-full sm:w-auto">
