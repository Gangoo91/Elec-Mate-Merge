  ...
  const quizQuestions = [
    ...
    },
    {
      ...
      options: [
        ...
        'The error is fixed at 1% of full-scale plus 2% of the reading',
        'A 1% tolerance that applies only to the final 2 digits shown',
        'The reading is accurate to within 2 digits regardless of range',
      ],
      correct: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'Small but significant changes need to be detected reliably',
        'It guarantees the reading is accurate to the true value',
        'It increases the input impedance of the instrument',
        'It compensates automatically for calibration drift',
      ],
      correct: 0,
      explanation:
    ...
    },
    {
      ...
      options: [
        'It eliminates random noise picked up from the environment',
        'It permanently increases the instrument resolution',
        'It speeds up the instrument response time',
        'It corrects for systematic errors and instrument drift',
      ],
      correct: 3,
      explanation:
