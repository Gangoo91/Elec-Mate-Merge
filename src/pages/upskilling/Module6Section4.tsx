      ...
      <header className="px-4 sm:px-6 lg:px-8 pt-8 pb-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4">
            <Badge variant="secondary" className="bg-elec-yellow text-black">Module 6.4</Badge>
      ...
      <footer className="px-4 sm:px-6 lg:px-8 pb-8">
        <div>
          <div className="flex flex-col sm:flex-row gap-4 sm:justify-between items-stretch sm:items-center">
            <Link to="/study-centre/upskilling/inspection-testing-module-6-section-3" className="flex-1 sm:flex-initial">
              <Button
                variant="outline"
            ...
            <Link to="/study-centre/upskilling/inspection-testing-module-6-section-5" className="flex-1 sm:flex-initial">
              <Button
