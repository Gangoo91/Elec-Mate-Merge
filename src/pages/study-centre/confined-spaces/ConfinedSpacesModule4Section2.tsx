...
const faqs = [
  {
    question: 'Can I use an FFP3 disposable mask instead of breathing apparatus to save time?',
    answer:
  ...
  {
    question: 'How long does a typical SCBA cylinder last, and what affects the duration?',
    answer:
  ...
  {
    question: 'What is the difference between ATEX-rated and non-ATEX equipment?',
    answer:
  ...
  {
    question: 'How often must fall protection equipment be inspected, and by whom?',
    answer:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          ...
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Risk assessment first:</strong> PPE selection is driven by the risk
                assessment &mdash; never one-size-fits-all
              </li>
              <li>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                There is no standard &ldquo;confined space PPE kit&rdquo; that can be issued to
                every worker for every entry. The PPE required for a specific confined space entry
                is <strong>determined by the risk assessment</strong> for that particular space,
                that particular task, and the hazards identified during the assessment process.
                Getting this wrong can be fatal &mdash; selecting the wrong respiratory protection,
                for example, is one of the leading causes of death in confined spaces.
              </p>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                selecting the wrong one is a life-or-death error. You must understand the
                distinction between <strong>respiratory protective equipment (RPE)</strong> and{' '}
                ...
                <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                      ...
                      <div className="flex-1 flex flex-col items-center gap-0">
                        ...
                        <div className="flex w-full justify-between px-4 sm:px-8">
                          <div className="flex flex-col items-center">
                            ...
                            <span className="text-[9px] sm:text-[10px] text-red-400 font-bold">
                              YES
                            </span>
                            <div className="w-0.5 h-3 bg-red-400/50" />
                          </div>
                  ...
                  <div className="mt-4 bg-white/5 border border-cyan-500/30 rounded-lg p-3">
                    <p className="text-cyan-300 text-xs sm:text-sm font-medium">
                      ...
                      <strong className="text-white">breathing apparatus</strong>. An incorrect
                      decision to use filtering RPE in an atmosphere that is oxygen-deficient, toxic
                      at IDLH levels, or unknown composition will result in loss of consciousness
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 mb-3">
                  ...
                  identified and within the filter&rsquo;s rated capability AND the atmosphere is
                  NOT and cannot become IDLH.
                </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        effort compared to non-powered masks. More comfortable for extended wear.
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-red-400 font-bold mt-0.5 flex-shrink-0">&times;</span>
                    <span>
                      <strong className="text-white">Unknown atmosphere</strong> &mdash; if you do
                      not know what is in the air, you cannot select the correct filter
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-400 font-bold mt-0.5 flex-shrink-0">&times;</span>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                the confined space. BA is required whenever the atmosphere is or may become
                oxygen-deficient, toxic at IDLH levels, or of unknown composition. There are two
                main types used in confined space work: self-contained breathing apparatus (SCBA)
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      throughout the entry. A low-pressure warning whistle activates at
                      approximately 55 bar, signalling the wearer to begin exiting immediately
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Weight:</strong> A fully charged SCBA set
                      weighs approximately 12&ndash;16 kg, which restricts mobility in tight spaces
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400/60 flex-shrink-0" />
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Duration:</strong> Much longer than SCBA
                      because the air supply is not carried by the wearer. Working duration is
                      limited by fatigue, not air supply
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400/60 flex-shrink-0" />
                    <span>
                      ...
                      tethered to the airline hose, restricting how far they can move inside the
                      space. Maximum hose lengths are specified by the manufacturer (typically up to
                      30&ndash;50 metres)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Air quality:</strong> The compressor intake
                      must be positioned in clean air, away from engine exhausts, chemical vents, or
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      failure), the escape set provides breathing air while the wearer exits the
                      space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                    <span>
                      The escape set is for <strong className="text-white">egress only</strong>{' '}
                      &mdash; it is not designed for continued working. The entrant must begin
                      exiting immediately upon activating the escape set
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                    <span>
                      The escape set must be checked before every entry to confirm the cylinder is
                      fully charged and the activation mechanism works
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="h-4 w-4 text-red-400 mt-0.5 flex-shrink-0" />
                    <span>
                      The entrant must be trained in activating the escape set quickly, including
                      under stress and in reduced visibility
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>mandatory</strong> for vertical entry. The fall protection system also
                serves a dual purpose: it provides the connection point for{' '}
                ...
                <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                  ...
                  <div className="mt-4 bg-white/5 border border-cyan-500/30 rounded-lg p-3">
                    <p className="text-cyan-300 text-xs sm:text-sm font-medium">
                      ...
                      point. This is why the harness must have a rescue attachment point &mdash; not
                      just a fall arrest point.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      body harness distributes arrest and retrieval forces across the shoulders,
                      chest, and thighs, preventing spinal injury
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Dorsal attachment (back):</strong> Used for
                      fall arrest. Keeps the wearer upright if a fall occurs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400/60 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      BA). Loose straps can cause the wearer to slip through the harness during
                      rescue
                    </span>
                  </li>
                </ul>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      be on firm, level ground. The tripod must be rated for the maximum expected
                      load (entrant + equipment). Tripods are the most common rescue system for
                      manhole entries
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-cyan-300 font-medium mb-3">Communication Methods</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-cyan-500/20 border border-cyan-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-cyan-300 text-xs font-bold">1</span>
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        inside metal tanks, deep chambers, or concrete structures. Test signal
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        where radio signals fail. Cable must be routed to avoid snagging or damage.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        out&rdquo;; 3 tugs = &ldquo;take up slack&rdquo;; 4 tugs = &ldquo;emergency
                        &mdash; help needed&rdquo;. Used as a backup when voice communication is not
                        available or has failed. All parties must be briefed on the agreed signals
                        before entry.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  Communication equipment must be tested immediately before entry, not assumed to be
                  working from a previous occasion.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                for safe working, hazard identification, and reading instruments (such as
                atmospheric monitors and pressure gauges). The type of lighting selected must be
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Head torches:</strong> Hands-free lighting is
                      essential in confined spaces where both hands may be needed for climbing,
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      lighting must provide sufficient illumination for the specific task being
                      carried out. Moving through the space safely requires different illumination
                      from detailed inspection or electrical work. Additional task lighting may be
                      required
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Battery condition:</strong> Check that
                      batteries are fully charged and that the torch has sufficient capacity for the
                      planned entry duration plus a safety margin. Carry a spare torch as a backup
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  vapours. If the risk assessment identifies any possibility of a flammable
                  atmosphere, all lighting and electrical equipment must be ATEX-rated. There are no
                  exceptions.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-cyan-300 font-medium mb-3">Clothing &amp; Body Protection</h3>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      provides integral eye protection. If chemical splashes are a risk and a
                      half-mask or FFP3 is being used, separate chemical splash goggles are needed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400/60 flex-shrink-0" />
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                inspection takes minutes; the consequences of using defective equipment in a
                confined space can be fatal.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-cyan-300 font-medium mb-3">Pre-Use Inspection Checklist</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-cyan-500/20 border border-cyan-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-cyan-300 text-xs font-bold">1</span>
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        undamaged. For airline BA: check the hose for cuts, kinks, and connector
                        integrity. Test the escape set cylinder pressure and activation mechanism.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        negative pressure face seal check. Confirm the user has a current face-fit
                        test certificate for this specific make and model.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        within its formal examination date (maximum 6 months for equipment in
                        regular use). Check all labels are legible.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        braking mechanism holds securely. Confirm the system is within its formal
                        examination date.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        test audio clarity. For tug-lines: confirm both parties understand the
                        agreed signal code.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        immediately withdrawn and replaced &mdash; never enter a confined space with
                        defective PPE.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-cyan-300 font-medium mb-3">Formal Examination Intervals</h3>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  Equipment that has been involved in a fall arrest event must be withdrawn from
                  service and returned to the manufacturer for detailed examination before reuse
                  &mdash; even if it appears undamaged, internal components may have been stressed
