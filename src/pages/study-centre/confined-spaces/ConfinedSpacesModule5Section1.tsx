...
const faqs = [
  {
    question: 'Does every confined space entry need a full written emergency plan?',
    answer:
  ...
  {
    question: 'How often should confined space rescue teams practise their skills?',
    answer:
  ...
  {
    question: 'Who is responsible for ensuring the emergency plan is in place?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 6,
    question: 'In the rescue alarm cascade, what is the correct order of communication?',
    options: [
  ...
  {
    id: 8,
    question: 'Where should the written emergency plan be displayed?',
    options: [
...
export default function ConfinedSpacesModule5Section1() {
  useSEO({
    title: 'Emergency Planning | Confined Spaces Module 5.1',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-3 mx-auto">
            <span className="text-cyan-400 text-xs font-semibold">MODULE 5 &middot; SECTION 1</span>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Reg 5:</strong> Emergency arrangements MUST be in place BEFORE entry
              </li>
              <li>
                <strong>60% of deaths:</strong> Are would-be rescuers &mdash; never rush in
              </li>
              <li>
                <strong>On-site rescue:</strong> Trained team is the primary rescue method
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              ...
              <li>
                <strong>Rehearsals:</strong> At least annually, ideally quarterly
              </li>
              <li>
                <strong>Written plan:</strong> Displayed at entry point, briefed to all
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Regulation 5 of the <strong>Confined Spaces Regulations 1997</strong> states that no
                person shall enter or carry out work in a confined space unless there are{' '}
                <strong>suitable and sufficient arrangements for the rescue of persons</strong> in
                the event of an emergency. This is not a recommendation &mdash; it is an{' '}
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  arrangements are not in place, entry must not take place. Any entry without a
                  rescue plan is a breach of the Confined Spaces Regulations 1997.
                </p>
              </div>

              <p>
                The emergency arrangements must be <strong>specific to the confined space</strong>{' '}
                and the work being carried out. A generic plan that covers &ldquo;all confined
                spaces&rdquo; is not sufficient. Each space presents different hazards, different
                access and egress challenges, and different rescue requirements. The plan must
                address all of these specifically.
              </p>

              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">Key Principle:</strong> The purpose of
                  Regulation 5 is to ensure that if something goes wrong during a confined space
                  entry, there is a <strong>planned, practised, and resourced method</strong> of
                  getting the casualty out alive. The emergency plan is not paperwork for its own
                  sake &mdash; it is the difference between life and death.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                One of the most important statistics in confined space safety is this:{' '}
                <strong>approximately 60% of confined space deaths are rescuers</strong>. These are
                people who saw a colleague in distress and rushed in to help &mdash; without proper
                equipment, without breathing apparatus, without a plan.
              </p>
              ...
              <div className="bg-red-500/10 border-2 border-red-500/40 p-5 rounded-xl">
                ...
                <p className="text-sm text-white/80">
                  ...
                  rescuer will be exposed to the{' '}
                  <strong className="text-white">identical hazard</strong>. Without breathing
                  apparatus, they will succumb within seconds or minutes. The result: multiple
                  fatalities from a single incident.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Trained rescuers</strong> know to assess the
                      situation before entering &mdash; they do not rush in blind
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Breathing apparatus</strong> is specified and
                      available, so rescuers are protected from the same atmospheric hazard
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Retrieval systems</strong> (tripods, winches,
                      harnesses) allow rescue from outside the space, without the rescuer needing to
                      enter at all
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Regular practice</strong> means the team can
                      execute the rescue quickly and efficiently, without panic or confusion
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">Remember:</strong> The emergency plan does not
                  just protect the entrant &mdash; it protects the <strong>rescuers</strong>.
                  Without it, a single-casualty incident can become a{' '}
                  <strong>multiple-fatality disaster</strong>. Every confined space death is a
                  tragedy; a death that was entirely preventable through proper planning is
                  unforgivable.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The emergency plan must be comprehensive and specific. It must cover every
                foreseeable emergency, the rescue method for each scenario, and all the resources
                needed to execute the rescue. Below is a breakdown of the{' '}
              ...
              <div className="bg-white/5 border-2 border-cyan-500/30 p-5 rounded-xl">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-bold text-cyan-400">Emergency Plan Components</p>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Atmospheric change</strong> &mdash; sudden
                      release of toxic gas, oxygen depletion, or build-up of flammable vapours
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Injury or illness</strong> &mdash; the entrant
                      suffers a medical event (heart attack, seizure, heat exhaustion) or physical
                      injury (fall, crush, burn)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Flooding</strong> &mdash; ingress of water,
                      sewage, or other liquids into the space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fire</strong> &mdash; ignition of flammable
                      atmospheres or materials within the space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Equipment failure</strong> &mdash; ventilation
                      breakdown, lighting failure, communication loss, or breathing apparatus
                      malfunction
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Structural collapse</strong> &mdash; collapse
                      of walls, floors, roofs, or supporting structures within the space
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                For <strong>each foreseeable emergency</strong>, the plan must specify: the rescue
                method to be used, the equipment required, the number of rescuers needed, and the
                estimated time to complete the rescue. This level of detail is what makes the plan
                &ldquo;suitable and sufficient&rdquo; as required by Regulation 5.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The rescue team is the <strong>most critical element</strong> of the emergency plan.
                Without competent, trained, and practised rescuers, even the best-written plan is
                worthless. The following requirements apply to all confined space rescue team
                members.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Confined space rescue training</strong> &mdash;
                      specific to the types of spaces and hazards they will encounter
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Use of breathing apparatus</strong> &mdash;
                      self-contained (SCBA) or airline, as appropriate to the rescue plan
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Casualty handling</strong> &mdash; moving an
                      unconscious or injured person through restricted openings and vertical shafts
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">First aid</strong> &mdash; at a minimum, first
                      aid at work certificate; ideally advanced first aid
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Use of rescue equipment</strong> &mdash;
                      tripods, winches, retrieval systems, stretchers, and harnesses
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Lift, carry, or drag an unconscious casualty through confined openings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Operate rescue equipment (winches, tripods) under time pressure</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Work in high-stress conditions without panic</span>
                  </li>
                </ul>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-2">Practice Frequency</p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Rescuers must be{' '}
                      <strong className="text-white">familiar with the specific space</strong>{' '}
                      &mdash; its dimensions, access points, internal features, and hazards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Rescuers must be{' '}
                      <strong className="text-white">familiar with the rescue equipment</strong>{' '}
                      &mdash; they must have used it in practice before being called upon to use it
                      in a real emergency
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      A rescue team that has <strong className="text-white">never seen</strong> the
                      space or <strong className="text-white">never used</strong> the equipment
                      cannot be considered competent
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Call <strong>999</strong> in any confined space emergency &mdash; this is always the
                right thing to do. However, you must{' '}
                <strong>NOT rely on the fire service arriving in time for rescue</strong>. The fire
                service may take 15 minutes or more to arrive, and the casualty may have only
                minutes.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  unconsciousness can occur within seconds and death within minutes. A fire service
                  response of 15+ minutes means the casualty has been without breathable air for 15+
                  minutes. Brain damage begins after approximately 4 minutes without oxygen. This is
                  why <strong className="text-white">on-site rescue capability is essential</strong>
                  .
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The <strong className="text-white">trained rescue team</strong> on site is the
                      primary rescue resource
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      They are <strong className="text-white">already present</strong>, already
                      equipped, and already familiar with the space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      They can begin rescue <strong className="text-white">within minutes</strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">backup and medical support</strong> &mdash;
                      they are not the primary rescue
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">Best Practice:</strong> Contact your local fire
                  service <strong>before</strong> the work begins to discuss the confined space
                  entry and the emergency plan. Some fire services offer pre-planning visits where
                  they can familiarise themselves with the site, the space, and the access routes.
                  This significantly improves their response if they are eventually called.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The emergency plan must specify <strong>how the alarm is raised</strong>, who is
                contacted, in what order, and how emergency vehicles will reach the site. Confusion
                during an emergency costs time &mdash; and time is the one thing you do not have.
              </p>
              ...
              <div className="bg-white/5 border-2 border-cyan-500/30 p-5 rounded-xl">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-bold text-cyan-400">Rescue Alarm Cascade</p>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Visual and verbal contact</strong> &mdash; the
                      top person must be able to see or hear the entrant at all times (direct line
                      of sight, tug lines, voice)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Radio communication</strong> &mdash;
                      intrinsically safe radios where the space is too large or complex for direct
                      communication
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Tug-line signals</strong> &mdash; pre-agreed
                      signals using a safety line (e.g. one tug = OK, two tugs = take up slack,
                      three tugs = haul out, four tugs = emergency)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Personal gas monitors with alarm</strong>{' '}
                      &mdash; audible and visual alarms that alert both the entrant and the top
                      person to atmospheric changes
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  indicate that the entrant has been incapacitated. Never assume that silence means
                  everything is fine.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                An emergency plan that has never been practised is an emergency plan that will{' '}
                <strong>fail when it matters most</strong>. Rehearsals are essential to identify
                weaknesses, build confidence, and ensure the rescue can be completed within the time
                window available.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Realistic:</strong> Use actual rescue
                      equipment, in or near the actual space, with a simulated casualty (weighted
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Different scenarios:</strong> Practise multiple
                      emergency types &mdash; atmospheric rescue, injury rescue, flooding
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Timed:</strong> Record the time from alarm to
                      casualty extraction &mdash; is it achievable within the survival window?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Documented:</strong> Record the date,
                      participants, scenario, time taken, and any issues encountered
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lessons learned:</strong> Debrief after every
                      rehearsal &mdash; what went well, what went wrong, what needs to change in the
                      plan
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">Critical Question:</strong> If the rehearsal
                  shows that rescue cannot be completed within the survival window (e.g. it takes 20
                  minutes to extract a casualty from a toxic atmosphere, but brain damage begins
                  after 4 minutes without oxygen), then the{' '}
                  <strong>emergency plan must be revised</strong> or the{' '}
                  <strong>entry must not proceed</strong>. Rehearsals are the test of whether the
                  plan is truly &ldquo;suitable and sufficient&rdquo;.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      A <strong className="text-white">trained first aider</strong> must be
                      available on site during all confined space work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Appropriate first aid equipment</strong> must
                      be available at the entry point &mdash; not locked in a distant site office
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      An{' '}
                      <strong className="text-white">automated external defibrillator (AED)</strong>{' '}
                      should be available if possible &mdash; cardiac arrest is a foreseeable
                      consequence of toxic gas exposure and oxygen deprivation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Supplemental oxygen</strong> may be needed for
                      casualties who have been exposed to toxic atmospheres or oxygen-deficient
                      environments
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Extraction route:</strong> How will the
                      casualty be removed from the space? Through the entry point? Through an
                      alternative opening? By vertical lift?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stretcher access:</strong> Is the entry point
                      wide enough for a stretcher? If not, what alternative (sked stretcher, drag
                      sheet, vertical rescue stretcher) will be used?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ambulance access:</strong> Can an ambulance get
                      close to the confined space? What is the route from the space to the nearest
                      ambulance access point? Is the route clear?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Nearest hospital:</strong> Which hospital has
                      the relevant capabilities? A toxicology unit, hyperbaric chamber, or burns
                      unit may be needed depending on the hazards
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>written emergency plan</strong> that is specific to the confined space and
                the work being carried out. The plan must be a practical, usable document &mdash;
                not a generic filing exercise.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Accessible:</strong> The plan must be readily
                      available to everyone involved in the entry &mdash; not locked away or only
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">On display at the entry point:</strong> A copy
                      of the emergency plan must be physically present at the confined space entry
                      point for the duration of the work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Briefed to all personnel:</strong> Every person
                      involved &mdash; the entrant, the top person, the rescue team, and the
                      supervisor &mdash; must be briefed on the emergency plan before entry begins
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Space-specific:</strong> The plan must address
                      the hazards, rescue methods, and equipment for this particular space &mdash;
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reviewed and updated:</strong> The plan must be
                      reviewed if conditions change (new hazards, different personnel, changed
                      access) and updated after each rehearsal
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Description of the confined space</strong>{' '}
                      &mdash; location, dimensions, access/egress points, known hazards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Foreseeable emergencies</strong> &mdash; the
                      specific hazards that could cause an emergency in this space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Rescue method for each scenario</strong>{' '}
                      &mdash; step-by-step procedure for each type of emergency
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Rescue equipment list</strong> &mdash; all
                      equipment, checked and available at the entry point
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Rescue team details</strong> &mdash; names,
                      roles, competencies, contact numbers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Alarm cascade</strong> &mdash; who calls whom,
                      in what order, with contact numbers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Emergency services contact</strong> &mdash;
                      999, plus the exact site address, postcode, grid reference, and access
                      instructions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Nearest hospital</strong> &mdash; name,
                      address, distance, travel time, and relevant specialist capabilities
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Extraction route and ambulance access</strong>{' '}
                      &mdash; how the casualty gets from the space to the ambulance
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">First aid provisions</strong> &mdash; first
                      aider details, equipment location, AED availability
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  the right &mdash; and the duty &mdash; to refuse to enter a confined space if they
                  are not satisfied that adequate emergency arrangements are in place. This is not
                  being difficult; this is being professional.
                </p>
              </div>

              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">Final Thought:</strong> The written emergency
                  plan is not just a legal requirement &mdash; it is a{' '}
                  <strong>life-saving document</strong>. It represents the difference between a
                  coordinated, effective rescue and a panicked, chaotic response that results in
                  additional casualties. Every minute spent preparing the plan could save a life
                  when it matters. Prepare it thoroughly, practise it regularly, and make sure every
                  person on site knows it exists and knows what it says.
                </p>
              </div>
            </div>
          </div>
