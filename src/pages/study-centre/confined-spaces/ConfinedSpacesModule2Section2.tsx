...
const faqs = [
  {
    question: 'Can a generic risk assessment be used for confined space work?',
    answer:
  ...
  {
    question: 'Who should carry out the confined space risk assessment?',
    answer:
  ...
  {
    question: 'How do individual factors like claustrophobia affect the risk assessment?',
    answer:
  ...
  {
    question: 'What is the difference between a static and a dynamic risk assessment?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 7,
    question: 'Which individual factor could make a worker unsuitable for confined space entry?',
    options: [
      'Being left-handed',
...
export default function ConfinedSpacesModule2Section2() {
  useSEO({
    title: 'Risk Assessment for Confined Spaces | Confined Spaces Module 2.2',
    description:
          ...
          <div className="rounded-lg p-4 bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Generic assessments fail:</strong> every confined
                  space has unique hazards requiring a specific assessment
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">3-tier hierarchy:</strong> (1) avoid entry, (2)
                  safe system of work, (3) emergency arrangements
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Six hazard categories:</strong> atmospheric,
                  physical, environmental, biological, mechanical, electrical
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Dynamic assessment:</strong> conditions can change
                  at any moment &mdash; continuous reassessment is essential
                </span>
              </li>
            </ul>
          </div>
          <div className="rounded-lg p-4 bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Always ask:</strong> can this work be done without
                  entering the space?
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Check the register:</strong> is this space on the
                  site confined space register?
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">
                    Never rely on yesterday&rsquo;s assessment:
                  </strong>{' '}
                  conditions may have changed overnight
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">If in doubt, stay out:</strong> evacuate and
                  reassess if anything changes during entry
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                employers to carry out a{' '}
                <strong className="text-white">suitable and sufficient</strong> risk assessment
                before any work is carried out in a confined space. This assessment must be{' '}
                <strong className="text-white">specific</strong> to the particular space, the
                particular task, and the particular conditions at the time of entry.
              </p>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  levels, and access restrictions. A <strong className="text-white">generic</strong>{' '}
                  or <strong className="text-white">template</strong> risk assessment cannot capture
                  these differences &mdash; and using one without adaptation is a common finding in
                  HSE enforcement actions.
                </p>
              </div>

              <p>A specific risk assessment takes account of:</p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">The space itself:</strong> dimensions, layout,
                      access/egress points, construction materials, previous contents, adjacent
                      processes
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">The task:</strong> what work is to be done,
                      what tools and materials will be taken in, estimated duration, number of
                      entrants
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Current conditions:</strong> atmospheric
                      readings taken on the day, weather, water levels, recent process activity,
                      adjacent work
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">The people:</strong> competence, fitness,
                      training, individual factors such as claustrophobia or medication
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  be reviewed and, if necessary, rewritten. Never treat a confined space risk
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                is done through a <strong className="text-white">site survey</strong> and recorded
                in a <strong className="text-white">confined space register</strong>.
              </p>

              <div className="bg-white/5 border border-teal-400/30 p-4 rounded-lg">
                <h3 className="text-teal-300 font-medium mb-3">The Site Survey Process</h3>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 text-sm space-y-1.5">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-3.5 w-3.5 text-cyan-400/60 mt-0.5 flex-shrink-0" />
                    <span>Description (type, dimensions, construction, access points)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-3.5 w-3.5 text-cyan-400/60 mt-0.5 flex-shrink-0" />
                    <span>Known or anticipated hazards (atmospheric, physical, etc.)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-3.5 w-3.5 text-cyan-400/60 mt-0.5 flex-shrink-0" />
                    <span>Classification (e.g. low risk / medium risk / high risk)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-3.5 w-3.5 text-cyan-400/60 mt-0.5 flex-shrink-0" />
                    <span>Date of last survey and next review date</span>
                  </li>
                </ul>
              </div>

              <p>
                The register must be <strong className="text-white">kept up to date</strong> &mdash;
                new spaces must be added as they are discovered, and spaces that have been
                permanently sealed or removed should be updated. The register is a living document,
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                in order. You must not skip to a lower tier until you have genuinely exhausted the
                tier above.
              </p>
              ...
              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">CCTV inspection:</strong> cameras on flexible
                      rods or drones can inspect tanks, vessels, and ducts without anyone entering
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Remote monitoring:</strong> sensors for level,
                      temperature, pressure, and gas concentration can be installed from outside
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Long-reach tools:</strong> cleaning, sampling,
                      and minor repairs can sometimes be carried out using extended tools from
                      outside the space
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">External work:</strong> can pipework be
                      modified, valves replaced, or connections made from outside the confined
                      space?
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Redesign the task:</strong> can the process or
                      system be modified so that routine entry is no longer needed?
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  safe system of work without emergency arrangements, and emergency arrangements
                  alone do not make an entry safe. Both must be planned, documented, communicated,
                  and ready before the first person enters the space.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              ...
              <p>
                ...
                <strong className="text-white">competent person</strong> &mdash; someone with
                sufficient training, knowledge, and experience of confined space hazards. If
                specialist knowledge is needed (e.g. for atmospheric testing or structural
                assessment), external expertise must be obtained.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                consider all six &mdash; not just the obvious atmospheric hazards.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 text-sm space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      <strong className="text-white">Oxygen depletion (O₂ &lt; 19.5%):</strong>{' '}
                      caused by rusting, biological decay, displacement by other gases, absorption
                      by the ground, or reaction with chemicals
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Oxygen enrichment (O₂ &gt; 23.5%):</strong>{' '}
                      increases the risk of fire and explosion &mdash; materials ignite more easily
                      and burn more fiercely
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Toxic gases:</strong> hydrogen sulphide (H₂S),
                      carbon monoxide (CO), carbon dioxide (CO₂), nitrogen dioxide (NO₂), chlorine,
                      ammonia &mdash; can accumulate from processes, decomposition, or ingress from
                      adjacent spaces
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Flammable atmosphere:</strong> methane, petrol
                      vapour, solvent fumes, hydrogen &mdash; an ignition source (spark, flame, hot
                      surface) could cause an explosion
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 text-sm space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      <strong className="text-white">Engulfment:</strong> being buried or submerged
                      by loose materials such as grain, sand, coal, or sewage solids
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 rounded-full bg-amber-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Entrapment:</strong> getting stuck due to the
                      shape or narrowing of the space, or becoming trapped by equipment
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 rounded-full bg-amber-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Drowning:</strong> sudden flooding from rain,
                      pipe bursts, rising water tables, or release of stored liquids
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 rounded-full bg-amber-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Falls from height:</strong> entry via ladders,
                      vertical shafts, or elevated platforms within the space
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-teal-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 text-sm space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      <strong className="text-white">Extreme temperature:</strong> heat stress from
                      hot processes, solar gain on metal structures, or cold exposure in underground
                      spaces
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Noise:</strong> amplified by enclosed spaces
                      &mdash; even relatively quiet tools can produce harmful noise levels when
                      reflected off walls
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Poor lighting:</strong> many confined spaces
                      have no natural light, making hazard identification and movement difficult
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="grid sm:grid-cols-3 gap-3">
                <div className="bg-white/5 border border-green-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white/70 text-xs space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-green-400 mt-1.5 flex-shrink-0"></div>
                      <span>Fungal spores in poorly ventilated spaces</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-green-400 mt-1.5 flex-shrink-0"></div>
                      <span>Bacterial contamination in water tanks or drains</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white/5 border border-orange-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white/70 text-xs space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-orange-400 mt-1.5 flex-shrink-0"></div>
                      <span>Agitators, mixers, or augers inside vessels</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-orange-400 mt-1.5 flex-shrink-0"></div>
                      <span>Pressurised systems (valves, pipes, relief devices)</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white/5 border border-yellow-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white/70 text-xs space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-yellow-400 mt-1.5 flex-shrink-0"></div>
                      <span>Increased shock risk in damp or wet conditions</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-yellow-400 mt-1.5 flex-shrink-0"></div>
                      <span>Reduced-voltage tools (110V or battery) may be required</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  physical hazards (restricted movement), environmental hazards (extreme heat from
                  cable runs), electrical hazards (live circuits), and biological hazards (rodent
                  contamination). The risk assessment must consider every applicable category
                  &mdash; not just the most obvious one.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4 text-white/80">
              ...
              <ul className="text-white/70 space-y-2 text-sm">
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                  <span>
                    A chemical reaction accelerates, depleting oxygen faster than predicted
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                  <span>
                    An upstream valve is opened, releasing toxic gas or liquid into the space
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                  <span>Heavy rain causes sudden flooding in an underground chamber</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                  <span>
                    The use of adhesives, solvents, or paints introduces flammable vapours
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                  <span>
                    Ventilation equipment fails, and the atmosphere deteriorates within minutes
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-white/70 text-sm">
                  ...
                  <p>
                    <strong className="text-white">Top person observation:</strong> the person
                    stationed at the entry point watches for signs of distress, changes in the
                    entrant&rsquo;s behaviour, and external factors (weather, nearby activities).
                  </p>
                  <p>
                    <strong className="text-white">Regular communication checks:</strong> verbal or
                    radio contact at agreed intervals (e.g. every 5 minutes). If contact is lost,
                    the emergency procedure is activated immediately.
                  </p>
                  <p>
                    <strong className="text-white">Willingness to stop:</strong> everyone involved
                    must understand that if <strong className="text-white">anything</strong> changes
                    &mdash; a gas alarm sounds, the entrant feels unwell, conditions feel wrong
                    &mdash; work stops and the space is evacuated. There is no &ldquo;just five more
                    minutes&rdquo; in a confined space.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  hazard or a change in conditions, work must stop and the formal (static)
                  assessment must be reviewed and updated before entry can resume.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                <strong className="text-white">individual workers</strong> who will be involved.
              </p>

              <div className="bg-white/5 border border-teal-400/30 p-4 rounded-lg">
                <div className="flex items-start gap-2 mb-3">
                  <Search className="h-5 w-5 text-teal-400 flex-shrink-0 mt-0.5" />
                  <h3 className="text-teal-300 font-medium">Task-Specific Factors</h3>
                </div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Duration of entry:</strong> longer entries
                      increase exposure time and fatigue. Maximum entry times may need to be set,
                      with mandatory rest breaks outside the space.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Number of entrants:</strong> more people
                      consume more oxygen. The risk assessment must consider the combined oxygen
                      demand and ensure ventilation is adequate for all entrants.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Tools and equipment:</strong> power tools
                      generate heat, sparks, fumes, and noise. Hand tools may be safer but slower.
                      Equipment must be suitable for the atmosphere (e.g. intrinsically safe in
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Substances introduced:</strong> paints,
                      adhesives, solvents, cleaning chemicals, welding gases &mdash; all can change
                      the atmosphere inside the space. The risk assessment must account for every
                      substance taken in.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Hot work:</strong> welding, cutting, grinding,
                      or brazing introduces ignition sources, toxic fumes, UV radiation, and extreme
                      heat. Hot work in a confined space is one of the highest-risk activities and
                      typically requires a separate hot work permit in addition to the confined
                      space permit.
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                <div className="flex items-start gap-2 mb-3">
                  ...
                  <h3 className="text-cyan-300 font-medium">Individual Factors</h3>
                </div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Claustrophobia:</strong> can cause panic,
                      hyperventilation, inability to follow procedures, and attempts to remove
                      breathing apparatus. Workers must be asked about this before assignment to
                      confined space work.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Physical fitness:</strong> confined spaces
                      often require climbing, crawling, working in awkward positions, and wearing
                      heavy PPE. Workers must be physically capable of the task and of self-rescue
                      if necessary.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Medication:</strong> some prescription and
                      over-the-counter drugs cause drowsiness, dizziness, or impaired coordination.
                      Workers on such medication should not enter confined spaces.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Training and competence:</strong> only workers
                      who have received adequate confined space training and who are competent in
                      the use of the required equipment (gas detectors, breathing apparatus,
                      harnesses, communication systems) should be permitted to enter.
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                reviewed and, if necessary, updated whenever circumstances change. The following are
                recognised triggers for review:
              </p>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  It is always better to take 30 minutes to review and confirm the assessment than
                  to proceed on the basis of assumptions. In confined space work, assumptions kill.
                  Review the assessment, confirm conditions, check equipment, brief the team &mdash;
              ...
              <div className="bg-white/5 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  provides an audit trail and demonstrates that the duty to review was fulfilled. In
                  the event of an HSE investigation, the absence of review records is treated as
                  evidence that no review took place.
                </p>
              </div>
            </div>
          </div>
