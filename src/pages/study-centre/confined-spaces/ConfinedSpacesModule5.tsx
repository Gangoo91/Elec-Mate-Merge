        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-white/60 text-sm sm:text-base">
              Learn how to plan for emergencies before anyone enters a confined space, select and
              use rescue equipment, retrieve a casualty safely, and report incidents to drive
