...
const examFeatures = [
  ...
  { icon: ShieldCheck, label: '80% pass mark (16/20)', description: 'Matches the standard required by confined spaces awareness assessments.' },
...
const preparationTips = [
  { title: 'Know the Confined Spaces Regulations 1997', description: 'Understand Regulations 1 to 5, the duties they impose, and how they link to the Health and Safety at Work Act 1974 and the Management of Health and Safety at Work Regulations 1999.' },
  { title: 'Learn the atmospheric limits', description: 'Oxygen depletion below 19.5%, oxygen enrichment above 23.5%, and the occupational exposure limits for common toxic gases such as hydrogen sulphide, carbon monoxide and carbon dioxide.' },
  { title: 'Understand the hierarchy of controls', description: 'Avoid entry wherever possible, then implement a safe system of work, then arrange emergency procedures. Know real examples of each level and why avoidance is always preferred.' },
  { title: 'Master the permit-to-work process', description: 'Understand when a permit is required, what it must contain, the roles of authorised persons, competent persons and entrants, and the full permit lifecycle from issue to cancellation.' },
  { title: 'Know your rescue equipment', description: 'Tripods, winches, davit systems, breathing apparatus, stretchers and communication equipment. Understand the difference between non-entry rescue and entry rescue, and why non-entry is always preferred.' },
  ...
  return (
    <div className="min-h-screen bg-[hsl(0_0%_8%)] text-white">
      <div className="px-4 sm:px-6 lg:px-8 pt-2 pb-24">
        <PageFrame>
          <button
            onClick={() => navigate('../confined-spaces-course')}
            className="inline-flex items-center gap-2 h-10 px-3 rounded-full bg-white/[0.06] border border-white/[0.1] text-white text-[13px] font-medium touch-manipulation hover:bg-white/[0.1] mb-1 self-start"
          >
            <ArrowLeft className="h-4 w-4" /> Confined spaces awareness
          </button>

          <PageHero
            eyebrow="Module 6 · Final assessment"
            title="Mock exam"
            description="Put your confined spaces awareness knowledge to the test under timed exam conditions. Questions are drawn from a 200-question bank covering all five content modules."
            tone="yellow"
          />
          ...
          >
            <div className="rounded-2xl bg-gradient-to-br from-elec-yellow/15 via-amber-500/10 to-transparent border border-elec-yellow/30 p-5 sm:p-6 active:scale-[0.99] transition-transform">
              <div className="flex items-center justify-between gap-3">
                ...
                <PrimaryButton size="lg" onClick={() => navigate('../confined-spaces-mock-exam')}>
          ...
          <ListCard>
            <div className="relative px-5 sm:px-6 py-3.5 sm:py-4 border-b border-white/[0.06]">
              <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-cyan-500/70 via-sky-400/70 to-blue-400/70 opacity-70" />
