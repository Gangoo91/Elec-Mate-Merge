...
const quickCheckQuestions = [
  ...
  },
  {
    id: 'loto-importance',
    question:
      'What does LOTO stand for, and why is it critical in confined spaces with mechanical hazards?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['36.5\u00b0C', '37.5\u00b0C', '39\u00b0C', '40\u00b0C or above'],
    correctAnswer: 3,
    explanation:
      "Heat stroke occurs when the body's thermoregulation fails and core temperature rises to 40\u00b0C or above. It is a life-threatening medical emergency requiring immediate cooling and emergency medical treatment. In confined spaces, heat stroke can develop rapidly due to high ambient temperatures, physical exertion, lack of ventilation, and the insulating effect of PPE. Workers may collapse suddenly, become confused, or lose consciousness.",
  },
  {
    id: 4,
  ...
  },
  {
    id: 7,
    question:
      'What makes noise particularly hazardous inside a confined space compared to open air?',
    options: [
...
export default function ConfinedSpacesModule3Section2() {
  useSEO({
    ...
    description:
      'Engulfment, entrapment, temperature extremes, noise, manual handling, biological hazards, mechanical and electrical hazards, falls, radiation, and structural collapse in confined spaces.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Non-atmospheric hazards</strong> kill and injure in confined spaces
                independently of air quality
              </li>
              <li>
                <strong>Engulfment</strong> by liquids or solids can cause death within minutes
              </li>
              <li>
                <strong>Mechanical/electrical</strong> risks are amplified by restricted escape
                routes
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>LOTO:</strong> All energy sources must be isolated before entry
              </li>
              <li>
                <strong>Reduced voltage:</strong> 110V CTE or lower in wet/conductive spaces
              </li>
              <li>
                <strong>Biological:</strong> Weil's disease is life-threatening &mdash; cover all
                cuts
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white/5 border border-cyan-500/30 rounded-xl p-6 sm:p-8">
              ...
              {[
                {
                  label: 'Engulfment',
                  sub: 'Liquids & solids',
                  colour: 'bg-red-500/20 border-red-500/40 text-red-300',
                },
                {
                  label: 'Entrapment',
                  sub: 'Structures & passages',
                  colour: 'bg-orange-500/20 border-orange-500/40 text-orange-300',
                },
                {
                  label: 'Temperature',
                  sub: 'Heat & cold stress',
                  colour: 'bg-amber-500/20 border-amber-500/40 text-amber-300',
                },
                {
                  label: 'Noise',
                  sub: 'Amplified sound',
                  colour: 'bg-yellow-500/20 border-yellow-500/40 text-yellow-300',
                },
                {
                  label: 'Manual Handling',
                  sub: 'Restricted movement',
                  colour: 'bg-lime-500/20 border-lime-500/40 text-lime-300',
                },
                {
                  label: 'Biological',
                  sub: 'Pathogens & disease',
                  colour: 'bg-green-500/20 border-green-500/40 text-green-300',
                },
                {
                  label: 'Mechanical',
                  sub: 'Moving machinery',
                  colour: 'bg-cyan-500/20 border-cyan-500/40 text-cyan-300',
                },
                {
                  label: 'Electrical',
                  sub: 'Wet/conductive risk',
                  colour: 'bg-blue-500/20 border-blue-500/40 text-blue-300',
                },
                {
                  label: 'Falls',
                  sub: 'Heights & slippery surfaces',
                  colour: 'bg-indigo-500/20 border-indigo-500/40 text-indigo-300',
                },
                {
                  label: 'Radiation',
                  sub: 'UV, ionising sources',
                  colour: 'bg-violet-500/20 border-violet-500/40 text-violet-300',
                },
                {
                  label: 'Structural Collapse',
                  sub: 'Deterioration & corrosion',
                  colour: 'bg-pink-500/20 border-pink-500/40 text-pink-300',
                },
              ].map((item, i) => (
            ...
            <div className="mt-6 bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-3 text-center">
              <span className="text-xs sm:text-sm text-cyan-300">
                All categories must be assessed <strong>in addition to</strong> atmospheric hazards
                &mdash; a space may present multiple non-atmospheric hazards simultaneously
              </span>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Engulfment by liquid is one of the most immediately life-threatening hazards in
                confined spaces. Unlike open environments where escape routes are numerous and
                visible, confined spaces offer <strong>limited egress</strong> &mdash; a rising
                water level that would be a minor inconvenience in an open area can become fatal
                when the only exit is a vertical ladder or narrow hatch above.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  stored liquids. The cold shock response in unheated water further reduces a
                  worker's ability to self-rescue.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Flooding from external sources:</strong> Heavy
                      rainfall overwhelming drainage, rivers or watercourses overtopping into
                      manholes, chambers, or excavations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Rising water tables:</strong> Groundwater
                      seeping into below-ground chambers, basements, and deep excavations &mdash;
                      rate of ingress can increase suddenly after rainfall
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Burst pipes and valve failures:</strong>{' '}
                      Pressurised water mains, fire suppression systems, or process pipework can
                      flood a space in seconds
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Tidal ingress:</strong> Coastal and estuarine
                      locations &mdash; sewers, outfalls, dock structures, and coastal chambers can
                      flood rapidly as tides rise
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Process liquids:</strong> Tanks, vessels, and
                      sumps may contain residual liquids or be inadvertently filled during
                      maintenance
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">Control Measures:</strong> Isolate all liquid
                  supply pipework and confirm isolation before entry. Check weather forecasts and
                  tide tables. Install pumps with alarms to manage water ingress. Ensure emergency
                  egress routes remain clear and accessible. Never enter a space with standing
                  liquid without a specific rescue plan for water rescue.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Free-flowing solids &mdash; materials such as{' '}
                <strong>grain, sand, cement powder, coal, wood pellets, and animal feed</strong>{' '}
                &mdash; can behave like liquids when disturbed. Workers entering silos, hoppers,
                bunkers, and storage vessels containing these materials face a serious risk of
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  exceed <strong className="text-white">400 kg</strong>. At chest depth, breathing
                  becomes impossible due to compressive force on the thorax. Most engulfment victims
                  who are fully submerged do not survive.
                </p>
              </div>
                ...
                <div className="mt-6 bg-red-500/10 border border-red-500/30 rounded-lg p-3 text-center">
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <span className="text-xs sm:text-sm font-bold text-red-400">
                      NEVER walk on stored grain, sand, or powder surfaces &mdash; NEVER enter
                      during discharge
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Grain and cereals:</strong> Wheat, barley,
                      maize &mdash; the most common cause of UK agricultural engulfment deaths
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Sand and aggregates:</strong> Construction
                      sites, quarries, and materials storage
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cement powder and calcium compounds:</strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Coal and biomass fuels:</strong> Power
                      stations, heating plants, and fuel storage
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Wood pellets and animal feed:</strong>{' '}
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">Control Measures:</strong> Never enter a silo,
                  hopper, or vessel containing free-flowing solids without a permit to work and
                  specific risk assessment. Ensure all discharge equipment is isolated (LOTO). Never
                  walk on the surface of stored material. Use fall arrest harnesses connected to
                  anchor points above. Provide a trained standby person with rescue equipment. If
                  bridging or rat-holing is suspected, break it from outside the vessel using
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Entrapment occurs when a worker becomes physically stuck or unable to escape from
                within a confined space. Unlike engulfment (where the person is buried by material),
                entrapment involves the <strong>physical geometry of the space itself</strong> or
                its internal structures preventing movement or egress.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Baffles and dividers:</strong> Internal plates
                      that divide tanks and vessels into compartments &mdash; workers can become
                      wedged between baffles, or trapped in a compartment with no direct exit
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Agitators and mixing blades:</strong>{' '}
                      Protruding shafts, paddles, and helical screws create snag points where
                      clothing, harnesses, or body parts can become caught
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cross-bracing and supports:</strong> Internal
                      structural members that restrict movement and complicate rescue stretcher
                      access
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Tapering vessels:</strong> Cone-bottomed
                      hoppers and vessels that narrow towards the discharge point &mdash; a worker
                      who enters from above may become wedged at a narrower section below
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Pipe runs and culverts:</strong> Sewers and
                      drainage systems may narrow at junctions, bends, or where sections of
                      different diameter connect
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Access restrictions:</strong> Manholes,
                      hatches, and openings that are too small to pass through wearing full rescue
                      equipment or while carrying a casualty
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Trench collapse:</strong> Unsupported trench
                      walls can collapse without warning, burying workers under tonnes of soil
                      &mdash; one cubic metre of soil weighs approximately 1.5 tonnes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Contributing factors:</strong> Vibration from
                      nearby traffic or plant, water saturation, surcharge loads (spoil heaps,
                      materials, vehicles parked near the edge), and previously disturbed ground
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Shoring and battering:</strong> Excavations
                      deeper than 1.2 metres must be assessed for collapse risk &mdash; trench
                      sheets, hydraulic shoring, or sloped sides (battering) are required
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  must be considered in the rescue plan <strong>before</strong> anyone enters the
                  space. If the geometry of the space means a standard stretcher will not fit, or if
                  internal structures prevent a casualty being lifted vertically, specialist rescue
                  equipment (flexible stretchers, confined space rescue teams) must be available at
                  the site before work begins.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Confined spaces are particularly susceptible to temperature extremes because of
                their
                <strong> limited ventilation</strong> and the{' '}
                <strong>thermal properties of their construction</strong>. Both heat stress and cold
                stress can develop far more rapidly inside a confined space than in an open
                environment, and the consequences can be life-threatening.
              </p>
              ...
              <div className="space-y-3">
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Unventilated spaces:</strong> Boilers, ovens,
                        kilns, and furnaces retain residual heat long after shutdown
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Sun-heated metal:</strong> Steel tanks,
                        containers, and roof spaces can reach 60&deg;C+ in summer
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">PPE burden:</strong> Protective clothing,
                        respiratory equipment, and harnesses reduce the body's ability to cool
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Physical exertion:</strong> Manual work in
                        restricted postures generates significant body heat
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-start gap-3">
                      <span className="text-xs font-bold text-red-300 w-20 flex-shrink-0 mt-0.5">
                        40&deg;C+
                      </span>
                      <span className="text-sm text-red-300 font-semibold">
                        HEAT STROKE &mdash; medical emergency, organ damage, potential death
                      </span>
                    </div>
                  </div>
                </div>
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-white">
                          Refrigeration chambers and cold stores:
                        </strong>{' '}
                        Temperatures may be as low as &minus;30&deg;C
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Cryogenic systems:</strong> Liquid nitrogen
                        and similar substances at &minus;196&deg;C can cause instant frostbite on
                        contact and create dangerously cold environments
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Underground chambers:</strong> Deep
                        underground spaces that maintain consistently low temperatures year-round
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Wet environments:</strong> Water dramatically
                        increases heat loss &mdash; wet clothing in a cool confined space can cause
                        hypothermia
                      </span>
                    </li>
                  </ul>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">Control Measures:</strong> For heat &mdash;
                  forced ventilation with cooled air, work/rest cycles (e.g. 20 minutes on / 10
                  minutes off), pre-hydration, lightweight clothing, and core temperature
                  monitoring. For cold &mdash; thermal protective clothing, limited exposure times,
                  warm rest areas, and buddy monitoring for signs of hypothermia. In both cases,
                  workers must be trained to recognise the symptoms and empowered to stop work if
                  they feel unwell.
                </p>
              </div>
            </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <div className="space-y-3">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white mb-3">
                    ...
                    surfaces{' '}
                    <strong className="text-white">
                      reflect sound waves instead of allowing them to dissipate
                    </strong>
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Amplification effect:</strong> A power tool
                        producing 85 dB(A) in open air may exceed 100 dB(A) inside a steel tank
                        &mdash; this is a <strong className="text-white">30-fold increase</strong>{' '}
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Accelerated hearing damage:</strong> At 100
                        dB(A), the maximum safe exposure time without hearing protection is only{' '}
                        <strong className="text-white">15 minutes</strong> (compared to 8 hours at
                        85 dB(A))
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Communication breakdown:</strong> Verbal
                        warnings, instructions, and emergency signals cannot be heard over amplified
                        noise &mdash; this is a{' '}
                        <strong className="text-white">critical safety issue</strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Hearing protection trade-off:</strong> Ear
                        defenders reduce noise exposure but further impair verbal communication
                        &mdash; alternative signalling methods are essential (visual signals, radio
                        headsets, vibrating alarms)
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Restricted movement:</strong> Workers may be
                        unable to adopt safe lifting postures &mdash; forced to twist, bend, or
                        reach awkwardly
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Awkward postures:</strong> Kneeling,
                        crouching, or lying flat significantly reduces lifting capacity and
                        increases musculoskeletal injury risk
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Limited lifting aids:</strong> Standard
                        mechanical handling equipment (pallet trucks, trolleys, hoists) often cannot
                        be used inside confined spaces
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Fatigue interaction:</strong> Heat, PPE
                        burden, and poor ventilation accelerate physical fatigue, reducing strength
                        and coordination for manual tasks
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  protection, and establish non-verbal communication systems before entry. For
                  manual handling &mdash; minimise loads carried into confined spaces, use
                  lightweight tools and equipment, plan tasks to reduce awkward postures, and
                  consider whether portable lifting aids (tirfor winches, rollers) can be deployed.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Confined spaces, particularly those associated with sewerage, drainage, water
                treatment, and agricultural storage, can harbour a range of{' '}
                <strong>biological hazards</strong>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  contact contaminated water or surfaces.{' '}
                  <strong className="text-white">
                    Sewers, drains, culverts, waterways, and canal structures
                  </strong>{' '}
                  are high-risk locations. Symptoms include fever, headache, muscle pain, and
                  jaundice. Severe cases cause organ failure and can be{' '}
                  <strong className="text-white">fatal</strong> if untreated. All workers in sewer
                  environments must carry a{' '}
                  <strong className="text-white">Weil's disease warning card</strong>.
                </p>
              </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Legionnaires' disease</strong> is caused by
                        inhaling water droplets contaminated with Legionella bacteria
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Bacteria thrive in{' '}
                        <strong className="text-white">stagnant water at 20&ndash;45&deg;C</strong>{' '}
                        &mdash; cooling towers, hot water systems, and water storage tanks are
                        high-risk
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Confined spaces that contain or are adjacent to warm water systems pose
                        particular risk when aerosols are generated
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Hepatitis A:</strong> Transmitted through
                        contact with contaminated sewage or faecal matter
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Gastroenteritis:</strong> Various bacteria
                        (E. coli, Salmonella, Campylobacter) in sewage cause severe gastrointestinal
                        illness
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Tetanus:</strong> Clostridium tetani in soil
                        and sewage can enter through cuts &mdash; ensure immunisation is up to date
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Mould and fungal spores:</strong> Damp,
                        unventilated spaces provide ideal growing conditions &mdash; inhalation can
                        cause respiratory sensitisation, allergic reactions, and aspergillosis
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Insect hazards:</strong> Wasps, bees, and
                        hornets may nest in undisturbed spaces &mdash; stings in a confined space
                        can cause anaphylaxis with no rapid escape route
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Rats, mice, and other animals:</strong>{' '}
                        Rodents carry disease and can behave aggressively when cornered &mdash;
                        disturbed nesting birds (particularly pigeons) generate airborne droppings
                        that carry Chlamydia psittaci
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">Control Measures:</strong> Ensure immunisations
                  are current (tetanus, hepatitis A/B for sewer workers). Cover all cuts and
                  abrasions with waterproof dressings. Wear appropriate PPE including waterproof
                  gloves and eye protection. Practise strict hygiene &mdash; no eating, drinking, or
                  smoking until hands and face are thoroughly washed. Carry a Weil's disease card
                  when working in sewer environments. Report any post-work illness to occupational
                  health immediately.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <div className="space-y-3">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Agitators and mixers:</strong> Rotating
                        shafts with paddles or blades inside tanks and vessels &mdash; accidental
                        start-up is fatal
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Pumps and impellers:</strong> Submersible
                        pumps in sumps and wet wells can start automatically on float switch
                        activation
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Conveyors and screw augers:</strong> Material
                        transport equipment that can trap, drag, and crush anyone within reach
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Automatic systems:</strong> Equipment
                        controlled by timers, level sensors, or remote SCADA systems can start
                        without local warning
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    machinery. Each worker applies their own personal padlock and identification
                    tag. The equipment
                    <strong className="text-white">
                      {' '}
                      cannot be restarted until every lock is removed
                    </strong>
                    . Simply switching off is <strong className="text-white">
                      NOT adequate
                    </strong>{' '}
                    &mdash; switches can be operated accidentally, and automatic systems can
                    override manual off positions.
                  </p>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Wet conditions:</strong> Standing water,
                        condensation, and damp surfaces reduce skin resistance from ~100,000 ohms
                        (dry) to as low as 1,000 ohms (wet)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Conductive surroundings:</strong> Metal
                        walls, floors, and structures provide multiple earth paths &mdash; contact
                        with a live conductor creates an unavoidable circuit through the body
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Limited escape:</strong> Muscle contraction
                        from electric shock can prevent a worker from releasing the conductor, and
                        there is no room for bystanders to safely intervene
                      </span>
                    </li>
                  </ul>
                </div>
                      ...
                      <tbody className="text-white">
                        <tr className="border-b border-white/5">
                          ...
                          <td className="py-2 pr-3">
                            <span className="text-cyan-400 font-semibold">110V CTE</span>
                          </td>
                          <td className="py-2">
                            55V max to earth &mdash; standard for UK construction
                          </td>
                        </tr>
                        <tr className="border-b border-white/5">
                          <td className="py-2 pr-3">Hand lamps (damp spaces)</td>
                          <td className="py-2 pr-3">
                            <span className="text-cyan-400 font-semibold">25V</span>
                          </td>
                        ...
                        <tr className="border-b border-white/5">
                          ...
                          <td className="py-2 pr-3">
                            <span className="text-cyan-400 font-semibold">12V</span>
                          </td>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">Key Point for Electricians:</strong> When
                  installing temporary supplies for confined space work, always use a{' '}
                  <strong>110V CTE transformer</strong>
                  as the minimum standard. For wet or conductive environments, specify 25V or 12V
                  supplies for hand lamps. RCDs (30mA, 40ms trip) must protect all circuits.
                  Battery-powered tools and lighting are the safest option and should be recommended
                  wherever the task allows. Ensure all equipment is inspected (PAT tested) before
                  use in the confined space.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Vertical access:</strong> Ladders in
                        manholes, shafts, and silos &mdash; a fall from even a modest height onto a
                        hard surface in a restricted space can cause fatal injuries
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Internal platforms and walkways:</strong>{' '}
                        Platforms within large vessels, tanks, and reactor chambers may be corroded,
                        poorly maintained, or inadequately guarded
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Wet and slippery surfaces:</strong>{' '}
                        Condensation, process residues, algae, and oil on metal surfaces create
                        extremely slippery conditions &mdash; standard footwear may provide no grip
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">PPE complications:</strong> Harnesses,
                        breathing apparatus, and bulky clothing can affect balance and restrict
                        movement on ladders and narrow walkways
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Non-ionising radiation (UV):</strong> Welding
                        operations inside confined spaces produce intense UV radiation. In an
                        enclosed environment, UV reflects off metal surfaces, increasing exposure
                        from all angles. Arc eye (photokeratitis) and severe skin burns can occur
                        even without direct line of sight to the arc. Other workers in the space are
                        at risk if adequate screening is not provided.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Ionising radiation:</strong> Some industrial
                        confined spaces (nuclear facilities, petrochemical plants, certain
                        manufacturing processes) may contain radioactive sources used for level
                        gauging, thickness measurement, or pipe weld inspection (radiography). These
                        sources require specific radiation protection procedures, dosimetry
                        monitoring, and controlled access supervised by a Radiation Protection
                        Adviser (RPA).
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Deteriorated structures:</strong> Old
                        brick-lined manholes, chambers, and tunnels may have degraded mortar,
                        spalling bricks, or weakened lintels that can collapse under load or
                        vibration
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Corrosion:</strong> Metal tanks, vessels, and
                        pipework that have been exposed to chemicals, moisture, or aggressive
                        environments may have corroded to the point of structural failure &mdash;
                        floors, walls, and internal supports can give way without warning
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Undermining:</strong> Excavation or water
                        flow near underground structures can remove supporting ground, causing
                        sudden subsidence or collapse of the chamber above
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Live loads:</strong> Traffic, stored
                        materials, or construction plant above or adjacent to a confined space can
                        impose loads that exceed the structure's (possibly degraded) design capacity
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  ionising sources. For structural collapse &mdash; visual inspection of the
                  structure before entry, engineering assessment for suspect structures, propping or
                  shoring where necessary, and monitoring for signs of movement during work.
                </p>
              </div>
            </div>
          </div>
