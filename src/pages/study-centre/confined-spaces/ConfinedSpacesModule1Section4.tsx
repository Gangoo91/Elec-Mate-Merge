...
const quickCheckQuestions = [
  {
    ...
    question:
      'What are the THREE main hazards that make cable ducts and tunnels confined spaces for electricians?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'What specific atmospheric hazard is associated with UPS battery rooms during charging?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'What maximum voltage is permitted for portable hand lamps in a confined or restrictive conductive location under BS 7671?',
    options: [
      '230V with RCD protection',
...
export default function ConfinedSpacesModule1Section4() {
  useSEO({
    ...
    description:
      'Cable ducts, transformer chambers, substations, plant rooms, risers, voids, lift motor rooms, trenches, manholes, and specific electrical hazards in confined spaces including arc flash amplification and reduced voltage requirements.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>11 types</strong> of confined space common in electrical work
              </li>
              <li>
                <strong>Arc flash risk amplified</strong> &mdash; blast reflects off walls
              </li>
              <li>
                <strong>12V SELV</strong> for hand lamps in confined spaces
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Battery tools preferred</strong> &mdash; no trailing leads
              </li>
              <li>
                <strong>110V CTE max</strong> for portable power tools
              </li>
              <li>
                <strong>RCD at 30mA</strong> as secondary protection &mdash; not a substitute for
                reduced voltage
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Cable tunnels are found beneath universities, hospitals, industrial campuses, data
                centres, and military installations. They provide a continuous underground route for
                high-voltage and low-voltage power cables, fibre-optic links, and control cabling
                between buildings. Tunnels can extend for <strong>hundreds of metres</strong> and
                are typically just wide enough for a single person to walk through &mdash; often
                requiring stooping or crawling in older installations.
              </p>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Heat build-up:</strong> Current-carrying cables
                      generate significant heat. In a tunnel with poor ventilation, ambient
                      temperatures can exceed 40&ndash;50&deg;C, creating a risk of heat exhaustion,
                      heat stroke, and reduced cognitive function
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Gas ingress:</strong> Methane, carbon dioxide,
                      and hydrogen sulphide can migrate through soil into tunnels. Leaks from
                      adjacent gas mains, drainage systems, or contaminated land add further risk.
                      Oxygen depletion can occur without warning
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Limited egress:</strong> Entry and exit points
                      may be hundreds of metres apart. If a fire, gas release, or medical emergency
                      occurs, escape is slow and difficult. Some tunnels have only a single access
                      point
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fire and smoke:</strong> Cable insulation is
                      combustible. A cable fault or fire in a tunnel produces dense toxic smoke that
                      fills the space within seconds, making visibility zero and breathing
                      impossible without BA
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Transformer chambers house oil-filled transformers, dry-type transformers, and
                associated switchgear. They are often located in basements, underground vaults, or
                purpose-built enclosures with restricted access. These spaces present a unique
                combination of
                <strong> electrical, chemical, and atmospheric hazards</strong> that qualify them as
                confined spaces.
              </p>
                ...
                <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Older transformers may contain PCBs (polychlorinated biphenyls) &mdash; a
                        toxic, carcinogenic substance
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Significant heat output reduces air quality and causes heat stress
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        SF&#8326; is 5&times; heavier than air &mdash; sinks and pools at floor
                        level
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Arc decomposition produces SO&#8322;, HF, and other IDLH compounds
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Gas leaks are colourless and may go undetected without instruments
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  , the atmosphere must be assumed to be immediately dangerous to life and health
                  (IDLH). No one may enter without full breathing apparatus (BA) and atmospheric
                  monitoring. The toxic decomposition products &mdash; including hydrogen fluoride
                  (HF) &mdash; can cause severe chemical burns to the lungs, eyes, and skin even at
                  very low concentrations. Ventilation must be established before any unprotected
                  entry.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Substations range from small kiosk-type units on residential streets to large
                indoor, basement, and underground installations serving commercial and industrial
                premises. Many substations meet confined-space criteria, particularly those that are
                <strong>
                  {' '}
                  below ground, within buildings, or of the sealed gas-insulated switchgear (GIS)
                  type
                </strong>
                .
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Underground substations:</strong> Found beneath
                      city streets and large buildings. Access via vertical shafts, manholes, or
                      steep stairways. Poor natural ventilation, potential water ingress, and
                      accumulation of exhaust gases from street level
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Basement substations:</strong> Located beneath
                      commercial buildings. Often share ventilation with car parks (carbon monoxide
                      risk), have limited egress routes, and experience heat build-up from
                      transformers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Indoor substations:</strong> Purpose-built
                      rooms within factories, hospitals, and data centres. May have sealed doors,
                      forced ventilation systems (which can fail), and contain SF&#8326; equipment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Gas-insulated switchgear (GIS) rooms:</strong>{' '}
                      Sealed environments with SF&#8326; equipment. Oxygen displacement risk, toxic
                      decomposition products if faults occur, and often very restricted internal
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">also qualifies as a confined space</strong>, these
                  electrical hazards are compounded by atmospheric risks (oxygen depletion, toxic
                  gases), thermal risks (heat stress from transformer losses), and access/egress
                  limitations. The combined risk profile requires both{' '}
                  <strong className="text-white">electrical safety procedures</strong> (permit to
                  work, isolation, proving dead) and{' '}
                  <strong className="text-white">confined-space procedures</strong> (risk
                  assessment, atmospheric monitoring, rescue plan) to be applied simultaneously.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Plant rooms house the mechanical and electrical infrastructure that serves a
                building: boilers, chillers, air-handling units, switchgear, UPS systems, and
                battery banks. Electricians frequently work in plant rooms for installation,
                maintenance, and fault-finding. Several types of plant room can meet confined-space
                criteria.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Types of Plant Room and Their Hazards
                </p>
                <div className="space-y-4">
                  <div className="bg-cyan-500/5 border border-cyan-500/20 p-3 rounded-lg">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      stress. Basement boiler rooms often have limited ventilation and a single
                      access point.
                    </p>
                  </div>
                  ...
                  <div className="bg-cyan-500/5 border border-cyan-500/20 p-3 rounded-lg">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      ventilation fails, oxygen levels may drop and heat build-up can become
                      dangerous during prolonged work.
                    </p>
                  </div>
                  ...
                  <div className="bg-red-500/5 border border-red-500/20 p-3 rounded-lg">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      . Sulphuric acid mist can also be released. Battery rooms are typically sealed
                      to prevent unauthorised access, creating an enclosed environment where
                      hydrogen accumulates if ventilation fails. A single spark from a tool, switch,
                      or static discharge can trigger a hydrogen explosion.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-cyan-400 mb-4 text-center">
                  Plant Room Hazard Map &mdash; Electrician&rsquo;s Perspective
                </p>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                These are the &ldquo;hidden&rdquo; confined spaces that electricians encounter daily
                but often fail to recognise as such. Because access is frequent and the spaces feel
                familiar, the risks are routinely underestimated.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Vertical shafts running through multi-storey buildings, shared with water
                      pipes, gas pipes, data cabling, and ventilation ducts
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Access is typically through small fire-rated doors at each floor level &mdash;
                      very restricted working space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Chimney effect can draw smoke, gas, or heat from lower floors upward through
                      the shaft
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Gas leaks from adjacent services (water, gas) can accumulate in the shaft
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                ...
                <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Accumulation of dust, fibres, and particulates (including potential asbestos
                        in older buildings)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Poor ventilation and elevated temperatures above lighting and HVAC
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Fire suppression gas (FM200, Novec) may discharge into the void &mdash;
                        immediately oxygen-depleting
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  treat them as &ldquo;normal&rdquo; working environments. However, any void that is
                  substantially enclosed, has limited access/egress, and presents a foreseeable risk
                  of serious injury from a specified hazard{' '}
                  <strong className="text-white">is a confined space under the law</strong>. A
                  specific risk assessment must determine whether confined-space procedures apply
                  &mdash; never assume they do not.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Restricted space &mdash; often very compact with limited room to manoeuvre
                      around equipment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Oil from hydraulic systems or motor bearings creates fire and slip hazards
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ground gas:</strong> Methane, CO&#8322;, and
                      H&#8322;S can migrate from contaminated land, old landfill sites, or natural
                      geological sources
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Water ingress:</strong> Heavy rain, water
                      table, or burst mains can flood the trench rapidly, trapping workers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Collapse:</strong> Unsupported trench walls can
                      collapse without warning, burying workers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Existing services:</strong> Gas mains, water
                      pipes, and other buried services may be struck during excavation
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Methane:</strong> From decomposing organic
                      matter, sewage systems, old landfill, and natural ground gas &mdash; explosive
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hydrogen sulphide (H&#8322;S):</strong> From
                      sewage contamination &mdash; toxic at very low concentrations, rapidly fatal
                      above 100 ppm
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Water ingress:</strong> Manholes frequently
                      flood, creating drowning risk and electrical hazards from submerged cables
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Oxygen depletion:</strong> Sealed covers
                      prevent natural air exchange &mdash; oxygen levels can drop below safe limits
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The growth of renewable energy has introduced new types of confined space that
                electricians must recognise. Solar farm inverter rooms and wind turbine
                nacelles/towers present unique combinations of restricted access, atmospheric
                hazards, and electrical risk.
              </p>
                ...
                <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Enclosed container-type rooms housing inverters, transformers, and
                        switchgear
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Extreme heat &mdash; inverters and transformers generate significant thermal
                        output in a small, sealed space
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Potential for battery storage (lithium-ion) &mdash; thermal runaway produces
                        toxic gases
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        DC systems cannot be fully isolated while the sun is shining &mdash; PV
                        panels always produce voltage
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Nacelle: restricted volume, limited egress (single hatch to tower),
                        80&ndash;120m above ground
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Tower interior: confined cylindrical space, vertical ladder climb,
                        atmospheric hazards from oil vapour and SF&#8326;
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Emergency rescue is extremely difficult at height &mdash; helicopter may be
                        required
                      </span>
                    </li>
                  </ul>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  an emerging confined-space risk &mdash; large containerised battery installations
                  can experience thermal runaway events that produce hydrogen fluoride, carbon
                  monoxide, and other toxic gases in an enclosed space. Confined-space training is
                  increasingly essential for electricians entering the renewable energy sector.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Electrical hazards that are manageable in open environments become{' '}
                <strong>significantly more dangerous</strong> in confined spaces. The combination of
                restricted movement, conductive surroundings, reduced body impedance, and limited
                escape routes means that even relatively low voltages can be lethal. BS 7671 (the
                IET Wiring Regulations) and the Electricity at Work Regulations 1989 impose strict
                requirements for electrical work in confined and restrictive conductive locations.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Blast pressure:</strong> The pressure wave
                      reflects off walls and ceiling, multiplying the force on the worker &mdash;
                      internal injuries, ruptured eardrums, and being thrown against structures
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Superheated gases:</strong> Cannot escape
                      &mdash; the worker is engulfed at temperatures exceeding 19,000&deg;C for
                      longer than in open air
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Molten metal:</strong> Copper and aluminium
                      projectiles ricochet within the confined volume
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Toxic fumes:</strong> Burning insulation, cable
                      sheathing, and plastics produce dense toxic smoke that fills the space within
                      seconds
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">No escape:</strong> The worker cannot move away
                      quickly &mdash; restricted egress means prolonged exposure to all of the above
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                ...
                <div className="mt-5 bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-3 text-center">
                  <p className="text-xs text-cyan-300 font-medium">
                    RCD protection at 30mA must ALWAYS be provided as secondary protection &mdash;
                    but it is NOT a substitute for reduced voltage
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reduced body impedance:</strong> In confined
                      spaces, perspiration is increased, the body is in contact with conductive
                      surfaces (metal walls, pipes, wet concrete), and clothing may be damp &mdash;
                      all of which reduce body impedance, meaning less voltage is needed to drive a
                      lethal current
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cannot break free:</strong> In a confined
                      space, a worker who receives a shock may be unable to pull away from the
                      source due to restricted movement &mdash; prolonging the shock duration and
                      increasing the risk of ventricular fibrillation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Rescue difficulty:</strong> If a worker is
                      incapacitated by electric shock in a confined space, rescue is complicated by
                      the restricted access, the need for isolation, and the risk to rescuers from
                      the same electrical hazard
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      SELV or PELV supply systems for hand-held equipment and hand lamps (12V max)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Safety isolating transformer placed{' '}
                      <strong className="text-white">outside</strong> the confined space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Additional protection by 30mA RCD for all circuits supplying equipment in the
                      space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Automatic disconnection of supply within the prescribed time limits for the
                      voltage used
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Protective equipotential bonding of all simultaneously accessible
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Emergency switching accessible from{' '}
                      <strong className="text-white">outside</strong> the confined space
                    </span>
                  </li>
                </ul>
