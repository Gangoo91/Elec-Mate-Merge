...
const faqs = [
  ...
  {
    question: 'How often should confined space rescue plans be rehearsed?',
    answer:
  ...
  {
    question: 'What is suspension trauma and why is it relevant to confined space rescue?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'What is the KEY advantage of non-entry rescue over entry rescue?',
    options: [
...
const ConfinedSpacesModule5Section3 = () => {
  useSEO({
    title: 'Casualty Retrieval | Confined Spaces Module 5 Section 3',
    description:
      ...
      <article className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 sm:p-5 rounded-lg">
            ...
            <ul className="text-white space-y-2 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Explain the three types of confined space rescue in the correct order of
                  preference
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-cyan-400 flex-shrink-0" />
                <span>
                  Describe the cascade effect and explain why unplanned entry rescue must never be
                  attempted
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-cyan-400 flex-shrink-0" />
                <span>
                  Outline the communication failure protocol and immediate response actions
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-cyan-400 flex-shrink-0" />
                <span>State the correct rescue sequences for both non-entry and entry rescue</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-cyan-400 flex-shrink-0" />
                <span>
                  Describe the first aid priorities after casualty extraction, including suspension
                  trauma management
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-cyan-400 flex-shrink-0" />
                <span>
                  Identify the post-rescue actions required, including decontamination and scene
                  preservation
                </span>
              </li>
            </ul>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              When an emergency occurs inside a confined space, there are three types of rescue that
              can be attempted. They must{' '}
              <strong>always be considered in a strict order of preference</strong>, from lowest
              risk to highest risk. The overriding principle is to minimise the number of people
            ...
            <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
              ...
              <p className="text-white/80 text-sm">
                ...
                <strong className="text-white">
                  The cascade effect kills more people than the original incident.
                </strong>{' '}
                This is why unplanned entry rescue must NEVER be attempted under any circumstances.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Self-rescue is the <strong>preferred method</strong> because it is the fastest and
                does not expose any additional personnel to the hazards inside the space. The
                entrant recognises a problem and exits the space under their own power before the
                situation deteriorates further.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-cyan-400 font-medium mb-3">When Self-Rescue Is Triggered</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Atmospheric alarm:</strong> the gas monitor alarm sounds, indicating
                      oxygen depletion, toxic gas, or flammable gas above safe limits
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Instruction from the top person:</strong> the attendant outside the
                      space orders the entrant to exit immediately due to a change in conditions
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Entrant feels unwell:</strong> dizziness, headache, nausea,
                      breathlessness, or any unusual symptoms &mdash; the entrant must exit
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Equipment failure:</strong> ventilation failure, lighting failure, BA
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  <strong className="text-white">training on the exit procedure</strong> specific to
                  that space, is <strong className="text-white">physically capable</strong> of
                  exiting (e.g. can climb a ladder while wearing PPE), and the{' '}
                  <strong className="text-white">exit is not blocked</strong> by equipment,
                  materials, or other personnel. If any of these conditions are not met, the rescue
                  plan must default to non-entry rescue.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Non-entry rescue is the <strong>second preference</strong> and the primary planned
                rescue method for most vertical confined spaces. The casualty is retrieved from
                outside the space using a pre-rigged lifeline and winch system, meaning{' '}
                <strong>no rescuer enters the space at any point</strong>.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-cyan-400 font-medium mb-3">Non-Entry Rescue Sequence</h3>
                <div className="space-y-0">
                  {[
                    {
                      step: '1',
                      label: 'Raise the alarm',
                      detail: 'Alert all personnel and activate the emergency response',
                    },
                    {
                      step: '2',
                      label: 'Confirm the emergency',
                      detail:
                        'Verify that a genuine emergency exists — do not assume a false alarm',
                    },
                    {
                      step: '3',
                      label: 'Attempt verbal contact',
                      detail:
                        'Call to the casualty by name, ask them to respond — assess level of consciousness',
                    },
                    {
                      step: '4',
                      label: 'Activate the winch',
                      detail:
                        'Begin raising the casualty via the pre-rigged lifeline — operate smoothly and steadily',
                    },
                    {
                      step: '5',
                      label: 'Extract to fresh air',
                      detail:
                        'Bring the casualty completely clear of the confined space into fresh air',
                    },
                    {
                      step: '6',
                      label: 'Commence first aid',
                      detail:
                        'Follow ABC priorities — airway, breathing, circulation — begin CPR if required',
                    },
                    {
                      step: '7',
                      label: 'Call 999 if not already done',
                      detail:
                        'Request ambulance and provide full details of the incident and hazards involved',
                    },
                  ].map((item, idx) => (
                    <div key={idx} className="flex items-start gap-3 sm:gap-4">
                      <div className="flex flex-col items-center">
                        ...
                        {idx < 6 && <div className="w-0.5 h-6 bg-cyan-500/30"></div>}
                      </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  hauling device at the entry point. If this was not done before entry, non-entry
                  rescue cannot be performed, and the situation may require entry rescue &mdash; a
                  far more dangerous option. This is why the Confined Spaces Regulations require
                  rescue arrangements to be in place{' '}
                  <strong className="text-white">before any entry</strong>.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                <strong>physically enters the confined space</strong> to reach the casualty. It
                carries the <strong>highest risk of any rescue method</strong> because it places
                additional people inside the hazardous environment. It must only be used when
                self-rescue and non-entry rescue are impossible.
              </p>
                ...
                <div className="rounded-lg p-3 sm:p-4 bg-red-500/10 border-l-2 border-l-red-500/50 border border-red-500/30">
                  ...
                  <ul className="text-base text-white space-y-1.5">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong>Breathing apparatus (BA) or RPE</strong> &mdash; the atmosphere
                        inside the space cannot be relied upon
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Own atmospheric monitoring</strong> &mdash; the rescuer needs
                        real-time data on the conditions they are entering
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Own communication system</strong> &mdash; two-way contact with
                        personnel outside the space at all times
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Own lifeline</strong> &mdash; so the rescuer can also be retrieved
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  is the single most dangerous action that can be taken during a confined space
                  emergency &mdash; it is the direct cause of the cascade effect.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Continuous communication between the entrant and the attendant outside the space is
                a critical safety control. If that communication is lost, it must be treated as a{' '}
                <strong>potential life-threatening emergency</strong> until proven otherwise.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm mt-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Assume an emergency</strong> &mdash; do not wait to see if contact is
                      restored. The entrant may be unconscious, injured, or in a toxic atmosphere.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-red-500/20 border border-red-500/40 flex items-center justify-center text-red-400 text-xs font-bold flex-shrink-0">
                    ...
                    <div>
                      <strong>Initiate non-entry rescue attempt</strong> &mdash; if a lifeline is
                      attached, activate the winch to begin raising the casualty.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-red-500/20 border border-red-500/40 flex items-center justify-center text-red-400 text-xs font-bold flex-shrink-0">
                    ...
                    <div>
                      <strong>Call emergency services (999)</strong> &mdash; provide full details of
                      the space, hazards, number of personnel, and what has happened.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  entrant &mdash; entering without BA, monitoring, and a plan will result in a
                  second casualty. Use the lifeline and winch from outside.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Once the casualty has been extracted from the confined space and is in fresh air,
                immediate first aid must be commenced. The priorities follow the{' '}
                <strong>ABC approach</strong>.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-cyan-400 font-medium mb-3">ABC First Aid Priorities</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Airway:</strong> check the airway is clear. Remove any obstructions.
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Breathing:</strong> look, listen, and feel for breathing. If not
                      breathing, begin CPR immediately (30 compressions to 2 rescue breaths).
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-full bg-cyan-500/20 border-2 border-cyan-500/50 flex items-center justify-center text-cyan-400 text-sm font-bold flex-shrink-0">
                    ...
                    <div>
                      <strong>Circulation:</strong> check for signs of circulation. Control any
                      bleeding. Treat for shock if necessary.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-cyan-400 font-medium mb-3">Additional First Aid Actions</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-cyan-500 mt-0.5 flex-shrink-0" />
                    <div>
                      If the casualty is <strong>breathing but unconscious</strong>, place them in
                      the <strong>recovery position</strong> to keep the airway open
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-cyan-500 mt-0.5 flex-shrink-0" />
                    <div>
                      Provide <strong>supplemental oxygen</strong> if available and trained to do so
                      &mdash; particularly important after oxygen-deficient atmosphere exposure
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-cyan-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>Continue CPR</strong> without stopping until the casualty begins
                      breathing, emergency services arrive, or you are physically unable to continue
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-cyan-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>Call 999</strong> if not already done &mdash; inform the ambulance
                      service of the specific hazards involved (toxic gas, oxygen depletion,
                      chemical exposure)
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm mb-3">
                  ...
                  <strong className="text-white">suspension trauma</strong> (orthostatic
                  intolerance). Blood pools in the legs during suspension. If the casualty is laid
                  flat immediately after rescue, this pooled blood can rush back to the heart and
                  cause <strong className="text-white">cardiac arrest</strong>.
                </p>
                <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-3 mt-2">
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong>Do NOT lay the casualty flat immediately</strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                      <span>
                        Place in a <strong>semi-recumbent position</strong> (partially upright,
                        approximately 30&ndash;40 degrees)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                      <span>
                        This is a <strong>medical emergency</strong> &mdash; call 999 immediately
                        and inform paramedics of the duration of suspension
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-400 flex-shrink-0" />
                      <span>
                        The casualty requires <strong>urgent hospital treatment</strong> even if
                        they appear alert
                      </span>
                    </li>
                  </ul>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                After the casualty has been extracted and first aid is underway, several important
                actions must be taken to protect the casualty&apos;s ongoing medical care and
                support any subsequent investigation.
              </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 text-sm">
                        ...
                        possible after extraction. Remove contaminated clothing and flush affected
                        skin with clean water. Decontamination procedures should have been specified
                        in the rescue plan.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 text-sm">
                        ...
                        duration of exposure, whether oxygen depletion was a factor, and whether the
                        casualty was suspended in a harness. This information is critical for the
                        hospital to prepare the correct treatment.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 text-sm">
                        ...
                        access until the investigation team (which may include the HSE) has
                        completed their work. Atmospheric monitoring data, permit to work
                        documentation, and communication logs should all be secured as evidence.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/80 text-sm">
                        ...
                        not overlook the wellbeing of those who performed the rescue.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <ul className="text-white space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      The rescue preference order is always: <strong>self-rescue first</strong>,
                      then non-entry rescue, then entry rescue as an absolute last resort. This
                      hierarchy minimises the number of people exposed to danger.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-cyan-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>NEVER attempt unplanned entry rescue.</strong> The cascade effect
                      &mdash; where untrained rescuers become casualties &mdash; kills more people
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-cyan-500 mt-0.5 flex-shrink-0" />
                    <span>
                      Non-entry rescue requires a <strong>pre-rigged lifeline and harness</strong>{' '}
                      attached before entry. If this is not in place, non-entry rescue is not
                      possible.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      ...
                      <strong>
                        BA, atmospheric monitoring, communication, and their own lifeline
                      </strong>
                      . The rescue must be planned and rehearsed.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-cyan-500 mt-0.5 flex-shrink-0" />
                    <span>
                      If communication is lost, <strong>assume an emergency</strong>, initiate
                      non-entry rescue, and call 999. Never enter to &ldquo;check&rdquo;.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-cyan-500 mt-0.5 flex-shrink-0" />
                    <span>
                      First aid follows <strong>ABC priorities</strong>. For harness-suspended
                      casualties, use a <strong>semi-recumbent position</strong> to avoid suspension
                      trauma.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-cyan-500 mt-0.5 flex-shrink-0" />
                    <span>
                      Post-rescue: <strong>decontaminate</strong> if chemicals were involved,{' '}
                      <strong>notify the hospital</strong> of specific hazards, and{' '}
        ...
        {/* ─── Quiz ─── */}
        <div className="mt-12">
          <Quiz title="Casualty Retrieval Quiz" questions={quizQuestions} />
        </div>
