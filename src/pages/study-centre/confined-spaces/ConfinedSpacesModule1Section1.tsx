...
const quickCheckQuestions = [
  {
    ...
    question:
      'Which TWO conditions must BOTH be present for a place to be classified as a confined space under the Confined Spaces Regulations 1997?',
    options: [
  ...
  },
  {
    ...
    question:
      'According to HSE data, approximately what percentage of deaths in confined space incidents are would-be rescuers?',
  ...
  },
  {
    ...
    question:
      'What is the FIRST priority in the confined spaces hierarchy of control under the Regulations?',
    options: [
...
const quizQuestions = [
  {
    id: 1,
    question: 'What is the statutory reference for the Confined Spaces Regulations?',
    options: ['SI 1997/1713', 'SI 2002/2677', 'SI 1999/3242', 'SI 1998/2306'],
    correctAnswer: 0,
    explanation:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Law:</strong> Confined Spaces Regulations 1997 (SI 1997/1713)
              </li>
              <li>
                <strong>Definition:</strong> Substantially enclosed + foreseeable risk of serious
                injury
              </li>
              <li>
                <strong>Not about size:</strong> A large room can qualify; a small cupboard may not
              </li>
              <li>
                <strong>Deaths:</strong> ~15/year in the UK, ~60% are would-be rescuers
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Priority 1:</strong> Can you avoid entry altogether?
              </li>
              <li>
                <strong>Priority 2:</strong> If not, follow a safe system of work
              </li>
              <li>
                <strong>Priority 3:</strong> Emergency arrangements MUST be in place before entry
              </li>
              <li>
                <strong>Never:</strong> Attempt an unplanned rescue &mdash; you may become the next
                casualty
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <p>
                The <strong>Confined Spaces Regulations 1997</strong> (statutory instrument
                reference
                <strong> SI 1997/1713</strong>) were introduced to address exactly this pattern.
                Made under the enabling powers of the{' '}
                <strong>Health and Safety at Work etc. Act 1974 (HASAWA)</strong>, these Regulations
                came into force on 28 January 1998 and apply to all work activities in Great
                Britain. They replaced earlier, sector-specific provisions and created a single,
                comprehensive legal framework for managing the risks of confined space work across
                all industries.
              </p>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  Regulations 1997 are built on one overriding principle:{' '}
                  <strong>
                    if you can do the work without entering the confined space, you must not enter
                    it
                  </strong>
                  . Entry is the last resort, not the default. This principle runs through every
                  requirement in the Regulations and the accompanying Approved Code of Practice.
                </p>
              </div>
              ...
              <p>
                ...
                switchgear rooms with limited ventilation, and trenches. Understanding what makes a
                space &ldquo;confined&rdquo; in the legal sense, and what that means for how you
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  specify work &mdash; did not recognise a space as confined, did not understand the
                  risks, or did not know what to do in an emergency. Awareness training is the first
                  line of defence against these failures.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <p>
                This definition has <strong>two essential limbs</strong>, and <strong>both</strong>{' '}
                must be satisfied for a space to be classified as a confined space:
              </p>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-cyan-500/20 text-cyan-400 text-sm font-bold flex-shrink-0">
                        1
                      </span>
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      is that the enclosure is sufficient to give rise to the specified risks (e.g.,
                      preventing natural ventilation, allowing gas to accumulate, or trapping heat).
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      knowledge and experience, would anticipate. It does not need to be probable
                      &mdash; just foreseeable. The injury must be &ldquo;serious&rdquo;, meaning
                      potentially fatal or causing major harm.
                    </p>
                  </div>
                </div>
                <div className="mt-4 bg-white/5 border border-white/10 rounded-lg p-4">
                  ...
                  <p className="text-xs text-white/70 leading-relaxed">
                    ...
                    make a space a confined space &mdash; it must be the specified confined-space
                    hazards.
                  </p>
                </div>
              </div>
              ...
              <p>
                ...
                <strong> not</strong> say. It does not mention size. It does not mention depth. It
                does not mention whether the space is underground, at ground level, or at height. It
                does not require the space to be permanently enclosed. A space that becomes
                substantially enclosed temporarily &mdash; for example, a room where all doors and
                windows are sealed during a coating operation &mdash; can become a confined space
                for the duration of that enclosure.
              </p>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-cyan-400">
                    Specified Risks Under the Regulations
                  </p>
                </div>
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      escape routes are limited. Sources of ignition include electrical equipment,
                      hot work, static electricity, and even sparks from hand tools.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      death follows within minutes. Oxygen can be displaced by other gases (e.g.,
                      nitrogen purging, CO&#8322; from fermentation, argon from welding) or consumed
                      by chemical reactions (e.g., rusting, microbial decomposition). Toxic gases
                      such as hydrogen sulphide (H&#8322;S) and carbon monoxide (CO) can cause
                      unconsciousness or death at very low concentrations.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      limited egress, a worker can be trapped and drowned in seconds. This risk
                      extends to any liquid, not just water &mdash; including chemicals, slurry, and
                      industrial effluent.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      bridged surface or enters a partly filled vessel can be engulfed in seconds.
                      Once engulfed beyond chest depth, the pressure of the material makes it
                      virtually impossible to escape without external assistance, and breathing is
                      rapidly compromised.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  hexafluoride) gas used in switchgear insulation. A chamber below a manhole cover
                  on a cable route may have CO&#8322; accumulation from biological decomposition in
                  the surrounding soil. In each case, the space is substantially enclosed and one or
                  more specified risks are foreseeable &mdash; making it a confined space.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                  ...
                  <p className="text-sm text-white/80 mb-2">
                    ...
                    purging). A trench that is covered with boards becomes substantially enclosed. A
                    normally open vessel that is partially covered during maintenance may
                    temporarily become a confined space. The assessment must consider the conditions
                    at the time of the work, not just the permanent physical characteristics of the
                    space.
                  </p>
                </div>
                ...
                <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                  ...
                  <p className="text-sm text-white/80 mb-2">
                    ...
                    having openings. The definition requires &ldquo;substantial&rdquo; enclosure,
                    not total enclosure. An opening does not automatically ensure adequate
                    ventilation or prevent the accumulation of hazardous atmospheres.
                  </p>
                </div>
                ...
                <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                  ...
                  <p className="text-sm text-white/80 mb-2">
                    ...
                    warning. By the time a worker realises something is wrong, they may already be
                    losing consciousness. Only atmospheric monitoring with calibrated instruments
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  depletion, heat, drowning, or engulfment?&rdquo; If the answer to any of these is
                  yes, it is a confined space and the full requirements of the Regulations apply.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                over time. Despite the Regulations being in force since 1998, people continue to die
                in confined spaces every year in the UK &mdash; and the pattern of incidents is
                depressingly predictable. Understanding these statistics is not an academic
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-cyan-400 mb-3">
                  UK Confined Space Incident Statistics
                </p>
              ...
              <p>
                The statistic that should command the most attention is that{' '}
                <strong>
                  approximately 60% of deaths in confined space incidents are would-be rescuers
                </strong>
                . This means that for every worker who is overcome by a hazardous atmosphere, more
                people are likely to die attempting an unplanned rescue than from the original
                incident itself. The instinct to help a fallen colleague is natural and
                understandable &mdash; but rushing into a confined space without breathing
                apparatus, atmospheric monitoring, and a planned rescue procedure is one of the most
                dangerous actions a person can take.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  without any respiratory protection. They too are overcome by the same atmosphere.
                  A third person may follow. HSE records include incidents where three, four, and
                  even five people have died from a single event &mdash; the first victim plus
                  multiple rescuers. This is why the Regulations require emergency arrangements to
                  be in place <strong>before</strong> any entry.
                </p>
              </div>

              <p>
                Notable confined space incidents in UK industrial history include fatalities in
                water treatment works, agricultural silos, chemical storage tanks, brewing vessels,
                ships&rsquo; holds, and sewers. The industries affected are diverse, but the
                underlying causes are remarkably similar: failure to recognise the space as
                confined, failure to assess the atmosphere, failure to implement a safe system of
                work, and unplanned rescue attempts.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Failure to recognise the space as a confined space in the first place
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      No safe system of work (permit to work, risk assessment, method statement)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  workplace hazards, confined space risks are often <strong>invisible</strong>. You
                  cannot see an oxygen-depleted atmosphere. You cannot smell carbon monoxide. You
                  cannot detect nitrogen displacement by looking into a space. The absence of any
                  visible hazard is precisely what lulls people into a false sense of security
                  &mdash; and into fatal decisions.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Confined Spaces Regulations 1997 are accompanied by{' '}
                <strong>
                  Approved Code of Practice L101: &ldquo;Safe Work in Confined Spaces&rdquo;
                </strong>
                , published by the HSE. Understanding the legal status of an ACoP is important for
                anyone involved in planning, supervising, or carrying out work that may involve
                confined spaces.
              </p>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 leading-relaxed">
                  ...
                  <strong>
                    unless you can demonstrate that you complied with the Regulations in some other
                    equally effective way
                  </strong>
                  . In practice, following the ACoP is the recognised standard means of
                  demonstrating compliance. Departing from it places the burden of proof on you to
                  show your alternative approach was equally effective &mdash; a difficult position
                  in court.
                </p>
              </div>

              <p>
                The Confined Spaces Regulations do not operate in isolation. They sit within a wider
                framework of UK health and safety legislation, and several other pieces of law are
                directly relevant to confined space work:
              </p>
                ...
                <div className="space-y-4">
                  <div className="border-b border-white/5 pb-4">
                    ...
                    <p className="text-sm text-white/80 leading-relaxed">
                      ...
                      law &mdash; breaches can result in unlimited fines and imprisonment.
                    </p>
                  </div>
                  <div className="border-b border-white/5 pb-4">
                    <p className="text-sm font-medium text-white mb-1">
                  ...
                  <div className="border-b border-white/5 pb-4">
                    ...
                    <p className="text-sm text-white/80 leading-relaxed">
                      ...
                      are properly planned, supervised, and carried out using suitable, inspected
                      equipment.
                    </p>
                  </div>
                  <div className="border-b border-white/5 pb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/80 leading-relaxed">
                      ...
                      equipment for use in those zones.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">In Practice:</strong> On a typical job, multiple
                  pieces of legislation will apply simultaneously to confined space work. An
                  electrician entering a cable tunnel to carry out an inspection may be subject to
                  the Confined Spaces Regulations (confined space entry), HASAWA (general duties),
                  the Management Regulations (risk assessment), PUWER (tools and instruments), COSHH
                  (if hazardous substances are present), and DSEAR (if flammable atmospheres could
                  form). Effective compliance requires awareness of all applicable legislation, not
                  just the Confined Spaces Regulations in isolation.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Confined Spaces Regulations 1997 establish a clear, three-tier hierarchy that
                governs all confined space work. This hierarchy is the backbone of the Regulations
                and must be applied in order. You cannot jump to tier 2 without first demonstrating
                that tier 1 is not reasonably practicable, and you cannot proceed to tier 3 alone
                &mdash; tier 3 must always be in place when entry occurs.
              </p>

              {/* Hierarchy Diagram */}
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-cyan-400 mb-4 text-center">
                  Hierarchy: Avoid &gt; Safe System &gt; Emergency
                </p>
                <div className="space-y-4">
                  <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                    <div className="flex items-start gap-3">
                      <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-green-500/20 text-green-400 text-lg font-bold flex-shrink-0">
                        1
                      </span>
                      <div>
                        ...
                        <p className="text-sm text-white/80 leading-relaxed">
                          ...
                          Before any entry is considered, you must ask: &ldquo;Can this work be done
                        ...
                        <div className="mt-3 bg-white/5 rounded-lg p-3">
                          ...
                          <ul className="text-xs text-white/60 space-y-1">
                            <li className="flex items-start gap-2">
                              ...
                              <span>
                                Inspecting a tank using remote cameras, CCTV, or robotic crawlers
                                instead of physical entry
                              </span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                              <span>
                                Cleaning a vessel using fixed spray nozzles operated from outside
                              </span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                              <span>
                                Taking samples via remote sampling points rather than entering a
                                chamber
                              </span>
                            </li>
                            <li className="flex items-start gap-2">
                  ...
                  <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-4">
                    <div className="flex items-start gap-3">
                      <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-cyan-500/20 text-cyan-400 text-lg font-bold flex-shrink-0">
                        2
                      </span>
                      <div>
                        ...
                        <div className="mt-3 bg-white/5 rounded-lg p-3">
                          ...
                          <ul className="text-xs text-white/60 space-y-1">
                            <li className="flex items-start gap-2">
                              <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                              <span>
                                Permit-to-work system with defined roles and responsibilities
                              </span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                            ...
                            <li className="flex items-start gap-2">
                              <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                              <span>
                                Isolation of connected pipework, valves, and energy sources
                              </span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                              <span>
                                Trained and competent personnel, with a top-person stationed at the
                                entry point
                              </span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                              <span>
                                Communication systems between entrant(s) and the top-person
                              </span>
                            </li>
                          </ul>
                        </div>
                  ...
                  <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                    <div className="flex items-start gap-3">
                      <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-red-500/20 text-red-400 text-lg font-bold flex-shrink-0">
                        3
                      </span>
                      <div>
                        ...
                        <p className="text-sm text-white/80 leading-relaxed">
                          ...
                          whenever entry occurs. The arrangements must be capable of effecting a
                        ...
                        <div className="mt-3 bg-white/5 rounded-lg p-3">
                          ...
                          <ul className="text-xs text-white/60 space-y-1">
                            <li className="flex items-start gap-2">
                              ...
                              <span>
                                Rescue equipment immediately available at the point of entry (e.g.,
                                tripod, winch, harness, breathing apparatus)
                              </span>
                            </li>
                            <li className="flex items-start gap-2">
                              <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                            ...
                            <li className="flex items-start gap-2">
                              <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                              <span>
                                A clear procedure for raising the alarm, initiating rescue, and
                            ...
                            <li className="flex items-start gap-2">
                              <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                              <span>
                                Practice and drill of emergency procedures at regular intervals
                              </span>
                            </li>
                          </ul>
                        </div>
              ...
              <p>
                ...
                <strong> safe system</strong> if you cannot avoid;{' '}
                <strong>emergency arrangements</strong> always in place when entry occurs. The first
                tier eliminates the risk entirely. The second tier manages the risk to an acceptable
                level. The third tier ensures that if something goes wrong despite the safe system
                of work, a rescue can be effected without creating additional casualties.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  was not followed. In the most tragic cases, no emergency arrangements were in
                  place, leading to the &ldquo;rescuer trap&rdquo; where multiple people died trying
                  to save the first victim. The hierarchy exists because it works &mdash; when it is
                  actually applied.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Confined Spaces Regulations 1997, supported by ACoP L101, require that no person
                enters a confined space unless they are competent and have received appropriate
                training. But the need for training extends well beyond those who physically enter
                confined spaces. Regulation 4 and the guidance in ACoP L101 make clear that a range
                of people require varying levels of confined space knowledge.
              </p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      confined space, and know what to do if they witness an emergency. This is the
                      &ldquo;awareness&rdquo; level of training.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      arrangements), the content and operation of permit-to-work systems, and their
                      responsibilities for ensuring workers are competent and properly equipped.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
              ...
              <p>
                ...
                installation and maintenance work regularly takes place in or near spaces that may
                be confined: plant rooms, risers, service tunnels, ceiling voids, trenches,
                transformer enclosures, and switchgear chambers. Even if you never physically enter
                a confined space, you need the awareness to recognise one, to avoid inadvertent
                entry, and to respond correctly if an incident occurs nearby.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  For those entering confined spaces, this typically means completing accredited
                  training, demonstrating practical skills, and receiving refresher training at
                  appropriate intervals. For awareness-level training, the requirement is
                  understanding the principles, recognising hazards, and knowing the correct course
                  of action.
                </p>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">Key Takeaway:</strong> Confined space awareness
                  training is not just for those who enter confined spaces. It is for anyone who may
                  encounter a confined space, work near one, supervise work involving one, or need
                  to respond to an emergency in or around one. As an electrician, this almost
                  certainly includes you. The knowledge in this course could save your life or the
                  life of a colleague.
                </p>
              </div>
            </div>
