...
const faqs = [
  ...
  {
    question: 'Do the CSR 1997 apply to self-employed persons?',
    answer:
  ...
  {
    question: 'How do the CSR 1997 interact with CDM 2015 on construction sites?',
    answer:
  ...
  {
    question: 'What atmospheric conditions must be tested before entering a confined space?',
    answer:
...
const quizQuestions = [
  {
    id: 1,
    question: 'What is the statutory instrument number of the Confined Spaces Regulations 1997?',
    options: ['SI 1997/1713', 'SI 1997/2776', 'SI 1997/1529', 'SI 1997/3242'],
    correctAnswer: 0,
    explanation:
...
export default function ConfinedSpacesModule2Section1() {
  useSEO({
    title: 'Confined Spaces Regulations 1997 | Confined Spaces Module 2 Section 1',
    description:
      ...
      <article className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
              ...
              <ul className="text-base text-white space-y-1.5">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Applies to{' '}
                    <strong>
                      employers, self-employed persons, and anyone who controls confined space work
                    </strong>
                    .
                  </span>
                </li>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Title:</strong> &ldquo;The Confined Spaces Regulations 1997&rdquo; (SI
                      1997/1713).
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      Ireland has equivalent regulations (the Confined Spaces Regulations (Northern
                      Ireland) 1999, SR 1999 No. 13).
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                    <div>
                      ...
                      Act 1974 (HASAWA), specifically Sections 15(1), 15(2), 15(3)(a), 15(4)(a), and
                      15(5)(b).
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                    ...
                    <p className="text-white italic">
                      ...
                      which, by virtue of its enclosed nature, there arises a reasonably foreseeable
                      specified risk.
                    </p>
                  </div>
                  ...
                  <div className="bg-white/5 border border-cyan-500/30 p-3 rounded-lg mt-2">
                    ...
                    <p className="text-white/80 text-xs">
                      ...
                      confined space because it lacks the enclosed nature.
                    </p>
                  </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                <strong>do not enter a confined space if the work can be done from outside</strong>.
                This is not merely guidance &mdash; it is a legal duty. Entry must be avoided
                ...
                <div className="grid sm:grid-cols-2 gap-3 text-sm">
                  <ul className="text-white space-y-2">
                    ...
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                      <div>
                        Cleaning by water jetting, steam, or chemical treatment from outside
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                      <div>
                        Blockage clearance using rods, high-pressure water, or mechanical tools
                      </div>
                    </li>
                  </ul>
                  <ul className="text-white space-y-2">
                    ...
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                      <div>
                        Modifying the space to eliminate the confined nature (e.g. permanent
                        ventilation)
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  duct without a person entering? Only when these alternatives are genuinely not
                  reasonably practicable should entry be planned.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Where entry to a confined space cannot be avoided, Regulation 4 requires that a safe
                system of work is established. This is the most detailed of the five regulations,
                and ACoP L101 provides extensive guidance on what a safe system must include. The
                safe system of work must be{' '}
                <strong>documented, communicated to all involved, and followed rigorously</strong>.
              </p>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      must be ventilated to ensure a safe atmosphere. Mechanical ventilation (forced
                      or extracted) is usually necessary. Natural ventilation alone is rarely
                      sufficient.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      permit-to-work system for all confined space entries. The permit documents the
                      hazards, precautions, time limits, communication arrangements, and emergency
                      procedures. It must be signed by the authorising person before entry and
                      formally closed on completion.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
              ...
              <div className="bg-white/5 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  the entrant&rsquo;s condition, keep count of persons inside, summon help if
                  needed, and <strong>never enter the space themselves to attempt a rescue</strong>{' '}
                  unless they are a trained rescuer with appropriate equipment. Approximately 60% of
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                <strong> before</strong> any person enters a confined space. This regulation exists
                because the speed with which conditions can deteriorate in a confined space means
                that rescue must begin within minutes &mdash; waiting for the emergency services is
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-white italic text-sm">
                  &ldquo;No person at work shall enter or carry out work in a confined space unless
                  suitable and sufficient arrangements for the rescue of persons in the event of an
                  emergency have been made.&rdquo;
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Trained rescue personnel:</strong> A sufficient number of persons must
                      be trained in the use of the rescue equipment and in the rescue procedures
                      specific to that confined space. They must be immediately available &mdash;
                      not on call elsewhere on site.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      hospital capable of treating the likely injuries (e.g. hyperbaric chamber for
                      gas poisoning) should be identified in advance.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Resuscitation equipment:</strong> Must be available at the entrance to
                      the confined space, ready for immediate use. Persons trained in its use must
                      be present. Where oxygen-depleted or toxic atmospheres are foreseeable, this
                      is critical.
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  <strong className="text-white">
                    {' '}
                    never enter a confined space to attempt an improvised rescue
                  </strong>
                  . Approximately 60% of confined space deaths in the UK are rescuers who entered
                  without proper equipment or training. The natural human instinct to rush in and
                  help a colleague in distress is understandable, but without breathing apparatus
                  and rescue training, the rescuer simply becomes the next casualty. Emergency
                  arrangements must be planned, equipped, and rehearsed <em>before</em> entry, not
                  improvised when something goes wrong.
                </p>
              </div>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <ul className="text-white space-y-2">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        Lifting equipment must be of adequate{' '}
                        <strong>strength and stability</strong> for the intended use
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    ...
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                      <div>
                        The lifting operation must be properly{' '}
                        <strong>planned, supervised, and carried out safely</strong> by competent
                        persons
                      </div>
                    </li>
                  </ul>
                ...
                <div className="space-y-2 text-sm text-white/80">
                  ...
                  <ul className="space-y-1.5">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        If you follow the ACoP guidance, you will normally be doing enough to comply
                        with the law on those specific matters.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                      <span>
                        If you do not follow the ACoP, you are not automatically in breach, but you
                        must demonstrate compliance by an equally effective method.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                      <span>
                        In court, failure to follow L101 is strong evidence that the duty holder has
                        not complied with the regulations, unless they can show an alternative
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Section 2 &mdash; Employer&rsquo;s duty to employees:</strong> Every
                      employer must ensure, so far as is reasonably practicable, the health, safety,
                      and welfare at work of all employees. This includes provision of safe systems
                      of work, safe equipment, information, training, and supervision.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Section 3 &mdash; Duty to non-employees:</strong> Every employer and
                      self-employed person must conduct their undertaking in such a way that persons
                      not in their employment (contractors, visitors, members of the public) are not
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Section 7 &mdash; Employee&rsquo;s duty:</strong> Every employee must
                      take reasonable care for their own health and safety and that of others, and
                      cooperate with their employer to enable the employer to comply with their
                      duties. An employee who enters a confined space without following the safe
                      system of work may be personally liable.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Self-employed persons</strong> have the same duties under the CSR 1997
                      as employers. They must avoid entry where possible, establish a safe system of
                      work, and put emergency arrangements in place.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      conduct their undertaking so that they and others are not exposed to risks. A
                      self-employed electrician working alone in a cable duct must still comply
        ...
        <section className="mb-10">
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The Health and Safety Executive (HSE) is the primary enforcing authority for the CSR
                1997. Local authorities also have enforcement powers in certain premises. Confined
                space fatalities are always investigated, and the HSE has consistently pursued
                prosecution where the regulations have been breached.
              </p>
              ...
              <div className="space-y-3">
                <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-white/80 text-sm">
                    ...
                    . For example, an HSE inspector finding that a company has no confined space
                    entry procedures may issue an improvement notice requiring a full safe system of
                    work to be developed and implemented within 21 days. Failure to comply is a
                    criminal offence.
                  </p>
                </div>
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-white/80 text-sm">
                    ...
                    injury. A prohibition notice may be issued when workers are found entering a
                    confined space without atmospheric testing, without emergency arrangements, or
                    without adequate training. Work cannot resume until the notice is complied with.
                  </p>
                </div>
                  ...
                  <ul className="text-white space-y-2 text-sm mt-2">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        apply &mdash; with unlimited fines and mandatory publicity orders
                      </div>
                    </li>
                  </ul>
                </div>
                ...
                <div className="space-y-4 text-sm">
                  <div className="border-b border-white/10 pb-3">
                    ...
                    <p className="text-white/80">
                      ...
                      emergency arrangements. The company was fined{' '}
                      <strong className="text-white">&pound;600,000</strong> plus costs. The court
                  ...
                  <div className="border-b border-white/10 pb-3">
                    ...
                    <p className="text-white/80">
                      ...
                      <strong className="text-white">custodial sentence</strong> and the company was
                      fined &pound;200,000. The case illustrates the devastating consequences of
                  ...
                  <div className="border-b border-white/10 pb-3">
                    ...
                    <p className="text-white/80">
                      ...
                      PUWER 1998. The case demonstrates how multiple regulatory frameworks can apply
                      simultaneously to a single confined space incident, and how failure to isolate
                      equipment is a breach of the safe system of work requirements.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-white/80">
                      ...
                      employer must ensure it is{' '}
                      <strong className="text-white">actually implemented and supervised</strong>.
                      The fine was &pound;120,000.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <ul className="text-white space-y-2 text-sm">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      measurements, photographs, samples, and require the production of documents
                      including risk assessments, permits to work, and training records.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                    <div>
                      ...
                      of truth. Obstructing an inspector is itself a criminal offence under Section
                      33(1)(e).
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Fee for intervention (FFI):</strong> Since 2012, the HSE has charged a
                      fee (currently &pound;163 per hour) to duty holders found to be in material
                      breach of health and safety law. This cost-recovery scheme means that even
                      without prosecution, regulatory non-compliance has a direct financial cost.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-500 mt-2 flex-shrink-0"></div>
                    <div>
                      ...
                      is the enforcing authority rather than the HSE. They have the same powers to
                      issue improvement and prohibition notices and to prosecute.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <ul className="text-white space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-cyan-500 mt-0.5 flex-shrink-0" />
                    <span>
                      The <strong>Confined Spaces Regulations 1997 (SI 1997/1713)</strong> contain 5
                      regulations establishing a clear hierarchy: avoid entry, then safe system of
                      work, then emergency arrangements.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-cyan-500 mt-0.5 flex-shrink-0" />
                    <span>
                      ...
                      enclosed with a reasonably foreseeable specified risk &mdash; both limbs must
                      be present.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      ...
                      PUWER 1998, LOLER 1998, COSHH 2002, and DSEAR 2002 all interact with the CSR
                      1997.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      ...
                      notices, and prosecution &mdash; with unlimited fines for organisations and up
                      to 2 years&rsquo; imprisonment for individuals.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-cyan-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Never attempt an unplanned rescue</strong> &mdash; approximately 60%
                      of confined space deaths are would-be rescuers. Emergency arrangements must be
                      planned, equipped, and rehearsed before entry.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        {/* ─── Quiz ─── */}
        <div className="mt-12">
          <Quiz title="Confined Spaces Regulations 1997 Quiz" questions={quizQuestions} />
        </div>
