...
const faqs = [
  {
    question: 'Can I enter a confined space briefly without testing the atmosphere?',
    answer:
  ...
  {
    question: 'What is the difference between a toxic gas and an asphyxiant gas?',
    answer:
  ...
  {
    question: 'How quickly can a confined-space atmosphere become dangerous?',
    answer:
...
const quizQuestions = [
  {
    id: 1,
    question: 'What is the normal percentage of oxygen in the atmosphere at sea level?',
  ...
  {
    id: 3,
    question: 'What is the UK Workplace Exposure Limit (WEL) for carbon monoxide as an 8-hour TWA?',
...
export default function ConfinedSpacesModule3Section1() {
  useSEO({
    title: 'Atmospheric Hazards | Confined Spaces Module 3.1',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-3 mx-auto">
            <span className="text-cyan-500 text-xs font-semibold">MODULE 3 &middot; SECTION 1</span>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Normal air:</strong> 20.9% O&sub2;, 78.1% N&sub2;, 0.04% CO&sub2;, trace
                gases
              </li>
              <li>
                <strong>Oxygen:</strong> &lt;19.5% depletion alarm, &gt;23.5% enrichment danger
              </li>
              <li>
                <strong>Toxic:</strong> H&sub2;S, CO, CO&sub2;, SO&sub2; &mdash; all potentially
                lethal in confined spaces
              </li>
              <li>
                <strong>Flammable:</strong> LEL/UEL range &mdash; methane, LPG, solvents, dust
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              ...
              <li>
                <strong>Monitor:</strong> O&sub2;, LEL, CO, and H&sub2;S continuously
              </li>
              <li>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Before you can understand what makes a confined-space atmosphere dangerous, you need
                to know what a <strong>normal, safe atmosphere</strong> looks like. The air we
                breathe every day has a remarkably consistent composition at sea level:
              </p>
              ...
              <p>
                ...
                <strong className="text-cyan-400">20.9% oxygen</strong>. This is the benchmark
                against which all oxygen measurements are compared. Even a small reduction in oxygen
                percentage &mdash; just 1 or 2 percentage points &mdash; can impair judgement,
                coordination, and consciousness. In a confined space, where dilution by fresh air is
                limited or absent, these small changes happen quickly and without warning.
              </p>

              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-500">Key Point:</strong> Atmospheric hazards are the{' '}
                  <strong>leading cause of death</strong> in confined spaces. More than 60% of
                  confined-space fatalities are caused by atmospheric conditions, and a significant
                  proportion of those are would-be rescuers who entered without testing. The
                  atmosphere must <strong>always</strong> be tested before entry and monitored
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Oxygen depletion occurs when the oxygen concentration drops below the normal 20.9%.
                In open air, natural convection and wind replace consumed or displaced oxygen almost
                immediately. Inside a confined space, this replacement mechanism is absent or
                severely limited, allowing oxygen levels to fall rapidly to life-threatening
                concentrations.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Rusting (oxidation):</strong> Steel walls,
                      fittings, and pipework consume oxygen as they corrode. A rusty tank or vessel
                      can reduce O&sub2; to lethal levels within hours of being sealed.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Biological activity:</strong> Bacteria, fungi,
                      and decomposing organic matter consume oxygen. Common in sewers, drains, grain
                      silos, and tanks that have held organic materials.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Displacement by other gases:</strong> Gases
                      such as nitrogen, argon, carbon dioxide, or methane can displace oxygen. A
                      leak from a nitrogen purge line, for instance, can render a space immediately
                      lethal.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Combustion:</strong> Burning, welding, cutting,
                      and the use of petrol or diesel engines inside or near a confined space
                      consume oxygen and produce toxic by-products.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Absorption by materials:</strong> Freshly
                      poured concrete, certain soils, chemical reactions in coatings, and some
                      granular materials can absorb oxygen from the surrounding air.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-4">Oxygen Level Effects Scale</p>
                <div className="space-y-2">
                  <div className="flex items-stretch gap-3">
                    <div className="w-20 sm:w-24 flex-shrink-0 flex items-center justify-end">
                      <span className="text-sm font-bold text-cyan-400">20.9%</span>
                    </div>
                  ...
                  <div className="flex items-stretch gap-3">
                    <div className="w-20 sm:w-24 flex-shrink-0 flex items-center justify-end">
                      <span className="text-sm font-bold text-green-400">19.5%</span>
                    </div>
                  ...
                  <div className="flex items-stretch gap-3">
                    <div className="w-20 sm:w-24 flex-shrink-0 flex items-center justify-end">
                      <span className="text-sm font-bold text-orange-400">16%</span>
                    </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  consciousness in one or two breaths, with no sensation of suffocation, no gasping,
                  and no chance to call for help or escape. The body simply shuts down. This is why
                  instrument monitoring is the <strong className="text-white">only</strong> defence.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                While oxygen depletion is the more common hazard, oxygen enrichment &mdash; where
                the O&sub2; concentration exceeds 23.5% &mdash; is equally dangerous, though for
                different reasons. In an enriched atmosphere, the risk of fire and explosion is{' '}
                <strong>dramatically increased</strong>.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Materials that do not normally burn (such as clothing, hair, and grease) can{' '}
                      <strong className="text-white">ignite and burn fiercely</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Flames spread <strong className="text-white">faster and burn hotter</strong>{' '}
                      than in normal air
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lower ignition energies</strong> &mdash;
                      smaller sparks or lower temperatures can start a fire
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      Fires are <strong className="text-white">much harder to extinguish</strong>{' '}
                      because the excess oxygen feeds the combustion
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">widens significantly</strong>, increasing the
                      chance of explosion
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Leaking oxygen supply lines:</strong>{' '}
                      Oxy-acetylene cutting/welding equipment, medical oxygen supplies, or
                      industrial O&sub2; lines that leak into a confined space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Electrolysis:</strong> The electrolysis of
                      water produces oxygen gas, which can accumulate in enclosed spaces near
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Improper use of oxygen:</strong> Oxygen must{' '}
                      <strong>never</strong> be used to ventilate a confined space or to
                      &ldquo;freshen the air&rdquo; &mdash; this creates an enrichment hazard
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  creating severe fire and explosion risk. Always ventilate with{' '}
                  <strong className="text-white">normal air</strong> only, using mechanical
                  ventilation equipment. If oxygen levels are low, the solution is forced
                  ventilation with fresh air, not the addition of oxygen.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Confined spaces can contain a range of toxic gases that are harmful or fatal even at
                relatively low concentrations. Each gas has specific properties, sources, and
                physiological effects. Understanding these is essential for selecting the correct
                gas detection equipment and interpreting its readings.
              </p>
                ...
                <div className="space-y-3 text-sm text-white/80">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      means you can no longer smell it. Heavier than air (relative density 1.19).
                      Colourless. Both toxic and flammable (LEL 4.3%).
                    </p>
                  </div>
                  <div>
                    ...
                    <p>
                      ...
                      disturbed sediment in waterways.
                    </p>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1">
                      <li className="flex items-start gap-2">
                        ...
                        <span>10&ndash;20 ppm: eye and respiratory irritation</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          50&ndash;100 ppm: severe eye damage, coughing, difficulty breathing
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                        <span>
                          100&ndash;200 ppm: olfactory fatigue (smell lost), serious respiratory
                          distress
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>&gt;300 ppm: rapid unconsciousness, pulmonary oedema, death</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-3 text-sm text-white/80">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      &mdash; impossible to detect without instruments. Slightly lighter than air
                      (relative density 0.97). Binds to haemoglobin approximately 200&times; more
                      readily than oxygen, forming carboxyhaemoglobin and preventing oxygen
                      transport.
                    </p>
                  </div>
                  <div>
                    ...
                    <p>
                      ...
                      carbonaceous materials in low-oxygen environments.
                    </p>
                  </div>
                  <div>
                    <p className="text-xs font-medium text-white/60 mb-1">Effects</p>
                    <ul className="space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-yellow-400 flex-shrink-0" />
                        <span>50 ppm: headache after several hours of exposure</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>200 ppm: headache within 2&ndash;3 hours, dizziness, nausea</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                        <span>
                          400 ppm: life-threatening within 3 hours; headache within 1&ndash;2 hours
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>
                          &gt;800 ppm: unconsciousness within 2 hours, death within 2&ndash;3 hours
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-600 flex-shrink-0" />
                        <span>&gt;6,400 ppm: death within 10&ndash;15 minutes</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-3 text-sm text-white/80">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      (relative density 1.52) &mdash; sinks and accumulates at floor level in pits,
                      cellars, and low-lying spaces. Acts both as an asphyxiant (displaces O&sub2;)
                      and as a direct toxic agent at high concentrations.
                    </p>
                  </div>
                  <div>
                    <p className="text-xs font-medium text-white/60 mb-1">Sources</p>
                    <p>
                      ...
                      systems, natural geological sources, and human respiration in poorly
                      ventilated spaces.
                    </p>
                  </div>
                  <div>
                    ...
                    <ul className="space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-yellow-400 flex-shrink-0" />
                        <span>5,000 ppm (0.5%): headache, drowsiness after prolonged exposure</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                        <span>
                          30,000 ppm (3%): rapid breathing, headache, dizziness, increased heart
                          rate
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                        <span>
                          50,000 ppm (5%): serious symptoms &mdash; confusion, loss of judgement
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>&gt;100,000 ppm (10%): unconsciousness within minutes, death</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-2">
                    <p className="text-xs text-red-300 font-medium">
                      ...
                      warning smell, taste, or sensation.
                    </p>
                  </div>
                  <div>
                    <p className="text-xs font-medium text-white/60 mb-1">Properties</p>
                    <p>
                      ...
                      Similar density to air (relative density 0.97). The victim has{' '}
                      <strong className="text-red-400">absolutely no warning</strong> before losing
                      consciousness. A single breath of a near-pure nitrogen atmosphere can cause
                      immediate collapse.
                    </p>
                  </div>
                  <div>
                    ...
                    <p>
                      ...
                      nitrogen supply lines. Nitrogen purging is extremely common in the process and
                ...
                <div className="space-y-3 text-sm text-white/80">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      moisture to form sulphuric acid.
                    </p>
                  </div>
                  <div>
                    <p className="text-xs font-medium text-white/60 mb-1">Sources</p>
                    <p>
                      ...
                      sulphur-containing materials in industrial confined spaces.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A flammable atmosphere exists when a gas, vapour, mist, or dust is present at a
                concentration that could ignite or explode if a source of ignition is introduced. In
                the open air, flammable gases disperse rapidly. In a confined space, they accumulate
                and can reach explosive concentrations quickly.
              </p>

              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-500">Key Concept &mdash; LEL &amp; UEL:</strong>{' '}
                  Every flammable gas has a <strong>Lower Explosive Limit (LEL)</strong> and an{' '}
                  <strong>Upper Explosive Limit (UEL)</strong>. Below the LEL, the mixture is too
                  lean (not enough fuel) to ignite. Above the UEL, the mixture is too rich (not
                  enough oxygen) to ignite. <strong>Between the LEL and UEL</strong>, the mixture is
                  in the <strong>flammable range</strong> and can be ignited by a suitable source of
                  energy.
                </p>
              </div>
                  ...
                  <div>
                    ...
                    <div className="w-full h-6 bg-white/5 rounded-lg overflow-hidden flex">
                      <div
                        ...
                        style={{ width: '20%' }}
                      >
                        <span className="text-[9px] text-green-400 font-medium">0&ndash;5%</span>
                      </div>
                      <div
                        className="bg-red-500/30 border-r border-red-500/50 flex items-center justify-center"
                        style={{ width: '40%' }}
                      >
                        <span className="text-[9px] text-red-400 font-bold">FLAMMABLE</span>
                      </div>
                      <div
                        className="bg-blue-500/20 flex items-center justify-center"
                        style={{ width: '40%' }}
                      >
                        <span className="text-[9px] text-blue-400 font-medium">15%+</span>
                      </div>
                    </div>
                  </div>
                  {/* LPG */}
                  <div>
                    ...
                    <div className="w-full h-6 bg-white/5 rounded-lg overflow-hidden flex">
                      <div
                        ...
                        style={{ width: '10%' }}
                      >
                        <span className="text-[9px] text-green-400 font-medium">0&ndash;2%</span>
                      </div>
                      <div
                        className="bg-red-500/30 border-r border-red-500/50 flex items-center justify-center"
                        style={{ width: '30%' }}
                      ...
                      <div
                        ...
                        style={{ width: '60%' }}
                      >
                        <span className="text-[9px] text-blue-400 font-medium">9.5%+</span>
                      </div>
                    </div>
                  </div>
                  {/* Hydrogen */}
                  <div>
                    ...
                    <div className="w-full h-6 bg-white/5 rounded-lg overflow-hidden flex">
                      <div
                        ...
                        style={{ width: '8%' }}
                      >
                        <span className="text-[9px] text-green-400 font-medium">0&ndash;4%</span>
                      </div>
                      <div
                        className="bg-red-500/30 border-r border-red-500/50 flex items-center justify-center"
                        style={{ width: '72%' }}
                      ...
                      <div
                        ...
                        style={{ width: '20%' }}
                      >
                        <span className="text-[9px] text-blue-400 font-medium">75%+</span>
                      </div>
                    </div>
                  </div>
                  {/* Petrol Vapour */}
                  <div>
                    ...
                    <div className="w-full h-6 bg-white/5 rounded-lg overflow-hidden flex">
                      <div
                        ...
                        style={{ width: '7%' }}
                      >
                        <span className="text-[9px] text-green-400 font-medium">&lt;1.4%</span>
                      </div>
                      <div
                        className="bg-red-500/30 border-r border-red-500/50 flex items-center justify-center"
                        style={{ width: '25%' }}
                      ...
                      <div
                        ...
                        style={{ width: '68%' }}
                      >
                        <span className="text-[9px] text-blue-400 font-medium">7.6%+</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Methane:</strong> Sewers, drains, landfill
                      sites, coal mines, and decomposing organic matter in enclosed spaces
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">LPG (Propane/Butane):</strong> Leaking gas
                      supplies, storage cylinders, catering equipment. Heavier than air &mdash;
                      accumulates in pits and low-lying areas
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Petrol vapour:</strong> Vehicle fuel tanks,
                      fuel storage areas, spills. Heavier than air. Extremely volatile.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hydrogen:</strong> Battery charging areas,
                      electrolysis, chemical reactions involving metals and acids. Very wide
                      flammable range (4&ndash;75%).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Solvent vapours:</strong> Paints, adhesives,
                      cleaning agents, degreasers, resins. Many solvents are heavier than air and
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Combustible dust:</strong> Grain, flour, coal,
                      wood, metal powders, and other finely divided materials can form explosive
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  five elements needed for a dust explosion are: combustible dust, an ignition
                  source, oxygen, dispersion (dust suspended in air), and confinement. Removing any
                  one element prevents the explosion. Grain silos, flour mills, and woodworking dust
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                In a flammable or explosive atmosphere, even a tiny source of ignition energy can
                trigger a devastating explosion. In a confined space, the consequences of an
                explosion are amplified by the enclosure &mdash; pressure waves are reflected and
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3 text-sm text-white/80">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hot work:</strong> Welding, cutting, brazing,
                      grinding, soldering &mdash; open flames and extreme temperatures
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Electrical sparks:</strong> Switching
                      electrical equipment on or off, loose connections, damaged cables, circuit
                      breakers operating
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Static electricity:</strong> Generated by
                      flowing liquids, powders, or gases; synthetic clothing; and movement of people
                      or equipment in dry conditions
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hot surfaces:</strong> Exhaust systems,
                      overheated bearings, steam pipes, friction from mechanical equipment
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Non-intrinsically-safe equipment:</strong>{' '}
                      Standard torches, mobile phones, power tools, cameras, and test instruments
                      that are not ATEX/Ex rated
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Impact sparks:</strong> Metal tools striking
                      metal surfaces. Non-sparking tools (brass, bronze, or beryllium-copper alloy)
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-500">Intrinsically Safe Equipment:</strong> Equipment
                  rated as &ldquo;intrinsically safe&rdquo; (marked with the Ex symbol) is designed
                  so that its electrical circuits cannot produce sparks or heat sufficient to ignite
                  a flammable atmosphere. In any confined space where a flammable or explosive
                  atmosphere may be present, <strong>only</strong> intrinsically safe (Ex) equipment
                  may be used. This includes gas monitors, torches, cameras, radios, and any other
                  electrical or electronic device taken into the space.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                When a confined space may contain a flammable or explosive atmosphere, the{' '}
                <strong>
                  Dangerous Substances and Explosive Atmospheres Regulations 2002 (DSEAR)
                </strong>{' '}
                and the <strong>ATEX Workplace Directive (1999/92/EC)</strong> impose specific
                requirements on employers. These regulations work alongside the Confined Spaces
                Regulations 1997 to ensure explosive atmospheres are assessed, classified, and
                controlled.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Risk assessment:</strong> The employer must
                      carry out a specific DSEAR risk assessment identifying all dangerous
                      substances present or likely to be present, and evaluating the risk of fire or
                      explosion
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazardous area classification:</strong> Areas
                      where explosive atmospheres may occur must be classified into zones (Zone 0,
                      1, or 2 for gases; Zone 20, 21, or 22 for dusts) based on the likelihood and
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Elimination and control:</strong> The first
                      priority is to eliminate the risk entirely (e.g. remove the dangerous
                      substance or prevent the explosive atmosphere forming). Where elimination is
                      not possible, control measures must be applied in the following hierarchy:
                      prevent ignition sources, use ventilation to keep concentrations below the
                      LEL, and mitigate the effects of any explosion
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Equipment selection:</strong> Only equipment
                      certified for the relevant ATEX zone may be used. Equipment must carry the
                      appropriate Ex marking and be suitable for the gas group and temperature class
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Warning signs:</strong> The entrance to any
                      classified hazardous area must display the EX warning triangle sign (yellow
                      triangle with EX marking)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hot-work permits:</strong> Any hot work in or
                      near a potentially explosive atmosphere requires a formal hot-work permit. The
                      permit must specify atmospheric monitoring requirements, fire precautions, and
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-500">For Electricians:</strong> As an electrician,
                  you may be asked to install, inspect, or maintain electrical equipment in or near
                  confined spaces classified under ATEX. You must ensure that any equipment you
                  install, repair, or work on is{' '}
                  <strong>appropriate for the zone classification</strong> of the area. Installing
                  non-Ex-rated equipment in a classified zone is a serious offence that could result
                  in prosecution and, more importantly, could cause a fatal explosion. Always check
                  the zone classification and the Explosion Protection Document (EPD) before
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Atmospheric hazards are the primary killer in confined spaces. Every confined-space
                entry must be preceded by thorough atmospheric testing, and the atmosphere must be
                continuously monitored throughout the work. The key categories are:
              </p>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-500">Golden Rule:</strong> Never enter a confined
                  space without confirming the atmosphere is safe using a properly calibrated,
                  bump-tested multi-gas detector. Never rely on your senses &mdash; many lethal
                  atmospheric hazards are completely{' '}
                  <strong>invisible, odourless, and tasteless</strong>. If any alarm triggers on
                  your monitor, evacuate immediately using the pre-planned escape route and do not
                  re-enter until the atmosphere has been made safe and re-tested.
                </p>
              </div>
            </div>
          </div>
