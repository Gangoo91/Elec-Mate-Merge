...
const faqs = [
  {
    question: 'How long should ventilation run before entry into a confined space?',
    answer:
  ...
  {
    question: 'Can natural ventilation ever be sufficient for confined space entry?',
    answer:
  ...
  {
    question: 'What happens if the ventilation system fails during work inside a confined space?',
    answer:
  ...
  {
    question: 'Is it always necessary to ventilate a confined space, or can RPE be used instead?',
    answer:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['4 m³ per hour', '25 m³ per hour', '100 m³ per hour', '500 m³ per hour'],
    correctAnswer: 2,
    explanation:
...
export default function ConfinedSpacesModule3Section4() {
  useSEO({
    title: 'Ventilation in Confined Spaces | Confined Spaces Module 3.4',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-3 mx-auto">
            <span className="text-cyan-500 text-xs font-semibold">MODULE 3 &middot; SECTION 4</span>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Purpose:</strong> Remove contaminants, maintain breathable atmosphere
              </li>
              <li>
                <strong>Preferred method:</strong> Positive pressure (blowing clean air in)
              </li>
              <li>
                <strong>Clean intake:</strong> Away from exhausts, traffic, chemical stores
              </li>
              <li>
                <strong>Verify with monitoring:</strong> Never rely on ventilation alone
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Heavy gases:</strong> Direct duct to the bottom of the space
              </li>
              <li>
                <strong>Light gases:</strong> Direct duct to the top of the space
              </li>
              <li>
                <strong>Flammable risk:</strong> ATEX-rated fans &amp; anti-static ducting
              </li>
              <li>
                <strong>Always monitor:</strong> Continuous four-gas readings throughout
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Confined spaces are, by definition, enclosed or substantially enclosed environments
                where the natural movement of air is severely restricted. Without intervention, the
                atmosphere inside a confined space can become{' '}
                <strong>immediately dangerous to life and health (IDLH)</strong> through three
                primary mechanisms: the build-up of toxic gases, the accumulation of flammable
                vapours, and the depletion of oxygen.
              </p>

              <p>
                Ventilation is the primary engineering control used to create and maintain a{' '}
                <strong>safe, breathable atmosphere</strong> inside a confined space. It serves
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Removing toxic contaminants</strong> &mdash;
                      displacing or diluting gases such as hydrogen sulphide (H&sub2;S), carbon
                      monoxide (CO), and carbon dioxide (CO&sub2;) to below their Workplace Exposure
                      Limits (WELs)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reducing flammable concentrations</strong>{' '}
                      &mdash; keeping flammable gas and vapour levels well below their Lower
                      Explosive Limit (LEL), typically below 10% LEL as the safe working threshold
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Maintaining oxygen levels</strong> &mdash;
                      ensuring the atmosphere contains between 19.5% and 23.5% oxygen by volume, the
                      safe range for human respiration
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Providing cooling</strong> &mdash; reducing
                      heat build-up in enclosed spaces, particularly during physical work or in
                      spaces exposed to heat sources such as industrial processes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Preventing re-accumulation</strong> &mdash;
                      continuous ventilation during work prevents contaminants from building up
                      again after the initial purge, particularly where the work itself generates
                      fumes (e.g. welding, painting, solvent use)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong>Approved Code of Practice (ACOP L101)</strong> accompanying the Confined
                  Spaces Regulations 1997 is clear: where atmospheric hazards are identified,
                  ventilation is a fundamental part of the safe system of work. It is not optional.
                </p>
              </div>

              <p>
                Ventilation is placed high on the hierarchy of control for confined space work
                because it is an <strong>engineering control</strong> &mdash; it addresses the
                hazard at source by physically changing the atmosphere, rather than relying on
                personal protective equipment (RPE) as the sole line of defence. However,
                ventilation must always be{' '}
                <strong>verified by continuous atmospheric monitoring</strong>. A fan running does
                not guarantee that the atmosphere is safe &mdash; only a calibrated four-gas monitor
                can confirm that.
              </p>
            </div>
          </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>wind, convection currents, and temperature differentials</strong> to move
                air through a space without the use of mechanical equipment. In theory, if a
                confined space has large openings at different levels and is exposed to prevailing
                wind, air movement may occur naturally. However, in the context of confined space
                work, natural ventilation has <strong>severe limitations</strong>.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      The space has{' '}
                      <strong className="text-white">large, unobstructed openings</strong> at
                      multiple levels (top and bottom) allowing through-flow of air
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                    <span>
                      There is <strong className="text-white">consistent wind</strong> driving air
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                    <span>
                      No hazardous substances are present, and the work being carried out does{' '}
                      <strong className="text-white">not generate fumes</strong> or deplete oxygen
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">confirms safe conditions</strong> throughout
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Unreliable:</strong> Wind speed and direction
                      change constantly and cannot be controlled
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Uncontrollable:</strong> Cannot be increased,
                      directed, or adjusted to target specific areas within the space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Unmeasurable:</strong> Difficult to quantify
                      the air change rate being achieved
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ineffective for enclosed spaces:</strong> Most
                      confined spaces have limited openings — a single manhole, a hatch, or a narrow
                      access point — which prevents effective natural air movement
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      ...
                      Heavier-than-air gases that have settled at the bottom of a space will not be
                      displaced by gentle air currents alone
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-500">Key Point:</strong> For the vast majority of
                  confined space entries, natural ventilation is <strong>not sufficient</strong>.
                  The ACOP L101 states that where atmospheric hazards exist or could develop,
                  mechanical ventilation should be provided. Natural ventilation should only be
                  relied upon where the risk assessment specifically demonstrates it is adequate —
                  and even then, continuous atmospheric monitoring is mandatory.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Positive pressure ventilation (PPV)</strong> involves using a powered fan or
                blower to <strong>blow clean, fresh air into the confined space</strong>. The fan is
                positioned outside the space, drawing clean air from a safe location, and ducting
                directs the airflow into the space. As fresh air is forced in, the contaminated air
                is displaced and pushed out through the entry point or other openings.
              </p>

              <p>
                Positive pressure ventilation is the{' '}
                <strong>preferred method for most confined space entries</strong> because of its
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; fresh air mixes with and reduces the concentration of toxic or
                      flammable gases across the whole volume
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                    <span>
                      ...
                      &mdash; the slight positive pressure inside the space resists the entry of
                      gases from the surrounding environment (e.g. from connected pipework or
                      adjacent chambers)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Provides continuous fresh air supply</strong>{' '}
                      &mdash; workers always have a stream of clean air flowing towards them
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Simple to set up and operate</strong> &mdash;
                      fan outside the space blowing air in through flexible ducting; no complex
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; works well when there is no single point source of contamination and
                      the aim is to improve the overall atmosphere
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  or where workers are located. The exhaust path (where contaminated air exits)
                  should be as far from the duct outlet as possible to avoid short-circuiting the
                  airflow.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-white/5 border border-white/10 rounded-lg p-4 relative">
                  ...
                  <div className="bg-cyan-500/10 border-2 border-dashed border-cyan-500/30 rounded-lg p-3 mb-3">
                    ...
                    <p className="text-[10px] text-cyan-400/60 text-center mt-1">
                ...
                <div className="bg-white/5 border border-white/10 rounded-lg p-4 relative">
                  ...
                  <div className="bg-amber-500/10 border-2 border-dashed border-amber-500/30 rounded-lg p-3 mb-3">
                    ...
                    <p className="text-[10px] text-amber-400/60 text-center mt-1">
                      Slight negative pressure (&minus;)
                    </p>
                  </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Negative pressure ventilation</strong> (also called extraction ventilation)
                uses a fan positioned outside the confined space to{' '}
                <strong>extract contaminated air out through ducting</strong>. As air is pulled out,
                fresh air is drawn in passively through the entry point or other openings to replace
                it. This creates a slight negative pressure (vacuum) inside the space.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Known contaminant source:</strong> The duct can
                      be placed directly at the source of contamination (e.g. a leaking valve, a
                      residue at the bottom of a tank) to extract the contaminant before it spreads
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Preventing spread:</strong> When the
                      contaminant must not be allowed to escape into the surrounding area (e.g.
                      toxic fumes that could affect workers outside the space, or during asbestos
                      work where negative pressure containment is required)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Welding and hot work:</strong> Local exhaust
                      ventilation (LEV) positioned near the weld point to capture fumes at source
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      Fresh air enters passively and may not reach all areas of the space
                      effectively, creating{' '}
                      <strong className="text-white">dead zones with poor air quality</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">draw in contaminants</strong> from connected
                      pipes, adjacent chambers, or the ground around the space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">overall dilution</strong> as positive pressure
                      — effective mainly at the extraction point
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Controlled airflow path:</strong> Air enters at
                      one location and exits at another, ensuring the entire space is swept by the
                      airflow
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Elimination of dead zones:</strong> The
                      push-pull action prevents stagnant pockets where contaminants could accumulate
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Higher air change rates:</strong> Two fans
                      working together achieve greater airflow than either alone
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Source extraction + general dilution:</strong>{' '}
                      One fan supplies clean air whilst the other extracts directly from the
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The quality of the air being supplied into the confined space is as important as the
                ventilation system itself. If the intake air is contaminated, the ventilation system
                will actively <strong>pump hazardous substances into the space</strong> &mdash;
                creating a more dangerous situation than having no ventilation at all. Air supply
                quality is one of the most commonly overlooked aspects of confined space
                ventilation, and one of the most dangerous when it goes wrong.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Away from vehicle exhausts:</strong> Position
                      the air intake well upwind and at a safe distance from any vehicles, plant, or
                      machinery that produce exhaust fumes (particularly carbon monoxide from petrol
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Away from generators:</strong> Portable
                      generators are a common source of carbon monoxide — the air intake must be
                      positioned upwind and far enough away that exhaust fumes cannot be drawn in
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Away from chemical stores:</strong> Chemical
                      storage areas, paint shops, fuel tanks, and any area where volatile substances
                      are present or being used
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Away from dust and particulates:</strong>{' '}
                      Construction dust, grinding debris, and other airborne particulates should not
                      be drawn into the ventilation system
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Away from the exhaust outlet:</strong> The
                      contaminated air being exhausted from the space must not be recirculated back
                      through the intake — position them as far apart as possible
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Shortest practical route:</strong> Every bend,
                      kink, or additional length of ducting reduces airflow. Keep the duct run as
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Avoid sharp bends:</strong> Use gradual curves
                      rather than tight 90-degree bends, which significantly restrict airflow
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Correct diameter:</strong> The duct must be the
                      correct diameter for the fan — too narrow restricts flow, too wide reduces air
                      velocity. Common sizes are 200mm (8&Prime;), 300mm (12&Prime;), and 400mm
                      (16&Prime;) diameter
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Secure and protected:</strong> Ducting must be
                      secured so it cannot be dislodged, crushed, or kinked during work. Protect it
                      from vehicle traffic, sharp edges, and tripping hazards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Anti-static ducting:</strong> In flammable
                      atmospheres, anti-static ducting must be used and properly earthed to prevent
                      the build-up of static charges that could produce a spark (see Section 07)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  is odourless and colourless — workers cannot detect it. They lose consciousness
                  rapidly and die if not rescued. Always verify that the air intake is drawing from
                  a genuinely clean source, and confirm with atmospheric monitoring inside the
                  space.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>air change rate</strong> is the number of times the entire volume of air
                in a space is replaced per hour. It is a key metric for determining whether
                ventilation is adequate. Too few air changes and contaminants will not be
                sufficiently diluted; too many and you may waste energy or create excessive noise
                and wind chill without additional benefit.
              </p>
                  ...
                  <table className="w-full text-sm text-white/80 border-collapse">
                    ...
                    <tbody className="divide-y divide-white/5">
                      <tr>
                        ...
                        <td className="py-2 font-medium text-white">5&ndash;10</td>
                      </tr>
                      <tr>
                        <td className="py-2 pr-4">
                          Moderate contaminant levels or fume-generating work
                        </td>
                        <td className="py-2 font-medium text-white">10&ndash;20</td>
                      </tr>
                      <tr>
                        <td className="py-2 pr-4">High contaminant levels, hot work, or welding</td>
                        <td className="py-2 font-medium text-white">20&ndash;30+</td>
                      </tr>
                      <tr>
                        <td className="py-2 pr-4">Pre-entry purge (before workers enter)</td>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="bg-[#1a1a1a] border border-white/10 rounded-lg p-3 mb-3 font-mono text-sm text-center">
                  ...
                  <p className="text-white text-lg">
                    =&nbsp;&nbsp;Space Volume (m&sup3;)&nbsp;&nbsp;&times;&nbsp;&nbsp;Air Changes
                    per Hour
                  </p>
                </div>
                <div className="space-y-3 text-sm text-white/80">
                  <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-3">
                    ...
                    <p>
                      A cylindrical tank has a diameter of 3m and a height of 4m. Volume = &pi;
                      &times; r&sup2; &times; h = &pi; &times; 1.5&sup2; &times; 4 &asymp;{' '}
                      <strong className="text-white">28.3 m&sup3;</strong>.
                    </p>
                    <p className="mt-1">
                      For moderate-risk work (15 air changes/hour): 28.3 &times; 15 ={' '}
                      <strong className="text-white">424.5 m&sup3;/hr</strong> &asymp; 250 CFM.
                    </p>
                  </div>
                  <div className="bg-cyan-500/10 border border-cyan-500/20 rounded-lg p-3">
                    <p className="text-cyan-400 text-xs font-bold mb-1.5">WORKED EXAMPLE 2</p>
                    <p>
                      A rectangular chamber measures 2m &times; 3m &times; 2.5m. Volume = 2 &times;
                      3 &times; 2.5 = <strong className="text-white">15 m&sup3;</strong>.
                    </p>
                    <p className="mt-1">
                      For pre-entry purge (10 complete air changes): 15 &times; 10 ={' '}
                      <strong className="text-white">150 m&sup3;</strong> total. With a fan rated at
                      300 m&sup3;/hr, this takes 30 minutes.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-500">Important:</strong> Air change rate calculations
                  provide a <strong>starting point</strong>, not a guarantee of safety. Factors such
                  as the type and concentration of contaminants, duct losses from bends and length,
                  the presence of obstacles in the space, and the number of workers all affect the
                  actual effectiveness. The{' '}
                  <strong>only reliable confirmation is atmospheric monitoring</strong> showing safe
                  readings inside the space.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Different atmospheric hazards require different ventilation strategies. The{' '}
                <strong>density of the contaminant gas</strong> relative to air determines where it
                accumulates within the space, and therefore where the ventilation duct must be
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">bottom of the space</strong> to displace the
                      heavy gas layer upwards and out
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">lowest point</strong> to pull the heavy gas
                      directly from where it accumulates
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      Monitor at <strong className="text-white">multiple levels</strong> —
                      particularly at floor level — to confirm the gas layer is being displaced
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">top of the space</strong> to displace or
                      extract the light gas from the ceiling
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      Monitor at the{' '}
                      <strong className="text-white">highest accessible point</strong> to detect
                      accumulation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      Be particularly cautious with methane and hydrogen as both are{' '}
                      <strong className="text-white">highly flammable</strong> — ATEX-rated
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  air removes heat from the space and reduces the core body temperature risk to
                  workers. In these situations, higher air change rates may be needed specifically
                  for thermal comfort and heat stress prevention, even if there are no chemical
                  contaminants present. The ventilation plan should consider the temperature of the
                  incoming air and whether additional cooling measures (such as spot coolers or
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">High-toxicity substances:</strong> Some
                      chemicals have extremely low WELs (e.g. hydrogen cyanide, arsine) where even
                      small residual concentrations after ventilation may be dangerous
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      ...
                      Where contaminant concentrations are so high that ventilation cannot reduce
                      them to safe levels quickly enough
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Oxygen-deficient atmospheres:</strong> Where
                      the oxygen concentration cannot be raised to safe levels (e.g. inerted vessels
                      that must remain inerted during work)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Continuous contaminant generation:</strong>{' '}
                      Where the work itself generates contaminants faster than ventilation can
                      remove them (e.g. large-scale grinding, spray painting, or solvent cleaning)
                    </span>
                  </li>
                </ul>
                <p className="text-sm text-white/80 mt-3">
                  ...
                  the method statement. Self-contained breathing apparatus (SCBA) or airline
                  breathing apparatus may be required. The choice depends on the hazard type,
                  duration of work, and the space configuration.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Selecting the correct ventilation equipment is essential for effective and safe
                operation. The choice of fan, ducting, and configuration depends on the size and
                geometry of the space, the type and concentration of contaminants, the required
                airflow rate, and whether a flammable or explosive atmosphere may be present.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/5 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white/80">
                      ...
                      200mm to 400mm diameter. Best suited for general purging and dilution
                      ventilation.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/5 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white/80">
                      ...
                      fans but can overcome the resistance caused by long or complex duct routes.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/5 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white/80">
                      ...
                      powerful than electric fans but are the safest option where ignition risk is
                      the primary concern.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/5 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white/80">
                      ...
                      Anti-static ducting (typically black with a conductive wire spiral) must be
                      used in flammable environments and properly earthed at both ends.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">ATEX fans:</strong> Motors are sealed,
                      spark-proof, and certified for use in explosive atmospheres. They carry the
                      ATEX &ldquo;Ex&rdquo; marking with the appropriate zone classification
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Anti-static ducting:</strong> Prevents static
                      charge build-up. Must be earthed at both ends and at any joints to provide a
                      continuous path to earth
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Pneumatic/air-driven equipment:</strong>{' '}
                      Venturi ejectors powered by compressed air are inherently safe as they have no
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Earthing and bonding:</strong> All metallic
                      components (fans, ducts, clips, frames) must be earthed and bonded to prevent
                      static accumulation
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  charges sufficient to create a spark. Either of these can ignite a flammable
                  gas-air mixture, causing an explosion within the confined space. There have been
                  multiple recorded incidents and fatalities from this exact scenario.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      Type and specification of ventilation equipment (fan type, airflow rating,
                      ATEX classification if applicable)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>Duct size, material, routing, and outlet position within the space</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      Location of the clean air intake and measures to protect it from contamination
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>Required air change rate and how it was calculated</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      Pre-entry purge duration and the criteria for confirming the space is safe to
                      enter (atmospheric monitoring thresholds)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      Continuous ventilation requirements during work and the frequency of
                      atmospheric monitoring
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      Emergency procedures in the event of ventilation failure — including immediate
                      evacuation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      Backup ventilation arrangements (if a single fan fails, is there a spare on
                      standby?)
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2">
                  <div className="bg-red-500/5 border border-red-500/20 rounded-lg p-3">
                    <p className="text-sm text-white">
                      <strong className="text-red-400">Insufficient air volume:</strong> Using a fan
                      that is too small for the space, resulting in inadequate air changes and
                      failure to reduce contaminant levels to safe thresholds. Always calculate the
                      required airflow rate and select a fan that exceeds it.
                    </p>
                  </div>
                  <div className="bg-red-500/5 border border-red-500/20 rounded-lg p-3">
                    <p className="text-sm text-white">
                      <strong className="text-red-400">Contaminated intake air:</strong> Positioning
                      the air intake near vehicle exhausts, generators, or chemical stores — pumping
                      toxic gases directly into the space. This is the single most dangerous
                      ventilation error.
                    </p>
                  </div>
                  <div className="bg-red-500/5 border border-red-500/20 rounded-lg p-3">
                    <p className="text-sm text-white">
                      ...
                      Assuming that because the fan is running, the atmosphere must be safe.
                      Ventilation must always be verified by continuous atmospheric monitoring — a
                      running fan is not a guarantee.
                    </p>
                  </div>
                  <div className="bg-red-500/5 border border-red-500/20 rounded-lg p-3">
                    <p className="text-sm text-white">
                      <strong className="text-red-400">Incorrect duct placement:</strong> Placing
                      the duct at the wrong level for the gas density — e.g. directing air to the
                      top of the space when the hazard is a heavier-than-air gas settled at the
                      bottom.
                    </p>
                  </div>
                  <div className="bg-red-500/5 border border-red-500/20 rounded-lg p-3">
                    <p className="text-sm text-white">
                      <strong className="text-red-400">Short-circuiting airflow:</strong>{' '}
                      Positioning the duct inlet and the exhaust outlet too close together, so clean
                      air exits the space before it has circulated and diluted contaminants.
                    </p>
                  </div>
                  <div className="bg-red-500/5 border border-red-500/20 rounded-lg p-3">
                    <p className="text-sm text-white">
                      ...
                      Standard electrical fans producing sparks or static discharge in the presence
                      of flammable gases — a direct path to explosion.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  Ventilation is <strong>never a substitute for atmospheric monitoring</strong>. It
                  is a control measure that requires continuous verification. The four-gas monitor
                  is the only tool that can confirm whether the ventilation system is achieving its
                  purpose. If the monitor shows unsafe readings despite ventilation being in
                  operation, the system is either inadequate or has a fault — either way,{' '}
