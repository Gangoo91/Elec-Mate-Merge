...
const faqs = [
  {
    question: 'Can I use standard 230V tools if I plug them into an RCD-protected socket?',
    answer:
  ...
  {
    question: 'What IP rating should portable appliances have for use in damp confined spaces?',
    answer:
  ...
  {
    question: 'Is it ever permitted to work on live electrical equipment inside a confined space?',
    answer:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['230V with RCD protection', '110V CTE', '25V', '12V'],
    correctAnswer: 3,
    explanation:
...
export default function ConfinedSpacesModule4Section4() {
  useSEO({
    title: 'Electrical Work in Confined Spaces | Confined Spaces Module 4.4',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-3 mx-auto">
            <span className="text-cyan-400 text-xs font-semibold">MODULE 4 &middot; SECTION 4</span>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>110V CTE:</strong> Max 55V to earth for portable tools in confined spaces
              </li>
              <li>
                <strong>30mA RCD:</strong> Additional protection on ALL circuits supplying confined
                spaces
              </li>
              <li>
                <strong>Battery tools:</strong> Preferred option &mdash; eliminates mains shock risk
                entirely
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              ...
              <li>
                <strong>BS 7671 Section 706:</strong> Conducting locations with restricted movement
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Electrical work always carries risk, but in a confined space those risks are{' '}
                <strong>significantly amplified</strong>. Multiple hazard factors combine to create
                conditions where even a relatively minor electrical fault can be fatal.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Wet and damp conditions:</strong> Many confined
                      spaces such as tanks, manholes, and ducts are inherently damp or contain
                      standing water. Moisture dramatically{' '}
                      <strong className="text-white">reduces body resistance</strong> &mdash; dry
                      skin typically has a resistance of around 100,000&nbsp;&Omega;, but wet skin
                      can fall below 1,000&nbsp;&Omega;. This means the shock current flowing
                      through the body at any given voltage is significantly higher in wet
                      conditions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Conductive surroundings:</strong> Metal tanks,
                      steel vessels, cast-iron manholes, and reinforced concrete structures create
                      an environment where the worker is in{' '}
                      <strong className="text-white">intimate contact with earth</strong>. Any fault
                      in electrical equipment can find an easy return path through the
                      worker&rsquo;s body to the surrounding conductive structure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Restricted movement:</strong> The physical
                      constraints of a confined space mean the worker cannot easily move away from
                      an electrical hazard. In an open area, a person receiving a shock may be
                      thrown clear or be able to step back &mdash; in a confined space, there is{' '}
                      <strong className="text-white">nowhere to go</strong>. The limited escape
                      route also means that rescue is more difficult and takes longer
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Arc flash amplification:</strong> In an
                      enclosed metal space, an arc flash does not dissipate into the surrounding air
                      as it would in an open area. The{' '}
                      <strong className="text-white">
                        thermal energy and pressure wave are concentrated
                      </strong>{' '}
                      within the enclosure, reflecting off metal walls and intensifying the blast
                      effect. The superheated air, molten metal, and pressure wave have nowhere to
                      expand, making even a relatively small arc flash potentially fatal in a
                      confined space
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">fatal</strong> inside a damp metal tank where the
                  worker is in direct contact with conductive surfaces and cannot escape. This is
                  why BS&nbsp;7671 requires specific additional precautions for all electrical work
                  in conducting locations with restricted movement.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The primary protection against electric shock in confined spaces is{' '}
                <strong>voltage reduction</strong>. By reducing the supply voltage, the potential
                shock current through the body is reduced to a level that is less likely to cause
                serious injury or death. BS&nbsp;7671 Chapter 70 series specifies the maximum
                voltages permitted for different equipment types and conditions.
              </p>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">portable power tools</strong> in confined
                      spaces is 110V from a centre-tapped earth transformer
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The centre-tap on the secondary winding means each conductor is only{' '}
                      <strong className="text-white">55V relative to earth</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      If a person touches a live conductor, the maximum shock voltage is 55V &mdash;
                      roughly <strong className="text-white">one quarter</strong> of the standard
                      230V mains supply
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">yellow sockets and plugs</strong> so they are
                      easily identified on site
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Where conditions are <strong className="text-white">damp</strong> (but not
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">held in the hand</strong> and frequently moved
                      around the space, increasing the chance of mechanical damage to the lamp or
                      cable
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Supplied from a{' '}
                      <strong className="text-white">safety isolating transformer</strong> complying
                      with BS&nbsp;EN&nbsp;61558
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      In <strong className="text-white">very wet or flooded</strong> confined
                      spaces, hand lamps must not exceed <strong className="text-white">12V</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      At 12V, even direct contact with a live conductor in wet conditions is{' '}
                      <strong className="text-white">
                        unlikely to produce a dangerous shock current
                      </strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      This is the <strong className="text-white">lowest voltage category</strong>{' '}
                      specified in BS&nbsp;7671 and provides the maximum level of protection against
                      electric shock
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">BS 7671 Section 706:</strong> These voltage
                  limits are specified in BS&nbsp;7671 Chapter 70 series, specifically{' '}
                  <strong>Section 706 &mdash; Conducting Locations with Restricted Movement</strong>
                  . This section applies to any location where a person is in contact with or in
                  close proximity to conductive parts and where freedom of bodily movement is
                  restricted. The voltage limits are <strong>maximum values</strong> &mdash; lower
                  voltages should always be used where practicable.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-[#111] border-2 border-cyan-500/40 rounded-xl p-4 sm:p-6 overflow-x-auto">
              ...
              <div className="mt-4 bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-3 text-center">
                <p className="text-[10px] sm:text-xs text-cyan-300 font-medium">
                  ALL voltages above require 30mA RCD additional protection &mdash; RCD does NOT
                  replace reduced voltage
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Residual current devices (RCDs) provide <strong>additional protection</strong>{' '}
                against electric shock by detecting imbalances between the line and neutral
                currents, which indicate that current is flowing to earth through an unintended path
                &mdash; potentially through a person&rsquo;s body.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">30mA RCD</strong> must protect ALL circuits
                      supplying a confined space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Must disconnect the supply within <strong className="text-white">40ms</strong>{' '}
                      at the rated residual current
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Must be <strong className="text-white">tested before each use</strong> using
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Applies to <strong className="text-white">all voltage levels</strong> &mdash;
                      110V CTE, 25V, and 12V circuits must all have RCD protection
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  together. An RCD can fail to trip (e.g., due to nuisance tripping being
                  &ldquo;solved&rdquo; by bypassing the device, or a mechanical fault in the trip
                  mechanism), so it must never be relied upon as the sole means of protection. The
                  reduced voltage limits the maximum shock energy, while the RCD provides a
                  fast-acting backup that disconnects the supply if a fault occurs.
                </p>
              </div>

              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">Testing:</strong> The RCD must be tested using
                  the integral test button <strong>before each period of use</strong>. In addition,
                  periodic testing with a calibrated RCD tester should confirm the actual trip time
                  and trip current are within specification. Any RCD that fails to trip when tested
                  must be <strong>immediately removed from service</strong> and replaced.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Battery-powered (cordless) tools are the <strong>preferred option</strong> for all
                electrical work in confined spaces. They offer the most fundamental form of
                protection: <strong>eliminating the mains electrical risk entirely</strong>.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">No mains connection</strong> &mdash; completely
                      eliminates the risk of mains electric shock
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">No trailing cables</strong> &mdash; eliminates
                      trip hazards and cable damage risks
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">No transformer required</strong> &mdash;
                      reduces the amount of equipment needed at the entry point
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Greater mobility</strong> within the confined
                      space without cable constraints
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Power output</strong> &mdash; may not be
                      sufficient for heavy-duty tasks such as large cable cutting or heavy conduit
                      bending
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Battery duration</strong> &mdash; finite run
                      time, which is particularly problematic for extended confined space operations
                      where frequent battery changes require re-entering and exiting the space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Battery management</strong> &mdash; spare
                      batteries must be available and charged; batteries should not be charged
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Not suitable for all tasks</strong> &mdash;
                      some operations such as sustained drilling into concrete or large-diameter
                      cable preparation may exceed battery tool capabilities
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">Best Practice:</strong> Battery-powered tools
                  should always be the <strong>first choice</strong> for confined space work. Only
                  when battery tools cannot deliver the required performance should mains-powered
                  tools on reduced-voltage supplies be considered. Even when mains-powered tools
                  must be used, plan the work so that the maximum amount is completed with battery
                  tools first, minimising the time mains supplies are present in the confined space.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Safe isolation is <strong>critical before any confined space entry</strong> where
                electrical hazards exist. The consequences of a failure in isolation are far more
                severe in a confined space than in an open area, so the procedure must be followed
                rigorously with no shortcuts.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Identify all sources of supply</strong> to the
                      confined space and to all equipment within it &mdash; check drawings, trace
                      cables, and verify with the duty holder. Consider both normal and emergency
                      supplies, standby generators, UPS systems, and any adjacent circuits that
                      could be inadvertently contacted
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-5 h-5 rounded-full bg-cyan-500/20 border border-cyan-500/40 flex items-center justify-center flex-shrink-0 text-[10px] font-bold text-cyan-400">
                    ...
                    <span>
                      <strong className="text-white">Switch off and lock off</strong> each supply at
                      the nearest point of isolation. Each supply must be individually identified,
                      switched off, and locked using a{' '}
                      <strong className="text-white">personal padlock</strong> &mdash; every person
                      entering the confined space must fit their own lock to every isolation point
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-5 h-5 rounded-full bg-cyan-500/20 border border-cyan-500/40 flex items-center justify-center flex-shrink-0 text-[10px] font-bold text-cyan-400">
                    ...
                    <span>
                      <strong className="text-white">Prove dead</strong> at the point of work using
                      an approved voltage indicator. Follow the{' '}
                      <strong className="text-white">prove-test-prove method</strong>: prove the
                      voltage indicator works on a known live source, test the isolated circuit at
                      the point of work, then prove the voltage indicator still works on the known
                      live source
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Fit caution notices</strong> at each isolation
                      point &mdash; &ldquo;DANGER &mdash; Do not switch on &mdash; Personnel working
                      in confined space&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-5 h-5 rounded-full bg-cyan-500/20 border border-cyan-500/40 flex items-center justify-center flex-shrink-0 text-[10px] font-bold text-cyan-400">
                    ...
                    <span>
                      <strong className="text-white">Complete the isolation register</strong>{' '}
                      &mdash; record all isolation points, lock numbers, the name of each person who
                      has locked on, date and time of isolation, and the scope of work authorised
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  removed by the person who fitted it, and only after they have personally confirmed
                  that they are clear of the confined space and it is safe to re-energise. A
                  &ldquo;master key&rdquo; system must <strong className="text-white">never</strong>{' '}
                  be used for confined space isolation &mdash; there must be no possibility of a
                  supply being restored while someone is still inside the space.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                When mains-powered equipment must be used in a confined space, the routing of supply
                cables and the provision of temporary lighting are{' '}
                <strong>critical safety considerations</strong>. Poor cable management or inadequate
                lighting significantly increases the risk of incidents.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Never trail cables across the entry/exit point
                      </strong>{' '}
                      &mdash; in an emergency, cables across the escape route could trip a person or
                      obstruct rescue
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Use <strong className="text-white">overhead cable supports</strong> or
                      wall-mounted hangers where possible to keep cables clear of the working area
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      ...
                      &mdash; especially where they pass through access openings or over sharp
                      edges. Use cable protectors, rubber matting, or conduit sections
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Avoid <strong className="text-white">tight bends or kinks</strong> that could
                      damage insulation and create fault points
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Inspect all cables before use</strong> &mdash;
                      check for cuts, abrasion, damaged plugs, and signs of overheating at
                      connections
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Adequate illumination</strong> must be provided
                      throughout the confined space &mdash; working in poor light increases the risk
                      of contact with live parts and slips/trips
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Voltage must match conditions</strong> &mdash;
                      25V for damp, 12V for very wet confined spaces (as above)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">LED luminaires preferred</strong> &mdash; less
                      heat output (reducing burn risk and ignition hazard), lower power consumption,
                      longer battery-backup run times, more robust than filament or fluorescent
                      lamps
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">ATEX-rated in flammable atmospheres</strong>{' '}
                      &mdash; where gas, vapour, or dust could create an explosive atmosphere, ALL
                      electrical equipment (including lighting) must carry the appropriate Ex
                      marking under the ATEX Directive (2014/34/EU)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Emergency lighting</strong> &mdash; a
                      battery-powered emergency torch should be carried by each person entering the
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">ATEX Zones:</strong> Before selecting lighting
                  or any electrical equipment for a confined space with a potentially flammable
                  atmosphere, the space must be <strong>gas-tested</strong> and a competent person
                  must determine the <strong>zone classification</strong> (Zone 0, 1, or 2 for
                  gases; Zone 20, 21, or 22 for dusts). The equipment&rsquo;s Ex rating must match
                  or exceed the zone classification. Using equipment rated for a lower-risk zone in
                  a higher-risk zone is a <strong>serious safety breach</strong>.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>specific additional precautions</strong> beyond those applied to standard
                testing. The restricted environment and conductive surroundings mean that test
                voltages which would normally present minimal risk become significantly more
                dangerous.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Test instruments must be battery-powered
                      </strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Insulation resistance testing</strong> (which
                      applies a high test voltage, typically 500V DC) must only be carried out after
                      full isolation and proving dead of all circuits within the space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Earth continuity testing</strong> &mdash;
                      ensure the test instrument leads are in good condition and that exposed test
                      probes do not contact the conductive surroundings during testing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">A standby person must be present</strong>{' '}
                      outside the space at all times during testing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The <strong className="text-white">permit to work</strong> must specifically
                      authorise the testing activity and identify which tests are to be carried out
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Use only <strong className="text-white">approved test equipment</strong> that
                      complies with GS&nbsp;38 (guidance on test instruments)
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">current PAT test label</strong> before being
                      taken into any confined space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">IP ratings</strong> must be appropriate for the
                      environment &mdash; minimum IP44 for damp conditions, IP55 or higher for very
                      wet conditions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Class II (double-insulated)</strong> equipment
                      is preferred over Class I in confined spaces because it does not rely on an
                      earth connection for protection
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">before each use</strong> &mdash; reject any
                      item showing damage, discolouration, or signs of overheating
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  and limited escape routes makes live working exceptionally dangerous. Live working
                  may only be considered where it is{' '}
                  <strong className="text-white">unreasonable in all the circumstances</strong> for
                  the equipment to be dead, where it is reasonable for the person to be working near
                  live conductors, and where{' '}
                  <strong className="text-white">suitable additional precautions</strong> are in
                  place. Even then, a specific risk assessment, method statement, and written
                  authorisation from a senior authorised person are required. In practice, live
                  working in confined spaces is{' '}
                  <strong className="text-white">almost never justified</strong> and must be avoided
                  wherever possible.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Emergency shutdown arrangements are a <strong>critical safety requirement</strong>{' '}
                for any confined space where electrical supplies are present. The ability to rapidly
                disconnect all supplies from outside the space can be the difference between a
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">
                        clearly identified and accessible from OUTSIDE
                      </strong>{' '}
                      the confined space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Must disconnect{' '}
                      <strong className="text-white">ALL electrical supplies</strong> to the
                      confined space, including temporary supplies brought in for the work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The <strong className="text-white">standby person</strong> must know the
                      location and operation of the emergency shutdown before entry begins
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Rescue team members</strong> must also be
                      briefed on the emergency shutdown location and operation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">clearly labelled</strong> &mdash;
                      &ldquo;EMERGENCY ELECTRICAL SHUTDOWN &mdash; Confined Space&rdquo;
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Cable jointing in manholes:</strong> Manholes
                      are often damp or flooded, with metal ladder rungs, cast-iron covers, and
                      cables running through the walls. Use 12V or 25V lighting depending on water
                      levels. Battery-powered tools are essential. All adjacent cables in the
                      manhole must be identified and isolated or proved dead before work begins.
                      Manhole covers must remain open for ventilation and escape &mdash; never work
                      in a sealed manhole with electrical equipment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-5 h-5 rounded-full bg-cyan-500/20 border border-cyan-500/40 flex items-center justify-center flex-shrink-0 text-[10px] font-bold text-cyan-400">
                    ...
                    <span>
                      <strong className="text-white">Switchgear maintenance in substations:</strong>{' '}
                      Small substations can meet the definition of a confined space when access is
                      restricted and a foreseeable hazard exists. High-voltage and low-voltage
                      switchgear may be present. Arc flash risk is extremely high in enclosed
                      switchgear rooms. Full safe isolation, arc flash PPE, and emergency shutdown
                      accessible from outside the substation are essential. Consider remote racking
                      of circuit breakers to reduce time spent in the confined area
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-5 h-5 rounded-full bg-cyan-500/20 border border-cyan-500/40 flex items-center justify-center flex-shrink-0 text-[10px] font-bold text-cyan-400">
                    ...
                    <span>
                      <strong className="text-white">Motor replacement in plant rooms:</strong>{' '}
                      Enclosed plant rooms with large rotating machinery can be classified as
                      confined spaces. Motors may have multiple supply feeds (power, control,
                      heaters). ALL supplies to the motor must be identified and isolated &mdash;
                      not just the main power supply. Stored energy in capacitors must be safely
                      discharged before work begins. Adequate temporary lighting is essential when
                      the plant room&rsquo;s normal lighting circuits are isolated for safety
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-5 h-5 rounded-full bg-cyan-500/20 border border-cyan-500/40 flex items-center justify-center flex-shrink-0 text-[10px] font-bold text-cyan-400">
                    ...
                    <span>
                      <strong className="text-white">Cable installation in ducts:</strong> Cable
                      ducts and trunking routes can become confined spaces, particularly underground
                      or within building risers. Existing cables in the duct may be live &mdash;
                      they must be identified and either isolated or physically protected before new
                      cables are drawn through. Cable pulling equipment must be on reduced-voltage
                      supplies. Adequate lighting and communication between the duct entry and exit
                      points are essential for safe cable pulling operations
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-[#111] border-2 border-cyan-500/40 rounded-xl p-4 sm:p-6 overflow-x-auto">
              ...
              <div className="mt-4 bg-red-500/10 border border-red-500/30 rounded-lg p-3 text-center">
                <p className="text-[10px] sm:text-xs text-red-300 font-medium">
                  ALL phases must be completed and verified BEFORE electrical work begins in the
                  confined space
                </p>
              </div>
