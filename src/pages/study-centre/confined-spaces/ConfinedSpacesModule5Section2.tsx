import { ArrowLeft, Heart, CheckCircle, AlertTriangle, ShieldCheck } from 'lucide-react';
...
const faqs = [
  ...
  {
    question: 'What is the difference between a rescue harness and a standard fall arrest harness?',
    answer:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['50-80 kg', '80-120 kg', '140-180 kg', '200-300 kg'],
    correctAnswer: 2,
    explanation:
...
export default function ConfinedSpacesModule5Section2() {
  useSEO({
    title: 'Rescue Equipment & Techniques | Confined Spaces Module 5.2',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-3 mx-auto">
            <span className="text-cyan-500 text-xs font-semibold">MODULE 5 &middot; SECTION 2</span>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Non-entry rescue:</strong> Preferred method &mdash; retrieve from outside
                using mechanical means
              </li>
              <li>
                <strong>Man-riding winch:</strong> Rated 140-180 kg, fall arrest built in, LOLER
                examined every 6 months
              </li>
              <li>
                <strong>Lifeline taut:</strong> Connected to dorsal D-ring, kept taut at all times
                during entry
              </li>
              <li>
                <strong>Pre-positioned:</strong> ALL rescue equipment at the entry point BEFORE work
                begins
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Tripod + winch:</strong> Vertical entries &mdash; manholes, hatches, shafts
              </li>
              <li>
                <strong>Stretcher:</strong> Neil Robertson or basket stretcher for vertical
                retrieval
              </li>
              <li>
                <strong>Rescue BA:</strong> SCBA for immediate entry, airline BA for extended
                operations
              </li>
              <li>
                <strong>First aid:</strong> Resuscitation, oxygen therapy, spinal immobilisation at
                entry point
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Non-entry rescue is the <strong>preferred method</strong> for retrieving a casualty
                from a confined space. The principle is straightforward: rather than sending
                additional people into the hazardous environment, the casualty is retrieved from{' '}
                <strong>outside</strong> the space using mechanical means. This approach eliminates
                the single greatest cause of multiple fatalities in confined space incidents &mdash;
                rescuers entering the space and being overcome by the same hazard that incapacitated
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  who entered the space without adequate protection. Non-entry rescue breaks this
                  cycle by keeping rescue personnel outside the hazardous environment at all times.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Before Entry</p>
                      <p>
                        A rescue lifeline is attached to the worker&rsquo;s dorsal attachment point
                        (the D-ring between the shoulder blades on the rescue harness). The other
                        end of the lifeline is connected to a man-riding rescue winch mounted on a
                        tripod or davit arm positioned directly above or adjacent to the entry
                        point.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">During Work</p>
                      <p>
                        The lifeline remains connected and is kept{' '}
                        <strong className="text-white">taut</strong> at all times. The standby
                        person monitors the worker from outside. If the worker collapses, becomes
                        unresponsive, or signals distress, retrieval can begin immediately without
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Retrieval</p>
                      <p>
                        The standby person (or winch operator) engages the raise function on the
                        winch. The casualty is raised vertically through the opening to the surface,
                        where first aid and further medical treatment can be provided in a safe
                        environment.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-500">Key Principle:</strong> Non-entry rescue only
                  works if the correct equipment is in place <strong>before</strong> entry begins. A
                  harness without a connected lifeline, a winch without a tripod, or a lifeline with
                  excessive slack are all situations where non-entry rescue will fail when it is
                  needed most.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>tripod and rescue winch</strong> is the most commonly used non-entry
                rescue system for vertical confined space entries &mdash; manholes, hatches, shafts,
                and similar openings. The tripod is positioned directly over the opening, and the
                winch is mounted at the apex, providing a direct vertical lifting line into the
                space below.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Adjustable legs</strong> &mdash; to accommodate
                      uneven ground and different opening sizes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Safety chain</strong> &mdash; connects the legs
                      to prevent accidental spreading under load
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Rated load</strong> &mdash; must be rated for
                      the combined weight of the person, PPE, tools, and rescue equipment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Feet positioned on firm ground</strong> &mdash;
                      never on loose fill, soft earth, or unstable surfaces
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Man-riding certification</strong> &mdash; the
                      winch must be specifically designed, tested, and certified for raising and
                      lowering persons
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Rated load capacity</strong> &mdash; typically{' '}
                      <strong className="text-cyan-400">140-180 kg</strong>, accounting for worker
                      weight plus PPE and tools
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fall arrest capability</strong> &mdash;
                      integrated mechanism to arrest a fall automatically if the person slips or the
                      winch malfunctions during descent
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Controlled descent and ascent</strong> &mdash;
                      smooth, controlled lowering and raising at a safe speed to prevent injury
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Thorough examination under LOLER</strong>{' '}
                      &mdash; at least every <strong className="text-cyan-400">6 months</strong> for
                      man-riding equipment, with annual servicing as specified by the manufacturer
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-500">Davit Arm Systems:</strong> Where a tripod
                  cannot be positioned over the opening (e.g. obstructions, limited headroom), a{' '}
                  <strong>davit arm</strong> provides an alternative. The davit arm is mounted on a
                  fixed or portable base adjacent to the opening, with a swing arm that extends over
                  the entry point. An integrated winch is mounted on the arm. Davit systems offer
                  the same rescue capability as tripods but allow the base to be offset from the
                  opening, making them suitable for entries where overhead clearance is restricted
                  or where the opening is flush with a wall.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="min-w-[300px] max-w-lg mx-auto space-y-3">
              ...
              <div className="flex items-end justify-between px-4 sm:px-8">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-[9px] text-cyan-400 mt-1 font-medium">Lifeline (taut)</span>
                </div>
                <div className="flex flex-col items-center">
                  <div className="w-px h-10 bg-white/20 rotate-[-25deg]" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every person entering a confined space where non-entry rescue is part of the rescue
                plan must wear a <strong>full body rescue harness</strong> with a{' '}
                <strong>dorsal attachment point</strong> (the D-ring located between the shoulder
                blades). The rescue lifeline is connected to this dorsal D-ring before the worker
                enters the space, and the other end is connected to the rescue winch.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Full body harness</strong> &mdash; not a belt
                      or chest harness; must distribute the load across the torso and thighs during
                      suspension
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Dorsal attachment point</strong> &mdash; the
                      D-ring between the shoulder blades, rated for suspension rescue and for
                      connecting to the rescue lifeline
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Correct sizing and adjustment</strong> &mdash;
                      a loose or ill-fitting harness can shift during suspension, causing the
                      casualty to slip out or suffer suspension trauma
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Pre-use inspection</strong> &mdash; check all
                      webbing, stitching, buckles, and D-rings for damage, wear, or contamination
                      before every use
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Connected before entry</strong> &mdash; the
                      lifeline must be attached to the worker&rsquo;s dorsal D-ring and the winch
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Kept taut</strong> &mdash; the winch operator
                      pays out the line smoothly as the worker descends or moves, maintaining
                      tension so that retrieval can begin immediately without taking up slack
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Remains connected throughout</strong> &mdash;
                      the lifeline is never disconnected whilst the worker is inside the confined
                      space; disconnecting defeats the entire non-entry rescue system
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  lead to loss of consciousness and death. Rapid retrieval is essential &mdash;
                  every minute counts once a casualty is hanging motionless in a harness.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Not all confined space entries are vertical. Tunnels, culverts, large-diameter
                pipes, and ductwork are accessed through{' '}
                <strong>horizontal or near-horizontal openings</strong>. The retrieval methods for
                horizontal entries differ significantly from vertical entries because the casualty
                must be moved along the length of the space rather than raised upward.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stretcher extraction</strong> &mdash; the
                      casualty is placed on a narrow-profile, rigid stretcher and drawn horizontally
                      along the space to the entry point. Guide rails or slide systems reduce
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Drag rescue device (DRD)</strong> &mdash; a
                      webbing harness integrated into the worker&rsquo;s clothing or worn underneath
                      the outer coverall. It has a handle or loop at the shoulder that allows a
                      rescuer to grasp and drag the casualty rapidly out of the space without
                      needing to apply a stretcher
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Guide rails</strong> &mdash; fixed or temporary
                      rails installed along the floor of the space, allowing a stretcher or casualty
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-500">Planning Note:</strong> Horizontal rescue is
                  inherently more difficult than vertical non-entry rescue because it may require a
                  rescuer to enter the space to apply the stretcher or initiate the drag. The rescue
                  plan must account for this and ensure that any rescuer entering the space has
                  appropriate BA, a communication system, and a secondary rescue plan for the
                  rescuer themselves.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                When entry rescue is required &mdash; because non-entry rescue is not feasible or
                has failed &mdash; the rescue team must have appropriate{' '}
                <strong>respiratory protective equipment (RPE)</strong> for entering a potentially
                contaminated atmosphere. The type of breathing apparatus selected depends on the
                hazard, the expected duration of the rescue, and the physical constraints of the
                space.
              </p>
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; provides a self-contained air supply independent of the surrounding
                      atmosphere
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Typical duration: 30-45 minutes</strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Suitable for immediate rescue entry</strong>{' '}
                      into unknown or confirmed toxic/oxygen-deficient atmospheres
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Limitation:</strong> bulky cylinder adds width
                      and weight, which may restrict movement in very tight spaces
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Clean air supplied via a hose</strong> from an
                      external source (compressed air cylinder bank or compressor) located outside
                      the confined space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Extended duration</strong> &mdash; air supply
                      is continuous for as long as the external source lasts, making it ideal for{' '}
                      <strong className="text-cyan-400">extended rescue operations</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Limitation:</strong> the airline hose restricts
                      the wearer&rsquo;s range of movement and may become snagged or damaged in
                      complex spaces; a small emergency escape cylinder must be carried as a backup
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Small, lightweight breathing apparatus</strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Typical duration: 10-15 minutes</strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Not a substitute for primary BA</strong>{' '}
                      &mdash; escape sets are a last resort for the worker to reach clean air, not
                      for use by rescue teams
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  These devices filter the surrounding air &mdash; they do not provide an
                  independent air supply. In an oxygen-deficient or immediately dangerous to life or
                  health (IDLH) atmosphere, filtering RPE offers no protection whatsoever. Only
                  atmosphere-supplying BA (SCBA or airline) is acceptable for entry into a
                  contaminated confined space.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Standard ambulance stretchers are too wide and too flat for confined space rescue.
                Purpose-designed <strong>confined space stretchers</strong> are narrow, rigid, and
                capable of being used vertically &mdash; essential qualities when extracting a
                casualty through a manhole or narrow hatch.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-cyan-400 mb-3">Stretcher Types</p>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-white mt-0.5">
                          ...
                          immobilisation. Passes through openings as small as 450 mm diameter.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-white mt-0.5">
                          ...
                          Robertson &mdash; may not fit through very narrow openings.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-white mt-0.5">
                          ...
                          &mdash; used for initial packaging before transfer to a rescue stretcher.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-500">Selection Criteria:</strong> The choice of
                  stretcher depends on the size of the opening, the orientation of the extraction
                  (vertical or horizontal), and the nature of the casualty&rsquo;s injuries. The
                  rescue plan must specify which type of stretcher is required for each confined
                  space, and the stretcher must be present at the entry point before work begins.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The rescue plan must specify the <strong>first aid equipment</strong> appropriate to
                the foreseeable injuries for each confined space. First aid equipment must be
                positioned at the entry point and immediately available to the rescue team. It is
                not sufficient to rely on a first aid box kept in the site office or a vehicle
                &mdash; every second counts in a confined space emergency.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Resuscitation equipment</strong> &mdash; pocket
                      mask, bag-valve mask (BVM), or mechanical resuscitator for providing
                      artificial ventilation to a non-breathing casualty
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Oxygen therapy</strong> &mdash; supplemental
                      oxygen delivery system with appropriate masks and flow regulators; essential
                      for casualties exposed to toxic gases or oxygen-deficient atmospheres
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Spinal immobilisation</strong> &mdash; cervical
                      collar, head blocks, and spinal board or scoop stretcher for casualties who
                      may have fallen or suffered impact injuries
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Burns kit</strong> &mdash; sterile burns
                      dressings and cooling gel for thermal or chemical burns that may be
                      foreseeable in certain confined spaces (e.g. near hot process equipment or
                      chemical storage)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Standard first aid kit</strong> &mdash; wound
                      dressings, bandages, eye wash, and other supplies appropriate to the
                      foreseeable risks of the specific confined space
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Backup communication system</strong> &mdash;
                      the rescue plan must include a backup communication system that is{' '}
                      <strong className="text-cyan-400">independent of the primary system</strong>.
                      If the primary system is a two-way radio, the backup might be a hard-wired
                      intercom, visual signals, or a tug-line code
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Intrinsically safe</strong> &mdash; all
                      electronic communication equipment used in a confined space must be rated for
                      use in potentially flammable or explosive atmospheres where such risks exist
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Communication failure protocol</strong> &mdash;
                      the rescue plan must state what action is taken if communication is lost
                      (typically: immediate evacuation of the space and initiation of rescue
                      procedures)
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cutting equipment</strong> &mdash; for
                      casualties who are trapped or entangled in machinery, pipework, or structural
                      elements; may include hydraulic cutters, reciprocating saw, or bolt croppers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lighting</strong> &mdash; intrinsically safe
                      torches and area lighting; many confined spaces are completely dark, and
                      rescue cannot be conducted in darkness
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      ...
                      &mdash; the rescue team must carry their own gas detectors, independent of the
                      entrant&rsquo;s monitoring equipment, to confirm that conditions inside the
                      space have not deteriorated further
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Rescue equipment that fails during an actual emergency is worse than having no
                equipment at all &mdash; it gives a false sense of security and wastes precious
                time. A rigorous <strong>inspection and maintenance regime</strong> is essential to
                ensure that every piece of rescue equipment will perform as expected when lives
                depend on it.
              </p>
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; check all rescue equipment for visible damage, wear, corrosion,
                      fraying, or contamination before it is set up at the entry point
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Functional check</strong> &mdash; test the
                      winch raise, lower, and fall arrest functions; test communication equipment;
                      confirm BA cylinder pressures are adequate
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Defective equipment must not be used</strong>{' '}
                      &mdash; any item that fails the pre-use check must be immediately withdrawn
                      from service, tagged as defective, and reported. Work must not commence until
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Manufacturer&rsquo;s service intervals</strong>{' '}
                      &mdash; all rescue equipment must be serviced in accordance with the
                      manufacturer&rsquo;s recommendations, typically annually or after a specified
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">After-use servicing</strong> &mdash; any
                      equipment that has been used in an actual rescue must be thoroughly inspected
                      and serviced before being returned to service; this includes checking for
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-white mt-0.5">
                          ...
                          <strong className="text-cyan-400">6 months</strong>
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">LOLER examination reports</strong> &mdash; must
                      be retained and available for inspection; any defects identified must be
                      reported to the equipment owner and, for serious defects, to the HSE
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Service records</strong> &mdash; a log of all
                      servicing, maintenance, and repairs carried out on each item of rescue
                      equipment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Pre-use check records</strong> &mdash;
                      documented evidence that pre-use checks were carried out before each
                      deployment; typically recorded on the confined space entry permit
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Unique identification</strong> &mdash; every
                      item of lifting equipment must be individually identified (serial number,
                      asset tag) so that examination and service records can be traced to the
                      specific item
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  Using lifting equipment for persons without a current thorough examination report
                  is a breach of LOLER and could result in prosecution. The entry permit should
                  require confirmation that all lifting equipment has a current, valid examination
                  report before work is authorised.
                </p>
              </div>
            </div>
          </div>
