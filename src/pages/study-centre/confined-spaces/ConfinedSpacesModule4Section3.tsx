...
const faqs = [
  {
    question: 'Can the top person perform other tasks while monitoring the confined space?',
    answer:
  ...
  {
    question: 'How are time limits for confined-space work determined?',
    answer:
  ...
  {
    question: 'What happens if conditions change inside the space during work?',
    answer:
  ...
  {
    question: 'Is a fire watch always required for hot work in a confined space?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 8,
    question: 'What record-keeping must be maintained DURING a confined-space entry?',
    options: [
...
export default function ConfinedSpacesModule4Section3() {
  useSEO({
    title: 'Working Inside Confined Spaces | Confined Spaces Module 4.3',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-3 mx-auto">
            <span className="text-cyan-400 text-xs font-semibold">MODULE 4 &middot; SECTION 3</span>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Top person:</strong> Must remain at the entry point at all times &mdash; no
                other duties
              </li>
              <li>
                <strong>Communication:</strong> Check-ins at least every 5 minutes using agreed
                signals
              </li>
              <li>
                <strong>Gas monitor alarm:</strong> Evacuate immediately &mdash; no investigation
                inside the space
              </li>
              <li>
                <strong>Time limits:</strong> Agreed before entry, enforced by the top person
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Never:</strong> Enter the space as the top person &mdash; summon rescue
                instead
              </li>
              <li>
                <strong>Always:</strong> Treat loss of communication as an emergency
              </li>
              <li>
                <strong>Never:</strong> Exceed the agreed time limit, even if the task is unfinished
              </li>
              <li>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The top person &mdash; also called the safety attendant, standby person, or banksman
                &mdash; is arguably the <strong>most critical role</strong> in any confined-space
                operation. While the entrant performs the work inside the space, the top person is
                the entrant&rsquo;s lifeline to the outside world. If something goes wrong, the top
                person is the person who detects it first and summons help.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  rescuers who entered without proper equipment. If the top person enters the space
                  and is also overcome, there is no one left to raise the alarm. The result is
                  multiple fatalities instead of a coordinated rescue.
                </p>
              </div>
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      The top person must not leave the entry point for any reason while someone is
                      inside the space. If they need to leave, the entrant must exit first.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Maintain continuous communication:</strong>{' '}
                      Regular check-ins with the entrant at the agreed interval (minimum every 5
                      minutes). This confirms the entrant is conscious, alert, and not in distress.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Monitor the atmosphere from outside:</strong>{' '}
                      The top person monitors readings relayed from the entrant&rsquo;s personal gas
                      monitor (via display unit or radio reports) and records them at the required
                      intervals.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Control access to the space:</strong> Only
                      authorised personnel listed on the permit may enter. The top person maintains
                      the personnel log, recording who enters and exits and at what time.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Summon help immediately:</strong> If an
                      emergency is detected &mdash; gas monitor alarm, loss of communication, change
                      in conditions, or the entrant reports a problem &mdash; the top person
                      activates the emergency rescue plan without delay.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">No other duties:</strong> The top person must
                      have no other responsibilities. They cannot perform maintenance, answer phone
                      calls, supervise other work, or be distracted in any way. Their sole focus is
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  system in use, the emergency rescue plan, and the operation of any rescue
                  equipment at the entry point (such as a tripod and winch). A top person who does
                  not understand the hazards or the emergency procedures is not a top person &mdash;
                  they are a bystander. Training must be refreshed regularly and must cover the
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Reliable communication between the entrant and the top person is a{' '}
                <strong>non-negotiable requirement</strong> of every confined-space entry. Without
                communication, the top person cannot confirm the entrant&rsquo;s condition, and the
                entrant cannot report changes or call for help. Communication failure must be
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Verbal (voice):</strong> Direct voice
                      communication or two-way radios. In short, simple spaces where the entrant is
                      within earshot, direct voice may be sufficient. In longer or noisier spaces,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Visual signals:</strong> Hand signals or torch
                      signals where line of sight is maintained. Limited to simple spaces where the
                      top person can see the entrant throughout.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Tug-line (signal line):</strong> A rope
                      attached to the entrant&rsquo;s harness. Agreed signals are communicated by a
                      series of tugs (e.g., one tug = &ldquo;are you OK?&rdquo;, two tugs =
                      &ldquo;yes, I&rsquo;m OK&rdquo;, three tugs = &ldquo;I need to come
                      out&rdquo;, continuous tugging = &ldquo;emergency, pull me out&rdquo;). Used
                      as a backup or primary method in spaces where electronic communication is
                      unreliable.
                    </span>
                  </li>
                </ul>
                  ...
                  <div className="flex items-start justify-center gap-4 sm:gap-8 w-full max-w-2xl">
                    ...
                    <div className="flex flex-col items-center w-1/2">
                      <div className="bg-red-500/20 border border-red-500/40 rounded-lg p-3 w-full text-center mb-2">
                        <p className="text-red-300 font-bold text-xs sm:text-sm">NO RESPONSE</p>
                      </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  is no &ldquo;wait and see&rdquo; period. The entrant may have been overcome by
                  toxic gas, suffered an oxygen deprivation event, or been injured. The emergency
                  rescue plan must be activated without delay.
                </p>
              </div>

              <p>
                All communication signals must be <strong>agreed before entry</strong> and
                understood by every member of the team. Signals must be practised during the
                pre-entry briefing. Ambiguous or misunderstood signals can delay an emergency
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Pre-entry atmospheric testing confirms the atmosphere is safe <em>before</em> anyone
                enters the space. But conditions inside a confined space can change rapidly during
                work &mdash; a coating may off-gas when disturbed, residual materials in pipework
                may release fumes, or ventilation may fail. For this reason,{' '}
                <strong>continuous atmospheric monitoring during the entire entry</strong> is
                essential.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Worn by the entrant:</strong> A personal
                      multi-gas monitor is worn on the entrant&rsquo;s person, typically clipped to
                      the chest or collar to sample the air in the breathing zone.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Four-gas minimum:</strong> The monitor must
                      detect at least oxygen (O<sub>2</sub>), flammable gases (LEL), carbon monoxide
                      (CO), and hydrogen sulphide (H<sub>2</sub>S). Additional sensors may be
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Audible and visual alarms:</strong> The monitor
                      must have alarms that are loud enough and bright enough to alert the entrant
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Calibrated and bump-tested:</strong> The
                      monitor must be in calibration and must have passed a bump test (exposure to
                      known gas concentration) before each use to confirm the sensors are responding
                      correctly.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">immediate evacuation</strong>. The entrant must
                  leave the space via the pre-planned egress route without delay. There is{' '}
                  <strong className="text-white">no investigation inside the space</strong>. Do not
                  attempt to identify the source of the gas, do not attempt to increase ventilation,
                  and do not wait to see if the reading stabilises. Evacuate first, investigate
                  later from outside.
                </p>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">Recording Readings:</strong> Atmospheric
                  monitoring readings must be recorded at regular intervals throughout the entry
                  (typically every 5 to 15 minutes, as specified in the risk assessment). The top
                  person logs the readings reported by the entrant or displayed on a remote
                  monitoring unit. These records form part of the entry documentation and provide
                  evidence that the atmosphere remained safe throughout the work.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every confined-space entry must have a <strong>defined time limit</strong> that is
                agreed before entry and recorded on the permit to work. Time limits protect the
                entrant from fatigue, heat stress, air supply depletion, and prolonged exposure to
                residual hazards. They are not advisory &mdash; they are a firm boundary that must
                be enforced.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Air supply duration:</strong> If the entrant is
                      using breathing apparatus (BA), the time limit must allow for the work to be
                      completed and the entrant to exit <em>before</em> the air supply runs low. A
                      safety margin must be built in to account for increased breathing rate under
                      physical exertion.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Heat stress:</strong> Confined spaces can
                      become extremely hot, especially when mechanical work, hot work, or powered
                      equipment is involved. Heat stress can lead to confusion, disorientation,
                      collapse, and death. Time limits must account for the thermal environment.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fatigue:</strong> Working in a restricted space
                      with limited movement, awkward postures, and heavy PPE is physically
                      demanding. A fatigued entrant makes more errors, moves more slowly, and may
                      not react quickly enough to an emergency.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Chemical exposure limits:</strong> If there is
                      any residual contamination or the work itself produces fumes, the time limit
                      must ensure the entrant&rsquo;s exposure remains within the workplace exposure
                      limit (WEL).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Task complexity:</strong> The nature of the
                      work and the physical effort required affect how long an entrant can work
                      safely before needing a break.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  &ldquo;Just five more minutes&rdquo; is not acceptable. If more time is needed, a
                  new risk assessment must be conducted, a fresh time limit agreed, and the entrant
                  must rest before re-entering.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                For tasks that take longer than a single entry period, work rotation is used to
                maintain a <strong>fresh, alert workforce</strong>. Rather than pushing one entrant
                to their limits, teams rotate so that each entrant works a manageable period inside
                the space and then rests while a colleague takes over.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Manages exposure:</strong> Even with continuous
                      ventilation and monitoring, limiting individual exposure time reduces
                      cumulative risk from heat, fumes, and physical strain.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reduces fatigue:</strong> A rested entrant is
                      more alert, makes fewer errors, and can respond more quickly to changing
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">All team members must be competent:</strong>{' '}
                      Every entrant in the rotation must be trained, competent, and briefed on the
                      specific confined space, its hazards, and the task in progress.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Handover between entrants:</strong> When
                      entrants swap, the outgoing entrant must brief the incoming entrant on the
                      current status of the work, any issues encountered, and the current
                      atmospheric conditions inside the space.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Personnel log updated:</strong> Every swap must
                      be recorded on the personnel log &mdash; who came out, when, who went in,
                      when.
                    </span>
                  </li>
                </ul>
              ...
              <p>
                The rotation schedule must be agreed before work begins and recorded on the permit.
                The top person monitors the schedule and ensures swaps happen on time. Rotation
                applies to the top person role as well &mdash; a top person who has been standing
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Everything taken into a confined space must be carefully controlled. Unnecessary
                items increase the risk of dropped objects, block the egress route, and may
                introduce ignition sources or other hazards into an enclosed environment.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Only take in what is needed:</strong> Every
                      tool and piece of equipment must be justified. Excess items clutter the space,
                      obstruct movement, and increase the risk of tripping or entanglement.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Secure tools against falling:</strong> In
                      vertical entries (manholes, vessels, shafts), tools must be lowered on lines,
                      not carried on ladders. Tool lanyards prevent dropped objects that could
                      injure the entrant below.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">No unnecessary combustion sources:</strong>{' '}
                      Petrol/diesel engines, naked flames, and any equipment that produces heat or
                      sparks must not be taken into the space unless specifically authorised by a
                      hot work permit. Even cigarette lighters must be excluded.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Intrinsically safe equipment:</strong> In
                      spaces where flammable atmospheres may occur, all electrical and electronic
                      equipment (torches, radios, monitors, cameras) must be intrinsically safe (IS)
                      rated to prevent ignition.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Controlled transfer:</strong> Materials must be
                      transferred in and out of the space in a controlled manner, using lines,
                      baskets, or buckets lowered from the entry point.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Never block the egress route:</strong>{' '}
                      Materials must not be placed in or near the exit path. The entrant must be
                      able to leave the space quickly at any time without climbing over obstacles.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Waste removal:</strong> Debris and waste must
                      be removed regularly to prevent accumulation. Do not allow waste to block
                      access routes or bury the entrant&rsquo;s escape path.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Manual handling difficulties:</strong> Lifting,
                      carrying, and manoeuvring materials in a restricted space increases the risk
                      of musculoskeletal injury. Standard lifting techniques may be impossible.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Accelerated fatigue:</strong> Awkward postures
                      and restricted movement accelerate physical fatigue, which directly affects
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ergonomic planning:</strong> Task planning must
                      consider posture requirements. Where possible, pre-fabrication outside the
                      space reduces the amount of work that must be done in awkward positions
                      inside.
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Hot work &mdash; welding, cutting, brazing, grinding, or any process that produces
                flames, sparks, or significant heat &mdash; inside a confined space is one of the{' '}
                <strong>highest-risk activities</strong> in any workplace. The combination of an
                enclosed atmosphere, potential flammable residues, and ignition sources demands the
                strictest controls.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">flammable atmosphere</strong> that was not present
                  during the initial test. This is why continuous atmospheric monitoring during hot
                  work is absolutely essential, and why the gas-free certificate covers conditions{' '}
                  <em>at the time of testing</em>, not permanently.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-3">
            ...
            Record Keeping, Shift Handover &amp; Conditions for Immediate Evacuation
          </h2>
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Accurate, real-time record keeping is essential during every confined-space entry.
                Records protect lives (by ensuring the team knows who is inside the space at all
                times), demonstrate compliance, and provide evidence for any subsequent
                investigation.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Atmospheric monitoring log:</strong> Continuous
                      record of O<sub>2</sub>, LEL, CO, and H<sub>2</sub>S readings at defined
                      intervals. Any abnormal readings are highlighted and actioned.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Personnel log:</strong> Names of every person
                      who enters and exits the space, with exact times. This is critical for
                      emergency response &mdash; if an evacuation is required, you must know exactly
                      who is still inside.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Communication log:</strong> Record of each
                      communication check-in, confirming that the entrant responded and reported
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Permit to work:</strong> The active permit must
                      be displayed at the entry point for the duration of the entry.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Full briefing:</strong> The outgoing team must
                      brief the incoming team on all current conditions, hazards encountered, work
                      completed, work remaining, and any issues or near-misses.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fresh atmospheric testing:</strong> The
                      incoming team must not rely on earlier test results. Conditions may have
                      changed since the last test, and a fresh atmospheric test must be conducted
                      before the new entrant enters the space.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Permit review:</strong> The permit to work must
                      be reviewed and revalidated for the incoming team. All conditions on the
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Emergency plan confirmation:</strong> Every
                      member of the incoming team must understand the emergency rescue plan, know
                      the alarm signals, and know the location of rescue equipment.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">Key Principle:</strong> In confined-space work,
                  the default response to anything unexpected is{' '}
                  <strong className="text-white">evacuate and reassess</strong>. The space will
                  still be there when conditions are confirmed safe. The entrant may not be if they
                  stay to investigate.
                </p>
              </div>
            </div>
