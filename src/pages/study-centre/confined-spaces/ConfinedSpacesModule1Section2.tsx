...
const faqs = [
  {
    question: 'Can a room inside a building be classed as a confined space?',
    answer:
  ...
  {
    question: 'Does the depth of an excavation determine whether it is a confined space?',
    answer:
  ...
  {
    question: 'How often should a confined space register be reviewed?',
    answer:
  ...
  {
    question: 'Are permit-to-work systems required for every confined space entry?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 4,
    question: 'Which of the following utility spaces is a common example of a confined space?',
    options: [
...
export default function ConfinedSpacesModule1Section2() {
  useSEO({
    title: 'Common Confined Space Examples | Confined Spaces Module 1.2',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-3 mx-auto">
            <span className="text-cyan-400 text-xs font-semibold">MODULE 1 &middot; SECTION 2</span>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>6 categories:</strong> Industrial, utility, construction, building,
                agricultural, marine
              </li>
              <li>
                <strong>Key test:</strong> Substantially enclosed + foreseeable specified risk
              </li>
              <li>
                <strong>Commonly missed:</strong> Cold stores, spray booths, large rooms with poor
                ventilation
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Excavations:</strong> Assess for confined space hazards below 1.2&thinsp;m
                depth
              </li>
              <li>
                <strong>Sewers:</strong> Among the most hazardous &mdash; H₂S, CH₄, flooding risk
              </li>
              <li>
                <strong>Register:</strong> A live document &mdash; reviewed after every site change
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Industrial confined spaces are found across manufacturing, processing, energy, and
                heavy industry. They are among the most commonly recognised confined spaces, yet
                they still account for a significant proportion of fatalities because complacency
                and familiarity breed shortcuts.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Used for storing liquids, chemicals, fuels, water, or waste products
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Access:</strong> Typically a single manway
                      (manhole) or top hatch
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Residual chemicals, toxic
                      fumes from coatings, oxygen depletion from rusting or purging, flammable
                      vapours, drowning risk from retained liquid or sudden inflow
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Even &ldquo;empty&rdquo; tanks can contain lethal atmospheres from residues,
                      sludge, or corrosion
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Tall, enclosed vessels for storing bulk materials (grain, cement, powders,
                      pellets)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Engulfment in free-flowing
                      solids, oxygen depletion from decomposition, dust explosions, bridging (a
                      crust forms over a void that can collapse under a person&rsquo;s weight)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Access is usually from the top via a ladder or from a restricted base outlet
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Enclosed vessels where chemical reactions or mixing take place (e.g.,
                      autoclaves, mixers, reactors)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Toxic residues, exothermic
                      reactions if cleaning is incomplete, oxygen-depleted or enriched atmospheres,
                      mechanical hazards from agitators or stirrers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Must be isolated, drained, purged, and atmospherically tested before entry
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Large boilers (particularly fire-tube and water-tube types) require internal
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Extreme heat (residual),
                      oxygen depletion from rusting or nitrogen purging, tight internal spaces with
                      tubes and baffles limiting movement and escape
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Condensers share similar characteristics &mdash; enclosed, restricted access,
                      potential for retained chemical residues
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">
                    Always treat every tank as hazardous until atmospheric monitoring proves
                    otherwise.
                  </strong>
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Utility infrastructure runs beneath and between every town and city. Workers in
                water, gas, electricity, and telecommunications regularly encounter confined spaces
                that are some of the most dangerous working environments in the UK.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Hydrogen sulphide (H₂S
                      &mdash; the &ldquo;silent killer&rdquo;), methane (CH₄), carbon monoxide (CO),
                      oxygen depletion, sudden flooding, biological hazards, rat infestation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      H₂S deadens the sense of smell at higher concentrations &mdash; you{' '}
                      <strong className="text-white">cannot rely on smell</strong> to detect it
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Access is restricted to manholes, often with vertical ladders and limited
                      escape routes
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Small underground chambers providing access to pipework, valves, or junctions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Very restricted internal
                      dimensions, poor ventilation, gas migration from surrounding ground, flooding
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Often overlooked because of their small size and &ldquo;routine&rdquo; nature
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Large-diameter water mains can be entered for cleaning, inspection, or repair
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Drowning from sudden inflow,
                      oxygen depletion from biological growth, disorientation in long pipe runs,
                      limited communication with the surface
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Pumping stations are enclosed below-ground chambers containing mechanical
                      plant, electrical equipment, and often foul water or sewage
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  upstream rainfall, and oxygen depletion makes them exceptionally dangerous.{' '}
                  <strong className="text-white">
                    Never enter a sewer or manhole without continuous atmospheric monitoring and a
                    trained standby person at the surface.
                  </strong>
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Construction sites generate confined spaces throughout every phase of a project
                &mdash; from groundworks and piling through to fit-out and commissioning. Many
                construction confined spaces are temporary, which makes them easy to miss in risk
                assessments that were written before the space existed.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Below 1.2&thinsp;m depth, natural air circulation is significantly reduced
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Heavier-than-air gases (CO₂,
                      petrol vapour) settle at the bottom, leaking gas mains, contaminated ground
                      producing methane, oxygen depletion, collapse and entrapment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Narrow trenches restrict movement and make self-rescue extremely difficult
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Shallower excavations may also qualify if near a contamination source (e.g.,
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Extended travel distances to
                      the surface, limited emergency escape routes, ground gas migration, flooding,
                      ventilation failure, collapse
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Vertical shafts present fall hazards in addition to atmospheric risks
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Caissons are watertight retaining structures used for below-water-level
                      construction &mdash; workers enter to excavate or build inside them
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Flooding (sudden water
                      ingress), pressure changes in pneumatic caissons, oxygen depletion, limited
                      egress
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Piling rigs create confined void spaces that may need to be entered for
                      inspection; bored pile casings can accumulate ground gases
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  Under CDM Regulations, the principal designer should identify confined spaces at
                  the design stage so that they can be designed out where possible. Where they
                  cannot be eliminated, the principal contractor must ensure they are identified in
                  the construction phase plan and that safe systems of work are in place before any
                  entry.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Existing buildings contain numerous confined spaces that are encountered during
                maintenance, refurbishment, and inspection work. Electricians, HVAC engineers,
                plumbers, and building maintenance staff regularly work in these spaces &mdash;
                often without recognising them as confined.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Accessed for electrical work, data cabling, fire alarm installation, and HVAC
                      ducting
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Heat accumulation (especially
                      in summer), poor ventilation, asbestos-containing materials, falling through
                      fragile ceilings, restricted movement
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Can become confined spaces if processes below introduce fumes, or if inert
                      fire suppression systems are present
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Vertical and horizontal service ducts carrying electrical cables, pipework,
                      and communications
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Very tight dimensions, no
                      natural ventilation, dust accumulation, heat from cables, risk of entrapment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Vertical risers present fall hazards; horizontal ducts may limit escape if a
                      fire occurs
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Falls (often multi-storey),
                      moving machinery (lift car, counterweights, cables), entrapment between car
                      and shaft wall, potential for oxygen depletion if fire suppression gases are
                      present in the motor room
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Below-ground basements may have limited natural ventilation and can accumulate
                      ground gases (radon, methane) or heavier-than-air fumes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Flooding, gas accumulation
                      from underground sources, build-up of fumes from solvent use or hot work,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Unventilated switch rooms, plant rooms, and store rooms can also become
                      confined spaces depending on what is stored or operating within them
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">
                    If there is any doubt, treat it as a confined space and follow the appropriate
                    safe system of work.
                  </strong>{' '}
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Agriculture has one of the highest fatality rates of any UK industry, and confined
                space incidents are a significant contributor. Many farm workers are self-employed
                or work in small family businesses without formal health and safety management
                systems, making these incidents more likely.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Large enclosed structures for storing harvested grain, animal feed, or seed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Engulfment in free-flowing
                      grain (a person can be buried in under 5 seconds once grain flow starts),
                      oxygen depletion from decomposition, dust explosions, bridging and crusting
                      above voids
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Fumigation with phosphine adds an extremely toxic atmospheric hazard
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Hazards:</strong> Hydrogen sulphide (H₂S),
                      methane (CH₄), carbon dioxide (CO₂), ammonia (NH₃), oxygen depletion, drowning
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Gas concentrations spike when slurry is agitated (mixed, pumped, or disturbed)
                      &mdash; this is when most fatalities occur
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">
                    H₂S at concentrations above 100&thinsp;ppm can cause unconsciousness in a single
                    breath and death within minutes.
                  </strong>{' '}
                  Attempting an unplanned rescue without breathing apparatus is one of the most
                  common causes of multiple confined space deaths.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Ships, boats, offshore platforms, and dockside infrastructure contain some of the
                most hazardous confined spaces encountered in any industry. Marine confined spaces
                are governed by both the Confined Spaces Regulations 1997 (when in UK waters or
                dockside) and the Merchant Shipping and Fishing Vessels (Entry into Enclosed Spaces)
                Regulations 2022.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Double-bottom and wing tanks used to carry sea water for ship stability
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Severe oxygen depletion from
                      rusting (bare steel consumes oxygen rapidly), toxic coating fumes, complex
                      internal structure (frames, brackets, lightening holes) making escape
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Access is via small manholes, often requiring a person to squeeze through
                      tight openings
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Large enclosed spaces used for transporting bulk cargo, containers, or
                      packaged goods
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Oxygen depletion from cargo
                      (e.g., fruit, grain, timber, coal all consume oxygen), fumigation chemicals
                      (phosphine, methyl bromide), carbon monoxide from decomposition, flammable
                      atmospheres from certain cargoes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Even &ldquo;empty&rdquo; cargo holds can retain residual fumigant gases or
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  below 16% (the level at which impaired judgement begins) within hours.{' '}
                  <strong className="text-white">At 6% oxygen, death occurs within minutes.</strong>{' '}
                  Always test the atmosphere before entry and maintain continuous monitoring
                  throughout.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A systematic approach to identifying confined spaces is essential. Relying on
                memory, previous experience, or assumptions leads to spaces being missed &mdash; and
                missed spaces kill. The HSE Approved Code of Practice L101 recommends a structured
                assessment process.
              </p>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-400">Important:</strong> The assessment must be
                  carried out by a <strong>competent person</strong> &mdash; someone with sufficient
                  training, experience, and knowledge to recognise confined spaces and the hazards
                  they present. On a construction site, this is typically the responsibility of the
                  principal contractor, who may delegate it to a site safety adviser or specialist
                  consultant.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Not every confined space looks like a tank or a sewer. Some of the most dangerous
                confined spaces are &ldquo;hidden in plain sight&rdquo; because they appear to be
                normal rooms or work areas. The HSE has identified several categories that are
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      A room does not need to be small to be a confined space &mdash; the key test
                      is whether it is substantially enclosed with a foreseeable specified risk
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Large unventilated warehouses, workshops using solvents, or rooms where inert
                      gases are used (e.g., nitrogen for purging, argon for welding) can become
                      oxygen-depleted
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Server rooms and data centres with inert gas fire suppression (e.g., FM-200,
                      Novec 1230, IG-541) can become immediately life-threatening if the system
                      activates
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Sealed, insulated rooms with mechanical refrigeration &mdash; natural
                      ventilation is deliberately eliminated
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Refrigerant gas leaks
                      (ammonia, CO₂, or fluorinated gases) can displace oxygen rapidly; hypothermia
                      risk; doors may not be openable from inside older units
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Several fatalities have occurred in UK cold stores due to refrigerant leaks
                      creating oxygen-depleted atmospheres
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Enclosed booths designed to contain paint overspray, solvent vapours, and
                      isocyanates
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazards:</strong> Flammable vapour
                      concentrations can build to explosive levels if ventilation fails; toxic
                      vapour exposure; limited access points
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The confined space risk is highest during maintenance, cleaning, or when
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Unique identifier:</strong> A reference number
                      or code for each space (e.g., CS-001, CS-002)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Location:</strong> Building, floor, area, grid
                      reference, or GPS coordinates
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Description:</strong> Type of space,
                      dimensions, access points, normal contents
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Identified hazards:</strong> The specific risks
                      present (e.g., H₂S, oxygen depletion, flooding, engulfment)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Required controls:</strong> Summary of the safe
                      system of work (e.g., permit required, continuous gas monitoring, standby
                      person, rescue plan)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Risk assessment reference:</strong> Link to the
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Date of last review:</strong> When the entry
                      was last verified and updated
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>After changes to processes, chemicals, or plant</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      After any confined space incident, near-miss, or dangerous occurrence
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>At each phase of a construction project (under CDM 2015)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>As a minimum, annually &mdash; even if no changes have occurred</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  atmospheric monitoring before and during entry, a permit to work (where required),
                  or emergency rescue arrangements. Each entry on the register triggers all of these
                  requirements.
                </p>
              </div>
          ...
          <div className="p-5 rounded-xl bg-gradient-to-br from-cyan-500/10 via-cyan-400/5 to-transparent border border-cyan-500/15">
            ...
            <ul className="text-sm text-white space-y-2">
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-cyan-400/70 mt-0.5 flex-shrink-0" />
                <span>
                  Confined spaces exist across{' '}
                  <strong className="text-white">six main categories</strong>: industrial, utility,
                  construction, building, agricultural, and marine
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-cyan-400/70 mt-0.5 flex-shrink-0" />
              ...
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-cyan-400/70 mt-0.5 flex-shrink-0" />
                <span>
                  Commonly missed examples include cold stores, spray booths, large rooms with poor
                  ventilation, and server rooms with inert gas fire suppression
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-cyan-400/70 mt-0.5 flex-shrink-0" />
                <span>
                  A systematic <strong className="text-white">six-step assessment process</strong>{' '}
                  (desk study, walkround, legal test, worker consultation, register, review) ensures
              ...
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-cyan-400/70 mt-0.5 flex-shrink-0" />
                <span>
                  The <strong className="text-white">confined space register</strong> is a live
                  document that must be reviewed after every site change and at least annually
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-cyan-400/70 mt-0.5 flex-shrink-0" />
                <span>
                  A register does <strong className="text-white">not replace</strong> individual
                  risk assessments, permits to work, atmospheric monitoring, or emergency rescue
                  arrangements
                </span>
              </li>
            </ul>
