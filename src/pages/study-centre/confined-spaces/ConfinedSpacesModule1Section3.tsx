...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    options: ['Below 19.5%', 'Below 18%', 'Below 16%', 'Below 12%'],
    correctIndex: 2,
    explanation:
  ...
  },
  {
    ...
    question: "What is the 'cascade effect' in confined-space incidents?",
    options: [
...
const faqs = [
  ...
  {
    question: 'Can I rely on my sense of smell to detect dangerous gases in a confined space?',
    answer:
  ...
  {
    question: 'Why do so many rescuers die in confined-space incidents?',
    answer:
  ...
  {
    question: 'How quickly can the atmosphere inside a confined space change from safe to lethal?',
    answer:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['10 ppm', '100 ppm', '500 ppm', '1,000 ppm'],
    correctAnswer: 3,
    explanation:
  ...
  {
    id: 5,
    question: 'Why are heavier-than-air gases particularly dangerous in confined spaces?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <header className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-3 mx-auto">
            <span className="text-cyan-400 text-xs font-semibold">MODULE 1 &middot; SECTION 3</span>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              ...
              <li>
                <strong>60% are rescuers</strong> &mdash; not the original entrants
              </li>
              <li>
                <strong>Invisible hazards:</strong> O&#8322; depletion, CO, H&#8322;S &mdash; no
                warning
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            <p className="text-cyan-400/90 text-base font-medium mb-2">The Golden Rule</p>
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>NEVER</strong> enter without atmospheric testing
              </li>
              <li>
                <strong>NEVER</strong> attempt rescue without training &amp; equipment
              </li>
              <li>
                <strong>ALWAYS</strong> assume the atmosphere is hostile until proven safe
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every year in the United Kingdom, approximately <strong>15 people die</strong> as a
                direct result of confined-space incidents. Dozens more suffer serious injuries, many
                of which result in permanent disability. These numbers have remained stubbornly
                consistent over decades despite improvements in legislation, training, and
                equipment.
              </p>

              <p>
                To understand why this death toll matters, consider the context. The number of
                workers who actually enter confined spaces in any given year is a tiny fraction of
                the total UK workforce. Yet confined-space incidents consistently account for a
                disproportionately high number of workplace fatalities. A construction worker is
                statistically far more likely to die inside a confined space than from a fall, an
                electrical contact, or a vehicle strike on site &mdash; activities that, on the
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  themselves overcome by the same atmosphere. In many incidents, the original
                  entrant survived while the rescuer died. This single statistic is the most
                  powerful argument for why planned, trained, and equipped rescue arrangements must
                  be in place
              ...
              <p>
                The HSE has investigated hundreds of confined-space fatalities over the past three
                decades. The same causal factors appear again and again: no atmospheric testing, no
                safe system of work, no rescue plan, and the deadly cascade effect where multiple
                people enter after the first casualty. These are not freak accidents &mdash; they
                are predictable, preventable deaths caused by inadequate planning and human
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> speed</strong>. Unlike many other workplace hazards where there is time to
                recognise danger and react, atmospheric hazards in confined spaces can incapacitate
                and kill within seconds. There is often no warning, no gradual onset of symptoms,
                and no opportunity to self-rescue.
              </p>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  <strong>Hydrogen sulphide (H&#8322;S)</strong> at concentrations of approximately
                  1,000 ppm can cause immediate unconsciousness and death from a{' '}
                  <em>single breath</em>. The victim inhales, the H&#8322;S paralyses the
                  respiratory centre in the brain, and they collapse. There is no time to hold their
                  breath, no time to shout for help, no time to turn and exit. One breath.
                  Unconscious. Dead within minutes if not rescued.
                </p>
              </div>

              <p>
                <strong>Carbon monoxide (CO)</strong> is equally treacherous but works differently.
                CO is completely odourless, colourless, and tasteless. It binds to haemoglobin in
                the blood approximately 200 times more readily than oxygen, forming
                carboxyhaemoglobin (COHb). As COHb levels rise, oxygen delivery to tissues
                decreases. Early symptoms &mdash; headache, dizziness, nausea &mdash; are easily
                mistaken for feeling unwell, tiredness, or even a hangover. By the time the victim
                realises something is seriously wrong, they may already be too confused and weak to
                escape. At high concentrations, CO causes unconsciousness within minutes and death
                within an hour.
              </p>

              <p>
                The insidious nature of these gases is compounded by the fact that{' '}
                <strong>human senses are entirely unreliable</strong> as detection methods. You
                cannot see oxygen depletion. You cannot smell carbon monoxide. Hydrogen sulphide has
                a distinctive &lsquo;rotten eggs&rsquo; smell at low concentrations, but at higher
                concentrations (above ~100 ppm) it paralyses the olfactory nerve &mdash; you stop
                smelling it precisely when it becomes most dangerous. The absence of an odour does
                not mean the absence of a hazard; it may mean the hazard is so severe that your body
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  A worker who enters a space with a lethal atmosphere may collapse before they have
                  taken two steps. They cannot call for help, cannot turn around, and cannot hold
                  their breath long enough to escape. This is why atmospheric testing before entry
                  is not a &lsquo;nice to have&rsquo; &mdash; it is the single most critical control
                  measure that prevents fatalities.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>20.9% oxygen</strong>. Our bodies are finely tuned to function at this
                level. Even a seemingly small reduction in oxygen concentration can have
                catastrophic effects on the human body &mdash; and in a confined space, oxygen can
                be displaced or consumed by a variety of mechanisms.
              </p>

              <p>
                Oxygen depletion is particularly dangerous because it is{' '}
                <strong>completely invisible and odourless</strong>. The air looks, smells, and
                feels exactly the same whether it contains 20.9% or 10% oxygen. There is no visible
                haze, no unusual smell, no taste, and no sensation on the skin. The first indication
                that something is wrong may be impaired judgement and coordination &mdash; by which
                time the victim may already be unable to make rational decisions about escape.
              </p>
              ...
              <p>
                Oxygen can be displaced or consumed by many mechanisms inside a confined space.{' '}
                <strong>Rusting of steel surfaces</strong> (oxidation) consumes oxygen.{' '}
                <strong>Biological decomposition</strong> of organic matter &mdash; sludge,
                vegetation, food waste &mdash; consumes oxygen while producing carbon dioxide,
                methane, and hydrogen sulphide. <strong>Inerting processes</strong> using nitrogen
                or argon deliberately displace oxygen. Even{' '}
                <strong>the breathing of previous occupants</strong> in a poorly ventilated space
                can reduce oxygen levels over time.
              </p>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  are functioning on three-quarters of your normal oxygen supply. Your brain &mdash;
                  which consumes about 20% of all the oxygen you breathe &mdash; is the first organ
                  to be affected. Impaired judgement means you may not even recognise you are in
                  danger.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Confined spaces can accumulate toxic gases from multiple sources: chemical
                reactions, biological decomposition, connected pipework, previous contents of tanks
                and vessels, welding and cutting operations, or the natural geology of the
                surrounding ground. Many of these gases are <strong>heavier than air</strong>,
                meaning they sink to the lowest point in the space and pool there &mdash; creating
                invisible pockets of lethal atmosphere at the very level where workers are most
                  ...
                  {[
                    {
                      ...
                      properties:
                        "Heavier than air. 'Rotten eggs' smell at low concentration; olfactory paralysis above ~100 ppm",
                      lethal: '1,000 ppm — death from single breath',
                      sources:
                        'Decomposition of organic matter, sewage, oil refining, volcanic geology',
                    },
                    {
                      gas: 'Carbon monoxide (CO)',
                      properties:
                        'Slightly lighter than air. Completely odourless, colourless, tasteless',
                      lethal:
                        '1,200+ ppm — unconsciousness within minutes, death within 1-3 hours at lower levels',
                      sources:
                        'Incomplete combustion (engines, welding, fires), chemical reactions',
                    },
                    {
                      gas: 'Carbon dioxide (CO\u2082)',
                      properties:
                        'Heavier than air. Odourless at low concentration; slightly acidic taste at high levels',
                      lethal:
                        '40,000 ppm (4%) — headache, dizziness; 100,000 ppm (10%) — unconsciousness and death',
                      sources:
                        'Fermentation, decomposition, combustion, dry ice sublimation, respiration',
                    },
                    {
                      gas: 'Methane (CH\u2084)',
                      properties:
                        'Lighter than air. Odourless (domestic gas is artificially odorised). Explosive at 5-15%',
                      lethal:
                        'Asphyxiant by displacement of oxygen; explosion risk at 5-15% in air',
                      sources:
                        'Decomposition of organic matter, landfill, coal seams, sewage systems',
                    },
                    {
                      gas: 'Nitrogen (N\u2082)',
                      properties:
                        'Slightly lighter than air. Completely odourless, colourless, tasteless',
                      lethal:
                        'Simple asphyxiant — displaces oxygen. Enriched N\u2082 atmospheres give no warning before unconsciousness',
                      sources:
                        'Inerting / purging operations, leaks from N\u2082 cylinders or pipework',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-black/30 rounded-lg p-3">
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  the bottom. A gas monitor held at head height may read safe levels while a lethal
                  concentration exists at knee level. This is why{' '}
                  <strong>multi-level atmospheric testing</strong> is essential &mdash; readings
                  must be taken at top, middle, and bottom of the space before and during entry.
                </p>
              </div>

              <p>
                The combination of multiple gases is often more dangerous than any single gas alone.
                A sewer, for example, may simultaneously contain elevated H&#8322;S, depleted
                oxygen, elevated methane, and elevated CO&#8322; &mdash; each contributing to the
                hazard. A worker entering this atmosphere faces toxic exposure, oxygen starvation,
                and potential explosion risk simultaneously. This is why a{' '}
                <strong>multi-gas detector</strong> that monitors oxygen, flammable gases, and at
                least two toxic gases (typically CO and H&#8322;S) is the minimum standard for
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The following case studies are based on real incidents investigated by the HSE.
                Names, locations, and identifying details have been changed or removed, but the
                circumstances and lessons are genuine. Each case illustrates one or more of the key
                factors that make confined spaces so deadly.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden">
                ...
                <div className="p-4 space-y-3">
                  <p className="text-sm text-white/80">
                    ...
                    permit was issued. The worker descended the ladder and collapsed at the bottom.
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    chamber was found to contain less than 4% oxygen &mdash; it had been displaced
                    by nitrogen leaking from a nearby line.
                  </p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden">
                ...
                <div className="p-4 space-y-3">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    entered without any respiratory protection. He was found unconscious beside his
                    colleague. Both men died from acute solvent vapour inhalation combined with
                    oxygen depletion. Residual solvent in the tank floor and walls had been
                    outgassing into the confined volume, displacing oxygen and creating a toxic
                    atmosphere that natural ventilation alone was insufficient to control.
                  </p>
                  <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-3">
                    <p className="text-xs font-medium text-red-400 mb-1">Failures Identified</p>
                    <ul className="text-xs text-white/70 space-y-1 list-disc list-inside">
                      ...
                      <li>&lsquo;Top man&rsquo; entered without RPE &mdash; cascade effect</li>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden">
                ...
                <div className="p-4 space-y-3">
                  <p className="text-sm text-white/80">
                    ...
                    documented in agricultural safety guidance but not known by this particular
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    lost consciousness on the ladder. Emergency services recovered all three. The
                    farmer and his son died. The neighbour survived after prolonged hospital
                    treatment.
                  </p>
                  <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-3">
                    ...
                    <ul className="text-xs text-white/70 space-y-1 list-disc list-inside">
                      ...
                      <li>Triple cascade &mdash; three casualties from a single incident</li>
                      <li>
                        Heroic instinct overrode rational risk assessment in both the son and
                        neighbour
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  like routine tasks, unaware of the invisible hazard that would kill them in
                  seconds.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The technical hazards of confined spaces &mdash; oxygen depletion, toxic gases,
                explosive atmospheres &mdash; are well understood. The legislation is clear. Gas
                detectors are readily available. So why do people keep dying? The answer lies in{' '}
                <strong>human behaviour</strong>. Time after time, HSE investigations reveal the
                same psychological and organisational factors that lead competent people to make
                fatal decisions.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  manifests as: first time, full procedure; second time, skip the rescue plan; third
                  time, skip the gas test; tenth time, just climb in and do it. Each deviation from
                  the safe system of work appears to be validated by the absence of an incident.
                  Until the day the atmosphere is not safe. And then people die.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The cascade effect is the single most important concept in understanding why
                confined-space incidents produce disproportionately high body counts. It explains
                why a single person being overcome by an atmosphere routinely results in two, three,
                or even four fatalities. It is the reason that 60% of confined-space deaths are
                rescuers.
              </p>

              <p>The pattern is devastatingly simple and tragically predictable:</p>
                ...
                <div className="relative mx-auto max-w-2xl">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-white/70">
                            ...
                            same lethal atmosphere and collapse within seconds.
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-white/70">
                            ...
                            produced four and even five casualties in documented UK incidents.
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-white/70">
                            ...
                            the first was entirely preventable if a rescue plan had been in place.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="mt-4 p-3 rounded-lg bg-cyan-500/10 border border-cyan-500/30">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      . When the standby person sees Worker A collapse, they do NOT enter. They
                      raise the alarm, initiate the emergency rescue plan, and the trained rescue
                      team enters with BA and retrieval equipment. Worker A may or may not survive
                      &mdash; but Workers B and C are alive because they did not become casualties
                      themselves.
                    </p>
                  </div>
                </div>
              ...
              <p>
                The psychological mechanism behind the cascade is powerful and deeply human. Seeing
                a colleague in distress triggers a fight-or-flight response heavily biased towards
                action. The instinct to help is overwhelming &mdash; it overrides training,
                overrides knowledge, and overrides rational risk assessment. Workers who know the
                rules, who have been trained, who understand the hazards, still enter because in
                that moment of crisis, emotion defeats logic. This is precisely why rescue
                arrangements must be <strong>pre-planned and practised</strong> &mdash; because in
                the moment of crisis, only ingrained procedures and immediately available equipment
                can compete with the instinct to rush in.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  If you do not have these three things, do NOT enter the space. Call 999. Shout to
                  the casualty. Ventilate from outside if possible. But do NOT go in. You will
                  almost certainly become the next casualty. The hardest thing in the world is to
                  stand at the edge and not enter &mdash; but it may be the decision that saves your
                  life.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Confined-space fatalities rarely involve a single hazard in isolation. In practice,
                the most dangerous situations involve{' '}
                <strong>combinations of atmospheric hazards</strong> occurring simultaneously, each
                compounding the effect of the others. Understanding these combinations is essential
                because they explain why incidents escalate so rapidly and why monitoring for a
                single parameter alone is never sufficient.
              </p>
              ...
              <p>
                The speed at which atmospheric conditions can change inside a confined space is
                often dramatically underestimated. A space that was tested and found safe an hour
                ago may now contain a lethal atmosphere. The causes of rapid atmospheric change
                include:
              </p>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  &mdash; using a personal gas detector worn by the entrant or a fixed monitor
                  within the space &mdash; is essential for the entire duration of the entry. The
                  detector must alarm if conditions deteriorate, giving the entrant time to evacuate
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ol className="text-sm text-white/80 mt-2 space-y-2 list-decimal list-inside">
                  ...
                  <li>
                    <strong>
                      NEVER attempt rescue without training, breathing apparatus, and a rescue plan.
                    </strong>{' '}
                    The cascade effect kills more people than the original hazard. Improvised rescue
                    is not rescue &mdash; it is additional casualties. Rescue arrangements must be
                    in place before entry begins.
                  </li>
                </ol>
              </div>
            </div>
