...
const quizQuestions = [
  ...
  {
    question:
      'Within what timeframe must a fatal injury in a confined space be reported to the HSE under RIDDOR 2013?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Fatal injuries must be reported to the HSE immediately by telephone via the HSE Incident Contact Centre. This must be followed by a written report (Form F2508) submitted online within 10 days of the incident. The immediate phone report ensures the HSE can respond rapidly, potentially investigating the scene while evidence is still intact.',
  },
  {
    question:
      "In the '5 Whys' root cause analysis technique, what is the primary purpose of asking 'Why?' repeatedly?",
    options: [
...
export default function ConfinedSpacesModule5Section4() {
  useSEO({
    ...
    description:
      'RIDDOR 2013 reporting requirements for confined space incidents, incident investigation, root cause analysis techniques, near-miss reporting, corrective actions, and legal implications of confined space incidents.',
  });
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-xl p-5 mb-6">
          ...
          <p className="text-white text-base leading-relaxed">
            ...
            cause to find root causes using techniques such as the 5 Whys and fishbone diagrams.
            Near misses are critical learning opportunities that vastly outnumber actual injuries.
            Corrective actions must address immediate, short-term, and long-term systemic failures.
            Lessons must be shared across the organisation.
          </p>
        </div>
        ...
        <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-5 mb-8">
          ...
          <p className="text-white text-base leading-relaxed">
            ...
            Do not allow anyone to enter the space to investigate until it has been made safe. The
            atmosphere that caused the first casualty will cause a second. Many confined space
            fatalities are rescuers who entered without adequate precautions. Preserve evidence for
            the investigation -- do not disturb equipment, permits, or atmospheric monitors.
          </p>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/40 pl-5 space-y-4">
            <p className="text-white text-sm leading-relaxed">
              ...
              relevant to confined space work.
            </p>
                ...
                <div className="flex items-start gap-3 bg-black/20 rounded-lg p-3">
                  ...
                  <div>
                    ...
                    <p className="text-white text-xs">
                      ...
                      requiring medical treatment, or causing loss of consciousness. Report without
                      delay using the online form -- even if the person recovers fully.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3 bg-black/20 rounded-lg p-3">
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <ul className="space-y-2 mt-3 text-sm text-white">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong className="text-white">Online form</strong> -- www.hse.gov.uk/riddor
                    (the preferred method for most reports)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Telephone</strong> -- 0345 300 9923 (mandatory
                    for fatal and specified injuries; also used when online reporting is not
                    possible)
                  </span>
                </li>
              </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/40 pl-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              failure that made the immediate cause possible (e.g. "there was no procedure requiring
              atmospheric testing before entry, and the supervisor was managing three other jobs
              simultaneously"). Effective investigations always look beyond the immediate cause.
            </p>
          </div>
        </section>
          ...
          <div className="border-l-2 border-cyan-500/40 pl-5 space-y-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                contributing factors must be present simultaneously; OR gates mean any single factor
                is sufficient. FTA is particularly useful for complex incidents with multiple
                contributing factors and is often used by the HSE in major incident investigations.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-semibold text-white">
              Common Root Causes of Confined Space Incidents
            </h3>
          </div>
          <div className="border-l-2 border-cyan-500/40 pl-5 space-y-4">
            <p className="text-white text-sm leading-relaxed">
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-semibold text-white">
              Near-Miss Reporting & the Iceberg Model
            </h3>
          </div>
          <div className="border-l-2 border-cyan-500/40 pl-5 space-y-4">
            <p className="text-white text-sm leading-relaxed">
            ...
            <div className="bg-white/5 border border-cyan-500/30 rounded-xl p-5">
              ...
              <div className="space-y-1 max-w-md mx-auto">
                ...
                <div className="flex justify-center">
                  <div
                    className="bg-red-500/30 border border-red-500/50 rounded-t-lg px-4 py-2 text-center"
                    style={{ width: '30%' }}
                  >
                ...
                <div className="flex justify-center">
                  <div
                    className="bg-orange-500/20 border-x border-b border-orange-500/40 px-4 py-2 text-center"
                    style={{ width: '45%' }}
                  >
                ...
                <div className="flex justify-center">
                  <div
                    className="bg-amber-500/15 border-x border-b border-amber-500/30 px-4 py-2 text-center"
                    style={{ width: '60%' }}
                  >
                ...
                <div className="flex justify-center my-1">
                  <div
                    className="border-t-2 border-dashed border-cyan-400/60 text-center"
                    style={{ width: '75%' }}
                  >
                    <p className="text-cyan-400 text-[10px] font-semibold mt-1">
                      WATERLINE -- what you see above vs below
                    </p>
                  </div>
                </div>
                {/* Near misses */}
                <div className="flex justify-center">
                  <div
                    className="bg-blue-500/10 border-x border-b border-blue-500/25 px-4 py-2 text-center"
                    style={{ width: '80%' }}
                  >
            ...
            <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Volume:</strong> There are far more near misses
                    than actual injuries, providing vastly more data points to learn from
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Same root causes:</strong> Near misses reveal the
                    same hazards, failures, and unsafe conditions that cause serious incidents --
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">No harm:</strong> They provide learning without
                    the cost of injury, legal consequences, or human suffering
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Predictive:</strong> A rising trend in near
                    misses is a leading indicator that a serious incident is likely
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Prevention:</strong> Acting on near-miss data
                    prevents incidents before they occur, rather than reacting after someone is hurt
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                actions taken as a result of reports, management visibly supports and encourages
                reporting, and workers see tangible improvements resulting from their reports.
                Without this culture, near misses go unreported and the organisation loses its most
              ...
              <div className="space-y-3">
                ...
                <div className="bg-black/20 rounded-lg p-3 border-l-4 border-amber-500">
                  ...
                  <p className="text-white text-xs mt-1">
                    ...
                    similar work. These actions are taken within days to weeks.
                  </p>
                </div>
                <div className="bg-black/20 rounded-lg p-3 border-l-4 border-green-500">
                  ...
                  <p className="text-white text-xs mt-1">
                    ...
                    safety). Update procurement standards for equipment. Implement audit programmes
                    to verify compliance. These actions are taken over weeks to months and address
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <ul className="space-y-2 mt-3 text-sm text-white">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Risk assessments</strong> -- Do they adequately
                    identify the hazards that contributed to the incident? Were there hazards not
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Safe systems of work</strong> -- Were the
                    controls sufficient? Were there gaps in the procedure that the incident exposed?
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Rescue plans</strong> -- Was the rescue plan
                    adequate? Could the rescue have been faster or more effective?
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Training programmes</strong> -- Does the training
                    adequately cover the hazards and controls that were relevant to this incident?
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                  <span>
                    <strong className="text-white">Equipment standards</strong> -- Was the equipment
                    adequate, properly maintained, and correctly used? Are specification changes
                    needed?
                  </span>
                </li>
              </ul>
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-semibold text-white">
              Legal Implications of Confined Space Incidents
            </h3>
          </div>
          <div className="border-l-2 border-cyan-500/40 pl-5 space-y-4">
            <p className="text-white text-sm leading-relaxed">
              ...
              <div className="space-y-3">
                <div className="bg-black/20 rounded-lg p-3">
                  ...
                  <p className="text-white text-xs mt-1">
                    ...
                    legislation, prosecution can follow. Organisations face unlimited fines.
                    Individual directors and managers can face personal fines and imprisonment for
                    up to 2 years.
                  </p>
                </div>
                <div className="bg-black/20 rounded-lg p-3">
                  ...
                  <p className="text-white text-xs mt-1">
                    ...
                    fines (typically millions of pounds), a publicity order, and a remedial order.
                    This applies where the way the organisation's activities were managed or
                    organised amounted to a gross breach of the duty of care owed to the deceased.
                  </p>
                </div>
                <div className="bg-black/20 rounded-lg p-3">
                  <p className="text-red-400 font-semibold text-sm">
                  ...
                  <p className="text-white text-xs mt-1">
                    ...
                    director, manager, or similar officer. Workers who deliberately bypass safety
                    controls can also face personal prosecution.
                  </p>
                </div>
                <div className="bg-black/20 rounded-lg p-3">
                  ...
                  <p className="text-white text-xs mt-1">
                    ...
                    but persistent safety failures can affect insurance terms and premiums. Civil
                    claims can be brought years after the incident.
                  </p>
                </div>
                <div className="bg-black/20 rounded-lg p-3">
                ...
                <div className="bg-black/20 rounded-lg p-3">
                  ...
                  <p className="text-white text-xs mt-1">
                    ...
                    Prevention of Future Deaths report requiring the organisation to take specific
                    actions.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 mt-3 text-sm text-white">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                  <span>
                    A documented rescue plan with trained rescue personnel and tested equipment
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                  <span>
                    Evidence that lessons from previous incidents and near misses were acted upon
                  </span>
                </li>
              </ul>
              <p className="text-white text-xs mt-3 italic">
        ...
        {/*  Quiz                                                         */}
        {/* ------------------------------------------------------------ */}
        <Quiz title="Section 4 -- Incident Reporting & Lessons Learned" questions={quizQuestions} />
