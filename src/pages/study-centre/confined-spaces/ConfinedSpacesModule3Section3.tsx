...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'What type of sensor does a standard 4-gas monitor use to detect flammable gases (LEL)?',
    options: [
  ...
  },
  {
    id: 3,
    question:
      'What are the standard LOW and HIGH alarm setpoints for oxygen (O\u2082) on a confined space 4-gas monitor?',
    options: [
      'LOW: 18.0% / HIGH: 22.0%',
      'LOW: 19.5% / HIGH: 23.5%',
      'LOW: 20.0% / HIGH: 25.0%',
    ...
    correctAnswer: 1,
    explanation:
      'The standard oxygen alarm setpoints are 19.5% (low alarm) and 23.5% (high alarm). Normal atmospheric oxygen is approximately 20.9%. A reading below 19.5% indicates oxygen depletion (risk of asphyxiation), and a reading above 23.5% indicates oxygen enrichment (increased fire and explosion risk). Both conditions are dangerous and require immediate action.',
  },
  {
    id: 4,
    question:
  ...
  },
  {
    id: 5,
    question:
      'A catalytic bead (pellistor) LEL sensor requires a minimum of approximately what percentage of oxygen to function correctly?',
    options: ['5% oxygen', '10% oxygen', '15% oxygen', '20% oxygen'],
    correctAnswer: 1,
    explanation:
      'Catalytic bead (pellistor) sensors detect flammable gases by oxidising them on a heated catalytic surface. This chemical reaction requires oxygen. If the oxygen concentration falls below approximately 10%, the sensor cannot reliably oxidise the flammable gas and will under-read or fail to detect it entirely. In oxygen-depleted environments, the LEL reading may be dangerously inaccurate. This is a critical limitation to understand.',
  },
  {
    id: 6,
    question:
      'What is the typical sensor life of an electrochemical cell in a portable gas monitor?',
    options: ['6 months', '1 year', '2 to 3 years', '5 to 10 years'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    id: 7,
    question:
      'What is the standard LOW alarm setpoint for carbon monoxide (CO) on a confined space 4-gas monitor?',
    options: ['10 ppm', '20 ppm', '50 ppm', '100 ppm'],
    correctAnswer: 1,
    explanation:
      'The standard LOW alarm setpoint for carbon monoxide is 20 ppm (parts per million). The HIGH alarm is typically set at 100 ppm. Carbon monoxide is a colourless, odourless, highly toxic gas that binds to haemoglobin in the blood approximately 200 times more readily than oxygen, preventing the blood from carrying oxygen to the body\u2019s tissues. Even relatively low concentrations are dangerous with prolonged exposure.',
  },
  {
    id: 8,
    question:
...
export default function ConfinedSpacesModule3Section3() {
  useSEO({
    ...
    description:
      'Atmospheric testing procedures, 4-gas monitors, sensor types, bump testing, calibration, pre-entry monitoring, continuous monitoring, and interpreting gas readings in confined spaces.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>What:</strong> Gas monitors detect invisible, deadly atmospheric hazards
              </li>
              <li>
                <strong>Standard:</strong> 4-gas monitor (O&#8322;, LEL, CO, H&#8322;S)
              </li>
              <li>
                <strong>Daily:</strong> Bump test before every use &mdash; no exceptions
              </li>
              <li>
                <strong>Rule:</strong> Never enter without testing first &mdash; test at all levels
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-cyan-500/5 border-l-2 border-cyan-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Before:</strong> Test from outside using extension probe &mdash; top,
                middle, bottom
              </li>
              <li>
                <strong>During:</strong> Continuous personal monitor on every entrant
              </li>
              <li>
                <strong>Alarm:</strong> Evacuate immediately &mdash; do not investigate
              </li>
              <li>
                <strong>Record:</strong> Log every reading &mdash; pre-entry and continuous
              </li>
            </ul>
          </div>
        </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  . Oxygen deficiency is completely undetectable without instruments. Carbon
                  monoxide is colourless and odourless. Hydrogen sulphide paralyses the sense of
                  smell at dangerous concentrations. Without a gas monitor, you are walking blind
                  into a potentially lethal environment.
                </p>
              </div>

              <p>
                The Confined Spaces Regulations 1997 and the accompanying Approved Code of Practice
                (ACoP L101) are clear:{' '}
                <strong>
                  no person shall enter a confined space unless the atmosphere has been tested and
                  confirmed safe, or appropriate controls are in place
                </strong>
                . This is not guidance &mdash; it is a legal requirement. Atmospheric testing must
                be carried out <strong>before entry</strong> and, in most cases,{' '}
                <strong>continuously during the work</strong>.
              </p>

              <p>
                The atmosphere inside a confined space can be hazardous for many reasons. Oxygen may
                have been displaced by other gases, consumed by biological processes (rusting,
                decomposition, fermentation), or absorbed by the materials of the space itself.
                Toxic gases may have accumulated from chemical reactions, leaking pipework,
                contaminated ground, or the work being carried out. Flammable gases may be present
                from fuel storage, decomposing organic material, or connected processes.{' '}
                <strong>
                  None of these conditions are reliably detectable by the human body until it is too
                  late.
                </strong>
              </p>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-500">Key Principle:</strong> The atmosphere inside a
                  confined space must be considered <strong>unknown and potentially lethal</strong>{' '}
                  until proven otherwise by instrumental testing. You must never assume a space is
                  safe based on previous entry, visual inspection, or the absence of odour.
                  Conditions can change rapidly and without warning.
                </p>
              </div>

              <p>
                Atmospheric testing fulfils three critical functions. First, it provides{' '}
                <strong>pre-entry confirmation</strong> that the atmosphere is within safe limits
                for human occupation. Second, it enables <strong>continuous monitoring</strong>{' '}
                during the work, providing real-time warning if conditions deteriorate. Third, it
                creates <strong>a documented record</strong> of atmospheric conditions for the
                permit-to-work, incident investigation, and regulatory compliance.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Before every entry</strong> &mdash; even if the
                      space was tested and entered earlier the same day, the atmosphere must be
                      re-tested before each subsequent entry
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Continuously during entry</strong> &mdash;
                      personal monitors must be worn by every entrant and/or fixed monitors must be
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">After any break in work</strong> &mdash; if the
                      space is left unattended, the atmosphere must be re-tested before re-entry
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">If conditions change</strong> &mdash; any
                      change in ventilation, work activity, or weather conditions may affect the
                      atmosphere
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Gas detection instruments range from simple single-gas detectors to sophisticated
                multi-gas monitors and specialist analysers. The type of instrument required depends
                on the <strong>hazards identified in the risk assessment</strong>, the{' '}
                <strong>nature of the confined space</strong>, and the
                <strong> work being carried out</strong>. Understanding the capabilities and
                limitations of each type is essential for selecting the right instrument for the
                job.
              </p>

              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-cyan-500 mb-3">
                  Gas Detection Equipment Types
                </p>
                <div className="grid sm:grid-cols-2 gap-3 text-sm">
                  ...
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <p className="text-white/70 text-xs mt-1">
                      ...
                      . Measures four channels simultaneously: O&#8322;, LEL, CO, and H&#8322;S.
                      Available as personal (diffusion) or with sample draw pump for remote
                      monitoring.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
              ...
              <p>
                For the vast majority of confined space entries, a{' '}
                <strong>4-gas monitor is the minimum requirement</strong>. It provides simultaneous
                detection of the four most common atmospheric hazards. Where the risk assessment
                identifies additional hazards &mdash; such as VOCs, carbon dioxide, or specific
                toxic gases &mdash; additional instruments or sensors may be required. A PID may be
                used alongside a 4-gas monitor in environments where volatile organic compounds are
                a concern.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3 text-sm text-white/80">
                  <div>
                    ...
                    <p>
                      Gas reaches the sensors by natural air movement. The monitor must be in the
                      same atmosphere as the area being tested. Used for{' '}
                      <strong className="text-white">personal monitoring</strong> when the monitor
                      is worn by the entrant inside the space. Response is slower than
                      pump-assisted.
                    </p>
                  </div>
                  <div>
                    ...
                    <p>
                      An internal pump draws the atmosphere through tubing to the sensors. Allows
                      testing from
                      <strong className="text-white"> outside the space</strong> using an extension
                      probe. Essential for{' '}
                      <strong className="text-white">pre-entry monitoring</strong>. The operator can
                      test the atmosphere at specific locations and depths without entering.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Understanding how each sensor type works helps you understand their{' '}
                <strong>capabilities, limitations, and failure modes</strong>. A gas monitor is only
                as reliable as its sensors, and every sensor type has characteristics that affect
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 mb-2">
                  ...
                  electrolyte, where it undergoes a chemical reaction at the electrode surface. This
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Strengths:</strong> Highly specific to the
                      target gas, low power consumption, good accuracy at low concentrations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Limitations:</strong> Cross-sensitivity to some
                      gases, affected by temperature and humidity extremes, finite lifespan
                      (typically 2&ndash;3 years), can be poisoned by certain chemicals
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 mb-2">
                  ...
                  (coated with a catalyst) and one reference. When flammable gas contacts the active
                  bead, it oxidises (burns) on the catalyst surface, raising its temperature. The
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Strengths:</strong> Responds to a wide range of
                      flammable gases and vapours, well-proven technology, robust
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Critical limitation:</strong> Requires a
                      minimum of approximately <strong className="text-white">10% oxygen</strong> to
                      function. In oxygen-depleted atmospheres, the sensor will under-read or fail
                      to detect flammable gas entirely
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Sensor poisoning:</strong> Exposure to silicone
                      compounds, lead compounds, or high concentrations of H&#8322;S can permanently
                      damage the catalyst, causing the sensor to under-read without any visible
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 mb-2">
                  ...
                  diffuses through a membrane and is reduced at the cathode, generating a current
                  proportional to the oxygen partial pressure. Some fixed-installation instruments
                  use
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Strengths:</strong> Highly specific to oxygen,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Limitations:</strong> Galvanic cells are
                      consumable &mdash; the lead anode is slowly depleted during normal use. Sensor
                      life is typically 2&ndash;3 years even without exposure to gas, as the sensor
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 mb-2">
                  ...
                  concentration. NDIR sensors are commonly used for{' '}
                  <strong className="text-white">carbon dioxide (CO&#8322;)</strong> detection and
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Key advantage:</strong> Does NOT require oxygen
                      to function &mdash; unlike catalytic bead sensors, IR sensors work reliably in
                      oxygen-depleted or inert atmospheres
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Other strengths:</strong> Cannot be poisoned,
                      longer sensor life (typically 5+ years), no consumable elements
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Limitations:</strong> More expensive, larger
                      sensor size, may be affected by water condensation on optical surfaces
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>4-gas (or &ldquo;quad-gas&rdquo;) monitor</strong> is the standard
                instrument for confined space atmospheric monitoring. It simultaneously measures the
                four most common atmospheric hazards in a single portable device. Every person
                involved in confined space entry operations must understand what each channel
                measures, what the alarm setpoints mean, and what action to take when an alarm
                sounds.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-4 sm:p-6">
                <p className="text-sm font-medium text-cyan-400 mb-4 text-center">
                  4-Gas Monitor Display Explained
                </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-cyan-300">O&#8322; (Oxygen)</strong> &mdash; measured
                      as percentage by volume of the atmosphere. Normal air is 20.9%. Below 19.5%
                      indicates oxygen depletion (risk of asphyxiation); above 23.5% indicates
                      oxygen enrichment (increased fire/explosion risk)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-orange-400 flex-shrink-0" />
                    <span>
                      <strong className="text-orange-300">LEL (Lower Explosive Limit)</strong>{' '}
                      &mdash; measured as a percentage of the LEL, not the actual gas concentration.
                      0% LEL means no flammable gas detected; 100% LEL means the atmosphere has
                      reached the lower explosive limit and is capable of igniting. Alarm at 10% and
                      20% provides early warning well before explosive conditions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-yellow-400 flex-shrink-0" />
                    <span>
                      <strong className="text-yellow-300">CO (Carbon Monoxide)</strong> &mdash;
                      measured in parts per million (ppm). Colourless, odourless, and highly toxic.
                      Binds to haemoglobin ~200 times more readily than oxygen. Workplace Exposure
                      Limit (WEL): 20 ppm (8-hour TWA), 100 ppm (15-minute STEL)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-purple-400 flex-shrink-0" />
                    <span>
                      <strong className="text-purple-300">H&#8322;S (Hydrogen Sulphide)</strong>{' '}
                      &mdash; measured in parts per million (ppm). Smells of rotten eggs at low
                      concentrations but paralyses the sense of smell above ~100 ppm. Workplace
                      Exposure Limit: 5 ppm (8-hour TWA), 10 ppm (15-minute STEL)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  Do not silence the alarm and continue working. Do not investigate the cause from
                  inside the space. Leave the space using the planned egress route, report to the
                  top person / attendant, and do not re-enter until the cause has been identified
                  and the atmosphere confirmed safe.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>bump test</strong> (also called a functional test or challenge test) is a
                quick check performed <strong>before every use</strong> to confirm that the gas
                sensors are responding to gas and that the alarms activate correctly. It is not a
                calibration &mdash; it does not adjust the sensor readings. Its purpose is to verify
                that the instrument is <strong>functional and capable of detecting gas</strong>.
              </p>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Sensors respond</strong> &mdash; each sensor
                      detects the presence of the test gas and changes its reading from the baseline
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Alarms activate</strong> &mdash; the audible,
                      visual, and vibration alarms all trigger when the sensor reading exceeds the
                      alarm setpoints
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Gas can reach the sensors</strong> &mdash;
                      confirms that the sensor ports, membranes, and filters are not blocked by
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-cyan-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Response time is acceptable</strong> &mdash;
                      the sensors respond within the expected timeframe when exposed to gas
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ol className="text-sm text-white/80 space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Switch on the monitor</strong> in clean air and
                      allow it to complete its start-up sequence and auto-zero
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-6 h-6 rounded-full bg-cyan-500/20 border border-cyan-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-cyan-400">
                    ...
                    <span>
                      <strong className="text-white">Connect the bump test gas cylinder</strong> to
                      the instrument using the appropriate regulator and tubing. Use a certified
                      bump test gas mixture containing concentrations above the alarm setpoints for
                      each sensor
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Apply the test gas</strong> to the sensor ports
                      for the duration specified by the manufacturer (typically 30&ndash;60 seconds)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-6 h-6 rounded-full bg-cyan-500/20 border border-cyan-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-cyan-400">
                    ...
                    <span>
                      <strong className="text-white">Verify all sensors respond</strong> and that
                      the readings rise above the alarm setpoints. Confirm audible, visual, and
                      vibration alarms activate
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-6 h-6 rounded-full bg-cyan-500/20 border border-cyan-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-cyan-400">
                    ...
                    <span>
                      <strong className="text-white">Remove the gas</strong> and confirm readings
                      return to baseline (zero for toxic gases, ~20.9% for O&#8322;, 0% for LEL)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-6 h-6 rounded-full bg-cyan-500/20 border border-cyan-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-cyan-400">
                    ...
                    <span>
                      <strong className="text-white">Record the bump test</strong> result &mdash;
                      pass or fail, date, time, and operator. Many modern instruments log this
                      automatically
                    </span>
                  </li>
                </ol>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  service and sent for full calibration or repair. Do not attempt to &ldquo;work
                  around&rdquo; a failed bump test. Do not enter a confined space with an instrument
                  that has not passed its daily bump test.{' '}
                  <strong className="text-white">No bump test, no entry.</strong>
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>full calibration</strong> goes beyond a bump test. While a bump test
                confirms that the sensors respond to gas, a calibration{' '}
                <strong>adjusts the sensor readings</strong> to match a known, certified reference
                gas concentration. It ensures that the readings displayed on the instrument are
                ...
                <div className="grid sm:grid-cols-2 gap-3 text-sm">
                  <div className="bg-cyan-500/5 border border-cyan-500/20 rounded-lg p-3">
                    ...
                    <ul className="text-white/70 text-xs space-y-1">
                      ...
                      <li>
                        &bull; Performed{' '}
                        <strong className="text-white">daily / before every use</strong>
                      </li>
                  ...
                  <div className="bg-cyan-500/5 border border-cyan-500/20 rounded-lg p-3">
                    ...
                    <ul className="text-white/70 text-xs space-y-1">
                      ...
                      <li>
                        &bull; Performed <strong className="text-white">monthly</strong> (or per
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Frequency:</strong> Follow the
                      manufacturer&rsquo;s recommended calibration schedule. Typically monthly, but
                      may be more frequent in harsh environments or following a failed bump test.
                      Some regulations or site requirements may mandate specific intervals
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Certified calibration gas:</strong> Only use
                      certified calibration gas cylinders with a known concentration and within
                      their expiry date. The gas mixture must be traceable to national or
                      international standards. Never use expired gas
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Competent person:</strong> Calibration should
                      be performed by a person trained and competent in the calibration procedure
                      for the specific instrument. This may be an in-house technician or an external
                      service provider
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Record keeping:</strong> Every calibration must
                      be recorded with the date, gas cylinder serial number and expiry, before/after
                      readings, and the name of the person who performed it. These records must be
              ...
              <p>
                Calibration is also required <strong>after sensor replacement</strong>, after the
                instrument has been exposed to very high gas concentrations, after a significant
                impact or drop, and whenever the bump test indicates the readings are drifting
                outside acceptable tolerances. If the calibration reveals that a sensor cannot be
                adjusted to within acceptable limits, the sensor must be replaced.
              </p>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Atmospheric monitoring in confined spaces falls into two phases:{' '}
                <strong>pre-entry monitoring</strong>
                (before anyone enters the space) and <strong>continuous monitoring</strong>{' '}
                (throughout the entire duration of the work). Both are essential. The atmosphere can
                change at any time, and a space that was safe at the start of the day may become
                dangerous as work progresses.
              </p>

              {/* Diagram: Pre-Entry Monitoring Procedure */}
              <div className="bg-white/5 border border-white/10 rounded-lg p-4 sm:p-6">
                <p className="text-sm font-medium text-cyan-400 mb-4 text-center">
                  Pre-Entry Monitoring Procedure
                </p>
                <div className="relative mx-auto max-w-md space-y-3">
                  {/* Step 1: Operator outside */}
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 rounded-full bg-cyan-500/20 border border-cyan-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-cyan-400">
                      1
                    </div>
                  ...
                  <div className="border-2 border-dashed border-cyan-500/30 rounded-lg p-3 bg-cyan-500/5">
                    <p className="text-[10px] text-cyan-400 font-medium mb-2 text-center">
                      CONFINED SPACE (Cross-Section)
                    </p>
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[9px] text-yellow-300">
                          Middle &mdash; breathing zone level
                        </span>
                      </div>
                      {/* Bottom level */}
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[9px] text-purple-300">
                          Bottom &mdash; heavy gases (H&#8322;S, CO&#8322;)
                        </span>
                      </div>
                    </div>
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Test from outside:</strong> Always test the
                      atmosphere from outside the space using an extension probe or sample draw
                      tubing. Never enter the space to take the first reading &mdash; the atmosphere
                      is unknown and may be immediately dangerous to life
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Test at multiple levels:</strong> Gases
                      stratify by density. Lighter-than-air gases (methane, hydrogen) accumulate at
                      the top. Heavier-than-air gases (H&#8322;S, CO&#8322;) settle at the bottom.
                      You must test at the top, middle, and bottom of the space to detect hazardous
                      pockets that may not be present at the entry point
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Allow adequate response time:</strong> The pump
                      must draw the atmosphere through the full length of tubing before the reading
                      is valid. A common error is reading the display too early, which shows the
                      outside atmosphere rather than the atmosphere inside the space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Repeat if ventilation is applied:</strong> If
                      the space is ventilated before entry, re-test the atmosphere after ventilation
                      has been running for an adequate period. Ventilation may displace gases to
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-3">
                  <p>
                    ...
                    duration of the work. Continuous monitoring uses two complementary approaches:
                  </p>
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    <div className="bg-cyan-500/5 border border-cyan-500/20 rounded-lg p-3">
                      ...
                      <p className="text-[11px] text-white/70">
                        ...
                        monitors are typically diffusion-type (no pump needed).
                      </p>
                    </div>
                    <div className="bg-cyan-500/5 border border-cyan-500/20 rounded-lg p-3">
                      <div className="flex items-center gap-2 mb-2">
                      ...
                      <p className="text-[11px] text-white/70">
                        ...
                        external alarm systems and data loggers.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="bg-red-500/10 border border-red-500/30 p-3 rounded-lg">
                    <p className="text-[11px] text-white/80">
                      ...
                      cleaning), changes in ventilation, or changes in the connected process.
                      Continuous monitoring provides the real-time warning that enables safe
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A gas monitor is a life-safety instrument, but it is only effective if the operator
                can
                <strong> correctly interpret the readings</strong> and understands the{' '}
                <strong>limitations</strong> of the technology. A reading on a display is not an
                absolute guarantee of safety &mdash; it is one input into an overall safety
                assessment that must also consider the risk assessment, the work being carried out,
                and the specific characteristics of the confined space.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Steady readings within safe limits</strong>{' '}
                      &mdash; the atmosphere is currently within acceptable parameters. Continue
                      monitoring. A steady reading does not mean conditions will remain unchanged
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fluctuating readings</strong> &mdash; indicate
                      an unstable atmosphere. The gas concentration is changing, which may be caused
                      by intermittent release, variable ventilation, or work disturbance.
                      Fluctuating readings are a warning sign &mdash; increase vigilance and be
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Trending upward</strong> &mdash; if a toxic gas
                      reading is gradually increasing, or if oxygen is gradually decreasing, this
                      trend indicates a worsening atmosphere. Do not wait for the alarm &mdash; if
                      the trend is consistent and moving toward alarm setpoints, consider
                      withdrawing from the space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Sudden spike or step-change</strong> &mdash; a
                      rapid increase in any gas channel (even briefly) indicates a sudden release.
                      This may be caused by disturbing contaminated material, a connected process
                      change, or a ventilation failure.
                      <strong className="text-red-300"> Evacuate immediately</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stuck at zero (toxic channels)</strong> &mdash;
                      if a toxic gas sensor shows exactly zero throughout the entire entry with no
                      fluctuation at all, this may indicate a failed or blocked sensor rather than a
                      genuinely zero reading. Cross-check with other instruments and consider
                      whether the environment genuinely contains no trace gases
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cross-sensitivity:</strong> Sensors may respond
                      to gases other than their target. An H&#8322;S sensor may respond to
                      SO&#8322;; a CO sensor may respond to hydrogen. This can cause false readings
                      in multi-gas environments
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Temperature and humidity:</strong> Extreme
                      cold, heat, or humidity can affect sensor performance. Most instruments are
                      rated for 0&ndash;40&deg;C and 15&ndash;90% RH. Outside these ranges, readings
                      may be unreliable
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Sensor poisoning:</strong> Certain substances
                      can permanently damage sensors. Silicone compounds, lead, and phosphorus
                      compounds can poison catalytic bead sensors. The poisoned sensor may read zero
                      even when flammable gas is present &mdash; a potentially fatal failure mode
                      that is not indicated by an alarm
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Response time:</strong> No sensor responds
                      instantaneously. There is always a delay between the gas reaching the sensor
                      and the reading appearing on the display. This delay is longer with sample
                      draw tubing. In a rapidly changing atmosphere, the displayed reading may lag
                      behind the actual condition
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Catalytic bead in low-O&#8322;:</strong> As
                      covered in Section 03, catalytic bead LEL sensors require ~10% oxygen to
                      function. In an oxygen-depleted atmosphere, the LEL reading is unreliable and
                      may dangerously under-report flammable gas concentration
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Sensor life:</strong> Track sensor installation
                      dates and expected lifespan (typically 2&ndash;3 years for electrochemical and
                      O&#8322; cells; longer for IR sensors). Replace sensors before they reach
                      end-of-life. A sensor that is past its rated life may still appear to work but
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Battery management:</strong> Always ensure the
                      battery is fully charged before use. Know the instrument&rsquo;s battery life
                      (typically 12&ndash;18 hours). A monitor with a low battery is a monitor that
                      may shut down during entry, leaving the entrant without atmospheric protection
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cleanliness:</strong> Keep sensor ports,
                      filters, and pump inlets clean and free from dust, dirt, and moisture. Blocked
                      sensor ports will prevent gas from reaching the sensor. Clean the instrument
                      after each use as per manufacturer instructions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Storage:</strong> Store the instrument in a
                      clean, dry environment within the temperature range specified by the
                      manufacturer. Do not store in a sealed bag or container &mdash; galvanic
                      oxygen sensors consume oxygen continuously and will deplete in an enclosed
                      space, shortening sensor life
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-cyan-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Record keeping:</strong> Maintain a log for
                      each instrument recording bump test results, calibration dates and results,
                      sensor replacement dates, repairs, and any incidents of high-concentration
                      exposure. This log forms part of the evidence that the instrument is properly
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-cyan-500">Summary:</strong> A gas monitor is a life-safety
                  instrument. It must be bump tested before every use, calibrated at the frequency
                  specified by the manufacturer, properly maintained, and operated by someone who
                  understands what the readings mean and what to do when they change.{' '}
                  <strong>The instrument cannot protect you if you do not understand it.</strong>
                </p>
              </div>
            </div>
          </div>
