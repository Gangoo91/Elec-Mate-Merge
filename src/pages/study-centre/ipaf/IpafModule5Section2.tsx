...
const quizQuestions = [
  ...
  {
    question:
      'When identifying hazards for tower work, which of the following is a site-specific factor that must be assessed?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Site-specific hazard identification must cover ground conditions (soft ground, slopes, voids), overhead services (power lines, pipe bridges), proximity to vehicle traffic and the public, weather exposure, and any adjacent structures that could affect tower stability.',
  },
  {
    question:
      'In the hierarchy of control, what should be considered FIRST when controlling a risk?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'The hierarchy of control prioritises: (1) Eliminate — remove the hazard entirely; (2) Substitute — use a less hazardous alternative; (3) Engineering controls — isolate people from the hazard; (4) Administrative controls — change working procedures; (5) PPE — as a last resort. Elimination is always the first consideration.',
  },
  {
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A method statement (also called a safe system of work or SSOW) details the step-by-step procedure for carrying out the work safely. For tower work, it covers assembly sequence, inspection requirements, access rules, emergency procedures, and dismantling — all linked to the risk assessment.',
  },
  {
...
const quickCheckQuestions = [
  ...
  {
    question:
      "The wind has increased since the morning briefing. The formal risk assessment says 'stop work at Beaufort Force 4.' The operative on the tower thinks it is close to Force 4 but is not sure. What should happen?",
    options: [
...
export default function IpafModule5Section2() {
  useSEO({
    ...
    description:
      'HSE 5-step risk assessment process for mobile access towers — identifying hazards, evaluating risks, hierarchy of control, method statements, and dynamic risk assessment.',
  });
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-xl p-5 mb-6">
          ...
          <p className="text-white text-base leading-relaxed">
            ...
            must always be assessed. The written assessment must be communicated to everyone
            involved, and a dynamic risk assessment continues throughout the work.
          </p>
        </div>
        ...
        <div className="bg-blue-500/10 border border-blue-500/30 rounded-xl p-5 mb-8">
          ...
          <p className="text-white text-base leading-relaxed">
            ...
            weather forecast. Then write it down, brief your team, and keep reassessing throughout
            the day.
          </p>
        </div>
            ...
            <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4">
              ...
              <div className="space-y-3 text-sm text-white">
                <div className="bg-black/20 rounded-lg p-3">
                  ...
                  <p>
                    Falls from height, contact with overhead hazards, platform collapse,
                    over-reaching injuries, fatigue-related errors, manual handling injuries during
                    assembly
                  </p>
                </div>
                <div className="bg-black/20 rounded-lg p-3">
                  ...
                  <p>
                    Struck by falling tools/materials from platform, struck by collapsing tower,
                    tripping hazards from tower base components, vehicle-tower collision while
                ...
                <div className="bg-black/20 rounded-lg p-3">
                  ...
                  <p>
                    Struck by falling objects, walking into exclusion zones, children climbing
                    unattended towers (out of hours), vehicle impact with towers near roads
                  </p>
                </div>
                <div className="bg-black/20 rounded-lg p-3">
                  <p className="text-orange-400 font-medium">Vulnerable Groups</p>
                  <p>
                    New or inexperienced workers, lone workers, agency staff unfamiliar with the
                    site, operatives with pre-existing health conditions, young workers
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-semibold text-white">
              Step 3: Evaluate Risks & Decide on Controls
            </h3>
          </div>
          <div className="border-l-2 border-amber-500/40 pl-5 space-y-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                performed. Physical barriers (Heras fencing, crash barriers, cones and tape as a
                minimum) must be used — verbal warnings alone are not sufficient.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-green-500/40 pl-5 space-y-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                on file is not compliance — it must actively inform the people doing the work.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    Ground conditions deteriorate (rain softening, nearby excavation, frost heave)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    New overhead hazards discovered (cables, structures, crane operations)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
            ...
            <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    Inspection requirements and schedule (pre-use, formal, after adverse events)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
          ...
          <div className="border-l-2 border-emerald-500/40 pl-5 space-y-4">
            ...
            <p className="text-white text-sm leading-relaxed">
              ...
              <strong className="text-white">
                if in doubt, stop, descend safely, and reassess with your supervisor
              </strong>
              .
            </p>
          </div>
          ...
          <div className="border-l-2 border-sky-500/40 pl-5 space-y-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white text-sm leading-relaxed">
                ...
                other trades about their planned activities. This site walk often reveals hazards
        ...
        <section className="mb-10">
          <h3 className="text-xl font-semibold text-white mb-4">
            Risk Assessment vs Method Statement — Quick Reference
          </h3>
        ...
        {/*  Quiz                                                         */}
        {/* ------------------------------------------------------------ */}
        <Quiz title="Section 2 — Risk Assessment for Tower Use" questions={quizQuestions} />
