...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'Why would you choose a GRP (fibreglass) tower instead of a standard aluminium tower?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'GRP (Glass Reinforced Plastic) towers are non-conductive, making them the preferred choice when working near or on live electrical installations where an aluminium tower could create a shock hazard.',
  },
  {
    id: 3,
    question: 'What is the approximate width of a double-width mobile access tower?',
    options: ['0.7 metres', '1.0 metres', '1.35 metres', '1.8 metres'],
    correctAnswer: 2,
    explanation:
      'Double-width towers are approximately 1.35m wide. The wider platform provides a more stable working area and allows for more materials and personnel on the platform.',
  },
  {
    id: 4,
    question:
      'Which type of tower is specifically designed for use in areas with limited headroom?',
    options: [
      'Stairwell tower',
  ...
  },
  {
    id: 6,
    question:
      'When working on a domestic rewire, which tower type would typically be most suitable for accessing ceiling roses in a narrow hallway?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'A single-width tower at approximately 0.7m wide is ideal for narrow hallways. It provides a stable working platform whilst fitting through standard doorways and along corridors.',
  },
  {
    id: 7,
...
const quickCheckQuestions = [
  ...
  },
  {
    id: 'grp-vs-aluminium',
    question:
      'You are replacing a light fitting directly above a live busbar chamber. Which tower material should you use?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'GRP towers are non-conductive and should always be used when working near live electrical equipment. An aluminium tower could become energised if it contacts a live conductor, creating a serious shock hazard.',
  },
  {
    id: 'stairwell-application',
    question:
      'You need to install emergency lighting on a staircase where the steps rise 3m between landings. What type of tower is required?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'A stairwell tower with adjustable legs is the correct choice. The independently adjustable legs allow the tower to sit level on the steps, providing a safe and stable platform at the required working height.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes. All mobile access towers, including low-level and folding platforms, must comply with the Work at Height Regulations 2005. Even at lower heights, falls can cause serious injury. Guardrails, toeboards, and proper assembly are still required unless the platform height is below the threshold specified in the manufacturer's instructions.",
  },
  {
    question: 'Can I mix components from different tower manufacturers?',
    answer:
      'Absolutely not. Mixing components from different manufacturers is extremely dangerous and is prohibited. Components may look similar but have different load ratings, connection methods, and tolerances. Always use components from a single manufacturer and ensure they are compatible with the specific tower system you are using.',
  },
];
...
const IpafModule2Section1 = () => {
  useSEO({
    ...
    description:
      'Learn about standard aluminium, GRP, single-width, double-width, stairwell, and folding mobile access towers. Understand when to use each type for safe working at height.',
  });
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Standard aluminium:</strong> Most common, lightweight, strong.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>GRP/fibreglass:</strong> Non-conductive — essential for electrical work.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Single-width:</strong> ~0.7m wide, for narrow spaces.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Double-width:</strong> ~1.35m wide, larger working area.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Stairwell:</strong> Adjustable legs for steps and slopes.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Folding/low-level:</strong> Compact, for lower heights.
                  </span>
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Assess:</strong> Check the workspace — width, floor surface, overhead
                    obstructions.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Select:</strong> Match tower type to the task, environment, and hazards
                    present.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Verify:</strong> Confirm the tower system is BS EN 1004 compliant.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Check:</strong> Ensure all components are from the same manufacturer and
                    system.
                  </span>
                </li>
              </ul>
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                Identify the main types of mobile access tower and describe their key features
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Standard aluminium mobile access towers are the most commonly used type across the
                construction and maintenance industries. They are manufactured from lightweight
                aluminium alloy, making them easy to transport, handle, and assemble whilst still
                providing excellent structural strength.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Material:</strong> Aluminium alloy — lightweight yet strong. A typical
                      frame weighs between 5kg and 12kg depending on size.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Corrosion Resistant:</strong> Aluminium naturally forms a protective
                      oxide layer, making it suitable for both indoor and outdoor use.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Modular Design:</strong> Components interlock to build towers to
                      various heights. The modular system means one set of components can create
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Compliance:</strong> Designed and tested to BS EN 1004-1:2020,
                      ensuring structural integrity and safe working loads are met.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  working near live electrical installations, you must use a GRP (fibreglass) tower
                  instead.
                </p>
              </div>

              <p>
                Standard aluminium towers are available in both single-width and double-width
                configurations. They can typically be built to heights ranging from 2m to over 12m
                depending on the system and whether the tower is used indoors or outdoors. The
                manufacturer's instruction manual will specify the maximum permissible height for
                each configuration.
              </p>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                GRP stands for Glass Reinforced Plastic, commonly known as fibreglass. GRP towers
                are specifically designed for use in environments where electrical conductivity is a
                hazard. For electricians, these are often the <strong>only</strong> appropriate
                choice when working near live equipment.
              </p>
              ...
              <div className="bg-white/5 border border-green-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Switchrooms:</strong> Working above switchgear panels where adjacent
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Substations:</strong> Overhead busbars and cable trays may carry live
                      supplies.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Industrial units:</strong> Cable containment, trunking, and basket
                      trays running at height.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Data centres:</strong> High-density power distribution with multiple
                      live feeds.
                    </div>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Non-conductive:</strong> Will not conduct electricity if it contacts a
                      live source.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Heavier than aluminium:</strong> GRP components are typically 30-50%
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>UV sensitive:</strong> Prolonged outdoor exposure can degrade the
                      material over time. Store under cover when not in use.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Surface condition:</strong> GRP must be kept clean and dry.
                      Contamination with conductive materials (metal filings, wet grime) can reduce
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Cost:</strong> GRP towers are more expensive than aluminium
                      equivalents, but the safety benefit is essential where electrical hazards
                      exist.
                    </span>
                  </li>
                </ul>
              ...
              <p>
                It is critical to understand that a GRP tower's non-conductive properties can be
                compromised. If the tower is wet, dirty, or contaminated with conductive substances,
                its insulating properties are reduced. Always ensure GRP components are clean and
                dry before use, and store them properly to maintain their integrity.
              </p>
              ...
              <div className="bg-white/5 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  strong, lightweight, non-conductive material. Also known as fibreglass or FRP
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Mobile access towers come in two standard width configurations. The choice between
                single-width and double-width depends on the available space, the nature of the
                work, and the number of operatives who need to be on the platform simultaneously.
              </p>
                  ...
                  <div className="bg-white/5 border border-blue-400/30 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Width:</strong> Approximately 0.7m (700mm)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Platform length:</strong> Typically 1.8m to 2.5m
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Best for:</strong> Narrow corridors, between shelving/racking,
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Doorways:</strong> Fits through standard doorways without
                          dismantling
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Operatives:</strong> Generally one person on the platform
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Max height:</strong> Lower than double-width due to reduced base
                          area (check manufacturer's data)
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white/5 border border-blue-400/30 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Width:</strong> Approximately 1.35m (1350mm)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Best for:</strong> Open areas, external work, tasks requiring more
                          workspace
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Stability:</strong> Greater base area provides increased stability
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Operatives:</strong> Can accommodate two people and materials
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Max height:</strong> Can be built higher than single-width (check
                          manufacturer's data)
                        </span>
                      </li>
                    </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1 text-sm">
                  <li>
                    1. <strong>Measure the available space</strong> — can the tower physically fit?
                  </li>
                  <li>
                    2. <strong>Consider the task</strong> — do you need to lay out tools and
                    materials on the platform?
                  </li>
                  <li>
                    3. <strong>Count the operatives</strong> — will more than one person need to
                    work from the platform?
                  </li>
                  <li>
                    4. <strong>Check the height required</strong> — single-width towers have lower
                    maximum heights.
                  </li>
                  <li>
                    5. <strong>Think about access</strong> — does the tower need to pass through
                    doorways or lifts?
                  </li>
                </ul>
              </div>
              ...
              <p>
                Remember that platform dimensions determine the available working area. A
                single-width tower platform of 0.7m x 2.5m gives approximately 1.75m² of workspace.
                A double-width platform of 1.35m x 2.5m gives approximately 3.38m² — nearly double
                the working area. For tasks that require spreading out tools, materials, or having
                two operatives working side by side, double-width is the better choice.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Stairwell towers — sometimes called staircase towers or split-level towers — are
                specialised mobile access towers designed to provide a safe, level working platform
                on stairs, ramps, or other sloping surfaces where a standard tower cannot be used.
              </p>
              ...
              <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Adjustable Legs:</strong> Each leg can be independently adjusted to
                      different lengths, allowing the tower to sit level on steps or slopes.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Locking Mechanisms:</strong> Adjustable legs have positive locking
                      pins or clamps to prevent movement once set.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Compact Footprint:</strong> Designed to fit within standard
                      stairwells, typically using a narrow base configuration.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Level Platform:</strong> Despite the uneven base, the platform remains
                      horizontal for safe working.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <p>
                For electricians, stairwell towers are invaluable. Emergency lighting installations,
                fire alarm detectors on staircase ceilings, and rewiring work in stairwells all
                require safe access at height. Working from stepladders on stairs is extremely
                hazardous — the uneven surface creates an unstable base and significantly increases
                the risk of a fall.
              </p>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  tower with proper adjustable legs and locking mechanisms.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1 text-sm">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Fire alarm detector installation and maintenance on stairwell landings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Rewiring work — accessing junction boxes and cable routes above staircases
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
        ...
        <section className="mb-10">
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Folding towers and low-level platforms provide safe access for work at modest
                heights — typically up to 2.5m platform height. They are designed to be compact,
                quick to set up, and easy to transport, making them ideal for lighter tasks where a
                full-height tower would be impractical.
              </p>
                  ...
                  <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Foldable frame:</strong> Collapses flat for storage and transport
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Quick assembly:</strong> Can typically be erected by one person in
                          minutes
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Platform height:</strong> Usually up to 1.5m-2.5m
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Guardrails:</strong> Fold-out or clip-on guardrails provided
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Castors:</strong> Fitted with braked castors for easy
                          repositioning
                        </span>
                      </li>
                    </ul>
                  ...
                  <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Step-up design:</strong> Simple, robust platforms with integrated
                          steps
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Platform height:</strong> Typically 0.5m-1.0m
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Guardrails:</strong> May not require guardrails at very low
                          heights (check regs)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Lightweight:</strong> Often under 15kg for easy portability
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Ideal for:</strong> Repetitive tasks at just-out-of-reach heights
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <p>
                Folding and low-level towers are not a substitute for full-height towers when
                greater reach is needed. However, they fill an important gap between stepladders and
                full mobile access towers. They provide a safer, more stable platform than a
                stepladder, with the added benefit of guardrails and a larger working area.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="font-semibold mb-2 text-elec-yellow">
                  When to Use a Folding/Low-Level Tower
                </h3>
                <ul className="text-white space-y-1 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Installing ceiling-mounted accessories (light fittings, smoke detectors,
                      speakers)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Any task where a stepladder feels unstable but a full tower is overkill
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  They are covered by BS 8620:2022 and must still comply with the Work at Height
                  Regulations 2005.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Selecting the correct tower type is a key competence for anyone working at height.
                The wrong choice can create hazards, reduce productivity, and lead to non-compliance
                with regulations. Use this quick reference to guide your selection:
              </p>
                ...
                <div>
                  ...
                  <ul className="space-y-1 text-white">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Aluminium double-width:</strong> Warehouse
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">GRP single-width:</strong> Switchroom cable
                        tray work
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Stairwell:</strong> Emergency lighting in
                        stairwells
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Folding:</strong> Office ceiling sensor
                        installations
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Low-level:</strong> Domestic light fitting
                        changes
                      </span>
                    </li>
                  </ul>
        ...
        {/* Quiz Section */}
        <div className="mt-12">
          <Quiz title="Types of Mobile Access Towers Quiz" questions={quizQuestions} />
        </div>
