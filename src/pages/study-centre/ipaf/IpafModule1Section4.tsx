...
const quickCheckQuestions = [
  ...
  },
  {
    id: 'pasma-renewal',
    question:
      'How long is a standard PASMA Towers for Users card valid before renewal is required?',
    options: ['1 year', '3 years', '5 years', '10 years'],
    correctIndex: 2,
    explanation:
      'PASMA Towers for Users cards are valid for 5 years from the date of the course. After 5 years, you must complete a renewal course to maintain your certification. However, competence should be maintained throughout through regular practice.',
  },
  {
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'PASMA Towers for Users cards are valid for 5 years from the date of successful completion. Holders must complete a renewal course before expiry to maintain their certification.',
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'Competence for tower work requires a combination of adequate training, relevant knowledge, sufficient experience, and practical ability to carry out the task safely. No single factor is sufficient on its own.',
  },
  {
    id: 4,
    ...
    correctAnswer: 1,
    explanation:
      'The Work at Height Regulations require that trainees are supervised by a competent person. For tower work, this means someone with current PASMA certification, practical experience, and the ability to intervene if the work is being done incorrectly.',
  },
  {
    id: 5,
    question:
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Employers should maintain comprehensive training records including the course attended, date of completion, certificate/card number, expiry date, and any additional assessments of competence or refresher training. These records demonstrate compliance with the duty to use competent persons.',
  },
  {
    id: 8,
...
export default function IpafModule1Section4() {
  useSEO({
    ...
    description:
      'What PASMA is, Towers for Users course, competence vs qualification, supervision of trainees, record keeping, 5-year renewal cycle, employer responsibilities, and card types.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>PASMA:</strong> Industry trade body for mobile access towers
              </li>
              <li>
                <strong>Card:</strong> Valid 5 years, renewable with refresher course
              </li>
              <li>
                <strong>Competence:</strong> Training + knowledge + experience + ability
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Carry:</strong> Valid PASMA card at all times when using towers
              </li>
              <li>
                <strong>Verify:</strong> Check card validity via the PASMA online system
              </li>
              <li>
                <strong>Supervise:</strong> Trainees must have direct competent supervision
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                It is the recognised trade association for the mobile access tower industry in the
                United Kingdom. Founded in 1974, PASMA represents manufacturers, hire companies, and
                training providers across the sector.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">PASMA's Role:</strong> PASMA develops
                  industry guidance, sets training standards, operates the card scheme for trained
                  operatives, and works with the HSE and other regulators to improve safety
                  standards in mobile tower scaffold work across all industries.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Develops and maintains training courses for tower users, managers, and
                      instructors
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <p>
                While PASMA is not a regulatory body and has no legal enforcement powers, its
                training and card scheme are universally recognised across the construction and
                maintenance industries. Holding a valid PASMA card is widely accepted as evidence of
                competence for mobile tower scaffold work.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The PASMA Towers for Users course is the flagship training programme for anyone who
                will assemble, alter, dismantle, move, inspect, or work from a mobile access tower.
                It is a practical, hands-on course that combines classroom theory with physical
                tower assembly and dismantling exercises.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Card shows holder's name, photograph, card number, issue and expiry dates
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                complying with the Work at Height Regulations. The Regulations do not require
                specific qualifications &mdash; they require competence. A qualification is evidence
                towards competence, but it is not the whole picture.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  ...
                  <p>
                    <strong className="text-white">2. Knowledge:</strong> Understanding of the
                    regulations, standards, hazards, and safe systems of work
                  </p>
                  <p>
                    <strong className="text-white">3. Experience:</strong> Regular practical
                    application of skills in real working situations
                  </p>
                  <p>
                    <strong className="text-white">4. Ability:</strong> Physical and cognitive
                    capacity to carry out the work safely, including recognising and responding to
                    changing conditions
                  </p>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  date. Refresher training or supervised practice may be needed before allowing
                  unsupervised tower work.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Work at Height Regulations allow persons who are not yet fully competent to
                carry out work at height, provided they are under the direct supervision of a
                competent person. This is essential for allowing on-the-job training and
                development, but the supervision requirements are strict.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Direct supervision:</strong> The competent
                      person must be physically present and able to observe the trainee's work.
                      Remote supervision (e.g. by phone) is not acceptable for tower assembly.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Able to intervene:</strong> The supervisor must
                      be in a position to stop incorrect work immediately and correct the trainee
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Competent supervisor:</strong> The supervisor
                      must themselves be competent in the specific work being supervised. For tower
                      work, this means holding a current PASMA certificate and having relevant
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Proportionate:</strong> The level of
                      supervision must match the risk and the trainee's level of experience. A
                      complete beginner needs closer supervision than someone who has completed
                      their PASMA course but needs practice.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Maintaining accurate training and competence records is not just good practice
                &mdash; it is essential evidence that the employer has fulfilled their legal duty to
                use competent persons for work at height. If an incident occurs, the HSE will ask to
                see these records.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  listing all workers who use towers, their PASMA card numbers, expiry dates, and
                  when they last assembled a tower. Set reminders 3 months before cards expire so
                  renewal can be arranged without a gap in certification.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  site during the work and retain for at least 3 months after completion.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                PASMA Towers for Users certification is valid for 5 years from the date of
                successful completion. After this period, the card expires and the holder must
                complete a renewal course to maintain their certified status. The renewal course is
                shorter than the initial course as it builds on existing knowledge.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex items-start gap-3">
                    ...
                    <p>
                      <strong className="text-white">Years 1-4:</strong> Card is valid. Maintain
                      competence through regular practice. Employer should monitor ongoing
                      competence.
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <p>
                      <strong className="text-white">3 months before expiry:</strong> Book renewal
                      course. PASMA sends reminder notifications to cardholders.
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <p>
                      <strong className="text-white">Renewal course:</strong> Shorter than the
                      initial course. Updates on regulation changes, refreshes practical skills, and
                      assesses current competence.
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <p>
                      <strong className="text-white">New card issued:</strong> Valid for a further 5
                      years from the renewal date. Old card becomes invalid.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      If your card has been expired for more than 12 months, you may need to
                      complete the full initial course again rather than the shorter renewal
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Your employer may be in breach of the Regulations if they allow you to carry
                      out tower work with an expired card
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The employer bears the primary legal duty to ensure that anyone who assembles,
                alters, dismantles, inspects, or works from a mobile scaffold tower is competent to
                do so. This duty goes well beyond simply sending someone on a course &mdash; it
                requires an ongoing commitment to training, assessment, and development.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    towers they will use.
                  </p>
                  <p>
                    <strong className="text-white">2. Provide appropriate training:</strong> Fund
                    and arrange PASMA courses (or equivalent) appropriate to the type of tower work
                    involved.
                  </p>
                  <p>
                    <strong className="text-white">3. Verify competence:</strong> Check that
                    training has been received, cards are valid, and workers can demonstrate
                    practical ability.
                  </p>
                  <p>
                    <strong className="text-white">4. Monitor ongoing competence:</strong> Observe
                    workers assembling and using towers to ensure standards are maintained.
                  </p>
                  <p>
                    <strong className="text-white">5. Provide refresher training:</strong> Arrange
                    renewal courses before cards expire and provide additional training if
                    competence concerns arise.
                  </p>
                  <p>
                    <strong className="text-white">6. Supervise appropriately:</strong> Ensure the
                    level of supervision matches the experience and competence of each worker.
                  </p>
                  <p>
                    <strong className="text-white">7. Keep records:</strong> Maintain up-to-date
                    records of training, assessments, and card validity dates.
                  </p>
                </div>
              </div>
