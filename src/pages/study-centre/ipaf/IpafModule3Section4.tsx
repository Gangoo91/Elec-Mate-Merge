...
const DESCRIPTION =
  'Safe dismantling procedures for mobile access towers. Reverse sequence, lowering components safely, minimum crew requirements, and post-dismantling site clearance.';
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A full post-dismantling site clearance is required. All components must be collected, inspected, and stored properly. Barriers and signage must be removed. The ground must be checked for debris, fixings, or damage. The area should be left in a safe and tidy condition.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'If wind conditions become hazardous, stop work immediately. Secure the tower in its current state — do not leave it partially dismantled without guardrails. Wait for conditions to improve before resuming. A partially dismantled tower is less stable than a complete one.',
  },
  {
    id: 8,
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Reverse Sequence:</strong> ALWAYS dismantle in the exact reverse order
                    of assembly.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Never Throw:</strong> Components are lowered, NEVER thrown or dropped.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Two Persons Minimum:</strong> One on the tower, one on the ground at
                    minimum.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Guardrails Last:</strong> At each level, guardrails are the last to be
                    removed.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Exclusion Zone:</strong> Maintain the zone throughout the entire
                    dismantling process.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Site Clearance:</strong> Remove all components, barriers, and debris
                    when complete.
                  </span>
                </li>
              </ul>
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Spot:</strong> End of a job, tower relocation, scaffold handback.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Use:</strong> Follow the manufacturer's dismantling sequence from the
                    instruction manual.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Apply:</strong> Plan the dismantling, brief the team, maintain the
                    exclusion zone, lower components carefully, inspect and store components after
                    removal.
                  </span>
                </li>
              </ul>
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                Explain why dismantling must always follow the exact reverse of the assembly
                sequence
              </span>
            </li>
            <li className="flex items-start gap-3">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                tested, and certified to be assembled in a specific sequence. The structural
                integrity of the tower at each stage of assembly depends on the components being in
                the correct order. Dismantling must therefore follow the exact reverse of this
                sequence.
              </p>
              ...
              <div className="bg-red-500/20 border border-red-400/50 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Structural Integrity:</strong> Removing components out of order can
                      create an unstable structure that collapses without warning
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Overloading:</strong> The wrong sequence can overload remaining
                      components beyond their design capacity
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Fall Protection:</strong> Only the reverse sequence guarantees the
                      operative is always protected by guardrails during dismantling
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Tested Sequence:</strong> The manufacturer has tested the
                      assembly/dismantling sequence — any other order is untested and unpredictable
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="font-semibold mb-3 text-elec-yellow">
                  Reverse Sequence Example (3T Tower)
                </h3>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Before starting, brief the team on the dismantling plan. Ensure the exclusion zone
                is in place, all castors are locked, and the instruction manual is available.
                Confirm all personnel and materials are off the tower working platform.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ol className="space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Clear the Top Platform:</strong> Remove all tools, materials, and
                      equipment from the working platform. Nothing should remain on the tower above
                      the dismantler.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Descend to the Level Below:</strong> Climb down to the platform one
                      level below the top. You are now protected by the guardrails of this lower
                      platform.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Remove Top Guardrails:</strong> Reaching up through the trapdoor (3T)
                      or from below, remove the guardrails from the top level. Lower them carefully.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-elec-yellow/20 border border-elec-yellow/40 flex items-center justify-center flex-shrink-0 text-elec-yellow text-xs font-bold">
                    ...
                    <div>
                      <strong>Remove Top Platform:</strong> Lift out the platform from the top level
                      and lower it down. For AGR systems, the guardrails will collapse when the
                      platform is removed.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Remove Toeboards:</strong> Remove toeboards from the top level if
                      fitted as separate components.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-elec-yellow/20 border border-elec-yellow/40 flex items-center justify-center flex-shrink-0 text-elec-yellow text-xs font-bold">
                    ...
                    <div>
                      <strong>Remove Braces:</strong> Remove diagonal and horizontal braces from the
                      top frame section. Lower each one carefully.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-elec-yellow/20 border border-elec-yellow/40 flex items-center justify-center flex-shrink-0 text-elec-yellow text-xs font-bold">
                    ...
                    <div>
                      <strong>Remove Frame Sections:</strong> Disconnect and remove the top frame
                      sections. Lower them to the ground person.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-elec-yellow/20 border border-elec-yellow/40 flex items-center justify-center flex-shrink-0 text-elec-yellow text-xs font-bold">
                    ...
                    <div>
                      <strong>Repeat:</strong> Move down one level and repeat the sequence until
                      only the base remains. Dismantle the base last.
                    </div>
                  </li>
                </ol>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Components must NEVER be thrown, dropped, or allowed to fall uncontrolled from any
                height. There are two primary methods for lowering components safely, and the choice
                depends on the height, weight of the component, and the number of operatives
                available.
              </p>
                  ...
                  <div className="bg-white/5 border border-green-400/30 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Suitable For:</strong> Lower heights (up to ~4m), lighter
                          components
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Method:</strong> Operative on tower passes component down to
                          person on ground or intermediate level
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Communication:</strong> Clear verbal signals ("ready to receive",
                          "releasing")
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Position:</strong> Ground person stands to the side, not directly
                          below
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Grip:</strong> Both parties must have a firm grip before releasing
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Suitable For:</strong> Greater heights (above ~4m), heavier
                          components
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Equipment:</strong> Purpose-made gin wheel, rated rope, secure
                          attachment
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Rope Rating:</strong> Must be rated for the weight being lowered
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Control:</strong> Lower steadily — never let the rope run free
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Anchor:</strong> Pulley must be securely fixed to the tower
                          structure
                        </span>
                      </li>
                    </ul>
              ...
              <div className="bg-red-500/20 border border-red-400/50 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  Throwing components from a tower is one of the most dangerous practices on a
                  construction site. A 3kg guardrail tube dropped from 6 metres generates enough
                  force to cause a fatal head injury. Even with a hard hat, the impact energy at
                  this height is well beyond the protection level of standard head protection. Use
                  controlled lowering methods every time.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Tower dismantling requires a minimum of two persons. This is not merely a
                recommendation — it is a practical necessity for safe operation. The risk assessment
                may require additional personnel depending on the tower height, location, and
                complexity.
              </p>
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Position:</strong> On the tower, one level below the level being
                          dismantled
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Role:</strong> Removes components in the correct reverse sequence
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Passes:</strong> Hands or lowers components to the ground person
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Qualification:</strong> Must be PASMA trained and competent
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>PPE:</strong> Full PPE including hard hat with chinstrap
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Position:</strong> On the ground, outside the tower footprint
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Role:</strong> Receives components, stacks them safely
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Exclusion Zone:</strong> Maintains the exclusion zone and controls
                          access
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Emergency:</strong> Available to summon help if an incident occurs
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>PPE:</strong> Full PPE including hard hat
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <h3 className="font-semibold mb-2 text-elec-yellow">
                  When More Than Two Are Needed
                </h3>
                <ul className="text-white text-sm space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Tower height exceeds 4 metres — additional person for component handling
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Near public areas — dedicated banksman for exclusion zone control</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>AGR systems — heavier frames may need team lifting</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Rope and pulley operations — separate rope handler</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Complex configurations — additional trained operative on the tower</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Just as guardrails are installed first (before stepping onto a platform) during
                assembly, they must be removed last during dismantling. The operative must always be
                on the level below — protected by that level's guardrails — before removing
                guardrails from the level above.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="font-semibold mb-3 text-elec-yellow">
                  Why Guardrails Are Removed Last
                </h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Fall Protection:</strong> Guardrails are the primary fall protection
                      for anyone on the platform. Removing them early exposes the operative to an
                      unprotected edge.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Reverse of Assembly:</strong> In assembly, guardrails are fitted
                      before the operative steps onto the platform. In dismantling, the operative
                      leaves the platform (goes down) before the guardrails are removed.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Protected Removal:</strong> Guardrails on the level above are removed
                      by reaching up from the protected level below — the same principle as the 3T
                      assembly method in reverse.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-500/20 border border-red-400/50 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  Removing guardrails early to "make it easier to pass components down" is one of
                  the most common and most dangerous shortcuts in tower dismantling. It is
                  responsible for numerous fatal falls from mobile towers. There is no situation
                  where removing guardrails before the platform and braces is acceptable.
                </p>
              </div>
            </div>
          </div>
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Inspect:</strong> Check each component for damage as it is removed
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Clean:</strong> Remove dirt, concrete, paint, and debris
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Dry Storage:</strong> Store in a dry, covered area to prevent
                          corrosion
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Off the Ground:</strong> Use racks, pallets, or stillages
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Organised:</strong> Group by type (frames, braces, platforms,
                          etc.)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Inventory:</strong> Count all components against the parts list
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Tag Defects:</strong> Separate and tag any damaged components
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Remove Barriers:</strong> Take down exclusion zone barriers and
                          signage
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Clear Debris:</strong> Pick up any fixings, clips, or locking pins
                          from the ground
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Ground Repair:</strong> Note any ground damage (indentations from
                          castors, sole board marks)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Notify Site:</strong> Inform the site manager that the area is
                          clear
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Documentation:</strong> Complete any required handback or
                          completion forms
                        </span>
                      </li>
                    </ul>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Dismantling is as vulnerable to weather conditions as assembly. Wind, rain,
                lightning, and poor visibility can all create additional hazards during the process.
              </p>
                ...
                <div className="bg-white/5 border border-red-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Wind:</strong> Stop if wind speed exceeds the manufacturer's limit
                        (typically 17 mph / Beaufort 4)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Lightning:</strong> Stop immediately — metal tower is a conductor
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Heavy Rain:</strong> Slippery components and reduced grip
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Ice/Frost:</strong> Slippery surfaces on platforms and frames
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Poor Visibility:</strong> Fog, failing light, or dust
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-green-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Secure:</strong> Leave the tower in a stable state with guardrails
                        in place
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Descend:</strong> All operatives descend safely to ground level
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Barriers:</strong> Ensure the exclusion zone remains in place
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Signage:</strong> Post "Tower Under Dismantling — Do Not Use" signs
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Report:</strong> Notify site management of the situation
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reverse sequence:</strong> Always
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Never throw:</strong> Lower everything
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Min 2 persons:</strong> Tower + ground
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Guardrails last:</strong> At every level
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Castors locked:</strong> Throughout
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Exclusion zone:</strong> Maintain always
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hand-to-hand:</strong> Lower heights, light
                      items
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Rope & pulley:</strong> Above 4m, heavier items
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">NEVER:</strong> Throw, drop, or slide
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <ul className="space-y-1 text-white">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Clean and dry before storage</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Tag any defective items</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Count against parts list</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Store in dry, covered area</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Remove barriers and signage</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Clear debris from site</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Notify site manager of completion</span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Lightning is observed</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Heavy rain reduces grip</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Ice or frost on components</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Visibility is poor</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        {/* Quiz Section */}
        <div className="mt-12">
          <Quiz title="Dismantling & Safe Lowering Quiz" questions={quizQuestions} />
        </div>
