...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'What is the maximum total load typically permitted on a mobile access tower (all platforms combined)?',
    options: ['500kg', '750kg', '950kg', '1200kg'],
    correctAnswer: 2,
    explanation:
      'The maximum total load on the tower — combining all platforms — is typically 950kg. This is the total structural capacity. Individual platform limits and the overall tower limit must both be respected.',
  },
  {
    id: 3,
    ...
    correctAnswer: 1,
    explanation:
      'Work should cease at Beaufort Force 4 (approximately 17 mph / 28 km/h). At this wind speed, loose papers blow around and small branches move. The tower itself may be rated to withstand higher forces, but working from it becomes unsafe.',
  },
  {
    id: 4,
    question:
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'The 3:1 rule was a simplified guideline that did not account for differences between tower systems, single vs double-width, indoor vs outdoor use, or stabiliser configurations. Manufacturer-specific instructions now take precedence, as they are based on actual structural calculations for each system.',
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation:
      'Manufacturer instructions are legally binding under the Work at Height Regulations 2005 and the Provision and Use of Work Equipment Regulations 1998 (PUWER). Failure to follow them is a criminal offence and can result in prosecution.',
  },
  {
    id: 7,
    question:
...
const quickCheckQuestions = [
  {
    ...
    question:
      'Two electricians (80kg and 95kg) are on the platform with 60kg of cable drums. Is the platform load within limits?',
    options: [
    ...
    correctIndex: 0,
    explanation:
      "Total platform load = 80 + 95 + 60 = 235kg. This is within the 275kg per-platform limit. However, always check the manufacturer's instructions for the specific tower system, as some may have different limits.",
  },
  {
    id: 'wind-assessment',
    question:
      'You are working on an outdoor tower and notice leaves and small twigs are constantly moving, and loose paper blows off the platform. What should you do?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'Leaves and small twigs in constant motion, and loose paper blowing around, are indicators of Beaufort Force 4 (moderate breeze, 17-24 mph). This is the threshold at which all tower work must cease. Descend, secure the tower, and do not resume until wind conditions improve.',
  },
  {
    id: 'manufacturer-instructions',
    question:
      'A colleague tells you the 3:1 rule means you can build a 9m tower on a 3m base outdoors without stabilisers. Is this correct?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      "The 3:1 rule is obsolete and must not be used. Every tower system has different maximum heights for different configurations (single/double, indoor/outdoor, with/without stabilisers). Only the manufacturer's instruction manual provides the correct limits for the specific system you are using.",
  },
];
...
const IpafModule2Section3 = () => {
  useSEO({
    ...
    description:
      'Learn about mobile access tower stability, 275kg platform limits, 950kg total load, wind speed limits, lateral forces, and why manufacturer instructions are legally binding.',
  });
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>275kg:</strong> Maximum per-platform safe working load.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>950kg:</strong> Maximum total tower load (all platforms).
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>20kg:</strong> Maximum lateral force at platform level.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Beaufort 4:</strong> Cease work (17 mph / 28 km/h winds).
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Beaufort 6:</strong> Tower design wind rating (27 mph / 44 km/h).
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>3:1 ratio:</strong> Obsolete — use manufacturer's data instead.
                  </span>
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Calculate:</strong> Add up all platform loads before climbing.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Monitor:</strong> Check wind conditions regularly throughout the day.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Follow:</strong> Manufacturer instructions are the law — no exceptions.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Record:</strong> Document load assessments in your risk assessment.
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-3 text-white">
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Identify the Beaufort scale thresholds for ceasing work and tower design ratings
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Every mobile access tower has defined load limits that must never be exceeded. These
                limits are calculated by the manufacturer based on the structural capacity of the
                tower components and are stated in the instruction manual. There are two key limits
                you must know:
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Personnel:</strong> Full body weight of every person on the platform
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Tools:</strong> Hand tools, power tools, drills, testers, etc.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Materials:</strong> Cable drums, containment, fittings, fixings,
                      luminaires
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Equipment:</strong> Tool bags, tool boxes, buckets, trays
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>PPE:</strong> Harness, tool belt, hard hat (smaller but still counts)
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                A mobile access tower is designed primarily to carry vertical loads (the weight of
                people and materials pressing downward). It has far less capacity to resist
                horizontal (lateral) forces. The typical lateral force limit at platform level is
                just <strong>20kg (approximately 200N)</strong>.
              </p>
              ...
              <div className="bg-white/5 border border-blue-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Leaning out:</strong> Reaching beyond the edge of the platform creates
                      a horizontal force on the guardrail and structure
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Pushing against walls:</strong> Using the tower as a brace whilst
                      drilling or fixing creates a reaction force
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Wind loading:</strong> Wind pressure on the tower structure, sheeting,
                      or personnel creates lateral forces
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Pulling cables:</strong> Drawing cables through containment creates a
                      reaction force on the tower
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  requires significant horizontal force, you need to reposition the tower rather
                  than reach from where you are.
                </p>
              </div>

              <p>
                The 20kg lateral force limit is a critical design parameter. Exceeding it can cause
                the tower to overturn, especially at greater heights where the overturning moment is
                amplified. A small horizontal force at the top of a 10m tower creates a very large
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Wind is the most significant environmental factor affecting tower stability. It
                creates lateral forces on the tower structure and on the people working on it. There
                are two critical wind speed thresholds you must know:
              </p>
              ...
              <p>
                Wind speed is not constant — it gusts. A sustained wind of Beaufort 3 can produce
                gusts at Beaufort 5 or higher. Always consider gust conditions, not just the
                sustained wind speed. If gusts are reaching Beaufort 4 or above, cease work even if
                the sustained wind is lower.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Force 3:</strong> Leaves and small twigs in constant movement, light
                      flags extended
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Force 4:</strong> Dust, loose paper, and small branches moving —{' '}
                      <strong className="text-orange-300">STOP WORK</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Force 5:</strong> Small trees sway, wavelets form on inland waters
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Force 6:</strong> Large branches in motion, difficult to use umbrellas
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                You may hear experienced workers refer to the "3:1 rule" — the idea that a tower can
                be built to a height three times the smallest base dimension. For example, a tower
                with a 2m x 1.35m base could supposedly be built to 4.05m (3 x 1.35m).{' '}
                <strong>This rule is obsolete and must not be used.</strong>
              </p>
              ...
              <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>One size does not fit all:</strong> Different tower systems have
                      different structural capacities. A 3:1 ratio might be safe for one system but
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Indoor vs outdoor:</strong> The rule made no distinction between
                      indoor use (no wind) and outdoor use (wind loading is a major factor).
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Stabiliser configurations:</strong> The rule did not account for the
                      effect of stabilisers or outriggers on the effective base area.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Single vs double-width:</strong> Single-width towers have
                      fundamentally different stability characteristics than double-width towers.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Not evidence-based:</strong> The ratio was a rule of thumb, not
                      derived from engineering calculations for specific tower systems.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  single-width, double-width, indoor, outdoor, with stabilisers, and without
                  stabilisers. There is no universal ratio.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                This is one of the most important points in the entire IPAF course. Manufacturer
                instructions for mobile access towers are not optional guidance — they are{' '}
                <strong>legally binding requirements</strong>. Failure to follow them is a criminal
                offence under multiple pieces of legislation.
              </p>
              ...
              <div className="bg-white/5 border border-red-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Work at Height Regulations 2005, Regulation 8:</strong> Requires work
                      equipment to be used in accordance with the manufacturer's instructions.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>PUWER 1998, Regulation 5:</strong> Work equipment must be used only
                      for operations and under conditions for which it is suitable, as specified by
                      the manufacturer.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>HSWA 1974, Section 2:</strong> Duty of care to employees — using
                      equipment contrary to manufacturer instructions is a breach.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>CDM 2015:</strong> Duty holders must ensure work equipment is used in
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-elec-yellow font-medium mb-2">
                  What the Manufacturer Manual Specifies
                </h3>
                <ul className="text-white space-y-1 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Maximum heights for each configuration (single/double, indoor/outdoor)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <p>
                The manufacturer's instruction manual must be available on site whenever the tower
                is in use. If the manual is lost, contact the manufacturer for a replacement. Do not
                assemble or use the tower without it.
              </p>
              ...
              <div className="bg-white/5 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  <strong className="text-white">legal right and duty to refuse</strong>. Report the
                  situation to your employer and the HSE if necessary. No job is worth a criminal
                  prosecution or a serious injury.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Understanding why towers overturn helps you appreciate the importance of the load
                and force limits. The physics are straightforward: any lateral force applied at
                height creates an
                <strong> overturning moment</strong> — a rotational force that tries to tip the
                tower over.
              </p>
              ...
              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Overturning moment:</strong> Force x distance from the base. A 20kg
                      force at 8m height creates an overturning moment of 160 kg-m — far greater
                      than the same force at 2m (40 kg-m).
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Restoring moment:</strong> The tower's own weight and base width
                      resist overturning. A wider base and heavier tower resist overturning better.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Tipping point:</strong> When the overturning moment exceeds the
                      restoring moment, the tower tips. This happens suddenly and without warning.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Stabilisers help:</strong> Stabilisers increase the effective base
                      area, dramatically increasing the restoring moment and resistance to
                      overturning.
                    </div>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1 text-sm">
                  <li>
                    1. <strong>Level:</strong> Check the tower is plumb (vertical) using a spirit
                    level on the uprights
                  </li>
                  <li>
                    2. <strong>Castors locked:</strong> Confirm all four castor brakes are fully
                    engaged
                  </li>
                  <li>
                    3. <strong>Stabilisers deployed:</strong> If fitted, verify all stabilisers are
                    making firm ground contact
                  </li>
                  <li>
                    4. <strong>Ground condition:</strong> Check the ground has not become soft, wet,
                    or undermined
                  </li>
                  <li>
                    5. <strong>No packing:</strong> Verify nobody has placed blocks, bricks, or
                    timber under the base
                  </li>
                  <li>
                    6. <strong>Braces complete:</strong> All diagonal and horizontal braces are in
                    position and secure
                  </li>
                  <li>
                    7. <strong>No sheeting:</strong> No tarpaulins, banners, or sheeting attached
                    that would catch wind
                  </li>
                  <li>
                    8. <strong>Ties intact:</strong> If the tower is tied to a structure, verify the
                    ties are secure
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Missing braces:</strong> Allows racking under
                      lateral load
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Unlocked castors:</strong> Tower can roll and
                      tip
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Overloading one side:</strong> Shifts the
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Sheeting or tarpaulins:</strong> Massively
                      increases wind loading
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Climbing the outside:</strong> Shifts body
                      weight beyond the base footprint
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Soft or uneven ground:</strong> Base sinks on
                      one side, tilting the tower
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Adjacent vehicle traffic:</strong> Vibration
                      and impact risk
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  in Newton-metres (Nm) or kilogram-metres (kg-m). The higher the point of
                  application, the greater the overturning moment for the same force.
                </p>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Per platform:</strong> 275kg max (people +
                      tools + materials)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Total tower:</strong> 950kg max (all platforms
                      combined)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lateral force:</strong> 20kg max at platform
                      level
                    </span>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Beaufort 4 (17 mph):</strong> CEASE WORK
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Beaufort 6 (27 mph):</strong> Tower design
                      limit (unoccupied)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Beaufort 7+:</strong> Consider
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">3:1 rule:</strong> OBSOLETE — do not use
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Manufacturer manual:</strong> Legally binding
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Manual on site:</strong> Required whenever
                      tower is in use
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Right to refuse:</strong> If instructions say
                      no, say no
                    </span>
                  </li>
                </ul>
        ...
        {/* Quiz Section */}
        <div className="mt-12">
          <Quiz title="Stability & Safe Working Loads Quiz" questions={quizQuestions} />
        </div>
