...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      'Under CDM 2015, who is responsible for managing and planning the construction phase?',
    options: ['The client', 'The principal designer', 'The principal contractor', 'The HSE'],
    correctIndex: 2,
    explanation:
      'The principal contractor is responsible for planning, managing, and co-ordinating the construction phase. This includes ensuring that work at height, including tower scaffold work, is properly managed and that all contractors comply with site rules.',
  },
  {
    id: 'cdm-notification',
...
const quizQuestions = [
  {
    id: 1,
    question:
      'Which section of HSWA 1974 places a general duty on employers to ensure employee health and safety?',
    options: ['Section 1', 'Section 2', 'Section 7', 'Section 8'],
    correctAnswer: 1,
    explanation:
      'Section 2 of HSWA 1974 places the general duty on every employer to ensure, so far as is reasonably practicable, the health, safety, and welfare at work of all employees.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    options: ['The HSE', 'The main contractor', 'The client', 'The designer'],
    correctAnswer: 2,
    explanation:
      'The client has the duty to appoint a principal designer and principal contractor on projects involving more than one contractor. The client must make these appointments as soon as practicable and before the construction phase begins.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'The principal designer plans, manages, and co-ordinates health and safety during the pre-construction phase, including identifying and eliminating or reducing risks through design decisions.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Clients must ensure that reasonable welfare facilities are available throughout the construction phase. This includes toilets, washing facilities, drinking water, changing rooms, and rest areas.',
  },
];
...
export default function IpafModule1Section2() {
  useSEO({
    ...
    description:
      'Employer and employee duties under the Health and Safety at Work Act 1974, CDM 2015 duty holders, notification requirements, and how they apply to mobile tower scaffold work.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>HSWA:</strong> Overarching safety law &mdash; Sections 2, 3, 7, 8
              </li>
              <li>
                <strong>CDM:</strong> Construction-specific duties for clients, designers,
                contractors
              </li>
              <li>
                <strong>Tower work:</strong> Both apply whenever you use a tower on site
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Know:</strong> Who is the principal contractor and principal designer?
              </li>
              <li>
                <strong>Check:</strong> Is the F10 displayed? Are welfare facilities provided?
              </li>
              <li>
                <strong>Always:</strong> Report hazards, co-operate with site safety rules
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                enabling Act, meaning it provides the framework under which more specific
                regulations (such as the Work at Height Regulations 2005 and CDM 2015) are made.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Scope:</strong> HSWA 1974 applies to all work
                  activities, all employers, all employees, the self-employed, and anyone who
                  controls premises where work takes place. It covers every workplace in Great
                  Britain and is enforced by the Health and Safety Executive (HSE) and local
                  authorities.
                </p>
              </div>

              <p>
                HSWA operates on the principle of goal-setting rather than prescriptive rules. It
                sets out broad duties and objectives, leaving the specific methods of compliance to
                be determined by duty holders based on their circumstances. This makes it flexible
                enough to cover every type of work activity, from office work to high-risk
                construction.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Criminal law &mdash; breaches can lead to prosecution, fines, and imprisonment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Enforced by the HSE and local authority environmental health departments
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Places duties on employers, employees, the self-employed, designers,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Enables the creation of subordinate regulations (e.g. WAHR 2005, CDM 2015)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Four sections of HSWA 1974 are particularly relevant to mobile scaffold tower work.
                Every person on site, from the site manager to the apprentice, must understand these
                duties.
              </p>
                  ...
                  <div className="text-sm text-white space-y-1">
                    ...
                    <ul className="ml-4 space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          (d) Maintenance of a safe place of work with safe access and egress
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Construction (Design and Management) Regulations 2015, commonly known as CDM
                2015, are the primary regulations for managing health, safety, and welfare on
                construction projects in Great Britain. They apply to all construction work, no
                matter how small, and place duties on clients, designers, and contractors.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Change from CDM 2007:</strong> CDM 2015
                  removed the CDM co-ordinator role and replaced it with the principal designer. It
                  also made domestic clients subject to CDM duties for the first time, although in
                  practice these duties pass to the contractor or principal contractor.
                </p>
              </div>

              <p>
                CDM 2015 applies to all "construction work," which is broadly defined and includes
                the erection, alteration, maintenance, and dismantling of structures. Mobile
                scaffold tower work on a construction site is covered by CDM, and the tower itself
                constitutes a temporary structure under the Regulations.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Work involves erection, alteration, repair, or dismantling of structures
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Installation, maintenance, or removal of mechanical or electrical services
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                CDM 2015 identifies five key duty holders, each with specific responsibilities.
                Understanding who these duty holders are and what they must do is essential for
                anyone working on a construction site, including those assembling and using mobile
                scaffold towers.
              </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Appoint principal designer and principal contractor (multi-contractor
                        projects)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Workers:</strong> CDM 2015 also places duties
                  on individual workers. Every worker must be consulted on health and safety
                  matters, report unsafe conditions, and co-operate with others. Workers must not
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Mobile scaffold towers are classified as temporary works under CDM 2015. This means
                the erection, use, and dismantling of towers must be planned and managed as part of
                the overall construction phase plan. Several CDM requirements have direct
                implications for tower work.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    inspection schedules, and competence requirements.
                  </p>
                  <p>
                    <strong className="text-cyan-400">Co-ordination:</strong> The principal
                    contractor must ensure that tower work does not conflict with other site
                    activities. For example, crane operations must be co-ordinated with tower
                    locations.
                  </p>
                  <p>
                    <strong className="text-cyan-400">Information Flow:</strong> Designers must
                    communicate any specific requirements for access equipment, and contractors must
                    share details of tower positions and working heights with the PC.
                  </p>
                  <p>
                    <strong className="text-cyan-400">Competence:</strong> CDM requires that
                    everyone involved is competent. For tower work, this means PASMA-trained
                    operatives for assembly and dismantling.
                  </p>
                  <p>
                    <strong className="text-cyan-400">Welfare:</strong> Adequate welfare facilities
                    must be accessible to tower workers, including at height where practicable.
                  </p>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Not all construction projects need to be notified to the HSE. Notification is
                required only for larger projects that meet specific thresholds. However, all CDM
                duties apply regardless of whether notification is required.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  ...
                  <p>
                    <strong className="text-white">Threshold 2:</strong> The construction work will
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  administrative requirement for larger projects.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The client must provide pre-construction information (PCI) to every designer and
                contractor as soon as practicable before the construction phase begins. This
                information helps designers and contractors to plan their work safely, including the
                selection and use of access equipment such as mobile scaffold towers.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  PCI Relevant to Tower Work Includes:
                </p>
                <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                  <div>
              ...
              <p>
                ...
                configuration of tower for the task. For example, knowing that the ground is soft
                clay means planning for larger base plates or sole boards, whilst knowing there are
                overhead power lines means establishing exclusion zones and potentially selecting a
                lower tower configuration.
              </p>
            </div>
          </div>
        </section>
