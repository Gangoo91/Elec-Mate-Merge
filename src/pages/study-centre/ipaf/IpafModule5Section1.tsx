...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Unlocked castors allow the tower to move when climbed or when lateral force is applied. This can cause the user to fall and, on uneven ground, can lead to sudden tower collapse.',
  },
  {
    question:
...
const quickCheckQuestions = [
  ...
  {
    question:
      "Two operatives are on a single-width tower platform. The platform's safe working load is 275 kg. Together they weigh 170 kg and their tools weigh 60 kg. A third person asks to come up to pass materials. Should they allow it?",
    options: [
    ...
    correctIndex: 1,
    explanation:
      'Although the static weight totals 230 kg (170 + 60), dynamic forces from movement, and the physical space constraints of a single-width platform, mean a third person creates unacceptable risk. Always account for dynamic loading and safe movement space.',
  },
  {
    question:
      "An operative is over-reaching from the platform to paint a wall section just out of comfortable arm's reach. What is the correct action?",
    options: [
    ...
    correctIndex: 2,
    explanation:
      "Over-reaching shifts the operative's centre of gravity towards the platform edge, creating lateral forces that can overturn the tower. The correct response is always to reposition the tower so the work area is comfortably within reach.",
  },
];
...
export default function IpafModule5Section1() {
  useSEO({
    ...
    description:
      'Falls from height, tower collapse, overturning, electrocution, falling objects, over-reaching, and fatigue — the common hazards and accident causes when using mobile access towers.',
  });
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-xl p-5 mb-6">
          ...
          <p className="text-white/80 text-base leading-relaxed">
            ...
            major hazard categories. Every one of these is preventable with proper training,
        ...
        <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-5 mb-8">
          ...
          <p className="text-white/80 text-base leading-relaxed">
            ...
            "I'm not sure," do not use the tower until the issue is resolved.
          </p>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/40 pl-5 space-y-4">
            <p className="text-white/80 text-sm leading-relaxed">
              ...
              failure pattern: guardrails not installed, trapdoors left open, or platforms used
              before assembly was complete.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                working on that level. These requirements apply regardless of the platform height —
                there is no "safe" height to fall from.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-semibold text-white">
              Tower Collapse from Incorrect Assembly
            </h3>
          </div>
          <div className="border-l-2 border-orange-500/40 pl-5 space-y-4">
            ...
            <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Missing diagonal braces</strong> — braces transfer lateral loads;
                    without them, the tower racks sideways under even light forces
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Wrong assembly sequence</strong> — following the wrong build order can
                    leave structural gaps at critical load points
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Components not fully locked</strong> — spigot pins, brace hooks, and
                    platform catches must all be fully engaged and checked
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Mixed manufacturer components</strong> — components from different
                    systems may appear similar but have different load ratings and connection
                    tolerances
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Damaged components used</strong> — bent frames, cracked welds, and
                    corroded tubes significantly reduce structural capacity
                  </span>
                </li>
              </ul>
            </div>
            <p className="text-white/70 text-sm leading-relaxed">
              ...
              who have received appropriate training — such as the PASMA Towers for Users course.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            <span className="flex items-center justify-center w-8 h-8 rounded-lg bg-yellow-500/20 text-yellow-400 font-bold text-sm">
              04
            </span>
            <h3 className="text-xl font-semibold text-white">
              Electrocution from Overhead Power Lines
          ...
          <div className="border-l-2 border-yellow-500/40 pl-5 space-y-4">
            <p className="text-white/80 text-sm leading-relaxed">
              ...
              current will pass through the entire structure to anyone touching it at ground level.
            </p>
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm text-white/70">
                ...
                <p>
                  If work must take place within 15 metres,{' '}
                  <strong className="text-white">
                    you must contact the Distribution Network Operator (DNO)
                  </strong>{' '}
                  for specific guidance — they may isolate the line, install barriers, or specify
                  exact safe distances
                </p>
                <p>
                  Remember to account for the{' '}
                  <strong className="text-white">
                    full tower height plus any tools or materials
                  </strong>{' '}
                  that could be raised above the platform (e.g., scaffold poles, paint rollers on
                  extension handles)
                </p>
              </div>
            </div>
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                every overhead line as potentially lethal and maintain the 15-metre minimum
                clearance.
              </p>
            </div>
          </div>
            ...
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Tool lanyards</strong> — attach all hand tools to a wrist strap or tower
                    anchor point
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Toeboards</strong> — minimum 150mm high on all open sides, preventing
                    items sliding off
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Brick guards / mesh panels</strong> — used when materials on the
                    platform could fall through gaps
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Exclusion zones</strong> — barrier off the area below and around the
                    tower base
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Hard hats</strong> — required PPE for anyone within the exclusion zone
                    at ground level
                  </span>
                </li>
              </ul>
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-semibold text-white">
              Unlocked Castors & Climbing Externally
            </h3>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  loose during the day through vibration.
                </p>
              </div>
              <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  all fall protection and applies lateral forces that can overturn the tower. Always
                  use the internal ladder or stairway access.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-semibold text-white">
              Unauthorised Modifications & Overloading
            </h3>
          </div>
          <div className="border-l-2 border-emerald-500/40 pl-5 space-y-4">
            ...
            <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-4">
              <ul className="space-y-2 text-sm text-white/70">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    Tying the tower to an adjacent structure without manufacturer guidance
                  </span>
                </li>
              </ul>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                the SWL is never exceeded and that their combined movement does not create excessive
                dynamic forces. Always check the manufacturer's data plate for the specific tower's
                SWL.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-sky-500/40 pl-5 space-y-4">
            ...
            <p className="text-white/70 text-sm leading-relaxed">
              ...
              they feel too tired to work safely. It is never acceptable to continue working at
              height when fatigued.
            </p>
          </div>
        </section>
          ...
          <div className="bg-gradient-to-br from-red-500/10 to-orange-500/10 border border-red-500/20 rounded-xl p-5">
            ...
            <div className="mt-4 bg-black/20 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                ignored manufacturer instructions. Beyond the legal consequences, each statistic
                represents a real person — someone who did not go home that day. The purpose of
                hazard awareness training is to ensure you never become one of these statistics.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-5 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-3">
                ...
                <p className="text-white/70 text-xs leading-relaxed">
                  ...
                  acceptable — together they are not.
                </p>
              </div>
              <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-3">
            ...
            <p className="text-white/70 text-sm leading-relaxed">
              ...
              every hazard, not just the obvious ones.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl p-5 space-y-3">
            <p className="text-white/80 text-sm leading-relaxed">
              ...
              get the job done quickly before the wind picks up. They assemble the tower without
            ...
            <div className="bg-black/20 rounded-lg p-4">
              <ul className="space-y-2 text-sm text-white/70">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    Carrying tools in both hands while climbing — no three-point contact, tools
                    could fall
                  </span>
                </li>
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    Rushing to beat the weather — time pressure compromises safety decisions
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
        ...
        <section className="mb-10">
          <h3 className="text-xl font-semibold text-white mb-4">
            Hazard Frequency — Most to Least Common
          </h3>
          <div className="bg-white/5 border border-white/10 rounded-xl p-5">
        ...
        {/*  Quiz                                                         */}
        {/* ------------------------------------------------------------ */}
        <Quiz title="Section 1 — Common Hazards & Accident Causes" questions={quizQuestions} />
