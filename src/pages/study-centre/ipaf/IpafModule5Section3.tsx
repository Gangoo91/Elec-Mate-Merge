...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'First aid provision must be planned before work begins. A qualified first aider should be on site or rapidly available, with a stocked first aid kit at ground level near the tower. They should be briefed on the rescue plan and understand the specific risks of working at height, including suspension trauma.',
  },
  {
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'A lone worker who is injured or collapses on the tower cannot call for help. Lone working at height requires additional controls: regular welfare check calls at agreed intervals (e.g., every 30 minutes), a lone worker monitoring device, or — ideally — a ground-level buddy. If the worker misses a check-in, the alarm is raised immediately.',
  },
  {
    question:
...
export default function IpafModule5Section3() {
  useSEO({
    ...
    description:
      'PASMA rescue hierarchy, written rescue plans, communication methods, first aid provision, suspension trauma awareness, and emergency lowering procedures for tower scaffold work.',
  });
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="bg-elec-yellow/10 border border-elec-yellow/30 rounded-xl p-5 mb-6">
          ...
          <p className="text-white/80 text-base leading-relaxed">
            ...
            account for realistic emergency response times, and ensure first aid provision at ground
            level. If someone collapses on a tower, do NOT climb up without a plan — call 999 first.
          </p>
        </div>
        ...
        <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-5 mb-8">
          ...
          <p className="text-white/80 text-base leading-relaxed">
            ...
            the realistic emergency service response time to this location? If any answer is "I
            don't know," the plan is not ready.
          </p>
        </div>
            ...
            <div className="space-y-3">
              <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                <div className="flex items-center gap-3 mb-2">
                  <span className="bg-green-500/20 text-green-400 rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold flex-shrink-0">
                    1
                  </span>
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  injuries (small cuts, mild dizziness), self-rescue may be appropriate if the
                  person can descend safely.
                </p>
              </div>
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
                <div className="flex items-center gap-3 mb-2">
                  <span className="bg-blue-500/20 text-blue-400 rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold flex-shrink-0">
                    2
                  </span>
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  put themselves at risk. The tower's safe working load must not be exceeded with
                  both persons on the platform.
                </p>
              </div>
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                <div className="flex items-center gap-3 mb-2">
                  <span className="bg-red-500/20 text-red-400 rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold flex-shrink-0">
                    3
                  </span>
                ...
                <p className="text-white/70 text-sm leading-relaxed">
                  ...
                  stretchers, lowering devices, and aerial platforms. The rescue plan must include
                  how to contact them and how to direct them to the exact location.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-blue-500/40 pl-5 space-y-4">
            <p className="text-white/80 text-sm leading-relaxed">
              ...
              <strong className="text-white">before any work at height begins</strong> — for every
              tower operation, regardless of height or duration.
            </p>
            <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Site-specific details</strong> — exact tower location, height, access
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Emergency contact numbers</strong> — 999, site manager, first aider,
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Location information</strong> — postcode, what3words reference, grid
                    reference, site access code
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Rescue hierarchy</strong> — self-rescue, assisted descent, and
                    professional rescue procedures
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Communication plan</strong> — primary and backup communication methods
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>First aid provision</strong> — location of first aid kit, name of
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Realistic response times</strong> — verified emergency service response
                    time for this specific location
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Named responsibilities</strong> — who does what in an emergency
                  </span>
                </li>
              </ul>
            </div>
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    Plan says "call 999" without specifying what information to give or how to
                    direct vehicles to the site
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    Assumes emergency response time of 10 minutes on a site where actual response is
                    30+ minutes
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    No backup communication method — mobile phone signal may be poor or phone
                    battery may be dead
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    Generic plan not updated for the specific site, tower height, or personnel
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/40 pl-5 space-y-4">
            ...
            <p className="text-white/70 text-sm leading-relaxed">
              ...
              visual/audible signal system with the ground-level buddy.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-semibold text-white">
              First Aid Provision at Ground Level
            </h3>
          </div>
            ...
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    Qualified first aider on site or rapidly available (know their name and
                    location)
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    First aider briefed on the rescue plan and work-at-height-specific risks
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-semibold text-white">
              If Someone Falls or Collapses on the Platform
            </h3>
          </div>
          ...
          <div className="border-l-2 border-red-500/40 pl-5 space-y-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                (W-position or seated with knees raised) and seek immediate medical attention.
                Inform paramedics of the duration of suspension.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-semibold text-white">
              Emergency Lowering of an Injured Person
            </h3>
          </div>
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    Only attempt if trained personnel with appropriate equipment are on site
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    Fire service aerial platforms can reach the platform directly — clear the base
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    Provide paramedics with: tower height, nature of injury, time elapsed, whether
                    the person was suspended in a harness
                  </span>
                </li>
              </ul>
            </div>
          ...
          <div className="border-l-2 border-purple-500/40 pl-5 space-y-4">
            ...
            <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4">
              ...
              <ul className="space-y-2 text-sm text-white/70">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Timed welfare checks</strong> — agree a check-in schedule (e.g., every
                    30 minutes) with a designated contact. If a check-in is missed, the alarm is
                    raised immediately.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Lone worker monitoring device</strong> — wearable devices with tilt
                    sensors, man-down detection, and GPS tracking that automatically alert a
                    monitoring centre if the worker becomes incapacitated.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Buddy system (off-site)</strong> — even if no one else is physically
                    present, a colleague or supervisor maintains phone contact at agreed intervals.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Risk assessment review</strong> — the risk assessment must specifically
                    address the lone working element and may conclude that lone tower work is not
                    acceptable at certain sites.
                  </span>
                </li>
              </ul>
            </div>
            <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
              ...
              <p className="text-white/70 text-sm leading-relaxed">
                ...
                dismantling (which always requires at least two people), or the tower height exceeds
                the point where self-rescue is the only realistic option.
              </p>
            </div>
          </div>
        </section>
