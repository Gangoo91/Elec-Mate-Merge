...
const quizQuestions = [
  {
    id: 1,
    question:
      'What is the required minimum height for guardrails on a mobile access tower platform?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Guardrails must be at least 950mm above the platform surface. This height is specified in BS EN 1004 and the Work at Height Regulations to prevent falls from the platform edge.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'All castor brakes must be locked before anyone climbs or works on the tower. Unlocked castors allow the tower to roll, which could cause it to move unexpectedly and tip over, especially on sloping surfaces.',
  },
  {
    id: 6,
    ...
    correctAnswer: 1,
    explanation:
      'Spigots are connecting pins that fit into the top of one frame section and allow the next frame section to sit on top, creating a secure vertical connection. They ensure the frames are correctly aligned and locked together.',
  },
  {
    id: 7,
...
const quickCheckQuestions = [
  ...
  },
  {
    id: 'diagonal-braces',
    question:
      'You notice that a colleague has assembled a tower without fitting the diagonal braces. What is the risk?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      "Without diagonal braces, the tower has no lateral rigidity and can rack — sway sideways like a parallelogram until it collapses. Diagonal braces triangulate the structure and are essential for the tower's structural integrity.",
  },
  {
    id: 'toeboard-purpose',
    question:
...
const faqs = [
  {
    ...
    answer:
      'Yes. Guardrails, mid-rails, and toeboards must be fitted on all four sides of every working platform. There must be no unprotected edges at any point. The only opening in the edge protection should be the trapdoor access point, and this must be closed once the operative is on the platform.',
  },
  {
    question: 'Can I use the diagonal braces as a climbing route to reach the platform?',
    answer:
      "No. Diagonal braces are structural components, not access routes. Climbing on diagonal braces can damage them, alter the tower's structural integrity, and is a significant fall hazard. Always use the internal ladder or stairway system provided with the tower for access to the platform.",
  },
  {
    question: 'When should stabilisers or outriggers be used?',
    answer:
      "Stabilisers or outriggers should be used whenever specified by the manufacturer's instruction manual. Generally, they are required when the tower exceeds certain height-to-base ratios, when used outdoors, or when additional stability is needed. Always refer to the specific tower system's instruction manual for guidance.",
  },
  {
    question: 'What should I do if a component appears damaged or bent?',
    answer:
      'Do not use any component that appears damaged, bent, cracked, or corroded. Remove it from service immediately and tag it as defective. Report the damage to your supervisor. Damaged components can compromise the structural integrity of the entire tower and must be replaced with genuine manufacturer parts before the tower is used.',
  },
];
...
const IpafModule2Section2 = () => {
  useSEO({
    ...
    description:
      'Learn about mobile access tower components including frames, braces, platforms, guardrails, mid-rails, toeboards, stabilisers, outriggers, castors, and base plates.',
  });
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Frames:</strong> Vertical uprights forming the tower structure.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Braces:</strong> Diagonal & horizontal — prevent racking and add
                    rigidity.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Platforms:</strong> Working surface with trapdoor access.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Guardrails:</strong> 950mm high — fall prevention on all sides.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Toeboards:</strong> 150mm min — stop items falling off the edge.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Stabilisers/outriggers:</strong> Increase the effective base area.
                  </span>
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Inspect:</strong> Check every component before assembly — reject if
                    damaged.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Assemble:</strong> Follow manufacturer's sequence exactly.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Verify:</strong> Guardrails, mid-rails, toeboards on all sides.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Lock:</strong> All castor brakes engaged before climbing.
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <p className="text-white mb-6">
              The diagram below shows a double-width mobile access tower with all major components
              labelled. Study this carefully — you need to know each part by name and understand its
              function.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4 sm:p-6 mb-6">
              ...
              >
                ...
                <text x="5" y="195" fill="#22c55e" fontSize="10" fontFamily="sans-serif">
                  (150mm)
                </text>
                ...
                <text x="5" y="460" fill="#facc15" fontSize="10" fontFamily="sans-serif">
                  Braces
                </text>
                ...
                <text x="5" y="340" fill="#9ca3af" fontSize="10" fontFamily="sans-serif">
                  Braces
                </text>
                ...
                <text x="5" y="282" fill="#fff" fontSize="10" fontFamily="sans-serif">
                  Uprights
                </text>
                ...
                <text x="5" y="660" fill="#facc15" fontSize="10" fontFamily="sans-serif">
                  (with brakes)
                </text>
                ...
                <text x="390" y="667" fill="#facc15" fontSize="10" fontFamily="sans-serif">
                  Outriggers
                </text>
                ...
                <line
                  ...
                  strokeDasharray="2,2"
                />
                <text x="160" y="168" fill="#facc15" fontSize="9" fontFamily="sans-serif">
                  Trapdoor
                </text>
                ...
                <text
                  ...
                  fontWeight="bold"
                >
                  Double-Width Tower — Component Anatomy
                </text>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Frames are the vertical structural elements that form the tower's main upright
                columns. They are typically H-shaped or ladder-shaped sections with two vertical
                tubes connected by horizontal rungs. Frames provide the primary load-bearing
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Material:</strong> Aluminium alloy or GRP depending on tower type
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Connection:</strong> Frames connect vertically via spigots — male pins
                      that fit into the tube ends
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Rungs:</strong> Horizontal bars within each frame serve as the
                      internal climbing route
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Sizes:</strong> Available in single-width (~0.7m) and double-width
                      (~1.35m) configurations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Inspection point:</strong> Check for bends, dents, cracks, and
                      corrosion before every use
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  (permanently welded) or separate (inserted into the tube). They include a locking
                  mechanism — usually a gravity lock or spring clip — to prevent accidental
                  separation.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Braces are the components that give the tower its lateral rigidity and structural
                strength. Without braces, a tower would have no resistance to sideways forces and
                could collapse under even modest lateral loading.
              </p>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  and collapse. Never use a tower if any required brace is missing or damaged.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The platform is the working surface at the top of the tower. It must be fully decked
                — with no gaps that a person or object could fall through — and incorporate a
                trapdoor for safe access from below.
              </p>
              ...
              <div className="bg-white/5 border border-green-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Fully decked:</strong> No gaps greater than 25mm between platform
                      boards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Non-slip surface:</strong> Platforms should have a slip-resistant
                      finish
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Secured:</strong> Platforms must be locked in position — they must not
                      be able to lift or slide
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Load rated:</strong> Each platform has a maximum safe working load
                      (typically 275kg)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Wind-up or slide-in:</strong> Platform may slide in from the side or
                      be lifted through the tower
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1 text-sm">
                  <li>
                    1. It means you are always within the guardrail protection whilst accessing the
                    platform
                  </li>
                  <li>2. You never have to climb over or around the edge protection</li>
                  <li>
                    3. Once closed, the trapdoor completes the platform surface, eliminating trip
                    hazards
                  </li>
              ...
              <p>
                Always close the trapdoor fully once you are on the platform. An open trapdoor is a
                trip hazard and reduces the effective working area. It also creates a gap through
                which objects could fall, potentially injuring someone below.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Edge protection is the primary fall prevention system on a mobile access tower. It
                consists of three components working together: guardrails, mid-rails, and toeboards.
                All three must be present on every working platform.
              </p>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                These components all serve to increase the stability of the tower by enlarging its
                effective base area or ensuring a firm connection with the ground surface.
              </p>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Castors are wheeled fittings attached to the base of the tower legs, allowing the
                tower to be repositioned without dismantling. They are a convenience feature but
                also a potential hazard if not used correctly.
              </p>
              ...
              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Brakes:</strong> Every castor must have a functioning brake mechanism
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Lock before climbing:</strong> All castor brakes must be locked before
                      anyone ascends the tower
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Load rated:</strong> Castors must be rated for the total tower load
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Swivel:</strong> Most tower castors are swivel type for easy
                      manoeuvring
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Diameter:</strong> Typically 150mm-200mm for stability and ease of
                      rolling
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Compatibility:</strong> Must be the correct type for the tower system
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  dangerous practices in tower use.
                </p>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Frames:</strong> Vertical uprights (H-frames)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Diagonal braces:</strong> Prevent racking
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Horizontal braces:</strong> Connect frames
                      laterally
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Spigots:</strong> Frame-to-frame connectors
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Tie bars:</strong> Maintain frame spacing
                    </span>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-1 text-white">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Guardrails:</strong> 950mm minimum height
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Mid-rails:</strong> ~470mm height
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Toeboards:</strong> 150mm minimum height
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Platform:</strong> Fully decked, non-slip
                      surface
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Trapdoor:</strong> Access hatch — close after
                      use
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Internal ladder:</strong> Frame rungs for
                      climbing
                    </span>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stabilisers:</strong> Extend base area
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Outriggers:</strong> Additional stability
                      support
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Base plates:</strong> For fixed positions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Castors:</strong> Wheels with brakes — always
                      lock
                    </span>
                  </li>
                </ul>
        ...
        {/* Quiz Section */}
        <div className="mt-12">
          <Quiz title="Components & Terminology Quiz" questions={quizQuestions} />
        </div>
