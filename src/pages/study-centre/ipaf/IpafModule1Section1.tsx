...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 0,
    explanation:
      'The Work at Height Regulations 2005 require you to avoid work at height wherever reasonably practicable. This is the first and most important step in the hierarchy of control.',
  },
  {
    id: 'wahr-schedule5',
    question:
      'Under Schedule 5 of the Work at Height Regulations, who must inspect a mobile tower before first use on site?',
    options: [
      'The site manager',
      'A competent person',
    ...
    correctIndex: 1,
    explanation:
      'Schedule 5 requires that scaffolding, including mobile towers, must be inspected before first use and after any event likely to have affected stability. Inspections must be carried out by a competent person.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Reasonably practicable means you must weigh the risk against the sacrifice (cost, time, effort) needed to avert it. If the risk is significant, the cost of prevention must be very disproportionate before you can justify not acting.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'There is no minimum height threshold. The Regulations apply to all work at height where a person could fall a distance liable to cause personal injury, regardless of whether that is 1 metre or 10 metres. Even stepping onto a single platform board is work at height.',
  },
  {
    question: 'Who is responsible for ensuring work at height is safe?',
    answer:
      'The employer has the primary duty to ensure work at height is properly planned, appropriately supervised, and carried out by competent persons using suitable equipment. However, employees and the self-employed also have duties to report hazards, use equipment correctly, and follow systems of work.',
  },
  {
    question: 'How often must a mobile tower be inspected under Schedule 5?',
    answer:
      'A mobile tower must be inspected by a competent person before first use on a site, after any substantial alteration, after any event likely to have affected its stability (such as severe weather), and at regular intervals not exceeding 7 days if it remains erected. Each inspection must be recorded in writing.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'The Work at Height Regulations were introduced in 2005 and remain the primary legislation governing work at height in England, Wales, and Scotland.',
  },
  {
    id: 2,
  ...
  },
  {
    id: 5,
    question:
      'Who has the primary duty under the Work at Height Regulations to plan and organise work at height?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'The employer bears the primary duty to ensure that work at height is properly planned, appropriately supervised, and carried out in a safe manner by competent persons.',
  },
  {
    id: 6,
    question:
      'A mobile tower is blown over by strong winds overnight. What must happen before it can be used again?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Schedule 5 requires inspection by a competent person after any event likely to have affected stability. Wind damage constitutes such an event and a full inspection must be completed and recorded before the tower is used again.',
  },
  {
    id: 7,
...
export default function IpafModule1Section1() {
  useSEO({
    ...
    description:
      'Hierarchy of control, duty to plan and supervise, Schedule 5 scaffolding inspection requirements, employer and employee duties under the Work at Height Regulations 2005.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Hierarchy:</strong> Avoid &rarr; Prevent &rarr; Mitigate falls
              </li>
              <li>
                <strong>Duty:</strong> Plan, supervise, use competent persons
              </li>
              <li>
                <strong>Schedule 5:</strong> Inspect towers before use and every 7 days
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Before:</strong> Plan the work, assess risks, select equipment
              </li>
              <li>
                <strong>During:</strong> Supervise, inspect, record findings
              </li>
              <li>
                <strong>Always:</strong> Use competent persons for assembly and inspection
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Work at Height Regulations 2005 (WAHR) came into force on 6 April 2005 and apply
                across England, Wales, and Scotland. They replaced a patchwork of older legislation
                and consolidated all work-at-height duties into a single, clear framework. The
                Regulations apply to all work at height where there is a risk of a fall liable to
                cause personal injury.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Definition:</strong> "Work at height"
                  means work in any place where, if precautions were not taken, a person could fall
                  a distance liable to cause personal injury. There is{' '}
                  <strong>no minimum height</strong> &mdash; even stepping onto a single platform
                  board constitutes work at height.
                </p>
              </div>

              <p>
                The Regulations apply to employers, the self-employed, and anyone who controls the
                work of others. This means that principal contractors, facilities managers, and site
                supervisors all have duties under WAHR, not just the person physically working at
                height.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Work above ground level, below ground level (e.g. near a pit), and at ground
                      level where a fall hazard exists
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Inspection of work equipment used at height, including mobile scaffold towers
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Regulation 6 establishes a strict hierarchy of control that must be followed when
                planning any work at height. This hierarchy is the cornerstone of the Regulations
                and dictates the approach you must take before any work at height begins.
              </p>
              ...
              <p>
                This hierarchy is not optional. You must work through each step in order and only
                move to the next when the previous step is not reasonably practicable. Using a
                harness (Step 3) when a mobile tower with guardrails (Step 2) could have been used
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Regulation 4 places three fundamental duties on employers and those who control work
                at height. These duties apply to every instance of work at height, no matter how
                short the duration or how low the height.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Regulation 4 &mdash; The Three Duties
                </p>
                <div className="space-y-3">
                  <div>
              ...
              <p>
                Planning must be proportionate to the complexity and risk of the task. A simple task
                using a low-level platform may need only a brief risk assessment and method
                statement, whereas assembling a complex tower in an exposed location requires
                detailed planning covering ground conditions, wind loads, access routes, and
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1 mt-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Is the ground firm, level, and capable of supporting the tower loads?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Work at Height Regulations place distinct duties on employers and employees.
                Both parties must fulfil their respective obligations to ensure work at height is
                carried out safely. Failure by either party can lead to enforcement action,
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Schedule 5 of the Work at Height Regulations sets out specific inspection
                requirements for scaffolding, which includes mobile scaffold towers. These
                requirements are in addition to the general duty to maintain and inspect work
                equipment. Non-compliance with Schedule 5 is a criminal offence.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    inspected before anyone works from it.
                  </p>
                  <p>
                    <strong className="text-white">2. After substantial alteration</strong> &mdash;
                    Any change to the tower configuration, such as adding height or relocating,
                    requires a fresh inspection.
                  </p>
                  <p>
                    <strong className="text-white">3. After adverse events</strong> &mdash; Any
                    event likely to have affected the tower's stability or structural integrity
                    (e.g. storm, impact, subsidence) triggers an inspection.
                  </p>
                  <p>
                    <strong className="text-white">4. At regular intervals</strong> &mdash; If the
                    tower remains erected, it must be inspected at intervals not exceeding 7 days.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Location and description of the scaffold (including the type of tower)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <p>
                Inspection records must be kept on site until the work is completed, and then
                retained for a minimum of 3 months after that. The HSE can request to see these
                records at any time. Failure to produce records when requested is an offence.
              </p>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Regulation 3 requires that every employer must ensure that a suitable and sufficient
                risk assessment is carried out for all work at height activities. The risk
                assessment must identify the hazards, evaluate the risks, and determine what control
                measures are needed.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    or pedestrians, electrical hazards.
                  </p>
                  <p>
                    <strong className="text-elec-yellow">Step 2:</strong> Decide who might be harmed
                    &mdash; tower users, passers-by, other workers in the area.
                  </p>
                  <p>
                    <strong className="text-elec-yellow">Step 3:</strong> Evaluate the risks &mdash;
                    consider likelihood and severity, determine if existing controls are adequate.
                  </p>
                  <p>
                    <strong className="text-elec-yellow">Step 4:</strong> Record findings &mdash;
                    document the hazards, who is at risk, and what controls are in place.
                  </p>
                  <p>
                    <strong className="text-elec-yellow">Step 5:</strong> Review and update &mdash;
                    review the assessment regularly and whenever conditions change.
                  </p>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Many duties under the Work at Height Regulations are qualified by the phrase "so far
                as is reasonably practicable." This is a legal test that has been defined by case
                law over many decades and is central to understanding your obligations.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Legal Test:</strong> You must weigh the
                  degree of risk on one side against the sacrifice needed to avert it (in terms of
                  money, time, and trouble) on the other. If the risk is significant, the cost of
                  prevention must be
                  <strong> grossly disproportionate</strong> to the risk before you can justify not
                  taking action.
                </p>
              </div>
              ...
              <p>
                The burden of proof sits with the duty holder. If prosecuted, you must demonstrate
                that it was not reasonably practicable to do more than you did. The HSE does not
                have to prove that it was reasonably practicable &mdash; you must prove that it was
                not.
              </p>
            </div>
          </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  prosecute for serious breaches. Fines for work-at-height offences can be
                  unlimited, and individuals can face imprisonment for the most serious cases.
                </p>
              </div>
            </div>
          </div>
