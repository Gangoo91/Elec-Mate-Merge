...
const DESCRIPTION =
  'Step-by-step 3T assembly method for mobile access towers. Climb through the trapdoor, install guardrails from a protected position, and build safely to full height.';
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'All castors must be locked before the first frame is erected. The tower must never be moved during assembly — all four castor brakes must remain engaged throughout the entire build process.',
  },
  {
    id: 3,
...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'The operative always installs guardrails from the platform below by reaching through the trapdoor. This ensures they are protected by the existing guardrails while fitting new ones to the level above.',
  },
  {
    id: '3t-platform-rule',
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>3T:</strong> "Through The Trap" — climb through the trapdoor to reach
                    each new level.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Key Principle:</strong> Guardrails are always installed BEFORE stepping
                    onto a platform.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Protected Position:</strong> Install guardrails from the level below via
                    the trapdoor.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Sequence:</strong> Base → Level → Frames → Braces → Guardrails (from
                    below) → Platform → Repeat.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Golden Rule:</strong> NEVER stand on an unguarded platform.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Castors:</strong> Locked from the very start and throughout assembly.
                  </span>
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Spot:</strong> Traditional aluminium tower systems with trapdoor
                    platforms.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Use:</strong> Standard assembly method for most PASMA-type towers.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Apply:</strong> Follow the instruction manual step by step, never skip
                    guardrail installation, always close the trapdoor after climbing through.
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-3 text-white">
            <li className="flex items-start gap-3">
              ...
              <span>
                Explain the meaning and purpose of the 3T (Through The Trap) assembly method
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Describe the correct sequence for assembling each level of a mobile access tower
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Demonstrate how guardrails are installed from a protected position through the
                trapdoor
              </span>
            </li>
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Assemble the base section correctly including castors, levelling, and first frame
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The base is the foundation of the entire tower. Every error at base level is
                amplified as the tower grows in height. Take your time to get this stage right — it
                determines the stability and safety of the entire structure.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ol className="space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Position Castors:</strong> Place the four castors at the marked
                      positions. Ensure they are the correct type for the tower system.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-elec-yellow/20 border border-elec-yellow/40 flex items-center justify-center flex-shrink-0 text-elec-yellow text-xs font-bold">
                    ...
                    <div>
                      <strong>Lock All Castors:</strong> Engage all four castor brakes immediately.
                      They remain locked throughout the entire assembly process.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-elec-yellow/20 border border-elec-yellow/40 flex items-center justify-center flex-shrink-0 text-elec-yellow text-xs font-bold">
                    ...
                    <div>
                      <strong>Fit Adjustable Legs:</strong> Insert adjustable legs into the castors
                      or base plates. Extend as needed for levelling.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-elec-yellow/20 border border-elec-yellow/40 flex items-center justify-center flex-shrink-0 text-elec-yellow text-xs font-bold">
                    ...
                    <div>
                      <strong>Level the Base:</strong> Use a spirit level across both diagonals and
                      both axes. Adjust legs until perfectly level.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-elec-yellow/20 border border-elec-yellow/40 flex items-center justify-center flex-shrink-0 text-elec-yellow text-xs font-bold">
                    ...
                    <div>
                      <strong>Add First Frame Sections:</strong> Fit the end frames onto the
                      adjustable legs, ensuring locking clips engage fully.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-elec-yellow/20 border border-elec-yellow/40 flex items-center justify-center flex-shrink-0 text-elec-yellow text-xs font-bold">
                    ...
                    <div>
                      <strong>Add Horizontal Braces:</strong> Connect the two end frames with
                      horizontal braces at the base level.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-elec-yellow/20 border border-elec-yellow/40 flex items-center justify-center flex-shrink-0 text-elec-yellow text-xs font-bold">
                    ...
                    <div>
                      <strong>Add Diagonal Braces:</strong> Fit diagonal braces to provide lateral
                      stability. Follow the manufacturer's bracing pattern.
                    </div>
                  </li>
                </ol>
              </div>
              ...
              <div className="bg-red-500/20 border border-red-400/50 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-1 text-sm">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>All four castors MUST be locked</strong> before any frame is erected
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>The base MUST be level</strong> — check with a spirit level, not by
                      eye
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Never use bricks, blocks, or timber</strong> as packing under castors
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>All connections MUST click or lock</strong> — finger-tight is not
                      enough
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Once the base is complete, each subsequent level follows the same repeating
                sequence. The key principle is that guardrails for the new level are always
                installed from the protected position of the level below, through the trapdoor.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ol className="space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Add Next Frame Sections:</strong> From the current platform (or
                      ground), add the frame sections for the next level. Lock all connections.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-elec-yellow/20 border border-elec-yellow/40 flex items-center justify-center flex-shrink-0 text-elec-yellow text-xs font-bold">
                    ...
                    <div>
                      <strong>Add Braces:</strong> Fit horizontal and diagonal braces to the new
                      frame sections. Follow the manufacturer's bracing pattern exactly.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-elec-yellow/20 border border-elec-yellow/40 flex items-center justify-center flex-shrink-0 text-elec-yellow text-xs font-bold">
                    ...
                    <div>
                      <strong>Install Guardrails From Below:</strong> Standing on the current
                      platform, reach UP through the trapdoor opening and install guardrails and
                      intermediate rails on the new level.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-elec-yellow/20 border border-elec-yellow/40 flex items-center justify-center flex-shrink-0 text-elec-yellow text-xs font-bold">
                    ...
                    <div>
                      <strong>Install Toeboards:</strong> Fit toeboards around the perimeter of the
                      new level (may also be done from below or as part of the guardrail frame).
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-elec-yellow/20 border border-elec-yellow/40 flex items-center justify-center flex-shrink-0 text-elec-yellow text-xs font-bold">
                    ...
                    <div>
                      <strong>Place Platform:</strong> Slide the trapdoor platform into position on
                      the new level. Ensure it locks securely on all support points.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-elec-yellow/20 border border-elec-yellow/40 flex items-center justify-center flex-shrink-0 text-elec-yellow text-xs font-bold">
                    ...
                    <div>
                      <strong>Climb Through The Trap:</strong> Open the trapdoor, climb through to
                      the new guarded level. Close the trapdoor behind you.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-elec-yellow/20 border border-elec-yellow/40 flex items-center justify-center flex-shrink-0 text-elec-yellow text-xs font-bold">
                    ...
                    <div>
                      <strong>Repeat:</strong> Continue adding levels following the same sequence
                      until the planned working height is reached.
                    </div>
                  </li>
                </ol>
              </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                the lower platform (protected by existing guardrails) and reaching through the
                trapdoor to install guardrails on the level above.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg text-sm">
                <p className="text-white">
                  ...
                  new guardrails (yellow dashed) on the level above. The tower frame (grey) and
                  diagonal braces provide the structural support.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Watch this PASMA demonstration of the 3T method in action. Pay close attention to
              ...
              <div className="overflow-hidden rounded-lg border border-white/10">
                <div className="grid grid-cols-3 gap-0 text-xs sm:text-sm">
                  ...
                  <div className="bg-white/5 p-3 border-b border-white/5">
                    Castors, legs, level, first frames and braces
                  </div>
                  ...
                  <div className="bg-white/[0.02] p-3 border-b border-white/5">
                    First platform with guardrails — first climb through trap
                  </div>
                  ...
                  <div className="bg-white/5 p-3 border-b border-white/5">
                    Check: may need stabilisers / outriggers from this height
                  </div>
                  ...
                  <div className="bg-white/[0.02] p-3 border-b border-white/5">
                    Re-check plumb; wind exposure increases significantly
                  </div>

                  <div className="bg-white/5 p-3">Level 4+</div>
                  <div className="bg-white/5 p-3">~8m+</div>
                  <div className="bg-white/5 p-3">
                    Verify max height for base size; ballast or ties may be needed
                  </div>
                </div>
              </div>
                ...
                <div className="text-white text-sm space-y-1">
                  ...
                  <ul className="space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        The tower is plumb (vertical) — use a plumb bob or spirit level on the
                        vertical members
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>All connections are locked and secure</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Braces are fitted in the correct pattern</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>The tower does not feel unstable or excessively flexible</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Whether stabilisers or outriggers are now required for the new height
                      </span>
                    </li>
                  </ul>
                </div>
            ...
            <div className="space-y-4 text-white">
              <div className="bg-red-500/20 border border-red-400/50 p-4 rounded-lg">
                ...
                <p className="text-white text-sm mb-3">
                  ...
                  been installed on a platform, nobody may step onto it. Falls from unguarded
                  platforms are the leading cause of serious injury and death from mobile tower
                  scaffolds.
                </p>
                  ...
                  <div className="bg-white/5 border border-red-400/30 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Skipping guardrails:</strong> "Just quickly stepping onto the
                          platform" without rails
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Not closing the trapdoor:</strong> Creating a trip hazard and fall
                          risk
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Unlocked castors:</strong> Tower moves during assembly
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Wrong brace pattern:</strong> Omitting diagonals reduces stability
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Over-reaching:</strong> Leaning too far through the trapdoor
                        </span>
                      </li>
                    </ul>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/5 border border-green-400/30 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>Follow the instruction manual step by step</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>Work methodically — never rush</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>Check every connection before moving up</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>Close the trapdoor immediately after climbing through</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>Communicate clearly between team members</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">NEVER</strong> stand on unguarded platform
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">ALWAYS</strong> lock castors first
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">ALWAYS</strong> close the trapdoor
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">ALWAYS</strong> follow the manual
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <ul className="space-y-1 text-white">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Adjustable legs fitted</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Base levelled (spirit level)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>First frames connected</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Horizontal braces fitted</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Diagonal braces fitted</span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-white">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>All connections locked</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Braces in correct pattern</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Guardrails secure</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Platform locked in place</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Stabilisers needed?</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        {/* Quiz Section */}
        <div className="mt-12">
          <Quiz title="3T Method (Through The Trap) Quiz" questions={quizQuestions} />
        </div>
