...
const quizQuestions = [
  {
    id: 1,
    question:
      'You need to install cable tray in a corridor that is 1.0m wide. Which tower width should you choose?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'A single-width tower at 0.7m fits comfortably in a 1.0m corridor with clearance either side. A double-width tower at 1.35m is wider than the corridor and cannot be used. Always measure the available space first.',
  },
  {
    id: 2,
    question:
  ...
  },
  {
    id: 4,
    question:
      'You need to reach a ceiling-mounted smoke detector 5m above a staircase. Which tower type is most appropriate?',
    options: [
  ...
  },
  {
    id: 5,
    question:
      'Two electricians need to work side by side installing a large cable containment system at 4m height in a warehouse. Which configuration is best?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'A double-width tower provides sufficient platform area for two operatives to work side by side with their tools and materials. The 1.35m width gives enough room for comfortable working, and the platform load must be checked against the 275kg limit.',
  },
  {
    id: 6,
    question:
      'You need to change four ceiling light fittings in a small office with a 2.7m ceiling. What is the most practical access equipment?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'A folding or low-level tower is ideal for this task. The ceiling is low (2.7m), the work is light (fitting changes), and the tower needs frequent repositioning between the four fittings. A full-height tower would be impractical and overkill for this application.',
  },
  {
    id: 7,
    question:
...
const IpafModule2Section4 = () => {
  useSEO({
    ...
    description:
      'Learn how to select the correct mobile access tower for any job — matching tower type to task, environment, height, load, and access requirements.',
  });
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            ...
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Indoor vs outdoor:</strong> Outdoor needs wind assessment + stabilisers.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Width:</strong> Single for narrow spaces, double for bigger jobs.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Height:</strong> Check manufacturer limits for your configuration.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Load:</strong> Calculate total platform load before selecting.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Material:</strong> GRP near live electrics, aluminium otherwise.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Access:</strong> Stairwell towers for stairs, folding for low heights.
                  </span>
                </li>
              </ul>
            </div>
            <div className="rounded-lg p-3 sm:p-4 bg-elec-yellow/10 border-l-2 border-l-elec-yellow/50 border border-elec-yellow/30">
              ...
              <ul className="text-base text-white space-y-1.5">
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Survey:</strong> Measure the workspace before ordering the tower.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Plan:</strong> Consider all tasks, not just the first one.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Check:</strong> Floor condition, overhead clearance, access routes.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  <span>
                    <strong>Confirm:</strong> Tower system matches the manufacturer manual on site.
                  </span>
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <ul className="space-y-3 text-white">
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Identify the key factors: indoor/outdoor, height, width, load, material, and access
                type
              </span>
            </li>
            <li className="flex items-start gap-3">
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
              <span>
                Use the decision flowchart to select the correct tower for a given scenario
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-elec-yellow mt-0.5 flex-shrink-0" />
        ...
        <section className="mb-10">
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <p className="text-white mb-6">
              Use this decision flowchart to guide your tower selection. Work through each question
              in order to arrive at the correct tower type for your job.
            </p>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4 sm:p-6 mb-6">
              ...
              >
                ...
                <text
                  ...
                  fontWeight="bold"
                >
                  Tower Selection Decision Flowchart
                </text>
                ...
                <polygon
                  points="280,120 400,165 280,210 160,165"
                  fill="#facc15"
                  fillOpacity="0.15"
                  stroke="#facc15"
                  strokeWidth="2"
                ...
                <polygon
                  points="280,300 400,345 280,390 160,345"
                  fill="#facc15"
                  fillOpacity="0.15"
                  stroke="#facc15"
                  strokeWidth="2"
                ...
                <polygon
                  points="280,430 400,475 280,520 160,475"
                  fill="#facc15"
                  fillOpacity="0.15"
                  stroke="#facc15"
                  strokeWidth="2"
                ...
                <polygon
                  points="280,560 400,605 280,650 160,605"
                  fill="#facc15"
                  fillOpacity="0.15"
                  stroke="#facc15"
                  strokeWidth="2"
                ...
                <polygon
                  points="280,690 390,725 280,760 170,725"
                  fill="#facc15"
                  fillOpacity="0.15"
                  stroke="#facc15"
                  strokeWidth="2"
                ...
                <text
                  ...
                  fontFamily="sans-serif"
                >
                  Always verify your selection against the
                </text>
                <text
                  x="280"
                  y="805"
        ...
        <section className="mb-10">
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The first major decision when selecting a tower is whether it will be used indoors
                or outdoors. This single factor affects almost every other aspect of the selection,
                from maximum height to the need for stabilisers.
              </p>
                  ...
                  <div className="bg-white/5 border border-green-400/30 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>No wind loading:</strong> Higher maximum heights permitted
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Controlled surface:</strong> Floors are usually flat and firm
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Stabilisers:</strong> May not be required at lower heights (check
                          manual)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Weather:</strong> Not a factor for stability
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Space constraints:</strong> Doorways, corridors, low ceilings may
                          limit options
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Floor loading:</strong> Check raised floors can take the weight
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-white/5 border border-orange-400/30 p-4 rounded-lg">
                    <ul className="text-white space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Wind loading:</strong> Major factor — lower max heights apply
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Weather dependent:</strong> Rain, ice, and wind affect safety
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Stabilisers:</strong> Almost always required for outdoor use
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Ground conditions:</strong> May be uneven, soft, or sloping
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Lighting:</strong> Daylight hours may limit working time
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong>Security:</strong> Tower may need to be secured overnight
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-white/5 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  affect the tower. When in doubt, apply the outdoor criteria.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-blue-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The working height you need to reach determines the platform height, which in turn
                determines the tower configuration. Remember: the platform height is not the same as
                the reach height. A person standing on a platform can typically reach approximately
                2m above the platform level.
              </p>
              ...
              <p>
                If the required platform height exceeds the maximum for any tower configuration, you
                may need to consider alternative access equipment such as a MEWP (cherry picker),
                traditional scaffolding, or a combination of solutions. Do not attempt to exceed the
                manufacturer's maximum height.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The weight of personnel, tools, and materials you need on the platform determines
                both the width and the type of tower you need. Remember the 275kg per-platform
                limit.
              </p>
              ...
              <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Count the operatives:</strong> How many people will be on the platform
                      simultaneously? Add their weights.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>List the tools:</strong> Power tools, hand tools, test instruments —
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Assess materials:</strong> Cable drums, containment, luminaires,
                      fixings — weigh the heaviest items.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Add it all up:</strong> Total must be under 275kg. If it exceeds this,
                      reduce the load or make multiple trips.
                    </div>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The environment where the tower will be used can significantly affect your
                selection. Beyond the basic indoor/outdoor distinction, several environmental
                factors must be assessed during planning.
              </p>
                ...
                <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-1 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Raised access floors:</strong> May not support tower weight — check
                        floor tile loading
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Soft ground:</strong> Use base plates or spreader boards to
                        distribute load
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Slopes:</strong> Use adjustable legs or stairwell towers — never
                        pack under castors
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Wet surfaces:</strong> Ensure castors and stabilisers grip safely
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Fragile surfaces:</strong> Glass roofs, ceiling tiles — tower must
                        be on the structural floor
                      </span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-1 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Overhead power lines:</strong> Maintain safe exclusion zones —
                        consult the DNO if in doubt
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Low beams and pipes:</strong> Measure clearance before selecting
                        tower height
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Moving equipment:</strong> Overhead cranes, conveyors — establish a
                        safe system of work
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Falling objects:</strong> Other work happening above? Use a fan or
                        crash deck
                      </span>
                    </li>
                  </ul>
                ...
                <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-1 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Wet/humid:</strong> Swimming pools, food processing — use GRP, check
                        for corrosion
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Dusty/dirty:</strong> Construction sites — clean components, check
                        brakes work
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Chemical exposure:</strong> Laboratories, industrial — check
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>Extreme temperature:</strong> Cold stores, furnace areas — material
        ...
        <section className="mb-10">
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The following table maps common electrical tasks to recommended tower
                configurations. Use this as a starting point, then verify against the manufacturer's
                instructions and your site-specific risk assessment.
              </p>
              ...
              <div>
                ...
                <ul className="space-y-1 text-white/80">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Near live electrics?</strong> GRP only
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">On stairs?</strong> Stairwell tower only
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Under 2.5m?</strong> Consider folding tower
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Narrow space?</strong> Single-width
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Two people?</strong> Double-width
                    </span>
                  </li>
                </ul>
              </div>
        ...
        {/* Quiz Section */}
        <div className="mt-12">
          <Quiz title="Selecting the Right Tower Quiz" questions={quizQuestions} />
        </div>
