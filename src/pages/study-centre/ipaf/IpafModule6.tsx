    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Put your IPAF mobile scaffold knowledge to the test under timed exam conditions. Questions
        ...
        <Link to="../ipaf-mock-exam" className="block touch-manipulation focus:outline-none">
