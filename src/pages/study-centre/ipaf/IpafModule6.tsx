...
const examFeatures = [
  ...
  { icon: ShieldCheck, label: '80% pass mark (16/20)', description: 'Matches the standard required by PASMA training assessments.' },
...
const preparationTips = [
  { title: 'Review all five modules', description: 'Questions are drawn equally from Legislation, Tower Types, Assembly, Inspection and Hazards. Cover every module before attempting the exam.' },
  { title: 'Know your regulations', description: 'The Work at Height Regulations 2005, HSWA 1974 and BS EN 1004-1:2020 are heavily tested. Understand the hierarchy of control and employer duties.' },
  { title: 'Understand assembly methods', description: 'Be clear on the differences between 3T (Through The Trap) and AGR (Advance Guard Rail), including when each is appropriate and the step-by-step sequences.' },
  { title: 'Remember key dimensions', description: 'Guardrail height (950 mm), mid-rail (470 mm), toeboard (150 mm), platform safe working load (275 kg) and wind limits (Beaufort 4 cease work) appear frequently.' },
  { title: 'Inspection triggers', description: 'Know when inspections are required: before first use, every 7 days, after any event that could affect stability and after any modification or relocation.' },
  ...
  return (
    <div className="min-h-screen bg-[hsl(0_0%_8%)] text-white">
      <div className="px-4 sm:px-6 lg:px-8 pt-2 pb-24">
        <PageFrame>
          <button
            onClick={() => navigate('../ipaf-course')}
            className="inline-flex items-center gap-2 h-10 px-3 rounded-full bg-white/[0.06] border border-white/[0.1] text-white text-[13px] font-medium touch-manipulation hover:bg-white/[0.1] mb-1 self-start"
          >
            <ArrowLeft className="h-4 w-4" /> IPAF mobile scaffold training
          </button>

          <PageHero
            eyebrow="Module 6 · Final assessment"
            title="Mock exam"
            description="Put your IPAF mobile scaffold knowledge to the test under timed exam conditions. Questions are drawn from a 200-question bank covering all five content modules."
            tone="yellow"
          />
          ...
          >
            <div className="rounded-2xl bg-gradient-to-br from-elec-yellow/15 via-amber-500/10 to-transparent border border-elec-yellow/30 p-5 sm:p-6 active:scale-[0.99] transition-transform">
              <div className="flex items-center justify-between gap-3">
                ...
                <PrimaryButton size="lg" onClick={() => navigate('../ipaf-mock-exam')}>
