...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 2,
    explanation:
      'Class 3 towers have a maximum uniformly distributed load of 200 kg/m\u00B2 on the working platform. Class 2 towers have a lower limit of 150 kg/m\u00B2. The load class must be clearly marked on the tower.',
  },
  {
    id: 'en1004-max-height',
    question: 'What is the maximum height for a standard EN 1004 tower used outdoors?',
    options: ['4 metres', '8 metres', '12 metres', '16 metres'],
    correctIndex: 1,
    explanation:
      'BS EN 1004-1:2020 limits standard mobile towers to a maximum platform height of 8 metres for outdoor use and 12 metres for indoor use. Towers exceeding these heights fall outside the scope of the standard.',
  },
  {
    id: 'en1004-manual',
    ...
    correctIndex: 1,
    explanation:
      'BS EN 1004-2:2021 sets out the requirements for the instruction manual that must accompany every mobile access tower. It specifies what information the manual must contain, including assembly sequences, safe use guidance, and maximum heights.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'BS EN 1004-1:2020 is the European standard for prefabricated mobile access towers made from prefabricated elements. It covers design, structural requirements, and marking.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 3,
    explanation:
      'BS EN 1004-1:2020 permits a maximum platform height of 12 metres for towers used indoors, where wind loading is not a factor. Outdoor towers are limited to 8 metres.',
  },
  {
    id: 4,
    question: 'Which standard covers the instruction manual requirements for mobile towers?',
    options: ['BS EN 1004-1:2020', 'BS EN 1004-2:2021', 'BS 1139-6', 'BS EN 12811-1'],
    correctAnswer: 1,
    explanation:
      'BS EN 1004-2:2021 specifically covers the requirements for instruction manuals provided with mobile access towers, including assembly sequences, stability information, and safe use guidance.',
  },
  {
    id: 5,
...
export default function IpafModule1Section3() {
  useSEO({
    ...
    description:
      'Scope of BS EN 1004, load classes 2 and 3, maximum heights, BS 1139-6 for non-standard towers, instruction manual requirements, marking, and design safety factors.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>EN 1004:</strong> Standard for prefabricated mobile access towers
              </li>
              <li>
                <strong>Classes:</strong> Class 2 = 150 kg/m&sup2;, Class 3 = 200 kg/m&sup2;
              </li>
              <li>
                <strong>Heights:</strong> Max 8m outdoor, 12m indoor
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Check:</strong> Load class label before loading the platform
              </li>
              <li>
                <strong>Verify:</strong> Tower does not exceed its rated max height
              </li>
              <li>
                <strong>Keep:</strong> Manufacturer's instruction manual accessible on site
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                BS EN 1004-1:2020 is the European standard that specifies the design, structural,
                and safety requirements for prefabricated mobile access towers. It replaced the
                earlier EN 1004:2004 and introduced significant changes, including the new load
                classification system and updated stability requirements.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Full Title:</strong> BS EN 1004-1:2020
                  &mdash; "Mobile access and working towers made of prefabricated elements &mdash;
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Towers supporting persons, tools, and materials on working platforms
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                load classes. Previously, EN 1004:2004 specified a single load capacity. The new
                system gives users and specifiers a clearer choice based on the intended use of the
                tower.
              </p>
                  ...
                  <div className="grid sm:grid-cols-2 gap-4 mt-3">
                    <div className="bg-black/30 rounded-lg p-3">
                      ...
                      <p className="text-white font-mono">
                        3.25 m&sup2; &times; 150 ={' '}
                        <span className="text-blue-400">487.5 kg max</span>
                      </p>
                    </div>
                    <div className="bg-black/30 rounded-lg p-3">
                      <p className="text-xs text-white/60 mb-1">
                      ...
                      <p className="text-white font-mono">
                        3.25 m&sup2; &times; 200 ={' '}
                        <span className="text-green-400">650 kg max</span>
                      </p>
                    </div>
                  </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                BS EN 1004-1:2020 sets clear maximum platform height limits based on whether the
                tower is used indoors or outdoors. These limits are determined by the stability
                requirements of the standard, particularly the effect of wind loading on outdoor
                towers.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Height Measurement:</strong> Platform height
                  is measured from the ground (or supporting surface) to the top of the working
                  platform deck. It does not include the guardrail height above the platform. Always
                  refer to the manufacturer's data sheet for the specific tower configuration and
                  its rated maximum platform height.
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                When a mobile tower falls outside the scope of BS EN 1004 &mdash; for example
                because it exceeds the maximum height limits or uses a non-standard configuration
                &mdash; BS 1139-6 provides the relevant guidance. This British Standard covers metal
                scaffolding and is used as a reference for special scaffold structures.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Towers used in unusual environments (e.g. on slopes, on other structures)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  use, ground conditions, and any unusual features. A method statement based on this
                  design is essential.
                </p>
              </div>

              <p>
                In practice, most towers used on construction sites and for maintenance work fall
                within the scope of BS EN 1004. Towers falling under BS 1139-6 are the exception
                rather than the rule, and their use requires specialist knowledge and design input.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                BS EN 1004-2:2021 is the companion standard to EN 1004-1 and sets out the
                requirements for the instruction manual that must accompany every mobile access
                tower sold or hired. The manual is a critical safety document and must be available
                on site whenever a tower is in use.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Legal Requirement:</strong> Under the Work at
                  Height Regulations 2005, the manufacturer's instruction manual must be available
                  at the place where the tower is being used. The person assembling the tower must
                  follow the manufacturer's instructions. Assembling a tower without the manual is a
                  breach of the Regulations.
                </p>
              </div>

              <p>
                The instruction manual is not a substitute for training. A competent person must
                still assemble the tower, but they must do so in accordance with the manufacturer's
                specific instructions for that particular tower model and configuration.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                BS EN 1004-1:2020 requires every tower to be permanently and legibly marked with
                specific information. This marking allows users to quickly identify the tower's
                capabilities and limitations, which is essential for safe use on site.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  ...
                  <p>
                    <strong className="text-white">2. Standard reference</strong> &mdash; "EN
                    1004-1:2020" confirms compliance
                  </p>
                  <p>
                    <strong className="text-white">3. Load class</strong> &mdash; "Class 2" or
                    "Class 3" with the maximum UDL
                  </p>
                  <p>
                    <strong className="text-white">4. Maximum platform height</strong> &mdash; the
                    highest platform configuration permitted
                  </p>
                  <p>
                    <strong className="text-white">5. Tower model or type designation</strong>{' '}
                    &mdash; identifies the specific model
                  </p>
                  <p>
                    <strong className="text-white">6. Year of manufacture</strong> &mdash; for
                    traceability and age assessment
                  </p>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                BS EN 1004-1:2020 specifies the design loads and safety factors that manufacturers
                must use when designing mobile access towers. Understanding these helps you
                appreciate why exceeding the rated load is dangerous and how the margin of safety is
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  ...
                  <p>
                    <strong className="text-white">Imposed load:</strong> The working load on the
                    platform &mdash; persons, tools, and materials (up to the class rating).
                  </p>
                  <p>
                    <strong className="text-white">Wind load:</strong> The force exerted by wind on
                    the tower and anything attached to it (sheeting, netting, banners).
                  </p>
                  <p>
                    <strong className="text-white">Horizontal forces:</strong> Forces from people
                    leaning, pushing, or pulling whilst working on the platform.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    maximum rated load without structural failure (the ultimate limit state).
                  </p>
                  <p>
                    <strong className="text-white">Stability:</strong> The tower must remain stable
                    under the combined effects of all design loads. The overturning moment must not
                    exceed the stabilising moment.
                  </p>
                  <p>
                    <strong className="text-white">Deformation:</strong> Under working loads,
                    deflection of any component must remain within specified limits to ensure the
                    tower remains safe and usable.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  tolerances &mdash; not to allow overloading. Always work within the rated load
                  class and never rely on the safety margin as additional capacity.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>EN 1004-1:2020</strong> &mdash; Tower design and requirements
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>EN 1004-2:2021</strong> &mdash; Instruction manual requirements
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>BS 1139-6</strong> &mdash; Non-standard/special towers
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>EN 12811-1</strong> &mdash; Fixed scaffolding
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong>PAS 250</strong> &mdash; Low-level platforms (under 2.5m)
                      </span>
                    </li>
                  </ul>
                </div>
