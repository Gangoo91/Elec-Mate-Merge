...
export default function CRModule6() {
  useSEO({
    title: 'Module 6: Mock Exam | Conflict Resolution & Difficult Conversations',
    description:
      'Conflict Resolution mock examination — 20 random questions from a 200-question bank, 30-minute timer, 80% pass mark.',
  });
