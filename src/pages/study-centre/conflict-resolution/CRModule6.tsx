    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Put your conflict resolution knowledge to the test under timed exam conditions. Questions
        ...
        <Link to="../cr-mock-exam" className="block touch-manipulation focus:outline-none">
