...
const faqs = [
  ...
  {
    question: 'How do I know if my LEV system is working properly?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 6,
    question: 'What is the purpose of a process enclosure such as a glove box?',
    options: [
          ...
          <div className="rounded-lg p-4 bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Engineering controls:</strong> physical measures
                  that prevent hazardous substances reaching workers
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">LEV:</strong> captures contaminants at the source —
                  hood, ducting, filter, fan, discharge
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Reg 9:</strong> LEV must be examined and tested
                  every 14 months (6 months for certain processes)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Maintenance:</strong> Reg 8 requires all controls
          ...
          <div className="rounded-lg p-4 bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Chasing walls:</strong> always use on-tool
                  extraction with an M-class or H-class vacuum
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Soldering:</strong> use tip extraction or portable
                  fume extractor — never solder without extraction
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Plant rooms:</strong> check ventilation is adequate
                  before working — verify air change rates
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Daily checks:</strong> inspect LEV systems before
                  use — airflow, filters, ducting, capture velocity
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                source of generation — <strong className="text-white">before</strong> the
                contaminant reaches the worker&rsquo;s breathing zone. They sit third in the
                hierarchy of control, after elimination and substitution, and are preferred over
                administrative controls and PPE because they do not rely on human behaviour to be
                effective.
              </p>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  that reduce or eliminate worker exposure to hazardous substances. Unlike PPE
                  (which protects only the individual wearing it) or administrative controls (which
                  depend on people following procedures), engineering controls provide protection to{' '}
                  <strong className="text-white">everyone in the work area</strong> and work
                  continuously without relying on worker compliance.
                </p>
              </div>

              <p>
                Under <strong className="text-white">COSHH Regulation 7</strong>, employers must
                ensure that exposure to hazardous substances is either prevented or, where that is
                not reasonably practicable, adequately controlled. Engineering controls are a
                primary means of achieving adequate control. The regulation explicitly states that
                PPE should only be used as a <strong className="text-white">last resort</strong> —
                after all other reasonably practicable measures have been applied.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">General ventilation:</strong> dilutes
                      contaminants by supplying and exhausting air across the whole workspace
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Process enclosure:</strong> completely contains
                      the hazardous process within a sealed structure
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Process modification:</strong> changes the
                      process itself to reduce or eliminate contaminant release
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Segregation:</strong> physically separates the
                      hazardous process from the general work area
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">On-tool extraction:</strong> extraction systems
                      built into or attached to power tools
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Water suppression:</strong> uses water to
                      prevent dust becoming airborne during cutting or drilling
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  with the process). A face mask only works if the worker puts it on correctly, has
                  been face-fit tested, does not have facial hair preventing the seal, and wears it
                  for the entire duration of exposure. In practice, PPE compliance on construction
                  sites is far from perfect — which is precisely why engineering controls must
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                contaminated air at or near the point where the substance is released and removing
                it from the workplace before it can be inhaled. A well-designed, properly maintained
                LEV system is highly effective — but a poorly designed or neglected system can give
                ...
                <div className="bg-white/5 border border-violet-400/30 rounded-lg p-4 sm:p-6">
                  <div className="space-y-0">
                    ...
                    <div className="flex flex-col items-center gap-0">
                      ...
                      <div className="text-violet-400/60 text-xs font-medium">
                        Contaminated air flows in
                      </div>
                      <div className="w-0.5 h-4 bg-violet-400/40"></div>
                      ...
                      <div className="text-purple-400/60 text-xs font-medium">
                        Air transported through system
                      </div>
                      <div className="w-0.5 h-4 bg-purple-400/40"></div>
                      ...
                      <div className="text-fuchsia-400/60 text-xs font-medium">
                        Cleaned air continues
                      </div>
                      <div className="w-0.5 h-4 bg-fuchsia-400/40"></div>
                  ...
                  <div className="mt-4 bg-white/5 border border-violet-500/30 rounded-lg p-3">
                    <p className="text-violet-300 text-xs sm:text-sm font-medium">
                      ...
                      <strong className="text-white">any single component</strong> compromises the
                      entire system. The most common failures are blocked filters, leaking ducting,
                      and hoods positioned too far from the source.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="my-6">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  ...
                  <div className="bg-yellow-500/10 border border-yellow-400/30 rounded-lg p-4">
                    ...
                    <div className="bg-white/5 rounded p-2">
                      <p className="text-yellow-400 text-[10px] font-semibold uppercase tracking-wider mb-1">
                        Effectiveness
                      </p>
                      <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
                        <div
                  ...
                  <div className="bg-orange-500/10 border border-orange-400/30 rounded-lg p-4">
                    ...
                    <div className="bg-white/5 rounded p-2">
                      <p className="text-orange-400 text-[10px] font-semibold uppercase tracking-wider mb-1">
                        Effectiveness
                      </p>
                      <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
                        <div
                ...
                <div className="mt-4 bg-white/5 border border-violet-500/30 rounded-lg p-3">
                  <p className="text-violet-300 text-xs sm:text-sm font-medium">
                    Always use the{' '}
                    <strong className="text-white">highest level of enclosure</strong> that is
                    reasonably practicable. Total enclosure is the most effective. Captor hoods are
                    the least effective because capture velocity drops rapidly with distance —
                    doubling the distance reduces capture to about{' '}
              ...
              <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">
                        Vapours/gases released at low velocity (e.g. evaporation from open tank):
                      </strong>{' '}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">
                        Dusts/fumes released at moderate velocity (e.g. grinding, soldering):
                      </strong>{' '}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">
                        Dusts released at high velocity (e.g. disc cutting, chasing walls):
                      </strong>{' '}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">
                        Very high velocity release (e.g. abrasive blasting, high-speed machining):
                      </strong>{' '}
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <span>
                      <strong className="text-white">Standard interval:</strong> at least every{' '}
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <span>
                      <strong className="text-white">Shortened interval (6 months):</strong> for
                      processes involving certain blasting operations, work in substantial enclosed
                      spaces, or fumigation — as specified in Schedule 4 of COSHH
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <span>
                      <strong className="text-white">Records:</strong> must be kept for at least{' '}
                      <strong className="text-white">5 years</strong> from the date of examination
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <span>
                      <strong className="text-white">Commissioning test:</strong> every LEV system
                      must be performance-tested when first installed to confirm it achieves the
                      design capture velocity and airflow
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                air, thereby reducing the overall concentration of airborne contaminants. Unlike
                LEV, which captures contaminants at source, general ventilation dilutes the
                contaminant across the whole room volume.
              </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        <strong className="text-white">predictable and controllable</strong> — it
                        works regardless of weather conditions, wind direction, or whether someone
                        remembers to open a window.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        ventilation is{' '}
                        <strong className="text-white">unpredictable and variable</strong> — it
                        depends on external weather, wind speed and direction, temperature
                        differences, and the size and position of openings. It cannot be relied upon
                        as the sole control measure for hazardous substances unless a specific
                        assessment confirms it is adequate.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      <strong className="text-white">General offices:</strong> 4&ndash;6 air changes
                      per hour
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <span>
                      <strong className="text-white">Workshops:</strong> 6&ndash;10 air changes per
                      hour
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <span>
                      <strong className="text-white">Battery charging rooms:</strong> 10&ndash;15
                      air changes per hour (to manage hydrogen gas)
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <span>
                      <strong className="text-white">Transformer/switchgear rooms:</strong> as per
                      design specification — must account for SF6 release risk and heat dissipation
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      The substance is highly toxic or has a very low workplace exposure limit (WEL)
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <span>
                      Large quantities of contaminant are released (the dilution air volumes needed
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <span>
                      Workers are positioned close to the source of release (they would be exposed
                      before dilution takes effect)
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <span>
                      The contaminant is a dust or particulate (dilution does not effectively
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <span>
                      The release rate is variable or unpredictable (dilution calculations assume a
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  in a well-mixed workspace — for example, managing solvent vapours from small
                  cleaning operations, or maintaining air quality in a large workshop where multiple
                  low-level emission sources are widely distributed. It is often used as a{' '}
                  <strong className="text-white">supplement</strong> to LEV rather than a
                  replacement — providing background air quality while LEV handles the primary
                  source of exposure.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                that no contaminant escapes into the workplace atmosphere. It is the{' '}
                <strong className="text-white">most effective form of engineering control</strong>{' '}
                after elimination and substitution, because it physically separates the worker from
                the substance.
              </p>

              <div className="bg-white/5 border border-emerald-400/30 p-4 rounded-lg">
                <h3 className="text-emerald-300 font-medium mb-3">Types of Enclosure</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        of material into and out of the enclosure are through sealed ports or
                        closed-transfer couplings.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        any panel is opened during operation, the process shuts down automatically.
                        This prevents accidental exposure during maintenance or adjustment.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  the workspace. Battery rooms in substations are effectively enclosed and
                  ventilated spaces designed to contain and extract hydrogen gas generated during
                  charging. Understanding enclosure principles helps you recognise when a sealed
                  system has been compromised and exposure may have occurred.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                <strong className="text-white">Segregation</strong> means physically separating the
                hazardous process from other workers and the general work area. Both are powerful
                engineering strategies that reduce exposure without relying on PPE or worker
                behaviour.
              </p>

              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                <h3 className="text-cyan-300 font-medium mb-3">Process Modification Methods</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        water treatment — directly relevant to electricians working in water
                        treatment plants.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        for silica dust control when cutting brick, block, or concrete.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-cyan-400 font-medium mb-3">Segregation Methods</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Physical barriers:</strong> walls, partitions,
                      screens, or enclosures that separate the hazardous process from the rest of
                      the workplace. These can be permanent structures or temporary barriers such as
                      polythene sheeting with framed supports.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Distance separation:</strong> locating
                      hazardous processes as far as possible from occupied areas. In a workshop,
                      this might mean placing the soldering station in a dedicated, ventilated
                      corner rather than in the centre of the room.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Time separation:</strong> scheduling hazardous
                      tasks when fewer people are present — for example, carrying out floor coating
                      or solvent cleaning at the end of the working day or during weekends when the
                      building is unoccupied. This reduces the number of people potentially exposed.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Zoning and access control:</strong> designating
                      areas where hazardous substances are used as restricted zones with controlled
                      access — only authorised, trained personnel with appropriate PPE may enter.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  communicate with the site manager. Electricians often work near dusty trades —
                  protect yourself by staying upwind or using physical barriers when possible, and
                  always wear appropriate RPE when exposure cannot be avoided.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                exact point of generation — the cutting edge, drilling tip, or grinding face —
                before they can become airborne. For electricians, on-tool extraction is one of the
                most important day-to-day engineering controls because so much electrical
                installation work involves cutting, drilling, and chasing masonry.
              </p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        use an angle grinder for cutting masonry without extraction — the silica
                        dust exposure can exceed the WEL within seconds.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        Always use the extraction port — chasing without extraction generates
                        extremely high levels of respirable dust.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        particularly hazardous — dust falls directly into the worker&rsquo;s
                        breathing zone. Always use extraction for overhead work in masonry.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        slurry. If wet coring is not possible (e.g. near live electrical equipment),
                        dry coring with an H-class vacuum extractor is required.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
              ...
              <div className="bg-white/5 border border-violet-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <span>
                      <strong className="text-white">L-class:</strong> low hazard dusts only — NOT
                      suitable for silica, hardwood, or other high-hazard dusts
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <span>
                      <strong className="text-white">M-class:</strong> medium hazard dusts including
                      concrete, brick, tile, and softwood (OEL &ge; 0.1 mg/m&sup3;)
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <span>
                      <strong className="text-white">H-class:</strong> high hazard dusts including
                      silica, hardwood, lead, and carcinogens — the minimum standard for masonry
                      work generating silica dust
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-sky-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                grinding operations. Water binds to dust particles at the point of generation,
                causing them to form a slurry rather than becoming respirable airborne dust. It is
                one of the most effective controls for silica dust from masonry work.
              </p>

              <div className="bg-white/5 border border-sky-400/30 p-4 rounded-lg">
                <h3 className="text-sky-300 font-medium mb-3">Water Suppression Methods</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Wet cutting:</strong> feeding water directly
                      onto the cutting blade or disc during cutting. The water cools the blade,
                      extends blade life, and suppresses dust at the point of cut. Used with masonry
                      saws, tile cutters, and core drills.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Spray bars:</strong> fixed or adjustable
                      nozzles that deliver a fine mist of water over the work area during
                      dust-generating activities. Common on bench-mounted masonry saws and large
                      floor saws.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Suppression rings:</strong> circular nozzle
                      assemblies that fit around a core drill barrel or cutting wheel, delivering
                      water in a ring pattern around the cutting point. Ensures water reaches the
                      exact location where dust is generated.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Pressurised water bottles:</strong> portable
                      water supply systems that attach to power tools for wet cutting in locations
                      without a mains water supply. Essential for site work where plumbed water is
                      not available.
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <span>
                      Do not allow slurry to dry out — once dry, the dust becomes airborne again and
                      the suppression benefit is lost
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <span>
                      Clean up slurry while still wet using a wet vacuum or by mopping — never sweep
                      dry slurry
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <span>
                      Manage slip hazards — wet slurry on floors is a slip risk that must be
                      controlled with barriers, signage, and prompt clean-up
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <span>
                      Consider electrical safety — water and electrical equipment do not mix. When
                      wet cutting near live circuits or electrical panels, additional precautions
                      are essential including isolation of nearby circuits
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  using wet cutting or wet drilling methods, ensure all nearby circuits are isolated
                  and locked off. If isolation is not possible, use dry cutting with extraction
                  (H-class vacuum) instead. Always carry out a risk assessment that considers both
                  the dust exposure risk AND the electrical safety risk — and select the control
                  method that manages both hazards safely.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                . A neglected LEV system, a blocked filter, or a worn fan belt can reduce the
                effectiveness of the control to the point where it provides no meaningful protection
                — while giving workers a false sense of security.
              </p>
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      ...
                      <strong className="text-white">efficient state</strong>, in{' '}
                      <strong className="text-white">efficient working order</strong>, and in{' '}
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <span>
                      This applies to engineering controls, LEV systems, process enclosures,
                      ventilation systems, and all other control measures provided under Regulation
                      7
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <span>
                      Where engineering controls are provided, the employer must ensure there is a{' '}
                      <strong className="text-white">planned programme of maintenance</strong>, not
                      just reactive repairs
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <span>
                      ...
                      <strong className="text-white">rectified immediately</strong> — the control
                      must not be used until the defect is repaired
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-rose-400/30 p-4 rounded-lg">
                <h3 className="text-rose-300 font-medium mb-3">Three Levels of Checking</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        checks that take a few minutes and should become routine.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        replacing filters as needed. Results should be recorded in a maintenance
                        log.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        system pressure drop measurements, filter integrity checks, and a written
                        report with recommendations. The report must be kept for at least 5 years.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <span>
                      All thorough examination and test (TExT) reports — retained for at least{' '}
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <span>
                      Maintenance logs — dates of inspection, faults found, repairs carried out,
                      parts replaced
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <span>
                      Commissioning test results — the baseline performance data from when the
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <span>
                      Any modifications — changes to ducting, hoods, filters, or fan settings, with
                      the reason for the change and the effect on system performance
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Fume extraction when soldering:</strong> rosin
                      flux fumes from soldering are a respiratory sensitiser. Use a portable fume
                      extractor with a flexible arm positioned 50&ndash;100 mm from the soldering
                      point, or a bench-mounted unit with an activated carbon filter. This is a
                      COSHH requirement wherever soldering is carried out regularly.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Dust extraction when chasing walls:</strong>{' '}
                      use a wall chaser with built-in extraction connected to an H-class vacuum, or
                      an SDS drill with a dust extraction nozzle. The silica content of brick,
                      block, and mortar makes this a high-hazard dust exposure. On-tool extraction
                      is the primary control; RPE (FFP3) should be worn as a secondary measure.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <div>
                      ...
                      before entering electrical plant rooms, switchgear rooms, or battery rooms,
                      verify that the ventilation system is operating and providing the designed air
                      change rate. Check for warning signs indicating the presence of hazardous
                      gases (SF6, hydrogen, battery acid fumes). If ventilation has failed, do not
                      enter until the system is restored and the atmosphere has been tested and
                      confirmed safe.
                    </div>
                  </div>
                </div>
