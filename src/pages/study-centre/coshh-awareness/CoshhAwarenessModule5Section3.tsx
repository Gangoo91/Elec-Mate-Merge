...
const faqs = [
  {
    question: 'What should I do if I am unsure what chemical has been spilled?',
    answer:
  ...
  {
    question: 'How often should spill kits be inspected and what should I check?',
    answer:
  ...
  {
    question: 'What is the difference between RIDDOR and COSHH reporting requirements?',
    answer:
  ...
  {
    question: 'Can I use the same spill kit for acid and alkali spills?',
    answer:
...
export default function CoshhAwarenessModule5Section3() {
  useSEO({
    title: 'Emergency Procedures | COSHH Awareness Module 5 Section 3',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Reg 13:</strong> Employers must plan for foreseeable chemical emergencies
              </li>
              <li>
                <strong>Spills:</strong> Identify &rarr; PPE &rarr; contain &rarr; absorb &rarr;
                dispose as hazardous waste
              </li>
              <li>
                <strong>First aid:</strong> Skin/eyes &mdash; flush 15&ndash;20 min; ingestion
                &mdash; do NOT induce vomiting
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Spill kits:</strong> Right type, right location, staff trained to use them
              </li>
              <li>
                <strong>Eye wash:</strong> Check weekly, flush for 15&ndash;20 min if contaminated
              </li>
              <li>
                <strong>RIDDOR:</strong> Report acute illness, occupational disease, dangerous
                occurrences
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Regulation 13</strong> of the Control of Substances Hazardous to Health
                Regulations 2002 (COSHH) requires every employer to ensure that procedures are in
                place for dealing with{' '}
                <strong>
                  accidents, incidents, and emergencies involving hazardous substances
                </strong>
                . This is not optional &mdash; it is a legal duty that applies to all workplaces
                where hazardous substances are used, stored, or generated.
              </p>

              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <h3 className="text-violet-400 font-medium mb-3">What Regulation 13 Requires</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Identify foreseeable emergencies:</strong> consider what could go
                      wrong &mdash; spills, leaks, equipment failure, fires, uncontrolled releases
                      of gas or vapour, and accidental mixing of incompatible chemicals
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Write emergency procedures:</strong> clear, step-by-step instructions
                      for each type of foreseeable emergency, including who does what, what
                      equipment is available, and when to escalate
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Communicate procedures to workers:</strong> all employees who may be
                      affected must know the procedures, the location of emergency equipment, and
                      the names of trained responders
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Provide appropriate equipment:</strong> spill kits, eye wash stations,
                      safety showers, first aid supplies, and personal protective equipment must be
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Practise emergency drills:</strong> safety drills must be carried out
                      at suitable intervals so that workers know what to do when an emergency occurs
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  the SDS covers first aid measures,{' '}
                  <strong className="text-white">Section 5</strong> covers fire-fighting measures,
                  and <strong className="text-white">Section 6</strong> covers accidental release
                  measures. These sections provide substance-specific guidance that must be
                  incorporated into your site emergency procedures.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The response to a chemical spill depends on the <strong>substance involved</strong>,
                the <strong>quantity spilled</strong>, the <strong>location</strong>, and the{' '}
                <strong>risk to people and the environment</strong>. All spills must be taken
                seriously &mdash; even a small spill of a highly toxic or corrosive substance can
                cause serious harm.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <p className="text-sm font-medium text-violet-400">Small Spills</p>
                  </div>
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <p className="text-sm font-medium text-red-400">Large Spills</p>
                  </div>
                  <div className="space-y-2">
                    {[
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  , clearly signed, and not obstructed. All workers who may need to respond to a
                  spill must be{' '}
                  <strong className="text-white">trained in the correct use of the kit</strong> for
                  the chemicals in their area. Training should include hands-on practice, not just a
                  briefing. Kits must be inspected regularly and restocked after every use.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                An uncontrolled release of toxic gas or vapour is one of the most dangerous chemical
                emergencies. Gases and vapours can spread rapidly, are often invisible, and may be
                odourless at dangerous concentrations. The response must be swift and
                well-rehearsed.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <p className="text-sm font-medium text-red-400">Evacuation Procedures</p>
                </div>
                <div className="space-y-2">
                  {[
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-white">Natural:</strong> open doors and windows (if
                        safe to approach) to create cross-ventilation
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Forced:</strong> mechanical ventilation fans
                        to actively remove contaminated air &mdash; ensure extracted air is directed
                        away from people
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Caution:</strong> if the gas is flammable, do
                        NOT use electrical switches or equipment that could create a spark
                      </span>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul className="text-sm text-white/80 space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <strong className="text-white">safe range (19.5%&ndash;23.5%)</strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        The{' '}
                        <strong className="text-white">
                          source of the release has been identified and controlled
                        </strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <div className="text-white/80 text-sm space-y-2">
                  <p>
                    ...
                    CO, H2S, SO2). They provide real-time readings and alarms when safe limits are
                    exceeded.
                  </p>
                  <p>
                    <strong className="text-white">Bump testing</strong> must be carried out before
                    each use &mdash; a short burst of test gas is applied to verify the sensors
                    respond correctly. <strong className="text-white">Calibration</strong> must be
                    performed at the intervals specified by the manufacturer (typically every 3 to 6
                    months) using certified calibration gas. A detector that has not been
                    bump-tested or calibrated cannot be relied upon.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The correct first aid response depends on the <strong>route of exposure</strong>{' '}
                &mdash; skin contact, eye contact, inhalation, or ingestion. In every case, the
                Safety Data Sheet (SDS) Section 4 provides substance-specific first aid guidance
                that takes priority over general procedures.
              </p>

              {/* Skin Contact */}
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <h3 className="text-violet-400 font-medium mb-3">Skin Contact</h3>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-white/80">
                      ...
                      . Use a safety shower if available. Ensure water runs off the body and does
                      not contaminate unaffected areas.
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="flex items-center justify-center w-5 h-5 rounded-full bg-violet-500/20 text-violet-400 text-xs font-bold flex-shrink-0">
                    ...
                    <p className="text-white/80">
                      ...
                      &mdash; HF penetrates deeply and causes systemic fluoride poisoning. For
                      cement burns, wash thoroughly and remove all contaminated clothing including
                      boots.
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
              ...
              {/* Eye Contact */}
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <h3 className="text-violet-400 font-medium mb-3">Eye Contact</h3>
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-3">
                    <span className="flex items-center justify-center w-5 h-5 rounded-full bg-violet-500/20 text-violet-400 text-xs font-bold flex-shrink-0">
                      1
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-white/80">
                      ...
                      to prevent the chemical from washing into the unaffected eye.
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="flex items-center justify-center w-5 h-5 rounded-full bg-violet-500/20 text-violet-400 text-xs font-bold flex-shrink-0">
                    ...
                    <p className="text-white/80">
                      ...
                      if possible. Use bottles of saline or clean water. Every second of delay
              ...
              {/* Inhalation */}
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <h3 className="text-violet-400 font-medium mb-3">Inhalation</h3>
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-3">
                    <span className="flex items-center justify-center w-5 h-5 rounded-full bg-violet-500/20 text-violet-400 text-xs font-bold flex-shrink-0">
                      1
                    ...
                    <p className="text-white/80">
                      ...
                      to fresh air. Ensure your own safety first &mdash; do not enter without
                      appropriate RPE if fumes are still present.
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="flex items-center justify-center w-5 h-5 rounded-full bg-violet-500/20 text-violet-400 text-xs font-bold flex-shrink-0">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cool under running water</strong> for at least
                      20 minutes (longer for alkali burns, which penetrate deeper than acid burns)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cover with cling film</strong> applied
                      lengthways (not wrapped around a limb) to protect the burn and reduce pain
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Never attempt to neutralise</strong> a chemical
                      on the skin with another chemical &mdash; this can cause an exothermic
                      reaction and worsen the burn
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4">
              ...
              <ul className="text-xs text-white/80 space-y-1">
                ...
                <li>
                  <strong className="text-white">Call 999</strong> for significant exposures
                </li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Fires involving hazardous substances present additional risks beyond a standard
                fire. The <strong>choice of extinguishing agent is critical</strong> &mdash; using
                the wrong type can make the fire worse, cause explosions, or generate highly toxic
                fumes. The SDS Section 5 specifies the correct extinguishing media for each
                substance.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <p className="text-sm font-medium text-red-400">Extinguishant Requirements</p>
                </div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-red-300">Never water on metal fires:</strong> alkali
                      metals (sodium, potassium, lithium) react violently with water, producing
                      explosive hydrogen gas and intense heat. Use dry powder (Class D)
                      extinguishers or dry sand.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-red-300">Never water on oil fires:</strong> water
                      causes burning oil to splatter violently, spreading the fire. Use foam, dry
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-red-300">Never water on electrical fires:</strong>{' '}
                      water conducts electricity, creating a risk of electrocution. Isolate the
                      supply first. Use CO2 or dry powder extinguishers.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-amber-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-amber-300">Toxic fume generation:</strong> many
                      hazardous substances produce{' '}
                      <strong className="text-white">highly toxic fumes when they burn</strong>.
                      Plastics can release hydrogen cyanide, PVC produces hydrogen chloride gas, and
                      isocyanates generate toxic vapours. Treat all smoke from chemical fires as
                      toxic.
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  substances create a risk of explosive atmospheres (e.g. flammable solvents, gases,
                  or dusts), the workplace must be classified into{' '}
                  <strong className="text-white">hazardous area zones</strong>, and only{' '}
                  <strong className="text-white">ATEX-rated equipment</strong> may be used in those
                  zones. Emergency procedures must account for DSEAR risks.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>RIDDOR</strong>) require certain chemical exposure incidents to be reported
                to the HSE. Failure to report is a criminal offence. The{' '}
                <strong>responsible person</strong> (usually the employer, self-employed person, or
                person in control of the premises) must make the report.
              </p>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Acute illness requiring medical treatment:</strong> any acute illness
                      that requires medical treatment and results from occupational exposure to a
                      hazardous substance &mdash; for example, chemical burns requiring hospital
                      treatment, acute respiratory distress from fume inhalation, or acute poisoning
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Occupational disease diagnosed by a doctor:</strong> prescribed
                      diseases linked to hazardous substance exposure include occupational asthma
                      (from isocyanates, formaldehyde, etc.), occupational dermatitis (from repeated
                      chemical contact), and chronic beryllium disease
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Dangerous occurrence:</strong> the uncontrolled or accidental release
                      of a hazardous substance that could have resulted in exposure causing acute
                      ill health &mdash; this includes large spills, gas leaks, and failure of
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-white/80 text-sm space-y-2">
                  <p>
                    ...
                    specified injuries must be reported by the{' '}
                    <strong className="text-white">quickest practicable means</strong> (usually
                    telephone to the HSE Incident Contact Centre on 0345 300 9923), followed by a
                    written report within 10 days. Other reportable events must be reported within{' '}
                    <strong className="text-white">10 working days</strong> for accidents, or{' '}
                    <strong className="text-white">15 working days</strong> for over-7-day
                    incapacitation injuries. Occupational disease reports must be made as soon as
                    the diagnosis is received.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every chemical exposure incident &mdash; whether it resulted in harm or was a near
                miss &mdash; must be <strong>investigated</strong> to identify the root cause and
                prevent recurrence. The purpose of investigation is{' '}
                <strong>learning, not blame</strong>. A blame culture discourages reporting and
                prevents organisations from learning from incidents.
              </p>

              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <h3 className="text-violet-400 font-medium mb-3">Root Cause Analysis</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>What happened?</strong> &mdash; Establish the facts: what substance,
                      what quantity, where, when, who was involved, and what injuries or exposures
                      occurred
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>How did it happen?</strong> &mdash; Trace the sequence of events
                      leading to the incident. Identify the immediate cause (e.g. container dropped,
                      valve left open, incompatible chemicals stored together)
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Why did it happen?</strong> &mdash; Dig deeper to find the root cause.
                      Was there a failure in the risk assessment? Were control measures inadequate
                      or not followed? Was training insufficient? Was the COSHH assessment out of
                      date?
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>What must change?</strong> &mdash; Identify and implement corrective
                      actions: update the COSHH assessment, improve control measures, provide
                      additional training, change procedures, or improve equipment
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-violet-400 font-medium mb-3">After the Investigation</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-violet-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>Update the COSHH assessment</strong> to reflect what was learnt from
                      the incident. If the risk assessment did not anticipate the scenario, it needs
                      revising.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-violet-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>Implement corrective actions</strong> with clear ownership and
                      deadlines. Track completion.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-violet-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>Share lessons learnt</strong> with the workforce through toolbox
                      talks, safety briefings, or notice board updates. Workers who understand why
                      an incident occurred are better equipped to prevent it recurring.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-violet-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <strong>Review emergency procedures</strong> &mdash; did the emergency
                      response work effectively? Were there delays or gaps? Update procedures
                      accordingly.
                    </div>
                  </div>
                </div>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>
                  readily available, clearly signed, regularly inspected, and properly maintained
                </strong>
                . Equipment that is not working when needed is worse than no equipment at all,
                because workers may waste critical time attempting to use it.
              </p>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-xs text-white/80 space-y-1.5 leading-relaxed">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Located within{' '}
                        <strong className="text-white">10 seconds&apos; travel</strong> of where
                        chemicals are used
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Plumbed-in stations: <strong className="text-white">flush weekly</strong> to
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Bottled eye wash: check <strong className="text-white">expiry dates</strong>{' '}
                        and seal integrity
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Clearly signed with the standard green and white eye wash sign</span>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul className="text-xs text-white/80 space-y-1.5 leading-relaxed">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        <strong className="text-white">large-area chemical contamination</strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Test monthly</strong> and record the test
                        results
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Keep the area around the shower clear at all times</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-xs text-white/80 space-y-1.5 leading-relaxed">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Correct type for the chemicals in the area (acid, alkali, solvent, mercury,
                        general)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Inspect monthly</strong> and restock after
                        every use
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Located close to where hazardous substances are used, not in a remote store
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Workers trained in correct use for each kit type</span>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul className="text-xs text-white/80 space-y-1.5 leading-relaxed">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        (e.g. calcium gluconate gel for HF, saline for eye irrigation)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        ...
                        <strong className="text-white">chemical-specific training</strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Contents checked regularly, expired items replaced, and used items restocked
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Location clearly signed and known to all workers</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  . Inspection records must be kept. If a piece of emergency equipment is found to
                  be faulty, out of date, or missing, it must be reported and replaced{' '}
                  <strong className="text-white">immediately</strong>. During an emergency is the
                  worst time to discover that equipment does not work.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* ─── Key Takeaways ─── */}
        <section className="mb-10">
          <h2 className="text-lg sm:text-xl font-semibold text-white mb-4">Key Takeaways</h2>
          <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
            <ul className="text-white space-y-3 text-sm">
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-violet-500 mt-0.5 flex-shrink-0" />
                <span>
                  <strong>COSHH Regulation 13</strong> requires employers to identify foreseeable
                  emergencies, write procedures, provide equipment, train workers, and practise
                  drills.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-violet-500 mt-0.5 flex-shrink-0" />
                <span>
                  <strong>Small spills:</strong> identify, PPE, contain, absorb, clean, dispose as
                  hazardous waste. <strong>Large spills:</strong> evacuate, prevent spread, call
              ...
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-violet-500 mt-0.5 flex-shrink-0" />
                <span>
                  Different chemicals need different <strong>spill kits</strong> &mdash; general
                  purpose, acid, alkali, solvent, or mercury. Using the wrong kit can be dangerous.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-violet-500 mt-0.5 flex-shrink-0" />
                <span>
                  First aid: <strong>skin and eyes</strong> &mdash; flush 15&ndash;20 minutes;{' '}
                  <strong>inhalation</strong> &mdash; fresh air, call 999;{' '}
                  <strong>ingestion</strong> &mdash; do NOT induce vomiting, call 999.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-violet-500 mt-0.5 flex-shrink-0" />
                <span>
                  Fire: <strong>never use water</strong> on metal, oil, or electrical fires. All
                  smoke from chemical fires should be treated as toxic. Check SDS Section 5.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-violet-500 mt-0.5 flex-shrink-0" />
                <span>
                  <strong>RIDDOR</strong> requires reporting of acute illness from exposure,
                  prescribed occupational diseases, and dangerous occurrences.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-violet-500 mt-0.5 flex-shrink-0" />
                <span>
                  <strong>Investigate every incident</strong> &mdash; root cause analysis,
                  corrective actions, update the COSHH assessment, and share lessons learnt.
                </span>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="h-5 w-5 text-violet-500 mt-0.5 flex-shrink-0" />
                <span>
                  Emergency equipment &mdash; eye wash stations, safety showers, spill kits, and
                  first aid supplies &mdash; must be{' '}
                  <strong>inspected, maintained, and accessible</strong> at all times.
                </span>
              </li>
            </ul>
          </div>
