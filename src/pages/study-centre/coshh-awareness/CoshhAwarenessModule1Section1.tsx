...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      'Approximately how many people die each year in the UK from occupational lung disease?',
    options: ['Around 1,500', 'Around 5,000', 'Around 13,000', 'Around 25,000'],
    correctIndex: 2,
    explanation:
...
const quizQuestions = [
  {
    id: 1,
    question: 'What is the full title of the primary COSHH legislation?',
    options: [
  ...
  },
  {
    ...
    options: ['Around 2,000', 'Around 7,000', 'Around 12,000', 'Around 20,000'],
    correctAnswer: 2,
    explanation:
  ...
  },
  {
    ...
    options: ['Silica dust', 'Hydrogen chloride fumes', 'Carbon monoxide only', 'Lead vapour'],
    correctAnswer: 1,
    explanation:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>What:</strong> COSHH Regulations 2002 &mdash; controlling hazardous
                substances at work
              </li>
              <li>
                <strong>Scope:</strong> Chemicals, dusts, fumes, vapours, gases, mists, biological
                agents
              </li>
              <li>
                <strong>Not covered:</strong> Asbestos, lead, radioactive substances
              </li>
              <li>
                <strong>Deaths:</strong> ~13,000 per year from occupational lung disease alone
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Check:</strong> Safety data sheets before using any chemical product
              </li>
              <li>
                <strong>Read:</strong> The COSHH assessment before starting work with hazardous
                substances
              </li>
              <li>
                <strong>Use:</strong> All control measures and PPE as instructed
              </li>
              <li>
                <strong>Report:</strong> Any symptoms, spills, or failures in controls immediately
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every day in the United Kingdom, thousands of workers are exposed to substances that
                can damage their health. These range from everyday cleaning products and adhesives
                to highly toxic industrial chemicals, respirable dusts, and biological hazards. The
                consequences of uncontrolled exposure can be severe and, in many cases, irreversible
                &mdash; chronic lung disease, occupational asthma, dermatitis, cancer, and death.
              </p>

              <p>
                To address this, the UK Government introduced the{' '}
                <strong>Control of Substances Hazardous to Health Regulations 2002</strong>,
                commonly known as <strong>COSHH</strong>. The full statutory reference is{' '}
                <strong>SI 2002/2677</strong>, and the regulations have been amended several times
                since their original enactment to keep pace with evolving scientific understanding
                and European requirements. COSHH is secondary legislation made under the enabling
                powers of the <strong>Health and Safety at Work etc. Act 1974 (HASAWA)</strong>.
              </p>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  <strong> Control of Substances Hazardous to Health</strong>. The regulations
                  require employers to assess the risks from hazardous substances in the workplace
                  and to prevent or adequately control exposure to protect workers&rsquo; health.
                </p>
              </div>

              <p>
                The purpose of COSHH is straightforward: to protect people at work (and others who
                may be affected by the work activity) from illness caused by hazardous substances.
                The regulations set out a clear framework of duties for employers, which can be
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-sm sm:text-base">
                    <strong>Assess</strong> the risks to health from hazardous substances used in or
                    created by the workplace
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                  <span className="text-sm sm:text-base">
                    <strong>Prevent</strong> exposure where reasonably practicable, or{' '}
                    <strong>control</strong> it adequately where prevention is not possible
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                  <span className="text-sm sm:text-base">
                    <strong>Maintain</strong> control measures and keep them in efficient working
                    order
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                  <span className="text-sm sm:text-base">
                    <strong>Monitor</strong> exposure and carry out health surveillance where
                    appropriate
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                  <span className="text-sm sm:text-base">
                    <strong>Inform, instruct, and train</strong> employees about the risks and the
              ...
              <p>
                ...
                used, handled, stored, or produced as part of the work process. This includes
                offices, factories, construction sites, hospitals, laboratories, farms, and domestic
                premises where work is being carried out. It is not limited to &ldquo;heavy
                industry&rdquo; &mdash; even a small electrical contracting firm using PVC solvent
                cement, cleaning sprays, or flux is subject to COSHH.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  notably in 2003, 2004, and 2005 &mdash; to incorporate updated workplace exposure
                  limits, align with European directives on chemical agents, and strengthen
                  provisions around carcinogens and mutagens. When citing COSHH in assessments or
                  toolbox talks, always use the &ldquo;as amended&rdquo; form to indicate you are
                  referring to the current, up-to-date version.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Regulation 2 of COSHH provides the legal definition of a{' '}
                <strong>&ldquo;substance hazardous to health&rdquo;</strong>. Understanding this
                definition is important because it determines exactly which substances fall within
                the scope of COSHH and which do not.
              </p>

              <p>
                Under COSHH, a substance hazardous to health means any substance (including
                preparations, i.e. mixtures) that falls into one or more of the following
                categories:
              </p>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-sm sm:text-base">
                    ...
                    Table 1 of EH40/2005 (as amended), the HSE&rsquo;s guidance document on
                ...
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-sm sm:text-base">
                    ...
                    cause infection, allergy, toxicity, or otherwise create a hazard to human
                    health.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-sm sm:text-base">
                    ...
                    the air. The COSHH Regulations set a WEL of 10 mg/m&sup3; for inhalable dust and
                    4 mg/m&sup3; for respirable dust (the finer fraction that reaches deep into the
                    lungs).
                  </span>
                </li>
                <li className="flex items-start gap-2">
              ...
              <p>
                It is vital to understand that COSHH is not limited to &ldquo;chemicals in
                bottles&rdquo;. It also covers substances that are <strong>generated</strong> by the
                work process itself. For electricians, this is critically important. When you chase
                a wall, you generate respirable dust. When you solder a joint, you create solder
                fumes. When you cut PVC trunking with a hot-wire cutter, you release hydrogen
                chloride gas. When you strip old cable insulation, you may release toxic particles.
                All of these are substances hazardous to health within the meaning of COSHH, even
                though you never opened a container.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  by-products, waste, and anything produced, used, or given off during work
                  activities.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                COSHH has a very wide scope, but it is not universal. Certain specific substances
                are excluded because they are covered by their own dedicated regulations, which
                impose controls that are tailored to their particular hazards. Understanding what
                falls inside and outside the scope of COSHH is essential for compliance.
              </p>
                  ...
                  <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                    ...
                    <ul className="text-sm text-white space-y-2">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Chemicals &mdash; solvents, adhesives, paints, cleaning agents, oils,
                          resins
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                        <span>
                          Dusts &mdash; wood dust, cement dust, silica dust, plaster dust, general
                          construction dust
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                        <span>
                          Fumes &mdash; welding fumes, solder fumes, PVC fumes, diesel exhaust
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                        <span>
                          Biological agents &mdash; bacteria, viruses, fungi, moulds (e.g.,
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                        <span>
                          Nanotechnology &mdash; engineered nanoparticles and nano-materials
                        </span>
                      </li>
                    </ul>
                  </div>
                    ...
                    <ul className="text-sm text-white space-y-2">
                      ...
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          controlled by the Ionising Radiations Regulations 2017 (IRR 2017)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                        <span>
                          Substances below the hazard threshold that present no appreciable risk to
              ...
              <p>
                The distinction is important in practice. If you encounter asbestos on a
                construction site, you must follow the procedures set out in CAR 2012, not COSHH. If
                you are working with lead-based solder or lead-sheathed cable, the Control of Lead
                at Work Regulations 2002 apply. However, if you are using a chemical solvent to
                strip cable, that solvent is covered by COSHH &mdash; even if the cable itself
                contains lead.
              </p>
              ...
              <p>
                COSHH also does <strong>not</strong> cover hazards that are purely physical in
                nature. Noise, vibration, radiation (non-ionising), heat, and cold are not
                &ldquo;substances&rdquo; and are addressed by other regulations. Similarly, COSHH
                does not apply to substances that are hazardous only because of their physical
                properties (e.g., explosiveness or flammability) &mdash; those risks fall under the
                Dangerous Substances and Explosive Atmospheres Regulations 2002 (DSEAR). However,
                many substances are both hazardous to health <em>and</em> flammable, in which case
                both COSHH and DSEAR apply.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                staggering. Despite decades of regulation and enforcement, substance exposure at
                work remains one of the biggest causes of work-related death and disease in the
                United Kingdom. The numbers below, drawn from HSE published data, underline why
                COSHH compliance is not optional &mdash; it is a matter of life and death.
              </p>
              ...
              <p>
                These are not historical figures &mdash; they represent the current, ongoing scale
                of harm caused by hazardous substances in UK workplaces. The HSE estimates that
                around
                <strong> 13,000 people die each year</strong> as a result of occupational lung
                disease, making it one of the largest causes of work-related mortality. Occupational
                cancer, much of which is linked to substance exposure (including dusts, fumes, and
                chemical agents), accounts for an estimated 8,000 new cancer registrations annually.
              </p>

              <p>
                Skin disease is the <strong>second most common</strong> form of occupational ill
                health after musculoskeletal disorders. Around <strong>12,000 new cases</strong> of
                work-related skin disease are reported each year, with contact dermatitis being by
                far the most prevalent condition. Dermatitis caused by workplace substances can end
                careers &mdash; once sensitised to a substance, a worker may never be able to work
                with it again, and the condition may persist for life.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  dust, wood dust, solvents, diesel exhaust, welding fumes, epoxy resins, and
                  numerous other hazardous substances on a daily basis. Electricians face specific
                  risks from PVC fumes, cable dust, flux, solder fumes, solvent-based adhesives, and
                  the respirable dust created by chasing walls and drilling through concrete and
                  brick.
                </p>
              </div>

              <p>
                The long latency period of many occupational diseases is a critical factor.
                Occupational lung cancer may take 20 to 40 years to develop after initial exposure.
                Silicosis can develop over 10 to 20 years of cumulative dust exposure. Even
                occupational asthma, which can develop more rapidly, may not present until months or
                years after first contact with a sensitising agent. This means that the harm caused
                by today&rsquo;s poor practices may not become apparent for decades &mdash; by which
                time it is too late to reverse.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  single case of occupational disease can result in HSE enforcement action,
                  unlimited fines, personal liability for directors, and reputational damage. For
                  the individual worker, it can mean a lifetime of chronic illness, loss of
                  livelihood, and premature death.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Many electricians are surprised to learn just how many hazardous substances they
                come into contact with during routine work. COSHH is not just for chemical factories
                and laboratories &mdash; it applies directly to the day-to-day activities of every
                electrical contractor, whether working on a large commercial installation or a
                simple domestic rewire.
              </p>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-violet-400">
                    Common Hazardous Substances in Electrical Work
                  </p>
                </div>
                <div className="space-y-4">
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      respiratory tract. Prolonged exposure may damage the liver and kidneys. These
                      substances are also highly flammable.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      Lead-free solders still produce hazardous flux fumes.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      WEL for RCS is 0.1 mg/m&sup3; &mdash; an extremely low level that is easily
                      exceeded during uncontrolled chasing or cutting.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      concentrations can cause coughing, choking, and inflammation of the airways.
                      Cable burning to recover copper is illegal and extremely hazardous.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      cement are also skin sensitisers and carcinogens.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      sprays in confined spaces can be particularly hazardous.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      one of the leading causes of occupational asthma in the UK.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      adequate PPE can cause significant discomfort and occupational dermatitis.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <p>
                The key message is that hazardous substances are an{' '}
                <strong>everyday part of electrical work</strong>. They are not limited to unusual
                or specialist tasks. Routine activities &mdash; chasing a wall, soldering a joint,
                using PVC cement, spraying contact cleaner, or drilling through concrete &mdash; all
                generate or involve substances that fall within the scope of COSHH. Every
                electrician, from first-year apprentice to experienced supervisor, needs to
                understand what these substances are, how they can harm you, and what controls are
                required.
              </p>

              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">On-Site Reality:</strong> A 2019 HSE
                  inspection initiative targeting construction dust found that more than{' '}
                  <strong>40% of sites visited</strong> were failing to adequately control dust
                  exposure. Common failings included no water suppression on cutting tools, no local
                  exhaust ventilation, workers not wearing RPE (respiratory protective equipment),
                  and poor housekeeping allowing dust to accumulate and become re-airborne.
                  Electrical contractors were among those cited for poor compliance.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-violet-400 text-center flex-1">
                    The 8 COSHH Essentials Steps
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3 flex items-start gap-3">
                    <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-violet-500/20 text-violet-400 text-sm font-bold flex-shrink-0">
                      1
                    </span>
                    <div>
              ...
              <p>
                The eight steps are sequential and logical. You must{' '}
                <strong>assess the risks</strong>
                (step 1) before you can decide on precautions (step 2). You must decide on
                precautions before you can implement and maintain controls (steps 3 and 4).
                Monitoring and health surveillance (steps 5 and 6) verify that your controls are
                working. Emergency preparedness (step 7) ensures you can respond if something goes
                wrong. And training (step 8) ensures that everyone understands what they need to do
                and why.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ol className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Elimination</strong> &mdash; remove the
                      hazardous substance from the process entirely
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="inline-flex items-center justify-center min-w-[24px] h-6 rounded-full bg-violet-500/20 text-violet-400 text-xs font-bold flex-shrink-0">
                    ...
                    <span>
                      <strong className="text-white">Substitution</strong> &mdash; replace with a
                      less hazardous substance or process
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="inline-flex items-center justify-center min-w-[24px] h-6 rounded-full bg-violet-500/20 text-violet-400 text-xs font-bold flex-shrink-0">
                    ...
                    <span>
                      <strong className="text-white">Engineering controls</strong> &mdash; enclose
                      the process, use local exhaust ventilation (LEV), or use water suppression
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="inline-flex items-center justify-center min-w-[24px] h-6 rounded-full bg-violet-500/20 text-violet-400 text-xs font-bold flex-shrink-0">
                    ...
                    <span>
                      <strong className="text-white">Administrative controls</strong> &mdash; safe
                      systems of work, training, signage, restricted access, job rotation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="inline-flex items-center justify-center min-w-[24px] h-6 rounded-full bg-violet-500/20 text-violet-400 text-xs font-bold flex-shrink-0">
                    ...
                    <span>
                      <strong className="text-white">Personal protective equipment (PPE)</strong>{' '}
                      &mdash; the last resort, used when other controls cannot reduce exposure to an
                      adequate level
                    </span>
                  </li>
                </ol>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
                ...
                <div className="space-y-4">
                  <div className="border-b border-white/5 pb-4">
                    ...
                    <p className="text-sm text-white leading-relaxed">
                      ...
                      and welfare of their employees. Section 3 extends this duty to non-employees
                      who may be affected by the employer&rsquo;s undertaking. Section 7 places
                      duties on employees to take reasonable care and co-operate with their
                      employer. HASAWA is criminal law &mdash; breaches can result in unlimited
                  ...
                  <div className="border-b border-white/5 pb-4">
                    ...
                    <p className="text-sm text-white leading-relaxed">
                      ...
                      appoint competent persons, establish procedures for serious and imminent
                      danger, provide health surveillance, and co-operate with other employers
                      sharing a workplace. COSHH assessments are a specific, detailed part of the
                      broader risk assessment duty under these regulations.
                    </p>
                  </div>
                  <div className="border-b border-white/5 pb-4">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-sm text-white leading-relaxed">
                      ...
                      For example, a solvent used for cable jointing is a health hazard (toxic
                      vapours) under COSHH and a fire hazard (flammable) under DSEAR. Both sets of
                      regulations must be complied with simultaneously.
                    </p>
                  </div>
                  <div className="border-b border-white/5 pb-4">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-sm text-white leading-relaxed">
                      ...
                      Harmonised System (GHS) hazard pictograms (the red-bordered diamond symbols
                      you see on chemical containers). COSHH references CLP classifications to
                      determine which substances are &ldquo;hazardous to health&rdquo;.
                      Understanding CLP labels and safety data sheets (SDS) is essential for
                  ...
                  <div className="border-b border-white/5 pb-4">
                    ...
                    <p className="text-sm text-white leading-relaxed">
                      ...
                      dedicated, more stringent regulations. CAR 2012 includes the duty to manage
                      asbestos in non-domestic premises (Regulation 4), requirements for licensed
                      removal work, and mandatory training for all workers who may encounter
                      asbestos.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-white leading-relaxed">
                      ...
                      lead-sheathed cables, lead-based solder (still found in older installations),
                      and lead paint in pre-1980s buildings. CLAW 2002 sets action levels and
                      suspension levels for blood-lead concentrations and requires biological
                      monitoring for workers exposed above certain thresholds.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">In Practice:</strong> On a typical
                  construction site, multiple pieces of legislation will apply simultaneously. An
                  electrician chasing a cable route through a concrete wall is subject to COSHH
                  (silica dust exposure), the Management Regulations 1999 (general risk assessment),
                  the Construction (Design and Management) Regulations 2015 (construction-specific
                  duties), the Provision and Use of Work Equipment Regulations 1998 (the chasing
                  tool), and the Personal Protective Equipment at Work Regulations 1992 (RPE and
                  other PPE). Effective health and safety management requires awareness of all
                  applicable legislation, not just COSHH in isolation.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                these duties is essential because non-compliance can result in enforcement action by
                the HSE, including improvement notices, prohibition notices, unlimited fines, and
                (for serious breaches) criminal prosecution and imprisonment.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      duration, frequency, level), and the control measures needed. Assessments must
                      be recorded (where 5+ employees) and reviewed regularly or when circumstances
                      change.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      practicable,
                      <strong> adequately control</strong> exposure. Where a substance is a
                      carcinogen or mutagen, or causes occupational asthma, the duty is stronger
                      &mdash; exposure must be reduced to as low a level as is reasonably
                      practicable. Control measures must follow the hierarchy of controls.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                  ...
                  <div className="bg-white/5 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      for certain processes). RPE must be examined, tested, and maintained in
                      accordance with the manufacturer&rsquo;s instructions.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      for identifiable personal exposure records).
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      include lung function testing for workers exposed to respiratory sensitisers
                      and skin checks for workers exposed to skin sensitisers.
                    </p>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white leading-relaxed">
                      ...
                      monitoring and health surveillance. Training must be provided before first
                      exposure and repeated at appropriate intervals.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg mt-4">
                ...
                <ul className="text-sm text-white space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Report defects</strong> &mdash; if you discover
                      any defect in control measures, PPE, or any equipment provided for COSHH
                      compliance, you must report it to your employer immediately.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Attend health surveillance</strong> &mdash;
                      where your employer has arranged health surveillance, you must attend
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      You must co-operate with your employer so far as is necessary to enable them
                      to comply with COSHH and other health and safety legislation.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  for COSHH failures. Individual directors and managers can face personal
                  prosecution, fines, and imprisonment of up to two years for offences committed
                  with their consent, connivance, or neglect. Employees who deliberately breach
                  COSHH can also be prosecuted under HASAWA Section 7 or Section 8.
                </p>
              </div>

              <p>
                The fundamental principle is one of <strong>shared responsibility</strong>.
                Employers have the primary duty to assess risks, implement controls, provide
                information and training, and monitor the effectiveness of those controls. Employees
                have a duty to use those controls properly, report problems, attend health
                surveillance, and co-operate with their employer. When both parties fulfil their
                duties, the system works. When either side fails, workers&rsquo; health is put at
                risk.
              </p>
