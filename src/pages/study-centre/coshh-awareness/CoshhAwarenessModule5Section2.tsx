...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question: 'In spirometry testing, what does a reduced FEV1/FVC ratio primarily indicate?',
    options: [
...
const faqs = [
  {
    question: 'Can an employee refuse to attend health surveillance?',
    answer:
  ...
  {
    question: 'Who pays for health surveillance \u2014 the employer or the employee?',
    answer:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Schedule 3', 'Schedule 5', 'Schedule 6', 'Schedule 8'],
    correctAnswer: 2,
    explanation:
  ...
  {
    id: 8,
    question: 'What is the DERM checklist used for in occupational health surveillance?',
    options: [
...
export default function CoshhAwarenessModule5Section2() {
  useSEO({
    title: 'Health Surveillance | COSHH Awareness Module 5.2',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>COSHH Reg 11:</strong> Requires health surveillance when exposure creates an
                identifiable health risk
              </li>
              <li>
                <strong>Schedule 6:</strong> Lists substances requiring formal medical surveillance
                by an appointed doctor
              </li>
              <li>
                <strong>40 years:</strong> Health records must be retained for 40 years from the
                date of the last entry
              </li>
              <li>
                <strong>Early detection:</strong> The goal is to catch work-related ill health
                before it becomes irreversible
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            <p className="text-violet-400 text-base font-medium mb-2">For Electricians</p>
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Isocyanates:</strong> Spray foam insulation &mdash; Schedule 6 medical
                surveillance required
              </li>
              <li>
                <strong>Colophony/flux:</strong> Soldering fumes &mdash; respiratory questionnaire +
                spirometry
              </li>
              <li>
                <strong>Solvents:</strong> Cable jointing resins &mdash; biological monitoring may
                apply
              </li>
              <li>
                <strong>Duty to attend:</strong> Employees must present themselves for health
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Health surveillance is a system of <strong>ongoing health checks</strong> designed
                to detect early signs of work-related ill health in employees who are exposed to
                hazardous substances. It is a legal requirement under{' '}
                <strong>COSHH Regulation 11</strong> when specific conditions are met.
              </p>

              <p>
                The fundamental purpose of health surveillance is <strong>prevention</strong>. It is
                not about diagnosing diseases after they have become established &mdash; it is about
                identifying the earliest possible indicators of harm so that action can be taken
                before the condition becomes serious, chronic, or irreversible.
              </p>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Provide data to evaluate the effectiveness of control measures
                      </strong>{' '}
                      &mdash; if workers are developing symptoms despite controls being in place,
                      those controls are inadequate
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      ...
                      &mdash; for example, those who develop sensitisation to a substance
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Provide a feedback loop</strong> &mdash;
                      surveillance results inform risk assessments, triggering improvements to
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  it is appropriate for the protection of their health. This is not discretionary
                  &mdash; once the conditions triggering health surveillance are met, it becomes a{' '}
                  <strong className="text-white">legally enforceable duty</strong>.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  Health surveillance is specifically targeted at detecting work-related ill health
                  caused by hazardous substance exposure. It is not general health screening (such
                  as blood pressure checks or lifestyle assessments). It must be linked to specific
                  workplace exposures identified in the COSHH risk assessment.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Health surveillance is not required for every hazardous substance exposure. It is
                required when <strong>all four of the following conditions</strong> are met
                simultaneously. If any one condition is absent, health surveillance is not legally
                required (although employers may still choose to provide it as good practice).
              </p>
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        There must be a known disease or adverse health effect that is associated
                        with the substance in question. For example, isocyanates are known to cause
                        occupational asthma; solvents are known to cause dermatitis. If there is no
                        identifiable health effect linked to the substance, health surveillance
                        cannot be targeted.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        A reliable, validated method must exist to detect the condition. For
                        occupational asthma, serial peak expiratory flow (PEF) measurement is a
                        valid technique. For dermatitis, structured skin inspection is valid. If no
                        reliable detection method exists for a particular effect, surveillance
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Reasonable Likelihood of Occurrence</p>
                      <p>
                        The disease or effect must be reasonably likely to occur under the actual
                        conditions of work. This takes into account the nature of the substance, the
                        exposure level, the duration and frequency of exposure, and the
                        effectiveness of existing controls. If exposure is so minimal that the risk
                        is negligible, surveillance may not be justified.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        The surveillance must serve a genuine protective purpose. There must be a
                        realistic prospect that the results of surveillance will lead to actions
                        that improve employee health &mdash; such as early removal from exposure,
                        improved controls, or medical treatment. Surveillance that cannot lead to
                        any meaningful action is not required.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  Health surveillance does not require proof that employees will develop ill health.
                  It requires a <strong className="text-white">reasonable possibility</strong> that
                  ill health could develop under the current working conditions. If in doubt, the
                  COSHH ACOP (Approved Code of Practice) states that surveillance should be
                  provided.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                COSHH Schedule 6 lists specific substances and processes where formal{' '}
                <strong>
                  medical surveillance by an Employment Medical Adviser (EMA) or a doctor appointed
                  by the HSE
                </strong>{' '}
                is mandatory. This is the highest level of health surveillance and requires
                examination by a qualified medical professional &mdash; not just a responsible
                person or occupational health nurse.
              </p>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  Schedule 6 medical surveillance is a specific legal requirement that sits above
                  the general health surveillance duty in Regulation 11. If a substance is listed in
                  Schedule 6, medical surveillance by an EMA or appointed doctor is mandatory
                  regardless of the employer&rsquo;s own assessment of risk. The employer cannot
                  substitute a lower level of surveillance (such as a questionnaire) for a Schedule
                  6 substance.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Health surveillance ranges from simple checks that can be performed by a trained
                non-medical person on site, through to complex clinical investigations by
                specialists. HSG61 (Health Surveillance at Work) describes{' '}
                <strong>six levels</strong> of health surveillance, each appropriate to different
                circumstances.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Initial Assessment (Baseline)</p>
                      <p>
                        Conducted <strong className="text-white">before exposure begins</strong>.
                        Establishes the worker&rsquo;s baseline health status so that any future
                        changes can be measured against it. Includes a health questionnaire, basic
                        measurements (e.g. lung function), and a record of any pre-existing
                        conditions relevant to the exposure. Without a baseline, it is impossible to
                        determine whether later findings are caused by work or pre-date employment.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Skin Inspection</p>
                      <p>
                        A <strong className="text-white">trained responsible person</strong> (not
                        necessarily a medical professional) carries out regular visual inspections
                        of exposed skin &mdash; typically hands, wrists, and forearms. They look for
                        the early signs of contact dermatitis: dryness, redness, cracking, itching,
                        or blistering. Any abnormalities are referred to an occupational health
                        professional. This is the most common surveillance method for workers
                        exposed to skin irritants and sensitisers.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Respiratory Questionnaire</p>
                      <p>
                        A standardised questionnaire administered by a{' '}
                        <strong className="text-white">trained person</strong> to identify early
                        symptoms of occupational asthma or other respiratory conditions. Questions
                        cover wheeze, breathlessness, chest tightness, cough, and whether symptoms
                        improve on days away from work. A &ldquo;yes&rdquo; answer to key questions
                        triggers referral to an occupational health professional for further
                        investigation.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Lung Function Testing (Spirometry)</p>
                      <p>
                        Objective measurement of lung function using a{' '}
                        <strong className="text-white">spirometer</strong>. The two key measurements
                        are <strong className="text-violet-400">FEV1</strong> (Forced Expiratory
                        Volume in 1 second) and <strong className="text-violet-400">FVC</strong>{' '}
                        (Forced Vital Capacity). A baseline measurement is taken before exposure,
                        and periodic measurements are compared against it. A declining trend or
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Clinical Examination</p>
                      <p>
                        A physical examination conducted by an{' '}
                        <strong className="text-white">occupational health professional</strong>{' '}
                        (doctor or specialist nurse). This goes beyond questionnaires and basic
                        measurements to include a thorough clinical assessment. Used for substances
                        that cause systemic effects (affecting organs beyond the point of initial
                        contact) and for all COSHH Schedule 6 substances.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Biological Effect Monitoring</p>
                      <p>
                        Laboratory analysis of{' '}
                        <strong className="text-white">blood or urine samples</strong> to measure
                        the level of a hazardous substance (or its metabolites) in the body, or to
                        detect biological effects of exposure. For example, blood lead levels for
                        lead exposure, or urine toluene-diamine levels for isocyanate exposure. This
                        provides objective, quantifiable evidence of absorption and is the most
                        precise form of surveillance.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-500">Choosing the Right Level:</strong> The
                  appropriate level of health surveillance depends on the substance, the severity of
                  the potential health effect, the exposure level, and whether the substance is
                  listed in COSHH Schedule 6. The COSHH risk assessment should specify which level
                  of surveillance is required for each exposure. Multiple levels may be used
                  together &mdash; for example, a respiratory questionnaire combined with spirometry
                  for workers exposed to respiratory sensitisers.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>ongoing programme</strong> that begins before exposure starts and continues
                for as long as the employee remains at risk. The programme follows a structured
                cycle from baseline through periodic monitoring to action when abnormalities are
                detected.
              </p>
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Before the employee begins work involving hazardous substance exposure, a
                        baseline health assessment is conducted. This records the worker&rsquo;s
                        current health status including any pre-existing conditions (e.g. childhood
                        asthma, eczema). Baseline spirometry is performed if respiratory
                        surveillance is required. This baseline is the reference point for all
                        future comparisons.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Periodic Checks</p>
                      <p>
                        Regular health checks are conducted at intervals determined by the substance
                        and risk level. For isocyanates (Schedule 6), medical surveillance is
                        required <strong className="text-white">at least every 12 months</strong>.
                        For skin surveillance, inspections may be weekly or monthly depending on the
                        risk. For respiratory questionnaires, 6&ndash;12 monthly intervals are
                        typical. The COSHH risk assessment specifies the frequency.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Return-to-Work Assessment</p>
                      <p>
                        When an employee returns after a period of illness &mdash; particularly
                        illness that may be work-related &mdash; a return-to-work health assessment
                        determines whether they can safely resume the same exposure level.
                        Adjustments may include temporary or permanent redeployment, enhanced
                        controls, reduced exposure duration, or additional PPE.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        the employee must be referred to an occupational health professional without
                        delay. The referral pathway typically follows this sequence: responsible
                        person identifies abnormality &rarr; occupational health nurse assessment
                        &rarr; occupational health physician review &rarr; specialist referral if
                        needed &rarr; employee removed from exposure pending investigation.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  Any worker who develops breathing difficulties, persistent cough, skin irritation,
                  or other symptoms that may be work-related should report immediately to their
                  supervisor and be referred to occupational health. Health surveillance
                  appointments are scheduled checks &mdash; they do not replace the duty to report
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-white mb-6 flex items-center gap-3">
            <span className="text-violet-500/80 text-sm font-normal">&mdash;</span>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>COSHH Regulation 11(4)</strong> imposes strict requirements on how health
                surveillance records are maintained, stored, and made available. Because
                occupational diseases can take decades to manifest, the retention requirements are
                amongst the longest in UK health and safety law.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Gender and National Insurance number</strong>{' '}
                      &mdash; for traceability if the employee changes employer
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">The result of the surveillance</strong> &mdash;
                      recorded as &ldquo;fit&rdquo;, &ldquo;fit with conditions&rdquo;, or
                      &ldquo;unfit&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">The hazardous substance(s) involved</strong>{' '}
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  the HSE for safekeeping. This is one of the longest record-retention periods in UK
                  law and reflects the long latency of many occupational diseases. The 40-year
                  period ensures records remain available for diagnosis, compensation claims, and
                  epidemiological research long after the employee has left the organisation.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Employee access:</strong> Each employee has the
                      right to see their own health surveillance records upon request. The employer
                      must make records available without unreasonable delay.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">HSE access:</strong> An HSE inspector may
                      require the employer to produce health surveillance records during an
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Data Protection Act 2018 / UK GDPR:</strong>{' '}
                      Health surveillance records are{' '}
                      <strong className="text-white">special category data</strong> (health data).
                      They must be processed lawfully, stored securely, and access must be
                      restricted to authorised persons. The employer must have a lawful basis for
                      processing (typically &ldquo;legal obligation&rdquo; under COSHH) and must
                      comply with all UK GDPR requirements including data minimisation, storage
                      limitation (subject to the 40-year rule), and the individual&rsquo;s rights of
                      access.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Confidentiality:</strong> Clinical details
                      (specific diagnoses, test values) are confidential to the occupational health
                      provider. The employer is only entitled to the fitness outcome &mdash;
                      &ldquo;fit&rdquo;, &ldquo;fit with conditions&rdquo;, or &ldquo;unfit&rdquo;
                      &mdash; not the underlying medical details.
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="min-w-[300px] max-w-xl mx-auto">
              ...
              <div className="space-y-3">
                ...
                <div className="border-2 border-green-500/30 rounded-lg bg-green-500/5 p-3 sm:p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-sm font-medium text-green-400">Normal Pattern</p>
                  </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 rounded-lg p-3 mt-3">
                <p className="text-xs sm:text-sm text-white/80">
                  ...
                  individual readings remain within normal limits, a consistent downward trend may
                  indicate developing airway disease.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Occupational asthma and contact dermatitis are the two most common occupational
                diseases that health surveillance under COSHH is designed to detect. Both are highly
                relevant to electricians.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <p>
                    ...
                    Once sensitised, the worker will react to extremely low levels of the substance
                    &mdash; often far below the WEL. Sensitisation is usually{' '}
                  ...
                  <div className="bg-violet-500/10 border border-violet-500/20 rounded p-3">
                    ...
                    <ul className="space-y-1.5 text-xs text-white/70">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          <strong className="text-white">Respiratory questionnaire:</strong>{' '}
                          Standardised questions about wheeze, breathlessness, chest tightness, and
                          whether symptoms improve on rest days. Administered 6&ndash;12 monthly.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Peak flow diary:</strong> The worker
                          records peak expiratory flow (PEF) readings at least four times per day
                          over a minimum of 2&ndash;4 weeks, including both work days and rest days.
                          A pattern where PEF drops during work periods and improves on rest days is
                          strongly suggestive of occupational asthma.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Serial PEF analysis:</strong> Specialist
                          software (e.g. OASYS) is used to analyse the peak flow diary data and
                          determine whether a work-related pattern exists. This provides objective
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Specific IgE testing:</strong> A blood test
                          measuring specific immunoglobulin E antibodies to the suspected
                          sensitiser. A positive result confirms sensitisation to the substance.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Spirometry:</strong> FEV1/FVC measurements
                          taken at baseline and periodically. A declining FEV1 or a reduced FEV1/FVC
                          ratio (&lt; 0.70) supports an obstructive pattern consistent with asthma.
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-red-500/10 border border-red-500/20 rounded p-3">
                    <p className="text-xs text-white/80">
                      ...
                      <strong className="text-white">soldering with rosin-cored solder</strong>{' '}
                      (releasing colophony/rosin fumes) are at particular risk. Both isocyanates and
                      colophony are potent respiratory sensitisers.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <p>
                    ...
                    and affects electricians who handle solvents, fluxes, adhesives, oils, and
                    cement.
                  </p>
                  ...
                  <div className="bg-white/5 border border-white/10 rounded p-3">
                    ...
                    <ul className="space-y-1.5 text-xs text-white/70">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Inspect{' '}
                          <strong className="text-white">hands, wrists, and forearms</strong>{' '}
                          &mdash; the areas most commonly in contact with hazardous substances
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>
                          Look between fingers and around nail beds where dermatitis often begins
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>
                          Compare left and right hands &mdash; asymmetric changes may indicate
                          contact dermatitis from a specific work task
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Any abnormality</strong> triggers referral
                          to occupational health &mdash; do not wait for the next scheduled check
                        </span>
                      </li>
                    </ul>
                  </div>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-3">
            ...
            Employee &amp; Employer Duties, and Electrician-Specific Exposures
          </h2>
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Health surveillance is a <strong>shared responsibility</strong>. The employer has
                duties to provide, fund, and act on the results of health surveillance. The employee
                has a duty to attend and co-operate.
              </p>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; appointments, tests, specialist referrals, and employee time to attend
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Act on the results:</strong> if surveillance
                      reveals ill health, the employer must take immediate action &mdash; which may
                      include removing the employee from further exposure, investigating the cause,
                      improving control measures, reviewing the risk assessment, and reporting to
                      the HSE under RIDDOR if the condition is work-related
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Consider redeployment</strong> &mdash; if the
                      employee can no longer safely work with the substance, alternative duties must
                      be explored. Dismissal is a last resort, not a first response.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Maintain records for 40 years</strong> and make
                      them available to the employee and the HSE
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Review the surveillance programme</strong>{' '}
                      whenever the risk assessment changes, new substances are introduced, or
                      surveillance results indicate that current arrangements are inadequate
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Attend health surveillance</strong> when it has
                      been identified as necessary &mdash; this is a legal duty under COSHH
                      Regulation 11(5)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; answer questionnaires honestly, perform spirometry tests as
                      instructed, and present skin for inspection when requested
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Report symptoms promptly</strong> &mdash; do
                      not wait for the next scheduled check if you develop breathing difficulties,
                      skin irritation, or other symptoms that may be work-related
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Follow any restrictions</strong> imposed as a
                      result of surveillance &mdash; such as avoiding certain substances or using
                      additional PPE
                    </span>
                  </li>
                </ul>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-white/60 mt-0.5">
                          ...
                          spray foam insulation is being applied, or working in recently sprayed
                          areas, are at risk.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-white/60 mt-0.5">
                          ...
                          diary if symptoms are suspected. Affects electricians doing regular
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-white/60 mt-0.5">
                          ...
                          possibly biological monitoring may be required depending on the specific
                          solvents and exposure levels.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-white/60 mt-0.5">
                          ...
                          appropriate. Some hardeners also contain isocyanates, triggering Schedule
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  The employer is required to investigate the cause, review and improve control
                  measures, consider whether other employees may also be affected, and report the
                  condition under RIDDOR if it is work-related. Failure to act on health
                  surveillance results defeats the entire purpose of the programme and may
                  constitute a breach of COSHH Regulation 11.
                </p>
              </div>
            </div>
          </div>
