...
const examFeatures = [
  ...
  { icon: ShieldCheck, label: '80% pass mark (16/20)', description: 'Matches the standard required by COSHH awareness assessments.' },
...
const preparationTips = [
  { title: 'Know the COSHH Regulations 2002', description: 'Understand the legal duties on employers and employees, the eight steps of a COSHH assessment, and how the regulations link to the Health and Safety at Work Act 1974.' },
  { title: 'Learn the GHS pictograms', description: 'All nine GHS hazard pictograms are heavily tested. Know what each red-bordered diamond means, including health hazard, corrosive, flammable and environment symbols.' },
  { title: 'Understand routes of exposure', description: 'Inhalation, ingestion, skin absorption and injection — know which route is most common in construction and why respiratory protection is often the priority.' },
  { title: 'Master the hierarchy of control', description: 'Elimination, substitution, engineering controls, administrative controls, then PPE. Know real examples of each level and why PPE is always the last resort.' },
  { title: 'Know your RPE & PPE', description: 'Understand assigned protection factors, the difference between filtering and supplied-air RPE, face-fit testing requirements, and how to select the right gloves for different chemicals.' },
  ...
  return (
    <div className="min-h-screen bg-[hsl(0_0%_8%)] text-white">
      <div className="px-4 sm:px-6 lg:px-8 pt-2 pb-24">
        <PageFrame>
          <button
            onClick={() => navigate('../coshh-awareness-course')}
            className="inline-flex items-center gap-2 h-10 px-3 rounded-full bg-white/[0.06] border border-white/[0.1] text-white text-[13px] font-medium touch-manipulation hover:bg-white/[0.1] mb-1 self-start"
          >
            <ArrowLeft className="h-4 w-4" /> COSHH awareness
          </button>

          <PageHero
            eyebrow="Module 6 · Final assessment"
            title="Mock exam"
            description="Put your COSHH awareness knowledge to the test under timed exam conditions. Questions are drawn from a 200-question bank covering all five content modules."
            tone="purple"
          />
          ...
          <Link
            to="../coshh-awareness-mock-exam"
            className="block touch-manipulation focus:outline-none"
          >
            <div className="rounded-2xl bg-gradient-to-br from-purple-500/15 via-violet-500/10 to-transparent border border-purple-500/30 p-5 sm:p-6 active:scale-[0.99] transition-transform">
              <div className="flex items-center justify-between gap-3">
                ...
                <PrimaryButton size="lg" onClick={() => navigate('../coshh-awareness-mock-exam')}>
                ...
                <ListRow
                  ...
                  lead={
                    <div className="h-7 w-7 rounded-full bg-purple-500/10 border border-purple-500/30 flex items-center justify-center shrink-0">
                      <span className="text-[11px] font-bold text-purple-400">{i + 1}</span>
                    </div>
                  }
                  title={tip.title}
