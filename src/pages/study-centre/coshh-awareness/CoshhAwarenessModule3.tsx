...
export default function CoshhAwarenessModule3() {
  useSEO({
    ...
    description:
      'Identify hazardous substances commonly found on construction sites and in the electrical trade, including dust, fumes, chemicals, and biological hazards.',
  });
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-white text-sm sm:text-base">
              The real-world hazardous substances you will encounter on construction sites and in
              the electrical trade — and how to control dust, fumes, and biological risks
            </p>
          </div>
