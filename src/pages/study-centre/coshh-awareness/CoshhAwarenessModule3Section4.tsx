...
const faqs = [
  ...
  {
    question: "What is the difference between Legionnaires' disease and Pontiac fever?",
    answer:
...
export default function CoshhAwarenessModule3Section4() {
  useSEO({
    title: 'Biological & Environmental Hazards | COSHH Awareness Module 3.4',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Biological agents:</strong> Bacteria, viruses, fungi, parasites, prions
              </li>
              <li>
                <strong>Key risks:</strong> Leptospirosis, Legionella, mould, sewage, sharps
              </li>
              <li>
                <strong>Classification:</strong> 4 Hazard Groups (ACDP) &mdash; Group 1 to Group 4
              </li>
              <li>
                <strong>Primary control:</strong> Hygiene, PPE, vaccination, welfare facilities
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Cover cuts:</strong> Waterproof dressings on all wounds before starting work
              </li>
              <li>
                <strong>Wash hands:</strong> Before eating, drinking, or smoking &mdash; always
              </li>
              <li>
                <strong>Sharps:</strong> Never pick up discarded needles by hand
              </li>
              <li>
                <strong>Report:</strong> Flu-like symptoms after site work &mdash; mention your
                occupation
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Biological agents</strong> are micro-organisms, cell cultures, or human
                endoparasites that may cause infection, allergy, toxicity, or other harm to human
                health. Under the{' '}
                <strong>Control of Substances Hazardous to Health Regulations 2002 (COSHH)</strong>,
                biological agents are classified as hazardous substances and must be risk-assessed
                and controlled in the same way as chemical hazards.
              </p>
              ...
              <p>
                On construction sites, biological agents are not manufactured or deliberately used
                &mdash; instead, workers are <strong>incidentally exposed</strong> through contact
                with contaminated water, soil, animal droppings, sewage, or discarded sharps. This
                makes biological hazards easy to overlook, but the consequences of exposure can be
                severe and sometimes fatal.
              </p>

              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Key Point:</strong> Unlike chemical hazards,
                  biological agents can <strong>multiply and spread</strong>. A small initial
                  exposure can lead to infection, which the body then hosts and amplifies. This
                  means that even brief contact with a contaminated substance can cause serious
                  illness days or weeks later.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Advisory Committee on Dangerous Pathogens (ACDP)</strong> classifies
                biological agents into four Hazard Groups based on their ability to cause human
                disease, the likelihood of spread to the community, and whether effective treatment
                or prophylaxis is available. This classification determines the level of containment
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      . They pose minimal risk and require only basic hygiene controls. Most
                      environmental micro-organisms fall into this category.
                    </p>
                  </div>
                  ...
                  <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                    ...
                    <p className="text-sm text-white/80 mb-2">
                      ...
                      <strong className="text-white">
                        no effective prophylaxis or treatment is usually available
                      </strong>
                      .
                    </p>
                    <p className="text-xs text-white/60">
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Construction Site Context:</strong> The
                  biological agents most commonly encountered on construction sites are{' '}
                  <strong>Hazard Group 2</strong> organisms &mdash; agents such as Leptospira,
                  Legionella, and E. coli. However, exposure to <strong>Hazard Group 3</strong>{' '}
                  agents (such as hepatitis B and C through sharps injuries) is possible, which is
                  why control measures, PPE, and vaccination are so important.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Leptospirosis</strong> is a bacterial infection caused by{' '}
                <em>Leptospira</em> bacteria, which are carried in the urine of infected animals
                &mdash; primarily <strong>rats</strong>, but also cattle, pigs, and dogs. The
                bacteria can survive in water and damp soil for weeks. The severe form of
                leptospirosis is known as <strong>Weil&rsquo;s disease</strong>, which can cause
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  rat activity,{' '}
                  <strong>
                    seek medical attention immediately and tell the doctor about your work
                  </strong>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-amber-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Weil&rsquo;s disease:</strong> Jaundice,
                        kidney pain, internal bleeding
                      </span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1.5">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Cover ALL cuts, abrasions, and skin conditions with waterproof dressings
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                      <span>
                        Wear waterproof gloves and boots when working in water or near drains
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-green-400 flex-shrink-0" />
                      <span>
                        Wash hands thoroughly with soap and water before eating, drinking, or
                        smoking
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Legionella pneumophila</strong> is a bacterium that lives in water systems
                and can cause <strong>Legionnaires&rsquo; disease</strong> &mdash; a serious and
                potentially fatal form of pneumonia. The bacterium is transmitted by{' '}
                <strong>inhaling contaminated water droplets</strong> (aerosol), NOT by drinking
                contaminated water or person-to-person contact.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  <Droplets className="h-5 w-5 text-violet-400" />
                  <p className="text-sm font-medium text-violet-400">Where Legionella Thrives</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-20 sm:w-24 text-right">
                      <span className="text-xs font-bold text-red-400">70&deg;C+</span>
                    </div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-20 sm:w-24 text-right">
                      <span className="text-xs font-bold text-orange-400">60&deg;C</span>
                    </div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-20 sm:w-24 text-right">
                      <span className="text-xs font-bold text-amber-400">50&deg;C</span>
                    </div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-20 sm:w-24 text-right">
                      <span className="text-xs font-bold text-red-400">20&ndash;45&deg;C</span>
                    </div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-20 sm:w-24 text-right">
                      <span className="text-xs font-bold text-blue-400">&lt;20&deg;C</span>
                    </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Why This Matters to Electricians:</strong>{' '}
                  Electricians frequently work in plant rooms, boiler rooms, and mechanical services
                  areas where hot and cold water systems, cooling towers, and water storage tanks
                  are located. If you are working near water systems and notice a shower head, tap,
                  or outlet that has not been used for a long time (dead leg), or if you notice
                  water temperatures that seem to be in the danger zone (lukewarm water from a
                  &ldquo;hot&rdquo; tap), report it to the building manager. You should{' '}
                  <strong>
                    never turn on a shower or tap that has been unused for a prolonged period
                  </strong>{' '}
                  without checking with the responsible person first &mdash; the initial aerosol
                  from a stagnant outlet can contain high concentrations of Legionella.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Construction and renovation work frequently disturbs mould, fungi, and other
                biological contaminants that have accumulated in damp, neglected, or flood-damaged
                buildings. Additionally, work in or near drainage systems exposes workers to raw or
                partially treated sewage containing a wide range of pathogenic organisms.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 mb-3">
                  ...
                  healthy individuals, the body&rsquo;s immune system usually deals with the spores
                  without problem. However, in{' '}
                  <strong className="text-white">immunocompromised workers</strong> (those on
                  immunosuppressant medication, chemotherapy, or with conditions such as HIV),
                  Aspergillus infection (aspergillosis) can be serious and life-threatening.
                </p>
                <div className="grid sm:grid-cols-2 gap-3">
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  to date. <strong className="text-white">Hepatitis B</strong> vaccination may also
                  be considered depending on the risk assessment, particularly if there is a risk of
                  contact with sharps or blood-contaminated materials. Discuss your work activities
                  with your occupational health provider to determine which vaccinations are
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="mt-3 bg-violet-500/10 border border-violet-500/30 p-3 rounded-lg">
                  <p className="text-xs text-white">
                    <strong className="text-violet-400">Cleaning Procedure:</strong> Dampen
                    droppings with water before disturbing them to suppress dust. Wear an FFP3
                    respirator and disposable coveralls. Do NOT dry-sweep bird droppings. Place
                    contaminated material in sealed bags for disposal. Wash hands and exposed skin
                    thoroughly afterwards. If large accumulations of droppings are found, a
                    specialist cleaning contractor may be required.
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-sm text-white/80">
                      ...
                      Tetanus causes severe muscle spasms and can be fatal. Vaccination provides
                      effective protection, and most UK adults will have been vaccinated through the
                      childhood immunisation programme. If you sustain a contaminated wound and are
                      unsure of your vaccination status, seek medical advice promptly.
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-white/80">
                      ...
                      industrial sites that previously processed animal hides, wool, or bone meal
                      (such as former tanneries or mills). Contaminated land assessments should
                      identify this risk before work begins.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Sharps on Site &mdash; Prevention:</strong>{' '}
                  Never pick up discarded needles by hand, even with gloves. Use tongs or a
                  mechanical pick-up tool and place sharps in a proper rigid-walled{' '}
                  <strong>sharps container (yellow, conforming to BS 7320)</strong>. Mark and cordon
                  off any area where sharps are found. Report the find to your supervisor. If
                  working in areas where sharps may be present (derelict buildings, urban sites),
                  wear <strong>puncture-resistant gloves</strong> and exercise extreme caution when
                  reaching into concealed spaces.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Beyond the specific biological agents already discussed, construction workers may
                encounter a range of environmental biological hazards depending on the site location
                and conditions.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-black/30 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      damage. Avoid contact with water where blue-green algal blooms are present
                      (often visible as a green or blue-green scum on the surface). If you must work
                      near affected water, wear waterproof PPE and avoid creating spray or splash.
                    </p>
                  </div>
                  <div className="bg-black/30 rounded-lg p-3">
                    <div className="flex items-center gap-2 mb-1">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      rat urine, and organic matter. Ensure adequate drainage, pump out standing
                      water promptly, and avoid direct skin contact.
                    </p>
                  </div>
                  <div className="bg-black/30 rounded-lg p-3">
                    <div className="flex items-center gap-2 mb-1">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      <em>Coxiella burnetii</em> (Q fever from cattle and sheep), and ringworm
                      (dermatophyte fungi from cattle). Avoid contact with animal waste, wash hands
                      thoroughly, and inform your GP of your occupation if you develop unexplained
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Controlling exposure to biological agents follows the same hierarchy of control used
                for all workplace hazards under COSHH. However, the specific control measures for
                biological hazards place a strong emphasis on{' '}
                <strong>hygiene, vaccination, and welfare facilities</strong> &mdash; measures that
                are sometimes overlooked on construction sites.
              </p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-violet-500/10 border border-violet-500/30 rounded-lg p-4">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      contaminated areas during disturbance.
                    </p>
                  </div>
                  ...
                  <div className="bg-violet-500/10 border border-violet-500/30 rounded-lg p-4">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      sewage/wastewater contact, <strong className="text-white">hepatitis B</strong>{' '}
                      where sharps or blood contact is possible,{' '}
                      <strong className="text-white">tetanus</strong> booster if not up to date.
                      Vaccination does NOT replace other controls &mdash; it is an additional
                      safeguard.
                    </p>
                  </div>
                  ...
                  <div className="bg-violet-500/10 border border-violet-500/30 rounded-lg p-4">
                    ...
                    <p className="text-sm text-white/80">
                      ...
                      in water, drains, or sewage.{' '}
                      <strong className="text-white">Disposable coveralls</strong> when working in
                      heavily contaminated areas.{' '}
                      <strong className="text-white">Puncture-resistant gloves</strong> where
                      discarded sharps may be present.{' '}
                      <strong className="text-white">Eye protection</strong> where splashing is
                      possible.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="bg-black/30 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      infrequently used water outlets. Report lukewarm water from &ldquo;hot&rdquo;
                      systems.
                    </p>
                  </div>
                  <div className="bg-black/30 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      respiratory protection if contamination is visible. Bats are a protected
                      species &mdash; stop work and report if bats are found.
                    </p>
                  </div>
                  <div className="bg-black/30 rounded-lg p-3">
                    <p className="text-xs font-medium text-amber-400 mb-1">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      PPE. Wash and disinfect tools after use. Never eat, drink, or smoke in or near
                      the pump station.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Critical Reminder:</strong> If you develop
                  unexplained flu-like symptoms within two weeks of working in any environment where
                  biological hazards may have been present &mdash; drains, sewers, standing water,
                  animal waste, bird droppings, or contaminated soil &mdash;{' '}
                  <strong>seek medical attention and tell the doctor about your work</strong>.
                  Diseases like leptospirosis are often misdiagnosed as common flu because doctors
                  are not told about the patient&rsquo;s occupational exposure. Early diagnosis and
                  treatment can be the difference between a full recovery and a life-threatening
                  complication.
                </p>
              </div>
            </div>
