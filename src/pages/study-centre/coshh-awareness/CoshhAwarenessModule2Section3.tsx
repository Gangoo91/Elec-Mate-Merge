...
const faqs = [
  ...
  {
    question: 'What is the difference between the product label and the Safety Data Sheet?',
    answer:
  ...
  {
    question: 'Can Safety Data Sheets be stored digitally, or do I need paper copies?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 6,
    question: 'Which section of the SDS provides information on workplace exposure limits (WELs)?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>What:</strong> A 16-section document providing comprehensive safety
                information about a hazardous substance
              </li>
              <li>
                <strong>Legal basis:</strong> REACH Regulation (UK REACH) &amp; CLP Regulation
              </li>
              <li>
                <strong>Who provides it:</strong> The manufacturer or supplier &mdash; it is their
                legal duty
              </li>
              <li>
                <strong>Key sections for site:</strong> 2 (hazards), 4 (first-aid), 7 (handling), 8
                (PPE)
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Before first use:</strong> Read the SDS &mdash; especially Sections 2, 7,
                and 8
              </li>
              <li>
                <strong>PPE decisions:</strong> Always based on Section 8, not guesswork
              </li>
              <li>
                <strong>Spill or exposure?</strong> Section 4 (first-aid) and Section 6 (spills)
              </li>
              <li>
                <strong>Accessibility:</strong> SDS must be available at the point of use
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>Safety Data Sheet (SDS)</strong> is a standardised document that provides
                comprehensive information about a hazardous substance or mixture. It is the primary
                source of detailed safety, health, and environmental information for any chemical
                product used in the workplace. Every SDS follows the same 16-section format, making
                it possible to quickly locate specific information regardless of which manufacturer
                or supplier produced the document.
              </p>

              <p>
                The legal requirement to provide an SDS comes from{' '}
                <strong>Article 31 of the REACH Regulation</strong> (Registration, Evaluation,
                Authorisation and Restriction of Chemicals). In the UK, this is retained as{' '}
                <strong>UK REACH (EC 1907/2006 as amended)</strong> following the UK&rsquo;s
                departure from the EU. The format and content requirements for Safety Data Sheets
                are specified in <strong>Annex II of REACH</strong>, which was updated to align with
                the{' '}
                <strong>
                  Globally Harmonised System of Classification and Labelling of Chemicals (GHS)
                </strong>{' '}
                through the <strong>CLP Regulation</strong> (Classification, Labelling and Packaging
                &mdash; EC 1272/2008, retained in UK law as UK CLP).
              </p>

              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Key Point:</strong> The SDS is not an optional
                  document. It is a <strong>legal requirement</strong> under UK REACH. If you are
                  supplied with a hazardous substance and do not receive an SDS, you have the right
                  &mdash; and the duty &mdash; to request one from your supplier. Without an SDS,
                  you cannot carry out an adequate COSHH risk assessment.
                </p>
              </div>

              <p>
                Safety Data Sheets replaced the older &ldquo;Material Safety Data Sheets&rdquo;
                (MSDS). Whilst you may still hear the term MSDS on some sites, the correct and
                current term is <strong>Safety Data Sheet (SDS)</strong>. The key difference is that
                modern SDS documents follow the GHS format with standardised hazard pictograms,
                signal words, and hazard/precautionary statements, making them internationally
                consistent.
              </p>
            </div>
          </div>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>manufacturer, importer, or downstream supplier</strong> of the substance or
                mixture. This is not a discretionary decision &mdash; it is a legal obligation under
                Article 31 of UK REACH. The SDS must be provided <strong>free of charge</strong>,
                either in paper or electronic format, at or before the time of first supply.
              </p>
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">classified as hazardous</strong> under the CLP
                      Regulation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">Candidate List for Authorisation</strong>{' '}
              ...
              <p>
                For <strong>mixtures not classified as hazardous</strong> but containing certain
                hazardous ingredients above specified concentration thresholds, the supplier must
                provide an SDS on request. The supplier must also update and re-issue the SDS
                without delay when new information becomes available that may affect the risk
                management measures or hazard classification.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  work and cannot find the SDS, raise it with your supervisor immediately. An
                  adequate COSHH risk assessment cannot be completed without the information
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every Safety Data Sheet must contain <strong>exactly 16 sections</strong>, presented
                in a fixed order prescribed by Annex II of the REACH Regulation. This standardised
                format means that once you know how to read one SDS, you can read any SDS from any
                supplier for any substance. The sections are:
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    ...
                    <strong className="text-white">first sections to read</strong> &mdash; it gives
                    you the overall hazard picture at a glance.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    ...
                    medical attention required. This is a{' '}
                    <strong className="text-white">critical section</strong> to read before handling
                    any substance.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    ...
                    breakthrough time), eye/face protection, and skin/body protection. This is the{' '}
                    <strong className="text-white">
                      single most important section for determining what protection you need
                    </strong>
                    .
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    ...
                    toxicity, and organ-specific toxicity.
                  </p>
                </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A full SDS can be 20&ndash;40 pages long, which is why many workers never read one.
                But you do not need to read every page from cover to cover. As an on-site worker,
                you need to know{' '}
                <strong>which sections to check and what to look for in each</strong>. Here is a
                practical approach:
              </p>
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Start here. It gives you the overall hazard picture: pictograms, signal
                        word, and the key hazard statements. This tells you <em>what</em> the
                        substance can do to you.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        This tells you <em>how to protect yourself</em>: exposure limits,
                        ventilation requirements, and exact PPE specifications. Never select PPE
                        based on guesswork &mdash; always check Section 8.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Tells you <em>how to use and store it safely</em>: ventilation requirements,
                        ignition source precautions, temperature limits, and incompatible materials
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Section 4 &mdash; First-Aid Measures</p>
                      <p>
                        Tells you <em>what to do if something goes wrong</em>: specific first-aid
                        actions for each route of exposure (eyes, skin, inhalation, ingestion). Know
                        this <em>before</em> you start working, not after an incident.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Tells you <em>what to do if you spill it</em>: personal precautions,
                        containment methods, clean-up procedures, and how to prevent environmental
                        contamination.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Practical Tip:</strong> When you receive a new
                  product on site, take five minutes to scan Sections 2, 7, and 8 of the SDS. Write
                  a quick summary on a toolbox talk card or the COSHH assessment form: &ldquo;Main
                  hazards &rarr; PPE needed &rarr; Key precautions.&rdquo; This takes far less time
                  than dealing with an exposure incident.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Globally Harmonised System (GHS)</strong> uses{' '}
                <strong>nine standardised hazard pictograms</strong> &mdash; red-bordered diamond
                shapes with black symbols on a white background. These pictograms appear on both the
                product label and in Section 2 of the SDS. They provide an immediate visual
                ...
                <div className="p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                  {[
                    ...
                    },
                    {
                      ...
                      example: 'PVC solvent cement, contact cleaner sprays, isopropyl alcohol',
                    ...
                    },
                    {
                      ...
                      example: 'Certain cleaning agents containing sodium hypochlorite',
                      signal: 'Danger / Warning',
                    },
                    {
                      code: 'GHS04',
                      ...
                      example: 'Compressed air canisters, refrigerant gases in HVAC systems',
                      signal: 'Warning',
                    },
                    {
                      code: 'GHS05',
                      ...
                      example: 'Battery acid, certain drain cleaners, strong flux solutions',
                      signal: 'Danger',
                    },
                    {
                      code: 'GHS06',
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  categories (fatal/toxic) and always carries the signal word &ldquo;Danger&rdquo;.
                  GHS07 covers the less severe category (harmful) and carries &ldquo;Warning&rdquo;.
                  If a substance qualifies for GHS06, the GHS07 pictogram is <strong>not</strong>{' '}
                  used alongside it for the same hazard.
                </p>
              </div>

              <p>
                A single product may display <strong>multiple pictograms</strong> if it has more
                than one type of hazard. For example, PVC solvent cement commonly displays both the{' '}
                <em>flame</em> (GHS02 &mdash; flammable) and the <em>exclamation mark</em> (GHS07
                &mdash; irritant/harmful) pictograms. Always check all pictograms on the label and
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>standardised coded statements</strong> to describe hazards and recommended
                precautions. These appear on the product label and in Section 2 of the SDS.
              </p>
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      Examples: H220 &ldquo;Extremely flammable gas&rdquo;, H225 &ldquo;Highly
                      flammable liquid and vapour&rdquo;, H228 &ldquo;Flammable solid&rdquo;, H270
                      &ldquo;May cause or intensify fire; oxidiser&rdquo;, H280 &ldquo;Contains gas
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">H3xx &mdash; Health hazards.</strong> Examples:
                      H301 &ldquo;Toxic if swallowed&rdquo;, H315 &ldquo;Causes skin
                      irritation&rdquo;, H319 &ldquo;Causes serious eye irritation&rdquo;, H332
                      &ldquo;Harmful if inhaled&rdquo;, H334 &ldquo;May cause allergy or asthma
                      symptoms or breathing difficulties if inhaled&rdquo;, H350 &ldquo;May cause
                      cancer&rdquo;, H361 &ldquo;Suspected of damaging fertility or the unborn
                      child&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      Examples: H400 &ldquo;Very toxic to aquatic life&rdquo;, H410 &ldquo;Very
                      toxic to aquatic life with long lasting effects&rdquo;, H411 &ldquo;Toxic to
                      aquatic life with long lasting effects&rdquo;
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">P1xx &mdash; Prevention.</strong> Actions to
                      take to prevent exposure or accidents. Examples: P210 &ldquo;Keep away from
                      heat, hot surfaces, sparks, open flames and other ignition sources. No
                      smoking&rdquo;, P260 &ldquo;Do not breathe
                      dust/fume/gas/mist/vapours/spray&rdquo;, P280 &ldquo;Wear protective
                      gloves/protective clothing/eye protection/face protection&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">P3xx &mdash; Response.</strong> What to do if
                      exposure or an incident occurs. Examples: P301+P310 &ldquo;IF SWALLOWED:
                      Immediately call a POISON CENTRE/doctor&rdquo;, P305+P351+P338 &ldquo;IF IN
                      EYES: Rinse cautiously with water for several minutes. Remove contact lenses,
                      if present and easy to do. Continue rinsing&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">P4xx &mdash; Storage.</strong> How to store the
                      substance safely. Examples: P403 &ldquo;Store in a well-ventilated
                      place&rdquo;, P403+P235 &ldquo;Store in a well-ventilated place. Keep
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">P5xx &mdash; Disposal.</strong> How to dispose
                      of the substance and its container safely. Example: P501 &ldquo;Dispose of
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <p>
                Every hazardous substance must carry a <strong>CLP-compliant label</strong> on its
                container. The label is the first line of communication &mdash; it provides the key
                hazard information at a glance. The label elements are drawn directly from the
                information in the SDS and must include:
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Product identifier</strong> &mdash; the trade
                      name and/or chemical name
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">GHS hazard pictograms</strong> &mdash; the red
                      diamond symbols applicable to the product
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Signal word</strong> &mdash;
                      &ldquo;Danger&rdquo; or &ldquo;Warning&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazard statements (H-codes)</strong> &mdash;
                      describing the nature and degree of the hazard
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Precautionary statements (P-codes)</strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Supplier identification</strong> &mdash; name,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Nominal quantity</strong> &mdash; the amount of
              ...
              <p>
                Think of the label as the <strong>quick reference card</strong> and the SDS as the{' '}
                <strong>full technical manual</strong>. The label gives you enough information to
                handle the substance with basic precautions; the SDS gives you the complete picture
                needed for risk assessment, emergency response, and long-term health management.
              </p>

              <h3 className="text-lg font-medium text-white pt-4">Common SDS for Electricians</h3>
              <p>
                Electricians regularly work with substances that require an SDS. Here are four of
                the most common:
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg space-y-4">
                <div>
                  ...
                  <p className="text-sm text-white">
                    ...
                    <strong>serious eye irritation</strong> (H319). Pictograms: flame (GHS02) and
                    exclamation mark (GHS07). Requires adequate ventilation, no ignition sources,
                    and eye protection.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    ...
                    (H319). Some silicone-based lubricants may contain solvents with additional
                    flammability hazards. Always check the specific product&rsquo;s SDS.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    ...
                    <strong>may cause drowsiness or dizziness</strong> (H336), and{' '}
                    <strong>harmful if inhaled</strong>. Pictograms: flame (GHS02) and exclamation
                    mark (GHS07). Use in ventilated areas, away from ignition sources. Never spray
                    onto live circuits.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-white">
                    ...
                    <strong>respiratory irritation</strong> (H335). Neutral-cure variants are
                    generally less irritating. Pictogram: exclamation mark (GHS07). Ensure
              ...
              <p>
                ...
                <strong>
                  readily accessible to all workers who use or may be exposed to hazardous
                  substances
                </strong>
                . This means they must be available at the point of use &mdash; not locked in an
                office that workers cannot access during their shift.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Digital storage</strong> &mdash; SDS documents
                      can be stored on tablets, computers, shared drives, or cloud-based SDS
                      management systems. This makes it easier to keep documents current and
                      searchable. Many suppliers provide SDS downloads from their websites.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Paper storage</strong> &mdash; physical folders
                      or binders kept in a known, accessible location (e.g. the site office, welfare
                      unit, or COSHH cupboard). Paper copies provide a reliable backup when digital
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Best practice</strong> &mdash; use a digital
                      system as the primary repository (easy to update, search, and distribute) with
                      paper copies available as a backup for locations with poor connectivity. All
                      workers should know where to find the SDS collection and how to access it.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Version Control:</strong> Always check the
                  date and version number in Section 16 of the SDS. Suppliers must update the SDS
                  when new information becomes available. If your copy is more than a few years old,
                  contact the supplier for the latest version. Using an out-of-date SDS for a COSHH
                  risk assessment could mean that your control measures are based on incorrect or
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>foundation of chemical safety management in the workplace</strong>. Every
                time you use a hazardous substance, the SDS provides the information you need to
                protect yourself, your colleagues, and the environment. Here is how the key elements
                connect in practice:
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Obtain the SDS Before Use</p>
                      <p>
                        Before any hazardous substance is brought onto site or used for the first
                        time, the SDS must be obtained from the supplier. This is the
                        employer&rsquo;s responsibility, but every worker should check that the SDS
                        is available.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Read the Key Sections</p>
                      <p>
                        Check Sections 2, 4, 7, and 8 to understand the hazards, first-aid measures,
                        safe handling practices, and PPE requirements. This should take no more than
                        five minutes for a familiar product type.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Feed Into the COSHH Assessment</p>
                      <p>
                        The SDS provides the raw hazard data needed for the COSHH risk assessment.
                        Section 8 gives you the exposure limits and PPE specifications; Section 2
                        gives you the hazard classification; Section 7 gives you the handling and
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Implement the Controls</p>
                      <p>
                        Based on the SDS and the COSHH assessment, put the required controls in
                        place: engineering controls (ventilation), administrative controls (safe
                        working procedures), and PPE. Ensure all workers using the substance are
                        briefed.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Know the Emergency Procedures</p>
                      <p>
                        Sections 4 (first-aid) and 6 (spill response) provide the emergency
                        information. Everyone using the substance should know what to do in the
                        event of skin contact, eye contact, inhalation, or a spill &mdash; before an
                        incident occurs.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Dispose Correctly</p>
                      <p>
                        Section 13 tells you how to dispose of the substance and its container.
                        Never pour chemicals down drains or put them in general waste. Follow the
                        disposal instructions and local regulations.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Keep SDS Documents Up to Date</p>
                      <p>
                        Check the revision date in Section 16 periodically. Request updated copies
                        from your supplier when new versions are issued. An out-of-date SDS may
                        contain incorrect hazard classifications or outdated PPE recommendations.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">The Bottom Line:</strong> A Safety Data Sheet
                  is only useful if it is read, understood, and acted upon. The most comprehensive
                  SDS in the world provides zero protection if it stays in a filing cabinet. Make
                  SDS review a routine part of every COSHH assessment, every toolbox talk about
                  chemical hazards, and every induction for new workers. If you do not have the SDS
                  for a substance you are using &mdash; stop, find it, and read it before
                  continuing.
                </p>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  substances you work with &mdash; and the SDS is the starting point for all of
                  that. If you are asked to use a substance and no SDS is available, you are within
                  your rights to refuse until one is provided.
                </p>
              </div>
            </div>
          </div>
