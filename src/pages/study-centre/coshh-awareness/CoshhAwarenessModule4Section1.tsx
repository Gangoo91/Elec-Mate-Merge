...
const faqs = [
  {
    question: 'Can I skip straight to PPE if it is cheaper than engineering controls?',
    answer:
  ...
  {
    question: 'Is it ever acceptable to use PPE as the only control measure?',
    answer:
  ...
  {
    question: 'What is the difference between elimination and substitution?',
    answer:
  ...
  {
    question: 'How do I know if my controls are working effectively?',
    answer:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['Elimination', 'Substitution', 'Engineering controls', 'Administrative controls'],
    correctAnswer: 1,
    explanation:
...
export default function CoshhAwarenessModule4Section1() {
  useSEO({
    title: 'Hierarchy of Control | COSHH Awareness Module 4 Section 1',
    description:
      ...
      <article className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <section className="mb-10">
          <div className="bg-violet-500/10 border border-violet-500/30 p-4 sm:p-5 rounded-lg">
            <h2 className="text-violet-400 font-semibold text-base mb-3">Learning Outcomes</h2>
            <ul className="text-white space-y-2 text-sm">
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-violet-400 mt-0.5 flex-shrink-0" />
                <span>
                  Explain the duty under COSHH Regulation 7 to prevent or adequately control
                  exposure
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-violet-400 mt-0.5 flex-shrink-0" />
                <span>List the five levels of the hierarchy of control in the correct order</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-violet-400 mt-0.5 flex-shrink-0" />
                <span>
                  Give practical examples of each hierarchy level in electrical and construction
                  work
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-violet-400 mt-0.5 flex-shrink-0" />
                <span>Explain why collective protection is preferred over personal protection</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-violet-400 mt-0.5 flex-shrink-0" />
                <span>
                  Define &ldquo;so far as is reasonably practicable&rdquo; (SFAIRP) and explain how
                  it applies to control selection
                </span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-violet-400 mt-0.5 flex-shrink-0" />
                <span>
                  Describe the layered approach to combining control measures and how to monitor
                  their effectiveness
                </span>
              </li>
            </ul>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              ...
              <strong>prevent exposure</strong> to substances hazardous to health, or where
              prevention is not reasonably practicable, you must <strong>adequately control</strong>{' '}
              that exposure. This is not optional &mdash; it is a legal requirement enforced by the
              HSE.
            </p>
            <p>
              The regulation establishes a two-stage approach. First, the employer must consider
              whether the exposure can be prevented entirely &mdash; for example, by eliminating the
              hazardous substance or by changing the process so the substance is no longer needed.
              Only when prevention is not reasonably practicable should the employer move to
              adequate control, which means reducing exposure to a level that does not cause harm.
            </p>
              ...
              <div className="rounded-lg p-3 sm:p-4 bg-violet-500/10 border-l-2 border-l-violet-500/50 border border-violet-500/30">
                ...
                <ul className="text-base text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Remove the hazardous substance entirely from the process</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Redesign the work so the substance is not required</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Use a completely substance-free method</span>
                  </li>
                </ul>
              </div>
              <div className="rounded-lg p-3 sm:p-4 bg-violet-500/10 border-l-2 border-l-violet-500/50 border border-violet-500/30">
                ...
                <ul className="text-base text-white space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Apply the hierarchy of control in the correct order</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Reduce exposure to below workplace exposure limits (WELs)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Combine multiple control measures where a single control is insufficient
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
              ...
              <p className="text-white/80 text-sm">
                ...
                . If prevention is not achievable, exposure must be reduced to as low a level as is
                reasonably practicable &mdash; not merely below the WEL. This reflects the fact that
                there may be no truly safe level of exposure for these substances.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The hierarchy of control is the framework used to decide how to control exposure to
                hazardous substances. It has{' '}
                <strong>five levels, arranged in order of effectiveness</strong>. You must always
                start at the top and only move down when a higher-level control is not reasonably
                practicable.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Pre-fabricate off site</strong> &mdash; assemble components in a
                      controlled factory environment rather than performing hazardous processes on
                      site
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Push-fit connectors instead of soldered joints</strong> &mdash;
                      eliminates the need for flux, solder, and the fume they produce
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Mechanical fixing instead of adhesive bonding</strong> &mdash; removes
                      the need for chemical adhesives entirely
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Cable tray instead of chased channels</strong> &mdash; avoids
                      generating silica dust from concrete cutting
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Water-based cleaners instead of solvent-based</strong> &mdash; lower
                      volatility, reduced inhalation risk, less flammable
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Lead-free solder</strong> &mdash; eliminates lead exposure while still
                      allowing soldered connections
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Low-VOC adhesives and sealants</strong> &mdash; reduced volatile
                      organic compound emissions, lower inhalation risk
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Low-chrome cement</strong> &mdash; reduces the risk of chromium
                      sensitisation and occupational dermatitis
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Pre-mixed compounds instead of powders</strong> &mdash; reduces dust
                      generation during mixing
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Local exhaust ventilation (LEV)</strong> &mdash; captures fume, dust,
                      or vapour at the point of generation before it enters the breathing zone (e.g.
                      LEV on a soldering station)
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Enclosure</strong> &mdash; physically enclose the process so that the
                      substance cannot escape into the workplace (e.g. enclosed mixing systems)
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>On-tool extraction</strong> &mdash; dust suppression or vacuum
                      extraction fitted directly to cutting, drilling, or grinding tools (e.g. water
                      suppression on a concrete cutter)
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Automation / remote operation</strong> &mdash; remove the worker from
                      the exposure zone entirely
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Segregation</strong> &mdash; separate the hazardous process from other
                      workers (e.g. designated spray-painting area with its own ventilation)
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>General ventilation</strong> &mdash; dilutes contaminated air with
                      clean air (less effective than LEV but useful as a supplementary measure)
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Limit exposure duration</strong> &mdash; reduce the time each worker
                      spends in the exposure zone (e.g. maximum 30 minutes continuous soldering
                      before a break)
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-amber-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Rotate workers</strong> &mdash; share the exposure among multiple
                      workers so no individual exceeds safe limits
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-amber-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Safe systems of work</strong> &mdash; documented procedures that
                      specify how to handle, use, and dispose of hazardous substances safely
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-amber-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Signage and demarcation</strong> &mdash; warning signs, hazard zones,
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-amber-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Training and toolbox talks</strong> &mdash; ensure workers understand
                      the hazards, the controls in place, and their own responsibilities
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-amber-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Permit-to-work systems</strong> &mdash; formal authorisation for
                      high-risk tasks involving hazardous substances
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-amber-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Welfare facilities</strong> &mdash; washing facilities, clean eating
                      areas away from hazardous substances, changing areas
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 mb-3">
                  ...
                  measure while other controls are being implemented.
                </p>
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Correct selection</strong> &mdash; the RPE/PPE must be appropriate for
                      the specific substance and exposure level (e.g. the correct glove material for
                      the chemical being handled, the correct filter type for the vapour or
                      particulate)
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Face-fit testing</strong> &mdash; tight-fitting RPE must be face-fit
                      tested on each individual wearer to ensure an adequate seal; a poor fit
                      renders the RPE ineffective
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Training</strong> &mdash; workers must be trained in how to put on,
                      wear, remove, and check their PPE/RPE correctly
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Maintenance and storage</strong> &mdash; RPE filters must be replaced
                      according to the manufacturer&rsquo;s schedule, PPE must be stored clean and
                      dry, damaged items must be replaced immediately
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Examples in electrical work</strong> &mdash; chemical-resistant gloves
                      for handling solvents and resin, FFP3 masks for dust exposure, safety goggles
                      for splash protection, RPE with appropriate filters for soldering fume
                    </div>
                  </div>
                </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The hierarchy is not just a theoretical framework &mdash; it reflects a fundamental
                principle of occupational health:{' '}
                <strong>
                  higher-level controls are inherently more reliable because they do not depend on
                  human behaviour
                </strong>
                .
              </p>
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <strong>permanent, 100% protection</strong> &mdash; if the hazard is removed,
                      no one can be exposed, regardless of behaviour, training, or compliance.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-500 mt-2 flex-shrink-0"></div>
                    <div>
                      ...
                      <strong>near-permanent protection</strong> &mdash; the new substance is less
                      hazardous, so even if controls fail, the consequences are reduced.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-blue-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Engineering controls</strong> are <strong>highly reliable</strong>{' '}
                      when properly maintained &mdash; they operate automatically and protect
                      everyone in the area without individual action.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-amber-500 mt-2 flex-shrink-0"></div>
                    <div>
                      ...
                      <strong>workers following procedures</strong> &mdash; they can fail if workers
                      are not trained, are under time pressure, or simply forget.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>PPE/RPE</strong> is the <strong>least reliable</strong> &mdash; it
                      depends on correct selection, proper fitting, consistent wearing, and ongoing
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm mb-3">
                  ...
                  measures only protect the individual and depend on correct use.
                </p>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                (SFAIRP) appears throughout health and safety law, including COSHH. It determines
                how far an employer must go in applying the hierarchy of control.
              </p>
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <strong>sacrifice</strong> (cost, time, effort, inconvenience) of implementing
                      a control measure.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <strong>grossly disproportionate</strong> to the risk reduction achieved.
                      &ldquo;Grossly disproportionate&rdquo; is a high threshold &mdash; it is not
                      enough for the control to merely be expensive.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      The <strong>greater the risk, the more the employer must spend</strong> before
                      SFAIRP is satisfied. For high-risk exposures (e.g. carcinogens), very
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      The <strong>burden of proof lies with the employer</strong> to demonstrate
                      that further controls are not reasonably practicable. If challenged by the
                      HSE, the employer must prove it, not the other way round.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  &ldquo;grossly disproportionate&rdquo; to the health benefit &mdash; substitution
                  is clearly reasonably practicable here. However, if the only available alternative
                  required a complete redesign of the production line costing millions for a
                  marginal risk reduction, that <em>might</em> be grossly disproportionate.
                </p>
              </div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  hazards, the cost of implementing proper controls is nowhere near grossly
                  disproportionate. The HSE expects employers to apply good practice as a minimum
                  baseline.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The following table shows practical examples of each hierarchy level as they apply
                to common tasks in electrical installation and construction. These demonstrate that
                the hierarchy is not abstract &mdash; it has direct, everyday applications.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-xl border-2 border-green-500/40 bg-green-500/5 overflow-hidden">
                  <div className="bg-green-500/15 border-b border-green-500/30 px-4 py-2.5">
                    <p className="text-green-400 font-bold text-sm">Elimination Examples</p>
                  </div>
                  <div className="p-4 space-y-2 text-sm">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-white/80">
                        ...
                        &mdash; use expansion bolts or toggles rather than resin-based chemical
                        anchors to avoid isocyanate exposure
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-xl border-2 border-emerald-500/40 bg-emerald-500/5 overflow-hidden">
                  <div className="bg-emerald-500/15 border-b border-emerald-500/30 px-4 py-2.5">
                    <p className="text-emerald-400 font-bold text-sm">Substitution Examples</p>
                  </div>
                  <div className="p-4 space-y-2 text-sm">
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-emerald-500 mt-2 flex-shrink-0"></div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-white/80">
                        ...
                        &mdash; for degreasing panels, cleaning contacts, and general cleaning tasks
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-emerald-500 mt-2 flex-shrink-0"></div>
                ...
                <div className="rounded-xl border-2 border-blue-500/40 bg-blue-500/5 overflow-hidden">
                  <div className="bg-blue-500/15 border-b border-blue-500/30 px-4 py-2.5">
                    <p className="text-blue-400 font-bold text-sm">Engineering Control Examples</p>
                  </div>
                  <div className="p-4 space-y-2 text-sm">
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-blue-500 mt-2 flex-shrink-0"></div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-white/80">
                        ...
                        &mdash; water suppression or vacuum extraction on disc cutters, core drills,
                        and chase cutters to control silica dust
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-blue-500 mt-2 flex-shrink-0"></div>
                  ...
                  <div className="p-4 space-y-2 text-sm">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-white/80">
                        ...
                        &mdash; formal documentation and sign-off before using particularly
                        hazardous substances in confined or complex environments
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-xl border-2 border-red-500/40 bg-red-500/5 overflow-hidden">
                  <div className="bg-red-500/15 border-b border-red-500/30 px-4 py-2.5">
                    <p className="text-red-400 font-bold text-sm">PPE / RPE Examples</p>
                  </div>
                  <div className="p-4 space-y-2 text-sm">
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                      <div className="text-white/80">
                        ...
                        &mdash; nitrile gloves for solvents, neoprene for acids, butyl rubber for
                        ketones (check the safety data sheet for guidance)
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                In practice, it is{' '}
                <strong>rarely sufficient to rely on a single control measure</strong>. Most
                workplace exposures require a combination of controls from different levels of the
                hierarchy, working together to provide defence in depth.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-violet-400 font-medium mb-3">Why Combine Controls?</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>No single control is perfect</strong> &mdash; LEV may capture 90% of
                      fume, but the remaining 10% still needs managing. Combining LEV with reduced
                      exposure time and RPE provides multiple layers of protection.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Defence in depth</strong> &mdash; if one control fails (e.g. LEV
                      breaks down), other controls are still in place to protect workers until the
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Different exposure routes</strong> &mdash; a substance may be inhaled
                      and also absorbed through the skin. LEV controls the inhalation route;
                      chemical-resistant gloves control the skin absorption route. Both are needed.
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Implementing controls is not a one-off task. COSHH Regulation 9 requires employers
                to <strong>maintain, examine, and test</strong> control measures to ensure they
                remain effective. Controls that are not monitored will degrade over time and may
                give a false sense of security.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-violet-400 font-medium mb-3">How to Monitor Controls</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Workplace exposure monitoring</strong> &mdash; measure airborne
                      concentrations of hazardous substances to confirm they are below WELs. This
                      provides objective evidence that controls are working.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>LEV examination and testing</strong> &mdash; COSHH Regulation 9
                      requires LEV to be examined and tested at least every{' '}
                      <strong>14 months</strong> (or 6 months for some specific processes). Records
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Health surveillance</strong> &mdash; regular health checks for workers
                      exposed to substances that cause identifiable diseases (e.g. skin checks for
                      dermatitis, lung function tests for respiratory sensitisers).
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>RPE face-fit testing</strong> &mdash; check that each worker&rsquo;s
                      RPE fits correctly. Re-test if the worker&rsquo;s weight changes
                      significantly, if they have dental work, or if a different model of RPE is
                      introduced.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Incident and near-miss review</strong> &mdash; analyse any incidents
                      involving hazardous substances to identify whether controls failed and what
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Worker consultation</strong> &mdash; ask workers whether they believe
                      the controls are adequate. Workers are often the first to notice when a
                      control is not working properly (e.g. &ldquo;the LEV doesn&rsquo;t seem to be
                      pulling as strongly&rdquo;).
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-violet-400 mt-0.5 flex-shrink-0" />
                    <span>Investigate the root cause of the control failure</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-violet-400 mt-0.5 flex-shrink-0" />
                    <span>
                      Implement temporary additional controls (e.g. RPE) while the primary control
                      is repaired or improved
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-violet-400 mt-0.5 flex-shrink-0" />
                    <span>
                      Repair, replace, or upgrade the failed control as quickly as possible
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-violet-400 mt-0.5 flex-shrink-0" />
                    <span>
                      Review the COSHH assessment and update it if the risk profile has changed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-violet-400 mt-0.5 flex-shrink-0" />
                    <span>
                      Re-assess whether the task can move to a higher level of the hierarchy
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      <strong>COSHH Regulation 7</strong> requires employers to prevent exposure or,
                      where that is not reasonably practicable, to adequately control it using the
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-violet-500 mt-0.5 flex-shrink-0" />
                    <span>
                      The <strong>hierarchy has five levels</strong>: elimination, substitution,
                      engineering controls, administrative controls, and PPE/RPE &mdash; always
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      ...
                      engineering) are more effective because they do not depend on individual
                      behaviour.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-violet-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>Collective protection</strong> (e.g. LEV, enclosure) is always
                      preferred over personal protection (e.g. RPE, gloves).
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-violet-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>PPE is always the last resort</strong> &mdash; it only protects the
                      individual wearing it and depends on correct selection, fitting, training, and
                      maintenance.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-violet-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong>SFAIRP</strong> means controls must be implemented unless the cost is
                      grossly disproportionate to the risk &mdash; the burden of proof is on the
                      employer.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-violet-500 mt-0.5 flex-shrink-0" />
                    <span>
                      In practice, a <strong>layered approach</strong> combining controls from
                      multiple levels provides the most robust protection.
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-violet-500 mt-0.5 flex-shrink-0" />
                    <span>
                      Controls must be <strong>monitored, maintained, and reviewed</strong> &mdash;
                      LEV must be examined at least every 14 months and records kept for 5 years.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      Prevention or adequate control of exposure to substances hazardous to health
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-violet-400 font-semibold flex-shrink-0">Reg 9:</span>
                    <span>Maintenance, examination, and testing of control measures</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-violet-400 font-semibold flex-shrink-0">Reg 10:</span>
                    <span>Monitoring exposure at the workplace</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-violet-400 font-semibold flex-shrink-0">Reg 11:</span>
                    <span>Health surveillance for exposed workers</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* ─── Quiz ─── */}
        <div className="mt-12">
          <Quiz title="Hierarchy of Control Quiz" questions={quizQuestions} />
        </div>
