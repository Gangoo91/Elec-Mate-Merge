...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question: 'How long must health surveillance records be retained under COSHH?',
    options: [
  ...
  },
  {
    ...
    question: 'Which of the following would NOT typically trigger a review of a COSHH assessment?',
    options: [
...
const faqs = [
  {
    question: 'Do I need to keep COSHH records even if I have fewer than five employees?',
    answer:
  ...
  {
    question: 'What is the difference between competence and awareness in COSHH training?',
    answer:
  ...
  {
    question: 'Can COSHH training records be kept electronically?',
    answer:
...
const quizQuestions = [
  {
    id: 1,
    question: 'Under COSHH Regulation 12, which of the following must training cover?',
    options: [
  ...
  {
    id: 2,
    question: 'How long must personal exposure monitoring records be retained?',
    options: ['5 years', '10 years', '20 years', '40 years'],
    correctAnswer: 3,
    explanation:
  ...
  },
  {
    ...
    options: ['1 year', '3 years', '5 years', '40 years'],
    correctAnswer: 2,
    explanation:
...
export default function CoshhAwarenessModule5Section4() {
  useSEO({
    title: 'Training, Record Keeping & Review | COSHH Awareness Module 5 Section 4',
    description:
      ...
      <article className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="bg-violet-500/10 border border-violet-500/30 p-5 rounded-lg">
            ...
            <ul className="space-y-2 text-sm text-white/80">
              <li className="flex items-start gap-3">
                ...
                <span>
                  Explain what COSHH training must cover under Regulation 12 and when it is required
                </span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                <span>Distinguish between awareness and competence in COSHH training</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                <span>Identify the retention periods for different types of COSHH records</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                <span>Describe when and why a COSHH assessment must be reviewed</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                <span>Outline HSE enforcement powers and the consequences of non-compliance</span>
              </li>
              <li className="flex items-start gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                <span>
                  Apply the Plan-Do-Check-Act cycle to COSHH management in an electrical work
                  context
                </span>
              </li>
            </ul>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              Regulation 12 of the Control of Substances Hazardous to Health Regulations 2002
              (COSHH) requires every employer to ensure that employees who may be exposed to
              hazardous substances receive{' '}
              <strong>suitable and sufficient information, instruction, and training</strong>. This
              is not optional &mdash; it is a legal obligation that applies to all workplaces where
              hazardous substances are used, stored, or may be encountered.
            </p>

            <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
              <h3 className="text-violet-400 font-medium mb-3">What Training Must Cover</h3>
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Nature of the hazards</strong> &mdash; the health effects of each
                    substance, the routes of entry into the body, and why the substance is
                ...
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Precautions to be taken</strong> &mdash; safe handling procedures,
                    storage requirements, hygiene measures, and the importance of following safe
                    systems of work
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Control measures in place</strong> &mdash; what engineering controls are
                    provided (LEV, enclosures, ventilation), how they work, and the employee&rsquo;s
                    responsibility to use them correctly and report defects
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Correct use of PPE</strong> &mdash; how to select, fit, wear, maintain,
                    store, and dispose of personal protective equipment including RPE, gloves, eye
                ...
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Emergency procedures</strong> &mdash; what to do in the event of a
                    spill, leak, accidental exposure, fire involving chemicals, or any other COSHH
                    emergency
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Health surveillance requirements</strong> &mdash; why health
                    surveillance is carried out, what it involves, and the employee&rsquo;s duty to
                    attend and cooperate
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Results of monitoring</strong> &mdash; employees have the right to be
                    informed of the results of any workplace exposure monitoring and what those
                    results mean for their health
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
              <h3 className="text-violet-400 font-medium mb-3">When Training Is Needed</h3>
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Induction</strong> &mdash; before an employee is first exposed to any
                    hazardous substance, including when starting a new job, joining a new site, or
                ...
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>New substance introduced</strong> &mdash; whenever a new hazardous
                    substance is brought into the workplace or an existing substance is used in a
                    different way
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Change of job or process</strong> &mdash; when an employee moves to a
                    different role, task, or work area where the substance hazards differ from their
                    previous assignment
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Refresher training</strong> &mdash; at regular intervals to maintain
                    competence. The HSE recommends annual refresher training as a minimum, though
                    higher-risk environments may require more frequent updates
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
              <h3 className="text-violet-400 font-medium mb-3">Who Needs Training</h3>
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>All exposed workers</strong> &mdash; anyone who uses, handles, stores,
                    transports, or may be accidentally exposed to hazardous substances during their
                    work
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Supervisors and managers</strong> &mdash; those responsible for
                    overseeing work involving hazardous substances need additional training to
                    ensure they can identify risks and enforce controls
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Emergency responders</strong> &mdash; first aiders, fire marshals, spill
                    response teams, and anyone with a designated role in the COSHH emergency plan
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Visitors and contractors</strong> &mdash; must be informed of relevant
                    hazards during site induction, even if their exposure is incidental rather than
                    direct
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The COSHH Regulations do not prescribe a single training method. Employers must
                choose methods that are appropriate to the workforce, the hazards involved, and the
                complexity of the control measures. In practice, the most effective COSHH training
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-5">
                <div className="rounded-lg p-3 sm:p-4 bg-violet-500/10 border-l-2 border-l-violet-500/50 border border-violet-500/30">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    Should be recorded with date, topic, attendees, and delivery method.
                  </p>
                </div>
                <div className="rounded-lg p-3 sm:p-4 bg-violet-500/10 border-l-2 border-l-violet-500/50 border border-violet-500/30">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    understanding &mdash; not just attendance.
                  </p>
                </div>
                <div className="rounded-lg p-3 sm:p-4 bg-violet-500/10 border-l-2 border-l-violet-500/50 border border-violet-500/30">
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <span>
                      <strong className="text-white">Awareness</strong> = knowing hazardous
                      substances exist and that COSHH applies
                    </span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-violet-400 mt-2 flex-shrink-0"></div>
                    <span>
                      <strong className="text-white">Competence</strong> = being able to identify
                      specific hazards, select correct controls, use PPE properly, follow emergency
                      procedures, and apply knowledge in real work situations
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Topics covered</strong> &mdash; specific substances, hazards,
                      controls, and procedures discussed
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Names of attendees</strong> with signatures or electronic confirmation
                      of attendance
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Method of delivery</strong> &mdash; toolbox talk, classroom,
                      e-learning, practical demonstration
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Assessment results</strong> &mdash; how competence was verified (quiz,
                      practical test, observation)
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Refresher date</strong> &mdash; when the next refresher is due
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4 text-white">
            <p>
              COSHH requires employers to create, maintain, and retain a range of records. These
              records serve multiple purposes: they demonstrate compliance with the law, provide
              evidence during HSE inspections, support health surveillance programmes, and protect
              both employers and employees in the event of a future claim or investigation.
            </p>
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="flex items-center gap-3 mt-4">
                  ...
                  <div className="flex-1 h-3 rounded-full bg-amber-500/30 relative overflow-hidden">
                    <div
                      className="absolute inset-0 bg-amber-500/60 rounded-full"
                      style={{ width: '12.5%' }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 mt-4">
                  ...
                  <div className="flex-1 h-3 rounded-full bg-violet-500/30 relative overflow-hidden">
                    <div
                      className="absolute inset-0 bg-violet-500/60 rounded-full"
                      style={{ width: '50%' }}
                    ></div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 mt-4">
                  ...
                  <div className="flex-1 h-3 rounded-full bg-green-500/30 relative overflow-hidden">
                    <div
                      className="absolute inset-0 bg-green-500/60 rounded-full"
                      style={{ width: '5%' }}
                    ></div>
                  </div>
                </div>
            ...
            <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
              <h3 className="text-violet-400 font-medium mb-3">Detailed Record Requirements</h3>
              <div className="space-y-4 text-sm">
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>COSHH assessments</strong> &mdash; must be recorded in writing if the
                    employer has 5 or more employees (good practice always). Must include date,
                    assessor, substances, hazards, exposed persons, controls, and review date
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Health surveillance records</strong> &mdash; 40 years retention. Must
                    include the employee&rsquo;s name, date of surveillance, the outcome, and any
                    restrictions or referrals. Individual records are confidential and must not be
                ...
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Exposure monitoring records</strong> &mdash; personal records (linked to
                    a named individual) must be kept for 40 years. General workplace monitoring
                    records (not linked to an identifiable individual) must be kept for 5 years
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>LEV examination records</strong> &mdash; 5 years retention. Must include
                    the date, condition, any defects found, repairs carried out, and confirmation of
                ...
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Training records</strong> &mdash; retain for duration of employment plus
                    a reasonable period after leaving (many organisations retain for 6 years after
                    departure to cover the limitation period for civil claims)
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>RPE face-fit test records</strong> &mdash; retain for duration of
                    employment. Must include the make and model of RPE, the fit test method used,
                    the test result, and the date of the test. Retest when the wearer&rsquo;s face
                    shape changes significantly (e.g. weight change, dental work)
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>SDS library</strong> &mdash; current versions of all safety data sheets
                    must be accessible to workers who may be exposed. SDSs must be updated when new
                    versions are issued by the manufacturer. Superseded versions should be retained
                    for reference
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  <div>
                    <strong>Accident and incident records</strong> &mdash; 3 years minimum under
                    RIDDOR. Include any spills, leaks, accidental exposures, near misses, and first
                    aid treatment given
                  </div>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-4 sm:gap-5">
              <div className="rounded-lg p-3 sm:p-4 bg-violet-500/10 border-l-2 border-l-violet-500/50 border border-violet-500/30">
                ...
                <p className="text-sm text-white/80">
                  ...
                  stored securely and protected from damage. Many organisations use a hybrid
                  approach &mdash; electronic databases for management and signed paper copies as
              ...
              <div className="rounded-lg p-3 sm:p-4 bg-violet-500/10 border-l-2 border-l-violet-500/50 border border-violet-500/30">
                ...
                <p className="text-sm text-white/80">
                  ...
                  records to be retrievable on demand &mdash; telling an inspector &ldquo;we had the
                  records but lost them&rdquo; is not an acceptable defence.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Every new starter and every visitor to a workplace where hazardous substances are
                present must receive COSHH induction training before they enter areas where exposure
                could occur. This applies equally to permanent employees, agency workers,
                apprentices, and visiting contractors such as electricians working on a
                client&rsquo;s site.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-violet-400 font-medium mb-3">COSHH Induction Must Cover</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      What hazardous substances are used or stored on site and where they are
                      located
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      The main health hazards &mdash; what could happen if exposed without controls
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      The control measures in place and what the worker must do to protect
                      themselves
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>Where SDSs are stored and how to access them</div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      Emergency procedures &mdash; spill response, evacuation routes, first aid
                      arrangements, and who to contact
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      PPE requirements &mdash; what is needed, where it is available, and how to use
                      it
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>How to report concerns, incidents, or suspected ill health</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  <strong className="text-white">right to receive a COSHH induction</strong> before
                  entering any area where hazardous substances are present. If one is not offered,
                  request it. Never assume that because you are &ldquo;just doing the
                  electrics&rdquo; the chemical hazards do not apply to you.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                A COSHH assessment is not a static document. Regulation 6(3) requires employers to
                review their assessments whenever there is reason to suspect the assessment is no
                longer valid, or when there has been a significant change in the work to which it
                relates. In practice, the HSE recommends routine reviews at least annually, even if
                no specific trigger has occurred.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  <RefreshCw className="h-5 w-5 text-violet-400" />
                  <h3 className="text-violet-400 font-medium">Review Triggers Checklist</h3>
                </div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Change in work activity or process</strong> &mdash; new tasks,
                      different methods, changes to the sequence of work
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded border border-violet-500/50 bg-violet-500/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <strong>Change in substance</strong> &mdash; new substance introduced,
                      supplier changed, reformulated product, reclassified hazard
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded border border-violet-500/50 bg-violet-500/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <strong>New information available</strong> &mdash; updated SDS from
                      manufacturer, new WEL published, new HSE guidance or research
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded border border-violet-500/50 bg-violet-500/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <strong>Incident or near miss</strong> &mdash; spill, leak, accidental
                      exposure, adverse health effect reported by a worker
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded border border-violet-500/50 bg-violet-500/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <strong>Monitoring shows inadequacy</strong> &mdash; exposure levels
                      approaching or exceeding WELs, control measures not performing as expected
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded border border-violet-500/50 bg-violet-500/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <strong>Health surveillance findings</strong> &mdash; adverse health effects
                      detected in exposed workers
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded border border-violet-500/50 bg-violet-500/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <strong>Routine annual review</strong> &mdash; even if no specific trigger has
                      occurred, a systematic review is good practice
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-5">
                <div className="rounded-lg p-3 sm:p-4 bg-violet-500/10 border-l-2 border-l-violet-500/50 border border-violet-500/30">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    &mdash; they demonstrate that the assessment has been actively managed over time
                    and can be valuable evidence in any future investigation.
                  </p>
                </div>
                <div className="rounded-lg p-3 sm:p-4 bg-violet-500/10 border-l-2 border-l-violet-500/50 border border-violet-500/30">
                  <p className="font-semibold text-base text-violet-400 mb-2">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    confirm they have understood the changes. Simply emailing an updated document is
        ...
        <section className="mb-10">
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                The Health and Safety Executive (HSE) is the primary enforcing authority for COSHH
                in the United Kingdom. Local authority environmental health officers also enforce
                COSHH in certain sectors, including retail, hospitality, and leisure. Both have the
                power to enter premises, take samples, examine records, and take enforcement action.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <div className="flex items-center gap-2 mb-3">
                  <Shield className="h-5 w-5 text-violet-400" />
                  <h3 className="text-violet-400 font-medium">HSE Inspectors&rsquo; Powers</h3>
                </div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Enter any premises</strong> at any reasonable time (or at any time if
                      they believe a dangerous situation exists) &mdash; no appointment is required
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Take samples</strong> of any substances, articles, or the atmosphere
                      in the workplace for analysis
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Examine and copy records</strong> &mdash; COSHH assessments, training
                      records, health surveillance records, monitoring data, LEV examination
                      records, and SDSs
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Interview employees</strong> &mdash; inspectors can ask workers about
                      their training, understanding of hazards, and use of control measures
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-violet-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Serve enforcement notices</strong> &mdash; improvement notices and
                      prohibition notices
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-violet-400 font-medium mb-3">Enforcement Tools</h3>
                <div className="space-y-4 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Advice and guidance</strong> &mdash; informal approach for minor
                      issues. The inspector provides verbal or written advice on how to improve
                      compliance
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <strong>Improvement notice</strong> &mdash; requires specific action within a
                      set timeframe (typically 21 days). Work may continue while improvements are
                      made. An appeal suspends the notice until the appeal is heard
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Prohibition notice</strong> &mdash; STOPS work immediately where the
                      inspector believes there is a risk of serious personal injury. Takes effect
                      straight away. Work must not resume until the risk has been eliminated or
                      adequately controlled. An appeal does NOT suspend a prohibition notice
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-500 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong>Prosecution</strong> &mdash; for serious breaches, repeated
                      non-compliance, or situations where someone has been harmed or placed at
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-5">
                <div className="rounded-lg p-3 sm:p-4 bg-violet-500/10 border-l-2 border-l-violet-500/50 border border-violet-500/30">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    enforcement action. The current rate is charged per hour. FFI applies from the
                    point the breach is identified and is in addition to any fines or prosecution.
                    Poor COSHH management can therefore have an immediate financial cost before any
                    formal penalty.
                  </p>
                </div>
                <div className="rounded-lg p-3 sm:p-4 bg-red-500/10 border-l-2 border-l-red-500/50 border border-red-500/30">
                  ...
                  <div className="text-sm text-white/80 space-y-2">
                    <div className="flex items-start gap-3">
                      ...
                      <span>
                        <strong className="text-white">Unlimited fines</strong> for organisations
                        convicted of COSHH offences
                      </span>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                      <span>
                        <strong className="text-white">Imprisonment up to 2 years</strong> for the
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                      <span>
                        <strong className="text-white">Adverse publicity</strong> &mdash;
                        convictions are published by the HSE
                      </span>
                    </div>
                  </div>
                </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                Effective COSHH management is not a one-off exercise. The HSE promotes a{' '}
                <strong>Plan-Do-Check-Act (PDCA)</strong> approach to health and safety management,
                including COSHH. This cycle ensures that controls are continuously reviewed and
                improved, rather than becoming outdated or neglected.
              </p>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  will look for evidence that your COSHH management is{' '}
                  <strong className="text-white">dynamic</strong> &mdash; that assessments are
                  reviewed, training is refreshed, monitoring is ongoing, and the results feed back
                  into improved controls. A folder of dusty assessments that have never been touched
                  is a red flag.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                This final section brings together everything covered in this module &mdash; and
                indeed the entire COSHH Awareness course &mdash; into a practical summary for
                electricians working on site. These are the actions you should take before, during,
                and after every job where hazardous substances may be present.
              </p>
              ...
              <div className="bg-violet-500/10 border-2 border-violet-500/40 p-5 rounded-lg">
                ...
                <ul className="space-y-3 text-sm text-white/80">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      <strong className="text-white">Regulation 12</strong> requires employers to
                      provide information, instruction, and training before workers are first
                      exposed, when substances or processes change, and at regular refresher
                      intervals
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-violet-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Competence &ne; awareness</strong> &mdash;
                      workers must be able to apply their knowledge in practice, not merely
                      recognise that COSHH exists
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-violet-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Record retention</strong> varies from 3 years
                      (accident records) to 40 years (health surveillance and personal exposure
                      monitoring)
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-violet-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Assessments must be reviewed</strong> whenever
                      work, substances, or information changes, after incidents, and routinely at
                      least once per year
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-violet-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">HSE inspectors</strong> can enter premises
                      without notice, examine all records, interview workers, and issue improvement
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-violet-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Penalties</strong> include unlimited fines,
                      personal liability for directors and managers, and imprisonment for up to 2
                      years
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-violet-500 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Plan-Do-Check-Act</strong> ensures COSHH
                      management is a continuous, improving process rather than a static paperwork
                      exercise
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-green-500/10 border-2 border-green-500/40 p-5 rounded-lg">
                <div className="flex items-start gap-2 mb-3">
                  ...
                  <h3 className="font-bold text-green-300 text-base">Course Complete</h3>
                </div>
                <p className="text-white text-sm leading-relaxed">
                  You have now covered all the content in the COSHH Awareness course. You understand
                  what COSHH is, how hazardous substances affect the body, how to read safety data
                  sheets, the hierarchy of control measures, the role of PPE, workplace monitoring,
                  health surveillance, emergency procedures, training requirements, record keeping,
                  and HSE enforcement. The knowledge you have gained will help you identify chemical
                  hazards, protect yourself and others, and comply with the law on every job you
                  work. When you are ready, proceed to the mock exam to test your understanding
        ...
        {/* ─── Quiz ─── */}
        <div className="mt-12">
          <Quiz title="Training, Record Keeping & Review Quiz" questions={quizQuestions} />
        </div>
