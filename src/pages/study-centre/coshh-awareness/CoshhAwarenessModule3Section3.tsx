...
const faqs = [
  ...
  {
    question: 'What is the difference between an FFP2 and an FFP3 disposable mask?',
    answer:
  ...
  {
    question: 'Can I use a standard domestic vacuum cleaner to clean up construction dust?',
    answer:
  ...
  {
    question: 'Is wet cutting always sufficient to control dust from concrete and masonry?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'Which of the following is NOT a type of LEV hood?',
    options: [
  ...
  {
    id: 3,
    question: 'What filtration efficiency defines an H-class dust extractor?',
    options: [
...
export default function CoshhAwarenessModule3Section3() {
  useSEO({
    title: 'Dust & Fume Control | COSHH Awareness Module 3.3',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Threat:</strong> Respirable particles you cannot see are the most dangerous
              </li>
              <li>
                <strong>Control:</strong> LEV at source &gt; on-tool extraction &gt; wet methods
                &gt; RPE
              </li>
              <li>
                <strong>H-class:</strong> 99.995% HEPA filtration for silica, hardwood, asbestos
                dust
              </li>
              <li>
                <strong>Rule:</strong> Vacuum, never sweep &mdash; damp wipe, never blow
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>LEV:</strong> Thorough exam every 14 months (COSHH Reg 9)
              </li>
              <li>
                <strong>RPE:</strong> FFP3 (APF 20) for high-hazard dusts &mdash; must be face-fit
                tested
              </li>
              <li>
                <strong>Wet cutting:</strong> Clean slurry while wet &mdash; dried slurry = airborne
                silica
              </li>
              <li>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  the lungs, where they can cause permanent, irreversible damage. By the time you
                  can see a dust cloud with the naked eye, the concentration of invisible respirable
                  particles is already many times above safe limits.
                </p>
              </div>

              <p>
                Construction and electrical work generates dust and fumes from a wide range of
                activities:{' '}
                <strong>
                  cutting, grinding, drilling, chasing, sanding, welding, soldering, and cable
                  burning
                </strong>
                . Each of these activities produces particles that vary in size, composition, and
                toxicity. The health effects depend on <strong>what</strong> the particle is made
                of, <strong>how small</strong> it is, <strong>how much</strong> you inhale, and{' '}
                <strong>how often</strong> you are exposed.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Inhalable dust (&lt;100&mu;m)</strong> &mdash;
                      enters the nose and mouth; trapped by upper airways
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Thoracic dust (&lt;25&mu;m)</strong> &mdash;
                      penetrates past the larynx into the bronchial airways
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Respirable dust (&lt;10&mu;m)</strong> &mdash;
                      reaches the alveoli (gas exchange region) deep in the lungs; causes silicosis,
                      COPD, lung cancer
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ultrafine particles (&lt;0.1&mu;m)</strong>{' '}
                      &mdash; welding fume, solder fume; can pass through lung walls into the
                      bloodstream
                    </span>
                  </div>
                </div>
              ...
              <p>
                The damage from respirable dust and fumes is <strong>cumulative</strong>. Each
                exposure adds to the total burden on the lungs. Unlike a cut or a broken bone, lung
                damage from dust exposure does not heal. Scar tissue replaces healthy lung tissue,
                progressively reducing lung capacity. Conditions such as <strong>silicosis</strong>,{' '}
                <strong>occupational asthma</strong>, <strong>COPD</strong>, and{' '}
                <strong>lung cancer</strong> may not develop symptoms until years or decades after
                exposure &mdash; by which time the damage is irreversible.
              </p>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  Under COSHH, the hierarchy is: (1) eliminate the dust-generating process if
                  possible; (2) substitute with a less hazardous material or method; (3) enclose the
                  process and use LEV at source; (4) use general ventilation to dilute; (5) as a
                  last resort, use RPE. Controls higher in the hierarchy are always preferred over
                  RPE because they protect everyone in the area, not just the individual wearing the
                  mask.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Local Exhaust Ventilation is an <strong>engineering control</strong> that captures
                airborne contaminants at or near the point where they are generated, before they can
                spread into the general workplace air and reach the worker's breathing zone. A
                properly designed and maintained LEV system is one of the most effective ways to
                control dust and fume exposure under COSHH.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ol className="text-sm text-white/80 space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Hood</strong> &mdash; the opening that captures
                      the contaminant. Must be positioned as close to the source as possible. Types
                      include enclosing, receiving, and capturing hoods
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-7 h-7 rounded-full bg-violet-500/20 border border-violet-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-violet-400">
                    ...
                    <span>
                      <strong className="text-white">Ductwork</strong> &mdash; transports
                      contaminated air from the hood to the air cleaner. Must maintain adequate
                      transport velocity to prevent dust settling inside the ducts
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-7 h-7 rounded-full bg-violet-500/20 border border-violet-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-violet-400">
                    ...
                    <span>
                      <strong className="text-white">Air cleaner</strong> &mdash; removes the
                      contaminant from the airstream. May be a filter, cyclone, scrubber, or
                      electrostatic precipitator depending on the contaminant type
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-7 h-7 rounded-full bg-violet-500/20 border border-violet-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-violet-400">
                    ...
                    <span>
                      <strong className="text-white">Fan (air mover)</strong> &mdash; provides the
                      suction that draws air through the entire system. Positioned after the air
                      cleaner to protect the fan from contaminated air
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-7 h-7 rounded-full bg-violet-500/20 border border-violet-500/40 flex items-center justify-center flex-shrink-0 text-xs font-bold text-violet-400">
                    ...
                    <span>
                      <strong className="text-white">Discharge</strong> &mdash; where cleaned air is
                      released, either back into the workplace (recirculated) or to the outside
                      atmosphere. Air containing carcinogenic substances must not be recirculated
                    </span>
                  </li>
                </ol>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-violet-400 mb-3">Hood Types Explained</p>
              ...
              <p>
                <strong>Capture velocity</strong> is the minimum air speed at the hood face (or at
                the furthest point of contaminant generation) needed to draw the contaminant into
                the hood. If the capture velocity is too low, contaminants escape past the hood and
                enter the worker's breathing zone. Capture velocity depends on how the contaminant
                is generated: dust released at low velocity (e.g. pouring powder) needs a lower
                capture velocity than dust thrown at high speed (e.g. from an angle grinder).
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      LEV must be{' '}
                      <strong className="text-white">thoroughly examined and tested</strong> at
                      intervals not exceeding <strong className="text-white">14 months</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">competent person</strong> (e.g. a BOHS
                      P601/P602 qualified examiner)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      A <strong className="text-white">written report</strong> of each examination
                      must be kept for at least <strong className="text-white">5 years</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">routine maintenance and visual checks</strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Workers must be{' '}
                      <strong className="text-white">trained in the correct use</strong> of the LEV
                      system and must report any defects immediately
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <div className="relative mx-auto max-w-lg">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="border-2 border-violet-500 rounded-lg bg-violet-500/10 p-3 text-center">
                  ...
                  <div className="flex justify-around mt-2 gap-1">
                    <div className="flex-1 border border-violet-400/40 rounded bg-violet-500/5 p-1.5">
                      <span className="text-[9px] text-violet-300 block">Enclosing</span>
                    </div>
                    <div className="flex-1 border border-violet-400/40 rounded bg-violet-500/5 p-1.5">
                      <span className="text-[9px] text-violet-300 block">Receiving</span>
                    </div>
                    <div className="flex-1 border border-violet-400/40 rounded bg-violet-500/5 p-1.5">
                      <span className="text-[9px] text-violet-300 block">Capturing</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-2 border-violet-500 rounded-lg bg-violet-500/10 p-3 text-center">
                  ...
                  <div className="flex justify-around mt-2 gap-1">
                    <div className="flex-1 border border-violet-400/40 rounded bg-violet-500/5 p-1.5">
                      <span className="text-[9px] text-violet-300 block">Filter</span>
                    </div>
                    <div className="flex-1 border border-violet-400/40 rounded bg-violet-500/5 p-1.5">
                      <span className="text-[9px] text-violet-300 block">Cyclone</span>
                    </div>
                    <div className="flex-1 border border-violet-400/40 rounded bg-violet-500/5 p-1.5">
                      <span className="text-[9px] text-violet-300 block">Scrubber</span>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-4 border-2 border-dashed border-violet-400/50 rounded bg-violet-500/10 p-2 text-center">
                <span className="text-[10px] sm:text-xs text-violet-400 font-medium">
                  COSHH Reg 9: Thorough examination &amp; test every 14 months &mdash; records kept
                  5 years
                </span>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                On-tool extraction and wet suppression are <strong>source controls</strong> &mdash;
                they capture or suppress dust at the exact point where it is generated by the tool.
                These methods are especially important for portable power tools used on construction
                sites where fixed LEV systems are not practical.
              </p>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Built-in dust ports</strong> on saws, grinders,
                      drills, and sanders connect to an extraction unit via a hose. The extraction
                      captures dust as it is generated at the blade, disc, or bit
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">H-class vacuum required</strong> when cutting
                      concrete, stone, brick, morite, or any material containing silica or other
                      hazardous substances. M-class may be adequate for medium-hazard dusts only
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Connection must be secure</strong> &mdash; a
                      loose or disconnected hose provides zero protection. Check connections before
                      each use. Use correct adaptor sizes
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Automatic start</strong> &mdash; many H-class
                      extractors have auto-start sockets that power on the vacuum when the tool is
                      switched on, ensuring extraction runs whenever the tool is in use
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Water-fed cutting tools</strong> deliver a
                      continuous stream of water to the blade or disc, binding dust particles as
                      they are created and preventing them from becoming airborne
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Misting systems</strong> produce a fine water
                      mist in the cutting zone. Used where direct water feed is not practical
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Slurry management</strong> &mdash; wet cutting
                      creates a slurry of water and hazardous material. This slurry{' '}
                      <strong className="text-white">must be cleaned up while still wet</strong>. If
                      allowed to dry, the hazardous particles become airborne again, recreating the
                      original hazard
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Limitations</strong> &mdash; wet suppression
                      alone may not reduce dust below the WEL in enclosed spaces. In these
                      situations, combine wet methods with extraction and/or RPE
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  use water with tools not rated for wet operation. Consider 110V CTE supply for
                  site tools to reduce electrical risk further.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Dust extractors are classified by the level of filtration they provide. The class
                determines which types of dust the extractor is approved to handle. Using the wrong
                class of extractor for a hazardous dust provides inadequate protection and may
                result in dangerous exposure.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">M-Class vs H-Class Comparison</p>
                  ...
                  <div className="border border-violet-400/30 rounded-lg p-3 bg-violet-500/5">
                    ...
                    <ul className="text-xs text-white/70 space-y-1.5">
                      <li className="flex items-start gap-1.5">
                        ...
                        <span>
                          Filtration: <strong className="text-white">99.9% at 0.3&mu;m</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-1.5">
                        <span className="mt-1 w-1 h-1 rounded-full bg-violet-300 flex-shrink-0" />
                        <span>
                          Suitable for: <strong className="text-white">medium-hazard dusts</strong>{' '}
                      ...
                      <li className="flex items-start gap-1.5">
                        <span className="mt-1 w-1 h-1 rounded-full bg-violet-300 flex-shrink-0" />
                        <span>
                          Examples: general construction dust, softwood dust, plaster, drywall
                        </span>
                      </li>
                      <li className="flex items-start gap-1.5">
                        <span className="mt-1 w-1 h-1 rounded-full bg-violet-300 flex-shrink-0" />
                        <span>Standard filter maintenance and bag disposal</span>
                      </li>
                    </ul>
                  </div>
                  <div className="border-2 border-violet-500 rounded-lg p-3 bg-violet-500/10">
                    ...
                    <ul className="text-xs text-white/70 space-y-1.5">
                      <li className="flex items-start gap-1.5">
                        ...
                        <span>
                          Filtration:{' '}
                          <strong className="text-white">99.995% at 0.3&mu;m (HEPA H13+)</strong>
                        </span>
                      </li>
                      <li className="flex items-start gap-1.5">
                        <span className="mt-1 w-1 h-1 rounded-full bg-violet-300 flex-shrink-0" />
                        <span>
                          Required for: <strong className="text-white">high-hazard dusts</strong>{' '}
                          &mdash; carcinogenic, silica, asbestos
                        </span>
                      </li>
                      <li className="flex items-start gap-1.5">
                        <span className="mt-1 w-1 h-1 rounded-full bg-violet-300 flex-shrink-0" />
                        <span>Examples: hardwood dust, RCS, lead, cadmium, asbestos</span>
                      </li>
                      <li className="flex items-start gap-1.5">
                        <span className="mt-1 w-1 h-1 rounded-full bg-violet-300 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Bags disposed as hazardous waste</strong>{' '}
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">HEPA filtration</strong> &mdash; minimum H13
                      filter (99.995% efficiency at 0.3&mu;m particle size). This is what defines
                      the &ldquo;H&rdquo; classification
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Dust-free disposal</strong> &mdash; H-class
                      extractors have sealed bag systems that allow the collection bag to be removed
                      and sealed without exposing the operator to dust
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Airflow monitoring</strong> &mdash; an
                      indicator or alarm that warns when airflow drops below the required level
                      (e.g. blocked filter or full bag)
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Anti-static hose</strong> &mdash; prevents
                      static build-up that could ignite combustible dusts
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Filter maintenance</strong> &mdash; HEPA
                      filters must be replaced according to the manufacturer&rsquo;s schedule. A
                      clogged filter reduces suction and allows dust to bypass the filter
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">authorised hazardous waste carrier</strong>. Never
                  empty, shake, or reuse H-class collection bags. Treat the used bag as the
                  hazardous substance it contains.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                General ventilation (also called <strong>dilution ventilation</strong>) works by
                introducing clean air into a workspace to dilute the concentration of airborne
                contaminants. Unlike LEV, it does not capture contaminants at source &mdash; it
                reduces their concentration by mixing them with large volumes of clean air.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">LEV vs General Ventilation</p>
              ...
              <p>
                General ventilation can be <strong>natural</strong> (open windows, doors, vents) or{' '}
                <strong>mechanical</strong> (fans, HVAC systems). The effectiveness is measured in{' '}
                <strong>air changes per hour (ACH)</strong> &mdash; the number of times the total
                volume of air in the space is replaced per hour. Workshops typically require
                6&ndash;10 ACH; welding areas may need 10&ndash;20 ACH or more.
              </p>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  General ventilation is appropriate as a supplementary measure alongside LEV, or as
                  the sole control only when the substance has low toxicity, the emission rate is
                  low and uniform, and the worker is not close to the source. For most construction
                  dust and fume hazards, general ventilation alone is{' '}
                  <strong className="text-white">not sufficient</strong> &mdash; LEV or other source
                  controls must be the primary measure.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Respiratory Protective Equipment (RPE) is the <strong>last line of defence</strong>{' '}
                in the COSHH hierarchy of control. It should only be relied upon when engineering
                controls (LEV, on-tool extraction, wet methods) cannot reduce exposure below the
                Workplace Exposure Limit on their own, or as an interim measure while engineering
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Face-fit testing</strong> is mandatory for all
                      tight-fitting RPE (FFP1/2/3, half-mask, full-face). An ill-fitting mask
                      provides a fraction of its rated protection
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Facial hair prevents a seal</strong> &mdash;
                      tight-fitting RPE cannot achieve its APF if the wearer has a beard or stubble.
                      Workers with facial hair must use a PAPR (loose-fitting powered hood)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">CE/UKCA marked</strong> &mdash; RPE must carry
                      the correct conformity marking and be selected to match the specific hazard
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fit check every time</strong> &mdash; even a
                      face-fit-tested mask must be checked for seal each time it is put on (positive
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">required protection factor</strong>. Then choose
                  RPE with an APF equal to or greater than the required protection factor. For
                  example, if the expected exposure is 10 mg/m&sup3; and the WEL is 0.5 mg/m&sup3;,
                  the required protection factor is 20, so you need at least an FFP3 (APF 20).
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div className="border-2 border-violet-500 rounded-lg bg-violet-500/10 p-2 text-center">
                    ...
                    <p className="text-[9px] text-violet-300">Half-mask + P3</p>
                  </div>
                  <div className="border border-white/20 rounded-lg bg-white/5 p-2 text-center">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>condensation of vaporised metal or other materials</strong> during processes
                such as welding, soldering, brazing, and cable burning. Fume particles are extremely
                small (typically &lt;1&mu;m, often &lt;0.1&mu;m) and remain airborne for extended
                periods. Their small size allows them to penetrate deep into the lungs and, in the
                case of ultrafine particles, pass into the bloodstream.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  updated its guidance: welding fume must now be controlled with{' '}
                  <strong className="text-white">LEV or effective engineering controls</strong>, not
                  RPE alone. General ventilation is not considered sufficient for welding fume.
                </p>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">Fume Extraction Systems</p>
                <div className="grid sm:grid-cols-2 gap-3 text-sm">
                  <div className="bg-violet-500/5 rounded-lg p-3 border border-violet-400/20">
                    ...
                    <ul className="text-xs text-white/70 space-y-1">
                      ...
                      <li>Provides consistent extraction for fixed workstations</li>
                    </ul>
                  </div>
                  <div className="bg-violet-500/5 rounded-lg p-3 border border-violet-400/20">
                    ...
                    <ul className="text-xs text-white/70 space-y-1">
                      ...
                      <li>Position arm within 150&ndash;200mm of the fume source</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Solder fumes contain <strong className="text-white">rosin (colophony)</strong>
                      , which is a potent respiratory sensitiser and can cause
                  ...
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Bench-top fume extractors</strong> with
                      activated carbon filters are the standard control for soldering stations
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">limited lifespan</strong> and must be replaced
                      according to the manufacturer&rsquo;s schedule to remain effective
                    </span>
                  </div>
                </div>
              </div>
              ...
              <p>
                For <strong>on-site welding and hot work</strong> where fixed extraction is not
                available, use a <strong>mobile fume extraction unit</strong> with a flexible arm
                positioned as close to the arc/flame as possible. Supplement with RPE (minimum FFP3
                or, for prolonged work, a PAPR) where extraction alone cannot reduce exposure below
                the WEL. Remember that since the IARC reclassification, RPE alone is{' '}
                <strong>not considered adequate control</strong> for welding fume &mdash;
                engineering controls must always be the primary measure.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Effective housekeeping is one of the most underestimated controls for dust and fume
                exposure. Dust that has settled on surfaces, equipment, clothing, and flooring is
                not <strong>&ldquo;safe&rdquo;</strong> &mdash; it is a reservoir of hazardous
                particles waiting to be disturbed back into the air by foot traffic, moving
                equipment, wind, or inappropriate cleaning methods.
              </p>
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-2 text-sm text-white/80">
                    ...
                    <span>
                      ...
                      with a broom re-suspends fine respirable particles into the air. Always use an
                      appropriate class of vacuum extractor (M-class minimum; H-class for hazardous
                      dusts)
                    </span>
                  </div>
                  <div className="flex items-start gap-2 text-sm text-white/80">
                    ...
                    <span>
                      ...
                      dusting or using a dry cloth disperses particles. Use a damp cloth or mop to
                  ...
                  <div className="flex items-start gap-2 text-sm text-white/80">
                    ...
                    <span>
                      ...
                      &mdash; blowing dust with compressed air creates a concentrated airborne cloud
                      of respirable particles that can affect everyone in the area. This is one of
                      the most dangerous cleaning practices on site
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Clean as you go</strong> &mdash; do not allow
                      dust to accumulate. Clean up at regular intervals during the working day, not
                      just at the end
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Keep work areas tidy</strong> &mdash; clutter
                      creates surfaces where dust accumulates and makes cleaning difficult
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      ...
                      &mdash; dust on hands and surfaces can be ingested. Wash hands and face before
                      breaks
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Change contaminated clothing</strong> &mdash;
                      do not wear dusty work clothes home. Use designated changing areas and, where
                      provided, workplace laundry facilities
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Dispose of dust and waste correctly</strong>{' '}
                      &mdash; use sealed bags and the appropriate waste stream. Hazardous dust waste
                      must go through authorised hazardous waste disposal
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  activities including cutting, grinding, sanding, welding, soldering, and general
                  construction tasks. Each sheet specifies the control measures required for the
                  task and the class of extraction, RPE, and housekeeping needed. Use these sheets
                  as part of your COSHH assessment to identify the correct controls for each
                  activity.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  applied in the correct hierarchy. The most effective approach uses multiple
                  layers: on-tool extraction at the source, LEV for the immediate area, good
                  housekeeping to prevent accumulation, general ventilation as backup, and RPE as
                  the last line of defence. Each layer adds protection, and together they keep
                  exposure as far below the WEL as is reasonably practicable.
                </p>
              </div>
            </div>
          </div>
