...
const quickCheckQuestions = [
  {
    ...
    question:
      'What is the key difference between acute and chronic health effects of hazardous substances?',
    options: [
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'Which of the following is an occupational lung disease caused by inhaling respirable crystalline silica dust?',
  ...
  },
  {
    id: 3,
    question:
      'Once a worker becomes sensitised to a substance such as isocyanates, what is the recommended course of action?',
    options: [
  ...
  },
  {
    id: 6,
    question:
      'A worker develops red, cracked, itchy skin on their hands after months of using cement without gloves. The reaction occurs in every worker who handles wet cement without protection. This is most likely:',
    options: [
      'Allergic contact dermatitis',
      'Irritant contact dermatitis',
      'Urticaria (hives)',
  ...
  },
  {
    id: 8,
    question:
      "Which of the following factors does NOT typically increase an individual worker's susceptibility to the effects of hazardous substances?",
    options: [
...
export default function CoshhAwarenessModule1Section4() {
  useSEO({
    ...
    description:
      'Acute and chronic health effects, occupational lung and skin diseases, occupational cancers, sensitisation, reproductive effects, individual susceptibility, and the importance of health surveillance.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Acute effects:</strong> Burns, nausea, dizziness &mdash; immediate
              </li>
              <li>
                <strong>Chronic effects:</strong> Cancer, COPD, asthma &mdash; years later
              </li>
              <li>
                <strong>Sensitisation:</strong> Permanent, irreversible, no cure
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Target organs:</strong> Lungs, skin, liver, kidneys, nervous system
              </li>
              <li>
                <strong>Cancer latency:</strong> 10&ndash;40 years before diagnosis
              </li>
              <li>
                <strong>Health surveillance</strong> catches problems early
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong> acute effects</strong> and <strong>chronic effects</strong>. Understanding
                this distinction is fundamental to COSHH because it determines how quickly harm can
                occur, how it is detected, and how it should be prevented.
              </p>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  over months can cause permanent liver damage (chronic). This is why COSHH sets
                  both <strong className="text-white">short-term exposure limits (STELs)</strong>{' '}
                  &mdash; typically over 15 minutes &mdash; and{' '}
                  <strong className="text-white">workplace exposure limits (WELs)</strong> &mdash;
              ...
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-violet-400 mb-4 text-center">
                  Acute vs Chronic &mdash; Timeline Comparison
                </p>
                ...
                <div className="mt-5 bg-violet-500/10 border border-violet-500/30 rounded-lg p-3 text-center">
                  <p className="text-xs text-violet-300 font-medium">
                    Chronic effects are often irreversible by the time symptoms appear &mdash;
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Different hazardous substances target different organs and body systems.
                Understanding which organs are most at risk helps in selecting appropriate controls
                and recognising early warning signs of harm. The main <strong>target organs</strong>{' '}
                affected by workplace hazardous substances are the lungs, skin, liver, kidneys,
                nervous system, blood, and reproductive system.
              </p>

              {/* Target Organs Diagram */}
              <div className="bg-white/5 border border-white/10 p-4 sm:p-6 rounded-lg">
                <p className="text-sm font-medium text-violet-400 mb-4 text-center">
                  Target Organs &mdash; How Hazardous Substances Cause Damage
                </p>
                  ...
                  <div className="bg-violet-500/10 border border-violet-500/30 rounded-lg p-3 sm:col-span-2">
                    ...
                    <ul className="text-xs text-white/70 space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1 w-1 h-1 rounded-full bg-violet-400/60 flex-shrink-0" />
                        <span>
                          Teratogenic effects (birth defects) &mdash; lead, certain solvents
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1 w-1 h-1 rounded-full bg-violet-400/60 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The lungs are the organ most commonly damaged by workplace hazardous substances,
                because
                <strong> inhalation is the primary route of exposure</strong> for most dusts, fumes,
                vapours, and gases encountered on site. Occupational lung diseases account for a
                significant proportion of work-related ill health in the UK construction and trades
                sectors.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Silica particles cause irreversible scarring throughout the lung tissue
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">Asbestos Awareness</strong> course &mdash; they are
                  mentioned here for completeness but are not the focus of this COSHH module.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Irreversible airflow obstruction &mdash; the airways become permanently
                      narrowed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Occupational exposure to dusts and fumes accounts for approximately 15% of all
                      COPD cases
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Caused by sensitisation to substances such as isocyanates, wood dust, flour
                      dust, soldering flux fumes, and epoxy resins
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Symptoms: wheezing, breathlessness, chest tightness, cough &mdash; often worse
                      at work and better at weekends/holidays
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Once sensitised, even tiny amounts of the substance trigger a reaction
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Early detection and removal from exposure gives the best chance of recovery
                      &mdash; delayed diagnosis often means permanent damage
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Flu-like symptoms 4&ndash;8 hours after exposure: fever, chills,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Relevant to trades working in damp, poorly ventilated environments or handling
                      mouldy materials
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Flu-like symptoms: fever, chills, muscle aches, headache, metallic taste
                      &mdash; typically 3&ndash;10 hours after exposure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Sometimes called &ldquo;Monday morning fever&rdquo; because tolerance is lost
                      over the weekend
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  reversible if caught very early and the worker is immediately removed from
                  exposure. By the time symptoms are noticeable, significant permanent damage has
                  often already occurred. This is why
                  <strong className="text-white">
                    {' '}
                    prevention through proper COSHH controls is the only effective strategy
                  </strong>
                  .
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The skin is the body&rsquo;s largest organ and is frequently exposed to hazardous
                substances in the workplace. Occupational skin diseases are extremely common &mdash;
                dermatitis alone accounts for a significant proportion of all reported occupational
                diseases in the UK. The hands and forearms are the most commonly affected areas.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Red, dry, cracked, itchy, and sore skin &mdash; typically on hands and
                      forearms
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Common causes: wet cement, solvents, detergents, cutting oils, prolonged wet
                      work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Wet cement is particularly aggressive &mdash; its high alkalinity (pH
                      12&ndash;13) causes rapid skin damage
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Can be prevented by appropriate gloves, barrier creams, and good hygiene
                      practices
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Common sensitisers: epoxy resins, chromates in cement, nickel, colophony in
                      solder flux, isocyanates
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Once sensitised, the reaction is{' '}
                      <strong className="text-white">permanent</strong> &mdash; no cure, must avoid
                      substance
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Reaction may appear 24&ndash;72 hours after contact (delayed-type
                      hypersensitivity)
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      In severe cases, can progress to anaphylaxis &mdash; a life-threatening
                      allergic reaction
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Coal tar and pitch &mdash; historically a major cause in construction
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Solar UV radiation &mdash; a significant risk for outdoor workers in the
                      trades
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Painless initially &mdash; may go unnoticed until they become deep and
                      difficult to treat
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Chromium VI is also classified as IARC Group 1 carcinogen (causes lung cancer)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Also causes nasal septum perforation in workers with heavy inhalation exposure
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  bloodstream. This creates a vicious cycle: dermatitis increases chemical
                  absorption, which causes further damage. This is why early treatment and
                  prevention of occupational dermatitis is critical.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Occupational cancer is cancer caused wholly or partly by workplace exposure to
                carcinogenic substances. It is estimated that approximately{' '}
                <strong>8,000 people die each year in the UK</strong> from cancers linked to past
                occupational exposures. Many of these deaths are in the construction and trades
                sectors.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  diagnosed today were exposed decades ago, often before modern COSHH controls were
                  in place. It also means that workers exposed today may not develop cancer for many
                  years &mdash; making prevention through current COSHH controls essential for
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3">
                  {[
                    {
                      substance: 'Asbestos (all forms)',
                      cancers: 'Mesothelioma, lung cancer, laryngeal cancer, ovarian cancer',
                      trades: 'All trades working in pre-2000 buildings',
                    },
                    {
                      substance: 'Crystalline silica (respirable)',
                      cancers: 'Lung cancer',
                      trades: 'Chasing walls, drilling concrete, cutting stone/brick',
                    },
                    {
                      substance: 'Hardwood dust',
                      cancers: 'Nasal cavity and paranasal sinus cancer',
                      trades: 'Joiners, carpenters, cabinet makers',
                    },
                    {
                      substance: 'Diesel engine exhaust',
                      cancers: 'Lung cancer',
                      trades: 'Plant operators, workers in enclosed spaces with diesel equipment',
                    },
                    {
                      substance: 'Benzene',
                      cancers: 'Leukaemia (acute myeloid)',
                      trades: 'Solvent use, fuel handling, petrochemical work',
                    },
                    {
                      substance: 'Chromium VI compounds',
                      cancers: 'Lung cancer, nasal cancer',
                      trades: 'Welding stainless steel, anti-corrosion coatings, cement',
                    },
                    {
                      substance: 'Solar UV radiation',
                      cancers: 'Skin cancer (melanoma, non-melanoma)',
                      trades: 'All outdoor workers — roofers, linesmen, site workers',
                    },
                    {
                      substance: 'Coal tar and pitch',
                      cancers: 'Skin cancer, lung cancer, bladder cancer',
                      trades: 'Roofing, road surfacing (historical)',
                    },
                  ].map((item, i) => (
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  This ensures that if a worker develops cancer decades later, there is a record of
                  what they were exposed to, when, and at what levels. These records also support
                  compensation claims and epidemiological research.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Sensitisation is one of the most important concepts in COSHH because once a worker
                becomes sensitised to a substance,{' '}
                <strong>there is no cure and no safe level of future exposure</strong>. The worker
                must permanently avoid the substance, which can mean a change of job role, trade, or
                even career.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    ...
                    <p className="text-xs text-white/60 mt-1">
                      ...
                      months, or even years of repeated exposure before the immune system becomes
                      fully primed. During this period, the worker may believe the substance is
                      harmless because they have no symptoms.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 p-3 rounded-lg">
                    <p className="text-sm font-medium text-violet-300">
                  ...
                  <div className="bg-red-500/10 border border-red-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-xs text-white/60 mt-1">
                      ...
                      breathlessness, chest tightness). For skin sensitisers, this means allergic
                      contact dermatitis (redness, blistering, intense itching). Each reaction can
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white"> not sufficient</strong> protection because no mask
                  provides 100% filtration. The only option is{' '}
                  <strong className="text-white">complete, permanent avoidance</strong> of the
                  sensitising substance. This may require redeployment to a different role or area,
                  and in some cases, the worker may need to change trade entirely.
                </p>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Common Sensitisers in the Electrical &amp; Construction Trades
                </p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {[
                    {
                      name: 'Isocyanates',
                      source: 'Two-pack spray paints, spray foams, PU coatings, adhesives',
                      effect: 'Respiratory sensitiser → occupational asthma',
                    },
                    {
                      name: 'Epoxy resins',
                      source: 'Adhesives, coatings, flooring systems, encapsulants',
                      effect: 'Skin and respiratory sensitiser → dermatitis, asthma',
                    },
                    {
                      name: 'Chromates (Cr VI)',
                      source: 'Portland cement, anti-corrosion coatings, plating',
                      effect: 'Skin sensitiser → allergic dermatitis, chrome ulcers',
                    },
                    {
                      name: 'Colophony (rosin)',
                      source: 'Soldering flux fumes, adhesives, sealants',
                      effect: 'Respiratory sensitiser → occupational asthma',
                    },
                    {
                      name: 'Wood dust',
                      source: 'Working with timber, MDF, hardwoods',
                      effect: 'Respiratory sensitiser → occupational asthma, nasal cancer',
                    },
                    {
                      name: 'Latex proteins',
                      source: 'Natural rubber latex gloves',
                      effect: 'Skin and respiratory sensitiser → urticaria, anaphylaxis',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-white/5 border border-white/10 p-3 rounded-lg">
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">H317</strong>
                  (&ldquo;May cause an allergic skin reaction&rdquo;). Both use the GHS
                  &ldquo;health hazard&rdquo; pictogram. Any substance carrying these hazard
                  statements requires specific COSHH controls and health surveillance for exposed
                  workers.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                These effects are particularly concerning because they can affect not only the
                exposed worker but potentially their future children as well.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-violet-500/10 border border-violet-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-xs text-white/60 mt-1">
                      ...
                      include certain solvents (glycol ethers), lead compounds, and some pesticides.
                      COSHH assessments must specifically address risks to pregnant workers and
                  ...
                  <div className="bg-violet-500/10 border border-violet-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-xs text-white/60 mt-1">
                      ...
                      genetic changes. Examples include benzene, ethylene oxide, and certain
                      chromium VI compounds. Substances classified as mutagens carry the GHS hazard
                      statements H340 or H341.
                    </p>
                  </div>
                  ...
                  <div className="bg-violet-500/10 border border-violet-500/30 p-3 rounded-lg">
                    ...
                    <p className="text-xs text-white/60 mt-1">
                      ...
                      2-ethoxyethanol) have been shown to damage sperm production. Women working
                      with lead must have blood lead levels monitored, and the suspension level for
                      women of reproductive capacity is lower than for men.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  pesticides can all damage male reproductive function. COSHH assessments must
                  consider reproductive risks for all workers, not just pregnant women. Men exposed
                  to reproductive toxicants may experience reduced fertility or produce damaged
                  sperm that could affect their children.
                </p>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  solvent exposure can lead to falls from height, electric shock, and other serious
                  accidents. A worker who feels &ldquo;a bit dizzy&rdquo; or
                  &ldquo;light-headed&rdquo; while using solvents in an enclosed space is
                  experiencing acute neurotoxic effects and must stop work immediately and move to
                  fresh air.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Not everyone responds to hazardous substances in the same way. The same exposure
                that causes no apparent harm in one worker may cause significant illness in another.
                This is known as <strong>individual susceptibility</strong>, and it is a critical
                factor that must be considered in every COSHH assessment.
              </p>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-violet-400 mb-3">
                  Factors That Increase Individual Susceptibility
                </p>
                <div className="space-y-3">
                  {[
                    {
                      ...
                      detail:
                        'Workers with asthma, COPD, or other lung conditions are significantly more vulnerable to respiratory irritants and sensitisers. They may react at exposure levels well below the WEL that would not affect a healthy colleague.',
                    },
                    {
                      factor: 'Pre-existing skin conditions',
                      detail:
                        'Workers with eczema, psoriasis, or damaged skin are much more vulnerable to skin irritants and sensitisers. The compromised skin barrier allows greater chemical absorption and makes dermatitis more likely.',
                    },
                    {
                      factor: 'Genetic factors',
                      detail:
                        "Individual genetic variations can affect how quickly the body metabolises (breaks down) hazardous chemicals. Some people are 'fast metabolisers' and others 'slow metabolisers', affecting how long a toxic substance remains active in the body.",
                    },
                    {
                      factor: 'Smoking',
                      detail:
                        'Smoking damages the lungs and reduces their ability to clear inhaled particles. Smokers exposed to workplace dusts and fumes are at significantly increased risk of occupational lung disease. The synergistic effect of smoking and asbestos (50x lung cancer risk) is the most dramatic example.',
                    },
                    {
                      factor: 'Age',
                      detail:
                        'Older workers may have reduced lung function and less efficient detoxification mechanisms. Younger or apprentice workers may be less experienced in recognising hazards and using controls correctly.',
                    },
                    {
                      factor: 'Medication interactions',
                      detail:
                        "Certain medications — particularly those metabolised by the liver (e.g. paracetamol, statins, some antibiotics) — can interact with workplace chemicals, increasing toxicity or reducing the liver's ability to detoxify absorbed substances.",
                    },
                    {
                      factor: 'Previous sensitisation',
                      detail:
                        'A worker already sensitised to one substance may have a hyperactive immune system that is more likely to develop sensitivity to related chemicals. Cross-sensitisation between chemically similar substances is well documented.',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-white/5 border border-white/10 p-3 rounded-lg">
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  pre-existing asthma, pregnant workers, or young workers &mdash; and ensure that
                  control measures are adequate to protect
                  <strong className="text-white"> the most susceptible individuals</strong>, not
                  just the average worker. Workplace exposure limits are set to protect the majority
                  of the working population, but they may not be sufficient for particularly
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="bg-white/5 border border-white/10 p-3 rounded-lg mb-3">
                  ...
                  <ul className="text-xs text-white/70 space-y-1.5">
                    <li className="flex items-start gap-2">
                      <span className="mt-1 w-1 h-1 rounded-full bg-violet-400/60 flex-shrink-0" />
                      <span>
                        There is an identifiable disease or adverse health effect linked to the
                        substance
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {[
                    {
                      type: 'Spirometry (Lung Function Tests)',
                      purpose:
                        'Detects early airway obstruction in workers exposed to respiratory sensitisers, dusts, and fumes. Measures FEV1 and FVC.',
                    },
                    {
                      type: 'Skin Inspections',
                      purpose:
                        'Detects early signs of dermatitis in workers handling known skin irritants or sensitisers. Can be done by trained supervisors or occupational health professionals.',
                    },
                    {
                      type: 'Blood/Urine Monitoring',
                      purpose:
                        'Biological monitoring for specific substances, e.g. blood lead levels for lead workers, urine tests for isocyanate metabolites.',
                    },
                    {
                      type: 'Questionnaires',
                      purpose:
                        'Symptom questionnaires can identify early respiratory or skin symptoms before they become clinically significant.',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-white/5 border border-white/10 p-3 rounded-lg">
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  asthma, early detection and removal from exposure gives the best chance of full
                  recovery. If diagnosis is delayed and the worker continues to be exposed, the
                  asthma becomes permanent and irreversible. For occupational dermatitis, early skin
                  checks can catch the first signs before the skin barrier is seriously compromised.
                  For lead exposure, regular blood tests ensure levels remain below the action and
                  suspension levels. Health surveillance is not a substitute for proper COSHH
                  controls &mdash; it is a <strong className="text-white">safety net</strong> that
                  detects early signs of failure in those controls.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  include the name of the worker, the date of each health surveillance procedure,
                  the name of the person conducting the surveillance, the outcome, and any
                  restrictions or recommendations. These records are essential for tracking
                  long-term health trends, supporting compensation claims, and providing evidence in
                  legal proceedings.
                </p>
              </div>
            </div>
