...
const faqs = [
  ...
  {
    question: 'What does "Danger" vs "Warning" mean on a CLP-classified substance label?',
    answer:
  ...
  {
    question: 'Why are sensitisers particularly concerning in electrical work?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'What physical form do welding fumes take when they enter the atmosphere?',
    options: [
  ...
  {
    id: 3,
    question: 'Under CLP, what signal word is used for the most severe hazard categories?',
  ...
  {
    id: 4,
    question: 'What is the workplace exposure limit (WEL) for respirable crystalline silica dust?',
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>8 physical forms:</strong> solids, liquids, gases, vapours, mists, fumes,
                dusts, fibres
              </li>
              <li>
                <strong>9 GHS pictograms:</strong> standardised hazard symbols on red diamond labels
              </li>
              <li>
                <strong>4 biological hazard groups:</strong> from low risk (Group 1) to severe with
                no treatment (Group 4)
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            <p className="text-violet-400/90 text-base font-medium mb-2">Key Limits</p>
            <ul className="text-base text-white space-y-1.5">
              <li>
              ...
              <li>
                <strong>Silica dust WEL:</strong> 0.1 mg/m&sup3; &mdash; a Group 1 carcinogen
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The COSHH Regulations 2002 cover a vast range of substances that can harm health.
                Before you can control a hazardous substance, you need to understand{' '}
                <strong>what it is</strong>, <strong>what form it takes</strong>, and{' '}
                <strong>how it is classified</strong>. This section introduces the different ways
                hazardous substances are categorised &mdash; by physical form, by chemical type, and
                by regulatory classification.
              </p>

              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Why This Matters:</strong> The physical form
                  of a substance determines how it enters the body, how far it travels in the air,
                  how deep it penetrates the lungs, and what control measures are effective. A
                  substance that is harmless as a solid block can be lethal as a fine dust or
                  vapour. Understanding substance types is the foundation of every COSHH risk
                  assessment.
                </p>
              </div>
              ...
              <p>
                ...
                nanotechnology particles, biological agents (bacteria, viruses, fungi), and any
                other substance that is connected with work and can damage health. The only
                substances excluded from COSHH are asbestos (covered by CAR 2012), lead (covered by
                the Control of Lead at Work Regulations 2002), radioactive materials (covered by IRR
                2017), and substances that are hazardous only because they are at high pressure,
                extreme temperature, or are explosive or flammable (covered by other specific
                regulations).
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Chemicals used directly at work &mdash; adhesives, solvents, paints, resins,
                      cleaning agents
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Substances generated by work processes &mdash; welding fume, wood dust, silica
                      dust, solder fume
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Naturally occurring substances &mdash; grain dust, flour dust, enzyme proteins
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Biological agents &mdash; bacteria, viruses, fungi, parasites encountered at
                      work
                    </span>
                  </li>
                </ul>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Hazardous substances can exist in eight distinct physical forms. The form determines
                the route of exposure, how the substance behaves in the working environment, and
                what control measures are required. Many substances can exist in more than one form
                depending on how they are used &mdash; for example, a solid metal becomes a fume
                when welded.
              </p>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Key Principle:</strong> The smaller the
                  particle, the deeper it penetrates into the respiratory system. Coarse dust
                  particles are trapped in the nose and upper airways. Fine respirable dust reaches
                  the alveoli (gas exchange region) deep in the lungs. Fume particles are even
                  smaller &mdash; typically less than 1 micrometre &mdash; and can penetrate into
                  the bloodstream via the alveoli.
                </p>
              </div>

              <p>
                Understanding physical form is critical for selecting the right control measures. A
                local exhaust ventilation (LEV) system that captures dust may not be effective
                against vapours. A chemical cartridge respirator designed for organic vapours will
                not protect against particulates. The COSHH assessment must consider the form the
                substance takes during the actual work activity, not just its form in the container.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                is an internationally agreed system for classifying hazardous chemicals and
                communicating information about their hazards through standardised labels and safety
                data sheets. In the UK and EU, GHS is implemented through the{' '}
                <strong>CLP Regulation (Classification, Labelling and Packaging)</strong>.
              </p>

              <p>
                Before GHS/CLP, different countries used different classification systems. A
                substance classified as &ldquo;toxic&rdquo; in one country might have been labelled
                &ldquo;harmful&rdquo; in another. This was dangerous for international trade and for
                workers who encountered imported products. GHS created a single, worldwide standard.
              </p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-[#1a1a1a] p-3 rounded-lg">
                    ...
                    <p className="text-xs text-white/80">
                      ...
                      hazards). Some categories have no signal word at all.
                    </p>
                  </div>
                  <div className="bg-[#1a1a1a] p-3 rounded-lg">
                    <p className="text-sm font-semibold text-violet-400 mb-1">
                    ...
                    <p className="text-xs text-white/80">
                      ...
                      statements) describe protective measures (e.g. P280: &ldquo;Wear protective
                      gloves&rdquo;).
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">H2xx</strong> &mdash; Physical hazards
                      (flammable, explosive, oxidising, corrosive to metals)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">H3xx</strong> &mdash; Health hazards (acute
                      toxicity, skin corrosion, sensitisation, carcinogenicity)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">H4xx</strong> &mdash; Environmental hazards
                      (aquatic toxicity)
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  composition, first aid, fire-fighting measures, exposure controls, and disposal.
                  The SDS is the primary source of information for your COSHH assessment. If a
                  product does not have an SDS, do not use it until one is obtained.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The GHS/CLP system uses nine standardised hazard pictograms. Each is displayed as a
                black symbol on a white background within a red diamond-shaped border. Every worker
                should be able to recognise these symbols instantly &mdash; they provide an
                  ...
                  {[
                    {
                      symbol: 'GHS01',
                      name: 'Exploding Bomb',
                      hazards: 'Explosives, self-reactive substances, organic peroxides',
                    ...
                    },
                    {
                      ...
                      example: 'Acetone, white spirit, contact adhesives, aerosol sprays',
                    },
                    {
                      symbol: 'GHS03',
                      name: 'Flame over Circle',
                      hazards: 'Oxidising gases, liquids, solids',
                      example: 'Oxygen cylinders, hydrogen peroxide, bleach concentrates',
                    },
                    {
                      symbol: 'GHS04',
                      name: 'Gas Cylinder',
                    ...
                    },
                    {
                      symbol: 'GHS05',
                      name: 'Corrosion',
                      hazards: 'Corrosive to skin, serious eye damage, corrosive to metals',
                      example: 'Hydrochloric acid, sodium hydroxide (caustic soda), battery acid',
                    },
                    {
                      symbol: 'GHS06',
                      ...
                      example: 'Methanol, certain pesticides, hydrogen cyanide',
                    },
                    {
                      symbol: 'GHS07',
                      ...
                      example: 'Many cleaning products, some solvents, cement powder',
                    },
                    {
                      symbol: 'GHS08',
                      name: 'Health Hazard',
                      ...
                      example: 'Benzene, silica dust, isocyanates, some epoxy hardeners',
                    },
                    {
                      symbol: 'GHS09',
                      name: 'Environment',
                      hazards: 'Hazardous to aquatic environment (acute and chronic)',
                      example: 'Many pesticides, some solvents, waste oils, transformer PCBs',
                    },
                  ].map((item) => (
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">GHS08 &mdash; The One to Watch:</strong> The
                  &ldquo;health hazard&rdquo; pictogram (silhouette with a starburst on the chest)
                  is particularly important because it indicates the most serious chronic health
                  effects: cancer, genetic damage, reproductive toxicity, respiratory sensitisation,
                  and specific target organ toxicity. Many substances you encounter in electrical
                  work carry this pictogram &mdash; including isocyanate-based foams, some epoxy
                  hardeners, and silica-generating activities.
                </p>
              </div>

              <p>
                A single product can carry multiple pictograms. For example, a solvent-based
                adhesive might display the flame (flammable), the exclamation mark (irritant), and
                the health hazard (contains a respiratory sensitiser). You must read all the
                information on the label and SDS, not just react to the most obvious pictogram.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Chemical hazards in the workplace can be grouped into categories based on their
                chemical nature and the types of harm they cause. Electricians encounter many of
                these daily &mdash; from solvent-based adhesives and cable-pulling lubricants to the
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">What they are:</strong> Substances with a pH
                        below 7 that can corrode skin, eyes, and metals
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Examples:</strong> Sulphuric acid (lead-acid
                        batteries), hydrochloric acid (brick/mortar cleaning), phosphoric acid (rust
                        removers)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Risks:</strong> Severe skin burns, permanent
                        eye damage, toxic fumes when heated or mixed with other chemicals
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-white">What they are:</strong> Substances with a pH
                        above 7 &mdash; often more damaging to skin than acids because they dissolve
                        tissue without immediate pain
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Examples:</strong> Wet cement (calcium
                        hydroxide, pH ~12-13), caustic soda, lime, strong degreasing agents
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Risks:</strong> Deep alkali burns (penetrate
                        further than acid burns), cement dermatitis, chrome ulceration from
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">What they are:</strong> Liquids that dissolve
                        other substances. Many are volatile (evaporate readily), producing flammable
                        or toxic vapours
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Examples:</strong> Acetone, white spirit,
                        toluene, xylene, isopropyl alcohol, trichloroethylene
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Risks:</strong> Dizziness, headaches,
                        narcotic effects (drowsiness, loss of coordination), skin
                        defatting/dermatitis, liver and kidney damage with chronic exposure, some
                        are carcinogenic (benzene)
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    ...
                    <ul className="text-sm text-white/80 space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>Cyanoacrylate adhesives (superglues)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>Polyurethane sealants and foams (isocyanate-based)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>
                  ...
                  <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                    ...
                    <ul className="text-sm text-white/80 space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>Cutting oils and lubricants (dermatitis, oil acne)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>Diesel and petrol (skin defatting, benzene in petrol)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>Transformer oil (older oils may contain PCBs)</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  produce toxic fumes. Always follow the SDS and never mix substances unless the
                  manufacturer&rsquo;s instructions specifically require it.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Dust is one of the most underestimated hazards in the construction industry. It
                causes more deaths than falls from height. The HSE estimates that occupational lung
                disease causes <strong>approximately 12,000 deaths per year in the UK</strong>, with
                construction workers being among the most affected groups. Many of these deaths are
                caused by dust exposure that occurred decades earlier.
              </p>

              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Why &ldquo;Silent Killer&rdquo;?</strong> Dust
                  particles small enough to cause serious lung disease are invisible to the naked
                  eye. You cannot see respirable dust. The visible cloud of dust you see when
                  cutting concrete is mostly coarse particles that are filtered out by the nose and
                  throat. The real danger is the invisible fraction that passes through your airways
                  and reaches the deepest parts of your lungs &mdash; and stays there permanently.
                </p>
              </div>
                ...
                <div className="space-y-3">
                  <div className="bg-[#1a1a1a] p-3 rounded-lg">
                    <div className="flex items-center justify-between mb-1">
                      <p className="text-sm font-semibold text-violet-400">Inhalable Dust</p>
                  ...
                  <div className="bg-[#1a1a1a] p-3 rounded-lg">
                    <div className="flex items-center justify-between mb-1">
                      <p className="text-sm font-semibold text-violet-400">Respirable Dust</p>
                      <span className="text-xs font-mono bg-violet-500/20 text-violet-300 px-2 py-0.5 rounded">
                        WEL: 4 mg/m&sup3;
                      </span>
                    </div>
                  ...
                  <div className="bg-[#1a1a1a] p-3 rounded-lg border border-red-500/20">
                    ...
                    <p className="text-xs text-white/80">
                      ...
                      (chasing walls, drilling holes, cutting chases for trunking). Causes
                      silicosis, lung cancer, COPD, and kidney disease. The WEL is 40 times lower
                      than general respirable dust.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hardwood dust:</strong> WEL 3 mg/m&sup3;
                      &mdash; classified as a nasal carcinogen. Generated when drilling through
                      hardwood floors, dado rails, or timber frames
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Softwood dust:</strong> WEL 5 mg/m&sup3;
                      &mdash; causes occupational asthma and rhinitis in sensitised individuals
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cement dust:</strong> Contains hexavalent
                      chromium (a skin sensitiser) and calcium compounds (alkaline, pH 12-13).
                      Causes cement dermatitis and respiratory irritation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Plaster dust:</strong> Gypsum-based, causes
                      respiratory irritation and eye irritation. Generated when chasing into
                      plasterboard
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  generate respirable crystalline silica. Every one of these tasks requires dust
                  suppression (water), local exhaust ventilation (on-tool extraction), or both. A
                  dust mask alone is <strong className="text-white">not sufficient</strong> as the
                  sole control measure for silica dust.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Fumes, vapours, and gases are airborne hazards that enter the body primarily through
                inhalation. They behave differently in the workplace and require different control
                strategies. It is important to understand the distinction between them.
              </p>
              ...
              <div className="space-y-3">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80 mb-2">
                    ...
                    &mdash; and can remain airborne for hours.
                  </p>
                  <div className="space-y-2">
                    <div className="bg-[#1a1a1a] p-3 rounded-lg">
                      ...
                      <p className="text-xs text-white/80">
                        ...
                        <strong className="text-white">February 2019</strong>, the HSE reclassified
                        all welding fume (including mild steel welding fume) as a human carcinogen.
                        All welding must now be carried out with adequate LEV or RPE &mdash; even
                        outdoors in some circumstances.
                      </p>
                    </div>
                    <div className="bg-[#1a1a1a] p-3 rounded-lg">
                      ...
                      <p className="text-xs text-white/80">
                        ...
                        cause of occupational asthma. Once sensitised, even tiny exposures can
                        trigger severe asthma attacks. Lead-free solder still produces hazardous
                        rosin fume.
                      </p>
                    </div>
                    <div className="bg-[#1a1a1a] p-3 rounded-lg">
                      ...
                      <p className="text-xs text-white/80">
                        ...
                        toxic decomposition products. In fires, burning PVC produces extremely toxic
                        fumes including dioxins and furans. Never burn PVC cable insulation.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Solvent vapours:</strong> From paints,
                        adhesives, cleaning agents, degreasers. Cause headaches, dizziness,
                        drowsiness, and liver/kidney damage with prolonged exposure
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Isocyanate vapours:</strong> From spray foam
                        insulation, two-pack paints, and polyurethane coatings. Extremely potent
                        respiratory sensitisers with very low WELs (typically 0.02 mg/m&sup3;)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Fuel vapours:</strong> Petrol vapour is
                        heavier than air and accumulates in low-lying areas, creating fire and
                        explosion risks as well as inhalation hazards (benzene content)
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Carbon monoxide (CO):</strong> Colourless,
                        odourless, lethal. Produced by incomplete combustion of fuels. Binds to
                        haemoglobin 200-250 times more strongly than oxygen
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Hydrogen sulphide (H&sub2;S):</strong>{' '}
                        &ldquo;Rotten egg&rdquo; smell at low concentrations, but at higher
                        concentrations it deadens the sense of smell &mdash; making it undetectable
                        and extremely dangerous. Found in sewers, drains, and confined spaces
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Nitrogen/argon/CO&sub2;:</strong> Simple
                        asphyxiants that displace oxygen in enclosed spaces. Not toxic themselves
                        but cause suffocation by reducing the oxygen concentration below 19.5%
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                      <span>
                        <strong className="text-white">SF&sub6; (sulphur hexafluoride):</strong>{' '}
                        Used as an insulating gas in high-voltage switchgear. Non-toxic but a potent
                        greenhouse gas and a simple asphyxiant in enclosed spaces. Decomposition
                        products (from electrical arcing) are highly toxic
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  ventilated spaces. Always check the atmosphere before entry, ensure adequate
                  ventilation, and follow the Confined Spaces Regulations 1997. Never enter a
                  confined space without a safe system of work and a permit to work where required.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Biological agents are micro-organisms (and the toxins they produce) that can cause
                infection, allergy, or toxic effects in humans. They are covered by COSHH because
                they are substances hazardous to health encountered at work. In construction and
                electrical work, biological agents are more common than many workers realise.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Bacteria:</strong> Single-celled organisms.
                      Examples relevant to construction: Leptospira (causes Weil&rsquo;s disease
                      &mdash; spread through rat urine in water), Legionella (Legionnaires&rsquo;
                      disease &mdash; water systems, cooling towers), tetanus (Clostridium tetani
                      &mdash; soil contamination through puncture wounds)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Viruses:</strong> Sub-microscopic infectious
                      agents. Examples: hepatitis B and C (bloodborne, risk from sharps injuries),
                      norovirus (contaminated welfare facilities), respiratory viruses
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Fungi:</strong> Including moulds, yeasts, and
                      fungal spores. Examples: Aspergillus (found in damp buildings, causes
                      aspergillosis and allergic reactions), dry rot fungi, mould spores in ceiling
                      voids and damp wall cavities
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Parasites:</strong> Organisms that live on or
                      in a host. Examples: roundworms in contaminated soil (toxocariasis), bird
                      mites in loft spaces, parasites in untreated water
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">The Four Hazard Groups</p>
                <div className="space-y-2">
                  <div className="bg-[#1a1a1a] p-3 rounded-lg">
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">For Electricians:</strong> The most relevant
                  biological risks in electrical work include Weil&rsquo;s disease (leptospirosis)
                  when working in areas with rat contamination (basements, drains, old buildings),
                  Legionella when working on or near water systems, mould spores when opening up
                  damp wall cavities or ceiling voids, bird and bat droppings in loft spaces
                  (histoplasmosis risk), and tetanus from puncture wounds on contaminated sites.
                  Ensure tetanus vaccination is up to date and always wash hands before eating,
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Certain categories of hazardous substance are considered so dangerous that COSHH
                imposes additional, stricter requirements for their control. These are{' '}
                <strong>carcinogens, mutagens, and substances toxic to reproduction (CMRs)</strong>,
                and <strong>sensitisers</strong> (both respiratory and skin).
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Definition:</strong> Substances that can cause
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">CLP classification:</strong> Category 1A (known
                      human carcinogen), Category 1B (presumed human carcinogen), Category 2
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Examples in electrical work:</strong>{' '}
                      Respirable crystalline silica (from concrete/brick cutting), welding fume,
                      benzene (in some solvents and petrol), hexavalent chromium (in stainless steel
                      welding fume and wet cement), some wood dusts (hardwood)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">H-codes:</strong> H350 (&ldquo;May cause
                      cancer&rdquo;), H351 (&ldquo;Suspected of causing cancer&rdquo;)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Definition:</strong> Substances that can cause
                      heritable genetic damage (mutations in DNA that can be passed to offspring)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">H-codes:</strong> H340 (&ldquo;May cause
                      genetic defects&rdquo;), H341 (&ldquo;Suspected of causing genetic
                      defects&rdquo;)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Key point:</strong> Mutations are heritable
                      &mdash; they affect not just the exposed worker but potentially their future
                      children
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Definition:</strong> Substances that can impair
                      fertility in men or women, or cause developmental harm to the unborn child
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">H-codes:</strong> H360 (&ldquo;May damage
                      fertility or the unborn child&rdquo;), H361 (&ldquo;Suspected of damaging
                      fertility or the unborn child&rdquo;)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Examples:</strong> Lead compounds, some glycol
                      ethers (in certain paints and coatings), carbon disulphide, some pesticides
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="text-sm text-white/80 space-y-2">
                  ...
                  <ul className="space-y-1">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-white">Substitution</strong> must be considered as a
                        priority &mdash; can the CMR be replaced with a less hazardous substance?
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Health surveillance</strong> is mandatory for
                        workers regularly exposed to CMRs
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="bg-[#1a1a1a] p-3 rounded-lg">
                    ...
                    <ul className="text-xs text-white/80 space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>Epoxy resin hardeners (amine-based)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                  ...
                  <div className="bg-[#1a1a1a] p-3 rounded-lg">
                    ...
                    <ul className="text-xs text-white/80 space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>Hexavalent chromium (wet cement)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                        <span>Nickel compounds (metalwork, plating)</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  that caused the original sensitisation &mdash; can trigger severe allergic
                  reactions. For respiratory sensitisers, this means{' '}
                  <strong className="text-white">permanent occupational asthma</strong>. For skin
                  sensitisers, it means{' '}
                  <strong className="text-white">lifelong allergic contact dermatitis</strong>.
                  Sensitisation can be <strong className="text-white">career-ending</strong> for
                  electricians who regularly work with epoxy resins, solder flux, or
                  isocyanate-based products. Prevention is the only effective strategy.
                </p>
              </div>

              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Prevention for Electricians:</strong> When
                  using epoxy resins for cable joints, always wear chemical-resistant gloves
                  (nitrile, not latex), use barrier cream on exposed skin, work in well-ventilated
                  areas, and never handle mixed resin with bare hands. When soldering, always use
                  fume extraction (a bench-top LEV unit or tip extraction). When working near spray
                  foam insulation, ensure the area is cleared and ventilated before you enter
                  &mdash; isocyanate vapour can persist for hours after spraying. Health
                  surveillance (lung function testing and skin checks) must be provided for workers
                  regularly exposed to sensitisers.
                </p>
              </div>
            </div>
          </div>
