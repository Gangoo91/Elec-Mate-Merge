...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question: 'Which of the following is NOT typically found in a chemical spill kit?',
    options: [
      'A fire extinguisher',
...
const faqs = [
  {
    question: 'Can I transfer a hazardous substance into an unlabelled container?',
    answer:
  ...
  {
    question: 'How long must hazardous waste consignment notes be kept?',
    answer:
  ...
  {
    question: 'Do I need to be a licensed waste carrier to move hazardous waste on my own site?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 5,
    question: 'What is the FIRST action to take when a significant chemical spill occurs?',
    options: [
...
export default function CoshhAwarenessModule4Section4() {
  useSEO({
    title: 'Storage, Handling & Disposal | COSHH Awareness Module 4.4',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>DSEAR 2002:</strong> Zone classification for explosive atmospheres
              </li>
              <li>
                <strong>Segregation:</strong> Oxidisers away from flammables, acids from alkalis
              </li>
              <li>
                <strong>Bunding:</strong> Secondary containment at 110% of largest container
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Spill kits:</strong> Absorbent pads, pillows, socks, neutralisers, PPE
              </li>
              <li>
                <strong>Hazardous waste:</strong> EWC codes, consignment notes, 3-year records
              </li>
              <li>
                <strong>Empty containers:</strong> Triple rinse, deface label, correct waste route
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                apply wherever dangerous substances are stored, handled, or used at work. A
                dangerous substance is any substance that could create a risk of fire, explosion, or
                a similar energy-releasing event &mdash; including flammable gases, liquids, and
                dusts.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Risk assessment:</strong> Employers must assess
                      the risks from dangerous substances, covering fire, explosion, and similar
                      events
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Elimination or reduction:</strong> Replace
                      dangerous substances with safer alternatives where reasonably practicable
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Zone classification:</strong> Areas where
                      explosive atmospheres may form must be classified into zones (0, 1, 2 for
                      gases; 20, 21, 22 for dusts)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">ATEX equipment:</strong> Only equipment and
                      protective systems certified for the relevant zone category may be used within
                      classified zones
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ignition source control:</strong> Eliminate or
                      control all potential ignition sources within classified zones &mdash; naked
                      flames, sparking tools, hot surfaces, static discharge
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">continuously</strong> or for long periods
                      (e.g., inside a storage tank)
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-violet-400 font-bold min-w-[52px]">Zone 1</span>
                    <span>
                      Explosive atmosphere is{' '}
                      <strong className="text-white">likely to occur occasionally</strong> during
                      normal operation (e.g., around filling points)
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-violet-400 font-bold min-w-[52px]">Zone 2</span>
                    <span>
                      Explosive atmosphere is{' '}
                      <strong className="text-white">not likely during normal operation</strong> but
                      may occur briefly (e.g., surrounding area during abnormal conditions)
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Signage:</strong> All DSEAR-classified zones
                  must display the <strong>EX warning triangle</strong> (yellow triangle with
                  &ldquo;EX&rdquo;) at all entry points. Zone markings must be clearly visible and
                  maintained. Any electrical installation work within classified zones must be
                  carried out by competent persons in accordance with BS&nbsp;EN&nbsp;60079
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Not all hazardous substances can be stored together. Certain chemical combinations
                create{' '}
                <strong>
                  dangerous reactions &mdash; fire, explosion, toxic gas release, or violent
                  exothermic reactions
                </strong>
                . Segregation rules ensure incompatible chemicals are kept physically apart so that
                a spill, leak, or container failure cannot bring them into contact.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Oxidisers + Flammables:</strong> Oxidisers
                      supply oxygen that accelerates combustion &mdash; contact can cause
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Acids + Alkalis:</strong> Mixing produces
                      violent exothermic neutralisation reactions with potential splashing and gas
                      release
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      Contact with water produces flammable hydrogen gas or toxic fumes (e.g.,
                      alkali metals, calcium carbide)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-5 h-5 rounded-full bg-red-500/20 border border-red-500/40 flex items-center justify-center flex-shrink-0 text-[10px] font-bold text-red-400">
                    ...
                    <span>
                      ...
                      Strong acids (e.g., sulphuric, nitric) can ignite organic materials on contact
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Separate cabinets:</strong> Incompatible groups
                      stored in different cabinets within the same room
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Separate rooms:</strong> High-risk
                      incompatibles stored in entirely separate areas with independent bunding
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Distance separation:</strong> Where separate
                      rooms are not available, a minimum distance of 3&nbsp;metres between
                      incompatible groups
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Consult the SDS:</strong> Section 7 (Handling
                      and Storage) and Section 10 (Stability and Reactivity) of every Safety Data
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-white mb-4 flex items-center gap-3">
            <span className="text-violet-400/80 text-sm font-normal">&nbsp;</span>
            ...
            <div className="bg-[#111] border-2 border-violet-500/40 rounded-xl p-4 sm:p-6 overflow-x-auto">
              ...
              <div className="min-w-[320px] space-y-3">
                ...
                <div className="grid grid-cols-5 gap-1.5 items-center text-center">
                  ...
                  <div className="bg-red-500/15 border border-red-500/30 rounded p-1.5">
                    <span className="text-[10px] sm:text-xs text-red-400 font-bold">&#10007;</span>
                  </div>
                  <div className="bg-red-500/15 border border-red-500/30 rounded p-1.5">
                    <span className="text-[10px] sm:text-xs text-red-400 font-bold">&#10007;</span>
                  </div>
                ...
                <div className="grid grid-cols-5 gap-1.5 items-center text-center">
                  <div className="bg-blue-500/20 border border-blue-500/40 rounded p-1.5">
                    <span className="text-[9px] sm:text-[10px] font-bold text-blue-400">Acids</span>
                  </div>
                  <div className="bg-red-500/15 border border-red-500/30 rounded p-1.5">
                    <span className="text-[10px] sm:text-xs text-red-400 font-bold">&#10007;</span>
                  </div>
              ...
              <div className="mt-3 bg-violet-500/10 border border-violet-500/30 rounded-lg p-3 text-center">
                <p className="text-[10px] sm:text-xs text-violet-300 font-medium">
                  Always consult Safety Data Sheet Section&nbsp;7 and Section&nbsp;10 for
                  substance-specific incompatibilities
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>original containers</strong> wherever possible. The original container has
                been specifically designed for the substance it holds, carries the correct CLP
                label, and is constructed from compatible materials. Transferring substances into
                unsuitable containers introduces risks of leakage, chemical reaction with the
                container material, and loss of hazard information.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Product name:</strong> Chemical identity of the
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">GHS hazard pictograms:</strong> Red-bordered
                      diamonds showing the hazard type (flame, skull, exclamation mark, etc.)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Signal word:</strong> &ldquo;Danger&rdquo;
                      (more severe) or &ldquo;Warning&rdquo; (less severe)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hazard statements (H-codes):</strong> Describe
                      the nature and degree of hazard
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      ...
                      Recommended prevention, response, storage, and disposal measures
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Supplier details:</strong> Name, address, and
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Bunds must hold <strong className="text-white">at least 110%</strong> of the
                      volume of the largest single container within the bund
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">chemically resistant</strong> to the substances
                      being stored
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Bunds must be <strong className="text-white">impervious to liquids</strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">point-of-use containment</strong> for small
                      volumes
                    </span>
                  </li>
                </ul>
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      Fire-resistant construction (min. 30&nbsp;min), self-closing doors, integral
                      bunding, ventilation points
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Corrosive substance cabinets:</strong>{' '}
                      Acid-resistant lining, separate compartments for acids and alkalis, integral
                      sump
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">COSHH cupboard (point-of-use):</strong> Small
                      lockable cabinet holding{' '}
                      <strong className="text-white">minimum day-to-day working quantities</strong>{' '}
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Storage Environment:</strong> Chemical stores
                  must have <strong>temperature control</strong> (many substances have maximum
                  storage temperatures listed on the SDS), <strong>adequate ventilation</strong> to
                  prevent vapour build-up (natural or mechanical), and{' '}
                  <strong>fire detection</strong> linked to the site alarm system. Store rooms must
                  be clearly signed with GHS/CLP hazard symbols showing which substance classes are
                  stored within.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Safe handling of hazardous substances requires careful attention to{' '}
                <strong>
                  decanting procedures, mixing precautions, on-site transportation, and personal
                  hygiene
                </strong>
                . The majority of workplace chemical exposure incidents occur during routine
                handling tasks &mdash; not during emergencies.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Use <strong className="text-white">closed transfer systems</strong> (pumps,
                      taps, self-closing dispensers) wherever possible to minimise vapour release
                      and splashing
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">funnel with a lid</strong> to reduce exposure
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Decant in a <strong className="text-white">well-ventilated area</strong> or
                      under local exhaust ventilation (LEV)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Always <strong className="text-white">label the receiving container</strong>{' '}
                      immediately with the product name and hazard pictograms
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Wear <strong className="text-white">appropriate PPE</strong> as specified on
                      the SDS &mdash; chemical-resistant gloves, goggles, apron
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Never mix different chemical products</strong>{' '}
                      unless specifically directed by the manufacturer or a documented procedure
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      When diluting acids:{' '}
                      <strong className="text-white">always add acid to water</strong> &mdash; never
                      water to acid (&ldquo;Do as you oughta &mdash; add acid to water&rdquo;)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                    <span>
                      Add the concentrate <strong className="text-white">slowly</strong> with
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Use a <strong className="text-white">chemical trolley with drip tray</strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Containers must be{' '}
                      <strong className="text-white">securely closed and kept upright</strong> at
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Ensure route is clear of obstructions and avoid using lifts with other
                      occupants
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Wash hands</strong> thoroughly before eating,
                      drinking, or smoking &mdash; and always before leaving the work area
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">No eating, drinking, or smoking</strong> in
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Separate <strong className="text-white">clean welfare facilities</strong>{' '}
                      (mess room, toilets) must be provided away from chemical handling areas
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Remove contaminated clothing and PPE before entering welfare areas</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Spill kits must be available wherever hazardous substances are stored, handled, or
                used. All workers who may encounter a chemical spill must be{' '}
                <strong>trained in the location and use of spill kits</strong> before they begin
                work.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Absorbent pads:</strong> Placed directly on the
                      spill to soak up liquid
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Absorbent pillows:</strong> For larger volumes
                      &mdash; placed on or around the spill
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Absorbent socks:</strong> Flexible tubes placed
                      around the spill perimeter to contain spread
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Loose absorbent granules:</strong> Sprinkled
                      onto the spill, then swept up after absorption
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Neutralising agents:</strong> For acid or
                      alkali spills (e.g., sodium bicarbonate for acids, citric acid for alkalis)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">PPE:</strong> Chemical-resistant gloves,
                      splash-proof goggles, apron
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Disposal bags:</strong> For contaminated
                      absorbent materials (hazardous waste)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Instructions card:</strong> Quick-reference
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1.5">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Large spills</strong> that exceed the capacity
                      of available spill kits
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                    <span>
                      Spills producing{' '}
                      <strong className="text-white">toxic or irritant gases or fumes</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Unknown substances</strong> &mdash; do not
                      attempt to clean up if you do not know what has been spilt
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Any situation where you feel unsafe</strong>{' '}
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="bg-[#111] border-2 border-violet-500/40 rounded-xl p-4 sm:p-6 overflow-x-auto">
                ...
                <div className="flex items-stretch gap-0">
                  <div className="flex flex-col items-center mr-3">
                    <div className="w-8 h-8 rounded-full bg-green-500/20 border-2 border-green-500/50 flex items-center justify-center">
                      <span className="text-xs font-bold text-green-400">6</span>
                    </div>
                  </div>
              ...
              <div className="mt-4 bg-violet-500/10 border border-violet-500/30 rounded-lg p-3 text-center">
                <p className="text-[10px] sm:text-xs text-violet-300 font-medium">
                  All used spill kit materials are hazardous waste &mdash; dispose of via licensed
                  waste carrier with consignment note
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>Hazardous Waste (England and Wales) Regulations 2005</strong> (as amended).
                Waste producers have a <strong>legal duty of care</strong> to ensure hazardous waste
                is correctly classified, described, stored, transported, and disposed of.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      EWC codes are <strong className="text-white">six-digit codes</strong> that
                      classify every waste type
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Codes marked with an <strong className="text-white">asterisk (*)</strong>{' '}
                      indicate hazardous waste &mdash; e.g., 07&nbsp;01&nbsp;03* (organic
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">correct EWC code</strong> to each waste stream
                      &mdash; this determines the legal disposal route
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Using the <strong className="text-white">wrong code</strong> is a breach of
                      the duty of care and may result in enforcement action
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Describe:</strong> Correctly classify and
                      describe the waste, including the EWC code, physical form, and hazardous
                      properties
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Store:</strong> Keep waste securely in
                      suitable, labelled containers to prevent escape, leakage, or unauthorised
                      access
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Transfer:</strong> Only hand over waste to a{' '}
                      <strong className="text-white">licensed waste carrier</strong> registered with
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Document:</strong> Complete a{' '}
                      <strong className="text-white">consignment note</strong> for every hazardous
                      waste collection
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Record:</strong> Retain consignment notes for a{' '}
                      <strong className="text-white">minimum of 3&nbsp;years</strong>
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Licensed disposal:</strong> Hazardous waste
                  must be taken to a <strong>licensed disposal site</strong> that holds the correct
                  environmental permit for the waste type. The waste producer&rsquo;s duty of care
                  follows the waste <strong>from cradle to grave</strong> &mdash; you remain legally
                  responsible even after it leaves your site if you failed to check the
                  carrier&rsquo;s credentials or described the waste incorrectly.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>not automatically safe to handle or discard</strong>. Residues remain on
                internal surfaces, and fumes from &ldquo;empty&rdquo; containers of volatile
                substances can still pose a significant health and fire risk.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Triple rinse:</strong> Rinse the container
                      three times with an appropriate solvent (usually water). Each rinse should use
                      approximately one-quarter of the container&rsquo;s volume. Swirl or agitate to
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Dispose of rinsate:</strong> The rinse liquid
                      itself is <strong className="text-white">hazardous waste</strong> and must be
                      collected and disposed of through the correct waste stream &mdash; never pour
                      it down the drain.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Deface the label:</strong> Cross through or
                      remove the original label so the container cannot be confused with a full one
                      or reused without proper decontamination.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-0.5 w-5 h-5 rounded-full bg-violet-500/20 border border-violet-500/40 flex items-center justify-center flex-shrink-0 text-[10px] font-bold text-violet-400">
                    ...
                    <span>
                      <strong className="text-white">Dispose correctly:</strong> The container may
                      still need to go through the{' '}
                      <strong className="text-white">hazardous waste route</strong> depending on the
                      original contents and the level of residual contamination. Consult the SDS and
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  substance can react with the new contents, causing fires, toxic gas release, or
                  container failure. Even apparently &ldquo;clean&rdquo; containers may retain
                  sufficient residue to create a dangerous reaction. When in doubt, dispose of the
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Comprehensive record keeping is a <strong>legal requirement</strong> under the
                Hazardous Waste Regulations, the Environmental Protection Act 1990 duty of care, and
                COSHH itself. Records provide an audit trail demonstrating that hazardous substances
                have been managed, stored, handled, and disposed of in compliance with the law.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Consignment notes:</strong> Completed for every
                      hazardous waste collection — waste description, EWC code, quantity, carrier
                      details, destination site — retained for minimum 3&nbsp;years
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Safety Data Sheets:</strong> Up-to-date SDS for
                      every hazardous substance on site &mdash; accessible to all workers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">COSHH assessments:</strong> Written risk
                      assessments for each substance or process &mdash; reviewed at least annually
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stock inventory:</strong> Register of all
                      hazardous substances held on site including quantities, locations, and date of
                      receipt
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Spill/incident reports:</strong> Details of any
                      spills, leaks, or exposure incidents including root cause and corrective
                      actions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Training records:</strong> Evidence that all
                      workers have received COSHH training relevant to their role, including spill
                      response training
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Waste carrier licences:</strong> Copies of the
                      carrier&rsquo;s waste carrier registration and the disposal site&rsquo;s
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Environment Agency inspections:</strong> The
                  Environment Agency can inspect your premises and request to see all waste-related
                  records at any reasonable time. Failure to produce consignment notes, duty of care
                  documentation, or evidence of correct waste classification can result in{' '}
                  <strong>enforcement notices, fines, or prosecution</strong>. Good record keeping
                  is not optional &mdash; it is a fundamental legal obligation.
                </p>
              </div>
            </div>
          </div>
