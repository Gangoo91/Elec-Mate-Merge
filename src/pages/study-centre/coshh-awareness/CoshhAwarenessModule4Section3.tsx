...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question: "What is 'breakthrough time' in relation to chemical-resistant gloves?",
    options: [
  ...
  },
  {
    ...
    question: 'Which statement about face-fit testing for RPE under COSHH is correct?',
    options: [
...
const faqs = [
  {
    question: 'What is the difference between an FFP2 and an FFP3 filtering facepiece?',
    answer:
  ...
  {
    question: 'Can I use the same pair of chemical-resistant gloves for different chemicals?',
    answer:
  ...
  {
    question: 'What do the chemical suit types (Type 1 through Type 6) mean?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 2,
    question: 'What is the Assigned Protection Factor (APF) of an FFP2 filtering facepiece?',
...
export default function CoshhAwarenessModule4Section3() {
  useSEO({
    title: 'RPE & PPE Selection | COSHH Awareness Module 4.3',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>RPE/PPE:</strong> Last resort in the hierarchy of control &mdash; never the
                first line of defence
              </li>
              <li>
                <strong>COSHH Reg 7(3):</strong> Exposure must be below the WEL and as low as
                reasonably practicable
              </li>
              <li>
                <strong>Face-fit:</strong> Legal requirement for all tight-fitting RPE
              </li>
              <li>
                <strong>Gloves:</strong> Material must be matched to the chemical &mdash; check
                breakthrough time
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-violet-500/5 border-l-2 border-violet-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              ...
              <li>
                <strong>Never:</strong> Rely on RPE as the sole control measure
              </li>
              <li>
                <strong>Always:</strong> Replace gloves before breakthrough time
              </li>
              <li>
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                personal protective equipment &mdash; including respiratory protective equipment
                (RPE) &mdash; sits at the <strong>bottom of the hierarchy of control</strong>.
                Employers must not jump straight to issuing masks and gloves. Instead, they must
                work through the hierarchy in order: elimination, substitution, engineering controls
                (such as local exhaust ventilation), administrative controls (such as reduced
                exposure time and safe systems of work), and only then PPE/RPE to manage the{' '}
                <strong>residual risk</strong> that remains.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  been applied and a residual risk still exists &mdash; not because those controls
                  were skipped for convenience.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <ul className="text-sm text-white/80 space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Last resort in the hierarchy:</strong> When
                      elimination, substitution, engineering controls, and administrative controls
                      have been applied but residual exposure remains above the level considered
                      acceptable by the COSHH assessment. PPE manages the remaining gap.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Supplement to other controls:</strong> PPE is
                      often used alongside engineering controls as an additional layer of
                      protection. For example, a worker may use LEV to capture solvent vapours at
                      source whilst also wearing a half-mask respirator with organic vapour filters
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Emergency and short-duration use:</strong> RPE
                      may be required for emergency response to accidental releases, confined space
                      entry, short-duration maintenance tasks where installing permanent engineering
                      controls is impractical, or during the time it takes to implement higher-level
                      controls.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  Simply meeting the WEL is not sufficient &mdash; the employer must demonstrate
                  that they have done everything reasonably practicable to reduce exposure further.
                  PPE/RPE bridges the gap between what engineering controls achieve and the ALARP
                  principle.
                </p>
              </div>

              <p>
                Employers must provide all RPE and PPE <strong>free of charge</strong>, ensure
                workers are trained in its correct use, and maintain records demonstrating that the
                equipment is adequate and properly maintained. Workers have a legal duty to use the
                PPE provided and to report any defects.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                RPE protects the wearer from inhaling hazardous substances &mdash; dusts, fumes,
                vapours, gases, and mists. The type of RPE selected must be matched to the hazard
                identified in the COSHH assessment, considering both the nature of the substance and
                the concentration in the workplace air.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">FFP1 (APF 4):</strong> Suitable for nuisance
                      dusts at low concentrations (up to 4 times the WEL). Limited protection
                      &mdash; appropriate for low-hazard tasks such as sweeping general building
                      dust
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">FFP2 (APF 10):</strong> Suitable for moderate
                      hazards where concentrations do not exceed 10 times the WEL. Used for wood
                      dust, plaster dust, grain dust, and similar particulates. Filters at least 94%
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">FFP3 (APF 20):</strong> The highest level of
                      filtering facepiece. Suitable for toxic dusts, fumes, and fine particulates up
                      to 20 times the WEL. Required for substances such as hardwood dust, silica
                      dust, lead fume, and asbestos (non-licensed work). Filters at least 99% of
                      airborne particles
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      &mdash; they do NOT protect against gases or vapours. For vapour hazards, you
                      must use a respirator with appropriate gas/vapour filters
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-1">Half-Mask Respirators</p>
                <p className="text-xs text-violet-400 font-semibold mb-3">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Reusable rubber or silicone facepiece covering the nose and mouth, with
                      bayonet or screw-fit filter cartridges
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Particulate filters:</strong> P1 (low
                      efficiency), P2 (medium efficiency), P3 (high efficiency, 99.95% filtration)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Gas/vapour filters (colour-coded):</strong> A
                      (brown) = organic vapours with boiling point above 65&deg;C; B (grey) =
                      inorganic gases such as chlorine and hydrogen sulphide; E (yellow) = sulphur
                      dioxide and acidic gases; K (green) = ammonia and organic amines
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Combination filters:</strong> Filters can be
                      combined (e.g. A2B2P3) to protect against multiple hazards simultaneously. The
                      numbers (1, 2, 3) indicate the filter capacity &mdash; Class 1 has the lowest
                      capacity, Class 3 the highest
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Must be face-fit tested for each wearer. Filters must be replaced according to
                      the manufacturer&rsquo;s schedule or when the wearer detects taste or odour
                      breakthrough
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-1">Full-Face Respirators</p>
                <p className="text-xs text-violet-400 font-semibold mb-3">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Full-face mask covering eyes, nose, and mouth. APF 20 with particulate
                      filters, up to APF 40 with combination gas and particulate filters
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Provides built-in eye protection &mdash; eliminates the need for separate
                      safety goggles. Essential when the hazardous substance also poses a risk to
                      the eyes (e.g. acid vapours, corrosive mists)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Required when exposure levels are too high for a half-mask (above 10 times the
                      WEL), or when the substance is an eye irritant or corrosive
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Accepts the same filter types as half-masks (A, B, E, K, P, and combinations).
                      Filter selection depends on the hazardous substance identified in the COSHH
                      assessment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">quantitative testing</strong> (PortaCount)
                      because of the higher APF
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      A battery-powered fan draws air through filters and delivers purified air to
                      the wearer via a hood, helmet, or visor. Three protection classes: TH1 (APF
                      10), TH2 (APF 20), and TH3 (APF 40)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        Loose-fitting hoods and helmets do not require face-fit testing
                      </strong>{' '}
                      &mdash; positive pressure inside the headpiece prevents contaminated air from
                      entering
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ideal for workers with facial hair</strong>,
                      spectacle wearers, and those who find non-powered RPE uncomfortable or
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Advantages for prolonged use: reduced breathing resistance, better comfort
                      during heavy physical work, cooler operating temperature inside the headpiece
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Battery must be fully charged before each use. A flat battery means the fan
                      stops, positive pressure is lost, and the unit provides no protection
                    </span>
                  </li>
                </ul>
              </div>
              ...
              {/* Breathing Apparatus */}
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-1">Breathing Apparatus (BA)</p>
                <p className="text-xs text-violet-400 font-semibold mb-3">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Airline (compressed air line):</strong> Clean,
                      breathable air is supplied from an external compressor or cylinder bank via a
                      hose. The wearer is tethered to the air supply. Used when the atmosphere is
                      oxygen-deficient or the contaminant concentration is too high for any
                      filter-based RPE
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      The wearer carries their own air supply in a cylinder on their back. Provides
                      full mobility but limited duration (typically 30&ndash;60 minutes). Required
                      for emergency response, fire rescue, and unknown atmospheres
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">When required:</strong> IDLH (immediately
                      dangerous to life or health) atmospheres, oxygen-deficient environments (below
                      19.5% O<sub>2</sub>), confined spaces with unknown or unpredictable
                      atmospheric conditions, and any situation where filter-based RPE cannot
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-red-300">Specialist training is mandatory</strong> for
                      all breathing apparatus use. Workers must be trained, medically assessed, and
                      competent before using BA equipment
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every type of RPE has an Assigned Protection Factor (APF), which is a number
                indicating how much the RPE reduces the wearer&rsquo;s exposure compared to the
                ambient (surrounding) concentration. For example, an APF of 20 means the RPE reduces
                exposure by a factor of 20 &mdash; the air inside the mask should be 20 times
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">equals or exceeds</strong> that value. For example:
                  if the concentration is 8 mg/m&sup3; and the WEL is 1 mg/m&sup3;, you need a
                  minimum protection factor of 8. An FFP2 (APF 10) would be sufficient. If the
                  concentration were 15 mg/m&sup3;, you would need at least APF 20 (FFP3 or
                  full-face).
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <h2 className="text-xl font-semibold text-white mb-6 flex items-center gap-3">
            <span className="text-violet-400/80 text-sm font-normal">&mdash;</span>
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden">
            ...
            {[
              ...
              <div key={index} className="grid grid-cols-2 sm:grid-cols-4 gap-px bg-white/5">
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Face-fit testing is a <strong>legal requirement under COSHH</strong> for all
                tight-fitting RPE. A tight-fitting respirator can only achieve its stated APF if the
                facepiece creates a proper seal against the wearer&rsquo;s face. Without a
                successful face-fit test, the RPE must be assumed to provide little or no protection
                because contaminated air will leak past the seal.
              </p>
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        A bitter (bitrex) or sweet (saccharin) aerosol is sprayed into a hood placed
                        over the wearer&rsquo;s head. The wearer performs a series of exercises
                        (talking, bending, turning the head, breathing deeply) while wearing the
                        RPE. If the wearer can taste the aerosol, it means air is leaking past the
                        face seal and the RPE has <strong className="text-red-300">failed</strong>.
                        Simple pass/fail result. Suitable for FFP2, FFP3, and half-mask respirators.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        A machine (typically a TSI PortaCount) measures the concentration of
                        particles inside and outside the mask to calculate a numerical fit factor.
                        More accurate and objective than the taste test.{' '}
                        <strong className="text-white">Required for full-face respirators</strong>{' '}
                        because the higher APF demands a higher level of testing confidence. Also
                        used when qualitative testing is inconclusive.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      When the RPE model or size changes (even a different model from the same
                      manufacturer)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      When the wearer&rsquo;s facial features change significantly (weight gain or
                      loss of more than 5&ndash;7 kg, dental work, scarring, or other changes to the
                      face shape)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      When a different type of tight-fitting RPE is selected (e.g. switching from
                      FFP3 to a half-mask)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      At regular intervals as determined by the employer&rsquo;s health and safety
                      policy (commonly every 1&ndash;2 years)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  seal, reducing the actual protection factor to a fraction of the stated APF. These
                  workers must use a loose-fitting PAPR with a hood or helmet, or an airline hood,
                  neither of which relies on a face seal. There is no exception to this rule &mdash;
                  tightening the straps harder does not compensate for facial hair.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Clean after each use:</strong> Reusable RPE
                      must be washed and disinfected after every work session following the
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Replace filters on schedule:</strong>{' '}
                      Gas/vapour filters have a finite capacity. Replace according to
                      manufacturer&rsquo;s data, or immediately if taste or odour is detected inside
                      the mask
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Inspect before each use:</strong> Check the
                      facepiece for cracks, the straps for elasticity, the valves for damage, and
                      the filters for correct seating
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Store properly:</strong> In a clean, dry
                      location away from direct sunlight, chemicals, and extreme temperatures.
                      Ideally in a sealed bag or dedicated storage container
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lifespan:</strong> Disposable masks are
                      single-use. Reusable RPE typically has a 5-year shelf life from manufacture,
                      but the facepiece may need replacing sooner if damaged or worn. Always check
                      the manufacturer&rsquo;s stated lifespan
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The hands are the most common route of skin contact with hazardous substances.
                Selecting the right glove material is critical because no single glove resists all
                chemicals. The safety data sheet (SDS) for each substance specifies the recommended
                glove material and minimum breakthrough time.
              </p>
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <div className="flex gap-3">
                    ...
                    <p>
                      ...
                      Excellent against petroleum-based solvents, oils, greases, acids, and
                      caustics. Poor against ketones (e.g. acetone) and some aromatic solvents.
                      Latex-free, so safe for workers with latex allergies. The most commonly used
                  ...
                  <div className="flex gap-3">
                    ...
                    <p>
                      <strong className="text-white">Good dexterity and comfort.</strong> Resists
                      water-based chemicals, dilute acids, and alcohols. Poor against oils,
                      solvents, and organic chemicals. Risk of latex allergy (Type I
                      hypersensitivity) in some workers &mdash; always check before issuing. Largely
                      replaced by nitrile for chemical work.
                    </p>
                  </div>
                  <div className="flex gap-3">
                    <span className="flex items-center justify-center min-w-[64px] h-7 rounded-full bg-violet-500/20 text-violet-400 text-xs font-bold flex-shrink-0">
                    ...
                    <p>
                      <strong className="text-white">Broad chemical resistance.</strong> Good
                      against acids, alkalis, alcohols, fuels, and many solvents. Better than latex
                      for chemical work but less dexterous. Often used for handling hydraulic
                      fluids, phenols, and glycol ethers.
                    </p>
                  </div>
                  <div className="flex gap-3">
                    <span className="flex items-center justify-center min-w-[64px] h-7 rounded-full bg-violet-500/20 text-violet-400 text-xs font-bold flex-shrink-0">
                    ...
                    <p>
                      <strong className="text-white">Good for acids and caustics.</strong> Resists
                      mineral acids, caustic solutions, fats, and oils. Poor against most organic
                      solvents. Economical for tasks involving dilute chemicals and water-based
                  ...
                  <div className="flex gap-3">
                    ...
                    <p>
                      <strong className="text-white">Specialist solvent resistance.</strong>{' '}
                      Excellent against ketones (acetone, MEK), esters, and aldehydes where nitrile
                      and neoprene fail. Also good against gases. More expensive and less dexterous,
                      so reserved for tasks involving these specific chemicals.
                    </p>
                  </div>
                  <div className="flex gap-3">
                    <span className="flex items-center justify-center min-w-[64px] h-7 rounded-full bg-violet-500/20 text-violet-400 text-xs font-bold flex-shrink-0">
                    ...
                    <p>
                      ...
                      The best material for aromatic solvents (toluene, xylene), chlorinated
                      solvents (dichloromethane, trichloroethylene), and PCBs. Very expensive, but
                      essential for these high-hazard chemicals. Often laminated onto a nitrile base
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 mb-3">
                  ...
                  a 120-minute breakthrough time for a chemical means the chemical will begin
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Always check the manufacturer&rsquo;s permeation data for the specific
                      chemical you are handling &mdash; do not assume that a glove resists all
                      chemicals
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      to allow a safety margin. Workplace conditions (heat, abrasion, stretching)
                      reduce breakthrough time compared to laboratory conditions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      A glove with no rated breakthrough time for a particular chemical provides
                      essentially no protection against that chemical, even if it is marketed as
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Permeation:</strong> The rate at which a
                      chemical passes through the glove material at a molecular level. This
                      determines the breakthrough time. A glove may appear intact but still allow
                      chemical molecules to diffuse through it.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Degradation:</strong> Changes to the physical
                      properties of the glove material after chemical contact &mdash; swelling,
                      softening, cracking, stiffening, or discolouration. A degraded glove loses its
                      protective properties and may split during use.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Penetration:</strong> Whether the chemical can
                      pass through pinholes, seams, or other imperfections in the finished glove.
                      This tests manufacturing quality rather than material performance.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Single-use (disposable):</strong> Thin, good
                      dexterity, but limited breakthrough times. Suitable for brief contact, splash
                      protection, and tasks requiring fine motor control. Must be discarded after
                      each use &mdash; never washed or reused.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reusable:</strong> Thicker, longer breakthrough
                      times, more robust. Suitable for prolonged chemical handling. Must be
                      inspected for damage before each use, cleaned after use, and replaced when
                      signs of degradation appear.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Correct donning/doffing:</strong> Remove gloves
                      by peeling from the wrist, turning inside-out as you pull. This traps
                      contamination on the inside. Never snap gloves off or touch the outer surface
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Hazardous substances can cause serious eye injuries ranging from irritation to
                permanent blindness. The type of eye protection selected must match the hazard
                identified in the COSHH assessment. All eye protection for chemical hazards must
                comply with <strong>EN 166</strong> (the European standard for personal eye
                protection).
              </p>
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Protect against frontal impact and limited splash from the front. Suitable
                        for low-risk dust and minor chemical splash where the primary risk is from
                        the front. NOT suitable for chemical splash hazards where liquid could enter
                        from the sides, above, or below.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Chemical Splash Goggles</p>
                      <p>
                        Seal around the eyes providing protection from all directions. Indirect
                        ventilation models prevent liquid from entering through vents whilst still
                        reducing fogging.{' '}
                        <strong className="text-white">
                          The minimum standard for chemical splash hazards.
                        </strong>{' '}
                        Required when handling corrosive liquids, pouring or mixing chemicals, or
                        when there is any risk of splashed liquid reaching the eyes.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Protect the entire face from splashes, sprays, and flying particles. Worn{' '}
                        <strong className="text-white">over goggles, not instead of them</strong>,
                        for chemical work because face shields alone leave gaps around the sides and
                        bottom where liquid can reach the eyes. Used for high-volume chemical
                        handling, decanting, and any task with a risk of large-volume splashes to
                        the face.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Remember:</strong> If a full-face respirator
                  or PAPR with visor is being worn, it provides built-in eye protection. Separate
                  goggles are not needed in this case. However, if only a half-mask or FFP mask is
                  worn, the eyes are unprotected and appropriate eye protection must be worn in
                  addition to the RPE.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-violet-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Body protection prevents hazardous substances from contacting the skin, which is the
                second most common route of occupational exposure after inhalation. The level of
                body protection depends on the substance, its physical form, and the task being
                performed.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-3">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Overalls:</strong> Standard cotton or
                      polyester-cotton overalls. Suitable for low-hazard work where the substance is
                      not toxic by skin contact. Provide basic protection against contamination of
                      personal clothing but do not resist chemical penetration.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Disposable coveralls (Type 5):</strong>{' '}
                      Non-woven fabric suits that resist the penetration of airborne solid particles
                      (dusts, fibres). Full-body protection with hood, elasticated wrists and
                      ankles. Required for work with toxic dusts, respirable crystalline silica, and
                      fibrous materials.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      Classified from Type 1 (gas-tight, total encapsulation) to Type 6 (light
                      liquid splash). The type selected depends on the chemical form and the
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Chemical-resistant aprons (PVC, neoprene, or butyl rubber) provide frontal
                      protection during decanting, mixing, and cleaning tasks
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Aprons protect the torso but not the arms, back, or legs. They supplement
                      other body protection, not replace it
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-violet-400 flex-shrink-0" />
                    <span>
                      Must be made from a material that resists the specific chemicals being handled
                      &mdash; check the SDS for recommendations
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Understanding common mistakes helps you recognise and avoid them. Every one of these
                errors has resulted in preventable exposure and, in many cases, serious occupational
                illness.
              </p>
              ...
              <div className="bg-violet-500/10 border border-violet-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-violet-400">Key Message:</strong> Every one of these
                  mistakes is avoidable. Correct PPE selection starts with reading the COSHH
                  assessment and the safety data sheet, not with grabbing whatever is in the
                  cupboard. If you are unsure about the right PPE for a task, stop and ask your
                  supervisor &mdash; the cost of a pause is nothing compared to the cost of
