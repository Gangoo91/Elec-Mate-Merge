    ...
    <div className="overflow-x-hidden bg-[#1a1a1a]">
      ...
      <main className="px-4 sm:px-8 lg:px-12 pb-12">
        <div className="max-w-5xl mx-auto space-y-6 sm:space-y-8">
          {/* Course Header */}
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-violet-500/10 via-violet-400/5 to-transparent border border-violet-500/15 p-5 sm:p-8">
            <div className="absolute top-0 right-0 w-48 h-48 bg-violet-500/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/4" />
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-3">
                <div className="p-2.5 rounded-xl bg-gradient-to-br from-violet-500/20 to-violet-400/20 border border-violet-500/20">
                  <FlaskConical className="h-6 w-6 text-violet-400" />
                </div>
                <span className="px-2.5 py-1 rounded-full text-[10px] font-bold bg-violet-500/10 text-violet-400 border border-violet-500/20">
                  Foundation
                </span>
              </div>
