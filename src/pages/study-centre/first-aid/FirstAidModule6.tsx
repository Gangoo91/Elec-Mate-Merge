    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Put your First Aid at Work knowledge to the test under timed exam conditions. Questions
        ...
        <Link to="../first-aid-mock-exam" className="block touch-manipulation focus:outline-none">
