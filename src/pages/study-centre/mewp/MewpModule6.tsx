    ...
    <HubPage>
      ...
      <HubBody>
        <p className="max-w-3xl text-[13px] leading-relaxed text-white">
          Put your MEWP operator knowledge to the test under timed exam conditions. Questions are
        ...
        <Link to="../mewp-mock-exam" className="block touch-manipulation focus:outline-none">
