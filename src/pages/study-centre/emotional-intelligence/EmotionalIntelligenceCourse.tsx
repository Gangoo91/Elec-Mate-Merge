...
export default function EmotionalIntelligenceCourse() {
  useSEO({
    title: 'Emotional Intelligence | Personal Development',
    description:
      "Complete Emotional Intelligence training based on Daniel Goleman's framework — self-awareness, self-regulation, motivation, empathy, social skills and mock exam.",
  });
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-3">
                <div className="p-2.5 rounded-xl bg-gradient-to-br from-rose-500/20 to-rose-400/20 border border-rose-500/20">
                  <Smile className="h-6 w-6 text-rose-400" />
                </div>
              ...
              <p className="text-sm sm:text-base lg:text-lg text-muted-foreground mt-1 max-w-2xl">
                Self-awareness, managing reactions, reading people and building stronger working
