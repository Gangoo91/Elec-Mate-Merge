...
export default function EIModule6() {
  useSEO({
    title: 'Emotional Intelligence Mock Exam | Module 6',
    description:
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-white text-sm sm:text-base">
              Put your Emotional Intelligence knowledge to the test under timed exam conditions.
          ...
          <Card className="border-white/10 bg-white/[0.02] mb-6">
            <CardContent className="p-5 sm:p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {[
                  { name: 'Understanding Emotional Intelligence', count: 40 },
                  { name: 'Self-Awareness', count: 40 },
                  { name: 'Self-Regulation', count: 40 },
                  { name: 'Motivation & Empathy', count: 40 },
                  { name: 'Social Skills & Applying EI', count: 40 },
                ].map((cat) => (
                  <div
                    key={cat.name}
