...
const quickCheckQuestions = [
  {
    ...
    question:
      'What is the minimum guardrail height above the working platform on a mobile access tower?',
    options: ['750mm', '850mm', '950mm', '1100mm'],
    correctIndex: 2,
    explanation:
      'The minimum guardrail height is 950mm above the platform surface. This is specified in the Work at Height Regulations 2005 and BS EN 1004. The guardrail must be fitted on all exposed sides of the platform — any side not adjacent to a structure.',
  },
  {
...
const quizQuestions = [
  {
    ...
    correctAnswer: 2,
    explanation:
      'Guardrails must be a minimum of 950mm above the working platform surface. This height provides effective edge protection to prevent persons falling from the platform. Both BS EN 1004 and the Work at Height Regulations 2005 specify this requirement.',
  },
  {
    id: 2,
    ...
    correctAnswer: 1,
    explanation:
      'The mid-rail should be positioned at approximately 470mm above the platform — roughly halfway between the toeboard top and the guardrail. Its purpose is to prevent a person falling through the gap between the guardrail and toeboard.',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "A tower must be tied to a suitable adjacent structure when it is built beyond the manufacturer's specified maximum freestanding height. The instruction manual states the freestanding limit for each configuration. Building beyond this without ties creates an unacceptable risk of overturning.",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'The AGR method provides temporary guardrail protection at each stage of the build. The advance guardrails are installed from the level below before the operative moves up to the next level, ensuring continuous edge protection throughout the assembly process.',
  },
  {
    id: 8,
...
const PasmaModule2Section3 = () => {
  useSEO({
    ...
    description:
      'Learn about mobile access tower safety components: guardrails, mid-rails, toeboards, stabilisers, outriggers, tie-ins, access systems, and PPE requirements.',
  });
          ...
          <div className="rounded-lg p-4 bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Guardrails:</strong> min 950mm, all exposed sides
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Mid-rails:</strong> ~470mm, prevent falling through
                  gap
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Toeboards:</strong> min 150mm, prevent objects
                  falling
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Stabilisers/outriggers:</strong> increase base,
                  prevent overturning
                </span>
              </li>
            </ul>
          ...
          <div className="rounded-lg p-4 bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Check:</strong> guardrails on all open sides before
                  use
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Confirm:</strong> toeboards fitted and secure
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Verify:</strong> stabilisers fitted as per
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Climb:</strong> using 3-point contact, internal
                  access only
                </span>
              </li>
            </ul>
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                falling from the platform. Guardrails are classified as{' '}
                <strong className="text-white">collective protection</strong> — they protect
                everyone on the platform without requiring individual action.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 text-sm space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Guardrail frames slot into sockets or clips welded to the end frames
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Gravity locks or spring clips engage automatically when the guardrail is
                      seated
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Some systems use separate guardrail posts that bolt or clip to the platform
                      edge
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      All connections must be checked — pull-test each guardrail after fitting
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Guardrails must never be removed while anyone is on the platform. If a guardrail is
                damaged or missing, the tower must not be used until it is replaced. The operative
                must descend and report the deficiency before any further work is carried out.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                and fall from the platform. The mid-rail closes this gap.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  halfway between the toeboard and the guardrail. Its primary purpose is to prevent
                  a person from falling through the gap between the guardrail and the toeboard.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Position:</strong> approximately 470mm above
                      platform — midway between toeboard and guardrail
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Coverage:</strong> fitted on all open sides of
                      the platform, matching the guardrail layout
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Strength:</strong> must withstand a horizontal
                      force of at least 20kg at any point
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Integration:</strong> on most modern systems,
                      the mid-rail is integral to the guardrail frame
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Together, the guardrail, mid-rail, and toeboard form a complete edge protection
                system. All three elements must be present on all open sides of the working
                platform. Missing any one of these components creates a gap through which a person
                or object could fall.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                falling off the platform edge — protecting people below from being struck by falling
                objects.
              </p>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  everyone working below or passing near the tower. Always ensure an exclusion zone
                  is maintained at the base of the tower.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                base area and reduce the risk of overturning.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 text-sm space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Stabilisers and outriggers must not obstruct pedestrian routes, fire exits, or
                      vehicle access
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      If they encroach on a walkway, the area must be barriered and signed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      They must be fitted symmetrically — do not fit stabilisers on one side only
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The manufacturer's manual specifies which type is required for each
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      All stabiliser/outrigger foot plates must be in firm contact with the ground
                      or sole boards
                    </span>
                  </li>
                </ul>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                transfer lateral forces (primarily wind) from the tower into the building structure.
              </p>
              ...
              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      The task creates lateral forces on the tower (e.g., drilling into a wall)
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/60 text-sm space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Ties on alternating faces of the tower to resist forces in all directions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The topmost tie should be as close to the top of the tower as practical
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/60 text-sm space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Structural steelwork (columns, beams) — not cladding or infill panels
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Masonry walls of sufficient thickness and integrity (not single-leaf
                      blockwork)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
            ...
            <div className="space-y-4 text-white/80">
              ...
              <div className="bg-white/5 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <ul className="text-white/60 text-sm space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Always climb <strong className="text-white">inside</strong> the tower — never
                      on the outside
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Do not carry heavy or bulky items while climbing — use a hoist or rope
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Wear suitable footwear with grip — no loose laces or open-toed shoes
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  This ensures stability throughout the climb and significantly reduces the risk of
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  to withstand. Always use the internal ladder access through trapdoor platforms. If
                  the internal access is obstructed, do not climb — clear the obstruction first.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                tower's safety components (guardrails, toeboards, etc.) — it does not replace them.
              </p>
              ...
              <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Safety helmet:</strong> mandatory during
                      assembly and disassembly — protects against falling components and head
                      impacts with the frame structure
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Safety boots:</strong> steel or composite toe
                      cap, ankle support, non-slip sole — essential for handling heavy components
                      and climbing
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Gloves:</strong> grip gloves for handling
                      aluminium tubes and frames — reduces risk of cuts, pinch injuries, and
                      improves grip
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">High-visibility clothing:</strong> required on
                      construction sites and in areas with vehicle or plant movements
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm mb-3">
                  ...
                  assembly method is used that does not provide continuous guardrail protection, a
                  harness and lanyard must be worn.
                </p>
              ...
              <p>
                Once a tower is fully assembled with all guardrails, mid-rails, and toeboards in
                place, the collective protection is generally sufficient and a harness is not
                required for normal use. However, always check the site-specific risk assessment and
                method statement — some clients and principal contractors have additional PPE
                requirements beyond the statutory minimum.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 text-sm space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      All PPE must be inspected before each use — check for damage, wear, and expiry
                      dates
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Harnesses must have a current thorough examination certificate (at least every
                      6 months for frequently used equipment)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Safety helmets must be replaced if cracked, heavily scratched, or past their
                      expiry date (typically 3-5 years from manufacture)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      PPE must be stored correctly — away from UV light, chemicals, and extreme
                      temperatures
                    </span>
                  </li>
                </ul>
