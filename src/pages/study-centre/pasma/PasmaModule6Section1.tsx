...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'Tower collapse is most commonly caused by incorrect assembly (missing braces or diagonal members), overloading the platform beyond its rated capacity, or a combination of both. Every brace and connection plays a structural role — omitting even one can compromise the entire tower.',
  },
  {
    id: 'hazards-power-line-clearance',
    question:
      'What is the minimum safe distance that must be maintained from overhead power lines when using an aluminium tower?',
    options: ['5 metres', '10 metres', '15 metres', '3 metres'],
    correctIndex: 2,
    explanation:
      'A minimum exclusion zone of 15 metres must be maintained from overhead power lines. Aluminium towers are excellent conductors of electricity and present extreme electrocution risk if they come close to or contact overhead lines. You do not need to touch a line — electricity can arc across gaps.',
  },
  {
...
export default function PasmaModule6Section1() {
  useSEO({
    ...
    description:
      'Identify and understand the most common hazards associated with mobile access towers: falls from height, tower collapse, electrocution, falling objects, manual handling injuries, entrapment, and environmental factors.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Falls from height</strong> = #1 UK workplace killer
              </li>
              <li>
                <strong>Tower collapse</strong> from incorrect assembly or overloading
              </li>
              <li>
                <strong>Electrocution risk</strong> from overhead power lines
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Identify:</strong> all hazards before work begins
              </li>
              <li>
                <strong>Control:</strong> exclusion zones, PPE, competent assembly
              </li>
              <li>
                <strong>Monitor:</strong> conditions throughout the work, stop if unsafe
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Falls from height remain the single largest cause of workplace fatalities in the
                United Kingdom. Year after year, HSE statistics confirm that more workers die from
                falls than from any other type of workplace accident. Mobile access towers, while
                far safer than ladders when used correctly, are involved in a significant proportion
                of these incidents.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white mb-2">
                  ...
                  incorrectly assembled, misused, or operated by untrained personnel.
                </p>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Climbing the outside:</strong> Operatives
                      climbing the external face of the tower instead of using the internal ladder —
                      often to save time
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Missing guardrails:</strong> Working on a
                      platform where guardrails have not been fully installed or have been removed
                      to pass materials
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Overreaching:</strong> Leaning beyond the
                      platform edge rather than repositioning the tower, shifting the centre of
                      gravity dangerously
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Tower movement:</strong> The tower rolling
                      unexpectedly because castor brakes were not locked or the ground is sloping
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Trapdoor left open:</strong> An open trapdoor
                      in the platform creating a fall-through hazard, particularly during descent
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Climbing with loads:</strong> Carrying tools or
                      materials while climbing instead of using a hoisting line, compromising the
              ...
              <p>
                Every one of these scenarios is preventable. Competent assembly, proper training,
                locked castors, fully installed guardrails, and disciplined use of the internal
                ladder and hoisting line eliminate the vast majority of fall risks associated with
                mobile towers.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  removing a guardrail &ldquo;just for a minute&rdquo; to pass a sheet of
                  plasterboard, or leaning out &ldquo;just a bit further&rdquo; rather than moving
                  the tower. The word &ldquo;just&rdquo; in a safety context is a warning sign. If
                  you hear yourself thinking it, stop and do the job properly.
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A mobile tower that collapses or overturns while occupied is almost certain to cause
                serious injury or death. Unlike a controlled fall where an operative might grab hold
                of something, a tower collapse is sudden, violent, and gives no time to react.
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <p>
                    ...
                    the wrong order. Every structural member plays a critical role &mdash; a tower
                    with missing braces is like a building without walls.
                  </p>
                  <p>
                    <strong className="text-white">Overloading:</strong> Exceeding the platform's
                    rated load capacity with people, tools, and materials. A standard platform is
                    typically rated for 275 kg, but this varies by manufacturer and configuration.
                  </p>
                  <p>
                    <strong className="text-white">Wind forces:</strong> High winds create lateral
                    loads that can overturn a tower, particularly when the platform is sheeted or
                    has large flat materials stored on it that act as sails.
                  </p>
                  <p>
                    <strong className="text-white">Vehicle impact:</strong> A vehicle striking the
                    tower base can cause instant collapse. This is a particular risk on construction
                    sites and in car parks where towers are positioned near traffic routes.
                  </p>
                  <p>
                    <strong className="text-white">Unstable ground:</strong> Ground that sinks,
                    shifts, or is uneven causes the tower to lean progressively until it overturns.
                    Freshly backfilled trenches and waterlogged ground are common culprits.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  and collapsed sideways. The operative suffered multiple fractures including a
                  broken pelvis and spent four months in hospital. Investigation found that the
                  braces would have taken less than two minutes to install.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Follow the manufacturer's instruction manual exactly &mdash; no shortcuts
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  the ratio can be 3.5:1. Exceeding these ratios dramatically increases the risk of
                  overturning, even in calm conditions. Stabilisers and outriggers extend the
                  effective base, improving the ratio and increasing stability. Always check the
                  manufacturer&rsquo;s specific guidance for the tower system in use.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Contact with overhead power lines is one of the most lethal hazards in construction.
                Unlike many accidents where there is a chance of survival, electrocution from
                high-voltage overhead lines is almost always fatal. Mobile towers, particularly
                aluminium ones, present a significant risk because they are tall, conductive, and
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Maintain a minimum 15-metre exclusion zone from all overhead power lines
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      This distance applies to every part of the tower at its maximum height
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Include the reach of any tools, poles, or materials being handled from the
                      platform
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Electricity can arc across a gap &mdash; direct contact is not required for
                      electrocution
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  electrical current. However, even GRP towers must respect safe distances from
                  power lines, as tools and materials on the platform may still be conductive.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  11 kV overhead line. The operative holding the tower received a fatal electric
                  shock. A colleague who attempted rescue also received serious burns. The
                  investigation found that no site survey for overhead hazards had been conducted,
                  no exclusion zone was in place, and the operatives were unaware the power line
                  existed. The entire incident was preventable through a basic pre-work survey.
                </p>
              </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                The energy of a falling object increases with height &mdash; even a small hand tool
                dropped from a 6-metre platform can cause a fatal head injury. This hazard affects
                not just the tower operatives but anyone in the vicinity, including other trades,
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hand tools:</strong> Spanners, screwdrivers,
                      pliers, and drills placed on the platform edge or in pockets that fall during
                      movement
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Building materials:</strong> Fixings, cable
                      clips, light fittings, and other materials being installed from the platform
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Debris:</strong> Dust, plaster, and removed
                      components from the work being carried out
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Tower components:</strong> Components that are
                      dislodged or dropped during assembly, reconfiguration, or dismantling
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Personal items:</strong> Phones, drinks, and
                      other personal items not secured to the operative
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    items from being kicked or rolling off the platform edge. On towers used for
                    work generating debris (drilling, chasing, removal work), a mesh guard between
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    level. Tethering is especially important in busy environments where exclusion
                    zones cannot fully prevent access below. Ensure the tether is short enough that
                    the tool cannot swing into hazards or reach beyond the platform edge.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  with public access &mdash; additional measures may be needed, including debris
                  netting around the platform, solid barriers at ground level, and a dedicated
                  ground-level banksman to manage pedestrian access.
                </p>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  full force. The physics are simple: the higher the platform, the greater the speed
                  at impact, and the more damage is done. This is why toeboards, tool tethering, and
                  exclusion zones are all required &mdash; no single measure is sufficient on its
                  own.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Tower components are heavy, awkward to grip, and often need to be carried across
                uneven ground or up flights of stairs to reach the assembly area. Manual handling
                injuries are among the most common non-fatal injuries associated with tower work,
                and they can be severe enough to end careers.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <p>
                    ...
                    twisting while carrying, or repetitive bending during assembly. Can result in
                    chronic pain and long-term disability.
                  </p>
                  <p>
                    <strong className="text-white">Trapped and crushed fingers:</strong> Components
                    sliding during carrying, frames being lowered onto hands, and spigot connections
                    closing on fingers. Gloves provide some protection but correct hand positioning
                    is more important.
                  </p>
                  <p>
                    <strong className="text-white">Foot and ankle injuries:</strong> Dropping heavy
                    components onto feet, or tripping while carrying loads across uneven ground.
                    Safety footwear with toe protection is mandatory.
                  </p>
                  <p>
                    <strong className="text-white">Shoulder and arm injuries:</strong> Overhead
                    lifting, carrying components at arm's length, and passing frames up to
                    operatives on the tower. Repetitive strain from prolonged assembly work.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Plan the lift:</strong> Where are you picking
                      it up? Where is it going? Is the route clear? Do you need help?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Position your feet:</strong> Shoulder-width
                      apart, one foot slightly ahead for balance
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Bend the knees:</strong> Keep your back
                      straight, bend at the knees and hips, get a firm grip before lifting
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Lift smoothly:</strong> Use your leg muscles,
                      not your back. Avoid jerking or snatching the load
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Keep close:</strong> Hold the load as close to
                      your body as possible throughout the carry
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Team lift:</strong> If the component is too
                      heavy, too long, or too awkward for one person, always use a team lift
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Mechanical aids:</strong> For elevated assembly
                      areas, consider using a powered stair climber, trolley, or hoist to move
                      components
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  degeneration, nerve compression, and chronic pain. By the time symptoms appear,
                  the damage is done. Correct technique from day one is an investment in your
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                During assembly and dismantling, there are numerous points where fingers, hands, and
                limbs can become trapped or crushed between tower components. These injuries often
                happen quickly and without warning, making prevention through correct technique and
                awareness far more effective than reactive measures.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Frame locks:</strong> The locking mechanism on
                      frame connectors can close with significant force on fingers positioned in the
                      pinch zone
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Spigot connections:</strong> Inserting vertical
                      frames into the spigots of the level below creates a shear point where fingers
                      can be trapped between the tube and the cup
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Brace clips and hooks:</strong> Snap-on brace
                      connections can trap fingers as they spring into place
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Platform installation:</strong> Lowering
                      platform decks into position creates crush points at the edges where the
                      platform meets the frame
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Castor adjustment:</strong> Adjusting castor
                      height with the leg threads can trap fingers if the tower shifts during
                      adjustment
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  clear,&rdquo; and &ldquo;locked&rdquo; should be used at every connection point.
                  Never rush &mdash; the few seconds saved are not worth a crushed finger.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  tired by the time dismantling begins. Extra vigilance, fresh gloves (if worn ones
                  have reduced grip), and strict adherence to the &ldquo;hands clear&rdquo; protocol
                  are essential during the dismantling phase. If a connection is stuck, do not force
                  it with bare hands &mdash; use a rubber mallet and keep fingers well clear of the
                  release point.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  add bulk that may obscure the view of the pinch point. Operatives are tempted to
                  rush to get back into the warm, leading to less careful component handling. In
                  cold conditions, take extra time at each connection, and warm hands regularly to
                  maintain dexterity.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Working at height is physically demanding. Climbing, carrying components,
                maintaining balance on a platform, and concentrating for extended periods all take a
                toll on the body. Environmental conditions compound this &mdash; heat, cold, wind,
                and rain each introduce additional hazards that must be managed proactively.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <p>
                    ...
                    include excessive sweating, dizziness, nausea, confusion, and collapse.
                    Dehydration compounds the effect &mdash; even 2% body mass loss from dehydration
                    impairs concentration and reaction time.
                  </p>
                  <p>
                    <strong className="text-white">Cold in winter:</strong> Cold hands lose
                    dexterity and grip strength, increasing the risk of dropped tools and missed
                    connections during assembly. Hypothermia reduces mental sharpness and
                    decision-making. Cold metal components can cause contact cold burns on exposed
                    skin.
                  </p>
                  <p>
                    <strong className="text-white">Wind exposure:</strong> Wind chill reduces
                    effective temperature further. Wind also affects balance, makes it harder to
                    control components during assembly, and increases the force required to hold
                    position on the platform.
                  </p>
                  <p>
                    <strong className="text-white">Rain and wet conditions:</strong> Wet platforms,
                    ladder rungs, and components become slippery. Reduced visibility, distracted
                    concentration, and the urge to rush to &ldquo;get it done before it gets
                    worse&rdquo; all increase accident risk.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  repeatedly forgetting steps in the assembly sequence, irritability, and reduced
                  grip strength. A brief rest now prevents a serious incident later. Every operative
                  has the authority to request a break without criticism.
                </p>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  risk of skin cancer &mdash; the most common cancer in the UK construction
                  industry. Wear sunscreen (SPF 30+, reapplied every two hours), a hard hat with a
                  neck flap, and long sleeves where practicable. Do not dismiss sun protection as
                  something only for holidays &mdash; construction workers receive some of the
                  highest occupational UV doses of any profession.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  have driven two hours to reach site, you are already more fatigued than someone
                  who lives nearby. Factor this into your fitness-for-work self-assessment, and do
                  not underestimate the additional risk of the return journey when already tired
                  from a day at height.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  of entrapment increases. In high-noise environments, agree visual signals before
                  assembly begins, and consider ear defenders that attenuate noise while still
                  allowing verbal communication. Vibration from power tools used on the platform can
                  also accelerate fatigue in the hands and arms, reducing grip strength over time.
                </p>
              </div>
            </div>
          </div>
