...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      'During a pre-use inspection you notice a spigot has a cracked spring-loaded gravity lock. What should you do?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'A defective gravity lock means the spigot connection is not secure. The component must be immediately removed from service, clearly tagged as defective, and quarantined to prevent accidental reuse. Never attempt field repairs on structural tower components.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    id: 2,
    question:
      'Horizontal braces connect end frames at right angles. What is their primary function?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      "Horizontal braces connect opposing end frames at right angles, maintaining the correct spacing and providing lateral stability. Without them, the end frames could spread apart or move closer together, compromising the tower's structural integrity.",
  },
  {
    id: 3,
    question:
      'Diagonal braces are fitted in pairs on opposing faces of the tower. This pattern is called:',
    options: ['Parallel bracing', 'Cross-bracing', 'Plan bracing', 'Cantilever bracing'],
    correctAnswer: 1,
    explanation:
      'Fitting diagonal braces in opposing pairs creates cross-bracing (X-pattern). This triangulates the structure, providing rigidity and preventing racking — the parallelogram distortion that would cause the tower to lean and potentially collapse.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Spigots are male connectors that join frame sections vertically. They slide into the top of one frame section, and the next frame section sits over the protruding spigot, creating a secure vertical joint. Spring-loaded gravity locks hold the joint in place.',
  },
  {
    id: 6,
    ...
    correctAnswer: 2,
    explanation:
      "The maximum extension of adjustable legs is specified in the manufacturer's instruction manual. Exceeding this limit reduces the structural stability of the tower and creates a risk of collapse. Always check the manual for the specific tower system you are using.",
  },
  {
    id: 7,
    question:
...
const PasmaModule2Section2 = () => {
  useSEO({
    ...
    description:
      'Learn about mobile access tower structural components including end frames, braces, platforms, castors, spigots, and adjustable legs. Includes labelled tower diagram.',
  });
          ...
          <div className="rounded-lg p-4 bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">End frames:</strong> vertical ladder frames forming
                  the tower skeleton
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Braces:</strong> horizontal (lateral stability) and
                  diagonal (rigidity)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Platforms:</strong> working decks with trapdoor
                  access and locking hooks
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Base:</strong> castors (mobile), base plates
          ...
          <div className="rounded-lg p-4 bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Inspect:</strong> every component before use —
                  reject if damaged
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Check:</strong> all locks engaged, platforms
                  hooked, castors braked
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Verify:</strong> all components from same
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Record:</strong> any defects and quarantine damaged
                  components
                </span>
              </li>
            </ul>
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                <strong className="text-white">standards</strong> — connected by horizontal rungs
                called <strong className="text-white">transoms</strong>. The result is an H-shaped
                frame with built-in ladder rungs for climbing access.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  intervals. End frames are manufactured in sizes that match the tower width — 0.74m
                  frames for single-width towers and 1.35m frames for double-width towers.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Spigot sockets:</strong> at the top and bottom
                      of each standard for vertical stacking
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Brace connection points:</strong> welded
                      sockets or pressed fittings for attaching braces
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Locking mechanisms:</strong> gravity locks or
                      spring clips that engage when frames are stacked
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Rung spacing:</strong> typically 250mm to 300mm
                      centres, providing comfortable climbing steps
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <p>
                End frames are positioned at each end of the tower — hence the name. On a standard
                tower, two end frames sit opposite each other at each lift level, connected by
                horizontal and diagonal braces. The width of the end frame determines the tower
                width. Always check that the end frames match the intended tower configuration
                before assembly.
              </p>
            </div>
          </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                apart. There are two main types:
                <strong className="text-white"> horizontal braces</strong> and{' '}
                <strong className="text-white">diagonal braces</strong>.
              </p>
                ...
                <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white/70 space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Sometimes called <strong className="text-white">ledgers</strong>
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                ...
                <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white/70 space-y-2 text-sm">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Prevent <strong className="text-white">racking</strong> (parallelogram
                        distortion)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  or damaged. Racking significantly reduces structural stability and can lead to
                  tower collapse. Diagonal braces prevent racking by triangulating the structure.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  fitted within the plan view of the tower (across the platform area). Plan braces
                  prevent the tower from twisting and are typically required at the base level and
                  at intervals up the tower. Check the manufacturer's assembly sequence for plan
                  brace positions.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                working surface. Modern tower platforms incorporate a{' '}
                <strong className="text-white">trapdoor</strong> — a hinged section that opens to
                allow the operative to climb through from below.
              </p>
              ...
              <div className="bg-white/5 border border-teal-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Full-width deck:</strong> spans the complete
                      platform area, providing maximum working space
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Trapdoor access:</strong> hinged section allows
                      climbing through from below without removing guardrails
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Locking hooks:</strong> spring-loaded hooks
                      engage with the frame tubes to secure the platform
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Non-slip surface:</strong> textured or
                      perforated deck to reduce slip risk in wet conditions
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-teal-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Wind locks:</strong> some platforms have wind
                      locks to prevent uplift in windy conditions
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/60 text-sm space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Provide a resting point during the climb — reducing fatigue on tall towers
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Act as a staging area during assembly — the operative stands on the
                      intermediate platform while fitting the next lift of frames and braces above
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  <strong className="text-white">150kg to 275kg</strong> depending on the tower
                  class (BS EN 1004 load classes 1, 2, or 3). Always check the manufacturer's data
                  plate or instruction manual for the specific SWL of your platform.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                each component — you will need to identify them during assembly, inspection, and
              ...
              <div className="my-8 flex justify-center">
                ...
                >
                  ...
                  <text
                    x="145"
                    y="410"
                    className="text-green-400/90 fill-current"
                    fontSize="9"
                    fontFamily="system-ui"
                  >
                    Horizontal Brace
                  ...
                  <text
                    x="263"
                    y="454"
                    className="text-orange-400/90 fill-current"
                    fontSize="9"
                    fontFamily="system-ui"
                  >
                    Diagonal
                  ...
                  <text
                    x="15"
                    y="380"
                    className="text-purple-400/90 fill-current"
                    fontSize="9"
                    fontFamily="system-ui"
                  >
                    Spigot
                  ...
                  <text
                    x="5"
                    y="535"
                    className="text-amber-400/90 fill-current"
                    fontSize="9"
                    fontFamily="system-ui"
                  >
                    Adjustable
                  ...
                  <text
                    x="343"
                    y="574"
                    className="text-blue-400/90 fill-current"
                    fontSize="9"
                    fontFamily="system-ui"
                  >
                    Castor
                  ...
                  <text
                    ...
                    fontStyle="italic"
                  >
                    Base plates replace castors for fixed positions
                  </text>
                  ...
                  <text
                    ...
                    textAnchor="middle"
                  >
                    Double-Width Tower — Component Layout
                  </text>
                  <text
                    x="200"
                    y="52"
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                adjustable legs depends on whether the tower needs to be mobile, the ground
                conditions, and the manufacturer's specification.
              </p>
              ...
              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Swivel wheels:</strong> allow the tower to be
                      rolled to different positions when unoccupied
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Brakes:</strong> each castor has an integral
                      brake that must be locked before anyone ascends the tower
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Load rating:</strong> each castor is rated for
                      a maximum load — do not exceed it
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">ALL castors must be locked:</strong> not just
                      two diagonal ones — all four (or more) must be braked
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-white/70 text-sm">
                    ...
                    in a fixed position for an extended period.
                  </p>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-white/70 text-sm">
                    ...
                    nuts or pins secure the legs at the set height.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  Extending beyond this limit reduces the structural stability of the tower and
                  creates a risk of buckling or collapse. If the ground is too uneven for the
                  adjustable legs to compensate, the ground must be levelled first or an alternative
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                section, and the bottom socket of the next frame section sits over the protruding
                portion, creating a secure vertical joint.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  automatically under its own weight or spring tension, locking the joint in place.
                  The lock must be visually and physically confirmed as engaged before proceeding
                  with the build.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Visual check:</strong> Look for the gravity
                      lock tab — it should be fully extended through the engagement hole. If the tab
                      is not visible, the lock has not engaged.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <Search className="h-4 w-4 text-elec-yellow mt-1 flex-shrink-0" />
                    <div>
                      <strong className="text-white">Physical check:</strong> Attempt to lift the
                      upper frame section slightly. If properly locked, it should resist being
                      pulled upward. Any vertical play indicates the lock has not engaged.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/60 text-sm space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Excessive play (wobble) in the joint even when the lock appears engaged
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Corrosion or pitting on the spigot surface preventing smooth insertion
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Brace connectors (hooks, claws, or clips at each end of a brace) also use gravity
                locks or spring clips. The same inspection criteria apply — the connector must fully
                engage with the frame tube and the lock must be confirmed as secure before the brace
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                out methodically — checking each component as it is handled during assembly.
              </p>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <div className="text-white/70 text-sm space-y-2">
                  ...
                  <ol className="list-decimal pl-5 space-y-1 text-white/60">
                    ...
                    <li>
                      <strong className="text-white">Tag:</strong> Clearly mark it as defective (red
                      tag, tape, or written label)
                    </li>
                    <li>
                      <strong className="text-white">Quarantine:</strong> Separate it from
                      serviceable components to prevent accidental reuse
                    </li>
                    <li>
                      <strong className="text-white">Report:</strong> Inform the supervisor and
                      record the defect
                    </li>
                    <li>
                      <strong className="text-white">Return:</strong> Send the component to the
