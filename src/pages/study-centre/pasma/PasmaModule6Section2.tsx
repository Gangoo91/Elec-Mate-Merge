...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'The HSE recommends a 5-step risk assessment process: (1) Identify hazards, (2) Decide who might be harmed and how, (3) Evaluate the risks and decide on controls, (4) Record your findings, and (5) Review and update the assessment. This structured approach ensures no aspect of risk management is overlooked.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'A risk score of 16 falls into the red zone (13–25), which means the risk is unacceptable and work must not proceed until the risk has been reduced to an acceptable level through additional control measures. Only when the residual risk score drops to amber or green can work be considered.',
  },
  {
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'A comprehensive tower risk assessment must consider all site-specific hazards including ground conditions, overhead services, weather, traffic, public access, manual handling, working alone, emergency access, lighting, and noise. Focusing on only one or two factors leaves significant risks unmanaged.',
  },
  {
    id: 3,
    question:
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'The hierarchy of control must be followed in order: (1) Eliminate the hazard entirely, (2) Substitute with something less hazardous, (3) Engineering controls to isolate people from the hazard, (4) Administrative controls such as procedures and training, (5) PPE as a last resort. Higher-level controls are always more effective because they do not depend on human behaviour.',
  },
  {
    id: 5,
...
export default function PasmaModule6Section2() {
  useSEO({
    ...
    description:
      'HSE 5-step risk assessment process, likelihood × severity matrix, control hierarchy, method statements, dynamic risk assessment, and documentation requirements for mobile tower work.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>5 Steps:</strong> Identify, assess who, evaluate, record, review
              </li>
              <li>
                <strong>Score:</strong> Likelihood &times; Severity = Risk rating
              </li>
              <li>
                <strong>Controls:</strong> Eliminate &rarr; Substitute &rarr; Engineer &rarr; Admin
                &rarr; PPE
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Before:</strong> Site-specific risk assessment &amp; method statement
              </li>
              <li>
                <strong>During:</strong> Dynamic risk assessment &mdash; stop if conditions change
              </li>
              <li>
                <strong>After:</strong> Record near-misses, review, update for next time
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                to risk assessment. This is not paperwork for its own sake &mdash; it is a
                structured method for thinking through what could go wrong, who could be hurt, and
                what you are going to do about it before the work starts.
              </p>

              <div className="space-y-3">
                <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-green-500/30 text-green-300 text-sm font-bold flex-shrink-0">
                      1
                    </span>
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    routes, and the physical environment (lighting, noise, temperature). Consult the
                    manufacturer&rsquo;s instructions, industry guidance, and accident records.
                    Speak to people who do the work &mdash; they know where the real risks are.
                  </p>
                </div>

                <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-blue-500/30 text-blue-300 text-sm font-bold flex-shrink-0">
                      2
                    </span>
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    object hazard affects people at ground level, while a fall from height hazard
                    affects the platform operatives. Some people may be at higher risk: new
                    starters, lone workers, or those with medical conditions.
                  </p>
                </div>

                <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-amber-500/30 text-amber-300 text-sm font-bold flex-shrink-0">
                      3
                    </span>
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    existing controls and any additional controls needed. The goal is to reduce risk
                ...
                <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-purple-500/30 text-purple-300 text-sm font-bold flex-shrink-0">
                      4
                    </span>
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    4.2m due to missing guardrails — control: full guardrail system installed and
                    checked before use&rdquo; is meaningful. If you employ five or more people,
                    recording findings is a legal requirement under the Management of Health and
                ...
                <div className="bg-teal-500/10 border border-teal-500/30 p-4 rounded-lg">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-teal-500/30 text-teal-300 text-sm font-bold flex-shrink-0">
                      5
                    </span>
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    risk assessment is a dangerous document &mdash; it may give false confidence
                    that risks are being managed when they are not.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                While the 5-step process applies to any work activity, mobile tower work has
                specific hazards that must always be considered. The following list is not
                exhaustive but covers the key areas that should appear in every tower risk
                assessment.
              </p>
                ...
                <div className="grid md:grid-cols-2 gap-4 text-sm text-white/80">
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-white">Ground conditions:</strong> Firmness,
                        levelness, drainage, load-bearing capacity, underground services
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Overhead services:</strong> Power lines (15m
                        exclusion), building services, cranes, tree branches
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Weather exposure:</strong> Wind speed, rain,
                        ice, temperature extremes, lightning risk
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Nearby traffic:</strong> Vehicles, forklifts,
                        delivery lorries, site plant
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Public access:</strong> Pedestrians, site
                        visitors, building occupants, children
                      </span>
                    </li>
                  </ul>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Manual handling:</strong> Component weights,
                        carry distances, stair access, repetitive lifts
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Working alone:</strong> Lone working risks,
                        communication, emergency response capability
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Emergency access:</strong> Routes for
                        emergency services, first-aid provision, rescue plan
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Lighting:</strong> Natural light
                        availability, artificial lighting for early/late work, task lighting on
                        platform
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Noise:</strong> Proximity to noisy operations
                        affecting communication between team members
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  multi-national teams. Human factors are involved in the majority of workplace
                  accidents.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  introduces ice, frost, reduced daylight, cold-related injuries, and ground that
                  alternates between frozen and waterlogged. Spring brings unpredictable weather,
                  nesting birds in certain locations, and pollen that can cause sudden sneezing fits
                  at height. A risk assessment written in July may not be adequate in January
                  &mdash; seasonal variation must be considered.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  work that affects ground stability, welding or cutting that creates fire and fume
                  hazards, concrete pours that generate dust, and delivery vehicles manoeuvring near
                  the tower base. Coordination with the principal contractor and other trades is
                  essential to manage these interacting risks.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A risk matrix is a simple but powerful tool for prioritising hazards. By rating both
                the likelihood of a hazard causing harm and the severity of the potential outcome,
                you get a numerical risk score that helps determine what level of action is
                required.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-1 text-sm text-white/80">
                  ...
                  <p>
                    <strong className="text-white">2 &mdash; Unlikely:</strong> Not expected but
                    possible in certain conditions
                  </p>
                  <p>
                    <strong className="text-white">3 &mdash; Possible:</strong> Could occur during
                    the life of the project
                  </p>
                  <p>
                    <strong className="text-white">4 &mdash; Likely:</strong> Will probably occur at
                    some point
                  </p>
                  <p>
                    <strong className="text-white">5 &mdash; Very likely:</strong> Expected to occur
                    frequently or almost certainly
                  </p>
                </div>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-1 text-sm text-white/80">
                  ...
                  <p>
                    <strong className="text-white">2 &mdash; Minor:</strong> Injury requiring
                    medical treatment, short absence from work
                  </p>
                  <p>
                    <strong className="text-white">3 &mdash; Moderate:</strong> Injury causing
                    significant time off work (fracture, sprain)
                  </p>
                  <p>
                    <strong className="text-white">4 &mdash; Major:</strong> Serious injury with
                    long-term effects (amputation, spinal injury)
                  </p>
                  <p>
                    <strong className="text-white">5 &mdash; Catastrophic:</strong> Fatal injury or
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <p className="text-sm font-medium text-white mb-3">
                  Risk Score = Likelihood &times; Severity
                </p>
              ...
              <p>
                After applying control measures, re-score the residual risk. The difference between
                the original score and the residual score demonstrates the effectiveness of your
                controls. If the residual risk remains in the red zone, additional or alternative
                controls must be found before work can begin.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  ...
                  <p>
                    <strong className="text-white">Before controls:</strong> Likelihood 4 (likely
                    during extended work) &times; Severity 5 (fatal or life-changing) ={' '}
                    <span className="text-red-300 font-semibold">Risk Score 20 (RED)</span>
                  </p>
                  <p>
                    <strong className="text-white">Controls applied:</strong> Full guardrail system,
                    locked castors, toeboards, internal ladder access only, hoisting line for
                    materials, trained operatives, pre-use inspection
                  </p>
                  <p>
                    <strong className="text-white">After controls:</strong> Likelihood 1 (very
                    unlikely with all controls in place) &times; Severity 5 (fatal consequence
                    unchanged) ={' '}
                    <span className="text-amber-300 font-semibold">Risk Score 5 (AMBER)</span>
                  </p>
                  <p>
                    Note that the severity does not change &mdash; a fall from 6 metres is still
                    potentially fatal. The controls reduce the likelihood, not the consequences.
                    This is why the residual risk remains amber, requiring ongoing monitoring and
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Control measures must follow the hierarchy of control, working from the most
                effective (elimination) to the least effective (PPE). Higher-level controls are
                always preferable because they do not depend on individuals remembering to follow
                procedures or wear equipment.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <p>
                    ...
                    prefabricated components be lifted into position mechanically?
                  </p>
                  <p>
                    <strong className="text-white">2. Substitute:</strong> Can a lower platform be
                    used? Can an aluminium tower be replaced with a GRP tower near electrical
                    hazards? Can a different access method reduce the risk?
                  </p>
                  <p>
                    <strong className="text-white">3. Engineering controls:</strong> Guardrails and
                    toeboards on the platform, stabilisers and outriggers to prevent overturning,
                    barriers to protect from vehicle impact, sole boards to distribute loads on soft
                    ground.
                  </p>
                  <p>
                    <strong className="text-white">4. Administrative controls:</strong> PASMA
                    training, method statements, team briefings, permit-to-work systems, exclusion
                    zones, inspection regimes, supervision, and competence verification.
                  </p>
                  <p>
                    <strong className="text-white">5. PPE:</strong> Hard hats during assembly and
                    dismantling, safety footwear, gloves, high-visibility clothing near traffic. PPE
                    is always the last line of defence, never the first.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  disproportionate to the benefit. In practice, for high-severity hazards like falls
                  from height, very few control measures would be considered disproportionate. The
                  cost of a guardrail system is trivial compared to the cost of a fatal fall.
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A method statement &mdash; often called a &ldquo;safe system of work&rdquo; &mdash;
                is a written document that describes step by step how the tower assembly, use, and
                dismantling will be carried out safely. It takes the control measures identified in
                the risk assessment and turns them into practical, sequenced instructions that every
                member of the team can follow.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    follow the manufacturer&rsquo;s instructions and the chosen method (3T or AGR).
                  </p>
                  <p>
                    <strong className="text-white">Defined roles:</strong> Named individuals and
                    their specific responsibilities during assembly, use, and dismantling.
                  </p>
                  <p>
                    <strong className="text-white">Equipment list:</strong> A full inventory of
                    tower components, PPE, tools, sole boards, barriers, signage, and any other
                    ancillary equipment.
                  </p>
                  <p>
                    <strong className="text-white">Emergency procedures:</strong> What to do if
                    someone is injured, falls ill, or becomes stranded at height. The rescue plan,
                    first-aid arrangements, and emergency contacts.
                  </p>
                  <p>
                    <strong className="text-white">Inspection requirements:</strong> What must be
                    inspected before the tower is used, how often inspections take place during use,
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  (Risk Assessment and Method Statement) package. Neither document is complete
                  without the other &mdash; a risk assessment without a method statement identifies
                  problems without solutions, while a method statement without a risk assessment
                  prescribes actions without understanding the risks they address.
                </p>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  statement must reference specific site hazards, specific control measures,
                  specific team members, and specific emergency arrangements for that location.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  procedure, team roles, equipment checklist, risk controls cross-referenced to the
                  risk assessment, inspection requirements, emergency and rescue procedures,
                  sign-off by a competent person, and space for dynamic amendments during the work.
                  This structure provides both consistency and site-specific adaptability.
                </p>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  conditions on the ground. If anything has changed since the method statement was
                  written &mdash; a new obstruction, different ground conditions, a change in team
                  personnel &mdash; the method statement must be updated before work begins.
                  Proceeding with an outdated method statement is proceeding without a method
                  statement.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                No matter how thorough the pre-work risk assessment, conditions on site can change
                while work is in progress. Wind may increase, rain may start, new activities may
                begin nearby, or the ground may become waterlogged. Dynamic risk assessment is the
                process of continuously evaluating these changing conditions and taking action
                &mdash; including stopping work &mdash; when necessary.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Weather changes:</strong> Wind increasing, rain
                      starting, temperature dropping, lightning approaching
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ground changes:</strong> Ground becoming
                      waterlogged, new excavation nearby, vehicle creating ruts near the tower base
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">New activities:</strong> Crane operation
                      starting, hot work beginning nearby, traffic management changes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">New hazards:</strong> Overhead obstruction not
                      previously identified, chemical spill, structural movement in the building
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Personnel changes:</strong> New team member
                      arriving unfamiliar with the method statement, someone feeling unwell
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    authority. Work must stop until the new hazard has been assessed and either
                    controlled or the work method changed.
                  </p>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  that burst pipe? What if my colleague becomes unwell at the top of the tower? This
                  proactive thinking identifies hazards before they become incidents. It is not
                  paranoia — it is professional awareness. The best tower operatives are always
                  thinking one step ahead, not just reacting to what has already happened.
                </p>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  for a serious accident. If you are ever made to feel that stopping work for safety
                  reasons was wrong, that is a significant problem with the organisation&rsquo;s
                  safety culture, not with your judgement.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A risk assessment that exists only in someone&rsquo;s head protects nobody. The
                findings must be documented clearly and communicated to everyone who needs to act on
                them. Communication is not a one-way process &mdash; workers must have the
                opportunity to raise concerns and contribute their own knowledge of the risks.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Assembly team:</strong> Every person involved
                      in assembling, using, or dismantling the tower
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Tower users:</strong> Anyone who will work from
                      the platform after assembly, even if they were not part of the assembly team
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Site supervisor:</strong> The person
                      responsible for managing work activities in the area
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Other trades:</strong> Anyone working nearby
                      who may be affected by the tower work (falling objects, exclusion zones)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Client/principal contractor:</strong> May need
                      copies for site records and audit purposes
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  change in personnel or equipment, and at regular intervals for ongoing work. Each
                  review should be documented with the date, the reviewer, and the changes made. Old
                  versions should be retained for audit purposes.
                </p>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  fingers/thumbs/toes, amputation, loss of sight, crush injuries to head or torso),
                  any over-7-day incapacitation, and dangerous occurrences such as tower collapse or
                  contact with overhead power lines. Reports must be made without delay for
                  fatalities and within 15 days for other reportable events. Failure to report is a
                  criminal offence.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  demonstrate that the employer identified the hazards, evaluated the risks, and
                  implemented reasonable controls. A risk assessment that is vague, generic, or
                  clearly not site-specific will not withstand scrutiny. Conversely, a thorough,
                  specific, and well-communicated risk assessment demonstrates due diligence and
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  incidents as system failures to be understood, not individual failures to be
                  punished. When people are punished for reporting problems, they stop reporting
                  &mdash; and that is when real disasters occur.
                </p>
              </div>
            </div>
          </div>
