...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'PASMA cards are valid for 5 years from the date of training. After 5 years, operatives must complete a refresher course to renew their certification and maintain competence.',
  },
  {
    id: 'pasma-digital-date',
    question: 'From what date did PASMA transition to digital certification?',
    options: ['1 January 2024', '31 March 2025', '1 April 2026', '30 June 2025'],
    correctIndex: 1,
    explanation:
      'PASMA transitioned to digital certification from 31 March 2025, replacing the traditional physical card system with a digital card accessible via app and online portal.',
  },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Physical cards issued before 31 March 2025 remain valid until their expiry date. However, all new certifications and renewals from that date onwards are issued digitally only. You can access your digital card via the PASMA app or the online verification portal at any time.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation:
      "PASMA stands for Prefabricated Access Suppliers' and Manufacturers' Association. It is the lead trade body for the mobile access tower industry in the UK.",
  },
  {
    id: 3,
    ...
    correctAnswer: 2,
    explanation:
      'Towers for Users is the most commonly taken PASMA course. It covers the safe assembly, use, and dismantling of mobile scaffold towers and is typically delivered as a half-day practical course.',
  },
  {
    id: 4,
    question: 'How many member companies does PASMA have approximately?',
    options: ['50+', '100+', '250+', '400+'],
    correctAnswer: 3,
    explanation:
      "PASMA has over 400 member companies, including tower manufacturers, hire companies, training providers, and contractors who commit to upholding PASMA's standards.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'From 31 March 2025, PASMA transitioned to digital certification. All new certifications are issued digitally and can be accessed via the PASMA app and the online verification portal.',
  },
  {
    id: 7,
    ...
    correctAnswer: 2,
    explanation:
      'The PASMA Code of Practice is considered industry best practice by the HSE. While it is not law itself, it is regularly referenced in enforcement action and court proceedings as the standard against which competence and safe practice are measured.',
  },
  {
    id: 8,
...
export default function PasmaModule1Section3() {
  useSEO({
    ...
    description:
      'What PASMA is, the Code of Practice scope, course types including Towers for Users, digital certification from 31 March 2025, card validity and renewal process.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>PASMA:</strong> Trade body since 1974, 400+ members
              </li>
              <li>
                <strong>CoP:</strong> Industry best practice, referenced by HSE
              </li>
              <li>
                <strong>Card:</strong> 5-year validity, digital from March 2025
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Check:</strong> Valid PASMA card before tower work
              </li>
              <li>
                <strong>Verify:</strong> Use online portal or QR code scan
              </li>
              <li>
                <strong>Renew:</strong> Before expiry to avoid gaps in competence
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                PASMA stands for the{' '}
                <strong>
                  Prefabricated Access Suppliers&rsquo; and Manufacturers&rsquo; Association
                </strong>
                . Founded in 1974, it is a not-for-profit trade body that represents the mobile
                access tower industry in the United Kingdom and beyond.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Facts:</strong> PASMA has over
                  <strong> 400 member companies</strong> including tower manufacturers, hire
                  companies, training providers, and contractors. It is the recognised authority on
                  mobile tower safety and training in the UK construction and facilities management
                  sectors.
                </p>
              </div>
              ...
              <p>
                ...
                <strong> de facto standard</strong> for demonstrating competence in mobile tower
                work. The vast majority of construction sites, facilities, and employers require a
                valid PASMA card as a condition of working with towers.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The PASMA Code of Practice is the definitive guidance document for the safe use of
                mobile access towers. It brings together legislative requirements, European and
                British standards, and industry best practice into a single, practical reference.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Legal Standing:</strong> The Code of Practice
                  is not law. However, it is considered <strong>best practice by the HSE</strong>{' '}
                  and is regularly referenced in court cases, inquests, and enforcement action.
                  Failing to follow the Code of Practice can be used as evidence that a duty holder
                  did not take reasonably practicable steps to manage the risk of falls from height.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Specific guidance for advanced configurations and unusual environments
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                The Code of Practice is aligned with the Work at Height Regulations 2005, EN
                1004:2020, BS 1139-6, and other relevant legislation. It translates these legal and
                technical requirements into clear, practical guidance that tower users can follow on
                site.
              </p>
            </div>
          </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                fully digital certification system. This represents the biggest change to the PASMA
                card scheme since its inception and affects how you access and present your
                credentials.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">No more physical cards:</strong> New
                      certifications and renewals are issued digitally only. No plastic card will be
                      posted to you.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Digital card via app:</strong> Your PASMA card
                      is accessible through the official PASMA app on your smartphone, available
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Online portal access:</strong> You can also
                      access and share your certification via the PASMA website verification portal.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">QR code verification:</strong> Each digital
                      card includes a QR code that can be scanned by site managers and clients to
                      instantly verify your credentials.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                PASMA certifications have a fixed validity period. Understanding the renewal process
                and your employer&rsquo;s duty to check card validity is essential for maintaining
                compliance and ensuring that everyone working with towers is demonstrably competent.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Employer Duty to Check:</strong> Employers
                  have a duty under the Work at Height Regulations to ensure that persons working at
                  height are competent. This includes checking that PASMA cards are valid and
                  current before allowing operatives to assemble or work from towers. The online
                  verification system makes this straightforward.
                </p>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Relying on a photocopy rather than the actual card or digital version
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Holding a PASMA card means you have demonstrated competence to safely assemble,
                alter, dismantle, and use mobile scaffold towers. But the card comes with
                responsibilities and limitations that you must understand.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Follow the manufacturer&rsquo;s instruction manual for the specific tower
                      system
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Ensure the tower is assembled on firm, level ground with castors locked
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Use the correct access method (internal ladder or built-in stairway)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Ensure the tower is not used in wind speeds exceeding the manufacturer&rsquo;s
                      limit
                    </span>
                  </li>
                </ul>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  operative&rsquo;s name matches their identity, the course type matches the work
                  they will carry out (e.g. Towers for Users, not just Work at Height Essentials),
                  the card is within its 5-year validity period, and the card has not been reported
                  lost or suspended.
                </p>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  untrained persons to work with towers breaches the Work at Height Regulations and
                  exposes everyone on site to unacceptable risk.
                </p>
              </div>
            </div>
          </div>
