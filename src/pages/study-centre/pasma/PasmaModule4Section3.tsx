...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Damaged components must be immediately separated from serviceable stock, tagged with a red defect tag, and the defect details recorded. They must be placed in a quarantine area and must not be re-used until they have been repaired by the manufacturer or disposed of.',
  },
];
...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      'The primary reason for proper storage is to prevent component damage. Damaged components — whether corroded, bent, or contaminated — can fail in use, leading to tower collapse and serious injury or death.',
  },
  {
    id: 2,
    question:
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'A red tag indicates that the component is defective, has been quarantined, and must not be used under any circumstances. It must remain in the quarantine area until it is repaired by the manufacturer or disposed of.',
  },
  {
    id: 5,
    ...
    correctAnswer: 1,
    explanation:
      'Debris such as concrete, grit, and plaster in the castor wheels and brake mechanisms can cause them to seize during storage. If the brake fails to engage on next use, the tower can roll when occupied, leading to overturning.',
  },
  {
    id: 6,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      "Manufacturers' warranties typically include conditions about storage and maintenance. Storing components outdoors without protection, failing to maintain them, or making unauthorised repairs can all void the warranty, leaving the owner liable for replacement costs.",
  },
];
...
export default function PasmaModule4Section3() {
  useSEO({
    ...
    description:
      'Correct storage and maintenance procedures for mobile scaffold tower components including cleaning, indoor storage, component segregation, quarantine, and manufacturer requirements.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Clean first:</strong> remove concrete, plaster, paint before storing
              </li>
              <li>
                <strong>Store:</strong> under cover, off ground, on racking, ventilated
              </li>
              <li>
                <strong>Quarantine:</strong> tag and separate damaged components immediately
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Before storing:</strong> Clean, inspect, sort by type
              </li>
              <li>
                <strong>During storage:</strong> Regular checks, lubricate castors, test locks
              </li>
              <li>
                <strong>Defects found:</strong> Red tag, quarantine, record, report
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Mobile scaffold tower components are precision-engineered structural elements. They
                are designed to carry specific loads and maintain specific tolerances. When
                components are damaged through poor storage &mdash; whether by corrosion, bending,
                contamination, or UV degradation &mdash; they can no longer perform as designed. A
                corroded frame may look intact but fail under load. A bent brace may fit but provide
                no structural support.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Point:</strong> Damaged components cause
                  tower failures. Tower failures cause falls from height. Falls from height cause
                  death and life-changing injuries. The chain from poor storage to a fatal incident
                  is direct and well documented in HSE investigation reports.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Corrosion:</strong> Steel components left in damp conditions rust.
                      Rust weakens the metal and can cause lock mechanisms to seize.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Bending:</strong> Frames and braces stored directly on the floor or
                      stacked improperly can become bent, affecting fit and structural integrity.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Contamination:</strong> Concrete and plaster left on components traps
                      moisture, accelerating corrosion and jamming connection points.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>UV degradation:</strong> GRP (fibreglass) components exposed to
                      sunlight deteriorate, losing strength and becoming brittle.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every component should be cleaned before it goes into storage. This is not about
                aesthetics &mdash; cleaning serves two critical safety purposes. First, it removes
                contaminants that cause corrosion and mechanical failure. Second, the act of
                cleaning each component forces a close visual inspection that reveals defects.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    or scraper. Do not use power tools that could damage the zinc coating.
                  </p>
                  <p>
                    <strong className="text-white">Paint splashes:</strong> Remove with an
                    appropriate solvent where necessary, particularly from connection points, lock
                    mechanisms, and adjustment threads.
                  </p>
                  <p>
                    <strong className="text-white">Castor wheels and brakes:</strong> Clear all
                    debris from the wheel treads, axles, and brake mechanisms. Grit in the brake
                    mechanism is a common cause of brake failure.
                  </p>
                  <p>
                    <strong className="text-white">Labels and tape:</strong> Remove all
                    site-specific labels, hazard tape, and adhesive residue. Old labels can conceal
                    defects and cause confusion on the next job.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  cleaning should be treated as a combined cleaning and inspection activity, not
                  just a housekeeping task.
                </p>
              </div>

              <p>
                After cleaning, allow components to dry completely before placing them into storage.
                Storing damp components in an enclosed space creates the very conditions that cause
                corrosion. If components have been washed, stand them upright to drain and air-dry
                before racking.
              </p>
            </div>
          </div>
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                extremes of temperature. While not every site can provide perfect conditions, the
                closer you get to this standard, the longer your components will last.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  ...
                  <p>
                    <strong className="text-white">Off the ground:</strong> Components stored
                    directly on the floor sit in any water that collects and are vulnerable to
                    forklift damage. Use racking or pallet supports.
                  </p>
                  <p>
                    <strong className="text-white">On racking:</strong> Purpose-built racking
                    organises components, prevents bending from improper stacking, and makes stock
                    management easier.
                  </p>
                  <p>
                    <strong className="text-white">Ventilated:</strong> Air circulation prevents
                    condensation buildup. A sealed, unventilated container will generate
                    condensation as temperatures change, creating a damp environment that
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    recommends to avoid bending the lower items.
                  </p>
                  <p>
                    <strong className="text-white">Braces (diagonal and horizontal):</strong> Store
                    flat on racking. Keep diagonal braces separate from horizontal braces to prevent
                    mix-ups during assembly.
                  </p>
                  <p>
                    <strong className="text-white">Platforms and trapdoor platforms:</strong> Store
                    flat, supported evenly. Do not stand platforms on their edge as this can cause
                    warping over time.
                  </p>
                  <p>
                    <strong className="text-white">Castors:</strong> Store clean, with brakes
                    engaged to prevent the mechanism from relaxing. Keep away from sources of grit
                    and dust.
                  </p>
                  <p>
                    <strong className="text-white">Stabilisers and outriggers:</strong> Store
                    together. Check adjustment threads are clean and free-moving before putting
                    away.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Example: &ldquo;BoSS Clima &mdash; Diagonal Braces &mdash; 1.45m&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Example: &ldquo;Youngman &mdash; Trapdoor Platforms &mdash; 1.8m&rdquo;
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  certifications, and creates an untested, potentially unsafe structure.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    picked up by someone unaware of the defect.
                  </p>
                  <p>
                    <strong className="text-white">2. Apply a red tag:</strong> Attach a red defect
                    tag to the component with the date, description of the defect, and the name of
                    the person who found it.
                  </p>
                  <p>
                    <strong className="text-white">3. Record the defect:</strong> Enter the defect
                    in the maintenance and inspection register. Include the component type, serial
                    number or identifier if available, nature of the defect, and severity.
                  </p>
                  <p>
                    <strong className="text-white">4. Place in quarantine area:</strong> Move the
                    component to a designated quarantine area that is clearly signed and separate
                    from serviceable stock.
                  </p>
                  <p>
                    <strong className="text-white">5. Prevent re-use:</strong> The component must
                    not be used again until it has been repaired by the manufacturer or a
                    manufacturer-approved repairer, re-certified, and returned to service with
                    documentation.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Bent or bowed frame tubes (even slight bends affect structural capacity)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <p>
                The quarantine area should be clearly signed &ldquo;Defective Equipment &mdash; Do
                Not Use&rdquo; and should be locked or controlled to prevent unauthorised access.
                Defective components left in an unlocked area will eventually find their way back
                into service.
              </p>
            </div>
          </div>
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                that is only caught by routine checks. A maintenance schedule ensures nothing is
                overlooked.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    manufacturer. This prevents seizing and ensures smooth operation on next use.
                  </p>
                  <p>
                    <strong className="text-white">Lock mechanism testing:</strong> Operate every
                    lock mechanism (gravity locks, spigot pins, AGR release catches) through its
                    full range at least quarterly. Mechanisms that are not used can seize.
                  </p>
                  <p>
                    <strong className="text-white">Frame straightness verification:</strong>{' '}
                    Visually check frames for straightness. Place on a flat surface and check for
                    rocking or bowing. Even slight deformation can indicate impact damage.
                  </p>
                  <p>
                    <strong className="text-white">Brake testing:</strong> Engage and disengage
                    every castor brake. The brake must hold firmly when engaged and release fully
                    when disengaged. Replace any castor with a suspect brake.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  manufacturer&rsquo;s requirements as a minimum &mdash; if your experience or
                  conditions suggest more frequent maintenance, increase the frequency.
                </p>
              </div>

              <p>
                Record all maintenance activities in a maintenance log. This creates an audit trail
                demonstrating due diligence and helps identify components that require more frequent
                attention or are approaching end of life.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                instructions for their equipment. These instructions are not advisory &mdash; they
                form part of the design and certification basis for the tower. Failing to follow
                them can compromise the equipment&rsquo;s safety and void all warranties and product
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  inspect their specific tower system. If there is ever a conflict between general
                  guidance and the manufacturer&rsquo;s instructions, the manufacturer&rsquo;s
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Storage environment:</strong> Temperature range, humidity limits, UV
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Stacking limits:</strong> Maximum number of frames or platforms that
                      can be stacked without causing damage
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Maintenance intervals:</strong> How often to lubricate, test, and
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Component lifespan:</strong> Expected service life under normal
                      conditions and when to retire components
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Replacement criteria:</strong> What level of wear or damage requires
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Approved repair centres:</strong> Where to send damaged components for
                      authorised repair
                    </span>
                  </li>
                </ul>
              ...
              <p>
                If you are unsure about any aspect of storage, maintenance, or repair, contact the
                manufacturer directly. Most tower manufacturers have technical support teams who can
                advise on specific situations. It is always better to ask than to guess when the
                safety of a structural element is in question.
              </p>
            </div>
          </div>
        </section>
