...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'Work should cease when wind reaches Beaufort 4 (moderate breeze, approximately 13-18 mph / 17 kph). At this wind speed, loose materials can be blown from the platform and the tower experiences significant lateral loading. The tower itself is typically rated to withstand up to Beaufort 6, but working conditions become unsafe at Beaufort 4.',
  },
];
...
const quizQuestions = [
  {
    id: 1,
    question:
      'What is the typical maximum freestanding height for a double-width tower used indoors?',
    options: ['Up to 4 metres', 'Up to 8 metres', 'Up to 12 metres', 'Up to 18 metres'],
    correctAnswer: 2,
    explanation:
      "Double-width towers used indoors can typically reach up to approximately 12m platform height (varies by manufacturer). Indoor use eliminates wind loading, allowing greater freestanding heights. Always verify the specific limit in the manufacturer's instruction manual.",
  },
  {
    id: 2,
    question: 'What is the typical maximum freestanding height for a tower used outdoors?',
    options: ['Up to 4 metres', 'Up to 8 metres', 'Up to 12 metres', 'Up to 15 metres'],
    correctAnswer: 1,
    explanation:
      'Outdoor towers are typically limited to approximately 8m freestanding platform height for double-width configurations. Wind loading is the primary limiting factor. Single-width towers have even lower outdoor height limits due to their narrower base.',
  },
  {
    id: 3,
    question:
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'BS EN 1004 defines load classes (1, 2, and 3) that specify the maximum distributed load on the working platform. This includes the weight of operatives, tools, and materials. Class 3 has the highest load rating. The load class must be checked against the planned use before work begins.',
  },
  {
    id: 6,
...
const PasmaModule2Section4 = () => {
  useSEO({
    ...
    description:
      'Learn how to select the right tower for the task: indoor vs outdoor, single vs double width, height calculations, environmental factors, ground conditions, and load planning.',
  });
          ...
          <div className="rounded-lg p-4 bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Indoor:</strong> higher heights (up to 12m), no
                  wind, check floor loading
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Outdoor:</strong> lower heights (up to 8m), wind
                  limits Beaufort 4
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Height:</strong> platform height = working height
                  minus 2m reach
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Ground:</strong> must be firm, level, and
                  load-bearing
                </span>
              </li>
            </ul>
          ...
          <div className="rounded-lg p-4 bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Plan:</strong> calculate height, check space,
                  assess environment
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Select:</strong> tower type, width, material based
                  on assessment
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Document:</strong> method statement, risk
                  assessment, inspection records
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Communicate:</strong> brief team, liaise with site
                  management
                </span>
              </li>
            </ul>
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                need for stabilisers, and the ongoing risk assessment during use.
              </p>
                ...
                <div className="bg-white/5 border border-elec-yellow/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white/70 space-y-2 text-sm">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <strong className="text-white">Higher freestanding heights:</strong> up to
                        12m (no wind loading)
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                      <div>
                        <strong className="text-white">No wind assessment:</strong> but check for
                        draughts from open doors/loading bays
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                      <div>
                        <strong className="text-white">Floor loading:</strong> check the floor can
                    ...
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                      <div>
                        <strong className="text-white">Ceiling height:</strong> ensure sufficient
                        clearance above the platform
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                      <div>
                        <strong className="text-white">Surface:</strong> concrete, tile, raised
                        floor — check condition and rating
                      </div>
                    </li>
                  </ul>
                </div>
                <div className="bg-white/5 border border-elec-yellow/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white/70 space-y-2 text-sm">
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                      <div>
                        <strong className="text-white">Lower freestanding heights:</strong> up to 8m
                        (wind loading applies)
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                      <div>
                        <strong className="text-white">Wind assessment:</strong> continuous
                        monitoring, cease work at Beaufort 4
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                      <div>
                        <strong className="text-white">Ground conditions:</strong> soil, gravel,
                        tarmac — may need sole boards
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                      <div>
                        <strong className="text-white">Weather:</strong> rain, ice, temperature
                        extremes all affect safety
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-elec-yellow mt-2 flex-shrink-0"></div>
                      <div>
                        <strong className="text-white">Stabilisers:</strong> typically required at
                        lower heights than indoor use
                      </div>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  generally be treated as outdoor for tower selection purposes. When in doubt, apply
                  outdoor height limits.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                requirements — not personal preference or convenience.
              </p>
              ...
              <p>
                As a general rule: if both widths would physically fit and the double-width is
                available, choose double-width. The increased stability and working area make it the
                safer and more productive option in most situations.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                <strong className="text-white">working height</strong> (the height you need to
                reach) and <strong className="text-white">platform height</strong> (the height of
                the tower platform).
              </p>
                    ...
                    <tbody className="text-white/70">
                      ...
                      <tr>
                        ...
                        <td className="py-2 pr-4" colSpan={2}>
                          Heights may be extended — see manufacturer's data
                        </td>
                      </tr>
                    </tbody>
                  </table>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                lighting, and noise all affect the risk assessment.
              </p>
                  ...
                  <div>
                    ...
                    <ul className="text-white/60 space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          Extreme heat: fatigue, dehydration, metal components hot to touch
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                <strong className="text-white"> bearing the load</strong> of the tower and
                everything on it. Poor ground conditions are a leading cause of tower instability
                and collapse.
              </p>
              ...
              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/60 text-sm space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Sole boards</strong> (spreader plates)
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Must be level — use packing beneath the sole board if needed, not under the
                      castor
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Timber sole boards should be at least 225mm x 225mm x 40mm for each support
                      point
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                any equipment on the platform. Overloading a platform can cause structural failure,
                platform collapse, or tower overturning.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="bg-white/5 rounded p-3 text-sm">
                  ...
                  <p className="text-green-400/70 mt-1">
                    125kg is well within the 675kg SWL &#10003;
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  lifting, pulling, or pushing while on the platform — can momentarily exceed the
                  static load. When drilling into a wall, for example, the reaction force pushes the
                  operative backward and transfers a lateral force through the platform. Always plan
                  for dynamic loading by keeping the static load well below the SWL maximum.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                controlled, and all necessary documentation is in place.
              </p>
                  ...
                  <div>
                    ...
                    <ul className="text-white/60 space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          What is the working height required? (Calculate platform height)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  ...
                  <div>
                    ...
                    <ul className="text-white/60 space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          Indoor or outdoor? (Determines max heights and wind considerations)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          Adjacent hazards? (Open edges, traffic routes, live electrical equipment)
                        </span>
                      </li>
                    </ul>
                  </div>
                  <div>
                    ...
                    <ul className="text-white/60 space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          Configuration: standard, stairway, linked, bridge? (Based on access needs)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          Access method: ladder or stairway? (Based on frequency and duration)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          Tower system: BS EN 1004 compliant? Manufacturer's manual available?
                        </span>
                      </li>
                    </ul>
                  </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/60 text-sm space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Tower specification (manufacturer, model, configuration, max height)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Inspection arrangements (pre-use, periodic, who inspects, how recorded)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
