...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 2,
    explanation:
      'Moving a tower with anyone on the platform is absolutely prohibited. It is a zero-tolerance offence on virtually all construction sites and can result in immediate dismissal, prosecution, and serious injury or death from overturning.',
  },
  {
...
const faqs = [
  {
    ...
    answer:
      'A minimum of two people are required to move a tower safely. One person should push or pull the tower at base level while at least one other person acts as a spotter, watching for overhead hazards, obstructions, and other workers in the path. For larger towers or longer moves, more people may be needed to maintain control.',
  },
  {
    question: 'Can I push a tower from a higher level rather than from the base?',
    answer:
      'No. You must always push or pull a tower from the base level only. Pushing from a higher point raises the centre of gravity of the applied force, dramatically increasing the risk of overturning. The force should be applied as low as possible, ideally at or near castor height.',
  },
  {
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Force must always be applied at the base level. Pushing from a higher point creates a turning moment that can overturn the tower. The lower the push point, the more stable the tower remains during movement.',
  },
  {
    id: 4,
  ...
  },
  {
    id: 6,
    question:
      'Moving a tower with a person on the platform is classified as what on most UK construction sites?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Moving a tower with anyone on the platform is a zero-tolerance offence on most UK construction sites. It can lead to immediate removal from site, disciplinary action, and prosecution. The risk of the tower overturning with a person at height is extremely serious.',
  },
  {
    id: 7,
...
export default function PasmaModule4Section2() {
  useSEO({
    ...
    description:
      'Safe procedures for moving and repositioning mobile scaffold towers including pre-move conditions, route planning, post-move verification, and zero-tolerance rules.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Never move</strong> with anyone on the platform
              </li>
              <li>
                <strong>Max height:</strong> 4m or manufacturer&rsquo;s limit
              </li>
              <li>
                <strong>Push at base</strong> &mdash; never from height
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Before:</strong> Survey route, check conditions, remove materials
              </li>
              <li>
                <strong>During:</strong> Push at base, spotter watching overhead, move slowly
              </li>
              <li>
                <strong>After:</strong> Lock castors, check level, re-inspect, update records
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A mobile scaffold tower can only be moved when a specific set of conditions are{' '}
                <strong>all</strong> met simultaneously. If even one condition is not satisfied, the
                tower must not be moved. There are no partial exceptions and no workarounds.
              </p>
              ...
              <p>
                The Work at Height Regulations 2005 require that work equipment used at height is
                stable at all times. Moving a tower inherently introduces instability &mdash; forces
                acting on the structure, uneven ground transitions, and the risk of striking
                obstacles. This is why the pre-move conditions are so strict.
              </p>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every single condition on this checklist must be confirmed as true before the tower
                is moved. This is not a &ldquo;best practice&rdquo; recommendation &mdash; it is a
                mandatory set of requirements. If any condition is not met, the tower stays where it
                is.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    during a move. Zero tolerance.
                  </p>
                  <p>
                    <strong className="text-white">2. Wind below Beaufort Force 4:</strong>{' '}
                    Approximately 13&ndash;18 mph. If small branches are moving or loose paper is
                    being lifted, do not move the tower.
                  </p>
                  <p>
                    <strong className="text-white">3. Tower height within the moving limit:</strong>{' '}
                    Maximum 4 metres overall height, or the lower limit specified by the
                    manufacturer. If the tower exceeds this, it must be partially dismantled first.
                  </p>
                  <p>
                    <strong className="text-white">4. All tools and materials removed:</strong>{' '}
                    Nothing should remain on the platform. Loose items can fall during movement, and
                    they raise the centre of gravity.
                  </p>
                  <p>
                    <strong className="text-white">5. Route clear and surveyed:</strong> The entire
                    route from current to new position must be free of obstructions, and the ground
                    must be firm and level throughout.
                  </p>
                  <p>
                    <strong className="text-white">6. Ground firm and level:</strong> The route must
                    support the tower&rsquo;s weight. Soft ground, mud, gravel, and slopes are all
                    hazards.
                  </p>
                  <p>
                    <strong className="text-white">7. No overhead hazards on route:</strong> Check
                    for overhead cables, beams, pipework, lighting, and any other obstructions above
                    the tower&rsquo;s height on the intended path.
                  </p>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Once all pre-move conditions have been confirmed, the tower can be moved using the
                following procedure. The move should be slow, controlled, and stopped immediately if
                any problem arises.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  ...
                  <p>
                    <strong className="text-white">Step 2:</strong> Position a minimum of two people
                    at the base of the tower. One pushes, one acts as spotter.
                  </p>
                  <p>
                    <strong className="text-white">Step 3:</strong> Push the tower at base level
                    only. Apply force as low as possible, ideally at or near the bottom frame
                    members.
                  </p>
                  <p>
                    <strong className="text-white">Step 4:</strong> Move slowly and steadily. Sudden
                    movements or rapid changes in direction can destabilise the tower.
                  </p>
                  <p>
                    <strong className="text-white">Step 5:</strong> The spotter walks ahead or
                    alongside, watching for overhead hazards, ground-level obstructions, and other
                    personnel in the path.
                  </p>
                  <p>
                    <strong className="text-white">Step 6:</strong> Maintain clear verbal
                    communication throughout the move. Use commands like &ldquo;moving&rdquo;,
                    &ldquo;stop&rdquo;, &ldquo;overhead&rdquo;, and &ldquo;clear&rdquo;.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  minimising the overturning moment. Even a moderate push at mid-height can overturn
                  a tower on an uneven surface.
                </p>
              </div>

              <p>
                If the tower needs to pass through a doorway, measure the doorway width and the
                tower width (including any projecting components) before attempting to pass through.
                Forcing a tower through a tight opening can damage the tower structure and jam the
                castors.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Repositioning a tower subjects its structure to forces it does not experience when
                stationary. Vibrations from uneven ground, impacts from obstacles, and the forces of
                pushing and stopping can all loosen connections. A thorough post-move check is
                therefore essential before anyone climbs the tower.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  ...
                  <p>
                    <strong className="text-white">Check level:</strong> Use a spirit level on the
                    platform or check the base frame. The tower must be plumb. Adjust leg screws if
                    fitted.
                  </p>
                  <p>
                    <strong className="text-white">Verify stability:</strong> Gently push the tower
                    at waist height. It should feel rigid with no excessive sway. If it feels
                    unstable, do not use it.
                  </p>
                  <p>
                    <strong className="text-white">Check for new overhead hazards:</strong> The new
                    position may have different overhead services, lighting, cables, or structural
                    elements. Confirm safe clearance.
                  </p>
                  <p>
                    <strong className="text-white">Re-inspect all components:</strong> Check that
                    frames, braces, platforms, and guardrails have not loosened during the move.
                    Tighten or re-seat as needed.
                  </p>
                  <p>
                    <strong className="text-white">Confirm braces are secure:</strong> Diagonal and
                    horizontal braces can work loose during movement. Verify every connection.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  not optional &mdash; it is a mandatory safety step.
                </p>
              </div>

              <p>
                If the tower has been moved to a position where stabilisers or outriggers are
                required (e.g. on a softer surface or at a greater height), these must be fitted and
                adjusted before the tower is used. Re-attach any stabilisers that were removed for
                the move.
              </p>
            </div>
          </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                zero-tolerance offences across the construction industry. These rules are absolute
                &mdash; there are no circumstances, no matter how urgent the job, where they can be
                broken.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white">
                  <div>
                    ...
                    <p>
                      This is the most dangerous act associated with mobile towers. The forces of
                      movement, combined with the height of the person, create an extreme
                      overturning risk. On most UK construction sites this is treated as an
                      immediate dismissal offence. Prosecution under HSWA 1974 Section 7 is common.
                    </p>
                  </div>
                  <div>
                    <p className="font-medium text-white">
                      NEVER move in wind above Beaufort Force 4
                    </p>
                    <p>
                      Wind acting on the tower during movement significantly increases the
                  ...
                  <div>
                    <p className="font-medium text-white">
                      NEVER move above the manufacturer&rsquo;s moving height limit
                    </p>
                    <p>
                      The maximum moving height (typically 4 metres) is calculated by the
                      ...
                      because the centre of gravity is too high relative to the base.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  rules apply to every move, regardless of distance.
                </p>
              </div>
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                position must be surveyed on foot. The person carrying out the survey should walk
                the route looking for every potential hazard, measuring critical clearances, and
                identifying any obstacles that need to be removed.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    cable covers. Any change in level or surface can jam castors.
                  </p>
                  <p>
                    <strong className="text-white">Ramps and slopes:</strong> Even gentle slopes can
                    cause a tower to roll uncontrolled. If a slope cannot be avoided, additional
                    people are needed to control the speed.
                  </p>
                  <p>
                    <strong className="text-white">Door widths:</strong> Measure the tower width
                    including any projecting components and compare with every doorway on the route.
                    Remember that stabiliser brackets may project beyond the base frame.
                  </p>
                  <p>
                    <strong className="text-white">Other workers:</strong> Identify work areas along
                    the route. Inform other trades of the planned move and timing. Establish
                    temporary exclusion zones if needed.
                  </p>
                  <p>
                    <strong className="text-white">Vehicle movements:</strong> On sites with vehicle
                    traffic, coordinate the move with the traffic management plan. Use a banksman if
                    the route crosses a vehicle route.
                  </p>
                </div>
              </div>
              ...
              <p>
                Remove obstacles before the move, not during it. If a bin, cable, pallet, or other
                obstruction is on the route, clear it first. Attempting to steer a tower around
                obstacles while it is in motion increases the risk of collision and overturning. A
                clear, straight route is always safer than a winding one.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Every tower relocation must be documented and communicated to the relevant parties.
                This is not just good practice &mdash; it is a requirement of the inspection regime
                under Schedule 5 of the Work at Height Regulations 2005. A tower that has been moved
                is effectively a tower in a new location and must be treated accordingly.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    move, and who carried out the post-move inspection.
                  </p>
                  <p>
                    <strong className="text-white">Post-move inspection record:</strong> A fresh
                    Schedule 5 inspection record must be completed for the tower in its new
                    position. This is treated as a new location and triggers the &ldquo;before first
                    use&rdquo; inspection requirement.
                  </p>
                  <p>
                    <strong className="text-white">Risk assessment review:</strong> The risk
                    assessment must be reviewed for the new location. New hazards (overhead
                    services, different ground, proximity to traffic) may require additional control
                    measures.
                  </p>
                  <p>
                    <strong className="text-white">Method statement update:</strong> If the method
                    statement references the tower location, it must be updated to reflect the new
                    position.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Point:</strong> Inform site management of
                  the tower&rsquo;s new position. Other trades, the principal contractor, and
                  emergency services need to know where towers are located. An unannounced tower in
                  a new position can block emergency access routes or interfere with other planned
                  work.
                </p>
              </div>

              <p>
                If the tower is moved to a location where it affects fire escape routes, access for
                deliveries, or the work of other trades, these parties must be informed before the
                move takes place. On larger sites, the tower coordinator or site manager may need to
                approve the new position in advance.
              </p>
