...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'The AGR (Advance Guard Rail) system deploys guardrails upward from below, meaning protection is already in place before the operative climbs to the next level. With the 3T method, there is a brief period where the operative must install guardrails from the waist-height position through the trapdoor.',
  },
  {
    ...
    correctIndex: 2,
    explanation:
      'AGR frames are manufacturer-specific and must be used with compatible tower systems from the same manufacturer. The 3T method, by contrast, works with any standard tower that has trapdoor platforms, regardless of manufacturer.',
  },
  {
    id: 'agr-dismantling',
    question:
      'When dismantling a tower with AGR frames, at what point can the guardrails be lowered and folded?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'During AGR dismantling, the guardrails must remain in position until the operative has descended to the lower level. Only from the safety of the lower platform can the guardrails be unlocked, lowered, and folded. This maintains continuous edge protection throughout the dismantling process.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'The 3T method works with any standard tower that has trapdoor platforms, regardless of manufacturer. AGR requires specific compatible frames from the same manufacturer, making the 3T method more versatile across different tower systems.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'AGR frames require inspection of the hinge points for free movement, locking mechanisms for positive engagement, springs for correct tension, and guardrail sections for straightness and structural integrity. Any defect in the AGR mechanism makes the frame unsafe to use.',
  },
  {
    id: 7,
    question:
      'Can AGR frames from manufacturer A be used with standard frames from manufacturer B?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'AGR frames are manufacturer-specific and must only be used with compatible components from the same manufacturer and tower system. Mixing manufacturers risks incompatible fits and failed locking mechanisms.',
  },
  {
    id: 8,
...
export default function PasmaModule3Section3() {
  useSEO({
    ...
    description:
      'How the Advance Guard Rail assembly method works, step-by-step AGR assembly, 3T vs AGR comparison, when to use each method, dismantling, and AGR maintenance.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Principle:</strong> Guardrails deployed BEFORE climbing to next level
              </li>
              <li>
                <strong>How:</strong> Hinged guardrails pushed up from below, locked in place
              </li>
              <li>
                <strong>Result:</strong> No exposure to unguarded edges at any point
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Requires:</strong> Specific AGR-compatible frames from one manufacturer
              </li>
              <li>
                <strong>Base:</strong> Same as 3T &mdash; castors, frames, braces, level, lock
              </li>
              <li>
                <strong>Check:</strong> AGR hinges, locks, and springs before each use
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The AGR (Advance Guard Rail) method is the most advanced and safest assembly
                technique for mobile scaffold towers. Unlike the 3T method where guardrails are
                installed after the operative passes through the trapdoor, AGR frames provide
                guardrail protection <strong>before</strong> the operative reaches the next level.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Core Principle:</strong> AGR frames have
                  built-in guardrail sections that are hinged to the end frames. These guardrail
                  sections are pushed upward from below and locked into their extended position.
                  Once locked, they provide full guardrail protection at the next level &mdash;
                  before anyone climbs there.
                </p>
              </div>

              <p>
                The AGR method is considered the safest because the operative is never exposed to an
                unguarded edge at any point during the assembly. With the 3T method, there is a
                brief transition where the operative must install guardrails from the waist-height
                position. The AGR method eliminates even this brief exposure.
              </p>
              ...
              <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  towers, and sites with strict safety standards.
                </p>
              </div>

              <p>
                The AGR method was developed in response to the recognition that the brief unguarded
                period during 3T guardrail installation &mdash; however short &mdash; represented a
                residual risk that could be engineered out. Major tower manufacturers now offer
                AGR-compatible frames as standard in their product ranges, and the method is
                increasingly specified on construction sites across the UK.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  not need separate certification for AGR use.
                </p>
              </div>

              <p>
                The development of the AGR method represents a broader trend in the construction
                industry toward engineering out risk rather than relying solely on procedural
                controls. By building the guardrail protection into the frame itself, the AGR system
                removes the human factor from the most critical safety step &mdash; ensuring
                guardrails are in place before the operative is exposed to a fall hazard.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                AGR frames are mechanically more complex than standard end frames. Each AGR frame
                incorporates guardrail sections that are hinged at the top of the frame. In their
                folded (transport) position, the guardrail sections lie flat against the frame,
                making the unit compact for storage and handling.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    a standard end frame, allowing normal handling and transport.
                  </p>
                  <p>
                    <strong className="text-white">Deployment:</strong> From the level below, the
                    operative pushes the guardrail sections upward using their hands. The guardrails
                    swing up through an arc until they reach their fully extended vertical position.
                  </p>
                  <p>
                    <strong className="text-white">Locking:</strong> At full extension, a locking
                    mechanism engages to hold the guardrail in position. The lock must click
                    positively &mdash; check that it has engaged before releasing the guardrail.
                    Some systems use spring-loaded locks, others require manual engagement.
                  </p>
                  <p>
                    <strong className="text-white">Result:</strong> The extended guardrail section
                    provides protection at the correct height (950mm to 1000mm above the next
                    platform level) before the operative climbs to that level.
                  </p>
                </div>
              </div>
              ...
              <p>
                Different manufacturers implement the AGR mechanism in different ways. Some use a
                gravity-assisted lock that engages automatically as the guardrail reaches full
                extension. Others use a spring-loaded catch that clicks into a receptor. Some
                systems require the operative to manually engage a pin or clip after the guardrail
                is raised. You must be familiar with the specific mechanism of the AGR frames you
                are using &mdash; consult the manufacturer's instruction manual.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  lifting techniques. For taller towers where AGR frames must be lifted to
                  significant heights, consider using a material hoist rather than hand-passing
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The AGR assembly follows the same base setup as the 3T method. The difference begins
                when AGR frames are fitted at the upper levels. The sequence ensures guardrail
                protection is always established before the operative ascends.
              </p>
              ...
              <div className="my-8 flex justify-center">
                ...
                >
                  ...
                  <text x="460" y="52" fill="#EAB308" fontSize="9" opacity="0.7">
                    lock
                  </text>
                  <text x="270" y="102" fill="currentColor" fontSize="9" opacity="0.6">
                    platform
                  </text>
                </svg>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Both the 3T and AGR methods are taught on the PASMA Towers for Users course and both
                are accepted as safe assembly methods when performed correctly. The key differences
                lie in the level of protection provided, speed of assembly, equipment requirements,
                and cost.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Takeaway:</strong> AGR is the safer and
                  faster method, but it requires specific compatible equipment that costs more and
                  is not universally available. The 3T method remains a fully valid, safe approach
                  that works with any standard tower system.
                </p>
              </div>

              <p>
                On larger projects where multiple towers are in use simultaneously, standardising on
                one method (either all 3T or all AGR) simplifies training, reduces the risk of
                errors, and streamlines component management. However, the decision should always be
                based on safety and equipment availability rather than administrative convenience.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  or negotiate an approved alternative. Check the site induction and construction
                  phase plan for tower assembly requirements specific to that project.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The choice between 3T and AGR depends on the equipment available, the frequency of
                tower use, the experience level of the team, and the site's safety requirements. In
                some cases, the decision is made for you &mdash; if AGR frames are not available,
                the 3T method is the only option.
              </p>
              ...
              <p>
                Regardless of which method is chosen, it must be documented in the method statement.
                The risk assessment should record why the chosen method is appropriate for the
                specific job and site conditions.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Transitioning Between Methods:</strong> Some
                  organisations start with 3T equipment and later invest in AGR frames. When
                  transitioning, ensure all operatives receive specific training on the new AGR
                  frames, including deployment, locking, release, and inspection. Do not assume that
                  3T competence transfers automatically to AGR operation &mdash; the mechanical
                  elements require separate familiarisation.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  standard frames and attempt to continue with 3T unless the method statement is
                  revised and the team is briefed on the change of procedure.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Dismantling an AGR tower follows the reverse sequence of assembly, with the same
                fundamental safety principle: the operative must always be protected by guardrails.
                Guardrails are only lowered after the operative has descended to the level below.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  ...
                  <p>
                    <strong className="text-white">2. Descend to the level below:</strong> Climb
                    down through the trapdoor or access point to the next level down. The guardrails
                    at the level you have just left remain in place.
                  </p>
                  <p>
                    <strong className="text-white">3. Lower the guardrails from below:</strong> From
                    the safety of the lower level, release the AGR locking mechanisms on the level
                    above. The guardrail sections swing down and fold against the frame.
                  </p>
                  <p>
                    <strong className="text-white">4. Remove the platform:</strong> Take out the
                    platform board from the level above.
                  </p>
                  <p>
                    <strong className="text-white">5. Remove braces and frames:</strong> Dismantle
                    the horizontal and diagonal braces, then remove the AGR end frames.
                  </p>
                  <p>
                    <strong className="text-white">6. Repeat downward:</strong> Continue the
                    sequence for each lift until only the base remains.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  platform creates an immediate, unprotected fall hazard.
                </p>
              </div>

              <p>
                The dismantling process also requires the same level of planning, competence, and
                supervision as assembly. Fatigue is a factor &mdash; if the team has been working
                all day and the tower is being dismantled at the end of the shift, concentration may
                be lower. Schedule dismantling for a time when the team is alert, and never rush the
                process. Components should be lowered carefully and stacked for transport, not
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Confirm all materials and tools have been removed from the platform before
                      dismantling begins
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Inspect components for damage during dismantling &mdash; report any defects
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Maintain the exclusion zone until all components are at ground level
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                AGR frames have moving parts that standard frames do not. This means they require
                additional inspection and maintenance to ensure the guardrail deployment and locking
                mechanisms work reliably every time. A failed AGR mechanism is worse than having no
                AGR at all, because it creates a false sense of security.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Hinges:</strong> Check for free movement, no
                      binding, no excessive wear or play. The guardrail should swing smoothly from
                      folded to deployed position.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Locking mechanisms:</strong> Confirm positive
                      engagement at full extension. The lock must hold firmly without requiring
                      force to maintain position. Test by pushing and pulling the deployed
                      guardrail.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Springs:</strong> Where spring-loaded locks are
                      used, check that the spring returns the lock to the engaged position. Weak or
                      broken springs may allow the lock to fail under load.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Guardrail straightness:</strong> Inspect each
                      guardrail section for bends, dents, or deformation that could affect its
                      strength or its ability to fold and deploy correctly.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Release mechanisms:</strong> Confirm that the
                      release mechanism (for dismantling) operates smoothly and that the guardrail
                      folds down cleanly when released.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Manufacturer&rsquo;s Guidance:</strong>{' '}
                  Always follow the manufacturer's specific maintenance instructions for AGR frames.
                  Different manufacturers use different mechanisms, and the inspection and
                  lubrication requirements vary. Keep the manufacturer's instruction manual
                  available on site.
                </p>
              </div>
              ...
              <p>
                ...
                as defective. Do not leave faulty AGR frames mixed with serviceable stock &mdash;
                there is a risk that another team will pick them up and use them unknowingly. Report
                defective frames to the equipment manager or hire company for repair or replacement.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  (impact, adverse weather, or being dropped). The inspection must be carried out by
                  a competent person and the results recorded.
                </p>
              </div>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">AGR Frame Identification:</strong> AGR frames
                  should be clearly marked or labelled to distinguish them from standard end frames.
                  When storing mixed inventories, keep AGR frames separate and clearly identified to
                  prevent confusion during deployment. Using a standard frame where an AGR frame was
                  expected disrupts the assembly method and may leave operatives unprotected.
                </p>
              </div>
            </div>
          </div>
