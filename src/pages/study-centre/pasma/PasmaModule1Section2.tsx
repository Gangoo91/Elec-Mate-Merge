...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question:
      'What is the minimum platform loading capacity for a Class 3 tower under EN 1004:2020?',
    options: ['100 kg/m²', '150 kg/m²', '200 kg/m²', '250 kg/m²'],
    correctIndex: 2,
    explanation:
      'EN 1004:2020 defines Class 3 towers as having a minimum uniformly distributed load capacity of 200 kg/m². Class 2 towers have a capacity of 150 kg/m².',
  },
  {
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'EN 1004:2020 defines Class 2 towers as having a minimum uniformly distributed load capacity of 150 kg/m². Class 3 towers have a higher capacity of 200 kg/m².',
  },
  {
    id: 3,
    question:
      'What is the maximum indoor platform height for a mobile tower under EN 1004:2020 without additional measures?',
    options: ['6 metres', '8 metres', '10 metres', '12 metres'],
    correctAnswer: 3,
    explanation:
      'EN 1004:2020 sets the maximum indoor platform height at 12 metres without additional measures. For outdoor use, the maximum is 8 metres.',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'BS 1139-6 is the British Standard for metal scaffolding Part 6, specifically covering mobile access and working towers made of prefabricated elements.',
  },
  {
    id: 7,
    ...
    correctAnswer: 1,
    explanation:
      "Wind loading is a critical factor. Even if a tower is rated to 8 m outdoors under EN 1004:2020, the actual maximum safe height may need to be reduced if the site is exposed to high winds. The manufacturer's instructions will specify wind speed limits.",
  },
  {
    id: 8,
    question:
      'What should you do if you discover tower components from two different manufacturers have been mixed?',
    options: [
...
export default function PasmaModule1Section2() {
  useSEO({
    ...
    description:
      'EN 1004:2020 European standard for mobile access towers, load classes 2 and 3, maximum heights, BS 1139-6 British Standard scope, compliance marking and identification.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>EN 1004:2020:</strong> Two load classes &mdash; 150 kg/m&sup2; and 200
                kg/m&sup2;
              </li>
              <li>
                <strong>Max Heights:</strong> 8 m outdoor / 12 m indoor
              </li>
              <li>
                <strong>BS 1139-6:</strong> UK-specific requirements for mobile towers
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Check:</strong> Data plate for EN 1004:2020 and load class
              </li>
              <li>
                <strong>Verify:</strong> Components are from same manufacturer
              </li>
              <li>
                <strong>Confirm:</strong> Instruction manual is available on site
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                elements. It sets out design, structural, and safety requirements that manufacturers
                must meet when producing towers for use across Europe and the United Kingdom.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Definition:</strong> EN 1004:2020
                  replaced the previous EN 1004:2004 standard. The transition period ended in{' '}
                  <strong>November 2021</strong>, after which all newly manufactured towers must
                  comply with the 2020 edition. The standard is harmonised, meaning it applies
                  uniformly across all EU and UK markets.
                </p>
              </div>

              <p>
                The standard is mandatory for manufacturers, not directly for end users. However, as
                a tower user you must understand it because it determines the safe working
                parameters of the equipment you are using. Selecting a tower that does not comply
                with EN 1004:2020 could be a breach of your duty to select suitable work equipment
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Design and structural requirements for tower frames, platforms, and guardrails
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                One of the most important changes in EN 1004:2020 is the introduction of two defined
                load classes. Each class specifies the minimum uniformly distributed load (UDL) that
                the tower platform must be able to support. Choosing the correct class for your work
                is critical.
              </p>
                  ...
                  <tbody className="text-white/80">
                    ...
                    <tr className="border-b border-white/5">
                      ...
                      <td className="py-2 pr-4">
                        Light-duty tasks: inspection, painting, cable pulling
                      </td>
                      <td className="py-2">
                        Heavier work: bricklaying, M&amp;E installation, plastering
                      </td>
                    </tr>
                    <tr className="border-b border-white/5">
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Practical Load Calculation:</strong> A
                  standard platform of 1.3 m &times; 2.5 m = 3.25 m&sup2;. At Class 2 (150
                  kg/m&sup2;), the maximum total load is 487.5 kg. At Class 3 (200 kg/m&sup2;), it
                  rises to 650 kg. Remember this includes the weight of persons, tools, and
                  materials combined.
                </p>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  beyond its rated capacity is extremely dangerous and could cause structural
                  failure.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                EN 1004:2020 sets clear maximum platform heights for mobile towers. These heights
                represent the limits within which the tower has been tested and certified as stable
                under normal conditions. Exceeding them is not permitted without additional measures
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Wind speed:</strong> High winds significantly
                      increase overturning forces. Towers must not be used in wind speeds above
                      those specified by the manufacturer (typically around 17 m/s or Beaufort Force
                      7).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stabilisers/outriggers:</strong> Required at
                      certain heights to maintain the correct height-to-base ratio. Without them,
                      the maximum safe height is reduced.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Height-to-base ratio:</strong> EN 1004:2020
                      specifies maximum ratios (typically 3.5:1 outdoors and 3.5:1 indoors) that
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ground conditions:</strong> Soft or uneven
                      ground may require the height to be reduced or additional measures to be
                      taken.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Sheeting and enclosure:</strong> Attaching
                      sheeting or banners to a tower dramatically increases wind loading and may
                      reduce the safe maximum height.
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                BS 1139-6 is the British Standard for metal scaffolding, Part 6, covering mobile
                access and working towers made of prefabricated elements. While EN 1004:2020 is the
                harmonised European standard, BS 1139-6 provides additional UK-specific requirements
                and guidance.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Relationship to EN 1004:</strong> BS 1139-6
                  and EN 1004:2020 are complementary standards. EN 1004 sets the base European
                  requirements for design and manufacture, while BS 1139-6 adds UK-specific
                  provisions for inspection, use, and maintenance. Towers used in the UK should
                  ideally comply with both.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Inspection criteria:</strong> More detailed
                      guidance on what constitutes a competent inspection, including specific checks
                      for frame distortion, locking mechanisms, and castor condition.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Maintenance schedules:</strong> Recommended
                      maintenance frequencies and procedures for keeping towers in safe working
                      condition.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Storage requirements:</strong> How tower
                      components should be stored when not in use to prevent damage and corrosion.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Component marking:</strong> Additional marking
                      requirements for individual components to aid identification and matching.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                When selecting a mobile tower for use in the UK, you should look for compliance with
                both EN 1004:2020 and BS 1139-6. The manufacturer&rsquo;s documentation should
                reference both standards where applicable.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                EN 1004:2020 introduced strengthened marking requirements to make it easier for
                users and inspectors to verify compliance on site. Every tower must carry clear,
                durable markings that provide essential safety information at a glance.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Standard reference:</strong> "EN 1004:2020"
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Load class:</strong> Class 2 or Class 3 with
                      the corresponding UDL capacity
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Maximum platform height:</strong> The highest
                      permitted working platform height
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Manufacturer identification:</strong> Name,
                      logo, or trademark of the manufacturer
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Year of manufacture:</strong> When the tower or
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Model/type reference:</strong> The specific
                      tower model designation
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Instruction Manual:</strong> Every tower must
                  be supplied with an instruction manual that covers assembly sequences, safe use,
                  inspection procedures, maximum heights, load capacities, and dismantling. This
                  manual must be available on site whenever the tower is in use. Missing manuals are
                  a common compliance failure noted by HSE inspectors.
                </p>
              </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Before assembly:</strong> Confirm the tower
                      carries EN 1004:2020 markings and the correct load class for the planned work.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Component check:</strong> Verify all frames,
                      braces, platforms, and guardrails are from the same manufacturer and tower
                      system. Never mix components.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Manual available:</strong> Ensure the
                      manufacturer&rsquo;s instruction manual is on site and accessible to the
                      person assembling the tower.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Height check:</strong> Confirm the planned
                      platform height does not exceed the rated maximum for the environment
                      (indoor/outdoor).
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  tower until it has been confirmed as compliant. This is not optional &mdash; using
                  a non-compliant tower puts you and others at risk and breaches the Work at Height
                  Regulations.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Do not attempt to repair components yourself unless trained to do so
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  guaranteed. Mixed towers have not been tested as a system and may fail under load.
                  Always use components from a single manufacturer and a single tower system.
                </p>
              </div>
            </div>
          </div>
