...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'The operative opens the trapdoor and passes through to waist height. At this point, the platform provides protection and the operative can safely fit guardrails on all sides before stepping fully onto the platform.',
  },
  {
    id: 5,
  ...
  },
  {
    id: 8,
    question:
      'What should you do if you discover a missing diagonal brace during the completion check?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      "Every brace specified by the manufacturer is a structural element. A missing brace compromises the tower's rigidity and stability. The tower must not be used until the correct replacement brace has been obtained and fitted.",
  },
];
...
export default function PasmaModule3Section2() {
  useSEO({
    ...
    description:
      'Step-by-step 3T tower assembly method — base setup, building up through trapdoor platforms, guardrail installation, completion checks, and common errors to avoid.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Method:</strong> Build from inside, climb through trapdoors
              </li>
              <li>
                <strong>Guardrails:</strong> Fitted from waist-height through the trap
              </li>
              <li>
                <strong>Works with:</strong> All standard towers with trapdoor platforms
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Base first:</strong> Castors, frames, braces, level, lock
              </li>
              <li>
                <strong>Build up:</strong> Frames &rarr; braces &rarr; platform &rarr; through trap
                &rarr; guardrails
              </li>
              <li>
                <strong>Finish:</strong> Check all braces, locks, guardrails, castors
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                PASMA assembly method for mobile scaffold towers. The operative works from inside
                the tower at all times, climbing through trapdoor openings in each platform to
                access the next level and install guardrails before stepping fully onto any
                unguarded surface.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Principle:</strong> At no point during 3T
                  assembly should an operative be standing on an unguarded platform. The trapdoor
                  provides protection to waist height while guardrails are being fitted. This is the
                  safest method when Advance Guard Rail (AGR) frames are not available.
                </p>
              </div>

              <p>
                The 3T method is compatible with all standard mobile scaffold towers from any
                manufacturer, provided the platforms include trapdoor openings. It is the method
                taught on every PASMA Towers for Users course and is the most widely used assembly
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  ground level and maintains the exclusion zone. For taller towers or heavier
                  components, additional team members may be needed for safe manual handling.
                </p>
              </div>

              <p>
                The 3T method has been used safely for decades and remains the most widely practised
                assembly technique across the UK. Its effectiveness depends entirely on the
                competence of the operatives and strict adherence to the correct sequence. Shortcuts
                are where accidents happen.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The base is the foundation of the entire tower. Every measurement, every level
                check, and every lock at this stage affects the safety of the tower at its full
                height. Take your time here &mdash; correcting a base error after multiple lifts
                have been built is extremely difficult.
              </p>

              <p>
                Before starting the base assembly, lay out all base components in the order they
                will be used: castors or base plates first, then end frames, then braces. Having
                everything to hand prevents delays and reduces the risk of assembling components in
                the wrong order. The ground operative should prepare components while the assembly
                lead positions the castors.
              </p>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Once the base is complete and checked, the tower is built upward one lift at a time.
                Each lift follows the same sequence: fit the next end frames, add braces, install
                the platform, climb through the trapdoor, and fit guardrails. This repeating cycle
                continues until the tower reaches the required height.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  <p>
                    ...
                    home and locking clips engage.
                  </p>
                  <p>
                    <strong className="text-white">2. Add horizontal and diagonal braces:</strong>{' '}
                    Fit horizontal braces between the new end frames, then install diagonal braces.
                    All brace hooks and locks must be fully engaged.
                  </p>
                  <p>
                    <strong className="text-white">3. Install platform with trapdoor:</strong> Slide
                    the platform into position at the new level. Ensure it sits correctly on the
                    frame ledgers and the platform locks engage. The trapdoor should be in the
                    closed position.
                  </p>
                  <p>
                    <strong className="text-white">4. Climb through the trapdoor:</strong> Open the
                    trapdoor from below, climb through until your waist is at platform level. At
                    this point, the platform provides protection on all sides to waist height.
                  </p>
                  <p>
                    <strong className="text-white">5. Install guardrails:</strong> From the
                    waist-height position inside the trapdoor, fit guardrails on all open sides. Do
                    not step fully onto the platform until all guardrails are in place.
                  </p>
                  <p>
                    <strong className="text-white">6. Step onto platform:</strong> Once all
                    guardrails are secure, step fully onto the platform. Close and lock the trapdoor
                    behind you.
                  </p>
                </div>
              </div>
              ...
              <div className="my-8 flex justify-center">
                ...
                >
                  ...
                  <text x="205" y="195" fill="currentColor" fontSize="10" opacity="0.5">
                    trap open
                  </text>
                  ...
                  <line
                    ...
                    strokeDasharray="8 4"
                  />
                  <text x="330" y="124" fill="#EAB308" fontSize="10" fontWeight="600">
                    guardrail
                  </text>
                  ...
                  {/* Labels */}
                  <text x="15" y="365" fill="currentColor" fontSize="10" opacity="0.6">
                    Level 1
                  </text>
                  <text x="15" y="245" fill="currentColor" fontSize="10" opacity="0.6">
                    Level 2
                  </text>
                  <text x="15" y="192" fill="currentColor" fontSize="10" opacity="0.6">
                    Level 3
                  </text>
                  <text x="160" y="498" fill="currentColor" fontSize="10" opacity="0.5">
                    firm, level ground
                  </text>
                </svg>
              </div>
              ...
              <p>
                This sequence repeats for every lift. The critical safety principle is that the
                operative is always protected: either by the platform edge (when passing through the
                trapdoor to waist height) or by the guardrails (once fitted). At no point should an
                operative stand on an unguarded platform.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  heavier items, use a gin wheel or material hoist attached to the tower frame.
                  Carry nothing in your hands while climbing &mdash; use a tool belt or material
                  line.
                </p>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Three Points of Contact:</strong> While
                  climbing inside the tower between levels, always maintain three points of contact
                  with the structure &mdash; two hands and one foot, or two feet and one hand. This
                  means both hands must be free during climbing. Tools, components, and materials
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <p>
                Guardrail installation is the most safety-critical part of each lift cycle. The
                sequence must be followed precisely to ensure the operative is never exposed to an
                unguarded edge.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-elec-yellow mb-3">
                  Guardrail Installation Sequence
                </p>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <span className="flex items-center justify-center w-7 h-7 rounded-full bg-elec-yellow/20 text-elec-yellow text-xs font-bold flex-shrink-0">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Main guardrail:</strong> Must be between 950mm
                      and 1000mm above the platform surface
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Intermediate guardrail:</strong> Fitted midway
                      between the main guardrail and the toe board to prevent falls between the
                      rails
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Toe board:</strong> At platform level, minimum
                      150mm high, to prevent tools and materials falling from the platform edge
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                Some tower systems use end frames that incorporate guardrail protection on the
                narrow ends of the tower. In this case, separate guardrails only need to be
                installed on the long sides (the open sides not protected by end frames). However,
                you must verify this for your specific tower system &mdash; not all end frames
                provide adequate edge protection at the correct height.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Guardrail Integrity:</strong> Guardrails are
                  structural safety elements, not handholds. They must be capable of withstanding a
                  person falling against them. Check that each guardrail hook or clip is fully
                  engaged and that the rail sits securely without wobbling. A guardrail that
                  detaches under load defeats its entire purpose.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  protection throughout the dismantling process, just as during assembly.
                </p>
              </div>

              <p>
                Never remove a guardrail to create more working space on the platform. If the
                platform feels too small for the task, the tower configuration is wrong for the job.
                Use a wider platform or reposition the tower rather than compromising the edge
                protection that prevents falls.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The trapdoor is a critical safety feature of the 3T method. It provides the access
                route between levels while also forming part of the working platform when closed.
                Correct operation of the trapdoor is essential for both the safety of the person
                climbing and the structural integrity of the platform.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Opening:</strong> Open the trapdoor from below,
                      pushing it upward. It should rest securely in the open position without risk
                      of falling closed on the person below.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Climbing through:</strong> Use the internal
                      ladder or climbing rungs. Maintain three points of contact. Do not carry tools
                      or materials while climbing &mdash; use a tool belt or haul line.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Closing:</strong> After stepping onto the
                      platform and fitting guardrails, close the trapdoor. It must lock into the
                      closed position to form a continuous platform surface.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Locking:</strong> Engage the trapdoor locking
                      mechanism. A closed but unlocked trapdoor could open unexpectedly if someone
                      steps on it.
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Never</strong> leave a trapdoor open unattended &mdash; it is a fall
                      hazard for anyone on the platform
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Never</strong> step on a trapdoor without confirming it is closed and
                      locked
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Never</strong> exceed the platform's load capacity &mdash; the
                      trapdoor section may have a lower capacity than the main platform
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Always</strong> check the trapdoor mechanism during pre-assembly
                      inspection
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong>Always</strong> report any trapdoor that does not open, close, or lock
                      correctly
                    </span>
                  </li>
                </ul>
              ...
              <p>
                When stepping on a closed trapdoor, distribute your weight across the full surface.
                Do not stand on the edge of the trapdoor or the hinge line. Place materials and
                tools away from the trapdoor area to keep it clear for access and egress.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  keep the trapdoor area clear of obstructions. Ensure every team member knows the
                  emergency descent procedure before work begins.
                </p>
              </div>

              <p>
                On multi-platform towers with intermediate levels, ensure each trapdoor at every
                level is closed and locked when not in use. A person descending in an emergency
                should not encounter an unexpected open trapdoor on any level. During regular work,
                only one trapdoor should be open at a time &mdash; the one being used for access.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                After the tower has been fully assembled, a comprehensive completion inspection must
                be carried out before anyone uses the tower for work. This inspection should be
                documented as required by Schedule 5 of the Work at Height Regulations.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">All braces fitted:</strong> Horizontal,
                      diagonal, and plan braces at every level as specified by the manufacturer
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">All locks engaged:</strong> Every brace hook,
                      frame lock, and spigot clip must be fully engaged &mdash; check each one
                      individually
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Guardrails on all sides:</strong> Main
                      guardrail, intermediate guardrail, and toe boards on every open side at the
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Correct guardrail heights:</strong> Main
                      guardrail between 950mm and 1000mm above platform surface
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Platform level:</strong> Check with a spirit
                      level &mdash; the platform should be level in both directions
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Castors locked:</strong> All four castors must
                      have both wheel brakes and swivel locks fully engaged
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stabilisers fitted:</strong> If the tower
                      height requires stabilisers or outriggers, confirm they are correctly
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Trapdoors closed and locked:</strong> All
                      trapdoors at every level must be closed and locked
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  use. Check that the tower is plumb using a plumb line or long spirit level against
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Understanding common errors is just as important as knowing the correct procedure.
                These errors are seen regularly on sites and each one creates a serious risk of
                tower failure or a fall from height.
              </p>
              ...
              <div className="space-y-4">
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    can lose over 50% of its lateral rigidity.
                  </p>
                </div>
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    provided by the tower structure itself.
                  </p>
                </div>
                ...
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white">
                    ...
                    stabilisers creates an overturning hazard.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">How to Avoid These Errors:</strong> Follow
                  the manufacturer's instruction manual exactly. Use the assembly sequence chart
                  provided. Check each component is locked before moving to the next. Have a second
                  person carry out an independent check of each completed lift. If anything does not
                  feel right or look right, stop and investigate before proceeding.
                </p>
              </div>
            </div>
          </div>
