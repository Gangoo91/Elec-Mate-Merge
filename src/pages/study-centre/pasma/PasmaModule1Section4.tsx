...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 2,
    explanation:
      'CDM 2015 defines five duty holder roles: the client, the principal designer, the principal contractor, designers, and contractors. Each has specific duties that cannot be delegated to another role.',
  },
  {
    id: 'pasma-cdm-cpp',
...
const quizQuestions = [
  {
    ...
    correctAnswer: 2,
    explanation:
      'The Construction (Design and Management) Regulations 2015 (CDM 2015) came into force on 6 April 2015, replacing the CDM 2007 Regulations.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Where a project involves more than one contractor, the client must appoint a principal designer and a principal contractor. These roles carry specific duties for co-ordinating health and safety across the project.',
  },
  {
    id: 4,
    question: 'Who is responsible for providing pre-construction information?',
    options: ['The principal contractor', 'The designer', 'The client', 'The tower manufacturer'],
    correctAnswer: 2,
    explanation:
      'The client must provide pre-construction information to every designer and contractor appointed to the project. This includes information about existing structures, hazards, services, and any site-specific constraints.',
  },
  {
    id: 5,
  ...
  },
  {
    id: 6,
    question:
      'A contractor is installing a fire alarm system and using a mobile tower for access. Under CDM 2015, this contractor must:',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'Every contractor under CDM 2015 must plan, manage, and monitor the work under their control to ensure it is carried out without risks to health and safety. This applies regardless of project duration.',
  },
  {
    id: 7,
...
export default function PasmaModule1Section4() {
  useSEO({
    ...
    description:
      'Construction (Design and Management) Regulations 2015, the five CDM duty holders, construction phase plan, pre-construction information, worker engagement, and practical scenarios for tower work.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>CDM 2015:</strong> Applies to all construction projects in GB
              </li>
              <li>
                <strong>5 Duty Holders:</strong> Client, PD, PC, Designer, Contractor
              </li>
              <li>
                <strong>CPP:</strong> Required before construction phase begins
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Know:</strong> Your duty holder role and responsibilities
              </li>
              <li>
                <strong>Follow:</strong> Construction phase plan and site rules
              </li>
              <li>
                <strong>Report:</strong> Any hazards or concerns immediately
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                on 6 April 2015 and apply to all construction projects in Great Britain. They
                replaced the CDM 2007 Regulations and simplified the duty holder structure while
                extending duties to all projects, regardless of size.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Principle:</strong> CDM 2015 aims to
                  ensure that health and safety is considered throughout the life of a construction
                  project &mdash; from initial design through to completion and beyond. The
                  Regulations require that all parties involved in a project co-operate and
                  co-ordinate their work to manage risks effectively.
                </p>
              </div>
              ...
              <p>
                ...
                tradesperson carrying out a minor repair to major infrastructure developments. The
                duties scale with the size and complexity of the project, but no project is exempt.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                CDM 2015 defines five duty holder roles. Each role carries specific legal duties
                that cannot be transferred to another party. On smaller projects, one person or
                organisation may fulfil multiple roles, but the duties for each role still apply.
              </p>
              ...
              <div className="space-y-3">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    principal designer and principal contractor where there is more than one
                    contractor.
                  </p>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    instruction. Must not start work unless welfare facilities are available.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Mobile tower work on a construction project triggers CDM duties for everyone
                involved. Understanding when tower use constitutes "construction work" and what
                duties apply is essential for compliance.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">
                    When Does Tower Use Become Construction Work?
                  </strong>{' '}
                  Under CDM 2015, "construction work" has a broad definition that includes building,
                  alteration, fitting-out, commissioning, renovation, repair, maintenance,
                  decoration, and demolition. If you are using a mobile tower to carry out any of
                  these activities, CDM applies.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Planning:</strong> Tower work must be planned
                      as part of the overall project, not treated as an afterthought. The
                      construction phase plan should address tower selection, assembly, use, and
                      dismantling.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Competence:</strong> All persons assembling,
                      inspecting, or working from towers must be demonstrably competent. PASMA
                      training is the recognised route for tower operatives.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Co-ordination:</strong> If multiple contractors
                      are on site, tower work must be co-ordinated with other activities to prevent
                      clashes (e.g. towers blocking emergency routes, crane operations conflicting
                      with tower positions).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Information:</strong> The client must provide
                      relevant pre-construction information, such as floor loading limits, overhead
                      service locations, and restricted areas.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  project must be notified to the HSE, not whether CDM applies.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The construction phase plan (CPP) is a key CDM document that sets out how health and
                safety risks will be managed during the construction phase. It must be prepared
                before construction work begins and must be proportionate to the scale and
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Project description:</strong> What work is
                      being done, where, and over what time frame
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Management arrangements:</strong> Who is
                      responsible for what, lines of communication, co-ordination procedures
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Specific risk arrangements:</strong> How
                      identified risks will be managed, including work at height and tower use
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Welfare provisions:</strong> Location and
                      adequacy of toilets, washing facilities, rest areas, drinking water
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Emergency procedures:</strong> First aid, fire,
                      rescue from height, evacuation routes
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Site rules:</strong> Access restrictions, PPE
                      requirements, permit-to-work procedures
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Tower-Specific CPP Elements:</strong> The
                  plan should specifically address how mobile towers will be selected, who will
                  assemble and dismantle them, how inspections will be carried out and recorded,
                  maximum heights for the site, any ground condition restrictions, overhead hazard
                  exclusion zones, and the rescue plan for a person injured on the tower platform.
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The client has a duty under CDM 2015 to provide pre-construction information (PCI)
                to every designer and contractor appointed to the project. This information allows
                those planning the work to understand existing risks and constraints before work
                begins.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Existing services:</strong> Location of
                      electrical cables, gas pipes, water mains, and other services that could be
                      affected by tower positioning
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Structural information:</strong> Floor loading
                      capacities, fragile surfaces, asbestos-containing materials, structural
                      condition
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Access arrangements:</strong> How the site can
                      be accessed, any restrictions on vehicle movements, loading/unloading areas
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Environmental hazards:</strong> Contaminated
                      ground, unstable areas, confined spaces, proximity to railways or highways
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">
                        Previous health and safety information:
                      </strong>{' '}
                      Records from previous construction work, known hazards, accident history
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Relevance to Tower Work:</strong>{' '}
                  Pre-construction information is critical for tower work planning. Floor loading
                  limits determine whether a tower can be used safely indoors. Overhead service
                  locations identify where towers must not be positioned. Access restrictions affect
                  how tower components will be transported to the work area. Without this
                  information, you cannot carry out an adequate risk assessment.
                </p>
              </div>

              <p>
                If the client fails to provide adequate pre-construction information, contractors
                should request it in writing. Do not proceed with tower work if you lack critical
                information about the site conditions &mdash; this is a foreseeable risk that must
                be managed.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                CDM 2015 places significant emphasis on worker engagement and competence. The
                Regulations require that workers are consulted, competent, and properly supervised
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Before work starts:</strong> Workers must be
                      consulted on matters affecting their health and safety, including the methods
                      of work and equipment to be used
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Site induction:</strong> All workers must
                      receive a site-specific induction covering site rules, emergency procedures,
                      welfare facilities, and specific hazards
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ongoing engagement:</strong> Workers must be
                      encouraged to report hazards, near misses, and suggestions for improvement
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    for the tasks they carry out. For tower work, this means:
                  </p>
                  <ul className="space-y-1 ml-4">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Valid PASMA Towers for Users card for those assembling/dismantling
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Manufacturer-specific familiarisation for the tower system being used
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  newly qualified PASMA operative working on a complex tower configuration needs
                  closer supervision than an experienced operative carrying out a straightforward
                  assembly. The contractor must determine and provide the appropriate level.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="text-white space-y-4 leading-relaxed">
                ...
                <div className="bg-white/5 border border-white/10 p-3 rounded mt-2">
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Client:</strong> Building owner must provide
                        PCI (ceiling heights, services, floor loading)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">PC:</strong> Co-ordinates tower work with
                        other trades, includes in CPP
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Contractor:</strong> Plans tower use, ensures
                        operatives hold PASMA cards, provides supervision
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Worker:</strong> Assembles tower per
                        manufacturer&rsquo;s instructions, carries out pre-use inspection
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-3 rounded mt-2">
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Client:</strong> Still has CDM duties &mdash;
                        must provide relevant information about the building
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">No PC/PD needed:</strong> Single contractor
                        takes on contractor duties directly
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Contractor:</strong> Prepares CPP (can be
                        simple for a small project), manages tower work safely
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Key consideration:</strong> Occupied building
                        means managing risks to non-construction workers (HSWA Section 3)
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-3 rounded mt-2">
                  <ul className="text-sm text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Client:</strong> FM company must appoint PC
                        and PD (multiple contractors)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">PC:</strong> Co-ordinates all contractors,
                        ensures tower work does not conflict with other activities
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Contractor:</strong> Selects appropriate
                        tower for warehouse (check floor loading, racking clearance)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Key consideration:</strong> Warehouse may
                        have forklift traffic requiring exclusion zones around the tower
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  paperwork &mdash; it is a framework for ensuring that every person on a
                  construction project understands their role, the risks, and the controls in place.
                  For tower work, this means proper planning, competent personnel, clear
                  co-ordination, and documented procedures every time.
                </p>
              </div>
            </div>
          </div>
