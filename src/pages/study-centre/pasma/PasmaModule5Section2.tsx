...
const faqs = [
  {
    question:
      'Does the 7-day inspection interval start from the date of erection or the first day of use?',
    answer:
...
const quizQuestions = [
  {
    id: 1,
    question:
      'Under which piece of legislation is the formal 7-day inspection requirement for mobile towers found?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'Schedule 5 of the Work at Height Regulations 2005 specifically sets out the inspection requirements for scaffolding, including mobile scaffold towers.',
  },
  {
    id: 2,
    question:
      "Which of the following best describes a 'competent person' for the purpose of formal tower inspection?",
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'A competent person must have sufficient training, knowledge, experience, and practical ability to identify defects and assess tower safety. No specific qualification is mandated by law, though industry guidance recommends PASMA training as a minimum.',
  },
  {
    id: 3,
    question:
  ...
  },
  {
    id: 5,
    question:
      'How long must formal inspection records be retained after the work at that location is completed?',
    options: ['1 month', '3 months', '6 months', '12 months'],
    correctAnswer: 1,
    explanation:
      'Schedule 5 requires that inspection records be kept on site until the work is completed, then retained for a minimum of 3 months after completion.',
  },
  {
    id: 6,
    question:
...
export default function PasmaModule5Section2() {
  useSEO({
    ...
    description:
      'WAHR Schedule 5 formal inspection requirements for mobile scaffold towers: legal basis, competent person, inspection triggers, retention, enforcement, and best practice.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Law:</strong> WAHR 2005 Schedule 5 &mdash; criminal offence to breach
              </li>
              <li>
                <strong>Interval:</strong> Every 7 days, plus before first use and after events
              </li>
              <li>
                <strong>Records:</strong> On site during work, retained 3 months after
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Before:</strong> Confirm competent person is available and scheduled
              </li>
              <li>
                <strong>During:</strong> Systematic check of every component, record findings
              </li>
              <li>
                <strong>After:</strong> Sign, date, and store record on site; schedule next
                inspection
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Work at Height Regulations 2005 (WAHR), Schedule 5, mandates formal inspections
                for all scaffolding used in the workplace, and this expressly includes mobile
                scaffold towers. The definition of &ldquo;scaffold&rdquo; within the Regulations is
                broad: it covers any temporarily provided structure from which persons work at
                height or which is used as a means of access to or egress from a place of work at
                height.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Point:</strong> Non-compliance with
                  Schedule 5 is a criminal offence. It is not simply a matter of best practice or
                  industry guidance &mdash; failure to carry out formal inspections, failure to
                  record them, or failure to retain records can all result in prosecution, unlimited
                  fines, and in the most serious cases, imprisonment.
                </p>
              </div>

              <p>
                Schedule 5 sits alongside Regulation 12, which requires that all scaffolding
                (including towers) must not be used unless it has been inspected by a competent
                person. The two provisions work together: Regulation 12 imposes the duty to inspect,
                and Schedule 5 specifies the details of when, how, and what must be recorded.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">&ldquo;Scaffold&rdquo;:</strong> Any
                      temporarily provided structure on or from which persons perform work at
                      height, or which is used as a means of access/egress &mdash; includes mobile
                      towers, fixed scaffolding, and system scaffolding
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">&ldquo;Inspection&rdquo;:</strong> A visual
                      and, where necessary, physical examination by a competent person to identify
                      any defect or condition that could give rise to risk
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">&ldquo;Competent person&rdquo;:</strong> A
                      person with sufficient training, knowledge, experience, and practical ability
                      to carry out the inspection and identify relevant defects
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                The Regulations apply to all workplaces, not only construction sites. If a mobile
                tower is used in a warehouse, factory, school, hospital, or any other premises,
                Schedule 5 applies in full. There is no exemption based on the type of premises or
                the industry sector.
              </p>
            </div>
          </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                &ldquo;competent person.&rdquo; The Regulations do not prescribe a specific
                qualification or certificate &mdash; instead, they define competence in terms of
                four attributes that the person must possess.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  environments, a higher level of competence &mdash; such as PASMA Advance or
                  manufacturer-specific training &mdash; may be appropriate. The employer must
                  assess the level of competence required based on the complexity of the tower and
                  the risks involved.
                </p>
              </div>

              <p>
                It is the employer&rsquo;s responsibility to ensure that the person they appoint to
                carry out formal inspections is genuinely competent. Simply nominating someone is
                not sufficient &mdash; the employer must be able to demonstrate, if challenged, that
                the appointed person meets all four competence criteria for the specific type of
                tower being inspected.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                examination of every component of the tower, following the manufacturer&rsquo;s
                inspection protocol and covering all structural and safety-critical elements. The
                inspector must physically check each item, not simply give the tower a glance from
                ground level.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Structural integrity:</strong> All frames,
                      uprights, and transoms checked for straightness, damage, cracking, and
                      corrosion. Each component examined individually
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Bracing:</strong> All horizontal and diagonal
                      braces confirmed present, correctly positioned, and fully locked. No missing
                      or substituted braces
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Connections:</strong> Spigot joints, locking
                      pins, gravity locks, and spring clips all checked for full engagement and
                      correct operation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Platform:</strong> Fully decked, trapdoor
                      operational, locking hooks engaged, no damage to deck surface or supporting
                      members
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Guardrails &amp; toeboards:</strong> Full edge
                      protection on all sides at correct heights (950mm guardrail, 150mm toeboard
                      minimum), mid-rails present where required
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Castors:</strong> Brakes functional and
                      engaged, wheels in good condition, swivel mechanisms operating correctly
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stabilisers:</strong> Where fitted, correctly
                      positioned, fully extended, and making proper ground contact
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ground conditions:</strong> Base surface firm,
                      level, and adequate to support the total applied load
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Point:</strong> The formal inspection
                  must follow the manufacturer&rsquo;s inspection protocol for the specific make and
                  model of tower. Different manufacturers use different locking mechanisms, bracing
                  configurations, and component designs. A generic checklist may miss
                  manufacturer-specific items. The manufacturer&rsquo;s instruction manual must be
                  available to the inspector.
                </p>
              </div>

              <p>
                The difference between a pre-use check and a formal inspection is one of depth and
                rigour. The pre-use check is a quick visual scan to catch obvious defects. The
                formal inspection is a methodical, component-by-component examination that may
                involve climbing the tower, physically testing locking mechanisms, and applying
                force to check stability. Both are necessary &mdash; they are complementary, not
                interchangeable.
              </p>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The 7-day interval is the <strong>maximum</strong> period between formal
                inspections, but it is not the only trigger. Schedule 5 requires formal inspection
                at several other points, and these are frequently overlooked on site. Understanding
                all inspection triggers is essential for compliance.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-elec-yellow mb-3">
                  All Formal Inspection Triggers
                </p>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  overnight storms where no one was present to witness the conditions. If in doubt,
                  inspect. It takes far less time than dealing with the consequences of an accident
                  or an HSE enforcement action.
                </p>
              </div>

              <p>
                A useful way to manage inspection triggers is to keep a simple log attached to the
                tower or held in the site office. Record every event that could trigger an
                inspection: relocations, alterations, weather events, near misses, and any
                interference with the tower. This log creates a clear audit trail and makes it easy
                to demonstrate that you responded to each trigger with an appropriate inspection.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  formal inspections were required: before first use (Monday), after relocation
                  (Wednesday), and after the storm event (Saturday or first thing Monday before
                  use). The 7-day inspection on Monday is also due, but the post-storm inspection
                  covers it. If any of these inspections were missed, the duty holder is in breach
                  of Schedule 5.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Schedule 5 imposes specific requirements on how long inspection records must be kept
                and where they must be available. These requirements exist so that the HSE and other
                enforcing authorities can verify compliance at any time, and so that in the event of
                an incident, there is a clear audit trail.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <span className="flex items-center justify-center w-7 h-7 rounded-full bg-cyan-500/20 text-cyan-400 text-xs font-bold flex-shrink-0">
                      1
                    </span>
                    <div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Point:</strong> Electronic records are
                  acceptable under the Regulations, provided they can be produced in a readable
                  format when requested. Digital inspection systems such as PASMA&rsquo;s TowerSure
                  app produce time-stamped, cloud-stored records that meet the legal requirements
                  and are often easier to retrieve than paper records.
                </p>
              </div>

              <p>
                Many organisations choose to retain records for longer than the 3-month minimum,
                particularly on larger projects or where the work involves higher-risk activities.
                Retaining records for the duration of the project plus 6 to 12 months is considered
                good practice. In the event of a civil claim for personal injury, records may be
                relevant for years after the work was completed.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Health and Safety Executive takes work at height non-compliance extremely
                seriously. Falls from height remain the number one cause of workplace fatalities in
                the United Kingdom, and the HSE has extensive enforcement powers to address breaches
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Sentencing guidelines consider turnover and culpability</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Publicity orders (public naming of the offender)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Loss of approved contractor status</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Both corporate and individual liability can apply</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  (2024/25 rate). This is in addition to any fine or enforcement action and applies
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The legal minimum is just that &mdash; a minimum. Organisations that take tower
                safety seriously will implement additional measures that go beyond Schedule 5
                requirements. These measures not only reduce risk but also demonstrate a positive
                safety culture and provide stronger protection in the event of an incident or
                enforcement action.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Daily documented checks:</strong> Record every
                      pre-use check in writing, not just formal 7-day inspections. Creates a
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Photographic records:</strong> Take
                      date-stamped photographs at each inspection showing the tower&rsquo;s
                      condition, location, and surroundings
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Competent person register:</strong> Maintain a
                      register of all persons authorised to carry out formal inspections, including
                      their qualifications, training dates, and competence assessments
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Inspection scheduling system:</strong> Use a
                      calendar or digital system to schedule inspections in advance and alert when
                      they are due, preventing missed deadlines
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Management review:</strong> Periodically review
                      inspection findings at management level to identify trends, recurring defects,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Digital inspection tools:</strong> Use apps
                      such as PASMA TowerSure for time-stamped, cloud-backed inspection records that
                      cannot be backdated
                    </span>
                  </li>
                </ul>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Better audit trail for client and HSE inspection</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Earlier identification of recurring defects</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Improved safety culture across the workforce</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Defects may go undetected for up to a week</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Weaker legal position if questioned</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Reactive rather than proactive safety approach</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Point:</strong> In the event of a
                  prosecution, the court will consider whether the duty holder did everything
                  &ldquo;reasonably practicable&rdquo; to prevent harm. Demonstrating that you went
                  beyond the minimum &mdash; with daily checks, photographic records, and a robust
                  inspection system &mdash; significantly strengthens your defence and shows the
                  court that safety was a genuine priority, not an afterthought.
                </p>
              </div>
            </div>
          </div>
