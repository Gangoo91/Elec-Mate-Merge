...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation:
      'TILE stands for Task (what does the activity involve?), Individual (who is doing it — are they fit and trained?), Load (how heavy, how awkward, can it be gripped?), and Environment (ground conditions, space, temperature, lighting). This structured assessment helps identify manual handling risks before they cause injury.',
  },
];
...
export default function PasmaModule6Section4() {
  useSEO({
    ...
    description:
      'PASMA fitness requirements, medical conditions affecting work at height, 3-point contact rule, TILE manual handling assessment, adverse weather procedures, PPE standards, and safe working habits.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Fitness:</strong> Self-assessment + employer assessment before height work
              </li>
              <li>
                <strong>Climbing:</strong> 3-point contact always, never carry items in hands
              </li>
              <li>
                <strong>Weather:</strong> Cease work at Force 4 (17 mph), dismantle at Force 6
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>PPE:</strong> EN 397 helmet, EN ISO 20345 boots, gloves, hi-vis if needed
              </li>
              <li>
                <strong>Handling:</strong> TILE assessment, team lifts for heavy components
              </li>
              <li>
                <strong>Culture:</strong> Challenge unsafe practice, report near-misses, lead by
                example
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Working at height on a mobile tower is physically demanding. Operatives must climb
                repeatedly, carry and position heavy components, maintain balance on an elevated
                platform, concentrate for extended periods, and be capable of self-rescue if
                conditions deteriorate. Both the employer and the individual have responsibilities
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Climbing:</strong> Repeated ascent and descent
                      of the internal ladder, potentially dozens of times during assembly
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Carrying:</strong> Moving tower components from
                      storage to the assembly area, often over uneven ground or up stairs
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Positioning:</strong> Lifting and manoeuvring
                      frames, braces, and platforms into place, often overhead or at arm&rsquo;s
                      length
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Balance:</strong> Working on a platform at
                      height, maintaining stability in wind, and moving carefully in a confined
                      space
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Concentration:</strong> Following the assembly
                      sequence precisely, monitoring conditions, communicating with the team
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Emergency response:</strong> Ability to descend
                      quickly in an emergency or assist with a colleague&rsquo;s rescue
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    also consider the demands of the specific task — a 2-metre tower in a warm
                    indoor environment places different demands than a 12-metre tower on an exposed
                    rooftop in winter.
                  </p>
                </div>
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    dizziness? Do you feel physically capable of the demands? If the honest answer
                    to any of these is no, you should not work at height that day.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  recovery from exertion, and the increased likelihood of medical conditions
                  requiring medication &mdash; must be factored into the assessment. Experience is
                  valuable, but it does not compensate for physical limitations. An honest
                  conversation between the operative and their employer, supported by medical
                  assessment where needed, ensures the right people are doing the right tasks.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Certain medical conditions can affect a person&rsquo;s ability to work safely at
                height. Having a condition does not necessarily mean a complete ban from tower work,
                but it does require proper assessment and, in most cases, medical guidance. The key
                question is: could this condition cause sudden incapacitation, impaired balance, or
                reduced awareness while at height?
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <p>
                    ...
                    at height. Fear of heights may cause panic, freezing, or irrational behaviour.
                    Both require honest self-assessment and may need medical input.
                  </p>
                  <p>
                    <strong className="text-white">Epilepsy:</strong> Seizures at height can be
                    fatal. The risk depends on seizure frequency, control by medication, and any
                    warning signs (aura). Medical clearance from a specialist is essential.
                  </p>
                  <p>
                    <strong className="text-white">Heart conditions:</strong> Conditions causing
                    sudden dizziness, fainting, chest pain, or breathlessness could incapacitate a
                    person at height. Strenuous climbing and manual handling increase cardiovascular
                    demand.
                  </p>
                  <p>
                    <strong className="text-white">Balance disorders:</strong> Inner ear conditions,
                    Meniere&rsquo;s disease, and neurological conditions affecting balance present
                    obvious risks at height.
                  </p>
                  <p>
                    <strong className="text-white">Recent surgery:</strong> Post-operative
                    restrictions on lifting, climbing, and physical exertion must be respected.
                    Return to height work should follow medical advice.
                  </p>
                  <p>
                    <strong className="text-white">Medication side effects:</strong> Many common
                    medications cause drowsiness, dizziness, blurred vision, or impaired reaction
                    times. Always check the patient information leaflet and consult a pharmacist or
                    GP if unsure.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  residual effects from the previous evening can impair performance. If you would
                  not drive a car in your current state, you should not climb a tower.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  physical coordination. The construction industry has historically been poor at
                  acknowledging mental health, but it is increasingly recognised as a genuine
                  occupational health factor. If you are struggling, speak to your GP, your
                  employer&rsquo;s occupational health service, or a confidential support line.
                  Working at height when your mind is not on the job puts both you and your
                  colleagues at risk.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  assessed and, if appropriate, adjustments can be made. Many conditions are
                  manageable with the right controls. Concealing a condition and having an incident
                  at height is far worse than an honest conversation with your supervisor or
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  require honest self-assessment on the day. If a temporary condition means you
                  cannot climb safely, maintain concentration, or respond to an emergency, you
                  should not work at height that day. There is no shame in this &mdash; recognising
                  your own limitations is a professional strength, not a weakness. Inform your
                  supervisor so that the work can be reassigned rather than left undone.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  confidential between the operative and the occupational health professional, who
                  provides a &ldquo;fit/unfit/fit with restrictions&rdquo; outcome to the employer
                  without disclosing specific medical details. This protects both the
                  operative&rsquo;s privacy and the employer&rsquo;s duty of care.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The 3-point contact rule is one of the most fundamental safety principles for
                climbing any ladder or tower. It is simple, absolute, and non-negotiable: at all
                times while climbing, you must maintain three points of contact with the ladder —
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Always face the ladder:</strong> Climb with
                      your body facing the rungs, never with your back to the ladder
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Three points at all times:</strong> Two hands +
                      one foot, or two feet + one hand. Move only one limb at a time
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Never carry items:</strong> Both hands must be
                      free. Tools, materials, drinks, and phones go up by hoisting line, not in your
                      hands or pockets
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Climb one rung at a time:</strong> Do not skip
                      rungs, even when descending. Each foot placement should be deliberate and
                      confirmed before moving the next limb
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Grip the rungs, not the stiles:</strong>{' '}
                      Gripping the rungs gives a more secure hold than gripping the side rails
                      (stiles), especially with wet or greasy hands
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Use the internal ladder only:</strong> Never
                      climb the outside of the tower. The internal ladder provides protection on all
                      sides and allows you to rest safely at each platform level
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  the rope. When hoisting, stand clear of the load path, and ensure no one is below.
                  Lower items under control; never throw anything from the platform.
                </p>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  and attempting to hold a torch while descending in poor light. Every one of these
                  can be solved by using a hoisting line, tool belt, or leaving the item on the
                  platform. If it does not fit in your hand while maintaining three points of
                  contact, it does not go up the ladder with you.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Manual handling injuries — particularly back injuries — are among the most common
                causes of lost working days in the construction industry. Tower components are heavy
                (frames typically 10&ndash;20 kg each) and awkward to carry. The TILE assessment
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <p>
                    ...
                    twisting, stooping, or reaching involved? Can the task be redesigned to reduce
                    the risk?
                  </p>
                  <p>
                    <strong className="text-white">I — Individual:</strong> Who is doing the
                    lifting? Are they physically fit? Do they have any medical conditions affecting
                    their ability to lift? Have they been trained in correct technique? Are they
                    fatigued from previous activity?
                  </p>
                  <p>
                    <strong className="text-white">L — Load:</strong> How heavy is it? Is it bulky,
                    awkward, or difficult to grip? Is the weight evenly distributed? Could it shift
                    during carrying? Can it be broken down into smaller components?
                  </p>
                  <p>
                    <strong className="text-white">E — Environment:</strong> Is the ground even and
                    dry? Is there sufficient space to adopt a good posture? Is the lighting
                    adequate? Is it hot (causing sweat and reduced grip) or cold (reducing
                    dexterity)? Are there obstacles in the carry route?
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  can move components between floors. For rooftop work, a crane or hoist may be
                  needed to lift the components to the working level. The cost of a mechanical aid
                  is far less than the cost of a back injury that takes an operative off work for
                  months. Discuss mechanical aid options during the planning stage, not after
                  someone has already hurt themselves carrying components up four flights of stairs.
                </p>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  deteriorates as tiredness builds. Rotate tasks between team members so that no one
                  person does all the heavy lifting. Take breaks between tower assemblies. If you
                  notice your technique slipping &mdash; hunching over, lifting with your back,
                  rushing connections &mdash; take a break and reset before continuing. The last
                  lift of the day should be as careful as the first.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Weather is one of the most variable and dangerous factors in tower work. Conditions
                can change rapidly, and what was a safe working environment an hour ago can become
                life-threatening. Knowing the thresholds and having the discipline to act on them is
                essential.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <p>
                    ...
                    Cease all work on the tower. This is a moderate breeze — dust and loose paper
                    are raised, small branches move. At platform height, where wind is stronger than
                    at ground level, this creates significant balance and component-handling risks.
                  </p>
                  <p>
                    <strong className="text-white">
                      Wind — Beaufort Force 6 (28 mph / 45 km/h):
                    </strong>{' '}
                    The tower must be dismantled to a safe height or tied to a permanent structure.
                    At this wind speed, large branches move and umbrellas are difficult to use. Wind
                    loads increase with the square of the wind speed — doubling the wind speed
                    quadruples the force.
                  </p>
                  <p>
                    <strong className="text-white">Rain:</strong> Wet platforms, ladder rungs, and
                    components become slippery. Reduced visibility and the psychological pressure to
                    &ldquo;finish quickly&rdquo; both increase accident risk. Consider whether the
                    work can be postponed. If proceeding, ensure anti-slip measures and extra
                    caution.
                  </p>
                  <p>
                    <strong className="text-white">Ice and frost:</strong> Do not use a mobile tower
                    when platforms or ladder rungs are icy. Ice creates an extreme slip hazard that
                    cannot be adequately controlled on a tower. Wait for conditions to improve or
                    apply de-icing measures before the tower is climbed.
                  </p>
                  <p>
                    <strong className="text-white">Lightning:</strong> Descend from the tower
                    immediately if lightning is observed or thunder is heard. A metal tower at
                    height is an excellent lightning conductor. Do not wait for the storm to be
                    directly overhead — lightning can strike from a storm cell 10 miles away.
                  </p>
                  <p>
                    <strong className="text-white">Extreme heat:</strong> Ensure adequate hydration,
                    rest breaks, and sun protection. Exposed metal platforms can reach temperatures
                    that cause contact burns in direct sunlight. Monitor operatives for signs of
                    heat stress.
                  </p>
                </div>
              </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Remember: wind at platform height is typically stronger than at ground level
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Weather apps provide wind speed updates but do not replace on-site
                        observation
                      </span>
                    </li>
                  </ul>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  A tower that is stable in moderate wind without sheeting can be blown over by the
                  same wind with sheeting attached. This also applies to large sheets of plywood,
                  plasterboard, or other flat materials stored on the platform.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Personal protective equipment is the last line of defence — it does not eliminate
                hazards but provides a final layer of protection when higher-level controls are in
                place. For tower work, specific PPE items are required at different stages, and all
                must comply with the relevant European/British standards.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <p>
                    ...
                    objects or contact with components. A chin strap should be fitted when looking
                    upward (during assembly) or in windy conditions. Must be replaced after any
                    significant impact or according to the manufacturer&rsquo;s lifespan guidance.
                  </p>
                  <p>
                    <strong className="text-white">Safety footwear — EN ISO 20345:</strong> Boots
                    with toe protection (at minimum S1P — toe cap + penetration-resistant midsole)
                    are required at all times. Ankle support is recommended for the climbing and
                    carrying demands of tower work. Non-slip soles are essential for wet platforms
                    and ladder rungs.
                  </p>
                  <p>
                    <strong className="text-white">Gloves:</strong> Suitable work gloves for
                    handling metal components. Must protect against sharp edges, pinch points, and
                    cold metal, while allowing sufficient dexterity to operate locks and pins.
                    Oversized or bulky gloves that reduce dexterity can be more dangerous than no
                    gloves at all.
                  </p>
                  <p>
                    <strong className="text-white">High-visibility clothing:</strong> Required when
                    working near vehicle routes, on public highways, or on sites with mobile plant.
                    Must comply with EN ISO 20471 and be appropriate for the lighting conditions.
                  </p>
                  <p>
                    <strong className="text-white">Fall-arrest harness:</strong> Not routinely
                    required for normal use of a fully assembled tower with guardrails. However, a
                    harness may be specified in the method statement for certain assembly stages
                    (e.g., installing guardrails at the leading edge) or for work on complex or
                    bespoke tower configurations.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  webbing, damaged stitching, and functional buckles. Defective PPE must be taken
                  out of service immediately — damaged PPE can give a false sense of security.
                </p>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  handling technique does. PPE mitigates the consequences when higher-level controls
                  fail. If your safety strategy starts with &ldquo;wear PPE,&rdquo; your hierarchy
                  of control is upside down.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Safety is not just about rules, regulations, and equipment. It is fundamentally
                about culture — the habits, attitudes, and behaviours that people adopt every day. A
                safe culture is one where doing things correctly is the norm, not the exception.
                Every operative contributes to this culture through their personal conduct.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Personal responsibility:</strong> You are
                      responsible for your own safety and the safety of those around you. Do not
                      wait for someone else to fix a problem — if you see a hazard, deal with it or
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Challenging unsafe practices:</strong> If you
                      see a colleague cutting corners, climbing the outside of the tower, or
                      skipping steps in the assembly sequence, say something. Do it respectfully but
                      firmly. Silence is complicity
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reporting near-misses:</strong> Every near-miss
                      is a future accident that almost happened. Reporting near-misses allows the
                      risk assessment to be updated and prevents the same situation from causing
                      actual harm next time
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Continuous learning:</strong> Stay up to date
                      with PASMA guidance, HSE publications, and industry best practice. Attend
                      refresher training. Learn from incidents — both your own and those of others
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  consistent practice, honest self-reflection, and a genuine commitment to getting
                  it right. When safe behaviour is habitual, it happens even when you are tired,
                  under pressure, or working without supervision. That is the standard to aim for.
                </p>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  ...
                  <p>
                    <strong className="text-white">2. Conscious incompetence:</strong> You recognise
                    what you do not know. You understand the risks but do not yet have the skills to
                    manage them. This is where learning begins.
                  </p>
                  <p>
                    <strong className="text-white">3. Conscious competence:</strong> You can do the
                    job safely, but it requires concentration and deliberate effort. Each step
                    requires active thought.
                  </p>
                  <p>
                    <strong className="text-white">4. Unconscious competence:</strong> Safe working
                    is automatic. You lock the castors without being reminded, check the guardrails
                    without a checklist, and maintain 3-point contact without thinking about it.
                    This is the goal.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  competence requires ongoing practice, staying up to date with changes in guidance
                  and regulations, learning from each tower you assemble, and being open to feedback
                  from colleagues. A PASMA card holder who has not assembled a tower for two years
                  is not as competent as one who works with towers daily. Refresher training,
                  continued professional development, and honest self-assessment keep your skills
                  sharp and your practice safe.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  to instruction manuals, and industry events and conferences. The work at height
                  industry evolves continuously &mdash; new equipment, updated regulations, lessons
                  learned from incidents, and improved techniques. Operatives who engage with
                  ongoing learning are safer, more efficient, and more valuable to their employers.
                </p>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  it, and the wider industry&rsquo;s reputation. Every tower you assemble correctly,
                  every hazard you identify and control, every near-miss you report, and every
                  unsafe practice you challenge contributes to a safer industry for everyone. That
                  is the professional standard, and it starts with you.
                </p>
              </div>
            </div>
          </div>
