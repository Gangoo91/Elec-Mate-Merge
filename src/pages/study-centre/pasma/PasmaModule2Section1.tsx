...
const quickCheckQuestions = [
  {
    ...
    question:
      'A client needs lighting installed along a 0.9m-wide corridor. Which tower width is appropriate?',
    options: [
    ...
    correctIndex: 1,
    explanation:
      'A single-width tower at 0.74m will fit within the 0.9m corridor with clearance either side. A double-width tower at 1.35m physically cannot fit. Always measure the available space before selecting a tower.',
  },
  {
    id: 'stairway-tower-use',
    question:
      'You need to install emergency lighting on a staircase ceiling where steps rise 3.5m between landings. What tower type should you use?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      "A stairway tower is specifically designed for use on stairs and slopes. Never pack under castors with timber or bricks — this is extremely dangerous. The stairway tower's adjustable legs allow it to sit level on the steps.",
  },
  {
    id: 'grp-selection',
    question:
...
const quizQuestions = [
  {
    ...
    options: ['0.50 metres', '0.74 metres', '1.00 metres', '1.35 metres'],
    correctAnswer: 1,
    explanation:
      'Single-width towers have a platform width of approximately 0.74m (740mm). This narrower footprint makes them suitable for confined spaces such as corridors, doorways, and between racking.',
  },
  {
    id: 2,
    question: 'What is the approximate platform width of a double-width tower?',
    options: ['0.74 metres', '1.00 metres', '1.35 metres', '1.80 metres'],
    correctAnswer: 2,
    explanation:
      'Double-width towers have a platform width of approximately 1.35m (1350mm). The wider platform provides greater stability, more working space, and allows higher build heights than single-width towers.',
  },
  {
    id: 3,
    question:
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Stairway towers provide internal staircase access, making it easier and safer to ascend and descend. This reduces fatigue, allows materials to be carried more easily, and is particularly beneficial for frequent access or when operatives have limited mobility.',
  },
  {
    id: 6,
  ...
  },
  {
    id: 8,
    question:
      'When selecting a tower type, which factor determines whether you need a GRP tower rather than aluminium?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'The proximity of live electrical equipment is the determining factor. If there is any risk of the tower contacting live conductors, a non-conductive GRP tower must be used. Aluminium conducts electricity and could create a fatal shock hazard.',
  },
];
...
const PasmaModule2Section1 = () => {
  useSEO({
    ...
    description:
      'Learn about tower classifications including standard, specialist, stairway, GRP, and folding towers. Understand when to use each type for safe working at height.',
  });
          ...
          <div className="rounded-lg p-4 bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-white text-base space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Standard towers:</strong> single-width (0.74m) or
                  double-width (1.35m)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Specialist:</strong> linked, bridge, high
                  clearance, stairway
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Material:</strong> aluminium (common) or GRP
                  (non-conductive)
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Folding/low-level:</strong> quick deploy, under
                  2.5m platform height
                </span>
              </li>
            </ul>
          </div>
          <div className="rounded-lg p-4 bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-white text-base space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Assess:</strong> task height, duration, location,
                  ground conditions
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Select:</strong> correct width, configuration, and
                  material
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Verify:</strong> tower rated for intended use and
                  load
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Document:</strong> record selection rationale in
                  method statement
                </span>
              </li>
            </ul>
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                it is a fundamental safety decision. Using the wrong tower type can lead to
                instability, restricted access, inefficient working, and in the worst cases,
                collapse or falls from height.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  prefabricated components and comply with BS EN 1004-1:2020. They must only be
                  erected, altered, or dismantled by trained and competent persons.
                </p>
              </div>

              <p>
                Tower classifications can be broadly divided by{' '}
                <strong className="text-white">width</strong> (single or double),
                <strong className="text-white"> configuration</strong> (standard, linked, bridge,
                stairway, high clearance),
                <strong className="text-white"> material</strong> (aluminium or GRP), and
                <strong className="text-white"> deployment type</strong> (modular or folding).
                Understanding these categories helps you make informed selections during planning
                and risk assessment.
              </p>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                across commercial and industrial buildings. Standard towers come in two width
                options: <strong className="text-white">single-width</strong> and
              ...
              <p>
                The choice between single-width and double-width should always be based on a
                practical assessment: measure the available space, consider the task requirements,
                count the number of operatives, and check the required platform height. If both
                widths would physically fit, the double-width tower is generally preferred for its
                greater stability and working area.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                work requirements. These specialist types must only be assembled following the
                manufacturer's specific instructions for that configuration.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  Cantilever sections must be factory-designed for the specific tower system and are
                  subject to strict load limitations. Counterweighting or tie-in may be required to
                  prevent overturning.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  bracing patterns, and load ratings that differ from a standard tower build.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                standard ladder-climb through end frames. The operative ascends and descends via a
                built-in stairway within the tower structure, making access significantly easier and
                safer — particularly for frequent trips up and down, or when carrying tools and
                materials.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  with intermediate platforms at each turn. Stairway towers have a larger footprint
                  than standard towers of the same platform height.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-red-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Easier access:</strong> Walking up stairs is
                      significantly less physically demanding than climbing vertical ladder rungs,
                      especially repeatedly over a working day.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Material carrying:</strong> Operatives can
                      carry tools and lightweight materials up the stairs using both hands for
                      balance, rather than needing one hand free for ladder climbing.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Reduced fatigue:</strong> Less physical effort
                      per ascent/descent means reduced fatigue over the working day — lowering the
                      risk of accidents caused by tiredness.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Accessibility:</strong> Stairway access may be
                      specified in the risk assessment where operatives have mobility limitations or
                      where the task requires frequent platform access.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white text-sm space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The risk assessment identifies frequent ascent/descent (more than a few times
                      per hour)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Operatives need to carry tools or materials to the platform regularly
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The tower will be in use for extended periods (full-day or multi-day tasks)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Operative fitness or mobility constraints make ladder climbing impractical
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      The platform height exceeds 6m (some organisations mandate stairway access
                      above this height)
                    </span>
                  </li>
                </ul>
              ...
              <p>
                The trade-off with stairway towers is their larger base footprint. The internal
                staircase sections increase the overall width and length of the tower compared to a
                standard ladder-access tower of the same platform height. Ensure you have sufficient
                ground space before specifying a stairway tower.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                <strong className="text-white">GRP (Glass Reinforced Plastic)</strong>. The choice
                between them is primarily driven by the presence or absence of electrical hazards in
                ...
                <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Lightweight:</strong> Easy to transport and
                        handle
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Strong:</strong> High strength-to-weight
                        ratio
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Corrosion resistant:</strong> Natural oxide
                        layer
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Most common:</strong> ~90% of towers in use
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Conductive:</strong> Conducts electricity
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Cost:</strong> Less expensive than GRP
                      </span>
                    </li>
                  </ul>
                </div>
                <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                  ...
                  <ul className="text-white space-y-2 text-sm">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Non-conductive:</strong> Does not conduct
                        electricity
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Heavier:</strong> 30–50% heavier than
                        aluminium
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">UV sensitive:</strong> Store under cover when
                        not in use
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Specialist use:</strong> Near live electrical
                        equipment
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Maintenance:</strong> Must be kept clean and
                        dry
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        <strong className="text-white">Cost:</strong> More expensive than aluminium
                      </span>
                    </li>
                  </ul>
                </div>
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                stable working platform for tasks at modest heights — typically up to 2.5m platform
                height.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-white text-sm">
                  ...
                  short-duration tasks at low heights. Unlike a mobile access tower, a podium step
                  has a fixed height and cannot be extended. Podium steps comply with BS 8620:2022.
                </p>
              </div>

              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                <h3 className="text-elec-yellow font-medium mb-2">
                  Podium Steps vs Towers — When to Use Each
                </h3>
                <div className="grid sm:grid-cols-2 gap-3 text-sm">
                  <div>
              ...
              <p>
                Folding and low-level towers are subject to the same Work at Height Regulations 2005
                as full-height towers. Even at modest heights, falls can cause serious injury.
                Always ensure guardrails, toeboards, and stable bases are in place, and follow the
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white">
              <p>
                ...
                systematic approach ensures you arrive on site with the right equipment every time.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  ...
                  <p className="text-white font-medium mt-3">
                    Step 2: Check for electrical hazards
                  </p>
                  ...
                  <p className="text-white font-medium mt-3">
                    Step 3: Assess the ground conditions
                  </p>
                  <p className="pl-4">
                    &#8594; Level, firm ground? Standard tower with castors or base plates
                  </p>
                  <p className="pl-4">
                    &#8594; Steps or slope? Stairwell tower with adjustable legs
                  </p>
                  ...
                  <p className="pl-4">
                    &#8594; Over 1.5m wide? Double-width preferred for stability
                  </p>

                  <p className="text-white font-medium mt-3">
                    Step 5: Consider access requirements
                  </p>
                  <p className="pl-4">&#8594; Frequent trips, heavy tools? Stairway tower</p>
                  <p className="pl-4">
                    &#8594; Span over obstruction? Bridge or high clearance tower
                  </p>
