...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 1,
    explanation:
      'The Work at Height Regulations 2005 (WAHR) require that rescue procedures are planned and in place BEFORE any work at height begins — regardless of the height involved. You cannot rely on making it up as you go or assuming the emergency services will arrive in time. The plan must be specific to the work activity and location.',
  },
  {
    id: 'rescue-suspension-trauma-time',
    question:
      'How quickly can suspension trauma (orthostatic intolerance) cause circulatory failure in a person suspended in a harness?',
    options: ['2-4 hours', '30-60 minutes', '5-15 minutes', 'It cannot cause circulatory failure'],
    correctIndex: 2,
    explanation:
      'Suspension trauma can cause circulatory failure in as little as 5-15 minutes. When a person is suspended motionless in a harness, blood pools in the legs due to the harness compressing the femoral veins. This reduces the volume of blood returning to the heart, leading to unconsciousness and potentially death. This is why rapid rescue is absolutely critical.',
  },
  {
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      'Emergency service response times are variable and can be 15-30+ minutes depending on location and demand. For a casualty suffering suspension trauma, this delay can be fatal — circulatory failure can occur in as little as 5-15 minutes. On-site assisted rescue capability is essential to bridge this gap.',
  },
  {
    id: 3,
...
export default function PasmaModule6Section3() {
  useSEO({
    ...
    description:
      'Rescue plan requirements under WAHR, PASMA rescue hierarchy, suspension trauma, communication during emergencies, first aid at height, and rescue drill training for mobile tower work.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Legal duty:</strong> Rescue plan required BEFORE work at height begins
              </li>
              <li>
                <strong>Suspension trauma:</strong> Can kill in 5&ndash;15 minutes &mdash; rapid
                rescue essential
              </li>
              <li>
                <strong>3 levels:</strong> Self-rescue &rarr; assisted rescue &rarr; professional
                rescue
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Plan:</strong> Written rescue plan, team roles, equipment identified
              </li>
              <li>
                <strong>Communicate:</strong> Everyone knows how to raise the alarm
              </li>
              <li>
                <strong>Practise:</strong> Drill regularly &mdash; a plan on paper is not enough
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Work at Height Regulations 2005 (WAHR) are unambiguous: rescue procedures must
                be planned and in place <strong>before</strong> any work at height begins. This is
                not guidance or best practice &mdash; it is a legal requirement. Regulation 4(1)
                specifically states that every employer must plan work at height, including the
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    rural or remote areas, it may take 30 minutes or longer. For a fire service
                    rescue involving specialist equipment, the wait may be longer still.
                  </p>
                  <p>
                    For a casualty suffering suspension trauma, even 8 minutes may be too long. For
                    someone with a serious bleed, every minute counts. A rescue plan that consists
                    solely of &ldquo;call 999&rdquo; is not a plan &mdash; it is an abdication of
                    responsibility.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  services can find and access the location. Every minute saved in the early stages
                  of an emergency significantly improves the casualty&rsquo;s chance of survival.
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                PASMA teaches a three-level rescue hierarchy. The plan must address all three
                levels, because you cannot predict what state the casualty will be in or what
                resources will be available at the moment an emergency occurs. Always plan for the
                worst case.
              </p>
              ...
              <div className="space-y-3">
                <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    all times, ensure trapdoors are functional, and do not block the descent path
                    with tools or materials. Self-rescue applies when the operative recognises a
                    developing problem (feeling unwell, weather deteriorating) and descends before
                ...
                <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    casualty, lowering the casualty using a rescue system, or helping the casualty
                    descend with physical support. All team members must be trained in the assisted
                    rescue procedure before work begins.
                  </p>
                </div>

                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-red-500/30 text-red-300 text-sm font-bold flex-shrink-0">
                      3
                    </span>
                  ...
                  <p className="text-sm text-white/80">
                    ...
                    monitor the casualty, maintain communication, and ensure clear access for the
                    response vehicles. The rescue plan must include the site address, grid
                    reference, access instructions, and any restrictions (low bridges, narrow lanes,
                    security gates).
                  </p>
                </div>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The rescue plan must be written, site-specific, and available to everyone involved
                in the work. A rescue plan that exists only in someone&rsquo;s memory is not a
                rescue plan. The document should be concise enough to be read quickly but
                comprehensive enough to cover all foreseeable emergency scenarios.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  ...
                  <p>
                    <strong className="text-white">Rescue equipment:</strong> What equipment is
                    available (first-aid kit, stretcher, rescue harness, lowering device), where it
                    is stored, and who is trained to use it.
                  </p>
                  <p>
                    <strong className="text-white">Communication methods:</strong> How to raise the
                    alarm from the platform — mobile phone (with confirmed signal), two-way radio,
                    whistle, verbal call. Emergency contact numbers.
                  </p>
                  <p>
                    <strong className="text-white">Access for emergency services:</strong> Site
                    address with postcode, grid reference or what3words location, access route
                    instructions, gate codes or security arrangements, any restrictions on vehicle
                    size.
                  </p>
                  <p>
                    <strong className="text-white">Nearest A&amp;E:</strong> Name and address of the
                    nearest accident and emergency department, with estimated travel time.
                  </p>
                  <p>
                    <strong className="text-white">First-aid provision:</strong> Location of the
                    nearest first-aid kit, identity of trained first aiders on site, and any
                    specialist first-aid equipment (AED, burns kit, trauma dressings).
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  information &mdash; emergency numbers, A&amp;E location, access routes &mdash;
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  stretcher access? On a remote rural site, can an air ambulance land nearby and is
                  there mobile phone signal? In an occupied building, how will the building&rsquo;s
                  occupants be managed during the emergency? Each of these scenarios requires
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  intervals are all methods of ensuring a lone worker&rsquo;s condition is
                  monitored. In many cases, the risk assessment may conclude that lone working on a
                  tower is not acceptable because an adequate rescue cannot be guaranteed.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  tower (not stored centrally where it may take minutes to retrieve), and that
                  communication between tower locations is reliable. A single rescue plan that
                  assumes only one tower is in use at a time is inadequate for a multi-tower site.
                  Each tower should have its own brief rescue addendum covering location-specific
                  details.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  available for rescue team members. The access route for emergency services must be
                  illuminated and clearly marked. Identifying a casualty&rsquo;s condition is harder
                  in poor light, and descent takes longer when visibility is limited.
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Suspension trauma &mdash; also known as orthostatic intolerance or harness hang
                syndrome &mdash; is one of the most critical dangers in work at height rescue. It is
                poorly understood by many in the construction industry, yet it can kill a healthy
                person in minutes. Every person involved in tower work must understand this hazard.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    heart. With progressively less blood available to circulate, the heart&rsquo;s
                    output drops, blood pressure falls, and vital organs &mdash; including the brain
                    &mdash; are starved of oxygen.
                  </p>
                  <p>
                    This cascade can proceed from initial discomfort to unconsciousness in as little
                    as 5 minutes, and to death in 15 minutes or less. The speed depends on the
                    individual&rsquo;s health, the harness fit, ambient temperature, and whether the
                    person is able to move their legs.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Early:</strong> Tingling in the legs, numbness,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Developing:</strong> Nausea, sweating, grey or
                      pale skin, increasing anxiety
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Advanced:</strong> Confusion, inability to
                      respond to instructions, vision disturbance
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Critical:</strong> Loss of consciousness,
                      irregular heart rhythm, cardiac arrest
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  casualty in a sitting position or a W-position with knees raised. Monitor closely
                  and seek immediate medical attention, even if the person appears to recover.
                  Internal damage may not be immediately apparent.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  in the harness and activate their leg muscles, and training operatives to keep
                  moving their legs if suspended &mdash; even small movements help pump blood back
                  towards the heart. However, none of these measures replace the need for rapid
                  rescue; they only buy additional time.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  of oxygen-deprived muscle tissue (rhabdomyolysis) may not become apparent for
                  hours. Inform the hospital that the casualty was suspended in a harness and for
                  how long, so that appropriate blood tests and monitoring can be carried out.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                In an emergency, clear and rapid communication is the difference between a timely
                rescue and a delayed one. The communication plan must be established before work
                begins, tested to confirm it works at the specific location, and understood by every
                member of the team.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    the phone (999, site office, first aider, supervisor). Keep the phone charged
                    and accessible, not in a bag at the bottom of the tower.
                  </p>
                  <p>
                    <strong className="text-white">Two-way radios:</strong> Essential where mobile
                    phone signal is unreliable. Test range and clarity before work begins. Ensure
                    batteries are charged. Agree an emergency channel or call sign.
                  </p>
                  <p>
                    <strong className="text-white">Buddy system:</strong> Always work with at least
                    one other person within visual or audible range. The buddy remains at ground
                    level and can raise the alarm, call for help, and coordinate the initial
                    response.
                  </p>
                  <p>
                    <strong className="text-white">Signal words and whistles:</strong> Agree
                    standard emergency signals &mdash; for example, three blasts on a whistle means
                    &ldquo;emergency, help needed.&rdquo; This works when verbal communication is
                    not possible due to distance, noise, or the casualty&rsquo;s condition.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">1. On-site rescue team:</strong> Alert
                      colleagues to begin assisted rescue immediately
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">2. Emergency services (999):</strong> Ambulance
                      as a minimum; fire service if specialist rescue is needed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">3. Site management:</strong> Notify the site
                      supervisor or principal contractor
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">4. Own employer:</strong> Report the incident
                      to your company&rsquo;s emergency contact
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  involved, any specific hazards at the scene (overhead power lines, chemicals,
                  confined spaces), the access route for emergency vehicles, and a contact phone
                  number for a person who will meet and guide the emergency crew. Have this
                  information pre-prepared in the rescue plan &mdash; in an emergency, clear
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  buddy. If any communication method is found to be unreliable, implement an
                  alternative before work begins. A communication failure during an emergency can
                  turn a survivable incident into a fatality.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Providing first aid to someone on a tower platform presents unique challenges. Space
                is limited, equipment access is restricted, and the height itself adds risk to both
                the casualty and the first aider. Deciding when to treat in situ versus when to
                lower the casualty to the ground is a critical judgement.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    person to lie down, let alone for a first aider to work alongside them.
                    Treatment options are limited by the confined space.
                  </p>
                  <p>
                    <strong className="text-white">Equipment access:</strong> The first-aid kit
                    should be accessible from the platform. If it is at ground level, someone must
                    climb up with it. Consider keeping a compact first-aid kit on the platform for
                    immediate response.
                  </p>
                  <p>
                    <strong className="text-white">AED access:</strong> If the casualty has suffered
                    a cardiac arrest, an automated external defibrillator (AED) must be brought to
                    the platform. AED location and access route should be identified in the rescue
                    plan.
                  </p>
                </div>
              </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        The casualty is unconscious and at risk of further injury on the platform
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  neutral position, and wait for paramedics with spinal immobilisation equipment.
                  Incorrect handling of a spinal injury can cause permanent paralysis.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  injured limb if possible. For catastrophic bleeding from limbs, a tourniquet may
                  be necessary if direct pressure cannot control the bleed. First aiders should be
                  trained in the use of haemostatic dressings and tourniquets where these are
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  the casualty is conscious, keep them talking &mdash; this helps you monitor their
                  level of consciousness and provides comfort during a frightening situation.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A rescue plan that has never been practised is a plan that will fail when it matters
                most. Under stress, people revert to their training &mdash; if there has been no
                training, there is nothing to revert to. Regular rescue drills are not optional
                extras; they are an essential part of a safe system of work at height.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white/80">
                  <p>
                    ...
                    changes, drill more frequently. New team members should participate in a drill
                    before beginning work at height.
                  </p>
                  <p>
                    <strong className="text-white">Simulated scenarios:</strong> Vary the scenario
                    each time — unconscious casualty, casualty with a leg injury, casualty suspended
                    off the platform, communication equipment failure. This tests the team&rsquo;s
                    ability to adapt, not just follow a memorised script.
                  </p>
                  <p>
                    <strong className="text-white">Timed exercises:</strong> Record how long the
                    rescue takes from alarm to casualty at ground level. Compare against the
                    suspension trauma timeline. If the rescue takes longer than 10 minutes, the plan
                    needs improvement.
                  </p>
                  <p>
                    <strong className="text-white">Debriefing:</strong> After every drill, hold a
                    structured debrief. What went well? What went badly? What needs to change?
                    Update the rescue plan based on the findings.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  the plan. These records demonstrate competence and due diligence if ever
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  psychological resilience. People who have practised a rescue scenario respond more
                  calmly, think more clearly, and act more decisively when the real thing happens.
                  This is why the military, emergency services, and aviation industry all practise
                  emergency procedures repeatedly &mdash; and why the construction industry should
                  do the same.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  height work. Employers have a duty to provide appropriate support, which may
                  include access to counselling, time off, gradual return to duties, and a
                  supportive debrief. Ignoring the psychological impact of a workplace emergency is
                  neither responsible nor effective. People need support to recover and return to
                  work safely.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  condition, and any amendments made to the plan following drills or incidents.
                  These records serve two purposes: they ensure the plan stays current and
                  effective, and they provide evidence of competence if the plan is ever tested by a
                  real emergency or examined by an enforcing authority. A well-documented rescue
                  programme demonstrates professional commitment to worker safety.
                </p>
              </div>
            </div>
          </div>
