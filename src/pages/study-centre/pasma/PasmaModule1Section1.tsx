...
const quickCheckQuestions = [
  {
    ...
    correctIndex: 0,
    explanation:
      'The Work at Height Regulations 2005 require you to avoid work at height wherever reasonably practicable before considering any other measure. This is the top priority in the three-step hierarchy.',
  },
  {
    id: 'pasma-hswa-section2',
    question:
      'Under HSWA 1974 Section 2, who has the primary duty to ensure workplace health and safety?',
    options: [
    ...
    correctIndex: 2,
    explanation:
      'Section 2 of the Health and Safety at Work etc. Act 1974 places the primary duty on the employer to ensure, so far as is reasonably practicable, the health, safety, and welfare at work of all employees.',
  },
  {
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'No. There is no minimum height threshold. The Regulations apply to all work at height where a person could fall a distance liable to cause personal injury, regardless of whether that is half a metre or ten metres. Even stepping onto a single platform board constitutes work at height.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Inspection records must be kept on site until the work is completed, and then retained for a minimum of 3 months after that. The HSE can request to see these records at any time, and failure to produce them when requested is a criminal offence.',
  },
];
...
const quizQuestions = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation:
      "Schedule 5 requires inspection after any event likely to have affected the tower's stability, such as severe weather, impact damage, or ground movement.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    correctAnswer: 2,
    explanation:
      'Section 8 of HSWA 1974 makes it an offence for any person to intentionally or recklessly interfere with or misuse anything provided in the interests of health, safety, or welfare.',
  },
  {
    id: 7,
    question:
      "What does 'reasonably practicable' mean in the context of the Work at Height Regulations?",
    options: [
...
export default function PasmaModule1Section1() {
  useSEO({
    ...
    description:
      'Work at Height Regulations 2005 hierarchy of control, HSWA 1974 Sections 2, 3, 7 and 8, Schedule 5 inspection requirements, employer and employee duties, HSE enforcement powers.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          ...
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Before:</strong> Plan work, assess risks, select equipment
              </li>
              <li>
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                &mdash; including parts of the Construction (Health, Safety and Welfare) Regulations
                1996 &mdash; and consolidated all work-at-height duties into a single, clear
                framework.
              </p>
              ...
              <p>
                ...
                work of others. This means principal contractors, facilities managers, and site
              ...
              <p>
                Importantly, the Regulations apply to all work at height where there is a risk of a
                fall liable to cause personal injury. This includes work from ladders, stepladders,
                scaffolding, mobile towers, roofs, fragile surfaces, and any other elevated
                position.
              </p>
            </div>
          </div>
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                regulations &mdash; including the Work at Height Regulations 2005 &mdash; are made.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-elec-yellow mb-3">
                  Key Sections for Tower Work
                </p>
                <div className="space-y-3">
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white">
                      ...
                      members of the public, visitors, and other contractors on site.
                    </p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-white">
              ...
              <p>
                HSWA 1974 applies to all workplaces, not just construction sites. Whether you are
                erecting a tower in a factory, warehouse, school, or office building, the
                Act&rsquo;s duties apply in full.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                at height is carried out safely. Failure by either party can lead to enforcement
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  properly inspected. Under Section 3 of HSWA 1974, you must also protect others who
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm text-white">
                  ...
                  <p>
                    ...
                    Any change to the tower configuration, such as adding or removing height,
                    requires a fresh inspection.
                  </p>
                  <p>
                    <strong className="text-white">3. After adverse events</strong> &mdash; Any
                    event likely to have affected stability or structural integrity (e.g. storm,
                    impact, subsidence) triggers an inspection.
                  </p>
                  <p>
              ...
              <p>
                ...
                retained for a minimum of <strong>3 months</strong> after that. The HSE can request
                to see these records at any time. Failure to produce records when requested is an
                offence.
              </p>
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                premises, examine work activities, and take enforcement action where breaches are
                found.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  of all fatal injuries. This is precisely why the HSE takes work at height
                  enforcement so seriously and why penalties can be severe.
                </p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Understanding the law is only useful if you can apply it on site. Here is a
                practical breakdown of what the legislation means for your day-to-day work with
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Reasonably Practicable in Practice:</strong>{' '}
                  ...
                  have to prove that it was reasonably practicable &mdash; you must prove that it
                  was not. Always document your decisions and the rationale behind them.
                </p>
              </div>
            </div>
          </div>
