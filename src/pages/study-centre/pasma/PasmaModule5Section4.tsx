...
const quizQuestions = [
  {
    ...
    correctAnswer: 1,
    explanation:
      "The TowerSure workflow begins with scanning the QR code attached to the tower. This links the inspection to the specific tower's record, ensuring traceability and preventing mix-ups between different towers on site.",
  },
  {
    id: 2,
    ...
    correctAnswer: 2,
    explanation:
      'TowerSure records are stored in the cloud with automatic backup. This means records are protected against device loss, damage, or theft, and can be accessed from any authorised device with an internet connection.',
  },
  {
    id: 3,
  ...
  },
  {
    id: 5,
    question:
      'What should you do if TowerSure is unavailable during an inspection (e.g. phone battery dead)?',
    options: [
    ...
    correctAnswer: 1,
    explanation:
      'If TowerSure or any digital tool is unavailable, you must still carry out the inspection and record it. A paper form that captures all Schedule 5 mandatory fields is perfectly acceptable. The inspection cannot be postponed because of a technology failure.',
  },
  {
    id: 6,
  ...
  },
  {
    id: 8,
    question:
      'Which emerging technology could provide real-time monitoring of tower conditions without a human inspector?',
    options: [
    ...
    correctAnswer: 2,
    explanation:
      'IoT sensors can be attached to tower components to monitor conditions such as tilt, vibration, wind loading, and component stress in real time. This technology is still emerging but has the potential to supplement human inspections with continuous automated monitoring.',
  },
];
...
export default function PasmaModule5Section4() {
  useSEO({
    ...
    description:
      'PASMA TowerSure digital inspection app: how it works, QR code workflow, benefits over paper, setup, sharing records, compliance, and the future of digital tower inspection.',
  });
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>What:</strong> PASMA&rsquo;s free digital inspection app (iOS &amp; Android)
              </li>
              <li>
                <strong>How:</strong> Scan QR &rarr; Answer checklist &rarr; Photo &rarr; Submit
                &rarr; Cloud
              </li>
              <li>
                <strong>Why:</strong> Time-stamped, searchable, shareable, tamper-resistant records
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-elec-yellow/5 border-l-2 border-elec-yellow/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Before:</strong> Register towers, attach QR labels, set up team access
              </li>
              <li>
                <strong>During:</strong> Scan, inspect, photograph, submit &mdash; all from your
                phone
              </li>
              <li>
                <strong>After:</strong> Share records instantly, review analytics, schedule next
                check
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                TowerSure is PASMA&rsquo;s official digital inspection application, developed to
                modernise and simplify the process of recording mobile scaffold tower inspections.
                It is available as a free download on both iOS (Apple App Store) and Android (Google
                Play Store) and is designed to replace traditional paper inspection forms with a
                faster, more reliable digital alternative.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Point:</strong> TowerSure was developed
                  by PASMA in response to industry feedback that paper inspection records were
                  inconsistent, often incomplete, and vulnerable to loss, damage, and backdating.
                  The app addresses all of these issues by providing a structured, time-stamped,
                  cloud-backed recording system.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Free to download</strong> &mdash; no
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cross-platform</strong> &mdash; works on iOS
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Offline capable</strong> &mdash; complete
                      inspections without connectivity, sync when back online
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Schedule 5 compliant</strong> &mdash; captures
                      all 7 mandatory record fields automatically
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Photo integration</strong> &mdash; attach
                      time-stamped photographs directly to each inspection record
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Cloud storage</strong> &mdash; records backed
                      up automatically, accessible from any authorised device
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <p>
                TowerSure is not the only digital inspection tool available, but it is the one
                developed and endorsed by PASMA &mdash; the trade body for the mobile access tower
                industry. Using TowerSure demonstrates alignment with industry best practice and
                PASMA&rsquo;s recommended standards.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The TowerSure workflow is designed to be simple and intuitive, even for operatives
                who are not particularly tech-savvy. The process follows five clear steps, each
                taking only a few moments to complete. The entire inspection can typically be
                recorded in under five minutes.
              </p>

              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm font-medium text-elec-yellow mb-3">
                  The 5-Step TowerSure Workflow
                </p>
              ...
              <p>
                Each QR code is unique to a specific tower. This means that over time, TowerSure
                builds a complete inspection history for every tower in your fleet &mdash; showing
                every inspection carried out, every defect found, every action taken, and the
                condition of the tower at each point in time. This historical data is invaluable for
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The following diagram illustrates the five-step TowerSure workflow from scanning the
                tower&rsquo;s QR code through to secure cloud storage. Each step takes only moments,
                and the entire process is completed on a single device.
              </p>
              ...
              <div className="my-8 flex justify-center">
                <svg
                  ...
                  role="img"
                  aria-label="TowerSure 5-step workflow: Scan QR, Answer Questions, Take Photo, Submit, Cloud Storage"
                >
                  {/* Step 1: Scan QR */}
                  <rect
                    x="2"
                  ...
                  />
                  <path
                    d="M542,89 a7,7 0 0 1 0,-8 a6,6 0 0 1 10,-3 a5,5 0 0 1 8,4 a5,5 0 0 1 -2,7 z"
                    fill="none"
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  it may take slightly longer. This is comparable to or faster than completing a
                  paper form, with the added benefit of automatic time-stamping, cloud backup, and
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Digital inspection through TowerSure offers significant advantages over traditional
                paper forms, but it is important to understand both the benefits and the limitations
                so you can make an informed decision about which system &mdash; or combination
                &mdash; works best for your operation.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Photo evidence built into every record</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Searchable &mdash; find any record in seconds</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Shareable instantly via email or export</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Backed up automatically to secure cloud</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Complete audit trail for each tower</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Analytics to identify defect trends</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Automated overdue inspection alerts</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Device battery must be charged</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Connectivity needed for sync (offline mode available)</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Operatives need basic app familiarity</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Device may be damaged on site</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>QR labels must be maintained on towers</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Initial setup time to register towers</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Dependence on PASMA maintaining the platform</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Point:</strong> The most significant
                  advantage of TowerSure is the automatic time-stamp. Paper records can be completed
                  at any time &mdash; there is nothing to prevent someone filling in a form at the
                  end of the week and backdating it. TowerSure records are stamped at the moment of
                  creation, making it virtually impossible to falsify the date and time of an
                  inspection. This is a powerful compliance tool.
                </p>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  and recorded. A competent person should never delay an inspection because of a
                  technology failure.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Setting up TowerSure for a new site or fleet of towers involves a few
                straightforward steps. The initial setup takes a small investment of time but pays
                dividends in efficiency and compliance throughout the life of the project.
              </p>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Point:</strong> QR code labels must be
                  attached in a location that is visible and accessible but protected from damage.
                  The inside of a frame member or the underside of the platform are common
                  positions. Use weatherproof, durable labels &mdash; a QR code that has faded or
                  been torn off is useless. Carry spare labels on site for replacements.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-elec-yellow/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                One of the most practical advantages of TowerSure is the ability to share inspection
                records instantly with anyone who needs them. This is particularly valuable during
                HSE visits, client audits, and when demonstrating compliance to principal
                contractors.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">On-screen display:</strong> Show the record
                      directly on your device during a site visit or audit. The structured format is
                      easy to read and presents professionally
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">PDF export:</strong> Generate a formal PDF
                      report of any inspection or series of inspections. Suitable for inclusion in
                      project files and handover documentation
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Email:</strong> Send records directly via email
                      to clients, principal contractors, HSE inspectors, or colleagues
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Construction management integration:</strong>{' '}
                      Some platforms allow direct integration with site management software, pulling
                      tower inspection data into the broader project compliance system
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Point:</strong> During an HSE visit,
                  being able to produce comprehensive, time-stamped inspection records within
                  seconds makes a powerful impression. It demonstrates that your organisation takes
                  compliance seriously and has invested in systems that go beyond the minimum.
                  Contrast this with rummaging through a filing cabinet for a crumpled paper form
                  &mdash; the difference in perception is significant.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  carried out consistently, defects have been addressed, and the 7-day interval has
                  been maintained. Analytics features can also show trends, such as the most common
                  defect types or the average time between inspections.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Digital inspection tools like TowerSure represent the current state of the art, but
                the technology is evolving rapidly. Several emerging technologies have the potential
                to transform how tower inspections are carried out, recorded, and monitored in the
                coming years.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">IoT sensors:</strong> Small wireless sensors
                      attached to tower components that continuously monitor tilt, vibration, wind
                      loading, and component stress. Data transmitted in real time to a central
                      dashboard, alerting supervisors to changes that require attention
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Automated alerts:</strong> Systems that
                      automatically notify the responsible person when a tower exceeds a pre-set
                      tilt angle, when wind speed approaches the working limit, or when a component
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">AI defect recognition:</strong> Artificial
                      intelligence trained on thousands of inspection photographs to automatically
                      identify defects such as corrosion, bending, cracking, and missing components
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Industry-wide databases:</strong> Shared
                      databases where tower inspection records from across the industry contribute
                      to a national picture of tower safety, enabling regulators to identify trends
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Digital PASMA cards:</strong> Linking TowerSure
                      inspection records to the inspector&rsquo;s PASMA digital card, automatically
                      verifying their competence and training currency at the point of inspection
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Real-time compliance dashboards:</strong>{' '}
                      Management dashboards showing the inspection status of every tower in the
                      fleet, with colour-coded indicators for compliance, upcoming, and overdue
                      inspections
                    </span>
                  </li>
                </ul>
              ...
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-green-500/10 border border-green-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Maintain your competence in both digital and paper methods</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Stay current with PASMA updates and new features</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        View technology as a complement to, not replacement for, human judgement
                      </span>
                    </li>
                  </ul>
                </div>
                <div className="bg-blue-500/10 border border-blue-500/30 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-white/80 space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Professional judgement is still required for every inspection</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Sensors can detect data but cannot make safety decisions</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>The legal duty remains with the duty holder, not the technology</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-elec-yellow/10 border border-elec-yellow/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-elec-yellow">Key Point:</strong> No matter how
                  sophisticated the technology becomes, the legal requirement for a competent person
                  to carry out inspections will remain. IoT sensors, AI, and automated systems will
                  augment human inspection &mdash; making it faster, more accurate, and more
                  consistent &mdash; but they will not remove the need for a trained, experienced
                  person to exercise professional judgement on whether a tower is safe to use.
                </p>
              </div>
            </div>
          </div>
