...
export default function GSModule6() {
  useSEO({
    title: 'Module 6: Mock Exam | Goal Setting & Continuous Growth',
    description:
      'Goal Setting & Continuous Growth mock examination — 20 random questions from a 200-question bank, 30-minute timer, 80% pass mark.',
  });
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <Link to="../goal-setting-growth">
                ...
                Back to Goal Setting &amp; Continuous Growth
              </Link>
            </Button>
          </div>
        </div>
