...
const examFeatures = [
  ...
  { icon: ShieldCheck, label: '80% pass mark (16/20)', description: 'Matches industry assessment standards for self-development training.' },
...
const preparationTips = [
  { title: 'Review all five modules', description: 'Questions are drawn equally from Mindset, Effective Goals, Habits, Tracking Progress, and Action Plan. Cover every module before attempting the exam.' },
  { title: 'Know the SMART framework', description: 'Specific, Measurable, Achievable, Relevant, Time-bound — be able to apply it to apprentice, qualified electrician and business owner scenarios.' },
  { title: 'Understand habit formation', description: 'The habit loop (cue, routine, reward), the 4 Laws of Behavior Change, habit stacking and the 20-second rule are heavily tested.' },
  { title: 'Remember the trade-specific frameworks', description: 'JIB pathway, ECS cards, IET registration, NICEIC/NAPIT assessments, BS 7671 amendments and CITB grants — know how each fits CPD planning.' },
  { title: 'Master mindset & motivation theory', description: "Carol Dweck's growth mindset, Locke & Latham goal setting, Angela Duckworth's grit, Pink's autonomy/mastery/purpose and the comfort-zone model." },
  ...
  return (
    <div className="min-h-screen bg-[hsl(0_0%_8%)] text-white">
      <div className="px-4 sm:px-6 lg:px-8 pt-2 pb-24">
        <PageFrame>
          <button
            onClick={() => navigate('../goal-setting-growth')}
            className="inline-flex items-center gap-2 h-10 px-3 rounded-full bg-white/[0.06] border border-white/[0.1] text-white text-[13px] font-medium touch-manipulation hover:bg-white/[0.1] mb-1 self-start"
          >
            <ArrowLeft className="h-4 w-4" /> Goal setting & continuous growth
          </button>

          <PageHero
            eyebrow="Module 6 · Final assessment"
            title="Mock exam"
            description="Put your goal setting and continuous growth knowledge to the test under timed exam conditions. Questions are drawn from a 200-question bank covering all five content modules."
            tone="yellow"
          />
          ...
          >
            <div className="rounded-2xl bg-gradient-to-br from-elec-yellow/15 via-amber-500/10 to-transparent border border-elec-yellow/30 p-5 sm:p-6 active:scale-[0.99] transition-transform">
              <div className="flex items-center justify-between gap-3">
                ...
                <PrimaryButton size="lg" onClick={() => navigate('../gs-mock-exam')}>
