import { ArrowLeft, Search, CheckCircle, AlertTriangle, Calendar, TreePine } from 'lucide-react';
...
const faqs = [
  ...
  {
    question: 'What is biodiversity net gain and how does it relate to ecological surveys?',
    answer:
...
const quizQuestions = [
  ...
  },
  {
    ...
    options: ['January to March', 'April to June', 'July to September', 'October to December'],
    correctAnswer: 1,
    explanation:
...
export default function EnvironmentalSustainabilityModule5Section2() {
  useSEO({
    title: 'Ecological Surveys & Assessments | Environmental & Sustainability Module 5.2',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>PEA first:</strong> Desktop study + Phase 1 habitat survey before any
                further work
              </li>
              <li>
                <strong>Seasonal:</strong> Most surveys can only be done at specific times of year
              </li>
              <li>
                <strong>Mitigation hierarchy:</strong> Avoid &rarr; minimise &rarr; restore &rarr;
                offset
              </li>
              <li>
                <strong>Three tests:</strong> Public interest, no alternative, conservation status
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>ECoW:</strong> Ecological Clerk of Works monitors compliance during
                construction
              </li>
              <li>
                <strong>Toolbox talks:</strong> Site workers briefed on ecological constraints
              </li>
              <li>
                <strong>Licence conditions:</strong> Strict adherence to method statements required
              </li>
              <li>
                <strong>Stop work:</strong> If protected species found unexpectedly, all works halt
              </li>
            </ul>
          </div>
        </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Ecological surveys are a <strong>fundamental requirement</strong> of the planning
                process in the United Kingdom. They provide the evidence base upon which planning
                decisions are made, and they are the mechanism by which developers demonstrate
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Planning Requirements</p>
                      <p>
                        The National Planning Policy Framework (NPPF) requires local planning
                        authorities to consider the ecological impact of proposed developments.
                        Applications that do not include adequate ecological information will be
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Site purchasers and developers have a duty of care to understand the
                        ecological constraints on a site before committing to a development. Failing
                        to identify protected species early can result in costly delays, redesigns,
                        or prosecution.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        ...
                        Species Regulations 2017 make it a criminal offence to disturb, injure, or
                        kill protected species or to damage or destroy their habitats without an
                        appropriate licence. Ecological surveys identify where these legal
                        protections apply.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Species Licensing</p>
                      <p>
                        If protected species are found on site, a licence from Natural England (or
                        the relevant devolved body) is required before works that would affect them
                        can proceed. The licence application must be supported by survey data
                        demonstrating the species&rsquo; presence, population size, and usage of the
                        site.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Informed Decision-Making</p>
                      <p>
                        Surveys enable the design team to make informed decisions about site layout,
                        phasing, and mitigation measures. Understanding ecological constraints early
                        allows them to be designed around rather than encountered unexpectedly
                        during construction.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Key Principle:</strong> Ecological surveys
                  are not optional extras &mdash; they are a legal and planning requirement. The
                  cost of surveys is negligible compared to the cost of prosecution, project delays,
                  or redesigning a scheme after construction has begun.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Preliminary Ecological Appraisal is the <strong>first stage</strong> of the
                ecological assessment process. It provides an initial overview of the ecological
                value of a site and identifies where further, more detailed surveys may be required.
                Every development project should begin with a PEA.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Local biological records centre</strong>{' '}
                      &mdash; existing records of protected and notable species within a defined
                      search radius (typically 1&ndash;2 km)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Statutory designations</strong> &mdash; Sites
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Non-statutory designations</strong> &mdash;
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Aerial photography and mapping</strong> &mdash;
                      identifying habitat features, connectivity corridors, waterbodies, and
                      woodland
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Previous survey reports</strong> &mdash; any
                      existing ecological data for the site from prior applications or assessments
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Habitat types</strong> are mapped using
                      colour-coded categories &mdash; woodland, grassland, scrub, wetland, built
                      environment, etc.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Target notes</strong> record specific features
                      of ecological interest &mdash; potential bat roost features, badger setts,
                      ponds suitable for great crested newts, veteran trees, invasive species
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">potential for protected species</strong> based
                      on the habitats present and their quality
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">potential for protected species</strong>, and{' '}
                  <strong className="text-white">recommendations</strong> for further surveys where
                  needed. It also provides an initial assessment of the likely ecological
                  constraints and opportunities for the proposed development.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>species-specific surveys</strong> are required to determine whether those
                species are actually present, their population size, and how they use the site. Each
                species group has its own survey methodology and seasonal requirements.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Preliminary Roost Assessment (PRA)</p>
                      <p>
                        A daytime inspection of buildings or trees to assess their potential to
                        support roosting bats. The ecologist looks for features such as gaps in roof
                        tiles, lifted lead flashing, crevices in timber, and signs of bat presence
                        (droppings, urine staining, feeding remains). Structures are graded from
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Emergence and Re-Entry Surveys</p>
                      <p>
                        Conducted at dusk and dawn respectively. Surveyors position themselves
                        around the building or tree and use bat detectors to record bats emerging
                        from or returning to potential roost locations. The number of surveys
                        required depends on the roost potential grading &mdash; typically 2&ndash;3
                        surveys for moderate potential, 3&ndash;4 for high potential.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Activity Surveys</p>
                      <p>
                        Transect walks or static bat detector deployments that record bat activity
                        across the wider site. These identify commuting routes, foraging areas, and
                        the species present. Static detectors are left in position for consecutive
                        nights to gather data on activity levels.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">eDNA (environmental DNA)</strong> &mdash; water
                      samples taken from ponds are analysed in a laboratory for the presence of GCN
                      DNA. This confirms presence or likely absence but does not provide population
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Bottle trapping</strong> &mdash; funnel traps
                      are set in ponds overnight and checked the following morning. This provides
                      data on species presence and population size class (small, medium, or large).
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Torch surveys</strong> &mdash; surveyors walk
                      the perimeter of ponds at night using powerful torches to count newts visible
                      in the water. Combined with other methods for a full population assessment.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Breeding bird surveys</strong> &mdash;
                      typically conducted between March and June using territory mapping (Common
                      Bird Census) methodology. A minimum of three visits is required to map
                      breeding territories. All nesting birds are protected under the Wildlife and
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Wintering bird surveys</strong> &mdash;
                      conducted between November and March. Particularly important near wetland
                      sites, estuaries, and farmland that may support overwintering populations of
                      Schedule 1 or Annex I species.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  The refugia must be left in place for at least two weeks to &ldquo;bed in&rdquo;
                  before survey visits begin. A minimum of{' '}
                  <strong className="text-white">seven survey visits</strong> conducted during
                  suitable weather conditions (typically April to September, ideally in warm but not
                  hot conditions) is required for a robust assessment. All four common UK reptile
                  species (slow worm, common lizard, grass snake, adder) are protected from
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Most ecological surveys are <strong>seasonally constrained</strong> because species
                are only active, visible, or detectable at certain times of year. Understanding
                these seasonal windows is critical to project programming. Missing a survey window
                in one year can delay a project by up to <strong>12 months</strong>.
              </p>

              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Multi-Season Requirements:</strong> Some
                  surveys require visits across multiple seasons to provide a complete picture. Bat
                  activity surveys, for example, may require visits from May to September. If a
                  project starts too late in the season to complete all required visits, the
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>identifying, quantifying, and evaluating</strong> the potential effects of a
                proposed development on ecological features. In the UK, the standard framework is
                provided by the{' '}
                <strong>Chartered Institute of Ecology and Environmental Management (CIEEM)</strong>{' '}
                guidelines.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3 text-sm text-white/80">
                  <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-3">
                    ...
                    <p>
                      Physical destruction or removal of habitats or species directly caused by the
                      development (e.g., demolishing a building containing a bat roost, clearing
                      woodland).
                    </p>
                  </div>
                  <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-3">
                    <p className="text-white font-medium mb-1">Indirect Impacts</p>
                    <p>
                      Secondary effects not directly caused by the development but occurring as a
                      consequence (e.g., increased light spill affecting bat foraging, changes to
                      hydrology affecting wetland habitats).
                    </p>
                  </div>
                  <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-3">
                    <p className="text-white font-medium mb-1">Cumulative Impacts</p>
                    <p>
                      Combined effects of the proposed development together with other existing or
                      planned developments in the area (e.g., multiple housing schemes collectively
                      reducing habitat connectivity).
                    </p>
                  </div>
                  <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-3">
                    <p className="text-white font-medium mb-1">Additional Parameters</p>
                    <p>
                      Magnitude, extent, duration (temporary or permanent), reversibility, timing,
                      and frequency of the impact are all assessed.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Receptor importance</strong> &mdash; the
                      conservation value of the ecological feature, assessed on a geographic scale
                      (international, national, regional, county, local, site-level)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Magnitude of impact</strong> &mdash; the scale,
                      extent, and severity of the predicted change to the ecological feature
                    </span>
                  </li>
                </ul>
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>internationally recognised framework</strong> for managing ecological
                impacts. It must be applied in strict order &mdash; each step is only considered
                when the preceding step has been exhausted or is demonstrably not achievable.
              </p>
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Redesign the development to avoid ecological impacts entirely. This is
                        always the preferred option. Examples: relocating the footprint away from a
                        bat roost, phasing works to avoid nesting bird season, retaining existing
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-emerald-300 font-medium">Minimisation</p>
                      <p>
                        Where avoidance is not fully possible, reduce the severity or extent of the
                        impact. Examples: directional lighting to reduce light spill on bat
                        commuting routes, noise barriers during piling, timing of vegetation
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-emerald-300 font-medium">Rehabilitation / Restoration</p>
                      <p>
                        Repair or restore ecological features that have been damaged or degraded.
                        Examples: reinstating a hedgerow after trenching, restoring grassland after
                        temporary construction access, like-for-like habitat replacement.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Compensate for residual impacts that cannot be avoided, minimised, or
                        restored. This is the <strong className="text-white">last resort</strong>.
                        Examples: creating new habitat elsewhere to replace what was lost,
                        purchasing biodiversity credits, contributing to off-site habitat
                        management.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  Planning authorities and Natural England will reject applications that propose
                  compensation without evidence that the earlier steps of the hierarchy have been
                  properly applied.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>European Protected Species</strong> (such as bats or great crested newts) or
                their habitats, a <strong>mitigation licence</strong> must be obtained from Natural
                England before any works that could disturb, injure, or kill the species or damage
                or destroy their breeding sites or resting places can proceed.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Works will <strong className="text-white">disturb</strong> a protected species
                      at a breeding site or resting place
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Works will <strong className="text-white">damage or destroy</strong> a
                      breeding site or resting place (e.g., demolishing a building with a bat roost)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      ...
                      <strong className="text-white">killing or injury</strong> of a protected
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Method statement</strong> &mdash; detailed
                      description of the proposed works, timing, and the specific mitigation
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Reasoned statement</strong> &mdash; the
                      applicant&rsquo;s justification for how each of the three derogation tests is
                      satisfied
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Supporting survey data</strong> &mdash;
                      up-to-date ecological survey reports (typically no more than 2 years old)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Planning permission</strong> &mdash; a valid
                      planning consent must be in place before a licence can be granted
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Named ecologist</strong> &mdash; the licence is
                      issued to a named, suitably qualified ecologist who is responsible for
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  Penalties include an unlimited fine and up to six months imprisonment (or both).
                  Ignorance of the species&rsquo; presence is not a defence if reasonable steps to
                  identify protected species (i.e., adequate ecological surveys) were not taken.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                An Ecological Clerk of Works (ECoW) is a <strong>qualified ecologist</strong>{' '}
                appointed to be present on site during construction to ensure that ecological
                planning conditions, licence requirements, and approved method statements are
                complied with. The ECoW acts as the ecological representative on site, bridging the
                gap between the project ecologist and the construction team.
              </p>
                ...
                <div className="space-y-3 text-sm text-white/80">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        The ECoW is present during ecologically sensitive works to watch for
                        protected species and ensure the method statement is being followed. This
                        may include supervising vegetation clearance, building demolition, or
                        excavation near known habitats. If a protected species is encountered, the
                        ECoW has the authority to stop works immediately.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        Delivering ecological awareness briefings to site workers before works
                        begin. Toolbox talks cover what protected species may be present, what they
                        look like, what to do if one is found, and the legal consequences of
                        non-compliance. Records of attendance must be kept.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p>
                        If a protected species is discovered unexpectedly, or if a breach of
                        ecological conditions occurs, the ECoW manages the response. This may
                        include stopping works, securing the area, contacting Natural England, and
                        advising the site manager on the appropriate course of action. Incidents
                        must be formally recorded and reported.
                      </p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Monitoring Compliance</p>
                      <p>
                        The ECoW monitors ongoing compliance with ecological planning conditions,
                        licence conditions, and the Construction Environmental Management Plan
                        (CEMP). This includes checking that exclusion zones are maintained, that
                        timing restrictions are observed, that pollution prevention measures are in
                        place, and that mitigation features (such as bat boxes or newt fencing) are
                        installed correctly.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-500/70 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Site visit reports</strong> documenting
                      activities observed, species encountered, and compliance status
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-500/70 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Toolbox talk records</strong> with dates,
                      topics covered, and attendance signatures
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-500/70 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Incident logs</strong> recording any ecological
                      incidents, the response taken, and outcome
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-500/70 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Licence return data</strong> &mdash; species
                      counts and mitigation outcomes required by Natural England as a condition of
                      the licence
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Key Point:</strong> The ECoW is not just an
                  advisory role &mdash; they have the <strong>authority to stop works</strong> if
                  ecological conditions are being breached. Site managers and contractors must
                  respect this authority. Failure to comply with the ECoW&rsquo;s directions can
                  result in criminal prosecution and the revocation of planning permission or
