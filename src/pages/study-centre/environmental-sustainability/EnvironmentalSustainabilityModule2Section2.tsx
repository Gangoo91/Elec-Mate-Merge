...
const quickCheckQuestions = [
  ...
  },
  {
    ...
    question: 'What is the maximum custodial sentence for fly-tipping in England?',
    options: [
...
const faqs = [
  {
    question: 'What is the difference between a waste transfer note and a consignment note?',
    answer:
  ...
  {
    question: 'Can I use a season ticket instead of individual waste transfer notes?',
    answer:
  ...
  {
    question: 'How do I check whether a waste carrier is properly registered?',
    answer:
  ...
  {
    question: 'What are my responsibilities as a householder regarding waste disposal?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'Consignment notes for hazardous waste must be retained for how long?',
...
const EnvironmentalSustainabilityModule2Section2 = () => {
  useSEO({
    title: 'Duty of Care & Waste Transfer Notes | Environmental & Sustainability Module 2.2',
    description:
          ...
          <div className="rounded-lg p-4 bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Duty of care:</strong> &ldquo;cradle to
                  grave&rdquo; responsibility for all controlled waste
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Waste transfer notes:</strong> legally required for
                  every waste transfer, retained 2 years
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Consignment notes:</strong> 5-part form for
                  hazardous waste, retained 3 years
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Fly-tipping:</strong> unlimited fine, up to 5
          ...
          <div className="rounded-lg p-4 bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Before transferring:</strong> complete a waste
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Check carriers:</strong> verify registration on the
                  EA public register
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Keep records:</strong> store all duty of care
                  paperwork for the required period
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Never:</strong> hand waste to anyone who cannot
                  prove they are authorised
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                waste. This is one of the most important principles in waste management law and
                applies to{' '}
                <strong className="text-white">
                  anyone who produces, imports, keeps, stores, treats, or disposes of controlled
                  waste
                </strong>
                . It is not limited to large businesses &mdash; it applies equally to sole traders,
                small firms, and major corporations.
              </p>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  responsibility for their waste from the moment it is created through every stage
                  of its journey &mdash; collection, transport, treatment, and final disposal. Even
                  after waste has been handed to a registered carrier, the producer is not absolved
                  of responsibility if they failed to take reasonable steps to ensure proper
                  handling.
                </p>
              </div>
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      ensure waste is not deposited, treated, or disposed of in a way that pollutes
                      the environment or harms human health
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Prevent escape of waste:</strong> keep waste
                      contained securely so it cannot blow away, leak, or otherwise escape from your
                      control
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Transfer only to authorised persons:</strong>{' '}
                      only pass waste to someone who is legally authorised to accept it &mdash; a
                      registered carrier, a licensed waste site, or the local authority
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Provide an accurate description:</strong> give
                      a written description of the waste so that anyone who subsequently handles it
                      can do so safely and lawfully
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Complete a waste transfer note:</strong> for
                      every transfer of non-hazardous waste, or a consignment note for hazardous
                      waste
                    </div>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  described, contained, transferred only to authorised persons, and accompanied by
                  the correct documentation. Ignorance is no defence: if your waste ends up
                  fly-tipped because you handed it to an unregistered carrier, you can be
                  prosecuted.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-teal-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                of non-hazardous controlled waste from one party to another. It provides a paper
                trail that demonstrates compliance with the duty of care and allows regulators to
                trace waste from its source to its final destination.
              </p>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  transfer notes at any time during this period. Failure to produce a valid WTN when
                  asked is an offence.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                <strong className="text-white">consignment note</strong> must be used. This is a
                more detailed document that provides a full audit trail for dangerous materials.
              </p>

              <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                <h3 className="text-amber-300 font-medium mb-3">The 5-Part Consignment Note</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-amber-500/20 border border-amber-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-amber-300 text-xs font-bold">A</span>
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-amber-500/20 border border-amber-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-amber-300 text-xs font-bold">B</span>
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-amber-500/20 border border-amber-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-amber-300 text-xs font-bold">C</span>
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-amber-500/20 border border-amber-400/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-amber-300 text-xs font-bold">E</span>
                    </div>
                    <div>
              ...
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  <strong className="text-white">unique consignment note code</strong> that must be
                  recorded on the consignment note. The code allows the EA to track the waste
                  movement and ensure it reaches an authorised facility. Pre-notification must be
                  completed <strong className="text-white">before</strong> the waste leaves the
                  site.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  reflecting the higher risk associated with hazardous waste. Both the producer and
                  the consignee must retain copies.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Fluorescent tubes and lamps:</strong> contain
                      mercury &mdash; classified as hazardous waste
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-amber-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Batteries:</strong> lead-acid and lithium
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-amber-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Capacitors containing PCBs:</strong> found in
                      older electrical equipment, highly toxic
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-amber-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Cable with lead sheathing:</strong> older
                      cables may contain lead which is a hazardous substance
                    </div>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-cyan-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                Environment Agency. This includes businesses that carry their own waste as well as
                dedicated waste collection companies. There are two tiers of registration:
              </p>

              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                <h3 className="text-cyan-300 font-medium mb-3">Carrier Registration Tiers</h3>
                <div className="space-y-4 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Lower tier:</strong> free registration for
                      businesses that carry only their own non-hazardous waste (e.g. an electrical
                      contractor taking cable offcuts to the tip). Registration does not expire but
                      must be renewed if details change.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Upper tier:</strong> paid registration for
                      businesses that carry other people&rsquo;s waste or their own
                      construction/demolition waste. Must be renewed every 3 years.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  <strong className="text-white">public register</strong> available online at GOV.UK
                  where you can search by company name, registration number, or company number. The
                  register confirms whether the registration is current, the tier, and what types of
                  waste the carrier is authorised to handle. Keep a record of your check &mdash; a
                  screenshot or printout of the register entry is good evidence of due diligence.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Prosecution of the waste producer:</strong> for
                      failing to fulfil the duty of care
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Liability for fly-tipping:</strong> if the
                      unregistered carrier dumps the waste illegally, the original producer can be
                      held jointly liable
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Unlimited fines:</strong> on conviction, courts
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Seizure of vehicles:</strong> the Environment
                      Agency has the power to seize vehicles used for illegal waste carriage
                    </div>
                  </li>
                </ul>
              </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                <strong className="text-white">waste dealers</strong> &mdash; intermediaries who
                arrange or facilitate waste transfers without necessarily transporting the waste
                themselves.
              </p>

              <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                <h3 className="text-purple-300 font-medium mb-3">Key Differences</h3>
                <div className="space-y-4 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Waste broker:</strong> arranges the disposal or
                      recovery of waste on behalf of others. They do not take physical possession of
                      the waste. A broker acts as an intermediary between the waste producer and the
                      carrier or disposal facility.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Waste dealer:</strong> buys, sells, or
                      otherwise arranges waste transactions. Unlike a broker, a dealer typically
                      takes ownership of the waste at some point &mdash; they buy it from the
                      producer and sell it on for treatment or recovery.
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Waste carrier:</strong> physically transports
                      waste from one location to another. The carrier may or may not also be the
                      broker or dealer.
                    </div>
                  </div>
                </div>
              ...
              <p>
                ...
                <strong className="text-white">registered with the Environment Agency</strong>. They
                have a <strong className="text-white">due diligence obligation</strong> to ensure
                that waste is handled lawfully at every stage. If you use a broker to arrange waste
                removal, you should verify their registration in the same way you would check a
                carrier &mdash; through the EA&rsquo;s public register. The broker must also ensure
                that any carriers and facilities they use are properly authorised.
              </p>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  unregistered carrier to collect your waste and it is fly-tipped, you can still be
                  prosecuted. Always carry out your own checks and keep records.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-sky-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                <strong className="text-white">digital waste tracking system</strong> that will
                fundamentally change how waste is recorded and monitored. The system replaces
                paper-based waste transfer notes and consignment notes with electronic records.
              </p>
              ...
              <div className="bg-white/5 border border-sky-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Single digital record:</strong> all waste
                      movements will be recorded in a single national system, creating an end-to-end
                      audit trail from production to disposal
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Real-time tracking:</strong> regulators will be
                      able to monitor waste movements as they happen, making it far easier to detect
                      illegal activity
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Reduced paperwork:</strong> businesses will no
                      longer need to retain physical copies of waste transfer notes &mdash; the
                      digital system will hold all records centrally
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-sky-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Improved data quality:</strong> standardised
                      digital forms will reduce errors, inconsistencies, and incomplete records that
                      plague the current paper-based system
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Easier compliance:</strong> guided digital
                      forms help ensure all mandatory fields are completed correctly
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Better enforcement:</strong> the EA can
                      identify gaps in the waste chain &mdash; where waste disappears between
                      producer and disposal &mdash; which often indicates illegal dumping
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Waste crime reduction:</strong> transparency
                      and traceability make it much harder for criminals to operate undetected
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Resource efficiency:</strong> better data on
                      waste types and volumes supports improved recycling and resource recovery
                      planning
                    </div>
                  </li>
                </ul>
          ...
          <div className="border-l-2 border-red-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                <strong className="text-white">Section 33</strong> of the Environmental Protection
                Act 1990 and is one of the most significant environmental crimes in England.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Over 1 million incidents</strong> of
                      fly-tipping are recorded each year in England alone
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      ...
                      <strong className="text-white">hundreds of millions of pounds</strong> per
                      year
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      The most commonly fly-tipped waste types include household waste, construction
                      and demolition waste, white goods, and tyres
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      Fly-tipping causes pollution, harms wildlife, reduces property values, and
                      blights communities
                    </div>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-red-400/30 p-4 rounded-lg">
                <h3 className="text-red-300 font-medium mb-3">Penalties for Fly-Tipping</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Summary conviction:</strong> unlimited fine
                      and/or up to 12 months&rsquo; imprisonment
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Conviction on indictment:</strong> unlimited
                      fine and/or up to{' '}
                      <strong className="text-white">5 years&rsquo; imprisonment</strong>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Fixed penalty notices:</strong> local
                      authorities can issue FPNs of up to &pound;1,000 for smaller-scale fly-tipping
                      &mdash; these are an alternative to prosecution for less serious offences
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-red-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Vehicle seizure:</strong> vehicles used for
                      fly-tipping can be seized and crushed
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  hands waste to an unlicensed individual &mdash; for example, someone offering
                  cheap rubbish removal on social media &mdash; and that waste is subsequently
                  fly-tipped, the householder can be issued a fixed penalty notice of up to{' '}
                  <strong className="text-white">&pound;400</strong> or prosecuted. The message is
                  clear: always check that whoever takes your waste is authorised to do so.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  must never dump waste in skips that belong to other contractors without
                  permission, and you must never ask an unregistered person to &ldquo;get rid&rdquo;
                  of waste for you. These are all potential offences that could result in
                  prosecution, unlimited fines, and reputational damage.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                prosecution, and protect their reputation. Here are the practical steps you should
                take:
              </p>
              ...
              <div className="bg-white/5 border border-emerald-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      Keep copies of all waste transfer notes and consignment notes for the required
                      retention periods (2 years and 3 years respectively)
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-emerald-400/60 mt-0.5 flex-shrink-0" />
                    <span>
                      Maintain a log of all waste carrier registrations you have checked, including
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-emerald-400/60 mt-0.5 flex-shrink-0" />
                    <span>
                      Store records in a central, accessible location &mdash; digitally if possible
                      &mdash; so they can be produced quickly if the Environment Agency requests
                      them
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-emerald-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-emerald-400/60 mt-0.5 flex-shrink-0" />
                    <span>
                      Conduct regular waste audits to understand what waste your business produces,
                      in what quantities, and how it is currently disposed of
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-emerald-400/60 mt-0.5 flex-shrink-0" />
                    <span>
                      Identify opportunities to reduce waste, reuse materials, and increase
                      recycling rates
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-emerald-400/60 mt-0.5 flex-shrink-0" />
                    <span>
                      Use audit findings to negotiate better waste collection contracts and reduce
                      disposal costs
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-white/5 border border-emerald-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-emerald-400/60 mt-0.5 flex-shrink-0" />
                    <span>
                      Ensure all employees understand the duty of care and their personal
                      responsibilities
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-emerald-400/60 mt-0.5 flex-shrink-0" />
                    <span>
                      Train staff to separate waste correctly on site &mdash; general waste,
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-emerald-400/60 mt-0.5 flex-shrink-0" />
                    <span>
                      Make sure staff know how to complete waste transfer notes and who to contact
                      if they are unsure about waste classification
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-emerald-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-emerald-400/60 mt-0.5 flex-shrink-0" />
                    <span>
                      Verify that the final destination for your waste holds the correct
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-emerald-400/60 mt-0.5 flex-shrink-0" />
                    <span>
                      Consider visiting the disposal or recovery site to satisfy yourself that it is
                      a legitimate, well-managed operation
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-emerald-400/60 mt-0.5 flex-shrink-0" />
                    <span>
                      Be suspicious of waste collection services that offer prices significantly
                      lower than competitors &mdash; this may indicate illegal disposal
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-emerald-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-emerald-400/60 mt-0.5 flex-shrink-0" />
                    <span>
                      An estimate of the types and quantities of waste the project will produce
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-emerald-400/60 mt-0.5 flex-shrink-0" />
                    <span>Plans for waste minimisation, reuse, and recycling</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-emerald-400/60 mt-0.5 flex-shrink-0" />
                    <span>Details of the carriers and disposal/recovery facilities to be used</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="h-4 w-4 text-emerald-400/60 mt-0.5 flex-shrink-0" />
                    <span>
                      Actual waste volumes and disposal routes recorded as the project progresses
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="flex justify-center mb-3">
            <div className="bg-amber-500/15 border-2 border-amber-500/40 rounded-xl px-5 py-3 text-center max-w-sm">
              <p className="text-amber-300 font-semibold text-sm">Is the waste hazardous?</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 max-w-2xl mx-auto mb-3">
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="bg-white/5 border border-emerald-400/30 rounded-lg px-3 py-2 text-center w-full">
                <p className="text-emerald-300 font-medium text-xs">No &mdash; Non-Hazardous</p>
              </div>
            ...
            <div className="flex flex-col items-center gap-2">
              <div className="bg-white/5 border border-amber-400/30 rounded-lg px-3 py-2 text-center w-full">
                <p className="text-amber-300 font-medium text-xs">Yes &mdash; Hazardous</p>
              </div>
        ...
        <section className="mb-10">
          ...
          <div className="mt-4 bg-white/5 border border-white/10 rounded-lg p-3 max-w-2xl mx-auto">
            <p className="text-white/60 text-xs text-center">
              ...
              for hazardous waste) accompanies each transfer.
            </p>
          </div>
        </section>
