...
const faqs = [
  {
    question: 'What should I do if I discover a bat roost during construction work?',
    answer:
  ...
  {
    question: 'Can I carry out vegetation clearance during the bird nesting season?',
    answer:
  ...
  {
    question: 'How does biodiversity net gain work in practice on a construction project?',
    answer:
...
const quizQuestions = [
  ...
  {
    id: 6,
    question: 'What is the purpose of pre-commencement ecological surveys on a construction site?',
    options: [
...
export default function EnvironmentalSustainabilityModule5Section1() {
  useSEO({
    title: 'Protected Species & Habitats | Environmental Sustainability Module 5.1',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>All bats:</strong> Protected year-round, including roosts when bats are
                absent
              </li>
              <li>
                <strong>10% net gain:</strong> Mandatory biodiversity improvement for new
                developments
              </li>
              <li>
                <strong>Criminal offences:</strong> Unlimited fines and/or imprisonment for breaches
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Nesting season:</strong> March to August &mdash; check before clearing
                vegetation
              </li>
              <li>
                <strong>30-year management:</strong> Created habitats must be maintained long-term
              </li>
              <li>
                <strong>Due diligence:</strong> Ignorance is not a defence if surveys were not
                carried out
              </li>
            </ul>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>Biodiversity</strong> &mdash; the variety of life on Earth &mdash; underpins
                the <strong>ecosystem services</strong> that human civilisation depends upon. These
                are not abstract environmental concepts; they are practical services that directly
                affect our daily lives and the viability of the construction industry itself.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Pollination</strong> &mdash; bees, butterflies,
                      and other insects pollinate approximately 75% of global food crops. Without
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Water purification</strong> &mdash; wetlands,
                      rivers, and their associated ecosystems naturally filter and purify water,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Flood defence</strong> &mdash; natural habitats
                      such as floodplains, wetlands, and woodlands absorb and slow rainwater,
                      reducing the risk and severity of flooding downstream
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Carbon sequestration</strong> &mdash; forests,
                      peatlands, and grasslands absorb and store carbon dioxide, helping to regulate
                      climate
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Soil health</strong> &mdash; earthworms, fungi,
                      and microorganisms maintain soil structure and fertility, essential for
                      agriculture and the stability of built structures
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  extinction, and species abundance has fallen by an average of 19% since 1970.
                  Construction and development are significant drivers of habitat loss, accounting
                  for the direct destruction of greenfield sites, fragmentation of wildlife
                  corridors, and disturbance of species during works.
                </p>
              </div>

              <p>
                The construction industry has a <strong>legal and moral responsibility</strong> to
                minimise its impact on biodiversity. This is not optional &mdash; it is enforced
                through criminal law, planning conditions, and the new mandatory biodiversity net
                gain requirement. Every person working on a construction site needs to understand
                which species and habitats are protected, what the law requires, and what the
                consequences are for getting it wrong.
              </p>

              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">Key Principle:</strong> Biodiversity
                  protection is not about preventing development &mdash; it is about ensuring that
                  development is carried out in a way that{' '}
                  <strong>
                    avoids unnecessary harm, mitigates unavoidable impacts, and compensates for any
                    residual loss
                  </strong>
                  . This is known as the mitigation hierarchy: avoid first, mitigate second,
                  compensate last.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Wildlife &amp; Countryside Act 1981</strong> (WCA) is the principal
                legislation for the protection of wildlife in Great Britain. It establishes three
                key Schedules of protected species and creates criminal offences for harming them.
              </p>

              <div className="bg-white/5 border-2 border-emerald-500/30 p-5 rounded-xl">
                <div className="flex items-center gap-2 mb-4">
                  <Scale className="h-5 w-5 text-emerald-400" />
                  <p className="text-sm font-bold text-emerald-400">Protected Species Schedules</p>
                </div>
                ...
                <div className="space-y-3">
                  <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      wild birds receive basic protection under Part 1 of the Act.
                    </p>
                  </div>
                  ...
                  <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      species, or to damage or destroy their places of shelter.
                    </p>
                  </div>
                  ...
                  <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70">
                      ...
                      any wild plant without authorisation.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Killing, injuring, or taking</strong> any wild
                      bird, or taking or destroying their eggs or nests
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Intentionally or recklessly disturbing</strong>{' '}
                      Schedule 1 birds at or near their nest during the breeding season
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Killing, injuring, or taking</strong> Schedule
                      5 animals, or damaging or destroying their places of shelter or protection
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Picking, uprooting, or destroying</strong>{' '}
                      Schedule 8 plants
                    </span>
                  </li>
                </ul>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">up to six months&apos; imprisonment</strong>.
                  Penalties are per specimen &mdash; if ten protected animals are killed, that is
                  ten separate offences. Courts can also order{' '}
                  <strong className="text-white">forfeiture of equipment and vehicles</strong> used
                  in the commission of the offence.
                </p>
              </div>

              <p>
                <strong>Licensing:</strong> Natural England can issue licences permitting actions
                that would otherwise be offences, where there is a justified need (such as
                development with overriding public interest) and the conservation status of the
                species will be maintained. Licences are not granted automatically &mdash; they
                require detailed survey data, evidence that alternatives have been considered, and a
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Conservation of Habitats and Species Regulations 2017</strong> (commonly
                known as the &ldquo;Habitats Regulations&rdquo;) transposed the EU Habitats
                Directive into UK law and provide the highest level of protection for certain
                species and habitats. These regulations were retained in UK law after Brexit.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">All 18 species of bat</strong> found in the UK
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Great crested newt</strong> (Triturus
                      cristatus)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Dormouse</strong> (Muscardinus avellanarius)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Otter</strong> (Lutra lutra)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80 mb-2">
                  ...
                  their protection. Any plan or project likely to have a significant effect on a SAC
                  must undergo a{' '}
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Screening:</strong> Determines whether the
                      project is likely to have a significant effect on the SAC
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Appropriate Assessment:</strong> If screening
                      identifies a likely significant effect, a detailed assessment of impacts on
                      site integrity must be carried out
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      ...
                      Only where there is no alternative and the reasons are of exceptional public
                      importance can a project proceed despite adverse effects on a SAC
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1 mt-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      There is <strong className="text-white">no satisfactory alternative</strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      The action will{' '}
                      <strong className="text-white">
                        not be detrimental to the maintenance of the species at a favourable
                        conservation status
                      </strong>
                    </span>
                  </li>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">Remember:</strong> The Habitats Regulations
                  provide the <strong>highest level of species protection</strong> in UK law.
                  Working without the required licence where European Protected Species are present
                  is a criminal offence regardless of whether planning permission has been granted.
                  Planning permission does not override the need for an EPS licence.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The following protected species are most frequently encountered on construction
                sites in the UK. Understanding their ecology, legal protection, and the implications
                for construction work is essential for every site operative.
              </p>
              ...
              <div className="bg-white/5 border-2 border-emerald-500/30 p-5 rounded-xl">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      All <strong className="text-white">18 species</strong> of bat in the UK are
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Roosts are protected year-round</strong>{' '}
                      &mdash; even when bats are not present. The roost structure itself is
                      protected, not just the bats within it
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Bats roost in buildings, bridges, trees, tunnels, and underground structures
                      &mdash; places commonly encountered in construction
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Offences include killing or injuring bats, disturbing them, damaging or
                      destroying their roosts, or obstructing access to a roost
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Bat surveys</strong> are required before
                      demolition, renovation, or tree felling where bats may be present
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">terrestrial habitat up to 500 metres</strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Found in ponds, rough grassland, log piles, rubble piles, and beneath
                      materials stored on the ground
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      District Level Licensing (DLL) schemes now available in some areas as an
                      alternative to individual site licences
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">All wild birds, their nests, and eggs</strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      , though some species (e.g. pigeons, robins) may nest at any time of year
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      It is an offence to intentionally or recklessly destroy or damage an active
                      nest, or to disturb nesting birds
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Vegetation clearance during the nesting season requires a nesting bird check
                      by an ecologist within 48 hours before work
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Protected under the{' '}
                      <strong className="text-white">Protection of Badgers Act 1992</strong>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Offences include killing, injuring, or taking badgers, and interfering with a
                      sett (blocking entrances, digging, causing disturbance)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Heavy machinery vibration near a sett can constitute disturbance &mdash;
                      exclusion zones are typically 30 metres minimum
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      A licence from Natural England is required for any work that may disturb a
                      sett
                    </span>
                  </li>
                </ul>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-xs text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Slow worms, common lizards, grass snakes, and adders are protected against
                        killing and injury
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Found in brownfield sites, rough grassland, rubble, and compost heaps
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Translocation (trapping and moving) may be required before site clearance
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                  ...
                  <ul className="text-xs text-white/80 space-y-1">
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        The UK&apos;s fastest-declining mammal &mdash; population has fallen by 90%
                        since the 1970s
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>Protected against killing, injuring, and disturbance of burrows</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                      <span>
                        Work near waterways requires water vole surveys and potential displacement
                        programmes
                      </span>
                    </li>
                  </ul>
                  ...
                  <div className="min-w-[600px]">
                    ...
                    <div className="grid grid-cols-[140px_repeat(12,1fr)] gap-px mb-1">
                      ...
                      {Array.from({ length: 12 }).map((_, i) => (
                        <div
                          key={i}
                          className="h-5 rounded-sm bg-red-500/40 border border-red-500/30"
                        />
                      ))}
                    </div>
                    <p className="text-[10px] text-red-400 mb-2 ml-[140px]">
                      Roosts protected year-round
                    </p>
                    ...
                    <div className="grid grid-cols-[140px_repeat(12,1fr)] gap-px mb-1">
                      ...
                      {Array.from({ length: 12 }).map((_, i) => (
                        <div
                          key={i}
                          className={`h-5 rounded-sm ${i >= 4 && i <= 8 ? 'bg-emerald-500/40 border border-emerald-500/30' : 'bg-white/5 border border-white/10'}`}
                        />
                      ))}
                    </div>
                    <p className="text-[10px] text-emerald-400 mb-2 ml-[140px]">
                      Optimal survey window: May &ndash; Sep
                    </p>
                    ...
                    <div className="grid grid-cols-[140px_repeat(12,1fr)] gap-px mb-1">
                      ...
                      {Array.from({ length: 12 }).map((_, i) => (
                        <div
                          key={i}
                          className={`h-5 rounded-sm ${i >= 2 && i <= 7 ? 'bg-amber-500/40 border border-amber-500/30' : 'bg-white/5 border border-white/10'}`}
                        />
                      ))}
                    </div>
                    <p className="text-[10px] text-amber-400 mb-2 ml-[140px]">
                      Breeding season: Mar &ndash; Aug (check before clearing)
                    </p>
                    ...
                    <div className="grid grid-cols-[140px_repeat(12,1fr)] gap-px mb-1">
                      ...
                      {Array.from({ length: 12 }).map((_, i) => (
                        <div
                          key={i}
                          className={`h-5 rounded-sm ${i >= 2 && i <= 5 ? 'bg-blue-500/40 border border-blue-500/30' : 'bg-white/5 border border-white/10'}`}
                        />
                      ))}
                    </div>
                    <p className="text-[10px] text-blue-400 mb-2 ml-[140px]">
                      Aquatic surveys: Mar &ndash; Jun
                    </p>
                    ...
                    <div className="grid grid-cols-[140px_repeat(12,1fr)] gap-px mb-1">
                      ...
                      {Array.from({ length: 12 }).map((_, i) => (
                        <div
                          key={i}
                          className={`h-5 rounded-sm ${(i >= 0 && i <= 5) || i === 11 ? 'bg-orange-500/40 border border-orange-500/30' : 'bg-white/5 border border-white/10'}`}
                        />
                      ))}
                    </div>
                    <p className="text-[10px] text-orange-400 mb-2 ml-[140px]">
                      Sett closure restricted: Dec &ndash; Jun (breeding season)
                    </p>
                    ...
                    <div className="grid grid-cols-[140px_repeat(12,1fr)] gap-px mb-1">
                      ...
                      {Array.from({ length: 12 }).map((_, i) => (
                        <div
                          key={i}
                          className={`h-5 rounded-sm ${i >= 3 && i <= 8 ? 'bg-purple-500/40 border border-purple-500/30' : 'bg-white/5 border border-white/10'}`}
                        />
                      ))}
                    </div>
                    <p className="text-[10px] text-purple-400 mb-2 ml-[140px]">
                      Survey window: Apr &ndash; Sep (active season)
                    </p>
                  </div>
                </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The UK has a hierarchy of habitat designations, each carrying different levels of
                legal protection. Construction projects may be affected by any of these, and the
                level of protection determines the assessment, consent, and mitigation requirements.
              </p>
                    ...
                    <ul className="text-xs text-white/80 space-y-1">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          &mdash; designated under the Habitats Regulations for habitats and species
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Special Protection Areas (SPAs)</strong>{' '}
                          &mdash; designated under the Birds Directive for internationally important
                          bird populations
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Ramsar sites</strong> &mdash; wetlands of
                    ...
                    <ul className="text-xs text-white/80 space-y-1">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          &mdash; designated by Natural England for outstanding wildlife,
                          geological, or physiographical features. Operations likely to damage the
                          special features require consent. Criminal offence to intentionally or
                          recklessly damage a SSSI
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Ancient Woodland</strong> &mdash; woodland
                          that has existed continuously since at least 1600 (England and Wales).
                          Irreplaceable habitat &mdash; development resulting in loss of ancient
                          woodland is refused except in wholly exceptional circumstances (NPPF)
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Priority Habitats</strong> &mdash; habitats
                          identified under Section 41 of the Natural Environment &amp; Rural
                          Communities Act 2006 as being of principal importance for conservation
                          (e.g. lowland meadows, hedgerows, ponds, coastal saltmarsh)
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-3">
                    ...
                    <ul className="text-xs text-white/80 space-y-1">
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Local Wildlife Sites (LWS)</strong> &mdash;
                          non-statutory sites identified by local authorities as being of local
                          importance for wildlife. Protected through the planning system &mdash;
                          development should avoid impact where possible
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                        <span>
                          <strong className="text-white">Local Nature Reserves (LNRs)</strong>{' '}
                          &mdash; designated by local authorities for their nature conservation
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">Practical Implication:</strong> Before any
                  construction project begins, the planning authority&apos;s ecological records and
                  Natural England&apos;s MAGIC map service should be checked to identify whether any
                  designated habitats are present on or near the site. The higher the designation,
                  the more rigorous the assessment and consent requirements.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>biodiversity net gain (BNG)</strong> in England. This is one of the most
                significant changes to environmental law affecting the construction industry in
                recent years.
              </p>
              ...
              <div className="bg-emerald-500/10 border-2 border-emerald-500/40 p-5 rounded-xl">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">DEFRA biodiversity metric</strong>, which assigns a
                  numerical score to each habitat type based on its distinctiveness, condition, and
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">On-site:</strong> Planting native hedgerows,
                      creating wildflower meadows, installing green roofs, creating ponds, planting
                      native trees, enhancing existing habitats
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Off-site:</strong> Creating or enhancing
                      habitats on land controlled by the developer elsewhere &mdash; must be
                      registered with Natural England
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Statutory credits:</strong> Purchasing
                      biodiversity units from a government habitat bank as a last resort &mdash;
                      deliberately priced to incentivise on-site and off-site delivery first
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  through the metric. Additionally, on-site habitat delivery is always preferred
                  over off-site, and off-site is always preferred over purchasing credits. This
                  ensures that biodiversity gains are delivered as close to the impact as possible.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                When construction work takes place near protected species or habitats, a structured
                approach is required to ensure legal compliance and avoid harm. The following
                measures represent <strong>industry best practice</strong> and are typically
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Phase 1 habitat survey:</strong> Maps all
                      habitats on and adjacent to the site, identifies potential for protected
                      species, and recommends further surveys
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Protected species surveys:</strong> Targeted
                      surveys for specific species (bats, newts, birds, badgers, reptiles) carried
                      out at the appropriate time of year by licensed ecologists
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Pre-commencement checks:</strong> Immediately
                      before work begins, updated checks to confirm the situation has not changed
                      since the original surveys (e.g. new nests, new badger sett activity)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Vegetation clearance:</strong> Ideally carried
                      out September to February (outside bird nesting season). If clearance is
                      required March to August, a nesting bird check is mandatory within 48 hours
                      before work
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Demolition/renovation:</strong> Where bats are
                      present, work may only be carried out under licence during specified months
                      (typically avoiding the maternity season May to August and hibernation
                      November to March)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Badger sett closure:</strong> Only permitted
                      July to November under licence &mdash; sett closures are not permitted during
                      the breeding season (December to June)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Badger setts:</strong> Minimum 30-metre buffer
                      zone for heavy machinery; no digging or ground works within this zone without
                      a licence
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Active bird nests:</strong> Exclusion zone
                      typically 5 to 20 metres depending on the species (Schedule 1 species may
                      require larger zones)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Watercourses with water voles:</strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ancient woodland:</strong> Minimum 15-metre
                      buffer zone from the woodland edge (NPPF guidance)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Supervising ecologically sensitive operations (e.g. vegetation clearance,
                      demolition near bat roosts)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>Carrying out pre-start checks each day during sensitive works</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Monitoring compliance with licence conditions and ecological method statements
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      Stopping work immediately if protected species are discovered or if licence
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ecological method statements:</strong> Written
                      procedures detailing how specific operations will be carried out to avoid harm
                      to protected species (e.g. hand-searching before excavation, directional
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Toolbox talks:</strong> All site operatives
                      must receive briefings on what protected species may be present, how to
                      recognise them, what to do if they are found, and who to contact. Records of
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">Golden Rule:</strong> If in doubt,{' '}
                  <strong>stop work and seek advice</strong>. Every person on a construction site
                  has the right and the duty to stop work if they believe a protected species may be
                  at risk. Stopping work for an hour while an ecologist attends is always better
                  than continuing and committing a criminal offence.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Wildlife offences are <strong>criminal offences</strong> in the UK. The penalties
                are severe, and enforcement has increased significantly in recent years as awareness
                of biodiversity loss has grown.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Investigation powers:</strong> Natural England
                      can investigate suspected wildlife offences, enter land, and gather evidence
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Stop notices:</strong> Natural England can
                      issue notices requiring the immediate cessation of activities that are
                      damaging a SSSI or harming protected species
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Restoration orders:</strong> Courts can require
                      offenders to restore damaged habitats at their own expense, which can cost
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Licence revocation:</strong> If a licence
                      holder breaches their licence conditions, Natural England can revoke the
                      licence and require all work to stop immediately
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Breach of planning conditions:</strong> Most
                      planning permissions include ecological conditions (e.g. no work during
                      nesting season, implementation of ecological management plan). Breach of these
                      conditions is a planning offence
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Enforcement notices:</strong> The local
                      planning authority can issue enforcement notices requiring remedial action,
                      including stopping work entirely
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Injunctions:</strong> In urgent cases, the
                      local planning authority can seek a court injunction to immediately halt
                      development that is causing ecological harm
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-1">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      Appropriate ecological surveys were carried out at the right time of year by
                      competent ecologists
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>The results of surveys were properly assessed and acted upon</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      Reasonable precautions were taken to avoid harm (method statements, exclusion
                      zones, ecological supervision)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>
                      All relevant licences were obtained and their conditions were followed
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="h-4 w-4 text-emerald-400 mt-0.5 flex-shrink-0" />
                    <span>Workers were properly trained and briefed through toolbox talks</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  <strong className="text-white">reasonable steps to find out</strong> what is on
                  their site before commencing work. Failure to survey is itself evidence of a lack
                  of due diligence.
                </p>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">Final Thought:</strong> Protecting
                  biodiversity is not just a legal obligation &mdash; it is an investment in the
                  environment that sustains us all. The construction industry has the power to be a{' '}
                  <strong>positive force for nature</strong> through biodiversity net gain,
                  sensitive design, and responsible working practices. Every person on a
                  construction site plays a part in this. Know the law, know what is on your site,
                  and act responsibly. The penalties for getting it wrong are severe, but the real
                  cost of biodiversity loss is measured in the degradation of the natural systems
