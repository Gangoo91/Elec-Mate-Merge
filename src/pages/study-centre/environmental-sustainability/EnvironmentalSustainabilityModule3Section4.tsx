...
const quickCheckQuestions = [
  {
    id: 'fsc-pefc-purpose',
    question: 'What do FSC and PEFC certification schemes guarantee about timber products?',
    options: [
  ...
  {
    id: 'bes-6001-purpose',
    question: 'What does the BES 6001 standard assess in relation to construction products?',
    options: [
...
const faqs = [
  ...
  {
    question: 'Is it always better to choose a material with the lowest embodied carbon?',
    answer:
  ...
  {
    question: 'What practical steps can a site electrician take to reduce material waste?',
    answer:
  ...
  {
    question: 'What is a material passport, and why is it relevant to sustainable procurement?',
    answer:
...
export default function EnvironmentalSustainabilityModule3Section4() {
  useSEO({
    title: 'Sustainable Materials & Procurement | Environmental & Sustainability Module 3.4',
    description:
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Sustainable materials:</strong> Low embodied carbon, renewable, recyclable,
                non-toxic
              </li>
              <li>
                <strong>Timber:</strong> FSC/PEFC certified, CLT, glulam, UK-grown
              </li>
              <li>
          ...
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Specify certified:</strong> FSC/PEFC timber, BES 6001 products
              </li>
              <li>
                <strong>Check EPDs:</strong> Compare embodied carbon between options
              </li>
              <li>
                <strong>Reduce waste:</strong> Accurate specification, standard sizes
              </li>
              <li>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                A <strong>sustainable construction material</strong> is one whose extraction,
                manufacture, transport, use, and end-of-life disposal or recycling cause the{' '}
                <strong>least possible harm</strong> to the environment and to human health. No
                single material is perfectly sustainable in every respect, so the goal is to select
                materials that perform well across a range of environmental and social criteria.
              </p>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Key Point:</strong> No material is
                  &ldquo;perfectly sustainable.&rdquo; Timber sequesters carbon but requires land
                  and water; steel is infinitely recyclable but energy-intensive to produce from
                  ore. The skill is in <strong>comparing trade-offs</strong> and selecting the best
                  option for each specific application using objective data such as EPDs and
              ...
              <p>
                ...
                <strong>40% of the nation&rsquo;s total carbon emissions</strong> when both embodied
                and operational carbon are included. Material selection is therefore one of the most
                impactful decisions a designer, specifier, or contractor can make. Even small
                improvements &mdash; such as specifying CEM II concrete instead of CEM I, or
                choosing FSC-certified timber over uncertified imports &mdash; can deliver
                significant carbon savings when scaled across a project.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Timber is one of the most sustainable structural materials available to the
                construction industry. Unlike concrete or steel, timber is{' '}
                <strong>renewable</strong> &mdash; trees can be replanted and regrown &mdash; and it
                actively <strong>sequesters carbon</strong> during growth. A cubic metre of timber
                stores approximately <strong>1 tonne of CO&#8322; equivalent</strong>, locking that
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <ul className="text-xs sm:text-sm text-white space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>Chain of custody from forest to final product</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>Three label types: FSC 100%, FSC Mix, FSC Recycled</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>
                          Widely recognised and required by many UK public sector projects
                        </span>
                      </li>
                    </ul>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <ul className="text-xs sm:text-sm text-white space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>
                          Endorses national certification schemes against international benchmarks
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>
                          Covers sustainable forestry, biodiversity, and workers&rsquo; rights
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      erection, and significantly lower embodied carbon than concrete or steel
                      frames. The cross-laminated structure provides dimensional stability and high
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      aesthetically attractive and can be left exposed as a finished surface.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">sweet chestnut</strong> available from managed
                  forests. Using UK-grown timber dramatically reduces transport emissions compared
                  to imports from Scandinavia, the Baltics, or North America. It also supports the
                  domestic forestry economy and contributes to national carbon sequestration
                  targets. The UK currently imports approximately 80% of its timber needs &mdash;
                  increasing the use of homegrown timber is a key government policy objective.
                </p>
              </div>

              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Carbon Sequestration:</strong> Unlike
                  concrete and steel, which release CO&#8322; during manufacture, timber actively{' '}
                  <strong>removes</strong> CO&#8322; from the atmosphere during tree growth through
                  photosynthesis. When timber is used in construction, that stored carbon remains
                  locked in the building for its entire lifespan. This means timber buildings can be{' '}
                  <strong>carbon negative</strong> in terms of their structural materials &mdash;
                  they store more carbon than was emitted during their manufacture and construction.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Concrete is the world&rsquo;s most widely used construction material, but its key
                ingredient &mdash; <strong>Portland cement clinker</strong> &mdash; is responsible
                for approximately <strong>7% of global CO&#8322; emissions</strong>. The calcination
                process (heating limestone to around 1,450&deg;C) releases CO&#8322; both from the
                chemical reaction and from the fuel burned. Reducing the clinker content of cement
                is therefore one of the most impactful decarbonisation strategies in construction.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      durability, reduced permeability, and better resistance to sulphate and
                      chloride attack. Slower early-age strength gain but higher ultimate strength.
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      pours), and enhances long-term durability. Availability is declining in the UK
                      as coal-fired power stations close, so stockpiled fly ash and imported
                      supplies are increasingly used.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      produce very high-strength, low- permeability concrete. Often used in bridges,
                      marine structures, and high-performance applications where durability is
                      critical.
                    </p>
                  </div>
                </div>
                  ...
                  <table className="w-full text-sm text-white">
                    ...
                    <tbody className="divide-y divide-white/5">
                      ...
                      <tr>
                        ...
                        <td className="py-2">
                          Moderate reduction &mdash; blended with limestone, fly ash, or GGBS
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td className="py-2">
                          Significant reduction &mdash; high GGBS replacement (up to 70%)
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Geopolymer cements:</strong> Alkali-activated
                      binders that do not require Portland cement clinker at all. Made from
                      industrial waste products (fly ash, GGBS) activated by alkaline solutions. Can
                      reduce embodied carbon by up to 80% compared to CEM I. Still relatively new in
                      UK construction but gaining traction.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Recycled aggregates:</strong> Crushed concrete
                      from demolition can replace virgin aggregates (gravel, sand) in new concrete
                      mixes. Reduces quarrying, transport emissions, and landfill. BS 8500 allows up
                      to 20% recycled coarse aggregate in structural concrete.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Carbon capture and storage (CCS):</strong> Some
                      cement manufacturers are investing in capturing CO&#8322; at the point of
                      emission and storing it permanently underground. This could significantly
                      reduce the carbon footprint of clinker production in the future.
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  the specific application. CEM III mixes with high GGBS content have slower
                  early-age strength gain, which may affect formwork striking times and construction
                  programmes. Always work with the structural engineer and concrete supplier to
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Steel is one of the most recyclable materials in existence. It can be melted down
                and reformed into new products <strong>indefinitely</strong> without any loss of
                structural quality. This makes steel a fundamentally{' '}
                <strong>circular material</strong> &mdash; every piece of steel in use today can
                become a new product tomorrow.
              </p>
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <ul className="text-xs sm:text-sm text-white space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>Produces structural sections, plate, and strip</span>
                      </li>
                    </ul>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <ul className="text-xs sm:text-sm text-white space-y-1">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>Can achieve up to 100% recycled content</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>Significantly lower embodied carbon per tonne</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                        <span>Primarily produces reinforcement bar (rebar) and long products</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      and cable management systems. Recycled aluminium is indistinguishable from
                      virgin material in terms of quality and performance.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      properly segregating copper offcuts and waste cable ensures this valuable
                      material enters the recycling stream rather than going to general waste.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Designing for Disassembly:</strong> The
                  recyclability of steel is only fully realised if the steel can be{' '}
                  <strong>recovered</strong> at end of life. Using{' '}
                  <strong>bolted connections</strong> rather than welded joints allows steel members
                  to be unbolted and reused directly, or sent for recycling without the energy cost
                  of cutting. This principle &mdash; <strong>design for disassembly</strong> (DfD)
                  &mdash; is increasingly required on projects targeting high BREEAM ratings and is
                  a key part of circular economy thinking in construction.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Insulation is critical to building energy performance, but the insulation material
                itself has an <strong>embodied carbon footprint</strong>. Choosing the right
                insulation involves balancing thermal performance (how well it insulates per unit
                thickness) against environmental impact (how much carbon was emitted to manufacture
                it). Natural insulation materials are gaining popularity as the industry moves
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <div className="flex justify-between items-start mb-1">
                      <p className="text-sm font-medium text-white">Mineral Wool (Glass / Rock)</p>
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      approximately 1.2&ndash;1.4 kgCO&#8322;e/kg.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <div className="flex justify-between items-start mb-1">
                      <p className="text-sm font-medium text-white">PIR (Polyisocyanurate)</p>
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      Combustible and requires fire protection in many applications.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <div className="flex justify-between items-start mb-1">
                      <p className="text-sm font-medium text-white">EPS (Expanded Polystyrene)</p>
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      recycled in practice due to contamination.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <div className="flex justify-between items-start mb-1">
                      <p className="text-sm font-medium text-white">Sheep Wool</p>
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      approximately 0.9&ndash;1.0 kgCO&#8322;e/kg. Can sequester carbon within the
                      wool fibres.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <div className="flex justify-between items-start mb-1">
                      <p className="text-sm font-medium text-white">Hemp Insulation</p>
                      <span className="text-xs px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">
                        Very low carbon
                      </span>
                    </div>
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      0.6&ndash;1.1 kgCO&#8322;e/kg. Can be carbon negative when sequestration is
                      accounted for.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <div className="flex justify-between items-start mb-1">
                      <p className="text-sm font-medium text-white">Wood Fibre</p>
                      <span className="text-xs px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">
                        Low carbon
                      </span>
                    </div>
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      carbon: approximately 0.8&ndash;1.5 kgCO&#8322;e/kg.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <div className="flex justify-between items-start mb-1">
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      Excellent use of waste material that would otherwise go to landfill.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Performance vs Sustainability:</strong>{' '}
                  Natural insulation materials generally have slightly higher lambda values (lower
                  thermal performance per unit thickness) than synthetic alternatives like PIR. This
                  means you need a thicker build-up to achieve the same U-value. Where space is
                  limited &mdash; for example, in refurbishment projects with constrained cavity
                  widths &mdash; a synthetic insulation may be the only practical option. The key is
                  to <strong>make an informed choice</strong>, weighing thermal performance,
                  embodied carbon, moisture behaviour, fire safety, and cost for each specific
                  application.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Responsible procurement goes beyond choosing materials with low embodied carbon. It
                considers the <strong>entire supply chain</strong> &mdash; from raw material
                extraction through manufacturing, transport, and delivery to site &mdash; and
                examines both environmental and <strong>social</strong> impacts. In the UK
                construction industry, responsible procurement is increasingly mandated on public
                sector projects and is a key assessment criterion under BREEAM.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Organisational governance:</strong> Policies,
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Supply chain management:</strong> Traceability,
                      supplier assessment, stewardship of raw materials
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Environmental aspects:</strong> Energy, water,
                      waste, emissions, biodiversity, transport
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Social aspects:</strong> Health and safety,
                      employment practices, community engagement, stakeholder relations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Ratings:</strong> Pass, Good, Very Good, or
                      Excellent &mdash; higher ratings contribute more BREEAM credits
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Raw material origin:</strong> Where were the
                      raw materials extracted? Were extraction practices legal and environmentally
                      responsible?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Manufacturing conditions:</strong> What are the
                      working conditions in the factory? Is the manufacturer ISO 14001
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Transport and logistics:</strong> How far has
                      the product travelled? What transport modes were used? Can a more local
                      alternative be specified?
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Conflict minerals:</strong> For products
                      containing tin, tantalum, tungsten, or gold (common in electrical components),
                      are there assurances that these are not sourced from conflict zones?
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  vulnerable to modern slavery due to their length, complexity, and reliance on
                  low-cost labour in developing countries. Responsible procurement policies must
                  include due diligence on labour practices throughout the supply chain, and any
                  concerns must be reported and investigated.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  national living wage, prohibit child labour and forced labour, minimise
                  environmental impact, and participate in regular audits. As an electrician or
                  subcontractor, you may be asked to provide evidence of your own supply chain
                  practices as part of pre-qualification questionnaires (PQQs) for larger projects.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/5 border border-emerald-500/30 rounded-xl p-4 sm:p-6 overflow-x-auto">
            <div className="min-w-[600px]">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/10">
                    <th className="text-left py-2 pr-3 text-emerald-400 font-medium">Material</th>
                ...
                <tbody className="divide-y divide-white/5">
                  {[
                    ...
                    <tr key={i}>
                      <td className="py-2 pr-3 text-white font-medium">{row.material}</td>
                      <td className={`py-2 px-2 text-centre ${row.carbonColour}`}>{row.carbon}</td>
                      <td className={`py-2 px-2 text-centre ${row.recycleColour}`}>
                        {row.recycle}
                      </td>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                An <strong>Environmental Product Declaration (EPD)</strong> is a standardised
                document that provides transparent, independently verified data about the
                environmental impact of a product throughout its lifecycle. Think of it as a{' '}
                <strong>nutritional label for building products</strong> &mdash; it tells you
                exactly what the environmental &ldquo;ingredients&rdquo; are, allowing you to
                compare products on an objective, like-for-like basis.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">GWP (Global Warming Potential):</strong>{' '}
                      Measured in kgCO&#8322;e &mdash; this is the embodied carbon figure. The most
                      commonly compared metric. Lower is better.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">ODP (Ozone Depletion Potential):</strong>{' '}
                      Impact on the ozone layer, measured in kg CFC-11 equivalent.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">AP (Acidification Potential):</strong>{' '}
                      Contribution to acid rain, measured in kg SO&#8322; equivalent.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">EP (Eutrophication Potential):</strong>{' '}
                      Nutrient enrichment of water bodies causing algal blooms, measured in kg
                      PO&#8324;&sup3;&minus; equivalent.
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Functional unit:</strong> Always check the
                      declared unit (e.g. per m&sup2;, per tonne, per linear metre) to ensure you
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white">
                  ...
                  <strong className="text-white">E (worst)</strong> based on their environmental
                  impact across 13 categories. It is the reference tool used for BREEAM assessments
                  under the <strong className="text-white">Mat 01</strong> credit and provides a
                  quick way to compare the relative sustainability of different building element
                  specifications (for example, comparing a steel-framed wall with a timber-framed
                  alternative). The guide is available free of charge via the BRE website.
                </p>
              </div>

              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">Practical Tip:</strong> When comparing
                  products for a project, always request EPDs from competing manufacturers. If one
                  manufacturer provides an EPD and another does not, the EPD holder is providing{' '}
                  <strong>verifiable evidence</strong> of their environmental performance &mdash;
                  the other is asking you to take their claims on trust. Increasingly, project
                  specifications are requiring EPDs as a mandatory submission.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-emerald-500/50 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                <strong>62 million tonnes of waste</strong> per year, making it the largest
                waste-producing sector in the country. Much of this waste results from
                over-ordering, poor specification, damage during storage, and demolition rather than
                deconstruction. Even small improvements in material efficiency can deliver
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      of metres of copper on a large project. Tighter specification reduces both
                      cost and waste.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      construction in factory-controlled environments can reduce waste by up to 70%
                      compared to traditional site-built methods.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs sm:text-sm text-white">
                      ...
                      materials becoming obsolete due to design changes.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>Material composition and any hazardous content</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>Embodied carbon data and environmental certifications</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>Expected lifespan and maintenance requirements</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white space-y-2">
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Use <strong className="text-white">bolted</strong> rather than welded steel
                      connections
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Use <strong className="text-white">mechanical fixings</strong> rather than
                      adhesives
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Specify <strong className="text-white">modular panel systems</strong> that can
                      be unclipped and relocated
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Maintain <strong className="text-white">material passports</strong> so
                      composition is known at end of life
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-emerald-400 flex-shrink-0" />
                    <span>
                      Avoid <strong className="text-white">composite materials</strong> that cannot
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      <strong className="text-white">accessible cable routes</strong> and{' '}
                      <strong className="text-white">removable trunking systems</strong> to allow
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-500">The Circular Economy Principle:</strong> The
                  construction industry is moving from a <strong>linear economy</strong> (extract
                  &rarr; make &rarr; use &rarr; dispose) to a <strong>circular economy</strong>{' '}
                  (design &rarr; build &rarr; use &rarr; recover &rarr; reuse). Every material
                  selection decision you make on site contributes to this transition. Specifying
                  recyclable materials, reducing waste, maintaining material records, and designing
                  for disassembly are all practical steps that any electrician or contractor can
                  take today.
                </p>
              </div>
            </div>
          ...
          <div className="bg-white/5 border border-emerald-500/30 rounded-xl p-4 sm:p-6">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {[
                ...
                <div key={gi} className="bg-white/5 border border-white/10 rounded-lg p-4">
                  <p
