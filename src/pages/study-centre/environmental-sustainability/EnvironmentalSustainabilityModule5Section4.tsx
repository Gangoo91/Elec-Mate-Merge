...
const quizQuestions = [
  ...
  {
    id: 3,
    question: 'Which of the following is NOT a requirement of ISO 14001?',
    options: [
  ...
  {
    id: 6,
    question: 'What is a non-conformance in the context of an environmental audit?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>EMS:</strong> Systematic framework for managing environmental impacts
              </li>
              <li>
                <strong>ISO 14001:</strong> International standard with 10 clauses
              </li>
              <li>
                <strong>EMAS:</strong> EU scheme requiring public environmental statement
              </li>
              <li>
                <strong>PDCA:</strong> Plan-Do-Check-Act drives continual improvement
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>ISO 14001:2015:</strong> Environmental management systems
              </li>
              <li>
                <strong>ISO 14004:</strong> General guidelines on implementation
              </li>
              <li>
                <strong>ISO 19011:</strong> Guidelines for auditing management systems
              </li>
              <li>
                <strong>EMAS Regulation:</strong> EC No 1221/2009 (amended)
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="border-l-2 border-emerald-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                that enables an organisation to systematically manage its environmental
                responsibilities. It provides the organisational structure, planning activities,
                responsibilities, practices, procedures, processes, and resources for developing,
                implementing, achieving, reviewing, and maintaining the organisation&rsquo;s
                environmental policy and improving its environmental performance.
              </p>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-white/70">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Identifying environmental aspects</strong> &mdash; understanding all
                      the ways in which the organisation&rsquo;s activities, products, and services
                      interact with the environment, both positively and negatively
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong>Assessing environmental impacts</strong> &mdash; evaluating the
                      significance of those interactions, considering factors such as scale,
                      severity, probability, duration, and reversibility
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong>Setting objectives and targets</strong> &mdash; establishing
                      measurable goals for reducing negative impacts and enhancing positive
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong>Implementing operational controls</strong> &mdash; putting in place
                      procedures, work instructions, and controls to manage significant
                      environmental aspects during normal operations, abnormal conditions, and
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong>Monitoring and measuring performance</strong> &mdash; tracking
                      environmental performance against objectives using key performance indicators
                      (KPIs) and taking corrective action when targets are not being met
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  {[
                    {
                      label: 'PLAN',
                      desc: 'Establish environmental objectives, identify aspects and impacts, determine legal requirements, plan actions to address risks and opportunities, allocate resources',
                    },
                    {
                      label: 'DO',
                      desc: 'Implement the planned actions, establish operational controls, deliver training, establish communication processes, manage documented information',
                    },
                    {
                      label: 'CHECK',
                      desc: 'Monitor and measure performance against objectives, evaluate compliance with legal requirements, conduct internal audits, analyse and evaluate data',
                    },
                    {
                      label: 'ACT',
                      desc: 'Take corrective action on non-conformances, address audit findings, conduct management review, identify opportunities for improvement, update the system',
                    },
                  ].map((item, i) => (
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  reinforces the others: the environmental policy sets the direction, the aspects
                  register identifies what needs managing, the objectives provide measurable
                  targets, the operational controls ensure day-to-day compliance, the monitoring
                  verifies effectiveness, the audits provide independent assurance, and the
                  management review closes the loop by ensuring top management remains engaged and
                  accountable. Without this systematic integration, environmental management becomes
                  fragmented, reactive, and ineffective.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-emerald-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                <strong>ISO 14001:2015</strong> is the internationally recognised standard for
                environmental management systems, published by the International Organisation for
                Standardisation (ISO). It provides a framework that any organisation &mdash;
                regardless of size, sector, or geographical location &mdash; can follow to
                establish, implement, maintain, and continually improve an EMS. The 2015 revision
                introduced significant changes including a stronger emphasis on leadership,
                risk-based thinking, and lifecycle perspective.
              </p>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-emerald-400">
                    The 10 Clauses of ISO 14001:2015
                  </p>
                </div>
                  ...
                  {[
                    {
                      ...
                      desc: 'Defines the scope of the standard and confirms it is applicable to any organisation wishing to establish, implement, maintain, and continually improve an EMS.',
                    },
                    {
                      clause: 'Clause 2 — Normative References',
                      desc: 'States that there are no normative references for ISO 14001:2015 — it is a self-contained standard.',
                    },
                    {
                      clause: 'Clause 3 — Terms and Definitions',
                      desc: 'Defines key terms used throughout the standard, ensuring consistent interpretation.',
                    },
                    {
                      clause: 'Clause 4 — Context of the Organisation',
                      desc: 'Requires the organisation to understand its context (internal and external issues), the needs and expectations of interested parties, and to determine the scope of the EMS.',
                    },
                    {
                      clause: 'Clause 5 — Leadership',
                      desc: 'Requires top management to demonstrate leadership and commitment, establish the environmental policy, and assign roles, responsibilities, and authorities.',
                    },
                    {
                      clause: 'Clause 6 — Planning',
                      desc: 'Addresses actions to address risks and opportunities, environmental aspects and impacts identification, compliance obligations, environmental objectives, and planning to achieve them.',
                    },
                    {
                      clause: 'Clause 7 — Support',
                      desc: 'Covers resources, competence, awareness, communication (internal and external), and documented information (the documents and records the EMS requires).',
                    },
                    {
                      clause: 'Clause 8 — Operation',
                      desc: 'Addresses operational planning and control, including management of processes consistent with a lifecycle perspective, and emergency preparedness and response.',
                    },
                    {
                      clause: 'Clause 9 — Performance Evaluation',
                      desc: 'Covers monitoring, measurement, analysis, and evaluation; compliance evaluation; internal audit; and management review.',
                    },
                    {
                      clause: 'Clause 10 — Improvement',
                      desc: 'Addresses non-conformity and corrective action, and continual improvement of the EMS.',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-white/5 border border-white/10 rounded-lg p-3">
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  safety), and ISO 50001 (energy). The HLS uses the same clause numbering, core
                  text, and common terms and definitions across all these standards. This makes it
                  significantly easier for organisations to integrate multiple management systems
                  into a single Integrated Management System (IMS), avoiding duplication of effort
                  and ensuring a coherent approach to management across quality, environment, health
        ...
        <section className="mb-10">
          <div className="border-l-2 border-emerald-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Whilst all ten clauses of ISO 14001 are important, several key requirements form the
                operational backbone of the standard. These are the elements that auditors will
                examine most closely, and they are the areas where organisations must demonstrate
                robust implementation to achieve and maintain certification.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      environment (including prevention of pollution), include a commitment to
                      fulfil compliance obligations, and include a commitment to continual
                      improvement. The policy must be documented, communicated within the
                      organisation, and available to interested parties (including the public). It
                      is not a generic statement &mdash; it must reflect the specific environmental
                      context and significant aspects of the organisation.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      documented in an <strong>aspects and impacts register</strong>. For each
                      aspect, the register records: the activity or process, the aspect itself, the
                      associated impact(s), the conditions (normal, abnormal, emergency), the
                      significance assessment, and the controls in place. Significance is typically
                      assessed using a scoring methodology that considers factors such as scale,
                      severity, probability, duration, reversibility, and the existence of legal
                      requirements.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      Permitting Regulations 2016, Hazardous Waste Regulations 2005), industry codes
                      of practice, contractual requirements, and any voluntary commitments. The
                      legal compliance register must be maintained and kept up to date as
                      legislation changes. The organisation must periodically evaluate compliance
                      with these obligations and maintain documented evidence of the evaluation
                      results.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      appropriate. For each objective, the organisation must determine what will be
                      done, what resources will be required, who will be responsible, when it will
                      be completed, and how the results will be evaluated. Targets are the specific,
                      quantified performance requirements that support the achievement of objectives
                      &mdash; for example, &ldquo;reduce skip waste to landfill by 25% by December
                      2026.&rdquo;
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      environmental impacts. Examples include: waste segregation procedures, spill
                      response kits and procedures, dust suppression measures, noise management
                      plans, energy management procedures, and procurement specifications for
                      environmentally preferable materials. Controls must also address operations
                      carried out by contractors and suppliers that can influence the
                      organisation&rsquo;s environmental performance.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      discharges to watercourses, fire (and the environmental impact of
                      fire-fighting water run-off), and failure of pollution prevention
                      infrastructure. Emergency procedures must be established, tested periodically
                      (through drills and exercises), and revised based on lessons learned.
                      Equipment such as spill kits, bunds, and absorbent materials must be
        ...
        <section className="mb-10">
          <div className="border-l-2 border-emerald-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The <strong>Eco-Management and Audit Scheme (EMAS)</strong> is a voluntary
                environmental management instrument developed by the European Commission. It was
                first established in 1993 and has been revised several times, most recently under
                Regulation (EC) No 1221/2009 (as amended). EMAS builds upon ISO 14001 but adds
                additional requirements that make it a more demanding &mdash; and in many respects
                more rigorous &mdash; scheme.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      its activities, the environmental policy, a description of all significant
                      environmental aspects, a summary of quantitative data on environmental
                      performance (including core indicators for energy efficiency, material
                      efficiency, water usage, waste generation, biodiversity, and emissions),
                      objectives and targets, and a declaration of legal compliance. The statement
                      must be validated by an accredited EMAS environmental verifier. ISO 14001 has
                      no equivalent public disclosure requirement.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      commitment to compliance and periodic compliance evaluation, but does not
                      require demonstrated full compliance as a condition of certification. This
                      distinction is important &mdash; an organisation can be certified to ISO 14001
                      whilst having minor compliance gaps that it is actively working to close,
                      whereas EMAS registration requires those gaps to be closed before registration
                      is granted.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      environmental aspects, the development of objectives and targets, and the
                      improvement of environmental performance. This participatory approach
                      recognises that the people doing the work are often best placed to identify
                      practical improvements and that engagement increases the likelihood of
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      (total energy consumption and proportion from renewables), material efficiency
                      (annual mass-flow of key materials), water (total annual water consumption),
                      waste (total annual generation by type and disposal route), biodiversity (land
                      use in terms of built-up area), and emissions (total annual greenhouse gas
                      emissions and total annual emissions to air). ISO 14001 does not prescribe
                      specific indicators.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  environmental regulatory framework, and organisations that previously held EMAS
                  registration may choose to transition to ISO 14001 or maintain EMAS through an
                  EU-based subsidiary. For UK electrical contractors, ISO 14001 remains the most
                  relevant and widely recognised EMS standard. Some international clients and
                  projects may still reference EMAS, so understanding it remains professionally
                  valuable.
                </p>
              </div>
            </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-emerald-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Implementing an EMS on a construction site requires a practical, structured
                approach. The system must be proportionate to the scale and complexity of the
                project, relevant to the actual environmental risks, and integrated into the
                day-to-day management of the site rather than existing as a separate administrative
                burden. The following steps outline the implementation process.
              </p>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      through construction to demobilisation. For an electrical contractor, typical
                      aspects include: energy consumption (site accommodation, power tools,
                      temporary lighting), waste generation (cable off-cuts, packaging, redundant
                      equipment, excavation spoil), use of hazardous substances (solvents, flux, PVC
                      adhesive, cable-pulling lubricant), emissions from generators and vehicles,
                      noise from power tools and generators, dust from chasing and drilling, and
                      water use for testing, cleaning, and dust suppression.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      considers: the scale of the impact (how large an area or volume is affected),
                      the severity (how damaging the impact is), the probability of occurrence (how
                      likely it is to happen), the duration (how long the impact persists), the
                      reversibility (whether the impact can be undone), whether legal requirements
                      apply, and stakeholder concern (whether the aspect is of particular concern to
                      neighbours, regulators, or clients). Aspects that score above a defined
                      threshold are classified as &ldquo;significant&rdquo; and must have specific
                      objectives, targets, and operational controls assigned to them.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      project: &ldquo;Achieve 95% diversion of waste from landfill by project
                      completion,&rdquo; &ldquo;Reduce energy consumption in site accommodation by
                      15% compared to the previous project,&rdquo; &ldquo;Zero environmental
                      incidents resulting in enforcement action.&rdquo; Targets break these
                      objectives into actionable steps with assigned responsibilities and deadlines.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      includes: the purpose (why the procedure exists), the scope (what activities
                      it covers), the responsibilities (who does what), the method (step-by-step
                      instructions), the records (what must be documented), and the emergency
                      response (what to do if something goes wrong). Procedures should be displayed
                      in relevant locations &mdash; for example, waste segregation instructions at
                      the waste compound, spill response procedures near fuel and chemical storage
                      areas.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      environmental aspects relevant to their activities, the procedures they must
                      follow, the consequences of departure from procedures (both environmental and
                      disciplinary), and how to report environmental incidents and concerns.
                      Supervisors and managers require more detailed training on the EMS, their
                      specific responsibilities, monitoring requirements, and incident investigation
                      procedures. Training records must be maintained as documented evidence.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      procedures, training records, monitoring and measurement records, audit
                      reports, management review minutes, and records of incidents and corrective
                      actions. Documentation should be proportionate &mdash; ISO 14001:2015
                      deliberately avoids prescribing specific documents, allowing organisations
                      flexibility. The emphasis is on having the documented information necessary to
                      ensure the system is effective, not on creating paperwork for its own sake.
                      Electronic systems are preferred over paper-based systems for ease of
                      updating, accessibility, and searchability.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-emerald-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Environmental auditing is a critical component of any EMS. Audits provide
                systematic, independent, and documented assessment of whether the EMS is being
                implemented effectively, whether it conforms to the requirements of the standard,
                and whether it is achieving the desired environmental outcomes. There are two main
                types of environmental audit: <strong>internal audits</strong> (conducted by the
                organisation itself) and <strong>external audits</strong> (conducted by an
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-white/70">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong>Audit programme</strong> &mdash; the organisation must establish an
                      audit programme that defines the frequency, methods, responsibilities, and
                      reporting requirements. The programme should ensure all elements of the EMS
                      are audited within a defined cycle (typically 12 months), with more frequent
                      auditing of high-risk areas or areas with a history of non-conformance
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong>Auditor competence</strong> &mdash; internal auditors must be
                      competent and impartial. They should not audit their own work. Auditor
                      training (typically to ISO 19011 standard) ensures they understand audit
                      principles, techniques, and reporting requirements. Many organisations train
                      multiple internal auditors so that audits can be conducted by someone
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong>Audit planning</strong> &mdash; each individual audit should be
                      planned in advance, with a defined scope, criteria, and schedule. The audit
                      plan should be communicated to the auditee so that relevant personnel and
                      documentation are available. An opening meeting sets expectations and a
                      closing meeting presents preliminary findings
                    </span>
                  </li>
                </ul>
              </div>
                ...
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      understanding of the requirements, and identifies any areas of concern that
                      need to be addressed before the Stage 2 audit. The Stage 1 audit may be
                      conducted off-site or on-site.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    <p className="text-sm font-medium text-white mb-1">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      processes, review of records and documented evidence, and verification that
                      the EMS is achieving its intended outcomes. This is the audit that determines
                      whether certification is granted.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  {[
                    {
                      ...
                      desc: 'A systematic failure or absence of a required element that significantly undermines the EMS. Examples: no environmental policy, no aspects register, no internal audit programme, systematic failure to monitor legal compliance. A major NC will prevent initial certification or may trigger suspension of an existing certificate.',
                    },
                    {
                      label: 'Minor Non-Conformance',
                      desc: 'An isolated lapse or partial failure that does not undermine the system as a whole. Examples: a single training record missing, one monitoring reading not recorded, a procedure not updated after a minor change. Minor NCs require corrective action but do not prevent certification.',
                    },
                    {
                      label: 'Corrective Action Process',
                    ...
                    },
                    {
                      ...
                      desc: 'Audit findings (both internal and external) must be reported to top management as an input to the management review process. This ensures that management is aware of system performance, non-conformances, and improvement opportunities, and can allocate resources and set priorities accordingly.',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-white/5 border border-white/10 rounded-lg p-3">
        ...
        <section className="mb-10">
          <div className="border-l-2 border-emerald-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Continual improvement is the fundamental purpose of an EMS. It is not about
                achieving perfection &mdash; it is about consistently and systematically enhancing
                environmental performance over time. ISO 14001 requires the organisation to
                continually improve the suitability, adequacy, and effectiveness of the EMS to
                enhance environmental performance. This section examines the tools and mechanisms
                  ...
                  {[
                    {
                      ...
                      desc: 'Percentage of total waste diverted from landfill through recycling, recovery, or reuse. Industry target: 90%+ diversion from landfill.',
                    },
                    {
                      label: 'Energy intensity',
                      desc: 'Energy consumption per unit of output (e.g., kWh per £100k turnover, or kWh per m² of installation area). Tracks efficiency rather than just volume.',
                    },
                    {
                      label: 'Carbon emissions',
                      desc: 'Total CO₂ equivalent emissions (Scope 1, 2, and where practical Scope 3). Increasingly required by clients and frameworks.',
                    },
                    {
                      label: 'Water consumption',
                      desc: 'Total water usage per project or per unit of activity. Especially important in water-stressed areas or for activities requiring significant water use.',
                    },
                    {
                      label: 'Environmental incidents',
                      desc: 'Number and severity of environmental incidents (spills, pollution events, complaints). Target: zero incidents requiring regulatory notification.',
                    },
                    {
                      label: 'Legal compliance',
                      desc: 'Percentage compliance score from compliance evaluations. Target: 100% compliance with all applicable environmental legislation.',
                    },
                  ].map((item, i) => (
                    <div key={i} className="bg-white/5 border border-white/10 rounded-lg p-3">
                      <p className="text-sm font-medium text-white">{item.label}</p>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 sm:p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-white/70">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong>Internal benchmarking</strong> &mdash; comparing performance between
                      different projects, sites, or time periods within the same organisation. This
                      identifies best practice and underperformance within the organisation&rsquo;s
                      own operations
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong>External benchmarking</strong> &mdash; comparing performance against
                      industry averages, sector leaders, or published standards. Sources include
                      WRAP (Waste and Resources Action Programme), CIRIA (Construction Industry
                      Research and Information Association), and BRE (Building Research
                      Establishment)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong>Client benchmarking</strong> &mdash; many clients publish
                      environmental performance expectations or targets. Meeting or exceeding these
                      benchmarks strengthens the commercial relationship and supports future tender
                      submissions
                    </span>
                  </li>
                </ul>
                ...
                <div className="grid sm:grid-cols-2 gap-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      met, environmental performance data including KPI trends, the status of
                      corrective actions, audit results (internal and external), compliance
                      evaluation results, communications from interested parties (including
                      complaints), and opportunities for continual improvement.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      objectives, and other elements), actions needed when objectives have not been
                      met, opportunities to improve integration of the EMS with other business
                      processes, and any implications for the strategic direction of the
                      organisation.
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <p className="text-sm text-white/80">
                  ...
                  incident should be investigated to determine its root cause (not just the
                  immediate cause), and the findings should be used to improve the EMS. Near-miss
                  reporting is particularly valuable because it provides insight into system
                  weaknesses before they result in actual harm. An organisation that actively
                  encourages near-miss reporting and learns from every incident will improve more
                  quickly than one that only reacts to serious events.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-10">
          <div className="border-l-2 border-emerald-500/30 pl-4 sm:pl-6">
            ...
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                Whilst the environmental benefits of an EMS are self-evident, the practical business
                benefits are equally compelling. For electrical contractors operating in an
                increasingly competitive and environmentally conscious market, EMS certification
                delivers tangible commercial, legal, and operational advantages.
              </p>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 sm:p-6 rounded-lg">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-sm font-medium text-emerald-400">
                    Business Benefits of EMS Certification
                  </p>
                </div>
                <div className="space-y-3">
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      organisations are excluded from the tender process entirely, regardless of
                      price or technical competence. Certification opens doors to contracts that
                      would otherwise be inaccessible. Major frameworks such as Procure
                      Partnerships, Pagabo, Crown Commercial Service, and NHS Shared Business
                      Services all include environmental management requirements in their
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      14001 certification, or as a broader requirement to provide evidence of a
                      functioning EMS. Even where certification is not mandated, having it
                      demonstrates a level of environmental management maturity that gives clients
                      confidence in the subcontractor&rsquo;s ability to manage environmental risks
                      on their projects.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      periodic compliance evaluation process verifies that those laws are being met.
                      This significantly reduces the risk of inadvertent non-compliance, which can
                      result in Environment Agency enforcement notices, prosecution, unlimited fines
                      (under the Environmental Permitting Regulations 2016), and criminal records
                      for responsible individuals. The &ldquo;due diligence&rdquo; defence is
                      strengthened by evidence of a systematic approach to compliance management.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      (currently &pound;103.70 per tonne for standard rated waste). Energy
                      efficiency: systematic monitoring typically yields 10&ndash;20% energy cost
                      savings through identification of inefficiencies and behaviour change.
                      Material efficiency: tracking material usage reduces over-ordering and
                      wastage. These savings are recurring and cumulative, typically delivering a
                      payback period of 12&ndash;24 months on the EMS implementation investment.
                    </p>
                  </div>
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      planning objections, and insurance claims. Each of these risks carries
                      significant financial and reputational consequences. A pollution incident
                      requiring clean-up can cost tens or hundreds of thousands of pounds, and a
                      prosecution can result in unlimited fines plus the costs of legal defence. The
                      EMS provides a structured approach to identifying and controlling these risks
                  ...
                  <div className="bg-white/5 border border-white/10 rounded-lg p-3">
                    ...
                    <p className="text-xs text-white/70 leading-relaxed">
                      ...
                      seriously. This strengthens the organisation&rsquo;s reputation,
                      differentiates it from competitors who lack certification, supports bids for
                      environmentally sensitive projects, attracts environmentally conscious
                      employees (particularly younger workers entering the industry), and
                      demonstrates corporate social responsibility. In a market where technical
                      competence and price are often similar between competitors, environmental
                      credentials can be the differentiating factor that wins contracts.
                    </p>
                  </div>
                </div>
              </div>
              ...
              {[
                {
                  ...
                  desc: 'Baseline assessment of current environmental performance, legal compliance status, and existing practices',
                  icon: Search,
                },
                {
                  step: '2',
                  title: 'Environmental Policy',
                  desc: 'Top management commits to protection of the environment, compliance, and continual improvement',
                  icon: FileText,
                },
                {
                  step: '3',
                  title: 'Aspects & Impacts Identification',
                  desc: 'Systematic identification of all environmental aspects and assessment of their significance',
                  icon: ClipboardList,
                },
                {
                  step: '4',
                  title: 'Legal Compliance Register',
                  desc: 'Identify all applicable environmental legislation and establish a compliance evaluation process',
                  icon: ShieldCheck,
                },
                {
                  step: '5',
                  title: 'Objectives, Targets & Programmes',
                  desc: 'Set measurable environmental objectives with action plans, responsibilities, and timescales',
                  icon: Target,
                },
                {
                  step: '6',
                  title: 'Operational Controls & Procedures',
                  desc: 'Develop and implement procedures for managing significant aspects during all conditions',
                  icon: Building,
                },
                {
                  step: '7',
                  title: 'Training & Awareness',
                  desc: 'Ensure all personnel are competent and aware of their environmental responsibilities',
                  icon: BookOpen,
                },
                {
                  step: '8',
                  title: 'Monitoring, Auditing & Review',
                  desc: 'Track KPIs, conduct audits, evaluate compliance, and review the system at management level',
                  icon: BarChart3,
                },
              ].map((item, i) => (
                <div key={i}>
