...
const quizQuestions = [
  ...
  {
    id: 4,
    question: 'What does Section 85 of the Water Resources Act 1991 make it an offence to do?',
    options: [
      ...
      <article className="px-4 sm:px-6 lg:px-8 py-8 sm:py-12 max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>8 key pieces</strong> of legislation covering pollution, waste, water, air,
                wildlife, and hazardous materials
              </li>
              <li>
                <strong>Environment Act 2021:</strong> post-Brexit framework with binding targets
                and new watchdog (OEP)
              </li>
              <li>
                <strong>Penalties:</strong> unlimited fines and up to 5 years imprisonment for
                serious offences
              </li>
            </ul>
          </div>
          <div className="p-4 rounded-lg bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-base text-white space-y-1.5">
              <li>
                <strong>Polluter pays:</strong> those who cause pollution bear the cost of managing
                it
              </li>
              <li>
              ...
              <li>
                <strong>Precautionary principle:</strong> act to prevent harm even without full
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Environmental Protection Act 1990 (EPA 1990) is one of the most important pieces
                of environmental legislation in the United Kingdom. It established the fundamental
                framework for pollution control and waste management in England, Scotland, and
                Wales. The Act was a landmark statute that consolidated and strengthened previous
                environmental controls, and it remains in force today — although many of its
                provisions have been amended by subsequent legislation including the Environment Act
                1995 and the Environment Act 2021.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-2">
                  <p>
                    ...
                    processes&rdquo; (such as chemical works, power stations, waste incinerators,
                    and large industrial installations) were required to obtain authorisation from
                    the relevant regulator before commencing operations. The system required
                  ...
                  <p>
                    ...
                    Wales) Regulations 2016 for installations in England and Wales, which
                    implemented the EU Industrial Emissions Directive. However, the principle of
                    integrated pollution prevention and control that Part I established remains the
                    foundation of the modern environmental permitting regime.
                  </p>
                </div>
              </div>
                ...
                <div className="text-sm text-white/80 space-y-2">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong className="text-white">
                          Section 33 — Prohibition on unauthorised depositing of waste:
                        </strong>{' '}
                        It is an offence to deposit controlled waste, or knowingly cause or
                        knowingly permit controlled waste to be deposited, in or on any land unless
                        a waste management licence or environmental permit authorises the deposit.
                        This section targets fly-tipping and unauthorised waste disposal. The
                        maximum penalty on indictment is an unlimited fine and/or five years
                        imprisonment
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Section 34 — Duty of care:</strong> This
                        imposes a duty of care on anyone who imports, produces, carries, keeps,
                        ...
                        harmful deposit, treatment, or disposal of waste; prevent the escape of
                        waste from their control; ensure that waste is transferred only to an
                        authorised person; and ensure that a written description of the waste
                        accompanies it on transfer (a waste transfer note). Breach of the duty of
                        care carries an unlimited fine
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        ...
                        Introduced by the Clean Neighbourhoods and Environment Act 2005, this
                        section allows enforcement officers to issue fixed penalty notices for
                        breaches of the duty of care, particularly for the failure to produce waste
                        transfer notes on demand. The fixed penalty amount is 300 pounds
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="text-sm text-white/80 space-y-2">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        Dust, steam, smell, or other effluvia arising on industrial, trade, or
                        business premises
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        Noise emitted from premises or from vehicles, machinery, or equipment in a
                        street
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                  ...
                  <p>
                    When a local authority is satisfied that a statutory nuisance exists, it must
                    serve an <strong className="text-white">abatement notice</strong> under Section
                    80, requiring the responsible person to abate the nuisance and/or prohibit its
                    recurrence. Failure to comply with an abatement notice is a criminal offence,
                    carrying a fine of up to 20,000 pounds for industrial, trade, or business
                    premises (5,000 pounds for other premises). Construction site noise is one of
                    the most common triggers for statutory nuisance complaints.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  (cable offcuts, packaging, old components, fluorescent tubes, batteries), you are
                  a waste producer and the duty of care under Section 34 applies to you. You must
                  ensure waste is described accurately, stored securely, and handed over only to a
                  registered waste carrier with the correct documentation. If waste from your work
                  ends up being fly-tipped because you failed to check the carrier&rsquo;s
                  credentials, you could face prosecution under both Section 33 and Section 34.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-emerald-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                governance framework following the United Kingdom&rsquo;s departure from the
                European Union, ensuring that environmental standards would not be weakened in the
                absence of EU oversight mechanisms.
              </p>
                ...
                <div className="text-sm text-white/80 space-y-2">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        Scrutinise and advise on the implementation of environmental law by
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        Receive and investigate complaints from members of the public about failures
                        by public authorities to comply with environmental law
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        Issue information notices requiring public authorities to provide
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        Issue decision notices setting out its findings and recommendations
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        Take enforcement action through the courts, including applying for judicial
                ...
                <div className="text-sm text-white/80 space-y-2">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Air quality</strong> — including a target for
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Water</strong> — targets for the ecological
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Biodiversity</strong> — including halting
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        — including reducing residual waste per capita
                      </span>
                    </li>
                  </ul>
                  <p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-2">
                  <p>
                    ...
                    biodiversity value of a site must exceed its pre-development value by at least
                    10%, as measured using the statutory biodiversity metric (currently Metric 4.0).
                  </p>
                  <p>
                    The requirement became mandatory for major developments (10 or more dwellings or
                    0.5 hectares or more) from{' '}
                    <strong className="text-white">12 February 2024</strong> and for smaller
                    developments from <strong className="text-white">2 April 2024</strong>.
                    Developers must submit a biodiversity gain plan as part of the planning
                    application and can achieve net gain through on-site habitat creation, off-site
                    habitat creation, or purchasing statutory biodiversity credits from the
                    government.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-2">
                  <p>
                    ...
                    schemes, requiring producers of products and packaging to bear the full net cost
                    of managing those products at end of life. The first EPR scheme for packaging
                    came into force in 2024, making producers financially responsible for the
                    collection, sorting, and recycling or disposal of their packaging waste.
                  </p>
                  <p>
                    The Act also provides powers to introduce{' '}
                    <strong className="text-white">deposit return schemes (DRS)</strong> for drinks
                    containers. Under a DRS, consumers pay a small deposit when purchasing a drink
                    in a single-use container and receive the deposit back when they return the
                    empty container for recycling.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">Construction Impact:</strong> The
                  biodiversity net gain requirement directly affects every construction project
                  ...
                  (including cable trenching) can take place, particularly during bird nesting
                  season (March to August) or where protected species such as great crested newts or
          ...
          <div className="border-l-2 border-emerald-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                forced the government to act. The 1993 Act remains the principal legislation for
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong className="text-white">Dark smoke offences (Sections 1-2):</strong> It
                      is an offence to emit dark smoke from a chimney of any building (Section 1) or
                      from any industrial or trade premises (Section 2). Dark smoke is defined by
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      emit smoke from a chimney unless an authorised fuel is being burned or an
                      exempt appliance is being used. The penalty is a fine of up to 1,000 pounds.
                      There are currently over 100 smoke control areas across England covering the
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Chimney height controls (Sections 14-15):
                      </strong>{' '}
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Grit and dust from furnaces (Sections 5-12):
                      </strong>{' '}
                      ...
                      equipment to arrest grit and dust as far as practicable. The Secretary of
                      State can set limits on the rate of emission of grit and dust
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-2">
                  <p>
                    ...
                    The burning of waste materials on construction sites can constitute a dark smoke
          ...
          <div className="border-l-2 border-emerald-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                Water Industry Act regulates the water and sewerage industry, including the
                discharge of trade effluent into public sewers.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong className="text-white">Section 24 — Water abstraction:</strong> It is
                      an offence to abstract water from any source of supply (river, stream, lake,
                      underground strata) without an abstraction licence granted by the Environment
                      Agency, unless an exemption applies. Exemptions include abstractions of less
                      than 20 cubic metres per day from surface water for certain purposes.
                      Dewatering of construction excavations (pumping out groundwater to keep
                      excavations dry) may require an abstraction licence if the volume exceeds the
                      exempt thresholds
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">
                        Section 85 — Principal water pollution offence:
                      </strong>{' '}
                      ...
                      &ldquo;Controlled waters&rdquo; is defined in Section 104 and includes
                      relevant territorial waters (extending to three nautical miles from the
                      coast), coastal waters, inland freshwaters (rivers, streams, watercourses,
                      lakes, ponds, and reservoirs), and groundwater (water in underground strata).
                      The maximum penalty on indictment is an unlimited fine and/or five years
                      imprisonment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong className="text-white">Discharge consents:</strong> Any person who
                      wishes to discharge trade effluent or sewage effluent into controlled waters
                      must obtain a discharge consent (now an environmental permit under the
                      Environmental Permitting Regulations 2016) from the Environment Agency. The
                      permit specifies conditions including the volume, composition, and temperature
                      of the discharge
                    </span>
                  </li>
                </ul>
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      ...
                      alkaline (pH 11-13) and toxic to aquatic life. A single cement washout can
                      kill fish for several kilometres downstream
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-red-400" />
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-2">
                  <p>
                    ...
                    as any liquid that is wholly or partly produced in the course of any trade or
                    industry carried on at trade premises. Discharging trade effluent into a public
                    sewer without the consent of the sewerage undertaker (water company) is a
                    criminal offence under Section 118.
                  </p>
                  <p>
                    A trade effluent consent specifies conditions including the maximum daily
                    volume, the maximum rate of discharge, the composition and temperature of the
                    effluent, and the sewer into which the discharge is made. On construction sites,
                    any discharge to the public sewer that is not purely domestic sewage may be
                    classified as trade effluent and require consent — this can include contaminated
                    groundwater from dewatering operations, process water from concrete batching, or
                    water used in pressure testing of pipework.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="border-l-2 border-emerald-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                The Wildlife and Countryside Act 1981 (WCA 1981) is the principal legislation for
                the protection of wildlife, habitats, and the countryside in England and Wales. It
                implements the requirements of the European Birds Directive (79/409/EEC) and the
                Bern Convention on the Conservation of European Wildlife and Natural Habitats.
                Despite the United Kingdom&rsquo;s departure from the European Union, the
                protections provided by the WCA 1981 remain in force and have been retained in
                domestic law.
              </p>
                ...
                <div className="text-sm text-white/80 space-y-2">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Section 1 — Wild birds:</strong> It is an
                        offence to intentionally kill, injure, or take any wild bird; to
                        intentionally take, damage, or destroy the nest of any wild bird while it is
                        in use or being built; or to intentionally take or destroy an egg of any
                        wild bird. Schedule 1 lists species receiving additional protection, making
                        it an offence to intentionally or recklessly disturb them at or near the
                        nest
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        intentionally kill, injure, or take any Schedule 5 animal; to intentionally
                        or recklessly damage, destroy, or obstruct access to any structure or place
                        used by a Schedule 5 animal for shelter or protection; or to intentionally
                        or recklessly disturb such an animal while it is occupying such a structure.
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-2">
                  <p>
                    ...
                    . Natural England (in England) or Natural Resources Wales (in Wales) can notify
                    land as an SSSI where it is of special interest by reason of its flora, fauna,
                ...
                <div className="text-sm text-white/80 space-y-2">
                  ...
                  <ul className="space-y-1">
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-red-400" />
                      <span>
                        <strong className="text-white">Bat roosts:</strong> all bat species and
                        their roosts are protected. A bat roost is protected whether or not bats are
                        present. Demolition, renovation, re-roofing, or any work that might disturb
                        a bat roost requires a European Protected Species licence from Natural
                        England
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-red-400" />
                      <span>
                        <strong className="text-white">Great crested newts:</strong> found across
                        England, particularly in ponds and surrounding terrestrial habitat.
                        Development within 500 metres of a great crested newt pond may require
                        survey, licensing, and mitigation. District Level Licensing schemes now
                        offer a strategic alternative in some areas
                      </span>
                    </li>
                  </ul>
                  <p>
                    ...
                    offences involving Schedule 5 animals, the court can impose a fine of up to
                    5,000 pounds per specimen and/or six months imprisonment.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="border-l-2 border-emerald-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                of Waste in relation to hazardous waste. They establish a system for tracking
                hazardous waste from the point of production (the &ldquo;cradle&rdquo;) to the point
                of final disposal or recovery (the &ldquo;grave&rdquo;), ensuring that hazardous
                waste is properly managed at every stage.
              </p>
                ...
                <div className="text-sm text-white/80 space-y-2">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">HP1 Explosive</strong> — waste capable of
                        producing gas at such a temperature, pressure, and speed as to cause damage
                        to surroundings
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">HP3 Flammable</strong> — flammable liquid,
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">HP6 Acute toxicity</strong> — waste that can
                        cause acute toxic effects following oral, dermal, or inhalation exposure
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">HP7 Carcinogenic</strong> — waste that
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">HP14 Ecotoxic</strong> — waste that presents
                        or may present immediate or delayed risks to the environment
                      </span>
                    </li>
                  </ul>
                  <p>
                    The <strong className="text-white">European Waste Catalogue (EWC)</strong>{' '}
                    assigns a six-digit code to each type of waste. Entries marked with an asterisk
                    (*) are classified as hazardous. For example, 17 06 01* is insulation materials
                    containing asbestos, and 20 01 21* is fluorescent tubes and other
                    mercury-containing waste. Some entries are &ldquo;mirror entries&rdquo; — the
                    same waste type may be classified as hazardous or non-hazardous depending on the
                ...
                <div className="text-sm text-white/80 space-y-2">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        A unique consignment note code in the format prescribed by the regulations
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        A full description of the waste including the EWC code, the quantity, the
                        physical form (solid, liquid, sludge, powder, mixed, gas), and the hazardous
                        properties
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        Details of the registered waste carrier (name, registration number)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        Details of the receiving facility (consignee) including their environmental
                        permit number
                      </span>
                    </li>
                  </ul>
                  <p>
                    ...
                    and consignee. Failure to complete consignment notes correctly, or to retain
                    them for the required period, is a criminal offence.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-2">
                  <p>
                    ...
                    asbestos waste, waste oils, lead paint debris, solvent containers, and
                    fluorescent tubes must all be segregated from each other and from general
                    construction waste.
                  </p>
                  <p>
                    <strong className="text-white">Premises registration:</strong> Premises that
                    produce or hold hazardous waste no longer need to register with the Environment
                    Agency as a result of amendments made in 2009. However, producers must still
                    comply with all other requirements including the duty to classify waste
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">For Electricians:</strong> Common hazardous
                  wastes produced by electrical work include fluorescent tubes and other
                  mercury-containing lamps (EWC 20 01 21*), batteries containing lead,
                  nickel-cadmium, or mercury (EWC 16 06 01*, 16 06 02*, 16 06 03*), waste oils from
                  transformers and switchgear (EWC 13 03 01*), asbestos-containing materials
                  encountered during rewiring of older buildings (EWC 17 06 01* and 17 06 05*), and
                  waste electrical and electronic equipment containing hazardous components (EWC 16
                  02 11* to 16 02 13*). All of these must be segregated, described accurately on
                  consignment notes, and sent to appropriately licensed facilities.
                </p>
              </div>
            </div>
          </div>
                ...
                {[
                  {
                    ...
                    desc: 'First clean air legislation following the Great Smog of London (1952). Introduced smoke control areas.',
                  },
                  {
                    year: '1974',
                    title: 'Control of Pollution Act 1974',
                    desc: 'Early framework for waste disposal, water pollution, noise, and atmospheric pollution.',
                  },
                  {
                    year: '1981',
                    title: 'Wildlife & Countryside Act 1981',
                    desc: 'Principal wildlife protection statute. Protected species, SSSIs, habitat conservation.',
                  },
                  {
                    year: '1990',
                    title: 'Environmental Protection Act 1990',
                    desc: 'Landmark statute — IPC, waste management licensing, duty of care, statutory nuisances.',
                  },
                  {
                    year: '1991',
                    title: 'Water Resources Act 1991',
                    desc: 'Water abstraction licensing, Section 85 pollution offence, discharge consents.',
                  },
                  {
                    year: '1993',
                    title: 'Clean Air Act 1993',
                    desc: 'Consolidation of 1956 and 1968 Acts. Dark smoke offences, smoke control areas, chimney heights.',
                  },
                  {
                    year: '1995',
                    title: 'Environment Act 1995',
                    desc: 'Created the Environment Agency and Scottish Environment Protection Agency (SEPA).',
                  },
                  {
                    year: '2005',
                    title: 'Hazardous Waste Regulations 2005',
                    desc: 'Consignment note system, mixing prohibition, cradle-to-grave tracking of hazardous waste.',
                  },
                  {
                    year: '2015',
                    title: 'CDM Regulations 2015',
                    desc: 'Construction safety regulations with environmental overlap — pre-construction information, design considerations.',
                  },
                  {
                    year: '2016',
                    title: 'Environmental Permitting Regulations 2016',
                    desc: 'Single permitting framework for waste operations, water discharge, and industrial emissions.',
                  },
                  {
                    year: '2021',
                    title: 'Environment Act 2021',
                    desc: 'Post-Brexit framework. OEP, legally binding targets, biodiversity net gain, extended producer responsibility.',
                  },
                ].map((item, i) => (
          ...
          <div className="border-l-2 border-emerald-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                regulated activities. They replaced the previous separate regimes for waste
                management licensing (under the EPA 1990), pollution prevention and control (under
                the Pollution Prevention and Control Act 1999), water discharge consents (under the
                Water Resources Act 1991), and groundwater authorisations. The intention was to
                reduce administrative burden while maintaining or improving environmental
                protection.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-sm text-white/80 space-y-2">
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong className="text-white">Waste operations:</strong> the storage,
                      treatment, recovery, and disposal of waste (including waste transfer stations,
                      materials recovery facilities, composting sites, landfill sites, and waste
                      incineration plants)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                  ...
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong className="text-white">Groundwater activities:</strong> discharging
                      polluting substances to groundwater or carrying out activities that might lead
                      to the input of polluting substances to groundwater
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong className="text-white">Installations:</strong> industrial activities
                      listed in Schedule 1, including energy production, metals processing, minerals
                      processing, chemicals manufacturing, waste management, and certain other
                      activities (implementing the Industrial Emissions Directive)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                    <span>
                      <strong className="text-white">Radioactive substances activities:</strong> the
                      keeping and use of radioactive substances and the accumulation and disposal of
                      radioactive waste
                    </span>
                  </li>
                </ul>
                    ...
                    <div className="bg-emerald-500/5 border border-emerald-500/20 p-3 rounded-lg">
                      ...
                      <ul className="text-xs text-white/80 space-y-1.5">
                        <li className="flex items-start gap-2">
                          <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                          <span>
                            Pre-defined set of conditions published by the Environment Agency
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <div className="text-sm text-white/80 space-y-2">
                  <p>
                    ...
                    <strong className="text-white">registered</strong> with the Environment Agency.
                    There are currently 58 waste exemptions covering activities such as:
                  </p>
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">T4:</strong> preparatory treatments such as
                        baling, sorting, shredding, or compacting waste for onward transfer
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">U1:</strong> use of waste in construction
                        (e.g., crushed concrete as aggregate)
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">D7:</strong> burning waste in the open (very
                        limited circumstances, specific waste types only)
                      </span>
                    </li>
                  </ul>
                  <p>
                    Exemptions must be registered before the activity commences, and operators must
                    comply with the specific conditions and quantity limits attached to each
                    exemption. Registration is free and can be done online through the Environment
                    Agency website.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  <strong className="text-emerald-400">Enforcement:</strong> Operating a regulated
                  facility without an environmental permit is a criminal offence under Regulation 38
                  of the EPR 2016. The maximum penalty on indictment is an unlimited fine and/or
                  five years imprisonment. The Environment Agency can also issue enforcement
                  notices, suspension notices, and revocation notices. In addition, it has the power
                  to impose civil sanctions including variable monetary penalties as an alternative
          ...
          <div className="border-l-2 border-emerald-500/30 pl-4 sm:pl-6">
            <div className="text-white space-y-4 leading-relaxed">
              <p>
                ...
                principal health and safety regulations for the construction industry. While CDM
                2015 does not directly regulate environmental matters, there are significant areas
                of overlap where environmental legislation and CDM duties intersect. Failing to
                consider environmental constraints during the design and planning stages can lead to
                delays, additional costs, enforcement action, and criminal prosecution.
              </p>
                ...
                <div className="text-sm text-white/80 space-y-2">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Contaminated land:</strong> sites with a
                        history of industrial use may contain contaminants in the soil including
                        heavy metals, hydrocarbons, asbestos fibres, and volatile organic compounds.
                        These pose direct health risks to workers through skin contact, inhalation,
                        and ingestion. Site investigation reports should be included in the
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Asbestos in existing buildings:</strong> the
                        Regulation 4 duty to manage asbestos (Control of Asbestos Regulations 2012)
                        requires the dutyholder to determine whether asbestos-containing materials
                        are present in the building. Refurbishment and demolition surveys to HSG264
                        must be included in pre-construction information where the work involves
                        disturbing the building fabric
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        ...
                        ecological survey reports identifying protected species (bats, newts,
                        nesting birds) and designated sites (SSSIs, Local Wildlife Sites) near the
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Environmental permit conditions:</strong> any
                        environmental permits attached to the site or required for the construction
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Planning conditions:</strong> environmental
                        planning conditions relating to noise, dust, working hours, ecology,
                        drainage, and construction traffic that constrain how the work is carried
                        out
                      </span>
                    </li>
                  </ul>
                ...
                <div className="text-sm text-white/80 space-y-2">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Material specification:</strong> choosing
                        materials with lower environmental impact (e.g., specifying recycled
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Drainage design:</strong> incorporating
                        sustainable drainage systems (SuDS) to manage surface water runoff, prevent
                        flooding, and protect water quality. Schedule 3 of the Flood and Water
                        Management Act 2010 (when commenced) will make SuDS mandatory for new
                        developments
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Waste minimisation:</strong> designing to
                        standard material dimensions to reduce cutting waste, using off-site
                        manufacture and modular construction to reduce waste generation on site, and
                        designing for deconstruction at end of life
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Energy and carbon:</strong> designing
                        energy-efficient buildings, specifying low-carbon electrical systems (LED
                        lighting, heat pumps, solar PV), and minimising embodied carbon in materials
                ...
                <div className="text-sm text-white/80 space-y-2">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Pollution prevention:</strong> spill response
                        procedures, bunded storage for oils and chemicals, silt management, cement
                        washout areas, and emergency pollution control equipment
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Dust management:</strong> wheel washing,
                        damping down, covered skips, boundary monitoring, and dust action levels
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Noise and vibration:</strong> best
                        practicable means under Section 72 of the Control of Pollution Act 1974,
                        prior consent under Section 61, monitoring, and complaint response
                        procedures
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Waste management:</strong> site waste
                        management plan, segregation procedures, duty of care compliance, and waste
                    ...
                    <li className="flex items-start gap-2">
                      <div className="flex-shrink-0 mt-1.5 w-1 h-1 rounded-full bg-emerald-400" />
                      <span>
                        <strong className="text-white">Ecological mitigation:</strong> timing
                        restrictions for vegetation clearance and demolition, ecological watching
                        briefs, species relocation programmes, and habitat reinstatement
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <p className="text-sm text-white">
                  ...
                  compliance is not separate from health and safety — it is integral to it.
                  Contaminated land, hazardous waste, and pollution incidents all pose direct risks
                  to workers. The CDM 2015 framework provides the structure for identifying and
                  managing these risks during the design and construction phases, but compliance
