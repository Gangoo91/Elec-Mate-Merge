...
const quickCheckQuestions = [
  {
    ...
    question: 'Why is cement and concrete washout water particularly dangerous to watercourses?',
    options: [
  ...
  },
  {
    ...
    options: ['0800 80 70 60', '999', '0300 123 1110', '111'],
    correctIndex: 0,
    explanation:
...
const faqs = [
  {
    question: 'What should I do if I see a colleague washing concrete or cement into a drain?',
    answer:
          ...
          <div className="rounded-lg p-4 bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong className="text-white">Pollutants:</strong> silt, cement washout, oils,
                  chemicals, sewage, and dewatering discharge
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Legal:</strong> unlimited fines and imprisonment
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Cement pH:</strong> 11-13 — highly alkaline, lethal
                  to aquatic life within minutes
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Bunding:</strong> 110% of largest container or 25%
          ...
          <div className="rounded-lg p-4 bg-emerald-500/5 border-l-2 border-emerald-500/50">
            ...
            <ul className="text-white/80 text-base space-y-1.5">
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Spill kits:</strong> know where they are, what they
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">EA hotline:</strong> 0800 80 70 60 — report ALL
              ...
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">Drains:</strong> NEVER pour cement, oil, chemicals,
                  or silty water into any drain
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="mt-1.5 w-1 h-1 rounded-full bg-white/60 flex-shrink-0" />
                <span>
                  <strong className="text-white">SuDS:</strong> temporary drainage controls must be
                  in place before earthworks begin
                </span>
              </li>
            </ul>
          </div>
              ...
              <div className="bg-white/5 border border-white/10 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Silt and sediment:</strong> the single most
                      common cause of water pollution from construction sites. Exposed ground,
                      earthworks, stockpiles, haul roads, and vehicle tracking all generate fine
                      sediment that is carried by rainwater into drains and watercourses. Silt
                      smothers riverbeds, destroys spawning gravels, blocks fish gills, and reduces
                      light penetration needed by aquatic plants.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Cement and concrete washout:</strong> cement
                      washout water is{' '}
                      <strong className="text-white">highly alkaline with a pH of 11-13</strong>.
                      This extreme alkalinity kills aquatic life rapidly — fish, invertebrates, and
                      plants can die within minutes of exposure. Sources include concrete mixer
                      wash-down, chute cleaning, tool washing, and wet cutting of concrete and
                      blockwork.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      water surfaces and toxic to aquatic life. One litre of oil can contaminate one
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-emerald-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Chemicals:</strong> paints, solvents,
                      adhesives, mould oils, curing compounds, cleaning agents, and preservatives.
                      Many of these are toxic to aquatic life even in very small concentrations and
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      groundwater or accumulated rainwater from excavations can discharge
                      silt-laden, contaminated, or chemically-altered water directly into drains or
                      watercourses if not properly managed and treated before discharge.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  <strong className="text-white">
                    ...
                    rivers, streams, and ponds with NO treatment
                  </strong>
                  ...
                  must not receive construction pollutants. If you are unsure which type of drain is
                  present, assume it is surface water and treat it accordingly.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4 text-white/80">
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm ml-4">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-white">Cause</strong> any poisonous, noxious, or
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 w-1 h-1 rounded-full bg-red-400 flex-shrink-0" />
                    <span>
                      <strong className="text-white">Knowingly permit</strong> any such matter to
                ...
                <p className="text-white/70 text-sm mt-3">
                  ...
                  <strong className="text-red-300">imprisonment</strong> — up to 2 years on summary
                  conviction, or up to 5 years on indictment.
                </p>
              </div>

              <div className="bg-white/5 border border-teal-400/30 p-4 rounded-lg">
                <h3 className="text-teal-300 font-medium mb-3">Key Legislation Summary</h3>
              ...
              <div className="bg-white/5 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  your actions caused polluting matter to enter controlled waters, you have
                  committed the offence regardless of intent. The only question is whether your
                  actions were the cause of the pollution. Both{' '}
            ...
            <div className="space-y-4 text-white/80">
              ...
              <div className="bg-white/5 border border-cyan-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Planning:</strong> all works near watercourses
                      must be carefully planned in advance. Identify potential pollution pathways,
                      install appropriate controls before work begins, and have contingency plans
                      for heavy rainfall events and equipment failure.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Buffer zones:</strong> maintain an undisturbed
                      buffer zone between the works and the watercourse wherever possible. Store
                      materials, refuel plant, and mix concrete well away from watercourses. A
                      minimum 10-metre buffer is recommended where practicable.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Seasonal restrictions:</strong> avoid in-river
                      work during fish spawning seasons (typically October to March for salmon and
                      trout). The Environment Agency may impose specific timing restrictions through
                      permits or consents. Works during breeding seasons may also affect nesting
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Protected species:</strong> watercourses often
                      support protected species including otters, water voles, great crested newts,
                      white-clawed crayfish, and various fish species. An ecological survey may be
                      required before works begin, and a licence from Natural England may be needed
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Permits and consents:</strong> you may need a
                      Flood Risk Activity Permit for works within 8 metres of a main river (or 16
                      metres for a tidal main river). Works affecting ordinary watercourses may
                      require Land Drainage Consent from the Lead Local Flood Authority.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-cyan-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Emergency preparedness:</strong> have spill
                      kits, containment booms, and absorbent materials readily available at all
                      times during works near water. Ensure all operatives know the emergency spill
                      response procedure and the EA incident hotline number.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  is far better to ask for guidance before work begins than to face enforcement
                  action afterwards. Early engagement with the EA demonstrates good practice and can
          ...
          <div className="border-l-2 border-amber-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                construction sites. Fine particles suspended in runoff water can travel long
                distances and cause serious ecological damage to watercourses. Effective silt
                management requires a combination of control measures, installed{' '}
              ...
              <div className="bg-white/5 border border-amber-400/30 p-4 rounded-lg">
                <h3 className="text-amber-300 font-medium mb-3">Silt Control Measures</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        moderate slopes but NOT suitable for concentrated flows or steep gradients.
                        Must be inspected after every rainfall event and repaired or replaced as
                        needed.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        sized correctly for the expected flow rate and sediment load — undersized
                        lagoons are ineffective. Settled sludge must be regularly removed and
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        operations with very fine clay or silt particles. More expensive but
                        significantly more effective than passive settlement.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        measure. Must be replaced regularly as they become saturated and compressed.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        Used as a last line of defence, not a primary control.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/60">
                        ...
                        cleaning dirty water. Minimise the area of exposed ground at any one time
                        and re-vegetate or cover completed areas as soon as possible.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white/5 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  blocked drain cover provides{' '}
                  <strong className="text-white">zero protection</strong>. Inspect all silt controls
                  at least daily and after every significant rainfall event. Repair, clean out, or
                  replace controls as needed. Record all inspections.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-orange-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                lubricating oil, vegetable oil, and waste oil. One litre of oil can contaminate up
                to one million litres of water.
              </p>
              ...
              <div className="bg-white/5 border border-orange-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Bunding:</strong> all oil storage containers
                      must be bunded — 110% of the largest container or 25% of total capacity,
                      whichever is greater. Bunds must be impermeable, structurally sound, and have
                      no drainage valve. Inspect bunds regularly for cracks, leaks, or
                      deterioration.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Drip trays:</strong> use drip trays under all
                      connections, valves, sight gauges, and fill/draw points. Drip trays must be
                      emptied regularly and the contents disposed of correctly — never pour drip
                      tray contents onto the ground.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Refuelling procedures:</strong> refuel on hard
                      standing, well away from drains and watercourses. Use drip trays during
                      refuelling. Never leave fuel dispensing unattended. Use automatic shut-off
                      nozzles where possible. Carry a spill kit in all refuelling vehicles.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Spill kits:</strong> keep spill kits at every
                      fuel storage location and on all plant and machinery that carries fuel or oil.
                      Spill kits must contain absorbent pads, booms, granules, disposal bags, and
                      PPE (gloves, goggles). All operatives must be trained in their use.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-orange-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">DSEAR considerations:</strong> the Dangerous
                      Substances and Explosive Atmospheres Regulations 2002 (DSEAR) apply to the
                      storage and handling of flammable fuels. Ensure adequate separation from
                      ignition sources, appropriate signage, fire extinguishers, and no-smoking
                      zones around fuel storage areas.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  place and not overflowing. Check that spill kits are stocked and accessible.
                  Report and rectify any defects immediately — a small drip today becomes a major
                  spill tomorrow.
                </p>
              </div>
            </div>
          ...
          <div className="border-l-2 border-rose-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                construction sites. Fresh concrete, cement mortar, and grout produce washout water
                with a <strong className="text-white">pH of 11-13</strong> — this is highly alkaline
                and extremely toxic to aquatic life. Even a small quantity entering a watercourse
                can cause catastrophic ecological damage.
              </p>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  . The high alkalinity (pH 11-13) of cement washout kills fish, invertebrates, and
                  aquatic plants within minutes. A single incident of concrete washout entering a
                  river can kill thousands of fish over several kilometres. This is a criminal
                  offence carrying unlimited fines and imprisonment.
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-rose-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Designated washout areas:</strong> every site
                      that uses concrete, cement, mortar, or grout must have a designated washout
                      area. This must be lined (impermeable membrane), bunded, and located well away
                      from any drain, watercourse, or low point where water could escape. All
                      concrete mixer trucks, chutes, tools, and equipment must be washed out in this
                  ...
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-rose-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">pH neutralisation:</strong> washout water can
                      be neutralised by adding a controlled quantity of acid (typically carbon
                      dioxide or citric acid) to bring the pH down to acceptable levels (pH 6-9)
                      before controlled disposal. pH must be tested before any discharge. Never
                      attempt to discharge alkaline water.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-rose-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Settlement and recycling:</strong> allow
                      washout water to settle so that cement solids drop out. The settled water can
                      often be reused for further washout or dampening haul roads. The settled
                      solids must be disposed of as waste. Some sites use recirculating washout
                      systems that continuously settle and recycle the water.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-rose-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Wet cutting:</strong> wet cutting of concrete,
                      blockwork, and paving slabs produces alkaline slurry that must also be
                      contained. Use a wet vacuum or containment system to collect the slurry — do
                      not allow it to run off into drains. The same containment and disposal
                      requirements apply.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-rose-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Signage and briefings:</strong> clearly mark
                      the designated washout area with signage. Brief all operatives — including
                      delivery drivers — on the washout procedure. Concrete truck drivers must be
                      directed to the washout area before they arrive on site. Monitor compliance
                      and take corrective action immediately if anyone washes cement elsewhere.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white/5 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm mb-3">
                  ...
                  most aquatic organisms can tolerate, because the pH scale is logarithmic — each
                  whole number represents a tenfold change.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-purple-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              ...
              <div className="my-6">
                ...
                <div className="bg-white/5 border border-white/10 rounded-lg p-4 sm:p-6">
                  ...
                  <div className="mt-4 bg-white/5 border border-emerald-500/30 rounded-lg p-3">
                    <p className="text-emerald-300 text-xs sm:text-sm font-medium">
                      Defence in depth — multiple layers of protection ensure that if one control
                      fails, the next layer catches the problem before pollutants reach water.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 border border-purple-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-2 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Absorbent pads:</strong> for soaking up liquid
                      spills on hard surfaces. Oil-only pads (white) absorb oil but repel water —
                      ideal for use in wet conditions. Universal pads (grey) absorb all liquids
                      including water-based chemicals.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Absorbent booms/socks:</strong> long tubes of
                      absorbent material placed around a spill to contain it and prevent it
                      spreading. Also used to surround drain gullies to prevent pollutants entering
                      the drainage system.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Absorbent granules:</strong> loose granular
                      material scattered over spills on hard surfaces to absorb liquid. Swept up
                      after absorption and disposed of as contaminated waste.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Disposal bags:</strong> heavy-duty bags for
                      collecting used absorbent materials. All used spill kit materials are
                      classified as contaminated waste and must be disposed of through a licensed
                      waste carrier.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-purple-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">PPE:</strong> chemical-resistant gloves, safety
                      goggles, and coveralls. Always wear PPE when dealing with spills — you may not
                      know exactly what has been spilled or its toxicity.
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-lg">
                <div className="flex items-start gap-2 mb-3">
                  <AlertTriangle className="h-5 w-5 text-red-400 flex-shrink-0 mt-0.5" />
                  <h3 className="font-semibold text-red-300">Emergency Spill Response Procedure</h3>
                </div>
              ...
              <div className="bg-white/5 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/70 text-sm">
                  ...
                  present and toxic. In fact, using detergent makes the pollution{' '}
                  <strong className="text-white">worse</strong> because the dispersed oil is more
                  bioavailable and harder to clean up. The detergent itself is also a pollutant.
                  Always use absorbent materials to physically remove oil from the water or surface.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-l-2 border-green-500/50 pl-4 sm:pl-6">
            ...
            <div className="space-y-4 text-white/80">
              <p>
                ...
                Rather than piping rainwater directly into drains and watercourses — which increases
                flood risk, pollution, and erosion — SuDS slow water down, filter out pollutants,
                and allow water to soak into the ground or be released gradually.
              </p>

              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                <h3 className="font-semibold mb-2 text-emerald-400">The Four Pillars of SuDS</h3>
              ...
              <div className="bg-white/5 border border-green-400/30 p-4 rounded-lg">
                <h3 className="text-green-300 font-medium mb-3">Temporary vs Permanent SuDS</h3>
              ...
              <div className="bg-white/5 border border-green-400/30 p-4 rounded-lg">
                ...
                <ul className="text-white/70 space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">Attenuation:</strong> storing water temporarily
                      and releasing it slowly to reduce peak flow rates. This reduces downstream
                      flood risk and erosion. Attenuation can be above-ground (ponds, basins) or
                      below-ground (tanks, oversized pipes, crates).
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">Infiltration:</strong> allowing water to soak
                      into the ground through permeable surfaces, soakaways, and infiltration
                      trenches. This recharges groundwater and reduces runoff volume. Not suitable
                      where ground conditions are impermeable (clay), where the water table is high,
                      or where ground contamination could be mobilised.
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-400 mt-2 flex-shrink-0"></div>
                    <div>
                      <strong className="text-white">SuDS Approval Bodies (SABs):</strong> local
                      authorities acting as SuDS Approval Bodies have statutory responsibility for
                      approving, adopting, and maintaining SuDS that serve more than one property.
                      Developers must obtain SAB approval for their SuDS designs before construction
                      can begin.
                    </div>
                  </li>
                </ul>
              ...
              <div className="bg-emerald-500/10 border border-emerald-500/30 p-4 rounded-lg">
                ...
                <p className="text-white/80 text-sm">
                  ...
                  monitoring equipment) associated with permanent SuDS. Most importantly, you must
                  understand that{' '}
                  <strong className="text-white">
                    your actions on site directly affect water quality
                  </strong>{' '}
                  — from where you refuel your van, to how you dispose of cable stripping waste, to
                  whether you wash your tools into a drain. Every operative has a role in water
